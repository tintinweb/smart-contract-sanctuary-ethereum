...
contract EntryPass is ERC721, Pausable, Ownable, IEntryPass {
    ...
    {
        require(msg.value >= mintPrice, "Not enough ETH to Mint the NFT; Please check price!");
    ...
    function setNFTPrice(uint256 _mintValue) external override onlyOwner 
    {
        mintPrice = _mintValue;
        emit setNFTValue(mintPrice);
    }
...
interface IEntryPass { 
    ...
    event setNFTValue(uint256 mintPrice);
