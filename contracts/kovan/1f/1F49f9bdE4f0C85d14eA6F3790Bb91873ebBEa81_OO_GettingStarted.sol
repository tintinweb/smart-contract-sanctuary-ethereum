...
// File: https://github.com/UMAprotocol/protocol/blob/master/packages/core/contracts/oracle/interfaces/FinderInterface.sol
...
// File: https://github.com/UMAprotocol/protocol/blob/master/packages/core/contracts/oracle/interfaces/OptimisticOracleV2Interface.sol
...
// This contract shows how to get up and running as quickly as posible with the UMA Optimistic oracle.
...
contract OO_GettingStarted {
    ...
    OptimisticOracleV2Interface oo = OptimisticOracleV2Interface(0xB1d3A89333BBC3F5e98A991d6d4C1910802986BC);
    ...
    bytes ancillaryData = bytes("Q:Is the temperature on the 25th of July 2022 in Manhattan NY hotter than 35c? 1 for yes. 0 for no.");
    ...
    function requestPrice() public {
        ...
        IERC20 bondCurrency = IERC20(0xbF7A7169562078c96f0eC1A8aFD6aE50f12e5A99); // Use Kovan Dai as the bond currency.
    ...
    function getRequest() public view returns (int256) {
