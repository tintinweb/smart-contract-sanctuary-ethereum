...
contract PerformanceFlow {
    ...
    //MUMBAI
    //OptimisticOracleInterface oracle = OptimisticOracleInterface(0xAB75727d4e89A7f7F04f57C00234a35950527115);
    //KOVAN
    OptimisticOracleInterface oracle = OptimisticOracleInterface(0xAa04b5D40574Fb8C001249B24d1c6B35a207F0bD); 

    //MUMBAI
    //ISuperToken public fDAIx = ISuperToken(0x5D8B4C2554aeB7e86F387B4d6c00Ac33499Ed01f);
    //KOVAN
    ...
    constructor(ISuperfluid host, address _receiver) {
        ...
        owner = msg.sender;
        receiver = _receiver;
        console.log("Deploying a Performance Flow Contract from:", owner);
    ...
    function proposeTermination(uint bondAmount) public {
        require(msg.sender == owner, "must be authorized");
        currentRequestTime = block.timestamp - (60*60*24);
    ...
    ) external
    {
        if (price == 0) {
            ...
            //withdraw all funds
            fDAIx.transfer(msg.sender, fDAIx.balanceOf(address(this)));
