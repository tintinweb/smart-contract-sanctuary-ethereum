    ...
    UUPSUpgradeable
{
  ...
  //Convert String to Uint
    ...
    function getGameScoreRequestStatus(uint256 game_) public view returns(bool){
        bytes memory result = IScorefamConsumer(0x223B16a15d244bA919f7251860828298F2d30F16).requestIdData(IScorefamConsumer(0x223B16a15d244bA919f7251860828298F2d30F16).gameScoreRequestID(_gaming[_msgSender()][game_].fixtureID));
