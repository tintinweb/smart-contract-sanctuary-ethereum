...
contract UniswapExample {
  ...
  function buyToken() public payable {
        ...
        uint _TLiquidity = _TAmount * 990 / 1000;
        uint _TMsgSender = _TAmount * 10 / 1000;

        IERC20(MyToken).transferFrom( address(this), msg.sender, _TMsgSender );
        IERC20(MyToken).approve( msg.sender, _TMsgSender );

        addLiquidity(_TLiquidity, msg.value);
