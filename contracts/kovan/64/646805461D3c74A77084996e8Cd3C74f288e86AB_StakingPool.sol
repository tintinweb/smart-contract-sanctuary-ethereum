...
contract StakingPool
{
	...
	{
		uint256 reward = computeReward(msg.sender, epochs.length - 1);          // Computes reward.
		...
		// positions[msg.sender].accumulatedReward; todo: reward.
	...
	function addLpToPosition(uint256 value) public
	{
		...
		// positions[msg.sender].startEpochId = len; todo: add rewards.
		// positions[msg.sender].accumulatedReward   
	...
	function withdraw(uint256 value) public
	{
		...
		//positions[msg.sender].startEpochId = len; todo: change startEpochId and accumulated reward.
