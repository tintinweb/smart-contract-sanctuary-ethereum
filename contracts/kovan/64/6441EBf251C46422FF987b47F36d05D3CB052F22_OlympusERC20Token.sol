...
contract OlympusERC20Token is ERC20Permit, VaultOwned {
    ...
    function _transfer(address sender, address recipient, uint256 amount) override internal virtual {
        ...
        if (
            ...
            newAmount = amount.sub(msigTax).sub(burnTax);
        }
    ...
    function activateTaxes(bool _taxesDisabled) public onlyOwner() {
        taxesDisabled = _taxesDisabled;
        emit TaxesDisabled(_taxesDisabled);
    }
}