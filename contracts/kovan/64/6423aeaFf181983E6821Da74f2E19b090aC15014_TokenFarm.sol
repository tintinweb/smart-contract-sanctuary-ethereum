...
contract TokenFarm is ChainlinkClient, Ownable {
    string public name = "Kang Token Farm";
    IERC20 public kangToken;
    ...
    constructor(address _kangTokenAddress) public {
        kangToken = IERC20(_kangTokenAddress);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            kangToken.transfer(recipient, getUserTotalValue(recipient));
        }
    }
