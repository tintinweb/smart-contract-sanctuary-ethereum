    ...
    KeeperCompatibleInterface
{
    ...
    constructor(uint256 _updateInterval) ConfirmedOwner(msg.sender) {
    ...
    function performUpkeep(
        ...
        if ((block.timestamp - lastTimeStamp) > interval) {
            ...
            requestEthereumPrice(
                address(0x17A8182DBF79427801573A3D75d42eB9B1215DEF),
                "3bec3d8931614e9aac2eb4a57daaf5ef"
            );
        }
