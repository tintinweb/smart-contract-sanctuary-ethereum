...
contract GravitySCtest {
    ...
    constructor() {
        ...
        tokenAddresses[AssetType.DAI] = address(0xC4375B7De8af5a38a93548eb8453a498222C4fF2);
        tokenAddresses[AssetType.wETH] = address(0xd0A1E359811322d97991E03f863a0C30C2cF029C);
        tokenAddresses[AssetType.LINK] = address(0xa36085F69e2889c224210F603D836748e7dC0088);
    }
    ...
    function deposit(address _owner, AssetType _sourceAsset, uint256 _amount) external {
        require(tokenAddresses[_sourceAsset] != address(0x0), "Unsupported asset type");
        address _token = tokenAddresses[_sourceAsset];
        require(IERC20(_token).allowance(_owner, address(this)) > _amount, "Insufficient value");
    ...
    function withdraw(AssetType _sourceAsset, uint256 _amount) external {
        address _token = tokenAddresses[_sourceAsset];
