...
// File contracts/WhitelistUpgradeable.sol
    ...
    WhitelistUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        address gnosisSig = 0x9d9133c8191Af631231c28bCfad8cCF1d5f7F8fC;
        _grantRole(DEFAULT_ADMIN_ROLE, gnosisSig);
        _grantRole(PAUSER_ROLE, gnosisSig);
        _grantRole(MINTER_ROLE, gnosisSig);
        _grantRole(UPGRADER_ROLE, gnosisSig);
    }
