...
contract Exchange is Ownable {
    ...
    uint256 public tokenPerEth = 10000;
    ...
    function buyTokenOnPayload() public payable {
        ...
        // uint256 tokenReturn = (amountInEth * 1 ether) / tokenPerEth;
        uint256 tokenReturn = amountInEth * tokenPerEth;
        // // require(amountTobuy >= costWei);
    ...
    function sellToken(uint256 amount) public {
        ...
        uint256 exchangeEth = amount / tokenPerEth;
