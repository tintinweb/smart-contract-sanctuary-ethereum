...
contract TransportationOffert { // 
    ...
    function createContract(string memory _startTime, string memory _pickupLoation, string memory _arrivalTime, string memory _finalDestination, uint256 _finalPrice, address payable _driver) public  {
