...
contract TitanDoge is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address payable private _developmentAddress =
        payable(0x06443fAAFE85F644a4A7853451c55C1bA5A8CF3C);
    address payable private _marketingAddress =
        payable(0xeE6e3230D28f7F43f077a609fa481Bc246eA9B3f);
    address payable private _buyBackAddress =
        payable(0xF6EC5D0cdd98F6A6E3935287A7036E5B64F95A14);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBLiquidity = (amountReceived * liquidityShare) /
            2 /
            totalBNBShare;
