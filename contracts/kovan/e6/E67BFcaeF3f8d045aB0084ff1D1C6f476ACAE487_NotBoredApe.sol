...
contract NotBoredApe is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public parterMintPrice = 0.0001 ether;
    ...
    ) ERC721A("Not Bored Ape Yacht Club", "NBAYC") {
    ...
    // MUST CALL toggleRefundCountdown() once ready to kick off minting
    ...
    function publicSaleMint(uint256 quantity) external payable {
        ...
        for (uint256 i = 0; i < partnerContracts.length; i++) {
            ...
            if(IERC721(partnerContract).balanceOf(msg.sender) != 0){
                finalMintPrice = parterMintPrice;
                break;
            }
        }
