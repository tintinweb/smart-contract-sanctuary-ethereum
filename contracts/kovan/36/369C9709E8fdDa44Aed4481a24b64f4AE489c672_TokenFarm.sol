...
contract TokenFarm is ChainlinkClient, Ownable {
    ...
    //100 ETH 1:! for every 1 ETH, we give 1 DappToken
    // 50 ETH and 50 dAI staked, we want to five a reward of 1 DAPP/1 DAI
    ...
    function unstakeTokens(address token) public {
        ...
        //now remove users if you want to.
    }

    //better to claim tokens here instead of looping, more gas efficient to claim
