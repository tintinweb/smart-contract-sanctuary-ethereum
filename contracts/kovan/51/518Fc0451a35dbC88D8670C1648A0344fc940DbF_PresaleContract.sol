...
contract PresaleContract is AccessControlEnumerable, PresaleInterface {
    ...
    uint private _firstStageBlockStart = 14574566;              // https://etherscan.io/block/countdown/14574566
    uint private _firstStageBlockEnd = 14577403;                // https://etherscan.io/block/countdown/14577403
    uint private _firstStageMaxContributorCount = 1000;
    uint private _firstStageMaxContribution = 5000 * 10**6;

    uint private _secondStageBlockStart = 14587757;             // https://etherscan.io/block/countdown/14587757
    uint private _secondStageBlockEnd = 14590313;               // https://etherscan.io/block/countdown/14590313
