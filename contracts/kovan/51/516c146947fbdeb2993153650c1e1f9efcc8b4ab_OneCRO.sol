...
// File: stableswap-cronos-contracts/contracts/tokens/OneCRO.sol
...
contract OneCRO is IERC20 {
    using SafeMath for uint256;

    string public constant symbol = "1CRO";
    string public constant name = "1CRO";
