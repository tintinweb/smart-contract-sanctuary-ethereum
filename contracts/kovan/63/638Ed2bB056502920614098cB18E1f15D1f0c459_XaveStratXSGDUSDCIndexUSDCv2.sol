...
//        require(hTokenBalance > 0, "XaveStrat/collateral-withdrawn");
        ...
        (
            uint256[] memory tokenOutAmounts,
            address[] memory tokenOutAddresses
        ...
        )
    {
        ...
        (uint256 estimatedLpTokens, uint256[] memory estimatedAmounts) = IFXPool(addresses.lpToken)
        ...
        return (estimatedLpTokens, sortedAmounts, tokens);
    }
