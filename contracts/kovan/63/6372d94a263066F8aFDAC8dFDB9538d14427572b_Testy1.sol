...
contract Testy1 is Context, IERC20, Ownable {
    ...
    bool public swapEnabled = true; // cannot be set to false
    ...
    address public treasuryAddress = 0x5b182eb4FE0F3463b1c4042e4Fa90eD9C45aB604;
    address public charityAddress = 0xe88Eeae06aa59bd5e77aF4dB01404C591110893D;
    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public lpRecipient = 0x1Fe48cF88CBad1BE2876215801B5Bb57d4941198;


    string private constant _name = "Testy1";
    ...
    Taxes public taxes = Taxes(15,12,38,5,20);
    ...
    function setTaxes(uint256 _rfi, uint256 _treasury, uint256 _charity, uint256 _burn, uint256 _liquidity) public onlyOwner {
        // total tax cannot exceed 10%
        require((_rfi + _treasury + _charity + _burn + _liquidity <= 100), "Too high");
    ...
    function updateMaxTxAmt(uint256 amount) external onlyOwner{
        require(amount >= minMaxTxAmount, "Too little");
    ...
    function updateCoolDownSettings(bool _enabled, uint256 _timeInSeconds) external onlyOwner{
        // coolDown time cannot exceed 60 seconds
        require(_timeInSeconds <= 60, "Too high");
