...
contract WyvernExchange is Exchange {
     ...
     */
    constructor (ProxyRegistry registryAddress, TokenTransferProxy tokenTransferProxyAddress, ERC20 tokenAddress, address protocolFeeAddress, uint256 _chainID) public {
 ...
 * @author Project Wyvern Developers
 */
contract Exchange is ExchangeCore, Pausable {
...
contract ExchangeCore is ReentrancyGuarded, Ownable {
        ...
        returns (bytes32 hash)
    {
        ...
        index = ArrayUtils.unsafeWriteUint256(index, chainID);
...
contract ProxyRegistry is Ownable, Pausable {
...
contract TokenTransferProxy is Ownable, Pausable {
...
library ArrayUtils {
     ...
     * @return End memory index
     */
    function unsafeWriteUint256(uint index, uint256 source)
        internal
        pure
        returns (uint)
    {
