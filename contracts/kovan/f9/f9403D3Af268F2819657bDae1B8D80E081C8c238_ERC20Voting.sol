...
contract ERC20Voting is MajorityVoting {
    ...
    function newVote(
        ...
        emit StartVote(voteId, _msgSender(), _actions, _startDate, _endDate);
...
interface IMajorityVoting {
    ...
    event StartVote(uint indexed voteId, address indexed creator, IDAO.Action[] action, uint64 start, uint64 end);
