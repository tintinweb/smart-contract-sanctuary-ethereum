    ...
    ReentrancyGuardUpgradeable
{
    ...
    function setUSDCAddress(address _usdc) external onlyOwner {
        require(_usdc != address(0),"setUSDCAddress: Invalid address");
        USDC = _usdc;
    ...
    function pathUSDCAddress() public view returns (address[] memory) {
        return pathUSDC;
    }

    function pathAddress() public view returns (address[] memory) {
        return path;
    }
