...
contract ValorantCards is Ownable, ERC1155, VRFConsumerBase, ChainlinkClient {
    ...
    constructor(
        ...
        oracle = 0x43Ab85B881F5A8C6024DC597c6A129D92F9343e9;
        jobId = "a367aba53e954251bec3296ae8f21091";
    ...
    /// @dev Fetches the account level for the provided account
    /// @param accountName The account's name
    /// @param tagNumber The account's tag number
    function requestUserLevel(
