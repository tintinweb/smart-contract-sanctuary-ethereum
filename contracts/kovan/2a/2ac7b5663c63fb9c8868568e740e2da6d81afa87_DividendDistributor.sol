...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router, address _ep, address _eth) {
        EP = IERC20(_ep);
        METIS = _eth;
...
contract AtlasPrinter is Context, IERC20, Ownable {
    using SafeMath for uint256;

    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

    address EP = 0xd0A1E359811322d97991E03f863a0C30C2cF029C;             // TETHYS
    address public WETH = 0xd0A1E359811322d97991E03f863a0C30C2cF029C;       // METIS
    address public autoLiquidityReceiver=0x1A6Ab945414cFbEC5B8915A43E9Eda7767B7412b;
    address public marketingFeeReceiver=0x1A6Ab945414cFbEC5B8915A43E9Eda7767B7412b;
    ...
    string constant _name = "AtlasPrinter";
    string constant _symbol = "ATLAS";
    ...
    uint256 public _maxTxAmount = _totalSupply.div(1); // 1%
    uint256 public _maxWallet = _totalSupply.div(1); // 2,5%
    ...
    constructor () {
        ...
        WETH = router.WETH();
        distributor = new DividendDistributor(routerAddress, EP, WETH);
