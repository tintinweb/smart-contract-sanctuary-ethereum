...
contract TokenFarm is ChainlinkClient, Ownable {
    string public name = "Sixela Token Farm";
    ...
    constructor(address _sTokenAddress) public {
        sToken = IERC20(_sTokenAddress);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            sToken.transfer(recipient, getUserTotalValue(recipient));
        }
    }
