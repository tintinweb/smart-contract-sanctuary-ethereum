...
/**
* @title Implementation ERC20 token for tests
* @notice You can use this contract for mint token
*/
contract MockedToken is ERC20 {

    /**
    * @dev Creates a contract instance that allows mint and transfer token
    ...
    * @param account Address recipient token
