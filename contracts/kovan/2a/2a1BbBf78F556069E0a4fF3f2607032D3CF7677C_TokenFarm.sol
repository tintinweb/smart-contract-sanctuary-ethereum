...
contract TokenFarm is Ownable {
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        // transferFrom function from ERC20 - need to call approve first (because is not owner)
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            // send token reward based on ther TVL
        ...
        returns (uint256)
    {
        ...
        // Dont want to revert, thats why is not stating require
