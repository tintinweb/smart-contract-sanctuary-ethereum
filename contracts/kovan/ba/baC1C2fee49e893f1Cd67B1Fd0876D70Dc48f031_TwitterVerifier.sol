...
contract TwitterVerifier is Initializable, IVerifier, OwnableUpgradeable, EIP712Upgradeable {
     ...
     * @param tweetId tweetId in which user verified on twitter
     */
    ...
    function registerSelf(
        ...
        require(bytes(userData[msg.sender].twitterId).length == 0, 'RS1');
        require(twitterIdMap[_twitterId] == address(0), 'RS2');
        require(block.timestamp < _timestamp + signValidity, 'RS3');
        ...
        require(hashAddressMap[digest] == address(0), 'RS4');
