...
contract xCoolCats is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        Address.sendValue(
            payable(0xa42124D4C69a23602114bF8a61a4d2f081C8Af59),
            amount
        );
    }
}