...
contract LegionNFT is Context, IERC721, Ownable {
    ...
    function hunt(uint256 tokenId, uint256 monsterId) external returns(bool){
        require(ownerOf(tokenId)==msg.sender, "you should own this legion first");
        require(tokenData[tokenId].supplies>0&&!tokenData[tokenId].onMarket, "This legions can not hunt");
        //require(lastHuntTime + 1 days<block.timestamp, "You need to wait for next hunt");
    }
