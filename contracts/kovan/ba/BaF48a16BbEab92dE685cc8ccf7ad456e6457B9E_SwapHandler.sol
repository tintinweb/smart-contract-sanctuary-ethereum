...
// File contracts/misc/interfaces/uniswapv2.sol
...
// File contracts/misc/swap/SwapHandler.sol
...
contract SwapHandler {
    ...
    function swapBestOut(
        ...
        IERC20Upgradeable(tokenIn).safeApprove(address(router), amountIn);
    ...
    function swapBestIn(
        ...
        IERC20Upgradeable(tokenIn).safeApprove(address(router), amountInMax);
    ...
    function swapExactTokensForTokens(
        ...
        require(recipient != address(0), "SwapHandler: recipient is the zero address");
        IERC20Upgradeable(path[0]).safeApprove(address(router), amountIn);
    ...
    function swapTokensForExactTokens(
        ...
        require(recipient != address(0), "SwapHandler: recipient is the zero address");
        IERC20Upgradeable(path[0]).safeApprove(address(router), amountInMax);
