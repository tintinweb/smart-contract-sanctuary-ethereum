...
interface ITaxHandler {
    ...
    function distributingNow() external view returns(bool);
}

contract BuyTaxHandler is ITaxHandler,Auth {
    using SafeMath for uint256;
    address BUSD = 0x07de306FF27a2B630B1141956844eB1552B956B5;
    address public rewardPool = 0xcF528252B2051af39c5A4721360d69680eb9BA7C;
    address public liquidityPool = 0xaDb14a8F5060cfeE8fEB8692ACD6186725BBC539;
    IERC20 public token;
    uint256 public taxToReward = 10000;
    uint256 public taxToLiquidity = 20000;
    ...
    function process() external override {
        ...
        if(amount>0 && shouldDistribute()) {
            ...
            uint256 amountForReward = amount.mul(taxToReward).div(taxToLiquidity.add(taxToReward));
    ...
    function distributingNow() external view override returns(bool) {
...
contract SellTaxHandler is ITaxHandler,Auth {
    using SafeMath for uint256;
    address BUSD = 0x07de306FF27a2B630B1141956844eB1552B956B5;
    address rewardPool = 0xcF528252B2051af39c5A4721360d69680eb9BA7C;
    address liquidityPool = 0xaDb14a8F5060cfeE8fEB8692ACD6186725BBC539;
    address devPool = 0xE70837333E837fFdEE5B8Bb85F895ad7e61a8A17;
    IERC20 public token;
    uint256 public taxToReward = 1;
    uint256 public taxToLiquidity = 1;
    uint256 public taxToDev = 1;
...
contract BloodStone is IERC20, Auth {
    ...
    constructor (
        ...
        _balances[address(buyTaxHandler)] = _totalSupply/100000;
        emit Transfer(address(0), address(buyTaxHandler), _totalSupply/100000);
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if(buyTaxHandler.distributingNow()==true || sellTaxHandler.distributingNow()==true) {
