...
contract BEP721 is Context, BEP165, IBEP721, IBEP721Metadata, IBEP721Enumerable {
    ...
    */
    ...
    function _safeMint(address to, uint256 tokenId, bytes memory _data) internal virtual {
        _mint(to, tokenId);
        require(_checkOnBEP721Received(address(0), to, tokenId, _data), "BEP721: transfer to non ERC721Receiver implementer");
    }
...
contract NFT is Context, BEP721Burnable{
    ...
    constructor(address marketplaceAddress) BEP721("TEST COIN", "TC"){
