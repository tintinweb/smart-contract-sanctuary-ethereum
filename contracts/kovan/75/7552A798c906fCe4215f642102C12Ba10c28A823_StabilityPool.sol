...
contract StabilityPool is IStabilityPool, Ownable, OrumBase{
    ...
    function sendUSDCtoBorrower(
        ...
        if (_amount > 0) {
            uint amount_transfered = usdcStaker.transferUSDC(_amount, _to);
            require(amount_transfered == _amount, "Stability Pool: sendUSDCtoBorrower failed");
            USDC_Lent += _amount;
