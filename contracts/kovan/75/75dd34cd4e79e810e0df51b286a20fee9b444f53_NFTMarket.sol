 ...
 * {ERC721Enumerable}.
 */
contract BEP721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeTransfer(
        ...
        _transfer(from, to, tokenId);
        require(_checkOnERC721Received(from, to, tokenId, _data), "BEP721: transfer to non ERC721Receiver implementer");
    }
    ...
    function _checkOnERC721Received(
        ...
        if (to.isContract()) {
            try IERC721Receiver(to).onERC721Received(_msgSender(), from, tokenId, _data) returns (bytes4 retval) {
                ...
                if (reason.length == 0) {
                    revert("BEP721: transfer to non ERC721Receiver implementer");
                } else {
                    assembly {
