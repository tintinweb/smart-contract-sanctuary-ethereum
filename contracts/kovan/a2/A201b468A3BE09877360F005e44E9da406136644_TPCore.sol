...
contract TPCore is AccessControl {
    ...
    function stake(uint104 amount) external {
        ...
        uint256 totalBeforeReward = strategy.estimateReward(address(this));  ////////////////////////////////////////////////////////////////////
        ...
        uint256 differenceReward = totalReward - totalBeforeReward;         ///////////////////////////////////////////
        if (
            totalReward == 0 ||
            ...
            liquidityAmount = differenceReward;                              //////////////////////////////////////////////////////////////////////
        } else {
            liquidityAmount =
                (differenceReward * liquidityToken.totalSupply()) /       ///////////////////////////////stakingCoinAmount => differenceReward///////////
                (totalReward - differenceReward);                           ///////////////////////////////stakingCoinAmount => differenceReward///////////
        }
