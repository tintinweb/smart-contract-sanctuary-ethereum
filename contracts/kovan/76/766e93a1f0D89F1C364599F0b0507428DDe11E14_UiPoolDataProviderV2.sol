...
contract UiPoolDataProviderV2 is IUiPoolDataProviderV2 {
    ...
    returns (AggregatedReserveData[] memory, BaseCurrencyInfo memory)
  {
    ...
    baseCurrencyInfo.networkBaseTokenPriceInUsd = int256(networkBaseTokenPriceInUsdProxyAggregator
      .latestAnswer());
    ...
    try oracle.BASE_CURRENCY_UNIT() returns (uint256 baseCurrencyUnit) {
      if (ETH_CURRENCY_UNIT == baseCurrencyUnit) {
        ...
        baseCurrencyInfo
        .marketReferenceCurrencyPriceInUsd = int256(marketReferenceCurrencyPriceInUsdProxyAggregator
        .latestAnswer());
      } else {
