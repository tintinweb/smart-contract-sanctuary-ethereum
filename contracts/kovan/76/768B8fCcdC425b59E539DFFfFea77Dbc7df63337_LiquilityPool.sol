...
contract LiquilityPool is XlpToken {
    ...
    function swap(address _token0, address _token1, uint256 _amountIn, uint256 _minAmountOut) public {
        ...
        require(amountOut >= _minAmountOut ,"amount out not larger min amount out");
    ...
    function removeLiquidity(uint256 _amount1, uint256 _amount2) public {
        ...
        uint256 spendBurn = _amount1 * totalSupply / DAI.balanceOf(address(this));
