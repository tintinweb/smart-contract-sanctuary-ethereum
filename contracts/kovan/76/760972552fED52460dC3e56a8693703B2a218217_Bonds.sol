...
contract Bonds is ERC1155, IBonds {
    ...
    function newLoan(
        ...
        require(
            ...
            "Hash of data signed must be the paymentContractAddress and id encoded in that order"
        );
        //
        ...
        require(
            user == creator,
            "Data provided must be signed by the borrower"
        );
    ...
    function stake(uint256 _id, uint256 _amm)
        ...
        returns (uint256)
    {
        //        require(this.balanceOf(msg.sender, _id) > 0, "Caller has no Bonds");
