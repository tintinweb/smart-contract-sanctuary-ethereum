...
contract Distributor is IDistributor, Policy {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        address _treasury,
        address _miner,
        address _staking // address _authority
    ) {
     ...
     */
    function setBounty(uint256 _bounty) external override onlyPolicy {
    ...
    function removeRecipient(uint256 _index) external override {
        require(msg.sender == policy(), "Caller is not governor or guardian");
