...
contract Erc721ItemAssetFactory is AssetFactoryBase {
    ...
    function setOwnerAsset(
        ...
        _setOwnerAsset(
            positionId,
            createAsset(contractAddress, tokenId)
        );
    }
...
contract Erc721ItemAsset is AssetBase, IErc721ItemAsset {
    ...
    function transferToAsset(address spender, uint256[] calldata data)
        external
    {
    ...
    function assetTypeId() external override pure returns (uint256) {
        return 3;
    }
}
