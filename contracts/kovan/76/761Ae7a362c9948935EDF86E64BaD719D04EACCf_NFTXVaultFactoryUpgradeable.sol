    ...
    INFTXVaultFactory
{
    ...
    function createVault(
        ...
        emit NewVault(_vaultId, vaultName, is1155, vaultAddr, _assetAddress, levels, ratios);
        return _vaultId;
    }
...
interface INFTXVaultFactory is IBeacon {
  ...
  event NewVault(uint256 indexed vaultId, string vaultName, bool is1155, address vaultAddress, address assetAddress, uint256[] levels, uint256[] ratios);
