...
// File: contracts/ERCTEST5050.sol
...
contract ERCTEST5050 is ERC721A, Ownable, ReentrancyGuard {
    // limits
    ...
    string public nftSymbol= "KUSD" ;
    address constant public aavecontractAddess= 0x580D4Fdc4BF8f9b5ae2fb9225D584fED4AD5375c  ;
    address constant public aaveErc20contractAddess= 0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe ;
    ...
    address constant public daiAddress = 0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD; // testnet DAI
    address constant public myAddress = 0x0242e1575eCa732BA39cF1f377083a9899BEB49E; // mywallet
    ...
    function depositDaiToAave() external payable nonReentrant {
...
//E.g: lendingPool.deposit{ value: msg.value }(reserve, msg.value, referralCode)
        ...
        aavecontractAddess.call{ value : msg.value  }(abi.encodeWithSignature("deposit(address,uint256,uint16)", ethKovanTokenAddress, msg.value , 0) )  ;
        // aavecontractAddess.deposit{ value: msg.value }(ethKovanTokenAddress , msg.value, 0 ) ;
...
function burn (uint256 tokenID) external {
        ...
        _burn(tokenID) ;
        aethKovanTokenAddress.call(abi.encodeWithSignature("redeem(uint256)", 78668565446))  ;
}
