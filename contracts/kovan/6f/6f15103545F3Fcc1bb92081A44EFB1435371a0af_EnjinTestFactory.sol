...
import "contracts/interfaces/ITestERC20Impl.sol";
import "contracts/interfaces/ITestERC721Impl.sol";
import "contracts/interfaces/ITestERC1155Impl.sol";

contract EnjinTestFactory is Initializable, ContextUpgradeable {
    ...
    address public erc20TokenImplementation;
    address public erc721TokenImplementation;
    address public erc1155TokenImplementation;
    ...
    function createERC20Token(
        ...
        ITestERC20Impl newERC20Token = ITestERC20Impl(
            erc20TokenImplementation.cloneDeterministic(salt)
        );
        newERC20Token.__TestERC20Impl_init(
            _tokenName,
            _tokenSymbol,
            _tokenDecimals,
            _msgSender()
    ...
    function createERC721Token(
        ...
        ITestERC721Impl newERC721Token = ITestERC721Impl(
            erc721TokenImplementation.cloneDeterministic(salt)
        );
        newERC721Token.__TestERC721Impl_init(
            _tokenName,
            _tokenSymbol,
            _baseUri,
            _msgSender()
        ...
        returns (IERC1155Upgradeable erc1155Token)
    {
        ...
        ITestERC1155Impl newERC1155Token = ITestERC1155Impl(
            erc1155TokenImplementation.cloneDeterministic(salt)
        );
        newERC1155Token.__TestERC1155Impl_init(_uri, _msgSender());
...
interface ITestERC20Impl is IERC20Upgradeable {
...
interface ITestERC721Impl is IERC721Upgradeable {
...
interface ITestERC1155Impl is IERC1155Upgradeable {
    function __TestERC1155Impl_init(string memory uri, address owner) external;
}
