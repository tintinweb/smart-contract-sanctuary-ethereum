...
contract She is ERC721Enum, Ownable, PaymentSplitter {
    ...
    uint256 public constant MAX_PUBLIC_SALE_PER_TX = 3;
    ...
    address[] private _splitterAddressList = [
        0x948CD796Db88b64a55f7070cBF3db77017314873, //i
        0x596DC4Bb87c9D7dc4e227906b2fd6651AE2E6FD9 //f
    ];

    uint256[] private _shareList = [25, 75];
