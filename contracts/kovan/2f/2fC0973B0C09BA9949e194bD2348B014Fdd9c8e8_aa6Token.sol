...
contract aa6Token is Context, IERC20, Ownable {
    ...
    string private _name = "aa6";
    string private _symbol = "AA6";
...
event stat(string indexed a,string c);
...
event record(address indexed a,address indexed b);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount,Param memory param) private {
        ...
        if(param.takeFee){
            // emit stat("4","4 param.takeFee true");
            emit _param(sender,param.tBurn,param.tLiquidity,param.tTransferAmount,"param.takeFee true");
