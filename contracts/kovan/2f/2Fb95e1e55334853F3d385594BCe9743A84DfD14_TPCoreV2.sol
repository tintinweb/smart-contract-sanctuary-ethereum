...
contract TPCoreV2 is AccessControl {
    ...
    uint256 private lastIntervalBalance;
    ...
    function totalTPYAvail() public view returns (uint256) { 
        //return (block.number - startingBlock) * blockReward - takenTPY;  // todo implement
    ...
    function registerTPY(address staker, uint256 stakingCoinAmount) private {
        ...
        intervalBalances[nextIntervalNumber] = lastIntervalBalance;
    }
    ...
    function takeTPYReward(uint256 unstakeCoinAmount) private {
        ...
        intervalBalances[nextInterval()] = lastIntervalBalance;
