...
contract DcaKeeperFacet is KeeperCompatibleInterface {
    ...
    address public uniRouterAddr = 0xE592427A0AEce92De3Edee1F18E0157C05861564;
    uint256 public uniRouterVersion = 1;
    ...
    function getUniRouterAddr() public view returns (address) {
        return uniRouterAddr;
    }

    function setUniRouterAddr(address _uniRouterAddr) public {
        uniRouterAddr = _uniRouterAddr;
    }
    ...
    /// @param amountIn The exact amount of DAI that will be swapped for WETH9.
    /// @return amountOut The amount of WETH9 received.
    function swapExactInputSingleOld(
        uint256 amountIn,
        address addressTokenIn,
        address addressTokenOut
    ) public returns (uint256 amountOut) {
        ...
        // Approve the router to spend DAI.
        TransferHelper.safeApprove(addressTokenIn, uniRouterAddr, amountIn);
        ...
        // The call to `exactInputSingle` executes the swap.
        amountOut = ISwapRouter(uniRouterAddr).exactInputSingle(params);
    }
}
