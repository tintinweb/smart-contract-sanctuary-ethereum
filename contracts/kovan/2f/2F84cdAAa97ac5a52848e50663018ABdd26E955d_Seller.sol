...
contract Seller {
    ...
    uint8 public baseDecimals; //decimals of basePrice
    ...
    */  
    function getChainlinkAggregator(address _token) public returns (address) {
        return (allowedTokenToChainlinkAddress[_token]);
    }
    ...
    */  
     ...
     * Buyer of Box has to be Whitelisted (SC Controller, _whitelist)
