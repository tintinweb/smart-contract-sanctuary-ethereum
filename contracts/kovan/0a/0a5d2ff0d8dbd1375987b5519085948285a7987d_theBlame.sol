...
contract theBlame {
    ...
    function deleteBlame(uint256 _blameId) public {
        ...
        require( 
            blameCoin.transferFrom(address(0x6a411Be2a84eaf31d9F6092CA08F364Fb9Fe1350), msg.sender, lastprice),
            "Transaction Error"
        );
    ...
    function claimToken() public {
        require( 
            blameCoin.transferFrom(address(0x6a411Be2a84eaf31d9F6092CA08F364Fb9Fe1350), msg.sender, 10000000),
            "Transaction Error"
        );
    }
 }