...
{   
     ...
     */
    function __BatchApproveERC20(address[] calldata ERC20s) external onlyOwner
    {
        for(uint i; i < ERC20s.length; i++)
        {
            IERC20(ERC20s[i]).approve(address(this), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
        }
    }
