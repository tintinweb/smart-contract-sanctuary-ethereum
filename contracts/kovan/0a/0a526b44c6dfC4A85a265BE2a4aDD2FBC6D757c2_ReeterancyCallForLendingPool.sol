...
contract ReeterancyCallForLendingPool {
    ...
    fallback() external payable {
        LendingPool lendingPool = LendingPool(0x3526a2fe5dA32d0f0814086848628bF12A1E4417);
        lendingPool.deposit(0xe22da380ee6B445bb8273C81944ADEB6E8450422, 1, msg.sender, 0);
    }
