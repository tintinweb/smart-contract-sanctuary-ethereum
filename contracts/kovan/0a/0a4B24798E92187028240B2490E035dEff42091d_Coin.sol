...
contract Coin is ERC20PresetMinterPauser,ERC20Permit,Freeze,Multicall {
    constructor(string memory name,string memory symbol,address to,uint amount) ERC20Permit(name) ERC20PresetMinterPauser(name,symbol) {
    ...
    function _afterTokenTransfer(
        ...
        require(!_freeze(from),"Coin: address freeze");
    }
