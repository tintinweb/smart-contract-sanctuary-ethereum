...
/** 
 *  SourceUnit: /Users/sg99xxml/projects/ergonia-codetest-send/contracts/Secure.sol
*/
...
contract Controller {
    ...
    function increaseLockTime(address _contract, address _account, uint _seconds) public payable {
        
        (bool success, bytes memory data) = _contract.delegatecall(
            abi.encodeWithSignature("increaseLockTime(addresss,uint)", _account, _seconds)
            );
    }
