...
// Stake Tokens, Unstake tokens, issue tokens, add allowed tokens, get Eth value, mapping of token addr => staker addr => amount
...
contract TokenFarm is Ownable {
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        require(tokenIsAllowed(_token), "Token is currently not accepted");
    ...
    {
        // need price feed address for the token (need mapping)
