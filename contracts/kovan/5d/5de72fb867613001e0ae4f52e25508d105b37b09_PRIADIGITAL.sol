...
contract PRIADIGITAL is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("PRIADIGITAL NFT", "PDG") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmfWratrbeDmL7VgxFXoDagG2DWhYu82rsZC6hzHdc1Hhk?filename=PRIA.png";
    }
