...
contract ABCToken is Context, IERC20, Ownable {
    ...
    string private _name = "ABC Token";
    ...
    address public oldSwan = address(0x30e5d713194699151700b0A905f2e76EbDcAc06F);
    ...
    function mapingInviter(address[] calldata _sender) public {
