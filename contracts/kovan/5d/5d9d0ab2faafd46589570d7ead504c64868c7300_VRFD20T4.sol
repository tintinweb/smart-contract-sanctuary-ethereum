...
contract VRFD20T4 is VRFConsumerBase, ConfirmedOwner(msg.sender) {
    ...
    function rollDice(address roller) public onlyOwner returns (bytes32 requestId) {
        require(LINK.balanceOf(address(this)) >= s_fee,  string(abi.encodePacked("Not enough LINK to pay fee. Balance:",LINK.balanceOf(address(this)))));
