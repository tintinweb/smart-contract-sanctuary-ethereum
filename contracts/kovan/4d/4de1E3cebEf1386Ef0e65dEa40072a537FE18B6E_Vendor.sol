...
contract Vendor is Ownable {
  ...
  function withdraw() public onlyOwner {
    require(address(this).balance > 0 , "Contract is broke.");
  ...
  function sellTokens(uint256 _amount) public {
    ...
    require(address(this).balance >= (_amount / tokensPerEth), "ETH in contract exceeded.");
    require(yourToken.allowance(msg.sender, address(this)) >= _amount, "Transfer not approved.");
