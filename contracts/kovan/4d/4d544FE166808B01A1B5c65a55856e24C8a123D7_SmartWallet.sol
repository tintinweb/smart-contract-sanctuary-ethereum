...
contract SmartWallet {
    ...
    modifier ownerOnly() {
        ...
        require(msg.sender == owner, 'Error: You are not authorized');
    ...
    //IminerNFTs[] minersOwned;



    mapping(address => bool) farmIsApproved;

    modifier approvedFarmsOnly() {

        require(farmIsApproved[msg.sender] == true, "Error: You are not authorized");

        _;

    }

    address[] approvedFarms;
    


    constructor(address yourPersonalCryptoAddress) {


        owner = payable(yourPersonalCryptoAddress);


        host = ISuperfluid(0xF0d7d1D47109bA426B9D8A3Cde1941327af1eea3);
        ...
        usdt = ISuperToken(address(0x2eB320E2100A043401e3B3B132d4134F235A6A04));
    ...
    //cfaV1.cfa.createFlow(receiver, token, flowRate, userData);
    //cfaV1.cfa.updateFlow(receiver, token, flowRate, userData);



    function createElectricityPaymentStream(

        string memory minerSerial, 
        
        int96 flowRate /*how to determine this?*/

    ) external approvedFarmsOnly {

            bytes memory serialBytes = bytes(minerSerial);
            
            cfaV1.cfa.createFlow(
                
                usdt, 
                
                msg.sender,//msg.sender is the farm contract , as the reciever, calling this smart wallet contract
    ...
    function updateElectricityPaymentStream(
    ...
    function withdrawBalance() public payable ownerOnly returns(bool withdrawSuccessful) {
    ...
    function approveFarmForPaymentStream(address farm) public ownerOnly {
        
        //later make it so that master contract is called to see if added farm belongs to a farm in krater ecosystem
        
        approvedFarms.push(farm);
        
        farmIsApproved[farm] = true;

    }



    //NFT balance can be seen using ERC721 interface
    //NFT can be sent using ERC721 interface
    //NFT can be received using ERC721 interface

    /////////////////////////////////////////////////////////////////////////////////////////////////////////
    //NFT will be purchased from either, marketplace or farm/////////////////////////////////////////////////
    ////thus NFT will be transferred from marketplace to farm, or minted at the farm/////////////////////////
    ////the NFT will have an owner metadata attribute////////////////////////////////////////////////////////
    //////the farm contract holds the miner NFT while mining even though the owner is the hosting crustomer///
    ////in case the customer wants the miner in their physical possesion, the customer will never hold the 
    ////miner NFT on the blockchain, but will always get listed the owner in the metadata of the miner NFT
