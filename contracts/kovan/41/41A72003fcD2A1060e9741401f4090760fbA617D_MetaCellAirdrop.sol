...
// File: contracts\meta-cell\MetaCellAirdrop.sol


pragma solidity ^0.8.3;
contract MetaCellAirdrop is Ownable, ReentrancyGuard {
    ...
    constructor(address _metaCellToken) {
        ...
        nonReentrant
    {
        ...
        IMetaCellCreator(metaCellToken).create(msg.sender);
    }
