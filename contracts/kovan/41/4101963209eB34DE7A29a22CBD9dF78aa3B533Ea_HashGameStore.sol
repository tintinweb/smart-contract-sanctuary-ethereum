...
contract HashGameStore {
    struct Game {
        ...
        /* Filecoin Distribution Variables:
        string[] CID; // Filecoin Hash Location
        uint serverReserves; // Hash Token reserves for paying for Filecoin server space
        */
    }
    ...
    */
    ...
    // PUBLIC
    function gameRegister(uint256 price, uint256 quantityAvailable)
        public
        returns (uint256)
    {
        Game memory newGame;
