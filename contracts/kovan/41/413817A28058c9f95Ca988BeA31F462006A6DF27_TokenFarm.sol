...
contract TokenFarm is Ownable {
    ...
    // maps tokens to it's chainlink pricefeed
    ...
    function issueTokens() public onlyOwner {
        // loop through list of all stakers
        for (
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        // keep track of staked amount by token and by wallet
        updateUniqueTokensStaked(msg.sender, _token);
        stakingBalance[_token][msg.sender] =
            stakingBalance[_token][msg.sender] +
            _amount;
        // add wallet address to stakers list if it's its first time staking
    ...
    function unstakeTokens(address _token) public {
        ...
        // need to remove address from stakers list if there's no more coins from this staker
    }
