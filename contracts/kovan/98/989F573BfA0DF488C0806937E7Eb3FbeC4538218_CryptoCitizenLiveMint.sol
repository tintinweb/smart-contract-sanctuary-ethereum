...
{   
    ...
    /**
     * @dev Batch Returns If `Wallet` Owns Multiple TokenIDs
     */
    function getOwnedTokenIDs(address Wallet, address NFTAddress, uint[] calldata TokenIDs) public view returns (uint[] memory)
    {
