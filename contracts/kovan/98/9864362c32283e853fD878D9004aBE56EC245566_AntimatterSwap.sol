...
contract AntimatterSwap is OwnableUpgradeable {
    ...
    function getAmounts() public view returns(uint256 optionAmount, uint256 premiumAmount) {
        IVault vaultContract = IVault(vault);
        ...
        IERC20MetadataUpgradeable assetToken = IERC20MetadataUpgradeable(vaultContract.vaultParams().asset);
        uint256 optionDecimals = optionToken.decimals();
        uint256 assetDecimals = assetToken.decimals();
        ...
        return (optionAmount, premiumAmount);
    }
