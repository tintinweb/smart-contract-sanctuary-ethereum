...
contract RC3_Mall is RC3_Auction {
    ...
    function _buyCheck(uint256 _marketId, Asset _asset) private view {
        Market memory market = markets[_marketId];
...
contract RC3_Auction is Ownable, ReentrancyGuard {
    ...
    function _bidCheck(uint256 _auctionId) private view {
        Auction memory auction = auctions[_auctionId];
