...
contract LiquidityMiningManager is TokenSaver {
    ...
    uint256 private immutable totalRewards;
    ...
    constructor(
        ...
        require(
            _totalRewards != 0,
            "LiquidityMiningManager.constructor: totalRewards cannot be zero"
        );
    ...
    function setMaxPoolCount(uint256 _newMaxPoolCount) external onlyGov {
        MAX_POOL_COUNT = _newMaxPoolCount;
    }

    function distributeRewards(uint256 _percent) public onlyRewardDistributor {
        // uint256 timePassed = block.timestamp - lastDistribution;
        // uint256 totalRewardAmount = rewardPerSecond * timePassed;
        uint256 totalRewardAmount = (totalRewards * _percent) / BP;
