...
/*
    Sample contract based on https://www.721.so/contract?config=%7B%22schemaVersion%22%3A%221.0.0%22%7D
*/
contract MockERC721 is Erc721BurningErc20OnMint, ReentrancyGuard {
...
abstract contract Erc721BurningErc20OnMint is ERC721, IErc721BurningErc20OnMint, Ownable {
    address private erc20TokenAddress;

    function setErc20TokenAddress(address erc20TokenAddress_) public override onlyOwner {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721) returns (bool) {
        return interfaceId == type(IErc721BurningErc20OnMint).interfaceId || super.supportsInterface(interfaceId);
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (from == address(0) && to != address(0)) {
            require(erc20TokenAddress != address(0), "erc20TokenAddress must be defined");
