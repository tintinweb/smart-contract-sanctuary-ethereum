...
contract PreMinerTokenUpgradeableChild is ERC20PresetFixedSupplyUpgradeable, OwnableUpgradeable {
    ...
    function initializeChild(address _Minerdmin, address _childChainManagerProxy) public initializer {
        __PreMinerTokenUpgradeableChild_init(_Minerdmin, _childChainManagerProxy);
    }

    function __PreMinerTokenUpgradeableChild_init(address _Minerdmin, address _childChainManagerProxy)
        internal
        initializer
    {
        ...
        _addApprovedSeller(_Minerdmin);
        _addApprovedSeller(address(0x0000));
        _addApprovedSeller(_childChainManagerProxy);
        __Ownable_init();
        childChainManagerProxy = _childChainManagerProxy;
        __ERC20PresetFixedSupply_init("PreMiner (POS)", "pMINER", 0 * 1e18, _Minerdmin);
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            (balanceOf(to_) > 0 || isApprovedSeller[from_] == true || !requireSellerApproval),
            "Account not approved to transfer pMINER."
        );
    }
