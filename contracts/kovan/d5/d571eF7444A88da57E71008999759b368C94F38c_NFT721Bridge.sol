...
contract NFT721Bridge is
    ...
    function setClaimStatus(bytes32 _claimId, bool value) public onlyGovernance {
        alreadyClaims[_claimId] = value;
    }
...
//        alreadyClaims[_claimId] = true;
    ...
    function removeTokenMap(address _originToken, uint256 _chainId) public onlyGovernance {
        tokenMap[_chainId][_originToken] = address(0);
    }

    function setOriginChainToken(address _originToken, bool value) public onlyGovernance {
        originChainTokens[_originToken] = value;
    }
