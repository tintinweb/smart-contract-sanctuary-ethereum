...
contract Uchu is Initializable {
    ...
    **/
    function deposit(address user, uint256 amount, uint8 proId) public returns (bool) {
        if (productId > 0) {
    ...
    **/
    ...
    function repay(address user, uint256 amount, uint8 proId) public returns (bool) {
            Product memory pro = getProduct(proId);
