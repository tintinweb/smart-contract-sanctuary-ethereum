...
contract OriginationCore is IOriginationCore, Initializable, OwnableUpgradeable {
    ...
    function createFungibleListing(IFungibleOriginationPool.SaleParams calldata saleParams) external payable {
        ...
        IFungibleOriginationPool(originationPool).initialize(originationFee, this, msg.sender, saleParams);
    ...
    /**
     * @dev Creates a new NFT listing
     * @dev Must pay the listing fee
     * @dev ETH is only payable asset to mint
     *
