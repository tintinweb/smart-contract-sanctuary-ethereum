...
interface IMonster {
    function getMonsterInfo(uint256 monsterId) external view returns(string memory, uint256, uint256, uint256);
...
contract Monster is IMonster {
    ...
    function getMonsterInfo(uint256 monsterId) external override view returns(string memory, uint256, uint256, uint256) {
