...
contract Pool is Ownable, ReentrancyGuard {
    ...
    function swap(uint256 _minXTokenOut) external payable nonReentrant {
        ...
        if (_xTokenOut > 0) {
            ...
            xToken.mint(address(this), _xTokenOut);
        }
    ...
    function collect() external nonReentrant {
        ...
        if (_sendXToken) {
            xToken.safeTransfer(_sender, _xTokenAmount);
        }
    ...
    function setController(address _controller) external {
        ...
        emit NewControllerSet(_controller);
    }
    ...
    event NewControllerSet(address indexed _controller);
}
