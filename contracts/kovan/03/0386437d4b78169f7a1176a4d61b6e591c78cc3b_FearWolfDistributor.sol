...
contract FearWolfDistributor is AccessControl, Pausable, Withdrawable, ReentrancyGuard {
    ...
    */
    ...
    // Prices in ETH
    uint256 public presalePrice = 0.01 * 10 ** 17; // 0.0010 ETH
    uint256 public salePriceMax = 0.02 * 10 ** 17; // 0.0020 ETH
    uint256 public salePriceMin = 0.02 * 10 ** 17; // 0.0020 ETH
    ...
    */
    ...
    constructor() {
        ...
        claimingStart = whitelistedPresaleStart + 65 minutes ;
        grantRole(MANAGER_ROLE, msg.sender);
        grantRole(PAUSER_ROLE, msg.sender);
        setFearWolfContractAddress(0x4Ecf9111a04CA95C06947d80C86F228a73f2CFCe);
        addWhitelistedAddress(0xAf98aE477c5C2394b92aC75767753cbDaF152f12);
        _unpause();
    }
    ...
    */
    ...
    function setFearWolfContractAddress(address _address) public onlyRole(MANAGER_ROLE) {
        require(block.timestamp < whitelistedPresaleStart, "Too late, presale is already active");
    ...
    function addWhitelistedAddress(address _address) public onlyRole(ADMIN_ROLE) {
