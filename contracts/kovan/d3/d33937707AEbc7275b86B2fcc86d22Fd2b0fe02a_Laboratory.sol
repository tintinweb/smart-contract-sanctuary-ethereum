...
// File: contracts\interfaces\IMetaCellCreator.sol
...
// File: contracts\interfaces\INanoCellCreator.sol
    ...
    Ownable
{
    ...
    function _processSplit(CellData.Cell memory cell) private {
        if (CellData.Class(cell.class) == CellData.Class.SPLITTABLE_NANO) {
            ...
            emit NewCellCreated("MDMA", amount);
        } else if (
        ...
        override
    {
        ...
        IMetaCellCreator(metaCell).create(msg.sender);
