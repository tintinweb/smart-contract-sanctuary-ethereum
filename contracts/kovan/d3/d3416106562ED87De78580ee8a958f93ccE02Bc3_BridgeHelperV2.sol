...
import "./nxtpV2/IConnextHandler.sol";
import {ERC20} from "@rari-capital/solmate/src/tokens/ERC20.sol";
import "hardhat/console.sol";

contract BridgeHelperV2 {
    ...
    function transfer(
        ...
        require(
            token.allowance(address(connext), address(this)) >= _amount,
            "Approval failed"
        );
        ...
        emit TransferInitiated(_asset, msg.sender, _to);
    }

    function test() external {
        address asset = 0xB5AabB55385bfBe31D627E2A717a7B189ddA4F8F;
        address to = 0x6d38A527407adE9E5bADA4501d8C4508262b97E3;
        uint256 amount = 1e18;
        uint32 originDomain = 2221;
        uint32 destinationDomain = 1111;
