...
contract OlympusERC20Token is ERC20Permit, VaultOwned {
    ...
    event DisableTaxes(bool _disableTaxes);
    ...
    function setDisabledTaxes(bool _disableTaxes) public onlyOwner() {
        disableTaxes = _disableTaxes;
        emit DisableTaxes(_disableTaxes);
    }
}