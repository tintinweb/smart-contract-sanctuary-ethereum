...
contract Pizza is Initializable, UUPSUpgradeable, OwnableUpgradeable {
   ...
   // Yükseltilebilir contract'larda contructor yok. Bunun yerine initializers var.
   ...
   function initialize(uint256 _sliceCount) public initializer {
       slices = _sliceCount;
      // Constructor olmadığı için, OwnableUpgradeable'ı açıkça başlatmamız gerekiyor.
