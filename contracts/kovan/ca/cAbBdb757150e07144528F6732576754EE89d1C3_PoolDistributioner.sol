...
// File contracts/misc/isolation/PoolDistributioner.sol


pragma solidity ^0.8.0;

contract PoolDistributioner is Distributioner {

    function initialize(address _rewardToken, address _comptroller, address _manager) initializer override public {
        Distributioner.initialize(_rewardToken, _comptroller, _manager);
    }
