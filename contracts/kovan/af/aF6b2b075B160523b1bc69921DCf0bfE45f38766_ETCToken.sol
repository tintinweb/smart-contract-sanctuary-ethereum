...
contract ETCToken is Context, IERC20, IERC20Metadata ,  Ownable{
    ...
    constructor(
        ...
        daoContractAddress = 0xC7788f351571641130b33c31E6B7a4Ffa8021E8d;  //dao pool contract
        lpPoolContractAddress = 0x8d0092485e79dC5dBD5bE06950caE415d41beFcb; //lp pool contract
        etcPrice = 1;
    ...
    event casting_(uint256 taxes,address indexed _caller,uint256 usdtBalance,uint256 etcBalance,  uint256 etcPrice);
    ...
    function casting(uint256 taxes,address _caller)  external   returns(bool) {
            ...
            etcPrice =  _totalSupply.div(usdtBalance);
            usdtValue += taxes;
            emit casting_(taxes,_caller,usdtBalance,_totalSupply,etcPrice);
        return true;
    }
