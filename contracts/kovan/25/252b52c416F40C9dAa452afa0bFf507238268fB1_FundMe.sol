...
contract FundMe {
    ...
    mapping(address=> uint256) public addressToAomountFunded;
    ...
    function fund() public payable{
        ...
        require(getConversionRate(msg.value) >= minimumUSD, "You need to spend more ETH, Min 50USD");
        addressToAomountFunded[msg.sender] += msg.value;
    }
    ...
    function getConversionRate(uint256 ethAmount) view public returns(uint256) {
        uint256 price = ethAmount*getPrice();
        //  All in gwei
    ...
    modifier OwnerAddress {
        require(msg.sender == owner, "You're not the owner of the Scontract");
        _;
    }

    function withdraw() public OwnerAddress payable {
