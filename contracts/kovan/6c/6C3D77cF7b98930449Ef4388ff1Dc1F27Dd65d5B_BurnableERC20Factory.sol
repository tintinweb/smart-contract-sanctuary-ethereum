...
contract BurnableERC20Factory {
    ...
    function create(
        ...
        require(tokens[symbol].owner == address(0), "Token already exists");

        require(initialOwner != address(0), "Token already exists");
        ...
        ERC20 burnableErc20 = new BurnableERC20(
            initialOwner,
            name,
            symbol,
            mintAmount,
