...
/** 
    @title CryptoTaxReducerKov.sol (Kovan testversion of the Cryptotaxreducer contract)
    @author https://twitter.com/CryptTaxReducer
    
    @dev This contract helps people swap unsellable tokens to the TAX token on Kovan.
    ...
    *   Step 3:
    ...
    Get Kovan testnet tokens:
    To get Kovan ETH, USDC and other testnet tokens for tests, go to: 
    https://docs.alchemist.wtf/copper/auction-creators/getting-test-tokens-for-balancer-lbps-on-the-kovan-testnet.
...
contract CryptoTaxReducerKov is Ownable {
    ...
    constructor(address taxTokenAddr) {
        ...
        usdc = IERC20(0xc2569dd7d0fd715B054fBf16E75B001E5c0C1115); // USDC on Kovan testnet.
