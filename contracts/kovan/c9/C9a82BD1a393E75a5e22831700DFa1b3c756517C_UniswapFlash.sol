...
contract UniswapFlash is 
    ...
    function uniswapV3FlashCallback(
        ...
        require(loanAmount == 0, Helpers.getMessageUint("loanAmount: ", loanAmount));
        ...
        uint16 tradeDex1 = tradeDexs[1];
    {
        ...
        require(amountOut0 != balance0, "same amountOut0");
        ...
        // uint256 profit = LowGasSafeMath.sub(amountOut1, amountOwed);
