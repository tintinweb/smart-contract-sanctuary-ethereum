...
// File @eth-optimism/contracts/libraries/bridge/[email protected]
...
// File contracts/ControlL1Greeter.sol
...
// File contracts/ControlL2Greeter.sol
...
contract Layer1 
{
  ...
  address public messengerAddress = 0x4361d0F75A0186C05f971c566dC6bEa5957483fD;
  address layer2Address = 0x63583e5014434653AEA73C0d172689E25Bbd358d; // contract deployed on optimism...
  bytes public message = abi.encodeWithSignature(
  "setValue(uint256)",
  45);
  ...
  {
    ICrossDomainMessenger(messengerAddress).sendMessage(layer2Address, message, 100000);
  }
}
