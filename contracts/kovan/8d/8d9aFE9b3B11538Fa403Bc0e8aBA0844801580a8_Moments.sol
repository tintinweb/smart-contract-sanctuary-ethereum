...
contract Moments is ERC721, AccessControl, ContextMixin, NativeMetaTransaction, ERC721URIStorage {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant ADMIN_ROLE = keccak256("DEFAULT_ADMIN_ROLE");
    using ECDSA for bytes32;


    //constructor sets baseURI, name, and admin
    constructor(string memory name, string memory baseTokenURI) ERC721(name, "MOMENTS") {
