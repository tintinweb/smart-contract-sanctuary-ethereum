...
contract IDO is VestedClaim, Whitelisted {
    ...
    ERC20 public USDTAddress; // solhint-disable-line var-name-mixedcase
    ERC20 public USDCAddress; // solhint-disable-line var-name-mixedcase

    uint256 public startTime; // Only for test purposes not marked as . We accept the increased gas cost
    uint256 public endTime; // Only for test purposes not marked as . We accept the increased gas cost
