...
contract BixosverseGame is AccessControl {
    ...
    function addNewIsland(uint256 nftId) public onlyRole(ORACLE_ROLE) {
        // cspell:disable
        // @TODO: bu require hic calismiyor "ERC721: owner query for nonexistent token" donuyor zaten eger mintlenmemisse
        // cok gerekli ise nft'nin totalSupply'dan kucukluk kontrolu yapilabilir.
        // cspell:enable
    ...
    function joinGame(uint256 nftId) public onlyIslandExists(nftId) {
        ...
        userInGameExistence[nftId][msg.sender] = true;
