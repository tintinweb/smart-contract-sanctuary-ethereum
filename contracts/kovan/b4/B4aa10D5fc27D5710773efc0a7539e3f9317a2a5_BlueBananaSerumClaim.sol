...
contract BlueBananaSerumClaim is Ownable {
    ...
    bytes32 public merkleRoot = 0x5dfc0e2bf0aabe0fa57f85eb391997b7f1fb3befdcc78a223ca1620873ba493b;
    ...
    function airdropBBS(address[] calldata recipients) external onlyOwner {
        require(claimOpen, "Claim not opened");
        
        require(recipients.length > 0, "Zero recipients specified");

        for (uint256 i = 0; i < recipients.length; i++) {
             blueBananaSerum.mint(0, recipients[i]);
        }
    }
