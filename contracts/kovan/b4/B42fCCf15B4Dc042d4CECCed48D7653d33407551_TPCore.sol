...
contract TPCore is AccessControl {
    ...
    function nextIntervalTPYs(address lpProvider) external view returns (uint256) {
        ...
        if (intervalTotalStakingAmount > 0){
            ...
            if(staking.intervalNumber == interval && staking.pendingAmount == 0) {
                return 0;
            }
            else if(staking.intervalNumber == interval) {
                return staking.amount * intervalTotalReward / intervalTotalStakingAmount;
            }
            else {
                return (staking.amount + staking.pendingAmount) * intervalTotalReward / intervalTotalStakingAmount;
            }
        }
        else {
            return 0;
