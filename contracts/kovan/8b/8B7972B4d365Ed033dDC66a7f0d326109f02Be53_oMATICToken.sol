...
contract oMATICToken is CheckContract, IoMATICToken, Ownable {
    ...
    function _requireCallerIsBorrowerOps() internal view {
        require(msg.sender == borrowerOpsAddress, "oMATIC: Caller is not BorrowerOps");
    }

    function _requireCallerIsCollateralPool() internal view {
        require(msg.sender == collateralPoolAddress, "oMATIC: Caller is not CollateralPool");
    }

    function _requireCallerIsAPorCP() internal view {
        require(msg.sender == activePoolAddress || msg.sender == collateralPoolAddress, "oMATIC: Caller is neither  ActivePool nor CollateralPool");
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external override returns (bool) {
        _approve(msg.sender, spender, _allowances[msg.sender][spender].sub(subtractedValue, "oMATICToken: decreased allowance below zero"));
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balances[sender] = _balances[sender].sub(amount, "oMATICToken: transfer amount exceeds balance");
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account].sub(amount, "oMATICToken: burn amount exceeds balance");
