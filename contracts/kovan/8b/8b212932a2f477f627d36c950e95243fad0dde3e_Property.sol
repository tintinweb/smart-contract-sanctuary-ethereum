...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // contract   0xD4Fc541236927E2EAf8F27606bD7309C1Fc2cbee

    bool public succe;
    bytes public data;
    function test(uint amount) public{
        address tokenAddr = address(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8);
        IERC20 token = IERC20(tokenAddr);
        bytes memory callData = abi.encodeWithSelector(
        ...
        (bool success, bytes memory dat) = tokenAddr.call(callData);
        succe = success;
        data = dat;
    }
    ...
    function test1() public {
        address tokenAddr = address(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8);
        IERC20 token = IERC20(tokenAddr);
        token.transfer(address(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2), 1);
    } 
