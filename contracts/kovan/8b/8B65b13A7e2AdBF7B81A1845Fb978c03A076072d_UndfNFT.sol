...
contract UndfNFT is ERC721, Ownable {
    ...
    constructor() payable ERC721('undfNFT', 'UNDF') {
        mintPrice = 0.01 ether;
        totalSupply = 0;
        maxSupply = 1000;
        maxPerWallet = 3;
        // isPublicMintEnabled = true;
        // baseTokenUri = 'https://undf.io/';
    ...
    function mint(uint256 quantity_) public payable {
        ...
        require(quantity_ <= maxSupply - totalSupply, 'Max supply reached.');
        require(quantity_ <= maxPerWallet - walletMints[msg.sender], 'Max per wallet reached.');
