...
contract UniswapFlash1Inch is 
    ...
    function uniswapV3FlashCallback(
        ...
        address flashPool = getFlashPool(factory, callback.poolKey);
    ...
    function approveToken(address token, address router) public {
        TransferHelper.safeApprove(token, router, uint(-1));
    }
