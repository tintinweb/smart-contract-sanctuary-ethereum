...
contract SANDOAirdrop is Ownable {
    ...
    event airdrop_log(string remark, address _msgSender, uint _amount,string _unit);
   ...
   bool internal locked;
    ...
    function getAirdrop() public {
        ...
        emit airdrop_log("You have airdrop.",msg.sender,(AirdropPerUser/10**18)," Tokens");
    }

    function _clearhasClaimed(address claimAddress) public view onlyOwner returns(bool){
        require(claimAddress != address(0x0),"Address is not zero.");
        return hasClaimed[msg.sender] == false;        
    }

    function _getOwnerToken() public returns(address){
