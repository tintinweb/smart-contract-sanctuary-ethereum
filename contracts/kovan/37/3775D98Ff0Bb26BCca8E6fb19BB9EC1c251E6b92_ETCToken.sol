...
contract ETCToken is Context, IERC20, IERC20Metadata ,  Ownable{
    ...
    function sellEtc(uint256 amount) external returns(bool){
        ...
        _burn(msg.sender,amount.mul(84).div(100));
        ...
        unchecked {
            _balances[msg.sender] = fromBalance - amount.mul(16).div(100);
        }
    ...
    function _transfer(
        ...
        require(whitelist[from],"Non-normal users cannot transfer money");
