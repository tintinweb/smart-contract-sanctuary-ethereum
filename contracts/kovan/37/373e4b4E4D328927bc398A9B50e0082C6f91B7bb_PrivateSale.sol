...
contract PrivateSale is ERC20, Ownable {
    ...
    uint256 public hardCapEthAmount = 130 ether;
    uint256 public totalDepositedEthBalance;
    uint256 public minimumDepositEthAmount = uint256(0.1 ether);
    uint256 public maximumDepositEthAmount = uint256(5 ether);
    uint256 public tokenPerBNB = 12600000;
    ...
    constructor(
        IERC20 _token,
        uint256 decimals
    ) ERC20("LittlePonyPrivateSale", "LPPS")
    {
        token = _token;
