...
contract DonateDirectDAO is ERC721Enumerable, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint8 public constant maxMintAmount = 50;
  ...
  constructor(string memory _name, string memory _symbol, string memory _initBaseURI, uint256 _cost, address _treasurerAddress) ERC721(_name, _symbol) {
