...
contract TokenFarm is Ownable {
    ...
    function stakeToken(uint256 _amount, address _token) public {
        ...
        require(
            ...
            "This token is not availiable to stake"
        );
    ...
    function unStakeTokens(address _token) public {
        ...
        require(balance > 0, "You dont have any tokens staked");
        ...
        returns (uint256)
    {
        ...
        require(
            uniqueTokenStaked[_recipient] > 0,
            "You dont have any tokens staked"
        );
        for (uint256 i = 0; i < allowedTokens.length; i++) {
            totalValue =
                totalValue +
                getUserSingleTokenValue(_recipient, allowedTokens[i]);
        }
        return totalValue;
    }
