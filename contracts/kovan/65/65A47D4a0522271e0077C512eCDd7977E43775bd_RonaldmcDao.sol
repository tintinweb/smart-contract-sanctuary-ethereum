...
contract RonaldmcDao is Context, IERC20, Ownable {
    ...
    string private _name = "Ronald McDao";
    string private _symbol = "MCRON";
    uint8 private _decimals = 9;
    uint256 public maxbuytreshold = 10;

    uint256 public _buyTaxFee =0; //buy reflection fee 
    uint256 public _sellTaxFee =1;

    uint256 public _taxFee = 1; //reflections
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _buyLiquidityFee =0; //buy liquidity fee
    uint256 public _sellLiqFee = 21;
    uint256 public _liquidityFee = 21; //liquidity and marketing
    uint256 public _startingMaxWallet = 15000000000;
    ...
    uint256 public _maxTxAmount = maxbuytreshold**10 * 10**9; //10 for 1% 11 for 2.5%
    uint256 public _maxWalletSize = _startingMaxWallet * 10**9; //
    
    uint256 public numTokensSellToAddToLiquidity = 10000000000 * 10**9; //1%
    ...
    function updateMaxWalletSize() public onlyOwner{
            _startingMaxWallet = 50000000000;
    }
    ...
    function _transfer(
        ...
        if(to != uniswapV2Pair) {
                require(balanceOf(to) + amount < _maxWalletSize, "MCRON: Balance exceeds wallet size!");
            }
