...
contract FlashLoanArbitrage is FlashLoanReceiverBase {
    ...
    address public wethAddress = 0x4c6E1EFC12FDfD568186b7BAEc0A43fFfb4bCcCf;
    address public daiAddress = 0xd0A1E359811322d97991E03f863a0C30C2cF029C;
    ...
    function flashloan(address _asset, uint256 _amount) public onlyOwner {
        ...
        uint256 parsedAmount = _amount * unit;
        bytes memory data = "";
