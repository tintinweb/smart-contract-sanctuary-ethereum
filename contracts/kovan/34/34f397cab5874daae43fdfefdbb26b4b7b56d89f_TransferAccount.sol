    ...
    function executeOperation(
        ...
        for(uint i=0; i<_DebtTokenBalance.length; i++) {
            ...
            if (_DebtTokenBalance[i].stableDebtTokenBalance != 0) {
                ...
                if (s_platformFee != 0) IERC20(_DebtTokenBalance[i].tokenAddress).transfer(s_owner, calculatePlatformFee(_DebtTokenBalance[i].stableDebtTokenBalance));
                flag = true;
            }
            // Borrow VariableDebt
            if (_DebtTokenBalance[i].variableDebtTokenBalance != 0) {
                ...
                if (flag == false && s_platformFee != 0) IERC20(_DebtTokenBalance[i].tokenAddress).transfer(s_owner, calculatePlatformFee(_DebtTokenBalance[i].variableDebtTokenBalance));
            }
        }
