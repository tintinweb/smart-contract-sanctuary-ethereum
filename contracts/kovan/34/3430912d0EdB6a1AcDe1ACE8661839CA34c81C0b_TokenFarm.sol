...
// 100 ETH 1:1 for every 1ETH, we give 1 DAPP
// 50 ETH and 50 DAI staked, and we want to give a reward of 1 DAPP / 1 DAI
    ...
    function getUserTotalValue(address _user) public view returns (uint256) {
        ...
        for (
            ...
            + getUserTokenStakingBalanceEthValue(_user, allowedTokens[allowedTokensIndex]);
        }
        return totalValue;
    }


    function getUserTokenStakingBalanceEthValue(address _user, address _token)
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        require(tokenIsAllowed(_token), "Token is currenlty not allowed");
