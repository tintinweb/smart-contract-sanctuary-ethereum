...
//    FlashLoanReceiverBase()
    ...
    function beginLiquidate(uint repayAmount)
    public
    onlyOwner
    returns (uint)
    {

        uint repayAmount1 = this.getRepayAmount(borrower, cTokenBorrow);
        emit Log("amount", repayAmount1);
        IERC20(aaveToken).transferFrom(msg.sender, address(this), repayAmount);
...
//        tokenBorrow = _tokenBorrow;
        ...
        flashLoan("123", aaveToken, repayAmount);
        return repayAmount;
    }
