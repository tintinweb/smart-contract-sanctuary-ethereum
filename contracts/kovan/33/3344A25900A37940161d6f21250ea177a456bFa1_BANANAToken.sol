...
contract NODERewardManagement is Ownable {
  ...
  function setDetaforDay(uint256 _DetaforDay) public onlyOwner {
  ...
  function _changeNodePrice(uint256 _nodePrice) public onlySentry {
...
contract BANANAToken is ERC20, Ownable {
  ...
  function setNodeManagement(address payable _nodeManagement) external onlyOwner {
  ...
  function createNodeWithTokens() public onlyStarted whenDistribution {
    ...
    super._transfer(address(this), treasuryAddress, balanceOfLiquidity);
