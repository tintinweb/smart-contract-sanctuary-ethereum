...
contract BillieJoeArmstrong is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Billie Joe Armstrong", "BJA") {
    setHiddenMetadataUri("ipfs://QmRd2QFWsgmhfucHT5hTR6yrp9iPXXutYPxJznHSAEdygj/hidden.json");
  }
