...
// TODO: refactor and extend getters/removers similar to Puppet.sol
contract WhitelistRegistry is AccessControlEnumerable {
    ...
    /**
     * @notice list of addresses whitelisted by MetaFi
     */
    ...
    constructor() {
        ...
        _setupRole(REMOVER_ROLE, msg.sender);
    }
     ...
     */
    function addToWhitelist(address _investor) external onlyRole(ADDER_ROLE) {
        require(!whitelisted[_investor], "investor already in whitelist");
