...
// File: contracts/staking/OneBeamChef.sol
...
/*  OneBeamChef is a fork from Sushi's MasterChef v2:
    - Remove Rewarder
    - Support MultiFeeDistribution
*/
contract OneBeamChef is Ownable, Initializable {
    ...
    function initialize(IMultiFeeDistribution _reward) external initializer onlyOwner {
