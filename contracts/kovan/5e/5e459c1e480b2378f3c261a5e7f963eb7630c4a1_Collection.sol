...
pragma solidity >=0.7.0 <0.9.0;
contract Collection is ERC721Enumerable, Ownable, ERC2981 {
    using Strings for uint256;
    ...
    function mint(uint256 _mintAmount) public payable {
        uint256 supply = totalSupply();
        require(saleState != 0, "Sale not opened.");
        require(saleState == 2 || whitelisted[msg.sender], "Not whitelisted.");
        require(_mintAmount > 0);

        require(
            minter_balances[msg.sender] + _mintAmount <= maxMintAmount,
    ...
    function withdraw() public payable onlyOwner {
        ...
        /*
        (bool hs, ) = payable(0xAddress).call{value: address(this).balance * TREASURY_PERCENT / 100}("");
        require(hs);
        */
