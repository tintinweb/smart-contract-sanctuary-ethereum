...
contract BindBoxParam is IBindBoxParam,Ownable,Multicall {
    ...
    uint public freeU;
    IERC20 public usdt;
    uint public override freeLevel;
    uint public override newUserBoxLimit;
    address public override signerAddress;

    using MathX128 for uint;


    constructor(uint _freeU,IERC20 _usdt,uint _newUserBoxLimit,address _signerAddress) {
        n=MathX128.oneX128*8/10;
        freeU=_freeU;
        usdt=_usdt;
        newUserBoxLimit=_newUserBoxLimit;
        freeLevel=2;
    ...
    function updateNewUserBoxLimit(uint _newUserBoxLimit) public onlyOwner {
        newUserBoxLimit=_newUserBoxLimit;
    }
    ...
    function updateFreeLevel(uint _freeLevel) public onlyOwner {
        freeLevel=_freeLevel;
    }
