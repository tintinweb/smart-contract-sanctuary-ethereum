...
import {
    EveThetaVaultStorage
} from "../../storage/EveThetaVaultStorage.sol";
import {Vault} from "../../libraries/Vault.sol";
import {VaultLifecycle} from "../../libraries/VaultLifecycle.sol";
import {ShareMath} from "../../libraries/ShareMath.sol";
import {ILiquidityGauge} from "../../interfaces/ILiquidityGauge.sol";
import {EveVault} from "./base/EveVault.sol";

/**
 * UPGRADEABILITY: Since we use the upgradeable proxy pattern, we must observe
 * the inheritance chain closely.
 * Any changes/appends in storage variable needs to happen in EveThetaVaultStorage.
 * EveThetaVault should not inherit from any other contract aside from EveVault, EveThetaVaultStorage
 */
contract EveThetaVault is EveVault, EveThetaVaultStorage {
...
import {IOptionsPremiumPricer} from "../interfaces/IEve.sol";
import {Vault} from "./Vault.sol";
import {IEveThetaVault} from "../interfaces/IEveThetaVault.sol";
...
library GnosisAuction {
    ...
    function claimAuctionOtokens(
        ...
        IGnosisAuction(gnosisEasyAuction).claimFromParticipantOrder(
            IEveThetaVault(counterpartyThetaVault).optionAuctionID(),
            orders
        );
    }
...
import {IStrikeSelection} from "../interfaces/IEve.sol";
...
library VaultLifecycle {
     ...
     * @param vaultState is the storage variable vaultState passed from EveVault
    ...
    ERC20Upgradeable
{
    ...
    // Gap is left to avoid storage collisions. Though EveVault is not upgradeable, we add this as a safety measure.
    uint256[30] private ____gap;

    // *IMPORTANT* NO NEW STORAGE VARIABLES SHOULD BE ADDED HERE
    // This is to prevent storage collisions. All storage variables should be appended to EveThetaVaultStorage
    // instead. Read this documentation to learn more:
