...
contract Voting is Authorizable {
    ...
    */
    ...
    // Release result to public, can be called only by the chairman
    function RealeaseResults() public onlySmartContractOwner EndedState {
        resultOut = true;
    }

    // to start the voting period, we would control to ensure, there's atleast a candidated added
    ...
    /*
    Method to Calculate winners, called only but the Authorized folks
    */
    ...
    /*
    This function returns the winners of the elections
    */
    ...
    /*
    Get the list of all preent candidates
    */
