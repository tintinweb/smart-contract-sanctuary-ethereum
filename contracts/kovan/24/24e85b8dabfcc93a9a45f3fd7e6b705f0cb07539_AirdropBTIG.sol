...
contract AirdropBTIG is BTIG {
    ...
    */
    ...
    event TokenSell(address indexed seller,uint256 value,uint256 amount);
    ...
    function checkRate() external returns(uint){
        ...
        rate = rates/100000000;
        return rate;
    }
    function checkETHRate() external returns(uint){
        uint rates = uint(getLatestETHPrice());
        rateETH = rates/100000000;
        return rateETH;
    }
    function viewRate() external view returns(uint){
        return rate;
    }
    function viewETHRate() external view returns(uint){
        return rateETH;
    }
