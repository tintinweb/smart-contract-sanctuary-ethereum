...
// import "./utils/EIP712MetaTransactionUpgradeable.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function fetch_trustedForwarder() public view virtual returns (address) {
    ...
    */
    ...
    /**
        @notice changes the trustedforwarder address.
        @notice Only callable by an address that currently has the admin role.
        @param newTF Value {trustedforwarder} will be changed to.
     */
    function adminChangeTrustedForwarder(address newTF) public virtual onlyRole(DEFAULT_ADMIN_ROLE) {
        _trustedForwarder = newTF;
    }
 ...
 */
    ...
    */
    function genericDeposit(uint8 _destChainID, bytes32 _resourceID) external whenNotPaused returns (uint64) {
        ...
        emit Deposit(_destChainID, _resourceID, depositNonce);
        return depositNonce;
    }
    ...
    */
    ...
    //MetaTx Section starts ( Potentially Remove )
    ...
    //     if (isTrustedForwarder(msgSender())) {
