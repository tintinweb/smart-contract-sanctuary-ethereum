...
import "./HodlRewardDistributor.sol";
...
contract BabyLilFloki is ERC20, Ownable {
    ...
    constructor(
        ...
        // init distributor 
        hodlRewardDistributor = new HODLRewardsDistributor(wbnb_, lilFloky_,swapRouter_);
...
contract HODLRewardsDistributor is Ownable {
    ...
    address public immutable lilflocky;
    ...
    receive() external payable { 
        uint256 balanceBefore = IERC20(lilflocky).balanceOf(address(this));
        _swap(msg.value);
        uint256 addedBalance = IERC20(lilflocky).balanceOf(address(this)) - balanceBefore;
        _updateGlobalShares(addedBalance);
    }
    constructor (address wbnb_, address lilFloky_, address swapRouter_){
        wbnb = wbnb_;
    ...
    */
    function claimPending(
        ...
        IERC20(lilflocky).safeTransfer(sharholderAddress_, pendingAmount);
