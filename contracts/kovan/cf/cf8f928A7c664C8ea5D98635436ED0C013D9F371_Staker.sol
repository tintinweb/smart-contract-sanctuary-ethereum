...
contract Staker {
  ...
  modifier thresholdNotReached() {
      require(address(this).balance < threshold, "Thresold reached.");
      _;
  }
  ...
  function withdraw() public deadlineExpired thresholdNotReached {
    uint256 withdrawalAmount = balances[msg.sender];
    require(withdrawalAmount > 0, "No stake!");
    balances[msg.sender] = 0;
    (bool success, ) = msg.sender.call{value: withdrawalAmount}("");
    require(success, "Failure to send ETH");
  }
