...
contract MutantApesPlanet is Ownable, ERC721A {
    ...
    constructor() ERC721A("Mutant Apes Planet", "MAP") Ownable() {
        wallet1 = 0xeCC8196c56080De3Eb66DCDa00096ACdA9Ced6aB ;
        wallet2 = 0xeCC8196c56080De3Eb66DCDa00096ACdA9Ced6aB ;
        _safeMint(wallet2, 1);
    }
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
     ...
     */
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {        
        if (!_exists(tokenId) && tokenId != 6805) revert URIQueryForNonexistentToken();
