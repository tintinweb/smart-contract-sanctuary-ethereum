...
10% of each sell goes into $test treasury.
...
pragma solidity ^0.6.12;
    ...
    contract TesterTTT is Context, IERC20, Ownable {
        ...
        string private _name = 'TesterTTT2';
        ...
        function _takeTeam(uint256 tTeam, uint256 tFee) private {
            uint256 currentRate =  _getRate();
            uint256 rTeam = tTeam.add(tFee).mul(currentRate);
