...
contract TokenFarm is Ownable {
    ...
    function tokenIsAllowed(address _token) public returns (bool) {
        for (
            uint256 allowededTokensIndex = 0;
            allowededTokensIndex < allowedTokens.length;
            allowededTokensIndex++
        ) {
            if (allowedTokens[allowededTokensIndex] == _token) {
                return true;
            }
        }
        return false;
    ...
    // 50 ETH 50 DAI staked, we give 1 Dapp / 1 DAI
        ...
        for (
            ...
            totalValue =
                ...
                getUserSingleTokenValue(
                    _user,
                    allowedTokens[allowededTokensIndex]
                );
        }
        return totalValue;
    }
        ...
        returns (uint256)
    {
        ...
        // price of the token * stakingBalance[_token][_usr]
