...
contract CCML is ERC721, ERC721Enumerable, Ownable {
    ...
    string public notRevealedUri = "https://not-revealed.com";
    ...
    // TODO set notRevealedURI default in the contract to save gas on deployment
    ...
    function preSaleMint(uint256 numTokens) external payable {
        ...
        require(tokenPrice * numTokens <= msg.value, "CCML: Ether value sent is not correct");
