...
contract LiquidationHelper is AaveFlashLoanReceiverBaseV2, Withdrawable {
    ...
    constructor(
        ...
        IBSVault _warpVault
    ) public AaveFlashLoanReceiverBaseV2(_aaveAddressProvider) {
    ...
    function _swapTokensForExactTokens(
        ...
        uint256 original = IERC20(assetToSwapFrom).balanceOf(address(this));
        ...
        amountToSwapped = original - IERC20(assetToSwapFrom).balanceOf(address(this));
    }
...
import {IAaveFlashLoanReceiverV2} from "../../interfaces/aaveV2/IAaveFlashLoanReceiverV2.sol";
import {
    IAaveLendingPoolAddressesProviderV2
} from "../../interfaces/aaveV2/IAaveLendingPoolAddressesProviderV2.sol";
import {IAaveLendingPoolV2} from "../../interfaces/aaveV2/IAaveLendingPoolV2.sol";

abstract contract AaveFlashLoanReceiverBaseV2 is IAaveFlashLoanReceiverV2 {
    using SafeERC20 for IERC20;

    IAaveLendingPoolAddressesProviderV2 public immutable override ADDRESSES_PROVIDER;
    IAaveLendingPoolV2 public immutable override LENDING_POOL;

    constructor(address provider) {
        ADDRESSES_PROVIDER = IAaveLendingPoolAddressesProviderV2(provider);
        LENDING_POOL = IAaveLendingPoolV2(
            IAaveLendingPoolAddressesProviderV2(provider).getLendingPool()
        );
    }
