...
function contribution(uint256 amount) payable public{

    require(amount>= minimumContribution, "You need to meet the minimum contribution");
    require(block.timestamp>startTime && block.timestamp<deadline, "Sorry the fund raising is over");
    addressToAmountContributed[msg.sender]+= amount ;
