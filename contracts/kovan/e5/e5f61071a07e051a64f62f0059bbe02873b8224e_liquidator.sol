...
contract liquidator is ReentrancyGuard {
    ...
    constructor(address _vaultContract, address _usdp) {
        admin = msg.sender;
    ...
    function checkValid( uint256 _vaultId ) public view returns(bool, uint256, uint256, uint256) {
        ...
        // halfDebt is in dollar value (usdp tokens assumed to be $1). Convert to Matic amount;
    ...
    function checkUSDPBalance(address _address) public view returns (uint256){
    ...
    function liquidateVault(uint256 _vaultId) public nonReentrant {
        ...
        // check usdp balance of contract;
