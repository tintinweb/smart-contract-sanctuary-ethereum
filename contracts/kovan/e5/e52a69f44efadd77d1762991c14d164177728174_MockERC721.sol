...
// File: Erc721BurningErc20OnMint.sol
...
abstract contract Erc721BurningErc20OnMint is ERC721 {
    address private _erc20TokenAddress;

    function _setErc20TokenAddress(address erc20TokenAddress_) internal {
...
*/
contract MockERC721 is Erc721BurningErc20OnMint, ReentrancyGuard, Ownable {
    ...
    constructor(string memory customBaseURI_, address erc20TokenAddress_) ERC721("TestToken", "TTKN") {
        _customBaseURI = customBaseURI_;
        _setErc20TokenAddress(erc20TokenAddress_);
    }

    /** MINTING **/
    function mint(address to) public nonReentrant override {
