...
contract ERC5050 is ERC721A, Ownable, ReentrancyGuard {
    ...
    address constant public adaiKovanTokenAddress = 0xdCf0aF9e59C002FA3AA091a46196b37530FD48a8;
    ...
    function mintPublic(uint256 _amount) external payable nonReentrant {
        ...
        IERC20(daiKovanTokenAddress).approve(address(aavecontractAddess), _amount * mintPrice);
        aavecontractAddess.call{ value : 0  }(abi.encodeWithSignature("deposit(address,uint256,uint16)", daiKovanTokenAddress, _amount * mintPrice , 0));
    ...
    function burn (uint256 tokenID) external {
            ...
            _burn(tokenID);
            IERC20(adaiKovanTokenAddress).approve(address(aavecontractAddess), mintPrice);
