...
contract MerkleRewardsDistributor is Ownable, ReentrancyGuard {
    ...
    function claim(
        ...
        require(
            isInState(leafIndex,userAddress, amountToClaim, merkleProof),
    ...
    function isInState(
        ...
        return _verify(_leaf(leafIndex, userAddress, amountToClaim), merkleProof);
    }
    ...
    ///@dev returns a node of the tree
    function _leaf(
        uint256 leafIndex,
        address account,
        uint256 amountToClaim
    ) internal view returns (bytes32) { //TODO: Return to pure
        console.log("leafidx: ");
        console.log(leafIndex);
        console.log("Amount to claim: ");
        console.log(amountToClaim);
        console.log("Acc: ");
        console.log(account);
        console.log("Leaf hash: ");
        console.logBytes32(keccak256(abi.encodePacked(leafIndex, amountToClaim, account)));
        console.log("On-chain encodePacked");
        console.logBytes(abi.encodePacked(leafIndex, amountToClaim, account));
        return keccak256(abi.encodePacked(leafIndex, account, amountToClaim));
    }
...
library MerkleProof {
    ...
    function verify(
        ...
        bytes32 onChainRoot = processProof(proof, leaf);
        console.log("Root obtained on-chain: ");
        console.logBytes32(onChainRoot);
