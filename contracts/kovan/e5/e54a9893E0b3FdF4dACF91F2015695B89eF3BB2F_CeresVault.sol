...
contract CeresVault is ICeresVault, Ownable {
    ...
    modifier onlyBank() {
        require(msg.sender == bank, "CeresVault: Only Bank!");
        _;
    }

    constructor(address _owner, address _bank) Ownable(_owner){
        bank = _bank;
    }

    /* ---------- Functions ---------- */
    function claimFromBank(address staking, address token, uint256 amount) external override onlyBank {
