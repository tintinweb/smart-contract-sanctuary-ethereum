...
contract ContributorLender is Ownable {
    ...
    // Get lending pool
    function getLendingPool() public {
        poolAddress = IPoolAddressesProvider(poolProvider).getPool();
    ...
    function poolDeposit(address _token, uint256 _amount) public onlyOwner {
        IERC20(_token).transferFrom(address(this), address(poolAddress), _amount);
    }
