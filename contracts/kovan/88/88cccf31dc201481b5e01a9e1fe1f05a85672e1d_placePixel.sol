...
contract placePixel is ERC721URIStorage {
    ...
    function lock(bytes32 packedCoordinates) external payable returns(bytes32 quesitonID){
        ...
        string memory question= string(abi.encodePacked(Strings.toString(x),"\xE2\x90\x9F",Strings.toString(y),"\xE2\x90\x9F",Strings.toString(xx),"\xE2\x90\x9F",Strings.toString(yy)));
        // templateID = 54 for mainnet
        // 20 for kovan
        bytes32 questionID = reality.askQuestion(20, question, arbitrator, challengePeriod, 0, block.number);
    ...
    function executeRuling(bytes32 questionID, bytes32 packedCoordinates, address requester, uint256 blocknumber) external{
        uint64 yy = uint64(uint256(packedCoordinates));
        uint64 xx = uint64(uint256(packedCoordinates >> 64));
        uint64 y = uint64(uint256(packedCoordinates >> 128));
        uint64 x = uint64(uint256(packedCoordinates >> 192));
        ...
        bytes32 content_hash = keccak256(abi.encodePacked(uint256(20), uint256(0), question));
        bytes32 question_id_calculated = keccak256(abi.encodePacked(content_hash, arbitrator, challengePeriod, uint256(0), reality, requester, blocknumber));
    ...
    function burn(bytes32 questionID, bytes32 packedCoordinates, uint256 blocknumber) external{
        uint64 yy = uint64(uint256(packedCoordinates));
        uint64 xx = uint64(uint256(packedCoordinates >> 64));
        uint64 y = uint64(uint256(packedCoordinates >> 128));
        uint64 x = uint64(uint256(packedCoordinates >> 192));
        ...
        // templateID = 54 for mainnet, 20 for kovan
        bytes32 content_hash = keccak256(abi.encodePacked(uint256(20), uint256(0), question));
        bytes32 question_id_calculated = keccak256(abi.encodePacked(content_hash, arbitrator, challengePeriod, uint256(0), reality, msg.sender, blocknumber));
        if(questionID != question_id_calculated) { revert AuthenticationFailure();}
