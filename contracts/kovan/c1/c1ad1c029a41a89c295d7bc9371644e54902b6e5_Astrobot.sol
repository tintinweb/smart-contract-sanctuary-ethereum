    ...
    OwnableUpgradeable
{
    ...
    function mint(address _user, uint256 quantity) external whenNotPaused {
        require(
            saleSupply >= saleMinted + quantity,
            "mint: Sale completed"
        );
        require(
     ...
     */
    function updateAirdropAddresses(address[] memory _addresses, uint256[] memory _quantity) external onlyOwner {
        require(
    ...
    function airdropClaim()
        ...
        whenNotPaused
    {
        require(airdropSupply >= airdropMinted + userAirdropMints[msg.sender], "claim: All minted");
