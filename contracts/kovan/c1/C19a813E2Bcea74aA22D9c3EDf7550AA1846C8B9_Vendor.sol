...
contract Vendor is Ownable {
    ...
    function buyTokens() public payable {
        ...
        // check balance of this erc20 in this contract
        require(
            yourToken.balanceOf(address(this)) >= amountOfTokens,
            "not enough tokens"
        );
        require(amountOfTokens > 0, "must be non-zero amount");
    ...
    function sellTokens(uint256 amountToSell) public payable {
        require(amountToSell > 0, "amount must greater than 0");
        require(
            amountToSell / tokensPerEth <= address(this).balance,
            "not enough liquidity"
        );
        /*uint256 allowance = yourToken.allowance(msg.sender, address(this));
        require(allowance >= amountToSell, "exceeded token allowance");*/
        ...
        emit SellTokens(msg.sender, amountToSell, amountOfEth);
    }
}
