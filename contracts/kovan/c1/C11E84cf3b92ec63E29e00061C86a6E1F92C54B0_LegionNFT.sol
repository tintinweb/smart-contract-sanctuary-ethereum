...
interface IFeeHandler {
    function getMarketPlaceTax() external view returns(uint);
}
...
contract FeeHandler is IFeeHandler {
    ...
    uint buyTax;
    uint sellTax;
    uint damageForLegion;
    uint summonFee;
    uint supplyDiscountFee1;
    uint supplyDiscountFee2;
    uint denominator;
    constructor() {
        marketplaceTax = 1500;
        huntingTax = 250;
        ...
        damageForLegion = 200;
        summonFee = 20;
        supplyDiscountFee1 = 12;
        supplyDiscountFee2 = 16;
        denominator = 10000;
    }
    function getMarketPlaceTax() external view override returns(uint) {
        return marketplaceTax;
    }
}
...
contract BeastNFT is Context, IBeastNFT, Ownable {
    ...
    function buyToken(uint256 tokenId) external {
        ...
        uint marketplaceTax = feehandler.getMarketPlaceTax();
