...
contract ERC721Token is ERC721Enumerable, ERC721URIStorage, AccessControl {
    mapping (bytes32 => uint256) private _tokenIdByTokenUri;
    ...
    function _burn (uint256 tokenId) internal override(ERC721, ERC721URIStorage) {
        ...
        _tokenIdByTokenUri[keccak256(abi.encode(tokenUri))] = 0;
    ...
    function mint (
    ...
    ) external hasRole('admin') returns (bool) {
        require(
            _tokenIdByTokenUri[keccak256(abi.encode(tokenUri))] == 0,
        ...
        _tokenIdByTokenUri[keccak256(abi.encode(tokenUri))] = tokenId;
        return true;
    }
    ...
    function tokenIdByTokenUri (
        ...
        return _tokenIdByTokenUri[keccak256(abi.encode(tokenUri))];
    }
}
