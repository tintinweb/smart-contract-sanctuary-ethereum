...
contract Frenky is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Frenky Inu";
    ...
    address payable private _marketingAddress = payable(0x759198b8E504fe5aE8A76e484a3e9e173A0096D8);
