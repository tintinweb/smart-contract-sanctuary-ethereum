...
contract TokenFarm is Ownable{
    // mapping tokenaddress -> stacker address -> amount
    // we cannot loop through an mapping
    ...
    // 50 ETH + 50 DAI staked and we give a reward of 1 DAPP / 1 DAI
    ...
    function getUserTotalValue(address _user) public view returns(uint256){
        ...
        for(
            ...
            totalValue = totalValue + getUserSingleToken(_user, allowedTokens[allowedTokenIndex]);
        }
        return totalValue; 
    }
    ...
    function unStakeTokens(address _token) public {
        ...
        require (balance > 0, "Staking balance must be great than zero !");
