...
contract LegionNFT is Context, ILegionNFT, Ownable {
    ...
    event Hunted(address indexed _addr, string name, uint256 legionId, uint256 monsterId, uint256 roll, uint256 percent, bool success);
    ...
    function hunt(uint256 tokenId, uint8 monsterId) public {
        ...
        emit Hunted(msg.sender, tokenData[tokenId].name, tokenId, monsterId, randnum, percent, retval);
