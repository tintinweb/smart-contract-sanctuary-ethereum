...
contract GachaGame {
    ...
    function showMyPublicKey() public view returns(address){
        return msg.sender;
    }
    ...
    function showGachapull(address userAddress)public view returns(uint common,uint rare,uint epic,uint legendary){
