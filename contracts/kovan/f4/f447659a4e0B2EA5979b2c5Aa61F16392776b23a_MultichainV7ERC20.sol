    ...
    AccessControlEnumerable
{
    ...
    function setAllMintPaused(bool paused)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function setAllBurnPaused(bool paused)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function setAllMintAndBurnPaused(bool paused)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        allMintPaused = paused;
    ...
    function setMintPaused(address minter, bool paused)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(hasRole(MINTER_ROLE, minter), "not minter");
    ...
    function setBurnPaused(address minter, bool paused)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(hasRole(MINTER_ROLE, minter), "not minter");
    ...
    function setMintAndBurnPaused(address minter, bool paused)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(hasRole(MINTER_ROLE, minter), "not minter");
...
contract MultichainV7ERC20WithUnderlying is MultichainV7ERC20 {
    ...
    constructor(
        ...
        require(
            ...
            "underlying is same to address(this)"
        );
        require(
