...
contract TestingTheory is Context, IERC20, IERC20Metadata, Ownable {
    ...
    bool public SnipersActive = false;
    ...
    constructor() {
        // Editable
        _name = "Testing Theory";
        _symbol = "TestT";
        uint e_totalSupply = 5_000_000_000 ether;
        // End editable
    ...
    function setsnipersactive
    (bool value) external onlyOwner {
        SnipersActive = value;
    }
