...
// File: contracts/interfaces/ICricStoxTreasury.sol
...
// File: contracts/interfaces/ICricStoxCurve.sol
interface ICricStoxCurve {
    function lookupPrice(uint256 totalSupply) external view returns (uint256);
}

// File: contracts/interfaces/ICricStoxOrderHistory.sol
...
// File: contracts/interfaces/IPlayerStoxToken.sol
...
// File: contracts/CricStoxMaster.sol
contract CricStoxMaster {
    ...
    function quote(address stox_, uint256 quantity_, TradeType tradeType_) public view returns (uint256) {
        ...
        if (tradeType_ == TradeType.BUY) {
            ...
            totalSupply = totalSupply.sub(quantity_);
        }
