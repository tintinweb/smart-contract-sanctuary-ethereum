...
contract Erc20AssetFactory is AssetFactory {
    ...
    function setOwnerAsset(uint256 positionId, address contractAddress)
        external
    {
        _setOwnerAsset(positionId, createAsset(positionId, contractAddress));
    }

    function setOutputAsset(uint256 positionId, address contractAddress)
        external
    {
        _setOutputAsset(positionId, createAsset(positionId, contractAddress));
    }

    function createAsset(uint256 positionId, address contractAddress)
        internal
...
contract Erc20Asset is AssetBase {
