...
contract Lottery is Ownable, VRFConsumerBase {
    ...
    function enter() public payable {
        ...
        require(lottery_state == LOTTERY_STATE.OPEN, "lottery is closed now");
    ...
    function startLottery() public onlyOwner {
        require(lottery_state == LOTTERY_STATE.CLOSED, "lOTTERY IS GOING ON");
    ...
    function endLottery() public onlyOwner {
        ...
        require(randomResult > 0, "Random Number not Found");
