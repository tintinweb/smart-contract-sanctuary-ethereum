 ...
 */
contract LaLukaERC20 is ERC20Upgradeable, IBurnableMintableERC677Token, ERC20PausableUpgradeable, Ownable, Blacklistable, Rescuable  {
   ...
   */
     ...
     */
    function mint(address _to, uint256 _amount) public whenNotPaused onlyOwnerOrBridge returns (bool){
        _mint(_to, _amount);
        return true;
    }
