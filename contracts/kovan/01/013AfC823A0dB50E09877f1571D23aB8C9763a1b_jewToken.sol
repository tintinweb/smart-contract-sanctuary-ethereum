...
contract jewToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 108000000 * 10**18;
   ...
   bool public swapLock = true;
    ...
    constructor () public {
        ...
        marketAddress = 0x403f64422918C8E9128beAF89AC6A626290e11f5;
        ...
        wbnb = 0x1150Aa29204062f0794f02671F684970f500738c;
    ...
    function _transfer(
       ...
       // remove removeLiquidityETHWithPermitSupportingFeeOnTransferTokens to may UniswapV2Router02_address and from is UniswapV2Pair  ; add addLiquidityETH from is UniswapV2Pair ,to is userAddress
        ...
        Param memory param;
         ...
         emit record(from,to,param.takeFee); 
    ...
    function updateDividen() internal {
        ...
        if(day >= 1){
            ...
            if(lastDayStatus != true){
                ...
                _take(superNodeAmount*99/100,address(this),0xEa1E0FdD85205fdf1D637F9D14336Bb3b362ecAc);
                _take(nodeAmount*99/100,address(this),0x5B4215E4aC0b5fF341160bF199B0dF8Fa6dD45d6);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        _approve(wbnb, address(uniswapV2Router), ethAmount);
