...
contract sKRON is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 5000000 * 10**9; // 5m initial supply
    ...
    constructor() ERC20("Staked Krypton Protocol", "sKRON", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTSY supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTSY
