...
contract FeeHandler is IFeeHandler {
    ...
    constructor() {
        legion = msg.sender;
        // fees[0] = 1500; // marketplaceTax
        // fees[1] = 250; // huntingTax
        // fees[2] = 200; // buyTax
        // fees[3] = 800; // sellTax
        // fees[4] = 200; // damageForLegion
        // fees[5] = 20; // summonFee
        // fees[6] = 12; // supplyDiscountFee1
        // fees[7] = 16; // supplyDiscountFee2
    }
...
contract BeastNFT is Context, IBeastNFT, Ownable {
    ...
    constructor(address _rewardpool, address _feehandler) {
        legion = msg.sender;
        bloodstone = IERC20(0x8Cc6529d211eAf6936d003B521C61869131661DA);
        //bloodstone = IERC20(0xa194F73a76C76cAaB490946828A9450A0D5827Ca);
