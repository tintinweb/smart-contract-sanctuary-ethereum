...
contract UniswapFlash is 
    ...
    function uniswapV3FlashCallback(
        ...
        uint256 balance0 = IERC20(tradeAssets[0]).balanceOf(address(this));
        require(amountOut != balance0, Helpers.getMessageUint("amount:", amountOut));
        ...
        uint256 balance1 = IERC20(tradeAssets[1]).balanceOf(address(this));
        require(amountOut == balance1, Helpers.getMessageUint("swaped amount:", amountOut));
