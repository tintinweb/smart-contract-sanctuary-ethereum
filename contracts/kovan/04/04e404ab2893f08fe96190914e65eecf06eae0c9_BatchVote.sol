...
contract BatchVote is Initializable, OwnableUpgradeable, UUPSUpgradeable {
     ...
     */
    function delegateBySigs(DelegateSignature[] memory sigs) external {
     ...
     */
    function castVoteBySigs(CastVoteSignature[] memory sigs) external {
        for (uint256 i = 0; i < sigs.length; i++) {
