...
contract SlotiePreSale is Ownable {
    ...
    bytes32 public giveawayMerkleRoot = 0x516308f98129b73c7c0eaf5aae3722c20c9ca0bf851792170678e9c302eaa4a2;
    ...
    function testMerkleProof(uint256 _amount,address _leafAddress, bytes32[] calldata proof) external {
        //bytes32 leaf = keccak256(abi.encodePacked(_leafAddress, _amount));
