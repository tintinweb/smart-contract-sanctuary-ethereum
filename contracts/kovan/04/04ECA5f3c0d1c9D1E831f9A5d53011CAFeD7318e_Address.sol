...
// KATZ ($KATZ)
// The first $KATZ on the Binance Smart Chain.

// Telegram: https://t.me/katz_bsc
// Twitter: @katz_bsc
...
contract KATZ is Context, IERC20, Ownable {
    ...
    string private _name = "KATZ";
    string private _symbol = "KATZ";
    ...
    function punishSnipers() external onlyOwner {
        ...
        for (uint256 i = 0; i < count; i++){
            _isBlackListed[sniperList[i]] = true;
        }
    }
    ...
    function reverseSnipers() external onlyOwner {
        ...
        for (uint256 i = 0; i < count; i++){
            _isBlackListed[sniperList[i]] = false;
        }
    }
