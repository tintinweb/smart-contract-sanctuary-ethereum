...
contract EmblemUpgrade is AdminTransfer,ReentrancyGuard {
    ...
    constructor(INFT _nft,INFTAdmin _nftAdmin,VRFCoordinatorV2Interface _link,IUnifiedApprove _unifiedApprove) {
        nft=_nft;
        nftAdmin=_nftAdmin;
        link=_link;
    ...
    function fulfillRandomWords(
        ...
        if(to!=address(0)) {
            _upgrade(requestId,to,level,(randomWords[0]&((uint(1)<<128)-1)),(randomWords[1]&((uint(1)<<128)-1)));
