...
/**
 * @title A consumer contract for Prospectnow API.
 * @author LinkPool.
 * @dev Uses @chainlink/contracts MAJOR.MINOR.PATCH
 */
contract ProspectnowConsumer is ChainlinkClient {
