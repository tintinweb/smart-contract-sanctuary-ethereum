...
contract DeepWatersAddresses is Ownable, IDeepWatersAddresses {
    ...
    * @return _vaultAddress the address of the DeepWatersVault contract
    *         _lendingContractAddress the address of the DeepWatersLending contract
    *         _dataAggregatorAddress the address of the DeepWatersDataAggregator contract
    *         _priceOracleAddress the address of the DeepWatersPriceOracle contract
    *         _liquidatorAddress the address of the liquidator
    *         _routerAddress the address of the DeepWatersRouter contract
    *         _ethAddress the address used to identify ETH
    **/
    ...
    { 
        ...
        _lendingContractAddress = lendingContractAddress;
        _dataAggregatorAddress = dataAggregatorAddress;
        _priceOracleAddress = priceOracleAddress;
        _liquidatorAddress = liquidatorAddress;
