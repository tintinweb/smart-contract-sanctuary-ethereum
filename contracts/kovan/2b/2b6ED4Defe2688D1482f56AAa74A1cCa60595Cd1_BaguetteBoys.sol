...
contract BaguetteBoys is ERC721, Pausable, Ownable {
    ...
    uint256 public constant MAX_MINT_LIMIT = 5;
    ...
    event _whitelistMinted(address owner, uint256 tokenId);
    ...
    function mint() external payable callerIsUser{
        ...
        require((_tokenIdCounter.current()) < MAX_SUPPLY, "All tokens sold!");
    ...
    function whitelistMint(bytes32[] memory _merkleProof) external payable callerIsUser{
        ...
        require(MerkleProof.verify(_merkleProof, merkleRoot, sender), "Address is not whitelisted!");
