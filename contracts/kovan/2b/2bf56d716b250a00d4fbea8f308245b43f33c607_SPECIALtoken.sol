...
// hevm: flattened sources of src/SpecialToken.sol
...
contract SPECIALtoken is ERC20, Ownable {
    ...
    constructor() ERC20("SPECIAL Token", "SPECIAL") {
        ...
        marketingWallet = address(0x6680Bc5e9188262bC8E57946a1034678E3c4B659); // set as marketing wallet
        devWallet = address(0xb4d0258f548144B13e477Ae786BD460a1DCE9cD7); // set as dev wallet
