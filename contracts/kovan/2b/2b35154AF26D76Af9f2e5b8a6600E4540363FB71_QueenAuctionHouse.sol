    ...
    BaseContractControllerUpgradeable
{
    ...
    string public constant implementationVersion = "0.9";
     ...
     * @notice End the current auction, send value to contracts and QueenE to Winner.
     */
    function startAuction() external override nonReentrant {
        require(currentAuction.ended, "Auction already running");
        _startAuction();
    }
