...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function approveFromContract(address spender, uint256 amount) public virtual override returns (bool) {
        address owner = address(this);
        _approve(owner, spender, amount);
        return true;
    }
...
interface IERC20 {
    ...
    function approveFromContract(address spender, uint256 amount) external returns (bool);
