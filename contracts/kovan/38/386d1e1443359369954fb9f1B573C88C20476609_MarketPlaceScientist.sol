...
contract MarketPlaceScientist is IAdmin, Ownable, IMarketPlaceScientist {
    ...
    constructor(address _scientistToken) {
        ...
        override
    {
        ...
        ScientistData.Scientist memory scientist = IScientistRepository(scientistToken)
            .getScientist(_tokenId);

        require(msg.value == scientist.price, "Incorrect price");

        scientist.onSale = false;
        IScientistRepository(scientistToken).updateScientist(scientist, _oldOwner);
    ...
    function updateScientistPrice(uint _tokenId, uint _newPrice) external override {
        ...
        IScientistRepository(scientistToken).updateScientist(scientist, msg.sender);
