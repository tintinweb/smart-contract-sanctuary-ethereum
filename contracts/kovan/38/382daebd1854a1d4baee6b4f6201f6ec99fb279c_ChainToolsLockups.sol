...
/*
 * @title ChainTools.app Token&Liquidity Lockups
 * @dev To Use this Dapp: https://chaintools.app
*/
...
contract UpgradeabilityProxy is Proxy {
  ...
  bytes32 private constant implementationPosition = keccak256("chaintools.app.proxy.implementation");
...
pragma solidity 0.4.24;
/**
 * @title ChainToolsLockups
 * @dev This contract combines an upgradeability proxy with basic authorization control functionalities
 */
contract ChainToolsLockups is UpgradeabilityProxy {
  /**
  ...
  */
  ...
  bytes32 private constant proxyOwnerPosition = keccak256("chaintools.app.proxy.owner");
