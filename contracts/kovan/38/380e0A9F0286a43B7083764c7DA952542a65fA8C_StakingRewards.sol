...
contract StakingRewards is Pausable {
  ...
  function stake(uint256 _amount) whenNotPaused external {
   ...
   **/
  function withdraw(uint256 _amount, bool isClaimAllRewards) public returns (bool) {
    require(_amount != 0, 'INVALID_ZERO_AMOUNT');
  ...
  function getNextCooldownTimestamp(
    ...
    cooldowns[_toAddress] = toCooldownTimestamp;
    return toCooldownTimestamp;
  }   
...
contract BALRewardPool {// is ReentrancyGuard {
    ...
    function withdrawFor(address _for, uint256 amount) public updateReward(_for) returns(bool) {
