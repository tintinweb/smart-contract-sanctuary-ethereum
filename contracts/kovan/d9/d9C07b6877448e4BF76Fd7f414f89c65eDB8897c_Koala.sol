...
contract Koala is Context, IERC20, Ownable {
    ...
    string private constant _name = "Koala in the air v5";
    string private constant _symbol = "KAIRv5";
    ...
    constructor(
        ...
        _feeAddrWallet3 = payable(wallet3);
        ...
        isExcludedFromFee[_feeAddrWallet3] = true;
        ...
        isExcludedFromLimit[_feeAddrWallet3] = true;
