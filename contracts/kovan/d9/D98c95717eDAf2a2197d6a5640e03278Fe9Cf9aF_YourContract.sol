...
contract YourContract is ChainlinkClient, ConfirmedOwner {
  ...
  string public catFact = 'Owning a cat is actually proven to be beneficial for your health.';
   ...
   */
  function fulfill(bytes32 _requestId, string memory _catFact) public recordChainlinkFulfillment(_requestId) {
    catFact = _catFact;
