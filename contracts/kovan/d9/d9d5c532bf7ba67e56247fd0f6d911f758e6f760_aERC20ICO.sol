...
// The aERC20 Token Contract
contract aERC20 is ERC20Interface {
    string public name = "aERC20";
...
contract aERC20ICO is aERC20 {
        ...
        returns (bool success)
    {
        ...
        super.transfer(to, tokens); // same as aERC20.transfer(to, tokens);
        return true;
    }
    ...
    function transferFrom(
        ...
        aERC20.transferFrom(from, to, tokens); // same as super.transferFrom(to, tokens);
        return true;
    }
}