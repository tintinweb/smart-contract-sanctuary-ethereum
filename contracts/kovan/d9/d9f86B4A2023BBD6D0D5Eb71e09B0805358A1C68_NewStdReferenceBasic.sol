...
/// @title BandChain NewStdReferenceBasic
/// @author Band Protocol Team
contract NewStdReferenceBasic is AccessControl, StdReferenceBase {
    event RefDataUpdate(
        string symbol,
        uint64 rate,
        uint64 resolveTime,
    ...
    /// @param resolveTime A list of timestamps of when the rate data was retrieved
    /// @param requestID A list of BandChain request IDs in which the rate data was retrieved
    function relay(
