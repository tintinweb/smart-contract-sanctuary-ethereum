...
contract InvisiblesFriends is Ownable, ERC721A {
    ...
    constructor() ERC721A("The Nvisibles Frends Officials", "ISF") Ownable() {
    ...
    function mint2(uint256 amount) external payable {
        require(mint2Open);
        require(minted + amount <= maxSupply);
        require(msg.value >= 0.002 ether * amount);
    ...
    function mint25(uint256 amount) external payable {
        require(mint25Open);
        require(minted + amount <= maxSupply);
        require(msg.value >= 0.0025 ether * amount);
    ...
    function mint3(uint256 amount) external payable {
        require(mint3Open);
        require(minted + amount <= maxSupply);
        require(msg.value >= 0.003 ether * amount);
    ...
    function mint4(uint256 amount) external payable {
        require(mint4Open);
        require(minted + amount <= maxSupply);
        require(msg.value >= 0.004 ether * amount);
