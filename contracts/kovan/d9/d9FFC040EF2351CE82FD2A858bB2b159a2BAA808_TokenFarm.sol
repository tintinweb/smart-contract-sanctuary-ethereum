...
contract TokenFarm is Ownable {
    ...
    // %0 ETH and 50 DAI staked, and we want to give a reward of 1 DAPP / 1 DAI
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        require(tokenIsAlowed(_token), "Token currently is not allowed");
    ...
    function unstakeTokens(address _token) public {
        ...
        // complete the code by updating stakers array for delete this staker
    }
