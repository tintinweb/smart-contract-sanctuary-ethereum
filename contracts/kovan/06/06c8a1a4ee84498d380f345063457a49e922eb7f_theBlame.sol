...
contract theBlame {
    ...
    function getBlameDetail(uint256 _id) public view returns (string memory, string memory, uint256) {
    ...
    function deleteBlame(uint256 blameId) public {
    ...
    function boostBlame(uint256 _blameId) public {
        require(_blameId<=blameCount-1,"There is no blame for the id you specified.");
        require( 
