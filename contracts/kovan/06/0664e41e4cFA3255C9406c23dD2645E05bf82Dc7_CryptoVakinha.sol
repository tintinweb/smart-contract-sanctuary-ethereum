...
contract CryptoVakinha {
    ...
    function getConversionRate(uint256 ethWeiAmount) public view returns (uint256) {
        ...
        uint256 mult = (ethWeiAmount * ethPriceInUsdWei);
        uint256 ethAmountInUsd = mult / (10 ** 18);
    ...
    function dollarsToWei(uint256 dollarAmount) public view returns (uint256) {
        ...
        //then we add +1 because the previous division truncates down and ends up failing our minimum funding requirement.
        //This is a trivial price to pay (<$0.0001) so there shouldn't be any problem in practice
        return dollarsInEthWei + 1;
    }
