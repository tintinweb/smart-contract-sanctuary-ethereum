...
contract Flashloan is FlashLoanReceiverBase {
    ...
    event repaymentAmount(address _from, address _reserve, uint _totalDebt);
    ...
    */
        ...
        override
    {
        ...
        emit repaymentAmount(address(this), _reserve, totalDebt);
     ...
     */
    function flashloan(address lendingPoolAddr, address _asset, bytes memory data) public onlyOwner {
        uint amount = 1 ether;
