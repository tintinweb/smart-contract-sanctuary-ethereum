...
contract ShaddaiToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Shaddai Token";
    string private _symbol = "I AM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0DBC567D408bA127B96e2b1CdD43b8e86157b477);
    ...
    uint256 public _maxTxAmount =   _totalSupply.mul(5).div(1e3);  //0.5%
    uint256 public _walletMax =     _totalSupply.mul(2).div(1e2);   //2%
