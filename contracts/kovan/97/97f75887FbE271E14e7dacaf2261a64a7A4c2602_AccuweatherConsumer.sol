...
contract AccuweatherConsumer is ChainlinkClient {
    ...
    function requestLocation(
        ...
        Chainlink.Request memory req = buildOperatorRequest(_specId, this.fulfillLocation.selector);
        ...
        _storeRequestParams(requestId, 0, "location", _lat, _lon, "");
    }
    ...
    function requestCurrentConditions(
        ...
        Chainlink.Request memory req = buildOperatorRequest(_specId, this.fulfillCurrentConditions.selector);
        ...
        // Below this line is just an example of usage
        _storeRequestParams(requestId, _locationKey, "current-conditions", "0", "0", _units);
    }
    ...
    function requestLocationCurrentConditions(
        ...
        Chainlink.Request memory req = buildOperatorRequest(_specId, this.fulfillLocationCurrentConditions.selector);
        ...
        // Below this line is just an example of usage
        _storeRequestParams(requestId, 0, "location-current-conditions", _lat, _lon, _units);
    }
    ...
    function _storeLocationResult(bytes32 _requestId, bytes memory _locationResult) private {
        LocationResult memory result = abi.decode(_locationResult, (LocationResult));
        requestIdLocationResult[_requestId] = result;
    }

    function _storeCurrentConditionsResult(bytes32 _requestId, bytes memory _currentConditionsResult) private {
