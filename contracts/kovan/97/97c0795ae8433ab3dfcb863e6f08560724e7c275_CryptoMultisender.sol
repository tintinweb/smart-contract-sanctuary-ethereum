...
contract CryptoMultisender is Ownable {
    ...
    **/
     ...
     * @return success true if function executes successfully, false otherwise.
     * */    
    function erc20Airdrop(address _addressOfToken,  address[] memory _recipients, uint256[] memory _values, uint256 _totalToSend, bool _optimized, string memory _afCode) public payable returns(bool success) {
