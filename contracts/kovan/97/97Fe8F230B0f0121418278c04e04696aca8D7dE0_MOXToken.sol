    ...
    AccessControlUpgradeable
{
    ...
    function initialize(uint256 _buyFee,uint256 _sellFee,address _feeTo,address _router,address _token) public initializer {
        __AccessControl_init();
        __ERC20_init("MOX", "MOX");
    ...
    function mintToken(address receiptor, uint256 amount)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        _mint(receiptor, amount);
    }
    ...
    function _transfer(
        ...
        _balances[feeTo] = _balances[to] + fee;
