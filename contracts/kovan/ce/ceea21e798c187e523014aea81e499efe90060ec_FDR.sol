...
contract FDR is Context, IERC20, Ownable {
    ...
    string private constant _name = "Foundation Defense Against Rug";
    string private constant _symbol = "FDR";
    ...
    constructor () {
        _feeAddrMarketing = payable(0xa86AD65959fcA5fd92b78cb601aE6c2626415C84);
        _feeAddrTeam = payable(0x4D1de6d2ea988AA81A6196BFCe82a1a40bcD092e);
