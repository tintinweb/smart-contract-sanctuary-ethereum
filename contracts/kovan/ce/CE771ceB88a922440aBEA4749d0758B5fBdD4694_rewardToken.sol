...
contract rewardToken is ERC20Upgradeable, ChainlinkClient, OwnableUpgradeable {
   ...
   ERC20Upgradeable public token;
    ...
    // mapping (address=>mapping(string=>mapping(string=>bool))) public isClaimed;
    mapping(address=>mapping(string=>bool)) public isClaimed;
    ...
    {
        require(msg.sender==dataUrl,"!owner");
        require(!isClaimed[dataUrl][id],"already Rewards Taken");
