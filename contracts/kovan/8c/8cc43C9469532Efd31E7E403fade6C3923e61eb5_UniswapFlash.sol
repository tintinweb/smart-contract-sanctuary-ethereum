...
contract UniswapFlash is 
    ...
    function uniswapV3FlashCallback(
        ...
        string memory message0 = string(abi.encodePacked("loanAmount0: ", Strings.toString(loanAmount0)));
        string memory message1 = string(abi.encodePacked("loanAmount1: ", Strings.toString(loanAmount1)));
        require(
            loanAmount1 == 0,
            message1
        );
