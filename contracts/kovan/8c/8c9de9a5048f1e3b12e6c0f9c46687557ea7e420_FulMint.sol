...
contract FulMint is Ownable{
    ...
    event RemovedwhiteListedUserForFreeMint(string indexed RemoveFromWhitelist);
    event packIdMinted(uint256 indexed packid,uint256[] nftIDs );
    event burnNFTNewNFTMinted(uint256[] nftIDs, uint256 indexed NftId);
