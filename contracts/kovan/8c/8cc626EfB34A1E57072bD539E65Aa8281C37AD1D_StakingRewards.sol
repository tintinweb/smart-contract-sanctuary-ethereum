...
contract StakingRewards is ReentrancyGuard, Pausable {
  ...
  /// @notice maxFees
  uint256 public constant MaxFees = 3300;
  ...
  function configFees(uint128 _earmarkIncentive, uint128 _operationFee) external {
    require(msg.sender == OPERATOR, 'ONLY_OPERATOR');
    require(_earmarkIncentive.add(_operationFee) <= MaxFees, ">MaxFees");
    require(_earmarkIncentive >= 0 && _earmarkIncentive <= 300, "!earmarkIncentive");
    require(_operationFee >= 0 && _operationFee <= 3000, "!platformFee");
