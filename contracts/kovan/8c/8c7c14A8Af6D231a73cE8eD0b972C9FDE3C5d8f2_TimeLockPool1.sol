...
abstract contract AbstractRewards is IAbstractRewards {
    ...
    function(address) external view returns (uint256) private getSharesOf; // DELETE
    function() external view returns (uint256) private getTotalShares;// DELETE

    /* ========  Storage  ======== */
    uint256 public pointsPerShare;
    mapping(address => int256) public pointsCorrection;
    mapping(address => uint256) public withdrawnRewards;
    mapping(address => uint256) public amountPerUser; // Start like this but it doesn't work the use below
    // depositsOf[_account]; option to separate deposited amounts incluse withdrawn, delete points correction
