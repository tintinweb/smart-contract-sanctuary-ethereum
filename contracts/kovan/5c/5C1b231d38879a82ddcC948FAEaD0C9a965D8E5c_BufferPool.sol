...
contract BufferPool is IBufferPool, Ownable, OrumBase {
    ...
    function sendUSDC(address _receiver, uint _amount) external payable override returns (bool) {
        _callerIsLendingPoolOrBorrowerOps();
    ...
    function _callerIsLendingPoolOrBorrowerOps() internal {
        require(msg.sender == lendingPoolAddress, "BufferPool, sender is not Lending Pool");
    }
