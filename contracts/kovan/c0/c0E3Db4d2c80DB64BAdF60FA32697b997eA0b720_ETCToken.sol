...
contract ETCToken is Context, IERC20, IERC20Metadata ,  Ownable{
    ...
    constructor(
        ...
        usdtAddress =  IERC20(0x1150Aa29204062f0794f02671F684970f500738c);
        daoAddress = 0x7331224548Eae1d7c897C7f0b6449A2E04975cCd;
        lpAddresss = 0xf807d50fB90871a4e1e80a6A3EAA3832b57C4A22;
    ...
    function setdaoAddress(address daoAddress_) public onlyOwner{
    ...
    function setAuthorize(address _addr) public onlyOwner{
        
        if(authorize[_addr]){
            authorize[_addr] = false;
        }else{
            authorize[_addr] = true;
        }
    ...
    function casting(uint256 taxes,address _caller)  external  returns(bool){
        require(authorize[msg.sender], "unauthorized");
    ...
    function sellEtc(uint256 amount) external returns(bool){
        ...
        usdtAddress.transfer(daoAddress,daoUsdtIn);

        usdtAddress.transfer(lpAddresss,lpUsdtIn);
