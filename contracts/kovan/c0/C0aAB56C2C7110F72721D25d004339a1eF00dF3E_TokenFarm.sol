...
// 1. stake tokens
// 2. unstake tokens
// 3. add more tokens to be allowed to be staked
// 4. issue some reward tokens
// 5. get value of staked tokens
...
contract TokenFarm is Ownable {
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        require(
            ...
            "Token is currently not allowed to be staked"
        );
        // call transferFrom function to be then approved by the user
