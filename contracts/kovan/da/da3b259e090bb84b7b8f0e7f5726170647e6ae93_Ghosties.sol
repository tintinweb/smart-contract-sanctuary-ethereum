...
contract Ghosties is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ghosties", "GSTIES") {
    setHiddenMetadataUri("ipfs/QmT3Af1WNmCLyswqxdWibzD7JhCxcBMUazXNunAaf8MpH5/");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool os, ) = payable(0x2ea6e0D4c32Dd14d42E7d69d8128A5411F50d031).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
  }
