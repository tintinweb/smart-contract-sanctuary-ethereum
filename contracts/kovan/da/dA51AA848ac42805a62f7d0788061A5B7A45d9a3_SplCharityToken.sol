...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFromContract(address to, uint256 amount) public virtual override returns (bool) {
...
interface IERC20 {
    ...
    function transferFromContract(address to, uint256 amount) external returns (bool);
