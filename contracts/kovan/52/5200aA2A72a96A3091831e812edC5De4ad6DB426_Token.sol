...
contract Token {
    ...
    mapping(address => mapping(address => uint256)) public allowance; // Keep track balances and allowances approved

    event Transfer(address indexed from, address indexed to, uint256 value);  // Events - fire events on state changes etc
