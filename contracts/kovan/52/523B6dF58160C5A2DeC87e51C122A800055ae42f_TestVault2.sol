...
contract TestVault2 is VaultInterface {
    ...
    function balanceOf(address user_) public view override returns(uint256) {
        ...
        uint256 balance = s.amount + s.amount * (block.number - s.lastBlockNumber) * rewardGrowthSpeed / 20000; /// TODO for each block
        console.log("V - bal:", balance);
        return balance;
        // test
        // require(address(0x0) != user_, "user cannot be 0x0");
        // Stake storage s = stakesMapping[user_];
