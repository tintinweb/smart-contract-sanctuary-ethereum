...
interface IOrumToken is IERC20, IERC2612 {
    ...
    event ORUMStakingAddressSet(address _orumStakingAddress);
    ...
    function sendToContract(address _sender,  address _votedEscrowAddress, uint256 _amount) external;
...
contract VotedEscrow is IERC721, IERC721Metadata {
    ...
    * What we can do is to extrapolate ***At functions */
    ...
    constructor(
        ...
        orumToken = IOrumToken(token_addr);
    ...
    function _deposit_for(
        ...
        if (_value != 0 && deposit_type != DepositType.MERGE_TYPE) {
            orumToken.sendToContract(from, address(this), _value);
        }
