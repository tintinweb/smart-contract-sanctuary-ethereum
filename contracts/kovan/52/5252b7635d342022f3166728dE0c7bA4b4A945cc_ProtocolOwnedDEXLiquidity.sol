...
contract ProtocolOwnedDEXLiquidity is Ownable {
    ...
    IUniswapLPToken constant public lpToken = IUniswapLPToken(0xC4cbedE6C5cc7D0C775AdFC76803c5888c1530f0);
    IERC20 constant public gFTM = IERC20(0xC834Dde677cCc13c6F7Ce55Ca1ce0b7108f8ACC6);
    IMultiFeeDistribution constant public treasury = IMultiFeeDistribution(0xF3eaDbdf94c339B3FF8BD6a4ea2F450AE56Dcefe);
    ...
    constructor(
        ...
        IChefIncentivesController chef = IChefIncentivesController(0xbD2c44d70EaaCDB4A875dca8620E64BfAAa645D6);
    ...
    function availableForUser(address _user) public view returns (uint256) {
        ...
        uint userLocked = treasury.lockedBalancesUser(_user);
    ...
    function superPODL(uint256 _amount) public {
        require(treasury.lockedBalancesUser(msg.sender) >= minSuperPODLLock, "Need to lock GEIST!");
