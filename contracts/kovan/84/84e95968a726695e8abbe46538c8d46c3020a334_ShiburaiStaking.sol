...
contract ShiburaiStaking is Ownable {
    ...
    IERC20 public shiburaiToken;

    uint256 public constant PERCENT_DENOMINATOR = 100000;
    uint256 public constant YEAR = 360 * 10 seconds;   // 30 days for 1 Month
    uint256 public constant DAY = 10 seconds;
    ...
    uint256[3] public durations = [300 seconds, 900 seconds, 1800 seconds]; // lock durations
    uint256[3] public apyBonus = [120000, 180000, 240000];  
    ...
    function stake(uint256 amount, uint256 planIndex) public {
        ...
        shiburaiToken.transferFrom(msg.sender, address(this), amount);
    ...
    function withdraw(uint256 index) public {
        ...
        shiburaiToken.transfer(msg.sender, userStakeInfo.amount);
        shiburaiToken.transferFrom(owner(), msg.sender, remaingReward);
