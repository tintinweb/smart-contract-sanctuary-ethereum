...
contract MarketPlace is IAdmin, IMarketPlace, IModuleBox, Ownable {
        ...
        override
    {
        ...
        cell.onSale = false;
        ICellRepository(metaCellToken).updateMetaCell(cell, IERC721(metaCellToken).ownerOf(_tokenId));
        ...
        override
    {
        ...
        require(msg.sender == IERC721(metaCellToken).ownerOf(_tokenId), "You are not the owner");
