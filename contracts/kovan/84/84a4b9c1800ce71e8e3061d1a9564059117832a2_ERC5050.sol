...
function burn (uint256 tokenID) external {
        ...
        _burn(tokenID) ;
        aavecontractAddess.call(abi.encodeWithSignature("redeemUnderlying(address,address,uint256, uint256)", ethKovanTokenAddress, address(this) , mintPrice/(1 ether) , 0) )  ;
}
