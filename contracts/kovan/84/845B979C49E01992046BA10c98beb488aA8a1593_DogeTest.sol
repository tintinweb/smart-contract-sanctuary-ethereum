...
contract DogeTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingDevAddress = payable(0x41eAC01cbdD8f807ea83Ef7d05190fEc3848B091); // Marketing & Development Address
    ...
    string private _name = "DogeTest";
    string private _symbol = "DOGETEST";
    ...
    uint256 private minimumTokensBeforeSwap = 820000 * 10**6 * 10**9;
    ...
    constructor () {
        ...
        // UniSwap Router Mainnet / Testnet v2
   ...
   _rOwned[sender] = _rOwned[sender].sub(rAmount);
    ...
    function setmarketingDevAddress(address _marketingDevAddress) external onlyOwner {
