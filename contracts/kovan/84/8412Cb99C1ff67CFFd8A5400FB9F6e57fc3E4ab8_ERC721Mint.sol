...
contract MintFactory is Ownable {
    constructor() {}
    function deploy_mint(address NFT, uint count) public onlyOwner payable {
...
// 工厂合约
contract ERC721Mint is Ownable {
    SimejiNFT nft;
    ...
    function withdraw_nft(uint8 tokensId) public onlyOwner {
