...
//contract RapidTokenUpgradeable is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable, ValidationModule, EnforcementModule, PauseModule, DataStorageUpgradeable {
contract RapidTokenUpgradeable is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable, ValidationModule, EnforcementModule, PauseModule, DataStorageModule {
//contract RapidTokenUpgradeable is Initializable, ERC20Upgradeable, Initializable, ContextUpgradeable, AuthorizationModule, PauseModule, MintModule, BurnModule, EnforcementModule, ValidationModule, SnapshotModule, DataStorageUpgradeable {
    ...
    /* STORAGE ISSUED BOND MODULE  */
    /**
     * @dev Sets all token issue data to contract
     *
     * stored data will be used to automatically determine selection of methods and parameters in other modules
     * due to that there is no need to provide parameters beside this module
     */
    ...
    function initialize(
        ...
        _mint(msg.sender, __baseData.par_value * 10 ** decimals());
...
abstract contract DataStorageModule is Initializable, ERC20Upgradeable{
    ...
    function _storeBaseData(
        ...
        baseData = baseData_;
        emit IssuedBase(baseData_.name, baseData_.symbol, baseData_.tokenId, baseData_.terms, baseData_.par_value);
    }
    ...
    function _storeBondData(
        ...
        bondData = bondData_;
        emit IssuedBond(bondData_.guarantor_identifier, bondData_.bondholder_representative_identifier, bondData_.maturity_date,
            bondData_.interest_rate, bondData_.currency, bondData_.interest_schedule_format, bondData_.interest_payment_date);
    }
