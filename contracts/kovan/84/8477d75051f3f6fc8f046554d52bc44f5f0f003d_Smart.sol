...
contract Smart is ERC721I, Ownable, PublicMint, Security {
    // Constructor
    constructor(string memory baseTokenURI) payable ERC721I("Smart", "Smart") {
    ...
    // Public Limits
    uint256 public maxMintsPerPublic = 5;
    ...
    onlySender publicMintEnabled {
        ...
        if (totalSupply + amount_ < freeSupply + 1) {
            cost = 0;
        }
