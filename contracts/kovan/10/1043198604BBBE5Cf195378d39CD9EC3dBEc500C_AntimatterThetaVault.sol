...
contract AntimatterThetaVault is RibbonVault, RibbonThetaVaultStorage {
    ...
    event NewProduct(uint256 indexed productId, address indexed newOption);
    ...
    function commitAndClose(
        ...
        nextProductId = newProductId;
        products[nextProductId] = optionState.nextOption;
    ...
    function rollToNextOption() external onlyKeeper nonReentrant {
        ...
        emit NewProduct(nextProductId, newOption);
