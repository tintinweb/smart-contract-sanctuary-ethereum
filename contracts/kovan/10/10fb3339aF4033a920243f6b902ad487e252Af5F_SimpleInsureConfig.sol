...
contract SimpleInsureConfig {
    ...
    function classIDLength(address project_) external view returns (uint256, uint256) {
        require(projects[project_].accept, "!project classID");
