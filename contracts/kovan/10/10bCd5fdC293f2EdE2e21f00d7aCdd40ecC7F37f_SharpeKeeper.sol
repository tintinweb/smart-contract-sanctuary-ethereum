...
contract SharpeKeeper is KeeperCompatibleInterface{
    ...
    constructor(
        uint updateInterval, address _vault, int24 _baseThreshold, int24 _limitThreshold, int24 _maxTwapDeviation, uint32 _twapDuration, address _keeper) {
    ...
    function setKeeperRegistry(address _keeper) external onlyGovernance {
        keeper = _keeper;
    }
