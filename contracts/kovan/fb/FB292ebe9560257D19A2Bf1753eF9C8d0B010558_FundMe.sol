...
contract FundMe {
    ...
    mapping(address => uint256) public addressToAmountFunded; // to map wach address to the fund given
    ...
    constructor(address priceFeedAddress) {
        ...
        */
        ...
        owner = msg.sender; // first and last definition
    ...
    function fund() public payable {
        ...
        addressToAmountFunded[msg.sender] += msg.value; // add amount of value sent by sender
    ...
    function withdraw() public onlyOwner {
        ...
        // reset the array entirely - i.e create a new array
...
*/
    ...
    // with below, if somoen send fund by mistake
