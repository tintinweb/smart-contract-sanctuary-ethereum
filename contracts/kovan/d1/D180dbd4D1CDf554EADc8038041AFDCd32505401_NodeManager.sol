...
contract NodeHelper is Ownable {
    ...
    constructor(address _manager, address _router, address _token, address _treasury) {
    ...
    function createNodeWithTokens(string memory name, uint8 levelID) public {
        ...
        uint256 nodePrice = manager.getPrice(levelID) * 10 ** 18;
