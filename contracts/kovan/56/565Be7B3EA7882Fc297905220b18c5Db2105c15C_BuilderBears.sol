...
contract BuilderBears is ERC721A, Ownable, ReentrancyGuard {
    ...
    MintStage public mintStage = MintStage.PAUSED;
    ...
    function mint() external payable nonReentrant {
        require(mintStage == MintStage.ACTIVE, "mint not active");
    ...
    function setCeilingPriceToBaseURIMapping(uint256[] calldata _ceilingPrices, string[] calldata _baseURIs) external onlyOwner {
    ...
    function getLatestEthPriceUSD() public view returns (uint) {
