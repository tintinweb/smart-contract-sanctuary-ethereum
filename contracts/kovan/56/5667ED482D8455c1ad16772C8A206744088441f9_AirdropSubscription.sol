...
contract AirdropSubscription is Ownable, KeeperCompatibleInterface {
  ...
  function performUpkeep(bytes calldata performData) external override {
    ...
    for (uint256 i = 0; i < addresses.length; i++) {
      ...
      console.log(addresses[i]); // TODO
      console.log(deleteIndex); // TODO
  ...
  function cleanupAirdrop(uint256 _airdropIndex) external {
    Airdrop memory airdrop = airdrops[_airdropIndex];
    require(block.timestamp < airdrop.start || airdrop.end < block.timestamp, "Cant do this mid-airdrop"); // TODO test
  ...
  function setWhitelist(address _token, bool _status) external onlyOwner {
    // TODO should we whitelist a specific sender?
  ...
  // KEEPERS UPKEEP
  // function setKeeperRegistryAddress(address _keeperRegistryAddress) public onlyOwner {
