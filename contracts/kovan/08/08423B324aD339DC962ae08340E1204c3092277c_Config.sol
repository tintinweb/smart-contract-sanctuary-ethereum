...
contract Config is PermissionGroupUpgradeable {
    ...
    uint feeWithdrawGem;
    address treasury;
    mapping(address => bool) listStableTokens;

    function _initialize(uint _feeDepositETH, uint _feeWithdrawETH, uint _feeDepositGem, uint _feeWthdrawGem, address _treasury)
        external
        initializer
    {
        __operatable_init();
    ...
    function setFee(uint _feeDepositETH, uint _feeWithdrawETH, uint _feeDepositGem, uint _feeWthdrawGem) public onlyOwner {
        feeDeposit = _feeDepositETH;
        feeWithdraw = _feeWithdrawETH;
        feeDepositGem = _feeDepositGem;
        feeWithdrawGem = _feeWthdrawGem;
    ...
    function addListToken(address _token) public onlyOwner {
        require( _token != address(0), "invalid address");
        listStableTokens[_token] = true;
    }

    function removeListToken(address _token) public onlyOwner {
