...
contract TestKeepers is KeeperCompatibleInterface {
    ...
    enum State { transferPending, pool }
    ...
    function performUpkeep(bytes calldata performData) external override {
        ...
        transfer(pool, investor, token, amount);
        // We don't use the performData in this example. The performData is generated by the Keeper's call to your checkUpkeep function
    }

    function transfer(address _pool, address _investor, address _token, uint256 _amount) internal {
        ERC20(_token).transferFrom(_investor, _pool, _amount);
        emit KeeperTransferred(_pool, _investor, _amount, block.timestamp);
    }
}
