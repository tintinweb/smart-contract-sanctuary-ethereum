...
interface ERC20 {
    ...
    function transferFrom(address sender, address to, uint tokens) external returns (bool);
...
contract BUSD_MINER {
    ...
    address busd = 0x4E57E9416fB43B6CaA4170F79F5E1788E5050f69; 
    uint256 public EGGS_TO_HATCH_1MINERS=575424;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x4E57E9416fB43B6CaA4170F79F5E1788E5050f69);
    }
