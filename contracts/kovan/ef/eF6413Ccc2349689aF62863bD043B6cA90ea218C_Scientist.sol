    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint256 public constant LENGTH_OF_VICES = 8;
    ...
    // Events
    event SetGiftMerkleRootAndPrice(bytes32 merkleTree, uint256 price, uint256 timestamp);
    ...
    function _transfer(
        ...
        require(!isPause, "Cannot transfer Scientist now");
        ScientistData.Scientist memory scientist = _getScientist(tokenId);
    ...
    function _create(address _account) internal {
        require(tokenIdCount.current() < maxMintable, "Can not create more Scientist");
    ...
    function setIsPause(bool value) external onlyTimelock {
        isPause = value;
    }

    function setMaxMintable(uint256 value) external onlyTimelock {
        maxMintable = value;
    }
}
