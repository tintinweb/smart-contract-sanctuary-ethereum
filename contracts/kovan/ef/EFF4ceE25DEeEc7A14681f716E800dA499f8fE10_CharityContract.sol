...
contract CharityContract is ERC20 {
  ...
  constructor(address _MyToken, uint _tAmount, address _Owner, address _Dev) ERC20("CharityToken", "CT") {

    Owner = payable(_Owner);
    Dev = payable(_Dev);
    MyToken = _MyToken;
    Standard = IERC20(_MyToken);
    _mint(msg.sender, _tAmount);
