...
contract GenesisFarmBUSD {
	...
	uint256[] public REFERRAL_PERCENTS 	= [300, 200, 100, 50, 25, 25, 25, 25, 25, 25];
	uint256[] public SEED_PERCENTS 		= [500, 300, 200, 100, 100, 100, 50, 50, 50, 50];
