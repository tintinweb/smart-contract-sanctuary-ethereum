...
contract Jungle is ERC1155, ERC173, IERC165 {
    ...
    address TestAddress = 0x590AfC242d692d6B4b9BD8d69783BFb099E8BCf5;

    constructor() ERC1155("Jungle by ESCAPEPLAN", "JNGL") ERC173(TestAddress) {
        _mint(msg.sender);
    }
...
contract ERC1155 is IERC1155, IERC1155Metadata {
    ...
    string private cream = "bafybeihtmxaqjqa7mloiyt3ti47t62cdl4sjz5rqe76azxvntpjthhomvm/cream.json";
    string private solidGold = "bafybeihci4bblyutluls4pobhnztl5kirnwwl2ipar25fjrsv7ancmmlpm/solid-gold.json";
    string private diamond = "bafybeibsbnzpyrmry6ehquxhbwjhrnlugx2jcdwnl7576kce3v7bta3uwq/diamond.json";
    string private trippy = "bafybeiheuxykvlkq3czvw34fpa4buybopcpgqyakjpygjjxkhnbe3mqceu/trippy.json";
    string private deathBot = "bafybeigkobjk6fsoxyxmcjcy7jdwjxodx5e52xcezjzxg5l2fvo3w54uhe/death-bot.json";
    string private dmt = "bafybeidsdaz5upy5z3mhpodo75uv23uhlliz3rxwbkxk4sl6utjxmw4wfm/dmt.json";
    string private zombie = "bafybeidu44zn7qww6g5tmkwv6bqjcmqgpp5cp2brzydnjhuilxnlpsewxy/zombie.json";
    string private cheetah = "bafybeidp7ppy7tf2silnlr5yklrxbcmomya5grca4edijgfepqqkkl542u/cheetah.json";
    ...
    function tokenTotalSupply(uint256 _id) public virtual returns (uint256) {
