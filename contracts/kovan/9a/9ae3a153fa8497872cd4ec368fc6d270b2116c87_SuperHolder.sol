...
contract SuperHolder is Ownable{
    ...
    uint256 public constant SUPER_HOLDER_QUOTA = 2;
    uint256 public constant HOLDER_DEPOSIT_LIMIT = 2500 * 1 ether;
    ...
    uint256 public constant SUPER_HOLDER_DEPOSIT_LIMIT = 5000 * 1 ether;
