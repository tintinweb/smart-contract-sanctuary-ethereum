...
contract Testy2 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_100_000_000 * 10**9;
    ...
    string private _name = "Testy2";
    string private _symbol = "Testy2";
    ...
    // Function to allow dev to claim *other* ERC20 tokens sent to this contract (NOT TESTY2)
