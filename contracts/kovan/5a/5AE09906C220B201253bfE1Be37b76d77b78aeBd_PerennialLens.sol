...
interface IController {
    ...
    event CoordinatorCreated(uint256 indexed coordinatorId, address owner, address treasury);
    ...
    error ControllerNotPauserError(address sender);
    ...
    function createCoordinator(address coordinatorTreasury) external returns (uint256);
