        ...
        returns (uint256 shares,uint256 amount0,uint256 amount1)
    {
        ...
        if (shares == 0){
            ...
            if (amount0 > 0 && amount1 == 0){
                ...
                router.swapExactTokensForTokens(difference,0,path,address(this));
                ...
                // _mint(to, newShares);
                emit Deposit(msg.sender, to, amount0, amount0ToSend, difference); //(msg.sender, to, newShares, amount0ToSend, amount1Sent)
