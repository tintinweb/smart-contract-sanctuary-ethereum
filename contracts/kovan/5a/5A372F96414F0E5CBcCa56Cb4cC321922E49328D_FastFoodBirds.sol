...
contract FastFoodBirds is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public freeMintCount = 3;   
    ...
    function costForMint(uint256 _numToMint, address _account) public view returns(uint256) {
        uint256 availableFreeMint = (freeMintCount > 0 && freeMintPerAddr <= freeMintCounts[_account]) ? 0 : freeMintPerAddr - freeMintCounts[_account];
