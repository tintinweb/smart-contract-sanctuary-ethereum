...
contract MembershipContract is ChainlinkClient {
  ...
  address public sampleTokenContract;
  ...
  uint256 public rate; // rate of exchange between SAMP and USDC
  ...
  function requestPriceData() public returns (bytes32 requestId) {
      ...
      // request.add("get", "https://api.coingecko.com/api/v3/simple/token_price/ethereum?contract_addresses=0x6307b25a665efc992ec1c1bc403c38f3ddd7c661&vs_currencies=USD");
      ...
      //      }
      //    }
      // request.add("path", "0x6307b25a665efc992ec1c1bc403c38f3ddd7c661.usd");
      request.add("path", priceFeedPath);
      
      // Multiply the result by 100 to get to an amount in cents
      // Note that this also aligns with the units for general USDC / SAMP token exchange
      int timesAmount = 100;
