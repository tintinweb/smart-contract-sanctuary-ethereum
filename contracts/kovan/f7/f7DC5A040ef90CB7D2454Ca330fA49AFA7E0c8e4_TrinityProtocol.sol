...
// File: contracts/TrinityRegistry.sol
...
// File: contracts/TrinityProtocol.sol
...
contract TrinityProtocol is ERC721A, Ownable, ReentrancyGuard {
    ...
    function burn(uint256 tokenId) external {
        ...
        IERC20(bondType[tokenId].token).transferFrom(address(this), msg.sender, bondType[tokenId].principal);
    }
    ...
    function getMintPrice(address tokenAddress) public view returns (uint256) {
        return mintPrice[tokenAddress];
    }

    function getAtoken(address tokenAddress) public view returns (address) {
        return trinityRegistry.getToken(tokenAddress);
    }
