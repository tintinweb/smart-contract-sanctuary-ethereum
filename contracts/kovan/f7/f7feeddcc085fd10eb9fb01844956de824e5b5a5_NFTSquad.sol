...
/**
 * @title Insight Squad
 * @notice Insight Finance NFT collection
 */
contract NFTSquad is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        require((_maxSupply == 100) || (_maxSupply == 1000) || (_maxSupply == 300000), "Operations: Wrong max supply");
