...
contract sBook is ERC20Permit, Policy {
    ...
    constructor() ERC20("Staked Book", "sBOOK", 9) ERC20Permit("Staked Book") {
    ...
    /**
        @notice increases sBOOK supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBOOK
