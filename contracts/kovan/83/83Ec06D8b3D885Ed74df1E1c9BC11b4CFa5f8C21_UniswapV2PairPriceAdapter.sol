...
contract UniswapV2PairPriceAdapter is AccessControl, IOracleAdapter {
     ...
     */
    constructor(IPriceOracle priceOracle, IUniswapV2Pair[] memory uniswapPools) {
    ...
    function _getUniswapPairPrice(
        ...
        // Get reserve amounts
        (uint256 token1Reserves, uint256 token2Reserves, ) = IUniswapV2Pair(poolAddress).getReserves();
        ...
        return totalNotionalToMaster.preciseDiv(IUniswapV2Pair(poolAddress).totalSupply());
    }
