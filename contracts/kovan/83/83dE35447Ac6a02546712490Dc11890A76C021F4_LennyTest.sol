...
contract LennyTest is ERC721A, Ownable {
    ...
    /**
     * @notice Every wallet gets ONE free NFT! Please enter the EXACT amount of ETH corrisponding to the number of tokens you want to mint.
     * If you only want to claim your free one, enter 0 in the available field and submit the transaction!
     */
