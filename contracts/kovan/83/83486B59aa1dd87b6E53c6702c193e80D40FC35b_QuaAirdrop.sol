...
contract QuaAirdrop is AccessControl {
    ...
    modifier includeFee(uint256 distributedAmount) {
        require(msg.value - distributedAmount >= fee, "Fee not paid");
        _;
    ...
    function multisendCurrency(
        ...
        uint256 total
    ) external payable includeFee(total) {
     ...
     */
    function withdrawTokens(IERC20 token) external onlyRole(0x00) {
     ...
     */
    function withdrawCurrency() external onlyRole(0x00) {
