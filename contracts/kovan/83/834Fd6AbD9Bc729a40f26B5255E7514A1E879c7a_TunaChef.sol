...
contract TunaToken is ERC20("TunaToken", "TUNA"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "TUNA::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "TUNA::delegateBySig: invalid nonce");
        require(now <= expiry, "TUNA::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "TUNA::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying TUNAs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "TUNA::_writeCheckpoint: block number exceeds 32 bits");
...
// TunaChef is the master of Tuna. He can make Tuna and he is a fair guy.
//
...
contract TunaChef is Ownable {
    ...
    // Withdraw LP tokens from TunaChef.
    ...
    // Safe tuna transfer function, just in case if rounding error causes pool to not have enough TUNA  s.
