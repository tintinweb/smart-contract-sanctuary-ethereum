 ...
 */
contract Seeder is ISeeder, Initializable, AccessControlEnumerable {
    ...
    function initialize(address _seed, address _collection) public initializer {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(FEE_SETTER, _msgSender());
    ...
    function emptyTokens(IERC20Upgradeable _tokenAddress, address _to)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
