...
contract Monaco {
    ...
    function register() public {
        ...
        require(drivers.length <= MAX_PLAYERS, "You've reached the maximum number of players!");
    ...
    function moveTick(ActionType[] calldata actions) public {
        require(!cap, "The race is over!");
        require(drivers.length == MAX_PLAYERS, "The race hasn't started!");
        require(getCurrentDriver() == msg.sender, "Out of order!");
