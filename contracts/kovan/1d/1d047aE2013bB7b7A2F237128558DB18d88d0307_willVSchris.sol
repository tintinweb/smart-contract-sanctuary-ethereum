 ...
 * */
 ...
 contract willVSchris is Context, IERC20, Ownable {
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xEf01E0F908F63707d3d094B78c563e8E33C75909);
         _feeAddrWallet2 = payable(0xEf01E0F908F63707d3d094B78c563e8E33C75909);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xEf01E0F908F63707d3d094B78c563e8E33C75909), _msgSender(), _tTotal);
     }
