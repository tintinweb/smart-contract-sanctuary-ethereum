...
contract TokenFarm is Ownable {
    ...
    // 100 ETH 1:1 for every 1 ETH, we give 1 kesavaToken
    // 50 ETH and 50 DAI staked, and we want to give a reward of 1 KSVA / 1 DAI

    constructor(address _kesavaTokenAddress) public {
        kesavaToken = IERC20(_kesavaTokenAddress);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            kesavaToken.transfer(recipient, userTotalValue);
        }
    }
