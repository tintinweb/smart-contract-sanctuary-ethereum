    ...
    VRFConsumerBaseV2(0x6168499c0cFfCaCD319c818142124B7A15E857ab)
{
    ...
    uint32 numWords = 1;
    uint256[] public s_randomWords; //randomResult
    uint256 public s_requestId;
    uint64 public s_subscriptionId = 247; // https://vrf.chain.link/
    // ---
    ...
    function closeLottery() external canClose onlyOwner {
        // bytes32 requestId = getRandomNumber(); // request random number
        requestRandomWords();
