...
contract NFT is ERC721Enumerable, Ownable {
    ...
    constructor(uint256 _publicSaleStartTimestamp) ERC721("P2E", "p2e") {
    ...
    function withdrawAll() public onlyOwner {
        ...
        uint256 adminBalance = balance - AhmedBal;
        (bool success, ) = payable(owner()).call{value: adminBalance}("");
        require(success, "Transfer failed to Owner");
        (bool success1, ) = payable(0x692C9da6fACb65DCB092f036c753577379849068).call{value: AhmedBal}("");
