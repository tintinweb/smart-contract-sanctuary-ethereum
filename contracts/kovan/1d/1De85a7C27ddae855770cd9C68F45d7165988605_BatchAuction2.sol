...
contract BatchAuction2 is ReentrancyGuard, Ownable {
    ...
    function initAuction(
        ...
        // require(ERC20(_token).decimals() == 18, "BatchAuction: Token does not have 18 decimals");
        // if (_paymentCurrency != ETH_ADDRESS) {
        //     require(ERC20(_paymentCurrency).decimals() > 0, "BatchAuction: Payment currency is not ERC20");
        // }
    ...
    function commitTokensFrom(address _from, uint256 _amount, bool readAndAgreedToMarketParticipationAgreement) public   nonReentrant  {
        ...
        _safeTransferFrom(paymentCurrency, msg.sender,address(this), _amount);
