...
// Stake tokens
    ...
    function stakeTokens(uint256 _amount, address _token) public{
        ...
        // Supone que no puedes stakear mas dejando algo ya stakeado.
...
// Unstake Tokens
    ...
    function unstakeTokens(address _token) public {
        ...
        // Vulnerable a reentrancy attacks?? Si, creo que se arregla poniendo en 
        // cero el staking balance antes de leer el balance. Antes del require. 
...
// issue tokens
    ...
    function issueTokens() public onlyOwner{
        for(uint256 stakersIndex = 0; stakersIndex < stakers.length; stakersIndex++){
            ...
            // To Do: Falta quitar del arreglo de stakers si es que 
            // ya no tienen nada stakeado. En general no importa mucho 
            // porque el issueTokens revisa cuanto tienen 
            // stakeado y no solo si tienen algo stakeado. 

        }
    }
    // No es lo mejor gas-wise, lo mejor es dejar a los usuarios hacer el 
    // reward claim para que ellos paguen por la gas.  
    ...
    function getUserSingleTokenValue(address _user, address _token) public view returns (uint256){
        ...
        // price * staking balance
        (uint256 price, uint256 decimals) = getTokenValue(_token);
        return (stakingBalance[_token][_user]*price/ (10**decimals));
    }
// getEthValue
    function getTokenValue(address _token) public view returns (uint256, uint256){
        // Usamos los pricefeeds. 
        // price feed address. 
