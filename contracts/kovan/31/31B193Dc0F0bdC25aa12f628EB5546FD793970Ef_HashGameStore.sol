...
contract HashGameStore {
    ...
    constructor() public {
        ...
        token = new HashToken(500000000000000000000); // Creates the token contract (500 HASH)
    ...
    */
    ...
    function setKeysForSale(
        ...
        require( // The wallet must at least as many keys as it is trying to sell
            ...
            "The wallet does not own as many keys as it is trying to list"
        );
    ...
    function buyLowestPriceKey(uint256 gameID, uint256 quantity) public {
        ...
        address lowestPriceAddress = getLowestPriceReseller(gameID);
    ...
    function getLowestKeyPrice(uint256 gameID) public view returns (uint256) {
        address lowestPriceAddress = getLowestPriceReseller(gameID);
    ...
    function getLowestPriceKeyQuantity(uint256 gameID)
        public
        view
        returns (uint256)
    {
    ...
    function getLowestPriceReseller(uint256 gameID)
        public
        view
        returns (address)
    {
