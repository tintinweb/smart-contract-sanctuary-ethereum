...
contract MetarixContract is Ownable {
  ...
  uint256 public immutable bnbPriceInDollar=0; // bnb price in dollar
  ...
  function buy() external payable {
     ...
     require(getBalanceByAddress[msg.sender]*bnbPriceInDollar <= 5000, "You have exceeded max dollar price 5000!");
