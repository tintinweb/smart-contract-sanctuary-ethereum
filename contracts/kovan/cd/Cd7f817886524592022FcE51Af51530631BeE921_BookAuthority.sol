...
import "IBookAuthority.sol";

import "BookAccessControlled.sol";

contract BookAuthority is IBookAuthority, BookAccessControlled {
    /* ========== STATE VARIABLES ========== */
    ...
    constructor(
        ...
        address _policy,
        address _vault
    ) BookAccessControlled(IBookAuthority(address(this))) {
        governor = _governor;
...
abstract contract BookAccessControlled {
    /* ========== EVENTS ========== */

    event AuthorityUpdated(IBookAuthority indexed authority);

    string UNAUTHORIZED = "UNAUTHORIZED"; // save gas

    /* ========== STATE VARIABLES ========== */

    IBookAuthority public authority;

    /* ========== Constructor ========== */

    constructor(IBookAuthority _authority) {
    ...
    function setAuthority(IBookAuthority _newAuthority) external onlyGovernor {
