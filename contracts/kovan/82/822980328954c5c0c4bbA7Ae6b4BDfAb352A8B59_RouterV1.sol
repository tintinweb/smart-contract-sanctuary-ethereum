...
contract RouterV1 {
    ...
    {
        perp.getDepositBond(); // pulls most recent bond to get perp state up to date
    ...
    function trancheAndDeposit(
        ...
        require(bond == perp.getDepositBond(), "Expected to tranche deposit bond");
    ...
    // @param trancheOutBalance The tranche balance held by the reserve to be pre-calculated off-chain.
        ...
        )
    {
        ...
        r.remainingTrancheOutBalance = trancheOutBalance;
