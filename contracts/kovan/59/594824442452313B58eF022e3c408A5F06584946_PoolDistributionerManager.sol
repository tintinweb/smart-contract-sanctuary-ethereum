...
contract PoolDistributionerManager is DistributionerManager {
    ...
    DeployFactoryForPoolInterface public deployFactory;

    function initialize(address _comptroller, DeployFactoryForPoolInterface _deployFactory) initializer public {
    ...
    function deployDistributioner(address rewardToken) public {
        require(hasRole(MAINTAINER, msg.sender));
        address _distributioner = deployFactory.createDistributioner(msg.sender, rewardToken, comptroller, address(this));
