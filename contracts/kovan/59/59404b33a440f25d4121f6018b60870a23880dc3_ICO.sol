...
contract ICO {
    ...
    Token public token;
    IERC20 public eth = IERC20(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2);
    ...
    function buy(uint ethAmount)
        external
        icoActive() {
        require(
          ethAmount >= minPurchase && ethAmount <= maxPurchase, 
          'have to buy between minPurchase and maxPurchase'
        );
        uint tokenAmount = ethAmount.div(price);
        require(
