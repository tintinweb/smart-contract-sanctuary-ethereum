...
// File contracts/libraries/ERC20Capped.sol
...
// File contracts/libraries/ERC20Mintable.sol
...
// File contracts/services/IFeeReceiver.sol

interface IFeeReceiver {
  function processFee(string memory serviceId) external payable;
}


// File contracts/services/FeeProcessor.sol
...
abstract contract FeeProcessor {
    ...
    constructor (address payable receiver, string memory serviceId) payable {
        IFeeReceiver(receiver).processFee{value: msg.value}(serviceId);
    }
}


// File contracts/CappedMBOwnableToken.sol
...
contract CappedMBOwnableToken is ERC20Base, ERC20Capped, ERC20Mintable, ERC20Burnable, Ownable, FeeProcessor {
    constructor(
        string memory name,
        ...
        FeeProcessor(feeReceiver, "CappedMBOwnableToken")
        payable {

        require(initialSupply > 0, "CappedMBOwnableToken: initial supply cannot be zero");
