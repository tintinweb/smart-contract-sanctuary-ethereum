...
contract TokenTrading{
    event offerEvent(address token_address, address seller, uint256 tokens,uint256 price);
    event withdrawEvent(address token_address,uint256 offerId,uint256 tokens);
    event buyEvent(address token_address,uint256 offerId,uint256 tokens,uint256 price,address from,address to);
    ...
    function offer(address _tok_addr,uint256 _tokens,
        ...
        emit offerEvent(_tok_addr,msg.sender,_tokens,_price_in_wei);
    }
    ...
    function withdraw(address _tok_addr,uint256 _offerId,uint256 _tokens) public{
        ...
        emit withdrawEvent(_tok_addr,_offerId,_tokens);
    }
    ...
    function buy_offerId(address _tok_addr,LinkedList.Data memory _offer,
        ...
        emit buyEvent(_tok_addr,_offer.offerId,_tokens,_offer.price,_offer.seller,_to);
        return cost;
    }
