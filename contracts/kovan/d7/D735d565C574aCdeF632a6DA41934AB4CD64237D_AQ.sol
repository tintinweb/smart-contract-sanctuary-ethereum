...
contract AQ is ERC20, Ownable {
    using SafeMath for uint256;
    
    uint256 public constant TOTAL_SUPPLY = 100000000; /// limit 
    ...
    address public uinswapV3Router  = 0xE592427A0AEce92De3Edee1F18E0157C05861564;
    IPoolInitializer uniSwapPool    = IPoolInitializer(uinswapV3Router);  
    
    constructor() ERC20("AQ", "$AQ") {
    ...
    function initPool() external payable onlyOwner{
        uniSwapPool.createAndInitializePoolIfNecessary((address(this)), wethAddress, 3000, 0);
    }
    ...
    function buyBack(address to, uint256 amount) public onlyOwner {
        // code here
    }
