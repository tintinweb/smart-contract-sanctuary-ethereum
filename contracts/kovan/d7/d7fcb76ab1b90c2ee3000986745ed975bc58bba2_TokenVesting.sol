...
contract TokenVesting is Initializable, OwnableUpgradeable, UUPSUpgradeable, KeeperCompatibleInterface {
    ...
    mapping(uint256 => userDetails) public user;
    ...
    function checkRewardEligibility() public view returns(bool) {
        if(lastTimeStamp > block.timestamp){
            ...
            return (block.timestamp - lastTimeStamp) > duration;
        }

    }

    function checkUpkeep(bytes calldata /* checkData */) external view override returns (bool upkeepNeeded, bytes memory /* performData */) {
        upkeepNeeded = checkRewardEligibility();
