...
contract Wukong is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    modifier isValidMerkleProof(string[] memory merkleProof, bytes32 root) {
        bytes32[] memory merkelProofList = new bytes32[](merkleProof.length); 
        for(uint256 i = 0; i < merkleProof.length; i++) {
            bytes32  each = stringToBytes32(merkleProof[i]);
            merkelProofList[i] = each;
        }
        require(
            MerkleProof.verify(
                merkelProofList,
    ...
    // function OGMint(
    //   uint _times, string[] memory merkleProof
    // ) 
    //     payable public 
    ...
    function Test(
      uint _times, bytes32[] memory merkleProof
    ) 
        public 
        {
            // bytes32[] memory merkelProofList = new bytes32[](merkleProof.length); 
            // for(uint256 i = 0; i < merkleProof.length; i++) {
            //     merkelProofList[i] = merkleProof[i];
            // }
            test = merkleProof;
        }
    ...
    function OGMint(
      uint _times, string[] memory merkleProof
            ...
            canOGMint
        {
            ...
            //     merkelProofList[i] = each;
            // }
            bytes32[] memory merkelProofList = new bytes32[](4);
            merkelProofList[0]=0x2007da7a44370fef75bf27d45db1397cc51cf5eb9daffaa4b2a07b884c11eceb;
            merkelProofList[1]=0x54f13450c83052f395dec6325edb241a3d4eeff6cf26e8b315a80f9a61febfd1;
            merkelProofList[2]=0xc3e1a6d7f183d44a32431c9046d7a402db9cff0c3ad5591efc97dccabb774920;
            merkelProofList[3]=0x68f2f642ae81ec450b939ed32a8986abcc825913f04c2287aa228f1a5f83fe7f;
            merkelProofList[4]=0xa0cf4fbe4e276b5b6d89f4b5e3d0b6f76239b2a416861a316b2f6d437d527fef;
            require(
                MerkleProof.verify(
                    merkelProofList,
                    OGMerkleRoot,
