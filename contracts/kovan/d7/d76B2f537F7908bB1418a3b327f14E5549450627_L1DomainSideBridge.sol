...
contract L1DomainSideBridge {
    ...
    address Proxy_OVM_L1CrossDomainMessenger;  //Source & Destintion side rollup(Optimism) l1messenger address 
    ...
    constructor(){
        Proxy_OVM_L1CrossDomainMessenger = 0x4361d0F75A0186C05f971c566dC6bEa5957483fD;
    ...
    function declareNewHashChainHead(bytes32 _hashOnion) external{
        ...
        l1cdm.sendMessage(
            ...
            abi.encodeWithSignature(
                "declareNewHashChainHead(byte32)",
                _hashOnion
            ),
