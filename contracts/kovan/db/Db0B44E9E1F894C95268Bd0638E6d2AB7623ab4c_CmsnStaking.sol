...
contract CmsnStaking is Ownable {
    ...
    // uint256 public constant MIN_POOL_SIZE = 1000_000; // 100,000 CMSN as minimum pool size
    uint256 public constant MIN_POOL_SIZE = 2; // 100,000 CMSN as minimum pool size
    // uint256 public constant MIN_PERIOD = 3 days;
    uint256 public constant MIN_PERIOD = 3 minutes;
    // uint256 public constant MIN_TIME_ACCEPTING = 1 days;
    uint256 public constant MIN_TIME_ACCEPTING = 1 minutes;
    ...
    constructor(address _marketing) {
        ...
        cmsn = IERC20(0xa36085F69e2889c224210F603D836748e7dC0088);
    ...
    function addReward(uint256 _poolId, uint256 _amount) external onlyOwner {
        require(_poolId < poolCount, "invalid pool");
    ...
    function createPool(
        ...
        uint256 endsAt = startedAt + poolTypes[_poolTypeId].period;
        ...
        emit PoolCreated(_poolTypeId, startedAt, endsAt);
