...
contract wETHBondDepository is Ownable {
    ...
    enum PARAMETER { VESTING, PAYOUT, DEBT, MIM_PRICE }
    /**
    ...
    function setBondTerms ( PARAMETER _parameter, uint _input ) external onlyPolicy() {
        ...
        } else if ( _parameter == PARAMETER.MIM_PRICE ) { // 3
    ...
    function deposit( 
        ...
        IERC20( principle ).transfer(treasury, _amount);
