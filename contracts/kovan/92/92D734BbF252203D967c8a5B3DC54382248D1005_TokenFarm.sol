...
contract TokenFarm is Ownable{
    ...
    //Token pricefeed mapping requires the address of the token then fetch the address of the priceFeed
    mapping(address => address) public tokenPriceFeedMapping;
    //This check for the no of unique tokens staked
    mapping (address => uint256) public uniqueTokenStaked;
    // 100ETH 1:1 for every 1 ETH, we give 1DappToken
    // 50 ETH and 50 DAI staked, and we want to give a reward of 1 DAPP/1 DAI
    constructor(address _dappTokenAdress) public {
        //This will be the address of the dappToken we created, address of thsi will be pass to the deployment function of this contract
    ...
    function getUserTotalValue(address _user) public view returns (uint256){
        uint totalValue=0;
        require(uniqueTokenStaked[_user]>0, "No stokens staked");
        for (
