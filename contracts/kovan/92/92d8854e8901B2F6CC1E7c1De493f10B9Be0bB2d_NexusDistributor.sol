    ...
    ReentrancyGuardUpgradeable
{
  ...
  */
   ...
   function buyCover(
        ...
        uint256 wNXMAmount;
        if (coverAsset == ETH) {
            require(msg.value >= coverPriceWithFee, "NexusDistributor: Insufficient ETH sent");
            ...
            wNXMAmount = _swapExactETHForTokens(priceFeed,address(wnxmToken),msg.value.sub(remainder));
        } else {
            require(
                    IERC20Upgradeable(coverAsset).allowance(msg.sender, address(this)) >= coverPriceWithFee,
...
abstract contract AbstractDistributor {
   ...
   function _checkApprovals(
    ...
    //TODO Buying in Abstract? This code will be present in every distributor?
