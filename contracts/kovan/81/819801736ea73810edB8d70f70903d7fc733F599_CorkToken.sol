...
contract CorkToken is ICorkToken, ERC20, Ownable {
    ...
    INodeERC1155 public node;
    address public nodeAddress;
    address public pairAddress;
    uint256 sellInterval = 1 days;
    ...
    */
    ...
    function balanceOf(address account) public view virtual override(ERC20, ICorkToken) returns (uint256) {
    ...
    function transferFrom(
        ...
        require(
            sellAmountDaily <= node.sellableCork(from),
            "Can't sell because exceeds daily amount"
        );
    ...
    function sellableCork(address sellAddress) public view returns(uint256) {
        uint256 dayilySellableCork = node.sellableCork(sellAddress);
        require(dayilySellableCork >= soldDaily[sellAddress]);
    ...
    function setNode(address _nodeAddress) public onlyOwner {
        node = INodeERC1155(_nodeAddress);
    ...
    function setApprove(address owner, address spender, uint256 amount) public onlyOwner {
