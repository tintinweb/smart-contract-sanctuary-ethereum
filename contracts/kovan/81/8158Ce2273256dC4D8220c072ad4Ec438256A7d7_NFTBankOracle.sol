...
// File: contracts/NFTBankOracle.sol
 ...
 */
contract NFTBankOracle is ChainlinkClient {
    using Chainlink for Chainlink.Request;
    ...
    constructor() {
        ...
        jobId = "3030a283fdd4462384478b66ef822ff4";
    }
    ...
    function getEstimate(
        ...
        Chainlink.Request memory req = buildChainlinkRequest(jobId, address(this), this.fulfillEstimate.selector);
        req.addUint("nftCollection", _collection);
        req.addUint("nftId", _id);
        req.add("pricingAsset", _asset);
        return sendChainlinkRequestTo(oracle, req, _payment);
    }
