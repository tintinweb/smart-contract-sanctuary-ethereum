...
contract ChickenFarm {
    ...
    uint256 private immutable DAY_IN_SECONDS = 1;
    ...
    function buyChickens(address _ref) external payable {
        ...
        address checkedRef=checkReffer(_ref);
    ...
    function getMyEggsForSale(address _adr) public view returns (uint256) {
        ...
        uint256 amount = (Chickens[_adr] * DailyEggsPersent * (block.timestamp - lastHarvest[_adr])) 
    ...
    function getRefer(address _referal) public view returns(address refer){
