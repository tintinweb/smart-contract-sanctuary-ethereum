...
contract ERC721Token is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://nft-marketplace.io/api/factory/";
    ...
    function name() external pure override returns (string memory) {
        return "NftMarketplace Item Sale";
    }
    ...
    function mint(uint256 _optionId, address _toAddress) public override {
        ...
        ERC721Tradable nftERC721Tradable = ERC721Tradable(nftAddress);
        nftERC721Tradable.mintTo(_toAddress);
    }
    ...
    /**
     * Hack to get things to work automatically on nft.
...
contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    function baseTokenURI() public pure returns (string memory) {
        return "https://nft-marketplace.io/api/nft/";
    }
