...
contract rewardToken is ERC20Upgradeable, ChainlinkClient, OwnableUpgradeable {
   ...
   ERC20Upgradeable public token;
    ...
    function requestVolumeData(string memory id,address dataUrl) public returns (bytes32 requestId)
    {
        string memory finalUrl = string(abi.encodePacked(url,dataUrl,"&id=",id));
