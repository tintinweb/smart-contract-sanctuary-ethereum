...
contract CivNFTFarm is Ownable, ERC1155Holder, ReentrancyGuard {
    ...
    function updateRate(uint256 rateNumber) public onlyOwner {
        uint256 prevAllocPoint = tokensPerBlock;
        tokensPerBlock = rateNumber;
        uint256 newAllocPoint = tokensPerBlock;
        emit SetTokensPerBlock(prevAllocPoint, newAllocPoint);
    }
    ...
    function enterStaking(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        pool.representToken.safeTransfer(msg.sender, actualRepresentToken);
    ...
    function leaveStaking(uint256 _pid, uint256 _amount) public nonReentrant {
        ...
        require(
            allowanceAmount >= actualRepresentToken,
