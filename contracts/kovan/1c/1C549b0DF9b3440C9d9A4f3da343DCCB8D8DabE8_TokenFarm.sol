...
contract TokenFarm is Ownable {
    ...
    // mapping tokenaddress > staker address > amount -- Guardamos de cada token
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        // what tokens and how much can they stake?
        require(_amount > 0, "Amount >0 required");
        require(tokenIsAllowed(_token), "Token not allowed");
        // we use transerfrom because the contract does not own the tokens being transferred
        // from msg.sender to "this" contract, specified _amount
    ...
    /*  function issueTokens() public onlyOwner {
        for (
            ...
            // This is redundant, but highlights that we are sending 1 DAPP por 1 USD de TVL
            //uint256 amount = userTVL;
            // based on TVL
    ...
    function getUserTvl(address _user) public view returns (uint256) {
        ...
        for (
            ...
            address _token = allowedTokens[allowedTokenIndex];
