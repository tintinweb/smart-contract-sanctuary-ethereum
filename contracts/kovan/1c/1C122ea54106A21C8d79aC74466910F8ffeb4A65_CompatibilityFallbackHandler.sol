  ...
  ISignatureValidator
{
    ...
    returns (bytes4)
  {
    ...
    SafeVault safe = SafeVault(payable(msg.sender));
  ...
  function getMessageHash(bytes memory message) public view returns (bytes32) {
    return getMessageHashForSafe(SafeVault(payable(msg.sender)), message);
  }
  ...
  /// @param message Message that should be hashed
  /// @return Message hash.
  function getMessageHashForSafe(SafeVault safe, bytes memory message)
    public
    view
    returns (bytes32)
  {
