...
'----\\--//----`
      \\//
       \/     FUUUUUUUUUUUUUUUUUUUCKCCCCCCCCCCCCCCKKKKKKKKKKKKKKK
 * 
 */
...
contract EpicKikeWorldTour {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 1e18; // 11B
	uint256 constant private BURN_RATE = 2; // 20% per tx
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 1M = 10K

	string constant public name =  "Epic Kike";
	string constant public symbol =  "KIKE";
