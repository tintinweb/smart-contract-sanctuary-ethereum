...
contract PlasmaGasStation is Ownable, LondonTxSupport {
    ...
    event GasLog(string log, uint256 gasUsed);
    ...
    function sendTransaction(TxRequest calldata _tx, TxFee calldata _fee, bytes calldata _sign) external onlyFeePayer {
        ...
        emit GasLog("preCallGasUsed", preCallGasUsed);
        ...
        emit GasLog("callGasUsed", callGasUsed);
        ...
        emit GasLog("postCallGasUsed", postCallGasUsed);
        ...
        emit GasLog("totalGasUsed", initialGas.sub(gasleft()));
    }
