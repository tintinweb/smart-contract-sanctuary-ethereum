...
contract ERC721NFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ReentrancyGuard {
    ...
    function userMints(address to, string memory uri) public payable nonReentrant whenNotPaused {
