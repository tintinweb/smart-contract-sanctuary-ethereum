...
contract ClockAuction is Pausable, ClockAuctionBase {
    ...
    function bid(uint256 _tokenId, address _tokenAddress)
        external
        virtual 
        payable
        whenNotPaused
...
contract SaleClockAuction is ClockAuction {
    ...
    function bid(uint256 _tokenId,address _tokenAddress)
        ...
        payable
    {
        require(isApproved[_tokenAddress],"Invalid token to bidding");
        // _bid verifies token ID size
        address seller = tokenIdToAuction[_tokenId].seller;
        uint256 price = _bid(_tokenId, _tokenAddress);
        _transfer(msg.sender, _tokenId);
    ...
    function buyNFT(uint256 _tokenId, address _tokenAddress) external payable whenNotPaused {
        ...
        _transferAmount(sale.seller,sale.Price - price, price, _tokenAddress );
