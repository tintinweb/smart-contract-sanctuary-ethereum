...
contract FarmRewardsVesting is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public farm = IERC20(0x608a73a87c0240480c3f14b1B157De0F3bF7b70E);
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            farm.safeTransferFrom(rewardDistribution, msg.sender, reward);
    ...
    function inCaseTokenGetsStuckPartial(IERC20 _TokenAddress, uint256 _amount) onlyOwner public {
        require(_TokenAddress != farm && _TokenAddress != stakeToken);
