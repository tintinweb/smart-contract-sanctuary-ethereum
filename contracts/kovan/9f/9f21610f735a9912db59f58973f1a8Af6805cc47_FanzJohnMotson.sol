...
contract FanzJohnMotson is Ownable, ERC721A, ReentrancyGuard, Pausable {
    ...
    event UpdatePublicSaleMaxMint(uint256 publicSaleMaxMint);
    ...
    uint256 public publicSaleMaxMint = 50;
    ...
    function setPublicSaleMaxMint(uint256 publicSaleMaxMint_)
        external
        onlyOwner
    {
        publicSaleMaxMint = publicSaleMaxMint_;
        emit UpdatePublicSaleMaxMint(publicSaleMaxMint_);
    }
    ...
    function _validateMint(
        ...
        require(
            (_numberMinted(_msgSender()) + quantity_) <= maxMint_,
