...
// This contract also acts as the mining treasuary
// Using the "approve and setting a limit", the owners can introduce a new staking contract to access a portion of the treasuary
// The user deposit YOLLAR for playing the game (through staking contracts) and they can withdraw it at a later time if they choose to
