...
contract TokenFactory1155 is TokenFactory1155Storage, ITokenFactory1155, AccessControlEnumerableUpgradeable/*, OwnableUpgradeable*/ {
    ...
    // modifier onlyAdminOrSuperFactory() {
    //     require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender) || superFactoryAddress == msg.sender, "Not an Admin or super factory");
    //     _;
    // }

    // function setNewSuperFactory(address _superFactoryAddress) external override onlyAdminOrSuperFactory {
    ...
    */
    function deployToken1155(string memory _name,
            ...
            uint256 _biPercent,
            uint256 _creatorPercent) public override onlyAdmin returns (address) {
        Token1155 newToken = new Token1155(); //(_baseTokenURI, _creatorAddress, _creatorCollectorAddress, _biPercent, _creatorPercent);
        newToken.initialize(_name, _symbol, _baseTokenURI, _creatorAddress, _creatorCollectorAddress, _biPercent, _creatorPercent);
    ...
    */
    function deployTokenWithWL(string memory _name,
            ...
            address _creatorCollectorAddress,
            uint256 _biPercent,
            uint256 _creatorPercent) external override onlyAdmin returns (address, address) {
        address newTokenAddress = deployToken1155(_name, _symbol,_baseTokenURI, _creatorAddress, _creatorCollectorAddress, _biPercent, _creatorPercent);
...
contract Token1155 is Token1155Storage, OwnableUpgradeable, AccessControlEnumerableUpgradeable, 
                    PausableUpgradeable, ERC1155Upgradeable, ERC2981Upgradeable, IToken1155/*, ContextMixin*/ {
    using SafeMathUpgradeable for uint256;
    ...
    function initialize(string memory _name,
            ...
            address _creatorCollectorAddress,
            uint256 _biPercent,
            uint256 _creatorPercent) public initializer {
        OwnableUpgradeable.__Ownable_init();
        __ERC1155_init(_uri);
        name = _name;
        symbol = _symbol;
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view override(AccessControlEnumerableUpgradeable, ERC1155Upgradeable, ERC2981Upgradeable) returns (bool) {
        return (
