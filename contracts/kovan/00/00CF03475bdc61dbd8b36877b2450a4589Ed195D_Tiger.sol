 ...
 */
contract Tiger is ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable {
    ...
    function initialize() public initializer {
        ERC721Upgradeable.__ERC721_init("TigerNFT", "Tiger");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(SET_TOKEN_ROLE, _msgSender());
        _setupRole(MINT_TOKEN_ROLE, _msgSender());
    }
    ...
    function tokenURI(uint256 _tokenId) public override view returns (string memory) {
        ...
        string memory uriSuffix = Strings.toString(_tokenId);
