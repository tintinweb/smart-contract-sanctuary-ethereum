...
contract PlatziPunksDNA {
    ...
    // This pseudorandom function is deterministic, mustn't be used in production
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("PlatziPunks", "HPLPKS") {
    ...
    function mint() public payable {
        ...
        require(current <= maxSupply, "Max supply has been reached!");
