...
contract DMTToken is ERC20, EIP712MetaTransaction {
    uint256 public initialSupply = 100000000000000000000;

    constructor(string memory name,string memory symbol) ERC20(name,symbol) EIP712MetaTransaction("GineteToken", "1", 3) {
