...
contract NodeManager is Ownable, IERC721, IERC721Metadata {
    ...
    address public purchaseCurrency = 0xe22da380ee6B445bb8273C81944ADEB6E8450422;
    ...
    function createNode(address account, string memory nodeName) external {
        ...
        require(IERC20(purchaseCurrency).allowance(msg.sender, address(this)) > (nodePrice * (10 ** IERC20(purchaseCurrency).decimals())), "Token is not approved!");
