...
contract Uchu {
    ...
    **/
    ...
    function getProductDeposit(string memory name) public view returns (uint256) {
        return allowance[name];
    }

    function getUserProductDeposit(address user, string memory name) public view returns (uint256) {
    ...
    **/
    function getProductMaxBalance(address user) public view returns (uint256) {
