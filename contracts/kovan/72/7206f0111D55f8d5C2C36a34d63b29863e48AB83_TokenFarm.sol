...
contract TokenFarm is Ownable {
    //Mapping the token address to a mapping of the users address to the amount
        ...
        returns (uint256)
    {
        ...
        uint256 balance = stakingBalance[_token][_user];

        return uint256((balance * price) / (10**decimals));
    }
    ...
    function addAllowedTokens(address _token) public onlyOwner {
        require(tokenIsAllowed(_token) == false, "Token is already added");
