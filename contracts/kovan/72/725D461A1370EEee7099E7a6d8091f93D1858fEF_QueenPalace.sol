    ...
    ERC165Storage
{
    ...
    function isOwnerOrArtist() internal view {
        require(
            msg.sender == owner() || isArtist(msg.sender),
            "Not Owner, Artist"
        );
    }
     ...
     *OUT
     */
    function _setDAO(address payable _addressDAO) private {
        require(
    ...
    function setDAOExecutor(address payable _addressDAOExecutor)
        ...
        onlyOnImplementationOrDAO
    {
        _setDAOExecutor(_addressDAOExecutor);
    }

    /**
     *IN
     *_newArtist: address of Royal Executor contract
     *OUT
     */
    function _setDAOExecutor(address payable _addressDAOExecutor) private {
        require(
    ...
    function setRoyalTower(address payable _addressRoyalTower)
        ...
        onlyOnImplementationOrDAO
    {
        _setRoyalTower(_addressRoyalTower);
    }
     ...
     *OUT
     */
    function _setRoyalTower(address payable _addressRoyalTower) private {
        require(
