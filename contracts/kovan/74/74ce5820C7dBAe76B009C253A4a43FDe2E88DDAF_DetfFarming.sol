...
contract DetfFarming is Ownable {
    // 3 MONTHS
    uint256 constant UNLOCK_TIME = 60 * 60 * 2;
        ...
        onlyOwner
    {
        ...
        uint256 days30 = 60 * 60;
        farmingDuration = days30;
        farmingEnd = startTimestamp + days30;
        rewardPerSec = (_rewardAmount * 1e12) / days30;
        ...
        onlyOwner
    {
        ...
        updatePool();
        rewardPerSec += rewardPerSecIncrease * 1e12;
    ...
    function increaseFarmingDuration(uint256 timeIncrease) external onlyOwner {
        ...
        uint256 rewardIncrease = (timeIncrease * rewardPerSec) / 1e12;
        rewardAmount += rewardIncrease;
        require(
            rewardToken.transferFrom(
                _msgSender(),
