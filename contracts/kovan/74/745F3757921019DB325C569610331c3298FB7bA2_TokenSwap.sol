...
contract TokenSwap is ReentrancyGuard,Context{
    ...
    function swap(address token, uint256 amountIn) external nonReentrant{
        ...
        require(IERC20(token).approve(UNISWAP_ROUTER_ADDRESS,amountIn),"Fail approval");
        ...
        balances[_msgSender()] += address(this).balance-balance;
    }
