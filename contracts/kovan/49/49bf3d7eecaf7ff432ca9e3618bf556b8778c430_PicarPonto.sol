...
contract PicarPonto {
    ...
    constructor() {
        autorizarAgente(0x22CF42C287A106587e953934dAC25f76DF963e80, "Formador");
        autorizarAgente(0x0e1B0FaC92d6Bc3EBB72A2A5BBa3Ec66Dc4D99A0, "Formando");
    }
    ...
    function marcar(string memory Nome, string memory Data, string memory Hora1, string memory Hora2, string memory Hora3, string memory Hora4) public {
        require(agente[msg.sender].sender == msg.sender, unicode"Não está autorizado a interagir com este contrato.");
