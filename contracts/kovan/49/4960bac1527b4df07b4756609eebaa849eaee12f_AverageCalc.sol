...
contract AverageCalc {
    ...
    function averageCalc(uint256 _input1, uint256 _input2, uint256 _input3, uint256 _input4, uint256 _input5) public pure returns(uint256 max, uint256 average, uint256 min){
        uint256 _max;
        ...
        return(_max, (_input1 + _input2 + _input4 + _input3 + _input5) / 5, _min);
    }
}