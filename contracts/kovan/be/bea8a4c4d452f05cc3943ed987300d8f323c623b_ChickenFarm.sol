...
contract ChickenFarm {
    ...
    uint256 private immutable OneChickenCost = 0.0005 ether; //for final version should be 0.05 ether (0.05 MATIK)
    uint256 private immutable OneEggInitialCost = 0.0005 ether; //for final version should be 0.05 ether (0.05 MATIK)
