...
contract SCARDust is Context,IERC20, Ownable{
    ...
    address _owner;
    address payable public marketingAddress = payable(0xaD8172565f1D575F288F47249bb5a8eFB391847c);
    address payable public prizePoolAddress = payable(0xaD8172565f1D575F288F47249bb5a8eFB391847c);
    ...
    uint256 private buyprizePool = 2;//1 //P2E
