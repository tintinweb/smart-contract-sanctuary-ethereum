...
contract FundMe {
    // safe math library check for uint256 type integer overflows
    using SafeMathChainlink for uint256;

    // mapping to store which address depositeded how much eth
    mapping(address => uint256) public addressToAmountFunded;
    // aray of addresses who deposited
    address[] public funders;
    // address of owner (whio deployed the contract)
    ...
    // function to get the version of the chainlink pricedfeed
