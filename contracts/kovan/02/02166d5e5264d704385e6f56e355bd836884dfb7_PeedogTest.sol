...
contract PeedogTest is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.0009 ether;
    uint256 public MAX_SUPPLY = 2000;
    uint256 public MAX_MINTS = 50;
    string public baseURI = "https://ipfs.io/ipfs/QmRpv9PTGky7v1vn3kQCMhVwcuuhgtYkQ9vp77crFxuKiS?filename=video.gif/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("PeeDogTest", "PD-NTF", MAX_MINTS, MAX_SUPPLY) {  
    }
