...
contract SPEAR is ERC20, Ownable {
    ...
    constructor() ERC20("CrosschainKOVANeth", "Test") payable {
    	...
    	marketingWallet = address(0x1329F810f4CCcA16769b719F61d325518eB41009); // set as marketing wallet
        ...
        excludeFromFees(0x46D175d566B3004554B04b41d0F863e24a9748AE, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x46D175d566B3004554B04b41d0F863e24a9748AE, true);
