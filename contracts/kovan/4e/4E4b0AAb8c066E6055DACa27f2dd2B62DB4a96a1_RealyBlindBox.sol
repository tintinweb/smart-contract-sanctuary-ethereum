...
contract RealyBlindBox is ERC721, Ownable {
    ...
    uint public constant maxPurchase = 50;
    ...
    constructor(string memory name, string memory symbol, string memory baseURI, uint256 maxNftSupply, uint256 saleStart) public ERC721(name, symbol) {
        _setBaseURI(baseURI);
        MAX_SUPPLY = maxNftSupply;
        REVEAL_TIMESTAMP = saleStart + 2 hours;
    ...
    */
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(SALE_START <= block.timestamp, "Sale time has not started");
        require(numberOfTokens <= maxPurchase, "Mint exceed maxPurchase at a time");
