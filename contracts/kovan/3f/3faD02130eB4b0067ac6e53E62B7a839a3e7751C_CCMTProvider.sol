...
//    uint256 constant private _AMOUNT_INDEX = 2;
    ...
    constructor(address _limitOrderProtocol, address _feeManager) CCMTTrade(_limitOrderProtocol)
...
contract CCMTToken is ERC721, Ownable {
    ...
    function addNewTrade(address tradeHolder, uint256 uniq_id) onlyOwner public {
...
contract CCMTVault is Ownable {
    ...
    function requestTokenAmountOrRevert(uint256 requestAmount, address fromAsset, address toAsset) public view returns(bool) {
...
contract CCMTTrade is CCMTVault {
    ...
    function createTradeImpl(
        ...
        _swapTo(fromAsset, toAsset, amountWithMargin, amountOutMin, address(this));
    ...
    function closeTradeImpl(uint256 uniq_id) internal {
        ...
        uint256 currentMinPriceOut = _getAmountOutMin(trades[uniq_id].fromAsset, trades[uniq_id].toAsset, trades[uniq_id].depositedWithMargin);

//        if (currentMinPriceOut > trades[uniq_id].fromAsset) {
//            // get fee
//        } else {
//            // just return money
//        }
