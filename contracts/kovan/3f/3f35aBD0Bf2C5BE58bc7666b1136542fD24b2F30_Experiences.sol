...
contract Experiences is ERC721Enumerable, VRFConsumerBase, Ownable {
    ...
    function buy(uint256 _numBuy) external {
        ...
        IERC20(mintableToken).safeTransferFrom(msg.sender, treasury, price * _numBuy);
    ...
    function setMintableToken(address _mintableToken) public onlyOwner {
