...
contract BANANAToken is ERC20, Ownable {
  ...
  function swapTokensForAvax(uint256 tokenAmount) public payable {
    address[] memory path = new address[](2);
    path[0] = address(this);
    path[1] = uniswapV2Router.WETH();

    super._approve(address(this), address(uniswapV2Router), tokenAmount + 10000);
  ...
  function updateRewardOfOneNode(address account, uint256 ID) private whenDistribution {
