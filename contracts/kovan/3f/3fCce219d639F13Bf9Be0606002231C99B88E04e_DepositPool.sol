...
contract DepositPool is Initializable, UUPSUpgradeable, ERC721HolderUpgradeable, ERC20Upgradeable {
    ...
    function isAssetSupported(address erc20) public view returns (bool) {
    ...
    function currentPrice(address base) public view returns (int) {
       (
            , 
            int price,
            ,
            ,
        ) = registry.latestRoundData(base, Denominations.ETH);
        return price;
    }
