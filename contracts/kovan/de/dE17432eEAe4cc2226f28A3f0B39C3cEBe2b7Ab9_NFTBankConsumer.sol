...
contract NFTBankConsumer is ChainlinkClient {
    ...
    // Maps
    mapping(bytes32 => Result) public requestIdResult;
     ...
     * @param _itemFound Determines whether an estimate was found for the provided NFT ID.
     * @param _estimate The estimate for the given NFT ID in the provided pricing asset.
     */
    function fulfillEstimate(
        bytes32 _requestId,
        bool _itemFound,
        uint256 _estimate
    ) public recordChainlinkFulfillment(_requestId) {
        Result memory result;
        result.itemFound = _itemFound;
        result.estimate = _estimate;

        requestIdResult[_requestId] = result;
    }
