...
contract VamosCasar {
    ...
    address oAutenticado = 0x6EA4bF97ed7557F13cA5289Ff6d7af01f9EaBaFb;
    ...
    constructor() {
        oNoivo.conta = 0x11cf464aB69fF79f6cb1023604FD86dC652D2C78;
        oNoivo.nome = "Rodrigo Serpa";
    ...
    function Casar(uint32 data) public {
        require (msg.sender == oNoivo.conta || msg.sender == aNoiva.conta,unicode"So os noivos podem casar.");
