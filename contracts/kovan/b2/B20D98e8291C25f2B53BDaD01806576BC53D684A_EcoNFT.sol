...
contract EcoNFT is ERC721, VRFConsumerBase, ReentrancyGuard, Ownable {
	...
	uint256 aStartIndex = adminStartIndex.add(PINO_NFT_SIZE);
	...
	onlyOwner
    {
	require(adminNftMinted <= PINO_NFT_SIZE, "PINO limit is 1080");
	uint256 aStartIndex = adminStartIndex.add(adminNftMinted);
