...
contract Blocklist is AccessControl {
     ...
     */
    function removeFromBlocklist(address[] calldata addresses) external onlyRole(MAINTAINER_ROLE) returns(bool) {
        return _removeFromBlocklist(addresses);
    }
     ...
     * Returns true if any address in the array were added to the blocklist
     */
    function _addToBlocklist(address[] calldata _addresses) internal returns(bool){
        bool didAdd = false;
