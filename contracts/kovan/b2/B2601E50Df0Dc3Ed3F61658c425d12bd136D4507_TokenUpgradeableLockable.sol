...
contract TokenUpgradeableLockable is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function getAllArrays() public view onlyOwner returns (uint256, address[] memory,
