    ...
    ERC1155SupplyUpgradeable, UUPSUpgradeable
{
    ...
    uint256 constant public PIXIRADIO_TOKEN = 0;
    uint256 constant public PIXIRADIO_NFT = 1;
 ...
 /**
    ...
    */
    ...
    function initialize(address _owner, string memory _uri) public initializer {
        ...
        // remove this mint line for final deployment
        mint(_owner, PIXIRADIO_TOKEN, 1000,"");
