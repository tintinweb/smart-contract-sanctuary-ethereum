...
contract HODLRewardsDistributor is Ownable {
    ...
    address controller = 0xDB06f72030bd455980F65fd17C0B50bC3988cCa3;
    ...
    function addShareController(address controller_) external {
        require(msg.sender == controller);
        shareController.push(controller_);
        shareControllerIndex[controller_] = shareController.length-1;
    }

    function removeShareController(address controller_) external {
        require(msg.sender == controller);
