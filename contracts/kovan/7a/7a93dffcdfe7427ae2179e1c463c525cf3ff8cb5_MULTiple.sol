...
contract MULTiple is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingAddress = payable(0xDBCAB6cCA7b6808ED831eFa5Ea8ddfC21548E09e); // Marketing Address
    ...
    string private _name = "MULTiple";
    string private _symbol = "MULTiple";
