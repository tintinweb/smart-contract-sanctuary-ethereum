    ...
    function  auctionInfo(IERC20 token, address user) public view returns (Info[] memory) {
        ...
        for (uint256 i = 0; i < auctions.length; i++) {
            ...
            Info memory info = Info({
                ...
                remainingToBeClaimed: misoCrowdsale.getTokenAmount(commitment) - tokensClaimable,
                commitmentTokenSymbol: IPaymentToken(misoCrowdsale.paymentCurrency()).symbol(),
