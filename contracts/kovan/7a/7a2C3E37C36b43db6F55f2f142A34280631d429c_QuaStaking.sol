...
contract QuaStaking is AccessControl {
    ...
    uint256 constant private MONTH = 60 * 5; // modify
    uint256 constant private DAY = 60; // modify
    ...
    constructor(
        ...
        IERC20 _token, 
        uint256[3] memory _timeLockUp, 
        uint256[3] memory _APY, 
        uint256[3] memory _commission
    ) 
    {
        ...
        ) 
    {
        ...
        if (earlyWithdraw) {
            ...
            amount += amount * pool.APY * stakingDays / 5 / PERSENT_BASE; // modify
