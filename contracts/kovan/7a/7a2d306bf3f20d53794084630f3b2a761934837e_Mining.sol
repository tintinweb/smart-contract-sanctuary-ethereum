...
contract Mining is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public mine;
    ...
    constructor(IERC20 _pledge, IERC20 _mine, uint _starttime) public LPTokenWrapper(_pledge) {
    ...
    function getReward() public updateReward(msg.sender) checkStart{
        ...
        if (reward > 0) {
            ...
            if(referrer != address(0)) {
                uint256 referrerReward = reward / 10;
                safeMineTransfer(referrer, referrerReward);
            }
