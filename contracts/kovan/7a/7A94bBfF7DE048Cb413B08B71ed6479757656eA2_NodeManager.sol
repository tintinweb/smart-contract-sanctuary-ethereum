...
contract NodeManager is Ownable, IERC721, IERC721Metadata {
    ...
    function createNode(address account, string memory nodeName) external {
        ...
        require(IERC20(purchaseCurrency).allowance(msg.sender, address(this)) > (nodePrice * (10 ** IERC20(purchaseCurrency).decimals())), "MANAGER: Token has not been approved.");
