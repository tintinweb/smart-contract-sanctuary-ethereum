...
// File contracts/misc/swap/SwapHandlerInterface.sol
    ...
    function estimateInternal(
        ...
        if(depositAmount > 0) { 
            ...
            if(collateralUnderlying == borrowUnderlying){
                ...
                repayAmount = amountOutMin.mul(uint(1e18).sub(slippage)).div(1e18);
                path = _path;
            }
            ...
            if(collateralUnderlying == borrowUnderlying){
                ...
                depositAmount = amountInMax.mul(uint(1e18).sub(slippage)).div(1e18);
                path = _path;
            }
