    ...
    UUPSUpgradeable
{
  ...
  //Convert String to Uint
    ...
    function getGameScoreRequestId(uint256 fixtureID) public view returns(bool){
        if (IScorefamConsumer(consumer).gameScoreRequestID(fixtureID)[0] != 0)
            return true;
        return false;
    }
    ...
    function updateGameScore(uint256 fixtureID) public {
        ...
        require(IScorefamConsumer(consumer).gameScoreRequestID(fixtureID)[0] != 0, "Scorefam: Game Data Already Retrieved");
