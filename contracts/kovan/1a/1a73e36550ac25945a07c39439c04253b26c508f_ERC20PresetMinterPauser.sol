 ...
 */
contract ERC20PresetMinterPauser is Context, AccessControlEnumerable, ERC20Burnable, Pausable {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(ERC20) {
        ...
        require( !paused() && !hasRole(PAUSER_ROLE, _msgSender()) , "ERC20Pausable: token transfer while paused" );
    }
}