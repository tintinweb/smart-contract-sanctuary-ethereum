...
contract ERC5050 is ERC721A, Ownable, ReentrancyGuard {
    ...
    address constant public aavecontractAddess= 0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD  ;
...
function burn (uint256 tokenID) external {
        ...
        _burn(tokenID) ;
        aavecontractAddess.call(abi.encodeWithSignature("withdraw(address, uint256, address)", aavecontractAddess,  5000000000000000 , msg.sender ))  ;
}
