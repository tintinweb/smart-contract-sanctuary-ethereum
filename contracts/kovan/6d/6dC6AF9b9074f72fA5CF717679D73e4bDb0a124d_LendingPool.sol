...
contract LendingPool is VersionedInitializable, ILendingPool, LendingPoolStorage {
  ...
  function _executeBorrow(ExecuteBorrowParams memory vars) internal {
    ...
    //require(DataTypes.InterestRateMode(vars.interestRateMode) != DataTypes.InterestRateMode.STABLE);
    uint256 amountInETH =
    ...
    bool isFirstBorrowing = IVariableDebtToken(reserve.variableDebtTokenAddress).mint(
        vars.user,
        vars.onBehalfOf,
        vars.amount,
        reserve.variableBorrowIndex
