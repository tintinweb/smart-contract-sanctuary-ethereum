...
contract FilthyRichCryptoKids is ERC721, Ownable, VRFConsumerBase{
     ...
     */
    uint256 internal link_fee = 0.1 * 10 ** 18 wei; // 0.2 LINK (BSC)
    ...
    address public vaulablesContract;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory){
        ...
        if(tokenId < maxVipSupply){
            ...
            uint tokenId_n = tokenId.add(randomness & n) % n;
            tokenId_n = tokenId_n + maxVipSupply;
