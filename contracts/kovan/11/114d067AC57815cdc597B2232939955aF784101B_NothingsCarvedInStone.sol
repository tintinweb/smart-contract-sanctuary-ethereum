...
contract NothingsCarvedInStone is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Nothing's Carved In Stone", "NCIS") {
    setHiddenMetadataUri("ipfs://QmRrgQ8CmKzLMtyQQnFoPEE9VYoDW8MMXTJHT945TrB11u/hidden.json");
  }
