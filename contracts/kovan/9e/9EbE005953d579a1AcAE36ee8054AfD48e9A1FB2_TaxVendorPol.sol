...
contract TaxVendorPol is Ownable {
    ...
    constructor(address taxTokenAddr) {
        ...
        usdc = IERC20(0xd8f2c30Fab55F464cA8d7e7e1525F96ab6907928);
    ...
    function _resetNumberOfTaxTokenSent() public onlyOwner {
        numberOfTaxTokenSent = 0;
    }

    //  Setting a new amount of TAX tokens to be sent out when swapping.
    //  Again, if needed for any reason.
    function _setTokensToTransfer(uint amount) public onlyOwner {
