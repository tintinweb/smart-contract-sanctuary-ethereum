...
contract BigShort is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Big Short", "SHORT") {
        ...
        taxWallet = address(0xC71D257d9092d2EaA8dCaA7D8Ce24c4a9498420B); // set as tax wallet
        devWallet = address(0x9dEB036115C1c66D2838B31a18edB9269cbdd383); // set as dev wallet
