...
contract DEMOTKN is Initializable,UUPSUpgradeable, ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
...
/// @custom:oz-upgrades-unsafe-allow constructor
    ...
    uint256 mintPrice_, uint256 collectionSize_,
    uint256 whitelistMintMaxSupply_, uint256 maxItemsPerWhiteListedWallet_,
    uint256 maxItemsPerTx_, 
    // bool whitelistMintPaused_,
    // bool publicMintPaused_,
     bytes32 whitelistMerkleRoot_) external initializer {
    ...
    function ownerMintInBatch(BatchMint[] memory batchMint) external  onlyOwner {
