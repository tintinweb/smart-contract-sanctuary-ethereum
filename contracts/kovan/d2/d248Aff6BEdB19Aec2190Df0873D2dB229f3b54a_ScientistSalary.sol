...
import "./interfaces/IScientistSalary.sol";

contract ScientistSalary is IScientistSalary, IAdmin, Ownable {
    ...
    uint256 public override constant genesisBasedSalary = 100;
