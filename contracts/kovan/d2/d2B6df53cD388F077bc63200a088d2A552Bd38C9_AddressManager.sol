...
contract AddressManager is Ownable {
    ...
    mapping(bytes32 => uint256) public networkIndexMap;
    mapping(bytes32 => string[]) public walletAddressesMap;
        ...
        onlyOwner
    {
        ...
        if (addrs.length == 0) {
            ...
            networks[networksIndex] = networks[lastNetworksIndex];
    ...
    /// @dev Public function to retrieve all the networks holding available that have addresses
    function allNetworks() external view returns (string[] memory) {
        return networks;
    }

    // TODO: Add networks length method
