...
contract ERC20 is Context, IERC20Metadata, Ownable { 
    ...
    */
    ...
    //add deposit
    function addDepozit(uint _cantitate, uint _valoare) public onlyOwner {
        Depozite.push(Depozit(_cantitate,_valoare));
    }

    //show deposit
    function showDepozit(uint index) public view returns (uint,uint){
        return (Depozite[index].cantitate, Depozite[index].valoare);
    }
