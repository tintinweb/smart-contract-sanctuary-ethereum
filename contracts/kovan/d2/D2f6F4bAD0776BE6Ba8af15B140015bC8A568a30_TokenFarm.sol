...
contract TokenFarm is Ownable {
    ...
    // map token address to staker address of the amount
    mapping(address => mapping(address => uint256)) public stakingBalance;
    mapping(address => address) public tokenPriceFeed;

    constructor(address dapp_token_address) public {
        dappToken = IERC20(dapp_token_address);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            uint256 userToltalValue = getUserTotalValue(recipient);
            dappToken.transfer(recipient, userToltalValue);
