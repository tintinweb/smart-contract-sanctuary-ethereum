...
contract Token {
    ...
    // Mantiene el estado de los balances aprobados - Keep track balances and allowances approved 
    mapping(address => uint256) public balanceOf;
    mapping(address => mapping(address => uint256)) public allowance;


    // Eventos, estados de cambio - Events - fire events on state changes
    ...
    /// @param _to receiver of token
    /// @param _value amount value of token to send
    //  Función interna que solo puede ser llamada por este contrato 
    //  Internal function transfer can only be called by this contract
    //  Emite el evento Transfer - Emit Transfer Event event 
    function _transfer(address _from, address _to, uint256 _value) internal {
    //  Asegura la validéz de la dirección, 0x0 permite quemar()
    ...
    //  Permite al spender gastar el monto en tu nombre -  Allow _spender to spend up to _value on your behalf
    ...
    //  Permite al _spender gastar en tu nombre - Allow _spender to spend up to _value on your behalf
