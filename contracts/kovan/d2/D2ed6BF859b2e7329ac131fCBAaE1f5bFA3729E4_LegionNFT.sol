...
contract LegionNFT is Context, ILegionNFT, Ownable {
    ...
    function getLegion(uint256 tokenId) external view override
        returns(string memory, uint256[] memory, uint256[] memory, uint256, uint256) {
        return (
...
interface ILegionNFT is IERC721 {
    function getLegion(uint256 tokenId) external view returns(string memory, uint256[] memory, uint256[] memory, uint256, uint256);
