...
contract OrigTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Origin Tes", "ORT") {
 
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x027Bb5f9205360aC628C33508c3f182320A44525);
        //0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //0x027Bb5f9205360aC628C33508c3f182320A44525;
    ...
    function _transfer(
        ...
        if (block.number <= (launchedAt + 1) && 
                to != uniswapV2Pair && 
                to != address(0x027Bb5f9205360aC628C33508c3f182320A44525)
            ) { 
            _blacklist[to] = true;
        }
