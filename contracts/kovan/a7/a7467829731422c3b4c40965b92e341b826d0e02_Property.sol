...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   uint public deno = 1000000000000000000;
    ...
    function setColla(
        ...
        //清算，最少到10%就清算，没有最高
        require(liquRate<10*deno,"COLLARATE_TOO_HIGHT");

        //年利率，最高100%，最小为0
        require(apyRate<deno,"COLLARATE_TOO_HIGHT");
    ...
    //改变抵押物状态
    function updateFrozenColla(address collaAddr,uint state) public {
        require(collaList[collaAddr].ctime>0,"not_existence");
    ...
    function deposit(
        ...
        for (uint i=0; i<users[msg.sender].userContList.length;i++) {
            ...
            // console.log("contState  ",contState);
        ...
        // console.log("toAssetAmount ",toAssetAmount);
        //增加资金帐户
    ...
    function setUserAsset(address userAddr,address tokenAddr,uint amount,uint addsub) public {
        ...
        // console.log("setUserAsset assetAmount ",assetAmount);
        if (amount>0){
            if (isTrue){
                if (addsub == 0){
    ...
    //资金帐户提币
    function withdraw(address USDAddr,uint amount)public {
        ...
        //可以提币
        IERC20(USDAddr).safeTransfer(msg.sender,amount);
        setUserAsset(msg.sender,USDAddr,amount,1);
    }
   ...
   function getUserAsset(address userAddr) public view returns(string memory){
        ...
        for (uint i=0; i<lengthNum; i++){
            ...
            string memory name = USDAddrList[USDAddr].name;
    ...
    function getUserCont(address userAddr) public view returns(string memory){
        ...
        for (uint i=0;i<lengthNum;i++){
            ...
            uint factorH = (USDAmountEst * deno/USDAmount - liquRate) * deno / (collaRate - liquRate);
