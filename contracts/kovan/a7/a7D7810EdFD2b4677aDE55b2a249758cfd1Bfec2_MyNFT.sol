...
contract MyNFT is ERC721, ERC721Enumerable, Ownable, Roadmap {
    ...
    bytes private ancillaryData = bytes(abi.encodePacked(s1, s2));
    ...
    {
        address finderAddress = 0xbb6206fb01fAad31e8aaFc3AD303cEA89D8c8157;
    ...
    function priceSettled(
        ...
        require(timestamp == 123, 'different timestamps');
        require(identifier == priceIdentifier, 'same identifier');
        require(
            keccak256(ancillaryData) == keccak256(ancillaryData),
            'same ancillary data'
        );
