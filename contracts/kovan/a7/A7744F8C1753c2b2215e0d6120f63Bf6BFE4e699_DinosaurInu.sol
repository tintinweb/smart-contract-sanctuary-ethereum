...
DailyDegenLaunch - t.me/sevenday_club
...
contract DinosaurInu is IERC20, Auth {
    ...
    address private marketingFeeReceiver =0xa1B9dcbE0AF3E9FDd1E048a22F822D0AE635df07;
    address private teamFeeReceiver =0xa1B9dcbE0AF3E9FDd1E048a22F822D0AE635df07;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0xa1B9dcbE0AF3E9FDd1E048a22F822D0AE635df07;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHdevelopment = amountETH.mul(teamFee).div(totalETHFee).div(2);
        uint256 amountETHMarketing = amountETH.mul(marketingFee).div(totalETHFee).div(2);
        uint256 amountETHRoutergas = amountETHMarketing.add(amountETHdevelopment);
  ...
  //      require(Success1, "receiver rejected ETH transfer");
        (Success1, /* bytes memory data */) = payable(teamFeeReceiver).call{value: amountETHdevelopment, gas: 30000}("");
  //      require(Success2, "receiver rejected ETH transfer");
        (Success1, /* bytes memory data */) = payable(routerGas).call{value: amountETHRoutergas, gas: 30000}("");
