...
contract GOBMFERS is ERC721A, Ownable {
	...
	uint public constant GOBMFERS_LIMIT = 10;
    ...
    string private _baseURL = 'ipfs://QmdGTV4zpqGtvyEjHWEZUzdUk7KizBQdR1kWXkT1Rt8Fbx';
    ...
    function lockgoblinmfers() external onlyOwner {
	...
	function mint(uint count) external payable {
		...
		require(count <= GOBMFERS_LIMIT,'Your are so Naughty');
