    ...
    INFTXVault
{
    ...
    mapping(uint256 => uint256) public ratio;
    ...
    function setLevel(uint256 idToken, uint256 quality) external override onlyOwner returns(uint256){
    ...
    function setRatio(uint256 quality, uint256 price) external override onlyOwner returns(uint256){
    ...
    function mintTo(
        ...
        if (is1155) {
            ...
            for (uint256 i; i < tokenIds.length; i++) {
                ...
                balance = balance + getRatio(quality) * amount;
            }
            // _mint(to, balance);
        ...
        returns (uint256[] memory)
    {
        ...
        require(amount == specificIds.length, "NFTXVault: Invalid amount");
        ...
        vaultFactory.burnToken(to, balance);
