...
import "../govern-contract-utils/minimal-proxies/ERC1167ProxyFactory.sol";
...
import '../govern-contract-utils/initializable/Initializable.sol';
import '../govern-contract-utils/safe-math/SafeMath.sol';

import './interfaces/IERC20.sol';

// Copied and slightly modified from https://github.com/aragon/aragon-network-token/blob/v2-v1.0.0/packages/v2/token.sol
// Lightweight token modelled after UNI-LP: https://github.com/Uniswap/uniswap-v2-core/blob/v1.0.1/UniswapV2ERC20.sol
// Adds:
...
import "../govern-contract-utils/acl/ACL.sol";
import "../govern-contract-utils/minimal-proxies/ERC1167ProxyFactory.sol";
...
// Copied and modified from: https://github.com/Uniswap/merkle-distributor/blob/master/MerkleDistributor.sol
...
import "../govern-contract-utils/erc20/SafeERC20.sol";
import "../govern-contract-utils/initializable/Initializable.sol";
