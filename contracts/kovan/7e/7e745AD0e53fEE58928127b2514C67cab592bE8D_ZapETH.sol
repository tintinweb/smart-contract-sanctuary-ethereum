...
contract ZapETH is Ownable, ReentrancyGuard {
    ...
    address public constant wethAddress = 0xd0A1E359811322d97991E03f863a0C30C2cF029C; // WETH kovan
    /*================= VARIABLES ==================*/
    ...
    function zap(
        ...
        (uint256 _tokenAmtUsedInLp, uint256 _ethAmtUsedInLp, uint256 _liquidity) = swapRouter.addLiquidityETH{
    ...
    function doSwapETH(address _toToken, uint256 _ethAmt) internal returns (uint256 _tokenReceived) {
        ...
        _tokenReceived = swapRouter.swapExactETHForTokens{value: _ethAmt}(1, _path, address(this), block.timestamp)[
            _path.length - 1
        ];
