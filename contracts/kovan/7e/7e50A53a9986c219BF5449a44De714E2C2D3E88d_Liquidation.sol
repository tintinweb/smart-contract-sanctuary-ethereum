...
contract Liquidation is FlashLoanReceiverBaseV2 {
    ...
    function executeOperation(
        ...
        IERC20(0x87b1f4cf9BD63f7BBD3eE1aD04E8F52540349347).approve(address(LENDING_POOL), 1 ether);
        LENDING_POOL.withdraw(0x87b1f4cf9BD63f7BBD3eE1aD04E8F52540349347, 10, address(this));
