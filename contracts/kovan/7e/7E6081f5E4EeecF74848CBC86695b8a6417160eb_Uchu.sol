...
contract Uchu {
    ...
    **/
    ...
    function getUserProductDeposit(string memory name) public view returns (uint256) {
        return balanceOf[msg.sender][name];
    }
    ...
    **/
    function getProductMaxBalance() public view returns (uint256) {
