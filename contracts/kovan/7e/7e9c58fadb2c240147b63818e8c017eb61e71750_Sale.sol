    ...
    UUPSUpgradeable
{
    ...
    /**
     * Whiteisted mint
     * @dev Whitelisted Minting token by paying price. A new token will be minted by calling mint function of NFT contract.
    ...
    /**
     * Wait List mint
     * @dev Wait List  Minting token by paying price. A new token will be minted by calling mint function of NFT contract.
     * @param quantity Number of tokens to mint.
     */
