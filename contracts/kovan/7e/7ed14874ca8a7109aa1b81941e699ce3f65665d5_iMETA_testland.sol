...
contract iMETA_testland is Initializable, UUPSUpgradeable, OwnableUpgradeable, ERC721URIStorageUpgradeable {
    ...
    function mintQuad(uint256 x, uint256 y) public payable returns(uint) {
        /*
