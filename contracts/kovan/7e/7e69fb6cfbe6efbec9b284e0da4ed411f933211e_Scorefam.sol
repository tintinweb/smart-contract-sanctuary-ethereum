    ...
    UUPSUpgradeable
{
  ...
  //Convert String to Uint
    ...
    function getGameScoreRequest(uint256 game_) external view returns(bytes memory){
       return sc.requestIdData(sc.gameScoreRequestID(_gaming[_msgSender()][game_].fixtureID));    
    }
