...
contract PredictionPool is Ownable {
    ...
    // array of predictionSpec
    predictionSpec[] public predictionsSpec;

    // require the pool is active
    modifier onlyActive {
    ...
    // let admin open the pool
    function openPredictionPool() public onlyOwner {
        isActive = true;
    }

    // let admin close the pool
    ...
    // let any user create a prediction instance (payable)
    ...
    // get Oracle prices with Chainlink
    ...
    // get closest prediction from all participants, based on real oracle price
    ...
    // get winner(s) based on closestPrediction
