...
contract NftBattleArena is Ownable
{
	...
	function chooseWinnerInPair(uint256 pairIndex) external
	{
		...
		uint256 income1 = tokensToShares(tokensAtBattleEnd1 - battleRewardOfToken1.tokensAtBattleStart);
		uint256 income2 = tokensToShares(tokensAtBattleEnd2 - battleRewardOfToken2.tokensAtBattleStart);
