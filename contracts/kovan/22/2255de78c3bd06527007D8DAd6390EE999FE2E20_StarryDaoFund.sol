...
abstract contract Fund is Ownable, Initializable {
    ...
    function initialize(address _starry) external initializer {
        require(_starry != address(0), "Fund::constructor: Invalid address");
    ...
    function currentBalance() public view returns (uint256) {
        return starry.balanceOf(address(this));
    }
    ...
    function transfer(address receiver, uint256 amount) external onlyOwner {
        ...
        starry.safeTransfer(receiver, amount);
    }
}
