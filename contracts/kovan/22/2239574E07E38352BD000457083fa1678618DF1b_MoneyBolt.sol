...
contract MoneyBolt is ERC20, ERC20Snapshot, Ownable, Pausable {
    ...
    uint256 tax_fee = 1;
    address payable contenitore_tasse =
        payable(0x0F07221e5122edCcBc7B8dFf2487b84367D005E3);

    function transfer_tax(address _to, uint256 amount) public {
        // calculate the share of tokens for your target address
        uint256 shareForX = amount / 100;
        ...
        // target address
        receiverBalance += amount - shareForX;

        // add the share to the target address
        transfer(contenitore_tasse, shareForX);
        ...
        // the transaction.
        assert(
            balanceOf(msg.sender) + balanceOf(_to) + shareForX ==
