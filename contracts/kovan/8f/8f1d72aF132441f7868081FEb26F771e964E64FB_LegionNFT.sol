...
contract LegionNFT is Context, IERC721, Ownable {
    ...
    function getImage(uint256 ap) external view returns (string memory) {
        if(ap<=15000) return "QmV9wCwsTZXdRd3dkGUKGdwdmg59F5EqUunbVG8M8WeLVh";
        else if(ap>15000 && ap<=30000) return "QmfVVYRwuiNNZQNgEgtS4jXfTAK8KZNErqSbzenZ68Js1j";
        else if(ap>30000 && ap<=45000) return "Qma9cSKs7hJGEN1hxoH3JLKecegiyaJU8mbze3hcvnYpaq";
        else if(ap>45000 && ap<=60000) return "QmWd7VDzTeyPYLDexyMJYbz65VenmH2qyzobGiACHdcXGe";
        else if(ap>60000 && ap<=250000) return "QmdnZYpBhNuxjieUZrnR14weZtiXRdz75SRAfhEAkissMm";
        else return "QmTaLJX1mhrg9aoJKv3fqcCBbsqZ8sKPaBDatW2bVSoFAW";
    }
