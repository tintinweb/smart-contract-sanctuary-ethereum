...
contract UtilToken is ERC721AUpgradeable, BlackListUpgradeable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IUtilToken{
    ...
    function mint(bytes32[] calldata _merkleProof) external payable override whenNotBlackListedUser(_msgSender()) nonReentrant whenNotPaused {
        ...
        uint256 lastNFTIndex = currentActiveIndex();
    ...
    function burn(uint256 tokenId) external override onlyOwner returns (bool){
        _burn(tokenId);
        return true;
    }
    ...
    function _beforeBurnTokenTransfers(
        address from,
        address to,
        uint256 startTokenId,
        uint256 quantity
    ...
    IERC721EnumerableUpgradeable
{
    ...
    function totalSupply() public view override returns (uint256) {
        return currentIndex - burnedCount;
    }

    function currentActiveIndex() public view returns (uint256) {
        return currentIndex;
    }
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        _beforeBurnTokenTransfers(owner, address(0), tokenId, 1);
    ...
    /**
     * @dev Hook that is called before a set of serially-ordered token ids are about to be transferred before burn. This includes minting.
     *
     * startTokenId - the first token id to be transferred
     * quantity - the amount to be transferred
     *
