...
contract ERC20Voting is MajorityVoting{
    ...
    event StartVoteToCreateVault(uint voteId, uint startDate, uint endDate, string vaultName, address assetAddress, uint quality, uint price);
    event StartVoteToSetRatio(uint voteId, uint startDate, uint endDate, uint quality, uint price);
    event StartVoteToSetLevel(uint voteId, uint startDate, uint endDate, uint idToken, uint quality);
    ...
    function newVoteToCreateVault(
        ...
        emit StartVoteToCreateVault(voteId, _startDate, _endDate, vaultName, assetAddress, quality, price);
    }
    ...
    function newVoteToSetRatio(
        ...
        uint voteId = this.newVote(_actions, _startDate, _endDate, _choice);
        emit StartVoteToSetRatio(voteId, _startDate, _endDate, quality, price);
    }
    ...
    function newVoteToSetLevel(
        ...
        uint voteId = this.newVote(_actions, _startDate, _endDate, _choice);
        emit StartVoteToSetLevel(voteId, _startDate, _endDate, idToken, quality);
    }
