 ...
 */
contract SmartzipConsumer is ChainlinkClient {
    ...
    function fulfillPrice(bytes32 _requestId, uint256 _avm) public recordChainlinkFulfillment(_requestId) {
        requestIdData[_requestId] = _avm;
    }
