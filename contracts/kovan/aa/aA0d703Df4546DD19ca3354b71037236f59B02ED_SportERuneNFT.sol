...
contract SportERuneNFT is SportEERC721LazyMint, AccessControlEnumerable {
    ...
    modifier onlyMinter() {
        require(
            ...
            "SportERuneNFT: Must be have minter role"
        );
        _;
    }

    constructor() SportEERC721LazyMint("SportE Rune NFT", "SPORTERUNE") {
    ...
    function mint(address to) public virtual {
        require(
            hasRole(MINTER_ROLE, _msgSender()),
            "SportERuneNFT: must have minter role to mint"
        );
    ...
    function mintBatch(address[] memory accounts) public virtual {
        ...
        require(length > 0, "SportERuneNFT: array length is invalid");
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        return SportEERC721Enumerable.supportsInterface(interfaceId);
    }
}
