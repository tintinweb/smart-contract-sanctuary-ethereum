...
contract LaunchPadFund is Ownable {
    ...
    modifier onlyDistributor() {
        require(distributor == _msgSender(), "Only distributor can request transfer");
        _;
    }
    ...
    function transferTo(
        ...
        if (_amount > 0) {
            IERC20(_token).safeApprove(msg.sender, 0);
    ...
    event DistributorUpdated(address _newComptroller);
}