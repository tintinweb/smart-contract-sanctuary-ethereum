...
import { SignatureVerifier_V3 } from "../NFT/SignatureVerifier/SignatureVerifier_V3.sol";

contract TransactionForwarder is SignatureVerifier_V3, Ownable {
    ...
    constructor(address signer) SignatureVerifier_V3(signer) {}
