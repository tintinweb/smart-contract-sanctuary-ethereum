 ...
 */
contract DRPocConsumer is ChainlinkClient {
    ...
    function fulfillRequest(bytes32 _requestId, bool _result) external recordChainlinkFulfillment(_requestId) {
        requestIdResult[_requestId] = _result;
    }

    function requestTest1(bytes32 _specId, uint256 _payment) external {
        ...
        uint256 expiration = block.timestamp + getExpiryTime;
        emit OracleRequest(
            _specId,
            msg.sender,
            requestId,
