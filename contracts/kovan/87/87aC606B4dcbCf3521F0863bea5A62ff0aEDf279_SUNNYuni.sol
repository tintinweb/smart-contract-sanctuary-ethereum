...
contract SUNNYuni is Context, IERC20, Ownable {
    ...
    uint256 private _redisFeeOnBuy = 7;
    ...
    string private constant _name = "SUNNYinu1";
    string private constant _symbol = "SNI1";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xa8079bEe8566cFFc3c55807faeCa4443EAdbC7c2);
    address payable private _marketingAddress = payable(0x679A5218a12b962743C784298e3363e7250ca1f1);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    ...
	    require(redisFeeOnSell < 111, "Redis cannot be more than 10.");
	    require(taxFeeOnBuy < 11, "Tax cannot be more than 10.");
	    require(taxFeeOnSell < 11, "Tax cannot be more than 10.");
