...
contract OpsNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Royalty, Ownable {
    ...
    function tokenDetails(uint256 _tokenId) public view returns (address, string memory, uint256, address, uint256) {
        ...
        return (nftOwner, tokenMetadata, amount, nftCreator, _tokenId);
    }
    ...
    function redeemEthFromNFT(uint256 _tokenId) external isInitialized {
        (address nftOwner, string memory tokenMetadata, uint256 amount, address nftCreator, uint256 tokenId) = tokenDetails(_tokenId);
