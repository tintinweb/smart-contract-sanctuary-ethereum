...
//function finalize() public onlyOperator nonReentrant {function finalizeTimeExpired() public view returns (bool) {
...
contract BatchAuction is ReentrancyGuard {
  ...
  /// @notice Withdraw cap 
  /// TODO: comment
  uint256 public WITHDRAW_CAP_MIN_THRESHOLD = 0.1 ether;
  uint256 public WITHDRAW_CAP_MAX_THRESHOLD = 1.5 ether;
  uint256 public WITHDRAW_CAP_LIMIT = 1.5 ether;
  uint256 public WITHDRAW_CAP_INTERCEPT = 285714290000000000000;
  uint256 public WITHDRAW_CAP_PLUS = 714285710000000000000;
  ...
  constructor(address _operator) {
    OPERATOR = _operator;
    WITHDRAW_CAP_MIN_THRESHOLD = 0.1 ether;
    WITHDRAW_CAP_MIN_THRESHOLD = 1.5 ether;
  ...
  function withdrawCap(uint256 _userAccumulated) internal view returns (uint256) {
    if (_userAccumulated <= WITHDRAW_CAP_MIN_THRESHOLD) {
      ...
      return accumulatedTotalInETH.mul(WITHDRAW_CAP_INTERCEPT).add(WITHDRAW_CAP_PLUS);
    } else {
