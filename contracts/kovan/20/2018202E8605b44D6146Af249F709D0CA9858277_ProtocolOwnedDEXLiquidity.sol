...
interface IMultiFeeDistributionFake {
...
contract ProtocolOwnedDEXLiquidity is Ownable {
    ...
    IUniswapLPToken public lpToken = IUniswapLPToken(0xC4cbedE6C5cc7D0C775AdFC76803c5888c1530f0);
    IERC20 public gFTM = IERC20(0xC834Dde677cCc13c6F7Ce55Ca1ce0b7108f8ACC6);
    IMultiFeeDistributionFake public treasury;
    ...
    constructor(
        ...
        address multifeeController
    ) Ownable() {
        IChefIncentivesController chef = IChefIncentivesController(incentivesController);
        treasury = IMultiFeeDistributionFake(multifeeController);
