...
contract ProtocolFarm is Ownable {
    ...
    // Issue protocol tokens based on staker TVL
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            protocolToken.transfer(recipient, userTVL);
        }
    }
    ...
    // What tokens can be staked? How much can be staked?
    ...
    function unstakeTokens(address _token, uint256 _amount) public {
        ...
        require(
            balance >= _amount,
            "Amount is greater than balance. Please decrease amount."
        );
    ...
    // Updates the amount of tokens a user has staked. This function is used to help
    // decide if a staker should be pushed on to the stakers array that is used to
    // issue protocol tokens.
