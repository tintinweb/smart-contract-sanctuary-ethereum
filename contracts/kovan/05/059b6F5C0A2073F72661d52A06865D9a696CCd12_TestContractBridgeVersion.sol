    ...
    ReforgeBridgeUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        __ReforgeBridgeUpgradeable_init(
            2000000000000000,
            payable(0xbE35035bbC968cFC28Cf7F6359d3223f78375445) //Dima's acc
    ...
    function setBridgeOwner(address payable account)
        ...
        onlyRole(ADMIN_eEUR)
    {
        _setBridgeOwner(account);
    }

    /**
     * @dev set minimal value of bridge transaction fee
     */
    function setMinimumFee(uint256 fee) external onlyRole(ADMIN_eEUR) {
    ...
    AccessControlUpgradeable
{
     ...
     */
    uint256 internal _minimumBridgeFee;
     ...
     * @param account address of new bridgeOwner
     */
    function _setBridgeOwner(address payable account) internal {
