...
contract MerkleDistributor is IMerkleDistributor {
    ...
    function concentAndAgreeToTerms(uint256 index, uint256 amount, bytes32 terms, bytes32[] calldata merkleProof) external override {
...
interface IMerkleDistributor {
    ...
    // Approves T&Cs
    function concentAndAgreeToTerms(uint256 index, uint256 amount, bytes32 terms, bytes32[] calldata merkleProof) external;
