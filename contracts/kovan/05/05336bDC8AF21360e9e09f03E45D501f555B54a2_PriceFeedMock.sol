...
contract PriceFeedMock is PriceFeed {
    ...
    function getLatestPriceUSD(address _token) public override  view returns (int256) {
    ...
    function getLatestPriceUSDOriginal(address _token) public  view returns (int256) {
...
contract PriceFeed is Ownable{
    ...
    constructor() Ownable(){
        // WETH (ETH)
        priceFeedAddresses[0xd0A1E359811322d97991E03f863a0C30C2cF029C] = 0x10b3c106c4ed7D22B0e7Abe5Dc43BdFA970a153c;
        // DAI
        priceFeedAddresses[0x04D8A950066454035B04FE5E8f851F7045F0E6B3] = 0xB27bC5473C9c18e9860f520E6A554e23bb675eba;
    }
     ...
     */
    function getLatestPriceUSD(address _token) public view virtual returns (int) {
