...
contract UsingERC777 is IERC777Sender, IERC777Recipient, ERC1820Implementer {
    ...
    function deposit(uint256 _amount) external {
        ...
        IERC777(token).send(address(this), _amount, "");
    ...
    function registerHookForAccount(address _account) public {
