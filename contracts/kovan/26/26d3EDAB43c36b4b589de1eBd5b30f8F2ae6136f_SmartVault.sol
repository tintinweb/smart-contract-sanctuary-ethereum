...
contract SmartVault is ERC721PresetMinterPauserAutoId, Ownable {
    ...
    function distributeFungibleAssets(uint256 _vaultId) private {
        ...
        if (smartVaults[_vaultId].fungibleAssets.length > 0) {
            for (i=0;i<smartVaults[_vaultId].fungibleAssets.length;i++){
                ...
                // test if transferFrom is available
                if(smartVaults[_vaultId].fungibleAssets[i].transferFrom(
                            smartVaults[_vaultId].owner,
                            smartVaults[_vaultId].beneficiaries[0].beneficiary,
                            0)
                ) {
                    for (j=0;j<smartVaults[_vaultId].numBeneficiaries-1;j++){    
                        ...
                        _valueDistributed += _valueToDistribute*smartVaults[_vaultId].beneficiaries[j].percentage/100;
                    }
                //no dust
                smartVaults[_vaultId].fungibleAssets[i].safeTransferFrom(
                        smartVaults[_vaultId].owner,
                        smartVaults[_vaultId].beneficiaries[smartVaults[_vaultId].numBeneficiaries-1].beneficiary,
                        _valueToDistribute-_valueDistributed
                    );
                }
                fungibleAssetsOfOwner[smartVaults[_vaultId].owner][smartVaults[_vaultId].fungibleAssets[i]] = false;
            }
    ...
    function distributeNonFungibleAssets(uint256 _vaultId) private {
        ...
        if (smartVaults[_vaultId].numNonFungibleAssets > 0) {
            for (i=0;i<smartVaults[_vaultId].numNonFungibleAssets;i++) {
                if (smartVaults[_vaultId].nonfungibleAssets[i].nonfungibleAddress.isApprovedForAll(smartVaults[_vaultId].owner, address(this)) ||
                    smartVaults[_vaultId].nonfungibleAssets[i].nonfungibleAddress.getApproved(smartVaults[_vaultId].nonfungibleAssets[i].tokenid) == address(this)) {
    ...
    // function distributeBalance(uint256 _vaultId) private {
    //     uint256 j;
    ...
    //     uint256 _totalBalanceToDistribute = vaultBalance[smartVaults[_vaultId].owner][_vaultId]-_processingFee-_trusteeIncentiveValue; //*(100-(processingFee+trusteeIncentive))/100;
    //     uint256 _partialBalanceToDistribute;

    //     payable(owner()).transfer(_processingFee); //*processingFee/100);
    ...
    //     }
    //     //no dust
    //     payable(smartVaults[_vaultId].beneficiaries[smartVaults[_vaultId].numBeneficiaries].beneficiary).transfer(vaultBalance[smartVaults[_vaultId].owner][_vaultId]);
    ...
    function executeSmartVault(uint256 _vaultId) public onlyVaultReadyAndTrustees(_vaultId) {
        ...
        //         smartVaults[_vaultId].fungibleAssets[i].safeTransferFrom(
        //                 smartVaults[_vaultId].owner,
        //                 smartVaults[_vaultId].beneficiaries[smartVaults[_vaultId].numBeneficiaries].beneficiary,
        //                 _valueToDistribute-_valueDistributed
        //             );
        //         fungibleAssetsOfOwner[smartVaults[_vaultId].owner][smartVaults[_vaultId].fungibleAssets[i]] = false;
                ...
                //         smartVaults[_vaultId].owner,
                //         smartVaults[_vaultId].beneficiaries[0].beneficiary,
                //         smartVaults[_vaultId].fungibleAssets[i].balanceOf(smartVaults[_vaultId].owner)
                //                 .min(smartVaults[_vaultId].fungibleAssets[i].allowance(smartVaults[_vaultId].owner, address(this)))
                //     );
        //     }
        // }
