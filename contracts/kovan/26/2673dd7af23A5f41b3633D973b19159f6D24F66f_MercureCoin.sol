...
contract MercureCoin is ERC20("Mercure","MRC"), Ownable {
    ...
    address ownerAddress = 0x9C37c140469452f7f3c6DaCdF40C12c3c0CbB438;

    uint24 public price1 = 3500000;
    uint24 public price2 = 5000000;
    uint24 public price3 = 7000000;
    ...
    uint constant beginingThirdPeriod = 1664575200; //Sat Oct 01 2022 00:00:00 GMT+0200
    uint constant endICO = 1669849199; //Wed Nov 30 2022 23:59:59 GMT+0100


    function setPrice1(uint8 newPrice) public onlyOwner (){
        price1 = newPrice;
    }

    function setPrice2(uint8 newPrice) public onlyOwner (){
        price2 = newPrice;
    }

    function setPrice3(uint8 newPrice) public onlyOwner (){
        price3 = newPrice;
    }

    constructor(){
        priceFeed = AggregatorV3Interface(0x9326BFA02ADD2366b30bacB125260Af641031331); //Kovan testnet. Mainnet : 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419 
    ...
    function buyToken() public payable {
        ...
        uint256 _nbOfCoin;
        uint24 _priceCoinUsd;
        uint256 totalValueUSDSent = msg.value * uint256(_price);

        require(totalValueUSDSent >= 90000000000,"You have to provide at least 900 $USD in ETH");
        require(forSale > 0,"No more token in sale");

        if (_currentTimestamp < beginingSecondPeriod){
        ...
        if (_leftToken < _nbOfCoin){
            ...
            uint256 _ethToReturn = (_diff * _priceCoinUsd * (10**decimals())) / uint(_price) ;
    ...
    //In case not all toke has been claimed
    function claimRemaingCoins() public onlyOwner () {
