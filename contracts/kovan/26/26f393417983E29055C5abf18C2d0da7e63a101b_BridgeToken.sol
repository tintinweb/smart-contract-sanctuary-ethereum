    ...
    UUPSUpgradeable
{
    ...
    mapping(address => SwapToken) internal swapTokens;
    ...
    /// @dev Set token address for bridging
    /// @param token address of contract for bridging
    ...
    // function mintAdmin(address to, uint256 amount)
    //     public
    //     onlyRole(MINTER_ROLE)
    // {
    //     (bool success, ) = _token.call(
    //         abi.encodeWithSignature("whitelist(to)", to)
    //     );
    //     require(success, "Address is not in whitelist");
    //     _mint(to, amount);
    // }
     ...
     */
    function addSupportedChainId(uint256 chainId) public onlyRole(BRIDGE_ROLE) {
    ...
    function swap(address token, uint256 amount) public {
        ...
        // Burn the old token.
        // ERC20BurnableUpgradeable swapToken = ERC20BurnableUpgradeable(
