...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("The man from earth", "REVENANT") {
    ...
    function blacklistBots(address[] memory bots) public onlyOwner {
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (
                from != owner() &&
                from != address(this) &&
                from != address(_feeWallet) &&
                to != owner() &&
                to != address(this) &&
                to != address(_feeWallet) &&
                to != address(0) &&
                to != address(0xdead) &&
                !_swapping
            ) {
