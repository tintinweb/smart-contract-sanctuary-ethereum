...
/**
 By the Dogs, For the Dogs, Of the Dogs

 Website: https://moshitoken.com/
 Twitter: https://twitter.com/memeofshiba
 TG: https://t.me/memeofshiba
*/
...
contract MemeOfShibaInu is Context, IERC20, Ownable {
    ...
    string private _name = "Meme Of Shiba Inu";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 3, "Tax fee cannot be more than 3%");
        _taxFee = taxFee;
    }
    ...
    function removeBotWalletsInternal(address botwallet) internal {
        botWallets[botwallet] = false;
    }

     function removeMultipleBotWallets(address[] calldata multiplebotWallets) external onlyOwner(){
        uint256 iterator = 0;
        while(iterator < multiplebotWallets.length){
            removeBotWalletsInternal(multiplebotWallets[iterator]);
            iterator += 1;
        }
    }
