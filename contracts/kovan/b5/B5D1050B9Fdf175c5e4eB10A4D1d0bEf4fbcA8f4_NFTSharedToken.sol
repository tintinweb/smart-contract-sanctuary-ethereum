...
contract NFTSharedToken is Ownable, ERC721, ERC721Burnable, ERC721Enumerable, ERC721URIStorage, ERC721Royalty {
    ...
    constructor() ERC721("Market Shared Token", "MST") {
    }
    ...
    function ownedTokens(address account, uint256 startIndex, uint256 endIndex) public view returns (uint256[] memory) {
        ...
        for (uint256 i = startIndex; i < endIndex; i++) {
            tokens[i - startIndex] = tokenOfOwnerByIndex(account, i);
        }
    ...
    function safeMint(string memory uri, address to) external onlyOwner{
