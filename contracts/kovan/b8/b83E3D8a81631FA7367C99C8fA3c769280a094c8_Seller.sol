...
contract Seller is AccessControl, ReentrancyGuard {
    ...
    function buyToken(uint256 amount) external payable nonReentrant {
    ...
    function calculateAmount(uint256 amount) external view returns(uint256) {
