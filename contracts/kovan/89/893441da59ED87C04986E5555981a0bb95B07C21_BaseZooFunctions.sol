...
contract BaseZooFunctions is Ownable, VRFConsumerBase
{
	...
	uint256 public firstStageDuration = 1 hours;        //todo:change time //3 days;    // Duration of first stage(stake).
	uint256 public secondStageDuration = 1 hours;       //todo:change time //7 days;    // Duration of second stage(DAI).
	uint256 public thirdStageDuration = 1 hours;        //todo:change time //2 days;    // Duration of third stage(Pair).
	uint256 public fourthStageDuration = 1 hours;       //todo:change time //5 days;    // Duration fourth stage(ZOO).
	uint256 public fifthStageDuration = 1 hours;        //todo:change time //2 days;    // Duration of fifth stage(Winner).
...
contract NftBattleArena is Ownable, ERC721
{
		...
		) Ownable() ERC721("ZooBattle", "zBat")
	{
		...
		epochStartDate = block.timestamp + 20 hours;	//todo:change time for prod + n days; // Start date of 1st battle.
	}
