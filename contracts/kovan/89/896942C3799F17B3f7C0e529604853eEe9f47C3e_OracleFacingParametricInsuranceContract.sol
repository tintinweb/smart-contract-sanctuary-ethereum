...
contract OracleFacingParametricInsuranceContract is InsuranceContract {
    constructor(address payable _client, uint _duration, uint _premium, uint _payoutValue, 
                address _link, uint256 _oraclePaymentAmount) InsuranceContract(_client, _duration, _premium, _payoutValue, 
             _link, _oraclePaymentAmount)  {
