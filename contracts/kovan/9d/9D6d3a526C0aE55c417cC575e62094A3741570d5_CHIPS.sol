...
contract CHIPS is Initializable, ERC20Upgradeable, OwnableUpgradeable{
    ...
    // Tax Fee 
    uint256 public constant buyTax = 2;
    uint256 public constant sellTax = 8; 

    // Tax Fee Percentages to redistribute 
    uint256 public constant liquidityPercentage = 35;
    uint256 public constant treasuryPercentage = 25;
    uint256 public constant stakingRewardPercentage = 40;
    ...
    function _transfer(address from,address to,uint256 amount)internal override{
        ...
        distributeTaxAmount(amount);
    }

    function distributeTaxAmount(uint256 amount) public {
        ...
        lp += amount.mul(liquidityPercentage).div(100);
        if(lp > 10000000000){
            addLiquidity(lp, address(this).balance);
            lp = 0;
        }
    ...
    function distribute() external onlyOwner{
        ...
        // setTeamAddress(0x7023A483443785B7A06ae15D0f6544a22E09d374);
        // setTreasuryAddress(0x213252E60A29d0f35D9CD31E10B6DAEC826010f0);
        // setStakeRewardAddress(0x56A751409eFf7fC24E240f8031c1f0CdFAf76978);
