...
contract AirdropFund is Ownable {
    uint256 public constant ALLOCATION = 1_500_000 ether; //5%
    using SafeERC20 for IERC20;
    uint256 public claimedAmount;
    ...
    function transfer(address _receiver, uint256 _amount) external {
        require(_receiver != address(0), "AirdropFund::transfer: Invalid address");
        require(_amount > 0, "AirdropFund::transfer: Invalid amount");
        require(_amount <= claimable(), "AirdropFund::transfer: > vestedAmount");
    ...
    function setMinter(address _rewardMinter) external onlyOwner {
        require(_rewardMinter != address(0), "AirdropFund::setMinter: Invalid address");
        require(address(rewardMinter) == address(0), "AirdropFund::setMinter: Can redefine rewardMinter");
