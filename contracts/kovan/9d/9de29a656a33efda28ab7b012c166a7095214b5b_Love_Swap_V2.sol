...
contract Love_Swap_V2 is DydxFlashloanBase {
    ...
    address uniRouter = 0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45;
    address DAIAddress = 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa;
    address BATAddress = 0x1a23a6BfBAdB59fa563008c0fB7cf96dfCF34Ea1;
    address WETHAddress = 0xd0A1E359811322d97991E03f863a0C30C2cF029C;
    address dydxAddress = 0x4EC3570cADaAEE08Ae384779B0f3A45EF85289DE;
    ...
    constructor () public {
        ...
        IERC20(DAIAddress).safeApprove(sushiRouter, 10000000000000000);
        IERC20(DAIAddress).safeApprove(uniRouter, 10000000000000000);
    }
    ...
    function setSushiRouter(address _sushiRouter) public onlyOwner {
    ...
    function callFunction(
        ...
        for(uint256 i = 0; i < loopTimes; i++) {
            CoFiXRouter(sushiRouter).swapExactETHForTokens{value:cofixETHSapn}(DAIAddress,cofixETHSapn.sub(nestPrice),1,address(this), address(this), uint256(block.timestamp).add(100));
        }
        // USDT->ETH
        uint256 usdtBalance = IERC20(DAIAddress).balanceOf(address(this));
        address[] memory uniData = new address[](2);
        uniData[0] = address(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa);
