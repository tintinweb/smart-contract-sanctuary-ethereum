...
abstract contract MarketToken is AbstractMarketToken{
     ...
     */
    function liquidateBorrowInternal(address borrower, uint repayAmount, MarketToken marketTokenCollateral) internal nonReentrant {
        accrueInterest();
        ...
        liquidateBorrowFresh(msg.sender, borrower, repayAmount, marketTokenCollateral);
    }
     ...
     * @param repayAmount The amount of the underlying borrowed asset to repay
     */
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, MarketToken marketTokenCollateral) internal  {
     ...
     * @param addAmount Amount of addition to reserves
     */
    function _addReservesFresh(uint addAmount) internal {
...
// File contracts/misc/isolation/PoolMarketTokenEther.sol


pragma solidity ^0.8.0;


contract PoolMarketTokenEther is MarketToken {

    PoolFundManagerInterface public fundManager;
    uint public cashPrior;
    ...
    function initialize(ComptrollerInterface comptroller_,
        ...
        address underlying_ = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
    ...
    function mint() external payable {
        ...
        cashPrior = cashPrior + msg.value;
        fundManager.mint{value:msg.value}(msg.sender, msg.value);
    }
    ...
    function redeem(uint redeemTokens) external returns (uint) {
        ...
        cashPrior = cashPrior - redeemAmount;
    ...
    function borrow(uint borrowAmount) external returns (uint) {
        ...
        cashPrior = cashPrior - borrowAmount;
    ...
    function repayBorrow() external payable {
        ...
        fundManager.repayBorrow{value:msg.value}(msg.sender, msg.value);
    }
    ...
    function repayBorrowBehalf(address borrower) external payable {
        ...
        fundManager.repayBorrow{value:msg.value}(borrower, msg.value);
    }
     ...
     *  The collateral seized is transferred to the liquidator.
     * @dev Reverts upon any failure
     * @param borrower The borrower of this marketTokenCollateral to be liquidated
     * @param marketTokenCollateral The market in which to seize collateral from the borrower
     */
    function liquidateBorrow(address borrower, MarketToken marketTokenCollateral) external payable {

        liquidateBorrowInternal(borrower, msg.value, marketTokenCollateral);

        cashPrior = cashPrior + msg.value;

        fundManager.liquidateBorrow{value:msg.value}(borrower, msg.value);
    } 
    ...
    receive() external payable {
        ...
        if(msg.sender != address(fundManager)){
            mintInternal(msg.value);
            cashPrior = cashPrior + msg.value;
            fundManager.mint{value:msg.value}(msg.sender, msg.value);
        }
    ...
    function getCashPrior() internal override view returns (uint) {
        return cashPrior + totalReserves;
    }
