...
contract TokenNFT is TokenNFTStorage, OwnableUpgradeable, ERC721EnumerableUpgradeable, ERC721PausableUpgradeable, ERC2981Upgradeable, ITokenNFT {
    ...
    */
    function reserve(uint256 _number) public whenNotPaused creatorOnly {
        ...
        require(totalMinted.add(_number) <= maxSupply, "TokenNFT: too much tokens to mint");
    ...
    */
    function withdraw() external payable {
        ...
        (success, ) = (feesCollectorAddress).call{value: biAmount}("");
        require(success, "Transfer failed.");
        // creator fees
        uint256 creatorAmount = balance.sub(biAmount);
        (success, ) = (creatorAddress).call{value: creatorAmount}("");
        require(success, "Transfer failed.");
    }
