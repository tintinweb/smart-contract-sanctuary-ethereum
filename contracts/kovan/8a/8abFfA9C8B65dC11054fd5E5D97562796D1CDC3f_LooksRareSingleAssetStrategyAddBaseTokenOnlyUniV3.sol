...
contract LooksRareSingleAssetStrategyAddBaseTokenOnlyUniV3 is
  Ownable,
  ReentrancyGuard,
  IStrategy
{
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "LooksRareSingleAssetStrategyAddBaseTokenOnlyUniV3::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function execute(
    ...
    IWorker02UniV3 worker = IWorker02UniV3(msg.sender);
    ...
    require(
      ...
      "LooksRareSingleAssetStrategyAddBaseTokenOnlyUniV3::execute:: insufficient farmingToken amount received"
    );
