...
contract PrimeToken is ERC20PresetFixedSupply, AccessControl, ReentrancyGuard {
     ...
     */
    constructor() ERC20PresetFixedSupply(NAME, SYMBOL, SUPPLY, msg.sender) {
     ...
     */
    function addConfigurator(address _newAddr)
        external
        onlyRole(INVOKE_ECHELON_CONFIGURATION_ROLE)
    {
        require(
            _newAddr != address(0),
            "Configuration addresses cannot be 0x0"
        );
     ...
     */
    function removeConfigurator(address _rmvAddr)
        external
        onlyRole(INVOKE_ECHELON_CONFIGURATION_ROLE)
    {
