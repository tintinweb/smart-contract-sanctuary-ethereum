...
contract Liquidator is IUniswapV3FlashCallback, PeripheryImmutableState, PeripheryPayments {
    ...
    function uniswapV3FlashCallback(
        ...
        for (uint i = 0; i < assets.length; i++) {
            ...
            console.log("buyCollateral done");
            uint256 amountOut = swapCollateral(asset);
            console.log("swapCollateral done");
    ...
    function initFlash(FlashParams memory params) external {
        ...
        console.log("poolKey.token0: %s", poolKey.token0);
        console.log("poolKey.token1: %s", poolKey.token1);
        console.log("poolKey.fee: %s", poolKey.fee);
        ...
        console.log("pool: %s", pool.token0());
        console.log("pool: %s", pool.token1());

        console.log("initFlash 4");
        console.log("totalBaseAmount: %s", totalBaseAmount);
