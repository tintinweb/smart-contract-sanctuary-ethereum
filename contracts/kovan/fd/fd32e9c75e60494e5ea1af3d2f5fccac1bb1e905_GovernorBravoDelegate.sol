...
contract GovernorBravoDelegate is Initializable,UUPSUpgradeable,GovernorBravoDelegateStorageV2, GovernorBravoEvents {
    ...
    uint public constant quorumVotes = 1; // 50
    ...
    /**
      ...
      */
    function initialize(address timelock_, address uRvlt_, uint votingPeriod_, address treasury_, uint proposalPeriod_, uint rvltPriceProposal_, address _adminOwner) public initializer{
