...
contract PrecogV5 is IPrecogV5 {
    ...
    function addLiquidityPool(address token) external onlyAdmin {
        ...
        cyclesChangedInfo[token] = CyclesChangedInfo(lastTradingCycle.endTime, _now, _now, cycleConfig.fundingCycle, cycleConfig.firstDefundingCycle, cycleConfig.defundingCycle);
