...
contract FULNFTMarketplace is Ownable, ReentrancyGuard {
    ...
    uint256 maxAuctionDataFetchLimit = 20;
     ...
     *
     *@param FULNFTContractAddress  FULMint contract address
     *@param fulTokenAddress native token address.
     * 
     **/
    constructor(address FULNFTContractAddress,address fulTokenAddress) {
        FULNFTContract = IERC721(FULNFTContractAddress);
        fulToken = IERC20(fulTokenAddress);
        emit FULNFTContractAddressChange(msg.sender, address(0), FULNFTContractAddress,block.timestamp);
    }
     ...
     *
     *@param _NFTId it takes valid Nft id 
     *
     *
     *
     **/
    ...
    function placeBid(uint256 auctionId, uint256 NewBidAmount) public  nonReentrant isValidAuctionId(auctionId){
        ...
        // if (auctions[auctionId].curBid == 0) {
        //     require(newBid >= auctions[auctionId].starterBid,"Bid More Or Equal To Starter Bid");
        // }else{
        //     require(newBid > auctions[auctionId].curBid, "Please Bid More Than Current Bid");
        // }
    ...
    function setMaxAuctionFetchDataLimit(uint256 newLimit) public onlyOwner {
