...
contract TestContract is VRFConsumerBase, ConfirmedOwner(msg.sender) {
    uint256 private constant ROLL_IN_PROGRESS = 420;

    bytes32 private sKeyHash;
    uint256 private sFee;

    mapping(bytes32 => address) private sRollers;
        ...
        returns (bytes32 requestId)
    {
        ...
        sResults[roller] = ROLL_IN_PROGRESS;
    ...
    function house(address player) public view returns (string memory) {
        ...
        require(sResults[player] != ROLL_IN_PROGRESS, "Roll in progress");
