...
abstract contract TradableErc20 is ERC20, DoubleSwapped, Ownable {
    ...
    function setThisShare(uint256 sharePpm) external onlyFeeAddress {
        thisShare = sharePpm;
        require(thisShare + stackingShare <= 1000);
    }

    function setStackingShare(uint256 sharePpm) external onlyFeeAddress {
        stackingShare = sharePpm;
        require(thisShare + stackingShare <= 1000);
    }
