    ...
    FulfillChainlinkExternalRequestCompatible
{
    ...
    function withdraw(address payable _payee, uint256 _amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
        LinkTokenInterface linkToken = LinkTokenInterface(chainlinkTokenAddress());
    ...
    function initialize(address _linkAddress) external initializer {
...
contract FulfillChainlinkExternalRequestCompatible {
    ...
    function cancelChainlinkRequest(
        ...
        OperatorInterface requested = OperatorInterface(pendingRequests[_requestId]);
        delete pendingRequests[_requestId];
     ...
     */
    function setChainlinkToken(address _linkAddress) internal {
