...
contract Marketplace is Ownable, ReentrancyGuard
{
    ...
    event SaleChangedEndingIndex(uint SaleIndex, uint OldEndingIndex, uint NewEndingIndex);
    ...
    event SaleChangedActiveStateBrightList(uint SaleIndex, bool OldState, bool NewState);
    ...
    { 
        ...
        require(Sales[SaleIndex].StartingIndex + 1 <= Sales[SaleIndex].EndingIndex, "Sold Out");
        require(
    ...
    function _StartSale(Sale memory NewSaleInstance) external onlyBRTOperator
    {
        ...
        require(NewSaleInstance.ERC_TYPE == 721 || NewSaleInstance.ERC_TYPE == 1155, "Incorrect ERC Type. (721 for ERC721) or (1155 for ERC1155)");
    ...
    {
        //Auto-Increments The Unique Sale Index
        uint StartingSaleIndex = UniqueSaleIndex+1;
        
        //Checks Passed Variables
        for(uint i; i < NewSaleInstance.length; i++)
        {
            require(NewSaleInstance[i].ERC_TYPE == 721 || NewSaleInstance[i].ERC_TYPE == 1155, "Incorrect ERC Type. (721 for ERC721) or (1155 for ERC1155)");
            UniqueSaleIndex++; 
     ...
     * note: `8. ERC_TYPE (721 for ERC721) || (1155 for ERC1155)`
     * note: `9. ContractAddress` Of NFT
     * note: `10. Operator`
     * note: `11. Merkle Root` 
     * note: `12. Is Sale Public Active`
     * note: `13. Is Sale BrightList Active`
     * note: `14. Allow Multiple Purchases`
     */
