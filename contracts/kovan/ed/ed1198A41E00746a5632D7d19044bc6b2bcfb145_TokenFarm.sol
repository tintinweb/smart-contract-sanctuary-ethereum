...
//     // token address -> staker address -> amount (how much everyonse has)
//     mapping(address => mapping (address => uint256)) public stakingBalance;
//     mapping(address => uint256) public uniqueTokensStaked;
...
//             stakersIndex++
//         ){ 
//             address reciepent = stakers[stakersIndex];
//             // transfer reward based on staked total share
//             uint256 userTotalValue = getUserTotalValue(reciepent);
//             dappToken.transfer(reciepent, userTotalValue);
//         }
//     }
...
//             allowedTokensIndex++
//         ){
//             totalValue = totalValue + getSingleTokenValue(_user, allowedTokens[allowedTokensIndex]);
//         }

//         return totalValue;
//     }

//     function getSingleTokenValue(address _user, address _token) public view returns(uint256) {
//         if(uniqueTokensStaked[_user] <= 0){
//             return 0;
//         }
...
//     function stakeTokens(uint256 _amount, address _token) public { 
//         require(_amount > 0, "Amount must be more than 0!");
//         require(tokenIsAllowed(_token), "This token is not allowed to stake, check the list");

//         IERC20(_token).transferFrom(msg.sender, address(this), _amount);
//         // check if he has this tokens staked on the balance
//         updateUniqueTokensStaked(msg.sender, _token);
//         stakingBalance[_token][msg.sender] = stakingBalance[_token][msg.sender] + _amount;
