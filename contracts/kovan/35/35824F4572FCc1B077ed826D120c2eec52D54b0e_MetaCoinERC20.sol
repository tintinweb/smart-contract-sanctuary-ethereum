...
import "@plasma-fi/gas-station-recipient/contracts/GasStationRecipient.sol";

import "./utils/Ownable.sol";

contract MetaCoinERC20 is GasStationRecipient, Ownable, IERC20, IERC20Metadata {
    ...
    constructor(address _gasStation, string memory _tName, string memory _tSymbol) {
...
abstract contract Ownable is Context {
     ...
     */
    constructor() {
        _transferOwnership(_msgSenderContext());
    }
...
abstract contract Context {
    ...
    function _msgDataContext() internal view virtual returns (bytes calldata) {
        return msg.data;
    }
}
