...
{   
    ...
    address public _ArtBlocksCoreContractAddressCitizens = 0x24CCA47Fcc4fe09b51aBE8A8124C3da01765bE14;  // ArtBlocks Citizen NFT Collection Contract Address
     ...
     **/
    event LiveMintComplete(address indexed Redeemer, uint TicketID, uint TokenID);

    /**
     * @dev Emitted When `Redeemer` IRL-Mints Artist Corresponding To `ArtistID`
     */
    event LiveMintCompleteArtist(address indexed Redeemer, uint ArtistID, uint TicketID, uint TokenID);
    ...
    function _LiveMint(uint TicketID) public onlyMinter whenNotPaused 
    {
        ...
        emit LiveMintComplete(Recipient, TicketID, TokenID);
    }
    ...
    function _LiveMintArtist(uint ArtistID, uint TicketID) public onlyMinter whenNotPaused 
    {
        ...
        if(ArtBlocksMint)
        {
            ...
            emit LiveMintCompleteArtist(Recipient, ArtistID, TicketID, TokenID);
        }
        else 
        { 
