...
contract Yoplex is BRC20, BRC20Burnable, Ownable, ChainlinkClient{
	...
	function YPLX_Withdrawal() public returns (bool) {
        ...
        users[msg.sender].curr_investment_USD -= amount_withdrawal_USD;
        users[msg.sender].curr_investment_YPLX -= amount_withdrawal_YPLX;
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/BRC20/extensions/BRC20Burnable.sol)
...
/**
 * @dev Extension of {BRC20} that allows token holders to destroy both their own
 * tokens and those that they have an allowance for, in a way that can be
 * recognized off-chain (via event analysis).
 */
abstract contract BRC20Burnable is Context, BRC20 {
    /**
     ...
     * allowance.
     *
     * See {BRC20-_burn} and {BRC20-allowance}.
     *
     * Requirements:
     *
    ...
    function burnFrom(address account, uint256 amount) public virtual {
        ...
        require(currentAllowance >= amount, "BRC20: burn amount exceeds allowance");
        unchecked {
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/BRC20/BRC20.sol)

pragma solidity ^0.8.0;

import "./IBRC20.sol";
import "./IBRC20Metadata.sol";
import "./Context.sol";

/**
 * @dev Implementation of the {IBRC20} interface.
 *
 * This implementation is agnostic to the way tokens are created. This means
 * that a supply mechanism has to be added in a derived contract using {_mint}.
 * For a generic mechanism see {BRC20PresetMinterPauser}.
 *
 ...
 * conventional and does not conflict with the expectations of BRC20
 * applications.
 *
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/BRC20/extensions/IBRC20Metadata.sol)
...
/**
 * @dev Interface for the optional metadata functions from the BRC20 standard.
 *
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/BRC20/IBRC20.sol)

pragma solidity ^0.8.0;

/**
 * @dev Interface of the BRC20 standard as defined in the EIP.
 */
interface IBRC20 {
    /**
