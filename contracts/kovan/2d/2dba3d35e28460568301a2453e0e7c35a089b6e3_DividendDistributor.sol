...
// File: contracts/CronosMaximus.sol
...
contract MaxTest is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "MaxTest";
    string constant _symbol = "$MaxTest";
    uint8 constant _decimals = 9;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;

    uint256 _totalSupply = 1 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = 5750 * (10 ** _decimals);
    uint256 public _walletMax = 5750 * (10 ** _decimals);
    ...
    constructor (IUniRouterV2 _router) Auth(msg.sender) {
        ...
        marketingWallet = address(0x0A15264A5aE3aAc72F53Ed03cda1f47061717D17);
        developmentWallet = address(0x66D63583f7DB4b833517E1Ce0a250731F5d3A4f0);
        
        vestingPeriod = 1 hours;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeAmount = amount.mul(multiplier).mul(totalFee).div(10000);
    ...
    {        
        ...
        uint256 amountCRODevelopment = amountCRO.sub(amountCROLiquidity).sub(amountCROReflection).sub(amountCROMarketing);
