...
contract pERC20 is ERC20Permit, ERC20Burnable, Ownable{ 
    ...
    constructor() ERC20("Template", "TLE") {
        _setupEIP712("Template", "1");
        claimed = true;
    }

    function claimContract(string memory name_, string memory symbol_) public {
        require(claimed, "Contract has already been claimed");
        claimed = true;

        _setupEIP712(name_, "1");
        _name = name_;
        _symbol = symbol_;
...
abstract contract EIP712 {
    ...
    function _setupEIP712(string memory name, string memory version) internal {
        require(_CACHED_THIS == address(0));
