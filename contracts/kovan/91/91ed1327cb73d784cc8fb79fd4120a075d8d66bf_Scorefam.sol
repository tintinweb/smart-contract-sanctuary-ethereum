    ...
    UUPSUpgradeable
{
        ...
        returns (uint256)
    {
        ...
        require(gameType == 3);
            ...
            if(!getGameScoreRequestStatus(_gaming[_msgSender()][game_].fixtureID) && sliceInterruptedBytes(_gaming[_msgSender()][game_].fixtureID)){
                uint256 result;
                if ( 
            ...
            else if (!getGameScoreRequestStatus(_gaming[_msgSender()][game_].fixtureID) && sliceInterruptedBytes(_gaming[_msgSender()][game_].fixtureID)){
                return amount;
            }
  ...
  //Convert String to Uint
    ...
    function claimGameReward(uint256 game_) external returns (bool){
        ...
        IScorefamConsumer(consumer).requestIdData(IScorefamConsumer(consumer).gameScoreRequestID(_gaming[_msgSender()][game_].fixtureID)).slice(2,11).equal(hex"696e746572727570746564"));
