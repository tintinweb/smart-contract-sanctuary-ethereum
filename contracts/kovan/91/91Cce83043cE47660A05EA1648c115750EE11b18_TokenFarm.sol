...
import "Ownable.sol";
// importo l'interfaccia ERC20 poer poter usare i suoi metodi
import "IERC20.sol";
...
contract TokenFarm is Ownable {
    ...
    function getUserSingleTokenValue(address _user, address _token)
        ...
        returns (uint256)
    {
        // if the price of 1 ETH is $2000 the function must return 2000
        // if the price of 200 DAI is $200 the function must return 200
        // uso if e non require perch̩ voglio che non mi si annulli la transazione visto che la funzione ̩ richiamata dentro un for loop
        ...
        // 10 ETH
        //ETH/USD --> 100 USD (ipotizziamo 1 ETH = 100 dollari)
        //10 eth * $100 = 1000
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        // hou much can they stake?
        require(_amount > 0, "Amount must be more than 0");
        require(tokenIsAllowed(_token), "Token is currentrly not allowed");
        // ricavo l'ABI del token e poi chiamo trasferFrom
