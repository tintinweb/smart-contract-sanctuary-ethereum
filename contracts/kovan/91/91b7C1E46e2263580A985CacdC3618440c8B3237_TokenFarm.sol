...
contract TokenFarm is Ownable{
    ...
    function getUserSingleTokenValue(address _user,address _token) public returns (uint256){
    ...
    function getTokenValue(address _token) internal returns (uint256,uint256){
        //pricefeed address
    ...
    function stakeTokens(uint256 _amount, address _token) public{
        ...
        require(isAllowedToken(_token)==true,"Token is not allowed to stake");
    ...
    function unstakeBalance(address _token) public{
        require(stakingBalance[_token][msg.sender] > 0,"Staking cannot be 0");
