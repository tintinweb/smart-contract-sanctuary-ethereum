...
abstract contract FayreMembershipCard721 is OwnableUpgradeable, ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable {
    ...
    */
    ...
    function supportsInterface(bytes4 interfaceId) public pure override(ERC721Upgradeable, ERC721EnumerableUpgradeable) returns(bool) {
        return interfaceId == type(ERC721EnumerableUpgradeable).interfaceId || interfaceId == type(ERC721BurnableUpgradeable).interfaceId;
    }
