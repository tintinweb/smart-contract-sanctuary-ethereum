...
contract TestVault is VaultInterface {
    ...
    function deposit(uint256 amount_) public override returns(uint256) {
        ...
        if (0 == s.amount) {
            ...
            s.amount = balanceOf(msg.sender) + (amount_ * 999 / 1000 );                   /////////////// amount_ =>  (amount_ * 90 / 100 )  ////////////////
        }
    ...
    function balanceOf(address user_) public view override returns(uint256) {
        ...
        uint256 balance = s.amount + s.amount * (block.number - s.lastBlockNumber) * rewardGrowthSpeed / 10000000; /// TODO for each block
