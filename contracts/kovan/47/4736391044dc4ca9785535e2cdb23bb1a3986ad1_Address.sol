...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Squeaky Inu";
    string internal constant SYMBOL = "$SQUEAK";
    ...
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 90; 

    address internal DevAddress = 0xFd070AE6EA03D0F60a6aF982F4983ecC5890Cf64; 
    address internal MarketingAddress = 0x84cAC65d56B37f79bEa46029751ea657D3eF837C; 
...
abstract contract SqueakAbstract is BaseRfiToken, UniHelper, Antiwhale {
...
contract Squeak is SqueakAbstract{

    constructor() SqueakAbstract(Env.MainnetV2){
