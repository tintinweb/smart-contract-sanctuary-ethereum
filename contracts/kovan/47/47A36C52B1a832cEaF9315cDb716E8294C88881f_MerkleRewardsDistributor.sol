...
contract MerkleRewardsDistributor is Ownable, ReentrancyGuard {
    ...
    function _leaf(
        ...
        console.logBytes32(keccak256(abi.encodePacked(leafIndex, account, amountToClaim)));
        console.log("On-chain encodePacked");
        console.logBytes(abi.encodePacked(leafIndex,account, amountToClaim));
        ...
        returns (bool)
    {
        ...
        console.log("Using rootHash not-sorted: ");
...
library MerkleProof {
    ...
    function verify(
        ...
        console.log("RootHash obtained on-chain: ");
