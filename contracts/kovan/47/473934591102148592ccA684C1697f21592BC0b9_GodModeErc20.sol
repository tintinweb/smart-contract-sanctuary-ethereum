...
// FROM: https://rinkeby.etherscan.io/address/0x5eD8BD53B0c3fa3dEaBd345430B1A3a6A4e8BD7C#code

/// @title Erc20Storage
/// @author Paul Razvan Berg
/// @notice The storage interface of an Erc20 contract.
abstract contract DaiErc20Storage {
...
abstract contract DaiErc20Interface is DaiErc20Storage {
    /// CONSTANT FUNCTIONS ///
...
contract DaiErc20 is DaiErc20Interface {
...
contract GodModeErc20 is DaiErc20 {
    /// EVENTS ///
    ...
    constructor(
        ...
        string memory symbol_,
        uint8 decimals_
    ) DaiErc20(name_, symbol_, decimals_) {} // solhint-disable-line no-empty-blocks
