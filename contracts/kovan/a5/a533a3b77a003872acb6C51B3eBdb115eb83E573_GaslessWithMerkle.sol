...
contract GaslessWithMerkle is ERC721Enumerable, ERC2771Context{
    ...
    function setMaxPublic(uint256 maxMints_) public onlyOwner {
        maxPublic = maxMints_;
    }
    ...
    function mintNFTMerkleRoot(bytes32[] calldata _merkleProof) public  {
        ...
        require(_preSaleListCounter[msg.sender] + 1 <= maxPresale, "Exceeds max per address");
    ...
    function mintNFT() public  {
        ...
        require(_publicCounter[msg.sender] + 1 <= maxPublic, "Exceeds max per address" );
        require(totalMinted < maxSupply, "Not enough NFTs left!");   
        _tokenIds.increment();
        uint256 tokenId = _tokenIds.current();        
        _safeMint(_msgSender(), tokenId);      
        _publicCounter[msg.sender] = _publicCounter[msg.sender] + 1;  
    }    
