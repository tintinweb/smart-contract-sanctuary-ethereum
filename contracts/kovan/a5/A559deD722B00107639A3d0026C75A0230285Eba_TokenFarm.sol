...
*/
    ...
    function stakeToken(uint256 _amount, address _token) public {
        ...
        require(tokenIsAllowed(_token), "Currently this token is not allowed!");
    ...
    // ATTENZIONE questo è un metodo molto costoso (per le gas fees)
    // molto più economico utilizzare una funzione di CLAIM!
    function issueToken() public onlyOwner {
        ...
        for (
            ...
            // Send them the reward based on their total value locked
