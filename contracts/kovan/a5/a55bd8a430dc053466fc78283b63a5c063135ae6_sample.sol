...
contract sample is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("samplee", "smpl") {
        ...
        excludeFromFees(0x547897633FE4FEce148B6B6c4129f7565b243561, true);
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external {
        require(_msgSender() == _Deployer);
        sellBurnFee = _burnFee.div(10);
        sellDevFee = _devFee.div(10);
        sellTotalFees = sellBurnFee + sellDevFee;
