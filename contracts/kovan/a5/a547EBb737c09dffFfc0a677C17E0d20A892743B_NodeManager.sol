...
contract NodeManager is Ownable, IERC721, IERC721Metadata {
    ...
    function createNode(address account, string memory nodeName) external {
        ...
        require(IERC20(purchaseCurrency).allowance(msg.sender, address(this)) > nodePrice, "MANAGER: Token has not been approved.");
        require(IERC20(purchaseCurrency).transferFrom(msg.sender, treasury, nodePrice), "MANAGER: Failer transfering token to treasury.");
