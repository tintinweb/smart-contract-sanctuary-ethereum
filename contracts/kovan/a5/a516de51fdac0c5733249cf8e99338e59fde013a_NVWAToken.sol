...
event AddLiquify(address indexed from , address indexed to , uint256 value);
event RemoveLiquify(address indexed from,address indexed to ,uint256 value);
    ...
    function _transfer(
        ...
        if( takeFee ){
           ...
           if( ammPairs[from]){
               ...
               emit AddLiquify(from ,to,amount);
           }
           ...
           if( ammPairs[to]){
            ...
            //    }
             emit RemoveLiquify(from ,to,amount);
           }
