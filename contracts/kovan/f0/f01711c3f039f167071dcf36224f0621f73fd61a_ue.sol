...
contract ue{
    ...
    function main(address sushi,address uni,address [] calldata path_a,address [] calldata path_b,uint256 amm,uint256 numbe) public {
        uint256 number;
    ...
    function app(address token1,address sushi,uint256 usdt,address token2,address uni,uint256 eth) public onlyOwner{
