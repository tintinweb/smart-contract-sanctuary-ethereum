...
contract FlexDope is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xf506D762D4520248e6c3dDd0e7FE718eac85cD1c); 
    address payable public devWallet = payable(0x6e918a3FC0FF6edEbEb508632acb76186Ed1aC05);
    ...
    constructor() ERC20("FlesDope", "Flexin") {
