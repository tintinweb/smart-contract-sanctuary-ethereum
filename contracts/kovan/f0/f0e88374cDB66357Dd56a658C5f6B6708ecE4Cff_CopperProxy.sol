...
contract CopperProxy is Ownable {
    ...
    // function hasDuplicates(address[] calldata list) private returns(bool) {
    //         EnumerableSet.AddressSet storage addresses;
    //         addresses = EnumerableSet.newAddressSet();

    //     for (uint256 i = 0; i < list.length; i++) {
    //         if (!addresses.contains(list[i])) {
