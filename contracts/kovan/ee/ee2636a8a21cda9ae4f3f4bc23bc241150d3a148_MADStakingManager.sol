    ...
    IMADRadicalMarketDelegate
{
        ...
        whenNotPaused
    {
        ...
        if (metaverse == Metaverse.DCL_LAND) {
            ...
            for (uint256 i = 0; i < assetIds.length; i++) {
                ...
                setAssetOperators(metaverse, assetIds[i], defaultOperators);
        ...
        whenNotPaused
    {
        ...
        if (metaverse == Metaverse.DCL_LAND) {
            ...
            for (uint256 i = 0; i < assetIds.length; i++) {
                ...
                setAssetOperators(metaverse, assetIds[i], operators);
        ...
        authorized
    {
        ...
        setAssetOperators(metaverse, assetId, operators);
    ...
    ) public override whenNotPaused authorized {
