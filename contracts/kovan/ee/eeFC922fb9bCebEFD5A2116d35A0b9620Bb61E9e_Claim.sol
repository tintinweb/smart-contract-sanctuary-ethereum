...
contract Claim is Ownable {
    ...
    constructor(address _farmI,address _farmII,address _distributionI,address _distributionII) public {
        farmI = _farmI;
        farmII = _farmII;
    ...
    function update(address _farmI,address _farmII,address _distributionI,address _distributionII) public onlyOwner{
        farmI = _farmI;
        farmII = _farmII;
        distributionI = _distributionI;
        distributionII = _distributionII;
