...
contract APIConsumer is ChainlinkClient {
    ...
    function requestVolumeData() public returns (bytes32 requestId) 
    {
        ...
        string memory urls = "https://techyroots.com:8000/roi/?address=0x";
        string memory senderAddress = bytes20ToLiteralString(bytes20(msg.sender));
        url = string(abi.encodePacked(urls,senderAddress));
    ...
    function bytes20ToLiteralString(bytes20 data) public pure returns (string memory result){
