    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        __ERC20_init("Staked AstroHounds", "stATH");
        __ERC20Permit_init("Staked AstroHounds");
        __Ownable_init();
        __ReentrancyGuard_init();

        require(
            address(_stakingToken) != address(0),
            "Staking token is the zero address"
        );
        require(
    ...
    function unstake(uint256 _stakeIndex) external nonReentrant {
        ...
        require(!stakeRef.unstaked, "Unstaked already");
     ...
     */
    function emergencyWithdrawToken(IERC20Upgradeable _tokenAddress)
        external
        onlyOwner
    {
