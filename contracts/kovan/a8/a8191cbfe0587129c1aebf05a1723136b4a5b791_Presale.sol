...
contract Presale {
  ...
  constructor () public {
    token = TOKEN(0xbB55788d00Df430d7b9E59930d9433738e68fF94);
    ceoAddress = msg.sender;
    buyLimit = SafeMath.mul(10000, multiplier);
    tokenPrice = 25 * 1e14; // $ 0.005 BNB
  }
  ...
  function withdrawToad (uint256 amount) external ceoOnly {
