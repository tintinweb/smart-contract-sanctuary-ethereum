...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    // event is used to access the log of smartcontracts without need of paying gas fee
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 adjustedPrice = uint256(price) * 10**10; // 18 decimals sicne price has already 8 decimals just add 10 more
        //  $50, $2,000 / ETH
        // 50/2,000
    ...
    function endLottery() public onlyOwner {
        // Not true random number way to do it
        // uint256(
        //     keccack256(
        //         abi.encodePacked(
        ...
        // emit event to get the requestId for test_lottery_unit.test_can_pick_winner_correctly()
