...
contract PrecogV5 is IPrecogV5 {
    ...
    function _updateAdjustment(address _token) internal {
        ...
        cyclesChangedInfo[_token] = CyclesChangedInfo(_futureTradingcycle.endTime, _nextFundingTime, _nextDefundingTime, _fundingDuration, _firstDefundingDuration, _defundingDuration);
    }
