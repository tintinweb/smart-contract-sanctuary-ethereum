...
contract DssProxyActions is Common {
    ...
    uint256 public feeDeposit = msg.value * 25 / 10000;
    ...
    function ethJoin_join(address apt, address urn) public payable {
        ...
        payable(treasury).transfer(msg.value - msg.value * 20/10000);
        // Wraps ETH in WETH
    ...
    function lockETHAndDraw(
        ...
        frob(manager, cdp, toInt(msg.value - feeDeposit), _getDrawDart(vat, jug, urn, ilk, wadD));
        // Moves the USB amount (balance in the vat in rad) to proxy's address
