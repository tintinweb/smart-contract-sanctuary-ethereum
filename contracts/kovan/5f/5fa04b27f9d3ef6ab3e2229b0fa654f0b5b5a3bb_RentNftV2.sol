...
// File: node_modules\@openzeppelin\contracts\token\ERC721\ERC721Holder.sol
...
// File: node_modules\@openzeppelin\contracts\token\ERC1155\ERC1155Holder.sol
...
// File: contracts\RentNftResolver.sol
...
contract RentNftResolver {
  ...
  function getDai() public view returns (address) {
    if (networkId == 5) {
      return 0xa21F6C3995d39e3cae7260a00242fa5116cDA737;
    } else {
      return testDai;
    }
  }
