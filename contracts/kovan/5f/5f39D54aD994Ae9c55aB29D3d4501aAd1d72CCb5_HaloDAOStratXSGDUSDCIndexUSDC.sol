...
contract HaloDAOStratXSGDUSDCIndexUSDC is Ownable {
    ...
    function addLiquidity(
        ...
        uint256 minLpTokens = numeraire.sub(
            numeraire.mul(slippage).div(PRECISION)
        );
    ...
    function swap(
        ...
        console.log("[StratContract] Approving USDC spent for SwapRouter...", amount);
        ...
        console.log("[StratContract] Swapping USDC for indexUSDC...", amount, minAmountOut);
