...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata , Pausable {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view whenNotPaused virtual override(ERC165, IERC165) returns (bool) {
        return
     ...
     */
    function balanceOf(address owner) public view whenNotPaused  virtual override returns (uint256) {
     ...
     */
    function ownerOf(uint256 tokenId) public  view whenNotPaused virtual override returns (address) {
     ...
     */
    function tokenURI(uint256 tokenId) public view whenNotPaused virtual override returns (string memory) {
     ...
     */
    function isApprovedForAll(address owner, address operator) public view whenNotPaused virtual override returns (bool) {
     ...
     * - `tokenId` must exist.
     */
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal whenNotPaused view virtual returns (bool) {
...
contract NFT is ERC721URIStorage {
    ...
    constructor() ERC721("GRAVITYPULL","gps") {
        
    }

    function createToken(string memory tokenURI) public whenNotPaused returns (uint) {
        _tokenIds.increment();
