...
contract Moonwalkers is ERC721, ERC721Enumerable, PullPayment, Pausable, Ownable, ReentrancyGuard {
  ...
  /// @dev Maximum presale supply
  uint256 private constant maxPresaleSupply = 2;
  ...
  /// @dev Mapping of the whitelisted addresses
  ...
  function mintWhitelist() public payable returns (uint256) {
    ...
    require(tokenId < maxPresaleSupply, "Max supply reached");
