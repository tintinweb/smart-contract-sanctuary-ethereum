...
contract ERC1155Token is ERC1155, Ownable {
    ...
    constructor(string memory _uri, string[] memory _names, uint[] memory _ids) ERC1155(_uri) {
        ...
        names = _names;
        ids = _ids;
        createMapping(_ids, _names);
        setURI(_uri);
        transferOwnership(tx.origin);
    }   

    function createMapping(uint[] memory _ids, string[] memory _names) private {
...
contract FactoryERC1155 {
    ...
    string public testbaseMetadataURI;
