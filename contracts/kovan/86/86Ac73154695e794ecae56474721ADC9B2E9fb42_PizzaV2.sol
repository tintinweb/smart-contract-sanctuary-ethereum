...
contract PizzaV2 is Pizza {
    uint256 public slicesV2; // impact adding new variable in proxy upgrade
    ...
    ///@dev increments the slices when called
    function refillSliceV2() external {
        slicesV2 += 1;
    }

    function eatSliceV2() external {
        require(slicesV2 > 1, "no slices left");
        slicesV2 -= 1;
    }
