...
contract TokenFarm is Ownable {
    ...
    mapping(address => address) public tokenPriceFeeding;
    ...
    function setPriceFeedContract(address _token, address _priceFeed) public onlyOwner{
        ...
        tokenPriceFeeding[_token] = _priceFeed;

    }

    function getTokenValue(address _token) public view returns (uint256, uint256){

        address priceFeedAddress = tokenPriceFeeding[_token];
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        (uint256 price, uint256 decimals) = getTokenValue(_token);
        uint256 newValueAdded = _amount * price/10**decimals;

        dappToken.transferFrom(address(this), msg.sender, newValueAdded);
    }
