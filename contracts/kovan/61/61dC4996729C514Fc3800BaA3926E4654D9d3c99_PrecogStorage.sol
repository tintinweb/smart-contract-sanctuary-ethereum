...
contract PrecogStorage is IPrecogStorage {
    ...
    function setMiddlewareService(address newMiddlewareService)
        external
        override
        onlyAdmin
    {
    ...
    function setMiddlewareExchange(address newMiddlewareExchange)
        external
        override
        onlyAdmin
    {
    ...
    function setWithdrawalRegister(address newWithdrawalRegister)
        external
        override
        onlyAdmin
    {
    ...
    function findExistingTokenIndex(address token)
        external
        view
        override
        returns (uint index)
    ...
    function swapExistingTokensByIndex(uint indexTokenA, uint indexTokenB)
        external
        override
        onlyOperator
    {
    ...
    function getExistingTokensPair()
        external
        view
        override
        returns (TokenPair[] memory pairs)
    {
    ...
    function updateCurrentProfitId(address token, uint newValue)
        external
        override
        onlyOperator
    {
    ...
    function updateIsExistingToken(address token, bool newValue)
        external
        override
        onlyOperator
    {
    ...
    function updateTokenConvert(address token, address newValue)
        external
        override
        onlyOperator
    {
    ...
    function updateLiquidity(address token, uint newValue)
        external
        override
        onlyOperator
    {
    ...
    function updateLiquidityWhitelist(address token, uint newValue)
        external
        override
        onlyOperator
    {
    ...
    function checkIsNotFirstInvestmentCycle(address token)
        external
        view
        override
        returns (bool)
    ...
    function updateIsNotFirstInvestmentCycle(address token, bool newValue)
        external
        override
        onlyOperator
    {
    ...
    function updateIsRemoved(address token, bool newValue)
        external
        override
        onlyOperator
    {
    ...
    function pushWhitelist(address token, address account)
        external
        override
        onlyOperator
    {
    ...
    function getTradingCycles(address token)
        external
        view
        override
    ...
    function getLastTradingCycle(address token)
        external
        view
        override
        returns (Cycle memory)
    ...
    function pushTradingCycle(address token, Cycle memory tradingCycle)
        external
        override
        onlyOperator
    {
    ...
    function getProfitsForWhitelist(address token)
        external
        view
        override
        returns (uint[] memory)
    ...
    function pushProfitForWhitelist(address token, uint newValue)
        external
        override
        onlyOperator
    {
    ...
    function getTotalUnitsForWhitelistTradingCycle(address token, uint index)
        external
        view
        override
        returns (uint)
    ...
    {
        lastInvestmentOf = investmentsOf[token][account][
            investmentsOf[token][account].length - 1
        ];
    }
    ...
    function popInvestmentOf(address token, address account)
        external
        override
        onlyOperator
    {
