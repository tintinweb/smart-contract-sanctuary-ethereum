...
contract GsnRelay is Ownable, LondonTxSupport {
    ...
    function sendTransaction(TxRequest calldata _tx, TxFee calldata _fee, bytes calldata _sign) external onlyFeePayer {
        ...
        uint256 spentTokens = router.swapTokensForExactETH(feeInEth, maxFeeInTokens, _swapPair(address(token)), txFeePayer, block.timestamp)[0];
        ...
        require(gasUsed > gasleft(), "GsnRelay: Gas overspending");
    }
