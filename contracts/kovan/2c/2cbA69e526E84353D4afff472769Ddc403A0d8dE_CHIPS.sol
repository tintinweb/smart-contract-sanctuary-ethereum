...
contract CHIPS is Initializable, ERC20Upgradeable, OwnableUpgradeable{
    ...
    function _transfer(address from,address to,uint256 amount)internal override{
        ...
        if(msg.sender  == owner()){
            ...
            emit msgs("msg.sender -- if block");
        }else{
            emit msgs("buy/ sell -- else block");
            super._transfer(from, to, amount);
    ...
    function getLpLimit() external view returns(uint256){
        return lpLimit;
    }
    ...
    function getStakeRewardAddress() external view returns(address){
