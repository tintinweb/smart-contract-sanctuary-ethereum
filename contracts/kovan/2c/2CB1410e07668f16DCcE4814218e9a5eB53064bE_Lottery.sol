...
contract Lottery is Ownable, ERC721, VRFConsumerBase {
	...
	// Kovan network chainlink data
	bytes32 constant private keyHash = 0x6c3699283bda56ad74f6b855546325b68d482e983852a7a82979cc4807b641f4;
    ...
    constructor(
		...
		0xa36085F69e2889c224210F603D836748e7dC0088	// LINK Token contract address
	) {
		startLottery(
			_lotteryTicketPrice,
			_lotteryPeriod,
	...
	function getRandomNumber() public returns (bytes32 requestId) {
		...
		return requestRandomness(keyHash, uint256(chainlinkFee));
	}
