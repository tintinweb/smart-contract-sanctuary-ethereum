...
contract capsToken is ERC20 {
    ...
    modifier onlyFixlineBettingContractOrCreator() {
        require(
            msg.sender == fixlineBettingContractAddress ||
                ...
                msg.sender == creator,
            "Only FixlineLossCap Contract Can Access This Method"
        );
        _;
    }
    ...
    function setCreatorAddress(address newCreatorAddress) public onlyCreator {
    ...
    function getFixlineBettingContractAddress() public view returns (address) {
        return fixlineBettingContractAddress;
    }

    function getCapsStackingContractAddress() public view returns (address) {
