...
contract STUToken is Context, IERC20, Ownable {
    ...
    string private _name = "Stuff-Test";
    string private _symbol = "STU-Test";
    ...
    constructor () public {
       ...
       _mint(0xF855101284b09df93236b24Ae8D481395Fb037Fd, totalSupply.mul(4).div(10)); //盲盒
       _mint(0x9d47CA26Da1e91F473578b3FA1E4242e1329F144, totalSupply.mul(1).div(10)); //白名单
       _mint(0xAd35577DA956f06C2C15CBeeB7FECB809E8D93c2, totalSupply.mul(25).div(100)); //流动性池
       ...
       lpSetter[0x9d47CA26Da1e91F473578b3FA1E4242e1329F144]=true;
    }
