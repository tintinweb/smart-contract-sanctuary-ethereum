    ...
    ReforgeBridgeUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC20_init("TestContractBridgeVersion", "TCBV");
        ...
        _grantRole(BRIDGE_OWNER_ROLE, multiSigTreasury);
    }
    ...
    function reforge(
        ...
        _reforge(to, amount, transaction);
    }
    ...
    function sendToChain(uint256 amount, uint256 destinationChainId)
        ...
        payable
    {
        _sendToChain(amount, destinationChainId);
    }
...
contract WhitelistUpgradeable is Initializable {
    ...
    function __WhitelistUpgradeable_init() internal onlyInitializing {}

    function __WhitelistUpgradeable_init_unchained()
        internal
        onlyInitializing
    {}
    ...
    ERC20BurnableUpgradeable
{
    ...
    function __ReforgeBridgeUpgradeable_init() internal onlyInitializing {}
     ...
     * @param destinationChainId bridge will reforge token on this chain
     */
    function _sendToChain(uint256 amount, uint256 destinationChainId) internal {
        burn(amount);
        emit SentToChain(
            msg.sender,
            amount,
