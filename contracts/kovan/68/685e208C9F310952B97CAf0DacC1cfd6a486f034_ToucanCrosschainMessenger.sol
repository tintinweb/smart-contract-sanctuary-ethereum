...
contract ToucanCrosschainMessenger is ToucanCrosschainMessengerStorage, Router {
    ...
    modifier onlyAllowedTokens(address _token) {
        require(allowedTokens[_token], "Only allowed tokens");
        _;
    }
...
contract TestToken is ERC20, Ownable {
    ...
    constructor() ERC20('TestToken', 'TT') {
        ...
        _mint(0x67BE2C36e75B7439ffc2DCb99dBdF4fbB2455930, initialMintAmount);
    }
    ...
    function burn(address _account, uint256 _amount) external onlyRouter {
