...
contract TokenExample is ERC20, Ownable {
    ...
    constructor() ERC20("Token Example", "TEB") {
        ...
        marketingWallet = address(0x7e68B48CF5a70C3bbd0e1626F24bcc94318880ac); // set as marketing wallet
        devWallet = address(0x1B54FF756E2a04707826b95041C0e9123C6B4F23); // set as dev wallet
