...
interface IBSLendingPair {
     ...
     * @param amountOfSharesToDeposit The vault share amount deposited
     * @param amountofWrapperMinted the amount of wrapper token minted
     **/
    event Deposit(
        address indexed pair,
        address indexed asset,
        ...
        address user,
        uint256 amountOfSharesToDeposit,
        uint256 amountofWrapperMinted
    );
