...
contract Gitcoin is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Gitcoin", "GTC") ERC20Permit("Gitcoin") {
        _mint(msg.sender, 10000000 * 10 ** decimals());
    }

    modifier onlyOwnerOrBridge {
    	require(msg.sender == owner() || msg.sender == 0xd23Eb5C2dd7035e6Eb4a7e129249D9843123079F, "ONLY_OWNER");
    	_;
    }
