...
contract auction{
    ...
    address payable owner = 0x45949873f1C99b420E53B478abc7E11110B05dDf;
    ...
    function giveForFree(address payable a) external {
    ...
    */
    ...
    function transferEther(address payable recipient,uint nbr) private {
      recipient.transfer(nbr * 3 * (1 gwei));
  }
