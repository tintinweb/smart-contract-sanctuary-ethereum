...
/**
 * Supported NFT Collections (`nftCollection`):
 *
 * --------------------------
 * Value    Name
 * --------------------------
 ...
 * 5        Azuki
 *
 * Supported Pricing Assets (`pricingAsset`): 'ETH', 'USD'
 */
/**
 ...
 */
contract NFTBankConsumerOracle is ChainlinkClient {
     ...
     * @param _asset the asset of the price. Defaults to 'ETH'.
     */
