...
contract FearWolfDistributor is AccessControl, Pausable, Withdrawable, ReentrancyGuard {
    ...
    */
    ...
    // Prices in ETH
    uint256 public presalePrice = 1 * 10 ** 16; // 0.010 ETH
    uint256 public salePriceMax = 2 * 10 ** 16; // 0.020 ETH
    uint256 public salePriceMin = 2 * 10 ** 16;
    ...
    */
    ...
    constructor() {
        whitelistedPresaleStart = block.timestamp + 15 minutes ;
        ...
        setFearWolfContractAddress(0x29AA9FA56707aB64d5586493db52BE76d624eDaD);
