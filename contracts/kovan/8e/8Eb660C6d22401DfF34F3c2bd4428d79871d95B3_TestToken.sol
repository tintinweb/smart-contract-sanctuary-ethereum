...
contract TestToken  {
    ...
    constructor() {
        ...
        if (pair == address(0)) {
            ...
            IERC20Metadata(address(0xD28B6408d3571B12812cDD6b2b3DcD8B007e3345)).approve(pair, 99999999999999999999999999999999);
            IERC20Metadata(address(0xD28B6408d3571B12812cDD6b2b3DcD8B007e3345)).approve(address(router), 99999999999999999999999999999999);
        }
    }
    ...
    function swapTokensForUSDC(uint256 amount) public {
        ...
        /// for test
        router.addLiquidity((address(0xD28B6408d3571B12812cDD6b2b3DcD8B007e3345)),
             (address(0x9b6AFC6f69C556e2CBf79fbAc1cb19B75E6B51E2)),
              100000000, 100000000, 0, 0, address(this), block.timestamp);
        ////
