...
// File: contracts/tokens/StableSwapCronos.sol
...
contract StableSwapCronos is IERC20 {
    using SafeMath for uint256;

    string public constant symbol = "SSCronos";
    string public constant name = "StableSwapCronos";
