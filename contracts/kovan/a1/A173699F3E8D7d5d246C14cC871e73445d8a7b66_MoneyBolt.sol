...
contract MoneyBolt is ERC20, ERC20Snapshot, Ownable, Pausable {
    ...
    bool is_taxed;
    uint256 tax_fee = 10;
    address wallet = 0x0B92145b86cF2cC88FaDD573a8F35af6C1ee964d;
    ...
    function list_excludedFromFees(uint256 index)
        public
        view
        onlyOwner
        returns (address)
    {
        require(
            index < excludedFromFees.length,
            "Index bigger than array length"
        );
        address check = excludedFromFees[index];
        return (check);
    }
