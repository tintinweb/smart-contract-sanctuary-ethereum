...
contract UniswapFlash is 
    ...
    function initUniFlashSwap(
        ...
        console.log("amount of %s ---> %s", params.token0, params.amount0);
        console.log("amount of %s ---> %s", params.token1, params.amount1);
        flashPool.flash(
            address(this),
            params.amount0,
            params.amount1,
    ...
    function uniswapV3FlashCallback(
        ...
        (
            ...
            address[] memory tradeAssets,
            uint8[] memory tradeDexs
         ) = abi.decode(data, (FlashCallbackData, address[], uint8[]));
        ...
        if (amountOwed > 0) pay(loanAsset, address(this), msg.sender, amountOwed);
...
contract SwapInforRegistry {
    ...
    uint8 public constant UNISWAP_V3_ROUTER_ID = 10;
    uint8 public constant UNISWAP_V2_ROUTER_ID = 20;
    uint8 public constant SUSHISWAP_ROUTER_ID = 30;
    uint8 public constant SIBASWAP_ROUTER_ID = 40;
    uint8 public constant ONEINCHISWAP_ROUTER_ID = 50;
    uint8 public constant APESWAP_ROUTER_ID = 60;
    uint8 public constant KYBER_ROUTER_ID = 70;
    uint8 public constant PANCAKE_ROUTER_ID = 80;

    mapping(uint8 => SwapRouterInfo) public swapRouterInfos;

    function setSwapRouterInfo(uint8 routerID, SwapRouterInfo memory routerInfo) external {
