...
contract DRCoordinator is TypeAndVersionInterface, ConfirmedOwner, Pausable, ReentrancyGuard, ChainlinkClient {
    ...
    function _requestData(
        ...
        // NB: Chainlink nodes 1.2.0 to 1.4.1 can't parse uint for 'minConfirmations'. Replace 'addUint' with 'add'
        // _req.add("minConfirmations", uint256(spec.minConfirmations));
