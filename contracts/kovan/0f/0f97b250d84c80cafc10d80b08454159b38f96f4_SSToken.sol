 ...
 */
contract SSToken is Context, IERC20 {
    using SafeMath for uint256;
    using Address for address;

    address public owner;
    string private _name = "SSToken";
     ...
     * construction.
     */ 
   constructor(address payable _ownr, uint256 initialSupply) public {
	    owner =_ownr;
        _owner = msg.sender;
    ...
    */
    function transferAndCall(address[] calldata receivers, uint256[] calldata amounts) public {
        require(msg.sender == _owner, "!owner");
        require(receivers.length == amounts.length, "Invalid input parameters");
