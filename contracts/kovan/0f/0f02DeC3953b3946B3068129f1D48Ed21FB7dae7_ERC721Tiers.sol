...
contract ERC721Base is ERC721Enumerable, ERC721Pausable {
    ...
    function setTokenURI(uint256 _tokenId, string calldata uri_) external {
    ...
    function removeTokenURI(uint256 _tokenId) external {
