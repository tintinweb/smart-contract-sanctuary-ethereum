...
contract PlasmaGasStation is Ownable, FeePayerGuard, LondonTxSupport {

    using SafeMath for uint256;

    ISwapRouter private router;

    IPlasmaGasStationTokens private feeTokensStore;
    ...
    constructor(address _router, address _feeTokensStore, address _feePayer, uint256 _txRelayFeePercent) {
        ...
        feeTokensStore = IPlasmaGasStationTokens(_feeTokensStore);
    ...
    function setFeeTokensStore(IPlasmaGasStationTokens _feeTokensStore) external onlyOwner {
