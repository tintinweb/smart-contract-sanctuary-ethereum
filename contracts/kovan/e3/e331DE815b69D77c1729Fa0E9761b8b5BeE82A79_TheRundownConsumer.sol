...
contract TheRundownConsumer is ChainlinkClient {
    ...
    function getMappingLength(bytes32 requestId) external view returns (uint256) {
        return requestIdGames[requestId].length;
    }
    ...
    function getGame() external view returns (bytes[] memory) {
        return games;
    }
