...
contract WolfAttackCow is WolfGameStorage {
    ...
    event Attack(uint indexed requestId,uint wolfId,uint cowId,bool success,uint stealValue,uint cowDownLevel);
    ...
    function _attack(AttackParam memory attackParam) internal {
        ...
        if(!param.attackSuccess(attackParam.randomX128,attackParam.cowLevel,_cowGrade(attackParam.cowId),attackParam.wolfGrade,life,attackParam.cowLevelLife)){
            emit Attack(attackParam.requestId,attackParam.wolfId,attackParam.cowId,false,0,0);
            return;
        }
        ...
        emit Attack(attackParam.requestId,attackParam.wolfId,attackParam.cowId,true,stealValue,cowDownLevel);
    }
