...
contract P4TCHwxyz is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private _price = .0001 ether;                                                          //CHANGE TO 0.111 ether
    uint256 public nextPatchId = 1;
    ...
    mapping(uint256 => uint256) public _claimed;                                      //test and maybe change to private
    ...
    function publicMint(uint256 numOfPatches) external payable {
        ...
        if (totalSupply() + numOfPatches <= MAX_W_ID) {          //PUBLIC [W] SALE
            ...
            require(numOfPatches <= 20, "Exceeded max numOfPatches");
