...
contract Pool is Ownable {
    ...
    // token address -> staker address -> amount
    mapping(address => mapping(address => uint256)) public borrowingBalance;
    ...
    function stakeToken(address _token, uint256 _amount) public {
        ...
        require(tokenIsAllowed(_token), "Token is not supported yet");
        ...
        // uint256 totalValue = _amount * price / (10**decimals);
        // defiToken.transfer(msg.sender, totalValue);
    }
