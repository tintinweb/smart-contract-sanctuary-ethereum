    ...
    UUPSUpgradeable
{
  ...
  //Convert String to Uint
     ...
     */
    function updateRequestGameScore(uint256 fixtureID) internal {
    ...
    function updateRequestIdData(uint256 fixtureID) public returns(bytes memory) {
        IScorefamConsumer sc = IScorefamConsumer(consumer);
    ...
    function claimGameReward(uint256 game_) external returns (bool){
        ...
        updateRequestGameScore(_gaming[_msgSender()][game_].fixtureID);
        bytes memory result = updateRequestIdData(_gaming[_msgSender()][game_].fixtureID);
        sliceBytes(_gaming[_msgSender()][game_].fixtureID, result );
