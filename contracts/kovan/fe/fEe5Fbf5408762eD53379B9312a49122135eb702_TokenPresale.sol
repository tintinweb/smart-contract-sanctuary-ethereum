...
contract TokenPresale is Ownable, ReentrancyGuard {
    ...
    function buyTokens() public payable nonReentrant icoActive {
        ...
        TransferHelper.safeTransferFrom(address(depositToken), address(this), _msgSender(), tokenAmount);
    ...
    function setDepositToken(address depositTokenAddress, uint8 decimals) external onlyOwner {
        depositToken = IERC20(depositTokenAddress);
        _tokenDecimals = decimals;
    }
