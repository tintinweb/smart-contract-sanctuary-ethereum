...
pragma solidity ^0.6.12;
    ...
    contract Quantum is Context, IERC20, Ownable {
        ...
        address payable public _marketingWalletAddress;     // Pasquale
        address payable public _devWalletAddress;           // Elevate
        address payable public _useCaseWallet;              // Jeff
        address payable public _useCaseWallet2;             // Faraz 
        address payable public _useCaseWallet3;             // Peter + Trent
