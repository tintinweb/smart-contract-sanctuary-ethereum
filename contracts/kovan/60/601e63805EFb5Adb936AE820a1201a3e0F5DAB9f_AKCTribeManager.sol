...
contract AKCTribeManager is Ownable, ReentrancyGuard {
    ...
    /** DEX HELPER METHODS */
    function swapTokensForEthSupportingFeeOnTransferTokens(uint256 tokenAmount) public {
    ...
    function purchaseTribeNoLiq(uint256 spec, uint256 identifier)
        external
        nonReentrant { 
            require(spec < akcCore.getTribeSpecAmount(), "SPEC OUT OF BOUNDS");
