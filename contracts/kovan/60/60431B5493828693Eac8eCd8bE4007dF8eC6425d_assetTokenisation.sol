...
contract assetTokenisation is ERC1155, Ownable {
    ...
    uint256 Id;
    IERC20 USDC = IERC20(0x656f644650d116baa31C60244B8Bba2210B52838);   //For Kovan Testnet   //0x2519f6FC924BE4ac916152059C46E1bFeB5CfFcC
    ...
    event DividendTransferred(string _userId, string _propertyId, uint256 _dividendAmount);
