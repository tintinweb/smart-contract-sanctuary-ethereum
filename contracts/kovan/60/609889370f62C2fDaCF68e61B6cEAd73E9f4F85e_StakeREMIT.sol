...
contract StakeREMIT is ReentrancyGuard {
    ...
    function stakeAmount(uint256 _amount) public nonReentrant onlyAfterStakingStarted {
        ...
        if(_isUserStaking(msg.sender)) {
            ...
            stakingDatas[msg.sender].rewardGained = 
                stakingDatas[msg.sender].rewardGained.add(rewardGained);
            stakingDatas[msg.sender].rewardFee = 
                stakingDatas[msg.sender].rewardFee.add(rewardFee);
        ...
        require(i_remitToken.transferFrom(msg.sender, address(this), _amount));
    }
    ...
    function unstakeAmount() public nonReentrant onlyAfterStakingStarted {
        ...
        uint256 amountAvailable = stakedAmount.sub(userUnstakingFee);
        ...
        stakingDatas[msg.sender].stakingDurationInDays = _calculateStakingDuration(
            stakingDatas[msg.sender].stakingStartingTime,
        ...
        uint256 rewardAmount = _getRewardAmount(
            stakedAmount,
            stakingDatas[msg.sender].stakingDurationInDays
        );
        uint256 rewardFee = _getStakingRewardsFee(rewardAmount);
        uint256 rewardGained = rewardAmount.sub(rewardFee);
        ...
        uint256 totalAmountAvailable = amountAvailable.add(
            stakingDatas[msg.sender].rewardGained
        );
        ...
        require(i_remitToken.transfer(msg.sender, totalAmountAvailable));
    }
