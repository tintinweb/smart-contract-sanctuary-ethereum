...
contract NewCowParam is INewCowParam,AdminTransfer {
    ...
    uint[31] public upgradeFailProbability=[uint(0),0,1,2,3,4,5,7,9,11,13,16,19,22,25,28,32,36,40,44,49,53,58,63,69,
    74,80,86,93,99,100];
    ...
    uint[31] public override power=[uint(0),100,120,161,223,306,413,543,701,887,1106,1359,1655,1999,2398,2860,3396,4027,4773,5656,6710,7997,9565,11526,14018,17341,
    21813,28283,38521,60178,211611];
