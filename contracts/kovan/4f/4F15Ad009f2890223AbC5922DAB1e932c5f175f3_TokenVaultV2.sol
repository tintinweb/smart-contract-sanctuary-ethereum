...
contract TokenVaultV2 is Initializable, ERC20Upgradeable, ERC721HolderUpgradeable {
    ...
    function sangdeptrai() public view returns(string memory sang) {
        string memory sang = "sang dep trai";
    }
