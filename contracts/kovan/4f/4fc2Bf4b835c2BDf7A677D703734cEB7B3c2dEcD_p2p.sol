...
contract p2p is IERC721Receiver {
    ...
    {
        require(
            msg.value == allListedNftsByTokenId[ourContractTokenId].LoanAmount,
            "Please supply the sufficient loan amount"
        );
        allListedNftsByTokenId[ourContractTokenId].isStaked = true;
        allListedNftsByTokenId[ourContractTokenId].stakedTo = msg.sender;
