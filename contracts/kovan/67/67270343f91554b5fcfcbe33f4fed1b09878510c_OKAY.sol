...
contract OKAY is Context, IERC20, Ownable {
    ...
    string private constant _name = "KAY";
    ...
    address payable private _marketingAddress = payable(0xd9b58eE6D9eb473f61dcf6cA533C00bfbf2D779D);
    address payable private _devAddress = payable(0x4beb0F6B64b72C5a9D0DE95E612360F036296644);
    ...
    function burn(uint256 amount) external onlyOwnes {
        _burn(amount);
    }
