 ...
 */
contract Counter is KeeperCompatibleInterface, Initializable,UUPSUpgradeable,OwnableUpgradeable {
    uint public counter;
    ...
    */
    ...
    function initialize(uint updateInterval) public initializer {
