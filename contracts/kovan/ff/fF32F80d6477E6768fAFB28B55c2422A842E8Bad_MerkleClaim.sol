...
contract MerkleClaim {
    ...
    function claimTokens() external {
        ...
        if(limit != 0 && release_amount > limit){
            release_amount = limit;
            total_release_amount = user_released[msg.sender].add(limit);
        }
        // update user info
    ...
    function transferUserLock(address _user, address _newAddress) external {
