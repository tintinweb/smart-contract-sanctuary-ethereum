...
contract NodeManager is Ownable, IERC721, IERC721Metadata {
    ...
    bool private _nodeCreationEnabled = true;
    ...
    */
    ...
    function createNode(address account, string memory nodeName, uint8 levelIndex) external {
        ...
        require(_nodeCreationEnabled, "MANAGER: Node creation is disabled");
    ...
    function _setNodeCreationEnabledStatus(bool status) onlyOwner external {
        _nodeCreationEnabled = status;
    }
