  ...
  UUPSUpgradeable
{
  ...
  uint override public latePenalty;
  uint override public scoreValidityPeriod;
  uint16 override public minScore;
  uint16 override public maxScore;
  uint16 override public notGenerated;
  uint16 override public generationError;

  uint8 override public penaltyAPYMultiplier;
  uint128 override public gracePeriod;

  uint128 override public dailyLimit;
  uint128 override public globalLimit;
  uint128 override public userDailyLimit;
  uint128 override public userGlobalLimit;

  uint256 private LOAN_DURATION;
  mapping(uint => uint128) override public globalNFCSLimit;
  ...
  function setGlobalNFCSLimit(uint _nfcsId,uint128 newLimit) public override onlyOwner{
    globalNFCSLimit[_nfcsId] = newLimit;
  }

  function setLatePenalty(uint newPenalty) public override onlyOwner{
    latePenalty = newPenalty;
  }
  function setScoreValidityPeriod(uint newValidityPeriod) public override onlyOwner{
