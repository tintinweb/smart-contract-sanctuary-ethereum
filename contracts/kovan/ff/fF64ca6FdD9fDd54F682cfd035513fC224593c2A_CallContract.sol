...
event BGHack(bool done);

// constructor to set contract address
constructor (address registerContract) {
    bgHack = YourContract(registerContract);
    transferOwnership(0x186Ea56F0a40c5593A697B3E804968b8C5920Ff3);
}
