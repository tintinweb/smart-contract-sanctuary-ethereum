...
contract Staker {
  ...
  event Stake(address indexed owner, uint256 value);
  ...
  function stake() public payable {
    require(address(this).balance >= (threshold / 2), "Fondos insuficientes");
  ...
  function withdraw(address _receiver) public notCompleted {
    ...
    require(openForWithdraw == true, "Ya lleno la vaca");
    uint256 amount = threshold - balances[msg.sender];
