...
contract PrecogFactory is IPrecogFactory {
    ...
    function _handleFirstTimeAddLiquidityPool(address _token, IPrecogCore.CycleConfiguration memory _cycleConfig)
        internal
    ...
    ) internal returns (IPrecogStorage.Cycle memory _currentTradingCycle) {
