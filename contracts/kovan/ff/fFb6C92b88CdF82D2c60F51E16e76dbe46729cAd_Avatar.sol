...
contract Avatar is ERC721URIStorage, Ownable {
    ...
    constructor(address priceFeedAddress, uint16 usd)
        public
    ...
    function getRequiredWei() public view returns (uint256) {
        ...
        return (usdFee * 10**18) / adjustedPrice;
    }

    function setUsdFee(uint16 usd) public onlyOwner {
        _setUsdFee(usd);
    }

    function _setUsdFee(uint16 usd) private {
        usdFee = usd * (10**18);
    }
}
