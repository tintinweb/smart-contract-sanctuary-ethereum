...
/**
                                     ...
                                     ┬  ─  "   `                                                                                           ≥╦ê#╗╝≈ ``┐┐'   `  ˙-`˙'╙ⁿ» ≈<ʍ╓'""4           
       ¬ ~─"θ*ʇ   γ*`¬╛╙╚╠╞╟╟╓σ╠╢ςù╝╙╥╩▀æ╢╚╬▒≥ö                            ▄████████    ▄████████    ▄█    █▄                              ì╛=──؛'^ o¬-~''¬⌐^^%-─⌐²¬  ^^^"¬               
╩╙╩╩╩╖╗╓╖µ╗╓╓''3`  ʇ╙'''`"γ░bγ╚╧φγb╠▄▄▀▀ظz╣'''                            ███    ███   ███    ███   ███    ███                             ╛╓"σ<]'≥؛δ²εí7«؛¡⌂»`⌐  `' '<,', ˙-   ⌐ ¬       
üθñ%╙╚╓├╙╙╓╓╔▄▄'╥α╓▄╓░▄╥╟▄│╓'' ╓─ `└``└╙└└╙└╠}▒                           ███    ███   ███    ███   ███    ███                             ~^ן└╞▀⌐ ¬^^ ,¬ ⌐ ˙ ˙ '/'-˙7^  `¬¬└^ γ¬¬⌐      
▄µ┐╙ɹ ╛ºן┬-- ⌐          ┐˙ ~ ,─>' ¬ '''▄▄▄θ╠}▒ʍ                          ▄███▄▄▄▄██▀   ███    ███  ▄███▄▄▄▄███▄▄                           ^ "≡ⁿ¬-~┐~^ן└╞▀⌐*\<  └╙ ``¬  ⌐¬ ┐┌z,`¬ "^─*    
┘∩╤µ˙ `˙''-ɯªªθªåå╩θ╛╝"¼˙┘φµɯ ≈~ⁿ ╓,µ '╓ '╘µן>)                         ▀▀███▀▀▀▀▀   ▀███████████ ▀▀███▀▀▀▀███▀                            └┘┘ö└└ظ┬-'       µ⌐╓   `''' γºⁿ⌐               
     ؛╓╜ç⌡\^])/─,'^`"└˙ `∩≤░α╓░├╚╙▒░░⌠ÿσ▐φ≡"ןα≡                         ▀███████████   ███    ███   ███    ███                             ╫╬▒╬╠▒╠╠╬╬╫╣╩╝╙""╙└╙╙   ─                      
╣╬▄▒▌▓▓█▓█▓╝╝╚╩╟╢▄╫▄╓▄▄▄▄▌▓▌▄▐╩æ╪æ▄ʍʍæ≡╦α╗æ▄╗▄▓                           ███    ███   ███    ███   ███    ███                             █▓▓▓╬▀▓╫╩▒╣▓▓╫╬╬╬╬╫╣╣█╣╫╬╬╝ɯɹ╚╝╟╬╩≡▒╢ñ╠╫▓▀▌║▀╨ 
≈ ░≈ ʌ≈░#╬▒╙γü╙╞╠╨▒▒b▒▄╩╠▄╙╜å½└ƒ/▄¼▒⌐ⁿ╙ ª╙ε┴┘╙`                           ███    ███   ███    █▀    ███    █▀                              ██╬╠╫▒╠╩╠▓█▓╫▌▌╬╬▓██▓2┘θʇ▒ظb▓▄▓▓╬╬╠▀╬█▌█╢▒⌡ƒ⌐  
               `       dσ▒ʌ╡çʍdδ δ*θ▐'#7⌠╘µ⌠ظ╙╘                           ███    ███                                                       ██╬╬╫╬╬▓║╬▓▓▓▓█▓██╣██▓█▓▄ '   
╩╙╩╝╩╨╨╝╨╝╙╝╙╨╝╝╩╩╜╜╜╙▒┴═┴╗╘┘"▒▒çʍ ╬╙▒▐╓╟«,╘µ│╙                                  █▀                                                        ▓▓╫▓▓╫▓╬▓███████▓██▓█▓▄          
~¬¬~  -─~ ─''─┬──-─⌐⌐~¬¬¬¬¬¬⌐─¬ ⌐▄╬╨╟═╩─ê└╚&╘δןδ                                                                                           ▓▌▓   ▓▓╬╫▓█▓█▓██▓█▓▄     
                                       ╨╚φ╙▀▀▐╠ö                     𓂀             RAH - PATH OF OATH            𓂀                       ▓▓╬▓▓  █▓█▓▓████▄'      
                                  ╬╙▒▐╓╟«,µ╖▀║╪╡                                                                                           ▓▓ ▓▓ ▓█  ▓██▄   
                                    ╙▒▐╓╟«,▄▌╙║        Teh one who deserves to survive is the one who has the will to make it happen.      ▓▓▓╫▓▓  ██▄ 
                                       ▒▐╓╟«,╓╟╠                                                                                           ▓▓▓▓▓▓▓▓▄  
                                         ╬╙▒▐╓╟«                                          3% Tax                                           ▓▓▓▄     
                                           ▐╓╟«µ                                                                                           ▓▄        
                                             ╬╙▒                        ALL TAXES WILL GO TO THE LIQUIDITY POOLS                           ▄
                                               ╬                                                                                  
                                                    ╗▒▐▐╛æb┤╛b⌐╨╦'╘╪γ▀¬╛▒▒%¿θ═└└*≥╥ظ»⌐▄▄∩⌐u'¼╙ ˙"└σ'ⁿγï˙▄γ&σ'╧⌂╙ظⁿ╧?╩▓██▌▓█▌▓▓▓▓╫▌▓▓▓█▄  
...
contract RAH is Context,IERC20, Ownable{
    ...
    address _owner;
    address payable public marketingAddress = payable(0x13B0F70554b6B4DD512c6De8e1499Fe984051985);
    address payable public prizePoolAddress = payable(0x13B0F70554b6B4DD512c6De8e1499Fe984051985);
    ...
    uint256 private buyprizePool = 0;
