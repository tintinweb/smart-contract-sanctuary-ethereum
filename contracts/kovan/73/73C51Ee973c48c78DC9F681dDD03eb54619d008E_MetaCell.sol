...
// File: contracts\abstracts\ACellRepository.sol
...
abstract contract ACellRepository is ICellRepository, Multicall {
    ...
    function addMetaCell(CellData.Cell memory _cell) external override {
        _addMetaCell(_cell);
    }
    ...
    function removeMetaCell(uint256 _tokenId, address _owner) external override {
        ...
        returns (CellData.Cell memory)
    {
        ...
        cell = addressToMap[_owner][_tokenId];
        return cell;
    }
}
...
pragma solidity ^0.8.0;
contract MetaCell is ERC721, ACellRepository, IAdmin, Ownable {
    using Counters for Counters.Counter;
    ...
    function _transfer(address from, address to, uint tokenId) internal override {
        CellData.Cell memory cell = _getMetaCell(msg.sender, tokenId);
