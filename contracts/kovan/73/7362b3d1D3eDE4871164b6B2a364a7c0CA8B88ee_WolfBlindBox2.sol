...
contract WolfBlindBox2 is AdminTransfer,ReentrancyGuard,EIP712,Multicall {
    ...
    uint[] public price=[uint(0),199*10**18,468*10**18];
    uint[] public cowProbability1=[uint(0),15,35,45,5];
    uint[] public cowLevel1=[uint(0),5,6,7,8];
    uint[] public cowLevel2=[uint(0),11,12,13,14];
    uint[] public cowProbability2=[uint(0),54,20,15,10];
    ...
    uint[31] public power=[uint(0),
    0,0,0,0,8680,
    2933,3871,4991,6307,7826,
    9576,11564,13818,16352,16458,
    17760,18260,18760,19260,19760,
    20260,20760,21260,76110,203437,
    729207,0,0,0,0];
