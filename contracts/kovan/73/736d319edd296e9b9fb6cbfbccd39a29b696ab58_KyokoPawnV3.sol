    ...
    OwnableUpgradeable
{
    ...
    function mintPawnForSales(uint256 _number) public {
        ...
        IERC20Upgradeable(applyToken).transferFrom(
            msg.sender,
            multiSign,
            totalCost
        );
    ...
    function mintPawnForSalesV2(uint256 _number) public {
        require(saleIsActive, "Sale must be active to mint Pawn");
        require(
            _number <= maxPawnPurchase,
            "Can only mint 10 tokens at a time"
    ...
    function mintPawnForSalesV3(uint256 _number) public {
        require(saleIsActive, "Sale must be active to mint Pawn");
        require(
            _number <= maxPawnPurchase,
            "Can only mint 10 tokens at a time"
        ...
        uint256 totalCost = pawnPrice.mul(_number);
        ITetherToken(address(0xB98649feC7C53b037d3369404Afe1B6827157c73)).transferFrom(
            msg.sender,
            multiSign,
            totalCost
        );
