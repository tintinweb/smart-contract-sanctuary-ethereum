...
contract Concert is ERC721, ERC721Enumerable {
  string[] public tokenURIs;
  mapping(string => bool) _tokenURIExists;
  mapping(uint256 => string) _tokenIdToTokenURI;
  mapping(uint256 => address[]) _itemTrack;
  mapping(uint256 => address) public _concertOwner;
  mapping(uint256 => bool) public _ConcertExist;

  constructor() 
    ERC721("Concert Collection", "CCNFT") 
  {
  }
  ...
  function safeMint(string memory _tokenURI) public {
    ...
    _concertOwner[_id] = msg.sender;
    _ConcertExist[_id] = true;
  }
    ...
    function getConcertOwner (uint256 _id) public view returns (address) {
      address owner = _concertOwner[_id];

      return owner;
    }

    function getConertExist (uint256 _id) public view returns (bool) {
      bool exist = _ConcertExist[_id];
