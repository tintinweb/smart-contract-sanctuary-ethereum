...
contract FlashLoanTemplate is ICallee {
    ...
    IWETH private WETH = IWETH(0xd0A1E359811322d97991E03f863a0C30C2cF029C);//0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
    ...
    ISoloMargin private soloMargin = ISoloMargin(0x4EC3570cADaAEE08Ae384779B0f3A45EF85289DE);//0x1E0447b19BB6EcFdAe1e4AE1694b0C3659614e4e);
    ...
    function flashLoan(uint loanAmount) public {
        /*
