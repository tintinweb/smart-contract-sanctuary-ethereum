...
contract TokenFarm is Ownable {
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        require(_amount > 0, "Amount must be greater tha 0");
        require(tokenIsAllowed(_token), "Token currently not allowed");
        //wrap token in ABI, which is what IERC20 does, then use
        //the transferfrom function because we don't have ownership of
        //the tokens, because we are smart contract. if we own smart contract,
        //then we can use .transfer
