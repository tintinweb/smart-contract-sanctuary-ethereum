...
contract Crowdsale is AccessControl, ReentrancyGuard {
    ...
    /**
     * @return how many 0gas user can buy, till reach max purchase
     */
    function getMaxAllowable(address user) external view returns (uint256) {
        return maxPurchase - userToBalance[user][3];
    }
    ...
    /**
     * @notice return current stage, = 0 if pause, = -1 if not start/end
     */
