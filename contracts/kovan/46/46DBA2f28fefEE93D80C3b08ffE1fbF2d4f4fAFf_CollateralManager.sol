 ...
 * @notice A contract to manage the collateral of the Roci protocol
 */
abstract contract Manager is IManager, AddressHandler {
    ...
    * @param _user of loan
    * @param _amount to withdarawl
    * @param _receiver who receives the withdrawln collateral
     */
    function withdrawal(address _user, uint256 _amount, address _receiver) external override{
