...
contract SimpleInsureConfig {
    ...
    function projectConfig(address project_) external view returns (uint256, uint256, uint256, uint256, uint256) {
        require(projects[project_].accept, "!project classID");
        return (projects[project_].classID, projects[project_].payFactor, projects[project_].leverageFactor, projects[project_].policyPrice, projects[project_].policyPay);
    }
