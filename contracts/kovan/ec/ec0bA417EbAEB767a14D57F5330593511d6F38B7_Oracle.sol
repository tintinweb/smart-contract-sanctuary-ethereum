    ...
    WithdrawalInterface
{
    ...
    mapping(address => bool) private callbackAddressAllowed;
    ...
    modifier onlyCallbackAddressAllowed(address _callbackAddress) {
        require(
            callbackAddressAllowed[_callbackAddress],
            "Your APIComsumer contract is not allowed"
        );
        _;
    }
    ...
    function oracleRequest(
        ...
        onlyCallbackAddressAllowed(_callbackAddress)
    {
    ...
    function isCallbackAddressAllowed(address _callbackAddress)
        external
        view
        returns (bool)
    {
        return callbackAddressAllowed[_callbackAddress];
    }
    ...
    function addCallbackAddressToWhiteList(
        address _callbackAddress,
        bool _allowed
    ) external onlyOwner {
        callbackAddressAllowed[_callbackAddress] = _allowed;
    }
