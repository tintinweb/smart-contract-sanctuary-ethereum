...
/** 
 *  SourceUnit: c:\Projects\flux\smart-contracts\contracts\staking\MasterChef.sol
*/
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function getRewardPerBlockByMonth(uint256 month)
        public
        pure
        returns(uint256)
    {
    ...
    function getCurrentRewardPerBlock()
        public
        view
        returns(uint256)
    {
        uint256 month = (block.number - startBlock) / BLOCK_PER_MONTH + 1;

        return getRewardPerBlockByMonth(month);
    }
        ...
        returns(uint256)
    {
        ...
        for (uint256 i = month; i <= 50; i++) {
            ...
            uint256 rewardPerBlock = getRewardPerBlockByMonth(i);
        ...
        onlyOwner
    {
        ...
        uint256 rewardPerBlock = getCurrentRewardPerBlock();
