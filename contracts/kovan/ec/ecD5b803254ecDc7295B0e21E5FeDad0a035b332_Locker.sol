...
contract Locker {
  ...
  function withdraw (address _token, uint256 _amount) public {
    ...
    (unlockedAmount,sender) = amountEligibleForWithdrawal(msg.sender, _token);
  ...
  function amountEligibleForWithdrawal (address _user, address _token) public view returns (uint256, address) {
    ...
    return (finalAmount, msg.sender); // eligibleAmount;
  }
