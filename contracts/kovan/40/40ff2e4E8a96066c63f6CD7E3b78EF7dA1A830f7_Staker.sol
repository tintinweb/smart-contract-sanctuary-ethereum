...
contract Staker is IERC721Receiver, ReentrancyGuard {
    IERC721 mToken;
    MonfterProfile pToken;

    mapping(uint256 => address) public mOwners;

    constructor(IERC721 _mToken, MonfterProfile _pToken) {
        mToken = _mToken;
        pToken = _pToken;
    }

    // for test
    function setToken(IERC721 _mToken, MonfterProfile _pToken) public {
        mToken = _mToken;
        pToken = _pToken;
    }
