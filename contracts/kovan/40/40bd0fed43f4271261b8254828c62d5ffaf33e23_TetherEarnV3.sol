...
contract DividendDistributor is IDividendDistributor {
    ...
    // mm router                    0x145677FC4d9b8F19B5D56d1820c48e0443049a30
    // uniswap main/testnet router  0xf164fC0Ec4E93095b804a4795bBe1e041497b92a  
    // uniswap testnet router       0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    ...
    // pancakeswap testnet router 2 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3

    IBEP20 RewardToken = IBEP20(0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa);

    //Tether CRO: 0x66e428c3f67a68878562e79A0234c1F83c208770
    //DAI Kovan: 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa
    //DAI BSC Test: 0x8a9424745056Eb399FD19a0EC26A14316684e274
    ...
    uint256 public dividendsPerShareAccuracyFactor = 100 ** 33;

    uint256 public minPeriod = 1 hours;
    uint256 public minDistribution = 10 * (10 ** 15);
...
contract TetherEarnV3 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TetherEarnV3";
    string constant _symbol = "TEARNv3";
    ...
    uint256 public swapThreshold = 10 * 10**3 * (10 ** _decimals);
