...
contract LazyNFT is ERC721URIStorage, EIP712, ERC2981PerTokenRoyalties, AccessControl {
  ...
  function redeem(address redeemer, NFTVoucher calldata voucher) public payable returns (uint256) {
    ...
    // Assign the royalty info
    uint256 royaltyValue = 1000;

    if (royaltyValue > 0) {
      _setTokenRoyalty(voucher.tokenId, signer, royaltyValue);
    }
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override (ERC2981Base, AccessControl, ERC721) returns (bool) {
