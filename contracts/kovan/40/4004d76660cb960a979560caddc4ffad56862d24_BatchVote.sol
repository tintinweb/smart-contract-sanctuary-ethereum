...
contract BatchVote is Initializable, OwnableUpgradeable, UUPSUpgradeable, PausableUpgradeable {
     ...
     */
    function delegateBySigs(DelegateSignature[] memory sigs) external whenNotPaused {
     ...
     */
    function castVoteBySigs(CastVoteSignature[] memory sigs) external whenNotPaused {
        for (uint256 i = 0; i < sigs.length; i++) {
