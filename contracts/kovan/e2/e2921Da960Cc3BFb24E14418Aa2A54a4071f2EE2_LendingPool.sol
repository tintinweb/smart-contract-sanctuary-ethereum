    ...
    ReentrancyGuardUpgradeable
{
    ...
    function withdraw(uint256 _amount) external nonReentrant {
        ...
        _payVendorLendFees();
        if (
            lendToken.balanceOf(address(this)) < _amount
        ...
        nonReentrant
    {
        ...
        if (!factory.pools(msg.sender)) { // If this is a call not from another pool a.k.a rollover
    ...
    function _payVendorLendFees() private {
