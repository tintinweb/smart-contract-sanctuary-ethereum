...
contract MerkleRewardsDistributor is Ownable, ReentrancyGuard {
    ...
    /// @param _newMerkleCDI the CDI on IPFS where the file to rebuild the Merkle Tree is contained
    ...
    function claim(
        ...
        require(
            isInState(leafIndex, amountToClaim, userAddress, merkleProof),
    ...
    function isInState(
        ...
        return _verify(_leaf(leafIndex, amountToClaim, userAddress), merkleProof);
    }
    ...
    function _leaf(
        ...
        return keccak256(abi.encodePacked(leafIndex, amountToClaim, account));
    }
...
library MerkleProof {
    ...
    function verify(
        ...
        bytes32 p0 = processProof(proof, leaf);
        console.log("Processed proof on-chain: ");
