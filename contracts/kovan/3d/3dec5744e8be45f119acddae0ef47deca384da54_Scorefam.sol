    ...
    UUPSUpgradeable
{
    ...
    function sliceInterruptedBytes(uint256 _fixtureID) public view returns(bool) {
        IScorefamConsumer sc = IScorefamConsumer(consumer);
        return sc.requestIdData(sc.gameScoreRequestID(_fixtureID)).slice(2,11).equal(hex"696e746572727570746564");
    }
