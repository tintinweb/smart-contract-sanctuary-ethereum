...
contract AKCTribeManager is Ownable, ReentrancyGuard {
    ...
    function liquifyAKC() public {
        ...
        uint256 usableBalance = contractBalance >= liquidityReserved ? contractBalance - liquidityReserved : contractBalance;
    ...
    function purchaseTribeNoLiq(uint256 spec, string calldata identifier)
        external
        nonReentrant { 
            require(spec < akcCore.getTribeSpecAmount(), "SPEC OUT OF BOUNDS");
