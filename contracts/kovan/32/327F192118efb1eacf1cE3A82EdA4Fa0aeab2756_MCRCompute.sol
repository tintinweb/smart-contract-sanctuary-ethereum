...
contract MCRCompute {
    ...
    function computeTestGas(address policy_, uint256 pay_, bool add_) external {
    ...
    function _updatePolicyValue(address policy_, uint256 pay_, bool add_) internal returns (uint256, uint256) {
    ...
    function _computeCorrValue(address policy_, uint256 typeID_, uint256 policyValue_) internal returns (uint256, uint256) {
