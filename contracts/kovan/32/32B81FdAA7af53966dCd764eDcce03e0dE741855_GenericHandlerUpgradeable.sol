...
contract GenericHandlerUpgradeable is Initializable,  EIP712Upgradeable , ContextUpgradeable, AccessControlUpgradeable {
    ...
    function MapContract( RouterLinker calldata linker , bytes memory _sign ) external {
        ...
        require( linkedAddress == crossTalk.fetchLinkSetter() , "Router Generichandler : Signature Mismatch for Linked Address to contract" );
    ...
    function _hash(RouterLinker calldata linker) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
                keccak256("RouterLinker(address _rSyncContract,uint8 _chainID,address _linkedContract,uint8 linkerType)"),
...
// TODO : Add Fee logic in here
    ...
    function executeProposal( bytes calldata _data) external onlyRole(BRIDGE_ROLE) returns ( bool ) {
        ...
        (bool success , bytes memory callback ) = crossTalk.routerSync( depositData._srcChainID, depositData._srcAddress, depositData._selector, depositData.data, depositData.hash);
        return success;
    }
