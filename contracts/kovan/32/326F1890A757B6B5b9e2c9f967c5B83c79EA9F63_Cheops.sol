...
contract Cheops is ERC20 {
    ...
    function queueLiquidityWallsParameters(int24[2][] calldata _liquidityWallsRanges, uint[] calldata _liquidityWallsRatios, bool[] calldata _liquidityWallsInToken) external {
    ...
    function setSellThresholdAmount(uint _sellThresholdAmount) external {
