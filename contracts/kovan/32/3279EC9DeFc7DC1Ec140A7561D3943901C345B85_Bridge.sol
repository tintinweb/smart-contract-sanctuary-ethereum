...
contract Bridge is IBridge, Ownable {
    ...
    bytes public encodedValidators;
    function setEncodedValidators(ValidatorWithPower[] memory validators) public {
        encodedValidators = abi.encode(validators);
    }

    function getEncodedValidators() public view returns(ValidatorWithPower[] memory validators) {
        return abi.decode(encodedValidators, (ValidatorWithPower[]));
    }
