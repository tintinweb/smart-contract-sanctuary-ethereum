...
contract BabyOriginal is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabyOriginal";
    string constant _symbol = "bORIG";
    ...
    address RewardToken = 0xD1462E4f0cfE85631997907f8758545A7f4933A4;
