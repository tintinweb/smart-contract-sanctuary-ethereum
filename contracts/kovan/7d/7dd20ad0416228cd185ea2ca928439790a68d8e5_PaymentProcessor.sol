...
interface IMultipleArbitrableTransactionWithAppeals {
    ...
    function hashTransactionState(Transaction memory _transaction) external pure returns (bytes32);
}

contract PaymentProcessor {
    address multipleArbitrableAddress;
    ...
    constructor(
        ...
        multipleArbitrableAddress = _arbrAdress;
    }
    ...
    function managePayment(
        ...
        TransactionInput memory transactionInput = TransactionInput({
            _amount: receiverAmount,
            _token: _token,
            _timeoutPayment: _timeoutPayment,
            _receiver: _receiver,
            _metaEvidence: _metaEvidence
        });

        createTransaction(
            transactionInput._amount,
            transactionInput._token,
            transactionInput._timeoutPayment,
            transactionInput._receiver,
            transactionInput._metaEvidence
        );
    ...
    */
    ...
    function createTransaction(
        ...
        return IMultipleArbitrableTransactionWithAppeals(
            multipleArbitrableAddress).createTransaction(
                _amount,
                _token,
                _timeoutPayment,
                _receiver,
    ...
    function pay(
        uint256 _transactionID,
        IMultipleArbitrableTransactionWithAppeals.Transaction memory _transaction,
        uint256 _amount
    ) external {
        return IMultipleArbitrableTransactionWithAppeals(
            multipleArbitrableAddress).pay(_transactionID, _transaction, _amount);
    }
    ...
    function executeTransaction(
        ...
        return IMultipleArbitrableTransactionWithAppeals(
            multipleArbitrableAddress).executeTransaction(_transactionID, _transaction);
    }
    ...
    function payArbitrationFeeBySender(
        ...
        return IMultipleArbitrableTransactionWithAppeals(
            multipleArbitrableAddress).payArbitrationFeeBySender(_transactionID, _transaction);
    }
    ...
    function payArbitrationFeeByReceiver(
        ...
        return IMultipleArbitrableTransactionWithAppeals(
            multipleArbitrableAddress).payArbitrationFeeByReceiver(_transactionID, _transaction);
    }
}