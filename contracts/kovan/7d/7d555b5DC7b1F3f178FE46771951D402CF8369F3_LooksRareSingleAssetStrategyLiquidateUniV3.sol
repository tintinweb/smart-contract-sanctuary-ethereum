...
contract LooksRareSingleAssetStrategyLiquidateUniV3 is
  Ownable,
  ReentrancyGuard,
  IStrategy
{
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "LooksRareSingleAssetStrategyLiquidateUniV3::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function execute(
    ...
    require(
      ...
      "LooksRareSingleAssetStrategyLiquidateUniV3::execute:: insufficient baseToken amount received"
    );
