...
contract DrShanks is ERC721, Ownable, IERC2981Royalties {
   ...
   struct RoyaltyInfo {
    ...
    //Separate Counters for reserved and general tokenIds
    ...
    constructor(string memory baseURI) ERC721("DrShanks", "DSH") {
        ...
        setRoyalties(PROJECTADRESS, ROYALTIES_POINTS);
    ...
    function reservedNFTs(uint256 number) public onlyOwner {
        ...
        require(totalMinted + number <= reservedMints, "Max reserved NFT minting exceeded");
