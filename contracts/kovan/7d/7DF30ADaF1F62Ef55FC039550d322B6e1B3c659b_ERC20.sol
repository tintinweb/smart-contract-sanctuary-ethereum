...
contract EFT is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = 10000 * (10**9) * (10**18); //1%

    uint256 public _BuyETHRewardsFee = 4;
    uint256 public _BuyLiquidityFee = 1;
    uint256 public _BuyMarketingFee = 3;
    uint256 public _BuyDevFee = 2;
  //  uint256 public extraFeeOnSell = 4;
    uint256 public _BuyTotalFees = _BuyETHRewardsFee.add(_BuyLiquidityFee).add(_BuyMarketingFee).add(_BuyDevFee);
    
    uint256 public _SellETHRewardsFee = 5;
    uint256 public _SellLiquidityFee = 2;
    uint256 public _SellMarketingFee = 4;
    uint256 public _SellDevFee = 3;
    uint256 public _SellTotalFees = _SellETHRewardsFee.add(_SellLiquidityFee).add(_SellMarketingFee).add(_SellDevFee);
    
    uint256 public maxWalletToken = 10000 * (10**9) * (10**18); //1%

    address public _marketingWalletAddress = 0x54f563a778065F97E1Bf8fd0F521502bF9C7d867;
    address public _developmentWalletAddress = 0xa65c2c35Cc10265BFc1Ac83E2A143d21d3787Da1;
    ...
    constructor() ERC20("ETH Fan Token Ecosystem", "EFT") {
    ...
    {
        require(_isExcludedFromMaxTx[account] != excluded, "EFT: Account is already the value of 'excluded'");
      ...
      function setBuyFees(uint256 buyEthRewardFee, uint256 buyLiquidityFee, uint256 buyMarketingFee, uint256 buyDevFee) external onlyOwner
    {
        ...
        _BuyTotalFees = _BuyETHRewardsFee.add(_BuyLiquidityFee).add(_BuyMarketingFee).add(_BuyDevFee);
    ...
    function setSellFees(uint256 sellEthRewardFee, uint256 sellLiquidityFee, uint256 sellMarketingFee, uint256 sellDevFee) external onlyOwner
    {
        ...
        _SellTotalFees = _SellETHRewardsFee.add(_SellLiquidityFee).add(_SellMarketingFee).add(_SellDevFee);
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 800000, "EFT: gasForProcessing must be between 200,000 and 800,000");
...
contract EFTDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("EFT_Dividen_Tracker", "EFT_Dividend_Tracker") {
    	claimWait = 3600;
