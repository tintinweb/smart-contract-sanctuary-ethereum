...
contract ContributorLender is Ownable {
    ...
    function setLendingPool() public {
        poolAddress = poolProvider.getPool();
    ...
    function poolDeposit(address _token, uint256 _amount) public onlyOwner {
        IERC20(_token).transferFrom(address(this), getPoolAddress(), _amount);
    }

    // lend amount to lending pool
