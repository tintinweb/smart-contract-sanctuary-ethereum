...
contract GravitySCtest {
    ...
    function deposit(string memory _sourceAsset, uint256 _amount) external payable {
    ...
    function withdraw(string memory _sourceAsset, uint256 _amount) external payable {
        address _token = tokenAddresses[_sourceAsset];
