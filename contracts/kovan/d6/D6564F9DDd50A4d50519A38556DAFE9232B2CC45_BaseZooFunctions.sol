...
contract BaseZooFunctions is Ownable, VRFConsumerBase
{
	...
	uint256 public firstStageDuration = 10 minutes;      	//todo:change time //3 days;    // Duration of first stage(stake).
	uint256 public secondStageDuration = 10 minutes;      	//todo:change time //7 days;    // Duration of second stage(DAI).
	uint256 public thirdStageDuration = 10 minutes;       	//todo:change time //2 days;    // Duration of third stage(Pair).
	uint256 public fourthStageDuration = 10 minutes;       	//todo:change time //5 days;    // Duration fourth stage(ZOO).
	uint256 public fifthStageDuration = 10 minutes;        	//todo:change time //2 days;    // Duration of fifth stage(Winner).
	...
	function getRandomNumber1(bytes32 keyHash) public returns (bytes32 requestId) {
...
contract NftBattleArena is Ownable, ERC721
{
	...
	// function getRandomNumber(bytes32 keyHash) public returns (bytes32 requestId) {
	...
	function chooseWinnerInPair(uint256 pairIndex) public
	{
		...
		// {
			// zooFunctions.getRandomNumber1(keyhash);
		// }
