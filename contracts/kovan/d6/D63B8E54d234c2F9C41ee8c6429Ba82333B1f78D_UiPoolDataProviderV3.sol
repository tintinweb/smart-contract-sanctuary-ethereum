...
import {IUiPoolDataProviderV3V3} from './interfaces/IUiPoolDataProviderV3V3.sol';
...
import {IERC20DetailedBytesV3} from './interfaces/IERC20DetailedBytesV3.sol';
import {AaveProtocolDataProvider} from '@aave/core-v3/contracts/misc/AaveProtocolDataProvider.sol';

contract UiPoolDataProviderV3 is IUiPoolDataProviderV3V3 {
    ...
    returns (AggregatedReserveData[] memory, BaseCurrencyInfo memory)
  {
    ...
    for (uint256 i = 0; i < reserves.length; i++) {
      ...
      if (address(reserveData.underlyingAsset) == address(MKR_ADDRESS)) {
        bytes32 symbol = IERC20DetailedBytesV3(reserveData.underlyingAsset).symbol();
      ...
      reserveData.isSiloedBorrowing = false; // reserveConfigurationMap.getSiloedBorrowing();
...
interface IUiPoolDataProviderV3V3 {
...
interface IERC20DetailedBytesV3 is IERC20 {
