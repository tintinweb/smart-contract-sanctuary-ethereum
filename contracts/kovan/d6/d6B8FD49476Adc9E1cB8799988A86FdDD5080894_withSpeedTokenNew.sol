...
contract withSpeedTokenNew {
    ...
    function transfer(uint256 _value) public returns (bool success) {
        ...
        return speedToken.approveAndtransfer(owner,_value);
    }
