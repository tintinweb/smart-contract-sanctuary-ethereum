...
contract FlashLoan is FlashLoanReceiverBase(address(0x506B0B2CF20FAA8f38a4E2B524EE43e1f4458Cc5)) {
  ...
  event CallingFlashLoan(string msg, address exchangeAddress, address deployedAddress);
  ...
  function flashLoan() external {
    ...
    address deployedAddress = address(this);
    ...
    emit CallingFlashLoan("Calling FlashLoan", exchangeAddress, deployedAddress);

    exchange.flashLoan(deployedAddress, daiAddress, amount, _params);
