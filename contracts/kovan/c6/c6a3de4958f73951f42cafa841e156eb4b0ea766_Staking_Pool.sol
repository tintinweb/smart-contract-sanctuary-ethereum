...
$$ |      $$ |  $$ |$$ |  $$ |  \$$$  /  $$ |      $$ |  $$ |$$\   $$ |$$ |      
$$$$$$$$\ $$ |  $$ |$$ |  $$ |   \$  /   $$$$$$$$\ $$ |  $$ |\$$$$$$  |$$$$$$$$\ 
\________|\__|  \__|\__|  \__|    \_/    \________|\__|  \__| \______/ \________|
...
contract Staking_Pool is Ownable {
    ...
    function Stake(uint _pid,uint256 _amount) public { //1=daily, 2=30days, 3=60days
        ...
        if(_pid == 1) {           
            ...
            dataBase memory newdata = dataBase(_person,time,_amount,_pid);  /// order must be same
    ...
    function check_index() public view returns (uint index_){
        for(uint i = 0 ; i < _userdata.length ; i++) {
            if(_userdata[i].person == msg.sender){
                return i;
            }
