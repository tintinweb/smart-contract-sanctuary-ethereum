...
contract hberg is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapAtAmount = _tTotal.mul(30).div(1000);       // 0.3% of total supply
    uint256 public maxTxLimit = _tTotal.mul(30).div(1000);         // 0.3% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(200).div(10000);    // 1.00% of total supply
    ...
    constructor(address _dev) public ERC20("Richard Branson Inu", "HBERG") {
