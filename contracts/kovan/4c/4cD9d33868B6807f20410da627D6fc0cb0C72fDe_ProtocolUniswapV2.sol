...
contract ProtocolUniswapV2 is DSMath, ProtocolWETH {
    ...
    constructor(address _wethAddress, address _uniSwapRouter)
        ProtocolWETH(_wethAddress)
    {
        // Kovan 0xDC292C81e24efB77Bc69e6d3727E3727EC1bF170
    ...
    function buyToken(
        ...
        approve(_sellAddr, router, _expectedAmt);
    ...
    function sellToken(
        ...
        approve(_sellAddr, router, _sellAmt);
        ...
        )
    {
        ...
        approve(_tokenA, router, _amtA);
        approve(_tokenB, router, _amtB);
        ...
        )
    {
        ...
        _uniAmt = _amt == type(uint256).max
            ...
            : _amt;
        approve(uniToken, router, _uniAmt);
    }
