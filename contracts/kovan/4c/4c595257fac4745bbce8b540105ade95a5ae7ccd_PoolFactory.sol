    ...
    PausableUpgradeable
{
    ...
    /// @dev Deploy a new lending pool as a minimal proxy
    ...
    /// @param _feeRate Interest that will be due on expiry by borrowers. Can be modified later
    ...
    /* ========== SETTERS ========== */
    /// @dev Update the lending pool implementation address
    ...
    /// @dev Add or remove collateral from the allow list
    ...
    /* ========== UPGRADES ========== */
    ///@dev Contract version for history
    ///@return Contract version
    function version() external pure returns (string memory) {
        return "0.0.1";
    }

    ///@dev Pre-upgrade checks
...
interface ILendingPool {
    ...
    event Deposit(uint256 depositAmount);
    event Collect();
