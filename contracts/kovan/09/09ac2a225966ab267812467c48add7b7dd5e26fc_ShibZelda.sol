...
Website: https://shibzelda.com/
Telegram: https://t.me/shibzelda
Twitter: https://twitter.com/@shibzelda
Medium: https://medium.com/@shibzelda
Github: https://github.com/shibzelda
Instagram: https://www.instagram.com/shibzelda/
Reddit: https://www.reddit.com/user/shibzelda
...
contract ShibZelda is Context, IERC20 {
    ...
    string private _name = " ShibZelda";
    string private _symbol = "ShibZelda";

    uint256 public _reflectFee = 100;
    uint256 public _marketingFee = 900;

    uint256 private maxReflectFee = 900;
    uint256 private maxMarketingFee = 3000;
    ...
    address payable private _marketingWallet = payable(0xEAe81612eb59ebd2A95aEa1e5f480789EbeECFf0);
        ...
        if (sniperProtection){
            ...
            if (!_hasLiqBeenAdded) {
                ...
                if (_liqAddBlock > 0 
                    ...
                    if (block.number - _liqAddBlock < snipeBlockAmt + 3) {
                        _isSniper[to] = true;
                        snipersCaught ++;
