...
contract SquarezGame is Ownable, SquarezNFT, RandomGameBoard, SportsDataAPIConsumer, AdAuction {
    ...
    {
        // squarezNFT = IERC721(_tokenContract);
    ...
    function createGameBoard() public onlyOwner returns (bytes32 requestId) {
    ...
    function claimPrize(uint256 _quarter) public {
        ...
        // require(squarezNFT.ownerOf(quarterWinner(_quarter))==msg.sender,"Caller does not own winning tile");
