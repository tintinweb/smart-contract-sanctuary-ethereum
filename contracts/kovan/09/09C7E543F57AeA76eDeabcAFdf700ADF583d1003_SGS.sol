...
contract SGS is ERC20PresetMinterPauser,ERC20Permit {
    constructor(string memory name,string memory symbol) ERC20Permit(name) ERC20PresetMinterPauser(name,symbol) {
    }
