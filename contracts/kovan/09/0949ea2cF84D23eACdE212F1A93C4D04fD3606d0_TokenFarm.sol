...
contract TokenFarm is Ownable {
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            dappToken.transfer(recipient, userTotalValue * 1);
    ...
    function getUserSingleTokenValue(address _user, address _token)
        ...
        returns (uint256)
    {
        // 1 ETH => $3000 market value
        // 200 DAI => $ 200
        if (uniqueTokensStaked[_user] <= 0) {
            return 0;
        }
        // need to get the price of the token and multiply by stakingBalance[_token][user]
