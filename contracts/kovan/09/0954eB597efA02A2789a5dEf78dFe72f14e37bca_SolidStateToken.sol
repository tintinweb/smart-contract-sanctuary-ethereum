...
contract SolidStateToken is ERC20 {
    ...
    function getContractPriceAsPriceFeedCurrency() public returns (uint256) {
        ...
        return (_contractSalePrice / 1e18) * (price / (10**_decimals)); //(_contractSalePrice) / (price / (10**_decimals));
    }
    ...
    function getContractSalePrice() public view returns (uint256) {
        // get the trades and get the latest trade
        (
            uint256[] memory eth,
