...
contract TestUpgradable is SimpleAccessUpgradable {   
    mapping(address => uint256) public myMapping;
    uint256 public someOthervalue;
    IMyOtherContract public myOtherContract;
    ...
    function setMyMapping(address user, uint256 value) external onlyOwner {
        myMapping[user] = value;
    }

    function setMyOtherContract(address _contract) external onlyOwner {
        myOtherContract = IMyOtherContract(_contract);
    }
}
