    ...
    AccessControlUpgradeable
{
    ...
    function initialize(string memory _name, string memory _symbol, uint256 maxSupply) public initializer  {
    ...
    function setNewMaxSupply(uint256 newMaxSupply) public onlyOwner {
        require(newMaxSupply >= totalSupply(), "setNewMaxSupply: New supply cannot be less than total supply");
    ...
    {
        require(numberOfTokens + totalSupply() <= MAX_SUPPLY, "mintTokens: Max supply reached" ); 
