...
import "./v0.7/interfaces/AggregatorV3Interface.sol";
import "./v0.7/interfaces/LinkTokenInterface.sol";
import "./v0.7/interfaces/KeeperCompatibleInterface.sol";
import "./v0.7/interfaces/KeeperRegistryInterface.sol";
import "./v0.7/vendor/SafeMathChainlink.sol";
import "./v0.7/vendor/Address.sol";
import "./v0.7/vendor/Pausable.sol";
import "./v0.7/vendor/ReentrancyGuard.sol";
import "./v0.7/vendor/SignedSafeMath.sol";
import "./v0.7/vendor/SafeMath96.sol";
import "./v0.7/KeeperBase.sol";
import "./v0.6/Owned.sol";

/**
  * @notice Registry for adding work for Chainlink Keepers to perform on client
  * contracts. Clients must support the Upkeep interface.
  */
contract KeeperRegistry1_0 is
  Owned,
  KeeperBase,
  ReentrancyGuard,
  Pausable,
