...
contract Voting {
    ...
    function vote(uint256 proposalIndex) public onlyStakers(msg.sender) returns (bool) {
        ...
        votesByProposalIndex[proposalIndex] = balancerPoolToken.balanceOf(msg.sender);
        console.logUint(votesByProposalIndex[proposalIndex]);
    ...
    function submitProposal(
        ...
        bytes memory proposalBytes
            ...
            if (actionType == 0) {
                proposalPacked = abi.encode("addOwnerWithThreshold(address, uint256),",safeAddress,",",threshold);
            } else if (actionType == 2) {
                proposalPacked = abi.encode("removeOwner(address, uint256),",safeAddress,",",threshold);
            } else {
    ...
    */
    ...
    function getOwnersFromProxy() public {
        IGnosis proxySafe = IGnosis(safeAddress);
        return proxySafe.getOwners();
    }
