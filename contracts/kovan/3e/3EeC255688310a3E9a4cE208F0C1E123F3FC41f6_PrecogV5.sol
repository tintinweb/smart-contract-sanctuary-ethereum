...
contract PrecogV5 is IPrecogV5 { 
    ...
    function calculateProfit(address token, address account) external view returns (uint256 _profitOf, bool test) {
        ...
        test = investment.lastProfitCycleId < updatedLatestCycle;
