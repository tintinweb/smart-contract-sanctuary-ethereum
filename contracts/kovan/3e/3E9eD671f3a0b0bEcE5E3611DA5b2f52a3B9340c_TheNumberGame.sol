    ...
    SignerRole
{
    ...
    function mint(
        ...
        bytes32 mintHash = toEthSignedMessageHash(keccak256(abi.encodePacked(this, tokenId, amount, timestamp)));
        ...
        require(amount > 0 && amount <= maxMintCount, "amount is invalid");
        _mintedHashs[mintHash] = true;        
        for (uint256 x = 0; x < amount; x++) {
            uint256 curTokenId = tokenId + x;
