...
contract TokenDistributor is ReentrancyGuard {
     ...
     * @param _supplyCap supply cap of the token
    ...
    // Todo:: add permission contract
    // function setSupplyCap(uint256 _newSupplyCap) external nonReentrant {
    ...
    function _updatePool() internal {
        ...
        if (tokenRewardForStaking > 0) {
            ...
            stateToken.mint(tokenSplitter, tokenRewardForOthers);
        }
