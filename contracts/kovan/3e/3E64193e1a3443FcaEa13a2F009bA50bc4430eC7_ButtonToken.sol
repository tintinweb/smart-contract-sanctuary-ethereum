...
contract ButtonToken is IButtonToken, Initializable, OwnableUpgradeable {
    ...
    function _deposit(
        ...
        require(uAmount > 0 && amount > 0, "ButtonToken: too few button tokens to mint");
    ...
    function _withdraw(
        ...
        require(uAmount > 0 && amount > 0, "ButtonToken: too few button tokens to burn");
    ...
    function _bitsToUAmount(uint256 bits) private pure returns (uint256) {
        return bits.ceilDiv(BITS_PER_UNDERLYING);
    }
