...
contract LiquidationHelper is AaveFlashLoanReceiverBaseV2, Withdrawable {
    ...
    function _liquidateAndSwap(
        ...
        console.log("===>balanceOf", IERC20(params.borrowedAsset).balanceOf(address(this)));
        console.log(
            "===>allowance",
            IERC20(params.borrowedAsset).allowance(address(this), address(warpVault))
        );
        console.log("====>flashBorrowedAmount", flashBorrowedAmount);
