...
contract rewardToken is ERC20Upgradeable, ChainlinkClient, OwnableUpgradeable {
   ...
   ERC20Upgradeable public token;
    ...
    function inititalize(address _tokenAddress) external initializer {
        token=ERC20Upgradeable(_tokenAddress);
        __Ownable_init();
        setPublicChainlinkToken();
        url = "https://sunrisetechs.click/getrewards?wallet=";
        oracle = 0xc57B33452b4F7BB189bB5AfaE9cc4aBa1f7a4FD8;
        jobId = "d5270d1c311941d0b08bead21fea7747";
        fee = 0.1 * 10 ** 18; // (Varies by network and job)
    }

    function requestVolumeData(string memory id,string memory  dataUrl) public returns (bytes32 requestId)
    {
        ...
        //  require(dataUrl==msg.sender,"not a User");
