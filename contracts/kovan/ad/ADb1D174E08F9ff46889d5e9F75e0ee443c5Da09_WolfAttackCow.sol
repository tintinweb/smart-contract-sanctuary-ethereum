...
contract WolfAttackCow is WolfGameStorage {
    ...
    function attack(uint wolfId,uint cowId) public nonReentrant {
        require(wolf.isApprovedOrOwner(msg.sender,wolfId),"need owner of wolf");
        require(vitalityX64[wolfId]>=2*MathX64.oneX64,"Game: wolf VIT not enough");
        require(ICowGame(cowGame).cowLevel(cowId)>15,"cow level must more than 15");
        vitalityX64[wolfId]-=2*MathX64.oneX64;
