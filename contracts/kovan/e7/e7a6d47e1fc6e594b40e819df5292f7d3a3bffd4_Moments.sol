...
contract Moments is ERC721A, AccessControl, ContextMixin, NativeMetaTransaction {
...
function safeMint(address to, uint256[] calldata tokenIds, uint256 minted, uint32 _maxSupply, string[] memory uri)
    //string memory uri)
        public
