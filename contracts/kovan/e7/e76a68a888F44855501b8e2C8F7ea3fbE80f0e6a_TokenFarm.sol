...
contract TokenFarm is Ownable{
    ...
    constructor(address _dappTokenAddress) public {
        ...
        //now we can call functions on it
    }
    ...
    function issueTokens() public onlyOwner {
        for (uint i = 0; i < stakers.length; i++) {
            ...
            dappToken.transfer(recipient, userTotalValue); //transfer them the amount of total value they have staked as a reward
        }
    }
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        //transferFrom from the ERC20 function
        IERC20(_token).transferFrom(msg.sender, address(this), _amount);
        updateUniqueTokensStaked(msg.sender, _token);
        //add them to our stakers list if they aren't already there
