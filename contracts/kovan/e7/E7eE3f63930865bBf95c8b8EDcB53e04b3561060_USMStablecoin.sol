...
contract USMStablecoin is ERC20, Ownable, OperatorList {
    ...
    function mintUSM(address _to, uint _amount) external onlyOwner{
        _mint(_to, _amount);
    }
}
...
contract OperatorList is Ownable {
    ...
    function validatorAdd(address _address) external onlyOwner validAddress(_address) {
    ...
    function validatorRemove(address _address) external onlyOwner validAddress(_address) {
