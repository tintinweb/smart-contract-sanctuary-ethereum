...
contract TokenFarm is Ownable {
    ...
    // eg 100ETH 1:1 for every 1ETH, we give 1 DappToken
    ...
    function issueTokens() public onlyOwner {
        for (
            ...
            // dappToken.transfer(recipient, based on total value locked)
    ...
    // returns the staking balance of a single token
        ...
        returns (uint256)
    {
        ...
        // get price and number of decimals from function
