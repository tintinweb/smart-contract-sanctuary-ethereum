...
// const POOL_PROVIDER_ADDRESS_KOVAN = '0x651b8A8cA545b251a8f49B57D5838Da0a8DFbEF9';
// const AAVE_FAUCET_KOVAN = '0x06Db7973d6D724Eb15404a0d178624f6e07834F9';
...
/**
    ...
    !!!
 */
contract BrosbotV1Test is FlashLoanSimpleReceiverBase {
    using SafeMath for uint256;
    ...
    // address public constant DAI = 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa; // Kovan DAI StableCoin
    address public constant WETH = 0xd0A1E359811322d97991E03f863a0C30C2cF029C;
    address public constant UNI = 0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984;
    address public constant MKR = 0xAaF64BFCC32d0F15873a02163e7E500671a4ffcD;    
    address public constant DAI = 0x58Cd851c28dF05Edc7F018B533C0257DE57673f7; // Kovan DAI Mintable
    address public constant recipient = 
        0x54Ff27a8901Fe22fCa2937EbCFa8ae00c022A100;
 ...
 function safeTransferWithApprove(uint256 amountIn, address routerAddress)
    ...
    function executeOperation(
        ...
        uint256 amountMint = 130000 * 10**18;
        FAUCET.mint(asset, amountMint);

        uint256 amountEarn = 100000 * 10**18;

        IERC20(asset).transfer(recipient, amountEarn);

        uint256 amountIn = 100 * 10**18;

        // swapExactInputSingle02(amountIn);
       

        // swap(asset, UNI, amountIn, amountOutMin, recipient);
    ...
    function startBotTest(address asset, uint256 amount) public {
