    ...
    Ownable
{
    ...
    function _processSplit(CellData.Cell memory cell) private {
        if (CellData.Class(cell.class) == CellData.Class.SPLITTABLE_NANO) {
            ...
            console.log("Split Nano Cell");
            // emit NewCellCreated("NanoCell", nanoCells.current());
        } else if (
            ...
            console.log("Split %s MAD token", amount);
            ...
            console.log("Split Enhancer Id: %s", randomEnhancerId);
