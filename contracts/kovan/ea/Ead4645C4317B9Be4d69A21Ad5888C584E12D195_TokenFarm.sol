...
contract TokenFarm is ChainlinkClient, Ownable {
    string public name = "Dutch Token Farm";
    IERC20 public dutchToken;
    ...
    constructor(address _dutchTokenAddress) public {
        dutchToken = IERC20(_dutchTokenAddress);
    }
    ...
    function issueTokens() public onlyOwner {
        ...
        for (
            ...
            dutchToken.transfer(recipient, getUserTotalValue(recipient));
        }
    }
