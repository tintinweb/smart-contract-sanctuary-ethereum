...
{   
    ...
    address public _ArtBlocksMintingContractArtists = address(0);                                       // ArtBlocks Minting Contract Artists
    address public _ArtBlocksCoreContractCitizens = address(0);                                         // KOVAN ArtBlocks Citizen NFT Collection Contract Address
    address public _ArtBlocksCoreContractArtists = address(0);                                          // ArtBlocks Artist NFT Collection Contract Address 
    ...
    { 
        ...
        ArtistMintPasses[_CurrentCityIndex][1] = 0xc22266Fa49E15BbE2f9622B8EEF652C5f8628A29; // Artist Mint Pass #1
        ArtistMintPasses[_CurrentCityIndex][2] = 0xc22266Fa49E15BbE2f9622B8EEF652C5f8628A29; // Artist Mint Pass #2
        ArtistMintPasses[_CurrentCityIndex][3] = 0xc22266Fa49E15BbE2f9622B8EEF652C5f8628A29; // Artist Mint Pass #3
        ArtistMintPasses[_CurrentCityIndex][4] = 0xc22266Fa49E15BbE2f9622B8EEF652C5f8628A29; // Artist Mint Pass #4
        ArtistMintPasses[_CurrentCityIndex][5] = 0xc22266Fa49E15BbE2f9622B8EEF652C5f8628A29; // Artist Mint Pass #5
        ArtistMintPasses[_CurrentCityIndex][6] = 0xc22266Fa49E15BbE2f9622B8EEF652C5f8628A29; // Artist Mint Pass #6
    ...
    {
        require(BookingsAvailable[_CurrentCityIndex][TimeSlot] > 0, "LiveMint: TimeSlot Fully Booked");
        // require(!RedeemedQR[_CurrentCityIndex][msg.sender], "User Has Already Redeemed"); //commented out 4 testin
        require(readBrightListMerkle(msg.sender, Proof), "LiveMint: User Is Not On BrightList"); 
        // RedeemedQR[_CurrentCityIndex][msg.sender] = true; //commented out 4 testin
        BookingsAvailable[_CurrentCityIndex][TimeSlot]--;
