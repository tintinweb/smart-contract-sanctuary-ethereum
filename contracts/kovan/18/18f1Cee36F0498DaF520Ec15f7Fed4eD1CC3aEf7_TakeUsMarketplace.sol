...
contract TakeUsMarketplace is Ownable {
  ...
  {
    if (listingERC721[_nftAddress][_tokenId].price < _price) {
      transfer(
        msg.sender,
        addressRegistry.royaltyCollector(),
        _price - listingERC721[_nftAddress][_tokenId].price,
        listingERC721[_nftAddress][_tokenId].paymentToken
      );
    }
    listingERC721[_nftAddress][_tokenId] = Lending({
      duration: _duration,
      price: _price,
      lender: listingERC721[_nftAddress][_tokenId].lender,
      paymentToken: listingERC721[_nftAddress][_tokenId].paymentToken
    });
    emit Updated(
      address(_nftAddress),
      _tokenId,
  ...
  {
    if (listingERC1155[_nftAddress][_tokenId].price < _price) {
      transfer(
        msg.sender,
        addressRegistry.royaltyCollector(),
        _price - listingERC1155[_nftAddress][_tokenId].price,
        listingERC1155[_nftAddress][_tokenId].paymentToken
      );
    }
    ...
    listingERC1155[_nftAddress][_tokenId] = Lending({
      ...
      price: _price,
      lender: msg.sender,
      paymentToken: listingERC1155[_nftAddress][_tokenId].paymentToken
    });
    emit Updated(
      address(_nftAddress),
      _tokenId,
