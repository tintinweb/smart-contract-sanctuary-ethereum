...
contract capsStaking is Ownable {
    ...
    function setMaxDataFetchSizeLimit(uint newSize) public onlyOwner {
    ...
    function getCapsTokenContractAddress() public view returns (address) {
    ...
    function getActiveStacker(uint index) public view returns (address) {
