...
contract CronosMaximus is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "CronosMaximus";
    ...
    uint256 public _maxTxAmount = 10 * 10**3 * (10 ** _decimals);
    uint256 public _walletMax = 10 * 10**3 * (10 ** _decimals);
    ...
    constructor (IUniRouterV2 _router) Auth(msg.sender) {
        ...
        //Wallets
        autoLiquidityReceiver = address(0x7c41E8C2D9da3db2dAec165e4123760d65be4E63);
        marketingWallet = address(0xD3650A418B7082597F76396482A88F99315Bf33C);
        developmentWallet = address(0x7c41E8C2D9da3db2dAec165e4123760d65be4E63);
        vaultWallet = address(0x8c776Ce632CCc562ee6E6C9c903Ce6818F2E8666);
