...
contract Transaction is ERC2771Context, Ownable {
    ...
    function sendViaTransfer(address payable seller) public payable onlyOwner{
        // This function is no longer recommended for sending Ether.
        seller.transfer(msg.value);
    }

    function sendViaSend(address payable seller) public payable onlyOwner{
    ...
    function sendViaCall(address payable seller) public payable onlyOwner{
