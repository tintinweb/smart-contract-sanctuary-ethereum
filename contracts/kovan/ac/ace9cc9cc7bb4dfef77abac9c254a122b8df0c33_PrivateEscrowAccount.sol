...
// deposits working
// restricted deposits working
// whitelisted token addresses working
// execute trade working

// reneg isnt taking the total amount deposited 

// reneg needs to be tested
// 0.1% fee needs to be implemented
// execute and reneg features need to be restricted ideally to the parties through a modifier
// contract not reusable, need to reset deposited count or suicided
...
//    }
    ...
    function executeTrade() external { // needs re-entrancy guard
      ...
      function withdrawTrade() external { // needs re-entrancy guard
...
//       function renegTrade() external {
//         tokenContractB.transferFrom(address(this), partyB, tokenAmountB);
//         tokenContractA.transferFrom(address(this), partyA, tokenAmountA);
