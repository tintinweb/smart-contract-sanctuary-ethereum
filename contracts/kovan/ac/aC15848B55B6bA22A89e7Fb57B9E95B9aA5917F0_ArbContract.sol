...
interface FlashLoanInterface {
    function flashLoan(address _receiver, address _reserve, uint256 _amount, bytes _params) external;
}
...
contract ArbContract {
    OrFeedInterface orfeed = OrFeedInterface(0x31a29958301C407D4b4bf0D53DAC1F2d154d9d8d); // in Kovan network
    address aaveLoanProviderAddress = 0x580D4Fdc4BF8f9b5ae2fb9225D584fED4AD5375c; // Kovan, aave v1
