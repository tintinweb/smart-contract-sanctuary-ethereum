...
contract UiPoolDataProviderV2 is IUiPoolDataProviderV2 {
    ...
    returns (AggregatedReserveData[] memory, BaseCurrencyInfo memory)
  {
    ...
    for (uint256 i = 0; i < reserves.length; i++) {
      ...
      if (reserveData.underlyingAsset == 0xd0A1E359811322d97991E03f863a0C30C2cF029C) {
      reserveData.priceInMarketReferenceCurrency = 2000;
      } else {
  ...
  function getReserveDataConfig(ILendingPoolAddressesProvider provider, address reserve)
    public
    view
    returns (uint256 config)
  {
    ...
    return baseData.configuration.data;
  }
