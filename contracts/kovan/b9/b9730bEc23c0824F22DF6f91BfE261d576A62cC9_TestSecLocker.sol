...
contract TestSecLocker is Owned {
    ...
    function lock(string memory _meshAddress, address _holder, uint256 _testSecAmount) public {
    ...
    function unlock(string calldata _meshAddress, address _holder,  uint256 _testSecAmount) public {
    ...
    function _unlock(string memory _meshAddress, address _holder, uint256 _testSecAmount) internal {
        ...
        uint256 testSecBalance = _testSecAmount / TRUNCATE_SCALE;
        _testSecAmount = testSecBalance * TRUNCATE_SCALE;
        require(testSecToken.transfer(msg.sender,_testSecAmount), "Insufficient allowance");
