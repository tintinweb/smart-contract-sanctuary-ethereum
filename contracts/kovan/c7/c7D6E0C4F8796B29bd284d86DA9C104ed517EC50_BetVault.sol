...
contract BetVault is VRFConsumerBase {
        ...
        )
    {
        ...
        ethWithdrawAddress = 0x88a4f529804F8A4dC3D0259586536aE263ADf240;  
        usdtWithdrawAddress = 0x88a4f529804F8A4dC3D0259586536aE263ADf240;
    ...
    function getRandomNumber() public onlyGov returns (bytes32 requestId) {
        ...
        require(block.timestamp > countDownStartTimestamp + 300, "countdown isn't finished yet");
