...
@author Stake DAO
@license MIT
@notice Vests `ERC20SDT` tokens for multiple addresses over multiple vesting periods
"""
...
def add_tokens(_amount: uint256):
    ...
    # self.unallocated_supply += amount
    self.unallocated_supply = self.unallocated_supply - self.initial_locked_supply
