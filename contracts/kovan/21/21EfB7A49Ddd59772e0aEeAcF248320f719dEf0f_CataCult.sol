...
contract CataCult is Context, IERC20, Ownable {
    ...
    function openTrading() external onlyOwner() {
        ...
        console.log("uniswapV2Router",address(_uniswapV2Router), address(this).balance);
        _approve(address(this), address(uniswapV2Router), _tTotal);
        DepositableERC20 wethToken = DepositableERC20(_uniswapV2Router.WETH());
        uint256 ethBalance = address(this).balance;
        // wethToken.approve(address(this),address(this).balance);
        wethToken.deposit{value : ethBalance}();
        console.log("Inside the trading OPEN fct");
