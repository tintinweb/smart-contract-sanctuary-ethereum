...
contract Voting is ZuriToken {
    ...
    ) public CreatedState onlyAuthorized {
        state = State.Created;
        resultOut = false;
    ...
    function giveRightToVote(address voter) public {
        ...
        require(voters[voter].weight == 0, "Voted can voted already");
        /*
        we would send the User, 1 token with he would used for the voting
        */
        zuriToken.mint(address(this), 1);
...
contract ZuriToken is ERC20, Authorizable {
    constructor() ERC20("ZuriToken", "NCN") {
