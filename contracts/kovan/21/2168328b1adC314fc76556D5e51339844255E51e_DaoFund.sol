...
contract DaoFund is Fund {
    /*===================== CONSTANTS =====================*/
    uint256 private constant ALLOCATION = 20_000_000 ether; // 20% for DAO fund
    uint256 private constant VESTING_DURATION = 2 * 365 * 24 * 3600;
    uint256 private constant VESTING_START = 1646870400;

    /*===================== CONSTRUCTOR =====================*/
    constructor(address _share) Fund(_share) {}
...
abstract contract Fund is Ownable {
    ...
    constructor(address _share) {
        require(_share != address(0), "Fund::constructor: Invalid address");
        share = IERC20(_share);
    }
    ...
    function transfer(address receiver, uint256 amount) external onlyOwner {
        ...
        share.safeTransfer(receiver, amount);
    }
}