...
interface IERC20 {
    ...
    /* EVM State changing functions */
    function approve(address spender, uint256 amount) external returns (bool);
    function transfer(address recipient, uint256 amount) external returns (bool);
    function transferFrom(address sender, address recipient, uint256 amount) external returns (bool);

    /* Non State or view functions */
...
abstract contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender(), "Caller is not the owner, pls check");
        _;
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
     ...
     function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "New owner address cant be Zero address");
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    /* Public functions that can be accessible outside contract listed in alphabetical order*/
    ...
    /* Internal functions only accessible via this Contract */
...
contract ST1 is ERC20, Ownable {
    ...
    constructor() ERC20("ST1.is", "ST1") {
        ...
        uint256 _sellMarketingFee = 10; /* After first 20 mins launch it will go down to 10% */
        uint256 _sellLiquidityFee = 10; /* After first 20 mins launch it will go down to 3% */ 
        uint256 _sellRewardsFee = 10; /* After first 20 mins launch it will go down to 2% */ 

        uint256 totalSupply = 100_000_000_000 * 1e18;

        maxTransactionLimit = 1_000_000_000 * 1e18; // 1% from total supply
        ...
        marketingWallet = address(0xaD242F79780B5c225f59DE8Db350a0C8CB80898A); // set as marketing wallet
        rewardsWallet = address(0x7fdF0B507e3fdc1dD3F64f0db7c97972daac4D48); // set as rewards wallet
    ...
    function setMaxTxnLimit(uint256 newNum) external onlyOwner {
        require(
            ...
            "Cannot set maxTransactionLimit lower than 0.1%"
        );
        maxTransactionLimit = newNum * (10**18);
    }
