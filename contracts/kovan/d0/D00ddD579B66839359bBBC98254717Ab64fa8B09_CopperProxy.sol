...
contract CopperProxy is Ownable {
    ...
    constructor(
        ...
        _partnerShare[_primaryFeeRecipient] = 5000; // 50% default
        _partnerShare[_secondaryFeeRecipient] = 3000; // 30% default
        _partnerShare[_tertiaryFeeRecipient] = 2000; // 20% default
    }
    ...
    function changePrimaryFeeRecipient(address newRecipient) external onlyOwner {
        address previousFeeRecipient = _primaryFeeRecipient;
        _primaryFeeRecipient = newRecipient;
        emit ChangedFeeRecipient(previousFeeRecipient, newRecipient);
    }

    function changeFeeRecipient(address newRecipient) external onlyOwner {
        address previousFeeReciepient = _primaryFeeRecipient;
        _primaryFeeRecipient = newRecipient;
        emit ChangedFeeRecipient(previousFeeReciepient, newRecipient);
    }

    function changeSecondaryFeeRecipient(address newRecipient) external onlyOwner {
        address previousFeeRecipient = _secondaryFeeRecipient;
        _secondaryFeeRecipient = newRecipient;
        emit ChangedFeeRecipient(previousFeeRecipient, newRecipient);
    }

    function changeTertiaryFeeRecipient(address newRecipient) external onlyOwner {
        address previousFeeRecipient = _tertiaryFeeRecipient;
        _tertiaryFeeRecipient = newRecipient;
        emit ChangedFeeRecipient(previousFeeRecipient, newRecipient);
    }

    function changePartnerShare(address feeRecipient, uint256 newPercentage) external onlyOwner {
        _partnerShare[feeRecipient] = newPercentage;
        emit ChangedPartnerShare(feeRecipient, newPercentage);
    }
