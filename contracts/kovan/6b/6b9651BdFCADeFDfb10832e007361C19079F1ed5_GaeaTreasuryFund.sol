...
contract GaeaTreasuryFund is Fund {
    uint256 public constant ALLOCATION = 2_400_000 ether;
    uint256 public constant VESTING_DURATION = 3 * 365 * 24 * 3600; // 3 years
    uint256 public constant VESTING_START = 1650636000; // 22nd Apr 2022, 2PM UTC
