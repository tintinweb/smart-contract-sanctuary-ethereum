...
// TODO: Upgradeable
contract NFToneToken is ERC721, ERC721Royalty, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor(address owner, address storeContract, address royaltyAddress, uint96 royaltyRate) ERC721("NFToneToken", "NFTONETST") {
        // Mint starter tokens
        safeMint(owner, "");
        safeMint(owner, "");
        safeMint(owner, "");
        ...
        if (royaltyAddress != address(0)) {
            setDefaultRoyalty(royaltyAddress, royaltyRate);
        }
    }
