...
contract WLNFT_MintPass is ERC721A, ChainlinkClient, Ownable {
    ...
    // whitelist minting
    function mintPhase1(uint256 _quantity) internal returns (bytes32 requestId) {
    ...
    function fulfill(bytes32 _requestId, bool _isWhitelisted) public recordChainlinkFulfillment(_requestId) {
        ...
        require(requests[_requestId].quantity > 0, "Must mint one or more.");
