...
contract Core is Ownable, IInitialization {
    ...
    Core public immutable masterContract;
    ...
    function init(bytes calldata data) public payable override {
        require(address(collateral) == address(0), "Core: already initialized");
        ...
        require(address(collateral) != address(0), "Core: bad pair");
    }
    ...
    modifier solvent() {
        _;
        require(_isSolvent(msg.sender, exchangeRate), "Core: user insolvent");
    }
