...
contract DestNFT is ERC721,
    ...
    function updateMetadataHashList(bytes32[] memory metahashes) external override onlyOwner {
        metadataHashList = metahashes;
        emit MetaHashListInitialized(metahashes);
    }
...
interface IDestNFT is IERC721 {
    ...
    function updateMetadataHashList(bytes32[] memory metahashes) external;
}
