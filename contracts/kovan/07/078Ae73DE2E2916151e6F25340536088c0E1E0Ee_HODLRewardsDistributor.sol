...
contract HODLRewardsDistributor is Ownable {
    ...
    mapping (address => bool) public shareController;

    modifier onlyShareControllers () {
        require(shareController[msg.sender] || msg.sender == owner(),"HODLRewardsDistributor: Not a share controller");
        _;
    }
    ...
    constructor (address wavax_){
        wavax = wavax_;
        shareController[msg.sender] = true;
