...
contract NodeERC1155 is INodeERC1155, ERC1155, Ownable, ReentrancyGuard {
    ...
    uint256 private _rewardInterval = 1 minutes;
    uint256 private _period = 30 minutes;
    ...
    function getClaimableCork(address claimAddress) public view returns (uint256) {
