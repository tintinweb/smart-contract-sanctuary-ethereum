...
interface IMarketPlace {
     ...
     */
    function withdrawMDMATokens() external;
...
contract Marketplace is IAdmin, IEnhancer, IMarketPlace, IModuleBox, Ownable {
    ...
    function withdrawMDMATokens() external override onlyOwner {
        uint256 balance = IERC20(mdmaTokenAddress).balanceOf(address(this));

        IERC20(mdmaTokenAddress).transferFrom(address(this), owner(), balance);
    }
