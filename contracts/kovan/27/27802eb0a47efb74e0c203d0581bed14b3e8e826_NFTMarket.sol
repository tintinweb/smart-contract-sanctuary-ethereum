...
contract BEP721 is Context, BEP165, IBEP721, IBEP721Metadata {
    ...
    function _safeTransfer(
        ...
        _transfer(from, to, tokenId);
        require(_checkOnBEP721Received(from, to, tokenId, _data), "BEP721: transfer to non ERC721Receiver implementer");
    }
    ...
    function _safeMint(
        ...
        require(
            ...
            "BEP721: transfer to non ERC721Receiver implementer"
        );
    }
    ...
    function createMarketItem(
        ...
        //  require(msg.value == listingPrice, "Price must be equal to listing price");
         ...
         idMarketItem[itemId] = MarketItem(
            ...
            IBEP721(nftContract).transferFrom(msg.sender, address(this), tokenId);
        ...
        function createMarketSale(
           ...
           idMarketItem[itemId].seller.transfer(msg.value);
            ...
            IBEP721(nftContract).transferFrom(address(this), msg.sender, tokenId);
