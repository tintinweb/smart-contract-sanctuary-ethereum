...
contract Token {
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        // Ensure sending to valid address! 0x0 address can be use to 
    ...
    /// @notice Apporval other spend on your behalf eg an exchange
    /// @param _spender allowed to spend and a max amount allowed to spend 
    /// @param _value amount value of token to send
    /// @return true, success one address approved
    ...
    ///@notice transfer by approved person from originals address of an amount 
    ///@param _from, address sending to an the amount to send
    ///@param _to reciever of token 
    ///@param _value amount value of token to send
    ///@dev internal helper transfer function with required safety checks 
