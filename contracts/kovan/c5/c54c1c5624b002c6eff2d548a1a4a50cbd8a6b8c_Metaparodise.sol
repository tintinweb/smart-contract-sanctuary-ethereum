...
contract Metaparodise is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meta parodise";
    string private _symbol = "Mparo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24D47b93465757C7468Fd62dB139079c1a0a2977);
    address payable public teamWalletAddress = payable(0x011907df99347A6Dd8cB936C20cC987e2dF29Ec5);
