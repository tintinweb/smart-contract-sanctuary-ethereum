...
contract NToken is ERC721A, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 reserveQuantity, uint256 totalSupply_, uint256 clubId_) ERC721A(name_, symbol_) {   
    ...
    function _baseURI() override internal view returns (string memory) {
        string memory factoryBaseURI = NFTClubFactory(factory)._factoryBaseURI();
        return string(abi.encodePacked(factoryBaseURI, "/0x", this));
    }
    ...
    // Set the sale period. See `enum Period` for definition
    function setPeriod(Period newPeriod) public onlyOwner {
        _period = newPeriod;
    }
...
contract NFTClubFactory is Ownable {
    ...
    string public _factoryBaseURI = "https://tinyclub.com";
    ...
    /// Set the factoryBaseURI, no trailing slashes
    function setFactoryBaseURI(string memory newBaseURI) public onlyOwner {
        _factoryBaseURI = newBaseURI;
    }
