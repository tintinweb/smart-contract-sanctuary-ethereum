...
contract NoDecimalsFactoryClone {
    ...
    constructor() {
        tokenImplementation = address(new NoDecimalsERC20());
    }
    ...
    function createToken(string calldata name, string calldata symbol, uint256 initialSupply) external returns (address) {
        ...
        NoDecimalsERC20(clone).initialize(name, symbol, msg.sender, initialSupply);
        
        // _tokens.add(address(clone.address)); TODO add token to set
        return clone;
    }
 }
...
contract NoDecimalsERC20 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize (string memory name, string memory symbol, address mintTo, uint256 mintAmount) public initializer {
