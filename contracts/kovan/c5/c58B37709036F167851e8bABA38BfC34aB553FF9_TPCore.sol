...
contract TPCore is AccessControl {
    ...
    // 32 (max 1 year)
    uint32 public tpyInterval = 10 seconds;
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        if(uint32(block.timestamp) - ownerPercentageLastChangeTS < 10 days) {
    ...
    function stake(uint104 amount) external {
        ...
        liquidityToken.mint(_msgSender(), liquidityAmount * 100);   /////////////////////////////////// add "* 10000" //////////////////////////////////
