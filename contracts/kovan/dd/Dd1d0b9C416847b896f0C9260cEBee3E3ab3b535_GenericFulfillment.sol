    ...
    FulfillChainlinkExternalRequestCompatible
{
    ...
    error GenericFulfillment__LinkTransferFailed(address to, uint256 amount);
    ...
    function _requireLinkTransfer(
        ...
        if (!_success) {
            revert GenericFulfillment__LinkTransferFailed(_to, _amount);
        }
    }
}
...
import "./FulfillChainlinkExternalRequestBase.sol";
