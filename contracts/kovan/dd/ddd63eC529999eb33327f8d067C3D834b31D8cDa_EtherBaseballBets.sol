...
contract EtherBaseballBets is ChainlinkClient {
    ...
    */
    ...
    function fulfillGames(bytes32 _requestId, bytes[] memory _games) public recordChainlinkFulfillment(_requestId) {
        ...
        resultRD = getGameResolvedRD(_requestId, 0);
        fetchedRD = true;
    }
/*
    function fulfillGames(bytes32 _requestId, bytes[] memory _games) public recordChainlinkFulfillment(_requestId) {
...
*/
    ...
    function getGameResolvedRD(bytes32 _requestId, uint256 _idx) public view returns (GameResolveRD memory) {
        GameResolveRD memory game = abi.decode(requestIdGames[_requestId][_idx], (GameResolveRD));
        return game;
    }
