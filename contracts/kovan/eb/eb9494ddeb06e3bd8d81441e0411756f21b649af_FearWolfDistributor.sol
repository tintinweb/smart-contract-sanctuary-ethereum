...
contract FearWolfDistributor is AccessControl, Pausable, Withdrawable, ReentrancyGuard {
    ...
    */
    ...
    constructor() {
        whitelistedPresaleStart = block.timestamp + 1 hours;
        publicPresaleStart = whitelistedPresaleStart + 2 hours;
        saleStart = whitelistedPresaleStart + 3 hours;
        claimingStart = whitelistedPresaleStart + 4 hours;
    }
