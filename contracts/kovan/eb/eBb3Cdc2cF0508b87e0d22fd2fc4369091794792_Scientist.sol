...
contract Scientist is ERC721TradableUpgradeable, AScientistRepository, ReentrancyGuard {
    ...
    function setMintableAmount(uint256 newAmount) external onlyTimelock {
        remainingAmount = mintableAmount = newAmount;
    }

    function setPrice(uint256 newPrice) external onlyTimelock {
        price = newPrice;
    }
    ...
    function _create(address _account)
        internal
    {
        ScientistData.Point memory _point;
