...
contract UniswapV3LPFactory is Ownable{
    ...
    constructor(address _uniswapV3Factory, address _WETH9, address _tickHelper, address _feeHelper) {
    ...
    function createOrUpdatePool(address _token0, address _token1, uint24 _fee, uint160 _sqrtPriceX96) external returns (address lpToken) {
        ...
        UniswapV3LPToken lpTokenContract = new UniswapV3LPToken("Unicrypt Uniswap V3 LP","UNCX-UNI-V3-LP", token0, token1, _fee, pool, WETH9);
