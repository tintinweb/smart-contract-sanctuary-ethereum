...
contract ModuleManager is SelfAuthorized, Executor {
    ...
    /// @dev Allows to add a module to the whitelist while doing the setup of the safe
    /// it can only be called once
    /// @notice Enables the module `module` for the Safe.
    /// @param module Module to be whitelisted.
    function enableKeyperModule(address module) public {
        // Module address cannot be null or sentinel.
        require(module != address(0) && module != SENTINEL_MODULES, "GS101");
        // Method cannot be called twice.
        require(keyperEnabled == false, "Keyper module can only by set once");
        // Module cannot be added twice.
        require(modules[module] == address(0), "GS102");
        modules[module] = modules[SENTINEL_MODULES];
        modules[SENTINEL_MODULES] = module;
