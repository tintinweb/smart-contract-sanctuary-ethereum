...
contract CopperProxy is Ownable {
    ...
    function changePrimaryFeeRecipient(address newRecipient, uint256 shareSize) external onlyOwner {
        ...
        require(
            _partnerShare[_primaryFeeRecipient] +
            _partnerShare[_secondaryFeeRecipient] +
             _partnerShare[_tertiaryFeeRecipient] == 10_000,
             "All percentage together can't be more than 100%"
        );
