...
{   
    ...
    address public immutable _BRTMULTISIG = 0xcff43A597911a9457071d89d2b2AC3D5b1862b86;                 // BRT Multisig Address
    address public _ERC20_BRT_Token;                                                                    // BRT ERC-20 Contract Address   
    ...
    uint _QRIndex = 334;                                                                                // QR Code Index
    bytes32 public Root = 0xf8e478dac7230526fe7b2386e720c40522b9f2d5d3d09154a32c1b9a39173b59;           // Merkle Root
    ...
    { 
        ...
        _QRIndex = 334; // First QR To Be Redeemed
    }
    ...
    function readMetadata(
        ...
        {
            Metadata[TokenID] = ERC721(ContractAddress).tokenURI(TokenIDs[TokenID]);
        }
        return Metadata;
    }
    ...
    function readBatchMetadata(
        ...
        for(uint ProjectID; ProjectID < ContractAddresses.length; ProjectID++)
        {
            ...
            {
                Metadata[ProjectID][TokenID] = ERC721(ContractAddresses[ProjectID]).tokenURI(TokenIDs[ProjectID][TokenID]);
            }
        }
        return Metadata;
    }
