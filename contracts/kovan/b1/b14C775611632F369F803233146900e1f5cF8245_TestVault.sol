...
contract TestVault is VaultInterface {
    ...
    uint32 public rewardGrowthSpeed = 1;
    ...
    function balanceOf(address user_) public view override returns(uint256) {
        ...
        //uint256 balance = s.amount * 90 / 100 + s.amount * (block.number - s.lastBlockNumber) * rewardGrowthSpeed / 1000000; /// TODO for each block;
        return balance;
    }
