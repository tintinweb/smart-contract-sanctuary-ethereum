...
contract PrecogVault is IPrecogVault {
    ...
    modifier onlyPrecog() {
        require(msg.sender == precogStorage.getPrecog());
        _;
    }
    ...
    function _decreaseInvestmentWhenWithdraw(
        ...
        {
            IPrecogStorage.AccountTradingInfo memory _accountTradingInfo = precogStorage.getAccountTradingInfo(_token, msg.sender);
            _accountTradingInfo.availableAmount -= _amount;
            precogStorage.updateAccountTradingInfo(_token, msg.sender, _accountTradingInfo);
        }
    ...
    function _withdrawBeforeFundingTime(
        ...
        IERC20(_token).safeTransfer(precogStorage.getCore(), _fee);
    }
