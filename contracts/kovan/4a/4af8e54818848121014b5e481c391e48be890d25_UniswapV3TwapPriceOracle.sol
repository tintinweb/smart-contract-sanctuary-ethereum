...
/** 
 *  SourceUnit: /Users/sg99xxml/projects/bazaar-contract/contracts/oracles/UniswapV3TwapPriceOracle.sol
*/
...
contract UniswapV3TwapPriceOracle is BasePriceOracle {
    ...
    constructor(address _uniswapV3Factory,address _WETH) public {
     ...
     */
    uint24 public immutable feeTier = 3000;


    /**
     * @dev Base token (WETH by default).
     */
    address public immutable baseToken = WETH;
    ...
    function _price(address underlying) internal view returns (uint256) {
        ...
        uint128 baseUnit = 10**uint128(IERC20(underlying).decimals());
