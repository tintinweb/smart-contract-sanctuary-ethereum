...
############### variables ###############
BITTULIP_ADDR: constant(address) = 0x79B7076E06b6FF0B75f216ddD799E6828cd9ebB3

GOLDEN_BITTULIP_ADDR: constant(address) = 0x28D30c89Edc7118476d95779b1F004b2a96ac551 
...
def setBlockRaff():
	...
	assert self.balance >= as_wei_value(MAX_RAFF, "ether"), "Stop trying to cheat the raffle design Josh"
	self.blockRaff = block.number + 300
