...
contract FrankTreasury is Ownable {
    ...
    function _addPoolAndFarmLiquidity3(uint256 _amount, address _pool) public {
        ...
        uint256 quote = TraderJoeRouter.quote(safeAmount, reserveA, reserveB);
        ...
        IERC20(tokenB).approve(address(TraderJoeRouter), quote);

        (, , uint256 liquidity) = TraderJoeRouter.addLiquidity(tokenA, tokenB, _div, quote, 0, 0, address(this), block.timestamp + 1000);
