...
contract NeedForSeed is IERC20, Ownable {
    ...
    constructor(
        ...
        _maxWalletSize = 300000000000000; //%3

        _numOfTokensRequiredInAccount = 10000000000000; //%1

        _ETHEntryFee = 5000000000000000; //0.005
       ...
       // address router_=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
        ...
        buyBackWallet=payable(0xC9f297599c515FEC9153E06de9871362071bE128);
   ...
   function manualToken() external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 liquidityETHPortion = newBalance.mul(10000).div(divisor);
        liquidityETHPortion = liquidityETHPortion.div(10000).mul(liqD);
