...
contract CricStoxCurve is Ownable {
    ...
    uint256 public priceSetTill = 0; // the value of total supply till which price has been set
    ...
    /**
        ...
        * @param totalSupply The total to get price at.
    ...
    /**
        ...
        * @param startingTotalSupply The total supply to start setting price at.
