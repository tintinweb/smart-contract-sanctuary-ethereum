...
contract LARToken is ERC20,AbstractController{

    IController icontroller;
    address public platformAdmin;
    
    constructor(address controllerAddress) ERC20("LAR Token", "LAR") AbstractController(controllerAddress){
    ...
    function burn(uint256 amount) public virtual onlyPlatformAdmin{
        _burn(_msgSender(), amount);
    }

    function mint(uint256 amount) public onlyPlatformAdmin {
        _mint(msg.sender,amount);
    }

    
    function burnFrom(address account, uint256 amount) public virtual onlyPlatformAdmin {
