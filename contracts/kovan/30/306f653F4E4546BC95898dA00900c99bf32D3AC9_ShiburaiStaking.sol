...
contract ShiburaiStaking is Ownable {
    ...
    uint256 public constant YEAR = 360 * 1 minutes;   // 30 days for 1 Month
    ...
    uint256[3] public durations = [30 minutes, 30 minutes, 30 minutes]; // lock durations
        ...
        returns (uint256 reward)
    {
        ...
        if (block.timestamp < userStakeInfo.unlockTime) {
            ...
            //         reward = userStakeInfo.rewardPerDay.mul(
