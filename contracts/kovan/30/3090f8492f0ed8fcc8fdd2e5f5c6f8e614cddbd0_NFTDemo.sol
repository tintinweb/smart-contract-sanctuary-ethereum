...
contract NFTDemo is ERC721URIStorageUpgradeable, OwnableUpgradeable{
    ...
    function mint(uint256 _times) payable public {
        require(_times >0 && _times <= maxBatch, "wrong batch");
        require(totalSupply + _times <= totalCount, "mint too much");
