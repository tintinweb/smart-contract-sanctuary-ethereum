...
// FakeLoserClub is a compromised version of LoserClub. use to test stuff lol

contract FakeLoserClub is ERC721A, Ownable {
  // general
  ...
  constructor() payable ERC721A('Loser Club', 'LOSERCLUB') {
    ...
    publicSaleTime = 0; // (March 5, 9:00 PM UTC)
