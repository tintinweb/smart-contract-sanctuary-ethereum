...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x308A80EaC7B00CcA19141972cD3A6BA6250ce5f0;
...
contract REU is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA82B94B1d49A2ac0A6b83226FC00847e074CCB90;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 77000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "REU Mining";
    string private _symbol = "REU";
    ...
    function setTaxFeePercent(uint256 developmentFee) external onlyOwner() {
        _taxFee = developmentFee;
    }
    function setDevelopmentFeePercent(uint256 developmentFee) external onlyOwner() {
        _developmentFee = developmentFee;
    }
    function setLiquidityFeePercent(uint256 developmentFee) external onlyOwner() {
        _liquidityFee = developmentFee;
    }
