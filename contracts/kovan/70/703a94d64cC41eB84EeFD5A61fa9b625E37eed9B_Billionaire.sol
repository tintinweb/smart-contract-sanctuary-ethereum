...
contract Billionaire is Ownable, PaymentSplitter, ERC721A, ReentrancyGuard {
  ...
  constructor(string memory _theBaseURI, string memory _notRevealedURI)
    PaymentSplitter(_team, _teamShares)
    ERC721A("GreeenLishg", "Gl")
  {
