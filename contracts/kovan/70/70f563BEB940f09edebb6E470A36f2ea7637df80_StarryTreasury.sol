...
/*  StarryTreasury.sol ============================================
    The contract is to store the reserve of Starry Protocol
...
==================================================================== */
contract StarryTreasury is Ownable {
    using SafeERC20 for IERC20;
    using Address for address;

    mapping(address => bool) public strategies;
    address[] public strategiesArray;
    IStarryStaking public staking;

    constructor(IStarryStaking _staking) {
        staking = _staking;
    }

    // ========== PUBLIC VIEW FUNCTIONS ============

    /// @notice Return ERC-20 balance of StarryTreasury
    /// @param _token Address of the ERC-20 token
    /// @return Balance of the StarryTreasury
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(strategies[msg.sender], "StarryTreasury::requestFund: Only strategies can request fund");
        require(_amount <= balanceOf(_token), "StarryTreasury::requestFund: Request more fund than balance");
    ...
    function addStrategy(address _strategy) external onlyOwner {
        require(_strategy != address(0), "StarryTreasury::addStrategy: invalid address");
        require(!strategies[_strategy], "StarryTreasury::addStrategy: strategy was previously added");
    ...
    function removeStrategy(address _strategy) external onlyOwner {
        require(strategies[_strategy], "StarryTreasury::removeStrategy: strategy not found");
    ...
    function allocateFee(address _token, uint256 _amount) external onlyOwner {
        require(address(staking) != address(0), "StarryTreasury::allocateFee:Fee distributor not set");
        require(_amount > 0, "StarryTreasury::allocateFee: invalid amount");
