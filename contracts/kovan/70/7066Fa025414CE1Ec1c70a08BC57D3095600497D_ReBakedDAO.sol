...
/**
	...
	*/
    ...
    function rejectPayment(bytes32 _projectId, bytes32 _packageId,address _collaborator) external onlyOwner {
		...
		require(!collaboratorData[_projectId][_packageId][_collaborator].isMGPPaid,"Already MGP Claimed!");
		require(!collaboratorData[_projectId][_packageId][_collaborator].isBonusPaid,"Already Bonus Claimed!");
		uint256 _mgp = collaboratorData[_projectId][_packageId][_collaborator].mgp;
		uint256 _bonus = collaboratorData[_projectId][_packageId][_collaborator].bonusScore;
	...
	*/
	function addCollaborator(
		...
		nonZero(mgp_)
	{
		require(!collaboratorData[projectId_][packageId_][collaborator_].isMGPPaid,"Already Added And MGP Paid");
	...
	{
		require(packageData[projectId_][packageId_].timeFinished != 0,"Package Is Runing");
		require(!observerData[projectId_][packageId_][observer_].isFeePaid,"Observer Fee Already Paid");
	...
	*/
		...
		returns(uint256 amount_)
	{
		require(msg.sender == collaborator_,"Only Collaborator Can Call!");
        require(!isDispute[collaborator_][packageId_]);
		require(collaboratorData[projectId_][packageId_][collaborator_].isBonusPaid, "Bonus already paid");
