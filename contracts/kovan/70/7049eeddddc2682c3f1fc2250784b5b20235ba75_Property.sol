...
//抵押物进来直接兑换，需要用户先approve到this.address
   ...
   function getUserAsset(address userAddr) public view returns(string memory){
        ...
        for (uint i=0; i<users[userAddr].userAsset.length; i++){
            ...
            asset = string(abi.encodePacked(asset,'"address1":"'));
            asset = string(abi.encodePacked(asset,addressToSting(tokenAddr)));
            asset = string(abi.encodePacked(asset,'",'));
            asset = string(abi.encodePacked(asset,'"address2":"'));
            asset = string(abi.encodePacked(asset,addressToSting(tokenAddr)));
            asset = string(abi.encodePacked(asset,'",'));
            asset = string(abi.encodePacked(asset,'"address3":"'));
            asset = string(abi.encodePacked(asset,addressToSting(tokenAddr)));
            asset = string(abi.encodePacked(asset,'",'));
            asset = string(abi.encodePacked(asset,'"address4":"'));
            asset = string(abi.encodePacked(asset,addressToSting(tokenAddr)));
            asset = string(abi.encodePacked(asset,'",'));
            ...
            if (i==users[userAddr].userAsset.length){
                asset = string(abi.encodePacked(asset,'},'));
            }else{
                asset = string(abi.encodePacked(asset,'}'));
            }
    ...
    //用户合同列表
    function getContract(address userAdd) public view returns(string memory){
        string memory contractList;
