...
contract APIConsumer is ChainlinkClient {
    ...
    event DataFullfilled(bytes32 resource);
    ...
    function requestData() public returns (bytes32 requestId) 
    {
        ...
        request.add("get", "https://cricket.sportmonks.com/api/v2.0/scores/1?api_token=hePsXaPV36P3rFkQlTxqCJs9wictwYhVoMd0aJDg1ByplYIssJCdhwcKyoqV&include=");
        // request.add("path", "data");
        request.add("path", "data.resource");
        // Sends the request
    ...
    // }
    function fulfill(bytes32 _requestId, bytes32 _resource) public recordChainlinkFulfillment(_requestId)
    {
        // data = bytes32ToString(_data);
        resource = _resource;
        emit DataFullfilled(resource);
    }
