...
contract korpica is ERC20, Ownable {
    ...
    constructor() ERC20("korpica", "krp") {
        ...
        marketingWallet = address(0x3721C7c0588c1B4B02f293561afeE85b5Ed243Ba); // set as marketing wallet
        devWallet = address(0xa648d5cC51D95aF0d7A892AAD3050b2c64E8a8C4); // set as dev wallet
