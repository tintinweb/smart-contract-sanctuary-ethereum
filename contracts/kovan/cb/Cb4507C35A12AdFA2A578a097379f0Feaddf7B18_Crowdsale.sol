...
contract Crowdsale is AccessControl, ReentrancyGuard {
     ...
     * @param buyed buyed amount of 0gas with decimals
    ...
    /**
     * @notice allow users claim buyed 0gas tokens if softcap was earned
     */
     ...
     */
    function getStage() public view returns (int256) {
        uint256 _sellEnd = sellEnd;
