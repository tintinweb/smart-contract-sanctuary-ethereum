...
// File @openzeppelin/contracts-upgradeable/access/AccessControlEnumera[email protected]
...
contract Distributioner is AbstractDistributioner, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function initialize(address _rewardToken, address _comptroller, address _manager) initializer public {
