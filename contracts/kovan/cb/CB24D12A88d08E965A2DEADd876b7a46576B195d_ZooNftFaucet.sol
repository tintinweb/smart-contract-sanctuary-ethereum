...
contract ZooNftFaucet is ERC721Burnable, Ownable {
	...
	/// @param imageUri - image uri, or literally anything.
	function mintNft(string memory imageUri) external onlyOwner returns (uint256 newId)
	{
	...
	function batchMint(address recipient) external onlyOwner
	{
