...
contract TokenFarm is Ownable{
    ...
    function issueTokens() public onlyOwner{
        // loop through users that have staked
        for (
            ...
            // send each user a token reward base on Total Value Locked
    ...
    function getUserSingleTokenValue(address _user, address _token) public view returns(uint256){
        ...
        return (
            stakingBalance[_token][_user] * price / (10**decimal)
        );
    }
    ...
    function unStakeTokens(address _token) public{
        ...
        require(balance > 0, "Insuficcent staking balance!");
        IERC20(_token).transfer(msg.sender, balance);
        stakingBalance[_token][msg.sender] = 0;
        // Is this vulnerable to reentrancy attacks?
        uniqueTokensStaked[msg.sender] = uniqueTokensStaked[msg.sender] -1;
        // should then remove user from stakers array - skipped - add later
    }
