...
contract Gemies is ERC20, Ownable {
    ...
    function spendEcosystemBalance(uint256 amount, address user) external onlyOperator {
        ...
        ecoSystemBalance[communityWallet] += spent * communityWalletAllocation / 1000;
    }
    ...
    function hasDebt(address user)
        ...
        returns (bool) {
            ...
            uint256 positiveBalance = stakingProvider.getAccumulatedGemies(user) + deposit;
    ...
    function setFlags(bool _withdrawals, bool _deposits, bool _spending, bool _transfers, bool killSwitch)
        external
        onlyOwner {
            if (killSwitch) {
