...
contract StakingRewards is ReentrancyGuard, Pausable {
  ...
  /// @notice A week
  uint128 private constant ONE_WEEK = 7 days;
  ...
  uint256 public constant operationFeeMax = 3000;

  /// @notice earmark incentive fee max 
  uint256 public constant earmarkIncentiveMax = 300;
  ...
  constructor(
    ...
    COOLDOWN_SECONDS = ONE_WEEK;
    UNSTAKE_WINDOW = TWO_WEEKS;
    ...
    assetData.emissionPerSecond = 0.01929*10e8; // initial value
  ...
  // claim WNCG Rewards
  function claimWNCGRewards(uint256 _amount) public nonReentrant {
  ...
  // claim BAL Rewards
  function claimBALRewards() public nonReentrant {
