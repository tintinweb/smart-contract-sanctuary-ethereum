...
contract Stablecoin is ERC20, ReentrancyGuard {
    ...
    function transferVault(uint256 vaultID, address to) external onlyVaultOwner(vaultID) notBlackList(vaultOwner[vaultID]) {
    ...
    function depositCollateral(uint256 vaultID) external payable onlyVaultOwner(vaultID) notBlackList(vaultOwner[vaultID]) {
    ...
    function withdrawCollateral(uint256 vaultID, uint256 amount) external onlyVaultOwner(vaultID) notBlackList(vaultOwner[vaultID]) nonReentrant {
    ...
    function borrowToken(uint256 vaultID, uint256 amount) external onlyVaultOwner(vaultID) notBlackList(vaultOwner[vaultID]) {
    ...
    function payBackToken(uint256 vaultID, uint256 amount) external onlyVaultOwner(vaultID) notBlackList(vaultOwner[vaultID]) {
