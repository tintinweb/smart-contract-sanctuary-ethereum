...
contract EtherBaseballBets is ChainlinkClient {
    ...
    */
    ...
    function getGameResolveSD(uint256 _idx) public view returns (GameResolveSD memory) {
    ...
    function getGameResolvedRD(uint256 _idx) public view returns (GameResolveRD memory) {
