...
contract TestTokenPrice is ChainlinkClient, ConfirmedOwner {
    ...
    event RequestPrice(bytes32 indexed _requestId, uint256 price);
    ...
    function requestPrice() public returns (bytes32 requestId) {
        ...
        // request.add("path", "RAW.ETH.USD.VOLUME24HOUR"); // Chainlink nodes prior to 1.0.0 support this format
        req.add("path", "RAW,ETH,USD,PRICE"); // Chainlink nodes 1.0.0 and later support this format
    ...
    function fulfillVolume(bytes32 _requestId, uint256 _volume)
        public
