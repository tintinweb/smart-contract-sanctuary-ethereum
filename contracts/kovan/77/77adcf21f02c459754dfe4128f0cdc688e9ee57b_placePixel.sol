...
contract placePixel is ERC721URIStorage {
    ...
    function executeRuling(bytes32 questionID, bytes32 packedCoordinates, address requester, uint256 timestamp) external{
        ...
        uint64 y = uint64(uint256(packedCoordinates >> 128));
        uint64 x = uint64(uint256(packedCoordinates >> 192));
        string memory question= string(abi.encodePacked(Strings.toHexString(uint160(requester)),"\xE2\x90\x9F",Strings.toString(timestamp),"\xE2\x90\x9F",Strings.toString(x),"\xE2\x90\x9F",Strings.toString(y),"\xE2\x90\x9F",Strings.toString(xx),"\xE2\x90\x9F",Strings.toString(yy)));
    ...
    function burn(bytes32 questionID, bytes32 packedCoordinates, uint256 timestamp) external{
        ...
        uint64 y = uint64(uint256(packedCoordinates >> 128));
        uint64 x = uint64(uint256(packedCoordinates >> 192));
        string memory question= string(abi.encodePacked(Strings.toHexString(uint160(msg.sender)),"\xE2\x90\x9F",Strings.toString(timestamp),"\xE2\x90\x9F",Strings.toString(x),"\xE2\x90\x9F",Strings.toString(y),"\xE2\x90\x9F",Strings.toString(xx),"\xE2\x90\x9F",Strings.toString(yy)));
