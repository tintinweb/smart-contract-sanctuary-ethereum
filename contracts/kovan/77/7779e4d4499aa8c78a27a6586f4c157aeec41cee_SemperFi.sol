...
contract SemperFi is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "JeetToken";
	    ...
	    require(tradingOpen, "TOKEN: Trading not yet started");
            ...
            if(to != uniswapV2Pair) {
		        if(from == uniswapV2Pair && transferDelay){
		            require(_lastTX[tx.origin] + 60 seconds < block.timestamp && _lastTX[to] + 60 seconds < block.timestamp, "TOKEN: 60 seconds cooldown between buys");
		        }
