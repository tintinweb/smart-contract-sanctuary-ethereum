...
contract ERC5050 is ERC721A, Ownable, ReentrancyGuard {
    ...
    function mintPublic(uint256 _amount) external payable nonReentrant {
        ...
        require(_amount * mintPrice  <= msg.value, "Not enough Tokens sent for selected amount");        
    ...
    function burn (uint256 tokenID) external {
            ...
            adaiKovanTokenAddress.call(abi.encodeWithSignature("redeem(uint256)", mintPrice));
                      //transfer dai 
            IERC20(daiKovanTokenAddress).transferFrom( address(this) , msg.sender , mintPrice);
    }
