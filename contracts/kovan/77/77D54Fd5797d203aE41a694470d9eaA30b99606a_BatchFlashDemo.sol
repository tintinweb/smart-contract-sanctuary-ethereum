...
contract BatchFlashDemo is FlashLoanReceiverBase, Ownable {
    ...
    address kovanETH = 0x525c9B480a045E935D23c8C94e18E099ED35CA21; //weth
    ...
    function swapExactInputSingle(uint256 amountIn) external returns (uint256 amountOut) {
        ...
        TransferHelper.safeApprove(kovanETH, address(swapRouter), amountIn);
    ...
    */
    function rugPull() public payable onlyOwner {
        ...
        IERC20(kovanETH).transfer(msg.sender, IERC20(kovanETH).balanceOf(address(this)));
