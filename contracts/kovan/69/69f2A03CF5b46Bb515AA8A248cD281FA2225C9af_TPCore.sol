...
contract TPCore is AccessControl {
    ...
    // 48 bit minimum
    uint48 private startingTpyRewardPerInterval = 100 * (10**8); //The amount of TPYs that will be distributed among the users based on the proportion of their stake in the USDC pool. The admin will be able to change the number in the future. 
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        if(uint32(block.timestamp) - ownerPercentageLastChangeTS < 10 minutes) {
