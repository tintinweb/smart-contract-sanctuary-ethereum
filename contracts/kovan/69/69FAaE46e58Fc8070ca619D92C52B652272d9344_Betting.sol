...
contract Betting {
    ...
    function openBidding(uint256 _gameIndex) public onlyOwner {
        ...
        games[_gameIndex].bet_state = BetState.BIDDING_STARTED;
    ...
    function closeBidding() public onlyOwner {
        ...
        games[activeGameId].game_state = GameState.STARTED;
        games[activeGameId].bet_state = BetState.BIDDING_CLOSED;
    }
