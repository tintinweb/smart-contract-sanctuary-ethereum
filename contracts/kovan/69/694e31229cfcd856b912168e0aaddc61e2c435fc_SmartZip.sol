 ...
 */
contract SmartZip is ChainlinkClient {
    ...
    event DataFullfilled(uint256 data);
     ...
     * @param _data - response; requested 24h trading volume of ETH in USD
     */
