...
// Fix: For safety and compatibility reasons, it is always best to specify the exact version of the solidity compiler.
...
// Fix: a license should be provided.
...
// Fix1: a license should be provided.

pragma solidity =0.8.13;

// Fix2: For safety and compatibility reasons, it is always best to specify the exact version of the solidity compiler.
//import "@openzeppelin/contracts/math/SafeMath.sol";
// Fix3: import path corrected
//import "@openzeppelin/contracts/math/Math.sol";
// Fix4: import path corrected
contract StakingRewards is
    IStakingRewards,
    RewardsDistributionRecipient,
    ReentrancyGuard
{
    using SafeMath for uint256; // Not required since solidity > 0.8
    ...
    constructor(
        ...
        // Fix5: no need for visibility in constructor anymore
    ...
    // Fix5: Added missing implementation (Not sure what this function should return though!)
    function getRewardForDuration(address account)
        public
        view
        returns (uint256)
...
contract StakingRewardsFactory is Ownable {
    ...
    // Fix7: no need for visibility in constructor anymore
