...
contract MultiFeeDistribution is IMultiFeeDistribution, Ownable {
    ...
    IMintableToken public override immutable stakingToken;
    ...
    function rewardPerToken(address _rewardsToken) external override view returns (uint256) {
    ...
    function lockedBalances(
        address user
    ) view override external returns (
        uint256 total,
        uint256 unlockable,
        uint256 locked,
