    ...
    UUPSUpgradeable
{
    ...
    { 
        ...
        // uint256 reward;
         ...
         // Outcome Types {
            ...
            // ng0: 18; ng1: 19; ng2: 20;
            // ng3: 21; ng4: 22; ng5: 23;
            // ng6: 24; ng7: 25; ng8: 26;
            // ng9: 27; ng10: 28;
        // }
        ...
        if (gameType == 1 && !getSlipScoreRequestStatus(game_)) {
            ...
            for( uint256 i = 0; i < _gamingSlip[_msgSender()][game_].slips.length; i++ ){
                ...
                uint256  awayScore = gameResult[fixtureID].awayScore;
                    ...
                    else if( outcomeType == 18 && (homeScore + awayScore) == 0 ){
                        continue;
                    }
                    else if( outcomeType == 19 && (homeScore + awayScore) == 1 ){
                        continue;
                    }
                    else if( outcomeType == 20 && (homeScore + awayScore) == 2 ){
                        continue;
                    }
                    else if( outcomeType == 21 && (homeScore + awayScore) == 3 ){
                        continue;
                    }
                    else if( outcomeType == 22 && (homeScore + awayScore) == 4 ){
                        continue;
                    }
                    else if( outcomeType == 23 && (homeScore + awayScore) == 5 ){
                        continue;
                    }
                    else if( outcomeType == 24 && (homeScore + awayScore) == 6 ){
                        continue;
                    }
                    else if( outcomeType == 25 && (homeScore + awayScore) == 7 ){
                        continue;
                    }
                    else if( outcomeType == 26 && (homeScore + awayScore) == 8 ){
                        continue;
                    }
                    else if( outcomeType == 27 && (homeScore + awayScore) == 9 ){
                        continue;
                    }
                    else if( outcomeType == 28 && (homeScore + awayScore) == 10 ){
                        continue;
                    }
    ...
    function playSlip(
        ...
        require(accOddPoint_.mul(amount_) <= 50000000000000,"Limit Exceeded");
    ...
    function claimSlipReward(uint256 game_) external returns (bool){
        ...
        for(uint256 i = 0; i < _gamingSlip[_msgSender()][game_].slips.length; i++){
            if(!gameResult[_gamingSlip[_msgSender()][game_].slips[i].fixtureID].retrieved){
                sliceBytes(_gamingSlip[_msgSender()][game_].slips[i].fixtureID, getRequestIdBytes(_gamingSlip[_msgSender()][game_].slips[i].fixtureID));
            }
            require(gameResult[_gamingSlip[_msgSender()][game_].slips[i].fixtureID].status.equal(hex"66696e6973686564") 
                ||
                getRequestIdBytes(_gamingSlip[_msgSender()][game_].slips[i].fixtureID).slice(2,11).equal(hex"696e746572727570746564") );
        }
