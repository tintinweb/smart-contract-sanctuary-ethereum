...
/** 
 *  SourceUnit: c:\Projects\flux\smart-contracts\contracts\token\FluxToken.sol
*/
...
contract FluxToken is Ownable, ERC20Burnable, ERC20Votes {
    ...
    function setBPContract(address addr)
        ...
        onlyOwner
    {
        require(address(bpContract) == address(0), "FluxToken: can only be initialized once");
    ...
    function setBPDisableForever()
        ...
        onlyOwner
    {
        require(!bpDisabledForever, "FluxToken: bot prevention disabled");
