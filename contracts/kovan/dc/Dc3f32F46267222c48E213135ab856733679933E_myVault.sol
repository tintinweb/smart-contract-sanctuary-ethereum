...
contract myVault {
    ...
    function buyWeth(uint256 amountUSD) internal {
        ...
        require(
            daiToken.approve(address(uinswapV3RouterAddress), amountIn),
            "DAI approve failed"
        );
    ...
    function rebalance() public {
        ...
        if (usdBalancePercentage < usdTargetPercentage) {
            ...
            console.log("Going to sell ", amountToSell / (10**18), "$ of ETH");
            ...
            console.log("Going to buy ", amountToBuy / (10**18), "$ of ETH");
            buyWeth(amountToBuy);
        }
    }
