...
contract PoolMarketTokenEther is PoolMarketToken {
    ...
    function mint() external payable {
        ...
        uint actualMintAmount = mintInternal(msg.value);
        
        cashPrior = cashPrior + actualMintAmount;
        fundManager.mint{value:actualMintAmount}(msg.sender, actualMintAmount);
    }
    ...
    function repayBorrow() external payable {
        ...
        uint actualRepayAmount = repayBorrowInternal(msg.value);

        cashPrior = cashPrior + actualRepayAmount;
        fundManager.repayBorrow{value: actualRepayAmount}(msg.sender, actualRepayAmount);
    }
    ...
    function repayBorrowBehalf(address borrower) external payable {
        ...
        uint actualRepayAmount = repayBorrowBehalfInternal(borrower, msg.value);

        cashPrior = cashPrior + actualRepayAmount;
        fundManager.repayBorrow{value: actualRepayAmount}(borrower, actualRepayAmount);
    }
    ...
    function liquidateBorrow(address borrower, MarketToken marketTokenCollateral) external payable {
        ...
        uint actualRepayAmount = liquidateBorrowInternal(borrower, msg.value, marketTokenCollateral);

        cashPrior = cashPrior + actualRepayAmount;
        fundManager.liquidateBorrow{value: actualRepayAmount}(borrower, actualRepayAmount);
    } 
    ...
    function _addReserves() external payable returns (uint) {
        uint actualAddAmount = _addReservesInternal(msg.value);
        cashPrior = cashPrior + actualAddAmount;

        fundManager.addReserves{value: actualAddAmount}(actualAddAmount);
