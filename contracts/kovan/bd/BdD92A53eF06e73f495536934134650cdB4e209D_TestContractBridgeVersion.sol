    ...
    ReforgeBridgeUpgradeable
{
     ...
     */
    function setMinimalFee(uint256 fee) external onlyRole(ADMIN_eEUR) {
        _minimalBridgeFee = fee;
    }
    ...
    AccessControlUpgradeable
{
     ...
     */
    uint256 internal _minimalBridgeFee;
    ...
    function _sendToChain(uint256 amount, uint256 destinationChainId) internal {
        require(msg.value >= _minimalBridgeFee, "Fee too small");
