...
contract ERC20Voting is MajorityVoting{
    ...
    event StartVoteToCreateVault(uint voteId, string vaultName, address assetAddress, uint quality, uint price);
    ...
    function newVoteToCreateVault(
        ...
        uint voteId = this.newVote(_actions, _startDate, _endDate, _choice);
        emit StartVoteToCreateVault(voteId, vaultName, assetAddress, quality, price);
    }
