...
contract TestUSDCStrategy is USDCStrategy {
    ...
    function vaultAddress() public view override returns(address) {
        ...
        return 0x523B6dF58160C5A2DeC87e51C122A800055ae42f;//0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512//<test;//0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0;//_vault;//0xd16B472C1b3AB8bc40C1321D7b33dB857e823f01;
    }

    function vaultTokenAddress() public view override returns(address) {

        return  0xe86d072CD77ac02dEdb85d37757cDE285Cdf4c92;//0x5FbDB2315678afecb367f032d93F642f64180aa3;//<test//_stakeToken;//0xd9145CCE52D386f254917e481eB44e9943F39138;
    }
}
...
contract YearnStrategy is IStrategy {
    ...
    function estimateReward(address addr_) public view override returns (uint256) {
