...
interface ITokenSaleV3 {
    ...
    function claimAmountNaboo(address beneficiary)
        external
        view
        returns (uint256);
...
contract SaleClaim is ReentrancyGuard {
    ...
    // Sale contract
    ITokenSaleV3 public saleContract;
        ...
        returns (uint256)
    {
        ...
        uint256 beneficiaryClaimNaboo = saleContract.claimAmountNaboo(beneficiary);
        require(
            beneficiaryClaim.add(beneficiaryClaimNaboo) > 0,
    ...
    function ownerWithdraw() external {
        ...
        uint256 nabooBalance = naboo.balanceOf(address(this));
        naboo.safeTransfer(msg.sender, nabooBalance);
