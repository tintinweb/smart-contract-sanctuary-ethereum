...
contract TokenFarm is Ownable {
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        require(_amount > 0, "Amount must be more then 0"); // how much can they stake?
        require(tokenIsAllowed(_token), "Token is currently not allowed"); // what tokens can they stake?
