...
error TinyExplorerAlreadyClaimed();
...
// @author emrecolako
// todo: 
// - check multiclaim with tiny kingdoms (done)
// - add modifier for claim with tiny kingdoms and restrict minting tiny explorers 
// - add index for when claiming is over (and minting is started)
// - add paused modifier and function to pause minting (if a problem arises)
// - add off-chain renderer: https://etherscan.deth.net/address/0x9C443ea8d027e6CDbD37719F8Aa5c5c94411Faec#code

contract TinyExplorers is ERC721Enumerable, ReentrancyGuard, Ownable{


    uint256 private constant TOTAL_SUPPLY = 300;
    uint256 private constant MINT_PRICE = 0.05 ether;
    uint256 public claimed = 0;



    bool public restricted = true; // Restrict free claim to Tiny Kingdoms holders 
    ...
    // rinkeby:
    // address private tinyKingdomsMetadataAddress = 0x4E543110b52BFa58350C10D2D438A4a140099eDe;
    
    // mainnet:
    address private tinyKingdomsAddress = 0x788defd1AE1e2299D54CF9aC3658285Ab1dA0900;
    // rinkeby:
    // address private tinyKingdomsAddress =0x7b9Ad8d480272e7E628d5EB9A07F1f7Ceef327B0;
    ...
    //     require(
    //         totalMinted <= (TOTAL_SUPPLY - numTokens) &&
    //         msg.value >= numTokens * MINT_PRICE
    //     );
    //     _;
    // }
   
    modifier paymentAmountValid(uint256 value){
    ...
    modifier tokenAvailable(uint256 tokenId) {
        if (explorers[tokenId].dna!=0) revert TokenAlreadyClaimed();
        _;
    }
    ...
    constructor() ERC721("Tiny Explorers", "EXPLORE") {} 
    ...
    function generateExplorer(uint256 tokenId) public view returns (uint256,bool _pirate){
        console.log("inside generateexplorer");
    ...
    function claimWithTinyKingdoms(uint256 tinyKingdomsId) public nonReentrant{
        ...
        // if(explorers[tinyKingdomsId].dna!=0) revert TokenAlreadyClaimed();
        ...
        console.log('claimWithTinyKingdoms dna:',explorers[tinyKingdomsId].dna);
    ...
    function mintExplorers(uint256 amount) public payable nonReentrant publicSaleActive{
            ...
            for (uint256 i=0; i <amount; i++) {
                mint(msg.sender,findfirstExplorer());
                // console.log("minting:",findfirstExplorer());
            }
    ...
    function mint(address to, uint256 tokenId) internal {
        ...
        console.log("explorer generated");
        
        _safeMint(msg.sender, tokenId);
        explorers[tokenId] = explorer;

        console.log("dna after explorer creation:",explorers[tokenId].dna);
    ...
    //         return '';
    //     }
    //     return renderer.tokenAttributes(explorers[tokenId]);
    // }


     function findfirstExplorer() public view returns (uint256){
        uint256 firstExplorer;
