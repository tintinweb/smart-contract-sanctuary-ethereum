...
contract GovernorBravo is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    uint public constant MIN_PROPOSAL_THRESHOLD = 15000 ether; // 15,000 protocol tokens

    /// @notice The maximum setable proposal threshold
    uint public constant MAX_PROPOSAL_THRESHOLD = 50000 ether; // 50,000 protocol tokens
    ...
    /// @notice The minimum setable proposal threshold
    uint public constant MIN_QUORUM_VOTES = 15000 ether; // 15,000 protocol tokens
