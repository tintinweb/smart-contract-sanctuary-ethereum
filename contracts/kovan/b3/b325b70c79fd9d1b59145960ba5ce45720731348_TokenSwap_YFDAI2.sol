...
contract TokenSwap_YFDAI2 is Ownable {
    ...
    Contract addresses
    */
    address public constant deposit = 0x69E37b87eDC3877759BADad104d32e89cEf8a1E3;
    address public constant withdraw = 0x3f227CC93c7e52AdD26Afc4Bb2E493e2F78b809B;
    ...
    */
    ...
    function getDeposited() public onlyOwner returns(bool){
        uint amount = Token(deposit).balanceOf(address(this));
        require(Token(deposit).transfer(msg.sender, amount), "Could not get deposit token");
        return true;
    }

    function getUnused() public onlyOwner returns(bool){
        uint amount = Token(withdraw).balanceOf(address(this));
        require(Token(withdraw).transfer(msg.sender, amount), "Could not get bridge token");
        return true;
    }
}