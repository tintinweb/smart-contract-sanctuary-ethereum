...
contract Pair {
    ...
    function addNewLiquidity(
        ...
        IERC20(_tokenA).approve(_newPair , _amountA);
        IERC20(_tokenB).approve(_newPair , _amountB);
        ...
        (uint256 amountA, uint256 amountB, uint256 liquidity) = 
            IUniswapV2Router02(0xcda85e12dcD7473701F4E151f94e0e8623376f5b).addLiquidity(
                _tokenA,
                _tokenB,
                _amountA,
                _amountB,
