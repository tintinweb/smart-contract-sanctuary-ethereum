...
contract NftBattleArena is Ownable, ERC721
{
	...
	function requestRandom() public
	{
		...
		require(randomRequested == false, "random error");                     // Requires to call once per epoch.
	...
	{
		require(getCurrentStage() == Stage.FifthStage, "Wrong stage!");             // Requires to be at 5th stage.
		require(zooFunctions.randomResult() != 0, "random error");                          // Reverts until new random generated.
