...
3.5% Daily | Sustainable Static ROI Yield Farm
Launching 14th of July, 8PM UTC
by Metaminers, trusted and known Team (Ruby Mine, Rothschild Winery)

Genesis Farm (BUSD) official Dapp:
Website: https://busd.genesisfarm.money/
*/
...
contract Stackoin_v2 {
    ...
    IERC20 public token = IERC20(0x1D89E635c136E7429069b6551D995C7f764688FB); //** Main
	uint256 constant public INVEST_MIN_AMOUNT = 1 ether; // 1 CKIO
	uint256[] public REFERRAL_PERCENTS 	= [300, 100, 50, 50, 25, 25, 25, 25, 50, 100];
	uint256[] public SEED_PERCENTS 		= [300, 100, 50, 50, 25, 25, 25, 25, 50, 100];
