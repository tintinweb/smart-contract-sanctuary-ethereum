...
contract Betting {
    ...
    event MatchInfo(uint256 _matchId, string _competition, string _teamA, string _teamB, uint256 _tie, uint256 _team_A_win, uint256 _team_B_win, uint256 _gameDay);
    ...
    function setMatchDetails(
        ...
        emit MatchInfo(matchCount, _competition, _teamA, _teamB, _tie, _team_A_win, _team_B_win, _gameDay);
