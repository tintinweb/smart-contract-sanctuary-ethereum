...
contract Flashloan is FlashLoanReceiverBase {
        ...
        override
    {
        ...
        uint balance = reserve.balanceOf(address(this));

        uint totalDebt = _amount + _fee;
        require(balance >= totalDebt, "Not enough balance to repay loan");
        
        transferFundsBackToPoolInternal(_reserve, totalDebt);
    }

    //1 ether indicates 1e18 worth of _asset i.e 10^18 wei of DAI or 1 DAI
