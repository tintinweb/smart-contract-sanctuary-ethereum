 ...
 * @title TokenVesting
 */
contract TokenVesting is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, KeeperCompatibleInterface{
    ...
    */
    function multisendToken(
        ...
        uint256 total = 0;
        for (uint256 i = 0; i < recipients.length; i++) total = total.add(values[i]);
    ...
    */
    function getLastVestingScheduleForHolder(address holder)
        ...
        view
        returns(VestingSchedule memory){
        return vestingSchedules[computeVestingScheduleIdForAddressAndIndex(holder, holdersVestingCount[holder].sub(1))];
    }
