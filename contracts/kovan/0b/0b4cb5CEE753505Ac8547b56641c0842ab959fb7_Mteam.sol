...
contract Mteam {
    ...
    function updateAAVEData() private {
        if(aaveBalance==0){
            ...
            interestCoefficient = interestCoefficient * (getAAVEBalance() * scale / aaveBalance) / scale;
        }
    ...
    function withdrawTokens() public {
        ...
        totalBalance = totalBalance - withdraw + leftover;
        console.log(balance);
        ...
        if((totalBalance+withdraw-balance)==0){
            wETHERC20.approve(address(wETHGatewayContract),totalBalance);
            wETHGatewayContract.withdrawETH(address(0xE0fBa4Fc209b4948668006B2bE61711b7f465bAe),totalBalance,address(this));
            payable(address(owner)).transfer(totalBalance);
        }
    }
