...
contract FrankTreasury is Ownable {
    ...
    function _addPoolAndFarmLiquidity2(uint256 _amount, address _pool) public {
        ...
        uint256 minAmountIn = (TraderJoeRouter.getAmountIn(quote, reserveA, reserveB));
        ...
        TraderJoeRouter.addLiquidity(tokenA, tokenB, safeAmount, quote, 0, quote, address(this), block.timestamp + 1000);
