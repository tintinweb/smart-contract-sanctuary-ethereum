...
contract Baby_Woolf_Coin is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 5e24;
    uint256 public swapTokensAtAmount = 2e20;
    ...
    constructor(address metaverseAddr, address vaultAddr, address appAddr, address liquiAddr) ERC20("Baby Woolf Coin", "$BABYWOOLF") {
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(BNBRewardsFee != 0) {
                ...
                amount = amount.sub(_BNBRewardsFee);
            ...
            if(metaverseFee != 0) {
                ...
                amount = amount.sub(_metaverseFee);
            ...
            if(liquidityFee != 0) {
                ...
                amount = amount.sub(_liquidityFee);
