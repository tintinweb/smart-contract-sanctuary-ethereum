...
contract NBTStaking is UUPSUpgradeable, AccessControlUpgradeable , ReentrancyGuardUpgradeable {
    ...
    @param maxStakingTime_ the max locked staking period in weeks
    */

  
    function initialize(address tokenAddress_, address rewardToken_, address owner_, uint minClaimPeriod_, uint rewardRate_, uint maxStakingWeeks_, uint maxStakingTime_ ) initializer external {
