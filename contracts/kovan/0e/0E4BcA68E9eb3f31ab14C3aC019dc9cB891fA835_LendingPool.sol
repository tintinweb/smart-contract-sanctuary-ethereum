...
contract LendingPool {
    ...
    CEth C_ETH = CEth(0x41B5844f4680a8C38fBb695b7F9CFd1F64474a72);

    CErc20 C_DAI = CErc20(0xF0d0EB522cfa50B716B3b1604C4F0fA6f04376AD);
    ...
    function depositCompound() public payable returns (bool) {
        ...
        (bool success, ) = address(0x41B5844f4680a8C38fBb695b7F9CFd1F64474a72)
            .delegatecall(abi.encodeWithSignature("mint(unit256)", msg.value));
