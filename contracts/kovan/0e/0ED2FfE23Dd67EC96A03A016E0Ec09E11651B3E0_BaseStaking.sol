    ...
    ReentrancyGuardUpgradeable
{
    ...
    function stake(uint256 _amount) external nonReentrant {
        ...
        uint256 stakeIndex = _createStake(msg.sender, _amount);
     ...
     */
    function getStakesLength(address _stakerAddress)
        external
        view
        returns (uint256)
    {
     ...
     */
    function emergencyWithdrawToken(IERC20MetadataUpgradeable _tokenAddress)
        external
        onlyOwner
    {
     ...
     * @param _amount amount to stake
     */
    function _createStake(address _staker, uint256 _amount)
        private
        returns (uint256 stakeIndex)
    {
        stakeIndex = stakers[_staker].length;
