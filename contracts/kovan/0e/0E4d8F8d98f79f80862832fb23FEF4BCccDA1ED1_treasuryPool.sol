...
contract treasuryPool is Ownable, whitelistChecker, ChainlinkClient {
    ...
    mapping (address => mapping (uint => bool)) public whichCurreny;
    IERC20 busd;
    ...
    mapping (bytes32 => uint) public storeProjectId;
    ...
    {
//        string memory id = string (abi.encodePacked(projectId));
        string memory finalUrl = string(abi.encodePacked(url,dataUrl,"&projectid=",id));
        ++stringdatacounter;
        stringData[stringdatacounter] = finalUrl;
        ...
        storeProjectId[bytes32(byteData)] = projectId;
        return byteData;
    }
...
//        emit data(_volume);
    ...
    function refund(uint randomNumber) public {
        volume = randomNumber+1;
    }
