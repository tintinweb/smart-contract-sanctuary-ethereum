...
contract NFT is ERC721URIStorage {
    ...
    constructor (string memory _name, string memory _symbol, address _marketplace) ERC721(_name, _symbol) {
        require(_marketplace != address(0), "address must exist");
        marketplaceAddress = _marketplace;
    }
    /**
     * @dev Mint a new NFT
     * @param _tokenURI - token URI
     * @param _startingPrice - starting price nft
     * @return tokenId - nft asset id
     */
    function mint(
    ...
    function totalCount() public returns (uint) {
        return count;
    }
