...
contract UniswapFlash is 
    ...
    function uniswapV3FlashCallback(
        ...
        // {   
        //     address tradeAsset0 = tradeAssets[0];
        //     address tradeAsset1 = tradeAssets[1];
        //     uint16 tradeDex0 = tradeDexs[0];
        //     uint16 tradeDex1 = tradeDexs[1];
        //     // swap assets on dexes
        //     uniswapV2Router = IUniswapV2Router02(swapRouterInfos[tradeDex0].router);

        //     TransferHelper.safeApprove(loanAsset, address(uniswapV2Router), loanAmount);
        //     uint256 amountOut0 = uniswapV2Router.swapExactTokensForTokens(
        //         loanAmount,
        //         0,
        //         Helpers.getPaths(loanAsset, tradeAsset0),
        //         address(this),
        //         block.timestamp + 300
        //     )[1];

        //     uint256 balance0 = IERC20(tradeAsset0).balanceOf(address(this));
        //     require(amountOut0 == balance0, "differ amountOut0");

        //     uniswapV2Router = IUniswapV2Router02(swapRouterInfos[tradeDex1].router);
        //     TransferHelper.safeApprove(tradeAsset0, address(uniswapV2Router), balance0);
        //     uint256 amountOut1 = uniswapV2Router.swapExactTokensForTokens(
        //         amountOut0,
        //         0,
        //         Helpers.getPaths(tradeAsset0, tradeAsset1),
        //         address(this),
        //         block.timestamp + 300
        //     )[1];
        //     uint256 balance1 = IERC20(tradeAsset1).balanceOf(address(this));
        //     require(amountOut1 == balance1, "same amountOut1");
        //     emit AssetSwaped(loanAsset, amountOut1);
        // }
        ...
        if (profit > 0) {
            ...
            TransferHelper.safeApprove(loanAsset, payer, profit);
            pay(loanAsset, address(this), payer, profit);
            emit TransferedProfitToWallet(payer, loanAsset, profit);
        }
    }
