...
// File @openzeppelin/contracts/utils/String[email protected]
...
// File contracts/MetaTransfer.sol

contract MetaTransfer is ERC2771Context {
    IERC1155 private collection;

    constructor(address collectionAddress, address forwarder)
    ...
    function safeTransferTo(
        ...
        try collection.safeTransferFrom(_msgSender(), to, id, amount, data) {
            return;
