...
contract RipGabe is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xa5e60Dacd7ecF126058729844163d3597c85af52); // Marketing Address
        
    address payable public developerAddress =
        payable(0xD0C4e70aA795723f7De05D29E41a775a400Ba61d); // developer Address
        
    address payable public liquidityAddress =
        payable(0x4e6AE2b9C8d1586effCA4e760BB201301CcB7fE6); // Liquidity Address
    ...
    string private constant _name = "RipGabe";
