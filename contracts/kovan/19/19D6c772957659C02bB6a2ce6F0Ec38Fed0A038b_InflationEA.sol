...
contract InflationEA is ChainlinkClient, ConfirmedOwner {
    ...
    function requestInflationData() public onlyOwner returns(bytes32 requestId) {
        ...
        request.add("post", "https://evening-forest-80004.herokuapp.com");
        request.add( "requestData", '{"id": 0, "data": { "start_date": "2005-01-01"}}' );

        request.add("path", "data,result");
        request.addInt("multiply", 1000);

        return sendChainlinkRequest(request, fee);
    }

    function fulfill(bytes32 _requestId, uint256 _accumulatedInflation) public recordChainlinkFulfillment(_requestId) {
