...
contract AnchorCertificates is ERC721 {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory name = string(abi.encodePacked(certificateType, ' KIRIBEX Certificate #',toString(certificates[tokenId].nr)));

        string memory description = "KIRIBEX Certificate";
    ...
    function generateImage(uint256 tokenId) public view returns (string memory) {
        ...
        return string(
            ...
            abi.encodePacked(
                ...
                '<text x="215" y="80" class="small">KIRIBEX</text>',

                '<text x="15" y="80" class="medium">EDITION> ',class,'1</text>',

                '<text x="15" y="100" class="medium">ID> ',toString(certificates[tokenId].nr),'</text>',

                '<text x="15" y="120" class="medium">LOCATION:</text>',

                '<rect x="15" y="125" width="205" height="40" style="fill:white;opacity:0.5"/>',

                '<text x="15" y="140" class="medium">TO ',reasons[rIndex],'</text>',

                '<text x="15" y="190" class="small">AUDITED BY:</text>',

                '<text x="15" y="205" style="font-size:8px">',toHexString(uint160(certificates[tokenId].sponsored), 20),'</text>',

                '<text x="15" y="230" class="tiny">Under Section 1.C of the ESG doctrine.</text>',

                '<text x="15" y="240" class="tiny">Carbon Credits issued to the Bearer Is Entitled To The Monies.</text>',

                '<text x="15" y="250" class="tiny">If Sponsored, Under Section 6.F share the Monies</text>',

                '<text x="15" y="260" class="tiny">All claim verifiable on the blockchain..</text>',
    ...
    function generatePaletteSection(uint256 tokenId, uint256 pIndex) internal view returns (string memory) {
        ...
        return string(abi.encodePacked(
                ...
                '<text x="15" y="25" class="medium">KIRIBEX CERTIFICATE</text>',
