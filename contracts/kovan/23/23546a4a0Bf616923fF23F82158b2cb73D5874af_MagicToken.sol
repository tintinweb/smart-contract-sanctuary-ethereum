...
contract MagicToken is ERC20, Ownable {
    ...
    uint256 public _tokensForMarketing; // TODO: Change back to private
    uint256 public _tokensForLiquidity; // TODO: Change back to private
    uint256 public _tokensFromBuy; // TODO: Change back to private
    uint256 public _tokensFromSell; // TODO: Change back to private
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[from]) {
                ...
                // Get the currently collected sell and buy fees
                buyReward = _tokensFromSell + _tokensFromBuy;
            ...
            if (fees > 0) {
                (address _from, address _to, uint256 correctedFee) = fees > buyReward ? (from, address(this), fees - buyReward) : (address(this), to, buyReward - fees);
                super._transfer(_from, _to, correctedFee);
            }
            
            amount = amount - fees + buyReward;
        }
