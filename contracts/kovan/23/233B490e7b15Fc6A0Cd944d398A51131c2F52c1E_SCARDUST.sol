...
contract SCARDUST is Context,IERC20, Ownable{
    ...
    address payable public marketingAddress = payable(0x9Fb238a42FDda1Ca6559bAA953109e2d5B46262C);
    ...
    address payable public charityAddress = payable(0x2962a301DA97fDE15961c75bE3e858Df49114512);
