...
contract HaloDAOStratXSGDUSDCIndexUSDC is Ownable {
    ...
    function zapIn(
        ...
        require(
            ...
            "HaloDAOStrat/unsupported-token"
        );
    ...
    function addLiquidity(
        ...
        uint256 minLpTokens = numeraire
            ...
            .mul(ETH_DECIMALS);
        console.log("[StratContract] zap() minLpTokens", minLpTokens);
    ...
    function depositAndBorrow() internal {
        ...
        console.log("[StratContract] HLP received: ", hlpBalance);
        ...
        console.log(
            "[StratContract] totalCollateralETHBeforeDeposit:",
        ...
        console.log("[StratContract] deposited HLP:", hlpBalance);

        (uint256 totalCollateralETHAfterDeposit, , , , , ) = ILendingPool(
            addresses.lendingPool
        ).getUserAccountData(msg.sender);
        console.log(
            "[StratContract] totalCollateralETHAfterDeposit:",
            totalCollateralETHAfterDeposit
        );
        ...
        console.log("[StratContract] borrowed USDC:", usdcToBorrow);
    }
    ...
    function swap(
        ...
        console.log(
            "[StratContract] Approving USDC spent for SwapRouter...",
            amount
        );
        ...
        console.log("[StratContract] OracleLibrary.consult...");
        (int24 tick, ) = OracleLibrary.consult(addresses.uniswapPool, 1);
        console.log("[StratContract] OracleLibrary.getQuoteAtTick...");
        ...
        console.log("[StratContract] minAmountOut: ", minAmountOut);
        ...
        console.log(
            "[StratContract] Swapping USDC for indexUSDC...",
            amount,
            minAmountOut
        );
        ...
        console.log("[StratContract] Swapped for indexUSDC", amountReceived);
