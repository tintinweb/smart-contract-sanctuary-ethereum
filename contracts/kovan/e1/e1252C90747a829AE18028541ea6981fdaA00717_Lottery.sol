...
contract Lottery is VRFConsumerBase {
    ...
    function enter() public payable {
        //50$ minimum
        require(lottery_state == LOTTERY_STATE.OPEN, "Not happening rn bro");
    ...
    function getEntranceFee() public view returns (uint256) {
        (, int256 answer, , , ) = ethUsdPriceFeed.latestRoundData(); // 8 decimals
    ...
    function startLottery() public onlyOwner {
        require(
            lottery_state == LOTTERY_STATE.CLOSED,
            "Cannot open what is already open"
        );
    ...
    function endLottery() public onlyOwner {
        ...
        bytes32 requestId = requestRandomness(vrfkeyhash, vrffee); // -> bytes32 requestId
