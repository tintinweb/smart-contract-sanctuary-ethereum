...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x31acdd70B7ec6FFd7c5EdDeb132C4b9f63724234;
...
contract SEED is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x18D693EE3336AAF8Dffd1f579ECEd1Ea0E6855ba;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Seed";
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);//FUJI
        
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //BSCTEST
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForEth(half); // <- this breaks the AVAX -> HATE swap when swap+liquify is triggered
