...
contract SquarezGame is Ownable, SquarezNFT, RandomGameBoard, SportsDataAPIConsumer, AdAuction {
    ...
    function getGameBoardRandomness() public override(RandomGameBoard) returns (bytes32) {
    ...
    function startClaim() external override(SquarezNFT) onlyOwner {
...
contract SquarezNFT is ERC721, ERC721Enumerable  {
    ...
    function startClaim() external virtual{
        require(claimState == ClaimState.Off, "Sale already started and/or completed");
        claimState = ClaimState.Active;
    }
