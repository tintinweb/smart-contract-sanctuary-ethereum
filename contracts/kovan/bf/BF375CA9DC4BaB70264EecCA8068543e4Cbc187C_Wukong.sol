...
contract Wukong is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    function MintWukong(uint256 _times) payable public mintEnabled {
        ...
        require(totalWukong + _times <= totalCount, "too much");
    ...
    function OGMint( uint _times, bytes32[] calldata merkleProof ) payable public 
    ...
    function adminMintGiveaways(address _addr) public onlyOwner {
        require(totalWukong + 1 <= totalCount, "Mint amount will exceed total collection amount.");
