...
contract SANDOAirdrop is Ownable {
    ...
    event airdrop_log(string _remark, address _msgSender, uint _amount,bool _status);
    event OwnerWithdraw(string phase,uint256 amount);
    error airdrop_empty(string _remark,address _msgSender, bool _status);
   ...
   bool internal locked;
    ...
    function getAirdrop() public {
        ...
        emit airdrop_log("You have airdrop.",msg.sender,(AirdropPerUser/10**18), hasClaimed[msg.sender]);
            ...
            revert airdrop_empty({
                _remark: "This adr has been requested.",
                _msgSender: msg.sender, 
                _status: hasClaimed[msg.sender]
                });
        }
    }
