...
contract TokenFactoryNFT is TokenFactoryNFTStorage, ITokenFactoryNFT {
    ...
    */
    function deployTokenNFT(string memory _name, 
            ...
            bool _waitToTransferOwner) public override onlyOwnerOrSuperFactory returns (address) {
        TokenNFT newToken = new TokenNFT(_name, _symbol, _baseTokenURI, _creatorAddress, 
    ...
    */
    function deployTokenWithWL(string memory _name, 
            ...
            uint256 _biPercent,
            uint256 _creatorPercent,
            uint256 _baseCollectionPrice) external override onlyOwnerOrSuperFactory returns (address, address) {
...
contract TokenNFT is TokenNFTStorage, Ownable, AccessControlEnumerable, ERC721Enumerable, ERC721Pausable, ERC2981, ITokenNFT/*, ContextMixin*/ {
    ...
    constructor(string memory _name, 
            ...
            uint256 _biPercent,
            uint256 _creatorPercent,
            uint256 _baseCollectionPrice) ERC721(_name, _symbol) {
    ...
    */
     ...
     */
    function tokenURI(uint256 tokenId) public view override(ERC721, ITokenNFT) returns (string memory) {
...
*/
    ...
    */
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view override(ERC721, ERC721Enumerable, AccessControlEnumerable, ERC2981) returns (bool) {
        return (
