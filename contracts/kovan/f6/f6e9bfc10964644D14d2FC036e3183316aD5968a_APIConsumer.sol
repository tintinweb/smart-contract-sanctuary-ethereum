...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    event requestReputation(address indexed, string);
    event fullfillReputation(uint256);
    ...
    function requestReputationData(string memory _query)
        public
        returns (bytes32 requestId)
    {
        ...
        emit requestReputation(msg.sender, _query);
        // Sends the request
        ...
        recordChainlinkFulfillment(_requestId)
    {
        ...
        emit fullfillReputation(_reputation_data);
    }
