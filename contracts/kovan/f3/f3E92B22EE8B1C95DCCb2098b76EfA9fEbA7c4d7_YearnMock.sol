...
contract YearnMock is ERC20, VaultAPI, Ownable {
	...
	function deposit(uint256 amount) public onlyOwner override returns (uint256 shares) {
	...
	function withdraw(uint256 shares, address receiver) public onlyOwner override returns (uint256 withdrawn) {
