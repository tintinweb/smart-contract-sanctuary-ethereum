...
contract Step3{
    ...
    function sendWethAndApprove() payable public{
    ...
    function approveWeth()public{
        IWETH(weth).approve(ILendingPoolAddressesProvider(addressProvider).getLendingPool(),100000000000000000);
    }
    ...
    function depositAAVE() public view returns (address){
