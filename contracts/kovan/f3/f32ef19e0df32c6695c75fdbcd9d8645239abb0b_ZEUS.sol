...
contract ZEUS is ERC20, Ownable {
    ...
    constructor() ERC20("KovanTest", "GANG") payable {
    	...
    	marketingWallet = address(0xEB0a6D01096f47Cc6B06021cB3d0Eae9927A6e67); // set as marketing wallet
        ...
        excludeFromFees(0xBfa6fE3999cA2b0197BA13aC0003e0E872AD1E87, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0xBfa6fE3999cA2b0197BA13aC0003e0E872AD1E87, true);
        ...
        */
        ...
        _createInitialSupply(0xBfa6fE3999cA2b0197BA13aC0003e0E872AD1E87, totalSupply*10/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0xBfa6fE3999cA2b0197BA13aC0003e0E872AD1E87,
            block.timestamp
        );
    }
