...
contract RoyaltyNFT is ERC721, Ownable, RoyaltiesV2Impl{
    ...
    address public constant DEV_ADDRESS_1 = 0x36c0D7528F0D56d7B3f3CF066ae0f5abDdbbCb83; // J
    address public constant DEV_ADDRESS_2 = 0x2B099F96eaAd16A76127aEe391A301ec2782e3A9; // P
    ...
    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmWGLJ5E1B78jpo75Ky52wVUbgU4DBppzkcavWbu8j4a9p/";
    ...
    function withdrawAll() external onlyOwner {
        ...
        payable(DEV_ADDRESS_1).transfer(balance * 5000 / 10000);
        payable(DEV_ADDRESS_2).transfer(balance * 5000 / 10000);
    }
    ...
    function batchRoyalties(uint256 _startId, uint256 _endId, uint96 _basisPercentage, address payable _recepient) public onlyOwner {
        for(uint256 i = _startId;i <= _endId; i++){
            setRoyalties(i, _recepient,_basisPercentage);
        }
    }
    ...
    function setRoyalties(uint _tokenId, address payable _royaltiesReceipientAddress, uint96 _percentageBasisPoints) private {
