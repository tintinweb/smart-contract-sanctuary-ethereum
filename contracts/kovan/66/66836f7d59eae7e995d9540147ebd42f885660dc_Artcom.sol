...
contract Artcom is Context, IBEP20, Ownable {
  ...
  constructor()  {
    ...
    priceFeedEth = AggregatorV3Interface(0x9326BFA02ADD2366b30bacB125260Af641031331);//test net
        tokenPerUsd = 3;
  ...
  // to change Price of the token
    ...
    function ethToToken(uint256 _amount) public view returns(uint256){
        ...
        uint256 ethToUsd = precision.mul(_amount).mul(getLatestPriceEth()).div(1e18);
