...
contract Okdudu is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "Okdudu";
    string constant _symbol = "$OKD";
    uint8 constant _decimals = 9;
    uint256 constant _totalSupply = 1 * 10**12 * (10**_decimals);
    uint256 public maxWalletSize = _totalSupply.mul(3).div(100); // 3%
    ...
    constructor(
        ...
        marketFeeReceiver =payable(0x7863d1C6f74Ebb0d4C7c0bdBE40EEB963dE005A0);
        devFeeReceiver = payable(0x7863d1C6f74Ebb0d4C7c0bdBE40EEB963dE005A0);
