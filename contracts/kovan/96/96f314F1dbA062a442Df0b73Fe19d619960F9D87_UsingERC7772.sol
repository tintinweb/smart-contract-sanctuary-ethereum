...
contract UsingERC7772 is IERC777Sender, IERC777Recipient, ERC1820Implementer {
    ...
    // deposit
    // TODO: since its external fn, need do any require statement as security protection?
    function tokensReceived(
        ...
        emit Deposit(_operator, _from, _to, _amount, _userData, _operatorData);
    }
    ...
    // withdraw
    // TODO: since its external fn, need do any require statement as security protection?
    // TODO: put re-entrancy guard at tokensToSend or at send fn?
    function tokensToSend(
        ...
        require(_amount > 0, "zero amount");
        // require(userToHolding[] >= _amount, "insufficient holding"); // TODO: check which is proper address to put
        // userToHolding[_from] -= _amount;
        // this will be run for every registered
        // 'from' token transfers
        emit Withdraw(_operator, _from, _to, _amount, _userData, _operatorData);
    }
}
