...
contract UtilToken is ERC721AUpgradeable, BlackListUpgradeable,  PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IUtilToken{
    ...
    function initialize(
        ...
        _baseURIPrefix = _uri;
        Batch memory tempBatch = Batch(block.timestamp, block.timestamp, 0.01 ether, '', false);
    ...
    function batchCollectLength() public view returns(uint256){
        return batchCollection.length;
    }
