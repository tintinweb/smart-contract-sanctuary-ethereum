...
contract SheebaInu is Context,IERC20, Ownable{
    ...
    uint256 maxWalletAmount =50*10**9; //0.5%
    uint256 maxTxAmount = 25*10**9;// 0.25%
    ...
    uint256 public requiredTokensToSwap = currentThreshold * 10 ** 5 * 10 ** _decimals; //threshold of around 1000000 0.02% tokens 
    ...
    function _transfer(address from, address to, uint256 amount) internal{
        ...
        if(inContractBalance >=requiredTokensToSwap && 
            ...
            if(takeFees){
                require(amount <= maxTxAmount,"CANT TRADE MORE THAN THGE MAX TX");
                ...
                //Buy Fees
                    ...
                    require(balanceOf(to) + amount < maxWalletAmount,"Cant have more tokens than maxWalletAmount");
                    totalFeeFortx = 0;
