...
contract InsuranceContract is ShambaGeoConsumer  {
   ...
   /**
    ...
    function checkGeostats(
        ...
        requestGeostatsData(agg_x, dataset_code, selected_band, image_scale, start_date, end_date, geometry);
    ...
    function getLatestCid() public view returns (string memory) {
        return cids[total_oracle_calls];
    }
    ...
    function getShambaGeostatsData() public returns (int256) {
        ...
        currentGeostats = getGeostatsData();
