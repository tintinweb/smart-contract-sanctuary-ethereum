...
import { FlagsInterface } from "@chainlink/contracts/src/v0.7/interfaces/FlagsInterface.sol";
import { LinkTokenInterface } from "@chainlink/contracts/src/v0.7/interfaces/LinkTokenInterface.sol";
import { Operator, OperatorInterface } from "@chainlink/contracts/src/v0.7/Operator.sol";
// import { OperatorInterface } from "@chainlink/contracts/src/v0.7/interfaces/OperatorInterface.sol";
...
contract DRCoordinatorV2 is Operator {
    uint256 private constant MINIMUM_CONSUMER_GAS_LIMIT = 400_000; // 32 bytes
     ...
     * @param _linkTknFeed TODO.
     * @param _description TODO.
     * @param _fallbackWeiPerUnitLink TODO.
     * @param _stalenessSeconds TODO.
     * @param _isSequencerDependant TODO.
     * @param _sequencerOfflineFlag TODO.
     * @param _chainlinkFlags TODO.
     * @param _fallbackWeiPerUnitLink TODO.
     */
    constructor(
        address _link,
    ...
    function drCoordinatorRequest(
        ...
        if (!success) {
            revert("DRCoordinatorRequestFailed");
        }
    }
    ...
    function fulfillDRCoordinatorRequest(
        ...
        validateRequestId(_requestId)
        validateCallbackAddress(_callbackAddress)
        ...
        returns (bool)
    {
        ...
        require(gasleft() >= MINIMUM_CONSUMER_GAS_LIMIT, "GasLimitIsLtMinConsumerGasLimit");
