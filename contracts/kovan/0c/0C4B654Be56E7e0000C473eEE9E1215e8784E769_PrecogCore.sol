...
contract PrecogCore is IPrecogCore {
    ...
    function _updateAdjustments() internal {
        ...
        for (uint i = 0; i < pairs.length; i++) {
            ...
            IPrecogV5.Cycle memory _currentTradingCycle = IPrecogV5(precog).getCurrentTradingCycle(
                pairs[i].token
            );
            ...
            require(_currentTradingCycle.id != 0 || _futureTradingcycle.id != 1, "PrecogCore: CAN_NOT_CHANGE_CYCLE_DURATION_AT_THIS_TIME");
