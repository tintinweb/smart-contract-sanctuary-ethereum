...
contract WarriorNFT is Context, IWarriorNFT, Ownable {
    ...
    mapping (uint256 => bool) tokenMarket;
    mapping (uint256 => uint256) public tokenPrice;
    uint256[] tokensOnMarket;
    ...
    function buyToken(uint256 tokenId) external {
        ...
        require(tokenMarket[tokenId], "This warrior is not on Market");
    ...
    function getTokenIdsOnMarket() external view returns(uint256[] memory) {
        return tokensOnMarket;
    }
