...
contract FearWolfDistributor is AccessControl, Pausable, Withdrawable, ReentrancyGuard {
    ...
    */
    ...
    constructor() {
        whitelistedPresaleStart = block.timestamp + 5 minutes ;
        publicPresaleStart = whitelistedPresaleStart + 30 minutes ;
        saleStart = whitelistedPresaleStart + 60 minutes ;
        claimingStart = whitelistedPresaleStart + 90 minutes ;
