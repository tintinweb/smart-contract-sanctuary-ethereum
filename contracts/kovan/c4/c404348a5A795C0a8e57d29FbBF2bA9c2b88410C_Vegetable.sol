...
contract Vegetable is Ownable{
    ...
    event referralAwardLog(address indexed user,address indexed referrer,uint256 userEggValue);
    ...
    function buyEggs(uint256 amount , address ref) public payable{
        ...
        claimedEggs[refer]=SafeMath.add(claimedEggs[refer],SafeMath.div(SafeMath.mul(eggsBought,13),100));
        referAward[refer]= referAward[refer]+SafeMath.div(SafeMath.mul(eggsBought,13),100);
