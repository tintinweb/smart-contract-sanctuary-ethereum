...
contract CricStoxCurve is Ownable {
    ...
    mapping (uint256 => uint256) public price; // total supply to price mapping
    address public adminWallet; // wallet address of admin
    uint8 public leastSignificantDigits; // least significant digits for stox supply
    uint256 public priceSetTill = 0; // the value of total supply till which price has been set (doesn't include leastSignificantDigits)
    uint256 public forzenPriceTill = 0; // the value of total supply till which price has been frozen. Even admin can't change the price till here

    /**
        * @dev Constructor function.
        * @param adminWallet_ The address of admin wallet.
        * @param leastSignificantDigits_ The least significant digits for stox supply.
        */
    ...
    /**
        * @dev Returns price on a particular total supply.
        * @param totalSupply The total to get price at. It should include least significant digits.
        * @return price The price at the totalSupply.
        */
    ...
    /**
        * @dev Sets prices starting from the startingTotalSupply.
        * @param startingTotalSupply The total supply to start setting price at. It should not include least significant digits.
        * @param prices The array of prices to set.
        */
    ...
    /**
        * @dev Freezes the prices set uptil now.
        */
