...
contract DEX {
    ...
    function price(
        ...
        uint256 xInputWithFee = _xInput.mul(fee);
        uint256 xReserves = _xReserves.mul(1000);
     ...
     */
    function tokenToEth(uint256 _tokenInput)
        public
    ...
    function deposit() public payable returns (uint256 tokensDeposited) {
        ...
        require(
            token.transferFrom(msg.sender, address(this), tokensToDeposit),
