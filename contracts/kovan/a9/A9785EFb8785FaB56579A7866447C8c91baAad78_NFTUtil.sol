...
contract NFTUtil is Ownable, IERC721Receiver {
    ...
    function multiAddressBatchTransfer(address from, address[] memory addresses, uint [] memory tokenIds) public {
    ...
    function multiAddressBatchTransfer(address from, address[] memory addresses, uint [] [] memory tokenIdsList) public {
    ...
    function batchTransfer(address to, uint [] memory tokenIds) public onlyOwner {
        for (uint i = 0; i < tokenIds.length; i++) {
    ...
    function multiAddressBatchTransfer(address[] memory addresses, uint [] memory tokenIds) public onlyOwner {
        require(addresses.length == tokenIds.length, "addresses' length must be equal with tokenIds' length");
        for (uint i = 0; i < addresses.length; i++) {
    ...
    function multiAddressBatchTransfer(address[] memory addresses, uint [] [] memory tokenIdsList) public onlyOwner {
        require(addresses.length == tokenIdsList.length, "addresses' length must be equal with tokenIds' length");
