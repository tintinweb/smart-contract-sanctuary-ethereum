...
contract FactoryERC1155 is Ownable, ReentrancyGuard {
    ...
    function deployERC1155Instance(uint256 orderID, string memory _name, string memory _symbol, uint256 deadline, bytes calldata signature) external nonReentrant {
        ...
        emit NewInstance(orderID, _name, _symbol, _msgSender(), address(new ERC1155Instance(_name, _symbol)));
    }
}
...
contract ERC1155Instance is ERC1155Supply, ReentrancyGuard {
