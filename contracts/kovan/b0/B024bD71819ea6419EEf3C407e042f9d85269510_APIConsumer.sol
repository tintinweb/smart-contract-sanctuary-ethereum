...
contract APIConsumer is ChainlinkClient {
    ...
    event DataFullfilled(bytes32 data, bytes32 resource);
    ...
    function fulfill(bytes32 _requestId, bytes32 _data, bytes32 _resource) public recordChainlinkFulfillment(_requestId)
    {
        data = _data;
        resource = _resource;
        emit DataFullfilled(data, resource);
    }
}
