...
contract Bank is ERC20, ReentrancyGuard, Ownable {
    ...
    event Work(uint256 indexed id, uint256 loan, uint256 maxReturn);
    event Kill(uint256 indexed id, address indexed killer, uint256 prize, uint256 left);

    string public name = "Interest Bearing USDV";
    string public symbol = "ibUSDV";
