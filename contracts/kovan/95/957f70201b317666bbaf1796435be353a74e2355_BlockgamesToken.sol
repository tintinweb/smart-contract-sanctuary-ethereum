...
contract BlockgamesToken is IERC20 {
        ...
        returns (bool)
    {
        require(
            ...
            "BlockGames Token: Insufficient funds"
        );
    ...
    function transferFrom(
        ...
        require(
            ...
            "Blockgames Token: Allowance is not enough"
        );
    ...
    modifier mustBeOwner(address _account) {
        require(_owner == _account, "Blockgames Token: Caller must be owner");
        _;
    }
}