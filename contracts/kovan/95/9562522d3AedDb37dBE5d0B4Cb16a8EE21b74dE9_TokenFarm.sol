...
contract TokenFarm is Ownable {
    ...
    // StakeTokens
    // unStakeTokens
    // issueTokens reward for stake some token
    // addAllowedTokens
    // getEthValue
    ...
    function getUserSingleTokenValue(address _user, address _token)
        ...
        returns (uint256)
    {
        // return de value of token in USD
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        require(_amount > 0, "Amount must be more than 0"); // how much can they stake?
        require(tokenIsAllowed(_token), "Token is currently no allowed"); // what tokens can they stake?
