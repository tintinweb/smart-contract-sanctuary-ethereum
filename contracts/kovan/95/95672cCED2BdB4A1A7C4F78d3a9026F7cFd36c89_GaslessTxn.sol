...
contract GaslessTxn is ERC721Enumerable, Ownable, EIP712MetaTransaction("Testing","1") {
    ...
    using Strings for uint256;
      ...
      function mint() public payable {       
        ...
        require(mintAmount > 0 , "its not greater than 0");
        require(mintAmount <= maxMintAmount , "its not mint amount is greater than max mint amount");
        require(supply + mintAmount <= maxSupply, "supply and mintamount greater than maxSupply");
