...
contract CP_ERC20_Contract is ERC2771Context, Ownable {
    address private _trustedForwarder;
    IERC20 private token;
    mapping(address => uint) private balances;

    constructor(address _addressToken, address trustedForwarder) ERC2771Context(_trustedForwarder){
    ...
    function transfer(address to, uint amount)public returns(bool){
        require(token.balanceOf(_msgSender()) >= amount, "Balance of buyer must be enough!");
