...
// File: contracts/token/Hellven.sol
...
contract Hellven is Ownable, ERC20Burnable {
    ...
    function setBPContract(address addr) public onlyOwner {
        require(
            address(bpContract) == address(0),
            "Hellven: only initialized once"
        );
    ...
    function setBPDisableForever() public onlyOwner {
        require(!bpDisabledForever, "Hellven: bot protection disabled");
