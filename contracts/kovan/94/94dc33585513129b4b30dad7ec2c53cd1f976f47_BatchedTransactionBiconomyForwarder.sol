...
contract BatchedTransactionBiconomyForwarder is ERC20ForwardRequestTypes,Ownable{
    ...
    bytes32 public constant REQUEST_TYPEHASH = keccak256(bytes("ERC20ForwardRequest(address from,address to,uint256 txGas,uint256 batchId,uint256 batchNonce,uint256 deadline,bytes data)"));
    ...
    function executeBatchEIP712(
        ERC20ForwardRequest[] memory reqs,
        bytes32 domainSeparator,
        bytes[] memory sigs
