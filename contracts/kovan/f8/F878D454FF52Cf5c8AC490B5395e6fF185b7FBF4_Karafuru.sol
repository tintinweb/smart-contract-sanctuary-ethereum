    ...
    Withdrawable
{
    ...
    uint256 public constant PRE_SALES_PRICE = 0.2 ether; //Edit to be cheap in test net
    uint256 public constant PUBLIC_SALES_START_PRICE = 0.5 ether; //Edit to be cheap in test
