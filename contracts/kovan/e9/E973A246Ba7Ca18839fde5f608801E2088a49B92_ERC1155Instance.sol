...
contract ERC1155Instance is ERC1155Supply, ERC1155Burnable, AccessControl {
    ...
    function burn(address account, uint256 id, uint256 value) public override onlyRole(BURNER_ROLE) {
        ERC1155Burnable.burn(account, id, value);
    }

    function burnBatch(address account, uint256[] memory ids, uint256[] memory values) public override onlyRole(BURNER_ROLE) {
