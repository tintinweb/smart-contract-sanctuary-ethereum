...
contract InitialCoinOffering is Ownable, ReentrancyGuard, ERC721Holder, Pausable {    
     ...
     * @dev add nft to the sale list.
     */
    function addMultipleNftToList( uint[] memory nftId, uint[] memory price) external onlyOwner {
     ...
     * @dev update price of NFT added to the sale list.
     */
    function updateMultipleNftPrice( uint[] memory nftId, uint[] memory price) external onlyOwner {
     ...
     * @dev remove NFT from the sale list
     */
    function removeMultipleNftToList( uint[] memory nftId) external onlyOwner {
