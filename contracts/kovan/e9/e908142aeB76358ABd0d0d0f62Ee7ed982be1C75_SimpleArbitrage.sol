...
contract SimpleArbitrage {
    ...
    function makeabt() external payable returns(uint256){
        uint256 amountIn = arbitrageAmount;
        ...
        uint256 amountOut = IUniswapV2Router02(uniswapRouterAddress)
        ...
        paths[0] = daiAddress;
        paths[1] = wethAddress;
        uint256 amountOutMins = (_getPrice(
            uniswapRouterAddress,
            daiAddress,
            wethAddress,
            amountOut
        ...
        uint256 amountOuts = IUniswapV2Router02(uniswapRouterAddress)
