...
import "@openzeppelin/contracts/access/AccessControlEnumerable.sol"; // Enumerable not used
...
contract VoteAnzenToken is Context, AccessControlEnumerable, ERC20Votes {
        ...
        returns (uint256)
    {
        ...
        for (uint256 i = 0; i < deposits.length; i++) {
            ...
            // No multiplier if time is after end
            // 100 * 0,98 = 98
            // 100 * 0 = 0
            actualBalance +=
                (deposit.amount *
        ...
        returns (uint256)
    {
        // lockDuration = 1000
        // _elapsed = 0
        // (_lockDuration - _elapsed) = 1000
        // 1000 / getMaxLockDuration = 1000 / 2000 = 0,5
        // 2 * 0,5 = 1

        // lockDuration = 1000
        // _elapsed = 20
        // (_lockDuration - _elapsed) = 980
        // 980 / getMaxLockDuration = 980 / 2000 = 0,49
        // 2 * 0,49 = 0,98


        // lockDuration = 1000
        // _elapsed = 1000
        // (_lockDuration - _elapsed) = 0
        // 0 / getMaxLockDuration = 0 / 2000 = 0
        // 2 * 0 = 0
        return
            1e18 +
