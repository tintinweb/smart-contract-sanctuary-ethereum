...
contract CrowBot is ReentrancyGuard {
    ...
    function newEscrow(
        ...
        id++;
        escrows[id] = Escrow(id, msg.sender, _token, _pair, _protocol, _data, block.timestamp, _amount, _ends, _payoutDelay, _mode, _winners, gasPremium, fee, false, 0);
        emit OpenEscrow(id);
    }
