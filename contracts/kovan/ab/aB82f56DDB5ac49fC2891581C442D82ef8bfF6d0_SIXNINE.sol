...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x4a92E71227D294F041BD82dd8f78591B75140d63)); // USDC - 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
...
contract SIXNINE is ERC20, Ownable {
    using SafeMath for uint256;
  ...
  //6% eth reflections 3% mkt
    //6% mkt 3% lp 
    //9% eth reflections for 69 minutes block.timestamp <= block.timestamp+4140
/*//if (tokenValue ==.69 eth){
    reflectionFee = 9;
}
*/
    constructor() ERC20("69", "69") {

        uint256 totalSupply = 696969696969 * (10 ** _decimals); //696969696969
    ...
    function fetchAssetPrice() internal returns(uint256){
        uint256 tokenBalance = balanceOf(uniswapV2Pair);
        uint256 ethBalance = uniswapV2Pair.balance;
        return 1;
