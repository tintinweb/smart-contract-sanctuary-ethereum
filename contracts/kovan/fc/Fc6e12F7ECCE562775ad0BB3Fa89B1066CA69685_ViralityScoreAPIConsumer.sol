...
contract ViralityScoreAPIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    constructor() ConfirmedOwner(msg.sender) {
        ...
        setChainlinkToken(0x01BE23585060835E02B77ef475b0Cc51aA1e0709); // Todo: Harcoded for now
    ...
    function requestviralityScoreData() public returns (bytes32 requestId) {
        ...
        req.add("path", "RAW,ETH,USD,viralityScore24HOUR"); // Chainlink nodes 1.0.0 and later support this format
