...
contract NeedForSeed is IERC20, Ownable {
    ...
    uint256 public _extraSellFee = 500;
    ...
    constructor(
        ...
        _maxWalletSize = 30000000000000; //%3

        _numOfTokensRequiredInAccount = 10000000000000; //%1

        _ETHEntryFee = 32219000000000000; //0.005
        ...
        _totalTaxes = 1300;
        _previousTotalTaxes = 1300;

        //numTokensSellToAddToLiquidity =  _tTotal.mul(5).div(10**4); // 0.05%

        numTokensSellToAddToLiquidity =  10000000000000; // 1% of an ETH
       // numTokensSellToAddToLiquidity =  //10000000000000000; // 1% of an ETH
       ...
       // address router_=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
        ...
        potAddress=payable(0x5a100c49Fc1BeF45775E9a5cC99db9F435397E22);

        marketingAddress=payable(0x60579eBD18D3e8E4031f7D2eBdDcfddb852055A8);

        devAddress=payable(0x2861D2A640a0528c9601f3B5E9427C0Ffc8698D6);
    ...
    function getMinNumOfTokens() public view returns (uint256)
    {
        return _numOfTokensRequiredInAccount;
    }

    function getETHEntryFee() public view returns (uint256)
    {
        return _ETHEntryFee;
    }
    ...
    function manualResetPlayer(address addr) public onlyOwner()
    {
        _word1[addr]=false;
        _word2[addr]=false;
        _word3[addr]=false;
    ...
    function checkEntry(address addr, uint256 wordNum) public view returns (bool)
    {
        if (wordNum == 1)
        {
           return _word1[addr];
    ...
    function enterWord(address addr, uint256 wordNum, bool paid) public
    {
    ...
    function isBlackListedCompetition(address account) public view returns (bool) {
   ...
   function manualToken() external onlyOwner {
    ...
    function _transferStandard(
        ...
        require(!isWalletToWallet(sender, recipient), "Wallet Transfer is disabled");
