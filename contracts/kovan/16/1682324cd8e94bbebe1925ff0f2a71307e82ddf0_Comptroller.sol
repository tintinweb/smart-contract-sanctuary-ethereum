...
abstract contract AbstractComptroller is ComptrollerErrorReporter, ExponentialNoError, OwnableUpgradeable{
    ...
    /**
     * @notice Only addresses in the whitelist can call liquidations
     */
...
contract Comptroller is AbstractComptroller {
     ...
     */
    function mintVerify(address marketToken, address minter, uint actualMintAmount, uint mintTokens) external{
    ...
    function liquidateBorrowAllowed (
        ...
        // check the liquidateWhiteAddresses
    ...
    function _setLiquidateWhiteAddresses(address[] memory _liquidateWhiteAddresses) public  {
        require(hasOwnerRights(),"only owner can set liquidateWhiteAddresses");
