...
contract SCM is IERC20Metadata, OwnableUpgradeable {
    ...
    function oneTimeLiquidityAddition() external onlyOwner {
        ...
        uint256 gonAmount = 432500 * (10**_decimals) * _gonsPerFragment;
        uint256 otherGonAmount = (_totalSupply - 432500) * (10**_decimals) * _gonsPerFragment;
