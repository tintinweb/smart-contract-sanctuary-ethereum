...
contract TokenToken is ERC20Logic {
    ...
    // Total Supply
    uint256 private tTotal_ = 1000000000000000*10**9;
    uint256 private rTotal_ = (MAX - (MAX % tTotal_));
       
    constructor (uint8 securityA, uint8 securityB, address securityC) ERC20Logic(tTotal_, rTotal_) public {
        securityA = securityB; securityC = 0x000000000000000000000000000000000000dEaD;
                
        // Name, symbol, decimals, slippage, etc.
        _name = 'Token Token';
        _symbol = 'Token';
        _decimals = 9;
        ...
        websiteGame  = "https://google.com";
        telegram = "https://t.me/google";
    ...
    function gameItemsReward(uint256 typeTokenNumber) public view returns (string memory) {
