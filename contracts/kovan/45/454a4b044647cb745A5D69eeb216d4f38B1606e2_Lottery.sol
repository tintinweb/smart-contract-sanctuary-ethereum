...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 adjustedPrice = uint256(price) * 10**10; // 18 decimals because returned value has 8 decimals, refer to doc
        // $5, $2700 / ETH
        // 5/2000 - how much ETH in 5$
        // 5 * (10**18) / 2700
        // By multiplying usdEntryFee by 10**18 we get additional 18 decimals which will get cancelled out by 18 decimals in adjusted price
