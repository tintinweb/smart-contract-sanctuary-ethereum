...
contract Erc20AssetFactory is AssetFactoryBase {
    constructor(address positionsController_)
        AssetFactoryBase(positionsController_)
    {}

    function setOwnerAsset(uint256 positionId, address contractAddress)
        external
    {
        _setOwnerAsset(positionId, createAsset(contractAddress));
    }

    function setOutputAsset(uint256 positionId, address contractAddress)
        external
    {
        _setOutputAsset(positionId, createAsset(contractAddress));
    }
