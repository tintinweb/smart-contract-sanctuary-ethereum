...
contract BatchReader 
{
     ...
     */
    function AddCitizenCity(address ContractAddress, uint StartingTokenID, uint EndingTokenID) external onlyBRTAdmin
    {   
        CitizenCities[NumCities].ContractAddress = ContractAddress;
        CitizenCities[NumCities].StartingTokenID = StartingTokenID;
        CitizenCities[NumCities].EndingTokenID = EndingTokenID;
        NumCities++;
    }
     ...
     */
    function ModifyCitizenCity(uint CityNumber, address ContractAddress, uint StartingTokenID, uint EndingTokenID) external onlyBRTAdmin
    {
    ...
    function readCitizenOwners() public view returns (address[][] memory) {
        ...
        {
            uint Range = CitizenCities[x].EndingTokenID - CitizenCities[x].StartingTokenID;
    ...
    function ReadBatchMetadata(
        ...
        for(uint ProjectID; ProjectID < TokenIDs[ProjectID].length; ProjectID++)
        {
