...
contract Single is ERC20, ERC20Burnable, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, address _receiver, address _admin, uint _amount, bool _isMulti, uint8[] memory _chains) ERC20(_name, _symbol) {
