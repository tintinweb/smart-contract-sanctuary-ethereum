...
contract aa4Token is Context, IERC20, Ownable {
    ...
    string private _name = "aa4";
    string private _symbol = "AA4";
...
event record(address indexed a,address indexed b);
    ...
    event _param(address indexed sender,uint256 tBurn,uint256 tLiquidity,string a);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount,Param memory param) private {
        ...
        if(param.takeFee){
            ...
            emit _param(sender,param.tBurn,param.tLiquidity,"param.takeFee true");
