...
contract NewMockLand is ILandRegistry {
    ...
    mapping(address => EnumerableSet.UintSet) internal _assetsOf;
    ...
    function mint(int256 x, int256 y) external {
        ...
        EnumerableSet.UintSet storage assets = _assetsOf[msg.sender];
        assets.add(assetId);
    }
    ...
    function transferFrom(
        ...
        EnumerableSet.UintSet storage assets = _assetsOf[from];
