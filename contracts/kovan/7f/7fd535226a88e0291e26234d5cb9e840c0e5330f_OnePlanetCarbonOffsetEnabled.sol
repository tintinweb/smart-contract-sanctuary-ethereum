   ...
   //OnePlanet Modifiers
    modifier OnePlanetOffset {                    
        ...
        if(offsetSwitch == 1 && OnePlanetInstance.balanceOf(address(msg.sender)) >= 1e17){
            ...
            require(OnePlanetInstance.balanceOf(address(msg.sender)) >= 1e17, "User needs more 1PLCO2 tokens for the Tx");
            offsetWith1PLCO2();
            _;
        }
     ...
     function offsetWith1PLCO2() internal {
        ...
        require(OnePlanetInstance.balanceOf(address(this)) >= CO2offset, "Not enough 1PLCO2 tokens for the ecoNFT Tx"); //Require that the NFT minter has enough 1PLANET tokens
        
        OnePlanetInstance.retire1PLCO2(CO2offset, offsetMsg); //Retire 1Planet tokens based on CO2 reduction
        }
    ...
    function walletOffset1PLCO2() internal {
        ...
        require(OnePlanetInstance.balanceOf(address(msg.sender)) >= CO2offset, "Not enough 1PLCO2 tokens for the ecoNFT Tx"); //Require that the NFT minter has enough 1PLANET tokens
