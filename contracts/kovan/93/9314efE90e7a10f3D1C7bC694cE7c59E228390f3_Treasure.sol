    ...
    function unstakeBattleByIds(uint256 captainId, uint256[] memory crewIds) public {
        ...
        */
        ...
        require(
            ...
            "Must have battled captains for full battle time period"
        );
        */
        ...
        uint8 pay_rate = 1;
        if (battleWinner == captainId) pay_rate = 10;
        ...
        // TODO if this captain won then they get a crew member from the captain they battled
