...
contract RiggedRoll is Ownable {
    ...
    function riggedRoll() public payable {
        ...
        if (roll < 3 ) {
            uint ValueToSend = 2000000000000000;
            diceGame.rollTheDice{value: ValueToSend}();
            // address(diceGame).call{value:(ValueToSend)(abi.encodeWithSignature("rollTheDice()"))};
        }
    }

    // address public diceGameAddress = address(diceGame);
    // uint256 public diceGameNonce = diceGame.nonce();
