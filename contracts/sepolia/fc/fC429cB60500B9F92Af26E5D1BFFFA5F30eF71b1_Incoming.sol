...
contract Incoming {
    ...
    address public tokenContractAddress = 0x779877A7B0D9E8603169DdbD7836e478b4624789;
    ...
    function distributeTokens(uint256 amount) external {
        require(tokenContract.transferFrom(msg.sender, recipient, amount), "Token transfer failed");
    }
}
