...
contract YPresale is Ownable, Pausable {
    // Global Variables
    uint256 public constant MAX_CONTRACT_BALANCE = 100 ether;
    ...
    constructor(uint256 _minDeposit, uint256 _maxDeposit) {
        ...
        require(_maxDeposit >= _minDeposit, "Maximum deposit must be greater than or equal to minimum deposit");
    ...
    // Update the minimum and maximum deposit limits
    function updateDepositLimits(uint256 _minDeposit, uint256 _maxDeposit) public onlyOwner {
        require(_minDeposit > 0, "Minimum deposit must be greater than zero");
        require(_maxDeposit >= _minDeposit, "Maximum deposit must be greater than or equal to minimum deposit");
        MINDEPOSIT = _minDeposit;
        MAXDEPOSIT = _maxDeposit;
