...
contract ERC721NFT is ERC721URIStorage {
    ...
    function mint(string memory uri) external payable returns (uint256) {
        require(msg.value == _mintPrice, "ERC721NFT: invalid amount");
        _mint(msg.sender, _tokenId);
        _setTokenURI(_tokenId, uri);
        payable(_contractOwner).transfer(_mintPrice);
        return _tokenId++;
    }
    ...
    function burn(uint256 tokenId) external {
        require(
            ...
            "ERC721NFT: caller is not the owner"
        );
        _burn(tokenId);
    }
    ...
    function changeMintPrice(uint256 newMintPrice) external {
        require(
            ...
            "ERC721NFT: caller is not the contract owner"
        );
