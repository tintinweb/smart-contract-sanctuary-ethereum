...
import {SuperwhitelistERC20} from "../lib/superwhitelist/src/SuperwhitelistERC20.sol";

/**
 * @title Open Exchange Token (OX)
 * @notice OX is an ERC20 token deployed initially on Ethereum mainnet. It has a 
   maximum supply of 9,866,493,250 tokens, which is 100 times the total supply of 
   ...
   SuperwhitelistERC20 contract for managing the blacklist and superwhitelist.
 * @author opnxj
 */
contract OpenExchangeToken is SuperwhitelistERC20 {
    // 100 times the max supply of FLEX on flexstatistics.com
    uint256 public constant MAX_MINTABLE_SUPPLY = 9_866_493_250 ether;
    ...
    constructor(
        address lzEndpoint
    ) SuperwhitelistERC20("Open Exchange Token", "OX", lzEndpoint) {}
