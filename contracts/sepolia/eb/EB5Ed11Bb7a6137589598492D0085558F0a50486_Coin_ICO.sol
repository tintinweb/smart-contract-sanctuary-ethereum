...
contract Coin_ICO is ERC20 , Ownable {
    ...
    // vamos a tener un mapping con las addresses
    mapping (address => bool) public allowedToMint;

    modifier onlyAllowed {
        require(allowedToMint[msg.sender], "El usuario no esta autorizada");
        _;
    }
    
    constructor() ERC20("Moneda de Alumnos", "MdA") {        
        wallet = msg.sender;              
        currentRate = 1000;
        startDate = block.timestamp;
        lastDate = 1688223042;

        secondPhase = startDate + 2 days;
        thirdPhase = startDate + 15 days;
    ...
    function mint(address receiver, uint256 amount) external onlyOwner returns(bool) {
