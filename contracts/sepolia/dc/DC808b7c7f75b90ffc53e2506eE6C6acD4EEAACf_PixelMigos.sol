...
contract PixelMigos is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("PixelMigos", "PM") {
    ...
    function getRescure() public view onlyOwner returns (uint256) {
        return rescure;
    }
    ...
    function setRescure(uint256 _rescure) public onlyOwner {
        rescure = _rescure;
    }
