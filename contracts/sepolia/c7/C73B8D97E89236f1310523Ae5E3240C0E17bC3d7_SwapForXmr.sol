...
contract SwapForXmr is ReentrancyGuard, Ownable {
    ...
    receive() external payable {
        ...
        emit EtherDepositedForXmr(msg.value, msg.sender);
    }

    event EtherDepositedForXmr(uint256 amount, address indexed trader);
