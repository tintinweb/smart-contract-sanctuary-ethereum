...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address payable _addr, uint256 _amount) public onlyOwner {
        require(address(this).balance >= _amount, "Insufficient balance in the contract to withdraw");
    ...
    function riggedRoll() public {
        require(address(this).balance >= 0.002 ether, "Insufficient balance to roll the dice");
        ...
        require(predictedRoll <= 2, "Predicted roll too high, not rolling!");
