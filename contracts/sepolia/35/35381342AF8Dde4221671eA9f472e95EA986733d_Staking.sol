...
// File: pp/finalStaking/staking.sol
...
contract Staking is Ownable, ReentrancyGuard, Pausable {
        ...
        returns (bool)
    {
        ...
        uint256 month = planIdToPlans[_planId].timePeriodInMonth;
        uint256 interestRate = planIdToPlans[_planId].interestRate;
        uint256 rewards = calculateRewards(_amount, month, interestRate);
    ...
    function calculateRewards(
        ...
        uint256 rewards = (amount * month * interestRate) / (12 * 100 * 10);
        return rewards;
    }
