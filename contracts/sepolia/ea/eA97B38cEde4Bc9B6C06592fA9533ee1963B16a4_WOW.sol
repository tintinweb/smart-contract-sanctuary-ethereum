    ...
    UUPSUpgradeable
{
    ...
    function checkCoupan(
        uint256 _coupon
    ) public view isBenefactorOrOwner returns (bool, address) {
    ...
    function getClaimNFTsAddressesData(
        address _address
    ...
    function mintNFT(
        uint256 quantity
    ) public payable checksBeforeMint(quantity) {
        _safeMint(msg.sender, quantity);
    }

    function _discountNFTPrice(
        uint256 _quantity,
        uint256 condition
