...
contract CarrotBond is ERC721, Ownable {
    ...
    struct StakingBond {
        uint256 balanceOf; // PETER balance of the staking position
        uint256 stakedAt; // Timestamp of when the staking position was created
    }
     ...
     */
    function stake_f96d5a(uint256 _amount) public {
        ...
        stakingBonds[tokenId].stakedAt = block.timestamp;
        unchecked {
            totalSupply += _amount;
        }
    }

    function increaseStake_9f4c06(uint256 _tokenId, uint256 _amount) public {
        if (_amount == 0) revert AmountIsZero();
     ...
     */
    function unstake_39c37c(uint256 tokenId) public {
        ...
        if (stakingBond.stakedAt + unstakeLock > block.timestamp) {
            uint256 fee = stakingBond.balanceOf * unstakeFee / 100;
        ...
        unchecked {
            totalSupply -= stakingBond.balanceOf;
        }
     ...
     */
    function getReward_0bfb78(uint256 tokenId) public {
