...
contract Testkasd is ERC721, ERC721URIStorage, Ownable, ERC2981 {
  using Strings for uint256;
  ...
  uint256 public MINTPRICE = 11759470000000000000; //mintprice in wei
...
uint256 public constant royaltyBps = 1; // Set royalty percentage (e.g., 1000 = 10%)
