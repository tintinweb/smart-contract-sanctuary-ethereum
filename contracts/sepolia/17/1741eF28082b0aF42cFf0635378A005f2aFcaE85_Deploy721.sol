...
contract Deploy721 is Script {
    function run() external {
        ...
        nft.mint(address(1), "https://boredapeyachtclub.com/api/mutants/8216", 1);
        nft.mint(address(2), "https://api.otherside.xyz/vessels/9111", 1);
...
contract TestERC721 is ERC721URIStorage, Ownable {
    constructor() ERC721("TBAD721", "TBAD") {}
