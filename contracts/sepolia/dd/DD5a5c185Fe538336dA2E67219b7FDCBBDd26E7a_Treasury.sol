...
contract Treasury is TreasuryToken {
    ...
    mapping(address => uint256) public fundsLedger;
    ...
    function storeFunds() public payable {
        fundsLedger[msg.sender] += msg.value;
    ...
    function withdrawTokens(uint256 withdrawalId, address to) public {
        require(block.timestamp > withdrawalRequests[withdrawalId].expiresAt, "Voting period has not yet expired");
