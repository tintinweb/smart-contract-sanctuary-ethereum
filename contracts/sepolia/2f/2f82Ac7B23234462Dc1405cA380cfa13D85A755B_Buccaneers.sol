...
contract Buccaneers is ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("BotB Test", "BOTBTG") {
        fees.whitelistMintFee = 0.066 ether; // 0.066
        fees.mintFee = 0.1 ether;   // 0.1
        fees.attackFee = 0.007 ether; //0.007
        fees.defendFee = 0.014 ether; //0.014
        fees.trainFee = 0.007 ether;  //0.007
    }
// ----------------------------------------------------------------------------- OWNER OPERATION MODIFIERS & FUNCTIONS
    ...
    /**
    * @notice  Owner can add address to whitelist.
    * @param  wl_address address to be whitelisted
    */
    function addWhitelist(address wl_address) external onlyOwner {
        whitelist[wl_address] = true;
    }
...
// ----------------------------------------------------------------------------- ON-RAMP FUNCTIONS
    ...
    function mintBuccaneer() external onlyIndividual payable {
        ...
        _split(fees.whitelistMintFee, 25, 25);
        } else {
