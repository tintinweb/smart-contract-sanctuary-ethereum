...
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner {
  ...
  function changeSubscriptionId(uint64 newSubscriptionId) public{
    s_subscriptionId = newSubscriptionId;
  }

  function fetchPricePredict() public returns (bytes32){
    Functions.Request memory req;
    req.initializeRequest(Functions.Location.Inline, Functions.CodeLanguage.JavaScript, fetchPriceSource);
    bytes32 assignedReqID = sendRequest(req, s_subscriptionId, i_gasLimit);
