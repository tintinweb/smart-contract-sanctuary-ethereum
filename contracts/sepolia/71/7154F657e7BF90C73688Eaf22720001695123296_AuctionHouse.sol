...
contract AuctionHouse is IAuctionHouse, Pausable, ReentrancyGuard, Ownable {
    ...
    */
    ...
    // airdrop batch mint; sends 1 to each address in array (wild pass)
    function wildPassBatchMint(address[] memory _to) external onlyAdmin {
        ...
        for (uint256 i = 0; i < _to.length; i++) {
            ...
            emit TokenMint(to, tokenId, MintType.WildPass, 0, false, address(0), false, 0);
        }
