...
contract NFTWinner is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable {
  constructor() ERC721A("NFT_Winner", "WIN") {
   ...
   mapping(uint256 => uint256) public atributes1;
   mapping(uint256 => uint256) public atributes2;
...
//   }
  ...
  function mintReward(uint256 quantity, address winnerAddress, uint256 param1, uint256 param2) public {
