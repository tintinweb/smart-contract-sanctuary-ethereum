...
contract GHOST is Context, IERC20, Ownable {
    ...
    function openTrading() external onlyOwner {
        ...
        // Set the Uniswap V2 Router address dynamically based on your contract's requirements
        // Replace the address below with the actual address of the Uniswap V2 Router contract
