...
contract Harambe is IERC20 {
    ...
    constructor() {
        ...
        taxRate = 0; // Initial tax rate is set to 0%. Tax function serves only for blocking MEV bots buying at launch.
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (taxEnabled && !taxWhitelist[sender] && !taxWhitelist[recipient]) {
            ...
            uint256 transferAmount = amount - taxAmount; // Subtract tax amount from the transfer
