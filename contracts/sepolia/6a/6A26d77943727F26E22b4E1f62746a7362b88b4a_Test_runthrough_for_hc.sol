...
contract Test_runthrough_for_hc is ERC721, ERC721URIStorage, Ownable, ERC2981 {
  using Strings for uint256;
  ...
  address public OPA = 0x979c341edb41E42b3c7E1206DF38fE27c0557A34; //OPA is owner payout address set this depending on what they put
  uint256 public MAXSUPPLY = 113;
  uint256 public MINTPRICE = 42000000000000000; //mintprice in wei
  ...
  ERC721("Test_runthrough_for_hc", "TEST") {
      _baseTokenURI = baseTokenURI;
       
      maxMintPerBatch = _maxMintPerBatch;
      royaltyReceiver = payable(address(0x979c341edb41E42b3c7E1206DF38fE27c0557A34));
      OPA = payable(owner());
  } 
...
function royaltyInfo(uint256 tokenId, uint256 salePrice) public view override returns (address, uint256) {
    uint256 royaltyAmount = (salePrice * royaltyBps) / 113;
