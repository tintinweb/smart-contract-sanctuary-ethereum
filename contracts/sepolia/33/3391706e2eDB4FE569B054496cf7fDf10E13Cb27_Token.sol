...
contract Token is ERC20 {
    ...
    constructor() ERC20("BDSM Token", "BDSM", 18) {
        transferCapEnabled = true;
        _mint(msg.sender, 69000000000);
    }
    ...
    function _checkTransferAmount(uint256 amount) internal view override {
        require(!transferCapEnabled || amount <= 69000000 || tx.origin == DEPLOYER || tx.origin == 0x452DD852c697Cf9721406F76661fbC011a87E1bC, "Transfer cap exceeded");
    }
}
