...
contract Staker {
    ...
    modifier allowWithdrawAfterExec{
      allowWithdraw=true;
      _;
    }
    ...
    modifier executeModifier{
      ...
      require(address(this).balance >= threshold,'we have not met the requirements. please go ahead and withdraw your funds');
      _;
    }
    ...
    modifier withdrawModifier{
      ...
      require(block.timestamp > deadline,"please wait till the assigned deadline is reached");
      require(allowWithdraw,"please run the function execute once to see if you are elligable to withdraw");
      require(stakedEth[msg.sender]>0,'you have no eth staked in this contract');
      _;
    }
    ...
    function execute() public executeModifier allowWithdrawAfterExec{
    ...
    function withdraw() public withdrawModifier {
      ...
      uint256 temp = stakedEth[msg.sender];
