 ...
 * @author Boris Kolev
 * @notice Decentralized raffle
 * @dev The application implements Chainlink VRF2 and Chainlinks Keepers
 */
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function enterRaffle() public payable {
        ...
        if (getRaffleState() != RaffleState.OPEN) {
    ...
    /**
     * @dev This is the function for the ChainLink Keepers
     */
