    ...
    function fundChannel() public payable {
        ...
        */
        require(
            ...
            "Sender already has a running channel"
        );
    ...
    function withdrawEarnings(
        ...
        */
        ...
        require(
            ...
            "Channel with insufficient balance"
        );
        uint256 payout = balances[signer] - voucher.updatedBalance;
        console.log("Initial signer balance: ", balances[signer]);
        console.log("Payout: ", payout);
        balances[signer] -= payout;
        console.log("Final signer balance: ", balances[signer]);
        (bool sent, ) = payable(owner()).call{value: payout}("");
        require(sent, "Tx reverted");
