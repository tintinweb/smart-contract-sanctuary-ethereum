...
contract ChainZapTUP is Initializable, OwnableUpgradeable, IAny2EVMMessageReceiver, IERC165 {
  ...
  IRouterClient public i_router = IRouterClient(0xA5bD184D05C7535C8A022905558974752e646a88);

  // Current feeToken
  IERC20 public s_feeToken = IERC20(0x779877A7B0D9E8603169DdbD7836e478b4624789);
  address public gov = address(0x74DE73F2C586ba6Ed7B154c5460A7Ef42e8194cE);
  IBofRouter public bofRouter = IBofRouter(0x65EC7626416a31752a9EE9FcE7555e709a684666);
  address public pendingGov = address(0);
