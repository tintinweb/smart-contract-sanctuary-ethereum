...
contract AdvancedCollectible is ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    event tokenBreedAssigned(uint256 indexed tokenId, Breed breed);
    ...
    constructor(
        ...
        uint32 _numWords
    ) public ERC721(name_, symbol_) VRFConsumerBaseV2(_vrfCoordinator) {
        tokenCounter = 0;
    ...
    function fulfillRandomWords(
        ...
        emit tokenBreedAssigned(newTokenId, breed);
