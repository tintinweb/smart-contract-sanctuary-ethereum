...
contract Dimension is ERC721A, ReentrancyGuard, Ownable{
    ...
    uint256 public maxSupplyPreSale = 1111;
    ...
    constructor() ERC721A("5th Dimension", "5D") {
        merkleRoot = 0xc8ad51d7f7c0aa2b65a7e834db683ee87c472ead57a87dfc67277e233c70d046;
    ...
    function setMaxSupplyPreSale(uint256 _maxSupplyPreSale) public onlyOwner {
    ...
    function preSaleMint(uint256 _quantity, bytes32[] memory _merkleProof) external payable callerIsUser {
        ...
        if((presaleMintedAmount + _quantity) > maxSupplyPreSale) revert MaxSupplyPreSaleExceeded();
