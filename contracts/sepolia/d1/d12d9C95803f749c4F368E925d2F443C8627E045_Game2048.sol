...
contract Game2048 {
    ...
    event TileMoved(uint256 indexed id, uint256[16] board);
    ...
    function _updateBoard(uint256 id, uint256[16] memory board) internal {
        // Update board
        _boards[id] = board;
