    ...
    Ownable
{
    ...
    //---------- Variables ----------//
    uint256 public creditPrice; // Price of credit.
    ...
    */
    ...
    /**
     * @notice Buy credits and fund keepers
    ...
    function buyCredits(
        ...
        uint256 linkAmount = creditPrice.mul(amount);
        ...
        require(msg.value >= ethAmount, "Insufficient eth value");

        // Swap eth for LINK
        nineInchRouter.swapExactETHForTokens{value: ethAmount}(
            linkAmount,
            _getPath(address(nineInchRouter.WETH()), address(link)),
            address(this),
            block.timestamp.add(300)
        ...
        automationRegistryInterface.addFunds(keeperId, linkAmount.toUint96());
