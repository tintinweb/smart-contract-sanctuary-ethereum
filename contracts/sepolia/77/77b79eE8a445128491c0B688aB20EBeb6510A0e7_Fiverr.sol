...
contract Fiverr {
    ...
    function getJobsBySeller(address seller) public view returns (uint256[] memory) {
        return jobsBySeller[seller];
    }


    function getJobsByBuyer(address buyer) public view returns (uint256[] memory) {
        return jobsByBuyer[buyer];
    }
