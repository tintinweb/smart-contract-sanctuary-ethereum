...
contract JunePass is WildNFT {
    constructor(address _minter, uint256 _maxSupply, string memory _baseURI, address[] memory _payees, uint256[] memory _shares, uint96 _feeNumerator) WildNFT('June Pass 2023', 'JUNEPASS', _minter, _maxSupply, _baseURI, _payees, _shares, _feeNumerator) {}
