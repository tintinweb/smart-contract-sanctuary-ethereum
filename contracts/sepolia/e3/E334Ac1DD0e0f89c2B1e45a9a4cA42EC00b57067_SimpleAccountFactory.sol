...
import { UserOperation } from "../proto/structs.sol";
...
abstract contract Account is IAccount {
    ...
    modifier onlyEntryPoint() virtual {
        require(
            ...
            "ERC4337Account: only entryPoint can call this method"
        );
        _;
    }
...
interface IAccount {
     ...
     *
     * @dev [IMPORTANT] Must validate caller is the entryPoint.
     *      [IMPORTANT] validate the signature and nonce
     ...
     *      <20-byte> sigAuthorizer - 0 for valid signature, 1 to mark signature failure,
     *         otherwise, an address of an "authorizer" contract.
     *      <6-byte> validUntil - last timestamp this operation is valid. 0 for "No Expiration"
     *      <6-byte> validAfter - first timestamp this operation is valid
...
/**
  ...
  */
contract SimpleAccount is Account, UUPSUpgradeable, Initializable {
