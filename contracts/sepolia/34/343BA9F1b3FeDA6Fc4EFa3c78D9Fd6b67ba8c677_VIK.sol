...
contract VIK is ERC721A, Ownable, DefaultOperatorFilterer {
    uint256 public max_mints = 100;
    uint256 public max_supply = 21314;
    uint256 public price = 175 ether;
    ...
    string public baseURI = "ipfs://bafkreidd3phdmic2tofngcwnhtj6lpnixhuscmmuzdv6rgpubg35abhfda";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("NFT VIK 2018 Limited Edition", "VIK") {
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        for (uint256 i = 0; i < quantity; i++) {
            ...
            _setTokenURI(newTokenId, baseURI);  // set the baseURI as the default tokenURI
        }    
    }  
    ...
    function claim() external {
        ...
        // Update the tokenURI
        _tokenURIs[firstUnclaimedTokenId] = "ipfs://bafkreiakpxbqagv2el3lvgyxmry7srh3aarkgut2sahcq4icxjlkkpd2ly";
