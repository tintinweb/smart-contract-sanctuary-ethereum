...
contract TheHumania is ERC721AEnumerable, Payable, DefaultOperatorFilterer {
    using Strings for uint256;

    uint256 private maxSalePlusOne = 10001;
    uint256 private maxPresalePlusOne = 10001;

    uint256 public tokenPrice = 0.009 ether;

    uint256 private txLimitPlusOne = 20;
    uint256 public presaleAllowancePlusOne = 20;

    bytes32 public merkleRootPresale1 = 0x7c94ffbc5013097281b6c8c13d08a12c7211c21e03ccab4dea538fbffde0c046;
    bytes32 public merkleRootPresale2 = 0x7c94ffbc5013097281b6c8c13d08a12c7211c21e03ccab4dea538fbffde0c046;
    ...
    bytes32 public merkleRootFree = 0x3b1159365bb6a30a7d5875444df81b6d67e84a33fc8a0095eadc49374e9d92d8;
    ...
    constructor() ERC721AEnumerable("The Humania", "HUMANIANS") {
        humanians = IERC721(0xA88212bDcdf7125557C325269A4857689F8b88A9);
        humaniansStaking = IStaking(0x0A3464Bdce8Cdc457610d61Bd79e052431722C3a);
