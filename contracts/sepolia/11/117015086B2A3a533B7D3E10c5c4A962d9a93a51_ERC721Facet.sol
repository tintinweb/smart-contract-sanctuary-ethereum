...
contract ERC721Facet is IERC721, DefaultOperatorFiltererUpgradeable {
  ...
  function _getAux(address owner) internal view returns (uint64) {
    return uint64(LibERC721.getStorage()._packedAddressData[owner] >> LibERC721._BITPOS_AUX);
  }
  ...
  function _setAux(address owner, uint64 aux) internal {
    ...
    packed = (packed & LibERC721._BITMASK_AUX_COMPLEMENT) | (auxCasted << LibERC721._BITPOS_AUX);
  ...
  function _setExtraDataAt(uint256 index, uint24 extraData) internal {
    ...
    packed = (packed & LibERC721._BITMASK_EXTRA_DATA_COMPLEMENT) | (extraDataCasted << LibERC721._BITPOS_EXTRA_DATA);
