...
library BureaucratTypeHashHelper {
    ...
    function hashTransactionDocumentWrapper(BureaucratTypes.TransactionDocumentWrapper memory dataToHash) internal pure returns (bytes32) {
        return keccak256(abi.encode(
            BureaucratTypeSchemas.EIP712_TransactionDocumentWrapper_SCHEMA_HASH,
