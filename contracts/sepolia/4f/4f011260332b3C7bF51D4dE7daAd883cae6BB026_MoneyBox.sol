...
contract MoneyBox is IERC721Receiver {
    uint256 public withdrawDate;
    address public owner;

    constructor() {
        withdrawDate = 1686258000;
        owner = 0x812E8CFE73a952Cd4be7f7a2dD69EB35b03eB155;
    }
    ...
    function withdraw() external onlyOwner {
        require(block.timestamp >= withdrawDate, "The withdraw date has not been reached yet");
