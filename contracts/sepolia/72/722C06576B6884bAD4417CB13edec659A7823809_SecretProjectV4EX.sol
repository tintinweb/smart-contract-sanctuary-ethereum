...
contract SecretProjectV4EX is ERC721, ERC2981, Ownable, AccessControl, RevokableDefaultOperatorFilterer, PaymentSplitter, ReentrancyGuard {
    ...
    constructor(address[] memory payees, uint256[] memory shares, address admin) 
        ERC721("SecretProjectV4EX", "SPV4EX")
