    ...
    UUPSUpgradeable
{
    ...
    function generateCoupan() public isBenefactorOrOwner returns (uint256) {
    ...
    function checkCoupan(uint256 _coupon) public isBenefactorOrOwner view returns (bool, address) {
