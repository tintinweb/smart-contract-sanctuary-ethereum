...
contract IdleBurn {
    ...
    function burnInactiveTokens() external {
        require(isInactive(msg.sender), "Only inactive accounts can trigger burn");
        
        uint256 amount = balances[msg.sender] / 100; // 1% of the balance
        balances[msg.sender] -= amount;
