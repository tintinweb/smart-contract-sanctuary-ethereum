    ...
    IVRFMigration
{
    ...
    {
        // For a new valid juelsPerFeeCoin report by the OCR committee,
        // update local info.
        ...
        // For a new valid reasonableGasPrice report by the OCR committee,
        // update local info.
        if (reasonableGasPrice != 0) {
            s_hotBillingConfig.reasonableGasPrice = reasonableGasPrice;
    ...
    Pausable
{
    ...
    // getWeiPerUnitLink returns the most recent LINK/ETH ratio,
    // "ETH" being the native gas token of a given network.
    function getWeiPerUnitLink(
    ...
    function convertToJuels(
        ...
        uint256 weiPerUnitLink = localFeedData == 0
            ? getWeiPerUnitLink(billingConfig, hotBillingConfig)
            : localFeedData;
