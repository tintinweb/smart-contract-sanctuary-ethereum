...
contract BTCSenders is ERC721A, Ownable, OperatorFilterer, MerkleProof {

    uint256 public maxToken = 7777;
    uint256 public maxFreeSupply = 7777;
    uint256 public mintMax = 7; 
    ...
    constructor() ERC721A("BTC Senders", "BTCS") OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), true) {
        sethiddenBaseURI("yougetnothing.eth");
    }
