...
contract OceanToken is ERC20, Ownable {
    uint256 private _resaleFee;

    constructor() ERC20("MyToken", "MTK") {
        _resaleFee = 0; // Standard-Wiederverkaufsgebühr von 2%
    ...
    function decimals() public view virtual override returns (uint8) {
        return 18; // Festlegung der Dezimalstellen auf 18
    }

    function setResaleFee(uint256 fee) external onlyOwner {
    ...
    function _transfer(
        ...
        uint256 feeAmount = (amount * _resaleFee) / 100;
