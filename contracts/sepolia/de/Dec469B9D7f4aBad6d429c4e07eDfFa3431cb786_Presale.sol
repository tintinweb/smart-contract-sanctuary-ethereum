...
contract Presale is Context, ReentrancyGuard, Ownable {
    ...
    * @param beneficiary who paid for purchase
    ...
    function _getTokenFromEth(
        ...
        //   uint256 value = weiAmount.div(10 ** 18);
    ...
    function _getTokenFromUsdt(
        ...
        uint256 conversion = _rate.mul(usdtAmount.div(10 ** 6));
        return conversion;
    }
    ...
    function _getTokenFromBnb(
        ...
        //   uint256 value = bnbAmount.div(10 ** 18);
        //   uint256 conversion =  value.mul(rates);
    ...
    receive() external payable { // undo change
        if (_finalized) {
