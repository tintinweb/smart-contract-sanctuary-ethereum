...
contract Calculator {
    ...
    event Multiply(uint256 indexed resut);
    event Divide(uint256 indexed resut);
    event Add(uint256 indexed resut);
    event Substract(uint256 indexed resut);


    function mutiply(uint256 a, uint256 b) external returns (uint256){
