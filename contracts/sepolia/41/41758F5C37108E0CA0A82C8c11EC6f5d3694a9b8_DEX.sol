...
contract DEX {
    ...
    function deposit() public payable returns (uint tokenDeposited) {
    ...
    function withdraw(
        uint amount
    ) public returns (uint eth_amount, uint token_amount) {
        require(
