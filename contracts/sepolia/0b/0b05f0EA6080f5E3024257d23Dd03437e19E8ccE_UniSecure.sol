...
contract UniSecure is ChainlinkClient, ConfirmedOwner {
    ...
    function requestData(
        ...
        request.add("post", superApi);

        request.add("path", "data");
        request.add("userPublicKey", addressToString(msg.sender));
        request.add("userPublicKey", userPubKey);
        request.add("receiverPublicKey", entities[receiver].publicKey);
        request.add("apiEndpoint", endpoint);
