    ...
    ReentrancyGuard
{
        ...
        returns (address)
    {
        ...
        (bool success, bytes memory result) = identicalChild.delegatecall(abi.encodeWithSignature("initialize(string,string,string,uint256[],uint256[],address[],uint256[],address,uint32,bytes32)",
            _name,
            _symbol,
            _uri,
            _ticketPrices,
        ...
        // INFTixERC721(identicalChild).initialize(_name, _symbol, _uri, _ticketPrices, _ticketRanges, _payees, _shares, defaultPlatformAdmin, mintingLimit, _root);
