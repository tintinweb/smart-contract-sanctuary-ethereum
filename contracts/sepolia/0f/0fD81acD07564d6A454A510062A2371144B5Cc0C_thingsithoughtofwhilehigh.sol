...
// File: contracts/thingsithoughtofwhilehigh.sol

contract thingsithoughtofwhilehigh is Ownable, ERC721AI, ReentrancyGuard {
    bool public frozen;
    
    uint256 public publicMax = 169;
    uint256 public pricePerMint = 42000000000000000 wei; // 0.0033 ETH
    uint256 public fireMintPrice = 69000;
    ...
    address public fireAddress = 0x3Cb59376dc71781f32CF9915b3AB595d34583eFB;
    mapping(address => uint256) public mintedCount;
    
    constructor(
    ) ERC721AI(
        "thingsithoughtofwhilehigh", 
        "high", 
        2, 
        169 // NEED FINAL ##
    ) {}
    ...
    function mint(
        ...
        IERC20 fireToken = IERC20(fireAddress);
        fireToken.approve(address(this), fireMintPrice * amount);
        _mintWithFire(
            _msgSender(),
            amount
        );
    ...
    function _mintWithFire(
      ...
      require(
        ...
        "max batch limit");
      require(
        totalSupply() + amount <= publicMax, "reached max public"
        );
      ...
      require(
        fireToken.transferFrom(msg.sender, 0x14bBD070256657a1d779552B86635e1055AE0eFE, fireMintPrice),
