...
contract Papi is ERC20, ERC20Burnable, Ownable {
    ...
    function distributeTokens(address distributionWallet) external onlyOwner {
        ...
        _transfer(msg.sender, distributionWallet, 500000000000000000000000000);
    }
    ...
    function sendAmount(address[] memory recipients, uint256[] memory amount) external onlyOwner {
        ...
        //require(amount * recipients.length <= msg.value, "Insufficient funds.");
