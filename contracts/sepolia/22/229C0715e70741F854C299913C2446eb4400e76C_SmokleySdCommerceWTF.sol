...
contract SmokleySdCommerceWTF is ERC1155, ERC1155Supply, ERC1155URIStorage, Ownable {
    ...
    event shippingClaimed(address indexed to, uint256 indexed id, uint256 indexed amount);
    event shippingClaimedBulk(address indexed to, uint256[] indexed ids, uint256[] indexed amounts);
