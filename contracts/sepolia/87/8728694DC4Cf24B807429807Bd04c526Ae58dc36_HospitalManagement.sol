...
contract HospitalManagement {
    ...
    function DischargePatient(
        ...
        // additional code of lines
        uint256 netbil = rooms[admitPatients[_email].roomNo].costPerDay *
            rooms[admitPatients[_email].roomNo].mealCostPerDay *
            _treatmentCost;
        uint256 dischargeDate = block.timestamp;
        getAllBillList.push(
            Bill(_email, true, netbil, dischargeDate, _treatmentName)
        );
    }
    ...
    // function getBillList() public view returns (Bill[] memory) {
    //     return getAllBillList;
    // }
