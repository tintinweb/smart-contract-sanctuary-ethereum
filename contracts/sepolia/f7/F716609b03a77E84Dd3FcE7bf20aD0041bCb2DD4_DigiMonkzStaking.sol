...
contract DigiMonkzStaking {
    ...
    mapping(uint16 => NftInfo) artifactPerGen1Nft;
    mapping(uint16 => NftInfo) artifactPerGen2Nft;
    mapping(address => uint256) artifactPerStaker;
    mapping(address => uint16[]) gen1InfoPerStaker;
    mapping(address => uint16[]) gen2InfoPerStaker;
