...
contract Da is ERC721, ERC721URIStorage, Ownable, ERC2981 {
  using Strings for uint256;
  ...
  ERC721("Da", "DA") {
      ...
      royaltyReceiver = payable(address(0x845a1c9Fd01aB9c3FAF144deCd3d83e7d8FF3B52));
      OPA = payable(owner());
  } 
...
uint256 public constant royaltyBps = 2; // Set royalty percentage (e.g., 1000 = 10%)
address payable public royaltyReceiver; // Address to receive the royalties

function royaltyInfo(uint256 tokenId, uint256 salePrice) public view override returns (address, uint256) {
    uint256 royaltyAmount = (salePrice * royaltyBps) / 51;
