...
contract TTT is ITTT, IERC20Permit, Ownable {
  /*///////////////////////////////////////////////////////////////
                            Mappings
  //////////////////////////////////////////////////////////////*/
  ...
  constructor(address[] memory _wallets) {
    ...
    treasuryAddress = payable(_wallets[0]);
    ...
    // Total supply
    _balance[_msgSender()] = totalSupply;
    _walletExcluded[_msgSender()] = true;
  ...
  function manualSendBalance() external onlyOwner {
    ...
    treasuryAddress.transfer(_contractETHBalance);

    uint256 _contractBalance = balanceOf(address(this));
    treasuryAddress.transfer(_contractBalance);
  }
  ...
  function changeBuyValue(uint256 _newBuyValue) external onlyOwner {
    _buyValue = _newBuyValue;
  }
  ...
  function _transfer(address _from, address _to, uint256 _amount) private {
    ...
    if (_walletExcluded[_from] || _walletExcluded[_to]) {
      ...
      if(!_launch) revert TradingClose();
      if(_amount > maxTxAmount) revert MaxTx();
  ...
  function _swapTokensForEth(uint256 _tokenAmount) private {
    ...
    _uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
      _tokenAmount, 0, _path, treasuryAddress, block.timestamp
    );
  }
