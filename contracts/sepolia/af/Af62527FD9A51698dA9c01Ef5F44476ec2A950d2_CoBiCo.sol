...
contract CoBiCo is ERC721("Collaterize,Bid & Collect", "CBC"), IERC721Receiver {
   
    address stablecoin_addr = 0x2aE7592B48D19608e32Cd18AfBcde337Aaf3cf9A;
    address collateral_addr = 0xefdc9e737Fc649D0a37A8e802c872f0464cfa896;
    IERC20 stablecoin = IERC20(stablecoin_addr);

    IERC20 collateral = IERC20(collateral_addr);
address stablecoin_agg_addr= 0xA2F78ab2355fe2f984D808B5CeE7FD0A93D5270E;
address collateral_agg_addr= 0xC5981F461d74c46eB4b0CF3f4Ec79f025573B0Ea;
    struct Storage {
        uint256[] members;
...
uint256 stablecoin_agg_decimals= 10**stablecoin_agg.decimals();
    ...
    function getBTCPrice() public view returns (uint256) {
        ...
        return uint((price*int(stablecoin_agg_decimals/acollateral_decimals))/(price2/int(stablecoin_agg_decimals)));
