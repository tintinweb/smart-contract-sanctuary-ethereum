...
// File @openzeppelin/contracts/access/[email protected].9.0
...
contract ChaosCoin is ERC20, PullPayment, ERC20Burnable, Ownable {
    ...
    bool mintable = true;
    uint256 unitsOneWeiCanBuy = 1000;
    ...
    constructor() ERC20("Chaos Coin", "CHAOSCOIN") {
        tokenOwner = msg.sender;       // address of the token owner        
        // mint 1 ETH worth of tokens to deployer
        _mint(msg.sender, unitsOneWeiCanBuy*10**18);
    }


    function setUnitsOneWeiCanBuy(uint256 _newUnitsOneWeiCanBuy) external onlyOwner {
        unitsOneWeiCanBuy = _newUnitsOneWeiCanBuy;
    }

    function setMintable(bool newState) external onlyOwner {
        mintable = newState;
    }

    function setStartingTier(uint256 _newTier1) external onlyOwner {
        tier1 = _newTier1;
        tier2 = _newTier1*2;
        tier3 = _newTier1*4;
        tier4 = _newTier1*10;
    ...
    receive() external payable {        
        ...
        uint256 chaosAmount = msg.value * unitsOneWeiCanBuy;
