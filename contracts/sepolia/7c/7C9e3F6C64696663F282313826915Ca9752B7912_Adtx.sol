...
contract Adtx {
    ...
    event AddAdvertiser(address,uint,uint);
    ...
    function addAdvertiser(address adrs, uint adPrice, uint numberOfDays) external returns(bool){
         require(msg.sender == owner, "caller is not owner");
         ...
         emit AddAdvertiser(adrs,adPrice,numberOfDays);
         return true;
    }
