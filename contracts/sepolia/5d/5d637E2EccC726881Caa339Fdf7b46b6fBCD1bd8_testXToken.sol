...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    modifier isPresaleLive {
       // require(_burnOwner != address(0),'Presale is not active');
        require(isPresaleDone == true,'The Pre-Sale is Still Ongoing');
        _;
    } 
    ...
    function transfer(
        address to,
        uint256 amount
    ) public virtual isPresaleLive override returns (bool)  {
