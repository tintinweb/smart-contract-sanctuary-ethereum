  ...
  UpdatableOperatorFiltererUpgradeable
{
  ...
  function initialize() public initializer {
    ...
    s_tokenIdToPrice[2] = 0.008 ether;
  }
  ...
  /**
   * @notice mints token with Id 1 from powerpack contract
  ...
  function mintAgeOfValor(uint256 quantity) external payable nonReentrant {
    if (msg.value < s_tokenIdToPrice[2] * quantity) {
      revert ReaderTokens__PaymentInsufficient();
    }
    _mint(msg.sender, 2, quantity, "");
    emit MintedToken(2, quantity, msg.sender);
  }
