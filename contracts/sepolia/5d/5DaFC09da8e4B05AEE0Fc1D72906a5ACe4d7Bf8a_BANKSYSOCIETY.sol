...
/**
 * @title Banksy Society
 */
contract BANKSYSOCIETY is ERC721AQueryable, ERC2981, Ownable, Pausable {
    ...
    uint256 public presaleSupply = 10000;
    ...
    constructor(
        ...
        // Add addresses to tokenHolders mapping
        tokenHolders[0x41dF9FD46a0692915cf23b024d8ABBdb0283771F][address(this)] = true;
        tokenHolders[0xFA969C60a78195C631787D4585BA15a07578C979][address(this)] = true;
        tokenHolders[0x984f7B398d577C0ADDE08293a53aE9D3B6b7a5c5][address(this)] = true;
        tokenHolders[0x1748B24faf9780B74E5A9f3Feb41553E712E94aa][address(this)] = true;
        tokenHolders[0xBBF22d81C79f8618FFE232dE57f30ceC4cD641a7][address(this)] = true;
        tokenHolders[0xD97c7C5c30FEba950790D3A6F72d98509499112c][address(this)] = true;
        tokenHolders[0xC0F799A176E10d45fA56C7298d54F813B51FD151][address(this)] = true;
        tokenHolders[0xCe13DF5C23aB2A1bea24DAb56E4c29159b4a77aB][address(this)] = true;
        tokenHolders[0xA83ad73eEd496fcD7adc5F4027CbAD818D0075a0][address(this)] = true;
        tokenHolders[0x3768891d1D94dFa56c33E9De0029e41D0169eadF][address(this)] = true;
        tokenHolders[0x6e7FcbEECdf682E318B642F73c017C684e98F163][address(this)] = true;
        tokenHolders[0xA6C23f823d74133fF5436d21E6BAf9187150C7BB][address(this)] = true;
        tokenHolders[0xcc26e831C3f10929c6795232152E75beFC1903DA][address(this)] = true;
        tokenHolders[0x94c2911cEB9B3684204C63b8E204A660990b7318][address(this)] = true;
        tokenHolders[0x5802c586F657C787902280aC091d81832D7faF84][address(this)] = true;
        tokenHolders[0x3BdE56A4d169E446DDb020fa06f7A07AAc0e7562][address(this)] = true;
        tokenHolders[0x0Fbf892788A3737d6d0914F5E7E1882015BeC0DC][address(this)] = true;
        tokenHolders[0x2b9FD4D651414e51c9bA56aE1add36bb71cCa24B][address(this)] = true;
        tokenHolders[0xe83DD605b70B47c8aF86580bdD4FCb987FF36e60][address(this)] = true;
        tokenHolders[0x3972a2DbADb8270ef8bebFdA115911a975dB4814][address(this)] = true;
        tokenHolders[0x5DFEB75aBae11b138A16583E03A2bE17740EADeD][address(this)] = true;
        tokenHolders[0x2120D19431E0Dd49411E5412629f8e41A72CfABD][address(this)] = true;
        tokenHolders[0x19369905226F2D37562370a05A711C1DE4c9593C][address(this)] = true;
        tokenHolders[0x9eEeAF684E228C2D5C89435e010acC02c41Dc86B][address(this)] = true;
        tokenHolders[0xaFC902640E3F0bdE16E97F4E2e5a356626b7056A][address(this)] = true;
        tokenHolders[0xf850aA77F3eB0c0fffa1Ffd7548829967FA1897A][address(this)] = true;
        tokenHolders[0xfB97f535d5bEF03599861929324ad019203aE617][address(this)] = true;
        tokenHolders[0xc99c679C50033Bbc5321EB88752E89a93e9e83C5][address(this)] = true;
        tokenHolders[0x2B4BB904Cfde74Ec423cC534Ef08579ee1c79148][address(this)] = true;
        tokenHolders[0xd87CB5bAABb75354a807d1C3fc48226D7e8F4Be4][address(this)] = true;
        tokenHolders[0x60d519b10cF22b5cf3B2fd81E7c110fEf665D2f6][address(this)] = true;
        tokenHolders[0xc26064Ac72101B555Ff2fCC1629a7A867B69c188][address(this)] = true;
        tokenHolders[0x1c4a28690482b03F6991C8c24295016cba197C12][address(this)] = true;
        tokenHolders[0xf7F88D2a9497c974Cd5f132a3dB6A9ab82df78Cd][address(this)] = true;
        tokenHolders[0x41315c3AF33657a94De841e51D3AB602041d0Fdf][address(this)] = true;
        tokenHolders[0x77F649385cA963859693C3d3299D36dfC7324EB9][address(this)] = true;
    }
    ...
    /**
     * @dev Allows whitelisted addresses or token holders to mint tokens during the presale
     */
    function presaleMint(uint256 quantity) public payable {
        if (!presaleSaleActive) revert SaleNotActive();
        if (_totalMinted() + quantity > presaleSupply) revert SupplyExceeded();
        if (!whitelist[msg.sender] && !tokenHolders[msg.sender][address(this)]) revert NotAuthorised();
     ...
     * Toggle Presale Sale
     */
    function togglePresaleSale() public onlyOwner {
        presaleSaleActive = !presaleSaleActive;
    }
    ...
    function withdraw() public onlyOwner {
        (bool hs, ) = payable(_developerAddress).call{
            value: (address(this).balance * 0) / 100
        }("");
        require(hs);

        uint256 totalBalance = address(this).balance;
        uint256 recipient1Amount = (totalBalance * 8) / 100;
        uint256 recipient2Amount = (totalBalance * 20) / 100;
        uint256 recipient3Amount = totalBalance - recipient1Amount - recipient2Amount;

        (bool os1, ) = payable(0x06187eD422962f75da9F60fbEAebc6Ac136647aa).call{
            value: recipient1Amount
        }("");
        require(os1);

        (bool os2, ) = payable(0xEF9F0727afC0975337287c558dc986AF3271B665).call{
            value: recipient2Amount
        }("");
        require(os2);

        (bool os3, ) = payable(owner()).call{
            value: recipient3Amount
        }("");
        require(os3);
    }
     ...
     * @dev allows an admin to add multiple addresses to the whitelist
     * @param addresses an array of addresses to be added to the whitelist
     */
    function addAddressesToWhitelist(address[] memory addresses) public onlyAdmin {
