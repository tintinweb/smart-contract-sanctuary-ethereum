...
contract FancyBearStakingV3 is Ownable, AccessControlEnumerable, IERC721Receiver {
    ...
    address public newHoneyContract;
    ...
    constructor(
        ...
        newHoneyContract = _newHoneyContract;
    ...
    function _stakeFancyBear(address _sender, uint256 _tokenId) internal {
        ...
        require(
            levelsContract.getConsumedToken(address(fancyBearContract), _tokenId, newHoneyContract) >=
    ...
    function _unstakeFancyBear(address _sender, uint256 _tokenId) internal {
        ...
        require(
            stakingDataByTokenId[_tokenId].timestamp != 0,
            "_unstakeFancyBear: _requestToUnstakeFancyBear should be called before"
        );

        require(
            block.timestamp - stakingDataByTokenId[_tokenId].timestamp >= cooldown,
