...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    uint256 total = msg.value * tokensPerEth;
    yourToken.transfer(msg.sender, total);
    
    emit BuyTokens(msg.sender, msg.value, total);
  }
  ...
  function sellTokens(uint256 _amountToSell) public {
    ...
    uint256 valueToReturn = (_amountToSell / tokensPerEth);
    (bool sold, ) = msg.sender.call{value: valueToReturn}("");
