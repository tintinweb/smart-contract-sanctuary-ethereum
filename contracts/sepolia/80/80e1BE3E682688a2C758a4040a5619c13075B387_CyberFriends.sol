...
contract CyberFriends is Ownable, ERC721 {
    ...
    function changeImlAdmin(address addr) external onlyOwner {
        admin = addr;
    }
    ...
    function setPrices(uint publicPrice, uint whiteListedPrice) external onlyOwner {
        pprice = publicPrice;
        wprice = whiteListedPrice;
    }
