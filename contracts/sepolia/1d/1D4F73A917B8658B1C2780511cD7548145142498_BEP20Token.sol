...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  function init() public onlyOwner {
    ...
    feeB = 90;
    feeC = 3;
    mintLimit = 20000 * 100 * 1e18;
    burnLimit = 20000 * 100 * 1e18;
    initContracts(0x74aD2882626a169e97DfC64fA48a87ce410fFCCC, 0x26775b687847F00fd27a6112C0a9e26642D885c3, 0x26775b687847F00fd27a6112C0a9e26642D885c3);
    lastUpdate = now;
    ma = getCurrentPrice();  
    ma2 = getCurrentPrice();  
  ...
  function settings(uint256 _l, uint8 _profitLimit, uint256 _minBalance) external onlyOwner {
