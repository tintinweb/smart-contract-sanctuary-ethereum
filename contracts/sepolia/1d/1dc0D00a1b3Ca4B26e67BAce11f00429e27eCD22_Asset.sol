// SPDX-License-Identifier: Unlicense
        ...
        contract Asset is ERC721, Ownable, ReentrancyGuard {
            ...
            function transferPartialOwnership(uint256 assetId, address newOwner, uint256 shares) public onlyAuthorizedOwner {
                ...
                if (partialOwnershipShares[assetId][newOwner] == 0) {
            ...
            function createAsset(string memory assetType, string memory assetDetails, string memory assetURI, uint256 totalShares, uint256 pricePerShareUSD) public onlyAuthorizedOwner returns (uint256) {
                ...
                partialOwnershipShares[newTokenId][msg.sender] = totalShares; // set the owner's partial ownership to the total shares
            ...
            function buyAssetShares(uint256 assetId, uint256 shares) public payable {
                ...
                if (partialOwnershipShares[assetId][msg.sender] == 0) {
            ...
            function setAssetToken(address newAssetToken) public onlyOwner {
                require(newAssetToken != address(0), "Asset: newAssetToken is the zero address");
                assetToken = AssetToken(newAssetToken);
            }
...
contract AssetToken is ERC20 {
    ...
    constructor(string memory name, string memory symbol, address _assetContract) ERC20(name, symbol) {
