...
// NFT存储合约
contract NFTVault is OwnableUpgradeable {
    ...
    function setProxyAdmin(address newProxyAdmin) public onlyOwner {
    ...
    function withdraw(address senderAddress, address contractAddress, address to, uint256 tokenId) public {
        require(msg.sender == _proxyAdmin, "Only the owner can withdraw the NFT.");
