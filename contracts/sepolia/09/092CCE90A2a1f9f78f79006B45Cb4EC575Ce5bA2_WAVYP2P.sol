...
contract WAVYP2P is ReentrancyGuard, Ownable {
    ...
    function makeOffer(uint _sendTokenId, uint256 _sendAmount, uint _receiveTokenId, uint256 _receiveAmount, uint256 _minReceiveAmount) external {
        ...
        emit OfferCreated(offerDetails.length, msg.sender, _sendTokenId, _sendAmount, _receiveTokenId, _receiveAmount, _minReceiveAmount);
    }
