    ...
    EIP712Upgradeable
{
    ...
    function _hash(
        MarketplaceVoucher memory voucher
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "MarketplaceVoucher(address owner,uint256 price,uint256 auctionType,uint256 quantity,uint256 endTime,uint256 tokenId,address tokenAddress,address payFrom,uint256 salt)"
                        ),
                        voucher.owner,
                        voucher.price,
                        voucher.auctionType,
    ...
    function verifySignatureAndQuantityAvailable(
        ...
        MarketplaceVoucher memory voucher = MarketplaceVoucher({
            owner: _owner,
            price: _otherParams[1],
            auctionType: _otherParams[2],
            quantity: _otherParams[3],
            endTime: _otherParams[4],
            tokenId: _otherParams[0],
            tokenAddress: _tokenAddress,
            payFrom: _erc20Address,
            salt: _otherParams[5],
        ...
        // }
        // require(
        //     _quantity <= auctionDetails[otherParams[5]].quantityLeft,
        //     "Cannot buy more than available"
        // );
        // auctionDetails[otherParams[5]].quantityLeft -= _quantity;
        return seller;
    }
    ...
    function buy721(
        ...
        emit BuyEvent(seller, _msgSender(), otherParams[0], _tokenAddress);
