  ...
  function chipURI(uint256 tokenId) internal pure returns (string memory) {
    ...
    return string(abi.encodePacked(
      ...
      Base64.encode(bytes(string(abi.encodePacked(
        "{ \"name\": \"", abi.encodePacked('Unrevealed Identity #', LibUtils.numberToString(tokenId)), "\", ",
          "\"attributes\": [",
            "{ \"trait_type\": \"Identity\", \"value\": \"", LibUtils.numberToString(tokenId), "\" }",
          "], ",
          "\"image_data\": \"",
            LibERC721.CHIP_SVG,
          "\"",
