...
contract Seed is Ownable {
    ...
    constructor(address _stbl, address _stbl_fe, address _nft_slag, address _nft_fe, DepositInfo[] memory _depositInfoForSlag, DepositInfo[] memory _depositInfoForFE) {
