...
contract FCEBridge is AccessControl {
    ...
    function swap(
        ...
        if(!isContractAvailable) require(!isContract(msg.sender) && msg.sender == tx.origin, "Only non contract call");
    ...
    function redeem(
        ...
        require(isBridgeValid[chainIdFrom][getChainID()][tokenFrom][tokenTo], "Redeem is not possible");
        ...
        require(redeemStatus[redeemHash] != Status.Done, "Arguments to redeem was already used");
