...
import {CommodityNFT} from "../core/CommodityNFT.sol";
import {IAssetDeployer} from "../interfaces/IAssetDeployer.sol";

contract CommodityDeployer is IAssetDeployer {
    /// @inheritdoc IAssetDeployer
    function deploy(bytes32 salt)
        external
        override
        returns (address addr)
    {
        addr = address(new CommodityNFT{ salt: salt }());   
    }
