...
import {Staking20Upgradeable} from "Staking20Upgradeable.sol";
import "ITokenStake.sol";

contract StakeSnails is
    Initializable,
    ContractMetadata,
    ...
    ITokenStake
{
    bytes32 private constant MODULE_TYPE = bytes32("SnailsStake");
    ...
    function initialize(
        ...
        /*require(
            ...
            "Reward Token and Staking Token can't be same."
        );*/
        rewardToken = _rewardToken;

        uint256 _stakingTokenDecimals = _stakingToken ==
            CurrencyTransferLib.NATIVE_TOKEN
            ? 18
            : IERC20Metadata(_stakingToken).decimals();
        uint256 _rewardTokenDecimals = _rewardToken ==
            CurrencyTransferLib.NATIVE_TOKEN
            ? 18
...
abstract contract Staking20Upgradeable is
    ...
    IStaking20
{
    ...
    address public stakingToken = 0x0AfEC09Ef3e96BE36e2E83d9e11ca2B15E673BD0;
    address public rewardToken = 0x0AfEC09Ef3e96BE36e2E83d9e11ca2B15E673BD0;

    /// @dev Decimals of staking token.
    uint256 public stakingTokenDecimals = 18;

    /// @dev Decimals of reward token.
    uint256 public rewardTokenDecimals = 18;
    ...
    function __Staking20_init(
        ...
        require(
            _stakingTokenDecimals != 0 && _rewardTokenDecimals != 0,
            "decimals 0"
        );
    ...
    */
    ...
    function getTimeUnit() public view returns (uint256 _timeUnit) {
        _timeUnit = stakingConditions[3600].timeUnit;
    }
    ...
    {
        _numerator = stakingConditions[1].rewardRatioNumerator;
        _denominator = stakingConditions[20].rewardRatioDenominator;
    }
    ...
    function _stake(uint256 _amount) internal virtual {
        ...
        uint256 actualAmount = IERC20(_stakingToken).balanceOf(address(this)) -
            balanceBefore;
