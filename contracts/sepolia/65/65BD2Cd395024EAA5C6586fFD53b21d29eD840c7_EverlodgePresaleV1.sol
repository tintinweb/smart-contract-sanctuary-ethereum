...
contract EverlodgePresaleV1 is
    Initializable,
    ...
    PausableUpgradeable
{
    ...
    function initialize(
        ...
        require(_oracle != address(0), "0 aggregator address");
        require(_usdt != address(0), "0 USDT address");
    ...
    function startClaim(
        ...
        require(_saleToken != address(0), "0 token address");
