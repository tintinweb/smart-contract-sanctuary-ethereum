...
contract ALTGPTPresale is Ownable,ReentrancyGuard {
    ...
    function calculateETH2USDT(uint256 _amount) public view returns (uint256) {
    ...
    function calculateUSDT2ETH(uint256 _amount) public view returns (uint256) {
        uint256 price = stages[currentStage].price;
        uint256 ethPrice = getCurrentETHPrice();
    ...
    function nextStage() public onlyOwner {
        ...
        stages[currentStage].price = 1000000;
        stages[currentStage].duration = 1 days;
