...
// File: contracts/banksyfinal.sol
...
contract BANKSYSOCIETY is ERC721AQueryable, ERC2981, Ownable, Pausable {
    ...
    function presaleMint(uint256 quantity) public payable {
        if (!presaleMintActive) revert SaleNotActive();
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 recipient1Amount = (totalBalance * 33) / 100;
        uint256 recipient2Amount = (totalBalance * 33) / 100;
        uint256 recipient3Amount = totalBalance - recipient1Amount - recipient2Amount;

        (bool os1, ) = payable(0xB4C55107c5a4650500269D6DD1b2aE0F028Cf15f).call{
            value: recipient1Amount
        }("");
        require(os1);

        (bool os2, ) = payable(0xdA0E640FD5F40b66FF3dE75D0dfE670259136B15).call{
