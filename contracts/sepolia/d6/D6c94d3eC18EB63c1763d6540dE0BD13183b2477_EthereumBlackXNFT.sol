...
contract EthereumBlackXNFT is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("EthereumBlack", "XNFTs") {
        maxSupply = 10000;
    ...
    function getEthPrice() public view returns (uint256) {
        ...
        ethereumBlackValue = ethValue; // 1 ETH Black value in USD
        return ethereumBlackValue;
    }
}