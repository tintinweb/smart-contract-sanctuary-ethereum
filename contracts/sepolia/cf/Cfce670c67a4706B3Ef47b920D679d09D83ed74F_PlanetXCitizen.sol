...
// File: contracts-hardhat/contracts/NFT/Plntx_Multicall.sol
...
contract Plntx_Multicall {

    // string public name = 'PlanetXCitizen';
    // string public symbol = 'PLXCTZ';
...
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    // Token name
    string private _name = "PlanetX Citizen";

    // Token symbol
    string private _symbol = "PLXCTZ";
...
// File: @openzeppelin/contracts-upgradeable/token/ERC721/extensions/draft-ERC721VotesUpgradeable.sol
...
// File: contracts-hardhat/contracts/NFT/PlanetXCitizen.sol
...
contract PlanetXCitizen is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable, Plntx_Multicall {
    using CountersUpgradeable for CountersUpgradeable.Counter;
    ...
    function toggleTransferable() external onlyRole(ADMIN_ROLE) returns (bool) {
      if (_transferable) {
        _transferable = false;
      } else {
        _transferable = true;
    ...
    {
        if(_exists(tokenId)) require(transferable(), "SoulBoundNFT: not transferable");
