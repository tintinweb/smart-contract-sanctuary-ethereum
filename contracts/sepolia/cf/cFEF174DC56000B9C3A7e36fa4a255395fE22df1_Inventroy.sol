...
contract Inventroy {
    ...
    mapping(address => Types.Item[]) internal Inventor;
    mapping(address => mapping(bytes32 => Types.Item)) internal rawMaterials; //mapping change public to normal
    mapping(address => Types.manfItem[]) internal userLinkedProducts;
    ...
    function updateRawMaterial(
        ...
        Types.Item[] storage products = Inventor[msg.sender];
    ...
    // onlyManufacturer
    {
        ...
        Types.manfItem[] storage products_ = userLinkedProducts[msg.sender];
