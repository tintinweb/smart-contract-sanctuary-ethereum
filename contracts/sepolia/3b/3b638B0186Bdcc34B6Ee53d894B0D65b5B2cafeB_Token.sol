...
contract Token is Initializable, ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, AccessControlUpgradeable {
    struct airdrop {
    ...
    function initialize(string memory name_,string memory symbol_,airdrop[] memory airdrop_) initializer public {
        ...
        for (uint i = 0; i < airdrop_.length; i++) {
          ...
          _delegate(airdrop_[i].airdropAddress,airdrop_[i].airdropAddress);
        }
