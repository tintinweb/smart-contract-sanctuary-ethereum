...
// File contracts/RmblockcodePunksDNA.sol



pragma solidity ^0.8.18;

contract RmblockcodePunksDNA {
   string[] private _accessoriesType = [
    ...
    // Thins pseudo random is deterministic and should not be used in production
...
// File contracts/RmblockcodePunks.sol
...
contract RmblockcodePunks is ERC721, ERC721Enumerable, RmblockcodePunksDNA{
    ...
    constructor(uint256 _maxSupply) ERC721("RmblockcodePunks", "RMPKS"){
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current < maxSupply, "No RmblockcodePunks left :(");
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "Rmblockcode #',
                tokenId.toString(),
                '", "description": "Rmblockcode are randomized Avataaars stored on chain to teach DApp development on Platzi", "image": "',
                image,
                '"}'
            )
        );
