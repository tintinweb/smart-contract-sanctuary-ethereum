...
contract TheNFTWar is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public MAX_PER_Transaction_WL = 3; // maximum amount that user can mint per transaction for whitelisted members
    uint256 public MAX_PER_Wallet_WL = 3;
    ...
    function setWLCost(uint256 num) public onlyOwner {
        whiteListCost = num;

    }
    
    function setPublicCost(uint256 num) public onlyOwner {
        cost = num;
