...
contract DeQuestXIlluviumSummerChallenge is ERC721, ERC721Burnable {
    ...
    mapping(address => bool) nftMintedToAddress;
    ...
    constructor(
        ...
        backend = _backend;
        // _grantRole(DEFAULT_ADMIN_ROLE, _backend);
    }
    ...
    function safeMint(address to, bytes memory signature) public {
        ...
        if (message.recover(signature) != backend || nftMintedToAddress[to]) {
    ...
    //     backend = _backend;
    //     emit BackendChanged(oldBackend, _backend);
    // }
