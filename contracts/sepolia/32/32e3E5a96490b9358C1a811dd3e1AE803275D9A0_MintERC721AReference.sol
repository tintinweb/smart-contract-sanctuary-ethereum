...
/**
 * @title Mint ERC721A Function Reference
...
contract MintERC721AReference {
    ...
    function defaultMintFeePerToken() external view returns (uint256) {}
    ...
    function mintFeePerToken() external view returns (uint256) {}

    function mintPayoutAddress() external view returns (address) {}
    ...
    function mintAdminAddress() external view returns (address) {}
    ...
    function setMintFeePerToken(uint256 _mintFeePerToken) external {}
