...
contract ArtTokenVaultFactory is Ownable, Pausable, Whitelist {
    ...
    constructor(ILisaSettings _settings) {
        settings = _settings;
        _grantRole(WHITELISTER_ROLE, _settings.protocolAdmin());
    }
    ...
    ) external whenNotPaused onlyRole(PARTICIPANT_ROLE) {
