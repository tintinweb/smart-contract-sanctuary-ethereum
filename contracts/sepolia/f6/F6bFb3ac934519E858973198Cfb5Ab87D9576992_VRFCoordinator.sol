    ...
    IVRFMigration
{
        ...
        returns (uint256)
    {
        ...
        Callback memory callback = Callback({
            ...
            gasPrice: 100, // TODO: use return value from billing instead
            weiPerUnitLink: 100 // TODO: use return value from billing instead
        });
        ...
        // Retrieve sub and increment requests and pending fulfillments.
        Subscription storage sub = s_subscriptions[subID];
        sub.reqCount++;
        ...
        RandomnessLogPayload memory log = RandomnessLogPayload({
            ...
            callback: callback,
            arguments: arguments,
            costJuels: billSubscriberForCallback(callback), // throws on failure
            balance: sub.balance
        });
    ...
    function getFulfillmentFee(
        ...
        return
            uint256(
                calculateRequestPriceCallbackJuels(callbackGasLimit, arguments)
            );
    }
    ...
    Pausable
{
    ...
    mapping(address => mapping(uint256 => bool)) /* consumer */ /* subId */ /* subscribed? */
        private s_consumers;
    ...
    function billSubscriberForRequest(
        ...
        if (!s_consumers[requester][subID]) {
    ...
    function billSubscriberForCallback(
        ...
        if (!s_consumers[callback.requester][callback.subID]) {
            revert InvalidConsumer(callback.subID, callback.requester);
        }

        // Calculate the request price.
        uint256 costJuels = calculateRequestPriceCallbackJuels(
    ...
    function calculateRequestPriceCallbackJuels(
        ...
        uint256 gasCostPerByte = getReasonableGasPrice() * 16;
    ...
    function addConsumer(
        ...
        s_consumers[consumer][subId] = true;
