...
//   require(!completed, "Staking period is complete");
//   _;
// }
  ...
  // ( Make sure to add a `Stake(address,uint256)` event and emit it for the frontend <List/> display )
      function stake() public payable {
        // require(address(this).balance <= threshold, "too much");
        require(block.timestamp < deadline, "Cannot stake anymore, deadline passed");
  ...
  function withdraw() external payable notCompleted {
    require(balances[msg.sender] > 0, "u got no money");
    require(openForWithdraw== true, "cant do it");
