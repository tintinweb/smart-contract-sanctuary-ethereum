...
contract FundMe {
	...
	function fund() public payable {
		require(msg.value.getConversionRate(priceFeed) > MINIMUM_USD, "Didn't send enought!"); // 1e18 = 1 * 10 ** 18 == 1000000000000000000
...
library PriceConverter {
  ...
  function getPrice(AggregatorV3Interface priceFeed) internal  view returns(uint256) {
    ...
    return uint256(price * 1e10); // adding 10 more zeros on price to match up wei which as 18 and price comes with 8 decimals
  }
