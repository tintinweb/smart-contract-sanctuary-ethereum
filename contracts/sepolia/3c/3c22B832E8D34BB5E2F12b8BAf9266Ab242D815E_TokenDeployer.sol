...
contract YourSee20 is ERC20 {
    address public owner;
    modifier onlyOwner() {
        require(msg.sender == owner, "Caller is not the owner");
        _;
    }
    event TokenMinted(address indexed to, address indexed minter, uint256 amount);
    constructor(
        string memory name,
...
contract TokenDeployer {
    ...
    function deployToken(
        ...
        ERC20 newToken = new YourSee20(name, symbol, initialSupply, msg.sender);
