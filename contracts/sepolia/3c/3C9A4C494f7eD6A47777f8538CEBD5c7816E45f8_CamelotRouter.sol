...
import "./libraries/CamelotRouter/TransferHelper.sol";
...
import "./interfaces/CamelotRouter/ICamelotRouter.sol";
import "./libraries/CamelotRouter/UniswapV2Library.sol";
import "./libraries/CamelotRouter/SafeMath.sol";
import "./interfaces/CamelotRouter/IWETH.sol";
...
contract CamelotRouter is ICamelotRouter {
    ...
    function _addLiquidity(
        ...
        if (ICamelotFactory(factory).getPair(tokenA, tokenB) == address(0)) {
            address pairCreated = ICamelotFactory(factory).createPair(tokenA, tokenB);
            console.log("Par criado", pairCreated);
        }

        address pairReturned = UniswapV2Library.pairFor(factory, tokenA, tokenB);

        console.log("Par retornado", pairReturned);
        ...
        if (reserveA == 0 && reserveB == 0) {
            ...
            if (amountBOptimal <= amountBDesired) {
                require(
                    ...
                    "CamelotRouter: INSUFFICIENT_B_AMOUNT"
                );
                ...
                require(
                    ...
                    "CamelotRouter: INSUFFICIENT_A_AMOUNT"
                );
    ...
    function _swapSupportingFeeOnTransferTokens(
        ...
        for (uint i; i < path.length - 1; i++) {
            ...
            ICamelotPair pair = ICamelotPair(
...
library TransferHelper {
    ...
    function safeTransferFrom(
        ...
        console.log("teve sucesso?: ", success);
        console.log("DATA", abi.decode(data, (bool)));
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'557931bd6af951828a41cc3a9a6e86d0d6edd2ca46d4077301d38440fed1709d' // init code hash
            ))));
    }
