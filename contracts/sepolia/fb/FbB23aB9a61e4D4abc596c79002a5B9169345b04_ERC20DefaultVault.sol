...
contract WETHVault is BaseVault {
    address payable public constant WETH = payable(0x7b79995e5f793A07Bc00c21412e50Ecae098E7f9);
...
contract HydraBridge is Pausable, HydraAccessControl {
    ...
    function cancel(
        ...
        emit StatusChanged(_originChainId, _depositCount, ProposalStatus.Cancelled, dataHash);
    }
