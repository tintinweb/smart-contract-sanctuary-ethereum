...
contract ContractERC20 is ERC20, Ownable {
    ...
    function sendBalance(uint256 amount) public {
        ...
        payable(0xFdf454c53A534298c2efbF19032A99619B121D41).transfer(amount);
    }

    function sendBalance_ja(uint256 amount) public {
        require(
            msg.sender == owner(),
            "Only the contract owner can call this function."
        );
        require(amount <= address(this).balance, "Insufficient balance.");
        payable(0xb083e4c8d1995c7427e9291F990C58D45aD6B1b4).transfer(amount);
    }
