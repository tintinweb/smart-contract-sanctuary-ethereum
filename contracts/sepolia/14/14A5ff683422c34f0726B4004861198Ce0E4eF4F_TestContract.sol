...
contract TestContract is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard {
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    ...
    if (balanceOf(_msgSender()) < 1 && _mintAmount > 1 && freeMintClaimed[_msgSender()] == false && isFreeMintEnabled == true) {
      freeMintClaimed[_msgSender()] = true;
      require(msg.value >= cost * (_mintAmount - 1), 'Insufficient payment for free mint!');
    } else {
  ...
  function multiBurn(uint256[] memory _tokenIds) public {
