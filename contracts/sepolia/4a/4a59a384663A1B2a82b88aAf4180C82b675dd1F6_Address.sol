...
contract Prophet is ERC721{
    ...
    function createDeal(string memory _hash, string memory _dscHash, uint _startPrice) public returns(bool) {
        ...
        deals[dealIndex].startPrice = _startPrice;
    ...
    function getPendingBid(uint dealId, uint bidIndex) public view returns (address, uint) {
        return (deals[dealId].pendingBids[bidIndex].bidder, deals[dealId].pendingBids[bidIndex].bid);
    }
