...
contract StakingPlatform is IStakingPlatform, Ownable {
     ...
     * Cannot claim initial stakeholders deposit
     */
    function withdrawResidualBalanceStakeholders() external onlyOwner {
        uint balance = token.balanceOf(address(this));
        uint residualBalanceStakeholders = balance;
        require(residualBalanceStakeholders > 0, "No residual Balance on Stakeholders to withdraw");
