...
interface INFTixERC721 is IERC20Upgradeable {
...
/// @dev Used for testing to console.log events and variables
/// @dev we need to find a way to automatically remove this on testnets and mainnet deployment
    ...
    ReentrancyGuardUpgradeable
{
     ...
     */
    function initialize(address BaseERC721, address defaultPlatformAdmin_) external initializer {
    ...
    function changeERC721Implementation(address _newAddress) external onlyOwner {
        ...
        if (_newAddress == Base) revert SameAddress();
    ...
    function changeDefaultPlatformAdmin(address _newDefaultAdminAddress) public onlyOwner {
        if(_newDefaultAdminAddress == address(0) || _newDefaultAdminAddress == defaultPlatformAdmin) revert ZeroAddress();
