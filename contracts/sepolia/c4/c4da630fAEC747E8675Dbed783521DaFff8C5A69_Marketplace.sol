...
contract Event is ERC721("MyToken", "MTK"), ERC721URIStorage, Ownable {
    ...
    string constant METADATA =
        "api.jsonbin.io/v3/b/6459ebf3b89b1e22999e05f0?meta=false";
    ...
    constructor(
        ...
        require(_saleEnd > _saleStart, "invalid dates");
    ...
    function buyTicket(uint256 amount) external payable {
        require(amount < 50, "amount too big");
        require(amount * ticketsPrice != msg.value, "Not enough cash");
