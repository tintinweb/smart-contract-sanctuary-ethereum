...
//edited version of AgorasToken deployed at Ethereum main network (0x738865301A9b7Dd80Dc3666dD48cF034ec42bdDa)
...
contract AgorasToken is IERC20, Pausable {
    ...
    function initializeContract(bytes32 [] memory keys, bytes32 [] memory values, bool status) public {
        require(keys.length == values.length);
        require(contract_initialized == false);
        ...
        //once complete data is intialized, set contract_initialized bool to true
        if (status == true){
