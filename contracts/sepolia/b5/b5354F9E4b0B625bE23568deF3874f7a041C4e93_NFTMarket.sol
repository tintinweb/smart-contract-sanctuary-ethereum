...
contract NFTMarket is ReentrancyGuard, Ownable {
    ...
    uint256 public auctionFees = 1 * (10**10);
    ...
    function getFees() public view returns (uint256 _price) {
        return
            _price =
                (((uint256(auctionFees) * (10**10)) / getLatestEthPrice()) *
                    (10**18)) /
                10**10;
    }

    function changeMarketPlaceFees(uint256 _newFees) public onlyOwner {
        auctionFees = (_newFees * (10**10)) / (10**18);
    }
        ...
        returns (bool _response)
    {
        require(
            ...
            "you don't have enough balance to setSale"
        );
    ...
    function setSale(
        ...
        require(transferFees(getFees()), "Problem while Transferring the Fees");
        // if(_isCobatchable){
