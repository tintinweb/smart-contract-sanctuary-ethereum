...
contract kt is ERC721, ERC721URIStorage, Ownable, ERC2981 {
  using Strings for uint256;
  ...
  address public OPA = 0x845a1c9Fd01aB9c3FAF144deCd3d83e7d8FF3B52; //OPA is owner payout address set this depending on what they put
  uint256 public MAXSUPPLY = 10;
  uint256 public MINTPRICE = 18549000000000000; //mintprice in wei
  uint256 public immutable TWO_DOLLARS_ETH = 1080000000000000; // 0.00108 ETH in wei
  ...
  constructor(string memory baseTokenURI,  uint256 _maxMintPerBatch) 
  ERC721("kt", "KT") {
...
uint256 public constant royaltyBps = 200; // Set royalty percentage (e.g., 1000 = 10%)
