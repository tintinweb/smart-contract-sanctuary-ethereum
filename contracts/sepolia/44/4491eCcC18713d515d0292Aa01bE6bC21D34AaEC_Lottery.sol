...
contract Lottery is VRFConsumerBaseV2, Ownable {
    ...
    function fulfillRandomWords(
        ...
        random_number = _randomWords[0];
        winner = random_numbers[0] % no_of_players;
        winner_address = players[winner];
    }
    ...
    function revealWinner() public {
        (rn_status, random_numbers) = getRequestStatus(lastRequestId);
    }
