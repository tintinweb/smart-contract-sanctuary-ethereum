...
// File: contracts/SchedulerBase.sol
...
contract SchedulerBase {
    ...
    event JobCreated (bytes32 ID, address indexed Validator, 
    ...
    event JobDeleted (bytes32 ID, uint256 Timestamp); 
...
contract Scheduler is SchedulerBase {
    ...
    function deleteJob (bytes32 _jobID) external Auth (_jobID, true) { 
        ...
        emit JobDeleted (_jobID, block.timestamp);
    }
