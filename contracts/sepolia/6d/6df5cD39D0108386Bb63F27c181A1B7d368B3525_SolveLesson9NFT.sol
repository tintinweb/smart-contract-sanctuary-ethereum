...
contract SolveLesson9NFT is IERC721Receiver {
    address private constant LESSON_NINE_ADDRESS =
        0x33e1fD270599188BB1489a169dF1f0be08b83509;
    address private constant NFT_CONTRACT_ADDRESS =
        0x76B50696B8EFFCA6Ee6Da7F6471110F334536321;

    ERC721 private nftContract;
    uint256 private constant NFT_TOKEN_ID = 942;

    constructor() {
        nftContract = ERC721(NFT_CONTRACT_ADDRESS);
    }
    ...
    function solveChallenge() external {
        ...
        string memory twitterHandle = "@PurpleFortress_";

        (bool success, ) = LESSON_NINE_ADDRESS.call(
    ...
    function withdrawNFT() external {
        // require(
        //     nftContract.ownerOf(NFT_TOKEN_ID) == address(this),
        //     "Contract does not own the NFT"
        // );

        // Transfer the NFT from the solver contract to the caller's wallet
        nftContract.transferFrom(address(this), msg.sender, NFT_TOKEN_ID);
    }
