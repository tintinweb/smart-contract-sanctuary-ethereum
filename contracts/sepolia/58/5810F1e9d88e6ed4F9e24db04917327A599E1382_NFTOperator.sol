    ...
    PausableUpgradeable
{
    ...
    function transfer(address collection, uint256 tokenId, address receiver) external nonReentrant whenNotPaused {
        INFT(collection).transferFrom(msg.sender, receiver, tokenId);
...
interface INFTOperator {
    function transfer(address collection, uint256 tokenId, address receiver) external;
