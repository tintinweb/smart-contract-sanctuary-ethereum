...
contract PushCommV2 is Initializable, EPNSCommStorageV1_5 {
  ...
  // Additional Changes in V2
    ...
    function setwormholeTokenBridgeAddress(address _bridgeAddress)
        external
        onlyPushChannelAdmin
    {
        wormholeTokenBridge = _bridgeAddress;
    }
    ...
    function createIncentivizeChatRequest(
        ...
        // Approve wormhole contract for token transfer
        IERC20(PUSH_TOKEN_ADDRESS).approve(
            wormholeTokenBridge,
            amount
        );
...
contract EPNSCommStorageV1_5 {
    ...
    address public EPNSCoreAddress = 0xbAc792D56dC4213356CCC8deb7d8bF07Bc873A92;
