...
contract Pizza is Pausable, Blacklist, MinterControl, ReentrancyGuard {
    ...
    event OraclesAdded(address oraclesAddress);
    event OraclesRemoved();

    constructor() Blacklist("Pizza", "PIZZA") {}
    ...
    function transfer(
        ...
        require(!isBlackListed[msg.sender], "msg.sender is blacklisted!");
    ...
    function transferFrom(
        ...
        require(!isBlackListed[_from], "the approved is blacklisted!");
    ...
    function issue(uint256 amount) public onlyOwner {
        ...
        require(
            balanceOf(owner()) + amount > balanceOf(owner()),
    ...
    function setOracles(
        ...
        require(oraclesAddress != address(0));
        oracles = oraclesAddress;
        success = true;
        emit OraclesAdded(oraclesAddress);
    }

    function removeOracles() public onlyOwner returns (bool success) {
        oracles = address(0);
        success = true;
    }
}
...
contract Blacklist is Ownable, ERC20 {
    ...
    function getBlackListStatus(address _maker) public returns (bool) {
