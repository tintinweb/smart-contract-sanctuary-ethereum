...
contract Vault is
    AccessControl //[email protected] pausable and native eth recivde?
{
    ...
    event Withdrawn(address indexed _to, uint256 _amount); // [email protected] amount indexed

    constructor(IERC20 token, address _owner, address _operator) {
    ...
    function transferOwnership(
        ...
        return true; //  [email protected] return true
    }
    ...
    function transferFromVault(
        ...
        return success; // [email protected] all in one validiate
    }
}