...
contract TwoFactorAuth is VRFV2WrapperConsumerBase {
    ...
    event VerifyOTP(address indexed user, uint256 otp);
    ...
    function fulfillRandomWords(
        ...
        emit VerifyOTP(statuses[_requestId].user, _randomWords[0]);
    }

    function getStatus(uint256 _requestId) external view returns (Status memory) {
