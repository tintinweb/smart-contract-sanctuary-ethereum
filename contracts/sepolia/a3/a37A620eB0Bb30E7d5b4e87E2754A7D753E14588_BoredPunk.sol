...
contract BoredPunk is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 private rescure = 2000;
    bool public paused = true;
    bool public revealed = true;

    uint256 public salePrice = 0.0015 ether;
    uint256 public maxFree = 2;
    uint256 public maxTx = 10;
    uint256 public totalBored = 5555;
    ...
    constructor() ERC721A("BoredPunk", "BP") {
    ...
    function teamMint(uint256 _quantity) external onlyOwner {
        require(totalSupply() + _quantity <= totalBored, "Sold out");
        _safeMint(msg.sender, _quantity);
    }
    ...
    function setTotalBored(uint256 _totalBored) public onlyOwner {
        totalBored = _totalBored;
    }
        ...
        returns (uint256[] memory)
    {
        ...
        while (
            ownedTokenIndex < ownerTokenCount && currentTokenId <= totalBored
        ) {
