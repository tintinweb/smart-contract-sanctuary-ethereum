...
contract DOOM is ERC20, Ownable {
    uint256 private constant TOTAL_SUPPLY = 2_000_000 * 10**18;
    ...
    constructor(address _marketingAddress) ERC20("Doomer Dao Token", "DOOM") {
    ...
    function buyPresaleTokens(uint256 amount) external payable {
        ...
        require(msg.value == presalePrice * amount, "Incorrect payment amount");
