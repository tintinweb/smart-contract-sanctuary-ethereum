...
contract Staker {
  ...
  bool public openForWithdrawa;

  event Stake(address indexed sender, uint256 amount);

  modifier deadlineReached(bool requireDeadlinePassed) {
  ...
  function execute() public stakeNotCompleted {
    ...
    // (bool sent,) = exampleExternalContract.complete{value: address(this).balance}();
  ...
  function withdraw() public deadlineReached(true) stakeNotCompleted {
    require(openForWithdrawa, 'Stake is not completed yet');
