...
contract Diploma is Ownable, ERC721A_SBT {
    ...
    ) payable ERC721A_SBT(_name, _symbol) {
    ...
    function getIsEditor(address editorAddr) public view returns (bool) {
        return editors[editorAddr];
    }
    ...
    function addDiploma(
        ...
        address student
    ) public onlyEditors overrideGuard(diplomaHash, tokenUri) {
