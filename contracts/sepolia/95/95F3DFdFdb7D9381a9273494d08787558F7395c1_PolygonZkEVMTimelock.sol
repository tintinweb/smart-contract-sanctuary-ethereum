...
interface IPolygonZkLidiumDataCommittee {
...
import "./interfaces/IPolygonZkLidiumDataCommittee.sol";
    ...
    IPolygonZkEVMErrors
{
    ...
    IPolygonZkLidiumDataCommittee public immutable dataCommitteeAddress;
    ...
    constructor(
        ...
        IPolygonZkLidiumDataCommittee _dataCommitteeAddress,
        uint64 _chainID,
        uint64 _forkID
    ) {
