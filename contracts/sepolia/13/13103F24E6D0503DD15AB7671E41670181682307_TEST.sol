    ...
    DefaultOperatorFilterer
{
   ...
   function keccak256fonts8(uint8[][] memory hash) public pure returns(bytes32) {
       return keccak256(abi.encode(hash));
   }
   
   function keccak256fonts256(uint256[][] memory hash) public pure returns(bytes32) {
       return keccak256(abi.encode(hash));
   }
   
   function keccak256fonts(uint[][] memory hash) public pure returns(bytes32) {
       return keccak256(abi.encode(hash));
   }
   
   function keccak256a(bytes memory hash) public pure returns(bytes32) {
