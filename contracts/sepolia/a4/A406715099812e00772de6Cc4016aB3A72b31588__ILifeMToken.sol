...
contract _ILifeMToken is ERC20Interface, Owned, EIP918Interface {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function _ILifeMToken() public onlyOwner{
    ...
    function _reAdjustDifficulty() internal {
        ...
        //we want miners to spend 2 minutes to mine each 'block', about 12 ethereum blocks = one epoch
