...
contract FurionLeverage is OwnableUpgradeable {
    ...
    function _toFURAmount(
        ...
        furAmount = (_usdValue * 1e24) / _furPrice();
    }
    ...
    function _furPrice() internal view returns (uint256 furPrice) {
        ...
        (uint256 usdtReserve, uint256 furReserve,) = IFurionSwapPair(0xe78b66bD29494e81959EAdda0A03da3198789d67).getReserves();
        furPrice = furReserve / usdtReserve;
    }
