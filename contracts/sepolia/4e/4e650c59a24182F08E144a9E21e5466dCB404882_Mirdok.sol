...
contract Mirdok is ERC721, ERC721URIStorage, Ownable, ERC2981 {
  using Strings for uint256;

  uint256 private _tokenIdCounter = 23;
  ...
  uint256 public MINTPRICE = 20000000000000000; //mintprice in wei
...
function royaltyInfo(uint256 tokenId, uint256 salePrice) public view override returns (address, uint256) {
    uint256 royaltyAmount = (salePrice * royaltyBps) / 456;
