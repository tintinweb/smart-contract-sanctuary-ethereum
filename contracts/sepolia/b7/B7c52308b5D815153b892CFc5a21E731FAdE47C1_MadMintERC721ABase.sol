...
import {BaseConfig, MadMintStorage} from "../libraries/MadMintStorage.sol";
...
contract MadMintERC721ABase is MadMintERC721AUpgradeable, IERC2981Upgradeable {
    ...
    function initialize(
        ...
        MadMintStorage.state().cfg = _config;
        ...
        if (_config.publicSaleStartTime > 0 && _config.publicSaleEndTime == 0) {
            MadMintStorage.state().cfg.publicSaleEndTime =
        ...
        if (_config.publicSaleEndTime > 0 && _config.publicSaleStartTime == 0) {
            MadMintStorage.state().cfg.publicSaleStartTime = uint32(
                block.timestamp
            );
        }
        ...
        if (_config.presaleStartTime > 0 && _config.presaleEndTime == 0) {
            MadMintStorage.state().cfg.presaleEndTime =
        ...
        if (_config.presaleEndTime > 0 && _config.presaleStartTime == 0) {
            MadMintStorage.state().cfg.presaleStartTime = uint32(
                block.timestamp
            );
        }
    }
    ...
    view
    virtual
    override(MadMintERC721AUpgradeable, IERC165Upgradeable)
    returns (bool)
    {
        return MadMintERC721AUpgradeable.supportsInterface(interfaceId);
    }
    ...
    function setBaseURI(string calldata _newBaseURI) external onlyOwner {
        ...
        MadMintStorage.state().cfg.uriBase = _newBaseURI;
    }
    ...
    function freezeMetadata() external onlyOwner {
        MadMintStorage.state().advCfg.metadataFrozen = true;
    }
    ...
    function setPublicSaleState(bool _saleActiveState) external onlyOwner {
        MadMintStorage.state().cfg.publicSaleActive = _saleActiveState;
    }
    ...
    function setPublicPrice(uint32 _publicPrice) external onlyOwner {
        MadMintStorage.state().cfg.publicPrice = _publicPrice;
    }
    ...
    function setPublicMintsAllowedPerAddress(
        ...
        MadMintStorage.state().cfg.publicMintsAllowedPerAddress = _mintsAllowed;
    }
    ...
    function setPublicSaleStartTime(
        ...
        MadMintStorage.state().cfg.publicSaleStartTime = _publicSaleStartTime;
    }
    ...
    function setPublicSaleEndTime(
        ...
        MadMintStorage.state().cfg.publicSaleEndTime = _publicSaleEndTime;
    }
    ...
    function setUsePublicSaleTimes(
        ...
        MadMintStorage.state().cfg.usePublicSaleTimes = _usePublicSaleTimes;
    }
