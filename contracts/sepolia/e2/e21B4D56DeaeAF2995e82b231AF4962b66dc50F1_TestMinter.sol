...
import {OpenExchangeToken} from "../../src/OpenExchangeToken.sol";

/**
 * @notice Test minter contract used for testing. Able to mint infinite unlocked OX tokens.
 */
contract TestMinter {
    OpenExchangeToken public oxToken;

    constructor(address _oxToken) {
        oxToken = OpenExchangeToken(_oxToken);
    }

    function mint(address to, uint256 amount) external {
        oxToken.mint(to, amount);
    }
}
