...
contract MetalordzSilver is ERC20, Authorizable {
    string private TOKEN_NAME = "Metalordz Silver";
    string private TOKEN_SYMBOL = "SILVER";

    event Minted(address owner, uint256 SilverAmt);
    event Burned(address owner, uint256 SilverAmt);
