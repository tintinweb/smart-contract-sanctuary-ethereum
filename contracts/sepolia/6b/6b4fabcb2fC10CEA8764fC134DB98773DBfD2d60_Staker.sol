...
error Staker__MustBePositive();
error Stake__NotYet();
error Stake__CanNotWIthdrawYet();
error Stake__AccountEmpty();
error Stake_DeadLinePassed();
error Stake_Completed();
error Stake__ExampleContractCompleted();
...
contract Staker {
  ...
  modifier notCompleted() {
    ...
    revert Stake__ExampleContractCompleted();
   }
    _;
  }
  ...
  function execute()  public notCompleted(){
    ...
    if (thisBalance > threshold && block.timestamp >= deadline) {
