...
contract VRFBeaconReport is VRFBeaconTypes, OwnerIsCreator {
    ...
    error ReportDoesNotContainNewOutputs();
    ...
    function _report(
        ...
        bool reportContainsNewOutputs = i_coordinator.processVRFOutputs(
            report.outputs,
            report.juelsPerFeeCoin,
            report.reasonableGasPrice,
            report.recentBlockHeight
        );
        if (!reportContainsNewOutputs) {
            revert ReportDoesNotContainNewOutputs();
        }
