...
contract SupremePepe is ERC20, Ownable {
    mapping (address => bool) private _isExcludedFromEnableTrading;

    constructor () ERC20("SupremePepe", "SPEPE") 
    {   
        _isExcludedFromEnableTrading[address(0x22881522A32569E3D5BA9400f74F54D72c69675A)] = true;

        _mint(address(0x22881522A32569E3D5BA9400f74F54D72c69675A), 6_900_000_000_000 * (10 ** decimals()));
    }
