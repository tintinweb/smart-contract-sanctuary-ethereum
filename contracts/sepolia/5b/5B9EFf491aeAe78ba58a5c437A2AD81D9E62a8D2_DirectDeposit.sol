...
*/
    ...
    address public  BOB = 0x6B175474E89094C44Da98b954EedeAC495271d0F;
    ...
    */
    function directDeposit(
        ...
        bob.transferAndCall(
            address(queue),
            amount,
            abi.encode(fallbackReceiver, zkAddress)
        );
    ...
    */
    ...
    function swapExactInputSingle(uint256 amountIn) public returns (uint256 amountOut) {
        ...
        TransferHelper.safeApprove(BOB, address(swapRouter), amountIn);
