...
contract WARLockerGMD is Ownable, Pausable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    uint256 public test8G;

    IERC20 public warToken;
    uint256 public vestingDuration = 365 days; // 1 year
    // uint256 public vestingCliff = 1685808000;
    uint256 public vestingCliff = 1682969350;
