...
contract MetadataProvider is AccessControlled, IMetadataProvider {
    ...
    function tokenURI(uint256 tokenId, address replicantContract, bool validity, bytes memory)
        public
        view
        returns (string memory)
    {
        IERC721Metadata replicant = IERC721Metadata(replicantContract);
        string memory name = replicant.name();
