...
contract vaultFactory is OwnableUpgradeable {
    ...
    function initialize(address _Dividend, address _NFT) external initializer {
        require(_Dividend != address(0), "DZA"); //Dividend Zero Address
        require(_NFT != address(0), "NZA"); //Dividend Zero Address
    ...
    function createDividend(
        ...
        require(DividendAddress[_tokenId] == address(0), "DAE"); //Dividend address exists for this Category address and token ID
        ...
        IDividend(Dividend).initialize(_tokenId, _dividendToken, NFT, _creator);
...
interface IXegaraNFT {
    ...
    function safeBurn(address from, uint256 id, uint256 amount) external;
