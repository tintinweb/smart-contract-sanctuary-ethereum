...
contract Loris is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string private constant _name = "Loris";
    string private constant _symbol = "LORIS";
    ...
    uint256 public maxTrxnAmount = _totalSupply.mul(15).div(1000);
    uint256 public maxWalletSize = _totalSupply.mul(15).div(1000);
    bool private inSwap;
    ...
    function setBuyCommisioPercent(uint32 buyTaxPercent) external onlyOwner {
        require(buyTaxPercent <= 100000, "Buy tax restricted by 10%");
        buyTax = buyTaxPercent;
    }

    function setSellCommisioPercent(uint32 sellTaxPercent) external onlyOwner {
        require(sellTaxPercent <= 100000, "Sell tax restricted by 10%");
