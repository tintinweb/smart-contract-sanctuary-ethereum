...
contract DEX {
     ...
     */
    event EthToTokenSwap(address, string, uint, uint);

    /**
     * @notice Emitted when tokenToEth() swap transacted
     */
    event TokenToEthSwap(address, string, uint, uint);
    ...
    function price(
        ...
        return (xInputWithFee * yReserves) / ((xReserves * 1000) + xInputWithFee);
    }
    ...
    function deposit() public payable returns (uint256 tokensDeposited) {
        ...
        tokensDeposited = (token.balanceOf(address(this)) * msg.value) / (address(this).balance - msg.value);
