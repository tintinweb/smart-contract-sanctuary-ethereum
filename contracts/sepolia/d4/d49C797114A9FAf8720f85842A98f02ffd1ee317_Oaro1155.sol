 ...
 */
abstract contract OperatorFilterer is OwnableUpgradeable{
...
// File: Collection/20230601-1155.sol
...
contract Oaro1155 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, DefaultOperatorFilterer, ERC2981 {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }

    function initialize(string memory contractUri) initializer public {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Upgradeable, ERC2981) returns (bool) {
        // InterfaceId of ERC1155
