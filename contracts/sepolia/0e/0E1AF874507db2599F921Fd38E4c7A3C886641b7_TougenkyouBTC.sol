...
import "./IERC4906.sol";
import { ERC721BridgeBRCTokenMapping } from "ERC721BridgeBRC/src/ERC721BridgeBRCTokenMapping.sol";
...
contract TougenkyouBTC is ERC721A, IERC4906, ERC721AQueryable, AccessControl, ERC2981, ERC721BridgeBRCTokenMapping {
    ...
    string private _baseMetadataURI = "ar://DO3K5VGKt20yIpJlDVe4T-ZENylKtdoh6R8WdiJKvmE/";
    ...
    constructor(bool _callerIsUserFlg, address _originalContract) ERC721A("TougenkyouBTC", "momoBTC") {
        ...
        _registOriginalContractAddress(_originalContract);
        // BRC-721E Bridge Contract Address
        _registBridgeContractAddress(0x000000000000000000000000000000000000dEaD);
    ...
    function bridge(address from, uint256 tokenId, string memory _btcAddress) external virtual {
        require(bridgeContract != address(0), "Bridge Contract is Zero Address");
        ERC721A.safeTransferFrom(from, bridgeContract, tokenId, bytes(_btcAddress));
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override(ERC721A, IERC721A) returns (string memory) {
        ...
        if (bytes(_metadataURI[tokenId]).length != 0) {
            ...
            return string(abi.encodePacked(_baseMetadataURI, _toString(originalTokenId(tokenId)), BASE_EXTENSION));
        }
    }
    ...
    function setBaseURI(string memory metadata) external onlyRole(DEFAULT_ADMIN_ROLE) {
