...
contract CoinFlip is VRFV2WrapperConsumerBase {
    ...
    address constant vrfWrapperAddress = 0xc4950B7eaa1f7946F991D08575be9B1E00751f25;
...
interface CoinFlipTokenInterface {
...
import "./CoinFlipTokenInterface.sol";
...
abstract contract VRFV2WrapperConsumerBase {
  CoinFlipTokenInterface internal immutable LINK;
  ...
  constructor(address _link, address _vrfV2Wrapper) {
    LINK = CoinFlipTokenInterface(_link);
