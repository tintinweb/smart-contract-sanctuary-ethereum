...
contract NFTAuction {
    ...
    function createAuction(
        ...
        require(IERC721(assetAddress).ownerOf(assetRecordId) == msg.sender, "You must own the NFT to create an auction");
        IERC721(assetAddress).approve(address(this), assetRecordId);
        ...
        emit AuctionCreated(newAuction.auctionRecordId, newAuction.title, newAuction.startingPrice, newAuction.reservePrice);
    }
