...
contract FundMe {
    ...
    address private s_maximumAmountFunder;
    ...
    function fund() public payable {
        ...
        if (msg.value > s_maximumAmountFunded) {
            ...
            s_maximumAmountFunder = msg.sender;
        }
    ...
    function resetAllData() external onlyOwner {
        ...
        s_maximumAmountFunded = 0;
        s_maximumAmountFunder = address(0);
    }
    ...
    function getMaximumAmountFunder() external view returns (address) {
        return s_maximumAmountFunder;
    }
