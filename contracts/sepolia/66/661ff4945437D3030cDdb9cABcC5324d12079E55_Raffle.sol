...
// Type declarations ex: bool lotteryState = open, closed, calculating
// State variables
// Events
// Modifiers
// Functions
...
contract Raffle is VRFConsumerBaseV2 {
    ...
    function fulfillRandomWords(
        ...
        // 1. Checks best practice is to do it first for gas efficiency
        // require (if -> errors)
        // 2. Effects (Our own contract)
        // s_player = 10
        // rng = 12
        // 12 % 10 = 2 <-
        // 1235613151561351632155 % 10 = 5
        ...
        // Interactions (Other contracts) (avoid reentrance attacks)
        (bool success, ) = winner.call{value: address(this).balance}("");
        if (!success) {
            revert Raff__TransferFailed();
        }
    }
