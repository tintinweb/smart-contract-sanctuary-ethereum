...
/**
 * @title An Sepolia Ethereum Raffle contract
 * @author Mathew Kennedy
 * @notice This contract creates a secure, decentralised smart contract
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        i_interval = interval;
        // the above line is equivalent to: s_raffleState = RaffleState(0);
        // here we're using the uint256 for the given state but casting it to a RaffleState enum
    }
    ...
    function enterRaffle() public payable {
        ...
        // type cast the non payable address as a payable address so winner can be paid
