...
contract Vault is Ownable, AccessControlEnumerable {
	...
	modifier onlyWithdrawer() {
		require(
			hasRole(WITHDRAWER_ROLE, msg.sender) || msg.sender == owner(),
	...
	function setMaxWithdrawAmount(uint _maxWithdrawAmount) public onlyOwner {
	...
	function withdraw(uint256 _amount, address _to) external onlyWithdrawer {
		require(withdrawEnabled, 'Vault: Withdraw is not enabled');
		require(
