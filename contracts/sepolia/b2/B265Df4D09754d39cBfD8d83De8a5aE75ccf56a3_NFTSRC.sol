...
contract NFTSRC is ERC721AUpgradeable, ERC2981Upgradeable, OwnableUpgradeable, PausableUpgradeable, DefaultOperatorFilterer {
...
string public baseUri;
       ...
       function initialize(string memory __name,
       string memory __symbol,
       string memory __contractUri,
       string memory _baseUri,
       address recipient,
       uint96 value) initializerERC721A initializer public {
       _name = __name;
       _symbol = __symbol;
    ...
    function name() public view override(ERC721AUpgradeable) returns (string memory) {
       return _name;
    }
    
    /// @notice The symbol of the ERC721 token.
    function symbol() public view override(ERC721AUpgradeable) returns (string memory) {
       return _symbol;
    }
    ...
    function setApprovalForAll(
       address operator,
       bool approved
    ) public override(ERC721AUpgradeable) onlyAllowedOperatorApproval(operator) whenNotPaused {
    ...
    function transferFrom(
       ...
       address to,
       uint256 tokenId
    ) public payable override(ERC721AUpgradeable) onlyAllowedOperator(from) whenNotPaused {
    ...
    function supportsInterface(
       bytes4 interfaceId
    ) public view override(ERC721AUpgradeable, ERC2981Upgradeable) returns (bool) {
