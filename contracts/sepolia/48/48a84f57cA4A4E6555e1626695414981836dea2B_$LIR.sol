...
contract $LIR is ERC20, Ownable { 
    ...
    constructor() ERC20("Let It Ride", "$LIR") { 

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008 //Sepolia Router address
        );
        ...
        maxTransactionAmount = 44444444 * 1e18; // .5%
        maxWallet = 177777777 * 1e18; // 2% 
        swapTokensAtAmount = (totalSupply * 5) / 100000000;  

        teamWallet = address(0x4Dd211DB87B92B4796cc3D86C13bEEc0e928D184);
        marketingWallet = address(0xCaEB6db42317B88e189f8d87C500cbd927d117d6);
