...
//------------------------------------------CONSTRUCTOR----------------------------------------------------//
    constructor(string memory tokenName, string memory tokenSymbol, uint256 maxSupply) ERC20(tokenName, tokenSymbol) {
    _name = tokenName;
    _symbol = tokenSymbol;
...
//------------------------------------TOKEN STANDARD FUNCTIONS----------------------------------------------//    
    ...
    function setPrice (uint256 initialPrice) public onlyMinter{
    ...
    function storageDoc(string memory _docHash) public{
      ...
      DocsMapping[msg.sender] = newDocStorage; 
    } 

    function getDocStored(uint256 _index) public view returns(string memory) {
      return DocsMapping[msg.sender].docsHash[_index];
    }
