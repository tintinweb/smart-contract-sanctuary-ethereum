...
contract WWFINALTESTRUN2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public finalMaxSupply = 100000000000;
  ...
  constructor() ERC721("WWFINALTESTRUN3", "WWFTR3") {
    setHiddenMetadataUri("ipfs://QmcWWyHirU1QzpA8Phi7rqTfLEDVLuAdp76hK87GbXUoDa/hidden.json");
  }
