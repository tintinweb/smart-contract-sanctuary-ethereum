...
contract DEEPW3B_2 is IERC20 {
    ...
    string private constant _symbol = "DW3B_2";
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0x9a65278dC3Faa9d88299A7d5c7ba27ab63Bd850b),
            development: payable(0x9a65278dC3Faa9d88299A7d5c7ba27ab63Bd850b)
        });    
    bool inSwap;
    ...
    constructor() payable {
        ...
        if (block.chainid == 56) {
            ...
            dexRouter = IRouter02(0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008);            
        } else {
            revert();
        }
        ...
        _isExcludedFromFees[0x9a65278dC3Faa9d88299A7d5c7ba27ab63Bd850b] = true;
