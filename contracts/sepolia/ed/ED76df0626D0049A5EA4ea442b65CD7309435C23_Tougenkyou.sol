...
contract Tougenkyou is ERC721A, ERC721AQueryable, ERC721ABurnable, ERC2981, Ownable, Pausable, DefaultOperatorFilterer {
    ...
    constructor(bool mintERC2309Flg) ERC721A("Tougenkyou", "MOMO") {
        ...
        if (mintERC2309Flg == true) {
            _mintERC2309(0x1d5E687dB64D34236A5ad6Ff54d44f993C6ca49C, 198);
    ...
    function preMint(uint256 _mintAmount, uint256 _presaleMax, bytes32[] calldata _merkleProof, TicketID ticket) external payable whenMintable callerIsUser whenNotPaused {
