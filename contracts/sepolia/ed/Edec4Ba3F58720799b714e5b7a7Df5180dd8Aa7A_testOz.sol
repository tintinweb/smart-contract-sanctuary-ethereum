...
contract testOz is ERC721, Ownable {
    ...
    constructor() ERC721("testOz", "to") {}
    
    function mint(uint256 quantity) external {
        require(quantity > 0, "Number of tokens must be greater than zero");
        require(
            quantity + getOwnedTokenCount(msg.sender) <= MAX_MINTS,
            "Exceeded the limit"
        );
         require(
