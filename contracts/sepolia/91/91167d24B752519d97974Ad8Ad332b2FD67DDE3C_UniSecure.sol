...
contract UniSecure is ChainlinkClient, ConfirmedOwner {
    ...
    constructor() ConfirmedOwner(msg.sender) {
        ...
        superApi = "https://super-api-production.up.railway.app/superapi";
    }
    ...
    function requestData(
        ...
        // requestsByRecipient[receiver].push(DataRequest(sender, msg.sender, _data));
