 ...
 */
contract HotWalletProxy is AccessControlEnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address adminAddress, address operatorAddress) public initializer {
        __Ownable_init();
    ...
    function setHotWallet(
        ...
        require(
            coldWalletToHotWallet[coldWalletAddress].walletAddress != hotWalletAddress,
            "Already linked"
        );
        ...
        if (hotWalletAddress != address(0)) {
            require(
                hotWalletToColdWallets[hotWalletAddress].length < MAX_HOT_WALLET_COUNT,
