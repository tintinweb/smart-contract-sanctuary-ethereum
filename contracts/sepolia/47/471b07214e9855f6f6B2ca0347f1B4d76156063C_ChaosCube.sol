...
abstract contract ERC721ChaosCoinClub is ERC721, ContextMixin, NativeMetaTransaction,  PullPayment, Ownable {
    ...
    /// @notice The price to create new NFTs
    uint256 _mintingPrice;
    /// @notice The currency to create new NFTs
    ERC20Spendable _mintingCurrency;
    /// @dev The serial number of the next NFT to create
    ...
    constructor(
        ...
        _mintingPrice = mintingFromERC20Price;
    ...
    /**
     * @notice The price to create nft in other tokens
    ...
    function mintWithErc20() external {
        ...
        require(mintingWithChaos == true, "Minting with custom token is Not Enabled");
        require(_mintingPrice > 0, "Minting with custom token is Not Enabled");
        require(_mintingCurrency.balanceOf(address(msg.sender)) >= _mintingPrice, "ERC20 Balance is not sufficient to mint an NFT.");
    ...
    function mintWithErc20(uint256 _count) external {
        // Take payment for this service
        require(mintingWithChaos == true, "Minting with custom token is Not Enabled");
        require(_mintingPrice > 0, "Minting with custom token is Not Enabled");


        uint256 finalPrice = _count * (_mintingPrice * (1 + (totalSupply() / nftsPerTier)));
        ...
        require(_mintingCurrency.balanceOf(address(msg.sender)) >= finalPrice, "ERC20 Balance is not sufficient to mint this number of NFTs.");
        
        _mintingCurrency.spend(msg.sender, finalPrice);
...
contract ChaosCube is ERC721ChaosCoinClub {
    ...
    ERC721ChaosCoinClub("Chaos Cube", "CHAOSCUBE", address(0x36E569119af6735a6Fe4B0F9e9B8A250D7775275), address(0x36E569119af6735a6Fe4B0F9e9B8A250D7775275), 
25000000000000000, 5000000000000000, 1000, 10, 4, 20, 100, 25000000000000000000){}
