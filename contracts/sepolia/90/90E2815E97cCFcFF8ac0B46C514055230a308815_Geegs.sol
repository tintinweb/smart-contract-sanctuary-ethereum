...
contract Geegs is ERC721A, Ownable, ReentrancyGuard, EIP712 {
    ...
    constructor(
        ...
        ERC721A("Employment Contract", "GEEGS")
    ...
    function approve(
        address operator,
        uint256 tokenId
    ) public payable override(ERC721A) transferrable(tokenId) {
    ...
    function transferFrom(
        ...
        if (sbt[tokenId]) transferAllowance[tokenId]--;
