...
contract ArtistInAPostTruthWorld is ERC721A, ERC2981, IAutographNFT {
    ...
    uint256 private constant _mintStart = 1685700000; // June 2nd 12PM UTC
    uint256 private constant _mintEnd = 1685959200; // June 5th 12PM UTC

    string private constant _signedImage = "ipfs://QmdrhRaegFfTxJjd5ydRibH29d7ybqkieaSUdH3yFMwkRe";
    string private constant _unsignedImage = "ipfs://Qmds9JZkRq3R9xtuM7i2rLtFvEqe8HBEeSKU35KRbDVbG5";
    string private constant _unsignedWebapp = "https://ipfs.idea.tf/ipfs/QmaTeF1gqG9C8mCc2wn1Q7Aq7nr3Li9hfQGRVT5zteP85o/";
    ...
    function sign(uint256 _tokenId) external onlyAPI {
        ...
        string memory uri = OnChainMetadata.signedTokenURI(
            _tokenId,
            block.timestamp,
            _signedImage
        );
        emit MetadataUpdate(_tokenId);
        emit Autograph(_tokenId);
        emit PermanentURI(uri, _tokenId);
    }
...
interface IAutographNFT {
    ...
    event Autograph(uint256 indexed tokenId);
