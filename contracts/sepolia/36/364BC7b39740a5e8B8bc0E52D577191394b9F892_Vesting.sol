...
contract Vesting is Ownable, ReentrancyGuard {
    ...
    function getClaim(
        ...
        if (schedule.multipleRemainingSet > 0) {
            ...
            if (schedule.lastRevoked > 0) {
                ...
                if (weeksPassed > 1) {
                    console.log("inside weekspassed", weeksPassed);
                    schedule.multipleRemainingSet = weeksPassed - 1;
                    console.log(
                        "multipleRemainingSet",
                        schedule.multipleRemainingSet
                    );
                    updateSchedule(_beneficiary, schedule);
                }
            }
    ...
    function claim(
        ...
        // bytes32 _leaf = keccak256(abi.encodePacked(beneficiary, amount));
        // require(
