...
mapping(string=> string) public Buscar_Contrato;

//String memory
//storage  
  function Add_Contrato(string memory _CONTRATO, string memory _RAZON_SOCIAL ,string memory _CAMPO, string memory _DEPTO, string memory _MUNICIPIO, string memory _APLICA_REVERSION, uint256 _PORCENTA_LEY_REGALIA) public 
  {
