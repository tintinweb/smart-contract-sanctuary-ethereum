...
error SalaryPayments__IsNotOpen();
    ...
    ReentrancyGuard
{
    ...
    modifier checkIfContractIsOpen() {
        if (statusSalaryPayment != salaryPaymentStatus.OPEN) {
            revert SalaryPayments__IsNotOpen();
        }
        _;
    }
    ...
    function withdrawEth(uint _balance) public onlyOwner nonReentrant {
    ...
    function fundEthToContract() public payable nonReentrant {}

    function manualPayment() public onlyOwner nonReentrant {
    ...
    function updateTimeInterval(
        uint _newTimeInterval
    ) public onlyOwner checkIfContractIsOpen {
