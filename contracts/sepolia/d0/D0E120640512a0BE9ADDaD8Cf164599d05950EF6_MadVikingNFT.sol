...
contract MadVikingNFT is MinteebleERC1155 {
    constructor() MinteebleERC1155("MadVikingNFT", "MVN", "_") {
        addId(0); // Obsidian Treasure Chest NFT: 180% extra GEMS
        addId(1); // Diamond Treasure Chest NFT: 120% extra GEMS.
        addId(2); // Platinum Treasure Chest NFT: 70% extra GEMS.
        addId(3); // Gold Treasure Chest NFT: 40% extra GEMS.
        addId(4); // Silver Treasure Chest NFT: 30% extra GEMS.
        addId(5); // Bronze Treasure Chest NFT: 20% extra GEMS.
        addId(6); // Dainsleif: The Merciless NFT: 5% extra GEMS.
        addId(7); // Draupnir: The Dripper NFT: 5% extra GEMS.
        addId(8); // Svalin: The Guardian NFT: 5% extra GEMS.
        addId(9); // Surtur's Sword: The World Cleaver NFT: 5% extra GEMS.
        addId(10); // Thor's Hammer: Mjölnir, The Thunderer NFT: 5% extra GEMS.
        addId(11); // Odin's Shield - Version A NFT: 10% extra GEMS.
        addId(12); // Odin's Shield - Version B NFT: 10% extra GEMS.
        addId(13); // Odin's Shield - Version C NFT: 10% extra GEMS.
        addId(14); // Odin's Shield - Version D NFT: 10% extra GEMS.
        addId(15); // Odin's Shield - Version E NFT: 10% extra GEMS.
        addId(16); // Odin's Spear - Gungnir NFT: 40% extra GEMS.
        addId(17); // Odin's Throne - Hlidskjalf NFT: 50% extra GEMS.
        addId(18); // Laevateinn - The Silent Betrayer NFT: 30% extra GEMS.
        addId(19); // Járngreipr - The Iron Crusher NFT: 35% extra GEMS.
