...
contract veBALDeploymentCoordinator is ReentrancyGuard {
    ...
    address public lmCommitteeMultisig = 0x235A2ac113014F9dcb8aBA6577F20290832dDEFd;
    ...
    address public veBALGaugeRecipient = 0x235A2ac113014F9dcb8aBA6577F20290832dDEFd;
    address public polygonGaugeRecipient = 0x235A2ac113014F9dcb8aBA6577F20290832dDEFd;
    address public arbitrumGaugeRecipient = 0x235A2ac113014F9dcb8aBA6577F20290832dDEFd;
    ...
    function getAuthorizer() public view returns (ICurrentAuthorizer) {
        return ICurrentAuthorizer(address(_xaveAuthorizer));
    }
    ...
    function performFirstStage() external nonReentrant {
        ...
        // which automate the distribution of BAL to BPT stakers on other networks and veBAL holders.
        {
            ...
            _createSingleRecipientGauge(
                ...
                "Liquidity Mining Committee XAV Holder",
                lmCommitteeMultisig
            );
            ...
            _createSingleRecipientGauge(
                ...
                "Temporary veBAL Liquidity Mining XAV Holder",
                veBALGaugeRecipient
            );
            ...
            _createSingleRecipientGauge(
                ...
                "Temporary Polygon Liquidity Mining XAV Holder",
                polygonGaugeRecipient
            );
            // Temporary
            _createSingleRecipientGauge(
                IGaugeAdder.GaugeType.Arbitrum,
                "Temporary Arbitrum Liquidity Mining XAV Holder",
    ...
    function performSecondStage() external nonReentrant {
        ...
        address payable[1] memory initialPools = [
            0xf7a7E1F48FA43cb7919Ff4Eb362c5bE78092dF4A // sepolia mock weighted pool
        ];
    ...
    function performThirdStage() external nonReentrant {
        ...
        _setGaugeTypeWeight(IGaugeAdder.GaugeType.Arbitrum, ARBITRUM_WEIGHT); // @todo remove 
