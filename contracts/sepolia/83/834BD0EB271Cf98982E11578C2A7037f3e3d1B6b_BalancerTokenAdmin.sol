...
abstract contract SingletonAuthentication is Authentication {
    ...
    constructor(IVault vault, IAuthorizer xaveAuthorizer) Authentication(bytes32(uint256(address(this)))) {
        _vault = vault;
...
contract BalancerTokenAdmin is IBalancerTokenAdmin, SingletonAuthentication, ReentrancyGuard {
    ...
    constructor(
        ...
        IAuthorizer xaveAuthorizer
    ) SingletonAuthentication(vault, xaveAuthorizer) {
