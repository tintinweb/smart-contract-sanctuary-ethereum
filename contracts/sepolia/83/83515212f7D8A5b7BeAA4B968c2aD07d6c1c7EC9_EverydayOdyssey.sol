...
contract EverydayOdyssey is WildNFT, DateTime {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return metadataContract.generateTokenURI(tokenId, baseURI);
    }
...
contract EverydayOdysseyMetadata is DateTime {
    ...
    function generateTokenURI(uint256 tokenId, string memory baseURI) public view returns (string memory uri) {
        ...
        if (bytes(baseURI).length > 0) {
            if (animationMapping[tokenId] == true) {
                ...
                if (tokenId <= 20) {
                    ...
                    animationUrl = string(abi.encodePacked(baseURI, 'viewer/index.html?tokenId=', stringTokenId));
                }
                imgUrl = string(abi.encodePacked(baseURI, stringTokenId, fileExt));
            }
            else {
...

            {
                ...
                attributesStr = string(abi.encodePacked(',"attributes":[{"trait_type":"Name","value":"', everydayname, '"}, {"trait_type": "Miniseries", "value":"', miniseries, '"}, {"trait_type": "Date", "value":"', date, '"}, {"trait_type": "Number", "value":"', Strings.toString(getEverydayNumber(tokenId)), '"}]'));
            }
        }
