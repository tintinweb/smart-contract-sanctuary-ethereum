...
contract VaultCore is ERC721Holder, Pausable, AdminControl {
    uint8 public constant VERSION = 1;
    // bytes32("joiivault")
    bytes32 public constant contractType =
        0x6a6f69697661756c740000000000000000000000000000000000000000000000;
    ...
    function transfer(
        ...
        address _tokenAddress,
        address _to
    ) external whenNotPaused adminRequired {
        address _tokenOwner = _ownerOf(_tokenId, _tokenAddress);
        require(
            _approvedForEscrow(
                _tokenOwner,
                _tokenId,
        ...
        _transferFromTo(_tokenOwner, _to, _tokenId, _tokenAddress);
    }
}