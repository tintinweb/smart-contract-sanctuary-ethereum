...
import "./LisaCrowdsaleSimple.sol";
...
contract LisaCrowdsaleProportional is Initializable, LisaCrowdsaleBase {
    ...
    bool private saleProceedsClaimed = false;
    ...
    function buyTokens(
        uint256 amountBT
    ) external override nonReentrant onlyRole(PARTICIPANT_ROLE) {
        ...
        emit TokensReserved(address(this), _msgSender(), amountATSimple);
    ...
    function claimTokens() public override nonReentrant returns (uint256) {
        ...
        uint256 amountBT = (allocationsBT[_msgSender()] *
            targetSaleProceedsBT) / collectedBT;
        uint256 refundBT = allocationsBT[_msgSender()] - amountBT;
    ...
    function getAllocationFor(
        ...
        if (buyer == seller) {
            ...
            uint256 totalAT = targetSaleProceedsBT * rate;
    ...
    function _preValidatePurchase(
        ...
        require(
            allocationsBT[buyer] + amountBT <= maxPurchaseBT, // TODO: should we allow partial purchases?
        ...
        if (block.timestamp >= startTimestamp) {
            require(
                collectedBT < targetSaleProceedsBT,
