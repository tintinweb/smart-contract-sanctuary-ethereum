...
contract Richelieu is ERC20 {
    uint256 public supplyMinted;

    uint256 public constant MAX_SUPPLY = 50000 * 10 ** 18;

    constructor(uint initialSupply) ERC20("BS", "BS_Token") {
        supplyMinted += initialSupply * 10 ** 18;
        _mint(msg.sender, initialSupply * 10 ** 18);
    }

    function mint(uint256 inputAmount) public {
        require(
            MAX_SUPPLY > supplyMinted + inputAmount * 10 ** 18,
            "All token minted"
        );
