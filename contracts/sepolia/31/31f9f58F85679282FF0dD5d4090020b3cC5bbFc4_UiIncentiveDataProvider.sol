...
/**
 * @title IHopeLendIncentivesController
 * @author HopeLend
 * @notice Defines the basic interface for an HopeLend Incentives Controller.
 * @dev It only contains one single function, needed as a hook on hToken and debtToken transfers.
 */
interface IHopeLendIncentivesController {
  /**
...
interface IUiIncentiveDataProvider {
  ...
  struct UserReserveIncentiveData {
    address underlyingAsset;
    UserIncentiveData hTokenIncentivesUserData;
