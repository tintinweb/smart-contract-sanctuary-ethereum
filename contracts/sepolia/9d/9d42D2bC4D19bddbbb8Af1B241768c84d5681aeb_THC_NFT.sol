...
contract THC_NFT is ERC721, ERC721URIStorage, Ownable, ERC2981 {
  using Strings for uint256;
  ...
  address public OPA = 0x04C0f5dBd7D32847D52960Ff26663D73e01Ad639; //OPA is owner payout address set this depending on what they put
  uint256 public MAXSUPPLY = 6969;
  uint256 public MINTPRICE = 10000000000000; //mintprice in wei
...
function royaltyInfo(uint256 tokenId, uint256 salePrice) public view override returns (address, uint256) {
    uint256 royaltyAmount = (salePrice * royaltyBps) / 6969;
