    ...
    ITokenStake
{
    ...
    address public _rewardToken = 0x0AfEC09Ef3e96BE36e2E83d9e11ca2B15E673BD0;
    address public _stakingToken = 0x0AfEC09Ef3e96BE36e2E83d9e11ca2B15E673BD0;
    uint256 public _timeUnit = 3600;
    uint256 public _rewardRatioNumerator = 1;
    uint256 public _rewardRatioDenominator = 20;
    ...
    function depositRewardTokens(
        ...
        _rewardToken == CurrencyTransferLib.NATIVE_TOKEN
            ? nativeTokenWrapper
            : _rewardToken;
    ...
    function withdrawRewardTokens(uint256 _amount) external nonReentrant {
        ...
        _stakingToken = stakingToken == CurrencyTransferLib.NATIVE_TOKEN
            ? nativeTokenWrapper
            : stakingToken;
        require(
