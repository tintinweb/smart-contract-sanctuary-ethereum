...
contract NftMarketplace is ReentrancyGuard {
    ...
    /**
     * @notice Method for listing our NFT on the marketplace
     ...
     * but this way people can still be holf their NFTs when listed.
     */
    function listItem(
        address nftAddress,
        uint256 tokenId,
        ...
        // There are following ways to list NFT in contract
        // 1. Send NFT to contract. Transfer -> Contract "hold" the NFT. (Gas Expensive)
        // 2. Owners can still hold their NFT and give marketplace approval to sell NFT for them.
        // we are giving with 2nd appraoch
    ...
    function buyItem(
        ...
        // We don't just send the money to the seller (https://fravoll.github.io/solidity-patterns/pull_over_push.html)
        // we provide withdrw option to user
