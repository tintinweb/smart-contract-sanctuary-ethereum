...
contract Sassy_Auto_Burn is Context, IERC20, Ownable {
  ...
  uint256 public burnFee = 2; // 2% burn Fee on each Transaction (i.e. buy, sell, transfer)
  ...
  constructor()  {
    ...
    _symbol = "SAS";
    _decimals = 18;
    _totalSupply = 1_000_000_000_000 *10**18; //1 Trillion total token supply
  ...
  */
  ...
  function _transfer(
    ...
    //transfer amount, it will take burn fee
