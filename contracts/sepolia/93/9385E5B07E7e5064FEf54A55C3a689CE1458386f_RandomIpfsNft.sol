...
// When we mint an NFT, we will trigger a chainlink VRF call to generate a random number.
// using the number, we will get a random NFT( According to rarity )

error RandomIpfsNft__RangeOutOfBound();
error RandomIpfsNft__NeedMoreETHSent();
error RandomIpfsNft__TransferFailed();

//users pay to mint an Nft and owner can withdraw the funds
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    uint256 internal constant MAX_CHAANCE_VALUE = 100;
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        uint256 moddedRng = randomWords[0] % MAX_CHAANCE_VALUE;
    ...
    function getChanceArray() public pure returns (uint256[3] memory) {
        return [10, 30, MAX_CHAANCE_VALUE];
    }
