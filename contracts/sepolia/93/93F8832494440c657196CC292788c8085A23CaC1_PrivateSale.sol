...
contract PrivateSale is Ownable {
    ...
    VestingMonth public vestingContract;
    IERC20 public token;
    bool public isSaleEnd;

    uint256 public maxTokensToSell;
    uint256 public remainingTokens;
    // uint8 public constant VESTING_SCHEDULE_MONTH = 36;
    // uint256 public constant VESTING_START_TIME = 1656633599;
    ...
    constructor(address _vestingContract, address _token, uint256 _maxTokensToSell) {
        vestingContract = VestingMonth(_vestingContract);
        token = IERC20(_token);
        ...
        onlySaleNotEnd
    {
        ...
        for (uint256 i = 0; i < recipients.length; i++) {
            ...
            contributions[recipient] = contributions[recipient].add(amount);
    ...
    function claimVestedTokens() external {
        ...
        require(contributedAmount > 0, "No tokens available to claim");
    ...
    // function withdrawFunds() external onlyOwner onlySaleEnd {
...
contract VestingMonth is Ownable, Pausable {
    using SafeMath for uint256;

    uint256 public constant SECONDS_PER_MONTH = 2629746;

    struct VestingSchedule {
        uint256 totalTokens; // amount of token
