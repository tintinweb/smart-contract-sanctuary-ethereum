...
// Boys of Summer - Presale by Mitchell F Chan
...
contract BoysOfSummerPresale is WildNFT {
  constructor(address _minter, uint256 _maxSupply, string memory _baseURI, address[] memory _payees, uint256[] memory _shares, uint96 _feeNumerator) WildNFT('Boys of Summer - Presale', 'BOSPRESALE', _minter, _maxSupply, _baseURI, _payees, _shares, _feeNumerator) {}
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    string memory json;
    {
      string memory name = string(abi.encodePacked('Boys of Summer - Presale #', tokenIdStr));
      string memory description = 'BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS BOYS. SUMMER!!!';
      string memory externalUrl = string.concat('https://wild.xyz/mitchell-f-chan/boys-of-summer-presale/', tokenIdStr);
      
      json = Base64.encode(bytes(abi.encodePacked('{"name":"', name, '", "description": "', description, '", "image": "', baseURI, '", "external_url": "', externalUrl, '"}')));
    }
