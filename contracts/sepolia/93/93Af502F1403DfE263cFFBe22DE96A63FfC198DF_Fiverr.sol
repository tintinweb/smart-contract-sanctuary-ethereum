...
contract Fiverr {
    ...
    function getJobsBySeller() public view returns (uint256[] memory) {
        return jobsBySeller[msg.sender];
    }

    function getJobsByBuyer() public view returns (uint256[] memory) {
        return jobsByBuyer[msg.sender];
    }
    ...
    function acceptJob(uint256 _jobId) public payable {
        ...
        jobsByBuyer[msg.sender].push(_jobId);
