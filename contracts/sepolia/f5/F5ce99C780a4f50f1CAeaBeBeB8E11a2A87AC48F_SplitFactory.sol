...
contract SplitFactory is AccessControl {
    ...
    /**
     * @dev Public function for creating clone proxy pointing to  Percentage.
     * @param _data Initial data for creating new Split contract.
     */
    ...
    /**
     * @dev External function for creating clone proxy pointing to  Percentage.
     * @param _data  Create data used for hashing and getting random salt.
     * @param _deployer Wallet address that want to create new  contract.
     */
...
contract Split is AccessControlEnumerableUpgradeable {
    ...
    function _recursiveERC20Distribution(address _recipient, IERC20 _token) internal {
        ...
        if (recipientSize > 0) {
            IRecursive recursiveRecipient = IRecursive(_recipient);
