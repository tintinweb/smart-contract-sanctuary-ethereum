...
contract MyToken {
    ...
    uint256 public coinrefundamount;
    uint256 public rate;
    ...
    constructor() {
        ...
        priceFeed2 = AggregatorV3Interface(0x91FAB41F5f3bE955963a986366edAcff1aaeaa83);
    ...
    function openposition() public payable
    {
        ...
        (uint80 roundID2, int price2,uint startedAt2,uint timeStamp2,uint80 answeredInRound2) = priceFeed2.latestRoundData();
        rate = uint256(price);
        rate2 = uint256(price2);
        amount = ((msg.value) * rate / rate2);
    ...
    function closeposition(uint256 value) public payable {
        ...
        rate = uint256(price);
        rate2 = uint256(price2);
        amount2 = (value * rate2 / rate);
        coinrefundamount = coinrefund[msg.sender]; 
