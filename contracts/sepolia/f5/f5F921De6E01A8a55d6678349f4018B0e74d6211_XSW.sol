...
contract XSW {
    ...
    constructor() {
        uint256 initialSupply = 1000000;  // Example initial supply of 1,000,000 tokens
        string memory tokenName = "My Token";  // Example token name
        uint8 decimalUnits = 18;  // Example of 18 decimal units
        string memory tokenSymbol = "MT";  // Example token symbol
