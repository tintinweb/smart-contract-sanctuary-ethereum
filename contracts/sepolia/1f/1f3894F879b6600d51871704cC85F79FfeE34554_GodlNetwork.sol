...
contract GodlNetwork is PausableUpgradeable, OwnableUpgradeable {
    ...
    event NewTopline(address[] indexed newToplineList);
    ...
    function join(address _referrer, uint256 _level) public whenNotPaused {
        ...
        emit NewUser(_msgSender(), _referrer);
    }
     ...
     * @dev rewardTierCost is calculated by adding all the costs upto a given reward tier level.
     * @param _currentLevel : Current level of the user.
