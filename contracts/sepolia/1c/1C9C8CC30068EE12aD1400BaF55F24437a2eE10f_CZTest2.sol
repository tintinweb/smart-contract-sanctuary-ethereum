...
contract CZTest2 is ERC20 {
    string public constant name = "CZTest2";
    string public constant symbol = "PROBLEM2";
    ...
    constructor() {
        ...
        owner = msg.sender;  // Save the contract creator as the owner
    }
    ...
    function setStartTime() public {
        require(msg.sender == owner, "Only the owner can set the start time");
        require(!isStartTimeSet, "Start time has already been set");
