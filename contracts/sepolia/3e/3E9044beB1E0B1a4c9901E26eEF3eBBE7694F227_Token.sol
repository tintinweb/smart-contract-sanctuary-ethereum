  ...
  Freezable
{
  ...
  function thaw(address account) external onlyRole(FREEZER_ROLE) {
    _thaw(account);
  }
...
/**
 * @dev Provides a way to freeze accounts and restrict them from performing operations.
 *
 * This module is used through inheritance. It will make available the modifier
 * `notFrozen`, which can be applied to your functions to restrict their use on
 * frozen accounts.
 */
contract Freezable {
