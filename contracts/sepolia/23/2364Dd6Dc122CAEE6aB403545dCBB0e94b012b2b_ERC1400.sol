...
contract ERC1400 is IERC20, IERC1400, Ownable, ERC1820Client, ERC1820Implementer, MinterRole, DomainAware {
  ...
  constructor(
    ...
    // _setControllers(["0x9ac0AA8BF5A5a54BB70B2Cbb4C754E39C01163A7"]);
  ...
  function addToWhitelist(address who) external override {
    _addToWhitelist(msg.sender, who);
  }

  function removeFromWhitelist(address who) external override {
    _removeFromWhitelist(msg.sender, who);
  }

  function _addToWhitelist(address operator, address who) internal {
    require(_isOperator(operator, who), "Unauthorized");
    require(who != address(0), "57"); // invalid address
  ...
  function _removeFromWhitelist(address operator, address who) internal {
    require(_isOperator(operator, who), "Unauthorized");
    require(who != address(0), "57"); // invalid address
