...
contract NftFactory1155{
    ...
    event NFTCreated(address indexed nftAddress, address mintTo);
    ...
    function createNewFactory(
        ...
        MyToken nft = new MyToken(_baseURI, mintTo);

        emit NFTCreated(address(nft), mintTo);
        return address(nft);
    }
}
