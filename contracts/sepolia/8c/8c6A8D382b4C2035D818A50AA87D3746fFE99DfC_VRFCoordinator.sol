    ...
    IVRFMigration
{
        ...
        )
    {
        ...
        s_billingConfig.reentrancyLock = true;
        bool success;
        ...
        s_billingConfig.reentrancyLock = false;
    ...
    RequestParams internal s_requestParams;
    ...
    function isTargetRegistered(address target) internal returns (bool) {
    ...
    function migrate(
        ...
        if (!isTargetRegistered(address(newCoordinator))) {
    ...
    IERC677Receiver
{
    ...
    uint96 internal constant MAX_JUELS_SUPPLY = 1e27;
    ...
    modifier nonReentrant() {
        if (s_billingConfig.reentrancyLock) {
            revert Reentrant();
        }
        _;
    }
    ...
    /// @dev Error when contract is paused
    ...
    function setPauseFlag(bool pause) external onlyOwner {
        s_billingConfig.paused = pause;
    }
}
