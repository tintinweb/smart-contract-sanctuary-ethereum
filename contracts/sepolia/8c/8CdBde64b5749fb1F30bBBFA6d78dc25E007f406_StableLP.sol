...
contract StableLP is Ownable, ReentrancyGuard {
    ...
    function _swap(
        ...
        int256 fee = calculateFees(_input, _output, amount);
        uint256 outputAmount = uint256(int256(amount) - fee);
    ...
    function calculateFees(
        ...
        int256 fee = int256(inputAmount * feeCalcX / totalLiquidity - feeCalcY);
        fee = int256(_amount) * fee / 10**18;
    ...
    function accumulateFees(int256 fee) private {
        uint256 total = totalBalance();
        int256 revenue = fee * int256(depositorRevenueShare);
        uint256 increaseFeeMult = uint256(10**18 + revenue / int256(total));
