...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 theAmount) public payable {
    // this will only work if the address has the correct approvals
    yourToken.transferFrom(msg.sender, address(this), theAmount);
    // TODO: get the amount of eth that we need to send back to the user
    uint256 ethToSend = theAmount / tokensPerEth;
    console.log('tokensPerEth', tokensPerEth);
    console.log('theAmount', theAmount);
    console.log('sending this amount of eth to the seller', ethToSend);
