...
contract FunctionsConsumer is FunctionsClient, ConfirmedOwner {
  ...
  function fetchPricepredict() public returns(bytes32 requestId){
    bytes memory secrets;
    string[] memory args;
    requestId = executeRequest(fetchPriceSource, secrets, args, c_subscriptionId, c_gasLimit);
  }
