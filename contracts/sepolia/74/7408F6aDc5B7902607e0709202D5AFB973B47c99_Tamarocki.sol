...
contract Tamarocki is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("Tamarocki", "TRK");
        __ERC721URIStorage_init();
        __Ownable_init();
    }

		function baseTokenURI() public view returns (string memory) {
			return "ipfs://bafybeiayx6hobnr53qgff6ghzt72l3vx3kpnmkuqxqzndm7x4b3isa3bp4";
		}
