    ...
    Ownable
{
    ...
    function creditPriceInEth(
        ...
        uint256 ethAmount = nineInchRouter.getAmountsIn(
            linkAmount,
            _getPath(address(nineInchRouter.WETH()), address(link))
        )[0];
        return ethAmount;
    }
    ...
    */
    ...
    function createOrder(
        ...
        if (credits[_msgSender()] < _credits) {
            ...
            nineInchRouter.swapExactETHForTokens{
                value: creditPriceInEth(requiredCredits)
            }(
        ...
        if (tokenIn == address(nineInchRouter.WETH())) {
            require(msg.value >= prices[2], "Insufficient eth value");
        }
