...
contract DiamETH is Ownable, ERC20 {
    using SafeMath for uint256;

    uint256 public ownerNounce;

    constructor() ERC20("DIAM ETH", "DIAM ETH") {
    ...
    function deposit(
        ...
        require(
            keccak256(abi.encodePacked(msg.sender, amount, ownerNounce)) ==
                _hash,
            "DW091"
        );
        ...
        //DW02 - unauthrorised accounts not allowed
