...
contract AuctionHouse is IAuctionHouse, Pausable, ReentrancyGuard, Ownable {
    ...
    */
    ...
    function promoBatchMint(address[] memory _to, uint256[] memory _amounts, MintType mintType) external onlyAdmin {
...
interface IAuctionHouse {
    ...
    */
    event TokenMint(address indexed to, uint256[] indexed tokenIds, MintType indexed mintType, uint256 amountPaid, bool isDelegated, address delegatedVault, bool oasisUsed, uint256[] oasisIds);
