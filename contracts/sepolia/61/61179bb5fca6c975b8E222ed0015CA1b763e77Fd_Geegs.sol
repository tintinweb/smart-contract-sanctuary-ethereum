...
contract Geegs is ERC721A, Ownable, ReentrancyGuard, EIP712 {
    ...
    /* ========== EVENTS ========== */
    event TecCreated(uint256 indexed jobId, uint256 amount);
    ...
    function createDocument(
        ...
        _checkAndMark(signatures);
        bytes32 digest = keccak256(
            abi.encodePacked(doc.talent, msg.sender, doc.wage)
        );
        _validateParties(digest, signatures, [doc.talent, doc.hirer]);
        uint256 feeBasis;
        unchecked {
        ...
        emit TecCreated(_next, doc.wage);
    }
