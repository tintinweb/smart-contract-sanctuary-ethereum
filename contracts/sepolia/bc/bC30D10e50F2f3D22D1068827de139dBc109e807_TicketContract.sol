...
contract TicketContract is ERC1155, Ownable {
    ...
    mapping(address => mapping(uint256 => uint)) public addressHasPurchased; // 地址是否已購買特定活動的票
    ...
    function mintTicket(uint256 eventId, uint256 quantity) external payable returns(bool) {
        ...
        require(!selectedEvent.oneTicketPerPerson || addressHasPurchased[msg.sender][eventId] == 0 , "One ticket per person rule violated");
    ...
    function refund(uint256 tokenId) external {
        ...
        require(!tickets[tokenId].refunded, "The ticket has already been refunded.");
        ...
        uint256 refundAmount = (tickets[tokenId].price * tickets[tokenId].quantity * REFUND_PERCENT) / 100;
