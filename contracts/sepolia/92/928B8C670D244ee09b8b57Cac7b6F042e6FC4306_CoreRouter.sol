...
contract CoreRouter {
    ...
    address private constant _CCIP_RECEIVER_MODULE = 0x79654872398a5C667455058890B29B081Ed47939;
    ...
    address private constant _CROSS_CHAIN_POOL_MODULE = 0x8Db7E7E3f00c2Fd011Bb715935d33BfA0570cDB6;
    address private constant _CROSS_CHAIN_UPKEEP_MODULE = 0x26c9B83fA781e93Ec4cA5fBAC07AC82135872512;
    address private constant _CROSS_CHAIN_USDMODULE = 0x3974935755a50295b727Ab40ae144BE29391d818;
    ...
    address private constant _UTILS_MODULE = 0xd2472bFf6794a0eb59Af037f91B4d6Eb500Fc607;
            ...
            function findImplementation(sig) -> result {
                ...
                if lt(sig,0xbcae3ea0) {
                    ...
                    if lt(sig,0xaaf10f42) {
                        ...
                        case 0xa14d707c { result := _CROSS_CHAIN_USDMODULE } // CrossChainUSDModule.transferCrossChain()
