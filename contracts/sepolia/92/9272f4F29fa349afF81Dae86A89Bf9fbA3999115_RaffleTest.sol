...
//PRICES
 ...
 //   mapping(uint256 => PriceStructure) public pricesList;
  ...
  //  address payable public destinationWallet = payable(0xB6A832c5aD60619d3D77aFE26d79B0b518E6930a);
...
return hasRequiredCollection;
    ...
    function buyEntry(
        ...
        if (raffles[_raffleId].collectionWhitelist.length > 0 && raffles[_raffleId].collectionWhitelist[0]!=address(0) ) {
