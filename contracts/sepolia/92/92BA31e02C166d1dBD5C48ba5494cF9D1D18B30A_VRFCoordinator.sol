    ...
    IVRFMigration
{
    ...
    {
        uint48 currentNonce = s_requestParams.nonce++;
        ConfirmationDelay[NUM_CONF_DELAYS]
            memory currentConfirmationDelays = s_requestParams
                .confirmationDelays;
        return (currentNonce, currentConfirmationDelays);
    }
