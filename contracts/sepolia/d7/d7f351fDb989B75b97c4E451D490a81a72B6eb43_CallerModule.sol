...
contract CallerModule is ContractDeployerModule, CallerDependentModule {
    constructor(address dripsDeployer_)
        BaseModule(dripsDeployer_, _callerModuleSalt, abi.encode(dripsDeployer_))
    {
        // slither-disable-next-line too-many-digits
...
contract DripsModule is DripsDependentModule, ProxyDeployerModule {
    ...
    constructor(address dripsDeployer_, uint32 dripsCycleSecs_, address proxyAdmin_)
        BaseModule(dripsDeployer_, _dripsModuleSalt, abi.encode(dripsDeployer_, dripsCycleSecs_, proxyAdmin_))
    {
...
contract AddressDriverModule is CallerDependentModule, DriverModule(0) {
    constructor(address dripsDeployer_, address proxyAdmin_)
        BaseModule(dripsDeployer_, "AddressDriver", abi.encode(dripsDeployer_, proxyAdmin_))
    {
        // slither-disable-next-line too-many-digits
        _deployProxy(
            proxyAdmin_,
...
contract NFTDriverModule is CallerDependentModule, DriverModule(1) {
    constructor(address dripsDeployer_, address proxyAdmin_)
        BaseModule(dripsDeployer_, "NFTDriver", abi.encode(dripsDeployer_, proxyAdmin_))
    {
        // slither-disable-next-line too-many-digits
        _deployProxy(
            proxyAdmin_,
...
contract ImmutableSplitsDriverModule is DriverModule(2) {
    constructor(address dripsDeployer_, address proxyAdmin_)
        BaseModule(dripsDeployer_, "ImmutableSplitsDriver", abi.encode(dripsDeployer_, proxyAdmin_))
    {
        // slither-disable-next-line too-many-digits
        _deployProxy(
            proxyAdmin_,
...
contract RepoDriverModule is CallerDependentModule, DriverModule(3) {
    ...
    constructor(
        ...
        BaseModule(
            dripsDeployer_,
            "RepoDriver",
            abi.encode(dripsDeployer_, proxyAdmin_, operator_, jobId_, defaultFee_)
        )
    {
        operator = operator_;
        jobId = jobId_;
