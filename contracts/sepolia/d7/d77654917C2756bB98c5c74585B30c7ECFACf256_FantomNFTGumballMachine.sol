...
// File: contracts/FantomNFTGumballMachine.sol
...
contract FantomNFTGumballMachine is ERC721, Pausable, ReentrancyGuard,Ownable {
    ...
    function buyGumball() external payable  whenNotPaused nonReentrant {
        require(IERC20(_tokenAddress).balanceOf(msg.sender) >= _price, "Not enough tokens to buy a gumball");
        IERC20(_tokenAddress).transferFrom(msg.sender, address(this), _price);
    ...
    function MyToken_approve(address _spender) public {
        IERC20(_tokenAddress).approve(_spender, _price);
    }
