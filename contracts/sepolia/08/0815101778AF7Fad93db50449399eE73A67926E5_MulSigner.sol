    ...
    IERCSignerManage
{
    ...
    function createMulSignerTx(
       ...
       _createMulSigerTx(amount, when, to, blank, txType, txId, owner);
    }
    ...
    function _createMulSigerTx(
        ...
        emit CreateMulSigner(owner, SignerTx.txHash, mtx.txId);
    }
    ...
    function _setSinger(
        ...
        emit CreateSigner(Signer, threshold, owner, userId);
    }
    ...
    function setSigners(
        ...
        address owner = msg.sender;
        _setSinger(Signer, owner, threshold, userId);
    }
