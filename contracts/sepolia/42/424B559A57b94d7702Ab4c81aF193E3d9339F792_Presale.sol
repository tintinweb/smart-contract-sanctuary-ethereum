...
contract Presale is Context, ReentrancyGuard, Ownable {
    ...
    address payable vestingContract;
    ...
    function buyTokensFromEth(
        ...
        Vesting(vestingContract).createVestingSchedule(beneficiary, tokens);
    ...
    function setVestingAddress(address payable _vesting) public onlyOwner {
