...
contract Staker {
  ...
  modifier deadlineHasExpired() {
    require(timeLeft() == 0, "Deadline has not expired");
    _;
  }
  ...
  function execute() public notCompleted deadlineHasExpired {
    require(!openForWithdraw, "It's second attempt, U lost");
  ...
  function withdraw() public payable notCompleted {
    require(openForWithdraw == true, "Treshold wasn't met");
    require(balances[msg.sender] > 0, "This address doesn't have enough ETH to withdraw");
