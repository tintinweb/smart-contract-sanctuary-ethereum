...
contract PointsNFT is ERC721, ERC1155Receiver, Ownable, Pausable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    function reducePower(uint256 tokenId, uint256 reduceAmount) external nonReentrant {
        ...
        require(mintPowers[tokenId] > 0 && mintPowers[tokenId] >= reduceAmount , "Invalid reduce amount");
