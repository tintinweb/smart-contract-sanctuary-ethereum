...
import "./Interfaces/IArtERC721.sol";
    ...
    OwnableUpgradeable
{
    ...
    event ArtTokenERC721NewItem(uint256 indexed newItemId);
    ...
    /// Mints a new NFT item. Can be used to store extra images and documents.
    ...
    function mintItem(
        ...
        emit ArtTokenERC721NewItem(newItemId);

        return newItemId;
    }

    function burnItem(uint256 tokenId) external onlyOwner {
