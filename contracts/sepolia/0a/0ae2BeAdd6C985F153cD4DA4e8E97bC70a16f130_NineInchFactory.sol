...
contract NineInchERC20 is INineInchERC20 {
    ...
    string public constant name = "NineInch LP";
    string public constant symbol = "NINE LP";
...
contract NineInchPair is INineInchPair, NineInchERC20 {
    using SafeMath for uint;
    ...
    function swap(
        ...
        uint balance1;
        {
            ...
            if (data.length > 0)
                INineInchCallee(to).uniswapV2Call(
                    msg.sender,
                    amount0Out,
                    amount1Out,
                    data
