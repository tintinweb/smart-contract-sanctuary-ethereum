...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
        require(balances[msg.sender] == 0, "Already have a channel");
    ...
    function withdrawEarnings(Voucher calldata voucher) public {
        ...
        uint256 updatedBalance = voucher.updatedBalance;
        bytes32 hashed = keccak256(abi.encode(updatedBalance));
        ...
        */
        ...
        require(
            ...
            "signer has invalid channel"
        );

        uint256 payout = balances[signer] - updatedBalance;
    ...
    */
    function challengeChannel() external {
        require(balances[msg.sender] > 0, "caller has no channel");
    ...
    */
    function defundChannel() external {
        ...
        require(balance > 0, "caller has no channel");
        require(canCloseAt[msg.sender] > 0, "caller has no closing channel");
        require(
            canCloseAt[msg.sender] < block.timestamp,
            "time not up to close channel"
        );
