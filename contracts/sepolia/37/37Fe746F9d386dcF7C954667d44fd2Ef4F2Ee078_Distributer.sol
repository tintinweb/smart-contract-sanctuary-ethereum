...
contract Distributer is Ownable {
     ...
     */
    function requestToken(address token, uint256 amount, address[] memory users) external onlyOwner {
     ...
     * distribute eth
     */
    function requestEth(address[] memory users, uint256 amount) external onlyOwner {
