...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD);
        _token = msg.sender;
    }
...
contract infinityglobalnftgame is IBEP20, Auth {
    ...
    string constant _name = "ECO VERSE PAYMENT APP";
    string constant _symbol = "ECO VERSE PAYMENT APP";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD);
