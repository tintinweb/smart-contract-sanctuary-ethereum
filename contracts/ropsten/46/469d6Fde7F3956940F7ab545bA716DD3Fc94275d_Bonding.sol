...
/* ========== VIEWS ========== */
    ...
    function earned(address account) public view returns (uint256) {
        ...
        return totalBalance.mul(rewardPerToken().sub(userRewardPerTokenPaid[account])).div(1e18).add(rewards[account]);
    }
    ...
    function getBrainPrice(uint256 amount) public view returns (uint256){
        ...
        uint res0 = Res0*(10**18); //18 decimals for BRAIN
        return((amount*res0)/Res1); // return amount of wETH needed to buy BRAIN
    }
    ...
    function withdraw(uint256 id) public nonReentrant {
        ...
        require(
            block.timestamp > _balances[msg.sender][id].bondedAt.add(432000),
