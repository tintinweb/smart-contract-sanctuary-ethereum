...
contract LotteryPool is ReentrancyGuard,  Ownable{
    ...
    event claimReward(uint256 _amount, uint256 _fee);
    ...
    function CloseLottery() external onlyOwner{
        ...
        lotteryId++;
        allLotteryInfo[lotteryId]._startDate = block.timestamp;
        allLotteryInfo[lotteryId]._ticketPrice = ticketPrice;
        allLotteryInfo[lotteryId]._reward = rewardPrize;
    }
