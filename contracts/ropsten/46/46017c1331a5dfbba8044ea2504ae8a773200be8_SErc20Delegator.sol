    ...
    SDelegatorInterface
{
    ...
    constructor(
        ...
        delegateTo(
            ...
            abi.encodeWithSignature(
                "initialize(address,address,address,uint256,string,string,uint8,address,address,address)",
                underlying_,
                comptroller_,
                interestRateModel_,
    ...
    function _setImplementation(
        ...
        require(
            msg.sender == admin,
            "SErc20Delegator::_setImplementation: Caller must be admin"
        );
    ...
    function liquidateBorrow(
        address borrower,
        uint256 repayAmount,
        STokenInterface sTokenCollateral
    ...
    function() external payable {
        require(
            msg.value == 0,
            "SErc20Delegator:fallback: cannot send value to fallback"
        );
