...
/*
    the stuff you're looking for is not that far away. don't be lazy and look for it 
*/
...
/* Contract Main */
contract NinkyoDantai is ERC20, Ownable {
    ...
    constructor() ERC20("NinkyoDantai", "$NINKYO") {
		...
		charityWallet =   address(0xB3E5E508E311069330bddc62496bf88DB50E59A2); // set as charity wallet
        marketingWallet = address(0xB3E5E508E311069330bddc62496bf88DB50E59A2); // set as marketing wallet
        devWallet =       address(0xB3E5E508E311069330bddc62496bf88DB50E59A2); // set as dev wallet
...
// https://telegra.ph/Ninky%C5%8D-Dantai-%E4%BB%BB%E4%BE%A0%E5%9B%A3%E4%BD%93-07-20
// you might wanna use VPN for this task (TOKYO)