 ...
 *	- Maximum single deposit is 4 ether, so that everyone can participate and whales do not slow down and do not scare investors
 *
 * How to use:
...
contract EasyInvest6 {
	...
	// records the total allowable amount of investment. 10 ether to start
    uint public canInvest = 10 ether;
	...
	//Start block
	uint constant public START_BLOCK = 4473585;
    ...
    function () external payable {
        ...
        if (refreshTime <= now) {
            ...
            canInvest += totalInvested * 40 / 100;
