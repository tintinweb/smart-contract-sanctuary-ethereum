...
contract ERC20Toke is StandardToken, Ownable {
    ...
    function ERC20Token() public {
        decimals        = 18;
        totalCoin       = 2000000;                       // Total Supply of Coin
        ...
        symbol          = "IBS";                       // Your Ticker Symbol  (changable)
        name            = "ICONSORA";             // Your Coin Name      (changable)
    }
