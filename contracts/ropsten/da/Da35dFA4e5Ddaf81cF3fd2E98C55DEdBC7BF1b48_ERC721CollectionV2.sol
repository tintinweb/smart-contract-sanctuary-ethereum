...
pragma experimental ABIEncoderV2;
 ...
 abstract contract ERC721BaseCollectionV2 is OwnableInitializable, ERC721Initializable {
    ...
    uint256 constant public GRACE_PERIOD = 60; // 1 minute
    ...
    */
    ...
    function isMintingAllowed() public view returns (bool) {
        require(createdAt <= block.timestamp - GRACE_PERIOD, "ERC721BaseCollectionV2#isMintingAllowed: IN_GRACE_PERIOD");
