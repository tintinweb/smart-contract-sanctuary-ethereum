...
contract AccessoryDictionaryImpl is Ownable {
    ...
    constructor() {
        ...
        // TODO: Uncomment if description is to be added!
        //_initializeDescriptionDictionary();
    }

    /**
     * @notice Get name given {_line} and {_stage}.
     *
     * @param _line Accessory line index.
     * @param _stage Accessory stage index.
    ...
    /**
     * @dev Add new Name to dictionary.
     *
     * @param _line Accessory line index.
     * @param _stage Accessory stage index.
    ...
    /**
     * @notice Get description given {_line} and {_stage}.
     *
     * @param _line Accessory line index.
     * @param _stage Accessory stage index.
    ...
    /**
     * @dev Add new description to dictionary.
     *
     * @param _line Accessory line index.
     * @param _stage Accessory stage index.
     ...
     *
     * @param _line Accessory line index.
     * @param _lineName name of the Line.
     */
     ...
     *
     * @param _variation Accessory variation index.
     * @param _variationName name of the Variation.
     */
    ...
    /// @dev initialize names dictionary
    ...
    /// @dev initialize description dictionary
