...
contract StudyNft is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public maxTokensCount = 5555;
    address[] private distributions;
    string private baseURI;
    string public baseTokenURI;
    string public contractURI;

    constructor() ERC721("cutecat", "CC") {
        baseURI = "ipfs://QmUvbx9gLnz13ckB6LZYQdEe5DoQe2x6MbZYu8XBZyP8GX/"; 
        baseTokenURI = "ipfs://QmbBCeA6riFn69vCjaBhwr9oHQwebPjgmhLV6ydHfCdqTx?filename=_metadata.json";
        contractURI = "";
    }
