...
// RaeBar is the coolest bar in town. You come in with some rae, and leave with more! The longer you stay, the more rae you get.
//
// This contract handles swapping to and from xRAE, RAE's staking token.
contract RaeBar is ERC20("RaeBar", "xRAE"){
    using SafeMath for uint256;
    IERC20 public rae;
    ...
    // Enter the bar. Pay some RAE. Earn some shares.
    ...
    // Leave the bar. Claim back your RAE.
