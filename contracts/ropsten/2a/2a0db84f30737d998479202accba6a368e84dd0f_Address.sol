...
contract BMC is Context, IBEP20, Ownable {
    ...
    uint256 public _marketingSellFee = 4;                           // Marketing Fee percent to sell
    uint256 public _marketingBuyFee = 6;                            // Marketing Fee percent to buy
