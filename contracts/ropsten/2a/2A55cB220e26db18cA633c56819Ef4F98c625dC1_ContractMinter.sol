...
contract ContractMinter is ERC721Configurable {
    ...
    address public constant LEGACY_CONTRACT = 0xd4AE8f91994F6ed45189322ecbAbbB83f85C9d2e;
    ...
    constructor() ERC721Configurable(MAX_MINT, MAX_SUPPLY, 'Contract Minter', 'minter') ERC721Royalty(_msgSender(), 1000) {
        setBaseURI('https://niftyvs.com/metadata/contract-minter/json/');

        // Holders Snapshot
        // setAllowlist(0, /** Merkle Root **/);
        setConfig(0, 1658041200, 5, MAX_SUPPLY, 0.1 ether, 1657911600);

        // Allowlist
        // setAllowlist(1, /** Merkle Root **/);
    ...
    function _availableSupply() internal override(ERC721Configurable) view virtual returns (uint256) {
        return super._availableSupply() - IERC721A(LEGACY_CONTRACT).totalSupply();
    }

    function swap(uint256[] calldata ids) external {
