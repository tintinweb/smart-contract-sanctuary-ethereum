...
contract RETHStaking is SMAuth, ReentrancyGuard, Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    uint256 internal constant ONE_MONTH_SEC = 2592000;
    ...
    constructor() {
        _disableInitializers();  
        rewardToken=IERC20(0x53F27Af8F3e9bF25FEd74e8869a39C6F11436649);
        depositToken= IERC20(0x3b8B833A1763041C7BAd48e7434eE9363b220AB6);
    ...
    function _stake(uint256 amount, uint256 months) internal {
