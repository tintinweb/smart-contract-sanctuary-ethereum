...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    function  addLiquidityETH(
        ...
        address to,
        uint256 deadline
    ) override external payable returns (uint256 amountToken, uint256 amountETH, uint256 liquidity);
...
contract FireEmperor is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Hono No Teio";
    string private constant _symbol = "TEIO";
    ...
    uint256 public swapAmount = 5 * 1e2 * 1e6; //.05%
    ...
    address payable private TeioWallet = payable(0x43EB13ae0A2258C65cCe719EC63d7640BBB2e976);
    ...
    constructor() {
        ...
        _isExcludedFromFee[TeioWallet] = true;
