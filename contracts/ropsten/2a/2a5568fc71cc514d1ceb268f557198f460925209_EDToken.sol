 ...
 * HarCap - 1,000,000,000 - One billion tokens + 18 decimals
 */
contract EDToken is EdgeToken {
  string public constant name = "EdToken";  // The Token's name
  string public constant symbol = "ET";    // Identifier 
  ...
  constructor() public {
    ...
    //Hardcap is 158,000,000 - 158 million + 18 decimals
    hardCap_ = 158000000 * (10**uint256(18)); 
