...
contract CryptoCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CryptoCoin() {
        ...
        name = "CryptoCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT2018-055";                                             // Set the symbol for display purposes (CHANGE THIS)
