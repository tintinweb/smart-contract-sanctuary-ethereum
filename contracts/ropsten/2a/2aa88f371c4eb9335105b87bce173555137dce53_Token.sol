...
/**
 * @title Uraniumplus Token
 * @dev Basic version of StandardToken, with no allowances.
 */
contract UraniumplusToken is ERC20Basic {
 ...
 */
contract StandardToken is ERC20, UraniumplusToken {
 ...
 */
contract BurnableToken is UraniumplusToken {
...
{
    string public constant name = 'Stock Shopping';
...
contract Crowdfunding
{
    ...
    uint256 public hard_cap = 4000 ether;
    uint256 public rate = 40000;
    address public funds_address = address(0xde15Fce199e807CBBcd0fEdF489ad6d26553e0a0);
