 ...
 * see https://github.com/OpenZeppelin/openzeppelin-solidity/blob/master/contracts/token/ERC20/StandardBurnableToken.sol
 */
...
//LopachuToken
contract LopachuToken is StandardBurnableToken, Ownable {

  using SafeMath for uint256;

  string public symbol = "LPC03";
  string public name = "Lopachu 03";
  ...
  **/
  function close() onlyOwner public {
    ...
    teamTokensLockedPeriod = now + 10 minutes;
