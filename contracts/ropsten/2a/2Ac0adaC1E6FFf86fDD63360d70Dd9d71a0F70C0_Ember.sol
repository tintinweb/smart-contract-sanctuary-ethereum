...
contract Ember is ERC20, Ownable {
    ...
    uint256 public marketingFee = 5; // marketing fee
    address public  marketingWallet = 0x6c808B0588Cb438B513f655711e587b007fDF110; // marketing wallet address
    ...
    constructor() ERC20("Ember", "Ember") {
        ...
        */
        _createInitialSupply(owner(), 10000000000 * (10**18));
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "POC: Account is already the value of 'excluded'");
        _isExcludedFromFees[account] = excluded;
        emit ExcludeFromFees(account, excluded);
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "POC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "POC: Automated market maker pair is already set to that value");
