...
contract cc70ccviski is ERC721, NonblockingReceiver {
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(!paused, "cc70ccviski: Paused");
        require(nextTokenId + _amount <= MAX_MINT, "cc70ccviski: Mint exceeds supply");
        require(MAX_PER_TX >= _amount , "cc70ccviski: Excess max per tx");
        require(MAX_PER_WALLET >= minted[_caller] + _amount, "cc70ccviski: Excess max per wallet");
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "cc70ccviski: msg.value not enough to cover messageFee. Send gas for message fees"
        );
