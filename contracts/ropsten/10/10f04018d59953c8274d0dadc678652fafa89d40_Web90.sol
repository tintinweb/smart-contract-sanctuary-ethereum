...
contract Web90 is Context, IERC20, Ownable {
    ...
    // mapping to keep track of who is blacklist   
    mapping (address => bool) public _isBlacklisted; 

    address[] private _excluded;
    address private _developmentWalletAddress = 0xaA96052CbEFc4d9c8daEB069884A99E2cEFFB371;
    address payable public marketingAddress = payable(0xaA96052CbEFc4d9c8daEB069884A99E2cEFFB371); // Marketing Address
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Web90";
    string private _symbol = "W90";
