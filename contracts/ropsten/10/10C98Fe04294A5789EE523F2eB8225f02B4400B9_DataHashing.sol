...
pragma solidity >=0.4.22 <0.9.0;
    ...
    function createehrdatahash(string memory _ehrRecordID, string memory _effDate, string memory _patientID, string memory _doctorID, string memory _disease, string memory _prescriptionFile) public{

        bytes32 hash=keccak256(abi.encodePacked( _ehrRecordID,  _effDate,  _patientID, _doctorID,  _disease,_prescriptionFile));
 ...
 function verifyehrdatahash(string memory _ehrRecordID, string memory _effDate, string memory _patientID, string memory _doctorID, string memory _disease, string memory _prescriptionFile) public view returns (bool) {
      bytes32 hash1=keccak256(abi.encodePacked(_ehrRecordID,  _effDate,  _patientID, _doctorID,  _disease,_prescriptionFile));
