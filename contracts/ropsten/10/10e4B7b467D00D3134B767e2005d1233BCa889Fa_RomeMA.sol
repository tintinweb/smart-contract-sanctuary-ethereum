...
contract RomeMA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "RomeMA";
    string constant _symbol = "RomeMA";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xBf5aDAd0C66f808c6679Afc866c74a46863C03B1;
        solor = msg.sender;
