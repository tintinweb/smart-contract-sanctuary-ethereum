...
// File contracts/contracts/OZ_forks/extensions/IaNFTMetadata.sol
...
// File contracts/contracts/OZ_forks/aNFT.sol
...
// File contracts/contracts/OZ_forks/extensions/IaNFTEnumerable.sol
...
// File contracts/contracts/OZ_forks/extensions/aNFTEnumerable.sol
...
// File contracts/contracts/OZ_forks/extensions/aNFTBurnable.sol
...
// File contracts/contracts/OZ_forks/extensions/aNFTPausable.sol
...
// File contracts/contracts/OZ_forks/extensions/aNFTURIStorage.sol
...
// File contracts/contracts/MetaDungeon.sol
    ...
    IMetaDungeon
{
    ...
    function setBaseURI(string memory newBaseTokenURI) public virtual override {
        // MD01: MetaDungeon: must have minter role to setBaseURI
    ...
    function mint(address to, address brain, string[] memory tokenURIs) public virtual override returns (uint tokenId) {
        // MD02: MetaDungeon: must have minter role to mint
        require(hasRole(MINTER_ROLE, _msgSender()));
    ...
    function setTokenURIs(uint256 tokenId, string[] memory tokenURIs) external override {
        // MD03: MetaDungeon: must have minter role to setTokenURIs
        require(hasRole(MINTER_ROLE, _msgSender()));
        _setTokenURIs(tokenId, tokenURIs);
    }
    ...
    function pause() public virtual override {
        // MD04: MetaDungeon: must have pauser role to pause
    ...
    function unpause() public virtual override {
        // MD05: MetaDungeon: must have pauser role to unpause
        require(hasRole(PAUSER_ROLE, _msgSender()));
        _unpause();
    }
