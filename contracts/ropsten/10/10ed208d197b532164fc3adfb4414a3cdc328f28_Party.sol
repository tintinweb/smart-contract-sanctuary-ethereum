...
contract Party is PartyInitializable, PartyStorage, IParty {
    ...
    ***************/
        ...
        )
    {
        ...
        if (amountPT > 0) {
            // @ubinatus: can be improved on a further version
...
library Announcements {
    ...
    function create(
        ...
        self.posts.push(Post(title, description, url, block.timestamp));
    }
...
interface IPartyMemberActions {
     ...
     */
    function withdraw(uint256 amountPT) external payable;
     ...
     */
    function leaveParty(uint256 memberIdx) external payable;
}
