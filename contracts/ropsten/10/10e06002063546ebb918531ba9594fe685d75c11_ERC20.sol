...
contract TamaShib is ERC20, Ownable {
    ...
    constructor() ERC20("TShib", "TamaShib") {
        ...
        marketingWallet = address(0xc6DC9429b366eb670A0124c07a6a5028f91C39fd); // set as marketing wallet
        devWallet = address(0x3700e8aD452e46f55aC369BA1A5Eb7e7C2197ca8); // set as dev wallet
