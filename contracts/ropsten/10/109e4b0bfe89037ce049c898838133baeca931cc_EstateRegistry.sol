...
// File: contracts/MegaToken/IMegaToken.sol

interface IMegaToken {
////////////////
...
contract EstateStorage {
  ...
  // Land balance Mega token
  IMegaToken public estateLandBalance;
...
contract EstateRegistry is Migratable, IEstateRegistry, ERC721Token, ERC721Receiver, Ownable, EstateStorage {
  ...
  */
  ...
  /**
   * @dev Set a new estate land balance Mega token
  ...
  function _setEstateLandBalanceToken(address _newEstateLandBalance) internal {
    ...
    estateLandBalance = IMegaToken(_newEstateLandBalance);
  }
  ...
  /**
   * @dev Set a estate land balance Mega token hardcoded because of the
