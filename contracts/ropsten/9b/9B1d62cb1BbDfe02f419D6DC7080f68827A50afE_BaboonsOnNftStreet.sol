...
contract BaboonsOnNftStreet is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Baboons On Nft  Street", "SGS") {
    setHiddenMetadataUri("ipfs://QmZwcnxGmt74GxKmyWbkdD5LUraGjoFrkSxVmj1bWp8ZX5/1.json");
  }
