...
contract PlayerBook {
    ...
    // TO DO: TEAM ADDRESS
    TeamAnonymousInterface constant private TeamAnonymous = TeamAnonymousInterface(0x9B210Ff31E036469657b7A1262d4E2535aDfE52B);
    ...
    address constant private developer = 0xA41c5535F92911B65bcb4bE1Eb97E65c90613126;
...
//==============================================================================    
        ...
        public
    {
        ...
        plyr_[1].names = 1;
        pIDxAddr_[0xA41c5535F92911B65bcb4bE1Eb97E65c90613126] = 1;
        pIDxName_["creator"] = 1;
        plyrNames_[1]["creator"] = true;
        plyrNameList_[1][1] = "creator";
        
        plyr_[2].addr = 0xA41c5535F92911B65bcb4bE1Eb97E65c90613126;
        plyr_[2].name = "admin";
        plyr_[2].names = 1;
        pIDxAddr_[0xA41c5535F92911B65bcb4bE1Eb97E65c90613126] = 2;
        pIDxName_["admin"] = 2;
