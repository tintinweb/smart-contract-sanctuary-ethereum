...
/// @title Storage helpers for the `ERC721CurveFactory` feature.
library LibERC721CurveFactoryStorage {
    ...
    function getStorage() internal pure returns (Storage storage stor) {
        uint256 storageSlot = LibStorage.getStorageSlot(LibStorage.StorageId.ERC721CurveFactory);
