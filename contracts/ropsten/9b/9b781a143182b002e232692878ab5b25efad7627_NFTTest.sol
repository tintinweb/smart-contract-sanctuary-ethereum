...
contract NFTTest is ERC721URIStorage {
   ...
   struct Tokens {
      ...
      address owner;
		...
		mapping(address => Tokens[]) public userOwnedTokens;
    ...
    */
    ...
    constructor() ERC721("NFTTokens", "NFT") {
...
/**
    ...
    */
    ...
    function CreateNFT(address ownerAddress, string memory tokenURI)
        public
        returns (uint256)
    {
       require(balanceOf(ownerAddress) <=MaxToken, "Max Limit Execeeded"); 
 		_tokenIds.increment();
		...
		tokenBalance[ownerAddress] += 1;
		tokenOwner[tokenId] = ownerAddress; 
	 Tokens memory newToken = Tokens ({
            owner: ownerAddress,
            tokenURI: tokenURI,
            tokenId: tokenId
        });
 		userOwnedTokens[ownerAddress].push(newToken);
    ...
    function CreatePrivateNFT(address ownerAddress, string memory tokenURI)
        public
        returns (uint256)
    {
