...
contract ChiToken is ERC20Token, AccessControlUpgradeable, EIP712Upgradeable, IMintable {
   ...
   */
  function __ChiToken_init() public initializer {
    __AccessControl_init();
    __EIP712_init("EventXToken", "1.0.0");
    __ERC20Token_init("EventXToken", "EVTX", 18, 1000000000);
    _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
  }

  function mint(address _account, uint _amount) external override onlyRole(DEFAULT_ADMIN_ROLE) {
