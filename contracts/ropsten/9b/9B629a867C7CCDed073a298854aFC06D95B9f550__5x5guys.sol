...
contract _5x5guys is Ownable{
    ...
    function get_number_minted() public view returns (uint16) {
        return supply;
    }
    ...
    function mint_5x5guy(string memory str) public payable returns (uint256) {
        ...
        require(keccak256(bytes(chars[0])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 1: ", chars[0])));
        require(keccak256(bytes(chars[1])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 2: ", chars[1])));
        require(keccak256(bytes(chars[7])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 3: ", chars[7])));
        require(keccak256(bytes(chars[8])) == keccak256(bytes("\n")), string(abi.encodePacked("Wrong string format 4: ", chars[8])));
        require(keccak256(bytes(chars[9])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 5: ", chars[9])));
        require(keccak256(bytes(chars[17])) == keccak256(bytes("\n")), string(abi.encodePacked("Wrong string format 6: ", chars[17])));
        require(keccak256(bytes(chars[26])) == keccak256(bytes("\n")), string(abi.encodePacked("Wrong string format 7: ", chars[26])));
        require(keccak256(bytes(chars[35])) == keccak256(bytes("\n")), string(abi.encodePacked("Wrong string format 8: ", chars[35])));
        require(keccak256(bytes(chars[39])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 9: ", chars[39])));
        require(keccak256(bytes(chars[40])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 10: ", chars[40])));
        require(keccak256(bytes(chars[41])) == keccak256(bytes(">")), string(abi.encodePacked("Wrong string format 11: ", chars[41])));
        require(keccak256(bytes(chars[44])) == keccak256(bytes("\n")), string(abi.encodePacked("Wrong string format 12: ", chars[44])));
        require(keccak256(bytes(chars[53])) == keccak256(bytes("\n")), string(abi.encodePacked("Wrong string format 13: ", chars[53])));
        require(keccak256(bytes(chars[56])) == keccak256(bytes("`")), string(abi.encodePacked("Wrong string format 14: ", chars[56])));
        require(keccak256(bytes(chars[61])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 15: ", chars[61])));
        require(keccak256(bytes(chars[62])) == keccak256(bytes("\n")), string(abi.encodePacked("Wrong string format 16: ", chars[62])));
        require(keccak256(bytes(chars[63])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 17: ", chars[63])));
        require(keccak256(bytes(chars[64])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 18: ", chars[64])));
        require(keccak256(bytes(chars[65])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 19: ", chars[65])));
        require(keccak256(bytes(chars[66])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 20: ", chars[66])));
        require(keccak256(bytes(chars[69])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 21: ", chars[69])));
        require(keccak256(bytes(chars[70])) == keccak256(bytes(" ")), string(abi.encodePacked("Wrong string format 22: ", chars[70])));
    ...
    function string_to_array(string memory str) public pure returns (string[] memory){
        ...
        for (uint i; i<b.length; i++){
            return_array[i] = bytes32ToString(b[i]);
        }
        return return_array;
    }
