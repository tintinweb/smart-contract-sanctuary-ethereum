...
contract Pollen  {
    ...
    function stake(uint256 amount, uint256 period ) public returns(uint256)  {
        ...
        rewards[newItemId] = StakedToken(newItemId, amount, block.timestamp ,block.timestamp, period,0);
    ...
    function getBalanceCToken(address sender, uint256 tokenIndex) public  returns(uint) {
        ...
        staked._totalRedeem = cToken.redeem(cToken.balanceOf(address(this)));
