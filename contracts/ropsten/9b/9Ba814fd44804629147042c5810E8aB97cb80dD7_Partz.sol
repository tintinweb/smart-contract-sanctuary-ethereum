...
contract Partz is ERC721AX, Ownable {
...
// SPDX-License-Identifier: MIT
// ERC721XX.org by Catze Labs
// Inherited from ERC721A by Chiru Labs
 ...
 */
contract ERC721AX is Context, ERC165, IERC721AX {
    ...
    function _safeMintById(
        ...
        require(
            ...
            'ERC721AX: transfer to non ERC721Receiver implementer'
        );
    }
...
/**
 * @dev Interface of an ERC721AX compliant contract.
 */
interface IERC721AX is IERC721, IERC721Metadata {
    /**
