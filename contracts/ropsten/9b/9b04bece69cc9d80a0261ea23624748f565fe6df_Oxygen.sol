...
contract Oxygen is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Oxygen() {
        ...
        name = "Oxygen";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "OXI";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 166666500;                                      // Set the price of your token for the ICO (CHANGE THIS)
