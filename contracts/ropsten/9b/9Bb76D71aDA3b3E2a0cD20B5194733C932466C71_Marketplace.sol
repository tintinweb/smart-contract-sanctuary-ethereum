...
contract Marketplace is Ownable, ReentrancyGuard{
    ...
    function SellWithMint(uint256 tokenID, string memory collectionName, string memory tokenURI, uint256 price, string memory transactionID, HDY721.Sig memory MintRSV, Sig memory sellRSV) public pausable initializer{
        require(verifySigner(platformAddress, messageHash(abi.encodePacked(msg.sender, tokenID, price, transactionID)), sellRSV), "Sell rsv invalid");
    ...
    function updatePlatform(address newPlatform) external onlyOwner onlyAdmin {
...
contract HDY721 is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    function Mint(
        ...
        firstOwner[tokenId] = callerAddress;
