...
Telegram : https://t.me/PoocroinCRO
Website  : https://poocroin.io/
...
contract LemonCro is IBEP20, Auth {
    ...
    string constant _name = "LemonCro";
    string constant _symbol = "LEMONCRO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * 10**3 * (10 ** _decimals);
    ...
    address private marketingFeeReceiver = 0xA4811A08D53B9E2D57059E11b0b6BC9897cA6789;
    address private teamFeeReceiver = 0x13c41C0BbC737D7BF2CdBdF3BA5C3D7Cf08C8f95;
    ...
    uint256 public swapThreshold = 20 * 10**3 * (10 ** _decimals); // 0.3%
    bool inSwap;
    modifier swapping() { inSwap = true; _; inSwap = false; }

    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        //0x145677FC4d9b8F19B5D56d1820c48e0443049a30 (uniswap) 
