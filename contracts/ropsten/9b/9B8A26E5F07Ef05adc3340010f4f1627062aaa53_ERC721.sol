...
contract ERC721 is IERC721, IERC721Metadata, ERC165{
    ...
    function approve(address _spender, uint256 _tokenId) public override {
        ...
        require((msg.sender == owners[_tokenId] || msg.sender == tokenApprovals[_tokenId]), "ERC721: approve caller is not owner nor approved for all");
    ...
    function transferFrom( address _from, address _to, uint256 _tokenId) external override {
        require((msg.sender == owners[_tokenId] || msg.sender == tokenApprovals[_tokenId]), "ERC721: transfer caller is not owner nor approved");
