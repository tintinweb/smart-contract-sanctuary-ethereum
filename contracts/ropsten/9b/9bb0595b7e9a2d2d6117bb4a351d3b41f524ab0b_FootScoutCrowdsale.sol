...
contract FootScoutCrowdsale is TokenDeskProxyAware {
    using SafeMath for uint256;
    // Wallet where all ether will be moved after escrow withdrawal. Can be even multisig wallet
    address public constant WALLET = 0xB7133d2fDa66A7F8984229d63a289afEB9A37D84;
    // Wallet for founders tokens
    address public constant FOUNDERS_WALLET = 0xc3757c9F09D515542F779D50639e9F7A01d04e51;
    // Wallet for reserve tokens
    address public constant RESERVE_WALLET = 0x95aef253432b7c86c1220F79501a7F41c919fD89;
    // Wallet for company and advisors tokens
    address public constant COMPANY_WALLET = 0xe8DEBAA4f6DdC77260a58A6f4218d26109D3fd22;
    // Wallet for bounty tokens
    address public constant BOUNTY_WALLET = 0x1Fb645E80854a849Eb0F8d94cF60aAad1ADD2E7E;
    ...
    uint256 public constant START_TIME = 1530439200; // 07/01/2018 @ 10:00am (UTC)
    uint256 public constant RATE = 5100;  // 1 ETH = 5100 FTSC

    uint256 public icoEndTime = 1533117600; // 2018/05/31 10:00 UTC +0
    ...
    */
    ...
    function FootScoutCrowdsale() public {
        stages.push(Stage({ till: 1530525600, bonus: 34, cap: 163100000e18 }));    // 07/02/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1530784800, bonus: 21, cap: 0 }));               // 07/05/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531216800, bonus: 13, cap: 0 }));               // 07/10/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531908000, bonus: 5, cap: 0 }));                // 07/18/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1533117600, bonus: 0, cap: 0 }));                // 08/01/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: ~uint64(0), bonus: 0, cap: 0 }));                // unlimited

        token = FootScoutToken(0xa4933D09401D5222B98b971BE9DC75753f70665E); // token address
