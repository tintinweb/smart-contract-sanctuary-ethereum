...
contract CoinflectStaking is Ownable, Pausable, ReentrancyGuard {
    ...
    modifier updateReward(bool withdrawal) {
        ...
        uint256 pending = penaltyFlag ? 0 : user.amount.mul(reward).div(1e12*(10**decimalsDiff)).div(100 * 365 * 24 * 60 * 60);
    ...
    function claimable(address _user) external view returns (uint256) {
        ...
        return amount.mul(reward).div(1e12*(10**decimalsDiff)).div(100 * 365 * 24 * 60 * 60).add(user.pendingRewards);
    }
