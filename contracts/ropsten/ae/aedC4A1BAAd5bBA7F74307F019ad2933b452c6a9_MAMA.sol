...
contract MAMA is Context, IERC20, Ownable {
    ...
    uint256 public _buyLimit = 50000 * 10**18;
    uint256 public _sellLimit = 20000 * 10**18;
    uint256 public _lockupPeriod = 15 seconds;
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair) || _msgSender() == owner()) {
            ...
            if (to == uniswapV2Pair && from != address(uniswapV2Router)) {
                ...
                if (_devWalletAddress[to] == false && _marketingWalletAddress[to] == false) {
