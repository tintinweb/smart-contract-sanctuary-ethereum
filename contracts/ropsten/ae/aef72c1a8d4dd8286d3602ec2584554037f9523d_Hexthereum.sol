...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Router address -- Do not modify
      uniswapV2Router = _uniswapV2Router; 
      rewardTokens.push(address(0xF1633e8D441F6F5E953956e31923F98B53c9fd89)); //Rewarding token
...
contract Hexthereum is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public immutable uniswapV2Router;
    ...
    address payable private _marketingAddress = payable(0x749e72fa3671b44bCA94EEbAe467b50F67E78203);
    ...
    constructor() ERC20("Hexthereum", "HEXTH") {
    ...
    function updateBuyFees(uint256 _rewardsFee, uint256 _liquidityFee, uint256 _marketingFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _rewardsFee, uint256 _liquidityFee, uint256 _marketingFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForRewards + tokensForMarketing;
        ...
        uint256 ethForMarketing = ethBalance - ethForLiquidity - ethForRewards;
        tokensForLiquidity = 0;
        tokensForRewards = 0;
        tokensForMarketing = 0;
        if(liquidityTokens > 0 && ethForLiquidity > 0 && ethForMarketing > 0){
            _marketingAddress.transfer(tokensForMarketing.div(2));
