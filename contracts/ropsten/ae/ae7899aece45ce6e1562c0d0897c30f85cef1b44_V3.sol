...
interface IDividendDistributor {
   ...
   //function showRewardAddress() external returns(IBEP20);
...
contract DividendDistributor is IDividendDistributor {
   ...
   //function showRewardAddress() external view override returns(IBEP20){
   //    return USDC;
   //}
...
contract V3 is IBEP20, Auth {
   ...
   string constant _name = "v3";
   string constant _symbol = "V3";
