 ...
 */
contract P2EGame2Player_v1 is Ownable {
    // admin address1
    ...
    function setRewardTokenAddress(address _gameToken) external onlyOwner returns (bool) {
        require(_gameToken != address(0), "P2EGame2Player_v1: reward Token address cannot be zero address");
        tokenAddress = _gameToken;
        return true;
    }
    /**
     */
    ...
    function setAdmin(address _admin) external onlyOwner returns (bool) {
        require(_admin != address(0), "P2EGame2Player_v1: admin address cannot be zero address");
        admin = _admin;
        return true;
    }
    ...
    function createGame(
        ...
        require(_p >= unit, "P2EGame2Player_v1: must insert 1 whole token");
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "P2EGame2Player_v1: winnings exceed balance in escrow"
        );
        ...
        require(
            ...
            "P2EGame2Player_v1: It seems winnner is invalid address"
        );
