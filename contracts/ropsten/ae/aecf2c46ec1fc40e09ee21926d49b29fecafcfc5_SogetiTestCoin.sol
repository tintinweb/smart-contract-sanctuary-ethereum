...
contract SogetiTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SogetiTestCoin() {
        ...
        name = "SogetiTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TSOG";                                             // Set the symbol for display purposes (CHANGE THIS)
