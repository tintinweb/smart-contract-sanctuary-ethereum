...
contract Marketplace is IERC721Receiver {
    ...
    function mintAndCreateAuction(
        ...
        if(!isContract(_addressNFTCollection)){

             _NFTCollection = new NFTCollection(
                msg.sender,
                initialRoyalty_,
                _name,
                _symbol,
            ...
            _addressNFTCollection = address(_NFTCollection);
            emit ContractCreated(_addressNFTCollection);

        }else{
            _NFTCollection = NFTCollection(_addressNFTCollection);
        }
