...
contract Flash is Ownable, IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        IWETH(path[0]).transfer(msg.sender, amount0.add((amount0 * 3) / 1000) + 1);
    }
    ...
    function startFlash(
        ...
        IUniswapV2Pair(addressFrom).swap(brrow, 0, address(this), "falsh");
    }

    function sendToken(address _token, address to) external {
        ERC20 erc20token = ERC20(_token);
