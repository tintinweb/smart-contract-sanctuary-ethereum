...
contract METAPETS is Context, IERC20, Ownable {
    ...
    address payable public maintainanceAddress = payable(0x7Fd4B56b94F1CA529c5c60f70677cca29A9569C7); // Maintainance Address
    address payable public developmentAddress  = payable(0x7Fd4B56b94F1CA529c5c60f70677cca29A9569C7); // Development Address
    address payable public marketingAddress    = payable(0x7Fd4B56b94F1CA529c5c60f70677cca29A9569C7); // Marketing Address

    string private _name = "gold1"; //token name
    string private _symbol = "gold1"; // token symbol
