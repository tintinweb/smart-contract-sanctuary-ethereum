...
contract BBvsEA is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("srslythelasttest", "LASTtestFRFR") {
    setHiddenMetadataUri("https://bbvsea.mypinata.cloud/ipfs/QmQ4vWJXDbsWByJTEsoRycNqTCFLE22Nu6jnnm9nkdt9Z3");
  }

  modifier mintCompliance(uint256 _mintAmount) {
    if (msg.sender != owner()) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, "You have hit your minting limit.");
    }
