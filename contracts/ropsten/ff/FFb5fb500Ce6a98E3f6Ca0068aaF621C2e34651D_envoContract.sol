...
contract envoContract is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_VIPWA = 1;
    ...
    bytes32[] public VIPMerkleProofArr;
    ...
    constructor(
        ...
        mint(0x72521683e85F1a6eCfb0198D2f497ea6A664908A, 14); // mint the first 14 to the founders envolabs wallet
    ...
    function calcPrice() internal view returns (uint256 nowPrice) {
        ...
        if(MerkleProof.verify(
            ...
            if(currentTime > vipDate && currentTime < startDate) {
                return vipPrice;
            }
        }
        // ----------------------------------- regular price calc
