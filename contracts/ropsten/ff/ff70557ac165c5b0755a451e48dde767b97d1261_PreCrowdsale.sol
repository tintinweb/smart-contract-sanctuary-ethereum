...
contract PreCrowdsale is Context, ReentrancyGuard {
    ...
    function _forwardFunds(uint256 _weiAmount) internal {
        uint deducePercent = _weiAmount.mul(5e19);
        uint share = deducePercent.div(1e20);
        busdToken.safeTransfer(wallet1, share);
        busdToken.safeTransfer(wallet2, share);
    }
    ...
    function updatePreSale(address _add1, address _add2) public onlyOwner(){
        wallet1 = _add1;
        wallet2 = _add2;
    }
