...
contract ALP is ERC20, Ownable, Pausable {
    ...
    function preTransfer(address _holder, uint256 _releaseStart, uint256 _amount) public onlyOwner returns(bool){
        
        transfer(_holder,_amount);
        lock(_holder,_releaseStart,_amount);
