...
contract DustyLand is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public cost = 0.01 ether; //0.15WL 0.2P
    ...
    string public uri = "ipfs://reveal/";

    constructor() ERC721A("Dusty Land", "DUSTYLAND") ReentrancyGuard() {}
    ...
    function toggle_mode() external onlyOwner {
        mode = (mode+1)%2;
        if(mode == 0) {
            cost = 0.001 ether; //whitelist price
        }
        else {
            cost = 0.002 ether; //pub price
        }
    }
