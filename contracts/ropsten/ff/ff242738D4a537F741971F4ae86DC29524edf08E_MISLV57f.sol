...
ERC20 Token
57f = 57e (Swapped functions - transfer to ETH) -  + marketingETHwallet - swaptoeth removal  
57d
57c = 57b and copied swap and liquify function contents into swapmarketingtoETH function and use the swapmarketingtoETH function in Transfer Call. 
*/
...
contract MISLV57f is Context, IERC20, Ownable {
    ...
    string private _name = "MISSLEv57f";
    string private _symbol = "MISLV57f";
    ...
    uint256 private _previousmarketingTokenFee = _marketingTokenFee;

    uint256 public _marketingETHFee = 1;
    uint256 private _previousMarketingETHFee = _marketingETHFee;

    address public marketingTokenFeeWallet = 0xAf99dc81bA48285b6A3AE0113721732d80F1Fae7;
    address public marketingETHFeeWallet = 0xAf99dc81bA48285b6A3AE0113721732d80F1Fae7;
    ...
    uint256 private _numTokensSellToAddToMarketing = 100000 * 10**9;
    ...
    function marketingConvertToETH() public view returns (bool) {
        return _marketingConverttoETH;
    }

     function numTokensSellToAddToMarketing() public view returns (uint256) {
        return _numTokensSellToAddToMarketing;
    }
    ...
    function _transfer(
        ...
        bool overMinTokenBalance = contractTokenBalance >= _numTokensSellToAddToMarketing;
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            from != uniswapV2Pair &&
            ...
            contractTokenBalance = _numTokensSellToAddToMarketing;
            //add liquidity
    ...
    function enableAllFees() external onlyOwner() {
        ...
        _marketingTokenFee = 1;
        _previousmarketingTokenFee = _marketingTokenFee;
        _marketingETHFee = 1;
        _previousMarketingETHFee = _marketingETHFee;
   ...
   // Number of Tokens to Accrue before Selling To Add to Marketing
	function setnumTokensSellToAddToMarketing(uint256 tokenAmount) external onlyOwner() {
       _numTokensSellToAddToMarketing = tokenAmount;
    }
