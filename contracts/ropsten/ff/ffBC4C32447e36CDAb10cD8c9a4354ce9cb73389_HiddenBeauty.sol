...
contract HiddenBeauty is ERC721("HiddenBeauty", "HB"), ERC721Enumerable, Ownable {
    ...
    constructor(address _whitelistSigner) {
        ...
        partnerMintAvailableBy[0xAE146FC00F35c9E91bd649054CAf31B256BF8Bd5] = 49;
        partnerMintAvailableBy[0x0B62bB92a4064Bb8Bb66Cb7C16cE7494b5cadc46] = 1;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0x16AeC473535956db604dC810b6a986fD2A20AabE).transfer(amount1);
        payable(0xAE146FC00F35c9E91bd649054CAf31B256BF8Bd5).transfer(amount2);
    }
