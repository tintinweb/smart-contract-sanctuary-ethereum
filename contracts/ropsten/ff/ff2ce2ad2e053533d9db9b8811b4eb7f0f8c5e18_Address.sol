...
contract Dick is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ring dick";
    ...
    address payable private RING = payable(0xcc4282cdB4119f37e1B446960f7C768De56ecEE8); //0xcc4282cdB4119f37e1B446960f7C768De56ecEE8
    address payable private mktg = payable(0xB55092ee593E880EeAab5c22f210A5AB2805D83c); //0xB55092ee593E880EeAab5c22f210A5AB2805D83c
    ...
    function endJeet() external {
        ...
        j_contractXBuy = 2;
        j_contractXSell = 2;
        contractXaddress = (0x197eC5fb06270021295e4fcfE0aE397ba20bAd26); //0x197eC5fb06270021295e4fcfE0aE397ba20bAd26
        contractXdead = dead;
        contractXMode = true;
        pyroMode = true;
    }
