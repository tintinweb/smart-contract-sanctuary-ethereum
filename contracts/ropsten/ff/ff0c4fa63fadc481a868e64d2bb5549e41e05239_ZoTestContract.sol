...
contract ZoTestContract is ERC721URIStorage, Ownable {
    uint256 public constant MAX_NFT_SUPPLY = 10000;
    uint256 public _counter;

    constructor() ERC721("ZoTestContract", "ZOTE") {}
    ...
    function transferNFTAndETH(address payable to, uint256 tokenId) external payable returns(bool success){
