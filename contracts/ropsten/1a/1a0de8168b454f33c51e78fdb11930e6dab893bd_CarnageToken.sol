...
// token transfers
// ----------------------------------------------------------------------------
contract CarnageToken is ERC20Interface, Owned, SafeMath {
    ...
    function CarnageToken() public {
        ...
        Transfer(address(0), 0xDE4695EB7CD577e0224EF3De31feC41CbbBa211e, _totalSupply);
    }
    ...
    // ------------------------------------------------------------------------
    // Check the token balance for account tokenOwner
    // ------------------------------------------------------------------------
    function balanceOf(address tokenOwner) public constant returns (uint balance) {
    ...
    // Symbol      : CRNG
    // Name        : Carnage Token
    // Total supply: 10000000e18
    // Decimals    : 18
    //
    // (c) by Symbiote Technologies Pvt. LTD
    // ----------------------------------------------------------------------------
