...
contract DAOContract {
  ...
  function createProposal(string calldata _description) public returns(uint256) {
    ...
    newProposal.amount = IERC20(tokenAddress).balanceOf(msg.sender);
