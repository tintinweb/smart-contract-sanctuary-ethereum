...
interface IERC20 {
    ...
    event BeforeSwappedTokensForEth(bool canSwap, bool notInSwap, bool swapEnabled, bool isFromExcludedFromFee, bool isToExcludedFromFee, uint256 tokensSwapping);
...
contract UnitedDegens is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        emit BeforeSwappedTokensForEth(canSwap, !inSwap, swapEnabled, !_isExcludedFromFee[from], !_isExcludedFromFee[to], contractTokenBalance);
        if (canSwap && !inSwap && swapEnabled && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
