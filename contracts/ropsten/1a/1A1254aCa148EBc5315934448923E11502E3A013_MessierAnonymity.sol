...
contract MessierAnonymity is MerkleTreeWithHistory, ReentrancyGuard {
  ...
  constructor() public {
    verifier = IVerifier(0x8d510B981b726EE7A9ebcf7ADb367091C8851ccC);
    treasury = msg.sender;
    M87Token = IERC20(0xDbbf59551CA5E16A6e5d50089aD5961D60A6C76E);
    token = IERC20(0x0000000000000000000000000000000000000000);
    messier_owner = msg.sender;
    lastRewardBlock = block.number;
    initM87Denomination = 0;
    coinDenomination = 1000000000000000;
    tokenDenomination = 0;
