...
contract BlockCities is ERC20, BaseContract {
    ...
    function transferPrice(
        ...
        address blockcitieAssetsAddress = manager.getAddress(_BlockCitiesAssets);
        require(msg.sender == blockcitieAssetsAddress, "Can be invoked by only blockcities asset contract");
    ...
    function setBlockCitiesAssets(string memory _assetAddress) public onlyOwner {
