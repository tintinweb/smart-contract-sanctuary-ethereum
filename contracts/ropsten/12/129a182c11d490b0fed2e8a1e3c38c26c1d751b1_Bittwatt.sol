...
contract EscrowContract {
    ...
    function EscrowContract (address creator,address beneficiary,uint amount,uint date) {
        creator_ = creator;
...
contract Bittwatt is Token,Claimable, PausableToken {
    ...
    function createEscrow(address _beneficiary, uint _amount, uint _date) public {
        address escrowContract = new EscrowContract(msg.sender,_beneficiary,_amount,_date);
        escrowContracts.push(escrowContract);
        this.transfer(escrowContract,_amount);
    }
