...
contract MoneyBolt is ERC20, ERC20Snapshot, Ownable, Pausable {
    ...
    bool is_taxed;
    uint256 tax_fee = 4;
    uint256 dividend = 1000; // set dividend to 100 for int tax, set to 1000 for decimal tax (0.4 example)
    address wallet_fees = address(0x0B92145b86cF2cC88FaDD573a8F35af6C1ee964d);
