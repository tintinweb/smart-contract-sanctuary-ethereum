...
contract Presale {
	...
	function BuyWDF(uint256 amount) public returns (bool success) {
        ...
        uint256 paid = _pricetoken * amount;
	...
	function BuyWDFETH() payable public {
        ...
        uint256 getwdf = _priceeth * amount;
	...
	function WithdrawSale( address receiver ) public isOwner {
        ...
        if(balance_ > 0){
            _token.transferFrom(address(this), receiver, balance_);
        }
    }
