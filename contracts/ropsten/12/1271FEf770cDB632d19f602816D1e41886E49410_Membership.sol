...
contract Membership is ERC1155, Ownable, Pausable {
    ...
    function setTier(uint256 id, string memory name, uint256 price, uint256 max) public onlyOwner {
        tiers[id] = Tier(id, name, price, max, 0);
        emit TierUpdated(id, name, price, max);
    }
