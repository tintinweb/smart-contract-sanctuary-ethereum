...
import { ILensHub } from "https://github.com/aave/lens-protocol/blob/main/contracts/interfaces/ILensHub.sol";
import { DataTypes } from "https://github.com/aave/lens-protocol/blob/main/contracts/libraries/DataTypes.sol";
...
contract Test {
    ...
    constructor(address _lensHub) {
        LENS_HUB = ILensHub(_lensHub);
    }

    function createPrfile(DataTypes.CreateProfileData calldata vars) external {
