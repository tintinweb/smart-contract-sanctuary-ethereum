...
contract ProxyRegistry is Ownable {
    ...
    */
    ...
    {
        require(proxies[msg.sender] == OwnableDelegateProxy(payable(0)));
...
contract TokenTransferProxy {
    ...
    function transferFrom(address token, address from, address to, uint amount)
        ...
        returns (bool)
    {
        require(registry.contracts(msg.sender),string.concat("TokenTransferProxy-> Caller not allow by registry.contracts"));
...
contract VaultTokenTransferProxy is TokenTransferProxy {
