...
contract MyNFT is ERC1155, Ownable {
    uint256[] supplies = [10, 50, 100];
    uint256[] minted = [0, 0, 0];
    uint256[] rates = [0.1 ether, 0.05 ether, 0.025 ether];
    ...
    function mint(uint256 id, uint256 amount) public payable {
        ...
        require(id > 0, "Token doesn't exits");
        uint256 index = id - 1;

        require(minted[index] + amount <= supplies[index], "Not enough supply");
        require(msg.value >= amount * rates[index], "Not enough ether to sent");
