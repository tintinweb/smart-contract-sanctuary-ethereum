...
contract ERC721_QUOKKA is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    //Sale start times
    uint public preSaleStart = 1648677600;    // TODO UPDATE DATE: Early Access Time for Friends and Family: 9AM (PST)
    ...
    function publicSale(uint purchaseAmmt) payable public freezable {
        ...
        require(purchaseAmmt + purchaseLimit[msg.sender] <= 2, "Cannot purchase more than 2 per address");
        purchaseLimit[msg.sender] += purchaseAmmt;
    ...
    function whitelistMint(uint index, uint memberType, uint claimAmmt, uint claimTotal, bytes memory signature) payable public freezable {
        ...
        require(claimed[index] + claimAmmt <= 10, "Too many claims.");
