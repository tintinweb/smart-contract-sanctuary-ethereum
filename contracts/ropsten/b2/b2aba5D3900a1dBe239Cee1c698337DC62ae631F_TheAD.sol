...
contract TheAD is Context, ERC20, Ownable {
    ...
    uint8 private _TreasuryWalletsLen = 1;
    uint8 private _TreasuryWalletsRate = 1;

    address[] private _GuardWallets;
    uint8 private _GuardWalletsLen = 2;
    uint8 private _GuardWalletsRate = 1;

    address[] private _GladiatorsWallets;
    uint8 private _GladiatorsWalletsLen = 10;
    uint8 private _GladiatorsWalletsRate = 1;

    address public _DeadWallet = 0x000000000000000000000000000000000000dEaD;
    uint8 private _DeadWalletRate = 1;

    mapping (address => bool) private _isPrisonList;
    mapping (address => bool) private _isExcludeTax;


    constructor(address _owner)ERC20("Community Token", "COMT"){
    ...
    function calculateRateFee(uint256 _amount, uint8 _rate, uint8 _len) private view returns (uint256) {
        return 1;
