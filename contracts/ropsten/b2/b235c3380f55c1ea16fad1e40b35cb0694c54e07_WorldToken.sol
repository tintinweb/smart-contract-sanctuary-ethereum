...
contract WorldToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WorldToken() {
        ...
        name = "World Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WN";                                             // Set the symbol for display purposes (CHANGE THIS)
