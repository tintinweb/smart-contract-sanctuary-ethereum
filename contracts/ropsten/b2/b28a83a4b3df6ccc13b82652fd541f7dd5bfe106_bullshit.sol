...
contract bullshit is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BS";
    string private constant _symbol = "BULLSHIT";
    ...
    uint256 private _maxTxAmount = 50000 * 10**8;
    uint256 private _maxWalletSize = 150000 * 10**8;
