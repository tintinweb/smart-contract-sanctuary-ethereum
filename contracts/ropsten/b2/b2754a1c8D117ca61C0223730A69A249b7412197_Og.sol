...
contract Og is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.0089 ether;
    uint256 public maxSupply = 7777;
    uint256 public maxOG = 40;
    uint256 public totalmintedOG = 0;
    ...
    function MintF(uint256 _mintAmount) public payable nonReentrant{
		...
		require(totalmintedOG+ _mintAmount <= maxOG, "Cant go over OG supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        ...
        require(s + _mintAmount <= maxSupply-maxOG, "Cant go over supply");
    ...
    function setmaxSupply(uint256 _newMaxSupply) public onlyOwner {
     ...
     function setmaxOGSupply(uint256 _newmaxOGSupply) public onlyOwner {
               maxOG = _newmaxOGSupply;
    }
