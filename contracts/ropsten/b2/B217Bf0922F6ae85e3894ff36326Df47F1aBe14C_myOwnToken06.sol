...
contract myOwnToken06 is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        schedule[0].date = 'July 14 2022 7:00 PM MSC';

        schedule[1].free = true;
        schedule[1].date = 'July 16 2022 7:00 PM MSC';

        schedule[2].free = true;
        schedule[2].date = 'July 21 2022 7:00 PM MSC';

        schedule[3].free = true;
        schedule[3].date = 'July 23 2022 7:00 PM MSC';                
