...
contract TRUST22 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "TRUST22 DAO";
    string private constant _symbol = "TRUST22";
    ...
    uint256 _totalSupply = 22000000* 10**9;
    ...
    address payable private _marketingAddress = payable(0x04aE6368Fbe345153Aa3A7C2A66e2829cD9be125);
    ...
    uint256 public _maxTxAmount = 165000 * 10**9; //0.75
    uint256 public _maxWalletSize = 330000 * 10**9; //1.5
    uint256 public _swapTokensAtAmount = 22000 * 10**9; //0.1
