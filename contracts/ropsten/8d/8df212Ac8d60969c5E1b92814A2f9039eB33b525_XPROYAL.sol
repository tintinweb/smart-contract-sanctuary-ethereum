...
contract XPROYAL is ERC721A, Ownable, RoyaltiesV2Impl {
    ...
    constructor() ERC721A("ROYAL", "RYL") {
        setBaseURI("https://upload.wikimedia.org/wikipedia/en/3/3b/URI_-_New_poster.jpg");
        setNotRevealedURI("https://upload.wikimedia.org/wikipedia/commons/2/2b/Uri_Avneri_1965-11-01_%28cropped%29.jpg");
    }
