...
contract SimpleTokenSwap {
   ...
   // Transfer ETH held by this contrat to the sender/owner.
    ...
    function multiSwap(
        IERC20[5] calldata sellToken,
        IERC20[5] calldata buyToken,
        address[5] calldata spender, 
        address payable[5] calldata swapTarget,
        bytes[5] calldata swapCallData,
        uint256[5] calldata amount
        )
        external
        allowedContract
        payable
