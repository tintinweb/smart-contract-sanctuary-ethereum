...
contract Jongo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3eb4Aa88af33858b1d6c28B9d2AeD5Fd1489cAD1); // Marketing Address
    ...
    string private _name = "Jongo";
    string private _symbol = "JONGO";
