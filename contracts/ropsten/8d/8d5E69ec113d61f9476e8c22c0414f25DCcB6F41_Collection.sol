...
contract Collection is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,10,0,1655135100,1655136300);
        epochs[2] = EpochDetails(1,2,0,1655136900,1655138100); 
        epochs[3] = EpochDetails(3,12,0,1655138700,0); 
        epochs[4] = EpochDetails(1,2,0,1655136900,0); 
    }
