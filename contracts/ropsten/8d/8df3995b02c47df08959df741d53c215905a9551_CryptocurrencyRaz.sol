...
contract CryptocurrencyRaz is Ownable {
    ...
    function getUserBetsInARazInstance(uint razNumber, uint instanceNumber) public constant returns(uint[],uint)
    {
        return (userBetsInEachRazInstance[razNumber][instanceNumber][msg.sender].bets,
                userBetsInEachRazInstance[razNumber][instanceNumber][msg.sender].timestamp);
    }
