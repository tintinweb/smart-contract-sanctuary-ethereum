...
contract GoE721Proxy is Proxy, GoE721Data {
     constructor (address proxied, string memory name_, string memory symbol_, string memory baseUri_, string memory baseExt_, uint256 maxSupply_, uint256 mintCost_) Proxy(proxied) {
        _name = name_;
        _symbol = symbol_;
        _baseUrl = baseUri_;
