...
// File contracts/tokens/YToken.sol
...
// File contracts/tokens/cronos/MNG.sol


pragma solidity 0.8.3;

contract MNG is YToken {
    ...
    constructor(
        ...
        _mint(msg.sender, 600_001 ether);
        _mint(_daoFund, 2_400_000 ether); // 8%
        _mint(_devFund, 2_400_000 ether); // 8%
        _mint(_treasuryFund, 2_400_000 ether); // 8%
        _mint(_reserve, MAX_TOTAL_SUPPLY - 2_400_000 * 3 ether - 600_001 ether);
        operator = msg.sender;
    }
