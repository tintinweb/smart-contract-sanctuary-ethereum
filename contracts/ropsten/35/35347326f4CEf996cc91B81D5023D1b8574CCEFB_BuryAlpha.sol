...
// BuryAlpha is the coolest pit in town. You come in with some Alpha, and leave with more! The longer you stay, the more ALPHA you get.
//
// This contract handles swapping to and from xAlpha, EdanSwap's staking token.
contract BuryAlpha is ERC20("tAlpha Staked Alpha ShibaSwap", "tALPHA"){
    ...
    // Enter the doghouse. Pay some ALPHAs. Earn some shares.
