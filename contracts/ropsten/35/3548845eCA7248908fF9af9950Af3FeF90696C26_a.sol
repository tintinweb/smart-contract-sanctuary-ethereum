...
contract a is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x94b30E1939e2c5347A62DFFA16989a551271Fc15); // 
    address payable private ecosystemWallet = payable(0x94b30E1939e2c5347A62DFFA16989a551271Fc15); // 
    address payable private devWallet = payable (0x94b30E1939e2c5347A62DFFA16989a551271Fc15); // 
    ...
    uint256 public _maxWalletToken = _tTotal.div(100).mul(4); 
    ...
    uint256 public _sellEcosystemFee =60;
