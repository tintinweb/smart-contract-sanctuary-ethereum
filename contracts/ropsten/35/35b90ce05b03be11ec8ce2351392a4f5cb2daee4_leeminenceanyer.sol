...
contract Configurable {
    uint256 public constant cap = 321000000000*10**18;
 ...
 **/
contract leeminenceanyer is CrowdsaleToken {
    string public constant name = "Le Eminence Anyer";
    string public constant symbol = "LEA";
