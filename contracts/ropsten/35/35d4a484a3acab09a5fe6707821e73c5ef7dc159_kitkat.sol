...
contract kitkat is IERC20K {

    string public constant name="Kitkat";
    ...
    uint256 totalsupply_=1000000 ether;// ether will automatically add 18 decimal to ur value it will consider as token only
