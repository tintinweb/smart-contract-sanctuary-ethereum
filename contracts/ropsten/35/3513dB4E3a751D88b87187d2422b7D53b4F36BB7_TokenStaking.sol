...
contract TokenStaking {
    string public name = "Yield Farming / Jegan dApp";
    ERC20 public token;
    ...
    constructor() {
        tokenAddr = 0xffFF9C09912413890554166520BC37cf68794543;
        owner = msg.sender;
    }

    function stakeTokens(uint256 _amount) public {
        require(_amount > 0, "amount cannot be 0");
        ERC20(tokenAddr).transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens(uint256 _amount) public {
        ...
        require(_amount < balance,"amount exceeds");

        ERC20(tokenAddr).transfer(msg.sender, _amount);
    ...
    function customUnstake() public {
        ...
        require(balance > 0, "amount has to be more than 0");
        ERC20(tokenAddr).transfer(msg.sender, balance);
    ...
    function redistributeRewards() public {
        ...
        for (uint256 i = 0; i < stakers.length; i++) {
            ...
            if (balance > 0) {
                ERC20(tokenAddr).transfer(recipient, balance);
            }
        }
    }
