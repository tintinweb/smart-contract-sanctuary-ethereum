...
contract auction is Ownable {
    ...
    function backEther (uint number) external {
        ...
        require(balances[msg.sender][number] > 0, "You didn't vote");
        require(block.timestamp > auctions[number].time, "Still open");
        require(auctions[number].bestBidAddr != msg.sender, "You are winner! Please check NFT on your account!");
    ...
    function changeToken(IERC20 _address) external onlyOwner {
        token = _address;
    }
