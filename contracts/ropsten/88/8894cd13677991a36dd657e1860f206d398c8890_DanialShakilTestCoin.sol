...
contract DanialShakilTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DanialShakilTestCoin() {
        ...
        name = "DanialShakilTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "Ubit2018-37";                                             // Set the symbol for display purposes (CHANGE THIS)
