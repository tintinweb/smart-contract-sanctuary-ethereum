...
library Address{
 ...
 contract SPACEPAWS is Context, IERC20, Ownable {
    ...
    uint256 public coolDownTime = 1000 seconds;
    ...
    uint256 public maxBuyLimit = 20_000_0000 * 10**9;
    uint256 public maxSellLimit = 20_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 40_000_0000 * 10**9;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x9C9e1FCd899Adf044db7f1345a6dc2551aAD99C1;
    address public CHARITYWallet = 0x9C9e1FCd899Adf044db7f1345a6dc2551aAD99C1;

    string private constant _name = "SPACE PAWS";
    string private constant _symbol = "SPAWS";
    ...
    Taxes public taxes = Taxes(0, 0, 2, 2);
    Taxes public selltax = Taxes(0, 0, 2, 2);
    ...
    function setselltax(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _CHARITY) public onlyOwner {
       selltax = Taxes(_rfi,_marketing,_liquidity,_CHARITY);
        emit FeesChanged();
    }
    ...
    function bulkIsBlacklisted(address[] memory accounts, bool state) external onlyOwner{
        ...
        function bulkIsWhitelisted(address[] memory accounts, bool state) external onlyOwner{
        for(uint256 i =0; i < accounts.length; i++){
            _isBlacklisted[accounts[i]] = state;
