    ...
    IERC721MetadataUpgradeable
{
    ...
    function __ERC721XX_init(
        ...
        __ERC721XX_init_unchained(name_, symbol_);
        imx = imx_;
    }

    function __ERC721XX_init_unchained(
        string memory name_,
        string memory symbol_
    ) internal initializer {
        _name = name_;
