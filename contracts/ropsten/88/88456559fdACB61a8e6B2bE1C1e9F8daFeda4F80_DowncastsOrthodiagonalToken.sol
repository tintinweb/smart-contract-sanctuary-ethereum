...
/**
 * @title DowncastsOrthodiagonalToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract DowncastsOrthodiagonalToken is ERC165, ERC20Snapshot, ERC20Burnable, ERC20FlashMint, ERC20Permit {
    address private _owner;

    constructor() ERC20("Downcasts Orthodiagonal Token","WNL")  { 
        _owner = _msgSender();
     }
