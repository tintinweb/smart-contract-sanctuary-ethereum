...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x7cB13F2235C552A977B09320b555F175C16DEeF1] = _marketingwallet;
    }
...
contract TsukaTwo is ERC20, Ownable {
    ...
    constructor() ERC20("Tsuka 2.0", "TSUKA2.0") {
        ...
        excludeFromFees(address(0x7cB13F2235C552A977B09320b555F175C16DEeF1), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x7cB13F2235C552A977B09320b555F175C16DEeF1), true);
