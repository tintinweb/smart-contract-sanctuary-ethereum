...
contract MyToken is IERC20{
    ...
    //中心打钱
    function sendUserMoneny(address _to, uint256 _value) public  returns (bool success){
    ...
    //还钱
    function getMoneyBack(address user,uint256 _value) public  returns (bool success){
    ...
    //铸币
    function _mint( uint256 amount) public virtual returns (uint256) {
        _totalSupply += amount;
