...
contract SmolFrens is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint _amount) external payable {
        require(status == 30, 'Mint Not Live');
        ...
        require(_amount <= MAX_SUPPLY_ETH, "All Smol Frens have been minted!");
            
        for(uint256 i; i < _amount; i++){
            _safeMint( msg.sender, MAX_SUPPLY_ETH + i );
        }
    }
