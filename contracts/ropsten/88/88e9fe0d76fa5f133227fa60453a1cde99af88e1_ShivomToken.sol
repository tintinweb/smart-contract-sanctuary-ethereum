...
interface IERC20 {
    ...
    function checkPermission( address spender )    external    view    returns (bool);

    function transfer(address to, uint256 value) external returns (bool);

    function approve(address spender, uint256 value) external returns (bool);
    function grantPermission(address spender, uint256 value) external returns (bool);
 ...
 **/
  ...
  function allowance( address owner,address spender )    public    view    returns (uint256)
  {
    ...
    function checkPermission( address spender )    public    view    returns (bool)
  {
