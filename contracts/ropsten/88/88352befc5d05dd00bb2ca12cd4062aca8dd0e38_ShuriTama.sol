...
contract ShuriTama is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x634785CCee01DbE1be6CF475A190418e70e5d823);
    address payable private _marketingAddress = payable(0x634785CCee01DbE1be6CF475A190418e70e5d823);
    ...
    uint256 public _maxTxAmount = 5000 * 10**9; //0.5
    uint256 public _maxWalletSize = 10000 * 10**9; //1
    uint256 public _swapTokensAtAmount = 5000 * 10**9; //0.1
