...
interface IInitializableAToken {
     ...
     * @param treasury The address of the Soup treasury, receiving the fees on this aToken
...
/**
 * @title Soup AToken enabled to delegate voting power of the underlying asset to a different address
...
contract AToken is VersionedInitializable, IncentivizedERC20('ATOKEN_IMPL', 'ATOKEN_IMPL', 0), IAToken {
    ...
    /**
     * @dev Returns the address of the Soup treasury, receiving the fees on this aToken
     **/
