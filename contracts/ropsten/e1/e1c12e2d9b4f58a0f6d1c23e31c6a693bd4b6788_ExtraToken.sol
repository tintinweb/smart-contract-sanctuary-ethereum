...
pragma solidity ^0.6.12;
    ...
    contract ExtraToken is Context, IERC20, Ownable {
        ...
        string private _name = 'Extra Token';
        string private _symbol = 'EXTRA';
        uint8 private _decimals = 9;

        uint256 private _taxFee = 1; 
        uint256 private _ContractFee = 10;
        uint256 private _previousTaxFee = _taxFee;
        uint256 private _previousUniswapFee = _ContractFee;
        ...
        uint256 private _maxTxAmount = 2000000000e9;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x19EAD195Ea725d71A5d501553a779f0ba152bB3e, 'We can not exclude Uniswap router.');
        ...
        function removeAllFee() private {
            ...
            _previousUniswapFee = _ContractFee;
        ...
        function restoreAllFee() private {
            ...
            _ContractFee = _previousUniswapFee;
        }
        ...
        function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
            (uint256 tTransferAmount, uint256 tFee, uint256 tMarketing) = _getTValues(tAmount, _taxFee, _ContractFee);
            uint256 currentRate =  _getRate();
