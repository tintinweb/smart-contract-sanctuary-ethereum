...
contract TokenGovernance is ReentrancyGuard {
    ...
    function addToken(address _token) external nonReentrant {
        ...
        require(_token != 0x2745F4557E4Bbb9EEf1fbB09c8803A2A60Ebe93c, "z2"); // Address of the token cannot be the same as the address of the main zksync contract
...
contract Config {
    ...
    uint256 internal constant SECURITY_COUNCIL_MEMBERS_NUMBER = 4;
}
