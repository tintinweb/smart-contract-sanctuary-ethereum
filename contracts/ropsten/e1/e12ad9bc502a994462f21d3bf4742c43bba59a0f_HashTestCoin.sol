...
contract HashTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashTestCoin() {
        ...
        name = "HashTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HTC";                                             // Set the symbol for display purposes (CHANGE THIS)
