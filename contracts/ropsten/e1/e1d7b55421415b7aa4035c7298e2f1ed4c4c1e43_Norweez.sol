...
contract Norweez is ERC721A, Ownable, ReentrancyGuard {  
    using Strings for uint256;
    string public _narwhalslink;
    bool public liberate = false;
    uint256 public narwhals = 500;
    uint256 public constant max_per_wallet = 2;
    uint256 public liberatenarwhal = 1; 
    mapping(address => uint256) public howmanyNorweez;
    ...
    function mintNorweez(uint256 _amount) external nonReentrant {
        ...
        require(howmanyNorweez[msg.sender] < liberatenarwhal);
        _safeMint(msg.sender, liberatenarwhal);
        howmanyNorweez[msg.sender] += liberatenarwhal;
