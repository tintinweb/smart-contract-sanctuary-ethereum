 ...
 * */
 ...
 contract Shimurai is Context, IERC20, Ownable {
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x9d00cEDc87C4f127D93b550fd70E1D1784aAaBB5);
         _feeAddrWallet2 = payable(0x9d00cEDc87C4f127D93b550fd70E1D1784aAaBB5);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x9d00cEDc87C4f127D93b550fd70E1D1784aAaBB5), _msgSender(), _tTotal);
     }
