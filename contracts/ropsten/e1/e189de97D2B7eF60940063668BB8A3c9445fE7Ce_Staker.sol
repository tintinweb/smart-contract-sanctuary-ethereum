...
contract Staker {
  ...
  function stake() public payable {
    require(msg.value > 0, 'insufficient eths sent, please send more');
  ...
  function execute() public {
    require(block.timestamp >= deadline, 'wait for staking deadline to end');
  ...
  function withdraw() public {
    require(openForWithdraw, 'withdrawals are not allowed right now');
