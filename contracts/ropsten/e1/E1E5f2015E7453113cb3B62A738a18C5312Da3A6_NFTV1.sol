...
contract NFTV1 is ERC721Tradable, ERC2981, Mintable {
    ...
    // EVENTS
    event evtNFTCreated(address new_owner, uint256 _tokenId);
    ...
    constructor(
        ...
        address _imx
    ) public ERC721Tradable(_name, _symbol, _owner) Mintable(_owner, _imx) {
        gameOwner = _owner;
        gameName = _name;
    ...
    function contractURI() public pure returns (string memory) {
        //return "https://nfting.zoidsnft.com/api/v1/meta/eth/contract-meta";
        return "https://zoidsnft.com/api/meta/contract-meta";
    }

    function baseTokenURI() public pure override returns (string memory) {
        //return "https://nfting.zoidsnft.com/api/v1/meta/eth/";
        return "https://zoidsnft.com/api/meta/";
    }
