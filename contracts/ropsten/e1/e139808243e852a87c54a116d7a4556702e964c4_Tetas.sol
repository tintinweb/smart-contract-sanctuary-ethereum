...
contract DiamondDividendTracker is DividendPayingToken, Ownable {
    ...
    function _approve(
        ...
        require(false, "Tatas_Dividend_Tracker: No approvals allowed");
    }
    ...
    function _transfer(
        ...
        require(false, "Tatas_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Tatas_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Tatas contract."
        );
    }
...
contract Tetas is ERC20, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    string private constant _name = "Tetas";
    string private constant _symbol = "TETAS";
    ...
    function openTrading(uint256 _launchTime, uint256 _minutesForPrivateSale)
        ...
        onlyOwner
    {
        require(!tradingOpen, "Tetas: Trading is already open");
        require(_launchTime > block.timestamp, "Tetas: Invalid timestamp");
    ...
    function _claim(address payable _account, bool _reinvest) private {
        ...
        require(
            ...
            "Tetas: Claimer has no withdrawable dividend"
        );
        uint256 ethAmount;
        uint256 tokenAmount;
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                ...
                "Tetas: Private and public sale is not open"
            );
            if (
                privateSaleTimestamp <= block.timestamp &&
        ...
        if (!automatedMarketMakerPairs[_to] && !isExludeFromWalletLimit[_to]) {
            ...
            require(
                ...
                "Tetas: Wallet balance limit reached"
            );
        }
    ...
    function _setAutomatedMarketMakerPair(address _pair, bool _value) private {
        require(
            ...
            "Tetas: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[_pair] = _value;
