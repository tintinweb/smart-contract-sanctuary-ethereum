...
* 300,000 tokens on offer, no more can be created once quota filled - last buyer can over subscribe.
* If company gets baught out, ICO Token holders will get paid their share of the buyout via a final payout
*/
