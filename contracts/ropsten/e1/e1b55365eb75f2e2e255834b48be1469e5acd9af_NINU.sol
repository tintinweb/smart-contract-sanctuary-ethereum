...
contract NINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "NINU";//
    ...
    address payable private _developmentAddress = payable(0x9da6ff09e646Ec030fCfFa299dDd6142d855EB9C);//
    address payable private _marketingAddress = payable(0x729aE92C820D9e01E5f059F97C1010e22Fb24775);//
