...
contract Human1StandardToken is StandardToken { 
    ...
    function Human1StandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
