...
// Teammates World Decentralized Exchange Contract
// https://teammatesworld.co.in/
contract teammatesworld is Pausable {
    // Trade & order types
    ...
    bytes32 public constant ETH_SIGN_TYPED_DATA_ARGHASH ="0x";
    ...
    function teammatesworld(address _signer) public {
