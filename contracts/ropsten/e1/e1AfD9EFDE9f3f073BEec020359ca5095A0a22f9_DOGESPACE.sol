...
contract DOGESPACE is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("DOGESPACE", "DOGESPACE") {}
    
    uint256 public collectionSize = 5100;
    ...
    // allowList mint
    uint256 public allowListMintPrice = 20.000000 ether;
    // default false
    bool public allowListStatus = false;
    uint256 public amountForAllowList = 2000;
    uint256 public immutable maxPerAddressDuringMint = 500;
    ...
    uint256 public publicPrice = 30.000000 ether;
    uint256 public amountForPublicSale = 3100;
