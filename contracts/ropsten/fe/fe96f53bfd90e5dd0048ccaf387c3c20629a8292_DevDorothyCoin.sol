...
contract DevDorothyCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DevDorothyCoin() {
        ...
        name = "DevDorothyCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DevDOC";                                             // Set the symbol for display purposes (CHANGE THIS)
