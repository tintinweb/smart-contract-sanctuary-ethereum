...
interface IMarket {
    ...
    function adminUpdateContract(address treasury) external;
}
interface ITreasury {
...
contract MarketPlaceFactory {
    ...
    function createContract(address treasury) external returns (address contractCreated) {
        ...
        address dummyTreasury = address(new MarketTreasury());
        ITreasury(contractCreated).initialize(address(this));
        
        IMarket(contractCreated).initialize(dummyTreasury);
        IMarket(contractCreated).adminUpdateConfig(0, 300, 0, 0);
        IMarket(contractCreated).adminUpdateContract(treasury);
