...
/**
    ...
    Bully Maguire Inu is the Will Smith Inu Killer and the next hottest crypto meme this bull run! We are an experienced DeFi native team, a community of chads; and most importantly the NEXT bullish meme in the hottest bull market of 2022! $BMI to the moon!

    *Social*
    Telegram: t.me/bullymaguireinu
    Twitter: twitter.com/BulyMaguireInu
    Website: https://bullymaguireinu.com/
*/
...
contract BullyMaguireInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bully Maguire Inu", "BMI") {
