...
contract MessageValidator is OwnableUpgradeable {
    ...
    function setBlockMaxThreshold(uint _blockMaxThreshold) public onlyOwner
    {
    ...
    modifier isValidBlock(uint transBlock)
    {
        ...
        // console.log("blockMaxTreshold: %s", blockMaxThreshold);
         console.log("block number: %s", block.number);

        require(block.number <= transBlock + blockMaxThreshold, "block exceeded the threshold");        
        _;   
    }
