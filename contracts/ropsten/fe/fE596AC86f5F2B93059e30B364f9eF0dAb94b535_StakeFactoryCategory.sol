...
contract StakeFactoryCategory is Ownable{
    ...
    function addCategory(uint8 _stakingType,bytes memory _categoryName,bytes memory _description,address _factoryAddress) public onlyOwner{
        require(!stakeCategory[_stakingType].exist,"staking type is exist");
        stakeCategory[_stakingType]=Category({
            exist:true,
