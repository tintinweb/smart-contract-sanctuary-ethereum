...
contract StakeFactoryCategory{
    ...
    function updateCategory(uint8 _stakingType,bytes memory _categoryName,bytes memory _description,address _factoryAddress) public{
        require(stakeCategory.length>_stakingType&&stakeCategory[_stakingType].exist,"staking type is not exist");
        stakeCategory[_stakingType].categoryName=_categoryName;
        stakeCategory[_stakingType].description=_description;
        stakeCategory[_stakingType].factoryAddress=_factoryAddress;
