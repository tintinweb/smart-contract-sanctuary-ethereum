...
contract WatchChain is ERC1155Holder,
    ...
    event SwapSharesToQuoteToken(uint256 watchId,uint256 totalSwapped);
    ...
    function proposalAccepted(uint256 watchId,uint256 id,address proposer,uint256 price) internal{
        ...
        watches[watchId].soldPrice=price;
    ...
    function swapSharesToQuoteToken(uint256 watchId) 
        ...
        uint256 swapRemaining=watch.soldPrice-watch.swapped;
        if(usdtAmount>swapRemaining){
            usdtAmount=swapRemaining;
        }
        ...
        emit SwapSharesToQuoteToken(watchId,watch.swapped);
    }
