...
// SPDX-License-Identifier: MIT
  ...
  //StakeWithAmd
   ...
   function withdrawInWolve(uint256 count) public {
       ...
       //require(user.stakerecord[count].stakeTime == completed ,"you canot withdraw before time completed");
   ...
   function extendStake(uint256 count,uint256 newplan) public {
      ...
      // require(user.stakerecord[count].stakeTime != ,"This stake is already withdrawn.");
    ...
    function migrateV1(address[] memory userList) external onlyOwner returns (bool){
        ...
        require(migrationCheck == true,"Owner  can not called this function again.");
