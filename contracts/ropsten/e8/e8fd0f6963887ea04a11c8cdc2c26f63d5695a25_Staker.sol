...
contract Staker is ERC721Holder, ReentrancyGuard, Ownable {
    ...
    IERC20 public stakingToken20 = IERC20(0x54D3FC5230C02cd4838601409A348041655903A2);

    uint256 public cal;
    uint256 public totalStakeBonus;
    uint256 public totalBurntCount;
    uint256 public bonusPoolTokens;
    uint256 public bonusPoolDailyDist;
    uint256 public burntTokenCount;
    uint256 public dailyTokenDist;
    uint256 public stakingBonusCount;
    uint256 public burntTokenMult;
    uint256 public dailyBonusPoolDist;
    uint256 public yearlyTokenDist;
    ...
    function userPending(address user) public returns (uint256) {
    ...
    function _calculateRewards(address stakeHolder) internal returns (uint256) {
        /*
        uint256 cal;
