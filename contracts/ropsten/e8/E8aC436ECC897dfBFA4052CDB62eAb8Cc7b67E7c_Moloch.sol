...
contract Moloch is ReentrancyGuard {
    ...
    ***************/
    ...
    uint256 public constant MAX_NUMBER_OF_SHARES_AND_LOOT = 10**18; // maximum number of shares that can be minted
    uint256 public constant MAX_TOKEN_WHITELIST_COUNT = 40; // maximum number of whitelisted tokens
    uint256 public constant MAX_TOKEN_GUILDBANK_COUNT = 20; // maximum number of tokens with non-zero balance in guildbank
    ...
    event SubmitProposal(address indexed applicant, 
    ...
    *****************/
    function submitProposal(
        ...
        if (tributeOffered > 0 && userTokenBalances[GUILD][tributeToken] == 0) {
            require(totalGuildBankTokens < MAX_TOKEN_GUILDBANK_COUNT, "no more tribute proposals allowed - guildbank full");
        }
    ...
    function _ragequit(address memberAddress, uint256 sharesToBurn, uint256 lootToBurn) internal {
        ...
        require(canRagequit(member.highestIndexYesVote), "highestIndexProposalMember must be processed"); 
    ...
    ***************/
    ...
    function fairShare(uint256 balance, uint256 shares, uint256 _totalShares) internal pure returns (uint256) {
        require(_totalShares != 0, "_totalShares cannot be 0");
