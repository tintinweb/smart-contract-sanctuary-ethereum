...
contract ERC1155Stardust is Initializable, ERC1155Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory uriStr, address imxAddress) public initializer {
        __ERC1155_init(uriStr);
        __Ownable_init();
        __UUPSUpgradeable_init();
        imxAuthority = imxAddress;
    }
    ...
    function setImxAuthority(address imxAddress) public onlyOwner {
        imxAuthority = imxAddress;
    }
    ...
    function mintFor(
        ...
        require(imxAuthority == _msgSender(), "UNAUTHORIZED");
