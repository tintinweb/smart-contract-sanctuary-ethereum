...
contract ETHPool is AccessControl {
    ...
    uint256 totalStaked;
    bool depositReward;
    uint256 rewardInterval = 30 minutes; // 604800 / 24 / 60; // 86400 = 1 day
   ...
   // 604800
    ...
    function calculateReward(address _sender) public view returns (uint256) {
        ...
        //Fazer o calculo baseado no dia que fez o deposito
        // 7 dias - timestamp que o usuario fez o deposito

        uint256 userInterval = userInfos[_sender].startTimestamp;
