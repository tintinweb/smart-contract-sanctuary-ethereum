...
contract MarketPlace is BasePlace {
    ...
    function getMessageHash(address nftContract, uint256 tokenId, address seller, uint256 price, uint256 expiry, address creatorAddress, uint256 creatorRoyalty) external pure returns (bytes32) {
