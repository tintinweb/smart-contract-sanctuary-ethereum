...
contract GmoneyToken is Context, IERC20, Ownable {
    ...
    string private _name = "GMONEY Token";
    ...
    address public buyBackAddress = 0x45D429376328813df3b8d103EE2f84bd0D2806F6;
    address public marketingAddress = 0x4E08c6Fc8DBd270a8B5b83164d8b8fa18f7A3aEc;
    address public devAddress = 0x18C18c4bF8Ac39363fe9bF21E3C89BAa6B5193E0;
...
contract DividendTracker is IERC20, Context, Ownable {
    ...
    string private _name = "GMONEY TRACKER";
    string private _symbol = "GMNYT";
    uint8 private _decimals = 9;
    ...
    GmoneyToken private gmoneyToken;
    ...
    function setTokenBalance(address account) external {
        uint256 balance = gmoneyToken.balanceOf(account);
        if(!gmoneyToken.isExcludedFromRewards(account)) {
    ...
    function setERC20Contract(address contractAddr) external onlyOwner {
        gmoneyToken = GmoneyToken(payable(contractAddr));
    }
