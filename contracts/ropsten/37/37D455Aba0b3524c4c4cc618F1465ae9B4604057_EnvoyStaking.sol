...
contract EnvoyStaking is Pausable, AccessControl {
    ...
    function _addStake(address _beneficiary, uint256 _totalStake, uint256 _lockupPeriod, bool _isEmbargo) internal whenNotPaused {
        ...
        Stake memory stake = Stake({exists:true,
                                    ...
                                    apy: calculateAPY(_lockupPeriod),
                                    claimed:false,
    ...
    function calculateRewards(uint256 initialAmount, uint256 lockupPeriod, uint256 apy) public pure returns (uint256) {
        uint256 totalRewards = initialAmount * apy * lockupPeriod / 120000;
    ...
    function createEmbargo(address _account, uint256 _totalStake, uint256 _lockupPeriod) public {
    ...
    function _setupInitialAPYs() public {
        _setAPY(1, 0, 500000, 1000);
        _setAPY(1, 500000, 1000000, 900);
        _setAPY(1, 1000000, 5000000, 800);
        _setAPY(1, 5000000, 10000000, 700);
        _setAPY(1, 10000000, 50000000, 625);
        _setAPY(1, 50000000, 100000000, 575);
        _setAPY(1, 100000000, 10000000000, 500);

        _setAPY(3, 0, 500000, 1600);
        _setAPY(3, 500000, 1000000, 1440);
        _setAPY(3, 1000000, 5000000, 1280);
        _setAPY(3, 5000000, 10000000, 1120);
        _setAPY(3, 10000000, 50000000, 1000);
        _setAPY(3, 50000000, 100000000, 920);
        _setAPY(3, 100000000, 10000000000, 800);

        _setAPY(6, 0, 500000, 2200);
        _setAPY(6, 500000, 1000000, 1980);
        _setAPY(6, 1000000, 5000000, 1760);
        _setAPY(6, 5000000, 10000000, 1540);
        _setAPY(6, 10000000, 50000000, 1375);
        _setAPY(6, 50000000, 100000000, 1265);
        _setAPY(6, 100000000, 10000000000, 1100);

        _setAPY(9, 0, 500000, 2600);
        _setAPY(9, 500000, 1000000, 2340);
        _setAPY(9, 1000000, 5000000, 2080);
        _setAPY(9, 5000000, 10000000, 1820);
        _setAPY(9, 10000000, 50000000, 1625);
        _setAPY(9, 50000000, 100000000, 1495);
        _setAPY(9, 100000000, 10000000000, 1300);

        _setAPY(12, 0, 500000, 3000);
        _setAPY(12, 500000, 1000000, 2700);
        _setAPY(12, 1000000, 5000000, 2400);
        _setAPY(12, 5000000, 10000000, 2100);
        _setAPY(12, 10000000, 50000000, 1875);
        _setAPY(12, 50000000, 100000000, 1725);
        _setAPY(12, 100000000, 10000000000, 1500);
    }
