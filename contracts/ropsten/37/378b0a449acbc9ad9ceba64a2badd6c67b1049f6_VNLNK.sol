...
contract VNLNK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Vinlink", "VNLNK") {
    	...
    	developmentWallet = address(0x3A23ACf34007De8F3f234d7e465722481508B6c9); // set as marketing wallet
    	treasuryWallet = address(0xc33191a0A2596813D01842A43c4fb781Ff793c08); // set as buyback wallet
