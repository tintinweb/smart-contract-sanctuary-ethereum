...
/// @author Global Group - <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d1b6b6bdbeb3b0bdb8abb4b591b6bcb0b8bdffb2bebc">[email&#160;protected]</a>>
library SafeMath {
...
contract Lottery is Owned{
    ...
    uint256 public constant ROUND_DURATION = 2000; //5300; 23 hours
    ...
    event BuyTicket(uint32 _num1,uint32 _num2, uint32 _num3, uint32 _num4, uint32 _num5, uint32 _num6, uint256 _ticketNumber);
	function buyTicket(uint32 _num1,uint32 _num2, uint32 _num3, uint32 _num4, uint32 _num5, uint32 _num6) public returns(uint256 _ticketNumber) {
		...
		emit BuyTicket(_num1, _num2, _num3, _num4, _num5, _num6, ticketsCounter - increment);
