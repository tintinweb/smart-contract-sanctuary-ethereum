    ...
    */
    ...
    function buyLevel(uint8 level, uint256 investAmount) public payable {
        ...
        if (isRootUser) {
            ...
            users[msg.sender].credit += amountForRootUser;
        ...
        if (rewardAddress != msg.sender) {
            ...
            if (sent) {
                ...
                users[msg.sender].credit += restOfAmount;
    ...
    function getBalances() public view returns (uint256 counter, uint256 regFee, uint256 marketingFee, address[] memory userAddrs, uint256[] memory debits, uint256[] memory credits) {
