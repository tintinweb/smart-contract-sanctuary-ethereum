 ...
 */
contract RT3D is Context, IERC20, Ownable, AntiWhale {
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;

    string private _name = "Real-Time 3D";
    string private _symbol = "RT3D-1";
    uint8 private _decimals = 18;

    uint256 constant maxCap = 300000000000 * (10**18);
