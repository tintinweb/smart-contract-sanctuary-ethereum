...
contract FinalTest3 is ERC20, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    string private constant _name = "FinalTest3";
    string private constant _symbol = "FinalTest3";
    ...
    uint256 private walletLimitPercentage = 50; // 0.5% of total supply
    ...
    function _transfer(
        ...
        if (
            ...
            if (
                ...
                walletLimitPercentage = 10; //change walletLimit to 0.1%
                require(
        ...
        //update wallet limit to default
    ...
    function getHistory(
        ...
        require(start < userClaimedCount, "Diamond: Out of range"); // 0 < 124 = true
