    ...
    function createThenLinkProfile(
        ...
        ProfileLogic.createProfile(
            DataTypes.CreateProfileData({
                to: to,
                handle: Strings.toHexString(uint256(uint160(to))),
                uri: "",
