 ...
 */
contract ProjectStarterPro is ERC721, Ownable {
    using SafeMath for uint256;

    address public ownerWalletAddress;

    constructor() ERC721("ProjectStarterPro", "PSPRO") public {
    ...
    */
    function mintPro(address payable recipient, string memory uri) public   payable returns(uint256) {
