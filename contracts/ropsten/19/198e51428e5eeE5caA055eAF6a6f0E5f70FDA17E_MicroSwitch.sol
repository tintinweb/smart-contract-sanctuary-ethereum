...
*/
    ...
    function addingLiquiditySwitch() external {
        ...
        token.transferFrom(msg.sender, address(this), availableMicro);
        token2.transferFrom(msg.sender, address(this), availableMatic);
...
*/
    ...
    function MicroBuyPrice() external payable returns (uint256[] memory) {
        // do something here
    }
