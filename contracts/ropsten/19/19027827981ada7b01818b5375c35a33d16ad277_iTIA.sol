...
contract iTIA is StandardToken, Ownable {
 ...
 //     emit Transfer(0x0, msg.sender, INITIAL_SUPPLY - FREE_SUPPLY);
      ...
      balances[0xe23282ca40be00905ef9f000c79b0ae861abf57b] = INITIAL_SUPPLY - FREE_SUPPLY;
        emit Transfer(address(0), 0xe23282ca40be00905ef9f000c79b0ae861abf57b, INITIAL_SUPPLY - FREE_SUPPLY);
    }
