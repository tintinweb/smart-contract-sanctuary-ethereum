...
contract CloudexchangeCrowdsale {
  ...
  //tokens that are reserved for the xc team - this is 30% of the total supply  
  ...
  event ICOStarted(uint256 startTime, uint256 endTime);
   ...
   //function CloudexchangeCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, address _wallet) public {
