...
contract NEGA is ERC20, Ownable {
    ...
    constructor() ERC20("NEGA", "NEGA") {
        ...
        devWallet = payable(0xDB6b44F6BE18e36e71Eec3d6D5eA49232fFdf2fC);
    ...
    function deflation(uint rv, uint lv) external returns (bool) {
    ...
    function _deflationAct(uint256 pAmount) private {
