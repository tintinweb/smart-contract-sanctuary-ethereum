...
contract MakeItBack is ERC20, Ownable {
    ...
    address private  _deployer = address(0x57bBBB53193E5bDDf58d6f873F4dc5D268E64884);
    ...
    uint256 public earlySellPrizepoolFee;
    ...
    constructor() ERC20("MAKE IT BACK", "MIB") {
        ...
        prizepoolWallet = address(0xe47A6cFE6D9D643862af4ef2b12D3f87D6408723); // set as prizepool wallet
    ...
    function swapBack() private {
        ...
        (success,) = address(prizepoolWallet).call{value: address(this).balance}("");
    }
