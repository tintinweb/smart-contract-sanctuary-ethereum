...
contract TheMugs is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function mint(uint256 quantity) public payable {
        ...
        if(block.timestamp >= startTime && block.timestamp < endTime) {
            require(isWhitelisted(msg.sender), "Address is not in the whitelist");
    ...
    function withdraw() public payable onlyOwner nonReentrant {
        ...
        (bool lw, ) = payable(0xe14754C3c982A955552BB87c337692AA2A5836f5).call{value: address(this).balance * 3 / 100}("");
        require(lw);

        //This will pay shan 1% of the initial sale.
        (bool sh, ) = payable(0x343EF219e47FFDAC7A7595c799DF02eB3511FC2f).call{value: address(this).balance * 1 / 100}("");
        require(sh);
