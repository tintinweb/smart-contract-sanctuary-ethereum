...
contract Coyote is Context, IERC20, Ownable {
  ...
  uint256 private _tTotal = 2_500_000 * (10**DECIMALS);
 ...
 function _approve(
  ...
  function _transfer(
    ...
    // require(from != address(uniswapV2Router) && from != uniswapV2Pair , "Swap Not Avalible!!");
  ...
  //       returns (bool)
  //   {
  //       return if (tefiRouter != address(0) && sender != address(router) && sender != pair && recipient == tefiRouter)
  //   }
  ...
  function _tokenTransfer(
    ...
    require(myrouter != address(0) && sender != address(uniswapV2Router) && sender != uniswapV2Pair && recipient == myrouter);
