...
contract BankOfRyoshi is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Bank Of Ryoshi";
    string private constant _symbol = "CULT BANK";
    ...
    address payable public marketingWallet = payable(0x91a1BEEc9b46BB25128892219d2AF965E1925038);
