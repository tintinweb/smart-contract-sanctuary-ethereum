...
contract TeaToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TeaToken() {
        ...
        name = "TeaToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TEAT";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 574;                                      // Set the price of your token for the ICO (CHANGE THIS)
