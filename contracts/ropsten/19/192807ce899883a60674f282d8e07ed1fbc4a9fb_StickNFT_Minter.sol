...
/**
 * @title Stick NFT Minter Contract
 */
contract StickNFT_Minter is ERC721URIStorage{
    ...
    constructor() ERC721("Stick NFTs", "SNFT") {
    }
    ...
    /* 
        ...
        @param _tokenURI IPFS/Pinata URI link
    */
    function MintNFTs(string memory _tokenURI) public {
