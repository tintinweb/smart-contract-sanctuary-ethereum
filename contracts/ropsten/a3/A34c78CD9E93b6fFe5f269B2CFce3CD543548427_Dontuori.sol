...
contract Dontuori is IERC20{
    ...
    modifier onlyOwner(){
        require(msg.sender == owner, "Voce nao tem as honrarias necessarias para tanto");
        _;
    }
    ...
    function transferFrom(address _from,address _to,uint _amount) external override returns (bool){
        ...
        require(_to != address(0), "Mandando para o Address 0");
        require(_allowances[_from][msg.sender] >= _amount, "Saldo Insuficiente");
