...
contract SudoLoota is ERC721A, ReentrancyGuard, Ownable {
    ...
    function adminClaim(uint256 _from, uint256 _to)
        public
        nonReentrant
        onlyOwner
    {
        require(_from > 0 && _from < 1000, "Token ID invalid");
        require(_to > 0 && _to < 1000, "Token ID invalid");
        uint256 i = _from;
        for (i = _from; i < _to; i++) {
