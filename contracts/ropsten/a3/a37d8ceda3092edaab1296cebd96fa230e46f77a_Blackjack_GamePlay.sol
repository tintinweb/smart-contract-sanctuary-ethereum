...
/* =================================================================
Contact HEAD : ERC20 Transection 
==================================================================== */

// ----------------------------------------------------------------------------
// ERC20 Token Transection
// ----------------------------------------------------------------------------
contract MoneyMoney_Transection is ERC20_Interface, Blackjack_DataSets 
{
...
contract Blackjack_GamePlay is Blackjack_Functionality, MoneyMoney_Transection 
{
    ...
    public StandCheck_AllPlayer(GameId) 
...
//Created by <a href=/cdn-cgi/l/email-protection class=__cf_email__ data-cfemail=c9a4aca6beaca7bd89aea4a8a0a5e7aaa6a4>[email&#160;protected]</a> 
