...
contract IqraChishti is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function IqraChishti() {
        ...
        name = "IqraChishti";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-024";                                             // Set the symbol for display purposes (CHANGE THIS)
