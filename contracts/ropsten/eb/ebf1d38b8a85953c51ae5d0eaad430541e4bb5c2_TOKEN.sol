...
// SPDX-License-Identifier: MIT
    ...
    contract TOKEN is ERC20 {
        ...
        constructor () ERC20("MILTEST", "MILT"){

            _marketingWalletAddress = 0xde11FC90870297C69D03c8d91e1Fb7997ce6D642;
            ...
            _isWhiteListed[_marketingWalletAddress] = true;
        ...
        function mint(uint256 tokens) external onlyOwner {
              _mint(owner(), tokens * 10 ** decimals());		
        }
