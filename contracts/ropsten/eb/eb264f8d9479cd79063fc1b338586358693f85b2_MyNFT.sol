...
contract MyNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("MyNFT", "QNFT") {}

    // function _baseURI() internal pure override returns (string memory) {
    //     return "ipfs://QmSSXDnZffHqkKB4nBGY3iETp1MKb8Nzgs8tHVdmd4XKiR";
    // }

    function safeMint(address to, string memory uri) public payable{
       require(totalSupply() < MAX_SUPPLY, "YOU CAN'T MINT MORE NFTS");
    ...
    //To Withdraw ether which was collected by Just Owner
...
// ipfs://QmawoDynLF7ZeT8eMeaSyaKqQQ8TEZ6tDosXyEpHTymhLM