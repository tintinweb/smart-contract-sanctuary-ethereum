...
contract ThisTheOne is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("ThisTheOne", "Test") {}

    function mint(uint256 num) public payable {
        require(totalSupply() + num < MAX_SUPPLY, "no more mints lol fucked");
        require(msg.value >= mintRate * num, "The Mint Rate is 0.1");
    ...
    function withdraw() public onlyOwner{
        require(address(this).balance > 0, "deez");
