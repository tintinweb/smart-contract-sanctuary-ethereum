...
contract BayCoin is ERC20 {
    ...
    modifier onlyOwner() {
        ...
        function BayCoin  () public {
        owner = msg.sender;
        uint256 TeamTokens = 1000000000000;
