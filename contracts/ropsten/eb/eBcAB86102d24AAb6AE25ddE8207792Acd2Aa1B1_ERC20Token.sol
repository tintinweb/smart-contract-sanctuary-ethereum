...
contract ERC20Token is ERC20, Ownable, Pausable, Initializable {
    constructor(
        string memory name_,
        ...
        initialize(name_, symbol_, decimals_, initialAccount, initialBalance);
    }
    ...
    function getBlocklist(address addr) public onlyOwner view returns(bool) {
