...
contract NFT is Ownable, ERC721Checkpointable, Lottery {
    ...
    bool public RreSaleIsActive = true;
    ...
    uint256 public constant Lottery_PRICE = 0 ether;
    uint256 public constant PRICE = 0.1 ether;
    mapping(address => uint8) private _allowList;
    mapping(address=>uint8)public LotteryAllow;
    ...
    function presalemint(uint numberOfTokens) public payable {
        uint256 ts = totalSupply();
        require(RreSaleIsActive, "Pre sale must be active to pre sale mint tokens");
        require(numberOfTokens <= MAX_PUBLIC_MINT, "Exceeded max token purchase");
        require(ts + numberOfTokens <= MAX_SUPPLY, "Purchase would exceed max tokens");
