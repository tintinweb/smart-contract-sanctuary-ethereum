...
contract ValueShuttle {
    ...
    function swap(
        ...
        amountOut = amountInWithFee * uint256(reserve0) / (uint256(reserve1) * 1e4 + amountInWithFee);
    ...
    function addLiquidity(
        ...
        uint256 amountIn1 = maxAmountIn0 * uint256(reserve1) / uint256(reserve0);
        ...
        if (amountIn1 > maxAmountIn1) {
            ...
            maxAmountIn0 = maxAmountIn1 * uint256(reserve0) / uint256(reserve1);
        }
