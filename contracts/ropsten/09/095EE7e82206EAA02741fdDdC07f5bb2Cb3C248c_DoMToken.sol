...
contract DoMToken {
    string constant public name = "Dogs Of Moon";
    string constant public symbol = "DOM";
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'DOM: EXPIRED');
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'DOM: INVALID_SIGNATURE');
