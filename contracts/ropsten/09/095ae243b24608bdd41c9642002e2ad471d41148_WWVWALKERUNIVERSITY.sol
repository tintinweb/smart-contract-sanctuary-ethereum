...
contract WWVWALKERUNIVERSITY {
    // Name your custom token
    string public constant name = "WALKERUNIVERSITY";

    // Name your custom token symbol
    string public constant symbol = "WWV";
    ...
    constructor() public {
        ...
        treasury = address(0xa002780e605637176535401BAbF7E0F617015182);
