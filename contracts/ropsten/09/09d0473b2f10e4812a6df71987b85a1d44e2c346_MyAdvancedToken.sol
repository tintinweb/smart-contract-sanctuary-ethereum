...
contract CCXTokenERC20 {
    string public constant _myTokeName = 'GYQCoin';//change here
    string public constant _mySymbol = 'GYC';//change here
    uint public constant _myinitialSupply = 2000000;//leave it
...
contract MyAdvancedToken is owned, CCXTokenERC20 {
    ...
    /* Initializes contract with initial supply tokens to the creator of the contract */
    function MyAdvancedToken() CCXTokenERC20() public {}
