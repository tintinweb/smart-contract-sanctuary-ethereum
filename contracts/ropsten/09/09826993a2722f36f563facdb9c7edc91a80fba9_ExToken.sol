...
contract ExToken is PausableToken {
    ...
    constructor()  public   {
        ...
        // assign the total tokens to Ex 1 B
        totalSupply_ = 1 * 1000 * 1000 * 1000 * 1000000000000000000;

        // air-drop supply 
        uint256 airdrop = (totalSupply_ * (100-mintPct)) / 100;
    ...
    */
    function mint(address _to,uint256 _amount) hasMintPermission public returns (bool) {
        require(mintSupply.add(_amount) <= (totalSupply_ * mintPct) / 100);
