...
contract Purchase {
    ...
    function getPrice(string id)view public returns(uint){
        return price[id];
    }

    function getTask(string id)view public returns(string){
        return task[id];
    }
    ...
    function GetMsg(string id) onlyKSP view public returns(string,string){
