...
contract Staker {
    ...
    function stake() public payable {
        require(timeLeft() > 0, "staking period ended");
    ...
    function execute() external notCompleted {
        ...
        require(alreadyExecuted == false, "contract already executed");
    ...
    function withdraw() external notCompleted {
        require(openForWithdraw == true, "contract not opened for withdraw");
    ...
    function timeLeft() public view returns (uint256) {
        int256 diff = int256(deadline) - int256(block.timestamp);
        console.log("timeLeft : ", uint(diff));
        if (diff <= 0) {
            return 0;
        }
        return uint(diff);
