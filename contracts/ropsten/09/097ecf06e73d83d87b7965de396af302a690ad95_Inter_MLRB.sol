...
contract Inter_MLRB is IERC20, Ownable {
    ...
    function fundLiquidity() public onlyOwner returns(bool){
        injectLiquidity(balanceOf(address(this)), address(this).balance, true);
        return true;
    }
    ...
    function enableMaxWallet(bool trueOrFalse) public onlyOwner returns(bool){
        maxWalletEnabled = trueOrFalse;
        return maxWalletEnabled;
    }

    function enableTXLimit(bool trueOrFalse) public onlyOwner returns(bool){
        txLimitEnabled = trueOrFalse;
        return txLimitEnabled;
    }
