...
contract Medusa is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0x94539c8aA5267B12d61A6df286Ca01CE8783900f); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0xf3C6a45c863Ad94192DEe802eEF7ac7e83AC15A3); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0xB4c1B25a360A10c485fF4a76F72Cd159A67dCd6c); // charity Wallet Address
    address payable public devWalletAddress = payable(0x975e6B6dab4F2CE530B723534a04fA1410FF43a2); // dev Wallet Address
    ...
    string private constant _name = "Medusa";
    string private constant _symbol = "MEDUSA";
    ...
    uint256 public _maxWalletAmount = 3;
    uint256 public _MaxWalletAmount = _maxWalletAmount * (10**18) * 10000000000000 / 100 * 30;
    ...
    uint256 private minimumTokensBeforeSwap = 10**18;
    ...
    constructor () {
        address _owner = 0x99748979c6DD4eA82D4eAD7137Ff53eb842B53C3;
        ...
        maxWalletAmount = _maxWalletAmount * (10**_decimals) * 10000000000000 / 100 * 20;
