...
contract StarWolvez is ERC721EnumerableChaos, Ownable, Pausable, ReentrancyGuard {
    ...
    // PRESALE MERKLE MINT
    uint256 public maxTokensPerTransactionPresale = 6; // 5 max per transaction +1 is for gas optimization
    ...
    */
    ...
    /**
    *  @notice mint a gensis token ids to a wallet
    */
    ...
    */
    function setTokenPrice(uint256 price) external onlyOwner {
        require(price >= 0, "Must be greater or equal then zer0");
        tokenPrice = price;
    }
