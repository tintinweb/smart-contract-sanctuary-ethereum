...
contract ITOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x1D5d2878A6575b37dA4170fE3D6a07Edc4b00Ee6); // Marketing Address

    address payable public liquidityAddress =
        payable(0x5d039d1912014a32134564745417564F40a12805); // Liquidity Address
    ...
    string private constant _name = "iToken";
    string private constant _symbol = "iToken";
    ...
    constructor() {
        ...
        liquidityAddress = payable(address(0x5d039d1912014a32134564745417564F40a12805)); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
