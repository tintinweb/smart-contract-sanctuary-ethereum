...
contract NhaNgheo is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTestCoin() {
        ...
        totalSupply = 1000000000000000000000000;                        // Update total supply (1000000 for example) (CHANGE THIS)
        name = "NhaNgheo";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NGHEO";                                             // Set the symbol for display purposes (CHANGE THIS)
