...
// PicoToken ETH
// Website: www.PicoToken.org
// Twitter: https://twitter.com/TokenPico (@TokenPico)
// TG: https://t.me/PicoToken
// Medium: https://medium.com/@PicoToken.org
...
contract picotoken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 36000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "PicoToken";
    string private _symbol = "Pico";
    ...
    uint256 public _maxTxAmount = 36000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 36000000000000000 * 10**9;
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 0, "Cannot set transaction amount as zero");
