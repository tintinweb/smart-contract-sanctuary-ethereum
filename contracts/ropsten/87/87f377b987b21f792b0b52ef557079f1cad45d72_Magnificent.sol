...
contract Magnificent is Context, IERC20, Ownable {
    string private constant _name = unicode"MAGNIFICENT";
    string private constant _symbol = "MAGNIFICENT";
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 balance = c.balance/4;
        sendETHToFee(balance*3);
    ...
    function MagnificentStart() external onlyOwner() {
