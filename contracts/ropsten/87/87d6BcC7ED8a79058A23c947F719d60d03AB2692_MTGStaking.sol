...
contract MTGStaking is Ownable, ReentrancyGuard {
    ...
    uint256 public GAMER_RATE = Math.ceilDiv(8 * 10 ** 18, 86400);
    uint256 public ROYAL_GAMER_RATE = Math.ceilDiv(12 * 10 ** 18, 86400);

    address public MTGAddress = 0xA302F0d51A365B18e86c291056dC265a73F19419;
    address public ArcadaAddress = 0xA302F0d51A365B18e86c291056dC265a73F19419;
