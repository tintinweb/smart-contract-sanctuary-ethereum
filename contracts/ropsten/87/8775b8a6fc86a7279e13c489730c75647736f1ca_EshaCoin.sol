...
contract EshaCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EshaCoin() {
        ...
        name = "EshaCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-015";                                             // Set the symbol for display purposes (CHANGE THIS)
