...
contract NFTRewards is ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 private constant MIN_UNSTAKE = 100 ether; // Minimum amount of tokens can be unstake
    uint256 private constant MAX_UNSTAKE = 2000 ether; // Maximum amount of tokens can be unstaked
