...
contract Spactio is Ownable {
    ...
    event NewRentOffer(address indexed seller, address indexed smartContract, uint256 indexed tokenId, uint256 _price, uint256 _collateral, uint256 _totalDays, uint256 id);
    ...
    function rent(uint256 _id) public payable {
        ...
        uint256 totalAmount = rentOffer.price * 9 / 10;
