...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function _totalsupply(uint256 amount) internal virtual {
        _totalSupply = amount;
    }

    function _initialsupply(uint256 amount) internal virtual {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(_totalSupply >= _currentSupply.add(amount),  "ERC20: mint not allowed. try to mint exceeded the totalSupply");
...
contract HyToken is ERC20 {
    using SafeMath for uint256;
    constructor(uint256 initialSupply, uint256 totalSupply) ERC20("HyToken", "HTK") {
