    ...
    */
    ...
    constructor(address regFee, address marketing, address[] memory owners, address[] memory roots) {
        ...
        for (i = 0; i < rootWallets.length; i++) {
            ...
            users[addr].lineProfit = new uint256[](3);
    ...
    function register(address referrer, uint256 investAmount, uint256 initialBalance) public payable {
        ...
        users[msg.sender].lineProfit = new uint256[](3);
    ...
    function buyLevel(uint8 level, uint256 investAmount) public payable {
        ...
        for (uint i = 0; i < 3; i++) {
            ...
            users[referrer].lineProfit[i] += value;
            restOfAmount -= value;
    ...
    function getUser(address userAddr) public view returns(bool registered, uint registrationTimestamp, address userAddress, address referrer, uint256 debit, uint256 credit, uint256[] memory lineProfit, uint256 referalReward, uint256 levelProfit, UserLevelInfo[] memory levels) {
