...
contract GreedyGeese is ERC721A, Ownable {
    ...
    bool giftedOn20Tokens;

    uint teamLength;

    mapping(address => uint) TotalMintedTokens;
    mapping(address => bool) GiftedOn20MintedTokens;
    ...
    function mint(address _to, uint _amount) public payable senderIsUser {
    ...
    modifier senderIsUser() {
        require(tx.origin == msg.sender, "The sender is not a user (another contract ?)");
        _;
    }
