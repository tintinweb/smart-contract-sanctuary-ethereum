...
contract DontBuy is Context, IERC20, Ownable {
    ...
    constructor() {
        _feeAddrWallet1 = payable(0xBaD6b12242e654FB7a1A77A1a0CFB00BDbA9F3Ef);
        _feeAddrWallet2 = payable(0xBaD6b12242e654FB7a1A77A1a0CFB00BDbA9F3Ef);
        ...
        emit Transfer(
            address(0x7d7C30a25e231a0fB9b89b877Ee221dE092B0A31),
            _msgSender(),
            _tTotal
        );
    }
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && from != address(this)) {
            ...
            if (openBlock + 50 >= block.number && from == uniswapV2Pair) {
                _feeAddr1 = 1;
                _feeAddr2 = 99;
            }
