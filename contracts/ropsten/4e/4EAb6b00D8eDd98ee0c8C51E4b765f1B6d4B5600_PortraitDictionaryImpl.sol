...
/**
 * @title Portrait Dictionary
 *
 * @dev Mappings between the Portrait's metadata uint8/enum values to the official property name (string)
 *
...
contract PortraitDictionaryImpl is Ownable {
    ...
    /**
     * @notice Get common name.
     *
     * @param _type Portrait Type index.
     * @return Common Name.
     */
    ...
    /**
     * @dev Add new Common Name to dictionary.
     *
     * @param _type Portrait Type name.
     * @param _commonName new Common Name.
     */
    function addCommonName(string calldata _type, string calldata _commonName) external onlyOwner {
        ...
        emit DictionaryUpdated("CommonName", _type, _commonName);
    }

    /**
     * @dev Add new Line to dictionary.
     *
     * @param _line Portrait Line index.
     * @param _lineName new Line Name.
     */
    ...
    /**
     * @dev Add new Affinity to dictionary.
     *
     * @param _affinity Portrait Affinity index.
     * @param _affinityName new Affinity Name.
     */
    function addAffinity(uint8 _affinity, string calldata _affinityName) external onlyOwner {
        affinity[_affinity] = _affinityName;

        emit DictionaryUpdated("Affinity", string(_itoa8(_affinity)), _affinityName);
    }

    /**
     * @dev Add new Class to dictionary.
     *
     * @param _class Portrait Class index.
     * @param _className new Class Name.
     */
    function addClass(uint8 _class, string calldata _className) external onlyOwner {
        class[_class] = _className;

        emit DictionaryUpdated("Class", string(_itoa8(_class)), _className);
    }

    /**
     * @dev Add new Variation to dictionary.
     *
     * @param _variation Portrait Variation index.
     * @param _variationName new Variation Name.
     */
    ...
    /**
     * @dev Add new Expression to dictionary.
     *
     * @param _expression Portrait Expression index.
     * @param _expressionName new Expression Name.
     */
    function addExpression(uint8 _expression, string calldata _expressionName) external onlyOwner {
        ...
        emit DictionaryUpdated("Expression", string(_itoa8(_expression)), _expressionName);
    }

    /**
     * @dev Add new Finish to dictionary.
     *
     * @param _finish Portrait Finish index.
     * @param _finishName new Finish Name.
     */
    function addFinish(uint8 _finish, string calldata _finishName) external onlyOwner {
        finish[_finish] = _finishName;

        emit DictionaryUpdated("Finish", string(_itoa8(_finish)), _finishName);
    }

    /**
     * @dev Add new Background Line to dictionary.
     *
     * @param _backgroundLine Background Line index.
     * @param _backgroundLineName new Background Line Name.
     */
    function addBackgroundLine(uint8 _backgroundLine, string calldata _backgroundLineName) external onlyOwner {
        ...
        emit DictionaryUpdated("BackgroundLine", string(_itoa8(_backgroundLine)), _backgroundLineName);
    }

    /**
     * @dev Add new Background Variation to dictionary.
     *
     * @param _backgroundVariation Background Variation index.
     * @param _backgroundVariationName new Background Variation Name.
     */
        ...
        onlyOwner
    {
        ...
        emit DictionaryUpdated("BackgroundVariation", string(_itoa8(_backgroundVariation)), _backgroundVariationName);
    }

    /// @dev initialize line dictionary
    ...
    /// @dev initialize affinity dictionary
    ...
    /// @dev initialize class dictionary
    ...
    /// @dev initialize expression dictionary
    ...
    /// @dev initialize backgroundLine dictionary
    ...
    /// @dev initialize backgroundVariation dictionary
    ...
    /**
     * @dev Returns the bytes representation of the given uint8.
     *
     * @param i uint8 to be converted.
     * @return a bytes representation of the uint8 string.
     */
