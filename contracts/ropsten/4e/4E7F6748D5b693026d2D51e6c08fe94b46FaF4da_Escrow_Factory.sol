...
contract Escrow_Factory {
    ...
    function newEscrow(uint256 _id, address payable _seller, address payable _buyer, uint256 _startDate, uint256 _endDate) external {
        ...
        e.setStartDate(_startDate);
        e.setEndDate(_endDate);
...
contract Escrow {
    ...
    function setStartDate(uint256 _startDate) onlyFactory public {
        startDate = _startDate;
    }

    function setEndDate(uint256 _endDate) onlyFactory public {
        endDate = _endDate;
    }
