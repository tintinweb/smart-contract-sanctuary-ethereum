...
*/ 
// This is my first token ever,I will keep adding to the LP as we grow,Hop in the TG <Rest assured i won't rug you guy's i am one among you a degen 
//  https://t.me/tenjinerc
...
contract Tenjin  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Poetry God";
    string private constant _symbol = "TENJIN";
