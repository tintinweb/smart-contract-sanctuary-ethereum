...
contract presale is ReentrancyGuard, Context, Ownable {
    ...
    constructor (address _wallet, address _taxWallet, address _paymentToken, string memory _logo, string memory _description, string memory _site)  {
    ...
    function updateDetails(string memory _logo, string memory _description, string memory _site)external onlyOwner  {
            logo = _logo;
            description = _description;
            projectSite = _site;
    }
    ...
    function presaleSettings(string memory _name,uint256 hardcap, uint256 _minPurchaseAmount, uint256 _maxPurchaseAmount, uint256 _starttime, uint256 _duration, bool _overflow, bool _whitelist, bool _timedpre) external onlyOwner  {
        presaleName = _name;
