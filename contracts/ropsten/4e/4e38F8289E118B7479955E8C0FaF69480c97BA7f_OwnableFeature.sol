...
abstract contract FixinCommon {
    ...
    modifier onlySelf() virtual {
        ...
        // }
        require(msg.sender == address(this), "LibCommonRichErrors.OnlyCallableBySelfError");
        _;
    }
    ...
    modifier onlyOwner() virtual {
        {
            ...
            // }
            require(msg.sender == owner, "LibOwnableRichErrors.OnlyOwnerError");
        }
        _;
    }
...
contract SimpleFunctionRegistryFeature is IFeature, ISimpleFunctionRegistryFeature, FixinCommon {
    ...
    function rollback(bytes4 selector, address targetImpl) external override onlyOwner {
        ...
        // }
        require(i != 0, "NotInRollbackHistoryError");
