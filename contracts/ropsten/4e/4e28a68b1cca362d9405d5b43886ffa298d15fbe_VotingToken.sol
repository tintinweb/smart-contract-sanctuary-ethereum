...
contract VotingToken is ExpandedIERC20, ERC20Snapshot, MultiRole {
    ...
    string public constant name = "CUS_UMA"; // solhint-disable-line const-name-snakecase
    string public constant symbol = "CUS_UMA"; // solhint-disable-line const-name-snakecase
