...
// File: contracts/libs/PaymentSplitter.sol
...
contract AeraNodes is ERC20, Ownable, PaymentSplitter  {
    using SafeMath for uint256;

    address public Pair;
    address public RouterAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Trader Router
...
function getPayees() private returns(address[] memory){
    ...
    constructor(
        ...
        ERC20("Aerarium Nodes", "AERA")
        PaymentSplitter(getPayees(), getShares())
    {
     
        addresses[0] = 0xd86aC952724Cb84143B45c7dBf3e3144B65541CC;
        addresses[1] = 0xb30Cdd089129Ea8C7841373419fbD9DCb5d4fa6E;
       ...
       nodeManager = INodeManager(addresses[1]);
    ...
    function _transfer(
        ...
        if (from != owner() && to != Pair && to != address(Router) && to != address(this) && from != address(this)) {
