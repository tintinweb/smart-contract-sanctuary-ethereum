...
contract dminer is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function getTicketResult(uint256 ticketId) public view returns(uint256){
        ...
        return TicketKey_.mul(winningKey_) % 1000;
    }
    

    function getWinningOre(uint256 ticketId) public view returns(Ores Ore){
        uint256 result = getTicketResult(ticketId);
        if(VortexiaOre.contains(result)){
            return Ores.Vortexia;
        } else if(DiamondOre.contains(result)){
            return Ores.Diamond;
        } else if(GoldOre.contains(result)) {
            return Ores.Gold;
    ...
    function claimWinning(uint256 ticketId) public nonReentrant {
        ...
        uint256 winning = getPrice(getWinningOre(ticketId));
