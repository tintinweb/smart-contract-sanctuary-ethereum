...
//
// Nakhla PROTOCOL COPYRIGHT (C) 2022 
...
contract Nakhla is ERC20Detailed, Ownable {
    ...
    string public _name = "Nakhla";
    string public _symbol = "NKL";
    ...
    constructor() ERC20Detailed("Nakhla", "NKL", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x7eedC21ab29da990f085265EEe2e20b7996f0F6B;
        treasuryReceiver = 0x6ABEaE8C7648971d16322606030f1c64e881A915; 
        safuuInsuranceFundReceiver = 0x12fD7A2715CACacC3E2C9f3CaC6B9F4c1CF58b8f;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no NKL token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
