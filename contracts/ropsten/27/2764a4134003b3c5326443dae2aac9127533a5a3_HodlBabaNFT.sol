...
contract HodlBabaNFT is ERC721, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public constant MAX_MINT_PER_PRESALE = 5;
    ...
    address[] private _royaltyAddresses = [
        0x0CC494215f952b7cD96378D803a0D3a6CAb282b0, // Team wallet address
    ...
    constructor(
        ...
        _royaltyShares[_royaltyAddresses[0]] = 99; // Royalty for Team wallet
        _royaltyShares[_royaltyAddresses[1]] = 1; //  Royalty for Auditor wallet
    }
    ...
    function mintForGiveaway() external onlyOwner {
        require(totalSupply + GIVEAWAY_SUPPLY <= MAX_SUPPLY, "MAX_SUPPLY_REACHED");
    ...
    function mintAdmin(uint256 _count, address _account) external onlyOwner {
        require(totalSupply + _count + GIVEAWAY_SUPPLY <= MAX_SUPPLY, "MAX_SUPPLY_REACHED");
