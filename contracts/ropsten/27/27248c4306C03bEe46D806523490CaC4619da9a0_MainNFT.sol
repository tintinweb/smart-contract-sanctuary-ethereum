...
contract MainNFT is ERC721A, Ownable {
	...
	//@testnet Set constants for mainnet deployment
	// Maximum supply
	...
	bool public isAuctionEnded; //@testnet set this to private
	...
	//@testnet Set private for mainnet deployment
	...
	function getBidsByAddresses(address[] memory _bidders) public view returns (uint256[] memory bids) {
	...
	//@testnet --TESTNET ONLY / DEV TESTING FUNCS--
