...
contract ColgateInu is ERC20, Ownable {
    ...
    string constant _name = "Colgate Inu";
    string constant _symbol = "COL";
    ...
    function _distributeBNB(uint256 remainingBNB) private {
        ...
        uint256 amountBNBtreasury = remainingBNB * (devOpsFee) / (totalFee);
