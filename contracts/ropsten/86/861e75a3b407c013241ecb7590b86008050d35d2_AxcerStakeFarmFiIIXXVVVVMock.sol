...
contract AxcerStakeFarmFiIIXXVVVVMock is Ownable{
   using SafeERC20 for IERC20; // Wrappers around ERC20 operations that throw on failure
    ...
    function deposit(uint256 _poolId, uint256 _amount) external {
        ...
        IswapV2ERC20(pool.stakeToken).transferFrom(msg.sender,address(this),_amount);
    }
    ...
    function withdraw(uint256 _poolId) external {
        ...
        IswapV2ERC20(pool.stakeToken).transfer(msg.sender,amount);
    }
