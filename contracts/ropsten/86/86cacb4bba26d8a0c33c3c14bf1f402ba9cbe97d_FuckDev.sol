...
contract FuckDev is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dev1";
    ...
    uint256 public _SelltaxFee = 100; // means 2% which distribute to all holders reflection fee
    uint256 public _SellCommunityFee=200;// meanse 2% 
    ...
    uint256 public _maxWalletToken = 10000e9;
    uint256 public minTokensBeforeSwap = 50000e9;
