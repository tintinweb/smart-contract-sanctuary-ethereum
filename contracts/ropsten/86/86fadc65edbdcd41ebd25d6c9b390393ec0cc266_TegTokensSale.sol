...
contract TegTokens {
    ...
    function buy() payable public {
        uint amount = msg.value * unitsOneEthCanBuy;               // calculates the amount
    ...
    function() payable public {
      ...
      _transfer(fundsWallet, msg.sender, amount); // Broadcast a message to the blockchain

      //Transfer ether to fundsWallet
      fundsWallet.transfer(msg.value); */
    //  _transfer(msg.sender, fundsWallet, msg.value);
      }
