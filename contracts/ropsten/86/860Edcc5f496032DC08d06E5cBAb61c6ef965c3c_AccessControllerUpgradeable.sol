...
contract AccessControllerUpgradeable is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable, AccessControlUpgradeable {
    ...
    function whiteListMint(
        ...
        require(!whitelistClaimed[msg.sender], "Address Already Claimed ID");
    ...
    function updateCensus(
        ...
        merkleRoot = _merkleRoot;
        ipfsHash = _ipfsHash;
        if(tokenId != 0 && whitelistClaimed[msg.sender]) {
            _burn(tokenId);
        }
    }
    ...
    function _safeMint(
        address to,
        uint256  tokenId
    ) internal virtual override(ERC721Upgradeable) onlyOwner {
