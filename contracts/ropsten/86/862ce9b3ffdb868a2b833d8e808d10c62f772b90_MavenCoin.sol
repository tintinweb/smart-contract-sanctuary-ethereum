...
///0x2ba13c13893de4abcdbee80f7158ef91ca5206e8
contract Token {
...
contract MavenCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MavenCoin() public {
        ...
        name = "MavenNet";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MVNNET";                                             // Set the symbol for display purposes (CHANGE THIS)
    ...
    function freeze(bytes32 _foreignNetworkId, bytes32 _recipient, uint256 _amount, bytes _localData) public {
