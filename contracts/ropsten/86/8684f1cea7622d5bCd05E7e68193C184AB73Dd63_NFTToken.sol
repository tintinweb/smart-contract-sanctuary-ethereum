...
contract NFTToken is ERC721A, Ownable, Pausable {
    ...
    constructor(string memory baseURI, string memory TokenName, string memory TokenSymbol, uint Iprice, uint Supply, address originalOwner) ERC721A(TokenName, TokenSymbol) {
...
contract NFTTokenFactory {
    ...
    function createToken(string memory baseURI, string memory TokenName, string memory TokenSymbol, uint Iprice, uint Supply, address originalOwner) public {
        NFTToken token = new NFTToken(baseURI, TokenName, TokenSymbol, Iprice, Supply, originalOwner);
