...
contract Wise_Young_Cat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Wise Young Cat"; //token name
    string private _symbol = "WSC"; // token symbol
    uint8 private _decimals = 10; //decimals to return
    ...
    uint256 internal _tokenTotal = 2147483647e10; // total supply
    ...
    uint256 public _liquidityFee = 2; // means 0% add liquidity on each buy and sell
    
    uint256 public devFee = 7; //0 means 0% 
