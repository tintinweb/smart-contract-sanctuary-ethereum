...
contract STSTEST is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function STSTEST() {
        ...
        name = "STSTEST";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "STSTEST";                                             // Set the symbol for display purposes (CHANGE THIS)
