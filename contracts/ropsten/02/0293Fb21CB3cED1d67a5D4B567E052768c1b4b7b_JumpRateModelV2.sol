...
/**
  * @title Logic for Atlantis's JumpRateModel Contract V2.
  * @author Atlantis (modified by Dharma Labs, refactored by Arr00)
...
/**
  * @title Atlantis's JumpRateModel Contract V2 for V2 aTokens
  * @author Arr00
  * @notice Supports only for V2 aTokens
  */
