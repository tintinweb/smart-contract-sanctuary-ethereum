...
contract ClaimTokens is Ownable {
    ...
    function ClaimToken() public payable {
        ...
        require(amountTobuy >= 600000000000000, "You need to send 0.0006 BNB to receive 2000 Rom");
        require(2000000000000000000000 <= dexBalance, "Not enough tokens in the reserve");
        require(!isBlacklisted[msg.sender], "You have claimed Rom token from your current address");
        romToken.transfer(msg.sender, 2000000000000000000000);
    ...
    function BlackList(address _user) public {
        require(!isBlacklisted[_user], "You have claimed romano token from your current address");
        isBlacklisted[_user] = true;
    }

    function CheckBlackList(address _user) public view returns (bool test ) {
        require(!isBlacklisted[_user], "You have claimed romano token from your current address");
        require(isBlacklisted[_user], "You haven't claimed romano token from your current address");
