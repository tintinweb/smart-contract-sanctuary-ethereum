...
contract PermTokenTest is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PermTokenTest() {
        ...
        name = "PermTokenTest";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PTT";                                             // Set the symbol for display purposes (CHANGE THIS)
