...
contract STONKCOIN is Ownable, IERC20 {

    using SafeMath for uint256;
    using Address for address;

    string public constant name = 'STONKS Coin';
    string public constant symbol = 'ST0NKZ';
    ...
    uint256 public constant FounderLockupAmount = 200 * 10000 * 10 ** decimals;
    uint256 public constant FounderLockupCliff = 2 days;
    uint256 public constant FounderReleaseInterval = 10 minutes;
    uint256 public constant FounderReleaseAmount = 50 * 10000 * 10 ** decimals;

   // address public founder = address(0);
    address public _founder = 0x0d4AFd7a6964C6aE33Df8926E3264f77cfF1897F;
    address public _operator = 0x5De274F06B7529360B48d3Ad89Bd0a3161C1D3b4;
  ...
  //      _founder = ;
   //     _operator = ;
    ...
    function release() public {
        ...
        _transfer(address(this), _founder, amount);
    }
    ...
    function changeFounder(address founder) public onlyOwner {
        require(founder != address(0), "LightCoin: founder is the zero address");

        emit ChangeFounder(_founder, founder);
        _founder = founder;
    }

    function setMinter(address minter) public onlyOwner {
        require(minter != address(0), "LightCoin: minter is the zero address");
        require(minter.isContract(), "LightCoin: minter is not contract");
