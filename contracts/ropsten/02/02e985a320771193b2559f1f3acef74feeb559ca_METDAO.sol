...
contract METDAO is Context, IERC20, Ownable {
    ...
    string private _name = "MET DAO";
    string private _symbol = "METDAO";
    ...
    uint256 public _maxBuyAmount = 12500000000 * 10**9; //1.25
    uint256 public _maxWalletAmount = 25000000000 * 10**9; //2.5
    uint256 public numTokensSellToAddToLiquidity = 100000000 * 10**9; //0.0001
    uint public ethSellAmount = 1000000000000000;  //1 ETH
    address public marketingWallet = 0x6Da7E3d9A8f1D2959b4e011a99A6086a34574415;
    address public devWallet = 0x6Da7E3d9A8f1D2959b4e011a99A6086a34574415;
