...
// File: contracts/Derabbitags.sol
...
contract Derabbitags is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if(supply > 0) {
        ...
        giftValue = supply + 1 == maxSupply ? address(this).balance * 40 / 100 : msg.value * 25 / 100;
    }
  ...
  function withdraw() public payable onlyOwner {
    ...
    payable(0x724a065bF2FC65AD5fb4298b40183012Be59DE73).transfer(withdrawAmount_10);
    payable(0x79e414deC0Fa44fe71ea3eF0460b59e5b4AA91bb).transfer(withdrawAmount_10);
    payable(0xd9683977c8996C434592f30a83aC42d43f96df39).transfer(withdrawAmount_10);
