...
contract WENCONTRACT is ERC20Detailed, Ownable, Pausable {
    ...
    uint256 public rewardYieldDenominator = 1000000000000;
    ...
    address private liquidityReceiver = 0x7CF47cabb764dF647b5376de37666Fdb24764A13;
    address private treasuryReceiver = 0x7CF47cabb764dF647b5376de37666Fdb24764A13;
    address private riskFreeValueReceiver = 0x7CF47cabb764dF647b5376de37666Fdb24764A13;
//  address public busdToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    address public busdToken = 0xaD6D458402F60fD3Bd25163575031ACDce07538D; //DAI on Ropsten
    ...
    constructor() ERC20Detailed("Wenburn", "WENB1", uint8(DECIMALS)) {
  //    router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Pancakeswap Testnet
        router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Uniswap Ropsten
