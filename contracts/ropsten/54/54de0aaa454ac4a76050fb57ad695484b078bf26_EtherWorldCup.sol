...
Rules are as follows:
    ...
    * 90% of the entry fee will go towards the prize fund, with 10% forming a fee.
        Of this, 5% goes to the developer, and 5% goes directly to Giveth (giveth.io/donate).
...
contract EtherWorldCup {
    ...
    // How many people are taking place in the tournament?
    ...
    // Which game ID did a player last compute their score up to
