...
contract TheChickenLab is ERC721A, Ownable{
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        ...
        //create sender_leaf node
        bytes32 sender_leaf = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(_merkleProof, merkleRoot, sender_leaf), "TheChickenLab :: You are not whitelisted");
