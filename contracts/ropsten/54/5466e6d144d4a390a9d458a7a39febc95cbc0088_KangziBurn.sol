...
| |/ /((_)_  _(_/(  (()(_)((_)(_)  | _ )(_))(  ((_) _(_/(  
  ' < / _` || ' \))/ _` | |_ /| |  | _ \| || || '_|| ' \)) 
 _|\_\\__,_||_||_| \__, | /__||_|  |___/ \_,_||_|  |_||_|  
                   |___/                                   

    KangziBurn - $Kangzi

    Telegram : https://t.me/KangziBurn

    Max tx: 2% / Max Wallet: 3%
    Txs: 5/5 for buyback & burns 

The time has come for a great revival. Gone are the days of weak holders who only keep their bags for a short time. The Kangxi dynasty is about to be reborn, and it does not want people who are not willing to fight for their bags.
We have to rebuild the kingdom starting from 0, to become unstoppable afterwards.   
...
contract KangziBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KANGZIBURN", "KANGZI") {
