...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc778417E063141139Fce010982780140Aa0cD5Ab); // reward address busd
...
contract KIRIA is IBEP20, Auth {
   
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc778417E063141139Fce010982780140Aa0cD5Ab; // reward wbnb
    address public WETH = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "test_fail8";
    string constant _symbol = "ttff8";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 88_888_888 * (10 ** _decimals);
    ...
    address public autoLiquidityReceiver=0x25eD1645ab4dCD3788Cc6057225CCE94B41EcBE6; //liq address
    address public marketingFeeReceiver=0x25eD1645ab4dCD3788Cc6057225CCE94B41EcBE6; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 500000; // 0.25%
    bool inSwap;
