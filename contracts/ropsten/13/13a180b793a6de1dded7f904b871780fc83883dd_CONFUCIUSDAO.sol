...
The world’s first PAY2READ application that aims to help people rediscover all the magical worlds hidden in the pages of classic and modern literature.  Join this truly revolutionary project today and be part of its development!
...
contract CONFUCIUSDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "CONFUCIUS DAO";
    string private constant _symbol = "CONFU";
