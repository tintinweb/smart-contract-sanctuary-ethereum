...
contract ShibaArmy is ERC721, Ownable {
    ...
    string public unrevealedURI = "https://ipfs.io/ipfs/QmRYAGJoQ55vykWG4uGVJUt5jCddUP3p2zChs3KXnsNQrM"; // this will change
    ...
    function getSaleConfig() public view returns (saleConfig memory currentConfig) {
        ...
        // (now - start time ) modulo 1 day = number of days since sale started
