...
contract WILLSLAPS is Context, IERC20, Ownable
{
    ...
    string private _name 	= 'Will Slaps Chris';
    string private _symbol 	= 'WILLSLAPS';
    ...
    uint256 private constant MIN_BUY_SELL_TXN_AMOUNT 	= 4000000000;

    // buy/sell Max transaction limit - >  4T
    uint256 private _maxTxAmount 	= 4000000000 * (10**18);



    // minimum amount of tokens to be swaped => 50M
    uint256 private _numOfTokensToExchangeForTeam = 50000000 * (10**18);
