...
// File: contracts/erctoken/ERC721/ERC721Blacklistable.sol
 ...
 */
abstract contract ERC721Blacklistable is Context, ERC721 {
...
// File: contracts/erctoken/presets/ERC721MinterBurnerPauserBlacklist.sol
...
contract ERC721MinterBurnerPauserBlacklist is Context, AccessControl, ERC721Burnable, ERC721Pausable, ERC721Blacklistable {
    ...
    function mint(address to, uint256 tokenId, string memory _data) public {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC721MinterBurnerPauserBlacklist: must have minter role to mint");
    ...
    function pause() public {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721MinterBurnerPauserBlacklist: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721MinterBurnerPauserBlacklist: must have pauser role to unpause");
        _unpause();
    }

    function addBlackList(address _evilUser) external virtual {
        require(hasRole(BLACKLISTER_ROLE, _msgSender()), "ERC721MinterBurnerPauserBlacklist: must have BLACKLISTER_ROLE to addBlackList");
        _addBlackList(_evilUser);
    }

    function removeBlackList(address _clearedUser) external virtual {
        require(hasRole(BLACKLISTER_ROLE, _msgSender()), "ERC721MinterBurnerPauserBlacklist: must have BLACKLISTER_ROLE to removeBlackList");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override(ERC721, ERC721Pausable) {
        super._beforeTokenTransfer(from, to, tokenId);
        require(!getBlackListStatus(from), "ERC721MinterBurnerPauserBlacklist: from address is in blacklist");
        require(!getBlackListStatus(to), "ERC721MinterBurnerPauserBlacklist: to address is in blacklist");
        require(!getBlackListStatus(_msgSender()), "ERC721MinterBurnerPauserBlacklist: msg sender is in blacklist");
    }
}
...
contract ERC721Safe {
    ...
    function mintERC721(address tokenAddress, address recipient, uint256 tokenID, bytes memory data) internal {
        ERC721MinterBurnerPauserBlacklist erc721 = ERC721MinterBurnerPauserBlacklist(tokenAddress);
