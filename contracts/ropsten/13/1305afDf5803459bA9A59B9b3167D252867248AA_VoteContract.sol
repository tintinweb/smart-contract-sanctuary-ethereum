...
function candidatesCount1() public view returns(uint){
  return (c1);
}
function candidatesCount2() public view returns(uint){
  return (c2);
}
function candidatesCount3() public view returns(uint){
  return (c3);
}
function candidatesCount4() public view returns(uint){
  return (c4);
}
