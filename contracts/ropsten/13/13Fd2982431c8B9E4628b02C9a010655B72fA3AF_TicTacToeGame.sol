...
contract TicTacToeGame {
    ...
    {   
        ...
        if (winVertically(game, _tictac) == false || winVertically(game, _tictac) == false || winObliquely(game, _tictac) == false) {
            revert youNoWin();
        }
        ...
        returns (bool) 
    {
        if (_game.fields[0] == _tictac && _game.fields[3] == _tictac && _game.fields[6] == _tictac) {
            return true;
        } else if (_game.fields[1] == _tictac && _game.fields[4] == _tictac && _game.fields[7] == _tictac) {
            return true;
        } else  if (_game.fields[2] == _tictac && _game.fields[5] == _tictac && _game.fields[8] == _tictac) {
            return true;
        }
        ...
        returns (bool) 
    {
        if (_game.fields[0] == _tictac && _game.fields[1] == _tictac && _game.fields[2] == _tictac) {
            return true;
        } else if (_game.fields[3] == _tictac && _game.fields[4] == _tictac && _game.fields[5] == _tictac) {
            return true;
        } else if (_game.fields[6] == _tictac && _game.fields[7] == _tictac && _game.fields[8] == _tictac) {
            return true;
        }
        ...
        returns (bool) 
    {
        if (_game.fields[0] == _tictac && _game.fields[4] == _tictac && _game.fields[8] == _tictac) {
            return true;
        } else if (_game.fields[2] == _tictac && _game.fields[4] == _tictac && _game.fields[6] == _tictac) {
            return true;
        }
