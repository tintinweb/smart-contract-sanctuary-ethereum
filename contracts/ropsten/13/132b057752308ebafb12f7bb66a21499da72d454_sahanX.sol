...
contract sahanX is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("sahanX", "sahanX") {
        setBaseURI("");
    ...
    function mintFree() public nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max sahanX per address exceeded");
		require(s + _mintAmount <= maxFree, "Cannot exceed sahanX supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(!paused, "Paused");
        require(_mintAmount > 0, "Cant mint 0 sahanX");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more sahanX" );
        require(s + _mintAmount <= maxSupply, "Cant exceed sahanX supply");
        ...
        onlyOwner
    {
        ...
        require(s + totalQuantity <= maxSupply, "Too many sahanX");
