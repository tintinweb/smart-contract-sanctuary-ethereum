...
contract KYU is ERC20, Ownable {
    ...
    constructor() ERC20("Kyuubi Inu", "KYU") {
        ...
        marketingWallet = address(0x17c66b0aA0955e71f507b1117095c4ACd1cEb9Ca); // set as marketing wallet
        devWallet = address(0x37869E4238ce493B6f35fc01Cd1CD1d89408A957); // set as dev wallet
