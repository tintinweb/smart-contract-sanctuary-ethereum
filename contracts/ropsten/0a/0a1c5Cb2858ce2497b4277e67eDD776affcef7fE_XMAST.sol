...
contract XMAST is IERC721, Ownable, Functional {
    ...
    constructor() {
        _name = "0xMAST";
        _symbol = "0xMN";
        //_baseURI = "http://172.104.50.53/avius-metadata/obscuris/";
        _baseURI = "http://localhost:3000/";
        
        CC = ERC721(0xA42eac35f31c3f12009A8F8A0BB3c61E8dE05e38);
        //CC = ERC721(0x9AE777FB3838DdC64C1B5D2e6174F9bBeBCa6EdA);
