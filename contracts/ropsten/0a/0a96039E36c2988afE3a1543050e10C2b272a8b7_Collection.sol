...
contract Collection is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,2,0,1655097000,1655097600);
        epochs[2] = EpochDetails(1,3,0,1655097900,1655098500); 
        epochs[3] = EpochDetails(3,7,0,1655098800,0); 
        epochs[4] = EpochDetails(1,2,0,1655097900,0); 
    }
