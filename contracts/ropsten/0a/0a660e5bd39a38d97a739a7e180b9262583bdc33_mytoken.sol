...
contract mytoken is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xF0FB9CA2b43EC930754A050BDfD97D12038C3534);
    address payable private _marketingAddress = payable(0xF0FB9CA2b43EC930754A050BDfD97D12038C3534);
    ...
    uint256 public _maxTxAmount = 30000000000000 * 10**9; //3
    uint256 public _maxWalletSize = 30000000000000 * 10**9; //3
    uint256 public _swapTokensAtAmount = 1 * 10**9; //0.0000000000001
