    ...
    IERC1155ReceiverUpgradeable
{
    ...
    /// @dev Returns the native token wrapper of the contract.
    function getNativeTokenWrapper() external view returns (address) {
        return nativeTokenWrapper;
    }

    /// @dev Sets the native token wrapper of the contract.
    function setWrappedNativeToken(address _nativeTokenWrapper) external onlyRole(DEFAULT_ADMIN_ROLE) {
        nativeTokenWrapper = _nativeTokenWrapper;
    }
