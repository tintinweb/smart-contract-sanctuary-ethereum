...
contract ImperoITCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ImperoITCoin() {
        ...
        name = "ImperoITCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "IPTC";                                             // Set the symbol for display purposes (CHANGE THIS)
