...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[xtkn302227][ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[xtkn302227][ownable] new owner is the zero address");
...
contract IXTKN302227Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN302227Project{
    function init() public{}
...
contract IXTKN302227StakingLocked{
    function init(uint256, uint256) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN302227PreSale{
    function init(uint256, address) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN302227Lottery{
...
*/
contract XTKN302227 is Context, IERC20, Ownable, RobinHood, Native, ReentrancyGuard{
    // public properties
        // lib
        ...
        // interfaces
            ...
            IXTKN302227Liquidity private _liquidity;
            IXTKN302227Project private _project;
            IXTKN302227Staking private _staking;
            IXTKN302227StakingLocked private _staking30D;
            IXTKN302227StakingLocked private _staking90D;
            IXTKN302227StakingLocked private _staking180D;
            IXTKN302227StakingLocked private _staking365D;
            IXTKN302227PreSale private _preSale;
            IXTKN302227Lottery private _lottery;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals
            string private _name = "XTKN302227"; // the name of our project
            string private _symbol = "XTKN302227";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN302227Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN302227Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(
        ...
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN302227Staking(ADDRESS_STAKING);
            _staking.init();
            
            _staking30D = IXTKN302227StakingLocked(ADDRESS_STAKING_DAYS30);
            _staking30D.init(1643578036, 30);

            _staking90D = IXTKN302227StakingLocked(ADDRESS_STAKING_DAYS90);
            _staking90D.init(1643578036, 90);

            _staking180D = IXTKN302227StakingLocked(ADDRESS_STAKING_DAYS180);
            _staking180D.init(1643578036, 180);

            _staking365D = IXTKN302227StakingLocked(ADDRESS_STAKING_DAYS365);
            _staking365D.init(1643578036, 365);
    ...
    function initPreSale(address contractAddress, address contractVault) public onlyOwner{
        if(!_contractPreSaleActive){
            ...
            // init contract
            _preSale = IXTKN302227PreSale(ADDRESS_PRESALE);
            _preSale.init(1643621236, ADDRESS_PRESALE_VAULT);
    ...
    function initLottery(address contractAddress) public onlyOwner{
        if(!_contractLotteryActive){
            ...
            // init contract
            _lottery = IXTKN302227Lottery(ADDRESS_LOTTERY);
            _lottery.init(1643578036);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[xtkn302227] approve from the zero address");
        require(spender != address(0), "[xtkn302227] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[xtkn302227] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[xtkn302227] transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function price() public view returns(uint256){
        require(_contractLiquidityActive, "[xtkn302227] no liquidity, no price!");
    ...
    function _transfer(address pFrom, address pTo, uint256 pAmount) private{
        ...
        if(pFrom == ADDRESS_PAIR){
            require(SWAPPING_ENABLED, "[xtkn302227] trading disabled during presale!");
