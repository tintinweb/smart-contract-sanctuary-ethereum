...
contract ShujINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "ShujINU";
    string private constant _symbol = "SHUNU";
    ...
    address payable private _developmentAddress = payable(0x8Be81DBd6225083db64E3A3fcaDE5E17867c64fE);
