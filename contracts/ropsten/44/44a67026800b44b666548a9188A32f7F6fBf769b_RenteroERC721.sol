...
contract RenteroERC721 is IRentero, ERC721, ERC721Holder {
    ...
    function stake(uint256 tokenId) public virtual override {
        ...
        require(_tokenIdToDelegator[tokenId] != address(0), "No delegator.");
    ...
    function redeem(uint256 tokenId) public virtual override {
        ...
        require(uint256(info.expires) < block.timestamp, "Token in use.");

        address delegator = _tokenIdToDelegator[tokenId];
        address owner = ERC721.ownerOf(tokenId);
        require(msg.sender == delegator || msg.sender == owner, "Not delegator or owner.");
    ...
    function _onlyApprovedOrOwner(address operator, uint256 tokenId) internal view returns (bool) {
        ...
        return (operator == owner || IERC721(nftAddress).isApprovedForAll(owner, operator));
    }
}
