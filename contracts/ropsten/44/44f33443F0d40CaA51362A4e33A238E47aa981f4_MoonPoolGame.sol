...
contract MoonPoolGame is Ownable {
  ...
  function withdrawERC20() public {
    tokenInstance.transfer(msg.sender, balances[msg.sender]);
  ...
  function approveERC20(uint256 amount) public {
    tokenInstance.approve(address(this), amount);
  }

  function depositERC20(uint256 amount) public {
    tokenInstance.allowance(msg.sender, address(this));
    // require(tokenInstance.allowance(msg.sender, address(this)) == amount, "Owner did not allow this smart contract to transfer.");
