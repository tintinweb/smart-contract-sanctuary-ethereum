...
constructor() public {
       ...
       /** emit PermissionGranted(address(0), _owner);
        **/
    }
  ...
  */
/** 
 * shivom Only the user calling the contract can check the recorded permission for its public address.
 **/
   ...
   */
  /**
   * Shivom Any user can call the contract with an address to check if they have got permission from that address.
   * Contract should expose a public method for any user to check if they have permission from any user. 
   * This will accept a public address parameter and return a true if user has permission.
   **/
  function allowance( address owner,address spender )    public    view    returns (uint256)
  {
    ...
    function hasPermission( address spender )    public    view    returns (bool)
  {
    return _allowed[msg.sender][spender] != 0 ;
  }
  ...
  */
   ...
   */
   /**
    shivom Contract should expose a public method for any user to grant permission to another public address. 
    * This will accept a public address parameter and return a true if successful.
    * **/
  ...
  function grantPermission(address spender, uint256 value) public returns (bool){
              require(spender != address(0));
