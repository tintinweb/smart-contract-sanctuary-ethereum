...
contract StandardToken is RiccardoToken {
...
name = "RiccardoToken"; // Set the name for display purposes
decimals = 18; // Amount of decimals for display purposes
symbol = "RIC"; // Set the symbol for display purposes
}
