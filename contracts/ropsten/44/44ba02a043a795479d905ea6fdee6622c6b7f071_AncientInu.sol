...
contract AncientInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Testr";
    ...
    **/
    ...
    constructor() payable {
        _feeAddrWallet1 = payable(0xF59E65555Df013e8600710de9b9691c381fCD8a5);
        _feeAddrWallet2 = payable(0xE6f82478023905b5971C5bBAe648DaA76ad50230);
        ...
        maxTransactionAmount = (MAX_PERCENTAGE_WALLET * (10000000000000 * 10**9) * 10) / 100;
        maxWallet = (MAX_PERCENTAGE_WALLET  * (10000000000000 * 10**9) * 10) / 100;
    ...
    mapping(uint256 => bool) public transactionCountUsed;
    function getTransactionsCount() public view returns (uint256){
        return transactionsCount / 10;
    } 
    ...
    function _transfer(
        ...
        if (applyRestrictions) {
            ...
            if (from != owner() && to != owner()) {
                ...
                transactionsCount++;
                if(getTransactionsCount() >=1 && !transactionCountUsed[getTransactionsCount()]){
                    transactionCountUsed[getTransactionsCount()] = true;
