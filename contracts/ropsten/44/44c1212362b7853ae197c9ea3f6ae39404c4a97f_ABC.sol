...
contract ABC is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ABC() {
        ...
        name = "ABC";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ABC";                                             // Set the symbol for display purposes (CHANGE THIS)
