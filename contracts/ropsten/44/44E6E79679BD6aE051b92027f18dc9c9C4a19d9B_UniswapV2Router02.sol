...
import "./amm/libraries/SafeMath.sol";
import "./amm/libraries/TransferHelper.sol";
import "./amm/periphery/interfaces/IUniswapV2Router02.sol";
import "./amm/periphery/interfaces/IUniswapV2Factory.sol";
import "./amm/periphery/interfaces/IERC20.sol";
import "./amm/periphery/interfaces/IWETH.sol";
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                // hex'e18a34eb0e04b04f7a0ac29a6e80748dca96319b42c54d679cb821dca90c6303' // init code hash for mainnet fork
                hex'4b9cb0478f456615399da4a7096c17c0d38f03d9f9f9209985f7d283a529510f' // init code hash
            ))));
    }
