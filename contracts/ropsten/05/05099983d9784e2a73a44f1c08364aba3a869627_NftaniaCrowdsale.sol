...
contract NftaniaCrowdsale is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Main Variables /////////////////////////////////// 
        ...
        uint256 private totalTokensSold;                  // Total accimilative tokens purchased 
   ...
   //////////////////////// Events /////////////////////////////////////////// 
    ...
    // New Purchase Range
        event NewPurchaseRange  (uint256 _minPurchase, uint256 _maxPurchase);
   ...
   //////////////////////// Initialize Contract //////////////////////////////////////   
    function InitializeContract (address  _tokenAddress) public onlyOwner{
        ...
        setRemainingTokens(_tokenAddress);
    }
   ...
   //////////////////////// Set remaining tokens //////////////////////////////// 
    function setRemainingTokens (address  _tokenAddress)  public onlyOwner {
        remainingTokens = IERC20(_tokenAddress).allowance(owner(), address(this)); 
    }
   ...
   //////////////////////// Set Purchase Range ///////////////////////////////// 
    function setPurchaseRange (uint256 _minPurchase, uint256 _maxPurchase) public onlyOwner returns (bool status){
        require (_minPurchase > 0,"The min purchase should be larger than 0");
        require (_maxPurchase >= _minPurchase,"The max purchase should be larger or euqal to min purchase");
        minPurchase= _minPurchase;
        maxPurchase=_maxPurchase;
        emit NewPurchaseRange (minPurchase, maxPurchase);
        return true;
    }
   ...
   //////////////////////// Purchase Tokens  /////////////  
    function buyTokens(address to, uint amount) public payable whenNotPaused() nonReentrant() returns(bool) {   
        ...
        require(amount <= remainingTokens, "currently paid tokens are sold out");           // Checks "Purchase supply" availability.
        ...
        totalTokensSold += amount;                                                                            // UPDATE TOTAL PURCHASED TOKENS  ie. increase total current purchased supply
        ...
        emit Sales (weiRaised,totalTokensSold);
        return true;
    }
    
   //////////////////////// Function get Remaining Tokens /////////////  
