...
contract StarterTokenBase {
     ...
     */
    function StarterTokenBase() public {
...
contract StarterToken is owned, StarterTokenBase {
    ...
    /* Initializes contract with initial supply tokens to the creator of the contract */
    function StarterToken() StarterTokenBase() public {}
...
/**
  @title StarterTokenSale
**/
contract StarterTokenSale is owned, Pausable {
    ...
    **/
    ...
    /**
        CONTRACT VARIABLES
    **/
    StarterToken public starterToken;
    ...
    uint256 public maxSellToken = 11000000 * 10 ** 18;
    ...
    **/
    ...
    /**
      @dev ICO CONSTRUCTOR
    **/
    function StarterTokenSale()
      public
    {
        starterToken = StarterToken(address(0xa0f81565105e2c28b8e85c1354646888994be6b1));

        startTime = 1530362569;
        wallet = address(0xca35a1c768084b71ab4bde6403497e98212afbeb);
    }
    ...
    **/
    function buyTokens() payable whenNotPaused public {
        ...
        if(tokenPool > maxSellToken){
            uint256 possibleTokens = maxSellToken.sub(tokensSold);
        ...
        starterToken.transfer(msg.sender, tokens);
    ...
    **/
    ...
    /**
      @dev allows the owner to change the max token sell
      @param _tokens uint256 the new maximum gas price
    **/
    function changeMaxTokenSell(uint256 _tokens)
      public onlyOwner whenNotPaused
    {
        maxSellToken = _tokens;
    }
    ...
    **/
    function isValidPurchase() view internal returns(bool valid) {
        ...
        require(tokensSold < maxSellToken);
