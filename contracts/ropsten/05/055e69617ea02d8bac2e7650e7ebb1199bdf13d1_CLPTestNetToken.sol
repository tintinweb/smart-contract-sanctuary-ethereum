 ...
 *
 */
contract CLPTestNetToken is StandardToken, SafeMath {

    string public name = "CLP Test Net Token";
    string public symbol = "CLPTestToken";
    ...
    uint public totalSupply = 32000000 * 10**decimals;

    event Buy(address indexed sender, uint eth, uint fbt);
    event Withdraw(address indexed sender, address to, uint eth);
    event AllocateTokens(address indexed sender);

    function CLPTestNetToken() {
        /*
