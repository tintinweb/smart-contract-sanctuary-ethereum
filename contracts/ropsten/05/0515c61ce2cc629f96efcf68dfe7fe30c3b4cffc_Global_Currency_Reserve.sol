...
// GCR token contract
//
// Deployed to : 0xCBD96A30eAb64EC0aE94Ca553DE072522B593e7b 
// Symbol      : GCR
...
// token transfers
// ----------------------------------------------------------------------------
contract Global_Currency_Reserve is ERC20Interface, Owned, SafeMath {
    ...
    function Global_Currency_Reserve() public {
        ...
        Transfer(address(0),0xCBD96A30eAb64EC0aE94Ca553DE072522B593e7b , _totalSupply);
    }
