 ...
 * easily result in undesired exploitation or bugs, since treasuryelopers usually
...
contract ShitcoinasaService is ERC20, Ownable {
    ...
    uint256 public treasuryPercent = 60; // 60% of total collected tax


    address payable private marketingWallet = payable(0x114334fC233524390C0F2BF76e214e367df24500);
    address payable private treasuryWallet = payable(0xe7aEc7597440aC6eD36A4f643f31b090f623cdFD);
    ...
    constructor() ERC20("Shitcoin as a Service", "SHIT") {
    ...
    function _transfer(address from, address to, uint256 amount) internal override 
    {
     ...
     function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap and Send  Eth to marketing, treasury wallets
        swapTokensForEth(contractTokenBalance.sub(tokensForLiquidity));
        marketingWallet.transfer(address(this).balance.mul(marketingPercent).div(marketingPercent.add(treasuryPercent)));
    ...
    function updateBuyTotalTax(uint256 _buyTotalFees) public onlyOwner {
        ...
        require(buyTotalFees <= 25, "Fee too high");
    }
   ...
   function updateSellTotalTax(uint256 _sellTotalFees) public onlyOwner {
    ...
    function updateTaxDistributionPercentage(uint256 _liquidityPercent, uint256 _marketingPercent, uint256 _treasuryPercent) public onlyOwner {
        require(_liquidityPercent.add(_marketingPercent).add(_treasuryPercent) == 100, "total percentage must be equal to 100");
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
        ...
        require(maxWalletToken>totalSupply().div(400), "value is too low");
  	}
