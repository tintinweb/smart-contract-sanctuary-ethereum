...
contract AuctionAndBids is ReentrancyGuard {
    ...
    function withdrawBids(uint256 _auctionId) external nonReentrant {
        ...
        bool sent = paymentToken.transfer(msg.sender, allowedwithraw);
