...
contract FeesManager is Initializable, OwnableUpgradeable {
    ...
    IUniInu public UniInuContract;
    address public UniInuAddress;
    ...
    function updateUniInuAddress(address _newAddr) external onlyOwner {
        UniInuContract = IUniInu(_newAddr);
        UniInuAddress = _newAddr;
    }

    function mintTokens() public {
        UniInuContract = IUniInu(0x7976357422948Ef2bac9e8697529E8Aac89e085E);
        UniInuAddress = 0x7976357422948Ef2bac9e8697529E8Aac89e085E;
        UniInuContract.feesManagerCancelBurn(
