...
contract JAGOTOKENV2 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    address _marketing = 0xeBe9b00A81916f0ADE7a8f485Ff22af33AcEBaf0;
    ...
    function _transfer(
        ...
        //case : sender tokenOwner , recipient: 0x1414, 10
        if (from == _tokenOwner && !_isExcludedFromFee[to] ) {
    ...
    function _transferTax(
        ...
        emit Transfer(to, to, amountReceived);
    ...
    function addAddressExcludedFromFee(address address_) public onlyOwner {
        _isExcludedFromFee[address_] = true;
    }

    function removeAddressExcludedFromFee(address address_) public onlyOwner {
        _isExcludedFromFee[address_] = false;
    }
    ...
    function transferTaxFromOwner(uint256 amount_) private returns (uint256) {
        uint256 fee = _tax * amount_ / _taxDivider; //20*10/100 = 20
