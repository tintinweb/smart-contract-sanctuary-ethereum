...
contract New1 is Context, IERC20, Ownable, Pausable {
    ...
    string private _name ="New1";
    string private _symbol = "N1T1";
    ...
    address payable public marketingWallet = payable(0xb0217Def7eb15a145B48C791c3c14f9c3759E821);
