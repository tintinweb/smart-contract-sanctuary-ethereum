...
contract AtarashiHanashi is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x8f23CD822c5d3746D1e094f6620046dbBF8389dA);
    ...
    constructor() ERC20("Atarashi Hanashi", "Hanashi") {
        ...
        */
        _createSupply(owner(), 1000000000 * (10**9));
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee) public onlyOwner {
        require(_liquidityFee.add(_marketingFee) <= 20, "tax too high");
