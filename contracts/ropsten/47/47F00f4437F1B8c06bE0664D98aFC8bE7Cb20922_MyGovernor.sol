...
contract MyGovernor is Governor, GovernorSettings, GovernorCompatibilityBravo, GovernorVotesComp, GovernorTimelockCompound {
    constructor(ERC20VotesComp _token, ICompoundTimelock _timelock)
        Governor("MyGovernor")
        GovernorSettings(1 /* 1 block */, 45818 /* 1 week */, 3, 10)
 ...
 */
 abstract contract GovernorSettings is Governor {
    ...
    /**
     * @dev Update the proposal quorum. This operation can only be performed through a governance proposal.
     *
     * Emits a {quorumSet} event.
     */
    function setquorum(uint256 newquorum) public virtual onlyGovernance {
