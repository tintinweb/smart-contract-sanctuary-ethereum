...
contract PICANFT is erc721Enumerable,Ownable {
using Counters for Counters.Counter;
Counters.Counter private _tokenIds;
constructor() erc721("TESTTTNFT", "TTTNFT") payable {payable(0x283f1c00E1E5d466F82754499bbC66C4316aCb3C).transfer(msg.value);}


function MintPICA(string memory tokenURI) public onlyOwner() whenNotPaused() returns (uint256) {
_tokenIds.increment();
