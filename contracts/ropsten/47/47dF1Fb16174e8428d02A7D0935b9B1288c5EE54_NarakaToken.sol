...
contract NarakaToken is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0xd27436ad06128b84EdCFCdE7322766CFD3081180); // Marketing Wallet
    address payable private ecosystemWallet = payable(0xd27436ad06128b84EdCFCdE7322766CFD3081180); // Ecosystem Wallet
    address payable private devWallet = payable (0xd27436ad06128b84EdCFCdE7322766CFD3081180); // dev Wallet
    ...
    string private _name = "HumanityWillReachMars";
    string private _symbol = "HWRM";
    ...
    uint256 public _buyEcosystemFee = 0;
    ...
    uint256 public _sellEcosystemFee =0;
    ...
    uint256 public swapThreshold = _tTotal.div(10000).mul(5); //
