...
contract UniswapCrossFlash {
    ...
    // Fund Smart Contract
    // Provides a function to allow contracts to be funded
    ...
    // Allows public view of balance of the contract
    ...
    function placeTrade(
        ...
        require(amountReceived > 0, "Aborted Tx: Trade Returned Error");
        return amountReceived;
    }

    // Start Arbitrage
    // Executing placing a trade
    ...
    function uniswapv1Call(
        address _sender,
        uint256 _amount0,
        uint256 _amount1,
        bytes calldata _data
    ) external {
        // Ensure that request came from contract
        ...
        require(msg.sender == pair, "The sender needs to watch the pair");
        require(
        ...
        // Check profitability
        bool proofCheck = checkProfitability(amountToRepay, trade2AcquiredCoin);
        console.log("acquired coin : %s", trade2AcquiredCoin);
        console.log("amount to repay : %s", amountToRepay);
        require(proofCheck, "Arbitrage not profitable");
...
// ? To improve:
// ? 1. Put addresses as variables
// ? 2. Change what type of swip I want to do
