...
contract MyShop is Ownable {
    ...
    IERC1155 private tokenA;
    IERC20 private tokenB;

   
    address public initial;

    address public DivideReceiver = 0x1a099bFeC641EB34CA9D677c2C61953c2623Be1e;
    ...
    event Synthesis(address indexed from,uint256[]  _tokenId, uint256[]   _amount, uint256  value);
    ...
    function commonSynthesis(uint256[] memory _tokenId,uint256[] memory _amount,uint256 _monsterTokenid) public {
        ...
        emit Synthesis(msg.sender, _tokenId, _amount,_monsterTokenid);
    ...
    function setDEADFee(uint256 _amount) external onlyOwner {
        DEADFee = _amount;
    }
