...
contract Order is Listing {
    ...
    /// @notice Internal function that handles the business logic of the creation and storage of a pod order within the Beanstalk ecosystem.
...
contract PodTransfer is ReentrancyGuard {
    ...
    /// @notice Internal function that returns the IBean object for the Bean stablecoin.
    /// @return IBean the IBean object of the Bean stablecoin
