...
contract MISSLEV8 is Context, IERC20, Ownable {
    ...
    string private _name = "MISSLE V8";
    string private _symbol = "MISSLV8";
    ...
    uint256 public _marketingAndTeamFee = 9;
    ...
    uint256 private numTokensSellToAddToLiquidity = 43000000 * 10**9;
