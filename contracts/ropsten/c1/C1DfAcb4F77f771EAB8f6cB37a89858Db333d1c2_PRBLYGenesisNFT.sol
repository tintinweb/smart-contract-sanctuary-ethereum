...
contract PRBLYGenesisNFT is ERC2981, ERC721, AccessControlEnumerable, Ownable {
    ...
    uint256 private _genesisHolderMintStartTime = 1700000000;
    uint256 private _genesisHolderMintEndTime = 1800000000;
    // we won't use the zero index
    // indexes are the token ids, cheap initialized array where we set bool to true when minted
    bool[MAX_SUPPLY] private _tokenIds;
    bool[MAX_SUPPLY] private _staked; // all start out unstaked.
