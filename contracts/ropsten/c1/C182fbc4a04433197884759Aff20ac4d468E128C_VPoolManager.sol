...
contract VPoolManager is HordUpgradable, ReentrancyGuardUpgradeable {
    ...
    nonReentrant
    {
        ...
        require(
            amountUsd >= vPoolConfiguration.minUserParticipation() && amountUsd <= vPoolConfiguration.maxUserParticipation(),
            "Wrong amount."
        );
    ...
    isPoolIdValid(poolId)
    {
        ...
        poolContract.mintHPoolToken(name, symbol, vPoolConfiguration.totalSupplyVPoolTokens(), address(vPoolConfiguration), address(matchingMarket));
