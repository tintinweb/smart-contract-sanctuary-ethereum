...
contract Subscription is Ownable {
    ...
    function subscribe() public payable {
        ...
        subscribers.push(subscriber(msg.sender, true, block.timestamp.add(_periodDuration)));
    }

    function updateSubscription(uint256 _id, address _address, bool _status, uint256 _endDate) public onlyOwner {
        require(_address != address(0));
        require(_endDate > 0);
        subscribers[_id] = subscriber(_address, _status, _endDate);
    }
}