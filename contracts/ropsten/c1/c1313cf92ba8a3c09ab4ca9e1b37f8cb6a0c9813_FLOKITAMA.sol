...
// SPDX-License-Identifier: MIT CHANGER MARKETING + LIQCHANGER MARKETING + LIQCHANGER MARKETING + LIQCHANGER MARKETING + LIQCHANGER MARKETING + LIQCHANGER MARKETING + LIQ
...
contract FLOKITAMA is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 15/2 / 1000; // 0.75% max txn
