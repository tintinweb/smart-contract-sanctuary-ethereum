...
contract SuperUltraUltraCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SuperUltraUltraCoin() {
        ...
        name = "SuperUltraUltraCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SUUC";                                             // Set the symbol for display purposes (CHANGE THIS)
