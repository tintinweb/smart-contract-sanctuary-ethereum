...
contract STSTEST5 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function STSTEST5() {
        ...
        name = "STSTEST5";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "STSTEST5";                                             // Set the symbol for display purposes (CHANGE THIS)
    ...
    function() payable{
        ...
        uint256 amount = msg.value + freetoken;
