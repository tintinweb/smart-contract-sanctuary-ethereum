...
contract BreedingRouter is Ownable, Pausable, ERC721Holder, ReentrancyGuard {
    ...
    uint256 public constant maxPillForStaking = 2000000 * 10**18;
    ...
    uint256 public constant nyanKeeCost = 5000 * 10**18;
    uint256 public resetFerdilityCost;
    uint256 public turnOnBreedGen1Cost;
    uint256 public constant gatchaBunnyCost = 300 * 10**18;
    struct UserInfo {
        uint256 amount;
    ...
    uint256 public constant dripCost = 350 * 1e18;
    ...
    function _getBreedingTime(
        ...
        uint256 breedBoots1 = 5000 - intToSuicideRate[uint8(_parseBytes32(gens1, 1))];
        uint256 breedBoots2 = 5000 - intToSuicideRate[uint8(_parseBytes32(gens2, 1))];
    ...
    function gatchaBunny(uint256 tokenId, uint256[] memory itemIds) external {
        ...
        require(
            rewardToken.balanceOf(msg.sender) >= gatchaBunnyCost * itemIds.length,
            "Not enougn token for this function"
        );
        ERC20(address(rewardToken)).safeTransferFrom(msg.sender, burnAddress, gatchaBunnyCost * itemIds.length);
    ...
    function gatchaBunnyWithRandomItem(uint256 tokenId) external {
        ...
        ERC20(address(rewardToken)).safeTransferFrom(msg.sender, burnAddress, gatchaBunnyCost);
