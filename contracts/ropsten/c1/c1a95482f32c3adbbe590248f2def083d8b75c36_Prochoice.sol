...
contract Prochoice is ERC1155, Ownable, ERC1155Supply, ReentrancyGuard, PaymentSplitter {

    string public constant name = "Prochoice DAO NFT";
    string private constant symbol = "PRO";
    string public baseURI = "https://ipfs.io/ipfs/QmZSKvPtibUYM6AB5C4fDERa35uUyH6n53vnYGHuPFo7eP/";
    uint256 public ethPrice = 1047;
