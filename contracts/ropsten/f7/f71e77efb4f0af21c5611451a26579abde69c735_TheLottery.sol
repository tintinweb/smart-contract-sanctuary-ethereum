...
contract TheLottery is ERC721 {

    uint private startTime;
  	TLToken TLContract;
  	uint constant PRICE = 10*10**18;
    ...
    function buyTicket(bytes32 hash_rnd_number) public {
        ...
        require(balances[msg.sender] >= PRICE, "You don't have enough balance to purchase a ticket");
