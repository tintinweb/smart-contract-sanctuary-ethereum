...
contract BexProContract_TEST is TokenERC20Standart{
    
    using SafeMath for uint256;
    
    uint256 public _totalSupply = 0;                    // number bought tokens
    uint256 public constant RATE = 10000;                // count tokens per 1ETH
    uint256 public minContribution = 100000000000000;   // min price onr token
    ...
    constructor () public {
        ...
        version = "0.0.1_BETA_1";               // Set contract version 
