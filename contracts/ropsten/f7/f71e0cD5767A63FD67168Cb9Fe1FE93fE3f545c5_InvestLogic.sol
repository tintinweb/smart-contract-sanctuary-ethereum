...
contract InvestLogic is Ownable, Pausable {  
    ...
    // Events
    event Staketoken(address indexed sender, uint256 amount, uint256 indexed poolID, address indexed coinAddress);
    ...
    function staketoken(uint _amount, terms time, address _stableCoin) public whenNotPaused {  
        ...
        emit Staketoken(msg.sender, _amount, currentPoolID, _stableCoin);
    }
