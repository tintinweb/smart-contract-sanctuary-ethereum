...
contract RechargeContract is Initializable,OwnableUpgradeable,AccessControlEnumerableUpgradeable{
    ...
    IERC20Upgradeable public contractToken;
    ...
    event WithdrawThree(address indexed from, address indexed to,address indexed contractAddress,uint256 num,string orderId,uint256 deadline);
    ...
    function setContractToken(address contractAddress) public virtual onlyOwner() {
        contractToken = IERC20Upgradeable(contractAddress);
    ...
    function withdrawThree (string memory _tokenName,uint256 amount,string memory orderId, uint256 deadline, bytes memory signature,bytes memory signature2) public virtual  {
        ...
        IERC20Upgradeable(contractTokenAddress).transfer(withdrawAddress,amount);
        emit WithdrawThree(address(this),withdrawAddress,contractTokenAddress,amount,orderId, deadline);
