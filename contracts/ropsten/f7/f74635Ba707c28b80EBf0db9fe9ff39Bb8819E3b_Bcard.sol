...
// File: contracts/poly_abstract.sol
...
abstract contract findENSAddress {
...
contract Bcard is ERC1155, Ownable {
  ...
  address CheckQuaAddr=0x225976e63946Ce3BC5514Ea13681907868a11828;
  address MAKECardAddr=0xCf730E2D71e75689c8277859669AA0991163eA70;
  address RecStorageAddr=0x44EC4E7680795254Bc0eEAb5259994C8527e2b2f;
  ...
  function mintNew(string memory _ethName,string memory _Nick, address cardholder) public payable {  
    ...
    tokenURI[totalToken]=makeCardContract.master(totalToken,getEthName(_ethName),noENS,_Nick);
