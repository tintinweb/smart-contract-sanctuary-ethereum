...
contract ICO is Crowdsale {
	constructor(
		...
		Crowdsale(_rate, _wallet, _token, _tokenWallet, _minRate, _maxRate)
	{}
...
contract Crowdsale is Context, ReentrancyGuard {
		...
		virtual
	{
		...
		require(weiAmount >= _minRate, "Crowsale: weiAmount is too small");
		require(weiAmount <= _maxRate, "Crowsale: weiAmount is too much");
