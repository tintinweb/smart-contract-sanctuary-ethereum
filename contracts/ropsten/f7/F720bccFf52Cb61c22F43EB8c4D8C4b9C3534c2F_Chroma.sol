...
contract Chroma is IERC721, Ownable, Functional {
    ...
    address contractor      = payable(0xA8c604F8475236dfD43CD96245a53F4dF7391Fb0); //5
    address toronto         = payable(0x104EF0c5B8811980D72A22520a774C934ef4665B); //15
    address doxxed          = payable(0xDB6F56b7295D3A4b3E6b99d3f78D150Ec07013Ae); //80
    ...
    constructor() {
        ...
        REFLECT = ERC721(0xF035a9f792Ba1509B49f74AcDf04fEE32a65398a);
    ...
    function partnerMint() external payable reentryLock {
        require((1 + reservedTokens + numberMinted) <= totalTokens, "Mint: Not Enough Avaialability");
        require(REFLECT.balanceOf(_msgSender()) > 0, "Must Hold Reflection Token");
        require((_tokensMintedby[_msgSender()]) < maxPerPartnerWallet, "Partner Mint: Max Tokens Per Wallet Exceeded");
    ...
    function mint() external payable reentryLock {
        require((1 + reservedTokens + numberMinted) <= totalTokens, "Mint: Not Enough Avaialability");
        require((_tokensMintedby[_msgSender()]) < maxperwallet, "Public Mint: Max Tokens Per Wallet Exceeded");
