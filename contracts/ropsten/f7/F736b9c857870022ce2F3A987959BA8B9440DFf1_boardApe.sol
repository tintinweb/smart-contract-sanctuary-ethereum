...
contract boardApe is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) ERC20("boardAPE", "brdAPE") {
        _mint(msg.sender, 1 ether); // mint 1 boardAPE for initial pools deployment
