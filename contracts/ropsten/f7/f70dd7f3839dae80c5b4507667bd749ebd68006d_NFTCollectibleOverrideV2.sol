...
import "./NFTCollectibleOverrideV1.sol";


contract NFTCollectibleOverrideV2 is NFTCollectibleOverrideV1 {
...
function mintNFTs(uint _count) public override(NFTCollectibleOverrideV1) payable {
    string memory newMintFUnction = "This is version 2 min function and only mints 5 nfts";
	super.mintNFTs(5);
}
...
contract NFTCollectibleOverrideV1 is  ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
...
//Replace Constructor with initialize
  //  constructor(string memory baseURI) ERC721("NFT Collectible Collection V1", "BlueNFT") {
    // setBaseURI(baseURI);
//}
//Ensures contract is initialized only once 
function initialize(string memory baseURI) public initializer {
   __ERC721_init("BlueBlingNFT Collectible Collection V1","BlueBlingNFT");
 __Ownable_init();   
...
function mintNFTs(uint _count) public virtual payable {
