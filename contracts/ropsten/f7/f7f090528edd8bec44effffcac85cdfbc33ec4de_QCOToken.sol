...
contract QCOToken is StandardToken {
    ...
    public
    {
        ...
        Mint(teamWallet, teamAmount);
        Transfer(0x0, teamWallet, teamAmount);

        uint256 reservesAmount = totalSupply.sub(teamAmount);
        balances[reserves] = reservesAmount;
        Mint(reserves, reservesAmount);
        Transfer(0x0, reserves, reservesAmount);
    }
