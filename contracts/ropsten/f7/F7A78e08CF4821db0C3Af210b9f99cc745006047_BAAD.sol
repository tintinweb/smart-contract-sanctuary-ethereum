...
contract BAAD is ERC20, Ownable, Pausable {
    ...
    event TransferLockUp(address indexed holder, uint256 value);
    ...
    function transferLockUp(address _holder, uint256 _releaseStart, uint256 _amount) public onlyOwner returns(bool){
        
        transfer(_holder,_amount);
        lock(_holder,_releaseStart,_amount);
        emit TransferLockUp(_holder, _amount);
        return true;
