...
contract AzumaToken is CappedToken {
    string public constant name = "Azuma Token";
    string public constant symbol = "AZC";
    uint8 public constant decimals = 18;

    constructor()
    CappedToken(20000000 * 10 ** uint256(decimals)) public
    {
