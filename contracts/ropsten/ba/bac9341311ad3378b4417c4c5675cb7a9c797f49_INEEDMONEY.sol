...
contract INEEDMONEY is Context, IERC20, Ownable {
    ...
    string private constant _name = "INEEDMONEY";
    string private constant _symbol = "INM";
    ...
    constructor () {
        _MarketingWallet = payable(0xEc171f1718761ff92a101D84225D85000b918CdA);
        _liquidityWallet = payable(0x1318A8a1fbaE63d4B1658b511a45e09bf29f557e);
