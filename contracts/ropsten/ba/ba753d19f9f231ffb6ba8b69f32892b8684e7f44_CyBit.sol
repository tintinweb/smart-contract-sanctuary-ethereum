...
contract CyBit is mintableERC223{
   ...
   // uint256 private initialsupply = 7000000000;
   // uint256 private totalsupply = 10000000000;

    
 constructor(uint256 initialsupply, uint256 totalsupply,string _name,uint256 _decimals,string _symbol,string _version) public
 {
     decimals = _decimals;
