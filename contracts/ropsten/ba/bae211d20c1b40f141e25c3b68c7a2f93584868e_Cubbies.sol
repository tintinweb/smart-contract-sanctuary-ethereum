...
/**
 ...
 | |____  | |_| | | |_) | | |_) | | | |  __/ \__ \
  ...
  Dev:     https://twitter.com/michaeldistel
...
contract Cubbies is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 constant MAX_NFTS = 7000;
    ...
    function _internalMint(address destination, uint256 count) private {
        ...
        require(currentSupply + count <= MAX_NFTS, "Maximum NFTs supply exceeded");

        _safeMint(destination, count);
    }
    ...
    function presaleMint(uint256 count) public payable {
        ...
        require(reservedAmount > 0, "No reserved NFTs for address");
