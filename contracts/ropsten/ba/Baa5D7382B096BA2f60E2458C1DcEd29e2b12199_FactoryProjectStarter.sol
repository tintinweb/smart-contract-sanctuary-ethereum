...
contract ProjectStarterCustom is ERC721, Ownable {
    ...
    string public metaDataColl;

    constructor(address setOwnerWalletAddress, string memory name, string memory symbol,string memory _metaData) ERC721(name, symbol) public {
        ownerWalletAddress = setOwnerWalletAddress;
        metaDataColl=_metaData;
...
contract FactoryProjectStarter {
    ...
    function deployNewCollection(address ownerAddress, string memory name, string memory symbol,string memory metaData) public returns (address){
        ProjectStarterCustom toDeploy = new ProjectStarterCustom(ownerAddress, name, symbol,metaData);
