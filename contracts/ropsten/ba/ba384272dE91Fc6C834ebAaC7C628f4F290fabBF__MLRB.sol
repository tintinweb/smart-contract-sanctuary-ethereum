...
contract _MLRB is IERC20, Ownable {
    ...
    constructor() payable {
        _rOwned[_msgSender()] = (_rTotal - startupToken);
        ...
        emit Transfer(address(0), _msgSender(), (_tTotal - startupToken));
    }
    ...
    function initialize() external onlyOwner returns (bool) {
        ...
        manageTrading(true);
        injectLiquidity(startupToken, address(this).balance);
        return true;
    }
