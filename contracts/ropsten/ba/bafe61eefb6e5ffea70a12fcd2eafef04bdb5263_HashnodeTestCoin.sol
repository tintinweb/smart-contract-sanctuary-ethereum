...
contract StandardToken is Token {
    ...
    function transfer(address _to, uint256 _value) validDestination(_to) returns (bool success) {
    ...
    function transferFrom(address _from, address _to, uint256 _value) validDestination(_to) returns (bool success) {
...
contract HashnodeTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function() payable{
        ...
        //uint256 preamount = msg.value / 10000000000000;
