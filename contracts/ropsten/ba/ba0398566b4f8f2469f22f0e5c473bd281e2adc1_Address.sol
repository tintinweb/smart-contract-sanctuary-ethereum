...
library ECDSA {
    ...
    function _throwError(RecoverError error) public pure {
...
contract goblintownNFTa is ERC721A, Ownable, ReentrancyGuard {  
    using Strings for uint256;
	...
	constructor() ERC721A("goblintown a", "GOBLINaa") {}
