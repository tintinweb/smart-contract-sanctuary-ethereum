...
contract Pollen  {
    ...
    function getBalanceCToken(address sender, uint256 tokenIndex) public returns(uint256) {

        StakedToken memory staked = rewards[tokenIndex];

        uint256 calc = cToken.redeem(cToken.balanceOf(address(this))) - rewards[tokenIndex].amount;
