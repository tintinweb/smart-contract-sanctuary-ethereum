...
// File: contracts/BarabooWhitelistCrowdsale.sol

contract BarabooWhitelistCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, WhitelistedCrowdsale{

  uint256 public investorMinCap = 0;
  uint256 public investorHardCap = 0;
  ...
  /**
   * @dev keeps track of the raised amount by contributor
  ...
  /**
   * @dev Verifies that the incoming contribution is between the cap limits
   * @param _beneficiary Reciever of the balance
   * @param _weiAmount transfer balance to check
   */
  function _preValidatePurchase(
    address _beneficiary,
    uint256 _weiAmount
   ...
   * @param _rate The new rate for the sale
   */
