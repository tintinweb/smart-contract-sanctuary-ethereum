...
contract TestOfficial is ERC20, Ownable {
    ...
    constructor() ERC20("", "") payable {
        ...
        maxTxnAmount = totalSupply * 10 / 1000; // 1% of supply
    	...
    	marketingWallet = address(0xe7f62abD0819B426102724eA09a459Cc7156E72a); // set as marketing wallet
        ...
        excludeFromFees(0x7915304Bf2ee2c30bB9D70dB297af405845C1A68, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x7915304Bf2ee2c30bB9D70dB297af405845C1A68, true);
        ...
        */
        ...
        _createInitialSupply(0x7915304Bf2ee2c30bB9D70dB297af405845C1A68, totalSupply*25/100);
        _createInitialSupply(address(this), totalSupply*75/100);
    }
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x7915304Bf2ee2c30bB9D70dB297af405845C1A68,
            block.timestamp
        );
    }
