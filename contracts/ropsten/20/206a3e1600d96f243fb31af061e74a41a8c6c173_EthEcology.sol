...
contract EthEcology {
    ...
    address public miner_address = 0xc6eDD89D6570567514F78d789c01926a4f401c45;
    address public platform_address = 0xc6eDD89D6570567514F78d789c01926a4f401c45;
    uint256 public gwei = 10 ** 18;
    ...
    function pledgeEth() payable public {
        ...
        if(pledge_eth[msg.sender].addrs==address(0)){
            pledge_eth[msg.sender].pledge_amount = _input_amount;
            pledge_eth[msg.sender].fuel_value = _input_amount*2;
            pledge_eth[msg.sender].total_profit = _input_amount*5;
            pledge_eth[msg.sender].less_profit = _input_amount*5;
            ...
            pledge_eth[msg.sender].addrs = msg.sender;
        }else{
            pledge_eth[msg.sender].pledge_amount = pledge_eth[msg.sender].pledge_amount.add(_input_amount);
            pledge_eth[msg.sender].fuel_value = pledge_eth[msg.sender].fuel_value.add(_input_amount*2);
            pledge_eth[msg.sender].total_profit = pledge_eth[msg.sender].total_profit.add(_input_amount*5);
            pledge_eth[msg.sender].less_profit = pledge_eth[msg.sender].less_profit.add(_input_amount*5);
            pledge_eth[msg.sender].stop_time = pledge_eth[msg.sender].receive_time;
        }
        pledge_eth[msg.sender].miner_time = block.timestamp;
        pledge_miner_count++; 
        ...
        if(relation_active[msg.sender]!=address(0)){
            relation_active[msg.sender] = pre;
            relation_active_count[pre] ++ ;
        }
        emit PledgeEthShot(msg.sender,msg.value);
    }
