...
contract HVerse is ERC721, Ownable {
  ...
  constructor() ERC721("HVerse", "HVS") {
    ...
    buildings.push(Building("HOUSE4", 1, 1, 2, 2, 0, 3));
    buildings.push(Building("HOUSE5", 1, 3, 2, 2, 0, 3));
    buildings.push(Building("HOUSE6", 1, 3, 2, 2, 0, 3));
    buildings.push(Building("HOUSE7", 1, 3, 2, 2, 0, 3));
    buildings.push(Building("HOUSE8", 1, 3, 2, 2, 0, 3));
    buildings.push(Building("HOUSE9", 1, 3, 2, 2, 0, 3));
    buildings.push(Building("HOUSE10", 1, 3, 2, 2, 0, 3));
    buildings.push(Building("HOUSE11", 1, 3, 2, 2, 0, 3));
  }
