...
contract PartyFactory is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function createParty(
        ...
        if (PFI_FEE > 0) {
            IERC20Upgradeable(PFI).transferFrom(
                msg.sender,
                address(this),
                PFI_FEE
            );
        ...
        BeaconProxy party = new BeaconProxy(
            ...
            abi.encodeWithSignature(
                "initialize(address,(string,string,string,string,string,bool,uint256,uint256),string,uint256,address,uint256,address,uint256)",
                msg.sender,
                partyInfo,
                tokenSymbol,
                initialDeposit,
