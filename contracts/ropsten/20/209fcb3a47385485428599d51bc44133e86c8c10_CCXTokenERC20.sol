...
contract CCXTokenERC20 {
    string public constant _myTokeName = 'PKN Token';//change here
    string public constant _mySymbol = 'PKN';//change here
    uint public constant _myinitialSupply = 1000000;//leave it
