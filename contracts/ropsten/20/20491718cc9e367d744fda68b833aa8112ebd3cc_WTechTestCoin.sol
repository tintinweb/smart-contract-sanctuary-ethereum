...
contract WTechTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WTechTestCoin() {
        ...
        name = "WTechTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WTTC";                                             // Set the symbol for display purposes (CHANGE THIS)
