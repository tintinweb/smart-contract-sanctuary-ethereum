...
contract SimpleToken is MintableToken {
  ...
  string public constant name = "Theory Chimney Switch"; // solium-disable-line uppercase
  string public constant symbol = "TCS"; // solium-disable-line uppercase
