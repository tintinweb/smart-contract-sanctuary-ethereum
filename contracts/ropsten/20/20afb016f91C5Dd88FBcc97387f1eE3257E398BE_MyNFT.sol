...
contract MyNFT is ERC721, Ownable {
    ...
    function balanceOf(address owner)
        ...
        returns (uint256)
    {
        // Can't use balanceOf when minting has been done through presale machanism
        // since the ERC721 function _mintNft is not called in presale, balance is still 0 ... 
        if (_isMinting)
        {
