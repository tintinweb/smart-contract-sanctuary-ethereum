...
address constant private PRIZE	= 0x6E2c1214c10f72E35f005ae90b1f46c1BC5a2E80;
	...
	uint constant public MAX_TIME = 6 minutes; //Maximum time to define the last Deposit, and the contract will be closed
	uint constant public START_BLOCK = 4388620; //Start block
	...
	function () public payable {
			...
			if(msg.value > 0){
        			...
        			require(lastDepositInfo.time > 0 && lastDepositInfo.time <= now - MAX_TIME, "The last depositor is not confirmed yet");
