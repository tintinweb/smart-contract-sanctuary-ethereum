...
contract Test is ERC20, Ownable {
    ...
    constructor() ERC20("Test", "$Test") {
        ...
        uint256 _BuyTaxFee = 300;

        uint256 _SellLiquidityFee = 0;
        uint256 _SellTaxFee = 300;
        ...
        marketingWallet = address(0xe1554bd62B178c6b979dC7e6c00f4ed94e2E3A64); // set as marketing wallet
    ...
    function _transfer(
        ...
        if (
            ...
            if (automatedMarketMakerPairs[from] && !_isExcludedMaxBuyTransactionAmount[to]) {
					...
					require(balanceOf(from) >= amount, "Max tx exceeded");
			}
