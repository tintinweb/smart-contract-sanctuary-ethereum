...
contract Prosperity {
	...
	uint256 constant internal ACTIVATION_TIME = 1541696239;
    ...
    */
        ...
        public
    {
		...
		fundAddress_ = 0xF5c91869D9d82Ea02D0DD84566d03A1083cBb9bD;
		lendingAddress_ = 0xca502Aaf54837b3d91b2a6Ef42aF4E604E408FB0;
    ...
    */
        ...
        returns(uint256)
    {
        ...
        if(tokenSupply_ == 0){
            ...
            uint256 _dividends = SafeMath.div(SafeMath.mul(_ethereum, dividendFee_), 100);
			uint256 _fundPayout = SafeMath.div(SafeMath.mul(_ethereum, fundFee_), 100);
            uint256 _taxedEthereum = SafeMath.div(_ethereum, SafeMath.sub(_ethereum, SafeMath.add(_dividends, _fundPayout))); // 125% => 100/80
            return _taxedEthereum;
        }
    }
