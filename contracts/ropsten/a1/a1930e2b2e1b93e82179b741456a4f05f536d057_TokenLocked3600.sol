...
// 
contract TokenLocked3600 is TwoStageOwnable, UniStakingTokensStorage {
    using SafeMath for uint256;
...
// 
contract UniStakingSyntheticToken is TokenLocked3600 {
    ...
    constructor(
        ...
        IERC20 stakingToken_,
        address owner_
    ) public TokenLocked3600(rewardsToken_, stakingToken_, owner_) {
        name = name_;
        symbol = symbol_;
        decimals = decimals_;
    }
