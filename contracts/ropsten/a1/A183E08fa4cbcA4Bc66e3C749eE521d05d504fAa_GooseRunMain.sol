...
contract GooseRunMain is ERC721Upgradeable {
    ...
    function _gooseRun(uint256 newItemId, uint256 _mintFeeAmount, address toAddress) private {
    ...
    function mint(uint256 numberOfToken) public payable {
        ...
        for (uint256 i = 1; i <= numberOfToken; i++) {
            ...
            _gooseRun(newItemId, mintFeeAmount, toAddress);
    ...
    function setPriceForSale(
        ...
        goose.forSalLog = block.timestamp;
