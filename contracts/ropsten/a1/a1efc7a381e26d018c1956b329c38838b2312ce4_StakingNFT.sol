...
//    mapping(uint256 => Staker) public stakerMain;
   ...
   constructor(address _token) {
    ...
    function totalRewardClaim(address _userAddress)  public view returns(uint){
        UserStakingHistory[] storage userdata = userhistory[_userAddress];
        uint total = 0;
    ...
    function _updateReward(uint _z) public view returns (address) {
        return stakerinfo[_z].userAddress;
