...
contract BPS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Based Points";//
    ...
    uint256 private constant _tTotal = 75 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xD5AF96BFB3a41f1081DD7CBB87d58b14108F13E8);//
    address payable private _marketingAddress = payable(0xD5AF96BFB3a41f1081DD7CBB87d58b14108F13E8);//
    ...
    uint256 public _maxTxAmount = 0.75 * 10**9; //
    uint256 public _maxWalletSize = 0.75 * 10**9; //
    uint256 public _swapTokensAtAmount = 0.075 * 10**9; //
