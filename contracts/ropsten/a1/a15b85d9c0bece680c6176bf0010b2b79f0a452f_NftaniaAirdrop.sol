...
contract NftaniaAirdrop is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Claim Airdrop //////////////////////////////////// 
    function getAirdrop ( bytes32 msgh, uint8 v, bytes32 r, bytes32 s, uint256 amount, address to, uint256 signedNonce)
     public whenNotPaused whenNotClosed nonReentrant returns (bool) { 
        ...
        // Prequalify airdrop
        updateStatus();
        require(amount * 10**18 <= remainingTokens,"Nftania Airdrop: No more Airdrop tokens are available");
   ...
   //////////////////////// function update Status /////////////  
    function updateStatus() public onlyOwner {
        ...
        require(!tokensFinished,"Nftania Airdrop: All tokens are distributed out");    
