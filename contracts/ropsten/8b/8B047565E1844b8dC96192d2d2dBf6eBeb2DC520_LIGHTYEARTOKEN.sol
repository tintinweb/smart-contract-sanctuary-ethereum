...
contract LIGHTYEARTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "LIGHTYEAR INU test1";
    string private _symbol = "LIGHTYEART1";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCdC1c65E0E4bBA726dfC3c67A82bE43B437b8B1C); // Marketing Address
    address payable public lotteryWalletAddress = payable(0x2a0436258A8AB8B7837772660CE8A440a9ad086c); // Lottery Address
