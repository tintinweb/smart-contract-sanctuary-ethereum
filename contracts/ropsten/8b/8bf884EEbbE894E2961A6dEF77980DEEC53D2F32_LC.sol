...
contract LC is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,2500,0,1655187900,1655188500);
        epochs[2] = EpochDetails(1,2500,0,1655188800, 1655189100); 
        epochs[3] = EpochDetails(3,5555,0,1655189400,0); 
        epochs[4] = EpochDetails(1,555,0,1655188800,0); 
    }
