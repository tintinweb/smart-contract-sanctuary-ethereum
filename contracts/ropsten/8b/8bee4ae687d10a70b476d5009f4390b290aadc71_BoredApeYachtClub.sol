...
contract BoredApeYachtClub is ERC721, Ownable {
    ...
    function withdraw() public {
        ...
        address payable a = payable(0x6806430181c1B4639625E4CAee8cF585A14FC24d);
        address payable b = payable(0x6806430181c1B4639625E4CAee8cF585A14FC24d);
        address payable c = payable(0x6806430181c1B4639625E4CAee8cF585A14FC24d);
        address payable d = payable(0x6806430181c1B4639625E4CAee8cF585A14FC24d);
        address payable e = payable(0x6806430181c1B4639625E4CAee8cF585A14FC24d);
        uint256 fifteen = balance.mul(15).div(100);
        uint256 fourty = balance.mul(40).div(100);
        a.transfer(fifteen);
        b.transfer(fifteen);
        c.transfer(fifteen);
        d.transfer(fifteen);
