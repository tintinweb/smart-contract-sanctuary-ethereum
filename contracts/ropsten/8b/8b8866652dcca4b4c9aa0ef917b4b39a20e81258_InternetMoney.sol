...
contract InternetMoney is ERC20, Ownable {
   ...
   uint64 private buyCounter=0;
    ...
    constructor() ERC20("Internet Money", "eCASH") {
        ...
        devwallet = address(0xba0CD7876160D7A623389d9910245807b0255C4B); // set as dev wallet
    ...
    function swapBack() private {
        ...
        // Halve the amount of buyback tokens
        uint256 buybackTokens = (contractBalance * tokensForBuyBack) /
            totalTokensToSwap /
            2;
        uint256 amountToSwapForETH = contractBalance.sub(buybackTokens);
