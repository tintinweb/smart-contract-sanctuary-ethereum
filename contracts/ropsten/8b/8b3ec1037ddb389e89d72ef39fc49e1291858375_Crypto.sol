...
contract Crypto is ERC1155, Ownable, Pausable, ERC1155Supply, RoyaltiesV2Impl {
    uint256 public constant MINT_PRICE = .0005 ether;

    constructor() ERC1155("") {}

    modifier denyContract() {
        require(tx.origin == msg.sender, "Crypto :: Call from contract is not allowed.");
        _;
    }
    ...
    function mint(uint256 id, uint256 amount) 
        ...
        denyContract
    {
        require(msg.value >= MINT_PRICE , "Crypto :: Not enough funds sent.");
