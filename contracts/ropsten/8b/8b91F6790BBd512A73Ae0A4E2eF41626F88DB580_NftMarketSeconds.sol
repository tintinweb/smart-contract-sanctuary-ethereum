...
contract NftMarketSeconds is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("SCCNFT", "SNcFT") {
        AllTokens.push(GruopNft(0.25 ether, 0, 8));     //DEJAR ESPACIO DE 10K DE NFTS POR EJEMPLO 0, 10000  .    20000, 40000

        AllTokens.push(GruopNft(0.35 ether, 16, 32));

        AllTokens.push(GruopNft(0.45 ether, 48, 72));
        ...
        returns (uint256)
    {
        ...
        // uint256 totalTokenIdBuy = group.startTokenId;
        // totalTokenIdBuy += amount;
