...
contract Marketplace is IERC721Receiver, Context, Ownable {
    ...
    returns (bool)
    {
        ...
        require(
            (_newBid >= auction.currentBidPrice && auction.bidCount == 0 ) || (_newBid > auction.currentBidPrice && auction.bidCount > 0 ),
        ...
        emit NewBidOnAuction(_auctionIndex, _newBid, auction.bidCount, _msgSender());
