...
contract DapNoxj is Ownable {
    ...
    mapping(address => string) public userVideoApp;
    ...
    function sendApplication(uint _amount, string memory _videroUrl) public {
        ...
        require(usersExists[msg.sender] == false ,"User should be unique");
        ...
        userVideoApp[msg.sender] = _videroUrl;
    ...
    //Check Application - owner only

    function checkApplication(address _applicant) external view onlyOwner returns(string memory){

        string memory _videroUrl = userVideoApp[_applicant];
    ...
    function acceptApplication(uint _applicationNo, address _withdrawTo) external onlyOwner {
        ...
        userVideoApp[msg.sender] = "";



        // Once the application is accepted, the user is unable to apply again, as he has already been accepted. 

        // usersExists[msg.sender] = false;
    ...
    // This function is for ether and with its removal, the dapp won't be able to accept Ether.
