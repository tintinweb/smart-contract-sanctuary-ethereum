...
contract IO is ERC721, Ownable, ReentrancyGuard {
    ...
    address private signerAddress=0x34F1BdC854e5e95381a5dbc25b1c6b5eE6456A7E;
        ...
        payable
    {
        ...
        if (!matchAddresSigner(hashTransaction(msg.sender), signature)){
            ...
            console.log("Transaction done", msg.sender);
        }
    ...
    function matchAddresSigner(bytes32 hash, bytes memory signature)
        ...
        returns (bool)
    {
        console.log("hash recover", hash.recover(signature));
        return signerAddress == hash.recover(signature);
    }

    /*function hashTransaction(address sender) public pure returns (bytes32) {
