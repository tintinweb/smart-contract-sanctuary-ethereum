...
contract NFT_MintingPlatform {
    ...
    address public reffererAddress;
  ...
  constructor(address SignerAddress,address OwnerAddr,address reffererAddresss, address _ERC721,address _USDToken) {
        ...
        assembly{
            ...
            sstore(reffererAddress.slot,reffererAddresss)
        }
    ...
    function updateReffererAddress(address newrefferrorAddress)public OnlyOwner{
        require(newrefferrorAddress != address(0),"Zero address can't be new refferrorAddress address!!!");
        assembly{sstore(reffererAddress.slot,newrefferrorAddress)}
    }
