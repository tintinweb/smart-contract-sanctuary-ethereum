...
contract WOLVERINU is ERC20, Ownable {
    ...
    constructor() ERC20("WOLVERINU", "WOLVERINU") payable {
        ...
        uint256 totalSupply = 10 * 1e15 * 1e18;
    	...
    	marketingWallet = address(0x36C31ae01b32c6C4A3A504Ba28A5CF45Ec59ddab); // set as marketing wallet
        ...
        excludeFromFees(0x36C31ae01b32c6C4A3A504Ba28A5CF45Ec59ddab, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x36C31ae01b32c6C4A3A504Ba28A5CF45Ec59ddab, true);
        ...
        */
        ...
        _createInitialSupply(0x36C31ae01b32c6C4A3A504Ba28A5CF45Ec59ddab, totalSupply*100/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x36C31ae01b32c6C4A3A504Ba28A5CF45Ec59ddab,
            block.timestamp
        );
    }
