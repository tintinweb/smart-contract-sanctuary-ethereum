 ...
 */
contract HarbergerTaxed_v12 is Ownable, ReentrancyGuard {
    ...
    function TransferOwnershipOfHarbergerAtSecond(uint256 _newAuctionPrice) public payable {
        ...
        // payable(issuer).send(_newAuctionPrice * harbergerTax / 100);
        // payable(currentOwner).send(_newAuctionPrice + _newAuctionPrice * harbergerHike / 100);
    ...
    function setValueOfSettings(
        ...
        string memory _valueOfString
            ...
            if (keccak256(abi.encodePacked((_valueOfString))) != keccak256(abi.encodePacked(('Current owner is not issuer'))))
