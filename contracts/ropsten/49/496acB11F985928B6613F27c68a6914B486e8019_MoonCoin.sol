...
contract MoonCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MoonCoin() {
        ...
        name = "MoonCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MOON";                                             // Set the symbol for display purposes (CHANGE THIS)
