...
contract Purchase {
    ...
    constructor(address _admin,uint _MD_LBP,uint _MD_KSP,string id,string _task,uint _price) public payable {
    ...
    function GetMsg(string id)view onlyKSP public returns(string,string){
