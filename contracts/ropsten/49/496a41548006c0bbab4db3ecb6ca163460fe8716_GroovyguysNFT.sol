...
/**
 * @title A contract for Groovyguysnft.io
 * @author Hiro
 * @notice NFT Minting
 */
contract GroovyguysNFT is ERC721, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    using SafeMath for uint256;
    using SafeMath for uint8;

    uint256 public constant MAX_SUPPLY = 6999;
    ...
    address[] private _royaltyAddresses = [
        0xb20F2a4601aED75B886CC5B84E28a0D65a7Bfd48,  // Dev wallet address
        0x04e1646ae8bc0ae0B89116Ac484e9b382232abf8,  // Artist wallet address
        0x78244E7A862bDa32B1A44beBD5A91BabF6cf23E3   // Team wallet address
    ];
    ...
    ) ERC721("GroovyGuys", "GGS") {
        setBaseURI(_initBaseURI);
        setNotRevealedURI(_initNotRevealedURI);
        _royaltyShares[_royaltyAddresses[0]] = 2;  // Royalty for Dev
        _royaltyShares[_royaltyAddresses[1]] = 25; // Royalty for Artist
        _royaltyShares[_royaltyAddresses[2]] = 73; // Royalty for Team
    }
    ...
    function mintAdmin(uint256 _count) external onlyOwner {
