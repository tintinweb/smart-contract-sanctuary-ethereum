...
contract WildMestPasses is ERC1155Supply, Ownable 
{
    ...
    uint public maxSupply = 16;
    uint256 public maxPerWallet = 2;
    string public name;
    address public caller;
    uint256 public constant PRICE = 20000000000000; //0.0002
    uint256 public constant WLPRICE = 10000000000000; //0.0001
    ...
    address payable private recipient1  = payable(0xaEBF8eDeEe630ABbE0d9c6926FA653B3415907ca);
    ...
    function addToWhitelistMultiple(address[] memory _addresses) public onlyOwner {
    ...
    function WLMINT(uint256 amount) external payable 
    {
        ...
        require(saleIsActive, "Sale must be active to mint");
        require(amount > 0 && amount <=2 , "Amount cannot be negative or greater than 2");
        require(totalSupply(activeBadgeId) + amount <= maxWLSupply , "Purchase would exceed max whitelist supply");
