...
contract WorldCup {
    ...
    function setbetEnd() public {
        ...
        bonusPool = this.balance.sub(serverGas);
    }
    ...
    function settle() public payable {
        ...
        // settle
        for (i = 0; i < victors.length; i++) {
            victorsWeight = victorsWeight.add(victors[i].betWeight);
        }
