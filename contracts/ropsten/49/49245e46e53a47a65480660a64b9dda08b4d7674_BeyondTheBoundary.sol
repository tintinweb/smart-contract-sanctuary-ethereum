...
contract BeyondTheBoundary is ERC721A, Ownable {
    ...
    uint256 public constant publicPrice = 0.005 ether;
    ...
    function publicMint(uint256 quantity) external payable {
        ...
        require(_minter == tx.origin, "Contract minting is not allowed");
        require(quantity < MAX_PER_TX + 1, "Not allowed to mint this many");
