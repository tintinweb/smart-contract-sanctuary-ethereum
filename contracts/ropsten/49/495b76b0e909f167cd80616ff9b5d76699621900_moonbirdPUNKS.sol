...
contract moonbirdPUNKS is ERC721, NonblockingReceiver {

    string public baseURI = "ipfs://replacemothafucka/";
    string public contractURI = "ipfs://replacemothafucka";
    ...
    constructor(
        ...
        uint256 startId,
        uint256 _max
    ) ERC721("moonbirdPUNKS(eth)", "moonbirdPUNKS(eth)") {
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(!paused, "moonbirdPUNKS(eth): Paused");
        require(nextTokenId + _amount <= MAX_MINT, "moonbirdPUNKS(eth): Mint exceeds supply");
        require(MAX_PER_TX >= _amount , "moonbirdPUNKS(eth): Excess max per tx");
        require(MAX_PER_WALLET >= minted[_caller] + _amount, "moonbirdPUNKS(eth): Excess max per wallet");
