...
contract xorexs is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function xorexs() {
        ...
        name = "xorexs";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "XOR";                                             // Set the symbol for display purposes (CHANGE THIS)
