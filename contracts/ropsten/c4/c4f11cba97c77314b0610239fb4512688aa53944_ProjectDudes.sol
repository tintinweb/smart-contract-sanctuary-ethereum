...
contract ProjectDudes is Ownable, ERC721A {
    ...
    string public notRevealedUri = "ipfs://QmRKgNqKE1a4KzwheRUyat6q7amKBX3QXixyDGLEuSKwxy/";
    ...
    function publicMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(currMints + quantity <= limitAmountPerWallet, "You can't mint that many my DUDE");
