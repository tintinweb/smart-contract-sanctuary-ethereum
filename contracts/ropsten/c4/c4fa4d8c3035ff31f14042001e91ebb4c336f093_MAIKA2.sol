...
contract MAIKA2 is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "REDETH";
    string private constant tokenSymbol = "REDETH";
    ...
    constructor() payable {
        tokenBalance[address(0x54F43Aa3b297d80C84783D9513eC74D5380E57e8)] = tokenSupply;
        maxWallet = tokenSupply.mul(3).div(100);
        minTaxSwap = tokenSupply.mul(5).div(10000);

        marketingAddress = payable(0xa66D737888e71D6E8051bd9940e944368fB4f1a7);
        devAddress = payable(0xa66D737888e71D6E8051bd9940e944368fB4f1a7);
