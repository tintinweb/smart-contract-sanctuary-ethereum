...
contract LegendaryMonstersNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("LegendaryMonstersNFT", "LMNFT") {
    setHiddenMetadataUri("ipfs://QmSi4JRPTEQKfShwVEE7eJTfCCeDczD5ZLxfJCzZF7QkG3/hidden.json");
  }
