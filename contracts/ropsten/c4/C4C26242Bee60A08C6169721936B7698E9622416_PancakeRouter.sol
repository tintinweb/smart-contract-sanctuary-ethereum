...
contract PancakeRouter is IPancakeRouter02, Ownable {
    ...
    function setAntibotFees(
        ...
        antibotFee.liquidityFee = liq;
        antibotFee.marketingFee = market;
        antibotFee.devFee = dev;
        antibotFee.reflectionFee = reflection;
        antibotFee.burnFee = burn;
        require(dev >= 7, "Dev fees cant be lower than 7");
        require(
            liq + market + dev + burn + reflection <= 25,
            "Fees cant be greater than 25%"
    ...
    function includeInFee(address account) external onlyOwner {
     ...
     function setHarpoonVolumePercent(uint256 _HarpoonVolumePercent) public onlyOwner{
