...
//
// Owner Address : 0xC3a7b0caCDDf74cB69E94DF2a504467946086E02
// Symbol      : PIZ
// Name        : PIZ Token
...
contract PIZTOKEN is owned {
    ...
    string public name = "PIZ Token";
    string public symbol = "PIZ";
    uint8 public decimals = 18;
    uint256 public totalSupply = 1000000 * 10 ** uint256(decimals);
     /// the price of tokenBuy
    uint256 public TokenPerETHBuy = 10000000000000000;
    
    /// the price of tokenSell
    uint256 public TokenPerETHSell = 10000000000000000;
...
contract PIZ_ICO is Killable {
    
     /// The token we are selling
    PIZTOKEN public token;
