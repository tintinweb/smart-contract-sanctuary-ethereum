...
contract Holder is ERC721A, Ownable, Pausable, ReentrancyGuard {
    // metadata
    ...
    ) public view isValidMerkleProof(merkleProof) returns (uint256) {
