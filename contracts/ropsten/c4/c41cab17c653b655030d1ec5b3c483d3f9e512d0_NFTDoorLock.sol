...
// File: contracts/ERC721Rentable.sol
 ...
 * {ERC721Enumerable}.
 */
contract ERC721Rentable is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(uint256 => address) private _mappedOwners;
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721Rentable.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(ERC721Rentable.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721Rentable.ownerOf(tokenId), to, tokenId);
    }
...
// File: contracts/NFTDoorLock.sol
