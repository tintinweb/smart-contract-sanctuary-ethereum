...
/*
 ...
 ,  ,'  ,--.  `,   \.;'         `
  `{D, {    \  :    \;
    ...
    Stories about aging have traditionally focused on the need for graceful accommodation.
    ...
    Given that nothing could be done to prevent or retard aging, this focus made sense. Rather than fretting about the inevitable, one could aim for peace of mind.
...
contract FABLE is ERC20, Ownable {
