...
abstract contract Swap is Storage, UserWallet, EIP712Upgradeable {
  ...
  function executeSwapWithSignature(
    ...
    emit SwapPerformed(swapId, swapConstraints.swapGateway, swapConstraints.user, swapConstraints.tokenFrom, swapConstraints.amountFrom, swapConstraints.tokenTo, tokenToAmount);
  }
  ...
  function executeSwapWithSelfLiquidity(
    ...
    emit SwapPerformed(swapId, bytes32(0), user, tokenFrom, amountFrom, tokenTo, tokenToAmount);
  }
