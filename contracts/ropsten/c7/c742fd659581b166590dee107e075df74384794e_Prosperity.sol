...
contract Prosperity {
	...
	uint256 constant internal antiPumpAndDumpTime_ = 30 minutes;							// remember it is constant, so it cannot be changed after deployment
	...
	uint256 constant internal ACTIVATION_TIME = 1541448500;
    ...
    */
        ...
        public
    {
		...
		fundAddress_ = 0x1C43901d740B9F7bAdb8Dd314515Bec7A286700f;
		lendingAddress_ = 0x25dA1B71a689697589Df09C9E5b8394C2a8Fc7e2;
        
        // add the ambassadors here.
        ambassadors_[0x6bca7e1EC8595B2f0F4D7Ff578F1D25643004825] = true;	// tobi
        ambassadors_[0x6134DD437C51423410BE01aBB8D7CEe427B90481] = true;	// fabi
		ambassadors_[0x13f168168E2dB70679a59A191AFb62111D4142Ec] = true;	// julian
		ambassadors_[0xB62E2dcBf305ef0735b30F090C5822cA7CD07f65] = true;	// dominik
		ambassadors_[0xd2e67b7678c2AFEe6C3Bf3E698Aa19F1d6fc0746] = true;	// lukas
