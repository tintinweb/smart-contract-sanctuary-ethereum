...
contract LiquexPrivateInvestment is PausableToken {
    string  public  constant name = "Liquex Private Investment";
    string  public  constant symbol = "LQP";
    ...
    function LiquexPrivateInvestment( address _admin ) 
    {
