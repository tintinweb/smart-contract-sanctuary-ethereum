...
contract QuantumXV1 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Quantum XV1";
    string private constant _symbol = "Quantum XV1";
    ...
    address public treasuryAddress = 0xb3CE07935586887323AfE16A83Af52B9B833d3d3;
    address public marketingAddress = 0x82dbD74cfD093625bD0A62Aaccc81D4AF4cFEF93;
    address public devAddress = 0x42e3a8F823115C1DFe41F67A6bb9BA1E58301976;
    ...
    uint256 public _swapTokensAtAmount = 20000 * 10**_decimals;
    ...
    function sendETHToFee(uint256 amount) private lockTheSwap {
        ...
        uint256 treasuryShare = distributionEth.mul(distribution.treasury).div(100);
    ...
    function manualswap() external {
        require(_msgSender() == devAddress || _msgSender() == marketingAddress || _msgSender() == treasuryAddress);
    ...
    function setDistribution(uint256 devTeam, uint256 marketing, uint256 treasury) external onlyOwner {        
        distribution.devTeam = devTeam;
        distribution.marketing = marketing;
        distribution.treasury = treasury;
    }

    function setWalletAddresses(address devAddr, address marketingAddr, address treasuryAddr) external onlyOwner {
        devAddress = devAddr;
