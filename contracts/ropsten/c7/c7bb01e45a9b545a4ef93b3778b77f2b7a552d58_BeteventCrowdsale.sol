...
contract BeteventCrowdsale is CappedCrowdsale, RefundableCrowdsale {
  ...
  // Nustatom default stage i pre ico ico2 ico3
  // ============
  ...
  // Tokenu padalinimas
  // =============================
  uint256 public maxTokens = 75000000000000000000000000; // Visas Kiekis tokenu
  uint256 public tokensForEcosystem = 3750000000000000000000000; // is ju 10 eko systemai
  uint256 public tokensForTeam = 7500000000000000000000000; //10 is ju komandai  
  uint256 public tokensForDevelopment = 7500000000000000000000000; // developmentui 
  uint256 public totalTokensForSale = 56250000000000000000000000; // 65 is ju bus parduota per crowdsale
  uint256 public totalTokensForSaleDuringPreICO = 11250000000000000000000; // 15 is ju parduota per pre ico
  // ==============================

  // Kiekis surinktas pre ico
  // ==================
  ...
  // =================
  function createTokenContract() internal returns (MintableToken) {
    return new BeteventToken(); // Sukuria tokena automatiskai kai sukuriams crowdsaleas
  }
  // ==================
