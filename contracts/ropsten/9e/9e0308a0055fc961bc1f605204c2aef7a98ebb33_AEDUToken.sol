...
contract AEDUToken is IERC20 {
    ...
    function authorization(address newUser) public {
        require(authorized_map[msg.sender] == true, "you are not authorized to authorize users");
        require(authorized_map[newUser]==false, "user already authorized");
    ...
    function mint(address account, uint256 amount) external virtual {
        ...
        require(authorized_map[msg.sender] == true, "you are not an authorized user");
