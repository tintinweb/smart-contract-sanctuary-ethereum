...
contract cripto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "cripto inu";
    string private constant _symbol = "cryp";
    ...
    address payable private _marketingAddress = payable(0x5Ec1C6AC1a0f75C0378f6551F4E492EDD4F7B5E9);
