...
contract MrMeta is ERC721Enumerable, DataLayout, Proxiable, Ownable {
    using SafeMath for uint256;
    
    constructor() ERC721("MrMetas", "MRMETA") {
    ...
    function NFTConstructor(address _manager) public payable {
        ...
        gateWay = "https://mrmeta.mypinata.cloud/ipfs/";
        proxyConstructor("MrMetas", "MRMETA");
        mintCost = 0.06 ether;
        mintLimit = 4500;
        userMintLimit = 5;
    ...
    function createNFT(uint amount, address claimer, bool ownerMint) public payable delegatedOnly {
        ...
        if (!ownerMint) {
            require(amount <= 5, "Invalid mint amount");
            require(userMintCount[msg.sender].add(amount) <= userMintLimit, "mint limit for user reached");
        ...
        currentMintCount = currentMintCount.add(amount);
    }
