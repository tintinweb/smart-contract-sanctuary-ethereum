...
contract ClubVirtual is NFTokenMetadata {
 ...
 uint256 _tokenId;
  ...
  function transferamount(address creator,address admin,address owner,uint256 amount,uint256 adminpersent, uint256 royaltypersent, uint256 tokenId) public payable
