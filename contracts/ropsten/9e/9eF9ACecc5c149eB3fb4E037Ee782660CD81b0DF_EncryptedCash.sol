...
/*
    ...
    Tokenomics (STO => This is security token)

     *** Token information
     * name =>          Encrypted Cash
     * symbol =>        CASH
     * decimals =>      18 
     * total supply =>  10 M (= 10**7)

     *** Token distribution
     * Presale for Investors    => 20%
     * Liquidity                => 10%
     * Public Staking           => 15%
     * Utility Ecosystem        => 35%
     * Team                     => 20%
...
contract EncryptedCash is ERC20Detailed, ERC20Pausable, MinterRole, BlacklistedRole {

  using SafeERC20 for ERC20;
  
  //   string public name = "Encrypted Cash";
  ...
  //   uint256 private _totalSupply = 1000000000 * (10 ** uint256(decimals));
    ...
    uint256 public _presale_amount;
    uint256 public  _liquidity_amount;
    uint256 public  _public_amount;
    uint256 public  _utility_amount;
    uint256 public  _team_amount;
        ...
        public
    {
        ...
        // _total_supply = 100 * 10**5 * 10**uint256(decimals)
        _presale_amount = 20 * 10**5 * 10**uint256(decimals);
        _liquidity_amount = 10 * 10**5 * 10**uint256(decimals);
        _public_amount = 15 * 10**5 * 10**uint256(decimals);
        _utility_amount = 35 * 10**5 * 10**uint256(decimals);
        _team_amount = 20 * 10**5 * 10**uint256(decimals);

        presale_address = 0x5C29099Dc53ddf3b3Fa3a299C48EC1Bff9C59d29;
        liquidity_address = 0x5C29099Dc53ddf3b3Fa3a299C48EC1Bff9C59d29;
        public_address = 0x5C29099Dc53ddf3b3Fa3a299C48EC1Bff9C59d29;
        utility_address = 0x5C29099Dc53ddf3b3Fa3a299C48EC1Bff9C59d29;
        team_address = 0x5C29099Dc53ddf3b3Fa3a299C48EC1Bff9C59d29;

        transfer(presale_address, _presale_amount);
        transfer(liquidity_address, _liquidity_amount);
        transfer(public_address, _public_amount);
        transfer(utility_address, _utility_amount);
        transfer(team_address, _utility_amount);
