...
contract AcquinomToken is StandardToken {

    string public constant name = "Acquinom Token";
    string public constant symbol = "ACQ";
    ...
    function AcquinomToken(address _owner) public {
    ...
    */
    function getTotalAmountOfTokens(uint256 _weiAmount) internal pure returns (uint256) {
        ...
        if( _weiAmount == 5.0 ether){
            amountOfTokens = 10000 * 10**3 * (10**uint256(decimals));
        }
        if( _weiAmount == 1.0 ether){
