...
contract TEST is Context, IERC20 {
    ...
    uint256 buyCoolDown = 3 minutes;

    uint256 private startingSupply = 1_000_000_000;

    string private _name = "mufatTEST";
    string private _symbol = "mufatTEST";
    ...
    // @Certik, check our setter functions
    uint256 private maxTxPercent = 75;
...
//===============================================================================================================
    ...
    function setBuyCoolDownTime(uint256 timeInMinutes) public onlyOwner{
        uint256 timeInSeconds = timeInMinutes * 60 seconds;
