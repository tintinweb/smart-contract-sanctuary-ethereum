...
contract CNSController is ERC721, Ownable {
    ...
    ) ERC721("Community Name Services", "CNS") {
    ...
    function _setSubdomain(
        ...
        ens.setSubnodeRecord(_node, _label, address(this), resolverAddress, 0);
        ...
        _tokenIds.increment();
        _mintCNS(_tokenIds.current());
        //TODO: FIX Metadata uri
        _setTokenURI(
            _tokenIds.current(),
            "https://metadata.ens.domains/ropsten/0x57f1887a8bf19b14fc0df6fd9b2acc9af147ea85/0xbef1f3d0596fbe75afc570c9911523400ab06b60768af7e5ea7a0cff56412071"
        );
    }

    function _mintCNS(uint256 _tokenId) internal {
