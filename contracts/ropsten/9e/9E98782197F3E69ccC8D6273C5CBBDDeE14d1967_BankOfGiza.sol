...
Previous project was BankOfLinu who hit more than 300k MC from 7k.

Dashboard for track & claim rewards will be release around 1h after launch and are still in dev.
...
contract BankOfGiza is Context, IERC20, Ownable { ////
    mapping (address => uint) private _owned;
    mapping (address => mapping (address => uint)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => User) private cooldown;
    mapping (address => bool) private _isBot;
    uint private constant _totalSupply = 21000000 * 10**9;

    string public constant name = unicode"BankOfGiza"; ////
    string public constant symbol = unicode"BOGIZA"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 420000 * 10**9; // 2% 
        _maxHeldTokens = 840000 * 10**9; // 4%
    }
