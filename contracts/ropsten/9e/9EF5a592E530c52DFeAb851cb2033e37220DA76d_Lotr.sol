...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x11E097B2876fC7B576b3709d386086fBc1184F18;
...
contract Lotr is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x907aA1CD4FEb075a6B5b1258bf79385E774f41f9;
    address private _devWalletAddress = 0xdF4BD96D35132F2CaAfb531C332dbc34eaD1768f;
   


    string private _name = "Lord Of The Rings";
    string private _symbol = "LOTR";
    uint8 private _decimals = 9;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1954 * 10**6 * 10** _decimals;
    ...
    uint256 private numTokensSellToAddToLiquidity = ((_tTotal * 2) / 100) / 10;
