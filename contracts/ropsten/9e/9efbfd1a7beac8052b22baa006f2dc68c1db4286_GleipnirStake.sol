...
// File: contracts/GleipnirStake.sol
...
contract GleipnirStake is AccessControl, ReentrancyGuard {
    ...
    constructor(address _stakingToken, uint48 _lockTimePeriod) {
        ...
        require(_lockTimePeriod < 60 days, "lockTimePeriod >= 366 days");
        ...
        stakeRewardEndTime = uint48(block.timestamp + 60 days); // default : reward scheme ends in 1 year
