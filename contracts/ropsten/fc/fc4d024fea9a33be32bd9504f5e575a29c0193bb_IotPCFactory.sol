...
contract IotPCFactory {
    ...
    event ContractPublished(bytes32 merkle_root, bytes20 package_info_hash, address indexed contract_creator,address contract_address,bytes20 filehash, uint days_till_expiration);
