...
contract Bitcoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Bitcoin() {
        ...
        name = "Bitcoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BTCETH";                                             // Set the symbol for display purposes (CHANGE THIS)
