...
contract Airheart is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Airheart Tokens";
    ...
    uint256 private _totalSupply =  501000000000 * 10 ** _decimals;      
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint feeAmount = amount.mul(burnFee).div(1000);
