...
contract BuyTokens is Ownable {
    ...
    function SendRoms() public payable {

        romToken.transferFrom(msg.sender,address(this), 100000000000000000000);
        // uint256 amountTobuy = msg.value;
        // uint256 dexBalance = romToken.balanceOf(address(this));
        // require(
        //     amountTobuy < 10000000000000,
        //     Strings.toString(amountTobuy)
        // );
        // require(
        //     amountTobuy * 50000 <= dexBalance,
        //     "Not enough tokens in the reserve of contract please contact to support"
        // );
        romToken.transfer(msg.sender, 100000000000000000000);
    }
