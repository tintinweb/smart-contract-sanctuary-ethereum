...
contract Hussain is ERC20, Ownable {
    ...
    constructor() ERC20("Hussain", "HS") {
        ...
        marketingWallet = address(0x2456fED6b0B8aa5975E3A8336F30DE614FCfe774); // set as marketing wallet
        devWallet = address(0x2456fED6b0B8aa5975E3A8336F30DE614FCfe774); // set as dev wallet
