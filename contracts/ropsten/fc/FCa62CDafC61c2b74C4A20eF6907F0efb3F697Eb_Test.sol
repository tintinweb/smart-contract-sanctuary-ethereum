...
contract Test is ERC20, Ownable {
    ...
    function showUserDonation(address account) public view returns (uint256) {
        return userDonation[account];
    }

    function showUserBurned(address account) public view returns (uint256) {
        return userBurned[account];
    }
