...
contract HASHI is Context, IERC20, Ownable {
    using SafeMath for uint256;

    address private _uniswapRouterAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Uniswap Router Address
    address payable public marketingAddress = 0xa03EEa6928992B1Ff82a64967D9D6906cAFbE7ee; // Marketing Address
    address payable public burningAddress = 0x0000000000000000000000000000000000000000; // Burn Address
    address payable public treasuryAddress = 0xF5D33070e73A44D9De259841075E2150B4a392Ad; // Treasury Address
    ...
    uint256 private constant _tTotal = 628000000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "HashLinkV9";
    string private constant _symbol = "HASHI9";
    ...
    uint256 public _upperLv2Fee = 3000;
    uint256 public _upperLv3Fee = 2000;

    uint256 private minimumTokensBeforeSwap = 6280 * 10**9 * 10**9;
    uint256 public _maxWalletAmount = 6280000 * 1 * 10**9 * 10**9;
...
//        require(account != _uniswapRouterAddress, 'Cant exclude Pancake router');
    ...
    function setSwapMarketingEnabled(bool _enabled) external onlyOwner {
    ...
    function transferContractBalance(uint256 amount) external onlyOwner {
        require(amount > 0, "Transfer amount must be greater than zero");
