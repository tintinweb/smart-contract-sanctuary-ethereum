...
contract AXCERToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    uint256 constant MAXIMUMSUPPLY = 1000000 * 10 ** 8;
    uint256 constant MINIMUMSUPPLY = 100000 * 10 ** 8;

    function initialize(uint256 initialSupply) external initializer {
        require(!initialized, "Contract instance has already been initialized");
        initialized = true;
        __ERC20_init("AXCERToken", "AXCT");
        __Ownable_init();
