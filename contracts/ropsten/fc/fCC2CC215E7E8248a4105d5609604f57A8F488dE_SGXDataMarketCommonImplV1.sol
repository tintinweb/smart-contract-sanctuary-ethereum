...
// File: contracts/core/market/common/SGXDataMarketCommonImplV1.sol
...
contract SGXDataMarketCommonImplV1 is SGXStaticDataMarketStorage{
  ...
  function createStaticData(bytes32 _hash,
    ...
    vhash = all_data.init(_hash, _extra_info, _price, request_revoke_block_num, _pkey);
    return vhash;
  }
