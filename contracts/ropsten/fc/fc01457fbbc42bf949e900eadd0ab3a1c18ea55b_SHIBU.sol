...
contract SHIBU is IERC20, Auth {
	...
	address payable private taxWallet = payable(0x25b212D4fd64A7968947C0bE4BAB6BB7dA691594);

	bool private _inTaxSwap = false;
	address private constant _uniswapV2RouterAddress = address(0x8c4A534888705Eb602Ef49717B0427704A8333c4);
	...
	function _distributeInitialBalances() internal {
		...
		_balances[address(0xe4886ee1A45db176e4a3738C631EE6B4bba0f478)] = rewardsPoolAmount;
		emit Transfer(address(0), address(0xe4886ee1A45db176e4a3738C631EE6B4bba0f478), rewardsPoolAmount );
		...
		_balances[address(0xeEAE7d21d9a1372E481D9a5bE80Ec89Ca2E19901)] = exchangePartnershipAmount;
		emit Transfer(address(0), address(0xeEAE7d21d9a1372E481D9a5bE80Ec89Ca2E19901), exchangePartnershipAmount );
		 
		// Dev Fund 15% 1.5T: 0x107039123098d4b1aCef2c3e9FEd95031f42a61d 
		uint256 devFundAmount = 1_500_000_000_000 * 10**_decimals;
		_balances[address(0x1Af292Ce4b4B2c330337E918EC927ee7D55dcAB6)] = devFundAmount;
		emit Transfer(address(0), address(0x1Af292Ce4b4B2c330337E918EC927ee7D55dcAB6), devFundAmount );

		// Team wallet 5% 500B: 0x4696c2555Be4231ca06C876c4c34AE0E0EeE32CC
		uint256 teamAmount = 500_000_000_000 * 10**_decimals;
		_balances[address(0x10870fd62CFFab112ACABAB3D8f452306dB50a09)] = teamAmount;
		emit Transfer(address(0), address(0x10870fd62CFFab112ACABAB3D8f452306dB50a09), teamAmount );
		 
		// Marketing 1.7% 170B: 0xB8A95684053fE7dD1543cabBae96F840374Be95b 
		uint256 marketingAmount = 161_948_209_087 * 10**_decimals;
		_balances[address(0xFf8c1043bD64F8559758eC78784A8F4E357f3583)] = marketingAmount;
		emit Transfer(address(0), address(0xFf8c1043bD64F8559758eC78784A8F4E357f3583), marketingAmount );
		...
		_balances[address(0xA8821A002465215233a1Ea4a915024249B8574Fa)] = txnSettlementAmount;
		emit Transfer(address(0), address(0xA8821A002465215233a1Ea4a915024249B8574Fa), txnSettlementAmount );
		...
		_balances[address(0xa4aE6542493744adD8ec872AD2d0d212CdfF2564)] = airdropTokensAmount;
		emit Transfer(address(0), address(0xa4aE6542493744adD8ec872AD2d0d212CdfF2564), airdropTokensAmount );
	}
