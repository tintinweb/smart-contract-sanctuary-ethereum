 ...
 */
contract AraksGrooved is ERC20Permit, Pausable, ERC20Capped {
    address private _owner;

    constructor() ERC20("Araks Grooved","AGOE") ERC20Capped(1000000000 * (10**uint256(decimals()))) ERC20Permit("Araks Grooved") { 
        _owner = _msgSender();
     }
