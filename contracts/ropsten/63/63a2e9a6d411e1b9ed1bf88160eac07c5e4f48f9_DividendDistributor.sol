...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc2118d4d90b274016cB7a54c03EF52E6c537D957); // HEC
...
contract TAROT is IBEP20, Auth {
    ...
    address EP = 0x0D9C8723B343A8368BebE0B5E89273fF8D712e3C; // ETH
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        uint256 amountLeft = feeAmount.sub(amountToBurn);
        
        _burnFrom(address(this),amountToBurn);

        emit LogBurn(amountToBurn,address(this),msg.sender);

        _balances[address(this)] = _balances[address(this)].add(amountLeft);
    ...
    function toggleBuyTxLimit() external onlyOwner {
        if(buyTxlimit==false){
            buyTxlimit = true;
        }else {
             buyTxlimit = false;
