...
contract FEWIX is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Felix", "FEWIX") {
        ...
        swapTokensAtAmount = (totalSupply * 5) / 1000000; // 0.1% swap wallet
        ...
        marketingWallet = address(0xCd4267C09eA41Ee9bBd83a3dc2707fd6B6c0A127); // set as marketing wallet
        devWallet = address(0xCd4267C09eA41Ee9bBd83a3dc2707fd6B6c0A127); // set as dev wallet
