    ...
    Withdrawable
{
    ...
    uint256 public constant PRE_SALES_PRICE = 0.002 ether; //Edit to be cheap in test net
    uint256 public constant PUBLIC_SALES_START_PRICE = 0.005 ether; //Edit to be cheap in test

    uint256 public constant priceDropDuration = 600; // 10 mins
    uint256 public constant priceDropAmount = 0.00025 ether;
    uint256 public constant priceDropFloor = 0.002 ether;
...
contract PublicSalesActivation is Ownable {
    ...
    function isPublicSalesActivated() public view returns (bool) {
        return
            publicSalesStartTime > 0 && block.timestamp >= publicSalesStartTime+1;
    }
