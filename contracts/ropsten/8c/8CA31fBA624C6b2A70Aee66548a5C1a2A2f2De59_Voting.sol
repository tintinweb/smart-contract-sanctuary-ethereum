...
contract Voting {
	...
	mapping(uint256 => CommunityPoll) private _commpolls;
	...
	*/
	 ...
	 */
	function isAlreadyVoted(uint256 pollId) internal returns(bool){
	...
	*/
	function pollFetch(uint256 commId, uint256 id) internal returns ( CommunityPoll storage ){
		...
		CommunityPoll storage pollArr  = _commpolls[id];
