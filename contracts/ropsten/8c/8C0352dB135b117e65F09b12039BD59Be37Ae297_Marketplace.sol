...
contract Marketplace is IERC721Receiver {
    ...
    mapping(uint256 => mapping(address => Auction)) private nftAuctionData;
    ...
    mapping(uint256 => mapping(address => Sale)) private nftSaleData;
    ...
    */
    ...
    function getnftAuctionData(uint256 _nftId,address _nftCollection) public  view returns(Auction memory){
        return nftAuctionData[_nftId][_nftCollection];
    }


    /**
     * Return the Sale Data
     * for a specific NFT Sale
    */

    function getnftSaleData(uint256 _nftId,address _nftCollection) public  view returns(Sale memory){
        return nftSaleData[_nftId][_nftCollection];
    }
