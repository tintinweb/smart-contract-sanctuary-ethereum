...
interface OraclizeResolverI {
    ...
    function eventSetWinner(uint _gameId, address _eventAddress) external;
}
...
contract Bet0xgameMaster {
        ...
        endsAtAfterBetsCloseAt(_betsCloseAt, _endsAt)
    {
        ...
        _game.eventAddress = _eventAddress;
    ...
    {
        if (game[_gameId].eventAddress == 0x0) {
            ...
            OraclizeResolverI(resolverAddress).eventSetWinner(_gameId, game[_gameId].eventAddress);
        }
    }
