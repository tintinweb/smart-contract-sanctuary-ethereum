...
// File @imtbl/imx-contracts/contracts/[email protected]
...
// File @imtbl/imx-contracts/contracts/utils/[email protected]
...
contract BurningHeroeZ is IMintable, ERC721, Ownable {
    ...
    constructor(address _imx) ERC721('BurningHeroeZ', 'BHN') {
        imx = _imx;
    }
