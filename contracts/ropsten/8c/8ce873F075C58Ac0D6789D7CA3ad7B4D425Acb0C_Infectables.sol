...
contract Infectables is ERC721A {
    ...
    function getPrice(bool isWL, uint256 amount) public view returns (uint256) {
        if (isWL && NbMinted[msg.sender] == 0 && totalSupply() <= FREE_SUPPLY) {
        ...
        payable
    {
        ...
        require(msg.value >= getPrice(isWL, amount), "Not enought ETH sent");
