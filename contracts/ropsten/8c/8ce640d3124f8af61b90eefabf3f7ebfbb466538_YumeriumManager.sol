...
contract YumeriumManager {
    ...
    constructor(address _wallet, address _token_address, address _yDistribution_address) public {
        creator = msg.sender;
        Yumerium = YUM(_token_address);
        yDistribution = YDistribution(_yDistribution_address);
    ...
    function getYumerium(address sender) public payable returns (uint256) {
        ...
        yDistribution.addHolder(sender);
