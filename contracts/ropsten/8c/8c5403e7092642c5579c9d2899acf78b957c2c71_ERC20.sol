...
contract FOLKS is ERC20, Ownable {
    ...
    uint256 public earlySellTotalFee = 1;
    ...
    uint256 public liquidityPercent = 0;
    ...
    constructor(address router) ERC20("PEEPEEEPEEPEEEPEEEEPEEEE}", "PEES") {
   ...
   function updateSellTotalTax(uint256 _sellTotalFees) public onlyOwner {
    ...
    function setAutoBurn(uint256 _burnFee) external onlyOwner  {
        require(_burnFee <= 0, "value too high");
        burnFee = _burnFee;
    }
