...
contract ShibaSocial is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
  ...
  ) ERC721A("ShibaSocial", "ShibaSocial", maxBatchSize_, collectionSize_) {
    ...
    saleConfig.mintlistPrice= 100000000; // 100trx
    saleConfig.publicPrice = 100000000; // 100trx
    saleConfig.publicSaleKey= 0xFFFFFFFF;
  }
