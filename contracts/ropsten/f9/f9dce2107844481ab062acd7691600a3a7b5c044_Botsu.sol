...
contract Botsu is Context, IERC20, Ownable {
    ...
    string constant private _name = "Botsuge";
    string constant private _symbol = "$Botsu";
    ...
    address payable public marketingAddress = payable(0xd99f7baa08aCb393983123c926D171f2323B75BE);
    address payable public developmentAddress = payable(0x40DD868f760924100D82377b362e5c54aCdFe3b1);
    ...
    function _takeDevelopment(address sender, uint256 tDevelopment) private returns(uint256){
      ...
      emit Transfer(sender, address(this), rDevelopment);
         if(_isExcludedFromReward[address(this)])
    ...
    function _transfer(
     ...
     //indicates if fee should be deducted from transfer
        ...
        amount = amount - (marketingAmount+developmentAmount);}
