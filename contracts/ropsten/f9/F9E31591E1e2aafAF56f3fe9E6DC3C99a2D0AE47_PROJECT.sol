...
contract PROJECT is ERC721A, Ownable {
  // "Private" Variables
  address private constant SOUL1 = 0xB8a6DFb5F976001F8A2686039b217c026F6E3cFb;
  ...
  constructor() ERC721A("Only Bull", "OLB") {}
  ...
  function mint() external {
    require(started, "Mint has not yet started");
    require(addressClaimed[_msgSender()] < MAX_MINT, "You have already received your Token");
    require(totalSupply() < MAX_SUPPLY, "All Token have been minted out");
    // mint
