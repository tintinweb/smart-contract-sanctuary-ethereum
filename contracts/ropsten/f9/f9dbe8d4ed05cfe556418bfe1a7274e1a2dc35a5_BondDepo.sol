...
contract BondDepo is Ownable {
    ...
    uint public tokenVested; // track the rewardtoken vesting 
    uint public paidOut; // amount of rewardtoken claimed
     ...
     *  @return uint
     */
    function setMaxPayout(uint _maxpayout) external onlyOwner() returns (uint) {
        maxpayout = _maxpayout;
        return maxpayout;
    }
     ...
     *  @return bool
     */
    function recoverLostToken( address _token, uint256 _amount ) onlyOwner() external returns ( bool ) {
