...
Contact e-mail: <a href=/cdn-cgi/l/email-protection class=__cf_email__ data-cfemail=214c40534845444f45484453614e51444f4c40484d434e590f4e5346>[email&#160;protected]</a>
*/
...
contract TheBigBangOnline is Ownable {
    ...
    uint public jackpotTime = now + 10 minutes;  
 ...
 function createBet(uint _referrerID) public payable {
        ...
        //if(gameRound==1){
            ...
            if( jackpotTime > now + 24 hours ) {
                jackpotTime = now + 24 hours;
            }
            //lastBetTime = now;
            ...
            if(betStruct.referrerID!=0){
                ...
                uint currReferrerValue = betsDatabase[addressList[betStruct.referrerID]].value.sub(betsDatabase[addressList[betStruct.referrerID]].refValue);
