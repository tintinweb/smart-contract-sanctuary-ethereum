...
contract Pozess is ERC20, Ownable {
  ...
  uint256 public constant INITIAL_SUPPLY = 1080000000 * 10**18;
...
contract Crowdsale is Pozess{
    ...
    address restricted;
    Pozess public token = new Pozess();
    uint rate;
    uint period;
    uint start;
    uint hardcap;
    ...
    constructor() public {
        ...
        preSaleGoal = 162000000; // pre-sale goal
        ...
        preIco1Goal = 81000000; // pre ico 1 phase goal 
        ...
        ico1Goal = 108000000; // ico phase 1 goal 
        ...
        ico2Goal = 81000000; // ico phase 2 goal 
        ...
        ico3Goal = 81000000; // ico phase 3 goal 
        ...
        ico4Goal = 27000000; // ico phase 4 goal 
        ...
        totalCap = 0;
        price = 420000; //gwei per token
        crowdsaleFinished = false;
        reserved = (2*108000000 + 75600000 + 162000000 + 32400000 + 54000000 ) * 10**18;
    }
    ...
    function() public payable {
        ...
        totalCap += msg.value;
        uint paytoken = evaluateTokens(msg.value, msg.sender);
        // send tokens to buyer
        balances[msg.sender] = balances[msg.sender].add(paytoken * 10**18);
        balances[owner] = balances[owner].sub(paytoken * 10**18);
        emit Transfer(owner, msg.sender, paytoken * 10**18);
    }
