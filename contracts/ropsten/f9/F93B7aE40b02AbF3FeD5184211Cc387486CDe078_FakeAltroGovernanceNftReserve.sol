...
contract FakeAltroGovernanceNftReserve is Context, ERC721Holder, Ownable {
	event NftReceived(address indexed collectionAddress, address indexed from, address operator, uint256 tokenId);

	function approveToken(address nftContract, address to, uint256 tokenId) external onlyOwner {
