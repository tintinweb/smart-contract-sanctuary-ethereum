...
contract LunaDaoToken is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("LunaDao", "LunaDao", 18) {
        USDTAddr = address(0xe5213623818B6DC70144F37aE585ca465e290cA8);
        ...
        marketingAddress = address(0xE355fac4Ab9532cE4DEdd9BbA39B8F1170282395);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            /*
                3%进一个LP分红，2%进入黑洞地址，1%进入营销地址。当总量只剩下100万时候，2%进入到ow账户
            */
