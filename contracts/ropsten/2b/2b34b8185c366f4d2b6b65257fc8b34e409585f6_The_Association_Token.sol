    ...
    recovery
{
    ...
    constructor(
        ...
        ERC721("The Association NFT", "ASSOC")
        token_configuration("https://ether-cards.mypinata.cloud/ipfs/QmXKpNG6YrYAbQu9EtLBmxNbup2rQcQBWZC1G1BiVSwLv4", 18000, true)
    {
        projectID = 4;
        projectFactory = 0xe14B40e4D41F3f22A93298EdA99Ea3A50506EB1B;
        reserved = 100; //1480
        constantReserved = 100;
    }
    ...
    modifier onlybegin(){
        require(
            begin==true,"Not begin"
        );
        _;
    }
    
    function setbegin() public onlyAllowed{
        begin=true;
    }
