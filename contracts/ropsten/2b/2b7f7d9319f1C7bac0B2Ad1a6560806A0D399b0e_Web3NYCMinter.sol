...
contract Web3NYCMinter is AccessControl{
    ...
    function mint(uint256 tokenId, bytes calldata _signature) payable external {
        ...
        require(_verify(_signature, tokenId, msg.value), "bad signature");
    ...
    function multiMint(uint256[] memory tokenIds, uint256[] memory values, bytes[] calldata _signatures) payable external {
