...
contract BarryNFT is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
  constructor() ERC721("BarryNFT", "BFT") {}
  ...
  public onlyOwner whenNotPaused returns (bool)
  {
    ...
    require(_tokenIds.length == _uris.length, "values length error");
