...
contract Asset is ERC721, Ownable, Mintable {
  ...
  uint256 public publicSaleCost = 0.11 ether;
  ...
  bytes32 private merkleRoot = "";
    ...
    constructor(
        ...
        setMetadata("https://ipfs.io/ipfs/QmZR2bSu8mQekaBnzB8VwTpbSz8ZGPJiJjKpSjDVC7jM7E/hidden.json","","");
    }
  ...
  function cost() public view returns (uint256) {
      if(saleActive)  return publicSaleCost;
      return presaleCost;
  }
  ...
  function whitelistMint(uint _mintAmount, bytes32 leaf, bytes32[] memory proof, uint256[] memory ids) external payable mintCompliance(_mintAmount) {
  ...
  function setStatusAndCosts(bool _isRevealed, uint256 _presaleCost, uint256 _publicCost, bool _saleStatus, bool _preSaleStatus) public onlyOwner {
   ...
   function setLimits(uint256 _maxMintAmountPerTx, uint256 _maxWalletLimit) public onlyOwner {
    maxMintAmountPerTx = _maxMintAmountPerTx;
    maxWalletLimit = _maxWalletLimit;
  }

  function setMetadata(string memory _hiddenMetadataUri, string memory _uriPrefix, string memory _uriSuffix) public onlyOwner {
