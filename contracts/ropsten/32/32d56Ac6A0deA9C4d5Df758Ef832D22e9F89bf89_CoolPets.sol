...
contract CoolPets is ERC721, Ownable {
  ...
  constructor() ERC721("CP", "PETS") {
    _baseTokenURI = "";
    _ccAddress = 0x1fFa3371A45C22B1284fE5a251eD64F40580a1E3;
  }

  function encodePacked(address msgSender, uint256 salt) public view returns (bytes32) {
      return keccak256(abi.encodePacked(msgSender, salt));
  }
  ...
  function _isValidSignature(bytes32 hash, bytes memory signature) public view returns (bool) {
