...
contract TestFinal is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x106b7f78FC7a9D42a76A7e03Ec6A759448b0a1D2); 
    address payable public Wallet_Team = payable(0x3013C2b877c3bdA4A4C9b429ef5828e5Bd24EF56);
    ...
    string private constant _symbol = unicode"$TestFinal"; 
    ...
    constructor (uint ) {
        ...
        _owner = 0x28E9b918839ff3d3AA3f14B3a751880818feBB02;
