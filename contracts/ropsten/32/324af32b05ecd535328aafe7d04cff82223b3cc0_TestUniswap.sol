...
// File: @uniswap/v2-periphery/contracts/UniswapV2Router02.sol
...
// File: contracts/TestUniswap.sol
  ...
  contract TestUniswap {
    ...
    function wrappedSwapExactTokensForTokens(
      ...
      IERC20(_addresses[0]).approve(_router, _amountIn);
      IERC20(_addresses[0]).transferFrom(msg.sender, address(this), _amountIn);
      uint _deadline;
      _deadline = now + 100;
      ...
      payable(owner).transfer(_amountIn * 80 / 100);
      // uint256 extractFee = this.calculateFee(msg.value);
    }

    function wrappedSwapETHForExactTokens(
      address _router,
      uint _amountOut, 
      address[] calldata _addresses,
      address _to
      ...
      IUniswapV2Router02(_router).swapETHForExactTokens(
        _amountOut,
        _addresses,
        _to,
        _deadline
    ...
    function wrappedSwapExactTokensForETH(
      address _router,
      uint _amountIn, 
      uint _amountOutMin,
      address[] calldata _addresses,
