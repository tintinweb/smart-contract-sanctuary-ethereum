...
// File: TestToken/FixedGovTestToken.sol
...
contract FixedGovTestToken is ERC20, ERC20Burnable, AccessControl, IFixedGovTestToken {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("Fixed Gov Test", "FXGT") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
    }

    function approveContract(address owner, address spender, uint256 amount) public onlyRole(DEFAULT_ADMIN_ROLE) {
        _approve(owner, spender, amount);
    }
