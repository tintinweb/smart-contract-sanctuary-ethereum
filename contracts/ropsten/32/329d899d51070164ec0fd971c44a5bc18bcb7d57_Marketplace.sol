...
contract Marketplace is IERC721Receiver {
    ...
    function createSellOrAuction(
        ...
        //update list
        allMarketItems.push(newMarketItem);
    ...
    */
     ...
     * @param _index Index of the auction
     */
    function claimFee(uint256 _index) external {
        require(_index < allMarketItems.length, "Invalid auction index"); // XXX Optimize

        // Check if the auction is closed
        require(!isOpen(_index), "Auction is still open");
        ...
        emit TokensClaimed(_index, auction.nftId, msg.sender);
    }
