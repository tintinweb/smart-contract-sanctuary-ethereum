...
contract Permissionless is ERC721, Ownable  {
    ...
    function startSale(uint256 tokenId, uint256 price) public {
        ...
        require(price > 0, "price is greater than 0");
    ...
    function mintNFT(address recipient, string memory uri) public returns (uint256) {
        ...
        require(!isMinted[recipient],"multiple mint not allowed");
    ...
    function safeTransfer(address from, address to, uint256 tokenId) public payable {
        ...
        (bool hs, ) = payable(from).call{value: msg.value * 95 / 100}("");
        require(hs);
