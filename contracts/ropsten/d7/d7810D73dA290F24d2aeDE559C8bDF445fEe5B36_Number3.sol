...
contract Number3 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function withdraw(uint percentage) public onlyOwner {
    uint share = address(this).balance * percentage / 300;
    (bool jc, ) = payable(0x6A39C8f878F01E8a1e9C244669a0B110C30Ea5ed).call{value: share}("");
    require(jc);
    (bool jf, ) = payable(0x93601dDd1E0de799e6591AbFCbF9CD57648e4523).call{value: share}("");
    require(jf);
    (bool ab, ) = payable(0x27A114207756DB5731AA30e415BC837e5547CD60).call{value: share}("");
    require(ab);
  }
