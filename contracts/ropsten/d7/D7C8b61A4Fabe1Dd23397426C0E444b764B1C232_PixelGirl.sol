...
contract PixelGirl is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("PixelGirl", "PixelGirl") {}
    ...
    function getPublicSalePrice(uint256 offset) public view returns(uint256){
        if (7777 < 2222 + amountForPublicSale - offset){
            return 0.002000 ether;
        }
        return 0.001000 ether;
    }
    ...
    uint256 public amountForPublicSale = 7777;
    // per mint public sale limitation
    uint256 public immutable publicSalePerMint = 500;
