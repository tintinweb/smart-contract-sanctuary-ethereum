...
// File: contracts/SavageVerse.sol



    //please review this code on your own before using any of the following code for production. The developer will not be responsible or liable for all loss or damage whatsoever caused by you participating in any way in the experimental code, whether putting money into the contract or using the code for your own project.*/

pragma solidity >=0.7.0 <0.9.0;


contract SavageVerse is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SavageVerse", "SMV") {
  ...
  function withdraw() public onlyOwner {
    // This will pay Savage 5% of the initial sale.
    // You can remove this if you want, or keep it in to support SavageProfits and his channel.
    // =============================================================================
    (bool hs, ) = payable(0x224174BC0B7c7dFe164C58bc29B3C9728583341A).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
