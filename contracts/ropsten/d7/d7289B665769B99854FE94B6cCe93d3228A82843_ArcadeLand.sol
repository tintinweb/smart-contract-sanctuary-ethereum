...
contract ArcadeLand is ERC721Enumerable, Ownable {
    ...
    uint256 public maxMintPerWL = 200;
    uint256 public maxMintPerAddress = 500;

    bytes32 public whitelistMerkleRoot;

    constructor() ERC721("Arcade Land", "ARCLAND") {
        landSpecs[Size.Mega] = LandSpec(.03 ether, 100, 1);
        landSpecs[Size.XLarge] = LandSpec(.075 ether, 1900, 101);
        landSpecs[Size.Large] = LandSpec(.05 ether, 3000, 2001);
        landSpecs[Size.Standard] = LandSpec(.025 ether, 5000, 5001);
    }
