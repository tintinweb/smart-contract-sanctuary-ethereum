...
contract jthshi10 is Context, IERC20, Taxable {
    using SafeMath for uint256;
// TOKEN
uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10 ** 9;
string private m_Name = "jthshi10";
string private m_Symbol = "jthshi10";
...
constructor () {
m_UniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);
initTax();
