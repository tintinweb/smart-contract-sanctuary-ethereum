 ...
 */
contract Frethan is ERC20Detailed, ERC20 {
    using SafeMath for uint256;
    ...
    uint256 public constant maxtokens = 10000000000;                              // 10 Billion
    uint256 public constant INITIAL_SUPPLY = maxtokens * (10 ** uint256(18));
