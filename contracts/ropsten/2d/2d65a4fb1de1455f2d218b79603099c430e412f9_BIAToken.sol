...
contract BIAToken is ERC223Token {
  using SafeMath for uint256;

  // name
  string public name = "Blockchain I A";
  // ticker
  string public symbol = "BIA";
  // set token's precision
  //
  // for example, 4 decimal points means that
  // smallest token using will be 0.0001 BIA
  ...
  // given 4 decimals, this setting means "1 ETC = 4000 BIA"
