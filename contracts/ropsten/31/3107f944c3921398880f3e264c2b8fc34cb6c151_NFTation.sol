...
contract NFTation is Initializable,
    ...
    function testUpgradability1(uint256 testParam) public returns (uint256) {
        return testUint256;
    }
}
...
contract NFTation_StorageV2 {
    mapping(uint256 => uint256) internal storageTestMapping;
    uint256 internal testUint256;
