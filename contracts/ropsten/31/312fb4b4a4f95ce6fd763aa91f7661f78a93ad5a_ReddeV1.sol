...
contract ReddeV1 is BasicToken {
  ...
  function book(address _to, uint256 _value) public returns (bool) {
    ...
    if(balancesBooking[_to]==0){
        ...
        //balancesBookingArray.push(Booking(_to,true));
    }
  ...
  function bookingBalanceOf(address _owner) public view returns (uint256) {
    return balancesBooking[_owner];
  }
