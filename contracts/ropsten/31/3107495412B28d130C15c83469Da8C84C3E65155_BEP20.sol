 ...
 */
contract BEP20 is Context, IERC20, Ownable, AntiWhale {
     ...
     * construction.
     */
    constructor(string memory tokenName, string memory tokenSymbol, uint8 decimals, uint256 initSupply) {
        _name = tokenName;
        _symbol = tokenSymbol;
        _decimals = decimals;
       ...
       // _totalSupply = maxCap;
        ...
        _balances[msg.sender] = _totalSupply; //At the moment of creation all tokens will go to the owner.
