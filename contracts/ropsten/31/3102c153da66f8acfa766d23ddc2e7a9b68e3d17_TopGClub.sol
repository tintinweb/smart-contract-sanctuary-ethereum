...
contract TopGClub is Ownable, ERC721B {

    using Strings for uint256;

    uint256 public constant MAX = 333;
    ...
    constructor() ERC721B("TopGClub", "TOPG") { }
    ...
    function buy(uint256 tokenQuantity) external payable {
        ...
        require(supply + tokenQuantity <= MAX, "EXCEED_MAX_SALE_SUPPLY");
