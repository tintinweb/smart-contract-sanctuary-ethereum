...
contract Land is ERC721, ReentrancyGuard, Ownable, Pausable {
    ...
    string public baseTokenURI =
        "ipfs://Qmdgk11XLi5UfWmrK45HRAwwP6duizpjfmmwmVQP3VTsNw/";
    ...
    modifier notCap() {
        require(totalSupply < MAX_SUPPLY, "Max Reached");
        _;
    }
    ...
    function mint(uint256 _tokenId, bytes32[] memory _merkleProof)
        public
        payable
        whenNotPaused
        ...
        isValidAmount
    {
        ...
        // NOTE: Add 1 on tokenId once array of coordinates is provided
