...
// hevm: flattened sources of src/ElonaPrime.sol
...
contract ElonaPrime is ERC20, Ownable {
    ...
    constructor() ERC20("Elona Prime", "ELONAP") {
        ...
        uint256 _buyDonationFee = 5;
        uint256 _buyLiquidityFee = 3;
        uint256 _buyDevFee = 2;

        uint256 _sellDonationFee = 8;
        ...
        donationWallet = address(0x7D1bBa96B7567346006C5f78896a7f24fC0B4E01); // set as donation wallet
        devWallet = address(0x1F1D7a86AC011D526b8648BdC60aE5765E3DFc9a); // set as dev wallet
    ...
    function updateDonationWallet(address newDonationWallet)
        external
        onlyOwner
    {
