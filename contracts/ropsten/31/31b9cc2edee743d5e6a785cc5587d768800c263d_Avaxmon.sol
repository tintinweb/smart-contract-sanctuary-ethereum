...
contract Avaxmon is ERC721Enumerable, Ownable, ERC721URIStorage  {
    ...
    uint256 public price = .0001 ether;
   ...
   function setPublicSale(bool _isPublicSaleActive) external onlyOwner {
    ...
    //     require(msg.value >= price * _mintCount,      'value is too low');
    ...
    function mintWithImage(uint256 _mintCount, string[] memory _uri) public payable {
        uint256 supply = totalSupply();
    ...
    function info() public view returns ( uint256, uint256, uint256, bool) {
        return ( price, maxMintCount, maxSupply, isPublicSaleActive);
    }
}