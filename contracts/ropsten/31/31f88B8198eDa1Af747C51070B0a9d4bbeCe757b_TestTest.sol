...
contract TestTest is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xD8fbBb895eb82384eBCFC0cf35b76c91A7967c98); // Marketing Address
    address payable public rewardAddress = payable(0xD8fbBb895eb82384eBCFC0cf35b76c91A7967c98); // Reward Address
    address payable public liquidityAddress = payable(0xD8fbBb895eb82384eBCFC0cf35b76c91A7967c98); // Liquidity Address
    ...
    uint256 private constant _tTotal = 5 * 1e8 * 1e18;
    ...
    uint256 private constant SELL = 3;
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 500 / 10000; // 5% max txn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05%
        maxWallet = _tTotal * 250 / 10000; // 1%
