...
contract KASUKU is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xA5Ab46CCf381E783204E3ba956AdF104616DB259));
    address payable public _teamwallet =
        payable(address(0x39004F688938E27AfF63E4Ed45c074a03Bdb393e));
    address _partnershipswallet =
        payable(address(0xA203b51a5f13d968367e0F139dd161baB31a5211));
    ...
    uint256 private numTokensSellToAddToLiquidity = 750000000000 * 10**9;
