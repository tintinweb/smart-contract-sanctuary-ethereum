...
contract Ownable is Context {
     ...
     */
    constructor() public{
        //need o set contract Owner here
        _owner =0x25a214FB042d65F56ac58ba4C103FFD9368Fa810;
...
contract RadioGugu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Radio Gugu";
    string private _symbol = "GUGU";
    ...
    //origianl circullation
    //uint256 internal _tokenTotal = 1_000_000_000_000_000e18;
    //Saeed: changing fo rsimplicity sake to million token with 9 decimals
    uint256 private _tokenTotal = 1000000000 * 10**9;
    ...
    uint256 public _charityFee = 100; // means 1% 
    uint256 public _devFee = 100; // means 1% 
    ...
    uint256 public _SellcharityFee = 100; // means 1%
    uint256 public _SelldevFee = 100; // means 1% 
    
    
    address private marketingAddress=0x0290Dd49b2cDc188c8A11c144e863a1C6bb8c58e;
    address private devWallet =0x161661c995bc011c424834652f24aA4d8fd6dD6C;
    address private charityWallet = 0x0Cf966515058Bb4bC81B82E85b1c78dC33f7Ce7e;
    ...
    //address public _UniSwapRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
