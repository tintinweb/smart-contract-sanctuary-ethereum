...
contract BaseToken8 is ERC20Snapshot, Ownable {
    ...
    // Name of the token
    string public constant TOKEN_NAME = "BaseToken07";
    // Symbol of the token
    string public constant TOKEN_SYMBOL = "BT07";
    ...
    // Map of payments made by snapshot index
    mapping(uint256 => uint256) private paymentsMap;
    ...
    function payDividends(uint256 _ammount) public onlyOwner {
        ...
        paymentsMap[nCurrentSnapshotId] = _ammount;
        // save the date
    ...
    /**
     * @dev Returns the ammount of the payment based on the index
     */
    function getPaymentValue(uint256 paymentIndex)
        public
        view
        returns (uint256)
    {
        return paymentsMap[paymentIndex];
    }
