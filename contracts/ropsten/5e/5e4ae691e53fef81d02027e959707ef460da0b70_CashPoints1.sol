...
contract CashPoints1 is StandardToken { // ПОДЛЕЖИТ ИЗМЕНЕНИЮ. Обновить название контракта.
    ...
    */
    ...
    function CashPoints1() {
        ...
        totalSupply = 100000000;                        // Обновить общий выпуск (100000000 для примера) (ПОДЛЕЖИТ ИЗМЕНЕНИЮ)
        name = "Cash Points1";                                   // Установить название токена для отображения на дисплее (ПОДЛЕЖИТ ИЗМЕНЕНИЮ)
        decimals = 18;                                               // Количество десятичных знаков после запятой для отображения на дисплее (ПОДЛЕЖИТ ИЗМЕНЕНИЮ)
        symbol = "CPS1";                                             // Идентификатор токена для отображения на дисплее (ПОДЛЕЖИТ ИЗМЕНЕНИЮ)
