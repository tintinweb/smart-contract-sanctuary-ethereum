  ...
  UUPSUpgradeable
{
  ...
  function initialize() initializer public {
    ...
    __ERC1155Store_init("PsuB ERC1155 Store", "PsuB1155", 0xFc91bd78227E756c9BfB6586F2A58F2011CC6f83);
  ...
  // * 추가 민팅
  function additionalMint(address account, uint256 id, uint256 amount, bytes memory data)
    external
  ...
  function burn(
    ...
    uint256 id,
    uint256 amount
  ) override virtual public onlyRole(MINTER_ROLE) onlyCreator(id) onlyExists(id) whenNotPaused {
    require(
