...
contract TEST is IBEP20, Ownable {
    ...
    address private marketingWallet = 0xC34Fb5411735977653FBEEF409E878CF5b0d19b9;
    ...
    constructor () Ownable(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(0xc778417E063141139Fce010982780140Aa0cD5Ab, address(this));
