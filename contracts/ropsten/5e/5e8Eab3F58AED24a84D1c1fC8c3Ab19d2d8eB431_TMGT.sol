...
contract TMGT is ERC20Votes, ERC20Burnable, ERC20Blacklisted, ApprovalCaller {
  ...
  modifier onlyBridge() {
    require(msg.sender == bridge, "TMGT: CALLER_NO_BRIDGE");
    _;
  }

  constructor(address _bridge) ERC20Permit("Test MetalCore Token") ERC20Blacklisted("Test MetalCore Token", "TMGT") {
    require(_bridge != address(0), "TMGT: BRIDGE_ADDRESS_INVALID");
    bridge = _bridge;
  }
  ...
  function mint(
    ...
    require(msg.sender == owner() || msg.sender == bridge, "TMGT: CALLER_NO_OWNER_BRIDGE");
    require(_amount != 0, "TMGT: ZERO_AMOUNT");
