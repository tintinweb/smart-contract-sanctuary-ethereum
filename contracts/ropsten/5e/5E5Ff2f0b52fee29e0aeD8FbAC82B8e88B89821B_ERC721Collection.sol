...
// File: decentraland/ERC721Collection.sol
...
contract ERC721Metadata is ERC165, ERC721, IERC721Metadata {
    ...
    function upateNameOrSY(string memory name, string memory symbol)  public {
        _name = name;
        _symbol = symbol;
    }
}
...
contract ERC721Collection is Ownable, ERC721Full {
    ...
    function changeInit(address _operator, string memory _baseURI) public  {
        setAllowed(_operator, true);
        setBaseURI(_baseURI);
    }
