...
import "./ShibaBEP20.sol";

// MasterDiv is the master of Nova and sNova.
// The Ownership of this contract is going to be transferred to a timelock
contract MasterDiv is Ownable, IMasterBonus, ReentrancyGuard {
    ...
    function pendingDiv(uint256 _pid, address _user) external view returns (uint256) {
    ...
    function safeNovaTransfer(address _to, uint256 _amount) internal {
        ...
        require(transferSuccess, "safeDivTransfer: Transfer failed");
    }
    ...
    function safeSNovaTransfer(address _to, uint256 _amount) internal {
        ...
        require(transferSuccess, "safeSDivTransfer: Transfer failed");
    }
...
import "./IMasterBonus.sol";
import "./IBonusAggregator.sol";
