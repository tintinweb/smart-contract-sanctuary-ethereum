...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory DDumpster, string memory DDUMP) {
        _name = DDumpster;
        _symbol = DDUMP;
    }
...
contract DDump$ter is ERC20, Ownable {
    ...
    constructor () ERC20("","") payable {
        ...
        buyCommunityFee = _buyCommunityFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyBuyBackFee = _buyBuyBackFee;
        buyDevFee = _buyDevFee;
        buyTotalFees = buyCommunityFee + buyLiquidityFee + buyBuyBackFee + buyDevFee;
        
        sellCommunityFee = _sellCommunityFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellBuyBackFee = _sellBuyBackFee;
        sellDevFee = _sellDevFee;
        sellTotalFees = sellCommunityFee + sellLiquidityFee + sellBuyBackFee + sellDevFee;
        
    	CommunityWallet = address(0xd4d3f63A65678747e2A845c78968b02beDa918b5); // set as Community wallet
        ...
        excludeFromFees(0x1b786B7bC32E8adD5e2BdDb13D4d01519F008AF0, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(CommunityWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x1b786B7bC32E8adD5e2BdDb13D4d01519F008AF0, true);
        ...
        */
        ...
        _createInitialSupply(0x1b786B7bC32E8adD5e2BdDb13D4d01519F008AF0, totalSupply*100/100);
        _createInitialSupply(address(this), totalSupply*0/100);
    }
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 1000)/1e9, "Cannot set maxTxnAmount lower than 0.5%");
        maxTxnAmount = newNum * (10**9);
    }
    ...
    function updateBuyFees(uint256 _CommunityFee, uint256 _liquidityFee, uint256 _buyBackFee, uint256 _devFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _CommunityFee, uint256 _liquidityFee, uint256 _buyBackFee, uint256 _devFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(takeFee){
            // bot/sniper penalty.  Tokens get transferred to Community wallet to allow potential refund.
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForCommunity + tokensForBuyBack + tokensForDev;
        bool success;
        ...
        uint256 ethForLiquidity = ethBalance - ethForCommunity - ethForBuyBack - ethForDev;
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x1b786B7bC32E8adD5e2BdDb13D4d01519F008AF0,
            block.timestamp
        );
    }
