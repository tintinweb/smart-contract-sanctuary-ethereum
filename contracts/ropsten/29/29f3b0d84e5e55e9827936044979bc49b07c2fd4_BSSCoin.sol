...
contract BSSCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BSSCoin() {
        ...
        name = "BSSCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BSS";                                             // Set the symbol for display purposes (CHANGE THIS)
