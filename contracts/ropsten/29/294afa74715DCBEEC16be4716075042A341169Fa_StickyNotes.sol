...
contract StickyNotes is ERC721, ERC721Enumerable, Ownable {
    ...
    returns (string memory)
  {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"description":"Send on-chain notes to any ETH wallet. StickyNotes.wtf","external_url":"https://stickynotes.wtf/","name":"StickyNote #',
        tokenId.toString(),
