...
contract Governance is Context {
    ...
    function executeProposal(uint256 proposalId) external onlyDAOTokenHolder {
        ...
        require(!_executes[proposalId].executed, "Execute: proposal has already been executed");
        ...
        _executes[proposalId].result = result;
        _executes[proposalId].executed = true;
    ...
    function executedOf(uint256 proposalId) external view returns (bool) {
        return _executes[proposalId].executed;
    }
}
