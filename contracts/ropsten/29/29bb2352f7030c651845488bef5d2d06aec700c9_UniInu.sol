...
Telegram https://t.me/BLACKandWHITEeth

Website www.blackandwhite-eth.com
...
contract UniInu is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "UniInu";
    string private constant tokenSymbol = "Uni";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xF32FD8337C58A8A204675dc2D392Cd915e4E30Ab);
        devAddress = payable(0xF32FD8337C58A8A204675dc2D392Cd915e4E30Ab);
