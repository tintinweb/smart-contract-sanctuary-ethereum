...
contract NekoCat1 is ERC721A , Ownable { 
    ...
    address payable private _PaymentAddress = payable(0x9879Ae00a47b91de0bE24ADCDB86371937D0101B);

    uint256 public NEKO_MAX = 1000;
    ...
    uint256 private _activeDateTime = 1651853530; // (GMT): Sunday, January 30, 2022 8:00:00 PM
