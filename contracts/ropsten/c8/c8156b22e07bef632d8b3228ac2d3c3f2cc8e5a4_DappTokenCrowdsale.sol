...
contract DappToken is MintableToken, DetailedERC20 {
...
//     function finish(address _teamFund) public onlyOwner {
//         require(!isFinalized);
//         uint256 alreadyMinted = token.totalSupply();
//         require(alreadyMinted < cap);

//         uint256 unsoldTokens = cap - alreadyMinted;
//         if (unsoldTokens > 0) {
//             tokensForEcosystem = tokensForEcosystem + unsoldTokens;
//         }

//         token.mint(_teamFund, tokensForEcosystem);
//         finalize();
//     }
