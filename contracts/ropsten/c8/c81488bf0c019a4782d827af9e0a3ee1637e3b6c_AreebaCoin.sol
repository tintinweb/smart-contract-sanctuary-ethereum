...
contract AreebaCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AreebaCoin() {
        ...
        name = "AreebaCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-009";                                             // Set the symbol for display purposes (CHANGE THIS)
