...
contract HappyMonkey is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    constructor() ERC721("HappyMonkey", "HMT") {}
    ...
    function safeMint(address to) public payable {
        // check that totalSupply is less then MAX_SUPPLY
        require(totalSupply() < MAX_SUPPLY ,"Can't mint anymore token.");
        // check is ethr value is correct
        require(msg.value >= MINT_PRICE,"Not enough ehter sent");
