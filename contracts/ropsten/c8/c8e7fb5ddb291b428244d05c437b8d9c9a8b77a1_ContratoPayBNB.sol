...
contract ContratoPayBNB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xeb61B3B027FD5674F1D6B98fA9f70C21A551bC57); // Marketing Address
        
    address payable public teamAddress =
        payable(0xbFfDfc85182439779926D7E59d0FC4C7f6caf32E); // Team Address
    ...
    string private constant _name = "PAYBNB";
