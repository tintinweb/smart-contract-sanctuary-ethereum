 ...
 */
contract Token is AccessControlEnumerable, Pausable {
    ...
    /**
     * Return player stats.
     * @notice This returns essential stats about a player.
     */
    ...
    function mint(address to_, uint256 amount_) external trusted {
        return _internalMint(to_, amount_);
    }
    ...
    function burn(address from_, uint256 amount_) external trusted {
        return _internalBurn(from_, amount_);
    }
     ...
     * @param amount_ Amount of tokens to mint.
     */
    function _internalMint(address to_, uint256 amount_) internal
    {
     ...
     */
    function _internalBurn(address from_, uint256 amount_) internal
    {
        require(_balances[from_] >= amount_, "Insufficient funds");
        _balances[from_] -= amount_;
        _totalSupply -= amount_;
    ...
    /**
     * @notice Requires default admin role. These are methods that will be
     * called by trusted users.
     */
    modifier admin()
    {
