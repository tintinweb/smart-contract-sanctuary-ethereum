...
import "./dependency/LeslarMetaVerse.sol";
import "./dependency/LeslarReward.sol";
import '@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol';
import '@openzeppelin/contracts-upgradeable/token/ERC721/IERC721ReceiverUpgradeable.sol';

contract LeslarStaking is OwnableUpgradeable, IERC721ReceiverUpgradeable {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   function initialize(LeslarMetaVerse _nft, LeslarReward _token)external initializer { 
    nft = _nft;
    token = _token;
  }
...
contract ERC721A is ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    function _ERC721A_init(string memory name_, string memory symbol_) public {
        _name = name_;
        _symbol = symbol_;
