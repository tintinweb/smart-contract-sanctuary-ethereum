...
contract VisionaryDeFi is Context, IERC20, Ownable {
    ...
    address public _exchangewallet =
        payable(address(0x00024475EFFd012A797DBDD371078374496B9b1e));
    address _partnershipswallet =
        payable(address(0x986aB885cC22Bb4Fc16d0C77FC53039b0B7F6f7f));
    ...
    uint256 public _maxWalletSize = 4 * 10**19 * 10**9;
