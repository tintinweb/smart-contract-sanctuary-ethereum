...
contract KiwooToken is IERC20 {
    ...
    constructor()  {
        ...
        _name = "KiwooToken"; 
        _decimals = 18;
        _brate = 4;  // 4%  de cada token sera quemado de la cadena en cada transaccion transfer from && transfer to 
        _totalSupply = 1000000000000* 10**uint(_decimals);
        balances[msg.sender]=_totalSupply;
       _minimumSupply = 1* 10** uint (_decimals);
    }
