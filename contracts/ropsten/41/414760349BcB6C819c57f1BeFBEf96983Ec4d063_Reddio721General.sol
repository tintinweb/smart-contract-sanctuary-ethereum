...
contract Reddio721General is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    bool _publicMint;
    constructor(string memory name_, string memory symbol_,  address owner , bool publicMint)
    ...
    function pause() public {
        require(
            ...
            "ReddioGeneral721: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function setBaseURI(string memory baseURI) public {
        require(
            ...
            "ReddioGeneral721: must have admin role to pause"
        );
