 ...
 */
contract TokenPrice is Pausable, Ownable {
    ...
    /**
    * @dev Retrive readable date from count of days
    * @param _days count of days
    */
    ...
    * @param _day date (day)
    */
    function setPrice(uint _price, uint16 _year, uint8 _month, uint8 _day) external whenNotPaused {
    ...
    * @param _day date (day)
    */
    function getPrice(uint16 _year, uint8 _month, uint8 _day) external whenNotPaused view returns (uint) {
