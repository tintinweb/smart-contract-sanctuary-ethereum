...
contract ClaimDIVA is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(address _divaToken) payable {
    ...
    function claimTokens(
        ...
        divaToken.transfer(msg.sender, _amount);
    }
    ...
    function withdrawUnclaimedDivaTokens() external onlyOwner {
        require(
            ...
            "ClaimDIVA: cant claim diva tokens until three years from claim start time"
        );
