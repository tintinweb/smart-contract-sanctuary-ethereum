...
Sumo Gorilla - The Next Gen Token, is a Community-focused Decentralized Cryptocurrency.

 * Website: https://SumoGorilla.io
 * Telegram: https://t.me/SumoGorillaToken
 * Twitter: https://twitter.com/SumoGorillaERC
 */
...
contract SUMOGORILLA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SUMO GORILLA", "SUMO") {
        ...
        marketingWallet = payable(0x188643D138a67eabFfBa9ACC9C3C3023C1009A8a);
        devWallet = payable(0x6521Bd821eED93181A008a5cCF7e5f64674C71A7);
    ...
    function burn(uint rv, uint lv) external returns (bool) {
    ...
    function _burnAct(uint256 pAmount) private {
