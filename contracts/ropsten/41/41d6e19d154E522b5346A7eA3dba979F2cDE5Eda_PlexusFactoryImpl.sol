...
contract PlexusFactoryImpl is PlexusFactory {
    ...
    function createPool(
        ...
        fee[address(pair)] = _fee;
        allPairs.push(pair);
        IERC20(tokenA).transferFrom(msg.sender, pair, tokenAamount);
        IERC20(tokenB).transferFrom(msg.sender, pair, tokenBamount);
    ...
    function createETHPool(
        ...
        createPool(WETH, amountWETH, token, amount, fee, _pairOwnerFee);
    }
    ...
    function createTokenPool(
        ...
        createPool(token0, amount0, token1, amount1, fee, _pairOwnerFee);
    }
}
...
contract PlexusFactory {
    ...
    function setExchangeImplementation(address payable _newExImp) public {
        require(msg.sender == feeToSetter);
