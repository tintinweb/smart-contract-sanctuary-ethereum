...
contract Vendor is Ownable {
    ...
    uint256 public tokensPerEth = 100; // 100 BEP/1ETH
    ...
    function sell(uint256 amount) public {
        ...
        require(userBalance >= amount, "Your balance has not enough to sell");

        // Check that the Vendor's balance is enough to do the swap
        uint256 vendorOurETHBalance = address(this).balance;
        uint256 amountOfETHToTransfer = amount / tokensPerEth;
        require(
            vendorOurETHBalance >= amountOfETHToTransfer,
