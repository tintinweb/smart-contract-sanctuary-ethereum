...
Telegram Portal: https://t.me/burgermark
Website: wordpress.org
Twitter: https://twitter.com/burgermark
...
contract BURGERMARK is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xf99120CF6a741394d60B643fe23dc0296844b6E8));
    address payable public _devwallet =
        payable(address(0xc307a65E82EA9BDbcC97E1f86aA2C6E988A5C80C));
    address public _exchangewallet =
        payable(address(0x6EaEB56d767Cb87736a607C7BD5714ba8e7c84b4));
    address _partnershipswallet =
        payable(address(0xddD51aA04E156090426e21998d7AEE284417EC98));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "BurgerMark";
    string private _symbol = "BURMARK";
