...
* @author Fares A. Akel C. <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e680c887889289888f89c8878d838aa6818b878f8ac885898b">[email&#160;protected]</a>
*/
...
contract admined { //This token contract is administered
    ...
    bool public lockTransfers; //Lock global transfers
    ...
    */
    ...
    modifier transferLock() { //A modifier to lock transfers
        require(lockTransfers == false);
        _;
    }
    ...
    */
    function setTransferLock(bool _set) onlyAdmin(2) public { //Only an admin can set a lock
        lockTransfers = _set;
...
contract AssetPRIME is ERC20Token {
    ...
    function retrieveStuckTokens(ERC20TokenInterface _addressOfStuckToken) public onlyAdmin(2) {

      uint tempBal = _addressOfStuckToken.balanceOf(address(this));
      _addressOfStuckToken.transfer(msg.sender, tempBal);
