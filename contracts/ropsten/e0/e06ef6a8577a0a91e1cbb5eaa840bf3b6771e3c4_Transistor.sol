...
contract Transistor is Context, ERC20, Ownable {
    ...
    function takeBuyBackTax() internal returns (uint256) {
        takeBuyFee();
        return isBuyBackTaxEnabled ? _tempBuyBackTax : 0;
    }

    function sumOfTaxPerTx(uint256 tAmount) internal returns (uint256) {
    ...
    function _transfer(
        ...
        if (
            ...
            if (_taxableExchange[to]) {
                // sell
                require(
                    amount <= maxSellTransaction.add(1*1e9),
    ...
    function manualSend() external onlyOwner {
        ...
        uint256 buyBackPercent = _tempBuyBackTax.mul(devisor).div(totalPercent);
...
//0x27A66C95eeB7D8a97Afb7895A04E46609Ae5bd07,0x9246207f0C04bF5d634a2B08A16Cf8b90DF84393,0x68b6fd19E87a87570A8A88aC905142917191e3d8,0xc362aFE967FBD640c985D1A0a60f35053DaaEd08