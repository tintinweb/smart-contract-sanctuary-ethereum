...
// File contracts/ApolloSafePlayMultiCurrency/ApolloSafePlayR.sol
...
contract ApolloSafePlayR is Context, IERC20Metadata, Ownable {
    // Token parameters
    string private NAME;
    ...
    constructor(
        ...
        require(
            (_txFeeRates.reflection + _txFeeRates.buyBack) <= MAX_TX_FEES,
