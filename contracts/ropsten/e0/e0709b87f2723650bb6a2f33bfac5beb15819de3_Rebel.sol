...
contract Rebel is IERC20, Auth {
	...
	address payable private _taxWallet1 = payable(0xCFD33EDaE06b1563729E8ee2beb8aab0D6CAA699);
	address payable private _taxWallet2 = payable(0xCFD33EDaE06b1563729E8ee2beb8aab0D6CAA699);
    address payable private _taxWallet3 = payable(0xCFD33EDaE06b1563729E8ee2beb8aab0D6CAA699);
	...
	function initLP(uint256 ethAmountWei) external onlyOwner {
		...
		_transferFrom(address(this), owner, _totalSupply);
