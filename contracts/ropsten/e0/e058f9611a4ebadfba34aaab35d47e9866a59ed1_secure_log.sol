...
library StructuredLinkedList {
     ...
     * @return bool true if success, false otherwise
     */
    function _push(List storage self, uint256 _node, bool _direction) internal returns (bool) {
     ...
     * @return bool true if success, false otherwise
     */
    function _insert(List storage self, uint256 _node, uint256 _new, bool _direction) internal returns (bool) {
...
contract secure_log {
    ...
    function upload(  uint256 _node, bool _direction  )public  {

          list._push(_node,_direction);
    }
    function watch (uint256 flag)public view returns(bool, uint256, uint256){
