    ...
    ReentrancyGuardUpgradeable
{
    ...
    function updateValset(
        ...
        eventNonce++;
        emit ValsetUpdatedEvent(_newValset.valsetNonce, eventNonce, chainType, chainId, _newValset.validators, _newValset.powers);
    }
    ...
    function requestFromRouter(
        ...
        if (block.timestamp > requestPayload.expTimestamp) {
            ...
            emit EventOutboundAck(requestPayload.relayerRouterAddress, requestPayload.routerBridgeAddress, chainId, chainType, eventNonce, requestPayload.outboundTxNonce, emptyData, 1, false);
            return;
        }
        ...
        emit EventOutboundAck(requestPayload.relayerRouterAddress, requestPayload.routerBridgeAddress, chainId, chainType, eventNonce, requestPayload.outboundTxNonce, data, 0, success);
    }
