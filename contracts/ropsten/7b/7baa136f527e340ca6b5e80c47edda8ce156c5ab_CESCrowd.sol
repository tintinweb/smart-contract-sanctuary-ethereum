...
contract CESCrowd is DSAuth, DSMath {
    ...
    uint128 public onePieceOfToken; // how many tokens of one piece
    uint128 public pieceSupply;     // total pieces of the all sell token
    uint128 public pieceSell;       // how many pieces was sold
    ...
    constructor () public {
        totalIssue  = 210000000; // 210 million token
        totalSell   =  20000000; //  20 million token
