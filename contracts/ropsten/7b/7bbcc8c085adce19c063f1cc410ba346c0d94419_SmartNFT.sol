...
contract SmartNFT is ERC721, ERC721Enumerable,ERC2981{
    ...
    address public wlMinter=0x68F7eB428D40659b2FBA5405905217090b73D716;
    ...
    uint128 public normalPrice = 5000000000000000;  // 0.005ETH

    uint128 public totalMint = 0;

    uint128 public maxMint = 2500;
    ...
    constructor(uint96 _royaltyFeesInBips) ERC721("World of Cats", "CT") {
    ...
    function changePrice(uint128 normalPrice_) public onlyOwner {

        normalPrice = normalPrice_;
  ...
  function changeBaseURI(string memory baseURI_) public onlyOwner {
    ...
    function claimBalance(uint128 withdrawAmount) external onlyOwner {
