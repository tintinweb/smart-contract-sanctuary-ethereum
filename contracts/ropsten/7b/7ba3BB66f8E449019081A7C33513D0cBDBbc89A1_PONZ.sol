...
contract PONZ is ERC20, Ownable {
    ...
    //Variable Block Enable Trade - once enabled, can never be turned off
    function EnableTrade1(uint256 DontMiss) external onlyOwner {
        tradingActive = true;
        _launchTime = block.timestamp.add(DontMiss);
    }
