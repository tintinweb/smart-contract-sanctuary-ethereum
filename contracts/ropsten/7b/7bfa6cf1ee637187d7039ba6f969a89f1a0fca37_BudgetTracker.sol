...
contract BudgetTracker{
    ...
    function addTransaction(address user,string memory description , uint date,string memory month, int64 amount) public {
    ...
    function deleteTransaction(address user,string memory description , uint date,string memory month, int64 amount) public returns (bool){
