...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  // how many nfts an account has staked
  ...
  function _unstakeMany(address account, uint256[] calldata tokenIds) internal {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      //remove nft from stakedNFTs
      stakedNFTs[account] = stakedNFTs[account].sub(1);
    }
  }
  ...
  // should never be used inside of transaction because of gas fee (USE MAPPING stakedNFTs INFO INSTEAD THIS FUNCTION!!!)
