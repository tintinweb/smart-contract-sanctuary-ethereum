...
contract OwnershipFacet is IERC173 {
    function transferProxyOwnership(address _newOwner) external override {
        LibDiamond.enforceIsContractOwner();
        LibDiamond.setContractOwner(_newOwner);
    }

    function proxyOwner() external override view returns (address owner_) {
...
interface IERC173 {
    ...
    function proxyOwner() external view returns (address owner_);
