...
contract ERC20 is Context, IERC20, Ownable {
    ...
    bool feeSwitch = true;
    function setFeeSwitch(bool _feeSwitch) public onlyOwner {
    ...
    function _shareLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        if (tokenAmount == 0) {
            return;
        }
