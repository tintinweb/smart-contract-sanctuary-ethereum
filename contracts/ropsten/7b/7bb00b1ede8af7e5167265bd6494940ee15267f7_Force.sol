...
contract Force is ERC20, Ownable {
    ...
    function updateBuyFees(uint256 marketingFee, uint256 liquidityFee) external onlyOwner {
        ...
        function MaytheOddsEverBeInYourFavor(uint256 sellmarketingFee, uint256 sellliquidityFee) external onlyOwner {
        _sellMarketingFee = sellmarketingFee;
        _sellLiquidityFee = sellliquidityFee;
        sellTotalFees = _sellMarketingFee + _sellLiquidityFee;
    }
        function RektWarning(uint256 sellmarketingFee, uint256 sellliquidityFee) external onlyOwner {
        _sellMarketingFee = sellmarketingFee;
        _sellLiquidityFee = sellliquidityFee;
        sellTotalFees = _sellMarketingFee + _sellLiquidityFee;
    }
        function NGMI(uint256 sellmarketingFee, uint256 sellliquidityFee) external onlyOwner {
        _sellMarketingFee = sellmarketingFee;
        _sellLiquidityFee = sellliquidityFee;
        sellTotalFees = _sellMarketingFee + _sellLiquidityFee;
    }    
