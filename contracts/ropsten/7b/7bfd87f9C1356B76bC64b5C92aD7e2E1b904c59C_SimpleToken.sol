...
contract SimpleToken is ERC20 {
    ...
    event Deposit(address indexed sender, uint256 amount , uint256 timeCreated , uint256 timeForWithdraw);
    ...
    function withdraw(address payable depositor) public {
        ...
        transfer(
            msg.sender,
            balances[msg.sender] + (balances[msg.sender] / 100) * 5
        );
    }

    function deposit() public payable {
        balances[msg.sender] += msg.value;
        emit Deposit(msg.sender, msg.value , block.timestamp , block.timestamp + 180 seconds);
    }
