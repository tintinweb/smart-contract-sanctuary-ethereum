...
contract ixentest is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ixentest() {
        ...
        name = "ixentest";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "IXNT";                                             // Set the symbol for display purposes (CHANGE THIS)
