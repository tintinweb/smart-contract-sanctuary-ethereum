...
contract EmiratesDao is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("EmiratesDao", "EmiratesDAO") {
    ...
    function dao() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function updatePhaseToStaking() external onlyOwner returns (bool){
        limitsInEffect = false;
        return true;
    }
