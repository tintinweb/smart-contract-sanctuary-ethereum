...
/**
GPS Riding GPS is a community-driven web3 move2earn platform amongst GenZers 
The world’s first NFT bike race metaverse marketplace.
*/
...
contract GPSRiding is Context, IERC20, Ownable {
    ...
    string private _name = 'GPSRiding';
