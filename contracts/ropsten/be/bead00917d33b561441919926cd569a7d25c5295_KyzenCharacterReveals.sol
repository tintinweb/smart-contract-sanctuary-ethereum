...
contract KyzenCharacterReveals is ERC721, ERC721URIStorage, Mintable {
    ...
    function _mintFor(
        ...
        string memory cid = findCID(blueprint);
        _safeMint(to, id);
        _setTokenURI(
            id,
            string(abi.encodePacked("https://ipfs.io/ipfs/", cid))
        );
    }
    ...
    /**
     * bytes  => 0x7b317d3a7b516d565379724c563335794643716e633977426f5955664d346832524a736f3650756a624d4e6a51484761454c677d
     * string => {0}:{QmVSyrLV35yFCqnc9wBoYUfM4h2RJso6PujbMNjQHGaELg}
     * cid    => QmVSyrLV35yFCqnc9wBoYUfM4h2RJso6PujbMNjQHGaELg
     *
     * bytes  => 0x7b31307d3a7b516d565379724c563335794643716e633977426f5955664d346832524a736f3650756a624d4e6a51484761454c677d
     * string => {10}:{QmVSyrLV35yFCqnc9wBoYUfM4h2RJso6PujbMNjQHGaELg}
     * cid    => QmVSyrLV35yFCqnc9wBoYUfM4h2RJso6PujbMNjQHGaELg
     *
     * bytes  => 0x7b3130307d3a7b516d565379724c563335794643716e633977426f5955664d346832524a736f3650756a624d4e6a51484761454c677d
     * string => {100}:{QmVSyrLV35yFCqnc9wBoYUfM4h2RJso6PujbMNjQHGaELg}
     * cid    => QmVSyrLV35yFCqnc9wBoYUfM4h2RJso6PujbMNjQHGaELg
     */
    function findCID(bytes memory data) public pure returns (string memory) {
        ...
        for (uint256 i = 0; i < 46; i++) {
            result[i] = data[i + delimiterIndex];
        }
        return string(result);
    }
}