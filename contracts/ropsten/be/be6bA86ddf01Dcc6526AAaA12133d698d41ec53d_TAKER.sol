...
contract TAKER is ERC721R, Ownable {
    ...
    {
        require( totalSupply() + (LAUNCH_MAX_SUPPLY - LAUNCH_SUPPLY) + Max_Team_Supply + count <= maxSupply(), "Max Supply" );
        
        _mintRandom(to, count);
    }
        ...
        payable
    {
        ...
        require(totalSupply() + count <= maxSupply(), "Max Token Mint");
    ...
    function SetReveal() public onlyAdmin
    {
        if( !IsRevealed )
        {
            IsRevealed = true;
