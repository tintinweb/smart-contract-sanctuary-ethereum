...
contract DDAOTeamClaim is AccessControl
{
    ...
    event eStakeRecalc(uint8 id,uint8 num,address addr,uint256 amount,uint256 staked,uint256 payed,uint48 time);
...
//	require(amount_to_send > 0,"Amount to send is zero");
