...
// from: https://solidity-by-example.org/app/erc20/
contract FtnssToken is ERC20{
    constructor(string memory name, string memory symbol) ERC20(name, symbol) {
        /*
        * Mint 1,000,000 tokens `amount` to msg.sender `account`, increasing
        * the total supply.
        * Similar to how
        * 1 dollar = 100 cents
        ...
        * @param uint256 amount  total supply
        */
