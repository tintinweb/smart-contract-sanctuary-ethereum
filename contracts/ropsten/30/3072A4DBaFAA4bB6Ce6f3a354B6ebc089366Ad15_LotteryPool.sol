    ...
    function CloseLottery(address[] memory _playerlist) external onlyOwner{
        ...
        for(uint256 i = 0; i < _playerlist.length; i++){
            ...
            if(_playerlist[i]== winnerAddress){
                ...
                if(lotteryid == 0){
                    remainPrice = 0 + allLotteryInfo[lotteryid]._ticketPrice * _playerlist.length;
                }else{                    
                    remainPrice = allLotteryInfo[lotteryid-1]._remainPrice + allLotteryInfo[lotteryid]._ticketPrice * _playerlist.length;
                }
                ...
                allLotteryInfo[lotteryid]._winnerAddress = winnerAddress;
                isWinner = true;                
            }
        }
        if(!isWinner){
