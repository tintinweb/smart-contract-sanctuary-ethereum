...
contract BlackBeltInu is ERC20, Ownable {
    ...
    constructor() ERC20("Black Belt Inu", "OSS") {
        ...
        marketingWallet = address(0x8643a9eC002a53816FF6132D87C4dDC2bF5D0005); // set as marketing wallet
        devWallet = address(0x0eA93a79739F14320C87710D90069f76C2A30741); // set as dev wallet
