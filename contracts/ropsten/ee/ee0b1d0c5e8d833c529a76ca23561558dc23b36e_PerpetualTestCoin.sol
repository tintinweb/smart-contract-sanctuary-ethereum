...
contract PerpetualTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PerpetualTestCoin() {
        ...
        name = "PerpetualCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "";                                             // Set the symbol for display purposes (CHANGE THIS)
