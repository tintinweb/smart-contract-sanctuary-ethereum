...
/**
 * @title TylectomiesTrainable
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract TylectomiesTrainable is ERC20FlashMint, Pausable, Forwarder {
    address private _owner;

    constructor() ERC20("Tylectomies Trainable","TEAE")  { 
        _owner = _msgSender();
     }
     ...
     * - `account` cannot be the zero address.
     */
     function mint(address account, uint256 amount) public whenNotPaused onlyParent {
     ...
     * - The contract must not be paused.
     */
    function pause() public onlyParent whenNotPaused {
        super._pause();
    }
     ...
     * - The contract must be paused.
     */
    function unpause() public onlyParent whenPaused {
        super._unpause();
    }
