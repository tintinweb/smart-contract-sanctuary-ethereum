...
contract LastTicket is ERC721, Ownable {
    ...
    constructor() payable ERC721('LASTTICKET', 'NFT3MINT') {
        mintPrice = 0.1 ether;
        maxMintSupply = 12;
        maxPerWallet = 3; // each wallet can mint up to 3 nfts
        withdrawWallet = address(0x96dFCC6413e09c9B02e7892beC6e215D57EF19a7); // limit withdraw to owner address
