...
contract NardoTest1 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NardoTest1() {
        ...
        name = "NardoTest1";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NRDOTF";                                             // Set the symbol for display purposes (CHANGE THIS)
