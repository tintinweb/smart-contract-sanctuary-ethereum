...
{   
    ...
    address public _ArtBlocksMintingContractCitizens = 0x296FF13607C80b550dd136435983734c889Ccca4;      // ArtBlocks Minting Contract Citizens
    ...
    address public _ArtBlocksCoreContractCitizens = 0x24CCA47Fcc4fe09b51aBE8A8124C3da01765bE14;         // ArtBlocks Citizen NFT Collection Contract Address
    ...
    address public _GoldenToken = 0x6d4aF8CAbB5713037954713ba9cE3BDA4EB851EB;                           // Golden Token Contract Address
    uint public _ArtBlocksProjectID = 2;                                                                // ArtBlocks Project ID
    uint public _CurrentCityIndex;                                                                      // Current City Index
    uint _QRIndex = 333;                                                                                // QR Code Index
    bytes32 public Root = 0x9af7e5a6e7b494fdcdb682be7be5d3f166913354ffcad0044f00da38f974cc50;           // Merkle Root
    ...
    { 
        ...
        ArtistMintPasses[_CurrentCityIndex][7] = 0x2A15300e8749C8025c370101259EB8AaE9127288; //testing
        ArtistContracts[_CurrentCityIndex][7] = 0x9CBd20e9F124e5A3df90Ed6508F5D3c0E14C5F8C; //testing
