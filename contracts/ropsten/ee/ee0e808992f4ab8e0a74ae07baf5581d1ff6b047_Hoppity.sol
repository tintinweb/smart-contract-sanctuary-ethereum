...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "Your wallet currently has 0 HOPPITY");
        return shares[shareholder].totalClaimed;
    }
}

contract Hoppity is IERC20, Auth {
    using SafeMath for uint256;

    address public RewardToken;

    string private constant _name = "Hoppity";
    string private constant _symbol = "HPTY";
    ...
    address payable public marketingWallet = payable(0x655Ffa17119Ed98D2Aa3650C3ab9Ce5e4A652681);
    address payable public devWallet = payable(0x655Ffa17119Ed98D2Aa3650C3ab9Ce5e4A652681);
