...
contract CursedWarriors is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI = "ipfs://QmbKrFpEihKFC1sDLDNBpcenBButod9XUYeUp5nwu7iq2m/";
    ...
    constructor() ERC721A("CursedWarriors", "CWS") {
        setBaseURI("");
    ...
    */
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max CursedWarriors per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 CursedWarriors" );
		require(s + _mintAmount <= maxFree, "Cant exceed CursedWarriors supply" );
    ...
    /**
    * @dev MINT A CursedWarrior
    * @param _mintAmount HOW MANY NFTS U WANT
    */
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 CursedWarriors");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more CursedWarriors" );
        require(s + _mintAmount <= maxSupply, "Cant exceed CursedWarriors supply");
