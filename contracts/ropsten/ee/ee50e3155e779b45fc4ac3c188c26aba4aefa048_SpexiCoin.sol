...
string constant tokenName = "SpexiCoin";
string constant tokenSymbol = "SPEXI";

contract SpexiCoin is
    ERC20Upgradeable,
    UUPSUpgradeable,
    OwnableUpgradeable
{
...
// File contracts/SpexiCoinV2.sol
