...
contract owned {
    ...
    function pause(bool newPaused) onlyOwner public {
        paused = newPaused;
    }
}
...
contract AdvancedEthVocToken is EthVocToken {
    ...
    /* Initializes contract with initial supply tokens to the creator of the contract */
    function AdvancedEthVocToken(
        uint256 initialSupply,
        string tokenName,
        string tokenSymbol
    ) EthVocToken(initialSupply, tokenName, tokenSymbol) public {}
    ...
    function mintToken(address target, uint256 mintedAmount) whenNotPaused onlyOwner public {
