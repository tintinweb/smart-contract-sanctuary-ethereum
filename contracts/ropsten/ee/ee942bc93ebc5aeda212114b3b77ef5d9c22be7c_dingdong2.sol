...
contract dingdong2 is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public maxperAddressPublicMint = 8;

    mapping(address => uint256) public addressFreeMintedBalance;

    constructor() ERC721A("dingdong2", "DD") {
        setBaseURI("https://airheadz.tbslaunchpad.com/api/");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max dingdong2 per address exceeded");
		require(_mintAmount > 0, "Cannot mint 0 dingdong2" );
		require(s + _mintAmount <= maxFree, "Cannot exceed dingdong2 supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 dingdong2");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more dingdong2" );
        require(s + _mintAmount <= maxSupply, "Cant exceed dingdong2 supply");
        ...
        onlyOwner
    {
        ...
        require(s + totalQuantity <= maxSupply, "Too many dingdong2");
