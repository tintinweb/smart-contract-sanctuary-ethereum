...
contract AccrualBondsV1 is AccrualBondStorageV1, Initializable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    /// @notice emmitted when a bond is redeemed/claimed
    /// @param bonder account that purchased the bond
    ...
    function purchaseBondUsingPermitAllowed(
        ...
        // approve tokens for spender - https://eips.ethereum.org/EIPS/eip-2612
        SelfPermitLib.selfPermitAllowed(token, nonce, deadline, v, r, s);
    ...
    function redeemBond(
        ...
        // make sure amount is greater than zero to save gas
    ...
    function policyUpdate(
        ...
        // if percent to convert is less than 10,000 bips, we assume 
        // caller wants to update shuttles percent to convert. 
        if (1e4 > percentToConvert) IShuttle(beneficiary).setPercentToConvert(percentToConvert);
    ...
    function removeQuoteAsset(
        ...
        require(quote.lastUpdate != 0, "!exists");
