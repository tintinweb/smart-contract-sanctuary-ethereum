...
contract WOWTokenConfig {

    string  public constant TOKEN_SYMBOL   = "WOW";
    string  public constant TOKEN_NAME     = "WOW_test";
    uint8   public constant TOKEN_DECIMALS = 18;

    uint256 public constant DECIMALSFACTOR = 10**uint256(TOKEN_DECIMALS);
    uint256 public constant TOKENS_MAX     = 141414141414141 * DECIMALSFACTOR;
}
...
contract WOWToken is ERC20Token, OpsManaged, WOWTokenConfig {
