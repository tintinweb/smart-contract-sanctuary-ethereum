...
// Messsage to all those mushu sendors who ape in ...

// There are no official socials,build community and the coin will follow
// 
// Early sells tax, and max txn will be on for the first half hour
// after those penny flipper jeets get out I will lower taxes. and remove max txn
...
contract mushu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("mushu", "SendorDragon") {
