...
contract LinearVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
        ...
        onlyOwner
    {
        ...
        for(uint256 i = 0 ; i < _rewards.length; i++){
            ...
            if(r.amount > 0 && !isFarmUser[r.user]){
                ...
                totalUserRewards[r.user] = amount;
    ...
    {
        uint256 totalRewardsUnlocked = totalRewards / (lastTimeRewardApplicable() - startTime);
        uint256 totalRewardsLocked = totalRewards - totalRewardsUnlocked;
        return ((totalRewardsLocked / 1e18), (totalRewardsUnlocked / 1e18), (totalWithdrawn / 1e18));
    }
        ...
        nonReentrant
    {
        ...
        if (rewardAmount > 0) {
            ...
            vestedToken.safeTransfer(address(msg.sender), (rewardAmount / 1e18));
        ...
        onlyOwner
    {
        ...
        vestedToken.safeTransfer(collector, (withdrawnAmount / 1e18));
        ...
        onlyOwner
    {
        ...
        token.safeTransfer(collector, (token.balanceOf((address(this))) / 1e18));
