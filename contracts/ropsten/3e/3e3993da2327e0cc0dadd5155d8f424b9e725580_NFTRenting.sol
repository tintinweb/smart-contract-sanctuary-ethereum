...
contract NFTRenting is Context {
    ...
    mapping(string => mapping(address => RentalRequest)) rentalRequests;
    // rentId => user
    ...
    constructor(){         
        // mint(0, )
        // mint(0x858367E33d86756C205ecF5de7243C71c0dAE2Df, 0x9FF33C0224eB37c4A554f86BA2B5dA8e4a5d9503, 0);
        // mint(0x858367E33d86756C205ecF5de7243C71c0dAE2Df, 0x9FF33C0224eB37c4A554f86BA2B5dA8e4a5d9503, 1);
        
        // mint(0x09c65020750dAd8f6A80FA58cab14949Cab64883, 0x9FF33C0224eB37c4A554f86BA2B5dA8e4a5d9503, 0);
        // mint(0x09c65020750dAd8f6A80FA58cab14949Cab64883, 0x9FF33C0224eB37c4A554f86BA2B5dA8e4a5d9503, 1);

     }

    function mint (address to, address nft, uint256 tokenId) public{
        require(IERC721(nft).ownerOf(tokenId) == address(0),"ERC721: oh no token exists already");
        IERC721(nft).transferFrom(address(0), to, tokenId);
    } 

    function ownerOf(address nft, uint256 tokenId) view public returns(address){
    ...
    function rent(string memory rentId) public checkIsRented(rentId){
        ...
        // require(IERC20(info.paymentToken).transferFrom(_msgSender(), info.owner, info.price), "ERC20: cannot transfer money");
