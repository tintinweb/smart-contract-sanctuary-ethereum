 ...
 */
 ...
 contract Context {
    ...
    */
    ...
    /**
     *@dev function sets the addr of a VC 
    */
    function setVCAddr(address addr) external {
        VCAddr = addr;
    }

    /**
     *@dev function gets the address of the VC
    */
    function getVCAddr() external view returns (address){
        return VCAddr;
    }
