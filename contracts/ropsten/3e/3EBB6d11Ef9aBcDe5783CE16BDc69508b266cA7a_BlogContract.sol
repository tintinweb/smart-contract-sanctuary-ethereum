...
contract BlogContract is EduFi {
    ...
    function createBlog(string memory _title, string memory _content) public {
        blogs.push(Blog({title: _title, content: _content}));
        mint();
    }

    function blogByIndex(uint _index) public view returns(string memory title, string memory content) {
...
contract EduFi is ERC20, Ownable {
    ...
    uint public constant maxTotalSupply = 1000000 * 10 ** 18;

    constructor() ERC20("EduFi Token", "EDUFI") {}
