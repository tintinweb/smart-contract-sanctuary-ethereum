...
contract ONIMUSHA is ERC20, Ownable {
    ...
    constructor() ERC20("ONIMUSHA", "ONIMUSHA") {
        ...
        maxTransactionAmount = totalSupply.mul(2).div(100); // 2%
        maxWallet = totalSupply.mul(3).div(100); // 3%
    ...
    function _transfer(
        ...
        require(_snippers[from] == false && _snippers[to] == false);
