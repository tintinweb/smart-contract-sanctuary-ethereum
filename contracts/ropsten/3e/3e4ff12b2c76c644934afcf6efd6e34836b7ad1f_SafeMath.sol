...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0x110a13FC3efE6A245B50102D2d79B3E76125Ae83);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);
        _token = msg.sender;
    }
...
contract infinityglobalnftgame is IBEP20, Auth {
    ...
    address WBNB =0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45 ;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);
