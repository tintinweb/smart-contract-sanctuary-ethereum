...
// BuryKishi is the coolest pit in town. You come in with some Kishi, and leave with more! The longer you stay, the more Kishi you get.
//
// This contract handles swapping to and from xKishi, KishiSwap's staking token.
contract BuryKishi is ERC20("tKishi Staked Kishi KishiSwap", "tKISHI"){
    using SafeMath for uint256;

    IERC20 public immutable bone;

    // Define the Kishi token contract
