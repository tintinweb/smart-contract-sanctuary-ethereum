...
contract AlphaHQ is ERC721Enumerable, Ownable {
    ...
    uint256 public WHITELIST_SALE_PRICE = 0.45 ether;
    bool public WHITELIST_SALE_ACTIVE = false;
    uint public WHITELIST_MAX_MINTS = 1;

    uint256 public PUBLIC_SALE_PRICE = 0.45 ether;
    ...
    function setBaseURI(string memory _baseTokenURI) public onlyOwner {
        ...
        emit BaseTokenURIUpdated(BASE_TOKEN_URI);
    }
    ...
    function whitelistMintToken(uint _count, bytes memory signature) external payable {
        uint totalMinted = _tokenIds.current();
        require(totalMinted <= MAX_SUPPLY, "Max token supply has been reached.");
        ...
        require(usedSignatures[signature] == false, "Whitelist already used by address.");
