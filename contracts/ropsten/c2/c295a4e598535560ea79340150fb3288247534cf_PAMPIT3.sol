...
contract PAMPIT3 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pamp ittt!", "PAMp3") {
    ...
    function updateSellFees(uint256 sellmarketingFee, uint256 sellliquidityFee) external onlyOwner {
        _sellMarketingFee = sellmarketingFee;
        _sellLiquidityFee = sellliquidityFee;
    }
