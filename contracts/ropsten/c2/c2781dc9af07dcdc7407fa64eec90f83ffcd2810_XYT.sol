 ...
 */
contract XYT is StandardToken {

    string public constant name = "XYT"; // solium-disable-line uppercase
    string public constant symbol = "XYT"; // solium-disable-line uppercase
