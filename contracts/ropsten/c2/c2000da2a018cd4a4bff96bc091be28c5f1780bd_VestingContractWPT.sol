...
contract VestingContractWPT {
  ...
  constructor (Token _company_token) public {
    ...
    originalBalance = 29500 * 10**18; // 29 500 WPT
    currentBalance = originalBalance;
    alreadyTransfered = 0;
    startDateOfPayments = 1538294999; //From Sun Sep 30 2018 08:09:59
    endDateOfPayments = 1538330400; //From Sun Sep 30 2018 00:00:00
    periodOfOnePayments = 2 * 60; // 2 min in seconds
    daysOfPayments = (endDateOfPayments - startDateOfPayments) / periodOfOnePayments; // 295 days
