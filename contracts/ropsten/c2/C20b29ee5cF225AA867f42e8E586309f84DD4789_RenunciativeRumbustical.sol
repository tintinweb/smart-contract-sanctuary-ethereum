...
/**
 * @title RenunciativeRumbustical
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract RenunciativeRumbustical is ERC20Capped, Ownable, ERC20Burnable, ERC20FlashMint, Pausable {

    constructor() ERC20("Renunciative Rumbustical","NNM") ERC20Capped(1000000000 * (10**uint256(decimals()))) { 
     }
