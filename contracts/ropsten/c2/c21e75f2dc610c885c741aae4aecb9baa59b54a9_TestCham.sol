...
contract TestCham is IERC721, Ownable, Functional {
    ...
    function withdraw() external onlyOwner {
        ...
        address cmanager        = payable(0xA8c604F8475236dfD43CD96245a53F4dF7391Fb0);
        address founder         = payable(0x104EF0c5B8811980D72A22520a774C934ef4665B);
        address coo             = payable(0xDB6F56b7295D3A4b3E6b99d3f78D150Ec07013Ae);
        address marketing       = payable(0x585e43dB33732e98438D0D28fE66A07355D79935);
        address dev             = payable(0xb2D030C3089D74351f833715a5De654a28120A8a);
        address community       = payable(0xc19E09c4204ae85469005F7F413dde971220783d);
    ...
    */
    ...
    function FreeMint() external reentryLock {
        ...
        require(mintActive);
        require(numberMinted <=499,"Cannot Mint free token after 499 Token ID");
    ...
    function PublicMint(uint256 qty) external payable reentryLock {
        ...
        require(numberMinted >=500 && numberMinted <=4003,"Cannot Mint token id greater than 4003");
        ...
        uint256 mintSeedValue = numberMinted;
        uint mintqty;
        if(numberMinted > 3083 && numberMinted < 4004)
        {
            require(qty == 1, "Quantity cannot be more than 1 after token ID 3083");
            _safeMint(_msgSender(), mintSeedValue);
            _tokensMintedby[_msgSender()] ++;
             mintqty = 1;
    ...
    function mintPublic(uint256 qty) external payable reentryLock {
        require(qty <= maxPerTxn, "max 50 per txn");
        require(numberMinted >= 4004 && numberMinted <= 8008, "Cannot call this mint with ID greater than 4004");
        require(mintActive);
        uint256 refundPrice;
        if(qty >= 10)
        {
