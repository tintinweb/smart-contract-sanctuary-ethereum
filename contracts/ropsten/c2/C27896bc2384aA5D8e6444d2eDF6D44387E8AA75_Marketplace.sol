...
contract Marketplace is IERC721Receiver {
    ...
    function mintAndCreateAuction(
        ...
        this.createAuction(_addressNFTCollection, _nftId, _initialBid, _buyNowPrice, _endAuction);
    ...
    function collectionAndMintAndCreateAuction(
        string memory _name,
        ...
        this.mintAndCreateAuction(initialRoyalty_, _addressNFTCollection, _initialBid, _buyNowPrice, _endAuction);
