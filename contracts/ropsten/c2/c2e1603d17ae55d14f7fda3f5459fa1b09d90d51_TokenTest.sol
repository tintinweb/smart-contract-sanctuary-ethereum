...
contract TokenTest is IERC20, Ownable {
	...
	string private constant _symbol = "Token Test";
	...
	function excludeFromDividends(address account, bool excluded) public onlyOwner {
		require(_isExcludedFromDividends[account] != excluded, "Account is already the value of 'excluded'");
		if(excluded) {
