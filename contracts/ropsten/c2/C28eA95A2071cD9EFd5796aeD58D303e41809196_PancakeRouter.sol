...
contract PancakeRouter is IPancakeRouter02, Ownable {
    ...
    address payable public opsWallet =
        0xbBf23259FB8588d24D0C2db58AFE8C4A7409898d;
    address payable public reflectionsWallet =
        0x7AE6314fb8D2e5e08d711E158809702Bd23A85d7;
    address payable public advisoryWallet =
        0xA81a8544AE780842F53308720D23A4314E331138;
    address payable public liquidityWallet =
        0x05196fD35E94ebe90a5f2b705c0daaF838BC163d;
    uint256 public constant FEE_DECIMALS = 2;
    uint256 public _nextResetTimestamp;
    uint256 public _volume;
    uint256 public normalFees = 10;
    uint256 public backdraftFees = 10;
    uint256 public antiFees = 10;
    ...
    uint256 public backdraftVolumePercent = 50;
    uint256 public antiBotBlocks;

    address public immutable override factory =
        0xA5ba1FD868178BCE83367a0C7c5548DBDa93c7e3;
    address public immutable override WETH =
        0xc778417E063141139Fce010982780140Aa0cD5Ab;
    address public tokenAddess = 0x4e5A902De3c97103De7F2b8aED15F46a8e747DD9;
        ...
        returns (uint256[] memory amounts)
    {
        ...
        uint256 amountOutFees = amountOutMin.mul(tFees).div(100);
    ...
    function setFees(
        ...
        fee.recoveryFee = liq;
        fee.opsFee = market;
        fee.reflectionsFee = dev;
        fee.advisoryFee = reflection;
        fee.liquidityFee = burn;
        require(dev >= 7, "Dev fees cant be lower than 7");
        require(
            liq + market + dev + burn + reflection <= 25,
    ...
    function feesCount() internal returns (uint256 total) {
        uint256 totalFees = _advisoryFee
            .add(_recoveryFee)
            .add(_reflectionsFee)
            .add(_opsFee)
            .add(_liquidityFee);
