...
// - [X] Gas Tuning
//
// Difference from ConsenSys/ZMultiSigWallet
//   - Support ERC20
//   - Not support Data Call
//   - Not revocable
//   - Stored count for number of
//     - reduced gas usage
//
// Question:
//   - How could you improve it? e.g. gas tuning, logic assumption (no order of execution,
//     no guarantee for balance)
//   - What do you like or not like about (the current state of) Solidity?
//   - Bounty for found security flaws.
//   - Bonus quesiton: create your own version
