...
contract MidasToken is StandardToken, Pausable {
    string public constant name = 'MidasProtocol Ropsten';
    string public constant symbol = 'MASR';
    ...
    uint256 public constant ethConvertRate = 10000; // 1 ETH = 10000 MASR
    uint256 public constant tomoConvertRate = 10; // 1 TOMO = 10 MASR
    uint256 public totalTokenSold = 0;
    uint256 public maxCap = maxEthContribution.mul(ethConvertRate); // Max MASR can buy
