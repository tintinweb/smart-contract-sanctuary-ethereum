...
for(uint i=1;i<=pendingNo;i++){ 							            //Loop through all the users that have requested withdrawal and...
...
for(uint i=1;i<=pendingNo;i++){     //Loop through all the users that requested withdrawal.
...
for(uint i=1;i<=pendingNo;i++){                 //Loop through all users that requested withdrawal
