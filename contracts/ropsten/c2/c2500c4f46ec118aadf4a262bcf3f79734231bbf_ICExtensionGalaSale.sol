...
contract ICExtensionGalaSale is ERC721, Ownable {
    ...
    address private constant IC_PAYOUT_ADDRESS = 0x78BF2E97b5c8b7d9f16D00d784FCB456AFb4D96a;
    ...
    address private _signer = 0x78BF2E97b5c8b7d9f16D00d784FCB456AFb4D96a;
    ...
    address _controller = 0x78BF2E97b5c8b7d9f16D00d784FCB456AFb4D96a;
    string __baseURI = "na";
    string na = "na";
    ...
    function verifySignatureTest(bytes calldata signature, bytes32 hash) external view returns (bool) {
        return _signer == ECDSA.recover(hash, signature);
    }

    function returnECDSAResult(bytes calldata signature, bytes32 hash) external pure returns (address) {
