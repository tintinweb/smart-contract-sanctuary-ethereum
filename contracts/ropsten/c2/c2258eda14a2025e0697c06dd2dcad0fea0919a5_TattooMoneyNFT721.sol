...

{
    ...
    TattooMoneySingle public TattooMoneyNFT721Sing;
     ...
     constructor(uint256 id , address _whitelistAdmin, address originalContract,string memory type1,address  address1,string memory type2,address address2) 
        ERC721("TattooMoneySingle", "TAT2S")    
    {   
        _tid = id; 
        deci = 18;
        ...
        TattooMoneySingle _TattooMoneyNFT721 = TattooMoneySingle(originalContract);
