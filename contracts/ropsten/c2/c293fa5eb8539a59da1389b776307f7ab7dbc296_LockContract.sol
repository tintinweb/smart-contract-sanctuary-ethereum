...
contract LockContract is Ownable {
    ...
    function currencyInvestment(uint256 lockTimeInSeconds, uint256 amount ) external returns (Investment memory){
        ...
        investment.amountStatus = EAmountStatus.Locked;
        investment.userAddress = msg.sender;
        investment.lockAmount = investment.lockAmount.add(amount);
