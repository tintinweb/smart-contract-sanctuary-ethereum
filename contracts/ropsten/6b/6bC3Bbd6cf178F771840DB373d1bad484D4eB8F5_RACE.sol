...
contract RACE is ReentrancyGuard, ERC721Holder {
    ...
    **/
    function createOrder(
        ...
        bytes32 hash = hashMessage(msg.sender, block.chainid, _maxApprovalAmount, _tokenId, _nftToken);
        ...
        return
            keccak256(
                abi.encodePacked(
                    ...
                    keccak256(abi.encodePacked(sender, chainId, _maxApprovalAmount, tokenId, _nftaddress))
                )
            );
    }
