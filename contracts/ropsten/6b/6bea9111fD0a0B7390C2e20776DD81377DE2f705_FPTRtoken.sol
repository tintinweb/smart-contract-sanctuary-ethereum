...
contract FPTRtoken is ERC20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() ERC20("Fantom Printer1", "FPTR1", 9) {
      address teamWallet = 0x88733f5cF8137C219b666CDFb9234e9a0bdc5952;
      _mint(teamWallet, 87500e9);
    }
