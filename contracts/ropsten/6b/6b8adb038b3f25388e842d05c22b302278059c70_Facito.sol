...
contract Facito {
    ...
    function readArticle(bytes32 _id) public returns (bool success) {
        ...
        this.transfer(msg.sender, (balanceOf[this]/totalSupply)*(2*baseReward)); // Transfer coins to reader
        this.transfer(articles[_id].Author, (balanceOf[this]/totalSupply)*(10*baseReward)); // Transfer coins
