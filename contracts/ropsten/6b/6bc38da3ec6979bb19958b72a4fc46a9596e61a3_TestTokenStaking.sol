...
contract TestTokenStaking is ReentrancyGuard {
    ...
    function redeemInterest() external nonReentrant {
        ...
        if (redeemResult.interestAmount != 0) {
            FixedTestToken.mintInterest(msg.sender, redeemResult.interestAmount);
        } 
        ...
        FixedTestToken.burnTokenFrom(msg.sender, redeemResult.redeemableAmount);

        FixedGovTestToken.safeTransferFrom(CommunityDistributor, msg.sender, redeemResult.redeemableAmount / govTokenRatio);
    ...
    //     FixedTestToken.safeTransfer(msg.sender, amount);
    ...
    //         FixedTestToken.mintInterest(address(this), userMapping[msg.sender].interestDebt);
    //     } 
