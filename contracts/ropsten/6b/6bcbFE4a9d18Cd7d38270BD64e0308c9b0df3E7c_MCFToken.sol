...
contract MCFToken is ERC20Interface, SafeMath {
    ...
    constructor(string memory _name, string memory _symbol, uint __totalSupply, uint8 _precisionDecimals, address _initialWalletAddress) {
        symbol = _symbol;
        name = _name;
        decimals = _precisionDecimals;
        _totalSupply = __totalSupply;
        balances[_initialWalletAddress] = _totalSupply;
        emit Transfer(address(0), _initialWalletAddress, _totalSupply);
    }
