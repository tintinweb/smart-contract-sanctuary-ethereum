...
contract BlockchainDevToken is StandardToken {
    ...
    uint256 public unitsOneEthCanBuy;       // How many units of your token can be bought by 1 ETH? (eg. 1 ETH (1000000000000000000000 wei) = 10 tokens).
    ...
    constructor() {
        ...
        name = "NatesToken";          // Set name. For display purposes.
        symbol = "NMT";                         // Set symbol. For display purposes.
