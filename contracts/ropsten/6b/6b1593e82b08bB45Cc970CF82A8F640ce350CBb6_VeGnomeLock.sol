...
contract VeGnomeLockWrapper is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialized(address _lockToken, string memory _nameArg, string memory _symbolArg) public {
...
contract VeGnome is ERC20 {
    ...
    function setAdmin(address newAdmin_) external {
        require(_msgSender() == owner, "This function can only be called by an owner");
        adm = newAdmin_;
    }
}
