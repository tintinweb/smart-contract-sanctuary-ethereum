...
// Dependency file: contracts/rk/RKTokenDividendTracker.sol
...
contract RKTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RKToken contract."
        );
    }
...
// Root file: contracts/rk/RKToken.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/rk/RKTokenDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract RKToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    RKTokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = RKTokenDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "RKToken: The dividend tracker already has that address"
        );

        RKTokenDividendTracker newDividendTracker = RKTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "RKToken: The new dividend tracker must be owned by the RKToken token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "RKToken: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "RKToken: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "RKToken: The PanRKSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "RKToken: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "RKToken: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "RKToken: Cannot update gasForProcessing to same value"
        );
