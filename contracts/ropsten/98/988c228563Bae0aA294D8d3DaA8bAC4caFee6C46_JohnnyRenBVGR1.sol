...
contract JohnnyRenBVGR1 is ERC721A, PaymentSplitter, Ownable {
    ...
    constructor(address[] memory payees, uint256[] memory shares)
        ERC721A("JohnnyRenBVGR1 Open Edition", "JRBVGR1")
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory)
    {
        ...
        return string(abi.encodePacked("https://ipfs.io/ipfs/QmV5ARc1HiDWuLmKphiqPu8xnvw82DTUWU65AvfgLCjVr9"));
    }

    function setPrice(uint256 newPrice) external onlyOwner {
        require(newPrice > 0, "Cannot set price to 0");
