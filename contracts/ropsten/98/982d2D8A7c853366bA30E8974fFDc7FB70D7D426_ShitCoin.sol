...
contract ShitCoin is ERC20, Ownable {
    uint256 public constant MAX_SUPPLY = 100_000_000_000_000 ether; //最大提供
    uint256 public constant RESERVED_FOR_POOL_SUPPLY = 25_000_000_000_000 ether;  //预留池
    uint256 public constant V_GIFT_SUPPLY = 25_000_000_000_000 ether; //赠与
    uint256 public constant HOLDER_SUPPLY = 50_000_000_000_000 ether; //公开持有

    address public constant V_ADDRESS = 0x7E0fF5672e79968dD055EaBeebD061FC811f3587; //赠与地址
    address public constant ECOSYSTEM_ADDRESS = 0x53260D713FCbFcDA05855E4F757Ee25b0F1D4bB8; //预留地址

    uint256 public _holderClaimed; //目前持有数量
