...
contract kkkkks is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 public maxLiqFee = 5;                // Transaction fee % that would be used to add liquidity (
    uint8 public maxTaxFee = 4;                // Transaction fee % that would be distributed to holders 
    uint8 public maxBurnFee = 0;               // Transaction fee % that would be burned (
    uint8 public maxWalletFee = 3;             // Transaction fee % that would be sent to a marketing and devel
    ...
    uint8 public maxBuybackFee = 12;            // Transaction fee % that would be used to buyback tokens on sell (Hyper-deflation) (0-10)
