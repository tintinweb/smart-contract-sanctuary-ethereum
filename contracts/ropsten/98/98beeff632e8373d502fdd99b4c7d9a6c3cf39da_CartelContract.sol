    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://a/";
...
contract CartelContract is CartelERC721A {
    ...
    function presale(uint256 qty) public payable {
        ...
        if(whiteList[msg.sender]){
            require(msg.value==WHITELIST_USER_PRICE,"Invalid amount");
        }else{
        require(msg.value==SALE_PRICE,"Invalid amount");
        }
    ...
    function setEvent(uint256 _salePrice,uint256 _whitelistUserPrice) public onlyOwner{
