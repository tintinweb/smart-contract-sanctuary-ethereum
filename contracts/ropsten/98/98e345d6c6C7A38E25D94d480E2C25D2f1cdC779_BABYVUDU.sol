 ...
 * allowances. See {IERC20-approve}.
 */
contract BABYVUDU is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "BabyVoodoo";
    string private _symbol = "BABYVUDU";
    uint8 private _decimals = 18;
    uint256 private _supply = 10000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 4;
    uint256 public maxTxAmount = 100 * 10**_decimals;
    uint256 public maxWalletAmount = 100 * 10**_decimals;
    address public marketingWallet = 0x0B5c955aCd6398eA68781BF295E2D9BA1D053D48;
    uint256 private _numTokensSellToAddToLiquidity = 10 * 10**_decimals;
