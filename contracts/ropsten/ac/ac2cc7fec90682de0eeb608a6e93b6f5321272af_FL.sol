...
contract FL {
    ...
    function upload(uint256 g, string calldata k, uint128 i, uint128 j) public {
        updateList[updatesCnt].gradient = g;
        updateList[updatesCnt].key = k;
        updateList[updatesCnt].i = i;
        updateList[updatesCnt].j = j;
        updatesCnt++;
    }
