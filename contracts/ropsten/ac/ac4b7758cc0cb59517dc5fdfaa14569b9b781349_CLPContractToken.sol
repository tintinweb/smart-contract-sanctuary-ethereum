 ...
 *
 */
contract CLPContractToken is StandardToken, SafeMath {

    string public name = "CLP Contract Token";
    ...
    function CLPContractToken() {
        /*
            Initialize the contract with a sane set of owners
        */
        founder = msg.sender;
        balances[msg.sender] = 32000000 * 10**decimals;
    }
