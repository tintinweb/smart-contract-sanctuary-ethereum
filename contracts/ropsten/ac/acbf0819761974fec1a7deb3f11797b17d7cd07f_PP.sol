...
contract PP is ERC20, Ownable {
    ...
    constructor() ERC20("PP", "PP") {
        ...
        uint256 totalSupply = 69420069 * 1e18;
 
        maxTransactionAmount = totalSupply * 420 / 1000; // 4.2% maxTransactionAmountTxn
        maxWallet = totalSupply * 420 / 1000; // 4.2% maxWallet
