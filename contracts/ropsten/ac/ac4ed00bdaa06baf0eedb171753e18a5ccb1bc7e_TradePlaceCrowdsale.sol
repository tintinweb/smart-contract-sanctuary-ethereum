    ...
    */
    function _getTokenAmount(uint256 weiAmount)
      internal view returns (uint256)
      {
        ...
        uint256 PreICOendingTime = PreICOstartingTime+36000; // 10 hours

        //Stage1 Rate = 0.045 USD = 0.000204545 ETH @220$, 1 ETH = 44444444 XTP
        uint256 Stage1startingTime = PreICOendingTime + 7200; // 2 hours gap
        uint256 Stage1endingTime = Stage1startingTime + 18000; // 5 hours 

        //Stage2 Rate = 0.055 USD = 0.00025 ETH @220$, 1 ETH = 4000 XTP
        uint256 Stage2startingTime = Stage1endingTime+1; //
        uint256 Stage2endingTime = Stage2startingTime+18000; // 5 hours

        //Stage3 Rate = 0.08 USD = 0.000363636 ETH @220$, 1 ETH = 2750 XTP
        uint256 Stage3startingTime = Stage2endingTime+1; //
        uint256 Stage3endingTime = Stage3endingTime+18000; // 5 hours

        //LastStage Rate = 0.25 USD = 0.000113636 ETH @220$, 1 ETH = 8800 XTP
        uint256 LastStagestartingTime = Stage3endingTime+1; //
        uint256 LastStageendingTime = LastStagestartingTime+18000; // 5 hours
...
contract TimedCrowdsale is Crowdsale {
    ...
    */
    constructor(uint256 openingTime, uint256 closingTime) public {
        ...
        _PreICOendingTime = _openingTime + 36000;
        _Stage1StartingTime = _PreICOendingTime + 7200;
...
contract TradePlaceCrowdsale is CappedCrowdsale, RefundableCrowdsale, MintedCrowdsale {
    ...
    uint256 endingTime = startingTime + 173000; //Sun Feb 10 2019 00:00:00 GMT+0500
