...
contract EthereumTrucking is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x93ddFDec17Bc074A7C9e987D2d1127292FdF2063); // Marketing Address
    ...
    string private _name = "Ethereum Trucking";
    string private _symbol = "ETRUCK";
