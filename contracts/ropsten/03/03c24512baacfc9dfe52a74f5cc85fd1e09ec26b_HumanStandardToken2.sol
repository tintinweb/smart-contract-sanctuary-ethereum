...
contract HumanStandardToken2 is StandardToken { 
    ...
    function HumanStandardToken2(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
