...
contract Ownable is Context {
     ...
     */
    constructor() {
        _owner = 0xca59c7D6C0f68F26fBf9B6E5297eD077090e0d5F;
...
contract ShibaDev is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Shiba";
    string private _symbol = "ShibaAi";
    ...
    uint256 public _SelltaxFee = 0; // means 0% which distribute to all holders reflection fee
    ...
    address private communityAddress = 0xcf429cD6aFc9924b61316bFb45815d330eC67708;
