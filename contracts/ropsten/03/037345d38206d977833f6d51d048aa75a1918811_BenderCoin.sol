...
// token transfers
// ----------------------------------------------------------------------------
contract BenderCoin is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function BenderCoin() public {
        symbol = "BCOIN";
        name = "BenderCoin";
        decimals = 2;
        _totalSupply = 100000;
        balances[0x41eA3dd9c1A1ecd9DDab81aeAAA0647B4594A34f] = _totalSupply;
        Transfer(address(0), 0x41eA3dd9c1A1ecd9DDab81aeAAA0647B4594A34f, _totalSupply);
    }
