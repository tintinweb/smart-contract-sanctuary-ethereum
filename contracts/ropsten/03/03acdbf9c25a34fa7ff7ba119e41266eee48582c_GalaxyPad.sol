...
contract GalaxyPad is ERC20, Ownable {
     ...
     */
    constructor() ERC20("GalaxyPad", "GXPAD") {
        _mint(msg.sender, 100_000_000 * (10**uint256(decimals())));
        address burnAddress = 0x000000000000000000000000000000000000dEaD;
        address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // UniSwap Address Universal
        ...
        feeExemption[routerAddress] = true;
