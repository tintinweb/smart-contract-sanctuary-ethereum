...
contract FXDBZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "FXDBZ";
    string private constant _symbol = "FXDBZ";
    ...
    address payable private _marketingAddress = payable(0xb4D4668CE0c1C9B2abEE9A69eB9bD023dF1Ff0c0);
    address payable private _devAddress = payable(0xEb8dF7ec718Bba42de203EC6C481d9Ed72D9119b);
