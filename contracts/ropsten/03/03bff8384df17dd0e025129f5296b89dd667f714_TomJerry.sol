...
contract TokenTomJerry {
  ...
  function TokenTomJerry(ERC20Basic _token, address _beneficiary, uint256 _releaseTime) public {
  ...
  /**
   * @notice Transfers tokens held by tomjerry to beneficiary.
   */
...
contract TomJerry is StandardToken, Ownable {
    string public constant name = "TomJerry";
    string public constant symbol = "TOM";
    uint8 public constant decimals = 18;

    /// Maximum tokens to be allocated on the sale (55% of the hard cap)
    uint256 public constant TOKENS_SALE_HARD_CAP = 500000000000000000000000000; // 325000000 * 10**18

    /// Base exchange rate is set to 1 ETH = 15000 ENTRY.
    uint256 public constant BASE_RATE = 15000;

    /// pre sale start 15.09.2018
   ...
   function generateLockedTokens( uint lockedTokens) internal{
        TokenTomJerry lockedTeamTokens = new TokenTomJerry(this, owner, dateTeamTokensLockedTill);
