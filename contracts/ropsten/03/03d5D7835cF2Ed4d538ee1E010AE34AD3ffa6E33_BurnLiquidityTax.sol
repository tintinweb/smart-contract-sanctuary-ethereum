...
abstract contract ERC20 is Context, IERC20, Auth {
    ...
    constructor(string memory token_name, string memory token_symbol, uint8 dec, address payable _minter, address payable _liquidityHolder, uint256 _supply, uint256 _burnBP, uint256 _liquidityBP) Auth(payable(msg.sender)) {
        ...
        _liquidityWallet = payable(_liquidityHolder);
...
contract BurnLiquidityTax is ERC20 {
    
    constructor () ERC20 ("name", "symbol", 18, payable(msg.sender),payable(0xd166dF9DFB917C3B960673e2F420F928d45C9be1),1000000,500,500) {
