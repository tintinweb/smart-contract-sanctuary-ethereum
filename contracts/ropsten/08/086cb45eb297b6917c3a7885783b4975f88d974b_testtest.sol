...
contract testtest is Context, IERC20, Ownable {
    ...
    uint256 private _sellTaxMarketing = 4;
    uint256 private _autoLpFee = 1;
    uint256 private _trueBurnFee = 2;

    uint256 private _earlySellTime = 24 * ONE_HOUR;

    uint256 private _LpPercentBase100 = 10;
    uint256 private _testPercentBase100 = 90;

	address payable private _testWallet;
	...
	constructor () {
		_testWallet = payable(0x7a11209dd1027208A886E6d2A2c3FfE763e59c2e);
    ...
    function settestWallet(address newWallet) external onlyOwner() {
        _testWallet = payable(newWallet);
    }
    ...
    function settestPercentBase100(uint256 newPercentBase100) external onlyOwner() {
        require(newPercentBase100 < 100, "Percent is too high");
        _testPercentBase100 = newPercentBase100;
    }
