...
contract Practice1 is IDataTypesPractice {
    ...
    bytes32 bytes32Variable = "Hello World! bytes...";
    ...
    string stringVariable = unicode"Hello World! 😃";
