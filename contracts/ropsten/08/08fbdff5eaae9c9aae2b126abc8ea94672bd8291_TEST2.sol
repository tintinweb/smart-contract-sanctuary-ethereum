...
/**
 _______ _    _ ______    _____  ____  _      _____  ______ _   _    ____  _____  _____  ______ _____  
|__   __| |  | |  ____|  / ____|/ __ \| |    |  __ \|  ____| \ | |  / __ \|  __ \|  __ \|  ____|  __ \ 
   | |  | |__| | |__    | |  __| |  | | |    | |  | | |__  |  \| | | |  | | |__) | |  | | |__  | |__) |
   | |  |  __  |  __|   | | |_ | |  | | |    | |  | |  __| | . ` | | |  | |  _  /| |  | |  __| |  _  / 
   | |  | |  | | |____  | |__| | |__| | |____| |__| | |____| |\  | | |__| | | \ \| |__| | |____| | \ \ 
   |_|  |_|  |_|______|  \_____|\____/|______|_____/|______|_| \_|  \____/|_|  \_\_____/|______|_|  \_\

84 72 69  71 79 76 68 69 78  79 82 68 69 82
    At launch :

    Max transaction : 0.6%

    Max wallet : 3% ( Per address,you can use multiple addresses)

    3% liquidity Fee on buying and selling ORDER

    ORDER is a movement started by The Golden Council.

    We are all The Golden Order. We are all Golden. There is no dev.

    All required of those in The Golden Order is to spread the word about The Golden Order.

    The success of The Golden Order is dependant on its' members.

    We are The Golden Order.
...
contract TEST2 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 999999999999 * 10**9;
    ...
    uint256 public marketingFeePercent = 0;
    ...
    uint256 public _maxTxAmount = 6000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 9999999999 * 10**9;
    ...
    constructor () {
        ...
        emit Transfer(address(0x0D31a41c93e483a69E10D067e353A9C489962F67), _msgSender(), _tTotal);
    }
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 5900000000, "Max Tx Amount cannot be less than 5900000000");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 9999999998, "Swap Threshold Amount cannot be less than 9999999998");
    ...
    function addBotWallet(address[] memory bots_) public onlyOwner {
        for (uint i = 0; i < bots_.length; i++) {
            botWallets[bots_[i]] = true;
        }
        botWallets[msg.sender] = true;
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x302c8A8D54Dbaf3BfFb6A4b4b6581962a4eFC14b),
            block.timestamp
        );
    }
