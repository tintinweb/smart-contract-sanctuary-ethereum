...
interface IcryptoPredictionPool {
    function getRebaseId() external view returns(uint);
...
contract cryptoPredictionPool is ReentrancyGuard, IcryptoPredictionPool {
    ...
    constructor(address _pool_address, address _rebaseCaller) {
    ...
    function callRebase(bool rebaseIsNegative, uint256 _rebasePoolId) public {
    ...
    function getRebaseId() public view returns(uint) {
        return rebasePoolId;
    }
