...
contract MyToken is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    function safeMint(address to) public payable {
        // check that totalsupply is less than MAX_SUPPLY
         require(totalSupply() < MAX_SUPPLY, "Can't mint anymore token." );
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://happyMonkeyBaseURL/";
    }
...
//  Hash Key  0x10e7d11f6397ce6e2d6c6dec4790c1659a9785e498e0ce9ba6d3fc480d73c14e

//  owner "0x5B38Da6a701c568545dCfcB03FcB875f56beddC