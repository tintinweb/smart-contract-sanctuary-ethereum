...
contract SC is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, ERC2981Upgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    uint currentTokenId;
    ...
    function initialize(string memory _contractURI) initializer public {
        ...
        wallet1 = payable(msg.sender);
        wallet2 = payable(msg.sender);
