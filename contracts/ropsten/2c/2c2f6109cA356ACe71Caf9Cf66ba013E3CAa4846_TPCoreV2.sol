...
contract TPCoreV2 is AccessControl {
    ...
    uint16 public ownerPercentage = 9950; //(this means we hold 0.5%) make sure when changing it to keep this formatting
    ...
    function unstake(uint104 amount_) public {
        ...
        uint256 stakingAmount = amount_ * userStaking[_msgSender()].amount / estimatedRewards;
        //console.log("---------stakingAmount", stakingAmount);
        uint256 profit = amount_ - stakingAmount;
        ...
        stakingcoin.safeTransfer(_msgSender(), amount_ - fee);
