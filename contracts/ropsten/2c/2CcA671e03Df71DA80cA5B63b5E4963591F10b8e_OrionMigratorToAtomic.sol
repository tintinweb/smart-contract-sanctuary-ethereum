...
contract OrionMigratorToAtomic is IOrionMigratorToAtomic, Ownable {
     ...
     */
    function initialize (address _pair, address _exchange, address _WETH9) external onlyOwner {
     ...
     */
    function migrate(uint256 tokensToMigrate, LockOrderDetails memory _lockOrderDetails0, LockOrderDetails memory _lockOrderDetails1) external override {
...
interface IExchangeWithAtomic {
    ...
    function lockAtomic(LockOrder memory swap) payable external;
...
interface IOrionMigratorToAtomic {
    ...
    function migrate(uint256 tokensToMigrate, LockOrderDetails memory _lockOrderDetails0, LockOrderDetails memory _lockOrderDetails1) external;
