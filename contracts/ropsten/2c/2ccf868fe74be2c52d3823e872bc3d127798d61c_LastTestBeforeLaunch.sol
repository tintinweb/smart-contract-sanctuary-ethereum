...
/* Contract Main */
contract LastTestBeforeLaunch is ERC20, Ownable {
    ...
    constructor() ERC20("LastTestBeforeLaunch", "$LTBL") {
		...
		charityWallet = address(0xD2CCb5B3cc095f2988892026520F806ca260f74B); // set as charity wallet
        marketingWallet = address(0xD2CCb5B3cc095f2988892026520F806ca260f74B); // set as marketing wallet
        devWallet = address(0xD2CCb5B3cc095f2988892026520F806ca260f74B); // set as dev wallet
