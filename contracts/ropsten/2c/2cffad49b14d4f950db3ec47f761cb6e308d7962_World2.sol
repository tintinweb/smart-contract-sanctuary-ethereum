...
contract World2 {
	...
	string constant public name = "World2";
	...
	// Converts the Ether accrued as dividends back into WST tokens without having to
	...
	function reinvestDividends() public {
		...
		// 25% of the total Ether sent is used to pay existing holders.
		var fee = div(value_, 25);
	...
	function sell(uint256 amount) internal {
        ...
        var fee = div(numEthersBeforeFee, 25);
