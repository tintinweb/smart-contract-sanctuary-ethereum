...
contract TIE {                   //using SafeMath for uint256;
    string public name;          //creates the name for the token 
    string public symbol;        //creates the symbol for the token  
    uint8 public decimals;       //creates the amount of decimals used 
    uint256 public totalSupply;  //it is the total supply created of the token 
	address public owner;        //it is the initial created owner of the contract wallet 
