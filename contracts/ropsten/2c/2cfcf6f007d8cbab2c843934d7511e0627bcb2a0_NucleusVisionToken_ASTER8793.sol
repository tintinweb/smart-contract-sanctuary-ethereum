...
contract NucleusVisionAllocation is Ownable {
  ...
  NucleusVisionToken_ASTER8793 public token;
  ...
  function NucleusVisionAllocation() public {
    token = new NucleusVisionToken_ASTER8793();
  }
...
contract NucleusVisionToken_ASTER8793 is MintableToken {
  string public constant name = "NucleusVision_ASTER8793";
  string public constant symbol = "ASTER8793";
  uint8 public constant decimals = 18;

  // Total supply of nCash tokens is 5 Billion
  uint256 public constant MAX_SUPPLY = 5 * 1000 * 1000 * 1000 * (10 ** uint256(decimals));
   ...
   */
  function NucleusVisionToken_ASTER8793() public {
  }
