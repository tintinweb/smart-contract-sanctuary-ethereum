...
contract Marketplace is IERC721Receiver {
    ...
    function cancelSaleOrAuction(uint256 _nftId, address _nftCollection) external {
        ...
        if (isNFTOnSale(_nftId, _nftCollection)) {
            ...
            // require(nftCollection.ownerOf(nftAuctionData[_nftId][_nftCollection].nftId) == msg.sender,"Caller is not the owner of the NFT");
...
// contract NFTCollection is IERC721Upgradeable {
//     struct NFT {
//         string name;
//         string URI;
//     }
...
//     constructor() ERC721Upgradeable("NFT Collection", "NFTC") {}
