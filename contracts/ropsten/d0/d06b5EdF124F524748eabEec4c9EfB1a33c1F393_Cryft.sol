...
contract Cryft is IERC20MetadataUpgradeable, LPSwapSupport, AntiLPSniper {
    ...
    mapping (address => uint256) public _rOwned; // TODO
    ...
    uint256 public _rCurrentExcluded; // TODO
    uint256 public _tCurrentExcluded; // TODO
...
//        uint256 initialTokenBalance = IBEP20(address(this)).balanceOf(address(this));

        // swap tokens for
        swapCurrencyForTokensUnchecked(address(this), currencyHalf, address(this));

//        // how much did we just swap into?
//        uint256 boughtTokens = IBEP20(address(this)).balanceOf(address(this)).sub(initialTokenBalance);
//
//        if(currencyOtherHalf > address(this).balance){
//            currencyOtherHalf = address(this).balance;
//        }
//
////        currencyOtherHalf = currencyOtherHalf > address(this).balance ? address(this).balance : currencyOtherHalf;
//        // add liquidity to uniswap
//        addLiquidity(0, currencyOtherHalf);
//
