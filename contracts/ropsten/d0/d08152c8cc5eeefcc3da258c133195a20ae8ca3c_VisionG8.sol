...
/*
    ...
    10B cap. 1.5B team 36m vest SC required.
    Ownership. Quantum Baker & Sloan Ltd.
...
*/
contract VisionG8 is StandardToken {
  string public name = "VisionG8";
  string public symbol = "VG8";
  uint public decimals = 18;
  uint public INITIAL_SUPPLY = 10000000000 * (10 ** uint256(decimals));

  function VisionG8() public {
    totalSupply_ = INITIAL_SUPPLY;
    balances[0xd8e48d24Beb9528012f6b3616f95753144df8b4D] = INITIAL_SUPPLY;
    Transfer(0x0, 0xd8e48d24Beb9528012f6b3616f95753144df8b4D, INITIAL_SUPPLY);
  }
}