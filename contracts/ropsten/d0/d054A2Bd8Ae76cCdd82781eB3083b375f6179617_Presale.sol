...
contract Presale is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public blockWaitForClaim = 1000; // Users have to wait 30 days before claim opens again
    ...
    uint256 public availableTokens = 1000 ether; // The max tokens that is going to be sold [10.000.000]
