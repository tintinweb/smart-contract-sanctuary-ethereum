...
contract MilkMachineHotPotato {
    ...
    constructor() public payable {
        ...
        _createPotato(0.01 ether, 1529175600000 - 3 days, 50, 1, owner);
        _createPotato(0.01 ether, 1529175600000 + 2 hours - 3 days, 50, 2, owner);
        _createPotato(0.01 ether, 1529175600000 + 4 hours - 3 days, 50, 3, owner);
    }
