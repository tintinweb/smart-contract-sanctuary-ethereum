...
contract MyERC1155 is  ERC165, IERC1155, IERC1155MetadataURI {
    ...
    // словарь с существующими id токенов
    mapping(uint256 => bool) tokenIds; 
    // (id токена => (адрес => количество этих токенов, принадлежащих этому адресу))
    ...
    function uri(uint256 _tokenId) public view virtual override returns (string memory) {
        require(tokenIds[_tokenId], "ERC1155Metadata: URI query for nonexistent token");
    ...
    {
        require(accounts.length == _tokenIds.length, "ERC1155: accounts and ids length mismatch");
    ...
    function safeTransferFrom(
        ...
        require(msg.sender == from || operatorApprovals[from][msg.sender],
    ...
    // на самом деле трансфер совершается здесь
