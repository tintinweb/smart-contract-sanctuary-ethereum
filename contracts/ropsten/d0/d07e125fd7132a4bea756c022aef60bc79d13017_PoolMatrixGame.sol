...
contract PoolMatrixGame {
    ...
    */
    ...
    constructor() {
        ...
        regFeeWallet = 0x3C94E1C74f22d23E0334716BAE213F508a7A7907;

        // Capture the creation date and time
        creationTimestamp = block.timestamp;

        // Define root users
        rootWallets.push(0x3bBa5c2540A15f70EB5edAD16b8fB4584Dc4D5A2); // Root wallet #1
        rootWallets.push(0xB910B076b73C79c1a5ac6C7bde5a81D4CCeee902); // Root wallet #2
        rootWallets.push(0x751A89adaa8d6E0f51A63E44dDD804eDCA1FFF5a); // Root wallet #3
        rootWallets.push(0xfEF80e1D7C168504D5168835e503694a9A2af007); // Root wallet #4
