...
contract Doodbeast is ERC721A, Ownable {
    ...
    uint8 public ownerAssignments;
    uint16 public maxSupply = 5555;
    uint256 public price = 0.015 ether;

    mapping(address => uint8) public _airdrops;
    mapping(address => uint8) public _freeTokensMinted;

    constructor() ERC721A("Doodbeast", "Doodbeast") {}

    function _baseURI() internal pure override returns (string memory) {
        return "Enter the base uri!";
    }
    ...
    function claimAirdrop() external {
        ...
        uint8 amount = _airdrops[msg.sender];
    ...
    function ownerAssignment(address wallet, uint8 amount) external onlyOwner {
        require(ownerAssignments + amount <= 55, "Not enough tokens to assign");
        _airdrops[wallet] += amount;
        ownerAssignments += amount;
    }

    function freeMint(uint16 amount) external {
