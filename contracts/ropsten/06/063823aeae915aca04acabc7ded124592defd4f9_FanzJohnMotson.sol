...
contract FanzJohnMotson is Ownable, ERC721A, ReentrancyGuard, Pausable {
    ...
    address public treasury = 0xFe065CDaF500d33E740c2aD2aE992071d2f3e907;
    ...
    function setStartingIndex() external onlyOwner {
        require(
            startingIndex == 0,
            "EnchantedCreaturesClub: Starting index is already set"
        );
        require(
            startingIndexBlock != 0,
            "EnchantedCreaturesClub: Starting index block must be set"
        );
        startingIndex =
    ...
    function setEmergencyStartingIndex(
        uint256 _startingIndex,
        uint256 _startingIndexBlock
    ) external onlyOwner {
