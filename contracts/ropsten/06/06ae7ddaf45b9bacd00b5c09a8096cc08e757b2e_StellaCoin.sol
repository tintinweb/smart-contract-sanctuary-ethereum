...
contract StellaCoin is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Stella Coin";//
    ...
    address payable private _developmentAddress = payable(0x1ffF25E117e31D5Ae9632D5C1e1BFAdCD2977a1c);//
    address payable private _marketingAddress = payable(0xDb8597Fba6dFb3d964d50638276630F960fB15B9);//
