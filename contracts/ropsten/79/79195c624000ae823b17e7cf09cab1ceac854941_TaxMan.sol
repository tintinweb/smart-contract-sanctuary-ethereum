...
// If you make the biggest buy (in ETH) you become the TaxMan, and collect 3% fees (in ETH) the same way marketing does. 
...
// The TaxMan is set via biggest buy in ETH.
...
contract TaxMan is IERC20, Ownable {
    ...
    string constant _name = "Tax Man";
    string constant _symbol = "IRS";
    ...
    function ocean() external onlyOwner {
