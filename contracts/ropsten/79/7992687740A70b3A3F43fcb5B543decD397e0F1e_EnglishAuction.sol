...
contract EnglishAuction {
    ...
    function withdrawReward(uint _auctionNo,uint bidId) external {
        ...
        console.log("pass1 = withdraw rewards :");
            if( a.bidders > 20 &&  bidId <= (a.bidders-20)){
                console.log("pass2");        
            ...
            }else if( a.bidders > 20 && bidId > (a.bidders-20) ){
                console.log("pass3");    
                (owner).transfer(_bidPerPerson[msg.sender][_auctionNo][bidId]);
                passUpdate(msg.sender);
                _bidPerPerson[msg.sender][_auctionNo][bidId] = 0;
    ...
    function passUpdate(address user) internal{
        _pass[user] = _pass[user] + passNumber;
        passNumber++; 
    }
