...
contract LinearVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
        ...
        returns(uint256, uint256, uint256)
    {
        ...
        totalRewardsLocked = totalRewardsLocked.div(1e18);
        uint256 _totalWithdrawn = totalWithdrawn.div(1e18);
        return (totalRewardsLocked, totalRewardsUnlocked, _totalWithdrawn);
    }
