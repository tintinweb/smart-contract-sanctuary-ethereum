...
contract TestVeryCoin2 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SuperUltraPowerCoin() {
        ...
        name = "TestVeryCoin2";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TVC";                                             // Set the symbol for display purposes (CHANGE THIS)
