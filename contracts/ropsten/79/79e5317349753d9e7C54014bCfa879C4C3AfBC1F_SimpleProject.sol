...
// ____   _                    _         ____                  _              _   
/// ___| (_) _ __ ___   _ __  | |  ___  |  _ \  _ __   ___    (_)  ___   ___ | |_ 
//\___ \ | || '_ ` _ \ | '_ \ | | / _ \ | |_) || '__| / _ \   | | / _ \ / __|| __|
// ___) || || | | | | || |_) || ||  __/ |  __/ | |   | (_) |  | ||  __/| (__ | |_ 
//|____/ |_||_| |_| |_|| .__/ |_| \___| |_|    |_|    \___/  _/ | \___| \___| \__|
//                     |_|                                  |__/
//
...
contract SimpleProject is ERC1155Burnable, Ownable, IERC2981 {
    using Strings for uint256;

    string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/771/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/771/contract-uri";

    uint256 public royaltyBps = 2;
    ...
    function adminMint(address to, uint id, uint qty) external onlyOwner {		
		_mint(to, id, qty, "");
	}
