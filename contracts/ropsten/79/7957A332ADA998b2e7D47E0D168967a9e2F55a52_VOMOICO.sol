...
//buy
    ...
    balance[owner1] = PRESALE_TOKEN_SOFT_CAP;
    require(msg.value != 0);
    ...
    Transfer(owner1, _buyer,  newTokens);
...
/// @param _owner Address of token owner.
 ...
 function redeem(address _buyer, uint numTokens) payable {  
    ...
    balSoftcap = balance[msg.sender];
    if(refbal>0){
        require(_buyer.send(refbal));
        balance[_buyer]=this.balance + refbal;
    }
