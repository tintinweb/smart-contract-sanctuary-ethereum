...
contract NFTV1 is ERC2981, ERC721Tradable, Mintable {
    ...
    mapping(uint256 => cardinfoArry) public _cardinfoArry;
    ...
    function _createCard(
        ...
        _cardinfoArry[tokenId] = cardinfoArry(
            name,
            uri,
            cost,
            grade,
    ...
    // ======== CardIfo =========
    function cardInfo(uint256 tokenId)
        public
        view
        returns (
            string memory name,
    ...
    {
        return (
            _cardinfoArry[tokenId].name,
            _cardinfoArry[tokenId].uri,
            _cardinfoArry[tokenId].cost,
            _cardinfoArry[tokenId].grade,
            _cardinfoArry[tokenId].atk,
            _cardinfoArry[tokenId].hp,
            _cardinfoArry[tokenId].speed
        );
    }
