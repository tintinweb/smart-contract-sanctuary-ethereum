...
contract Token{
    ...
    /// to keep track of approved balances and allowances 
    mapping(address => uint256) public balanceOf;
    mapping(address => mapping(address => uint256)) public allowance;


    // Events - to be fired on state changes etc
   ...
   function transerFrom(address _from, address _to, uint256 _value) external returns(bool) {
