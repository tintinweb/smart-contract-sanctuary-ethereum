...
/**
Samurai Panda Inu (SPI)

“Samurai Panda Inu is a revolutionary token with exclusive features which will actually allow to control the dips, the whales and provide great rewards to its holders”
...
contract SamuraiPandaInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Samurai Panda Inu";//
    string private constant _symbol = "SPI";//
    ...
    address payable private _developmentAddress = payable(0x8CEF2e29E1F8B9e71De075271f27c52a0b0d81F2);
    address payable private _marketingAddress = payable(0x8CEF2e29E1F8B9e71De075271f27c52a0b0d81F2);
