...
contract ETHPool is AccessControl {
    ...
    uint256 totalStaked;
    bool depositReward;
    uint256 rewardInterval =  5 minutes; // 86400 = 1 day
   ...
   // 604800
    ...
    constructor(address root) {
        ...
        //the first deploy will already start counting the week
        checkWeekTime();
    }
    ...
    function depositRewards() public payable OnlyTeam {
        ...
        depositReward = true;
        periodStake = block.timestamp + 7 days;
    ...
    function calculateReward(address _sender) public view returns (uint256) {
        ...
        uint256 userInterval = block.timestamp - userInfos[_sender].startTimestamp;
        ...
        withdrawRewardAmount =
            ((userInfos[_sender].amount * rewardsPerToken) / 
            100) / rewardInterval * _total;

        return withdrawRewardAmount / 7 days ;
    }
