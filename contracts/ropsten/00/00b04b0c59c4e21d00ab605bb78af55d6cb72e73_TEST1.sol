...
contract TEST1 is Context, IERC20, Ownable {
    ...
    uint256 public _swapTokensAtAmount = 10 * 10**18; //0.1%
    ...
    constructor() {
        _feeAddrWallet1 = payable(address(this));
        _feeAddrWallet2 = payable(address(this));
    ...
    function openTrading() external onlyOwner {
        ...
        // .5% 
        _maxTxAmount = 101 * 10**18;
        _maxWalletAmount = 201 * 10**18;
        tradingOpen = true;
