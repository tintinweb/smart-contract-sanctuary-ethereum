...
contract GoldPot is Context, IERC20 {
    ...
    string private _name = "Gold Pot";
    string private _symbol = "GDP";

    uint256 public _buyFee = 1200;                    //12%
    uint256 public _sellFee = 1200;                   //12%
    uint256 public _transferFee = 1200;               //12%

    uint256 constant public maxBuyTaxes = 5000;        //50%
    uint256 constant public maxSellTaxes = 9000;       //90%
    uint256 constant public maxTransferTaxes = 5000;   //50%
    ...
    address payable private _marketingWallet = payable(0xbc73fFc98479Fc4386dAC43DBee46bA6C9580456);
    address payable private _teamWallet = payable(0xbc73fFc98479Fc4386dAC43DBee46bA6C9580456);
