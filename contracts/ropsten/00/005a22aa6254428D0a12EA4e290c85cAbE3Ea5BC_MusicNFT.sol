    ...
    ERC721EnumerableUpgradeable
{
    ...
    modifier onlyPresaleMintable() {
        ...
        require(
            _maxTracks > 0
                ? totalSupply().add(_tracksPerAlbum) <= _maxTracks
                : true,
            "MAX_PRESALE_EXCEEDED"
        );
        require(
            _mintedTracks[_msgSender()].add(_tracksPerAlbum) <= _maxPerWallet,
    ...
    */
    ...
    function setTreasury(address newTreaasury_) public onlyOwner {
    ...
    function startPresale(
        ...
        uint256 maxAlbumsPerTx_,
        uint256 newPrice_,
        uint256 presaleStartDate_,
        uint256 presaleEndDate_
    ) public onlyOwner {
        require(!_presaleActive, "PRESALE_ALREADY_ACTIVE");
        require(!_saleActive, "SALE_IS_ACTIVE");
        require(presaleStartDate_ < presaleEndDate_, "PRESALE_START_AFTER_END");
        require(presaleStartDate_ > block.timestamp, "PRESALE_START_IN_PAST");
        ...
        _maxAlbumsPerTx = maxAlbumsPerTx_;
        _price = newPrice_;
        _presaleStart = presaleStartDate_;
        _presaleEnd = presaleEndDate_;
        _presaleActive = true;
        _saleActive = false;
    }
    ...
    */
    ...
    // mint album in sale
    function mint(uint256 albums_) public payable onlySaleMintable {
        _mintAlbum(_msgSender(), albums_);
    }
