...
/*
        ...
        Telegram: https://t.me/Akira_Inu
        Website: https://www.akira-inu.com/
        Twitter: https://twitter.com/Akirainueth
...
contract Shinjurai is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xd152Bc35722Ef6F67626D004CD8B1aF9A05bB754); // Marketing Address

    address payable public liquidityAddress =
        payable(0xd152Bc35722Ef6F67626D004CD8B1aF9A05bB754); // Liquidity Address
    ...
    uint256 private constant _tTotal = 69 * 1e21 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Shinjurai";
    string private constant _symbol = "SHINJURAI";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 5 / 1000; // 0.5% max txn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05%
        maxWallet = _tTotal * 9 / 1000; // 0.1% 
