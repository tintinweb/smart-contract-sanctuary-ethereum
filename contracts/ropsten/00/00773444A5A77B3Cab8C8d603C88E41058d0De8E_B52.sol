...
contract B52 is IERC20, Auth {
	string constant _name = "Bo52";
	string constant _symbol = "B52";
	...
	function _openTrading() internal {
		_humanBlock = block.number + 6; // end sniper protections 6 blocks after adding liquidity
