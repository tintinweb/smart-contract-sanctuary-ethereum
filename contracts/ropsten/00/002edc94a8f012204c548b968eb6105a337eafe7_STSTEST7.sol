...
contract STSTEST7 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function STSTEST7() {
        ...
        name = "STSTEST7";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "STSTEST7";                                             // Set the symbol for display purposes (CHANGE THIS)
