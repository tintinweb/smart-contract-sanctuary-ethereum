...
contract LinkRoadToken is ERC20, Ownable {
    uint256 public constant MAX_SUPPLY = 200_000_000 ether;
    uint256 public constant RESERVED_FOR_POOL_SUPPLY = 100_000_000 ether;
    uint256 public constant V_GIFT_SUPPLY = 1_000_000 ether;
    uint256 public constant HOLDER_SUPPLY = 99_000_000 ether;

    address public constant V_ADDRESS = 0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045;
    address public constant ECOSYSTEM_ADDRESS = 0x55b56DF5Bd075aD0f00Fd65638c89E6F30f882F5;

    uint256 public _holderClaimed;
    address public _claimer;

    constructor() ERC20("LinkRoad", "LINK") {
    ...
    function holderClaim(address holder, uint256 amount) external {
        require(_claimer == msg.sender, "LinkRoad: Not Claimer");
        require(_holderClaimed + amount <= HOLDER_SUPPLY, "LinkRoad: Exceed supply");
