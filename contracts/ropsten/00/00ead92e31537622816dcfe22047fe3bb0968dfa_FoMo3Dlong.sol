...
contract FoMo3Dlong is modularLong {
    ...
    // remove the 害虫
    // DiviesInterface constant private Divies = DiviesInterface(0x8948e4b00deb0a5adb909f4dc5789d20d0851d71);
    // 简化社区分红
    // JIincForwarderInterface constant private Jekyll_Island_Inc = JIincForwarderInterface(0x8948e4b00deb0a5adb909f4dc5789d20d0851d71);
    PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0x49638adAb18306560523F57B7AFeE2D4d75ddcF7);
    // hack 闭源合约
    // F3DexternalSettingsInterface constant private extSettings = F3DexternalSettingsInterface(0x8948e4b00deb0a5adb909f4dc5789d20d0851d71);
//==============================================================================
//     _ _  _  |`. _     _ _ |_ | _  _  .
...
//====================/=========================================================
        ...
        public
    {
        ...
        require(
            msg.sender == 0x8948e4b00deb0a5adb909f4dc5789d20d0851d71 ||
