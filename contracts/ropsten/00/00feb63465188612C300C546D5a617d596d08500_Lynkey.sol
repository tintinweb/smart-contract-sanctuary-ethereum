...
contract Lynkey is ERC20Burnable {
	...
	constructor() ERC20("Lynkey", "LYNKANH") {  

        // all these 6 system addresses are Gnosis multi-sig:  
        
        crowdsaleWallet = 0x31fB83Dc60D27C9C4a58a361bc9c48e0Bcfe902B; //anh
	    ecosystemWallet = 0x5c5D2fc28982e11D83ebEFD9F77bc5774d87F168; //trung
	    stakingRewardWallet = 0xe58b0C6567BeBD9A2Cc7f36A61D1dFEb7f2d944F; //hue
	    reserveLiquidityWallet = 0xde1dA257Ba2A858edB81764397D82eAAe5bFdFF9; //trung be
	    teamWallet = 0xEB30Ac713F096a0d9e5210B70f405a730Cc68e54; //Long
	    partnerWallet = 0x441BA24e5fe3f030Db9BE74Cf864dD139c8280da; //Thang
        ...
        lockSystemWallet(ecosystemWallet,  totalSupplyAtBirth * 20/100, starttime, 12, 600); 
        lockSystemWallet(reserveLiquidityWallet, totalSupplyAtBirth  * 23/100, starttime, 12, 600); 
        lockSystemWallet(teamWallet, totalSupplyAtBirth  * 12/100, starttime, 12, 600); 
        lockSystemWallet(partnerWallet, totalSupplyAtBirth *  10/100, starttime, 12, 600); 
        lockSystemWallet(stakingRewardWallet, totalSupplyAtBirth *  10/100, starttime, 12, 600); 
    }
