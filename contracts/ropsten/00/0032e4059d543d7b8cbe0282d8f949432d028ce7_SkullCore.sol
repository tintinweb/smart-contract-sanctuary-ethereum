...
/// @author Dieter Shirley <<a href=/cdn-cgi/l/email-protection class=__cf_email__ data-cfemail=660203120326071e0f090b1c0308480509>[email&#160;protected]</a>> (https://github.com/dete)
...
contract SkullCore is SkullAuction {
    ...
    event Mint(address _to, uint256 attack, uint256 defend, uint256 rank, uint256 _tokenId, string _tokenURL);
    ...
    function mint(address _to, uint256 _attack, uint256 _defend, uint256 _rank, uint256 _genes, string _tokenURI) public whenNotPaused onlyAdministrator returns (uint256 tokenId) {
        ...
        emit Mint(_to, _attack, _defend, _rank, tokenId, _tokenURI);
    }
