...
contract Sale {
    ...
    function contribute(bytes32 referralCode) external payable {
        buy(referralCode);
    }
    ...
    function becomeRenown() public payable {
        ...
        renownedPlayers[msg.sender].referralCode = keccak256(abi.encodePacked(totalPariticpants));
    ...
    function buy(bytes32 referralCode) internal {
