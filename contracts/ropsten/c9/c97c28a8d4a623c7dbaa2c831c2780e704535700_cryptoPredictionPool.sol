...
interface IcryptoPredictionPool {
    ...
    function callRebase(bool _rebaseIsPositive, uint256 _rebasePoolId) external;
    ...
    function fetchRebasePool(uint _RebasePoolId) external view returns( uint _NumberOfOccurances, uint _numberOfPositiveDates, uint _createdTime, uint _endingTime);
