...
import { iNVM_L1CrossDomainMessenger } from
    "../../../iNVM/bridge/messaging/iNVM_L1CrossDomainMessenger.sol";
import { Lib_NVMCodec } from
    "../../../libraries/codec/Lib_NVMCodec.sol";

interface iNVM_L1MultiMessageRelayer {
    ...
    struct L2ToL1Message {
        ...
        Lib_NVMCodec.Transaction ovmTransaction;
        Lib_NVMCodec.Receipt receipt;
        iNVM_L1CrossDomainMessenger.L2MessageInclusionProof proof;
    }
