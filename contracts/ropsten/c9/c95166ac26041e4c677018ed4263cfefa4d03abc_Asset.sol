...
// File: src\contracts\IMintable.sol
...
// File: src\contracts\utils\Bytes.sol
...
// File: src\contracts\utils\Minting.sol
...
// File: src\contracts\Mintable.sol
...
contract Asset is ERC721, Mintable {
    ...
    function withdrawToken(uint256 amount) external onlyOwner {
        require(amount > 0, "Amount is larger than Zero.");
        require(amount < balance, "You can only less than deposited amount");
