...
contract SheepionWL is ERC1155, Ownable {
  ...
  uint256 private boosterMintFee = 0.2 ether;
  uint256 private battleMintFee = 0.3 ether;
  uint256 private herdMintFee = 0.6 ether;

  address payable constant public walletMaster = payable(0x46Ff2267F2302acD2DE594Ae668E2f50Fc19D139);
  address payable constant public walletDev = payable(0x52BD82C6B851AdAC6A77BC0F9520e5A062CD9a78);
  ...
  constructor(
    ...
    name = "Sheepion Whitelist Token";
    symbol = "SHEEPIONWLTOKEN";
  }
