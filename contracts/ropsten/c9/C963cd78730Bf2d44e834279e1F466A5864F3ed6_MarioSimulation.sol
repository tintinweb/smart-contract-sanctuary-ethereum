...
contract MarioSimulation is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = 210000 * 10**_decimals;
    uint256 public maxWalletAmount = 210000 * 10**_decimals;
    address public marketingWallet = 0x9f556c7F9Ba4569EA39e28C152d3E18F24fD8ba1;
    ...
    uint256 public _numTokensSellToAddToLiquidity = 20000 * 10**_decimals;
    uint256 public _numTokensSellToAddToETH = 10000 * 10**_decimals;
    ...
    function setNumTokensSell(uint256 _numTokenSell) external onlyOwner {
        _numTokensSellToAddToETH = _numTokenSell * 10**_decimals;
        _numTokensSellToAddToLiquidity = _numTokenSell * 2 * 10**_decimals;
    }
