...
contract FuckDev1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Dev2";
    ...
    uint256 public _burnFee = 100; // means 2% 
    ...
    uint256 public _SellBurnFee = 200; // means 6% 
    ...
    uint256 public _maxWalletToken = 2000e9;
