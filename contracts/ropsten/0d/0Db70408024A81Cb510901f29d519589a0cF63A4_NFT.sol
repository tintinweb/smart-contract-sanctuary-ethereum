...
contract NFT is ERC721URIStorage, Ownable {
  ...
  constructor(address marketplaceAddress, address _WETH) ERC721("Straym Collections", "SCS") {
  ...
  function acceptOfferItem(
    ...
    _setApprovalForAll(msg.sender, contractAddress, true); //grant transaction permission to marketplace
    // setApprovalForAll(address(this), true); //grant transaction permission to marketplace
    ...
    _setApprovalForAll(signer, contractAddress, true); //grant transaction permission to marketplace
