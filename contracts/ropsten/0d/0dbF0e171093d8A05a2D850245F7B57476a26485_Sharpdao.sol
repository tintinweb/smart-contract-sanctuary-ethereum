...
// Holders most create the Telegram group with this name @sharp_dao
// Twitter some thing like shrap dao lol :)
...
contract Sharpdao is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xa7fF42c2Cb3F82Cb726Ba9aAfc0bffA32eE7301B;
    ...
    string private _name = "SHARP DAO.V3";
    string private _symbol = "SHRP.v3";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _tax = 20;
