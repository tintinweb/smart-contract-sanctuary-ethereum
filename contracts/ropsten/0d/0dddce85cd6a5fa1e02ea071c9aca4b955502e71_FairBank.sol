...
contract FairBank is ERC721{
     ...
     */ 
    FairBankCompute constant private bankCompute = FairBankCompute(0xc62b40882A1B794cA46fdEc4Ebc20247Dc3E1a7b);
                    ...
                    if(round[_goods.rId].endSid > _startSid.add(_goods.stepSize)){
                        ...
                        /*if(round[_goods.rId].endSid == _goods.endSid){
                            _amount = _amount.add(
                                _goods.endAmount.mul(getRoundJackpot(_goods.rId))
                                .div(stage[_goods.rId][_goods.endSid].amount)
                                .sub(_goods.endAmount.mul(_goods.protectRatio.mul(88)) / 1000)
                            );
                        }*/
        ...
        returns(uint256, uint256, uint256, uint256, uint256, uint256)
    {
        ...
        return
            (
                ...
                (stage[rId][sId].dividendAmount <= _targetExpectedAmount ? _targetExpectedAmount : stage[rId][sId].dividendAmount).mul(100) / 88,
