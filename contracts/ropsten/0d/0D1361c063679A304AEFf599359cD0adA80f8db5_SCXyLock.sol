...
contract SCXyLock is ISCXyLock {
    using Address for address payable;
    using EnumerableSet for EnumerableSet.AddressSet;
    using EnumerableSet for EnumerableSet.UintSet;
    using SafeERC20 for IERC20;
    uint256 unlockTimerSeconds = 30 * 24 * 3600; // 30 days expressed in seconds
    uint256 testUnlockTimerSeconds = 120; // 2 mins expressed in seconds
    uint256 minimumPayableEthInWei = 1 * 10**18;
    uint256 minimumSCXHolding = 10000000 * 10 * 9;
    ...
    function perpLock(
        ...
        uint256 unlockDate = block.timestamp + testUnlockTimerSeconds;
        id = _createLock(
            owner,
            token,
            isLpToken,
    ...
    function startPerpUnlock(uint256 lockId) external validLock(lockId) {
        ...
        userLock.tgeDate = block.timestamp + testUnlockTimerSeconds;
