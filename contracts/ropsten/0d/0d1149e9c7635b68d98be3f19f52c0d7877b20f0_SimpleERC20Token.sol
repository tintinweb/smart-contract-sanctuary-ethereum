...
contract SimpleERC20Token is owned {
  ...
  uint256 public token_price_wei   = (uint256(10) ** 18) * token_price_eurcent / eth_price_eurcent;
  ...
  function () public payable {
    // FIXME: check that eth are sent back when paused
    require(started);
    uint256 equivalent_tokens = msg.value.mul(token_price_wei);
