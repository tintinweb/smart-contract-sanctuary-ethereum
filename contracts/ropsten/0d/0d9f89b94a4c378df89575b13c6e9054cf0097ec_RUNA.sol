...
contract RUNA is Context, IERC20, Ownable {
    ...
    string private constant _name = "RUNA";
    string private constant _symbol = "RED LUNA";
    ...
    address payable private _marketingAddress = payable(0x2eBe5D3Dcf4619f68D731A1ae3B9C4e857c744f5);
    ...
    uint256 public _swapTokensAtAmount = 300000000 * 10**9; //0.3
