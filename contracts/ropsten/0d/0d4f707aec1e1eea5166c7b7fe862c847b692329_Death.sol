...
contract Death is Context, IERC20, Ownable {
    ...
    string private constant _name = "Death";
    string private constant _symbol = "$DEATH";
    ...
    uint256 private _maxTxAmount = 200_000 * 10**18;
    uint256 private _maxWalletSize = 300_000 * 10**18;
