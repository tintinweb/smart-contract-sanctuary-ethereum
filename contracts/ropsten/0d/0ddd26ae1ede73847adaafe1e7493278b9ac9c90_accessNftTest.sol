 ...
 */
 ...
 contract accessNftTest is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, ERC2981PerTokenRoyalties {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("accessNftTest", "accessNftTest") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x6248CfaBE04B55a327eAD71b79b34EA0DdE263E1);
          _setupRole(MINTER_ROLE, 0x6248CfaBE04B55a327eAD71b79b34EA0DdE263E1);
          _setupRole(MINTER_ADMIN_ROLE, 0x6248CfaBE04B55a327eAD71b79b34EA0DdE263E1);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x6248CfaBE04B55a327eAD71b79b34EA0DdE263E1);
     }
     ...
     function setBaseRoyalty (address recipient, uint256 percent, uint256 amount) public {
         require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "accessNftTest/minter-role-required");
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "accessNftTest/minter-role-required");
         _mint(to, tokenId);
