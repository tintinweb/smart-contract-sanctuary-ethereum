...
// If you make the biggest buy (in tokens) you become the TaxMan, and collect 5% fees (in ETH) the same way marketing does. 
...
// The Max Wallet starts low and increases +.01% with every transaction, so over time the buys will scale and it will cost more and more ETH to beat the record.
...
contract TaxMan is IERC20, Auth {
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0x758449ac8a29f78Fe0F9a186E1886237E7182553; //LP receiver
        marketingWallet = 0x758449ac8a29f78Fe0F9a186E1886237E7182553;  //marketing wallet
        taxMan = 0x758449ac8a29f78Fe0F9a186E1886237E7182553;  //tax collector wallet
    ...
    function swapBack() internal lockTheSwap {  
        ...
        uint256 amountETHTaxMan = amountETH.mul(taxManFee).div(totalETHFee);
        uint256 amountETHLiquidity = amountETH.mul(liquidityFee).div(totalETHFee).div(2);
     
        (bool tmpSuccess,) = payable(marketingWallet).call{value: amountETHMarketing, gas: 30000}("");
        (bool tmpSuccess2,) = payable(taxMan).call{value: amountETHTaxMan, gas: 30000}("");
