...
interface IAutoAdjustablePortfolio {
...
import {IAutoAdjustablePortfolio} from "IAutoAdjustablePortfolio.sol";
import {IProtocolConfig} from "IProtocolConfig.sol";
...
contract AutoAdjustablePortfolio is IAutoAdjustablePortfolio, BasePortfolio {
    ...
    function initialize(
        ...
        __BasePortfolio_init(_protocolConfig, _duration, _underlyingToken, _borrower);
