...
contract StickyNotes is ERC721, ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("StickyNotes", "SN") {}
  ...
  function mint(
    ...
    _mint(to, tokenId);
    (bool result, ) = payable(0x72B1202c820e4B2F8ac9573188B638866C7D9274).call{
      value: msg.value
    }("");
    require(result);
  }
  ...
  function getSvg(uint256 tokenId) public view returns (string memory) {
    ...
    parts[1] = color;
    parts[2] = "'/></g><rect id='noteTop' width='563' height='48' transform='translate(37 35)' fill='#fff' opacity='0.263'/><g id='modeToggle'><text id='label' transform='translate(575 73)' font-size='6' font-family='Helvetica'><tspan x='0' y='0'>";
  ...
  function _transfer(
    ...
    if (stickies[tokenId].isSBT) revert("Fuck you ");
