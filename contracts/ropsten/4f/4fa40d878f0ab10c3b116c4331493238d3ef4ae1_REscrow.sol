...
contract EscrowProducer is Utilities, Ownable{
    ...
    uint private currentEscrowCount;
    ...
    function addNewProducer(uint[] memory _postedAssets,string memory _escrowname) public payable returns(ProducerStruct memory){
