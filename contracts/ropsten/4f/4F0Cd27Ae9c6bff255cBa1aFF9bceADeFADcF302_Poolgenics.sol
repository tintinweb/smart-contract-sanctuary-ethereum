...
//Poolgenics.sol
contract Poolgenics is Context, IERC20, Ownable {
    ...
    string constant private _name = "Poolgenics";
    string constant private _symbol = "PLGN";
    ...
    address payable public marketingAddress = payable(0x553f351228FDc76894DDdDA3C61a87C96b136Fa7);
    address payable public developmentAddress = payable(0x553f351228FDc76894DDdDA3C61a87C96b136Fa7);
  
    uint256 public _maxBuyTxAmount = 10000000 * 10**18;
        uint256 public _maxSellTxAmount = 1000000 * 10**18;
