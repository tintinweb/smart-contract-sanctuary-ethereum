...
contract SmatContac is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Smat Contac";                                           // name
    string private _symbol = "SMAT";                                            // symbol
    ...
    uint256 public defaultTeamFee = 8;
    uint256 public _teamFee = defaultTeamFee;
    uint256 private _previousTeamFee = _teamFee;

    uint256 public _teamFee4Sellers = 8;
    ...
    address payable public teamWallet = payable(0x43EB13ae0A2258C65cCe719EC63d7640BBB2e976);
