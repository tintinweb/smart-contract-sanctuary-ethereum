...
contract BurgerNFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("BurgerNFT", "CHILD") {}
...
contract Deployer {
  function deployChild() external {
    Create3.create3(keccak256(bytes("1357924680")), type(BurgerNFT).creationCode);
  }
}
