...
/**
 * @title Immutable Mintable
 *
 * @notice Generic contract compatible with IMX (ImmutableMintableERC721) to be inherited by
 *      - IlluvitarERC721
 *      - AccessoryERC721
 *      - D1skERC721
 *
 * @notice Illuvitars are Avatars for Illuvium
 * @notice Accessories enrich Illuvitars' look and feel
 * @notice D1sks are loot boxes containing Illuvitar(s) and/or Accessory(ies)
 *
 * @notice D1sks can be burnt on L2 by sending a request to Illuvium's backend to mint
 *      Illuvitars and Accessories
 *
 * @notice Basic D1sks will return 1 random Illuvitar, 3 random Accessories (plus a tier 0) when opened.
 * @notice Ultra D1sks will return 1 random Illuvitar, 4 random Accessories (plus a higher tier), including
 *  at least one rare NFT, when opened
 *
