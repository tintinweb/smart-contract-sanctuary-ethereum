...
// File: contracts/SaitermSale.sol
...
contract SaitermCrowdsale is TimedCrowdsale {
  ...
  function createTokenContract() internal returns (StandardToken) {
    ...
    // Part of supply will be assigned to the crowdsale contract, and part to owner
    return new SaitermToken(totalSupply, tokenSaleSupply, ownerSupply, msg.sender);
  }

  struct Bonus {
        // UNIX timestamp/amount for bonus
        uint timeOrAmount;
  ...
  // @dev Contruction, creating a list of bonuses
