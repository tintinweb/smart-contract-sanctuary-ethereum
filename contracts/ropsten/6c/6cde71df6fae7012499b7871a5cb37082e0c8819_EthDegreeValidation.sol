...
contract EthDegreeValidation {
    ...
    constructor() public {
        owner = msg.sender;
        //change so that pendingOwner != 0x0
        ...
        //DegreeOwnership storage degree = degrees[0x0];
        //degree.name = "Invalid Hash";
        //degree.date = block.timestamp;
        //sha256HashesOfDegrees.push(0x0);
        //emit DegreeAdded(0x0, msg.sender);
    }
