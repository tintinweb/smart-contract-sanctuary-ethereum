...
abstract contract MaxWalletDynamic {
    ...
    uint256 constant maxBuyIncrementPercentil = 3; // increment maxbuy percentile 1000=100%
...
// File: contracts/TEST_2.sol

pragma solidity ^0.8.7;



contract TEST_2 is TradableErc20, Withdrawable {
    constructor()
        TradableErc20("TEST2 TESTNAME", "t2SYMB")
