 ...
 */
contract MetaTopeAuction is MetaTopeIERC1155Receiver, Auth(msg.sender, Authority(address(0))) {
     ...
     */
    function claim(address[] memory _bidders) external requiresAuth onlyEnded {
     ...
     */
    function end() external requiresAuth onlyStarted {
     ...
     */
    function setLowestPrice(uint256 _lowestPrice) external requiresAuth onlyEnded {
     ...
     */
    function withdraw() external requiresAuth onlyEnded {
