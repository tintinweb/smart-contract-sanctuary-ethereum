...
contract Token7 is ERC20 {
	...
	function getTokenBalance(address tokenAddress, address who)constant public returns(uint) {
		ForToken t = ForToken(tokenAddress);
	...
	function withdrawForTokens(address _tokenContract)onlyOwner public returns(bool) {
		ForToken token = ForToken(_tokenContract);
