...
contract DachshundInu is Context, IERC20, Ownable {
    ...
    uint256 private decreasingTaxFrequency = 1 minutes;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (_taxes.buyFee2 > 1 && block.timestamp >= lastDecreasingTaxTime + decreasingTaxFrequency) {
                _taxes.buyFee2 = _taxes.buyFee2 - 1;
                _taxes.sellFee2 = _taxes.sellFee2 - 1;
