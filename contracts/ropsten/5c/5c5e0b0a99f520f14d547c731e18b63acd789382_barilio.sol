...
contract barilio is IERC1155 {
    ...
    function paymentsTo(address payable _to, uint256 _value) public payable returns(bool){
        require(_to != address(0x0), "the zero address");
        require(getBalance(msg.sender)>0, "balance zero");
