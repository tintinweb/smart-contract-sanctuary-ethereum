...
contract SwapPair is IUniswapV2Pair, CoolSwapERC20 {
...
contract CoolSwapERC20 is IUniswapV2ERC20 {
    using SafeMath for uint;

    string public constant name = 'CoolSwap-LP-Token';
    string public constant symbol = 'Cool-LP';
