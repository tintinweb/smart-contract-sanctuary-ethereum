...
contract DBSNFTLootBox is ReentrancyGuard, AccessControl, Ownable{
    ...
    // event
    event newLoopBox(uint256 _Id, uint256 _amount);
     ...
     */
    function listBox(uint256 _id, uint256 _amount, string memory _name, string memory _image, string memory _description) public onlyOwner{
     ...
     * @param _amount box amount
     */
    function addSupply(uint256 _id, uint256 _amount) public onlyRole(MINTER_ROLE){
        require(_id > 0 && _amount > 0, "DBSNFTLootBox: listbox param failed");
        ...
        emit addLoopBox(_id, launched[_id].supply);
    }
