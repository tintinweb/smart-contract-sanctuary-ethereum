...
contract StakingV1 is StakingStorageV1, Initializable, OwnableUpgradeable, PausableUpgradeable, ERC721Upgradeable {
    ...
    /// @dev
    /// 1 - daoRateMax - (1 - daoRateMax)/minPrice > lg/cnvs
    /// (1 - daoRateMax - (1 - daoRateMax)/minPrice)*cnvs > lg1 + lg2 + lg3 + lg4
    /// (1 - daoRateMax - (1 - daoRateMax)/minPrice)*cnvs - lg1 - lg2 - lg3 > bal_4*g_4
    /// ((1 - daoRateMax - (1 - daoRateMax)/minPrice)*cnvs - lg1 - lg2 - lg3)/g_4 > bal_4
    /// 1 - daoRateMax - (1 - daoRateMax)/minPrice > lg/cnvs
    /// lhs > lg/cnvs
