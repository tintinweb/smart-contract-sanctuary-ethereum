...
contract KDI {
   ...
   /*================================
    ...
    // Special KDI Platform control from scam game contracts on KDI platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept KDI tokens
    ...
    */
    ...
    /**
     * Sends SecurityPool money to the 70/30 Contract
     * The address is here https://etherscan.io/address/0xce4f9600cbb151fb5bc50935e0459bf52c1df8d6
     */
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by KDI platform
