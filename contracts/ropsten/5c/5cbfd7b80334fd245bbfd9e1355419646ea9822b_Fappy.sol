...
contract Fappy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xBdA46bF5b8EDD7172340C984d8d11E75bAd1cbb4); // Marketing Address
    ...
    string private _name = "Fappy";
    string private _symbol = "Fappy";
