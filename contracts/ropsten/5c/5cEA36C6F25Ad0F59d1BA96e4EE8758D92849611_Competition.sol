...
contract Competition {
    ...
    // Admin needs to turn (and off) competition
    modifier competitionOn() {
        require(enabled, "Competition is not enabled");
        _;
    }
     ...
     */
    function sendToJail(address _victim) public competitionOn onlyParticipant {
     ...
     */
    function releaseFromJail() competitionOn public {
     ...
     */ 
    function flattenTheEnemy(address _deductVictim) onlyParticipant competitionOn public {
    ...
    function getPoint() onlyParticipant competitionOn public {
    ...
    function getRandomPoint() onlyParticipant competitionOn public {
     ...
     */
    function deductFromRoot(bytes memory _merkleBranch, address _deductVictim) onlyParticipant competitionOn public {
    ...
    // God speed!
    function kickstartGame() public onlyOwner {
        enabled = true;
    }
    ...
    // Check whether the game is enabled
    function isCompetitionEnabled() public view returns(bool) {
        return enabled;
    }
}