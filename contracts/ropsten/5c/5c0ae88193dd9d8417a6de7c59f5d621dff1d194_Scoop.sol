      ...
      (_.--._.-._)
        \=-=-=-/
         \=-=-/
          \=-/
           \/
Inside Scoop - Class of 2022 OG Gift
@0xBirkin on Twitter
discord.gg/scoop on Discord
------------------------------------------------ 
*/
...
contract Scoop is ERC721Burnable, Ownable {
    ...
    uint8 public maxTx = 1;
    uint256 public maxSupply = 1000;
    uint256 public price = 0 ether;
    
    bool public scoopPresaleOpen = true;
    bool public scoopMainsaleOpen = false;
    ...
    constructor(string memory _initBaseURI) ERC721("InsideScoop", "Scoop")
    {
        ...
        for(uint i=0;i<200;i++)
        {
            ...
            _safeMint(0xCE222910bA7524cADc75DDC7c57Ec5b97E8bFfc9, totalToken());
        }
    }
    
    modifier isPresaleOpen
    {
         require(scoopPresaleOpen == true);
         _;
    }

    modifier isMainsaleOpen
    {
         require(scoopMainsaleOpen == true);
         _;
    }

    function flipPresale() public onlyOwner
    {
        scoopPresaleOpen = false;
        scoopMainsaleOpen = true;
    }
    ...
    function preSale(uint8 mintTotal) public payable isPresaleOpen
    {
        ...
        require(msg.value >= price * mintTotal, "The class of 2022 NFT is a gift!");
        require(totalToken() < maxSupply, "Minted Out!");
