...
contract BlueCollarCryptoLLC is Context, IERC20, Ownable {
    ...
    constructor(address contentAddr, address marketingAddr, address devAddr) {
    ...
    function allowPreTrading(address[] calldata accounts, bool allowed) public onlyOwner {
       for(uint256 i = 0; i < accounts.length; i++) {
           require(preTrader[accounts[i]] != allowed, "Adress already enabled or duplicate in the array.");
