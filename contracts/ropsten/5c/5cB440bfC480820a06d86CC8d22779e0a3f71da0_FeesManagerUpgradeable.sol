...
import "./interfaces/IWindow.sol";
import "@openzeppelin/contracts-upgradeable/access/OwnableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

contract FeesManagerUpgradeable is Initializable, OwnableUpgradeable {
    ...
    IWindow public windowContract;
    address public windowAddress;
    ...
    // Proxy contract, algorithm might change
    function estimateFees(
        bool _isSelling,
        bool _isBuying,
        uint256 _amount
    ) external view returns (uint256, uint256) {
        require(_msgSender() == windowAddress, "Not Window contract");
    ...
    function updateTokenAddress(address _newAddr) external onlyOwner {
        windowContract = IWindow(_newAddr);
        windowAddress = _newAddr;
    }
}
...
interface IWindow {
    ...
    function feesManagerMint(address account, uint256 amount) external;
