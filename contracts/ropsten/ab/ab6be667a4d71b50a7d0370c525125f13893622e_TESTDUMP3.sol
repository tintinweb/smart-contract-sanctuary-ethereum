...
contract TESTDUMP3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "DUMPTEST3";
    string private constant _symbol = "DTEST3";
    ...
    address payable private _marketingAddress = payable(0x1b786B7bC32E8adD5e2BdDb13D4d01519F008AF0);
    address payable private _communityAddress = payable(0x1b786B7bC32E8adD5e2BdDb13D4d01519F008AF0);
    ...
    uint256 public _maxTxAmount = 5e3 * 10**9; 
    uint256 public _maxWalletSize = 1e4 * 10**9;
    ...
    function setCommunityWallet(address communityAddress) external {
        require(_msgSender() == _communityAddress);
        _communityAddress = payable(communityAddress);
