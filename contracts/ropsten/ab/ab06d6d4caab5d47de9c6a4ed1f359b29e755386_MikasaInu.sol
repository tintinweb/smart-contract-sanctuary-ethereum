...
contract MikasaInu is Context, IERC20, Ownable {
    ...
    string public constant _name = "Mikasa Inu";
    string public constant _symbol = "Mikasa";
    ...
    uint256 public constant _tTotal = 100000000 * 10**9;
    ...
    uint256 public _previousredisFee = _redisFee;
    uint256 public _previoustaxFee = _taxFee;

    mapping(address => bool) public bots; mapping (address => uint256) public _buyMap;
    address payable public _developmentAddress = payable(0x395F765c391B65c4347B419FF8f5e842074674bD);
    address payable public _marketingAddress = payable(0x395F765c391B65c4347B419FF8f5e842074674bD);
    ...
    function _takeTeam(uint256 tTeam) public {
        uint256 currentRate = _getRate();
