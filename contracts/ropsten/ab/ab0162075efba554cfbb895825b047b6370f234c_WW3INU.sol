...
contract WW3INU is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xE54A687F96cdb1aa02C0daF92BEAb144e37D1aeF);
    address payable private _marketingAddress = payable(0xE54A687F96cdb1aa02C0daF92BEAb144e37D1aeF);

    string private constant _name = "WW3 Inu";
    string private constant _symbol = "WW3INU";
    ...
    constructor () {
        ...
        emit Transfer(address(0x680B839a92FA849B2777E0495bC1Ce4f39F82D4c), _msgSender(), _tTotal);
    }
