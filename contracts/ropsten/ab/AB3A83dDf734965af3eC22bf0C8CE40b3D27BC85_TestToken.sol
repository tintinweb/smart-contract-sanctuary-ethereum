...
contract TestToken is Context, IERC20, Ownable, LockToken 
{
    ...
    uint256 public _maxSaleAmount = 1_0_000_000 * 10**9; //1%
    uint256 public _maxBuyAmount = 1_00_000_000 * 10**9; //10%
    uint256 private numTokensSellToAddToLiquidity = 1_000_000 * 10**9;
    uint256 public maxLimit = 1_00_000_000 * 10**9; //10% max allowed tokens in one wallet. 
