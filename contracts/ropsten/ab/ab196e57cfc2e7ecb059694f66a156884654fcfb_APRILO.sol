...
contract APRILO is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"APRILO"; ////
    string public constant symbol = unicode"APRILO"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 100000000000 * 10**9; // 10%
        _maxWallet = 160000000000 * 10**9; // 16%
    }
