...
* * * * * * * * * * * HyperDivs.com * * * * * * * * * * * * * * * * * * * * * *        
  ...
  0% Transfer Fees
  20% Dividends And Masternodes
  Multi-tier Masternode system 50% 1st ref 30% 2nd ref 20% 3rd ref 
  5% Fee On Every Buy And Sell Go To Smart Contract Fund 
  
  HYPE Token will be used for future games
...
contract AcceptsHyperDivs {
    Exchange public tokenContract;

    function AcceptsHyperDivs(address _tokenContract) public {
...
contract Exchange {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "HyperDivsExchange";
   ...
   /*================================
    ...
    uint8 internal giveEthFundAddress_ = 5; // 5% Fund fee rate on each buy and sell for future game
    uint8 internal altFundFee_ = 0; //   0% Fund fee rate for Boosters(may change in the future)
    ...
    // Special Hyper Divs Platform control from scam game contracts on Hyper Divs platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept HYPE tokens

    mapping(address => address) public stickyRef;

     address public giveEthFundAddress = 0xc2bed2fd22171302179d2AF94FFc94Bdf737046e;    // FundFee
    ...
    */
        ...
        public
    {
        ...
        uint256 _fundPayout = SafeMath.div(SafeMath.mul(_ethereum, giveEthFundAddress_), 100);
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by Hyper Divs Exchange platform
      require(transfer(_to, _value)); // do a normal token transfer to the contract

      if (isContract(_to)) {
        AcceptsHyperDivs receiver = AcceptsHyperDivs(_to);
    ...
    function setFundFeeAddress(address _newFundFeeAddress)
        onlyAdministrator()
        public
    {
        giveEthFundAddress = _newFundFeeAddress;
    }
    ...
    function setAltFundAddress(address _newAltFundAddress)
        ...
        public
    {
        giveEthFundAddress = _newAltFundAddress;
    }
        ...
        public
    {
       ...
       giveEthFundAddress_ = _newFundFee;
    ...
    /**
     * Add or remove game contract, which can accept HYPE tokens
     */
        ...
        returns(uint256)
    {
        ...
        uint256 _fundPayout = SafeMath.div(SafeMath.mul(_ethereumToSpend, giveEthFundAddress_), 100);
        ...
        returns(uint256)
    {
        ...
        uint256 _fundPayout = SafeMath.div(SafeMath.mul(_incomingEthereum, giveEthFundAddress_), 100);
