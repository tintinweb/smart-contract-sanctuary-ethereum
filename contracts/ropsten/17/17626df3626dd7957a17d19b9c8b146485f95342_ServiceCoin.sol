...
contract ServiceCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ServiceCoin() {
        ...
        name = "ServiceCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SRV";                                             // Set the symbol for display purposes (CHANGE THIS)
