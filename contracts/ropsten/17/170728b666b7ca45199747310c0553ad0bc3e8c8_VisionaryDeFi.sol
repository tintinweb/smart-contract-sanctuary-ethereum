...
contract VisionaryDeFi is Context, IERC20, Ownable {
    ...
    string constant private _symbol = "Yeah";
    ...
    function setBuyMarketingPercent(uint256 MarketingFee) external onlyOwner() {
        _marketingFee = MarketingFee;
    }

     function setSellMarketingPercent(uint256 MarketingFee) external onlyOwner() {
        _marketingFee = MarketingFee;
    }

    function setBuyFoundationPercent(uint256 FoundationFee) external onlyOwner() {
        _foundationFee = FoundationFee;
    }

    function setSellFoundationPercent(uint256 FoundationFee) external onlyOwner() {
        _foundationFee = FoundationFee;
    }

    function setSellTeamPercent(uint256 TeamFee) external onlyOwner() {
        _teamFee = TeamFee;
    }
     
    function setBuyTeamPercent(uint256 TeamFee) external onlyOwner() {
        _teamFee = TeamFee;
    }
  ...
  function withdrawStuckETH(address recipient, uint256 amount) public onlyOwner {
    ...
    function BotBurner() public onlyOwner {
