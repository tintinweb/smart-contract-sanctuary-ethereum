...
contract NAME is Context, IERC20, Ownable {
    ...
    string private constant _name = "Poopy";//
    string private constant _symbol = "Pooper";//
    ...
    address payable private _marketingAddress = payable(0xE2d7e50B1C8b95452AD4EC0B4d9182efF109496D);//
