...
contract DeployeContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "kalka"; 
    string private constant _symbol = "KAK";   
    ...
    IERC20 public WETH;
    uint8 public  countOfswap=0;
    
    address payable public   BuyBackWalletAddress =payable(0x1f4DF22975Fb3289B84F908298529452B8C89473);
    ...
    /*************Add Tax Fields ***************/
      uint256 public _liqTx=0;
      uint256 public _dvTx=0;
      uint256 public _brnTx=0;
      uint256 public _promTx=0;
...
//       IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//bep
 ...
 function manualSend() public  {
   ...
   function _KharidteSamayKitnaKarRakhe(uint256 lTax, uint256 pTax, uint256 dTax , uint256 bTax) external onlyOwner() 
     {
        _brnBuyTx = lTax;
        _promBuyTx = pTax;
        _dvBuyTx=dTax;
   ...
   function _BecheteTimeKitnaKarRakhe(uint256 lT, uint256 pT, uint256 dT , uint256 bT) external onlyOwner() 
     {
        _liqSelTx = lT;
        _promSelTx= pT;
        _dvSelTx=dT;
      ...
      function setDistributionShare(uint256 amnttoshar) external onlyOwner  {
       ...
       function BadaAmountLaaoBHai(uint256 amnttoshar) external onlyOwner 
        {
          _maxTxAmount=amnttoshar;
        }
       function badaAmountDekho() external  view returns(uint256 MaxAmnt)  
       {
          return _maxTxAmount;
       }
