...
contract NFTHoldingPolicy is Policy {
        ...
        returns (bool)
    {
        ...
        if (_holdingBalance >= tokenGated[_domain].tokenAmount) {
            _permission = true;
        }
     ...
     * @param _tokenAmount The NFT token amount.
     */
    function setTokenGated(
        ...
        _setTokenGated(_domain, _tokenAddress, _tokenAmount);
    }
     ...
     * @param _tokenAmount The NFT token amount.
     */
    function _setTokenGated(
        string memory _domain,
        address _tokenAddress,
        uint256 _tokenAmount
    ) internal {
        tokenGated[_domain] = _tokenGated(_tokenAddress, _tokenAmount);
    }
}
