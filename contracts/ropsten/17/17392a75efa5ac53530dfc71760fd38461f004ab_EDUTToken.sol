...
contract EDUTToken is DetailedERC20, PausableToken {
    ...
    // 80 billion tokens, 18 decimals.
    uint public constant INITIAL_SUPPLY = 8e27;
    ...
    constructor() public DetailedERC20("EDUT Token", "EDUT", 18) {
