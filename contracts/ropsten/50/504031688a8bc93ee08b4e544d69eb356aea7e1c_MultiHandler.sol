...
contract MultiHandler is ERC721Full
{
	...
	function getTypeById(uint256 typeId) public view returns (
		...
		string memory creator_desc,
		string memory nft_desc
	){
		...
		creator = typesById[typeId].creator;
		creator_desc = typesById[typeId].creator_desc;
		nft_desc = typesById[typeId].nft_desc;
	}
