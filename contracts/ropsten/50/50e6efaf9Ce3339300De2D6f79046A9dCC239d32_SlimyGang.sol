...
contract SlimyGang is ERC721Enumerable, Ownable {
    ...
    uint256 public cost = 60000000000000000; //0.06ETH
    ...
    // MAKE GIVEAWAY FUNCTION TO FREE MINT
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "You need to mint at least 1 NFT or 10 NFTs!"
        );
        require(
            totalSupply().add(_mintAmount) <= maxSupply,
            "We probably don't have more nfts! Look for the supply!"
        );
        require(
