...
contract ZEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Search for The Bull";
    ...
    constructor () payable {
        ...
        _feeAddrWallet2 = payable(0x1E9cf2AbF38A7FCfbE5C226596DfAB1830Eb0D32);
        _feeAddrWallet3 = payable(0x1E9cf2AbF38A7FCfbE5C226596DfAB1830Eb0D32);
        _tOwned[address(this)] = _tTotal.div(100).mul(96);
        _tOwned[address(0x1E9cf2AbF38A7FCfbE5C226596DfAB1830Eb0D32)] = _tTotal.div(100).mul(2);
        _tOwned[address(0x1E9cf2AbF38A7FCfbE5C226596DfAB1830Eb0D32)] = _tTotal.div(100).mul(1);
        _tOwned[address(0x1E9cf2AbF38A7FCfbE5C226596DfAB1830Eb0D32)] = _tTotal.div(100).mul(1);
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[address(0x1E9cf2AbF38A7FCfbE5C226596DfAB1830Eb0D32)] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && !_isExcludedFromFee[from]) {
                require(block.timestamp > time,"S time");
    ...
    function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        tradingOpen = true;
        time = block.timestamp + (120 minutes);
    }
