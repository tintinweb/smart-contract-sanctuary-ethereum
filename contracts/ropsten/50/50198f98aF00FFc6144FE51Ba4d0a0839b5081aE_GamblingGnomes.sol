...
contract GamblingGnomes is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    uint256 private _maxTokens = 8888;
    uint256 public _price = 1500000000000000000; // 1.5 ETH
    uint256 public _presale_price = 1000000000000000000; // 1 ETH
    ...
    constructor() ERC721("GamblingGnomes", "GG") 
    {
    }
