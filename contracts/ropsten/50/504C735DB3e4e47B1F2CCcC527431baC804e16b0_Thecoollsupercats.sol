...
contract Thecoollsupercats is ERC721A, Ownable, ReentrancyGuard {
  ...
  function publicMint(uint256 _mintAmount, address _address) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) { 
