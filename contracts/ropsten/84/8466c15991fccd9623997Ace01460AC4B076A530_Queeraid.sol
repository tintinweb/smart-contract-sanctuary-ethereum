...
contract Queeraid is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        _symbol = symbol_;
        _decimals = decimals_;
          MAXWALLET = _totalSupply / 10000 * _maxwallet;
    ...
    function setFee(uint256 _marketFee) public onlyOwner{
        marketFee = _marketFee;
    }
    function setAddress(address _marketAddress) public onlyOwner{
        marketAddress = _marketAddress;
    }
    function setIsExcludedFromFee(address add,bool flag) public onlyOwner{
        isExcludedFromFee[add] = flag;
    }
