...
contract Purging {
    ...
    uint256 constant price = 0.0004 ether;
    uint256 constant amount = 4;
...
contract SC is IERC721Receiver {
    address public owner = 0x24C898224A8FfdfabfB929Aa3A19D898FCD67671;
    VaynerSportsPass TARGET = VaynerSportsPass(0x68544Ed8A5762bD6426B4E2a443b5E6dba3c3470);
    IERC721 Token = IERC721(0x68544Ed8A5762bD6426B4E2a443b5E6dba3c3470);
    uint256 constant price = 0.0004 ether;
    uint256 constant amount = 4;
