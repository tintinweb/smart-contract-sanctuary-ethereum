...
contract earn is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public marketingAddress =
    payable(0x2D2CaB448243b8eF16f9CFc986FB35946fb14f8a); // Marketing Address
    
  address payable public maintenanceAddress =
    payable(0x2D2CaB448243b8eF16f9CFc986FB35946fb14f8a); // Project Maintenance
    
  address payable public treasuryAddress =
    payable(0x2D2CaB448243b8eF16f9CFc986FB35946fb14f8a); // Treasury
  ...
  string private _name = 'earn';
  string private _symbol = 'earn';
  ...
  uint256 public _feeRate = 12;
  uint256 launchTime;

  // limit
  uint256 public _maxTxAmount = 3000000 * 10**18;
