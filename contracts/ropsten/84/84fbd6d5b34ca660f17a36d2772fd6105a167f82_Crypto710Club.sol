 ...
 */
contract Crypto710Club is Context, ERC721A, Ownable, ReentrancyGuard  {
    ...
    constructor(address signer) ERC721A("Crypto710Club", "C7D") {
        signerAddress = signer;
    }

    function mintCCC(uint256 amount) public payable nonReentrant {
    ...
    function mintCCCWL(uint256 amount, bytes calldata signature) public payable nonReentrant {
        uint256 supply = totalSupply();
