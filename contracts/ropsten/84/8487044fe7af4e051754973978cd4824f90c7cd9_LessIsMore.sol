...
The opium was so strong. 

And yet everyone knew that SHIBA, FLOKI, SAFEMOON, and so on, would never have any use. The name was cool, the community was fun. 
...
contract LessIsMore is ERC20, Ownable {
    ...
    constructor() ERC20("Less is More", "LIM") {
        ...
        buyTotalFees = buyBBFee + buyLiquidityFee + buyDevFee;

        sellBBFee = _sellBBFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevFee = _sellDevFee;
        sellTotalFees = sellBBFee + sellLiquidityFee + sellDevFee;

        marketingWallet = address(0x2c98B15286acc26071dba2A13B31F0ddC27d7c4c); // set as marketing wallet
        devWallet = address(0x2c98B15286acc26071dba2A13B31F0ddC27d7c4c); // set as dev wallet
