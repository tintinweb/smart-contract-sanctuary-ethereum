...
// File: Contracts/PITTEST.sol
    ...
    contract QUASsSY is Ownable, ERC721A {
    ...
    constructor() ERC721A("QSDOT", "QSDOT") {_safeMint(msg.sender, 1); setHiddenMetadataUri("https:/ipfs/QmRpRrEL6QHnZSqdkx6crecci6s2CPJtqjm3n9Q5JXCd4H");}
