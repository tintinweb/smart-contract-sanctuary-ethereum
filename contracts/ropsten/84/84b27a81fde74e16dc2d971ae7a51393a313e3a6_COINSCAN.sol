...
contract COINSCAN is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0xA64f71350Ecf5AF1B583897Ee4da5A2AeD802572);
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 contractETHBalance = address(this).balance;
	addLiquidity(balanceOf(address(this)), contractETHBalance.mul(15).div(100));
    }
