...
contract TestToken is Context, IERC20, Ownable {
	...
	address payable public burningAddress = 0x000000000000000000000000000000000000dEaD; // burn Address
        address payable public marketingAddress = msg.sender; // Marketing Address //ToChange
    ...
    uint256 public maxWalletHoldings = 7860000 * 10**9;
    ...
    uint256 public _maxTxAmount = 786000000 * 10**9;
