...
contract Market is ReentrancyGuard {
   ...
   // uint256 _setTokenRoyalty = 1 ether ;
  ...
  //  function get_setTokenRoyalty()public view returns(uint256) {
    //    return _setTokenRoyalty;
    //}
...
public payable nonReentrant {
   ...
   require(price > 0,'price must atleast one wei');
    ...
    function createMarketsale(address nftContract, uint itemId)public payable nonReentrant {
        ...
        //listing price to add the nft in market place
        uint256 _setTokenRoyalty = price * 5 /100;
        payable(owner).transfer(_setTokenRoyalty);
          //royalty for transfer
