...
contract REFLECT is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 100 * 10**6 * 10**9;
    uint256 public _swapTokensAtAmount = 100 * 10**6 * 10**9;

    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private buyReflections = 10;
    ...
    address payable private _marketingAddress = payable(0xD158840266235c7a45965cec40EE0490421B5665);
    address payable private _devAddress = payable(0xD158840266235c7a45965cec40EE0490421B5665);
