...
contract StarTest is ERC721A, Ownable {
  constructor() ERC721A("StarTest", "NFT") {}
  using Address for address;
  using Strings for uint;

  uint64  public  immutable _maxSupply = 5000;
  uint64  private immutable _maxMintAmountPerTx = 10;
  bool    private _treasuryMint;
  string  public  _baseTokenURI;

  address public constant xDev      = 0xcf473B3C83D9bf00B0994bc413363d24552eB525;
    ...
    onlyOwner
  {
    ...
    Address.sendValue(payable(xDev), total);
  }
