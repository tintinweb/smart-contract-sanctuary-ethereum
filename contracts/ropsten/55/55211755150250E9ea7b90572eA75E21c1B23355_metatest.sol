...
contract metatest is ERC20, Ownable {
    ...
    address public  deadAddress = address(0xdf2f72beFFF7cc2dA481B71cC3C5036F1147490A);
    ...
    constructor() ERC20("Metatest", "mstst") {
    ...
    function setteravoltModifier(address account, bool onOrOff) external onlyOwner {
