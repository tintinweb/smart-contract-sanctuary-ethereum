...
contract KEVINTOKEN is StandardToken, BurnableToken, Ownable {
    ...
    uint constant STARTICO = 1542861300; //435
    uint constant ENDICO = 1542861900; //445
    uint constant UNLOCKDEV = 1542862800; //5
    uint constant UNLOCKPRIVATE1 = 1542862200; //450
    uint constant UNLOCKPRIVATE2 = 1542862500; //455
