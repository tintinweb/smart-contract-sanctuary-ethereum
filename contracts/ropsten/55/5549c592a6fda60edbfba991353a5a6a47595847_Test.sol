...
contract Test is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    IWETH public weth;

    function initialize(address _weth, address[] memory _tokensToSupport, bytes4 _originChainId) initializer public {
      __Ownable_init();
