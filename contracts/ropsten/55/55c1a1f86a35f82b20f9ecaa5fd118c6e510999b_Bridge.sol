    ...
    UpgradableOwnable
{
    ...
    */
    ...
    function getResourceIDToHandlerAddress(bytes32 resourceID)
        external
        view
        returns (address)
    {
        ...
        if (bytes32(swapIdentifier) == bytes32("swap")) {
            return _resourceIDToHandlerAddress[srcResourceId];
        } else {
            return _resourceIDToHandlerAddress[resourceID];
        }
    }
}
