...
// File: contracts/ToStringLib.sol
...
// File: contracts/MetaGoblinns721A.sol
...
contract MetaGoblinns is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public phasePrice = 0.1 ether; 

    address accessAuthority = 0x0ECd4C5977257ac67d952ce0ef335e31edbF63c7;

    constructor() ERC721A("MetaGoblinns", "MG", 100, 4444) {}
    ...
    /* Mint */
    function goblinMintPrecheck(uint256 numberOfTokens, bool isOwner) private {
    ...
    function goblinMint(address to, uint256 numberOfTokens) private {
    ...
    function processMint(uint256 numberOfTokens, bool isOwner) private {
        ...
        goblinMintPrecheck(numberOfTokens, isOwner);
        goblinMint(msg.sender, numberOfTokens); 
