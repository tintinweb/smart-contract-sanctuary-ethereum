...
contract EpikStaking is ReentrancyGuard, Pausable {
    ...
    uint256 private _totalSupplyWithBlacklisted;
    ...
    function totalSupplyWithBlacklisted() external view returns (uint256) {
        return _totalSupplyWithBlacklisted;
    }
        ...
        notPaused
    {
        ...
        _totalSupplyWithBlacklisted = _totalSupplyWithBlacklisted.add(amount);
        ...
        nonReentrant
    {
        ...
        _totalSupplyWithBlacklisted =  _totalSupplyWithBlacklisted.sub(amount);
    ...
    function claimReward() public nonReentrant {
        require(!isBlacklisted[msg.sender], "Claim: Blacklisted address cannot claim rewards");
        _updateReward(msg.sender);
    ...
    function _updateReward(address account) internal {
        require(!isBlacklisted[account], "updateReward: address is blacklisted ");
