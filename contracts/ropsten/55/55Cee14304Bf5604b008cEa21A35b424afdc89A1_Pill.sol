...
contract Pill is IBEP20, Auth, IERC721Receiver {
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNB = IBEP20(WBNB).balanceOf(address(this)).sub(balanceBefore);
        ...
        if(amountToLiquify > 0){
            increaseLiquidityCurrentRange(tokenId, amountBNBLiquidity, WBNB, amountToLiquify, address(this));
