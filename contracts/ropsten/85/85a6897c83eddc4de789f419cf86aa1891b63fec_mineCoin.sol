...
contract mineCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function mineCoin() {
        ...
        name = "mineCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-019";                                             // Set the symbol for display purposes (CHANGE THIS)
