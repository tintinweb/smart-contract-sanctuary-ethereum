...
contract FUCKU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "FUCKU";
    string private constant _symbol = "FUCKU";
    ...
    address payable private _marketingAddress = payable(0xf097c29fc1e4f0827e1fb75C7991504f22dfbB63);
    address payable private _devAddress = payable(0xf097c29fc1e4f0827e1fb75C7991504f22dfbB63);
