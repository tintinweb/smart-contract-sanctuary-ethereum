...
contract MultiSig {
    ...
    function getNetworkId() public pure returns (string memory) {
        return "ETHER";
    }

    function getTokenNetworkId() public pure returns (string memory) {
        return "ERC20";
    }
        ...
        )
    {
        ...
        console.log("other signer:", otherSigner);
