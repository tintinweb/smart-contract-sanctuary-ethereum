...
Dali is a mythical goddess of hunting among the Svan tribe. 
Draped in her endearing golden hair and flawless glowing skin,
Dali was known to grant successful hunts and offer protection
to hunters who followed her set of taboos.
...
contract DALI_HUNTERS_GOLD is ERC20, Auth {
    ...
    string constant private _name = "DALI";
    string constant private _symbol = "HUNTERS GOLD";
    uint8 constant private _decimals = 18;

    uint256 private _totalSupply = 1_000_000_000* 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply * 110 / 10000; //1.1%
    uint256 public _maxWalletAmount = _totalSupply * 200 / 10000; //2.0%
    ...
    address private autoLiquidityReceiver =0x2eBe5D3Dcf4619f68D731A1ae3B9C4e857c744f5 ;
    address private MarketingFeeReceiver =0x2eBe5D3Dcf4619f68D731A1ae3B9C4e857c744f5 ;
    address private operationsFeeReceiver =0x2eBe5D3Dcf4619f68D731A1ae3B9C4e857c744f5 ;
    address private devFeeReceiver =0x2eBe5D3Dcf4619f68D731A1ae3B9C4e857c744f5 ;
