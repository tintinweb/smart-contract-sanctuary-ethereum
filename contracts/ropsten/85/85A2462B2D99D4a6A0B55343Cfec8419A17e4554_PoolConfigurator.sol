 ...
 * @author None, inspired by the OpenZeppelin Initializable contract
...
library ConfiguratorInputTypes {
  ...
  struct InitM1CollateralsInput{
    // M1 contract address of collateral
    address collateralAddress;
    //Type of collateral
    uint256 m1CollateralTypeModel;
    //Maximum allowable quantity in base currency
    uint256 maxBorrowLimitInBaseCurrency;
    //The threshold at which loans using this asset as collateral will be considered undercollateralized
    uint256 liquidationThreshold;
 ...
 * @author None, inspired by the OpenZeppelin upgradeability proxy pattern
