...
contract AKINU is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 100000000000  * 10**9;  //100 Billion
    ...
    constructor () {
        marketingAddress = payable(0xbc73fFc98479Fc4386dAC43DBee46bA6C9580456);
        devAddress = payable(0xbc73fFc98479Fc4386dAC43DBee46bA6C9580456);
