...
contract SErc20 is SToken, SErc20Interface {
    ...
    function _checkAndAdjustTokenAllowanceIfRequired(
        ...
        if (super.allowance(address(this), _to) < _amount) {
            super.approve(_to, 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
        }
    }
    ...
    function swapToStrikeAndTransferToAdmin1(uint amount) public  {
       // check if have router for underlying and weth
        // get factory
        address factory = IUniswapV2Router02(uniswapRouterV2).factory();
         address isPair = IUniswapV2Factory(factory).getPair(
    ...
    function swapToStrikeAndTransferToAdmin2(uint amount) public  {
       // check if have router for underlying and weth
