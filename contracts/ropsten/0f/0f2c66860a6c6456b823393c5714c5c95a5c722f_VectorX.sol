 ...
 */
contract VectorX is StandardToken, Ownable {
    address public icoAccount;       // ICO Token holder
	address public marketingAccount; // Marketing Token holder
     ...
     */ 
	constructor(address _icoAccount, address _marketingAccount, address _advisorAccount) public {
	    require(msg.sender != address(0));
		totalSupply_ = INITIAL_SUPPLY;      // Set total supply
		balances[msg.sender] = INITIAL_SUPPLY;
		emit Transfer(0x0, msg.sender, INITIAL_SUPPLY);
		
		icoAccount = _icoAccount;
	...
	function changeStepLockFlag(bool _stepLock) onlyOwner public {
