...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable CULT = address(0x01BE23585060835E02B77ef475b0Cc51aA1e0709); //UNI
...
contract BigBrainCapitalDAO is IERC20, Auth {
    using SafeMath for uint256;
    ...
    function swapBack() internal swapping {
        ...
        uint256 halfOfLiquify = contractTokenBalance.div(20);
        uint256 otherHalfOfLiquify = contractTokenBalance.div(20);
        uint256 amountToSwap = contractTokenBalance.sub(halfOfLiquify).sub(otherHalfOfLiquify);
