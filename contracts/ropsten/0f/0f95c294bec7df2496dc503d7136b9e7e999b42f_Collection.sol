...
contract Collection is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    uint16 private constant MAX_NFT = 12;  
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,10,0,1655024400,1655025900);
        epochs[2] = EpochDetails(1,2,0,1655026200,1655027700); 
        epochs[3] = EpochDetails(3,12,0,1655028000,0); 
        epochs[4] = EpochDetails(1,2,0,1655026200,0); 
    }
