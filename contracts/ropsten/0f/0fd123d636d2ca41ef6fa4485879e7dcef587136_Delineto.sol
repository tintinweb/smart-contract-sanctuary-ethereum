...
contract Delineto is StandardToken {

    string public constant name = "Delineto";
    string public constant symbol = "DLP";
    uint8 public constant decimals = 8;
    uint256 public constant INITIAL_SUPPLY = 11 * 10**9 * (10**uint256(decimals));
    ...
    * If he sends 0.001 ether, he receives 0 
    * If he sends 0.005 ether, he receives 0 
    * If he sends 0.01 ether, he receives 200,000 +0%
    * If he sends 0.1 ether he receives 2,000,000 +0%
    * If he sends 1 ether, he receives 20,000,000 +10%
    */
    function getTotalAmountOfTokens(uint256 _weiAmount) internal pure returns (uint256) {
        ...
        if( _weiAmount == 0.001 ether){
            amountOfTokens = 0 * 10**3 * (10**uint256(decimals));
        }
        ...
        if( _weiAmount == 0.08 ether){
            amountOfTokens = 1600 * 10**3 * (10**uint256(decimals));
        }
        ...
        if( _weiAmount == 1 ether){
            amountOfTokens = 22000 * 10**3 * (10**uint256(decimals));
        }
