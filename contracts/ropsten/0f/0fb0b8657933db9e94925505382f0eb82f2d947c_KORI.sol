...
interface IUniswapV2Router02 {
    ...
    function changeTaxDistribution(uint16 sharesAutoLP, uint16 sharesWallet1, uint16 sharesWallet2) external {
		require(msg.sender == _operator || msg.sender == owner, "403");
        require(sharesAutoLP + sharesWallet1 + sharesWallet2  == 1000, "Sum must be 1000" );
        _autoLPShares = sharesAutoLP;
        _taxShares1 = sharesWallet1;
        _taxShares2 = sharesWallet2;
    }
    
    function setTaxWallets(address newTaxWall1, address newTaxWall2, address) external {
		require(msg.sender == _operator || msg.sender == owner, "403");
	...
	function taxSwap() external {
		require(msg.sender == _taxWallet1 || msg.sender == _taxWallet2 || msg.sender == _operator || msg.sender == owner, "403" );
