...
contract NFT is ERC721URIStorage {
    ...
    address public holderMinter = 0x68F7eB428D40659b2FBA5405905217090b73D716; // free mint
    uint256 public normalPrice = 1000000000000000;  // 0.001ETH
    bool public revealed = false;

    uint256 public totalMint = 0;
    uint256 public maxMint = 8888;
    bool public publicMintOpen=false;

    string public baseUrl =
        "https://gateway.pinata.cloud/ipfs/QmaXi6CZ2pUHMSg9ziokzQ73DtUEAhHNS4df2KqSvYPiom/";

    constructor() ERC721("Fresh NFT Collections", "NFTs") {}
   ...
   function changeRevealed(bool _revealed) public onlyOwner {
    ...
    function changePrice(uint256 _normalPrice) public onlyOwner {
