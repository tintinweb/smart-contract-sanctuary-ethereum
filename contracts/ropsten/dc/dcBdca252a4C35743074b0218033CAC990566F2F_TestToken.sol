...
contract TestToken is Context, IERC20, Ownable {
    ...
    string constant private _name = "TestToken";  //its for token name 
    string constant private _symbol = "TestToken"; // and its for symbol we can put our name symbol here

    uint256 constant private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    //its for 1 billion
    uint256 private _tTotal = 1000000000 * 10**8;  //hete put your totall supply amount
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
   
    address payable public marketingAddress = payable(0x3CbD1840722B14BA294dF4A3Ba4Da761a2460E69);  //for marketing address

    address payable public developmentAddress = payable(0xcc55Bad18a598782e9138dE4eed459631d3d52ac); //its for dev address 
    //you need to put you market and dev address here
  
//here in this line put you all taxes amount 

    uint256 public _taxFee = 1; //its for tax
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 1; //its for liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 public _marketingFee= 2; //its for market
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 public _developmentFee = 3; //its for dev 
    ...
    uint256 public _maxTxAmount = 8000000 * 10**8; 
    ...
    constructor() {
      ...
      // here we need to put uniswap router address
