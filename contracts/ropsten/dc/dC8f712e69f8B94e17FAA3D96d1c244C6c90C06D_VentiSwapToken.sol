...
contract VentiSwapToken is Context {
    ...
    bool private _imposeLimits = false;
    ...
    function imposeLimits(bool limitsInEffect) external onlyOwner
    {
        _imposeLimits = limitsInEffect;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (!_imposeLimits && !_exemptFromLimits[from]) {
