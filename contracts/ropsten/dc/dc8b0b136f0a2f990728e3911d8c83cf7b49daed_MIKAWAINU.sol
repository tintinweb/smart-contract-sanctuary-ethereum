...
contract MIKAWAINU is Context, IBEP20, LockToken 
{
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x0f3b0bB55EB96d9e4C5393064dDa7490eaA95A52);
    ...
    {
        uint256 _totalFees = _liquidityFee.add(_marketingFee).add(_saleLiquidityFee).add(_saleMarketingFee);
    ...
    external onlyOwner()
    {
        ...
        uint256 totalFee = _saleLiquidityFee.add(_saleMarketingFee);
