...
contract HamzaCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HamzaCoin() {
        ...
        name = "HamzaCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-21";                                             // Set the symbol for display purposes (CHANGE THIS)
