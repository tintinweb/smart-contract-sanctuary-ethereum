    ...
    OwnableUpgradeable
{
    ...
    function transfer(
        ...
        _transfer(from, to, partialBurn(amount));
        return true;
    }
    ...
    function getBurnAmount(uint256 amount) internal pure returns (uint256) {
