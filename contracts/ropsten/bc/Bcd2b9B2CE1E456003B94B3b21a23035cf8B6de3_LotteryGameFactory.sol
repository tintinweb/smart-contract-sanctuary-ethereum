...
contract LotteryGameFactory is ILotteryGameFactory, Ownable {
     ...
     * @param callerFeePercents fee percentages for caller
     * @param isDateTimeRequired boolean value if timelock will be calculated in datetime
    ...
    /**
     * @dev Function creating multiple entrance to games at one transaction by user
...
interface ILotteryGameFactory {
     ...
     * @param participationFee fee to participate in the game
     * @param countOfWinners the number of winners
     * @param winnersPercentages list of percentages for each winner
     * @param callerFeePercents fee percentages for caller
     * @param isDateTimeRequired boolean value if timelock will be calculated in datetime
     * @param governance inctance of governance contract
     **/
    ...
    /**
     * @dev Function creating multiple entrance to games at one transaction
     * @param gamesList list of games addresses
     **/
    function entryMultipleGames(address[] memory gamesList)
        external
