...
contract SUIJIN is ERC20, Ownable {
    ...
    constructor() ERC20("Alien Mirror2", "SAPIENS") {
        ...
        marketingWallet = address(0x7e4E810a5aA959Df448e45EA7c5Ab04773CAcB96); // set as marketing wallet
        devWallet = address(0x7e4E810a5aA959Df448e45EA7c5Ab04773CAcB96); // set as dev wallet
