...
contract StarWolvez is ERC721EnumerableChaos, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public constant MAX_TOKENS = 8980 + 2; // +2 is for code optimization
    ...
    // PUBLIC MINT
    uint256 public constant MAX_TOKENS_PURCHASE = 4;
    ...
    */
    function mint(uint256 numberOfTokens) external payable nonReentrant{
        ...
        require(mintingTokenIndex + numberOfTokens < MAX_TOKENS, "Not enough tokens left to mint that many");
