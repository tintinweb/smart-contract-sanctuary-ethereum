...
contract MayanToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MayanToken() {
        ...
        name = "MayanToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MAYA";                                             // Set the symbol for display purposes (CHANGE THIS)
