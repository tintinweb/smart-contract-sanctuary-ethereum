...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable{
    ...
    uint256 private constant _tTotal = 15_000_000_000 * 10**_decimals; //TEMP 
    ...
    uint256 private _presaleTokenLimit = 7_000_000_000 * 10**_decimals; //TEMP 
    uint256 private _presaleTokensSold = 0;
    uint256 private minInvestment = 1 * 10**_decimals; //TEMP 
