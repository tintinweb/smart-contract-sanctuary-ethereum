...
contract RattleSnake is ERC721URIStorage {
...
constructor() ERC721 ("RattleSnake", "RTSK") { // construct your token, needs name and symbol
  console.log("An NFT has been minted to %s", msg.sender);
}

function createNFT() public { //function to create nfts
