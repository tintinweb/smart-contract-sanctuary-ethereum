...
contract Staker {
  ...
  modifier deadlineReached() {
    ...
    require(timeRemaining == 0, 'Deadline not yet reached');
    _;
  }
  ...
  function withdraw() public payable notCompleted deadlineReached {
    ...
    require(openForWithdraw, "Staking ready for execution");
    ...
    require(sent, 'Failed to return user balance');
