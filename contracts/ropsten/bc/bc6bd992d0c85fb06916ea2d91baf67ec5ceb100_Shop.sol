...
contract Shop is Ownable {
    ...
    constructor() {
        ...
        catPrice[Cat.ChanKwongYan] = 0.05 * 10 ** 18; // 0.05 ETH/BNB
    }
    ...
    // user bought cat counts
    function getUserCatCounts(address _addr) external view returns(uint[7] memory) {
        require(_addr != address(0), "Zero address");
        uint[7] memory counts = [
            userCatCounts[_addr][Cat.SnoopDogg],
            userCatCounts[_addr][Cat.Urban],
            userCatCounts[_addr][Cat.Rothschild],
            userCatCounts[_addr][Cat.SakuragiHanamichi],
            userCatCounts[_addr][Cat.MasterShifu],
            userCatCounts[_addr][Cat.Spock],
            userCatCounts[_addr][Cat.ChanKwongYan]
        ];
    ...
    function income() external view onlyOwner returns(uint) {
        return totalUsdt;
    }
