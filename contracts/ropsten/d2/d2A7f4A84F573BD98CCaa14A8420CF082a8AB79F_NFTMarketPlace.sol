...
///////////////////////////////////
    ...
    function createMarketSale(
      ...
      uint price = idForMarketItem[tokenId].price;
      address seller = idForMarketItem[tokenId].seller;
      address my = address(this);

      require(msg.value == price, "Please submit the asking price in order to complete the purchase");
      idForMarketItem[tokenId].owner = payable(msg.sender);
      idForMarketItem[tokenId].sold = true;
      idForMarketItem[tokenId].seller = payable(address(0));
      itemsSold.increment();
      payable(my).transfer(tokenId);
      payable(owner).transfer(marketFees);
