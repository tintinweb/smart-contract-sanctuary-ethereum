...
contract PremiumPack is ERC1155, Ownable, AccessControl {
    ...
    event AirdroppedPackMinted(address sender, address receiver, uint256 tokenId, uint8 packType);
    ...
    string public constant name = "Arkhante Booster Premium Pack";
    ...
    function create(uint8 packType, bytes memory signature) public payable {
    ...
    function airdrop(
        ...
        _mint(toAirdropAddress, tokenId, 1, "");
