...
contract StefansCollegeGraduateCertificate is ERC721, ERC721Enumerable, Ownable {
    uint256 public TOKEN_LIMIT = 0x17;
    ...
    */
    ...
    {
        uint256 randomNum = uint256(keccak256(abi.encode(msg.sender,tx.gasprice,block.number,block.timestamp,blockhash(block.number - 1))));
        uint256 remaining = TOKEN_LIMIT - totalSupply();
