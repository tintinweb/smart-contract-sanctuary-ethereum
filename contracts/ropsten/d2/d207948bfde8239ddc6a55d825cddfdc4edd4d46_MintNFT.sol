...
contract MintNFT is ERC721, Ownable {
  ...
  string public uriPrefix = "ipfs://QmWUvKqZtLqB68erx367zcE4Q3Zz9XY2A3i2DFvNy7BPgp/";
  ...
  constructor() ERC721("MintNFT", "MNT") {
    setHiddenMetadataUri("ipfs://QmVgA2VS7T9FTokyQZu4a9ifpwNLDqMb9pMyULuX2PVfVm/hidden.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xC13de37C7166e54FC7761dcE8348e4e5c3AF319d).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
