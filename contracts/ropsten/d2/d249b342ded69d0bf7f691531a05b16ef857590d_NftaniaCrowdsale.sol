...
contract NftaniaCrowdsale is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Get Eth Raised //////////////////////// 
    function getEthRaised() public view returns ( uint256 EthRaised) {
        EthRaised = weiRaised/10**18;
        return EthRaised;
    }
   ...
   //////////////////////// Purchase Tokens  /////////////  
    function buyTokens(uint amount) public payable whenNotPaused() nonReentrant() returns(bool) {   
        ...
        require(amount* 10**18 <= remainingTokens, "currently paid tokens are sold out");           // Checks "Purchase supply" availability.
        ...
        emit TokensUpdate (weiRaised/10**18,totalTokensSold,remainingTokens/10**18);
        return true;
    }
