...
contract CryptoParadoxClub is ERC721, ERC721Enumerable, Ownable {
    ...
    // config
    string constant notRevealedURI = "ipfs://QmZbQMraHWFsDPokX8Sftu7VfLsTTExbWJnJkyAqgCpfh6/";
    ...
    function buy(address _to, uint256 _quantity) public payable {
        require(SaleStarted, "The sale isn't started yet");
    ...
    function startPublicSale(uint256 _newPrice) public onlyOwner {
        price = _newPrice;
        SaleStarted = true;
    }
