...
// File: contracts/BBA/testTokens/imports/Copy_mainframe.sol
...
// File: contracts/BBA/testTokens/swordV1.sol
...
contract swordNFT is ERC721 {
    ...
    constructor() ERC721("sword","SWORD"){
        tokenCount = 0;
        whitelist = ArkadeWhitelist(0x68aFa5fDc478ba26F9c64f22c087D3A5efd10e2e);
    }
    ...
    function mint(address to, string memory name, uint damage)
    public
    {
        _safeMint(to, tokenCount);
        weapons[tokenCount] = weapon(name,damage);
        tokenCount++;
    }
