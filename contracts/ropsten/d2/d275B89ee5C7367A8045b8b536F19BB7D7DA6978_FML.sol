...
After witnesing about 100 tokens just today ive found that almost every token is tax farm
Dev just wants to get tax money and that's all litrelly no effort to grow the community
After some thinking I decided on leveraging the move in market, which led me
to create a safe community owned token , Inspired from Shinigami.
...
I will be observing from behind the scene as I want this to be driven by the community!
...
* Contract Trx and Wallet size can't be lowered , and taxes won't be higher than 5%.
* I will communicate on ETHERSCAN.io.
* Website will be built at 69K MC.
* I hope the community makes a Telegram (I will join but as a normal holder).  
* DEXTOOL LOGO SOCIAL UPDATE at 150K MC.

I only get 2 % Tax 2% goes back to You the Community.
No Dev Cash Grab, but a Dev Who Cares About the COMMUNITY
Let's Moon this, because the more volume we get the more we grow.

* I will burn atleast 0.3 % tax collected every day for 1 week.
* Liquidity will be locked for 100 years at 200K MC
* I will Doxx at 1 million MC, I'm not a coward like SATOSHI

We don't need big paid Influencers or big Marketing,I rather prefer the community to get all the rewards! RIGHT????
...
https://medium.com/@FuckMyLifeETH/fml-fuck-my-life-2a85e7cad644
*/
...
contract FML is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Fuck My Life";
    string private constant tokenSymbol = "FML";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 100e9 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x39e983d237368c48A80069991a9d906Fffa05495);
        devAddress = payable(0x39e983d237368c48A80069991a9d906Fffa05495);
