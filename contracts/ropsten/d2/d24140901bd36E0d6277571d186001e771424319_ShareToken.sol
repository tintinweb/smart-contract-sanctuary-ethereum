...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(!recipient.isContract(),"to non-contract");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(canTransfer,"can not mint now");
    ...
    function _setCanTransfer(bool _canTransfer) internal virtual {
...
interface IToken {
    ...
    function setCanTransfer(bool canTrans) external;
...
contract ShareToken is ERC20, Ownable, IToken {
    ...
    function setCanTransfer(bool canTrans) public onlyController virtual override {
        _setCanTransfer(canTrans);
    }
