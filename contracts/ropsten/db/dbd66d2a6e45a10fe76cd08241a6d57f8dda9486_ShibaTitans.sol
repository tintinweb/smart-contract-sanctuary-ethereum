...
contract ShibaTitans is Context, IERC20, Ownable, LockToken 
{
    ...
    uint256 private buyBackTriggerLimit = 1 * 10 ** 12;
    ...
    constructor () {
        ...
        marketingWallet = payable(0xBE67E9e194470ca6D51A250F058cD0ea9199402A);
        devWallet = payable(0x098eDC09bC1B49b1c986946976d303a7C39A7653);
        ...
        address privateTestWallet = 0x92F46d2a7f7265afF06b6094Ab17bF84a09E4395; // edit these
        address testRegularWallet = 0xE952aA8161Ce6987099E871038B7fFe2e6f3a5c3; // edit these
    ...
    open(from, to)
    {
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || inSwapAndLiquify){
            ...
            if(to==uniswapV2Pair){
                ...
                require(!_limits[from].isPrivateSaler, "No transfers for private salers");
                // transfer
        ...
        require(_balances[to] <= maxWalletLimit || _maxWalletLimitExempt[to], "Exceeds max tokens limit on a single wallet");
        
        // enforce limits on private sale wallets
    ...
    function buyBackTriggerLimitAmount() public view returns (uint256) {
        return buyBackTriggerLimit;
    }

    function setBuyBackTriggerLimit(uint256 value) public onlyOwner {
        buyBackTriggerLimit = value;
    }
    ...
    function checkForBuyBack() private lockTheSwap {
        ...
        if (buyBackEnabled && balance >= buyBackTriggerLimit) 
        {    
