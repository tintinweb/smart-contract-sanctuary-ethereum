 ...
 */
contract BlueMoonCustom is ERC721, Ownable {
    using SafeMath for uint256;

    address public ownerWalletAddress;

    constructor(address setOwnerWalletAddress, string memory name, string memory symbol) ERC721(name, symbol) public {
...
contract FactoryBlueMoon {
    ...
    function deployNewCollection(address ownerAddress, string memory name, string memory symbol) public returns (address){
        BlueMoonCustom toDeploy = new BlueMoonCustom(ownerAddress, name, symbol);
