...
contract BobaFarm {
    ...
    function getBobaBalance() public view returns (uint256) {
        return bobaBalance[msg.sender];
    }

    function getMilkStakingBalance() public view returns (uint256) {
        return milkStakingBalance[msg.sender];
    }

    function getTeaStakingBalance() public view returns (uint256) {
        return teaStakingBalance[msg.sender];
    }

    function getPearlStakingBalance() public view returns (uint256) {
        return pearlStakingBalance[msg.sender];
    }
