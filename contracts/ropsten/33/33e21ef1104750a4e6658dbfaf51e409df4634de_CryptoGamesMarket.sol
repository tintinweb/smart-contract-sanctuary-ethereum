...
contract CryptoGamesMarket is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CryptoGamesMarket() {
        ...
        name = "CryptoGamesMarket";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "CGM";                                             // Set the symbol for display purposes (CHANGE THIS)
