    ...
    UUPSUpgradeable
{
    ...
    function getCreators(uint256 id) public view returns(address[] memory) {
        return _tokenCredit[id].creators;
    }
    function getRoyalties(uint256 id) public view returns(uint256[] memory) {
        return _tokenCredit[id].royalties;
    }
