pragma solidity ^0.4.4;
	...
	///
    /// This ERC20 Token h2g2(HHGTTG) is NOT meant to have any intrinsic (fundamental) value nor any
	...
	/// then you will no doubt know WHY the Total Supply is ONLY 42 Tokens. This Token Contract has been
	/// designed to return the SAME amount of h2g2(HHGTTG) Tokens as the amount of ETH sent to the
	/// contract with the smallest amount being: .000000000000000001 of ETH which will return the same
	/// amount of HHGTTG until the total supply of 42 HHGTTG Tokens is depleted. The following text has been
	/// lifted from WikiPedia on 9 June 2018, the date of creation of this token contract.
...
contract h2g2 is StandardToken { // Contract Name.
    ...
    */
    ...
    function h2g2() {
        ...
        name = "h2g2";								// Set the name for display purposes.
        decimals = 18;									// Amount of decimals for display purposes.
        symbol = "HHGTTG";								// Set the symbol for display purposes
