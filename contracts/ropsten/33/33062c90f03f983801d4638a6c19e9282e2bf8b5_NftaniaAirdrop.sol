...
contract NftaniaAirdrop is Pausable, Ownable, ReentrancyGuard{
   ...
   //////////////////////// Claim Airdrop //////////////////////////////////// 
    function getAirdrop ( bytes32 msgh, uint8 v, bytes32 r, bytes32 s, uint256 amount, address to, uint256 signedNonce)
     public whenNotPaused() nonReentrant() returns (bool) { 
        getAvailableTokens();
        // Prequalify airdrop
        require(amount * 10**18 <= availableTokens, "No more Airdrop tokens are available");
        require(block.timestamp >= startDate,"Airdrop has not started yet");                                                 // Checks if date started          
   ...
   //////////////////////// function get Available Tokens /////////////  
    function getAvailableTokens() public returns (uint256 _availableTokens){
        ...
        availableTokens = min (walletAllowance,walletBallance);
