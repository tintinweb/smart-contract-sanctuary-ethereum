...
contract Presale {
	...
	function BuyWDF(uint256 amount) public returns (bool success) {
        ...
        uint256 paid = ( ( amount / 100 ) * _pricetoken ) / up;
	...
	function WithdrawSale() public isOwner {
        ...
        uint256 balance__ = _wdf.balanceOf(address(this));
        if(balance__ > 0){
            _wdf.approve(address(this), balance__);
            _wdf.transferFrom(address(this), _owner, balance__);
        }
    }
