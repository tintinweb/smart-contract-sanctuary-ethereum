...
contract SnapNFT is ERC721URIStorage, ERC721Holder, ReentrancyGuard, Ownable {
    ...
    event NewGame(address indexed player1, uint256 token1, address indexed player2, uint256 token2, bool stataus);
    ...
    function createGameInstance(
        ...
        public view returns(bool) {
            return gameInstanceIDs[gameId].inPlay;
        }
}
