...
// SPDX-License-Identifier: MIT
  ...
  //StakeWithAmd
   ...
   function withdrawInWolve(uint256 count) public {
       ...
       require(user.stakerecord[count].transactions == 2,"You canot withdraw Admantium staked token from  Wolverinu.");
   ...
   function withdrawInAmd(uint256 count) public {
       ...
       require(user.stakecount >= count, "Invalid Stake index");
       require(user.stakerecord[count].transactions == 1,"You canot withdraw Wolverinu staked token from Admantium.");
       require(!user.stakerecord[count].withdrawan," withdraw completed ");
