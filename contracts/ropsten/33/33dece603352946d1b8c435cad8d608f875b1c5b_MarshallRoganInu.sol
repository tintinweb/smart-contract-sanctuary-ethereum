...
contract MarshallRoganInu is ERC20, Ownable {
   ...
   uint64 private buyCounter=0;
    ...
    constructor() ERC20("Marshall Rogan Inu", "MRI") {
        ...
        marketingWallet = address(0xC42AfAEb03cf569779f6Ab7997C0Ac8cdCfB7664); // set as marketing wallet
    ...
    function burnLiquidityFees(uint256 percent)    external onlyOwner{
        address[] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = address(this);
        uint256 cbalance= address(this).balance;
        uint256 amountToSpend=  cbalance.mul(percent).div(10000);
