...
contract ContractDevelopmentV2 is ERC721A {
    uint256 public constant PRICE = 0.0005 ether;
    uint256 public constant MAX_SUPPLY = 6969;
    uint256 public constant MAX_SALE_QUANTITY = 200;

    constructor() ERC721A("Contract Development (v2)", "ContractDevelopmentV2") {}

    function mint(uint256 quantity) external payable {
        require(quantity <= MAX_SALE_QUANTITY, "INCORRECT_QUANTITY");
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://ipfs.io/ipfs/ContractDevelopmentV2/";
    }
}