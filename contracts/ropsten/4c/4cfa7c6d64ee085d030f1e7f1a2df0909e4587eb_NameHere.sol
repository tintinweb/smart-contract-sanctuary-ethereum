...
10% project development tax on sales
*/
...
contract NameHere is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "NameHere";                                                // name
    string private _symbol = "SYM";                                             // symbol
    ...
    address payable public marketingWallet = payable(0x37C3347BD41F733F46b02D33b302360A139f6C7e); // marketing wallet
