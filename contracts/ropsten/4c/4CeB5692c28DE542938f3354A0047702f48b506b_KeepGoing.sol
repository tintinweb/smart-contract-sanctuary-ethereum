...
contract KeepGoing is Context, IERC20, Ownable {
    string private constant _name = "KeepGoing";
    string private constant _symbol = "KGG";
    uint8 private constant _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x708160a1475B9aEA74Ab2e66209c528F23f7D665);
