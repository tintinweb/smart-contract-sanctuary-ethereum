...
*/
    ...
    function rarity(uint16 _tokenId) private view returns(uint64)
    {
        uint32 count;
        uint8 i;
        uint8 ti;
        ...
        for(uint8 t = 0; t < 4; t++)
        {
            ...
            //console.log(randomHash >> ti * 8) ;
            //console.log(randomHash >> ti * 6 & 0x40);
           // console.log(i);
            while ((randomHash >> (ti * 8)) & 0xff > i)
            {
                i += newRarityMath[count];
                count++;
            }
            /*
            console.log (count); //<< (ti*8));
            console.log(1 << ti * 6);
            */
            console.log (count);
    ...
    {
        tokenTraits[_tokenId] = uint16(rarity(_tokenId));
