...
contract Bittwatt is Token,Claimable, PausableToken {
    ...
    function createTokenEscrow(address _beneficiary, uint _date,address _token) public {
        address escrowContract = new EscrowContract(msg.sender,_beneficiary,_date,_token);
        escrowContracts.push(escrowContract);
    }
