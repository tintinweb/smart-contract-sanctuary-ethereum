...
// ----------------------------------------------------------------------------
//
// Maleum Foundation MAL token public sale contract
//
...
contract MaleumIcoDates is Owned {

    uint public dateMainStart = 1536017000; // 09/02/2018 @ 1:52pm (UTC)
    uint public dateMainEnd   = 1536019000; // 09/02/2018 @ 2:22pm (UTC)


    uint public constant DATE_LIMIT = 1536019000 + 1 days;
...
// ----------------------------------------------------------------------------
//
// Maleum public token sale
//
// ----------------------------------------------------------------------------

contract MaleumToken is ERC20Token, Wallet, LockSlots, MaleumIcoDates {
    ...
    string public constant name = "Maleum";
    string public constant symbol = "MAL";
    uint8 public constant decimals = 18;

    // Token number of possible tokens in existance

    uint public constant MAX_TOTAL_TOKEN_SUPPLY = 10000 * E18;


    // crowdsale parameters
    // Opening ETH Rate: USD$300
    // Therefore, 1 ETH = 7500 FTM --- 0.04$ per token
    //3+2+10+15+70
    // Total token for sell 15400
    ...
    uint public constant MAXIMUM_FIRST_DAY_CONTRIBUTION = 3 ether;

    uint public constant TOKEN_MAIN_CAP = 6000 * E18;
