...
contract Exchange {
    ...
    constructor(address token , uint256 _tokenprice){
        owner = msg.sender;
        Apad = IERC20(token);
    ...
    function sell(uint256 _amount) external{
        require(Apad.balanceOf(msg.sender)>=_amount*tokenprice);
        Apad.transferFrom(msg.sender, address(this),_amount*tokenprice);
