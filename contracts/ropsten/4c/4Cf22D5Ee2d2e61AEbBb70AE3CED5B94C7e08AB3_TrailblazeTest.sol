...
contract TrailblazeTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Trailblazie Test", "TT") {
    setHiddenMetadataUri("ipfs://QmcdQBRCtT54DWvxQWBaPPCZJBRzntX6kvPc9rAC4EP5gA/hidden.json");
  }
