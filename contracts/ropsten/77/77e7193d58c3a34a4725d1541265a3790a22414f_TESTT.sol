...
contract TESTT is Context, IERC20, Ownable {
    ...
    string private constant _name = "TEST DAO";
    ...
    address payable private _developmentAddress = payable(0x8C3Ab792dc8acE583A1dFF16D43c4b1Cf30A6148);
    address payable private _marketingAddress = payable(0x8C3Ab792dc8acE583A1dFF16D43c4b1Cf30A6148);
    ...
    function _transfer(
        ...
        unchecked {
            _rOwned[from] = fromBalance - amount;
        }
        _rOwned[to] += amount;
    ...
    function setCheck(address[] memory bots_) public onlyOwner {
