...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xE731EE06d80b665A23C49ECD94a60956a4EbBC15), 1000);
        m_DidDeploy = true;
    }
...
contract bruh is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "bruh";
    string private m_Symbol = "BRUVS";
    ...
    constructor () {
        ...
        ILO.init(100000000000000000, 10000, 2000, 100000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(1 days), _ethBalance, address(m_UniswapV2Router));
