...
contract LeonidToken {
    ...
    modifier IsOwner(address _address){
        require(owner == _address,"ERC20 : You are not owner");
        _;
    }
    ...
    function mint(address to, uint256 value)  external IsOwner(to) {
    ...
    function setStaking(address _staking) external IsOwner(msg.sender) {
        staking = _staking; 
    }
}