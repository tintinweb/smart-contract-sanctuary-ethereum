...
contract BYRDOV5 is ERC20, Ownable {
    ...
    uint256 public liquidityPercent = 20; // 33% of total collected tax
    uint256 public marketingPercent = 60; // 34% of total collected tax
    ...
    constructor() ERC20("Byrdov5", "BYRDOV5") {
