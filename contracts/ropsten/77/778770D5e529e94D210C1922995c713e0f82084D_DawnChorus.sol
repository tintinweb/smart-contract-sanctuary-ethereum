...
contract DawnChorus is ERC721DC, ReentrancyGuard, Ownable, IDawnChorus {
  ...
  function requestExhibition(
    ...
    emit ExhibitionRequest(tokenId, startTime, endTime, uri);
  }
  ...
  function retractRequest(uint256 tokenId) public onlyTokenOperator(tokenId) {
    ...
    _requestStatuses[tokenId] = RequestStatus.NONE;
    _requestTypes[tokenId] = RequestType.NONE;
    _designatedRecipient[tokenId] = address(0);
  }
  ...
  function approveTransfer(uint256 tokenId, address to) public onlyOwner {
    require(
      _requestStatuses[tokenId] == RequestStatus.PENDING,
  ...
  function approveSale(uint256 tokenId, address to, uint256 price) public onlyOwner {
    require(
      _requestStatuses[tokenId] == RequestStatus.PENDING,
...
//  - no operators (setApprovalForAll always reverts)
//  - no burning
//  - no direct transfers except for token 0
...
contract ERC721DC is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        revert("DC: This contract doesn't support operators");
    }
