...
contract TwapRelayer is ITwapRelayer {
        ...
        )
    {
        ...
        checkLimits(tokenOut, _amountOut, false);
    ...
    {
        checkLimits(tokenOut, amountOut, true);
    ...
    function getPricesVolume(
        ...
        for (uint256 i; i < amountsLength; ++i) {
            if (isSellSide) {
                ...
                checkLimits(tokenOut, prices[i], false);
            } else {
                checkLimits(tokenOut, amounts[i], true);
    ...
    function checkLimits(
        ...
        if (denormalize) {
            ...
            if (tokenOutDecimals > 18) {
                amount = amountOut.mul(10**(tokenOutDecimals - 18));
            } else if (tokenOutDecimals < 18) {
                amount = amountOut.div(10**(18 - tokenOutDecimals));
            }
        }
