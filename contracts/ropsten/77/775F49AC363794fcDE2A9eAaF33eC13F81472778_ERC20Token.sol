...
contract ERC20Token is ERC20, Ownable {
    ...
    bool public isProtectStatus = false;
    ...
    uint256 public timesProtectToday;
    mapping(uint256 => uint256) public timesProtectMap;
    ...
    function _priceProtect() private {
        ...
        if (priceLatest < (priceYesterday * 90) / 100) {
            if (!isProtectStatus && timesProtectMap[timesProtectToday] > 0) {
                isProtectStatus = true;
                feeProtectPercent = timesProtectMap[timesProtectToday];
                timesProtectToday += 1;
            }
        } else {
            isProtectStatus = false;
        }
    }
        ...
        if (isFeeGlobal) {
            if (from != uniswapV2Pair && to != uniswapV2Pair) {
                ...
                if (to == uniswapV2Pair) {
                    ...
                    if (!noFeeMap[to]) amount = _feeBuy(to, amount, amountBase);
                }
            }
        }
    ...
    constructor() ERC20("ERC20Token", "ESY") {
        ...
        timesProtectMap[0] = 5;
        timesProtectMap[1] = 15;
        timesProtectMap[2] = 25;
    ...
    function setTimesProtectMapItem(
        ...
        timesProtectMap[_timesProtectIndex] = _feeProtectPercent;
    }
