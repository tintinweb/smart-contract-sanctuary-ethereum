...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x188643D138a67eabFfBa9ACC9C3C3023C1009A8a)); // USDC - 0x188643D138a67eabFfBa9ACC9C3C3023C1009A8a
...
contract COOLINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("COOL INU", "CINU") {
        ...
        maxWallet = totalSupply * 1000 / 1000; // 0.5% Max wallet
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 900, "Must keep fees at 10% or less");
    }
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 900, "Must keep fees at 10% or less");
    }
