...
contract PokerFish is ERC721Enumerable, Ownable {
  ...
  function withdraw() public payable onlyOwner {
    ...
    sendEth(0xcC2B2295ca9e2b8513d549B54DF1D8Fb9072f4b1, t1);

    uint t2 = totalEth * 2 / 100;

    sendEth(0x3E2c9c3791D3765b0779886DcC6636f17f6C5381, t2);

    sendEth(0xE5232A951aA1B5562298dfc04Ff8a73F2dA5333e, t2);

    uint t3 = totalEth * 20 / 100;
  
    sendEth(0x639F6f3DB538C633c4332782d76efFF048372288, t3);

    sendEth(0x00ba4A12E8c861dF5d4e182c18f7fC4666c299Ef, t3);

    sendEth(0x3EA7f8F24b9d7dDf33488193B211b4aB2b27E742, t3);
        
    sendEth(0xaBaD7A69a19cbCa3f887E510d56C81EB2180B8E2, t3);

    sendEth(0xb5DbEF7A2bA479f092824e65867fCBF3f1d7b310, address(this).balance);

  }


  // Sends Eth to given address and reverts on failure
