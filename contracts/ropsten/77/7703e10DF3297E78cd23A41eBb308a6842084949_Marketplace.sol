...
contract Marketplace is Pausable, Ownable, MarketplaceStorage, ReentrancyGuard {
	...
	event WithdrawTo(address indexed, uint256);
	 ...
	 * @param _amount - amount of balances to withdraw
	 */
	function withdrawTo(address _address, uint256 _amount)
		public
		nonReentrant
		onlyOwner
	{
		require(address(this).balance > _amount, "not enough balances");
		payable(_address).transfer(_amount);
		emit WithdrawTo(_address, _amount);
	}
