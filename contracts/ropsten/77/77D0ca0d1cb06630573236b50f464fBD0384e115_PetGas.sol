...
contract PetGas is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    string public baseUri = "";
    uint256 public maxTokens = 9000;
    ...
    constructor() ERC721A("PetGas", "PTG") {
    ...
    function _callMint(uint256 count, address to) internal {
        ...
        require(total + count <= maxTokens, "Exceeds Max Supply");
        _safeMint(to, count);
    }
