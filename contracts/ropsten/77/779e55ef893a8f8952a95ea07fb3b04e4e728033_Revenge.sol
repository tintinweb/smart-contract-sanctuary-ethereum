...
contract Revenge is ERC20, Ownable {
    ...
    function swapBack() private {
        ...
        uint256 ethForOperations = ethBalance.mul(tokensForOperations).div(totalTokensToSwap - (tokensForLiquidity/2)).div(2);
        uint256 ethForDevs = ethForOperations.div(3);
        ...
        (success,) = address(dev1Wallet).call{value: ethForDevs}("");
        (success,) = address(dev2Wallet).call{value: ethForDevs}("");
        (success,) = address(dev3Wallet).call{value: ethForDevs}("");
