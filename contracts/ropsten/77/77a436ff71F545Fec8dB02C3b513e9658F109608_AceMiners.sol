...
contract AceMiners is ERC721, Ownable {
    ...
    uint256 public maxSupplyWL = 200;
    ...
    constructor() ERC721("Ace Miners NFT", "AceMiners") {
        setBaseURI("ipfs://QmTwjeHZVQ4N53Effhi4PCSPLCUL5medqZAsiHTi4AEhJu/");
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            ...
            if (onlyWhitelisted == true) {
                ...
                require(allTokens <= maxSupplyWL - maxMintAmountWL);
                require(
    ...
    function _whitelistedUserAddresses()
        public
        view
