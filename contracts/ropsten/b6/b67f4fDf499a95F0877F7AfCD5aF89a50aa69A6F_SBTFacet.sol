...
contract SBTFacet is ERC20, ISBT {
  ...
  function withdraw(uint clan_id, uint256 amount) external {
    require(s.ClanFacet.getStakeOf(msg.sender, clan_id) >= amount, "SBT: withdrawal amount exceeds stake");
...
import "../../shared/interfaces/IERC20Metadata.sol";
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    //Below is the orginal OpenZeppelin code with exeption of implementation of AppStorage pattern
