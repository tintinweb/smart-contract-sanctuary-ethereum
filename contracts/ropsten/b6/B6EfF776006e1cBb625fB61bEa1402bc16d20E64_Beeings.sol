...
// File: contracts/dev-beeings.sol
...
contract Beeings is ERC721, Ownable, Pausable {
	...
	address 								_address_for_withdrawal = 0x668275221aE8aAE93B2C0eA7C6D80F5B2e5264e4;
	...
	function mint(uint256 mint_num) public payable {
		...
		if(_is_whitelist_only) {
			...
			uint256 token_count = get_addr_minted_balance(msg.sender);
			require(token_count + mint_num <= _mint_limit_whitelist, 'You have exceeded maximum mint limit.');
		}
