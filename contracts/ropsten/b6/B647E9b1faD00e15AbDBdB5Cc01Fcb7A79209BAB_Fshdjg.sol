...
contract Fshdjg is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/694/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/694/contract-uri";
	...
	constructor(address _signerAddress) ERC721("fshdjg", "TEST") {
