...
contract MultiTokenSwap {
    ...
    function multiSwap(
        IERC20[3] calldata sellToken,
        IERC20[3] calldata buyToken,
        address[3] calldata spender,
        address payable[3] calldata swapTarget,
        bytes[3] calldata swapCallData
        )
        external
        onlyOwner
        payable{
            ...
            obj.fillQuote(sellToken[2], buyToken[2], spender[2], swapTarget[2], swapCallData[2]);
