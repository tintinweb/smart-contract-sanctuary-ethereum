...
contract MST is ERC20, Ownable {
    ...
    constructor() ERC20("Mystery Staking Token", "MST", 18) {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);  //Ropsten testnet - CHANGE
    	...
    	marketingWallet = address(0x5B4D2BebB976fE2fF198ceb9d2BeB480DA130007); // set as marketing wallet
    	liquidityWallet = address(0x5B4D2BebB976fE2fF198ceb9d2BeB480DA130007); // set as liquidity wallet
        stakingAddress = address(0x5B4D2BebB976fE2fF198ceb9d2BeB480DA130007); // set as staking wallet / contract
        jumpStartWallet = address(0x5B4D2BebB976fE2fF198ceb9d2BeB480DA130007); // set as Jump Start wallet
        utilityWallet = address(0x5B4D2BebB976fE2fF198ceb9d2BeB480DA130007); // set as utility wallet
