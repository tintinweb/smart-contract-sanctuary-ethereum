...
contract FeesManagerUpgradeable is OwnableUpgradeable {
    ...
    address private windowContract;

    function initialize() external initializer {
        __Ownable_init();

        windowContract = 0x22ff9E30BfF6aFe43Bd139DCD3af16D31Cd45115;
        buyBurnFee = 8;
        buyDevFee = 0;
    ...
    function estimateFees(
        ...
        require(_msgSender() == windowContract, "Not Window contract");
