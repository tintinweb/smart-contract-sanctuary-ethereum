...
contract Pill is IBEP20, Auth, IERC721Receiver {
    ...
    constructor (
        ...
        nhatmanager = INhatManager(0xA73E3C58139c13062CA578EEd4946103FCeFBDa5);
        ...
        _allowances[address(this)][0xC36442b4a4522E871399CD717aBDD847Ab11FE88] = _totalSupply;
        WBNB = uniswapRouter.WETH9();

        isFeeExempt[msg.sender] = true;
        isFeeExempt[0xA73E3C58139c13062CA578EEd4946103FCeFBDa5] = true;
        isFeeExempt[0xC36442b4a4522E871399CD717aBDD847Ab11FE88] = true;
        
        isFeeExempt[0xE592427A0AEce92De3Edee1F18E0157C05861564] = true;
        ...
        approve(0xE592427A0AEce92De3Edee1F18E0157C05861564, _totalSupply);
