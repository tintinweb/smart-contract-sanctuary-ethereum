...
contract Akkredetiv {
   ...
   //nur für Demo Zwecke
   function resetContract (uint256 newAnzahlungAmount, uint256 newContractAmount, string calldata newDeliveryTerms, string calldata newStartHarbor, string calldata newEndHarbor) public{

      anzahlungAmount = newAnzahlungAmount;
      contractAmount = newContractAmount;
      deliveryTerms = newDeliveryTerms;
      startHarbor = newStartHarbor;
      endHarbor = newEndHarbor;
      status = 1;
   }
/*
