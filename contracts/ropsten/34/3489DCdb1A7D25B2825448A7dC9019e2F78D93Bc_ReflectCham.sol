...
contract ReflectCham is IERC721, Ownable, Functional {
	...
	address doxxed = payable(0xA8c604F8475236dfD43CD96245a53F4dF7391Fb0); //REPLACE ADDRESS(0) WITH PAYOUT ADDRESS!!!
	address artist = payable(0x104EF0c5B8811980D72A22520a774C934ef4665B);
	address toronto = payable(0x585e43dB33732e98438D0D28fE66A07355D79935);
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == ReflectCham.onERC721Received.selector;
    }
