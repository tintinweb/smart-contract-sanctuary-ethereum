...
contract Escrow {
   ...
   //VARIABLES
    ...
    function addData(address payable client, uint price) public onlyOwner {
        dataCount+=1;
    ...
    function roolcomplete(address payable client, uint price) onlyOwner payable public{
        
        client.transfer(price * (1 ether));
        currState = State.COMPLETE;
    }

    function roolbroken(uint price) onlyOwner payable public{
