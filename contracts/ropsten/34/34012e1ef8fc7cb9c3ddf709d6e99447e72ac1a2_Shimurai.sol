 ...
 * */
 ...
 contract Shimurai is Context, IERC20, Ownable {
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x779139C4497a3D2226A5aebf34BFbdC8bb15a5d3);
         _feeAddrWallet2 = payable(0x779139C4497a3D2226A5aebf34BFbdC8bb15a5d3);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x779139C4497a3D2226A5aebf34BFbdC8bb15a5d3), _msgSender(), _tTotal);
     }
