...
abstract contract Blacklistable is Ownable {
    ...
    */
    ...
    function updateBlacklister(address _newBlacklister) public onlyOwner {
        ...
        contract XYZTOKEN is ERC20, LockToken, Blacklistable {
            using SafeMath for uint256;
        ...
        modifier lockTheSwap {
            ...
            function _transfer(
                ...
                balanceOf(to).add(amount) <= _maxWalletBalance
                 || amount <= _maxTxAmount,
                "Balance is exceeding maxWalletBalance or Transfer amount exceeds the maxTxAmount."
                );
            ...
            if (from == uniswapV2Pair) {
                ...
                super._transfer(from, _charityAddress, charityTokens);
                super._transfer(from, to, amount);
                ...
                {
                uint256 liquidityTokens = amount.mul(_liquidityFee).div(1000);
