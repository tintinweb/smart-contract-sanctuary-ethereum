...
contract Caca is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 4, "Porut: Max 3 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_SUPPLY,
            "Porut: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        require(
            ...
            "You must own the NFT to traverse"
        );
        require(
        ...
        require(
            ...
            "koko: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "caca: Failed to withdraw Ether");
    }
