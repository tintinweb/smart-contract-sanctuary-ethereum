...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[xtkn212302][ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[xtkn212302][ownable] new owner is the zero address");
...
abstract contract Team is Context, Ownable{
    ...
    modifier onlyTeam(){
        require(_isTeamMember(_msgSender()), "[xtkn212302][team] only team can access this function!");
        _;
    }
...
contract XTKN212302 is Context, IERC20, Ownable, ReentrancyGuard, Team{
    // public properties
        // lib
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals
            string private _name = "XTKN212302"; // the name of our project
            string private _symbol = "XTKN212302";
    ...
    function setTaxesBuy(uint16 pMarketing, uint16 pDev, uint16 pBurn) public onlyTeam{
        require((pMarketing + pDev + pBurn) <= 100, "[xtkn212302] sum of all taxes can't exceed 10%!");
        TAX_BUY_MARKETING = (
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[xtkn212302] approve from the zero address");
        require(spender != address(0), "[xtkn212302] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[xtkn212302] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[xtkn212302] transfer amount exceeds allowance"));
        return(true);
    }
