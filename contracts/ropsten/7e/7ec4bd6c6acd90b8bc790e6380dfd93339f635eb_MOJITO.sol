...
/**
 * @title MOJITO contract.
 * @author The MOJITO team.
 *
 * @notice Airdrops a MOJITO.
 *
 */
contract MOJITO is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function mintMojito(address[] calldata recipients) external onlyOwner {
