...
//                                        _               _   
// _ __   _ __   ___   _ __ ___    ___   | |_   ___  ___ | |_ 
//| '_ \ | '__| / _ \ | '_ ` _ \  / _ \  | __| / _ \/ __|| __|
//| |_) || |   | (_) || | | | | || (_) | | |_ |  __/\__ \| |_ 
//| .__/ |_|    \___/ |_| |_| |_| \___/   \__| \___||___/ \__|
//|_|
//
//different art
//
...
contract PromoTest is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/75/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/75/contract-uri";

    address public tokenfyAddress = 0x41387f9da1cE00e574e57ed5B6D77D796A948889;
    ...
    uint256 public tokenfyPrice = 100000000000000000;

    // presale settings
    address private signerAddress;
    mapping(address => uint256) public presaleMinted;
	uint256 public presaleMaxSupply = 0;
	uint256 public presaleMaxPerMint = 0;
	...
	constructor(address _signerAddress) ERC721A("promo test", "TEST") {
