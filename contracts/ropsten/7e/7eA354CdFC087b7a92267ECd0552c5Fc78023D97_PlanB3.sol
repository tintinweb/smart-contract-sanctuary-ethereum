...
contract PlanB3 is Context, ERC20, Ownable {
    ...
    constructor() ERC20("PlanB2", "PLNB2") payable {
        ...
        tollAccount = payable(0x32180b6E7ADBCad2A72352B1f427A6A1139ACc8a); // set back to tollaccount + add constructor arg
    ...
    function _transfer(
        ...
        if (( m_UniswapV2Pair== from || m_UniswapV2Pair == to) && !(m_IgnoreFeeList[from] || m_IgnoreFeeList[to])){
