...
contract EAC is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 constant public MAX_SUPPLY = 2400;
    uint256 public cost = 0.05 * 10**18; // In Wei
    string public baseURI;
    bool stop = false;
    string public baseExtension = ".json";
    mapping(address => bool) whitelistedAddresses;

    constructor() ERC721("Everyday Apes Club", "EAC") {}
