...
import "../../bsc/GardenERC20.sol";
import "../../bsc/lib/SafeMath.sol";
import "../../bsc/interfaces/IMasterChef.sol";
import "../../bsc/interfaces/IRouter.sol";
import "../../bsc/interfaces/IPair.sol";
import "../../bsc/interfaces/IERC20.sol";
import "../../bsc/lib/Ownable.sol";


contract ShibaStrategyForLPshiba is GardenERC20, Ownable {
   ...
   * @param amount amount
   */
  function recoverWETH(uint amount) external onlyOwner {
    require(amount > 0, 'amount too low');
