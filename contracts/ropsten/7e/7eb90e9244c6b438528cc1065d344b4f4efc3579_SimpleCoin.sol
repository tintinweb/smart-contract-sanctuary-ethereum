...
contract SimpleCoin is ERC20Interface{
    ...
    constructor() {
        ...
        _totalSupply = 1000000 * 10**uint(_decimals); // multiply by decimals 
    ...
    function allowance(address ownerAllowance, address spender) public view virtual override returns (uint256){
        return 0;
    }
