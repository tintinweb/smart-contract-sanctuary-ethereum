...
contract ChimpersX is ERC721A, Ownable {
    string public baseURI = "ipfs://QmYEkBYBTSLmecDEXY8jFQztE38KFYNgtqaYBhSFyE7LkW/";
    ...
    constructor() ERC721A("ChimpersX", "CMPX") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        if(Free_MAX_SUPPLY > totalSupply()){
            ...
            require(_amount * price == msg.value, "Not enough funds provided");
        }
