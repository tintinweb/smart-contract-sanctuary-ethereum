 ...
 * {ERC721Enumerable}.
 */
contract ColdBloodedCreepaz is Context, ERC721A, Ownable, ReentrancyGuard  {
    ...
    constructor(string memory _baseURI, address _signer) ERC721A("Cold Blooded Creepz", "CBC") {
    ...
    function mintCreepz(uint256 amount) public payable nonReentrant callerIsUser {
    ...
    function mintCreepzWL(uint256 amount, bytes calldata signature) public payable nonReentrant callerIsUser {
        uint256 supply = totalSupply();
