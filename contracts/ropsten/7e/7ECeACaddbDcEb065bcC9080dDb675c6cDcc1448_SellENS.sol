...
contract SellENS {
    ...
    function verifySale(string memory ensNAME,address buyer,address token,uint value) public view returns(bool,address) {
	bytes32 hash=keccak256(abi.encodePacked(ensNAME,buyer,token,value));
