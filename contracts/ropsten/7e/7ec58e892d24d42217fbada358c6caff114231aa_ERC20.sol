...
contract Archbel is ERC20, Ownable {
    ...
    uint256 internal buyCharityFee;
    uint256 internal buyTreasuryFee;

    uint256 public sellTotalFees;
    uint256 public sellOperationsFee;
    uint256 public sellLiquidityFee;
    uint256 internal sellCharityFee;
    uint256 internal sellTreasuryFee;

    uint256 public tokensForOperations;
    uint256 public tokensForLiquidity;
    uint256 internal tokensForCharity;
    uint256 internal tokensForTreasury;
    ...
    function setCharityAddress(address _charityAddress) internal onlyOwner {
