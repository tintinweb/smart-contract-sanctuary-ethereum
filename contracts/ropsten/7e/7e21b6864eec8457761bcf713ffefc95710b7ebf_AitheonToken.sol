...
// File: contracts/BulkableToken.sol
...
contract BulkableToken is Ownable, ERC20Basic {
    ...
    // storage instance of BulkArray
    BulkArray bulkAddressList;

    /**
     * Send Bulk Transactions from main contract/owner
     *
     * Send `_value` tokens to `_to` in arrays provided in attempt to save on transaction fees
     *
     * @param _addressList contains addresses
     * @param _amountList matching values to send
     */
...
contract Foundation is MintableToken, StandardBurnableToken, Pausable {
    ...
    */
    ...
    /**
    * 
    * Add or remove exemption addresses
...
// File: contracts/AitheonToken.sol
...
contract AitheonToken is Foundation {
    ...
    function buyTokens(address _user) public payable {
        ...
        // ethPrice should be integer $875.00 => 87500  10^2
        // aicPrice should be integer $0.245  => 245    10^3
