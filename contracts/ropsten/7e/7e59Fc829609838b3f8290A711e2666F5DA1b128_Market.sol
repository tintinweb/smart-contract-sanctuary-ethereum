...
contract Market is IMarket {
    ...
    function _finalizeNFTTransfer(uint256 tokenId, address bidder) private {
        ...
        if(_soldTokenList[tokenId])   // Secondary sale
        {
            ...
            payable(address(0x3c739BEa9af7c33045b6E26655E0E6Fa04d18f21)).transfer(creatorAmount);
        }
...
contract Media is IMedia, ERC721Burnable, ReentrancyGuard {
     ...
     */
    constructor(address marketContractAddr) public ERC721("XYZ", "XYZ") {
        ...
        nonReentrant
    {
        ...
        // IMarket.BidShares memory bidShares = IMarket.BidShares(0, uint256(10).mul(Decimal.BASE), uint256(90).mul(Decimal.BASE));
