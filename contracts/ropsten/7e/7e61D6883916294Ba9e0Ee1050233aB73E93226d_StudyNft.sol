...
contract StudyNft is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint public constant maxMintBatch = 20;//用户最大购买
    uint256 public constant tokenPrice = 10000000000000000; // 你要出售的价格0.01 ETH数字越大越贵
    uint256 public maxTokensCount = 5555;//总量
    ...
    constructor() ERC721("cutecat", "CC") {
        baseURI = "https://ipfs.io/ipfs/QmUvbx9gLnz13ckB6LZYQdEe5DoQe2x6MbZYu8XBZyP8GX/"; // 填写您的baseURI
        baseTokenURI = "https://ipfs.io/ipfs/QmbBCeA6riFn69vCjaBhwr9oHQwebPjgmhLV6ydHfCdqTx?filename=_metadata.json";//JSON地址
        contractURI = "";
    }
