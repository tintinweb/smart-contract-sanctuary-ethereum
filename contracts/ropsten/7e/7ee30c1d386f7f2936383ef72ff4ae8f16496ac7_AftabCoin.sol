...
contract AftabCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AftabCoin() {
        ...
        name = "AftabCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-002";                                             // Set the symbol for display purposes (CHANGE THIS)
