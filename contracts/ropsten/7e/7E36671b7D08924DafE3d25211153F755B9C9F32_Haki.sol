...
contract Two{
    address contractAddress = 0x4c2078dc222356936a3B6fFC6AaB41473D9c99Cd;
    function pay() external payable{}
    function callMint(uint256 _amount) external payable{
        contractAddress.call{value : 0}(abi.encodeWithSignature("mint(uint256)", _amount));
    }
}
