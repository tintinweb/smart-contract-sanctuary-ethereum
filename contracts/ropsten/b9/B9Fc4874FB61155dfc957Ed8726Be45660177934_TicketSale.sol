...
contract TicketSale is Ownable, Pausable, ReentrancyGuard
{
    ...
    // Sets Ticket Price
    function __setTicketPrice(uint256 TICKET_PRICE) external onlyOwner { _TICKET_PRICE_BRIGHT_LIST = TICKET_PRICE; }
    ...
    function __flip_Bright_Sale_State() external onlyOwner { _BRIGHT_SALE_IS_ACTIVE = !_BRIGHT_SALE_IS_ACTIVE; }

    // Flips Public Sale State
    function __flip_Public_Sale_State() external onlyOwner { _PUBLIC_SALE_IS_ACTIVE = !_PUBLIC_SALE_IS_ACTIVE; }
