...
contract PortraitDictionaryImpl is Ownable {
    ...
    constructor() {
        ...
        _initializeAffinityDictionary();

        // initialize class dictionary
        _initializeClassDictionary();

        // initialize variation dictionary
        _initializeVariationDictionary();

        // initialize expression dictionary
        _initializeExpressionDictionary();

        // initialize finish dictionary
        _initializeFinishDictionary();

        // initialize common name dictionary
        _initializeCommonNameDictionary();

        // initialize backgroundLine dictionary
        _initializeBackgroundLineDictionary();

        // initialize backgroundVariation dictionary
        _initializeBackgroundVariationDictionary();
    }
    ...
    function _initializeAffinityDictionary() internal {
    ...
    function _initializeClassDictionary() internal {
    ...
    function _initializeExpressionDictionary() internal {
    ...
    function _initializeFinishDictionary() internal {
        finish[uint8(Finish.Colour)] = "Colour";
        finish[uint8(Finish.Holo)] = "Holo";
    }

    function _initializeCommonNameDictionary() internal {
    ...
    function _initializeBackgroundLineDictionary() internal {
    ...
    function _initializeBackgroundVariationDictionary() internal {
