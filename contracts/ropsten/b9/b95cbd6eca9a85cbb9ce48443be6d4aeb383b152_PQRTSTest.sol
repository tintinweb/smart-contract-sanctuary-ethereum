...
contract PQRTSTest is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PQRTSTest() {
        ...
        name = "P & GP";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 6;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PQRTS";                                             // Set the symbol for display purposes (CHANGE THIS)
