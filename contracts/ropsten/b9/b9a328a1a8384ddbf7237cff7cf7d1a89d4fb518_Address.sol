...
contract SkyStar is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xC529b108f86C808b54728c4dF30D24A1f9C3F5e9); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0xA4b6f9C923412Ee71DbcDaE511438498f7dD89BB); // Liquidity Address
    ...
    uint256 private constant _tTotal = 3000000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "SkyStar Token";
    string private constant _symbol = "SkyStar";
    ...
    constructor() {
        address newOwner = address(0xA4b6f9C923412Ee71DbcDaE511438498f7dD89BB);
        ...
        maxTransactionAmount = _tTotal * 100 / 100; // 100% maxTransactionAmountTxn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        maxWallet = _tTotal * 100 / 100; // 100% max wallet
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                // extra tax if bought in the same block as trading active for 72 hours
