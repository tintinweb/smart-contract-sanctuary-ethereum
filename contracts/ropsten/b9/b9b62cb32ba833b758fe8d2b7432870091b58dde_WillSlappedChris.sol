...
// Will Smith was right or wrong ?. Vote your opinion here : https://xoyondo.com/ap/r7XJ0PtRAWiuubE

contract WillSlappedChris is Context, IERC20, Ownable
{
    ...
    string private _name 	= 'Will Smith was right or wrong ?';
    string private _symbol 	= 'WillSlappedChris';
