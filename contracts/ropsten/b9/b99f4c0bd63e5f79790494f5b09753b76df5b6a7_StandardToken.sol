...
// File: contracts/Traceability.sol
...
contract StandardToken is ERC20, Ownable{
  ...
  Traceability public traceability; // add @ Traceability
  ...
  constructor(string _name, string _symbol, string _decimals, uint _initialSupply, address _account) payable public{
    name = _name;
    symbol = _symbol;
    decimals = _decimals;
    ...
    traceability = Traceability(0xbc02e9A33c0908985612A2975682bC5Bd9e8Bcef);
    traceability.addContract(this, "Token");
    emit NewContract(owner,this,"Token");
    assert(_account.send(msg.value));
