    ...
    function createParty(
        ...
        BeaconProxy party = new BeaconProxy(
            ...
            abi.encodeWithSignature(
                "initialize(address,(string,string,string,string,string,bool,uint256,uint256),string,uint256,address,address)",
                msg.sender,
                partyInfo,
                tokenSymbol,
                initialDeposit,
        ...
        IERC20Upgradeable(denominationAsset).transferFrom(
            msg.sender,
            address(this),
            initialDeposit + fee
        );
        IERC20Upgradeable(denominationAsset).transfer(PLATFORM_ADDRESS, fee);
        IERC20Upgradeable(denominationAsset).transfer(
            address(party),
            initialDeposit
        );
