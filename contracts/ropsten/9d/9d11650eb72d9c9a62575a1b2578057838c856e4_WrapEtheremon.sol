...
interface WrapEtheremonInterface {
    ...
    function whitelistKyberAddress(address _kyber) public;

    /// @notice Can only be called by operators
    /// @dev Sets the KyberNetworkProxy address
    /// @param _kyberProxy KyberNetworkProxy contract address
    function setKyberProxyAddress(address _kyberProxy) public;
...
contract WrapEtheremon is WrapEtheremonInterface, WrapEtheremonPermissions, Utils2 {
    ...
    /// @param _kyberProxy KyberNetworkProxy contract address
    /// @param _etheremon EtheremonExternalPayment contract address
    constructor (address _kyber, address _kyberProxy, address _etheremon) public {
        kyber = _kyber;
    ...
    /// @dev Sets the KyberNetworkProxy address
    /// @param _kyber KyberNetworkProxy contract address
    function whitelistKyberAddress(address _kyber) public onlyOperator {
      kyber = _kyber;
    }
    ...
    /// @dev Sets the KyberNetworkProxy address
    /// @param _kyberProxy KyberNetworkProxy contract address
    function setKyberProxyAddress(address _kyberProxy) public onlyOperator {
      kyberProxy = KyberNetworkProxyInterface(_kyberProxy);
    }
        ...
        )
    {
        ...
        require(kyberProxy == _kyberProxy);
        ...
        returns (uint monsterId)
    {
        ...
        // allowance to 0
        require(token.approve(kyberProxy, 0));
