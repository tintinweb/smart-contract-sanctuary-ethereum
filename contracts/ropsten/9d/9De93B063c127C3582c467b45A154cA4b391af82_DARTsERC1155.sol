...
contract DartsAccessControl is AccessControl, ERC2981TokenRoyalties{
    ...
    function supportsInterface(bytes4 interfaceId)
        public view virtual override(AccessControl, ERC2981Base) returns (bool) {
        return super.supportsInterface(interfaceId);
    }
