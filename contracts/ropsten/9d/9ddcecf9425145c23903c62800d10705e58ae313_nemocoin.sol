...
contract nemocoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function nemocoin() {
        ...
        name = "nemocoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "nnn";                                             // Set the symbol for display purposes (CHANGE THIS)
