...
contract dextst is Context, Ownable {
        ...
        payable
    {
        ...
        // require((_amount == price && _token == token) || (msg.value == price && token == address(0)));

        require(_amount == price);

        // make sure the erc20 token matches what's expected
        // 
        ...
        emit MarketPurchase(seller, _msgSender(), _point, price, _token);
    }
