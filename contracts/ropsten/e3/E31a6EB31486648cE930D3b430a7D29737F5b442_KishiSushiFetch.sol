...
contract KishiSushiFetch {
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'KishiSushiFetch: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'KishiSushiFetch: INSUFFICIENT_B_AMOUNT');
    }
