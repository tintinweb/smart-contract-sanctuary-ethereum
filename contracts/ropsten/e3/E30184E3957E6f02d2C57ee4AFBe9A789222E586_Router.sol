...
contract ReactMakerExploitMock {
    XBarman public immutable reactMaker;

    constructor(address _reactMaker) {
        reactMaker = XBarman(_reactMaker);
    }
...
import "../pantry/XLendFees.sol";

contract ReactMakerKashiExploitMock {
    XLendFees public immutable reactMaker;

    constructor(address _reactMaker) {
        reactMaker = XLendFees(_reactMaker);
    }
