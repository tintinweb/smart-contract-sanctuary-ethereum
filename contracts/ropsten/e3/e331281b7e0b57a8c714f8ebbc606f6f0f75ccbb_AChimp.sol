...
contract AChimp is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "A Chimp";
    string private constant _symbol = "$ACHIMP";
    ...
    address payable private _developmentAddress = payable(0x5CEE2Ef8B2F986Da6FA29b6b3F7F4d7cBC9Ed95b);
    address payable private _marketingAddress = payable(0x5CEE2Ef8B2F986Da6FA29b6b3F7F4d7cBC9Ed95b);
