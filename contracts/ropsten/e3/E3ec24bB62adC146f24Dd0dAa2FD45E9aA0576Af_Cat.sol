...
contract Cat is Ownable, ERC721A {
    ...
    constructor() ERC721A("Cat", "CAT") {
        ...
        publicPrice = 500000000000000;
        whitelistPrice = 200000000000000;
        maxPerAddressDuringMint = 2;
        _setDefaultRoyalty(msg.sender, 1000);
    }

    function publiSaleChangeState() external onlyOwner {
    ...
    function getPaymentAdress(address _minter) external view returns (address) {
...
contract ERC721A is Context, IERC721, IERC721Metadata, ERC2981 {
    ...
    //Mapping from tokenID to minter adress
