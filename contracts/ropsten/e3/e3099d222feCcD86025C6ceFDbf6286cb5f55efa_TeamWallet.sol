...
contract TeamWallet {  
  ...
  constructor(
    ...
    firstUnlockDate = now + (12 * 1 minutes); // Allow withdraw 20% after 12 month    
    secondUnlockDate = now + (24 * 1 minutes); // Allow withdraw 30% after 24 month
    thirdUnlockDate = now + (36 * 1 minutes); // Allow withdraw all after 36 month    
