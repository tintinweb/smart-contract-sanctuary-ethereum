...
contract SELT is ERC20Interface, Owned, SafeMath {
    ...
    mapping(address => bool) public gottenToken;
    ...
    function getToken() public returns (bool success) {
        //Check already getToken
        require(!gottenToken[msg.sender]);
        
        //record that voter has gottenToken
        gottenToken[msg.sender] = true;
        
        //give Token
        balances[msg.sender] = 1;
        emit Transfer(this, msg.sender, 1);
        return true;
    }
