...
contract smolcontract is ERC721A, Ownable {
    ...
    address private constant artistAddress =
        0x1bDB53944d91C0FB6Cb96cD8cCD1996F49A2eC90;
    ...
    function withdraw() external onlyOwner {
        Address.sendValue(payable(artistAddress), address(this).balance * 45 / 100);
        Address.sendValue(payable(devAddress), address(this).balance * 25 / 100);
        Address.sendValue(payable(marketing1Address), address(this).balance * 15 / 100);
