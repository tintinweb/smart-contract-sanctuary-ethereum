...
contract PortraitLayer is BaseIlluvitar {
        ...
        )
    {
        ...
        (tierUint256, p) = _atoi(blueprint, p);
        tier = uint8(tierUint256);
     ...
     */
    function _atoi(bytes memory a, uint8 index) internal pure returns (uint256 i, uint8 p) {
