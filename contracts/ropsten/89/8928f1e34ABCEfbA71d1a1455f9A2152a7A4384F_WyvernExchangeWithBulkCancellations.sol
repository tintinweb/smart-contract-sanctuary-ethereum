...
contract WyvernExchangeWithBulkCancellations is Exchange {
    string public constant codename = "WyvernExchangeWithBulkCancellations";

    /**
     * @dev Initialize a WyvernExchange instance
     * @param registryAddress Address of the registry instance which this Exchange instance will use
     * @param tokenTransferProxyAddress 
     *  par am tokenAddress Address of the token used for protocol fees
     */
