...
contract AA_MC_3 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x406D07C7A547c3dA0BAcFcC710469C63516060f0); // XXXXXXXXXX 2
    ...
    string  private constant _name = "AA_MC_3"; 
    string  private constant _symbol = "AA_MC_3";  
    ...
    */
    ...
    // swapTrigger 0.25% of supply
    uint256 public swapTrigger = _tTotal/400;
    ...
    */
    ...
    function Swap_Trigger_Tokens(uint256 number_of_Tokens) external onlyOwner {
        // Add 1 to trigger to avoid resetting to 0 to reduce gas
        swapTrigger = number_of_Tokens * 10**_decimals;
    }
