...
/**
 * @title Cryptosoph ERC20 token
 *
 * @dev Implementation of the Cryptosoph Token.
 */
contract CryphosToken is StandardToken
{
    string public name = "Cryptosoph";
    ...
    address public constant RAVI_ADDRESS = 0x405f192b188ac94072B20de9732Fd6D9F1D99c67; // 0xB75066802f677bb5354F0850A1e1d3968E983BE8;
    uint public constant    RAVI_ALLOCATION = 120000000000000; // 4%

    address public constant JULIAN_ADDRESS = 0x76abdC05e7031c2739C87E95a654b520DcF677E2;// 0xB2A76D747fC4A076D7f4Db3bA91Be97e94beB01C;
    uint public constant    JULIAN_ALLOCATION = 120000000000000; // 4%

    address  public constant ABDEL_ADDRESS = 0x8505648A9fd048852fD9262e854a652DEFbEb10F;// 0x9894989fd6CaefCcEB183B8eB668B2d5614bEBb6;
    uint public constant     ABDEL_ALLOCATION = 120000000000000; // 4%

    address public constant ASHLEY_ADDRESS = 0xEeD5b9cD392471F8d22d94E17F3b9E92A6b43240; // 0xb37B31f004dD8259F3171Ca5FBD451C03c3bC0Ae;
    ...
    // Is the spender address one of the Cryptosoph Team?
