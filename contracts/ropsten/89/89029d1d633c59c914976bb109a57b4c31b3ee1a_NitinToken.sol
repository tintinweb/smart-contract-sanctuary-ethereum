...
contract NitinToken is StandardToken {
    ...
    */
    string public name = "Nitin Token";                   //fancy name: eg Simon Bucks
    ...
    string public symbol = "NITN";                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function NitinToken(
        ...
        name = "Nitin Token";                                   // Set the name for display purposes
        decimals = 0;                            // Amount of decimals for display purposes
        symbol = "NITN";                               // Set the symbol for display purposes
    }
