...
contract Shitster is Ownable {
    ...
    constructor(
        ...
        value = ValueLiquidityToken(0xaD4707AEc9B7a48D21E5915bFa878032cEa8737c);
        insuranceFundAddr = 0xaD4707AEc9B7a48D21E5915bFa878032cEa8737c;
        valuePerBlock = 1; // supposed to be 0.001 (1e16 wei)
        startBlock = 1; // supposed to be 10,883,800 (Fri Sep 18 2020 3:00:00 GMT+0)
    }
