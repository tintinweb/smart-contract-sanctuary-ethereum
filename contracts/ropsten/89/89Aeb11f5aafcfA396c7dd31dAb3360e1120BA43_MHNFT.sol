...
contract MHNFT is ERC721, Ownable, Mintable {
    using Strings for uint256;

    uint256 private constant MAX_TOKEN_COUNT = 600;
    uint256 private constant TOKENS_PER_ITEM = 100;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmZsJg1WgGVTBoGUebWN7pJokPstEQUAMLjCCejZLjfkPn/";
    }
        ...
        returns (string memory)
    {
        ...
        // Get the item ID from the token ID
        uint256 itemId = (tokenId - 1) / TOKENS_PER_ITEM;
