...
contract Ashib {
    ...
    //burn mechanic
    //when want to burn token (not the creator of the token) will send those tokens to the burn address.
    function burnto(address _who, uint256 _value) private returns (bool) {
