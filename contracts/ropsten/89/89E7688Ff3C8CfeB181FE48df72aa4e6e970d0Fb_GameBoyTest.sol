...
contract GameBoyTest is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("GameBoy Test", "GBT") {
    setHiddenMetadataUri("ipfs://QmecH4Gc9xm7XkXcCVpZvjjnvpy9i4AFMegtYtWsHY4Nrx/contract.json");
  }
