...
contract sPAXG is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked PAXG", "sPAXG", 9) ERC20Permit() {
    ...
    /**
        @notice increases sPAXG supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPAXG
