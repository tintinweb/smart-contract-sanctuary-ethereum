...
contract TokenERC20 {
    ...
    uint8 public decimals = 18;     //位数的小数点后多少位
...
contract ExMoneyToken is owned, TokenERC20 {
    ...
    /* Initializes contract with initial supply tokens to the creator of the contract */
    function ExMoneyToken(
        uint256 initialSupply,
        string tokenName,
        string tokenSymbol,
        address centralMinter
    ) TokenERC20(initialSupply, tokenName, tokenSymbol) public {
        if (centralMinter!=0 ) owner = centralMinter; //所有者
    }
    ...
    /// @notice 设置价格
    /// @param  newSellPrice  出售价格
    /// @param  newBuyPrice   购买价格
