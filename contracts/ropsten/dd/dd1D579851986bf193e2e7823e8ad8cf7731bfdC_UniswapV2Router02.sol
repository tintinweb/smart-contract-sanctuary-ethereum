...
interface IUniswapV2Router01 {
    ...
    function getAmountsOut(uint amountIn, address[] calldata path, address factory) external view returns (uint[] memory amounts);
...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function addLiquidity(
        ...
        (amountA, amountB) = _addLiquidity(tokenA, tokenB, amountADesired, amountBDesired, amountAMin, amountBMin, factory);
    ...
    function removeLiquidityETHWithPermitSupportingFeeOnTransferTokens(
        ...
        amountETH = removeLiquidityETHSupportingFeeOnTransferTokens(
            token, liquidity, amountTokenMin, amountETHMin, to, deadline, factory
        );
    }
