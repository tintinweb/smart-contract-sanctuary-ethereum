...
contract sss is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "sss";
    string constant _symbol = "sss";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 10000) / 10000;
    uint256 _maxSellTxAmount = (_totalSupply * 10000) / 10000;
    uint256 _maxWalletSize = (_totalSupply * 10000) / 10000;
    ...
    address payable public liquidityFeeReceiver = payable(0xF3C3319363591F8f9a7Eee56a00f8922F0f63B84);
    address payable public marketingFeeReceiver = payable(0x3e01A1785E2C6b9dC99AC976588Caf6C09C6bde3);
    ...
    function swapBack(uint256 amount) internal swapping {
        ...
        uint256 totalBNBFee = totalFee - (liquidityFee / 5);

        uint256 amountBNBLiquidity = (amountBNB * liquidityFee / 5) / totalBNBFee;
