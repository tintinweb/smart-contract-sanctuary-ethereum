...
contract NomanLiteCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NomanLiteCoin() {
        ...
        name = "NomanLiteCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-045";                                             // Set the symbol for display purposes (CHANGE THIS)
