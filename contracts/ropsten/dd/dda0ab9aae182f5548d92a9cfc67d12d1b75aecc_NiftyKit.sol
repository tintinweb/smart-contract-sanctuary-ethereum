...
contract NiftyKit is Initializable, OwnableUpgradeable, INiftyKit {
    ...
    function initialize(address dropImplementation, address tokenImplementation, address mutateImplementation)
        public
        initializer
    {
        __Ownable_init();
    ...
    function setMutateImplementation(address implementation) external onlyOwner {
