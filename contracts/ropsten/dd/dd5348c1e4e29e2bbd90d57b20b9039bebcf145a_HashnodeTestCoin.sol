...
contract HashnodeTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTestCoin() {
        balances[msg.sender] = 1000000000000000000000;               // To be standard complicant keep it 1000000000000000000000
        totalSupply = 1000000000000000000000;                        // To be standard complicant keep it 1000000000000000000000
        name = "HashnodeTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // To be standard complicant keep it 18
