...
contract MasterChef is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor() {
        niob = NiobToken(payable(0xaD4707AEc9B7a48D21E5915bFa878032cEa8737c));
        startBlock = 0;
        niobPerBlock = 1e18;
        lockTime = 5 * DAY_IN_SECONDS;
    ...
    //withdraw niob token
    function withdrawNiob(uint256 _amount) public nonReentrant whenNotPaused {
        require(!blacklisted[msg.sender], "blacklisted");
