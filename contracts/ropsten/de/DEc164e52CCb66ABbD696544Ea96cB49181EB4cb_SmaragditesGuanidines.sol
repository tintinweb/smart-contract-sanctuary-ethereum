...
/**
 * @title SmaragditesGuanidines
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract SmaragditesGuanidines is ERC20FlashMint, ERC20Burnable, ERC20Capped, ERC20Permit, ReentrancyGuard {
    address private _owner;

    constructor() ERC20("Smaragdites Guanidines","RANN") ERC20Capped(1000000000 * (10**uint256(decimals()))) { 
        _owner = _msgSender();
     }
