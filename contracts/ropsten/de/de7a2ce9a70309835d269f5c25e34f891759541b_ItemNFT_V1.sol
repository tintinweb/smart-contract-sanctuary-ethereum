...
contract ItemNFT_V1 is ERC721Enumerable, Ownable {
    ...
    mapping(uint256 => Warranty) public TokenWarranty;
    mapping(uint256 => Product) public TokenProduct;
    ...
    function hasWarrentyExpired(uint256 _tokenId) public view returns (bool) {
        require(_tokenId <= tokenId, "Invalid Token Id");
        Warranty memory w = TokenWarranty[_tokenId];
