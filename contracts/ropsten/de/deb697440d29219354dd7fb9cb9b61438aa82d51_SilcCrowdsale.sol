...
contract MyRefundableCrowdsale is FinalizableCrowdsale {
  ...
  function getDeposit() public view returns(uint256 depositedValue) {
    return vault.getDeposit(msg.sender);
  }
}
...
contract SilcCrowdsale is CappedCrowdsale, MyRefundableCrowdsale {
  ...
  function getTokenIssued() public returns (uint256 token) {
    return tokenIssued[msg.sender];
  }
