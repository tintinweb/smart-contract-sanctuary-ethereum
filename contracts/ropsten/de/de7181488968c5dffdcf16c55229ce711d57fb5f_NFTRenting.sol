...
contract NFTRenting is Context {
    ...
    function setForRent(string memory rentId, address tokenNFT, uint256 _tokenId, address paymentToken, uint256 price, uint256 period) public onlyTokenOwner(tokenNFT, _tokenId) checkIsRented(rentId){
    ...
    function rent(string memory rentId) public checkIsRented(rentId){
