...
contract PEOToken is ERC20 {



    constructor() ERC20("PEO", "PEO") {
    ...
    **/
    ...
    function setIstransferEnabled (bool value) external onlyOwner {
    ...
    **/
    function mintTo(address to, uint256 amount) public onlyOwner {
        require(totalSupply() + amount <= 10000000000 * 10**18, " 10 Billion POE only");
        _mint(to, amount);
    }
    /**
