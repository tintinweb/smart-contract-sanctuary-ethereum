...
contract Ownable {
     ...
     */
    constructor() public {
        owner = 0x490324F8980Dd54d0707B2350A530F3CD3feEF43;
    }
...
contract PallyToken is ERC20,PoSTokenStandard,Ownable {
    ...
    //HardCodedAddresses
    address GamificationReserve = 0x3bb9E8b21E4447A01551c7c282B47682779314B1;
    address AirdropOne = 0xeDaDca53d02C6EDfb2B01748Dc9C324EaF507540;
    address AirdropTwo = 0x1f57c1d15C993200BA402BEe4659F8D3DAec8136;
    address PrivateFunding = 0x6a6046f39990754131EA885C7bB830b5CB36205D;
    address MarketingAllocation = 0x5cc1Cbd344A229634430eB3D1402975446543b7a;
    address BountyPayments = 0x41B19BAfA078CB9414dC68cF8619219ae60Ca3D0;
    address PallyNetworkFoundation = 0xf0A0DE601E538402aC341a34018B046Ad9d0FDC0;
    address TeamAllocation = 0xBF0351669697Bb64d47693E11Ddc44902EB37F1b;
    //Mappings
    ...
    function annualInterest() constant public returns(uint interest) {
        ...
        // Due to the monthly added interests, compounding should be taken into account.
        // Effective annual interest rate = (1 + (nominal rate / number of compounding periods)) ^ (number of compounding periods) - 1
        if((_now.sub(stakeStartTime)).div(1 years) == 0) {
            // 1st year effective annual interest rate is 5% when we select the stakeMaxAge (30 days) as the compounding period.
            interest = (49 * baseIntCalc).div(100);
        } else if((_now.sub(stakeStartTime)).div(1 years) <= 10){
            // 2nd to 8th year effective annual interest rate is 5%
            interest = (49 * baseIntCalc).div(100);
        }
    }
