...
/**
  Chris Rock Inu STATS:
   0% burned when sold only 
   0% fee auto distribute to all holders
   3% fee auto add to charity & Marketing
...
contract ChrisRockInu is Context, IBEP20, Ownable {
