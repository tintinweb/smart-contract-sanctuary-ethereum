...
contract NFTMinting is ERC721A, Ownable, ReentrancyGuard {
    ...
    address public w1 = 0x1335bA3abD959130C3b71087Dd453182528Cf63C;
    // address public w1 = 0x94aC2B4Cd463dAA10B8960D418073Dc0A5C67CA5;//Daniel

    uint8 public constant percentW1 = 100;       // wallet1 will receive 100%
    uint256 public constant PRESALE_MAX_CNT = 1000;
    ...
    constructor() ERC721A("NFT Minting Contract Using ERC721A", "NMCUEA", 20) {
        ...
        for(uint8 i = 0; i < 5; i ++) {
            _safeMint(0x6Ae6F2fEc9d97e37bBFb3F17D68d84a996BB1B6A, 10);
        }
        for(uint8 i = 0; i < 2; i ++) {
            _safeMint(0x68cA2a9956e99EB1dB7FD88997575e6520F0300d, 10);
        }
    }
    ...
    function setWithdrawWalletAddress(address _addr) external onlyOwner {
        w1 = _addr;
    }
    ...
    function mintPresale(uint256 tokens, bytes32[] memory merkleProof) external payable {
        ...
        require(totalSupply() + tokens <= PRESALE_MAX_CNT, 'Cannot purchase for presale');
        ...
        require(pricePresale * tokens == msg.value, "ETH amount is incorrect");
