...
contract ClubVirtual is NFTokenMetadata {
 ...
 uint256 _tokenId;
  ...
  {   address payable _creator = payable(creator);
      ...
      uint256 ownerpercent=(10000000000-adminpersent-royaltypersent);
      uint256 creatoramount = (amount * royaltypersent)/10000000000;
      uint256 adminamount = (amount*adminpersent)/10000000000;
      uint256 owneramount = (amount*ownerpercent)/10000000000;
