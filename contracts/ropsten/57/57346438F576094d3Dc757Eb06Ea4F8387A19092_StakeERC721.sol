...
contract StakeERC721 {
    ...
    function claimReward() external returns (bool) {
        ...
        // require(stakeInfos[msg.sender]. == 0, "Already claimed");
        ...
        noReentrant
    {
        ...
        require(erc20Contract.balanceOf(address(this)) >= 0, "No More tokens available fro reward" 
        ...
        stakeable += (interestRate  * (stakeTime/60)) ;
