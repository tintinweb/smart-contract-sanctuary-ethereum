...
contract AlphaStaking is ERC20("AlphaStak", "xAlpha"){
    ...
    function Staking(uint256 _amount) public {
        ...
        // If no xAlpha exists, mint it 1:1 to the amount put in
        if (totalShares == 0 || totalAlpha == 0) {
            _mint(msg.sender, _amount);
        } 
        // Calculate and mint the amount of xAlpha the Alpha is worth. The ratio will change overtime, as xAlpha is burned/minted and Alpha deposited + gained from fees / withdrawn.
        else {
    ...
    function UnStack(uint256 _share) public {
        // Gets the amount of xAlpha in existence
        uint256 totalShares = totalSupply();
        // Calculates the amount of Aplha the xAlpha is worth
