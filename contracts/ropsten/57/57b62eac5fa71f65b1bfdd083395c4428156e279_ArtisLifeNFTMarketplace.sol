...
contract ArtisLifeNFTMarketplace {
        ...
        notPaused
    {
        ...
        require(nftsForAuction[auctionId].owner != sender, "Cannot bid own auction.");
        require(
    ...
    {
        uint256 auction = auctionId;
        require(block.timestamp > nftsForAuction[auction].expirationTime, "Auction still active.");
        require(
