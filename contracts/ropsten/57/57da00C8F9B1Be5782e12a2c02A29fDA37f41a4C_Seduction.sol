...
contract Seduction is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    function addToWhiteList (address user) public onlyOwner {
        require(!(whiteListIndexOfUser[user] > 0), "This Address is already in the WhiteList!");
    ...
    function removeFromWhiteList (address user) public onlyOwner {
        require(whiteListIndexOfUser[user] > 0, "This Address does not exist in the WhiteList!");
