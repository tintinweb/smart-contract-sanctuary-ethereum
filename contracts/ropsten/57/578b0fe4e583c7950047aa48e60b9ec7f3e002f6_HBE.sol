...
contract HBE is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 6_281_971_000 * 10**9;
    ...
    string private constant _name = "H B";
    ...
    function HappyBirthday() external onlyOwner() {
