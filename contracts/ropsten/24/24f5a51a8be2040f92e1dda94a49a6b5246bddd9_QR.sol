...
contract QR is Context,IERC20, Ownable{
    ...
    uint256 private _totalSupply = (1000000 * 10**4) * 8**_decimals; //1T supply
    ...
    address _owner;
    address payable public marketingAddress = payable(0xa31A8A2e42d2EF878395d7908a4C29BB3c33dC1a);
    ...
    uint256 QRDaycooldown = 0;
    bool private tradeEnabled = false;

    
    uint256 private sellliqFee = 1;
    uint256 private sellprevLiqFee = 10;
    ...
    function QRDay() public onlyOwner{
         require(block.timestamp > QRDaycooldown, "You cant call QRDay more than once per day");
    ...
    function QRDayOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         QRDaycooldown = block.timestamp + 86400;
    }
