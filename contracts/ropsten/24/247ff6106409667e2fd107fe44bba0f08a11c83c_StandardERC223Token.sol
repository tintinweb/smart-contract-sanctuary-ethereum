...
/**
 * @title StandardERC223Token
 * @dev StandardERC223Token is a standard ERC223 Token with ERC20 functions and events
 *      Fully backward compatible with ERC20
 */
contract StandardERC223Token is ERC223, Ownable {
    ...
    constructor() public {
        balances[msg.sender] = totalSupply; // Creator gets all initial tokens.
    }
