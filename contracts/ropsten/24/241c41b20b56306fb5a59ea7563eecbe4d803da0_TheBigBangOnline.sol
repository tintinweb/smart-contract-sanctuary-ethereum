...
Contact e-mail: <a href=/cdn-cgi/l/email-protection class=__cf_email__ data-cfemail=472a26352e232229232e223507283722292a262e2b25283f69283520>[email&#160;protected]</a>
...
contract TheBigBangOnline is Ownable {
    ...
    // Jackpot
    uint public jackpotLevel2Amount = 0.05 ether;//1 ether;
    uint public jackpotLevel3Amount = 0.1 ether;//10 ether;
    uint public jackpotLevel4Amount = 0.5 ether;//100 ether;    
    ...
    uint public increaseJackpotTimeAfterBetLevel2_3 = 1 minutes;//1 minutes;  //If more than 1 ETH in Jackpot Bank 
    uint public increaseJackpotTimeAfterBetLevel4 = 30 seconds;//30 seconds;  //If more than 100 ETH in Jackpot Bank 
 ...
 function createBet(uint _referrerID) public payable notFromContract {
  ...
  //Delete before the release to the main network !!!!!!!! Only for the test version!!!
