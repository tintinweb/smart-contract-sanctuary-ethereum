...
contract Happyfeet is ERC721A, Ownable {
    ...
    uint64 public price;
    uint64 private totalPrice;
    uint64 private supply;
    mapping(address => uint64) private addressMintCount;
    ...
    function updatePrice(uint64 _price) external onlyOwner() {
      price = _price;
    }
    ...
    function mint(uint64 _quantity) external payable {
      ...
      unchecked {
        ...
        supply = uint64(totalSupply()) + _quantity;
      }
