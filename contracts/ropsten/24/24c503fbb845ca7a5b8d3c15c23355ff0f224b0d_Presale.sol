...
contract CommonTokensale is MultiOwnable, Pausable {
    ...
    function softCapCompleted() {
      uint totalBalanceUSD = weiToUSD(balance);
      require(totalBalanceUSD >= minCapUSD);
      isSoftCapComplete = true;
    ...
    function() public payable {
        ...
        if(isSoftCapComplete) {
          ...
          if(inversorToSponsor[_buyer] > 0) {
            sponsorToComisionList.push(inversorToSponsor[_buyer]);
