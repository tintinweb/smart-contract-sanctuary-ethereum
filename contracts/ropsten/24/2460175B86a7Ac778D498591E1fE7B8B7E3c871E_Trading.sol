...
contract Synchron is ISynchron,ERC1155Holder{
    ...
    function getActieOfferId(uint256 orderId) public view returns(uint256 offId){
...
contract Trading is IEnum,ERC1155Holder{
    ...
    function getNftInfo(address token,uint256 id) public view returns(uint256 royal,address mine){
        if(IERC165(token).supportsInterface(0xd9b67a26) != false){
            (mine,royal) = IERC1155(token).getNftInfo(id);
        }else{
            (mine,royal) = IERC721(token).getNftInfo(id);
        }
    }
    ...
    function getActiveOfferId(uint256 orderId) public view returns(uint256 offId){
...
//ropsten
//token721:0x746BC4ff6f350981685C9ca4a2d5A584cD185f56
//token155:0xC850d08f7421c4b4E81B14F7a59F6783ba5D6C4b
//data:0x79bF41E51988e9eea5d1708aFf2D413A2388bBfB
//trading:0x2460175B86a7Ac778D498591E1fE7B8B7E3c871E

//factory:0xe67E99542df601629d8259d00f6522a47cb2aeeB