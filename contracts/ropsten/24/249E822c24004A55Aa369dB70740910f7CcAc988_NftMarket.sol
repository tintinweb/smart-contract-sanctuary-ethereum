...
contract NftMarket is ERC721URIStorage, Ownable {
    ...
    uint256 public maxFoxy = 7;
    uint256 public maxAquans = 15;
    uint256 public maxAlufi = 23;
    uint256 public maxFluffys= 31;
    uint256 public maxGolems= 10000;
    uint256 public maxElfos= 12000;
        ...
        returns (uint256)
    {
        ...
        require(newTokenId < maxFoxy, "Max Foxys Nfts Minted");     
        ...
        returns (uint256)
    {
        ...
        uint256 newTokenId = 8;

        require(newTokenId < maxAquans, "Max Aquans Nfts Minted");     
         for( uint i = 0; i < amount; ++i ){
        ...
        returns (uint256)
    {
        ...
        uint256 newTokenId = 16;

        require(newTokenId < maxAlufi, "Max Alufis Nfts Minted");     
         for( uint i = 0; i < amount; ++i ){
        _safeMint(msg.sender, newTokenId);
        newTokenId += 1;
        _createNftItem(newTokenId);
        ...
        returns (uint256)
    {
        ...
        uint256 newTokenId = 24;

        require(newTokenId < maxFluffys, "Max Fluffy Nfts Minted");     
         for( uint i = 0; i < amount; ++i ){
        _safeMint(msg.sender, newTokenId);
        newTokenId += 1;
        _createNftItem(newTokenId);
        ...
        returns (uint256)
    {
        ...
        require(newTokenId < maxGolems, "Max Golems Nfts Minted");     
         for( uint i = 0; i < amount; ++i ){
        _safeMint(msg.sender, _tokenIds.current());
        _tokenIds.increment();
        _createNftItem(_tokenIds.current());
        ...
        returns (uint256)
    {
        ...
        require(newTokenId < maxElfos, "Max Elfos Nfts Minted");     
         for( uint i = 0; i < amount; ++i ){
        _safeMint(msg.sender, _tokenIds.current());
        _tokenIds.increment();
        _createNftItem(_tokenIds.current());
