...
contract XenobladeChronicles is Context, IERC20, Ownable {
    ...
    uint256 public _feeAddr1;
    uint256 public _feeAddr2;
    ...
    constructor (address payable feeAddWallet) {
        _feeAddrWallet = feeAddWallet;
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxWalletSize = _tTotal.mul(6).div(100);
        _feeAddr1 = 3;
        _feeAddr2 = 0;
        tradingOpen = true;
    ...
    function excludeWalletFromFee(address[] memory addresses) public onlyOwner {
