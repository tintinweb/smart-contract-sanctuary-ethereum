...
contract SupportTransaction is Ownable
{
   ...
   RealmsOfEthernity tokenaddess ;
    ...
    function Swapout(uint256 amount , bytes calldata signature, bytes32 txhash) public returns (bool)
    {
        require(usedSigns[signature]==false, "Duplicate");
         require(_signerAddress == keccak256(
            abi.encodePacked(
         ...
         tokenaddess.Swapout(amount,msg.sender);
          emit OutSwapp(msg.sender,amount,txhash);
         return true ;
    }
