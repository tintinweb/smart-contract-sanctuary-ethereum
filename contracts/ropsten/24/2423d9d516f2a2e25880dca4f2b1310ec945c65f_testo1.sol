...
contract testo1 is Context, IERC20, Ownable, LockToken 
{
...
//        uint256 ethForLiquidity = newBalance.div(allFee).mul(_liquidityFee-buybackDivisor).div(2); //this was added to test buyback but can be removed
