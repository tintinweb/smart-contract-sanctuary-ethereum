...
contract MTToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MTToken() {
        ...
        name = "MTCoin";                                   // Set the name for display purposes (CHANGE THIS)
