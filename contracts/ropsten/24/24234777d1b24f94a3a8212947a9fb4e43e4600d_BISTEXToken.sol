...
contract BISTEXToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BISTEXToken() {
        ...
        name = "BISTEXToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BIST";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 815;                                      // Set the price of your token for the ICO (CHANGE THIS)
