...
contract PowerNetCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PowerNetCoin() {
        ...
        name = "PowerNetCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 5;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PNC";                                             // Set the symbol for display purposes (CHANGE THIS)
