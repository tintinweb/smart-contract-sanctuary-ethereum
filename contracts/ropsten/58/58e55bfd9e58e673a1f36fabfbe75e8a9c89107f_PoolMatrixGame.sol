...
contract PoolMatrixGame {
    ...
    function configureParams(uint totalTransactions, uint totalTurnover, uint users24h1, uint users24h2, uint transactions24h1, uint transactions24h2, uint turnover24h1, uint turnover24h2, uint newMode) public {
        require(msg.sender == adminWallet);
