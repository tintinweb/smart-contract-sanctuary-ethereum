...
contract sRPLC is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked RPLC", "sRPLC", 9) ERC20Permit() {
    ...
    /**
        @notice increases sRPLC supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sRPLC
