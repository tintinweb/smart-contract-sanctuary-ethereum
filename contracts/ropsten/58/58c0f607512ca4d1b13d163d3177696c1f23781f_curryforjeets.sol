...
contract curryforjeets is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "CURRYs";
    ...
    address payable private _developmentAddress = payable(0x51C7dEa8167E3dD72A25499Ad4e9850dA0907450);
    address payable private _marketingAddress = payable(0x2D9d35fAF446dDBa48173811bD9707E53A55fC03);
    ...
    uint256 public _maxTxAmount = 300000000000 * 10**9; //0.3%
    uint256 public _maxWalletSize = 100000000000 * 10**9; //1%
