...
contract CrtrToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        //TODO Change the following 9 addresses to official addresses during deployment
        _seed(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
        _private(address(0));
        _preSales(address(1));
        _foundation(address(2));
        _tech(address(3));
        _partners(address(4));
        _ecosystem(address(5));
        _marketing(address(6));
        _liquidity(address(7));
