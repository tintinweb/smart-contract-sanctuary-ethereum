...
contract ShareFile {
    ...
    // function removePer(string calldata fileId, address otherUser) public onlyFileOwner(fileId) returns (bool success){
    function removePer(string calldata fileId, address otherUser)
        public
    ...
    // function removeFile(string calldata fileId) public onlyFileOwner(fileId) returns (bool success) {
    function removeFile(string calldata fileId)
        public
        onlyFileOwner(fileId)
        returns (bool success)
    {
