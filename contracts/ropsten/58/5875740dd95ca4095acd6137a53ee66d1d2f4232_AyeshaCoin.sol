...
contract AyeshaCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AyeshaCoin() {
        ...
        name = "AyeshaCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-013";                                             // Set the symbol for display purposes (CHANGE THIS)
