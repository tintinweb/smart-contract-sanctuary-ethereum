...
contract MillionDollarTokenPage is ERC721, IERC721Enumerable, Ownable {
    ...
    uint16 public totalMintLimit; // 2000
    uint16 public singleMintLimit; // 35
    uint16 public ownershipMintLimit; // 35
    uint256 public mintPrice; // 0.01 Ether

    string public _metadataBaseURI;       // ipfs://QmVTktJb8VSi4AGeuRrv7eeedRxn8Zsh3VU543ZDwDwMbB/
    string public _defaultContentBaseURI; // ipfs://QmYeZHGzfUS4R2wfTi1wYW8Cq9eyK4Rea8QQKtG3ERhKfC/
