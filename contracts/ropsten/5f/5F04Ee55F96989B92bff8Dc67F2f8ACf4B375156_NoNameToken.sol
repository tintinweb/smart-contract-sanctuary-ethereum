...
contract NoNameToken is ERC20, Ownable, ReentrancyGuard{    
    ...
    /**
     * @param price_ Number of token units a buyer gets per wei
     * @dev The rate is the conversion between wei and the smallest and indivisible
     * token unit. So, if you are using a rate of 1 with a ERC20Detailed token
     * with 3 decimals called TOK, 1 wei will give you 1 unit, or 0.001 TOK.
     */
    constructor (string memory name_, string memory symbol_, uint256 maxSupply_, uint256 price_) ERC20(name_, symbol_) {
  ...
  function _tokenAmount(uint256 amount_) private view returns (uint256) {
      ...
      uint256 _amount = (amount_ * _coefficient) / _price;
      return _amount;
