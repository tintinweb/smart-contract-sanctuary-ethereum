...
contract ThePixelCollective is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public PRICE_PER_TOKEN_ALLOWLIST = 0.02 ether;

    mapping(address => uint8) private _allowList;

    constructor() ERC721("The Pixel Collective", "PIXEL") {}
