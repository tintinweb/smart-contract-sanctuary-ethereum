...
contract BreedingRouter is Ownable, Pausable, ERC721Holder, ReentrancyGuard {
    ...
    function setIntToBreedBoots(uint256[] calldata breedBoots) external onlyOwner {
        intToBreedBoots = breedBoots;
    }

    function setIntToSuicideRate(uint256[] calldata suicideRates) external onlyOwner {
