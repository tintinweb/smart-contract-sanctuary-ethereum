...
contract Tradex is StandardToken { 
    ...
    function Tradex() {
        ...
        name = "Tradex";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "dex";                                             // Set the symbol for display purposes (CHANGE THIS)
