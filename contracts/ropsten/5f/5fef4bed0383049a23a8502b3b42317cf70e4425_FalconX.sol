...
contract FalconX is Context, IERC20, IERC20Extented, Ownable {
    ...
    string private constant _name = "hussain";
    ...
    address payable private _marketingAddress = payable(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF);
    address payable private _teamAddress = payable(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF);
    address payable private _communityAddress = payable(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF);
