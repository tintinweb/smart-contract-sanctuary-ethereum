...
contract Sports3D {
    ...
    uint256 constant internal tokenPriceIncremental_ = 0.00000000005 ether;
    ...
    address internal employeeFeeAddress1 = 0xC6D4a4A0bf0507749D4a23C9550A826207b5D94b; 
    address internal employeeFeeAddress2 = 0xB1dB0FB75Df1cfb37FD7fF0D7189Ddd0A68C9AAF;
    address internal neatAddress = 0x5e8fAEbfd5623F9A041D7DE844f20dD8131391BF;
   ...
   /*=================================
    ...
    uint256 constant internal ambassadorMaxPurchase_ = 1.05 ether;
  ...
  function changeMarketing(address _marketingAddress) public{
    ...
    function sell(uint256 _amountOfTokens) onlyBagholders public {
        ...
        uint256 _taxedEthereum = SafeMath.sub(SafeMath.sub(SafeMath.sub(SafeMath.sub(_ethereum, _dividends), _devFee), _marketingFee), _ownerFee);
