...
// ----------------------------------------------------------------------------
// 'XCTOKEN' smart contract token ICO
//
...
// token transfers
// ----------------------------------------------------------------------------
contract TQToken is ERC20Interface, Owned, SafeMath { // 'is' indicates an inheritance relationship, in this case XCToken inherits functions from the parent class ERC20Interface
    string public symbol;
    string public  name;
    uint8 public decimals;
    uint public _totalSupply;
    uint public startDate;// start of ico
    uint public bonusEnds;// end of bonus
    uint public endDate;// end of ico


    //Two-level mapping.Holds the amount of money that a certain address A allows another address B to operate on.
    //The outermost mapping is for a certain address A and the inner mapping is 
    ...
    function TQToken() public { 
        symbol = "TQ";
        name = "TQ Token"; 
        decimals = 18;  //The maximum number of decimals, i.e. the number of 10^decimals that can be split by 1 token
    ...
    // ------------------------------------------------------------------------
    // 1,000 XCTOKEN Tokens per 1 ETH (exchange rate)
    // ------------------------------------------------------------------------
    function () public payable {
        ...
        if (now <= bonusEnds) {
            ...
            tokens = msg.value * 1000;// original exchange rate
        }
