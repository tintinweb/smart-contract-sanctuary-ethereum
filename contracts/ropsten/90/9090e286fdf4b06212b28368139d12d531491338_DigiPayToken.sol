...
contract DigiPayToken is StandardToken, Ownable, TokenSaleKYC, Pausable {
  ...
  bool    public   locked;
    ...
    function _setTimes() internal {   
        presaleStartTime          = 1540319400; // 01st Nov 2018 09:00:00 GMT
        presaleEndTime            = 1540321200; // 29th Nov 2018 08:59:59 GMT
        mainsaleStartTime         = 1540322100; // 20th Dec 2018 09:00:00 GMT
        mainsaleEndTime           = 1540326600; // 24th Jan 2019 08:59:59 GMT
    }
    ...
    function _getTokenAmount(uint256 _weiAmount) internal view returns (uint256) {
        ...
        if(now >= mainsaleStartTime && now < (mainsaleStartTime + 15 minutes)) {
            RATE = 6000; // @dev 1 ETH = 6000 DIP
        }
        
        if(now >= (mainsaleStartTime + 15 minutes) && now < (mainsaleStartTime + 30 minutes)) {
            RATE = 5750; // @dev 1 ETH = 5750 DIP
        }
        
        if(now >= (mainsaleStartTime + 30 minutes) && now < (mainsaleStartTime + 45 minutes)) {
            RATE = 5500; // @dev 1 ETH = 5500 DIP
        }
        
        if(now >= (mainsaleStartTime + 45 minutes) && now < (mainsaleStartTime + 60 minutes)) {
            RATE = 5250; // @dev 1 ETH = 5250 DIP
        }
        
        if(now >= (mainsaleStartTime + 60 minutes) && now <= mainsaleEndTime) {
