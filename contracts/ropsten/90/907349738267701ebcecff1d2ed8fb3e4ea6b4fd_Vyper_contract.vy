...
init_supply: public(uint256)
supplyLimit: public(uint256)
...
@external
def __init__():
    init_supply: uint256 = 10
    self.name = "TestToken1"
    self.symbol = "TT1"
    self.decimals = 0
    self.balanceOf[msg.sender] = 10
    self.totalSupply = 10
    self.supplyLimit = 100
...
def mint(_to: address, _value: uint256):
    assert self.totalSupply <= self.supplyLimit
