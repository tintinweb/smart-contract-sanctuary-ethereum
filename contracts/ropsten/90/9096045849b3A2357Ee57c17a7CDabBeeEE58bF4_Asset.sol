...
contract Asset is ERC721, Mintable {
    ...
    uint256 public constant ORIGINAL = 1997; 
    ...
    function _mintFor(
        ...
        _safeMint(msg.sender,ORIGINAL);
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeigf5z2pk47jvodpicpo6ckjjuhpamwhpzt37xt7vnhdy3fkq3stra/";
    }

    // Update for collection-specific metadata.
    function contractURI() public pure returns (string memory) {
        return "ipfs://bafkreid5roqbqjajkioyciuoullmennko5ilc4wgmn67vpng6bl5crby7y"; // Contract-level metadata 
    }
}
