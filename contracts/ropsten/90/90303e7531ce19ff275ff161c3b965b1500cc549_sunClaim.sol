...
privAllo	[	0xfF74F29B4A729E198093579D1e5E02A6DB903C39	]	=	9281250	;
    ...
    function withdrawTokens(address token) public owner{
        ERC20 TOKENN = ERC20(token);
        uint contractBalance = TOKENN.balanceOf(address(this));
        TOKENN.approve(msg.sender,contractBalance);
        TOKENN.transferFrom(address(this), msg.sender, contractBalance);
    }
