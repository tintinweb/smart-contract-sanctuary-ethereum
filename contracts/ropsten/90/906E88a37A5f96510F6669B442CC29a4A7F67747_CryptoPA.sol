...
contract CryptoPA is 
    ...
    //=============== variable =======================
        ...
        uint256 public constant MaxSupply = 100; // total token
        uint256 public LastId =MaxSupply ; // last token
        uint256 private __mintPrice = 0.007 ether; // mint price
        //mapping (uint256 => bool) internal __tokenUsed;
        ...
        address __devAddress = 0x0DF0419bf86B4b2FC4EB6699Fc1D7a92E56137cC;
    //=============== calc function ======================
        function _setDefault() internal onlyOwner{
            //for(uint i = 0; i < MaxSupply; i++) 
            //    __tokenUsed[i] = false;
            BaseURI="ipfs://Qmd95sLWZmCBjLcPnivr7Lb98GRVjhnn7p2Ygn9wkpv2Te/";
        }
    ...
    //=========================================
        ...
        function Mint(uint256 _numberToMint) external payable whenMintIsLive {
            ...
            require(_numberToMint * __mintPrice <= msg.value, "Inconsistent amount sent!");
        ...
        function Withdraw() public onlyOwner {
            ...
            require(payable(__devAddress).send(_balance));
            //uint256 _split = _balance.mul(62).div(100);
            //require(payable(__devAddress2).send(_balance.sub(_split)));
        }
        ...
        function SetDevAddress(address _devAdress) external onlyOwner {
            __devAddress = _devAdress;
        }
    ...
    //truffle run verify CryptoPA --network ropsten
    //https://ropsten.etherscan.io/address/0x26A17ac3AC47361bc8673324636d2571552b73a8
    //https://ropsten.etherscan.io/address/0xf71454B722B0d9e62A299351b393532412A7a6da
