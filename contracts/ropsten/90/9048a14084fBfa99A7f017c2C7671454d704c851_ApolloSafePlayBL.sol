...
// File contracts/ApolloSafePlayMultiCurrency/ApolloSafePlayBL.sol
...
/**
 * Apollo safe play token without reflection and marketing
 */
...
contract ApolloSafePlayBL is Context, IERC20Metadata, Ownable {
    // Token parameters
    string private NAME;
    ...
    function setFeeRates(
        ...
        uint256 buyFees = _buyFeeRates.liquidity + _buyFeeRates.burning;

        uint256 sellFees = _sellFeeRates.liquidity + _sellFeeRates.burning;
