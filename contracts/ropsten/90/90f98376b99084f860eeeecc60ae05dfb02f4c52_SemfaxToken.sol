...
contract SemfaxToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SemfaxToken() {
        ...
        name = "SemfaxToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SFT";                                             // Set the symbol for display purposes (CHANGE THIS)
