...
contract StreeoNft is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI, uint price)  ERC721("Streeo.io NFT", "STREEIO") {
        setBaseURI(baseURI);
        setBasePRICE(price);
    }
    ...
    function setBasePRICE(uint256 _baseTokenPrice) public onlyOwner {
        PRICE = _baseTokenPrice;
    }
