    ...
    ICreatorMinterERC721
{
        ...
        AccessControlAdmin()
    {
        ...
        AccessControlAdmin._grantRole(DEFAULT_ADMIN_ROLE, developer);
    }
     ...
     */
    function setMintPrice(uint256 mintPrice_) public onlyAuthorized {
        if (mintPrice_ <= 0) revert InvalidMintPrice();
        mintPrice = mintPrice_;
    }

    /**
     * @dev Get the price for Minting
     */
