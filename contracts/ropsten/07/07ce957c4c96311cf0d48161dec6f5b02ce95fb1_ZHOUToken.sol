...
/**
 * This is the official ZHOU Token smart contract (ZHOU) - https://ZHOU.io/
 */
 ...
 * @title ZHOUToken
 */
contract ZHOUToken is StandardToken {

  string public constant name = "ZHOUYANGCoin";
  string public constant symbol = "ZHOU";
