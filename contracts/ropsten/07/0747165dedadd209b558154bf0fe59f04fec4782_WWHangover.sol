 ...
 */
contract WWHangover is Context, ERC721A, Ownable, ReentrancyGuard  {
    ...
    uint256 public RESERVED = 69;
    uint256 public MINT_PRICE = 0.085 ether;

    bool public saleIsActive;
    bool public WLSaleIsActive;

    constructor(address signer) ERC721A("Wasted Whales: Hangover", "HO") {
        signerAddress = signer;
    }

    function mintHangover(uint256 amount) public payable nonReentrant {
    ...
    function mintHangoverWL(uint256 amount, bytes calldata signature) public payable nonReentrant {
        uint256 supply = totalSupply();
