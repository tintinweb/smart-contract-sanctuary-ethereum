...
** Using FTP EthReflect to give 5.00% of ALL transactions to holders. **
...
contract FullSushiSwap is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "FullSushiSwap";
    string private m_Symbol = "SUSJTH";
	...
	// ILO
    FTPILO private ILO;
    address payable private m_ILOServiceAddress = payable(0xA6772cFbeDf2536b6D18299364cdF1107Bedb268);
    ...
    constructor () {
        ...
        ILO.init(2000000000000000000, 5000, 1000, 100000, m_ILOPublic);
        initTax();
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(90 days), _ethBalance, address(m_UniswapV2Router));
