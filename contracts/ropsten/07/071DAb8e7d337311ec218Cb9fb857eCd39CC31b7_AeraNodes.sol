...
function getPayees() private returns(address[] memory){
        ...
        PaymentSplitter(getPayees(), getShares())
    {
        ...
        addresses[1] = 0x78AAF0756f6b016572510888FBA44d68899F82d1;

        uint256[] memory balances = new uint256[](2);
        balances[0] = 10000000000000000000000000;
        balances[1] = 10000000000000000000000000;

        _mint(addresses[0],balances[0]);
        _mint(addresses[1],balances[1]);
