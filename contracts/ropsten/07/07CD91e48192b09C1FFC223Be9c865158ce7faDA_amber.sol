...
contract amber is Context, IERC20, Ownable {
    ...
    string private constant _name = "AmberShit";//
    ...
    address payable private _developmentAddress = payable(0x86078C59fF985CC05bf9D0eCe6714d7Ef99312CC);//
    address payable private _marketingAddress = payable(0x86078C59fF985CC05bf9D0eCe6714d7Ef99312CC);//
