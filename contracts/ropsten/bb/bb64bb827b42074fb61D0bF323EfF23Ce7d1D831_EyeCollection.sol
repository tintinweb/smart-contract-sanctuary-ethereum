...
contract EyeCollection is ERC721URIStorage, Ownable{
    ...
    string private revealUrl ="https://ipfs.io/ipfs/QmXvUGTjJ7jVc7dY5ebeCqLjbx7LhdkMnY1Xo2AXRv2MB1/mystery.json";

    constructor() ERC721("EyeCollection", "EYE") public {}

    function mintNFT(address collector, string memory tokenURI) 
        payable
        public 
        returns (uint256) 
    {
