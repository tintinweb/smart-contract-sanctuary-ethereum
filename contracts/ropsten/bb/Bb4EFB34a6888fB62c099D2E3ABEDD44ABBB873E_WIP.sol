//created with ERC20 smart contract with openzeppelin wizard - https://docs.openzeppelin.com/contracts/4.x/wizard
...
contract WIP is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    ...
    constructor() ERC20("WIP", "WIP") ERC20Permit("WIP") {
        ...
        //"* 10 ** decimals()" needs to be included in order to keep the same standard format
        postThreshold = 100 * 10 ** decimals();
        commentThreshold = 25 * 10 ** decimals();
    }

    //onlyOwner is added in order to make sure only the owner of the contract can perform this action regardless of the fact the contract is public
