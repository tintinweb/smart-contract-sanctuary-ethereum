...
contract Collection is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    uint256 private constant MAX_NFT = 10;  
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,10,0,1655110800,1655112000);
        epochs[2] = EpochDetails(1,2,0,1655112600,1655113800); 
        epochs[3] = EpochDetails(3,10,0,1655114400,0); 
