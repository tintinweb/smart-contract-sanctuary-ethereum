...
contract NucleusVisionAllocation is Ownable {
  ...
  NucleusVisionToken_ASTER8794 public token;
  ...
  function NucleusVisionAllocation() public {
    token = new NucleusVisionToken_ASTER8794();
  }
...
contract NucleusVisionToken_ASTER8794 is MintableToken {
  string public constant name = "NucleusVision_ASTER8794";
  string public constant symbol = "ASTER8794";
  uint8 public constant decimals = 18;

  // Total supply of nCash tokens is 20181108
  uint256 public constant MAX_SUPPLY = 20181108 * (10 ** uint256(decimals));
   ...
   */
  function NucleusVisionToken_ASTER8794() public {
  }
