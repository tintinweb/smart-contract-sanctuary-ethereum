...
contract Facito {
    ...
    function readArticle(bytes32 _id) public returns (bool success) {
        ...
        require(this.transfer(msg.sender, 2), "Transaction failed"); // Transfer coins to reader
        require(this.transfer(articles[_id].Author, 10), "Transaction failed"); // Transfer coins to author
