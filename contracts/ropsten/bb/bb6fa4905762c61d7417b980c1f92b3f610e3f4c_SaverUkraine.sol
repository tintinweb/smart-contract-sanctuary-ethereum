...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc0f85F24C7D1d6aE0c394131E130cDA4E28f40bD;
...
contract SaverUkraine is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0xc82E3731438B6a879C61aEEbFAb435656568bC54); 
    address payable private Wallet_Token_Burn = payable(0xc82E3731438B6a879C61aEEbFAb435656568bC54); 
    address payable private Wallet_Dev = payable(0xc82E3731438B6a879C61aEEbFAb435656568bC54); 
    ...
    uint256 private _tTotal = 15000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Save Ukraine "; 
    string private _symbol = "SUKE";  
    ...
    uint256 public minPossibleReflect = 0; 


    // Setting the initial fees
    uint256 public _FeeReflection = 0; 
    uint256 public _FeeBurnTokens = 0; 
    ...
    // Maximum transaction amount (15% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(15).div(100); 
