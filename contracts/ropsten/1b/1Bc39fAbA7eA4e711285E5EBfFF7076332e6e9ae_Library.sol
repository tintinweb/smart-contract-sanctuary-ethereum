...
contract Library is Ownable {
    ...
    function borrowBook(uint id) external payable {
        ...
        // transferring 0.1LIB from msg.sender to the library contract
    ...
    function borrowBookWithSignature(bytes32 hashedMessage, uint8 v, bytes32 r, bytes32 s, address receiver, uint id) public payable {
    ...
    function convertAndWithdraw() external onlyOwner {
        address owner = owner();
        // Approve that the owner can spend the whole LIB balance of the Library
        LibToken.approve(owner, LibToken.balanceOf(address(this)));
        // Transfer the whole balance of Library from Library to the owner
