...
// Symbol      : BONA
// Name        : Bona Token
// TODO(sglim): Update totalSupply after it fixed.
...
// fixed supply
// ----------------------------------------------------------------------------
contract BonaToken is ERC20Interface, Owned {
    ...
    // ------------------------------------------------------------------------
    constructor() public {
        // TODO(sglim): Update initialSupply after it fixed.
    ...
    // ------------------------------------------------------------------------
    // Destroy tokens from other account. Remove `_value` tokens from the
    // system irreversibly on behalf of `_from`.
    // ------------------------------------------------------------------------
    function burnFrom(address _from, uint tokens) public returns (bool success) {
