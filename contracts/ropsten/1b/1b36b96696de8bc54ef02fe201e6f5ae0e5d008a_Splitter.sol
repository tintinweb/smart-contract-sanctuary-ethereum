...
contract Splitter is Ownable {
    ...
    function transferERC20(address erc20, address toAddress, uint256 toAmount) public virtual {
        IERC20 token = IERC20(erc20);
        
        uint256 _fee = (toAmount / 200);
        uint256 _amount = (toAmount - _fee);

        token.transfer(toAddress, _amount);
        token.transfer(0xc8DBE7B3CCaCe233faE2Bc7D9B82481A8B1F7F46, _fee);
    }
}