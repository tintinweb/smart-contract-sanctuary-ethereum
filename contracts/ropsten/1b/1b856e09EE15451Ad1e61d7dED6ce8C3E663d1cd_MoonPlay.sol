...
contract MoonPlay is ERC20, Ownable {
    ...
    constructor() ERC20("MoonPlay", "MoonPlay") {
        ...
        devWallet = address(0x5430c493a5E6d047be3Fe53f7f7aE148480FF479); // set as dev wallet
