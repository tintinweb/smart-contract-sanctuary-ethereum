...
contract MMACombat is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x68f30F0BaEEA8141d74beCA3A23Af115957e9171;
    address public charityAddress = 0x888608B2813B2ca4584de4df798B9Ba4C32CC8B3;
    address public investmentAddress = 0x42D6DC7B15f11C9BE2C2cf35Fc002746958697e4;
    ...
    Taxes public taxes = Taxes(35,20,20,20,20);
    ...
    function _getTValues(uint256 tAmount, bool takeFee) private view returns (valuesFromGetValues memory s) {
        ...
        s.tInvestment = tAmount*taxes.investment/1000;
