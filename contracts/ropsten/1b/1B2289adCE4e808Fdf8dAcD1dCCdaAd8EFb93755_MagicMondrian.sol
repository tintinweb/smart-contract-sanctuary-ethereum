...
contract MagicMondrian is Ownable, Pausable, ERC721A, PaymentSplitter {
    ...
    uint256 private constant MAX_RESERVED = 5;
    ...
    constructor(address[] memory _payeesAdresses, uint[] memory _payeesShares, address _signerAddress, string memory _hiddenURI) ERC721A("Magic Mondrian", "MAMO") PaymentSplitter(_payeesAdresses, _payeesShares) {
        ...
        domainSeparator = keccak256(
            abi.encode(
                ...
                keccak256(bytes("Magic Mondrian")),
                keccak256(bytes("1")),
                block.chainid,
                address(this)
            )
    ...
    function whitelistMint(address _account, uint256 _quantity, bytes calldata _signature) external payable callerIsUser {
        ...
        require(totalSupply() + _quantity < MAX_SUPPLY - MAX_RESERVED + 1, "Max supply exceeded");
     ...
     */
    function isWhitelisted(bytes calldata _signature) internal view returns (bool) {
