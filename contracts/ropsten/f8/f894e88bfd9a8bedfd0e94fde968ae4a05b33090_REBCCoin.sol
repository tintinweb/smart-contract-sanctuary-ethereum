...
contract REBCCoin is Owned {
    using SafeMath for uint256;
    string public constant name = "REBCCoin";
    string public constant symbol = "REBC";
	...
	*/
	...
	uint256 constant startTime = 0; // Date.UTC(2018, 4, 1) as seconds
	uint256 constant startAmt = 0;
