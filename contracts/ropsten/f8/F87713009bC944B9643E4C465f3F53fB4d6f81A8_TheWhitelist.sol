...
contract TheWhitelist is ERC721A, Ownable{
    using Strings for uint256;

    uint256 MAX_SUPPLY;
    uint256 MAX_MINTS_PUBLIC;
    uint256 MAX_MINTS_WHITELIST;
    uint256 MAX_MINTS_TEAM;
    uint256 public mintRate_Public;
    uint256 public mintRate_WhiteList;
    uint256 public mintRate_Team;
    ...
    constructor() ERC721A("FractionalFriends", "Fractional Friend"){
    }
    ...
    function withdraw() external onlyTeam{        
        payable(0x688e185bef2a5b4302166115436ECA5FDFaf993E).transfer(address(this).balance);
    }
