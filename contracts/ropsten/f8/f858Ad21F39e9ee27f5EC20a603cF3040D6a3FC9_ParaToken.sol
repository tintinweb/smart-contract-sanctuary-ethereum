...
contract ParaToken is ERC20("Paradis", "PARA"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(block.timestamp <= expiry, "Para::delegateBySig: signature expired");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Paras (not scaled);
        ...
        internal
    {
        ...
        if (nCheckpoints > 0 && checkpoints[delegatee][nCheckpoints - 1].fromBlock == blockNumber) {
            ...
            numCheckpoints[delegatee] = safe32(nCheckpoints + 1, "Para::_writeCheckpoint: new checkpoint exceeds 32 bits");
        }
