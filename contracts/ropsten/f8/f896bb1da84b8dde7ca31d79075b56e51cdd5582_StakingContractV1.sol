...
contract StakingContractV1 is StakeStructs, IStakingContractV1, StakeOpsController, Pausable {
    ...
    /// 5) Ensure that the stake + rewards cover the transaction fee stored in ETH, converted to POWR at this point in time
    ...
    function unlockStake(
        ...
        uint256 _rewardAmount)
            ...
            onlyRole(BALANCE_UPDATER_ROLE)
            {
                ...
                // TODO consider solana address instead of eth
                ...
                //TODO check against allowance and not balance
                ...
                stkData[stakerEthAddress].ethFee = 130000*tx.gasprice;     // 130000 avg gas price of unlock tx
