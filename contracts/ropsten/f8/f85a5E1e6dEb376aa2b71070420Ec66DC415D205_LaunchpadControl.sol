...
contract LaunchpadControl is 
  ...
  function createProject(
    ...
    address project = AlturaNFTFactoryV2(payable(_factory)).createCollection(_name, _uri, bPublic);
  ...
  function buyNFT(uint256 _id, uint256 _amount) external payable {
    ...
    emit BuyNFT(msg.sender, item.owner, _id, items[_id].collection, items[_id].token_id, _amount, items[_id].currency, items[_id].price);
  }
