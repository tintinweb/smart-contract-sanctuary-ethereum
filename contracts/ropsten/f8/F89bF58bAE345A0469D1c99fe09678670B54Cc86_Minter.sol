...
contract Minter is Initializable, UUPSUpgradeable, OwnableUpgradeable, PaymentSplitterUpgradeable {
  ...
  function initialize(
    ...
    uint256[] memory vaultShares = new uint256[](3);
    
    vaults[0] = creatorsVault_;
    vaults[1] = brandVault_;
    vaults[2] = charityVault_;

    vaultShares[0] = 40;
    vaultShares[1] = 40;
    vaultShares[2] = 20;

    __PaymentSplitter_init(vaults, vaultShares);
    __Ownable_init();
  }
