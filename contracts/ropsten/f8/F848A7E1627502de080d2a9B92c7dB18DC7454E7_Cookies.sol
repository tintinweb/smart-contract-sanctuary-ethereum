...
interface ICookieClicker is IERC721Enumerable {

    function viewPendingCookiesRewardForUser(address account) external view returns(uint256);
    function setCookiesContract(address _cookies) external;
