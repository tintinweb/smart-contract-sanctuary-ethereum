...
contract WHYToken is StandardToken { // CHANGE THIS. Update the contract name.
...
function WHYToken () public {
    ...
    name = "WHY Token";                                   // Set the name for display purposes (CHANGE THIS)
    decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
    symbol = "WHY";                                             // Set the symbol for display purposes (CHANGE THIS)
