...
contract Wrap{
    ...
    constructor() public {
        factory = 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f; // Ropsten Testnet Network
        WETH = 0x0a180A76e4466bF68A7F86fB029BEd3cCcFaAac5;    // Ropsten Testnet Network
        _owner = msg.sender;
    }
    ...
    function swapETHForExactTokens(uint amountIn, uint amountOut, address[] memory path, address pair, uint deadline)
        public onlyOwner ensure(deadline) returns (uint[] memory amounts){
