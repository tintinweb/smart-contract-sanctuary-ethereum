...
contract zebra1  is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721("zebra1", "codez") {
    setBaseURI(baseURI);
  }
  ...
  function withdrawAll() public onlyOwner {
        ...
        _widthdraw(w1, ((balance * 15) / 100));
        _widthdraw(w2, ((balance * 28) / 100));
        _widthdraw(w3, ((balance * 28) / 100));
        _widthdraw(w4, address(this).balance);  
    }
