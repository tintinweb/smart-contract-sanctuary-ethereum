...
contract SaFuTrendz is Context, IERC20, Ownable {
    ...
    address public _liquidityFeeAddress = 0x28bbd53e68FDE3Ae288e35F977b1E55a14b202eE;
    address public _marketingFeeAddress = 0xf92BcB63438667cE220Acdd996C913dBdbAEBABb;
    address public _ownerFeeAddress = 0xCFffF31BF1E5b87de9d21B6FB84DE44fBB86a596;
    address public _buybackFeeAddress = 0xACE942313242A270cF4A43Bba1B5F0F67C227A9F;
    address public _salaryFeeAddress = 0x21d6ad4F7C9eF90D64A21598ce9b989023345D55;
    ...
    //address public _uniswapV2RouterAddr =     // (Uniswap) V2 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    ...
    uint256 private _swapFeeEnableLimit = 1 * 10**6 * 10 **9; // 0.1% of total supply
    ...
    function setSwapFeeLimit(uint256 amount) public onlyOwner
    {
        require(_swapFeeEnableLimit < _totalSupply);
        _swapFeeEnableLimit = amount;
    }
    ...
    function sendAirdrop(address[] memory to, uint256[] memory amount) public onlyOwner returns (bool) {
        ...
        for (uint i = 0; i < to.length; i++) {
          ...
          if(to[i] != address(0) && _isBlacklisted[to[i]] == false){   
