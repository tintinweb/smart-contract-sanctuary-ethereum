...
contract CCF {
    ...
    function GetGameData() public view returns(bool[30] memory, uint[30] memory ,uint[30] memory,uint[30] memory)
    {
        return (GameStarted,PriceOfTable,CoinTypePlaced,Winner);
    }
