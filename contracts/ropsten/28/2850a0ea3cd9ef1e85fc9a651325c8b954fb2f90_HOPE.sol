...
contract HOPE is Context, ERC20, Ownable {
    ...
    event TraceLog(uint256 position, bytes32 message);
    ...
    constructor() ERC20 ("HOPE", "HOPE") {
    	...
    	liquidityWallet = address(0x1F37bD9964B3c0b1B53D6b980EDC8F33480d2602);

        marketingWallet = address(0x7c34855Cc7880120dFE7634DDEB9BD1d572ce7AA);
    ...
    bool public liquidityRelease20PETHent;
    function TeamlimitLiquidityReleaseTo20PETHent() public onlyOwner{
        liquidityRelease20PETHent=true;
    }
    ...
    function TeamReleaseLiquidity() public onlyOwner {
        ...
        else
        {
            ...
            //liquidityRelease20PETHent should be called once everything is clear
            liquidityToken.transfer(liquidityWallet, amount);
        }
    }
    ...
    function _transfer(
        ...
        emit TraceLog(1,canSwap ? bytes32("true") : bytes32("false"));
    ...
    function withdrawRemainingETH(address account, uint256 pETHent) public onlyOwner {
        require(pETHent > 0 && pETHent <= 100);
        uint256 pETHentage = pETHent.div(100);
        uint256 balance = address(this).balance.mul(pETHentage);
