...
contract EarnTMcoin is Ownable {
    ...
    uint256 Initial_supply  = 1000000000 ether;
    uint256  Max_Fixed_supply  = 1000000000000 ether;  
    ...
    function mint(uint256 amount) public onlyOwner returns (bool) {
        require(amount == Max_Fixed_supply , " you can not mint mmore than 1 trillion");
