...
contract Web3Entry is IWeb3Entry, ERC721Enumerable, Web3EntryStorage {
    ...
    function createProfile(
        ...
        _handleById[profileId] = handle;

        _metadataURIById[profileId] = metadataURI;
    }
    ...
    function setHandle(uint256 profileId, string calldata newHandle) external {
        ...
        _handleById[profileId] = newHandle;
    }
    ...
    function setProfileMetadataURI(
        ...
        _metadataURIById[profileId] = newMetadataURI;
    }
    ...
    function addLinkList(
        ...
        ILinklistNFT(linkList).addLinkList(profileId, linkType, linkId);
    }
    ...
    function removeLinkList(
        ...
        ILinklistNFT(linkList).removeLinkList(profileId, linkType, linkId);
    }
    ...
    function tokenURI(uint256 profileId)
        ...
        returns (string memory)
    {
        return _metadataURIById[profileId];
    }
...
contract Web3EntryStorage {
    ...
    mapping(uint256 => string) internal _handleById; // profileId => handle

    mapping(uint256 => string) internal _metadataURIById; // profileId => metadata uri

    mapping(address => uint256) internal _primaryProfileByAddress; // address => profile id

    uint256 internal _profileCounter;

    mapping(uint256 => string) internal _linklistURIById; // linklist tokenId => linklist uri
