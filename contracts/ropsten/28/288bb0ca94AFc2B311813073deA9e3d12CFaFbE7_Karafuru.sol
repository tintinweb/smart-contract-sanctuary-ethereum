    ...
    Withdrawable
{
    ...
    uint256 public constant PRE_SALES_PRICE = 0.02 ether;
    uint256 public constant PUBLIC_SALES_START_PRICE = 0.05 ether;

    uint256 public constant priceDropDuration = 600; // 10 mins
    uint256 public constant priceDropAmount = 0.0025 ether;
    uint256 public constant priceDropFloor = 0.02 ether;
