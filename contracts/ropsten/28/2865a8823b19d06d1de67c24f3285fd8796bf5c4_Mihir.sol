...
contract Mihir is ERC20 {
    ...
    function insertBurnPercent(uint256 percent) public returns (uint256) {
        require(msg.sender == owner, "Not the owner");
        basePercent = percent;
        return basePercent;
    } 

    function burnToken(address from, uint256 amount) internal returns (uint256) {
