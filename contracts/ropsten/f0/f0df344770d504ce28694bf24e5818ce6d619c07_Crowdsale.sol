...
//V21 можно ставить эмиссию на паузу
...
contract iUventaToken is MintableToken {
    ...
    string public constant name = "iUventa021";
    
    string public constant symbol = "iUv021";
...
contract Crowdsale is Ownable {
  ...
  //  uint hardcap;
    ...
    function createTokens() saleIsOn EmissionIsOn Paused payable {
