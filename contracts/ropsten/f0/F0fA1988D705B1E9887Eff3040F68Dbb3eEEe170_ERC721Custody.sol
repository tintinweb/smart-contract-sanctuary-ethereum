...
// import '/Users/lambda256/git/deployTest/luniverseTestRopsten/luniverse-bridge-contract/node_modules/openzeppelin-solidity/contracts/token/ERC721/ERC721Full.sol';
// import 'contracts/ownership/Ownable.sol';
// import 'contracts/IWERC721.sol';
// import 'contracts/utils/Strings.sol';

contract WERC721 is ERC721Full, Ownable, IWERC721 {
  ...
  function mint(address user, uint256 tokenId) external onlyCustody whenNotPaused {
    _mint(user, tokenId);
    _setTokenURI(tokenId, getTokenURI(tokenId));
  }

  function burn(uint256 tokenId) external onlyCustody whenNotPaused {
    _burn(tokenId);
  } 

  function setCustody(address custodyAddress) public onlyOwner {
  ...
  function getTokenURI(uint256 tokenId) internal view returns (string memory) {
		require(_exists(tokenId), "WERC721: URI query for nonexistent token");
...
// import '/Users/lambda256/git/deployTest/luniverseTestRopsten/luniverse-bridge-contract/node_modules/openzeppelin-solidity/contracts/token/ERC721/IERC721.sol';
// import '/Users/lambda256/git/deployTest/luniverseTestRopsten/luniverse-bridge-contract/node_modules/openzeppelin-solidity/contracts/token/ERC721/IERC721Receiver.sol';
// import 'contracts/ownership/Ownable.sol';
// import 'contracts/WERC721.sol';
// import 'contracts/ICustody.sol';
// import 'contracts/IBridge.sol';
contract ERC721Custody is ICustody, Ownable, IERC721Receiver {
      ...
      onlyBridge
  {
      ...
      emit LockToken(bytes32(_tokenType), depositor, depositReceiver, originToken, tokenId);
  }
      ...
      onlyBridge
    {
      ...
      emit UnlockToken(bytes32(_tokenType), withdrawReceiver, originToken, tokenId);
    }
      ...
      onlyBridge
    {
      ...
      emit MintWrappedToken(bytes32(_tokenType), depositReceiver, wrappedToken, tokenId);
    }
    ...
    onlyBridge
  {
    ...
    emit BurnWrappedToken(bytes32(_tokenType), withdrawer, wrappedToken, tokenId);
  }
