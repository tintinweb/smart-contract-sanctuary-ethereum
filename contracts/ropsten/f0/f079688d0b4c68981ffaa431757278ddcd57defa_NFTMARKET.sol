...
contract NFTMARKET is ERC721URIStorage, PaymentSplitter, Ownable {
    ...
    constructor(address[] memory _payees, uint256[] memory _shares) ERC721("NFTMARKET", "NFT") PaymentSplitter(_payees, _shares) payable {}
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if (revealed) {
            ...
            return string(abi.encodePacked(_getbaseURI, "hidden.json"));
        }   
    }
}