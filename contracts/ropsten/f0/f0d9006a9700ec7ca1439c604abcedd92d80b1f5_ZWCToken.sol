...
contract ZWCToken is CappedToken, PausableToken {
    ...
    uint256 public constant INITIAL_SUPPLY = 10000 * 10000 * (10 ** uint256(decimals));
    uint256 public constant MAX_SUPPLY = 10000 * 10000 * 10000 * (10 ** uint256(decimals));
