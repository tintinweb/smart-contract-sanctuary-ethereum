...
//=================_|===========================================================
	...
	uint256 public multLinear = 1;            // multiplier increases linearly, if not the multiplier is multiplied rather than added to each time a sufficient amount is purchased
...
function setStore(string _variable, uint256 _value) public  {  // we used uint256 for everything here
    ...
    if (keccak256(bytes(varname[i]))==keccak256("endround") && msg.sender == admin) insert(_variable,_value);
