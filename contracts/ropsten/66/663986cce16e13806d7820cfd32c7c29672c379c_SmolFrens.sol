...
contract SmolFrens is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("SmolFrens", "Frens") { 
        _owner = msg.sender;
    ...
    function setRemote(uint16 _chainId, bytes calldata _trustedRemote) external onlyOwner {
        trustedRemoteLookup[_chainId] = _trustedRemote;
    }
    ...
    function Portal(uint16 _chainId, uint tokenId) public payable {
