...
contract DextoolsSale is ReentrancyGuard, Ownable, AccessControl {
    ...
    constructor(
        ...
        buyPrice = _buyPrice;
        totalTokens = _hardcap * _buyPrice;
        ...
        hasntStarted()
    {
        ...
        for (uint8 i = 0; i < vestingClaim.length; i++) {
            vestingTotal += vestingClaim[i];
        }
    ...
    receive() external payable
    {
        ...
        require(participants[msg.sender] + msg.value <= maxBuy, "DextoolsSale: You must send less than the required maximum to participate");
        ...
        whenCrowdsaleAlive()
    {
        ...
        uint256 tokensSold = _value / buyPrice * (10 ** tokenDecimals);
    ...
    function claim() 
        ...
        returns (uint256) 
    {
        // require(claimableTokens[msg.sender] > claimedTokens[msg.sender], "DextoolsSale: All claimed");
        ...
        require(pending > 0, "DextoolsSale: Nothing to claim for now");
    ...
    function fund()
        external
    {
        IERC20(crowdsaleToken).transferFrom(msg.sender, address(this), hardCap * buyPrice);
        funded = true;
    }
