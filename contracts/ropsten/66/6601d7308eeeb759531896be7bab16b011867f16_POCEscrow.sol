...
contract POCEscrowAsset is Utilities,Ownable {
    ...
    function addNewAsset(string memory _sellerName, address _sellerAddress, uint _assetCost) public onlyOwner{
    ...
    function setAssetActiveStatus(uint _assetID,bool _isActive) public onlyOwner {
    ...
    function setAssetStatusCode(uint _assetID,uint _assetStatusCode) public onlyOwner {
        require(_assetID < currentEscrowAssetCount, "Invalid Asset Type ID");
