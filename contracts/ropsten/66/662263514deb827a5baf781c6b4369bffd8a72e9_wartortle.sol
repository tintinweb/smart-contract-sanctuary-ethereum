...
/**
https://t.me/Wartortlebsc,

Wartortle 

Low Taxes, LP locked , ownership renounced , 2% tax, pokemon meta, 0.5 bnb initial liquidity
  
CHANNEL : https://t.me/wartortlebsc
...
contract wartortle is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wartortle Coin"; // 
    string private constant _symbol = "Wartortle"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xBf200d022D3d4A68Be9967FC709d68AB1a5659Eb;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _marketingFee / 500; 
