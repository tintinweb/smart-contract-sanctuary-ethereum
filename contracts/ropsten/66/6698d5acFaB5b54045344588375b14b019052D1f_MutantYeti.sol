...
contract MutantYeti is ERC721A, Ownable {
    ...
    bool private _isSaleActive = false; //开始mint开关
    bool private _revealed = false; //开盲盒

    // Constants
    uint256 public constant MAX_SUPPLY = 10000; //NFT总数量
    uint256 public mintPrice = 0.05 ether ;//价格
    uint256 public maxBalance = 1000; //每个用户最多拥有的该NFT的数量
    uint256 public maxMint = 1000; //最大可mint数量
