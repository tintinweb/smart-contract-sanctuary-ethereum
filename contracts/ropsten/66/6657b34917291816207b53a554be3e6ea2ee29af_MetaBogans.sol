...
contract MetaBogans is ERC721, Ownable, ERC721Enumerable, ReentrancyGuard {
	...
	uint256 public MAX_MINT_EARLYSALE = EARLYSALE_NFT;
	uint256 public MAX_MINT_PRESALE = PRESALE_NFT;
	uint256 public MAX_MINT_SALE_BATCH_ONE = SALE_NFT_BATCH_ONE;
	uint256 public MAX_MINT_SALE_BATCH_TWO = SALE_NFT_BATCH_TWO;
	
	uint256 public MAX_BY_MINT_IN_TRANSACTION_EARLYSALE = EARLYSALE_NFT;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = PRESALE_NFT;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE_BATCH_ONE = SALE_NFT_BATCH_ONE;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE_BATCH_TWO = SALE_NFT_BATCH_TWO;
	
	uint256 public EARLYSALE_PRICE = 0;
	uint256 public PRESALE_PRICE = 0;
	uint256 public SALE_PRICE_BATCH_ONE = 0;
	uint256 public SALE_PRICE_BATCH_TWO = 0;
	...
	bool public saleEnableBatchOne = true;
	bool public saleEnableBatchTwo = true;
	...
	function pickgold(uint256 nonceNumber) public view returns (uint256) {
	   return uint256(uint256(keccak256(abi.encodePacked(nonceNumber, block.timestamp, block.difficulty)))%20);
	}
