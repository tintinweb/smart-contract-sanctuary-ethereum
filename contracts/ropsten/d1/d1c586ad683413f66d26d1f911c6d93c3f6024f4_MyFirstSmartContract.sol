...
// ----------------------------------------------------------------------------
// 'MyFirstSmartContract' token contract
//
// Deployed to : 0x412299225F0408555743C78A1E349f7d3c2433C9
// Symbol      : NWITOK
// Name        : MyFirstToken
// Total supply: 1000
// Decimals    : 2
...
// token transfers
// ----------------------------------------------------------------------------
contract MyFirstSmartContract is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function MyFirstSmartContract() public {
        symbol = "NWITOK";
        name = "MyFirstToken";
        decimals = 2;
        _totalSupply = 100000;
        balances[0x412299225F0408555743C78A1E349f7d3c2433C9] = _totalSupply;
        Transfer(address(0), 0x412299225F0408555743C78A1E349f7d3c2433C9, _totalSupply);
    }
