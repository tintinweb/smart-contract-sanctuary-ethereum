...
contract Test is Context, IERC20, Ownable {
    ...
    constructor() {
        marketingAddress = address(0xe1554bd62B178c6b979dC7e6c00f4ed94e2E3A64);
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            bool canSwap = (contractTokenBalance >= _swapTokensAtAmount || _taxFeeOnSell == 0);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 taxFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy + taxFeeOnBuy + redisFeeOnSell + taxFeeOnSell < 11, "Max 10% roundtrip");
