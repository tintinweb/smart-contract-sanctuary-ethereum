...
// ----------------------------------------------------------------------------
// 'Jolly' CROWDSALE token contract
//
// Symbol      : Jolly
// Name        : Jolly Token
...
// token transfers
// ----------------------------------------------------------------------------
contract jollyToken is ERC20Interface, Owned, SafeMath {
    string public symbol = "Jolly";
    string public TokenOwner = "Jonalyn Dimla";
    string public  name = "JollyCoin";
    uint8 public decimals = 12;
    uint public _totalSupply = 1000000000000 * 10 ** uint256(decimals);

	uint256 public price = 10000;
	bool public started = true;
	address public ceo = 0xe102C172Af2Ec811aA21FC80BC3B56801d587795;
