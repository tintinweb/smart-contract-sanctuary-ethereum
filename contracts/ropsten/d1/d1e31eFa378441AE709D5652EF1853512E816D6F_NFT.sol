...
contract NFT is ERC721URIStorage, Ownable {
  ...
  function createToken(string memory tokenURI, address _seller, uint256 _price, address _feeReceiver, uint256 _fee, bytes calldata signature)
    public
    payable
