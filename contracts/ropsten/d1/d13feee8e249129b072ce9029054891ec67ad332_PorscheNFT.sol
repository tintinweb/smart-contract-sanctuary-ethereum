...
contract PorscheNFT is ERC721, Ownable, ERC721Burnable, ERC721Enumerable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint mintRate = 0.01 ether;

    constructor() ERC721("Porsche 911 R", "911R") {
        _tokenIdCounter._value = 1;
    }

     function _baseURI() internal pure override returns (string memory) {
        return "https://www.wallpaperflare.com/search?https://www.wallpaperflare.com/porsche-porsche-911-r-car-motor-vehicle-mode-of-transportation-wallpaper-cqyod=911-r";
    }

    function safeMint(address to) public payable {
        require(msg.value >= mintRate);
        require(_tokenIdCounter.current() <= 991);
        uint256 tokenId = _tokenIdCounter.current();
        // _tokenIdCounter._value = multiplier(tokenId);
    ...
    // function multiplier(uint id) private pure returns(uint) {
    //     return id * 7;
    // }
    ...
    function balanceOfContract() external onlyOwner view returns(uint) {
