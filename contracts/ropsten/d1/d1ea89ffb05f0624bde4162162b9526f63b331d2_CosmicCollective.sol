...
contract CosmicCollective is ERC721A, Ownable {
    ...
    uint256 private MutantHoldings = IERC721(0x44102Bd86bCcB4eFe8E90b4A4D5C4E43a895D22e).balanceOf(msg.sender);
    uint256 private allowedQuantity;
    ...
    function mintHolder(uint256 _quantity) external payable HoldernotEnded {
     ...
     // require(whitelistCount + _quantity <= WHITELIST_MAX, "WHITELIST_MAXED");
        ...
        require(HolderlistClaimed[msg.sender] + _quantity <= allowedQuantity, "ALLOWED_MAXED");
