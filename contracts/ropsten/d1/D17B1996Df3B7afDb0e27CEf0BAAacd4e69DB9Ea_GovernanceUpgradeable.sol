...
contract GovernanceUpgradeable is Initializable, GovernorUpgradeable, GovernorSettingsUpgradeable, GovernorCountingSimpleUpgradeable, GovernorVotesUpgradeable, GovernorVotesQuorumFractionUpgradeable {
 ...
 */
abstract contract GovernorUpgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IGovernorUpgradeable, IERC721ReceiverUpgradeable {
    ...
    modifier onlyGovernance() {
        require(_msgSender() == address(this), "GovernorUpgradeable: onlyGovernance");
        _;
    }
    ...
    // if the proposal succeded or not
    function _voteSucceeded(uint256 proposalId) internal view virtual returns (bool);

    // Get the voting weight of `account` at a specific `blockNumber`
    function _getVotes(
        uint256 tokenId,
        uint256 blockNumber
    ...
    function propose(
        ...
        // Converts tokenId to an address for compatibility reason with the rest of the system
...
abstract contract IGovernorUpgradeable is Initializable, IERC165Upgradeable {
     ...
     * @dev Voting power of a `tokenId` at a specific `blockNumber`.
     *
