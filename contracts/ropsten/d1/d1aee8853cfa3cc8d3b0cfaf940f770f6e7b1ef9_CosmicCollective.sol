...
contract CosmicCollective is ERC721A, Ownable {
    ...
    uint256 public constant RESERVE_MAX = 651;
    ...
    uint256 public MutantHoldings = IERC721(0xA6b98F9cBA02A45eEB53A1381546e45768A12464).balanceOf(msg.sender);
    ...
    function buy(uint256 _quantity) external payable {
        ...
        require(DAClaimed[msg.sender] + _quantity <= 2, "DA_MAXED");
        unchecked {
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function getMutantHoldings(address owner) public view returns (uint256) {
        return uint256(IERC721(0xA6b98F9cBA02A45eEB53A1381546e45768A12464).balanceOf(owner));
    }
