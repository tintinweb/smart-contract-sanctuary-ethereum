...
contract BuyBackToken is Context, IERC20, Ownable {
    ...
    address constant BSC_TEST_ROUTER = 0x1Ed675D5e63314B760162A3D1Cae1803DCFC87C7;
    address constant ROPSTEN_ROUTER = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address constant MUMBAI_ROUTER = 0x8954AfA98594b838bda56FE4C12a09D7739D179b;
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma) {
        ...
        dappbuilderAddress = payable(0x7DEfe04FEEd55f771226627f1c7550Ca89742D91);
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(ROPSTEN_ROUTER);
