 ...
 */
contract XYY is StandardToken {

    string public constant name = "XYY"; // solium-disable-line uppercase
    string public constant symbol = "XYY"; // solium-disable-line uppercase
 ...
 * contract EasyToken is Crowdsale {
    ...
    string  public name        = 'XYY';
    string  public symbol      = "XYY";
