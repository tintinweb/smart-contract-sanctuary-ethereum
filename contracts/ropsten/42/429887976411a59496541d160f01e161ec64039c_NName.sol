...
contract NName is Context, IERC20, Ownable {
    ...
    string private constant _name = "NName ";
    string private constant _symbol = "NName";
    ...
    address payable public MarketingAddress = payable(0x556770301F2c44ba143A355439C9Dc979C99e798);
