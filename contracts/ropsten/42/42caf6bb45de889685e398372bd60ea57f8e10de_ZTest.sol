...
// Zen Inu is a community token aimed at providing calmness and tranquility in times where the world is full of uncertainty and all world markets are crashing. Join the ZINU family and instil calmness into the entire crypto community. 
// 
...
contract ZTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ztest", "ZTST") {
        ...
        devOpsWallet = address(0x3F6EFA019C5FeF72c0077d152f6f7ADB5f9E4cCC); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x3F6EFA019C5FeF72c0077d152f6f7ADB5f9E4cCC), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x3F6EFA019C5FeF72c0077d152f6f7ADB5f9E4cCC), true);
