...
contract Gotoken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Gotoken() {
        ...
        name = "Gotoken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "Go";                                             // Set the symbol for display purposes (CHANGE THIS)
