...
contract LoyelaTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LoyelaTestCoin() {
        ...
        name = "LoyelaTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 4;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LoyT";                                             // Set the symbol for display purposes (CHANGE THIS)
