...
contract MahamHasanTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MahamHasanTestCoin() {
        ...
        name = "MahamHasanTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-029";                                             // Set the symbol for display purposes (CHANGE THIS)
