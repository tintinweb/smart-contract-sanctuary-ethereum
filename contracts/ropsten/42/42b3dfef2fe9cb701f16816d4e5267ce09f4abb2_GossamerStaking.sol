...
contract GossamerStaking is Ownable
{
 ...
 constructor()
 {
     moth=IERC721(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
     warrior=IERC721(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
     serum=IERC721(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
     token=IERC20(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);

 }
 uint256 private  stakeCount = 1 ;
 uint256 public totalNfts;
 uint256 private ONE_WEEK_SEC=604800;
   struct staking {
        address owner;
        uint256 startTime;
        uint256 week;
 ...
 mapping(uint256=>uint256) public APY;
    ...
    function _getreward(uint256  _stakeid) public view returns (uint256)
    {
      ...
      require(stakeDetail[_stakeid].collected ==true,"USER ALREADY UNSTAKE");
    ...
    function claim (uint256  _stakeid) public 
    {
      ...
      require(stakeDetail[_stakeid].collected ==true ,"already unstake");
