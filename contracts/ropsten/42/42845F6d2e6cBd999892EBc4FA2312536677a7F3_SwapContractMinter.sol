...
contract SwapContractMinter is SwapContract {
    ...
    constructor(
        ...
        SwapContract(
            ...
            _tokenNums,
            _minTokenAmounts,
            _numOfThisBlockchain,
            _numsOfOtherBlockchains,
    ...
    function transferToOtherBlockchain(
    ...
    ) external payable override whenNotPaused onlyValidToken(token) {
        ...
        if (tokenAddress == 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE) {
            ...
            IERC20Mintable(tokenAddress).burn(sender, amount);
        }
    ...
    function transferToUserWithFee(
    ...
    ) external override onlyRelayer whenNotPaused onlyValidToken(token) {
        _checkTransferTo(
            token,
            user,
            amountWithFee,
        ...
        if (tokenAddress == 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE) {
            ...
            IERC20Mintable(tokenAddress).mint(user, amountWithoutFee);
            IERC20Mintable(tokenAddress).mint(feeAddress, fee);
        }
