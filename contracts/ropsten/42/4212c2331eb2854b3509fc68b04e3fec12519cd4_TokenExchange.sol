/* 
@Token Exchange
@2018 by TEX (A New Decentralized Exchange for Erc20 Tokens)
 */
...
contract TokenExchange is ERC20 {
    ...
    string public constant name = "TokenExchange";
    string public constant symbol = "TEX";
    uint public constant decimals = 8;
    
    uint256 public totalSupply = 20000000000e8;
    uint256 public totalDistributed = 0;    
    uint256 public constant MAX_PURCHASE = 0.1 ether / 100; // 0.1 Ether
    uint256 public constant MIN_PURCHASE = 0.1 ether / 100; // 0.1 Ether
