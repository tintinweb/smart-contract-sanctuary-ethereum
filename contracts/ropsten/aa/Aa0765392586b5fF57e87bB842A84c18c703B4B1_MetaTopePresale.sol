 ...
 */
contract MetaTopePresale is Ownable, MetaTopeIERC1155Receiver {
    ...
    modifier onlyWhitelisted() {
        if (isWhitelistMode) {
            require(whitelistedBuyers[msg.sender] == true, "Buyer should be whitelisted");
        }
        _;
    }
    ...
    function start(
        ...
        endAt = startAt + 2 days; // todo discuss presale duration
    ...
    ) onlyStarted onlyWhitelisted external {
     ...
     */
    function setWhitelist(address _buyer) onlyOwner external {
        whitelistedBuyers[_buyer] = true;
    }
     ...
     * @param _to withdraw
     */
    function withdraw(address _to) onlyOwner external {
