...
/// @notice This contract is a lending protocol where consumers lend crypto assets and receive high, stable yields secured by real estate.
contract AltaFinanceEarnV2 is EarnBase {
    /// ALTA token
    IERC20Metadata public ALTA;

    /// Address of wallet to receive funds
    address public loanAddress; // TODO: Rethink loanAddress name
