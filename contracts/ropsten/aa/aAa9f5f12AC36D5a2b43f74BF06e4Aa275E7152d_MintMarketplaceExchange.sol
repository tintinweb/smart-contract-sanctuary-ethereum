...
// MintMarketplace interfaces
import {ICurrencyManager} from "./interfaces/ICurrencyManager.sol";
import {IExecutionManager} from "./interfaces/IExecutionManager.sol";
import {IExecutionStrategy} from "./interfaces/IExecutionStrategy.sol";
import {IRoyaltyFeeManager} from "./interfaces/IRoyaltyFeeManager.sol";
import {IMintMarketplace} from "./interfaces/IMintMarketplace.sol";
import {ITransferManagerNFT} from "./interfaces/ITransferManagerNFT.sol";
import {ITransferSelectorNFT} from "./interfaces/ITransferSelectorNFT.sol";
import {IWETH} from "./interfaces/IWETH.sol";

// MintMarketplace libraries
import {OrderTypes} from "./libraries/OrderTypes.sol";
import {SignatureChecker} from "./libraries/SignatureChecker.sol";

contract MintMarketplaceExchange is IMintMarketplace, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x797cdb4e741f163c82871fae3535df8a0720acbdf0d483d3f29c9ec49db266ba, // keccak256("MintMarketplaceExchange")
...
/**
 * @title OrderTypes
 * @notice This library contains order types for the MintMarketplace exchange.
 */
library OrderTypes {
