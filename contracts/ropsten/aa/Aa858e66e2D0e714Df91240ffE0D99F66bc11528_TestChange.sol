...
//   | | / _ \/ __|| __|| |    | '_ \  / _` || '_ \  / _` | / _ \
//   | ||  __/\__ \| |_ | \__/\| | | || (_| || | | || (_| ||  __/
//   \_/ \___||___/ \__| \____/|_| |_| \__,_||_| |_| \__, | \___|
//                                                    __/ |      
//                                                   |___/       
...
contract TestChange is ERC721, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;

    uint256 public totalSupply = 0;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/319/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/319/contract-uri";
	...
	constructor(address _signerAddress) ERC721("TestChange", "TEST") {
