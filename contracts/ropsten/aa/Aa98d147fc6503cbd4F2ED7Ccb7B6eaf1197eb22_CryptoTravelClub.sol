  ...
  ReentrancyGuard
{
  ...
  uint256 private constant MAX_SUPPLY_SAPPHIRE = 5000;
  uint256 private constant MAX_SUPPLY_PLATINUM = 2000;
  uint256 private constant MAX_SUPPLY_DIAMOND = 500;

  uint256 private constant PRICE_IN_WEI_SAPPHIRE = 0.05 ether;
  uint256 private constant PRICE_IN_WEI_PLATINUM = 0.1 ether;
  uint256 private constant PRICE_IN_WEI_DIAMOND = 0.15 ether;
