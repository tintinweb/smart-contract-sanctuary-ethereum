...
// File contracts/ApolloSafePlayMultiCurrency/ApolloSafePlayBRL.sol
...
/**
 * Apollo safe play token with all functionalities except marketing
...
contract ApolloSafePlayBRL is Context, IERC20Metadata, Ownable {
    // Token parameters
    string private NAME;
    ...
    constructor(
        ...
        require(
            (_txFeeRates.burning +
                ...
                _txFeeRates.buyBack) <= MAX_TX_FEES,
    ...
    function swapAndLiquify() private lockTheSwap {
        uint256 reflection = balanceOf(address(this)) -
            (pendingToPay.liquidity + pendingToPay.buyBack);
        uint256 totalFeePercent = buyFeeRates.liquidity + buyFeeRates.buyBack;
