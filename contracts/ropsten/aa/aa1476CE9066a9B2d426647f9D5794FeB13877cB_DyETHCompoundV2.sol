...
contract DyETHCompoundV2 is DyETH {
    ...
    function lendingVersion() external pure returns (uint256) {
       return 2;
    }
}
...
// contracts/compound/interfaces/ICompoundETHDelegator.sol
//SPDX-License-Identifier: Unlicense
pragma solidity ^0.8.13;
...
interface ICompoundETHDelegator {
