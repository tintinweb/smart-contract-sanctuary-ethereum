...
// File: https://github.com/xurth/ERC721A/blob/main/contracts/IERC721A.sol
...
// File: https://github.com/xurth/ERC721A/blob/main/contracts/ERC721A.sol
...
contract sampleContract is ERC721A, Ownable, ReentrancyGuard, Pausable{
    ...
    function mint(uint256 _quantity) external payable whenNotPaused userOnly nonReentrant {
        ...
        require(msg.value >= (_quantity * mintPrice), "Error: Not enough ether sent");
