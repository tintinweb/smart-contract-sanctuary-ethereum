...
// Jurisdiction                            (companyJurisdiction)            : Nassau, Island of New Providence, Common Weatlh of Bahamas |
...
//                                                                           |
// (c) by The ACLYD PROJECT'S CENTRAL COMPANY INDENTIY (CCID) LISTING        |  
// ---------------------------------------------------------------------------
...
contract ERC20Interface {
    function cidTotalTokenSupply() public constant returns (uint);
...
contract ACLYDcidTOKEN is ERC20Interface, Owned, SafeMath {
    ...
    string public companyJurisdiction =  "Nassau, Island of New Providence, Common Weatlh of Bahamas";
    ...
    uint public   _cidTotalTokenSupply; 
    string public icoTokenStandard = "ERC20";
    string public icoTokenymbol = "ACLYD";
    ...
    function ACLYDcid() public {
        ...
        decimals = 0;
        _cidTotalTokenSupply = 11;
        balances[0x2bea96F65407cF8ed5CEEB804001837dBCDF8b23] = _cidTotalTokenSupply;
        Transfer(address(0), 0x2bea96F65407cF8ed5CEEB804001837dBCDF8b23, _cidTotalTokenSupply);
    }
    ...
    // ------------------------------------------------------------------------
    function cidTotalTokenSupply() public constant returns (uint) {
        return _cidTotalTokenSupply  - balances[address(0)];
    }
