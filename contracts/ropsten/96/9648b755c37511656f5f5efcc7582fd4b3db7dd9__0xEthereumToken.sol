...
contract Pow is Migratable {
        ...
        function hash(bytes32 challengeNumber, address msgSender, uint256 nounce) public returns (bytes32) {
                // digest = keccak256(challengeNumber, msgSender, nounce);
                digest = keccak256(keccak256(challengeNumber, msgSender, nounce));
                return digest;
        }
}
