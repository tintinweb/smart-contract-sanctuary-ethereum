...
// @title:  Mutant Shiba Club
// @desc:   Mutant Shiba Club is a collection of 10,000 animated NFTs. Each NFT is unique and resides on the Ethereum blockchain. Your Mutant Shiba Club NFT will double as your club membership.
// @artist: https://twitter.com/berrytheartist
// @team:   https://twitter.com/LordSlabs
// @team:   https://twitter.com/Gaba8545
// @author: https://twitter.com/crazyJUUMP
// @url:    https://mint.mutantshiba.club/
...
contract MutantShibaClub is ERC721A, Ownable {
    ...
    uint256 public constant PUBLIC_MAX_MINT_PER_ADDRESS = 2; 

    // ======== PRICE ========
    uint256 public publicSalePrice; // CHANGE
    ...
    function preSaleMint(uint256 _quantity, uint256 _maxAmount,  bytes32[] calldata _proof) external payable callerIsUser {
        require(isPreSaleActive, "WHITELIST SALE NOT ACTIVE");
        require(totalSupply() + _quantity <= MAX_SUPPLY, "MAX QUANTITY REACHED" );
        ...
        bool isValidProof = MerkleProof.verify(_proof, merkleRoot, sender);
    ...
    function publicSaleMint(uint256 _quantity) external payable callerIsUser {
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY, "MAX QUANTITY REACHED" );
        require(publicSaleMinted[msg.sender] + _quantity <= PUBLIC_MAX_MINT_PER_ADDRESS, "EXCEEDS MAX MINTS PER ADDRESS"); 
        require(msg.value == publicSalePrice * _quantity, "NEED TO SEND CORRECT ETH AMOUNT");
        _safeMint(msg.sender, _quantity);
    }

    function teamMint() external onlyOwner {
        require(totalSupply() <= MAX_SUPPLY, "MAX QUANTITY REACHED" );
    ...
    // ======== SETTERS ========
    /**
     * @notice activating or deactivating whitelist sale
     */
    ...
    /**
     * @notice seed collected whitelist addresses
     */
