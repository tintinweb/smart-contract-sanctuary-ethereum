...
contract UrbitexExchangeV7 is Context, Ownable {
        ...
        payable
    {
        ...
        if (token == address(0)) {
            ...
            ERC20.transferFrom(_msgSender(), address(this), _amount/1000*(1000-fee));
        }
        ...
        payable
    {
        ...
        // in order to save on gas fees, a check that the seller has approved the exchange as a 
        // transfer proxy can happen off-chain. 
        // if erc20 token, musst also set allowance.
    ...
    function addListing(uint32 _point, uint96 _price, address _token) external
    {
        ...
        // optional erc20 token can be set, if blank it's ether
        //         
