...
Many missed the original ZINU...great coin!! For all of those who found it too late...welcome to ZINU INU!
...
contract ZINUINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Zombie Inu Inu";
    string private constant _symbol = "ZINUINU";
    ...
    address payable private _developmentAddress = payable(0xd47c443678A75851832538E7bEBe888442fEc10E);
    address payable private _marketingAddress = payable(0x53942aE1585ce9b2a0D4d2D666c0afB6f47216D6);
