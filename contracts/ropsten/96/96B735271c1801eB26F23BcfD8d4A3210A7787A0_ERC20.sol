...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable{
    ...
    uint256 private _presaleRate = 4000;
    uint256 private _presaleTokenLimit = 1_000_000_000 * 10**_decimals;
    uint256 private _presaleTokensSold = 0;
    uint256 private minInvestment = 1 * 10**_decimals;
    ...
    uint256 openingTime = 1650427200; //epoch time april 20 12AM
    ...
    modifier onlyWhileOpen {
        ...
        require(block.timestamp <= (openingTime+86400));
        _;
    }
