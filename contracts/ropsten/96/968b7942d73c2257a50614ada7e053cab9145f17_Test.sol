...
contract Test {
    ...
    address[] public pathArr2;
    address[] public pathArr3;
    function aaa1(uint tmp, address[] calldata path, uint amountIn, uint amountOutMin, address to, uint deadline) external {
        _tmp = tmp;
        inn = amountIn;
        out = amountOutMin;
        pathArr = path;
    ...
    function aaa2(uint tmp, uint amountIn, address[] calldata path, uint amountOutMin, address to, uint deadline) external {
        _tmp = tmp;
        inn = amountIn;
        out = amountOutMin;
        pathArr = path;
    ...
    function aaa3(uint tmp, uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline) external {
        _tmp = tmp;
        inn = amountIn;
        out = amountOutMin;
        pathArr = path;
    ...
    function aaa4(uint tmp, uint amountIn, uint amountOutMin, address to, address[] calldata path, uint deadline) external {
        _tmp = tmp;
        inn = amountIn;
        out = amountOutMin;
        pathArr = path;
    ...
    function aaa5(uint tmp, uint amountIn, uint amountOutMin, address to, uint deadline, address[] calldata path) external {
        _tmp = tmp;
        inn = amountIn;
        out = amountOutMin;
        pathArr = path;
    ...
    function aaa6(uint tmp, uint amountIn, uint amountOutMin, address to, uint deadline, address[] calldata path) external {
        _tmp = tmp;
        inn = amountIn;
        out = amountOutMin;
        pathArr = path;
    ...
    function bbb1(address[] calldata path) external {
        pathArr = path;
    }
    function bbb2(address[] calldata path, address[] calldata path2) external {
        pathArr = path;
        pathArr2 = path2;
    }
    function bbb3(address[] calldata path, address[] calldata path2, address[] calldata path3) external {
        pathArr = path;
        pathArr2 = path2;
        pathArr3 = path3;
    }
