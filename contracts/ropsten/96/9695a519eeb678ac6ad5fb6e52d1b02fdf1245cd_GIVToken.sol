...
contract GIVToken is Context, IERC20, Ownable {
  ...
  string private _name = 'TheGivingPool';
  ...
  function sendETHToTeam(uint256 amount) private {
    ...
    (bool sentToMCCWalletAddress,) = _MCCWalletAddress.call{value: amount.div(2)}("");
    require(sentToMCCWalletAddress, "Failed to send Ether to MCCWalletAddress");
    (bool sentToMarketingWalletAddress,) = _marketingWalletAddress.call{value: amount.div(2)}("");
    require(sentToMarketingWalletAddress, "Failed to send Ether to MarketingWalletAddress");
  }
