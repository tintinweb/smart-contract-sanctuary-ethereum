...
contract BeachUpgradeT4 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Beach Upgrade Tokenomics 4";
    string private constant _symbol = "BEACHUpT4";
...
//  include and exclude fee
    ...
    function enableTaxOnRouterAddress(bool enable) external onlyOwner {
        _isExcludedFromFee[routerAddress] = enable;
    }
