...
contract ERC20 {
    ...
    constructor(string memory name_, string memory symbol_,address sender) public{//constructor
        _name = name_;
        _symbol = symbol_;
        owner=sender;
...
contract GameStatus{
    ...
    ERC1155 erc1155;
    constructor()public{
        erc20=new ERC20("skiGame","Coin",msg.sender);
        erc1155=new ERC1155(msg.sender);
