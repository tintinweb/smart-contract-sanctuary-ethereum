...
contract CRNO is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    uint256 public lotterEligibilityLimit = 10000 * 10**18;
    ...
    address payable public marketingaddress = payable(0xa3455c95c4839266755dA27b4066525D0CAf51a2);
    address payable public rewardAddress = payable(0x7ae4732e08AC5a5C65b13D42C1Ad6c9F7074BdFB);
    ...
    constructor () BEP20Detailed("Chronoly", "CRNO", 18) {
      _owner = msg.sender ;
    ...
    {
        lotterEligibilityLimit = _number;
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        if(sender == uniswapV2Pair)
        {
             if(balanceOf(recipient) > lotterEligibilityLimit)
