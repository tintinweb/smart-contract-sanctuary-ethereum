...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) external onlyOwner {
        ...
        require (success, "value wasn't sent");
    }

    //Add riggedRoll() function to predict the randomness in the DiceGame 
    // contract and only roll when it's going to be a winner
    function riggedRoll() external {
        require(address(this).balance >= 0.002 ether, "fuel the RiggedRoll");
