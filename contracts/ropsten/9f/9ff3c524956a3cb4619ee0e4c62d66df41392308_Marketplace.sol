...
contract Marketplace is IERC721Receiver, Context {
    ...
    event ContractCreated(address NFTContract);
    event Mint(address NFTContract, uint256 tokenId, address recipient);
    ...
    function mintAndCreateAuction(
        ...
        _mintAndCreateAuction(initialRoyalty_, _addressNFTCollection, _initialBid, _buyNowPrice, _endAuction);
        return index;
    ...
    function _mintAndCreateAuction(
        ...
        emit Mint(_addressNFTCollection, _nftId, address(this));
    ...
    function collectionAndCreateAuction(
        ...
        emit ContractCreated(_addressNFTCollection);

        _mintAndCreateAuction(_initialRoyalty, _addressNFTCollection, _initialBid, _buyNowPrice, _endAuction);
