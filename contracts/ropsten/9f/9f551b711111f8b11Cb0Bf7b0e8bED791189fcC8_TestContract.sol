...
contract TestContract is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    ERC721("ContractTest", "Test Contract"){
    ...
    function traverseNFT(
        ...
        require(trustedSourceLookup[_chainId].length != 0, "Tiny Girls: This chain is not a trusted source source.");
        ...
        require(msg.value >= quotedLayerZeroFee, "Tiny Girls: Not enough gas to cover cross chain transfer.");
