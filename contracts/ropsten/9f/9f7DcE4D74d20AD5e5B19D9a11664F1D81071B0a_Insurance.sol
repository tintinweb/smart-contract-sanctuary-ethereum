...
contract Insurance is ChainlinkClient, ConfirmedOwner {
    ...
    **/
    ...
    function transfer(address _buyer) public payable _onlyOwner(_buyer) {
    ...
    function buyInsurance(
        ...
        uint256 _expire
    ) public payable _onlyOwner(_buyer) returns (InsuranceStruct memory) {
        require(
    ...
    function getInsuranceForId(uint256 _idInsurance)
        public
        view
