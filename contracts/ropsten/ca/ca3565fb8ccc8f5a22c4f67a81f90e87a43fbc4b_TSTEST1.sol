...
contract TSTEST1 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TSTEST1() {
        ...
        name = "TSTEST1";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TSTEST1";                                             // Set the symbol for display purposes (CHANGE THIS)
