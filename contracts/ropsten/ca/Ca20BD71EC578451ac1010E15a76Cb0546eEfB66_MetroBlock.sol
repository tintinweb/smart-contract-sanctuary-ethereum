...
import "../../vault/MetroverseVault.sol";
...
contract MetroBlock is ERC721, Ownable {
    ...
    function getBlockScore(uint256 tokenId) external view returns (uint256 score) {
      ...
      return IMetroBlockInfo(scoresAddress).getBlockScore(tokenId);
    }
    ...
    function getHoodBoost(uint256[] calldata tokenIds) external view returns (uint256 score) {
      ...
      return IMetroBlockInfo(scoresAddress).getHoodBoost(tokenIds);
    }
...
import "../nfts/genesis/MetroBlock.sol";
import "../MetToken.sol";
