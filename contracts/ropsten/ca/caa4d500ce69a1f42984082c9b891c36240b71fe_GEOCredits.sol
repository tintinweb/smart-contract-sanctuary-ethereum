...
contract GEOCredits is BurnableToken, NoOwner {
  string public constant name = "GEO Credits"; // solium-disable-line uppercase
  string public constant symbol = "GEO"; // solium-disable-line uppercase
