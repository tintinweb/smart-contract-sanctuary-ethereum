...
contract Synthesis is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("Synthesis")
        GovernorSettings(10 /* 10 block */, 45818 /* 1 week */, 1000000e18)
