...
contract MLRB is IERC20, Ownable {
    ...
    string public constant _name = "Marketing Liquidity Reflections Burn";
    string public constant _symbol = "MLRB";
    ...
    function fund() public onlyOwner returns (bool _sent) {
        bool success;
        (success,) = address(this).call{value: startupETH}("");
