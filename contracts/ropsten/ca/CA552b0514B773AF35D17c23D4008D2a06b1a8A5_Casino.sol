// 0x7dA4c73Acd152A3B1911d259c1FDbC6B05BBC111
...
contract Casino is Ownable, ReentrancyGuard{
    ...
    uint96 private _maxWithdraftPeriod = 360000;
    uint96 public _defaultWithdraftPeriod = 360000;

    uint96 private _minWithdraftDelay = 0;
    uint96 private _maxWithdraftDelay = 360000;
    ...
    constructor(address token_) {
        ...
        _minWithdraftAmountLimit = uint256(10 ** _decimals).mul(100);
        _maxWithdraftAmountLimit = uint256(10 ** _decimals).mul(10000);
    ...
    function setDefaultSettings(uint256 defaultWithdraftAmountLimit, uint96 defaultWithdraftPeriod, uint96 defaultWithdraftDelay) public onlyOwner {
    ...
    function setUserSettings(address user, uint256 withdraftAmountLimit, uint96 withdraftPeriod, uint96 withdraftDelay) public onlyOwner {
    ...
    function getUserSettings(address user) public view returns(bool, uint96, uint256, uint96, uint256, uint256, uint256){

        require( _msgSender() == _serverWallet || _msgSender() == owner(), 'Access denied');
        ...
        return(_UserSettings.freeze, withdraftPeriod, withdraftAmountLimit, withdraftDelay,  _UserSettings.balance, _UserSettings.requestTime, _decimals);
