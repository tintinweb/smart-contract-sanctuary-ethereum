...
// mock
// import "../mocks/interfaces/IBorrowOperations.sol";
// import "../mocks/interfaces/ILeverageOperations.sol";
...
// contract RedeemOperations is IRedeemOperations {
    ...
    */
        ...
        external  
    {
        ...
        bytes32 currentNode = _firstRedemptionHint;
        ...
        while (currentNode != ZEROID && totals.remainingUSDA > 0 && _maxIterations > 0) {
            _maxIterations--;
            bytes32 nextNodeToCheck = sortedTroves.getNext(currentNode);
        ...
        returns (SingleRedemptionValues memory singleRedeem) 
    {
        ...
        if (newDebt == 0) {
            ...
            // remove sortedtroves
            sortedTroves.setSort(singleRedeem.borrowAddr, _opType, 0, 0, bytes32(0), bytes32(0));
        } else {
