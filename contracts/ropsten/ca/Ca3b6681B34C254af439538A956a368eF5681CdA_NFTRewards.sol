...
contract NFTRewards is ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 private constant MIN_STAKE = 1000 ether; // Minimum amount of tokens can be stake
    uint256 private constant MAX_STAKE = 20000 ether; // Maximum amount of tokens can be staked
    uint256 private constant STAKE_MULTIPLE = 1000 ether;

    uint256 private constant MIN_UNSTAKE = 1000 ether; // Minimum amount of tokens can be unstake
    uint256 private constant MAX_UNSTAKE = 20000 ether; // Maximum amount of tokens can be unstaked
    uint256 private constant UNSTAKE_MULTIPLE = 100 ether; // unstake count
        ...
        unstakelimits(_amount)
    {
        (uint256 firstInterval, uint256 secondInterval) = standardIntervals();
        Staker storage staker = poolStakers[msg.sender];
        require(staker.amount >= _amount, "Incorrect amount");
