...
// File contracts/newERC20Manager.sol
...
contract ERC20Manager is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    *            withDraw/cheapWithdraw锛氳浆绉?1 浣嶇敤鎴?8w Gas锛岃浆绉?3 浣嶇敤鎴?12w Gas锛岃浆绉?6 浣嶇敤鎴?18w Gas锛屼互姝ょ被鎺?
    ...
    */
    ...
    /**
    * 鏂规锛?
    *    1. 灏嗘巿鏉冪敤鎴蜂繚瀛樺湪鏈嶅姟鍣ㄤ腑锛屾寜闇€杞Щ鏌愰儴鍒嗙敤鎴?Token锛岃妭鐪?Gas
    *    2. 灏嗘巿鏉冪敤鎴蜂繚瀛樺湪璇?ERC20Manager 鍚堢害涓紝浣嗗皢 setApprover 鍑芥暟鐨勮皟鐢ㄦ帹缁欑敤鎴凤紝鑺傜渷 Gas
    *    3. 灏嗘巿鏉冪敤鎴蜂繚瀛樺湪璇?ERC20Manager 鍚堢害涓紝姣忔瀛樺叆鏁版嵁鑰楄垂 Gas锛屽湪澶ч噺鐢ㄦ埛鐨勬儏鍐典笅锛岃€楄垂澶ч噺 Gas
    */

    /**
    * 鏂规 1锛堣妭鐪?Gas锛岄渶瑕佹湇鍔″櫒澶勭悊閫昏緫锛夛細
    *    鐢变簬灏嗘巿鏉冪敤鎴蜂繚瀛樺湪鏈嶅姟鍣ㄤ腑锛屾寜闇€璋冪敤璇?ERC20Manager 鍚堢害浠庤€岃浆绉绘煇閮ㄥ垎鐢ㄦ埛 Token锛屽洜姝ゅ湪璇?ERC20Manager 鍚?
    *    绾︿腑鍙渶鍏虫敞 2 涓嚱鏁板嵆鍙€?
    *    鍔熻兘娴佺▼绠€鍗曟弿杩帮細
    *        1. 鐢ㄦ埛鍦ㄥ墠绔巿鏉冧竴瀹氭暟閲忕殑 Token
    *        2. 鏈嶅姟鍣ㄧ洃鍚 Token 鍚堢害鐨?Approval Event锛屽皢鎺堟潈鐢ㄦ埛鐨勪俊鎭繚瀛樺湪鏈嶅姟鍣ㄤ腑锛屾寜闇€璋冪敤璇?ERC20Manager 鍚堢害杩涜 Token 杞Щ
    *        3. 璋冪敤璇?ERC20Manager 鍚堢害涓殑 withdraw 鍑芥暟杩涜 Token 杞Щ锛寃ithdraw 鍑芥暟鍒嗕负 2 绉嶇被鍨嬶紝鍒嗗埆涓猴細
    *            3.1 cheapWithdraw - 杞Щ鏁扮粍鍙傛暟涓墍鏈夊湴鍧€涓嬬殑灏藉彲鑳藉鐨?Token 鑷宠 ERC20Manager 鍚堢害涓嬶紝鍙傝€?Gas 娑堣€楁祴璇曚腑鐨勬暟鎹紝璇蜂笉瑕佸皢鏁扮粍鍙傛暟璁剧疆杩囬暱锛屼互鍏嶅彂鐢熸湭鐭ラ敊璇鑷?Gas 娴垂
    *            3.2 safeWithdraw - 杞Щ璇?ERC20Manager 鍚堢害涓嬬殑 鏌愪釜 鏁伴噺鐨?Token 鑷?鏌愪釜 鍦板潃
    *
    * 鏂规 2锛堣妭鐪?Gas锛岀敤鎴锋搷浣滃鏉傦級锛?
    *    鐢变簬灏嗚缃巿鏉冪敤鎴峰嚱鏁扮殑璋冪敤鎺ㄧ粰浜嗙敤鎴凤紝鍥犳鍦ㄨ ERC20Manager 鍚堢害涓彧闇€鍏虫敞 2 涓嚱鏁板嵆鍙€?
    *    鍔熻兘娴佺▼绠€鍗曟弿杩帮細
    *        1. 鐢ㄦ埛鍦ㄥ墠绔巿鏉冧竴瀹氭暟閲忕殑 Token
    *        2. 鐢ㄦ埛鍦ㄥ墠绔皟鐢?setApprover 鍑芥暟锛屼富鍔ㄦ壙鎷?Gas
    *        3. 璋冪敤璇?ERC20Manager 鍚堢害涓殑 withdraw 鍑芥暟杩涜 Token 杞Щ锛寃ithdraw 鍑芥暟鍒嗕负 2 绉嶇被鍨嬶紝鍒嗗埆涓猴細
    *            3.1 cheapWithdraw - 杞Щ鏁扮粍鍙傛暟涓墍鏈夊湴鍧€涓嬬殑灏藉彲鑳藉鐨?Token 鑷宠 ERC20Manager 鍚堢害涓嬶紝鍙傝€?Gas 娑堣€楁祴璇曚腑鐨勬暟鎹紝璇蜂笉瑕佸皢鏁扮粍鍙傛暟璁剧疆杩囬暱锛屼互鍏嶅彂鐢熸湭鐭ラ敊璇鑷?Gas 娴垂
    *            3.2 safeWithdraw - 杞Щ璇?ERC20Manager 鍚堢害涓嬬殑 鏌愪釜 鏁伴噺鐨?Token 鑷?鏌愪釜 鍦板潃
    *
    * 鏂规 3锛堣€楄垂 Gas锛夛細
    *     鐢变簬璁捐鏋舵瀯鐨勫師鍥狅紝璇?ERC20Manager 鍚堢害閮ㄧ讲鏃舵病鏈変换浣曟暟鎹€傚嵆浣跨敤鎴疯繘琛屼簡鎺堟潈锛岃鍚堢害涔熸棤娉曡幏鍙栧埌鎺堟潈淇℃伅锛屽洜
    *     姝ゅ繀椤婚厤鍚堟湇鍔″櫒杩涜 Token 鐨?Approval Event 浜嬩欢鐩戝惉锛岃繃婊ょ瓫閫夋墍鏈?`to` 涓鸿 ERC20Manager 鍚堢害鍦板潃鐨?Event锛?
    *     骞惰皟鐢ㄨ ERC20Manager 鍚堢害涓殑 setApprover 鍑芥暟锛屽皢鎺堟潈鐢ㄦ埛淇濆瓨鍦ㄨ鍚堢害涓嬨€?
    *     鍔熻兘娴佺▼绠€鍗曟弿杩帮細
    *         1. 鐢ㄦ埛鍦ㄥ墠绔巿鏉冧竴瀹氭暟閲忕殑 Token
    *         2. 鏈嶅姟鍣ㄧ洃鍚 Token 鍚堢害鐨?Approval Event
    *         3. 璋冪敤璇?ERC20Manager 鍚堢害涓殑 setApprover 鍑芥暟锛屽皢鎺堟潈鐢ㄦ埛淇濆瓨鍦ㄨ鍚堢害涓?
    *         4. 璋冪敤璇?ERC20Manager 鍚堢害涓殑 withdraw 鍑芥暟杩涜 Token 杞Щ锛寃ithdraw 鍑芥暟鍒嗕负 5 绉嶇被鍨嬶紝鍒嗗埆涓猴細
    *            4.1 withdrawFrom锛堟帹鑽愶紝缁熶竴绠＄悊锛?- 杞Щ鏌愬湴鍧€涓嬬殑灏藉彲鑳藉鐨?Token 鑷宠 ERC20Manager 鍚堢害
    *            4.2 withdrawFromTo - 杞Щ鏌愬湴鍧€涓嬬殑灏藉彲鑳藉鐨?Token 鑷?鏌愪釜 鍦板潃
    *            4.3 withdraw锛堟帹鑽愶紝缁熶竴绠＄悊锛?- 杞Щ鎵€鏈夊叿鏈夋巿鏉冭褰曞湪璇?ERC20Manager 鍚堢害涓嬬殑鎵€鏈夊湴鍧€鐨勫敖鍙兘澶氱殑 Token 鑷宠 ERC20Manager 鍚堢害涓?
    *            4.4 withdrawTo - 杞Щ鎵€鏈夊叿鏈夋巿鏉冭褰曞湪璇?ERC20Manager 鍚堢害涓嬬殑鎵€鏈夊湴鍧€鐨勫敖鍙兘澶氱殑 Token 鑷?鏌愪釜 鍦板潃
    *            4.5 safeWithdraw - 杞Щ璇?ERC20Manager 鍚堢害涓嬬殑 鏌愪釜 鏁伴噺鐨?Token 鑷?鏌愪釜 鍦板潃
    *
    * 澶栭儴鍑芥暟锛?
    *     1. getTotalApprover view - 鑾峰彇鎵€鏈夊凡鎺堟潈鐨勭敤鎴峰垪琛?
    *     2. withdrawFrom
    *     3. withdrawFromTo
    *     4. withdraw
    *     5. withdrawTo
    ...
    *
    * 鍐呴儴鍑芥暟锛?
    *     1. approvedOfAddress view - 鑾峰彇 鏌愪釜 鍦板潃鐨?Token 鎺堟潈鏁伴噺
    *     2. balanceOfAddress view - 鑾峰彇 鏌愪釜 鍦板潃鐨?Token 鎸佹湁鏁伴噺
    *
    * 闈炶 ERC20Manager 鍚堢害鍐呭繀瑕佺殑鏁版嵁锛岀洿鎺ヨ皟鐢?Token 鍚堢害鑾峰彇鍗冲彲
    */
