...
contract StreeoNft is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI, uint price)  ERC721("Streeo.io NFT", "NFT") {
        setBaseURI(baseURI);
        setBasePRICE(price);
    }
    ...
    function setBasePRICE(uint _baseTokenPrice) public onlyOwner {
    ...
    // Недостаточно эфира для покупки NFT.
