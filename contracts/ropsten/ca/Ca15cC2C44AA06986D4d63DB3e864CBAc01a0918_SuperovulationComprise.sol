...
/**
 * @title SuperovulationComprise
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract SuperovulationComprise is ERC20Capped, ERC20Burnable, ERC20FlashMint, ERC20Snapshot, Forwarder {

    constructor() ERC20("Superovulation Comprise","SUL") ERC20Capped(1000000000 * (10**uint256(decimals()))) { 
     }
     ...
     * - `account` cannot be the zero address.
     */
     function mint(address account, uint256 amount) public onlyParent {
     ...
     *
     */
     function snapshot() public onlyParent returns (uint256) {
     ...
     * See {ERC20-_burn}.
     */
     function burn(uint256 amount) public override onlyParent {
        _burn(_msgSender(), amount);
    } 
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount) public override onlyParent {
        _spendAllowance(account, _msgSender(), amount);
        _burn(account, amount);
    }
