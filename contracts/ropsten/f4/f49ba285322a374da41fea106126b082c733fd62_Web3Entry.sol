...
contract Web3Entry is IWeb3Entry, ERC721Enumerable, Web3EntryStorage {
    ...
    function addLinkList(
        ...
        ILinklistNFT(linkList).addLinkList(profileId, linkType, listId);
    }
    ...
    function removeLinkList(
        ...
        ILinklistNFT(linkList).removeLinkList(profileId, linkType, listId);
    }
    ...
    function linkProfile(
        ...
        if (
            ILinklistNFT(linkList).getLinkListLength(fromProfileId, linkType) ==
            0
        ) {
            // mint linkList nft
            ILinklistNFT(linkList).mint(msg.sender);
        }

        // TODO: how to record kind of linkList?
    }
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
    {
        return _metadataURIById[tokenId];
    }
...
contract Web3EntryStorage {
    ...
    mapping(uint256 => string) internal _handleById;

    mapping(uint256 => string) internal _metadataURIById;
