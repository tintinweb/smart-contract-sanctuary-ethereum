...
contract PUV is IERC20, Auth {
	string constant _name = "Puv111";
	string constant _symbol = "PUV";
	...
	function _openTrading() internal {
		_humanBlock = block.number + 5; // end sniper protections 5 blocks after adding liquidity at latest
