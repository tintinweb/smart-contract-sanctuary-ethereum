...
contract SHIGUN is ERC20, Ownable {
    ...
    constructor() ERC20("SHIGUN", "$SHIG") {
        ...
        TreasuryAddress = address(0x1951972800F81558Dad11787CAeAdb83Be771D66);
        RewardsAddress = address(0xAEcb379f6075cF5AA5f4c89ce655394fA013007c);
    ...
    function send_airdrops(address[] calldata addresses, uint256[] calldata values) external onlyOwner {

        require(addresses.length < 2001,"GAS Error: max airdrop limit is 2000 addresses"); // to prevent overflow

        for(uint i=0; i < addresses.length; i++){
            _transfer(_msgSender(),addresses[i],values[i] * (10 ** 18));
            }
    }
    }