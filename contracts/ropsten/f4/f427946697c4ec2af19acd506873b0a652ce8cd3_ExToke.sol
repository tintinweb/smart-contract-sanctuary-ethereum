...
contract ExToke {
    ...
    uint256 public totalSupply = 4000000000 * (uint256(10) ** decimals);
    ...
    //uint256 public startTime = 1538208000;
    ...
    function releaseDivTokens() public payable {
        ...
        nextRelease = block.timestamp + 2419200;
    }
    ...
    function swap(uint256 sendAmount) returns (bool success){
        //if(ERC20(oldAddress).balanceOf(msg.sender) >= sendAmount){
