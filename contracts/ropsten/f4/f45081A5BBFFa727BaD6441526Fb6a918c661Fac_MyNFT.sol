...
contract MyNFT is ERC721A, Ownable {
    ...
    function freeMint(uint256 numberOfTokens) external {
        require(started, "The mi    nting has not yet started.");
        ...
        require(addressClaimed[_msgSender()] + numberOfTokens <= MAX_MINT, "The requested number is more than the possible value.");
