...
contract HashToken is MintableToken, BurnableToken {

    string public constant name = "Hash Token"; // solium-disable-line uppercase
    string public constant symbol = "HTTT"; // solium-disable-line uppercase
