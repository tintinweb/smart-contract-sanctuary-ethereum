...
contract QueenStaff is IQueenStaff, Pausable, ReentrancyGuard, Ownable {
     ...
     */
    modifier onlyOwnerOrChiefArtist(string memory caller) {
        if (msg.sender != owner() && msg.sender != _artist)
            revert RoyalLibrary.AuthorizationError({
                _caller: caller,
                _msg: "Not Owner nor Chief Artist",
                _address: msg.sender
            });
     ...
     */
    modifier onlyOwnerOrArtist(string memory caller) {
        if (
            msg.sender != owner() &&
            msg.sender != _artist &&
     ...
     */
    modifier onlyOwnerOrDeveloper(string memory caller) {
        if (
            msg.sender != owner() &&
     ...
     */
    modifier onlyOwnerOrChiefDeveloper(string memory caller) {
        if (msg.sender != owner() && msg.sender != _developer)
            revert RoyalLibrary.AuthorizationError({
                _caller: caller,
                _msg: "Not Owner nor Chief Developer",
                _address: msg.sender
            });
     ...
     */
    modifier onlyOwnerOrDAO(string memory caller) {
        if (msg.sender != owner() && msg.sender != queeneDAO)
            revert RoyalLibrary.AuthorizationError({
                _caller: caller,
                _msg: "Not Owner nor DAO",
                _address: msg.sender
            });
     ...
     * @notice Require that message sender is either owner or DAO contract.
     */
    modifier onlyOwnerOrAuctionHouse(string memory caller) {
        if (
            msg.sender != owner() &&
            ...
            revert RoyalLibrary.AuthorizationError({
                _caller: caller,
                _msg: "Not Owner nor Auction House",
                _address: msg.sender
            });
    ...
    function setArtist(address _newArtist)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrArtist("QueenStaff.setArtist")
    ...
    function allowArtist(address _allowedArtist)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrChiefArtist("QueenStaff.allowArtist")
        returns (address newArtist)
    {
    ...
    function disallowArtist(address _disallowedArtist)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrChiefArtist("QueenStaff.disallowArtist")
        returns (address newArtist)
    {
    ...
    function setDeveloper(address _dev)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrDeveloper("QueenStaff.setDeveloper")
    ...
    function allowDeveloper(address _allowedDeveloper)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrChiefDeveloper("QueenStaff.allowDeveloper")
    ...
    function disallowDeveloper(address _disallowedDeveloper)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrChiefDeveloper("QueenStaff.disallowDeveloper")
    ...
    function setQueenLab(IQueenLab _labContract)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrDeveloper("QueenStaff.setQueenLab")
    {
    ...
    function setQueenStorage(IQueenTraits _storageContract)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrDeveloper("QueenStaff.setQueenStorage")
    {
    ...
    function setQueenAuctionHouseProxy(
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrDeveloper("QueenStaff.setQueenAuctionHouseProxy")
    {
    ...
    function setQueenE(IQueenE _queenE)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrDeveloper("QueenStaff.setQueenE")
    {
        _setQueenE(_queenE);
    }
    ...
    function treasureBalance() external view returns (uint256) {
        return staffFunds[_developer] + staffFunds[_artist];
    }
    ...
    // fallback function
    fallback() external payable onlyOwnerOrAuctionHouse("QueenStaff.fallback") {
        _payStaff(msg.sender, 0, msg.value);
    }

    // receive function
    receive() external payable onlyOwnerOrAuctionHouse("QueenStaff.receive") {
        _payStaff(msg.sender, 0, msg.value);
    }
    ...
    function payStaff(uint256 _queeneAuctionId)
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrAuctionHouse("QueenStaff.payStaff")
    {
    ...
    function withdrawArtistFund()
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrChiefArtist("QueenStaff.withdrawArtistFund")
    {
    ...
    function withdrawDeveloperFund()
        ...
        nonReentrant
        whenNotPaused
        onlyOwnerOrChiefDeveloper("QueenStaff.withdrawDeveloperFund")
    {
...
contract ProxyAdmin is BaseContractController {
    ...
    modifier onlyAllowedByDAO() {
        if (!_upgradeAllowed && !queenStaff.isOnImplementation())
            revert RoyalLibrary.AuthorizationError({
                _caller: "modifier",
                _msg: "Upgrade Not Alowed by DAO",
                _address: msg.sender
            });
