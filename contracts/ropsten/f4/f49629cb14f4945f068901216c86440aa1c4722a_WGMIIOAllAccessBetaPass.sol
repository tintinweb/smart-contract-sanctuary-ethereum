...
// File: beta nft/EIP712Common.sol
...
// File: beta nft/Administrable.sol
...
// File: beta nft/WGMI2-ALLACCESS.sol
 ...
 function allowListMint(uint256 _count) external payable requireActiveAllowlist {
  ...
  function tokenURI(uint256 tokenId) public view virtual override(ERC721A, IERC721A) returns (string memory) {
    ...
    return
      string(
        abi.encodePacked(
          string(abi.encodePacked(baseImageURI, tokenId.toString(), imageExtension))
        )
      );
  }
