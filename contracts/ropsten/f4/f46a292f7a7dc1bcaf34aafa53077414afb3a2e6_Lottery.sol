...
contract Lottery {
   ...
   function revealCarWinners() public onlyOwner   payable{
        uint id = 0;
    ...
    function revealPhoneWinner() public onlyOwner payable{
        uint id = 1;
    ...
    function revealPCWinner() public onlyOwner payable {
        uint id = 2;
    ...
    function transfer(address newOwner) external onlyOwner payable  {
