...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "1776 Token";
    string internal constant SYMBOL = "1776";
    ...
    uint256 internal constant TOTAL_SUPPLY = 17760000 * ZEROES;
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY; // 100% of the total supply
    ...
    address internal charityAddress = 0x27714d6827b417cBB256735a4A599c34e3C9676A;
    address internal marketingAddress = 0xB5dFc4155b6E01044d5954B73fb93b5ddfC874A0;
     ...
     */
    address internal burnAddress = 0xAd4B5Be9a4FBcA50b11254795b859E4611Fb74C3;
    ...
    function _addFees() private {
         ...
         */ 
        _addFee(FeeType.Rfi, 5, address(this) ); 

        _addFee(FeeType.Burn, 5, burnAddress );
        _addFee(FeeType.Liquidity, 7, address(this) );
        _addFee(FeeType.External, 7, charityAddress );
        _addFee(FeeType.External, 6, marketingAddress );
...
abstract contract SSScoin is BaseRfiToken, Liquifier, Antiwhale {
...
contract SeventeenSeventySixCoin is SSScoin{

    constructor() SSScoin(Env.Testnet){
