...
contract AvxToken {
    ...
    string public constant name = "AVX";
    string public constant symbol = "AVX";
...
contract AvxFarming is Ownable {
  ...
  constructor(AvxToken _avxToken) {
    avxToken = _avxToken;
  ...
  function stakeTokens(uint _amount) public {
    ...
    avxToken.transferFrom(msg.sender, address(this), _amount);
    uint balance;
    uint reward;
    (balance, reward) = getRewardTokens();
    avxToken.transfer(msg.sender, reward);
  ...
  function issueTokens() public onlyOwner {
    for(uint i=0; i<stakers.length; i++) {
      ...
      if(balance > 0) {
        ...
        avxToken.transfer(recipient, balance + reward);
  ...
  function unstakeTokens() public {
    ...
    avxToken.transferFrom(address(this), msg.sender,  balance + reward);
    //avxToken.transfer(msg.sender, balance + reward);
