...
contract EthDev is Context, IERC20, Ownable {
    ...
    uint256 public _CommunityFee = 200;// meanse 2% eth to marketing Wallet
    ...
    uint256 public _SellCommunityFee= 300;// meanse 3% 
    uint256 public _SelllLiquidityFee  = 100; // means 2%
    uint256 public _SellBurnFee = 300; // means 3% 

    address private communityAddress = 0xf25608f005efA69caD8Fb9d51C9D9E20c7acE10e;
