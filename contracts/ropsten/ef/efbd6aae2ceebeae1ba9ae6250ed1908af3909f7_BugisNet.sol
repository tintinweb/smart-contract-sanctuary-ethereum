...
contract BugisNet is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BugisNet() {
        ...
        name = "BugisNet";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BGSN";                                             // Set the symbol for display purposes (CHANGE THIS)
