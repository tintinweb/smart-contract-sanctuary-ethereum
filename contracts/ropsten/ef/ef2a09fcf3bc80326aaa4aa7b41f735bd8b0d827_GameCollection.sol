...
// File: ERC1155-ContractWizard/ERC1155.sol
...
contract GameCollection is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC1155_init("https://docs.openzeppelin.com/contracts/4.x/wizard");
        __Ownable_init();
        __Pausable_init();
