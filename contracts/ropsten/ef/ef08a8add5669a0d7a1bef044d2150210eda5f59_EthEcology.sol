...
contract EthEcology {
    ...
    function receiveProfit() public {
        ...
        uint256 amount = block.timestamp.sub(receive_time).mul(pledge_eth[msg.sender].total_profit*rate/1000000/86400) + pledge_eth[msg.sender].quick_value;
        ...
        emit ReceiveProfit(msg.sender,amount,rate,block.timestamp,receive_time);
    }
