...
contract TNCBridgeCrossChain is Context {
    using SafeERC20 for IERC20;

    mapping(string => bool) public filledTNCTx;
    ...
    /**
     * swap token to tnc chain
     */
    function swapToken(
        uint256 amount,
        string calldata userName,
        string calldata tncAddress
