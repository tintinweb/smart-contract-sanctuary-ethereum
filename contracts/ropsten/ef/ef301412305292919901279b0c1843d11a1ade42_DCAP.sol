...
contract DCAP is ERC20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        gamingFeeReceiver = 0x34D21CDcA2d39CAb2E04640B89611719b8750Cd9;
        teamFeeReceiver = 0x88ae68b9A6229aE52BF13f113800C3C2AE8BC31F;
        devFeeReceiver = 0x70f5CCf6D94E0c8A5Fbaa180ed44C53C3bA28b65;
        utilityFeeReceiver = 0x3E884dC0cE217fB8CD229d70443D534bfb64A22F;
    ...
    function clearStuckToken(address tokenAddress, uint256 tokens) external onlyOwner returns (bool success) {
        require(tokenAddress != address(this), "tokenAddress can not be the DCAP");
