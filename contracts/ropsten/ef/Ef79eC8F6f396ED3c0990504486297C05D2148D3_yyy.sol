...
contract yyy is IERC20, Ownable {
    ...
    string constant _name = "yyy";
    string constant _symbol = "yyy";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 100) / 10000;
    uint256 _maxSellTxAmount = (_totalSupply * 100) / 10000;
    uint256 _maxWalletSize = (_totalSupply * 100) / 10000;
    ...
    address payable public marketingFeeReceiver = payable(0xF3C3319363591F8f9a7Eee56a00f8922F0f63B84);
