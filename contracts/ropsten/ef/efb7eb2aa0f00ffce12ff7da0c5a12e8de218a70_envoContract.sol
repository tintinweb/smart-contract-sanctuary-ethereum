...
// File: contracts/envoContract.sol
...
contract envoContract is ERC721Enumerable, Ownable {
    ...
    uint256 public vipDate = 1645366200;      // Date and time (GMT): Saturday, March 5, 2022 2:02:22 PM
    uint256 public vipPrice = 0.01 ether;      // VIP price before the auction starts
    uint256 public startDate = 1645380600;    // Date and time (GMT): Monday, March 7, 2022 2:02:22 PM
    uint256 public endDate = 1645467000;      // Date and time (GMT): Tuesday, March 8, 2022 2:02:22 PM
    ...
    constructor(
        ...
        mint(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, 14); // mint the first 14 to the founders envolabs wallet
        //mint("0x55cc003667464840F467eDb9AeE5F2c8f6b5a7c1",10); // mint the next 10 to supports and winners
    }
