...
contract TESTC is Context, IERC20, Ownable {
    
    string constant private _name = "TESTC";
    string constant private _symbol = "TESTC";
    uint8 constant private _decimals = 18;

    address public constant  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public autoLiquidityReceiver = payable(0x1318A8a1fbaE63d4B1658b511a45e09bf29f557e); // LP Address
    address payable public marketingWalletAddress = payable(0xEc171f1718761ff92a101D84225D85000b918CdA); // Marketing Address
    address payable public operationsWalletAddress = payable(0x4CC6b44bA6b90BA545A1308812084d6F13478616); // operations Address
    ...
    uint256 public operationsShare = 20;
    ...
    uint256 public walletMax = 10 * 10**6 * 10**_decimals;
