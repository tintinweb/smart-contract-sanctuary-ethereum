...
contract TEST is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 5000001 * (10**18); // 0.5% of total supply
    uint256 public maxBuyTransactionAmount = 5000001 * (10**18); // 0.5% of total supply
    uint256 public swapTokensAtAmount = 500000 * (10**18);
    uint256 public maxWalletToken = 10000000 * (10**18); // 1% of total supply

    uint256 private buyTotalFees = 0; // Cannot be set higher than 0%
    uint256 public sellTotalFees = 9; // Cannot be set higher than 12%
    uint256 public earlySellTotalFee = 24; // Cannot be set higher than 24%

    // auto burn fee
    uint256 public burnFee = 0;
    address public deadWallet = 0x3b4F7C9136E3857e80CD25B7daa7A4d5CE6c90c6;
    

    // distribute the collected tax percentage wise
    uint256 public liquidityPercent = 33; // 33% of total collected tax
    uint256 public marketingPercent = 34; // 34% of total collected tax
    uint256 public devPercent = 33; // 33% of total collected tax


    address payable public marketingWallet = payable(0x3b4F7C9136E3857e80CD25B7daa7A4d5CE6c90c6);
    address payable public devWallet = payable(0x5a7bfdFEd3ceFF68001085F780E6acb92a6210d2);
    ...
    constructor() ERC20("Test Name", "TEST3") {
    ...
    function _transfer(address from, address to, uint256 amount) internal override 
    {
        ...
        if(!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            if(enableEarlySellTax && span <= 5 minutes) {
