...
contract HanfuNFT is ERC721A, Ownable {
    ...
    uint256 public supply = 5000;  //5200 - (120 + 80)  reserve 120 for team, reserve 80 for og
    ...
    function ogDrop() public onlyOwner {
        _safeMint(0x2760B477b95B506dC9d3252B96e9A9eFC2b16a88, 2);
        _safeMint(0x2760B477b95B506dC9d3252B96e9A9eFC2b16a88, 2);
    }
    ...
    function withdraw() external onlyOwner {
        ...
        busyWallet4.transfer(toDevBalance);
    ...
    function buyNFTStock(uint nftId, uint amount, address seller) public {
        if (stock[nftId].length() == 0) {
            ...
            if (ownAmount > 0) {
                ...
                stockSelling[nftId].set(seller, ownAmount);
            } else {
