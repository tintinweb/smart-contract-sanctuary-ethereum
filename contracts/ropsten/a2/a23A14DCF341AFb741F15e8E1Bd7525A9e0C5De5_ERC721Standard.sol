    ...
    ERC721Burnable
{
    ...
    bytes4 public constant ROYALTY_INTERFACE =
        bytes4(keccak256("ROYALTY_INTERFACE"));
    ...
    function batchMint(
        ...
        require(
            _to.length == _uri.length &&
                _to.length == _feeAddresses.length &&
                _to.length == _fees.length,
            "Invalid params"
        );
    ...
    function setFeeAddress(
        ...
        require(
            _msgSender() == feeAddresses[_tokenId][_addressPosition],
            "Invalid account"
        );
    ...
    function getFeeAddresses(uint256 _tokenId)
        external
        view
    ...
    {
        return
            _interfaceId == ROYALTY_INTERFACE ||
