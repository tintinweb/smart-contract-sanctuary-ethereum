...
import "./interfaces/IGlideFactory.sol";
import "./interfaces/IGlideCallee.sol";
...
contract GlidePair is GlideERC20 {
        ...
        if (feeOn) {
            if (_kLast != 0) {
                ...
                if (rootK > rootKLast) {
                    ...
                    uint256 denominator = (rootK / 4).add(rootKLast);
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "Glide: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "Glide: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "Glide: INSUFFICIENT_LIQUIDITY"
        );
        ...
        require(
            ...
            "Glide: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
...
contract GlideERC20 is IGlideERC20 {
    ...
    string public constant override name = "Glide LPs";
    string public constant override symbol = "Glide-LP";
