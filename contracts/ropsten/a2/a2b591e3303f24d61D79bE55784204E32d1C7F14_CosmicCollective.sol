...
contract CosmicCollective is ERC721A, Ownable {
    ...
    uint256 public HolderlistPrice = 0.1 ether;
     ...
     */
    function mintHolder(uint256 _quantity, uint256 allowedQuantity, bytes32[] memory _merkleProof) external payable HoldernotEnded {
