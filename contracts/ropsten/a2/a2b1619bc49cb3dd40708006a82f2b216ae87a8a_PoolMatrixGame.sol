...
contract PoolMatrixGame {
    ...
    */
    ...
    function register(address referrer, uint256 investAmount, uint256 initialBalance) public payable {
        ...
        users[msg.sender].referalReward = 0;
    ...
    function buyLevel(uint8 level, uint256 investAmount) public payable {
        ...
        for (uint i = 0; i < 3; i++) {
            ...
            users[referrer].referalReward += value;
    ...
    function getUser(address userAddr) public view returns(bool registered, uint registrationTimestamp, address userAddress, address referrer, uint256 debit, uint256 credit, uint256[] memory userCountInLine, uint256 referalReward, uint256 levelProfit, UserLevelInfo[] memory levels) {
