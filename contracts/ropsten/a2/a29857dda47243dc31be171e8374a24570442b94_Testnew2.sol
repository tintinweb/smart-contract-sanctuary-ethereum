...
contract Testnew2 is Context, IERC20, Ownable {
    ...
    string private _name = "Testnew2";
    string private _symbol = "Testnew2";
    ...
    function setMarketingFeePercent(uint256 fee) public onlyOwner {
        require(fee < 80, "Marketing fee cannot be more than 80% of liquidity");
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 690000, "Max Tx Amount cannot be less than 69 Million");
