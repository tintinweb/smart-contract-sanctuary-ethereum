...
/**
 * KRISTORIUM BELLE 美利金 smart contract.
 */
contract KRISTORIU is AbstractToken {
  /**
  ...
  string constant public name = "KRISTORIUM BELLE 美利金";
  string constant public symbol = "美利金";
