...
contract TestCoinVN is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TestCoinVN() {
        ...
        name = "TestCoinVN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TCVN";                                             // Set the symbol for display purposes (CHANGE THIS)
