...
contract DBSNFTLootBoxTokens is ERC721Burnable, Ownable{
    ...
    */
    ...
    function getSupply(uint256 _tableId) public view returns(uint256){
        require(_tableId > 0);
    ...
    function mint(
        ...
        require(getSupply(_id) > _amount, "supply is not enough");
...
contract DBSNFTLootBox is ReentrancyGuard, AccessControl, Ownable{
    ...
    // event
    event newLoopBox(uint256 _Id, string _name, string _image, string _description);
    event eUpdateBox(uint256 _Id, string _name, string _image, string _description);
     ...
     */
    function listBox(uint256 _id, string memory _name, string memory _image, string memory _description) public onlyOwner{
        ...
        boxids.push(_id);
        emit newLoopBox(_id, _name, _image, _description);
    }

    /**
     * @param _id update box
     */
    function updateBox(uint256 _id, string memory _name, string memory _image, string memory _description) public onlyOwner{
        require(_id > 0 && 0 > 0, "DBSNFTLootBox: listbox param failed");
        ...
        emit eUpdateBox(_id, _name, _image, _description);
    }
