...
contract MetaWolves is ERC721, Pausable, Ownable {
    ...
    uint64 private celebMintStageLimitPerWallet = 30;
    uint64 private celebMintStageTotalSupplyLimit = 500;
    ...
    uint256 public TotalSupply = 9999; //tokenID should be <= TotalSupply
