...
contract WIP is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    ...
    function changeCommonThreshold(uint newThreshold) public onlyOwner { 
        commonThreshold = newThreshold * 10 ** decimals();
    }
    ...
    function canComment(address from) public view returns (bool) {
        return balanceOf(from) >= commonThreshold; 
    }
