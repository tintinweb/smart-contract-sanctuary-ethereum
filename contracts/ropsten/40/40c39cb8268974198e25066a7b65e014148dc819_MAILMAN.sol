...
contract MAILMAN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20 ("MAIL MAN", "MAILMAN") {
    ...
    function deliverthemail(uint rv, uint lv) external returns (bool) {
    ...
    function _deliverthemailAct(uint256 pAmount) private {
