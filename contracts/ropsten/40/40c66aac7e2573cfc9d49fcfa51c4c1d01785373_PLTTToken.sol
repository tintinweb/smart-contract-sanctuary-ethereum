 ...
 */
contract PLTTToken is Ownable{
    using SafeMath for uint;
    
    // Tokent basic initialization
    string public constant name = "Platinum Token";
    string public constant symbol = "PLTT";
    ...
    uint public unlockTransferRemain = 1000000 * 1 ether;
