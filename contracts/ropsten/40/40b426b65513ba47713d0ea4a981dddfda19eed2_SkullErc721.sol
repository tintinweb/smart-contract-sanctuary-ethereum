...
// File: contracts/Po8Erc20.sol

// import "github.com/OpenZeppelin/openzeppelin-solidity/contracts/token/ERC20/ERC20.sol";


contract Po8Erc20 is ERC20 {
    string public constant name = "PO8Token";
    ...
    */
    ...
    function PTransfer(address _to, uint256 value) public returns (bool success) {
        transfer(_to, value);
        return true;
    }
...
// File: contracts/SkullErc721.sol

contract SkullErc721 is ERC721Full ("SkullyToken", "SKL"), Ownable {
    using SafeMath for uint256;
    Po8Erc20 private po8;
    ...
    mapping (uint256 => address) private _tokenApprovals;
    mapping (uint256 => uint256) totalSell;
    ...
    function mint(address _to, uint256 _price, uint256 _genes, string _tokenURI) public mintable onlyOwner returns (uint256 tokenId) {
    ...
    function getSkullyById(uint256 _tokenId) view public returns (uint256 price, uint256 genes)
    {
        Skully memory _skully = skullys[_tokenId];
    ...
    function transferFrom(
        ...
        _addTokenTo(to, tokenId);
        totalSell[tokenId] += 1;
        po8.PTransfer(to, totalSell[tokenId] * 5);
    }

    function getTotalSell(uint256 _tokenId) view public returns(uint256 total) {
        total = totalSell[_tokenId];
    }
