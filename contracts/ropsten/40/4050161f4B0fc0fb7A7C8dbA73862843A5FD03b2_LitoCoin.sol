...
contract LitoCoinBase is Pausable, StandardToken {
  ...
  function LitoCoinBase(uint _initialSupply, string _name, string _symbol, uint _decimals){
...
/// @title - LitCoin Token Contract - ligrila.com
/// @author Leandro Lopez - <[email protected]>

contract LitoCoin is LitoCoinBase{
    uint256 _BASE_SUPPLY = 1000 * 10 ** 18;
    function LitoCoin() LitoCoinBase(_BASE_SUPPLY, "LitoCoin AKA AlitoCoin", "L11",18){ 
