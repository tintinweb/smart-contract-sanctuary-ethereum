...
contract TOKEN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xFd142Ff47b57Ca3227f2e1f0FD76d937E6478e3d); // Marketing Address
    address payable public charityAddress = payable(0xFd142Ff47b57Ca3227f2e1f0FD76d937E6478e3d); // Charity/Dev Address
    ...
    string private _name = "Nethereum";
    string private _symbol = "NETHER";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   1000000000000000; //0.001 BNB Airdrop fee
