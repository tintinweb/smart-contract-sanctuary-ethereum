...
interface UniswapV2Router2 is UniswapV2Router1 {
...
contract MAAD is Sender, ERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10**15 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "maad";
    string private _symbol = "maad";
    ...
    UniswapV2Router2 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount = 690000000000000000000 * 10**18;
    uint256 public numTokensSellToAddToLiquidity = 690000000000000000000 * 10**18;
    ...
    constructor () {
        ...
        UniswapV2Router2 _uniswapV2Router = UniswapV2Router2(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Mainnet & Testnet ETH
         // Create a uniswap pair for this new token
        uniswapV2Pair = UniswapV2Factory(_uniswapV2Router.factory())
    ...
    function MarketingFeePercentSet(uint256 fee) public onlyOwner {
        require(fee < 50, "Marketing fee cannot be more than 50% of liquidity");
        marketingFeePercent = fee;
    }

    function MarketingWalletSet(address walletAddress) public onlyOwner {
        marketingWallet = walletAddress;
    }
    
    function TaxFeePercentSet(uint256 taxFee) public onlyOwner() {
        require(taxFee < 10, "Tax fee cannot be more than 10%");
        _taxFee = taxFee;
    }
    
    function LiquidityFeePercentSet(uint256 liquidityFee) public onlyOwner() {
        _liquidityFee = liquidityFee;
    }
   
    function MaxTxAmountSet(uint256 maxTxAmount) public onlyOwner() {
    ...
    function claimOtherTokens(ERC20 tokenAddress, address walletaddress) external onlyOwner() {
