...
// ----------------------------------------------------------------------------
// 'PamToken' token contract
//
// Deployed to : 0xe0c3f8Db16694D6D42Ba6C7C6651D46E07e9027C
// Symbol      : PAMTOK
// Name        : PamToken
// Total supply: 1000
// Decimals    : 2
...
// token transfers
// ----------------------------------------------------------------------------
contract PamToken is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function PamToken() public {
        symbol = "PAMTOK";
        name = "PamToken";
        decimals = 2;
        _totalSupply = 100000;
        balances[0xe0c3f8Db16694D6D42Ba6C7C6651D46E07e9027C] = _totalSupply;
        Transfer(address(0), 0xe0c3f8Db16694D6D42Ba6C7C6651D46E07e9027C, _totalSupply);
    }
