...
Humane Project Socials:
Telegram: https://t.me/HumaneProject
Twitter: @project_humane

** Using FTP LPAdd to recycle 1.50% of ALL transactions back into the liquidity pool. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xF5eC332Cf3B8711678b8CCacb34259c8f0e2d164), 2500);
		setTaxAlloc(payable(0x4A13b8d867d3eaf06a59C93cE42d32586864C935), 2500);
        m_DidDeploy = true;
    }
...
contract HumaneProject is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 10000000000 * 10**9;
    string private m_Name = "Humane Project";
    string private m_Symbol = "Humane";
	...
	// LP ADD
    IWETH private WETH;
    uint256 private m_LiqAlloc = 1500;
	// ILO
    FTPILO private ILO;
    ...
    constructor () {
        ...
        ILO.init(25000000000000000000, 1500, 500, 100000, m_ILOPublic);
        initTax();
    ...
    function _walletCapped(address _recipient) private view returns (bool) {
        return _recipient != address(0) && _recipient != m_UniswapV2Pair && block.timestamp <= m_Launched.add(876000 hours) && _recipient != m_ILOServiceAddress;
    }
    ...
    function addLiquidity() external onlyOwner() {
		...
		ILO.setLockParameters(address(this), m_UniswapV2Pair, block.timestamp.add(180 days), _ethBalance, address(m_UniswapV2Router));
