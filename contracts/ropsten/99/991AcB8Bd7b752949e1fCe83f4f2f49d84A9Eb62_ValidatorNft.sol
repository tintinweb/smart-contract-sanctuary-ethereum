...
contract ValidatorNft is Ownable, ERC721AQueryable, ReentrancyGuard {
  ...
  modifier onlyAggregator() {
    require(_aggregatorProxyAddress == msg.sender, "Not allowed to mint nft");
    _;
  }
  ...
  function setAggregator(address aggregatorProxyAddress) public onlyOwner {
      ...
      returns (bool)
  {
      ...
      if (
          isOpenSeaProxyActive &&
          operator == _aggregatorProxyAddress
      ) {
          return true;
      }
