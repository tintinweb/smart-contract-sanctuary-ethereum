 ...
 * */
 ...
 contract popo is Context, IERC20, Ownable {
     ...
     string private constant _name = "popo";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xaB28C849BaD5cf097dA8c13E862dB14713371098);
         _feeAddrWallet2 = payable(0xaB28C849BaD5cf097dA8c13E862dB14713371098);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xaB28C849BaD5cf097dA8c13E862dB14713371098), _msgSender(), _tTotal);
     }
