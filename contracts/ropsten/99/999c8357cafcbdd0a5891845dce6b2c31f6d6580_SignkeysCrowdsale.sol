 ...
 * @author Remco Bloemen <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f381969e909cb3c1">[email&#160;protected]</a>π.com>, Eenae <<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="96f7faf3eef3efd6fbffeef4efe2f3e5b8fff9">[email&#160;protected]</a>>
...
contract SignkeysCrowdsale is Ownable, ReentrancyGuard {
    ...
    event BuyTokens(address buyer, uint256 tokenPrice, uint256 amount, bytes16 customerId);
    ...
    function buyTokens(
        ...
        address receivedSigner = ecrecover(
            keccak256(
                abi.encodePacked(
                    _tokenPrice, _minWei, _customerId, _expiration, msg.sender, weiAmount
                )
            ), _v, _r, _s);
