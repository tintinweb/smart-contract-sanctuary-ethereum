...
contract maxwallet1 is Context, IERC20, Ownable {
    ...
    uint256 public  _maxWallet = 100 * 10**7 * 10**9;

    string private _name = "max1";
    string private _symbol = "maxw1";
