...
contract AXPCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AXPCoin() {
        ...
        name = "AXPCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AXPC";                                             // Set the symbol for display purposes (CHANGE THIS)
