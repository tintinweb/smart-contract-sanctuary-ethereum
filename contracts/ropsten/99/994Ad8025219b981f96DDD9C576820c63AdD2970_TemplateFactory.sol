...
interface ITemplateFactory {
    ...
    event TemplateVersionCreated(bytes32 indexed templateId, uint256 indexed version, bytes creationCode, address indexed sender);
    ...
    event TemplateDeployed(address indexed instance, bytes32 indexed templateId, bytes args, bytes[] functionCalls, address indexed sender);
    ...
    function initialize(address networkAddress) external;
    ...
    function createTemplateVersion(bytes32 templateId, bytes memory creationCode) external returns (bool);
    ...
    function deployTemplateVersionLatest(bytes32 templateId, bytes memory args, bytes[] memory functionCalls) external returns (address instance);

    function deployTemplateVersion(bytes32 templateId, uint256 version, bytes memory args, bytes[] memory functionCalls) external returns (address instance);
