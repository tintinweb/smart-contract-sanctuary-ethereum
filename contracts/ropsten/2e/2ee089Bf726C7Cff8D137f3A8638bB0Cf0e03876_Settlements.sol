...
contract Settlements {
    ...
    function changeFeeAccount(address payable newFeeAccount) public onlyOwner {
    ...
    function _end(uint256 id) private {
        ...
        uint256 toTake = (total / 1000) * fee;

        bool sent = winner.send(total - toTake) && feeAccount.send(toTake);
