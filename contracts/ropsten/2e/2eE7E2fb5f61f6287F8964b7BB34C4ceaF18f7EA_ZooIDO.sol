...
contract ZooIDO is Ownable 
{
	...
	uint256 public firstPhaseDuration = 4 hours; //5 days;                                 // Duration of whitelist buy phase.
	uint256 public secondPhaseDuration = 4 hours;//3 days;                               // Duration of non whitelist buy phase.
	uint256 public thirdPhaseDuration = 4 hours;//17 days;                                // Duration of zoo tokens lock from start of ido.
