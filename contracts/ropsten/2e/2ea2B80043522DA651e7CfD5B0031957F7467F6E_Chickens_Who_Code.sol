...
contract Chickens_Who_Code is Ownable, ERC721Enumerable, ReentrancyGuard {
    ...
    modifier mintModifier(uint8 amount) {
        ...
        require(_tokenIds.current() < 1000, "Exceeds total supply");
        require(.05 ether * amount <= msg.value, "eth value sent is not correct");
        _;
    }
    ...
    mintModifier(_amount)
    {
        ...
        if (publicMint == false) {
            require(_premintList[msg.sender] - _amount >= 0, "Exceeded mint limit");
        ...
        // If it's public mint, you are not allowed to mint more than 10 at a time
