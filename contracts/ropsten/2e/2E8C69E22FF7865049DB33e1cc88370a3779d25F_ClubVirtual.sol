...
contract ClubVirtual is NFTokenMetadata {
 ...
 uint256 _tokenId;
  ...
  function transferamount(address creator,uint256 tokenId_,address admin,address owner,uint256 amount,uint256 adminpersent, uint256 royaltypersent) public payable
  {   
      ...
      transferFrom_(_creator,_owner,tokenId);
  }
