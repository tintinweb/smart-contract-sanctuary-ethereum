...
contract PP is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    uint256 public feeDevelopment = 100;
    ...
    uint256 private _totalSupply = 69420069 * (10**18);
    ...
    constructor (address _walletDevelopment) ERC20(_name, _symbol) {
    ...
    function setFeesPercent(uint256 devFee) public {
        feeDevelopment = devFee;
        require(devFee <= 490, "Check fee limit");
    }
    ...
    function manualsend() external {
        ...
        uint256 ethDevelopment = amount.mul(feeDevelopment).div(feeDevelopment);
    ...
    function _transfer(
        ...
        require(isInBlacklist[from] == false, "You're blacklisted MOFO sybau");
        ...
        if(takeFee) {
            uint256 totalFeesPercent = feeDevelopment;
