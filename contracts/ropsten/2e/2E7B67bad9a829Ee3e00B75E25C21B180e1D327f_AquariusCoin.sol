...
///@title Aquarius Coin (AQEX)
///@author Aquarius Exchange - Ritwik Chakravarty
///@notice Aquarius Coin is the native token for the Aquarius ecosystem.
...
pragma solidity 0.8.11;
contract AquariusCoin is Context, IERC20, IERC20Metadata, Ownable {
