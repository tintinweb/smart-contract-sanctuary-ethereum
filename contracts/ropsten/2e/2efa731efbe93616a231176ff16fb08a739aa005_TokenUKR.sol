...
contract TokenUKR is ERC20Std, Governance {
    ...
    constructor() public ERC20Std("Save Ukraine DAO", "UKR", 18){
        ...
        USDT = IERC20(0x8bD2Ac5Ed903D30C9dbbb1067a412bd77a894AA4);
        //USDT
        _whiteList[0x8bD2Ac5Ed903D30C9dbbb1067a412bd77a894AA4] = 1;
        //WBTC
    ...
    function donate(address token, uint256 amount) external returns (uint256 halfAmountOfUKR) {
