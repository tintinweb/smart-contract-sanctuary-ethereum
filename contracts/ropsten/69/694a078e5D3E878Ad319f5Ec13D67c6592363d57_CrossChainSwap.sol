...
contract CrossChainSwap is ZetaInteractor, ZetaReceiver, CrossChainSwapErrors {
        ...
        payable
    {
        ...
        bool success2 = IERC20(_zetaToken).approve(address(connector), zetaFixedAmount);
        if (!success2) revert ErrorApprovingTokens(_zetaToken);
        ...
        connector.send(
            ZetaInterfaces.SendInput({
                ...
                gasLimit: crossChainDestinationGasLimit,
