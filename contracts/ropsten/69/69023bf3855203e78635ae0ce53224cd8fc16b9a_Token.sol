...
contract HashnodeTenaraCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTenaraCoin() {
        ...
        name = "HashnodeTenaraCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HTTCN";                                             // Set the symbol for display purposes (CHANGE THIS)
