...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0xBB113ad1B7C4615CcF59A5D8A4062335038D6ee5), // ApeGenesisPool
        address(0xDb4736eE9Cf22d79501e4C079ac8ca090694274b) // ApeRewardPool
    ];

    // core components
    address public vape;
    address public boardape;
    address public bondape;
    ...
    modifier checkOperator {
        require(
            IBasisAsset(vape).operator() == address(this) &&
                ...
                IBasisAsset(bondape).operator() == address(this) &&
    ...
    function getBurnableVapeLeft() public view returns (uint256 _burnableVapeLeft) {
        ...
        if (_vapePrice <= vapePriceOne) {
            ...
            uint256 _bondSupply = IERC20(bondape).totalSupply();
    ...
    function initialize(
        ...
        bondDepletionFloorPercent = 10000; // 100% of bondApe supply for depletion floor
        seigniorageExpansionFloorPercent = 3500; // At least 35% of expansion reserved for masonry
        maxSupplyContractionPercent = 300; // Upto 3.0% supply for contraction (to burn vApe and mint bondApe)
    ...
    function buyBonds(uint256 _vapeAmount, uint256 targetPrice) external onlyOneBlock checkCondition checkOperator {
        ...
        uint256 newBondSupply = IERC20(bondape).totalSupply().add(_bondAmount);
        ...
        IBasisAsset(bondape).mint(msg.sender, _bondAmount);
    ...
    function redeemBonds(uint256 _bondAmount, uint256 targetPrice) external onlyOneBlock checkCondition checkOperator {
        ...
        IBasisAsset(bondape).burnFrom(msg.sender, _bondAmount);
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            if (previousEpochVapePrice > vapePriceCeiling) {
                ...
                uint256 bondSupply = IERC20(bondape).totalSupply();
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(bondape), "bondape");
