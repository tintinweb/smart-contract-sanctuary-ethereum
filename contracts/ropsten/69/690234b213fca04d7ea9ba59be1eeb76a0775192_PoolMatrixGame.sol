...
contract PoolMatrixGame {
    ...
    uint256[] levelPrices = [
        0.01 * 1e18, //  1 POOL = 0.01 ETH 
        0.01 * 1e18, //  2 POOL = 0.01 ETH 
        0.01 * 1e18, //  3 POOL = 0.01 ETH 
        0.01 * 1e18, //  4 POOL = 0.01 ETH 
        0.01 * 1e18, //  5 POOL = 0.01 ETH 
        0.01 * 1e18, //  6 POOL = 0.01 ETH 
        0.01 * 1e18, //  7 POOL = 0.01 ETH 
        0.01 * 1e18, //  8 POOL = 0.01 ETH 
        0.01 * 1e18, //  9 POOL = 0.01 ETH 
        0.01 * 1e18, // 10 POOL = 0.01 ETH 
        0.01 * 1e18, // 11 POOL = 0.01 ETH 
        0.01 * 1e18, // 12 POOL = 0.01 ETH 
        0.01 * 1e18, // 13 POOL = 0.01 ETH 
        0.01 * 1e18, // 14 POOL = 0.01 ETH 
        0.01 * 1e18, // 15 POOL = 0.01 ETH 
        0.01 * 1e18, // 16 POOL = 0.01 ETH 
        0.01 * 1e18, // 17 POOL = 0.01 ETH 
        0.01 * 1e18, // 18 POOL = 0.01 ETH 
        0.01 * 1e18, // 19 POOL = 0.01 ETH 
        0.01 * 1e18  // 20 POOL = 0.01 ETH 
    ];
    ...
    uint256 constant REGISTRATION_PRICE = 0.01 * 1e18; // 0.01 eth
