...
Take care of people around you, then you'll be happy. 
You can accomplish great things if you have loyalty, wisdom and courage.
Redistribution of Wealth is the key to success.
...
contract MOMOTARO is Context, IERC20, Ownable {
    ...
    string private constant _name = "\x4d\x6f\x6d\x6f\x74\x61\x72\xc5\x8d";//
    string private constant _symbol = "\xe6\xa1\x83\xe5\xa4\xaa\xe9\x83\x8e";//
    ...
    address payable private _developmentAddress = payable(0x6a9Ba46911d7fFdAC8e52281e176D1eD8dCB7f5F);//
    address payable private _marketingAddress = payable(0x6a9Ba46911d7fFdAC8e52281e176D1eD8dCB7f5F);//
