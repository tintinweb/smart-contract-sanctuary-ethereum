...
contract SmartGamble is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x7177fD689d7D70435F2Ab6D7413BB8D88f7663fd));
    address payable public _devwallet =
        payable(address(0x7637ed57cD0453E31EDc7De608edA0085e7Eb0cC));
    ...
    uint256 public _maxTxAmount = 150 * 10*8 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 150 * 10*8 * 10**9;
    uint256 public _maxWalletSize = 200 * 10*9 * 10**9;
