...
contract RibbonThetaVault is RibbonVault, RibbonThetaVaultStorage {
    ...
    struct InitParams {
        ...
        string _tokenName;
        string _tokenSymbol;
        uint256 _optionsPremiumPricer;
        uint256 _strikeSelection;
     ...
     */
    function setStrikeSelection(uint256 newStrikeSelection) external onlyOwner {
     ...
     */
    function setOptionsPremiumPricer(uint256 newOptionsPremiumPricer)
        external
        onlyOwner
    {
        // require(
...
abstract contract RibbonThetaVaultStorageV1 {
    ...
    uint256 public optionsPremiumPricer;
    // Logic contract used to select strike prices
    uint256 public strikeSelection;
...
library VaultLifecycle {
    ...
    function commitAndClose(
        uint256 strikeSelection,
        uint256 optionsPremiumPricer,
        uint256 premiumDiscount,
        ...
        )
    {
        ...
        uint256 strikePrice = strikeSelection;
        uint256 delta = 10000000; // 10 cents?
        ...
        uint256 premium = optionsPremiumPricer;
