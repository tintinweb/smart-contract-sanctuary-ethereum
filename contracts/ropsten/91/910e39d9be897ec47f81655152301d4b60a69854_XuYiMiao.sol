...
contract XuYiMiao {
    ...
    // Constants.
    address constant teamAddress = 0x7271cBf5232D8c5B838524cc49207d52412BD163;
    uint256 constant teamPortion = 2; // 2%.
    uint256 constant dividendPortion = 70; // 70%.
    uint256 constant delayPeriod = 30; // 30s.
    uint256 constant initialPeriod = 300; // 5min.
    uint256 constant icoPeriod = 60; // 1min.
    uint256 constant coolingPeriodBetweenRounds = 1; // 1s.
