...
contract HpbBallot {
    ...
    //当前阶段区块号
    uint public currentVoteStageBlock;
   ...
   */
    ...
    constructor(
        ...
        uint _version
			...
			//设置默认的阶段block
			currentVoteStageBlock=_startBlock;
	        voteStages.length++;
	        voteStageIndexMap[currentVoteStageBlock]=0;
	        uint voteStageIndex=voteStageIndexMap[currentVoteStageBlock];
	        
	        //设置第一位置
	        //Set the first position.
	        voteStages[voteStageIndex].blockNumber=currentVoteStageBlock;
    ...
    function changeStageBlock(
        ...
        require(currentVoteStageBlock< _voteStageBlock);
        
        uint _voteStageIndex=voteStageIndexMap[currentVoteStageBlock];
        currentVoteStageBlock=_voteStageBlock;
        voteStages.length++;
	    _voteStageIndex=_voteStageIndex+1;
	    voteStageIndexMap[currentVoteStageBlock]=_voteStageIndex;
	    
        voteStages[_voteStageIndex].blockNumber=currentVoteStageBlock;
   ...
   /**
	...
	function cancelVoteForCandidate(
        ...
        return cancelVoteForCandidateByStage(candidateAddr,num,currentVoteStageBlock);
    }
    ...
    function fechVoteMainInfo(
        ...
        return fechVoteMainInfoByStage(currentVoteStageBlock);
    }
    ...
    function fechVoteInfoForVoter(
        ...
        return fechVoteInfoForVoterByStage(voterAddr,currentVoteStageBlock);
    }
    /**
    ...
    function fechCurrentStageIndex(
        ...
        return voteStageIndexMap[currentVoteStageBlock];
    }
    ...
    function fechAllForCandidate(
        ...
        return fechAllSumNumForCandidateByStage(currentVoteStageBlock);
    }
   ...
   /**
    ...
    function fechVoteNumForCandidate(
        ...
        return fechVoteNumForCandidateByStage(candidateAddr,currentVoteStageBlock);
    }
    ...
    function fechVoteResultForCandidate(
       address candidateAddr
        ...
        return fechVoteResultForCandidateByStage(candidateAddr,currentVoteStageBlock);
    }
}