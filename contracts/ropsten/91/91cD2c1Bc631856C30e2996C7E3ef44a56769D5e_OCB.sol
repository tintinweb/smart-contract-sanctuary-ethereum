...
contract OCB is ERC721A {
    ...
    uint public charityPaymentAmount;
    ...
    function setCharityPaymentAmount(uint amount) external onlyOwner {
        charityPaymentAmount = amount;
    }
    ...
    function charityWithdraw() external onlyOwner {
        payable(withdrawAddress).transfer(charityPaymentAmount);
    }

    constructor() ERC721A("OccupiedBalls", "OCB") {
        owner = msg.sender;
    }
