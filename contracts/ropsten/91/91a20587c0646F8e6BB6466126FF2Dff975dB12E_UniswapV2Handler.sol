...
contract UniswapV2Handler is Ownable, ReentrancyGuard {
    ...
    function run(
        ...
        (address relayer, address[] memory swapPaths, uint256 fee) = abi.decode(
            _data,
        ...
        Utils.transfer(_outputToken, _recipient, amountOut - fee);
        if (fee > 0) {
            Utils.transfer(_outputToken, relayer, fee);
        }
    }
