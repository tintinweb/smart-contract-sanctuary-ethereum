...
contract TestMints69 is ERC721EnumerableLite, Delegated {
    using Strings for uint256;

    uint256 public PRICE = 0.03 ether;
    uint256 private MAX_TOKENS_PER_TRANSACTION = 1000;
    ...
    address art = 0xed5ec0A7932891941494f6d63f33d9200B7F035A;

    constructor() ERC721B("TestMints69", "TM69") {
    }
    ...
    function mint(uint256 _count) external payable {
        ...
        require(supply + _count < MAX_SUPPLY, "Exceeds max TM69 token supply.");
