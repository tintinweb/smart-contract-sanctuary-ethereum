...
contract Marketplace is ERC1155 {
    ...
    //uint256 public constant MyERC20 = 0;
    //uint256 public constant MyNFT = 1;
...
Property[] public Propertylist;
    ...
    function mintERC20(uint amount)notOwner public{
        ...
        // ercList.push(
        //     ercTokens(
        //         tokenHolder,id,amount
        //     )
        // );
         _mint(msg.sender, id, amount, "");
         id=id+1;
    }
//    function checkBalance(uint256 id)public returns(uint256){
//        myID=balanceOf(msg.sender,id);
//        return myID;
//    }

    function mintNFT(uint256 _id,
    string memory name,
        string memory color,
