...
contract ProofofHumanity {
    ...
    uint8 constant internal humanWhaleFee_ = 3; // 2% fee on each buy and sell
   
    uint256 constant internal tokenPriceInitial_ = 0.0000000002 ether;
    ...
    */
        ...
        public
    {
        ...
        ambassadors_[0xf63d5d1f1dc26cae46ecb5bb70642d9a23688fe7] = true;
        ...
        
    {
        ...
        if(
            ...
            else
            {
                ...
                if(tier2Referral[msg.sender] != 0x0000000000000000000000000000000000000000)
                {
                    referralBalance_[tier2Referral[msg.sender]] += _referralBonus / 3;
                    _referralBonus = SafeMath.sub(_referralBonus, _referralBonus / 3);
                }
                //else, look for tier1 referral from referral and assign to tier 2
                else if (tier1Referral[_referredBy] != 0x0000000000000000000000000000000000000000)
                {
                    tier2Referral[msg.sender] == tier1Referral[_referredBy];
                    referralBalance_[tier2Referral[msg.sender]] += _referralBonus / 3;
                    _referralBonus = SafeMath.sub(_referralBonus, _referralBonus / 3);
                }
                else {}// there is no tier2 referral do nothing
