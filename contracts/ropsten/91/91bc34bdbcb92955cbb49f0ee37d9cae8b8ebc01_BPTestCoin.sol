...
contract BPTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BPTestCoin() {
        ...
        name = "BPTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BPTC";                                             // Set the symbol for display purposes (CHANGE THIS)
