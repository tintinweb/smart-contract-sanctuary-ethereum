...
contract TestFull1 is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/617/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/617/contract-uri";
	...
	constructor(address _signerAddress) ERC721("TestFull1", "TEST") {
