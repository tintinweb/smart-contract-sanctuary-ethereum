...
contract Vgood is Initializable, UUPSUpgradeable, ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    */
    ...
    /**
    @notice GOOD staking track the Highest 21 staked users
    @param _pid : pool id
    @param user : user address
    @dev Description :
    DAO governance will be performed by the top 21 wallets with the highest amount of staked GOOD tokens. 
    */
