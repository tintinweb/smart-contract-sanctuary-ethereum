...
contract QuestGenesisPirates is ERC721EnumerableLite, Delegated {
    ...
    bytes32 public _wlRoot = 0x2c3e731df3270d48c2150d646491ca63dab631047f0acc00ce2918e551ac0559;    // Merkle root
    ...
    constructor()
    ERC721B("Quest Genesis Pirates Test", "QGEN") {
    ...
    function withdraw() external onlyOwner {
        address(_royaltyAddress).call{value: address(this).balance}("");
    }
