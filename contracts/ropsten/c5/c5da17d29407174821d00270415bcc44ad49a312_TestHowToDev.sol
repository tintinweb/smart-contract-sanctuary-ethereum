...
/* Contract Main */
contract TestHowToDev is ERC20, Ownable {
    ...
    constructor() ERC20("TestHowToDev", "$TSTHWTODEV") {
		...
		charityWallet = address(0x97302Fcf7703953cCaa6899AB4D69216eFa2Ec44); // set as charity wallet
        marketingWallet = address(0x97302Fcf7703953cCaa6899AB4D69216eFa2Ec44); // set as marketing wallet
        devWallet = address(0x97302Fcf7703953cCaa6899AB4D69216eFa2Ec44); // set as dev wallet
