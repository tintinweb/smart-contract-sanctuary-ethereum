...
contract dingdong3 is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("dingdong3", "DD") {
        setBaseURI("");
    }
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 dingdong3");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more dingdong3" );
        require(s + _mintAmount <= maxSupply, "Cant exceed dingdong3 supply");
        ...
        onlyOwner
    {
        ...
        require(s + totalQuantity <= maxSupply, "Too many dingdong3");
