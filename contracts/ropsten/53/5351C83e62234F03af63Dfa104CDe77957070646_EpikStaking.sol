...
contract EpikStaking is ReentrancyGuard, Pausable {
    ...
    function setCooldown(uint256 _cooldown) onlyManager() external {
        cooldown = _cooldown;
    }

    function setWithdrawFee(uint256 _fee) onlyManager() external {
        withdrawFee = _fee;
    }

    function setWithdrawVault(address _vault) onlyManager() external {
