...
contract LiquidityPool is Initializable, OwnableUpgradeable {
    ...
    /**
        Returns value of a selected token and the base currency. If the selected token is equal to base it returns 1e18(1 Ether).
        @param token Selected token to pair with base. It must be different than 0x0.
     */

    function getPriceWithBase(address token) public view returns (uint256 price) {
