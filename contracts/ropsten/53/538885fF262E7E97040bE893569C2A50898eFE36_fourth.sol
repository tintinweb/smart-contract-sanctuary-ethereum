...
contract fourth {
    ...
    function _4readText()external view returns(string memory){
        return s.text;
    }

    function _4readNum()external view returns(uint256){
        return s.num;
    }

    function _4setText(string memory _text)external{
        s.text = _text;
    
    }
    function _4setAnothertext(string memory _anothertext)external{
