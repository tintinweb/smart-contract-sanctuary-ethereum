    ...
    BaseContractControllerUpgradeable
{
    ...
    string public constant implementationVersion = "1.7";
    ...
    function setWeth(address _weth) external onlyOwnerOrDeveloper nonReentrant {
        weth = _weth;
    }
    ...
    OwnableUpgradeable
{
    ...
    function QueenStaff() public view returns (IQueenStaff) {
        return queenStaff;
    }
    ...
    modifier onlyDeveloper() {
        require(msg.sender == queenStaff.developer(), "Not Dev");
        _;
    }
