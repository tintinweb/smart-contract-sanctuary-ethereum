...
/**
    ...
    */
    ...
    function CreateNFT(address owner, string memory tokenURI)
        ...
        returns (uint256)
    {
        console.log(_tokenIds.current(),balanceOf(owner));
       require(balanceOf(owner) <=MaxToken, "Max Limit Execeeded"); 
 _tokenIds.increment();
        ...
        _mint(owner, newid);
 		_setTokenURI(newid, tokenURI);
		   nftCollection.push(newNFT);
		     remainingMintableNFTs = MaxToken-_tokenIds.current();
		    emit NewFilecoinNFTMinted(owner, newid, tokenURI);
    ...
    function CreatePrivateNFT(address owner, string memory tokenURI)
        public
        returns (uint256)
    {
