...
// ShibaUniFetch helps your migrate your existing Uniswap LP tokens to ShibaSwap LP ones
contract KishiUniFetch {
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'UniFetch: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'UniFetch: INSUFFICIENT_B_AMOUNT');
    }
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                factory,
                keccak256(abi.encodePacked(token0, token1)),
                hex'7fa16ca81708365e3e33e28dc3b87cc3461e389c5aaad9d543d49cc147965bdc' // init code hash
            ))));
    }
