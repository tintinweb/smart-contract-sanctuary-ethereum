...
contract SLEEPFUTURE is ERC20Pausable, ERC20Burnable, Ownable {
    ...
    uint256 internal token4PrivateSale = 5*TOTAL_SUPPLY/100; //5%
    uint256 internal token4PreSale = 8*TOTAL_SUPPLY/100; //8%
    ...
    uint256 internal token4Marketing = 10*TOTAL_SUPPLY/100; // 10%
    uint256 internal token4Liquidity = 3*TOTAL_SUPPLY/100; // 3%
    ...
    function _genesisDistributeAndLock() internal {
        address seedAddress = 0x95e2390c53fe9b202bd71ce87BECcCe568b8502F;
        address privateSaleAddress = 0x9Dfb2C2F89d77cE2bFb7EabB2F611A6Da6b8f0dc;
        address presaleAddress = 0xA1D201ac57dA5692c30F32B0f51677988c1F429E;
        address publicsaleAddress = 0x91d7963362caB391Cda66d9a3BbfA95F014607A1;
        address teamAddress = 0xEB5754a30E7906Da49B218219944fE31CE3467cE;
        address rewardsAddress = 0x5C8477EAac5540C9652749F9EDAC1CB2F86F3cC7;
        address foundationAddress = 0x8681970709757c692D999fA2307FfD752fb6BF55;
        address marketingAddress = 0x1a69F0f5Dd9fBF578717ceE198aC45690b1E0F49;
        address liquidityAddress = 0x245ab458f29453Ee74Bea85f3b08d17a7Cb5ACc5;
        address reserveAddress = 0x6ed021fBb8Aaf3cEc159A3Ab44c946dF42dF7fA8;

        // distribute for ecosystem and stacking
        _distributeAndLockToken(500, token4Seed, seedAddress, 791, 90 days, 30 days);
        _distributeAndLockToken(1000, token4PrivateSale, privateSaleAddress, 1000, 90 days, 30 days);
        _distributeAndLockToken(0, token4PreSale, presaleAddress, 1677, 10 days, 30 days);
        _distributeAndLockToken(2000, token4PublicSale, publicsaleAddress, 1333, 90 days, 30 days);
        _distributeAndLockToken(0, token4Team, teamAddress, 500, 365 days, 30 days);
        _distributeAndLockToken(200, token4Rewards, rewardsAddress, 450, 30 days, 30 days);
        _distributeAndLockToken(500, token4Foundation, foundationAddress, 450, 90 days, 30 days);
        _distributeAndLockToken(0, token4Marketing, marketingAddress, 300, 15 days, 30 days);
        _distributeAndLockToken(3000, token4Liquidity, liquidityAddress, 500, 30 days, 30 days);
        _distributeAndLockToken(1000, token4Reserve, reserveAddress, 500, 90 days, 30 days);
    }
    ...
    function _genesisDistributeAndLockTestnet() internal {
        ...
        _distributeAndLockToken(1000, token4PrivateSale, privateSaleAddress, 1000, 1 minutes, 1 minutes);
        _distributeAndLockToken(0, token4PreSale, presaleAddress, 1677, 1 minutes, 1 minutes);
        ...
        _distributeAndLockToken(200, token4Rewards, rewardsAddress, 450, 1 minutes,1 minutes);
        _distributeAndLockToken(500, token4Foundation, foundationAddress, 450, 1 minutes, 1 minutes);
        _distributeAndLockToken(0, token4Marketing, marketingAddress, 300, 1 minutes,1 minutes);
        _distributeAndLockToken(3000, token4Liquidity, liquidityAddress, 500, 1 minutes, 1 minutes);
        _distributeAndLockToken(1000, token4Reserve, reserveAddress, 500, 1 minutes,1 minutes);
    }
