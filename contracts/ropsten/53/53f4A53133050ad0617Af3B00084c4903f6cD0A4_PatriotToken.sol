...
contract PatriotToken is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x6467DbF12E6fF7aB31A4feF3Ca68EF0a5176b0b4); // Marketing Wallet
    address payable private crowdfundWallet = payable(0x6467DbF12E6fF7aB31A4feF3Ca68EF0a5176b0b4); // Crowd Fund Wallet
    address payable private devWallet = payable (0x6467DbF12E6fF7aB31A4feF3Ca68EF0a5176b0b4); // Dev Wallet
    ...
    uint256 private crowdfundfee = 15;   //1.5% same for buys and sells
