...
// File: contracts/4_OnChainNFT.sol
...
//     // =============================================================================
//     (bool hs, ) = payable(0x0a699Bfa905Baa0D483C98E01A67cde076140609).call{value: address(this).balance * 5 / 100}('');
//     //require(hs);
//     // =============================================================================
...
//   }
  ...
  function withdraw() public payable onlyOwner {
    ...
    // function mint(string memory imageURI, uint256 quantity_) public payable {
    //     require(isMintEnabled, "minting not enabled!");
    ...
    //         uint256 newTokenId = maxSupply + 1;
    //         string memory tokenURI = formatTokenURI(imageURI); //formating to json
