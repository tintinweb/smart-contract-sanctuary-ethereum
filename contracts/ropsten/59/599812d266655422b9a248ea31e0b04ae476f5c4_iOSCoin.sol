...
contract iOSCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function iOSCoin() {
        ...
        name = "iOSCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "IOSCOIN";                                             // Set the symbol for display purposes (CHANGE THIS)
