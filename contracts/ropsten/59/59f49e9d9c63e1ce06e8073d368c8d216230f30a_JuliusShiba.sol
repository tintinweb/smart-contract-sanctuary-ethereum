...
contract JuliusShiba is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x9028C893Dd287E6fA64394B2146933610bcd0F2e);
    address payable private _marketingAddress = payable(0x9028C893Dd287E6fA64394B2146933610bcd0F2e);
    ...
    uint256 public _maxWalletSize = 2000000000000 * 10**9; //1
