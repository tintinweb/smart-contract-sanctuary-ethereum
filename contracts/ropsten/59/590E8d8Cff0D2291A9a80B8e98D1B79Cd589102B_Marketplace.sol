...
contract Marketplace{
    ...
    */
    ...
    function ERC20_Provider(int _benefit) public returns(bool){
    ...
    */
    ...
    function buyERC721Token(int _itemId) external {
    ...
    */
    function getBalanceOfERC20(address _address) public view returns(uint256){
