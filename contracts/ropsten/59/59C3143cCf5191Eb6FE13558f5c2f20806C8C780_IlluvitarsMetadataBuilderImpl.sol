...
contract IlluvitarsMetadataBuilderImpl is IlluvitarsMetadataBuilder, UUPSUpgradeable, OwnableUpgradeable {
     ...
     */
    function initialize(address _portraitDictionary, address _accessoryDictionary)
        external
        initializer
    {
        require(_portraitDictionary != address(0), "Invalid Portrait Dictionary");
        // TODO: Need to implement the AccessoryDictionary contract
        ...
        returns (string[7] memory)
    {
        ...
        illuvitarGeneralAttributeArray[0] = _formatAttribute("Batch", string(_itoa8(_metadata.batch)));
        illuvitarGeneralAttributeArray[1] = _formatAttribute("Tier", string(_itoa8(_metadata.tier)));
        illuvitarGeneralAttributeArray[2] = _formatAttribute("Set", string(_itoa8(_metadata.set)));
