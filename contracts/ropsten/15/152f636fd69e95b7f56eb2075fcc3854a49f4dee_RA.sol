...
contract RA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8096C9C81f5ED850c105b248C9699EC336099BDE); 
    address payable public Wallet_Dev = payable(0x8096C9C81f5ED850c105b248C9699EC336099BDE);
    ...
    string private constant _name = "The Fierce"; 
    string private constant _symbol = unicode"RA"; 
    ...
    uint256 public Percent_Marketing = 55; // 2.75% Buy - 3.85% Sell Marketing
    uint256 public Percent_Dev = 15; // .75% Buy - 1.05% Sell Dev
    uint256 public Percent_Burn = 15; // .75% Buy - 1.05% Sell Burn
    uint256 public Percent_AutoLP = 15; // .75% Buy - 1.05% Sell LP
    ...
    constructor () {
        ...
        _owner = 0x8096C9C81f5ED850c105b248C9699EC336099BDE;
