...
contract SimpleProject is ERC1155Burnable, Ownable, IERC2981 {
    ...
    string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/66/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/66/contract-uri";

    uint256 public royaltyBps = 555;
