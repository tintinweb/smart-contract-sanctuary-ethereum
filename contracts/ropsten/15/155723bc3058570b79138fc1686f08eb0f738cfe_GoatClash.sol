...
contract GoatClash  {
    ...
    uint constant MAX_AMOUNT = 100000 * (10 ** 18);
    ...
    // function settleBetTest(uint reveal, bytes32 blockHash) external onlyCroupier returns (uint placeBlockNumber, uint commit, address gambler) {
