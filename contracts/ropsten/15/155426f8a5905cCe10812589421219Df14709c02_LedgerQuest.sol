...
contract LedgerQuest is Ownable, ERC721L, EIP712 {
    ...
    function mint(
        ...
        if (restictedModeEnabled && !allowlist[receiver])
            revert Errors.ReceiverNotAllowed();
        ...
        bytes32 digest = _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256("mint(address receiver,uint256 collectionId)"),
                    receiver,
                    collectionId
                )
            )
    ...
    function setCollectionIsPaused(bool paused, uint256 collectionId)
        public
        onlyOwner
    {
