...
contract AwesomePictureAuctions {
    ...
    function retrieveAuctionsIndex() public view returns (uint){
        return _auctionIndex;
    }

    function retrieveAuctionData(uint auctionIndex) public view returns (string memory, uint, uint, uint, uint, address){

        return ( auctions[auctionIndex]._description,
                auctions[auctionIndex]._startTime,
        auctions[auctionIndex]._endTime,
        auctions[auctionIndex]._startingPrice,
        auctions[auctionIndex]._maxBid,
        auctions[auctionIndex]._maxBidder);
    }
