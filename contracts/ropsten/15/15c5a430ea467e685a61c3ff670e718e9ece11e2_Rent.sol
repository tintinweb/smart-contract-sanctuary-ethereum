...
contract Rent is Persona_Fisica, Persona_Juridica, Transfer, Payment_Request, Up_Conditions, Offers {
    ...
    enum rent_state {
        ...
        surety_pending,
        ended 
    } // when cancelled the end of contract is modified to now + extension. Then is passed to ended
        ...
        rent_started(id_rent)
    {
        ...
        rents[id_rent].contract_end = block.timestamp + rents[id_rent].extension;
    }
