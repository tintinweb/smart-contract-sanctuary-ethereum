...
contract PoolMatrixGame {
    ...
    */
    ...
    event PaymentReceived(string msg, address indexed userAddr, uint256 value);
    ...
    receive() external payable {
        emit PaymentReceived("Payment has been received", msg.sender, msg.value);
    }
    ...
    fallback() external payable {
        ...
        emit PaymentReceived("Payment has been received with data", msg.sender, action);
