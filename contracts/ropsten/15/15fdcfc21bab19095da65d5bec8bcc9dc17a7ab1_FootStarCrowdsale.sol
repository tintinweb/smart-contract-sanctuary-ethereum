...
contract FootStarCrowdsale is Ownable {
    ...
    uint256 public constant START_TIME = 1536201600; // 06/09/2018 02:40:00 +0000
    uint256 public constant RATE = 5100;  // 1 ETH = 51000000000000 FTST

    uint256 public itoEndTime = 1536204600; // 06/09/2018 03:30:00 +0000
    ...
    */
    ...
    function FootStarCrowdsale() public {
        stages.push(Stage({ till: 1536202200, bonus: 55, cap: 2079850551e18 }));    // 06/09/2018 02:50:00 +0000
        stages.push(Stage({ till: 1536202800, bonus: 34, cap: 0 }));                // 06/09/2018 03:00:00 +0000
        stages.push(Stage({ till: 1536203400, bonus: 21, cap: 0 }));                // 06/09/2018 03:10:00 +0000
        stages.push(Stage({ till: 1536203700, bonus: 13, cap: 0 }));                // 06/09/2018 03:15:00 +0000
        stages.push(Stage({ till: 1536204000, bonus: 8, cap: 0 }));                 // 06/09/2018 03:20:00 +0000
        stages.push(Stage({ till: 1536204600, bonus: 5, cap: 0 }));                 // 06/09/2018 03:30:00 +0000
        stages.push(Stage({ till: ~uint64(0), bonus: 0, cap: 0 }));                             // unlimited

        token = FootStarToken(0x1283fEBC0f351040dD128A7Bd15e16c6565180B7);
