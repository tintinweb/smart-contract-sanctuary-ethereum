...
contract DDumpster is ERC20, Ownable {
    ...
    constructor() ERC20("DDumpster", "DDUMP") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        CommunityWallet = address (0x0CdB4a0CCEF84EE99D496e9a14688C4414ddB30a); // set as Community wallet
        devWallet = address(owner()); // set as dev wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xd4d3f63A65678747e2A845c78968b02beDa918b5), true);
        excludeFromFees(address(0xdead), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xd4d3f63A65678747e2A845c78968b02beDa918b5), true);
