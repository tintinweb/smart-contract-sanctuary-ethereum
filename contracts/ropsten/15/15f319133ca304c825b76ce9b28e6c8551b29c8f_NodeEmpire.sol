...
contract NodeEmpire is Context, IERC20, Ownable, Pausable {
    ...
    address payable public marketingWallet = payable(0x8643a9eC002a53816FF6132D87C4dDC2bF5D0005);

    uint256 public _treasuryFee = 5;
    uint256 private _previousTreasuryFee = _treasuryFee;
    address payable public treasuryWallet = payable(0x0eA93a79739F14320C87710D90069f76C2A30741);
