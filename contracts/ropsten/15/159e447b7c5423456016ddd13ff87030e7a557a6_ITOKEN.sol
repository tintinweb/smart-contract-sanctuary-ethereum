...
contract ITOKEN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xdD4e5De4F2a6b73F73C0b1116cFc2bd94b815208); // Marketing Address

    address payable public liquidityAddress =
        payable(0x902c2b077f8609f0F600aAe780facCb5889Bd9b4); // Liquidity Address
    ...
    constructor() {
        ...
        liquidityAddress = payable(address(0x902c2b077f8609f0F600aAe780facCb5889Bd9b4)); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
