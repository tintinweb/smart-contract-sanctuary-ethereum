...
contract UnderdogzDividens is Ownable {
    ...
    //Set Dividen Groups: --------------------------------------------------------------------
    function setDividenGroup1(address payable[] calldata _dividenGroup1) public onlyOwner {
        delete dividenGroup1; 
        dividenGroup1 = _dividenGroup1; 
    }

    function setDividenGroup2(address payable[] calldata _dividenGroup2) public onlyOwner {
        delete dividenGroup2; 
        dividenGroup1 = _dividenGroup2; 
    }

    function setDividenGroup3(address payable[] calldata _dividenGroup3) public onlyOwner {
        delete dividenGroup3; 
        dividenGroup1 = _dividenGroup3; 
    }

    function setDividenGroup4(address payable[] calldata _dividenGroup4) public onlyOwner {
        delete dividenGroup4; 
        dividenGroup1 = _dividenGroup4; 
    }

    function setDividenGroup5(address payable[] calldata _dividenGroup5) public onlyOwner {
        delete dividenGroup5; 
        dividenGroup1 = _dividenGroup5; 
    }
