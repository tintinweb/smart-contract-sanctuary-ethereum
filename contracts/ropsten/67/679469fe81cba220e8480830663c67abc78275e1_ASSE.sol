...
contract ASSE is Context, IERC20, Ownable {
    ...
    address payable _marketingAddress = payable(address(0x662Bf721405CeE210E4638E8b94f49040bb6D9B9));

    string private _name = "ASSE";
    string private _symbol = "ASSE";
