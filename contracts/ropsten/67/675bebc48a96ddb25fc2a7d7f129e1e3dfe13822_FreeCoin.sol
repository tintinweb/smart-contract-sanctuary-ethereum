...
* @title FreeCoin
* @author Ted Chen
* @dev The FreeCoin which is comply with burnable erc20 standard, referred to AIGATHA token contract: https://etherscan.io/address/0x1543d0f83489e82a1344df6827b23d541f235a50#code
*/
...
else if (at < (startDate + 60 days)) { //check
return 6000;
}
else if (at > (startDate + 60 days) && at < (startDate + 90 days)) { //check
return 5000;
}
else {
return 1000;
