...
*/
contract XTKN311728TheHorde is Context, Ownable{
    // lib
    ...
    function withdraw(address pToken, uint256 pAmount) public onlyOwner{
        ...
        if(pToken == address(0)){
            ...
            require(pAmount <= balance, "[xtkn311728][the horde] you can't withdraw more coins than you have!");
            address payable to = payable(_msgSender());
            (bool sent, ) = to.call{value:pAmount}("");
            require(sent, "[xtkn311728][the horde] transaction failed!");
            ...
            require(pAmount <= balance, "[xtkn311728][the horde] you can't withdraw more tokens than you have!");
    ...
    function transfer(address pToken, address pTo, uint256 pAmount) public onlyOwner{
        ...
        if(pToken == address(0)){
            balance = address(this).balance;
            require(pAmount <= balance, "[xtkn311728][the horde] you can't transfer more coins than you have!");
            ...
            balance = _token[pToken].balanceOf(address(this));
            require(pAmount <= balance, "[xtkn311728][the horde] you can't transfer more tokens than you have!");
