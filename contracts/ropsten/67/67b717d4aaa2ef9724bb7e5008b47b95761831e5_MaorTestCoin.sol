...
contract MaorTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MaorTestCoin() {
        ...
        name = "MaorTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MSTCN";                                             // Set the symbol for display purposes (CHANGE THIS)
