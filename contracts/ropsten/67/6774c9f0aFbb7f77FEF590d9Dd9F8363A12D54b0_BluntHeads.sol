...
contract BluntHeads is ERC1155, Ownable, Pausable, ReentrancyGuard
{
    ...
    //Merkle Root
    bytes32 private root = 0x6d92e0c781a6503a31c3cb90dac3e60ea733414d810304cc2778c357fa2c7869;
    ...
    function BluntHeadsMint(uint256 numberOfTokens) public payable nonReentrant whenNotPaused
    {
        ...
        require(numberOfTokens <= _MAX_BLUNTS_PURCHASE && numberOfTokens > 0, "Can Only Mint 20 Blunts At A Time");
