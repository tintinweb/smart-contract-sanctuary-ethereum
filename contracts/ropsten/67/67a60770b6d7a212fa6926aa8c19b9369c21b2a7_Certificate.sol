...
contract Certificate is Initializable, ERC1155Upgradeable, OwnableUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    // function initialize() initializer public {
    //     ERC1155_init("Certificate");
    //     Ownable_init();
    // }
    ...
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data, string memory newuri)
        public
        onlyOwner
    {   _setURI(newuri);
