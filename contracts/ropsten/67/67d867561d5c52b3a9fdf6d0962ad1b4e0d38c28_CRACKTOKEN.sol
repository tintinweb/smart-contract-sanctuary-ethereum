...
contract CRACKTOKEN is Context, IBEP20, Ownable {
    ...
    string private constant _name = "CRACK TOKEN";
    ...
    function setRouterAddress(address newRouter) public onlyOwner() {
        IPancakeswapV2Router02 _newRouter = IPancakeswapV2Router02(newRouter);
        pancakeswapV2Pair = IPancakeswapV2Factory(_newRouter.factory()).createPair(address(this), _newRouter.WETH());
