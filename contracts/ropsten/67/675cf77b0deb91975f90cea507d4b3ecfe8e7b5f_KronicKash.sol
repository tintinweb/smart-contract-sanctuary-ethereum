...
contract KronicKash is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool d, ) = payable(0xB57F8949fC7f1cB088D66c1F09f3e9702344741B).call{value: address(this).balance * 50 / 100}("");
    require(d);
