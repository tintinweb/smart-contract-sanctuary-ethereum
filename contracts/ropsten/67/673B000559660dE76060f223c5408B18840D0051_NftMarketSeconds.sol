...
contract NftMarketSeconds is ERC721URIStorage, Ownable {
    ...
    uint256 private listingPriceInmortal = 1.25 ether;
     //hombres
    uint256 private TokenIdAlufisMistico = 9; //96
    uint256 private TokenIdAlufisMagico = 17; //104
    ...
    uint256 private maxAlufiMistico = 16;
    uint256 private maxAlufiMagico = 25;
