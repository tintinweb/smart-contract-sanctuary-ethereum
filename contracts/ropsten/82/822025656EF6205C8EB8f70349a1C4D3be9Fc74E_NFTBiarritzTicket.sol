...
contract NFTBiarritzTicket is ERC721, Ownable {
    ...
    event LogCoupon(address buyer, uint256 discount);
    ...
    function getDiscount(address buyer) public view returns (uint256) {
        ...
        for (uint256 i = 0; i < contractList.length; i++) {
            ...
            uint256 nb = NftContract.balanceOf(buyer);
            return nb;
            //emit LogCoupon(contractList[i], couponStructs[contractList[i]].discount);
        }
        return discount;
    }
