...
// using https://joserodrigues443.github.io/post/nft-with-access-control/#show-me-the-code-man for the access control changes
...
import "./MyRoleControl.sol";

// Logs are useful
import "hardhat/console.sol";

contract MyNFTacid is ERC721URIStorage, Ownable, MyRoleControl {
    //using Counters for Counters.Counter;
    //Counters.Counter private _tokenIds;

    constructor() ERC721("MyNFTac", "NAC") MyRoleControl(msg.sender){
...
contract MyRoleControl is AccessControl {
  ...
  constructor (address root) {
    ...
    // DEFAULT_ADMIN_ROLE > MINTER_ROLE > USER_ROLE > INTERN_ROLE > no role

    _setRoleAdmin(MINTER_ROLE, DEFAULT_ADMIN_ROLE);
    _setRoleAdmin(USER_ROLE, MINTER_ROLE);
