...
contract Sale1 is Whitelist {
    ...
    uint256 public maximumNonWhitelistAmount = 12500 * 20 ether; // in minimum units of rune

    // in minimum units of rune (12500 RUNE per Wei)
    ...
    // winAmount0 is 0; if changed, change code to check for < value below as well
    ...
    function () public payable {
        ...
        if(runeRemaining < purchaseAmount) {
            ...
            // uint price = purchaseAmount / runeToWeiRatio;
