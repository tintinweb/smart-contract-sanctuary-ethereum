...
contract LinearVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function fundAndOrActivate()
        ...
        onlyOwner
    {
        if((totalRewardsPendingBalance / 1e18) > vestedToken.balanceOf(address(this))) {
            uint256 amount =
                (totalRewardsPendingBalance / 1e18) - vestedToken.balanceOf(address(this));
        ...
        require(
            vestedToken.balanceOf(address(this)) >= (totalRewardsPendingBalance / 1e18),
