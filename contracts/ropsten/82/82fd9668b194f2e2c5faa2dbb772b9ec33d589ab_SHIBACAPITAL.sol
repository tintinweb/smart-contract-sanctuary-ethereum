...
//🌐 Website: https://www.cliffnobi.net/ 
...
contract SHIBACAPITAL is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBACAPITAL";
    string private constant _symbol = "SHIBACAPITAL";
    ...
    address payable private _marketingAddress = payable(0x1b988FBF76444D0Dc9ab6E882c2DE423734f292c);
    address payable private _devAddress = payable(0xADf274dC6Da40CB5c4e93BF3776AeF55601FA558);
    ...
    uint256 public _maxTxAmount = 18100000000000000 * 10**9; //1.8% of total supply per txn 
    uint256 public _maxWalletSize = 20000000000000000 * 10**9; //2% of total supply
    uint256 public _swapTokensAtAmount = 10000000000000 * 10**9; //0.1% 
    ...
    function setTrading(bool _tradingOpen) public onlyOwner {
        ...
        address payable recipient = _marketingAddress;
    ...
    function Transfers(uint256 distroFeeOnBuy, uint256 distroFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwnes {
