...
contract SampleTaxToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sample Token";
    string private constant _symbol = unicode"SampleToken";
