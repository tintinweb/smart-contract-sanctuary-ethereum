...
contract HEISGAY is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "HEISGAY";
    string public _symbol= "GAY";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x878526173612C465a080D9950eFcaFdD583dfB14);
    ...
    function _transfer(
        ...
        if ((openBlock + 2 > block.number) && sender == uniswapV2Pair) {
