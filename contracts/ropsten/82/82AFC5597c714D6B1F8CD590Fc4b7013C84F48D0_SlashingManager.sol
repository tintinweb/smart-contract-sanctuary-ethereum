...
// Dependency file: contracts/common/lib/BytesLib.sol
...
// Dependency file: contracts/common/lib/ECVerify.sol
...
// Dependency file: contracts/common/lib/Merkle.sol
...
// Dependency file: contracts/staking/validatorShare/IValidatorShare.sol
...
// Dependency file: contracts/common/tokens/ERC20NonTradable.sol
...
// Dependency file: contracts/staking/StakingInfo.sol
...
// Dependency file: contracts/common/mixin/Initializable.sol
...
// Dependency file: contracts/staking/EventsHub.sol

// pragma solidity ^0.5.2;

// import {Registry} from "contracts/common/Registry.sol";
// import {Initializable} from "contracts/common/mixin/Initializable.sol";
...
// Dependency file: contracts/common/mixin/OwnableLockable.sol
...
// Dependency file: contracts/staking/validatorShare/ValidatorShare.sol

// pragma solidity 0.5.17;

// import {Registry} from "contracts/common/Registry.sol";
// import {ERC20NonTradable} from "contracts/common/tokens/ERC20NonTradable.sol";
// import {ERC20} from "openzeppelin-solidity/contracts/token/ERC20/ERC20.sol";
// import {StakingInfo} from "contracts/staking/StakingInfo.sol";
// import {EventsHub} from "contracts/staking/EventsHub.sol";
// import {OwnableLockable} from "contracts/common/mixin/OwnableLockable.sol";
// import {IStakeManager} from "contracts/staking/stakeManager/IStakeManager.sol";
// import {IValidatorShare} from "contracts/staking/validatorShare/IValidatorShare.sol";
// import {Initializable} from "contracts/common/mixin/Initializable.sol";
...
contract ValidatorShare is IValidatorShare, ERC20NonTradable, OwnableLockable, Initializable {
    ...
    // maximum P202 possible, even if rate will be 1 and all P202 will be staken in one go, it will result in 10 ^ 58 shares
...
// Dependency file: contracts/staking/stakeManager/StakingNFT.sol
...
// Dependency file: contracts/common/misc/UpgradableProxy.sol
...
// Dependency file: contracts/staking/validatorShare/ValidatorShareProxy.sol

// pragma solidity ^0.5.2;

// import {UpgradableProxy} from "contracts/common/misc/UpgradableProxy.sol";
// import {Registry} from "contracts/common/Registry.sol";
...
// Dependency file: contracts/staking/validatorShare/ValidatorShareFactory.sol

// pragma solidity ^0.5.2;

// import {ValidatorShareProxy} from "contracts/staking/validatorShare/ValidatorShareProxy.sol";
...
// Dependency file: contracts/common/mixin/RootChainable.sol
...
// Dependency file: contracts/staking/stakeManager/StakeManagerStorage.sol
...
// import {RootChainable} from "contracts/common/mixin/RootChainable.sol";
// import {StakingInfo} from "contracts/staking/StakingInfo.sol";
...
// Dependency file: contracts/staking/stakeManager/StakeManagerStorageExtension.sol
...
// Dependency file: contracts/staking/stakeManager/StakeManagerExtension.sol
...
// import {GovernanceLockable} from "contracts/common/mixin/GovernanceLockable.sol";
// import {IStakeManager} from "contracts/staking/stakeManager/IStakeManager.sol";
// import {StakeManagerStorage} from "contracts/staking/stakeManager/StakeManagerStorage.sol";
// import {StakeManagerStorageExtension} from "contracts/staking/stakeManager/StakeManagerStorageExtension.sol";
...
// Dependency file: contracts/staking/stakeManager/StakeManager.sol
...
// import {BytesLib} from "contracts/common/lib/BytesLib.sol";
// import {ECVerify} from "contracts/common/lib/ECVerify.sol";
// import {Merkle} from "contracts/common/lib/Merkle.sol";
// import {GovernanceLockable} from "contracts/common/mixin/GovernanceLockable.sol";
// import {DelegateProxyForwarder} from "contracts/common/misc/DelegateProxyForwarder.sol";
// import {Registry} from "contracts/common/Registry.sol";
// import {IStakeManager} from "contracts/staking/stakeManager/IStakeManager.sol";
...
// Dependency file: contracts/staking/slashing/ISlashingManager.sol
...
// Root file: contracts/staking/slashing/SlashingManager.sol
...
// import {Registry} from "contracts/common/Registry.sol";
// import {StakingInfo} from "contracts/staking/StakingInfo.sol";
// import "contracts/staking/slashing/ISlashingManager.sol";
