...
// File: contracts/token/TESTCOIN.sol
...
contract TESTCOIN is ERC20 {
    ...
    function TESTCOIN(uint256 _initialSupply) public {
        balances[msg.sender] = _initialSupply.mul(1e8);
        totalSupply = _initialSupply.mul(1e8);
        admin = msg.sender;
    }
