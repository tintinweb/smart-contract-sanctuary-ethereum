...
contract Beruqtoken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Beruqtoken() {
        ...
        name = "Beruqtoken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BRQT";                                             // Set the symbol for display purposes (CHANGE THIS)
