...
contract ERC1155_Template is ERC1155, Ownable {
    string public name;
    string public symbol;
    uint32 public maxSupply;
    uint32 public maxPerWallet;
    uint32 public maxPerTx;
    ...
    function presaleMint(uint32 count) external payable {
        require(presaleIsActive(), "Presale is not active.");
        require(count > 0, "Count must be greater than 0.");
        require(count < maxPerTx, "Count must be less than max per transaction count.");
