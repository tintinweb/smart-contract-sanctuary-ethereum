...
contract ScriptTV is Ownable {
    ...
    function earningPayout(
        ...
        emit EarningPayout(msg.sender, _amount);
    }
    ...
    function referralPayout(
        ...
        spay.mint(msg.sender, _amount);
        emit ReferralPayout(msg.sender, _amount, _referral);
    }
    ...
    function rechargeGlasses(
        ...
        emit RechargeGlasses(msg.sender, _amount, _glassId);
    }
    ...
    function openLootBox(
        ...
        spay.burnFrom(msg.sender, _amount);
        emit OpenLootBox(msg.sender, _amount, _lootBox);
    }
}
