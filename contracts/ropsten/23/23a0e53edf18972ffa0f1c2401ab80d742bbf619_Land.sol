...
contract Land is ERC721Enumerable, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    alphaContract = contractAddy;
        betaContract = contractAddy;
        tokenContract = contractAddy;

        MAX_ALPHA_NFT_AMOUNT = myAmount;
        MAX_BETA_NFT_AMOUNT = myAmount;
        MAX_PUBLIC_SALE_AMOUNT = myAmount;
        MAX_FUTURE_LANDS = myAmount;

        betaNftIdCurrent = myAmount; //beta starts after alpha
        mintIndexPublicSaleAndContributors = myAmount * 2; //public sale starts after beta
        RESERVED_CONTRIBUTORS_AMOUNT = 20;

        MAX_LANDS = myAmount*4;
        MAX_LANDS_WITH_FUTURE = MAX_LANDS + myAmount;
