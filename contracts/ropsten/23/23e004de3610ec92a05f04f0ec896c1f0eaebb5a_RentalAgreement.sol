...
contract RentalAgreement {
  ...
  function RentalAgreement() public {
    ...
    landlord = msg.sender;
    tenant = 0x0098fa833f340676dfe8ff8e4aa3caab72b27b1b; //tenant address
    ...
    clauses.general.propertyLocation.selectedCountry='USA';
    ...
    clauses.terms.rent.rentAmount = 1000000000000000000;
