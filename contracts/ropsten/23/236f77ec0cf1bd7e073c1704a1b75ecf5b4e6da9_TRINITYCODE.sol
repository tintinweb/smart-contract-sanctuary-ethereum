...
contract TRINITYCODE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "TRINITY CODE";
    ...
    uint256 _totalSupply = 3000000000000* 10**9;
    ...
    address payable private _marketingAddress = payable(0x7491C4Ae24c3C298e27a4AeC2Fa742fc1B3a7914);
    ...
    uint256 public _maxTxAmount = 22500000000 * 10**9; //0.75
    uint256 public _maxWalletSize = 45000000000 * 10**9; //1.5
    uint256 public _swapTokensAtAmount = 3000000000 * 10**9; //0.1
