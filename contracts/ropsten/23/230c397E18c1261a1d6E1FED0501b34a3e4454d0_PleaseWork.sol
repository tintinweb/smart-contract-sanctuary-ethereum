...
contract PleaseWork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ready To Go";
    ...
    uint256 private  _maxWallet = _tTotal * 10 / 1000; // 1% maxWallet
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xA27D7D1011691Ce2EE39F3756b4E01277cB18077);
        _feeAddrWallet2 = payable(0xA27D7D1011691Ce2EE39F3756b4E01277cB18077);
