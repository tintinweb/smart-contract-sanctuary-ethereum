    ...
    ERC2981
{
    ...
    function setup() external {
        characters.push(Character("Driver", 3, 0, 2, 4, 0.03 ether, 0));
        characters.push(Character("Thief", 3, 0, 4, 7, 0.03 ether, 0));
        characters.push(Character("Inside Man", 3, 0, 7, 10, 0.06 ether, 0.03 ether));
        characters.push(Character("Hacker", 3, 0, 10, 13, 0.06 ether, 0.03 ether));
        characters.push(Character("Mastermind", 3, 0, 13, 16, 0.06 ether, 0.03 ether));
    ...
    function securityCode(address to) public pure returns (string memory) {
        uint i;
        string memory code;
    ...
    function ownedList(address _owner) public view returns (uint16[200] memory) {
        uint16 i;
        uint16 j;
        address nftOwner;
