...
contract TBDPass is ERC1155, Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Reduce team allocation in the current release period.
     *
     * @param to The new allocation cap. Must equal or be greater than the 
     *  number of tokens actually minted by the team in the current period.
     *  Must also be less than the allocation previously set for the period.
     *  If `to` is equal to the number of tokens actually minted in the release
     *  period, effectively releases the rest of the team's supply this period.
     *
