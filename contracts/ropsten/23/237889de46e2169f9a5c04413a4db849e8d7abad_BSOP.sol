...
contract BSOP is IERC721 {
    ...
    uint public constant TOKEN_LIMIT = 100000;
    ...
    string internal nftName = "BSOP";
    string internal nftSymbol = "BSOP";
    ...
    function tokenURI(uint256 _tokenId) external view validNFToken(_tokenId) returns (string memory) {
        return string(abi.encodePacked("https://bsop-nft.herokuapp.com/api/token/", toString(_tokenId)));
    }
