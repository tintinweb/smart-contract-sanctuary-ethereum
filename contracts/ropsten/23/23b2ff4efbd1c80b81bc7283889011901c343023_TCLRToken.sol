...
///////////////////////////////////////// ALLOCATION FUNCTIONS /////////////////////////////////////////
    ...
    function allocateTCLRinTeamTokens() safeTimelock ownerOnly returns(bool success) {
...
bool isOutputeam=isTransferAllowed();
    ...
    function allocateAdvisorTokens() advisorTimelock ownerOnly returns(bool success) {
...
bool isOutput=isTransferAllowed();
    ...
    function releaseAdvisorTokens() ownerOnly returns(bool success) {
     ...
     function releaseTCLRinTeamTokens() ownerOnly returns(bool success) {
        ...
        balanceOf[TEAM_1] = TEAM1;       // TEAM1 TCLR tokens
        balanceOf[TEAM_2] = TEAM2;       // TEAM2 TCLR tokens
        balanceOf[TEAM_3] = TEAM3;       // TEAM3 TCLR tokens
        balanceOf[TEAM_4] = TEAM4;       // TEAM4 TCLR tokens
        balanceOf[TEAM_5] = TEAM5;       // TEAM5 TCLR tokens
