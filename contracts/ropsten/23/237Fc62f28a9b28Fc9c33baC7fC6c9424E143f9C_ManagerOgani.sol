...
contract ManagerOgani is Ownable {
    ...
    function transferToSupplier(string memory _idProduct, address _supplier) external payable onlyManagers (msg.sender) {
    ...
    function refundsOrderUser(address payable _walletuser,uint _amount) external payable onlyOwner {
