...
contract SlotieJr is ERC721A, AccessControl, Ownable {
    ...
    string public preRevealBaseURIString = "https://nft-demo-kgtechnologies.s3.amazonaws.com/slotie-jr-demo/";

    /**
     * @dev MINT SETTINGS 
     */
    uint256 public immutable maxMintPerTransaction = 50;
    ...
    ) ERC721A("Slotie Junior", "SLOTIEJR", maxMintPerTransaction) Ownable() {
