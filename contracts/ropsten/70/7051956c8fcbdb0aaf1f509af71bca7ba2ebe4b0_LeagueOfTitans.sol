...
//===============================================================================================================
    ...
    function setExcludedFromMaxTx(address account, bool enabled) public onlyOwner {
        _isExcludedFromMaxTx[account] = enabled;
    }

    function setExcludedFromMaxWallet(address account, bool enabled) public onlyOwner {
        _isExcludedFromMaxWallet[account] = enabled;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            bool excludeMaxTx = false;
            if(_isExcludedFromMaxTx[from] || _isExcludedFromMaxTx[to]){
                excludeMaxTx = true;
            }

            bool excludeMaxWallet = false;
            if(_isExcludedFromMaxWallet[from] || _isExcludedFromMaxWallet[to]){
                excludeMaxWallet = true;
            }
