...
contract Basictoken is ERC20Basic {
  ...
  uint256 totalSupply_ = 3600000000000000000;
 ...
 */
contract terecotest1 is ERC20, Basictoken {

  // Name of the token
  string constant public name = "terecotest1";
  // Token abbreviation
  string constant public symbol = "TCT1";
  // Decimal places
