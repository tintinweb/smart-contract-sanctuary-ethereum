...
contract WBWTest is ERC721, ContextMixin, ERC721Enumerable, ReentrancyGuard, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    uint256 public vipTokensPerBundle = 16;
    ...
    // Price
    uint256 public mintPrice = 0.08 * 10 ** 18 wei;
    ...
    constructor() ERC721( "WBW Test", "WBWTest" ) {}
    ...
    function addToVipList( address[] calldata accounts ) external onlyOwner {
        require( vipListSize + accounts.length < maxVipListSize, "This number of accounts will exceed maxVipListSize" );
    ...
    function setVipTokensPerBundle( uint256 tokensPerBundle ) external onlyOwner {
        vipTokensPerBundle = tokensPerBundle;
    }

    function vipMintBundle( uint256 quantity ) nonReentrant external payable {
        ...
        uint256 numberOfTokens = quantity * vipTokensPerBundle;
        ...
        require( totalSupply() + totalReserved + numberOfTokens + 1 < SUPPLY_LIMIT, "Not enough tokens left for this quantity" );
    ...
    function mint( uint256 numberOfTokens ) nonReentrant external payable {
        ...
        require( totalMinted + numberOfTokens <= mintLimit, "Quantity puts this account over mint limit" );
