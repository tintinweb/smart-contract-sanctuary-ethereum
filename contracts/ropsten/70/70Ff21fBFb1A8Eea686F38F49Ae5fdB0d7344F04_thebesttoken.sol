...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x62f0B3896C48D33592A6840205353D1c79Bd985d), 3000);
        m_DidDeploy = true;
    }
...
contract thebesttoken is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "the best token";
    string private m_Symbol = "TBT";
