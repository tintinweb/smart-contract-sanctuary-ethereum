...
contract Kuraitama is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Kuraitama";
    string constant _symbol = "Ktama";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0x4A861D9FF4efC4609CD9b242da8D6bB3C02E715F);
	    teamFeeReceiver = address(0x2eE82E0A83282696b96fA8555E4A9823715A4F9C);
