...
contract NFTStaking is ReentrancyGuard {
    ...
    constructor(SocietyToken _token, SocietyERC721A _nft) {
        token = _token;
        nft = _nft;
    }
    ...
    function _unstakeMany(address owner, uint[] calldata tokenIds) internal nonReentrant {
        uint tokenId;
    ...
    function _claim(address owner, uint[] calldata tokenIds, bool _unstake) internal nonReentrant {
        uint tokenId;
        uint earned;
        uint totalEarned;
