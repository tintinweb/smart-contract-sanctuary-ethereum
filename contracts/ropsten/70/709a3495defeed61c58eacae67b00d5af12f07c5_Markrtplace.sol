...
pragma solidity ^0.8.4;
 ...
 contract Markrtplace is ERC721, ERC721URIStorage, Ownable, EIP712 {
   ...
   Counters.Counter public _itemIds;
    ...
    uint public  platformfee = 0.005 ether;
    ...
    function recover(LazyNFTVoucher calldata voucher) public view returns (address) {
        bytes32 digest = _hashTypedDataV4(keccak256(abi.encode(
            keccak256("LazyNFTVoucher(uint256 tokenId,uint256 price,string uri,address artist)"),
            voucher.tokenId,
            voucher.price,
    ...
    function BuyVoucher (LazyNFTVoucher calldata voucher)
        public
        ...
        returns(bool)
    {
     //   require(admin == recover(voucher), "Wrong signature.");
        ...
        _safeMint(voucher.artist, voucher.tokenId);
