...
contract NewHashnodeTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NewHashnodeTestCoin() {
        ...
        name = "NewHashnodeTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NHTCN";                                             // Set the symbol for display purposes (CHANGE THIS)
