...
contract StakingPool is IStakingPool {
     ...
     */
    function closeStakingPool(bytes32 poolId) external virtual override {
        require(_stakingPools[poolId].isInitialized, "SPool: uninitialized");
     ...
     */
    function openStakingPool(bytes32 poolId) external virtual override {
        require(_stakingPools[poolId].isInitialized, "SPool: uninitialized");
     ...
     */
    function resumeStakingPool(bytes32 poolId) external virtual override {
        require(_stakingPools[poolId].isInitialized, "SPool: uninitialized");
     ...
     */
    function suspendStakingPool(bytes32 poolId) external virtual override {
        require(_stakingPools[poolId].isInitialized, "SPool: uninitialized");
