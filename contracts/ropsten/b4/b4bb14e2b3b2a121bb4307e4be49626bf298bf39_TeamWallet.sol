...
/// @author Stefan George - <<a href=/cdn-cgi/l/email-protection class=__cf_email__ data-cfemail=dba8afbebdbab5f5bcbeb4a9bcbe9bb8b4b5a8beb5a8a2a8f5b5beaf>[email&#160;protected]</a>>
/// @author Hung Le - <<a href=/cdn-cgi/l/email-protection class=__cf_email__ data-cfemail=deb6abb0b9b2b39ea8a4b1aabff0bdb1b3f0a8b0>[email&#160;protected]</a>>
contract TeamWallet {
     ...
     * Public functions
     */
    /// @dev Contract constructor sets initial owners and required number of approvals.
    ...
    /// @dev Allows to change the number of required approvals. Transaction has to be sent by wallet.
    /// @param _required Number of required approvals.
    ...
    /// @dev Allows an owner to submit and approve a transaction, bypass signature.
    ...
    /// @dev Allows an owner to approve a transaction, bypass signature.
    ...
    /// @dev Allows anyone to execute a approved transaction, bypass signature.
    /// @param transactionId Transaction ID.
    ...
    /// @dev Returns array with owner addresses, which approved transaction.
    /// @param transactionId Transaction ID.
