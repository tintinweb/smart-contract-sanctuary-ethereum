...
// File contracts/staking/StakingStorageV1.sol
...
contract StakingStorageV1 {
    ...
    /// used to calculate the amount of CNV during each rebase that goes to COOP.
    /// see _calculateCOOPRate
    uint256 public coopRateControl;
...
// File contracts/staking/StakingV1.sol
...
contract StakingV1 is StakingStorageV1, Initializable, OwnableUpgradeable, PausableUpgradeable, ERC721Upgradeable {
    ...
    function _calculateCOOPRate(
        ...
        // TODO maybe rework this line
        uint256 coopRate = (coopRatePriceControl * 1e18 / _bondPrice * coopRateControl) / 1e18;
        if (coopRateMax > coopRate) return coopRateMax;
        return coopRate;
    }
    ...
    function setCOOPParameters(
        ...
        uint256 _coopRateControl,
        uint256 _coopRateMax
    ) external virtual onlyOwner {
        coopRatePriceControl = _coopRatePriceControl;
        coopRateControl = _coopRateControl;
        coopRateMax = _coopRateMax;

        emit CoopRateManaged(_coopRatePriceControl,_coopRateControl,_coopRateMax);
    }
