...
contract MangosToken is IERC20, Ownable{
    ...
    string constant public name = "MANGO TOKEN"; //fancy name: eg MANGO COIN
    ...
    constructor()  {
        balances[_msgSender()] = 250000000000e18;  // Give the creator all initial tokens
        totalSupply_ = 250000000000e18;
