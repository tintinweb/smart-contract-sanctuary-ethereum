    ...
    ReentrancyGuardUpgradeable
{
    ...
    function getEstimatedDAXOOut(uint256 _ethAmount) public override view returns (uint256) {
        ...
        tokenList[0] = WETH;
        console.log("address(_token[0]) : ", address(_token[0]));
        tokenList[1] = address(_token[0]);
        console.log("0");
        //uint256[] memory tokenAmount = IUniswapV2Router02(uniswapRouterV2).getAmountsOut(_ethAmount, tokenList);
        ...
        console.log("_DALTokenAmount : ", _DALTokenAmount);
        return _DALTokenAmount;
    }
    ...
    function _checkBuyableLimit(address _user, uint256 _tokenAmount)
        ...
        returns (bool)
    {
        console.log("_totalTokenAmountThisPeriod %s", _totalTokenAmountThisPeriod);
        console.log("_globalSellableLimitPerPeriod %s", _globalSellableLimitPerPeriod);
