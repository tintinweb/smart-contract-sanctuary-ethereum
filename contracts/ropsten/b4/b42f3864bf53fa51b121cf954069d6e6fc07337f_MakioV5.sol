...
contract MakioV5 is ERC223Token , Ownable
{
    ...
    constructor() public{
        address founder = 0x3f6b64ee86a33750a017ca4acbc9cd3446ea1453;
        address developer = 0x5F6BF1b5c456677A7FD5D56cA8969b70BDBbD6C7;
    
        owner = founder;
        uint256  dec = decimals;
        totalSupply_ = 400 * 1e8 * (10**dec);
        balanceOf[founder] = totalSupply_.mul(95).div(100);
        balanceOf[developer] = totalSupply_.mul(5).div(100);
    }
