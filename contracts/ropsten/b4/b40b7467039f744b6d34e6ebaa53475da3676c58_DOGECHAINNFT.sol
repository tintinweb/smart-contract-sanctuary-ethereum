...
contract DOGECHAINNFT is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://thedogepoundapi.com/puppy/token/";
    address private openSeaProxyRegistryAddress = 0x8b7f9511eEcF2fa6Ea385E71625933a07eA09E06;
    ...
    // default false
    bool public allowListStatus = true;
    uint256 public amountForAllowList = 2222;
    uint256 public immutable maxPerAddressDuringMint = 500;

    mapping(address => uint256) public allowList;

    uint256 public constant MAX_MINTS_PER_TX = 5000;
    uint256 public maxMintAmountfreePerTx = 5000;
    uint256 public maxMintAmountfreePerWallet = 5000;
    uint256 public maxSupply = 5555;

    uint256 public PUBLIC_SALE_PRICE = 30 ether;
    // uint256 public PUBLIC_SALE_PRICE2 = 25 ether;
    // uint256 public PUBLIC_SALE_PRICE23 = 30 ether;
...
//   }
    ...
    constructor(
    ) ERC721A("DogeChain Puppy NFT", "Puppy NFT", 100, maxSupply) {
    }
