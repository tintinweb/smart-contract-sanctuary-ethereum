...
contract MINOTUINU is Context, IERC20 {
    ...
    string private _name = "MINOTU INU";
    ...
    address payable private _marketingWallet = payable(0x188643D138a67eabFfBa9ACC9C3C3023C1009A8a);
    address payable private _ecosystemWallet = payable(0x188643D138a67eabFfBa9ACC9C3C3023C1009A8a);
    ...
    constructor () payable {
        ...
        _isWhitelisted[0x648363a6E0E61b85971AE28745C5b534d97735d5] = true;

        _isExcludedFromFee[0x3E5Cf4d25061F0591d6393b3F6f2c7c52fbdd1dB] = true;
