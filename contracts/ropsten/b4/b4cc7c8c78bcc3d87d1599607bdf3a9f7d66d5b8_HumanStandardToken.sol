...
contract HumanStandardToken is StandardToken {
    ...
    function approveAndCall(address _spender, uint256 _value, bytes memory _extraData) public returns (bool success) {
        ...
        (bool result, ) = _spender.call(abi.encode(bytes4(bytes32(keccak256("receiveApproval(address,uint256,address,bytes memory)"))), msg.sender, _value, address(this), _extraData));
        require(result);
        return true;
    }
}