...
* Twitter          - https://twitter.com/355eth_club
* Telegram_channel - https://t.me/Ethereum355
* EN  Telegram_chat: https://t.me/Ethereum355_chat_en
* RU  Telegram_chat: https://t.me/Ethereum355_chat_ru
...
contract ERC20AdToken {
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        //You can call this method for advertise this contract and invite new investors
...
contract EarnEveryDay_v3_355 is ERC20AdToken, DT {
...
//   constructor() ERC20AdToken("Earn 3.55% Every Day for Life-long. https://355eth.io", 
//                             "Send your ETH to this contract and erach 3.55% every day for Live-long. https://355eth.io") public {
    ...
    if (!m_referrals[msg.sender].notZero()) {
      ...
      if (notZeroNotSender(ref) && m_investors.contains(ref)) {
        ...
        if(notZeroNotSender(bestPromouter.addr)){
          assert(m_investors.addRefBonus(bestInvestor.addr, m_refPercent2.mul(value) )); // referrer 2 bonus
          m_referrals[msg.sender] = bestPromouter.addr;
        }
      }
      
      if(notZeroNotSender(adtransfers[msg.sender])){
