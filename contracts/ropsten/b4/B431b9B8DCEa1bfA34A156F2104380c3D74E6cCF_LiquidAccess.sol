  ...
  Ownable
{
  ...
  mapping(uint256 => uint256) private dateExpirations;
  ...
  // safeMint =============================
  function safeMint(address to, string memory uri, uint256 date_expiration, string memory type_subscription ) public onlyOwner {
