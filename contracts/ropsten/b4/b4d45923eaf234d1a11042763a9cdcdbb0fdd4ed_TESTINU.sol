...
contract TESTINU is Context, IERC20 {
    ...
    uint256 private startingSupply = 1_000;

    string private _name = "TESTTURBO";
    string private _symbol = "TRBB";

    uint256 public _reflectFee = 0;
    uint256 public _marketingFee = 5;

    uint256 private maxReflectFee = 0;
    uint256 private maxMarketingFee = 5;
    ...
    // UNI ROUTER
    address private _routerAddress = 0x1F98431c8aD98523631AE4a59f267346ea31F984;
