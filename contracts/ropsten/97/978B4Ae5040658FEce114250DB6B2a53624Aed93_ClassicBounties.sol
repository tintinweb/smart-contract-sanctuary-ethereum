...
contract ClassicBounties {
  ...
  modifier hasNotRefunded(
    ...
    uint _contributionId)
  {
    console.log("Refund Status %s: ", bounties[_bountyId].contributions[_contributionId].refunded);
  ...
  */
    ...
    returns (uint)
  {
    ...
    // XXX remove the waiting period for testing
    newBounty.deadline = block.timestamp;  
    ...
    emit BountyIssued(bountyId, _sender, _questionId, block.timestamp + 60 * 10);
    return bountyId;
  }
  ...
  */
    ...
    callNotStarted
  {
    ...
    console.log("ContributionId: %d" , contributionId); 
  ...
  */
    ...
    callNotStarted
  {
    ...
    // Should check if the balance on the bounty is 0 and if so,
    // should decrease the number of bounties and clean up the 
  ...
  */
    ...
    internal
  {
      ...
      console.log("Transfer to: %s, Amount: %d", owner, _amount);
  }
