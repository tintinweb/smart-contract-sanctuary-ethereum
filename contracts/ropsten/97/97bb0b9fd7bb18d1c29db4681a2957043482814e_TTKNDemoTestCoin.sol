...
contract TTKNDemoTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TTKNDemoTestCoin() {
        ...
        name = "TTKNDemoTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TTKN";                                             // Set the symbol for display purposes (CHANGE THIS)
