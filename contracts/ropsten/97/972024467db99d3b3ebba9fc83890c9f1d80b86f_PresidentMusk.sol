...
contract PresidentMusk is Context, IERC20, Ownable {
    ...
    Taxes private _taxes = Taxes(0,2,0,20);
    ...
    string private constant _name = "President Musk";
    string private constant _symbol = "$PMUSK";
