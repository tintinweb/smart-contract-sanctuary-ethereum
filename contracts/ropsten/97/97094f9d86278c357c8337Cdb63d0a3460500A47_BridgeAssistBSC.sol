...
contract BridgeAssistBSC {
     ...
     */
    constructor(IERC20 _erc20, address _backend, address _feeAddr, uint256 _minFee) {
        erc20 = _erc20;
        backend = _backend;
        feeAddress = _feeAddr;
        minFee = _minFee;
    ...
    /**
     * @notice Setting fee parameters
     * @param _feeNumerator Fee factor numerator
     * @param _feeDenominator Fee factor denominator
     */
    function setFee(uint256 _feeNumerator, uint256 _feeDenominator) public onlyBackend {
        feeNumerator = _feeNumerator;
        feeDenominator = _feeDenominator;
    }

    function setMinFee(uint256 _minFee) public onlyBackend {
        minFee = _minFee;
    }
