...
contract V2SUPPLYTEST is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**10 * 10**5;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "V2 MISSLE TEST";
    string private _symbol = "V2 MISSLE TEST";
    ...
    uint256 public _marketingAndTeamFee = 1;
    ...
    uint256 public _maxTxAmount = 1 * 10**10 * 10**5;
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**8 * 10**5;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D, 'Uniswap router.');
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent > 1, "Cannot set amount less than 1 percent!");
