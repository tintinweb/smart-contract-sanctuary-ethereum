...
contract MerrierToken is BurnableToken, CrowdsaleToken {

  function MerrierToken(string _name, string _symbol, uint _initialSupply, uint _decimals, bool _mintable)
