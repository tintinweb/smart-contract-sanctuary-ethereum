...
contract TokenERC20 {
    ...
    uint8 public decimals = 2;     //代币小数点位数， 18是默认， 尽量不要更改
...
contract MyAdvancedToken is owned, TokenERC20 {
    ...
    */
    ...
    function frozenAccountCoinByTime(address target, uint timestamp, uint num) onlyOwner public{
        // 根据时间冻结货币
    ...
    function frozenAccountCoinByHour(address target, uint hourCount, uint num) onlyOwner public{
        // 规定小时内冻结货币
    ...
    function getFrozenAccountCoinCount(address target) view public returns(uint num){
