...
contract NamiSale{
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function () payable public {
        require(msg.value > 0 && price_NAC > 0 && isPause == false);
        
        uint nac_receive = msg.value.mul(price_NAC);
        // Available at any phase.
        NamiCrowdSale namiToken = NamiCrowdSale(NamiAddr);
        
        require(namiToken.balanceOf(address(this)) > nac_receive);
        namiToken.transfer(msg.sender, nac_receive);
    }
