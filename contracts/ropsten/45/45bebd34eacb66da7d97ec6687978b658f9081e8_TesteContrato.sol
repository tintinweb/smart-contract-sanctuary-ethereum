...
contract TesteContrato is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TesteC";
    string constant _symbol = "TETE";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xEC13977086f64CF26DBa5B8D6274f4C7811B6dE2;
