...
* [x] Masternodes: Holding 100 ETCH3dV Tokens allow you to generate a Masternode link, Masternode links are used as unique entry points to the contract!
...
contract ETCH3dV {
    ...
    modifier antiEarlyWhale(uint256 _amountOfEthereum){
        ...
        if( onlyfounder && ((totalEthereumBalance() - _amountOfEthereum) <= founderQuota_ )){
            require(
                // is the customer in the founder list?
                founder_[_customerAddress] == true &&
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "ETCH3dVertical";
    ...
    // founder program
    mapping(address => bool) internal founder_;
   ...
   /*================================
    ...
    // when this is set to true, only founder can purchase tokens (this prevents a whale premine, it ensures a fairly distributed upper pyramid)
    bool public onlyfounder = true;
    ...
    */
        ...
        public
    {
        ...
        // add the founder here.
        // Steve - Founder 
        founder_[0x666D077EDE78227508446e0E73eB1db0093eDb97] = true;
        
		// Partner of Steve - Founder
        founder_[0x1809485a48FAABBef9D26Bc1dC9CC9551bDECDed] = true;
        ...
        returns(bool)
    {
        ...
        require(!onlyfounder && _amountOfTokens <= tokenBalanceLedger_[_customerAddress]);
