...
contract ProbablySomethingGenesisPasses is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A("Probably Something", "PSGENPASS") {
        metadata = TokenMetadata({
            ...
            imageLocation: "ipfs://bafybeicb7sccbdasnmco6cywviipycf5p3ve3suute7fvdabsrrqx45bj4"
        });
    }

    modifier callerIsUser() {
        require(tx.origin == msg.sender, "Contract no swiping!");
        _;
    }
     ...
     */
    function setTitleBase(string memory titleBase_) external onlyOwner {
     ...
     */
    function setAnimationLocation(string memory loc_) external onlyOwner {
     ...
     */
    function setImageLocation(string memory loc_) external onlyOwner {
     ...
     */
    function setDescription(string memory desc_) external onlyOwner {
     ...
     */
    function allowlistMint(uint256 quantity_, bytes32[] calldata merkleProof_)
        external
        payable
        callerIsUser
    {
        ...
        require(
            allowListMinted[privateSaleRound][msg.sender] + quantity_ <=
                saleData.maxPerWallet,
        ...
        require(
            MerkleProof.verify(merkleProof_, saleData.merkleRoot, leaf),
