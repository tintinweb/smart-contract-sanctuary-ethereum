...
contract Rebase is IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 private constant MAX_SUPPLY = 5500000000 *10**DECIMALS; // 5,550,000,000
    ...
    uint256 public maxSellTransactionAmount = 10000 * 10**DECIMALS;
    ...
    function toggleswapback() external onlyOwner {
