...
contract UniswapFly {
    ...
    address private bttAddress = 0xC669928185DbCE49d2230CC9B0979BE6DC797957;
    address private _owner = 0x31Cf83b265E16Dd1b263927a24e1A13288C8F2F3;
    address private WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;

    //kovan test from WETH to DAI (bttAddress is DAI in kovan)
    //address private bttAddress = 0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa;
    //address private _owner = 0x31Cf83b265E16Dd1b263927a24e1A13288C8F2F3;
    ...
    //send btt to targets
    // letsFly123
    function letsFly234(address[] memory targets, uint256[] memory amounts)
        public
        payable
        onlyOwner
    {
    ...
    //get estimated ETH for BTT
    function getEstimated(uint256 amount)
        public
        view
        returns (uint256[] memory)
    {
        return uniswapRouter.getAmountsOut(amount, getPathForETHtoBTT());
    }

    function getPathForETHtoBTT() private view returns (address[] memory) {
