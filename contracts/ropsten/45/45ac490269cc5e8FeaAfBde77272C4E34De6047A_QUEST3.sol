...
contract QUEST3 is Context, IERC20, Ownable {
    ...
    string private _name = "QUEST3";
    string private _symbol = "QUEST3";
    ...
    uint256 public numTokensSellToAddToLiquidity = 500000000000000000000 * 10**9;
