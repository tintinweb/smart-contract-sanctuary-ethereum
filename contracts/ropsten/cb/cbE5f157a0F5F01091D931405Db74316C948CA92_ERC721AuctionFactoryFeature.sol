...
interface IFactoryFeature {
    ...
    /// @dev The factoryVersion param is 0 if the contract was added manually.
    /// @param factoryVersion The version number of the factory that was used to deploy the contract.
...
library LibERC721AuctionFactoryStorage {
    ...
    function getStorage() internal pure returns (Storage storage stor) {
        uint256 storageSlot = LibStorage.getStorageSlot(LibStorage.StorageId.ERC721AuctionFactory);
