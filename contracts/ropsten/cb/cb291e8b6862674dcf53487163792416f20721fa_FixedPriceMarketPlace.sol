...
contract AuctionMarketPlace is IAuctionMarketPlace, Initializable,UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable,ReentrancyGuardUpgradeable,AuctionMarketPlaceStorage {
    ...
    function createAuction(uint256 _tokenId,  uint256 _minBidPrice) external whenNotPaused {
        //TODO check contractAddress implement ERC721 standared
        //TODO check token belongs to sender (or aproved??)
        //TODO check marketPlace is approve for this token or not
    ...
    function settle(uint256 _tokenId) external whenNotPaused nonReentrant { 
        ...
        //ToDO use call instead of transfer
