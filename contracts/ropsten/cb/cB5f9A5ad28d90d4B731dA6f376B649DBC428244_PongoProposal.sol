...
contract PongoProposal is Ownable, IPongoProposal {
    ...
    // Symbol
    string private _symbol = "PONGOPT2";
    ...
    address public pongoContract = 0x3067C25f91A54a6D288A1c2143176AD25eBA29E7;
     ...
     */
    event CreatedProposal(address indexed to, uint256 indexed proposalId);

    /**
     * @dev Emitted when voted `proposalId` proposal.
     */
    event Voted(uint256 indexed proposalId, bool yes);
    ...
    function _createProposal(address to, uint256 proposalId) internal virtual {
        ...
        emit CreatedProposal(to, proposalId);
    }
