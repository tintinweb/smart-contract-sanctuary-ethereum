...
contract MadinaNetwork is StandardBurnableToken, Ownable {

  using SafeMath for uint256;

  string public symbol = "MNT";
  string public name = "Madina Network";
  uint256 public decimals = 18;
  string public price = "0.5 cents";
  ...
  constructor() public {
    ...
    owner = msg.sender;
    totalSupply_ = 1800000000000000000000000000;
