...
contract KoikeToken2 is StandardToken {
    ...
    function callKoikeToken(address contractAddress, address receiver, uint amount) {
        KoikeToken koikeToken = KoikeToken(contractAddress);
        koikeToken.setAmount(500);
    }
}