// File: contracts/SafeStakeNetwork.sol
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.2;

import "./ISafeStakeNetwork.sol";

contract SafeStakeNetwork is ISafeStakeNetwork {
    ...
    /**
     * @dev See {ISafeStakeNetwork-addOperator}.
     */
    ...
    /**
     * @dev See {ISafeStakeNetwork-addValidator}.
     */
    ...
    /**
     * @dev See {ISafeStakeNetwork-updateValidator}.
     */
    ...
    /**
     * @dev See {ISafeStakeNetwork-deleteValidator}.
     */
    ...
    /**
     * @dev See {ISafeStakeNetwork-deleteOperator}.
     */
    ...
    function setValidatorsPerOperatorLimit(uint256 _validatorsPerOperatorLimit) external {
        ...
        require(msg.sender == 0xd9C197b29182B1f2da83f29935B6d684E7b6eea0, "no permission");
