...
contract ECHPunks_Marketplace is ReentrancyGuard {
    ...
    function createMarketItem(
        ...
        address creator = NFT(nftContractAddress).ownerOf(tokenId);
     ...
     */
    function fetchMarketItemsByAddressProperty(string memory _addressProperty, address ownerOrSeller)
        public
        view
        returns (MarketItem[] memory)
    {
        ...
        for (uint256 i = 0; i < totalItemsCount; i++) {
            ...
            if (addressPropertyValue != ownerOrSeller) continue;
            itemCount += 1;
        }
