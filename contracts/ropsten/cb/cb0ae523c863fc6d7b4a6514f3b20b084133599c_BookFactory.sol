...
contract BookFactory is Ownable, ERC721URIStorage {
    ...
    modifier onlyOwnerOf(uint256 _bookId) {
    ...
    function mint(address recipient, uint id, string memory tokenURI) private onlyOwner {
        _mint(recipient, id);
    ...
    function createBook(
        ...
        Books.push(Book(_name, _description, _author, _tokenURI, _state));
