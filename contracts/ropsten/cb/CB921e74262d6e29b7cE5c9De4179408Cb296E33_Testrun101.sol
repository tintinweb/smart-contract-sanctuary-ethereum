...
contract Testrun101 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Testrun101", "TR") {
    setHiddenMetadataUri("ipfs://QmeNebvWuZeiUcfa9yVuyVKWwqSd2USqkZ5kfnmUijszro/hidden_metadata.json");
  }
