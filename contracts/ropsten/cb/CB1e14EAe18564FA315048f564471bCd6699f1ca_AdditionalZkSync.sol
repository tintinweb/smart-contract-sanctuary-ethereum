...
contract AdditionalZkSync is Storage, Config, Events, ReentrancyGuard {
    ...
    function approveCutUpgradeNoticePeriod(address addr) internal {
        address payable[SECURITY_COUNCIL_MEMBERS_NUMBER] memory SECURITY_COUNCIL_MEMBERS = [
            0xc0f97CC918C9d6fA4E9fc6be61a6a06589D199b2,0x400C00C178c66cF49a4de5FcCc981F5c4A34472A,0xA36B1c9De690C36C636d99930C5280F4de5f13D0,0xE1E85b0e63d7B0e0a4934cF5dcdc746761503655
        ];
    ...
    function getUpgradeTargetsHash() internal returns (bytes32) {
        ...
        address gatekeeper = 0x96FAFD628E21bF679F0215b87C61Cd1484Aad8f8;
...
contract TokenGovernance is ReentrancyGuard {
    ...
    function addToken(address _token) external nonReentrant {
        ...
        require(_token != 0x0BC1C9Ab8E7D9ddcBfb2A3A6373c852aD05C1bF9, "z2"); // Address of the token cannot be the same as the address of the main zksync contract
