...
contract Bou is StandardToken, Ownable {
    string public constant symbol = "BOU";
    string public constant name = "Bou";
    uint8 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY = 21000000 * (10 ** uint256(decimals));
    uint256 public constant TOKEN_OFFERING_ALLOWANCE = 15000000 * (10 ** uint256(decimals));
     ...
     */
    function Bou(address admin) public {
...
contract BouCrowdsale is Pausable {
    using SafeMath for uint256;
