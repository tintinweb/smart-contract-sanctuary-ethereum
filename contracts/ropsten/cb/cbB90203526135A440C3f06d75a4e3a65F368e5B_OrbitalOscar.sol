...
contract OrbitalOscar is ERC721, Ownable, Ticketed {
    ...
    address private b1 = 0x816ae721F90d9cd5190d0385E7224C6798DaD52B;
    // charity address
    address private a1 = 0xb8754D815621cA58Da6665C0100e867027d96A35;

    constructor(string memory baseURI) ERC721("OrbitalOscar", "ORBITALOSCAR") {
    ...
    function withdraw() external onlyOwner {
        (bool s1, ) = b1.call{value: (address(this).balance * 20) / 100}("");
