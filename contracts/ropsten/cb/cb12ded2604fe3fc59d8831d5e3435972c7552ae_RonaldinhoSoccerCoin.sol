...
contract RonaldinhoSoccerCoin is StandardToken, Ownable {
    string public name = "Ronaldinho Soccer Coin"; //Token name
    string public symbol = "RSC"; //Identifier
    uint8 public constant decimals = 18; //How many decimals to show. To be standard complicant keep it 18
    uint256 public unitsOneEthCanBuy = 500;     // Approximately 0.00000833 ETH per Nam coin, means 120048 Nam Coin per ETH
    uint256 public totalEthInWei;         // WEI is the smallest unit of ETH (the equivalent of cent in USD or satoshi in BTC). We'll store the total ETH raised via our ICO here.  
    address public fundsWallet; //ETH wallet
    uint public constant crowdsaleSupply = 350 * (uint(10)**6) * (uint(10)**decimals); // 60 billion NAM available for the crowdsale
    ...
    function RonaldinhoSoccerCoin(address _fundsWallet) public {
        fundsWallet = _fundsWallet;
        
        totalSupply_ = crowdsaleSupply;
