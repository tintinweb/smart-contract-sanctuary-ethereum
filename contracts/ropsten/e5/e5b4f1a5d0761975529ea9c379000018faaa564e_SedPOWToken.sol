...
// Thanks to the Mikers help (http://mike.rs)
...
contract SedPOWToken is ERC20Interface, Owned {
    ...
    function SedPOWToken() public onlyOwner{
        ...
        miningTarget = 2**214;//_MAXIMUM_TARGET;
       ...
       // Transfer(address(0), owner, tokensMinted);
        emit Transfer(address(this), owner, tokensMinted); //we need add it to show token transfers in the etherscan
