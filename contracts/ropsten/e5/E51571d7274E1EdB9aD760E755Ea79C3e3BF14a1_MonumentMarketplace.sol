...
contract MonumentMarketplace is Payable, ReentrancyGuard {
  ...
  mapping(uint256 => bool) public isEditionsAutoSellEnabled;
  ...
  function listEditions(
    ...
    isEditionsAutoSellEnabled[_artifactId] = true;
  ...
  function unlistEditions(
    ...
    isEditionsAutoSellEnabled[_artifactId] = false;
  ...
  function buyEditions(
    ...
    require(isEditionsAutoSellEnabled[_artifactId] == true, "editions not on autosale");
    ...
    if (msg.value > 0) {
      ...
      (
        address royaltyReceiver, 
        uint256 royaltyAmount
      ) = allowedNFTContract.getRoyaltyInfoByArtifactId(_artifactId);
