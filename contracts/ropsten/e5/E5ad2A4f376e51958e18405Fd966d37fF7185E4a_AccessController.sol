...
contract AccessController is ERC721, ERC721Enumerable, Ownable, EIP712, ERC721Votes, AccessControl {
    ...
    modifier isValidMerkleProof(bytes32[] calldata merkleProof, bytes32 root) {
        require(
            ...
            "Access control: Address does not exist in whitelist"
        );
        _;
    }
    ...
    {
        require(!whitelistClaimed[msg.sender], "AccesControl: Address has already claimed");
