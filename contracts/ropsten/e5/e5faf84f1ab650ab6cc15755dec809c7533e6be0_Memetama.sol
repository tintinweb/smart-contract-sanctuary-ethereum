...
contract Memetama is Context, IERC20, Ownable {
    ...
    string private _name = "Memetama";
    string private _symbol = "Memetama";
    ...
    uint256 public _maxTxAmount = 50000000000 * 10**9; // 1%
    uint256 private numTokensSellToAddToLiquidity = 5000000000 * 10**9; // 0.1%
    ...
    function setFeePercent(uint256 liquidityFee, uint256 marketingFee) external onlyOwner() {
        ...
        require(_liquidityFee + marketingFee <= 20, "Fees must be less then 20%");
    }
    ...
    function withdrawStuckET() external onlyOwner{
