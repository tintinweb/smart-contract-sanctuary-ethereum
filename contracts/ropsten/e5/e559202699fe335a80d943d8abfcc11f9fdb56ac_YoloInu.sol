...
contract YoloInu is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xAb2972Ea88Aeb146814dfa8a9fc0022fc5585eC7);
    ...
    constructor() ERC20("YOLOINU", "YINU") {
    ...
    function _transfer(
        ...
        // anti bot logic
        if (block.timestamp <= (launchedAt + 1 minutes) && 
                to != uniswapV2Pair && 
