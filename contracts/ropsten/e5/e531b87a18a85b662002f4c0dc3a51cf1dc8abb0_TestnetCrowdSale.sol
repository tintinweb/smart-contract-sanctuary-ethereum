...
contract TestnetCrowdSale is Ownable {
    ...
    uint public constant startPresaleTime = 1535454000; // 28.08.2018 17:00:00 GMT+06:00 - start time of Presale.
    uint public constant endPresaleTime = 1535457600;   // 28.08.2018 18:00:00 GMT+06:00 - end time of Presale.
    
    uint public constant startIcoTime = 1535459400;     // 28.08.2018 18:30:00 GMT+06:00 - start time of ICO.
    uint public constant endIcoTime = 1535463000;       // 28.08.2018 19:30:00 GMT+06:00 - end time of ICO.
    ...
    // We need sale 800 000  * 10^18 3VA to get hardcap.
    // 30% = 240,000 * 10^18 
    ...
    // 70% = 560,000,000 * 10^18 + maximum 55% of the bonus per volume.
    // Total ICO cap
    ...
    uint public constant softcap =  100 ether; // The amount of ETH the crowdsale must receive to be considered successful.
    uint public constant hardcap = 400 ether; // The maximum amount of ETH that the crowdsale can get.
