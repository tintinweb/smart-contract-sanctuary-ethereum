...
import { MetaTopeMock721 } from "./MetaTopeMock721.sol";
import { Auth, Authority } from "@rari-capital/solmate/src/auth/Auth.sol";
 ...
 * Copyright 2022 MetaTope
 */
contract MetaTopeSwap is Auth(msg.sender, Authority(address(0))) {
    MetaTopeChrysalis public swapFromToken;
    MetaTopeMock721 public swapToToken;
    ...
    function swap() external onlySwappingStarted {
        ...
        swapToToken.mint(msg.sender, mintTokenId);
     ...
     */
    function toggleSwapping() external requiresAuth {
