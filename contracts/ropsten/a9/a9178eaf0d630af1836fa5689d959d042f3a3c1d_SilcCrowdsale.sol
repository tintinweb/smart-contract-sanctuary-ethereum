...
contract SilcToken is MintableToken, BurnableToken {
	string public name = "SILCTEST";
	string public symbol = "SILCTEST";
...
contract SilcCrowdsale is CappedCrowdsale, MyRefundableCrowdsale {
  ...
  function () external payable {
      ...
      //if ((stage == CrowdsaleStage.phase1) && (token.totalSupply() + tokensThatWillBeMintedAfterPurchase > totalTokensForSaleDuringPhase1)) {
