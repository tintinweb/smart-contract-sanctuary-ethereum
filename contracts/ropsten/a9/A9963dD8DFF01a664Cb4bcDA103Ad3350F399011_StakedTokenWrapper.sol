...
contract StakedTokenWrapper {
    ...
    function stakeFor(address forWhom, uint128 amount) public payable virtual {
        IST20 st = stakedToken;
        if (st == IST20(address(0))) {
            unchecked {
...
contract Token_Staking_Contract is StakedTokenWrapper, Ownable {
    IST20 public rewardToken;
    ...
    constructor(IST20 _rewardToken, IST20 _stakedToken) {
    ...
    function rewardPerToken() public view returns (uint128) {
        ...
        unchecked {uint256 rewardDuration = lastTimeRewardApplicable() - lastUpdateTime;
