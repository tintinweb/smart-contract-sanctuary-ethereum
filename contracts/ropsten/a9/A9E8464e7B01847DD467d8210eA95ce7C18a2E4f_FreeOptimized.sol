...
contract FreeOptimized is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.005 ether;
    uint256 public maxSupply = 10000;
    uint256 public maxFree = 20;
    uint256 public maxperAddressFreeLimit = 9;
    uint256 public maxperAddressPublicMint = 20;
    uint256 public maxperSingletrnsFreeLimit = 3;
    ...
    constructor() ERC721A("Free Optimized", "freeoptimized") {
        setBaseURI("");
    ...
    function mintfree(uint256 _mintAmount) public payable nonReentrant{
		...
		require(_mintAmount <= maxperSingletrnsFreeLimit, "Cant mint more then maxmint" );
    ...
    //maxperSingletrnsFreeLimit
     function setMaxperSingletrnsFreeMint(uint256 _amount) public onlyOwner{
        maxperSingletrnsFreeLimit = _amount;
    }
