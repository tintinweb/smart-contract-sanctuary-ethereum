...
abstract contract SupportToken is Ownable {
	...
	*/
    function setBlackListWallet(address[] memory _address, bool result)
        public
        onlyOwner
    {
	...
	*/
    function setWhiteListAddressBot(address[] memory _address, bool result)
        public
        onlyOwner
    {
        for (uint256 i = 0; i < _address.length; i++) {
	...
	*/
    function setInvestmentContract(address _investmentContract)
        public
        onlyOwner
    {
