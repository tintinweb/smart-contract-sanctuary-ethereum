...
contract CosmicCollective is ERC721A, Ownable {
     ...
     * @notice return current sale price
     */
    function getMutantHoldings() external view returns (uint256) {
        return MutantHoldings;
    }
...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function balanceOfMutant() public view returns (uint256) {
        return uint256(IERC721(0x44102Bd86bCcB4eFe8E90b4A4D5C4E43a895D22e).balanceOf(msg.sender));
    }
