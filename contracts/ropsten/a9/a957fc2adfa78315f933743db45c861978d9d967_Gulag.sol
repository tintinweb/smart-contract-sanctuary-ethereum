...
contract Gulag {
    ...
    function end (uint totalTime) internal {
    ...
    function joinBattle(uint battleNumber, string memory NftChain,address NftAddress,uint NftTokenId) public payable{
        ...
        require(msg.value>=wagerByAddressForEachBattleByFighter[indBattle.battleCreator.battleCreator][battleNumber][0],"Your bet doesn't match the person who created this battle");
        require(indBattle.battleTiming.battleStarted== false,"Sorry, this gulag is full!");
        require(indBattle.battleCreator.battleCreator!=msg.sender,"Sorry, you can't join the battle - you created it!");
        indBattle.battleChallenger.challenger=msg.sender;
        indBattle.battleTiming.startTime=block.timestamp;
        indBattle.battleChallenger.challengerNFTAddress=NftAddress;
        indBattle.battleChallenger.challengerNFTTokenId=NftTokenId;
        indBattle.battleChallenger.challengerNFTChain=NftChain;
        ...
        indBattle.battleTiming.battleStarted=true;
    }
