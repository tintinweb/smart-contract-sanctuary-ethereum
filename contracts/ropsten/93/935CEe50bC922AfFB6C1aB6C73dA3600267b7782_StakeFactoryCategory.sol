...
contract StakeFactoryCategory is Ownable{
    struct Category{
        bool exist;
        uint8 stakingType;
        bytes categoryName;
    ...
    Category[] public stakeCategory;
    function addCategory(Category memory c) public onlyOwner{
        require(!stakeCategory[c.stakingType].exist,"staking type is exist");
        stakeCategory[c.stakingType]=c;
    }
