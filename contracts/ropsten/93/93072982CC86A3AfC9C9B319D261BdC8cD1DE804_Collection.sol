...
contract Collection is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,2,0,1655060400,1655061000);
        epochs[2] = EpochDetails(1,3,0,1655061300,1655061900); 
        epochs[3] = EpochDetails(3,7,0,1655062200,0); 
        epochs[4] = EpochDetails(1,2,0,1655061300,0); 
    }
