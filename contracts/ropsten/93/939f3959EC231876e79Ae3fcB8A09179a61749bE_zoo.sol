...
contract zoo is Context, IERC20, Ownable {
    ...
    string private constant _name = "zoo Season";//
    string private constant _symbol = "zoo";//
    ...
    address payable private _developmentAddress = payable(0x922B5a56355B304d2d8bC60e1945bFE5bFEBF3B2);//
    address payable private _marketingAddress = payable(0x922B5a56355B304d2d8bC60e1945bFE5bFEBF3B2);//
