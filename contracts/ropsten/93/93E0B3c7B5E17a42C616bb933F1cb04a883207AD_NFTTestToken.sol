...
contract NFTTestToken is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("NFTTestToken", "NTT") {}
    ...
    function mintItem(uint _count, bytes32[] memory _merkleProof) payable public {
      require(totalSupply() + _count <= 10000, "Can't mint anymore");
      require(msg.value >= PUBLIC_WHITELIST_PRICE * _count, "insufficient ether value");
