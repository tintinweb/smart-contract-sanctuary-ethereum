...
contract BigBucksToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BigBucksToken() {
        balances[msg.sender] = 10000000000000000000000000;           // Give the creator all initial tokens. This is set to 10000000 for example. If you want your initial tokens to be X and your decimal is 5, set this value to X * 1000000000. (CHANGE THIS)
