...
contract redits is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function redits() {
        ...
        name = "redits";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "zrd";                                             // Set the symbol for display purposes (CHANGE THIS)
