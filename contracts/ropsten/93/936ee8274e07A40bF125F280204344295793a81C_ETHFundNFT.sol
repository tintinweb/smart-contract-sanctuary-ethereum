...
contract ETHFundNFT is ERC721 {
    ...
    event itemCreated(uint256 id, address tokenAddress, address creator);

    constructor() ERC721("NftImage", "NFTIMG") {
        tokenCounter = 1;
    }
    ...
    function mint(uint256 royalty,address receiver, string memory svg) public returns (uint256) {
        _safeMint(msg.sender, tokenCounter);
       Items[tokenCounter] = Item(tokenCounter, msg.sender, svg,royalty,receiver);
         emit itemCreated(tokenCounter, address(this), msg.sender);
