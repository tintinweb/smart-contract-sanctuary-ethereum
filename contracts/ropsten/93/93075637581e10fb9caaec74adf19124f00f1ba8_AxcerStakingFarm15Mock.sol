...
contract RewardFarm7Token is ERC20, AccessControl {
    // bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("RewardFarm7Token", "AXF") {
...
contract AxcerStakingFarm15Mock is Ownable{
   using SafeERC20 for IERC20; // Wrappers around ERC20 operations that throw on failure

    RewardFarm7Token public rewardToken; // Token to be payed as reward
    ...
    constructor(address _rewardTokenAddress, uint256 _rewardTokensPerBlock) {
        rewardToken = RewardFarm7Token(_rewardTokenAddress);
