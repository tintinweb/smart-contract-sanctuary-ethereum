...
contract NFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) public payable ERC721A("NFT", "NFT", maxBatchSize_, collectionSize_, maxNormalNftIndex_, maxAmountForDevs_) {
  ...
  function mint(uint256 quantity) public payable isOpen callerIsUser {
    ...
    // emit MintTransEvent(payable(address(this)), cost);

    require(totalSupply() < maxNormalNftIndex, "reached max supply");
