...
contract _0xLitecoinToken is ERC20Interface, Owned {
    ...
    function _0xLitecoinToken() public onlyOwner{
        ...
        miningTarget = 500000; // from 0xBitcoin as of block 5902249

        latestDifficultyPeriodStarted = block.number;

        _startNewMiningEpoch();

        parentAddress = 0x9D2Cc383E677292ed87f63586086CfF62a009010;//0xb6ed7644c69416d67b522e20bc294a9a9b405b31; // XXX 
