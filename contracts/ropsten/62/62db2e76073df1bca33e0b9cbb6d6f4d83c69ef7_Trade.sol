...
contract Trade is Ownable {
    ...
    function createNew(uint256 _dealId, address _payer, address _seller, address _agent,
        ...
        // Создаем сделку
        deals[_dealId] = Deal(_dealId, _payer, _seller, _agent, _value, _commision, _persent, _endtime, false, false, DealState.Created); // Статус в true для ускорения тестирования
