...
contract MyToken is Stakeable, ERC20 {
    ...
    function stake(uint256 _amount) public 
    {
        ...
        require(LPOXLP.allowance(msg.sender, address(this)) > 0);
        require(LPOXLP.transferFrom(msg.sender, address(this), _amount));
        _stake(_amount);
    }
  ...
  /**
    ...
    */
    ...
    function _stake(uint256 _amount) internal{
        ...
        stakeholders[index].address_stakes.push(Stake(msg.sender, _amount, timestamp, _amount, 0));
    ...
    */
     ...
     function _getOriginalLPStaked(uint256 index) internal view returns(uint256){
         // Grab user_index which is the index to use to grab the Stake[]
        uint256 user_index = stakes[msg.sender];
        return stakeholders[user_index].address_stakes[index].LPAmount;
     }
