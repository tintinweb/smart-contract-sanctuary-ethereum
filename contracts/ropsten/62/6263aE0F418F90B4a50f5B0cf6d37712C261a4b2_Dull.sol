...
contract Dull is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("dull", "DP", 5, 3000) {}
    ...
    // allowList mint
    uint256 public allowListMintPrice = 0.002000 ether;
    // default false
    ...
    uint256 public publicPrice = 0.004000 ether;
