    ...
    OwnableUpgradeable
{
    ...
    function burn(uint256 tokenId) public virtual {
        ...
        if (msg.sender == owner()) {
            address owner = ERC721Upgradeable.ownerOf(tokenId);
            balances[tokenId][owner] = balances[tokenId][owner] - 1;
            _burn(tokenId);
        } else {
            require(balances[tokenId][msg.sender] == 1, "Not a Owner");
            balances[tokenId][msg.sender] = balances[tokenId][msg.sender] - 1;
            _burn(tokenId);
        }
    }
    ...
    ERC721BurnableUpgradeable
{
    ...
    function initialize() public initializer {
        __Ownable_init();
        ERC721Upgradeable.__ERC721_init("WeAlwin721", "WeAlwin721");
        _tid = 1;
    ...
    function newtokenasbid(
        ...
        if (keccak256(bytes(tokenAss)) == keccak256(bytes("ESC"))) {
