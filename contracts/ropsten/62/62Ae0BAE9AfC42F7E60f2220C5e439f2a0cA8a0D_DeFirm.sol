...
contract DeFirm is ERC20Detailed, Ownable {
    ...
    uint256 public LMSFee = 15;
    uint256 public totalFee = liquidityFee.add(treasuryFee).add(LMSFee);
    uint256 public feeDenominator = 1000;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address USDC = 0xDDB43ebc3F34947C104A747a6150F4BbAA78a5eB;
    ...
    constructor() ERC20Detailed("DeFirm", "DEFIRM", uint8(DECIMALS)) Ownable() {
        ...
        router = ITraderJoeRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); 
    ...
    function _transferFrom(
        ...
        if(!tradingActive) {
            require(sender == owner() || recipient == owner(), "Swap is not enabled");
        }
