...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract LemonCro3 is ERC20, Ownable  {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public constant troAddress = address(0x83793589e5ae2904Cf7233d9ea2F67f9bCa86393);
    ...
    constructor() ERC20("LemonCro3", "LEMCRO3") {
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        // 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D Uniswap
        // 0x145677FC4d9b8F19B5D56d1820c48e0443049a30 MM Finance
        ...
        maxTransactionAmount = 250000000000000000000000; // 2,5% maxTransactionAmountTxn
        maxWallet = 250000000000000000000000; // 2,5% maxWallet
        ...
        marketingWallet = 0xA4811A08D53B9E2D57059E11b0b6BC9897cA6789; // set as marketing wallet
        burnWallet = 0x13c41C0BbC737D7BF2CdBdF3BA5C3D7Cf08C8f95; // set as burn wallet
