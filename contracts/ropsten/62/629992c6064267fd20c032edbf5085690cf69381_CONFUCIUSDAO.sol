...
contract CONFUCIUSDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CONFUCIUSDAO", "CONFU") {
        ...
        uint256 totalSupply = 1 * 1e12 * 1e15;
        ...
        marketingWallet = address(0x7D3b35F15853941BbDa7d2BaB9b9Efb5F0e0F31A); // marketing wallet
        devWallet = address(0x04e73129D3299585147CBD87E267Cc35aF4886c5); // dev wallet
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee) external onlyOwner {
