...
contract animalMain is  ERC721,Ownable {
  ...
  function createAnimal() payable public {
       ...
       if(range_of_star < 60){ star = 1;}
       else if(range_of_star < 90){star = 2;}
       else if(range_of_star < 95){star = 3;}
       else if(range_of_star < 98){star = 4;}
       else {star=5;}
