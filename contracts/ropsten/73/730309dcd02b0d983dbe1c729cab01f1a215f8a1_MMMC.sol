...
contract MMMC is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MMMC() {
        ...
        name = "MMMC";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MMMCC";                                             // Set the symbol for display purposes (CHANGE THIS)
