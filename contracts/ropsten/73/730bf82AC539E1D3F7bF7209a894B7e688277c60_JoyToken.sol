...
contract AntiBotTokenUpgradeable {
    ...
    function __AntiBotToken_init() internal {
        deadBlocks = 2;
        launchedAt = 0;
        tradingOpen = false;
    }
    
    function openTrading(bool _status,uint256 _deadBlocks) public {
        tradingOpen = _status;
    ...
    function checkSniper(address account) public {
    ...
    function manage_Snipers(address[] calldata addresses, bool status) public {
