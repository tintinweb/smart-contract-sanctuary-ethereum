...
contract Streamer is Ownable {
    ...
    function approve(uint256 _amount) public {
        token.approve(msg.sender, (_amount + 1000));
    ...
    function getConfig() external view returns(int96 _flowRate, ISuperToken _token, address _receiver) {
        return (flowRate, token, receiver);
    }
