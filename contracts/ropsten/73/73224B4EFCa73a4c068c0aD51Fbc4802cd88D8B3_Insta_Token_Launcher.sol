...
contract Insta_Token_Launcher {
  ...
  function create_token(string memory name_, string memory symbol_, uint256 faucet_amount_, address minter_, uint256 initial_supply_, address initial_supply_receiver_) public returns(address){

    return address(new Insta_Token( name_, symbol_, faucet_amount_, minter_, initial_supply_, initial_supply_receiver_));
