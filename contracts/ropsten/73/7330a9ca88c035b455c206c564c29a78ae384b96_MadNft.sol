...
abstract contract MadNftBase is ERC1155Base, OwnableUpgradeable, EIP712Upgradeable {
  ...
  function _instantMint(InstantMintSubject memory _subject, bytes memory _signature)
    internal
  {
  ...
  function _instantMintBatch(InstantMintBatchSubject memory _subject, bytes memory _signature)
    internal
  {
