...
// BANKNET Token Smart contract based on the full ERC20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Verified Status: ERC20 Verified Token
// BANKNET tokens Symbol: BKN


contract BANKNETToken { 
...
/**
 * BANKNET tokens Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract BKNStandardToken is BANKNETToken, Ownable {
...
contract BANKNET is BKNStandardToken {

    
    uint256 constant public decimals = 8;
    uint256 public totalSupply = 70 * (10**7) * 10**8 ; // 700 million tokens, 8 decimal places, 
    string constant public name = "BANKNET";
    string constant public symbol = "BKN";
