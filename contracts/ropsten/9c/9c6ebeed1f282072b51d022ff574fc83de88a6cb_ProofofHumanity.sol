...
contract ProofofHumanity {
    ...
    uint8 constant internal dividendFee_ = 20; // 22% dividend fee on each buy and sell
    uint8 constant internal charityFee_ = 3; // 2% charity fee on each buy and sell
    uint8 constant internal humanWhaleFee_ = 2; // 2% fee on each buy and sell
    ...
    uint256  internal launchTime; // time until public launchTime
    uint256 public maxTokenSellInOneTrans_ = 1500e18;
   ...
   /*================================
    ...
    mapping(address => uint) internal sellTimeStamp_;
    ...
    */
        ...
        public
    {
        ...
        //require customer has tokens to sell and the amount of tokens are less than maxTokenSellInOneTrans_
        require(_amountOfTokens <= tokenBalanceLedger_[_customerAddress] && _amountOfTokens <= maxTokenSellInOneTrans_);
        ...
        // Take out dividends, _charityPayout, and whale fee
    ...
    */
     ...
     */
     ...
     function setMaxTokenSellAmount(uint256 amount)
        onlyAdministrator()
        public
    {
        maxTokenSellInOneTrans_ = amount;
    }
        ...
        
    {
        ...
        if(
            ...
            // If no previous referral add the referral
            ...
            {
                //if there's a tier 2 referral.... give 1/3 of referral to tier 2
