...
contract KAnsariCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KAnsariCoin() {
        ...
        name = "KAnsariCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-027";                                             // Set the symbol for display purposes (CHANGE THIS)
