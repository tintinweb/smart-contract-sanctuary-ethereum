...
// slothereum.io (REE)
// REE is a deflationary score based currency model
...
contract REE is Context, IERC20, Ownable {
    ...
    string private constant _NAME = "REE eee E";
    string private constant _SYMBOL = "REE";
