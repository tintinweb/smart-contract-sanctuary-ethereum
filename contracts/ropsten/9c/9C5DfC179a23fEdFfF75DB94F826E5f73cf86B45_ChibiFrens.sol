...
contract ChibiFrens is ERC721A, Ownable, ReentrancyGuard {
    ...
    function specialClaim(uint256[] calldata _tokenIds) external onlySender {
        ...
        require(Gen2Contract.balanceOf(_msgSender()) == numOfGen1, "must own same amount of gen 2");
        require(Gen3Contract.balanceOf(_msgSender()) == numOfGen1, "must own same amount of gen 3");
