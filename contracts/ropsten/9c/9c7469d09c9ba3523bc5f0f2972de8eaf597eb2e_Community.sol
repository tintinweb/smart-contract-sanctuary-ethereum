...
This pioneering project has been forged out of a focused desire for a TRUE community token.

Our community has joined together out of the ashes of previous projects that have let us down. In an environment surrounded by rugs, honey pots and malicious devs - here we stand.

COMMUNITY is built for the people, by the people.

We are here for all, from the biggest whales to the smallest minnows, we have a fully renounced unchangeable contract which has been carefully examined by multiple devs.

Buy in with zero tax and hold for years. Join our growing telegram community and help us grow this to the multi billion scale of success. Pass your holdings on to future generations.

Whenever you are ready to take some responsible profits, you will pay a 15 percent sell tax. 10 percent will go to massive reflections, quickly growing the holdings of all our community members. And 5 percent will go to a community wallet for outreach and to add additional liquidity as we grow.

We have (~25-50) dedicated members, who have put in equal amounts to fund the community liquidity pool, which is now locked for all eternity.
...
contract Community is Context, IERC20, Ownable {
    ...
    uint256 public maxWallet =  10000000001 * 10**9; 
    address payable public FeeAddress = payable(0x7C5ddBB690cE3f4Ae1409976bdAB6E3B3d157e38);
    address payable public FeeAddress2 = payable(0x7C5ddBB690cE3f4Ae1409976bdAB6E3B3d157e38);

    uint256 private _BuytaxFee = 0;
    uint256 private _BuyteamFee = 0;
   
    uint256 private _SelltaxFee = 10;
    ...
    function addLiquidity() external onlyOwner() {
        ...
        _maxBuyAmount = 10000000001 * 10**9; // 1% TX LIMIT 
