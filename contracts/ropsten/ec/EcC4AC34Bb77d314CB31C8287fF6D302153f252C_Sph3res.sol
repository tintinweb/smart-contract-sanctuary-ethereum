...
contract Sph3res is ERC721, Ownable{
    ...
    uint256 public ashPrice = 50000000000000000; 
    ...
    mapping (address => bool) public receivedSphere;
    ...
    constructor() ERC721("the sph3res ASH test","SPH3RESASH"){
        addAdmin(msg.sender);
    ...
    function shareSphere(address _to, uint _tokenid) public payable supplyNotReached{
        require(sphereToOwner[_tokenid] == msg.sender, "This sph3re does not belong to you.");
        ...
        payable(sph3res_).transfer(msg.value);
    ...
    function shareSphereWithAsh(address _to, uint _tokenid) public supplyNotReached{
        ...
        require(ash.transferFrom(msg.sender,sph3res_,ashPrice),"Unable to transfer enough ASH!");
