...
Mops Inu is a new utility token launched on the Ethereum Smart Chain. Our goal is creating a awesome community,and together celebrate Lunar New Year with Shiba. Only $MOPS holders will be able to participate and join in on the fun.

🚀 50% Token is Burned
🚀 Metaverse integration scheduled for the end of Q2 2022
✅ Liquidity has been locked
✅ Huge marketing campaign
💎 Coinmarket cap and Coingecko listing soon
💎 2% of tokens are redistributed

📟 Telegram: https://t.me/MopsInu
*/
...
contract MopsInu is Context, IERC20, Ownable {
    ...
    string private _name = 'Mops Inu';
    string private _symbol = 'MOPS';
