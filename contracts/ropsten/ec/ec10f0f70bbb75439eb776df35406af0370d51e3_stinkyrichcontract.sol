...
contract stinkyrichcontract is ERC721A, Ownable {
    ...
    constructor() ERC721A("Stinky Rich Frens", "STF") {}
    ...
    uint256[4] public tieredWhitelistMaximums = [1, 2, 1, 10];
    ...
    {
        if (_tier == 2) {
        require(whitelistAddressMintCount[msg.sender] < 1,"Minting above allocation" );
        }
        whitelistAddressMintCount[msg.sender] += 1;
