...
contract ERC721 {
   ...
   modifier onlyMinter {
    ...
    /**
     * @dev Safely mints `tokenId` and transfers it to `to`. This minting is associated with an optional `data` parameter.
     *
     * Requirements:
     *
     ...
     * Emits a {Transfer} event.
     */
    function mint(address to, uint256 tokenId, bytes memory _data) public onlyMinter {
     ...
     * Emits a {Transfer} event.
     */
    function burn(uint256 tokenId, string calldata _data) public {
