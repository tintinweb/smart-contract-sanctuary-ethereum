...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 USDC = IBEP20(address(distributorCoinAddress));
   ...
   function setDistributorReward(address _coin) external override onlyToken{
     distributorCoinAddress = address(_coin);
   }
...
function shouldAutoBuyback() internal view returns (bool) {
   ...
   //MODIFIED
   function setDistributorReward(address _coin) external authorized {
      USDC = address(_coin);
      distributor.setDistributorReward(_coin);
   }
