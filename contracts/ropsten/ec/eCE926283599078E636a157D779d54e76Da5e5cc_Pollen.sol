...
contract Pollen {
    ...
    function getBalanceUnder(address sender, uint256 tokenIndex) public returns(uint) {
    ...
    function getUnderReturn(uint256 tokenIndex) public view returns(uint) {

             StakedToken memory staked = rewards[tokenIndex]; 

             staked.resultUnder = staked.underTokens - staked.amount;
