...
contract IXTKN311728StakingLocked{
    function init(uint256, uint256) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN311728PreSale{
...
*/
contract XTKN311728Stats is Context, Ownable{
    // lib
    ...
    // interfaces
        IXTKN311728 private _main;
        IXTKN311728Project private _project;
        IXTKN311728Staking private _staking;
        IXTKN311728StakingLocked private _staking30D;
        IXTKN311728StakingLocked private _staking90D;
        IXTKN311728StakingLocked private _staking180D;
        IXTKN311728StakingLocked private _staking365D;
        IXTKN311728PreSale private _preSale;
        IXTKN311728PreSaleVault private _vault;
        IXTKN311728PreSaleVault20 private _vault20;
        IXTKN311728Lottery private _lottery;
    ...
    constructor(address pToken){
        if(ADDRESS_TOKEN == address(0) && pToken != address(0)){
            ...
            _main = IXTKN311728(ADDRESS_TOKEN);
    ...
    function _refresh() private{
        ...
        _lottery = IXTKN311728Lottery(ADDRESS_LOTTERY);
        _project = IXTKN311728Project(ADDRESS_PROJECT);
        _staking = IXTKN311728Staking(ADDRESS_STAKING);  

        if(block.timestamp <= (STAKING_LOCKED_DEATH - 60)){
            _staking30D = IXTKN311728StakingLocked(ADDRESS_STAKING_DAYS30);
            _staking90D = IXTKN311728StakingLocked(ADDRESS_STAKING_DAYS90);
            _staking180D = IXTKN311728StakingLocked(ADDRESS_STAKING_DAYS180);
            _staking365D = IXTKN311728StakingLocked(ADDRESS_STAKING_DAYS365);
        }        
    }
}