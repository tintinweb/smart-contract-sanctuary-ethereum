...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _getStatus(uint256 tokenId) internal virtual view returns (uint256) {
        return _status[tokenId];
    }
    
    function _setStatus(uint256 tokenId, uint256 status) internal virtual {
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        ...
        require(_status[tokenId] == 0 || _status[tokenId] ==1 ,"this token is busy");
...
contract BlindBox is ERC721("BlindBox", "BlindBox"), ERC721Enumerable, ERC721URIStorage, Ownable, INFT {
    ...
    function mint(address to,uint256 tokenId) public virtual override onlyController returns (bool) {
        _mint(to, tokenId);
    ...
    function setTokenURI(uint256 tokenId, string memory newTokenURI) public onlyController {
        require(_exists(tokenId), "ERAC: URI set of nonexistent token");
