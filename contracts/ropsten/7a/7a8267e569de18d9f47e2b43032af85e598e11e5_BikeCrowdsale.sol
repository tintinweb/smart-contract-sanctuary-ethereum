...
contract BikeCrowdsale is Ownable, StandardToken {
    ...
    uint256 public totalSupply= 5*10**9; // total supply 
    ...
    uint256 public tokenRate = 5000 ; // 1 ether = 5000 tokens
  ...
  function sellTokens(address _recepient, uint256 _value) private
  {
    ...
    uint256 tokensSold = _value * tokenRate / uint256(10)**18; // token = eth * rate
