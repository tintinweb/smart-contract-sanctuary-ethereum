...
contract ReflectionAutoLPToken is IERC20, Context, Ownable {
	...
	constructor(
		...
		_taxFee = txFee; // % shares holders
		_liquidityFee = lpFee; // %  add liquidity
