...
abstract contract IERC20Extented is IERC20 {
 ...
 contract test123 is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "test123";
    string private constant _symbol = "t123";
    ...
    address payable private _marketingAddress = payable(0x216fe89f2d4F2e1a3576d757fc95d2c17a5bCa82);
    address payable private _teamAddress = payable(0x216fe89f2d4F2e1a3576d757fc95d2c17a5bCa82);
    address payable private _communityAddress = payable(0x216fe89f2d4F2e1a3576d757fc95d2c17a5bCa82);
    ...
    function getTokenPriceBNB(uint256 amount) external view returns(uint256) {
        IERC20Extented token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token0());//test123
        ...
        if(pairSwapped) {
            token0 = IERC20Extented(IUniswapV2Pair(uniswapV2Pair).token1());//test123
