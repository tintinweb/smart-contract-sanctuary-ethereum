...
contract TestINU is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x34eA543C6B4AC9C7b6F438ebe19E403CdB2e2d16);
    address payable private _marketingAddress = payable(0x34eA543C6B4AC9C7b6F438ebe19E403CdB2e2d16);
