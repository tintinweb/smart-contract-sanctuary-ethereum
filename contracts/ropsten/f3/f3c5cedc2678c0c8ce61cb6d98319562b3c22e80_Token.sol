...
contract Token is ERC20 {
    ...
    function checkStakeRewardByIndex(uint _stakeIndexNo) public view returns(
        string memory,                                                          // - 0 legend below:
        ...
        allUserStakes[msg.sender]._optionReleaseSelected[_stakeIndexNo],        // - 1 ORS - option release selected
        allUserStakes[msg.sender]._epochDuration[_stakeIndexNo],                // - 2 ED  - epoch duration
        allUserStakes[msg.sender]._rewardPerCycle[_stakeIndexNo],               // - 3 RPC  - reward per cycle
        allUserStakes[msg.sender]._finalStakeReward[_stakeIndexNo]);            // - 4 FSR - final stake reward
        }
