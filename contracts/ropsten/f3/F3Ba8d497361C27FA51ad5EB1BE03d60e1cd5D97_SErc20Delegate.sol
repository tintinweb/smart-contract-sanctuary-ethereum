...
contract SToken is STokenInterface, Exponential, TokenErrorReporter {
    ...
    function seizeInternal(address seizerToken, address liquidator, address borrower, uint seizeTokens) internal returns (uint) {
        ...
        uint tempSeizeTokens = seizeTokens;
        seizeTokens = seizeTokens + moreForLiquidatorAndStrike * 2/3; // -> 10% for liquidator
        accountTokens[address(this)] += tempSeizeTokens+moreForLiquidatorAndStrike - seizeTokens;  // -> transfer 5% to sToken
        // swapToStrikeAndTransferToAdmin(tempSeizeTokens+moreForLiquidatorAndStrike - seizeTokens);   // swap to strike
