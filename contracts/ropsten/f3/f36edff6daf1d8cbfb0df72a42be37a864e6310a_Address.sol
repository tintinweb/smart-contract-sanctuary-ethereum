...
pragma solidity ^0.6.12;
    ...
    contract IKIGAMI is Context, IERC20, Ownable {
        ...
        string private _name = 'IKIGAMI';
        string private _symbol = 'IKIGAMI';
        ...
        constructor (address payable MarketingWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // bsc testnet pcs v2
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x7ABc96Dde4F235106b874e494132b4AbE4bA5F31, 'We can not exclude Uniswap router.');
