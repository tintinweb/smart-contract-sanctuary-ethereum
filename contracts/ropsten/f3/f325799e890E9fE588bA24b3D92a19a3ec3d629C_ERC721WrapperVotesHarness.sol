...
contract ERC721WrapperVotesHarness is ERC721WrapperVotes {
    constructor(
        string memory name,
        string memory symbol,
        IERC721Metadata rootToken_
    ) ERC721WrapperVotes(name, symbol, rootToken_) {}

    function setCommunityMembersCounter(uint24 communityMembersCounter) public {
        require(communityMembersCounter >= globalInfo.communityMembersCounter);
        globalInfo.communityMembersCounter = communityMembersCounter;
    }
}
