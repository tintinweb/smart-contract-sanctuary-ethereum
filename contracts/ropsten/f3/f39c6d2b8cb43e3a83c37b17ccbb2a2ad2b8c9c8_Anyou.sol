...
contract Anyou is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Anyou";
    string private constant _symbol = "AY";
    ...
    uint256 public _maxWalletSize = 28000000000 * 10**9;
