...
contract GrandTheftPepe is ERC20, Ownable {
   ...
   uint64 private buyCounter=0;
    ...
    constructor() ERC20("Grand Theft Pepe", "GTP") {
        ...
        devwallet = address(0xD7886b96E1D04DA305Da023E9bfc11Bb7c211d6C); // set as dev wallet
    ...
    function ModifySellFees(
        ...
        sellTotalFees = sellDevFee + sellBuyBackFee ;
        require(sellTotalFees <= 15, "Must keep fees at 12% or less");
    }
    ...
    function updateCreatorWallet(address newDevWallet)
        external
        onlyOwner
    {
