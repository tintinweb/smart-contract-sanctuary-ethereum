...
contract TestInu is ERC20, Ownable {
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 100)/1e18, "Cannot set maxWallet lower than 0.5%");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        treasuryWallet = (0xeF59334AeD6f4E22d1Cb3d56048d48a5E8823eFC);
        devWallet = (0xeF59334AeD6f4E22d1Cb3d56048d48a5E8823eFC);
