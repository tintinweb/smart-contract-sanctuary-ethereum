...
// File contracts/1155/Desire1155.sol

pragma solidity ^0.8.0;

// import "@openzeppelin/contracts/utils/Strings.sol";

contract Desire1155 is ERC1155Supply, Ownable {
    ...
    // total supply of 1: 100
    uint256 public constant totalSupply1 = 100;
    // total supply of 2: 200
    uint256 public constant totalSupply2 = 200;
    ...
    function _beforeTokenTransfer(
        ...
        if (from == address(0)) {
            for (uint256 i = 0; i < ids.length; i++) {
                if (ids[i] == 1) {
                    require(
                        totalSupply(1) + amounts[i] <= totalSupply1,
                        "not enough of 1"
                    );
                } else if (ids[1] == 2) {
                    require(
                        totalSupply(2) + amounts[i] <= totalSupply2,
                        "not enough of 2"
                    );
                }
            }
