...
contract MYLASTTOKEN is ERC20 {
    ...
    string public constant name = "MYLASTTOKEN";
    ...
    function getCirculationSupply () constant public returns (uint256) {
        
        uint256 circulationSupply = totalSupply.sub(totalDistributed);
