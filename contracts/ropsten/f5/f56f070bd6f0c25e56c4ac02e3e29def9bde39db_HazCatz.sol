...
| | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
                   ___      _       
  /\  /\__ _ ____ / __\__ _| |_ ____
 / /_/ / _` |_  // /  / _` | __|_  /
/ __  / (_| |/ // /__| (_| | |_ / / 
\/ /_/ \__,_/___\____/\__,_|\__/___|
                                    
*/

pragma solidity ^0.8.7;

interface ICatzToken {
...
contract HazCatz is ERC721, Ownable, Pausable {
    ...
    constructor() ERC721("HazCatz", "Catz") { }
    ...
    function setICatzToken(address _token) external onlyOwner {
        require(_token != address(catzToken), "TOKEN_ALREADY_SET");
        require(_token != address(0), "TOKEN_ADDRESS_ZERO");
        catzToken = ICatzToken(_token);
    }
    ...
    function _beforeTokenTransfer(
        ...
        catzToken.updateReward(from, to, tokenId);
