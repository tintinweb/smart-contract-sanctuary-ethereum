...
contract LendingRouter is Ownable, ReentrancyGuard {
    ...
    // TODO setter and constructor
    uint public minimumSwapRate = 90;
    ...
    function _swap(address sourceToken, address destinationToken, uint256 value) private returns (bool, uint) {
        ...
        try exchangeInstance.getOutputAmount(value, sourceToken, destinationToken) returns (bool status, uint swapAmount) {
            ...
            // TODO test
            if (
                swapAmount * (10 ** IERC20Metadata(sourceToken).decimals()) * 100 / 
            ...
            emit debug(swapAmount, 10 ** IERC20Metadata(sourceToken).decimals(), value, (10 ** IERC20Metadata(destinationToken).decimals()));
