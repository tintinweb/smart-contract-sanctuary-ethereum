...
contract JusticeTokenV2 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function JusticeTokenV2() {
        ...
        name = "JusticeTokenV2";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "JT";                                             // Set the symbol for display purposes (CHANGE THIS)
