...
contract BreedingRouter is Ownable, Pausable, ERC721Holder, ReentrancyGuard {
    ...
    function getFerdility(uint256 tokenId) public view returns (uint256) {
    ...
    function _getBreedingTime(
        ...
        uint256 fertility1 = getFerdility(bunnyId1);
        uint256 fertility2 = getFerdility(bunnyId2);
        /// return day in int
    ...
    function _breedingWithRentedBunny(
        ...
        require(getFerdility(bunnyId1) > 0, "Not enough Ferdility");
        require(getFerdility(rentedBunnyId) > 0, "Not enough Ferdility");
        if (useNyanKee) {
            require(
    ...
    function _breedingWithBunnies(
        ...
        require(getFerdility(bunnyId1) > 0, "Not enough Ferdility");
        require(getFerdility(bunnyId2) > 0, "Not enough Ferdility");
    ...
    function buyGatchaItem() external {
        uint256 itemId = _randomItem();
        require(rewardToken.balanceOf(msg.sender) >= itemPrice, "Not enougn token for this function");
    ...
    function _randomItem() internal view returns (uint256) {
        uint256 rd = _rand();
        uint256 tokenId;
        if (rd <= 500) {
            tokenId = 1;
