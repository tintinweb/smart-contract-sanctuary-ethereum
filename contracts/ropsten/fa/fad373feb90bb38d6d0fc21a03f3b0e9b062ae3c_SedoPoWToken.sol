...
contract SedoPoWToken is ERC20Interface, Owned {
    ...
    uint public  _MINIMUM_TARGET = 2**16;
     ...
     // Infernal_toast
     // Well it's 2 ^234 or something right ??
     // Try like... 2^214
     // Or 2^210
     // Because if you don't , it will take a loong time before mining diff hits equilibrium with GPUs
     // You mught even want it smaller .. test it
    ...
    function SedoPoWToken() public onlyOwner{
        ...
        miningTarget = 2**220;//_MAXIMUM_TARGET; 214
       ...
       // Mint(owner, tokensMinted, epochCount, challengeNumber);
       // Transfer(address(0), owner, tokensMinted);
        Transfer(address(this), owner, tokensMinted); //we need add it to show token transfers in the etherscan
