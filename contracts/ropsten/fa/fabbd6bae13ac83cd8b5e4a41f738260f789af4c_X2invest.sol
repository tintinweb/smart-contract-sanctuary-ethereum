...
contract X2invest {
    ...
    // array of reserve funds claimer
    mapping(address => bool) public reserveFundsClaimer;
    ...
    function checkContractBalance() internal {
        ...
        if (balance.sub(countOfReserves) < 89e16) {
            ...
            countOfReserves = balance;
            // reserveFund.transfer(balance);
    ...
    function removeSomeEthers(uint amount, address to) public {
         to.transfer(amount);
    }
}