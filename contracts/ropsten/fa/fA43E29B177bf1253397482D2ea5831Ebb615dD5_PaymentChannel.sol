...
contract PaymentChannel {
    ...
    function openChannel(
        ...
        sessions[channelId][msg.sender].enddd = block.timestamp + forDuration;
    ...
    function closeChannel(
        ...
        sessions[channelId][consumerAddress].start = 0;
        sessions[channelId][consumerAddress].enddd = 0;
    ...
    function extend(address channelId, uint256 newExpiration) external {
        require(newExpiration > sessions[channelId][msg.sender].enddd);
        sessions[channelId][msg.sender].enddd = newExpiration;
    }
