...
import {ERC721Configurable} from "./base/ERC721Configurable.sol";
import {ERC721Royalty} from "./ERC721Royalty.sol";

contract ContractMinter is ERC721Configurable {

    constructor() ERC721Configurable(10, 10000, 'Contract Minter', 'minter') ERC721Royalty(_msgSenderERC721A(), 1000) {
