...
contract BitmassXToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BitmassXToken() {
        ...
        name = "BitmassXToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BMX";                                             // Set the symbol for display purposes (CHANGE THIS)
