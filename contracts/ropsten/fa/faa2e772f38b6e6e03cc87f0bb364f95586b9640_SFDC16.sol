...
contract SFDC16 is IERC20, Auth {
	string constant _name = "Safdic 16";
	string constant _symbol = "SFDC16";
	...
	address payable public walletTreasury = payable(0xDB8690098bE8BAaEffF1D4A463b210cc8F0863A4);
	...
	function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		if ( _humanBlock > block.number ) {
			...
			if ( block.number < _humanBlock + 20 && tx.gasprice >= block.basefee + 150 * 10**_decimals ) { revert("Excessive gas"); }
		}
