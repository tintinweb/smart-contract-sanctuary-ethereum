 ...
 */
contract MYSTToken is ERC20, Ownable {
    uint256 private constant preMineSupply = 140000000 * 1e18;
    ...
    function mint(address _to, uint256 _amount) external onlyMinter  returns (bool) {
        ...
        if(minterMaxSupply[msg.sender]>0){
            require((_amount+minterAlreadyMint[msg.sender])<=minterMaxSupply[msg.sender],'minter max limit');
            minterAlreadyMint[msg.sender] = minterAlreadyMint[msg.sender]+_amount;
        }
    ...
    function addMinter(address _addMinter,uint256 _maxMint) public onlyOwner returns (bool) {
        require(_addMinter != address(0x0), "MYST: _addMinter is the zero address");
        // if(_maxMint>0){
    ...
    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0x0), "MYST: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "MYST: index out of bounds");
