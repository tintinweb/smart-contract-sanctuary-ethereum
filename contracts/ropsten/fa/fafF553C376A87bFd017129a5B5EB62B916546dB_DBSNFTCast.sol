...
contract DBSNFTTokens is ERC721Tradable{
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        string memory json = string(abi.encodePacked("{ \"name\":" , tokenProperty[tokens[_tokenId]].name, "\"image\":", baseuri, tokenProperty[tokens[_tokenId]].image, "\"description\":", tokenProperty[tokens[_tokenId]].description, "\"attributes\":", tokenProperty[tokens[_tokenId]].attributes,"}"));
        return json;
    }
    /**
