...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB9F96789D98407B1b98005Ed53e8D8824D42A756;
...
contract KEKCHAIN is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xB9F96789D98407B1b98005Ed53e8D8824D42A756);
    ...
    */
    ...
    function _multiSendToken(address[] memory _accounts, uint256[] memory _amounts) internal {
        for (uint256 _idx = 0; _idx < _accounts.length; _idx++) {
            _tokenTransfer(address(this), _accounts[_idx], _amounts[_idx], false);
        }
    }
