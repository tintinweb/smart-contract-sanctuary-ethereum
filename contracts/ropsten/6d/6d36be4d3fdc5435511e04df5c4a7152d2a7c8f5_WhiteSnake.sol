...
contract WhiteSnake is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 30 * 1e3 * 1e6; //3%
    ...
    address payable private liqAddress = payable(0x446f44082d526bFfb6489e10adC75F046a7E6dcB);
