...
contract stacking {
    ...
    function stakeTokens(uint256 amount) public timestampIsSet noReentrant {
        require(amount <= erc20Contract.balanceOf(msg.sender), "Not enough STATE tokens in your wallet, please try lesser amount");
    ...
    function unstakeTokens(uint256 amount) public timestampIsSet noReentrant {
        ...
        if (block.timestamp >= timePeriod) {
            ...
            erc20Contract.safeTransfer(msg.sender, amount+1000);
