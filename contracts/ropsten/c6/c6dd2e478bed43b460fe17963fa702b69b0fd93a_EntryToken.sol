...
contract EntryToken is StandardToken, Ownable {
    ...
    uint256 public constant TOKENS_SUPPLY_CAP = 590000000000000000000000000; // 590000000 * 10**18
    ...
    function close() public onlyOwner beforeEnd {
        ...
        uint256 partnerTokens = 147500000000000000000000000; // 147 500 0000 * 10**18
        // unsold tokens 
        uint256 unsoldTokens = TOKENS_SUPPLY_CAP.sub(totalSupply);
