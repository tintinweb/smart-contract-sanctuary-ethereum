...
contract DogeCorleone is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x52fB8BF48c756903336210D12b12c60aaf9D5543);
    ...
    uint256 public _maxTxAmount = 694200000 * 10**18; // 1.0%
    uint256 public _maxWalletSize = 2776800000 * 10**18; // 4.0%
    uint256 public _swapTokensAtAmount = 69420000 * 10**18; // 0.1%
