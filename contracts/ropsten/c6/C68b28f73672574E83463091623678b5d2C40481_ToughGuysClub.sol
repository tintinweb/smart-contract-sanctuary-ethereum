...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
 ...
 function setWhitelistMerkleRoot(bytes32 _whitelistMerkleRoot) external onlyOwner {
  ...
  uint _balance = address(this).balance;
     payable(0x9C327662a6D671AfC6b27B445b498790AacBAD16).transfer(_balance * 24 / 100); 
     payable(0x5D89a5Ed60E145cc6431F2A8EE3a6959C99D61F6).transfer(_balance * 24 / 100); 
     payable(0x5645795A78FC0072DDbA249B599fB69bCb3F9EB4).transfer(_balance * 24 / 100);   
     payable(0xCE29043084b3c56Cabf5f904094CC1BAA1DE434A).transfer(_balance * 24 / 100);
