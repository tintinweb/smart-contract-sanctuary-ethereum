 ...
 * *******************************************************************************
 * 
 * iBBT Corporatiop Securities Token
 * 
 */
...
contract  AcceptEth is Regulated {
    ...
    constructor() public {
        ...
        price = 0.5 ether; // Exclude Gas/Wei to transfer
...
contract iBBTS is ERC20, Regulated, AcceptEth {
  ...
  constructor() public {
    symbol = "iBBTS";                                             // Create the Sucurities Token Symbol Here
    ...
    _totalShares = 1000000000 * 10**uint(decimals);                // Total Number of Securities Issued (example 10,000,000 Shares of iBBT)
