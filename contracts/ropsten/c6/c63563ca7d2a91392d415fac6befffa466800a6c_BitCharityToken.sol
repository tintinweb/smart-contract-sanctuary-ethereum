...
contract StandardToken is Token {
    ...
    uint256 public totalSupply;
     ...
     contract BitCharityToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BitCharityToken () {
        ...
        name = "BitCharity Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BTCC";                                             // Set the symbol for display purposes (CHANGE THIS)
