  ...
  function hasEnded() public constant returns (bool) {
    ...
    **/
    ...
    function resumeCrowdsale() public onlyOwner {
      ...
      **/ 
     function getUsersAwaitingForTokensTop150() public onlyOwner constant returns (address[150])  {
      ...
      * this function would work in read mode
      **/
      function getUnapprovedUsersTop150() public onlyOwner constant returns (address[150]) 
      {
      ...
      **/
      function getAllUsers() public onlyOwner constant returns (address[]) 
      {
          return allUsers;
      } 
