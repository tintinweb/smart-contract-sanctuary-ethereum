...
contract PeaceAngelToken is StarndardToken {
    ...
    /**
     * @dev Allow define a address act like distribuitor even when token is block.
     * @param _issuer address of the account to act like distribuitor.
     * @param _value uint256 Amount of token that the issuer can deliver.
     **/
