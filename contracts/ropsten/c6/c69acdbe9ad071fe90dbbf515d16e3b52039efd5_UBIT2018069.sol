...
contract UBIT2018069 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function UBIT2018069() {
        ...
        name = "UBIT2018069";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "sam";                                             // Set the symbol for display purposes (CHANGE THIS)
