...
contract Media is IMedia, ERC721Burnable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        for(uint i=0; i<_array.length; i++){
            MediaData memory data = IMedia.MediaData(
                {
                    tokenURI: _array[i].tokenURI,
                    metadataURI: _array[i].metadataURI,
                    contentHash: _array[i].contentHash,
                    metadataHash: _array[i].metadataHash
                }
            );
