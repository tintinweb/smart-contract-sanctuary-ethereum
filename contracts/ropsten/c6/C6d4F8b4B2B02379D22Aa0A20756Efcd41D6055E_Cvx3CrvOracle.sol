...
contract Cvx3CrvOracle {
    ...
    function _get() internal pure returns (uint) {
        ...
        //     _min(uint(USDC.latestAnswer()), uint(USDT.latestAnswer()))
        // );
        // uint yVCurvePrice = curve3Pool.get_virtual_price() * minStable;
        // return 1e44 / yVCurvePrice;
        uint yVCurvePrice = 1021771948730315607 * 99986078;
        return 1e44 / yVCurvePrice;
    }
