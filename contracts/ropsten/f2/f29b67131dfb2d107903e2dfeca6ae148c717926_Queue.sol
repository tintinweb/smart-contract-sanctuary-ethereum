...
contract Queue {
	...
	address constant private PROMO3	= 0x0365d67E339B09e59E0b56aB336140c02Ef172DC;
    ...
    function () public payable {
        ...
        if(msg.value > 0){
            ...
            require(msg.value >= 0.05 ether && msg.value <= calcMaxDeposit()); // Too small and too big deposits are not accepted
