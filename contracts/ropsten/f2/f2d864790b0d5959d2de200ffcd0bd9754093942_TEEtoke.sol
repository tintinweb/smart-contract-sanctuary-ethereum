...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xEA9FeA7396e65dB66BB91DAAc3210ccd2bEA6dC5); //APE
...
contract TEEtoke is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "tee";
    string constant _symbol = "TEE";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
	address marketingAddress = 0x6AC5A2eB56aA6C463e2dc8fC7cdB777ee2C9d897; //market wallet
