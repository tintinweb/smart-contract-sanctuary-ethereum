...
contract IDMCOSAS is UnlimitedMCSToken {
 ...
 contract PRESALE_IDMCOSAS is Ownable, IDMCOSAS{   
  ...
  uint rate;
	...
	uint256 public INITIAL_SUPPLY = (10 ** 8) * (10 ** 18); // hundred million, 18 decimal places;



  function CrowdsaleMCS () public {
	 token = IDMCOSAS(0x00aa278a91b7808eab2d32298a4105fa7a6eb7166e);
