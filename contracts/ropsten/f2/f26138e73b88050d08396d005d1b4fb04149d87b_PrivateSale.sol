...
contract PrivateSale is Ownable, ReentrancyGuard {
    ...
    uint256 public startTime = 1650758400;
    ...
    address public fundTarget = 0x990274340B9c0B19bBc929247a68E869D555dEa2;
    ...
    modifier afterClosed() {
        require(block.timestamp > startTime + period, "Private sale is open now.");
        _;
    }
    ...
    function buy(address token, uint8 slotIndex) public nonReentrant {
        ...
        require(block.timestamp <= startTime + period, "Private Sale is closed.");
        ...
        uint256 stabl3Amount = slotPrice[slotIndex] * 10 ** 6 * 1000 / tokenPrice;
