...
contract DappTokenCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale, TimedCrowdsale, FinalizableCrowdsale {
    ...
    bool public withinPrivateICO;
    bool public withinPreICO;
    bool public withinPublicICO; 
    bool public enoughPurchase;
    bool public withinTokenCap;
    ...
    */
    ...
    function setCrowdsaleStage(uint value) public onlyOwner {
      ...
      if (stage == CrowdsaleStage.PrivateICO) {
        setCurrentRate(1250); // 25% Bonus
      } else if (stage == CrowdsaleStage.PreICO) {
        setCurrentRate(1150); // 15% Bonus
