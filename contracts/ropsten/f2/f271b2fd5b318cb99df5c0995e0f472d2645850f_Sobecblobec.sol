...
contract Sobecblobec is ERC721, Ownable {
    ...
    uint256 public constant MAX_MINT_PER_TX_PRESALE = 10;
    ...
    constructor() ERC721("Testtoken", "TSTTKN") {
        _tokenIds.increment();
    }

    modifier isMintable() {
        require(mintable, "Sobec: NFT cannot be minted yet.");
        _;
    }

    modifier isPreSaleMintable() {
        require(preSaleMintable, "Sobec: NFT cannot be minted yet.");
        _;
    }
    ...
    modifier isNotExceedMaxMintPerTx(uint256 amount) {
        require(
            ...
            "Sobec: Mint amount exceeds max limit per tx."
        );
        _;
    }
    ...
    modifier isNotExceedAvailableSupply(uint256 amount) {
        require(
            ...
            "Sobec: There are no more remaining NFT's to mint."
        );
        _;
    }
    ...
    modifier isPaymentSufficient(uint256 amount) {
        require(
            ...
            "Sobec: There was not enough/extra ETH transferred to mint an NFT."
        );
        _;
    }
    ...
    modifier isAllowList() {
        require(
            ...
            "Sobec: You're not on the list for the presale."
        );
        _;
    }
    ...
    function setmyshitupquavo() public onlyOwner {
        setMintable(true);
        setBatchCount(10);
        setBatchSize(50);
    }
