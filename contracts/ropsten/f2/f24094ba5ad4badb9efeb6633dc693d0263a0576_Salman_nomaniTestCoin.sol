...
contract Salman_nomaniTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Salman_nomaniTestCoin() {
        ...
        name = "Salman_nomaniTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT2018-049";                                             // Set the symbol for display purposes (CHANGE THIS)
