...
contract Web69Staking is ReentrancyGuard, Ownable {

    uint256 public UNSTAKEABLE_FEE = 9200; // How much can they Unstake? 92% AKA 8% Staking FEE
    uint256 public MINIMUM_CONTRIBUTION_AMOUNT = 0.005 ether; // Minimum Amount to Stake
    ...
    */
    ...
    function GetLifetimeContributionAmount(address a) public view returns (uint256){
      if(!StakerExists(a)){revert("This address has never contributed Web69 to the protocol");}
