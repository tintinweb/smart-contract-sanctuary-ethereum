...
contract PaperHeadMarket {
    ...
    string public standard = 'PaperHead';
    string public name;
    ...
    function PaperHeadMarket() payable {
        //        balanceOf[msg.sender] = initialSupply;              // Give the creator all initial tokens
        owner = msg.sender;
        totalSupply = 444;                        // Update total supply
        punksRemainingToAssign = totalSupply;
        name = "PaperHead";                                   // Set the name for display purposes
