...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RWRD = IERC20(0x3E3793FA163D668E2653ED669524b3a27719994c);
...
contract ETHTEST3 is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ETHTEST";
    string constant _symbol = "ETHTEST";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(1).div(1);
    uint256 public _maxBuy = 1000000;
    uint256 public _maxWalletToken = _totalSupply.mul(2).div(1);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x386Ce50D14d349E89cB918Edd2249ab49c5721Ac;
        ecosystemfeeReceiver = 0x9a111D3b994B0572eBB13Ef095f4D2d8c898AD71;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != ecosystemfeeReceiver  && recipient != autoLiquidityReceiver && recipient != burnFeeReceiver){
            ...
            require(amount  <= _maxBuy,"Transfer exceeds Max Buy");
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHDev = amountETH.mul(ecosystemfee).div(totalETHFee);

        try distributor.deposit{value: amountETHReflection}() {} catch {}
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountETHMarketing, gas: 30000}("");
        (tmpSuccess,) = payable(ecosystemfeeReceiver).call{value: amountETHDev, gas: 30000}("");
    ...
    function updateMaxBuy(uint256 newMaxBuy) public onlyOwner {
        _maxBuy = newMaxBuy * (10**9);
