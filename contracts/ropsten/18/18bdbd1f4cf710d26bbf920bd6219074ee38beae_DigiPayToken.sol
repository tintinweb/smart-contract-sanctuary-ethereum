...
contract TokenSaleKYC is Ownable {
     ...
     */
    function updateVerificationStatus(address participant, bool verificationStatus) private onlyOwner {
     ...
     * @param verificationStatus True or false
     */
    function updateVerificationStatuses(address[] participants, bool verificationStatus) private onlyOwner {
