...
contract Yacksoncoin is ERC20 {
    ...
    string public constant name = "Yacksoncoin";
    string public constant symbol = "YCK";
    ...
    function Yacksoncoin (uint256 _value, uint256 _minReq) public {
        owner = msg.sender;
        value = _value;
        minReq = _minReq;
