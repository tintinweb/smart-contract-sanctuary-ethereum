...
contract CCF {
    ...
    function QArrayPlayerOneAddress() public view returns(address[30] memory)
    {
        return PlayerOneAddress;
    }

    function QPriceOfTable() public view returns(uint[30] memory)
    {
        return PriceOfTable;
    }

    function QWinner() public view returns(uint[30] memory)
    {
        return Winner;
    }

    function QGameStarted() public view returns(bool[30] memory)
    {
        return GameStarted;
    }
    ...
    function QueryWinner(uint GameID) public view returns(uint)
    {
        return Winner[GameID];
    }

    function QueryCoinTypePlaced(uint GameID) public view returns(uint)
    {
        return CoinTypePlaced[GameID];
    }
