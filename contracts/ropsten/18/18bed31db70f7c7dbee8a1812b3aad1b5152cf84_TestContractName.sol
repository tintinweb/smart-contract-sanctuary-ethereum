...
/* Contract Main */
contract TestContractName is ERC20, Ownable {
    ...
    constructor() ERC20("TestContract", "$TCONTRACT") {
		...
		charityWallet = address(0xD38B309DDb59eb9DC05371B908D5ecB55331d40c); // set as charity wallet
        marketingWallet = address(0xD38B309DDb59eb9DC05371B908D5ecB55331d40c); // set as marketing wallet
        devWallet = address(0xD38B309DDb59eb9DC05371B908D5ecB55331d40c); // set as dev wallet
