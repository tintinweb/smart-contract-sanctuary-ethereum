...
contract MangaSociety is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 MAXIMUM_MINT_WL = 3;
    uint256 MAXIMUM_MINT_PUBLIC = 3;
    ...
    function updateMaxMintWL(uint256 _newMaxMint) public onlyOwner {
        MAXIMUM_MINT_WL = _newMaxMint;
    }

    function updateMaxMintPublic(uint256 _newMaxMint) public onlyOwner {
        MAXIMUM_MINT_PUBLIC = _newMaxMint;
    }
