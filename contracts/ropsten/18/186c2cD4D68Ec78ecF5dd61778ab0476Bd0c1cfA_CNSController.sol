...
contract CNSController {
    ...
    IBaseRegistrarImplementation internal baseRegistrar;
    ...
    constructor(
        ...
        baseRegistrar = IBaseRegistrarImplementation(baseRegistrarAddr);
     ...
     * Reclaims a name.
     */
    function changeControllerToCNS(uint256 _tokenId) public {
        console.log(address(this));
        console.log(_tokenId);
        baseRegistrar.approve(address(this), _tokenId);
        baseRegistrar.reclaim(_tokenId, address(this));
    }

    /**
     * Check ownership of a name.
     */
