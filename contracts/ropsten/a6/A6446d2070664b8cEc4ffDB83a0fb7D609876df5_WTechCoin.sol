...
contract WTechCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function WTechCoin() {
        ...
        name = "WTechCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 5;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "WTC";                                             // Set the symbol for display purposes (CHANGE THIS)
