...
// File: Orbis-balancer/contracts/rewards/StakingRewardsFactory.sol
...
contract StakingRewardsFactory is Ownable {
   ...
   constructor(address _rewardsToken,uint _stakingRewardsGenesis) onlyOwner() {
       rewardsToken=_rewardsToken;
        require(_stakingRewardsGenesis >= block.timestamp, 'StakingRewardsFactory::constructor: genesis too soon');
      stakingRewardsGenesis = _stakingRewardsGenesis;
    }

    // function SetStakingRewardGenesis(uint _stakingRewardsGenesis) public onlyOwner(){
    //   require(_stakingRewardsGenesis >= block.timestamp, 'StakingRewardsFactory::constructor: genesis too soon');
    //   stakingRewardsGenesis = _stakingRewardsGenesis;
    // }
                      //"10000","1000","10000"
