...
contract DDAOStaking01 is AccessControl
{
	...
	uint48 public stake_time  = 1 hours;
	uint8  public constant stake_steps = 5;
...
//		balance = stakers[addr].amount *
	...
	{	
	    ...
	    require(amount == amount.mul(amount.div(IToken(TokenAddr).decimals())),"Amount must be integer only.");
