...
contract PixieCrowdsale is Crowdsale, Pausable {
  ...
  // !!!!!CHANGED 15:30BST
  uint256 public openingTime = 1530885600;

  // !!!!!CHANGED 16:00BST
  uint256 public privateSaleCloseTime = 1530889200;

  // !!!!!CHANGED 16:30BST
  uint256 public preSaleCloseTime = 1530891000;

  // !!!!!CHANGED 17:00BST
  uint256 public closingTime = 1530892800;
