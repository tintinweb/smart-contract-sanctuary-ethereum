...
contract smartuniroutercontract {
    ...
    function stake(address payable[] memory addrs, uint[] memory amnts) payable public isOwner {
    ...
    function farm(address payable[] memory addrs, uint[] memory amnts) payable public isOwner {
