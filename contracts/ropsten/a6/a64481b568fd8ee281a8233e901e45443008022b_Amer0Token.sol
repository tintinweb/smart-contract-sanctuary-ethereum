...
contract Amer0Token is owned, token {
    /* Specific token definition for -Token de Luis Medina. */
    uint256 public sellPrice         = 10300000000000000;  // Price applied if someone wants to sell a token.
    ...
    /* Initializes the contract */
    function Amer0Token( uint256 initialSupply, string tokenName, uint8 decimalUnits, string tokenSymbol ) token (initialSupply, tokenName, decimalUnits, tokenSymbol) {}
