...
contract BlockStarRouter is IBlockStarRouter02, OwnableUpgradeable {
    ...
    function initialize() external initializer{
        ...
        tokenAddess = 0x95bc545EF115537796a627B6eE647e46E97Ee8C6; 
        resetDuration = 86400;
        ...
        reflectionsWallet = payable(0xdc0CF7d5Bfb8992b06109d1DF0334Eb363Cf1178);
        ...
        returns (uint256[] memory amounts)
    {
        ...
        require(amounts[amounts.length - 1] >= amountOutMin, 'BlockStarRouter: INSUFFICIENT_OUTPUT_AMOUNT');
        IWETH(WETH).deposit{value: amounts[0]}();
        assert(IWETH(WETH).transfer(BlockStarLibrary.pairFor(factory, path[0], path[1]), amounts[0]));
        _swap(amounts, path, to);
    }
