...
contract Claims  is   ERC1155Holder{
   ...
   function doMint(address  contra , bytes[] calldata signatures) public  {
...
contract  MainASJMultiClaim25{
  ...
  // address constant nftContra = address(0xc169B28d3eA128ACe729fb7E7C27f6Ec0a95f549);//ROPSTEN测试网
   ...
   function singleMint(bytes32 salt,uint countNumber,  bytes[] calldata _signature) public  {
     ...
     //duo个钱包mint
   function mulMint(bytes32 salt,  Record[] calldata records) public  {
           // bytes32 mintsalt =0x1;
