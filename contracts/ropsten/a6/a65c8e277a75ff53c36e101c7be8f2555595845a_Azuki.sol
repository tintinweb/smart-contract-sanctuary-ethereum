...
contract Azuki is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Wangshiqin", "Wangshiqin", maxBatchSize_, collectionSize_) {
  ...
  uint256 public constant AUCTION_START_PRICE = 1 ether ; // ether;
  uint256 public constant AUCTION_END_PRICE = 0.15 ether ; //ether;
