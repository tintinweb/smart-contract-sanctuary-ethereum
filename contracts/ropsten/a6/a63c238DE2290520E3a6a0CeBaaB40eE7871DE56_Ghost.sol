...
contract Ghost is Ownable, ERC721A {
    ...
    //Starting at 2 ether
    uint256 public constant DA_STARTING_PRICE = 0.01 ether;

    //Ending at 0.1 ether
    uint256 public constant DA_ENDING_PRICE = 0.001 ether;

    //Decrease by 0.05 every frequency.
    uint256 public constant DA_DECREMENT = 0.001 ether;
    ...
    address public constant FOUNDER_ADD =
        0x21F169f44597B7579eb46b84DBE3Dd85f2818D87;
    address public constant DEV_FUND =
        0xA7A8611a2D7663b3e215bB73f5fD57C9e673B2d8;
