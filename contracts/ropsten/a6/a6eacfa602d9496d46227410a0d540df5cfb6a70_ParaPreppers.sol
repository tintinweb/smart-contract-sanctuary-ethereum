...
contract ParaPreppers is ERC721A, Ownable {
    ...
    address public walletAddress = 0xD062974bAC1B9e4376Db2315ef69Bf93a6aE43A3;
    uint256 public nftPrice = 0.01 ether;
    constructor() ERC721A("Para Pro NFT", "PPN") {
    ...
    function mint(uint256 count) public onlyOwner {
            ...
            {
             transferFrom(msg.sender,address(this),i);
            }
    }

    function buy(address buyAddress, uint256 tokenId) public payable {
    require(msg.value==nftPrice);
     transferFrom(address(this),buyAddress,tokenId);
     payable(walletAddress).transfer(nftPrice/4);
     _burn(tokenId);
    }
