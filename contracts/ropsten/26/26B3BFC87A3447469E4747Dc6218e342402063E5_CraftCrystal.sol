...
contract Crystal is ERC721A, Ownable, Pausable {
    ...
    constructor() ERC721A('Crystal', 'CRL') {
        _pause();
    }
...
contract CraftCrystal is ERC721A, Ownable {
    ...
    Crystal private immutable gemContract;
    ...
    constructor(
        ...
        gemContract = Crystal(_gemAddress);
        uint256 total;
    ...
    function crafting(uint256[] calldata _gemIds) external payable {
