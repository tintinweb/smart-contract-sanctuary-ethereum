...
contract SAITAKI is Context, IERC20, Ownable {
    ...
    address private _owner = 0xaC3e3eaCbcF36BCc03D561FA0aCD591134Ca91A4; // ADD ADDRESS
    ...
    string private constant _name = "Saitaki"; // ADD PROPER NAME
    string private constant _symbol = "SAITAKI"; // ADD PROPER SYMBOL
    ...
    constructor() payable {
        _rOwned[_owner] = 210000000000; // Take 21% of total supply for team for BSC BRIDGE, CEX Listings and staking
        _rOwned[address(this)] = _rTotal.sub(_rOwned[_owner]);
        
        maxTransactionAmount = _tTotal * 4 / 1000; // 0.4% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 9 / 1000; // 0.9% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 100000; // 0.005% swap tokens amount
    ...
    function enableTrading() internal onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 720 hours;
    }
    ...
    function launch() external onlyOwner returns (bool){
        ...
        enableTrading();
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)); // ADD PROPER UNISWAP ADDRESS
        ...
        require(address(this).balance > 0, "Must have funds on contract to launch");
    ...
    function _transfer(
        ...
        require(!_blacklist[from], "Blacklisted! Contact mod");
        require(!_blacklist[to], "Blacklisted! Contact mod");
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev = ethForMarketing * 1 / 2; // 1/2 goes to dev
    ...
    function _tokenTransfer(
        ...
        require(!_blacklist[sender], "Blacklisted! Contact mod");
        require(!_blacklist[recipient], "Blacklisted! Contact mod");
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 6, "Must keep buy taxes below 6%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 6, "Must keep sell taxes below 6%");
