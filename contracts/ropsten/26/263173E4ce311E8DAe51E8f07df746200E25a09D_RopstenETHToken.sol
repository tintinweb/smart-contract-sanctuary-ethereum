...
contract RopstenETHToken is ERC20FullInterface {
    mapping(address => uint256) public balances;
    mapping(address => mapping(address => uint256)) internal allowed;
    address public owner;

    string public override name = "RopstenETHToken";
    string public override symbol = "RET";
    uint8 public override decimals = 16;
    //1,000,000 tokens
    uint256 public override totalSupply = 10000*1e18;
