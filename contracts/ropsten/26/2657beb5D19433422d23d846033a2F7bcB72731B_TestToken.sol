...
contract TestToken is IERC20, Ownable {
    ...
    string public constant name = "DDDD Dao Token";
    string public constant symbol = "DDDDDT";
    ...
    event SetPancakeswapV2Pair(address pancakeswapV2Pair);
    ...
    function toggleChargeFee() public onlyOwner {
    ...
    function setPancakeswapV2Pair(address pancakeswapV2Pair_)
        external
        onlyOwner
    {
        pancakeswapV2Pair = pancakeswapV2Pair_;
        emit SetPancakeswapV2Pair(pancakeswapV2Pair_);
    }
