...
contract ERC20 {
    ...
    //the minter address of this contract, i.e. who can mint more tokens
    ...
    /**
     * @dev Emitted when the allowance of a `spender` for an `minter` is set by
     * a call to {approve}. `value` is the new allowance.
     */
    event Approval(address indexed minter, address indexed spender, uint256 value);
    ...
    /**
     * @dev Functions using this modifier restrict the caller to only be the contract minter address (or the account operator of the minter)
     */
   modifier onlyMinter {
        require(isOperatorFor(msg.sender, minter()), "Caller is not the minter or the minter's account operator");
      _;
   }
    ...
    /**
     * @dev Changes the contract minter, i.e. who can mint new tokens
     *
     * Returns a boolean value indicating whether the operation succeeded.
     *
     * Requirements:
