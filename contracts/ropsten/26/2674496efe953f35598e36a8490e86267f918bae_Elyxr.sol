...
contract Elyxr {
    ...
    uint8 constant internal jackpotFee_ = 2; // 2% Jackpot fee on each buy and sell
    ...
    uint256 constant internal ambassadorQuota_ = 5 ether; // If ambassor quota not met, disable to open to public.
