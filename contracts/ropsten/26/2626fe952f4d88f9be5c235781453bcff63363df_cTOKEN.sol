...
/**
 * @dev Interface of cTOKEN.
 */
interface Ic is IERC20 {
...
contract cTOKEN is ERC20, Ownable {
    ...
    // THE WHITELISTS ARE GIVEN TO ARTcXX AND c UTILITY CONTRACTS
    ...
    event cMinted(address indexed _user, uint256 _amount);
    event cBurnt(address indexed _user, uint256 _amount);
