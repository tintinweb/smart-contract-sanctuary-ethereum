...
contract GenesisNFT is SafeOwnable, NFTCore, Mintable {
    ...
    //ethers.utils.keccak256(ethers.utils.formatBytes32String("reserve")
    bytes32 public constant RESERVE_SALT = 0xb6c17a2775875e9671841ef6e936b7aba2d52b6a996e621f91c6ba592d08e124;
    ...
    function reserve(address _to, uint _num, uint8 _v, bytes32 _r, bytes32 _s) external onlyMinterOrMinterSignature(keccak256(abi.encodePacked(address(this), RESERVE_SALT, _to, _num)), _v, _r, _s) {
