...
contract IDOFactory is Ownable {
    ...
    function createIDO(
        ...
        console.log('@@@@@@@@@@@');
        if(feeAmount > 0){
            console.log('calling method',feeAmount);
            ...
            console.log("feeAmount.sub(burnAmount): ", feeAmount.sub(burnAmount));

            IDao(feeToken).safeTransferFrom(
                msg.sender,
                feeWallet,
                feeAmount.sub(burnAmount)
            );
            console.log("after safeTransform");
            console.log(address(this), "address of this");
            IDao(feeToken).safeTransferFrom(msg.sender, address(this), burnAmount);
            IDao(feeToken).burn(burnAmount);
        }
