...
contract ESkillzStraightBet is Ownable {
    ...
    function SetSPGameResult(uint256 GameID, bool result) external onlyOwner{
    ...
    function SetMPGameResult(uint256 GameID, address winnerAddress) external onlyOwner{
        (uint256 amountToWinner,uint256 amountToESkillz) = getAmountsToDistribute(GameID);
