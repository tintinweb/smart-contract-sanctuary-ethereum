...
contract EigerToken is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xE006c5562cDD8B7b910055b7339Db0c1196b4353));
    address payable public _devwallet =
        payable(address(0x9cC623e27503AD07d5cEf809B3B1Fa3537a6E0F0));
    address public _exchangewallet =
        payable(address(0xcb766efc64Cc58346Af3C14ed78F1178a84Ed397));
    address _partnershipswallet =
        payable(address(0x13EC2046da85661D605c5049646e514527E33B0b));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Eiger";
    string private _symbol = "EIGER";
