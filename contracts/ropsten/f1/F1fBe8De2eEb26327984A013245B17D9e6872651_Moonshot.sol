...
contract Moonshot is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MSHOTv4";
   ...
   function setFees(uint256 newRewardFee, uint256 newLiquidityFee, uint256 newMarketingFee) external onlyOwner() {
    ...
    function setSwapAndLiquifyMaxAmountEnabledEnabled(bool _enabled) external onlyOwner {
    ...
    function setSwapAndLiquifyMaxAmountEnabled(uint256 amount) external onlyOwner {
