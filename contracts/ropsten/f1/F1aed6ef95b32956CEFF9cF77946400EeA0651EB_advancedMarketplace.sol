...
/////////////////////////////////////////////////////////////
    ...
    //custom function
    function removeListing(address nftAddress, uint256 tokenId) public onlyItemOwner(tokenId, nftAddress){
...
////////////////////////auction functions///////////////////////////////////////////////
    ...
    onlyTransferApproval(msg.sender, nftAddress) 
    {
        ...
        require(contractTokensAuction[nftAddress][tokenId], "Marketplace: an auction already exists for this token");
    ...
    function AuctionBid(address nftAddress, uint256 tokenId, uint256 bid) 
    external
    payable
    {
        ...
        require(contractAuction[nftAddress][tokenId].minimumBid >= bid, "Marketplace: a higher bid already exists for this token");
    ...
    {   
        ...
        if(auction.highestBidder != address(0)) {
            bool sent = payable(auction.highestBidder).send(auction.highestBid);                                     //need to return last bidders funds so they dont get stuck in the contract
            require(sent, "Marketplace: failed to send highest bidder their funds");
        }
