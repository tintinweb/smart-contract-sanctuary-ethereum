...
contract MockMinerTreasury is Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        // isLiquidityToken[ _MINERDAI ] = true;
        // liquidityTokens.push( _MINERDAI );
    ...
    function valueOfToken(address _token, uint256 _amount) public view returns (uint256 value_) {
        if (isReserveToken[_token]) {
            ...
            value_ = _amount.mul(10**IERC20(MINER).decimals()).div(10**IERC20(_token).decimals());
