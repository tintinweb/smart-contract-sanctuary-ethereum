...
contract Staking is Ownable{
    ...
    function init(address _cosmiteAddress, address _gemboxesAddress) public {
    ...
    function Harvest(uint256 DaysPassed, uint256 tokenID) public Initialize OnlyMember{
        ...
        //1 * 10**18 * 2
        uint256 totalHarvestGemboxes = ((totalStaking[msg.sender] / 5000) * DaysPassed)/10**18;
