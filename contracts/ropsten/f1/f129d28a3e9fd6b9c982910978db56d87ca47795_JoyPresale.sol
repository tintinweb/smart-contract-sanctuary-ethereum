...
contract JoyPresale is ContextUpgradeable, AuthorizableU {
    ...
    // Vesting Info
    VestingInfo[] public vestingList;       // 0: For early investors, 1: For advisors, 2: For teams
    ...
    // Update vesting info
    function updateVestingInfo(uint8 index, uint256 lockingDuration, uint256 vestingDuration) public onlyAuthorized {
        vestingList[index] = VestingInfo(lockingDuration, vestingDuration);
    }
