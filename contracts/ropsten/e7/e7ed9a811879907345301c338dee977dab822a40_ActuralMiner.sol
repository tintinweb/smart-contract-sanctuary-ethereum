...
contract ActuralMiner is Ownable{
    ...
    constructor() public{
        ...
        Manager = 0xe91C94Fe2c73eF0B86eCF9f15D30d18D63cdd116;
        
        ValidationInterfaceAddress = 0xC3cd4482F5A05a255286086f0c99A87908341a38;
        UserInterfaceAddress = 0x26Ae58975675f1916e50080CA64b799c3c93806c;
    ...
    function setUserList(address _userAddr) external onlyOwner() {
    ...
    function setCouponRatio(uint32 _newCouponRatio) external onlyOwner() {
    ...
    function buyAddress(address addr,bytes8 affCode,uint256 token) public onlyManager()
    //returns(uint32)
    {
        getETHUSD();
