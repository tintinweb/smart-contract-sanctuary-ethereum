...
contract Boos is ERC20, Ownable {
...
contract EBoos is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public constant maxPremintQuantity = 2;
    uint256 public constant maxMintQuantity = 2;
    uint public flag = 0;

    Boos boo;

    constructor() ERC721A("EBOOs", "EBOO") {
        collectionSize      = 8888;
        premintStartTime    = 1645444800;
        reserveSize         = 128 ;
        boo = Boos(0xc56A4d3C14aC1a702d00A0E7C2fe85F07B7b9cF3);
    }
