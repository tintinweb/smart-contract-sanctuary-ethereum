...
contract DFT is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x446F1A2c730Daf2631b9d1d13b18f44308B30142);
    ...
    address payable public buybackWallet = payable(0x13d50FFfd5AB94462135F7A589C539FF7C1BeC59);
    ...
    uint256 public swapTokensAtAmount = 10000000000000 * 10**9; //0.01%
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokenShare = contractTokenBalance.mul(_liquidityFee).div(_liquidityFee.add(_marketingFee).add(_buybackFee));
        uint256 marketingTokenShare = contractTokenBalance.mul(_marketingFee).div(_liquidityFee.add(_marketingFee).add(_buybackFee));
        ...
        swapTokensForWallets(teamTokenShare, buybackWallet);
    ...
    returns (uint256, uint256)
    {
        ...
        uint256 tTeam = tAmount.div(100).mul(_buybackFee);
