...
contract DeltaFlare is Context, ERC20, Ownable {
    ...
    constructor() ERC20 ("DeltaFlare", "HONR") {
        ...
        marketingWallet = address(0xF0509B8c51C6F0fA300DdAF86012DE2e23663C1e);
        ...
        */
        ...
        _mint(address(0x7BBAfb690B6da3FD1AE64b591478b4269315373F), 100000000 * (10**18));
    }
    ...
    function updateIsElon(address account, bool elon) public onlyOwner {
        require(_isElon[account] != elon, "DeltaFlare: Account is already the value of 'elon'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "DeltaFlare: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DeltaFlare: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "DeltaFlare: The liquidity wallet is already this address");
    ...
    function updateBuyFees(uint8 newBuyFee) public onlyOwner {
        totalBuyFees = newBuyFee;
    }
    ...
    function updateSellFees(uint8 newSellFee) public onlyOwner {
        totalSellFees = newSellFee;
    }
