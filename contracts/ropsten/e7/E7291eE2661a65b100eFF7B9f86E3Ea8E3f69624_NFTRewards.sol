...
contract NFTRewards is ReentrancyGuard, Ownable, Pausable {
    ...
    function getStakes(address user) external view {
    ...
    **/
    function calculateRewards(address staker) public view returns (uint256 rewards) {
        Staker memory staker = poolStakers[staker];
        uint256 stakedDays;
