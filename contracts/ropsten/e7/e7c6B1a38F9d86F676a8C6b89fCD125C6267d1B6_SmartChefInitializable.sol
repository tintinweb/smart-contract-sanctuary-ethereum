...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
   ...
   // uint256 public pancakeProfileThresholdPoints;
    ...
    event Deposit(address indexed user, uint256 amount,address Pooladresss);
    event EmergencyWithdraw(address indexed user, uint256 amount,address Pooladresss);
    event NewStartAndEndBlocks(uint256 startBlock, uint256 endBlock,address Pooladresss);
    event NewRewardPerBlock(uint256 rewardPerBlock,address Pooladresss);
    event NewPoolLimit(uint256 poolLimitPerUser,address Pooladresss);
    event RewardsStop(uint256 blockNumber,address Pooladresss);
    event TokenRecovery(address indexed token, uint256 amount);
    event Withdraw(address indexed user, uint256 amount,address Pooladresss);
    event Initialize(
...
address(this));
    ...
    function emergencyWithdraw() external nonReentrant {
        ...
        emit EmergencyWithdraw(msg.sender, user.amount,address(this));
    }
    ...
    function updatePoolLimitPerUser(bool _userLimit, uint256 _poolLimitPerUser) external onlyOwner {
        ...
        emit NewPoolLimit(poolLimitPerUser,address(this));
    }
    ...
    function updateRewardPerBlock(uint256 _rewardPerBlock) external onlyOwner {
        ...
        rewardPerBlock = _rewardPerBlock;
        emit NewRewardPerBlock(_rewardPerBlock,address(this));
    }
    ...
    function updateStartAndEndBlocks(uint256 _startBlock, uint256 _bonusEndBlock) external onlyOwner {
        ...
        emit NewStartAndEndBlocks(_startBlock, _bonusEndBlock,address(this));
    }
