 ...
 * {ERC721Enumerable}.
 */
contract ColdBloodedCreepz is Context, ERC721Enumerable, Ownable, ReentrancyGuard  {
    ...
    uint256 public constant RESERVED = 30;
    ...
    constructor(string memory _baseURI) ERC721("Cold Blooded Creepz", "CBC") {
        _creepzBaseURI = _baseURI;
    }

    function mintCreepz(uint256 amount) public payable nonReentrant {
        uint256 supply = totalSupply();
        require( saleIsActive, "Sale paused" );
        require( supply + amount < MAX_SUPPLY - RESERVED, "Exceeds maximum whale supply" );
