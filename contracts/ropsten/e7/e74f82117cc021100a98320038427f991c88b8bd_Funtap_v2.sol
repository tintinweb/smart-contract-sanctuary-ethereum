...
contract Funtap_v2 is BEP20Burnable {
    ...
    address coreTeam = 0x31fB83Dc60D27C9C4a58a361bc9c48e0Bcfe902B; //anh
    ...
    address staking = 0xF3E5337377EE08fA124c6eDa602348963f1B4dB6; //anh03
     ...
     */
	function getLockedAmount(address lockedAddress) private returns(uint256) {
     ...
     * @param lockedAddress The address to check.
     */
	function getAvailableBalance(address lockedAddress) public returns(uint256) {
    ...
    function getConfirmationCount(uint _txIndex)
        public view
        returns (uint _count) {
        Transaction storage transaction = transactions[_txIndex];
        _count = transaction.numConfirmations;
        return _count;
    }
