...
contract Token is StandardToken , MintableToken, CappedToken, BurnableToken, PausableToken {
    ...
    string public constant name = 'Sunda5';
    string public constant symbol = 'SUN5';
    uint8 public constant decimals = 18;

    function Token()
        public
        payable
         CappedToken(17000000000*10**uint(decimals))
    {
        
                uint premintAmount = 17000000000*10**uint(decimals);
