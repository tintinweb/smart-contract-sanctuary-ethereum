...
contract Token {
    ...
    event Approval(address indexed _owner, address indexed _spencer, uint256 _value);
}
...
contract StandardToken is Token {
    ...
    function allowance(address _owner, address _spender) constant returns (uint256 remaning) {
