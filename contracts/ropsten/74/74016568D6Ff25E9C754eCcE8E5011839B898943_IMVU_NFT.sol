...
contract IMVU_NFT is ERC721Royalty, ERC721Burnable, AccessControl {
    ...
    /// @param owner The wallet that is the owner of this minting contract
    /// @param name_ The name of this NFT collection
    /// @param symbol_ The symbol for this NFT collection
    /// @param imx is 0x5FDCCA53617f4d2b9134B29090C87D01058e27e9 for mainnet https://github.com/immutable/imx-contracts/blob/4a6dc460292ffa9a352d3043a4d9019d8f316a59/deploy/utils.ts#L1
    /// @param imvu_finance_wallet The deployment wallet
        ...
        ERC721(name_,symbol_)
    {
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, imx);
        _setupRole(DEFAULT_ADMIN_ROLE, imvu_finance_wallet);
    ...
    function mintFor(address to, uint256 quantity, bytes calldata mintingBlob) external onlyAdmin {
