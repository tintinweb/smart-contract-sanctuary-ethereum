...
contract AmpasToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SemfaxToken() {
        ...
        name = "Ampas Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AMT";                                             // Set the symbol for display purposes (CHANGE THIS)
