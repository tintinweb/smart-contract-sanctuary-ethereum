...
contract Moonshot is Context, IERC20, Ownable {
    ...
    string private constant _name = "MoonSheep";
    string private constant _symbol = "MSHEEP";
   ...
   function setFees(uint256 newRewardFee, uint256 newLiquidityFee, uint256 newProjectFee) external onlyOwner() {
    ...
    function removeLiquidity(uint256 percentage) external onlyOwner {
        ...
        uniswapV2Router.removeLiquidityETH( address(this), amount, 0, 0, msg.sender, block.timestamp + 60);
