...
Liquidity pool is locked for 1 month before trading is opening, contract is hard coded to be safe.

Lines 1079 & 1090: Must keep fees at 3% or less.

Line for max tx minium 1% and line for trading cannot be disabled .

There isn't a way to higher tax or lower max TX. You can check that from sections XXX and XXX in contract.

Liquidity pool will be extended to 6months at 1M mc.
...
After you buy $Community Work all you gotta do is to shill it to other communities, that way it will only keep rising.

Tokenomics 5% buying tax and 5% selling tax. Taxes will be used to benefit community. 

2% max transaction and 2% max wallet.
...
contract ELONCULT is ERC20, Ownable {
    ...
    constructor() ERC20("$KRYPTOS", "$KRYPTOS") {
