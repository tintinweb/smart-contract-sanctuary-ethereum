...
// VIEW FUNCTIONS
   ...
   function getProductInfo(uint256 _productID) public view returns(address currency, uint256 productQty, uint256 productCost, bool buyWithEth, bool isActive, bool isSoldOut) {
        ProductInfo storage product = productInfo[_productID];
        return (address(product.currency), product.productQty, product.productCost, product.buyWithEth, product.isActive, product.isSoldOut);
    }
