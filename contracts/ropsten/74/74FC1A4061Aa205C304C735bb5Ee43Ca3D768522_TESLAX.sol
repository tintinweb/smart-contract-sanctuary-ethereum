...
contract TESLAX is Context, IERC20, Ownable {
    ...
    string private _name = "Elon Nightmares";
    ...
    uint256 public _electricity = 4; 
    uint256 public _liquidityMarketingFee = 4;
    uint256 private _previouselectricity = _electricity;
    ...
    function removeAllFee() private {
        if(_electricity == 0 && _liquidityMarketingFee == 0) return;
        
        _previouselectricity = _electricity;
    ...
    function restoreAllFee() private {
        _electricity = _previouselectricity;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {        
        ...
        uint256 electricityToEat = amount.mul(_electricity).div(100);
        uint256 projectBoost = amount.mul(_liquidityMarketingFee).div(100);
        uint256 amountWithNoelectricity = amount.sub(electricityToEat);
        ...
        _balance[sender] = _balance[sender].sub(amountWithNoelectricity);
