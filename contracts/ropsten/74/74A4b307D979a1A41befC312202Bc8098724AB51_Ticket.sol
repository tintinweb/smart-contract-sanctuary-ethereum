...
contract Ticket is Ownable, ITicket {
    ...
    */
    ...
    function checkVerify(address user, bytes calldata _signature, uint spotId) external view returns(bool) {
        if (
            !_verify(
    ...
    */
    ...
    function claimAllowlistSpot(bytes calldata _signature, uint256 spotId)
...
interface ITicket {
   function claimAllowlistSpot(bytes calldata _signature, uint256 spotId) external;
}
