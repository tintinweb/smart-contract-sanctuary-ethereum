...
// File contracts/ApolloSafePlayMultiCurrency/ApolloSafePlayBR.sol
...
/**
 * Apollo safe play token with all functionalities except liquidity and marketing
...
contract ApolloSafePlayBR is Context, IERC20Metadata, Ownable {
    // Token parameters
    string private NAME;
    ...
    function _tokenTransfer(
        ...
        emit Transfer(sender, address(this), values.tBuyBack);
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        if (pendingToPay.buyBack > 0) {
            if (
                ...
                pendingToPay.buyBack = balanceOf(address(this));
            } else {
