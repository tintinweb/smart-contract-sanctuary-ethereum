 ...
 * @author None
 * @notice Main registry of PoolAddressesProvider of markets.
 * @dev Used for indexing purposes of protocol's markets. The id assigned to a PoolAddressesProvider refers to the
 * market it is connected with, for example with `1` for the main market and `2` for the next created.
 **/
 ...
 * @author None
 * @notice Defines the basic interface for an Pool Addresses Provider Registry.
 **/
