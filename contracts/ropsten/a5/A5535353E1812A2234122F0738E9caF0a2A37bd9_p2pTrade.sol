...
contract p2pTrade is Ownable, ReentrancyGuard {
    ...
    function fastChangeOrder(
        ...
        createOrder(order.Asset0, order.Asset1, minToBuy, ratio, newAmount0);
    }
    ...
    function cancellOrder(uint256 orderId) public {
        ...
        IBEP20(USD).safeTransfer(order.owner, order.leftAsset0);
    ...
    */
    function createOrder(
        ...
        IBEP20(Asset0).safeTransferFrom(
            msg.sender,
            address(this),
            amountAsset0
        );
    ...
    */
    ...
    function createDeal_ETH(uint256 orderId) public payable nonReentrant {
        ...
        safeTransferETH(address(this), deal.amount1);
