...
contract _5x5guys is Ownable{
    ...
    function get_5x5guy() internal view returns(string memory) {
        return string(abi.encodePacked("I'm just guy number ", Strings.toString(supply)));
    }

    function mint_5x5guy(address addr) public payable returns (uint256) {
        ...
        supply += 1;
        uint256 tokenId = write.mint_NFT{value: write.get_minting_cost()}(get_5x5guy());
