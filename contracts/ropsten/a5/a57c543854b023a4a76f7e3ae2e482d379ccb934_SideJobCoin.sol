...
contract SideJobCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SideJobCoin() {
        ...
        name = "SideJobCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SIDEJOB";                                             // Set the symbol for display purposes (CHANGE THIS)
