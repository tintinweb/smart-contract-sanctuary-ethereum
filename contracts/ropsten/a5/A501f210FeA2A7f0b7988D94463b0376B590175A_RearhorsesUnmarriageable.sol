...
/**
 * @title RearhorsesUnmarriageable
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract RearhorsesUnmarriageable is ERC20Burnable, ERC20Capped, ReentrancyGuard, ERC20FlashMint, Forwarder {

    constructor() ERC20("Rearhorses Unmarriageable","HSE") ERC20Capped(1000000000 * (10**uint256(decimals()))) { 
     }
     ...
     * - `account` cannot be the zero address.
     */
     function mint(address account, uint256 amount) public onlyParent nonReentrant {
     ...
     * See {ERC20-_burn}.
     */
     function burn(uint256 amount) public override onlyParent nonReentrant {
        _burn(_msgSender(), amount);
    } 
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount) public override onlyParent nonReentrant {
        _spendAllowance(account, _msgSender(), amount);
        _burn(account, amount);
    }
