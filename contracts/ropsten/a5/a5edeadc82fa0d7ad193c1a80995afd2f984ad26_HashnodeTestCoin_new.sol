...
contract HashnodeTestCoin_new is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTestCoin_new() {
        ...
        name = "HashnodeTestCoin_new";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "HTCNN";                                             // Set the symbol for display purposes (CHANGE THIS)
