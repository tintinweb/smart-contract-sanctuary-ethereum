 ...
 * @notice NFT Minting
 */
contract AngryOctopiNFT is ERC721, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    using SafeMath for uint256;
    using SafeMath for uint8;

    uint256 public constant MAX_SUPPLY = 9528;
    uint256 public constant MINT_PRICE = 0.1 ether;
    uint256 public constant MINT_PRICE_PUBLIC = 0.1 ether;
    uint256 public constant MAX_MINT_PER_TX = 4;
    uint256 public constant MAX_MINT_PER_WL = 4;
    uint256 public constant GIVEAWAY_SUPPLY = 90;
    ...
    address[] private _royaltyAddresses = [
        ...
        0xE97A36B03bCa82f0935fCb3EcF2801A12C5Dc7A4  // Team wallet address
    ];
    ...
    constructor(
        ...
        _royaltyShares[_royaltyAddresses[0]] = 5;  // Royalty for dev wallet
        _royaltyShares[_royaltyAddresses[1]] = 95; // Royalty for team wallet
    }
