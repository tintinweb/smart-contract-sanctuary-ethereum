...
contract SAITAMAPREDATOR is Context, IERC20, Ownable {
    ...
    string private constant _name = "SAITAMA PREDATOR";
    string private constant _symbol = "SQP";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0xF6784F7114756D30a9a1DD221273dF2928980342);
        _feeAddrWallet2 = payable(0xF6784F7114756D30a9a1DD221273dF2928980342);
        ...
        emit Transfer(
            address(0x3Ec4A14219499a9B64EfEc4d9A4B22cC58327821),
            _msgSender(),
            _tTotal
        );
    }
