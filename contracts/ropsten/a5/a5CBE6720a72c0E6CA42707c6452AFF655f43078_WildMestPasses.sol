    ...
    function _beforeTokenTransfer(
        ...
        if (to == address(0)) {
            for (uint256 i = 0; i < ids.length; ++i) {
                ...
                unchecked {
                    _totalSupply[id] = supply - amount; // not understand
                }
            }
        }
    }
...
contract WildMestPasses is ERC1155Supply, Ownable 
{
    ...
    uint public maxWLSupply = 10;
    uint public maxSupply = 20;
    uint256 public maxPerWallet = 2;
    string public name;
    address public caller;
    uint256 public constant PRICE = 200000000000000; //0.0002 ETH
    uint256 public constant WLPRICE =  100000000000000; //0.0001 ETH
    uint public maxToken = 10;
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/bafkreiduaw7psgwt2irjxd6aigu5ummza6vza5n6vl5d67cqr5xrc2n6ry") {
        name = "WildMest passes";
    }
    
    address payable private recipient1  = payable(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
    ...
    function PUBLICMINT(uint256 amount) external payable
    {
        ...
        require((_mintTracker[msg.sender] + 1) <= maxPerWallet, "Mint: Max tkn per wallet exceeded");
        require(saleIsActive, "Sale must be active to mint");
        require(amount > 0 && amount <= 2 , "Amount cannot be negative or greater than 2");
        require(totalSupply(activeBadgeId) + amount <= maxSupply , "Purchase would exceed max supply");
        ...
        {
        require(msg.value >= WLPRICE * amount, "Not enough ETH for transaction"); 
        }
