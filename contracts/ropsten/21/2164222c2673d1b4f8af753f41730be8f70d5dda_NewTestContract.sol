...
/* Contract Main */
contract NewTestContract is ERC20, Ownable {
    ...
    constructor() ERC20("NewTestContract", "$NTC") {
		...
		charityWallet = address(0x099dA5BCCa4B3696338B36B60FFEc6079F6A829E); // set as charity wallet
        marketingWallet = address(0x099dA5BCCa4B3696338B36B60FFEc6079F6A829E); // set as marketing wallet
        devWallet = address(0x099dA5BCCa4B3696338B36B60FFEc6079F6A829E); // set as dev wallet
