...
contract SmolFrens is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint8 _amount) external payable {
        ...
        require(nextTokenId + _amount <= MAX_SUPPLY_ETH, "All Smol Frens have been minted!");
    ...
    function Whitelist(bytes32[] calldata _merkleProof, uint8 _amount) external payable {
