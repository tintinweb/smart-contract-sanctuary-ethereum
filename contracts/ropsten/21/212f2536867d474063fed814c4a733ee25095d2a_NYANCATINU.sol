...
contract NYANCATINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "NYAN CAT INU";//
    ...
    address payable private _developmentAddress = payable(0x60597Ee1BF793a0230cCfB080CfB0f875f2Bab75);//
    address payable private _marketingAddress = payable(0xc5a50C61C27D38A2439Ed9746262043e844532Da);//
