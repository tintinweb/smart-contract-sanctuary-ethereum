...
contract SaburaiToken is Context, IERC20, Ownable {
    ...
    address payable public maintainanceAddress = payable(0x63db38289750A3F5f909c76D6B3cC3bF9676DEd8); // Maintainance Address
    address payable public developmentAddress  = payable(0x63db38289750A3F5f909c76D6B3cC3bF9676DEd8); // Development Address
    address payable public marketingAddress    = payable(0x63db38289750A3F5f909c76D6B3cC3bF9676DEd8); // Marketing Address

    string private _name = "SaburaiToken"; //token name
    string private _symbol = "SaburaiToken"; // token symbol
    ...
    uint256 public marketingFee = 120; // marketing fee 12%
