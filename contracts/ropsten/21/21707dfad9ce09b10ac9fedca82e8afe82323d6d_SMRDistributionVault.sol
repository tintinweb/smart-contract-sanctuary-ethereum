...
// This contract can be used and a Holding Trust for Securities Tokens 
// The service can be offered by IBBT's Trust Division
// 
...
contract SMRDistributionVault is ArgumentsChecker, multiowned, ERC20 {
    ...
    {
        m_SMR = ISmartzToken(address(0xC9c34CE1c669988644a9a6E53fF5540d9ec54920)); // Replace address SwartzToken [0x40ae4acd08e65714b093bf2495fd7941aedfa231] with YST address
        m_thawTS = 1551398400;
...
result[0] = address(0x43dad1525f65f86410bc6f740be980a4de485f2e); // replace prev owner [x4ff9a68a832398c6b013633bb5682595ebb7b92e] with YST owner [0x43dad1525f65f86410bc6f740be980a4de485f2e]
//result[1] = address(0x43dad1525f65f86410bc6f740be980a4de485f2e);
        return result;
    }
