...
contract newtest3 is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x0F769546cd7F84F8E57A4ABD724B51e8a4e66499));
    address payable public _devwallet =
        payable(address(0x3142872D7EBFc5b889E391C1385D65283f85A395));
    address public _exchangewallet =
        payable(address(0x3142872D7EBFc5b889E391C1385D65283f85A395));
    address private _donationAddress =
        payable(address(0x3142872D7EBFc5b889E391C1385D65283f85A395));

    string private _name = "new test 3";
    string private _symbol = "NEWTEST3";
