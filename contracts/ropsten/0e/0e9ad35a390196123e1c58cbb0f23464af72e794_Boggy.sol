...
// File: contracts/ooga.sol

pragma solidity >=0.7.0 <0.9.0;



contract Boggy is ERC721, Ownable {
    using Strings for uint256;
    ...
    // Used to permanently lock the total supply
    bool public totalSupplyLocked = false;
    ...
    mapping(address => uint256) public whitelistedMinters;
    ...
    constructor() ERC721("Boggy", "BOGGY") { }
    ...
    function mintTokens(uint256 _amount) public payable {
        uint256 unminted = whitelistedMinters[msg.sender];
        ...
        whitelistedMinters[msg.sender] = unminted - _amount;
    ...
    function whitelistUsers(address[] memory addresses) public onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
            whitelistedMinters[addresses[i]] = MAX_MINT_QUANTITY;
        }
    }

    // PUBLIC VIEWS

    // Get minting allocation of address
    function mintingAllocation(address _user) public view returns (uint256) {
        return whitelistedMinters[_user];
    }
