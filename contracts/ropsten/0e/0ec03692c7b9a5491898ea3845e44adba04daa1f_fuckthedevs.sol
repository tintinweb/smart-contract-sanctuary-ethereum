...
contract fuckthedevs is ERC20, Ownable {
    ...
    function swapBack() private {
        ...
        // Halfe the amount of liquidity tokens
    ...
    function ActivateMarket(bool status ,uint256 _blocknumbers) external onlyOwner{    
        require(!tradingActive, "Trading is already active, cannot activate Market Again.");
        require(_blocknumbers <= 10,"deadblocks can't be more than 10 blocks");
        tradingActive = true;
        swapEnabled = true;
