...
KASUKU LABS
Website: www.kasukulabs.com
Email: [email protected]
Twitter: @kasukulabs
Telegram:https://t.me/KasukuLabs


Kasuku is an ERC20 token.
Kasuku Labs is working on a platform for DYOR for especially new Defi investors. 
Most of us have fallen victim to this. You find a new token, looks promising.
Your influencer and social media pages are all telling you, "IT'S A GREAT TOKEN BUT... DYOR!!"
But how DO YOU DO YOUR OWN RESEARCH!!! Where do you start? 
We all have been in this position at some point and we hope Kasuku will be able
to make things easier for crypto-investors soon.

Kasuku DYOR platform will be able to give you, a clearer assessment of a token before making that trade. 
You will be able to tell if its a honeypot, renounced contract, have social media handles, dev wallets, malicious contract,
KYC'd devs/company, liquidity status, top wallets, presales etc Kasuku shall consolidate these features under one platform. 
All you will need then is your Kasuku Token to access some features on our platform.
We hope you join us on this Kasuku journey. More to come!!:-)


Tokenomic:
Total Supply: 22,300,000 Kasuku tokens (100%)
Social Promotions: 223,000 Kasuku tokens(1%)
Uniswap Liquidity: 22,0077,000 Kasuku tokens (99%)
liquidity locked: 30days
Max Supply per Wallet: 223,000 Kasuku tokens (1%)

Taxes: 
BUY 5% (2% liquidity, 2% marketing & partnerships, 1% charity)
SELL 10% (4% Liquidity, 4% marketing & partnerships, 2% charity)

Wallets:
Marketing Wallet: 0x603a808A465946Fe61Cb9D60e0246113405FDfEA
Charity: 0xb49F4b01d3800FB26826D59cb17235E63198b805
Partnerships: 0xa7599d4aa0CB718f28f4438a10e2380a9C830859

Partnerships:
Check Telegram and Twitter for updates.


Charity:
We have engaged two organizations focused on girl-child education and social welfare.
There are parts of the world where young girls miss every month, at least a week of school, due to her monthly menses.
Sanitary pads are an essential part of a young woman's growing life, but unfortunately not all have access to this essential. 
And sadly, this is the reality in many parts of remote Africa. 
Kasuku Labs will donate 1%(buy) and 2% (sell)of all transactions to help ease this problem by working through our vetted two organizations.
More to come!!! Check Telegram and Twitter for the latest updates.

Thank for investing with us!
...
contract KASUKU is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 22300000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x603a808A465946Fe61Cb9D60e0246113405FDfEA));
    address payable public _teamwallet =
        payable(address(0xb49F4b01d3800FB26826D59cb17235E63198b805));
    address _partnershipswallet =
        payable(address(0xa7599d4aa0CB718f28f4438a10e2380a9C830859));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "KASUKU";
    string private _symbol = "KASUKU";
    ...
    uint256 public _maxTxAmount = 22300000  * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 22077000 * 10**9;
    uint256 public _maxWalletSize = 223000 * 10**9;
    ...
    function kasuku() public onlyOwner {
