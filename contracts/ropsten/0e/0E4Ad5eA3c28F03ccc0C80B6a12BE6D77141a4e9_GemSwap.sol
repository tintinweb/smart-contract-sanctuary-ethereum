...
contract GemSwap is SpecialTransferHelper, Ownable, ReentrancyGuard {
        ...
        internal
    {
        ...
        for (uint256 i = 0; i < _tradeDetails.length; i++) {
            ...
            if (
                ...
                console.log("O proxy eh", _proxy);
                console.log("Is lib?", _isLib);
                ...
                console.log("Passou daqui man", success);
                // check if the call passed successfully
                _checkCallResult(success);
    ...
    function batchBuyWithETH(MarketRegistry.TradeDetails[] memory tradeDetails)
        ...
        nonReentrant
    {
        console.log("Chegou no buy with eth");
        // execute trades
        _trade(tradeDetails);
