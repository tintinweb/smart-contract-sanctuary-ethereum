...
contract FckDice {
    ...
    function settleBetUncleMerkleProof(bytes20 reveal1, bytes20 reveal2, uint40 canonicalBlockNumber) external onlyCroupier {
        ...
        settleBetCommon(bet, reveal1, reveal2, uncleHash);
    }
