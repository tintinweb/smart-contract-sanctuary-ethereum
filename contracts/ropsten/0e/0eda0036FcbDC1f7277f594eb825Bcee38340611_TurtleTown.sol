...
contract TurtleTown is ERC721A, Ownable, PaymentSplitter {
    ...
    bool public openWhitelistMint = true;
    bool public openPresaleMint = true;
    ...
    function whitelistMint(bytes32[] calldata _merkleProof) public payable {
        ...
        require(openWhitelistMint, "mint not open");
        require(
        ...
        whitelistSafeMint(msg.sender, 1);
    }
    ...
    function whitelistSafeMint(address to, uint256 quantity) internal {
