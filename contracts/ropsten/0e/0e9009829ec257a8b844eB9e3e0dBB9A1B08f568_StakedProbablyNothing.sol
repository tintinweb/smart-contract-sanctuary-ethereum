...
contract StakedProbablyNothing is Ownable, ERC20Burnable {
   ...
   event RemoveStake(address indexed _addr, uint _baseTokenValue, uint _stakedTokenValue);
     ...
     */
    function setupStakingPeriod(uint256 rewardsPerEpoch_, uint numEpochs_) public onlyOwner {
    ...
    /** @notice set the length of a vesting period in seconds
     *  @param numSeconds the length in seconds
     */
