    ...
    ReentrancyGuard
{
    ...
    */
    ...
    function T(uint256 amount0Desired, uint256 amount1Desired) external view returns (uint128 liquidityTotal, uint128 liquidityDeposit, uint256 depositAmount0, uint256 depositAmount1) {
        liquidityDeposit = _liquidityForAmounts(baseLower, baseUpper, amount0Desired, amount1Desired);
        (depositAmount0, depositAmount1) = _amountsForLiquidity(baseLower, baseUpper, liquidityDeposit);
        //adding one penny due to loss during conversion 
        (depositAmount0, depositAmount1) = (depositAmount0.add(1), depositAmount1.add(1));
    ...
    function T2(uint256 amount0Desired, uint256 amount1Desired) external view returns ( uint128 liquidityDeposit, uint256 depositAmount0, uint256 depositAmount1,  uint256 amount0,  uint256 amount1) {
        liquidityDeposit = _liquidityForAmounts(baseLower, baseUpper, amount0Desired, amount1Desired);
        (depositAmount0, depositAmount1) = _amountsForLiquidity(baseLower, baseUpper, liquidityDeposit);
        //adding one penny due to loss during conversion 
        (depositAmount0, depositAmount1) = (depositAmount0.add(1), depositAmount1.add(1));
        ...
        uint256 oneMinusFee = uint256(1e6).sub(protocolFeeA.add(protocolFeeB));
        amount0 = getBalance0().add(depositAmount0).add(uint256(tokensOwed0).mul(oneMinusFee).div(1e6));
        amount1 = getBalance1().add(depositAmount1).add(uint256(tokensOwed1).mul(oneMinusFee).div(1e6));

        //liquidity in position add liquidity from fees and contract balance
        //liquidityTotal = liquidityInPosition + _liquidityForAmounts(baseLower, baseUpper, amount0, amount1) - liquidityDeposit;
    }
    function T3(uint256 amount0Desired, uint256 amount1Desired) external view returns (uint128 liquidityTotal, uint128 liquidityDeposit, uint256 depositAmount0, uint256 depositAmount1) {
        liquidityDeposit = _liquidityForAmounts(baseLower, baseUpper, amount0Desired, amount1Desired);
        (depositAmount0, depositAmount1) = _amountsForLiquidity(baseLower, baseUpper, liquidityDeposit);
        //adding one penny due to loss during conversion 
        (depositAmount0, depositAmount1) = (depositAmount0.add(1), depositAmount1.add(1));
        (uint128 liquidityInPosition, , , uint128 tokensOwed0, uint128 tokensOwed1) =
            ...
            liquidityTotal = liquidityInPosition;
    }
