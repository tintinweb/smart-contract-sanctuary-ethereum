...
contract PLSDSock is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public royaltyFee = 1000; // Default 1000 BP (10%)
  ...
  */
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    require(address(this).balance == 0x0, "Transfer did not transfer");

    IERC20(plsdAddress).transferFrom(address(this), owner(), IERC20(plsdAddress).balanceOf(address(this)));
    require(IERC20(plsdAddress).balanceOf(address(this)) == 0x0, "Transfer did not transfer");
