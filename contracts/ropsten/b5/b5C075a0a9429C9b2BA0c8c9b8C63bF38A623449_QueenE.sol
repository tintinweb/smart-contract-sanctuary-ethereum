...
contract QueenE is IQueenE, QueenParliament {
    ...
    modifier whenMinterNotLocked() {
        require(!isMinterLocked, "Minter locked");
    ...
    modifier whenTraitStorageNotLocked() {
        require(!isTraitStorageLocked, "Storage locked");
    ...
    modifier whenLabNotLocked() {
        require(!isLabLocked, "Lab locked");
    ...
    {
        require(_multiplier >= 1, "Invalid value");
        ...
        returns (bool)
    {
        ...
        require(!houseOfBanned.contains(_sir), "Banned Subject");
        require(!sirs.contains(_sir), "Already Sir");

        if (!sirs.contains(_sir)) {
            sirs.add(_sir);
