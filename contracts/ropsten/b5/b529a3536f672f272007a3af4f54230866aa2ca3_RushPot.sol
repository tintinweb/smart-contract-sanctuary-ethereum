...
contract RushPot is modularShort {
    ...
    PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0x1ff36772dad26f2a72040fdb91ef23288c8d3fee);
...
****************************************************************************************************************************/
   ...
   function keysRec(uint256 _curEth, uint256 _newEth)
    ...
    function keys(uint256 _eth)
        ...
        returns(uint256)
    {
        uint256 x = ((((((_eth).mul(1000000000000000000)).mul(keyConstant_)).add(5624988281256103515625000000000000000000000000000000000000000000)).sqrt()).sub(74999921875000000000000000000000)) / (156250000);
    ...
    function eth(uint256 _keys)
        ...
        returns(uint256)
    {
        uint256 x = ((78125000).mul(_keys.sq()).add(((ethConstant_).mul(_keys.mul(1000000000000000000))) / (2))) / ((1000000000000000000).sq());
