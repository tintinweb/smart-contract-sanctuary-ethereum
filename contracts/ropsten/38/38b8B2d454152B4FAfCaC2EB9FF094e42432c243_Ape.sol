...
// File contracts/tokens/Ape.sol


pragma solidity 0.8.1;
contract Ape is ERC20Burnable, Operator {
    using SafeMath for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 24h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 11000 ether;
    // Initial distribution for the Ape LP reward pools
    uint256 public constant INITIAL_APE_POOL_DISTRIBUTION = 140000 ether;
    ...
    constructor() ERC20("Ape", "Ape") {
        // Mints 1 Ape to contract creator for initial pool setup
    ...
    /**
     * @notice Operator mints Ape to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of Ape to mint to
    ...
    function distributeReward(
        ...
        require(_apePool != address(0), "!_apePool");
        require(_airdropWallet != address(0), "!_airdropWallet");
        rewardPoolDistributed = true;
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_apePool, INITIAL_APE_POOL_DISTRIBUTION);
