...
import "../contracts/StakingTokenFix.sol";

contract StakingContract {
    StakingTokenFIX private token;
    uint256 public deadline = block.timestamp + 300 seconds;
    mapping(address => uint256) public balances;

    constructor() {
        token = new StakingTokenFIX();
    }
    ...
    function withdraw(address payable depositor) public {
        ...
        token.transfer(msg.sender, userBalance + (userBalance / 100) * 5);
    }
...
contract StakingTokenFIX is ERC20 {
    constructor() ERC20("StakingTokenFIX", "XPSTF") {
