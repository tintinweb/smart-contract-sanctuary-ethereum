...
contract AipPool is IAipPool, ReentrancyGuard {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        TransferHelper.safeApprove(token0, swapManager, amount0);
        ...
        require(balance0Before - amount0 <= balance0(), "T0");
        ...
        if (token != address(0)) {
            ...
            if (currentEndTick >= currentStartTick) {
                for (uint256 i = currentStartTick; i <= currentEndTick; i++) {
                    ...
                    // console.log(
                    //     "rewardCycle.rewardAmount %s",
                    //     rewardCycle.rewardAmount
                    // );
                    // console.log("plan.tickAmount0 %s", plan.tickAmount0);
                    // console.log(
                    //     "rewardCycle.paymentAmount0 %s",
