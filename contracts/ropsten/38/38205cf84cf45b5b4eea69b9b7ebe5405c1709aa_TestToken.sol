...
contract TestToken is Context, IERC20, Ownable {
    ...
    string constant private _name = "TestToken";  // here yopu can put your token name
    string constant private _symbol = "TestToken"; //and its for symbol

    uint256 constant private _decimals = 18;

    uint256 private constant MAX = ~uint256(0);
    //its for 1 billion
    uint256 private _tTotal = 1000000000 * 10**18;  // 1 billion //put here how much supply you want
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
   
    address payable public marketingAddress = payable(0x3CbD1840722B14BA294dF4A3Ba4Da761a2460E69);  //we need to put market addres for this 

    address payable public developmentAddress = payable(0xcc55Bad18a598782e9138dE4eed459631d3d52ac); // its for dev 

// inside this line wee need to set out taxes market dev and liquidity taxes parcentage
    ...
    constructor() {
       ...
       IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);  // this one for uniswap router address
