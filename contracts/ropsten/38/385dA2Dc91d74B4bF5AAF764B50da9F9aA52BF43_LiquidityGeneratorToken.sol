...
contract LiquidityGeneratorToken is IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, BaseToken, ILiquidityGeneratorToken {
    ...
    function initialize(
        ...
        string memory symbol_,
        uint256 totalSupply_,
        address router_,//0x10ED43C718714eb63d5aA57B78B54704E256024E binance PANCAKE V2,  0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F binance PANCAKE V1, 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D Ethereum mainnet, Ropsten, Rinkeby, Görli, and Kovan
        address charityAddress_,
        uint16 taxFeeBps_,
        uint16 liquidityFeeBps_,
        uint16 charityFeeBps_,
        ...
        require(
            taxFeeBps_ + liquidityFeeBps_ + charityFeeBps_ <= maxTxBps_,//10**4 / 4,
