...
contract NFT is ERC721Enumerable,ERC721Pausable,ERC721URIStorage {
...
contract WhiteList {
    ...
    constructor(address accessControlAddress,address[] memory wallets) {
        accessControl = AccessControlContract(accessControlAddress);
