...
contract JustTestCoin is SafeMath{
    ...
    constructor() public { // Give the creator all initial tokens
        ...
        name = "JustTestCoin"; // Set the name for dis play purposes 
        symbol = "JTCoin"; // Set the symbol for d isplay purposes
        decimals = 2; // Amount of decimals f or display purposes 
        owner = msg.sender; 
    }
