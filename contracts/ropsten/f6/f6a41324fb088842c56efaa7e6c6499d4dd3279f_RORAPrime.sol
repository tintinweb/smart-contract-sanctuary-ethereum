...
contract RORAPrime is ERC20, Pausable, AccessControl {
    ...
    bytes32 private constant CONTRACT_ADMIN_ROLE = keccak256("CONTRACT_ADMIN");
    bytes32 private constant PERMISSIONS_ADMIN_ROLE = keccak256("PERMISSIONS_ADMIN");
    bytes32 private constant MINT_ADMIN_ROLE = keccak256("MINT_ADMIN");
