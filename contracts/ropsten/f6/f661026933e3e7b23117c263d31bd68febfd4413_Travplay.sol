...
contract Travplay is Context, IERC20, Ownable {
    ...
    address public DevWallet = 0x7C9b6D2A1744D391d6bDe8bb94Cf0fb933135E0B;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x39B3AA2693C12dA383ABa6A6e404f1383a914f0e);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        uint256 charityAmt = amount.mul(_marketingFee).div(100);
        ...
        _transferStandard(sender, DevWallet, charityAmt);
