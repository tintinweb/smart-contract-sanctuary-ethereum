...
FOMO is the definitaion of desperation
Desperation of being left out

join this FOMO moment
apart from all rugs
Only Safu works here
with one of the Safest and most trusted contract 
With Locked liquidy
...
contract FOMOCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("FOMOCOIN", "FOMO") {
        ...
        marketingWallet = address(0xA086cE5d01b7Fd68664b07d82D95070DfD5D43Cf); // set as marketing wallet
        devWallet = address(0xA086cE5d01b7Fd68664b07d82D95070DfD5D43Cf); // set as dev wallet
