...
/**Our aim is to unite Shiba and Saitama - a merger of the biggest coins of last year, and become a fitting rival to Shinja and more recently Shintama.
...
contract SHUKOKUINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SHUKOKUINU", "SHUKOKUINU") {
	...
	uint256 _earlySellDevFee = 4;
        ...
        maxTransactionAmount = totalSupply * 10 / 400; // 1% maxTransactionAmountTxn
        maxWallet = totalSupply * 10 / 200; // 1% maxWallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 1)/1e18, "Cannot set maxTransactionAmount lower than 0.1%");
        maxTransactionAmount = newNum * (10**18);
    }
 
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 1)/1e18, "Cannot set maxWallet lower than 0.5%");
