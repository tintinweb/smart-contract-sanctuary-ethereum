...
contract NFT is ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("MyNFT", "MNFT") {
    setBaseURI("https://gateway.genfty.com/ipfs/QmaDWavMSZcpRBcRRCmmKSybz8B8sNA6kV3MwMzZTdcgiR/");
    mint(msg.sender, 4);
  }
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x212d0e86694fd9046c24C66Aa5d11C33CA9de680).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
