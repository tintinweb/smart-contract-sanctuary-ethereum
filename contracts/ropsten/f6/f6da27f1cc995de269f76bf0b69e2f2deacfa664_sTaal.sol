...
contract sTaal is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Taal", "sTAL", 9) ERC20Permit() {
    ...
    /**
        @notice increases sTAL supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTAL
