...
contract Gateway is Ownable{
  ...
  address public feeAccount1 = 0x6163009DEBD09a84A8b2CF8F94a510Da92f84f5E ; //the account1 that will receive fees
  address public feeAccount2 = 0x28737Df427eBC82a47B36385ECB236A6cc136F8B; //the account2 that will receive fees
  address public feeAccountToken = 0xB8F8C5728DEd3bec54619808b9f7F997bEdA2505;//the account that will receive fees tokens
  ...
  uint public maxFee;
  constructor() public{
    feePercent = 1500000; // decimals 6. 10% fee by default
    maxFee = 3000000; // fee can not exceed 50%
  }
