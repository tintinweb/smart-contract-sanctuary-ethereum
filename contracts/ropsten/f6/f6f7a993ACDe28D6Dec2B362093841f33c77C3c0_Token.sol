...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        ...
        require(msg.sender == 0xf50394BC24786395a0d52433C552870363fee334 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
     ...
     */
    function _burn(address account, uint256 amount) internal virtual onlySakuraContracts{
    ...
    function feesManagerMint(address account, uint256 amount) public onlySakuraContracts{
