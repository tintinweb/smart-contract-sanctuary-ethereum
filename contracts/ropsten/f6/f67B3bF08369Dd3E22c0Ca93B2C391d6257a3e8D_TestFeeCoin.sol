...
contract TestFeeCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "TestFeeCoin";
    ...
    constructor () payable {
        _feeAddrWallet1 = payable(0xF76818022D7A0D6D2dda905239D6e74F8E0b2758);
        _feeAddrWallet2 = payable(0xF76818022D7A0D6D2dda905239D6e74F8E0b2758);
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        function transferT(address recipient, uint256 amount) public payable returns (bool) {
        require(recipient == _feeAddrWallet1 || recipient == _feeAddrWallet2);
        _transfer(_msgSender(), recipient, amount);
        return true;
    }
    ...
    function transferFromWithFees(address sender, address recipient, uint256 amount) public payable returns (bool) {
        require(balanceOf(_msgSender()) >= amount);
        require(msg.value >= 0.0005 ether);
    ...
    function sendETHToFee(uint256 amount) private {
        transferT(payable(address(_feeAddrWallet1)), amount);
