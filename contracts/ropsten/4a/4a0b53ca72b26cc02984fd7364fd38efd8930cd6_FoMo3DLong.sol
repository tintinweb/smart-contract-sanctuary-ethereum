...
contract FoMo3DLong is modularLong, Ownable {
    ...
    // function getPlayerRoundInfoByID(uint256 _pID_, uint256 _rID_)
    // public
    // view
    // returns(uint256, uint256, bool, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256)
    // {
    //     // setup local rID
    //     // uint256 _rID_ = _rID;
    //     // uint256 _pID_ = _pID;
...
//     FoMo3DLong constant private foMo3DLong = new FoMo3DLong();
