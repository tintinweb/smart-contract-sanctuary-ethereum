...
contract GB_Token_Presale is Context, ReentrancyGuard {
    ...
    uint256 public maxBuyingLimit;

    mapping(address => uint256) public buyingLimitPerAddress;
    ...
    constructor () public {
        ...
        maxBuyingLimit = 888000000000000000000;
        wallet = _msgSender();
        owner = _msgSender();
    ...
    function buyTokens(uint256 _weiAmount) public nonReentrant {
        ...
        buyingLimitPerAddress[_msgSender()] = buyingLimitPerAddress[_msgSender()] + _weiAmount;
    }
    ...
    function _preValidatePurchase(address _beneficiary, uint256 _weiAmount) internal view {
        ...
        uint256 balance = buyingLimitPerAddress[_msgSender()];
        require(balance + _weiAmount <= maxBuyingLimit, "max buying limit per address exceeded"); 
    }
    ...
    function setMaxBuyingLimit(uint256 _limit) public onlyOwner() {
        maxBuyingLimit = _limit;
    }
