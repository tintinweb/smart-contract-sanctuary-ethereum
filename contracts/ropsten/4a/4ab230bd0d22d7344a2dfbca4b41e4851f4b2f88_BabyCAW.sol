...
contract BabyCAW is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyCAW";
    ...
    uint256 public totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _buybackFee;
    ...
    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleDevFee + _saleMarketingFee + _salebuybackFee;
    ...
    {   
        ...
        uint256 walletsTotal = devTokensCollected + marketingTokensCollected + buybackTokensCollected;

        uint256 ethForMarketing = (newBalance * marketingTokensCollected)/walletsTotal;
        uint256 ethForbuyback = (newBalance * buybackTokensCollected)/walletsTotal;
    ...
    function restoreAllFee() private {
        ...
        totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _buybackFee;
    }
    ...
    external onlyOwner() 
    {
        ...
        totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleDevFee + _saleMarketingFee + _salebuybackFee;
