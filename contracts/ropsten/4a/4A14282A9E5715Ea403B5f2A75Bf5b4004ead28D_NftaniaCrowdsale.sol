...
contract NftaniaCrowdsale is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// intializeAddresses //////////////////////////////////////     
    ...
    function intilizeAddresses ()
        public onlyOwner{  
        tokenAddress = 0xDCFF3ad5FBd5d4b5a9Cf0b4671ED6D500739e0d6;  
        LiquidityPoolLocker =0xf38A660b42C86b71a5707760f85d2A3f0fA8ba2A;
        NftaniaAddLiquidity = payable (address(0x304744C441561445cDEf18c7ee8C804FA926Ee31));
