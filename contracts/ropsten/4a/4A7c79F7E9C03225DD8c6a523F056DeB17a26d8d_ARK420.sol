...
contract ARK420 is IERC20, Ownable, Pausable {
    ...
    uint public constant vestingFoundationReleaseStart = 1645459835 + 1 hours; // 00:00:00 22 January 2022 GMT+00:00 + 2 Months 2022 GMT+00:00 1642809600
    ...
    uint public constant stakingContractRelease = 1645459835 + 3 hours; // 00:00:00 20 April 2022 GMT+00:00 1650412800
    ...
    uint public constant liquidityContractRelease = 1645459835 + 3 hours; // 00:00:00 20 April 2022 GMT+00:00 1650412800
    ...
    uint public constant exchangeListingContractRelease = 1645459835 + 3 hours; // 00:00:00 20 April 2022 GMT+00:00 1650412800
    ...
    uint public constant advisorsAndTeamContractRelease = 1645459835 + 2 hours; // 00:00:00 22 January 2022 GMT+00:00 + 2 Weeks 1642809600
    ...
    function vestPurchase(address user, uint amount) external {
        ...
        _vest(user, amount, 1, block.timestamp + 10 minutes, block.timestamp + 10 minutes + vestingSaleSecondPeriod);
    }
