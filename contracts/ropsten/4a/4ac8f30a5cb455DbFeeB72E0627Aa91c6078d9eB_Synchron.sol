...
contract Synchron is ISynchron,ERC1155Holder{
    ...
    function cancelBidding(uint256 orderId,uint256 offerId) public override OnlySync{
        ...
        if(offerIndex[offerId] == offerInfo[orderId].length.sub(1) || offId == 0){  
            if(offId > 0){
...
//ropsten
//token721:0xE922b35ea58C42C64Dde704E270f0Fdd64AA1BFB
//token155:0x48882fDD74cE82c0C9D9e567a814862EE9dc5Ccb
//data:0x4ac8f30a5cb455DbFeeB72E0627Aa91c6078d9eB
//trading:0x6E38826Fe7af5AD4A70dF2428c0888Fc20349fBb
