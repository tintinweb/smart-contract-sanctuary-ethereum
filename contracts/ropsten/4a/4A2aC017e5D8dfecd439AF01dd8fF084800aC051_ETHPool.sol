...
contract ETHPool is AccessControl {
    ...
    function calculateReward(address _sender) public view returns (uint256) {
        ...
        uint256 withdrawRewardAmount;
            ...
            withdrawRewardAmount = userInfos[_sender].amount * rewardsPerToken / 100;

            return withdrawRewardAmount + userInfos[_sender].amount;
    ...
    function withdrawAmount(uint256 amount) public OnlyAdmin {
        ...
        address payable from = payable(address(this));
