...
/**
 ___ ___ _ __ __  __   __ _ __  _ ___    ___ __  _ __  _  
| _ \ __| |  V  |/  \ / _] |  \| | __|  / _//__\| |  \| | 
| v / _|| | \_/ | /\ | [/\ | | ' | _|  | \_| \/ | | | ' | 
|_|_\___|_|_| |_|_||_|\__/_|_|\__|___|  \__/\__/|_|_|\__| 
...
contract ReimagineCoin is Context, IBEP20, Ownable {
    ...
    address public MarketingWallet = 0x8E3Ca3B2D1b2a719bfa56C684A3e431Ae9515f46;
    address public CharityWallet = 0x8E3Ca3B2D1b2a719bfa56C684A3e431Ae9515f46;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10**9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Reimagine Coin";
    ...
    constructor() {
        ...
        _isExcludedWalletLimit[CharityWallet] = true;
    ...
    function setWalletLimitstatus(address account, bool status)
        external
        onlyOwner
    {
    ...
    function setTaxFeePercentage(
        ...
        require(
            taxFee.add(liquidityFee).add(CharityFee).add(MarketingFee) <= 25,
            "Fee should me less or equal to 25"
        );
        _taxFee = taxFee;
        _previousTaxFee = _taxFee;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
        require(
            maxTxAmount >= 50000 * 10**_decimals,
            "Cannot set transaction amount as zero"
        );
    ...
    function setMaxWalletAmount(uint256 maxWalletAmount) external onlyOwner {
        require(
            maxWalletAmount >= 50000 * 10**_decimals,
            "Cannot set transaction amount as zero"
        );
