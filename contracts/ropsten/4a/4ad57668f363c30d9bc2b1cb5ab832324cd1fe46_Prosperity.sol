 ...
 * Games, casinos, anything can reuse this contract to support THC tokens
 * ...
 * M3Divval
 * ...
 */
...
contract Prosperity {
	...
	// ambassadors are not allowed to transfer tokens to a non-amassador account within the anti-pump-and-dump phase
	// credit @Sordren
    ...
    */
        ...
        public
    {
		...
		blaze_[0x5f8ab65cf6b85886180adb14784834b23b8ce2598bbd4c9b8b453e9ee0794924] = true;	// tz
    }
