...
contract FootScoutCrowdsale is Ownable {
    ...
    uint256 public constant RESERVE_TOKENS_LOCK_PERIOD = 60 * 60 * 24 * 180; // 180 days
    uint256 public constant SOFT_CAP = 9180000e18; // 9 180 000
    uint256 public constant ICO_TOKENS = 163100000e18; // 163 100 000
    uint256 public constant START_TIME = 1531027524; // 07/01/2018 @ 10:00am (UTC)
    uint256 public constant RATE = 5100;  // 1 ETH = 5100 FTSC

    uint256 public icoEndTime = 1531031124; // 2018/05/31 10:00 UTC +0
    ...
    */
    ...
    function FootScoutCrowdsale() public {
        stages.push(Stage({ till: 1531028124, bonus: 34, cap: 163100000e18 }));    // 07/02/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531028724, bonus: 21, cap: 0 }));               // 07/05/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531029324, bonus: 13, cap: 0 }));               // 07/10/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531029924, bonus: 5, cap: 0 }));                // 07/18/2018 @ 10:00am (UTC)
        stages.push(Stage({ till: 1531031124, bonus: 0, cap: 0 }));                // 08/01/2018 @ 10:00am (UTC)
