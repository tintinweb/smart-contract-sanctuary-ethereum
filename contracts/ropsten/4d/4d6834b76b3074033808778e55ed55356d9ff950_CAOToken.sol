...
contract CAOToken is MintableToken, PausableToken {
    string public constant name = "CAOToken"; // solium-disable-line uppercase
    string public constant symbol = "CAO"; // solium-disable-line uppercase
