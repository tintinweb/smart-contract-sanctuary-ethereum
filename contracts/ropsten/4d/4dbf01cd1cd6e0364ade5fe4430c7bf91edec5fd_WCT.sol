 ...
 */
contract WCT is StandardToken, BurnableToken { 
    
    // Public variables of the token
    string public constant symbol = "WCT";
    string public constant name =  "WealthChainToken";
    
    uint8 public constant decimals = 18;
    
    // 100.000.000 tokens + 8 DECIMALS = 10^16 units 
    uint256 public constant INITIAL_SUPPLY = 2000000000000000000000000;
