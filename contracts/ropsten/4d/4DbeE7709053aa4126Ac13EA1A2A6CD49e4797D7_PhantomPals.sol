...
contract PhantomPals is ERC721, Ownable {
    ...
    uint256 public constant NFT_STOCK = 10;
    ...
    constructor(string memory tokenBaseURI, string memory mysteryURI) ERC721("Phantom Pals", "PHMTPLSTEST") {
        ...
        onlyOwner
    {
        ...
        require(totalSupply <= NFT_STOCK, "OUT_OF_STOCK");
        require(totalSupply + tokenQuantity <= NFT_STOCK, "EXCEED_STOCK");
    ...
    function mint(
        ...
        require(tokenQuantity <= NFTS_PER_MINT, "EXCEED_MINT_AMT_PER_TRANSACTION");
        
        if (firstSaleLive) require(totalSupply + tokenQuantity <= NFT_STOCK/2, "EXCEED_FIRST_SALE_STOCK");
        else if (secondSaleLive) require(totalSupply + tokenQuantity <= NFT_STOCK, "EXCEED_SECOND_SALE_STOCK");
        else require(firstSaleLive || secondSaleLive, "SALE_NOT_LIVE");
