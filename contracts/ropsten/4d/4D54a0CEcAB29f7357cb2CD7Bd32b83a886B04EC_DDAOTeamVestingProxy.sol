...
//	bool public TokenApprovedAll = false;
	...
	{
		amount = IVesting(VestingAddress).calculateUnlockedTokens(address(this),1,0);
	}
...
//		require(!TokenApprovedAll,"All amount already approved");
