...
contract Geranos is Context, IERC20, Ownable {
    ...
    string private _name = "Double2";
    string private _symbol = "D2";
    ...
    uint256 public _maxBuyAmount = 7777777777 * 10**9;
    uint256 public _maxWalletAmount = 777777777777 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 2000000000 * 10**9;
    uint public ethSellAmount = 1000000000000000000;  //1 ETH
    address public marketingWallet = 0xCB81AAfc9c936E9CbCC0612A2f8370bB4C20Bc07;
    address public devWallet = 0xCB81AAfc9c936E9CbCC0612A2f8370bB4C20Bc07;
