...
//
// Deployed to : 0x4d287c9d5fa2318827ad273dcfee81b14348273a
// Symbol      : STAKE8
// Name        : STAKE8 Token
...
contract stake8Token is StandardToken {

    // metadata
    string  public constant name = "STAKE8 Token";
    string  public constant symbol = "STAKE8";
    ...
    bool    public isFormat;                 // switched to true in operational state
    ...
    /// @dev turn off decimal formatting
    function setFormat(bool format) isOwner external {
        isFormat = format;
    }

    /// @dev turn on decimal formatting
