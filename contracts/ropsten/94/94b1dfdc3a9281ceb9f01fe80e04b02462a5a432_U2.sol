...
contract U2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "U2";
    string private constant _symbol = "U2";
    ...
    constructor () {
        _MarketingWallet = payable(0x0E1DC9e8de9bB087f8481454E143DC3A9bFcf010);
