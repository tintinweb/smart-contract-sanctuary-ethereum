...
contract KungfuFighting is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public MAX_NFT = 10000;
    uint256 public GIVEAWAY_NFT = 10000;
    uint256 public SALE_NFT = 10000;

    uint256 public MAX_BY_MINT_IN_TRANSACTION = 10000;
    ...
    constructor() ERC721P("KungfuFighting", "KFFG") {}
    ...
    function mintGiveawayNFT(uint256 _count) public onlyOwner {
        ...
        require(GIVEAWAY_MINTED + _count <= GIVEAWAY_NFT, "Max limit");
        ...
        returns (string memory)
    {
        ...
        if (bytes(currentBaseURI).length > 0 && revealStatus) {
            return
                string(
                    abi.encodePacked(
                        currentBaseURI,
            ...
            return
                "https://ipfs.io/ipfs/QmeCDQiKbpTSorjYMNLQ5nTxGaV4w1SrNj7QXZCo3rHa6k/1645669574935.jpeg";
        }
    }
    ...
    function updateMintLimitPerTransection(uint256 newLimit)
        external
        onlyOwner
    {
