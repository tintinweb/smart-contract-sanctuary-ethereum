...
contract YomazukaFamily is ERC721A, Ownable {
  ...
  uint256 public NUMBER_OF_UNITS_DROP_2 = 10;
  uint256 public NUMBER_OF_UNITS_DROP_3 = 20;
  ...
  function mint(uint256 _quantity) external payable callerIsUser {
    ...
    if ((totalSupply() + _quantity) > NUMBER_OF_UNITS_DROP_3) {
  ...
  function setDrop2Amount(uint256 dropOneAmount) external onlyOwner {
    NUMBER_OF_UNITS_DROP_2 = dropOneAmount;
  }

  function setDrop3Amount(uint256 dropTwoAmount) external onlyOwner {
    NUMBER_OF_UNITS_DROP_3 = dropTwoAmount;
  }
