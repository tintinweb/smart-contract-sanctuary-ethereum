    ...
    Administrated
{
    ...
    function presaleBuyWETH(
        ...
        //Splitting
        if (presalePrice > 0) {
            IERC20(weth).safeTransferFrom(msg.sender, splitter, presalePrice);
    ...
    function publicBuyWETH(
        ...
        //Splitting
        if (price > 0) {
            IERC20(weth).safeTransferFrom(msg.sender, splitter, price);
            ISplitterContract(splitter).primaryDistribution(artist, price);
        }
