...
contract ShibeFace is ERC1155, Merkle, ReentrancyGuard {
    ...
    uint256 public constant presalePriceInEth = 0.111 ether;
    uint256 public constant publicsalePriceInEth = 0.111 ether;
    uint256 public presalePriceInShib = 111 ether;
    uint256 public publicsalePriceInShib = 111 ether;

    address public shib = 0x722dd3F80BAC40c951b51BdD28Dd19d435762180;
