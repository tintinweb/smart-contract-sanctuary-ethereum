...
contract OWTest2 is OWTest {
    ...
    mapping(uint256 => Universe2) public universes2;

    function addUniverse2(uint256 _projectId, string calldata _URL) external {
        universeId += 1;

        universes2[universeId] = Universe2({
            id: universeId,
...
contract OWTest is UUPSUpgradeable {
