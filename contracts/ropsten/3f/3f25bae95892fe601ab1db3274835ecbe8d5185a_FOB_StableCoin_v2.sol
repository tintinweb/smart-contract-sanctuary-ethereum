...
//      ///////////////////////////  Functions (Write) ///////////////////
    ...
    function initiate_contract (
        ...
        require(StatesArray[9],                "Prev contract not done yet!");
...
//      ///////////////////////////  Functions (Read) ///////////////////
    ...
    function get_paid_by_seller() public view returns(uint) {
        return depositors_balances[seller];
    }
    
    function get_paid_by_buyer() public view returns(uint) {
