...
// File: contracts/tokengating.sol
...
// function approveAndTransfer(IERC721 nft, uint256 _tokenId, address _from, address _to) public payable returns (uint256){
//     require(nft.ownerOf(_tokenId) == msg.sender, "NOT OWNER");
//      TokenData memory tokenData = tokenIdByTokenData[_tokenId];
//         uint256 price = tokenData.price;

//         require(msg.value == price, "You must pay the full price");

//         // Get the token owner
//         address owner = tokenIdByOwner[_tokenId];
...
//             tokenIdByOwner[_tokenId] = msg.sender;
//         delete ownerByTokenId[owner][_tokenId];
//         ownerByTokenId[msg.sender].push(_tokenId);
...
//TODO/awardNFT EVENT should be sent 
