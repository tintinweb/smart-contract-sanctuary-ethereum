...
// File contracts/CryptoHongKongLand.sol
// License-Identifier: MIT
...
contract CryptoHongKongLand is ERC721, Ownable {
    ...
    constructor() ERC721("Crypto HongKong Land", "CryptoHongKongLand") {
    ...
    function _mintNFT(uint256 amount, bytes32 signatureR, bytes32 signatureVS) internal {
        ...
        require(_tokenIdCounter + amount <= MAX_LANDS, "No more mints allowed");
