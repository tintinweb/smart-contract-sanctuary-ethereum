...
contract TrueTHB2 is StandardDelegate, PausableToken, BurnableToken, NoOwner, CanDelegate {
    string public name = "TrueTHB2";
    string public symbol = "TTHB2";
