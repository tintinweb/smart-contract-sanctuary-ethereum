...
// SPDX-License-Identifier: Unlicensed
        ...
        contract TOKEN is ERC20, LockToken {
            ...
            constructor () ERC20("XYZ Coin", "$XYZ"){
                ...
                _charityAddress = 0xd281d8A332370f0D0DE52253629AcB897D1d621C;
            ...
            function setFharityFeePercent(uint256 charityFee) external onlyOwner {
            ...
            function _transfer(
                ...
                else
                {
                    ...
                    uint256 charityTokens = amount.mul(_charityFee).div(1000);
                    amount= amount.sub(lpTokens).sub(marketingTokens).sub(charityTokens);
                    super._transfer(from, address(this), lpTokens.add(charityTokens).add(marketingTokens));
                    super._transfer(from, to, amount);
                }
            ...
            function swapBack(uint256 contractBalance) private {
                ...
                (success,) = address(_charityAddress).call{value: ethForCharity}("");
