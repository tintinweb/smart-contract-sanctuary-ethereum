...
contract BlockchainDevCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function BlockchainDevCoin() {
        ...
        name = "BlockchainDevCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "BDC";                                             // Set the symbol for display purposes (CHANGE THIS)
