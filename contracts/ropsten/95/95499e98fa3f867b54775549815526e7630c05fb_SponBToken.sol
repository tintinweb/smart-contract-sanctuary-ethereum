 ...
 * the SponB Network.
 *
 * For more infos :  https://sponb.io 
 *
 * Special Thanks: open zeppelin and their
 * fantastic work on openzeppelin-solidity. 
 * :-) 
 */
 ...
 */
contract SponBToken is StandardBurnableToken, PausableToken, HasNoEther, 
HasNoTokens, Claimable, Contactable {

    string public constant name = "SponBToken";
    string public constant symbol = "SPO";
    uint8 public constant decimals = 18;

    uint256 public constant INITIAL_SUPPLY = 1400000000 * (10 ** uint256(decimals));

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor(string _info) public 
    {
