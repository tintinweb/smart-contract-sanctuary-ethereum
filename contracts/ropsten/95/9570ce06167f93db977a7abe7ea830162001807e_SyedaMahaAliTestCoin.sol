...
contract SyedaMahaAliTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SyedaMahaAliTestCoin() {
        ...
        name = "SyedaMahaAliTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT2018-86";                                             // Set the symbol for display purposes (CHANGE THIS)
