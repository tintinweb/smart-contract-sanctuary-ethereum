...
contract ShardwalletFactory {
    event ShardwalletCreation(IShardwallet shardwallet, address owner);
    ...
    function summon(IShardwallet implementation, bytes32 salt)
        external
        returns (IShardwallet)
    {
        implementation;
        ...
        IShardwallet sw = IShardwallet(payable(clone));
