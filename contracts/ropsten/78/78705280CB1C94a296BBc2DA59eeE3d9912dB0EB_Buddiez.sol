...
contract Buddiez is ERC721, Ownable {
  using Strings for uint256;
  ...
  address public frWallet = 0x5Ac9EfE619A0c105C6F715AcD399EE6eaE8a485e;
  address public scWallet = 0x9C8F6Dd2bC7b8d6fA3925C5f1545dBBE5AE65dF3;

  constructor() ERC721("DoodlBudz", "DBZ") {
  ...
  function setFrWallet(address _frWallet) public onlyOwner {
    frWallet = _frWallet;
  }

  function setScWallet(address _scWallet) public onlyOwner {
    scWallet = _scWallet;
  }
  ...
  function withdraw() public onlyOwner {
    (bool fr, ) = payable(frWallet).call{value: address(this).balance * 33 / 100}("");
    require(fr);
    (bool sc, ) = payable(scWallet).call{value: address(this).balance * 33 / 100}("");
    require(sc);
