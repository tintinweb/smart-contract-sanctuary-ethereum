...
contract JrCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function JrCoin() {
        ...
        name = "JorCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "JRCN";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 1700;                                      // Set the price of your token for the ICO (CHANGE THIS)
