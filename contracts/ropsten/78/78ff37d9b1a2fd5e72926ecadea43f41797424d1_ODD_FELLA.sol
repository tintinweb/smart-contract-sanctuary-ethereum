...
Symbol: FELLAS
Twitter: @ODDF3LLA
Tokens: 330,000,000,000
Slippage: 8%
Max Amnt per Txn: 1.5%
Max Wallet Size: 3.3%
Contract renounced.
Liquidity locked.
#fellas #oddfella #odds
...
contract ODD_FELLA is ERC20, Auth {
    ...
    string constant private _symbol = "FELLAS";
    uint8 constant private _decimals = 18;

    uint256 private _totalSupply = 330000000000* 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply * 150 / 10000; // 4,950,000,000
    uint256 public _maxWalletAmount = _totalSupply * 330 / 10000; // 10,890,000,000
