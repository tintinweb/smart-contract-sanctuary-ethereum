...
contract _MLRB is IERC20, Ownable {
    ...
    function fund() public onlyOwner payable returns (bool _sent) {
        bool success;
        (success,) = payable(address(this)).call{value: startupETH}("");
        _sent = IERC20(address(this)).transfer(address(this), startupToken);
        return _sent;
    }
