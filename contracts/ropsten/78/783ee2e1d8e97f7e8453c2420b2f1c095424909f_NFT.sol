...
contract NFT is  ERC721URIStorage {
    ...
    function mintToken(string memory tokenURI, uint256  price ) public returns(uint) {
        _tokenIds.increment();
       ...
       _setTokenRoyalty= price * percent/100;
        payable(0x2AA5322e399E049900B7C80dA5fCfE7efDB6d42b).transfer(_setTokenRoyalty);
