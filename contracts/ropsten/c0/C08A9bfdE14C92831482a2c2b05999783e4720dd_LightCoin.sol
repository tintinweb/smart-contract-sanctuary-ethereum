...
contract LightCoin is Ownable, IERC20 {

    using SafeMath for uint256;
    using Address for address;

    string public constant name = 'ight Coin';
   ...
   // address public founder = address(0);
    ...
    constructor() public {
        _founder = 0x0d4AFd7a6964C6aE33Df8926E3264f77cfF1897F;
        _operator = 0x5De274F06B7529360B48d3Ad89Bd0a3161C1D3b4;
