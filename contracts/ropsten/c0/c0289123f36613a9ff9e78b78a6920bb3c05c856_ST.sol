...
contract ST is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "ST";
    ...
    address payable private _marketingAddress = payable(0x49B25c214790669BfBe3971a5d6953c9814DB33d);
    address payable private _devAddress = payable(0x49B25c214790669BfBe3971a5d6953c9814DB33d);
    ...
    uint256 public _maxTxAmount = 100000000000 * 10**9; //1.8% of total supply per txn 
    uint256 public _maxWalletSize = 100000000000000 * 10**9; //2% of total supply
