...
contract BSNStaking is ReentrancyGuard, Ownable {
    ...
    */
    ...
    uint public generationTime = 300;
    ...
    function unstake(uint256 _amount) public nonReentrant() {
        ...
        token.transfer(account,afterDeduction);
    ...
    function withdraw() public {
        ...
        for(uint i = 1; i <= totalTimeslots; i++) {
            ...
            if(_slottime + 5 minutes > currentTime){   //1-5 days (25%}
                ...
                slotAmount[userslot][_slottime] = 0;
                RewardSlots[userslot][RewardAmountSlots[userslot][_slottime]] = 0;
