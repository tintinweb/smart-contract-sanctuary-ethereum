...
// File: contracts/FLBFoundation.sol

contract FLBFoundation is Ownable {
  
  FarashaCoin public flb; // token Farasha
  address public flbAddress = 0x9564813AE2e80026D39656b559aF40eE794Ce746; // The address of FarashaCoin contract (testnet)	
  ...
  constructor() public {
   // _mint(msg.sender, INITIAL_SUPPLY);
    ...
    //defrostTime = now + 12 months; // tokens are frost 1 year for the foundation
    defrostTime = now + 10 minutes; 
  }
