...
contract TestETH is ERC721, Ownable, ReentrancyGuard {
	...
	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/626/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/626/contract-uri";
    ...
    uint256 public tokenfyPrice = 10000000000000000000000;
    ...
    uint256 public tokenfyPresalePrice = 10000000000000000000000;
	...
	constructor(address _signerAddress) ERC721("TestETH", "ETH") {
