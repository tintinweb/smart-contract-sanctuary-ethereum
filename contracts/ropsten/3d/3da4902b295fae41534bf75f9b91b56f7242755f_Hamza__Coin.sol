...
contract Hamza__Coin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Hamza__Coin() {
        ...
        name = "Hamza__Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-020";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 15;                                      // Set the price of your token for the ICO (CHANGE THIS)
