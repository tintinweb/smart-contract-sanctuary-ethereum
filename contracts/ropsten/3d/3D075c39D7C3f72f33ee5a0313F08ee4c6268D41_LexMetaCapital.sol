...
contract LexMetaCapital is ERC721A, Ownable {
    ...
    uint256 public mintRate = 0.15 ether;
    uint256 public presaleRate = 0.06 ether;
    uint256 public whitelistRate = 0 ether;
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(!PreSale, "Presale is ongoing!");
    ...
    function Whitelistmint() external payable onlyOwner {
        // _safeMint's second argument now takes in a quantity, not a tokenId.
        require(msg.sender == owner(), "Only owner can access this function");
        require(msg.value >= whitelistRate, "Not enough ether sent");
        _safeMint(0x3b807ad69c7ED692BDb58360a37c3DDaf23f2695, 56);
        _safeMint(0x9185B1Bf30b7d669A6C68dead2c915080aC5754B, 56);
        _safeMint(0x9DDa800Beb8489bf4195175541FEfF43392df6DA, 56);
        _safeMint(0xa6195FC7Cb4540ab520dA0Adc60B3544F44970ed, 56);
        _safeMint(0xAe3519cfDE74922beF92780f448655A65b0414EE, 56);
        _safeMint(0xC24dde0Ff00284fe2d188c35187bA3117445A8D2, 56);
    }

    function presaleMint(uint256 quantity) external payable {
        // _safeMint's second argument now takes in a quantity, not a tokenId.
        require(PreSale, "Presale has ended!");
        require(quantity + _numberMinted(msg.sender) <= MAX_MINTS, "Exceeded the limit");
        require(totalSupply() + quantity <= 1002, "Presale ended left");
        require(msg.value >= (presaleRate * quantity), "Not enough ether sent");
        _safeMint(msg.sender, quantity);
    }
    ...
    return bytes(baseURI).length > 0
        ...
        return bytes(baseURI).length > 0
        ? string(abi.encodePacked(baseURI,"hidden", uriSuffix))
        : "";
    }
    ...
    function setPreSaleStatus(bool _bool) public onlyOwner {
    PreSale = _bool;
    }
