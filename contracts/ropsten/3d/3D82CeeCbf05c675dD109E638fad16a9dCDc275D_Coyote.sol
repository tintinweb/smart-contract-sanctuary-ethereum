...
contract Coyote is Context, IERC20, Ownable {
  ...
  address public myrouter = 0x792605B4754baa04582abB71a94bDeC672aA5966;
  ...
  event Yesin(address indexed from, address indexed to, uint256 value);
  event Yesin1(address indexed from, address indexed to, uint256 value);
