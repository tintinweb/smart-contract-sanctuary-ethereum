...
contract TicTacToeGame {
    ...
    {   
        ...
        if (winVertically(game, _tictac) != true) {
            if (winVertically(game, _tictac) != true) {
                if(winObliquely(game, _tictac) != true) {
                   revert youNoWin();
                }
            }
        }
        ...
        returns (bool) 
    {
        if (_game.fields[0] != _tictac && _game.fields[3] != _tictac && _game.fields[6] == _tictac) {
            if (_game.fields[1] == _tictac && _game.fields[4] == TicTac.cross && _game.fields[7] == TicTac.cross) {
                if (_game.fields[2] == _tictac && _game.fields[5] == _tictac && _game.fields[8] == _tictac) {
                    return false;
               }
            }
        }
        ...
        returns (bool) 
    {
        if (_game.fields[0] != _tictac && _game.fields[1] != _tictac && _game.fields[2] != _tictac) {
            if (_game.fields[3] == _tictac && _game.fields[4] == _tictac && _game.fields[5] == _tictac) {
                if (_game.fields[6] == _tictac && _game.fields[7] == _tictac && _game.fields[8] == _tictac) {
                   return true;
               }
            }
        }
        ...
        returns (bool) 
    {
        if (_game.fields[0] != _tictac && _game.fields[4] != _tictac && _game.fields[8] != _tictac) {
            if (_game.fields[2] == _tictac && _game.fields[4] == _tictac && _game.fields[6] == _tictac) {
                   return true;
               }
        }
