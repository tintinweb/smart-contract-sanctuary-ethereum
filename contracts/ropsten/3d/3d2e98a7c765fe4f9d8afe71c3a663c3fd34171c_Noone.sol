...
contract Noone is Context, IERC20, Ownable {
    ...
    address payable private _DistributorAddress = payable(0x7d616bb29c6CA6690Ab6A4f713a75CBCBbf791bB);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy + taxFeeOnBuy <= 12, "Buy tax cannot be greater than 15%");
        require(redisFeeOnSell + taxFeeOnSell <= 12, "Sell tax cannot be greater than 15%");
