...
contract YOLOINU is ERC20, Ownable {
    ...
    constructor() ERC20("YOLOINU", "YINU") {
        ...
        uint256 _earlySellTreasuryFee = 11;
        ...
        treasuryWallet = address((0xeF59334AeD6f4E22d1Cb3d56048d48a5E8823eFC)); // set as treasury wallet
        devWallet = address((0xeF59334AeD6f4E22d1Cb3d56048d48a5E8823eFC)); // set as dev wallet
    ...
    function swapBack() private {
        ...
        (success,) = address(treasuryWallet).call{value: address(0xeF59334AeD6f4E22d1Cb3d56048d48a5E8823eFC).balance}("");
    }
