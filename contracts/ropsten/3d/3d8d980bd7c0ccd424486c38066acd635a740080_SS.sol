...
contract SS is ERC721A, Ownable {
  
  uint256 public mintPrice = 0.00911 ether;
  ...
  function allowListMint(uint256 _count) public payable saleIsOpen {
     uint256 mintIndex = totalSupply();
      require(isActive, "Sale is not active currently.");
      require(mintIndex + _count <= FREE_MAX_SUPPLY, 'FREE supply exceeded');
  ...
  function mint(uint256 _count) public payable saleIsOpen {
    ...
    require(isActive, "Sale is not active currently.");
    require(mintIndex + _count > FREE_MAX_SUPPLY, "FREE Supply is not exceeded yet.");
