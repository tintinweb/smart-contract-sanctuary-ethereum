...
import "./staking/StakedProbablyNothing.sol";

error Unimplemented();

/** @title Probably Nothing Holdier Tier - PNHT
 * @author 0xEwok and audie.eth
 * @notice This is a utility contract for calculating holder tiers, modeled as ERC20 to gracefully connect to discord plug-ins, etc.
 */
