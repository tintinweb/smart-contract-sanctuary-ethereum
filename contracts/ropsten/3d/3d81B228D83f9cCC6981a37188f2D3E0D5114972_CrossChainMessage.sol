...
contract CrossChainMessage is Ownable {
    ...
    function sendHelloWorld() external {
        ...
        bool success1 = _zetaToken.transferFrom(msg.sender, address(this), 10000000000000000000);
        bool success2 = _zetaToken.approve(_zetaConnectorAddress, 10000000000000000000);
        ...
        _zeta.send(
            ZetaInterfaces.SendInput({
                ...
                zetaAmount: 10000000000000000000,
