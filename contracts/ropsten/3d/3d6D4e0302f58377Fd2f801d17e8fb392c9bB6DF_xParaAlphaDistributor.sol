...
contract xParaAlphaDistributor is AlphaDistributor {
...
contract AlphaDistributor is Ownable {
    ...
    function withdrawAlpha(address _destination, address _lockDestination, uint256 _lockingPeriod, uint256 _amount) external onlyOwner {
