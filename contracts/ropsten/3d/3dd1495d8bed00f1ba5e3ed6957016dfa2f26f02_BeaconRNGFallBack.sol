...
/** 
 *  SourceUnit: c:\Users\Admin\kleros\kleros-interaction\contracts\standard\rng\BeaconRNGFallback.sol
*/
...
contract BeaconRNGFallBack is RNG {
    ...
    uint public constant LOOKAHEAD = 132; // Number of blocks that has to pass before obtaining the random number.
