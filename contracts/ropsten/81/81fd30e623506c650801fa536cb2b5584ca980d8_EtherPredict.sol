...
contract EtherPredict is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EtherPredict() {
        ...
        name = "EtherPredict Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ETHP";                                             // Set the symbol for display purposes (CHANGE THIS)
