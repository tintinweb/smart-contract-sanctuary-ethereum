...
contract YourToken is StandardToken, Ownable {
    ...
    constructor(string _name, string _symbol, uint32 _decimals, uint256 _maxSupply, uint256 _dateStartTransfer, address _owner) public {
        ...
        owner = _owner;
        dateStartTransfer = _dateStartTransfer;// 1538352000; 
    }
    ...
    /**
     * function can be run only from owner
     */
...
contract TokenFactory {
    ...
    function createToken(string _name, string _symbol, uint32 _decimals, uint256 _maxSupply, uint256 _dateStartTransfer) public {
        ...
        address newToken = new YourToken(_name, _symbol, _decimals, _maxSupply, _dateStartTransfer, msg.sender);  // создание нового контракта Campaign в блокчейне
                                                        // и сохранение его адреса в переменной newCampaign
        deployedTokens.push(newToken);            // добавление нового адреса в массив адресов кампаний
    }
