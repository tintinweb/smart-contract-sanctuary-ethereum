...
contract ProjectMaybeMintPass is ERC721Enumerable, Ownable {
    ...
    mapping(address => bool) private presaleAccess;
    ...
    function mint() external payable {
        ...
        if (isPreMintActive) {
            require(presaleAccess[msg.sender] == true, "address not in the whitelist");
            require(supply <= WL_SUPPLY, "Exceeds maximum pre-sales supply");
            require(ownerTokenIds.length < 1, "Cannot mint more than maximum pre-sales quantity");
        }
