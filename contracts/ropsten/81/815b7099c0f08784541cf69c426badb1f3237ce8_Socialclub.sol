...
contract Socialclub is IERC20, Ownable {
    ...
    uint256 public projectFee = 8;
    uint256 public liquidityFee = 1;
    uint256 public burnFee = 1;    

    uint256 public reflectionFee_OnTransfer = 10;    
    uint256 public projectFee_OnTransfer = 16;
    uint256 public liquidityFee_OnTransfer = 2;
    uint256 public burnFee_OnTransfer = 2;    
    ...
    uint256 public priceImpactLimit = 7;    
    ...
    function updatePriceImpactLimit(uint256 val) public onlyOwner {
        require(val > 0 || val < 100, "Please set correct number!");
    ...
    function checkATH(address from, address to, uint256 amount) private {
        ...
        if (tmpAddr == address(this)){
            ...
            if (!_isExcludedFromFees[from] && to == uniswapV2Pair){
                ...
                if (result1 < lastATH / 100 * (100 - priceImpactLimit)){
            ...
            if (!_isExcludedFromFees[from] && to == uniswapV2Pair){
                ...
                if (result2 < lastATH / 100 * (100 - priceImpactLimit)){
                    require(false, "Price impact is higher than Anti dumping limit!");
                }
            }
        }        
