...
contract Binkert  is ERC20, Ownable{
    ...
    address public marketingWallet =0xD3F9f7389e113E64893e82b909c0A6B43F3E6CF4;
    address public devWallet = 0xD3F9f7389e113E64893e82b909c0A6B43F3E6CF4;
    ...
    constructor() ERC20("Bink", "Binkie") {
        _mint(msg.sender, 2e7 * 10 ** decimals());
