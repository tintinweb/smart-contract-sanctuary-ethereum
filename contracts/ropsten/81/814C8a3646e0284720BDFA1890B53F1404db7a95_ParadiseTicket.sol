...
contract ParadiseTicket is ERC721, ERC721Enumerable, Pausable, Ownable 
{
    ...
    constructor(uint256 maxSupply, uint256 paradiseMintStartTimestamp, uint256 ogMintStartTimestamp, uint256 publicMintStartTimestamp) ERC721("ParadiseTicket", "ParadiseTicket") 
    {
    ...
    function forceMint(address to) public onlyOwner
    {
    ...
    function mint() public
    {
        ...
        require(!hasAlreadyMinted(msg.sender), "Address has already minted a ticket");
    ...
    function clearWhitelist() external onlyOwner
    {
        for (uint i = 0; i < _whitelist.length; i++) 
        {
            ...
            _whitelistMapping[addr] = 0;
        }

        delete _whitelist;
    }

    function hasAlreadyMinted(address to) public view returns (bool)
    {
        return _alreadyMintedMapping[to];
    }
