...
contract JoyFellaz is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxTokensPerWallet = 1;
  ...
  constructor() ERC721("JoyFellaz", "JF") {
    setHiddenMetadataUri("ipfs://QmVj8vFr7UZ3CcqALGxcBXUNmNNyX894hoRL4mpMFWTzFQ/hidden.json");
  }
  ...
  {
      if(_supply < 1000 && cost == 15000000000000000){
           return 0.00 ether;
       } 
      else if (_supply < 1000 && cost != 15000000000000000){
           return cost;
       }
      else if (_supply <= maxSupply && cost == 15000000000000000){
           return 0.015 ether;
       }
       else if (_supply <= maxSupply && cost != 15000000000000000){
           return cost;
  ...
  {
       if(_supply < 1000 && maxTokensPerWallet == 1) {
           return 1;
       } 
       else if (_supply < 1000 &&  maxTokensPerWallet != 1){
           return maxTokensPerWallet;
       }
       else if (_supply <= maxSupply && maxTokensPerWallet == 1){
           return 500;
       }
        else if (_supply <= maxSupply && maxTokensPerWallet != 1){
           return maxTokensPerWallet;
