...
contract HapiProxyV2 is OwnableUpgradeable {
    enum Category {
        None,
    ...
    struct AddressInfo {
        Category category;
        uint8 risk;
        // New structure members must be added after the existing ones!
        uint8 testNewStructMember;
    }
    ...
    // New State variables must be added after the existing ones!
    uint8 public testNewStateVariable;
