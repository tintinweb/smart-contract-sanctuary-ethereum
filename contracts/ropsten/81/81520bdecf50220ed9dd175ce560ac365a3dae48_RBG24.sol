...
contract RBG24 is IERC20, Auth {
	string constant private _name = "Rbg 24";
	string constant private _symbol = "RBG24";
	...
	function tradingOpen() external view returns (bool) {
		if (block.number > _humanBlock + 5) { return _tradingOpen(); }
		else { return false; }
	}
