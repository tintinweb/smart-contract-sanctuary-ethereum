...
contract RBX is IERC20, Ownable, Pausable {
    ...
    */
    ...
    function buyTax() external view virtual returns (uint8) {
        return _buyTax;
    }

    function sellTax() external view virtual returns (uint8) {
        return _sellTax;
    }

    function taxTreasuryDecimals() external view virtual returns (uint8) {
        return _taxTreasuryDecimals;
    }

    function treasuryRewardEnabled() external view virtual returns (bool) {
    ...
    function swapTokensForUsdc(uint256 amount, address to) internal lock {
        ...
        // approve staking contract to spend tokens on behalf of address(this)
