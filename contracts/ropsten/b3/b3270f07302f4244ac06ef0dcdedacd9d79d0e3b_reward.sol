...
contract reward{
    ...
    IERC20 Token=IERC20(0x56Ba78e18dD529C077516098B9fcCe90a5De4587);
   ...
   function getreward(string memory value) public  returns(bool){
       ...
       bool check=Token.transfer(msg.sender,50000000000000000000000);
       require(check);
