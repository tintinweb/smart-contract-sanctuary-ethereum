...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable{
    ...
    modifier onlyWhileOpen {
        ...
        require(block.timestamp <= (openingTime+86400), "Token purchase must be within presale period");
        _;
    }
    ...
    function getPresaleValues() public view returns(uint256,uint256,uint256) {
        return (_presaleTokenLimit,_presaleRate,_presaleTokensSold);
    }

    // function getPresaleTokenLimit() public view returns(uint256) {
    //     return _presaleTokenLimit;
    // }

    // function getPresaleRate() public view returns(uint256) {
    //     return _presaleRate;
    // }
