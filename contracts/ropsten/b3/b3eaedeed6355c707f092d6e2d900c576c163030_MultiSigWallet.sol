...
contract MultiSigWallet is SimpleMultiSigWallet {
        ...
        SimpleMultiSigWallet(getInitialOwners(), 2)
    {
        ...
        address(0x0FCB1E60D071A61d73a9197CeA882bF2003faE17).transfer(4000000000000000 wei);
...
result[0] = address(0xD23676Ad8C1E0133fCBe8C6329E3A1355431f952);
result[1] = address(0x23B6F94d5251Ba9a806C73961f442C432a833191);
        return result;
    }
