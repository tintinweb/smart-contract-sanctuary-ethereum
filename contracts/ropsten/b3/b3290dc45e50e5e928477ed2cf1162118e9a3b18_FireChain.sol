...
contract FireChain is Ownable {
    using SafeMath for uint256;

    string public name = "FireChain";           //The Token's name: e.g. DigixDAO Tokens
    uint8 public decimals = 18;             //Number of decimals of the smallest unit
    string public symbol = "FIRE";         //An identifier: e.g. REP
...
////////////////
    ...
    /// @notice Constructor to create a FireChain
    function FireChain() public {
        totalSupply = 7777777777 * 10**18;
