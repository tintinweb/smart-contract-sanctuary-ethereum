...
contract DMPhuongToken is DMPhuong { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function DMPhuongToken() {
        ...
        name = "DMPhuongToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "DMP";                                             // Set the symbol for display purposes (CHANGE THIS)
