...
contract LpExchange is AccessControl {
    ...
    uint256 private _minimumTokenAmount = 20 * 10 **18;
    uint256 private _bnbAmount = 10 **16;
    ...
    function setMinimum(
        ...
        if (_minimumTokenAmount != token) {
            _minimumTokenAmount = token;
        }
    ...
    /**
     * @dev Returns the minimumToken.
     */
    function minimumTokenAmount() public view virtual returns (uint256) {
        return _minimumTokenAmount;
    }
