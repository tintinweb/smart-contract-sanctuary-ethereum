 ...
 * COIN
 */
contract Null is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    // Addresses
    address BURN_ADDRESS = 0xFeED01000011010110010100001001010010dEAD;
    ...
    function getAllSellFees() public view returns ( uint256 _burnFeeSell ){
        return (burnFeeSell);
    }
    ...
    */
    ...
    function setSellFeesInPercentage( uint256 _burnFeeSell ) external onlyOwner {
    ...
    function _transfer(
        ...
        require(from!=BURN_ADDRESS,"ERC0: Burn address cannot transfer tokens");
    ...
    function _transferFromExcluded(
        ...
        (uint256 rAmount, uint256 rTransferAmount ,  uint256 tTransferAmount,  uint256 tBurn) =
            _getValues(tAmount);
