...
contract PoolMatrixGame {
    ...
    uint32 private stats1totalUsers;
    uint32 private stats2totalUsers;
    uint32 private stats1totalTransactions;
    uint32 private stats2totalTransactions;
    ...
    function setParams(uint totalTransactions, uint totalTurnover/*, uint32 users24h1, uint32 users24h2, uint32 transactions24h1, uint32 transactions24h2, uint turnover24h1, uint turnover24h2*/) public {
        require(msg.sender == adminWallet);
