...
contract Asset is ERC721Enumerable, ERC721Burnable, ERC721Blacklisted, PausableOwned, Minterable {
   ...
   */
  function supportsInterface(bytes4 _interfaceId) public view virtual override(ERC721, ERC721Enumerable, AccessControl)
    returns (bool)
  {
