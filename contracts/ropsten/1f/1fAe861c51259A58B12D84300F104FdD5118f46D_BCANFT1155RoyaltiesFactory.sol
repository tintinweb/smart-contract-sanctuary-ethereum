...
contract BCANFT1155RoyaltiesFactory is BCANFT1155Factory, ERC2981PerTokenRoyalties {
//    uint256 immutable maxSupply;
    ...
    // function mintTo(address to, uint256 id, uint256 amount, bytes memory data) public override onlyOwner {
    //     _mint(to, id, amount, data);
    // }

    // bsc  test public  mint
