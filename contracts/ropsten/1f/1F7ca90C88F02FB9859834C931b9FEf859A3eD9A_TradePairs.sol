...
contract TradePairs is Ownable, ITradePairs , ReentrancyGuard {
    ...
    function addOrder(bytes32 _tradePairId, uint256 _price, uint256 _quantity, Side _side, Type1 _type1) public override nonReentrant {
...
interface IDexManager {
    function addLimitOrder(bytes32 _tradePairId, uint256 _price, uint256 _quantity, ITradePairs.Side _side, address _traderAddress) external;
    function addMarketOrder(bytes32 _tradePairId, uint256 _quantity, ITradePairs.Side _side, address _traderAddress) external;
}
