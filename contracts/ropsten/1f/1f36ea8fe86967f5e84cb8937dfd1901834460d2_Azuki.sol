...
library Address {
     ...
     * Requirements:
     *
     * - the calling contract must have an TRX balance of at least `value`.
...
pragma solidity ^0.8.0;
  ...
  function refundIfOver(uint256 price) private {
    require(msg.value >= price, "Need to send more TRX.");
    if (msg.value > price) {
  ...
  uint256 public constant AUCTION_START_PRICE = 1 ether;    //  trx;
  uint256 public constant AUCTION_END_PRICE = 0.15 ether;   //  trx;
