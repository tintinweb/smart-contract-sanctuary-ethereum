...
contract MLRB is IERC20, Ownable {
    ...
    uint256 public startupToken = 1000 * 10**9;
    ...
    constructor() {
        ...
        marketingWallet = payable(0xC925F19cb5f22F936524D2E8b17332a6f4338751);
        liquidityWallet = payable(0x74b9006390BfA657caB68a04501919B72E27f49A);
    ...
    function initialize(uint256 maxWallet, uint256 maxTx, uint256 minLiqTokens, uint256 lFee, uint256 bFee, uint256 mFee, uint256 tFee) external onlyOwner returns(bool) {
        ...
        _isExcluded[address(marketingWallet)] = true;
        _isExcluded[address(liquidityWallet)] = true;
