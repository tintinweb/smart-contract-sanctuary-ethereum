...
contract Pollen {
    ...
    constructor() {
        xrz = IERC20(0xDEcEF803dC694341Cf2dA8A1efB67AD81B397519); //atualizado
        DAI = IERC20(0x31F42841c2db5173425b5223809CF3A38FEde360); //atualizado
        PollenNFT = IPollenNft(0x166c1662ed23fEad608CEEda9C8B7f77396EeC4c); // atualizado
        DAIPriceFeed = AggregatorV3Interface(
            0x2bA49Aaa16E6afD2a993473cfB70Fa8559B523cF
        );
        cToken = ICErc20(cTokenAddress); //atualizado
    ...
    function calculateReward(
     ...
     function getBalanceUnder() public view returns(uint256) {

         uint tokens =  cToken.balanceOfUnderlying(address(this));
         return tokens;
     }
...
interface ICErc20 {
    ...
    function balanceOfUnderlying(address sender) external view returns (uint);
