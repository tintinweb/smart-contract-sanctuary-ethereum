...
contract TemplateSafu is Context, IERC20, Ownable {
    ...
    Taxes private _taxes = Taxes(10,5,3,12);
    ...
    string private constant _name = "TemplateSafu";
    ...
    constructor () {
        _feeAddrWallet = payable(0xcCBe02a2D1C4024130Ddd4292f2C7ecd0aB61800);
