...
WEBSITE:
http://thenefarious.io/

DISCORD:
https://discord.com/invite/XR4DH7UZJE

TWITTER:
https://twitter.com/TheNefariousIO

MEDIUM:
https://medium.com/@TheNefarious

TELEGRAM:
https://t.me/NefariousIO
*/
...
contract Nefarious is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nefarious";
    string private constant _symbol = "NEFA";
    ...
    function setFeeAddresses(address devAddress, address marketingAddress)
        public
        onlyOwner
    {
        _feeAddrWallet1 = payable(devAddress);
        _feeAddrWallet2 = payable(marketingAddress);
    }
