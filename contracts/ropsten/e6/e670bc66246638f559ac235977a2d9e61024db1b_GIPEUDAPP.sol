...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x05A84f182b8b24067D4cD0d1d392A3043A1d34a7;
...
contract GIPEUDAPP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA6746DC0D824A267AbB1206C3B7C1952659ABAe0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 990000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GIPEUDAPP";
    ...
    uint256 private numTokensSellToAddToLiquidity = 990000000 * 10**9;
