...
// Flatened File contining all extensions
//contract BILLIONAIRE_CAT_NFT Starts at Line 1350
    ...
    IERC721Enumerable
{
  ...
  //*******************************************//
  // BILLIONAIRE_CAT_NFT Smart Contract ERC-721A Smart Contract
  /*  @dev can see * OpenZeppelin Contracts, utils/Strings.sol
                   * OpenZeppelin Contracts,  access/Ownable.sol
                   * ERC-721A, Creator: Chiru Labs  */



   pragma solidity ^0.8.0;

    contract BILLIONAIRE_CAT_NFT is ERC721A, Ownable {
        using Strings for uint256;

        string public baseURI;
        string public baseExtension = ".json";
        string public notRevealedUri;
        // BILLIONAIRE_CAT_NFT Smart Contract is on BSC network
        //so 1 ether means 1 BNB
        ...
        // Metadata is set to not revealed
      ...
      //BaseUri and NotRevealURI are modifiable
        constructor(
            string memory _name,
       ...
       //public can mint after setonlywhite list is set to false 
        ...
        function mint(uint256 _mintAmount) public payable {
            ...
            if (msg.sender != owner()) {
                ...
                require(msg.value >= cost * _mintAmount, "Insufficient value"); 
    ...
    //only owner Functions
        ...
        //Max mint amount can be  changed
       ...
       // to Pause the  Contract
        ...
        //to withdraw funds to Contract owner functions
