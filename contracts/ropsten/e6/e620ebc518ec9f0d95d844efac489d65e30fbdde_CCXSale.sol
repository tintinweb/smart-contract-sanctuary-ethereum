...
contract CCXSale is Ownable, PoolDaonomicCrowdsale, CountingDaonomicCrowdsale, WhitelistDaonomicCrowdsale, RefundableDaonomicCrowdsale {
  ...
  WhitelistDaonomicCrowdsale(_whitelist) public {
    ...
    registerPool("Test1", 10000, 0, 1, 100);
    registerPool("Test2", 100000, now, 3600, 25);
