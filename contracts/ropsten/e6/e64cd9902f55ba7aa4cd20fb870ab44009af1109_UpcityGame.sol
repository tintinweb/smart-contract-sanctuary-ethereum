...
contract UpcityGame is
	...
	function getBlockStats()
		...
		count[0] = _blockStats[0].count;
		production[0] =
			(_blockStats[0].production * ONE_TOKEN) / PPM_ONE;
		count[1] = _blockStats[1].count;
		production[1] =
			(_blockStats[1].production * ONE_TOKEN) / PPM_ONE;
		count[2] = _blockStats[2].count;
		production[2] =
			(_blockStats[2].production * ONE_TOKEN) / PPM_ONE;
	}
