...
contract PaoToken is ERC20, Lockable {
  ...
  address public address_private_sale = 0x8a7fe9893c63f718Ad066a1dd48458eC47F2FbaD;
  address public address_public_sale = 0x335f318aEE17D5c5852730748Ecd55E2aBFa555b;

  // constructor
  constructor() public {
    balances[msg.sender] = totalSupply_ * 6 / 10;
    balances[address_private_sale] = totalSupply_ * 1 / 10;
    balances[address_public_sale] = totalSupply_ * 3 / 10;
  }
