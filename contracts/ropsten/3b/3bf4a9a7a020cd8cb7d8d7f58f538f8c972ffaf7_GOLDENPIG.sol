...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 USDT = IBEP20(0x07865c6E87B9F70255377e024ace6630C1Eaa37F);
...
contract GOLDENPIG is IBEP20, Auth {
   using SafeMath for uint256;
 
   address USDT = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F;
   address WBNB = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Golden Pig";
   string constant _symbol = "GOLDPIG";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 100; // 1%
   
   //max wallet holding of 10% 
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountBNBMarketing = (amountBNB.mul(marketingFee).div(totalBNBFee)).mul(4).div(4);
