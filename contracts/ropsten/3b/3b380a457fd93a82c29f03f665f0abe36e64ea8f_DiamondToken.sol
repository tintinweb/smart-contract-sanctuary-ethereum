 ...
 */
contract BurnableToken is Burnable, StandardToken, Ownable {
...
contract DiamondToken is CappedToken, PausableToken, BurnableToken {
    string public constant name = "Diamond Token"; // solium-disable-line uppercase
    string public constant symbol = "DT"; // solium-disable-line uppercase
    ...
    */
    ...
    function burn(address _from, uint256 _amount) onlyOwner whenNotPaused public returns (bool) {
