...
contract presabranca4 is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public maxToken = 30;
    uint256 public price = 0.01 ether;

    string private _baseTokenURI;
    string public notRevealedUri = "ipfs://QmRH44MQCGbGDBmVBQMYemWKHWsF9eSyiyEdq5rtg8dkZk/notreveal.json";

    mapping (address => bool) public freeMinted;


    constructor() ERC721A("Presa Branca 4", "PSBNC4") {}
