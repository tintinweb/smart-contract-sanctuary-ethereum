...
contract ArtFungible is ERC721 {
    ...
    function mint(uint256 tokenId,address seller, string memory ipfsHash,uint256 salePrice,SellType sellType, uint256 auctionStart, uint256 auctionExpire ) external returns(uint256){
    ...
    safeTransferFrom(tokenDetails[tokenId].owner,bidDetail[tokenId].bidder,tokenId);
