...
//Controller: Aprovacoes - PetDataControl
contract PetDataControl {
    ...
    constructor(uint256 _feeAbsMax, uint256 _feePropMax) public {
        ...
        minApproval = 1;
        feeAbsMaxGlobal = _feeAbsMax;
        feePropMaxGlobal = _feePropMax;        
    }
    ...
    */
    ...
    modifier onlyMasterOwner() {
        require(ownerMaster == msg.sender, "Only master owner");
        _;
    }    

    modifier notApproved() {
        require(mapApproval[msg.sender] <= 0, "Already approved");
        _;
    }    

    modifier isApproved() {
        require(mapApproval[msg.sender] > 0, "Not approved yet");
        _;
    }
    ...
    */
    function changeMinApproval(uint8 _minApproval) public onlyMasterOwner {
...
contract PetController {
    ...
    */
    ...
    function setTokenAdmin (address _addressToken, address _address) 
        public onlyOwner onlyApproved returns (address) 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
        address add = token.setAdmin(_address);
        return add;      
    }

    function setTokenAudit (address _addressToken, address _address) 
        public onlyOwner onlyApproved returns (address) 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
        address add = token.setAudit(_address);
        return add;      
    }

    function setTokenMarketMaker (address _addressToken, address _address) 
        public onlyOwner onlyApproved returns (address) 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
        address add = token.setMarketMaker(_address);
        return add;      
    }

    function setTokenMintFeeReceiver (address _addressToken, address _address) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenTransferFeeReceiver (address _addressToken, address _address) 
        public onlyApproved
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenBurnFeeReceiver (address _addressToken, address _address) 
        public  //onlyApproved //onlyOwner
    {
        //dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenMintFeeAbs (address _addressToken, uint256 _value) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenMintFeeProp (address _addressToken, uint256 _value) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenTransferFeeAbs (address _addressToken, uint256 _value) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenTransferFeeProp (address _addressToken, uint256 _value) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenBurnFeeAbs (address _addressToken, uint256 _value) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenBurnFeeProp (address _addressToken, uint256 _value) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
    ...
    function setTokenMintApproveReset (address _addressToken, address _address) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
        token.mintApproveReset(_address);
    }

    function setTokenBurnApproveReset (address _addressToken, address _address) 
        public onlyApproved 
    {
        dataControl.resetAllApproval();
        PetToken token = PetToken(_addressToken);
        token.burnApproveReset(_address);
    }
