...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    // Token name
    string private _name = "Moonable Abstracts";
    ...
    string private baseExtension = ".jpeg";
    ...
    function mint(uint256 amount) external payable {
        require(currentSupply + amount <= maxSupply, "Total Supply would be exceeded");
        require(amount * mintPrice <= msg.value, "Not enough payed");
