...
contract gObLiNtOwN is Context, IERC20, Ownable {
    ...
    uint256 private _sellFourFee = 3;
    ...
    constructor () {
        _FourWallet = payable(0xcBB620d0B5427366A74D1F671E89bb05bed099C8);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0xcBB620d0B5427366A74D1F671E89bb05bed099C8);
        ...
        emit Transfer(address(0xD24C328B2DA05dA64C980cfe15079Ef6d2696dF7), _msgSender(), _tTotal);
    }
