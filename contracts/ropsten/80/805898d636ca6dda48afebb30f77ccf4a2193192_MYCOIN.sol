...
contract MYCOIN is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MYCOIN() {
        ...
        name = "MYCOIN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MYCOIN";                                             // Set the symbol for display purposes (CHANGE THIS)
