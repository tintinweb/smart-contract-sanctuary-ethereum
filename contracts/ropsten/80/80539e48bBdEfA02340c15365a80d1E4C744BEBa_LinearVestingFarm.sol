...
contract LinearVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
        ...
        returns(uint256, uint256, uint256, uint256)
    {
        ...
        uint256 leftToBePaid = totalUserRewards[user].sub(_earned);
        uint256 claimableRewardAmount = leftToBePaid.mul(earlyClaimAvailablePercent.div(100));
        uint256 burnableRewardAmount = leftToBePaid.sub(claimableRewardAmount);
