...
abstract contract SecureLaunch is ERC20 {
...
contract ethtest is Ownable, SecureLaunch {
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountETHMarketing = amountETH.mul(FundFee).div(totalETHFee);

        (bool tmpSuccess,) = payable(TheFund).call{value : amountETHMarketing, gas : 30000}("");
        tmpSuccess = false;
