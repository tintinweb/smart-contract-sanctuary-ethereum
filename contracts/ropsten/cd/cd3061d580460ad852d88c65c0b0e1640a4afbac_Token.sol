...
contract Token is Ownable{
    ...
    event Mint(address indexed to, uint256 value, uint256 balanceBefore, uint256 balanceAfter, uint256 supplyBefore, uint256 supplyAfter);
    event Burn(address indexed from, uint256 value, uint256 balanceBefore, uint256 balanceAfter, uint256 supplyBefore, uint256 supplyAfter);
    ...
    function _mint(address _to, uint256 _value) internal{
        ...
        emit Mint(_to, _value, balanceBefore, balanceAfter, supplyBefore, supplyAfter);
    }
    ...
    function _burn(address _from, uint256 _value) internal{
        ...
        emit Burn(_from, _value, balanceBefore, balanceAfter, supplyBefore, supplyAfter);
    }
