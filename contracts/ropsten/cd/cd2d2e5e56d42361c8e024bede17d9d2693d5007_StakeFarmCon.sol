...
contract StakeFarmCon is Ownable{
   using SafeERC20 for IERC20; // Wrappers around ERC20 operations that throw on failure
    ...
    struct Pool {
        uint256 poolId;
        IswapV2ERC20 stakeToken; // Token to be staked
     ...
     */
    function createPool(IswapV2ERC20 _stakeToken) external onlyOwner {
        Pool memory pool;
    ...
    function deposit(uint256 _poolId, uint256 _amount,uint256 _amount2) external {
        ...
        // _amount2 = _amount2 / 10 ** 18;

        pool.stakeToken.transferFrom(address(msg.sender),address(this),_amount2);
    }
