...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "[xtkn220010][ownable] caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "[xtkn220010][ownable] new owner is the zero address");
...
abstract contract Team is Context, Ownable{
    ...
    modifier onlyTeam(){
        require(_isTeamMember(_msgSender()), "[xtkn220010][team] only team can access this function!");
        _;
    }
...
contract XTKN220010 is Context, IERC20, Ownable, ReentrancyGuard, Team{
    // lib
    ...
    // tokenomics
        string private _name = "XTKN220010";
        string private _symbol = "XTKN220010";
    ...
    function setTaxesBuy(uint16 pMarketing, uint16 pDev, uint16 pBurn) public onlyTeam{
        require((pMarketing + pDev + pBurn) <= 100, "[xtkn220010] sum of all taxes can't exceed 10%!");
        TAX_BUY_MARKETING = (
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[xtkn220010] approve from the zero address");
        require(spender != address(0), "[xtkn220010] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[xtkn220010] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[xtkn220010] transfer amount exceeds allowance"));
        return(true);
    }
