...
contract OKToken is StandardToken, Ownable {
  string constant public name = "OK Token";
  string constant public symbol = "OKT";
  uint8 constant public decimals = 18;

  constructor() public {
    totalSupply_ = 1 * 10 ** 10 * (10 ** uint(decimals)); // total supply is 10 billion
