...
// File: Contracts/PITTEST.sol
    ...
    contract QUASssSY is Ownable, ERC721A {
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmdyK6xjNh5ZFMmKPEcMFEJvjmo7kafFQhAGTt2S1X6Qow/";
    string public constant baseExtension = ".json";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("QSSDOT", "QSSDOT") {_safeMint(msg.sender, 1); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmdbwwuD6K3U4AgeGQhVSddk1vQh6Wye5M793WvBEnjNbv/1.json");}
