...
contract NFT is ERC721URIStorage, Ownable {
  ...
  constructor(address marketplaceAddress) ERC721("Straym Tokens", "STT") {
  ...
  function createToken(string memory tokenURI, address feeReceiver, uint256 fee)
    public
    payable
    mintPriceCompliance()
    returns (uint256)
  {
    ...
    if (address(this).balance >= fee) {
      // =============================================================================
      (bool hs, ) = payable(feeReceiver).call{value: fee}('');
      require(hs);
      // =============================================================================
    }    
