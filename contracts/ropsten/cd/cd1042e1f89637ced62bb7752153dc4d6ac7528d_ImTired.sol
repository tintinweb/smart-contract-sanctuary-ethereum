...
contract ImTired is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintOneTime = 10;
  ...
  ) ERC721("archimedes123","archimedessymbol") {
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    require(saleConfig.saleIsOn,"sale is not on.");
  ...
  //only owner
  function setCost(uint64 _newPublicPriceWel) public onlyOwner {
    saleConfig.publicSalePriceWei = _newPublicPriceWel;
  }
  ...
  function setFreeMintCount(uint32 _newFreeMintCount) public onlyOwner{
      saleConfig.freeMintCount = _newFreeMintCount;
  }
  function setmaxMintAmount(uint256 _newmaxMintAmount) public onlyOwner {
    maxMintOneTime = _newmaxMintAmount;
  }
