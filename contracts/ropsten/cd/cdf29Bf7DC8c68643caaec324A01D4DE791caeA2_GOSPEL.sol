...
contract GOSPEL is Context, IERC20, Ownable {
    using Address for address;

    string private constant _name = "GOSPEL"; 
    string private constant _symbol = "$GSPL"; 
    ...
    address public _marketingWallet = 0x6dB7e3CAE0cFf6f5ECA04c356c38df298A9677Db;
