...
contract Dininho is ERC721, Ownable {
    ...
    constructor() ERC721("Dininho", "DNH") {
    ...
    function freeMint() external {
        require(isSalesActive, "Dininho sale is not active yet");
    ...
    function mint(uint quantity) external payable {
        ...
        require(totalSupply() + quantity <= MAX_SUPPLY, "Dininho Sold Out");
