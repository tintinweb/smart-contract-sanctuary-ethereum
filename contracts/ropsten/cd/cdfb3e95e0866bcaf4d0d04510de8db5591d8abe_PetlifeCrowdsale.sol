...
contract PetlifeCrowdsale is MintedCrowdsale, FinalizableCrowdsale {
  ...
  uint256 public saleCap = 77554959 * 10 ** 18;
  // ===================
  ...
  function finish(address _teamFund, address _reserveFund, address _bountyFund, address _advisoryFund) public onlyOwner {
      ...
      uint256 tokensForTeam = alreadyMinted * 15/100;
      uint256 tokensForBounty = alreadyMinted * 2/100;
      uint256 tokensForReserve = alreadyMinted * 175/1000;
      uint256 tokensForAdvisors = alreadyMinted * 35/1000;
