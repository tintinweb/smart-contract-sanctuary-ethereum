...
contract Forma is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    
    string public FORMA_ORIGIN = "";
    ...
    constructor() ERC721("GenMAP Forma", "Forma") {}
    ...
    */
    function mint(uint256 _count) public payable {
        ...
        require(totalSupply.add(_count) < MAX_TOKENS + 1, "Exceeds maximum tokens available for purchase");
