    ...
    UUPSUpgradeable
{
    ...
    * @param _tier The tier to stake (tier 0 to tier 2).
    ...
    function removeStakeInternal(address _stakeholderAddress, uint256 _stake, uint8 _tier, bool _isOverride, bool _isWaivePenalty) internal { 
        ...
        // * Take note that penalty amount is ALWAYS deducted from the unstaking amount (rounding down to the nearest 1 RLT)
        ...
        uint256 penaltyAmount = _isWaivePenalty ? 0 : _stake * 3 / 100 / (10**decimals()) * (10**decimals());
