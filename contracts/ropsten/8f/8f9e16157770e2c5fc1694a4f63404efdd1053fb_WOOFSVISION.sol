...
contract WOOFSVISION is Context, IERC20, ERC20Ownable {
    ...
    constructor() payable {
        ...
        MarketingAddress = payable(0x130e187946ADB81b25338D3BFF1c5b9512A4844F); 
        AppDevelopAddress = payable(0x130e187946ADB81b25338D3BFF1c5b9512A4844F); 
        DevAddress = payable(0x130e187946ADB81b25338D3BFF1c5b9512A4844F); 
        // Replace with your Public ETH Address
