...
contract TestCrispyStaker is CrispyStaker {
    ...
    function _registerOpenStake(uint256 _tokenId, uint256 _stakeIndex) internal override {
        ...
        require(
            _stakeIndex == _getHexToken().stakeCount(address(this)) - 1,
    ...
    function _getStakeId(uint256 _stakeIndex) internal view returns (uint256) {
        (uint256 stakeId, , , , , , ) = _getHexToken().stakeLists(address(this), _stakeIndex);
        return stakeId;
    }
}
...
contract CrispyStaker is ERC721, DualFeeTaker, ICrispyStaker {
    ...
    function unstakeMany(uint256[] calldata _tokenIds) external {
        uint256 lastStakeIndex = _getHexToken().stakeCount(address(this)) - 1;
    ...
    function unstake(uint256 _tokenId) external {
        _redeemToken(_tokenId, _getHexToken().stakeCount(address(this)) - 1);
    }
    ...
    function _createStakesFor(
        ...
        uint256 firstStakeIndex = _getHexToken().stakeCount(address(this));
    ...
    function _createStakeFor(
        ...
        _issueNewTokenFor(
            ...
            _stakeDays,
            newTokenId,
            _getHexToken().stakeCount(address(this))
        );
    ...
    function _openStake(
        ...
        _getHexToken().stakeStart(_stakeAmount, _stakeDays);
    ...
    function _closeStake(
        ...
        _getHexToken().stakeEnd(stakeIndex, stakeId);
        ...
        )
    {
        ...
        (stakeId, stakedHearts, stakeShares, lockedDay, stakedDays, unlockedDay, ) = _getHexToken()
            .stakeLists(address(this), stakeIndex);
    }

    /**
     * @dev get the amount of days past a certain reference timestamp
     ...
     */
    function _getHexToken() internal view returns (IHex) {
