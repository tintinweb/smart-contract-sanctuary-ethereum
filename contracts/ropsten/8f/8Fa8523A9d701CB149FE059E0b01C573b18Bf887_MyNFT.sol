...
contract MyNFT is ERC721A, Ownable {
    ...
    uint256 public MAX_FREE_SUPPLY = 400;
    ...
    function freeMint(uint256 numberOfTokens) external {
        ...
        // require(numberOfTokens <= MAX_MINT, "The requested number is more than the possible value.");
        require(addressClaimed[_msgSender()] + numberOfTokens <= MAX_MINT, "You have already received your max NFTs.");
    ...
    function claim(address[] memory _addresses, uint256 numberOfTokens) external onlyOwner {
        for (uint i = 0; i < _addresses.length; i++) {
            ...
            addressClaimed[_addresses[i]] += numberOfTokens;
        }
    }
