...
contract CTZN is ERC20, ReentrancyGuard, Ownable
{
    ...
    event RewardRatesChanged(uint ProjectID, uint[] RewardRates);
     ...
     */
    function __ChangeRewardRates(uint ProjectID, uint[] calldata RewardRates) external onlyOwner
    {
        IBRT(BRTContracts[ProjectID].ContractAddress).ModifyRewardRates(RewardRates);
        emit RewardRatesChanged(ProjectID, RewardRates);
    }
