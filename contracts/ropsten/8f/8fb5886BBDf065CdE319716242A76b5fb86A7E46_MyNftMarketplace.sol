...
contract MyNftMarketplace {
    ...
    function makeOffer(uint _id, uint _price) external {
        ...
        emit OfferCreated(msg.sender, offerId, _id, _price, false, false);
    }
    ...
    function fillOffer(uint _offerId) external payable {
        ...
        emit OfferFilled(msg.sender, _offerId, _offer.id);
        emit Earned(_offer.user, _offerId, _offer.id, _offer.price);
    ...
    function cancelOffer(uint _offerId) external {
        ...
        emit OfferCancelled(msg.sender, _offerId, _offer.id);
