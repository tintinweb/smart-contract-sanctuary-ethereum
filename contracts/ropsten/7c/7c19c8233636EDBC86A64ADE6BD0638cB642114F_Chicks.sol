...
contract Chicks is ERC20, Ownable {
    ...
    constructor(
        ...
        require(initialBalance > 0, "Chicks: Supply cannot be zero");
    ...
    function setService(address value) external onlyOwner {
        ...
        require(value != address(0) && value != oldServiceAddress, "Chicks: Invalid Service Address");
    ...
    function setPresale(address value) external onlyOwner {
        ...
        require(value != address(0) && value != oldPresaleAddress, "Chicks: Invalid Presale Address");
    ...
    function setFee(uint16 feePercent) external onlyOwner {
        require(feePercent != 0 && feePercent <= 900, "Chicks: Invalid Fee Percentage");

        uint16 oldFeePercent = s_feePercent;
        require(oldFeePercent != feePercent, "Chicks: new fee percentage unchanged");
    ...
    function mint(address account, uint256 amount) external onlyOwner {
        require(!s_canMint, "Chicks: minting is finished");
    ...
    function setMint(bool _canMint) external onlyOwner {
        ...
        require(oldStatus != newStatus, "Chicks: new mint status unchanged");
    ...
    function _mint(address account, uint256 amount) internal override {
        ...
        if(s_mintingFinished){
            ...
            require(afterTotalSupply <= MAX_TOTAL_SUPPLY_LIMIT, "Chicks: total supply was limited");
        }
    ...
    function setMintingFinished(bool _mintingFinished) external onlyOwner {
        ...
        require(oldMintingFinished != _mintingFinished, "Chicks: new minting_finished flag unchanged");
