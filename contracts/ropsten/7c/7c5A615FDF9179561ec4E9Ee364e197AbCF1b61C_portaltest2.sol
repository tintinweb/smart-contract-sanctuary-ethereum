...
contract portaltest2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "portaltest1";
    string private _symbol = "LIGHTportYEAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x30857853e8B985bbC1dcB300eE0d71E39Fc3aa7e); // Marketing Address
    address payable public lotteryWalletAddress = payable(0x25645826E0a5737dC36b4E8FE2a478429FfC2583); // Lottery Address
    ...
    uint256 public _sellLotteryFee = 8;
