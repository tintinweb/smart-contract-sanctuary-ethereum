...
contract Sunny is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Sunny() {
        ...
        name = "Sunny";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 0;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "S";                                             // Set the symbol for display purposes (CHANGE THIS)
