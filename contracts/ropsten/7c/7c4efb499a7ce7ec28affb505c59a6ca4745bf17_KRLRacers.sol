...
contract KRLRacers is ERC721A,  Ownable {
    ...
    uint256 public HOLDER_SALE_START_TIME=1663617600;
    uint256 public HOLDER_SALE_END_TIME=1664481600;
    ...
    function availableForAllowlist() public view  returns(uint256){
        require(whenAllowlistSaleIsOn()==true,"whites ale not start yet" );
    ...
    function holderMintNew(uint256 quantity, bytes calldata signature) public payable  {
        require(whenAllowlistSaleIsOn()==true,"Holder sale is not ON");
    ...
    function allowListMint(uint256 quantity, bytes32[] calldata proof) public payable  {
         require(whenAllowlistSaleIsOn()==true,"white sale not start yet" );
