...
contract RenteroERC721 is IRentero, ERC721, ERC721Holder {
    ...
    function setDelegator(uint256 tokenId, address delegator) public virtual override {
    ...
    function stake(uint256 tokenId, address owner) public virtual override {
    ...
    function canUseToken(address operator, uint256 tokenId) public view virtual override returns (bool) {
        // token in use
        UserInfo memory info = _tokenIdToUserInfo[tokenId];
