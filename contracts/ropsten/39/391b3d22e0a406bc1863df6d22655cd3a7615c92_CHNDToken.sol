...
contract CHNDToken is ERC1404, ERC20, ERC20Detailed, Whitelistable, Restrictable {

    // Token Details
    string constant TOKEN_NAME = "ChinaDream";
    string constant TOKEN_SYMBOL = "CHND";
    uint8 constant TOKEN_DECIMALS = 18;

    // Token supply - 1.5 Billion Tokens, with 18 decimal precision
    uint256 constant HUNDRED_MILLION = 100000000;
    uint256 constant TOKEN_SUPPLY = 14 * HUNDRED_MILLION * (10 ** uint256(TOKEN_DECIMALS));
