...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
        ...
        _approve(address(this), address(uniswapRouter), tokenAmount / 2);
...
contract Mizuchi is ERC20Decimals, ERC20Burnable {
    ...
    constructor() ERC20("Mizuchi", "Mizuchi") ERC20Decimals(18) {
    ...
    function airDrop(AirDrop[] memory list) external onlyOwner {
