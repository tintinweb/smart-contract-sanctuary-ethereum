...
contract USDC9TestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    constructor() {
        ...
        name = "USDC TEST 1";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "USDC9";                                             // Set the symbol for display purposes (CHANGE THIS)
