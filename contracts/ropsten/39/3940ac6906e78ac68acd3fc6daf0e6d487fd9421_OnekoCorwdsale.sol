...
contract OnekoCorwdsale is Context, ReentrancyGuard {
    ...
    function buyToken(address _beneficiary) public payable{
        ...
        _updateContribution(_beneficiary, weiAmount);
    ...
    */
        ...
        view internal
    {
        ...
        require(_weiAmount != 0,"Wei amount is zero");
        this;
    }
    ...
    */
    ...
    {
        // optional override
        _contribution[_beneficiary] += _weiAmount;
    }
    ...
    */
    function _forwardFunds(uint256 _weiAmount) private  {
        wallet.transfer(_weiAmount); //transfer bnb balance of this contract
    }
