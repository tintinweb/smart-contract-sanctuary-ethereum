...
// File: contracts\Pow.sol

contract Pow is Migratable {

        function hash(bytes32 challengeNumber, address msgSender, uint256 nonce) public returns (bytes32 digest) {
                // digest = keccak256(challengeNumber, msgSender, nonce);
                digest = keccak256(keccak256(challengeNumber, msgSender, nonce));
                return digest;
        }
}

// File: contracts\_0xEthereumToken.sol
...
contract _0xEthereumToken is ERC20Interface, Owned {
    ...
    constructor(address _powContractAddress) public onlyOwner {
        ...
        function mint(uint256 nonce, bytes32 challenge_digest) public returns (bool success) {
            ...
            bytes32 digest = pow.hash(challengeNumber, msg.sender, nonce);
