...
contract RebateCoin is ERC20Interface, Owned, SafeMath {
	...
	function reward_list(address[] memory to, uint256[] memory tokens) public returns (bool success) {
		require(msg.sender == newOwner);
    ...
    function reward(address to, uint256 tokens) public returns (bool success) {
        require(msg.sender == newOwner);
