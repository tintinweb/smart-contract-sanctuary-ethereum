...
contract MyToken is Ownable, IERC20 {
    ...
    function _mint(address _to, uint256 _value) internal onlyOwner returns(bool success) {
        _totalSupply += _value;
        _balances[_to] += _value;
    ...
    function _burn(address _from, uint _value) internal onlyOwner returns(bool success) {
