...
contract NehalCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NehalCoin() {
        ...
        name = "NehalCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-060";                                             // Set the symbol for display purposes (CHANGE THIS)
