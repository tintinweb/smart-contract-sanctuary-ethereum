...
contract KamuToken is Ownable {
    using SafeMath for uint256;

    string public name = "Kamu";           //The Token's name: e.g. DigixDAO Tokens
    uint8 public decimals = 8;             //Number of decimals of the smallest unit
    string public symbol = "KAU";         //An identifier: e.g. REP
...
////////////////
    ...
    /// @notice Constructor to create a KamuToken
    function KamuToken() public {
        totalSupply = 50000000e8;
