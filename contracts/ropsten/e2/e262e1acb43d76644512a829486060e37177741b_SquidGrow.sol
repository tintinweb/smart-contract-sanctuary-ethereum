...
contract SquidGrow  is IBEP20, Auth {
    ...
    uint256 private _totalSupply = 6 * 10**14 * (10 ** _decimals); // 60% of BSC total supply
    ...
    constructor(address bridge) Auth(msg.sender) {
        ...
        _balances[bridge] = _totalSupply;
        emit Transfer(address(0), bridge, _totalSupply);
    }
