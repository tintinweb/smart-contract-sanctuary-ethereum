...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable Birdoshi = address(0xBd120cc55FE95132eB757E67e08c8a81Bb34C168); //UNI
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            IERC20(Birdoshi).transfer(shareholder, amount);
        }
    }
...
contract BankOfBirdoshi is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Bank Of Bird";
    string private constant _symbol = "Bird BANK";
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForBirdoshi(amountToSwap.div(2));

        uint256 dividends = IERC20(Birdoshi).balanceOf(address(this));

        bool success = IERC20(Birdoshi).transfer(address(distributor), dividends);
    ...
    function swapTokensForBirdoshi(uint256 tokenAmount) private {
