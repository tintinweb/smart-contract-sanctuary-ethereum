...
contract CrtrToken is ERC20, AccessControl {
    ...
    event WithDrawToken(address _addr, uint _amount);
     ...
     constructor() ERC20("Creator", "CRTR"){
        ...
        //TODO msg.sender update to admin address
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _mint(address(this), 2000000000 * 10 ** decimals());

         _preSales(address(0x21C19ca41f191153bc592B20BE183CE89b42ed38),40000000);
         //seed
         _seed_private(address(0xc5cDAf6Fb0250177E6cd00D4049897Ef97a11C5c),80000000,4000000);
         //private
         _seed_private(address(0xd1cf1a6019F90878F7f60e7877C476e78488eF68),280000000,14000000);
        //foundation
         _lockTokens(address(0x2E99BFcCD94d226b6a3E799A4f41DD6fEC1c2493),12,48,300000000,30 days);
        //tech
         _lockTokens(address(0x4a0ab5C1CeE71Acb65833022a20B2A6f68E9B277),10,48,200000000,30 days);
        //partners
         _lockTokens(address(0x5daF087b8783Da1cCa8431c02907e1Cbe3336BF8),6,54,200000000,30 days);
        //ecosystem
         _lockTokens(address(0x90E35b1Fd3f0fC693AA86B26C1ebAD589EE6fcd1),0,59,760000000,30 days);
        //marketing
         _lockTokens(address(0xdD1F1026b40235fd7F36c4413549480780E6154C),0,59,100000000,30 days);
        //liquidity
         _lockTokens(address(0x446A3074893138225eAe7ce7e54EDC537b688Bc9),0,8,40000000,90 days);
    }
