  ...
  ERC721Status
{
  ...
  event Bought(address indexed from, address indexed to, uint256 indexed tokenId, uint256 price);
  ...
  function firstBuy() public payable {
      ...
      emit Bought(address(0), _msgSender(), _tokenIdTracker.current(), _price);
      _tokenIdTracker.increment();
  }
  ...
  function secondBuy(uint256 tokenId, address payable from) public payable {
      ...
      emit Bought(from, _msgSender(), tokenId, _sale[tokenId]);
      _sale[tokenId] = 0;
  }
