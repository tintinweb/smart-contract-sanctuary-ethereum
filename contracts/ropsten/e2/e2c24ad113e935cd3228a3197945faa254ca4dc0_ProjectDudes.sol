...
contract ProjectDudes is Ownable, ERC721A, ReentrancyGuard {
    ...
    string public notRevealedUri = "ipfs://QmZqE2YFmUkHRaiXbHdbEUVisHeqL7GwJKTGFNwRB658Ed/TLG_Unrevealed.png";
    ...
    function publicMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(quantity <= MAX_MINTS_PER_TX, "Quantity too high");
