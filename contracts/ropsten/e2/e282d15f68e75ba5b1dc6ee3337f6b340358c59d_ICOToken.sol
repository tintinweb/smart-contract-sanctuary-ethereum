...
// File: contracts/zeppelin/token/ERC20Pausable.sol
...
*/
    constructor(string name, string symbol, uint8 decimals, address adminAdress, uint256 totalSupply) 
    public
    notTokenAddress(adminAdress)
    {
        require(adminAdress != address(this), "`Invaid address");
