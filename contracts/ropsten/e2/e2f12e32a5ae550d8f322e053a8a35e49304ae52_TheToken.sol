...
pragma solidity ^0.6.12;
    ...
    contract TheToken is Context, IERC20, Ownable {
        ...
        address public marketingWallet = 0x11f370DF4503c43058b166c14b01ee5808ec0510;
        address public devWallet = 0xB176A0cBde26ab65743a509c6474d4be54E036d8;
        address public teamWallet = 0x9CfdbB2657413eAa36b9e1a1C7249b8F9473d67c;
        ...
        constructor() public {
           ...
           emit Transfer(address(0), _msgSender(), _rTotal.div(10**2).mul(65));
           emit Transfer(address(0), address(this), _rTotal.div(10**2).mul(25));
           emit Transfer(address(0), teamWallet, _rTotal.div(10**2).mul(10));    
        ...
        function excludeFromLimitHolder(address account) public onlyOwner {
            _isExcludedFromLimitHolder[account] = true;
        }
        
        function includeInLimitHolder(address account) public onlyOwner {
            _isExcludedFromLimitHolder[account] = false;
        }
