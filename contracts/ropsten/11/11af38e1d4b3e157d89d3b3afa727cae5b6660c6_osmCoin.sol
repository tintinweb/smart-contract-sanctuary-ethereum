...
contract osmCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function osmCoin() {
        ...
        name = "osmCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT2018082";                                             // Set the symbol for display purposes (CHANGE THIS)
