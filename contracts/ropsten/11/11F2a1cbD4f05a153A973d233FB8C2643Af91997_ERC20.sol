...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable{
    ...
    function _transfer(
        ...
        require((block.timestamp > closingTime) || ((to == owner()) || (from == address(this)) || (to == address(this))),"Metaland tokens may not be transacted until the presale period ends");
