...
contract AGCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AGCoin() {
        ...
        name = "AGCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "AGC";                                             // Set the symbol for display purposes (CHANGE THIS)
