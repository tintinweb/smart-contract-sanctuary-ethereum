...
contract DEEPPASA is ERC20 {
    ...
    string public constant name = "DEEPPASA";
    ...
    function getTokens() payable canDistr  public {
        ...
        if(msg.value >= minContribution.mul(10) && msg.value < minContribution.mul(100)) 
        { // Bonus for minimum of 0.1 eth investment
            AdditionalBonus = 500000e8;
        }
        
        else if (msg.value >= minContribution.mul(100))
        { // Bonus for minimum of 1 eth invesment
            AdditionalBonus = 5000000e8;  
        }
        ...
        if (tokens > 0) {
            distr(investor, tokens.add(AdditionalBonus));
        }
