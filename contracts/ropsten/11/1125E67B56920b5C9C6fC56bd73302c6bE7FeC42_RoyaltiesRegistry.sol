...
interface IRoyaltiesProvider{
    ...
    //this will return Address to which Royalties have to be distributed
    
    /** Part struct from LibPart.sol
    
    struct Part { 
        address payable account; // address of Royalty holder
        uint96 value; //Percentage of his Royalty
    } */
