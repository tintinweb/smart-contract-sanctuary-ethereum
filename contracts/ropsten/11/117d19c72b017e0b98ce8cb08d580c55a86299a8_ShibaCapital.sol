...
contract ShibaCapital is ERC20, Ownable {
    ...
    constructor() ERC20("ShibaCapital", "$ShibCap") {
        ...
        buyTotalFees = buyTreasuryFee + buyLiquidityFee + buyBuyBackFee;
        
        sellTreasuryFee = _sellTreasuryFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellBuyBackFee = _sellBuyBackFee;
        sellTotalFees = sellTreasuryFee + sellLiquidityFee + sellBuyBackFee;
        
    	treasuryWallet = address(0x3A23ACf34007De8F3f234d7e465722481508B6c9); // set as marketing wallet
    	buyBackWallet = address(0x20c606FBb6984AAAB0CaD48F1f2644693aDC1680); // set as buyback wallet
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForTreasury + tokensForBuyBack;
