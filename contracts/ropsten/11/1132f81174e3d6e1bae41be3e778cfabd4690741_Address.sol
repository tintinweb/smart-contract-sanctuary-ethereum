...
library ECDSA {
     ...
     *
     * //ANT: `hash` _must_ be the result of a hash operation for the
...
contract BaseFixedPriceAuctionERC721A is ERC721A, Ownable {
    using Strings for uint256;
...
// "./BaseFixedPriceAuctionERC721A.sol";
...
contract dogshit {
    ...
    uint256 dogwater=0;
    function pieceofshit(uint256 dogwater) public returns(uint256) {
        return dogwater += 1;
    }   
}