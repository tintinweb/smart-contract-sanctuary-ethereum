...
contract DataChunkCompiler {
    ...
    string public constant BEGIN_SCRIPT_DATA = "<script src='";
    string public constant END_SCRIPT_DATA = "'></script>";
    string public constant BEGIN_SCRIPT_DATA_COMPRESSED = "<script>var data = base64ToBytes('";
    string public constant END_SCRIPT_DATA_COMPRESSED = "'); var unzipped = fflate.gunzipSync(data); var text = fflate.strFromU8(unzipped); var b64 = btoa(text); var script = document.createElement('script'); script.setAttribute('src','data:text/javascript;base64,' + b64); document.head.appendChild(script)</script>";
