...
//
// author: Gifto Team
// Contact: <a href=/cdn-cgi/l/email-protection class=__cf_email__ data-cfemail=d9bdb8adaeb1b7beaca0bcb799beb4b8b0b5f7bab6b4>[email&#160;protected]</a>
...
contract Gifto is ERC20Interface {
    ...
    uint256 public _totalSupply = 10 ** 27; // total supply is 10^14 unit, equivalent to 10^9 Gifto
    uint256 public _originalBuyPrice = 43 * 10**20; // original buy 1ETH = 4300 Gifto = 43 * 10**7 unit
