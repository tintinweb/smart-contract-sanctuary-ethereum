...
contract WOOFYINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x33227a957085Ab3ba478767B335cbB2641B59398); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x33227a957085Ab3ba478767B335cbB2641B59398); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 333 * 10**11 * 10**9;
    uint256 public _walletMax = 333 * 10**11 * 10**9;
    uint256 private minimumTokensBeforeSwap = 333 * 10**11 * 10**9; 
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (20 * 10**11 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
