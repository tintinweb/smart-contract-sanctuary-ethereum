...
contract TopMinter is MasterCopy,Ownable,ERC721Full,ReentrancyGuard,ITopMinterSetup,RadicalNFT {
    ...
    function setup_constructor(string calldata name,string calldata symbol,
        ...
        nftPriceinETH=nftPriceinETH*0.01 ether/100;
...
;
        ...
        external payable
    {
        ...
        require(msg.value>=nftPriceinETH, "ERR_NOT_ENOUGH_MONEY");
        //refund extra money
        msg.sender.send(msg.value-nftPriceinETH);
    ...
    {
        merkleRoot=_mr;
        nftPriceinETH=_nftWLPriceinETH*0.01 ether/100;
    ...
    function WLMint(uint256 index, address account, uint256 amount, bytes32[] calldata merkleProof) external payable  {
        ...
        require(curid<nftNumber,"nftNumber reached");
        require(msg.value>=nftWLPriceinETH, "ERR_NOT_ENOUGH_MONEY");

        //refund extra money
         msg.sender.send(msg.value-nftWLPriceinETH);
