...
contract SquidGrowETHBridgeContract is Ownable {
    ...
    address payable public system = payable(0x2D8FB34ad3fb35CcBC5906B309686131666B0334);
    address public governor = address(0x2D8FB34ad3fb35CcBC5906B309686131666B0334);
    address public bridgeFeesAddress = address(0x2D8FB34ad3fb35CcBC5906B309686131666B0334);
    ...
    constructor() {
        ...
        _processFees[97] = 0.01 ether;
        supportedTargetChains[97] = true;

        emit TargetChainAdded(97, block.timestamp);
    }
    ...
    function _sendBSC(address _receipient, uint256 _amount) internal {
