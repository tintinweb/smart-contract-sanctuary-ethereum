...
contract thedumpster is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name ="thedumpster";
    ...
    address payable private _marketingAddress = payable(0x416904eFc71cB252e9CDfdF30cbE2BBAD8C86E7C);
