    ...
    */
    function _getTokenAmount(uint256 weiAmount)
      internal view returns (uint256)
      {
        ...
        uint256 PreICOendingTime = PreICOstartingTime+150;

        /*//Stage1
        uint256 Stage1startingTime = ; //
        uint256 Stage1endingTime = ; //

        //Stage2
        uint256 Stage2startingTime = ; //
        uint256 Stage2endingTime = ; //

        //Stage3
        uint256 Stage3startingTime = ; //
        uint256 Stage3endingTime = ; //

        //LastStage
        uint256 LastStagestartingTime = ; //
        uint256 LastStageendingTime = 1549738800; //*/
...
contract TradePlaceCrowdsale is CappedCrowdsale, RefundableCrowdsale, MintedCrowdsale {
    ...
    uint256 startingTime = now+500; //Mon Oct 29 2018 00:00:00 GMT+0500
    uint256 endingTime = startingTime + 600; //Sun Feb 10 2019 00:00:00 GMT+0500
