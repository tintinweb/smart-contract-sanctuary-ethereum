 ...
 */
contract RHEM_TEST3 is Ownable, ERC20Interface {
    
    using SafeMath for uint256;
    
    string public constant symbol = "RT3";
    string public constant name = "RT3";
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        assert(balances[_to].add(_value) >= balances[_to]);
