...
contract Pollen  {
    ...
    function stake(uint256 amount, uint256 period ) public returns (uint) {
       ...
       //  DAI.transferFrom(msg.sender, pollenVault, amount);
   ...
   function unstake(address _owner, uint256 tokenIndex) public  {
       ...
       if(staked.period == 1) {
                ...
                stakeOption   =  staked.startTimestamp + 20 minutes;
       }
