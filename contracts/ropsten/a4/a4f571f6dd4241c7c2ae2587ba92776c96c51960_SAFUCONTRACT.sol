...
contract SAFUCONTRACT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**5 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0xf10a65Fe6c71F9dED588fc3ae78d12f69Bb358FD));


    string private _name = "DEBLENG TOKEN";
    string private _symbol = "DEBELENG TOKEN";
