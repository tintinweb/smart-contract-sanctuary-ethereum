...
import "./PermitVault.sol";
import "@openzeppelin/contracts/utils/Create2.sol";

contract PermitVaultDeployer {
    /**
     * @notice Deployment of the {PermitVault}.
     */
    function deploy(bytes32 salt) public {
        Create2.deploy(0, salt, type(PermitVault).creationCode);
    }
    ...
    function computeAddress(bytes32 salt) public view returns (address) {
        return Create2.computeAddress(salt, keccak256(type(PermitVault).creationCode));
    }
}
