...
contract SPACEWORM is ERC20, Ownable {
    ...
    constructor() ERC20("SPACEWORM", "SPACEW") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xbd0a5CA420EF9802200447788f93c7F827AA36f8); // marketing wallet
        devWallet = address(0xbd0a5CA420EF9802200447788f93c7F827AA36f8); // dev wallet
