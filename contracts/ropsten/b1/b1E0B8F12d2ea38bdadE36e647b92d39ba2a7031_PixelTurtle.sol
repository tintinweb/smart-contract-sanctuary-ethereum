...
contract PixelTurtle is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function presaleMint() public payable{
        ...
        require(msg.value.mul(1e18) == presalePrice,"You need to pay the appropriate amount");
    ...
    function publicMint(uint amount) public payable{
        ...
        require (msg.value.mul(1e18) == price * amount, "You need to pay the appropriate amount");
        require (amount <= 3);
