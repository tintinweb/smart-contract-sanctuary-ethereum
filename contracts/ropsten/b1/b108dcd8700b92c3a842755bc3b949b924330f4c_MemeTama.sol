...
contract MemeTama is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "MemeTama";
    string private constant _symbol = "MemeTama";
    ...
    address payable private _developmentAddress = payable(0xBa7f919D35B59DECEcD6C445147C4693B3D77d22);
    address payable private _marketingAddress = payable(0xBa7f919D35B59DECEcD6C445147C4693B3D77d22);
    ...
    uint256 public _maxTxAmount = 0.5 * 10**9; //0.3
    uint256 public _maxWalletSize = 1 * 10**9; //1
    uint256 public _swapTokensAtAmount = 0.1 * 10**9; //0.1
