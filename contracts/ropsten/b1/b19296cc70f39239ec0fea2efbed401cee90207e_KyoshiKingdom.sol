...
contract KyoshiKingdom is ERC721A, Ownable {
    ...
    uint256 public freeSupply = 2;
    uint256 public maxWhitelist = 8;
    uint256 public maxPublic = 8;
    uint256 public maxFreeMint = 1;
    uint256 public maxPerTx = 4;
    uint256 public presaleCost = .03 ether;
    uint256 public publicCost = .03 ether;


    constructor(string memory _initBaseURI) ERC721A("Test Contract", "TC") {
    ...
    function freeMint(uint256 quantity) external payable {
        require(freeSale, "The public sale is not enabled!");
        uint256 supply = totalSupply();
        require(supply < freeSupply, "Free mint has ended");
        require(quantity > 0, "Quantity must be higher than zero!");
        require(
    ...
    function setSale(bool _presale, bool _publicSale, bool _freeSale) public onlyOwner {
        presale = _presale;
