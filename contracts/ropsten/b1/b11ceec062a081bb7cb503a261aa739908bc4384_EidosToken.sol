...
contract EidosConfig {
    ...
    // EidosToken
    string internal constant TOKEN_NAME            = "Eidos";
    string internal constant TOKEN_SYMBOL          = "EIDOS";
    ...
    uint internal constant EXCHANGE_RATE           = 1000;   // 1 eth = 1000 eidos
...
contract Ownable is EidosConfig {
...
contract EidosToken is Lockable, TokenERC20 {
    ...
    function EidosToken(address _companyCapital, address _prePayment) TokenERC20(TOKEN_NAME, TOKEN_SYMBOL, TOKEN_DECIMALS, INITIAL_SUPPLY) public {
...
contract EidosSale is MultiOwnable {
    ...
    function EidosSale(
        ...
        uint _softCapToken,
        uint _hardCapToken,
        EidosToken _addressOfTokenUsedAsReward
    ) public {
        ...
        tokenReward = EidosToken(_addressOfTokenUsedAsReward);
    }
...
contract EidosPresale is EidosSale {
    function EidosPresale(
        address _sendEther,
        uint _softCapToken,
        uint _hardCapToken,
        EidosToken _addressOfTokenUsedAsReward
...
contract EidosCrowdsale is EidosSale {
    function EidosCrowdsale(
        address _sendEther,
        uint _softCapToken,
        uint _hardCapToken,
        EidosToken _addressOfTokenUsedAsReward
