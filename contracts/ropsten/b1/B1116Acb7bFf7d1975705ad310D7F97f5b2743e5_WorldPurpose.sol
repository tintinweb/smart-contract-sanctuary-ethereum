...
contract WorldPurpose {
    ...
    */
    ...
    /**
        @notice Get the total amount of investment you have made. It returns both the locked and unlocked investment
    ...
    */
    modifier onlyNewUser() {
        // Check the new owner is not the previous one
    ...
    /**
        ...
        @return newPurpose The new World purpose
    */
    function setPurpose(string memory _purpose) public payable onlyNewUser returns (Purpose memory newPurpose) {
        // Check that new owner has sent us enough funds to override the previous purpose
