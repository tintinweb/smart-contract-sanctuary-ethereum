    ...
    */
    ...
    function unstake() public {
        ...
        for(uint i = 1; i <= totalTimeslots; i++) {
            ...
            if(_slottime + 3 minutes > currentTime){   //1-5 days (25%}
            ...
            else if(_slottime + 5 minutes > currentTime){   //6-10 days (20%)
                totalAmount += _runningAmount;
            ...
            else if(_slottime + 7 minutes > currentTime){   //11-15 days (15%)
                totalAmount += _runningAmount;
            ...
            else if(_slottime + 9 minutes > currentTime){   //16-20 days (10%)
                totalAmount += _runningAmount;
            ...
            else if(_slottime + 10 minutes > currentTime){   //21-25 days (5%)
                totalAmount += _runningAmount;
            ...
            else if(_slottime + 12 minutes > currentTime){   //26-30 days (3%)
                totalAmount += _runningAmount;
            ...
            else if (_slottime + 14 minutes > currentTime) {  // >30 days (2%)
                totalAmount += _runningAmount;
