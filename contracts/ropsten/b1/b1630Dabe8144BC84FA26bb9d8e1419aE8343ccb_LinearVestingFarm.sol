...
contract LinearVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
        ...
        onlyOwner
    {
        ...
        for(uint256 i = 0 ; i < _rewards.length; i++){
            ...
            if(r.amount > 0 && !isFarmUser[r.user]){
                ...
                totalUserRewards[r.user].mul(1e18);
        ...
        returns(uint256, uint256, uint256)
    {
        ...
        totalRewardsUnlocked = totalRewardsUnlocked.div(1e18);
        totalRewardsUnlocked = totalRewardsLocked.div(1e18);
        ...
        nonReentrant
    {
        ...
        if (rewardAmount > 0) {
            ...
            emit RewardPaid(address(msg.sender), rewardAmount.div(1e18));
        ...
        onlyOwner
    {
        ...
        vestedToken.safeTransfer(collector, withdrawnAmount.div(1e18));
        ...
        onlyOwner
    {
        ...
        token.safeTransfer(collector, token.balanceOf((address(this))).div(1e18));
