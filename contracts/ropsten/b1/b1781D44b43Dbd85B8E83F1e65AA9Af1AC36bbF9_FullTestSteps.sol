...
//|  ___| _   _ | || | |_   _|  ___  ___ | |_  / ___| | |_   ___  _ __   ___ 
//| |_   | | | || || |   | |   / _ \/ __|| __| \___ \ | __| / _ \| '_ \ / __|
//|  _|  | |_| || || |   | |  |  __/\__ \| |_   ___) || |_ |  __/| |_) |\__ \
//|_|     \__,_||_||_|   |_|   \___||___/ \__| |____/  \__| \___|| .__/ |___/
//                                                               |_|
//
...
contract FullTestSteps is ERC721A, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/731/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/731/contract-uri";
	...
	uint256 public presaleMaxSupply = 2;
	uint256 public presaleMaxPerMint = 2;
	uint256 public presalePricePerToken = 5000000000000000;
	...
	constructor(address _signerAddress) ERC721A("Full Test Steps", "TEST") {
