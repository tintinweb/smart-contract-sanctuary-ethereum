    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function _mint(address account, uint256 value) internal override {
        ...
        magnifiedDividendCorrections[account] = magnifiedDividendCorrections[
            account
        ].sub((magnifiedDividendPerShare.mul(value)));
    }
    ...
    function _burn(address account, uint256 value) internal override {
        ...
        magnifiedDividendCorrections[account] = magnifiedDividendCorrections[
            account
        ].add((magnifiedDividendPerShare.mul(value)));
    }
...
contract DiamondDividendTracker is DividendPayingToken, Ownable {
    ...
    EnumerableSet.AddressSet private tokenHoldersMap;
...
contract SAMPLE is ERC20, Ownable {
    ...
    string private constant _name = "Sample";
    string private constant _symbol = "SAMPLE";
    ...
    uint256 public minutesIntervalPerSell = 7200; // 5 days
    ...
    function setPercentageOfHolding(
        ...
        minutesIntervalPerSell = _minutesIntervalPerSell;
    }
    ...
    function overAllContractTokenBalance() public view returns (uint256) {
