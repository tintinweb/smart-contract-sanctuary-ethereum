...
contract PieceStandardToken is StandardToken { 
    ...
    function PieceStandardToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
