...
contract STSTEST2 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function STSTEST1() {
        ...
        name = "STSTEST2";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "STSTEST2";                                             // Set the symbol for display purposes (CHANGE THIS)
