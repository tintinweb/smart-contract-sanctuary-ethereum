...
contract MahamTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MahamTestCoin() {
        ...
        name = "MahamTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-030";                                             // Set the symbol for display purposes (CHANGE THIS)
