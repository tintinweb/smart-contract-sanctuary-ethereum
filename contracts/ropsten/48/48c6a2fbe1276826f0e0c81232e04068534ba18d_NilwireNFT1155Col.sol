    ...
    ERC1155Burnable
{
    ...
    NilwireNFT1155 public  NilwireNFT1155M;
    ...
    constructor(    
        ...
        NilwireNFT1155 _NilwireNFT1155M = NilwireNFT1155(adminContract);
        // set the rest of the contract variables
        NilwireNFT1155M = _NilwireNFT1155M;
    ...
    function getServiceFeeESC() public view returns (uint256) {
        return  NilwireNFT1155M.getServiceFeeESC();
    }

    function getServiceFee() public view returns (uint256) {
        return  NilwireNFT1155M.getServiceFee();
    }
    ...
    function _saleToken(
        ...
        uint256 serviceVal = NilwireNFT1155M.getServiceFee();
        if(keccak256(bytes(bidtoken)) == keccak256(bytes("NIL")))
        {
             serviceVal = NilwireNFT1155M.getServiceFeeESC();
        }

        address payable admin =  payable(NilwireNFT1155M.getOwner());
