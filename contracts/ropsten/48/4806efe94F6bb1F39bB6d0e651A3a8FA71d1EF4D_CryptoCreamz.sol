...
contract CryptoCreamz is Ownable, ERC721A {
    ...
    address public immutable withdrawWallet;
    address msgpWallet = 0x9C22CE2DF2d3BED0EB6EEdE5CB36aa15DcC95cA6;
    bool public isMSGPAuthorised = true;

    constructor(uint256 collectionSize_, string memory collectionName, string memory collectionAlias, address withdrawWallet_)
        ERC721A(collectionName, collectionAlias, collectionSize_) {
    ...
    modifier onlyMSGP() {
        ...
        require(msgpWallet == _msgSender(), "onlyMSGP: caller is not the MSGP");
        _;
    }

    function bulkMintOwner(address[] memory who, uint256[] memory quantityList) public onlyOwner {
