...
/*
 * TestToken is a standard ERC20 token with some additional functionalities:
...
contract TestToken is StandardToken, Ownable {
    ...
    uint256 public constant TOKEN_OFFERING_ALLOWANCE = 750000000 * (10 ** uint256(decimals));
