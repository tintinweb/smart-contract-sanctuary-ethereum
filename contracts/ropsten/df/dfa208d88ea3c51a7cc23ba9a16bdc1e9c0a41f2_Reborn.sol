...
contract Reborn is ERC20, Ownable {
    ...
    constructor() ERC20("Reborn", "RBRN") {
        ...
        marketingWallet = address(0x6D02218076333B5C4cD478dB185Dc15945C68A18); // set as marketing wallet
        devWallet = address(0x6D02218076333B5C4cD478dB185Dc15945C68A18); // set as dev wallet
