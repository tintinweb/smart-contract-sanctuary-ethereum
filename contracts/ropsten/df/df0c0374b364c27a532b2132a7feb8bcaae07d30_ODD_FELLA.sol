...
ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * ODD FELLA * 
...
contract ODD_FELLA is ERC20, Auth {
    ...
    string constant private _name = "ODD FELLA";
    string constant private _symbol = "ODDS";
    uint8 constant private _decimals = 18;

    uint256 private _totalSupply = 33000000000* 10**_decimals;
    uint256 public _maxTxAmount = _totalSupply * 150 / 10000; // 495,000,000
    uint256 public _maxWalletAmount = _totalSupply * 330 / 10000; // 1,089,000,000
    ...
    address private autoLiquidityReceiver =0x6Da7E3d9A8f1D2959b4e011a99A6086a34574415 ;
    address private MarketingFeeReceiver =0x6Da7E3d9A8f1D2959b4e011a99A6086a34574415 ;
    address private operationsFeeReceiver =0x6Da7E3d9A8f1D2959b4e011a99A6086a34574415 ;
    address private devFeeReceiver =0x6Da7E3d9A8f1D2959b4e011a99A6086a34574415 ;
