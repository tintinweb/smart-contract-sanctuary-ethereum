...
contract PRISU is ERC20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    ...
    event UpdateFees(uint256 sellMarketingFees, uint256 sellBridgeFundFees, uint256 buyMarketingFees,
                     uint256 buyBridgeFundFees, uint256 buyDevFee, uint256 sellDevFee);
