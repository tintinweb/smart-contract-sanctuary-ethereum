...
contract Market is ReentrancyGuard {
    ...
    function makeMarketItem(address nftContract,uint256 tokenId,uint256 price,bytes calldata data,uint256 Feeadmin )
public payable nonReentrant {
   ...
   // require(price > 0,'price must atleast one wei');
    ...
    function createMarketsale(address nftContract, uint256 itemId, uint256 Royalty, bytes calldata data, uint256 Listingprice)public payable nonReentrant {
