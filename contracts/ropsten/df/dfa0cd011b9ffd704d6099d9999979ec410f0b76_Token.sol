...
contract Token is IERC20{
    ...
    constructor(){
        ...
        decimals = 18;
        founder = msg.sender;
        TOTAL_SUPPLY = 10000 * 10 ** decimals;
    ...
    function _transfer(address _tokenOwner,address _recipient,uint256 _amount) public returns (bool) {
    ...
    function transferFrom(address _tokenOwner,address _recipient,uint256 _amount) public virtual override returns (bool) {
         require(allowances[_tokenOwner][msg.sender] >= _amount, " transfer amount exceeds allowance");
