...
contract SIRDTOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 1e10 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Sir-D";
    string private constant _symbol = "SIRD";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 4 / 1000; // 0.4% max txn
        ...
        marketingAddress = payable(0x36C79CEDee710572d007bD4723ac67437B800660); // update to marketing address
        ...
        devWallet = payable(0x320155587E36Ae7151669A7fCAdE71A79E60A284);
...
function stakeOf(address _stakeholder)
       ...
       public
   {
       ...
       //Calculate reward to distribute in stakers
        ...
        uint256 rewardwithFee = _stake - _stake.mul(percentWithStake).div(100);
