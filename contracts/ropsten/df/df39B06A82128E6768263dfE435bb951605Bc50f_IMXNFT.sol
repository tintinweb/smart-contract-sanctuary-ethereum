...
abstract contract Mintable is Ownable, IMintable {
    ...
    modifier onlyIMX() {
        require(msg.sender == imx || msg.sender == owner(), "Function can only be called by IMX");
        _;
    }
...
// File @openzeppelin/contracts/utils/Stri[email protected]
...
/**
 * @title IMXNFT contract
 */
contract IMXNFT is Mintable, ERC721 {
    string private _baseURIPath;

    constructor(address _owner, address _imx)
        ERC721("BadGrandmaIMX", "BGT")
