    ...
    ExponentialNoError
{
        ...
        returns (uint256)
    {
        ...
        uint256 allowance = comp.allowance(getTreasuryAddress(), address(this));
        uint256 balance = comp.balanceOf(getTreasuryAddress());
        uint256 compRemaining = allowance < balance ? allowance : balance; // minimum
