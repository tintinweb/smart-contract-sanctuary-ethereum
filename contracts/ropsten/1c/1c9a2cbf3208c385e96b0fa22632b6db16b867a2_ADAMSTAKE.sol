...
contract ADAMSTAKE {
    ...
    //arrays
    uint256[4] percentages = [0, 0, 0, 0];
    uint256[4] APY = [800000,900000,1000000,1100000];
    uint256[4] durations = [3 minutes, 5 minutes, 7 minutes, 10 minutes];
    ...
    constructor() {
        ...
        stakeToken = IERC20(0x78d08aC0321cFC247FeDC963DB4009Ca339C0567);
        rewardToken = IERC20(0x13a6D15Fe8A5a7AAF523378fC75c20B7Db3f7C29);
