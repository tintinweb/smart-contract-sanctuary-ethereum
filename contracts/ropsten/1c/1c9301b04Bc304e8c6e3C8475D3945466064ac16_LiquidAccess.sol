  ...
  // ERC165Storage
{
  ...
  // Mapping from token Id to date_expiration
  mapping(uint256 => string) private dateExpirations;

  // Mapping from token Id to type_subscription
  mapping(uint256 => string) private typeSubscriptions;
