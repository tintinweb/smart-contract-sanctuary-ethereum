...
contract KKday is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function KKday() {
        ...
        name = "KKday";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "kk";                                             // Set the symbol for display purposes (CHANGE THIS)
