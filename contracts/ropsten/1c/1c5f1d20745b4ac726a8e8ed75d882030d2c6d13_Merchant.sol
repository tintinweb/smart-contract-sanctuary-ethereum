...
contract Merchant is Pausable, MerchantProperty, ReentrancyGuard {
    ...
    function initialize(
        ...
        IERC20(receiveToken_).balanceOf(address(this)); // Function just confirming
        require(
...
contract SlashFactory is Ownable {
     ...
     */
    function deployMerchant(address merchantWallet_, address receiveToken_)
        external
    {
