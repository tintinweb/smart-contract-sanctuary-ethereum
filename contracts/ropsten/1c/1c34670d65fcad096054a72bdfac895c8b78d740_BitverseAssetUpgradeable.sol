...
abstract contract Mintable is Initializable, OwnableUpgradeable, IMintable {
    address public imx;
    mapping(uint256 => bytes) public blueprints;

    event AssetMinted(address to, uint256 id, bytes blueprint);

    function __Mintable_init(address _owner, address _imx) internal initializer {
        imx = _imx;
...
contract BitverseAssetUpgradeable is
    Initializable,
    ERC721Upgradeable,
    ...
    ERC2981
{
    ...
    function initialize(string memory _name, string memory _symbol, address _owner, address _imx) external initializer {
