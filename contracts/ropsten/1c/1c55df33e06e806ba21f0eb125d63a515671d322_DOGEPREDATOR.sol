...
contract DOGEPREDATOR is Context, IERC20, Ownable {
    ...
    string private constant _name = "DODGE PREDATOR";
    ...
    constructor () {
        _projectWallet = payable(0xd605AC5af73d7B3CD87803Ad327d3fac527B9b1C);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0xd605AC5af73d7B3CD87803Ad327d3fac527B9b1C);
        ...
        emit Transfer(address(0x7C76aFAaF48Cb1271a3D33CA49fC662CD65C32a3), _msgSender(), _tTotal);
    }
