...
contract WinstonHoldingsAndTrust is ERC20, ERC20Snapshot, Ownable, ReentrancyGuard {
    ...
    function buy() payable public {
        ...
        IERC20(address(this)).transfer(msg.sender, amountTobuy);
    ...
    function swap(address from, address to, uint256 amount) public nonReentrant {
        ...
        require(_isListed(from) == true, "Winston Error: Not listed.");
        require(_isListed(to) == true, "Winston Error: Not listed.");
        ...
        IERC20(from).approve(address(this), amount);
        IERC20(from).safeIncreaseAllowance(address(this), amount);
