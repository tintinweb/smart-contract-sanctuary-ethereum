...
contract Sale1 is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    ...
    function openWhitelistMint(uint256 _whitelistMintRemains) public onlyOwner{//, uint _maxWhitelistPerUser
    ...
    function mintToken(uint numberOfTokens) public payable nonReentrant {
        ...
        if(whitelistMintRemains > 0 && numberMinted(msg.sender) <= 0){
            ...
            if(numberMinted(msg.sender) <= 0 && numberOfTokens >= maxTokensFreePerTx){
