...
contract SatoruEnterprise is Context, IERC20, Ownable {
    ...
    bool public taxEnabledOnBuy = true;
    ...
    event TaxEnabledOnBuyUpdated(bool enabled);
    ...
    function _transfer(
        ...
        if (
            overMinTokenBalance &&
            !inSwapAndSend &&
            (from != uniswapV2Pair || taxEnabledOnBuy) &&
            SwapAndSendEnabled
        ) {
    ...
    function setTaxEnabledOnBuy(bool _enabled) public onlyOwner() {
        taxEnabledOnBuy = _enabled;
        emit TaxEnabledOnBuyUpdated(_enabled);
    }
