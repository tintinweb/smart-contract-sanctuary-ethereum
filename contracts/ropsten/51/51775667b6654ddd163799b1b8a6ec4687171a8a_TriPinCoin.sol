...
contract TriPinCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TriPinCoin() {
        ...
        name = "TriPinCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TPC";                                             // Set the symbol for display purposes (CHANGE THIS)
