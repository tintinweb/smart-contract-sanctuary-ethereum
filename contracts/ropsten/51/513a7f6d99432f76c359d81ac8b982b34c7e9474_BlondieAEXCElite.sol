...
contract BlondieAEXCElite is ERC721A, Ownable {
    using Strings for uint256;
    ...
    // URI
    string public baseURI = "ipfs://QmYN8wKJw6GjJmGvbUrfbZ5NLUA8WjwY5Knqx4U4T6AfAt/";
    string public hiddenURI = "ipfs://QmTPufoDEFrKUnJ19Rr3C6nyUTnuFMazN7JmTAmdzfNbY3/";

    // Costs
    uint256 public whitelistSaleCost = 0.25 ether;
    uint256 public publicSaleCost = 0.26 ether;
    ...
    // Constructor
    constructor() ERC721A("Blondie AEXCElite", "BAEXCE") {}
    ...
    modifier whitelistSaleMintCompliance(uint256 _mintAmount, bytes32[] memory _merkleTreeProof) {
        ...
        require(ownerMintedCount + _mintAmount <= nftPerAddressLimit, "MSG: Max NFT per address exceeded for whitelist sale");
    ...
    modifier publicSaleMintCompliance(uint256 _mintAmount) {
        uint256 ownerMintedCount = addressMintedBalance[msg.sender];
        require(ownerMintedCount + _mintAmount <= nftPerAddressLimit, "MSG: Max NFT per address exceeded for public sale");
