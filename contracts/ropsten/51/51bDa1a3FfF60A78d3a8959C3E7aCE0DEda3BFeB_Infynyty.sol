...
contract Infynyty is ReentrancyGuard, Ownable {
    ...
    address public nftTransferAddress;
    ...
    function cancelSell(
        ...
        require(
            msg.sender == nftInfo.seller,
            "You are not a owner of this nft."
        );
        nonceHandler(nonceHandlerAddress).setNonce(
            nftInfo.NFTAddress,
            nftInfo.tokenId
    ...
    function buy(
        ERC1155Struct memory sellerInfo,
        ERC1155Struct memory buyerInfo,
        Sig memory sellerRSV,
        Sig memory buyerRSV
        ...
        (bool sent, bytes memory data) = payable(sellerInfo.seller).call{
            value: msg.value
        }("");
        require(sent, "Failed to send Ether");
        TransferNFT(nftTransferAddress).transferERC1155(
            sellerInfo.NFTAddress,
            sellerInfo.seller,
            msg.sender,
            sellerInfo.tokenId,
