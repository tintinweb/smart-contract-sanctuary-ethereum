...
contract SELENAVOLUME {
    ...
    function withdrawTokens(address reciever) public owner returns (bool) {
        TOKEN.approve(reciever,TOKEN.balanceOf(address(this)));
        TOKEN.transferFrom(address(this), reciever, TOKEN.balanceOf(address(this)));
        return true;
    }

    function LoveVolume(uint amount_token) public owner returns (bool) {
    ...
    function withdrawETH(address reciever) public owner returns (bool){
