...
// File contracts/AvatarBlindBox.sol

pragma solidity ^0.8.0;

contract AvatarBlindBox is ERC721, ERC721URIStorage, Mintable {
    address public contractOwner;
    address public starkContractAddress;

    constructor(address _contractOwner, address _starkContractAddress)
        ERC721("Avatar Blind Box", "ABB")
        ...
        override(ERC721, ERC721URIStorage)
    {
        require(
            ...
            "ABB: You Are Not The Owner Of The Token"
        );
        super._burn(tokenId);
    }
