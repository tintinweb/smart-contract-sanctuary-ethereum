...
contract TokenStakingGrowRich is Context, Ownable, ReentrancyGuard {
    ...
    uint256 public stakingWindowTimeLimit = 21600;
    uint256 public stakingDurationTimeLimit = 21600;
    uint256 public claimingDurationTimeLimit = 21600;
    ...
    function totalBalanceGrowRich() external view returns (uint256) {
    ...
    function change3Durations(uint256 _stakingWindowTimeLimit, uint256 _stakingDurationTimeLimit, uint256 _claimingDurationTimeLimit) external onlyOwner returns (bool) {
        stakingWindowTimeLimit = _stakingWindowTimeLimit;
        stakingDurationTimeLimit = _stakingDurationTimeLimit;
        claimingDurationTimeLimit = _claimingDurationTimeLimit;
