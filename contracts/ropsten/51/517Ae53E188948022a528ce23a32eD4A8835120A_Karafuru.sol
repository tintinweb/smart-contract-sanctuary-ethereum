    ...
    Withdrawable
{
    ...
    uint256 public constant PUBLIC_SALES_START_PRICE = 0.00001 ether;

    uint256 public constant priceDropDuration = 31536000; // 1 year
    ...
    constructor() ERC721("Karafuru", "KARAFURU") Whitelist("Karafuru", "1") {
        publicSalesStartTime = 1643603175;
    }
