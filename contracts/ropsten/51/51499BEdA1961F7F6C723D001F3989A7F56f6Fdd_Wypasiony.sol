...
contract Wypasiony is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Wypasiony";
    string private constant _symbol = "Wypasiony";
    ...
    address payable private _marketingAddress = payable(0x8216d8bd3C9cD218072A459857e23aF424a7FC27);
    ...
    uint256 public _maxWalletSize = 250000000000000 * 10**9; //2.5%
