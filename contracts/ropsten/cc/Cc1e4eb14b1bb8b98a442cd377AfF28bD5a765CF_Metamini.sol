    ...
    function mint(string memory _listName, uint256 _mintAmount) public payable {
        ...
        if (whitelistEnabled) {
            ...
            if (compareStrings(_listName, "OG")) {
                require(balanceOf(msg.sender) < maxNFTcountOG, "OG address cannot mint more than 3");
                counter = counter + _mintAmount;
            ...
            if (compareStrings(_listName, "WL")) {
                require(balanceOf(msg.sender) < maxNFTcountWL, "WL address cannot mint more than 4");
                counter = counter + _mintAmount;
                _safeMint(msg.sender, _mintAmount);
                return;
            }
