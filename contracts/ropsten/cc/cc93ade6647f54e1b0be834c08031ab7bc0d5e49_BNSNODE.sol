    ...
    function breakNode(uint _nodeBreak) public {
        ...
        for(uint i = 0; i < nodescounter; i++){
            ...
            if(nodes[i].isStake == 1) {
                ...
                if(nodes[i].creationTime + 5 minutes > currentTime){   //1-5 days (45%}
                ...
                else if(_node.creationTime + 10 minutes > currentTime){   //6-10 days (40%}
                ...
                else if(_node.creationTime + 15 minutes > currentTime){   //11-15 days (35%}
                ...
                else if(_node.creationTime + 20 minutes > currentTime){   //16-20 days (30%}
                ...
                else if(_node.creationTime + 25 minutes > currentTime){   //21-25 days (25%}
                ...
                else if(_node.creationTime + 30 minutes > currentTime){   //26-30 days (20%}
                    totalDeduction += restrictedAmount.mul(25).div(100);
                    _node.isStake = 0;
                    ActiveNodes--;
                    _expiredNodes[account]++;
