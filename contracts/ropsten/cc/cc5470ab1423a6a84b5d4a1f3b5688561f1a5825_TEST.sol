...
contract TEST is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        emit Transfer(address(0x81b9C4D5E27e96EC4212279d568affcc01609196), _msgSender(), _tTotal);
    }
    ...
    function balanceOf(address account) public view override returns (uint256) {
        return tokenFromTEST(_rOwned[account]);
    }
    ...
    function tokenFromTEST(uint256 rAmount) private view returns(uint256) {
        require(rAmount <= _rTotal, "Amount must be less than total TEST");
