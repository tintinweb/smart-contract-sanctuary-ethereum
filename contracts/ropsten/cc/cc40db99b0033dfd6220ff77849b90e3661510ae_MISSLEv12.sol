...
//    MISSLE V12
//    2%  Marketing & Add Liquidity
//    1%  Add to Liquidity Pool
//	  1%  Redistribute to Holders 
// 	  1%  Token Burn



contract MISSLEv12 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 430000000 * 10**9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "MISSLE v12";
    string private _symbol = "MISSLEv12";
    ...
    uint256 public _maxTxAmount = 430000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 4300000 * 10**9;
	...
	// Number of Tokens to Accrue before Selling To Add to Liquidity
	function setnumTokensSellToAddToLiquidity(uint256 tokenAmount) external onlyOwner() {
       numTokensSellToAddToLiquidity = tokenAmount;
    }
	
	// Percentage for Liquidity Fees - Maybe Remove on Live
	function setAddtoLiquidityFees(uint256 fee) external onlyOwner() {
       _liquidityFee = fee;
    }
	
	// Percentage for Marketing Team Fees - Maybe Remove on Live
	function setMarketingFees(uint256 fee) external onlyOwner() {
       _marketingAndTeamFee = fee;
    }
    ...
    function recoverAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
