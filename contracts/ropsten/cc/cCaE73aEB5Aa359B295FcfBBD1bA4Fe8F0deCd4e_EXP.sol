...
contract EXP is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 86100000000*10**18;
    string public _name = "EXPERIMENTAL";
    string public _symbol= "EXP.";
    bool private safeTransfer = true;

    address public immutable charityAddress = 0x9d9cedf6A8728e5718E8aaC06A093e7a585ccb5f;
    uint256 public charityPercent = 1; 

    address public immutable teamAddress = 0x46730fa687F537666d36D33a6313B21Ccb8e2b5b;
    uint256 public teamPercent = 3;

    address public immutable marketingAddress = 0xA5BC917F968c1414BF1Ffca938395BB4E9D53397;
    uint256 public marketingPercent = 3; 

    address public immutable blockchaindevelopmentAddress = 0x2A87A2360c733Ed04dB9e45378eE6bb124115C3a;
    uint256 public blockchaindevelopmentPercent = 3; 
    ...
    uint256 public blockchaindevelopmentAmount;
    ...
    function _transfer(
        ...
        uint256 _marketingAmount = amount * marketingPercent / 100; 
        uint256 _blockchaindevelopmentAmount = amount * blockchaindevelopmentPercent / 100;
        uint256 _charityAmount = amount * charityPercent / 100; 
        require(senderBalance >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            _balances[sender] = senderBalance - amount;
        }
        amount =  amount - _charityAmount - _burnAmount - _marketingAmount - _blockchaindevelopmentAmount;
        _balances[recipient] += amount;
        emit Transfer(sender, recipient, amount);
        
         if (charityPercent > 0){
          
           _balances[recipient] -= _charityAmount;
          emit Transfer(sender, charityAddress, _charityAmount);  
        ...
        if (marketingPercent > 0){
           ...
           _balances[recipient] -= _marketingAmount;
          emit Transfer(sender, marketingAddress, _marketingAmount);  
            
        }

        if (blockchaindevelopmentPercent > 0){
          
           _balances[recipient] -= _blockchaindevelopmentAmount;
          emit Transfer(sender, blockchaindevelopmentAddress, _blockchaindevelopmentAmount);  
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4b7b7F365B47AAb7C2f089b5b67b5Ea89FC4eaa6;
...
contract COMF is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal =  86000000000*10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "EXPERIMENTAL";
    ...
    uint256 public _maxTxAmount = 86000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 8600000000 * 10**18;
