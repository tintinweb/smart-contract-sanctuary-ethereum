...
contract KibaInu is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0x2c5B9dd42d0510C43f1d6d672bD56A7DE0716c91);
    ...
    constructor() ERC20("KibaInu", "KIBA") {
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount && !isWalletToWallet;
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to] || isWalletToWallet) {
            takeFee = false;
        }
