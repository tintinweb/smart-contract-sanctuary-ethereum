...
contract qwercoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function qwercoin() {
        ...
        name = "qwercoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "qc";                                             // Set the symbol for display purposes (CHANGE THIS)
