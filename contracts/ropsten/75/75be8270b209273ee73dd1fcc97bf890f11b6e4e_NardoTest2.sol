...
contract NardoTest2 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NardoTest2() {
        ...
        name = "NardoTest2";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NRDOTS";                                             // Set the symbol for display purposes (CHANGE THIS)
