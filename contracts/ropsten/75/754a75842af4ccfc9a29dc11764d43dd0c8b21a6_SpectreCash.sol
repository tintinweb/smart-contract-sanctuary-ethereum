...
// SPDX-License-Identifier: GNU v3.0
...
contract SpectreCash is Context, IERC20, Ownable {
    ...
    string private constant _name = 'SpectreCash';
    string private constant _symbol = 'SCASH';
    ...
    constructor (address payable _devAddress, address payable _ownerAddress) {
