...
contract Masterchef is Ownable, ReentrancyGuard {
    ...
    function updatePool(uint256 _pid) public {
        ...
        alpha.mint(xParaAlphaDistributor, alphaReward.mul(xParaPercent).div(100)); // xParaPercent rewards to xParaAlphaDistributor address
    ...
    function xParaAlphaDistributorUpdate(address _xParaAlphaDistributor) public onlyOwner {
        xParaAlphaDistributor = _xParaAlphaDistributor;
        emit SetAddress("xPara-AlphaDistributor", msg.sender, _xParaAlphaDistributor);
    }
    ...
    function xParaPercentUpdate(uint _xParaPercent) public onlyOwner {
        ...
        emit SetPercent("xPara share", msg.sender, _xParaPercent);
    }
