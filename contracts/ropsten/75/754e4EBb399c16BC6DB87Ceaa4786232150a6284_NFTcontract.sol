...
contract NFTcontract is ERC721, ERC721URIStorage, Ownable, VerifySignature {
    ...
    function Authorization(
        ...
        require(ownerOf(id) == msg.sender, "not nft holder");
        _permission[msg.sender][id][receiver] = _status;
    }
