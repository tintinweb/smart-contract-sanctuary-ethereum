...
contract REscrow is Ownable, Utilities {
    ...
    function getBuyerDataBaseByAddress(address _buyerAddress)public onlyOwner returns(EscrowStruct[] memory){
        isEditByOwner = true;
        return buyerDatabase[_buyerAddress];
    }
    // Get Seller Database By Address - Only Owner
    function getSellerDataBaseByAddress(address _sellerAddress)public onlyOwner returns(SellerStruct[] memory){
        isEditByOwner = true;
        return sellerDatabase[_sellerAddress];
    }
    // Get EscrowArray - Only Owner
    function getEscrowArray()public onlyOwner returns(EscrowStruct[] memory){
        isEditByOwner = true;
        return escrowArray;
    }
    // Get EscrowArray - Only Owner
    function getSellerArray()public onlyOwner returns(SellerStruct[] memory){
        isEditByOwner = true;
        return sellerArray;
    }
    // Get Escrow By ID
    function getEscrowByID(uint _escrowID)public onlyOwner returns(EscrowStruct memory,bool){
        isEditByOwner = true;
        bool isExist = false;
    ...
    function getSellerInfoByAddressAndEscrowID(address _sellerAddress,uint _escrowID) public onlyOwner returns(SellerStruct memory, bool){
        isEditByOwner = true;
        bool isExist = false;
    ...
    function setEscrowStatusByID(uint _escrowID, bool _isActive) public onlyOwner {
        isEditByOwner = true;
    ...
    function getEscrowStatusByID(uint _escrowID) public onlyOwner returns(bool){
        isEditByOwner = true;
        (EscrowStruct memory escrowInfo, bool isExist) = getEscrowByID(_escrowID);
        require(isExist, "EscrowID is invaild in getListOfSellersByEscrowID");
    ...
    // Set Escrow Fee By ID
    function setEscrowFeeByID(uint _escrowID,uint _escrowFee) public onlyOwner {
        isEditByOwner = true;
        (EscrowStruct memory escrowInfo, bool isExist) = getEscrowByID(_escrowID);
        require(isExist, "EscrowID is invaild in getListOfSellersByEscrowID");
    ...
    // Get Escrow Fee By ID
    function getEscrowFeeByID(uint _escrowID) public onlyOwner returns(uint){
        isEditByOwner = true;
        (EscrowStruct memory escrowInfo, bool isExist) = getEscrowByID(_escrowID);
        require(isExist, "EscrowID is invaild in getListOfSellersByEscrowID");
    ...
    function setContractEscrowFee(uint _escrowFee) public onlyOwner {
        contractEscrowFee = _escrowFee;
    }
    // Get Contract Escrow Fee
    function getContractEscrowFee() public view returns(uint){
        return contractEscrowFee;
    }
    // Set Contract Escrow Fee
    function setSplitPercentage(uint _partyApercentage, uint _partyBpercentage) public onlyOwner {
    ...
    // Get Contract Escrow Fee
    function getSplitPercentage() public view returns(uint, uint){
...
// Create Escrow and Post Collected Numbers
    ...
    function addNewSeller(uint _escrowID,uint[] memory _collectedNumbers) public returns(string memory){
