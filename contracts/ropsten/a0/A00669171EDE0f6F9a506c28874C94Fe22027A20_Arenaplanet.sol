...
// File: contracts/Arenaplanet.sol
...
pragma solidity ^0.8.7;
  ...
  { 
    ...
    require(mintedPublictokens[msg.sender]<= publicamount, "You already own the maxiumum tokens, you cannot have one more");
  ...
  function OGMint(uint256 _amount) public payable {
    ...
    require(mintedOGtokens[msg.sender]<= OGamount, "You already own the maximum number of tokens, you cannot have one more");
    require(msg.value >= mintRate * _amount , "Not enough ETH sent; check price!");
  ...
  function DisableWhitelistMint() public onlyOwner {
  ...
  function DisableOGMint() public onlyOwner {
    ogMintEnabled = false;
  }
