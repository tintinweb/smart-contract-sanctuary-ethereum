...
contract Staking {
    ...
    // uint256[6] public periods = [15 days, 30 days, 60 days, 90 days, 180 days, 365 days];
    uint256[6] public periods = [150, 350, 600, 900, 1200, 1500]; //for testing purpose
    uint16[6] public rates = [10411, 10822, 11644, 12466, 14952, 20000];
