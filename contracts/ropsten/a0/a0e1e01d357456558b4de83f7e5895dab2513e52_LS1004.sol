...
contract LS1004 is IERC20, Auth {
	string constant _name = "LS 1k4";
	string constant _symbol = "LS1004";
	...
	function _openTrading() internal {
		_humanBlock = block.number + 20; // end sniper protections 10 blocks after adding liquidity at latest
