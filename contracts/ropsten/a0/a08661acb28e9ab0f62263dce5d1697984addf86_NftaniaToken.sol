...
contract NftaniaToken is ERC20, ERC20Snapshot, ERC20Burnable, Pausable, Ownable, ERC20Permit {
   ...
   //////////////////////// Freeze Not Expired Modifier ////////////////////////////////////////  
    modifier freezeNotExpired() {
      require(block.timestamp < tokensReleaseDate,"Token: freeze already expired");
      _;
    }

   //////////////////////// Freeze Expired Modifier ////////////////////////////////////////////  
    modifier freezeExpired() {
      require(block.timestamp > tokensReleaseDate,"Token: release date not achieved");
      _;
    }    

   //////////////////////// update Token Release Date //////////////////////////////////////////  
    function updateTokenReleaseDate(uint newTokenReleaseDate) onlyOwner freezeNotExpired public {
        require(newTokenReleaseDate >= block.timestamp ,"Token: date should be in the future");
        require (newTokenReleaseDate < tokensReleaseDate,"Token: date cannot be delayed");
   ...
   //////////////////////// Early Unfreeze Tokens (for admin) ////////////////////////////////////////  
    function earlyReleaseTokens() onlyOwner public  {
        require(isFrozen,"Token: already released");
        isFrozen = false;
   ...
   //////////////////////// update Royalty Rate /////////////////////////////////////// 
    function updateRoyalty(uint256 _royaltyRate ) public onlyOwner {
        require (_royaltyRate <= 100,"Token: Max Royalty is 100"); 
        royaltyRate  = _royaltyRate ;
    }
   ...
   /////////////// Exclude from royalties if address is Sender //////////////
    function addExempt_From(address targetAddress) public onlyOwner {
        require (royaltyExemptFrom[targetAddress] == false, "Token: already (From) exempted");
   ...
   /////////////// Exclude from royalties if address is Reciever  //////////////
    function addExempt_To(address targetAddress) public onlyOwner {
        require (royaltyExemptTo[targetAddress] == false, "Token: already (To) exempted");
        ...
        if (paused()==false){
            if (!isFrozen||isFreezeExempt[msg.sender]){
                ...
                revert E_TransferIsFrozen ({
                    message: "Token: Tokens are frozen",
   ...
   /////////////////////// Disable Renounce Ownership //////////////////////////////////// 
    function renounceOwnership() public view override onlyOwner {
        revert("Nftania Token: cannot be renounced");  
    }
