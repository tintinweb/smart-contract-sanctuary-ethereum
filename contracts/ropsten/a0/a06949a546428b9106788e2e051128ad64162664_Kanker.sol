...
contract Kanker is Context, IERC20, Ownable {
    ...
    Taxes private _taxes = Taxes(0,11,0,11);
    ...
    string private constant _name = "Kanker";
    string private constant _symbol = "KKR";
    ...
    constructor () {
        _feeAddrWallet = payable(0xfDFA2f1B5D37ADd4B56351c3DE18423b52941487);
