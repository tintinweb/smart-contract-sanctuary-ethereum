...
contract GenArt721Minter_DoodleLabs_Whitelist {
    ...
    function setMerkleRoot(uint256 projectId, bytes32 newMerkleRoot) public onlyWhitelisted {
        merkleRoot[projectId] = newMerkleRoot;
        emit SetMerkleRoot(projectId, newMerkleRoot);
    }
