...
contract ERC20 is IERC20 {
    ...
    uint256 public MaxWallet =8000e18;
    uint256 public Maxtx =8000e18;
...
contract TV5 is ERC20,Ownable {
    address public uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;
     event ExcludeLimitCheck(address indexed from, address indexed to, bool value);
     uint256 private CSupply=100000e18;
     address public devwallet=0x169BF07859e6C03f1ca7878ab8D511d339F81513;
    constructor () public ERC20 () {
        Excludecheck[msg.sender]=true;
        Excludecheck[devwallet]=true;
        _init(msg.sender,100000e18);
    }
