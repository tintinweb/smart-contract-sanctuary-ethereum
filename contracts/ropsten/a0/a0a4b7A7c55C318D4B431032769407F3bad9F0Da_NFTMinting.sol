...
contract NFTMinting is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint8 public constant percentW1 = 100;       // wallet1 will receive 25%
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmdPUr9e9cLgcs9nRGuXsRwSAquRi1MK7UPmbQ2vCuRNwG/";
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        if (isRevealed) {
            ...
            return
                string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmWZFyUK9F2cMKHqurft9kpbCHQQDCHdnPfq5DxZ9eFsoQ/", "symbol.json"));
        }
    }
