...
contract CoinToken is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply,address[5] memory _addr,uint256[6] memory _value) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(_value[0], _value[1], _value[2]);
        setSellTax(_value[3], _value[4], _value[5]);
        setTaxWallets(_addr[2], _addr[3]);
        exclude(msg.sender);
