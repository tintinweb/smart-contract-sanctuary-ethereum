...
contract AccessController is ERC721, ERC721Enumerable, Ownable, EIP712, ERC721Votes, AccessControl {
    ...
    mapping(address => bool) public whitelistClaimed; //CANVIAR PER BALANCE OF -> ESTALVIAR GAS

    constructor(string memory name, string memory symbol, bytes32 _merkleRoot) ERC721(name, symbol) EIP712(name, "1") {
