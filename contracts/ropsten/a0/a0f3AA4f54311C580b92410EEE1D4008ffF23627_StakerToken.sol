...
contract StakerToken is IERC20 {
   ...
   function transfer(address _to, uint256 _value) public override returns (bool){
       require(_balances[msg.sender] > _value, "Stakers Token: Insufficient funds");
   ...
   function transferFrom(address _from, address _to, uint256 _value) public override returns (bool){
       require(_allowances[_from][msg.sender] >= _value, "Stakers Token: Allowance is not enough");
   ...
   modifier mustBeOwner(address _owner){
       require(_tokenOwner == _owner, "Staker Token: Caller must be owber");
       _;
   }
}