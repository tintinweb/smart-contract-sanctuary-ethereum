 ...
 * @notice It distributes ORBIT tokens with rolling Merkle airdrops.
 */
contract TradingRewardsDistributor is Pausable, ReentrancyGuard, Ownable {
    ...
    // Total amount claimed by user (in ORBIT)
     ...
     */
    constructor(address _orbitToken) {
    ...
    function claim(uint256 amount, bytes32[] calldata merkleProof) external whenNotPaused nonReentrant {
        ...
        orbitToken.safeTransfer(msg.sender, adjustedAmount);
    ...
    /**
     * @notice Transfer ORBIT tokens back to owner
