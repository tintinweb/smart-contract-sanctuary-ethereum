...
contract TokingTurtles is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("TokingTurtles", "TT") {
    setHiddenMetadataUri("ipfs://QmYw9MbCvJY6QcVQznBd3XTNLwVQWZSRH3M5SRK6CDox3S/hidden.json");
  }
  ...
  function mintWl(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(supply.current() + _mintAmount <= wlSuppluy, "The presale ended!");
  ...
  function setWlSuppluy(uint256 _wlSuppluy) public onlyOwner {
    wlSuppluy = _wlSuppluy;
  }
