...
contract Staking is Ownable
{
    ...
    constructor(address _wabb, address _xwabb, address _locker) public {
        wabb = _wabb;
        xwabb = _xwabb;
        locker = _locker;
    ...
    function getMintedPerBlock() public view returns (uint)
    {
    ...
    function setMintedPerBlock(uint _arg) public onlyOwner
    {
        mintedPerBlock = _arg;
    }
    ...
    function getHowManyTokensCanBeMinted() public view returns (uint)
    {
        return (block.number - startBlock) * mintedPerBlock;
    }
