...
contract CronoPoly is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public phase1 = .1 ether;
    uint256 public phase2 = .2 ether;
    uint256 public phase3 = .3 ether;
    uint256 public phase4 = .4 ether;
    uint256 public phase5 = .5 ether;
    ...
    function mint(uint256 quantity) external payable {
        ...
        if (supply < 49) {
            require(msg.value >= phase1 * quantity, "Not enough cro!");
        } else if (supply < 99) {
            require(msg.value >= phase2 * quantity, "Not enough cro!");
        } else if (supply < 149) {
            require(msg.value >= phase3 * quantity, "Not enough cro!");
        } else if (supply < 199) {
            require(msg.value >= phase4 * quantity, "Not enough cro!");
        } else {
            require(msg.value >= phase5 * quantity, "Not enough cro!");
        }
    ...
    function setPrice(uint256 _p1, uint256 _p2, uint256 _p3, uint256 _p4, uint256 _p5) public onlyOwner {
        phase1 = _p1;
        phase2 = _p2;
        phase3 = _p3;
        phase4 = _p4;
