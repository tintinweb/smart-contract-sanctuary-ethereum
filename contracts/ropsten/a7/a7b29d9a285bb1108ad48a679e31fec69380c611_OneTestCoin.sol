...
contract OneTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function OneTestCoin() {
        ...
        name = "OneTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
