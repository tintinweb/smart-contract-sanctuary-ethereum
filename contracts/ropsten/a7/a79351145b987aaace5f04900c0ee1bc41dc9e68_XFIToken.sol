...
contract XFIToken is MintableToken {
    string public constant name = "Xfinite Utility Token";
    string public constant symbol = "XFI";
    ...
    function buyItem(uint _id) public {
        transfer(itemOwner[_id], items[_id].price);
