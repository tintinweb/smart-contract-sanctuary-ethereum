...
contract ETHPool is AccessControl {
    ...
    uint256 periodStake = 5 minutes;
    uint256 limitToDeposit = periodStake - 2 minutes;
    ...
    function deposit(address payable _to) public payable {
        ...
        //Só poderá depositar até o 5 dia da semana  7 - 5
    ...
    function depositRewards() public payable OnlyTeam OnlyAdmin {
    ...
    function checkWeekTime() external {
        require(block.timestamp - lastRun > periodStake, 'Need to wait 1 minutes');
