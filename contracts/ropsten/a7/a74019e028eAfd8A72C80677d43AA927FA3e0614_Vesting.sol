...
contract Vesting is Ownable, ReentrancyGuard {
  ...
  modifier onlyInitialized() {
    require(initialized, "Vestring: contract not initialized");
    _;
  }
  ...
  function init(
    ...
    require(!initialized, "Vestring::init: contract already initialized");
    require(recipient != address(0), "Vestring::init: invalid recipient");
    require(amount > 0, "Vestring::init: invalid amount");
    require(duration > 0, "Vestring::init: invalid duration");
