...
library LibBytesV06 {
    ...
    function slice(
        ...
        //     );
        // }
        require(from <= to, "InvalidByteOperationErrorCodes.FromLessThanOrEqualsToRequired");
        // if (to > b.length) {
        //     LibRichErrorsV06.rrevert(
        //         LibBytesRichErrorsV06.InvalidByteOperationError(
        ...
        //     );
        // }
        require(to <= b.length, "InvalidByteOperationErrorCodes.ToLessThanOrEqualsLengthRequired");
    ...
    function popLastByte(bytes memory b) internal pure returns (bytes1 result) {
        ...
        //     );
        // }
        require(b.length != 0, "InvalidByteOperationErrorCodes.LengthGreaterThanZeroRequired");
    ...
    function readAddress(bytes memory b, uint256 index) internal pure returns (address result) {
        ...
        //     );
        // }
        require(b.length >= index + 20, "InvalidByteOperationErrorCodes.LengthGreaterThanOrEqualsTwentyRequired");
    ...
    function readBytes32(bytes memory b, uint256 index) internal pure returns (bytes32 result) {
        ...
        //     );
        // }
        require(b.length >= index + 32, "InvalidByteOperationErrorCodes.LengthGreaterThanOrEqualsThirtyTwoRequired");
    ...
    function readBytes4(bytes memory b, uint256 index) internal pure returns (bytes4 result) {
        ...
        //     );
        // }
        require(b.length >= index + 4, "InvalidByteOperationErrorCodes.LengthGreaterThanOrEqualsFourRequired");
...
library LibBootstrap {
    ...
    function delegatecallBootstrapFunction(address target, bytes memory data) internal {
        ...
        if (!success || resultData.length != 32 || abi.decode(resultData, (bytes4)) != BOOTSTRAP_SUCCESS) {
            ...
            require(false, "Bootstrap call failed");
        }
    }
}
...
contract BootstrapFeature is IBootstrapFeature {
    ...
    function bootstrap(address target, bytes calldata callData) external override {
        ...
        // }
        require(msg.sender == _bootstrapCaller, "Invalid Bootstrap Caller");
        // Deregister.
    ...
    function die() external {
        ...
        // }
        require(msg.sender == _deployer, "Invalid Die Caller");
