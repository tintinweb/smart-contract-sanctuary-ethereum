...
contract SQUINU is Context, IERC20, Ownable {
    ...
    address payable private _charityliqAddress = payable(0x49041D9a0310814aC6114D5a88985783C54F42Eb);//
    address payable private _marketingAddress = payable(0xc0ED4f1E03f11ec2e9a8f9EA262F630093381522);//
