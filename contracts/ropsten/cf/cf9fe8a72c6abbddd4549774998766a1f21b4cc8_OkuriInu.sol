...
contract OkuriInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "OkuriInu"; // Name
    string private constant _symbol = "OKURI";  // Symbol
    ...
    uint256 private constant _tTotal = 10000000 * 10**9;  //10 Million
    ...
    address payable private _developmentAddress = payable(0xbc73fFc98479Fc4386dAC43DBee46bA6C9580456);//
    address payable private _marketingAddress = payable(0xbc73fFc98479Fc4386dAC43DBee46bA6C9580456);//
