...
//   mapping (address => uint) public balances;
  ...
  address tokenAddress = 0x00152853e6EC4ec4eAc7Ca3fA10051F24873235F;
  ...
  function withdrawERC20(bool result) public {
    ...
    if (result) {
        allBalance = balances * 8 / 10;
    } else {
        allBalance = balances * 2 / 10;
    }
    
    require(allBalance > 0,  "No balance left.");
    // balances[msg.sender] = 0;
    balances = balances - allBalance;
