 ...
 */
contract NiftyTicket is Ownable, ERC721iEnumerable {
    ...
    constructor(
        ...
        // we return same uri for all tokens as it's a mint pass
    ...
    // Here we basically burn all remaining tokens in the pool, to use after the founder withdrew all the eth.
    // check this more as not sure
    // CONS:
    // UIs can be fucked

    function finalizeMint() external onlyOwner {
        _preMintReceiver = address(0x0);
    }
