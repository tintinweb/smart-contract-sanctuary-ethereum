...
contract DopamintPass is ERC721Checkpointable, IDopamintPass {
    ...
    /// @notice The minimum number of passes that can be auctioned for a drop.
    uint256 public constant MIN_DROP_SIZE = 1;

    /// @notice The maximum number of passes that can be auctioned for a drop.
    uint256 public constant MAX_DROP_SIZE = 9999;

    /// @notice The minimum delay to wait between creation of drops.
    uint256 public constant MIN_DROP_DELAY = 4 weeks;

    /// @notice The maximum delay to wait between creation of drops.
    uint256 public constant MAX_DROP_DELAY = 24 weeks;

    /// @notice The owner address controls drop creation, size, and scheduling.
    address public owner;

    /// @notice The minter address controls NFT emissions.
    address public minter;

    /// @notice The OpenSea proxy registry contract 
