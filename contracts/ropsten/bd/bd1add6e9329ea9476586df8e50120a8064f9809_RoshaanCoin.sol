...
contract RoshaanCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function RoshaanCoin() {
        ...
        name = "RoshaanCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT2018-065";                                             // Set the symbol for display purposes (CHANGE THIS)
