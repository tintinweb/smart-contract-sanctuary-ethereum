...
contract eth_pay_v2 is Initializable, OwnableUpgradeable {
    ...
    function changePause(bool _bool) public pure returns(bool) {
        return _bool;
    }

    // ETH
    function startTrade (address _seller, bool yesNo) public payable {
        require(yesNo == true, "contract is paused.");
