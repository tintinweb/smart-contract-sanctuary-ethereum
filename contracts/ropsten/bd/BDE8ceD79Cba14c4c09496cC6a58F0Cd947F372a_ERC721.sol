...
contract ERC721 is IERC721, IERC721Metadata, ERC165{
    ...
    constructor(string memory newName, string memory newSymbol, string memory _baseUri) {
        owner = msg.sender;
        _name = newName;
        _symbol = newSymbol;
        baseUri = _baseUri;
    ...
    function approve(address _spender, uint256 _tokenId) public override {
        ...
        require((msg.sender == owners[_tokenId]) || (operatorAprovals[owners[_tokenId]][msg.sender]), "ERC721: approve caller is not owner nor approved for all");
