...
// File src/Token1155.sol

contract Token1155 is ERC1155, Ownable {
  mapping(uint256 => uint256) public totalDeposits;
  mapping(uint256 => uint256) public totalWithdrawals;

  constructor(string memory _uri, address _user) ERC1155(_uri) {
  ...
  function burn(uint256 tokenId, uint256 amount) external returns (bool) {
    ...
    totalWithdrawals[tokenId] += amount;
    return true;
  }
}