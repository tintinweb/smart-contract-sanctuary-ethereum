...
contract papu is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function papu() {
        ...
        name = "papu";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PAPU";                                             // Set the symbol for display purposes (CHANGE THIS)
