...
contract CITIZEN is Context, IERC20Upgradeable {
...
// change
    ...
    uint256 private _scapegoatMultipler = 100; // 1.00* anti dump to sell fee
    ...
    uint256 public _marketingRatio = 100;
    uint256 public _devRatio = 200;
...
//===============================================================================================================
    ...
    function setTaxesTransfer(uint256 reflect, uint256 liquidity, uint256 marketing, uint256 dev) external onlyOwner {
        ...
        require(reflect + liquidity + marketing <= 1000);
    ...
    function setMaxTxPercent(uint256 percent, uint256 divisor) external onlyOwner {
        ...
        require(check >= (_tTotal / 2000), "Max Transaction amt must be above 0.05% of total supply.");
        _maxTxAmount = check;
    }
