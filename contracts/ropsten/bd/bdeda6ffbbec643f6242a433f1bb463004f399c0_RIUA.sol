 ...
 * 
 * Decentralized Autonomous Organization (A)lpha
 * 
 * 
*/
...
contract RIUA is ERC20, Regulated, AcceptEth {
  ...
  constructor() public {
    ...
    name = "Residual Income Unit - DAO (A)lpha";                      // Description of the Securetized Tokens
    ...
    _totalShares = 100000 * 10**uint(decimals);         // Total Number of RIU Issued (example 100,000 of RIU)
