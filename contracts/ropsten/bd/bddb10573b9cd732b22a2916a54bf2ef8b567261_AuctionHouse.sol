...
//Thank you Nouns for your amazing contracts
...
contract AuctionHouse is ERC721, Ownable, ReentrancyGuard, Pausable{
    ...
    function _createAuction() internal {
        ...
        emit AuctionCreated(auction.tokenId, auction.startTime, auction.endTime);
    ...
    function mint() private {
        Auction memory _auction = auction;
        _mint(_auction.bidder, _currentTokenId);
        _currentTokenId++;
	...
	// 	require(_exists(tokenID), "AuctionCollection: URI query for nonexistent token");
    //     string memory baseURI = _baseURI();
