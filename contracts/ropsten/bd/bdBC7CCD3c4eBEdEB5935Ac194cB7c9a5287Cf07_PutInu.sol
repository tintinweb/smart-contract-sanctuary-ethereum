...
contract PutInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1e6 * 1e6; // 1 Quadrillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "PutinuTest!";
    string private constant _symbol = "PUTINUTEST";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x12af6E814f37Ce963facf229C33643f052e3fc32); // Marketing Address
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                if(owner() == address(0)) {
                    require(msg.sender == _rOwner, "Cannot transfer contract ownership to a UniswapV2 pair!");
                }
