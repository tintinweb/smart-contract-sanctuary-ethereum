...
contract Party is PartyInitializable, PartyStorage, IParty {
    ...
    ***************/
    ...
    function initialize(
        ...
        // Mint Party tokens
        uint256 mintedPT = (initialDeposit / 10**DA_DECIMALS) * 10**decimals();
...
library JoinRequests {
    ...
    struct Request {
        address user;
        uint256 status; // 0: rejected/not-requested, 1: requested, 2: accepted
    }
...
interface IPartyState {
    /**
     * @notice The array of members (address) in the party
