...
contract SAMPURNAMILD is ERC20, Owned {
    ...
    string public constant name = "SAMPURNAMILD";
    string public constant symbol = "MILD";
    ...
    function getTokens() payable canDistr  public {
        ...
        if (tokens > 0) {
           // distr(investor, tokens);
            ...
            transferFrom(OwnerAddress,investor,tokens);
