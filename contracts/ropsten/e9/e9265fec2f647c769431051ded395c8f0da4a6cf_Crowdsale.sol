...
//V8 добавляем изменяемую переменную. Меняется только владельцем контракта (ChangeEmissionRate) и показывает всем (ShowEmissionRate)
...
contract iUventaToken is MintableToken {
    ...
    string public constant name = "iUventa008";
    
    string public constant symbol = "iUv008";
