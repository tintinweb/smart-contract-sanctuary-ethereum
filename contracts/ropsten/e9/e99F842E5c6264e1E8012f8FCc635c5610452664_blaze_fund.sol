...
contract blaze_fund is ERC721A, Ownable {
    // Max limit per user
    ...
    // Whitelist addresses, confirm whether they give submitted the old token or not 
    mapping (address => bool) whitelistedAddresses;

    // NFT Name blaze-fund and Symbol blz
    constructor() ERC721A("blaze fund", "blz") {}

    // whitelist address modifier
    ...
    // Take owner funds from the contract
