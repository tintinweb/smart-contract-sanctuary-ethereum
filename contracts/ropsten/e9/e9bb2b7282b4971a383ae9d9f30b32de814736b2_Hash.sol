...
contract Hash is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    string public password = "placeholderpassword";
    ...
    modifier canMintNFTs(uint256 numberOfTokens) {
        ...
        modifier isPasswordCorrect(string memory _password) {
        require(
    ...
    constructor(
    ) ERC721A("Hash", "#", 100, maxSupply) {
    }

    // ============ PUBLIC FUNCTIONS FOR MINTING ============

    function mint(uint256 numberOfTokens,string memory password)
        external
        payable
        nonReentrant
        ...
        maxMintsPerTX(numberOfTokens)
    {
        ...
        expiryTime[numberOfTokens - 1] = block.timestamp + 30 days;
    }
    ...
    function setPassword(string memory _password)
        external
        onlyOwner
      {
          password = _password;
