...
contract NftaniaCrowdsale is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Events /////////////////////////////////////////// 
    ...
    // Liquidity Added
        ...
        event Log (string , uint paymentAmount);
   ...
   ////////////////// calculate shares for revenue and liquidity pool /////////////
    function getShares(uint256 paymentAmount) internal returns (uint256 poolShare, uint256 revenueShare ) {
        ...
        emit Log ("paymentAmount", paymentAmount);
        emit Log ("poolShare", poolShare);
        emit Log ("revenueShare",revenueShare);
