...
contract PoolMatrixGame {
    ...
    */
    ...
    function getUser(address userAddr) public view returns(bool registered, uint registrationTimestamp, uint userID, address userAddress, address referrer, uint256 debit, uint256 credit, uint256[] memory userCountInLine, uint256 referralReward, uint256 levelProfit, UserLevelInfo[] memory levels) {
