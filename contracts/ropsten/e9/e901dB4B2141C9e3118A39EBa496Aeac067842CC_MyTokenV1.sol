...
contract upgradedHEHE {
    uint verifyUpgraded = 1;

    function verifyHE() public {
        verifyUpgraded++;
    }
}
contract MyTokenV1 is Initializable, ERC20Upgradeable, UUPSUpgradeable, OwnableUpgradeable ,upgradedHEHE{
