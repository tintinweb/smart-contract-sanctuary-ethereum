...
contract AllowlistPolicy is Policy {
    ...
    // /**
    //  * Function: quotaManagement [public].
    //  * @param _domain The domain
    //  * @param _account The account to check.
    //  */
    ...
    //     address _account,
    //     uint256 _quota
    // ) public onlyOwner(_domain) isRegisterPolicy(_domain) {
    //     require(_quota == 0 || _quota == 1, "Invalid quota");
    //     for (uint256 i = 0; i < allowlists[_domain].length; i++) {
    //         if (allowlists[_domain][i].account == _account) {
    //             allowlists[_domain][i].quota = _quota;
    //             break;
    //         }
    //     }
    // }
