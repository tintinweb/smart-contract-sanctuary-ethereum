...
//FOR PRODUCTION
    ...
    uint256 public constant PRE_SALES_PRICE = 0 ether;
    uint256 public constant PUBLIC_SALES_PRICE = 0 ether;
    uint256 public constant MAX_QTY_PER_MINTER = 200;
    ...
    constructor(string memory _notRevealedUri) ERC721A("dudeles", "DUDE") PaymentSplitter( addressList, shareList) {
