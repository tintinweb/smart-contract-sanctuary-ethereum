...
interface ISToken is IERC20, IScaledBalanceToken, IInitializableSToken {
    ...
    /**
     * @dev Returns the address of the underlying asset of this sToken (E.g. USDC for sUSDC)
     **/
...
interface IInitializableSToken {
     ...
     * @param underlyingAsset The address of the underlying asset of this sToken (E.g. USDC for sUSDC)
