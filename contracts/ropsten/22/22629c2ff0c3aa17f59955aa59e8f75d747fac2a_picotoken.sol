...
contract picotoken is Context, IERC20, Ownable {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 360000, "Max Tx Amount cannot be less than 360 Thousand");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 360000, "Swap Threshold Amount cannot be less than 360 Thousand");
