...
contract hRCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function hRCoin() {
        ...
        name = "hRCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-041";                                             // Set the symbol for display purposes (CHANGE THIS)
