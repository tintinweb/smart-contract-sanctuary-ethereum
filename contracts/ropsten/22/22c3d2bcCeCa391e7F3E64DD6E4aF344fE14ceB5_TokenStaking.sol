...
import "./LgolToken.sol";

contract TokenStaking {
    string public name = "GOL Staking Platform";
    LgolToken public lgolToken;
    ...
    constructor(LgolToken lgolToken) public payable {
        lgolToken = lgolToken;
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        lgolToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        lgolToken.transfer(msg.sender, balance);
    ...
    function redistributeRewards() public {
        ...
        for (uint256 i = 0; i < stakers.length; i++) {
            ...
            if (balance > 0) {
                lgolToken.transfer(recipient, balance);
            }
        }
    }
    ...
    function claimTst() public {
        ...
        uint256 LGOL = 1000000000000000000000;
        uint256 balance = LGOL;
        lgolToken.transfer(recipient, balance);
    }
}
