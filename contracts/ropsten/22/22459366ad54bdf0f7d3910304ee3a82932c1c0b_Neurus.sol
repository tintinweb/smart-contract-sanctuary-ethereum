...
contract Neurus is StandardToken {
    ...
    */
    string public name = "Neurus";                   // fancy name: eg Simon Bucks
    ...
    string public symbol = "NEURUS";                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function Neurus(
        ...
        name = "Neurus";   // Set the name for display purposes
        decimals = 0;              // Amount of decimals for display purposes
        symbol = "NEURUS";                // Set the symbol for display purposes
    }
