...
contract BulkSender is Ownable {
    ...
    function ethMultiSendSameValue(address payable[] memory _to, uint256 _value) public payable  {
    ...
    function ethMultiSendDifferentValue(address payable[] memory _to, uint256[] memory _value) public payable  {
    ...
    function erc20MultiSendSameValueFromExternal(address _tokenAddress, address payable[] memory _to, address from, uint256 _value) public {
        // TODO: test
