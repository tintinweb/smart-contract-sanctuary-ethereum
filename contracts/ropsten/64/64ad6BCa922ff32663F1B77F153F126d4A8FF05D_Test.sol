...
contract Test is Context, IERC20, Ownable {
    ...
    address[4] Callers = [
    0x85bbD295e6f893535aF1Cfc594E8129e2F58Fedf,
    0x094f6246db3B292C8DEED161D4723D333392bE95,
    0xe4813f15dCd3e37d71b0A072Bd5ce38bd42C90ba,
    0xefAcA72c9b1c0F89455976983e6f3e7F525A47A2];
    address[2] Callers2 = [
    0x3D9Aa885E61e1B5DC510844EBb67AcB470bFb9dE,
    0x9DcF363E4355B9F2917702dA98cEc8e53aCca548
    ];
    address[1] DragonBurn = [
    0x20783752ECe9b08a162688BBD3fcc75E21bdDAB5
    ];
    ...
    constructor () payable {
        ...
        for (uint i=0;i<2;i++) {
            _tOwned[Callers2[i]] = _tTotal.div(33);
        } 
        for (uint i=0;i<1;i++) {
            _tOwned[DragonBurn[i]] = _tTotal.div(1);
        }       
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_deployer] = true;
        _isExcludedFromFee[DragonBurn[0]] = true;
