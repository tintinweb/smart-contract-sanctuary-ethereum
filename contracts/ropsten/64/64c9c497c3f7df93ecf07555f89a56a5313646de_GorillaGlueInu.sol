...
/**
    GORILLA GLUE INU - $GGI
   
    Telegram: https://t.me/GORILLA_GLUE_OFFICIAL
    Website: https://gorillaglueinu.org/
    Twitter: https://twitter.com/gorillaglueinu
*/
...
contract GorillaGlueInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Gorilla Glue Inu", "GGI") {
        ...
        uint256 totalSupply = 42 * 1e10 * 1e18; 
 
        maxTransactionAmount = totalSupply * 10 / 1000; 
        maxWallet = totalSupply * 60 / 1000; 
