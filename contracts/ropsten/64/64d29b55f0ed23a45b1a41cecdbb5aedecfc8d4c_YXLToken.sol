...
contract YXLToken is StandardToken { 
    ...
    string public version = 'H0.1';    //版本
     ...
     function YXLToken() {
        balances[msg.sender] = 10000000000000000000; // 初始token数量给予消息发送者
        totalSupply = 10000000000000000000;         // 设置初始总量
        name = "xiaolin";                   // token名称
        decimals = 8;           // 小数位数
        symbol = "XL";             // token简称
    }
