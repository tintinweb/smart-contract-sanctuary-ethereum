...
contract Test2 is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "2";//
    ...
    address payable private _developmentAddress = payable(0x1FE977b57505FD9b18cDd2F012CdbA68c1572B6E);//
    address payable private _marketingAddress = payable(0x237E6b965F0f3E9274ed58Eb6aBC60487C082dc1);//
