...
contract Shroom is ERC4907, Ownable {
    ...
    uint256 private _giftReserved = 57;
    ...
    function mintShroom(uint256 num) public payable {
        ...
        require( supply + num <= MAX_SUPPLY - _giftReserved, "Exceeds maximum Shrooms supply" );
    ...
    function giveAwayMany(address[] memory addresses) external onlyOwner() {
        require( addresses.length <= _giftReserved, "Exceeds reserved gift Shrooms supply" );
