...
contract taniumini is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 666 * 10**15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    /* Marketing Wallet
    This wallet is for marketing purposes and the address is one of the wallets we have to create before.
    The amount of tokens that go on this wallet is defined in variables buyFee.marketing and sellFee.marketing.
    That is ShibaDoge Marketing Wallet:
    https://etherscan.io/address/0x61E7210AE22cCfaBd5B9289208EA65a8718b04B1
    OMFG thats much money O.O
    It is currently set to 48 in buy and sell case
    */
    address payable public _marketingAddress =
        payable(address(0xD64a95bb753505d3656E5DC7cf31BA62c39f8A88));
    /* Dev Wallet
    This wallet is for I DO NOT KNOW purposes and the address is one of the wallets we have to create before.
    The amount of tokens that go on this wallet is defined in variables buyFee.dev and sellFee.dev.
    It is currently set to 0
    */
    address payable public _devwallet =
        payable(address(0xb8e97693DF3D6D27aD0155463F0cbA209C1Bb9F8));
    address public _exchangewallet =
        payable(address(0x427b5130F5FDA3a36292a19694070Ce7D7803226));
    address _partnershipswallet =
        payable(address(0x43de4a056B865DDbb4bBeb15862C7FB380C440dc));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "taniumini";
    string private _symbol = "taniumini";
    ...
    uint256 public _maxTxAmount = 333 * 10**13 * 10**_decimals;
    uint256 private numTokensSellToAddToLiquidity = 333 * 10**13 * 10**_decimals;
    uint256 public _maxWalletSize = 666 * 10**13 * 10**_decimals;
