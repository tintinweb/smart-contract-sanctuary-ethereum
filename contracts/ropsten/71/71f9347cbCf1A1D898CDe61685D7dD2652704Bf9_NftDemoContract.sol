...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    pragma solidity ^0.8.7;
    contract NftDemoContract is ERC721Enumerable,  Ownable {
    using Strings for uint256;


  string public uriPrefix = "ipfs://Qmc9iVY6ZHdSoJr9sjphT3jLgASNY6CdqX72NALjDLkLWS/";
  string public uriSuffix = ".json";

  uint256 public cost = 0.02 ether;
 
  uint256 public constant maxSupply = 10001; // actual value is 10000
  uint256 public maxMintAmountPerTx = 11;   // actual value is 10



  constructor() ERC721("DEMO ANIME PROJECT", "NFT") {
