...
contract Aggregator is IAggregator, ValidatorNftRouter, UUPSUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        __Pausable_init();
        __ValidatorNftRouter__init(depositContract, vault, nftContract);
...
contract ValidatorNftRouter is Initializable {
    ...
    function _tradeRoute(Trade memory trade) private {
        ...
        require(msg.value == sum, "Incorrect Ether amount provided");
        ...
        signercheck(trade.signature.s, trade.signature.r, trade.signature.v, masterHash, authority);
    }
    ...
    function tradeRoute(bytes calldata data) internal {
        Trade memory trade;
