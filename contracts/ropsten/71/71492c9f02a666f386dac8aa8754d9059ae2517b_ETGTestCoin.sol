...
contract ETGTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ETGTestCoin() {
        ...
        name = "ETGTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ETGCN";                                             // Set the symbol for display purposes (CHANGE THIS)
