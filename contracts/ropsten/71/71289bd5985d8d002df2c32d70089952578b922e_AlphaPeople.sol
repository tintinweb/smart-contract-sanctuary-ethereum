...
// File contracts/DNAData.sol

// SPDX-License-Identifier: MIT
pragma solidity >=0.7.0 <0.9.0;

contract DNAData {
    string[] internal _accessoriesType = [
        "Blank",
        "Kurt",
        "Prescription01",
        "Prescription02",
    ...
    string[] internal _facialHairColor = [
        "Auburn",
        "Black",
        "Blonde",
        "BlondeGolden",
    ...
    string[] internal _facialHairType = [
        "Blank",
        "BeardMedium",
        "BeardLight",
        "BeardMagestic",
...
// File contracts/AlphaPeople.sol
...
// contract PunkPpl is ERC721, ERC721Enumerable, PaymentSplitter, AlphaDNA {
contract AlphaPeople is ERC721, ERC721Enumerable, AlphaDNA {
  ...
  // constructor(uint256 _maxSupply, address[] memory _payees, uint256[] memory _shares) ERC721("AlphaPeople", "PPL") PaymentSplitter(_payees, _shares) {
  constructor(uint256 _maxSupply) ERC721("AlphaPeople", "ALP") {
    maxSupply = _maxSupply;
  }

  function mint() public payable {
    // require(msg.value >= 50000000000000000,"you neet 0.05 ETH to mint the AlphaPeople");
