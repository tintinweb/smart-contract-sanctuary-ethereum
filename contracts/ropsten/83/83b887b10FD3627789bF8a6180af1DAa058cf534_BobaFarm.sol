...
contract BobaFarm {
    ...
    constructor(BobaToken _bobaToken) {
        rewardTokensPerBlock = 200;
        bobaToken = _bobaToken;
    }

    function addTokensToFarm(MilkToken _milkToken, TeaToken _teaToken, PearlToken _pearlToken) public {
...
contract TeaToken is ERC20 {
    constructor (address user, uint256 initialSupply) ERC20("TeaToken", "TEA") {
        _mint(user, initialSupply * 10 ** 18);
    }
}
