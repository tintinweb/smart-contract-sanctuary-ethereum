...
contract Token is ERC20 {
    ...
    function () public payable isTgrLive isNotFrozenOnly noAnyReentrancy {
        ...
        require(tgrSettingsAmountCollected < tgrSettingsAmount); //checking if target amount is not achieved
        ...
        //if the value sent is bigger then remaining to achieve the target, the difference is refunded
        uint refundAmount = 0;
