...
contract BundleNFT is Initializable, OwnableUpgradeable, ERC721URIStorageUpgradeable {
     ...
     */
    function bundleWithTokenURI(NFT[] memory _tokens, string memory tokenURI, bool transferOwnership) public payable returns(uint256) {
     ...
     */
    function bundle(NFT[] memory _tokens, bool transferOwnership) public payable returns(uint256) {
        uint256 tokenId = bundleWithTokenURI(_tokens, "" , transferOwnership);
        return tokenId;
    }
