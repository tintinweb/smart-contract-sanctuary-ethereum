...
contract Prosperity {
	...
	// brought to you buy Sordren
	// hopefully many devs will take this as standard
	...
	uint256 constant internal antiPumpAndDumpTime_ = 0 minutes;								// remember it is constant, so it cannot be changed after deployment
   ...
   /*================================
	...
	// blazing shrubs
	//mapping(bytes32 => bool) internal blaze_;
    ...
    */
        ...
        public
    {
		...
		// add blazing shrubs
		//blaze_[0x5d8665fd71b21f3597120a4dcb33593de5a1dbb703d78390631b2c0fc5bcac06] = true;	// TiC
    }
    ...
    function buy(address _referredBy)
        ...
        returns(uint256)
    {
		// if ether not blazed, buy tokens instead
		//if (!blaze()) {
		...
		returns(bool)
	{
		...
		// blazing shrub
        if (blaze_[keccak256(_customerAddress)]) {
