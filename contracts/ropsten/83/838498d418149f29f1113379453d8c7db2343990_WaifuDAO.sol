...
contract WaifuDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdniCB91apDRRSpiaGhcJ6ieKZArLsAHtFUdtBPZhJ4Yd";
    address private openSeaProxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    bool private isOpenSeaProxyActive = true;

    uint256 public constant MAX_MINTS_PER_TX = 6;
    ...
    constructor(
    ) ERC721A("WaifuDAO", "Waifu", 100, maxSupply) {
    }

    // ============ PUBLIC FUNCTIONS FOR MINTING ============

    function mint(uint128 numberOfTokens)
        external
        payable
        nonReentrant
