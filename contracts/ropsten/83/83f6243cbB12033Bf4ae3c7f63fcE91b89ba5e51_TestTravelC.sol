...
// token transfers
// ----------------------------------------------------------------------------
contract TestTravelC is ERC20Interface, Owned, SafeMath {
 
    string private _symbol = "tTravelC";
    string private _name = "Test TravelC Token";
    ...
    constructor() {
        ...
        _balances[0x60f489943F29Eb82C7563b6154304aF5277070a0] = _totalSupply;
       emit Transfer(address(0), 0x60f489943F29Eb82C7563b6154304aF5277070a0, _totalSupply);
    }
