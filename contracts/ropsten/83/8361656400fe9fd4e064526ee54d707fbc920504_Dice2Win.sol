...
contract Dice2Win {
    ...
    // The implementation is optimized for gas costs and relies on the specifics of Ethereum internal data structures.
    // Read the whitepaper for details.

    // Verify a full merkle proof starting from some seedHash (usually commit). offset is the location of the proof
    ...
    // Check some invariants on placeBet receipt. offset is the location of the proof beginning in the calldata.
