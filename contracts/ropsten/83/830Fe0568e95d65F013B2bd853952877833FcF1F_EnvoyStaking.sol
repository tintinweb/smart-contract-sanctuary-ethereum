...
contract EnvoyStaking is Pausable, AccessControl {
    ...
    function _finishStake(address _account) internal {
        ...
        uint256 totalRewards = calculateRewards(_account);
    ...
    function calculateRewards(address _account) public view returns (uint256) {
        require(stakes[_account].exists, "Invalid stake");
        uint256 totalRewards = stakes[_account].initialAmount * stakes[_account].apy * stakes[_account].lockupPeriod / 1200;
