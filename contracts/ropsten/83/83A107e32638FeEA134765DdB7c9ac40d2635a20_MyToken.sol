...
// File: erc115ziplin.sol


// SPDX-License-Iden// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (token/ERC1155/ERC1155.sol)tifier: MIT
...
contract MyToken is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    uint256[] rates = [0.05 ether, 0.1 ether, 0.25 ether];
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data)
        ...
        payable//onlyOwner
    {
        require(id <= supplies.length, "Token doestn`t exist");
