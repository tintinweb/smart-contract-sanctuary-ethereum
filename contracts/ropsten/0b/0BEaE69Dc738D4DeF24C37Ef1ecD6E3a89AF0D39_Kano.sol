...
contract Kano is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 100000000000; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 100000000000; // 2% of supply
    uint256 public maxWalletAmount = _tTotal / 100000000000; // 2% of supply
    ...
    string private constant _name = "Kano Inu";
    string private constant _symbol = "KANO";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 4 / 100000000; //0.4%
