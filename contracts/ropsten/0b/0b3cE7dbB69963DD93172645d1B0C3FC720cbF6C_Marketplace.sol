...
contract Marketplace{
    ...
    */
    ...
    constructor(){
        ...
        contractName = "MarketPlace Contract";
    }
    ...
    */
    function ERC20_Transfer_User2User(address _to, uint256 _amount) public payable returns(bool){
        ...
        require(_amount*1e18 > 0 && token20.balanceOf(msg.sender) >= _amount*1e18);

        token20.exchangeERC20(msg.sender, _to, _amount*1e18);
    ...
    */
    ...
    function ERC20_Provider(int _benefit) public returns(bool){
        ...
        token20.transferERC20(address(this), msg.sender, tokenBenefit*1e18);
        
        emit TokenBenefitSuccess(msg.sender, tokenBenefit*1e18, true);
        return true;
    }
    ...
    */
    function createERC721Token(string memory _tokenURI, int _price) public returns(bool){
        ...
        // NFT 등록
        items[int(itemCount)] = NFT_List(int(itemCount), _tokenURI, _price*1e18, payable(msg.sender), true);

        // NFT 등록 완료 이벤트
        emit NFTOffered(int(itemCount), _tokenURI, _price*1e18, msg.sender, true);
