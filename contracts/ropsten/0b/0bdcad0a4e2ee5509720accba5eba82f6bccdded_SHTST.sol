...
contract SHTST is Context, IERC20 {
    ...
    string private _name = "STTST";
    string private _symbol = "$SHTST";
    ...
    address payable private _marketingWallet = payable(0x850aDe8D50260b2087E62D2fa0805BCEC7F9F7Cc);
    address payable private _devWallet = payable(0xd551060075120d845484E6453fdF9aa6DB984878);
