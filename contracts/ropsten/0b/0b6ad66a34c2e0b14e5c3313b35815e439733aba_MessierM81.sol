...
contract MessierM81 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Messier", "M81") {
        ...
        uint256 totalSupply = 81 * 1e9 * 1e18;
        ...
        marketingWallet = address(0x44E1D72493135f129BC3b762D988ec64e1420C09); // set as marketing wallet
