...
contract testNGT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("testNGT", "tNGT") {
        ...
        marketingWallet = address(0x484B7D3903D98D311B48156133d42C7536E99576); // set as marketing wallet
        devWallet = address(0x1e25657231d53fae433D5b04f39776ecB6465eaE); // set as dev wallet
