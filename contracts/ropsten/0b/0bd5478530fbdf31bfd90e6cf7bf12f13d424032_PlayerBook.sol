...
contract PlayerBook {
    ...
    BitYuInterface constant private BitYu = BitYuInterface(0x736b2b6bc6ca3ad59622858e397dc8925a041171);
    
    MSFun.Data private msData;
    function multiSigDev(bytes32 _whatFunction) private returns (bool) {return(MSFun.multiSig(msData, BitYu.requiredDevSignatures(), _whatFunction));}
    ...
    function checkSignersByName(bytes32 _whatFunction, uint256 _signerA, uint256 _signerB, uint256 _signerC) onlyDevs() public view returns(bytes32, bytes32, bytes32) {return(BitYu.adminName(MSFun.checkSigner(msData, _whatFunction, _signerA)), BitYu.adminName(MSFun.checkSigner(msData, _whatFunction, _signerB)), BitYu.adminName(MSFun.checkSigner(msData, _whatFunction, _signerC)));}
//==============================================================================
// Data Setup
//==============================================================================    
...
//==============================================================================    
        ...
        public
    {
        ...
        plyr_[1].addr = 0xfE6312f2350B8752923ED05fdfBeb96fbD5c781e;
        plyr_[1].name = "aceofhearts";
        plyr_[1].names = 1;
        pIDxAddr_[0xfE6312f2350B8752923ED05fdfBeb96fbD5c781e] = 1;
        pIDxName_["aceofhearts"] = 1;
        plyrNames_[1]["aceofhearts"] = true;
        plyrNameList_[1][1] = "aceofhearts";
        
        plyr_[2].addr = 0x577a0AD1cA4011924255A7A44F3f70aB5A4B62dF;
        plyr_[2].name = "aceofspades";
        plyr_[2].names = 1;
        pIDxAddr_[0x577a0AD1cA4011924255A7A44F3f70aB5A4B62dF] = 2;
        pIDxName_["aceofspades"] = 2;
        plyrNames_[2]["aceofspades"] = true;
        plyrNameList_[2][1] = "aceofspades";
        
        plyr_[3].addr = 0x769FE7079b0614330fA686dAC1fEAaCDB322f49F;
        plyr_[3].name = "aceofdiamonds";
        plyr_[3].names = 1;
        pIDxAddr_[0x769FE7079b0614330fA686dAC1fEAaCDB322f49F] = 3;
        pIDxName_["aceofdiamonds"] = 3;
        plyrNames_[3]["aceofdiamonds"] = true;
        plyrNameList_[3][1] = "aceofdiamonds";
        
        plyr_[4].addr = 0xDaed3C44d9d0Ef67B24247660d1f532F930aADC8;
        plyr_[4].name = "aceofclubs";
        plyr_[4].names = 1;
        pIDxAddr_[0xDaed3C44d9d0Ef67B24247660d1f532F930aADC8] = 4;
        pIDxName_["aceofclubs"] = 4;
        plyrNames_[4]["aceofclubs"] = true;
        plyrNameList_[4][1] = "aceofclubs";
...
//==============================================================================    
    /**
     * @dev prevents contracts from interacting with BitYu 
     */
    modifier isHuman() {
    ...
    modifier onlyDevs() 
    {
        require(BitYu.isDev(msg.sender) == true, "msg sender is not a dev");
        _;
    }
...
//==============================================================================    
        ...
        private
    {
        ...
        Bit_Yu_Inc.deposit.value(address(this).balance)();
