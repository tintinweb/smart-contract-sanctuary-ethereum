...
contract BittwattToken is CappedToken,Claimable, PausableToken {

    string public constant name = "BittwattToken";
    ...
    function BittwattToken(uint _cap) public CappedToken(_cap) {
        pause();
    }
