...
contract Claim is ERC721A, Ownable {
    ...
    uint256 MAX_SUPPLY;
    string public baseURI = "ipfs://NEW_IPFS_LINK/";
    string public uriSuffix = ".json";
    mapping(address => uint8) claimed;
    mapping(uint => bool) public nftSold;
    

    constructor(address _NFTAddress, uint256 _supply) ERC721A("BB Bunny", "BBB") {
    ...
    function claimAirdrop() external {
        ...
        for(uint i = 0; i<NftOwned; i++){
            if(!nftSold[ERC721Interface.walletOfOwner(msg.sender)[i]]){
                nftSold[ERC721Interface.walletOfOwner(msg.sender)[i]] = true;
