...
contract Egg is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("EGG", "EGG") {
        _mint(msg.sender, 1 ether); // mint 1 EGG for initial pools deployment
