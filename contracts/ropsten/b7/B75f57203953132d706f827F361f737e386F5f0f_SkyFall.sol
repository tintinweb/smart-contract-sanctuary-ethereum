...
abstract contract SilksLandInterface {
...
contract SkyFall is ERC1155, Ownable, ERC1155Burnable {
    ...
    address silksLandContractAddress;
    ...
    constructor() ERC1155("<path to metadata>") {}
    ...
    function setSilksLandContract(address contractAddress) public onlyOwner {
        silksLandContractAddress = contractAddress;
    }
...
//            tokenId++;
    ...
    function migrateToken(uint256 id) public returns(uint256) {
        ...
        SilksLandInterface silksLandContract = SilksLandInterface(silksLandContractAddress);
        uint256 mintedId = silksLandContract.mintTransfer(msg.sender); // Mint the ERC-721 token
    ...
    function forceMigrateToken(uint256 id) public onlyOwner {
        ...
        burn(msg.sender, id, 1); // Burn one the ERC-1155 token
        SilksLandInterface silksLandContract = SilksLandInterface(silksLandContractAddress);
        silksLandContract.mintTransfer(msg.sender); // Mint the ERC-721 token
    }
