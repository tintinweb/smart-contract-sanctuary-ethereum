...
contract lonmemay is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function lonmemay() {
        ...
        name = "lonmemay";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 8;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LMM";                                             // Set the symbol for display purposes (CHANGE THIS)
