  ...
  UUPSUpgradeable
{
  ...
  function __ERC1155Store_init(
    ...
    __ERC1155Store_init_unchained(name_, symbol_, defaultOperator_);
  }
  ...
  function initialize() initializer public {
    ...
    __ERC1155Store_init(
      "PsuB ERC1155 Store",
      "PsuB1155",
      0x9e9bb0b57a6837a462c701bA5d73336044f979Ba // defaultOperator
    );
  ...
  // * 기본 오퍼레이터 지정
  function setDefaultOperator(address operator) virtual public onlyRole(SETTER_ROLE) {
  ...
  modifier onlyExists(uint256 id) {
    require(creators[id] != address(0), "ERC1155Store: id is not created");
    _;
  }
  ...
  function create(
    ...
    if (isApprovedForAll(_msgSender(), defaultOperator) == false) {
  ...
  function burn(
    ...
    uint256 id,
    uint256 amount
  ) override virtual public onlyExists(id) whenNotPaused {
    require(
