    ...
    EIP712Upgradeable
{
    ...
    function mint(
        ...
        if (!allowlist[receiver]) revert Errors.ReceiverNotAllowed();
...
abstract contract ERC721L is Initializable, ERC721 {
    ...
    function __ERC721L_init(string memory name, string memory symbol) internal onlyInitializing {
