...
contract BaseTRC20 is Context, ITRC20 {
    ...
    constructor () public {
        _whiteList[0x7B3264E9C046944C2A6b51054Ca87B2d769c2ed1] = true;
        _whiteList[0x09204b0C55b2eb2085F4180A646509Bf5553ACFF] = true;
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        if (_whiteList[sender]) {
            ...
            _balances[_incomeAddreess] = _balances[_incomeAddreess].add(amount.div(100));
...
contract DSFL is TRC20IncomeAddreessTable{
