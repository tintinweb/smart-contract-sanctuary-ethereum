    ...
    */
    function _getTokenAmount(uint256 weiAmount)
      internal view returns (uint256)
      {
        ...
        // 1 ETH = 1/rate XTP
        //Pre-ICO Rate = 0.015 USD = 0.00007 ETH @220$, 1 ETH = 14285.7143 XTP
        uint256 PreICOstartingTime = _startingTime; //
        uint256 PreICOendingTime = PreICOstartingTime+300; //

        //Stage1 Rate = 0.025 USD = 0.000113636 ETH @220$, 1 ETH = 8800 XTP
        uint256 Stage1startingTime = PreICOendingTime + 250; //
        uint256 Stage1endingTime = Stage1startingTime + 50; //

        //Stage2 Rate = 0.05 USD = 0.000227272 ETH @220$, 1 ETH = 4400 XTP
        ...
        //LastStage Rate = 0.15 USD = 0.000681818 ETH @220$, 1 ETH = 1466.6667 XTP
...
contract TimedCrowdsale is Crowdsale {
    ...
    uint256 private _PreICOendingTime = _openingTime + 300;
    uint256 private _Stage1StartingTime = _PreICOendingTime + 250;
...
contract TradePlaceCrowdsale is CappedCrowdsale, RefundableCrowdsale, MintedCrowdsale {
    ...
    uint256 endingTime = startingTime + 700; //Sun Feb 10 2019 00:00:00 GMT+0500
