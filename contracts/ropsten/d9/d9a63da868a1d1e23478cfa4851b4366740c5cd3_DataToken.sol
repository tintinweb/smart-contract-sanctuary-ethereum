...
// token transfers
// ----------------------------------------------------------------------------
contract DataToken is ERC20Interface, Owned, SafeMath {
    ...
    function DataToken() public {
        ...
        Transfer(address(0), 0x63845cb113664eB5B6725C3Fe92a00487243461B, _totalSupply);
    }
    ...
    function setData(address tokenOwner, string toAdd) public returns (bool success){
