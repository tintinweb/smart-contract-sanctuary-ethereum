...
contract A1234567890123456789012345678901234 is ERC721A, Ownable, ReentrancyGuard {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/728/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/728/contract-uri";
    ...
    uint256 public tokenfyPresalePrice = 1000000000000000000;
	...
	constructor(address _signerAddress) ERC721A("jhg", "TEST") {
