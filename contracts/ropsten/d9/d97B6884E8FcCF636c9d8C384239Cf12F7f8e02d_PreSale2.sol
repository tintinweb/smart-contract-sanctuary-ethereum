...
contract PreSale2 is Ownable {
    ...
    // Avax Main Net
    IERC20 public PTOKEN = IERC20(0xB95364F928A1a5E210455401832fFA647C215560);
    IERC20 public RCTOKEN = IERC20(0x79533CC574140E7B0cCD8c9b7fE52B26957FDFEd);
    uint256 public RCTOKEN_DECIMAL = 18;
    ...
    function deposit(uint256 amount) public checkIfPaused {
        ...
        uint256 tokenAmount = amount.div(tokenPrice).div(10 ** (RCTOKEN_DECIMAL.sub(5)));
