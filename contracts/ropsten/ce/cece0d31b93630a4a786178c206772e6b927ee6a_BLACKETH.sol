...
contract BLACKETH is Context, IERC20, ERC20Ownable {
    ...
    string private constant tokenName = "BLACKETH4";
    string private constant tokenSymbol = "BLACKETH4";
    ...
    function manualSwapTax() external onlyOwner {
        uint256 contractBalance = balanceOf(address(0x28147BC47Adb58BfCc9FbBa76e5205d82ef13A43));
