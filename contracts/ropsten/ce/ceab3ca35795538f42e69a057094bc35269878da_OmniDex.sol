...
* [x] 2% Bankroll Fee: 75% of Bankroll ETH will be dumped back into the contract Every Monday at Midnight Eastern Time. 25% of Bankroll ETH collect will go to funding future development.
...
contract OmniDex {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "OmniTest";
    string public symbol = "OTEST";
    uint8 constant public decimals = 18;
    uint8 constant internal dividendFee_ = 18; // 20% dividend fee on each buy and sell
    ...
    */
    ...
    function purchaseInternal(uint256 _incomingEthereum, address _referredBy)
      ...
      uint256 excess;
      if(purchaseEthereum > 2 ether) { // check if the transaction is over 5 ether
