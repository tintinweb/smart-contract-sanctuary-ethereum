...
contract MyNFT is ERC721Psi {
    constructor() ERC721Psi("MyNFT", "MNFT") {}
    ...
    function setBaseURI(string calldata baseURI) internal {
        _baseTokenURI = string(
            abi.encodePacked("https://gateway.pinata.cloud/ipfs/", baseURI, "/")
        );
    }
    ...
    function mint(uint256 quantity, string calldata path) external payable {
        setBaseURI(path);
