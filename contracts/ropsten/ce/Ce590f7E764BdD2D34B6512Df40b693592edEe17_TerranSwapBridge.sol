...
contract TerranSwapBridge is Context {
    ...
    uint256 public feePercentageInTerran;
    ...
    constructor(
        uint256 fee_Native,
        uint256 fee_PerTerran,
        address payable fee_Receiver,
        address super_Admin
    ) {
        swapFee = fee_Native;
        feePercentageInTerran = fee_PerTerran;
     ...
     */
    function setSwapFeePercentageOfTRR(uint256 _feePerTerran)
        external
        onlyOwner
    {
        require(
            _feePerTerran < 100000000000000000000,
            "feePercentageInTerran: Greater than 100 %"
        );
        feePercentageInTerran = _feePerTerran;
    }
    ...
    function swapToken(
        ...
        require(amount > 0, "Amount should be greater than 0");
        require(
            feePercentageInTerran < 100000000000000000000,
            "feePercentageInTerran: Greater than 100 %"
        );

        uint256 feeAmountInTrr = 0;
        if (feePercentageInTerran > 0) {
            feeAmountInTrr = amount.mul(feePercentageInTerran);
