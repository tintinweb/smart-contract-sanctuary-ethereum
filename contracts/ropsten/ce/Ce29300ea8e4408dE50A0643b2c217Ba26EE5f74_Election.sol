...
contract Election  {
    ...
    function votingIsOn() public view returns (bool){
        return goingOn;
    }
    ...
    function resetVoting(address voterAddress,uint _candidateId) public {
        require (!goingOn , "Voting is on. So you can note reset the voting system.");
