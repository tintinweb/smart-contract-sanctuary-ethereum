...
contract Staking {
    ...
    uint32[6] public periods = [15 days, 30 days, 60 days, 90 days, 180 days, 365 days];
    uint16[6] public rates = [10411, 10822, 11644, 12466, 14952, 20000];
    uint256[6] public amounts = [10000e18, 20000e18, 50000e18, 100000e18, 250000e18, 500000e18];
