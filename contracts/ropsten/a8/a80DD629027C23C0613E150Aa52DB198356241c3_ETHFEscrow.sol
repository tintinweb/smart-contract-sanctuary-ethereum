...
contract ETHFEscrow is ERC721Holder {
    ...
    function escrowToken(address tokenAddress, address _from, uint256 _tokenId) external  {
        require(approvedContracts[msg.sender], "Contract is not approved");
        IERC721(tokenAddress).safeTransferFrom(_from, address(this), _tokenId);
    }
