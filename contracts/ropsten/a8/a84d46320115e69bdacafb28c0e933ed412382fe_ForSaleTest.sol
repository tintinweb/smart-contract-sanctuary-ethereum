...
contract ForSaleTest is ERC721, Ownable {
    using SafeMath for uint256;
    using Address for address;

    mapping(address => uint256) addressPurchaseTotal;
    ...
    uint256 public maxPurchaseAmount = 10;
    bool public saleActive = false;
    uint256 public price = 0.069 ether;

    constructor() ERC721("ForSaleTest", "FRSTST") {}
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            addressPurchaseTotal[msg.sender].add(_mintAmount) <=
                maxPurchaseAmount,
        ...
        for (uint256 i = 0; i < _mintAmount; i++) {
            addressPurchaseTotal[msg.sender] =
                addressPurchaseTotal[msg.sender] +
                1;
    ...
    function setPurchasePerAddress(uint256 _maxAllowed) external onlyOwner {
