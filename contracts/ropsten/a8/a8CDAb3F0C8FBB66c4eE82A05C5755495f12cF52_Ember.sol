...
contract Ember is ERC20, Ownable {
    ...
    constructor() ERC20("Ember", "Ember") {
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xC28eA95A2071cD9EFd5796aeD58D303e41809196); // pancakeswap v2 router address
    ...
    function setFee(uint256 _marketingFee) public onlyOwner {
        require(_marketingFee <= 5, "fees must be less than or equal to 5%");
