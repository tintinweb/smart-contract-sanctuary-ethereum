...
import {OracleLibrary} from "../intergrations/uniswap/libraries/OracleLibrary.sol";
...
contract PriceOracle {
    ...
    function convertToETH(address token, uint256 amount)
        ...
        returns (uint256)
    {
        return convert(token, wethAddress, amount);
    }
    ...
    function convert(
        ...
        // (int24 tick, ) = OracleLibrary.consult(pool, pricePeriod); // time-weighted price
