...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x4caA13f24BcBaad802e3D7B1252C783Ff9B4DD46), // FengGenesisPool
        address(0x07D6262a6b3a82aa092e409128F6B015257A9CE1) // new FengRewardPool
    ];
...
interface IMasonry {
    ...
    function getFengPrice() external view returns (uint256);
