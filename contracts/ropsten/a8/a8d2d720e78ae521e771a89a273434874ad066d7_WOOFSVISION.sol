...
contract WOOFSVISION is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
 
    string private constant _tokenName = "WOOFS VISION";
    string private constant _tokenSymbol = "WOOF";
    uint8 private constant _tokenDecimal = 4;
    ...
    uint256 private MarketingTax = 3;
    uint256 private prevMarketingTax = MarketingTax;
    uint256 private AppDevelopmentTax = 0;
    ...
    uint256 private buyMarketingTax = 3;
    uint256 private buyAppDevelopmentTax = 0; 
    uint256 private buyLiquidityTax = 3;
    uint256 private buyReflectionsTax = 0; 
    uint256 private sellMarketingTax = 3; 
    uint256 private sellAppDevelopmentTax = 0; 
    uint256 private sellLiquidityTax = 3;
    uint256 private sellReflectionsTax = 0; 
    uint256 private maxTokenPercent = 5;
    uint256 public ActiveTradeBlock = 0;
    uint256 public SniperPenaltyEndTime;
 
 
 
    // Max Wallet set as true
    ...
    constructor() payable {
        ...
        // Replace with your Public ETH Address
