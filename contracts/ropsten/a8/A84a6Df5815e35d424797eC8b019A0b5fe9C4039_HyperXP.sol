...
contract HyperXP is Ownable, ReentrancyGuard {
    ...
    mapping(address => mapping(uint256 => uint256)) public apBlock;
    ...
    public view returns(uint256) {
        return (!hyperAddresses[collection] || (block.timestamp - apBlock[collection][tokenId] < 5 minutes)) 
        ? 0 
        : 1;
    }
    ...
    external {
        ...
        apBlock[collection][tokenId] = block.timestamp;
