...
contract GroovyguysNFT is ERC721, Ownable, Pausable, ReentrancyGuard {
    ...
    address[] private _royaltyAddresses = [
        ...
        0x78244E7A862bDa32B1A44beBD5A91BabF6cf23E3
    ];
    ...
    ) ERC721("GroovyGuysNFT", "GG") {
        setBaseURI(_initBaseURI);
        setNotRevealedURI(_initNotRevealedURI);
        _royaltyShares[_royaltyAddresses[0]] = 25;  
        _royaltyShares[_royaltyAddresses[1]] = 25;
        _royaltyShares[_royaltyAddresses[2]] = 50; 
    }
    ...
    function mint(uint256 _count) public payable {
        ...
        require(
            _count > 0 && balanceOf(msg.sender) <= MAX_MINT_PER_TX,
            "COUNT_INVALID"
        );
        require(totalSupply >= GIVEAWAY_SUPPLY, "GIVEAWAY_NOT_MINTED");
        require(totalSupply + _count <= MAX_SUPPLY, "MAX_SUPPLY_REACHED");
