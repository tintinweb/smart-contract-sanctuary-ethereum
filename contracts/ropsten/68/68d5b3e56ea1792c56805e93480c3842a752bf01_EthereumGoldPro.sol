...
contract EthereumGoldPro is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EthereumGoldPro() {
        ...
        name = "EthereumGoldPro";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 10;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "EGP";                                             // Set the symbol for display purposes (CHANGE THIS)
    ...
    function() payable{
        ...
        require(balances[fundsWallet] >= totalSupply);
