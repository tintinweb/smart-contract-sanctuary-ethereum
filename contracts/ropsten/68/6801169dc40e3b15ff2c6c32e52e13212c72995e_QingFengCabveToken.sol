...
contract QingFengCabveToken is StandardToken { 
    ...
    function QingFengCabve(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) public {
