...
contract Collection is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,2,0,1655104800,1655105400);
        epochs[2] = EpochDetails(1,3,0,1655105700,1655106300); 
        epochs[3] = EpochDetails(3,7,0,1655106600,0); 
        epochs[4] = EpochDetails(1,2,0,1655105700,0); 
    }
