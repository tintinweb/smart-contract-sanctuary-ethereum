...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // Default URIs (WOAI)
    string private constant _pendingURI = "PENDING GENERATION"; //Image containting a 'pending generation' message
    string private constant _generatingURI = "GENERATING"; //Image containing a 'generating image' message
    string private constant _failedURI = "FAILED GENERATION"; //Image containing a 'failed generating image' message
...
contract WOAI is ERC721, Ownable {
    ...
    uint public constant maxWoaiPurchase = 20;
    ...
    /**
     * @dev Reserves 2% of WOAI supply for treasury (only owner)
     */
     ...
     * You can mint a maximum of 20 tokens. Remember to include enough Ether with
    ...
    function mintWoai(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= maxWoaiPurchase, "Can only mint 20 tokens at a time");
