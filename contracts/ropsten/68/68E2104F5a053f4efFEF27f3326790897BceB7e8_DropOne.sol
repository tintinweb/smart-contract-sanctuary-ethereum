...
contract DropOne is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIds;
    bool public isSaleActive = true;

    constructor() ERC721("Drophouse", "Drop") {
    }
    ...
    function mint(address to,  string memory tokenURI) public payable {
        ...
        require(_tokenIds.current() < 10, "Exceeds token supply");
    ...
    function withdraw(address payable recipient) public payable onlyOwner {
