    ...
    PausableUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        dateTime = IDateTime(0x947CC35992E6723DE50BF704828A01fD2D5d6641);
        ...
        PollenNFT = IPollenNft(0x542DDFdb580BDEC0be733Ed4A20fFe1666eBBB30); // atualizado
...
interface IDateTime {
   ...
   function getMonth(uint timestamp) external view returns (uint month);
