...
contract NftaniaAirdrop is Pausable, Ownable, ReentrancyGuard{
   ...
   //////////////////////// Claim Airdrop //////////////////////////////////// 
    function getAirdrop ( bytes32 msgh, uint8 v, bytes32 r, bytes32 s, uint256 amount, address to, uint8 signedNonce)
     public whenNotPaused() nonReentrant() returns (bool) { 
        getAvailableTokens();
        // Prequalify airdrop
        require(amount <= availableTokens, "No more Airdrop tokens are available");
