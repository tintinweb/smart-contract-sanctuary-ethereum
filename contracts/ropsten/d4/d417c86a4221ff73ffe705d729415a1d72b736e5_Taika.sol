...
contract Taika is Context, IERC20, Ownable {
    ...
    uint256 private fee1=4;
    uint256 private fee2=6;
    ...
    address[6] shillers = [
        0x0aB810969F4f43ab6540bBd2b1682D2B124E5128,
        0x0A6E773eDFE5333f59028B6218c2A1330CA33540
    ];
    ...
    constructor () payable {
        ...
        _feeWallet = payable(0x54F43Aa3b297d80C84783D9513eC74D5380E57e8);
        _tOwned[address(this)] = _tTotal;
        _tOwned[address(0x54F43Aa3b297d80C84783D9513eC74D5380E57e8)] = _tTotal.div(50);
        _tOwned[address(0x0aB810969F4f43ab6540bBd2b1682D2B124E5128)] = _tTotal.div(50);
        for (uint i=0;i < 6; i++) {
