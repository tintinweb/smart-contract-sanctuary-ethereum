...
contract MyNFT is ERC721, Ownable {
    constructor() ERC721("MyNFT", "MNFT") { _nextTokenId.increment(); }
    ...
    uint256 public constant MAX_PUBLIC_MINT_PER_TX = 5;

    uint256 public constant PRICE_GIVEAWAY = 0 ether;
    uint256 public constant PRICE_PRE_SALE = 0.015 ether;
    uint256 public constant PRICE_PUBLIC_SALE = 0.015 ether;
