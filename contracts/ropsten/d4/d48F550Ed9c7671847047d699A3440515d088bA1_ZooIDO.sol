...
contract ZooIDO is Ownable 
{
	...
	uint256 public firstPhaseDuration = 9 hours;//5 days;                                 // Duration of whitelist buy phase.
	uint256 public secondPhaseDuration = 6 hours;//3 days;                               // Duration of non whitelist buy phase.
	uint256 public thirdPhaseDuration = 6 hours;//17 days;                                // Duration of zoo tokens lock from start of ido.
	...
	function whitelistedBuy(uint256 amount) external
	{
		...
		amountAllowed[msg.sender] -= amount;                                    // Decreases amount of allowed dai to spend.
