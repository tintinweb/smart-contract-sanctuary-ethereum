...
contract NftaniaAirdrop is Pausable, Ownable, ReentrancyGuard{
   ...
   //////////////////////// Events ///////////////////////////////////////////
        ...
        // New Airdrop Status
            event NewAirdropStatus (uint256 totalAirdropedTokens,uint256 remainingTokens);
        // Withdraw
            event WithdrawTransfer( address indexed receivingWallet, uint amount, uint balance,uint256 indexed date);
        // Available Tokens
            event RemainingTokens (uint256 availableTokens);

   //////////////////////// Constructor //////////////////////////////////////            
    constructor(uint _startDate, uint _endDate,address _tokenAddress) {
   ...
   //////////////////////// Claim Airdrop //////////////////////////////////// 
    function getAirdrop ( bytes32 msgh, uint8 v, bytes32 r, bytes32 s, uint256 amount, address to, uint256 signedNonce)
     public whenNotPaused() nonReentrant() returns (bool) { 
        ...
        emit NewAirdropStatus (totalAirdropedTokens,remainingTokens);
        return true;        
    }
   ...
   //////////////////////// function get Available Tokens /////////////  
    function getRemainingTokens() public returns (uint256 _availableTokens){
        ...
        emit RemainingTokens (remainingTokens);
