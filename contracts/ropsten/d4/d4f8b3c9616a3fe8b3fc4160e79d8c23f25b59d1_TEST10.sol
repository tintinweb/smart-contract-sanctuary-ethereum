...
contract TEST10 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Token test 10";
    string private constant _symbol = "$TEST10";
    ...
    address payable private _marketingAddress = payable(0x5fac59aC082B2F5cFF811D99d14aCf6506339315);
