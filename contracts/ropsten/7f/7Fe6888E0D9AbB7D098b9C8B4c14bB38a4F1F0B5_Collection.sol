...
contract Collection is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,2,0,1655110800,1655112000);
        epochs[2] = EpochDetails(1,3,0,1655112600,1655113800); 
        epochs[3] = EpochDetails(3,7,0,1655114400,0); 
        epochs[4] = EpochDetails(1,2,0,1655112600,0); 
    }
