...
contract EtherJob is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function EtherJob() {
        ...
        name = "EtherJob";                         // Set the name for display purposes (CHANGE THIS)
        decimals = 4;                                      // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "JOB";                                   // Set the symbol for display purposes (CHANGE THIS)
