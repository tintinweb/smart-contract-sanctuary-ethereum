...
/**
 * vnd.eth (Ropsten.org network)
 * SmartContract: VND.ropsten.org
 * website : VND.ropsten.org
...
// fixed supply [email protected]

// ----------------------------------------------------------------------------

contract VND863 is ERC20Interface, Tokenlock, UserLock {
    ...
    constructor() public {
        ...
        name = "Virtual True NFT Certificates ";
