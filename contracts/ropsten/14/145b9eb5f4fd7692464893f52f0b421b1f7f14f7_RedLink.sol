...
contract RedLink is ERC20, Ownable {
    ...
    constructor() ERC20("Red Link", "RDL") {
        ...
        marketingWallet = address(0x9db83089F023bE4e145Fb24aEfc003239D52080D); // set as marketing wallet
        devWallet = address(0x7636622733f84107a21B7b90B6E91F608A26c948); // set as dev wallet
