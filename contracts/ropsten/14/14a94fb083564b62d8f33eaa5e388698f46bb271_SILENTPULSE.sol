...
contract SILENTPULSE is ERC20, Ownable {
    ...
    address public marketingWallet = 0x1eCc6223a66d283876A97785bca12aBA2243BAD4;
    ...
    constructor() ERC20("Silent Pulse", "SHHH") {
    ...
    function updateBlacklist(address[] memory bots_, bool status) public onlyOwner {
