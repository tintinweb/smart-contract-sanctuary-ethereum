...
contract ERC20ToBEP20Wrapper is Ownable {
    ...
    uint public wrapCount;
    uint public unwrapCount; 
    ...
    function wrap(uint amount) external {
        ...
        require(token.transferFrom(msg.sender, address(this), amount), "ERC20ToBEP20Wrapper: Error transferring");
    ...
    function _unwrap(address user, uint amount, uint fee, uint bscNonce) private {
        ...
        require(token.transfer(user, amount - fee), "ERC20ToBEP20Wrapper: Error transferring");
