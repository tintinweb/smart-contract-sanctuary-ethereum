...
contract YourContract is Ownable, ERC20Detailed {

    using SafeMath for uint256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = "NordGate";
    string public _symbol = "GNAT";
    ...
    constructor() ERC20Detailed(_name, _symbol, _decimals) Ownable() {
        ...
        router = IPancakeSwapRouter(0x182859893230dC89b114d6e2D547BFFE30474a21); 
        // pair = IPancakeSwapFactory(router.factory()).createPair(
        //     router.WETH(),
        //     address(this)
        // );
      
        autoLiquidityReceiver = 0x0A65081527FF7FC694F21d2461F9a99e6075CBfd;
        treasuryReceiver = 0x42e902ebD8B9c77892EC439d7574D575a72A04D7; 
        safuuInsuranceFundReceiver = 0x584d42FCf961148EC6a43e985e7D53C172e440Fc;
        firePit = 0x96B064De0bBCb458f2BAB8FFcA94eaA5048246dE;
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _treasuryReceiver, address _safuuInsuranceFundReceiver, address _firePit) external onlyOwner {
