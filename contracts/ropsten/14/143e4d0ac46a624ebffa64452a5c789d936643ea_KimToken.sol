...
contract Configurable {
    ...
    uint256 public constant preSaleFirstCap = 2.5*10**18;
    uint256 public constant preSaleSecondCap = 17.5*10**18; // 25,000,000 + 150,000,000
    uint256 public constant preSaleThirdCap = 32.5*10**18; // 25,000,000 + 150,000,000 + 150,000,000
    uint256 public constant preSaleFourthCap = 42.5*10**18; // 25,000,000 + 150,000,000 + 150,000,000 + 100,000,000
    uint256 public constant privateLimit = 20*10**18;
    uint256 public constant basePrice = 2777; // tokens per 1 ether
    uint256 public constant preSaleDiscountPrice = 11111; // pre sale 1 stage > 10 ETH or pre sale private discount 75% tokens per 1 ether
    uint256 public constant preSaleFirstPrice = 5555; // pre sale 1 stage < 10 ETH discount 50%, tokens per 1 ether
    uint256 public constant preSaleSecondPrice = 5555; // pre sale 2 stage discount 50%, tokens per 1 ether
    uint256 public constant preSaleThirdPrice = 4273; // pre sale 3 stage discount 35%, tokens per 1 ether
    uint256 public constant preSaleFourthPrice = 3472; // pre sale 4 stage discount 20%, tokens per 1 ether
    uint256 public constant privateDiscountPrice = 7936; // sale private discount 65%, tokens per 1 ether
    uint256 public privateSold = 0;
    
    uint256 public icoStartDate = 0;
    uint256 public constant timeToBeBurned = 1 years;
    uint256 public constant companyReserve = 100*10**18;
    uint256 public remainingTokens = 0;
    bool public icoFinalized = false;
    uint256 public icoEnd = 0; 
    uint256 public maxAmmount = 100 ether; // maximum investment allowed
    uint256 public minContribute = 0.1 ether; // Minimum investment allowed
    uint256 public constant preSaleStartDate = 1539155962; 
...
/**
 * @title KimToken 
 * @dev Contract to create the KimToken
 **/
contract KimToken is CrowdsaleToken {
    string public constant name = "KIMCoin";
