...
contract JackCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function JackCoin() {
        ...
        name = "JackCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "JACK";                                             // Set the symbol for display purposes (CHANGE THIS)
