...
contract ERC721NFTCustom is ERC721URIStorage, AccessControl {
    ...
    function tokenOfOwnerByIndex(address __owner, uint256 index) public view virtual returns (uint256) {
        require(index < balanceOf(__owner), "ERC721: owner index out of bounds");
