...
contract SumoShowPool is Ownable
{
    ...
    uint256 public constant BLACK_RESERVE_NUMBER = 4;
    ...
    function pendingPartnershipRewards(uint256 _partnershipId, address _user) public view returns (uint256 rewards) {
        uint256[] memory tokens = sumoShow.tokensOfOwner(_user);
    ...
    function pendingRoyaltiesRewards(uint256 _roundId, address _user) public view returns (uint256 rewards) {
        uint256[] memory tokens = sumoShow.tokensOfOwner(_user);
