...
contract FairBank is ERC721{
     ...
     */ 
    FairBankCompute constant private bankCompute = FairBankCompute(0x19425e748500aBcE454AF8b636482A6a2E2A1992);
        ...
        payable
    {
        ...
        cardList[5].playerAddress.transfer(_costAmount / 2);
        developerAddr.transfer(_costAmount / 2);
        
        if(_amount > _costAmount)
            msg.sender.transfer(_amount.sub(_costAmount));
        ...
        private
    {
        ...
        if(_recommendAddr != address(0) 
            ...
            _recommendAddr.transfer(_amount.mul(15) / 1000);
            msg.sender.transfer(_amount / 100);
        }
        else
        ...
        if(_protectRatio == 0)
            cardList[0].playerAddress.transfer(_amount.mul(5) / 1000);
        else if(_protectRatio > 0 && _protectRatio < 50)
            cardList[1].playerAddress.transfer(_amount.mul(5) / 1000);   
        else if(_protectRatio == 50)
            cardList[2].playerAddress.transfer(_amount.mul(5) / 1000);   
        else if(_protectRatio > 50 && _protectRatio < 95)
            cardList[3].playerAddress.transfer(_amount.mul(5) / 1000);   
        else if(_protectRatio == 95)
            cardList[4].playerAddress.transfer(_amount.mul(5) / 1000);   
        
        developerAddr.transfer(_amount.mul(5) / 1000);
    }
