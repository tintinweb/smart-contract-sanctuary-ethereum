...
contract BurnToken is ERC20Burnable, Ownable {
    ...
    uint256 maxWalletSize = (_initial_supply * 15) / 10000; // .15% of totalsupply
    uint256 maxTransactionSize = (_initial_supply * 15) / 100000; // .015% of totalsupply
    uint256 swapThreshold = (_initial_supply * 30) / 10000; // .3% of totalsupply
