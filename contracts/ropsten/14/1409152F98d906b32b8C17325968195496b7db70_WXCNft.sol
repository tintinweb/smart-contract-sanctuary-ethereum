...
abstract contract Factory {
    ...
    function _add(Segment segment, address account) internal {
        require(account != address(0), "address is not allowed");
    ...
    {
        require(account != address(0), "address is not allowed");
        return _segmentOptions[segment]._beneficiary[account];
    }
}
...
contract Whitelist is Factory, Ownable, ContextMixin {
    ...
    uint256 public constant TEAM_PRICE = 0.01 ether;
    ...
    constructor() {
        ...
        _segmentOptions[Segment.PUBLIC]._maxMint = 10;
    }
    ...
    Whitelist
{
    ...
    ) ERC721("Wicked X Club", "WXC") Whitelist() {
