...
contract Ogreville is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.0097 ether;
  uint public          maxPerTx          = 10;
  uint public          maxWallet         = 10;
  uint public          totalFree         = 5;
  uint public          maxSupply         = 10000;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("OgreVille", "OgreVille"){
  }
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(balanceOf(msg.sender) + 1 <= walletMax);
    require(msg.value == amt * cost,"Please send the exact amount");
    require(amt < maxTx + 1, "Max per TX reached");
    require(totalSupply() + amt < maxSupply + 1,"No more Ogres!");
...
//   function setMaxWallet(uint256 maxPerTx_) external onlyOwner {
