...
contract MyToken is ERC1155, Ownable {
    ...
    // .005 / .0125 / .0225
    uint256[] public mintRate = [5000000000000000, 12500000000000000, 22500000000000000];

    uint256[] public minted = [0,0,0];
    uint256[] public supplies = [10, 5, 2];

    string public name = "Mint Pass";
    ...
    function mint(uint256 id) payable public
    {
        ...
        require(msg.value >= mintRate[id], "Not enough ether sent");
        require(minted[id] + 1 <= supplies[id], "not enough supply left");
