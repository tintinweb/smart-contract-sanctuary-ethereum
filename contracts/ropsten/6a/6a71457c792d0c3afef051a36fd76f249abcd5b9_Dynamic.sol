...
contract Dynamic is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dynamic";
    string private constant _symbol = unicode"DYNAMIC";
    ...
    uint256 private _maxBuyAmount = 5000000 * 10**9;
    uint256 private _maxSellAmount = 1000000 * 10**9;
    ...
    uint256 private _moderateBuyFee = 25; // 7.5% fee
    uint256 private _highBuyFee = 50; // 5% fee
    uint256 private _extremeBuyFee = 75; // 2.5% fee

    uint256 private _moderateSellImpact = 1;
    uint256 private _highSellImpact = 3;
    uint256 private _extremeSellImpact = 5;

    uint256 private _moderateSellFee = 50; // 15% fee
    uint256 private _highSellFee = 100; // 20% fee
    uint256 private _extremeSellFee = 150; // 25% fee
    ...
    bool private _getFeeOnBuy = false;
    bool private _getFeeOnSell = false;

    bool private _cooldownEnabled = false;
    uint private _cooldownTimerInterval = 120; // 2 minutes cooldown    
    ...
    function updateDdynamicBuy(uint256 moderateBuyImpact, uint256 highBuyImpact, uint256 extremeBuyImpact) public onlyOwner {
    ...
    function updateDdynamicSell(uint256 moderateSellImpact, uint256 highSellImpact, uint256 extremeSellImpact) public onlyOwner {
