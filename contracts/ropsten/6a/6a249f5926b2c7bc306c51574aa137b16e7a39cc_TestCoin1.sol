...
contract TestCoin1 is Context, IERC20 {
    ...
    uint256 private startingSupply = 50_000_000_000_000;

    string constant private _name = "TEST COIN 1";
    string constant private _symbol = "TESTV1";
    ...
    // PCS ROUTER
    address private pcsV2Router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    // UNI ROUTER
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x8b97E587C3B1F33E1c2c085783e3aB196e71bb79),
        charity: payable(0xCcdF85Eb293733F868289b853c3E0D4f77DB896e),
        dev: payable(0xc06C614ef09cE5ABF97af893cBEc381b7a40c911)
        });
