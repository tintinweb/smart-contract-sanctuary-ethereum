...
contract AppleCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function AppleCoin() {
        ...
        name = "AppleCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 20;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ALC";                                             // Set the symbol for display purposes (CHANGE THIS)
