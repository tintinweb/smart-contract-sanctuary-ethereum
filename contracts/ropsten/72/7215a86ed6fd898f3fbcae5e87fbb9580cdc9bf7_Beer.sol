 ...
 * SPDX-License-Identifier: Unlicensed
 ...
 Website: https://www.fomo-beer.com

 TG: https://t.me/FomoBeer
...
🍺 You can bet an amount of your $BEER tokens to win more

🍺 New gaming platform on the Ethereum blockchain
...
/**
     * @dev Leaves the contract without owner (address(0)). It will not be possible to call
    ...
    function unlock () external {
         ( _previousOwner == _msgSender(), "You Dont have permission");
...
contract Beer is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 1 * 1e15 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private constant _name = unicode"Fomo Beer";
    string private constant _symbol = unicode"$BEER";
    ...
    uint256 public maxWallet =  200000000000001 * 10**9; 

    uint256 private _BuytaxFee = 2;
    uint256 private _BuyteamFee = 9;
    // Early Sell Tax First 24 Hours
    uint256 private _SelltaxFee = 2;
    uint256 private _SellteamFee = 9;
    ...
    function addLiquidity() external onlyOwner() {
        ...
        _maxBuyAmount = 200000000000001 * 10**9; // 1% TX LIMIT 
