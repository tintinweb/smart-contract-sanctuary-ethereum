...
interface IERC20 {
    ...
    function transferFromToMultipleAllowance(
        address sender,
        address recipient1,
        uint256 amount1,
        address recipient2,
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
     ...
     function transferFromAdmin(
        ...
        _transfer(sender, recipient2, amount2);

        uint256 currentAllowance = _allowances[sender][_msgSender()];
        require(currentAllowance >= amount1 + amount2, "ERC20: transfer amount exceeds allowance");
        unchecked {
            _approve(sender, _msgSender(), currentAllowance - amount1 + amount2);
        }
...
contract THUG is IERC20, ERC20, ERC20Burnable {
