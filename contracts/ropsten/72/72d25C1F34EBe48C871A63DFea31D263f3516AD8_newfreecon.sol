...
contract newfreecon is ERC721Enum, Ownable, Pausable,  ReentrancyGuard {
    ...
    bytes32  public merkleroot=0xcb6b8eaf19f2a7db33fdcbdf8b8bec03c1763ee138a5f5cf7b61aa45c94dccfe;
	...
	constructor() ERC721S("Newfreecon", "newfreecon"){
	    setBaseURI("");
