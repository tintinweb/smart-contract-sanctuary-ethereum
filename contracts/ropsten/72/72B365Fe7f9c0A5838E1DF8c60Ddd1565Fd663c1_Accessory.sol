 ...
 */
contract Accessory is BaseImxNFT {
    /// @dev Initialize Accessory proxy
    function postConstruct(address _imxStarkContract) external initializer {
        // initialize Base IMX NFT
        super._postConstruct("Illuvitar Accessory", "ACCESSORY", _imxStarkContract);
    }
}
