...
contract NoseStaking {
    ...
    constructor() {
        ...
        ctctmcoin = Coin("CTCTM token", "CTC(TM)", false, "Binance", 0x8759f4F91B3346Db4694fdDb9Ce6D65fAC0B7727, 0, 0, "USA", 5, 10000);
	    ctc7coin = Coin("CTC7 token", "CTC7", false, "Binance", 0x47b673E7ad791e5d8C41d94d4c786cdbD4A8838B, 0, 0, "USA", 5, 10000);
