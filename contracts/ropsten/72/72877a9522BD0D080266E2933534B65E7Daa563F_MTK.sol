    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        uint256 supply,
        uint256 minPoolPercent,
        uint256 maxPoolPercent,
        address owner
    ) public initializer {
        ...
        onlyRole(MINTER_ROLE)
    {
        ...
        require(!fullySold(), "Token: Token fully sold");
        require(couldReceiveContribution(amount), "Token: tokens reserved for pool");
        _mint(to, amount);
    }
