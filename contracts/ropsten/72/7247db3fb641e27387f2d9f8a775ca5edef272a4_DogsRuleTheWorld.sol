...
contract DogsRuleTheWorld is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmasSaVgzynd3fmcgrVEwnacB2m3qCrzvWg8KnravZbP2x";
    ...
    uint256 public constant PUBLIC_SALE_PRICE = 0.0066 ether;
    ...
    constructor(
    ) ERC721A("DogsRuleTheWorld", "DogsRuleTheWorld", 100, maxSupply) {
    }
