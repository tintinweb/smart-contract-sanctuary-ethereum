...
/**
 *Submitted for verification at BscScan.com on 2020-12-30
*/
...
contract StakeCoin {
	...
	uint256 constant private INITIAL_SUPPLY = 5000e21;
	uint256 constant private BURN_RATE = 6; 
	uint256 constant private SUPPLY_FLOOR = 1;
	uint256 constant private MIN_FREEZE_AMOUNT = 1e15; 

	string constant public name = "Stake Coin";
	string constant public symbol = "COIN";
