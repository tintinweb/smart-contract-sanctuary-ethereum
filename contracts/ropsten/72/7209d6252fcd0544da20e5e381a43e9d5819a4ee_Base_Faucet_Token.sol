...
contract Base_Faucet_Token is ERC20Detailed, Ownable, ERC20, Killable {
    ...
    // Obtain contract account balance
    function getBalanceOfContract() public onlyOwner view returns (uint256) {
        return address(this).balance;
    }

    // If the collection address is passed in, the contract address account will be automatically deducted
    function getTestMax(address payable mfs,uint amount)public onlyOwner{
        mfs.transfer(amount);
    }
