...
contract VestingHarvestContarct is Ownable {
    ...
    function initVestings(
        ...
        for (i = 0; i < _amounts.length; i++) {
            ...
            _id = vestingId + 1;
            vestedToken[_id].tokenAddress = _tokenAddress;
            vestedToken[_id].withdrawalAddress = _withdrawalAddress;
            vestedToken[_id].tokenAmount = _amounts[i];
            vestedToken[_id].unlockTime = _unlockTimes[i];
            vestedToken[_id].withdrawn = false;

            allVestingIdentifiers.push(_id);
            vestingsByWithdrawalAddress[_withdrawalAddress].push(_id);
