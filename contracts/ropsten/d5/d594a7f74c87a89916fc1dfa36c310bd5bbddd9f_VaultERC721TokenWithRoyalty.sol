...
interface IVaultERC721Token is IERC721Enumerable {
    ...
    function isNftToken(address tokenAddress) external view returns(bool);
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    /**
     * @dev See {IERC721Enumerable-totalTokens}.
     */
    function totalTokens() public view virtual returns (uint256[] memory) {
        return _allTokens;
    }
...
contract VaultERC721Token is IVaultERC721Token, ERC721Enumerable, Whitelist {
  ...
  bytes4 constant _INTERFACE_ID_VAULTERC721 = 0x780e9d63;
  ...
  /**
    ...
    */
  function tokenURI(uint256 tokenId) override(IVaultERC721Token, ERC721) virtual public view returns (string memory) {
  ...
  function supportsInterface(bytes4 interfaceId) public view override(IERC165, ERC721Enumerable) returns (bool) {
      return interfaceId == _INTERFACE_ID_VAULTERC721 ||
        interfaceId == type(IVaultERC721Token).interfaceId || super.supportsInterface(interfaceId);
  }  


  function isNftToken(address tokenAddress) public view override(IVaultERC721Token)returns(bool) {
      ...
      bool result = false;
      string memory name = VaultERC721Token(tokenAddress).name();
      string memory symbol = VaultERC721Token(tokenAddress).symbol();   
      ...
      result = (keccak256(abi.encodePacked(name)) == keccak256(abi.encodePacked(_NFT_NAME))) 
            ...
            && (supportsInterface(type(IVaultERC721Token).interfaceId) );
  ...
  function isApprovedOrOwner(address spender, uint256 tokenId) external view 
    override returns (bool) {
...
interface IVaultERC721TokenWithRoyalty is IVaultERC721Token,IERC2981 {
    
}
/**
 * @title VaultERC721TokenWithRoyalty
 * 
 */
contract VaultERC721TokenWithRoyalty is IVaultERC721TokenWithRoyalty,VaultERC721Token{
    ...
    * @return string of TokenURI
    */
    function tokenURI(uint256 tokenId) override(IVaultERC721Token,VaultERC721Token) public view returns (string memory) {
