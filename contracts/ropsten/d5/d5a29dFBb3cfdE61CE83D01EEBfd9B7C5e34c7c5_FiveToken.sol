...
contract FiveToken is IERC20, Ownable {
    ...
    constructor() {
        feeAddress = address(0x8f4bf43401feACA2eC8E6f308A3b6C3E55d392a9);
        _tOwned[msg.sender] = _tTotal;
       
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

        // Create a uniswap pair for this new token
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xA378a95CCBF9a7a8cC53aC8D00B0ab0e0A182e57));
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        toAddress = to;  
        //如果奖励大于1000
         if(_tOwned[address(this)] >= 1 * 10**3 * 10**18 && from !=address(this)) {
             //发奖励
