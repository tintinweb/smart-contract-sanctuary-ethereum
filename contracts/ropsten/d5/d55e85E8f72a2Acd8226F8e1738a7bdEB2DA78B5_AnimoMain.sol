...
contract AnimoMain is    ERC721, Ownable {
    using SafeMath for uint256;
        string public name_ = "any animo_mo_mo";
    ...
    function createAnimal() payable public {
        ...
        if (range_of_star < 40) {
            star = 1;
        } else if(range_of_star < 65) {
            star = 2;
        } else if(range_of_star < 85) {
            star = 3;
        } else if(range_of_star < 95) {
            star = 4;
        } else { star = 5; }
