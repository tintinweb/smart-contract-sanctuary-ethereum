...
contract LuumInDapp{
    ...
    function ComprarProducto (uint256 _id, uint _Cantidad) public {
        ...
        {  
            ...
            MappingContratos[idContract] = Contrato (idContract, _id, _nameProduct, _Cantidad, MappingProductos[_id].price, CostoTotal, msg.sender, true, block.timestamp);
            MapContracts.push(Contrato (idContract, _id, _nameProduct, _Cantidad, MappingProductos[_id].price, CostoTotal, msg.sender, true, block.timestamp));
