...
contract Daric is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Daric() {
        ...
        name = "Daric";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-062";                                             // Set the symbol for display purposes (CHANGE THIS)
