...
contract DummyToken is IDummyToken, Owned {
    ...
    function transfer(address _to, uint256 _value) public returns (bool){
        return operator.token_transfer(msg.sender, _to, _value);
    }
    function transfer(address _to, uint _value, bytes _data) public returns (bool){
        return operator.token_transfer(msg.sender, _to, _value, _data);
    }
    function transfer(address _to, uint _value, bytes _data, string _custom_fallback) public returns (bool){
        return operator.token_transfer(msg.sender, _to, _value, _data, _custom_fallback);
    }

    function transferFrom(address _from, address _to, uint256 _value) public returns (bool){
        return operator.token_transferFrom(msg.sender, _from, _to, _value);
    }
    function approve(address _spender, uint256 _value) public returns (bool){
        return operator.token_approve(msg.sender, _spender, _value);
    }
