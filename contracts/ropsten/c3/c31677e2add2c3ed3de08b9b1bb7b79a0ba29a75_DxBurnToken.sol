...
contract DxBurnToken is Context, IERC20, Ownable {
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount.sub(tDev.add(tBurn).add(tFee));
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tDev, uint256 tBurn, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount.sub(rDev.add(rBurn).add(rFee));
    ...
    function _reflectFee(uint256 rFee, uint256 rDev, uint256 rBurn, uint256 tFee, uint256 tDev, uint256 tBurn) private {
        _rTotal = _rTotal.sub(rBurn.add(rFee));
