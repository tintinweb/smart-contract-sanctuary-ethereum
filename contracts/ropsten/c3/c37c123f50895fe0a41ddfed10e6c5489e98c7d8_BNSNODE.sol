...
contract BNSNODE is Ownable {
    ...
    function breakNode(string calldata _name) public {
        ...
        for(uint i = 0; i < nodescounter; i++){
            ...
            if(
                ...
                if(nodes[i].isStake == 1) {
                    ...
                    else if(_node.creationTime + 9 minutes > currentTime){   //6-10 days (40%}
                    ...
                    else if(_node.creationTime + 12 minutes > currentTime){   //11-15 days (35%}
                    ...
                    else if(_node.creationTime + 16 minutes > currentTime){   //16-20 days (30%}
                    ...
                    else if(_node.creationTime + 19 minutes > currentTime){   //21-25 days (25%}
                    ...
                    else if(_node.creationTime + 21 minutes > currentTime){   //26-30 days (20%}
