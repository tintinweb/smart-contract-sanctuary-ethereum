...
contract DragonBallZ is ERC1155, Ownable { 
    uint256[] public supplies = [50,50,50];
    uint256[] public minted = [0,0,0];
    mapping(uint256 => mapping(address => bool)) public member;

    constructor() ERC1155("ipfs://QmWhw3UxchVgeyeJvPyc5PFwGZmf9z9c5Ctmqr3NhSTNdq/{id}.json")
        {
        }
    ...
    // to Put NFT to Opensea
     function uri(uint256 _tokenId) override public view returns (string memory) {
        ...
        return string(
        abi.encodePacked(
            "ipfs://QmTPNJbpqUkcmUSPikdsw6oyKKKSmoCFi3L6dyyspZGGKF/",
