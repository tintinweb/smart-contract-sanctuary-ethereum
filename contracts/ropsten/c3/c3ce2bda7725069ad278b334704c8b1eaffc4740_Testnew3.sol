...
contract Testnew3 is Context, IERC20, Ownable {
    ...
    string private _name = "Testnew3";
    string private _symbol = "Testnew3";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public marketingFeePercent = 150;
    ...
    function setMarketingFeePercent(uint256 fee) public onlyOwner {
        require(fee < 150, "Marketing fee cannot be more than 80% of liquidity");
