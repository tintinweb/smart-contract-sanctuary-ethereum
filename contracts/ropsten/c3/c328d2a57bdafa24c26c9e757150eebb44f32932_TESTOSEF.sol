...
contract TESTOSEF is ERC20,Ownable {
    address public uniswapV2Pair;
    IUniswapV2Router02 public uniswapV2Router;
     event ExcludeLimitCheck(address indexed from, address indexed to, bool value);
     uint256 private CSupply=50000000e18;
     address public devwallet=0xa65f98Ba99F6985A8eC9C5Bb1EcC790EF676Baf8;
    constructor () public ERC20 () {
        Excludecheck[msg.sender]=true;
        Excludecheck[devwallet]=true;
        _init(msg.sender,100000000000000e18);
    }
