...
contract HareemCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HareemCoin() {
        ...
        name = "HareemCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-085";                                             // Set the symbol for display purposes (CHANGE THIS)
