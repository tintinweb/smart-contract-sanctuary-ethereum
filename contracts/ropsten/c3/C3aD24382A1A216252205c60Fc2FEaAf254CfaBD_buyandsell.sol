...
contract buyandsell {
  ...
  function buyTokens(uint256 amount) public payable returns (uint256 tokenAmount) {
  ...
  function sellTokens(uint256 amount,uint256 ethamount) public  {
    require(amount>0,"insufficient amount");
  ...
  function tokenbal() public view returns(uint) {
    return yourToken.balanceOf(address(this));
  }

  function withdrawToken() public {
    uint256 withdrawBal = yourToken.balanceOf(address(this));
    yourToken.transfer(own, withdrawBal);
