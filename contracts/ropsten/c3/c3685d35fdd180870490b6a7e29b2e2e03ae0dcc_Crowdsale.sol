...
contract Crowdsale is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Main Variables /////////////////////////////////// 
        ...
        address payable private AddLiquidity;                  // Add Liquidity Contract (add liquidity to uniswap exchange)
   ...
   //////////////////////// intializeAddresses //////////////////////////////////////     
    function intilizeAddresses(
        ...
        require(_AddLiquidity != address(0),"NftaniaCrowdsale: Nftania Add Liquidity contract is the zero address");
   ...
   //////////////////// Add Liquidity /////////////  
    ...
    returns (uint amountToken, uint amountETH,uint amountliquidityTokens, uint _totalLiquidityTokens, address pairAddress){
        ...
        IERC20(tokenAddress).safeApprove(AddLiquidity, tokenAmount);  
        (amountToken, amountETH, amountliquidityTokens, totalLiquidityTokens, pairAddress) = 
        IAddLiquidity(AddLiquidity).addLiquidityETH {value:EthAmount} (tokenAddress, tokenAmount, EthAmount, LiquidityPoolLocker);
