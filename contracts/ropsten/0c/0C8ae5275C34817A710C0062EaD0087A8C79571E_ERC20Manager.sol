...
contract ERC20Manager is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    *
    * 外部函数：
    *     1. getTokenAddress view - 获取该 ERC20Manager 合约管理的 Token 地址
    *     2. getTotalApprover view - 获取所有已授权的用户列表
    *     3. setApprover - 设置授权用户地址
    *     4. withdrawFrom
    *     5. withdrawFromTo
    *     6. withdraw
    *     7. withdrawTo
