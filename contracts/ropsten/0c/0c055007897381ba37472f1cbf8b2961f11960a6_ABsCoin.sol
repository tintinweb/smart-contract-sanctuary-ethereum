...
contract ABsCoin is StandardToken {
    ...
    function ABsCoin (address tokenOwner, uint _endDate) public{
...
contract SalesManager is Ownable {
     ...
     *
        ...
        Token exchange rate: 1 ETH = 2400 ABsCoin
    ...
    **/
    ...
    address public tokenAddress = 0xf73CE90de6880307218581Af4D418Bd536b96A8D;

    address public tokenOwner = 0xf73CE90de6880307218581Af4D418Bd536b96A8D;
    ...
    function SalesManager () public{
        tokenAddress = new ABsCoin(tokenOwner, endDate);
    }
    ...
    function sendTokens(uint _amount, uint _ethers) internal {
        ABsCoin tokenHolder = ABsCoin(tokenAddress);
