...
contract MyToken is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public maxNftPerTransaction;
    uint256 public nftPerWallet;
    ...
    function setMaxNftPerTransaction(uint256 quantity) public onlyOwner {
        maxNftPerTransaction = quantity;
    }

    function setNftPerWallet(uint256 quantity) public onlyOwner {
        nftPerWallet = quantity;
    }
    ...
    function adminMint(address to,uint256 supply) public onlyOwner {
        ...
        require(maxNftPerTransaction >= supply, "supply is invalid");
        require((balanceOf(to) + (supply)) <= nftPerWallet, "Nft per wallet is exceed");
