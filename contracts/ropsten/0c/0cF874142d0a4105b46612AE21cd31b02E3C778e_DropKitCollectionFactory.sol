...
contract DropKitCollectionFactory {
  address immutable collectionImplementation;

  constructor() {
    collectionImplementation = address(new DropKitCollection());
  }

  function cloneCollection(string calldata name_, string calldata symbol_, address treasury_) external returns (address) {
