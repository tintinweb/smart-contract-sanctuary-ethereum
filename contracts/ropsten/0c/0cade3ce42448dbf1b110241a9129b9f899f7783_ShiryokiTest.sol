...
// File: contracts\ShiyokiTest.sol

contract ShiryokiTest is IERC20, Ownable {
    ...
    string private constant _name = "ShiryokiTest";
    string private constant _symbol = "ShiryokiTest";
