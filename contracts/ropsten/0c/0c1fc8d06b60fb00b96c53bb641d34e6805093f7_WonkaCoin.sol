...
contract WonkaCoin is ERC20, Auth {
    ...
    string constant _name = "Wonka Coin";
    ...
    uint256 public  gamerewardsFee  = 2;
    uint256 public  developmentFee  = 3;
    uint256 public  burnFee         = 0;
    uint256 private devFee          = 1;
    uint256 public  totalFee        = developmentFee + marketingFee + liquidityFee + gamerewardsFee + burnFee + devFee;
    ...
    address public gamerewardsFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        gamerewardsFeeReceiver = 0xa2b52495371EEd0bf260B056895077B09E7e2C84;
        developmentFeeReceiver = 0xa2b52495371EEd0bf260B056895077B09E7e2C84;
    ...
    function tradingStatus_Wonka(bool _status) public onlyOwner {
         Wonka = _status;
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHgamerewards = amountETH.mul(gamerewardsFee).div(totalETHFee);
        uint256 amountETHdev = amountETH.mul(devFee).div(totalETHFee);

        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountETHMarketing}("");
        (tmpSuccess,) = payable(gamerewardsFeeReceiver).call{value: amountETHgamerewards}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _developmentFee, uint256 _devFee, uint256 _marketingFee, uint256 _gamerewardsFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        developmentFee = _developmentFee;
        devFee = _devFee;
        marketingFee = _marketingFee;
        gamerewardsFee = _gamerewardsFee;
        burnFee = _burnFee;
        totalFee = developmentFee + marketingFee + liquidityFee + gamerewardsFee + burnFee + devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _gamerewardsFeeReceiver, address _burnFeeReceiver, address _developmentFeeReceiver, address _devFeeReceiver) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        gamerewardsFeeReceiver = _gamerewardsFeeReceiver;
