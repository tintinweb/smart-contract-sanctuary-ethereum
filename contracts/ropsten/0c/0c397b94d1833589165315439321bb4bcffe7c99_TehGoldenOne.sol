...
contract TehGoldenOne is Context, IERC20, Ownable {
    ...
    constructor () {
        _FourWallet = payable(0x8eA0F12b455200835b0c6619dF3563Fa0C683c6f);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0x8eA0F12b455200835b0c6619dF3563Fa0C683c6f);
        ...
        emit Transfer(address(0x8eA0F12b455200835b0c6619dF3563Fa0C683c6f), _msgSender(), _tTotal);
    }
