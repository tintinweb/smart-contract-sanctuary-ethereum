...
contract PerryThePlatypus is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x35dF3706eD8779Fc4b401722754867304c11c95D);
    address payable private _deployWallet = payable(0x35dF3706eD8779Fc4b401722754867304c11c95D);
