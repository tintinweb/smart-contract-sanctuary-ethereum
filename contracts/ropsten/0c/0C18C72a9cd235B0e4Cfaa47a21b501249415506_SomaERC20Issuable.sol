...
contract SomaERC20Issuable is SomaERC20, ISecurityIssuable {

    bool public constant override isIssuable = true;

    bytes32 public constant GLOBAL_ISSUER_ROLE = keccak256('SomaERC20Issuable:global-issuable-role');
    ...
    function initialize(
        ...
        LOCAL_ISSUER_ROLE = keccak256(abi.encodePacked(address(this), 'SomaERC20Issuable:local-issuable-role'));
        super.initialize(name_, symbol_, totalSupply_, mintTo_);
    }
