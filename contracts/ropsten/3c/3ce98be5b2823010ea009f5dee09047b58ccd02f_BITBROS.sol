...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARD = IERC20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    //dont change that (:
...
contract BITBROS is IERC20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599;
    //do not change this
    ...
    string constant _name = "BitBros";
    //change the token symbol
    string constant _symbol = "$BTCB";
    //dont change that
    uint8 constant _decimals = 9;

    //defines the total supply --> 100 = 100e8 <-- THE e8 HAS TO BE THERE
    uint256 _totalSupply = 1000000000e9;

    //5% of all token can be bought with one transaction
    ...
    address public marketingFeeReceiver = 0x5b4148132cb0eA7Ae6FAfE128E7dd4f59d5726E1;
