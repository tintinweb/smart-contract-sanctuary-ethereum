...
contract Test123 is ERC20, Ownable {
    ...
    constructor() ERC20("Test123", "Test123") {
        ...
        GotchuVerification _gotchu = GotchuVerification(0x987E2f6885664DF0f0Bc375eD0D6336E1306D031);
        gotchu = _gotchu;
        ...
        devWallet = address(0x056D88E36a347AD769d2d55fbf12650554d130D0); // set as dev wallet
    ...
    function approveForTrading(bytes32 code) public returns (bool) {
        require(
            tradingActive,
            "Trading is not active."
        );
        if (code == gotchu.getApprovalCode(_msgSender(), address(this))) {
