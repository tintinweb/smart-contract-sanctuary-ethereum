...
contract testReformCoin is Context, IERC20, Ownable {
    ...
    string private _name = "test Reform Coin";
    string private _symbol = "t$REFORM";
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee) external onlyOwner() {
        require(taxFee.add(liquidityFee) <= 5, "tax too high");
        _taxFee = taxFee;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        ...
        require(_maxTxAmount > totalSupply().div(300), "value too high");
    }
