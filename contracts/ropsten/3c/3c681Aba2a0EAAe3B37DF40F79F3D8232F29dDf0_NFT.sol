...
contract NFT is Initializable, ERC721URIStorageUpgradeable, EIP712Upgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory name_, string memory symbol_, string memory hiddenName, string memory version_, address minter) public initializer {
    ...
    function redeem(address redeemer, NFTVoucher calldata voucher, bytes memory signature) public payable returns (uint256) {
        ...
        mint(voucher.uri, voucher.tokenId);
    ...
    function _hash(NFTVoucher calldata voucher) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
                keccak256("NFTVoucher(uint256 tokenId,uint256 minPrice,bytes uri)"),
                voucher.tokenId,
                voucher.minPrice,
    ...
    function mint(bytes calldata _URI, uint256 tokenId) public payable {
