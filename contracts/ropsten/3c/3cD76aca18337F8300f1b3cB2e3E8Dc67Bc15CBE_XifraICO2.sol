...
contract XifraICO2 {
    ...
    address private xifraWallet;                      // Xifra wallet
    address private xifraToken;                       // Xifra token address
    address private usdtToken;                        // USDT token address
    address private usdcToken;                        // USDC token address
    uint256 private minTokensBuyAllowed;              // Minimum tokens allowed
    uint256 private maxICOTokens;                     // Max ICO tokens to sell
    ...
    function changeParameters(address _wallet, address _token, address _usdtToken, address _usdcToken, uint256 _minTokensBuyAllowed, uint256 _maxICOTokens, uint256 _icoStartDate, uint256 _icoEndDate) external {
        xifraWallet = _wallet;
        xifraToken = _token;
        usdtToken = _usdtToken;
        usdcToken = _usdcToken;
