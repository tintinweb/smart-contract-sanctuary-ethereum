...
contract Token is Ownable, ERC20, ERC20Detailed("The DOI Coin", "DOIC", 9) {
  ...
  constructor() public {
    ...
    uint256 treasuryAmount = 19340000000 * 10 ** 9;
    uint256 founderAmount = 220000000 * 10 ** 9; // 220000000 * 3 = 660000000

    _mint(treasuryWallet, treasuryAmount);
    _mint(founder1, founderAmount);
    _mint(founder2, founderAmount);
    _mint(founder3, founderAmount);
