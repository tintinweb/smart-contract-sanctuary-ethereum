...
contract chronicMarketplace is ReentrancyGuard {
    ...
    uint256 listingPrice = 2; /* Precentage of the Listing Price */
    ...
    function createMarketItem(
        ...
        uint256 price
            ...
            require(msg.value >= (price.mul(listingPrice).div(100)), "Price must be equal to 2% of listing price");
    ...
    function createMarketSale(
        ...
        uint256 itemId
            ...
            payable(owner).transfer(price.mul(listingPrice).div(100)); 
