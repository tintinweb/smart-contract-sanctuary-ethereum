...
contract PlatformToken is ERC20, Ownable {
    ...
    // bool public useProjectFee;
    // bool public useLiquidityFee;
    // bool public enableDividends;
    ...
    // function setSwapEnablers(bool _useProjectFee, bool _useLiquidityFee, bool _enableDividends) external onlyOwner {
    //     useProjectFee = _useProjectFee;
    //     useLiquidityFee = _useLiquidityFee;
    //     enableDividends = _enableDividends;
    // }
    ...
    function swapAndDistribute(uint256 tokens) private {
        ...
        uint256 ethForProject = (postBalance.mul(projectFee).div(totalFees)).div(2);
