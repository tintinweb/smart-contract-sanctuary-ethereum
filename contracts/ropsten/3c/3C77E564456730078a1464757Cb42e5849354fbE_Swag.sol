...
contract Swag is ERC20, Ownable {
    ...
    constructor() ERC20("Knucklez", "Knucklez") payable {
        ...
        maxSellTransactionAmount = totalSupply * 2 / 100; // max sell 2% of supply
        ...
        */
        ...
        _createInitialSupply(0xBfa6fE3999cA2b0197BA13aC0003e0E872AD1E87, totalSupply*20/100);
    ...
    function excludeFromMaxTransaction(address updAds, bool isEx) public onlyOwner {
  	...
  	function updateMaxSellTransaction(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 1000)/1e18, "Cannot set maxTxnAmount lower than 0.1%");
