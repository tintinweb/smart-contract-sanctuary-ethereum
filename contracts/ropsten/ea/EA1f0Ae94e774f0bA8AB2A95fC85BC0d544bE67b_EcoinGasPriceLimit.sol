...
import './Owned.sol';
import './Utils.sol';
import './interfaces/IEcoinGasPriceLimit.sol';

/*
    The EcoinGasPriceLimit contract serves as an extra front-running attack mitigation mechanism.
...
*/
contract EcoinGasPriceLimit is IEcoinGasPriceLimit, Owned, Utils {
    ...
    */
    function EcoinGasPriceLimit(uint256 _gasPrice)
