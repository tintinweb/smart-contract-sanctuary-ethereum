 ...
 * */
 ...
 contract pipo is Context, IERC20, Ownable {
     ...
     string private constant _name = "pipo Token";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x805Dcd1c3D996429F4f69c51515D59F2f99717e0);
         _feeAddrWallet2 = payable(0x805Dcd1c3D996429F4f69c51515D59F2f99717e0);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x805Dcd1c3D996429F4f69c51515D59F2f99717e0), _msgSender(), _tTotal);
     }
