...
/*
    ...
    RHODES OF COLOSSUS - $RHODES

    Web: https://www.rhodestoken.com/

    TG: https://t.me/RhodesToken

    A statue of the Greek sun-god Helios, erected in the city of Rhodes.
    Transacting $RHODES will contribute to the protocol by filling the DAO treasury slowly, to fund investments into our decentralised dapps.
...
contract RHODES is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 777777777777 * 10 ** 9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Rhodes of Colossus";
    string private _symbol = "RHODES";
    ...
    uint256 public _maxBuyAmount = 14000000000 * 10**9;
    uint256 public _maxWalletAmount = 14000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 2000000000 * 10**9;
    uint public ethSellAmount = 1000000000000000000;  //1 ETH
    address public marketingWallet = 0x0F304d662552DD3E5872DD996995717c8A7716D8;
    address public devWallet = 0xB44e3205c8931930A810ccaf6FCe8dc0dd331202;
