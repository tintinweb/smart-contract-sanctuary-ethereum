...
// Smart Contract Code Developed BY: IMEC MASTER
...
// LaunchPad Link: https://safutrendzpad.com
...
contract SaFuTrendz is Context, IERC20, Ownable {
    ...
    address public _liquidityFeeAddress = 0xc17001C454e800d305b7FF09C7121014EFdFd507;
    address public _marketingFeeAddress = 0x3da180722334C05608118262E827d36C0E4B2155;
    ...
    uint256 private _swapFeeEnableLimitPercentageRate = 200;
    ...
    function sendAirdrop(address[] memory to, uint256 amount) public onlyOwner returns (bool) {
        ...
        for (uint i = 0; i < to.length; i++) {
            if(_isExcludedMaxWallet[to[i]] == false &&  balanceOf(to[i]) + amount <= _maxWalletAmount)
            {
               continue;
            }
