...
// File: https://github.com/immutable/imx-contracts/blob/main/contracts/utils/Bytes.sol
...
abstract contract Mintable is ERC721A, Ownable, IMintable {
    ...
    constructor(address _imx) ERC721A("Demonica", "Demonica") {
        imx = _imx;
    }
...
contract Demonica is Mintable, ReentrancyGuard {
    ...
    // uint256 public constant MAX_TOKENS = 15000; // maximum supply of tokens
    // uint256 public constant MAX_BATCH_SIZE = 100; // maximum tokens minted per mint (used in reserve)
    address private constant TEAM = 0x64bFcbE7A74B5645cFbbC466E7caBBC05eF4c376;
    address private imx_address = 0x4527BE8f31E2ebFbEF4fCADDb5a17447B27d2aef;
    ...
    constructor() Mintable(imx_address) {
    ...
    function setImxAddress(address newImx) external onlyOwner {
        imx_address = newImx;
    }
