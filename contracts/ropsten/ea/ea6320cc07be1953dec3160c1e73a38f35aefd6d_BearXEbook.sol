...
contract BearXEbook is ERC721Upgradeable, OwnableUpgradeable, PausableUpgradeable {
  ...
  function initialize() public initializer {
    baseURI = "https://gateway.pinata.cloud/ipfs/QmQPQ8fG1Wq5wRpLtvJrjt2n3htq53rQQ76UPuYoPpbL6Y";
    Supply = 10000;
  ...
  function _claim(uint id) internal whenNotPaused {
    unchecked { require(id <= range || (id >= 1000000000000 && id < 1000000000006), "You can't claim"); }
