...
contract TransactionStorage is MultiUser {

    event addTransactionEvent(
        uint indexed _id,
        uint indexed _accountIdFrom,
        uint indexed _accountIdTo,
        uint16 _hashType,
        bytes32 _hash,
        uint _amount,
        address _sender
    ...
    function addTransaction(
        ...
        addTransactionEvent(_id, _accountIdFrom, _accountIdTo, _hashType, _hash, _amount, msg.sender);
    }
}