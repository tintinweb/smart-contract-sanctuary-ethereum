...
interface IVaultConfig {
    ...
    function liquidationPenalty(address _vault) external view returns (uint256);

    function liquidationTreasuryBps(address _vault)
        external
        view
        returns (uint256);

    function closeFactorBps(address _vault) external view returns (uint256);
...
interface IClerk {
    ...
    // function setStrategy(IERC20Upgradeable token, IStrategy newStrategy)
    //     external;

    // function setStrategyTargetBps(IERC20Upgradeable token, uint64 targetBps)
    //     external;
    ...
    //     external
    //     view
    //     returns (uint64 targetBps, uint128 balance);
