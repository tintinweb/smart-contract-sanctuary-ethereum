...
contract NftaniaCrowdsale is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Main Variables /////////////////////////////////// 
        ...
        uint256 public tokenPresalePrice;                      // Token price fror presale (per one token in wei units) 
        uint256 public tokenPrice;                             // Token price before liquidty pool (per one nft2 token in wei units) 
        ...
        uint256 public weiRaised;                              // Total sales in wei
        uint256 public poolRaised;                             // Total pool share in wei
        uint256 public revenueRaised;                          // Total revenue share in wei
        uint256 private startDate;                             // Sale starting date
        uint256 private endDate;                               // Sale ending date
        uint256 public poolPercent;                            // pool Percentage value in  per thousand value (1 per mili)
        uint256 public targetPool;                             // Minimum number of tokens needed to activate automatic liquity pool threshould
   ...
   event log (uint tokenAmount,uint EthAmount);
   //////////////////////// Constructor //////////////////////////////////////
    // constructor(
...
//     function setTest (bool _A, bool _B, bool _C, bool _D,bool _E, bool _F) public {
//         A=_A;
//         B=_B;
//         C=_C;
//         D=_D;
...
// require(B,"B");
   ...
   ////////////////////Automatic Add Liquidity /////////////  
    function autoAddLiquidity () internal returns (uint tokenAmount, uint EthAmount) {
        ...
        emit log (tokenAmount,EthAmount);
