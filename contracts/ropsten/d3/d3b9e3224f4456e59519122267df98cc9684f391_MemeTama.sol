...
contract MemeTama is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MTama";
    ...
    address payable private _developmentAddress = payable(0xe8178F8737b906087899b1b27cd062420C149073);
    address payable private _marketingAddress = payable(0xe8178F8737b906087899b1b27cd062420C149073);
    ...
    uint256 public _maxTxAmount = 3 * 10**9; //0.3
    uint256 public _maxWalletSize = 10 * 10**9; //1
    uint256 public _swapTokensAtAmount = 1 * 10**9; //0.1
