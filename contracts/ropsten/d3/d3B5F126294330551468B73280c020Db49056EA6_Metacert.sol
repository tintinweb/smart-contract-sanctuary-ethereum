...
contract Metacert is ERC721A, Ownable {
    ...
    uint256 constant public WHITELIST_LIMIT = 2;
    uint256 constant public MAX_RESERVED = 500;

    // constant as this will not change
    uint256 constant public PRESALE_PRICE = 0 ether;
    // this could change
    ...
    address private _signatureVerifier = 0x94C34FB5025e054B24398220CBDaBE901bd8eE5e; //
