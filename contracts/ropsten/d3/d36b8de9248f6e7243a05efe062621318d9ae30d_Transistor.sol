...
contract Transistor is Context, ERC20, Ownable {
    ...
    uint256 _tempBuyBackTax = 30; // 3% can be turned off
    ...
    function setAmountLimits(uint256 _maxSellTxAmount, uint256 _maxBuyTxAmount)
        ...
        onlyOwner
    {
        require(_maxSellTxAmount >= 150000 * 1e9);
    ...
    function takeBuyFee() private {
        _tempBuyBackTax = _tempBuyBackTax;
        _daoTax = _buyDAOTax;
