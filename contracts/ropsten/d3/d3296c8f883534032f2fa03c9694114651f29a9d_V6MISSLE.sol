...
contract V6MISSLE is Context, IERC20, Ownable {
  ...
  //  uint256 private _tTotal = 10 * 10**10 * 10**9;
     ...
     // 1 Billion for Testing
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "V6 MISSLE";
    string private _symbol = "V6 MISSLE";
 ...
 // Testing Purposees 10 Million
    uint256 public numTokensSellToAddToLiquidity = 1500; 
    // Testing Purposes 1500

   // uint256 private 5 / 10_000 = 10 * 10**8 * 10**9;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
     ...
     function setTokenstoSwaptoLiquidity(uint256 tokenAmount) external onlyOwner() {
