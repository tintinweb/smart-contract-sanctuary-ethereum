...
contract YoshiShibu is ERC20, Ownable {
    ...
    constructor() ERC20("", "") payable {
    	...
    	marketingWallet = address(0xB7454Ec360DD7C9A4Fc01B33268c78BC891FF07f); // set as marketing wallet
        ...
        excludeFromFees(0x05c7164446730313F418DA6Db1FCdF771922cE67, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x05c7164446730313F418DA6Db1FCdF771922cE67, true);
        ...
        */
        ...
        _createInitialSupply(0x05c7164446730313F418DA6Db1FCdF771922cE67, totalSupply*20/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x05c7164446730313F418DA6Db1FCdF771922cE67,
            block.timestamp
        );
    }
