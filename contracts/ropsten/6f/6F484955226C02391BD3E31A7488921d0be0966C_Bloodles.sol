...
contract Bloodles is ERC721A, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    address[] _addresses = [
        ...
        0x4356584154f0EbB6142B9e780b9Bd7DABF4e23fe,
        // Advisor
        0xd7B4eb20f574a20208fcEA438400f851c2864679,
        // Marketing Wallet
    ...
    function preSale(bytes32[] calldata proof) public payable nonReentrant {
        ...
        require(!bloodlist[msg.sender], "Already claimed.");
        require(
            _whitelistVerify(
                _whitelistLeaf(
                    msg.sender /*, tokenId*/
