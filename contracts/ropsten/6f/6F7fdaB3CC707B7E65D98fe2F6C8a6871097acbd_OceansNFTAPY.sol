...
contract OceansNFTAPY is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        BUSD = IERC20(0x48F0306d777906D94b56a933591451df08445A58); //testnet BUSD
        OCEANS = IERC20(0x63621de886D667068cb2e4a894957ae2a42aFC1d); //testnet Oceans
    ...
    function mint(
        ...
        uint256 TenPercent = (_amount * 10) / 100;
        uint256 remaining = (_amount * 90) / 100;

        string memory _uri = _NftData[_id]._cid;
        ...
        BUSD.transfer(developer, remaining);
    ...
    function setData(
        ...
        _NftData[_id] = database(_id, _roi, _img, _rate);
    }
