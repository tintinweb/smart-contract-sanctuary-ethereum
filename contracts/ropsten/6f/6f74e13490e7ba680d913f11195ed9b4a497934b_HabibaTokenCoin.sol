...
contract HabibaTokenCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HabibaTokenCoin() {
        ...
        name = "HabibaTokenCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT18-018";                                             // Set the symbol for display purposes (CHANGE THIS)
