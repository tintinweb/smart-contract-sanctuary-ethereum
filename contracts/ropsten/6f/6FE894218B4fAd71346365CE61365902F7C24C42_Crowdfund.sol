...
contract Staking {
    ...
    */
     ...
     */
      function calculateStakeReward(Stake memory _current_stake) internal view returns(uint256){
          ...
          return (((block.timestamp - _current_stake.since) / 1 minutes) * _current_stake.amount) / rewardPerHour;
    ...
    */
     ...
     */
    function hasStake(address _staker) public view returns(uint){
    ...
    function getSummary(address _staker) public view returns (Stakeholder memory) {
        return stakeholders[stakes[_staker]];
    }
