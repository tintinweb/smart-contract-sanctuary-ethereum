...
contract Token {
    ...
    mapping(address => uint256) public balanceOf; //tells how many token each person have
    mapping(address => mapping(address => uint256)) public allowance;

    // Events - fire events on state changes etc
    //to record transfer events on ether blockchain
    ...
    // where are you sending tokens and how much you want to send
    //aprrove token to Uniswap that you want to send
    function transfer(address _to, uint256 _value) external returns (bool success)  {
        //reqire fuction is to verify that you have tokens in your wallet before you tranfer
    ...
    //Uniswap take token from you and exchange it for you to person buying it
