...
/**
    Welcome to FREGULATION.

    If you are tired of Regulations JOIN US and fight against them.

    Here some utilities info:
...
contract Fregulation is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Fregulation";
    string private constant _symbol = "FREG";
    ...
    address payable private _marketingAddress = payable(0x718cA9fFB056b7E7c164b114508Cc949d7BC5364);
