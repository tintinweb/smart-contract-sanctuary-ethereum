...
abstract contract UniStakingTokensStorage {
    ...
    function getClaimingFeePercent(address account) internal returns(uint256) {
    ...
    constructor(IERC20 rewardsToken_, IERC20 stakingToken_, address feeReceiver_ ) public {
...
contract Staking is TwoStageOwnable, UniStakingTokensStorage {
    ...
    constructor(
        ...
        address owner_
    ) public TwoStageOwnable(owner_) UniStakingTokensStorage(rewardsToken_, stakingToken_, feeReceiver_) {
    }
...
contract UniStakingSyntheticToken is Staking {
    ...
    constructor(
        ...
        address feeReceiver_,
        address owner_
    ) public Staking(rewardsToken_, stakingToken_,feeReceiver_,owner_) {
        name = name_;
        symbol = symbol_;
        decimals = decimals_;
    }
