...
contract pINUchio is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("pINUchio", "NOSE") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x77302b46DcC654Fa30BD508AD36e96b3A88A9CDF); // set as marketing wallet
