...
// Root file: contracts/StarsNFT721.sol
...
contract StarNFT721 is Ownable, ERC721URIStorage {
	...
	constructor(address _marketplaceAddress) ERC721("Stars NFT", "StarNFT") {
	...
	function burnNFT(uint256 nftId) public returns (uint256) {
