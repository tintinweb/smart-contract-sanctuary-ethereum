...
contract UniswapTest is IERC721Receiver {
  ...
  // address public constant WETH9 = 0xc778417E063141139Fce010982780140Aa0cD5Ab; // ropsten
  // address public constant UNI = 0xC8F88977E21630Cf93c02D02d9E8812ff0DFC37a;  // ropsten
  ...
  function mintNewPosition(address token0, uint256 amount0ToMint, address token1, uint256 amount1ToMint)
    external
    returns (
      uint256 tokenId,
      uint128 liquidity,
