...
contract Mikoto is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = 8888888 * 10**9;
    uint256 public maxWalletAmount = 8888888 * 10**9;
    address public marketingWallet = 0x3De5D39c89c1dc9467418451f896651bA262ba6C;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    uint256 public _marketingReserves = 0; // tempo
    mapping(address => bool) private _isExcludedFromFee;
    uint256 private _numTokensSellToAddToLiquidity = 500000 * 10**9;
    uint256 private _numTokensSellToAddToETH = 250000 * 10**9;
     ...
     * construction.
     */
    constructor() ERC20("Tsukuyomi-no-Mikoto", "MIKOTO") {
        _mint(msg.sender, (888888888 * 10**9));
