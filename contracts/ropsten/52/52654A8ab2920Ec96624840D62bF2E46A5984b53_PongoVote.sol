...
contract PongoVote is Ownable, IPongoVote {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _gProposalId;

    // Name
    string private _name = "PONGO VOTE TEST";
    // Symbol
    string private _symbol = "PONGOVOTET1";
    ...
    address public pongoContract = 0x73e14D83f0F107e0Ac02131567AdE0BedB55A10E;
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view returns (uint256) {
        require(index < balanceOf(owner), "IPongoVote: owner index out of bounds");
        return _ownedProposals[owner][index];
    }

    /**
     * @dev See {IPongoVote-totalSupply}.
     */
    ...
    /**
     * @dev See {IPongoVote-proposalOfOwnerByIndex}.
     */
    ...
    /**
     * @dev See {IPongoVote-proposalByIndex}.
     */
    function proposalByIndex(uint256 index) public view returns (uint256) {
        require(index < totalSupply(), "IPongoVote: global index out of bounds");
