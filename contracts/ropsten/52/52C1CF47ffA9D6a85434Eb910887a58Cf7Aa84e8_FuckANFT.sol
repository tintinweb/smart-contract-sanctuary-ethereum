...
contract FuckANFT is ERC721URIStorage, Ownable {
    uint256 public constant MAX_NFT_SUPPLY = 10000;
    uint256 public _counter;

    constructor() ERC721("FuckANFT.com", "FAN") {}
    
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://FuckAnft.com/api/";
    }
    
    function mintFAN(address to, string memory tokenURI) public onlyOwner returns (uint256){
