...
contract FeeUpgradeablePrev is
    Initializable,
    OwnableUpgradeable,
    UUPSUpgradeable,
    IFeeupgradeable
{
    ...
    function initialize(
        ...
        _setThresholdMinimumFeeCollection(_thresholdMinimumFeeCollection);
    ...
    function geThresholdMinimumFee() public view override returns (uint256) {
        return thresholdMinimumFeeCollection;
    }
    ...
    function _setThresholdMinimumFeeCollection(
        uint256 _thresholdMinimumFeeCollection
    ) internal {
        uint256 oldThreshold = thresholdMinimumFeeCollection;
        thresholdMinimumFeeCollection = _thresholdMinimumFeeCollection;
        emit FeeThresholdSet(
            msg.sender,
            oldThreshold,
            thresholdMinimumFeeCollection
        );
    }
    ...
    function updateThresholdMinimumFeeCollection(
        uint256 _thresholdMinimumFeeCollection
    ) external {
        _verifyContractUpdaterRole();
        _setThresholdMinimumFeeCollection(_thresholdMinimumFeeCollection);
