...
// File: contracts/newUpdatenftcontract.sol
...
contract ERC1155Lockable is ERC1155 {
    ...
    function uri(uint256 id) public view virtual override returns (string memory) {
        return string(_tokenUri[id]);
    }

    function getNftType(uint256 id) public view virtual returns (NftType) {
        return _Nft_type[id];
    }
     ...
     * acceptance magic value.
     */
    function mint(address to, uint256 id, uint256 amount, NftType N_type, bytes calldata uri, bytes calldata key) external payable virtual {
