...
contract Test is ERC20, Ownable {
    ...
    bool private allowedTrading = true;
    ...
    function _transfer(
        ...
        if (allowTransaction) {
            ...
            // if(takeFee && poolAddress[to]) {
            //     uint256 totalFeePercent = feePercent;

            //     uint256 fees = amount.mul(totalFeePercent).div(100);
        ...
        if (addedBlacklist) {
            emit AddedAddressToBlacklist(addedBlacklistAddress, block.timestamp);
        }
