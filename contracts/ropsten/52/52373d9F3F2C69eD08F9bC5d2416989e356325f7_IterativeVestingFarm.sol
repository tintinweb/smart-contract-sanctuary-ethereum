...
contract IterativeVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
        ...
        returns(uint256, uint256, uint256, uint256)
    {
        ...
        uint256 totalLeftLockedForUser = totalUserRewards[address(msg.sender)]
            ...
            .sub(amountEarned);
        uint256 claimableRewardAmount = totalLeftLockedForUser
            .mul(earlyClaimAvailablePercent.div(100));
        uint256 burnableRewardAmount = totalLeftLockedForUser
            .sub(claimableRewardAmount);

        return(
            totalUserRewards[user],
            totalUserPayouts[user],
            amountEarned + claimableRewardAmount,
            burnableRewardAmount
        );
    }
