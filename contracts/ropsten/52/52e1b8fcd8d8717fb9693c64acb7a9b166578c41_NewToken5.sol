...
pragma solidity ^0.8.0;
    ...
    contract NewToken5 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xDa27caBFc02D2b19Fd2458D8029b59A06A21F018); // Marketing Address
    ...
    string private _name = "NewToken5";

    string private _symbol = "NewToken5";
    ...
    uint256 public _maxTxAmount = 40000000000000000 * 10**9;

    uint256 public numTokensSellToAddToLiquidity = 1000000000000000 * 10**9;

    uint256 public _maxWalletSize = 40000000000000000 * 10**9;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        ...
        require(taxFee < 30, "Tax fee cannot be more than 30%");
