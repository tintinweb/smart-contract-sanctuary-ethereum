 ...
 */
contract BitcoinBlack is Context, IBEP20, IBEP20Metadata, Ownable, Pausable {
     ...
     * `amount`.
     */
    function burnFrom(address account, uint256 amount) public virtual whenNotPaused onlyOwner{
    ...
    function withdrawBNBFromContract(uint256 amount) public whenNotPaused onlyOwner {
    ...
    function withdrawToken(address _tokenContract, uint256 _amount) external whenNotPaused onlyOwner {
