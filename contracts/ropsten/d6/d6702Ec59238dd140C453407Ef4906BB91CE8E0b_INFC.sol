...
abstract contract ERC20 is IERC20 {
    ...
    mapping(address => uint) _balances; // owner => ballot
    ...
    function _transfer(address from, address to, uint amount) internal {
        ...
        require(amount <= _balances[from], "transfer amount exceeds ballot");
    ...
    function _burn(address from, uint amount) internal {
        ...
        require(amount <= _balances[from], "burn amount exceeds ballot");
        _balances[from] -= amount;
        _totalSupply -= amount;
...
contract INFC is ERC20 {
    ...
    function withdraw(uint amount) public {
        require(amount > 0 && amount <= _balances[msg.sender], "withdraw amount exceeds ballot");
