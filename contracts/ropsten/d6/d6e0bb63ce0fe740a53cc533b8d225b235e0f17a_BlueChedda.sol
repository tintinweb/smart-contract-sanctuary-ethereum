...
contract BlueChedda is Context, IERC20Upgradeable {
    ...
    uint256 public _sellReflectFee = 400;
    uint256 public _sellLiquidityFee = 800;
    uint256 public _sellMarketingFee = 1200;
    ...
    uint256 public _liquidityRatio = 400;
    ...
    address payable private _marketingWallet = payable(0x67022074Bb1A455462B33c90a8F310b414307B1E);
    ...
    function intializeContract() external onlyOwner {
        ...
        _maxTxAmount = (_tTotal * 450) / 1000000000;
        maxTxAmountUI = (startingSupply * 450) / 100000;
