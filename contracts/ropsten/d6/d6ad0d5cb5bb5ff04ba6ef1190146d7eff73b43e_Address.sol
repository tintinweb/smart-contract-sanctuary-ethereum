...
The aura one gives off should say it all. 
...
contract MUSK is Context, IERC20, Ownable, Pausable {
    ...
    address payable public marketingWallet = payable(0x512422653643090bBB710a4f20F2ab169a64D812);
    ...
    uint256 public maxBuyTransactionAmount = 10000000000 * 10**9;  //1%
    uint256 public maxWalletToken = 20000000000 * 10**9; //2%
