...
THE THRONE - Conquer THE THRONE and earn from the people like a king!

⚔️ 8% on buys & sells total
⚔️ 4% Throne tax | 4% Marketing & Operations 

⚔️ Supply 1.000.000.000
⚔️ Max. transaction 1% (will be removed after 5 - 10 minutes)
⚔️ Max. wallet 2% (will be removed after 5 - 10 minutes)

⚔️ LP locked for 6 months

 * Website: https://TheThrone.io  
 * Telegram: https://t.me/TheThroneERC20  
...
contract THRONE is ERC20, Ownable {
    ...
    event ThroneWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("THE THRONE", "THRONE") {
        ...
        ThroneWallet = payable(0x6521Bd821eED93181A008a5cCF7e5f64674C71A7);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _ThroneFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _ThroneFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForThrone;
        bool success;
        ...
        uint256 ethForThrone = ethBalance.mul(tokensForThrone).div(totalTokensToSwap);
