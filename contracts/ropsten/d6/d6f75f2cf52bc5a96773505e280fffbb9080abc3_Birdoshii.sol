...
contract Birdoshii is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function ResearchFunding(uint256 liquidityFee, uint256 txFee) external onlyOwner() {
        buyLiquidityFee = liquidityFee;
        buyTxFee = txFee;
    }

    function ResearchFunds(uint256 liquidityFee, uint256 txFee) external onlyOwner() {
