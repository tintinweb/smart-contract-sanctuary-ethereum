...
contract HonkoDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Honko DAO", "Honko DAO") {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48));
        ...
        uint256 _earlySellMarketingFee = 90;
        uint256 _earlySellDevFee = 0
 
    ; uint256 totalSupply = .00001 * 1e12 * 1e18;
 
        maxTransactionAmount = totalSupply * 100 / 1000; // 0.1% maxTransactionAmountTxn
        maxWallet = totalSupply * 100 / 1000; // 0.1% maxWallet
        swapTokensAtAmount = totalSupply * 1000 / 10000; // 0.1% swap wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 90, "Must keep fees at 20% or less");
    }
