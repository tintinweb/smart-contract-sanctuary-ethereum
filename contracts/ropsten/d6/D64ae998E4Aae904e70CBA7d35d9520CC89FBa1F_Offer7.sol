...
import "./BaseOfferToken.sol";
import "./FimbStableToken.sol";

/**
 * @dev Offer7
 */
contract Offer7 is Ownable, IOffer {
    ...
    FimbStableToken private brlToken;
    ...
    constructor(
        ...
        brlToken = FimbStableToken(_brlTokenContract);
    ...
    function invest(address _investor, uint256 _amount) public onlyOwner {
        ...
        // @WARNING add logic to only set success based on something our clients want
        if (!bSuccess) {
            bSuccess = true;
        }
    }
