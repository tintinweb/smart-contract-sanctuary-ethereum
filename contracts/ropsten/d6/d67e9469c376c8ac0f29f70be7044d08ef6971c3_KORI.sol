...
contract KORI is IERC20, Auth {
    ...
    function changeTaxDistribution(uint16 sharesAutoLP, uint16 redistrubtion, uint16 sharesWallet1, uint16 sharesWallet2, uint16 sharesWallet3) external {
		require(msg.sender == _operator || msg.sender == owner, "403");
        require(sharesAutoLP +  redistrubtion + sharesWallet1 + sharesWallet2 + sharesWallet3 == 1000, "Sum must be 1000" );
        _autoLPShares = sharesAutoLP;
        _redisFee = redistrubtion;
