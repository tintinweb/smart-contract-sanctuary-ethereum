...
abstract contract ERC20Mintable is ERC20 {
    ...
    function mintFrom(address minted, uint256 amount) 
    external
    returns (bool success)
    {
        _mint(minted, amount);
...
contract AOK is
    ...
    ERC20Mintable
{
    string constant private _name = "AOK";
    string constant private _symbol = "AOK";
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "AOK/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "AOK/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "AOK/approve : Should not approve zero address"
        );
