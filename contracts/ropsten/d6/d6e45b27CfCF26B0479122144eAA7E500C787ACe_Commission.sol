...
contract Commission is Ownable, Pausable {
    ...
    function claim(
        ...
        historyCommission[msg.sender].push(
            Claim(_amount, _rateUSD, block.timestamp)
        );
        emit ClaimEvent(msg.sender, _amount, _rateUSD, block.timestamp);
    }
    ...
    function setWhiteList(address[] memory _list, bool _result)
        public
        onlyOwner
    {
