...
/**
 *Submitted for verification at Etherscan.io on 2022-26-09
*/
...
Tensa Zangetsu started as a passion crypto project by anime fans who love the medium. 
Now we are evolving into a bigger movement. The project was launched in last quarter of September. 
Come join our amazing community  on telegram and help us take over the world! 

Telegram:https://t.me/ZangetsuERC
*/
...
pragma solidity ^0.6.12;
    ...
    contract TensaZangetsu is Context, IERC20, Ownable {
        ...
        uint256 private _ContractFee = 15;
        ...
        uint256 private _maxTxAmount = 1e4;
        // We will set a minimum amount of tokens to be swaped => 10k
        uint256 private _numOfTokensToExchangeForMarketing = 10 * 10**3 * 1**9;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xF3C3319363591F8f9a7Eee56a00f8922F0f63B84, 'We can not exclude Uniswap router.');
