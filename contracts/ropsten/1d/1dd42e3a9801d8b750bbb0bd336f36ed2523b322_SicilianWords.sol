...
contract SicilianWords is ERC721Enumerable, Ownable {
  using Strings for uint256;
  
  string[] public wordsValues = ["puppo","arruso","minchia","aisamu","amuninni","funciuto","garganella","movitiiddocu","ammarravadduna","squazzalattuchi","gnada'"];
  ...
  constructor() ERC721("Sicilian Words", "SW") {}
