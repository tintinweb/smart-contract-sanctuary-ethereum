...
contract ERC721Claimable is ERC721, Ownable {
        ...
        ERC721(_name, _symbol)
    {
        ...
        endMintTimestamp = _endMintTimestamp;
    ...
    modifier premintCheck(bytes32[] calldata merkleProof) {
        ...
        require(premintCount[msg.sender] < maxPremint, "Too much premint");
        _;
    }

    modifier mintCheck() {
        require(block.timestamp > startMintTimestamp, "Too early to premint");
        require(block.timestamp < endMintTimestamp, "Too late to premint");
        _;
    }
    ...
    function claim() public mintCheck payable {
        uint256 mintPrice = getPrice(nextClaim);
