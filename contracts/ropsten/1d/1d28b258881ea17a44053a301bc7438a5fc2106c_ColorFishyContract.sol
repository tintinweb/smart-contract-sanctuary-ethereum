...
contract ColorFishyContract is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor() ERC721('ColorFish Nft', 'Color') {}
    ...
    function internalMint(address to ) internal {
        ...
        _tokenData[_tokenIdCounter.current()] = TokenData(_msgSender());
