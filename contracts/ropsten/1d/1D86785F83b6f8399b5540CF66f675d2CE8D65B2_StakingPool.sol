...
contract StakingPool is Ownable{
    ...
    constructor() {
        NFTCollection = IERC721Enumerable(0x3409c1A4Ac3d8De4064d296CF008e60Da82F25B7);
        Token = IERC20(0x4Eb2C71741C25b4D6e833beAcf4beC17779d6911);
    }
    ...
    */
    ...
    function calculateReward(uint tokenId, uint type_) public view returns(uint256) {
        ...
        if (type_ == 0) {
            ...
            return rewardPerDayBronze * ((block.timestamp-checkpoint) / 300);
        }
        else if (type_ == 2) {
            return rewardPerDaySilver * ((block.timestamp-checkpoint) / 300);
        }
        else if (type_ == 3) {
            return rewardPerDayGold * ((block.timestamp-checkpoint) / 300);
        }
        else {
            return rewardPerDayPlatinum * ((block.timestamp-checkpoint) / 300);
        }
