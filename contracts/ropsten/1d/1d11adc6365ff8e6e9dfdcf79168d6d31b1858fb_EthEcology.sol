...
contract EthEcology {
    ...
    function pledgeSwitch(bool _Is) public{
        require(msg.sender == owner, "EE: only owner");
        pledge_switch = _Is;
    }

    function pledgeEth() payable public {
        // require(msg.value > 2, 'EE: input_amount greater than 0.2 eth');
        // require(input_amount>=2, "LP: input_amount greater than 0.2 eth");
