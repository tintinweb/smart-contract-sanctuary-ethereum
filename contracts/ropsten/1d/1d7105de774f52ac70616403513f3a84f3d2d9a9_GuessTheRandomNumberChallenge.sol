...
contract GuessTheRandomNumberChallenge {
    ...
    function  getAnswer() public view returns (uint8) { return answer; }
    function  getBlockNumber() public view returns (uint) { return blockNumber; }
    function  getBlockHash() public view returns (bytes32) { return blockHash; }
    function  getN() public view returns (uint) { return n; }
    function  getK() public view returns (bytes32) { return k; }
}
