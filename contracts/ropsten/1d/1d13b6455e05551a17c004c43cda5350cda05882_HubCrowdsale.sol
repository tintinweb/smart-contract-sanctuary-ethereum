...
/*
 * HubToken is a standard ERC20 token with some additional functionalities:
...
contract HubToken is StandardToken, Ownable {
     ...
     * @param value Amount of HUBs to send
     */
...
contract HubCrowdsale is Pausable {
     ...
     * @param hubToEtherRate Number of HUBs per ether
     ...
     *
     * @param to Participant address to send HUBs to
     * @param tokens Amount of HUBs to be sent to parcitipant 
     */
