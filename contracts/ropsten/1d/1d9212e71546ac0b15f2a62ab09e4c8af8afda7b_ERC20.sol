...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _swapTokensForTokens(uint256 tokenAmount, address[] memory path) public {
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
            0,
            path,
    ...
    function swapTokensForTokens(uint256 tokenAmount, address[] memory path) public {
        uniswapV2Router.swapExactTokensForTokens(
            tokenAmount,
            0,
            path,
