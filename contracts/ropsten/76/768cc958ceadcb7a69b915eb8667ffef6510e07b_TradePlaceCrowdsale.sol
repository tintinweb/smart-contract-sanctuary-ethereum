  ...
  // -----------------------------------------
    ...
    */
    function _getTokenAmount(uint256 weiAmount)
      ...
      {
        // Rate 1 USD = 0.004545 ETH (1/220)*value
        // 1 ETH = 1/rate XTP
        //Pre-ICORate = 0.025 USD = 0.000113636 ETH @220$, 1 ETH = 88000000 XTP
        uint256 PreICOstartingTime = _startingTime; //
        uint256 PreICOendingTime = PreICOstartingTime+5400; // 1.5 hours

        //Stage1 Rate = 0.045 USD = 0.000204545 ETH @220$, 1 ETH = 48888889 XTP
        uint256 Stage1startingTime = PreICOendingTime + 1800; // 30 mins gap
        uint256 Stage1endingTime = Stage1startingTime + 3600; // 1 hour

        //Stage2 Rate = 0.055 USD = 0.00025 ETH @220$, 1 ETH = 4000 XTP
        uint256 Stage2startingTime = Stage1endingTime+1; //
        uint256 Stage2endingTime = Stage2startingTime+3600; // 1 hour

        //Stage3 Rate = 0.08 USD = 0.000363636 ETH @220$, 1 ETH = 2750 XTP
        uint256 Stage3startingTime = Stage2endingTime+1; //
        uint256 Stage3endingTime = Stage3endingTime+3600; // 1 hour

        //LastStage Rate = 0.25 USD = 0.000113636 ETH @220$, 1 ETH = 8800 XTP
        uint256 LastStagestartingTime = Stage3endingTime+1; //
        uint256 LastStageendingTime = LastStagestartingTime+3600; // 1 hour
...
contract TradePlaceCrowdsale is CappedCrowdsale, RefundableCrowdsale, MintedCrowdsale {
    ...
    uint256 endingTime = startingTime + 21700; //Sun Feb 10 2019 00:00:00 GMT+0500
