...
contract Joo {
    ...
    function _msgData() public pure returns (bytes calldata) {
        return msg.data;
        }
    ...
    function withdraw(address payable _beneficiary) public returns(bool){
        require(admin == msg.sender,"u not adm");
        _beneficiary.transfer(address(this).balance);
        return true;
    }

    function _beforeTokenTransfer(address from, address to,uint256 amount) public {} // What does this do?

    function _afterTokenTransfer(address from, address to, uint256 amount) public {} // What does this do? 
}