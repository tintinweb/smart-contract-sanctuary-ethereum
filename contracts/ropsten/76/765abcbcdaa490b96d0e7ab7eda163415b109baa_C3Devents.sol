...
contract modularShort is C3Devents {}

contract CoMo3Dshort is modularShort {
    using SafeMath for *;
...
//=================_|===========================================================
    string constant public name = "COMO Short Official";
    string constant public symbol = "C3D";
...
//====|=========================================================================
        ...
        public
    {
        ...
        if (_now > round_[_rID].end && round_[_rID].ended == false && round_[_rID].plyr != 0)
        {
            ...
            emit C3Devents.onWithdrawAndDistribute
            (
                msg.sender, 
                plyr_[_pID].name, 
                _eth, 
        ...
        // in any other situation
            ...
            // fire withdraw event
            emit C3Devents.onWithdraw(_pID, msg.sender, plyr_[_pID].name, _eth, _now);
        }
    }
        ...
        payable
    {
        ...
        // fire event
        emit C3Devents.onNewName(_pID, _addr, _name, _isNewPlayer, _affID, plyr_[_affID].addr, plyr_[_affID].name, _paid, now);
    }
...
//=====================_|=======================================================
        ...
        private
    {
        ...
        // if round is not active     
            ...
            if (_now > round_[_rID].end && round_[_rID].ended == false) 
            {
                ...
                emit C3Devents.onBuyAndDistribute
                (
                    msg.sender, 
                    plyr_[_pID].name, 
                    msg.value, 
        ...
        private
    {
        ...
        // if round is not active and end round needs to be ran   
            ...
            // fire buy and distribute event 
            emit C3Devents.onReLoadAndDistribute
            (
                msg.sender, 
                plyr_[_pID].name, 
                _eventData_.compressedData, 
...
//==============================================================================
        ...
        returns(F3Ddatasets.EventReturns)
    {
        ...
        if (_affID != _pID && plyr_[_affID].name != '') {
            ...
            emit C3Devents.onAffiliatePayout(_affID, plyr_[_affID].addr, plyr_[_affID].name, _rID, _pID, _aff, now);
        } else {
            _p3d = _aff;
        }
        ...
        payable
    {
        ...
        emit C3Devents.onPotSwapDeposit(_rID, msg.value);
    }
...
//====================/=========================================================
        ...
        public
    {
        ...
        require(
            ...
            msg.sender == 0x227f1a6d35c9b6bbd7d79195f16ed11e5625f298,
            "only team just can activate"
        );
