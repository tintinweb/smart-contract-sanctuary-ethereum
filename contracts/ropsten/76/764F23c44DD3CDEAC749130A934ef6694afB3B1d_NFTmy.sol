...
contract NFTmy is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes{
    using Counters for Counters.Counter ;
    Counters.Counter private _tokenIdCounter ;


	uint256 private  NUMBER_OF_RESERVED_BOX = 0;
	uint256 private constant MAX_BOX_SUPPLY = 5040; 
	uint256 private  MAX_BOX_SMALL ;        
	uint256 private  MAX_BOX_MEDIUM ;
    uint256 private  MAX_BOX_LARGE ;
    uint256 private  MAX_BOX_ULTRA ;
    uint256 private  MAX_BOX_MEGA ;    
    uint256 private  MAX_MINTS_PER_ADDRESS = 3; 
...
// for MetaData Frozen
   ...
   constructor() ERC721("MYNFT", "MYCOLLECTION") EIP712("",""){
      MAX_BOX_SMALL = 0;  
      MAX_BOX_MEDIUM = 0;
      MAX_BOX_LARGE = 0;  
      MAX_BOX_ULTRA = 0; 
   ...
   //// baseURI
    ...
    function countBox(uint256 _small, uint256 _medium, uint256 _large, uint256 _ultra) public view returns ( uint256 small, uint256 medium,uint256 large, uint256 ultra){   
    //mega box is also include but i removed for testing becuse i have 4 box just on front end
  ...
  //  require(_mega + MAX_BOX_MEGA <=30,'Exceeds maximum MEGA allowable mints');   
    ...
    ultra = _ultra;
    //mega = _mega;
    //count = _small + _medium + _large + _ultra ;
    return (small, medium, large, ultra);
    ...
    //// mint 
    function safeMint(uint256 count, uint256 small, uint256 medium, uint256 large, uint256 ultra) public payable //  uint256 mega
    {
       ...
       ////for loop
        ...
        assert(id > MAX_BOX_SMALL + MAX_BOX_MEDIUM + MAX_BOX_LARGE + MAX_BOX_ULTRA + MAX_BOX_MEGA + NUMBER_OF_RESERVED_BOX &&
				id <= MAX_BOX_SUPPLY);
         // Set Box available test 
...
function freezeMetadata() external onlyOwner {
    ...
    function setBaseURI(string memory newBaseURI, uint256 id) public {
        require(!metadataIsFrozen, 'Metadata is permanently frozen');
        _setTokenURI(id,newBaseURI);
