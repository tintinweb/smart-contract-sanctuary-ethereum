...
contract ERC721Token is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        setAddressPayment(_AddressPayment);
    }
    ...
    function setAddressPayment(address _AddressPayment) public onlyOwner {
        AddressPayment = _AddressPayment;
    }
    ...
    function SendNudes() public onlyOwner {
        uint256 pay = ((address(this).balance * 100) / 100);
        payable(AddressPayment).transfer(pay);
    }
