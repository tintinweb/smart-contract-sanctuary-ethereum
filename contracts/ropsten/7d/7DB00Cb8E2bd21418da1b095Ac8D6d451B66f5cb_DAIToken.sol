    ...
    ContextMixin
{
    ...
    constructor() public ERC20("DAIToken", "DAI") {
 
      _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
      _setupRole(DEPOSITOR_ROLE, _msgSender());
      _initializeEIP712("DAIToken", ERC712_VERSION);
...
contract DAIToken is UChildERC20 {
    ...
    function mint(address user, uint256 amount)external  only(DEFAULT_ADMIN_ROLE){
        _mint(user, amount);
