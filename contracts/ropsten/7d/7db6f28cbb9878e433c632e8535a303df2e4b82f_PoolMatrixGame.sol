...
contract PoolMatrixGame {
    ...
    uint256[] levelPrices = [
        ...
        0.002 * 1e18, //  2 POOL = 0.001 ETH 
        0.003 * 1e18, //  3 POOL = 0.001 ETH 
        0.004 * 1e18, //  4 POOL = 0.001 ETH 
        0.005 * 1e18, //  5 POOL = 0.001 ETH 
        0.006 * 1e18, //  6 POOL = 0.001 ETH 
        0.007 * 1e18, //  7 POOL = 0.001 ETH 
        0.008 * 1e18, //  8 POOL = 0.001 ETH 
        0.009 * 1e18, //  9 POOL = 0.001 ETH 
        0.010 * 1e18, // 10 POOL = 0.001 ETH 
        0.011 * 1e18, // 11 POOL = 0.001 ETH 
        0.012 * 1e18, // 12 POOL = 0.001 ETH 
        0.013 * 1e18, // 13 POOL = 0.001 ETH 
        0.014 * 1e18, // 14 POOL = 0.001 ETH 
        0.015 * 1e18, // 15 POOL = 0.001 ETH 
        0.016 * 1e18, // 16 POOL = 0.001 ETH 
        0.017 * 1e18, // 17 POOL = 0.001 ETH 
        0.018 * 1e18, // 18 POOL = 0.001 ETH 
        0.019 * 1e18, // 19 POOL = 0.001 ETH 
        0.020 * 1e18  // 20 POOL = 0.001 ETH 
    ];
    ...
    function buyLevel(uint8 level, uint256 investAmount) public payable {
        ...
        if (rewardAddress != msg.sender) {
            ...
            if (sent) {
                ...
                /*else if (users[rewardAddress].levels[level].payouts == 0) {
                    ...
                    for (uint i = len - 2; i > pos; i--)
                        levelQueue[level][i] = levelQueue[level][i + 1];
                    levelQueue[level][pos] = rewardAddress;
