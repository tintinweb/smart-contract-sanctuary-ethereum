...
contract Zhuantokens is Token {
    ...
    function multisendToken(address tokenAddress, address[] _contributors, uint256[] _balances) public  payable  returns (bool){  
        Token erc20token = Token(tokenAddress);
        uint8 i = 0;
