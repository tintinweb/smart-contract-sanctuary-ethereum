    ...
    AccessControlUpgradeable
{
    ...
    mapping(uint256 => destinyNFT) public destiny;
    ...
    function createToken(address _sender, string memory _tokenUri, string memory _destiny)
        public
        virtual
      //  onlyRole(MINTER_ROLE)
        returns (uint256)
    {
        ...
        destiny[_newItemID].destiny = _destiny;
        return _newItemID;
    }
