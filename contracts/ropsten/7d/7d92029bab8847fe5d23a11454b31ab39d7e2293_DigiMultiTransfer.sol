...
contract MultiTransfer is Pausable, CostTransfer {
    using SafeMath for uint256;
// uint256 _amount, address _referAddress, address _owner
    ...
    function multiTransfer_OST(
        ...
        distributeCommission(_fee, _referralAddress, address(this));
        return true;
    }
}

/// @notice Transfer equal Ether amount to multiple addresses
contract MultiTransferEqual is Pausable, CostTransfer {
...
/// @notice `DigiMultiTransfer` is a contract for sending multiple BEP/BEP20 Tokens to
/// multiple addresses.
///
contract DigiMultiTransfer is
    Pausable,
    Escapable,
    MultiTransfer,
    MultiTransferEqual,
