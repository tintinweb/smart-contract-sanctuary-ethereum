...
contract Casino is Ownable, ReentrancyGuard{
    ...
    function getUserSettings(address user) public view returns(uint96, uint256, uint96, uint256, uint256, uint256){
        ...
        return(withdraftPeriod, withdraftAmountLimit, withdraftDelay,  _UserSettings.balance, _UserSettings.requestTime, _decimals);
