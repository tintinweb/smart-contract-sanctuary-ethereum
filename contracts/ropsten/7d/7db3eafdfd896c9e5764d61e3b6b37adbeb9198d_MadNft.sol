...
interface IRoyaltyBase {
  function setRoyaltyPercentageForCreator(uint256 _royaltyPercentageForCreator) external;
  function setRoyaltyPercentageForAdmin(uint256 _royaltyPercentageForAdmin) external;
  function royaltyInfo(uint256, uint256) external view returns (address, uint256);
  function royaltyInfoAdmin(uint256) external view returns (address, uint256);
