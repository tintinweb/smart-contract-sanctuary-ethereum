...
contract OmniDiyApes is Ownable, ERC721, NonblockingReceiver{
    ...
    uint256 MAX_MINT_ETHEREUM = 4084;
    ...
    constructor(string memory baseURI_) ERC721("OmniDiyApes", "oda") { 
        _owner = msg.sender;
        baseURI = baseURI_;
    }
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 2, "OmniDiyApes: Max 2 NFTs per transaction");
        require(nextTokenId + numTokens <= MAX_MINT_ETHEREUM, "OmniDiyApes: Mint exceeds supply");
