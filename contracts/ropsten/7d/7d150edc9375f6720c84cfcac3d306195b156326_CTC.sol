...
contract CTC is Context, IERC20, Ownable {
    ...
    string private _name = "chainSniper Test Contract v1";
    ...
    address payable private _devWallet = payable(0x0C139f9D34535bd7be60623F81af0b199B6B4f92);
    address payable private _marketingWallet = payable(0xB65B50b5913F74e71792c560C29A39d9D77dE77b);
    address payable private _platformWallet = payable(0xF2c6f6aa0AC554147800B1c8dcC1bA7aF4b43Fbe);
    ...
    constructor () {
        ...
        // launch sell fee
        launchSellFeeDeadline = block.timestamp + 10 minutes;
