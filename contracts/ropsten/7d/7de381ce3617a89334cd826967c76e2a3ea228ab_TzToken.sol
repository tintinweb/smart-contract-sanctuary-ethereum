...
contract TzToken is UnboundedRegularToken {

    uint public totalSupplys = 21*10**27;
    uint8 constant public decimals = 18;
    string constant public name = "TzToken";
    string constant public symbol = "TzT";

     constructor () public{
        balances[msg.sender] = totalSupplys;
        emit Transfer(address(0), msg.sender, totalSupplys);
    }
}