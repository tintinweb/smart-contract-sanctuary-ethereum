...
contract VisionaryDeFi is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x1Ddb12F1F64f9Ccbc7facA39AF72d42357E32A7b));
    address payable public _teamwallet =
        payable(address(0xf3D329315D719a299dB9ac1aD6d633F54eA87032));
    address _partnershipswallet =
        payable(address(0x48A7a11A06B4867914809730B1aF96D2eE033Ee9));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "VisionaryDeFi";
    string private _symbol = "VISIONARY";
    ...
    uint256 public _maxTxAmount = 55500 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 555 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 55500 * 10**19 * 10**9;
    ...
    function VisionBox() public onlyOwner {
