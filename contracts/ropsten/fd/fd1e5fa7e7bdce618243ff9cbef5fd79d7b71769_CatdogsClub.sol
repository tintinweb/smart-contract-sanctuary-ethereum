...
contract CatdogsClub is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI) ERC721A("Catdogs Club", "CD") {
    ...
    function airdropNFT(uint256 quantity, address _address) public onlyOwner {
        require(!paused, "The contract is paused!");
