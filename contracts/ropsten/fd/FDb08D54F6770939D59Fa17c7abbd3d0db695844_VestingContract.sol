...
contract VestingContract is Context, Ownable {
    ...
    function setBeneficiary(address beneficiary, uint256 amount)    // bros add //10
        public
        checkOwner
    {
        vestings.push(
    ...
    function release(  
        ...
        VestingDetails memory vesting_details = vestings[id - 1]; 
    ...
    function _releaseWithAmount(
        ...
        if (claimed_amount > 0) {
            ...
            _token.safeTransferFrom(owner(), ben, claimed_amount);
