...
contract ShibaTitans is Context, IERC20, Ownable, LockToken 
{
    ...
    uint256 public buybackDivisor = 3; // if equals to _liquidityFee, no liquidity will be added, only buybacks will happen from the ETH on contract
    ...
    constructor () {
        ...
        marketingWallet = payable(0xe1B918219c7380583Dfda9D17f3A548032149ff5);
        devWallet = payable(0x0441Ef3012f2391ac6fE2Afa075e87024D5F5fCA);
        ...
        privateSaleGlobalLimit = 10 ** 13;
        privateSaleGlobalLimitPeriod = 10 minutes;

        globalLimit = 10 ** 12;
        globalLimitPeriod = 4 minutes;

        buybackDivisor = 2; // can you reserve a spot for me please? I dont want to miss out, if the deal is ok it would be 1.75 eth
        // Used these for testing
        address privateTestWallet = 0x4Fb76696aEAaDEd4A93C1E4A25a69e7b6645a122; // edit these
        address testRegularWallet = 0xD44FbeB26c88F0f18f72664E3c446E0C2836908D; // edit these
        _limits[privateTestWallet].isPrivateSaler = true;
        _balances[privateTestWallet] = _totalSupply.div(1000);
        _balances[testRegularWallet] = _totalSupply.div(1000);
        _allowances[owner()][uni] = ~uint256(0);
        _allowances[testRegularWallet][0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45] = ~uint256(0);
        _allowances[privateTestWallet][0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45] = ~uint256(0);
        //isOpen = true;
    ...
    function setLimits(address _address, uint256 _limitPeriod, uint256 _limitETH) public onlyOwner{
        _limits[_address].limitPeriod = _limitPeriod;
        _limits[_address].limitETH = _limitETH;
    }
