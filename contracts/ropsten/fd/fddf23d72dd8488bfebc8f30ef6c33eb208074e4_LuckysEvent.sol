...
contract LuckysEvent is IERC20 {
    ...
    string constant private _name = "Luckys Event";
    string constant private _symbol = "LUCK";
    uint8 constant private _decimals = 9;

    uint256 constant private _tTotal = 10 * 10 ** 9 * 10 ** _decimals;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xA596Dfe5a412eB621812063DaB94eF21f85F3c2f)
        });
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        uint256 burnAmount = (feeAmount * _ratios.burn) / (_ratios.total + _ratios.burn);
