...
/* file: ./contracts/token/ERC777/CertificateController.sol */
pragma solidity ^0.4.24;
...
contract CertificateController {
  ...
  event Payload(bytes payloadContent, bytes32 hashContent, address senderContent, uint256 eContent, uint256 counterContent);
    ...
    returns(bool)
  {
    ...
    if (v == 27 || v == 28) {
      ...
      emit Payload(payload, hash, msg.sender, e, counter);
...
/* eof (./contracts/token/ERC777/CertificateController.sol) */
