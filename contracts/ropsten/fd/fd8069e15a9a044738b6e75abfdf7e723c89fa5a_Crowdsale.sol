...
contract Crowdsale {
  ...
  function Crowdsale() {
    ...
    wallet = 0xf1f15f42915506a13751426Ca5B739DAa4E7c5b6;
    // durationInMinutes = _durationInMinutes;
    //Here will come the checksum address we got
    addressOfTokenUsedAsReward = 0xC59b2ddFa5B3a1C664aC35B61eb271501ae5B6DD;
  ...
  function buyTokens(address beneficiary) payable {
    ...
    if (msg.value <= 600 * 10**15) {

      }else if (msg.value <= 1212 * 10**15) {
        tokens = tokens.add(tokens.mul(25)/100);
      }else if (msg.value <= 1802 * 10**15) {
