...
contract BreedingRouter is Ownable, Pausable, ERC721Holder, ReentrancyGuard {
    ...
    uint256 public itemPrice = 200 * 1e18;
    uint256 public dripCost = 200 * 1e18;
    ...
    function setDripCost(uint256 _cost) external onlyOwner {
        dripCost = _cost;
    }
    ...
    function setItemPrice(uint256 _cost) external onlyOwner {
        dripCost = _cost;
    }
