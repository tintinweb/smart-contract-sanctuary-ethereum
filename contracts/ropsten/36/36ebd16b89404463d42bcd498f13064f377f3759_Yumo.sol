...
contract Yumo {
    ...
    address public yDistribution_address;
    ...
    constructor(address _wallet, address _manager_address, address _yDistribution) public {
        ...
        yDistribution_address = _yDistribution;
        currentRound = 0;
    ...
    function gameOver() public {
        ...
        if (remainETH > 0)
        {
            yDistribution_address.transfer(remainETH);
        ...
        {
            teamWallet.transfer(address(this).balance.sub(ethReserverForToken).sub(ethReserverForWithdraw));
        }
    ...
    function distribute(uint256 albums, uint team, address referredAddress) private {
        ...
        yDistribution_address.transfer(feeYDist);
