...
contract UdpnMetaTx is EIP712Base {
   ...
   function registerToken(bytes memory symbol, address contractAddress) external {
   ...
   function getRegisteredToken(uint256 index) external view returns(address contractAddress, bytes memory symbol ){
