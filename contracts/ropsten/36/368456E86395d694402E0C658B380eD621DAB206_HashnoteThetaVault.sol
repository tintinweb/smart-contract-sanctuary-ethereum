...
contract HashnoteThetaVault is HashnoteVault, HashnoteThetaVaultStorage {
     ...
     */
    function setPremiumDiscount(uint256 newPremiumDiscount) external onlyKeeper {
        require(
     ...
     */
    function commitAndClose(uint128 newStrikePrice) external onlyKeeper nonReentrant {
...
library VaultLifecycle {
    ...
    function commitAndClose(
        ...
        require(closeParams.strikePrice != 0, "!strikePrice");
    ...
    function getOrDeployOtoken(
        ...
        // console.log("strikePrice", closeParams.strikePrice);
