...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    string public baseURI = "ipfs://QmNypCdyKDtLPUZDAGDT3D37gofH3zLt6SsgwMFahggXHE";
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI2).length > 0 ? string(abi.encodePacked(baseURI2, tokenId.toString())) : "";
    }
