...
contract TEST is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 5000000 * (10**18); // 0.5% of total supply
    uint256 public maxBuyTransactionAmount = 5000000 * (10**18); // 0.5% of total supply
    ...
    constructor() ERC20("Test Name", "TEST1") {
