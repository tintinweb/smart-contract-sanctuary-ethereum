...
import "./interfaces/IDistributionContract.sol";
...
contract DistributionContract is IDistributionContract, Ownable {
     ...
     */
    function lockRewards(bool lock) external override onlyOwner {
     ...
     */
    function addBeneficiary(address beneficiary, uint256 amount) public override onlyOwner {
