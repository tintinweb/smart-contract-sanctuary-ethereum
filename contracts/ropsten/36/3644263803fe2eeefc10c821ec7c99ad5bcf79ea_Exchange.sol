...
// File: contracts/defi_exchange.sol
...
contract Exchange is ERC20 {
    ...
    constructor(address _CryptoDevtoken) ERC20("Musto LP Token", "MLPT") {
    ...
    function addLiquidity(uint _amount) public payable returns (uint) {
        ...
        */
        if(cryptoDevTokenReserve == 0) {
            ...
            cryptoDevToken.transferFrom(msg.sender, address(this), _amount * 100);
