...
contract TrustDeToken is PausableToken {

  string public constant name = "TrustDe Token"; // solium-disable-line uppercase
  string public constant symbol = "XTD"; // solium-disable-line uppercase
