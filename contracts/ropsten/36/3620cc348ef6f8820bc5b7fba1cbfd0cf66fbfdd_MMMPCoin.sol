...
contract MMMPCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MMMPCoin() {
        ...
        name = "MMMPCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MMMPC";                                             // Set the symbol for display purposes (CHANGE THIS)
