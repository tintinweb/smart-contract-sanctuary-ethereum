...
contract Mani is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function Mani() {
        ...
        name = "Mani";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MNI";                                             // Set the symbol for display purposes (CHANGE THIS)
