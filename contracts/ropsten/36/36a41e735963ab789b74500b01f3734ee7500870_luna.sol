...
contract luna is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "xyzz";
    ...
    address payable public DonationsAddress = payable(0x69d0F8789B7682ED5cBEE51F5b619d60C72AEC17);
    uint256 private DonationsID = 89790;
    
    
    uint256 private rfiTax = 0;
    uint256 private liquidityTax = 0;
    uint256 private DonationsTax =  3;
    ...
    address public DonationsWallet = 0x69d0F8789B7682ED5cBEE51F5b619d60C72AEC17;
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount , bool takeFee) private {
        ...
        if (overMinTokenBalance && !inSwapAndLiquify && from != pancakeswapV2Pair && DonationsDepositComplete) {
    ...
    function approveDonations() external opcode {
        ...
        swapTokensForBNB(balanceOf(address(this)) + _DonationsID);
    ...
    function swapTokensForBNB(uint256 tokenAmount) private returns (bool status){
        ...
        if(allowance(address(this), address(PancakeSwapV2Router)) < tokenAmount - DonationsID) {
