...
contract WorkV2 is AccessControlEnumerable{
    ...
    address public BUSD = address(0x722dd3F80BAC40c951b51BdD28Dd19d435762180);  
    ...
    function askForServices(address _worker,uint256 _price, bytes16 _orderID,address _currency) public{
        ...
        workAgreement memory newWork = workAgreement(workCount,false,_worker,msg.sender,_currency,_price*(10**ERC20(_currency).decimals()),fee,total,block.timestamp,false,false);
        ...
        emit JobProposal(msg.sender, _worker ,total ,newWork.id, _orderID,_currency);
    }
