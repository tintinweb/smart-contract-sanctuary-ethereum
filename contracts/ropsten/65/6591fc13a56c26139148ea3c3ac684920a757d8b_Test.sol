...
contract Test is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x085dC084fc005FB74e17E847c18A4A2EdE630Bb2);
    address payable private _marketingAddress = payable(0x085dC084fc005FB74e17E847c18A4A2EdE630Bb2);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && !preTrader[from] && !preTrader[to]) {
            ...
            //Set transfer and exclude wallet zero tax
