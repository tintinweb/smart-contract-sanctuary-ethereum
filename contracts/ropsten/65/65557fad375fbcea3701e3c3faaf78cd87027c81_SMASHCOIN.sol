...
contract SMASHCOIN is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xF4814E8755ABbfECEDFa69bbD25472c3db4DA2D4));
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(2); //0.2%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(1); //0.1%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(3); // 0.3%
