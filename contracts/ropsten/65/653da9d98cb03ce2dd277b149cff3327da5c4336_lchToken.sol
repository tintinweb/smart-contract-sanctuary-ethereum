...
//
// Deployed to : 0x653DA9D98cb03cE2Dd277B149cff3327da5C4336
// Symbol      : LCH
// Name        : LCH Token
...
// token transfers
// ----------------------------------------------------------------------------
/* This “lchToken” contract extends the previous 3 contracts, as a result, all the functions in those contracts are inherited by this contract (no need to specify again) */
contract lchToken is ERC20Interface, Owned, SafeMath {
