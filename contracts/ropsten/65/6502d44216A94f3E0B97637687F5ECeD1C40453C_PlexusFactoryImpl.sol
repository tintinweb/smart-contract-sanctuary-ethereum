...
contract PlexusFactoryImpl {
    ...
    function createPool(
        ...
        bytes memory bytecode = type(PlexusPairImpl).creationCode;
    ...
    function pairCodeHash() external pure returns (bytes32) {
        return keccak256(type(PlexusPairImpl).creationCode);
    }
...
contract PlexusPairImpl {
    ...
    function swap(
        ...
        require(fee == 30 || fee == 100 || fee == 1 || fee == 5, "Not a normal pair");
        // fee 수수료 설정 부분
        {
