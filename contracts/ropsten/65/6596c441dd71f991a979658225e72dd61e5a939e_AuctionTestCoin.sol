...
contract AuctionTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
	...
	constructor()public {
        ...
        name = "AuctionTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TESAUC";                                             // Set the symbol for display purposes (CHANGE THIS)
    ...
    function approveAndCall(address _spender, uint256 _value, bytes _extraData) returns (bool success) {
        ...
        if(!_spender.call(bytes4(bytes32(keccak256("receiveApproval(address,uint256,address,bytes)"))), msg.sender, _value, this, _extraData)) { revert('Error'); }
        return true;
    }
}