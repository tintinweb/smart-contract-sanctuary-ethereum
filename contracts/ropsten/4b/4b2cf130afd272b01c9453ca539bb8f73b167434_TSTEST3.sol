...
contract TSTEST3 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TSTEST3() {
        ...
        name = "TSTEST3";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TSTEST3";                                             // Set the symbol for display purposes (CHANGE THIS)
