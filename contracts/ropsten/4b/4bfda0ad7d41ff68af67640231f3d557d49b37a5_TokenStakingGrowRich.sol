...
contract TokenStakingGrowRich is Context, Ownable, ReentrancyGuard {
    ...
    uint256 private _stakingStartTime = block.timestamp + 86400;
    uint256 public constant stakingWindowTimeLimit = 172800;
    uint256 public constant stakingDurationTimeLimit = 864000;
    uint256 public constant claimingDurationTimeLimit = 86400;
    ...
    event TotalGrowRichUpdated(uint256);
    event UserGrowRichUpdated(uint256);
        ...
        onlyBeforeStakingDurationEnd
    {
        ...
        emit TotalGrowRichUpdated(totalBalanceGrowRich());
        emit UserGrowRichUpdated(balanceOf(to));
    }
    ...
    function stakeTokens(uint256 amount) external onlyInStakingWindow {
        ...
        emit TotalGrowRichUpdated(totalBalanceGrowRich());
        emit UserGrowRichUpdated(balanceOf(from));
    }
    ...
    function _stakeTokens(address from, uint256 amount) private {
        ...
        require(
            ...
            "TokenStakingGrowRich: GrowRich transferFrom not succeeded"
        );
    }
    ...
    function _unstakeTokens(address to, uint256 amount) private {
        ...
        require(
            ...
            "TokenStakingGrowRich: GrowRich transfer not succeeded"
        );
    }
    ...
    function claimRewards() external onlyAfterStakingDurationEnd nonReentrant {
        ...
        emit TotalGrowRichUpdated(totalBalanceGrowRich());
        emit UserGrowRichUpdated(balanceOf(beneficiary));
    }
    ...
    function _claimRewards(address beneficiary) private returns (uint256) {
        ...
        require(
            ...
            "TokenStakingGrowRich: USDC transfer not succeeded"
        );
