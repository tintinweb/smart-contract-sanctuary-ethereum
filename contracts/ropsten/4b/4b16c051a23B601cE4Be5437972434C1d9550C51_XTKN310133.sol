...
contract IXTKN310133Liquidity{
    function init() public{}
    function getPair() public returns(address){}
}


contract IXTKN310133Project{
    function init() public{}
...
contract IXTKN310133StakingLocked{
    function init(uint256, uint256) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN310133PreSale{
    function init(uint256, address) public{}
    function balanceOf(address) public view returns(uint256){}
}


contract IXTKN310133Lottery{
...
*/
contract XTKN310133 is Context, IERC20, Ownable, RobinHood, Native, ReentrancyGuard{
    // public properties
        // lib
        ...
        // interfaces
            ...
            IXTKN310133Liquidity private _liquidity;
            IXTKN310133Project private _project;
            IXTKN310133Staking private _staking;
            IXTKN310133StakingLocked private _staking30D;
            IXTKN310133StakingLocked private _staking90D;
            IXTKN310133StakingLocked private _staking180D;
            IXTKN310133StakingLocked private _staking365D;
            IXTKN310133PreSale private _preSale;
            IXTKN310133Lottery private _lottery;
    ...
    // private properties
        ...
        // how our token is setup, standard one billion tokens, but with 9 decimals
            string private _name = "XTKN310133"; // the name of our project
            string private _symbol = "XTKN310133";
    ...
    function initLiquidity(address contractAddress) public onlyOwner{
        if(!_contractLiquidityActive){
            ...
            if(ADDRESS_LIQUIDITY.balance > 0){
                ...
                // init contract
                _liquidity = IXTKN310133Liquidity(ADDRESS_LIQUIDITY);
                _liquidity.init();
    ...
    function initProject(address contractAddress) public onlyOwner{
        if(!_contractProjectActive){
            ...
            // init contract
            _project = IXTKN310133Project(ADDRESS_PROJECT);
            _project.init();
    ...
    function initStaking(
        ...
        if(!_contractStakingActive){
            ...
            // init contract
            _staking = IXTKN310133Staking(ADDRESS_STAKING);
            _staking.init();
            
            _staking30D = IXTKN310133StakingLocked(ADDRESS_STAKING_DAYS30);
            _staking30D.init(1643589207, 30);

            _staking90D = IXTKN310133StakingLocked(ADDRESS_STAKING_DAYS90);
            _staking90D.init(1643589207, 90);

            _staking180D = IXTKN310133StakingLocked(ADDRESS_STAKING_DAYS180);
            _staking180D.init(1643589207, 180);

            _staking365D = IXTKN310133StakingLocked(ADDRESS_STAKING_DAYS365);
            _staking365D.init(1643589207, 365);
    ...
    function initPreSale(address contractAddress, address contractVault) public onlyOwner{
        if(!_contractPreSaleActive){
            ...
            // init contract
            _preSale = IXTKN310133PreSale(ADDRESS_PRESALE);
            _preSale.init(1643669999, ADDRESS_PRESALE_VAULT);
    ...
    function initLottery(address contractAddress) public onlyOwner{
        if(!_contractLotteryActive){
            ...
            // init contract
            _lottery = IXTKN310133Lottery(ADDRESS_LOTTERY);
            _lottery.init(1643589207);
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "[xtkn310133] approve from the zero address");
        require(spender != address(0), "[xtkn310133] approve to the zero address");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public returns(bool){
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "[xtkn310133] decreased allowance below zero"));
        return(true);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns(bool){
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "[xtkn310133] transfer amount exceeds allowance"));
        return(true);
    }
    ...
    function price() public view returns(uint256){
        require(_contractLiquidityActive, "[xtkn310133] no liquidity, no price!");
    ...
    function _transfer(address pFrom, address pTo, uint256 pAmount) private{
        ...
        if(pFrom == ADDRESS_PAIR){
            require(SWAPPING_ENABLED, "[xtkn310133] trading disabled during presale!");
