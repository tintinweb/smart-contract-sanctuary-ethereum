...
// File: contracts/UniswapV3Math.sol
...
library UniswapV3Math {
    function getSqrtTwapX96(IUniswapV3Pool pool, uint32 twapInterval) public view returns (uint160 sqrtPriceX96) {
        if (twapInterval == 0) {
    ...
    IOracle
{
    ...
    function getPrice(address tokenAddressA, address tokenAddressB) external override view returns (uint256 price) {
