...
contract beggerNFT is ERC721, Ownable{
    ...
    constructor() payable ERC721("BeggerNFT","NB"){
    ...
    function mint(uint256 _mintQuantity) public payable{
        ...
        require(msg.value == _mintQuantity * mintPrice, "wrong mint value");
        require(totalSupply + _mintQuantity <= maxSupply,"sold out!" );
        require(walletMints[msg.sender]+_mintQuantity <= maxPerWallet, "exceed max per wallet");
        //require(_mintQuantity < maxPerWallet, "the max mints is 3 per wallet");
