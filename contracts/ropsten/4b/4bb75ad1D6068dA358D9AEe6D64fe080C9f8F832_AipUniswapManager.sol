...
library PoolAddress {
    bytes32 internal constant POOL_INIT_CODE_HASH =
        0xae6e5f3c92bdb62b64d84cd9da61bd78e654ed1aac766e05443c9442fe626b76;
        ...
        for (uint256 i = 0; i < 3; i++) {
            ...
            if (_isContract(poolAddress)) {
                ...
                if (_L > L) {
                    ...
                    price = (uint256(_sqrtPriceX96)
                        .mul(uint256(_sqrtPriceX96))
                        .mul(1e18) >> (96 * 2));
                }
            }
        }
