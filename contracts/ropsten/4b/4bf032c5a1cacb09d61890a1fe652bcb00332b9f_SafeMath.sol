...
/**
   ...
   I will renounce the ownership to burn addresses to transfer #PAO to the community, make sure it's 100% safe.
...
contract PardDAO is Context, ITRC20, Ownable {
    ...
    string private _name = 'TestPardDAO';
    string private _symbol = 'TPAO';
