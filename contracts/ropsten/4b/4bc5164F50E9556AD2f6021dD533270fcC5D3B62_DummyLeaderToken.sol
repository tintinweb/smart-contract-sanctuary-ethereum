...
contract DummyLeaderToken is ERC20, ERC20Burnable, Ownable, Mintable {
    uint256 public totalBurn = 0;

    constructor() ERC20('Dummy Leader Deployment', 'DUMMYLEADER') {
    ...
    function doNotBuy() public pure {
        revert("This is dummy token used for leader deployment");
    }
}
