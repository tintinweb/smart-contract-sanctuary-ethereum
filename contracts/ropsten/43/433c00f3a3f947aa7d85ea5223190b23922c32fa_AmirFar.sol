...
contract AmirFar is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("amirFar", "AM") ERC20Permit("amirFar") {
        _mint(msg.sender, 1888 * 10 ** decimals());
    }
