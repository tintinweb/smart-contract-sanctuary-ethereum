...
contract KLUB is ERC20, Ownable {
  using SafeMath for uint256;
  ...
  uint256 public constant FINAL_SUPPLY = 5_000_000_000 ether;
  ...
  uint256 public accumulatedTeam = 0;
  uint256 public accumulatedRewards = 0;
  uint256 public accumulatedLiq = 0;
  uint256 public accumulatedBBB = 0;

  uint256 public gasLimit = 300_000; // GAS FOR REWARDS PROCESSING
  uint256 public swapThreshold = 500_000 ether; // CONTRACT SWAPS TO BSD

  uint16 public constant BUY_TEAM = 2;
  uint16 public constant BUY_LIQ  = 2;
  uint16 public constant BUY_BBB  = 0;
  uint16 public constant BUY_DIV  = 2;
  uint16 public constant FEE_TO_BUY = 6;

  uint16 public constant SELL_TEAM = 5;
  uint16 public constant SELL_LIQ  = 4;
  uint16 public constant SELL_BBB  = 1;
  uint16 public constant SELL_DIV  = 4;
  uint16 public constant FEE_TO_SELL = 14;

  uint16 public constant TRF_TEAM = 3;
  uint16 public constant TRF_LIQ  = 1;
  uint16 public constant TRF_BBB  = 1;
  uint16 public constant TRF_DIV  = 0;
  uint16 public constant FEE_TO_TRF = 5;
  ...
  constructor() ERC20("Koalas Club", "BLUB") {
  ...
  function _transfer(address from, address to, uint256 amount) internal override {
    ...
    if ( taxFee[from] || taxFee[to] || isPresale[from] ){
        ...
        _setBalances(from, address(this), taxTotal);  // keep tax amount in cointract
        amount -= taxTotal;
      }
  ...
  function distributeTaxes() public  {
            ...
            swapping = true;
            _setBalances(address(this), BBBWallet, accumulatedBBB);
            accumulatedBBB = 0;
