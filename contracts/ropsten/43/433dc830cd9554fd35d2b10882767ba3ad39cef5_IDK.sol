...
contract IDK {
    ...
    string public symbol = "IDK2";
    uint8 constant public decimals = 18;
    uint8 constant internal dividendFee_ = 10; // 10% dividend fee on each buy and sell
    uint8 constant internal charityFee_ = 1; // 1% charity fee on each buy and sell
    uint256 constant internal tokenPriceInitial_ = 0.00000001 ether;
    uint256 constant internal tokenPriceIncremental_ = 0.000000001 ether;
    uint256 constant internal magnitude = 2**64;

    // Address to send the charity  ! :)
    // https://etherscan.io/address/0x2786ec40cB6797c9c6856101DA1686C3258BE9D3
   ...
   /*================================
    ...
    // Special IDK Platform control from scam game contracts on IDK platform
    mapping(address => bool) public canAcceptTokens_; // contracts, which can accept IDK tokens
    ...
    */
    ...
    /**
     * Sends charity money to the idk2 pool
     * Their charity address is here https://etherscan.io/address/0x2786ec40cB6797c9c6856101DA1686C3258BE9D3
     */
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
      ...
      require(canAcceptTokens_[_to] == true); // security check that contract approved by IDK platform
    ...
    /**
     * Add or remove game contract, which can accept IDK tokens
     */
