...
contract EineSignsV2 is ERC721A, Administrated {
    ...
    event whitelistBuy(uint256 amount, address buyer);
    event Buy(uint256 amount, address buyer);

    constructor(
        ) ERC721A("Eine Signs", "EINES") {
        maxSupply = 10000;
        signer = 0xaD4707AEc9B7a48D21E5915bFa878032cEa8737c;
    }
     ...
     */
    function setSaleStarted(bool started) external onlyAdmin {
        saleStarted = started;
    }
    ...
    function presaleBuy(
        ...
        uint256 totalPrice = amount * presalePrice;
        ...
        emit whitelistBuy(amount, msg.sender);
    }
