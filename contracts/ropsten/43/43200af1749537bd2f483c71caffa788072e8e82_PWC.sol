...
// Dependency file: contracts/rk/IterableMapping.sol
...
// Dependency file: contracts/rk/PWCDividendTracker.sol
...
// import "contracts/rk/IterableMapping.sol";
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeRKDividends(uint256 amount) public onlyOwner {
...
contract PWCDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PWC contract."
        );
    }
...
// Root file: contracts/rk/PWC.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/rk/PWCDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract PWC is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    PWCDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        uint256 totalSupply_,// rewards, liquidity, marketing
        uint256 minimumTokenBalanceForDividends_
    ) payable ERC20(name_, symbol_) {
        rewardToken = 0x6B637dEbC8da27283E7e5b848d1819A99bd81ABd;
        _marketingWalletAddress = 0x991aE03D4d7EF9B1CaeCdc45E4FaD56cFe5c928b;
        require(
        ...
        dividendTracker = PWCDividendTracker(
            payable(Clones.clone(0xb236a9fbf8431798f160e62A8C85962D910a421C))
        );
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "PWC: The dividend tracker already has that address"
        );

        PWCDividendTracker newDividendTracker = PWCDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "PWC: The new dividend tracker must be owned by the PWC token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "PWC: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "PWC: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "PWC: The PanRKSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "PWC: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "PWC: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "PWC: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialRKBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForRK(tokens);
    ...
    function swapTokensForRK(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeRKDividends(dividends);
