...
/*This is demo crowdsale contract. Uses basic functions only. Not intended for usage in production*/
...
contract Crowdsale {
    ...
    internal view returns (uint256)
  {
    ...
    uint256 bonusTokens = tokens.mul(_bonus).div(100);
