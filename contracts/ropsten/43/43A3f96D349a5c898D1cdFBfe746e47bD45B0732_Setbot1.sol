...
contract Setbot1 is Context, IERC20, Ownable {
	...
	string private constant _name = "Setbot1";
	string private constant _symbol = "Setbot1";
	...
	function unblockBot(address notbot) private onlyOwner {
			bots[notbot] = false;
	}
