...
contract YummyBase is ERC721BasicToken {
    ...
    */
    ...
    event TokenCreation(address owner, uint256 tokenId, uint256 dna, uint8 species);
    ...
    */
        ...
        returns (uint)
    {
        ...
        emit TokenCreation(_owner, newTokenId, _dna, uint8(_species));
...
contract YummyBreeding is YummyBase {
    ...
    */
    ...
    /**
    * @dev Internal utility functions (assumes inout is valid)
    */
