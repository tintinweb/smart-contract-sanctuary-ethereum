...
contract MotherContract {
  ...
  function createPool(uint256 amount, string memory name, address base) public payable{
    LiquidityPool pool;
...
contract LiquidityPool is Initializable, OwnableUpgradeable {
  ...
  function estimateWithdraw() external view returns (Withdraw memory){
    ...
    /**
   * Returns the amount in base of the balance of all tokens in the pool
   */
   ...
   function approveSwap(address from, address to, uint256 amout) public onlyOwner {
