...
GREATDANE is a crypto meme project created for people by people. It has great tokenomics whereas 2% will reward holders for every transactions, 8% goes to marketing and development, and 3% will go back to liquidity. 

Telegram Portal: https://t.me/GreatDaneToken
Website: GreatDaneToken.net
Twitter: https://twitter.com/GreatDaneToken
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc307a65E82EA9BDbcC97E1f86aA2C6E988A5C80C;
...
contract GreatDane is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf99120CF6a741394d60B643fe23dc0296844b6E8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 3690000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Great Dane";
    string private _symbol = "GREAT";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 80;
    ...
    uint256 public _maxTxAmount = 3690000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 3690000000000 * 10**18;
