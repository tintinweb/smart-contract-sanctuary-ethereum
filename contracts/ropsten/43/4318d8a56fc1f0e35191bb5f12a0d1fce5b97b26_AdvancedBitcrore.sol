...
using SafeMath for uint256;
     ...
     */
     ...
     /**function Lakshmi(uint256 initialSupply,string tokenName,string tokenSymbol) public */
    {
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        require(now >= creationTime + 1 days);
...
using SafeMath for uint256;
    ...
    constructor (
        ...
        string tokenName,
        string tokenSymbol
    ) Bitcrore(initialSupply, tokenName, tokenSymbol) public {}
    
    /*function AdvancedLakshmi(
       * uint256 initialSupply,
       * string tokenName,
        *string tokenSymbol
   * ) Lakshmi(initialSupply, tokenName, tokenSymbol) public {}*/
