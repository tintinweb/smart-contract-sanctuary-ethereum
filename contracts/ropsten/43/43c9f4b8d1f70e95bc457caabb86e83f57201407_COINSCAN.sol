...
contract COINSCAN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Coin Scanner";
    string private constant _symbol = "CSCAN";
    ...
    address payable private _marketingAddress = payable(0xD8F611f3aE837f94929C0A4217262B9e6Bff7199);
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (canSwap && !inSwap && from != uniswapV2Pair && swapEnabled) {
                swapTokensForEth(contractTokenBalance.mul(85).div(100)); // Reserve of 15% of tokens for liquidity
                uint256 contractETHBalance = address(this).balance;
                if (contractETHBalance > 0.2 ether) {
                    addLiquidity(balanceOf(address(this)), contractETHBalance.mul(15).div(100)); // Adding to LP 15% tokens and 15% ETH balance
