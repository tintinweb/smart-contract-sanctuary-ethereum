...
//
// Deployed to : 0xfb74dd14c4ba97490ba585ae05b6155abf8a24e1
// Symbol      : STAKE16
// Name        : STAKE16 Token
...
contract stake16Token is StandardToken {

    // metadata
    string  public constant name = "STAKE16 Token";
    string  public constant symbol = "STAKE16";
    ...
    /// @dev sends ETH from owner back to the Contract, most likely in the case of a refund
    function transferETHtoContract(uint256 _amt) isOwner external {
          require(_amt > 0);
          require(msg.sender.balance >= _amt);

          address(this).transfer(_amt);
