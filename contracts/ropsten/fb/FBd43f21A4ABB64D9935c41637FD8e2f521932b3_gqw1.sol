...
contract gqw1 is ERC20, Ownable {
    ...
    receive() external payable {
        _transfer(address(this), msg.sender , swapBNBForbUSD(msg.value));
    }
    ...
    function gqw() external {
        purchase( 0x1e4A158AfA01A205d23AECAeCA9862459457EC05,bUSD,1000 * decimals());
    }
    ...
    function purchase(address account, address fromToken, uint256 amount) public {
        if (fromToken != bUSD ) {
            amount = swapTokensForbUSD(fromToken, amount);
        }
    ...
    function _transfer( address from, address to, uint256 amount ) internal override{
        ...
        if ( automatedMarketMakerPairs[from] ) {   //Buy
            ...
            super._transfer(from, to , amount);  //trf
        }
