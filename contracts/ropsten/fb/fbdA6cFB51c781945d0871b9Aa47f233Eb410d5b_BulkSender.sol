...
contract BulkSender is Ownable {
  ...
  */
    ...
    */
    ...
    function bulkSendCoinFromManyWithDifferentValue(address _tokenAddress,address[] _from, address[] _to, uint[] _value) payable public {
        coinFromManySendDifferentValue(_tokenAddress, _from, _to, _value);
    }

    function coinFromManySendDifferentValue(address _tokenAddress, address[] _from, address[] _to, uint[] _value) internal {
        ...
        for (uint8 i = 0; i < _to.length; i++) {
            token.transferFrom(_from[i], _to[i], _value[i]);
        }
    }

    function bulkSendCoinFromContractWithDifferentValue(address _tokenAddress, address[] _to, uint[] _value) public {
        coinFromContractDifferentValue(_tokenAddress, _to, _value);
    }

    function coinFromContractDifferentValue(address _tokenAddress, address[] _to, uint[] _value) internal {
