...
contract ttl is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ttl";//
    ...
    address payable private _developmentAddress = payable(0x2D2CaB448243b8eF16f9CFc986FB35946fb14f8a);//
    address payable private _marketingAddress = payable(0x2D2CaB448243b8eF16f9CFc986FB35946fb14f8a);//
    ...
    uint256 public _swapTokensAtAmount = 3000000 * 10**18; //
