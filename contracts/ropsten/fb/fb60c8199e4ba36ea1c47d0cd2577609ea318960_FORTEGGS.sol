...
contract FORTEGGS is ERC20 {
	
    address payable private admin = 0x2123542F8D42CB13ab40220A395F3aE8e6A4D0cE;
    ...
    function buyEGG(uint256 _amount) public payable {
    ...
    token.transferFrom(msg.sender, address(this), _amount);	
		...
		uint numberFort = random.mul(1000000000000000000);
        token.transfer(msg.sender, numberFort);
