...
contract FXTOKEN is WhiteBlockList {
    ...
    // EVENTS
    event RequestBuyswithETH(uint256 amountTokens);
	event RequestBuyswithFX(uint256 amountTokens);
	...
	//function requestBuywithETH(address participant) external payable onlyIfAllowed {
	function buyTo(address participant) public payable onlyIfAllowed {
        ...
        RequestBuyswithETH(tokensToBuy);
    }
