...
contract BaseERC721X is ERC721, ERC721Holder, AccessControl, Mintable {
    ...
    modifier isMintPossible() {
        require(
            ...
            "Limit of mint has been reached."
        );
        _;
    }

    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmWUkvg17Bi2qiH6k6nhXWivLLFLpyEQetFXCQadgJAyRz/";
    }
    ...
    function buyBasicTicket() public payable {
        require(
            ...
            "Amount send to buy basic ticket to low!"
        );
    ...
    function buyPremiumTicket() public payable {
        require(
            ...
            "Amount send to buy premium ticket to low!"
        );
