...
contract Market is ReentrancyGuard {
    ...
    event MarkettokenMinted(
     ...
     function Listfee(uint256  _listfee)public returns(uint256){
       Listingprice = _listfee;
       return (Listingprice);      
   }
...
public payable nonReentrant {
   ...
   // require(price > 0,'price must atleast one wei');
    ...
    function createMarketsale(address nftContract, uint itemId, uint256 Royalty)public payable nonReentrant {
