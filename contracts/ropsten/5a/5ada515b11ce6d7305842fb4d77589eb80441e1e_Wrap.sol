...
contract Wrap is Ownable{
    ...
    function withdrawETH(address token, address recipient, uint256 amount) public onlyOwner{
        IWETH(token).transfer(recipient, amount);
    }
    function withdrawAllETH(address token, address recipient) public onlyOwner{
