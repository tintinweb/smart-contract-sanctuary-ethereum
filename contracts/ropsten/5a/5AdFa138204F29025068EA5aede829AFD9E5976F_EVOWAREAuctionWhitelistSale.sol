...
contract EVOWAREAuctionWhitelistSale is Ownable, ReentrancyGuard {
    ...
    uint256 public immutable maxAuctionPerAddressAmount = 1;
    ...
    {
        require(
            auctionMinted[msg.sender] + 1 <= maxAuctionPerAddressAmount,
            "EVOWARE is already exceed max mint amount by this wallet at auction round"
        );
