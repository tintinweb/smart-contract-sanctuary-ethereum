...
//V4 печатаем один раз двойное количество токенов. Зачисляем на счет Owner потом сразу переводим половину инвестору и половину в команду
//пробуем 2 варианта написания функции transfer
