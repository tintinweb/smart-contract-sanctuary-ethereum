...
contract XPAToken is StandardToken {
        ...
        uint256 _fundingEndBlock) public
    {
        ...
        emit CreateXPA(xpaFundDeposit, tokenCreationCap);    // logs deposit of XPlay Ltd. fund
    }
    ...
    function finalize() onlyOwner external {
        ...
        // move to operational
        isFinalized = true;
        assert(ethFundDeposit.send(address(this).balance));              // send the eth to XPlay ltd.
    }
}