...
contract CraftGem is ERC721A, Ownable, Pausable {
    ...
    function crafting(uint256[] calldata _gemIds) external payable whenNotPaused {
        require(_gemIds.length == 3, 'Needs 3 gems to crafting');
