...
jaredtest Socials:
Telegram: Jared's Amazing SushiTest
Twitter: Jared's Amazing SushiTest
Website: Jared's Amazing SushiTest
Whitepaper: Jared's Amazing SushiTest
...
contract jaredtest is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "jaredtest";
    string private m_Symbol = "JARSHI";
