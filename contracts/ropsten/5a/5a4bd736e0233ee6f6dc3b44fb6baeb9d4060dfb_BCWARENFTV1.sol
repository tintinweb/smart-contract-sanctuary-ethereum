...
// File: contracts/nft_marketplace_eth.sol
...
contract BCWARENFTV1 is ERC721URIStorage {
    ...
    Counters.Counter private _collectbaleIdss;
    ...
    function mintNFT(
        ...
        _collectbaleIdss.increment();
        uint256 newCollectableId = _collectbaleIdss.current();
