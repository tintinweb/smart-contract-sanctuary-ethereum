...
//    function migrateV1(address A1) external onlyOwner returns (bool){
   
//        // for (uint i=0; i< userList.length; i++){

//            // require(userList[i] != address(0),"This is not a valid address");
            
//             User storage user = users[A1];
//             (uint256 _totalstakeduser, uint256 _stakecount, uint256 _claimedstakeTokens) = stakeInstance.users(A1);
...
//                     bool _withdrawan) = stakeInstance.stakedetails(A1,j);
