...
contract TestNetz is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "TestNetz";
    string private _symbol = "TestNetz";
    ...
    address payable public _marketingAddress = payable(address(0x7Ca83D309dC79C3c75b41aAC6F76De26d4db7E11));
    address payable public _devAddress = payable(address(0xfcCe7f072200C7b8D008106A6a550df42FE3eaEa));
