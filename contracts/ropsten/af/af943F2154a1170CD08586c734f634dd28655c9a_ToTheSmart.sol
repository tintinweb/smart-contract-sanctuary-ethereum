...
contract ToTheSmart {
    address busdt = 0xF003a00093187d9CFD83410D9DA067aEC816dF79;
    uint256 public SECONDS_WORK_MINER = 1728000; 
    uint256 PSN = 10000;
    uint256 PSNH = 5000;
    uint256 BONUS_10_BUSD = 10000000; // bonus
    uint256 private mDep = 50000000;  // min dep
    uint256 public Dop = 500000000000; // tvl to 500000 
