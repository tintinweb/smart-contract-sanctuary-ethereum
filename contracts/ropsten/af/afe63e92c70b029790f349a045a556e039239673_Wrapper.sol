...
contract Wrapper is Utils {
    ...
    function getListReserves(KyberNetwork network, ERC20 token) public view returns(uint srcCount, uint destCount, address[] memory src, address[] memory dest) {
        ...
        return (srcCount, destCount, src, dest);
    }
}