...
/**
 * @title VicesimalNoncommunity
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract VicesimalNoncommunity is ERC20Permit, Forwarder, ERC20Capped, ERC20FlashMint, Ownable {

    constructor() ERC20("Vicesimal Noncommunity","IOM") ERC20Capped(1000000000 * (10**uint256(decimals()))) { 
     }
     ...
     * - `account` cannot be the zero address.
     */
     function mint(address account, uint256 amount) public onlyOwner onlyParent {
