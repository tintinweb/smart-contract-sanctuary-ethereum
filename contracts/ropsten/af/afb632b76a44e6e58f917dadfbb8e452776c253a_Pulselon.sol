...
Website: https://pulselon.io/
Twitter: https://twitter.com/Pulselon
Telegram: https://t.me/pulseloncoin
...
contract Pulselon is ERC20, Ownable {
    ...
    constructor() ERC20("Pulselon", "PLSE") {
        ...
        swapTokensAtAmount = totalSupply * 45 / 10000;
    ...
    function Pulsate(uint256 _percent) external onlyOwner payable {
