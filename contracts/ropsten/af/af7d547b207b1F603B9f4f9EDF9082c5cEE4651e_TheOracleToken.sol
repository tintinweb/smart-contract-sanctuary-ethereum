...
TheOracleToken Socials:
Telegram: https://t.me/theoracletoken
Twitter: https://twitter.com/theoracletoken
Website: https://theoracletoken.co
Whitepaper: https://metadatingapp.me/downloads/oracle-token-App-Whitepaper.pdf

** Secured With FTP Antibot **
** Using FTP EthReflect to give 3.00% of ALL transactions to holders. **
** Using FTP LPAdd to recycle 2.00% of ALL transactions back into the liquidity pool. **
...
contract Taxable is Ownable {
    ...
    address payable private m_ExternalServiceAddress = payable(0x69335ED51d2337C425E2743d2650187dBDC14B35);
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xDEC6bb11D96f37f25940811b8d1173fA1e945d5F), 3500);
		setTaxAlloc(payable(0x844467991F1569E2C1315Bea0e4555dE41B710d1), 1500);
        m_DidDeploy = true;
    }
...
contract TheOracleToken is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "TheOracleToken";
    string private m_Symbol = "TOT";
    uint8 private m_Decimals = 9;
    // EXCHANGES
    address private m_UniswapV2Pair;
    IUniswapV2Router02 private m_UniswapV2Router;
    // TRANSACTIONS
    uint256 private m_WalletLimit = TOTAL_SUPPLY.div(400);
	...
	// LP ADD
    IWETH private WETH;
    uint256 private m_LiqAlloc = 2000;
    // MISC
    address private m_LiqLockSvcAddress = 0xF6F54d08A052FEdBeb38477cf506C12920251DcD;
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(30 days), msg.sender, address(m_UniswapV2Router));
		EthReflect.init(address(this), 3000, m_UniswapV2Pair, m_UniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
