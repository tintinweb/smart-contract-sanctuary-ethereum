...
contract MuneebCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MuneebCoin() {
        ...
        name = "MuneebCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT-081";                                             // Set the symbol for display purposes (CHANGE THIS)
