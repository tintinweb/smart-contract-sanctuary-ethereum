...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 dev, uint16 floorSupport) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.dev = dev;
        _ratios.floorSupport = floorSupport;
        _ratios.totalSwap = liquidity + marketing + dev + floorSupport;
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        uint256 floorSupportBalance = (amtBalance * ratios.floorSupport) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - (devBalance + floorSupportBalance);
