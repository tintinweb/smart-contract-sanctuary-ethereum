...
contract ElonGate is ERC20Upgradeable, OwnableUpgradeable {
    ...
    */
    ...
    /**
        ...
        and exclude from fee owner and elongate contract addresses.
        Set default  _liquidityFee = 5%, _taxfee = 0% 
    ...
    */
    ...
    /**
        ...
        Or withdraw of elongate tokens in case if swapAndLiquifyEnabled is disable
    ...
    */
    ...
    /**
        ...
        @dev add approve and liquidity in MATIC tokens
        @param tokenAmount - amount of tokens for approve and liquidity
        @param maticAmount - amount of MATIC for call functions for add liquidity
    */
