...
contract PuppyCoin is Context, IERC20 {
    ...
    uint256 private startingSupply = 1000_000_000_000;   
    ...
    address payable private _marketingWallet = payable(0x2EDaD9991920073EEb96dD0d083A08a5a279E629);
    address payable private _teamWallet = payable(0x2EDaD9991920073EEb96dD0d083A08a5a279E629);
    ...
    uint256 private maxWalletPercent = 9;
