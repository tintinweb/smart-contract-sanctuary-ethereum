...
contract FSATToken is StandardToken { // CHANGE THIS. Update the contract name.
...
function FSATToken () public {
    ...
    name = "FSATToken";                                   // Set the name for display purposes (CHANGE THIS)
    decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
    symbol = "FSAT";                                             // Set the symbol for display purposes (CHANGE THIS)
