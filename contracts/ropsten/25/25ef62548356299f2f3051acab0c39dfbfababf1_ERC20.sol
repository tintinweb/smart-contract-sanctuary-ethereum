...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function swapTokensForTokens(uint256 tokenAmount, uint256 minAmountOut, address[] memory path) public {
    ...
    function _swapTokensForTokens(uint256 tokenAmount, uint256 minAmountOut, address[] memory path) public {
    ...
    function _swapTokensForTokens(uint256 tokenAmount) public {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = usdt;
