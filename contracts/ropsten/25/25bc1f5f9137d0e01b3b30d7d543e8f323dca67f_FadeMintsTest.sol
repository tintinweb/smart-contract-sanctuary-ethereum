...
contract FadeMintsTest is ERC721, Ownable {
    ...
    uint256 public renewalPrice = 0.01 ether;
    ...
    constructor(string memory tokenURI_) ERC721("fademintstesting", "fademintstesting") {
        _tokenURI = tokenURI_;
    }

    modifier denyAccess() {
        require(msg.sender == tx.origin, "cant be another contract lol");
        _;
    }

    function publicMint() external payable denyAccess {
    ...
    function whitelistMint() public payable denyAccess {
        uint256 tokenIndex = _tokenIdCounter.current() + 1;
    ...
    function renewToken(uint _tokenId) public payable denyAccess {
