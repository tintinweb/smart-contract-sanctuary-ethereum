    ...
    ComptrollerStorage
{
    ...
    function mintAllowed(
        ...
        require(markets[zBond].isListed, "market is not listed");
    ...
    function redeemAllowed(
        ...
        redeemAllowedInternal(zBond, redeemer, redeemTokens);
    }
    ...
    */
    ...
    function calculateLiquidationAmount(
        ...
        Exp memory nftCollateralFactor = Exp({
            mantissa: markets[address(ZNft)].collateralFactorMantissa
        });
    ...
    function liquidateBorrowAllowed(
        ...
        require(
            id.length == 1,
            "Comptroller: Cannot only liquidate 1 NFT a time."
        );
        ...
        require(
            ...
            "Insufficient shortfall to liquidate or not overdue."
        );
    }
    ...
    function transferAllowed(
        ...
        redeemAllowedInternal(zBond, src, transferTokens);
    }
    ...
    function changeSequenceOfLiquidation(
        ...
        require(markets[address(ZNft)].isListed, "NFT not supported");
    ...
    function _setCollateralFactor(
        ...
        require(
            greaterThanExp(highLimit, newCollateralFactorExp),
    ...
    ZBondStorage
{
    ...
    function redeemInternal(uint256 amountOut) internal returns (uint256) {
        require(
            underlying.balanceOf(address(this)) > 0,
            "No underlying tokens to redeem in the lending pool."
        );
        // effects
