...
contract FamousFuckingFrens is Ownable, ERC721A  { 
  ...
  uint256 private WL_MAX_NO_PL_ONE = 9;
  bool public _paused = true;   
  bool public _paused2 = true;   
  bool public _pausedWL = true;  

  address f1 = 0x643d8Ace169b2415bD9F6445863d4182b4f80925; 
  ...
  function giveAway(address _to, uint256 _amount) external onlyOwner() {
      ...
      require( supply + _amount < 8889,  "1" ); 
      mintedAddress[msg.sender] += _amount; 
      _safeMint(_to, _amount);
  } 
  function Allowlist(uint256 num, bytes memory signature, string memory nonce) public payable  {
      uint256 supply = totalSupply();  
      require( !_pausedWL, "1" );
      require( supply + num < 8889,"Exceeds maximum Frens supply" );
      require( num < 9, "You can mint a maximum of 8 Frens" );  
      require( matchAddresSignature(hashTransaction(msg.sender, num, nonce), signature),   "4");
      require(!_mintedNonces[nonce], "5");  
      require(mintedAddress[msg.sender] + num < WL_MAX_NO_PL_ONE, "8 per wallet");
      require( msg.value >= _price * num,"6" ); 
      mintedAddress[msg.sender] += num; 
      _safeMint(msg.sender, num); 
      _mintedNonces[nonce] = true;  
  }  
  function Mint(uint256 num) public payable notContract {
      uint256 supply = totalSupply(); 
      require( !_paused, "1" );
      require( num < 9, "You can mint a maximum of 8 Frens" );
      require( supply + num < 8889, "Exceeds maximum Frens supply" );
  ...
  function Mint2(uint256 num) public payable notContract {
      uint256 supply = totalSupply(); 
      require( !_paused2, "1" );
      require( num < 9, "You can mint a maximum of 8 Frens" );
      require( supply + num < 8889, "3" );
      require( msg.value >= _price * num, "4" ); 
      mintedAddress[msg.sender] += num; 
      _safeMint(msg.sender, num);
  } 
  ...
  function pause2(bool val) public onlyOwner {
      _paused2 = val;
  } 
  ...
  function withdrawAll() public payable onlyOwner {
      uint256 _e = address(this).balance;
      require(payable(f1).send(_e));
  }   
