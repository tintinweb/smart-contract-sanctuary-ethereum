...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    function _transfer(
        ...
        require(!frozenAccount[_msgSender()], "Account is freeze");
...
abstract contract BEP20Mintable is Context, BEP20, Ownable {
 ...
 function freezeAccount(address target, bool freeze) public virtual onlyOwner{
...
contract TRONXP is BEP20,Ownable,BEP20Burnable,BEP20Mintable {


    constructor()
         BEP20("TRONTOKEN", "TRTT", 18) {
             /* 750 Million Total Supply */
            _mint(msg.sender, 10 * (10 ** uint256(6)) * (10 ** uint256(18)));
        }
