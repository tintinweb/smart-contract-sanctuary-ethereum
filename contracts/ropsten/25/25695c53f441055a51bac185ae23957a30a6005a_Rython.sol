pragma solidity 0.4.25;
 /**
    ...
    contract TokenERC20 {
        ...
        using SafeMath for uint256;
        string public name = "Rython";
        string public symbol = "RYTN";
        uint8 public decimals = 18;         // 18 decimals is the strongly suggested default, avoid changing it
        uint256 public totalSupply          = 10000000000 * (1 ether);   
        uint256 public tokensForCrowdsale   = 4.5000000000 * (1 ether);
        uint256 public tokensForTeam        = 1500000000  * (1 ether);
        uint256 public tokensForOwner       = 1000000000  * (1 ether);
        
        address public teamWallet = 0x0F48772F2769CEF8F965a18B27086498feD68073;
        ...
        constructor() public {
            ...
            balanceOf[this] = tokensForCrowdsale;          // 4.5 Billion will remain in contract for crowdsale
            balanceOf[teamWallet] = tokensForTeam;         // 1.5 Billion will be allocated to Team
    ...
    contract Rython is owned, TokenERC20 {
        ...
        uint256 public exchangeRate = 15000000; // this is how many tokens for 1 Ether
