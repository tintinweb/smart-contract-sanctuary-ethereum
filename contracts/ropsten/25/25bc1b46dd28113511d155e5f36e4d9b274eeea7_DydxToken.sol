  ...
  Ownable
{
  ...
  string internal constant NAME = 'CUS_dydx';
  string internal constant SYMBOL = 'CUS_dydx';
  ...
  uint256 public constant MINT_MIN_INTERVAL = 0 days;
    ...
    ERC20(NAME, SYMBOL)
  {
   ...
   uint256 transfersRestrictedBefore=block.timestamp + 1;
   uint256 transferRestrictionLiftedNoLaterThan=block.timestamp + 1;
   uint256 mintingRestrictedBefore=block.timestamp+1;
