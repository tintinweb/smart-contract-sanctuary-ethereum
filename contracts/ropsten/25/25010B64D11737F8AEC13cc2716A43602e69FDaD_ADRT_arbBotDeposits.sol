...
mapping(address => uint) public ETHdepositsOf;
...
uint public pendingNo;
mapping(uint => uint) public pendingWithdrawalAmount;
mapping(address => uint) public withdrawID;
mapping(uint => address) public addressOfID;
