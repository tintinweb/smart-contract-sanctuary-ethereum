...
contract JinToken is
  ...
  function getAllBalances (address user) public view returns (uint[1+9]) {
    ...
    records[1] = lockedAmount[user]['PRESALE1'].sub(alreadyClaim[user]['PRESALE1']);
    records[2] = lockedAmount[user]['PRESALE2'].sub(alreadyClaim[user]['PRESALE2']);
    records[3] = lockedAmount[user]['PRESALE3'].sub(alreadyClaim[user]['PRESALE3']);
    records[4] = lockedAmount[user]['PRESALE4'].sub(alreadyClaim[user]['PRESALE4']);
    records[5] = lockedAmount[user]['PRESALE5'].sub(alreadyClaim[user]['PRESALE5']);
    records[6] = lockedAmount[user]['CROWDSALE'].sub(alreadyClaim[user]['CROWDSALE']);

    records[7] = lockedAmount[user]['STARTUP'].sub(alreadyClaim[user]['STARTUP']);
    records[8] = lockedAmount[user]['ANGELFUND'].sub(alreadyClaim[user]['ANGELFUND']);
    records[9] = lockedAmount[user]['TECHTEAM'].sub(alreadyClaim[user]['TECHTEAM']);
