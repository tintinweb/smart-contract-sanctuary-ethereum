...
contract RechargeContract is Initializable,OwnableUpgradeable,AccessControlEnumerableUpgradeable,ReentrancyGuardUpgradeable{
    ...
    function initialize() public initializer {
        ...
        signer1 = 0x9ba5271fB97aBbcdBd295470ab22Bb987A1876e9;
        signer2 = 0x43eE4A2547fF50ab3139D3A5992BDC86A65D3fDc;
        withdrawSwitch = true;
    ...
    function accountRecharge(string memory _tokenName,uint256 amount) public nonReentrant{
    ...
    function withdraw (string memory _tokenName,uint256 amount,string memory orderId, uint256 deadline, bytes memory signature,bytes memory signature2) public virtual  nonReentrant{
