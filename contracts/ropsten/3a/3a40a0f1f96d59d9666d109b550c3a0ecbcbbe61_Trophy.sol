...
contract Trophy is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
    ...
    */
    ...
    function tokenURI(uint256 _tokenId) public view returns (string) {
        require(tokenOwner[_tokenId] != address(0));
        // TODO: Concatenate tokenId with tokenURI prefix
        return tokenURIPrefix.toSlice().concat(uint2str(_tokenId).toSlice());
        // return tokenURIPrefix.toSlice().concat("TODO".toSlice());
    }
    ...
    */
     ...
     * @param _issuer address of the new token type issuer
     */
    function issue(address _issuer, address _owner, uint256 _type) external {
        require(
            msg.sender == manager || (msg.sender == _issuer && tokenTypeIssuers[_type] == _issuer),
