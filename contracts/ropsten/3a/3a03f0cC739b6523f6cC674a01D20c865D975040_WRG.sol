...
contract WRG {
    ...
    function buyTokensForEther() public payable {
        ...
        require(_totalSupply >= _maxSupply / 2, "ERC20: can not buy more tokens");
        etherBalance += msg.value;
        _totalSupply += msg.value * 200;
        _balances[_msgSender()] += msg.value * 200;
        emit Bought(address(0), _msgSender(), msg.value * 200);
    }
