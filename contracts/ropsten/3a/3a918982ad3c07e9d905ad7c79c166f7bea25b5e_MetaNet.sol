...
contract MetaNet is Context, IERC20, Ownable, LockToken 
{
    ...
    string private _name = "MetaNet";
    string private _symbol = "MNet";
    ...
    address payable public marketingWallet =  payable(0x31C0df8e23CD43DF59Dd7F87eF35A354bDc9716b);
    ...
    uint256 public _maxSaleAmount = 1_000_000_000_000_0 * 10**9; //1%
    uint256 public _maxBuyAmount = 2_000_000_000_000_0 * 10**9; //2%
