...
//                                  
//                                                                                                
// https://t.me/StonkBonk
// https://www.StonkBonk.io
// https://www.twitter.com/StonkBonkGlobal
// https://StonkBonkGlobal.medium.com
// https://www.instagram.com/StonkBonkGlobal
// https://www.reddit.com/r/StonkBonkGlobal
// https://www.facebook.com/StonkBonkGlobal
...
contract StonkBonk is IBEP20, Ownable {
    ...
    string private _name = "Stonk Bonk";
    string private _symbol = "STOBO";
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        Team: 0xB8D2C61C0bb142c34dd351dE2dae3EFDB5f66D56,
        Donation: 0xB7b5B3e4275B4E2515aBB1bdBBA44c23C751D0F6,
        PublicRelations: 0x9CFc8DF8EdE3674E6D90a3B0d3F5EEB4Cbf382aC
    });
    ...
    uint8 private mainRewardSplit=25;
    uint8 private miscRewardSplit=75;
...
///// AUTHORIZED FUNCTIONS /////
    ...
    //Performs a buyback of another ERC20 token and automatically burns tokens
        ...
        authorized 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newTeam + newLiquidity + newDonation + newPublicRelations + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newTeam, newLiquidity, newDonation, newPublicRelations, newRewards);
    }
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 Team, uint256 Donation, uint256 PublicRelations) {
        return (buybackBalance, TeamBalance, DonationBalance, PublicRelationsBalance);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _distributeStake(uint256 bnbAmount, bool newStakingReward) private {
        uint256 PublicRelationsSplit = (bnbAmount*_taxRatios.PublicRelations) / distributeRatio;
        ...
        uint256 DonationSplit = (bnbAmount*_taxRatios.Donation) / distributeRatio;      
