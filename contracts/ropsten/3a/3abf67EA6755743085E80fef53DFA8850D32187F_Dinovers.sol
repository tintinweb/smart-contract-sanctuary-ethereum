...
contract Dinovers is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant SALE_PRICE_INCREMENT_PER_THOUSAND = 0.03 ether;
    uint256 public TOKEN_PRICE = 0.07 ether;
    uint256 public constant PRE_SALE_TOKEN_PRICE = 0.03 ether;
    uint256 public constant MAX_TOKENS = 10000;
    uint256 public constant MAX_PURCHASE_PER_DINO_LOVER = 10;
    uint256 public constant MAX_PURCHASE_PER_DINO_LOVER_AT_PRESALE = 2;
    uint256 public claimedGiftCount = 0;
    uint256 public devReserve = 30;
    bool public isSaleActive = false;
    bool public isPreSaleActive = false;
    bool public isGiftActive = false;
    bool public isRevealed = false;
    string public baseURI = "";
    
    mapping(address => bool) private _whiteList;
    mapping(address => uint256) private _whiteListClaimed;
    mapping(address => bool) private _giftList;
    ...
    function mintDino(uint256 amountOfTokens) external payable {
        ...
        require((countOfDinos(msg.sender) + amountOfTokens) <= MAX_PURCHASE_PER_DINO_LOVER, "Allowed amount exceeded.");
    ...
    function preSaleMintDino(uint256 amountOfTokens) external payable {
        ...
        require(_whiteList[msg.sender], "You are not on the Presale List");
        require(amountOfTokens > 0, "Amount should bigger than zero.");
        require((_whiteListClaimed[msg.sender] + amountOfTokens) <= MAX_PURCHASE_PER_DINO_LOVER_AT_PRESALE, "Allowed amount exceeded.");
    ...
    function reserveDinos(address _to, uint256 _reserveAmount) external onlyOwner {
        ...
        require(_reserveAmount <= devReserve,"Allowed amount exceeded.");
