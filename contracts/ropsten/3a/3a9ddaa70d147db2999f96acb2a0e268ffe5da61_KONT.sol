...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfa8465854746515BAB6e744e5cf4D7b0247F47DA;
...
contract KONT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xfa8465854746515BAB6e744e5cf4D7b0247F47DA;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KONT";
    string private _symbol = "$KNTL";
