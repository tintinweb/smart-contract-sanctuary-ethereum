...
contract FOREIGN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "FOREIGN";
    string private constant _symbol = "FRGN";
    uint8 private constant _decimals = 9;
    mapping(address => uint256) private _balances;

    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    uint256 private constant _tTotal = 1000 * 1e9 * 1e9;

    uint256 public _maxWalletAmount = 20 * 1e9 * 1e9;
    ...
    address payable private _marketingAddress = payable(0xAb08f2FF0a22a5cD23a08d4d6418C974d833A469);
    address payable private deploymentWallet = payable(0xAb08f2FF0a22a5cD23a08d4d6418C974d833A469);
