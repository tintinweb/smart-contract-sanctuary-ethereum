...
contract ContributorList is Ownable {
    ...
    uint256 public _minContribution; // ETH
    uint256 public _maxContribution; // ETH
...
/**
* @return return Token exchange rate
*/
