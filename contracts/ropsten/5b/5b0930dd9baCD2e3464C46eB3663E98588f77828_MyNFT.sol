...
contract ERC721AMB is ERC721AOwnersExplicit, Ownable {
    ...
    function initiateMint(
        ...
        require(
            _mintPrice != 0
            && _wlMintPrice != 0,
            "MyNFT::initiateMint: wrong prices provided"
        );

        require(
            _maxAirdropClaims > maxAirdropClaims
            && _maxSupply > maxSupply,
            "MyNFT::initiate: wrong supplies provided"
        );
...
contract MyNFT is ERC721AMB {
  constructor() ERC721AMB("MyNFT", "MB") {}
}