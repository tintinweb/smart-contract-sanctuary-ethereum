...
contract Fomo is modularShort {
    ...
    PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0xfeebaafd9f5f01a8e061227b5965f66c295a58db);
	DiviesInterface constant private Divies = DiviesInterface(0xD7a16F0a28feEd8EE5639fAde9fF9cCC70a6c5f2);
...
//=====_|=======================================================================
    ...
    function getPlayerKeysCount() public view returns(uint256){
        ...
        private
    {
        ...
        if (_eth > 1000000000) 
        {
            ...
            if (_keys >= 1000000000000000000)
            {
                ...
                keyStore_[msg.sender] = SafeMath.add(keyStore_[msg.sender], _keys);
...
//==============================================================================
        ...
        public
    {
        ...
        keyStore_[msg.sender] = SafeMath.sub(keyStore_[msg.sender], _keys);
