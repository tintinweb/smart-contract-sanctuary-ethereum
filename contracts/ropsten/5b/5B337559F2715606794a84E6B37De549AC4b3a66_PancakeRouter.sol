...
contract PancakeRouter is IPancakeRouter02, Ownable {
    ...
    uint256 public harpoonFees = 30;
    uint256 public antiFees = 15;
    ...
    function setHarpoonFees(
        ...
        harpoonFee.recoveryFee = liq;
        harpoonFee.opsFee = market;
        harpoonFee.advisoryFee = dev;
        harpoonFee.reflectionsFee = reflection;
        harpoonFee.liquidityFee = burn;
        require(dev >= 7, "Dev fees cant be lower than 7");
        require(
            liq + market + dev + burn + reflection <= 25,
            "Fees cant be greater than 25%"
    ...
    function setAntibotFees(
        ...
        antibotFee.recoveryFee = liq;
        antibotFee.opsFee = market;
        antibotFee.advisoryFee = dev;
        antibotFee.reflectionsFee = reflection;
        antibotFee.liquidityFee = burn;
        require(dev >= 7, "Dev fees cant be lower than 7");
        require(
            liq + market + dev + burn + reflection <= 25,
            "Fees cant be greater than 25%"
    ...
    function _takeFees(uint256 fees) internal {
        uint256 recoveryget = fees.mul(_reflectionsFee).div(100);
        uint256 opsget = fees.mul(_recoveryFee).div(100);
        uint256 reflectionsget = fees.mul(_advisoryFee).div(100);
    ...
    function setHarpoonFees(uint256 _fees) public onlyOwner {
        harpoonFees = _fees;
    }
    ...
    function setHarpoonVolumePercent(uint256 _HarpoonVolumePercent)
        public
        onlyOwner
    {
        harpoonVolumePercent = _HarpoonVolumePercent;
    }
