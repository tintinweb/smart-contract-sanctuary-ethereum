...
contract DeFirm is ERC20Detailed, Ownable {
    ...
    ILiquidityManager liquidityManager = ILiquidityManager(0xdF0E42237eDF0CBF81E3deCA8ce3c8b48502bb03);
    ...
    function _transferFrom(
        ...
        console.log("_gonsPerFragment", _gonsPerFragment);
        console.log("_gonBalances[sender]", _gonBalances[sender]);
        console.log("gonAmount", gonAmount);
    ...
    function addLiquidity() internal swapping {
        ...
        console.log("ADD LIQ amountToSwap", amountToSwap);
        if( amountToSwap == 0 ) {
            return;
        }
    ...
    function swapBack() internal swapping {
        ...
        path[0] = address(this);
        path[1] = USDC;
        console.log("swapBack", amountToSwap);
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            amountToSwap,
            0,
            path,
