...
contract TushToken {
    ...
    // truffle init - this command is to create folders in the directory 
    // import contracts into the contract folder 
    // make sure to change sol version in truffle-config.js to match contract version. e.g. 0.8.4
    // then run "truffle compile" in the terminal, if error, use this step: 
    // sudo rm -rf ~/Library/Preferences/truffle-nodejs  ---- type this into vscode terminal 
    //