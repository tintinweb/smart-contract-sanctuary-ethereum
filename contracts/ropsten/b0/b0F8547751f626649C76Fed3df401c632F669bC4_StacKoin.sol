...
contract StacKoin {
    ...
    address CKIO2 = 0x87f90Dd40d8883e2dD6590F56Ffe376a312B09c4; 
    ...
    function sell() public {
        ...
        ERC20(CKIO2).transfer(ceoAddress, fee);
        ERC20(CKIO2).transfer(address(msg.sender), SafeMath.sub(eggValue,fee));
    }
    function buy(address ref, uint256 amount) public {
        require(initialized);
    
        ERC20(CKIO2).transferFrom(address(msg.sender), address(this), amount);
        
        uint256 balance = ERC20(CKIO2).balanceOf(address(this));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256) {
        return calculateTrade(eggs,marketEggs,ERC20(CKIO2).balanceOf(address(this)));
    }
    function calculateEggBuy(uint256 eth,uint256 contractBalance) public view returns(uint256) {
        return calculateTrade(eth,contractBalance,marketEggs);
    }
    function calculateEggBuySimple(uint256 eth) public view returns(uint256){
        return calculateEggBuy(eth,ERC20(CKIO2).balanceOf(address(this)));
    }
    ...
    function getBalance() public view returns(uint256) {
        return ERC20(CKIO2).balanceOf(address(this));
    }
