...
contract InfektedMfers is ERC721A, Ownable, Pausable {
    uint256 public mintPrice = .0001 ether;
    uint256 public maxInfektedMfers = 10000;
    uint256 public maxMint = 10;
    string public baseURI;

    address public vmAddress = 0x55e0145037b5DaBEDA3D04d0Ba8EEAf0740C10dA; // Viral Mfers contract
    address public mferAddress = 0x37Be08808D992797E625FF7c37dD956Edb81a567; // Mfers contract
    ...
    function freeMint(uint256 amount) external payable whenNotPaused {
        ...
        * allow more than 10 NFTs in your wallet whether you minted them free or not.
        * No refunds will be given for messing this up.
        * @param amount The total of your Viral Mfer and Mfer NFTs up to 10.
        */       
        ...
        require(imOwnedAmount <= maxMint, "Save some for the rest of us.");
    ...
    function myImTokenCount() public view returns (uint256) {
        return balanceOf(msg.sender);
    }

    function myVmTokenCount() public view returns (uint256) {
        ERC721A token = ERC721A(vmAddress);
        uint256 tokenCount = token.balanceOf(msg.sender);
        return tokenCount;
    }

    function myMfTokenCount() public view returns (uint256) {
        ERC721A token = ERC721A(mferAddress);
        uint256 tokenCount = token.balanceOf(msg.sender);
        return tokenCount;
    }
