...
// File contracts/ApolloSafePlayMultiCurrency/ApolloSafePlayM.sol
...
/**
 * Apollo safe play token with Marketing tax
 */
...
contract ApolloSafePlayM is Context, IERC20Metadata, Ownable {
    // Token parameters
    string private NAME;
    ...
    constructor(
        ...
        require(
            (_txFeeRates.marketing + _txFeeRates.buyBack) <= MAX_TX_FEES,
    ...
    function setFeeRates(
        ...
        uint256 buyFees = _buyFeeRates.marketing;

        uint256 sellFees = _sellFeeRates.marketing;
