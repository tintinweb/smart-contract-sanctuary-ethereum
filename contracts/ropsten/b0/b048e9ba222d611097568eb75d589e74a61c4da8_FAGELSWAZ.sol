...
Welcome to FagelSwaz (FAGEL)! This token's utility lies in the fact that it is a deflationary token and has no buy tax and a low sell tax.
...
contract FAGELSWAZ is Context, IERC20, Ownable {
    ...
    uint256 private _buyTaxMarketing = 20;
    uint256 private _earlySellTaxMarketing = 10;
    uint256 private _sellTaxMarketing = 10;
    uint256 private _autoLpFee = 5;
    uint256 private _trueBurnFee = 5;
	...
	string private constant _name = "FAGEL SWAZ";
	string private constant _symbol = "FAGEL";
	...
	constructor () {
		_kuramaWallet = payable(0xcBB620d0B5427366A74D1F671E89bb05bed099C8);
