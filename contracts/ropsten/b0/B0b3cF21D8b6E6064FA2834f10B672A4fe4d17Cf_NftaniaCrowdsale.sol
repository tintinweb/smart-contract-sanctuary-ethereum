...
contract NftaniaCrowdsale is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Constructor //////////////////////////////////////
    ...
    // }
        ...
        constructor()
        {
        tokenPresalePrice = 5000000000000;
        tokenPrice = 6250000000000;    
        walletLimit = 2000000;
        minPurchase = 20000;
        maxPurchase = 2000000;
        poolPercent = 400;
        // targetPool = uint256 (1e0 ether);
        targetPool = 100000000000000000;
        startDate = 1655492387;
        endDate = 2655404801;     
    }
   ...
   //////////////////////// intializeAddresses //////////////////////////////////////     
    ...
    function intilizeAddresses ()
        public onlyOwner{  
        tokenAddress = 0xC66581e6923d77762B71F5579a8211798ceaa29f;  
        LiquidityPoolLocker =0x7E02241F3e76796156a97E3aAA915Be602BAb5af;
        NftaniaAddLiquidity = payable (address(0x669c948dA5DB97e6d09A44de6B1b322C18a22750));
        revenueWallet = payable (address(0xaFd842164a5b79243bDe66269d0a01bFFc9610d0));       
        updateStatus();
    }
   ...
   //////////////////////// Update Dates //////////////////////////////////////// 
    function updateDates(uint _startDate, uint _endDate) public onlyOwner whenNotClosed {
        require(_startDate >= block.timestamp,"NftaniaCrowdsale: opening time is before current time");
