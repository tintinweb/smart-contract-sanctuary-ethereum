...
contract Dynamic is Context, IERC20, Ownable {
    ...
    uint256 private _maxBuyAmount = 2500000 * 10**9;

    uint256 private _baseFee = 10;

    uint256 private _moderateBuyImpact = 3;
    uint256 private _highBuyImpact = 7;
    uint256 private _extremeBuyImpact = 9;
    ...
    uint private _cooldownTimerInterval = 60; // 60 seconds
