...
/**
 * @title GUT token.
 * @notice Please, open GutToken.site() for details.
 */
contract GutTokenF is KeeperRole, ERC20Pausable, ERC20Burnable, ERC20Mintable {
  string public constant name = "GUTs Token";
  string public constant description = "GUT token description";
  string public constant symbol = "GUTs"; //==10^18 guttins. 1 guttin is the smallest value.
  uint8 public constant decimals = 18; 
  uint256 public constant INITIAL_SUPPLY = 100000000 * (10 ** uint256(decimals)); //reserved
  string public site;
