...
contract GAX_FNFT is ERC721Upgradeable,
    ...
    ERC721EnumerableUpgradeable
   {
    ...
    mapping(uint256 => address) public fnftLink;
    ...
    function mintToken(
        ...
        ERC20Instance.initialize(name_,symbol_,initialSupply_,owner_);
        ERC20Instance.transferOwnership(owner_);
        fnftLink[_tokenID] = ERC20InstanceAdr;
        emit ERC20InstanceCreated(owner_,ERC20InstanceAdr);
    }
