...
interface IAutoAdjustablePortfolio {
    ...
    function initialize(
        ...
        address _borrower,
        uint32 _minInterestRate,
        uint32 _minInterestRateUtilizationThreshold,
        uint32 _optimumInterestRate,
        uint32 _optimumUtilization,
        uint32 _maxInterestRate,
        uint32 _maxInterestRateUtilizationThreshold
    ) external;
...
contract AutoAdjustablePortfolioFactory is InitializableManageable {
    ...
    function createPortfolio(
        ...
        bytes memory initCalldata = abi.encodeWithSelector(
            ...
            msg.sender,
            _minInterestRate,
            _minInterestRateUtilizationThreshold,
            _optimumInterestRate,
            _optimumUtilization,
            _maxInterestRate,
            _maxInterestRateUtilizationThreshold
        );
