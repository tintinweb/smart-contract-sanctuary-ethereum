...
// ParaUniFetch helps your migrate your existing Uniswap LP tokens to ParaSwap LP ones
contract ParaUniFetch {
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'ParaUniFetch: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'ParaUniFetch: INSUFFICIENT_B_AMOUNT');
    }
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
                ...
                factory,
                keccak256(abi.encodePacked(token0, token1)),
                hex'b3f6e950c9f902f25e5e4b067ee4fe91e51d5dbc284cc68148eda3613a8d923c' // init code hash
            )))));
    }
