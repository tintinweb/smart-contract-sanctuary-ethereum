...
contract MariamTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MariamTestCoin() {
        ...
        name = "MariamTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "UBIT2018031";                                             // Set the symbol for display purposes (CHANGE THIS)
