...
contract heman is Context, IERC20, Ownable {
    ...
    uint256 private _maxTxAmount = 25e5 * 10**(_decimals);
    uint256 private _numTokensSellToAddToLiquidity = 3e5 * 10**(_decimals);
    uint256 private _maxWalletSize = 1e7 * 10**(_decimals);
    uint256 private tradingActiveBlock = 0;
    uint256 private blocksToBlacklist = 10;

    string private _name = "heman";
    string private _symbol = "heman";
