...
interface ISagaExchanger {
     ...
     * @param to The address of the SGN holder.
     * @param value The amount of SGA to transfer.
     */
...
contract SGNToken is ERC20, ContractAddressLocatorHolder {
     ...
     * @param value The amount of SGN to convert.
     ...
     * @notice If the destination account is this contract, then exchange SGN for SGA.
     */
    function transfer(address to, uint256 value) public returns (bool) {
        if (to == address(this)) {
