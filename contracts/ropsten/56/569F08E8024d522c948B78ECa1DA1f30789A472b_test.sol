...
contract test is ERC20, Auth {
    ...
    uint256 public totalFee = marketingFee + liquidityFee + teamFee + devFee + EducationFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x29D83D16fe4Be0121243b335f8A604785EB8FB81;
        teamFeeReceiver = 0x29D83D16fe4Be0121243b335f8A604785EB8FB81;
        devFeeReceiver = 0x29D83D16fe4Be0121243b335f8A604785EB8FB81;
        EducationFeeReceiver = 0x29D83D16fe4Be0121243b335f8A604785EB8FB81;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHpresident = amountETH.mul(EducationFee).div(totalETHFee);

        payable(marketingFeeReceiver).transfer(amountETHMarketing);
        payable(teamFeeReceiver).transfer(amountETHteam);
        payable(devFeeReceiver).transfer(amountETHDev);
        payable(EducationFeeReceiver).transfer(amountETHpresident);
    ...
    function setFees(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _teamFee, uint256 _devFee, uint256 _EducationFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        devFee = _devFee;
        EducationFee = _EducationFee;
        totalFee = _liquidityFee + _marketingFee + _teamFee + _devFee + _EducationFee;
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _devFeeReceiver, address _EducationFeeReceiver) external onlyOwner {
