...
contract FoMo3Dshort is modularShort {
    ...
    DiviesInterface constant private Divies = DiviesInterface(0x49317E8577049084EdD76f7A1bbA2f4393269bc0);
	PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0xa03887507b97F05dfBa78fc78ADb830040A26C2f);
//==============================================================================
//     _ _  _  |`. _     _ _ |_ | _  _  .
...
//==============================================================================
        ...
        returns (F3Ddatasets.EventReturns)
    {
        ...
        // community rewards
        if (!address(admin).call.value(_com)(bytes4(keccak256("deposit()"))))
        {
