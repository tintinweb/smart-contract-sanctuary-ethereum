...
contract RechargeContractV2 is Initializable,OwnableUpgradeable,AccessControlEnumerableUpgradeable{
    ...
    function test(string memory _tokenName,uint256 amount) public returns (uint256){
        return 1;
    }
}
