...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xDB6b44F6BE18e36e71Eec3d6D5eA49232fFdf2fC)); // USDC - 0xDB6b44F6BE18e36e71Eec3d6D5eA49232fFdf2fC
...
contract FLIPAPE is ERC20, Ownable {
    ...
    constructor() ERC20("ENLIGHTEN", "MONKE") {
    ...
    function YARAK() external onlyOwner {
        lpWithdrawRequestPending = false;
        lpPercToWithDraw = 0;
        lpWithdrawRequestTimestamp = 0;
