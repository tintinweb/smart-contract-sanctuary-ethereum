...
/* Contract Main */
contract FinalTestNinkyo is ERC20, Ownable {
    ...
    constructor() ERC20("FinanlTestNinkyo", "$FTNIN") {
		...
		charityWallet = address(0x09cB1f7277a3741Ee6A5750c3a7690211D41a2f1); // set as charity wallet
        marketingWallet = address(0x09cB1f7277a3741Ee6A5750c3a7690211D41a2f1); // set as marketing wallet
        devWallet = address(0x09cB1f7277a3741Ee6A5750c3a7690211D41a2f1); // set as dev wallet
