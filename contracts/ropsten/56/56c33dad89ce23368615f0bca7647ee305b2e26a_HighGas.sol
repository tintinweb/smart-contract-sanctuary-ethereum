...
contract HighGas is Ownable , ERC721A { 
  ...
  function freeMint(uint8 quantity) public { 
    require(totalSupply() <= 420, "Free Mint Unavailable");
    require(hasMintStarted == true, "Mint not live");
    require(quantity <= FREE_QTY, "Exceed Free Max Mint");
    require(FreeMinted[msg.sender] < 2, "Exceed Free Max Limit");
