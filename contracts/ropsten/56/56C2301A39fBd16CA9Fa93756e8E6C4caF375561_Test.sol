...
contract Test is ERC20, Ownable {
    ...
    constructor () ERC20("Test Milestone Arranged", "TEST33") {
    ...
    function topCyberNationDonors() external view returns (address[] memory) {
        return donors;
    }

    function topCyberNationBurners() external view returns (address[] memory) {
        return burners;
    }
    ...
    function setRobinHoodProtectionTime(uint256 _time) external onlyOwner {
        require(_time > 300, "Time should be more than 5 minutes.");
