...
contract ThePuzzleGuys is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The Puzzle Guys", "TPG") {
    setHiddenMetadataUri("ipfs://QmfKHFtzLJgaPjSbsRTQ9zXrUHuPxCHt68W9R3ZbUbUi6s/hidden.json");
  }
