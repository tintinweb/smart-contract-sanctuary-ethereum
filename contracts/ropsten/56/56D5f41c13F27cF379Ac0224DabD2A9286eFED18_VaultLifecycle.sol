...
library VaultLifecycle {
    ...
    function verifyOtoken(
        ...
        require(otoken.strikeAsset() == commitParams.USDC, "strikeAsset != USDC");
    ...
    function getOrDeployOtoken(
        ...
        // console.log("collateralAsset", commitParams.collateralAsset);
        // console.log("strikePrice", commitParams.strikePrice);
