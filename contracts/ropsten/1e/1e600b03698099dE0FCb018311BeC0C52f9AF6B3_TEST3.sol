...
abstract contract MaxWalletDynamic {
    ...
    uint256 constant maxBuyIncrementPercentil = 1; // increment maxbuy percentil 1000=100%
...
contract TEST3 is TradableErc20, Withdrawable {
    constructor()
        TradableErc20("TEST3 TESTNAME", "t3SYMB")
