 ...
 */
 ...
 contract TestNFT is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable, ERC2981PerTokenRoyalties {
     ...
     constructor() ERC721("TestNFT", "TestNFT") {
          ...
          _setupRole(MINTER_ROLE, 0x476Bb28Bc6D0e9De04dB5E19912C392F9a76535d);
          _setupRole(MINTER_ADMIN_ROLE, 0x476Bb28Bc6D0e9De04dB5E19912C392F9a76535d);
     ...
     function setBaseRoyalty (address recipient, uint256 percent, uint256 amount) public {
         require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "TestNFT/minter-role-required");
