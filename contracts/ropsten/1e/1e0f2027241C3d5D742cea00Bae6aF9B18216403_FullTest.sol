...
contract FullTest is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.tokenfy-staging.aegas.it/64/metadata/";
	string private _contractURI = "https://tokenfy-staging-public.s3.us-east-2.amazonaws.com/64/contract-uri";
	...
	uint256 public presalePricePerToken = 3000000000000000;
    ...
    // royalties
    uint256 public royaltyBps = 1800;
	...
	constructor(address _signerAddress) ERC721A("Full Test", "TEST") {
