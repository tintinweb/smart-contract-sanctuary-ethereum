...
contract SnapNFT is ERC721URIStorage, ERC721Holder, ReentrancyGuard, Ownable {
    ...
    function createGameInstance(
        ...
        public view returns(uint256) {
            // this needs changing
            uint256 beaconId = 3;//(block.timestamp % 60) % _tokenIds.current();
        ...
        public {
            ...
            // if the loser tries to claim, they should have already transferred and thus cannot transfer
            ...
            require((gameInstanceIDs[gameId].player1.tokenId == currentBeacon) || (gameInstanceIDs[gameId].player2.tokenId == currentBeacon), "Neither token matches the beacon!");

            this.safeTransferFrom(address(this),msg.sender,gameInstanceIDs[gameId].player1.tokenId);
            this.safeTransferFrom(address(this),msg.sender,gameInstanceIDs[gameId].player2.tokenId);
        }
