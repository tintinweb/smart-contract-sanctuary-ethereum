...
contract Simple is ERC721 {
    ...
    constructor() ERC721("Backstage", "BSO") {}

    function mintNFT(address recipient, string memory tokenURIs)
        public
        returns (uint256)
    {
        _tokenIds.increment();
        ...
        returns (string memory)
    {
        ...
        return "https://gateway.pinata.cloud/ipfs/QmWmvTJmJU3pozR9ZHFmQC2DNDwi2XJtf3QGyYiiagFSWb";
    }
}


// File contracts/BackstageTicket.sol
...
// contract BackstageTicket is ERC721, ERC721Enumerable, Ownable {
//     using Counters for Counters.Counter;
...
//     constructor(uint256 _maxSupply) ERC721("BackstageTicket", "BSOTKT") {
//         maxSupply = _maxSupply;        
//     }
