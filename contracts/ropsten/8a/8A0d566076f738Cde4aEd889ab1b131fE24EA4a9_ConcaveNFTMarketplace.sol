...
import {Position} from "../staking/StakingStorageV1.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function _transferNftAndPaySeller(
        ...
        idMarketItems[itemId].owner = _nftRecipient;
    ...
    function toggleForSale(address _nftContractAddress, uint256 _tokenId)
        external
        whenNotPaused
        onlyNFTOwner(_nftContractAddress, _tokenId)
    {
    ...
    function createMarketItem(address _nftContractAddress, uint256 _tokenId)
        public
        whenNotPaused
    {
    ...
    function unlockPositionHandler(
        address _nftContractAddress,
        uint256 _tokenId
    )
        external
