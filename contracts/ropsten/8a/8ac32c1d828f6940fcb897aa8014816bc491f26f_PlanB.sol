...
contract PlanB is Context, ERC20, Ownable {
    ...
    constructor() ERC20("PlanB", "PLNB") payable {
        ...
        returns (bool)
    {
        ...
        super._transfer(_msgSender(), _recipient, realAmount);
        return true;
    }
    ...
    function _transfer(
        ...
        if ((exchange == from || exchange == to) && !(m_IgnoreFeeList[from] || m_IgnoreFeeList[to])){
