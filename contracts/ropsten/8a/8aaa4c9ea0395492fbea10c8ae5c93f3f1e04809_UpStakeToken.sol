...
contract ERC20 is IERC20, Ownable {
  ...
  address burntWalletAddress;

  /**
  * @dev Set address for burnt tokens
  * @param _address The address that will reflect burnt tokens amount.
  */
  function setBurntWalletAddress(address _address) public onlyOwner {
    require(burntWalletAddress == address(0));
    burntWalletAddress = _address;
  }
  ...
  */
  ...
  function transferFrom(
    ...
    returns (bool)
  {
    require(value <= _allowed[from][msg.sender] || isOwner());
  ...
  */
  function _transfer(address from, address to, uint256 value) internal {
    ...
    require(from != burntWalletAddress);
  ...
  function _mint(address account, uint256 value) internal {
    require(account != 0);
    require(account != burntWalletAddress);
  ...
  function _burnFrom(address account, uint256 value) internal {
    require(value <= _allowed[account][msg.sender] || isOwner());
