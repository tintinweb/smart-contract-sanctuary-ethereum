...
contract KishiUniFetch {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'KishiSwap: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'KishiUniFetch: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'KishiUniFetch: INSUFFICIENT_B_AMOUNT');
    }
...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                factory,
                keccak256(abi.encodePacked(token0, token1)),
                hex'3a6b7b8f27054f064ca42864920f2767a684f55286a14e44cd2064165b8bbbf2' // init code hash
            ))));
    }
