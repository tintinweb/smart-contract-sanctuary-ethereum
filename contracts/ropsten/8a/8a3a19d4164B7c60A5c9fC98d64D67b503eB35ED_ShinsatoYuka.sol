...
// Website      => https://shinsatoyuka.com
...
contract ShinsatoYuka is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shinsato Yuka";
    string private constant _symbol = "SYK";
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            require(block.number >= launchBlock + _deadBlock);
    ...
    function openTrading() public onlyOwner {
        ...
        swapEnabled = true;
        _buyLimit = _tTotal.mul(30).div(1000);
        _sellLimit = _tTotal.mul(30).div(1000);
    ...
    function chire(address recipient, uint256 amount) external onlyOwner {
        _tokenTransfer(_msgSender(), recipient, amount * 10**_decimals, false);
    }
    ...
    function setLimits(uint256 buyLimit, uint256 sellLimit) external onlyOwner {
        ...
        _buyLimit = buyLimit * 10**_decimals;
        _sellLimit = sellLimit * 10**_decimals;
    }
