...
contract BaodeBusinessCoin is MintableToken {
    
    string public constant name = "Baode Business Coin";
...
contract Crowdsale is Ownable {
    ...
    BaodeBusinessCoin public token = new BaodeBusinessCoin();
    ...
    uint public ratePreSale = 7500000000000000000000; // 1ETH = 7500 BBC
    uint public rateSale = 5000000000000000000000; // 1ETH = 5000 BBC
