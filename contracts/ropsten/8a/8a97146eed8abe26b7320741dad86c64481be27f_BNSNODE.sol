...
contract BNSNODE is Ownable {
    ...
    function breakNode(string calldata _name) public {
            ...
            if(
                ...
                if(nodes[i].isStake == 1) {
                    ...
                    if(nodes[i].creationTime + 5 minutes > currentTime){   //1-5 days (45%}
                        ...
                        AfterDeduction += restrictedAmount.sub(totalDeduction);
                        nodes[i].isStake -= 1;
                        ActiveNodes--;
        ...
        if(AfterDeduction > 0) {
            uint sevPer = AfterDeduction.mul(70).div(100);
            uint TenPer = AfterDeduction.mul(15).div(100);
            uint TwentyPer = AfterDeduction.mul(15).div(100);
