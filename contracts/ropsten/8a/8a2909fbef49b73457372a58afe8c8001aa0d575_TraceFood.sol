...
contract TraceFood{
    ...
    function deleteBatch(string memory _batchName, string memory _data, bytes32 _hashOfEmail) public onlyValidKey {
        require(batchNameExists[_batchName] == true, "Batch_exists");
        stepId[_batchName]--;
        emit BatchStatus(_batchName, _batchName, _hashOfEmail, _hashOfEmail, _data, stepId[_batchName]);
    }
