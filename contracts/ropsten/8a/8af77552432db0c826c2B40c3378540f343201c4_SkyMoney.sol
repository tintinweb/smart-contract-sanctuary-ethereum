...
constructor(IERC20 token_,address owner_){
    ...
    createNewLvl(0, 40*(10**18), 5, 200);
    createNewLvl(1, 90*(10**18), 4, 150);
    createNewLvl(2, 170*(10**18),4, 175);
    createNewLvl(3, 270*(10**18), 6, 200);
    createNewLvl(4, 500*(10**18), 6, 225);
    createNewLvl(5, 900*(10**18), 8, 250);
    createNewLvl(6, 1500*(10**18), 8, 275);
