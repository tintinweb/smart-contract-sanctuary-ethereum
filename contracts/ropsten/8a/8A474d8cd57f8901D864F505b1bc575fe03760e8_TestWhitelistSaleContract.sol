...
contract TestWhitelistSaleContract is Ownable, ReentrancyGuard {
    uint256 public constant MAX_SUPPLY = 729;
    uint256 public immutable maxWhitelistAmount = 256;
    uint256 public immutable maxWhitelistPerAddressAmount = 15;
    uint256 public constant whitelistSalePrice = 0.00069 ether;

    // used to validate whitelists
    bytes32 public whitelistMerkleRoot;

    // set time
    uint64 public immutable whitelistStartTime = 1547684000;
    uint64 public immutable whitelistEndTime = 1747770400;
