...
contract AdrCrowdsale is Whitelisted {
    ...
    function () payable public {
        ...
        // divide by ether decimals to get the actual ether passed
        uint256 onlyEth = SafeMath.div(msg.value, 1000000000000000000);
        // divide by price to get the actual adt token
        uint256 onlyAdt = SafeMath.div(onlyEth, price);
