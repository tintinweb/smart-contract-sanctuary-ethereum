...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 public ocash = IERC20(0x07865c6E87B9F70255377e024ace6630C1Eaa37F); //busd mainnet
...
contract TestOV2 is Initializable, OwnableUpgradeable {
    using SafeMath for uint256;
    ...
    function initialize() public initializer {
        ...
        INITIAL_FRAGMENTS_SUPPLY = 60 * 10**6 * 10**_decimals;

        TOTAL_GONS = MAX_UINT256 - (MAX_UINT256 % INITIAL_FRAGMENTS_SUPPLY);
        MAX_SUPPLY = 600 * 10**6 * 10**_decimals; //600M
        ...
        MarketingWallet = 0xAd5292D3D35F57CC0D7876cfD7B583DC99637b0d;
        DeveloperWallet = 0xAd5292D3D35F57CC0D7876cfD7B583DC99637b0d;
        ...
        rewardYield = 3880579;//3830800;
        rewardYieldDenominator = 10000000000;
        rebaseFrequency = 1800;
        nextRebase = 1662983100;
        nexthalving = 1662983100 + 2629743;
    ...
    function runInit() external onlyOwner {
        ...
        address router_ = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //Mainnet
        ...
        OceansDividendReceiver = address(distributor);
