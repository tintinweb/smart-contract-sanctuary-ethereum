...
contract TicketSale is Ownable, Pausable, ReentrancyGuard
{
    ...
    event GovernanceRecipientsAddedAmts(address[] wallets, uint256 amount);
    ...
    function TicketPurchase() public payable nonReentrant whenNotPaused
    {
        ...
        {
            require(_TICKET_PRICE_PUBLIC == msg.value && _PUBLIC_SALE_IS_ACTIVE, "Ether Value Sent Is Not Correct Or Public Sale Inactive. Public Sale is 2 ETH Per Ticket");
        }
    ...
    function __modifyBrightList(address[] calldata wallets) external onlyOwner
    {
        ...
        emit GovernanceRecipientsAddedAmts(wallets, _BRIGHT_LIST_AMOUNT);
    }
    ...
    {
        _PUBLIC_SALE_IS_ACTIVE = false;
        _BRIGHT_SALE_IS_ACTIVE = false;
    }
