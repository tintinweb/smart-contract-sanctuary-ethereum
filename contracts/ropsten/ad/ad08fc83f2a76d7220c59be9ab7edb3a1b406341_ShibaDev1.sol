...
contract Ownable is Context {
     ...
     */
    constructor() {
        _owner = 0x96d5548C28E2Bd1997f99EB5c0CE438C1F1dd7Fc;
...
contract ShibaDev1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Shiba1";
    string private _symbol = "Shiba2";
    ...
    uint256 public _taxFee = 5; // means 5% which distribute to all holders reflection fee
    uint256 public _communityFee = 100;// meanse 2% eth to marketing Wallet
    uint256 public _liquidityFee = 100; // means 2% 
    uint256 public _burnFee = 500; // means 5% 
    
    uint256 public _SelltaxFee = 5; // means 5% which distribute to all holders reflection fee
    ...
    address public  communityAddress = 0xcf429cD6aFc9924b61316bFb45815d330eC67708;
    ...
    //Max tx Amount
    uint256 public maxTxAmount = 5_000e9; // 
    //max Wallet Holdings 2% of totalSupply
    uint256 public _maxWalletToken = 20_000e9;
    uint256 public minTokensBeforeSwap = 100_00_000e9;
    ...
    function setBuyFee(uint256 communityFee,uint256 burnFee,uint256 liquidityFee) external onlyOwner {
