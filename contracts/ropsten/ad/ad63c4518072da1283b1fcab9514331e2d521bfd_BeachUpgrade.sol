...
contract BeachUpgrade is Context, IERC20, Ownable {
    ...
    string private constant _name = "Beach Upgrade Tokenomics";
    string private constant _symbol = "BEACHUpT";
    ...
    address payable public _conduitAddress = payable(0x8f5DEde1126E029a1BC0de694A32BC80b4353f97);
