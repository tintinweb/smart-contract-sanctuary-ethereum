...
contract KishimotoV2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeERC20 for IERC20;
    
    address payable public rewardPoolAddress = payable(0x805B9Bd203ad2B69A241AE5084abEE11183f9429); // reward Pool Address
    ...
    string private _name = "Kishimoto Token V2";
    string private _symbol = "KISHI V2";
    ...
    constructor () {        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);//eth - 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)  bsc - 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 ;
