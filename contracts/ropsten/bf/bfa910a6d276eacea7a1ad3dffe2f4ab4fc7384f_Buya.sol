...
contract Buya is Context, IERC20, Ownable {
    ...
    string private _name = "Buya Token ";
    string private _symbol = "BUYA";
    ...
    uint256 public _maxBuyAmount = 50000000000 * 10** _decimals; //5%
    uint256 public ethPriceToSwap = 200000000000000000; //.2 ETH
    uint public ethSellAmount = 500000000000000000;  //.5 ETH
    address public marketingAddress = 0xBd80631288963E40911DE8ce0f246d9cA3caB7a4;
    address public charityAddress = 0xb594f957abd223Df54f289dA7bEBD8A1e622541d;
    address public devAddress = 0x8B73692b3038020aC61Ba7934cba221C4c6425d9;
    ...
    constructor () {
        ...
        distribution = Distribution(20, 30, 30, 20);
...
contract DividendTracker is IERC20, Context, Ownable {
    ...
    string private _name = "BUYA TRACKER";
    string private _symbol = "BUYAX";
    uint8 private _decimals = 9;
    ...
    function setTokenBalance(address account) external {
        uint256 balance = buya.balanceOf(account);
        if(!buya.isExcludedFromRewards(account)) {
    ...
    function setERC20Contract(address contractAddr) external onlyOwner {
        buya = Buya(payable(contractAddr));
    }
