...
contract BurnToken is ERC20, Ownable {
    ...
    uint256 public maxWalletAmount = 400 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 30 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 15 * 10**_decimals;
    // TOKENOMICS END ============================================================>
    ...
    function _transfer(
        ...
        if ((from == uniswapV2Pair || to == uniswapV2Pair) && !inSwapAndLiquify) {
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to] || (from != uniswapV2Pair && to != uniswapV2Pair)) {
                ...
                transferAmount = amount - (marketingShare + liquidityShare + burningShare);
