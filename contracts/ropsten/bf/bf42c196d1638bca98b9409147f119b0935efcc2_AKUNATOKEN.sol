...
contract AKUNATOKEN is ERC20, Owned {
    ...
    string public constant name = "AKUNATOKEN";
    ...
    // saleable 75%
    uint256 public constant totalIco = 75000000000000;
    uint256 public totalIcoDist = 0;
    address storageIco = owner;
    
    // airdrop 5%
    uint256 public constant totalAirdrop = 5000000000000;
    address storageAirdrop = 0xd06EA246FDb6Eb08C61bc0fe5Ba3865792c02202;
    
    // developer 20%
    uint256 public constant totalDeveloper = 25000000000000;
    ...
    // presale
	uint public presaleStartTime = 1536844200; // 23.00
    uint256 public presalePerEth = 500000000000;
    
    // ico
    uint public icoStartTime = 1536844800;
    uint256 public icoPerEth = 400000000000;
    
    // ico1
    uint public ico1StartTime = 1536845400;
    uint256 public ico1PerEth = 250000000000;
    
    // ico2
    uint public ico2StartTime = 1536846000;
    uint256 public ico2PerEth = 100000000000;
    
    //ico start and end
    uint public icoOpenTime = presaleStartTime;
    uint public icoEndTime = 1536846600;
