...
// File contracts/Staking/Uniswap/IUniswapV2Router01.sol
...
// File contracts/Staking/Uniswap/IUniswapV2Router02.sol
...
// File contracts/Staking/Uniswap/IUniswapV2Factory.sol
...
// File contracts/Staking/Uniswap/IUniswapV2Pair.sol
...
contract StakingToken is ERC20, Ownable {
    ...
    uint256 public _totalSupply = 10 ** 7 * 1 ether ;
    ...
    { 
        ...
        Owner = _owner;
        presaleAmount = _totalSupply * 20 / 100;
    ...
    function rewardOf(address _stakeholder) 
        ...
        returns(uint256)
    {
        return rewards[_stakeholder] + earned(_stakeholder);
    }
