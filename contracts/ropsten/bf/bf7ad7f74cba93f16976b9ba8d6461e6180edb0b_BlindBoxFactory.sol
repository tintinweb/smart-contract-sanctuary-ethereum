...
contract BlindBoxFactory is Ownable {
    ...
    uint256 constant public TOKEN_LIMIT = 10000;
    uint256[TOKEN_LIMIT] public indices;
    uint256 nonce;
    address private receiverAddress = 0x000000000000000000000000000000000000dEaD;

    constructor(address _blindBox,address _nftAddress,address _funAddress,uint256 _publicSellPrice,uint256 _buyStartTime,uint256 _openStartTime) {
        blindBox = _blindBox;
    ...
    function channelBuy( address to,uint256 price,uint256 amount,uint256 timestamp,bytes32 hash,bytes32 r,bytes32 s,uint8 v) public payable{
