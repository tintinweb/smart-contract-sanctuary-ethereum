...
// File: default_workspace/Shiberus.sol
...
/**
    ...
    Twiiter: https://twitter.com/shiberus_eth
    TG: https://t.me/Shiberus
*/
...
contract Shiberus is ERC20, Ownable {
    ...
    constructor() ERC20("The Mighty Shiberus", "SHIBERUS") {
        ...
        maxTransactionAmount = 100 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 200 * 1e18; // 2% from total supply maxWallet
        ...
        marketingWallet = address(0x0AFA30E6d23A9C19Dd3a78D1e851cf6ab865B9F3); // set as marketing wallet
        devWallet = address(0xBD84c2e2bF4C34F82A4E627d539cab0aa51AC479); // set as dev wallet
