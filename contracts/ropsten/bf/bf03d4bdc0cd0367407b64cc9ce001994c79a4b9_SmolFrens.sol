...
contract SmolFrens is ERC721Enumerable, Ownable, NonblockingReceiver {
    ...
    function Whitelist(bytes32[] calldata _merkleProof, uint amount) external payable {
        ...
        require(totalSupply() <= ETH_MINT, "Supply is capped!");
        ...
        for(uint nextTokenId; nextTokenId < amount; nextTokenId++){
            _safeMint( msg.sender, supply + nextTokenId );
        }
