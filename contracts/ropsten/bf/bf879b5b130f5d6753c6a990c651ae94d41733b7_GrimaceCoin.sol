...
contract GrimaceCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Deez Coin";//
    ...
    address payable private _developmentAddress = payable(0x56624621523C0005E96C6d96De9E5730cddf2E21);//
    address payable private _marketingAddress = payable(0xb59E21FaF76b565184645B2E105C7c5bB610AD2F);//
