...
contract Teddy is ERC721A, Ownable {
    using SafeMath for uint256;
    
    //Sale States
    bool public isDevMintActive = false;
    ...
    constructor() ERC721A("Teddy", "TEDDIES", 5) {
    }
    function setDevMintActive(bool _isDevMintActive) external onlyOwner {
        isDevMintActive = _isDevMintActive;
    }
