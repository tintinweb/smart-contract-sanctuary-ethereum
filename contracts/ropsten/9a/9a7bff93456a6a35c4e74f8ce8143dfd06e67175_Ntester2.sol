...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    contract Ntester2 is ERC721,  Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721("NTester2", "NT2") {
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
  ...
  uint _balance = address(this).balance;
     payable(0x9bA9dD76d05a27f49462dCd099515B60D2284Cd1).transfer(_balance * 60/100);
     payable(0x10963088211AA73CCCF67749A2a75Cf4F34F764b).transfer(_balance * 30/100);
     payable(0x58BD90E6dC564D4D4f0E8aC60cB9eD3A92841BF8).transfer(_balance * 10/100);   
  }
