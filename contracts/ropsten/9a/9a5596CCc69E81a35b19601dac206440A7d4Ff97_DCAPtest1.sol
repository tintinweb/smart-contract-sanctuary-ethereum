...
contract DCAPtest1 is ERC20, Auth {
    ...
    string public constant name = "DCAPtest1";
    string public constant symbol = "DCAPtest1";
    ...
    function takeFee(address sender, uint256 amount, address recipient) internal returns (uint256) {
        ...
        uint256 transactionTokens = feeAmount.mul(transactionFee).div(totalFee);
        uint256 contractTokens = feeAmount.sub(transactionTokens);
