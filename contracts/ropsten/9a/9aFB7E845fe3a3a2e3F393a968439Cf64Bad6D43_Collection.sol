...
contract Collection is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    ...
    uint256 private constant MAX_NFT = 152;  
    ...
    constructor(
        ...
        // Init epochs 
        // TODO check epochs 
        epochs[1] = EpochDetails(2,100,0,1655148600,1655149800);
        epochs[2] = EpochDetails(1,50,0,1655150400,1655151600); 
        epochs[3] = EpochDetails(3,152,0,1655152200,0); 
        epochs[4] = EpochDetails(1,2,0,1655150400,0); 
    }
