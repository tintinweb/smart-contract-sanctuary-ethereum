...
contract SolvenirAuction is ReentrancyGuard, ERC721Holder, ERC2981 {
    ...
    * @param _tokenId tokenId of NFT
     */
    function claimNFTOwner(address _nftContract, uint256 _tokenId)
        external
        nonReentrant
    {
        Auction memory auction = auctionForNFT[_nftContract][_tokenId];
    ...
    * @param _tokenId tokenId of NFT
     */
    function claimBidSeller(address _nftContract, uint256 _tokenId)
        external
        nonReentrant
    {
        Auction storage auction = auctionForNFT[_nftContract][_tokenId];
    ...
    * @param _tokenId tokenId of NFT
     */
    function claimNFTBidder(address _nftContract, uint256 _tokenId)
        public
        nonReentrant
    {
        Auction storage auction = auctionForNFT[_nftContract][_tokenId];
    ...
    * @param _tokenId tokenId of NFT
     */
    function claimBidAmount(address _nftContract, uint256 _tokenId)
        external
        payable
        nonReentrant
    {
