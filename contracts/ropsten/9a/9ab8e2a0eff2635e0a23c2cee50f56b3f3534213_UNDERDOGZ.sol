...
contract UNDERDOGZ is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function claimDividends(address payable _tokenHolder) nonReentrant() public {
        ...
        for(uint256 i = 0; i < balanceOf(msg.sender); i++) {
            ...
            // require(validClaimAmount <= maxDividendWhaleValue, "Claim amount exceeds maxDividendWhaleValue");
            // require(walletClaimAmount <= maxDividendWhaleValue, "Wallet claim amount exceeds maxDividendWhaleValue");

            _tokenHolder.transfer(dividendAmount * validClaimAmount);  
    }
}