    ...
    NectarImplementationPointerUpgradeable
{
     ...
     * @param _pair - Address of the NCTR/USDC pair
    ...
    function createBloomWithNectar(
        ...
        require(nectar.transferFrom(_msgSender(), address(this), _bloomValue), "3");
        ...
        onlyValidName(_bloomName)
    {
        ...
        require(usdc.transferFrom(_msgSender(), address(this), _bloomValue), "3");
     ...
     */
    function setNodeMinPriceNctr(uint256 _creationMinPriceNctr) external onlyOwner {
     ...
     */
    function setNodeMinPriceUsdc(uint256 _creationMinPriceUsdc) external onlyOwner {
