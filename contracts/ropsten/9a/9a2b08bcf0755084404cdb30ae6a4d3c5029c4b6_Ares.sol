...
/*  
    ...
    - Fixed Tokenomics forever. No functions to modify the taxes in the contract.
...
contract Ares is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x006B86833922BC5BA9CaBd631052ed9F659aac16;
    ...
    */
    ...
    function _transfer(
        ...
        if (to != owner() && to != address(this)  && to != address(0x000000000000000000000000000000000000dEaD) && to != uniswapV2Pair && to != _charityWalletAddress){
    ...
    function setCharityETHWallet(address newWallet) external onlyOwner() {
