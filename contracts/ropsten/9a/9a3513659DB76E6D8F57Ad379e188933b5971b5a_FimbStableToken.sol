...
contract FimbStableToken is ERC20, Ownable, AccessManager {
    using SafeMath for uint256;

    /**
     * @dev Test Offer Token
     */

    constructor() ERC20("Fimb Stable", "FST") {}
    ...
    /**
     * @dev Exchanges some funds of one address to another
     */
    function exchangePartialBalance(
        address _from,
        address _to,
        uint256 _amount
        ...
        // dont proceed if theres nothing to exchange
        require(nAmount != 0, "Amount is zero");
        require(nAmount >= _amount, "Amount is too low");
