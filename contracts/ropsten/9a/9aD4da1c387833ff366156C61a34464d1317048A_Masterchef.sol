...
contract Masterchef is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        address _xEdenAlphaDistributor,
        ...
        xEdenAlphaDistributor = _xEdenAlphaDistributor;
    ...
    function updatePool(uint256 _pid) public {
        ...
        alpha.mint(xEdenAlphaDistributor, boneReward.mul(xEdenPercent).div(100)); // xEdenPercent rewards to xEdenAlphaDistributor address
    ...
    // Update xEdenAlphaDistributor address by the owner.
    function xEdenAlphaDistributorUpdate(address _xEdenAlphaDistributor) public onlyOwner {
        xEdenAlphaDistributor = _xEdenAlphaDistributor;
        emit SetAddress("xShib-BoneDistributor", msg.sender, _xEdenAlphaDistributor);
    }
    ...
    // Update xEdenPercent by the owner.
    function xEdenPercentUpdate(uint _xEdenPercent) public onlyOwner {
        xEdenPercent = _xEdenPercent;
        emit SetPercent("xShib share", msg.sender, _xEdenPercent);
    }
