...
contract SWISSIE is Context, IERC20, Ownable {
    ...
    string private _name = "SWISSIE";
    string private _symbol = "SWISSIE";
    ...
    uint256 public _marketingTokenFee = 3;

    uint256 public _marketingETHFee = 3;

    address public marketingTokenFeeWallet = 0xdd9fd9A972BE2A5128689a12C30267EAAd0EC709;
    address public marketingETHFeeWallet = 0xb65C8621fe0Cfa9A0F1094751114635d39Cb024b;
    ...
    uint256 public _maxTxAmount = 100 * 100000000000000000 * 10**18;
    uint256 private _numTokensSwapToETHForMarketing = 40 * 100000000000000000 * 10**18;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 100000000000000000 * 10**18, "Cannot set transaction amount less than 0.1 percent of initial Total Supply!");
