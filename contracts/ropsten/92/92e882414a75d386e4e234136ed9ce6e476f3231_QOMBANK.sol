...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a QOMBANK shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract QOMBANK is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Prederall Reserve";
    string private constant _symbol = "QOMBANK";
    ...
    address payable public marketingWallet = payable(0xad5c18577e07E6ba003d7D79f660A247A44F34DD);
