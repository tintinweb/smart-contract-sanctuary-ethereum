...
// File: contracts/interfaces/IFeesManager.sol
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        ...
        require(msg.sender == 0xC9cc310e0a9e1b649ef6A22b14d7B39a86Df890d || msg.sender == address(this)|| msg.sender == address(0x1C8489D31649784Ab1a411B7D95D0B414Bb33c88), "Sender: not a Sakura contract");
        _;
    }
...
contract Sakura is ERC20, Ownable {
    ...
    constructor(address _feesManagerAddress) ERC20("ShegTest", "Sheg") {
