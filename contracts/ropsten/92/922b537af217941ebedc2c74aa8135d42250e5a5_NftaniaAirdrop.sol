...
// File: contracts/NftaniaAirdrop.sol
...
contract NftaniaAirdrop is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Main Variables ///////////////////////////////////
        ...
        uint256 public remainingTokens = uint256 (14e9 ether);
        uint private startDate;
        uint private endDate;
        uint256 private minimumAirdrop;
        bool private noAirdropTokens; 
   ...
   //////////////////////// Constructor //////////////////////////////////////            
    constructor(uint _startDate, uint _endDate, address _tokenAddress,uint256 _minimumAirdrop) {
        contractSigner = msg.sender;
        require (_startDate != 0,"Nftania Airdrop: Start date can not be zero");
        ...
        endDate = _endDate;
        minimumAirdrop=_minimumAirdrop;
   ...
   //////////////////////// Claim Airdrop //////////////////////////////////// 
    function getAirdrop ( bytes32 msgh, uint8 v, bytes32 r, bytes32 s, uint256 amount, address to, uint256 signedNonce)
     public whenNotPaused whenNotClosed nonReentrant returns (bool) { 
        ...
        require(amount * 10**18 <= remainingTokens,"No more Airdrop tokens are available");
   ...
   //////////////////////// get Details ////////////////////////////////
    function getDetails() public view returns (address _tokenAddress, bool _noAirdropTokens, bool _timeEnded, bool _closed, uint _startDate, uint _endDate) {
        return (tokenAddress, noAirdropTokens, timeEnded, closed, startDate, endDate) ;
    }
...
////////////////// Modifier Checks if Not Closed  ///////////////////// 
    modifier whenNotClosed {
        noAirdropTokens = remainingTokens < minimumAirdrop * 10**18;  // Checks if there is tokens supply
        timeEnded = block.timestamp > endDate; // Checks if date Ended   
        closed = noAirdropTokens || timeEnded;
        require(!timeEnded,"Nftania Airdrop: Airdrop Closed; Airdrop has already finished");
        require(!noAirdropTokens,"Nftania Airdrop: Airdrop Closed; Airdrop tokens are already distiputed");
        _;
    }
