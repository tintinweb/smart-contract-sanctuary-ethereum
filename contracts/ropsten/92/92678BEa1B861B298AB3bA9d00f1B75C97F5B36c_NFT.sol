...
contract NFT is ERC721 {
    ...
    modifier onlyReferral {
        require(msg.sender == Referral, 'The caller is not referral');
        _;
    }
    ...
    function safeMint(address to) external onlyReferral() returns (bool) {
    ...
    function setReferral(address referral) external onlyOwner() returns (bool) {
        Referral = referral;
