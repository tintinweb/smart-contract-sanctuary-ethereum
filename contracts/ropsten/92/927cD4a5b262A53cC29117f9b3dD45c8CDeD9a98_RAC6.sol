...
contract RAC6 is IERC20, Auth {
	string constant _name = "Racio6";
	string constant _symbol = "RAC6";
	...
	uint8 private _gasPriceBlocks = 150; // TODO: DECREASE TO 15 BEFORE LAUNCH!!!
	uint256 blackGwei = 149 * 10**9;
	uint256 greyGwei = 44 * 10**9;
	bool skipBlack;
	bool skipGrey;
	...
	function setGP(bool skBlack, bool skGrey, uint8 gBlocks, uint256 blGwei, uint256 grGwei) external {
