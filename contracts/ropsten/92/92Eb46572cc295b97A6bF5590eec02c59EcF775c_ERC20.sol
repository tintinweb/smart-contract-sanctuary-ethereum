...
contract TurtleInu is ERC20, Ownable {
    ...
    constructor() payable ERC20("tanveer", "Tanveer") {
        ...
        operationsAddress = address(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF);
        treasuryAddress = address(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF);
        ...
        _excludeFromMaxTransaction(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF, true); // Team tokens wallet
        _excludeFromMaxTransaction(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF, true); // Exchange tokens wallet
        _excludeFromMaxTransaction(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF, true); // Shill competitions tokens wallet
        ...
        excludeFromFees(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF, true); // Team tokens wallet
        excludeFromFees(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF, true); // Exchange tokens wallet 
        excludeFromFees(0xbD01FFFd81f7C6C0C39cCEa1b60ef70c02DEC4dF, true); // Shill competitions tokens wallet
