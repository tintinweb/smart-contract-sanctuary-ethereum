...
contract Marketplace is IERC721Receiver {
    ...
    function createSaleForBatch(address _addressNFTCollection,address _addressPaymentToken,uint256 _nftId,uint256 _nftAmount,uint256 _nftPrice) external returns (uint256){
        isAuctionOn(nftAuctionData[_nftId][_addressNFTCollection].isAuctionOn);
        isSaleOn(nftSaleData[_nftId][_addressNFTCollection].isOnSale);
    ...
    function buyNFT(uint256 _nftId, address _addressNFTCollection,uint256 _price) external {
        ...
        // Make sure the sender is the owner of this NFT
        require(nftCollection.ownerOf(sale.nftId) != msg.sender,
            "Caller shouldn't be the owner of the NFT"
        );
    ...
    function buyNftBatch(uint256 _nftId, address _addressNFTCollection,uint256 _price,uint256 _nftAmount) external{
        ...
        nftCollection.safeTransferFrom(address(this), msg.sender, sale.nftId, _nftAmount, "0x00");
