...
contract EnglishAuction is UpdateProxy{
    ...
    // complete Logic & tested
    function checkBidsPerId(address _user, uint _auctionNo) public view returns(uint[] memory){
        _auction storage a = auction[_auctionNo];
        bids storage b = _noOfBidsPerPerson[_user][_auctionNo];
