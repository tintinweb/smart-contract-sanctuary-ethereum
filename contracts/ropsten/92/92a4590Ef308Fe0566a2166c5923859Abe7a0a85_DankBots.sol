...
contract DankBots is ERC721A, Ownable {
	...
	address withdrawal_address = 0x992c6f5f330982d0BD6a30F5f545560482958Fb4;
	string baseURI = "";
	...
	uint256 public maxMintAmount = 5;		// max amount anyone can mint
	...
	// set/get whitelistRoot
	function setWhitelistRoot( bytes32 _newWhitelistRoot ) public onlyOwner {
	...
	// set/get freeRoot
	function setFreeRoot( bytes32 _newFreeRoot ) public onlyOwner {
	...
	function mintFree( bytes32[] calldata _merkleProof, uint256 _mintAmount) public payable {
