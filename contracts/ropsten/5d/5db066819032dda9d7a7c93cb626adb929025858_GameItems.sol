...
contract GameItems is ERC1155, ERC1155Burnable, Ownable {
    ...
    constructor(address Gtoken) public ERC1155("Gb-demo") {
        _mint(msg.sender, DEMO, 100, "");
        _mint(msg.sender, DEMO2, 100, "");
        _token = GoatedToken(Gtoken); 
    }
    ...
    function setTokenDetails ( uint256 tokenId,string calldata connectId) external {
        ...
        tokenMap[tokenId].connectId = connectId;
         _token._burnFrom(msg.sender,craftFee) ;
    }
    function setCraftFee (uint256 _craftfee) external onlyOwner{
        craftFee = _craftfee;
    }
}