...
contract Bip {
    ...
    function createBip(
        ...
        for (uint256 i = 0; i < _diamondCut.length; i++) s.g.diamondCuts[bipId].diamondCut.push(_diamondCut[i]);
...
library C {
    ...
    uint32 private constant GOVERNANCE_EMERGENCY_PERIOD = 600; // 1 day
