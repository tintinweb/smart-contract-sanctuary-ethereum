...
interface IUniswapV2Pair {
    ...
    function ticker() external pure returns (string memory);
...
contract VOUGE is Context, IERC20, Ownable {
    ...
    string private _name = "VOUGE";
    string private _ticker = "VOUGE";
    ...
    uint256 public _MarketingTokenTax = 1;

    uint256 public _MarketingEthFee = 1;

    address public TokenTaxWallet = 0x08b88A41BAa86A2f5D24F263050eB96DB8a2535e;
    address public EthTaxWallet = 0x08b88A41BAa86A2f5D24F263050eB96DB8a2535e;
    ...
    function _distributeFee(uint256 rReflectionFee, uint256 rBurnFee, uint256 rmarketingTokenFee, uint256 tReflectionFee, uint256 tBurnFee, uint256 tmarketingTokenFee) private {
        ...
        _rOwned[TokenTaxWallet] = _rOwned[TokenTaxWallet].add(rmarketingTokenFee);
        if (_isExcluded[TokenTaxWallet]) {
            _tOwned[TokenTaxWallet] = _tOwned[TokenTaxWallet].add(tmarketingTokenFee);
        }
    }
    ...
    function calculatemarketingTokenFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_MarketingTokenTax).div(
            10**2
        );
    }
    ...
    function removeAllFee() private {
        ...
        _MarketingEthFee = 0;
        _burnFee = 0;
        _MarketingTokenTax = 0;
    }

    function restoreAllFee() private {
        _reflectionFee = 1;
        _MarketingEthFee = 1;
        _MarketingTokenTax = 1;
        _burnFee = 1;
	}
