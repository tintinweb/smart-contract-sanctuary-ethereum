...
contract Treasury is Ownable {
  ...
  function swap(address _uniRouterAddress, uint _amount, address[] memory path) public {
    _safeSwap(_uniRouterAddress, _amount, slippageFactor, path, address(this), block.timestamp + 600);
  }
