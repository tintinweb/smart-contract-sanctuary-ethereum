...
contract SCXyLock is ISCXyLock, Ownable {
    ...
    uint256 unlockTimerSeconds = 300; //30 * 24 * 3600 - 30 days expressed in seconds, 300 - 5 mins testnet
    uint256 minimumPayableEthInWei = 1 * 10**17; //lock Fee in wei
    uint256 minimumSCXHolding = 10000000 * 10**9; // minimum amount of SCX or xSCX tokens to be held to create free lock
