...
contract ShibaZeusGosToken is Context, IERC20, Ownable {
    ...
    string private _name = "God of Slot Token";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_tTotal * 45) / 100000; 
    uint256 public _maxWalletToken = ( _tTotal * 45 ) / 100000; 
