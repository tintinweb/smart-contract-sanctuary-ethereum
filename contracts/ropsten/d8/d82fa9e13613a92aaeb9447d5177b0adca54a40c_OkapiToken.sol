...
contract OkapiToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function OkapiToken() {
        ...
        name = "Okapi Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "OKP";                                             // Set the symbol for display purposes (CHANGE THIS)
