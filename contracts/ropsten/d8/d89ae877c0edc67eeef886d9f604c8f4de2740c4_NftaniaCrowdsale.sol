...
contract NftaniaCrowdsale is Pausable, Ownable, ReentrancyGuard {
   ...
   //////////////////////// Get Results //////////////////////// 
    function getEthInfo () external view returns (uint _balance, uint256 _weiRaised, uint256 _poolRaised, uint256 _freeBalance, uint256 _revenueRaised) {
        _freeBalance = address(this).balance - poolBalance;
        return (address(this).balance, weiRaised, poolRaised, _freeBalance, revenueRaised);
    }
