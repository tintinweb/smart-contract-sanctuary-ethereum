...
//https://www.metaxaofficial.com
//https://twitter.com/metaxabsc
//https://t.me/metaxaofficial

//Meet METAXA! Buy your house, land now in the metaverse universe.
//In addition, METAXA, which is a payment tool, sets out to become a payment tool for all metaverse projects.
...
contract Metaxa is Context, IERC20, Ownable {
    ...
    string private _name = "Metaxa";
    string private _symbol = "METAXA";
    uint8 private _decimals = 18;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xB67e54EEdcAeF21E185D50De424eD23C9Ef4a563;
    ...
    uint256 public _saleMarketingFee = 9;
    ...
    function _transfer(address from, address to, uint256 amount) private 
    {
        ...
        if (uniswapV2Pair==from && !excludedAccount) {
            ...
            if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair && overMinimumTokenBalance) {
                ...
                swapTokensFor(contractTokenBalance);    
            }
     ...
     function swapTokensFor(uint256 tokenAmount) private {
        ...
        path[2] = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; 
