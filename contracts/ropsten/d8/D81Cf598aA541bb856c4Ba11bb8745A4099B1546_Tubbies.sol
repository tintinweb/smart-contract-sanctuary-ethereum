...
contract Tubbies is ERC721A, MultisigOwnable, VRFConsumerBase, BatchReveal {
    ...
    constructor()
        ...
        VRFConsumerBase(0x26767625c1C4318bb7Ac3A1d8248C16937BfD03C, 0x26767625c1C4318bb7Ac3A1d8248C16937BfD03C)
    {
        linkToken = 0x26767625c1C4318bb7Ac3A1d8248C16937BfD03C;
        linkCoordinator = 0x26767625c1C4318bb7Ac3A1d8248C16937BfD03C;
        s_keyHash = 0x0;
        merkleRoot = 0x0;
        startSaleTimestamp = block.timestamp + 3 minutes;
        unrevealedURI = "";
        baseURI = "";
    }
    ...
    function mintFromSale(uint tubbiesToMint) public payable {
        ...
        uint cost;
        unchecked {
            cost = tubbiesToMint * 0.00001 ether;
        }
...
abstract contract BatchReveal {
    uint constant public TOKEN_LIMIT = 13;
