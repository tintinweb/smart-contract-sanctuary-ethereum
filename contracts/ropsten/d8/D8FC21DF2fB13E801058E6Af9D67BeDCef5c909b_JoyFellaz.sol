...
contract JoyFellaz is ERC721, Ownable {
  ...
  {
      if(_supply < 10 && cost == 15000000000000000){
           return 0.00 ether;
       } 
      else if (_supply < 10 && cost != 15000000000000000){
           return cost;
       }
  ...
  {
      if(_supply < 10 && maxTokensPerWallet == 1) {
           return 1;
       } 
        else if (_supply < 10 &&  maxTokensPerWallet != 1){
           return maxTokensPerWallet;
       }
      else if (_supply <= maxSupply && maxTokensPerWallet == 500){
           return 500;
       }
        else if (_supply <= maxSupply && maxTokensPerWallet != 500){
           return maxTokensPerWallet;
