...
contract ANTIMATTER is ERC20, Ownable {
    ...
    constructor() ERC20("ANTI MATTER", "XMATTER") {
        ...
        marketingWallet = address(0x52d0f01B8dA8aa98a54A184Fe83548AaD389AdE9); // set as marketing wallet
        devWallet = address(0xEF84e26cE453B33dC9C4240986833102c45FFD87); // set as dev wallet
