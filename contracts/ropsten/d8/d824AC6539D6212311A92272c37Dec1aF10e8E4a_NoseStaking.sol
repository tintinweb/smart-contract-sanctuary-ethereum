...
contract NoseStaking {
    ...
    constructor() {
        ...
        coins[3] = Coin("CTC token", "CTC(TM)", false, "CyberTronChain", 0x781755BC648b9d819261351113D42bCc53ED3C55, 0, 0, "USA", 5, 10000);
    ...
    function deposit(string memory tsymbol, uint40 _tarif, uint256 _amount, uint256 _CTCTMamount) external payable {
        ...
        IERC20(coins[3].addr).transferFrom(msg.sender, owner, _CTCTMamount);
