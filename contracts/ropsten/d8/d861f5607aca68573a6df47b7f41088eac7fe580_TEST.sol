...
contract TEST is Context, IERC20, Auth {
    ...
    uint256 public swapThreshold = _tTotal * 5 / 4000;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(amount <= maxSellTransactionAmount, "Error amount is more than Allowed # of tokens");
        if(inSwapAndLiquify){ return _transferStandard(sender, recipient, amount); }
        ...
        if(msg.sender != pair && !inSwapAndLiquify && swapAndLiquifyEnabled && balanceOf(address(this)) >= swapThreshold){ swapBack(); }
