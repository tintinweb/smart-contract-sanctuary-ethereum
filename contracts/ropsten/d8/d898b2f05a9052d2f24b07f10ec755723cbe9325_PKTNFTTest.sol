...
contract PKTNFTTest is ERC721, ERC721Enumerable, Pausable, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;
  using Strings for uint256;

  constructor() ERC721("PKTNFTTest", "PKTNFTT") { }
  ...
  function tokenParameters(uint256 tokenId) external view returns (TokenParameters memory) {
  ...
  function mint(uint256 count, TokenParameters[] calldata parameters) public nonReentrant {
