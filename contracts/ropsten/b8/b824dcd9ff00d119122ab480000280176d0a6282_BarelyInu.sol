...
contract BarelyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Barely Inu";
    ...
    constructor () {
        ...
        _rewardWallet = payable(0xcD11d4f84E6dD5CF256e595557Ebd482399087ec);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 1e7 * 10**9;
        _maxSellAmount = 1e7 * 10**9;
        _maxWalletAmount = 3e7 * 10**9;
