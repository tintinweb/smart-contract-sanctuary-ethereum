...
contract OoToken is Context, IERC20, Ownable {
    ...
    function setBuyBurnFee(uint256 buyFee) external onlyOwner{
        _buyBurnFee = buyFee;
    }

    function setSellBurnFee(uint256 sellFee) external onlyOwner{
        _sellBurnFee = sellFee;
    }
