...
// File: contracts/MintNFTUpgradeable.sol
...
contract MintNFTUpgradeable is Initializable, ERC721EnumerableUpgradeable {
    ...
    function initialize() external initializer {
        __ERC721_init("MyNFTTest2", "NTEST");
        owner = msg.sender;
    }
    ...
    function mintNftToken(string memory _tokenURI)
        external
        onlyOwner
        returns (uint256)
    {
