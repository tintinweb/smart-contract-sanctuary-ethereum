...
contract CryptoAnts is ERC721, ICryptoAnts {
  ...
  function buyEggs(uint256 _amount) external payable override lock {
    ...
    require(msg.value / _eggPrice == _amount, 'Not enough eth to mint EGGs'); //TODO: is division by 1e18 good tyle?
  ...
  function _isAntTired(uint256 _antId) internal view returns (bool) {
    return antHatchTime[_antId] + 10 seconds > block.timestamp; //TODO: change to 10 minutes
  }
