...
contract Porkchampsv2 is ERC721A, Ownable {
    ...
    constructor() payable ERC721A("Porkchampsv2", "PKC") {}
        ...
        returns (bool)
    {
        ...
        return signer == saleConfig.adminSigner;
    }
    ...
    function allowlistMint(
        ...
        require(
            balanceOf(msg.sender) + quantity < allowance + 1,
    ...
    function setSaleConfig(
        uint64 allowlistSaleStartTime,
        uint64 publicSaleStartTime,
        uint64 allowlistPriceWei, // is uint64 enough?
        uint64 publicPriceWei,
        address adminSigner
    ) external onlyOwner {
    ...
    function setSigner(address _address) external onlyOwner {
        ...
        saleConfig.adminSigner = _address;
    }

    // This acts as a pause feature and also end of publicMinting phase toggle
    ...
    function withdrawMoney() external onlyOwner {
        address vault = payable(0x53782988F6A1d338d97f3B4eCF12653f5F8c1873);
