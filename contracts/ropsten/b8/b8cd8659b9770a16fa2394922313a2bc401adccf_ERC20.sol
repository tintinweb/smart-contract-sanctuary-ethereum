...
contract ERC20 is Context, IERC20, Ownable {
    ...
    string public symbol = "TT-006";
    uint256 public decimals = 18;

    address public usdt = 0x110a13FC3efE6A245B50102D2d79B3E76125Ae83;
    IUniswapV2Router02 public uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address public uniswapV2Pair;
    address lpShareDealAddress;

    mapping(address => address) public recommenderMap;

    address market = 0x8EdEc8119Bf67b761a7593C668BcFb4B376ce46E;
    address marketing = 0xD0eBF65e855A9C1f7d839B0129ac9ea027C4fB16;
    address platform = 0x896D50f1f893A89f40EF9374C927f560fCA0667e;
    address lp = 0x869846F60d9c553D58c17e98a5301e8baD7Ece63;
    ...
    uint256 minLpShareToDeal = 100 * 10 ** decimals;
    uint256 minLpShareToTrans = 10 * 10 ** decimals;
    ...
    function _tradeControl(address from, address to, uint256 amount) private {
        if (from == address(uniswapV2Pair) || to == address(uniswapV2Pair)) {
            ...
            if (!startNotLimit[addr]) {
                ...
                } else if (startTime + 8 > block.timestamp) {
                    blacklist[addr] = true;
    ...
    function _countFee(address from, address addr, uint256 amount) private returns(uint256 finalAmount) {
        ...
        _addBalance(from, liquidityManager, lpShareFee);
    ...
    function _swapForLiquidity() private swapLock {
        ...
        Address.functionCall(liquidityManager, abi.encodeWithSelector(0x24b1c2ba));
    }
