...
contract _5x5guys is Ownable{
    ...
    function mint_5x5guy(string memory str) public payable returns (uint256) {
        ...
        require(chars.length == 71, "Wrong string format");

        require(keccak256(bytes(chars[0])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[1])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[7])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[8])) == keccak256(bytes("\n")), "Wrong string format");
        require(keccak256(bytes(chars[9])) == keccak256(bytes(" ")), "Wrong string format");
        ...
        require(keccak256(bytes(chars[39])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[40])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[41])) == keccak256(bytes(">")), "Wrong string format");
        require(keccak256(bytes(chars[44])) == keccak256(bytes("\n")), "Wrong string format");
        require(keccak256(bytes(chars[53])) == keccak256(bytes("\n")), "Wrong string format");
        require(keccak256(bytes(chars[56])) == keccak256(bytes("`")), "Wrong string format");
        require(keccak256(bytes(chars[61])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[62])) == keccak256(bytes("\n")), "Wrong string format");
        require(keccak256(bytes(chars[63])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[64])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[65])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[66])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[69])) == keccak256(bytes(" ")), "Wrong string format");
        require(keccak256(bytes(chars[70])) == keccak256(bytes(" ")), "Wrong string format");
