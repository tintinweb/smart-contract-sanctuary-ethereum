...
import "./CryptoPoet.sol";

interface Skill {
    function onRoundStartCallBack(uint256[] memory teamPoets, uint256[] memory opponentPoets) external;

    function onDeadCallback(uint256[] memory teamPoets, uint256[] memory opponentPoets) external;

    function onDamagedCallback(uint256[] memory teamPoets, uint256[] memory opponentPoets) external;
}
