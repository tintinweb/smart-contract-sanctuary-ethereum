...
contract General is ERC20, Ownable {
    ...
    // Namings
    string private projectName = "Project Name";
    string private tokenName = string.concat("$", "PN");
   ...
   // Exlcude from fees and max transaction amount
    ...
    constructor() ERC20(projectName, tokenName) {
        ...
        // Wallets
        devWallet = address(0x08F5C7646762201C97D01b645f9c420dD9b405fb);
        marketingWallet = address(0x08F5C7646762201C97D01b645f9c420dD9b405fb);
    ...
    function updateMaxTxnAmount(uint256 newAmount) external onlyOwner {
        require(newAmount >= ((totalSupply() * 1) / 1000) / 10e18, "Cannot set maxTransactionAmount lower than 0.1%");
        maxTransactionAmount = newAmount * 10e18; //(10**18);
    }

    // Update maximum wallet amount
    function updateMaxWalletAmount(uint256 newAmount) external onlyOwner {
        require(newAmount >= ((totalSupply() * 5) / 1000) / 10e18, "Cannot set maxWallet lower than 0.5%");
        maxWalletAmount = newAmount * 10e18; //(10**18);
    }
