...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable{
    ...
    uint256 private constant _tTotal = 15_000_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 private _liquidityFee = 2;
    uint256 private _reflectionFee = 5;
    uint256 private _treasuryFee = 4;
    uint256 private _mktDevFee = 3;
    ...
    uint256 private numTokensSellToAddToLiquidity = 100_000 * 10**_decimals;
