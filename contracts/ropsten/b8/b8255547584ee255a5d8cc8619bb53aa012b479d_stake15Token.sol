...
//
// Deployed to : 0xb8255547584ee255a5d8cc8619bb53aa012b479d
// Symbol      : STAKE15
// Name        : STAKE15 Token
...
contract stake15Token is StandardToken {

    // metadata
    string  public constant name = "STAKE15 Token";
    string  public constant symbol = "STAKE15";
    ...
    function transferETHtoContract(uint256 _amt) isOwner external {
          ...
          require(_amt > 0);
          require(address(msg.sender).balance >= _amt);
