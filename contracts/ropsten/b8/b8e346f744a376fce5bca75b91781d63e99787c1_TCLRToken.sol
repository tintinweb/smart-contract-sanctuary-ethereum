...
uint256 public totalAllocated = 0;             // Counter to keep track of overall token allocation
    ...
    bool public isteams=isTransferAllowedteam();
    
    bool public istear=false;
///////////////////////////////////////// MODIFIERS /////////////////////////////////////////
...
///////////////////////////////////////// ALLOCATION FUNCTIONS /////////////////////////////////////////
    ...
    function allocateTCLRinTeamTokens() ownerOnly returns(bool success) {
...
return true;
    ...
    function isTransferAllowed() internal constant returns(bool) {
        if (now >= endTime || isReleasedToPublic == true && msg.sender==owner) {
        
        //if (isReleasedToPublic == true) {
