...
/**
 * @title Illuvitars Metadata Builder
 *
...
contract IlluvitarsMetadataBuilderImpl is IlluvitarsMetadataBuilder, UUPSUpgradeable, OwnableUpgradeable {
    /// @dev Emitted when a dictionary address is changed
    event UpdateDictionaryAddress(string indexed name, address newAddress);
    ...
    /**
     * @dev Initialize Illuvitars Metadata Builder.
     *
    ...
    function initialize(address _portraitDictionary, address _accessoryDictionary) external initializer {
        ...
        emit UpdateDictionaryAddress("Portrait", _portraitDictionary);
        emit UpdateDictionaryAddress("Accessory", _accessoryDictionary);
    }

    /**
     * @dev Set Portrait Dictionary address, must be non-zero address.
     *
     * @dev Current version of Portrait Dictionary doesn't support ERC165, so any
     *  address can be set.
     *
     * @dev Only owner can do the change.
     *
     * @param _portraitDictionary new Portrait Dictionary address.
     */
    ...
    /**
     * @dev Set Accessory Dictionary address, must be non-zero address.
     *
     * @dev Current version of Accessory Dictionary doesn't support ERC165, so any
     *  address can be set.
     *
     * @dev Only owner can do the change.
     *
     * @param _accessoryDictionary new Portrait Dictionary address.
     */
    ...
    /**
     * @dev Builds D1sk metadata (OpenSea standard).
     *
     * @dev Called by {tokenURI} function of D1sk contract.
     *
     * @dev Can be pratically called by any address, with no risks involved,
     *  since it's  view function.
     *
     * @param _tokenId ID of the token to have it's metadata formatted.
     * @return Base64 formatted metadata (OpenSea standard).
     */
    function buildD1skMetadata(uint256 _tokenId) external view returns (string memory) {
        // assuming the function was called by the D1sk contract itself,
    ...
    /**
     * @dev Builds Portrait metadata (OpenSea standard).
     *
     * @dev Called by {tokenURI} function of Portrait contract.
     *
     * @dev Can be pratically called by any address, with no risks involved,
     *  since it's  view function.
     *
    ...
    /**
     * @dev Builds Accessory metadata (OpenSea standard).
     *
     * @dev Called by {tokenURI} function of Accessory contract.
     *
     * @dev Can be pratically called by any address, with no risks involved,
     *  since it's  view function.
     *
    ...
    /**
     * @dev Get the D1sk metadata array.
     *
     * @param _tokenId ID of the D1sk token.
     * @param _metadata D1skMetadata associated with {_tokenId}.
     * @return array containing the formatted metadata to be concatenated (OpenSea standard).
     */
    ...
    /**
     * @dev Get D1sk token name.
     *
     * @param _metadata D1skMetadata for the D1sk token.
     * @return The name of the D1sk token.
     */
    function _d1skName(D1skMetadata memory _metadata) internal pure returns (string memory) {
        if (_metadata.packType == PackType.Basic) return "Basic D1sk";
        return "Ultra D1sk";
    }

    // TODO: Returns empty string in the moment.
    function _d1skDescription(D1skMetadata memory _metadata) internal pure returns (string memory) {
        // TODO: Add description for the D1sk
        _metadata;
        return "";
    }

    /**
     * @dev Builds D1sk token attributes array (OpenSea standard);
     *
     * @param _metadata D1skMetadata for the underlying D1sk token.
     * @return D1sk attributes stringfied array for OpenSea "attributes" metadata field.
     */
    ...
    /**
     * @dev Translate {PackType} enum to string.
     *
     * @param _packType PackType enum value.
    ...
    /**
     * @dev Get the Accessory metadata array.
     *
     * @param _tokenId ID of the Accessory token.
     * @param _metadata AccessoryMetadata associated with {_tokenId}.
     * @param _accessoryDictionary Accessory Dictionary instance.
     * @return array containing the formatted metadata to be concatenated (OpenSea standard).
     */
    ...
    /**
     * @dev Builds Accessory token attributes array (OpenSea standard);
     *
     * @param _metadata AccessoryMetadata for the underlying D1sk token.
     * @param _accessoryDictionary Accessory Dictionary instance.
     * @return Accessory attributes stringfied array for OpenSea "attributes" metadata field.
     */
        ...
        returns (string memory)
    {
        ...
        accessoryAttributes = abi.encodePacked(
            accessoryAttributes,
            _formatAttribute("Type", string(_getAccessoryType(_metadata, _accessoryDictionary))),
            ","
        );
        accessoryAttributes = abi.encodePacked(
            accessoryAttributes,
    ...
    /**
     * @dev Builds Accessory Type.
     *
     * @param _metadata AccessoryMetadata for the underlying Accessory token.
     * @param _accessoryDictionary Accessory Dictionary instance.
     * @return Accessory Type.
     */
    function _getAccessoryType(AccessoryMetadata memory _metadata, AccessoryDictionary _accessoryDictionary)
        internal
        view
    ...
    /**
     * @dev Get the Portrait metadata array.
     *
     * @param _tokenId ID of the Portrait token.
     * @param _metadata PortraitMetadata associated with {_tokenId}.
     * @param _portraitDictionary Portrait Dictionary instance.
     * @return array containing the formatted metadata to be concatenated (OpenSea standard).
     */
    ...
    /**
     * @dev Get the Portrait Type Array.
     *
     * @param _metadata PortraitMetadata associated with {_tokenId}.
     * @param _portraitDictionary Portrait Dictionary instance.
     * @return array containing the formatted "Type" to be concatenated.
     */
    ...
    /**
     * @dev Builds Background Type.
     *
     * @param _metadata PortraitMetadata for the underlying Portrait token.
     * @param _portraitDictionary Portrait Dictionary instance.
    ...
    /**
     * @dev Builds Portrait token attributes (OpenSea standard);
     *
     * @param _metadata PortraitMetadata for the underlying Portrait token.
     * @param _portraitDictionary Portrait Dictionary instance.
     * @return Portrait attributes string for OpenSea "attributes" metadata field.
     */
        ...
        returns (string memory)
    {
...

        {
            ...
            for (uint8 i = 0; i < accessoryIdsStrings.length - 1; i++) {
                portraitAttributes = abi.encodePacked(portraitAttributes, accessoryIdsStrings[i], ",");
            }
            portraitAttributes = abi.encodePacked(
                portraitAttributes,
                accessoryIdsStrings[accessoryIdsStrings.length - 1]
            );
        }
    ...
    /**
     * @dev Get array containing the formatted Slot ID attributes.
     *
     * @param _metadata Portrait token metadata instance.
     * @return Slot ID attributes' array to be concatenated with trailing comma.
     */
    ...
    /**
     * @dev Format attribute field in OpenSea standard.
     *
     * @param _attributeName name of the attribute field.
     * @param _attributeValue string value for the attribute field.
     * @return stringified formatted attribute field (OpenSea standard).
     */
        ...
        returns (bytes memory)
    {
...

        {
            ...
            for (uint8 i = 0; i < illuvitarSpecificAttributesString.length - 1; i++) {
                illuvitarAttributes = abi.encodePacked(illuvitarAttributes, illuvitarSpecificAttributesString[i], ",");
            }
            illuvitarAttributes = abi.encodePacked(
                illuvitarAttributes,
                illuvitarSpecificAttributesString[illuvitarSpecificAttributesString.length - 1]
            );
        }
    ...
    /**
     * @dev Get array of formatted general attributes for Illuvitar.
     *
     * @param _metadata PortraitMetadata for the underlying Portrait token.
     * @param _portraitDictionary Portrait Dictionary instance.
     * @return general Illuvitar attributes' array to be concatenated with trailing comma.
     */
    ...
    /**
     * @dev Get array of formatted specific attributes for Illuvitar.
     *
     * @param _metadata PortraitMetadata for the underlying Portrait token.
     * @param _portraitDictionary Portrait Dictionary instance.
     * @return specific Illuvitar attributes' array to be concatenated with trailing comma.
     */
    ...
    /**
     * @dev Get array of formatted background attributes.
     *
     * @param _metadata PortraitMetadata for the underlying Portrait token.
     * @param _portraitDictionary Portrait Dictionary instance.
     * @return formatted background attributes' array to be concatenated with trailing comma.
     */
    ...
    /**
     * @dev Returns the bytes representation of the given uint256.
     *
     * @param i uint256 to be converted.
     * @return a bytes representation of the uint256 string.
     */
