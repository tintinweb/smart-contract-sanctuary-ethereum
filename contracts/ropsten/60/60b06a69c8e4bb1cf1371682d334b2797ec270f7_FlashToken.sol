...
contract DividendPayingToken is BEP20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    address public constant BUSD = address(0xc778417E063141139Fce010982780140Aa0cD5Ab); //BUSD
...
/* FLASH.sol */
contract FlashToken is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    function swapAndSendToFee(uint256 tokens, address to) private  {
        ...
        IBEP20(BUSD).transfer(to, newBalance);
    }
    ...
    function swapAndSendDividends(uint256 tokens) private{
        ...
        try IBEP20(BUSD).transfer(address(dividendTracker), dividends){
...
contract FLASHDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("FLASH_Dividen_Tracker", "FLASH_DTker") 
    {
    	claimWait = 21600;
