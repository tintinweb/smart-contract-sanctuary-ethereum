...
contract CryptoPA2 is 
    ...
    //=============== variable =======================
        ...
        address __devAddress1 = 0xc9b6321dc216D91E626E9BAA61b06B0E4d55bdb1;
        address __devAddress2 = 0xBD152AcFA5f810Cba903c2eFe7074Be88E335f50;
    //=============== calc function ======================
        function _setDefault() internal onlyOwner{
            //for(uint i = 0; i < MaxSupply; i++) 
            //    __tokenUsed[i] = false;
            BaseURI="https://gateway.pinata.cloud/ipfs/QmPux5AYJPrV7Vb3hqhk7piFom9s58oZrZAkdVMRVuNf8r/";
        }
        ...
        function _getNewTokenId() public returns (uint256 newID) {
            while (true) {
        ...
        function _tryGetRandomId() private returns (uint256 randID) {
            randID = _generateRandomId();
            if (__tokenUsed[randID]) {
                randID= 0;
            }
        }

        function _generateRandomId() private returns (uint256 newID) {
            ...
            newID=__tokenIds[index] != 0 ? __tokenIds[index] : index;
    ...
    //=========================================
        function mint(uint256 _numberToMint) external payable whenMintIsLive {
            ...
            require(totalMinted * __mintPrice <= msg.value, "Inconsistent amount sent!");
