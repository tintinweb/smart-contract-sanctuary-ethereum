...
contract MysteriousDefi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x91BE0B3F5992Db98EA395e2033BdED563c882f97); // Marketing Address

    address payable public liquidityAddress =
        payable(0xD6279b8f8653e7ADb93eA6409c625cF3486201bc); // Liquidity Address
    ...
    string private constant _name = "Mysterious Defi";
    string private constant _symbol = "MDefi";
    uint8 private constant _decimals = 18;

    uint256 private constant BUY = 0;
    uint256 private constant SELL = 12;
    uint256 private constant TRANSFER = 12;
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 1 / 1000; // 0.1% max txn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05%
        maxWallet = _tTotal * 3 / 1000; // 0.3%
        ...
        liquidityAddress = payable(address(0xD6279b8f8653e7ADb93eA6409c625cF3486201bc)); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
