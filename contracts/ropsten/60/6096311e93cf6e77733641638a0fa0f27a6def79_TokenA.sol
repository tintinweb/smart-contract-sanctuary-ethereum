...
contract TokenA is ERC20, Ownable{
    ...
    constructor (address _peggedBTCToken, address _preSaleWallet, address _teamWallet, address _developmentWallet, address _airdropWallet, address _lockerWallet, address _marketingWallet) ERC20 ("PiratePennies", "PRP"){
        _mint(_preSaleWallet, preSaleTotalSupply);  // 26% tokens in presale and liquidity to create a launchpad on pinksale
