...
contract ImxImperialGallery is ERC721, Pausable, AccessControl, Ownable, IMintable {
    ...
    constructor(address _imx) ERC721("ImxImperialGallery", "IMXIG") {
        imx = _imx;
    ...
    // IMX calls this to mint on L1
    function mintFor(address to, uint256 quantity, bytes calldata mintingBlob)
        external 
        override
        onlyRole(MINTER_ROLE)
    {
