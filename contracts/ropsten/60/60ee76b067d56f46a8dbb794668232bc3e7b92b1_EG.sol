...
contract EG is Context, IERC20, Ownable {
    ...
    string private constant _name = "EG";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x9a06fAb3849Da44818158B0C5Ec172DAdd3c03EE);
    ...
    function EGS(address Recipient, string memory InsertMessage) external{
