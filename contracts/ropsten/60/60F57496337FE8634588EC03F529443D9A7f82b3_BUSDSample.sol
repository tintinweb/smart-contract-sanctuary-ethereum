...
contract BUSDSample is BUSDImplementation {

    constructor() BUSDImplementation() public {}
...
contract BUSDImplementation {
    ...
    string public constant name = "ITGOLD USD"; // solium-disable-line
    string public constant symbol = "IUSD"; // solium-disable-line uppercase
