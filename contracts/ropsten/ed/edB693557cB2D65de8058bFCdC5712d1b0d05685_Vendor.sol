...
contract Vendor is Ownable {
    ...
    function buyTokens() public payable {
        ...
        console.log(amount);
        require(
            amount <= yourToken.balanceOf(address(this)),
            "Insufficient yourToken balance from vendor"
        );
