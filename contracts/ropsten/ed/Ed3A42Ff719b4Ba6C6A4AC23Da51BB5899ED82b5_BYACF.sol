...
contract BYACF is ERC721A, Ownable {
    ...
    constructor()        
    {
       setNotRevealedURI('https://opensea.mypinata.cloud/ipfs/QmSnVcUMEpDCSe5uwm5KEMySLnV266dVxzFxH25cnrdS1x');
...
contract ERC721A is Context, ERC165, IERC721A {
    ...
    constructor() {       
        _name = "BORED APE YACHT CLUB FANS";
        _symbol = "BAYCF";
