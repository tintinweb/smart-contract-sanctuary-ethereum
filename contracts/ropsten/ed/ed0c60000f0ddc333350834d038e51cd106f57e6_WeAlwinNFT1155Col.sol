    ...
    ERC1155Burnable
{
    ...
    WeAlwinNFT1155 public  WeAlwinNFT1155M;
    ...
    constructor(    
        ...
        WeAlwinNFT1155 _WeAlwinNFT1155M = WeAlwinNFT1155(adminContract);
        // set the rest of the contract variables
        WeAlwinNFT1155M = _WeAlwinNFT1155M;
    ...
    function getServiceFeeWA() public view returns (uint256) {
        return  WeAlwinNFT1155M.getServiceFeeWA();
    }

    function getServiceFee() public view returns (uint256) {
        return  WeAlwinNFT1155M.getServiceFee();
    }
    ...
    function _saleToken(
        ...
        uint256 serviceVal = WeAlwinNFT1155M.getServiceFee();
        if(keccak256(bytes(bidtoken)) == keccak256(bytes("WA")))
        {
             serviceVal = WeAlwinNFT1155M.getServiceFeeWA();
        }

        address payable admin =  payable(WeAlwinNFT1155M.getOwner());
    ...
    function _acceptBId(
        ...
        uint256 serviceVal = WeAlwinNFT1155M.getServiceFee();
        if(keccak256(bytes(tokenAss)) == keccak256(bytes("WA")))
        {
             serviceVal = WeAlwinNFT1155M.getServiceFeeWA();
        }
