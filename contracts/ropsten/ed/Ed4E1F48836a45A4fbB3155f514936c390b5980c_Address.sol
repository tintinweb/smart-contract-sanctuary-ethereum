...
contract Bitasset is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="blue" /><text x="25" y="25" class="base">SOLIDUS</text><text x="25" y="230" class="base">';
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Bitasset #',
                        toString(tokenId),
                        '", "description": "ppp", "image": "data:image/svg+xml;base64,',
    ...
    constructor() ERC721("Bitasset", "BTA") Ownable() {}
}
