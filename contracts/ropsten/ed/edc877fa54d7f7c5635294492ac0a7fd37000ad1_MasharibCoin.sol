...
contract MasharibCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MasharibCoin() {
        ...
        name = "MasharibCoin";                                   // Set the name for display purposes (CHANGE THIS)
