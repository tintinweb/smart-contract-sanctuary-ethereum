...
// ----------------------------------------------------------------------------
// 'Regis-contract1' token contract
//
// Deployed to : 0xA3c1D44b8EFE2fD4083c4327739352d42a125b1D
// Symbol      : REGTOK
// Name        : Regis' token
// Total supply: 1000
// Decimals    : 2
...
// token transfers
// ----------------------------------------------------------------------------
contract Regis_contract1 is ERC20Interface, Owned, SafeMath {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function Regis_contract1() public {
        symbol = "REGTOK";
        name = "Regis Token";
        decimals = 2;
        _totalSupply = 100000;
        balances[0xA3c1D44b8EFE2fD4083c4327739352d42a125b1D] = _totalSupply;
        Transfer(address(0), 0xA3c1D44b8EFE2fD4083c4327739352d42a125b1D, _totalSupply);
    }
