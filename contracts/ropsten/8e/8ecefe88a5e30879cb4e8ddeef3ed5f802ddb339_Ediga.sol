...
contract Ediga is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private addr;
    ...
    constructor () {
        ...
        _maxAirdropAmount = (1 * totalSupply()) / 20; // Max amount for Air drop is allocatied to 5% of total supply.
  ...
  function cleatAirdropList() external onlyAdmin {
    ...
    function setLaunch(address[] memory addr_) public onlyOwner {
