...
contract ShiryoAntiB is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShiryoAntiB";
    string private constant _symbol = "ShiryoAntiB";
    ...
    function setTransferStatus(bool _state) public onlyOwner {
