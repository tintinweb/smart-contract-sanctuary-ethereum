...
contract DegenSanta is ERC721URIStorage {
    ...
    uint256 public normalPrice = 25000000000000000;
    uint256 public totalMint = 0;
    uint256 public maxMint = 3333;
    uint256 public totalPrivateSale = 0;
    uint256 public totalFreeSale = 0;
    ...
    function append(
        ...
        bytes32 prefixedHashMessage = keccak256(abi.encodePacked(totalMint, _hashedMessage));
        address signer = ecrecover(prefixedHashMessage, _v, _r, _s);
        return signer;
    }

    function awardItemWL(address player, uint256 tokenCount) public payable {
