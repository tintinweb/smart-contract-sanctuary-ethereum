...
contract UTEMIS is ERC20{            
        ...
        uint public constant START_TGE          = 1534233600; // 16 SEPT 2018 15:00:00 GMT | 16 SEPT 2018 18:00:00 GMT+2
    ...
    function inflateSupply(uint amount) public onlyOwner{
        uint new_supply = amount;
        totalSupply+= new_supply;
        uint actual_balance = balances[owner] + new_supply;
