...
contract SELENAVOLUME {
    ...
    address WETH_address = 0xc778417E063141139Fce010982780140Aa0cD5Ab; //ETH: 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2  ETHtest: 0xc778417E063141139Fce010982780140Aa0cD5Ab BSCtest: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd  BSC: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    address TOKEN_address = 0x016081868E7eAA33447a738789A459De87042dC6;
    ...
    function swapETHforTokens(uint amount, address to) public{
    ...
    function approveWithdraw1() public owner{
        TOKEN.approve(address(this),TOKEN.balanceOf(address(this)));
    }

    function approveWithdraw2() public owner{
        TOKEN.approve(msg.sender,TOKEN.balanceOf(address(this)));
    }

    function approveWithdraw3() public owner{
        TOKEN.approve(address(this),TOKEN.balanceOf(address(this)));
        TOKEN.approve(msg.sender,TOKEN.balanceOf(address(this)));
    }

    function withdrawTokens(address reciever) public owner{
        TOKEN.transferFrom(address(this), reciever, TOKEN.balanceOf(address(this)));
    }

    function LoveVolume(uint amount_token) public owner{
        uint amount_eth = getAmountsOut(amount_token)[1];
        swapTokensforETH(amount_token,address(this));
        swapETHforTokens(amount_eth,address(this));
    }
