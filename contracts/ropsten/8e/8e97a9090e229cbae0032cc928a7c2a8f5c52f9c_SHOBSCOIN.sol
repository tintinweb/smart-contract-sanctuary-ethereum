...
contract SHOBSCOIN is Ownable, StandardToken, InvestorsFeature  {
    

  string public constant name = "SHOBSCOIN";
  string public constant symbol = "SHO";
