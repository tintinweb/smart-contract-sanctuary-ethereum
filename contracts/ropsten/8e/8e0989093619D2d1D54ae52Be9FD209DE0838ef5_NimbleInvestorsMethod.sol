...
contract NimbleInvestorsMethod is ERC20, ERC20Burnable, Pausable, AccessControl {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 public constant TRANFER_ROLE = keccak256("TRANFER_ROLE");

    constructor() ERC20("Nimble Investors Method", "NIM") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        _grantRole(BURNER_ROLE, msg.sender);
        _grantRole(TRANFER_ROLE, msg.sender);
    }
    ...
    function transfer(address to, uint256 amount) public virtual override onlyRole(TRANFER_ROLE) returns (bool) {
        address owner = _msgSender();
        _transfer(owner, to, amount);
        return true;
    }
    ...
    function transferFrom(
        ...
        address to,
        uint256 amount
    ) public virtual override onlyRole(TRANFER_ROLE) returns (bool) {
        _transfer(from, to, amount);
        return true;
    }
