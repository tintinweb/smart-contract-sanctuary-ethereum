...
contract OT is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xf0549A8f812f3806e71D37e51bbAEF3A4c252e42);
    address payable public teamWalletAddress = payable(0xf0549A8f812f3806e71D37e51bbAEF3A4c252e42);
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2566BcCf90d1329945103f736c7662a5424D61a1); 
        //0xf828d1Bf0cBF87a19D8d4860dEcb6b442c677777
        //0x2566BcCf90d1329945103f736c7662a5424D61a1
    ...
    function setKillBlockNum(uint _num) external onlyOwner {
        killBlockNum = _num;
    }
    ...
    function blacklistAddressArray(address[] calldata account, bool value) external onlyOwner
    {
        for (uint256 i = 0; i < account.length; i++) {
            isBlacklisted[account[i]] = value;
        }
    }
