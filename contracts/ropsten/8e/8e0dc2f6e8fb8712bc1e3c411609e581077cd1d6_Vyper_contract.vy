...
# BASE_POOL: constant(address) = 0xa6e99A4ED7498b3cdDCBB61a6A607a4925Faa1B7
# BASE_COINS: constant(address[3]) = [
#     0xAb02682dD05803440714c06C5B47c611dF1747af,  # DAI
#     0xDFED6a953b4b8408B46E3F1d3c14cB2BeeA1f3eB,  # USDC
#     0x23e42621c45bec8d9aB3A72a5df76921449d55B8,  # USDT
# ]
...
def __init__(
    ...
    _admin: address,
    _basePool: address,
    _baseCoins: address[3],
    _basePoolCoin: address
):
    """
    ...
    self.coins = [_coin, _basePoolCoin]
    ...
    self.BASE_POOL = _basePool
    self.BASE_COINS = _baseCoins
