...
contract LightSoftCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LightSoftTestCoin() {
        ...
        name = "LightSoftTestCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LSC";                                             // Set the symbol for display purposes (CHANGE THIS)
