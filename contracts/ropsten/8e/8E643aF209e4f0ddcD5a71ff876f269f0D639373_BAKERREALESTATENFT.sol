...
contract BAKERREALESTATENFT is ERC721URIStorage, Ownable {
    ...
    constructor(string memory baseURI) ERC721("BAKERREALESTATENFT", "BRNFT") {
    ...
    function buyItem(uint256 tokenId) public payable onlyWhenNotPaused {
        ...
        _transfer(cowner, msg.sender, tokenId);
        _available--;
    }
