...
//                               [email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#:                               // 
//                             [email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&&&&&&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@J                              // 
//                            [email protected]@@@@@@@@@@@@@@#[email protected]@@@@@@BY!:.         ..^7P&@@@@@@@@@@@@@@@@@@@@@@#.                            // 
//                           [email protected]@@@@@@@@@@@@@@@J               [email protected]@@&Y:                     .?&@@@@@@@@@@@@@@@@@@@@@:                           // 
//                          [email protected]@@@@@@@@@@@@@@@@Y               :@#~                           ^&@@@@@@@@@@@@@@@@@@@@^                          // 
//                         [email protected]@@@@@@@@@@@@@@@@@Y               .~                               [email protected]@@@@@@@@@@@@@@@@@@@:                         // 
//                        [email protected]@@@@@@@@@@@@@@@@@@Y                                                 [email protected]@@@@@@@@@@@@@@@@@@@.                        // 
//                       [email protected]@@@@@@@@@@@@@@@@@@@Y                                                  @@@@@@@@@@@@@@@@@@@@B                        // 
//                       [email protected]@@@@@@@@@@@@@@@@@@@Y                     ^?5GGBG5?^                   [email protected]@@@@@@@@@@@@@@@@@@@!                       // 
//                      :@@@@@@@@@@@@@@@@@@@@@Y                  [email protected]@@@@@@@@@@&7                 [email protected]@@@@@@@@@@@@@@@@@@@&                       // 
//                      [email protected]@@@@@@@@@@@@@@@@@@@@Y                 [email protected]@@@@@@@@@@@@@@!                [email protected]@@@@@@@@@@@@@@@@@@@@^                      // 
//                      &@@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@#                [email protected]@@@@@@@@@@@@@@@@@@@@5                      // 
//                     [email protected]@@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@@@#                      // 
//                     :@@@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@@@&                      // 
//                     :@@@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@@@&                      // 
//                     [email protected]@@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@@@#                      // 
//                      @@@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@@@P                      // 
//                      [email protected]@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@@@!                      // 
//                      [email protected]@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@@@                       // 
//                       &@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@@J                       // 
//                       ^@@@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@&                        // 
//                        [email protected]@@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@@^                        // 
//                         [email protected]@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@@7                         // 
//                          #@@@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@@J                          // 
//                           [email protected]@@@@@@@@@@@@@@@Y                [email protected]@@@@@@@@@@@@@@@&                [email protected]@@@@@@@@@@@@@@@?                           // 
...
contract NFT2token is ERC20, ERC20Snapshot, ERC20Burnable, Pausable, Ownable, ERC20Permit {
   ...
   //////////////////////// Supply Settings ////////////////////////////////////////////////////
    ...
    address public immutable ADDR_LIQUIDITY;
   ...
   //////////////////////// Contract Initilaization ////////////////////////////////////////////
    constructor(
        ...
        address _ADDR_LIQUIDITY,
        address _ADDR_TEAM_lOCKER, 
        address _ADDR_TEAM, 
        address _ADDR_INVESTORS_lOCKER, 
        address _ADDR_INVESTORS, 
        ...
        require(_tokensReleaseDate >= block.timestamp ,"Token: token realese date should be in the future");


        require(_ADDR_LIQUIDITY_lOCKER != address(0),"zero address");
        require(_ADDR_LIQUIDITY != address(0),"zero address");
        require(_ADDR_TEAM_lOCKER != address(0),"zero address");
        require(_ADDR_TEAM != address(0),"zero address");
        require(_ADDR_INVESTORS_lOCKER != address(0),"zero address");   
        require(_ADDR_INVESTORS != address(0),"zero address");
        require(_royaltyWallet != address(0),"zero address");
        require(_royaltyRate <= 100,"Token: royalty rate should be <= (100/1000) or 100");

        // Set Variables
        isFrozen = true;
        tokensReleaseDate = _tokensReleaseDate;
        ADDR_LIQUIDITY_lOCKER = _ADDR_LIQUIDITY_lOCKER;
        ADDR_LIQUIDITY = _ADDR_LIQUIDITY;
        ...
        isFreezeExempt[ADDR_LIQUIDITY] = true;
   ...
   //////////////////////// Freeze Not Expired Modifier ////////////////////////////////////////  
    modifier freezeNotExpired() {
      require(block.timestamp < tokensReleaseDate,"Token: freeze token is already expired");
      _;
    }

   //////////////////////// Freeze Expired Modifier ////////////////////////////////////////////  
    modifier freezeExpired() {
      require(block.timestamp > tokensReleaseDate,"Token: The current date is earlier than the token release date");
      _;
    }    

   //////////////////////// update Token Release Date //////////////////////////////////////////  
    function updateTokenReleaseDate(uint newTokenReleaseDate) onlyOwner freezeNotExpired public {
        require(newTokenReleaseDate >= block.timestamp ,"Token: token realese date should be in the future");
        require (newTokenReleaseDate < tokensReleaseDate,"Token: Token release date cannot be delayed");
   ...
   //////////////////////// Early Unfreeze Tokens (for admin) ////////////////////////////////////////  
    function earlyReleaseTokens() onlyOwner freezeNotExpired public  {
        require(isFrozen,"Token: tokens are already released");
        isFrozen = false;
   ...
   //////////////////////// Withdraw Balance //////////////////////////////////////////////////     
    function withdrawEth(uint amount, address payable receivingWallet) public onlyOwner returns (uint256 balance , bool status)  {
        require(amount <= address (this).balance,"Token: Insufficient funds");
   ...
   //////////////////////// Withdraw Tokens ////////////////////////////////    
    function withdrawTokens (IERC20 token, address to, uint256 amount ) public onlyOwner {
        ...
        require (amount <= tokenBalance,"Token: balance is low") ;
   ...
   //////////////////////// update Royalty Rate /////////////////////////////////////// 
    function updateRoyalty(uint256 _royaltyRate ) public onlyOwner {
        require (_royaltyRate <= 100,"Token: Max Royalty is 100/1000 or (10%)"); 
        royaltyRate  = _royaltyRate ;
    }
   ...
   /////////////// Exclude from royalties if address is Sender //////////////
    function addExempt_From(address targetAddress) public onlyOwner {
        require (royaltyExemptFrom[targetAddress] == false, "Token: this address is already (From) exempted");
   ...
   /////////////// Exclude from royalties if address is Reciever  //////////////
    function addExempt_To(address targetAddress) public onlyOwner {
        require (royaltyExemptTo[targetAddress] == false, "Token: this address is already (To) exempted");
   ...
   /////////////// calculate royalties for a transaction //////////////
    function calculateRoyalty (address from, address to, uint256 amount) internal view 
        ...
        if (royaltyExemptTo[to]||royaltyExemptFrom[from]){
            ...
            require( amount * royaltyRate > 1000,"Token: small transaction");
        ...
        if (paused()==false){
            if (!isFrozen||isFreezeExempt[msg.sender]){
                ...
                revert E_TransferIsFrozen ({
                    message: "Token: Tokens transfers are currently frozen",
            ...
            revert E_ContractIsPaused({
                message: "Token: Contract is Paused"
            }); 
        }
    }
