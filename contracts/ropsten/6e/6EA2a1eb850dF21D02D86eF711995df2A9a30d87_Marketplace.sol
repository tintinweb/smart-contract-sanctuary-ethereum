...
contract Marketplace is IERC721Receiver, Context {
    ...
    function _mintAndCreateAuction(
        ...
        (bool success, bytes memory returnedData) = _addressNFTCollection.delegatecall(
            abi.encodeWithSignature("safeMintExt(address)", address(this))
        );
        // require(success, "Mint error");
        uint256 _nftId = abi.decode(returnedData, (uint256));
    ...
    function collectionAndCreateAuction(
        ...
        _NFTCollection.transferOwnership(_msgSender());
