...
contract CloudToken is StandardToken, Controlled {
    
    using SafeMath for uint;

    string public constant name = "Cloud Token";
    ...
    // for token circulation on platforms that integrate Cloud before unlockTime
    mapping (address => bool) internal precirculated;

    function CloudToken(uint _unlockTime) public {
