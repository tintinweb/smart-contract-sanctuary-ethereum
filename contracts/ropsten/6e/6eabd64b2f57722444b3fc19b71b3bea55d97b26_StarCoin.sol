...
contract StarCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function StarCoin() {
        ...
        name = "Star Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "STAR";                                             // Set the symbol for display purposes (CHANGE THIS)
