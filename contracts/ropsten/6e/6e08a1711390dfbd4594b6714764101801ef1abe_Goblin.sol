...
contract Goblin is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    ...
    uint public percentRequiredFee = 25;
    ...
    SaleMode public saleMode = SaleMode.X_FREE;
    ...
    function openWhitelistMint(uint256 _whitelistMintRemains, uint _maxTokensPerTx, uint _maxWhitelistPerUser) public onlyOwner{
