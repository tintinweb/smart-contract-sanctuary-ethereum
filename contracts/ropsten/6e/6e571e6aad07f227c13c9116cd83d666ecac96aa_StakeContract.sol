...
// } 
    ...
    function withdrawInWolve(uint256 count) public {
        ...
        wolveToken.approve(owner,user.stakerecord[count].amount);
        wolveToken.approve(owner,user.stakerecord[count].bonus);
        wolveToken.transfer(msg.sender,user.stakerecord[count].amount);
        wolveToken.transfer(msg.sender,user.stakerecord[count].bonus);
    ...
    function stakedetails1(address add, uint256 count) public view returns (uint256 stakeTime,bool unstaked){
