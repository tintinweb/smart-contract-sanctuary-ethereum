...
contract OMS_MagicDisciples_Genesis_1_Test is
    ...
    IMintable
{
    ...
    /// for 2981
    // function setRoyaltiesInfo(address _royaltiesAddress, uint256 _royaltiesFees, uint256 _newRoyaltiesRewardShare) public onlyOwner {
    ...
    //only owner
    // function mintSpecificID(uint256 _mintAmount, uint256 specificTokenID, address _mintToAddress)
    //     external
    //     onlyOwner
    // {
    //     uint256 supply = totalSupply();
    ...
    //     _mintSpecificID(_mintAmount, specificTokenID, _mintToAddress);
    // }


    function setReveal(bool _set) public onlyOwner {
        revealed = _set;
    }
    ...
    //Withdraw 100% of a custom token to selected address on ETH
    // function WithdrawCustomToken (address _tokenAddress, address _to)
    //     external
    //     onlyOwner
    // {
