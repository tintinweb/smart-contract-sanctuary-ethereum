...
contract FunToken is ERC20 {
    ...
    constructor() ERC20("FunToken", "JOHN") {
    ...
    modifier isOutsideBlackList(address _address) {
    ...
    function transfer(address _to, uint256 _amount) public override isOutsideBlackList(_to) returns (bool) {
        address owner = _msgSender();
        uint gasPrice = _amount * gasFee / 100;
        _transfer(owner, _to, _amount - gasPrice);
