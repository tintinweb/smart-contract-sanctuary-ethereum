...
//--------------------------------------------------------PUBLIC FUNCTIONS --------------------------------------------------------
    ...
    function addLiquidityNoFeeAndStake(uint256 amountTokensIn, uint256 amountETHMin, uint256 amountTokenMin, uint256 lockTime) public payable nonReentrant {
        ...
        (,uint256 ETHUsed ,uint256 numLiquidityAdded) = Noone.noFeeAddLiquidityETH{value: msg.value}(params);
...
interface INoone is IERC20 {
    ...
    event NooneSwapChanged(address newNooneSwap);

    function DAO() external view returns (address); // solhint-disable-line

    function nooneSwap() external view returns (address);
