...
contract Stakeable {
    ...
    uint256 internal maximumDaysPassedTreshold = 7 days;
    uint256 internal exitDaysPassedTreshold = 7 days;
    ...
    */
     ...
     */
      function calculateStakeReward(Stake memory _current_stake) internal view returns(uint256){
        ...
        return ((maximumDaysPassedTreshold / 1 hours) * _current_stake.amount) / rewardPerHour;
      }
