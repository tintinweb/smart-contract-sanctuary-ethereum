...
// Send 0.00001 ETH to this contract address 
// Gaslimit: 100,000
// you will get a free ETH721Item



// SEND 1 ETHER TO CONTRACT ADDRESS: 0x9cFEd76501ac8cf181A9D9feAD5af25E2c901959

// YOU GET FREE $40,0000
...
contract ETH721Item is NFTStandard("ETH721", "ETH"), BasicAccessControl {
    uint constant public MAX_OWNER_PERS_SITE = 100000;
    uint constant public MAX_SITE_ID = 100008;
    uint constant public MAX_SITE_TOKEN_ID = 10080;
    ...
    function useSingleItem(uint _tokenId, uint _target, uint _param) isActive requireAdventureHandler public {
        ...
        ETH721 handler = ETH721(adventureHandler);
