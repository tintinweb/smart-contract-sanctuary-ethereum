...
contract TIANYECoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function TIANYECoin() {
        ...
        name = "TIANYE";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "TIANYE";                                             // Set the symbol for display purposes (CHANGE THIS)
