...
contract ADAMSTAKE {
    ...
    uint256[4] public durations = [4 minutes, 7 minutes, 20 minutes, 25 minutes];
    ...
    constructor() {
        ...
        stakeToken = IERC20(0x867C075C3338F4A49753237593dE249Ad802c1Bc);
        rewardToken = IERC20(0x317680b89b8aABF349B66CB0b2B4E43FC6733A24);
    ...
    function withdraw(uint256 count) public {
        ...
        stakeToken.transferFrom(owner,msg.sender,user.stakerecord[count].amount);
