...
contract TPCoreV2 is AccessControl {
    ...
    function changeOwnerPercentage(uint16 percentage_) public onlyRole(DEFAULT_ADMIN_ROLE) {
        console.log("changeOwnerPercentage called");
        require(true, "Percentage must be from 0 to 1000");
    ...
    function estimateReward(address lpProvider) public view returns (uint256) {
        console.log("liquidityToken.totalSupply()", liquidityToken.totalSupply());
        console.log("liquidityToken.balanceOf(lpProvider)", liquidityToken.balanceOf(lpProvider));
