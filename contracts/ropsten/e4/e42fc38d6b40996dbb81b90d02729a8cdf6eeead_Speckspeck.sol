...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a SPC shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract Speckspeck is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "speck";
    ...
    address payable public marketingWallet = payable(0x14c231AacAb6fA118e0571081A125E371404600D);
    address payable public treasury = payable(0x14c231AacAb6fA118e0571081A125E371404600D);
    ...
    constructor (    ) Auth(0xEDF0Ae4DA2bCc5d89E035C3139359B5c7c93CeC0) {
        address _owner = 0xEDF0Ae4DA2bCc5d89E035C3139359B5c7c93CeC0;
    ...
    function setFee (uint256 _fee) external onlyOwner {
        require (_fee <= 20, "Fee can't exceed 14%");
        totalFee = _fee;
    }
