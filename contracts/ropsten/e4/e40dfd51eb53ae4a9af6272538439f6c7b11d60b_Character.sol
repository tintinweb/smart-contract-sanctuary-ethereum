...
contract Character is ERC721URIStorage, Ownable {
  ...
  uint256 public maxMintAmountPerTx = 100; // <-- max mints per tx
...
uint256 public pricePerNFT = 0.1 ether;
 uint256 public maxAirDrop = 50; // <-- max AirDrop
 ...
 Char storage char = _tokenDetails[i];
    // update owner
    char.owner = to;
...
//             TransferNFT(msg.sender, holders[i], amount);
//         }
//     }
