...
contract QRFID_gold is IERC1400, Ownable {
    ...
    /**
     * @dev Returns toke sale data of `account` from {addressToTokenSaleHistory}
     */
    ...
    /**
     * @dev Returns all toke sale data from {tokenSaleHistory}
     */
     ...
     * valid data of `_data`
     *
     * note Stores redeem data in {_redeemedTokensHistory}
     */
