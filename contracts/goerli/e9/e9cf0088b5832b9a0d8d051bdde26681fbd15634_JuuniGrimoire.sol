...
contract JuuniGrimoire is ERC721AQueryable, ReentrancyGuard, Ownable, ERC2981 {
    ...
    uint256 constant MAX_SUPPLY = 7_777;
    string private _baseTokenURI;
    address public signer;

    // Mint related info
    uint256 public maxGrimoires = 7_777;
    ...
    uint256 public maxPublicGrimoires = 2_500;
    uint256 public publicGrimoiresMinted = 0;
    uint256 private teamAllocation = 222;
    ...
    address private _zodiaContract;
        ...
        payable
    {
        ...
        if (saleState == SaleState.PUBLIC) {
            ...
            publicGrimoiresMinted = publicGrimoiresMinted + quantity;
    ...
    function discoverZodia(uint256 grimoireId)
        ...
        returns (uint256)
    {
        if (_zodiaContract == address(0)) revert ZodiaContractNotSet();
        ...
        Zodia zodia = Zodia(_zodiaContract);
    ...
    function setZodiaContract(address contractAddress) external onlyOwner {
        _zodiaContract = contractAddress;
    }
    ...
    function _checkMarketplace(address operator) internal view {
        if (blacklistedMarketplaces[operator]) revert UnsupportedMarketplace();
    }
