    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/fsf619Ri4m2tmGryCFVJ/contract-metadata";
  }
...
// File: contracts/CoolymooContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CoolymooContract is RamppERC721A {
    constructor() RamppERC721A("Coolymoo", "CLM"){}
}
