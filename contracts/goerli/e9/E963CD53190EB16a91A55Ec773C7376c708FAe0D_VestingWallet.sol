...
contract VestingWallet is Context, Ownable {
    ...
    event VestingCreated(address indexed token, uint256 amount);
    ...
    function createVesting(
        ...
        require(
            IERC20(token).balanceOf(address(this)) >= (debt + _amount),
    ...
    function release(address beneficiaryAddress) public virtual {
        ...
        SafeERC20.safeTransfer(IERC20(token), beneficiaryAddress, releasable);
    }
