...
contract Renderer {
    function render(Date memory date) public pure returns (string memory) {
        return string.concat(renderDayAttributes(), renderClockAttributes());
    }

    function renderDayAttributes() internal pure returns (string memory) {
        return
            string.concat(
                ...
                getDayAttribute("01", "360", "-9", "translate(56.167 396.88)"),
                getDayAttribute("01", "11", "0", "translate(334.17 744.08)")
            );
    }
