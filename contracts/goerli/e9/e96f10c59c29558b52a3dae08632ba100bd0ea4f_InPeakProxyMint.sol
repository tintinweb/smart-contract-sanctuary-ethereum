...
contract InPeakProxyMint is Ownable {
    ...
    uint16 public ccCut = 250;
    uint256 public ccTotal = 0;
    uint256 public referralCut = 1000;
    ...
    function mint(address referrerAddress) external payable callerIsUser {
        ...
        inPeakContract.pledgeMint{ value: toPay  - cut }(msg.sender, 1);
    }
