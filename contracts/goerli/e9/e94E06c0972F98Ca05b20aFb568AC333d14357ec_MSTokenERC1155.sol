    ...
    ITokenERC1155
{
    ...
    bytes32 private constant MODULE_TYPE = bytes32("MSTokenERC1155");
    ...
    function initialize(
        ...
        _owner = _MSdefaultAdmin;
        _setupRole(DEFAULT_ADMIN_ROLE, _MSdefaultAdmin);
        _setupRole(DEFAULT_ADMIN_ROLE, _creatorAddress);
        _setupRole(MINTER_ROLE, _MSdefaultAdmin);
        _setupRole(MINTER_ROLE, _creatorAddress);
        _setupRole(TRANSFER_ROLE, _MSdefaultAdmin);
        _setupRole(TRANSFER_ROLE, _creatorAddress);
    ...
    function _mintTo(
        ...
        emit MSTokensMinted(_to, _tokenId, _tokenURI[_tokenId], _amount);
    }
...
interface ITokenERC1155 is IERC1155Upgradeable {
    ...
    event MSTokensMinted(address indexed mintedTo, uint256 indexed tokenIdMinted, string uri, uint256 quantityMinted);
...
contract ERC1155Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC1155Upgradeable, IERC1155MetadataURIUpgradeable {
     ...
     *
     * Emits a {TransferMSERC1155} event.
     *
     * Requirements:
     *
