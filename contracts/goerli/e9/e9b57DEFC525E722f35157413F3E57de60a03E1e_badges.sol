...
contract badges is ERC721Enumerable,Ownable{

    string private _baseURIextended;

    // Mapping owner address to owned badgesID array
    ...
    constructor() ERC721("Bagdes", "badges") {
    }

    //reward address 'to' with badge 'badgeID'
    ...
    //returns badgeID array for address 'user' 
