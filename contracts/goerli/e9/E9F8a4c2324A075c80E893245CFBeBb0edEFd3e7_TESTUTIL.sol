...
contract TESTUTIL is ERC20, Ownable {
    uint256 public AMBER_PER_SECOND_PER_DRAGON = 1157400 gwei;
    // 19 November 2021 20:00:00 - 1637352000
    uint256 public immutable GENESIS = 14154000;

	// 30 October 2027 20:00:00 - 1824926400 (2171 days)
	uint256 public immutable END = 1824926400;

    IERC721Enumerable public DRAGONS;
    IERC721Enumerable public burnContract;

    mapping(uint256 => uint256) public last;

    constructor(address dragons ) ERC20("Amber", "AMBER") {
        DRAGONS = IERC721Enumerable(dragons);
    }
    function setDragon(address _newcontract) external onlyOwner {
        DRAGONS = IERC721Enumerable(_newcontract);
    }
    ...
    function mintForIds(uint256[] calldata ids) external {
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            ...
            totalAmber_PerSecond_PerDragon ;
            claimed = lastClaim(id);
