...
contract Laboratory {
    ...
    function NewStreamWallet(address[] memory _beneficiaries, uint256[] memory _shares) external returns (address) {
        ...
        teamWallet.initialize(_beneficiaries, _shares);
...
contract StreamTeamWallet is Initializable, ReentrancyGuard {
    ...
    function initialize(address[] calldata _beneficiaries, uint256[] calldata _shares) initializer public {
