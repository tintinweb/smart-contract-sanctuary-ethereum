...
abstract contract OCR2DRClient is OCR2DRClientInterface {
     ...
     */
    function sendRequest(OCR2DR.Request memory req, uint256 subscriptionId)
        internal
        returns (bytes32)
    {
     ...
     */
    function addExternalRequest(address oracleAddress, bytes32 requestId)
        internal
...
library OCR2DR {
     ...
     */
    function encodeCBOR(Request memory self)
        internal
        pure
     ...
     */
    function addInlineSecrets(Request memory self, bytes memory secrets)
        internal
        pure
    {
