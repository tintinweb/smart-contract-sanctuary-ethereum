...
contract ShibaoshiInuyama is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    // address public DAI = 0x6B175474E89094C44Da98b954EedeAC495271d0F; //TODO: change for mainnet
    address public DAI = 0x7252e7ac7EE3fF4f3efdeC987437E514E5f32749;
    ...
    constructor() ERC20("Shibaoshi Inuyama", "SHIBAO") {
        ...
        maxTransactionAmount =  totalSupply * 1 / 100; // 2% maxTxn
