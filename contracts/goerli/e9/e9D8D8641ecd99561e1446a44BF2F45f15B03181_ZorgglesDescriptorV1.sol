...
@@@@@@@@@@@@@@BB#####RRRRRRRROOOOOOOOOOOOOOZZZZZZZZZZZZZZZZZZZZZZZZZZZ[email protected]@@@@@@@@@@@@@@@
...
@@@@@@@@@@@@@@@@@@@@@@BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB[email protected]@@@@@@@@@@@@@@@@@@@@@@@
...
contract ZorgglesDescriptorV1 is Initializable, OwnableUpgradeable {
    ...
    function buildZorbs(uint256 tokenId) internal view returns (string memory) {
        ...
        for (uint i; i < 70; ++i) {
            ...
            bytes[5] memory colors = ColorLib.gradientForAddress(0x8465EF4F44E5b12aB73EB72524EC71C7790B64A3);
