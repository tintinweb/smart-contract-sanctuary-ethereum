...
contract DEX {
   ...
   */
  event EthToTokenSwap(address receiver, string trade, uint256 amountIn, uint256 amountOut);

  /**
   * @notice Emitted when tokenToEth() swap transacted
   */
  event TokenToEthSwap(address receiver, string trade, uint256 amountOut, uint256 amountIn);

  /**
   * @notice Emitted when liquidity provided to DEX and mints LPTs.
   */
  event LiquidityProvided(address provider, uint256 liquidityMinted, uint256 ethIn, uint256 tokenIn);

  /**
   * @notice Emitted when liquidity removed from DEX and decreases LPT count within DEX.
   */
  event LiquidityRemoved(address provider, uint256 liquidityWithdrawn, uint256 ethOut, uint256 tokenOut);
