...
contract StakeProxy is IStakeProxy, Initializable, Ownable, ReentrancyGuard, ERC721Holder {
    ...
    function unStake() external override onlyOwner nonReentrant {
        ...
        if (_isSingleBaycPool() || _isSingleMaycPool()) {
            ...
            nfts[0] = IApeCoinStaking.SingleNft({tokenId: _apeStaked.tokenId.toUint32(), amount: coinAmount.toUint224()});
    ...
    function stake(
        ...
        if (_isPairedBaycPool() || _isPairedMaycPool()) {
            ...
            IApeCoinStaking.SingleNft[] memory nfts = new IApeCoinStaking.SingleNft[](1);
            nfts[0] = IApeCoinStaking.SingleNft({tokenId: apeStaked_.tokenId.toUint32(), amount: coinAmount.toUint224()});
    ...
    function _claim() internal {
        if (!unStaked) {
            ...
            if (_isPairedBaycPool() || _isPairedMaycPool()) {
                ...
                nfts[0] = IApeCoinStaking.PairNft({mainTokenId: _apeStaked.tokenId.toUint128(), bakcTokenId: _bakcStaked.tokenId.toUint128()});
