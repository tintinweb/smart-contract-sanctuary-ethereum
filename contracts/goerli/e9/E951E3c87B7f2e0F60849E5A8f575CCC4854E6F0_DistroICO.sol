...
contract DistroICO is Ownable, ReentrancyGuard {
    ...
    function start(
        ...
        endDate = block.timestamp + 1800; // 3 months
    ...
    function buy(address _paymentToken, uint256 _amount) public payable {
    ...
    function trade(
        ...
        token.transferFrom(msg.sender, address(this), holdAmount);
    ...
    function startTrade(
        ...
        isTradable = true;
        vesting_period = block.timestamp + 1800;
