 ...
 * @notice This contract handles minting Sale test tokens.
 */
contract LaunchpadSaleTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xEDAd5d6634Cf2ef8642692B8E24EE8304c3E8742;
    ...
    constructor() ERC721A("Sale test", "CATC") {
