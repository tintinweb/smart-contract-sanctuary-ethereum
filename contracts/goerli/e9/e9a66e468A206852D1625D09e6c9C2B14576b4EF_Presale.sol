...
contract Presale is Ownable {
    ...
    function buyToken() public payable  {
        ...
        vestingCreate(tokenAmount,_msgSender(),totalDays,sliceDays);
    ...
    function getVestingId(address _walletAddress) public view returns(uint256[] memory) {
        return vestingContract(vestingAddress).getVestingIds(_walletAddress);        
    }
    ...
    function editListedAt(uint256 _time) public {
        return vestingContract(vestingAddress).editListedAt(_time);
