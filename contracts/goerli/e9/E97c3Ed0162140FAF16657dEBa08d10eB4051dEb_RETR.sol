...
contract RETR is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 0;
    uint256 public marketingFeeOnSell = 0;

    address public marketingWallet = 0x3e7056504bB76F9aaa08D84Ef0C80bf7b6C5Ff80;
    ...
    constructor () ERC20("Retard Token", "RETR") 
    {   
        ...
        _setOwner(0x3e7056504bB76F9aaa08D84Ef0C80bf7b6C5Ff80);
        ...
        _mint(owner(), 12_345_678_910 * (10 ** 18));
    ...
    function setFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnBuy <= 0, "Marketing fee on buy cannot be more than 0%");
        require(_marketingFeeOnSell <= 0, "Marketing fee on sell cannot be more than 0%");
