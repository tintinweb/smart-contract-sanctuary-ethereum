...
contract Beast is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 nextTokenId = 801; // change before deployment
    uint256 MAX_MINT_FTM = 1155; // change before deployment
    ...
    {
        _owner = msg.sender;
        endpoint = ILayerZeroEndpoint(address(0xb6319cC6c8c27A8F5dAF0dD3DF91EA35C4720dd7)); // change before deployment
    }
    ...
    function mint(uint8 numTokens) external {
        ...
        require(
            nextTokenId + numTokens <= MAX_MINT_FTM,
            "Mint exceeds supply"
        );
