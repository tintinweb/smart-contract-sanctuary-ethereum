 ...
 * @notice This contract handles minting Hello Kerochi tokens.
 */
contract HelloKerochi is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xFF39092Aa5aA80f7e057bc3BCb741F2ea10F0720;
    ...
    address public royaltyAddress = 0xabcde159f1612A68074fB889A37410C97156Db95;
    ...
    string public name = "Hello Kerochi";
    string public symbol = "KEROCHI";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeihsxrde5ndrvc5tnbqlgz7magbwnxivkdpj5bpwrusppioymi5xsq/{id}"
        )
    {
        blocklistContractAddress = _blocklistContractAddress;
        _setDefaultRoyalty(royaltyAddress, royaltyFee);
        tokenMaxSupply[100] = 10;
        tokenPublicPrice[100] = 0.001 ether;
        tokenPublicMintsPerAddress[100] = 10;
        tokenPublicSaleStartTime[100] = 1670986800;
        tokenPublicSaleEndTime[100] = 1670988600;
        tokenUsePublicSaleTimes[100] = true;
        require(
