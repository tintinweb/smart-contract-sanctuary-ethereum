...
contract Maskies is ERC721Psi, Ownable, ReentrancyGuard, WhiteList {
    ...
    // Minting
    //--------------------------------------------------
    function mint(address minter, uint256 maxMints, uint256 amount, bytes32[] memory proof) external payable {
