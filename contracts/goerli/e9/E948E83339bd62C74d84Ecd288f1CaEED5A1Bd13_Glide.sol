...
contract Glide is Ownable {
    ...
    function rerollOne(
        ...
        if(msg.value != rerollOneCost) revert IncorrectMsgValue();
    ...
    function rerollThree(
        ...
        if(msg.value != rerollThreeCost) revert IncorrectMsgValue();
    ...
    function rerollFive(
        ...
        if(msg.value != rerollFiveCost) revert IncorrectMsgValue();
