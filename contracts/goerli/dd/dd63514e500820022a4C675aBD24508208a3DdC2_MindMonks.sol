...
contract MindMonks is ERC721A, Ownable {

    uint256 public monkPrice = 70000000000000000; // 0.07 ETH for testing
    uint256 public constant maxMonkMint = 8;
    uint256 public maxMonks = 888; 
    uint256 public foundersReserve = 88; // Reserve up to 88 Monks for founders, marketing etc.
    ...
    constructor() ERC721A("Mind Monks", "Monks") { }
    ...
    function remainingMonks(address _address) external view returns (uint) {
