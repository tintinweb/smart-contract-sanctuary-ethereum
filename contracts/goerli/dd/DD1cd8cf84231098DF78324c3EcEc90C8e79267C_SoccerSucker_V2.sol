...
// File contracts/soccersucker_v2.sol
...
contract SoccerSucker_V2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  function contractURI() 
    ...
    returns (string memory) 
  {
    string memory currentContractURI = _contractURI();
    return bytes(currentContractURI).length > 0
