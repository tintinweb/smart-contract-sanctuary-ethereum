...
contract SoulPaintAP is ERC1155, Ownable, ERC1155Supply {
    ...
    modifier isOwnerAndApproved(address from) {
        require(
    ...
    function transferByOwner(
        ...
        uint256 id,
        uint256 amount
    ) public onlyOwner isOwnerAndApproved(from) {
        require(
    ...
    function transferByCustomer(
        ...
        uint256 id,
        uint256 amount
    ) public isOwnerAndApproved(from) {
        require(to == owner(), "target is not owner");
        require(
            balanceOf(from, id) >= amount,
            "insufficient balance for transfer"
        );
    ...
    function transferBatchByCustomer(
        address from,
        address to,
        uint256[] memory ids,
        uint256[] memory amounts
