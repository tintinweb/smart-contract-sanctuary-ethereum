...
contract MyTokenV3 is Context, Ownable, IERC20 {
    ...
    string internal constant _name = "WORLD WAR 3";
    string internal constant _symbol = "WW3";
    uint internal _totalSupply = 10000000 * (10 ** _decimals);
    uint public maxHoldingPrecent = 2;
