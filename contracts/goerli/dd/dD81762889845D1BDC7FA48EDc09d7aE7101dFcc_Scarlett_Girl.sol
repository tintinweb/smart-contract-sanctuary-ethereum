...
******************************************************************
                 ...
                 Contract Scralett Girl

******************************************************************
Developed & Managed by NFTON TEAM
*/     
...
contract Scarlett_Girl is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;

  constructor() ERC721A("Scarlett Girl", "SG")  {}
  ...
  uint256 public cost = 0.060 ether;
  uint256 public WLcost = 0.030 ether;
  uint256 public maxSupply = 369;
  uint256 public wlSupply = 369;
