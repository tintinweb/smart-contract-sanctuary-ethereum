 ...
 * Depodancia contract
 *
 * by @goldstellar - first contract & first deployment. No CS education. Not a coder.
 */
contract Depodancia is ERC1155, Pausable, Ownable, ReentrancyGuard {
    ...
    string public name;
    mapping(uint256 => DepodanToken) public tokens;
    Counters.Counter private tokenCounter;
    constructor() ERC1155("Depodancia") {}
    ...
    public
    {
        ...
        DepodanToken storage token = tokens[tokenCounter.current()];
    ...
    public
    {
        DepodanToken storage token = tokens[tokenId];
    ...
    function uri(uint256 _tokenId) public view override returns (string memory output) {
        ...
        DepodanToken storage token = tokens[_tokenId];
    ...
    {
        DepodanToken storage token = tokens[id];
