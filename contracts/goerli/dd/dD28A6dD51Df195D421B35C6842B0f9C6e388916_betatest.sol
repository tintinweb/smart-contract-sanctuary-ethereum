 ...
 contract betatest is ERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
      ...
      if (_isExcludedFromFee[from]) {
          transferAmount = amount;
        } else if (from == uniswapV2Pair || to == uniswapV2Pair && (taxForLiquidity + taxForHonorarium != 0)) {
                ...
                honorariumFunds += (ethAmount * (taxForHonorarium * 75 /100) / 100) ;
        ...
        returns (bool)
    {
        ...
        require(_taxForHonorarium <= 15, 'Honorarium Tax cannot be more than 15%');
