...
contract ROOM22 is Ownable, ERC721Enumerable, DefaultOperatorFilterer, ReentrancyGuard, ERC2981 {
    ...
    uint256 public publicStartTime = 1674331200;
    ...
    uint256 public allowlistPrice = .001 ether;

    // Royalties
    uint256 public mintRoyalties = 10;
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory data) public override (ERC721, IERC721) onlyAllowedOperator {
