...
//    mapping (uint256 => NftInfo) nftInfos;
    ...
    string constant rl2='{"name": "Character Dao Vocalo NFT 2 ';
...
//        _grantRole(ADMIN,0x0dAE5FcaD0DF8E5C029D76927582DFBdFd7eeC79);
    ...
    // 2023/2/5 00:00:00 (JST) = 1675522800				
    // 2023/1/29 00:00:00 (JST) = 1676386800
    function mintableTimer() public view returns (bool){
        if (block.timestamp >= 1675522800 && block.timestamp < 1676386800) {
            bool mintable = true;
            return mintable;
        } else {
            bool mintable = false;
