...
contract Trolluu is ERC721A, Ownable {
	using Strings for uint;

	uint public constant MINT_PRICE = 0.005 ether;
	uint public constant MAX_NFT_PER_TRAN = 6;
	...
	string public prerevealURL = 'ipfs://QmWbx9W3uGNHLSUDscX6QHkGZ3xGnv3RmNKV4UP41A64rB/';
	mapping(address => uint) private _walletMintedCount;

    // Name
	constructor()
	ERC721A('Alle Trolliey', 'TESTTOKEN') {
    }
	...
	function updateMetadata(string memory url) external onlyOwner {
