    ...
    AMultiFounderslistMerkle
{
        ...
        whenNotPaused
    {
        ...
        if (_signer != ecrecover(_hash, v, r, s)) revert SignatureMismatch();
    ...
    function signatureTest(address _signer, bytes32 _nonce, bytes32 _hash, uint8 v, bytes32 r, bytes32 s) public view returns (bool) {
        //if (nonceUsed[_nonce]) revert NonceAlreadyUsed();
