    ...
    AccessControl
{
    ...
    // mapping(address => uint256) public mintersId;
        ...
        returns (uint256 requestId)
    {
        ...
        // mintersId[_msgSender()] = requestId;
    ...
    function updateCallbackGasLimit(uint16 _confirmations) public onlyOwner {
...
interface IPixelNFTMinter {
    function awardToWinner(uint256 _requestId, uint256 _randomWord) external returns(bool);
}
