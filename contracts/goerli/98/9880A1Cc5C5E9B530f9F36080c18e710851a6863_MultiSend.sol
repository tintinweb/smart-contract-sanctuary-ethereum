...
contract MultiSend {
     ...
     * @dev Send ERC721 tokens with {tokenIds} to {recipients} addresses
     * @param erc721Contract address of ERC721
    ...
    function multiSendERC721(
        ...
        for (uint256 i; i < length; ) {
            erc721Contract.safeTransferFrom(msg.sender, _recipients[i], _tokenIds[i]);
     ...
     * @param erc1155Contract ERC1155 token address
     * @param recipients recipients addresses
    ...
    function multiSendERC1155(
        ...
        for (uint256 i; i < length; ) {
            erc1155Contract.safeTransferFrom(msg.sender, _recipients[i], _tokenIds[i], _amounts[i], "");
