...
contract Unity is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public MAX_NFT = 7999 ;
	uint256 public MAX_MINT_PRESALE = 5;
	uint256 public MAX_MINT_SALE = 5;
    uint256 public MAX_MINT_WL = 3;
	...
	uint256 public PRESALE_PRICE = 0.06 * 1000000000000000000;
	uint256 public SALE_PRICE =  0.08 * 1000000000000000000;
    ...
    uint private unlockDate;
    uint256 public constant WL_PRICE_PER_TOKEN = 0.06 * 1000000000000000000;
    event minted(address to, uint256 tokenId, string token_IPFS_URI);
    ...
    constructor() ERC721P('Unity', 'UNTY') {}
    ...
    function mint(address to, uint256 tokenId, string memory token_IPFS_URI) public payable nonReentrant{  
        uint256 _count = 1;         
		uint256 totalSupply = totalSupply();
        ...
        emit minted(to, tokenId, token_IPFS_URI);
    }
    ...
    function updateUnlockDate(uint _unlockDate) external onlyOwner {
