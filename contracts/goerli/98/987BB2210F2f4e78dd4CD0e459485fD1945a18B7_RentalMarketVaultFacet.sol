...
contract RentalMarketVaultFacet is ERC1155Holder, ERC721Holder {
    ...
    function setMarketCommission(uint256 _newMarketCommission) external onlyOwner {
        LibRentalStorage.setMarketCommission(_newMarketCommission);
    }
    ...
    function getMarketCommission() external view returns (uint256 _MarketCommission) {
        return LibRentalStorage.getMarketCommission();
    }
}
