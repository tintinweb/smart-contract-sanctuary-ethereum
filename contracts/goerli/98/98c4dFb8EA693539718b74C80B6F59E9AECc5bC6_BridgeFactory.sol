...
contract BridgeFactory {
    ...
    event ProjectApproved(address[2] projAndOwner, uint256 projectId, uint256 feeWalletPercentage);
    ...
    function approveProject(
        uint256 _projectId,
        address[] memory _criticalAddress,
...
contract Bridge is ERC721A, Ownable {
    ...
    event InitalDistributionRecipients(address[] recipients, uint256[] percentages);
    ...
    event TokensMinted(address owner, uint256 price, uint256 quantity, uint256 companyId, uint256 projectId);
    ...
    constructor(
        ...
        BUSD = _criticalAddress[0];
        BridgeFactoryAddress = _criticalAddress[1];
        ...
        emit InitalDistributionRecipients(_mintingDistributionRecipients, _recipientsMintingPercentage);
    }
    ...
    function _mint(
        ...
        emit TokensMinted(msg.sender, _price, _quantity, _companyID, _projectId);
    }
}
