...
contract ChilesNogadaNFT is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A('Chiles Nogada', '0xAF', 20, 100000) {
        saleStage = 0;
    }
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721A) returns (string memory) {
        ...
        return bytes(base).length > 0 ? string(abi.encodePacked(base, Strings.toString(tokenId), ".json")) : "https://bafybeifo3qu4df5ctxgqftvurefgk3wnvwiuvavxtcy44rqdj7sdgm4o4y.ipfs.nftstorage.link/";
    }
}
