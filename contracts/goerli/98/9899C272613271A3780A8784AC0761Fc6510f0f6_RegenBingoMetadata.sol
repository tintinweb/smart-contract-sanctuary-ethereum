...
import "../contracts/RegenBingoMetadata.sol";

contract $RegenBingoMetadata is RegenBingoMetadata {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(address _svgGeneratorAddress) RegenBingoMetadata(_svgGeneratorAddress) {}

    function $_generateImageStringFraction(uint256 tokenId,uint256[9][3] calldata numbers,bool[9][3] calldata covered,uint256 donationAmount,string calldata donationName,address donationAddress,bool isBingoFinished,uint256 drawTimestamp) external view returns (string memory ret0) {
        (ret0) = super._generateImageStringFraction(tokenId,numbers,covered,donationAmount,donationName,donationAddress,isBingoFinished,drawTimestamp);
    }
