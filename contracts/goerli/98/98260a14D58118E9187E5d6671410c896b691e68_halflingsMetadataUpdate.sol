...
contract halflingsMetadataUpdate is Ownable {
      ...
      mapping(uint256 =>mapping(uint256 => bool)) public _isattributeId;
    ...
    function addItems(
        ...
        if(_isattributeId[nftid][attributeId[itemcount]])
        {
        require((_isItemRemoved[nftid][attributeId[itemcount]]== false),"need to remove item from NFT");
        require((_isItemAdd[nftid][attributeId[itemcount]]== false),"need to remove item from NFT");
        }
        _isattributeId[nftid][attributeId[itemcount]]=true;
    ...
    function removeItem(
        ...
        _isItemAdd[nftid][attributeId]=false;
        _isItemAdd[nftid][attributeId]=true;
