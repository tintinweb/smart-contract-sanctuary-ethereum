...
/**
 * @title RecatalogingHypertension
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract RecatalogingHypertension is Pausable, ERC20Burnable, ReentrancyGuard {
    address private _owner;

    constructor() ERC20("Recataloging Hypertension","EIN")   { 
        _owner = _msgSender();
     }
