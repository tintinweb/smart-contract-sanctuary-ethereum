 ...
 * @title DEX
 * @author santipu
 * @notice Contract based on DEX Template by stevepham.eth and m00npapi.eth
...
contract DEX {
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        require(success, "Revert in transfering ETH to buyer");
        emit TokenToEthSwap(
            msg.sender,
            "Balloons to ETH",
            tokenInput,
    ...
    function withdraw(
        ...
        require(
            ...
            "sender does not have enough liquidity to withdraw"
        );
        ...
        require(success, "Revert in transferring eth to user");
