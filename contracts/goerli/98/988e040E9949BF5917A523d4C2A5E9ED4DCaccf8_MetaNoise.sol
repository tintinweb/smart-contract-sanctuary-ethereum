...
contract MetaNoise is ERC721, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    function mint(uint256 _count) public payable saleIsOpen noContract {
        ...
        require(_count == 1, "1 max per transaction");
        require(tokensClaimed[msg.sender] + _count <= maxMintPerWallet, "Exceeds max per wallet.");
