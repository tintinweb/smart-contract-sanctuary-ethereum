...
contract DeployBaseA {
    VatFab vatFab;
    JugFab jugFab;

    function setUp(address deploy) public {
        vatFab = new VatFab();
        jugFab = new JugFab();

        DeployLike(deploy).addFabsA(vatFab, jugFab);
    }
}

contract DeployBaseB {
    VowFab vowFab;
    CatFab catFab;
    ...
    function setUp(address deploy) public {
        ...
        DeployLike(deploy).addFabsB(vowFab, catFab);
    }
}

contract DeployBaseC {
    DogFab dogFab;
    IRDTFab irdtFab;
    ...
    function setUp(address deploy) public {
        ...
        DeployLike(deploy).addFabsC(dogFab, irdtFab, irdtJoinFab);
    }
}

contract DeployBaseD {
    FlapFab flapFab;
    FlopFab flopFab;
    FlipFab flipFab;
    ...
    function setUp(address deploy) public {
        ...
        DeployLike(deploy).addFabsD(flapFab, flopFab, flipFab);
    }
}

contract DeployBaseE {
    ClipFab clipFab;
    CalcFab calcFab;
    SpotFab spotFab;
    PotFab potFab;
    ...
    function setUp(address deploy) public {
        ...
        DeployLike(deploy).addFabsE(clipFab, calcFab, spotFab, potFab);
    }
}


contract DeployBaseF {
    CureFab cureFab;
    EndFab endFab;
    ESMFab esmFab;
    PauseFab pauseFab;
    ...
    function setUp(address deploy) public {
        ...
        DeployLike(deploy).addFabsF(cureFab, endFab, esmFab, pauseFab);
    }
}
