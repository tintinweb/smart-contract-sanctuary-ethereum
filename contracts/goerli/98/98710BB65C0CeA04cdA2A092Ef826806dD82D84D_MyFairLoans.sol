...
contract MyFairLoans is ERC20Burnable, Ownable, Math {
    ...
    IERC20 public constant dai =
        IERC20(0xdc31Ee1784292379Fbb2964b3B9C4124D8F89C60);
        // IERC20(0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B);
    ...
    function convertTreasuryToReserve() external payable onlyOwner {
    ...
    function _borrowLimit() public view returns (uint256) {
        ...
        uint256 ethPrice = uint256(_getLatestPrice());
        uint256 amountLeft = mulExp(amountLocked, ethPrice).sub(
            amountBorrowed
        );
...
contract DLYToken is ERC20Burnable, Ownable {
    constructor() ERC20("DLYToken", "DLYC") {
    }

    // Mint mock to example
