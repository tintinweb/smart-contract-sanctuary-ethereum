    ...
    PausableUpgradeable
{
    ...
    function getLimit(address operator, uint256 operatorDailyLimit)
        public
        view
        returns (uint256)
    {
    ...
    function getOperatorLimit(address operator) public view returns (uint256) {
        uint256 operatorLimit = getLimit(operator, getOperatorDailyLimit());
        uint256 bridgeLimit = getLimit(address(this), getTotalDailyLimit());
