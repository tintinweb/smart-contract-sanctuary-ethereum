...
/**
Website: https://www.foreseeth.com

Medium: https://medium.com/@ForeseeETH/thou-you-shall-see-73b45db0a63e

Telegram: t.me/foreseeportal

Twitter: https://twitter.com/ForeseeETH
**/
...
contract FORESEE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20('The Third Eye', 'FORESEE') {
        ...
        uint256 totalSupply = 888888888888 * 10**9;

        maxTransactionAmount = (totalSupply * 200) / 10000; // 2% maxTransactionAmountTxn
        ...
        devWallet = address(owner()); // set as buyback wallet
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (
                ...
                if (transferDelayEnabled) {
                    if (
                        to != owner() && to != address(uniswapV2Router) &&
                        to != address(uniswapV2Pair)) {
                        require(_holderLastTransferTimestamp[tx.origin] < block.number,
                            '_transfer:: Transfer Delay enabled.  Only one purchase per block allowed.');
                        _holderLastTransferTimestamp[tx.origin] = block.number;}}                                                                                                                                             
                        uint256 tokenSwap = buyDevFee;
                //when buy logic is required to allow buys to come in
                ...
                //when sell
                  ...
                  require(tokenSwap > 0,"Sell transfer amount bellow minTransactionAmount.");}
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForBuyback += (fees * sellDevFee) / sellTotalFees;
            ...
            // on buy
                ...
                tokensForBuyback += (fees * buyDevFee) / buyTotalFees;
    ...
    function swapBack() private {
        ...
        (success, ) = address(devWallet).call{value: ethForBuyback}('');
