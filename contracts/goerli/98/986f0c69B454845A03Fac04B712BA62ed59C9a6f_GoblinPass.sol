...
contract GoblinPass is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(PassConfig memory config) ERC721A("GoblinPass", "GOBLINPASS") {
        ...
        friieMiinttss = config.friieMiinttss;
        scheeapiarPrizzc = config.scheeapiarPrizzc;
        stndrrdPrizzc = config.stndrrdPrizzc;
        ...
        returns (uint256 cost, uint256 phreeePiss)
    {
        ...
        uint256 amountGoblins = goblinz.balanceOf(msg.sender);
        phreeePiss = 0;
