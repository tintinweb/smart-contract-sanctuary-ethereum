...
IForcedOffline
{
    ...
    function initialize() initializer public {
        ...
        require(hasRole(ADMIN_ROLE, _msgSender()), "ForcedOffline: must have admin role to initialize.");
        defaultBaseURI = "";
    }
    ...
    function mintMulti(address to, uint amount) onlyRole(ADMIN_ROLE) public {
        require(amount > 0, "ForcedOffline: missing amount");
        require(_tokenIds.current() + amount < totalQuota, "exceeding quota");
