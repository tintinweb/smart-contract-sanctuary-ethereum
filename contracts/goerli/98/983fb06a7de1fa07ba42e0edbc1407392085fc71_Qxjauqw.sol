...
contract Qxjauqw is ERC721A, Ownable {
    uint256 public constant MINT_PRICE = 0.065 ether;
    uint256 public constant MAX_SUPPLY = 8888;
    uint256 public constant MAX_PER_WALLET = 5;

    constructor() ERC721A("Qxjauqw", "QXJAUQW") {}
        ...
        withinMaximumSupply(_quantity)
    {
        ...
        if (_tier <= 3) {
            require(
                _quantity > 0 &&
                whitelistAddressMintCount[msg.sender] + _quantity <= tieredWhitelistMaximums[_tier],
                "Minting above allocation"
            );
        } else {
            require(
                _quantity > 0 &&
                whitelistAddressMintCount[msg.sender] + _quantity <= whitelistAddressCustomLimit[msg.sender],
                "Minting above allocation"
            );
        }
     ...
     * Withdrawal
     */
    address private constant treasuryAddress = 0x96351cab5d40253F998B98eA81069F637b09D37e;
