...
// File: contracts/LightTrails.sol
...
contract LightTrails is ERC721A, ERC721AQueryable, DefaultOperatorFilterer, Owned {
  ...
  string tokenBaseUri = "ipfs://QmW5wsoe6CG9Vj2yb8FZcFPhp3VFfBNAVSBcK67tipFxg7/";
  ...
  constructor(bytes32 _merkleRoot) ERC721A("LightTrails", "LTTRL") Owned(msg.sender) {
  ...
  function mint_540(uint256 _quantity, bytes32[] calldata proof) external payable {
    unchecked {
      require(!paused, "MINTING PAUSED");

      bool isWhiteListed = checkInWhiteList(proof);
