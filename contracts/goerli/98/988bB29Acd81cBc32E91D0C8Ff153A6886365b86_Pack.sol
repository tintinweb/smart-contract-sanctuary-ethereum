...
// File contracts/PackDividendTracker.sol
pragma solidity ^0.8.16;
...
// File contracts/PackToken.sol
pragma solidity ^0.8.16;
/// @notice Pack main contract
/// @custom:security-contact [email protected]
contract Pack is Initializable, ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    using SafeMath for uint256;
    ...
    function initialize(PackDividendTracker tracker) public initializer {
    ...
    function _transfer(
        ...
        // Anti-bot can be removed after launch
        if(twoBlockLock && block.number > unpauseBlock) {
            // Set initial taxes after unlock
            liquidityFeeOnBuy = 1;
            marketingFeeOnBuy = 1;
            holdersFeeOnBuy = 4;
            totalFeeOnBuy = 6;
