...
contract RafPrice is Ownable{
    ...
    function set_raf_price(int new_gold_price, int project_returns_new_value, int raf_in_circulation_new_value) external onlyOwner {
        ...
        raf_in_circulation_variation = ((raf_in_circulation_new_value - raf_in_circulation)*10e36/raf_in_circulation)*raf_holders_weight;
        gold_variation = ((new_gold_price - gold_price)*10e36/gold_price)*gold_investment_weight;
        project_returns_variation = ((project_returns_new_value - project_returns)*10e36/project_returns_variation_divisor)*projects_investment_weight;
