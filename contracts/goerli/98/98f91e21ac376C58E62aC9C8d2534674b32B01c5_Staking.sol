  ...
  IStaking
{
  ...
  function isAllowedForStaking(address nftAddress) external view returns (bool) {
  ...
  function _stake(
    ...
    require((amount + position.stakedAmount) <= pool.period.capPerPosition, "CapLimit reached for pool");
    updatePool(pool);
  ...
  function allowForStaking(address nftAddress) external override onlyOwner {
  ...
  function addStakingRewardToNFTPool(
    ...
    pool.period.capPerPosition = maxCapPerPosition;
...
interface IStaking {
  ...
  function allowForStaking(address nftAddress) external;
