...
contract TradingInsults is ERC721A, IERC2981, Ownable {
    ...
    struct PriceConfig {
        uint256 standardInsult;
        uint256 doubleInsult;
        uint256 greedyInsult;
        uint256 boostInsult;
        uint256 boosterInsult;
        uint256 boostestInsult;
        uint256 kingInsult;
    }

    struct TimerConfig {
        uint256 extensionSeconds;
        uint256 boostReductionBps;
        uint256 boosterReductionBps;
        uint256 boostestReductionBps;
    }

    struct Shares {
        uint256 kingShares;
        uint256 lastMinterShares;
    ...
    function setSaleDuration(uint256 saleDuration) external onlyOwner {
    ...
    function setSaleState(bool isSaleStateOpen) external onlyOwner {
        ...
        if (_config.saleExpiry == 0)
            _config.saleExpiry = block.timestamp + _config.saleDuration;
