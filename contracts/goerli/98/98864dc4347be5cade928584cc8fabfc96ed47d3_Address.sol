...
contract OxToadz is ERC721, Ownable {
  ...
  uint256 public publicSaleWalletLimit = 23;
  uint256 public preSaleCost = 0 ether;
  uint256 public publicSaleCost = 0.02023 ether;
  ...
  constructor() ERC721("senrmas", "MRAN") {
  ...
  function mint(uint256 _mintAmount, string memory random) public payable mintCompliance(_mintAmount){
