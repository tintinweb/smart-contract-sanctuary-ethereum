...
contract Arbitrage is DyDxFlashLoan {
    ...
    function loan(uint amount) public pure {
        amount++;
    }

    //
    function executeTrade(
        // sarà sempre token piccolo
        address _tokenA,
        uint _tokensFromFlashLoan,
        // sarà sempre token grande
        address _tokenB,
        bool _startOnUniswap
    ) external {
        // Prendere bilancio tokenA prima del flashloan
        // Eseguire flashloan
        // Prendere bilancio tokenA dopo il flashloan
        // Sottrare il bilancio dopo a prima e dovremmo ottenere il flashAmount
        loan(2);
        ...
        if (_startOnUniswap == true) {
            ...
            swapOnSushiswap(
                // il numero di token 0 che il nostro smart contract possiede
