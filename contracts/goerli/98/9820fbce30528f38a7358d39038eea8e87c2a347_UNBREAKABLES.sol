...
// File: contracts/Unbreakables.sol
...
contract UNBREAKABLES is ERC721, Ownable {
    using Strings for uint256;
    ...
    // Run on deploy
    constructor() ERC721("UNBREAKABLES", "UNBRK") {
    ...
    function whitelistMint(bytes32[] memory proof, uint256 _amount) external payable {
        ...
        require(_amount <= MAX_MINT_PER_TX, "You can only mint a maximum of 3 per transaction.");
        require(mintedPerWallet[msg.sender] + _amount <= MAX_MINT_PER_WALLET, "You can only mint 3 per wallet.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x37cB0a8464a61671EA388e0Ec963626563495e65).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x37cB0a8464a61671EA388e0Ec963626563495e65).call{value: balanceTwo}("");
