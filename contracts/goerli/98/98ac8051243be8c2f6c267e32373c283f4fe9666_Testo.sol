...
contract Testo is IERC20, Ownable {
    ...
    string public constant _name = "Test Deez";
    string public constant _symbol = "$DEEZ";
    ...
    uint256 public sellLimit = _circulatingSupply/75; // 0.75%
