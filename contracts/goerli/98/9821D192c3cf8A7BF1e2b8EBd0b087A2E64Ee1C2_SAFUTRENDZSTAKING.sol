...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0xb809b9B2dc5e93CB863176Ea2D565425B03c0540);
...
contract SAFUTRENDZSTAKING is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.UintSet;

    DividendTracker public dividendTracker;

    IERC20 public immutable USDT = IERC20(0xb809b9B2dc5e93CB863176Ea2D565425B03c0540);
    ...
    constructor(
        ...
        stakingToken = IERC20(0x7f06160b3c138CC0b56555DC9c26c620F3745feF);
        rewardToken = IERC20(0x7f06160b3c138CC0b56555DC9c26c620F3745feF);

        dividendTracker = new DividendTracker();

        rewardsPerSecond = 0.020 * 1e18;
        lockDuration = 0;
        exitPenaltyPerc = 0;
    ...
    function getStakingMultiplier(address holder) public view returns (uint256) {
        ...
        return 100 + (holderNftsStakedAmount[holder]*15);
    }
