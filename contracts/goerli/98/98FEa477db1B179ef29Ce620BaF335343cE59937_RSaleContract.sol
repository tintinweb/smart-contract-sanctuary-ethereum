...
contract RSaleContract is Ownable, ReentrancyGuard {
    ...
    // set time
    uint64 public immutable whitelistStartTime = 1676359800;
    uint64 public immutable whitelistEndTime = 1676360700;
    uint64 public immutable publicStartTime = 1676361600;
    uint64 public immutable publicEndTime = 1676362500;

    mapping(address => bool) public whitelistMinted;
    mapping(address => bool) public publicYinMinted;
    mapping(address => bool) public publicYangMinted;

    address RTokenAddress = address(0x3daa011B1AF9333AacAE88661C387beB373651Ec);
