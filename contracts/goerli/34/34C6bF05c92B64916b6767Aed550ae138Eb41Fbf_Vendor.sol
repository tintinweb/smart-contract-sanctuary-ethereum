...
contract Vendor is Ownable {
    ...
    function sellTokens(uint _amount) public {
        // yourToken.approve(msg.sender, _amount); in ERC20
        yourToken.transferFrom(msg.sender, address(this), _amount);
        (bool sent, ) = msg.sender.call{value: (_amount / tokensPerEth)}("");
        require(sent, "selling failed");
    }
}
...
contract YourToken is ERC20 {
    constructor() ERC20("Gold", "GLD") {
        ...
        // _mint(0x9Af3F15fCc7A4430F871aA64Fb6f82861f927Aa7, 1000 * 1e18);
        //side quest checkpoint 3 | it mints to vendor contract instead of multiple routes
