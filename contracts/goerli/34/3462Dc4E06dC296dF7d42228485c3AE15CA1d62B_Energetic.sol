        ...
        returns (string memory)
    {
        string memory output = string(
            abi.encodePacked(
                ...
                '<animate attributeName="stop-color" values="lightblue;blue;red;red;black;red;red;purple;lightblue" dur=360s" repeatCount="indefinite" />',
                "</stop>",
                '<stop offset="50%" stop-color="hsl(48, 100%, 50%)" />',
                '<stop offset="100%" stop-color="hsl(340, 100%, 50%)">',
                '<animate attributeName="stop-color" values="lightblue;yellow;purple;red;black;purple;orange;blue;lightblue" dur="120s" repeatCount="indefinite" />',
                '<animate attributeName="offset" values=".95;.80;.60;.40;.20;0;.20;.40;.60;.80;.95" dur="60s" repeatCount="indefinite" />',
                "</stop>",
                "</radialGradient>",
                SVG_DEFS_CLOSER,
                SVG_RECT_OPENER,
