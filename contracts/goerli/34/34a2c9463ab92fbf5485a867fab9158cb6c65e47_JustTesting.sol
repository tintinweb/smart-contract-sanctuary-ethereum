...
contract JustTesting is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "JustTesting";
    string constant _symbol = "JustTesting";
    ...
    address public marketingFeeReceiver = 0xe4A1CC608eE92e8a5eE9CC01D58526ba83f439a2;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xaA74140d9B595da5eF276a444C6EC35cB146fDaC] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xaA74140d9B595da5eF276a444C6EC35cB146fDaC] = true;
    ...
    //Exclude team member from fees.
    function shouldNotTakeFee(address stonker) internal view returns (bool) {
        return isFeeExempt[stonker];
    }
