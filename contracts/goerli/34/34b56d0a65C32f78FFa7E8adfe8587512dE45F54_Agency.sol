...
contract Agency is ERC721A, ERC2981, Ownable {
  ...
  uint constant TEAM_MINT_SUPPLY = 201;

  uint price = 0.0001 ether; // todo: update

  uint max_per_txn = 7;

  address theAgency = 0x4D5949BE178270B031c18FE86663d8bA5Ea97204;

  bool earlyRecruitmentIsOpen = true; // todo: false
  bool itsRecruitingSeason = true; // todo: false
  bool teamHasBeenRecruited;
  bool receiveable = true; // todo: false

  mapping(address => bool) addressHasMinted;
  mapping(address => uint) theSpecialists;
