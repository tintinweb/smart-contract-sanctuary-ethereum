...
contract TheGreatBurning is Ownable, VRFConsumerBaseV2, ReentrancyGuard {
    ...
    // ===========================
    IERC721 public bones = IERC721(0x364a330196d8c5FeF5F9A21e4eDd9d37C835e7fB);
    address public graveyard = 0x000000000000000000000000000000000000dEaD;
    ...
    function viewEntriesByWallet() public view returns (uint256) {
        Raffle storage raffle = raffles[numRaffles - 1];
        return raffle.walletEntries[msg.sender];
    }
