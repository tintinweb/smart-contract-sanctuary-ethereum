    ...
    ERC2981
{
    ...
    address public burnToMintContractAddress =
        0xE8d130e4d13404265651DAD91Bfc795404C6FdF3;
    address public burnToMintContractAddress721 =
        0x5F87Aa39D079C786b8225e7e5Fc9E1D77812B5e8;
    address public freeClaimContractAddress =
        0x5F87Aa39D079C786b8225e7e5Fc9E1D77812B5e8;
    address public royaltyAddress = 0x057E9421F42dA685e15Da50B5DB430c829fb495E;
    address[] public payoutAddresses = [
        0x057E9421F42dA685e15Da50B5DB430c829fb495E
    ];
    ...
    bool public burnClaimActive721;
    ...
    string public baseTokenURI =
        "ipfs://bafybeifddoonitxrhxhxw2ler6y5x7bvmmj6yehpzxi7me4vrsisrtggru/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 1000;
    uint256 public mintsPerBurn = 1;
    uint256 public mintsPerBurn721 = 5;
    uint256 public mintsPerClaim = 2;
    ...
    uint256 public claimPrice = 0.001 ether;
    ...
    uint96 public royaltyFee = 10;

    constructor(address _blocklistContractAddress) ERC721A("alltogetha", "allT") {
     ...
     * @notice To be updated by contract owner to allow burning to claim a token
     */
    function setBurnClaimState721(bool _burnClaimActive721) external onlyOwner {
        require(
            burnClaimActive721 != _burnClaimActive721,
            "NEW_STATE_IDENTICAL_TO_OLD_STATE"
        );
        burnClaimActive721 = _burnClaimActive721;
    }
     ...
     * @notice Update the number of free mints claimable per token burned
     */
    function updateMintsPerBurn721(uint256 _mintsPerBurn721) external onlyOwner {
        mintsPerBurn721 = _mintsPerBurn721;
    }
        ...
        originalUser
    {
        ...
        require(
            ExternalERC1155BurnContract.balanceOf(msg.sender, 1) >= amount, /**tokenID of burn**/
    ...
    function burnERC721ToMint(uint256[] calldata _tokenIds)
        ...
        originalUser
    {
        require(burnClaimActive721, "BURN_CLAIM_IS_NOT_ACTIVE");
        uint256 numberOfTokens = _tokenIds.length;
        require(numberOfTokens > 0, "NO_TOKEN_IDS_PROVIDED");
        require(
            totalSupply() + (numberOfTokens * mintsPerBurn721) <= MAX_SUPPLY,
            "MAX_SUPPLY_EXCEEDED"
        );
        ERC721A ExternalERC721BurnContract = ERC721A(burnToMintContractAddress721);
        ...
        _safeMint(msg.sender, numberOfTokens * mintsPerBurn721);
    }
    ...
    /**
     * @notice Update the claim mint price
     */
        ...
        originalUser
    {
        ...
        require(msg.value == claimPrice * mintsPerClaim, "PAYMENT_INCORRECT");
