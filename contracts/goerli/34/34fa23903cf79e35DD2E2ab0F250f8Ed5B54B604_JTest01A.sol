...
/**
 * @title JTest01A Contract
 * @notice This contract handles minting and distribution of tokens.
 */
contract JTest01A is ERC721A, Ownable, ReentrancyGuard {
  ...
  address constant WITHDRAW_ADDRESS =
    0x0c7d0B28AbfEA8273c7B12A6e1FD466dc4D2A825;
  ...
  /**
   * @notice Allow an address on the allow list to mint a single token. Allow to mint one token per address.
   */
    ...
    onlyAccounts
  {
    ...
    require(
      ...
      "1 Mint per Wallet, DON'T be greedy."
    );
    require(
      totalSupply() + quantity <= MAX_SUPPLY,
      'Minting ended. All sold out.'
    );
  ...
  modifier isValidMerkleProof(bytes32[] calldata _proof) {
    require(
      ...
      'Not allowed address for minting.'
    );
    _;
  }
