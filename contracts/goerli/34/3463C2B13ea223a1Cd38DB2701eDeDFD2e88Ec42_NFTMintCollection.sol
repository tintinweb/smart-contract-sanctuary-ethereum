...
import "./templates/NFTMint.sol";

contract NFTMintCollection is NFTMint {
    constructor(
...
ITemplate
{
    ...
    struct DeploymentConfig {
        ...
        // Donation address for charity one.
        address payable charityOneAddress;
        // Donation address for charity two.
        address payable charityTwoAddress;
        // Donation percentage for charity one.
        uint256 charityOnePercentage;
        // Donation percentage for charity two.
        uint256 charityTwoPercentage;
    }
    ...
    /// Contract name
    string public constant NAME = "Token Name2";
    ...
    function reserveMint(address to, string memory uri)
    external
    onlyRole(ADMIN_ROLE)
    {
    ...
    function burnToken(uint256 tokenId) external onlyRole(ADMIN_ROLE)
    {
        super._burn(tokenId);
    }
    ...
    function withdrawFees() external onlyRole(ADMIN_ROLE) {
        ...
        _deploymentConfig.charityOneAddress.sendValue( _contractBalance * _deploymentConfig.charityOnePercentage / 100);
        _deploymentConfig.charityTwoAddress.sendValue( _contractBalance * _deploymentConfig.charityTwoPercentage / 100);
    ...
    function _mintTokens(address to, uint256 tokenId) internal {
