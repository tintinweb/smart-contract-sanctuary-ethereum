...
contract TheFlags is ERC721, Ownable, RevokableDefaultOperatorFilterer {
    ...
    modifier checkIdExists(uint256 flagId){
        require(flagId != 0, "Flags idexes starts from 0"); // с 1?
    ...
    constructor() ERC721("TheFlags", "FLG") {
    ...
    function getConfigurations(bytes1 config) private pure returns (decompressionParameters memory params){
...
import "contracts/RevokableOperatorFilterer.sol";
...
import "contracts/UpdatableOperatorFilterer.sol";
import "contracts/IOperatorFilterRegistry.sol";
