...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("girl", "GIRL") {
        baseUri = "ipfs://bafybeicy4sbleup42m4gmov7rbthtuokwdcukvpk2y24yhnubelob4naiu/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x817d14d2552b6dFFc18b3c16E4633578250fee05).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x817d14d2552b6dFFc18b3c16E4633578250fee05).call{value: balanceTwo}("");
