...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public AlienFi =
        IERC20Extended(0x9801b4fEF6AB66B7033Fa152044Ee87Dd99E2aac);
    ...
    uint256 public minDistribution = 1 * (10**AlienFi.decimals());
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = AlienFi.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = router.WETH();
        path[1] = address(AlienFi);

        router.swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: msg.value
        }(0, path, address(this), block.timestamp);

        uint256 amount = AlienFi.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            AlienFi.transfer(shareholder, amount);
...
// main contract
contract atst is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "atst";
    string private constant _symbol = "$atst";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 1_000_000_000_000 * 10**_decimals;

    address public AlienFi = 0x9801b4fEF6AB66B7033Fa152044Ee87Dd99E2aac;
    ...
    uint256 _marketingBuyFee = 15_00;

    uint256 _reflectionSellFee = 3_00;
    uint256 _liquiditySellFee = 2_00;
    uint256 _marketingSellFee = 25_00;
    ...
    constructor() Ownable() {
        ...
        marketingFeeReceiver = 0xd88f57993Dc62452A3147cFD0c4A6d233877fF74;
