...
contract WishPool is Initializable, Pausable, Ownable {
    ...
    // useraddr -> tokenid -> redeemgen -> wishid -> 
    // grantaddr -> granttokenid -> grantnftgen -> grantwishid -> grantcolor -> 
    // donatetoken -> donateamount -> blocktime
    ...
    function redeem(RedeemData memory redeemData) public 
        ...
        // burn redeem nft
        IBurnNft(appConf.getRedeemNftToken()).burn(redeemData.tokenId);
