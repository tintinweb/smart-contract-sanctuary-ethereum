...
contract Octilions is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxPresaleWalletLimit = 88;
  uint256 public maxPublicSaleWalletLimit = 88;
  ...
  constructor() ERC721A("Octilions", "OCTA") {
      setHiddenMetadataUri("https://n3cr0.dev/hidden.json");
  }
