...
contract MergeGatorsMock is MergeGators {
    ...
    //11
    address constant collection = 0x2fE1Db79ABd0d61D688d9121A24496A3b7117DB6;
...
contract MergeGators is IMergeGators, Ownable, VRFConsumerBaseV2 {
    ...
    constructor(
        ...
        bytes32 gasLane_
            ...
            vrfCoordinator = VRFCoordinatorV2Interface(vrfCoordinatorV2_);
            gasLane = gasLane_;
        }
    ...
    function merge(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        if (alligators.tokenType(_1st) == 3 || alligators.tokenType(_2nd) == 3 || alligators.tokenType(_2nd) == 3) revert Mergefailed();
        ...
        if (alligators.anatomy(_1st)[0] == alligators.anatomy(_2nd)[0] && alligators.anatomy(_1st)[0] == alligators.anatomy(_3rd)[0]) {
            ...
            if (alligators.traitLevels(_1st)[0] != alligators.traitLevels(_2nd)[0] && alligators.traitLevels(_1st)[0] != alligators.traitLevels(_3rd)[0]) revert Mergefailed();

            if (alligators.traitLevels(_1st)[0] < 4) {

                _1stType[1]++;            
            }
        } else if (alligators.anatomy(_1st)[1] == alligators.anatomy(_2nd)[1] && alligators.anatomy(_1st)[1] == alligators.anatomy(_3rd)[1]) {
            if (alligators.traitLevels(_1st)[1] != alligators.traitLevels(_2nd)[1] && alligators.traitLevels(_1st)[1] != alligators.traitLevels(_3rd)[1]) revert Mergefailed();

            if (alligators.traitLevels(_1st)[1] < 4) {

                _2ndType[1]++;
            }

        } else if (alligators.anatomy(_1st)[2] == alligators.anatomy(_2nd)[2] && alligators.anatomy(_1st)[2] == alligators.anatomy(_3rd)[2]) {
            if (alligators.traitLevels(_1st)[2] != alligators.traitLevels(_2nd)[2] && alligators.traitLevels(_1st)[2] != alligators.traitLevels(_3rd)[2]) revert Mergefailed();

            if (alligators.traitLevels(_1st)[2] < 4) {

                _3rdType[1]++;
            }            

        } else if (alligators.anatomy(_1st)[3] == alligators.anatomy(_2nd)[3] && alligators.anatomy(_1st)[3] == alligators.anatomy(_3rd)[3]) {
            if (alligators.traitLevels(_1st)[3] != alligators.traitLevels(_2nd)[3] && alligators.traitLevels(_1st)[3] != alligators.traitLevels(_3rd)[3]) revert Mergefailed();

            if (alligators.traitLevels(_1st)[3] < 4) {

                _4thType[1]++;
            }

        } else if (alligators.anatomy(_1st)[4] == alligators.anatomy(_2nd)[4] && alligators.anatomy(_1st)[4] == alligators.anatomy(_3rd)[4]) {
            if (alligators.traitLevels(_1st)[4] != alligators.traitLevels(_2nd)[4] && alligators.traitLevels(_1st)[4] != alligators.traitLevels(_3rd)[4]) revert Mergefailed();

            if (alligators.traitLevels(_1st)[4] < 4) {

                _5thType[1]++;
            }

        } else if (alligators.anatomy(_1st)[5] == alligators.anatomy(_2nd)[5] && alligators.anatomy(_1st)[5] == alligators.anatomy(_3rd)[5]) {
            if (alligators.traitLevels(_1st)[5] != alligators.traitLevels(_2nd)[5] && alligators.traitLevels(_1st)[5] != alligators.traitLevels(_3rd)[5]) revert Mergefailed();

            if (alligators.traitLevels(_1st)[5] < 4) {

                _6thType[1]++;
            }

        } else if (alligators.anatomy(_1st)[6] == alligators.anatomy(_2nd)[6] && alligators.anatomy(_1st)[6] == alligators.anatomy(_3rd)[6]) {
            if(alligators.traitLevels(_1st)[6] != alligators.traitLevels(_2nd)[6] && alligators.traitLevels(_1st)[6] != alligators.traitLevels(_3rd)[6]) revert Mergefailed();

            if (alligators.traitLevels(_1st)[6] < 4) {
    ...
    function mergeWithJoker(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        if (JokerLvl == alligators.traitLevels(_2nd)[0] && JokerLvl == alligators.traitLevels(_3rd)[0]) {
            ...
            if (alligators.traitLevels(_2nd)[0] < 4) {
            // 
            _1stType[1]++;
            }
        } else if (JokerLvl == alligators.traitLevels(_2nd)[1] && JokerLvl == alligators.traitLevels(_3rd)[1]) {

            if (alligators.traitLevels(_2nd)[1] < 4) {
                _2ndType[1]++;
            }
        } else if (JokerLvl == alligators.traitLevels(_2nd)[2] && JokerLvl == alligators.traitLevels(_3rd)[2]) {

            if (alligators.traitLevels(_2nd)[2] < 4) {
                _3rdType[1]++;

            }
        } else if (JokerLvl == alligators.traitLevels(_2nd)[3] && JokerLvl == alligators.traitLevels(_3rd)[3]) {

            if (alligators.traitLevels(_2nd)[3] < 4) {
                _4thType[1]++;

            }
        } else if (JokerLvl == alligators.traitLevels(_2nd)[4] && JokerLvl == alligators.traitLevels(_3rd)[4]) {

            if (alligators.traitLevels(_2nd)[4] < 4) {
                _5thType[1]++;

            }
        } else if (JokerLvl == alligators.traitLevels(_2nd)[5] && JokerLvl == alligators.traitLevels(_3rd)[5]) {

            if (alligators.traitLevels(_2nd)[5] < 4) {
                _6thType[1]++;

            }
        } else if (JokerLvl == alligators.traitLevels(_2nd)[6] && JokerLvl == alligators.traitLevels(_3rd)[6]) {

            if (alligators.traitLevels(_2nd)[6] < 4) {
                _7thType[1]++;
