...
contract bruh is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint public constant maxSupply = 430;
    uint private constant TOKENS_RESERVED = 2;
    uint public price = 0.001 ether;
    uint public wlprice = 0.001 ether;
    uint256 public constant MAX_MINT_PER_TX = 430;
    ...
    constructor() ERC721A("Oppies", "OPPIE") {
        baseUri = "ipfs://QmTtXVq68k2imiifnqxq7QDexZy15FN7u15e6WAdH2ESjT/";
    ...
    function mintAllowlist(uint256 tokens, bytes32[] calldata merkleProof) external payable {
        ...
        require(totalSupply() + tokens <= MAXMINTWL, "You can't mint anymore");
        require(tokens > 0, "Must mint at least one Oppie");
        require(_ALWalletMints[_msgSender()] + tokens <= MAX_MINT_PER_TX, " limit for this wallet reached");
