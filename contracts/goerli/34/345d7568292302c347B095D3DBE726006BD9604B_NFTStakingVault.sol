...
import "./interfaces/IAlphaApeClub.sol";
import "./interfaces/IAlphaApeClubToken.sol";
...
contract NFTStakingVault is Ownable, IERC721Receiver {
    ...
    IAlphaApeClub immutable nft;
    IAlphaApeClubToken immutable token;
    ...
    constructor(address _nftAddress, address _tokenAddress) {
        nft = IAlphaApeClub(_nftAddress);
        token = IAlphaApeClubToken(_tokenAddress);
    }
