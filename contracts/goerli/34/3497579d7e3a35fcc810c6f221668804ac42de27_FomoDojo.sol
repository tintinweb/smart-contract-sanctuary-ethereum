...
interface IMofo is IERC721, IERC721Metadata, IERC721Receiver {
    struct StakedOwner {
...
contract FomoDojo is IMofo, ERC165, Ownable, ReentrancyGuard {
    using Strings for uint256;
    using ECDSA for bytes32;

    string constant public override name = "Fomo Mofo Dojo";
    string constant public override symbol = "FomoDojo";

    address private _fomoMofo;
    ...
    function exitDojo(uint256[] calldata dojoIds) external nonReentrant {
