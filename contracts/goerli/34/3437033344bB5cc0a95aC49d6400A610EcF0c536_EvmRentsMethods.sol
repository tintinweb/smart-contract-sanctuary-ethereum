...
contract EvmRentsMethods is ERC721Holder, ERC1155Holder, Ownable, TokensHandler {
    uint public id;
    uint public fee = 20;
    ...
    function rent(uint rentId) external payable {
        ...
        transferTokens(rents[rentId].owner,address(this),rents[rentId].nftAddresses,rents[rentId].nftIds,rents[rentId].nftTypes);
    ...
    function finish(uint rentId) external {
        ...
        transferTokens(address(this),rents[rentId].owner,rents[rentId].nftAddresses,rents[rentId].nftIds,rents[rentId].nftTypes);
