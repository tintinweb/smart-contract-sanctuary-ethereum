...
contract Staker {
  ...
  modifier notTimeYet(bool timeYet) {
  ...
  function stake() public payable stakeNotCompleted notTimeYet(false){

    require(msg.sender !=  address(0x0), "address zero");
    require(block.timestamp < deadline,"staking time exceed");
  ...
  function execute() public stakeNotCompleted notTimeYet(false){
  ...
  function withdraw() public stakeNotCompleted notTimeYet(true){
    uint256 userBalance = balances[msg.sender];
      require(userBalance > 0, "Funds not enough");
