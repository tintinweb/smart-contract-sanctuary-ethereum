...
contract WillFactory is AccessControl{
    ...
    function getInformationsWill(uint256 _tokenId) public view returns(string memory, string memory ,string memory,address  ){
        ...
        return (name,desc , ipfs, tokendIdOfWill[_tokenId]);
    }
