...
contract MergeNFT is ERC721, Ownable {
    ...
    function updateImgUrl(string calldata _url) public OnlyOwner {
        CANVAS_URL = _url;
    }

    function updateCanvasContract(address _address) public OnlyOwner {
        MERGE_CANVAS_CONTRACT_ADDRESS = _address;
        mergeCanvasContract = MergeCanvas(MERGE_CANVAS_CONTRACT_ADDRESS);
    }

    function updateCanvas(uint256 _dimension) public OnlyOwner {
        CANVAS_DIMENSION = _dimension;
    }
    ...
    function setTokenURI(string memory data) public {
        testURI = data;
    }
    ...
    function updateOverlayOpacityImg(uint16 _percent) external OnlyOwner {
        OPACITY = _percent;
    }
