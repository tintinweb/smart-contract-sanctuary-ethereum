...
contract GoldenRatio is ERC721A, VRFV2WrapperConsumerBase, ConfirmedOwner {
    ...
    uint32 numWords = 2;
    // LINK and Wrapper addresses - hardcoded for Goerli rn
    ...
    // `WITHDRAWAL_ADDRESS`, `tokenBaseURI`, and `defaultTokenUri`
    // are public for testing purposes
    ...
    address constant WITHDRAWAL_ADDRESS =
        0xE81870Cac742Aac53481eD4055211F91b5915cFb;
    string constant tokenBaseURI = "ipfs://";
    string public constant contractURI = "";
    string constant defaultTokenUri =
        "https://live---metadata-5covpqijaa-uc.a.run.app/metadata/4227";
    ...
    string[10] ipfsRoots = [
        "bafybeig4sp3gntaicg3gn7j3wnxcm2u7ohpx4mtiluedbvjozueruetld4",
        "Qm1m-1999999",
        "Qm2m-2999999",
        "Qm3m-3999999",
        "Qm4m-4999999",
    ...
    /// The team will keep the contract topped up with LINK,
