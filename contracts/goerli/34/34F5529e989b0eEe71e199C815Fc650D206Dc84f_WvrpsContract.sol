...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0x4b96315d6df01ed197A2816A93c1949dc9cc5A5B];
...
// File: contracts/WvrpsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract WvrpsContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/8Cd8U1BgsTqgaAIfq5bs/contract-metadata";
  }
