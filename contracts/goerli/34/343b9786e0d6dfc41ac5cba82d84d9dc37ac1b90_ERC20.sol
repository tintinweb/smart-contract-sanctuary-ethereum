...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Token", "Token") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x4648a43B2C14Da09FdF82B161150d3F634f40491);
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokenBurn += fees * sellBurnFee / sellTotalFees;
            ...
            // on buy
                ...
                tokenBurn += fees * buyBurnFee / buyTotalFees;
