...
contract GOLDENGOALS is ERC721Enumerable, Ownable, ERC721Pausable, ERC721Burnable {

    using SafeMath for uint256;
    string public baseURI;
    // 75%
    address private devWallet = 0x1c6a568aF831C42a560207088d3826b16ad17427;
    // 25%
    address private madWallet = 0xf16616D3bCf6e8542d4ACEDDB6DE797D34aBD8cb;
    ...
    //Sale setup
    bool public sale;
    uint256 public tokenPrice = 0.00012 ether;
    uint256 public constant maxSupply = 10000;
    uint256 public maxMintAmount = 3;

    //Presale setup
    bool public presale;
    uint256 public constant tokenPricePresale = 0.0010 ether;
    ...
    function updateMadWallet(address _address, bool principal) public onlyOwner {
        if (principal) {
            madWallet = _address;
        } else {
            devWallet = _address;
    ...
    function withdrawAll() public onlyOwner {
        ...
        // 25%
        _widthdraw(madWallet, ((balance * 25) / 100));
        // 75%
        _widthdraw(devWallet, ((balance * 75) / 100));
    }
