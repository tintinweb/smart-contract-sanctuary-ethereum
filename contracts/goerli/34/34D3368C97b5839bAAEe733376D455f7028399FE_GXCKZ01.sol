 ...
 * @notice This contract handles minting GXCKZ-01 tokens.
 */
contract GXCKZ01 is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xFE38dd61FC5102C0587EF7705BAfB857070685dd;
    address public royaltyAddress = 0xcD2663b1a22c77cd8A41f06Cff115BDBe81D17D5;
    address[] public payoutAddresses = [
        0xcD2663b1a22c77cd8A41f06Cff115BDBe81D17D5
    ];
    bool public isPresaleActive = false;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeie3ebcwjv53jeknaybmomw6cs664xuipxxrujnzvt2yy67epgneom/";
    ...
    constructor() ERC721A("GXCKZ-01", "GXCKZ") {
