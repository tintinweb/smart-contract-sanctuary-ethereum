 ...
 * @notice This contract handles minting Test ooo tokens.
 */
contract TestOoo is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0x73a10b4D6d016706Bd8A33b090A0705C3aD966c6;
    address[] public payoutAddresses = [
        0x73a10b4D6d016706Bd8A33b090A0705C3aD966c6
    ];
    ...
    string public baseTokenURI =
        "https://gateway.pinata.cloud/ipfs/QmQYZFM8RYxnd8oGN7Jp6XAGsD5ZUj3Z6MyBmh6HUWPWMj/";
    ...
    constructor(address _blocklistContractAddress) ERC721A("Test ooo", "too") {
