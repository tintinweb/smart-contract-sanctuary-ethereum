...
contract Airdrop is IAirDrop, Initializable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function setActiveUser(
        ...
        require(!isClaimed(_airdropId, _account, _collectionAddress, _tokenId), "Airdrop is claimed");
        airdropBlacklist[_hashUniqueAirdrop(_airdropId, _account, _collectionAddress, _tokenId)] = false;
        emit ActiveUser(_account, _collectionAddress, _airdropId, _tokenId);
    }
...
interface IAirDrop {
    ...
    event SetActivateAirdrop(uint256 indexed airdropId, bool isActivate);
    ...
    function setActiveUser(uint256 _airdropId, address _account, address _collectionAddress, uint256 _tokenId) external;
}
