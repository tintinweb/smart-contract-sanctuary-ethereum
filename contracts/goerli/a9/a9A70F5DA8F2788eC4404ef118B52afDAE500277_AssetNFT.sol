...
import "../storage/AssetNFTStorage.sol";
import "../lib/Types.sol";

// EntityNFT wraps up all entity basic information
// ERC721A NFT which can be used for any Unique asset
contract AssetNFT is ERC721ABase, AssetNFTStorage, UUPSUpgradeable, IUpgradeable {
    
    function initialize(Types.RegisterNFTParams memory params) initializerERC721A initializer public {
        super._initialize(params.name, params.symbol, params.baseURI, params.contractURI, params.owner);
    }
    ...
    function balanceOf(address owner) public view override(IERC721AUpgradeable, ERC721AUpgradeable) returns (uint256 balance) {
    ...
    // We keep the minimal functionality in the mint function, and for any other feature, we can implement them in the 
    // middleware. Only the Engine can mint the 
...
abstract contract AssetNFTStorage {
