...
// File: interfaces/IBSManagement.sol


pragma solidity ^0.8.0;

/**
   @title IBSManagement contract
   @dev Provide interfaces that allow interaction to BSManagement contract
*/
interface IBSManagement {
...
contract BSAvatar is ERC721Enumerable, Ownable {
	
	IBSManagement public management;

	/**
		Tiers: Darksheep, Blacksheep, Greysheep, Whitesheep
	 */
	...
	constructor(address _management, string memory _uri) ERC721("BS", "BS") {
		management = IBSManagement(_management);
		baseURI = _uri;
	}

	/**
       	@notice Update Address of BSManagement contract
       	@dev  Caller must have MANAGER_ROLE
		@param	_management				Address of BSManagement contract
    */
