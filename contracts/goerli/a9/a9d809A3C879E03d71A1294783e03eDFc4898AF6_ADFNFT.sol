...
contract ADFNFT is ERC721, ERC721URIStorage, Ownable , NFTPausable{
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    // TODO : 
    // 1. backend : 
    //  1. receive event "OwnershipTransferred(oldOwner, newOwner)"
    constructor() ERC721("ArtdeFinance-BWB", "AFB") {
	}
