...
contract Cocktail is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Goerli cocktail - test", "COCKTAIL") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFTs(uint num) public payable {
        ...
        //         require(!whitelistedAddresses[msg.sender], "You already have claimed the whitelisted NFT");
        //     }
        // }
