...
contract EveraiTmp is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A("Everai", "EVERAI", 10, 10000) {
        maxPerAddressDuringMint = 10;
        amountForAuctionAndDev = 10000;
        amountForDevs = 300;
    }
    ...
    function auctionMint(uint256 quantity) external payable callerIsUser {
        ...
        uint256 totalPrice = getAuctionPrice(_saleStartTime).mul(quantity);
    ...
    //         "Claim: Not allowed to claim given quantity"
    //     );
    ...
    //     uint256 numberToClaim = quantity.sub(allowlistClaimed[msg.sender]);
