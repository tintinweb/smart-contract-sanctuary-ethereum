...
contract SwapFactory is IUniswapV2Factory {
    ...
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(HootPair).creationCode));
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        bytes memory bytecode = type(HootPair).creationCode;
...
contract HootPair is IUniswapV2Pair, HootLP {
...
contract HootLP is IUniswapV2ERC20 {
    using SafeMath for uint;

    string public constant name = 'Hoot-LP-Token';
    string public constant symbol = 'HOOT-LP';
