...
contract TestContract is ERC721Q {
    constructor() ERC721A("VueJS", "VJS") {}
}
...
abstract contract ERC721Q is ERC721A, ERC2981, Ownable {
    using SafeMath for uint256;

    bytes32 public merkleRoot;
    string public baseURI = 'https://zoo-nft.fra1.digitaloceanspaces.com/json/';
    uint256 public startTime = block.timestamp;
    uint256 public price = 0.00003 ether;
    uint256 public whitelistStartTime;
    uint256 public whitelistPrice = 0.00001 ether;
    ...
    function mint(uint256 quantity) external payable {
        //require(isMintActive, "The mint is not active.");
...
//        this.setMerkleRoot(_merkleRoot);
//        this.setBaseUri(_newBaseURI);
//        this.setPrice(_price);
//        this.setWhitelistPrice(_whitelistPrice);
//        maxPerWallet = _maxPerWallet;
//        maxSupply = _maxSupply;
//        ERC2981._setDefaultRoyalty(_royaltiesReceiver, _feeNumerator);
    }
