...
contract Router is IUniswapV3SwapCallback {
    ...
    function uniswapV3SwapCallback(
        ...
        address tokenIn;
        // TODO path can only be bytes, is there better way to compare
        if (keccak256(path) == keccak256('0')){
            tokenIn = 0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C;
        } else {
            revert('invalid path');
        }
    ...
    function swap_usdc_to_eth(
        ...
        (int256 amount0, int256 amount1) =
            IUniswapV3Pool(0x951b8635A3D7Aa2FD659aB93Cb81710536d90043).swap(
                address(this),
                false,
                amountIn,
