...
contract SwifyStaking is ReentrancyGuard {
    ...
    uint public amountOfTokenPerEth = 101398;
    uint public thirtyDaysApy = 100;
    uint public sixtyDaysApy = 100;
    uint public ninetyDaysApy = 100;
    uint public hundredTwentyDaysApy = 100;
    address swifyCoinAddress = 0x111757A75B21CbD5de6eCe8B9efc2FB8ABD85269; // Change To Mainnet
    ...
    function stakeTokens(string calldata symbol, uint tokenQuantity) external nonReentrant {
          ...
          positions[currentPositionId] = Position(
               ...
               block.timestamp,
               perWeekPayment,
               block.timestamp + (7 * 1 seconds), // Change to days
               0,
               apy,
               true,
               true
     ...
     function receiveWeekProfits(uint positionId) external nonReentrant {
          ...
          positions[positionId].nextWeekUnlockDate = block.timestamp + (7 * 1 seconds); // Change to days
