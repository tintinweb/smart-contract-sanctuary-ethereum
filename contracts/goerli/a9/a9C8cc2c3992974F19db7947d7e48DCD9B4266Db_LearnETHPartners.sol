...
contract LearnETHPartners is ERC721, ReentrancyGuard, Ownable {
    ...
    function registerAsPartner(uint256 _referrerTokenId, uint256 _level, uint256 _position) public nonReentrant {
        require(_exists(_referrerTokenId),"hgfjhfjh");
