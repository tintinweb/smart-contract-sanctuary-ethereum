...
contract ColorTerrain is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 300;
    uint private constant TOKENS_RESERVED = 33;
    ...
    constructor() ERC721("Color Terrain", "CT") {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xccAFCe6F00082d15Ba34Ce28D0C61fa1e70F10bB).call{value: balanceOne}("");
