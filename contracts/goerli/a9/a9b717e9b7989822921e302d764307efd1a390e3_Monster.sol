...
contract Monster is ERC721A, Owned, OperatorFilterer {
    ...
    string public baseURI = "https://ipfs.io/ipfs/Qmd2UNz5CNMFZVScq7R4FqDGPKzrZ3mfji3tyVdbEzPfDP/";

    bool public revealed = false;

    bool public operatorFilteringEnabled;

    constructor() ERC721A("Monsterss", "MMMS") Owned(msg.sender) {}
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if (revealed) {
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI_, tokenId)) : "";
        } else {
