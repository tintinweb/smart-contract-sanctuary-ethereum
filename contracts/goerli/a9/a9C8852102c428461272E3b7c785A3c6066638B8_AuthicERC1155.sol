...
contract AuthicERC1155 is IERC1155, IERC2981, AccessControl, ReentrancyGuard {
  struct RoyaltyInfo {
    address recipient;
    uint256 bps;
  }
  ...
  constructor(
    ...
    addNewToken(type(uint256).max, _uri, _maxSupply);
  }
  ...
  function addNewToken(
    ...
    string memory _uri,
    uint256 _maxSupply
  ) internal onlyRole(DEFAULT_ADMIN_ROLE) returns (uint256) {
