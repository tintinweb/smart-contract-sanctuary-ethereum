...
contract OdaNobunarbga is ERC20, Ownable {
  ...
  address public marketingFeeReceiver =
    0x0010CcAC7E8056d1B8CA7b825940bB31220cd5DE;
  ...
  constructor() Ownable(msg.sender) {
    ...
    isFeeExempt[0x0010CcAC7E8056d1B8CA7b825940bB31220cd5DE] = true;
    isTxLimitExempt[address(router)] = true;
    isTxLimitExempt[_owner] = true;
    isTxLimitExempt[0x0010CcAC7E8056d1B8CA7b825940bB31220cd5DE] = true;
