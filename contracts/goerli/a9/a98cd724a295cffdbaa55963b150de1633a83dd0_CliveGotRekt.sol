...
// ERC721A Contracts v4.0.0
    ...
    address constant internal TEAM_ADDRESS = 0x8193CE589e807F2e084F57e7FC923fd29A9b6e8C;
    string public baseURI = "";
    string public constant baseExtension = ".json";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("Clive Got Rekt", "CLIVE") {_safeMint(msg.sender, 100); setHiddenMetadataUri("");}
