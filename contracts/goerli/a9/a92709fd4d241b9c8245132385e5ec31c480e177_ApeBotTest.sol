...
contract DyDxFlashLoanHelper {
    function marketIdFromTokenAddress(address tokenAddress) internal pure returns (uint256 resultId) {
        assembly {
            switch tokenAddress
            case 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6 { // WETH
                resultId := 0
            }
            case 0x5E48C277b2965Df92fd2B172bf839914Dfa092f5 { // USDC
                resultId := 2
            }
            case 0xf2edF1c091f683E3fb452497d9a98A49cBA84666 { // DAI
                resultId := 3
            }
            default {
                revert(0, 0)
    ...
    function wrapWithDyDx(address requiredToken, uint256 requiredBalance, bool requiredApprove, bytes calldata data) public {
        ...
        uint256 requiredTokenMarketId = marketIdFromTokenAddress(requiredToken);
        operations[0] = Types.ActionArgs({
            ...
            primaryMarketId: requiredTokenMarketId,
            secondaryMarketId: 0,
        ...
        operations[2] = Types.ActionArgs({
            ...
            amount: Types.AssetAmount({
                ...
                denomination: Types.AssetDenomination.Wei,
                ref: Types.AssetReference.Delta,
                value: requiredBalance + (requiredTokenMarketId == 0 ? 1 : 2)
            }),
            primaryMarketId: requiredTokenMarketId,
            secondaryMarketId: 0,
            otherAddress: address(this),
...
contract IAlphaLeakConstants {
    address internal constant TOKEN_WETH = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6;
    address internal constant TOKEN_USDC = 0x5E48C277b2965Df92fd2B172bf839914Dfa092f5;
    address internal constant TOKEN_DAI  = 0xf2edF1c091f683E3fb452497d9a98A49cBA84666;
...
contract ApeBotTest is DyDxFlashLoanHelper, IAlphaLeakConstants {
    ...
    function ape(uint256 actionFlags, uint256[] memory data) public payable {
        ...
        emit Log(IERC20Token(TOKEN_WETH).balanceOf(address(this)));
    ...
    function wfjizxua(
        ...
        if ((actionFlags & FLAG_EXIT_WETH) > 0) {
            // Exit weth from WETH contract to get back ETH
            uint wethbalance = IERC20Token(TOKEN_WETH).balanceOf(address(this));
            if (wethbalance > 1) WETH9(TOKEN_WETH).withdraw(wethbalance - 1);
        }
