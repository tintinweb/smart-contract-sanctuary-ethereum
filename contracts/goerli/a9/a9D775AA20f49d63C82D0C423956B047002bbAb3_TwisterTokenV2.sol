...
import "./TwisterTokenV1.sol";

/// @custom:security-contact [email protected]
contract TwisterTokenV2 is TwisterTokenV1 {
   ...
   function initializeV2() reinitializer(2) public {
    ...
    function mint(address to, uint256 amount) public override onlyRole(MINTER_ROLE) {
        require((TOTAL_SUPPLY + amount) <= MAX_SUPPLY, "You can't mint more than the maximum supply");
        _mint(to, amount);
...
/// @custom:security-contact [email protected]
contract TwisterTokenV1 is Initializable, ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
