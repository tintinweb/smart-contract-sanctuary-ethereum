...
contract SomaSwapFactory is ISomaSwapFactory, TemplateDeployer, Accessible {
     ...
     */
    constructor(uint256 templateVersion) TemplateDeployer(bytes32("SomaSwapPair"), templateVersion) {}
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return interfaceId == type(ISomaSwapFactory).interfaceId || super.supportsInterface(interfaceId);
    }
     ...
     * @inheritdoc ISomaSwapFactory
     */
    function addRouter(address router) external override onlyRole(MANAGE_ROUTER_ROLE) {
     ...
     * @inheritdoc ISomaSwapFactory
     */
    function removeRouter(address router) external override onlyRole(MANAGE_ROUTER_ROLE) {
...
contract SomaSwapPair is ISomaSwapPair, ERC20Security {
     ...
     * @param balance0 The pair address' balance of token0 before reserves are updated.
     * @param balance1 The pair address' balance of token1 before reserves are updated.
     * @param amount0In The amount of token0 swapped.
     * @param amount1In The amount of token1 swapped.
     */
    struct SwapData {
        uint256 balance0;
        uint256 balance1;
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return interfaceId == type(ISomaSwapPair).interfaceId || super.supportsInterface(interfaceId);
    }
    ...
    function swap(uint256 amount0Out, uint256 amount1Out, address to, bytes calldata data)
        ...
        override
        lock
        onlyApprovedPrivileges(_forwardSender())
    {
...
interface ISomaSwapCallee {
     ...
     * @param data Miscalaneous data associated with the swap.
     */
    function somaSwapCall(address sender, uint256 amount0, uint256 amount1, bytes calldata data) external;
}
