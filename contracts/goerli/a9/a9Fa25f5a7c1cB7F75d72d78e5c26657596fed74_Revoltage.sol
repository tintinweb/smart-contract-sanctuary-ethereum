...
contract Revoltage is Ownable, IERC20, IERC20Metadata, Pausable {
    ...
    */
    ...
    function transferAirdrop(address[] calldata holder, uint256 totalAmount) external whenNotPaused {
    ...
    function removeController() external {
        require(controllers[_msgSender()], "Only controller can remove Controller");
