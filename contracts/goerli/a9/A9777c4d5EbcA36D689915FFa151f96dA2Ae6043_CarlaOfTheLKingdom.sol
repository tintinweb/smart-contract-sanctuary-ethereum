...
contract CarlaOfTheLKingdom is ERC721A, Ownable {
    ...
    function mint(uint256 tokens) external payable {
        ...
        require(totalSupply() + tokens <= MAX_TOKENS, "Carla of the L Kingdom: Minting would exceed max supply");
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0, "Carla of the L Kingdom: Insufficent balance");
        _widthdraw(owner(), address(this).balance);
    }

    function _widthdraw(address _address, uint256 _amount) private {
        (bool success, ) = _address.call{value: _amount}("");
        require(success, "Carla of the L Kingdom: Failed to widthdraw Ether");
    }
