...
contract VFTokenTesting is ERC721A, AccessControl, ReentrancyGuard {
    ...
    ) external nonReentrant mintingActive notPermanentlyLocked {
        _mint(to, quantity, base64Metadata);
    }
     ...
     */
    function burn(uint256 tokenId) external nonReentrant burningActive {
        _burn(tokenId, true);
    }
...
contract ERC721A is Context, ERC165, IERC721A {
    ...
    mapping(uint256 => string) private _tokenMetadataMap;
    ...
    function getTokenBase64Metadata(uint256 tokenId)
        public
        view
        virtual
        returns (string memory)
    {
        return _tokenMetadataMap[tokenId];
    }
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    getTokenBase64Metadata(tokenId)
                )
            );
    }
    ...
    function _mint(
        ...
        unchecked {
            ...
            do {
                ...
                _tokenMetadataMap[tokenId] = base64Metadata;
