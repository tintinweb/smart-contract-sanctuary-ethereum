...
contract MarketplaceV5 is Initializable,ReentrancyGuardUpgradeable {
    ...
    function offerForNotListedToken(uint256 collectionId, uint256 tokenId, address tokenContract)payable public  {
        ...
        emit OfferForNotListed(OfferStatus.Active, _offerLastIndex,tokenId,collectionId,msg.value);
   ...
   function acceptOfferForNotListedToken(uint256 offerId, address tokenContract) public  {
        ...
        emit OfferForNotListed(OfferStatus.Accepted, offer.offerId, offer.tokenId, offer.collectionId, offer.offerPrice);
   }
     ...
     function denyOfferForNotListedToken(uint256 offerId) public  {
        ...
        emit OfferForNotListed(OfferStatus.Denied, offer.offerId, offer.tokenId, offer.collectionId, offer.offerPrice);
   }
