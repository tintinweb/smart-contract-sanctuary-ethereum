    ...
    TakrutSale
{
    ...
    */
    ...
    function newUpdate() external view returns (string memory) {
    ...
    ERC721AOperatorFilterUpgradeable
{
    ...
    function awakenNewUpdate() external view returns (string memory) {
        console.log("awakenNewUpdate->ssss");
        return "awakenNewUpdate__";
    }
}
