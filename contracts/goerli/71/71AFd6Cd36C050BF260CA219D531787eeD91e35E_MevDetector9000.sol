...
contract MevDetector9000 {
    error YoureAmev();
    event Kock(string);
    constructor() {}

    function MevCheck9000(address isItAmev) public  pure  returns(bool) {
        string memory fromAddress = Strings.toHexString(uint160(isItAmev), 20);
