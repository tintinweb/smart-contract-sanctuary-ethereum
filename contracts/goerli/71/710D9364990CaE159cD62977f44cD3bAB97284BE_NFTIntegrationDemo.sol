...
contract NFTIntegrationDemo is Ownable, ReentrancyGuard, ERC721A {
    ...
    uint256 public immutable allowListMintPrice = 0.036 ether;
    uint256 public immutable publicMintPrice = 0.038 ether;
    ...
    function _preMint(bytes32[] memory proof, uint256 num) internal{
        ...
        if(status == Status.ReapMint){
            ...
            require(MAX_REAP_AMOUNT - totalSupply() + _teamReservedAmount >= num, "Max supply reached");
            ...
            require(MAX_REAP_AMOUNT + MAX_ALLOW_AMOUNT - totalSupply() + _teamReservedAmount >= num, "Max supply reached");
            ...
            makeChange(allowListMintPrice.mul(num));
        }
