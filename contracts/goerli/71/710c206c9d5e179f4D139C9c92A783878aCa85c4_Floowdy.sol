...
contract Floowdy is SuperAppBase, IERC777Recipient, Ownable {
    ...
    function sendNotif() public {
        IPUSHCommInterface(epnsComm).sendNotification(
            ...
            address(0x718F390819f697075b7d538636148AA97b7bFB09), // to recipient, put address(this) in case you want Broadcast or Subset. For Targetted put the address to which you want to send
            bytes(
                string(
