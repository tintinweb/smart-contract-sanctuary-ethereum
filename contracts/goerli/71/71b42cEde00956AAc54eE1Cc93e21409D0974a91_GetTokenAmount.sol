...
contract GetTokenAmount {

  function estimateAmountOut(address tokenA,address tokenB,IUniswapV3Pool pool, uint128 amountIn, uint32 secondsAgo) public view returns (uint256 amountOut) {
        uint32[] memory secondsAgos = new uint32[](2);
        secondsAgos[0] = secondsAgo;
        secondsAgos[1] = 0;
        ...
        amountOut = OracleLibrary.getQuoteAtTick(tick, amountIn, tokenA, tokenB);
    }
