...
import "./EclipseMintGatePublic.sol";
...
contract EclipseMinter is EclipseMinterBase {
        ...
        onlyAdmin
    {
        ...
        IEclipseMintGate(Eclipse(eclipse).gateTypes(gateType))
            .addGateForCollection(
                collection,
                address(this),
                index,
        ...
        override
    {
        ...
        address gate = Eclipse(eclipse).gateTypes(
            collections[collection][index].gateType
        );
    ...
    function getAllowedMintsForUser(
        ...
        address gateAddress = Eclipse(eclipse).gateTypes(
            collections[collection][index].gateType
        );
        IEclipseMintGate gate = IEclipseMintGate(gateAddress);
