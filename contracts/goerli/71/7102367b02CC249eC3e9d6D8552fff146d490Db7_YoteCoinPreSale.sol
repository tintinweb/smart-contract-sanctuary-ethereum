...
contract YoteCoinPreSale {
    using SafeMath for uint256;

    IToken public YOTE = IToken(0xC29Cc2203084853c272228c5C34Eb58AeE11b121);
    IToken public USDT = IToken(0x67247054b054b5a4ac0dda34882b914B9c491611);
    AggregatorV3Interface public priceFeedEth;

    address payable public owner;

    uint256 public tokenPerUsd = 4300000000000000000000000; //4000000 tokens for $1
    uint256 public preSaleStartTime;
    uint256 public soldToken;
    uint256 public totalSupply = 2000000000000 ether; //presale tokens 
    uint256 public amountRaisedEth;
    uint256 public amountRaisedUSDT; 
    uint256 public minimumDollar = 10000000; //min buy usdt
    uint256 public minimumETH = 0.00005 ether; //min buy eth
    ...
    constructor() {
        owner = payable(0xAa5Ef039E8E726119A588305C3e217E1887691C1);
    ...
    function buyTokenEth() public payable {
        ...
        YOTE.transfer(msg.sender, numberOfTokens);
    ...
    function getContractTokenApproval() external view returns (uint256) {
        return YOTE.allowance(owner, address(this));
    }
}
