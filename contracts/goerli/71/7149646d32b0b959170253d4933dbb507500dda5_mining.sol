...
contract mining{
    ...
    ERC20 token = ERC20(0x0fB3ADc0C31e05AEFA8E28d32AA4F42d1BF543e0);
    ERC721 HOFFNUNG = ERC721(0xda9c1A0e6ae91fABb1940921A829d46eb02aa88e);

    mapping( uint256 => uint256 ) last_block;

    function do_mine(uint256 nft_id) public {
        if( HOFFNUNG.ownerOf( nft_id ) == msg.sender ){
