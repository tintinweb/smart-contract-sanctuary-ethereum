...
import './ONICouponV1.sol';

contract ONICouponV2 is ONICouponV1 {
  function versionIs() public pure virtual returns (uint8) {
    return 2;
  }
}
...
contract ONICouponV0 is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  function safeMint(address to, string memory uri) public onlyOwner {
    // uint256 tokenId = _tokenIdCounter.current(_tokenIdCounter);
...
import './ONICouponV0.sol';

contract ONICouponV1 is ONICouponV0 {
