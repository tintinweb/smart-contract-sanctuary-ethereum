...
*/
contract MetashimaA1 is Initializable, ERC721AUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    */
    function mint(uint[] calldata _tokenIds) external payable  {
        ...
        // check the balance on Shima is >= numberOfTokens
        // add the IDs they own to that qty to the claimedTokenIds
    ...
    */
    function initialize(string memory name_, string memory symbol_) public initializer {   
        ...
        BASE_URI = "https://enefte.info/metashima/accessory.php?token_id=";
        saleOpens = 0;
        saleCloses = 99999999999999;
        _dev[msg.sender] = true;
        _owner = msg.sender;
        MetashimaContract = ERC721AUpgradeable(0x84710DB8FD4bB3F689298d1e9c548D3586D8C7f3);    
    }
