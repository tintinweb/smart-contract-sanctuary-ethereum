...
contract Auction {
    ...
    function getListAuctionInformationById(uint256 auctionId)
        external
        view
        returns (
            // uint256,
    ...
    {
        return (
            // s_AuctionInformations[auctionId].startRegistrationTime,
            // s_AuctionInformations[auctionId].endRegistrationTime,
            // s_AuctionInformations[auctionId].startAuctionTime,
            // s_AuctionInformations[auctionId].endAuctionTime,
            // s_AuctionInformations[auctionId].duePaymentTime,
            // s_AuctionInformations[auctionId].registrationFee,
            s_AuctionInformations[auctionId].depositAmount,
            s_AuctionInformations[auctionId].startBid,
            s_AuctionInformations[auctionId].priceStep
        );
    }
