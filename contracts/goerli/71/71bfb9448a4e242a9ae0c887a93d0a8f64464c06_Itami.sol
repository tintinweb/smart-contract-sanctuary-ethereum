...
// MERKEL TREE STUFF
  ...
  constructor() ERC721A("ITAMI", "ITM") {
    _startTokenId();
    setHiddenMetadataUri("https://www.itami.gg/nft/hiddenMeta.json");
...
// IN THIS ONE WE CHECK AGAINST THE REGULAR WL MERKLE AND USE THE whitelistCost
...
// IN THIS ONE WE CHECK AGAINST THE DISCOUNT MERKLE AND USE THE discountedCost
