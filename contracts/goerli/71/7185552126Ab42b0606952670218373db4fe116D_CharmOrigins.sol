 ...
 * @notice This contract handles minting CharmOrigins tokens.
 */
    ...
    RevokableOperatorFilterer
{
    ...
    string public baseTokenURI =
        "https://charmorigins.mypinata.cloud/ipfs/QmfHi8fVowtNiheFxrjaLzzsthtL5rFcBDUcYv7C96P5Di/";
    uint256 private currentLoanIndex = 0;
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 639;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 9000;
