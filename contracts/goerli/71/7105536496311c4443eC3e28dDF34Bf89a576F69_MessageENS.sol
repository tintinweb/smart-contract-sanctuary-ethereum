...
contract MessageENS {
    ...
    event LogClaimL2Object(string name,uint256 l2user_address, uint256 object_contract_address,uint256 tokenid);
    ...
    */
    ...
    function claimL2Object(
        ...
        emit LogClaimL2Object(name,l2UserAddress,l2ObjectAddress,tokenid);
        ...
        payload[2] = l2ObjectAddress;
        payload[3] = token_id_low;
        payload[4] = token_id_high;
