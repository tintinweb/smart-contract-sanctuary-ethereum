...
contract DuskBreakers is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    */
    ...
    uint256 public constant breakerPrice = 0.0001 ether;
    string public baseTokenURI;
    bool private PAUSE = false;
    bool private fcfsMint = true;
    
    // Ensure Fairness
    string public BREAKER_PROVENANCE = "4e02fe1716bbf018894175d2127104278882ce817209a6d43814e7954aa5fb29";
    ...
    */
    ...
    function mintBreaker(uint256 numberOfTokens) public payable saleIsOpen nonReentrant() {
        ...
        require(hasSupply(numberOfTokens), "Exceeds max total Breakers");
    ...
    function canMint(uint256 numberOfTokens) public view returns (bool) {    
        if (numberOfTokens > 10) return false;
