...
contract EclipseMinterAirdrop is EclipseMinterBase {
        ...
        onlyAdmin
    {
        ...
        emit PricingSet(
            collection,
            CollectionMintParams(params.artist, 0, 0, maxSupply, address(0), 0),
            0
        );
    }
     ...
     */
    function _checkState(address collection, uint256 amount)
        internal
        view
        override
    {
     ...
     */
    function getPrice(address, uint256) public pure override returns (uint256) {
        return 0;
    }
     ...
     */
    function airdrop(address collection, address[] memory users)
        external
        payable
    {
...
abstract contract EclipseMinterBase is EclipseAccess, IEclipseMinter {
     ...
     */
    function _checkState(address collection, uint256 index)
        internal
        view
        virtual
    {
...
contract EclipseCollectionFactory is EclipseAccess {
     ...
     */
    function _getNextCollectionId(uint8 collectionType)
        internal
        returns (uint256)
    {
