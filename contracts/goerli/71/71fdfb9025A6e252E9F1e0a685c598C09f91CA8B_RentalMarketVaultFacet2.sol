...
contract ERC4908 {
    ...
    /// @param tokenId The NFT to get the user address for
    /// @return The user address for this NFT
    function usearOf(address collection, uint256 tokenId) public view virtual returns (address) {
...
import "./libraries/ERC4909.sol";
import "./storage/VaultStorage.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";

contract RentalMarketVaultFacet2 is ERC4908 {
