...
contract ColoredBook is ERC4973 {
    ...
    uint256 private maxSupply = 90;
    uint256 private maxMintAmount = 90;
    uint256 private _nftEtherValue = 59000000000000000;

    bool private paused = false;
    
    address _contractOwner;
    address walletForSplit = 0x15D20FAf3aBD46154E913c7925e307047381B5A5;
    address public owner;
    uint256 public count = 0;

    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);

    constructor() ERC4973("Colored Books", "TRCB", "TRCB") {
        owner = msg.sender;
        setBaseURI("https://ipfs.io/ipfs/QmUBuvzp1nasg8AbPJWzRsopR7SX2LRbovA4HcVLhBDCWk/");
        _contractUri = "https://ipfs.io/ipfs/Qmb3b7p4CUFcPkNiEcVTLd4Hw84Z7RQ1bhx2U3s6Bqgte3";
    ...
    function mint(
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _mint(_contractOwner, endUser, Id,  string(abi.encodePacked(_baseURI(), Id.toString(), baseExtension)));
    ...
    function split(uint256 _mintAmount) public payable {
        ...
        uint256 amountM = msg.value * 20 / 100;

        require(msg.value >= ((_nftEtherValueTemp - amountM) * _mintAmount), "Valor da mintagem diferente do valor definido no contrato");
        payable(walletForSplit).transfer(msg.value);
    }
