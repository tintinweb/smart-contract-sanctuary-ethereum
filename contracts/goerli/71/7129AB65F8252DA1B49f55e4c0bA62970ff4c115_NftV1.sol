    ...
    ERC721URIStorage
{
        ...
        onlyTicketContract
    {
        ...
        _safeMint(ticketOwner, newId);
        setStats(1005, newId, conditionId);
    }

    function balanceOfWallet(address account)
        public
        view
        ...
        external
    {
       require(totalSupply() < maxSupply, "Max supply reached");
        uint256 newId = totalSupply() + 1;
        _safeMint(ticketOwner, newId);
        setStatsWithoutTicket(1005, newId, conditionId);
    }
    ...
    function batchTransferFrom(address accouunt, uint256[] memory tokenIds, address to) public {
        for (uint i=0; i< tokenIds.length; i++) {
        safeTransferFrom(accouunt, to, tokenIds[i]);
        }
    }
