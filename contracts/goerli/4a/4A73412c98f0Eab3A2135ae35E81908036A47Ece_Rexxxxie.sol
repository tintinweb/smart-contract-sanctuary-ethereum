...
contract Rexxxxie is ERC721Enumerable, Ownable {
    ...
    function preSaleMint (uint256 amount, bytes32[] calldata merkleproof) public payable
    {
        require(preSaleIsActive && block.timestamp < presaleEnded, "Presale is not running");
        require(isValid(merkleproof, keccak256(abi.encodePacked(msg.sender))), "Not whitelisted");
