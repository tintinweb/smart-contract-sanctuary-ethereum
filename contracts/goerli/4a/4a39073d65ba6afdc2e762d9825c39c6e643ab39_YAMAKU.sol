...
contract YAMAKU is ERC20, Ownable {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _buyBuybackFee) external onlyOwner {
        sellMarketingFee = _marketingFee;
        sellLiquidityFee = _liquidityFee;
        sellDevFee = _buyBuybackFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
    ...
    function swapBack() private {
        ...
        (success,) = address(buyBackWallet).call{value: ethForDev}("");
