 ...
 * @notice This contract handles minting Burn to mint test tokens.
 */
contract BurnToMintTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x84695C3b6e40e72b5156995Fa57A4DF690Abd6fA;
    ...
    string public baseTokenURI =
        "ipfs://bafybeiaimytrqurtjkualduufhxxoy5nnl2emv4mgaqvj4ibrigpdhbh5q/";
    ...
    uint256 public presaleMintsAllowedPerAddress = 1500;
    uint256 public presaleMintsAllowedPerTransaction = 1500;
    uint256 public presalePrice = 0.01 ether;
    uint256 public publicMintsAllowedPerAddress = 1500;
    ...
    constructor()
        ERC721A("Burn to mint test", "BURN")
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        burnTokens.push(
            BurnToken(0xA2cCB0B501a14f319C76b5894C53B66117E71ea0, 1, 2, 0)
        );
        burnTokens.push(
            BurnToken(0xc0cc543193e702760C9cA281c1EcC8cFD5e76A0b, 2, 2, 100)
        );
    }
