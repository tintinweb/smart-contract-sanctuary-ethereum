...
contract FirstPhase is IFirstPhase, Operation, DateTime {
    ...
    function getListFrom(address addr) public view onlyOwner returns (Release.Data memory) {
        return _release[addr];
    }

    function getList() public view returns (Release.Data memory) {
