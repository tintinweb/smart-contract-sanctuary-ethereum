...
contract CryptoAvatarsExchange is ICryptoAvatarsExchange, ReentrancyGuard, Ownable {
    ...
    function matchAskWithTakerBidUsingETHAndWETH(
        ...
        // Emit event
        eventEmitter.emitEvent("MarketSell", abi.encode(
            makerAsk,
            takerBid));
        ...
        nonReentrant
    {
        ...
        // Execution part 1/2
        _transferFeesAndFunds(makerAsk,takerBid,_msgSender() , makerAsk.signer);
        ...
        nonReentrant
    {
        ...
        // Execution part 2/2
        _transferFeesAndFunds(makerBid,takerAsk, makerBid.signer , _msgSender());

        // Emit event
        eventEmitter.emitEvent("MarketSell", abi.encode(makerBid,takerAsk));
    }
