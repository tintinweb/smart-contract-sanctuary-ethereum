...
contract Grinch is Context, Ownable, IERC20 {
    ...
    string private _name = "TEST7";
    string private _symbol = "T7";
    ...
    */
    ...
    if (sell) {
        _approve(address(this), address(router), treasuryFeeInTokens.add(charityFeeInTokens).add(buybackFeeInTokens));
    }
