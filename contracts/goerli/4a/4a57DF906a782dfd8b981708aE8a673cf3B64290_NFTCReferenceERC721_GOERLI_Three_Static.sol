...
import './NFTCReferenceERC721_GOERLI_Three_StaticBase.sol';
import './NFTCReferenceERC721_GOERLI_Three_StaticSplitsAndRoyalties.sol';

/**
 * @title NFTCReferenceERC721_GOERLI_Three_Static
 */
contract NFTCReferenceERC721_GOERLI_Three_Static is NFTCReferenceERC721_GOERLI_Three_StaticSplitsAndRoyalties, NFTCReferenceERC721_GOERLI_Three_StaticBase {
    constructor()
        NFTCReferenceERC721_GOERLI_Three_StaticBase(
            'NFTCReferenceERC721_GOERLI_Three_Static',
            'NFTCR721_G_3_S',
            'https://nftculture.mypinata.cloud/ipfs/Qma8JyxudEvAjCTgA5jaWDAuJHooqHhxAu7qG8nuS53UD8/', // TODO: NFTCReference721-rinkeby-Metadata_V1
            addresses,
            splits,
            0.069 ether,
            0.069 ether,
...
import '@nftculture/nftc-contract-library/contracts/token/phased/PhaseTwoIsTiered.sol';
...
/**
 * @title NFTCReferenceERC721_GOERLI_Three_StaticBase
 * @author @NFTCulture
 * @dev ERC721a Implementation with @NFTCulture standardized components.
 *
 * Public Mint is Phase Three.
 */
abstract contract NFTCReferenceERC721_GOERLI_Three_StaticBase is
    ERC721ABurnable,
    ERC721AQueryable,
    Ownable,
    ...
    PhaseTwoIsTiered
{
    ...
    uint256 private constant PHASE_ONE_SUPPLY_CAP = 10000;

    uint256 private constant PHASE_TWO_BATCH_SIZE = 10;
    uint256 private constant PHASE_TWO_PURCHASE_LIMIT = 1000;
    uint256 private constant PHASE_TWO_SUPPLY_CAP = 10000;
    ...
    function _getPackedPurchasesAs64(address wallet)
        ...
        view
        virtual
        override(PhaseOneIsIndexed, PhaseTwoIsTiered)
        returns (uint64)
    {
     ...
     * @param count the number of tokens to mint.
     */
    function publicMintTokens(uint256 count) external payable nonReentrant onlyUsers isPublicMinting {
    ...
    function phaseOneMintTokens(bytes32[] calldata proof, uint256 count) external payable nonReentrant isPhaseOne {
        ...
        _proofMintTokens_PhaseOne(msg.sender, proof, newBalance, count);
    }
...
contract NFTCReferenceERC721_GOERLI_Three_StaticSplitsAndRoyalties is ERC2981 {
    address[] internal addresses = [
        0x05Ed4cf991c4ed7606930AB54dDbF27836C1f590
    ];
...
abstract contract PhaseTwoIsTiered is MerkleLeaves, AuxHelper32 {
    ...
    function checkProof_PhaseTwo(bytes32[] calldata proof, address wallet)
        external
        view
        returns (bool)
    {
