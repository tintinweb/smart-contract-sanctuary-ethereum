...
contract BinaryOptions {
    ...
    //GELATO AUTOMATE ADDRESSES
    //GOERLI: 0xc1C6805B857Bef1f412519C4A842522431aFed39
    //MAINNET: 0xB3f5503f93d5Ef84b06993a1975B9D21B962892F
    CounterTimeTaskCreatorWT public TASK_CREATOR = new CounterTimeTaskCreatorWT(payable(0xc1C6805B857Bef1f412519C4A842522431aFed39), address(this));
    ...
    address public constant owner = 0xaec7e05a7d508C448C207D333c90B336Fa31b57E;
    mapping (address => bet[]) public Accountbets;

    receive() external payable{}

    function getCount() public view returns (uint) {
      return TASK_CREATOR.count();
    }

    function getLast() public view returns (uint) {
      return TASK_CREATOR.lastExecuted();
    }
