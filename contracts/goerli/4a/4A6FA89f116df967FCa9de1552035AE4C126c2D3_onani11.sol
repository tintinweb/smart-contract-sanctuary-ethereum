...
contract onani11 is ERC721, Ownable {
    ...
    address private constant claim_add = 0x2D0B21cF65DAB94aF0Afa8a4de4F1837E6792652;
    ...
    function mint(uint256[] calldata _tokenIDs) external {
        ...
        require(numTokensMinted < MAX_TOKENS, "over");
        ...
        numTokensMinted = numTokensMinted + numberOfTokens;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        // need to get number of tokens minted together with this token and total number of degents tokens in the wallet
        string memory baseSvg = string(abi.encodePacked('<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" width="800" height="800" style="background-color:black" viewBox="0 0 800 800">'));
