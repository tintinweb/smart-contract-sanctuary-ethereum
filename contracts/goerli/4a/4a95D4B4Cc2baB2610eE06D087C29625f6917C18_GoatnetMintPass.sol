    ...
    AccessControlUpgradeable
{
    ...
    address payable private autoTransferReceiverAddress;
    ...
    function initialize(
        ...
        __ERC721_init('Goat Mint pass', 'GOAT');
        __Ownable_init();
    ...
    function _verifyMint(
        ...
        require(amount >= publicSalePrice * numberOfTokens, StringsUpgradeable.toString(publicSalePrice * numberOfTokens));
    }
