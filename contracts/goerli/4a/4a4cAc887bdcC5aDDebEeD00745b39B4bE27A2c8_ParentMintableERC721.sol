...
contract ParentMintableERC721 is
    ERC721,
    AccessControlMixin,
    ...
    ContextMixin
{
    ...
    constructor(string memory name_, string memory symbol_, address mintableAssetProxy)
        public
        ERC721(name_, symbol_)
    {
        _setupContractId("ParentMintableERC721");
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(PREDICATE_ROLE, mintableAssetProxy);
        _setupRole(0xae3a445685f2116a2dbab58a772ea47d873d14ceeec07986473afab28e4b8f7a, mintableAssetProxy);
        grantRole(0xae3a445685f2116a2dbab58a772ea47d873d14ceeec07986473afab28e4b8f7a, mintableAssetProxy);
