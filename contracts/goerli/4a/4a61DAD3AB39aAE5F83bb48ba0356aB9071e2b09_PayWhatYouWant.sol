...
contract PayWhatYouWant is ERC721, Ownable {

    string baseURI;
    uint256 public maxSupply;
    uint256 public lastId;
    uint256 public maxPrice = 1.0 ether;
    uint256 public maxLockDuration = 10 days;
    ...
    mapping(uint256 => uint256) public isUnlocked;


    constructor() ERC721("PayWhatYouWant", "PWYW"){
        setBaseURI("");
    }
    ...
    function getPrice(uint256 _lockDuration) public view returns (uint256 price) {
        //require(maxPrice < 0, "maxPrice not Set");
