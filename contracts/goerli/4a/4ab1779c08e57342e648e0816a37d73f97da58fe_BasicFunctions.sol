...
contract BasicFunctions {
   ...
   // function ( string _variablel , int _variable2 ) public view / pure returns ( bool ) { }
    ...
    function findCoinIndex ( string [ ] memory _myCoins , string memory _find , uint _startFrom ) public pure returns ( uint ) {
     ...
     // update a mapping
     function addCoin ( string memory _name , string memory symbol , uint _supply ) external {
       myCoins [ msg.sender ] = Coin ( _name , symbol , _supply ) ;
       }
