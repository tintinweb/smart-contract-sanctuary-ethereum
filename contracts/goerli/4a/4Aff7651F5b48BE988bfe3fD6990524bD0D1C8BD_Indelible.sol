...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    ContractData public contractData = ContractData(unicode"OnChainChimps", unicode"5,555 Chimps, One Chimp equals one vote on community proposals, Community members can make their own proposals, The main idea behind the OnChainChimps Voting portal is to create autonomous, decentralized Community of like-minded people where every member has a vote on how the Chimps progress and Navigate Web3.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/fcd9c46f-078e-47a4-a100-a801dec40d66", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/fcd9c46f-078e-47a4-a100-a801dec40d66", "", 500, "0xcB954E171c1BFdADC4aF7AdB3f4B20Bb937b6158");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"OnChainChimps", unicode"OCC") {
        tiers[0] = [1,1,1,1,1,1,5549];
        tiers[1] = [0,14,16,17,21,24,27,53,57,65,97,101,110,112,120,120,120,123,125,125,145,149,150,155,161,165,167,170,170,179,207,223,267,1800];
        tiers[2] = [0,1,1,1,4,4,6,7,7,8,8,10,13,16,16,18,20,21,29,32,32,39,44,45,54,57,58,59,60,64,68,68,72,77,77,77,77,77,84,86,89,95,97,100,108,116,121,122,123,126,127,127,137,137,144,147,166,167,175,176,258,269,931];
        tiers[3] = [0,9,10,20,20,36,38,41,41,46,51,53,76,84,94,95,107,123,132,142,143,146,154,159,183,194,204,222,228,247,247,288,307,309,367,405,534];
        tiers[4] = [0,5,8,8,9,11,12,26,28,29,30,32,32,36,43,45,47,47,50,59,75,76,82,82,100,119,124,124,127,129,133,140,150,150,153,154,160,178,182,200,220,240,1900];
        tiers[5] = [0,9,55,65,65,65,70,70,70,70,75,76,85,86,100,101,110,120,150,201,221,225,250,310,361,410,460,825,850];
        tiers[6] = [0,33,49,124,137,242,280,297,337,384,408,416,1240,1608];
