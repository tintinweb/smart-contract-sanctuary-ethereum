...
// File: contracts\Shrimp.sol

pragma solidity >=0.7.0 <0.9.0;
contract PixelPron is ERC721, Ownable, PaymentSplitter {
  using Strings for uint256;
  ...
  constructor(address[] memory _payees, uint256[] memory _shares) PaymentSplitter(_payees, _shares) payable ERC721("Pixel Pron", "SHRIMP")  {
