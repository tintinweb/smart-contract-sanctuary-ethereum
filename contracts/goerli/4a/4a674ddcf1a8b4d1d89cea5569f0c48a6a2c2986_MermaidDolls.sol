...
// Mermaid Dolls NFT by James Osbourne
...
//        .BG5G#&@@@@@@@@@@@@@@@@@@@@@@@G?:                   
//               :J#@@@@@@@@@@@@@@@@@@@@7                     
//                  .~YG#&&&&[email protected]@@@@@@@@J                    
//                            [email protected]&&@@@@@@[email protected]?                   
//                           [email protected]@@@@@@@[email protected]                  
//                       ^G#&Y [email protected]@@@@@@@& [email protected]^                
//            .~7?7^.    .^^:  #@@@@@@@@@. 7##7               
//          ~G&@@@@@@#7        [email protected]@@@@@@@@.                    
//          :.  .!5&@@@&#G5Y?!::@@@@@@@@&                     
//                [email protected]@@&^J&@@@@@&@@@@@@@@~                     
...
// File: OpenSeaGasFreeListing.sol
 ...
 */
abstract contract ERC721AQueryable is ERC721APreApproval, IERC721AQueryable {
    /**
     * @dev Returns the `TokenOwnership` struct at `tokenId` without reverting.
     *
     * If the `tokenId` is out of bounds:
...
// File: MermaidDolls.sol

pragma solidity >=0.8.9 <0.9.0;
contract MermaidDolls is ERC721AQueryable, Ownable, ReentrancyGuard, ERC2981 {
    ...
    uint256 public mintingHash;
	
	bool public paused = true;
	bool public whitelistMintEnabled = false;
    bool public keywordMintEnabled = false;
	...
	constructor(string memory _tokenName, 
				...
				uint96 _royaltyNumerator) ERC721A(_tokenName, _tokenSymbol) {
		setCost(_cost);
		...
		ERC2981._setDefaultRoyalty(_royaltyReceiver, _royaltyNumerator);
	}
	
	modifier mintCompliance(uint256 _mintAmount) {
		require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, 'Invalid mint amount!');
		require(totalSupply() + _mintAmount <= maxSupply, 'Max supply exceeded!');
        require(totalSupply() + _mintAmount <= maxToMint, 'Max to mint exceeded!');
		_;
	}
    ...
    function keywordMint(uint256 _mintAmount, string memory _keyword) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
		require(keywordMintEnabled, 'The keyword sale is not enabled!');
		require(mintingHash == uint256(keccak256(abi.encodePacked(_keyword))),'Invalid keyword!');
    ...
    function setMaxToMint(uint256 _maxToMint) public onlyOwner {
    ...
    function setMintingHash(uint256 _mintingHash) public onlyOwner {
		mintingHash = _mintingHash;
	}
    ...
    function setKeywordMintEnabled(bool _state) public onlyOwner {
		keywordMintEnabled = _state;
	}
	...
	function supportsInterface(bytes4 interfaceId) public view override(ERC721A, ERC2981, IERC165) returns (bool)
	{
