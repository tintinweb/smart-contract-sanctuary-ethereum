...
contract SomidaxNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function getRoyaltyFee() external pure returns (uint256) {
        return 1000;
    }

    function getRoyaltyRecipient() external pure returns (address) {
        return 0x558A03Ea3052620c34D12fA3A1500EbA7D135bE9;
    }
}
