...
/**
 * @title CointrollerCore
 * @dev Storage for the cointroller is at this address, while execution is delegated to the `cointrollerImplementation`.
 * RTokens should reference this contract as their cointroller.
 */
contract Unitroller is UnitrollerAdminStorage, CointrollerErrorReporter {

    /**
      * @notice Emitted when pendingCointrollerImplementation is changed
      */
    event NewPendingImplementation(address oldPendingImplementation, address newPendingImplementation);

    /**
      * @notice Emitted when pendingCointrollerImplementation is accepted, which means cointroller implementation is updated
      */
    ...
    /**
    * @notice Accepts new implementation of cointroller. msg.sender must be pendingImplementation
...
abstract contract PriceOracle {
    ...
    /**
      ...
      */
    function getUnderlyingPrice(RToken rToken) virtual external view returns (uint);
}
