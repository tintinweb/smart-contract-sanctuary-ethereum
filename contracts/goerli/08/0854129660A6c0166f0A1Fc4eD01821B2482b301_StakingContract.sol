...
contract StakingContract is Ownable, ReentrancyGuard {
    ...
    function stake(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            if (IMecha(mecha).isMinted(tokenIds[i])) {
                IMecha(mecha).transferFrom(
                    address(this),
                    msg.sender,
                    tokenIds[i]
                ...
                IMecha(mecha).mint(msg.sender, tokenIds[i]);
            }
            EnumerableSet.add(
    ...
    function unStake(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            IMecha(mecha).transferFrom(msg.sender, address(this), tokenIds[i]);
