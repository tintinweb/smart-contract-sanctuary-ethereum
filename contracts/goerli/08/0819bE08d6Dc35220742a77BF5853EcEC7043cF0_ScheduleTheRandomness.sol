...
contract ScheduleTheRandomness is
  ...
  Ownable
{
  uint256 intervalComponents = 3000;
  ...
  function getRandomControlType() public returns (uint8 _controlType) {
    latestRandomizingBlock = block.number;
     uint256 _usedFunds = witnet.randomize();
  ...
  function qualityControlCallback() internal{
  ...
  function employeeCallback() internal {
