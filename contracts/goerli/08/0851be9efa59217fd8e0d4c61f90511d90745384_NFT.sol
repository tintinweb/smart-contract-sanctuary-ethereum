...
contract NFT is ERC721A, Ownable {
    ...
    constructor(string memory _baseURI_) ERC721A("Gob", "GOB") {
        baseURI_ = _baseURI_;
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        ...
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(baseURI, _toString(tokenId), ".json")) : notRevealedURI_;
    }
