 ...
 * @notice This contract handles minting Sept 28 test tokens.
 */
contract LaunchpadSept28Test is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xC45D13B7284e49b59FFFd2e832D6EaFd687252a1;
    address public royaltyAddress = 0x214d6f36E2DCC55B72822cf37158a5af9c3E385c;
    // Used to allow transferring soulbound tokens with admin privileges
    address public soulboundAdminAddress =
        0x214d6f36E2DCC55B72822cf37158a5af9c3E385c;
    address[] public payoutAddresses = [
        0x214d6f36E2DCC55B72822cf37158a5af9c3E385c,
        0x713384BB2eFa92c4e75EeA91A1B58BE075bcf7B9
    ];
    ...
    uint256 public publicSaleEndTime = 1979769394;
    uint256 public publicSaleStartTime = 1663743600;
    uint256[] public payoutPercentages = [99, 1];
    // Array of all soulbound token ids
    uint256[] public soulboundTokens;
    uint96 public royaltyFee = 500;

    constructor() ERC721A("Sept 28 test", "KELLLL") {
