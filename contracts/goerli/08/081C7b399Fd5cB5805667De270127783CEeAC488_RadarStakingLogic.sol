...
// TODO: How to implement minimumToStake? Because users can unstake and then stake again. How will the minimum be enforced in that case?
...
contract RadarStakingLogic is iRadarStakingLogic, Ownable, ReentrancyGuard {
    ...
    uint256 public minimumToStake = 5_000 ether; // TODO: Keep?
    ...
    */
    ...
    function calculateReward(address addr) public view returns(uint256) {
        ...
        for (uint256 i = 0; i < allAprs.length; i++) {
            ...
            uint256 compoundingReward;
            for (i=0; i < daysPassed; i++) {
                compoundingReward += accruedReward * 3/100/365; // compound per day
            }
