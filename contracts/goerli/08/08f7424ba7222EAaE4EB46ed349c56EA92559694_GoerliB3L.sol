...
error NotOwner();
error Soulbound();
contract GoerliB3L is ERC721AQueryable, Ownable  {
    ...
    string public sameUriToUseForAllTokens =  "ipfs://cid/";
    ...
    /*///////////////////////////////////////////////////////////////
                                CONSTRUCTOR
    //////////////////////////////////////////////////////////////*/
    constructor(address b3lOg) ERC721A("B3EAST", "HYPR") {
        // paused=true;
        B3LOG = IERC721(b3lOg);
    }
    ...
    function airdropSingleTon(address to, uint amount) external {
        if(block.chainid == 1){
            revert();
        }
