...
contract abc is ERC20, Ownable {
    ...
    uint256 public buyGiveawayFee;
    uint256 public buyBurnFee;

    uint256 public sellTotalFees;
    uint256 public sellOperationsFee;
    uint256 public sellLiquidityFee;
    uint256 public sellGiveawayFee;
    uint256 public sellBurnFee;

    uint256 public tokensForOperations;
    uint256 public tokensForLiquidity;
    uint256 public tokensForGiveaway;
    ...
    constructor() ERC20("abc", "abc") {
        ...
        uint256 totalSupply = 2 * 1e5 * 1e18;
        ...
        buyGiveawayFee = 3;
        buyBurnFee = 0;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyGiveawayFee + buyBurnFee;

        sellOperationsFee = 0;
        sellLiquidityFee = 3;
        sellGiveawayFee = 5;
        sellBurnFee = 0;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellGiveawayFee + sellBurnFee;
        ...
        giveawayAddress = address(newOwner);
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _giveawayFee, uint256 _burnFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _giveawayFee, uint256 _burnFee) external onlyOwner {
        sellOperationsFee = _operationsFee;
        sellLiquidityFee = _liquidityFee;
        sellGiveawayFee = _giveawayFee;
        sellBurnFee = _burnFee;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellGiveawayFee + sellBurnFee;
        require(sellTotalFees <= 8, "Keep fees at 30% or less");
    }
    ...
    function returnToNormalTax() external onlyOwner {
        ...
        buyBurnFee = 0;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyGiveawayFee + buyBurnFee;
        require(buyTotalFees <= 5, "Keep fees at 15% or less");
    }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForOperations + tokensForGiveaway;
        ...
        uint256 ethForGiveaway = ethBalance * tokensForGiveaway / (totalTokensToSwap - (tokensForLiquidity/2));

        ethForLiquidity -= ethForOperations + ethForGiveaway;
    ...
    function setGiveawayAddress(address _giveawayAddress) external onlyOwner {
        require(_giveawayAddress != address(0), "_giveawayAddress address cannot be 0");
