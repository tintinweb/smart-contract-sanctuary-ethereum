...
contract ColoredBookPlus is ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 private maxSupply = 7;
    uint256 private maxMintAmount = 7;
    uint256 private _nftEtherValue = 120000000000000000;
    ...
    ) ERC721A("Colored Books Plus", "TCBP") {
    ...
    function mint(
        ...
        _indicationType = _indicationType;
        _recommendedBy = _recommendedBy;
