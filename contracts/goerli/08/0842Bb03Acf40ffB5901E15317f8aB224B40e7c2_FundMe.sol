...
contract FundMe {
    ...
    function cheaperWithdraw() public payable onlyOwner {
        ...
        s_funders = new address[](0);
        // jesli mamy nawias to  nieuzupełnione pola (przed lub po przecinku) oznaczają zmienna ktora nie jest zachowywana
        (bool success, ) = i_owner.call{value: address(this).balance}("");
        require(success);
    }
...
//     }
    ...
    // dzieki ponizszym funkcjom zmienne, które są private, ustawiamy na public i teraz te nowe nazwy funkcji uzywamy w testach
