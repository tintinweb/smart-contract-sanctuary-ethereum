 ...
 */
contract TurkishGalleryArtistDrop is TurkishGalleryArtistDropSplitsAndRoyalties, TurkishGalleryArtistDropBase {
    constructor()
        TurkishGalleryArtistDropBase(
            'TurkishGalleryArtistDrop',
            'TGAD',
            'https://nftc-media.mypinata.cloud/ipfs/QmX65WzGUvNTnMxysXGNSaFc5pNq8N7K7NMaDoTfuMZxke', // TODO: NFTCulture gateway
            addresses,
            splits,
            0.069 ether,
            0.069 ether,
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(ERC721A_NFTCExpandable, ERC2981) returns (bool) {
    ...
    function _getInitialFlavors() internal pure override returns (TokenFlavor[] memory) {
        ...
        TokenFlavor[] memory initialFlavors = new TokenFlavor[](39);

        initialFlavors[0] = TokenFlavor(100000, 10 ether, 1, 0, 'token1');
        initialFlavors[1] = TokenFlavor(200100, 6 ether, 1, 0, 'token2');
        initialFlavors[2] = TokenFlavor(200101, 6 ether, 1, 0, 'token3');
        initialFlavors[3] = TokenFlavor(200102, 6 ether, 1, 0, 'token4');
        initialFlavors[4] = TokenFlavor(200103, 6 ether, 1, 0, 'token5');
        initialFlavors[5] = TokenFlavor(200104, 6 ether, 1, 0, 'token6');
        initialFlavors[6] = TokenFlavor(200105, 6 ether, 1, 0, 'token7');
        initialFlavors[7] = TokenFlavor(200106, 6 ether, 1, 0, 'token8');
        initialFlavors[8] = TokenFlavor(200107, 6 ether, 1, 0, 'token9');
        initialFlavors[9] = TokenFlavor(200108, 6 ether, 1, 0, 'token10');
        initialFlavors[10] = TokenFlavor(200109, 6 ether, 1, 0, 'token11');
        initialFlavors[11] = TokenFlavor(200200, 3.5 ether, 1, 0, 'token12');
        initialFlavors[12] = TokenFlavor(200201, 3.5 ether, 1, 0, 'token13');
        initialFlavors[13] = TokenFlavor(200202, 3.5 ether, 1, 0, 'token14');
        initialFlavors[14] = TokenFlavor(200203, 3.5 ether, 1, 0, 'token15');
        initialFlavors[15] = TokenFlavor(200204, 3.5 ether, 1, 0, 'token16');
        initialFlavors[16] = TokenFlavor(200205, 3.5 ether, 1, 0, 'token17');
        initialFlavors[17] = TokenFlavor(200206, 3.5 ether, 1, 0, 'token18');
        initialFlavors[18] = TokenFlavor(200207, 3.5 ether, 1, 0, 'token19');
        initialFlavors[19] = TokenFlavor(200208, 3.5 ether, 1, 0, 'token20');
        initialFlavors[20] = TokenFlavor(200209, 3.5 ether, 1, 0, 'token21');
        initialFlavors[21] = TokenFlavor(200300, 2 ether, 1, 0, 'token22');
        initialFlavors[22] = TokenFlavor(200301, 2 ether, 1, 0, 'token23');
        initialFlavors[23] = TokenFlavor(200302, 2 ether, 1, 0, 'token24');
        initialFlavors[24] = TokenFlavor(200303, 2 ether, 1, 0, 'token25');
        initialFlavors[25] = TokenFlavor(200304, 2 ether, 1, 0, 'token26');
        initialFlavors[26] = TokenFlavor(200305, 2 ether, 1, 0, 'token27');
        initialFlavors[27] = TokenFlavor(200306, 2 ether, 1, 0, 'token28');
        initialFlavors[28] = TokenFlavor(200307, 2 ether, 1, 0, 'token29');
        initialFlavors[29] = TokenFlavor(200308, 2 ether, 1, 0, 'token30');
        initialFlavors[30] = TokenFlavor(200309, 2 ether, 1, 0, 'token31');
        initialFlavors[31] = TokenFlavor(300100, 0.5 ether, 50, 0, 'token32');
        initialFlavors[32] = TokenFlavor(300101, 0.5 ether, 50, 0, 'token33');
        initialFlavors[33] = TokenFlavor(300102, 0.5 ether, 50, 0, 'token34');
        initialFlavors[34] = TokenFlavor(300103, 0.5 ether, 50, 0, 'token35');
        initialFlavors[35] = TokenFlavor(300104, 0.5 ether, 50, 0, 'token36');
        initialFlavors[36] = TokenFlavor(400100, 0.2 ether, 20, 0, 'token37');
        initialFlavors[37] = TokenFlavor(400101, 0.2 ether, 20, 0, 'token38');
        initialFlavors[38] = TokenFlavor(500000, 0.06 ether, 0, 0, 'token39');
