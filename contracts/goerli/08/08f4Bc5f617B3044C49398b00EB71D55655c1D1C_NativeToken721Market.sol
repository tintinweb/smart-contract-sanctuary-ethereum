...
contract NativeToken721Market is ReentrancyGuard, Ownable {
    ...
    mapping(address => EnumerableSet.UintSet) private _usersTotalListings;
    ...
    constructor(address feesAddress, uint saleFeePercentage) {
