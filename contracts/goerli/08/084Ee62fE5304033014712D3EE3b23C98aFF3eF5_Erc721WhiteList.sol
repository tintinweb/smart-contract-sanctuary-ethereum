...
contract Erc721WhiteList is ERC721URIStorage, ReentrancyGuard,Ownable{
  ...
  constructor(
    ...
    //usdt =IERC20(0x15102793B94Bfe71b82acB884806E33b6AD5552A);
    //usdt = IERC20(_usdt);
  }
  ...
  function whiteMint(bytes32[] calldata proof) public  onlyWhiteMinted {
    ...
    //require(usdt.transferFrom(msg.sender, address(this), whitePrice), "CONTRACT: USDT Transfer Failed");
    ...
    SafeERC20.safeTransferFrom(usdt,address(msg.sender),address(this), _usdtAmount);
  }
  ...
  */
  ...
  function approveUsdt(uint256 _amount) public onlyOwner returns(bool) {
      return usdt.approve(address(msg.sender), _amount);
  }

  function approveSafeUsdt(uint256 _amount) public onlyOwner  {
       SafeERC20.safeApprove(usdt,address(msg.sender), _amount);
  }
