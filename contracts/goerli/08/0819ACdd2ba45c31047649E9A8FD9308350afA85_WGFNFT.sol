    ...
    ERC721Enumerable
{
    ...
    struct BoxState {
        mapping(uint256 => bool) isOpened;
    }

    mapping(address => BoxState) private nftStates;

    mapping(address => AddressMinted) private _addressMinted;

    uint256 public constant MAX_FREE_MINT = 1000;
    uint256 public constant MAX_TOTAL_MINT = 10001;
    uint256 public constant PRICE = 50 ether; //50U MINT购买价格
    uint256 public constant LIMIT = 1; //付费购买限制
    uint256 public constant FREE_LIMIT = 1; //免费MINT限制
    ...
    address public constant REPURCHASE_ADDRESS =
        0xefBc5cC10573B9c3598743BA421312684c9866C6; // 官方回购者地址
    uint256 public constant REPURCHASE_PRICE = 50 ether; //NFT 回购价

    address public constant MARKET_WALLET =
        0xefBc5cC10573B9c3598743BA421312684c9866C6; //付费MINT转到官方钱包
    ...
    function freeMint(bytes32[] memory _proof) external {
        // console.log("freeMint", _msgSender());
    ...
    function payMint() public {
        require(_mintingEnabled, "Minting is not enabled");
        // console.log("payMint", _addressMinted[_msgSender()].paidMinted, LIMIT);
        require(
    ...
    function tokenURI(
        ...
        if (!nftStates[_msgSender()].isOpened[tokenId]) {
            return "https://nft.wgfsocial.com/token/default.json";
        }
        return super.tokenURI(tokenId);
    }
