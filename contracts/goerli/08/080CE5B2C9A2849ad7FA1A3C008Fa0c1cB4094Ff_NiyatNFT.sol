...
contract NiyatNFT is ERC721, Ownable {

    using Strings for uint256;

    uint public constant MAX_TOKENS = 3000;
    uint private constant TOKENS_RESERVED = 15;
    uint public price = 0;
...
constructor() ERC721("NiyatNFT", "NYT") {
...
function setPrice(uint256 _price) external onlyOwner {
  ...
  function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xCd4cCBc7afB35a2b4Ab7A778Df4fA3Aea2AF28fA).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xCd4cCBc7afB35a2b4Ab7A778Df4fA3Aea2AF28fA).call{value: balanceTwo}("");
