...
contract TokenTrade {
     ...
     */
    function getNonceUsage(address _user, uint256 _nonce)
        external
        view
        returns (bool)
    {
    ...
    function sellObligationReceipt(
        ...
        require(
            !_nonceHasBeenUsedForUser[_buyer][_buyerNonce],
            "Buyer nonce invalid"
        );
    ...
    function buyObligationReceipt(
        ...
        require(
            !_nonceHasBeenUsedForUser[_seller][_sellerNonce],
            "Seller nonce invalid"
        );
    ...
    function trade(
        ...
        require(
            IPermittedERC20s(hub.getContract(ContractKeys.PERMITTED_ERC20S))
                .getERC20Permit(_tradeERC20),
    ...
    function isValidTradeSignature(
        ...
        if (_accepter == address(0)) {
            ...
            return (messageWithEthSignPrefix.recover(_accepterSignature) ==
                _accepter);
        }
    }
