...
contract LatticeAirdropsDistributorDev is Ownable, ReentrancyGuard, Pausable {
  ...
  function amountClaimed(uint256 airdropId, address claimingUser)
    public
    view
    returns (uint256)
  {
  ...
  function claim(
    ...
    _airdrops[airdropId].amountWithdrew += _amountToClaim;
  ...
  function devSetAirdrop(
    ...
    Airdrop memory airdrop;
    airdrop.token = token;
    airdrop.amountTotal = amountTotal;
    airdrop.amountWithdrew = amountWithdrew;
    airdrop.airdropStartsAt = airdropStartsAt;
    airdrop.vestingPeriod = vestingPeriod;
