    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/MslC2WHmB4VEGbCOuOwE/contract-metadata";
  }
...
// File: contracts/DinoClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DinoClubContract is RamppERC721A {
    constructor() RamppERC721A("Dino Club", "DCB"){}
}
