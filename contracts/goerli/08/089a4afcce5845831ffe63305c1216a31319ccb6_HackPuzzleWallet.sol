...
contract HackPuzzleWallet {
    ...
    PuzzleWallet wallet = PuzzleWallet(payable(0x29B16915d8DF9d064fE717BcB018F4499C5a9EF2));
    PuzzleProxy proxy = PuzzleProxy(payable(0x29B16915d8DF9d064fE717BcB018F4499C5a9EF2));
