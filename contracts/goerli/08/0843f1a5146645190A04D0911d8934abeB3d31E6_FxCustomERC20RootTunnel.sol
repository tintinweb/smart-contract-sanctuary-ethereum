...
import {IFXTestToken} from "./IFXTestToken.sol";

/**
 * @title FxERC20RootTunnel
 */
contract FxCustomERC20RootTunnel is FxBaseRootTunnel {
    using SafeERC20 for IFXTestToken;
    ...
    function mapToken(address rootToken, address childToken) public {
        ...
        require(rootToChildTokens[rootToken] == address(0x0), "FxCustomERC20RootTunnel: ALREADY_MAPPED");
        ...
        // MAP_TOKEN, encode(rootToken, name, symbol, decimals, childToken)
        bytes memory message = abi.encode(MAP_TOKEN, abi.encode(rootToken, childToken));
    ...
    function deposit(
        ...
        // check mapped
        require(rootToChildTokens[rootToken] != address(0x0), "FxCustomERC20RootTunnel: NOT_MAPPED");

        // transfer from depositor to this contract
        IFXTestToken(rootToken).safeTransferFrom(
    ...
    function _processMessageFromChild(bytes memory data) internal override {
        ...
        require(rootToChildTokens[rootToken] == childToken, "FxCustomERC20RootTunnel: INVALID_MAPPING_ON_EXIT");

        // transfer from tokens to
        IFXTestToken(rootToken).safeTransfer(to, amount);
...
interface IFXTestToken is IERC20 {
