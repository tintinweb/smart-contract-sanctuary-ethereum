...
contract BuyMeACoffee is Ownable {
    ...
    */
        ...
        payable
    {
        ...
        string memory _coffee = regularCoffee;

        // Add the memo to storage!
        memos.push(Memo(msg.sender, block.timestamp, _name, _message, _coffee));

        // Emit a NewMemo event with details about the memo.
        emit NewMemo(msg.sender, block.timestamp, _name, _message, _coffee);
    }
        ...
        payable
    {
        ...
        // set size of coffee
        string memory _coffee = largeCoffee;
