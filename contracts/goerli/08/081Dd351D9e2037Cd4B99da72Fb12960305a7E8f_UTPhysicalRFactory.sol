...
contract UTPhysicalRedeemStorage is UTGenericStorage {
    ...
    // Read the uint8 part of the trait state
...
import "../interfaces/IECRegistry.sol";
import "../interfaces/IGenericStorage.sol";

abstract contract UTGenericStorage is IGenericStorage {
...
interface IGenericStorage {
    ...
    function getUint8Value(uint16 _tokenId) external returns(uint8);
}
