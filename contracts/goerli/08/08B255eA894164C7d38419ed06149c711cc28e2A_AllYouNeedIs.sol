 ...
 * @notice This contract handles minting All you need is... tokens.
 */
contract AllYouNeedIs is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x354c99D397a8084201A1100d7AcE166725114853;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x6176A7FEc5Ef3b01A24fFBAef73cF7A63F8304Ff;
    address[] public payoutAddresses = [
        0x6176A7FEc5Ef3b01A24fFBAef73cF7A63F8304Ff
    ];
    ...
    string public name = "All you need is...";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiffdl35v3pr3ebf7s6qanwdy7zkdrpvoy7vcvcdgnnrpwcfkcwriq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[69] = 5000;
        tokenPublicPrice[69] = 0 ether;
        tokenPublicMintsPerAddress[69] = 10;
        tokenPublicSaleStartTime[69] = 1677303000;
        tokenPublicSaleEndTime[69] = 1677819600;
        tokenUsePublicSaleTimes[69] = true;
        require(
