...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xeBE455806c4E3C549CF8f0B42f473A083A94397A];
  address public erc20Payable = 0xeBE455806c4E3C549CF8f0B42f473A083A94397A;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 2016) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidrt5nl34sxedo6mfgmnrlurqehxyvcdyukrb6qjcifbst2ngy6am/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/WAyuE0ZOU3Hxl8gzu9CJ/contract-metadata";
  }
...
// File: contracts/TunedTinySuvContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TunedTinySuvContract is RamppERC721A {
    constructor() RamppERC721A("Tuned Tiny Suv", "TTS"){}
}
