...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1676811600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x6cf9b5865848A36514e5Ce6c779fCad2a89D96bE,0x6Cf9b5865848a36514e5CE6C779FCAD2a89d9644];
  address public erc20Payable = 0x6cf9b5865848A36514e5Ce6c779fCad2a89D96bE;
  uint256[] public payableFees = [2,93,5];
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  uint256 public PRICE = 0.0021 ether;
    ...
    , TimedDrop
{
  constructor(
    ...
    uint256 public MAX_WALLET_MINTS = 88;
