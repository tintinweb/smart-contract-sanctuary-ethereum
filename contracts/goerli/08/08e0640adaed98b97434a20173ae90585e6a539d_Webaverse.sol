    ...
    CantBeEvilUpgradeable
{
    ...
    uint256 private _mintFee; // ERC20 fee to mint ERC1155
     ...
     * @param _nftAddress WebaverseERC1155 contract address for Non-fungible tokens
     ...
     * @param signerAddress_ Address of the voucher signer account
     */
    function initialize(
        address _nftAddress,
    ...
    /**
     * @return The amount of ERC20(Silk) tokens required to mint the ERC1155 NFT
     */
    ...
    /**
     * @return The address of Webaverse ERC1155 contract
     */
    ...
    /**
     * @dev Set the contract instance for ERC1155
     * @param _nftContractAddress The address of the ERC1155 contract that needs to be set
     */
    ...
    /**
     * @return The address of voucher signer
     */
     ...
     * @param signerAddress_ Account address of the signer
     */
    ...
    /**
     * @notice Mint the item that users drag and drop into the world.
    ...
    /**
     * @notice Claims the User dropped token with User signed voucher.
     * @param to The address(new Owner) on which the NFT will be claimed.
     * @param voucher A User(old Owner) signed NFTVoucher that describes the NFT to be redeemed.
     **/
    // function claim_NFT(
    function claimUserDropNFT(
        address to,
        ...
        require(
            _nftContract.balanceOf(signer, voucher.tokenId) >= voucher.balance,
            "WBVRS: Signer's NFT token balance is not enough"
        );
    ...
    /**
     * @notice Claims the User dropped Silk token with User signed voucher.
     * @param to The address on which the Silk will be claimed.
     * @param voucher A signed NFTVoucher(FTVoucher) that describes the Silk to be redeemed.
     **/
    // function claim_FT(
    function claimUserDropSilk(
        address to,
        NFTVoucher calldata voucher
    ) public {
        // make sure signature is valid and get the address of the signer
        address signer = verifyVoucher(voucher);
        require(
            _silkContract.balanceOf(signer) >= voucher.balance,
            "WBVRS: Signer's silk token balance is not enough"
        );
    ...
    /**
     * @notice Claims the Server dropped token with Server signed voucher.
    ...
    function claimServerDropNFT(
        ...
        _nftContract.mintServerDropNFT(to, data, voucher);
    }
