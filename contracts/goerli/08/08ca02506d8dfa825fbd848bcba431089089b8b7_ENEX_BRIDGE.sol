...
contract ENEX_BRIDGE is WrapedTokenDeployer, Ownable, ECDSA, ReentrancyGuard{
 ...
 //   }
    ...
    //Deposit to contract
    //
    function lock(address token, uint256 amount, string memory receiver) public nonReentrant {
        require(
