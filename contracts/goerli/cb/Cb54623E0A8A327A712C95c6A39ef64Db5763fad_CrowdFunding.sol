...
contract CrowdFunding {
    ...
    uint256 price_food;
    uint256 price_healthcare;
    uint256 price_sanitation;
    uint256 price_shelter;
    ...
    function createCampaign(address _owner, string memory _title, string memory _description, uint256 _target, uint256 _deadline, string memory _image, uint256 _food, uint256 _healthcare, uint256 _shelter, uint256 _sanitation) public returns (uint256) {
