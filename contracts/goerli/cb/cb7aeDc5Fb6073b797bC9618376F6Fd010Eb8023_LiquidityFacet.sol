...
contract LiquidityFacet is ILiquidity, ReentrancyGuard {
        ...
        for (uint256 i = 0; i < len; ) {
            ...
            LibDIVA._addLiquidityLib(
                LibDIVA.AddLiquidityParams({
                    ...
                    collateralAmountMsgSender: _argsBatchAddLiquidity[i].collateralAmountIncr,
                    collateralAmountMaker: 0,
                    maker: address(0), 
    ...
    function _isValidAddLiquidityTx(
        ...
        LibDIVAStorage.Pool memory _poolParameters = LibDIVA._poolParameters(_poolId);
        ...
        LibDIVA._checkAddLiquidityAllowed(_poolParameters, _collateralAmountIncr);
    }
