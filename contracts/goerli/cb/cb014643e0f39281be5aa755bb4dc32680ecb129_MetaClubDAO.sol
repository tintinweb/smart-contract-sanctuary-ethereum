...
contract MetaClubDAO is ERC721, ReentrancyGuard, Ownable, EIP712Whitelisting {
  ...
  constructor (
    ...
    MAX_STANDARD_PER_WALLET = 5;

    MAX_MULTIMINT = 5;

    MAX_STANDARD_SUPPLY = 10000;
    MAX_STANDARD_RESERVED_SUPPLY = 750;
    MAX_SUPPLY = MAX_STANDARD_SUPPLY;

    MAX_STANDARD_WHITELIST_SUPPLY = 5000;
  }
