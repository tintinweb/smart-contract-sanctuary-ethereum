...
contract dfvdfv is ERC721, Ownable {
    using Strings for uint256;
    ...
    string public nameCollection = "ddsvfvfv";


    constructor() ERC721("Balance", "BAL") {
        baseUri = "ipfs://bafybeidmesyvanvvjudhnbdxefwvfjgjem5xtlxiju4yfau6vvdjvm722i/";
    ...
    function imagURI(uint256 tokenId) private view returns (string memory) {
  ...
  string memory metadata = '{"name":"Checks", "image": ';
  
  string memory encodedMetadata = Base64.encode(abi.encodePacked(metadata,'"', imagUri ,'"', " }"));
