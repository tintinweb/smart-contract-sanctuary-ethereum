...
contract LOOTaDOG is ERC3525, Ownable {
    ...
    constructor() ERC3525("LOOTaDOG", "LADT", 2) {
    ...
    function mint(
        ...
        _verifySign(Voucher(signer, to, slot, amount, expirationTime), v, r, s);
        _mint(to, slot, amount);
    }
    ...
    function safeTransferFrom(
        ...
        require(_allow_transfer, "SBT does not allow transfer");
        safeTransferFrom(from_, to_, tokenId_, data_);
    }
    ...
    //"Voucher(string signer,string to,uint256 slot,uint256 amount,uint256 expirationTime)";
    bytes32 private constant VOUCHER_TYPEHASH = 0x824f53e0cb7db7a7bd8b3140283a812a850e8ed79e38356752e932518456e035; //keccak256(bytes(VOUCHER_TYPEHASH));
