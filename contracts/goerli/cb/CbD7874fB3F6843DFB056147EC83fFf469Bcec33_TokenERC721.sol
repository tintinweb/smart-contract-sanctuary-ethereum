...
abstract contract ERC2771ContextUpgradeable is Initializable, ContextUpgradeable {
    ...
    function _msgSender() internal view virtual override returns (address sender) {
        ...
        if (isTrustedForwarder(msg.sender)) {
            //console.log("isTrustedForwarder: True");
...
library CurrencyTransferLib {
    ...
    function transferCurrencyWithWrapper(
        ...
        //console.log("transferCurrencyWithWrapper: %s %s %s", _currency, _from, _to);
        //console.log("%s %s %s", _amount, _nativeTokenWrapper, address(this));
        if (_amount == 0) {
            return;
        }

        //console.log("%s %s", _currency, NATIVE_TOKEN);
        //console.log("%s %s", _amount, msg.value);
        ...
        if (_currency == NATIVE_TOKEN) {
            ...
            //console.log("CurrencyTransferLib.sol line 66 safeTransferERC20");
            safeTransferERC20(_currency, _from, _to, _amount);
        }
    }
    ...
    function safeTransferNativeTokenWithWrapper(
        ...
        (bool success, ) = to.call{ value: value }("");
        if (!success) {
            //console.log("%s %s %s", to, _nativeTokenWrapper, value);
            require(success != true, "safeTransferNativeTokenWithWrapper failed");
