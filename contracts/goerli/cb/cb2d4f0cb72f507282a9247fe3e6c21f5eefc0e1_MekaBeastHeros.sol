...
/**
 @title Meka Beast Heros
 @author Paper Hand Labs <hello[at]paperhandlabs[dot]com>
*/
contract MekaBeastHeros is ERC721A, ERC2981, TeamPaidFirst {
    ...
    constructor(
        ...
        // The first 25 are legendary heros that will be distributed to Meka Beast partners
        _internalMint(_TREASURY, 25);

        // The next 72 are non-legendary heros that will be minted to the treasury for safe-keeping
        _internalMint(_TREASURY, 72);
    }
