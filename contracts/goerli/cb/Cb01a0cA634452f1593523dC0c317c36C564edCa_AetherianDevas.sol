...
contract AetherianDevas is ERC721A, Owned, ERC2981 {
    ...
    constructor(address payable royaltyReceiver, bytes32 _merkleRoot)
    ...
    /// Solady (https://github.com/vectorized/solady/blob/main/src/utils/MerkleProofLib.sol)
    function verify(
        ...
        external
    {
        ...
        require(started, "ceremony hasn't started");
        require(claimed[msg.sender] == false, "greediness is a sin");
        claimed[msg.sender] = true;
        require(
            verify(worthinessProof, merkleRoot, toBytes32(msg.sender)) == true,
    ...
    function startCeremony(bool mintStarted) external onlyOwner {
        started = mintStarted;
