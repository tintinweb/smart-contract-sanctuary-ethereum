...
contract ZwempiZemmers is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Zwempi Zemmers", "ZZ") {}
    ...
    function mintModifier(uint256 _amount) internal {
        ...
        require(msg.value >= mintCost * (_amount - free), "1 NFT is free, remaining 0.001 per nft");
