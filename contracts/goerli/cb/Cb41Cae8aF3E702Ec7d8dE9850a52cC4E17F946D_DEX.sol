...
contract DEX {
     ...
     */
    event EthToTokenSwap(address _to, string _msg, uint eth, uint bal);

    /**
     * @notice Emitted when tokenToEth() swap transacted
     */
    event TokenToEthSwap(address _to, string _msg, uint bal, uint eth);

    /**
     * @notice Emitted when liquidity provided to DEX and mints LPTs.
     */
    event LiquidityProvided(address _to, uint liq, uint eth, uint bal);

    /**
     * @notice Emitted when liquidity removed from DEX and decreases LPT count within DEX.
     */
    event LiquidityRemoved(address _to, uint amount, uint eth, uint bal);
