...
contract Test is ERC721Enumerable, Pausable, PaymentSplitter {
    ...
    uint public maxPresaleMint = 2;
    uint256 public MintPrice = 1800000000000000; // 0.0018 ether
    string public baseURI;
    Counters.Counter private _tokenIds;
    uint256[] private _teamShares = [100];
    address[] private _team = [0x7668dFC2987F64d2400be98c74405309Bfbdb51f];
    ...
    function setPrice(uint256 _amount) external onlyOwner {
        MintPrice = _amount * 1000000000000000; // 0.001
