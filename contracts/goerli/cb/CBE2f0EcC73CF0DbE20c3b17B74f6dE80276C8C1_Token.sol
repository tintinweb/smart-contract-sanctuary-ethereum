...
/// @author Osman Ali.
/// @notice Claim, mint and burn vvddrr with a maximum of 21,000,000.
contract Token is Context, ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    /// @notice Basic event emitted when a mint is claimed.
    ...
    function claimRank_66u(uint256 term) external {
        ...
        emit RankClaimed(_msgSender(), term, _globalRank);
    }
    ...
    function claimMintReward() external {
        ...
        require(totalAmount + _currentCreated < MAX_CREATED);
    ...
    function addFfxxddController(address controller) external onlyOwner {
        //  TEMPORARY NEED TO RESET TO ACTIVE
    ...
    function addMmccrrController(address controller) external onlyOwner {
        // TEMPORARY NEED TO RESET TO ACTIVE
        // require(setMmccrrController == false);
        controllers[controller] = true;
