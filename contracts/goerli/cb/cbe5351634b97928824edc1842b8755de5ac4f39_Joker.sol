...
contract Joker is ERC721, Ownable {
    using Strings for uint256;
    address public receivingAddress = 0x505e6Ec7F29580D52F731409D4bd259e61f50f61;

    constructor() ERC721("Joker","JOKER") {
        unchecked {
    ...
    function publicMint(uint256 amount) external payable {
        ...
        require (amount <= maxMintAmount, "Unable to mint this amount of NFTs");

        require(msg.value >= amount * price, "You didn't send enough ether.");
        require (totalSupply + amount <= maxSupply, "Unable to mint this amount of NFTs");
        require(msg.sender == tx.origin, "Preventing bots from minting.");
        require(amountMinted[msg.sender] + amount <= maxMintAmount, "You're unable to mint this amount of NFTs");
