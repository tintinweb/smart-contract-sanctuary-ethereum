...
contract VaultFactory {
    ...
    function createVault(address _beneficiary, string memory name, string memory description) external {
        ...
        VaultInfo memory newVaultInfo = VaultInfo(name, description, _beneficiary, address(newVault));
...
contract ImpactETHtoken is ERC20, ERC20Burnable, AccessControl {
    ...
    constructor() ERC20("impactETH", "imETH") {
...
contract Vault {
    ...
    function withdraw(uint _amountToWithdraw) external {
        ...
        stETH.transfer(
            msg.sender,
            stETH.getSharesByPooledEth(_amountToWithdraw)
        );
    }
    ...
    */
    function harvestRewards() external {
        ...
        uint256 unharvestedRewards = _stETHBalance -
        stETH.getSharesByPooledEth(imETH.totalSupply());
