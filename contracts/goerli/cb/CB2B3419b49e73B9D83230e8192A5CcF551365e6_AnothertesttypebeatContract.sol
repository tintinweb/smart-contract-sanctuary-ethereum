    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihjfdmwoklesznjazpodxyvve42oxd6rmxoppqijgcmjwr3qgqjti/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/DSKdKQtj1xWjEOe0kM3k/contract-metadata";
  }
...
// File: contracts/AnothertesttypebeatContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnothertesttypebeatContract is RamppERC721A {
    constructor() RamppERC721A("another test type beat", "MINTPLEX"){}
}
