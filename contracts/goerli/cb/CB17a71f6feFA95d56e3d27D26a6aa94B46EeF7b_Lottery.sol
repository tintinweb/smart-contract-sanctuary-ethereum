...
contract Lottery is VRFConsumerBase {
    ...
    uint256 public countFulfillRandomnessInvoked;
    bool public isCallGetRandomNumber = false;
        ...
        )
    {
        ...
        owner = msg.sender;
        lotteryId = 1;
        countFulfillRandomnessInvoked = 0;
    }

    function getRandomNumber() public returns (bytes32 requestId) {
        //
        isCallGetRandomNumber = true;
        //调用这个函数就需要给合约地址打款了
        require(
        ...
        // 完成後，isCallGetRandomNumber = false
        isCallGetRandomNumber = false;
        return _requestId;
    }

    // 調用這個函數會決定 fulfillRandomness
    function fulfillRandomness(bytes32 requestId, uint256 randomness)
        internal
        override
    {
        // 調用這個函數決定了 randomResult
        randomResult = randomness;
        // 我自己訂的，先把它傳出去再說
        myRequestId = requestId;
        // 增加一個計數器
        countFulfillRandomnessInvoked += 1;
    }
    ...
    function getRandomNumberWhenException() public view returns (uint256) {
