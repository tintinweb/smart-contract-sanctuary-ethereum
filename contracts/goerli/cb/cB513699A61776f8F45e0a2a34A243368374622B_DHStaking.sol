...
contract DHStaking is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable {
    ...
    IShowBiz _showBiz = IShowBiz(0x1dD4d0D2ADB23546a33D87ec50d1Ea61d243d0eC);
    ...
    function stake(address contractAddress, uint tokenId, uint months) public {
        ...
        uint endsAt = block.timestamp + months * 28 minutes;
    ...
    function unclaimedRewards(uint localTokenId) public view returns (uint) {
        ...
        uint rewardLimit = (stakedToken.endsAt - stakedToken.stakedAt) / 7 minutes;
        uint rewardsUntilNow = (block.timestamp - stakedToken.stakedAt) / 7 minutes;
