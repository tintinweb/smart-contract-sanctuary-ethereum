...
contract AaveAdapter is OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;
    using SafeERC20Upgradeable for IAToken;

    address public immutable V2_ADDRESSES_PROVIDER;

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor(address _v2AddressesProvider) {
        _disableInitializers();

        V2_ADDRESSES_PROVIDER = _v2AddressesProvider;
    }
