...
contract TokenFarm is Ownable {
    ...
    //Mapp of token address to staker address to the amount
    ...
    function getUserTotalValue(address _user) public view returns (uint256){
        // this function is expensive and uses gas
        uint totalValue = 0;
    ...
    function stakeTokens(uint256 _amount, address _token) public {
        ...
        // using the interface IERC, becase we dont need the entire contract
        // wrap _token as en erc20 token, so now we have the abi and address
        // via the interface
    ...
    function unstakeTokens(address _token) public {
        ...
        // feel free to add logic to remove the staker from the list since they are not staking anylonger
