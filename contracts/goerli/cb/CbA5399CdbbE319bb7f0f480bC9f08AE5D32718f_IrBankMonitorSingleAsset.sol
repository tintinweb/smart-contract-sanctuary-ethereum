...
contract IrBankMonitorSingleAsset {
    ...
    function getAllParams(address _underlying) external view returns (address, address, address, uint256, uint256) {
        ...
        return (_factory, _pToken, _stakeReward, _decimals, _baseUnit);
