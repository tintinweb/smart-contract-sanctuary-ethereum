...
contract DummyContract is Initializable, OwnableUpgradeable, UUPSUpgradeable, IImplementation {
    ...
    function initialize(address _orchestrator, address _steer, address _internalGovernance, bytes calldata _params) public initializer {
        // console.log('dummyContract 24');
