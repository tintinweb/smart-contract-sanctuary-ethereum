    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xbDF3C5B3e7A9Fe63592Dcfa73Cb646C32234d377;
    ...
    string public baseTokenURI =
        "ipfs://bafybeidqu6k23t3imzew4ampguhinsjv24hyqh2izganbfnnsxpzs7njja/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 100;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 50;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public presaleMintsAllowedPerAddress = 100;
    uint256 public presaleMintsAllowedPerTransaction = 100;
    uint256 public presalePrice = 0.01 ether;
    uint256 public publicMintsAllowedPerAddress = 100;
    uint256 public publicMintsAllowedPerTransaction = 100;
    ...
    constructor(address _crossmintAddress, uint256 _heymintFeePerToken)
        ERC721A("Curious Addys", "CATC")
        RevokableOperatorFilterer(
    ...
    function crossmint(uint256 numTokens, address to)
        external
        payable
        nonReentrant
        originalUser
    {
        ...
        require(
            _numberMinted(to) + numTokens <= publicMintsAllowedPerAddress,
            "MAX_MINTS_EXCEEDED"
        );
        require(totalSupply() + numTokens <= MAX_SUPPLY, "MAX_SUPPLY_EXCEEDED");
        uint256 heymintFee = numTokens * heymintFeePerToken;
