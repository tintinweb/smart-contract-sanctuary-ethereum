...
contract Market is Ownable {
    ...
    address private ethAddress = 0x0000000000000000000000000000000000000000;
    ...
    */
    ...
    function transferToken(address _token, address _to, uint256 _amount, bool _reward) public onlyOwner {
        ...
        if (_token == ethAddress) {
            ...
            _tokenBalance = IERC20(_token).balanceOf(address(this));
        }
