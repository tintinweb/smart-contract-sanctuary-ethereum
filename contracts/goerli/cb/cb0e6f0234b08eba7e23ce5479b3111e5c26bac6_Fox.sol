...
contract Fox is ERC20, Ownable, Pausable {
    // Variables
    ...
    uint256 private buyDevelopmentFee = 5;
    uint256 private sellLiquidityFee = 5;
    uint256 private sellDevelopmentFee = 5;
    ...
    constructor() ERC20('Fox', 'FOX') payable
    {
     ...
     */
    function setSellTax(uint256 devFee, uint256 liquidityFee) public onlyOwner {
