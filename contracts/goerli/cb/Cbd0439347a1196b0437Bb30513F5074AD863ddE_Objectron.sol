...
contract Objectron is DefaultOperatorFilterer, AccessControl, ERC2981, ERC1155URIStorage {
    ...
    constructor() ERC1155("") {
        ...
        _setURI(1, "https://2302-0bjectr0n.s3.ap-northeast-1.amazonaws.com/metadata/1.json");
        mint(msg.sender, 1, 1);
    }
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) external onlyRole(URI_SETTER_ROLE) {
    ...
    function mint(address account, uint256 id, uint256 amount) public payable onlyRole(MINTER_ROLE) {
        require(bytes(uri(id)).length != 0, "The tokenurl is not set.");
