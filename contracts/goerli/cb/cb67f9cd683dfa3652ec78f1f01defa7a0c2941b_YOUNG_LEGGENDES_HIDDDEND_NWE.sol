...
// File: contracts/TestContractSignature.sol
...
contract YOUNG_LEGGENDES_HIDDDEND_NWE is ERC721AQueryable, Ownable {
    using Strings for uint256;

    constructor() ERC721A("YOUNG LEGGENDES HIDDDEND5", "YLHH") {
