...
// WITH THIS CONTRACT YOU CAN COPYMINT ANY ERC721 IN EXISTENCE, WHICH MEANS CAN MIRROR THEIR METADATA
// YOU CAN EVEN COPYMINT A NFT IN THIS CONTRACT, EVEN THE ONES ISN'T IN EXISTENCE HEHE. FUN WAY TO EXPERIMENT
// PS. BY COPYMINTING, YOU ARE ONLY MIRRORING THE METADATA, NOTHING MORE. YOU ARE NOT STEALING ANYTHING, NOT BENEFITING WITH UTILITIES OF THE ORIGINAL
// BUT YOU CAN HEXAGON ANY SHIT YOU LIKE ON TWITTER FOR EXAMPLE!
// LET'S CURATE THIS COLLECTION TOGETHER! THIS COLLECTION WILL BE THE TRASHIEST
...
contract COPYMINTALLES is ERC721AQueryable {
    ...
    */
        ...
        returns (string memory)
    {
        ...
        return ERC721A(mirror).tokenURI(Database[_tokenId].id);
    }
