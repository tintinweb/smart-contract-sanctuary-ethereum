...
contract CVTest is ERC721A, Ownable, ReentrancyGuard, ERC2981{
    uint256 public tokenCount;
    uint256 public prePrice = 0.0005 ether;//デプロイ前に修正
    uint256 public pubPrice = 0.0008 ether;//デプロイ前に修正
    uint256 public batchSize = 100;
    uint256 public mintLimit = 3;
    uint256 public _totalSupply = 100;//デプロイ前に修正
    ...
    constructor() ERC721A("CVTest1", "CVT1",batchSize, _totalSupply) {
        tokenCount = 0;
    ...
    function withdrawRevenueShare() external onlyOwner {
        ...
        address artist = payable(0x90Ddea77bb4d8DFBf090C1b81917e683Cf87E9B0);//12 デプロイ前に修正
