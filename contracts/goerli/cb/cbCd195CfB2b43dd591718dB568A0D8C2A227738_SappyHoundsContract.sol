...
//
//    _____                            __  __                      __    
//   / ___/____ _____  ____  __  __   / / / /___  __  ______  ____/ /____
//   \__ \/ __ `/ __ \/ __ \/ / / /  / /_/ / __ \/ / / / __ \/ __  / ___/
//  ___/ / /_/ / /_/ / /_/ / /_/ /  / __  / /_/ / /_/ / / / / /_/ (__  ) 
// /____/\__,_/ .___/ .___/\__, /  /_/ /_/\____/\__,_/_/ /_/\__,_/____/  
//           /_/   /_/    /____/                                         
//
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xbe6dc512a629c2F9a3E1d38c4cFD914bAa1C3535];
  address public erc20Payable = 0xbe6dc512a629c2F9a3E1d38c4cFD914bAa1C3535;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 2222) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiff27woqh5gv7agvgdqywhbtk3njb34y25thrs47zi5cweksw6uiy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/1c5EftBfKs5EKI8as0NS/contract-metadata";
  }
...
// File: contracts/SappyHoundsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SappyHoundsContract is RamppERC721A {
    constructor() RamppERC721A("Sappy Hounds", "SAPH"){}
}
