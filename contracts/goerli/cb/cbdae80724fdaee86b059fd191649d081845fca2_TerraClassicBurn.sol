...
/**
Token name... Terra Classic Burn
Ticker.. LUNB
Supply.. 6,904,017,889,662
10% sell tax
5% to Liquidity
5% Burn
*/
contract TerraClassicBurn is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 6904017889662 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Terra Classic Burn";
    ...
    uint256 public numTokensSellToAddToLiquidity = 100000000;
    ...
    function setBurnWalletAddress(address _address) external onlyOwner() {
        require(_address != address(0), "Error: BurnWallet address cannot be zero address");
        _BurnWalletAddress = _address;
        emit SetBurnWalletAddress(_address);
    }
