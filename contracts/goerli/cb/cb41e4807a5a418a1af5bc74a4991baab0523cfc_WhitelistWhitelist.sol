...
contract WhitelistWhitelist is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    ...
    uint public maxWhitelistSupply = 10000;
    uint public normalMintPrice = 0.1 ether;
    uint public whitelistMintPrice = 0 ether;
    uint public maxNormalMintPerAccount = 2;
    uint public maxWhitelistMintPerAccount = 2;
    uint public publicSalesTimestamp = 1663639200;
    uint public whitelistSalesTimestamp = 1663639200;

    mapping(address => uint) private _totalNormalMintPerAccount;
    mapping(address => uint) private _totalWhitelistMintPerAccount;
    address private _signerPublicKey = 0xbEC76C83104313B9B582987F53326C7e05EE736d;
