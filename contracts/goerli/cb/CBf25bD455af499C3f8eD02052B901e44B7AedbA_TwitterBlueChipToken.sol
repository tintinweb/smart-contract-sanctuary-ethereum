...
contract TwitterBlueChipToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TwitterBlueChipToken", "TBT") {

        uint256 totalSupply = 1000000 * 1e18;
        
        maxTransactionAmount = totalSupply * 10 / 1000; // 1% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap tokens amount // set lower for testnet
