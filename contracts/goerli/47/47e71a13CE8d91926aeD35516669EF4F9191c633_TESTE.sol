...
contract TESTE is ERC20, Ownable {
    ...
    constructor() ERC20("Test", "TEST") {
        ...
        maxTransactionAmount = 10000000 * 1e9;
        maxWallet = 10000000 * 1e9;
        ...
        marketingWallet = address(0x0a98089eFbE9FEdE20a0a2F6e266DA91E1Dfb6Ad);
    ...
    function updateMaxWalletAndTxnAmount(uint256 newTxnNum, uint256 newMaxWalletNum) external onlyOwner {
        require(
            newTxnNum >= ((totalSupply() * 5) / 1000) / 1e9,
            "Cannot set maxTxn lower than 0.5%"
        );
        require(
            newMaxWalletNum >= ((totalSupply() * 5) / 1000) / 1e9,
            "Cannot set maxWallet lower than 0.5%"
        );
        maxWallet = newMaxWalletNum * (10**9);
        maxTransactionAmount = newTxnNum * (10**9);
    }
