...
/// @author LiquidX
/// @notice This smart contract mint the eveolve pixelmon for different stage.
contract PixelmonEvolution is Ownable, EIP712, ReentrancyGuard {
    ...
    /// @dev signature version for creating and verifing signature
    ...
    /// @notice List of nonce against user wallet for counting the total evolve transaction
    /// @dev Use this mapping to track the evolve transaction count
    /// @custom:key A valid ethereum address
    /// @custom:value the amount of eveolve transaction
    mapping(address => uint256) public nonces;

    /// @notice There's a batch evolve transaction happening
    ...
    /// @param nonce Nonce for evolve transaction
    ...
    /// @notice Recovers singer wallet from signature
