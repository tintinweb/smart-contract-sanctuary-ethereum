...
// Opensea: https://opensea.io/assets/xxxx
...
contract CSHOX is Ownable, ERC721A, ReentrancyGuard {
    string public baseURI = "https://asset.echeloncipher.xyz/cshox/";
        ...
        tokensAvailable(_howMany)
    {
        ...
        // require(
        //     numberMinted(msg.sender) + _howMany <= maxPerAddressDuringMint,
    ...
    function tokensRemaining() public view returns (uint256) {
        return maxSupply - totalSupply() - 50; // reserve mints for the team
    }
