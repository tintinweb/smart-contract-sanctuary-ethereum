...
//Made By Finn On The MetaLeopardsClub Team! Don't Forget To Credit Me If You Use Some Of My Code! :smile:
...
contract StakingOfDragons is ERC721Holder, AccessControl, TimerOfDragons {
    ...
    address internal projectOwner = 0x1C8CD38d3945035dd12Fe4B5EfCF17c0bc638CED;
    ...
    function stake(uint256 _nftId) public {
        ...
        require(!isStaked[_nftId], "Token is already staked"); //cant double stake silly :wink:
    ...
    function unstake(uint256 _nftId) public {
        ...
        endTimer(_nftId);
        uint256 reward = stakedTime[_nftId];
        mintTokenInternal(reward); 
        emit Unstake(msg.sender, _nftId);
    }

    function mintTokenInternal(uint256 _amount) internal {
        eggToken.mint(msg.sender, ((_amount * (10 ** 18) / 86400))); 
    }
...
contract TimerOfDragons is AccessControl {
    ...
    address internal stakingContract = address(this);
    ...
    function resetTokenStats (uint256 _tokenId) internal {
