...
// File: Bnet/Swap/Swap_core_2.sol
...
contract BNETSwap is Ownable {
    ...
    event AddNFTtoFixedSellSwapEvent(
        address indexed NftContract,
        uint256 tokenId,
        address indexed SellerOfToken,
        address tokenForPay,
        uint256 priceNFT,
        uint256 timeSwap
    );
    event AddNFTtoBidsSwapEvent(
        address indexed NftContract,
        uint256 tokenId,
        address indexed SellerOfToken,
        address tokenForPay,
    ...
    event BuyNFTitemOnFixedSwapEvent(
        address indexed NftContract,
        uint256 tokenId,
        address indexed SellerOfToken,
        address tokenForPay,
    ...
    event BuyNFTitemOnFixedSwapWithETHEvent(
        address indexed NftContract,
        uint256 tokenId,
        address indexed SellerOfToken,
        uint256 priceNFT,
    ...
    event NewOwnerOfNftAndShares(
        address indexed NftContract,
        uint256 tokenId,
        address indexed OldOwnerNft,
        address indexed NewOwnerNft,
        uint256 SellerShare,
        uint256 DevShare
    );
    event TakeBackNFTfromFixedSwap(
        address indexed NftContract,
        uint256 tokenId,
        address OwnerNft
    );
    event BidAPriceforNft(
        address indexed NftContract,
        uint256 tokenId,
        address SellerOfNft,
        address OwnerNft,
    ...
    mapping(address => mapping(uint256 => InfoNFTonFixedSwap))
        public InfoTokensNFTonSwapfixed;
    ...
    mapping(address => mapping(uint256 => InfoNFTonBidSwap))
        public InfoTokensNFTonSwapBids;
    ...
    modifier onSold(address _tokenContract, uint256 tokenId) {
        require(
            !InfoTokensNFTonSwapfixed[_tokenContract][tokenId].isSold,
            "It's Not For Sell"
        );
        _;
    }

    function AddNfTforFixedSell(
        address tokenContract,
        uint256 tokenId,
        address tokenMustPayAddress,
        uint256 amount
        ...
        )
    {
        ...
        if (!NFTisExistOnFixedSwap[tokenContract][tokenId]) {
            ...
            InfoTokensNFTonSwapfixed[tokenContract][
                tokenId
            ] = InfoNFTonFixedSwap(
                tokenContract,
                tokenId,
            ...
            InfoTokensNFTonSwapfixed[tokenContract][tokenId].OwnerNFT = msg
                .sender;
            InfoTokensNFTonSwapfixed[tokenContract][tokenId]
                .tokenMustPayAddress = tokenMustPayAddress;
            InfoTokensNFTonSwapfixed[tokenContract][tokenId]
                .priceOfItem = amount;
            InfoTokensNFTonSwapfixed[tokenContract][tokenId].timeListed = block
                .timestamp;
            InfoTokensNFTonSwapfixed[tokenContract][tokenId].isSold = false;
        }
        emit AddNFTtoFixedSellSwapEvent(
            tokenContract,
            tokenId,
            msg.sender,
            tokenMustPayAddress,
    ...
    {
        require(
            NFTisExistOnFixedSwap[tokenContract][tokenId],
            "NFT is Not Exist"
        );
        require(
            InfoTokensNFTonSwapfixed[tokenContract][tokenId].priceOfItem <=
                amount,
            "Your Price is Not Enough"
        );
        require(
            InfoTokensNFTonSwapfixed[tokenContract][tokenId]
                .tokenMustPayAddress == tokenMustPayAddress,
            "token you want to pay is diffrent"
        );

        _BuyItemNFTtoken(tokenContract, tokenId, tokenMustPayAddress, amount);
        emit BuyNFTitemOnFixedSwapEvent(
            tokenContract,
            tokenId,
            msg.sender,
            tokenMustPayAddress,
    ...
    function BuyItemNFwithETH(address tokenContract, uint256 tokenId)
        public
        payable
        returns (
            address,
        ...
        )
    {
        ...
        require(
            InfoTokensNFTonSwapfixed[tokenContract][tokenId]
                .tokenMustPayAddress == WETH,
            "token you want to pay is diffrent"
        );

        IWETH(WETH).deposit{value: msg.value}();
        _BuyItemNFTtoken(tokenContract, tokenId, WETH, msg.value);
        emit BuyNFTitemOnFixedSwapWithETHEvent(
            tokenContract,
            tokenId,
            msg.sender,
            msg.value,
        ...
        )
    {
        ...
        InfoTokensNFTonSwapfixed[_tokenContract][_tokenId]
            .LastOwnerNFT = InfoTokensNFTonSwapfixed[_tokenContract][_tokenId]
            .OwnerNFT;
        InfoTokensNFTonSwapfixed[_tokenContract][_tokenId].OwnerNFT = msg
            .sender;
        ...
        if (tokenMustPayAddress != WETH) {
            ...
            address _LastOwnerNFT = InfoTokensNFTonSwapfixed[_tokenContract][
                _tokenId
            ].LastOwnerNFT;
            ...
            TransferHelper.safeTransferETH(
                InfoTokensNFTonSwapfixed[_tokenContract][_tokenId].LastOwnerNFT,
                _SellerShareAmount
            );
        ...
        IERC721(_tokenContract).safeTransferFrom(
            address(this),
            msg.sender,
            InfoTokensNFTonSwapfixed[_tokenContract][_tokenId].tokenId
        );
    ...
    function takeBackNFTtokenToOwnerFixedSwap(
        address tokenContract,
        uint256 tokenId
    )
        public
        ...
        )
    {
        ...
        require(
            InfoTokensNFTonSwapfixed[tokenContract][tokenId].OwnerNFT ==
                msg.sender,
        ...
        IERC721(tokenContract).safeTransferFrom(
            address(this),
            msg.sender,
            InfoTokensNFTonSwapfixed[tokenContract][tokenId].tokenId
        );
    ...
    function AddItemBidSwapNFTonTime(
        address tokenContract,
        uint256 tokenId,
        address tokenMustPayAddress,
        uint256 amount,
        ...
        )
    {
        ...
        if (!NFTisExistOnBidsSwap[tokenContract][tokenId]) {
            ...
            InfoTokensNFTonSwapBids[tokenContract][tokenId] = InfoNFTonBidSwap(
                tokenContract,
                tokenId,
                msg.sender,
                msg.sender,
            ...
            SellerOfNftOnBid[tokenContract][tokenId] = msg.sender;
            InfoTokensNFTonSwapBids[tokenContract][tokenId].OwnerNFT = msg
                .sender;
            InfoTokensNFTonSwapBids[tokenContract][tokenId]
                .tokenMustPayAddress = tokenMustPayAddress;
            InfoTokensNFTonSwapBids[tokenContract][tokenId]
                .priceOfItem = amount;
            InfoTokensNFTonSwapBids[tokenContract][tokenId].timeListed = block
                .timestamp;
    ...
    function BidApriceForNFTpaywithToken(
        address tokenContract,
        uint256 tokenId,
        address tokenMustPayAddress,
        uint256 amount
    ...
    {
        require(
            NFTisExistOnBidsSwap[tokenContract][tokenId],
            "NFT is Not Exist"
        );
        require(
            amount >=
                InfoTokensNFTonSwapBids[tokenContract][tokenId].priceOfItem,
            "Your Price is Not Enough or too Low"
        );
        require(
            InfoTokensNFTonSwapBids[tokenContract][tokenId]
                .tokenMustPayAddress == tokenMustPayAddress,
        ...
        require(
            amount >= LastPrice[tokenContract][tokenId],
            "Your Offer is Low from Last Price"
        );
        uint256 endTime = InfoTokensNFTonSwapBids[tokenContract][tokenId]
            .timeEnd;
    ...
    function BidApriceForNFTpaywithETH(address tokenContract, uint256 tokenId)
        public
        payable
        returns (
            address,
        ...
        )
    {
        ...
        emit BidAPriceforNft(
            tokenContract,
            tokenId,
            SellerOfNftOnBid[tokenContract][tokenId],
            msg.sender,
            WETH,
            LastPrice[tokenContract][tokenId],
            msg.value
        );
        IWETH(WETH).deposit{value: msg.value}();
        ...
        )
    {
        ...
        InfoTokensNFTonSwapBids[_tokenContract][_tokenId]
            .LastOwnerNFT = InfoTokensNFTonSwapBids[_tokenContract][_tokenId]
            .OwnerNFT;
        ...
        if (_tokenMustPayAddress != WETH) {
            ...
            if (
                block.timestamp >=
                InfoTokensNFTonSwapBids[_tokenContract][_tokenId].timeEnd
            ) {
                _SellerShareAmount = _amount.mul(ShareOfSells).div(DivOfShare);
                _DevsShareAmount = _amount.sub(_SellerShareAmount);
                ...
                itoken.safeTransfer(
                    InfoTokensNFTonSwapBids[_tokenContract][_tokenId]
                        .LastOwnerNFT,
                    LastPrice[_tokenContract][_tokenId]
                );
                itoken.safeTransfer(
                    SellerOfNftOnBid[_tokenContract][_tokenId],
                    _SellerShareAmount
                );
                itoken.safeTransfer(addressOwner, _DevsShareAmount);
                IERC721(_tokenContract).safeTransferFrom(
                    address(this),
                    InfoTokensNFTonSwapBids[_tokenContract][_tokenId].OwnerNFT,
                    InfoTokensNFTonSwapBids[_tokenContract][_tokenId].tokenId
                );
                ...
                InfoTokensNFTonSwapBids[_tokenContract][_tokenId]
                    .LastPriceOfNFT = _amount;
                LastPrice[_tokenContract][_tokenId] = _amount;
                emit NewOwnerOfNftAndShares(
                    _tokenContract,
                    _tokenId,
                    InfoTokensNFTonSwapBids[_tokenContract][_tokenId]
                        .LastOwnerNFT,
    ...
    function _GetNftAfterTimeEnded(address tokenContract, uint256 tokenId)
        internal
        returns (
            address,
            uint256,
        ...
        )
    {
        // @dev Check Requires
        InfoTokensNFTonSwapBids[tokenContract][tokenId]
            .LastPriceOfNFT = LastPrice[tokenContract][tokenId];
        uint256 _SellerShareAmount = 0;
        uint256 _DevsShareAmount = 0;
        uint256 _amount = InfoTokensNFTonSwapBids[tokenContract][tokenId]
            .LastPriceOfNFT;
        IERC721(tokenContract).safeTransferFrom(
            address(this),
            InfoTokensNFTonSwapBids[tokenContract][tokenId].OwnerNFT,
            tokenId
        );
        if (
            InfoTokensNFTonSwapBids[tokenContract][tokenId]
        ...
        emit NewOwnerOfNftAndShares(
            tokenContract,
            tokenId,
            InfoTokensNFTonSwapBids[tokenContract][tokenId].LastOwnerNFT,
            InfoTokensNFTonSwapBids[tokenContract][tokenId].OwnerNFT,
            _SellerShareAmount,
            _DevsShareAmount
        );
    ...
    function GetNftAfterTimeEndedforSeller(
        address tokenContract,
        uint256 tokenId
    )
        public
        ...
        )
    {
        ...
        require(
            block.timestamp >=
                InfoTokensNFTonSwapBids[tokenContract][tokenId].timeEnd,
            "Time is Not Ended"
        );
        require(
            SellerOfNftOnBid[tokenContract][tokenId] == msg.sender,
    ...
    function GetNftAfterTimeEndedforLastOwner(
        address tokenContract,
        uint256 tokenId
    )
        public
    ...
    function LastPriceOfNft(address tokenContract, uint256 tokenId)
        public
        view
        returns (uint256)
    {
        ...
        return (
            (LastPriceForFixed[tokenContract][tokenId]).add(
                InfoTokensNFTonSwapBids[tokenContract][tokenId].LastPriceOfNFT
            )
        );
    }

    function LastPriceOfNftFixedSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (uint256)
    {
    ...
    function LastPriceOfNftBidsSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (uint256)
    {
    ...
    function timeIsEndedOnBidsSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (uint256)
    {
    ...
    function isSoldOnBidsSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (bool)
    {
    ...
    function isSoldOnFixedSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (bool)
    {
    ...
    function timeIsListedOnBidsSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (uint256)
    {
    ...
    function timeIsListedOnFixedSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (uint256)
    {
    ...
    function OwnerofNFTinFixedSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (address)
    {
    ...
    function OwnerofNFTinBidsSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (address)
    {
    ...
    function LastOwnerofNFTinBidsSwap(address tokenContract, uint256 tokenId)
        public
        view
        returns (address)
    {
