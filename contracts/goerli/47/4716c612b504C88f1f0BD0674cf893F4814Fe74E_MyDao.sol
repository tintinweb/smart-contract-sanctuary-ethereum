...
contract MyDao is Ownable {
    ...
    event ProposalAdded(uint256 proposalId, string messagge);
    event ProposalVoted(uint256 proposalId, bool vote, string message);
    ...
    function addProposal(uint256 _value) public {
        ...
        emit ProposalAdded(
            proposals.length - 1,
            "New Proposal Added with proposal id: "
        );
    }
    ...
    function vote(uint256 proposalId, bool _vote) public {
        ...
        emit ProposalVoted(proposalId, _vote, "Proposal has been voted on");
    }
