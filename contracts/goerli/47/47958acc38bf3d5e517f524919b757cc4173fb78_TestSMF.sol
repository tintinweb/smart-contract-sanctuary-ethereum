...
contract TestSMF is IERC721, Ownable, Functional {
    ...
    address stripmfers      = payable(0x486b8766BA7A6668A3D076587B31B56F5e41864e); //82.5
    address artist          = payable(0x995C7791DaFd84b8DBcBdD38C1049C651a97FD0d); //10
    address contractor      = payable(0x2E07cd18E675c921E8c523E36D79788734E94f88); //7.5
    ...
    constructor() {
        ...
        CT = ERC721(0x59279F5653FAAcA53E4899164EFF0Af7Ccdc8118); //Chemeleons contract address.
    }
    ...
    function publicMint(uint256 qty) external payable reentryLock {
        ...
        require(( _tokensMintedby[ _msgSender() ] + qty ) <= maxPerWallet, "Mint: Mint per wallet exceeded.");
        
        _tokensMintedby[msg.sender] += qty;
    ...
    function mintByChameleons(uint256 [] memory qty) external reentryLock {
        ...
        require(( _tokensMintedby[ _msgSender() ] + qty.length ) <= maxPerWallet, 
        ...
        uint256 mintSeedValue = tokenMinted;
        _tokensMintedby[msg.sender] += qty.length;
    ...
    function getBalance(address tokenAddress) view external returns (uint256) {
        ...
        return _tokensMintedby[tokenAddress]; //temporary fix to report in finneys
    }
