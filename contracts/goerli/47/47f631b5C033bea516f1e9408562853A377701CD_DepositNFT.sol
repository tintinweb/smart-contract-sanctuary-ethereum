...
contract DepositNFT {
    ...
    constructor(uint8 _maxSupply, uint256 _depositPrice, uint8 _sellGoal, uint256 _decisionTime, address _bankOwner) {
        maxSupply = _maxSupply;
        depositPrice = (_depositPrice / 10) * (1 ether); //0.01 ether
        sellGoal = _sellGoal;
