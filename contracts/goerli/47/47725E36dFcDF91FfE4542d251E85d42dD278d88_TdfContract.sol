...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xFa007b0468377fEA9C5C89c056D44Fbaf3d75d3B];
  address public erc20Payable = 0xFa007b0468377fEA9C5C89c056D44Fbaf3d75d3B;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibodolzsvs6la7qjh6mq4jrbqvjqy2fmjh4xs4dosg5wpb3eykmeu/";
...
// File: contracts/TdfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TdfContract is RamppERC721A {
    constructor() RamppERC721A("TDF", "TDF"){}
}
