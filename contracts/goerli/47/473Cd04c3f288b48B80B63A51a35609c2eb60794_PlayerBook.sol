...
contract PlayerBook is OwnableUpgradeable {
    ...
    address public constant _usdt = 0x17469575B111d5B7bb0478465765ea978f05FE5b;
        ...
        internal
    {
        ...
        IERC20(_usdt).safeTransferFrom(msg.sender,address(this),stakeAmount);
        ...
        for(uint k=0;k<5;k++)
        {
            ...
            if(_position[affID][0] == 0)
            {
                continue;
            }
            for(uint e = 0;e<3;e++)
            {
                address rewardAddr1 = arrange[_position[affID][0] + 1][e];
                address rewardAddr2 = arrange[_position[affID][0] + 2][e];
                ...
                if(k < 3 && _position[affID][0] > 1)
                {
                    address rewardAddr3 = arrange[_position[affID][0] - 1][e];
