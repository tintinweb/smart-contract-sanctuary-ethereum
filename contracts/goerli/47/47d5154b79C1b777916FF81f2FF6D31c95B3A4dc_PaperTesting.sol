    ...
    ERC721A
{
    ...
    uint256 public constant PRICE_PER_TOKEN = 0.0009 ether;
    ...
    constructor(address payable shareholderAddress_)
        ERC721A("Paper Testing", "PaperTesting")
        WCNFTToken()
    {
    ...
    function mintPaper(address _address, uint256 numberOfTokens)
        external
        payable
        isPublicSaleActive
        supplyAvailable(numberOfTokens)
 ...
 */
contract WCNFTToken is WCNFTAccessControl, ERC2981 {
    constructor() {
        // set up roles
