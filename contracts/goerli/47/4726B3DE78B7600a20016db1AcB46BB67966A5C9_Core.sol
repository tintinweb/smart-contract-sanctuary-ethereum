...
contract Core is OwnableUpgradeable, ICore {
    ...
    function resolveCondition(uint256 _oracleCondId, uint256 _outcomeWin)
        ...
        onlyOracle
    {
        uint256 conditionId = oracleConditionIds[msg.sender][_oracleCondId];
    ...
    function cancelByOracle(uint256 _oracleCondId) external onlyOracle {
        cancel(oracleConditionIds[msg.sender][_oracleCondId], _oracleCondId);
    }
