...
contract KanjiChild is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public totalPublicSale = 1949;
    ...
    constructor() ERC721A("KanjiChild", "KJC") {
    ...
    function mint(uint256 count) external payable {
        ...
        require(totalSupply() + count <= maxSupply, "No more Kanji");
