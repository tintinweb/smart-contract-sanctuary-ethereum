...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x40E2e2D57cf283e7BfD4B23605B4E5027C664C95];
  address public erc20Payable = 0x40E2e2D57cf283e7BfD4B23605B4E5027C664C95;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 12) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdZYiUs1mX33p4X5HrurM3fbQsvPY2HhD2aJr7SrRsH9S/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/jX1jJIR2k4gkFBUcPgPs/contract-metadata";
  }
...
// File: contracts/TestmonContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestmonContract is RamppERC721A {
    constructor() RamppERC721A("Testmon", "Testmon"){}
}
