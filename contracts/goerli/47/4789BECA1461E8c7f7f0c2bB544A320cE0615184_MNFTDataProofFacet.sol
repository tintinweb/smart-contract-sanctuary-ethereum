...
// File: contracts/facets/DataProofFacet.sol
...
contract MNFTDataProofFacet {
    ...
    function addNewHistory(bytes32 newDataProof) external {
        ...
        DataProofStorage storage dps = getDataProofStorage();
        dps._dataProofHistory.push(newDataProof);
