 ...
 * @notice This contract handles minting TEST Collection tokens.
 */
contract LaunchpadTESTCollection is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x02F58621596DA9CC0E8f64E10F0255b4491338cA;
    address public royaltyAddress = 0xDfE9102A2C14Ee955c648acBff92df64Ae55243B;
    address[] public payoutAddresses = [
        0xDfE9102A2C14Ee955c648acBff92df64Ae55243B
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibleomnkdd7jcynadmm3n5m7syst3dblq7pwg6wr3aotp3pbsiwma/";
    ...
    constructor() ERC721A("TEST Collection", "TEST") {
