...
contract WorldMiss is ERC721A, ReentrancyGuard, IERC721Receiver, Ownable {
    ...
    constructor(address _nft_address, string memory _name, string memory _symbol) ERC721A(_name, _symbol){
