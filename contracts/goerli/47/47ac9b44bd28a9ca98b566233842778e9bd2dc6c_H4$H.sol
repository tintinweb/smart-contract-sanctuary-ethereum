...
contract H4$H is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x758bdF4F525Aab212823670E2FF7bcB56B9C27Aa); 
    address payable private _marketingAddress = payable(0x758bdF4F525Aab212823670E2FF7bcB56B9C27Aa);
    ...
    uint256 public _maxTxAmount = 1000001 * 10**9; 
    uint256 public _maxWalletSize = 1000001 * 10**9; 
