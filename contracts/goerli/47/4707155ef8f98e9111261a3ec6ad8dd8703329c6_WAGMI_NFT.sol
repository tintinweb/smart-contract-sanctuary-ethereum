...
contract WAGMI_NFT is Ownable, ERC721AEnumerable {
    ...
    uint256 maxSupply = 102;

    string public constant WAGMI_PROVENANCE =
        "e561db26ef13b8a020691337de20a53862ca7a885709dd57efeb76bf24a5466c"; /// @dev Will be entered after all NFTs are genrated
    ...
    function batchMint(uint256 amount) external onlyOwner {
        require(
            ...
            "All NFTs for this phase are minted"
        );
