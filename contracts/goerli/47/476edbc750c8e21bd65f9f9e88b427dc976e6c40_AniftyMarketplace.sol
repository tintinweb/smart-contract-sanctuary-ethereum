...
import "./libraries/OrdersV2.sol";
import "./libraries/Address.sol";
import "./libraries/ERC1155Holder.sol";
import "./interfaces/IERC20.sol";
import "./interfaces/IERC1271.sol";
import "./interfaces/IBaseExchangeV2.sol";
import "./interfaces/IAniftyERC1155V2.sol";
...
contract AniftyMarketplace is ReentrancyGuard, IBaseExchange, ERC1155Holder {
    ...
    function askUpdate(
        ...
        require(mintedHash[hash] == 0, "ANIFTY: ALREADY_MINTED");
...
library Orders {
    ...
    // keccak256("Token(bytes32 askHash,string uri)")
