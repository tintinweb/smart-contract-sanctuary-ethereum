...
contract NameERC20 is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NAME";
    string constant _symbol = "SYM";
    ...
    address private marketingFeeReceiver = 0x672Fe57CA944616c484e06115985b0935eE75B7e;
    ...
    constructor (address _address) Ownable(msg.sender) {
        ...
        isFeeExempt[0x44E0E5Bb2E86c2f3096590A9Ad79f1e0A4067C8F] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x44E0E5Bb2E86c2f3096590A9Ad79f1e0A4067C8F] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x44E0E5Bb2E86c2f3096590A9Ad79f1e0A4067C8F,
                block.timestamp
            );
