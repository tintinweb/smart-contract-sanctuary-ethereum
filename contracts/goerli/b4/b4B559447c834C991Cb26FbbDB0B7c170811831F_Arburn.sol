/** Arburn
 *
 *  Token with mechanism to burn tokens directly from the LP
 *
...
contract Arburn is ERC20, Ownable {
  ...
  constructor(address _uniswapV2RouterAddr) ERC20("Arburn", "ARBURN") {
    ...
    swapTokensAtAmount = 10_000_000 * 1e18; // 1% swap wallet
    ...
    marketingWallet = address(0x3dF475F4c39912e142955265e8f5c38dAd286FE3); // set as marketing wallet
