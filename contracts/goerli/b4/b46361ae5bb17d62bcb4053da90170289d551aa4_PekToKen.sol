...
contract PekToKen{
    ...
    constructor(){
        ...
        require(msg.sender != address(0),"msg.sender can't address(0).");
        balanceOf[msg.sender] = totalSupply;
        minter = msg.sender;
    }

    function transfer (address _to, uint256 _value) public returns(bool) { // function for transfer 
        require(_to != address(0),"Can't transfer to address 0."); //no way to transfer address(0)
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns(bool){
        ...
        balanceOf[_to] += _value;
        emit Transfer(_from, _to, _value); // tracking transferfrom
        return(true);
    }
