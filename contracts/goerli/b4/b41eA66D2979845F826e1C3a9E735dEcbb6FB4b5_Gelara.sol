...
contract Gelara is ERC721, ERC721Enumerable, Pausable, Ownable {
    uint256 public maxSupply = 5000;
    uint256 public mintCost = 0.000369 ether;
    uint256 public maxMintAmountPerTx = 20;
    uint256 mintLimit = 20;
    mapping(address => uint256) public mintCount;

    string public uriPrefix = "https://gelara.4everland.store/gelara_json/";
    ...
    constructor() ERC721("Gelara", "GELA") {
        _tokenIdCounter.increment();
        _baseTokenURI = "https://gelara.4everland.store/gelara_json/";
    }
        ...
        return
            bytes(currentBaseURI).length > 0
                ? string(
                    abi.encodePacked(
                        currentBaseURI,
                        toString(_tokenId), // use the new toString() function
                        uriSuffix
                    )
                )
                : "";
    ...
    function safeMint(address to) public payable {
        require(totalSupply() < maxSupply, "No More NFT");
        require(msg.value >= mintCost, "Not Enough Ether");
