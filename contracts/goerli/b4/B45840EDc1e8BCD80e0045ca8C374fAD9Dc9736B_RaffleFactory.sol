...
contract Raffle is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    // save all ticket buy address in raffleBox and all referral addresses in referralBox
    ...
    //                          the ETH will be send to the raffle creator, developer, manager and referral of the winning ticket
    ...
    // once a random number has been created by RNGesus, transfer the NFT to the winner and pay his friend, the developer and the manager
    ...
    // all player can request a refund after the raffle duration days has elapsed
