...
contract EnovateBank {
    ...
    function depositETH(uint _amount) payable public {
        require(msg.value>=0 && msg.value==_amount, 'Error, invalide amount');
    ...
    function withdrawETH(uint _amount) public {
        ...
        enovateToken.transfer(recipient, interest);

        emit Withdraw(msg.sender, _amount, depositTime, interest);
    }
    ...
    function payoff() public {
        ...
        uint tokensToBurn = totalTokensMinted[msg.sender]/2; // 50% Burn of minted tokens
