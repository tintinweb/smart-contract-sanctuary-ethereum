...
contract HKCStakingContract is OwnableUpgradeable, ERC721HolderUpgradeable {
    ...
    // Variables to allow tokens to mint into staking. Impossible to lock user staked tokens
    ...
    // Variables to manage contract managers
    ...
    /**
        Transfer without losing stakign totals.
     */
