...
contract ERC1155Contract is ERC1155, Ownable, PaymentSplitter {
    ...
    function claimTo(address _address, uint256 _quantity, uint256 _id) public payable onlyFiatMinter {
        uint16 _currentSupply = tokens[_id].totalSupply;
        require(tokens[_id].saleIsActive, "Sale inactive");
