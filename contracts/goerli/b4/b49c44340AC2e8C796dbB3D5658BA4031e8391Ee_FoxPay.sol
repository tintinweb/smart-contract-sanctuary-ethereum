...
contract FoxPayMetadataDescriptor is IERC3525MetadataDescriptor {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    _generateSVGMessage(giftMessage),
                    "</svg>"
                    /* solhint-enable */
                )
            );
    ...
    function _generateSVGMessage(
        ...
        return
            string(
                abi.encodePacked(
                    /* solhint-disable */
                    '<text fill="#535353" xml:space="preserve" style="white-space: pre" font-family="Arial" font-size="48" letter-spacing="0em">',
                    _generateSVGMessagePart(isLong ? giftMessage: giftMessage, '"618.455"'),
                    _generateSVGMessagePart(isLong ? giftMessage : "", '"676.455"'),
                    '</text>'
                    /* solhint-enable */
                )
            );
    ...
    function _generateSVGMessagePart(
        string memory giftMessage,
        string memory y
    ) internal pure returns (string memory) {
        return
