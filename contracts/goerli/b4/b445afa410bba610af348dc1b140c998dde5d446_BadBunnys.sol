...
contract BadBunnys is ERC721AQueryable, DefaultOperatorFilterer, Ownable, Pausable {
    ...
    constructor(string memory _initBaseURI, address _BADDIES, address _BTFD) ERC721A("BadBunny's", "BB") {
