...
contract TestCF is ERC721, Ownable, Functional {
    ...
    constructor() ERC721("",""){
        ...
        pricePublic = 20 * (10 ** 15); // Replace leading value with price 
        priceWhitelist = 10 * (10 ** 15);//
        maxMintPerTx = 20;       
        maxPerWallet = 20;
    ...
    function whitelistMint(uint256 qty) external payable reentryLock {
        ...
        require(whitelistUser[msg.sender] > 0, "Whitelist: Invalid User"); 
        require((qty + reservedTokens + tokenMinted) <= maxSupply, 
        ...
        require(tokenMintedby[msg.sender] + qty <= whitelistUser[msg.sender],
    ...
    */
    ...
    function getWhitelistToken() external view returns (uint256) {
        return whitelistUser[msg.sender];
    }
