...
//                                                                                                                                     //
//    contract NftFootball is ERC1155PresetMinterPauser{                                                                               //
//                                                                                                                                     //
...
//        ) public{                                                                                                                    //
//            require(hasRole(MINTER_ROLE, _msgSender()), "NftFootball: Only minters can create new NFT");                             //
...
//            require(tokenId < nonce, "NftFootball: Token ID should be less than nonce");                                             //
...
//            require(hasRole(MINTER_ROLE, _msgSender()), "NftFootball: Only minter can change the baseURI");                          //
//            baseURI = baseURI_;                                                                                                      //
//        }                                                                                                                            //
//                                                                                                                                     //
...
contract FWCLN is ERC721Creator {
    constructor() ERC721Creator("LEGENDS NFTs", "FWCLN") {}
}
