  ...
  LazyMintedCollection
{
   ...
   */
  function burn(uint256 tokenId) public override(ERC721BurnableUpgradeable, LazyMintedCollection) {
    super.burn(tokenId);
  }
  ...
  function mintCountTo(
    uint16 count,
    address to
  ) public override(INFTDropCollectionMint, LazyMintedCollection) returns (uint256 firstTokenId) {
  ...
  /**
   * @inheritdoc TokenLimitedCollection
   */
  function numberOfTokensAvailableToMint()
    public
    view
    override(INFTDropCollectionMint, TokenLimitedCollection)
    returns (uint256 count)
  {
    count = super.numberOfTokensAvailableToMint();
  }
 ...
 */
abstract contract LazyMintedCollection is AdminRole, MinterRole, SequentialMintCollection, CollectionRoyalties {
  /**
