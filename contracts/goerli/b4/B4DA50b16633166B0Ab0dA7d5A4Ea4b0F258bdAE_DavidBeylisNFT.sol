...
contract DavidBeylisNFT is ERC721, Ownable {
    ...
    mapping(address => uint256) public walletMints; //keep track of how many NFTs a wallet has minted
 
 
    constructor() payable ERC721('David Beylis NFT', 'DBN'){
