...
contract Arkonaut is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public maxPerWallet = 6000;
    uint256 public maxPerTransaction = 6000;
    uint256 public presaleMaxPerWallet = 6000;
    uint256 public presaleMaxPerTransaction = 6000;
    ...
    address[] public withdrawAddresses = [0x103B64F95D87769EBFec57C158925d89F80f84e5];
    uint256[] public withdrawPercentages = [100];

    bytes32 public merkleRoot = 0xc2f54ae42a6e504146f1c75fa510e66d18d2d115e5049fbed62b0d478773430b;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x58306Cb614315f9952909dc6506c4B73E5043694, _royaltyAmount);
    }
...
// SPDX-License-Identifier: MIT
// File @openzeppelin/contracts/utils/[email protected].7.3
