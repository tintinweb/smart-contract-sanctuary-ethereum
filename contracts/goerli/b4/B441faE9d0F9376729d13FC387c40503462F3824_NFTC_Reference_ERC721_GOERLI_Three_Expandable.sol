...
// Lifted from: https://github.com/ProjectOpenSea/operator-filter-registry/blob/main/src/IOperatorFilterRegistry.sol
 ...
 */
abstract contract ERC721A_NFTCExpandable is ExpandableTypedTokenExtension, ERC721A {
...
import './NFTC_Reference_ERC721_GOERLI_Three_ExpandableBase.sol';
import './NFTC_Reference_ERC721_GOERLI_Three_ExpandableSplitsAndRoyalties.sol';

// For goerli only
import '@nftculture/nftc-contracts-private/contracts/interfaces/IOperatorFiltererRegistry.sol';


/**
 * @title NFTC_Reference_ERC721_GOERLI_Three_Expandable
 */
contract NFTC_Reference_ERC721_GOERLI_Three_Expandable is NFTC_Reference_ERC721_GOERLI_Three_ExpandableSplitsAndRoyalties, NFTC_Reference_ERC721_GOERLI_Three_ExpandableBase {
    constructor()
        NFTC_Reference_ERC721_GOERLI_Three_ExpandableBase(
            'NFTC_Reference_ERC721_GOERLI_Three_Expandable',
            'NFTC_REF_721_G_3_E',
            'https://gateway.pinata.cloud/ipfs/', // TODO: Default Public Gateway
            addresses,
            splits,
            0.069 ether,
            0.069 ether,
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721A_NFTCExpandable, ERC2981)
        returns (bool)
    {
        return ERC721A_NFTCExpandable.supportsInterface(interfaceId) || ERC2981.supportsInterface(interfaceId);
    }
    ...
    // For goerli only, to confirm operator filterer impl.
    IOperatorFilterRegistry public constant OPERATOR_FILTER_REGISTRY =
        IOperatorFilterRegistry(0x000000000000AAeB6D7670E522A718067333cd4E);
    
    function checkSubscription(address addressToCheck) external returns (address) {
        return OPERATOR_FILTER_REGISTRY.subscriptionOf(addressToCheck);
    }

    function _getInitialFlavors() internal pure override returns (TokenFlavor[] memory) {
        TokenFlavor memory castaway = TokenFlavor(
            100100,
            .08 ether,
            15,
            0,
            'QmPRFj3EuWDj4ezYjuSob34aPen3DD9dxbmTA9aatz9EsP/token_100100'
        );

        TokenFlavor memory sharks = TokenFlavor(
            200100,
            .05 ether,
            100,
            0,
            'QmPRFj3EuWDj4ezYjuSob34aPen3DD9dxbmTA9aatz9EsP/token_200100'
        );

        TokenFlavor memory enlightened = TokenFlavor(
            300100,
            .02 ether,
            0, // Open Edition
            0,
            'QmPRFj3EuWDj4ezYjuSob34aPen3DD9dxbmTA9aatz9EsP/token_300100'
        );

        TokenFlavor[] memory initialFlavors = new TokenFlavor[](3);

        initialFlavors[0] = castaway;
        initialFlavors[1] = sharks;
        initialFlavors[2] = enlightened;
...
import '@nftculture/nftc-contracts-private/contracts/token/ERC721A_NFTCExpandable.sol';
...
/**
 * @title NFTC_Reference_ERC721_GOERLI_Three_ExpandableBase
 * @author @NFTCulture
 * @dev ERC721a Implementation with @NFTCulture standardized components.
 *
 * Public Mint is Phase Three.
 */
abstract contract NFTC_Reference_ERC721_GOERLI_Three_ExpandableBase is
    ERC721A_NFTCExpandable,
    Ownable,
    ReentrancyGuard,
    ...
    PhaseTwoIsIndexed
{
    ...
    constructor(
        ...
        ERC721A_NFTCExpandable(__name, __symbol)
        ...
        ExpandableTypedTokenExtension(true)
    {
        ...
        // TODO: Support OpenSea Operator Filterer.
    ...
    */
    function premintTokens(
        ...
        TokenFlavor memory updatedFlavor = _canMint(count, flavorId, false, 0);
    ...
    */
    function phaseOneMintTokens(
        ...
        _proofMintTokensOfFlavor_PhaseOne(msg.sender, proof, newBalance, count, flavorId, msg.sender);
    }
    ...
    */
    function phaseTwoMintTokens(
        ...
        _proofMintTokensOfFlavor_PhaseTwo(msg.sender, proof, newBalance, count, flavorId, msg.sender);
    }
...
contract NFTC_Reference_ERC721_GOERLI_Three_ExpandableSplitsAndRoyalties is ERC2981 {
    address[] internal addresses = [
        0x000000000000000000000000000000000000dEaD // TODO: Set NFTC_Reference_ERC721_GOERLI_Three_Expandable Wallet(s)
    ];

    uint256[] internal splits = [100]; // TODO: Set NFTC_Reference_ERC721_GOERLI_Three_Expandable Split(s)
