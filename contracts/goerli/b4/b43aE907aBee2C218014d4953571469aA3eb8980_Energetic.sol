...
contract Energetic is ERC721, Ownable, ReentrancyGuard {
    ...
    function generateOuterEnergy() private pure returns (string memory) {
        return
            string(
                abi.encodePacked(
                    SVG_RECT_OPENER,
    ...
    function generateInnerEnergy() private pure returns (string memory) {
        return
            string(
                abi.encodePacked(
                    SVG_CIRCLE_OPENER,
    ...
    function generateOuterEnergyGradient()
        private
        pure
    ...
    function generateInnerEnergyGradient()
        private
        pure
        returns (string memory)
    {
