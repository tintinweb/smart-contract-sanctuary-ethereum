...
contract Test09182 is Ownable, ERC721A, ReentrancyGuard {
  uint256 public maxPerTx = 20;
  uint256 public maxFree = 10;
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Test09182", "Test 09182", maxBatchSize_, collectionSize_) {
...
function publicSaleMint(uint256 quantity)  
  ...
  function withdraw() public payable onlyOwner {
    ...
    payable(address1).transfer(tenPercent);
