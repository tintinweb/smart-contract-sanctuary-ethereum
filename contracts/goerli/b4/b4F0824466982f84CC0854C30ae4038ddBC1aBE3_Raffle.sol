// Entr the lottery )( paying some amount => fund me )
// pick a random winner
// winnder to be selected every x minutes -> completely automted
// Chainlink oracle -> reandomanes, automated, exceuteion
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
     ...
     * they look to upkeeneded to be true orfalse
     * Follow should be true in order to be upkeep
     */
    ...
    /** overriden based on chianlink/contracts */
