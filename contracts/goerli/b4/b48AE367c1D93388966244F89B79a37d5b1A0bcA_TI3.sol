...
contract TI3 is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  string public uriPrefix = "ipfs://QmU9ucCYTYy4vaqywSeGhQehL28u2xB84Doqqgf6b6N5v1/";
...
// ATG Main Constructor
  ...
  function airdropTokens(address[] calldata wAddresses) public onlyOwner {
    require(totalSupply() + wAddresses.length <= maxSupply, "Max supply exceeded!");
