...
contract TomieByJunjiIto is ERC721A, Ownable, ReentrancyGuard, RoyaltiesV2 {
    ...
    uint256 public privateMintPrice = 0.05 ether;
    ...
    uint256 private maxMintsPublicPerTx = 3;
    ...
    // constructor() ERC721A("TomieByJunjiIto", "TomieByJunjiIto") {
    ...
    function publicMint(uint256 amount) public payable nonReentrant {
        ...
        require(maxMintsPublicPerTx >= amount, "sale: 3 maxper tx");
        require(
    ...
    function getWL(address _address) public view returns (uint256) {
