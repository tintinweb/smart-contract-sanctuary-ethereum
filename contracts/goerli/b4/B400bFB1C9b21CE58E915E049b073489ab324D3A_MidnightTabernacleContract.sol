...
// //                                                                                                 //
// //          oe          oe      cuuu....uK                                                         //
// //        [email protected] [email protected]      888888888       .xn!~%x.      .d``            ..    .     :        //
// //    ==*88888    ==*88888      8*888**"       x888   888.    @8Ne.   .u    .888: x888  x888.      //
// //       88888       88888      >  .....      X8888   8888:   %8888:[email protected]  ~`8888~'888X`?888f`     //
// //       88888       88888      Lz"  ^888Nu   88888   X8888    `888I  888.   X888  888X '888>      //
// //       88888       88888      F     '8888k  88888   88888>    888I  888I   X888  888X '888>      //
// //       88888       88888      ..     88888> `8888  :88888X    888I  888I   X888  888X '888>      //
// //       88888       88888     @888L   88888    `"**~ 88888>  uW888L  888'   X888  888X '888>      //
// //       88888       88888    '8888F   8888F   .xx.   88888  '*88888Nu88P   "*88%""*88" '888!`     //
// //       88888       88888     %8F"   d888"   '8888>  8888~  ~ '88888F`       `~    "    `"`       //
// //    '**%%%%%%** '**%%%%%%**   ^"===*%"`      888"  :88%       888 ^                              //
// //                                              ^"===""         *8E                                //
// //                                                              '8>                                //
// //                                                               "                                 //
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xc000F1c46f62872BaAB948eC6E8593c73C1C41D7];
  address public erc20Payable = 0xc000F1c46f62872BaAB948eC6E8593c73C1C41D7;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 1000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiey4f3rmde4uyqelhhmv6lqnueenmvdfej4nt4t3wanb5m2lcml2a/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7xrPTE1zoboJbSM25L5h/contract-metadata";
  }
...
// File: contracts/MidnightTabernacleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MidnightTabernacleContract is ERC721APlus {
    constructor() ERC721APlus("Midnight Tabernacle", "swag1159pm"){}
}