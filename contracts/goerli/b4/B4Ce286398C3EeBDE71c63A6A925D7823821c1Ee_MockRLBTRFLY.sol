...
// File contracts/mock/MockRLBTRFLY.sol
...
contract MockRLBTRFLY is ReentrancyGuard, Ownable {
    ...
    // 1 epoch = 1 week
    uint32 public constant EPOCH_DURATION = 15 minutes;
    // Full lock duration = 16 epochs
    uint256 public constant LOCK_DURATION = 4 hours;
