...
contract MNLTHRVLD is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    mapping (address => uint256) public skinsEquippedByAddr;
    ...
    function equipSkin(uint256 dunkId, uint256 vialId) public {
        ...
        address owner = ownerOf(dunkId);
        skinsEquippedByAddr[owner] = skinsEquippedByAddr[owner] + 1;
    ...
    function unequipSkin(uint256 tokenId) public {
        ...
        skinsEquippedByAddr[msg.sender] = skinsEquippedByAddr[msg.sender] - 1;
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override(ERC721, IERC721) {
        require(skinsEquippedByAddr[msg.sender] == 0, "Cannot approve while skins are equipped");
    ...
    function isApprovedForAll(address owner, address operator) public view virtual override(ERC721, IERC721) returns (bool) {
        return super.isApprovedForAll(owner, operator) && skinsEquippedByAddr[owner] == 0;
    }

    function getApproved(uint256 tokenId) public view virtual override(ERC721, IERC721) returns (address) {
        if (equippedSkin[tokenId] != 0) {
            return address(0);
        }
