...
contract PriceOracle is Ownable {
     ...
     * @param _assetTwo         Address of second asset in pair
     */
    function removePair(address _assetOne, address _assetTwo)
        external
        onlyOwner
    {
        require(
     ...
     */
    function editMasterQuoteAsset(address _newMasterQuoteAsset)
        external
        onlyOwner
    {
     ...
     */
    function _getDirectOrInversePrice(address _assetOne, address _assetTwo)
        internal
        view
     ...
     * @return uint256          Price of asset pair to 18 decimal precision (if exists, otherwise 0)
     */
    function _getPriceFromMasterQuote(address _assetOne, address _assetTwo)
        internal
        view
        returns (bool, uint256)
    {
     ...
     * @return uint256          Price of asset pair to 18 decimal precision (if exists, otherwise 0)
     */
    function _getPriceFromAdapters(address _assetOne, address _assetTwo)
        internal
        view
        returns (bool, uint256)
    {
     ...
     */
    function _calculateInversePrice(IOracle _inverseOracle)
        internal
        view
        returns (uint256)
    {
