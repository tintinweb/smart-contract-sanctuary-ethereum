...
contract WEBSEVENDOTSOL is ERC721, ERC721Enumerable, ERC721URIStorage/*, Ownable*/ {
    ...
    constructor() ERC721("WEBSEVENDOTSOL", "DOTSOL") {}


    // onlyOnwer function modifier provides restricted access for minting. With onlyOwner
    ...
    function safeMint(address to, string memory uri) public /*onlyOwner*/ {
        ...
        require(_tokenIdCounter.current() <= MAX_SUPPLY, "I'm sorry we have reached the cap");
