    ...
    IService
{
    ...
    /**
     * @dev Event emitted on Custom Proposal Contract Address
     * @param _address Custom Proposal Contract Address
     */
    event CustomProposalChanged(address _address);
    ...
    /**
     * @dev Set Custom Proposal Contract Address
     * @param _address Custom Proposal Contract Address
     */
    function setCustomProposal(address _address)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(
        ...
        customProposal = ICustomProposal(_address);
        
        emit CustomProposalChanged(_address);
    }
