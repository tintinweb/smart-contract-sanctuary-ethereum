...
contract MarsVegasNFT is ERC721A, ReentrancyGuard, Ownable {
  ...
  constructor(string memory hiddenUri) ERC721A("MarsVegasNFT", "MVN") {
  ...
  function currentMintStatus() public view returns (MintStatus) {
    return mintStatus;
  }
