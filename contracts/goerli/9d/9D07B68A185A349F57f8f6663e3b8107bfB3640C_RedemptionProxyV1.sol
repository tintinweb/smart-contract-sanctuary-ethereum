...
/// @title RedemptionProxyV1
/// @notice This contract allows for simplified creation and management of Balancer LBPs destinated to be Redemption pools
/// It currently supports:
/// - LBPs with 2 tokens
/// - Withdrawl of the full liquidity at once
/// - Having multiple fee recipients
contract RedemptionProxyV1 is Ownable {
    ...
    function updatePlatformAccessFeeBPS(uint256 newFee) external onlyOwner {
        require(newFee <= 10_000, "Fee cannot be greater than 10.000 (100%)");
        platformAccessFeeBPS = newFee;
    }
}
