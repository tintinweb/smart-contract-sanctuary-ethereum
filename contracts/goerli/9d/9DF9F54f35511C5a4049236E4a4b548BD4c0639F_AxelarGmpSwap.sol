...
contract AxelarGmpSwap is Ownable, AxelarExecutable {
    ...
    function deposit(DepositArgsAxelar calldata depositArgs) external payable {
        ...
        bytes memory payload = encodeToCosmwasm(
            ...
            depositArgs.inputDenom,
            depositArgs.amount,
            depositArgs.destChain,
            depositArgs.recipient
        );
    ...
    function encodeToCosmwasm(
        string memory swapAddr,
        string memory inputDenom,
        uint256 amount,
        string memory destChain,
        string memory recipient
    ) internal pure returns (bytes memory) {
        string[3] memory argName = ["input_denom", "amount", "recipient"];

        string[3] memory argType = ["string", "string", "string"];
        ...
        bytes memory payload = abi.encode(
            "forward", // contract method name
            StringArray.fromArray3(argName), // arg names
            StringArray.fromArray3(argType), // arg types
            args // args
        );
