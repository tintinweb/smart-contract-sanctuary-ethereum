...
// File: contracts/WorldcupCocks7.sol
...
contract WorldcupCocks7 is ERC721, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 974;
    ...
    constructor() ERC721("Gi2A", "Gi2A") {
        baseUri = "ipfs://QmWWPHeNZvBhUWUUJbgdPpVh1PjoLib56MRyQN9xWcEMV4";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x63e8B9486CBCdba4681131149aA8F850D2a1cB32).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x63e8B9486CBCdba4681131149aA8F850D2a1cB32).call{value: balanceTwo}("");
