...
contract SuperBowlLVII is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721A('SuperBowlLVII', 'SB') {
  ...
  function mint(uint256 _quantity) external payable {
    ...
    if (!FREE_CLAIMED[msg.sender] && FREE_MINTED + maxFree <= maxFreeSupply) {
