...
contract MembershipNFT is ERC721, Ownable, EIP712, ERC721Votes {
    ...
    constructor(string memory name, string memory symbol, uint256 supply) ERC721(name, symbol) EIP712(name, "1") {
        maxSupply = supply;
    }

    function mint(address to, uint256 amount) public onlyOwner {
		require(lastTokenId + amount <= maxSupply, "supply limit reached");
