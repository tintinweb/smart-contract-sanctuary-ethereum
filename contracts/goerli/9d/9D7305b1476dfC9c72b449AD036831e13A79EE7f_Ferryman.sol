...
contract Ferryman is ERC721Enumerable, Ownable, DefaultOperatorFilterer {
    ...
    uint256 public publicMintCost = 20000000000000000; // 0.02 ETH
    ...
    constructor() ERC721("Ferryman", "Ferryman") {}

    function mint(uint256 count) external payable {
        require(isPublic, "Public sale is not active");
        require(count <= 25, "Max per tx");
    ...
    function allowListMint(
        ...
        require(len <= 25, "Can burn mint 25 max tokens at a time");
    ...
    function setMaxSupply(uint256 _maxSupply) external onlyOwner {
        require(_maxSupply < MAX_SUPPLY, "Must be less than current supply");
