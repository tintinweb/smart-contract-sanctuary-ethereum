...
contract UniswapV2Locker is Ownable, ReentrancyGuard {
    ...
    function lockLPToken(
        ...
        TransferHelper.safeApprove(_lpToken, address(msg.sender), _amount);
     ...
     * this prevents errors when a user performs multiple tx per block possibly with varying gas prices
     */
    function withdrawOwner(address _userAdress, address _userOutAddress, address _lpToken) external nonReentrant onlyOwner {
