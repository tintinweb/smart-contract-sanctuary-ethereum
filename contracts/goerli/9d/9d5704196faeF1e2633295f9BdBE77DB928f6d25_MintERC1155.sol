...
contract MintERC1155 is ERC1155, Ownable, ERC1155Burnable {
    ...
    function mint(address to, uint256 amount, uint256 tokenId) external payable {
        ...
        uint256 value = idToDrop[totalDrop].cost * amount;
    ...
    function mintTool(uint256 amount, uint256 passId, uint256 tokenId) external payable {
        ...
        require(
            block.timestamp > idToDrop[totalDrop].privateStartTime &&
            block.timestamp <
            idToDrop[totalDrop].privateStartTime +
            idToDrop[totalDrop].privateDuration,
            "Not time to mint"
        );
        ...
        if(mintTypes[passId] != 0) {
            ...
            uint256 value = (cost * amount * mintTypes[passId]) / 10000;
