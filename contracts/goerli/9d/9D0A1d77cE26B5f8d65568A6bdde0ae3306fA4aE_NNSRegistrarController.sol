...
/*    constructor(NNS _nns, bytes32 _baseNode) ERC721("", "") {
    ...
    function initialize(NNS _nns, bytes32 _baseNode) initializer public {
...
interface INNSRegistrarController {
...
import {INNSRegistrarController, IPriceOracle} from "./INNSRegistrarController.sol";
...
/*    import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";
    ...
    function __xxx_init() internal onlyInitializing 
    {
        __xxx_init_unchained();
    }

    function __xxx_init_unchained() internal onlyInitializing {
    }
  */     
 ...
 */
contract NNSRegistrarController is
    Ownable,
    INNSRegistrarController,
    IERC165,
    ERC20Recoverable
{
    ...
    bytes32 private constant NFT_NODE = 0xb75cf4f3d8bc3deb317ed5216d898899d5cc6a783f65f6768eb9bcb89428670d;
...
/*    BaseRegistrarImplementation immutable base;
    ...
    uint public wlBegin; //time
    uint public wlEnd;   //time
    uint public pubBegin;//time
    ...
    {
        __NNSRegistrarController_init(_base,_prices,_minCommitmentAge,_maxCommitmentAge,_reverseRegistrar,_nameWrapper,_wlBegin,_wlEnd,_pubBegin);
    }    
    ...
    {
        __Ownable_init();
        __NNSRegistrarController_init_unchained(_base,_prices,_minCommitmentAge,_maxCommitmentAge,_reverseRegistrar,_nameWrapper,_wlBegin,_wlEnd,_pubBegin);
    }
    ...
    function setContractAddr(
        ...
        IPriceOracle _prices,
        ReverseRegistrar _reverseRegistrar,
        INameWrapper _nameWrapper) public onlyOwner {
        base = _base;
        prices = _prices;
        reverseRegistrar = _reverseRegistrar;
        nameWrapper = _nameWrapper;     
    ...
    event NewPriceOracle(address prices);
...
/*
    ...
    function commit(bytes32 commitment) public override {
        require(((block.timestamp>=wlBegin)&&(block.timestamp>=wlBegin))||(block.timestamp>=pubBegin),"Not begin");
    ...
    function renewWithFuses(
        ...
        bytes32 nodehash = keccak256(abi.encodePacked(NFT_NODE, labelhash));
        ...
        returns (bool)
    {
        return
            ...
            interfaceID == type(INNSRegistrarController).interfaceId;
    }
    ...
    function _setRecords(
        ...
        bytes32 nodehash = keccak256(abi.encodePacked(NFT_NODE, label));
...
import "../registry/NNS.sol";
import "../nnsregistrar/IBaseRegistrar.sol";
...
interface INameWrapper is IERC1155 {
    ...
    function nns() external view returns (NNS);
