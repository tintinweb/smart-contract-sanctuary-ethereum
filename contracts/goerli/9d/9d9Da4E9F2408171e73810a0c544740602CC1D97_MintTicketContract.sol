    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 200) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiab4vdoevaoab62d32xxlgzs3tnh6fl6aqn6ii5a3i7mu5hd4vlym/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/jG6Ybe96uaTS80jbakLs/contract-metadata";
  }
...
// File: contracts/MintTicketContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MintTicketContract is RamppERC721A {
    constructor() RamppERC721A("Mint Ticket", "MINTTICKET"){}
}
