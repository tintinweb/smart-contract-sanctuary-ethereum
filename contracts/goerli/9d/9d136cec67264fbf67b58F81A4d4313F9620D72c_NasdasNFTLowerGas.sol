...
contract NasdasNFTLowerGas is ERC721, Ownable, IPaperCompatibleInterface {
  ...
  string private _uriPrefix = "ipfs://Qmeisb56Q5NHfbtAzSBgDiSm9mrF5KwNg4iSLa2tGuBJrX/"; // TODO change to client's Pinata account
  address private _creator = 0x37b25D9D8Ad6C79ef8491fD7aa02d8c5B8072882;  // TODO change for new creators' fee wallet
  address private _firstOwner = 0x4ad46a12c658Ff6102C1b51dC0c4fa8f7E57890b;
  uint256 private _firstOwnerAmount = 3;  // TODO change to 330
  ...
  constructor() ERC721("NasDas Squad", "NDS") {
    setHiddenMetadataUri("ipfs://QmXs8nDWuDu6WGwRndk2f7CuxotEYGDrhX9MizEEGw4VKR/hidden.json"); // TODO change to client's Pinata account
