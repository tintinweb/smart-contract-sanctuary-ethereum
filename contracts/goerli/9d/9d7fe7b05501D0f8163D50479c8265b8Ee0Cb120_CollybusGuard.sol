...
// hevm: flattened sources of lib/guards/src/CollybusGuard.sol
// SPDX-License-Identifier: Unlicense AND AGPL-3.0-or-later AND Unlicensed
pragma solidity >=0.8.4 >=0.8.4 <0.9.0;
...
////// lib/guards/src/CollybusGuard.sol
/* pragma solidity >=0.8.4; */
