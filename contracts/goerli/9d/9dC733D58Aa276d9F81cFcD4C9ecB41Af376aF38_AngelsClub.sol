...
contract AngelsClub is ERC721, Ownable {
    ...
    uint256 public constant NFT_WHITELIST_PRICE = 0.01 ether;
    ...
    constructor(string memory tokenBaseURI, string memory mysteryURI) ERC721("AngelsClub", "ANGELSCLUB") {
        ...
        onlyOwner
    {
        ...
        require(totalSupply <= NFT_MAX, "OUT OF STOCK");
        require(totalSupply + tokenQuantity <= NFT_MAX, "EXCEED STOCK");
    ...
    function whitelistMint(uint256 tokenQuantity) external payable {
        require(totalSupply <= NFT_MAX, "OUT OF STOCK");
        require(totalSupply + tokenQuantity <= NFT_MAX, "EXCEED STOCK");
        require(tokenQuantity > 0, "INVALID TOKEN QUANTITY");
        require(presaleLive, "PRESALE CLOSED");
        require(NFT_WHITELIST_PRICE * tokenQuantity <= msg.value, "INSUFFICIENT ETH");
