...
contract DClinic {
    ...
    function createPatient(
        ...
        emit patientCreated(patiendId, name, age, dob, gender, p_address);
    ...
    function createDoctor(
        ...
        emit doctorCreated(doctorId, name, age, gender, d_address, specialization);
