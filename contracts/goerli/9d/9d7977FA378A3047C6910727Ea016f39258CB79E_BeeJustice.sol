...
// File: BeeJustice/beejustice.sol
...
contract BeeJustice is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Bee Justice ", "BJ") {}
    ...
    function setNFTCost(uint256 _price) public onlyOwner {
        cost = _price;
    }
