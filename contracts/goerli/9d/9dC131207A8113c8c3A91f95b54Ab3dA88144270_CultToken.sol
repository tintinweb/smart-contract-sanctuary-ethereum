...
contract CultToken is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 333000000 * 10 ** 18; //Total Supply
    ...
    uint256 public _maxWalletSize = 50000000000000000000 * 10 ** 9;
