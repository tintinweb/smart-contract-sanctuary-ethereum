...
abstract contract WithdrawInterface {
...
contract WithdrawRobot is AdminControl, Pausable, WithdrawFundsControl {
    // bytes32("joiiwithdrawrobot")
    bytes32 public constant contractType =
        0x6a6f69697769746864726177726f626f74000000000000000000000000000000;

    function withdrawFundsFromContract(address _contractAddress)
        external
        whenNotPaused
        adminRequired
    {
        WithdrawInterface joiiContract = WithdrawInterface(_contractAddress);
        require(
            joiiContract.contractType() ==
                0x6a6f6969746f6b656e636f6e7472616374000000000000000000000000000000,
            "Not a Joii contract"
        );
        joiiContract.withdrawFunds();
    }
