...
contract AlienStorage is Ownable, ReentrancyGuard {
    ...
    uint256[] oneOfOnes = [0,1,2,3,4,5,708,1421,2121,2988,3637,4200,4946,5560,6281,6969,7549,8181,8700,9425,9999,10719,11451,12104];
    ...
    function createPartnership (string calldata _partnershipName, uint256 maxMints) public onlyOwner {
    ...
    function updatePartnership(uint8 partnershipId, uint256 maxMints, bool allTokensCanEvolve) public onlyOwner {
    ...
    function getPartnershipInfo(uint8 partnershipId) public view returns (string memory, uint256, uint256, bool) {
        // partnershipName, maxMints, numMints
        return (partnershipName[partnershipId], partnershipMaxMints[partnershipId], partnershipMintCounter[partnershipId], partnershipOpen[partnershipId]);        
    }
