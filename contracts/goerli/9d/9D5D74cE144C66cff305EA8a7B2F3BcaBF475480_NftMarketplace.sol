...
contract NftMarketplace is ReentrancyGuard {
        ...
        isOwner(nftAddress, tokenId, msg.sender)
    {
        ...
        s_listings[nftAddress][tokenId] = Listing(price, msg.sender, buyer, false);
    ...
    {
        s_listings[nftAddress][tokenId].completed = true;
        ...
        nonReentrant
    {
        ...
        require(!s_listings[nftAddress][tokenId].completed, "Not available trade");
        
        s_listings[nftAddress][tokenId].buyer.push(msg.sender);
        s_listings[nftAddress][tokenId].completed = true;
        // send nft to address
