...
contract LynkCrowdsale is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
     ...
     */
    function initialize(address _oracle, address _usdt, address _usdc) external initializer {
