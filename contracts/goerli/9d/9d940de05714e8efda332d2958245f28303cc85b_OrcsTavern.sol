...
contract OrcsTavern is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public EXTRA_MINT_PRICE = 0.0033 ether;
    uint256 public MAX_SUPPLY_PLUS_ONE = 3333;
    uint256 public MAX_PER_TRANSACTION_PLUS_ONE = 4;
    bool public paused = true;
    string private baseUri;

    mapping(address => uint256) private _freeMintedCount;

    constructor() ERC721A("Orcs Tavern", "ORCS") {}
    ...
    function reserves(uint256 numToReserve) external onlyOwner {
        require(
            totalSupply() + numToReserve < MAX_SUPPLY_PLUS_ONE,
