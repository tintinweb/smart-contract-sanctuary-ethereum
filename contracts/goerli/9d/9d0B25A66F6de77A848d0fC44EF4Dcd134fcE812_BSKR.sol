...
contract BSKR is IERC20, Ownable, Manageable, Pausable {
        ...
        returns (uint256[] memory)
    {
        ...
        response[uint8(Field.tRfiFee)] =
            (tAmount * currFees[uint8(Fees.RfiFee)]) /
            feeDiv /
            _BIPS;
        response[uint8(Field.tBurnFee)] =
            (tAmount * currFees[uint8(Fees.BurnFee)]) /
            feeDiv /
            _BIPS;
        response[uint8(Field.tGrowthFee)] =
            (tAmount * currFees[uint8(Fees.GrowthFee)]) /
            feeDiv /
            _BIPS;
        response[uint8(Field.tPaydayFee)] =
            (tAmount * currFees[uint8(Fees.PaydayFee)]) /
            feeDiv /
            _BIPS;
        response[uint8(Field.tLPFee)] =
            (tAmount * currFees[uint8(Fees.LPFee)]) /
            feeDiv /
            _BIPS;
        response[uint8(Field.tTransferAmount)] =
            tAmount -
            ((tAmount * currFees[uint8(Fees.TotalFee)]) / feeDiv / _BIPS);
