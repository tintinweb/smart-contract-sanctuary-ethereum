...
abstract contract Defaults {
    ...
    string constant _name = "KRToken_E";
    string constant _symbol = "KITE";
...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(
            newOwner != address(0),
            "Ownable: new owner is the newOwner address"
        );
...
contract KRToken_E is Defaults, IERC20, Ownable {
    ...
    constructor() {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            ...
            //0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff // polygon mumbai
            //0x10ED43C718714eb63d5aA57B78B54704E256024E
            //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 // other option for bnb test net
            //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        ); //Mainnet & Testnet ETH
    ...
    function _transferFrom(
        ...
        if (
            ...
            require(cooldownTimer[recipient] < block.timestamp, "wait 1min");
