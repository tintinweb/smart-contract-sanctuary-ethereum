 ...
 * Parent contract: https://etherscan.io/address/0x71B11Ac923C967CD5998F23F6dae0d779A6ac8Af#code
 */
interface Super1155 {
...
contract Grill2 is Ownable, ERC1155Holder {
  ...
  Super1155 public immutable Parent;
  ...
  /// number of stakes added & removed by each account (this contract) ///
  ...
  /// each tokenId by index for an account (tokenId is 0 if stake is removed or not made yet) ///
  ...
  /// number of emission tokens earned be each account from removed stakes ///
   ...
   * @param staker The address who created the stake
  ...
  /**
   * Initializes contract instances and sets initial emission rate
  ...
  /**
   * Sets a proxy transferer for an account's tokens
   ...
   * @notice This function gives the contract owner the ability to whitelist any account as an
   * approved operator for any other account's tokens
   */
  ...
  /**
   * Removes a proxy transferer for an account's tokens
  ...
  /**
   * Sets new rate for earning emission tokens
  ...
  /**
   * Stake an array of tokenIds with this contract to earn emission tokens
   * @param tokenIds An array of tokenIds to stake
   * @param amounts An array of amounts of each tokenId to stake
   * @notice This function transfers tokenIds from the caller to this contract only if they
   * own each token
  ...
  /**
   * Remove an array of tokenIds staked in this contract and/or the old one
  ...
  /**
   * Helper function to set contract state when adding a stake to this contract
  ...
  function _addStake(address staker, uint256 tokenId) internal {
    /// @dev increment slots filled by staker and fill it (account => index => tokenId) ///
  ...
  /**
   * Helper function to set contract state when removing a stake from this contract
  ...
  function _removeStake(uint256 tokenId) internal {
    /// @dev copy the stake being removed ///
    ...
    /// @dev increment emissions earned by staker for removing this stake ///
  ...
  /**
   * Helper function to set contract state when emission changes occur
   * @param _seconds The number of seconds a token must be staked for to earn 1 emission token
  ...
  /**
   * Gets the number of stakes an account has active with the old contract
   * @param account The address to lookup
  ...
  /**
   * Count the number of emission tokens a timestamp has earned
  ...
  /**
   * Gets tokenIds for an account's active stakes
   * @param account The address to lookup
  ...
  /**
   * Gets tokenIds for an account's active stakes in the old contract
   * @param account The address to lookup
   * @return _ids Array of tokenIds
   */
  ...
  /**
   * Gets the number of emission tokens an account has earned from their active and removed stakes
   * @param account The address to lookup
  ...
  /**
   * Gets Stake object from the initial grill contract
