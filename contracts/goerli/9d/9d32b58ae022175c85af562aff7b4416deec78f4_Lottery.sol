...
// File: gist-1bb62664cfad04de04d9dc5d059eb519/SimpleChainlinkLottery.sol
...
contract Lottery is VRFConsumerBase{
     ...
     * Fee: 0.25 * 10 ** 18; or 250000000000000000 // 0.25 LINK
     */
    ...
    function enter() public payable{
        ...
        uint tickets = msg.value / .01 ether;
        
        for (uint i = 0; i < tickets; i++) {
            players.push(msg.sender); // push once per ticket
        }
    }

    function askChainlinkToPickWinner() public returns (bytes32) {
        require(
    ...
    function pickWinner(uint256 randomness) private{
        ...
        // pay 90% of pot to the winner
        payable (players[index]).transfer((address(this).balance * 9) / 10);
        // pay 10% of pot to manager
