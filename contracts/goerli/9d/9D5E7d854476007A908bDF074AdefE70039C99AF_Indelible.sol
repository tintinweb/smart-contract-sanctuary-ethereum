...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Energy", unicode"Accessory", unicode"Face", unicode"Screen", unicode"Head", unicode"Body", unicode"Background"];
    ...
    uint public publicMintPrice = 0.0025 ether;
    ...
    ContractData public contractData = ContractData(unicode"BYTES - Generative", unicode"Handle with care.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9d0217c7-06e4-477f-bb03-77bc6b27f084", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9d0217c7-06e4-477f-bb03-77bc6b27f084", "", 500, "0xAf7a60900bF698814B7D4F5E3995361F9CEE9150");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"BYTES - Generative", unicode"BYTES") {
        tiers[0] = [73,222,229,401,450,625];
        tiers[1] = [26,32,33,48,86,88,97,137,157,204,253,267,572];
        tiers[2] = [94,154,221,242,256,282,365,386];
        tiers[3] = [52,227,257,304,570,590];
        tiers[4] = [9,11,21,46,47,50,65,99,128,131,153,159,179,259,643];
        tiers[5] = [11,12,15,20,58,60,64,69,69,103,190,243,258,282,546];
        tiers[6] = [8,20,25,34,34,41,67,93,119,129,217,248,285,288,392];
