...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x4918CE2770326888D535aBd73dD54D7aEeA31cF8];
...
// File: contracts/MyMintplexProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MyMintplexProjectContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "My Mintplex Project";
    string public symbol = "MINTPLEX";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ycfm7DE6qXeV7WbWNnjL/contract-metadata";
  }
