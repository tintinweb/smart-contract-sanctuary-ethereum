...
contract BasicAMB is BasicBridge, VersionableAMB {
    ...
    bytes32 internal constant OTHER_SIDE_AMB = 0x7b2b0f3b2f2f9b2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f2f; // TODO set this to keccak256(abi.encodePacked("otherSideAMB"))
    bytes32 internal constant SUCCINCT_AMB = bytes32(0x2f3); // TODO set this to keccak256(abi.encodePacked("succinctAMB"))
    /**
...
contract MessageDelivery is BasicAMB, MessageProcessor {
    ...
    */
        ...
        returns (bytes32)
    {
        ...
        ISuccinctAMB(succinctAMB).send(otherSideAMB, castChainId, GAS_LIMIT, eventData);
