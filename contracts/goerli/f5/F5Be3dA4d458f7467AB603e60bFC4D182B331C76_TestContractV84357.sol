...
contract TestContractV84357 is ERC721A, Ownable, RevokableDefaultOperatorFilterer {
    using Strings for uint256;

    uint256 public maxSupply = 2222;
    uint256 public maxPublicSupply = 1800;
    ...
    constructor(string memory _initHiddenTokenURI) ERC721A("TestContractV84357", "TC") {
