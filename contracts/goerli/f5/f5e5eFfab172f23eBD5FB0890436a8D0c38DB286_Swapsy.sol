...
contract Swapsy is ReentrancyGuard, Ownable {
    ...
    function sellETH(
        ...
        require(amountIn == msg.value, "Swapsy: sell order failed");
    ...
    function _refund(uint256 id) internal {
        ...
        if (_swaps.tokenIn == address(0)) {
            (bool sent, ) = payable(_swaps.seller).call{value: _swaps.amountIn}(
                ""
            );
        ...
        emit Refund(_swaps.seller, _swaps.tokenIn, _swaps.amountIn, id);
    }
