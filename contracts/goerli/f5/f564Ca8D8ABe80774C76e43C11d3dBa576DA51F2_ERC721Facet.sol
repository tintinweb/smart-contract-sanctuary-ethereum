...
contract ERC721Facet is BaseFacet, ERC721Upgradeable, IERC2981, DefaultOperatorFiltererUpgradeable {
    ...
    */
        ...
        supplyAvailable(tokenIds.length)
    {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            if (
                IERC1155(_as.daodonCardAddress).balanceOf(
                    msg.sender,
                    tokenIds[i]
                ) > 0
            ) {
                IERC1155(_as.daodonCardAddress).safeTransferFrom(
                    msg.sender,
                    _as.daodonControllerAddress,
                    tokenIds[i],
                    1,
                    ""
                );
...
library LibDiamond {
    ...
    struct AppStorage {
        ...
        address daodonControllerAddress;
