    ...
    ReentrancyGuard
{
        ...
        returns (uint256)
    {
        ...
        payable(owner()).transfer(msg.value); // transfer the money to the owner of the contract
    ...
    function toggleForSale(uint256 _tokenId) public nonReentrant itemOwnerSchema(_tokenId) {
    ...
    function buyToken(uint256 tokenId) public payable nonReentrant buyTokenSchema(tokenId) {
    ...
    function burn(uint256 tokenId) public nonReentrant itemOwnerSchema(tokenId) {
        _burn(tokenId);
