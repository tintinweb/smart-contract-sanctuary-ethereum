...
import "./TooneyLootBox.sol";

/**v
 * @title TooneyEpicLootBox
 *
 * TooneyEpicLootBox - a tradeable EPIC loot box of Tooney.
 */
contract TooneyEpicLootBox is TooneyLootBox {
    
    constructor(address _factoryAddress, string memory _baseTokenURI, address _ownerAddress) 
        TooneyLootBox(_factoryAddress, _baseTokenURI, _ownerAddress) 
    {
        numberOfItemsPerBox = 11;
        price = 0.4 ether;
    }
