...
contract paninitest is ERC721A, Ownable {
    
    uint256 MAX_SUPPLY = 4000;
    uint256 Allremain = 4000;
    uint256 public mintRate = 0 ether;
    uint256 MintForWallet = 4000;
    string public base_URI = "";
    string public baseExtension = ".json";
    string public prerevealURL = ".json" ;
    ...
    constructor() ERC721A("BunnyKnights", "BK") {}
    ...
    /**
    *If you see this, congratulations,Remember, after 2000 will all be shadows,A knight must have a corresponding numbered shadow before it can be upgraded to a king.
    *If you paid for Bunny Knghts, and your corresponding shadow is free mint, I will help you snatch your shadow for free.
    *FUUUUUCK free mint.
    *Thats ALL.
    */
    ...
    /**
    *ALL right.
    *If you paid, please put one of the Bunny Knights list 0.03 and I'll buy it back with money from people who don't read the contract carefully and don't pay attention to safety.
    */
