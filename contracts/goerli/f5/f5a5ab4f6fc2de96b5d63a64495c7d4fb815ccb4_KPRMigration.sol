...
contract KPRMigration is Ownable, OperatorFilterer, ERC721 {
    using Strings for uint256;
    ...
    // Copied the baseURI from 0x05da517B1bf9999B7762EaEfa8372341A1a47559
    string public baseURI = "https://metadata.kprverse.com/metadata/";
    bool public operatorFilteringEnabled = true;

    constructor() ERC721("KPRMigration", "KPR") {
        _registerForOperatorFiltering();
    }

    /// @notice Owner-only function to airdrop tokens to users.
    /// @dev ERC721 is used here so tokenIds can match up 1:1 with the old contract.
