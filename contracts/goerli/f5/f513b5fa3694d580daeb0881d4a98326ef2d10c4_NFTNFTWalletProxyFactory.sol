...
contract NFTNFTWalletProxyFactory {
    ...
    function deployProxyWithNonce(
        ...
        bytes memory initializer = abi.encodeWithSelector(NFTNFTWallet.setOwner.selector, msg.sender);
        assembly {
...
contract NFTNFTWallet is CallbackHandler, ISignatureValidator {
    ...
    IWalletPolicy policy;
    address public owner;
    bool internal ownerSet;
    ...
    function setOwner(address _owner) public {
        require(!ownerSet, "Owner can only be set once");
        owner = _owner;
        ownerSet = true;
    }
