...
contract Retrogression is ERC721A, ReentrancyGuard, Ownable, ERC2981 {
  ...
  /**
   * @dev a function that check for whitelist user address and verify its proof
   */
  function _verifyWhitelist(bytes32 _leaf, bytes32[] memory _proof)
    internal
    view
    returns (bool)
  {
  ...
  /**
   * @dev a function that check for OG user address and verify its proof
   */
