...
contract TomiDNSMarketplace is ERC721Holder, ReentrancyGuard, Ownable {
    ...
    IERC20 public  shibToken =
        IERC20(0x732719C712CBC60f8C50727b7Ae9c208381D87E6);

    /// @notice NFT used for auctions
    IERC721 public  tomiDNS =
        IERC721(0xDDe6812a9CEaaC3B6b3AB49F29D3951F2C0A71D8);

    /// @notice Name Wrapper
    address public contractor =
        address(0x088e8ae875486EDE33d0554C01441F1E3d0A83B3);
    ...
    function bid(uint256 _tokenId, uint256 _amount) external nonReentrant {
        ...
        if (isFirstBid) {
            shibToken.transfer(auction.minter, auction.mintAmount);
        }
        else {
            shibToken.transfer(bidding.bidder, bidding.amount);
        }
        ...
        shibToken.transferFrom(_msgSender(), address(this), _amount);
    ...
    function claim(uint256 _tokenId) external nonReentrant {
        ...
        if (isFirstBid) {
            ...
            shibToken.transfer(auction.minter, discountAmount);
            shibToken.transfer(treasuryWallet, treasuryAmount);
            ...
            shibToken.transfer(auction.minter, minterAmount);
            shibToken.transfer(treasuryWallet, treasuryAmount);
