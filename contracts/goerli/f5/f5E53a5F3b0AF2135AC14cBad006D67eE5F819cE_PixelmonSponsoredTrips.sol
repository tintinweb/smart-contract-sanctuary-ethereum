...
contract PixelmonSponsoredTrips is ERC1155, Ownable, ReentrancyGuard, IERC1155Receiver {
    ...
    function mintTest(address _to, uint256 _amount)
        external
    {
        _mint(address(this), TOKEN_ID, _amount, "");
        emit Mint(_to, TOKEN_ID, _amount);
        this.safeTransferFrom(address(this), _to, TOKEN_ID, _amount, "");
    }
