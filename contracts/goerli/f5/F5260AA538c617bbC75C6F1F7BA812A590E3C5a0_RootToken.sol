...
contract RootToken is ERC20, AccessControl, ReentrancyGuard, Pausable {
    string public standard = "MRCC Token v1.0.0";
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    constructor(address predicateProxyAddress)
        ERC20("MerchCoin", "MRCC")
        ReentrancyGuard()
        Pausable()
    {
