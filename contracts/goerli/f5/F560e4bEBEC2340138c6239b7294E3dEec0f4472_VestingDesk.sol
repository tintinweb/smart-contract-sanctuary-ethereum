...
/**
 * @title Vesting Desk
 * @notice Implements Vesting mechanism for UUM
 */
contract VestingDesk is AdminUpgradeable, ReentrancyGuardUpgradeable{
    ...
    */
     ...
     * @param _uumAddress address of the ERC20 token contract
     */
    ...
    */
    function withdraw(uint256 amount)
        ...
        uum.safeTransfer(msg.sender, amount);
    }
    ...
    */
    function release(
        ...
        require(
            isBeneficiary || isAdmin(msg.sender),
            "only beneficiary and admin can release vested tokens"
        );
        uint256 vestedAmount = _computeReleasableAmount(vestingSchedule);
        ...
        uum.safeTransfer(beneficiaryPayable, amount);
    }
    ...
    */
    function getWithdrawableAmount()
        ...
        view
        returns(uint256){
        return uum.balanceOf(address(this)).sub(vestingSchedulesTotalAmount);
    }
