...
contract SeaportFractions
{
	fallback () external payable
	{
		assembly {
			...
			let result := delegatecall(gas(), 0x4666b3c762cC6E66F6d9351780556e386Baa07e0, 0, calldatasize(), 0, 0)
...
contract SeaportFractionsImpl is ERC721Holder, ERC20, ReentrancyGuard
{
	...
	address constant SEAPORT_ENCODER = 0x1bf53d6d3a633a0c90C408b67352AB60455f07C7;
