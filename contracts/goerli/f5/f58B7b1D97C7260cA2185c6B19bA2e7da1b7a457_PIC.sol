...
contract PIC {
    ...
    ISuperToken public immutable superToken = ISuperToken(0xF2d68898557cCb2Cf4C10c3Ef2B034b2a69DAD00);
    IERC20 public immutable erc20Token = IERC20(0xF2d68898557cCb2Cf4C10c3Ef2B034b2a69DAD00);
    TOGA public immutable tOGA = TOGA(0xa54FC15FC75693447d70a57262F37a70B614721b);

    /**
     * Contract initialization.
     */
    //constructor(ISuperToken _superToken, TOGA _tOGA) {
    // constructor(ISuperToken _superToken, TOGA _tOGA) {
    //     superToken = _superToken;
    //     tOGA = _tOGA;
    // }

    function becomePIC() public {
        superToken.send(address(tOGA), 560000000000000000000, "0x");
    }

    function transferERC20() public {
        erc20Token.transfer(0xbC3baa45AAd1e14ADA4cCA3cEaC07b18c5Dd438e, 10000000000000000000);
    }
}