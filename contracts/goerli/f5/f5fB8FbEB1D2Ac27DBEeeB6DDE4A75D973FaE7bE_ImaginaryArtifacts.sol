    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public constant MAX_SUPPLY_PER_ARTIFACT = 8908;
    ...
    function updateIDsForMerge(uint256[] memory _ids) external onlyOwner {
        idsForMerge = _ids;
    }
    ...
    function claim(
        ...
        if (!MerkleProof.verify(_merkleproof, merkleRoots[_id], leaf))
    ...
    function merge(address _account, uint256[] memory _amounts)
        external
        nonReentrant
    {
