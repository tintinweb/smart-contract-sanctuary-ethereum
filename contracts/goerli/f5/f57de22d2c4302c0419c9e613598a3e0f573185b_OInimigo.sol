...
contract OInimigo is DefaultOperatorFilterer, ERC721A, Ownable {
    ...
    uint256 private supplyTotalHolders = 30;
    
    uint256 private supplyTotalBadList = 10;
    ...
    function mintPublic(
        ...
        if (onlyWhitelisted) {
            require(isValid(proof, keccak256(abi.encodePacked(endUser))), "Nao faz parte da Waitlist");
        }
