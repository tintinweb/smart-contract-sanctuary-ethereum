...
contract StoreManager is Initializable, ERC1155Vote, OwnableUpgradeable, UUPSUpgradeable{
    Store public store;
    ...
    function initialize(Store memory _store) public initializer {
        store = _store;
    ...
    // TODO: Change Owner to DAO governance
