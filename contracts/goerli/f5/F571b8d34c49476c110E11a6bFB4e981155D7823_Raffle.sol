...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        i_usdEntranceFee = usdEntranceFee;
    ...
    function enterRaffle() public payable {
        // require(msg.value >= i_usdEntranceFee, "Not enough value sent");
        // require(s_raffleState == RaffleState.OPEN, "Raffle is not open");
        if (msg.value < getEntranceFeeInWei()) {
    ...
    function getEntranceFeeInWei() public view returns (uint256) {
        ...
        uint256 convertedEntranceFee = uint256(i_usdEntranceFee * 10**36) / adjustedPrice;
