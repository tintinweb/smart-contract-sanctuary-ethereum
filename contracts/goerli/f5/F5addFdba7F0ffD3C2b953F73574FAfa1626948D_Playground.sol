// SPDX-License-Identifier: MIT
    ...
    contract Playground is ERC721, Ownable, ReentrancyGuard {
        ...
        constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet, string memory _initNotRevealedUri) ERC721("Playground", "PG") {
