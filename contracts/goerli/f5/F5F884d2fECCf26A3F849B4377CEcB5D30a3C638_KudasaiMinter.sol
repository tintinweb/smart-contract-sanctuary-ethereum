...
contract KudasaiMinter is Ownable {
    ...
    constructor(uint256 maxWalletPerToken_, address onchainKudasai_, address kudasaiNFT_, address ticketNFT_, address hidden_, bytes32 kudasaiListMerkleRoot_) {
