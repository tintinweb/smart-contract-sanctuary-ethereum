...
contract AdvancedCollectible is ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    // best pratice: after doing a mapping, we should emit an event
    ...
    function fulfillRandomWords(
        ...
        uint256 randWord = _randomWords[0] + _randomWords[1];
        Breed breed = Breed(randWord % 3);
    ...
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public {
        // 3 tokenuri for pug shiba_inu, st bernard
        require(
