...
contract OURGATEWAYGenesisWrapper is Ownable{
  ...
  function setCardAddress(address _cardContract) public onlyOwner {
    cardContract = _cardContract;
  }

  function setKeyPassAddress(address _keyPassContract) public onlyOwner {
    keyPassContract = _keyPassContract;
  }
