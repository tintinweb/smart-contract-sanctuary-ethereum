...
// IMintableERC721 required?

contract RootMetaJuiceCollection_Copper is ERC721URIStorage, AccessControl {
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");
    constructor(string memory name_, string memory symbol_, address mintableAssetProxy) ERC721(name_, symbol_) {
