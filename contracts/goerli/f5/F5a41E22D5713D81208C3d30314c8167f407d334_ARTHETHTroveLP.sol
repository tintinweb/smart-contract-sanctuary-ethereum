...
contract ARTHETHTroveLP is StakingRewardsChild, MerkleWhitelist {
    ...
    function withdraw(
        ...
        uint256 arthAmountOut = isARTHToken0 ? amount0 : amount1;
        uint256 ethAmountOut = isARTHToken0 ? amount1 : amount0;

        // 4. Check if the ARTH we received is less.
        if (arthAmountOut < position.debt) {
            revert("this is where it's coming");
            ...
            IUniswapV3SwapRouter.ExactOutputSingleParams memory params = IUniswapV3SwapRouter
                .ExactOutputSingleParams({
                    ...
                    amountInMaximum: ethAmountOut,
                    sqrtPriceLimitX96: 0
                });
            uint256 ethUsed = uniswapV3SwapRouter.exactOutputSingle{value: ethAmountOut}(params);
