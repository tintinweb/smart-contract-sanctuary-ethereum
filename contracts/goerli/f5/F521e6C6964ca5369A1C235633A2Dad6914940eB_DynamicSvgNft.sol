...
contract DynamicSvgNft is ERC721, Ownable {
    ...
    constructor(string memory _lowSvg, string memory _highSvg, address _priceFeedAddress) ERC721("DynamicNFT", "DNFT") {
        s_tokenCounter = 0;
    ...
    // convert svg to URI with Base64 encoding -- data:image/svg+xml;base64,<encoded string>
