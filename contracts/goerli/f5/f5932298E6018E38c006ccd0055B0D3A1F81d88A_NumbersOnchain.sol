...
contract NumbersOnchain is ERC721Enumerable, Ownable {
    ...
    function getSeed(uint256 tokenId) public view returns (uint256) {
        require(_exists(tokenId), "Number does not exist.");
...
function generateSeed(uint256 tokenId) private view returns (uint256) {
    ...
    uint256 seed = (r >> 48) % 11 + 10; // generate a seed value between 10 and 20
    uint256 topSeed = seed;
    seed = (r >> 96) % 11 + 10; // generate a new seed value between 10 and 20
    uint256 indexSeed = seed;
    seed = (r >> 144) % 11 + 10; // generate a new seed value between 10 and 20
    uint256 bodySeed = seed;
    seed = (r >> 192) % 11 + 10; // generate a new seed value between 10 and 20
    uint256 footerSeed = seed;
