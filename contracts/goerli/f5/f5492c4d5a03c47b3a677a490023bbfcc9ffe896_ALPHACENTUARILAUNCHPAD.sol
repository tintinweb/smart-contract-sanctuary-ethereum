...
contract ALPHACENTUARILAUNCHPAD is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public REWARD = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6;
    ...
    mapping(address => bool) isSwapThresholdExempt;
    ...
    uint256 public maxWalletTokens = (_totalSupply * 2000) / 10000; 
    uint256 public maxTxAmount = (_totalSupply * 1000) / 10000; 
    ...
    constructor() {
        ...
        isSwapThresholdExempt[owner()] = true;
        isSwapThresholdExempt[pair] = true;
        isSwapThresholdExempt[address(this)] = true;

        marketingFeeReceiver = 0xc586dEe88d1b71d526eD80b6e0fA32B849EeA538;
    ...
    function _transferFrom(
        ...
        if (!isSwapThresholdExempt[sender]) {
            require(amount <= swapThreshold, "Swap  Transaction Amount exceed");
        }
    ...
    function setIsMaxTxExempt(address holder, bool exempt) external onlyOwner {
     ...
     function setIsSwapThresholdExempt(address holder, bool exempt) external onlyOwner {
        isSwapThresholdExempt[holder] = exempt;
    }
