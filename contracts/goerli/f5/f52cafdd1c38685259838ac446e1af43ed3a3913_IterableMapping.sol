...
contract DipDetectorBot is BEP20, LockToken {
    ...
    uint256 public swapTokensAtAmount = 50 * (10**18); //50. 
    ...
    address payable public _marketingWalletAddress = payable(0x314BfEbC283d6d79dD535D8A023705f0551A5C85);
    address payable public _buybackWalletAddress = payable(0x314BfEbC283d6d79dD535D8A023705f0551A5C85);
    ...
    constructor() BEP20("DipDetectorBot", "DIP") 
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x589634784Db8fE44d4DA8F9125642DA2e69e977F);
