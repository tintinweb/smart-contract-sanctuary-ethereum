...
import "./EuterpeMysteryBoxErrors.sol";
    ...
    ReentrancyGuard
{
    ...
    uint64 public constant MINT_LIMIT_PER_WALLET = 5000;
...
/**
 * @title Errors for Euterpe Mystery Box.
 */
abstract contract EuterpeMysteryBoxErrors {
    /**
