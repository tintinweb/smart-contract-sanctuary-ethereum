...
contract CreationHistory is ICreationHistory, TimelockAccess, IOperator, OwnableUpgradeable {
    ...
    mapping(uint256 => EnumerableSetUpgradeable.UintSet) private metaCellIdToNanoCellIds;
