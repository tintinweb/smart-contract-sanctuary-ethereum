...
contract DreamUpgrV1 is ERC721AQueryableUpgradeable, ERC721ABurnableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC2981Upgradeable {
  ...
  function devolve(uint256 _tokenId, uint256 stage) public onlyOwner {
    require(tokenStage[_tokenId] < stage, "De-evolution is not possible");
    tokenStage[_tokenId] = stage;
  }
