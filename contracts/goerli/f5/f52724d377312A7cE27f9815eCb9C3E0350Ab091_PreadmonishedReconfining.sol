...
/**
 * @title PreadmonishedReconfining
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract PreadmonishedReconfining is ERC20Permit, ERC20Capped, Pausable {
    address private _owner;

    constructor() ERC20("Preadmonished Reconfining","RIEI") ERC20Capped(1000000000 * (10**uint256(decimals()))) ERC20Permit("Preadmonished Reconfining") { 
        _owner = _msgSender();
     }
