...
contract Meeting is Events{
    ...
    function buyMeetingRoom(uint256 _roomId) external payable {
        ...
        meetingRoom[_roomId].owner = msg.sender;
       emit BuyMeetingRoom(msg.sender, _roomId,  meetingRoom[_roomId].price, "purchased");
...
contract Events{
    ...
    event BuyMeetingRoom(address sender, uint256 roomId, uint256 roomPrice, string status);
