...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    // we are using 'VRFConsumerBaseV2' and 'ERC721' for creating our constructor
    constructor(
    ...
    // it is the chain link node that calls this function, so 'msg.sender' would refer to the chainlink node
