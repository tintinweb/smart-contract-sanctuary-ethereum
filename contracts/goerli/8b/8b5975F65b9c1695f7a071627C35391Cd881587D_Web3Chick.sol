...
contract Web3Chick is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This will pay Web3Chick 5% of the initial sale.
    // By leaving the following lines as they are you will contribute to the
    // development of tools like this and many others.
    // =============================================================================
    (bool hs, ) = payable(0x729E614222f3555194430423f5028B1F527B8C00).call{value: address(this).balance * 5 / 100}('');
    require(hs);
    // =============================================================================
