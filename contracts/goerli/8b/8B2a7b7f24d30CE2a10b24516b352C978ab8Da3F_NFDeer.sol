...
contract NFDeer is ERC721AQueryable, Ownable, ReentrancyGuard, Pausable {
    ...
    string public hiddenMetadataUri =
        "https://global.mypinata.cloud/ipfs/QmZsn4Ff3stZtxHEMjppy5oWnUU2wh376WbAHJSbxrcBTC";
    ...
    function mintOwner(
        ...
        bytes32 token,
        uint256 amount
    ) public payable onlyOwner whenNotPaused mintCompliance(amount) {
    ...
    function teamMint(uint256 _teamAmount) external onlyOwner {
        require(
            totalSupply() + _teamAmount <= maxSupply,
            "Max supply exceeded!"
        );
