...
contract TokenTraxx is Context, AccessControlEnumerable, ERC20Pausable {
    ...
    string name_ = "TokenTraxx";
    string symbol_ = "TRAXX";
    uint8 decimals_ = 18;
    uint256 cap_ = 35000000000000000000000000000000;
    address initialAccount = _msgSender();
    uint256 initialBalance = 35000000000000000000000000;
    address initialAdmin = _msgSender();
    address initialMinter = _msgSender();
    address initialPauser = _msgSender();
