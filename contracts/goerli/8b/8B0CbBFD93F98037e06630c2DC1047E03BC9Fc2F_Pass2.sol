...
contract Pass2 is ERC721Enumerable, Ownable {
    ...
    string  public baseURI = "https://alphapasstest.mypinata.cloud/ipfs/";
    ...
    function mintNeon(address to) public payable {
        ...
        console.log("\tID for new Mint:", id);
        console.log("\tMinter:", _msgSender());
    ...
    function mintNoir(address to) public payable {
        ...
        // When Checking the owners this is what we do
        // This pulling out owner is messing up the gas estimation
        // address owner = _owners[id];

        _tokenURIs[id] = _noirMetadata;
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
      // So the problem is checking the exists!!!!
        ...
        require(keccak256(abi.encodePacked(_tokenURIs[_tokenId])) != keccak256(abi.encodePacked("")));
            ...
            // keccak256(abi.encodePacked((contactName))) == keccak256(abi.encodePacked((""))) ? getContactName(hash) : contactName,
      // return substring(string(abi.encodePacked("@", firstNames[pluck(hash,8,0x1F)], lastNames[pluck(hash,13,0x1F)])),0,16);
        // This must not be returning, but it actually already does seem to????
