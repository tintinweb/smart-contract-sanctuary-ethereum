...
contract Dena {
  ...
  constructor(
    ...
    require(
      ...
      "Dena::constructor: minting can only begin after deployment"
    );
  ...
  function setMinter(address minter_) external {
    require(
      msg.sender == minter,
      "Dena::setMinter: only the minter can change the minter address"
    );
  ...
  function mint(address dst, uint256 rawAmount) external {
    ...
    require(
      ...
      "Dena::mint: minting not allowed yet"
    );
    require(
      dst != address(0),
      "Dena::mint: cannot transfer to the zero address"
    );
    ...
    require(
      ...
      "Dena::mint: exceeded mint cap"
    );
    totalSupply = safe96(
      SafeMath.add(totalSupply, amount),
      "Dena::mint: totalSupply exceeds 96 bits"
    );

    balances[dst] = add96(
      balances[dst],
      amount,
      "Dena::mint: transfer amount overflows"
    );
  ...
  function transferFrom(
    ...
    if (spender != src && spenderAllowance != uint96(-1)) {
      uint96 newAllowance = sub96(
        spenderAllowance,
        amount,
        "Dena::transferFrom: transfer amount exceeds spender allowance"
      );
    ...
    returns (uint96)
  {
    require(
      ...
      "Dena::getPriorVotes: not yet determined"
    );
  ...
  function _transferTokens(
    ...
    require(
      src != address(0),
      "Dena::_transferTokens: cannot transfer from the zero address"
    );
    require(
      dst != address(0),
      "Dena::_transferTokens: cannot transfer to the zero address"
    );

    balances[src] = sub96(
      balances[src],
      amount,
      "Dena::_transferTokens: transfer amount exceeds balance"
    );
    balances[dst] = add96(
      balances[dst],
      amount,
      "Dena::_transferTokens: transfer amount overflows"
    );
    ...
    if (srcRep != dstRep && amount > 0) {
      if (srcRep != address(0)) {
        ...
        uint96 srcRepNew = sub96(
          srcRepOld,
          amount,
          "Dena::_moveVotes: vote amount underflows"
        );
      ...
      if (dstRep != address(0)) {
        ...
        uint96 dstRepNew = add96(
          dstRepOld,
          amount,
          "Dena::_moveVotes: vote amount overflows"
        );
  ...
  function _writeCheckpoint(
    ...
    uint32 blockNumber = safe32(
      block.number,
      "Dena::_writeCheckpoint: block number exceeds 32 bits"
    );
