...
contract WeLoveMP is ERC1155, Ownable {
    ...
    constructor()
        ERC1155("ipfs://QmP63ACyyHNsstHyt1ShhbN9gasYpHrErncUnUPPcDWJPd/1.json")
    {}
    ...
    function authorizeReceiver(address receiver, uint256 tokenId) public onlyOwner {
        authorizedReceivers[tokenId][receiver] = true;
    }

    function revokeReceiver(address receiver, uint256 tokenId) public onlyOwner {
        authorizedReceivers[tokenId][receiver] = false;
    }
