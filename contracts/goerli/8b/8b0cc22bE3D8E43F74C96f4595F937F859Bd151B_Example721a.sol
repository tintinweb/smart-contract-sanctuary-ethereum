...
contract Example721a is ERC721A, Ownable {
    ...
    string private baseUri = "https://bafkreifyb5jetemu2qf2pbid7246kvsumzsqim5z3jabr5zrb3fukh35ki.ipfs.nftstorage.link/";

    constructor() ERC721A("Example721a", "EX721A") {}
            
    // MODIFIERS

    modifier isCorrectPayment(uint256 _quantity) {
        require(msg.value >= cost * _quantity, "Incorrect ETH value sent");
        _;
    }
