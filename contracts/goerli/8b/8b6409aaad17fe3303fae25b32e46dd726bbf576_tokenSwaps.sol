...
contract tokenSwaps {
    ...
    function tokenOrCoinAToB(uint256 amount) public {
        ...
        require(token1.balanceOf(msg.sender) >= amount , "TokenSwaps::tokenAToB: tokenA not enough balance from owner");
    ...
    function tokenOrCoinBtoA(uint256 amount) public {
        ...
        require(token2.balanceOf(msg.sender) > amount , "TokenSwaps::tokenBToA: tokenB not enough balance from owner");
