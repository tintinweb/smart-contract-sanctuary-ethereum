...
contract PhotochromicCore is Ownable {
    ...
    /**
     * Removes the ticket for the given namehash.
     */
    ...
    function _burn(bytes32 node, bytes32 baseNode, bytes32 labelHash, address owner) internal {
     ...
     */
    function getTicketUserId() public view returns (string memory userId) {
...
contract PhotochromicRegistrar is ERC721Enumerable, Controllable {
    ...
    function burn(bytes32 labelHash, bytes32 baseNodeUser) public onlyController {
    ...
    function isUserIdAvailable(uint256 labelHash) public view returns (bool) {
