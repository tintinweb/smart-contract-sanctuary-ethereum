...
contract Number  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://bafybeiegxbc26wxoma4zv6fmuzb63egxd5czk4wtztlbvntxjiie25gxqy/";

    uint256 public immutable mintPrice = 0.003 ether;
    uint256 public immutable minFeel = 0.002 ether;
    uint32 public immutable maxSupply = 2200;
    ...
    constructor()
    ERC721A ("Number - CAL Edition", "Num") {
    }
    ...
    function safeMintToBlueChip(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
