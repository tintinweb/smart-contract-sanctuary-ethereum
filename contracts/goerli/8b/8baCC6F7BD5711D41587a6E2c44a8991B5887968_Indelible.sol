...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    ContractData public contractData = ContractData(unicode"Cute Kevin", unicode"1111 Cute Kevins ready to go out and take over the PFP scene. All on-chain, these little Kevins are too cute to burn. Once sold out, the first utility will be a weekly prize for holders. One Cute Kevin will be picked out at random and whoever holds that particular one will receive a large percentage of that weeks creator's earnings from secondary sales. The more you hold the better your odds!", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9e31b41a-3c49-49a6-a3be-11a5c91d0969", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9e31b41a-3c49-49a6-a3be-11a5c91d0969", "", 700, "0x42f575Ebe22D4be35fE9e5906C7736416D70e58E");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Cute Kevin", unicode"OCC") {
        tiers[0] = [15,50,80,91,100,138,148,149,170,170];
        tiers[1] = [130,150,166,200,209,256];
        tiers[2] = [10,20,30,41,60,65,80,100,105,200,200,200];
        tiers[3] = [110,224,324,453];
        tiers[4] = [50,100,200,761];
        tiers[5] = [29,61,139,157,220,247,258];
        tiers[6] = [10,15,60,100,100,100,107,120,124,175,200];
