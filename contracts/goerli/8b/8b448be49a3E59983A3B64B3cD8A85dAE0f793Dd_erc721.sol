...
contract erc721 is ERC721, ERC721URIStorage, AccessControl {
    ...
    modifier minterOrOwner() {
        require(
            ...
            "CALLER_MUST_HAVE_MINTER_ROLE"
        );
        _;
    }

    constructor() ERC721("CalibNFT", "NFT") {
    ...
    function mint(address recipient, string memory url)
        public
        minterOrOwner
        returns (uint256)
    {
