 ...
 * @notice This contract handles minting RAF Night Club tokens.
 */
contract RAFNightClub is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x34F7D7376b91E9dee4391Ed2D37EB834B7C08d46;
    ...
    address public royaltyAddress = 0x5dD6CE899C482bb4f88Cb1FdC92d6fc06629d520;
    address[] public payoutAddresses = [
        0x5dD6CE899C482bb4f88Cb1FdC92d6fc06629d520
    ];
    ...
    string public name = "RAF Night Club";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeia4uzgfhvejhuqf5vbb3lelhid2g3fk5xh4lxzt6wxjb2cokzpvqi/{id}"
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1673541001;
        tokenPublicSaleEndTime[1] = 1676156400;
        tokenUsePublicSaleTimes[1] = true;
        tokenPresaleMaxSupply[1] = 100;
        tokenPresalePrice[1] = 0.008 ether;
        tokenPresaleMintsPerAddress[1] = 1;
        tokenPresaleSaleStartTime[1] = 1673539201;
        tokenPresaleSaleEndTime[1] = 1673550000;
