...
contract TTTT is Ownable, IERC20 {
    ...
    function _transfer(
        ...
        if (
            swapEnabled && canSwap && !swapping && !automatedMarketMakerPairs[sender] && sender != address(uniswapV2Router) && sender != owner() && recipient != owner()
        ) {
            swapping = true;
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "DividendTracker";
    string private _symbol = "DividendTracker";
