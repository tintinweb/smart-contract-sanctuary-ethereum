...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Test Inu";
    string internal constant SYMBOL = "TiT";
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics, Test {
    using SafeMath for uint256;
...
abstract contract BaseToken is BaseRfiToken, Liquifier, Antiwhale {
    ...
    function _beforeTokenTransfer(address sender, address, uint256 amount, bool) internal override {
        ...
        if (!_isUnlimitedSender(sender)) {
            UserSpending memory spending = userSpending[sender];
