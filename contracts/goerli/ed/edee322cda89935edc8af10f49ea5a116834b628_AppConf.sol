...
contract AppConf is IAppConf, Ownable {
    ...
    address incenseToken;
    uint256 incenseAmount = 0;
    ...
    function setIncenseToken(address _incenseToken) public onlyOwner {
        incenseToken = _incenseToken;
    }

    function getIncenseToken() external view override returns(address) {
        return incenseToken;
    }

    function setIncenseAmount(uint256 _incenseAmount) external onlyOwner {
        incenseAmount = _incenseAmount;
    }

    function getIncenseAmount() external view override returns(uint256) {
        return incenseAmount;
    }
...
interface IAppConf {
    ...
    function getIncenseToken() external view returns(address);
    function getIncenseAmount() external view returns(uint256);
