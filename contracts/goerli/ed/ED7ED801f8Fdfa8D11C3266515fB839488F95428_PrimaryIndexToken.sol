...
contract PrimaryIndexToken is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    function withdraw(address projectToken, uint256 projectTokenAmount, address user, address beneficiar) public isProjectTokenListed(projectToken) nonReentrant {
        ...
        uint256 _totalOutstanding = actualLendingToken == address(0) ? 0 : totalOutstandingInUSD(user, projectToken, actualLendingToken) ;
    ...
    function supply(address lendingToken, uint256 lendingTokenAmount, address user) public isLendingTokenListed(lendingToken) {
    ...
    function redeem(address lendingToken, uint256 bLendingTokenAmount, address user) public isLendingTokenListed(lendingToken) {
        require(!lendingTokenInfo[lendingToken].isPaused, "PIT: lending token is paused");
    ...
    function redeemUnderlying(address lendingToken, uint256 lendingTokenAmount, address user) public isLendingTokenListed(lendingToken) {
        require(!lendingTokenInfo[lendingToken].isPaused, "PIT: lending token is paused");
        require(lendingTokenAmount > 0, "PIT: lendingTokenAmount==0");
    ...
    function borrow(address projectToken, address lendingToken, uint256 lendingTokenAmount, address user) public isProjectTokenListed(projectToken) isLendingTokenListed(lendingToken) {
        ...
        require(getPriceConvert(lendingToken, lendingTokenAmount) <= pitRemaining(user, projectToken, lendingToken), "PIT: lendingTokenAmount exceeds pitRemaining");
