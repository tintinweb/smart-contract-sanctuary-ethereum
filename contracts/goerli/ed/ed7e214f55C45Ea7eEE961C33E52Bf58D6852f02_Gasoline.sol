...
contract Gasoline is ERC721A, VRFConsumerBaseV2, AccessControl {
     ...
     */
    function allowlistMint(bytes32[] calldata _merkleProof) public payable {
    ...
    uint256 public constant NORMAL_MINT_WEIRDOS_COST = 2;
    uint256 public constant SUPER_MINT_WEIRDOS_COST = 5;
