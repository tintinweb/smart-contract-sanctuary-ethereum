...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x06ea83BCeE0e3eeFcfF982A7Dcf162136a947B63];
  address public erc20Payable = 0x06ea83BCeE0e3eeFcfF982A7Dcf162136a947B63;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifetl67nrgwdwdcyq5xwc4n7azxlj6yscmoaz3kjzht33bz2rbnoy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Gn0Hz0zQ3eRsfHhHjDF2/contract-metadata";
  }
...
// File: contracts/YslBeautyNightMastersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YslBeautyNightMastersContract is RamppERC721A {
    constructor() RamppERC721A("YSL Beauty Night Masters", "YSLB Night"){}
}
