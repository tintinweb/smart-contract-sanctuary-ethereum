...
contract OratisNFT is ERC721A, ERC721AQueryable, ERC4907A, Ownable, ReentrancyGuard {
	...
	// USD has 6 decimals so $1 = 1000000 so $100 = 100_000000
	uint256 public usdcPublicPrice = 100_000000;
	 ...
	 */
	function mint(bytes calldata signature, uint256 numTokens) external nonReentrant originalUser {
		...
		require(isValidSignature(msg.sender, signature), "HASH_FAIL");
		...
		paymentToken.transferFrom(msg.sender, address(this), priceInWei);
		...
		emit TokensMinted(msg.sender, numTokens, priceInWei);
	}
