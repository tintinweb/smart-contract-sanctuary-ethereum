	...
	UUPSUpgradeable
{
	...
	function mint(
		...
		uint64 addressMintedCount = _getAux(msg.sender);
		require(
			addressMintedCount + amount <= maxAmountForAddress,
		...
		_setAux(msg.sender, addressMintedCount + amount);
	...
	function teamMint(address to, uint8 amount)
		external
