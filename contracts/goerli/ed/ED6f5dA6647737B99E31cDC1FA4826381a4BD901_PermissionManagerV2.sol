 ...
 */
contract PermissionManagerV2 is AccessControlUpgradeable, PermissionManagerStorage {
    struct UserProxy {
        address user;
        address proxy;
    }
     ...
     */
    function assingTier1(address[] calldata _accounts) external onlyPermissionsAdmin {
     ...
     */
    function assingTier2(UserProxy[] calldata _usersProxies) external onlyPermissionsAdmin {
