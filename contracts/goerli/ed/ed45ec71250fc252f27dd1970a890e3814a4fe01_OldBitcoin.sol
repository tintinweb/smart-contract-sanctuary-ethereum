...
contract OldBitcoin is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x24CFD892205b2F3F7dc15a686DC71418C8691A2E); 
    address payable private _marketingAddress = payable(0x24CFD892205b2F3F7dc15a686DC71418C8691A2E);
