...
contract GovernorBravoDelegate is GovernorBravoDelegateStorage, GovernorBravoEvents {
    /// @notice The name of this contract
    string public constant name = "HiFi Governor Bravo";

    /// @notice The minimum setable proposal threshold
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 10000e18; // 50,000 HiFi

    /// @notice The maximum setable proposal threshold
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 100000e18; //100,000 HiFi

    /// @notice The minimum setable voting period
    uint256 public constant MIN_VOTING_PERIOD = 5; // About 24 hours

    /// @notice The max setable voting period
    uint256 public constant MAX_VOTING_PERIOD = 258; // About 2 weeks
    ...
    /// @notice The number of votes in support of a proposal required in order for
    /// a quorum to be reached and for a vote to succeed
    uint256 public constant quorumVotes = 10000e18; // 400,000 = 4% of HiFi
    ...
    function propose(
        ...
        require(
            hifi.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold || isWhitelisted(msg.sender),
     ...
     * Whitelist status allows accounts to propose without meeting threshold
    ...
    /**
     * @notice Admin function for setting the whitelistGuardian. WhitelistGuardian can
     * cancel proposals from whitelisted addresses
 ...
 */
contract GovernorBravoDelegateStorage is GovernorBravoDelegatorStorage {
