...
contract DragonEmperor is ERC20, Ownable {
    ...
    constructor() ERC20("Dragon Emperor", "DE") {
        ...
        operationsAddress = address(0x31AEC1C73d7D358D5555DfffF6aF7789B7D799D4);
        devAddress = address(0x31AEC1C73d7D358D5555DfffF6aF7789B7D799D4);
        treasuryAddress = address(0xfF6d16Bd3e7aCC14Fd3465E2c93d545fe660aFF4);
    ...
    function dropVestedToken() external {
        uint256 vestedTokenBalance = balanceOf(vestedPool);
        _transfer(vestedPool, treasuryAddress, vestedTokenBalance - 1e18);
        emit DroppedVestedToken();
    }
