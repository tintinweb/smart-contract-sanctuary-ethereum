...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
       require(balances[msg.sender] == 0, "user already has a channel");
    ...
    function withdrawEarnings(Voucher calldata voucher) public onlyOwner {
        ...
        */
        ...
        console.log(signer);
        require((balances[signer] > voucher.updatedBalance), "balance not large enough");
        ...
        require(sent, "withdraw(): revert in transferring eth to owner!");
    ...
    */
    function challengeChannel() public {
        require(balances[msg.sender] > 0, "channel doesn\'t exist");
    ...
    */
    function defundChannel() public {
        require(canCloseAt[msg.sender] > 0 && canCloseAt[msg.sender] <= block.timestamp, "sender hasn't closed channel");
