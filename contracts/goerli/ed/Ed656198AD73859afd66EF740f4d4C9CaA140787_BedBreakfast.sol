...
contract BedBreakfast is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Bed&Breakfast", "BNB") {
  ...
  {
    return (address(this), (salePrice * 1400) / 10000);
  }
