...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    function enterRaffle() public payable {
        // revert tx if the user does not have enough ETH to enter raffle
    ...
    function fulfillRandomWords(
        ...
        // this will always return a result within the amount of players than have entered
        // ie. if 5 players ender, it will return a number from 1-5
