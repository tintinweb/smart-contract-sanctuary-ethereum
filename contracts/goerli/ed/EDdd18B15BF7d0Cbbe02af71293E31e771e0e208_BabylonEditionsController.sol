...
contract BabylonEditionsController is Ownable, ICreatorExtensionTokenURI {
    ...
    function registerEdition(address creator, uint256 listingId, uint256 royaltiesBps, string calldata editionURI) external {
    ...
    function getEdition(uint256 listingId) external view returns (address) {
