...
contract SBUCKS is ERC20, Ownable {
    ...
    uint256 public constant PRESALE_SUPPLY = 278787878787 * 10 ** 18;

    /// 60% for LP and team
    uint256 public constant RESERVE_MAX_SUPPLY = 418181818181 * 10 ** 18;
    ...
    function setUniswapV2Pair(address _uniswapV2Pair) external onlyOwner {
        require(uniswapV2Pair == address(0), "Can only set pair once.");
