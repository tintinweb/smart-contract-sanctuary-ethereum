...
contract BucketAuction is ReentrancyGuard, AccessControl, Ownable {
    ...
    event NewAuctionActive(bool status);
    ...
    */
    function _internalMint(address to, uint256 numberOfTokens) internal {
        ...
        IERC721Mintable(erc721).mint{value: amount}(to, numberOfTokens);
    }
    ...
    */
    ...
    function updateStartAndEndBlocks(uint256 _startBlock, uint256 _endBlock) external onlyOwner {
        ...
        require(_startBlock < _endBlock || startBlock == 0, "New startBlock must be lower than new endBlock");
        require(block.number < _startBlock || startBlock == 0, "New startBlock must be higher than current block");
