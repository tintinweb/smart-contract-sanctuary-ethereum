...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Top", unicode"Accessory", unicode"Ear Accessory", unicode"Eyes", unicode"Nose", unicode"Mouth", unicode"Beard", unicode"Clothing", unicode"Body", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"The Appraisoors", unicode"The Appraisooors are Guardians of the Liquidity. These market makers fear nothing and have everything to gain. Do you really think dumping on them is a good idea? Think twice. The Appraisoors work and live on-chain.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/5f43969c-4ebc-4332-b0d3-1f50921d5d12", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/5f43969c-4ebc-4332-b0d3-1f50921d5d12", "", 500, "0x8358Fc2Dd62c00C1a9Cd0fCB577309A4cead2471");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"The Appraisoors", unicode"DN") {
        tiers[0] = [27,38,46,47,57,71,80,85,96,106,126,154,166,174,175,250,276,276,283,284,309,351,380,411,421,507,637,893,995,1066,1213];
        tiers[1] = [31,63,86,108,135,150,155,175,242,301,407,496,510,610,665,1176,1534,1543,1613];
        tiers[2] = [171,516,870,949,998,1158,1462,1473,2403];
        tiers[3] = [158,171,429,480,528,542,1086,1389,1532,3685];
        tiers[4] = [453,586,1340,1343,1587,1662,3029];
        tiers[5] = [688,710,1016,1462,2618,3506];
        tiers[6] = [907,1418,3265,4410];
        tiers[7] = [2,214,310,456,588,883,918,925,1250,4454];
        tiers[8] = [194,322,450,1057,2449,5528];
        tiers[9] = [11,47,56,70,107,126,184,196,236,237,253,261,262,279,294,301,318,328,425,491,509,667,798,1069,2475];
