...
contract DynamicSvgNft is ERC721 {
    ...
    mapping(uint256 => int256) public s_tokenIdToHightValue;
    ...
    function mintNft(int256 highValue) public {
        s_tokenIdToHightValue[s_tokenCounter] = highValue;
        ...
        returns (string memory)
    {
        ...
        if (price >= s_tokenIdToHightValue[tokenId]) {
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                name(),
                                '","description":"An Nft that change based on the Chainlink Feed"',
