...
contract AhegaoNightsTest4 is ERC721AQueryable, Ownable, ERC2981, ReentrancyGuard {
    ...
    mapping(uint256 => bool) public _tokensRevealedStatus;

    constructor() ERC721A("Ahegao Nights Test 4","AHNT4") {}
