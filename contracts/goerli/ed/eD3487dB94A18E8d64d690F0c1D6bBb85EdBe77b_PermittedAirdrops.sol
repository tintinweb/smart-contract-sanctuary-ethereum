 ...
 * @author
 * @dev Registry for airdropa supported by . Each Airdrop is associated with a boolean permit.
 */
contract PermittedAirdrops is Ownable, IPermittedAirdrops {
    ...
    constructor(
        ...
        require(
            _airdopContracts.length == _selectors.length,
    ...
    function setAirdroptPermits(
        ...
        require(
            _selectors.length == _permits.length,
            "setAirdroptPermits function information arity mismatch"
        );
     ...
     */
    function isValidAirdrop(bytes memory _addressSel)
        external
        view
        override
        returns (bool)
    ...
    function _setAirdroptPermit(
        ...
        require(
            ...
            "airdropContract is zero address"
        );
