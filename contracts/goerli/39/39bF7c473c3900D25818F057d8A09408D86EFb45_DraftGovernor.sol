...
contract DraftGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl, Ownable {

    mapping(uint256 => bool) public allowedProposals;

    address public preProposalTimeLockAddress;
    ...
    function allowProposal(uint256 proposalId) public {
        require(msg.sender == preProposalTimeLockAddress, "DraftGovernor: only preProposalTimeLockAddress can call this function");
        allowedProposals[proposalId] = true;
    }

    function setPreProposalTimeLockAddress(address _preProposalTimeLockAddress) public onlyOwner {
        preProposalTimeLockAddress = _preProposalTimeLockAddress;
    }
    ...
    returns (uint256) {
        ...
        require(allowedProposals[proposalId], "PreProposalGovernor: Proposal not allowed");
        return proposalId;
    }
