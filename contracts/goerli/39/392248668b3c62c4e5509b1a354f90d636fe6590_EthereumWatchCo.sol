...
contract EthereumWatchCo is ERC721, Ownable, ReentrancyGuard {
    ...
    function tokenURIJSON(uint256 _tokenId) private pure returns (bytes memory) {
        ...
        string memory html = string(abi.encodePacked(
            '<html><head><meta charset="utf-8"></head><body style="margin:0; padding:0; text-align:center; height:100vmin;display:flex;align-items:center;justify-content:center">',
            svg,
