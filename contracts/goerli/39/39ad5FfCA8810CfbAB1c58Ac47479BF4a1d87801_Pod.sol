...
contract Pod is ERC20Burnable, Operator {
  using SafeMath for uint256;

  // TOTAL MAX SUPPLY = 70,000 paws
  ...
  constructor(
    ...
    // _mint(msg.sender, 1 ether); // mint 1 Paw Share for initial pools deployment
    _mint(msg.sender, 100 ether); // mint 100 Paw Share for initial pools deployment
