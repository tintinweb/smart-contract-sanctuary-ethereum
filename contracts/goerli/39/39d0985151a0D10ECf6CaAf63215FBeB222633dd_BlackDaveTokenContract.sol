...
abstract contract WithdrawableV2 is Teams {
  ...
  address public erc20Payable = 0xD01D744Ae46b1B80ed908479B8e704Ebd8a53ad7;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmSwaoCtChxGuTqf6gWx8NE7fSVqjaree6teDGg4N2BF26/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/fBUAAzembp6JlSove4Ct/contract-metadata";
  }
...
contract BlackDaveTokenContract is RamppERC721A {
    constructor() RamppERC721A("Black Dave Token", "BDT"){}
}
