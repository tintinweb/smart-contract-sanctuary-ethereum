...
contract NFT is ERC721, Ownable{
    ...
    constructor() ERC721 ("baru", "baru"){ 
        //Base IPFS URI of the NFTs

        baseUri = "ipfs://bafybeidv5mucckmwox4jmbmhzkn4uirndlvo36dx3ydrebojl7lfa2yksi/";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require (_numTokens <= MAX_MINT_PER_TX, " You can only a maximum of 1 NFTs per transaction");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne,) = payable (0x9667Df98852D1F2b37fDbA11cd45c520d9C87d7b).call{value: balanceOne}("");
        (bool transferTwo,) = payable(0x9667Df98852D1F2b37fDbA11cd45c520d9C87d7b).call{value: balanceTwo}("");
