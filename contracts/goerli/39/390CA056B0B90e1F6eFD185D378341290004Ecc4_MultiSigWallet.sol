...
contract MultiSigWallet {
    ...
    function SummitMultiTransaction(address[] memory receivers, uint256[] memory amounts) public onlyOwner {
        uint txIndex = transactions.length;
        ...
        emit SubmitTransaction(msg.sender, txIndex, address(0), 0x0, "0x0");
    }
}