...
// ERC20FactoryFlat / ERC20Contract
...
contract ERC20Contract is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor(
        string memory name,
...
contract ERC20Factory is Ownable {
    ...
    function deployToken(string memory name, string memory symbol) public payable {
        ...
        // Deployment.
        token = new ERC20Contract(name, symbol);
