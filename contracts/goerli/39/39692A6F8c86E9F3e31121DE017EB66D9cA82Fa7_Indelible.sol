// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Eyes", unicode"Hat", unicode"Mouth", unicode"Ears", unicode"Clothes", unicode"Type", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"On-Chain Monkey Business", unicode"5000 On-Chain Monkeys, Remixed CC0, An access pass to on-chain innovations.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/fdacc73a-d8ed-4297-927b-7eb4cfabffe5", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/fdacc73a-d8ed-4297-927b-7eb4cfabffe5", "https://onchainmonkey.business/", 0, "0xEa3BC00e7FBe881D8D10931714Fa55Ba83E1c54F");

        constructor() ERC721A(unicode"On-Chain Monkey Business", unicode"OMB") {
            TIERS[0] = [32,102,112,121,148,158,161,180,192,217,3577];
            TIERS[1] = [1,12,14,29,30,38,42,47,49,51,56,57,63,64,66,68,71,73,73,76,79,84,90,90,98,99,101,108,109,109,115,119,127,130,133,135,139,141,147,148,150,164,198,199,199,207,602];
            TIERS[2] = [134,198,358,647,3663];
            TIERS[3] = [235,872,3893];
            TIERS[4] = [7,26,51,52,64,83,124,142,153,163,169,177,183,188,213,302,345,350,362,368,374,383,721];
            TIERS[5] = [75,121,281,363,550,664,867,944,1135];
            TIERS[6] = [801,810,827,834,856,872];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"On-Chain Monkey Business #");
