...
// Enter the lottery (paying some amont)
// pick a random winner (verifiably random)
// winner to be selected every x amount of minutes -> completly automate
...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    // 0.4.18 time interval current timestamp minus the last block timestamp
