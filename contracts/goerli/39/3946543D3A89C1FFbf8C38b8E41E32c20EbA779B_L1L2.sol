...
contract L1L2 {
    ...
    uint256 private CLAIM_SELECTOR = 897827374043036985111827446442422621836496526085876968148369565281492581228;
    uint256 private EvaluatorContractAddress = 0x595bfeb84a5f95de3471fc66929710e92c12cce2b652cd91a6fef4c5c09cd99;
    ...
    function triggerex2(uint256 from_address, uint256 l2_user) public {
        uint256[] memory sender_payload = new uint256[](2);
        sender_payload[0] = uint256(uint160(msg.sender));
