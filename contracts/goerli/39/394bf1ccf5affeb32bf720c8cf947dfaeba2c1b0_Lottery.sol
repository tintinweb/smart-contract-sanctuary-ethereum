...
contract Lottery is VRFConsumerBaseV2, ConfirmedOwner {
  ...
  function randomBalls() external returns (uint8[5] memory balls) {
    ...
    validateBalls(balls[0],balls[1],balls[2],balls[3],balls[4]);
    delete ballBag;
    return balls;
  }
  ...
  //   balls = randomBalls();
  //   drawMap[currentDrawNumber] = balls;
