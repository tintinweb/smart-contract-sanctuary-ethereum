...
contract ApexConsumerWrapper is ChainlinkClient, Ownable, Pausable {
    ...
    function fulfillMetaData(
        ...
        consumer.fulfillMetaData(_requestId, _event_id, _bet_type, _event_name, _qualifying_start_time, _race_start_time);
    }
    ...
    function fulfillMatchup(
        ...
        consumer.fulfillMatchup(_requestId, _betTypeDetail, _probA, _probB, _probC, _probD, _timestamp);
    }
