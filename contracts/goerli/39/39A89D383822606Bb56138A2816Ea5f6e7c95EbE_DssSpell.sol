...
contract DssSpellCollateralAction {
    ...
    function onboardRwa008(
        ...
        RwaOutputConduitLike_2(RWA008_A_OUTPUT_CONDUIT).hope(RWA008_A_OPERATOR);
...
contract DssSpellAction is DssAction, DssSpellCollateralAction {
    ...
    function wipeFromRWA009Urn() internal {
        // wipe DAI
        RwaUrnLike_1(RWA009_A_URN_OLD).wipe(RWA009_DRAW_AMOUNT);

        // free old RWA009 Token from the URN
        RwaUrnLike_1(RWA009_A_URN_OLD).free(1 * WAD);
    }
