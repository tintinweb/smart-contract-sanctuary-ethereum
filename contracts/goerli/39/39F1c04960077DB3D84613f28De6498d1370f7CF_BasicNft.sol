...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        console.log("approve was called");
        ...
        console.log("msg.sender was owner", msg.sender, owner);

        _approve(to, tokenId);

        console.log("_approve was called");
    ...
    function getApproved(uint256 tokenId) public view virtual override returns (address) {
        ...
        console.log("getApproved: ", _tokenApprovals[tokenId]);
    ...
    function _safeMint(address to, uint256 tokenId) internal virtual {
        console.log("ERC721 _safeMint started");
        console.log("ERC721 _safeMint to: ", to);
        console.log("ERC721 _safeMint tokenId ", tokenId);

        _safeMint(to, tokenId, "");

        console.log("ERC721 _safeMint ended");
    }
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        console.log("_approve started");
        console.log("_approve to: ", to);
        console.log("_approve tokenId: ", tokenId);

        _tokenApprovals[tokenId] = to;
        console.log("_approve _tokenApprovals[tokenId]: ", _tokenApprovals[tokenId], to);
