 ...
 * @notice This contract handles minting Brad Tries to Break Launchpad  tokens.
 */
contract BradTriesToBreakLaunchpad is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xcb5C146C434c5416fdB7c5caD9C28B1A29dCB997;
    address public royaltyAddress = 0x77770275484eE9ffc316814F0100Bab1f01c2384;
    address[] public payoutAddresses = [
        0x3a9238D6806889f8A26f01344a9CE407c8369c35,
        0x77770275484eE9ffc316814F0100Bab1f01c2384,
        0xA8ddbDF82a042011D0364a67104110b377e62FC2,
    ...
    string public name = "Brad Tries to Break Launchpad ";
    string public symbol =
        "";
    // The respective share of funds to be sent to each address in payoutAddresses in basis points
    uint256[] public payoutBasisPoints = [4000, 3000, 2000, 1000];
    uint96 public royaltyFee = 500;

    constructor()
        ERC1155(
            "ipfs://bafybeidecfdg4zbzixaa3rdwj5wumyzpiq6e7ukja6hni53janzvop5l4m/{id}"
        )
    {
        _setDefaultRoyalty(royaltyAddress, royaltyFee);
        tokenMaxSupply[588066064] = 500000;
        tokenPublicPrice[588066064] = 1000000000 ether;
        tokenPublicMintsPerAddress[588066064] = 50;
        tokenPublicSaleStartTime[588066064] = 5685102660;
        tokenPublicSaleEndTime[588066064] = 37241925060;
        tokenUsePublicSaleTimes[588066064] = true;
        tokenPresaleMaxSupply[588066064] = 111;
        tokenPresalePrice[588066064] = 420 ether;
        tokenPresaleMintsPerAddress[588066064] = 69;
        tokenPresaleSaleStartTime[588066064] = 1676102400;
        tokenPresaleSaleEndTime[588066064] = 4522122000;
        tokenUsePresaleTimes[588066064] = true;
        require(
