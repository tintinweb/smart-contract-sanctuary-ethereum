...
contract AverageCollabTest1 is ERC1155, ERC1155Burnable, Ownable {
  ...
  CollectionContract private _guestContract;
  ...
  function calculateCost(address addy) public view returns (uint256) {
    if (_avgcreatures.balanceOf(addy) > 0) {
      return holderCost;
    }
    return publicCost;
  }
  ...
  // Set Guest Contract Address
  function setGuestContract(address _guestContractAddy) public onlyOwner {
    _guestContract = CollectionContract(_guestContractAddy);
  }
