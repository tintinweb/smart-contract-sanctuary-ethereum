...
/***
 *      _______________________________.____    .____       _____ ____________________  _____  ________   
 *     /   _____/\__    ___/\_   _____/|    |   |    |     /  _  \\______   \______   \/  _  \ \______ \  
 *     \_____  \   |    |    |    __)_ |    |   |    |    /  /_\  \|       _/|     ___/  /_\  \ |    |  \ 
 *     /        \  |    |    |        \|    |___|    |___/    |    \    |   \|    |  /    |    \|    `   \
 *    /_______  /  |____|   /_______  /|_______ \_______ \____|__  /____|_  /|____|  \____|__  /_______  /
 *            \/                    \/         \/       \/       \/       \/                 \/        \/ 
...
contract ReflectToken is IERC20, Ownable {
    ...
    event OperationFeePaid(uint256 amount);
    ...
    */
    ...
    function _swapTokensForBNB(
        ...
        try _swapRouter.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            emit OperationFeePaid(tokenAmount);
            return true;
        } catch(bytes memory) {
            return false;
        }
