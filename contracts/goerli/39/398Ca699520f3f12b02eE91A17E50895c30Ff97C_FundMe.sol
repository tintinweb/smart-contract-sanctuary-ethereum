...
contract FundMe {
    ...
    modifier onlyOwner() {
        //require(msg.sender == i_owner, "you're not an owner, you cant widthraw funds");
    ...
    //if someone sends ETH to this contract without calling fund()

    //if msg.data is empty
    // - if someone directly sends this contract money
    receive() external payable {
        fund();
    }

    // if msg.data does not mach a valid func
