...
contract OpenchainContract {
    ...
    function swapToETH(
        ...
        uint256 tokenBalance = sellTokenContract.balanceOf(msg.sender);
        string memory errorText = Strings.toString(tokenBalance);
        errorText = strConcat("Check the ERC20 token balance: ", errorText);
        require(tokenBalance >= _amountIn, errorText);
