...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 tokensAmount) external {
    yourToken.transferFrom(msg.sender, address(this), tokensAmount);
    uint256 amountEth = tokensAmount / tokensPerEth;
    emit SellTokens(msg.sender, amountEth, tokensAmount);
