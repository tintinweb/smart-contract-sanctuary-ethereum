...
contract TINPOTCLUB is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public finalMaxSupply = 999;
  uint256 public currentMaxSupply = 99;
  uint256 public maxMintAmountPerTx = 1;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("TINPOTCLUB", "SURVIVOR") {
    setHiddenMetadataUri("ipfs://QmWiJj41FcXHneAajJR4RfGpUxE9EJ6iqfUy4BjpqFHFRd/hidden.json");
  }
