...
contract IG is ERC721Enumerable, ERC2981, Ownable {
    ...
    */
    ...
    function setPresaleEnded(Timestamp storage timer, uint64 timestamp) internal {
        timer._deadline = timestamp;
    }
    function getPresaleEnded(Timestamp memory timer) internal pure returns (uint64) {
