...
contract FURY is ERC721, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    constructor(
        ...
        _weaponAmount[1] = 157; // 2-158
        _weaponAmount[2] = 207; // 159 - 365
        _weaponAmount[3] = 138; // 366 - 503
        _weaponAmount[4] = 112; // 504 - 615
        _weaponAmount[5] = 44; // 616 - 659
        _weaponAmount[6] = 155; // 660 - 814
        _weaponAmount[7] = 117; // 815 - 931
        _weaponAmount[8] = 87; // 932 - 1018
        _weaponAmount[9] = 164; // 1019 - 1182
        _weaponAmount[10] = 72; // 1183 - 1254
        _weaponAmount[11] = 168; // 1255 - 1422
        _weaponAmount[12] = 53; // 1423 - 1475
        _weaponAmount[13] = 121; // 1476 - 1596
        _weaponAmount[14] = 254; // 1597 - 1850
        _weaponAmount[15] = 42; // 1851 - 1892
        _weaponAmount[16] = 109; // 1893 - 2001
    }
