...
contract LiquidDelegateMarket {
    ...
    // One max bid, locked for 1 hour to prevent griefing
    ...
    function cancelListing(uint256 listingId) external {
       // Move data into memory to delete the bid data first, preventing reentrancy
        ...
        uint256 listingAmount = listing.weiAmount;
        address seller = listing.seller;
        delete listings[listingId];

        require(msg.sender == seller, "NOT_YOUR_LISTING");
        emit ListingCanceled(listingId, msg.sender, rightsId, listingAmount);
    }
