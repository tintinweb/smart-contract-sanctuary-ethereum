...
contract InitERC721KFNCFacet is Base {
    ...
    function initERC721KFNC(string memory name_, string memory symbol_, string memory baseURI_,uint256 startingTokenId_, address[] memory payees_, uint256[] memory shares_) external {
        ...
        LibPaymentSplitter.init(payees_, shares_);
    }
}
