...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    /* Functions */
    constructor(
        address vrfCoordinatorV2, // contract, needs a mock
        uint256 entranceFee, 
        bytes32 gasLane, 
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        uint256 requestID = i_vrfCoordinator.requestRandomWords(
            i_gasLane,  // gasLane, max gas price you are willing to pay in wei
            ...
            i_callbackGasLimit, // how much gas to use for the callback request to your contract's fulfillRandomWords() function
