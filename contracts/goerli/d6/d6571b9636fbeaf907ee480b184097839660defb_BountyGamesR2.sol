...
contract BountyGamesR2 is ERC721, EIP712, Ownable {
    ...
    uint256 public turnInPrice = 0.07 ether;
    ...
    uint256 public startSalesTimestamp = 1660788619;

    uint256 public endSalesTimestamp = 1661393419;
    ...
    constructor()
        ...
        ERC721("Bounty Games R2", "BOUNTYR2")
...

    {
        ...
        batches[1] = 40000000000000000;

        batches[2] = 80000000000000000;

        batches[3] = 120000000000000000;

        batches[5] = 150000000000000000;

        batches[10] = 250000000000000000;

        batches[20] = 450000000000000000;

        batches[50] = 1000000000000000000;

    }



    function batchMint(uint batchCount, uint256 freeMintQuantity, bytes calldata signature) external  payable {
        ...
        if(freeMintQuantity > 0){
            ...
            require(recoverAddress(msg.sender, freeMintQuantity, signature) == _signerAddress, "user cannot free mint");

            require(accountToMintedFreeTokens[msg.sender] > 0, "You already minted your free mint");
    ...
    function setTurnInPrice(uint256 newTurnInPrice) external onlyOwner {

        turnInPrice = newTurnInPrice;
    ...
    function arrest(uint256 tokenId) external payable {
        ...
        require(msg.value >= turnInPrice, "ether sent is under turn in price");
    ...
    function releaseAll() external {
        ...
        uint256 amount = accountToLockedTokens[msg.sender].length();



        for (uint256 i = 0; i < amount; i++) {

            _release(msg.sender, accountToLockedTokens[msg.sender].at(0));
    ...
    function release(uint256 tokenId) external {
        ...
        require(
            ...
            accountToLockedTokens[msg.sender].contains(tokenId),
        ...
        _release(msg.sender, tokenId);

    }



    function _release(address accountAddress, uint256 tokenId) internal {
    ...
    function releaseAll(address accountAddress) external onlyOwner {
        ...
        uint256 amount = accountToLockedTokens[accountAddress].length();
        ...
        for (uint256 i = 0; i < amount; i++) {
            ...
            _release(
                ...
                accountToLockedTokens[accountAddress].at(0)
    ...
    function release(address accountAddress, uint256 tokenId) public onlyOwner {

        require(

            accountToLockedTokens[accountAddress].contains(tokenId),
        ...
        _release(accountAddress, tokenId);
