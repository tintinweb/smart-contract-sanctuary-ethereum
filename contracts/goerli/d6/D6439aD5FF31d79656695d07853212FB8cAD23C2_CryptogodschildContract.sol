...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1678813200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1677613980;
    ...
    , TimedDrop
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7JnDol0yjfVkDrughI47/contract-metadata";
  }
...
// File: contracts/CryptogodschildContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptogodschildContract is ERC721APlus {
    constructor() ERC721APlus("CRYPTO GODS CHILD", "CGCMSK"){}
}