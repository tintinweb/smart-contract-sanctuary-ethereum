...
abstract contract ENSCAT {
    ...
    string public contractURI = "ipfs://QmRtm7gCXn29FjEoG6ZpVmdG1kvuRKn3ZzCHYbVs29x642"; // TESTNET

    /// @dev : ERC2981 Royalty info; 1 = 1%
    uint8 public royalty = 10; // TESTNET

    /// @dev : IPFS hash of metadata directory
    string public metaIPFS = "QmTMgQAYhjiqXcHmXH5rFM214aZj5Z755gsERawgpAp83i"; // TESTNET
