...
//    IERC20Upgradeable public rapidBondzContract;
...
//    event AddRapidBondzContract(RapidTokenUpgradeable rapidBondzContract);
//    event AddRapidBondzContract(IERC20Upgradeable rapidBondzContract);
    ...
    function addStableCoinContract(address __stableCoin) public onlyOwner {
        require(
            !initialOffering.launched,
...
//        rapidBondzContract = IERC20Upgradeable(__rapidBondzToken);
//        rapidBondzContract = RapidTokenUpgradeable(__rapidBondzToken);
    ...
    function launch(
        ...
        require(
//            rapidBondzContract.getIsInitialized(),
            rapidBondzContract.getIsInitialized(),
            "Rapid Bondz token have to be initialized initialized!"
        );
        require(
    ...
    function cancel() external {
        ...
        emit InitialOfferingCancel(initialOffering);
    }
...
//    function pledgeProxy(uint256 _amount, address payable provider) external {
//        if (initialOffering.pledged + _amount > initialOffering.maximalAmount) {
//            // pledged amount is adjusted in order not to exceed maximalAmount
//            _amount = initialOffering.maximalAmount - initialOffering.pledged;
//        }
//
//        initialOffering.pledged += _amount;
//        if (pledgedAmountsDict[provider] == 0) {
//            pledgers.push(provider);
//        }
//
//        pledgedAmountsDict[provider] += _amount;
//
//        stableCoin.transferFrom(provider, address(this), _amount);
//
//        emit Pledge(provider, _amount);
//    }
//
    ...
    function refundMe() external {
        ...
        require(
            initialOffering.pledged < initialOffering.maximalAmount,
