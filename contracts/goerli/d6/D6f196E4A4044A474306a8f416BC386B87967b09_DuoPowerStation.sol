...
// File contracts/IPowerStationV2_1.sol
...
interface IDUOPowerStation {
    ...
    // function stakerJoinPool(uint256 _pid,uint256 shares, string memory payby) external;
...
// File contracts/PowerStationv2_1.sol
...
contract DuoPowerStation is Initializable, UUPSUpgradeable, OwnableUpgradeable,IDUOPowerStation{
  ...
  Pool[] public pools; // Staking pools
    ...
    //     ///TODO: removed for testing, should add back when deploy
    //     _poolIsOpen(_pid);
    ...
    function withdraw(uint256 _pid) public override{
        ...
        renFil.safeTransfer(msg.sender, remainingRewardsPerShareUSDT* stakerUSDT.shares + 
                                        remainingRewardsPerShareRGP* stakerRGP.shares);
    ...
    function topUpPool(uint256 _pid, uint256 _allocPoint) public override{
        ...
        uint256 rewardPerShareRGP = _allocPoint*  1/poolRGP.poolInfoVars[6] * 45/100;    // allocPoint* 1/maxShares *0.45
        uint256 rewardPerShareUSDT = _allocPoint*  1/poolRGP.poolInfoVars[6] * 40/100;    // allocPoint* 1/maxShares *0.4
    ...
    function minerWithdraw(uint256 _pid)public override{
        ...
        renFil.safeTransfer(msg.sender, pool.remainBalance);
        pool.remainBalance = 0;
    }

    function emergencyWithdraw()public override onlyOwner{
        renFil.safeTransfer(filAddr, renFil.balanceOf(address(this)));
