    ...
    IERC721Enumerable
{
    ...
    uint256 public all_holders_amount;
    mapping(address => bool) is_holder;
    ...
    function add_holder(address to) internal {
        if (!is_holder[to]) {
            all_holders_amount += 1;
            is_holder[to] = true;
            all_holders.push(to);
        }
    }
...
contract Widow is ERC721, Ownable {
