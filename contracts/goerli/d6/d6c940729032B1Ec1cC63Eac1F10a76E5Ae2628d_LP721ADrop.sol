...
import "./LP721ADrop.sol";
import "@openzeppelin/contracts/proxy/Clones.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract LP721AFactory is Ownable {
    address private implementation;

    event ContractCreated(address creator, address contractAddress);

    constructor() {
        implementation = address(new LP721ADrop());
    }
    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < phaseLength; ) {
            ...
            bytes32[] calldata _proof = proofs[i];
            bytes32 _leaf = leafs[i];
