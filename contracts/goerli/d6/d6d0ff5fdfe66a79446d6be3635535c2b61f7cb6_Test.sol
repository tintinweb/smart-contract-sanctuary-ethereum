...
contract Test is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    address private PAYOUT_ADDRESS = 0x3798247589cba1ed036225dBd42B6c5DCFe0f476;
    ...
    IERC721 DVDA = IERC721(0x3F52ee1725e4C8992294eBaF095c386c0C321F7b); //CHange smart contracts
    IERC721 GHN = IERC721(0x3F52ee1725e4C8992294eBaF095c386c0C321F7b); 
    IERC721 MGHN = IERC721(0x3F52ee1725e4C8992294eBaF095c386c0C321F7b); 
    IERC721 AHC = IERC721(0x3F52ee1725e4C8992294eBaF095c386c0C321F7b);


    constructor() ERC721A("Chili", "CH") {}
    ...
    function MintPhase1(uint256 amount, bytes32[] memory proof) public payable nonReentrant {
        ...
        require(isChiliTravelsHolder(msg.sender, proof), "Not Holder of DD Mint Pass.");
...
*/
    function withdrawMoneyTo() external onlyOwner {
