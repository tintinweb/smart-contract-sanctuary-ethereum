...
contract DNSv2 is UUPSUpgradeable, OwnableUpgradeable, ERC721Upgradeable {    
    ...
    event Shout(string host, uint128 ip);
   ...
   function _transfer(address from, address to, uint256 tokenId) internal override {
    ...
    function setIPv4(string memory host, uint32 ipv4) public {
        _records[_tokenIds[host]].ipv4 = ipv4;
        emit Shout(host, ipv4);
    }

    function setIPv6(string memory host, uint128 ipv6) public {
        _records[_tokenIds[host]].ipv6 = ipv6;
        emit Shout(host, ipv6);
    }
