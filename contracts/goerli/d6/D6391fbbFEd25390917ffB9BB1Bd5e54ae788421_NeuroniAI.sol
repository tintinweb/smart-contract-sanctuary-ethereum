...
contract NeuroniAI is BaseErc20, AntiSniper, Burnable, Taxable {
    ...
    constructor () {
        ...
        taxDistributor.createWalletTax("Insight", 190, 456, 0x75D96bDC449033B53ba4C75f7448f8Ce9a0F426e, true);
        taxDistributor.createWalletTax("Marketing", 185, 444, 0xd530981266682B8147E733ce250124A585B7e936, true);
        taxDistributor.createWalletTax("Dev", 125, 300, 0xa4205544B85dD233fE82CaF84A0DF53Dd0CbE0c1, true);
        autoSwapTax = false;
