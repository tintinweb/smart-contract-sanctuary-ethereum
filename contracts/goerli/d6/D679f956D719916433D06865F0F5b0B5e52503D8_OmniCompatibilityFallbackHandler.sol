...
/// @author Richard Meissner - <[email protected]>
contract OmniCompatibilityFallbackHandler is DefaultCallbackHandler, ISignatureValidator, Ownable {
    //keccak256(
    ...
    function isValidSignature(bytes32 _dataHash, bytes calldata _signature) external view returns (bytes4) {
        if (SignatureChecker.isValidSignatureNow(oracle, _dataHash, _signature)) {
