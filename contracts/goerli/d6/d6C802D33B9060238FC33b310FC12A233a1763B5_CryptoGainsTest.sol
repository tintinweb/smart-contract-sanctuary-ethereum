...
contract CryptoGainsTest is ERC721Enumerable, Ownable2Step, ReentrancyGuard {
    ...
    constructor(
        ...
        usdcPrice = 50 * 10 ** 6; // 50 USDC (6 decimal places) - 5 million in decimals = 50$
        usdtPrice = 50 * 10 ** 6; // 50 USDT (6 decimal places)
    }
