...
contract MarketplaceDutch is Ownable, ReentrancyGuard
{
    ...
    struct _UserSaleInformation
    {
        ...
        bool _MaxAmountVerified;       // [7] -> _MaxAmountVerified       | If The User Passed MaxAmount Is Valid From The Merkle Tree
    ...
    function Purchase (
        ...
        if(_IS._ActiveBrightList)
        {
            ...
            if(BrightListEligible)
            {
                ...
                VerifyAmount(Recipient, MaxAmount, _RootHash, ProofAmount);
    ...
    function ViewWalletSaleInformation(
        ...
        return(
            _UserSaleInformation(
                ...
                ViewCurrentPrice(SaleIndex),                                                                    // The Current Price Of A Sale
                Priority,                                                                                       // Which Priority The User Is Eligible For
                VerifyAmount(Recipient, MaxAmount, SaleParams[SaleIndex]._RootsAmounts[Priority], ProofAmount), // If The User Has Passed A Valid MaxAmount
