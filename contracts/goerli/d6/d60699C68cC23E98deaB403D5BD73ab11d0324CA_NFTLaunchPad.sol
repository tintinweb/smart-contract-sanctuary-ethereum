...
contract NFTCollection is ERC721A, ERC2981, Ownable {
    ...
    function _setCurrency(
        ...
        require(_currencies.length == _currenciesPrice.length, "NFTCollection: public currency and price should be same length.");
    ...
    function _setCurrencyForwhiteList(
        ...
        require(
            _whiteListCurrencies.length == _currenciesPriceWhiteList.length, "NFTCollection: whitelist currency and price should be same length.");
