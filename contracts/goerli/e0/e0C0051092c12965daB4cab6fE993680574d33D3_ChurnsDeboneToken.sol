...
/**
 * @title ChurnsDeboneToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract ChurnsDeboneToken is ERC20Permit, ERC20Burnable {
    address private _owner;

    constructor() ERC20("Churns Debone Token","HURE")  ERC20Permit("Churns Debone Token") { 
        _owner = _msgSender();
     }
