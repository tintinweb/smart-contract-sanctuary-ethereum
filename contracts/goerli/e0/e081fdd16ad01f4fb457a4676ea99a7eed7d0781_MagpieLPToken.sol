  ...
  PausableUpgradeable
{
  ...
  mapping(uint256 => IMagpieLPToken.MagpieLPTokenInfo) public tokenMetadata;
  ...
  function mint(address _to) external onlyMagpieProviders whenNotPaused nonReentrant returns (uint256) {
