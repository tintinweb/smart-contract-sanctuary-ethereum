...
library Events {
    event Registration(address user, string serverName, uint256 timestamp);
...
contract MatrixHub is MatrixHubStorage, MatrixPeriphery {
    function registerAccount(
        ...
        emit Events.Registration(msg.sender, serverName, block.timestamp);
    ...
    function registerAccountWithSig(
        ...
        emit Events.Registration(vars.user, vars.serverName, block.timestamp);
