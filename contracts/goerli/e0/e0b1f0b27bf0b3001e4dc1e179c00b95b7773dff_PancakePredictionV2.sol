...
// File: contracts/PancakePredictionV2Simplify.sol
...
contract PancakePredictionV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public bufferSeconds = 30; // 30, number of seconds for valid execution of a prediction round
    uint256 public intervalSeconds = 300; // 300, interval in seconds between two prediction rounds

    uint256 public minBetAmount = 1000000000000000; // 0.001BNB, minimum betting amount (denominated in wei)
    uint256 public treasuryFee = 300; // 300, treasury rate (e.g. 200 = 2%, 150 = 1.50%)
    uint256 public treasuryAmount; // treasury amount that was not claimed

    uint256 public currentEpoch; // current epoch for prediction round

    uint256 public oracleLatestRoundId; // converted from uint80 (Chainlink)
    uint256 public oracleUpdateAllowance = 300; // 300, seconds
    ...
    constructor(
        ...
        oracle = AggregatorV3Interface(_oracleAddress); // 0xd276fcf34d54a926773c399ebaa772c12ec394ac
    }
