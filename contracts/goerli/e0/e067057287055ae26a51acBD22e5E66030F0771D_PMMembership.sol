...
contract PMMembership is ERC721, Ownable {
    ...
    ERC721("Planetmoon Membership", "PMM") {
    ...
    function getMembership(address to) public payable {
    ...
    function getPremiumMembership(address to) public payable {
