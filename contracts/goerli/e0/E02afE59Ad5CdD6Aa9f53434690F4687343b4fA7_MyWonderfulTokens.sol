 ...
 * @notice This contract handles minting My Wonderful Tokens tokens.
 */
contract MyWonderfulTokens is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xA7a4f3d3AD37eE4DC436282D100CEacb0A7A1b30;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x1D9Bb3399Dad211336CC686bfaeDf6f9bA1eFa23;
    address[] public payoutAddresses = [
        0x1D9Bb3399Dad211336CC686bfaeDf6f9bA1eFa23
    ];
    ...
    string public name = "My Wonderful Tokens";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeicziqx2epus5ixdl2j4pk3qvekon7xfo4wnkwdw4qyvvrsnmz6adq/{id}"
        )
        RevokableOperatorFilterer(
