  ...
  ReentrancyGuard
{
  ...
  constructor(
    ...
    routers.push(address(uniswapV2Router));
  }
  ...
  function _transfer(
    ...
    if (isRouter[msg.sender] || isRouter[recipient]) {
      if (addrsExcludedFromTax[sender]) {
        ...
        address[] memory uniswapV2PairPath = new address[](2);
        uniswapV2PairPath[0] = address(this);
        uniswapV2PairPath[1] = uniswapV2Router.WETH();
