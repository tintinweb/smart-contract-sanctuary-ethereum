...
//
//     ____  _           ______                      
//    / __ \(_)  _____  / / __ \___  ____  ___  _____
//   / /_/ / / |/_/ _ \/ / /_/ / _ \/ __ \/ _ \/ ___/
//  / ____/ />  </  __/ / ____/  __/ /_/ /  __(__  ) 
// /_/   /_/_/|_|\___/_/_/    \___/ .___/\___/____/  
//                               /_/                 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xB9088e9cb184e8d30F74A2DB03aBcB2d9eEfDb61];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xB9088e9cb184e8d30F74A2DB03aBcB2d9eEfDb61;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmX9M7mnrfUCPzDgjFB8G4dsX6NKUwmD5wQ1y31ngCt5W4/";
...
// File: contracts/PixelPepesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixelPepesContract is RamppERC721A {
    constructor() RamppERC721A("PixelPepes", "PP"){}
}
