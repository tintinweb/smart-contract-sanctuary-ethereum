...
contract devERC721 is ERC721, AccessControl, ReentrancyGuard, ERC721Burnable  {
    ...
    uint256 public tokenPrice = 10000000000000000; //0.01 
...
// =========== mint
    ...
    function onChainMint(address to, string calldata uri) 
        external 
        onlyRole(MINTER_ROLE) 
    {
        _safeMint(to, _tokenIdCounter.current() + 1);
        _tokenURIs[_tokenIdCounter.current() + 1] = uri;
