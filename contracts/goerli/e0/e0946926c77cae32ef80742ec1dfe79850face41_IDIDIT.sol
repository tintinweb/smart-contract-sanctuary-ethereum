...
contract IDIDIT  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"IDIDIT", unicode"NEVERGIVEUP") {
        ...
        maxWallet = totalSupply * 10 / 1000; // 1.0% maxWallet
        swapTokensAtAmount = totalSupply * 10 / 10000; // 1.0% swap wallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 15 / 1000)/1e9, "Cannot set maxTransactionAmount lower than 0.5%");
        maxTransactionAmount = newNum * (10**9);
    }
 
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 15 / 1000)/1e9, "Cannot set maxWallet lower than 1.5%");
