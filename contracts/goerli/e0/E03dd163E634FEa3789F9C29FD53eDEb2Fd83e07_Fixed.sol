...
contract Fixed is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("fixed_v1", "f_v1") Ownable() {}
    ...
    /// @param _count How many ffxxdd mining rigs to be mint.
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "fixed_v1 #', toString(tokenId), '", "description": "fulfill your destiny.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(o)), '", "attributes": \x5B ', makeAttributes(tokenId), ' \x5D}'))));
