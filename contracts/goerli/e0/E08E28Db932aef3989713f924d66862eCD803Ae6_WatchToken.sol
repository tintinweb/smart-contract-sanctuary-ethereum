...
contract WatchToken is ERC721, Ownable {
    struct TokenInfo {
        uint256 tokenId;
        string tokenURI;
        address owner;
        ...
        bytes32 digest = keccak256(
            abi.encodePacked(
                ...
                keccak256(
                    abi.encode(
                        keccak256(
                            "Msg(address owner,address spender,uint256 value,uint256 deadline)"
                        ),
                        owner,
                        spender,
                        value,
    ...
    function burn(uint256 tokenId) public onlyOwner {
        require(
            ...
            "Watch Token: OWNER_NOT_CONTRACT"
        );
        _burn(tokenId);
    }
    ...
    function transferOwnershipToContract(
        ...
        _checkSignature(owner, spender, value, deadline, v, r, s);
        // _ownerOf[tokenId] = address(this);
    }
    ...
    function tokenInfo(uint256 tokenId) public view returns (TokenInfo memory) {
        ...
        return TokenInfo(tokenId, tokenUri, owner);
    }
}
