    ...
    OwnableUpgradeable 
{
    ...
    function _setTokenSupply(uint256 id, uint256 amount) internal {
...
interface IBurnable {
    ...
    function burn(uint256 id, uint256 amount, address owner) external;
 
    function burnBatch(uint256[] memory ids, uint256[] memory amounts, address owner) external;
}
