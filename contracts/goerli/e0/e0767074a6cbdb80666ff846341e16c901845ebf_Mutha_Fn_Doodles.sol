...
contract Mutha_Fn_Doodles is Ownable, ERC721A {
    ...
    function withdraw() external onlyOwner {
        payable(0xE975567A01Ee879E6bA69eC9F03901267E9375f6).transfer(address(this).balance / 10);
        uint256 currentBalance = address(this).balance;
        payable(0x79BBf7C5920eaB63065418b5bd5e36A3B9338A85).transfer(currentBalance * 445/1000);
