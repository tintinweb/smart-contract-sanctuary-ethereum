...
contract ERC721Custom is ERC721A, Ownable, ReentrancyGuard {
  ...
  function airdropMint(uint256 amount, address to) public onlyOwner {
    require(!airdropDone, "Cant airdrop if airdrop is done");
  ...
  function mint(uint256 amount) public payable {
    ...
    require(amount > 0 && amount <= maxBatchMint, "You can mint from 1 to 5 token not less, not more, less is more");
    require(totalSupply() + amount <= maxSupply, "Sorry bro no more token you miss your luck");
    require(msg.value >= mintPrice * amount, "We said it's payable not free");
