...
/// @dev Contract Name, File name あとで変更, Error文も
contract NonameNFT is 
    ERC721,
    ERC2981,
    Ownable,
    ReentrancyGuard,
    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public constant MAX_SUPPLY = 50; /// @dev 3600
    ...
    constructor(
        string memory _unrevealedURI, /// @dev https://metadata.prtcl.xyz/metadata/notrevealed/0
    ...
    function setRoyalty(uint96 _royaltyFee) external onlyOwner {
    ...
    function whitelistMint(bytes32[] calldata _merkleProof) external nonReentrant {
        ...
        require(!whitelistClaimed[msg.sender], "NonameNFT: Already claimed"); 
        require(MerkleProof.verify(_merkleProof, merkleRoot, keccak256(abi.encodePacked(msg.sender))), "NonameNFT: Invalid Merkle Proof"); 
