...
import { ICurvePool } from "@gearbox-protocol/integrations-v2/contracts/integrations/curve/ICurvePool.sol";
...
contract CurveSwapper is ISwapper, GasConsumer {
        ...
        returns (SwapQuote memory quote)
    {
        ...
        if (swapTask.isInputTask()) {
            ...
            if (found) {
                quote = SwapQuote({
                    found: true,
                    amount: swapTask.amountWithSlippage(dy),
