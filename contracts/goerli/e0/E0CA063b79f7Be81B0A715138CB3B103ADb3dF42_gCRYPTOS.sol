...
contract gCRYPTOS is IgCRYPTOS, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _sCRYPTOS) ERC20("Governance CRYPTOS", "gCRYPTOS", 18) {
        require(_migrator != address(0), "Zero address: Migrator");
        approved = _migrator;
        require(_sCRYPTOS != address(0), "Zero address: sCRYPTOS");
        sCRYPTOS = IsCRYPTOS(_sCRYPTOS);
    }
     ...
     * @param _sCRYPTOS address
     */
    function migrate(address _staking, address _sCRYPTOS) external override onlyApproved {
        ...
        require(_sCRYPTOS != address(0), "Zero address found");
        sCRYPTOS = IsCRYPTOS(_sCRYPTOS);
    }
    ...
    /**
     * @notice pull index from sCRYPTOS token
     */
    function index() public view override returns (uint256) {
        return sCRYPTOS.index();
    }

    /**
        @notice converts gCRYPTOS amount to CRYPTOS
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts CRYPTOS amount to gCRYPTOS
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gCRYPTOS::getPriorVotes: not yet determined");
