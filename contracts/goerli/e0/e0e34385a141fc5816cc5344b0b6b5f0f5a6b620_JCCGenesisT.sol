...
// File: contracts/JCCGenesisT.sol
...
{    
    ...
    string public baseURI = "ipfs://QmX4Z9m9ZaadgCWiySQhLXjR5jTtXA1dwRQenYxex1kdXm/";
    ...
    constructor (address payable beneficiary, address payable royaltyReceiver)
        ...
        PublicPrivateVoucherMinter(
            PublicPrivateVoucherMinter.MinterConfig({
                isPublicMintActive : true,      // can call publicMint only when isPublicMintActive is true
                ...
                publicMintPrice: 0.005 ether,    // price for publicMint
                privateMintPrice: 0.005 ether,   // price for privateMint
