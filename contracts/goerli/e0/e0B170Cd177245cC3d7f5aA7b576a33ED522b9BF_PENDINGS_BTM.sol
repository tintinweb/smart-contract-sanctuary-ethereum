...
/**
    ...
    @notice methods: 2 pendings == 1 ordinalist, public mint remaining supply
 */
contract PENDINGS_BTM is ERC721, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public mintLimitPerTxnAndWallet = 99;
    ...
    uint256 public reservedForHoldersAmount = 5;
        ...
        totalSupplyChecks(_transactionIds.length/transactionsToBurnForFreeToken) 
    {
        ...
        for(uint256 i=0; i<_transactionIds.length; i=i+transactionsToBurnForFreeToken){
