...
contract DDomDiBion is ERC1155, Ownable, Pausable
{
    ...
    constructor()
        ERC1155("ipfs://bafybeiaql7ij4kgimd5jvnsutg22pprbgr6mlwyxvtgkjoagjin5cuugg4/DDomDiBion_")
    {
    ...
    function computeStats() public view returns (string memory)
    {
        ...
        return string(abi.encodePacked(numFreeSlots, " free slots out of ", numSlots));
    } // computeStats
