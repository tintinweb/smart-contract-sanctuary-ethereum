...
contract GeoInsuranceConsumer is ShambaGeoConsumer  {
     ...
     */ 
    constructor(address payable _client, uint _premium, uint _payoutValue, uint64 _chainId) payable ShambaGeoConsumer(_chainId) {
        
        //set ETH/USD Price Feed
        priceFeed = AggregatorV3Interface(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e);
        
        //initialize variables required for Chainlink Network interaction
        shambaGeoConsumer = new ShambaGeoConsumer(_chainId);
...
contract GeoInsuranceProvider {
    ...
    constructor(uint64 chain_id) payable {
        priceFeed = AggregatorV3Interface(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e); 
        chainId = chain_id;
    }
    ...
    /**
     * @dev gets the current request count for a given contract address
     */
