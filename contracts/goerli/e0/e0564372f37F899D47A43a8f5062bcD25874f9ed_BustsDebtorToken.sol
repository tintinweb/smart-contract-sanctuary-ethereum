...
/**
 * @title BustsDebtorToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract BustsDebtorToken is Pausable, ERC20Permit, ERC20Burnable {
    address private _owner;

    constructor() ERC20("Busts Debtor Token","BSD")  ERC20Permit("Busts Debtor Token") { 
        _owner = _msgSender();
     }
