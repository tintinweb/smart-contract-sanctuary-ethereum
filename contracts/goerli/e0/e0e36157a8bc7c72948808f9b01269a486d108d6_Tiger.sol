...
contract Tiger is ERC721, Owned, ReentrancyGuard {
    ...
    function setNewGDA(
        ...
        int256 _scaleFactor = _scaleFactorNum.div(_scaleFactorDen); // How much are you going to scale up the price if someone bought an amount. Should be > 1 but not be too big.
        int256 _decayConstant = int256(6931).div(10000 * _halfLife); // 6931/10000 is almost ln(2)
