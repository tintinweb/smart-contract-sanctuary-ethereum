...
contract EcoDoge is Context, IERC20, Ownable {
    ...
    // public constants
    uint256 public constant tax = 4;                                      // 4% buy / 4% sell - constant
    uint256 public constant maxTxAmount = 30000000 * 10**9;               // 3% - constant
    uint256 public constant maxWalletSize = 80000000 * 10**9;             // 8% - constant
    ...
    function openTrading() external lockTheSwap onlyOwner() {
