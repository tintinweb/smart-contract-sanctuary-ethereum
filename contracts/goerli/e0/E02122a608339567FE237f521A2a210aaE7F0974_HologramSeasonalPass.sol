...
contract HologramSeasonalPass is ERC721 {
    ...
    constructor(
        ...
        name = string(
            abi.encodePacked(
                "Hologram Pass: Season ",
                Strings.toString(_season)
            )
        );
        symbol = string(abi.encodePacked("HSP", Strings.toString(_season)));
    ...
    function _baseURI() internal pure returns (string memory) {
        return "https://hologramseasonalpass.com/"; // TODO: placeholder
    }
    ...
    // TODO: add minting logic around this function
