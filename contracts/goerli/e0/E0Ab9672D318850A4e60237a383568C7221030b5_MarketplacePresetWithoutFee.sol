    ...
    ERC721Holder
{
    ...
    function createOffer(SignData memory signData, Vrs memory vrs)
        external
        nonReentrant
    {
        hasRole(
    ...
    function purchase(uint256 offerId, uint256 quantity)
        external
        payable
        nonReentrant
    {
...
contract Payout2981Support {
    ...
    function _repayRoyalty(
        ...
        (address receiver, uint256 royaltyAmount) = getRoyaltyInfo(
            tokenAddress,
            tokenId,
            salePrice
        );
