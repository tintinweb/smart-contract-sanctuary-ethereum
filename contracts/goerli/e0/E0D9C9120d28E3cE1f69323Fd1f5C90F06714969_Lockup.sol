    ...
    ERC721Holder
{
    ...
    constructor(
        ...
        _startBlock = block.number + enrollmentPeriod_; // january 8th 2023 - 12s per block = 214_570
        _endBlock = _startBlock + lockDuration_; // 2_612_384 -> bonus pool = 900_000 ALCA
    }
