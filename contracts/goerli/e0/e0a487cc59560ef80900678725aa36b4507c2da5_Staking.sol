...
contract Staking is Ownable {
    ...
    function createStake(uint256 amount) external {
        ...
        emit CreateStake(msg.sender, amount);
    }
    ...
    function claimReward() public {
        ...
        emit ClaimReward(msg.sender, stakerReward);
    }
    ...
    //=========EVENTS=========//
    event CreateStake(address indexed staker, uint256 indexed amount);
    event RemoveStake(address indexed staker, uint256 indexed amount);
    event ClaimReward(address indexed staker, uint256 indexed amount);
}