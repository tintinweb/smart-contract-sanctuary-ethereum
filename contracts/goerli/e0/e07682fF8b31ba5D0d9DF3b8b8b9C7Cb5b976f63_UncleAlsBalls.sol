...
contract UncleAlsBalls is ERC721A, ERC2981, Ownable, ReentrancyGuard {

    /* Variables */

    uint128 public maxSupply = 100;
    string private _baseTokenURI;
    bool private _paused = true;

    /* Construction */

    constructor() ERC721A("UncleAlsBalls", "UAB") {
    ...
    /// @dev Uses the addPayee function to assign the share distribution. Also assigns ERC2981 royalty
    function constructDistribution() private {
        _setDefaultRoyalty(address(this), 2000);
        addPayee(address(0), 5000);
        addPayee(address(0), 4250);
        addPayee(address(0), 750);
    }
