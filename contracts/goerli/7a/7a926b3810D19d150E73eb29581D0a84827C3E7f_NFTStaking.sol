...
contract NFTStaking is Ownable{
    ...
    uint256 public rewardPeriod = 30 seconds;
    ...
    function rewardForTokenInUSD(address user, uint256 tokenID) public view returns(uint256) {
        ...
        uint256 stakedMonths = (block.timestamp-info.staked[tokenID])/rewardPeriod;
        uint256 rewardPerMonth = rewardForRarity[rarity[tokenID-1]-1];
        return stakedMonths*rewardPerMonth;
    }
