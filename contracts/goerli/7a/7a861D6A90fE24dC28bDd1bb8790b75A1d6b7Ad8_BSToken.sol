...
contract BSToken is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        initialize();
    }
    ...
    function _setURI(string memory newuri) override internal virtual {
        _uri = newuri;
    }
