...
contract AbstractionByAkayoJun is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://bafybeicjuemjs4iy4avkyersu5nhk3pzsvjbyysnoq47vjutgik3ik46l4/";
    uint256 public constant TOTAL_ABSTRACTS = 333;
    uint256 public constant MAX_ABSTRACT_MINT = 10;
    uint256 public constant TEAM_ABSTRACTS = 333;
    uint256 public ABSTRACT_PRICE = 0.003 ether;
    ...
    function ownerMint() external onlyOwner {
        require(totalSupply() + TEAM_ABSTRACTS <= TOTAL_ABSTRACTS, "Abstracts ran out");
        _safeMint(msg.sender, TEAM_ABSTRACTS);
    }
      function tokenURI(uint256 tokenId) public view virtual override returns (string memory)
    {
