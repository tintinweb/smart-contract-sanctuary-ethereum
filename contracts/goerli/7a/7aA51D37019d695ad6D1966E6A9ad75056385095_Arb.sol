...
interface IArb is IOwnable
{
	...
	function getAllPairsBulk(IExofiCompatibleFactory factory, uint256 startIndex) external view returns (PairData[] memory);
}
...
contract Arb is IArb, Ownable
{
	...
	function getAllPairsBulk(IExofiCompatibleFactory factory, uint256 startIndex) override external view returns (PairData[] memory)
	{
