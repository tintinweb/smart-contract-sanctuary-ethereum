...
contract Erc721WhiteList is ERC721URIStorage, ReentrancyGuard,Ownable{
  ...
  event mintMsg(string  func,address AddressMsg,string exec,uint256 number);
  ...
  function whiteMint(bytes32[] calldata proof) public  onlyWhiteMinted {
    ...
    //SafeERC20.safeTransferFrom(usdt,address(msg.sender),address(this), _usdtAmount);
    emit mintMsg("whiteMint",address(msg.sender),TokenUri,currentTokenIds);
  }
  ...
  function buyMint() public onlyBuyMinted {
    ...
    //usdt.transferFrom(address(msg.sender),address(this), _usdtAmount);
    //SafeERC20.safeTransferFrom(usdt,address(msg.sender),address(this), _usdtAmount);
     emit mintMsg("mint",address(msg.sender),TokenUri,currentTokenIds);
  }
