...
// File: contracts/artifacts/testwAI.sol
...
contract MyToken is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply, IERC2981 {
    constructor() ERC1155("") {}
    ...
    function royaltyInfo(uint256 tokenId, uint256 salePrice) external view override returns (address receiver, uint256 royaltyAmount) {
        require(exists(tokenId), "ERC2981Royalties: Royalty recipient query for nonexistent token");
