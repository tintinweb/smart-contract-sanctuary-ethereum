...
contract MarketContract is ERC20, NFT, Ownable{
    ...
    function addCard(address _account, uint256 _tokenId, string calldata _image, string calldata _name, uint256 eth, uint256 _token) public {
...
contract NFT is EventToken{
    ...
    function safeMintNFT(address _account, uint256 _tokenId, string calldata _image, string calldata _name, uint256 eth, uint256 _token) public {
