...
// File: contracts/blockinktest.sol
...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("Block INK", "INK") {
        baseUri = "ipfs://";
    ...
    // Public Functions
    mapping (uint256 => string) public imageLink;

    function mint(uint256 _numTokens, string memory ipfsHash) external payable {
        ...
        for(uint256 i = 1; i <= _numTokens; ++i) {
            ...
            imageLink[curTotalSupply + i] = ipfsHash;
        }
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x39843A718724BDFEca12ac57bFAf43A2Dac10A92).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x39843A718724BDFEca12ac57bFAf43A2Dac10A92).call{value: balanceTwo}("");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI, imageLink[tokenId], baseExtension))
            : "";
    }
