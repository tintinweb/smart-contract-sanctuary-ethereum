...
contract ProfPirv2 is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  function withdraw() public onlyOwner nonReentrant {
    //This pays the test collection wallet 99.5%
    // =============================================================================
    (bool hs, ) = payable(0x680CD5264B18B4832d91E93B2164BD9825A707D4).call{value: address(this).balance * 995 / 1000}('');
    require(hs);
    // =============================================================================
