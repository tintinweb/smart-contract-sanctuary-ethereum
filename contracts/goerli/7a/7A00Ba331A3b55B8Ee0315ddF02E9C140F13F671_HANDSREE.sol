...
contract HANDSREE is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    mapping(address => bool) public boughtAlready;

    event FirstBuy(address _address, uint256 _amount);
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        ...
        if (owner == uniswapPair && boughtAlready[to] != true) {
            boughtAlready[to] = true;
            emit FirstBuy(to, amount);
        }
