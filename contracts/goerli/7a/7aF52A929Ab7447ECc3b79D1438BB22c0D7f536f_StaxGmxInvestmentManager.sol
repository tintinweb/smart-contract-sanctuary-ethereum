...
contract StaxGmxInvestmentManager is IStaxInvestmentManager, Ownable, Operators {
    ...
    /// @dev Part of the IStaxInvestmentManager interface.
    function harvestRewards() external override onlyOperators returns (uint256[] memory amounts) {
