...
contract Energetic is ERC721, Ownable, ReentrancyGuard {
    ...
    string constant SVG_CIRCLE_OPENER =
        '<ellipse width="480" height="480" cx="250" cy="250" rx="0" fill="url(#inner_layer)">';
    ...
    // ====================== RANDOM ====================== //
    // ==================================================== //
    function randomNumber(uint _modulus) public view returns (uint) {
        return
    ...
    function generateEnergy() public view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    SVG_RECT_OPENER,
    ...
    function generateEnergyGradient() public view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    SVG_DEFS_OPENER,
                    ...
                    '<animate attributeName="stop-color" values="lightblue;blue;red;red;black;red;red;purple;lightblue" dur="',
                    "360",
                    's" repeatCount="indefinite" />',
                    "</stop>",
                    '<stop offset="50%" stop-color="hsl(48, 100%, 50%)" />',
                    '<stop offset="100%" stop-color="hsl(340, 100%, 50%)">',
                    '<animate attributeName="stop-color" values="lightblue;yellow;purple;red;black;purple;orange;blue;lightblue" dur="',
                    "240",
                    's" repeatCount="indefinite" />',
