...
contract OrigamiClub is ERC721A, ERC721AQueryable, Owned {
  ...
  uint256 public EXTRA_MINT_PRICE = 0.02 ether;
  uint256 public FIRST_MINT_PRICE_PUBLIC = 0 ether;
  ...
  constructor(bytes32 _merkleRoot) ERC721A("OrigamiClub", "OGClub") Owned(msg.sender) {
