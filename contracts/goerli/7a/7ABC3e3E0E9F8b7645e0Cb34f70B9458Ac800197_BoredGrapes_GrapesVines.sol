...
contract BoredGrapes_GrapesVines is ERC721A, Ownable {
    ...
    ERC721A public bottleContract = ERC721A(0xD2cfB26DC0c61d652F22E88208D81C79e01F208A);
   
    constructor() ERC721A('Bored Grapes - Grape Vines', 'BG') {
    }
    ...
    // Burn a grape to make a bottle
    function burn(uint tokenId) public {
        require(msg.sender == burnerContract, "Sender is not burner contract");
        _burn(tokenId); //burn tokenid without approval
    }
    ...
    function setBurnerContract(address _burnerContract) public devOrOwner {
