...
contract OxTHULU is ERC721AUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize() initializerERC721A initializer public {
        __ERC721A_init("0xTHULU Relic of Membership V2", "0xRoM2");
        __Ownable_init();
        __Pausable_init();
        MAX_SUPPLY = 11138;
        baseURI = "https://ipfs.perma.store/content/bafybeihrfzicsf674mmvjhascwlpuhqt4qxmr4cobzlaqysrsj7hcgv5de/";
    }
