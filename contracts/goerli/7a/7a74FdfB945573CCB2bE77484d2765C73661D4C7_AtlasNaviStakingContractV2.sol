...
contract AtlasNaviStakingContractV2 is AtlasNaviStakingContract {

    function returnOwnerAddress(uint256 tokenId) external view returns(address){
        return stakeOwner[tokenId].stakeOwner;
    }
...
contract AtlasNaviStakingContract is IERC721Receiver, Initializable, UUPSUpgradeable, OwnableUpgradeable {
    
    address parentNFTAddress;
    uint256 blockedOnStakeTime;
