...
contract BAPOrchestratorReduce is Ownable, IERC721Receiver {
    string public constant project = "Bulls & Apes Project";

    uint256 public startTime = 1664928000;
        ...
        returns (uint256 amount)
    {
        ...
        if (_type == 2) {
            ...
            if (!prevClaimed[tokenId]) {
                amount += getOldClaimableMeth(tokenId, _type);
    ...
    function _dailyRewards(uint256 _type, uint256 tokenId)
        internal
        pure
        returns (uint256)
    {
        ...
        returns (uint256)
    {
        ...
        return (timeFromCreation * _dailyRewards(_type, tokenId)) - claimed;
    }
        ...
        returns (uint256 methAmount)
    {
        ...
        uint256 claimed = 0;
        uint256 dailyRewards = _type == 1 ? 20 : 10;
        ...
        } else if (_type != 1 && breedings(tokenId) == 0) {
            dailyRewards = 15;
        }
