...
contract MasterChef is Ownable {
    ...
    // The CAKE TOKEN!
    TestCakeToken public cake;
    // The SYRUP TOKEN!
    SyrupBar public syrup;
    // Dev address.
    address public devaddr = 0xC95FDbB78dd78d555DcA549Fae330FA7691BDdb7;
    // CAKE tokens created per block.
    uint256 public cakePerBlock = 40 * 1e18;
    ...
    uint256 public startBlock = 7800389;
...
contract SyrupBar is ERC20("SyrupBar Token", "SYRUP"), Ownable {
    ...
    constructor(TestCakeToken _cake) {
        cake = _cake;
    }
...
contract TestCakeToken is ERC20("PancakeSwap Test Token", "TestCake"), Ownable {
    using SafeMath for uint256;
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterChef).
    function mint(address _to, uint256 _amount) public onlyOwner {
        _mint(_to, _amount);
