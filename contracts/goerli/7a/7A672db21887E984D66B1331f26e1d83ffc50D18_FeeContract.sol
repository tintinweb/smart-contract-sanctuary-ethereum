...
contract FeeContract is Governable {
    ...
    function getVars()
        ...
        returns (
            ...
            uint64 _treasuryFee,
            uint40 _GHNYPercent,
            uint24 _uniStableFee,
            uint24 _uniGHNYFee,
            uint24 _slippageMax,
            uint16 _optimal
        )
    {
        _stakingFee = vars.stakingFee;
        _treasuryFee = vars.treasuryFee;
        _GHNYPercent = vars.GHNYPercent;
        _uniStableFee = vars.uniStableFee;
        _uniGHNYFee = vars.uniGHNYFee;
        _slippageMax = vars.slippageMax;
        _optimal = vars.optimal;
    }
