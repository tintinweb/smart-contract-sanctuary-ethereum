    ...
    PausableUpgradeable
{
    ...
    function addAddressToAllowListWithAllocation(
        ...
        address _address,
        uint256 _allocation
    ) public whenNotPaused onlyRole(PLATFORM_MANAGER_ROLE) onlyValidCollectionId(_collectionId) onlyValidAddress(_address) {
    ...
    function mint(uint256 _collectionId) public payable whenNotPaused {
        ...
        require(collection.priceInWei <= msg.value, "Incorrect amount sent");
        ...
        _splitFundsETH(_collectionId, collection.priceInWei);
    ...
    function tokenURI(
        ...
        return string(bytes.concat(bytes(baseURI), bytes(_tokenId.toString()), bytes(".json")));
    }
        ...
        onlyValidAddress(_athleteAddress)
    {
        ...
        collections[collectionId].tournamentEarningPercentage = _tournamentEarningPercentage;
        ...
        onlyRole(PLATFORM_MANAGER_ROLE)
    {
        ...
        collections[_collectionId].tournamentEarningPercentage = tournamentEarningPercentage;
