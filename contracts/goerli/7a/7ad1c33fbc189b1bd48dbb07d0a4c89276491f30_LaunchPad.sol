    ...
    ReentrancyGuardUpgradeable
{
    ...
    //  total amount contributed on pool
    mapping(uint256 => uint256) public totalContributedAmountInPool;
    // balance stakable on pool
    mapping(uint256 => uint256) private balanceContributableAmount;
    ...
    struct UserInfo {
        ...
        uint256 interestFee; // Interest for staking
    }
    ...
    event AccountsauthorizedUserUpdated(address[] indexed accounts,bool status);
    ...
    */
    function _beforeAddPool(
        ...
        require(_startTime <= _endTime, "STACKING: Has Ended");
    ...
    */
        ...
        whenNotPaused
    {
        ...
        require(_amount >= poolInfo[_pid].minimumContribution,"Amount must be greater than minimum contributon");
        ...
        if (transferStatus) {
            ...
            balanceContributableAmount[_pid] =
