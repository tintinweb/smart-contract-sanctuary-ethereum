...
contract GenesisNote is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    require(purchaseCurrency.balanceOf(msg.sender) >= cost * _mintAmount, 'Insufficient funds! aaa');
    _;
  }
  ...
  function _beforeTokenTransfers(address from, address to, uint256 startTokenId, uint256 quantity)internal virtual override(ERC721A) onlyOwner {
