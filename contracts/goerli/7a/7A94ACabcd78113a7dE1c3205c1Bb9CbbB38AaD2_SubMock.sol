...
contract SubMock is Ownable, ERC5643 {
    using Counters for Counters.Counter;
    // Roughly calculates to 0.1 ether per 30 days
    uint256 public pricePerSecond = 38580246913;

    /// @notice Counter for totalSupply @SB
    Counters.Counter numberTokens;

    /// @notice Stores address to membership id @SB
    mapping(address => uint256) public addressToId;

/// @notice Stores membership id to address @SB
    mapping(uint256 => address) private idToAddress;
    /// @notice renewable state @Sub
    bool renewable;
...
contract ERC5643 is ERC721xo, IERC5643 {
