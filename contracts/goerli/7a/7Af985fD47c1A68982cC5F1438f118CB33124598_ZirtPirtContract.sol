...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x3E603deAa5f233cfA9d457b0d019C575954Cb4d1];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x3E603deAa5f233cfA9d457b0d019C575954Cb4d1;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeib2k66sumu5ax7pycnp3fhbbjlaotyjuhwxge3mf6kkyn22bwz6fe/";
...
// File: contracts/ZirtPirtContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ZirtPirtContract is RamppERC721A {
    constructor() RamppERC721A("ZirtPirt", "ZIRT"){}
}
