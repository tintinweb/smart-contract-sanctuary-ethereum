...
contract Samurices is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MINT_SUPPLY = 7770;
    uint256 public constant VAULT_SUPPLY = 7;
    ...
    function publicMint(uint256 _quantity) external payable callerIsUser {
        ...
        require(totalSupply() + _quantity <= MINT_SUPPLY, "Max supply reached");
    ...
    function reservedMint(uint256 _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        uint256 price = MINT_PRICE;
