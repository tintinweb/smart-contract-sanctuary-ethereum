...
contract DudePerfectIMX is ERC721, Mintable {
    constructor(address _owner, address _imx) ERC721("MyToken", "MTK") Mintable(_owner, _imx) {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmbCzGKXmxMaFMkAW43AP4rpmNFsfRCTwCBGAHKkokPsNm/";
    }
