 ...
 * @notice This contract handles minting DDSM Impact tokens.
 */
contract LaunchpadDDSMImpact is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x24e3aabc2dc22282De807443F676A4e459a002a6;
    address public royaltyAddress = 0x898afC20430FF64D4aBe4B06e519649CA78F3E3d;
    address[] public payoutAddresses = [
        0x3d08C1CC4bc7f70f71f5b70A7b28a7236e4579F9,
        0x898afC20430FF64D4aBe4B06e519649CA78F3E3d
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeifz52imlclwurt6ggjul3tvambbuewmqsxy2u4uc6mbdf43ad6ksm/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 50000;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 10000;
    ...
    uint256[] public payoutPercentages = [40, 60];
    uint96 public royaltyFee = 500;

    constructor() ERC721A("DDSM Impact", "DDSM") {
