...
contract MyToken is ERC20, Pausable, Ownable {
    ...
    address public development = 0x616F8909EAA3D8F99051eff371ffC7Df0f3fD3f8;
    address public muzzleLock = 0xc952b501575Ad6761F72D47149dbc6A5c9Aa5F42;
    uint256 public sellTax = 100; // 1%
    uint256 public buyTax = 300; // 3%

    constructor(address _uniswapV2Pair) ERC20("MyToken", "MTK") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        if (recipient == address(0) || recipient == address(this)) {
            ...
            super._transfer(sender, muzzleLock, taxAmount / 2);
            super._transfer(sender, development, taxAmount / 2);
