...
contract LSArtWorksFactory {
  ...
  function createArtWork(
    ...
    LSArtWorks721 artwork = new LSArtWorks721(
      _artWorkOwner,
      _projectId,
      _royaltyShare,
      address(fundraising),
    ...
    emit ArtWorkCreated(_artWorkOwner, address(artwork), _projectId, _royaltyShare, _license, _distributePool);
...
contract LSArtWorks721 is ERC721Royalty, CantBeEvil {
  ...
  string public constant BASEURI = "https://ipfs.io/ipfs/QmUh6xjX4ULkk8CcgSKXmnMpvgTZxriXZktKcamBCNbL6S";
  ...
  function supportsInterface(bytes4 interfaceId)
    ...
    view
    virtual
    override(CantBeEvil, ERC721Royalty)
    returns (bool)
  {
  ...
  function _beforeTokenTransfer(
    ...
    require(selling[tokenId].price == 0, "token is listed");
