...
contract ERC721A2 is ERC721A, Ownable {
  ...
  constructor() ERC721A("TOKEN NAME", "TOKEN SYMBOL") {
      mintIsActive = false;
  }
  ...
  function mint() public {
    ...
    require(amountMinted[_msgSender()] == 0, "You can not mint more than one token per wallet.");
    require(totalSupply() + mintQuantity <= maxSupply, "All tokens have been minted.");
