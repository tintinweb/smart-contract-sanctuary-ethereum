...
contract TestMinter is ERC721A("TestMinter", "TM"), ERC721ABurnable, Ownable {
    uint256 public maxSupply; //Maximum mintable supply
    uint256 public mintPrice; //Mint Price for RAFFLE and PUBLIC

    bytes32 public merkleRoot; //Can be set during each phase.
    ...
    Phase public currentPhase = Phase.NONE; //Current phase tracker. Can be accessed via web3.js, returns int depending on phase.
