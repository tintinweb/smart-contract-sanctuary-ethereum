...
/**
 * @title TensionallyRhizopusToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract TensionallyRhizopusToken is ERC20Capped, Ownable, Pausable {

    constructor() ERC20("Tensionally Rhizopus Token","NLZP") ERC20Capped(1000000000 * (10**uint256(decimals())))  { 
     }
