...
error NftMarketplace__NotEnoughEth(address nftAddress, uint256 tokenId, uint256 price);
...
contract NftMarketplace is ReentrancyGuard {
        ...
        isListed(nftAddress, tokenId)
    {
        ...
        if (msg.value >= s_listings[nftAddress][tokenId].price) {
            ...
            revert NftMarketplace__NotEnoughEth(nftAddress, tokenId, listedItem.price);
        }
    }
