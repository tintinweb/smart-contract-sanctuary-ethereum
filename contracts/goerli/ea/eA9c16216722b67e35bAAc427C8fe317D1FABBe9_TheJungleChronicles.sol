...
contract TheJungleChronicles is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 222;
    ...
    address[] public withdrawAddresses = [0x6772e726DfF4Ad2541C859b0799E8c18C6e2C489, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xfa78a3d25a7f21fc0a38117ebc5f0674fcda00a30c676179203b86f37b31de98;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x6772e726DfF4Ad2541C859b0799E8c18C6e2C489, _royaltyAmount);
    }
