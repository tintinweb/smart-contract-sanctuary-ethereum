    ...
    function _getClosurePaths(
        ...
        for (uint256 i = 0; i < len; i++) {
            ...
            if (i == 0) {
                ...
                result[i] = TradePath({path: path, rate: 0, expectedAmount: 0});
            } else {
...
contract AddressProvider is Ownable, IAddressProvider {
    ...
    function getContractsRegister() external view override returns (address) {
    ...
    function getAccountFactory() external view override returns (address) {
