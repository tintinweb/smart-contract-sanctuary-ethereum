 ...
 * @notice This contract handles minting and distribution of MTest05A tokens.
 */
contract MTest05A is ERC721A, Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Construct a MTest05A contract instance
     */
     ...
     */
    function mint(address _receiver) external payable nonReentrant onlyAccounts {
        uint256 quantity = MAX_MINTS;

        require(!isPaused, "Contract is paused");
        require(quantity + _numberMinted(_receiver) <= MAX_MINTS, "Exceeded the limit");
