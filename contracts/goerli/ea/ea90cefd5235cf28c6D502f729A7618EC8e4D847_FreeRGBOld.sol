...
contract FreeRGBOld is ERC1155, Ownable { 
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/QmNuYwUMuyRhvjS2bV3jXFpj7q4mbupxtafNntpkNHwyQ6?filename={id}.png")
        {
        }
    ...
    // to Put NFT to Opensea
     function uri(uint256 _tokenId) override public view returns (string memory) {
        ...
        return string(
        abi.encodePacked(
            "https://ipfs.io/ipfs/QmNuYwUMuyRhvjS2bV3jXFpj7q4mbupxtafNntpkNHwyQ6?filename=",
