...
contract TheGoodDogClubLLC is ERC721A, Ownable, ReentrancyGuard {
    ...
    address[] teamWalletList = [
        0x775958f2478C2E0f8219D184B99Db7720686BbC0,   // The Good Dog Club LLC
        0x56Cea2250a0B6Fe52D2a5d683Cc30f3dbdD9A584,   // community wallet
        0xFd849CA1C9766bF6EC96AEfb19ec5dFDd9925C25,   // Rebeca’s wallet 
        0x2f262BdfE6E355B3a884b5bFB0D55fFeEC578FBB,   // Allens's wallet
        0x29ECC8410E1Db1F5021CABF53964242B128a0e39,   // Adam's wallet
        0x8ff33273020cC1a82fa0a24c1168fCd184C28a64,   // Alex's wallet
        0x31c46C8Cf3109A66605C52384b6EFf9C3b891ee3    // Ron's wallet
    ];
    ...
    // Mint Price
    uint256 public mintPricePreSale = 0.06 ether;
    ...
    constructor() ERC721A("TheGoodDogClubLLC", "TGDC") {
        teamWalletPercent[teamWalletList[0]] = 48;  // The Good Dog Club LLC percent
        teamWalletPercent[teamWalletList[1]] = 30;  // community wallet percent
        teamWalletPercent[teamWalletList[2]] = 1;   // Rebeca's percent
        teamWalletPercent[teamWalletList[3]] = 1;   // Allen's percent
        teamWalletPercent[teamWalletList[4]] = 5;   // Adam's percent
        teamWalletPercent[teamWalletList[5]] = 10;   // Alex's percent
        teamWalletPercent[teamWalletList[6]] = 5;   // Ron's percent
    }
     ...
     *              4 - paused
     */
    function setMintPrice(uint256 _mintPrice, uint8 _mintStep) public onlyOwner {
        if (_mintStep == 1) {
            mintPricePreSale = _mintPrice;          
        } else {
            mintPricePublicSale = _mintPrice;
        }
    }
