...
contract ServoMatcher is 
    ILayerZeroReceiver,
    ILayerZeroUserApplicationConfig
{

  uint public immutable DOMINO_CHAIN_ID;
  ...
  constructor (
    address _lz, 
    address _domino,
    uint256 _domino_chain_id

  ) { 

    DOMINO_CHAIN_ID = _domino_chain_id;
  ...
  function placeTrader () public {

  }

  function placeMaker () public {
  ...
  function setConfig(uint16 _version, uint16 _chainId, 
     uint256 _configType, bytes calldata _config) public {
