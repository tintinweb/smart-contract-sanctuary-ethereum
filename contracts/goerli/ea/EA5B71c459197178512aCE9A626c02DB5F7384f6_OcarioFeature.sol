...
contract OcarioFeature is IFeature, IOcarioFeature, FixinCommon, FixinTokenSpender {
    ...
    SwapCallbackData public  datatemp;
        ...
        if (sellAmount != 0) {
            ...
            // while (true) {
 ...
 
                {
                    ...
                    swapDataCallTemp = _updateSwapCallbackData( inputToken, outputToken, fee, source);
                    // datatemp = abi.decode(swapDataCallTemp, (SwapCallbackData));
