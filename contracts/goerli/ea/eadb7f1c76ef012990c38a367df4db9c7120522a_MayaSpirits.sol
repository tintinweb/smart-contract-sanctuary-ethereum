...
contract MayaSpirits is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MINT_PRICE_ALLOWLIST = 0.02 ether; //MODIFY THIS
    uint256 public constant MINT_PRICE_PUBLIC = 0.03 ether; //MODIFY THIS
    string public uriPrefix = "";
    string public uriSuffix = ".json";
    string public hiddenMetadata =
        "ipfs://QmVHHfrKNGjTWr7JHSCK7SzQbdW31D9Q35ivMSmWqLvXHj/hidden.json";
    ...
    function AllowlistMint(uint256 amount) public payable nonReentrant {
        ...
        require(
            AmountClaimedWalletAllowlist[msg.sender] < MAX_MINT_AMOUNT_WALLET,
    ...
    function PublicMint(uint256 amount) public payable nonReentrant {
        ...
        require(_minted + amount <= MAX_SUPPLY, "Exceed max supply");
        require(
            AmountClaimedWalletPublic[msg.sender] < MAX_MINT_AMOUNT_WALLET,
  ...
  function withdrawMoney() external onlyOwner {
    ...
    function withdrawMoneyWithShareTo(uint256 share, address payoutAddress) external onlyOwner {
        Address.sendValue(payable(payoutAddress), (address(this).balance)*(share/100));
    }
