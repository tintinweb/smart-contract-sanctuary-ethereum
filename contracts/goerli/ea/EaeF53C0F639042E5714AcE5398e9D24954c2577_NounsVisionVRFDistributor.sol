...
contract NounsVisionVRFDistributor is VRFv2Consumer {
    ...
    **/
    ...
    ERC721Like public constant NOUNS_TOKEN =
        ERC721Like(0xE3835474Fe54BC75922D7Bf1018F9a7Bd5b8Ceb3);       
    ...
    INounsVisionBatchTransfer public constant NOUNS_VISION_BATCH_TRANSFER =
        INounsVisionBatchTransfer(0x2b1f0fc8F30C368C28262b14a890eC84324C5232);
    ...
    **/
    ...
    function fulfillRandomWords(
        ...
        address[] memory nounsOwners = new address[](nounsSupply);
        address[] memory winners = new address[](availGlasses);

        for (uint256 i = 0; i < nounsSupply; i++) {
            nounsOwners[i] = NOUNS_TOKEN.ownerOf(i); // We are pushing more than once if address has more than one Noun to make odds of winning Glasses proportional to number of Nouns per owner. Choosing of winners will allow repeats. That is, once a winner is selected, odds of winning next Glasses stays the same.
        }
