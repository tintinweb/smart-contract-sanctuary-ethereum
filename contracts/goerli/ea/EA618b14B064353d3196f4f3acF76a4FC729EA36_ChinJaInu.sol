...
contract ChinJaInu is IERC20 {
    ...
    string constant private _name = "ChinJa Inu";
    ...
    address payable public marketingWallet = payable(0x4041fcF5f3Cd55B76B81C1c2e87150C81Cd7B80a);
    ...
    function setLpPair(address pair, bool enabled) external onlyOwner {
        if (!enabled) {
            ...
            if (timeSinceLastPair != 0) {
                require(block.timestamp - timeSinceLastPair > 0 days, "0 Day cooldown.");
            }
