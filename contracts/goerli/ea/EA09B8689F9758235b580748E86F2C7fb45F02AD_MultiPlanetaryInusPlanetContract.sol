    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibngdi3bmcdqta7mluxhzilex5kadptwyhzojffttemmfgb2fsw2q/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Pw1KDjs4rl24f00uuMH3/contract-metadata";
  }
...
// File: contracts/MultiPlanetaryInusPlanetContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MultiPlanetaryInusPlanetContract is RamppERC721A {
    constructor() RamppERC721A("MultiPlanetaryInus Planet", "PLANET"){}
}
