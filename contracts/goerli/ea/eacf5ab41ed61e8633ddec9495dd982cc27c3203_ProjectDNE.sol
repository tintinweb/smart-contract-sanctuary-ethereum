...
contract ProjectDNE is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    constructor(address signer_) ERC721A("Project DNE", "DNE") {
        ...
        // erc2981 royalty - 5%
        _setDefaultRoyalty(0x7e646FA416C978029f07539F6F587232D49A4AEC, 500);
    }
    ...
    // supply
    function reduceSupply(uint256 maxSupply_) public onlyOwner {
    ...
    // operator filterer
    function setOperatorFilteringEnabled(bool value_) public onlyOwner {
        operatorFilteringEnabled = value_;
    }

    // erc2981
    function setDefaultRoyalty(address receiver_, uint96 feeNumerator_) public onlyOwner {
