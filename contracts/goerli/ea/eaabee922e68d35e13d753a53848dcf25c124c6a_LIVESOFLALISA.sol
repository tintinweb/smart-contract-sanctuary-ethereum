...
contract LIVESOFLALISA is ERC721A, Ownable {
    ...
    uint256 public WLcost = 0.069 ether;
    uint256 public pubCost = 0.069 ether;
    ...
    function mintPublic(uint256 _quantity) external payable {
        ...
        require(pubPaidMintAmount[msg.sender] + _quantity <= 888, "PUBLICPAID_MAXED");
        unchecked {
        ...
        onlyOwner
    {
        ...
        require(_quantity > 888, "QUANTITY_INVALID");
