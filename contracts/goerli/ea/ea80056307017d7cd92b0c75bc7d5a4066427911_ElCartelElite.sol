...
contract ElCartelElite is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(3); //.03% 
    uint256 public numTokensSellToAddToLiquidity = _tTotal.div(10000).mul(3); //.003% 
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(3); //.03% 
