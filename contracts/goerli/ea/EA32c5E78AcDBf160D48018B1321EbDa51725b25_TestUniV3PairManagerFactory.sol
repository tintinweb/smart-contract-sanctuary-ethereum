...
contract TestUniV3PairManagerFactory is IPairManagerFactory, Governable {
  ...
  function createPairManager(address _pool) external override returns (address _pairManager) {
    ...
    _pairManager = address(new TestUniV3PairManager(_pool, governance));
...
contract TestUniV3PairManager is IUniV3PairManager, Governable {
