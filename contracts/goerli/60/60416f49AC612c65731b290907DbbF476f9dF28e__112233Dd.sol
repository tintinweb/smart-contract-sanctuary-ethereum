 ...
 * @notice This contract handles minting 112233dd tokens.
 */
contract _112233Dd is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xF421dD55bb903964B916187495C92D7b0fFE2efB;
    ...
    string public baseTokenURI =
        "ipfs://bafybeiav727korlmre5qbqfiiqmgoo4hdyrllqe2hfd2s362z47fdrtdwi/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 111;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 111;
    ...
    uint96 public royaltyFee = 660;

    constructor(address _blocklistContractAddress) ERC721A("112233dd", "3344") {
