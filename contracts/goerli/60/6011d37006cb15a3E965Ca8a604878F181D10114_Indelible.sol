// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Weapon", unicode"Clothing", unicode"Face", unicode"Head", unicode"Hair", unicode"body", unicode"Background"];
        ...
        uint public publicMintPrice = 0.0095 ether;
        ...
        ContractData public contractData = ContractData(unicode"WormsOnChain", unicode"WormsOnChain is a 5000 supply 100% on-chain NFT collection. No roadmap. No Promises. Just a community that is passionate about the progression of truly censorship resistant, decentralized and permission-less technology.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/0464989e-e8ea-4165-9310-086ae3ec0753", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/0464989e-e8ea-4165-9310-086ae3ec0753", "https://discord.gg/l2labs", 600, "0x06E14b037650E6d7c5e6a8eB329E1b44E2D7650C");

        constructor() ERC721A(unicode"WormsOnChain", unicode"Worm") {
            TIERS[0] = [24,81,116,134,138,179,201,264,749,825,832,1457];
TIERS[1] = [205,219,330,762,782,1113,1589];
TIERS[2] = [69,108,126,164,171,194,244,265,282,297,316,328,666,712,1058];
TIERS[3] = [33,37,39,41,45,50,53,53,69,69,86,89,97,107,110,123,126,142,172,176,179,219,230,268,457,460,460,485,525];
TIERS[4] = [69,86,101,108,111,130,295,399,488,693,987,1533];
TIERS[5] = [33,62,91,168,298,308,452,589,635,707,805,852];
TIERS[6] = [159,199,345,356,441,525,820,876,1279];
            withdrawRecipients[0] = WithdrawRecipient("PETS FOR VETS","https://static.tgbwidget.com/organization_logo%2F4b4e232a-bf8f-43c7-88db-f62aa6cc5dab.jpg", 0x8558B66422beb243C0A7343cFF8bf303f41E9ECa, 1000);
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"WormsOnChain #");
