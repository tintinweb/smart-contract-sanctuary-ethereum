...
contract ListYourNft is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply, ReentrancyGuard, ERC1155Holder, Pausable, ERC2981 {
    ...
    string public constant name = "ListYourNft";
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC1155Receiver, ERC1155, AccessControl, ERC2981)
        returns (bool) 
    {
    ...
    function list(string memory uriMetadata, uint supply) 
        external 
        payable 
        nonReentrant 
    {
        require(msg.sender != address(0), "Invalid sender addresss");
        require(supply > 0, "supply greater than zero");
        require(msg.value == (mint_price * supply), "send required value to mint");
