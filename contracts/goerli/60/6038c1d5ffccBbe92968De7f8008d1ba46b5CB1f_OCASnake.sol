...
contract OCASnakeArt is Ownable, ReentrancyGuard {
        ...
        returns (string memory)
    {
        ...
        selectedColors = this.retrofy(tokenId, 20, 0, selectedColors, colors);
    ...
    function retrofy(
        ...
        string[4] memory colors
    ) public view returns (string[30] memory) {
        ...
        if (index < 3)
            return this.retrofy(tokenId, i, index + 1, parts, colors);
        ...
        if (i > 0) return this.retrofy(tokenId, i - 1, 0, parts, colors);
        else return parts;
    }
