...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xbfFdEceFE0BEf5eF807E6D5239a11F351f99e585];
  address public erc20Payable = 0xbfFdEceFE0BEf5eF807E6D5239a11F351f99e585;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigwcguhzg2eq2tdfu5lpgfkoo5an6ni4jogewbr4yvnurygc7zz7a/";
...
// File: contracts/BbbContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BbbContract is RamppERC721A {
    constructor() RamppERC721A("BBB", "BAD"){}
}
