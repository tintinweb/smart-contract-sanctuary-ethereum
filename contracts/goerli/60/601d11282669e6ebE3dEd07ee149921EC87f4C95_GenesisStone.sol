    ...
    OperatorFilterer
{
        ...
        OperatorFilterer(0x0000000000000000000000000000000000000000, false)
    {
        ...
        _setDefaultRoyalty(defaultAdmin_, 1000);
    ...
    function setMythicToken(uint256 tokenId_, bool isMythic_)
        external
    ...
    /**
     * Limit the maximum number of NFTs to MAX_NFTS
     */
    ...
    function _safeMint(
        ...
        super._safeMint(to_, quantity_, data_);
    }
