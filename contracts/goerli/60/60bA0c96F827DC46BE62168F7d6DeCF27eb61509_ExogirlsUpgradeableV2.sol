...
contract Exogirls is ERC1155, IERC2981, Ownable {
    using Strings for uint256;
    string public name;
    string public symbol;
    string public contractURI;
    uint256 public totalSupply;
    address private _royalty_recipient;

    constructor() ERC1155("") {
        name = "exogirls nft test 2";
        symbol = "EXGT2";
        contractURI = "";

        totalSupply = 6000 * 10**uint256(0);
        _royalty_recipient = owner();
    }
    ...
    function mint(
        ...
        require(
            id >= 1 && id <= totalSupply,
            "Exogirls: Token ID not cannot be used"
        );
    ...
    function _setRoyalties(address newRecipient) internal {
        ...
        _royalty_recipient = newRecipient;
    }
    ...
    {
        return (_royalty_recipient, (_salePrice * 300) / 10000);
    }
...
contract ExogirlsUpgradeable is
    Initializable,
    ERC1155Upgradeable,
    IERC2981Upgradeable,
    OwnableUpgradeable,
...
contract ExogirlsUpgradeableV2 is
    Initializable,
    ERC1155Upgradeable,
    IERC2981Upgradeable,
    OwnableUpgradeable,
    ...
    UUPSUpgradeable
{
    ...
    uint256 public totalSupply;
    address private _royalty_recipient;
    uint256 private _royalty_amount;
    ...
    function setRoyaltyAmount(uint256 newAmount)
        external
        onlyOwner
        whenNotPaused
    {
        _royalty_amount = newAmount;
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice)
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        return (_royalty_recipient, (_salePrice * _royalty_amount) / 10000);
    }
