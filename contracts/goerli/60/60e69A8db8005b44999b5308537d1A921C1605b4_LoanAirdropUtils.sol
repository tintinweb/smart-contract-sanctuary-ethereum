...
library LoanAirdropUtils {
    ...
    function pullAirdrop(
        ...
        {
            IDirectLoanCoordinator.Loan
                memory loanCoordinatorData = loanCoordinator.getLoanData(
                    _loanId
                );
            ...
            if (_loan.borrower != address(0)) {
                ...
                borrower = IERC721(loanCoordinator.obligationReceiptToken())
                    .ownerOf(smartNftId);
            }
        }
    ...
    function wrapCollateral(
        ...
        IDirectLoanCoordinator.Loan memory loanCoordinatorData = loanCoordinator
            .getLoanData(_loanId);
        uint256 smartNftId = loanCoordinatorData.smartNftId;
