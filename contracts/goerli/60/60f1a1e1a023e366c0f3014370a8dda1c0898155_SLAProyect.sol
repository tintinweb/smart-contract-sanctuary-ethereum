...
//
    ...
    function calculateDownTime(string memory _circuitIdentifier, uint _startDate, uint _endDate) public view returns (uint percentage){
        ...
        uint upTimePorcentage = 100.000 - ((downtime * 1000) * 100) / (_endDate - _startDate);
        
        associatedSLA memory actualSLA = this.getActualCircuitSLA(_circuitIdentifier);
        for(uint i = 0; SLAMap[actualSLA.SLAName].length > i; i++){    //100.000 99.866 99.000 
    ...
    uint public tmpVar_1 = 0;
    uint public tmpVar_2 = 0;
    uint public tmpVar_3 = 0;
    uint public tmpVar_4 = 0;
    uint public tmpVar_5 = 0;
    uint public tmpVar_6 = 0;
    uint public tmpVar_7 = 0;
    uint public tmpVar_8 = 0;
    uint public tmpVar_9 = 0;
    uint public tmpVar_10 = 0;

    function activatedByCron() public returns (returnedPorcentages[] memory){
