...
contract Purchase {
    ...
    uint public value;
    bytes item_name;
    bytes item_price_in_ETH;
    bytes item_details;
    bytes item_description;
    ...
    constructor() payable {
        ...
        value = msg.value / 2;
        item_price_in_ETH = bytes("0.01 ETH");
        item_name = bytes("Nike Air Max 90");
        ...
        item_details = bytes("SET ITEM DETAILS Hi my name is ma");// i want to see why the fuck this shit is not working is it becasause my string is too big? well we are about to find out.";
        item_description = bytes("SET ITEM DESCRIPTION");
    ...
    function getItemPriceInETH() public view returns (bytes memory) {
        return item_price_in_ETH;
    }

    function getItemName() public view returns (bytes memory) {
        return item_name;
    }

    function getItemDetails() public view returns (bytes memory) {
        return item_details;
    }

    function getItemDescription() public view returns (bytes memory) {
