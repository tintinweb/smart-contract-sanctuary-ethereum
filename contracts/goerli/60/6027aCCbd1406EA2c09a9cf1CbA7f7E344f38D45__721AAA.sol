 ...
 * @notice This contract handles minting 721AAA tokens.
 */
contract _721AAA is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    constructor(address _blocklistContractAddress) ERC721A("721AAA", "721a") {
        ...
        originalUser
    {
        ...
        require(
            ExternalERC1155BurnContract.balanceOf(msg.sender, 23) >= amount,
