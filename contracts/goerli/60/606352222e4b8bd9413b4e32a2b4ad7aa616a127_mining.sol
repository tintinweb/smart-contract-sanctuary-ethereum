...
contract mining{
    ...
    ERC20 token = ERC20(0x8FBdf38d552480DE0b3BAF70CA727ae9DBE3D6d7);
    ERC721 my_nft = ERC721(0x356ccf6cc61f83512F384CC87C5f109ad7b70618);
    ...
    //70번 nft -> 8212134블록
    //91번 nft -> 8345523블록
    //와 같이 각 nft_id에 각각 다른 블록 넘버를 넣는 형태로 구현

    function do_mine(uint256 nft_id) public {
        if(my_nft.ownerOf(nft_id) == msg.sender){
            //last_block이라는 매핑 변수안에서 nft_id에 해당하는 블록넘버를 확인
