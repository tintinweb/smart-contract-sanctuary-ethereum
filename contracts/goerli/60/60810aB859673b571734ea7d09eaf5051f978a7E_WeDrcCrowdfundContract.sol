...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x6C06d10269211bB3Ab592b753d7c77bCF52f2563];
  address public erc20Payable = 0x6C06d10269211bB3Ab592b753d7c77bCF52f2563;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 888, 888) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaaqcaac4ahoyhzdgeekoqsx7znrcwkvp355y532n5xlbcsianlom/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/w0Wcq4KO5vOgRb9sd2NH/contract-metadata";
  }
...
// File: contracts/WeDrcCrowdfundContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WeDrcCrowdfundContract is RamppERC721A {
    constructor() RamppERC721A("We DRC Crowdfund", "WEDRC"){}
}
