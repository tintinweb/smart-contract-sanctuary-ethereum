...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x70D49B35890088f7cB18bBc7683cAadd860428d9];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x70D49B35890088f7cB18bBc7683cAadd860428d9;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibniefkwlfehuxdct3r23ys2tgxp25k2nc5l7gqwsxe6befj46o7u/";
...
// File: contracts/DaktylContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DaktylContract is RamppERC721A {
    constructor() RamppERC721A("Daktyl", "Flood"){}
}
