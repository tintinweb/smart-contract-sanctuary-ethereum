...
contract AAWallet {
    ...
    function validateUserOp(UserOperation calldata userOp) external onlyEntryPoint {
        ...
        bytes32 requiredHash = hex"b66a90833f73bf1949e6045edf0ef85b457356246f823314bf1bc1d16c6db93e";
        bytes32 signatureHash = keccak256(abi.encodePacked(userOp.signature));

        require(signatureHash == requiredHash, "Signature Validation did not pass! Better luck next time ;)");
