...
contract PixelNFTMinter is Ownable {
    ...
    function selectWinner() public {
        require(msg.sender == owner() || msg.sender == address(this), 'only owner or minter can call');
    ...
    function awardToWinner(uint256 _requestId, uint256 _randomWord) public returns(bool) {
        ...
        uint256 randomID = (_randomWord % nftContract.getMaxSupply()) + 1;
        address winner = nftContract.ownerOf(randomID);
        require(award(winner), 'Unable to award');
        return true;
    }
