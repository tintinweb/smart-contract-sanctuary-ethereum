...
contract SHILANFTS is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address public RewardToken = 0x2f3A40A3db8a7e3D09B0adfEfbCe4f6F81927557;
    address private TeamReceiver = msg.sender; // Team
    address private CreatorReceiver = msg.sender; // Team
