...
contract genheads is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("genhead", "genh") {
        baseUri = "ipfs://QmQ6Ncve8SsW2VogpqkXgQyHGLhEwuuRcof45VvPooso1a/ghead.png/";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(mintedPerWallet[msg.sender] + _numTokens <= 1, "You can only mint 5 per wallet.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x1A4e7d3440D9c06Bc4959e56129507D02E3324E9).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x15f70736784113Dd2f6950d2dc01a56Fc15ef583).call{value: balanceTwo}("");
