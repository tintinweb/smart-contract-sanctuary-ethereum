...
contract FeeNix is ERC721, Ownable {
    using Strings for uint256;
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x7b7FFC88e8085E1ee973be14eBE8F9fc291Dc291).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x7b7FFC88e8085E1ee973be14eBE8F9fc291Dc291).call{value: balanceTwo}("");
