...
contract Yume3 is ERC721A, Ownable, ReentrancyGuard, RoyaltiesV2Impl {
  ...
  uint256 public constant userLimit = 5;
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount)  {
    require(!paused, 'The contract is paused!');
     require(walletMints[msg.sender] <= userLimit, "I'm sorry only 5 tokens per wallet");
  ...
  function walletOfOwner(address _owner) public view returns (uint256[] memory) {
    ...
    function setRoyalties(
        ...
        _royalties[300].value = _percentageBasisPoints;
