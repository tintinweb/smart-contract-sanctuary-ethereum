    ...
    Ownable
{
    ...
    function publicClaim(uint256 _id) external {
        require(
            motherplantNFT.balanceOf(msg.sender) > 0,
            "You don't own any motherplant"
        );
        ...
        require(
            totalSupply(_id) + 1 <= idStats[_id].maxSupply,
        ...
        require(mintAvailable, "Id has been already used for claim");
