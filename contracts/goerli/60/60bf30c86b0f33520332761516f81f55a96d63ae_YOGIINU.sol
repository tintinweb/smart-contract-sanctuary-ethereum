...
contract YOGIINU is ERC20, Ownable {
    ...
    constructor() ERC20("YOGI INU", unicode"🐻YOGI") payable {
    	...
    	marketingWallet = address(0x003DE7390CEE6bAb6ebaa78E7F94d005a582d630); // set as Marketing wallet
        devWallet = address(0x6001D8fE27197C6e7A90b9953F824155b4231381); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x003DE7390CEE6bAb6ebaa78E7F94d005a582d630, true);
        excludeFromFees(0x6001D8fE27197C6e7A90b9953F824155b4231381, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x003DE7390CEE6bAb6ebaa78E7F94d005a582d630, true);
        excludeFromMaxTransaction(0x6001D8fE27197C6e7A90b9953F824155b4231381, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x6001D8fE27197C6e7A90b9953F824155b4231381,
            block.timestamp
        );
    }
