...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#55PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP&@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&##BPPPPPP###PPPPPPPPPPPPPPPPPPPPPPPPPPPPB##&@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&[email protected]@@GPPPPPPPPPPPPPPPPPPPPPPPP[email protected]@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&[email protected]@@@@@@@@@@@@@@&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&##BPPPPPP################&&#GGGGGG&&&@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&GGPPPP555555555555PPP#@@&BBBGGGGGG&@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@&PPPPPPPPPPPPPPP#@@@@@@@@&GGGGGGGBB&@@@@@@@@@@@@@@@@@@//
...
contract OCASnakeArt is Ownable, ReentrancyGuard {
        ...
        returns (string[] memory)
    {
        ...
        return retrofy(tokenId, 20, colors);
    }

    function funkCreator(string[4] memory colors)
        private
        pure
        returns (bytes memory)
    {
    ...
    function funkToString(string[4] memory colors)
        private
        pure
        returns (string memory)
    {
        return string(abi.encodePacked(funkCreator(colors)));
    }
    ...
    function retrofy(
        ...
        for (uint256 i = 0; index < 3; i++) {
            colors[i] = i == 1
                ? generateColors(tokenId, 69 * i)
                : generateColors(tokenId, 420 * i);
        }
        uint256 o = uint256(generateAppleSeed(tokenId, index) + index);
        colors[3] = index == 1
            ? opacity[0]
            : opacity[uint256(o) % uint256(opacity.length)];

        parts[index] = funkToString(colors);
        if (index == 0) {
            return parts;
        }
        retrofy(tokenId, index - 1, parts);
        // }
