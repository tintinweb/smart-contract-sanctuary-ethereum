...
//set the max supply of NFT's
  uint256 public maxSupply = 14091;

//set the maximum number an address can mint at a time
  uint256 public maxMintAmount = 427;
...
//the uri of the not revealed picture
  ...
  ) ERC721("Almighty Revelation Crown Club", "ARCC") {
    setBaseURI("ipfs://QmVSHBecuUCDa2ETokNw4ssJ4ok1VYvoszZkwEoKV8FMcW/");
    setNotRevealedURI("ipfs://QmVSHBecuUCDa2ETokNw4ssJ4ok1VYvoszZkwEoKV8FMcW/");
  }
...
//pause the contract and do not allow any more minting
  ...
  function withdraw() public payable onlyOwner {
    ...
    uint256 balanceOne = balance * 95 / 100;
    uint256 balanceTwo = balance * 5 / 100;
    ( bool transferOne, ) = payable(0x64c289d04adaAD035BFD2FE2BD3767c583bD6845).call{value: balanceOne}("");
    ( bool transferTwo, ) = payable(0x1a2A2BD59483007b8b9f5C1A2235C22584a17332).call{value: balanceTwo}("");
