    ...
    DefaultOperatorFilterer
{
    ...
    uint256 presaleAmountLimit = 6;
    uint256 publicAmountLimit = 10;

    mapping(address => uint256) public _presaleClaimed;

    uint256 _preSalePrice = 3300000000000000; // 0.0033 ETH
    uint256 _ownerPrice = 0;
    uint256 _publicPrice = 5000000000000000; // 0.005 ETH
