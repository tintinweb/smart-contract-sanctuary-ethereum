...
contract ArbitrageHelper is Initializable, IArbitrageHelper {
    ...
    function swapByUniswapWithFlashLoan(uint256 orderId, address tokenA, address tokenB, uint256 tokenBAmount, bytes memory path) public {
        ...
        console.log("Start flash", tokenB, address(EXCHANGE), tokenBAmount);
        IERC20(tokenB).approve(address(EXCHANGE), tokenBAmount);
...
//        console.log(decoded.tokenBAmount);
//        console.log(address(EXCHANGE));
//        IERC20(decoded.tokenB).approve(address(EXCHANGE), decoded.tokenBAmount);
        (uint256 tokenAReceived, uint256 outAmount) = EXCHANGE.fillOrder(
            decoded.orderId,
            decoded.tokenBAmount,
            decoded.recipient,
            false
        );
