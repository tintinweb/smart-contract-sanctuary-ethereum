...
contract SpaceLP is ERC20 {
    ...
    function deposit(address to) external {
        ...
        uint256 addedEth = ethBalance - ethReserve;
        uint256 addedSpaceCoin = spaceCoinBalance - spaceCoinReserve;
        ...
        if (_totalLiquidity == 0) {
            ...
            // else add liquidity
            uint256 liquidityEth = (_totalLiquidity * addedEth) / ethReserve;
