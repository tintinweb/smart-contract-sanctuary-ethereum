...
contract NRFFCollectible is ERC721, Ownable {
    ...
    uint256 public presaleDate = 1658346327;
    uint256 public saleDate = 1658446327;

    uint256 public TOKEN_PRICE = 2000000000000000; // 0.02 ETH
    uint256 public PRESALE_PRICE = 2000000000000000; //0.02 ETH
    ...
    string private baseURI = "https://flappyfks.mypinata.cloud/ipfs/QmYHYmVtXofQfBnJVMRN1VtLndAATgkkz4gFBeYaNRj3XF/";
    ...
    function updatePresalePrice(uint256 price) external onlyOwner {
        PRESALE_PRICE = price;
    }
}
