...
/// @title The XNouns ERC-721 token
...
contract NounsToken is INounsToken, Ownable, ERC721Checkpointable {
    ...
    // An address who has permissions to mint XNouns
    address public minter;

    // The XNouns token URI descriptor
    INounsDescriptorMinimal public descriptor;

    // The XNouns token seeder
    ...
    /**
     * @notice Mint a XNoun to the minter, along with a possible nounders reward
     * XNoun. Nounders reward XNouns are minted every 10 XNouns, starting at 0,
     * until 183 nounder XNouns have been minted (5 years w/ 24 hour auctions).
    ...
    /**
     * @notice Mint a XNoun with `nounId` to the provided `to` address.
     */
