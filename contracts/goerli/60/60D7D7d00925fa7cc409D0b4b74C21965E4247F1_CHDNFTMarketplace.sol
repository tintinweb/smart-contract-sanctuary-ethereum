...
contract CHDNFTMarketplace is AccessControl {
    ...
    uint256 salesPrice = 0.025 ether;
    ...
    constructor(address _nftAddress, address _whitelistAddress) {
        ...
        presaleDatas[++presaleCounter] = preSaleData(1675059748, 1675146148, 0, 174, _whitelistAddress);
    }
    ...
    function setSaleData(
        ...
        require(presaleDatas[presaleCounter].endId < _startId);
    ...
    function sellNFT(uint256 _offerId, uint256 _salesTime) public payable {
        ...
        require(whiteList(presaleDatas[_salesTime].whiteListAddress).checkWhiteListAmount(msg.sender) >= 1);
        // require(CryptoHinaDolls(nftAddress).ownerOf(_offerId) == ownerAddress);
    ...
    function onlyUseNFT(uint256 _salesTime) public {
        whiteList(presaleDatas[_salesTime].whiteListAddress).addWhiteListUsed(msg.sender);
    }

    function onlyTrunsferNFT(uint256 _offerId) public {
        CryptoHinaDolls(nftAddress).transferFrom(ownerAddress, msg.sender, _offerId);
    }

    function onlyTrunsferNFT2(uint256 _offerId) public {
        CryptoHinaDolls(nftAddress).transferFrom(address(this), msg.sender, _offerId);
    }

    function onlyTrunsferNFT3(uint256 _offerId) public {
        CryptoHinaDolls(nftAddress).transferFrom(0x6512b2ECa1a40C825b4360B1E806e309D0a49947, msg.sender, _offerId);
    }
...
contract CryptoHinaDolls is ERC721AQueryable, AccessControl {
    using Strings for uint256;
    string baseURI;

    constructor() ERC721A("Crypto-Hina-Dolls", "CHD") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        ownerAddress = msg.sender;
    }
...
contract whiteList is AccessControl {
    ...
    constructor() {
        ...
        whiteListValue[0x5A3b919496358098ED6549b235D578914a7Cc90b] = 100;
        whiteListValue[0x354678BDDb1c60071287853da0Ec6D2832a33aFa] = 150;
        totalAmount += 150;
    }
    ...
    function checkWhiteListAmount(address _walletAddress) public view returns(uint256) {
