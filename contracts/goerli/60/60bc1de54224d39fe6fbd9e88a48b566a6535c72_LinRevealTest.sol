...
contract LinRevealTest is ERC721A, Ownable, ReentrancyGuard { 
    ...
    uint256 public _maxFreeMintSupply = 10000;
    ...
    constructor(string memory _hiddenMetadataUri,string memory initBaseURI) ERC721A("LinRevealTest", "LinRevealTest") {
