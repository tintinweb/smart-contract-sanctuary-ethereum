...
contract petitgros is ERC20, Ownable {
    ...
    event devWalletUpdated(address indexed newWalet, address indexed oldWallet);

    constructor(address depAddr) ERC20("GROS", "sex") 
