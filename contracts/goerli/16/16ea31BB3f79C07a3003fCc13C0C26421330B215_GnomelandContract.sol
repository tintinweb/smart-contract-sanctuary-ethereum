...
//     
//    ______                           __                __
//   / ____/___  ____  ____ ___  ___  / /___ _____  ____/ /
//  / / __/ __ \/ __ \/ __ `__ \/ _ \/ / __ `/ __ \/ __  / 
// / /_/ / / / / /_/ / / / / / /  __/ / /_/ / / / / /_/ /  
// \____/_/ /_/\____/_/ /_/ /_/\___/_/\__,_/_/ /_/\__,_/   
//                                                         
//                                                                                                    
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x2a34444eC8fc853035563A5E1E7f9A4792454014];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x2a34444eC8fc853035563A5E1E7f9A4792454014;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.01 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmQAiceca6yafhaJBJGAYAb4HWvEHaZ5ab35Tpq9cpqokz/";
...
// File: contracts/GnomelandContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GnomelandContract is RamppERC721A {
    constructor() RamppERC721A("Gnomeland ", "Gnome"){}
}
