...
contract Emily is Ownable, ERC721ACommon {
    ...
    uint256 private mintCostPublicSale = 0.1 ether;
    ...
    address payable public daoWallet =
        payable(0x4864A4DAb5072541d47C6fc27Bb56d84c4EfBcdA);
    address payable public incubationWallet =
        payable(0xC7086517dEAd1157cBa2133288d68ABA7D5FD8Cc);
    address payable public marketingWallet =
        payable(0xB653f6Bbc877F81195FEE9e94Dc52E3804DA38ab);
    address payable public devWallet =
        payable(0x2636Fd75297F75ba02c7f423f8C5826527Fc20eD);
    ...
    function genesisMint(
        ...
        require(saleState_ == State.GenesisSale, "Not in Genesis Sale!");
        require(
    ...
    function presaleMint(
        ...
        State saleState_ = saleState();
        require(saleState_ == State.Presale, "Not in Presale!");
        require(
            numberOfTotalTokens + number <= maxTokensPresale,
            "Not enough NFTs left to mint.."
        );
        require(
            mintsPerAddress[msg.sender] + number - maxMintGenesis <=
    ...
    @return total Total period of time for which the Emily has nested across
    ...
    /**
    @dev Emitted when an Emily is expelled from the nest.
     */
    ...
    */
    ...
    /**
    @notice Changes the Emilies staking status (what"s the plural of status?
    statii? statuses? status? The plural of sheep is sheep; maybe it"s also the
    plural of status).
    @dev Changes the Emilies" staking sheep (see @notice).
     */
    ...
    /**
    @notice Admin-only ability to expel an Emily from the nest.
    ...
    function expelFromStaking(uint256 tokenId) external onlyOwner {
        require(stakingStarted[tokenId] != 0, "Emily: not nested");
