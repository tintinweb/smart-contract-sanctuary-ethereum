...
/// @title An ERC712AQueryable contract for NFTs that is backwards compatible with ERC721A and ERC721. 
...
contract SpacePawz is ERC721AQueryable, Ownable, ReentrancyGuard {

    // Optimization note: declare like types next to each other to compact storage slots    
    // Use private whenever possible instead of public for vars that are used in repetitive actions
    // Using private vars saves gas since public vars have getters defined and private do not
    // Add public view getters for the private vars if necessary
    ...
    /// @dev This function allows the owner to reserve and provision tokens for stakeholders before the sale is active. 
