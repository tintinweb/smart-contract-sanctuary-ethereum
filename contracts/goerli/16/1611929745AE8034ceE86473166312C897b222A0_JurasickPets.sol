...
contract JurasickPets is ERC721A, Ownable, ReentrancyGuard {
    ...
    function checkVestingStep() internal view returns (bool) {
        ...
        if (vestingStep == 1 && block.timestamp > 1652287919) return true; // Now ... for test ...
        if (vestingStep == 2 && block.timestamp > 1652287919) return true; // Now ... for test ...
        if (vestingStep == 3 && block.timestamp > 1652287919) return true; // Now ... for test ...
        if (vestingStep == 4 && block.timestamp > 1652287919) return true; // Now ... for test ...
        if (vestingStep == 5 && block.timestamp > 1652287919) return true; // Now ... for test ...
