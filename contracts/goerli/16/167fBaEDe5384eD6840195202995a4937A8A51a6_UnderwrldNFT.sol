...
// Amended by Omega Studios LLC
/**

    !Disclaimer!
TODO add external instead of public to save gas
...
//Supply & Pricing Declarations/Definitons
  ...
  uint256 public maxSupply = 5000;  //check = 5000
  uint256 public freeSupply = 500; //check = 500
  uint256 public maxPublicMintSupply   = 4500; //check  = 4500
  uint256 public allowListSupply = 0;  //check = 0
  uint256 public maxMintAmountPerTx  = 10;  //check  = 10
...
//Contract Control Declarations
  ...
  constructor() ERC721("UNDRWRLD", "UWD") {
    setHiddenMetadataUri("ipfs://QmdCGQ8PYEprhHA1SmUQVN3ho4Lq9eaqQMY5Uno5MAiGX9/hidden.json"); // "ipfs://QmZzG5apdFYDuq82eZRzrgSNcP6ehjSBQ96cT9nQD5gp8H/.json"
  }
...
//set adddress allowlist/.  populate allowlist 
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(mintedPerWallet[msg.sender] + _mintAmount <= 20, "you can only mint 10 per wallet");
