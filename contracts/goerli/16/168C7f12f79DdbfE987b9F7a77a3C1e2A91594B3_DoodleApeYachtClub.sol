...
contract DoodleApeYachtClub is ERC721A, Ownable {
    ...
    uint256 public WL_TOKEN_PRICE = 0.0125 ether;
    uint256 public PUBLIC_TOKEN_PRICE = 0.0125 ether;
    ...
    uint256 public TOTAL_FREE_MINT;
    ...
    {
        require(this.totalSupply() + quantity <= MAX_SUPPLY, "Mint exceeds max supply");
        require(quantity + TOTAL_FREE_MINT <= MAX_FREE_SUPPLY, "Amount exceeds max free mint supply");
