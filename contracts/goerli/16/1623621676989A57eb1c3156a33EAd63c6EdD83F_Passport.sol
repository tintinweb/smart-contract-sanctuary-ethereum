...
contract Passport {
    ...
    function setPassportDetailEventOnly(string memory _hashId, string memory _name, uint _age, string memory _sex) public returns(bool) {
    ...
    function getPassPortRepo(string memory _hashId) public view returns (passport memory) {
        return passportRepo[_hashId];
    }
