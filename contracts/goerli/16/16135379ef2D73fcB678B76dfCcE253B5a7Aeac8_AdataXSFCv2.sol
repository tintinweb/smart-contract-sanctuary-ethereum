    ...
    UUPSUpgradeable
{
    ...
    modifier onlyBidder() {
        ...
        require(_bidder == msg.sender, "Permission error: not bidder");
        _;
    }
    ...
    function initialize() public initializer {
        __ERC721_init("XPG Xtreme Saga Fan Club v2", "XSFCv2");
    ...
    function rareMint(address to)
        ...
        onlyBidder
    {
        require(msg.value >= _bidPrice, "Runtime error: ether not enough");
        require(!_exists(1), "Runtime error: already minted");
        _mint(to, 1);
        emit Minted(to, 1);
    }

    function mint(address to, uint256 quantity) external onlyMinter {
        uint256 reversed = _exists(1) ? 0 : 1;
        require(
    ...
    function bidPrice() public view returns (uint256) {
        return _bidPrice;
    }
        ...
        returns (string memory)
    {
        ...
        return _shown ? _tokenURI(tokenId) : _blindboxURI(tokenId);
    }
    ...
    function switchShown() external onlyOwner {
        _shown = !_shown;
    }
