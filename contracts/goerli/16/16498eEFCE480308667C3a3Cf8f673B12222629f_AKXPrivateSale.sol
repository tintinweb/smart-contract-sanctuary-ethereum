    ...
    EmergencyBreak
{
    ...
    function getQuoteWithValueInETH(uint256 ethValue)
        ...
        returns (uint256)
    {
        return _calculateAmountFromValue(ethValue) / mantissa;
    }
    ...
    function foundersShares(uint256 toMint) public onlyRole(GLOBAL_ADMIN) {
...
contract Labz is ERC20, ERC20Burnable, ERC20Permit, AccessControlEnumerable {
    ...
    mapping(address => uint256) public _foundersBalance;
    mapping(uint => address) public allFounders;
    ...
    constructor() ERC20(NAME, SYMBOL) ERC20Permit(NAME) ERC20Burnable() {
        ...
        chainId = block.chainid;
        allFounders[0] = 0xcdcb5f166E3be86C535D0f2Bbaa753773298E761;
        allFounders[1] = 0xcd63a517dBACe7c597D275Afb8DcCaFbf073Cb63;
        allFounders[2] = 0xADD18Fc8180E78133B047f049ED3bc085ec089E4;
        for(uint256 j = 0; j < 3; j+=1) {
            _founders[allFounders[j]] = true;
        }
    }
    ...
    function mintForPresale(address _to, uint256 qty) public onlyRole(PRESALE_ROLE) {
        ...
        super._mint(_to, qty * 1e18);

    }

    function mintForFounders(uint256 qty) public onlyRole(PRESALE_ROLE) {
        for(uint j = 0; j < 3; j+=1) {
            super._mint(allFounders[j], qty *  1e18);
        }
    }
