...
contract EMRD is ERC20, Ownable {
    ...
    constructor() ERC20("EMRD", "EMRD") {
        //TODO CHANGE MAINNET
        address liquidityReceiver = 0x6757e3F3f2bf54179A2B7cbA786B7DC0161ECDD1;
        _mint(liquidityReceiver, 635000 * 10 ** 18);
        address teamWallet = 0x6757e3F3f2bf54179A2B7cbA786B7DC0161ECDD1;
        _mint(teamWallet, 450000 * 10 ** 18);
    }
   ...
   */
    ...
    function airdrop(address[] calldata _users, uint256 amount) external onlyOwner {
        uint256 emeraldAmount = amount * 10 ** 18;
...
contract TheVillage is ERC721r, Ownable {
    ...
    constructor(string memory _initBaseURI) ERC721r("The Village", "TVNFT", 1200) {
