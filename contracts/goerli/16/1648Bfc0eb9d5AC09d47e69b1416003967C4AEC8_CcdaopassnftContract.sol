...
//*********************************************************************//
//
//   ________________  ___   ____     ____  ___   __________      _   ______________
//   / ____/ ____/ __ \/   | / __ \   / __ \/   | / ___/ ___/     / | / / ____/_  __/
//  / /   / /   / / / / /| |/ / / /  / /_/ / /| | \__ \\__ \     /  |/ / /_    / /   
// / /___/ /___/ /_/ / ___ / /_/ /  / ____/ ___ |___/ /__/ /    / /|  / __/   / /    
// \____/\____/_____/_/  |_\____/  /_/   /_/  |_/____/____/    /_/ |_/_/     /_/     
//                                                                                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xAA03bD7907ff976b217c6c4F54D79352d4eFe5E7];
  address public erc20Payable = 0xAA03bD7907ff976b217c6c4F54D79352d4eFe5E7;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://nft.ccdao.club/https://nft.ccdao.club/metadata/json/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Qn6oBggaE6VfFn6zVgso/contract-metadata";
  }
...
// File: contracts/CcdaopassnftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CcdaopassnftContract is ERC721APlus {
    constructor() ERC721APlus("CCDAO PASS  NFT", "CPN"){}
}