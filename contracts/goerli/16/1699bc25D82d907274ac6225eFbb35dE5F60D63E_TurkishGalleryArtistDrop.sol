...
import './TurkishGalleryArtistDropBase.sol';
import './TurkishGalleryArtistDropSplitsAndRoyalties.sol';
...
/**
 * @title TurkishGalleryArtistDrop
 */
contract TurkishGalleryArtistDrop is
    TurkishGalleryArtistDropSplitsAndRoyalties,
    TurkishGalleryArtistDropBase,
    ERC721TransferableHolder
{
    constructor()
        TurkishGalleryArtistDropBase(
            'TurkishGalleryArtistDrop',
            'TGAD',
            'https://nftc-media.mypinata.cloud/ipfs/QmPVf1U5SN4k9JRTSs1iEHSEWFdCnRJCw1HyQSFSApRMGk/', // TODO: NFTCulture gateway
            addresses,
            splits
        )
        ERC721TransferableHolder(address(this))
    {
        ...
        _setMerkleRoots(
            0x0fbf76d248751f80ba28bfffc569ae6ae517b751f70cfa83cfb3de68a5bd9824,
            0x5abf6f348d3a38ac6bec81a51134be4a24044996c279489dd9e67f84b0330815
        );
    }
    ...
    // 1 -> 30 (Unique Tokens)
    // 31 -> 38 (Set)
    function premintUniqueTokens(uint256 start, uint256 end, uint256 count) external onlyOwner {
        ...
        for (uint256 i = start; i <= end; i++) {
            ...
            _internalMintTokensOfFlavor(address(this), count, flavorInfo.flavorId);
        }
    }
}
    ...
    PhaseTwoIsIndexed
{
    ...
    uint256 private constant PHASE_ONE_PURCHASE_LIMIT = 321; // Not Used

    uint256 private constant PHASE_TWO_BATCH_SIZE = 10;
    uint256 private constant PHASE_TWO_PURCHASE_LIMIT = 321; // Not Used
    ...
    function premintTokens(address friend, uint256 count, uint256 flavorId) external {
        ...
        FlavorInfo memory updatedFlavor = _canMint(count, flavorId, false, 0);
...
contract TurkishGalleryArtistDropSplitsAndRoyalties is ERC2981 {
    address[] internal addresses = [
        0x123400000000000000000000000000000000FAde, // Fake Project Wallet
        0x05Ed4cf991c4ed7606930AB54dDbF27836C1f590 // Team Wallet
    ];

    uint256[] internal splits = [80, 20]; // Fake Splits
