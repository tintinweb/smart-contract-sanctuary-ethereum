...
import {Brainy} from "../src/Brainy/Brainy.sol";

contract DeployBrainy is Script {
    ...
    function deploy() public returns (address) {
        bytes32 rootHash = 0xd003ecd4def56cc74d5c32948fca03c31351be30a4937cb769b3f13b58f1096e;

        // Deploy the Brainy contract
        console.log("Deploying Brainy....");
        ...
        console.log("Brainy Deployed", address(brainy));

        return address(brainy);
    }
}
