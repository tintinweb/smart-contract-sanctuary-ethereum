...
contract OracleConsumer is DataConsumerV3 {
    ...
    function get_LB_rate() public view returns (uint256){
        return uint256(_LB_Oracle._last_updated_rate());
    }
    function get_chainlink_rate() public view returns (uint256){
        return uint256(getLatestData());
    }
    function update() public {
        uint256 Chainlink_rate = get_chainlink_rate();
        uint256 LB_rate = get_LB_rate();
