    ...
    Initializable 
{
    ...
    bytes32 internal _LEND_TYPEHASH;
    ...
    function _deriveTypeHashes() internal view returns (
        bytes32 nameHash,
        bytes32 versionHash,
...
contract BasicLendInterface {
     ...
     * Lender
     */
    function proposeConfirm(BasicLendParameters calldata parameters) external virtual payable returns (bool confirmed){}

    function withdraw(BasicLendParameters calldata parameters) external virtual payable returns (bool withdrawed){}
    ...
    function proposePayment(BasicLendParameters calldata parameters) external virtual payable returns (bool paid){}

    function getProposeOffer(bytes32 lendHash) external virtual view returns (
        address _lender,
        address _tokenOwner,
...
contract BasicLendRealize is BasicLendValidator {
    ...
    function __BasicLendRealize_init() internal onlyInitializing {
        __BasicLendRealize_init_unchained();
    }

    function __BasicLendRealize_init_unchained() internal onlyInitializing {
        __BasicLendValidator_init();
    }

    function _proposeConfirm(BasicLendParameters calldata parameters) internal returns (bool valid) {
    ...
    function _withdraw(BasicLendParameters calldata parameters) internal returns (bool valid) {
    ...
    function _repayment(BasicLendParameters calldata parameters) internal returns (bool valid) {
    ...
    function _repaymentBasicFulfillment(BasicLendParameters calldata parameters) internal {
    ...
    function _prepareBasicFulfillment(BasicLendParameters calldata parameters) internal {
...
contract BasicLendUpgradeable is 
    BasicLendInterface, 
    BasicLendRealize,
    OwnableUpgradeable,
    UUPSUpgradeable
{
    ...
    function proposeConfirm(BasicLendParameters calldata parameters) external payable override returns (bool confirmed) {
        confirmed = _proposeConfirm(parameters);
    }

    function withdraw(BasicLendParameters calldata parameters) external payable override returns (bool withdrawed) {
        withdrawed = _withdraw(parameters);
    }

    function proposePayment(BasicLendParameters calldata parameters) external payable override returns (bool paid) {
...
contract BasicLendValidator is Executor {
    ...
    function __BasicLendValidator_init() internal onlyInitializing {
        __BasicLendValidator_init_unchained();
    }

    function __BasicLendValidator_init_unchained() internal onlyInitializing {
        __Executor_init();
    }
    ...
    function _updateLendHashFulfilled(
        bytes32 lendHash
    ) internal {
    ...
    function _withdrawERC721ToOriginalOwner(
        ...
        _transferERC721(token, address(this), msg.sender, tokenIdentifier, true);
    }
    ...
    function _withdrawERC721ToLender(
        ...
        LoanerComponents storage loaner = _loaner[lendHash];
        uint256 amountPaid = loaner.amountPaid;
    ...
    function _validateAndUpdateRepayment(
        ...
        if (totalAmount == updateAmountPaid) {
            _loaner[lendHash] = LoanerComponents(
                updateAmountPaid,
                true
            );
...
contract Derivers is Base {
    ...
    function __Derivers_init() internal onlyInitializing {
        __Derivers_init_unchained();
    }

    function __Derivers_init_unchained() internal onlyInitializing {
        __Base_init();
    }
...
contract Executor is 
    ...
    TokenTransferrer 
{
    function __Executor_init() internal onlyInitializing {
        __Executor_init_unchained();
    }

    function __Executor_init_unchained() internal onlyInitializing {
        __Verifiers_init();
    }
    ...
    function _transferERC721(
        ...
        _performERC721Transfer(token, from, to, identifier, approvalToCurrentOwner);
    }
...
contract Verifiers is 
    Derivers,
    SignatureVerification
{
    function __Verifiers_init() internal onlyInitializing {
        __Verifiers_init_unchained();
    }

    function __Verifiers_init_unchained() internal onlyInitializing {
        __Derivers_init();
    }

    function _verifyTime(uint256 endTime, bool revertOnInvalid) internal view returns (bool valid) {
    ...
    function _verifyExceedTime(uint256 endTime, bool revertOnInvalid) internal view returns (bool valid) {
        if (endTime >= block.timestamp) {
            if (revertOnInvalid) {
    ...
    function _verifyLendStatus (
        bytes32 lendHash,
        LendStatus storage lendStatus
