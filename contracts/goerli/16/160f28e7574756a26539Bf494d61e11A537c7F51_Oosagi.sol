...
contract Oosagi is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public baseTokenOORI;
    string public defaultTokenOORI;
    ...
    constructor(
        ...
        baseTokenOORI = baseTokenURI_;
        defaultTokenOORI = defaultTokenURI_;
    ...
    function setDefaultURI(string calldata _newDefaultURI)
        ...
        onlyOwner
    {
        defaultTokenOORI = _newDefaultURI;
    }
