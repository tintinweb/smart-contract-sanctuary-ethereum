...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint256 private mintToOwnerAmount = 1; //9
  uint256 private percentAfterMarketSales = 5; //9
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    (bool success, ) = payable(owner()).call{value: msg.value * percentAfterMarketSales / 100}("");
    require(success);
  }
