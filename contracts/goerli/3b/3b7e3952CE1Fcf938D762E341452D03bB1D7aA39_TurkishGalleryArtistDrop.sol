    ...
    ERC721TransferableHolder
{
    ...
    function _claimTokenViaTransfer(uint256 tokenId, uint256 flavorId, address to) internal {
        ...
        require(_getFlavorForToken(tokenId) == flavorId, 'Mismatched id and flavor');
        ...
        require(uniqueFlavor.maxSupply > 1, 'Only used for One of Ones.');
...
contract TurkishGalleryArtistDropSplitsAndRoyalties is ERC2981 {
    address[] internal addresses = [
        0x123400000000000000000000000000000000FAde, // Fake Studio Wallet
