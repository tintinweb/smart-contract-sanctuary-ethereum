...
import "../../tokens/DEINToken.sol";

contract DEINMock is DEINToken {
    constructor() DEINToken(msg.sender) {}

    function mintArbitrary(address _to, uint256 _amount) external {
        require(_amount <= 1_000_000 ether, "DEINMock: Can't mint that amount");
...
contract DEINToken is ERC20Permit {
    ...
    uint256 constant TOTAL_SUPPLY = 1 * (10**9) * (10**18);
