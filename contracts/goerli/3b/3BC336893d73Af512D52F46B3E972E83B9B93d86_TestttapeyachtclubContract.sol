    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiakbussx3pxnuixtjb7hkz43piv56b6nqulhwzh7qmelpcjck62uy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/FZX8Bjzhyx4uA5SNzyFF/contract-metadata";
  }
...
// File: contracts/TestttapeyachtclubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestttapeyachtclubContract is RamppERC721A {
    constructor() RamppERC721A("testtt ape yacht club", "TTTAYC"){}
}
