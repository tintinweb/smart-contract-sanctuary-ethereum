...
contract testi2 is StandardToken {

  string public constant name = "testi12"; // solium-disable-line uppercase
  string public constant symbol = "TESTI2"; // solium-disable-line uppercase
