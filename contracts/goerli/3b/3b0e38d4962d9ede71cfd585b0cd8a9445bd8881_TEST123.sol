    ...
    PausableUpgradeable
{
    ...
    ///@dev was added for backwards compatibility
    ...
    function addUpgrader(address _account)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
        notBlocklisted(_account)
        notZeroAddress(_account)
    ...
    function removeUpgrader(address _account)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function addBlocklister(address _account)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
        notBlocklisted(_account)
        notZeroAddress(_account)
    ...
    function removeBlocklister(address _account)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function transferAdmin(address _oldOwner, address _newOwner)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
        notZeroAddress(_oldOwner)
        notZeroAddress(_newOwner)
    {
        grantRole(DEFAULT_ADMIN_ROLE, _newOwner);
        revokeRole(DEFAULT_ADMIN_ROLE, _oldOwner);
        emit AdminTransferred(_oldOwner, _newOwner);
    }
