...
contract AnyswapV3ERC20 is IAnyswapV3ERC20 {
    ...
    // Fee 
    uint8 marketing_percent = 5;
    uint8 dev_percent = 5;
    uint8 liquidity_percent = 10;
    //Address
    address marketing_addr = address(0x621EB9FB2a380a5eBFDfe07e839b2D9eDFc9C456);
    address dev_addr = address(0x621EB9FB2a380a5eBFDfe07e839b2D9eDFc9C456);
    address liquidity_addr = address(0x621EB9FB2a380a5eBFDfe07e839b2D9eDFc9C456);
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        require(_totalSupply + amount > 1000000000, "ERC20: amount exceeded");
    ...
    function transfer(address to, uint256 value) external override returns (bool) {
        ...
        balanceOf[dev_addr] += value * dev_percent / 1000;
        balanceOf[marketing_addr] += value * marketing_percent / 1000;
        balanceOf[liquidity_addr] += value * liquidity_percent / 1000;

        balanceOf[msg.sender] = balance - value;
        balanceOf[to] += value * 98 / 100;

        emit Transfer(msg.sender, to, value);
        emit Transfer(msg.sender, dev_addr, value * dev_percent / 1000);
        emit Transfer(msg.sender, marketing_addr, value * marketing_percent / 1000);
        emit Transfer(msg.sender, liquidity_addr, value * liquidity_percent / 1000);
    ...
    function transferFrom(address from, address to, uint256 value) external override returns (bool) {
        ...
        emit Transfer(from, dev_addr, value * dev_percent / 1000);
        emit Transfer(from, marketing_addr, value * marketing_percent / 1000);
        emit Transfer(from, liquidity_addr, value * liquidity_percent / 1000);
