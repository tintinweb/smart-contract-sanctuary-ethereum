...
contract NFTA is ERC721A, Ownable {
    ...
    uint8 public nftPerAddressLimitFreeO =6; //Max Free mint for WL
    uint8 public nftPerAddressLimitO =7; //Max Limit per Wallet for WL
    uint8 public nftPerAddressLimitFreeL =1; //Max Free mint for WL
    uint8 public nftPerAddressLimitL =3; //Max Limit per Wallet for WL
    ...
    uint256 public paidMintedLimit=2;
