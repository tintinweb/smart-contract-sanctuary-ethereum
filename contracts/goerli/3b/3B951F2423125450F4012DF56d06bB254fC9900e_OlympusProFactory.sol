...
/// @author @aagbotemi
/// @author @Adebara123
/// @notice The CustomBond contract is deployed from OlympusDAO's factory contract, OlympusProFactory. It takes cares of the bonding mechanism such as bond purchase and the redemption of payout tokens.
