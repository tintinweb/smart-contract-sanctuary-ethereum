...
// File: contracts/coinFlipStorage.sol
...
contract coinFlipStorage {
    ...
    modifier betConditions() {
        ...
        require(
            msg.value <= contractBalance / 2,
            "Can't bet more than half the contract's balance!"
        );
        require(
...
// File: contracts/FlipManager.sol
    ...
    ReentrancyGuard
{
    ...
    function fulfillRandomWords(
        ...
        base(baseContract).checkResult(randomResult, _requestId);
...
/**
 * @title CoinFlip
 * @notice Coin flip base contract
 * @author decpinator.eth
 */
contract CoinFlip is FlipManager {
    /**
     * @notice constructor
    ...
    /**
     * @notice Place a bet
     * @param _betChoice tail or head bet
     **/
    function bet(uint256 _betChoice) public payable betConditions nonReentrant {
        ...
        uint256 requestId = FlipManager.requestRandomWords();
    ...
    /**
     * @notice Check result and update balances
     * @param _randomResult Result from chainlink vrf
     * @param _requestId
     **/
    function checkResult(uint256 _randomResult, uint256 _requestId)
        internal
    ...
    /**
     * @notice deposit eth to increase contract balance
     **/
    ...
    /**
     * @notice Get player unClaimed balance
     **/
    ...
    /**
     * @notice Withdraw the available contract balance eth and link
     **/
    ...
    /**
     * @notice Payout the available balance in eth
     **/
