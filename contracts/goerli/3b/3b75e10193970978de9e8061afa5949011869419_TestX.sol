...
contract TestX is ERC721A, Ownable, ReentrancyGuard, Pausable{

    // token-sale mint variables
    uint256 public pumlxMaxMint = 20;
    uint256 public pumlPrice = 2500 * (10**18);
    ...
    function handlePumlx(uint256 _quantity) external payable whenNotPaused nonReentrant {    
        ...
        // mint will be called off chain through ether js
    }
