...
contract ProxyIDO{
    ...
    function createIDO(address  _tokenA,
                         address  _tokenB,
                         uint256  _decimal)  public returns (address,address,address) {
        ...
        IDO contractAddr =  new IDO(_tokenA,_tokenB,_decimal,msg.sender,adminAddr);
