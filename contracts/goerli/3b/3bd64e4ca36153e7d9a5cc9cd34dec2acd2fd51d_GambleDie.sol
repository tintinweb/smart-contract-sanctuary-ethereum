...
contract GambleDie is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Gamble Die";
    string private _symbol = "GDie";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xBdeF6C4d0A1B764fb32ed50f392960B6F55eAe7f);
    address payable public DeveloperWallet = payable(0x5f8edDB6738F192b76259A8AeBdDF4e184BF1515);
    ...
    uint256 public minimumTokensBeforeSwap = _totalSupply.mul(1).div(1000000);   //0.0001%
    ...
    function enableTransactionLimit(bool _status) external onlyOwner {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 totalSharesFee = _totalTaxIfBuying.add(_totalTaxIfSelling);
        ...
        uint256 tokenForLp = tAmount.mul(liquidityShare).div(totalSharesFee).div(2);
        ...
        uint256 totalETHFee = totalSharesFee.sub(liquidityShare.div(2));
