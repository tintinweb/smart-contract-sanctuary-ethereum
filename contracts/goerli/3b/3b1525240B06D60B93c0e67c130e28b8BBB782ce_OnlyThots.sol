...
contract OnlyThots is ERC721A, ERC2981, Ownable,DefaultOperatorFilterer,ReentrancyGuard {
    bytes32 public merkleRootWL=0xac3264a12bc18716a8dbcae5138677c51d746c6f28225f68d99a89814514fc9b;
    string public baseURI="ipfs://bafybeicobg7rtufxjl33yauoyhz3727asnt7csvejobfizonxa5x5xth6q/";
    string public tokenSuffix=".json";
    string public unrevealedURI="ipfs://bafkreid56stmw5zzz74aqmnbjjl657mijavqbhnitqkgcohirotfrjaffy/";
    bool public isRevealed = false;
    uint256 public MAX_MINT_PUBLIC = 2;
    uint256 public MAX_MINT_WHITELIST = 2;
    uint256 public maxTokens = 222;
    ...
    //constructor
    constructor() ERC721A("OnlyThots", "OnlyThots") {
       setRoyalties(payoutAddress,750);
    }

    /* MINTING */
    function mintFromWhiteList(uint256 numberOfTokens,bytes32[] calldata _merkleProof) external payable nonReentrant{
