...
contract MvM is ERC721A, Ownable {
    ...
    bool public pauseMintL2 = false;
    bool public pauseMintL3 = false;
    ...
    function add50ToL1() public payable {
        for (uint256 index = 0; index < 50; index++) {
            mvmL1Tokens.push(index);
        }
    }
        ...
        if (_level == 1) {
            ...
            TransformInfoLevelThree
                memory transformInfoLevelThree = TransformInfoLevelThree(
                    msg.sender,
                    transformInfoLevelTwoByTokenId[_mvmL2TokenId]
                        .mvmLevelOneTokenId,
                    _mvmL2TokenId,
    ...
    function mint(
        ...
        obyclabs.safeTransferFrom(
            address(msg.sender),
            address(0xEa5BB994bF067Ce974D1b9E90fC371EAEEd1CFCC),
            _obycLabTokenId,
            1,
            localBytes
        );
    ...
    // Set base URI of metadata (an IPFS URL) =======================
    function setBaseURILevelTwo(string memory _newBaseURILevelTwo)
        public
        onlyOwner
    {
    ...
    // Set base URI of metadata (an IPFS URL) =======================
    function setBaseURILevelThree(string memory _newBaseURILevelThree)
        public
        onlyOwner
    {
