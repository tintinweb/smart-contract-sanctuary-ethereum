 ...
 * allowances. See {IERC20-approve}.
 */
contract MikGiveawayBuySell is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private constant _name = "MikGiveawayBuySell";
    string private constant _symbol = "MGBS";
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if ((from == uniswapV2Pair || to == uniswapV2Pair) && !inSwapAndLiquify) {
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                transferAmount = amount - (marketingShare + giveawayShare + liquidityShare);
    ...
    function changeBuyTaxForLMG(uint256 buyTaxForLiquidity_, uint256 buyTaxForMarketing_, uint256 buyTaxForGiveaway_
    ) external onlyOwner returns (bool) {
        require((buyTaxForLiquidity_ + buyTaxForMarketing_ + buyTaxForGiveaway_) <= 100, "ERC20: total tax must not be greater than 100");
    ...
    function changeSellTaxForLMG(uint256 sellTaxForLiquidity_, uint256 sellTaxForMarketing_, uint256 sellTaxForGiveaway_
    ) external onlyOwner returns (bool) {
        require((sellTaxForLiquidity_ + sellTaxForMarketing_ + sellTaxForGiveaway_) <= 100, "ERC20: total tax must not be greater than 100");
