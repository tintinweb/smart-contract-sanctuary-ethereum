...
contract SappySeals is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SappySeals", "SAPPY") {
    setHiddenMetadataUri("ipfs://QmPdtRj7rQsuhFjUKP59ejFtZ29N12jqn98R1TCnf6bb2M/hidden.json");
  }
