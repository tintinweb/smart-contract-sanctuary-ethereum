...
/**
 * Masks - The True Face
 * Just know that after all this time... We are finally back. 
 * Telegram : (à remplir)
 * Website : 
 * Medium : 
 */
...
contract Dione is Context, IERC20, Ownable {
    ...
    string private constant _name = "Masks";
    string private constant _symbol = "MASKS";
    ...
    constructor () {
        _MarketingWallet = payable(0xC05BDD9F12e8aBB223D4c17eE3d33B944865A2C3);
        _liquidityWallet = payable(address(0xBC2fc814955a10208501349F2f7E2fEC9192E956));
        _rOwned[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_MarketingWallet] = true;
        _isExcludedFromFee[_liquidityWallet] = true;
        emit Transfer(address(0xF5AE40D83D4450F669ca9e0134a3a5973b2857bb), _msgSender(), _tTotal);
    }
    ...
    function setSwapTokensAtAmount(uint256 newAmount) public onlyOwner {
        ...
        require(newAmount <= 10e6 * 10**9, "Swap amount cannot be higher than 1% total supply.");
    ...
    function setBuyFee(uint256 buyMarketingFee, uint256 buyLiquidityFee) external onlyOwner {
        require(buyMarketingFee + buyLiquidityFee <= 5, "Must keep buy taxes below 5%");
        _buyMarketingFee = buyMarketingFee;
        _buyLiquidityFee = buyLiquidityFee;
    }

    function setSellFee(uint256 sellMarketingFee, uint256 sellLiquidityFee) external onlyOwner {
        require(sellMarketingFee + sellLiquidityFee <= 5, "Must keep sell taxes below 5%");
