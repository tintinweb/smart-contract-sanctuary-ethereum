...
contract Album is ERC721Enumerable, KeepItHeady {
...
contract KeepItHeady is OnChainMusicMetadata {
    ...
    function getPublishingData() internal pure returns (PublishingData memory) {
        ...
        string
            memory description = "Infinati\x27s new single \x27Keep it Heady\x27 is self-explanatory. Stay in a good vibration and beautiful things will unfold. As always I encourage you to listen with your eyes closed, pry open your third eye, and have an entheogenic journey.\n\nI had a lot of fun producing this and recording the sample you hear, \x27Keep it Heady\x27, as well as collaborating with sweetman.eth on this custom smart contract.\n\nUpon purchasing this NFT not only do you support Infinati and sweetman.eth with some food in our bellies, but Infinati will airdrop a free music NFT for you. Previous holders may already hold this free NFT, so in the event that the supply of 50 runs out, you\x27ll just get the next free music NFT that I mint! Reach out to @infinatimusic on Twitter so I airdrop it to the correct address and so we can stay in touch. :)\n\nEndless love to everyone. Infinati is here to stay. Music is my first love, I\x27m basically married to it.";
