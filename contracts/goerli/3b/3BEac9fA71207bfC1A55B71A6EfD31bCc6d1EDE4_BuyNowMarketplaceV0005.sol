...
contract BuyNowMarketplaceV0005 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function cancelSale(uint256 _itemId) external nonReentrant {
        ...
        require(msg.sender == item.seller || (msg.sender == mintAdmin && mintingItem.shouldMint), "You do not have permission to cancel sale");
