...
contract Minth is ERC1155, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    string public name = "Minth";
    string public symbol = "MIH";
    string public base_uri =
        "https://deimos.mypinata.cloud/ipfs/QmZhmmMzLaHGJYMX9w73jRrFrzuisTUAWQ1xmk5ojxPgff/";
    ...
    constructor(bytes32 _merkleRoot) ERC1155("") {
        ...
        _mint(msg.sender, Genesis, 10, "");
        _mint(msg.sender, Owner, 10, "");
    }
