...
// File: contracts/PrimaryContractContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract PrimaryContractContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Primary Contract";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PUY0ec6C43mExI3gyLvD/contract-metadata";
  }
