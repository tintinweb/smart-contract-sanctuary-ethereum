...
{
    ILayerZeroReceiver constant lzEndpoint = ILayerZeroReceiver(0xbfD2135BFfbb0B5378b56643c2Df8a87552Bfa23);
    ...
    function initialize(address record, uint64 subscriptionId, address _nft) external initializer {
        ...
        trustedRemoteLookup[10132] = abi.encodePacked(record);
        nft = IERC721(_nft);
    ...
    function setTrustedRemote(address record) external onlyOwner {
