...
contract BearmarketGoaway is ERC721A, Ownable, ReentrancyGuard {
  ...
  function publicMint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount +  walletMintedCount[msg.sender] <= supplyLimit, 'Max mints per wallet exceeded');
  ...
  function xrewardMint(uint256 quantity) public payable onlyOwner {
        ...
        require(totalSupply() + quantity <= supplyLimit, 'Max supply exceeded!');
        walletMintedCount[msg.sender] = walletMintedCount[msg.sender] + quantity;
