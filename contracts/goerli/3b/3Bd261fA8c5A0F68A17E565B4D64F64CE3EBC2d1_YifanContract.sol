...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x87Ed26A3AF62cD67C6560877a905737934850e5b];
...
// File: contracts/YifanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract YifanContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Yifan";
    string public symbol = "Yifan";
