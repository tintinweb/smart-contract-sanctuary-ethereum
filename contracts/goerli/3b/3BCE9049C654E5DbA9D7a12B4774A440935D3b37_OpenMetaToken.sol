...
contract OpenMetaToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    mapping(address => address) private transferToEnabled;
     ...
     */
    constructor(uint256 _claimPeriodEnds) ERC20("OTEST", "OTEST") ERC20Permit("OTEST") {
        claimPeriodEnds = _claimPeriodEnds;

        // Transfer ownership to multi-sig wallet
        transferOwnership(address(0x6EcFB5E605Ab2191e1923201f754Ce35F94f20a1));
    }
    ...
    function _transfer(
        ...
        if (restrictedTransfersEnabled == true && sender != address(this) && msg.sender != owner())
            require(recipient == transferToEnabled[msg.sender], "OMETA: You are not allowed to perform transfers");
