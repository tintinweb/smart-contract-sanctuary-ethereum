...
contract CrowdFunding is ERC20Token{
    ...
    function NewFundContract(string memory ContractName) public OnlyOwner{
        ...
        ContractFund[name]= address(new FundContract(ContractName,i_owner,i_totalSupply,s_TokenName,s_TokenSYM,_cap,blockReward));
...
contract FundContract is ERC20Token{
