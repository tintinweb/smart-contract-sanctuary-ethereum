...
import "@minteeble/smart-contracts/contracts/token/misc/NftStakingERC20Token.sol";
import "@openzeppelin/contracts/access/AccessControlEnumerable.sol";

contract MeowToken is NftStakingERC20Token {
    constructor(
        string memory name,
        string memory symbol,
        uint256 initialSupply
    ) NftStakingERC20Token(name, symbol, initialSupply) {}
}
...
contract NftStakingERC20Token is ERC20, AccessControlEnumerable {
