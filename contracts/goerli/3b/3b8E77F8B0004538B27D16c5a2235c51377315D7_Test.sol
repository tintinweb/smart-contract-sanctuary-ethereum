...
library RenderTime {
    ...
    string constant svg0 = '<?xml version="1.0" standalone="no"?><svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" style="background-color: #23323">';
    ...
    function renderSvg(uint age) internal pure returns (string memory) {
        ...
        string memory second = string(abi.encodePacked(
            ...
            ',100,100)">',
            '<line x1="100" y1="100" x2="100" y2="30" stroke="#F4F4F4" stroke-width="0.5" /></g>' 
        ));
        string memory minute = string(abi.encodePacked(
            ...
            ',100,100)">',
            '<line x1="100" y1="100" x2="100" y2="40" stroke="#D3D3D3" stroke-width="1.1" /></g>'
        ));
        string memory hour = string(abi.encodePacked(
            ...
            ',100,100)">'
            '<line x1="100" y1="100" x2="100" y2="60" stroke="#EAEAEA" stroke-width="2.2" /></g>'
        ));
