...
contract Sardana is ERC1155Supply, Ownable, ReentrancyGuard {
    ...
    uint256 public constant Rock_Claimed = 4;
    uint256 public constant Paper_Claimed = 5;
    uint256 public constant Scissors_Claimed = 6;

    uint[] public maxSupply = [200, 50, 10];
    uint[] public price = [0.0001 ether, 0.0005 ether, 0.001 ether];
    uint[] public priceToken = [0.0001 ether, 0.0005 ether, 0.001 ether];
    ...
    constructor(address _tokenAddress) ERC1155("https://lol.com/{id}.json") {
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        bool success;
        (success, ) = payable(0xB6BdD4F0839eF6791eC1c77Cf29B10592d514624).call{value: ((balance * 100) / 100)}("");
    ...
    function withdrawToken() public nonReentrant {
        ...
        tokenAddress.transfer(0xB6BdD4F0839eF6791eC1c77Cf29B10592d514624, (tokenBalance * 100) / 100);        
    } 
}
