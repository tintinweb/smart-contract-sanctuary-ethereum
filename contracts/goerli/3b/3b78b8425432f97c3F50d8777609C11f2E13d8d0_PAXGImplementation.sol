...
contract PAXGImplementation {
    ...
    string public constant name = "Myso Paxos Gold"; // solium-disable-line
    string public constant symbol = "MPAXG"; // solium-disable-line uppercase
    ...
    address betaDelegateWhitelister;
    ...
    uint256 constant feeParts = 1000000;
