...
// File: contracts/ICOWithMultiSig(New).sol
...
contract ICO is ERC20, ReentrancyGuard {
    ...
    string _close = "No Withdrawal during ICO Period";
 ...
 uint fundAmount;
    ...
    constructor(address[] memory _owners, uint _numConfirmationsRequired) ERC20("Accenture Blockchain", "ATCP") {
    ...
    function getAllBuyerList() public view returns(Buyers[] memory) {
        return buyersList;
    }
    ...
    //     require(openTime >= block.timestamp, "Time is over!.");
    //     return openTime - block.timestamp;
    // }
    function getOpenTimeLeft() public view returns(uint256) {
        require(openTime >= block.timestamp , "It still lock!");
        return openTime;
    }
    ...
    */
    function buy() public payable nonReentrant icoLock returns (bool sucess)  {
      ...
      _transfer(address(this), _msgSender(), amount);
       buyersList.push(Buyers(msg.sender, msg.value,  amount));
      return true;
    }
