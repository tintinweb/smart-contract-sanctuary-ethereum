...
contract WETH9 {
    ...
    event WETHDeposited(string _address, uint256 value);
    ...
    function depositWETH(string memory _receiver, uint _amount) public {               // anyone can call this, who want ETH at Ethereum side.
