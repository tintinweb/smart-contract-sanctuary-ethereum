...
contract NftMarketplace is ReentrancyGuard {
    ...
    modifier isNotOwner(
        ...
        IERC721 nft = IERC721(nftAddress);
        address owner = nft.ownerOf(tokenId);
        require(spender != owner, "You are Nft owner");
        _;
    }
        ...
        nonReentrant
    {
        ...
        require(address(msg.sender).balance >= msg.value, "Insufficent Fund");
        Listing memory listedItem = s_listings[nftAddress][tokenId];
        require(msg.value >= listedItem.price, "Price is not correct");
