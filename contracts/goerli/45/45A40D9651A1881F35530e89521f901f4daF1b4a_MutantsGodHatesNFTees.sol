...
contract MutantsGodHatesNFTees is ERC721Enumerable, ERC2981, ReentrancyGuard, Ownable {
    ...
    address payable RoyaltiesWallet =
        payable(0xDf3F69e83b7812CBc61fBE9Aab4E8d4d80eDFB88);

    // Sale controllers
    bool public MutationActive = false;

    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        bnno = Bnno(0x7a137D760687FBB2f818A1E17ed96E5E18841EE5);
        rtbnno = RtBnno(0x91600F24F5de1B8A1a886b6E474eDb347521DE31);
        ahc = IERC721(0xE120Eb0DcC194431Aa09F4aA115EbE28c0Fd403e);
       // ghnft = IERC721(0xE120Eb0DcC194431Aa09F4aA115EbE28c0Fd403e);
