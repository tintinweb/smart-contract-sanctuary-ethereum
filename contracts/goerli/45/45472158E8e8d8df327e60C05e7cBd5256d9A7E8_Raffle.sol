...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /* Functions */
    constructor(
        address vrfCoordinatorV2, // contract - we need to deploy mocks for tests
        uint256 entranceFee,
        bytes32 gasLane,
    ...
    function enterRaffle() public payable {
        // require (msg.value > i_entranceFee, "Not enough ETH!"); // Big gas consumption - string
     ...
     * 3. Oru subscription is funded with LINK
    ...
    function performUpkeep(
        ...
        uint256 requestId = i_vrfCoordinator.requestRandomWords(
            i_gasLane, // keyHash = gasLane - max gaslimit we spent to generate random number
            ...
            i_callbackGasLimit, // the limit of how much computation of fulfillRandomWords() can be
            NUM_WORDS // how many random numbers we want
        );
        // This is redundant!! - event already exists in VRFCoordinatorV2Mock.sol and can be removed, but we leave it for educational purposes
    ...
    function fulfillRandomWords(
        ...
        // Example: s_players size 10, randomNumber 202, 202 % 10 = 2 - winner
