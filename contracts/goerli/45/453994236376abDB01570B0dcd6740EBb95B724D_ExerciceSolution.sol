...
contract ExerciceSolution is IExerciceSolution, ERC20
{
    ...
    address private constant myToken = 0x7BE7B39EE5F3591A599F68cB356b9497b1680061;
    IUniswapV2Router private _UniswapV2Router = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    ...
    function swapYourTokenForEth() override external {
        ...
        // myToken.approve(address(_UniswapV2Router), 10 ether);
