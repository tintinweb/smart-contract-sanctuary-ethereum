...
contract Trainer is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    //Constants
    // CHANGE BEFORE LIVE!! THIS IS FOR TESTING PURPOSES ONLY!!
    uint8 public ADDRESS_MAX_MINTS = 100;
    ...
    function setTransferAllowed(bool _transferAllowed) external onlyOwner {
        transferAllowed = _transferAllowed;
    }

    function setWardobeChangesAllowed(bool _wardrobeChangesAllowed) external onlyOwner {
        wardrobeChangesActive = _wardrobeChangesAllowed;
    }

    function setWardrobeChangePrice(uint256 _WardrobeChangePrice) external onlyOwner {
    ...
    function setAddressMaxMints(uint8 _maxMintable) external onlyOwner {
        ADDRESS_MAX_MINTS = _maxMintable;
    }
    ///////////////////////////////////////////////////////////////////////////
    // Mint Functions
    ///////////////////////////////////////////////////////////////////////////

    //Do we want this payable?
    ...
    function wardrobeChange(uint256 _tokenId) public payable {
    ...
    function transferFrom(
        ...
        require(transferAllowed, "Trainer: transfer is not allowed");
