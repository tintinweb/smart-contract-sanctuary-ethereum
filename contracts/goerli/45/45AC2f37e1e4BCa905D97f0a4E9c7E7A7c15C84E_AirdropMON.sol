...
contract AirdropMON is Ownable, ReentrancyGuard {
    ...
    bytes32 public immutable merkleRoot = 0x65c7999e2b67ecdae078a717f79e8988f522b33febd260ad1b9515382113b782; // NOTE to be updated with correct root
    ...
    IERC20 public immutable DCHF = IERC20(address(0xD550283363c981c363a71050a4A14a0DF6C6BDaD)); // IERC20(address(0x045da4bFe02B320f4403674B3b7d121737727A36));
    ...
    uint128 public constant VEST_DELAY_FREEZER = 3 hours; // 5,48 years of Freezing
