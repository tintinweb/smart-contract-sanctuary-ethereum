...
contract LunarWitch is ERC721A, DefaultOperatorFilterer, Ownable, PaymentSplitter {
    ...
    uint256 public tokenReserve = 15;
    ...
    */
    ...
    uint256[] private teamShares = [4750, 4750, 500];
    ...
    constructor()
        PaymentSplitter(teamWallets, teamShares)
        ERC721A("Test 1207-02", "TEST120702")
    {}
    ...
    */
    ...
    function presaleMintClaimed(address _wallet) external view onlyOwner returns (uint256) {
