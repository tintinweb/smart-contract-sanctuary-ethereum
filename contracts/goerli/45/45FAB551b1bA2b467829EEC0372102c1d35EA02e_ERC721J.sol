    ...
    Ownable
{
    ...
    function recycleMintOG(
        ...
        if (_recycleToggle != true ) { revert RecycleDisabled();}
        ...
        //Burns tokens
        _burnOG(burnTokenId1);
        _burnOG(burnTokenId2);
    ...
    //
    //Burn function
    function _burnOG(uint256 tokenId) internal virtual {
        address owner = ownerOf(tokenId);
