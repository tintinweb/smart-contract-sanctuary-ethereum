    ...
    VRFBeaconBilling
{
    ...
    function requestRandomness(
        ...
        billSubscriberForRequest(msg.sender, subID); // throws on failure
    ...
    function processCallback(
        ...
        // Ensure that more than GAS_FOR_CALL_EXACT_CHECK was used to prevent an
        // underflow.
        uint256 gasAfter = gasleft() + GAS_FOR_CALL_EXACT_CHECK;
