...
//*********************************************************************//
//
//     __  __           _  __ _          ____                     __                       __     ______                                       
//    / / / /_  ______ | |/ /(_)___ _   /  _/___ _   _____  _____/ /_____ ___  ___  ____  / /_   / ____/___  ____ ___  ____  ____ _____  __  __
//   / /_/ / / / / __ `/   // / __ `/   / // __ \ | / / _ \/ ___/ __/ __ `__ \/ _ \/ __ \/ __/  / /   / __ \/ __ `__ \/ __ \/ __ `/ __ \/ / / /
//  / __  / /_/ / /_/ /   |/ / /_/ /  _/ // / / / |/ /  __(__  ) /_/ / / / / /  __/ / / / /_   / /___/ /_/ / / / / / / /_/ / /_/ / / / / /_/ / 
// /_/ /_/\__,_/\__,_/_/|_/_/\__,_/  /___/_/ /_/|___/\___/____/\__/_/ /_/ /_/\___/_/ /_/\__/   \____/\____/_/ /_/ /_/ .___/\__,_/_/ /_/\__, (_)
//                                                                                                                 /_/                /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x69040d5281e43D1fFdF487D42840e0BB3460FE4b];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x69040d5281e43D1fFdF487D42840e0BB3460FE4b;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 10003) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigfxesahiozl427rx7if3olmorz2zi4vrkljzd2ikm5t2rk4dgggy/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 10003");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 10003");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 10003");
...
// File: contracts/HuaXiaInvestmentCompanyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HuaXiaInvestmentCompanyContract is RamppERC721A {
    constructor() RamppERC721A("HuaXia Investment Company", "HUAXIA"){}
}
