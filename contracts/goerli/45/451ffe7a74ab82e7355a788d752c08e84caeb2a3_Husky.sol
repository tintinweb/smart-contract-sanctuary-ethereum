...
contract Husky is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Husky";
    string private _symbol = "Husky";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xD5Ed78BFae41A039748324633796226aD203F093); 
    ...
    uint256 private _totalSupply = 80 *  10**7 * 10**_decimals;
