...
contract HypeOcrisy is ERC721A, Ownable, Pausable {
    using SafeMath for uint256;

    constructor(string memory baseURI) ERC721A("HYPEocrisy", "HYPEOCRISY") {
    ...
    function contractURI() public pure returns (string memory) {
        return
            "https://gateway.pinata.cloud/ipfs/QmZCPo5oysknCTbDujKcFpvu8F1izdfhe42duTRuAgRB23";
    }
