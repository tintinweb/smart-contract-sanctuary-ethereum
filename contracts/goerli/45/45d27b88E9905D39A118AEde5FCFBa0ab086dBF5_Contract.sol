...
contract Contract is ERC721Drop, DefaultOperatorFilterer {
    using TWStrings for uint256;
    bool private isCustomURI;
    bool private isReveal;
    string private baseURI = "";
    string private baseExtension = ".json";
    string private unrevealTokenURI = "";
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        if (isCustomURI) {
            return isReveal ? string(abi.encodePacked(_baseURI(), _tokenId.toString())) : unrevealTokenURI;
        } else {
    ...
    function setUnrevealTokenURI(string memory _newUnrevealTokenURI) external onlyOwner {
        unrevealTokenURI = _newUnrevealTokenURI;
    }
