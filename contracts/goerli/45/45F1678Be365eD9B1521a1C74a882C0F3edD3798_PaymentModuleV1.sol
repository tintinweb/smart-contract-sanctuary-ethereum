...
contract PaymentModuleV1 is IDepositHandler, IPaymentModule, AccessControlEnumerable, IERC721Receiver {
    ...
    function processPayment(ProcessPaymentParams memory params) external payable override onlyRole(PAYMENT_ADMIN_ROLE) {
        ...
        processFee(price.usdtAmount, payable(params.user), params.referrer);
    }
    ...
    function processFee(
        ...
        if (usdtAmount > 0) {
            ...
            if (msg.value > 0) {
                ...
                uint256 toBeRefunded = address(this).balance - oldEthBalance;
                (bool success, ) = user.call{ value: toBeRefunded }("");
                require(success, "Failed to refund leftover Ether");
            } else {
