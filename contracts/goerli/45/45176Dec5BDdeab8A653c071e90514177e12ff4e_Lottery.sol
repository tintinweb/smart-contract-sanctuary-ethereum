...
contract Lottery is Ownable, VRFConsumerBase
{
    ...
    constructor(address _priceFeedAddress, address _vrfCoordinator, address _linkToken, uint256 _fee, bytes32 _keyhash) public VRFConsumerBase(_vrfCoordinator, _linkToken)
    {
    ...
    {
        //price devuelve 8 decimales
        (, int price, , , ) = ethUsdPriceFeed.latestRoundData();
        uint256 adjustedPrice = uint256(price) * 10 ** 10; // así tendría 18 decimales
        // $50, $2,000 / ETH
        // 50/2,000
        // 50 * 100000 / 2000
    ...
    function fulfillRandomness(
        ...
        require(_randomness > 0, "Randomness must be greather than 0!");
