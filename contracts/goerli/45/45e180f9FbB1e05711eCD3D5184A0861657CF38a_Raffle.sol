...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
     ...
     * 4. Our Lottery contract should be in an open state
     */
    ...
    function fulfillRandomWords(
        ...
        uint256 _indexOfWinner = _randomWords[0] % s_players.length;
        address payable _recentWinner = s_players[_indexOfWinner];
        s_recentWinner = _recentWinner;
