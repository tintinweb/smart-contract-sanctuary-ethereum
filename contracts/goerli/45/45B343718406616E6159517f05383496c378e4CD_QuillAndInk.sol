    ...
    ERC2981Upgradeable
{
        ...
        initializerERC721A
    {
        ...
        uri = "";
        _pause();
        _setDefaultRoyalty(0x444600b116B5983B993A7Da8D88115bEc9a11B82, 250);
    }
    ...
    function mint(
        ...
        whenNotPaused 
    {
        require(_numberMinted(msg.sender) + amount <= limit, "Exceeds limit");
        require(tx.origin == msg.sender, "EOA");
        require(_nextTokenId() + amount <= supply, "Exceeds supply");
