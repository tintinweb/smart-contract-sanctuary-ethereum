...
contract BonjourV2 is ContextUpgradeable, OwnableUpgradeable {
    ...
    uint256 public roiPercent;  // 1 means 1000; So 2%
    ...
    function initialize(address _ownerAddress, address _externalAddress) public initializer {
        ...
        BusdAddress = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
