...
contract MH is ERC721A, Ownable, ReentrancyGuard {
    ...
    string private unrevealedURI = "ipfs://Qmaaq4Xbpw94kZdVx2zWY9Dyp3KxCwbwaGCMJpdVomKPTh";
    ...
    constructor (bytes32 _root_al, bytes32 _root_free) ERC721A("Metaverse Hospitality", "MH") {
        ...
        reserved_mints[0x163Cc5c6aF8A6e6320Eb8DC114B057Fafd6A1Fbb] = 40; // MH wallet
    }
