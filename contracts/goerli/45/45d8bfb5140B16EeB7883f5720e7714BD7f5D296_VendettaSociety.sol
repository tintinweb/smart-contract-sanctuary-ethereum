...
contract VendettaSociety is ERC721A, Ownable {
    ...
    uint256 public constant COMMUNITY_MINT_AMOUNT = 322;
    string public constant BASE_URI = "www.example.com/";
    address public constant COMMUNITY_WALLET = 0xb5E8683Aa524069C5714Fc2D8c3e64F78f2862fb;
    ...
    /// @param _allowlistMerkleRoot Allowlist Merkle Root
    constructor(bytes32 _allowlistMerkleRoot) ERC721A ("Vendetta Society", "VD") {
    ...
    function allowlistMint(bytes32[] memory _merkleProof, uint256 _mintAmount) public payable callerIsUser {
        if (totalSupply() + _mintAmount > COLLECTION_SIZE) revert MintingTooMany();
        ...
        if(!(MerkleProof.verify(_merkleProof, allowlistMerkleRoot, leaf))) revert InvalidProof();
    ...
    function communityMint() public onlyOwner {
        _safeMint(COMMUNITY_WALLET, COMMUNITY_MINT_AMOUNT);
    }
    ...
    /// @param _saleState Sale State number
