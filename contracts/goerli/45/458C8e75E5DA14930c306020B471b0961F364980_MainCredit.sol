...
import "../interface/ILoanCalculator.sol";
    ...
    LoanCurrencyWrapper
{
    ...
    ILoanCalculator private loanCalculator;
    ...
    function initialize(
        ...
        address _loanCalculatorAddress
    ) external {
        ...
        loanCalculator = ILoanCalculator(_loanCalculatorAddress);
    }
        ...
        internal
    {
        ...
        //     msg.sender,
        //     collateralLoans[_collateralAddress][_collateralId].lender,
        //     loanCalculator.getUserInterest(
        //         collateralLoans[_collateralAddress][_collateralId].offer
        //     )
        // );
        // _safeFTTransferFrom(
...
/**
 * @title  ILoanCalculator
 * @author Solarr
 * @notice
 */
interface ILoanCalculator is TermData {
    function getUserInterest(OfferTerm calldata _offer) external view returns (uint256);

    function getAdminFee(OfferTerm calldata _offer) external view returns (uint256);
