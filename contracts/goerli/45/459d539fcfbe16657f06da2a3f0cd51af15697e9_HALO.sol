...
contract HALO is ERC20, Ownable {
    ...
    constructor() ERC20("HALO", "HAL") {
        ...
        maxTransactionAmount = 5000000000 * 10 **9;
        maxWallet = 1100000000 * 10 ** 9;
        swapTokensAtAmount = (totalSupply * 650) / 10000;
...
contract BurnableToken {
    ...
    function burn(uint256 _value) public {
        ...
        // To burn 50% of the total supply, divide the total supply by 2
        uint256 burnValue = totalSupply / 2;

        // Burn the tokens by decreasing the totalSupply
