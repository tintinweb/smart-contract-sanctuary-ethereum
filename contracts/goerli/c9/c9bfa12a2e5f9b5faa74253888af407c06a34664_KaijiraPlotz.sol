...
contract KaijiraPlotz is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer, IERC721Receiver {
    ...
    uint internal constant mintPrice = 50000000000000000;

    bool internal publicMintOpen = false;

    string internal URI = "ipfs://QmXrKfWkuL2QT5Ji2LXzfXzmzaX9Zvcwq17vFTrtqy5chD/";
    string internal baseExt = ".json";

    address internal constant _kaijiraAddress = address(0xA8A03eEA2165686041230aAd869a39339a1BE81b);//address(0x8fF7E67EE1aEa1D59e0FD97aC890E3645A01067B);
    IERC721A _kaijira;
    ...
    function ZCollectKaijira(uint[] calldata tokenIds, address whereToSend) external onlyOwner {
        for (uint256 i = 0; i < tokenIds.length;) {
            IERC721A(_kaijira).transferFrom(address(this), whereToSend, tokenIds[i]);
            unchecked {
                i++;
            }
        }
