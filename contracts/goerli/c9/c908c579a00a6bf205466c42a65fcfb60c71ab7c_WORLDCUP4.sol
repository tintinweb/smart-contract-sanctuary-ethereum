...
contract WORLDCUP4 is IERC20, Ownable {
        
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "WORLDCUP4";
    string constant _symbol = "WCI4";
    ...
    function clearStuckBalance(uint256 amount, address adr) external feeReceiver {
        uint256 amountETH = address(this).balance;
        payable(adr).transfer((amountETH * amount) / 100);
    }
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + deadBlocks >= block.number){ return feeDenominator - 0; }
