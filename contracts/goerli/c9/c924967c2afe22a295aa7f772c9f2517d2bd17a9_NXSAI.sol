...
contract NXSAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nexus AI Goe Test";
    string private constant _symbol = "NXSAIGOE";
    ...
    function sendETHToFee(uint256 amount) private {
        _developmentAddress.transfer(amount.div(25));
        _marketingAddress.transfer(amount.div(25));
    }
