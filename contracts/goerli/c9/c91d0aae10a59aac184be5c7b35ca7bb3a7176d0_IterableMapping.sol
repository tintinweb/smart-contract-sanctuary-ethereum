...
contract SHIVA is ERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 100000000000 * (10**18); // 1%
    ...
    function setFee(uint256 newFee) public onlyOwner {
        require(newFee <= 70 , "the Fee should be 7% or less");
    ...
    constructor() ERC20("Shiva Finance", "SHIVA") {
        ...
        liquidityFee = 1;
        marketingFee = 24;
        marketingWallet = payable(0x828FF894DFEae781489Ed076F04B65Da7a37613A);
