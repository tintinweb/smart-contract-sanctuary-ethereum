...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x516649dBd606A980E767BDedbCD882d91c859C9c;
...
contract FiliFili is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x63F1355ed08da573ea0B08A8D588dD37B8d5E776;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Fili Fili";
    string private _symbol = "FILI";
