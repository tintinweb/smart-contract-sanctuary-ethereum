...
contract MyNFTDrop is ERC721Drop, PermissionsEnumerable {
        ...
        )
    {
        ...
        _setupRole(COVER_ROLE, msg.sender);
    ...
    /// @dev Returns whether set cover can be done in the given execution context.
    function _canSetCoverUri() internal view virtual returns (bool) {
        return hasRole(coverRole, _msgSender());
    }
    ...
    /// @dev Returns whether set cover can be done in the given execution context.
    function _canSwitchCover() internal view virtual returns (bool) {
        return hasRole(coverRole, _msgSender());
    }
    */
}