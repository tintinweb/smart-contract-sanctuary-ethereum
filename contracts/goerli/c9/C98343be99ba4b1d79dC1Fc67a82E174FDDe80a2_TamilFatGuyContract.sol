...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x67eAC3B5488302E6657A8Bf8cc643c2A12a40807];
  address public erc20Payable = 0x67eAC3B5488302E6657A8Bf8cc643c2A12a40807;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 1944) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigyj3aabrqbsmzv7k6d66nrhoztoqc5jtavnv6zf773hvjnkq74na/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ax9PrnNLfliPGuCxxmoK/contract-metadata";
  }
...
// File: contracts/TamilFatGuyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TamilFatGuyContract is RamppERC721A {
    constructor() RamppERC721A("Tamil Fat Guy", "TFG"){}
}
