...
contract Coinlend {
    ...
    uint256 public transferCount; // Transfer Count -> Used as ID
    ...
    uint256 public expirationBuffer = 60 * 60 * 24 * 14; // 14 days
    ...
    function payBackLoanInternal(Loan memory _loan, uint256 interestAmount, uint256 fee) internal {
        ...
        tokens[_loan.tokenLending][_loan.borrower] -= (_loan.tokenLendingAmount + interestAmount);
