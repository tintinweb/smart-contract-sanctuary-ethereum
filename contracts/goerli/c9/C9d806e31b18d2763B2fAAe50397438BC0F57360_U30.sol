...
contract U30 is AbstractERC1155Factory {
    ...
    constructor(
        ...
        //_mint(0x7909b2c97c657F548D467A74faD5C1de48E2da95, 0, 300, "");
    }
    ...
    // * @param _isActive paused or not?
    // */
    // function setActive(uint256 tokenId, bool _isActive) external onlyOwner {
    ...
    // *
    // * @param tokenId the token id
    // * @param _maxSupply the max number of tokens that can be minted
    // */
    ...
    // */
    // function setMintPrice(uint256 tokenId, uint256 _mintPrice) external onlyOwner {
    //     mintPrice[tokenId] = _mintPrice;
    // }

    // /**
    // * Edit the max mint count per transaction
    // *
    // * @param tokenId the token id
    // * @param _maxPerTx the max number of tokens that can be minted per transaction
    // */
    // function setMaxPerTx(uint256 tokenId, uint64 _maxPerTx) external onlyOwner {
    //     maxPerTx[tokenId] = _maxPerTx;
    // }

    // /**
    // * Edit the max number of tokens that can be owned per wallet
    // *
    // * @param tokenId the token id
    // * @param _maxPerWallet the max number of tokens that can be owned by each wallet
    // */
    // function setMaxPerWallet(uint256 tokenId, uint64 _maxPerWallet) external onlyOwner {
