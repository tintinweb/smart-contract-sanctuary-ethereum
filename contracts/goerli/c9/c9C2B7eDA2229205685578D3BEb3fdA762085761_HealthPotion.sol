...
// All existing tokens were restarted to begin at this deployment date
...
contract HealthPotion is ERC721, Pausable, ERC721Burnable, Authorized, ReentrancyGuard {
    ...
    constructor(address _usdcAddress, address _capitalVaultAddress) ERC721("Health Potion", "HP") {
    ...
    function refill(uint256 tokenId, uint256 _policyDays, Policy.PolicyType _policyType)
        public 
        onlyAuthorized 
        nonReentrant
    {
