...
contract Metaisland is ERC721, ERC721Enumerable, Pausable, AccessControl, ERC721Burnable {
   ...
   function mintRent(address to) public onlyRole(DEFAULT_ADMIN_ROLE) {
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
        emit rentNFT(
    ...
    function mintGift(address to) public onlyRole(DEFAULT_ADMIN_ROLE) {
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
        emit giftNFT(
