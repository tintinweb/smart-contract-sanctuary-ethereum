...
contract LotteryDAPP is Ownable, VRFConsumerBaseV2 {
    ...
    uint constant REWARD_AMOUNT = 500; // Amount of tokens to be given to the winner
    ...
    function getLotteryInfo(uint _extractionDate) public view returns(extractionHistoryStruct memory){
        return extractionHistory[_extractionDate];
    }
