...
contract USDB is IUSDB, ERC20, Ownable {
    ...
    function stake(address owner, address tokenAddress, uint256 tokenAmount) public onlyController{
        require(_whiteAddress[owner] == false, "USDB_stake: white address cann't stake.");
    ...
    function unStake(address owner) public onlyController {
        ...
        IEvent(_eventAddress).USDB_unStake(
