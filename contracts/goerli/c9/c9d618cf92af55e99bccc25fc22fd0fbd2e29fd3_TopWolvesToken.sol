...
abstract contract BlackList is Ownable, BasicToken {
    ...
    /////// Getters to allow the same blacklist to be used also by other contracts (including upgraded TopWolves) ///////
...
contract TopWolvesToken is Pausable, StandardToken, BlackList {
    ...
    function transfer(address _to, uint _value) override (BasicToken, ERC20Basic) public whenNotPaused {
