...
contract Factory is ERC721A__OwnableUpgradeable {
    address public implementationAddress;

    address public DRPPRaddress;
     ...
     * @param _implementationAddress The address of the NFTDrop implementation contract.
     * @param _DRPPRaddress The address of the DRPPR contract.
     */
    constructor(address _implementationAddress, address _DRPPRaddress) {
        implementationAddress = _implementationAddress;
        DRPPRaddress = _DRPPRaddress;
    }

    /**
     * @dev Creates a new NFTDrop collection contract.
     * @param name The name of the NFT collection.
     * @param symbol The symbol of the NFT collection.
     * @param baseURI The base URI for token metadata.
     * @param _maxSupply The maximum total supply of the NFT.
     * @param _maxFreeSupply The maximum supply available for free claims.
     * @param _costPublic The cost in Wei for public minting.
     * @param _maxMintPublic The maximum number of tokens that can be minted in a single public mint.
     * @param _freePerWallet The maximum number of tokens that can be claimed for free per wallet.
     * @param _withdrawAddress The address where funds will be withdrawn to.
     * @return The address of the created NFTDrop collection contract.
     */
    ...
    /**
     * @dev Retrieves the addresses of the NFTDrop collection contracts deployed by a user.
     * @param user The user's address.
     * @return An array of addresses representing the deployed collection contracts.
     */
    ...
    /**
     * @dev Allows the owner to change the implementation address.
     * @param _implementationAddress The address of the new implementation contract.
     */
    ...
    /**
     * @dev Allows the owner to change the _DRPPRaddress.
     * @param _DRPPRaddress The address of the new DRPPR contract.
     */
    function setDRPPRaddress(address _DRPPRaddress) public onlyOwner {
        DRPPRaddress = _DRPPRaddress;
    }
}
...
contract NFTDrop is ERC721A__Initializable, ERC721AUpgradeable, ERC721A__OwnableUpgradeable {
    ...
    /**
     * @dev Initializes the NFTDrop contract.
     * @param name The name of the NFT collection.
     * @param symbol The symbol of the NFT collection.
     * @param baseURI The base URI for token metadata.
     * @param _maxSupply The maximum total supply of the NFT collection.
     * @param _maxFreeSupply The maximum supply available for free claims.
     * @param _costPublic The cost in Wei for public minting.
     * @param _maxMintPublic The maximum number of tokens that can be minted in a single public mint.
     * @param _freePerWallet The maximum number of tokens that can be claimed for free per wallet.
     * @param _withdrawAddress The address where funds will be withdrawn to.
     * @param _DRPPRaddress The address where platform fee will be withdrawn to.
     */
    function initialize(
        string memory name,
        string memory symbol,
    ...
    /**
     * @dev Mints NFT tokens and airdrops them to a specified recipient.
    ...
    /**
     * @dev Mints NFT tokens for development purposes.
     * @param _quantity The number of tokens to mint.
     */
    ...
    /**
     * @dev Checks if an address can claim NFT tokens for free.
     * @param _address The address to check.
     * @return A boolean indicating if the address can claim tokens for free.
     */
    ...
    /**
     * @dev Gets the cost in Wei to mint a certain quantity of NFT tokens.
    ...
    /**
     * @dev Toggles the public minting feature on or off.
     */
    ...
    /**
     * @dev Sets the cost in Wei for public minting.
    ...
    /**
     * @dev Sets the maximum batch size for public minting.
     * @param _newBatchSize The new maximum batch size.
     */
    ...
    /**
     * @dev Sets the maximum number of tokens that can be claimed for free per wallet.
     * @param _newFreePerWallet The new maximum number of tokens.
     */
    ...
    /**
     * @dev Sets the maximum supply available for free claims.
     * @param _maxFreeSupply The new maximum supply.
     */
    ...
    /**
     * @dev Withdraws contract balance to the specified withdrawal address, less 5% platform fee
     */
    function withdrawAll() public payable onlyOwner {
        uint256 balance = address(this).balance;
        uint256 fee = (balance * 5) / 100;
        require(payable(withdrawAddress).send(fee));
        require(payable(DRPPRaddress).send(balance - fee));
    }
