...
contract Alchemy is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    mapping (address=>uint256) nftsMinted;
    uint256 MAX_NFTS_MINTED = 5;
    constructor() ERC721("Alchemy", "ALCH") {}

    function safeMint(address to, string memory uri) public {
        require(_tokenIdCounter.current() <= MAX_SUPPLY, "I'm sorry we reached the cap");
        ++nftsMinted[to];
        require(nftsMinted[to] <= MAX_NFTS_MINTED, "Maximum number of nfts minted per user is 5");
    ...
    function getNftsMinted(address _address) public view returns (uint256){
