...
contract Staking4 is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function deposit(address user,uint128 _amount, uint128 _stakeType) external nonReentrant returns(uint128 emitAmount) {
    ...
    function compound(address user, uint128 _stakeType) external nonReentrant returns(uint128) {
        require(stakeTypeExist[_stakeType], "STAKE_TYPE_DOES_NOT_EXIST");
        ...
        uint128 stakeTimeTillNow;
            ...
            return totalRewardTillNow;


    }

    function withdraw(address user, uint128 _amount, uint128 _stakeType) external nonReentrant returns(uint128) {
    ...
    function claim(address user, uint128 _stakeType) external nonReentrant returns(uint128) {
        require(stakeTypeExist[_stakeType], "STAKE_TYPE_DOES_NOT_EXIST");
