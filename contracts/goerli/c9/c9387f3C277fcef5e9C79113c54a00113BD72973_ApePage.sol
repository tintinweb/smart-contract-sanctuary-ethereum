...
import "token-bound-token/TokenBoundToken.sol";

contract ApePage is TokenBoundToken {

    address public constant OWNER = 0x8d62E8e44D63cd91ED02F1Cc90a01968b249e5B6;

    constructor(string memory name, string memory symbol, address payee_, bool isSoulbound_, uint256 price_)
        TokenBoundToken(name, symbol, payee_, isSoulbound_, price_)
    {
     ...
     * - `tokenId` 
     */
    function ownerMint(address to, uint256 tokenId) public onlyOwner returns (uint256) {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://stage.apes.page/api/v0/avatar/token/";
    }

    // TODO page claim expiration logic
