...
contract ParentContract {
    ...
    function claim(IERC20 token, address _tokenToBeClaimed, uint256 _amount) public {
        ...
        // check if the claim period is valid

        // send the token to the msg.sender
    }

        // this function will be called by the child
    function claimTest(IERC20 token, uint256 _amount) public returns(uint256) {
    ...
    function getBalanceTest(IERC20 token) public returns(uint256){
    ...
    function setClaimMomentDaily() public {
        uint current = getCurrentTime();
        claimMomentDaily = current + 1 days;
    }


    function setClaimMomentWeekly() public {

    }


    function setClaimMomentMonthly() public {
