 ...
 * @notice This contract handles minting Zetman's Porport tokens.
 */
contract ZetmansPorport is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xb306c1Af07AEC20060731b593eA27B226F8333e0;
    ...
    string public baseTokenURI =
        "ipfs://bafybeicvutlvlyk4gwli5qjsvoxavzdwfaajvqci5t5so5a64aba6o6bvq/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 2;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 2;
