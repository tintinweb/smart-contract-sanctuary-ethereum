...
contract Escrow is Ownable, ReentrancyGuard {
    ...
    function _mintLicense(
        ...
        emit License(_seller, _buyer, _licenseId, _collection, _tokenId, true);
    }
    ...
    function _resaleLicense(SellLicense memory _params) internal {
        ...
        emit License(_params.seller, _params.buyer, _params.licenseId, _params.collection, _params.tokenId, false);
    }
