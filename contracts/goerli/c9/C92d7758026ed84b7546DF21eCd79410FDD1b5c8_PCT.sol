...
//                                                                                                                    //
//                                                                                                                    //
//         _____   ____                    ______   ____                    _____         ____  _________________     //
...
//    |    |      |    |    |/  \|    |    /_____/ |    |     ||      | |   /____/ |    |  |    | |`   |              //
//    |____|      |____|____|    |____|____|     | /____|_____|/       \|___|    | /____|  |____| |____|              //
//      \(          \(   \(        )/   \( |_____|/  \(    )/            \( |____|/  \(      )/     \(                //
//       '           '    '        '     '    )/      '    '              '   )/      '      '       '                //
//                                            '                               '                                       //
//                                                                                                                    //
...
contract PCT is ERC721Creator {
    constructor() ERC721Creator("Pixel Cat contract", "PCT") {}
}
