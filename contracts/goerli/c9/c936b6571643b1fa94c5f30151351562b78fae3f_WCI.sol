...
contract WCI is ERC721, Ownable {
    ...
    constructor(string memory _baseTokenURI) public ERC721("WCI NFT", "WCI") {
    ...
    function addWhiteList(address _address) public onlyOwner {
        require(_address != address(0), "ERC721: Can't be add zero address in whitelist");
        require(!whiteList[_address], "ERC721: Already listed in whitelist");

        whiteList[_address] = true;
    }

    function removeWhiteList(address _address) public onlyOwner{
        require(_address != address(0), "ERC721: Can't be remove zero address in whitelist ");
