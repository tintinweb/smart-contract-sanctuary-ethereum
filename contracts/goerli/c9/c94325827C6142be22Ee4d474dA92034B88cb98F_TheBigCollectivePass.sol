 ...
 * @notice This contract handles minting The Big Collective Pass tokens.
 */
contract TheBigCollectivePass is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeie4i5y3xfupnhg4ky4l65c7frxoc72o4w4frcxhkstq7xxod4jkae";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 333;
    uint96 public royaltyFee = 0;

    constructor() ERC721A("The Big Collective Pass", "CPASS") {
        ...
        originalUser
    {
        ...
        require(
            ExternalERC1155BurnContract.balanceOf(msg.sender, 333) >= amount,
