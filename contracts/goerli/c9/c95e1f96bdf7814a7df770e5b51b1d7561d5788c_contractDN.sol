...
contract contractDN is Ownable{
    ...
    mapping(uint256 => mapping(address => bool)) public voterIdVoting;

    mapping(bytes32 => votingInfo) public votingInfoList;
    ...
    function voterCancelVoting(uint256 _idVoting, bool _isPri, uint256 _vote) public {
        ...
        {
            require(shareHolderList[msg.sender] == true,"Error ");
            require(voterIdVoting[_idVoting][msg.sender] == true,"User Does Not Vote");
            voterIdVoting[_idVoting][msg.sender] = false;
    ...
    function votingFunction(uint256 _idVoting, bool _isPri, uint256 _vote) public {
        ...
        {
            require(shareHolderList[msg.sender] == true,"Error ");
            require(voterIdVoting[_idVoting][msg.sender] == false,"Already Voted");
            voterIdVoting[_idVoting][msg.sender] = true;
