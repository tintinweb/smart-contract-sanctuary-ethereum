...
contract Hikari is ERC721A, Ownable, ReentrancyGuard
{
    ...
    uint256 public DA_STARTING_TIMESTAMP = 1649618451; //10th April 4pm EST
    uint256 public DA_QUANTITY = 1850;
    uint256 public DA_STARTING_PRICE = 0.01 ether;
    uint256 public DA_ENDING_PRICE = 0.01 ether;
    uint256 public DA_DECREMENT = 0.01 ether;
    uint256 public DA_DECREMENT_FREQUENCY = 2400; //decrement price every 1200 seconds (20 minutes).
