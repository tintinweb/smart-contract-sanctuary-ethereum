 ...
 * on-chain.energy
 *
 * A Project by superspace.network
 * Smart Contract by fidacura
 *
 */
...
contract OnChainEnergy is ERC721Royalty, ReentrancyGuard, Ownable {
    ...
    string COLOR_1 = randomColor(360).toString();
    string COLOR_2 = randomColor(359).toString();
    string COLOR_3 = randomColor(358).toString();
    string COLOR_4 = randomColor(357).toString();
    string COLOR_5 = randomColor(356).toString();
    string COLOR_6 = randomColor(355).toString();
    string COLOR_7 = randomColor(354).toString();
    string COLOR_8 = randomColor(353).toString();
    string COLOR_9 = randomColor(352).toString();

    string TIME_1 = randomSpeed(120).toString();
    string TIME_2 = randomSpeed(119).toString();
    string TIME_3 = randomSpeed(118).toString();
    string TIME_4 = randomSpeed(117).toString();
    ...
    function mutate(uint256 tokenId) public {
        ...
        COLOR_1 = randomColor(360).toString();
        COLOR_2 = randomColor(359).toString();
        COLOR_3 = randomColor(358).toString();
        COLOR_4 = randomColor(357).toString();
        COLOR_5 = randomColor(356).toString();
        COLOR_6 = randomColor(355).toString();
        COLOR_7 = randomColor(354).toString();
        COLOR_8 = randomColor(353).toString();
        COLOR_9 = randomColor(352).toString();
        TIME_1 = randomSpeed(120).toString();
        TIME_2 = randomSpeed(119).toString();
        TIME_3 = randomSpeed(118).toString();
        TIME_4 = randomSpeed(117).toString();
