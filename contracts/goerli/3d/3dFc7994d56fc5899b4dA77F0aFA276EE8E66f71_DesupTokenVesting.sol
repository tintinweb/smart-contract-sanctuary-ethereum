...
contract DesupTokenVesting is Ownable, ReentrancyGuard {
    ...
    /**
     * @dev Set our Desup Token Published
    ...
    /**
     * @dev Set our Desup Token Price
     * @param price Desup token price for investors (SeedA)
     */
    ...
    /**
     * @dev Set our Desup Token Price
     * @param price Desup token price for public
     */
     ...
     * @param amount to withdraw, it should be less than available amount
     */
    function withdraw(uint256 amount) public {
        bool isHolder = isInHolderlists(msg.sender);
        require(isHolder, "Only holders can withdraw");

        uint256 available_amount = getAvailableAmount(msg.sender);
    ...
    function getTokenPriceForSeedA() public view returns (uint16) {
        return token_price_for_seedA;
    }

    function getTokenPriceForPublic() public view returns (uint16) {
        return token_price_for_public;
    }
