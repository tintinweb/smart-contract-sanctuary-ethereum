...
// File: contracts/ICOWithMultiSigWallet.sol
...
contract ICO is ERC20, ReentrancyGuard {
 ...
 Buyers[] public buyersList;
    ...
    constructor(address[] memory _owners, uint _numConfirmationsRequired) ERC20("BasicCoin", "BSC") {
    ...
    function timeLock(uint256 time) public  {
        openTime = block.timestamp + time;
    }
    ...
    function mint(address account, uint256 amount) public  returns (bool sucess) {
