...
/*
 * Auction V2 Factory for cryptoWine project
 *
...
// File: contracts/AuctionV2FactoryI.sol

/*
 * Interface for cryptoWine auctions V2 Factory.
 */

interface AuctionV2FactoryI {
...
/*
 * cryptoWine Auction V2 deployment interface
 */
...
// File: contracts/AuctionV2Factory.sol

/*
 * Factory for cryptoWine auctions V2.
 */

contract AuctionV2Factory is AuctionV2FactoryI {
    ...
    returns (address)
    {
        ...
        AuctionV2DeployI(newAuctionAddress).initialRegister();
