...
contract Streamer is Ownable {
    ...
    error Streamer__RunningChannel();
    ...
    function fundChannel() public payable {
        ...
        */
        require(
            ...
            "The sender already has a running channel"
        );
    ...
    function withdrawEarnings(Voucher calldata voucher) public {
        ...
        */
        ...
        require(
            ...
            "No running filled channels detected"
        );
    ...
    */
    ...
    function challengeChannel() public {
        require(balances[msg.sender] != 0, "Sender has no open channel");
    ...
    */
    ...
    function defundChannel() public {
        ...
        console.log("Defunding channel...");
        (bool success, ) = payable(msg.sender).call{
            value: balances[msg.sender]
        }("");
        require(success, "Defunding failed");
