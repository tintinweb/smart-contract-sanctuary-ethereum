...
abstract contract ContinuousVesting is Distributor {
  ...
  uint256 private immutable start; // time vesting clock begins
  uint256 private immutable cliff; // time vesting begins (all tokens vested prior to the cliff are immediately claimable)
  uint256 private immutable end; // time vesting clock ends
  ...
  function _getVestingConfig() public view returns (uint256, uint256, uint256) {
