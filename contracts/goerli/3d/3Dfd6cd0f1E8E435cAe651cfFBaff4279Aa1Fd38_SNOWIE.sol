    ...
    ERC2981
{
    ...
    uint256 public publicprice = 420 ether;
    uint256 public supplyLimit = 69;
    uint256 public publicmaxMintAmountPerTx = 2;
    ...
    address internal royaltiesReciever = 0xd4578a6692ED53A6A507254f83984B2Ca393b513;
    ...
    function PublicMint(uint256 _mintAmount) public payable nonReentrant {
        ...
        if (!freeMintClaimed[_msgSender()]) {
            if (_mintAmount > 1) {
                require(
                    msg.value >= publicprice * (_mintAmount - 1),
                    "Insufficient funds!"
                );
            }
