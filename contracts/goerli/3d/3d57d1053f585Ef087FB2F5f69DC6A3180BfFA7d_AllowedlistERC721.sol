 ...
 */
contract AllowedlistERC721 is ERC721, Ownable {
  ...
  function mint(address to, uint256 amount) external payable {
    ...
    require(
      ...
      "AllowedlistERC721:mint: No token left for mint, or you are not in the AllowedList."
    );
   ...
   */
  function getRemainingTokenByAddress(
    address addr,
    uint8 rank
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(uint256 => mapping (address => uint256)) private _allowedUserList;
