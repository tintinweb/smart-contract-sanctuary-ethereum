...
contract DataAmmo is Context, IERC20, Ownable {
    ...
    string private _name = "DATA AMMO";
    string private _symbol = "DAMMO";
    ...
    uint256 public _liquiditySellTax = 3;

    uint256 public _marketingTax;
    uint256 public _marketingBuyTax = 1;
    uint256 public _marketingSellTax = 3;

    uint256 public _treasuryTax;
    uint256 public _treasuryBuyTax = 1;
    uint256 public _treasurySellTax = 3;
    ...
    uint256 public _reflectionBuyTax = 1;
    uint256 public _reflectionSellTax = 3;

    uint256 public _exchangeTax;
    uint256 public _exchangeBuyTax = 1;
    uint256 public _exchangeSellTax = 3;
    ...
    address public _ownerAddress = 0xD025b7d7DB2caA69f7197Cc83a63e0dfA1cd1Ef4;      
    address public _marketingAddress = 0xa730150B01dfbbDf9496A445D14CaF6dbAD06741;  
    address public _treasuryAddress = 0x3775bd50d33BFAC0dfB919Ced4d53830936ae1dA;   
    address public _foundationAddress = 0x79f24C801168a62F3834ac4cF06e0a2eE4d449E5; 
    address public _exchangeAddress = 0x79f24C801168a62F3834ac4cF06e0a2eE4d449E5;   
    ...
    uint256 public _tokenAmountForExchangeTax;
    ...
    event ExchangeAddressUpdate(address exchangeAddress);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal lockTheSwap {
       ...
       uint256 tokenForExchange = contractTokenBalance * (_tokenAmountForExchangeTax) / totalTokenAmount;     
       uint256 half = tokenForLiquidity.div(2);
       uint256 otherHalf = tokenForLiquidity.sub(half);
       uint256 initialBalance = address(this).balance;
       uint256 tokenAmountForSwap = tokenForMarketing + tokenForFoundation + tokenForTreasury + tokenForExchange + half; 
       ...
       uint256 ethForExchange = newBalance * tokenForExchange / tokenAmountForSwap;
       ...
       transferToAddressETH(payable(_exchangeAddress), ethForExchange.mul(90).div(100));
    ...
    function setTaxBuyTax() internal {
      ...
      _exchangeTax = _exchangeBuyTax;
      _totalTax = _liquidityTax.add(_marketingTax).add(_treasuryTax).add(_foundationTax).add(_exchangeTax);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(_totalTax > 0) {
           ...
           _takeExchange(tTotal.mul(_exchangeTax).div(_totalTax));
        }        
    ...
    function _takeExchange(uint256 tExchange) private {
        uint256 currentRate = _getRate();
        uint256 rExchange = tExchange.mul(currentRate);
        _tokenAmountForExchangeTax += tExchange;
        _rOwned[address(this)] = _rOwned[address(this)].add(rExchange);
        if(_isExcluded[address(this)])
            _tOwned[address(this)] = _tOwned[address(this)].add(tExchange);
    }
   ...
   // External Read functions 
    ...
    function setExchangeAddress(address exchangeAddress) external onlyOwner() {
        ...
        emit ExchangeAddressUpdate(exchangeAddress);
    }        
