...
// File contracts/Okubo.sol

pragma solidity ^0.8.13;
contract Okubo is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory initialBaseURI, bytes32 _wlRoot) ERC721A("Julio Okubo", "OKUBO") {
