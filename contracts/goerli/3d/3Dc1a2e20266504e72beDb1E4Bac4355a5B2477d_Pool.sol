    ...
    IPool
{
    ...
    function tokenExists(IToken token) public view returns (bool) {
        if (token == getGovernanceToken()) return true;
        else
            return
     ...
     */
    function _getProposalCreatedAt(
        uint256 proposalId
    ) internal view override returns (uint256) {
    ...
    function _getPreviousBlockTotalVotes()
        ...
        returns (uint256)
    {
        IToken GovernanceToken = getGovernanceToken();
        return
            IToken(GovernanceToken).getPastTotalSupply(block.number - 1) -
            getGovernanceToken().service().getProtocolCollectedFee(
     ...
     * @param blocknumber  block.number
     */
    function _setProposalCreatedAt(
        uint256 proposalId,
        uint256 blocknumber
    ) internal override {
    ...
    IGovernorProposals
{
    ...
    mapping(ProposalType => uint256) private lastProposalIdByType;
    ...
    function proposeTransfer(
        ...
        lastProposalIdByType[ProposalType.Transfer] = proposalId_;
        return proposalId_;
    }
    ...
    function proposeTGE(
        ...
        require(    
                address(token) == address(0) || IPool(address(this)).tokenExists(token), 
        ...
        lastProposalIdByType[ProposalType.TGE] = proposalId_;
        return proposalId_;
    }
    ...
    function proposeGovernanceSettings(
        ...
        require(    
                proposalState(lastProposalIdByType[ProposalType.GovernanceSettings])!=ProposalState.Active, 
        ...
        lastProposalIdByType[ProposalType.GovernanceSettings] = proposalId_;
        return proposalId_;
    }
///////////////////////////////////////////////////////////////////////////////
...
/*
    function proposePoolSecretary(
        ...
        // Validate 
        require(addSecretary.length > 0 || removeSecretary.length > 0, ExceptionsLibrary.EMPTY_ADDRESS);
