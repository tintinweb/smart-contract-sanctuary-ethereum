...
contract Energetic is ERC721, Ownable, ReentrancyGuard {
    ...
    function outerEnergyTransColor1(
        uint256 _modulus
    ) public view returns (uint256) {
        return
            uint256(keccak256(abi.encodePacked(block.timestamp, msg.sender))) %
    ...
    function outerEnergyTransColor2(
        uint256 _modulus
    ) public view returns (uint256) {
        return
            uint256(keccak256(abi.encodePacked(block.timestamp, msg.sender))) %
    ...
    function innerEnergyTransColor1(
        uint256 _modulus
    ) public view returns (uint256) {
        return
            uint256(keccak256(abi.encodePacked(block.timestamp, msg.sender))) %
    ...
    function innerEnergyTransColor2(
        uint256 _modulus
    ) public view returns (uint256) {
        return
            uint256(keccak256(abi.encodePacked(block.timestamp, msg.sender))) %
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    outerEnergyBaseColor(360).toString(),
                    ', 100%, 50%)">',
                    '<animate attributeName="stop-color" values="orange;hsl(',
                    outerEnergyTransColor1(360).toString(),
                    ", 100%, 50%);hsl(",
                    outerEnergyTransColor2(360).toString(),
                    ", 100%, 50%);hsl(",
                    outerEnergyBaseColor(360).toString(),
                    ', 100%, 50%);" dur="',
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    innerEnergyBaseColor(360).toString(),
                    ', 100%, 50%)" >',
                    '<animate attributeName="stop-color" values="hsl(',
                    innerEnergyTransColor1(360).toString(),
                    ", 100%, 50%);hsl(",
                    innerEnergyTransColor2(360).toString(),
                    ", 100%, 50%);hsl(",
                    innerEnergyBaseColor(360).toString(),
                    ', 100%, 50%);" dur="',
                    randomNumber(120).toString(),
