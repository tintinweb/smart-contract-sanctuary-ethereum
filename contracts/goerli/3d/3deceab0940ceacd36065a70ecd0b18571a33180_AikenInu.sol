...
contract AikenInu is ERC20, Ownable { // 
    ...
    constructor() ERC20("PARTH", "PARTH1") { // 
        marketingWallet = payable(0x1063e3aB873e8Fa41AD0ECDca96C30fb4745701C); // 
        devWallet = payable(0x1063e3aB873e8Fa41AD0ECDca96C30fb4745701C); // 
