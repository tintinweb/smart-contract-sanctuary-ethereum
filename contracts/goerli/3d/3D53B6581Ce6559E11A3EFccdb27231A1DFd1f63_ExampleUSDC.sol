...
contract ExampleUSDC is ERC721, Ownable {
    ...
    constructor(address _token) payable ERC721("Example NFT with USDC", "USDCNFT") {
    ...
    modifier isCorrectPayment(uint256 _quantity) {
        require(tokenAddress.balanceOf(msg.sender) >= cost * _quantity, "Insufficient USDC Funds.");
        _;
    }
    ...
    {
        tokenAddress.transferFrom(msg.sender, address(this), cost * _quantity );
