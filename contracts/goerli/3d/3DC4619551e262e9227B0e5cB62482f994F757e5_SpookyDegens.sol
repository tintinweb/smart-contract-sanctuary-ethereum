...
contract SpookyDegens is ERC721A, Ownable, ReentrancyGuard {
...
uint256 costOfNFT = 0.002 ether;


uint256 numberOfFreeNFTs = 1;
...
constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("Spooky Degens", "SD") {
...
if ((balanceOf(msg.sender) == 0) && (totalMints > numberOfFreeNFTs) ) { 
...
// --------------- 2.5% Cut for Launchifi ---------------------
//  uint _balance = address(this).balance;
// payable().transfer(_balance * 25 / 1000);
// ------------------------------------------------------------
...
function setStartTokenId(uint256 _startTokenID) public {
