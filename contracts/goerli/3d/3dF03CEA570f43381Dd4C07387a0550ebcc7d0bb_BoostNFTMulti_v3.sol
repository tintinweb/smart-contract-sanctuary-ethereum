...
contract BoostNFTMulti_v3 is ERC721A, ERC721AQueryable, Ownable, ReentrancyGuard {
    struct SharedData {
        uint256 totalAmount;
    ...
    uint256 public MAX_SUPPLY = 11070;
    ...
    address private signerAddress = 0x5B978A9Fa87Eab82afc8aBFcC62E4844E976f77E;
    ...
    function mintbyref(
        ...
        (bool success1, ) = payable(_refAddress).call{value: amountToRef}("");
        require(success1, "eth transfer failed");
        (bool success2, ) = payable(owner()).call{value: mintFee}("");
    ...
    /*
        function changeLockStatus(uint256 tokenId, bool status) internal{
    ...
    */
    ...
    function setVault(address _vaultAddress) external onlyOwner {
        require(_vaultAddress != address(0), "zero address passed");
        vaultAddress = _vaultAddress;
        vault = IVault(_vaultAddress);
        emit VaultAddressUpdated(_vaultAddress, block.timestamp);
    }
