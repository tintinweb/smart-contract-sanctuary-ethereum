...
contract AltavaLandNFT is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    // Events
    event mintByOwnerEvent(address indexed owner, address indexed to, uint256 indexed tokenId);
    ...
    function mintByOwner(address to, uint256 count) public virtual onlyOwner {
        require(totalSupply().add(count) <= _totalSupplyLimit, 'no more token to mint');
