...
contract ItsTicketPass is ERC1155, Ownable {
    ...
    uint256 private _nftEtherValue = 0.25 ether;
    uint256 public totalSupply = 0;

    address[] addressMintedBalance;
    uint256[] addressMintedBalanceToken;

    constructor() ERC1155("https://ipfs.io/ipfs/QmeafDctu8T1swGBW6dymLYWMmVuZruuBMSyXLRgKLUteD/{id}.json") {
