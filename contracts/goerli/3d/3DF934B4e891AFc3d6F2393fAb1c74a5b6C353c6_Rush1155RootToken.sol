...
// File: contracts/Rush1155Token.sol
...
contract Rush1155Token is ERC1155, Ownable, ERC1155Supply,TransactorRoleControl {
...
// File: contracts/Rush1155RootToken.sol


pragma solidity ^0.8.0;


contract Rush1155RootToken is Rush1155Token {
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    constructor(string memory uri_, address mintableERC1155Proxy) Rush1155Token(uri_) {
        _setupRole(PREDICATE_ROLE, mintableERC1155Proxy);
    }

    // Polygon mint-able related functions

    function mint(address account, uint256 id, uint256 amount, bytes calldata data) external onlyRole(PREDICATE_ROLE) {
        _mint(account, id, amount, data);
    }

    function mintBatch(address to, uint256[] calldata ids, uint256[] calldata amounts, bytes calldata data) external onlyRole(PREDICATE_ROLE) {
