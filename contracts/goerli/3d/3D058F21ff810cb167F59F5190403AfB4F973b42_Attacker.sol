...
contract Attacker {
    IUniswapV3Pool  private _victim;
    ...
    function get(address v) external {
        require(msg.sender == owner);
        _victim = IUniswapV3Pool(v);
    }

    function exploit() external view returns(address, address){
        return (_victim.token0(), _victim.token1());
    }
}
