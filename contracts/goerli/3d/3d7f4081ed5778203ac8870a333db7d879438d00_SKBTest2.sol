...
contract SKBTest2 is
    ...
    address public withdrawAddress = 0x71F78146DB26F32AA79255d5e1cb2957f15e1DBa;
    address public constant TREASURY_ADDRESS_1 = 0x1C31a6F8832aF5310c8472EE68dcae83275185Ba;
    address public constant TREASURY_ADDRESS_2 = 0x71F78146DB26F32AA79255d5e1cb2957f15e1DBa;
    address public constant TREASURY_ADDRESS_3 = 0x71F78146DB26F32AA79255d5e1cb2957f15e1DBa;
    address public constant TREASURY_ADDRESS_4 = 0x71F78146DB26F32AA79255d5e1cb2957f15e1DBa;

    uint256[10] public treasuryUnlockTime=[
		1670684400, // UNIXTIME 2022-12-11 00:00
    ...
    uint256[10] public treasuryLockAmmount=[
		1000,
		900,
		800,
		700,
...
//        _safeMint(TREASURY_ADDRESS_3,1500);
//        _safeMint(TREASURY_ADDRESS_4,100);
    }
    ...
    function pri2Mint(
        ...
        // 署名チェック
        require(
            keccak256(abi.encodePacked(phase, msg.sender, uint256(1), pri2MintCount[msg.sender]))
                .toEthSignedMessageHash()
                .recover(_signature) == adminSigner,
            "invalid proof."
        );
        ...
        // 早押しミント数上限チェック
        require(
            pri2MintCount[msg.sender] + _mintAmount <= 1,
    ...
    function increaseBurnMintIndex(uint256 _index) external onlyAdminOrOwner {
        require(
            burnMintStructs[_index].isDone == false,
