...
contract SMOL is ERC1155, Ownable {
    
	uint256 CHARACTER_1 = 0;
	uint256 CHARACTER_2 = 1;
	uint256 CHARACTER_3 = 2;
	uint256 CHARACTER_4 = 3;
	uint256 CHARACTER_5 = 4;
	uint256 CHARACTER_6 = 5;

	string public name = "SMOL RPG Party";
	...
	constructor() ERC1155("") {
		maxSupply[ CHARACTER_1 ] = 1;
		maxSupply[ CHARACTER_2 ] = 1;
		maxSupply[ CHARACTER_3 ] = 1;
		maxSupply[ CHARACTER_4 ] = 1;
		maxSupply[ CHARACTER_5 ] = 1;
		maxSupply[ CHARACTER_6 ] = 1;

		totalSupply[ CHARACTER_1 ] = 0;
		totalSupply[ CHARACTER_2 ] = 0;
		totalSupply[ CHARACTER_3 ] = 0;
		totalSupply[ CHARACTER_4 ] = 0;
		totalSupply[ CHARACTER_5 ] = 0;
		totalSupply[ CHARACTER_6 ] = 0;
	}
