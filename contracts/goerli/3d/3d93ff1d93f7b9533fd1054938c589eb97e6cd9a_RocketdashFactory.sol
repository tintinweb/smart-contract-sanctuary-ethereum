...
contract RocketdashFactory is AuctionBase {
    ...
    address elonone = 0x0cE1D09c4FAD171561274291A6C3F14EC9C4CAFc;
    ...
    // 1 mint event at a time only
    function initLimitedEditionMint(
        uint256 _mintPrice, 
        uint256 _mintPeriod, 
    ...
    function mintLimitedEditionRocket() external payable noContract(msg.sender) {
        ...
        partnerAddress.transfer(share);
        teamAddress.transfer(share);
    }
