...
contract TakaraKuji is ERC20, Ownable, VRFConsumerBaseV2 {
  ...
  constructor(
    ...
    swapTokensAtAmount = (totalSupply * 1) / 10000; // 1% from total supply (1_000_000_000) to swap wallet
    ...
    pickLotteryWinnerAtAmount = (totalSupply * 1) / 10000; // 1% from total supply (1_000_000_000) for pick a new lottery winner
