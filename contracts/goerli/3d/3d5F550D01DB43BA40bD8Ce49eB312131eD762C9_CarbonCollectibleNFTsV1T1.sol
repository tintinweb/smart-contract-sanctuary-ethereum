...
contract CarbonCollectibleNFTsV1T1 is Initializable, ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function initialize(string memory _initBaseURI, address _initOwner) public initializer {
    __ERC721_init("CarbonCollectibleNFTsT1", "CCNT");
    __Ownable_init();
