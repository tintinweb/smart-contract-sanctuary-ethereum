...
contract Testtt is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    Step public state = Step.Allowlist;
    ...
    uint256 public maxPerWalletAllowlist = 5000;
    uint256 public maxPerWalletPublic = 5000;
    uint256 public maxPerTx = 500;
    
    // URIs

    string public uriPrefix = "";
    string public hiddenMetadataUri = "ipfs://QmbZFU8w2nwmD3KYYKRRxsr1Q5V1err8UFiXbACMsJCaJ1/";
    
    bytes32 public allowlistMerkleRoot = 0xf485a0494de20285fd6d12dfbc2fa2b5976a69457664f24e1d8afc71bce3e1fc;

    mapping(address => uint256) public publicMinted;
    mapping(address => uint256) public allowlistMinted;

    constructor() ERC721A("Testtt", "Testtt") {}
