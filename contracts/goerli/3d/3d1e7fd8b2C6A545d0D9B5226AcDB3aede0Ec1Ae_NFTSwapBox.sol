    ...
    ERC1155Holder
{
    ...
    mapping(uint256 => ERC20Details[]) public erc20Details;
    mapping(uint256 => ERC721Details[]) public erc721Details;
    mapping(uint256 => ERC1155Details[]) public erc1155Details;
    ...
    mapping(uint256 => ERC20Fee[])  public erc20Fees;
    mapping(uint256 => RoyaltyFee[]) public boxRoyaltyFee;
