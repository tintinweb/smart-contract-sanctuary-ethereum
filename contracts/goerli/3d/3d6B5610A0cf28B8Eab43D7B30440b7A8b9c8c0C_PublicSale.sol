    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        gnosisSafeWallet = 0x32FFa8C3E0E98Db3D04E3ADfC0553E25a11dbD8e;
        __Pausable_init();
    ...
    function purchaseNftById(uint256 _id) external {
        ...
        IERC20 token = IERC20(miPrimerToken);
        uint256 priceNft = _getPriceById(_id) * (10 ** 18);

        require(token.allowance(msg.sender, address(this)) >= priceNft, "Public Sale: Not enough allowance");
        require(token.balanceOf(msg.sender) >= priceNft, "Public Sale: Not enough token balance");
        ...
        token.transferFrom(msg.sender, gnosisSafeWallet, fee);
        // from: msg.sender - to: address(this) - amount: net
        token.transferFrom(msg.sender, address(this), net);
