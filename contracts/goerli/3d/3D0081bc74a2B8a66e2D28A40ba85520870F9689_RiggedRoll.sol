...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) public payable onlyOwner {
        require(_amount <= address(diceGame).balance, "Too much");
    ...
    function riggedRoll() public payable {
        ...
        // } else {
        //     console.log("Not a winning roll");
        // }
        require(roll <= 2, "try again");
        // isReadyToWithdraw = true;
        // uint valuSend = 0.25 ether;
        // diceGame.rollTheDice{value: valuSend}();
    }
