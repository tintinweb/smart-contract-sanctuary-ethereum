...
contract Metablizzard is ERC721Enumerable, ERC721Burnable, Ownable, ReentrancyGuard {
    ...
    constructor(string memory baseURI_, bytes32 _whitelistMerkleRoot, bytes32 _airdropMerkleRoot) ERC721("MetaBlizzard Drop 2","MBD2") {
        __baseURI = baseURI_;
    ...
    function buy(uint8 _type, uint16 amount, bytes32[] calldata proof) external payable nonReentrant {
