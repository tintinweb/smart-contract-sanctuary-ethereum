...
/**
 * @dev A NFT holder contract that will allow a beneficiary to extract the
 * tokens after a given release time.
 *
 * Useful for simple vesting schedules like "dev gets UniV3 NFT after 1 year"
 *
 * Generic locker for all tokenIDs of a particular NFT
 *
 */
contract ERC721Timelock is ERC721Holder {

    // ERC721 token contract being held
    ...
    function release(uint256 tokenId) public virtual {
        ...
        require(nft().ownerOf(tokenId) == address(this), "ERC721Timelock: tokenId specified is not in vault");
