...
contract myVault {
  ...
  function sendDai(address recipient, uint amount) public {
    require(msg.sender == owner, "Only the owner can take Ether out");
    daiToken.safeTransfer(recipient, amount);
  }

  function sendWETH(address recipient, uint amount) public {
    require(msg.sender == owner, "Only the owner can take Ether out");
    wethToken.safeTransfer(recipient, amount);
  }
