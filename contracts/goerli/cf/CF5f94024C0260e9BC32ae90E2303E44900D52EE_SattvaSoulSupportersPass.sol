    ...
    Pausable
{
    ...
    // Royalty
    address public royaltyAddress = 0x90034c27E29484f87c6eF2ea91CD06B0A0641B3F;
    ...
    uint256 public maxSupply = 20;  //It's test
     ...
     * Constructor
     */
    constructor() ERC721Psi("SattvaSoulSupportersPass", "SSSP") {
        ...
        setMetadataTitle("SattvaSoulSupportersPass");
        setMetadataDescription("This is SattvaSoulSupporters Pass.");
        setMetadataAttributes("SSSP Test");
        setImageURI("https://pass.sattva-soul-supporters.com/images/nurie_hakuto.png");
    }
