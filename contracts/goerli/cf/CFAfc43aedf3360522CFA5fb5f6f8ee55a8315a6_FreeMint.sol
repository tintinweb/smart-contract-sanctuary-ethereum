...
contract FreeMint is DefaultOperatorFilterer, ERC721, Ownable {

    string public baseURI = "https://metadata.burnghost.com/freemint/metadata/"; 
    ...
    constructor() ERC721("FreeMint", "BGFM") {}
    ...
    function safeMint(bytes32[] memory proof) public {
        ...
        require(MerkleProof.verify(proof, root, leaf), "BurnGhostAlpha: Invalid proof");

        require(minted[_msgSender()] == false, "BurnGhostAlpha: User already minted");

        require(_tokenIdCounter.current() < maxSupply, "BurnGhostAlpha: Max supply minted"); 
    ...
    // Overrides for DefaultOperatorRegistry
