...
contract wolfNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor(string memory _link) payable ERC721("wolfNFT", "WNFT"){
    ...
    function Mint(address to, uint256 quantity) public payable {
        ...
        for(uint256 i =0; i<quantity; i++){
            ...
            string memory uri = string(abi.encodePacked(getLink(), Strings.toString(totalSupply+1), ".json"));
            _safeMint(to, tokenId);
    ...
    function getTokenId(address _address) public view returns(uint[] memory){
