...
contract NiftyLaunch {
    ...
    function finalizeLaunch(address _ticketAddress) external {
        ...
        launch.finalize(); // removed remaining nfts from pool.
    }
...
contract NiftyTicket is ERC721i {
    ...
    // we set this later to not edit the original erc721i library
    ...
    function finalize() external {
        ...
        _preMintReceiver = address(0x000000000000000000000000000000000000dEaD);
    }
    ...
    //allow users to mint later if they wish.

    //todo test this
    function mint(address _to) external onlyOwner {
        _maxSupply += 1;
        _mint(_to, _maxSupply);
    }
