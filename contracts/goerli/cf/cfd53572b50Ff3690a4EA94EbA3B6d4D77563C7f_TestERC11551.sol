 ...
 * @notice This contract handles minting Test ERC-1155 1 tokens.
 */
contract TestERC11551 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xA8d352a976D472205e6340387D411350c4eEA375;
    ...
    string public name = "Test ERC-1155 1";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeieikfn7c6vjuu64gyuqm7yabzl4g7kybczntjp2avqoynnmmnrqji/{id}"
        )
    {
        ...
        tokenPresaleMaxSupply[222] = 0;
        tokenPresalePrice[222] = 0 ether;
        tokenPresaleMintsPerAddress[222] = 0;
        require(
