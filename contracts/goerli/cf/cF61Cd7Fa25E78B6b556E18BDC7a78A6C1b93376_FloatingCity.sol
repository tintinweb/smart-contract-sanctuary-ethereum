    ...
    ERC721("FloatingCity", "FLOATINGCITY"), Ownable, Pausable
{
    ...
    // token index starts from 1 and goes to 100 
    ...
    function setFCGateKeyAddress(address _address)
        external
        onlyOwner
    {
