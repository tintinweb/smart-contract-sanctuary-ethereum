...
contract ERC20Mintable is IERC20Mintable, ERC20, ERC20Burnable {
    ...
    function setMinter(address _minterAddress, bool _isMinter) external override {

       minters[_minterAddress] = _isMinter;
    }

    function mint(address _toAddress, uint256 _amount) external override {

       require(minters[msg.sender] == true, "You are not a minter");
       _mint(_toAddress, _amount);
    }

    function isMinter(address _minterAddress) external override returns(bool){
...
contract ExerciceSolution is IExerciceSolution
{
  ...
  function depositTokens(uint256 amountToWithdraw) external override returns (uint256){
	...
	//part2
	mintableERC20.isMinter(address(this));
