...
contract Putin is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("Putin Digital Trading Cards", "PDTC") {
    ...
    uint256 public maxFreeSupply = 2012;
    uint256 public maxSupply = 2012;
