...
contract UsedToilets is ERC721A, Ownable {
    ...
    string public baseURI = "toChangeLater";
    uint256 public maxSupply = 5555;
    uint256 public maxMintAmount = 2;
    
    address private partners = 0x0000000000000000000000000000000000000000;
    address private signer = 0x0000000000000000000000000000000000000001;
    
    constructor() ERC721A("UsedToiletsNFT", "USEDTOILETS"){  }
    ...
    function getSignature() public view returns (bytes32) {
