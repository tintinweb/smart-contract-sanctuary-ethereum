...
contract AudaXiousAirdrop is AccessControl, Utils {
    ...
    function receiveEventEarnings (
        ...
        require(
            activityId >= 1 && activityId <= _events[eventId].activitiesNumber,
        ...
        uint256 amount = _events[eventId].amountPerEvent
            / _events[eventId].activitiesNumber;
    ...
    function addEvent (
        ...
        require(activitiesNumber > 0, 'At least one activity required');
        require(activitiesNumber <= 255, 'Too many activities');
        _takeAsset(
        ...
        _events[_eventsNumber].activitiesNumber = activitiesNumber;
