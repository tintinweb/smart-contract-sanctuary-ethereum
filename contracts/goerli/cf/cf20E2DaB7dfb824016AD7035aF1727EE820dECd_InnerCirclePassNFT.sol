...
contract InnerCirclePassNFT is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;
    uint public maxSupply = 500;
    uint8 seedRoundSupply = 100;
    uint16 privateRoundSupply = 200;
    ...
    constructor() ERC721("InnerCirclePass", "ICP") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmZ3Q4skZy6yECHXp5CuhiuNjC5DCnbgQjtdCTm578wG9c";
    }
    ...
    function seedMint() public payable {
