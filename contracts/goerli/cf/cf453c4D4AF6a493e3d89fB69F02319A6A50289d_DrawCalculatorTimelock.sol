...
contract DrawCalculatorTimelock is IDrawCalculatorTimelock, Manageable {
    ...
    IDrawCalculator internal calculator;
    ...
    function initialize(address _owner, IDrawCalculator _calculator)
        public
        initializer
    {
        __DrawCalculatorTimelock_init_unchained(_owner, _calculator);
    }
