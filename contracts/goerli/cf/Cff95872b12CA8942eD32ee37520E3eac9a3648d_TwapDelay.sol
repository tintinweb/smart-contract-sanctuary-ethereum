...
contract TwapDelay is ITwapDelay {
    ...
    constructor(
        ...
        orders.transferGasCosts[address(0)] = Orders.ETHER_TRANSFER_CALL_COST;
    ...
    function _executeWithdraw(Orders.WithdrawOrder memory withdrawOrder) external payable {
        require(msg.sender == address(this), 'TD00');
    ...
    function _executeBuy(Orders.BuyOrder memory buyOrder, uint256 amountLimit) external payable {
        require(msg.sender == address(this), 'TD00');
    ...
    function _executeSell(Orders.SellOrder memory sellOrder, uint256 amountLimit) external payable {
        require(msg.sender == address(this), 'TD00');
