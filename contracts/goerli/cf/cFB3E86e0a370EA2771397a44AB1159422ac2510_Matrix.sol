...
contract Matrix is IMatrix, Ownable, IERC1155Receiver {
    ...
    function correspondingSquareKey()
        external
        view
        override(IMatrix)
        returns (uint256)
    ...
    function getPrice() external view override(IMatrix) returns (uint256) {
        return price;
    }
    ...
    function _getShardPairRandomly() internal returns (uint256, uint256) {
        ...
        uint256 tokenId1 = shardToken.tokenOfOwnerByIndex(
            address(this),
            index1
        );
        uint256 tokenId2 = shardToken.tokenOfOwnerByIndex(
            address(this),
            index2
        );
