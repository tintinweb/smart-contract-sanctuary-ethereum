...
contract CryptoHunters is ERC721, Ownable {
    ...
    string public constant baseUri = "https://someipfs.com/uri/";
    ...
    constructor() ERC721("Crypto Hunters", "CH") {
        isMintEnabled = false;
    }
    ...
    function mint() external payable {
        require(_whitelist[msg.sender], "CryptoHunters: address is not in whitelist");
