...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Head", unicode"Background"];
    bool private shouldWrapSVG = true;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0x93a0a24e44cef4208609b8b4ae87aed37f9731fc32ab9b4b9f185bbed704666f;
    ...
    ContractData public contractData = ContractData(unicode"clown ii", unicode"Clown Cars", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/3cc3abae-0591-4dd9-8c99-b8eda296a64d", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/3cc3abae-0591-4dd9-8c99-b8eda296a64d", "https://media.discordapp.net/attachments/1056683645399728178/1070568280353423470/smolBOB_morning_brew_sun_and_love_abc524a9-051c-411c-b7f6-291b88000411.png", 700, "0x1f1177e1EA1D5f7761B7A9083af1064369303E30");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"clown ii", unicode"CLON") {
        tiers[0] = [2,2,3,3];
        tiers[1] = [4,6];
