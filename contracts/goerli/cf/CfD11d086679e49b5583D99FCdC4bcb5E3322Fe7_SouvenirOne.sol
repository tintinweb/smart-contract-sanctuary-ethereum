...
{}
    ...
    function giftSouvenir(address[] calldata _addresses, uint256[] calldata _quantity) external onlyOwner {
   ...
   function TimeWarp(uint256[] calldata _remaining) external onlyOwner {
    ...
    function isZeroAddress(address addr) internal view returns (bool) {
   ...
   function _beforeTokenTransfer(
        ...
        require(isOwner(msg.sender) || isZeroAddress(from) || _isApprovedOrOwner(msg.sender, tokenId), "Locked / Unauthorized");
    }
