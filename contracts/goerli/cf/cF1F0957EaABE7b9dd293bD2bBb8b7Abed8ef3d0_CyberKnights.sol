...
//SMARTCONTRACT OF CYBER KNIGHTS///2023 HAS JUST STERTED AS OUR JOURNEY///
...
contract CyberKnights is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    uint public userLimit = 2;
    string public baseURI = "ipfs://QmUyxuShSjMS76EjcitiFvt8QqHPBMoezwvJtE2FbKg9TG/";
  ...
  function tokenURI(uint256 tokenId_) public view override returns (string memory) {
    ...
    constructor() ERC721("CyberKnights", "CYB") {}
   ...
   function editMintWindows(
    ...
    function allowListMint() public payable {
        ...
        require(totalSupply() <= (maxSupply - TOKENS_RESERVED), "We Sold Out!");
         require(balanceOf(msg.sender) < userLimit, "Max Mint per wallet reached");
         //require(walletMints[msg.sender] < userLimit, "You have reached a maximum of mints");
