    ...
    IBNPLMarket
{
    ...
    */
     ...
     * @param _referralAddress The address of the referrer 
     */
    function _acceptBidAndPurchaseNFT(
        ...
        emit AssetPurchaseWithLoan(_bidId, _msgSender(), _lender,_referralAddress);
    }
     ...
     */
    function setAllowedFeeRecipient(address _feeRecipient, bool _allowed) public onlyMarketOwner {
