...
contract BINGUS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BingusClassic", "BINGUS") {
    	...
    	marketingWallet = address(0xc287f64fcB340296b795E2D09921Df1e8245926e); // set as marketing wallet
