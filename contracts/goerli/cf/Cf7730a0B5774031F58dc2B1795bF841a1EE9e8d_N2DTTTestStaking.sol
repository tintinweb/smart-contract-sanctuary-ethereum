...
import "https://github.com/nabil-boudouch/tttest/blob/main/N2DEVTTTestERC20.sol";
import "https://github.com/nabil-boudouch/tttest/blob/main/NET2DEVTTTest.sol";

contract N2DTTTestStaking is Ownable, IERC721Receiver {

  struct vaultInfo {
        NET2DEVTTTest  nft;
        N2DTTTestERC20  token;
        string name;
  }
