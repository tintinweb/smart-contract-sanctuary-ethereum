...
contract Particular is Initializable {
    ...
    */
    receive() external payable {
        ...
        IERC20Upgradeable(path[1]).transferFrom(address(this), admin, amountToSave);
        //TODO: 2 wallets -> 1 for kindly and 1 for ongs
        IERC20Upgradeable(path[1]).transferFrom(address(this), 0xF2D03fc122038172F6D1ef7893135E8650C30542, amountToKindly);
