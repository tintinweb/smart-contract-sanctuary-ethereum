...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x06B6b6c3d7bb876295a96Afcc5cf4e88fc079B22,0x74E06aE8546e4ef0B1c24B4d0fCA0E7f766AAea2];
  address public erc20Payable = 0x06B6b6c3d7bb876295a96Afcc5cf4e88fc079B22;
  uint256[] public payableFees = [2,49,49];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3000, 3333) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifmyr7rngojkvv6kvjhyk6sk7i6uv5y7hq6vxcajqtkgadpmcjgdq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/brhHB9U365do5oObhpK0/contract-metadata";
  }
