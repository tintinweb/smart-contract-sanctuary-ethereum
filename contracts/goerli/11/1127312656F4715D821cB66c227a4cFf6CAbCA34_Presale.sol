...
contract Presale {
    ...
    IToken public YOTETESTE = IToken(0xC5BE3e47a9216bf4ed82c38c768CF8Bd6cE09155);
    IToken public USDT = IToken(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    AggregatorV3Interface public priceFeedEth;

    address payable public owner;

    uint256 public tokenPerUsd = 4000000000000000000000000; //4000000 tokens for $1
    uint256 public preSaleStartTime;
    uint256 public soldToken;
    uint256 public totalSupply = 3000000000000 ether; //presale tokens 
    uint256 public amountRaisedEth;
    uint256 public amountRaisedUSDT; 
    uint256 public minimumDollar = 1000000; //min buy usdt
    uint256 public minimumETH = 0.00063 ether; //min buy eth
    ...
    constructor() {
        owner = payable(0xdE15c613a68FF48f11413693F35F24Ba8918Ce8e);
    ...
    function buyTokenEth() public payable {
        ...
        YOTETESTE.transfer(msg.sender, numberOfTokens);
    ...
    function getProgress() public view returns (uint256 _percent) {
        uint256 remaining = totalSupply -
            (soldToken / (10**(YOTETESTE.decimals())));
    ...
    function getContractTokenApproval() external view returns (uint256) {
        return YOTETESTE.allowance(owner, address(this));
    }
}
