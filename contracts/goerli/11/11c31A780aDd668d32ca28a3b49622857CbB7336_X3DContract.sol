...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x72df52A99D0C0012e6C8c44924F729f0D8C1794d];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x72df52A99D0C0012e6C8c44924F729f0D8C1794d;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmSiBvfmGAFYyC7w57U6TQmUnh3mHGW9gH2n9txd61FSzW/";
...
// File: contracts/X3DContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X3DContract is RamppERC721A {
    constructor() RamppERC721A("3d", "3d"){}
}
