...
contract Momentum is Context, IERC20, Ownable {
    ...
    address private marketingWallet = 0x93dF5fb09caccFc1dC0B291465C5811D85e9127d;
    address private devWallet = 0x94CC41738a8e746E39cC966EC0f0950d826a0A79;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Momentum";
    string private _symbol = "MoM";
    uint8 private _decimals = 10;
    uint256 private _tTotal = 1000000000 * 10 ** _decimals;  //reducing total supply because of burns from previous launch
    ...
    function openTrading() external onlyOwner() {
        ...
        nextLiquidityBurnTimeStamp = block.timestamp;
        liquidityUnlockDate = block.timestamp.add(7 days); //lock the liquidity for 7 days
    }
