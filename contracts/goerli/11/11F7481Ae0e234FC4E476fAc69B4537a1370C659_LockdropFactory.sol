...
contract LockdropFactory {
    ...
    address public immutable poolsController;
    address public immutable positionManager;
    mapping(bytes32 => address) private lockdrops;
    ...
    function getLockdrop(bytes32 id) public view returns (address) {
        return lockdrops[id];
    }
    ...
    function deployNewLockdrop(
        ...
        require(
            lockdrops[id] == address(0),
            "Lockdrop with target id already exists"
        );
