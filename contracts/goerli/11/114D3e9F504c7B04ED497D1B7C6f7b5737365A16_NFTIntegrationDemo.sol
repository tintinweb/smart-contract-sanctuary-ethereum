...
contract NFTIntegrationDemo is Ownable, ReentrancyGuard, ERC721A {
    ...
    uint256 public immutable MAX_REAP_AMOUNT = 111;
    uint256 public immutable MAX_ALLOW_AMOUNT = 300;
    ...
    constructor(string memory baseTokenURI, address _vault) ERC721A("Test! NFT", "TNFT", 100) {
