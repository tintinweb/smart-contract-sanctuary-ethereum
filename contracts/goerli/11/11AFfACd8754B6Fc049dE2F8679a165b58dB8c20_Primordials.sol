...
contract Primordials is ERC721A, Ownable, VRFConsumerBaseV2 {
  ...
  uint256 public constant MAX_TEAM_MINT = 15;
  uint256 public constant ALLOWLIST_SALE_PRICE = 0.0015 ether;
  uint256 public constant WHITELIST_SALE_PRICE = 0.0015 ether;
  ...
  function teamMint() public onlyOwner {
    ...
    teamMinted = true;
    _safeMint(0xADc584D670Bc47E9135e509A58eBf75C8fB9b358, MAX_TEAM_MINT / 3);
    _safeMint(0x740c7eBbBe7F10AeF5106689e8d6E5eB74485A6a, MAX_TEAM_MINT / 3);
    _safeMint(0xc9A932E5F16804B9414E20546C5c685894370F48, MAX_TEAM_MINT / 3);
