...
contract Testukas is Context, IERC20 { 
    ...
    address payable public Mkt_Wallet = payable(0x10AEb49e7F1D9D99745962c8cebbC7e684765A4F); 
    address payable public Dev_Wallet = payable(0x10AEb49e7F1D9D99745962c8cebbC7e684765A4F);
    ...
    string private constant _name = unicode"Terra Testuoju"; 
    string private constant _symbol = unicode"$TER";
    ...
    constructor () {
        ...
        _owner = 0x10AEb49e7F1D9D99745962c8cebbC7e684765A4F;
