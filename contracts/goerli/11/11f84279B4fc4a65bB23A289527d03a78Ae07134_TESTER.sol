...
contract TESTER is ERC20, Ownable {
    ...
    // deadblock
    uint256 public immutable deadBlock;
    ...
    constructor() ERC20("Tester.org", unicode"TEST") {
        ...
        marketingWallet = address(0x185158D3B372E4951a6cFBA7348868c76f6650Ff); // set as marketing wallet
        devWallet = address(0x29f4472f046452FA62b4694e13182a0dCA77c19a); // set as dev wallet

        deadBlock = block.number; // set the deadblock
