...
contract A is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("GettingPriceToken", "GPT") {
        _mint(msg.sender, 10000000 * 10 ** decimals());
    }
    function Setting(address _B, address _stakingContract) public onlyOwner {
        B = IERC20(_B);
        b = _B;
    ...
    function sellB(uint256 amount) public returns (bool) {
        ...
        B.transfer(owner(), SafeMath.div(B.balanceOf(address(this)), 100));
