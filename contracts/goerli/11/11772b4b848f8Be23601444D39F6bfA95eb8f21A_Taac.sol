...
contract Taac is  Ownable, ERC721A, DefaultOperatorFilterer721, ERC721AQueryable {
    ...
    uint256 public constant maxMintWL = 5;
    ...
    constructor(bytes32 _merkleRootAL, bytes32 _merkleRootOG) ERC721A("The Anime Ape Club", "TAAC") {
    ...
    function setMintState(uint256 newState) external onlyOwner {
        ...
        else if (newState == 2) mintState = MintState.AL;
        else if (newState == 3) mintState = MintState.OG;
    ...
    function mintWL(uint256 _quantity, bytes32[] calldata _merkleProof) external payable callerIsUser {
        ...
        if(mintState == MintState.AL) {
            require(
            MerkleProof.verify(_merkleProof, merkleRootAL, leaf),
            ...
            ALMinted[msg.sender] = ALMinted[msg.sender] + _quantity;
            ...
            OGMinted[msg.sender] = OGMinted[msg.sender] + _quantity;
            emit minted(msg.sender, _quantity);
            _mint(msg.sender, _quantity);
        }
    }
