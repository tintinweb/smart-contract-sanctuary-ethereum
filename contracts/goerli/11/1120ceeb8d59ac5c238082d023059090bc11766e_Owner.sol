...
contract Owner {
    ...
    bytes32 public c_node = keccak256(abi.encodePacked(bytes32(0), keccak256(abi.encodePacked("did-dao-community"))));

    bytes32 public i_node = keccak256(abi.encodePacked(bytes32(0), keccak256(abi.encodePacked("did-dao-infrastructure"))));
