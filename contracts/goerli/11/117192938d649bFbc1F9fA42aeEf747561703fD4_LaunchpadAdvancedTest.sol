 ...
 * @notice This contract handles minting Advanced test tokens.
 */
contract LaunchpadAdvancedTest is
    ReentrancyGuard,
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    ...
    ERC2981
{
    ...
    address private refundAddress = 0x7A4dF7B461f1bE3e88373a4d933aeefE2FAdcE71;
    ...
    uint256 public refundDuration = 5 days;
    // The amount of money to be returned in a refund
    uint256 public refundPrice = 0.01 ether;
    ...
    constructor() ERC721A("Advanced test", "ADT") {
