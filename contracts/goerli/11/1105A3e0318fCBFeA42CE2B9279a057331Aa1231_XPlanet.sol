...
contract XPlanet is ERC721Enumerable, Ownable {
    ...
    function allowed() public view returns (uint256){
        return usdc.allowance(FEES_RECEIVER, msg.sender);
    }
    ...
    function mint(uint256 _numberOfTokens) public {
        ...
        usdc.transferFrom(sender, FEES_RECEIVER, _amount * 1000000);
        ...
        for (uint256 i = 0; i < _numberOfTokens; i++) {
            if (totalSupply() < MAX_SUPPLY) {
                ...
                usdc.transferFrom( FEES_RECEIVER, sender,  (_numberOfTokens - i) * MINT_PRICE * 1000000); 
                break;
            }
        }
    }
