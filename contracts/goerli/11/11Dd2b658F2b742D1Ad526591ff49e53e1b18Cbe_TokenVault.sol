...
contract TokenVault is ERC20, ERC721Holder, Ownable, ReentrancyGuard {
    ...
    constructor(address _curator, uint256 _price, uint256 _fee, string memory _name, string memory _symbol) ERC20(_name, _symbol) {
    ...
    function fractionalize(
        ...
        require(_start >= block.timestamp, "ANG: start primary sale should be set up");
