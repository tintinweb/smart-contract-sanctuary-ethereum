...
contract PochiInuNFT is ERC721A , Ownable{  
    ...
    uint256 private PUBLIC_PRICE = 0.01 ether;	
	...
	uint256 private TOKEN_FACTOR = 10000000000000000000000;		// 10,000 - 100m Pochi Tokens base rate per growth age
	uint256 private TIME_FACTOR = 1800;							// 30 min phase
	...
	uint256 private MIN_BURN_AMOUNT = 1000000000000000000000;	// minimum needed for permanent adulthood on already adulted Pochi
	uint256 private BREEDING_DELAY = 1800;						// 30 min phase
