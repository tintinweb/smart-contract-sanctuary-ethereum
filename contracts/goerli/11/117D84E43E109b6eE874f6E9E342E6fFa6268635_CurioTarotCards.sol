...
contract CurioTarotCards is ERC721AQueryable, IERC721ABurnable, Ownable, Pausable, ReentrancyGuard {
    ...
    function setBallerMintRoot(bytes32 _root) external onlyOwner {
        ballerMintRoot = _root;
    }  

    function setBallerPublicMintActive(bool isActive) external onlyOwner {
        _ballerPublicMintActive = isActive;
    }  

    function setBallerWhitelistMintActive(bool isActive) external onlyOwner {
