...
contract Boom is ERC721Enumerable, Ownable {
    ...
    function setDescriptor(IBoomDescriptor newDescriptor) external onlyOwner {
        descriptor = newDescriptor;
    }
