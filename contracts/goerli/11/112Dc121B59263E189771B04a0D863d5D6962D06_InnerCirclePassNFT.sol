...
contract InnerCirclePassNFT is ERC721, ERC721Enumerable, Pausable, Ownable, ReentrancyGuard {
    ...
    function publicMint() public payable nonReentrant {
        ...
        require(NFTsPerWallet[msg.sender] < capPerWallet, "You have already minted the maximum amount of NFTs for your wallet, Thank you");
        internalMint();
        NFTsPerWallet[msg.sender] += 1;
    }
