...
abstract contract Project {
    ...
    string constant _name = "SparkoTest061115";
    string constant _symbol = "ST061115";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 100**9 * 10**_decimals;
 ...
 * MainContract
 */
contract SparkoTest061115Contract is Project, IERC20, Ownable {
