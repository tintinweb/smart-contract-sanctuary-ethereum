...
contract SeedworldMounts is ERC721AQueryable, Ownable {
    ...
    function safeMint(
        ...
        require(
            !whitelists[sender].minted,
            "You already minted all available mounts"
        );
    ...
    // functuion to override the start count on the ERC721A partner
    function _startTokenId() internal pure override returns (uint256) {
        return 1;
    }

    //Renounce ownership when all mounts have been minted
