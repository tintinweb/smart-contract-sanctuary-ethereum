...
contract FreeNFT is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("FreeNFT", "FN") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        if (isFree) {
            cost = 0;
            require(quantity <= maxFreePerTx, "Max per TX is 2");
        } else {
            require(quantity <= maxPerTx, "Max per TX is 5");
        }
