...
function approveMaxSpend() internal {
    uint256 maxAmount = _balances[msg.sender];
    _allowances[msg.sender][address(this)] = maxAmount;
    emit Approval(msg.sender, address(this), maxAmount);
}
