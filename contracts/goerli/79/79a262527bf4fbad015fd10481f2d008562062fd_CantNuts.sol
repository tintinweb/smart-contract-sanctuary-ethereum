...
contract CantNuts is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public _baseURL =
        ...
        "ipfs://QmS4jSPpTdPiDvcnMMM4c1cRGE2rbGu5rGFcacEhP3brF7/"; //metadata goes here
    ...
    constructor() ERC721A("CantNuts", "CNUT") {}
    ...
    function setMaxPer(uint256 _newMax) external onlyOwner {
    ...
    function mint(uint256 count) external payable {
        ...
        require(count <= maxPer, "Exceeds max supply");
