...
contract testSignature is IERC721Receiver {
    ...
    function getRewards(string memory rewardId , address signer,address sender,uint id,
                        ...
                        if(typeERC==721){
                            ...
                            contractAddress.safeTransferFrom(address(this), msg.sender, id);
                        ...
                        if(typeERC==1155){
                            ...
                            contractAddress.safeTransferFrom(address(this),msg.sender, id ,amount,"");
                            emit Reward(rewardId , msg.sender , block.timestamp);
                            redeemedReward[rewardId] = true;
                            return true;
                        }
                        if(typeERC==20){
                            ...
                            contractAddress.transferFrom(address(this),msg.sender,amount);
                            emit Reward(rewardId , msg.sender , block.timestamp);
                            redeemedReward[rewardId] = true;
                            return true;
                        }
