...
abstract contract CNPScore is Ownable {
    ...
    address public constant CONTRIBUTOR_ADDRESS_1 = 0x87d71224204e1438919743001376484a57b02d7c;
    address public constant CONTRIBUTOR_ADDRESS_2 = 0xF8D81e6fa6F2096D7258d8FD2b6567614A6b6e82;
    address public constant CONTRIBUTOR_ADDRESS_3 = 0x84F81B8822e6e18e32233b2978Df584E49c39969;
    ...
    string public baseURI = "https://data.insearchoffreedom.jp/json/";
...
contract CNPS is CNPSadmin {
    ...
    constructor() ERC721A("CNP Students", "CNPS") {
        ...
        _safeMint(CONTRIBUTOR_ADDRESS_1, 3);
        _safeMint(CONTRIBUTOR_ADDRESS_2, 3);
        _safeMint(CONTRIBUTOR_ADDRESS_3, 3);
    ...
    function mint(
        ...
        if (alcount == saleCountForFinishTime) {
            require(finishTime >= block.timestamp, "can not mint");
        }
