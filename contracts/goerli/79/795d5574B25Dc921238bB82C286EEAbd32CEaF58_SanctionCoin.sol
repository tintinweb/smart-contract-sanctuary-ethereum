...
contract Blacklistable is Ownable {
    ...
    event Whitelisted(address target);
...
contract SanctionCoin is Blacklistable, IERC20 {
    ...
    function allowance(address target, address spender) public view returns (uint256) {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        require(!isBlacklisted(from), "Transaction sender is blacklisted");
        require(!isBlacklisted(to), "Transaction recipient is blacklisted");
