...
//@@@@@@@@@@@@@@@@@@@@@@@@@#GJ!~:                  :~!JG#@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@BP?~:         :!!    !!:         [email protected]@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@B57:    ^!^    ^Y#@J.   ?&#Y^    :!^.^Y~   .^[email protected]@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@G7.    ^YBP7:  ^Y#@@&J.   ?&@@&Y^  :75?P&&5~.   .7G&@@@@@@@@@@@@
//@@@@@@@@@@@@@&P!.  .~JP&@G~   ^[email protected]@@@&J.   ?&@@@@G~  !Y^.?&@&BY^   [email protected]@@@@@@@@@@
//@@@@@@@@@@@@&J.    ^?YP#P~   ^5#&&@@@J.   [email protected]@@&&#5^ .?5~.~?!::.     ^5&@@@@@@@@@
//@@@@@@@@@@@P~.         .     ....~???^    ^???~....  .?5J~ .:::::.   .?#@@@@@@@@
//@@@@@@@@@@P^   .!Y555Y~                                .?P5G&&&&&G7.  .7#@@@@@@@
//@@@@@@@@@5^   [email protected]@@@@@J. ..     .:            ..     .: [email protected]@@@@@@@&Y:   7#@@@@@@
//@@@@@@@@5:   [email protected]@@@@@&J. !P?: :?P7    :~~:    !P?: :?P7  ?&@@@@@@@@&?.   ?&@@@@@
//@@@@@@@B!   :[email protected]@@@@@@&J.  :?PGP?:   :J#@@#J:   :?PGP?:   ?&@@@@@@@@@B!   :Y&@@@@
//@@@@@@@J   .?&@@@@@@&Y:   ^JPPPJ^  .?B?~~?BJ.  ^JPPPJ^   :[email protected]@@@@@@@@@5^   ?&@@@@
//@@@@@@G!   7#@@@@@@@&?   !5?: .757  ~~    ~~  !5?: .757  [email protected]@@@@@@@@J.  :J&@@@
//@@@@@&?   [email protected]@@@@@@@&?.  ..     ..            ..     ...:^. ~P&&&&&&&#?.   ?&@@@
//@@@@@&J.   ^?JJJJJJJ~.                                ^^.    .^^^^^^^^.    ?&@@@
//@@@@@&?    ^?JJJJJJJ~.    ~JJJJJJJJJJ~    ~JJJJJJJJJYP#?.   ~P########?.   ?&@@@
//@@@@@&Y:  .[email protected]@@@@@@@&?.   [email protected]@@@@@@@@@J.   [email protected]@@@@@@@@@@&J.   [email protected]@@@@@@@@J.  [email protected]@@@
//@@@@@@&?.  7#@@@@@@@&J.   ?&@@@@@@@@&J.   ?&@@@@@@@@@@&J.   ?&@@@@@@@P^   [email protected]@@@@
//@@@@@@&?   .?&@@@@@@&?    ?&@@@@@@@@&J.   ?&@@@@@@@@@@@J.  :Y&@@@@@@#7   :Y&@@@@
//@@@@@@@B!   :[email protected]@@@@@@B!   [email protected]@@@@@@@&J.   ?&@@@@@@@@@@5: :~Y&@@@@@@&J.   ?&@@@@@
//@@@@@@@@5:   [email protected]@@@@@@P7!!!5&@@@@@@@&J.   ?&@@@@@@@@#P!  ?&@@@@@@@@Y:   [email protected]@@@@@
//@@@@@@@@@5^   [email protected]@@@[email protected]@@@@@@@@@&?.   ?&@@@@@@&G!    ?&@@@@@@B?:   7#@@@@@@@
//@@@@@@@@@@P~ ^Y#@@@&?    ~G&&&&&Y^:::.    .::::::::.     .7Y5Y5GJ.   .7#@@@@@@@@
//@@@@@@@@@&P~ .!YYYY!.     .::::?B5???^    ^????~...            7J:..~5&@@@@@@@@@
//@@@@@@@@@G!.          .    .:[email protected]@@@J.   [email protected]@@@@&5^   ^5PYY?^  ^7?P#&@@@@@@@@@@@
//@@@@@@@@@@&J.    ^JYYPP~   ^5&@@@@@@&J.   ?&@@@@G~   [email protected]&PJ!.  .~P&@@@@@@@@@@@@@
//@@@@@@@@@@@&G7.  .~?5&@B!   ^[email protected]@@@@@&J.   ?&@@&Y^   ~PB5~    .7G&@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@B?:    ^YBP!   :Y#@#B#@J.   ?&#Y^     ^^    [email protected]@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@BP?:    ::     ^J^ :!!    !!:         [email protected]@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@#GJ!:       :.                :~!JG#@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@#GY!!!!JGGGY!!!!!!!!!!JGGB#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
contract Defaces is ERC721A, Ownable, ReentrancyGuard {
    ...
    bytes32 whitelistMerkleRoot = 0x5b27379ee186757b18df2a69b75b8c7ff754d17dd111468fe563b2dc322042e8;
    
    uint256 public maxSupply = 5000;
    uint256 public maxWhitelistSupply = 3000;
    ...
    modifier mintCompliance(uint256 quantity) {
        require(quantity > 0, unicode"Defaces>0◠0");
        require(totalSupply() + quantity <= maxSupply, unicode"ERROR◠404");
        _;
    }

    function DefaceMint(uint256 quantity)
     public
     payable
    ...
    function DefacesLists(bytes32[] calldata _merkleProof, uint256 quantity)
     public
     payable
     mintCompliance(quantity)
     nonReentrant
    ...
    function ReserveMint(uint256 quantity, address _to) 
    public 
    onlyOwner 
    mintCompliance(quantity) 
    {
