...
contract BiplesMarketplace is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    modifier validListing(
        ...
        require(_getNow() < listedItem.deadline, "listing expeired");
        _;
    }
    ...
    /// @param _deadline scheduling for a future sale
    function listItem(
        address _nftAddress,
        uint256 _tokenId,
        uint256 _quantity,
    ...
    function acceptOffer(
        ...
        IERC20Upgradeable(offer.payToken).safeTransferFrom(
            _creator,
            feeReceipient,
            feeAmount
        );
