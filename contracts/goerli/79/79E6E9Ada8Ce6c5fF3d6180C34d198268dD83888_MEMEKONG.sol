    ...
    ERC20Upgradeable
{
    ...
    //Eth tax additions
    uint256 public _swapTokensAmount = 10000 * 10 ** 9; //
    ...
    function _transferMkong(
        ...
        if (sender == owner()) {
            ...
            if ((sender == uniPool && recipient != address(uniswapV2Router))) {
                ...
                uint256 userBuyAmount = amount.sub(_taxFee).sub(
                    buyAdminCommission
                );
                if (canSwap && !sync) {
                    swapTokensForEth(buyAdminCommission);
                }
                ...
                if (canSwap && !sync) {
                    swapTokensForEth(sellAdminCommission);
                }
                _burnMkong(sender, _taxFee);
