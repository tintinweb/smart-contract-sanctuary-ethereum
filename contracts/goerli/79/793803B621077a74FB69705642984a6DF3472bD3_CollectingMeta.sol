...
contract CollectingMeta is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public costOne = 0.001 ether;
    uint256 public costTwo = 0.002 ether;
    uint256 public costThree = 0.003 ether;
    uint256 public costFour = 0.004 ether;
    uint256 public currentCost;
    uint256 public tokenTierOne = 2;
    uint256 public tokenTierTwo = 4;
    uint256 public tokenTierThree = 6;
    uint256 public tokenTierFour = 8;
    ...
    function getCurrentCost() public view returns (uint256 _currentCost) {
        ...
        } else if (supply > tokenTierTwo && supply <= tokenTierThree) {
            _currentCost = costThree;
        } else if (supply > tokenTierThree && supply <= tokenTierFour) {
            _currentCost = costFour;
        }
        return _currentCost;
    }
    ...
    function setCostFour(uint256 _newCost) public onlyOwner {
        costFour = _newCost;
    }
    ...
    function setTokenTierThree(uint256 _newTokenTier) public onlyOwner {
        tokenTierThree = _newTokenTier;
    }

    function setTokenTierFour(uint256 _newTokenTier) public onlyOwner {
        tokenTierFour = _newTokenTier;
    }
