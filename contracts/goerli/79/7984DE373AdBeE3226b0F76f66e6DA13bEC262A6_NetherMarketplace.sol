...
contract NetherMarketplace is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    struct SaleInfo {
        address seller;
        uint256 price;
    }
    ...
    function initialize(address _register, address _weth) public initializer {
        ...
        changeCreateFee(.0001 ether, 0 ether, .0001 ether);
    }
    ...
    function bidOnNonAuctionItem(address collection, uint256 tokenID, uint256 newPrice) public onlyRegisterUser {
        ...
        require(bidInfo.highestBidPrice < newPrice, "You have to with more bigger that current highest bid price");
    ...
    function bidOnAuction(address collection, uint256 tokenID) public payable onlyRegisterUser {
        ...
        require(auctionInfo.highestBidPrice < msg.value, "You have to with more bigger that current highest bid price");
