...
contract TREX is ERC721A, EIP712, Ownable {
	...
	address dev = 0x507CdC308B1d62BC52cB6C292a12A21E669318E5;
	...
	//		require(WL_RESERVE >= (totalSupply() + _quantity),"Whitelist has been sold out.");
    ...
    function mint(uint256 _quantity) external payable mintCompliance()
	{
			...
			require(MAX_SUPPLY >= (totalSupply() + _quantity)-WL_RESERVE,"The collection has been sold out.");
            require(_mintedAmount + _quantity <= 5,"Max Per Wallet Reached");
