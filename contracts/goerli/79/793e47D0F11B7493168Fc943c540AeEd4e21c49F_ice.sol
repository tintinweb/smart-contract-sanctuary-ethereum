...
contract ice is Context, IERC20, Ownable {
    ...
    string private _name = "ice";
    string private _symbol = "ICE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x916Eb27FdB3924898717BA0C03bC93663B3dbf42); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x916Eb27FdB3924898717BA0C03bC93663B3dbf42); // DEv/Buyback address
