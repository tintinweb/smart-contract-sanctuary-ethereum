    ...
    OprimizedEnumNonBurnable
{
    ...
    string constant _contractPath = "contract/coscon2022_identity.json";
    string constant _contractName = "CosCon 2022";
    string constant _contractSymbol = "CC22";
    ...
    function contractURI() public pure returns (string memory) {
        return string(abi.encodePacked(_metadataURI, _contractPath));
    }
}
