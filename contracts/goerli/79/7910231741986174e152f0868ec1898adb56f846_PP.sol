...
// File: https://github.com/LayerZero-Labs/solidity-examples/blob/main/contracts/examples/PingPong.sol
...
contract PP is PingPong {
    constructor(address _endpoint) payable PingPong(_endpoint) {}
}