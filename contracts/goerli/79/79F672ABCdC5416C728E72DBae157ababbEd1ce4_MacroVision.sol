...
// File: contracts/MacroVision.sol
...
contract MacroVision is ERC721, Ownable {
    using Strings for uint256;

    uint256 private constant MAX_TOKENS = 1000;
    uint256 private constant TOKENS_RESERVED = 50;
    ...
    constructor() ERC721("NFT Name", "SYMBOL") {
        baseUri = "ipfs://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transfer, ) = payable(0x828C586142c264B1cA9B6aEd79f457f6Ed92Fa7f)
            .call{value: balance}("");
