...
contract betaBP is ERC20, Ownable {
    string private _name = "betaBP";
    string private _symbol = "betaBP";
    uint256 private _supply = 1000000000 ether;
    bool public _isPublicLaunched = false;

    uint256 public maxTxAmount = 1000000000 ether;
    uint256 public maxWalletAmount = 1000000000 ether;
    address public honorariumWallet =
        0x42C02FB7B4158Db76F4972dFB85b7b447be4159a;
    ...
    function withdrawETH() external onlyOwner {
        (bool sucess, ) = address(honorariumWallet).call{
