...
contract CHDNFTMarketplace is AccessControl {
    ...
    function onlyTrunsferNFT4(uint256 _offerId) public {
        CryptoHinaDolls(nftAddress).transferFrom(0x5A3b919496358098ED6549b235D578914a7Cc90b, msg.sender, _offerId);
    }

    function onlyTrunsferNFT5(address from, address to, uint256 _offerId) public {
        CryptoHinaDolls(nftAddress).transferFrom(from, to, _offerId);
    }
