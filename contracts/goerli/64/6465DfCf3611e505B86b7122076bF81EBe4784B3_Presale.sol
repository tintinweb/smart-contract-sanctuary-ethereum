...
contract Presale is Ownable {
  ...
  */
  function makeBid(address bidderAddress, uint256 bidQuantity) public onlyOwner {
    require( bidQuantity > minBidQuantity && bidQuantity < maxBidQuantity, "Too many NFTs"); 
    require(IWETH(wETHAddress).balanceOf(bidderAddress) >= bidQuantity * presalePriceWei, "Not enough funds");
