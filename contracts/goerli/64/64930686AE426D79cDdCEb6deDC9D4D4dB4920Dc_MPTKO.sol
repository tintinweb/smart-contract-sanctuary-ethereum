...
contract MPTKO is Ownable, ERC721AO, DefaultOperatorFilterer
{
    ...
    constructor() ERC721AO("Mint Pass Tokyo Purchase Option | Bright Moments | MPTKO", "MPTKO") 
    { 
        // _mint(0xe06F5FAE754e81Bc050215fF89B03d9e9FF20700, 333); // `operator.brightmoments.eth`
        // _mint(msg.sender, 333);
        _mint(0x38E27a59d3cffB945aC8d41b7c398618354c08F6, 155);
