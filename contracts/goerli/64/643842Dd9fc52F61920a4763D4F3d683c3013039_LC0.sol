...
/**
 * @dev Ethereum Natural Language Specification Format (NatSpec) tags
 * (e.g., '@title', '@author', '@notice') are used throughout this file.
 *
 * This pragma means that the file will not compile with an earlier
 * version (<0.8.0) and will not work on a later major version (>=0.9.0),
 * but will work with any 0.8.x branch (e.g., 0.8.0, 0.8.1, 0.8.2, etc.).
 */
...
/// @title Information about the current execution context
/**
 ...
 * (e.g. ERC20 contract, ERC20Burnable contract, LuckyToken contract, etc.).
 *
 * Abstract contracts are used as base contracts so that child contracts can
 * inherit and utilise its functions.
 */
...
contract ERC20 is Context {
    ...
    function _approve(
        ...
        require(spender != address(0), "ERC20: approve to the zero zero address");
...
/// @title Destruction of {ERC20} tokens
/**
...
/// @title Implementation of the {ERC20} supply mechanism
/**
...
/// @title Creation of my ERC20 token
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyCoinAL", "LCAL") {}
}