...
contract lottery {
    ...
    uint start_block = 8336660;
    uint close_block = 8336680;
    ...
    function check_participants(uint) private view returns(uint) {
        return total_users;
    }

    // 당첨자 수 확인 read 부분 만들어야됨. 아래 코드 에러
    // function check_winners(uint) private view returns(uint) {
    //     return uint(winners);
    // }
