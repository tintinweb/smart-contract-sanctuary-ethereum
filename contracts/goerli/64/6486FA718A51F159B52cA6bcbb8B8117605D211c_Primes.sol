...
contract Primes is ERC721r, Ownable {
    ...
    uint256 private constant MAX_SUPPLY_MINUS_RESERVE = MAX_SUPPLY - RESERVE;
    uint256 private constant PRESALE_MAX_SUPPLY = 8; // 600+1
    ...
    function privateMint(
        ...
        require(
            totalSupply() + _quantity <= PRESALE_MAX_SUPPLY + 1,
            "Maximum presale limit exceeded"
        );
    ...
    function publicMint(
        ...
        require(
            totalSupply() + _quantity <= MAX_SUPPLY_MINUS_RESERVE,
