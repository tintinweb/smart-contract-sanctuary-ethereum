...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    ...
    require(yourToken.balanceOf(address(this)) > msg.value * 100, "no enough GLD");
  ...
  function sellTokens(uint256 _amount) public {
    require(address(this).balance >= _amount / 100, "no enough eth");
    require(yourToken.balanceOf(msg.sender) >= _amount, "no enough GLD");
