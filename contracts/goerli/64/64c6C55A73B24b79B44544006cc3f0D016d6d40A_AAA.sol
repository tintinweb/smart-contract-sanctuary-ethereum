...
contract AAA is ERC721A, Ownable, ReentrancyGuard, OperatorFilterer {
    ...
    function unregister() external onlyOwner {
        IUnregister u = IUnregister(0x000000000000AAeB6D7670E522A718067333cd4E);
        u.unregister(address(this));
    }
}
