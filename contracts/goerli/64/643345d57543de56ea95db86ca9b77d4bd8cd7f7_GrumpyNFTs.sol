...
contract GrumpyNFTs is Ownable, ReentrancyGuard, ERC721AQueryable, IERC721ABurnable {
        ...
        callerIsUser
    {
        ...
        // mint GrumpyNFTs
        //uint256 firstGrumpyId = _nextTokenId();
    ...
    function setPackxContract(address addr) external onlyOwnerOrAdmin {
