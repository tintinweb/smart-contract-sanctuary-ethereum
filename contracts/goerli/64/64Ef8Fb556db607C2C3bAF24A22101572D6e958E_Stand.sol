...
// TODO replace Stand with actual contract name
contract Stand is ERC721V, Ownable, ERC2981 {
    ...
    string public MINT_PROVENANCE_HASH = "";
    ...
    uint256 public constant TREASURY_SUPPLY = 250;
    ...
    // To be released later
    string public AUCTION_PROVENANCE_HASH = "";
    ...
    // TODO replace name and symbol with actual ones + move unlock times out of constructor
    constructor(address initialPresale) ERC721V("Name", "Symbol") {
    ...
    function mintTier(
        ...
        if (_signatureUsed[hash]) revert SignatureAlreadyUsed();
        _signatureUsed[hash] = true;
