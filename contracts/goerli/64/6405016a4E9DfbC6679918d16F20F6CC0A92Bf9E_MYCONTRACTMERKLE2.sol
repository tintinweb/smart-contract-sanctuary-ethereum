...
contract MYCONTRACTMERKLE2 is ERC721A, Ownable, Pausable, ERC721AQueryable{
    ...
    uint64 public salePhase = 0;

    uint64 public mintedCountPhase = 1;   //カウントアップでミント済みをリセット
    ...
    // public mint
    function publicMint(uint256 _mintAmount) external payable whenNotPaused callerIsUser {
