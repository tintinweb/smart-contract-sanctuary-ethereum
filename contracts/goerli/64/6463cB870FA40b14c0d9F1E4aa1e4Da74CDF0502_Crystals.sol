    ...
    IERC5050Receiver
{
        ...
        nonReentrant
    {
        ...
        if (isHyperEventOn) {
            payable(hyperChest).transfer(msg.value - 0.01 ether);
        }
    }
    ...
    function ownerSetHyperEvent(bool _isOn, address _hyperChest, uint256 _mintfee) external onlyOwner {
        isHyperEventOn = _isOn;
        hyperChest = _hyperChest;
        mintFee = _mintfee * 1 ether;
        mMintFee = _mintfee * 1 ether;
    }
