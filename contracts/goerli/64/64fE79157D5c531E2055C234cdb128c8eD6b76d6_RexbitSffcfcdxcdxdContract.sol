    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/zJT5i3VbGGE96C1wdoBe/contract-metadata";
  }
...
// File: contracts/RexbitSffcfcdxcdxdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RexbitSffcfcdxcdxdContract is ERC721APlus {
    constructor() ERC721APlus("REXBITSffcfcdxcdxd", "RXBT"){}
}