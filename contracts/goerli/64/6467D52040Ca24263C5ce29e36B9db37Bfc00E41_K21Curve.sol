...
contract K21Curve is Ownable {
  ...
  uint256 public _resetInterval = 100800;//number of 12second blocks in 2 weeks
  ...
  function getBurnReward(uint256 _x) public view returns(uint256 price) {
    ...
    int256 burnFraction18 = SignedWadMath.toWadUnsafe(1) - int256(_posFeePercent18);
    int256 burnPrice18 = SignedWadMath.wadMul(burnFraction18, int256(mintPrice18));
