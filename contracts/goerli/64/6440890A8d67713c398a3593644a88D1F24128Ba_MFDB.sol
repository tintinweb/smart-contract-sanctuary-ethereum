...
contract MFDB is ERC1155, Ownable {
    using Strings for uint256;
    
    string name_;
    string symbol_;   
    string private baseURI = "ipfs://QmfU5LfR5z8hj3LP9AsPGECJ2WoDRgNb2dGgfPsETrodsK/";
    
    constructor() ERC1155("MFD") {
        name_ = "MFD";
        symbol_ = "MFD";     
    }

    function airdrop( address [] calldata wallet, uint256 id) external onlyOwner {
