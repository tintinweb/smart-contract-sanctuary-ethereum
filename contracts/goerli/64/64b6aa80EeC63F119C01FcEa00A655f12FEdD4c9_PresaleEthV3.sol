    ...
    OwnableUpgradeable
{
    ...
    function checkLockupBonus(
        ...
        if (lockup_bonus[lockup_months] == 0) {
            ...
            bonus =
                ((amount * BASE_MULTIPLIER) * lockup_bonus[lockup_months]) /
                10000;
    ...
    function checkTokenQuantityBonus(
        ...
        uint256 price = (amount * stagePrice) / BASE_MULTIPLIER;
        ...
        return ((amount * BASE_MULTIPLIER) * bonus) / 10000;
    }
    ...
    function update(
        ...
        userDeposits[_user].push(
            UserDeposits(
                amount * BASE_MULTIPLIER,
                newBonus,
                (((amount * BASE_MULTIPLIER) + newBonus) *
                    initialClaimPercent) / 10000,
                0,
                time
            )
        );
