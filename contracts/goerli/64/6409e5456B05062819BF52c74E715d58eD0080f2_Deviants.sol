    ...
    ReentrancyGuard
{
    ...
    IERC721 private constant polymorphsV1Contract =
        IERC721(0xfBF3471CB8e09967E41aBf56d66a3eC59BF371F7);
    ...
    IERC721 private constant lobstersContract =
        IERC721(0x19946452eF676B28F32BdCcCAF69aA75DD61d1ac);
    ...
    function discountMint(uint256 _amount) public payable nonReentrant {
        ...
        require(msg.value >= (discountPrice * _amount), "Not enough ETH sent");
        ...
        uint256 excessAmount = msg.value - (discountPrice * _amount);
        if (excessAmount > 0) {
