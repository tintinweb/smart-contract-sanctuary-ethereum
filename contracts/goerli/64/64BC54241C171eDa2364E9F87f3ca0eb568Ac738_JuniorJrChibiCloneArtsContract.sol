    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 102) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiadijr3aaxdobbdd52uliqwqucagwblndah5q4bzxg3qlucbgi53e/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/DSd0xH1N9XsUu1PYVr4T/contract-metadata";
  }
...
// File: contracts/JuniorJrChibiCloneArtsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JuniorJrChibiCloneArtsContract is RamppERC721A {
    constructor() RamppERC721A("Junior Jr Chibi  Clone Arts", "JJC2"){}
}
