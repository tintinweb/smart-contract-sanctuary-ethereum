...
contract Loot is ERC1155, AccessControl {
    ...
    function getDropsInTable(string calldata table) public view returns (uint256) {
        return _lootTables[table].length;
    }

    function getDropId(string calldata table, uint256 dropIndex) public view returns (uint256) {
