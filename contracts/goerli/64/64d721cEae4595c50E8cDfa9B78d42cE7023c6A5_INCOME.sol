...
contract INCOME is ERC20TrueBurn, Ownable, SafeToken {
    ...
    function setMarketingWallet(address payable _newMarketingWallet)
        public
        onlyOwner
    {
    ...
    constructor() ERC20TrueBurn("Income Island Token", "INCOME") {
        ETHRewardsFee = 2;
        burnFee = 1;
        liquidityFee = 2;
 ...
 */
contract ERC20TrueBurn is Context, IERC20, IERC20Metadata {
