    ...
    ERC721AQueryableUpgradeable
{
    ...
    function approve(address to, uint256 tokenId)
        ...
        onlyAllowedOperatorApproval(to, _operatorFilteringEnabled)
    {
    ...
    function setApprovalForAll(address operator, bool approved)
        ...
        virtual
        override(ERC721AUpgradeable, IERC721AUpgradeable)
        onlyAllowedOperatorApproval(operator, _operatorFilteringEnabled)
    {
    ...
    function transferFrom(
        ...
        public
        override(ERC721AUpgradeable, IERC721AUpgradeable)
        onlyAllowedOperator(from, _operatorFilteringEnabled)
    {
    ...
    IBaseCollection
{
    ...
    // Operator Filtering
    bool internal _operatorFilteringEnabled = true;
    ...
    function setOperatorFilteringEnabled(bool value)
        ...
        onlyRolesOrOwner(ADMIN_ROLE)
    {
        _operatorFilteringEnabled = value;
    }
