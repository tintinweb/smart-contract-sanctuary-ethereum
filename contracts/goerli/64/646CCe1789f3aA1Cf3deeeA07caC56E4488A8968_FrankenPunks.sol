...
/**
 * @title FrankenPunks test contract
 * @author New Fundamentals, LLC
 *
 * @notice 10,000 NFT collection used as a test
 */
contract FrankenPunks is ERC721, Owned {
    ...
    ) ERC721("FrankenPunks", "FP") Owned(msg.sender) {
    ...
    /**
     * @notice Allows the contract owner
     */
