...
contract MLoot is ERC721KeyCallerBase, ERC721Enumerable, ReentrancyGuard, Ownable, Pausable {
    ...
    function _checkKeyModifier(address caller) internal override virtual {
    ...
    function _claim() internal nonReentrant {
        ...
        require(lastId < 8000, "MAX SUPPLY");
        _tokenIds.increment();
        uint256 tokenId = _tokenIds.current();
        _safeMint(_msgSender(), tokenId);
    }

    function claim() public keyReady whenNotPaused {
        ...
        require(isApproved, "Keys has not been approved to contract");
    ...
    constructor() ERC721("More Loot", "MLOOT") Ownable() Pausable() {}
