...
contract PetMferSeVersion1 is ERC721A, Ownable {
    ...
    uint public constant MAX_RESERVE_SUPPLY = 10;

    string public _baseURIExtended;
    bool public saleIsActive = false;
    address payable public _shareholderAddress;
    address payable public _reservedHolderAddress;
    ...
    function reserve(uint256 quantity) public onlyOwner {
        ...
        require(_reservedHolderAddress != address(0), "Not set the reserve holder address!");
        require(totalMinted.add(quantity) <= MAX_SUPPLY, "No more promo NFTs left");
        _safeMint(_reservedHolderAddress, quantity);
    }
    ...
    function setReservedHolderAddress(address payable reservedHolderAddress) public onlyOwner {
        _reservedHolderAddress = reservedHolderAddress;
    }
