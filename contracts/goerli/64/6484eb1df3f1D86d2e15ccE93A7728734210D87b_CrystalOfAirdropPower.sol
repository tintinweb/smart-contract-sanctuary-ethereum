...
contract CrystalOfAirdropPower is ERC721, ICrystalOfPower {
    ...
    ) ERC721("Crystal of Airdrop Power", "Crystal of Airdrop Power") {
    ...
    modifier checkMint() {
        ...
        if (gold_list_addresses[msg.sender]) {
            require(msg.value >= 2 * 4 * 10**17, "Not enough funds used");
        } else if (white_list_addresses[msg.sender]) {
            require(msg.value >= 2 * 45 * 10**16, "Not enough funds used");
        } else {
            require(msg.value >= 2 * 55 * 10**16, "Not enough funds used");
        }
