...
contract release_v2 is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Releasev2", "RV2") Ownable() {}
    ...
    /// @dev Svg returned by punks data contract needs values replaced to faclitate multiple layer svg rendering
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        p[0] = '<svg transform="scale(-1,1) translate(-0,0)" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.2" viewBox="0 0 600 600"><defs><pattern id="bleach" x="0" y="0" width="0.125" height="0.125"><image x="0" y="0" width="75" height="75" xlink:href="';
        ...
        p[4] = '" /><rect viewBox="0 0 600 600" width="600" height="600" fill="url(#bleach)" />';
