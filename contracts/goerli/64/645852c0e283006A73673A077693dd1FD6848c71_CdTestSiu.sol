...
contract CdTestSiu is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    uint256 public constant maxCures = 6;
    uint256 public constant curePrice = 0.001 ether;
    ...
    constructor(address payable royaltyReceiver)
        ERC721A("cdtestfinal2", "cdt2+")
    {
        _setDefaultRoyalty(royaltyReceiver, 1000);
    }

    function callDocForCure(address to, uint256 quantity) external payable nonReentrant{
        ...
        require(
            ...
            "more than 5 [cures] not recommended"
        );
