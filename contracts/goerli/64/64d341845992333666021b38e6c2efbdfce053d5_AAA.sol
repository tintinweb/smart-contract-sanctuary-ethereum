...
contract AAA is Base {
    ...
    constructor()
        Base(
            ...
            // usdt地址
            0xBCDBf978478C09B51C7Fc0E279779DdDf3e040b3,
            // 中转合约地址
            0x041e7Fa5638A0fA02E88C8DA48817d085F5F42D3
        )
    {
        // 设置开始交易
        swap = true;
        ...
        _sellSlippage = 3;
        // 设置买入手续费钱包
        _buyWallet = 0x85185457eB967749062D37e5b6fd42A9a827e6F8;
        // 设置卖出手续费钱包
        _sellWallet = 0x85185457eB967749062D37e5b6fd42A9a827e6F8;
        // 设置免费账号
        ...
        // 保存子币对象
        childToken = IERC20Metadata(0x0080bd76244514cCF36Aa49294eeC24717b4f283);
        // 设置自动
        setAuto(true);
        // 设置持币挖矿每次分红数量
        setHoldCount(15);
