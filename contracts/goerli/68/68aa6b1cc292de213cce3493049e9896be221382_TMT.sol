...
contract TMT is Context, IERC20, Ownable {
    ...
    string private    _name = "TMT Token";
    ...
    address public _EcoWalletAddress = 0xD6cea206aE2896FaCF553F1a9c904a9215D38950;
    ...
    function setMinLiquidityPercent(uint256 minLiquidityPercent) external onlyOwner {
        numTokensSellToAddToLiquidity = minLiquidityPercent;
    }
