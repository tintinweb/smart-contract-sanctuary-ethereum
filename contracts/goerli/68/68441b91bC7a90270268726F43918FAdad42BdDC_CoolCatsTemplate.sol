...
// File: contracts/CoolCatsTemplate.sol
 ...
 *
 * Curated by marcelchristianis.com
...
contract CoolCatsTemplate is ERC721Enumerable, Ownable {
    ...
    uint256 private _reserved = 1; // What is reserve?
    ...
    bool public _paused = false; // False by default for testing purposes

    // TODO: Withdraw addresses, it's my wallet address lol. Change this to your and add/remove address as needed.
    // address t1 = 0x46Ea9d10d7b96E90c3F0BF3310696575E8627693;
    // address t2 = 0x46Ea9d10d7b96E90c3F0BF3310696575E8627693;
    // address t3 = 0x46Ea9d10d7b96E90c3F0BF3310696575E8627693;
    // address t4 = 0x46Ea9d10d7b96E90c3F0BF3310696575E8627693;
    ...
    constructor(string memory baseURI) ERC721("K00lKatz", "K00L")  {
        setBaseURI(baseURI);
    ...
    function adopt(uint256 num) public payable {
        ...
        require( num < 4,                              "You can adopt a maximum of 20 NFT" );
        require( supply + num < 10 - _reserved,      "Exceeds maximum NFT supply" );
