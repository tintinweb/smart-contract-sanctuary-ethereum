...
contract GuardiansOfEthStaking is Ownable, ReentrancyGuard, PriceCalculator {
    ...
    // Safe stakingToken transfer function, just in case if rounding error causes pool to not have enough BCHIEFs.
