...
interface IBnebeqURI {
  function tokenURI(IBnebeqPRGToken tokenContract, uint256 tokenId, bool patchedVersion) external view returns (string memory);
}

interface IBnebeqPRGToken {
...
contract BNEBEQ is ERC721, ERC721Enumerable, Ownable, IBnebeqPRGToken {
  using Strings for uint256;

  string constant tokenName   = "beqbeq";
  string constant tokenSymbol = "beqbeq";

  string private description = "On chain PRG";
  ...
  uint256 constant DAY_SECONDS = 1; //24 * 60 * 60;  // CHANGE THIS! !!!!!

  string private imageBaseURI     = "https://nopsta.com/bnebeq/i/";
  string private animationBaseURI = "https://nopsta.com/bnebeq/v/";
  string private externalBaseURI  = "https://nopsta.com/bnebeq/";

  // the base prg data, this is modified to produce the prg for each token
  // length 2048
  // the base prg data, this is modified to produce the prg for each token
  bytes constant basePRGData = hex"";
  ...
  // if less than 1024 then this will also be the value of the next tokenId
  uint256 _tokenIdCounter;

  IBnebeqURI public tokenURIContract;
    ...
    returns (uint256)
  {
    ...
    /// CHANGE THIS !!!!!!!
    require (balanceOf(msg.sender) < 256, "Limit 16");
    ...
    returns (string memory) 
  {
    ...
    if (address(tokenURIContract) != address(0)) {
      return tokenURIContract.tokenURI(IBnebeqPRGToken(this), tokenId, tokenData[tokenId].patchIsDefault);
    }    

    string memory tokenIdString = Strings.toString(tokenId);

    string memory json = base64Encode(bytes(string(abi.encodePacked(
      '{"name":"bnebeq ', tokenIdString,
      '","description":"', description, '",',
      getTokenURIs(tokenIdString),
      ',"attributes":', getTokenAttributes(tokenId),
      ',"prg":"data:application/x-c64-program;base64,', getTokenPRGBase64(tokenId, tokenData[tokenId].patchIsDefault), 
      '"}'
    ))));
...
//      abi.encodePacked('[{"trait_type":"FG","value":"', 
  ...
  // Return the maximum mode unlocked
  ...
  // Is the patch unlocked for the token
  ...
  // Return the PRG for the token as base64 encoded data
  ...
  // Return the PRG for the token as bytes
  ...
  // Set the default version for the token
  function setDefaultVersion(uint256 tokenId, bool patched)
    external 
  {
    checkIsTokenOwner(msg.sender, tokenId);
    require (tokenData[tokenId].patchUnlocked, "Patch Locked");

    tokenData[tokenId].patchIsDefault = patched;
  }
  ...
  function setTokenURIContract(IBnebeqURI uriContract)
    external
    onlyOwner
  {
