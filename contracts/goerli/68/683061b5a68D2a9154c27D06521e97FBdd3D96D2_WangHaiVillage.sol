...
contract WangHaiVillage is Ownable, ERC721A, ReentrancyGuard {
        ...
        callerIsUser
    {
        ...
        require(block.timestamp >= saleConfig.whitelsitSaleStartTime, "whitelist sale has not begun yet");
        require(saleConfig.whitelsitSaleStartTime + saleConfig.whitelistSaleDuration >= block.timestamp, "whitelist sale has ended");
        require(
    ...
    function publicSaleMint(uint256 quantity) external payable callerIsUser {
        ...
        require(block.timestamp >= saleConfig.publicSaleStartTime, "public sale has not begun yet");
        require(saleConfig.publicSaleStartTime + saleConfig.publicSaleDuration >= block.timestamp, "public sale has ended");
        require(
            totalSupply() + quantity <= collectionSize,
            "reached max supply"
        );
