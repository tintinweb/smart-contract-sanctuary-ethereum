...
contract ShyLock is ERC721A, Ownable {
    ...
    uint256 public allowlistMints = 5;
    ...
    function togglePublicSaleStarted() external onlyOwner {
     ...
     function setAllowListSupply(uint256 _newallowListSupply) external onlyOwner {
        allowlistMints = _newallowListSupply;
    }
