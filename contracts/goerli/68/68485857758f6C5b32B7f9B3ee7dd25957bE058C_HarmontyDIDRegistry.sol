...
contract HarmontyDIDRegistry is ERC2771Context, IDIDRegistry, Ownable, Pausable {
     ...
     */
    function getContext() external view override returns (string[] memory) {
        return _context;
    }
...
interface IDIDRegistry {
    ...
    function getContext() external view returns (string[] memory);
