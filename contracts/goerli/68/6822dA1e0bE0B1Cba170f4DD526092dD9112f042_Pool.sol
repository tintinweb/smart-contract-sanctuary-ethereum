...
contract Liquidity is PoolGetters {
    ...
    function addLiquidity(uint256 dollarAmount, uint256 poolID)
        internal
    ...
    function addUNILiquidity(uint256 dollarAmount, uint256 poolID)
        internal
        returns (uint256, uint256)
    {
...
contract PoolGetters is PoolState {
    ...
    function balanceOfPool(uint256 poolID) public view returns (uint256) {
        ...
        return
            _state[poolID].ratio.div(totalRatio).mul(
