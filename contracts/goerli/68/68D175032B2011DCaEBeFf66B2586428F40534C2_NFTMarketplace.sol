...
contract NFTMarketplace is ERC721URIStorage, ERC721Enumerable, ERC2981 {
    ...
    function setRoyaltyInfo(address _receiver, uint96 _royaltyFees) public {
        require(owner == msg.sender, "Only owner can update Royalty info");
