...
contract Source is IXReceiver, ERC20, Ownable {
    ...
    function depositInFarm(
        ...
        //underlyingToken.approve(address(connext), depositAmount);

        // Encode the data needed for the target contract call.
        bytes memory callData = abi.encode(depositAmount);
    ...
    function xReceive(
        ...
        _mint(current_user, eTokenAmount * 10**decimals());
    }
}