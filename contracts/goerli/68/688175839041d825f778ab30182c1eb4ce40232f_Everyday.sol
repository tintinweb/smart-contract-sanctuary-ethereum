...
contract Everyday is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable {
  ...
  uint256 private splitJacob;
  uint256 private splitHenry;
  uint256 private splitMatt;
  ...
  function initialize() public initializer {
    ...
    limitPerTnx = 365;
    highestTokenId = 1;
    baseURI = 'https://everyday.photo/tokenURI/';
  ...
  function withdraw() public onlyRole(MANAGER_ROLE) {
    ...
    uint256 totalJacob = MathUpgradeable.mulDiv(total, splitJacob, 10000);
    uint256 totalHenry = MathUpgradeable.mulDiv(total, splitHenry, 10000);
    uint256 totalMatt = MathUpgradeable.mulDiv(total, splitMatt, 10000);
