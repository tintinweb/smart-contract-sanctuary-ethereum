...
contract CARROT is ERC20PresetMinterRebaser, Ownable, ICARROT {
    ...
    uint256 private _totalSupply;
    uint256 public taxForMarketing = 50; //sniper protection, to be lowered to 2% after launch
    ...
    function transferFrom(address from, address to, uint256 value) public override validRecipient(to) returns (bool) {
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            uint256 marketingShareAddToETH = value.mul(taxForMarketing).div(100);
            transferAmount = value - marketingShareAddToETH;
            emit Transfer(from, marketingWallet, marketingShareAddToETH);
        }
