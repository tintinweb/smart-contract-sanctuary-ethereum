...
contract SxTCommunity is ISxTCommunity, SxTCommunityStorage, ERC1155, Ownable, ReentrancyGuard, Pausable {
    ...
    function mintNFT(uint256 id, address to) external override whenNotPaused nonReentrant{   
        ...
        require(whitelist[msg.sender], "SxTCommunity: This address is not in the whitelist. Go to the Space and Time discord and comment your wallet address in the whitelist channel before minting!");
    ...
    function addArrayToWhitelist(address[] calldata toAddAddresses) 
    external onlyOwner
    {
