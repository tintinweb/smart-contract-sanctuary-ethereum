...
import {GovernorSettingsUpgradeable} from "../libraries/openzeppelin/upgradeable/governance/extensions/GovernorSettingsUpgradeable.sol";
...
library TokenVaultLogic {
    ...
    function newBnftInstance(
        ...
        address bnft = ClonesUpgradeable.clone(
            ISettings(settings).bnftTpl()
        );
