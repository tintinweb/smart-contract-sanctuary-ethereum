    ...
    IFoxPay
{
    ...
    function startDate(uint256 tokenId_) external view returns (uint256) {
        (uint256 expireYear_, uint256 expireMonth_, ) = BokkyPooBahsDateTimeLibrary.timestampToDate(slotOf(tokenId_));
...
contract FoxPayMetadataDescriptor is IERC3525MetadataDescriptor {
    ...
    function _generateSVG() internal view virtual returns (string memory) {
        return
            string(
                abi.encodePacked(
                    /* solhint-disable */
                    '<svg width="1415" height="908" viewBox="0 0 1415 908" fill="none" xmlns="http://www.w3.org/2000/svg">',
                    '<text fill="#FF980E" xml:space="preserve" style="white-space: pre" font-family="Arial" font-size="128" letter-spacing="0em"><tspan x="411.75" y="471.875">&#xa5;1,000,000</tspan></text>'
                    "</svg>"
                    /* solhint-enable */
                )
            );
