...
contract ParaSwapAugustus is AugustusStorage, IRouter {
    using SafeMath for uint256;
    ...
    constructor() {
        tokenTransferProxy = new TokenTransferProxy();
    }
    ...
    function setTokenTransferProxy(ITokenTransferProxy tokenProxy) external {
