...
// TODO: Reveal Captainz after staked 28 days
contract CaptainzBox is ERC721x, DefaultOperatorFiltererUpgradeable {
    ...
    function initialize(string memory baseURI) public initializer {
        ...
        ERC721x.__ERC721x_init("Captainz Box", "CaptainzBox");
    ...
    function reveal(uint256 tokenId) external {
        ...
        require(tokensLastStakedAt[tokenId] > 0 && block.timestamp - tokensLastStakedAt[tokenId] >= 28 days);
