...
//    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, getTokenSeed(tokenId).toString(), ".json")) : "";
    }
...
//        return uint256(keccak256(abi.encode(collectionSeed, tokenId))) % MAX_NFT_SUPPLY;
    }
    ...
    function getTokenSeed(uint256 tokenId) public view returns (uint256)
    {
        ...
        for (uint256 i = 0; i < MAX_NFT_SUPPLY; i++) {
            uint256 n = i + collectionSeed % (MAX_NFT_SUPPLY - i);
...
//        uint256 pendingCount = getPendingCount();
//        uint256 index;
//        unchecked {
//            index = (_randomValue % pendingCount) + 1;
//        }
//        uint256 _tokenId = _popPendingAtIndex(index, pendingCount);
...
//        unchecked { return _pendingIds[_index] + _index; }
//    }
//
//    function _popPendingAtIndex(uint256 _index, uint256 pendingCount) internal returns (uint256) {
