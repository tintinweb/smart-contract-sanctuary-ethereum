...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x6c3F5b74a64bDfbdD117e29Dd1FD330d5b1B8c60];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://bafybeiayofphs3imvlh3i22lvdn3snowclr74xmc36zdnypqziacdalhg4.ipfs.dweb.link/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5iOmAM3CcTK4E8zWoYec/contract-metadata";
  }
...
// File: contracts/AsdadsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AsdadsContract is RamppERC721A {
    constructor() RamppERC721A("asdads", "asd"){}
}
