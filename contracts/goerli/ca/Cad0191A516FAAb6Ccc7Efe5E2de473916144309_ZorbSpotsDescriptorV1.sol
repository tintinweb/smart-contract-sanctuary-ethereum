...
contract ZorbSpotsDescriptorV1 is Initializable, OwnableUpgradeable {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '<path fill="#fff" d="M1448.78 448H551V1552.3H1448.78V448Z"/>',
                    zorbPathsChunk0,
                    zorbPathsChunk1,
                    "</svg>"
                )
    ...
    function buildZorbs(uint256 tokenId) internal view returns (string memory) {
        ...
        for (uint i; i < zorbs; ++i) {
            address ownerAddress = getOwnerOf(tokenId + i);
            ...
            list = abi.encodePacked(
                ...
                string(
                    abi.encodePacked(
                        ...
                        zorbPositions[i],
                        ') scale(56.9951)" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="1" id="zorb-',
                        i.toString(),
                        '">',
