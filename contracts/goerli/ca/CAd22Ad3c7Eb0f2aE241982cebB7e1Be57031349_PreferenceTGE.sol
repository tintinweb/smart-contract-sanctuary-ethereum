    ...
    ITGE
{
    ...
    function initialize(
        ...
        IPreferenceToken(token_).service().dispatcher().validateTGEInfo(info_, token_);

        token = IPreferenceToken(token_);
        info = info_;
