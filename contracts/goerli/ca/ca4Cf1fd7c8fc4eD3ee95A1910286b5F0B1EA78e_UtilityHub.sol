...
contract UtilityHub is Ownable {
    ...
    /**
     * This is required because the beforeTransfer hook that was reponsible for calling it has become 
     * dead code in the Hyperclone Transcendance campaign as the utilitySpecies have been temporarily 
     * disabled. This is used to prevent holders from claiming unearned tachyon and needs to be called once 
     * before the address recieves its first _mint as a result from minting or hyperwarping
     */
