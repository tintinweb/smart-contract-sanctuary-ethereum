...
interface IQuestFactory {
    ...
    event ReceiptMinted(address indexed recipient, string indexed questId, uint tokenId);
...
contract QuestFactory is Initializable, OwnableUpgradeable, AccessControlUpgradeable, IQuestFactory {
    ...
    function mintReceipt(string memory questId_, bytes32 hash_, bytes memory signature_) public {
        ...
        uint tokenId = rabbitholeReceiptContract.currentTokenId();
        emit ReceiptMinted(msg.sender, questId_, tokenId);
    }
}
