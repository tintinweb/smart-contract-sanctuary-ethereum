...
contract NCNFT is ERC721Royalty, Ownable {
   ...
   * @param _data is the new string data that is being written.
   */
  function setCustomData(
      ...
      onlyArtist
  {
      customDataOf[_tokenId].push(_data);
      emit TokenUpdated(_tokenId, _data);
  }
  ...
  /**
   * @notice MINT is a publicly callable mint function.
  ...
  function MINT(
    string memory _certificate
      ...
      onlyArtist
  {
      _minter(msg.sender, _certificate);
  }
