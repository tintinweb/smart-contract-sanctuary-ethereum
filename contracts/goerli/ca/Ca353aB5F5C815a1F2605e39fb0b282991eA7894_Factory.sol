    ...
    AutomationCompatibleInterface
{
    ...
    // function distributeRewardsAndRugLoser() public onlyOwner {
    ...
    function requestRandomWords()
        public
    // onlyOwner returns (uint256 requestId)
    {
        // requestId =
    ...
    function fulfillRandomWords(
        ...
        //     // , "request not found"
        // );
        uint256 finalValue = (_randomWords[0] % 30) + 31;
        for (uint8 i = 0; i < numWords; i++) {
            _rugDays.push(finalValue);
        }
        console.log("finalValue", _requestId, finalValue);
        // s_requests[_requestId].fulfilled = true;
        // s_requests[_requestId].randomWords = finalValue;
    }
