...
contract MagicAxe is ERC721Enumerable, ERC721Burnable, Ownable, Pausable {
    ...
    Counters.Counter private _tokenIds = Counters.Counter(501);

    // Optional mapping for token URIs
    mapping(uint256 => string) private tokenURIs;

    // Base URI
    string private baseURI = "https://meta.evergem.xyz/magic-axe/";
    string private baseExt = ".json";

    constructor() ERC721("Magic Axe by Evergem", "MAGICAXE") {}
