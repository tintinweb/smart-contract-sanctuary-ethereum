...
contract Proxy {
    ...
    constructor(address _logic_contract, address _userImplementation) {
       ...
       (bool success, ) = _logic_contract.delegatecall(abi.encodeWithSignature("initialize(address,address)", msg.sender, _userImplementation));
       require(success, "Error: Initialize failed");
    }
