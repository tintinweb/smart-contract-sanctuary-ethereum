    ...
    DefaultOperatorFilterer
{
    ...
    mapping(uint256 => uint256) private _burnAmountToUriIndex;
    ...
    {
        _baseUri = baseURI_;
        _burnAmountToUriIndex[2] = 1;
        _burnAmountToUriIndex[4] = 2;
        _burnAmountToUriIndex[8] = 3;
        _burnAmountToUriIndex[16] = 4;
    }
    ...
    function _tokensOfOwner(address owner) public view virtual returns (uint256[] memory) {
        unchecked {
            uint256 tokenIdsIdx;
    ...
    function burn(uint256 burnAmount) public virtual override { 
        ...
        uint256[] memory ownedTokens = _tokensOfOwner(_msgSender());
        ...
        // Determine the URI index based on the number of NFTs burned
        uint256 uriIndex = _burnAmountToUriIndex[burnAmount];

        // Mint a new NFT with the appropriate URI
        string memory uri = string(abi.encodePacked(_baseURI(), "/", uriIndex));
