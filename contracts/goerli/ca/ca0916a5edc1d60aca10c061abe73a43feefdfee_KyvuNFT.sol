...
contract KyvuNFT is ERC721URIStorage, EIP712 {
    ...
    event offerCreated(uint256, offers);
    // struct offersTracker {
    //     uint noOfElements;
    //     uint cutOff;
    //     mapping(uint256 => offers) listOfOffers;
    // }
    // mapping(address => mapping(string => offersTracker)) public availableOffers;

    //to avoid stack overflow error, we will let backend handle the amount of offers and sort them with their expiration etc..
    ...
    function makeOffer(
        ...
        //changeX
        // require(IERC20(weth).allowance(msg.sender, address(this))>userWETHUtilization[msg.sender], "You are trying to spend more than you've approved");
    ...
    //approving WETH should be going on in a different transaction.
    ...
    function acceptOffer(
        ...
        console.log("Completed time check");
        address receiverOfNFT = offerIDToOffers[_offerID].offerer;
        console.log("address of receiver set.");
