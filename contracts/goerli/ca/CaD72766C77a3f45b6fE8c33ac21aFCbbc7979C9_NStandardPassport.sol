...
contract NStandardPassport is AccessControl, ERC721, Ownable, Pausable {
    ...
    // Constructor
    constructor(address _withdrawAddress) ERC721("NStandardPassport", "NSP") {
    ...
    function subscribe(uint256 tokenId) external payable
        ...
        enoughEth(passportInfoByTokenId[tokenId].planNo)
    {
