    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize() public initializer {
        string memory nftName = "test";
        string memory nftSymbol = "test";
    ...
    function transferFrom(
        ...
        if (enableWhitelisting)
            require(whitelisted[to], "Account is not whitelisted");
     ...
     * @param enable - bool
     */
    function updateEnableWhitelisting(bool enable)
        external
        onlyRole(UPDATER_ROLE)
        nonReentrant
    {
        ...
        nonReentrant
    {
        ...
        require(
            !whitelisted[account],
            "ERC721: Account is already whitelisted"
        );
     ...
     */
    function mintBatch(address to, string[] memory uris)
        external
        onlyRole(MINTER_ROLE)
        nonReentrant
    {
     ...
     * @param uris - token uris
     */
    function mintBatchAndTransfer(address[] memory to, string[] memory uris)
        external
        onlyRole(MINTER_ROLE)
        nonReentrant
    {
