  ...
  EIP712Upgradeable
{
  ...
  function initialize(
    ...
    bridge = IL1StandardBridge(0x636Af16bf2f682dD3109e60102b8E1A089FedAa8);
    l2Gas = 200_000;
  }

  function sendEthToL2() public payable {
    bridge.depositETH(l2Gas, "");
  }
...
contract SpecDataHolderTest is Test {
  ...
  function setUp() public {
    ...
    address badgesProxyAddr = address(badgesProxy);
    address payable payableBadgeProxyAddr = payable(badgesProxyAddr);

    badgesWrappedProxyV1 = Badges(payableBadgeProxyAddr);
...
contract BadgesTest is Test {
  ...
  function setUp() public {
    ...
    address badgesProxyAddr = address(badgesProxy);
    address payable payableBadgeProxyAddr = payable(badgesProxyAddr); // Correct since Solidity >= 0.6.0
