...
import {ExtendUpgradeabilityProxy} from './ExtendUpgradeabilityProxy.sol';
...
contract ZeroTokenFactory {
  ...
  function createZeroToken(string calldata name, string calldata symbol)
    external
    returns (ProxyAdmin, ExtendUpgradeabilityProxy)
  {
    (
      ProxyAdmin proxyAdmin,
      ExtendUpgradeabilityProxy zeroTokenProxy,
  ...
  function createZeroTokenWithMint(
    ...
    address to,
    uint256 amount
  ) external returns (ProxyAdmin, ExtendUpgradeabilityProxy) {
    (
      ProxyAdmin proxyAdmin,
      ExtendUpgradeabilityProxy zeroTokenProxy,
      ZeroToken zeroTokenImpl
    ...
    )
  {
    ...
    zeroTokenProxy = ExtendUpgradeabilityProxy(
      _createProxy(
        address(zeroTokenImpl),
        address(proxyAdmin),
...
contract ExtendUpgradeabilityProxy is TransparentUpgradeableProxy {
  constructor(
    address logic,
    address admin,
    bytes memory data
