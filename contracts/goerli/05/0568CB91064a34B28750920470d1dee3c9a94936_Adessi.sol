...
contract Adessi is ERC721, Ownable, ERC721Enumerable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant tokenPrice = 1500000000000000; // 0.0015 ETH
    uint256 public constant maxTokenPurchase = 2;
    uint256 public constant MAX_TOKENS = 50;

    string public baseURI =
        "ipfs://QmYqjE1Q5RKhP7Mw7YGoYMVyRcd44ngseA8cdStSa55bqg"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT

    bool public saleIsActive = false;
    bool public presaleIsActive = false;
    /* if you want to use the reveal feature
    ...
    event AdessiMinted(uint256 tokenId, address owner);

    constructor() ERC721("AdessiNew", "OKR") {}
    ...
    */
    ...
    function mintAdessi(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_TOKENS) {
                ...
                emit AdessiMinted(id, msg.sender);
            }
        }
    }

    function presaleAdessi(uint256 numberOfTokens) external payable {
