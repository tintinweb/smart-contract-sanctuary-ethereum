...
contract Anikana is ValidatorSmartContractInterface, Ownable {
    ...
    */
    ...
    uint256 private feeToBecomeValidator = 123 ether;
    ...
    uint256 private blockSpace = 5126300;
    //
    ...
    // Create request to become validator
    ...
    // Cancel Request to become validaor
    ...
    // elect new queen instead, delete old queen
    ...
    // appoint new knight, only Queen can call this function
    ...
    // Update the current Queen in the ongoing vote
    ...
    // Check number vote dismiss Queen
    ...
    // check Knight vote Dismiss Queen
    ...
    // Approve And Reject Request Validator
    ...
    // Returns the addresses that voted dismissQueen
    ...
    // Returns list address Queen dismiss voting
    ...
    // Returns the address that voted Queen
    ...
    // Returns the addresses that voted Queen
    ...
    // Returns the address of the current Knight in the array knightList
    ...
    // Set fee to become validator candidate
    ...
    // Check status request of validator candidate when request to knight
    ...
    // Returns the index of validator candidate in the array
    ...
    // Count the number of Knight in the array
    ...
    // Count the number of Validator Candidate in the array
    ...
    // Check 1 address has any position
    ...
    // Check if an address is a normal node
    ...
    function addStatusRequestList(
        ...
        statusRequestList[_ownerRequest].push(
            ActionRequest(_statusRequest, block.number)
        );
    }

    // Return the fee payable to become validator
    function getFeeBeComeToValidatorCandidate() public view returns (uint256) {
        return feeToBecomeValidator;
    }

    // Returns the address, time start term and time end term of Queen
    ...
    // Returns the address, its index is in the array knightList,
    // block.number it is set as Knight
    ...
    function getApproveRequestListOfKnight(uint256 _idKnight)
        ...
        view
        returns (
            address[] memory, // address normal node
            uint256[] memory, // timeRequestDay
            uint256[] memory, // timeApprove
            uint256[] memory // KnightNo
        )
    {
    ...
    // Return the index of the current queen in the array queen list
    ...
    // Return index of the knight in knightList
    ...
    // Return index of the requested validator candidate
    ...
    // Check status request of validator candidate
    ...
    // Check if an address is a knight or not
    ...
    // Update reward received after distribute reward
    ...
    // Return all address validator
    function getValidators() external view override returns (address[] memory) {
        address[] memory validators = new address[](
            countNumberValidatorCandiadate()
        );
        for (uint256 i = 0; i < validatorCandidateList.length; i++) {
