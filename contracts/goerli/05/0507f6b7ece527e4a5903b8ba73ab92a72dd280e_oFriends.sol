...
contract oFriends is ERC721Enumerable, ReentrancyGuard, ERC2981, Ownable {
    ...
    address public dogTrainer = 0x2D958BaC901aF14477470E707C3E5BF19e9Cde8E;
    ...
    function openHouse(uint256 houseId) public nonReentrant() returns (uint256) {
        ...
        _burn(houseId);
        uint256 oFriendTokenId = 10000;
        unchecked {
            oFriendTokenId += houseId;
        }
    ...
    function spillOtreats(address[] calldata receivers, uint256[] calldata amounts) external {
