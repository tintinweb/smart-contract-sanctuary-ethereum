...
contract WorldOfLedgerFactory is Ownable, VRFConsumerBaseV2 {
        ...
        override
    {
        ...
        uint256 hp = (s_requestIdToRandomWords[requestId][0] % 100) + 1;
        uint256 damage = (s_requestIdToRandomWords[requestId][1] % 100) + 1;

        usersCharacters[msg.sender] = Character(hp, damage, 0, 0, true, 0);
    }
}
