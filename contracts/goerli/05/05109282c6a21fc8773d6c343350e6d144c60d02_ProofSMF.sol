...
contract ProofSMF is ERC20, Ownable, ERC20Burnable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xa1D3737935686e719eECaA6d817BD319573aF1DB);
    ...
    uint256 public percentForLPBurn = 250; // 25 = .25% 250 = 2.5%
    ...
    constructor() ERC20("Proof of Safemoon", "SFM2.0") {
        ...
        swapTokensAtAmount = totalSupply * 5 / 1000; // 0.5% swap tokens amount
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 330, "Must keep fees at 33% or less");
    }
