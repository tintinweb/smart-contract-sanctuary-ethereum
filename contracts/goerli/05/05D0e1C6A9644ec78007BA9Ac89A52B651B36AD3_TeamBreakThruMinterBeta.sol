...
contract TeamBreakThruMinterBeta is ERC1155Burnable, Ownable, DefaultOperatorFilterer {
    string public name = "TeamBreakThruMinterBeta";
    string public symbol = "TBTMBETA";
    string CouponAddressCode = "";
    string public contractUri = "https://dev.teambreakthru.net/collections/TeamBreakThruMinterBeta/contract";
    ...
    bool MintPublic = false;
    bool TokenTypeSingle = true;
    uint256 public Token = 1;
    uint256 MaxTokenAmount = 0;
    struct MintTypes {
    ...
    constructor() ERC1155("https://dev.teambreakthru.net/collections/TeamBreakThruMinterBeta/token_{id}") {
        idTracker.increment();
    }
    ...
    function setToken(uint256 _token) public onlyOwner
    {
        Token = _token;
    }
