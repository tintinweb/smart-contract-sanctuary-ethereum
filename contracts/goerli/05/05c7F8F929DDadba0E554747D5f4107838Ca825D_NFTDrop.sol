...
interface INFTSalesPhase {
     ...
     *
     *  @param bSupportCategory               The flag that represents whether category is specified or not.
     *
     *  @param tokenIds                       The suitable NFT token ids of specific category.
