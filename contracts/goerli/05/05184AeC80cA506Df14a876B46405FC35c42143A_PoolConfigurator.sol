...
library ConfiguratorLogic {
    ...
    public
  {
    ...
    DataTypes.ReserveConfigMap memory currentConfig = DataTypes.ReserveConfigMap(0);
    ...
    pool.setConfig(input.underlyingAsset, currentConfig);
  ...
  function executeUpdateMToken(
    ...
    (, , , uint256 decimals, , ) = cachedPool.getConfig(input.asset).getParams();
...
import {ConfiguratorInputTypes} from '../protocol/libs/types/ConfiguratorInputTypes.sol';
...
interface IPoolConfigurator {
   ...
   * @param input The mToken update parameters
   **/
  function updateMToken(ConfiguratorInputTypes.UpdateMTokenInput calldata input) external;
   ...
   * swap interest rate, liquidate, mtoken transfers).
   * @param asset The address of the underlying asset of the reserve
   ...
   * - A part is sent to mToken holders as extra balance
 ...
 * @author Monetaria, inspired by the OpenZeppelin upgradeability proxy pattern
