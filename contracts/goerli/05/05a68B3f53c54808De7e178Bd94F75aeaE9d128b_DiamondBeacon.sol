...
import "./IDiamondBeacon.sol";

/// @title DiamondBeacon
/// @notice implementation Diamond Proxy + Beacon
contract DiamondBeacon is
    ...
    ERC165Base
{
    // @dev Copy of constructor of `@solidstate/contracts/proxy/diamond/SolidStateDiamond.sol`
    constructor() {
    ...
    function _getImplementation()
        internal
        view
        override(DiamondFallback)
        returns (address implementation)
    {
        implementation = super._getImplementation();
    }

    /// @notice gets the address of the current logic implementation contract
    function implementation(bytes4 functionSignature)
        public
        view
        returns (address)
    {
        ...
        return address(bytes20(l.facets[functionSignature]));
    }
}
...
/**
 * @dev This is the interface that {DiamondBeaconProxy} expects of its beacon.
 */
interface IDiamondBeacon {
     ...
     */
    function implementation(bytes4 _functionSignature)
        external
        view
        returns (address);
}
