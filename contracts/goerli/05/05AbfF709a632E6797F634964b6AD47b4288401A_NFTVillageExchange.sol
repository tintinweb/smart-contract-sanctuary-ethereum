...
// NFTVillage interfaces
import {ICurrencyManager} from "./interfaces/ICurrencyManager.sol";
import {IExecutionManager} from "./interfaces/IExecutionManager.sol";
import {IExecutionStrategy} from "./interfaces/IExecutionStrategy.sol";
import {INFTVillageExchange} from "./interfaces/INFTVillageExchange.sol";
import {ITransferManagerNFT} from "./interfaces/ITransferManagerNFT.sol";
import {ITransferSelectorNFT} from "./interfaces/ITransferSelectorNFT.sol";
import {IWETH} from "./interfaces/IWETH.sol";

// NFTVillage libraries
import {OrderTypes} from "./libraries/OrderTypes.sol";
import {SignatureChecker} from "./libraries/SignatureChecker.sol";

/**
 * @title NFTVillageExchange
 * @notice It is the core contract of the NFTVillage exchange.
 */
contract NFTVillageExchange is INFTVillageExchange, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x40c3d8391f10cda7389a339fabcfd8f1ea5dc5c19ba07422d34cae2b5f25bddf, // keccak256("NFTVillageExchange")
    ...
    function matchAskWithTakerBidUsingETHAndWETH(
        ...
        // Execution part 1/2
        _transferFeesAndFundsWithWETH(makerAsk.strategy, makerAsk.signer, takerBid.price, makerAsk.minPercentageToAsk);
