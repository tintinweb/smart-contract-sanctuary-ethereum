...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /**
     * @dev This is the function that chainlink keeper nodes call they look for the upkeepnode to return true/
     * The following should be true in orfer to return true:
    ...
    function checkUpkeep(
        ...
        view
        override
        returns (bool upkeepNeeded, bytes memory /*performDta */)
    {
