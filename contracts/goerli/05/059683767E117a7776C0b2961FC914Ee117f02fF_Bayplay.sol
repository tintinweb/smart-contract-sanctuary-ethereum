...
contract Bayplay is ERC721A, Ownable, RoyaltiesV2, DefaultOperatorFilterer {
    ...
    function setSalesTime(uint256 pre1StartAt, uint256 pre1EndAt, uint256 pre2StartAt, uint256 pre2EndAt, uint256 publicStartAt) external onlyOwner {
