...
using Counters for Counters.Counter;
  ...
  constructor() ERC721A("Deemo Test", "DMT")  {
    _setOwner(msg.sender);
    _allowAddress[msg.sender] = true;
    status = 1;
    supplyPerRarity[1] = 600;
    supplyPerRarity[2] = 300;
    supplyPerRarity[3] = 100;
    MaxSupply = 1000;
    whiteListRoot[0] = 0x074dcef9a9aa0b10062f3454e14892b9312e7001078b761fe5824d3f1a32f5ac;
    mainPrice = 10000000000000000;
    seed = 2347993460045;
    author = msg.sender;
    ...
    require(price <= depositAmount, "NFT 108");
       ...
       for (uint256 index = from; index <= to; index++) {
        ...
        if(supplyPerRarity[1] <= mintedPerRarity[1] + 1){
          ...
          rand = (uint256(keccak256(abi.encode(seed, limit, block.timestamp))) % 2) + 1;
        }
