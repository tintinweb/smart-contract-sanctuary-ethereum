...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface{
    ...
    constructor(address vrfCoordinatorV2, bytes32 keyHash,  uint32 gasLimit, uint256 entranceFee, uint256 interval) VRFConsumerBaseV2(vrfCoordinatorV2)  public {
    ...
    function createNewSubscription() private  {
        s_subscriptionId = s_vrfCoordinatorV2.createSubscription();
        // Add this contract as a consumer of its own subscription.
        s_vrfCoordinatorV2.addConsumer(s_subscriptionId, address(this));
    }
