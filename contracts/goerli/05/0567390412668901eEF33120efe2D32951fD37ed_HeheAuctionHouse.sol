...
contract HeheAuctionHouse is ERC721, Pausable, Ownable {
    ...
    function unpause(uint256 _auctionId) external whenPaused {
        require(
    ...
    function startNewAuction(uint256 _duration) internal {
        ...
        _mint(address(this), tokenCounter);
    ...
    function settleAuction(uint256 _tokenId) internal {
        ...
        if (_auctions[_tokenId].bidder == address(0)) {
            ...
            transferFrom(address(this), _auctions[_tokenId].bidder, _tokenId);
        }
