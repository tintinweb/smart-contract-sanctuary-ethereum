...
//@title: Babelong Azuki
// 
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
// @@@BYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY[email protected]@@
// @@&!:^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^:!&@@
// @@&~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^~~!!!~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^~!7?Y5GBB##&&&&&&#BP5J7!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
...
// @@&~^^^^^^^^^^^^^^^^^^^^^!?5B&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@J^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^^^^^^^^~75B&@@@@@@@@@@@@@@@@@@@&BPPGB&@@@@@@@@@#~.     .:^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^^^^^~JG&@@@@@@@@@@@@@@@@@@@@@#J:     .^[email protected]@@@@@G.        .~^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^^^!P&@@@@@@@@@@@@@@@@@@@@@@@Y.           [email protected]@@@@&5??JYJ!^^^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^[email protected]@@@@@@@@@#[email protected]@@@@@@@@@@@Y      ^77~.  [email protected]@@@@@@@@@@@@7^^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^?&@@@@@@@@@J:[email protected]@@@@@@@@@@^   ^[email protected]@@@BJJ#@@@@@@@@@@#Y!^^^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^:^J&@@@@@@@5   :[email protected]@@@@@@@@#[email protected]@@@@@@@@@@@@@@@@@@@@?.  .^^^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^. .7&@@@@@@&~   ^[email protected]@@@@@@@&G&@@@@@@@@G!!!7?Y&@@@@@@@@#GPY?!^^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^~.  .7&@@@@@@P.   [email protected]@@@@@@@@@@@@@@@@@@#7:  .7&@@@@@@@@@@@@@&?^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^:   .7&@@@@@&~   :[email protected]@@@@@@@@@@@@@@@@@@@&##&@@@@@@@@@@&BBP5?~^^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^:     ~P&@&BJ:    !&@@@@@@@@@@@@@@@@@@@@@@@@@@@@&GY7~:     ..^^^^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^:       ^~^.      :[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@&Y!:   :!?J?!:  .:^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^:                 [email protected]@@@@@@@@@@@@@@@@@@@@@@@@#!.   ?B&@@@@@&P^  ^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^:                  ^[email protected]@@@@@@@@@@@@@@@@@@@@@@@?.   [email protected]@@@@@@@@@&~ ^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^~.                  :[email protected]@@@@@@@@@@@@@@@@@@@@@@&!.  ^@@@[email protected]@@Y ^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^^.                  [email protected]@@@@@@@@@@@@@@@@@@@@@@@7:  [email protected]@@#?:  [email protected]@@J ^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^:                    ~&@@@@@@@@@@@@@@@@@@@@@@@5^  ^&@@@@&B#@@@#: ^^^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^~.                    ^[email protected]@@@@@@@@@@@@@@@@@@@@@@&!:  [email protected]@@@@@@@@@&!  :^^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^^                     :[email protected]@@@@@@@@@@@@@@@@@@@@@@@5^.  7P#&@@@@@@@P   .^^^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^^.                     :[email protected]@@@@@@@@@@@@@@@@@#P5555?^:    .:!?5G#&&!     :^^^^^^^^^^^^^~&@@
// @@&~^^^^^^^.                      :[email protected]@@@@@@@@@@@@@@@#7..                 .:.       ^^^^^^^^^^^^^~&@@
// @@&~^^^^^^.                       ^[email protected]@@@@@@@@@@@@@@@J                              .^^^^^^^^^^^^~&@@
// @@&~^^^^^:                        ~&@@@@@@@@@@@@@@@@?                               :^^^^^^^^^^^~&@@
// @@&~^^^^^:                      [email protected]@@@@@@@@@@@@@@@@G?!~^:..                         ^^^^^^^^^^^~&@@
...
contract BabelongAzuki is ERC721A, DefaultOperatorFilterer, Ownable {
    uint256 private constant MAX_SUPPLY = 3000;

    uint256 private MAX_WLA_MINTS_PER_ADDRESS = 15;
    uint256 private MAX_WLB_MINTS_PER_ADDRESS = 10;
    uint256 private MAX_PUB_MINTS_PER_ADDRESS = 5;
    
    uint256 public whitelistAMintPrice = 0.00001 ether;
    uint256 public whitelistBMintPrice = 0.00002 ether;
    ...
    string public baseURI = "ipfs://QmXsxVYJUArQWBK342oTzyY89nuPWeK74gozafvFbjxYBi/";
    string public notRevealedUri = "ipfs://QmXsxVYJUArQWBK342oTzyY89nuPWeK74gozafvFbjxYBi/unrevealed.json";

    constructor(address _fiatMinter) ERC721A("Babelong NFTs", "BABELONG") {
        setFiatMinter(_fiatMinter);
    }
...
// MISC
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if(revealed){
            ...
            return string(abi.encodePacked(baseURI, Strings.toString(tokenId % 20), ".json"));
        } else {
