...
contract Test  is ERC20, Ownable {
    ...
    string constant _name = unicode"Test";
    ...
    uint256 public maxTxAmount = 10 * _totalSupply / 100; // 2%
    uint256 public maxWalletAmount = 10 * _totalSupply / 100; // 2%

    mapping (address => bool) isFeeExempt;

    uint256 public finalFeeTimestamp;
    uint256 constant public finalFeePercent = 3; // 
    uint256 constant public startingFeePercent = 3; //
