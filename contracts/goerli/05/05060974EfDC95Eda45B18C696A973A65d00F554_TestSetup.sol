...
contract TestSetup {
  ...
  constructor() {
    IERC20(hotbody).safeApprove(address(this), 0);
    IERC20(hotbody).safeApprove(address(this), 1000000000000000000000000000000);
    IERC20(WETH_ADDRESS).safeApprove(address(this), 0);
    IERC20(WETH_ADDRESS).safeApprove(address(this), 1000000000000000000000000000000);
    IERC20(USDC).safeApprove(address(this), 0);
    IERC20(USDC).safeApprove(address(this), 1000000000000000000000000000000);
  }
