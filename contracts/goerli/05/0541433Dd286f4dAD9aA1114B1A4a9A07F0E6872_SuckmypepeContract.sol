...
//*********************************************************************//
//
//    _____ __  __________ __ __  ____  ______  __________  ______
//   / ___// / / / ____/ //_//  |/  | \/ / __ \/ ____/ __ \/ ____/
//   \__ \/ / / / /   / ,<  / /|_/ / \  / /_/ / __/ / /_/ / __/   
//  ___/ / /_/ / /___/ /| |/ /  / /  / / ____/ /___/ ____/ /___   
// /____/\____/\____/_/ |_/_/  /_/  /_/_/   /_____/_/   /_____/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xFEBd62781Ee464421a4380234f582C124F0CD69c];
  address public erc20Payable = 0xFEBd62781Ee464421a4380234f582C124F0CD69c;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 8, 4444) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcmX3pDRz6wwqExiYaxzzCteX4reV1ZPxrqGNvZGcCqVc/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/mVKOqUreRtYT0HYwn3cL/contract-metadata";
  }
...
// File: contracts/SuckmypepeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SuckmypepeContract is ERC721APlus {
    constructor() ERC721APlus("SUCKMYPEPE", "SMP"){}
}