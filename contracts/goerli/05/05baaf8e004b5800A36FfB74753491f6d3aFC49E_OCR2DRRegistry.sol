    ...
    AuthorizedReceiver
{
        ...
        returns (bytes32)
    {
        ...
        uint96 oracleFee = OCR2DROracleInterface(msg.sender).getRequiredFee(
            data,
            billing
        );
    ...
    function cancelSubscriptionHelper(uint64 subscriptionId, address to)
        private
        nonReentrant
    {
    ...
    function pendingRequestExists(uint64 subscriptionId)
        public
        view
        returns (bool)
    {
