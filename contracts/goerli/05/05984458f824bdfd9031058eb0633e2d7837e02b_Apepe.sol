...
contract Apepe is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Picassos Pepes", "PEPE") {
        owner = msg.sender;
        royalty = 69;
    }

    mapping(uint256 => uint256) free;
    function pepe(uint256 amount) payable public {
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeie7opggcnkohts47zwoywgpk6knj2ldtccfvnias6hg5ejx6jqska/", _toString(tokenId), ".png"));
    }
