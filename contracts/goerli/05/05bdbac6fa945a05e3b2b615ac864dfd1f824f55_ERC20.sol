...
contract TestSrgToken is ERC20, Ownable {
    ...
    /* ========== CONSTRUCTOR ========== */
    constructor() ERC20("IllumiShare SRG", "SRG") {
        supply = 0 ether;
        transferFee = 18;
    }
    ...
    /**
     * @notice Mints new SRG Tokens to designated address
     *
     * @param to - Address of minted tokens receiver
    ...
    {
        require(
            supply.add(amount) <= MAX_SUPPLY,
            "Cannot mint more Tokens than the maximum supply"
        );
        _mint(to, amount);
    ...
    /**
     * @notice Burns SRG Tokens of an address
     *
     * @param tokenHolder - Address of burned SRG tokens holder
    ...
    /**
     * @notice Sets deposit admin for Bridge
     *
     * @param _depositAdmin - The Admin address responsible for bridge Deposits
     */
    ...
    /**
     * @notice Deposits Token in contract for Bridge
     *
     * @param user - Address of token depositor
     * @param depositData - Depositing Data
     */
