...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x11579e5deF6e085102D9Cc3cd9AAef99e3a824A2];
  address public erc20Payable = 0x11579e5deF6e085102D9Cc3cd9AAef99e3a824A2;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintOwnershipCap = 3;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 100) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiextt6khpy4skfnejc56fidaszujedv3aewz5pe4xqsnuvdgqquca/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/6XvcUx3BB5hg6JOzmhzL/contract-metadata";
  }
...
// File: contracts/TestDec1StContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestDec1StContract is RamppERC721A {
    constructor() RamppERC721A("Test Dec 1st", "SNEK"){}
}