 ...
 */
contract ImmutableBundle is ERC721Enumerable, IERC721Receiver {
    // Incremental token id
    uint256 public tokenCount = 0;

    // Address of the bundler contract
    INftfiBundler public immutable bundler;
    ...
    constructor(
        ...
        bundler = INftfiBundler(_bundler);
    }
     ...
     */
    function mintBundle(address _to) external returns (uint256) {
    ...
    function withdraw(uint256 _immutableId, address _to) external {
        ...
        _burnImmutableBundle(_immutableId, bundleId);
     ...
     * @param _bundleId The associated bundle id
     */
    function _burnImmutableBundle(uint256 _immutableId, uint256 _bundleId) internal {
        _burn(_immutableId);
        delete immutableOfBundle[_bundleId];
