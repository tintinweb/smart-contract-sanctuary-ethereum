...
contract DaoEscrowFarm {
    ...
    receive() external payable {
        ...
        console.log("Deposited %s from address %s for new total of %s", 
            ...
            msg.sender,
            prev.balance);
        console.log("Block: %s", prev.blockDeposited);
    }
