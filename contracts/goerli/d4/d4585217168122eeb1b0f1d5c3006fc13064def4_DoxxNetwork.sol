...
contract DoxxNetwork is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xeA6D91d643fac81a2A7783c1B0d4cf361fb00434));

    string private _name = "XxX";
    string private _symbol = "DXr3";
