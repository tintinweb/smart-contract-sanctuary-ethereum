...
contract Madara is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x95cbf2267ddD3448a1a1Ed5dF9DA2761af02202e] = true;
    ...
    function addExcludeFromFee(address to) external onlyOwner {
        _isExcludedFromFee[to] = true;
    }

    function removeExcludeFromFee(address to) external onlyOwner {
    ...
    function addToBlacklist(address to) external onlyOwner {
        _isBlacklisted[to] = true;
    }

    function removeToBlacklist(address to) external onlyOwner {
