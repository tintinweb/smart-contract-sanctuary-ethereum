...
import "./lib/extensions/ERC721iRoyalty.sol";

contract OMRKT is ERC721iRoyalty {
    string internal _baseTokenURI;

    constructor(address preMinter, string memory baseTokenURI)
        ERC721i("OMRKT Token", "OMKRT", preMinter, 1)
    {
        _baseTokenURI = baseTokenURI;

        // set royalty to 2.5% - based on default fee denominator which is 10000
...
abstract contract ERC721iRoyalty is ERC2981, ERC721i {
    /**
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC2981, ERC721iEnumerable) returns (bool) {
        return
        interfaceId == type(ERC2981).interfaceId ||
        interfaceId == type(ERC721iEnumerable).interfaceId || 
