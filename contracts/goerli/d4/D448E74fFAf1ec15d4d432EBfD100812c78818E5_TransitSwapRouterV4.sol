...
contract TransitSwapRouterV4 is Ownable, ReentrancyGuard, Pausable {
    ...
    event TransitSource(string groupId, string telegramId);
    ...
    function swap(TransitStructs.TransitSwapDescription calldata desc, TransitStructs.CallbytesDescription calldata callbytesDesc, TransitStructs.TransitSwapSource calldata source) public payable nonReentrant whenNotPaused {
        ...
        emit TransitSource(source.groupId, source.telegramId);
    }
