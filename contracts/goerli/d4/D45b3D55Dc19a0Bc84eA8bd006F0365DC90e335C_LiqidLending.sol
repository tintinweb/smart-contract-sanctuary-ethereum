...
import "./LiqidLendingCore.sol";

/// @notice liqd lending and borrowing contract
contract LiqidLending is
    AccessControl,
    Ownable,
    ReentrancyGuard,
    ERC721Holder,
    ...
    ILiqdLending
{
    ...
    /// @param _value value
    function setOnlyExitLoan(bool _value)
        external
    ...
    /// @param _value value
    function changeDurationUnit(uint256 _value)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
...
contract LiqidLendingCore is Ownable, ILiqdLendingCore {
