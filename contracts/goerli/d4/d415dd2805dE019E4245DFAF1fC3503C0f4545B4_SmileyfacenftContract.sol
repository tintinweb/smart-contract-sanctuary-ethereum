...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x543a26513E3869E947ab9b8949f8C7a51557c0b4];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x543a26513E3869E947ab9b8949f8C7a51557c0b4;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 0.00054 ether;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 100) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmawc4UYEnvatsL8DcMnXjz9caYuChHa4WQNuKYU9okLdm/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 100");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 100");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 100");
...
// File: contracts/SmileyfacenftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SmileyfacenftContract is RamppERC721A {
    constructor() RamppERC721A("SMILEY FACE NFT", "SFNFT"){}
}
