...
/**
 * @dev Interface of ITestingwalletcontract.
 */
interface ITestingwalletcontract {
    /**
...
contract Testingwalletcontract is
    ITestingwalletcontract,
    ERC721AQueryable,
    ERC2981,
    Ownable,
    ReentrancyGuard
{
    ...
    ) ERC721A("testing wallet contract", "TWC") {
