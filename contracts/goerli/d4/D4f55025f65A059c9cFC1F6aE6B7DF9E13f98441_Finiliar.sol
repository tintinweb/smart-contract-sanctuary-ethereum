...
contract Finiliar is Ownable, ERC721, PaymentSplitter, IToken {
    ...
    // Sale details
    uint256 public override maxTokens = 10000; // presale amount
    // NOTE: changed this for testing
    uint256 public override maxMintsPerTx = 10000;
    // NOTE: changed this for testing
    uint256 public override price = .0 ether; // presale price
    // NOTE: changed this for testing
    bool public override saleActive = true;
