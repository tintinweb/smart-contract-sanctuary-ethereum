...
/**
 * @title ExclusiveNFTCollectionAlpha
 */
contract ExclusiveNFTCollectionAlpha is ExclusiveNFTCollectionSplitsAndRoyalties, ExclusiveNFTCollectionBase {
    constructor()
        ERC721A('ExclusiveNFTCollectionAlpha', 'ENCA')
        ExclusiveNFTCollectionBase(
            'https://nftc-media.mypinata.cloud/ipfs/Qma8JyxudEvAjCTgA5jaWDAuJHooqHhxAu7qG8nuS53UD8/', // NFTCReference721-rinkeby-Metadata_V1
            0.01 ether
        )
    {
