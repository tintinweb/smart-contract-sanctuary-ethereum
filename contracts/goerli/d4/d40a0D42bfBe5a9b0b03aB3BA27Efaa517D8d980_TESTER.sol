...
// in lines 500-600 is where you marketing tokens get dispersed
//step 1 after deployment is to turn on swapandliquifiy because that triggers fees to be captured and sent to the wallet
...
contract TESTER is Context, IERC20, Ownable {
    ...
    string private _symbol = "TCON";
    uint8 private _decimals = 18;

    address payable private taxWallet1 = payable(0xb994B9Ba74eCA212d2aB29E181EBA18D027216a4);
    address payable private taxWallet2 = payable(0xb994B9Ba74eCA212d2aB29E181EBA18D027216a4);
    ...
    uint256 public _totalDistributionShares = 11;

    uint256 private _totalSupply = 10000000000 * 10**6 * 10**9;
    ...
    constructor (bool swapandliq) {
        swapandliq = swapAndLiquifyEnabled;
