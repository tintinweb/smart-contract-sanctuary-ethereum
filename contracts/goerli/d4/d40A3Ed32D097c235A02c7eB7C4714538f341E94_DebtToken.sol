...
interface ILendPoolConfigurator {
     ...
     * @param buyItNowDuration The new redeem duration
     * @param redeemFine The new redeem fine
     **/
    event NftBuyItNowChanged(
        address indexed asset,
        uint256 redeemDuration,
        uint256 buyItNowDuration,
        uint256 redeemFine
    ...
    event NftMinBuyItNowFineChanged(
        address indexed asset,
        uint256 minBuyItNowFine
    );
...
abstract contract IncentivizedERC20 is Initializable, IERC20MetadataUpgradeable, ERC20Upgradeable {
  ...
  /**
   * @return Abstract function implemented by the child cToken/debtToken.
   * Done this way in order to not break compatibility with previous versions of cTokens/debtTokens
   **/
