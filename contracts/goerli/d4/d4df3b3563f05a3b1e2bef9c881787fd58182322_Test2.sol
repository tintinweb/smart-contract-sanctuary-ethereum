...
contract Test2  is Context, IERC20 { 
    ...
    address payable public Wallet_Reward = payable(0x2B72898f88c83881b09EA7D828484CE8A3b637F2); //replace with your Reward wallet 
    address payable public Wallet_Dev = payable(0x2B72898f88c83881b09EA7D828484CE8A3b637F2); // replace with your dev wallet
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Treasury = payable(0x2B72898f88c83881b09EA7D828484CE8A3b637F2); // replace with your treasury wallet
    ...
    uint256 public totalSellTax = 10;
            ...
            //buyFee
    uint256 public buy_Reward= 3;
    uint256 public buy_Dev = 3;
    uint256 public buy_burn = 1;
    uint256 public buy_autoLP = 2; 
    uint256 public buy_Treasury =1; 

           //sellFees
    uint256 public sell_Reward= 3;
    uint256 public sell_Dev = 3;
    uint256 public sell_burn = 1;
    uint256 public sell_autoLP = 2; 
    uint256 public sell_Treasury =1;      

                   

    uint256 public _maxWalletToken = _tTotal * 2/ 100; // 2% of the supply (maxWalletLimit)
    uint256 public _maxTxAmount = _tTotal * 11/ 1000; // 1.1% of the supply per tx limit
   ...
   function launch() public onlyOwner {
    ...
    function updateSellTax(uint256 reward, uint256 treasury, uint256 burn, uint256 autoLP, uint256 dev) external onlyOwner {
        ...
        require(totalSellTax <=12, "maxBuyTax should be less than equal to 12 percent");
    ...
    function updateBuyTax(uint256 reward, uint256 treasury, uint256 burn, uint256 autoLP, uint256 dev) external onlyOwner {
        ...
        totalBuyTax = reward + treasury + burn + autoLP + dev;
        require(totalBuyTax <=12, "maxBuyTax should be less than equal to 12 percent");
