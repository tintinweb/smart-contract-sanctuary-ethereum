...
contract sTestToken is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    /**
        @notice increases sTEST supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sTEST
