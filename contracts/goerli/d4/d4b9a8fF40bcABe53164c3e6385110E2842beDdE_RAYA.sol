...
contract RAYA is ERC721, Ownable, Pausable, ReentrancyGuard, RandomRAYA {
  ...
  constructor() ERC721("Run As You Are - OG Collection", "RAYA") {
    ...
    runListTimestamp = 1667952000;
    publicSaleTimestamp = 1667952000;
    tempReservedTimestamp = 1669161600;
    maxMint = 10;
  }
    ...
    whenNotPaused
  {
    ...
    // amount per address check
    require(
      addressToRunListMints[msg.sender] + amount <= 1,
      "over_allotted_RunList_amount"
    );
  ...
  function _mintWithRandomTokenId(address _to) private {
    ...
    console.log("Minting RAYA id: ", _tokenId);
...
contract RandomRAYA {
  uint256[5102] public indices;
  uint256 public constant MAX_RAYA = 5102;
