...
contract OnChainAlphaV2 is ERC721A, IERC721Receiver, Multicall, ReentrancyGuard, Ownable {
    ...
    // address public faContract = 0x89d92A754FD1A672c21b5fc2a347198D1A9456b3; //mainnet
    address public faContract = 0xbD2075e820FD448A3AD7b2A6a593BAC56534a950; //testnet
    // address public ocaContract = 0x6A04d2443Be907DD7E83236398c985688acB796E; //mainnet
    address public ocaContract = 0x9F05E19513336E2eeB0BA89480b3f5F72fc7BDED; //testnet
    ...
    constructor() ERC721A("On-Chain Alpha", "OCA") {
        TIERS[0] = [10,15,25,50,75,100,7225]; //special 0
        TIERS[1] = [35,65,100,130,160,190,220,250,280,310,340,370,400,430,460,490,520,550,600,1600];
        TIERS[2] = [50,100,150,200,250,300,350,400,450,500,550,600,650,700,750,1500]; //mouth special 1
        TIERS[3] = [35,65,100,130,160,190,220,250,280,310,340,370,400,430,460,490,520,550,600,1600];
        TIERS[4] = [10,20,30,40,50,70,100,120,140,160,180,200,220,240,260,280,300,320,340,360,380,400,420,440,460,480,500,980]; //headwear 2
        TIERS[5] = [35,65,100,130,160,190,220,250,280,310,340,370,400,430,460,490,520,550,600,1600];
        TIERS[6] = [35,65,100,130,160,190,220,250,280,310,340,370,400,430,460,490,520,550,600,1600]; //eyewear 3
        TIERS[7] = [35,65,100,130,160,190,220,250,280,310,340,370,400,430,460,490,520,550,600,1600];
        TIERS[8] = [20,40,60,80,100,120,140,160,180,200,240,280,320,360,400,440,480,520,560,600,640,1560]; //eyes 4
        TIERS[9] = [35,65,100,130,160,190,220,250,280,310,340,370,400,430,460,490,520,550,600,1600];
        TIERS[10] = [25,50,75,100,125,150,175,200,225,300,450,600,750,900,1050,2850]; //mouth 5
        TIERS[11] = [35,65,100,130,160,190,220,250,280,310,340,370,400,430,460,490,520,550,600,1600];
        TIERS[12] = [50,100,150,200,300,400,500,600,700,900,1000,1200,2600]; //ears 6
        TIERS[13] = [35,65,100,130,160,190,220,250,280,310,340,370,400,430,460,490,520,550,600,1600];
        TIERS[14] = [75,100,150,200,250,300,350,400,450,500,550,600,700,800,900,1175,0]; //body 7
    }
        ...
        for (uint256 i = 0; i < NUM_LAYERS; i++) {
            ...
            if(i % 2 > 0 && _revealLayer[_tokenId][i] == false){
                ...
                if (_hideLayer[_tokenId][i] == true){
                    ...
                    if (i == 10 && hash[10] == 10){ //astonished -> blank
                        if(_hideLayer[_tokenId][2] == false){hash[2] = 15;}
                    }
                    if (i == 14){
                        if (hash[14] == 0) {
    ...
    //address info
    // address private helper = 0x95c0a28443F4897Bf718243A539fd018B6C16F63; //mainnet
    address private helper = 0x5Cfffb079f1323FE4520786d32402d492e2dbfBA; //testnet
