...
contract ForgeNft is ERC721AQueryable, Ownable, Pausable {
  ...
  */
  function createMintWindow(uint256 fromTimestamp, uint256 toTimestamp, uint256 newFeeAmount) public onlyOwner {
 ...
 */
  function mint(
    ...
    require(IERC721(contractAddress).ownerOf(tokenId) == msg.sender, "Not owner");
