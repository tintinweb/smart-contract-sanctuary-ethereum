...
contract NftMain is ERC721URIStorage, Ownable {
	// 1. Type Declarations
	using Strings for uint256;

	// 2. State variables
	uint256 public constant TOKEN_MAX_COUNTER = 2;
	uint256 public constant MIN_NFT_MINT_FEE = 1 * 1e16;
	...
	function getMinMintFee() public pure returns (string memory) {
		string memory count = (MIN_NFT_MINT_FEE / 1e18).toString();
		string memory unit = "ETH";
		return string(abi.encodePacked(count, unit));
	}
