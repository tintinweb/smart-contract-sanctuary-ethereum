...
import { BaseRelayRecipient } from "lib/gsn/packages/contracts/src/BaseRelayRecipient.sol";
...
contract SoulboundMinter is
    ...
    UUPSUpgradeable
{
    string private constant VERSION_RECIPIENT = "2.2.5";
    // LIBS
    ...
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() BaseRelayRecipient() {
        _disableInitializers();
    }
    ...
    // OpenGSN Recipient version

    function versionRecipient() external view virtual override returns (string memory) {
        return VERSION_RECIPIENT;
    }
}