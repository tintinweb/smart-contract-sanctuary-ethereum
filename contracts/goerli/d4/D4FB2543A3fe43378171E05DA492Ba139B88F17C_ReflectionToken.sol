...
contract ReflectionToken is IERC20, Context, AccessControl, Ownable {
    ...
    mapping (address => bool) private _isExcluded; // Accounts to not receive rewards (e.g. liquidity, dead wallet)
    ...
    constructor(
        ...
        setExclude(address(this));
        setExclude(0xdEAD000000000000000042069420694206942069);
