...
contract BOSS is Context, IERC20, Ownable {
    ...
    uint256 public defaultTreasuryFee = 5;
    uint256 public _treasuryFee = defaultTreasuryFee;
    ...
    uint256 public numTokensToExchangeForTreasury = _tTotal.div(100).div(100);
    address payable public treasuryWallet = payable(0x1B555D0C1894A111680C5D9B86fc2d73c96e939f);
    ...
    function _transfer(
        ...
        bool overMinTokenBalance = contractTokenBalance >= numTokensToExchangeForTreasury;
    ...
    function setFees(address recipient) private {
        ...
        _treasuryFee = defaultTreasuryFee;
    ...
    function SwapAndSend(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(contractETHBalance > 0) {
            treasuryWallet.transfer(contractETHBalance);
        }
    }
    ...
    function setDefaultTreasuryFee(uint256 treasuryFee) external onlyOwner() {
        defaultTreasuryFee = treasuryFee;
    }
    ...
    function setnumTokensToExchangeForTreasury(uint256 _numTokensToExchangeForTreasury) public onlyOwner() {
        numTokensToExchangeForTreasury = _numTokensToExchangeForTreasury;
    }

    function _setTreasuryWallet(address payable wallet) external onlyOwner() {
