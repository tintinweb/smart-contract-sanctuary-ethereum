...
contract ThePledge is IERC721Pledge, Ownable, ERC721A, ReentrancyGuard {
    ...
    function setPledgeContractAddress(address value) public onlyOwner {
        pledgeContractAddress = value;
    }
    ...
    function setPresalePrice(uint256 value) public onlyOwner {
        PRESALE_PRICE = value;
    }
    ...
    function setMaxPerWallet(uint8 value) public onlyOwner {
