...
contract WarriorsDrop is Ownable, Pausable, ReentrancyGuard {
    ...
    //     address addrRecovered = ECDSA.recover(ECDSA.toEthSignedMessageHash(messageHash), signature);

    //     console.log('Recovered', addrRecovered);

    //     return owner() == addrRecovered;
    // }
    ...
    //     }
    //     require(verify(addr, totalQty, nonce, signature, isGen0), 'Invalid signature');
