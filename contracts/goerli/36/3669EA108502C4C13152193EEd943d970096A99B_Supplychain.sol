...
contract Supplychain {
    ...
    function createShipment(address _owner,string memory _title, string memory _category, address _sender, address _logistics, address _receiver, string memory _description, string memory _commonDocuments, string memory _confidentialDocuments, string memory _image) public returns (uint256) {
