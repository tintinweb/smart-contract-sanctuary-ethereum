...
contract mQuark is ImQuark, ERC721, IERC2981, DefaultOperatorFilterer, Ownable {
  ...
  function mint(
    ...
    _mint(to, _tokenId);
    _tokenInfo[_tokenId] = TokenInfo(false,_tempData.royaltyReciever,_tempData.collectionURIs[variationId]);
  ...
  function mintWithPreURI(
    ...
    uint256 _tokenId = _tempData.minTokenId + _tempData.mintCount;
    _mint(to, _tokenId);
    _tokenInfo[_tokenId] = TokenInfo(false,_tempData.royaltyReciever,uri);
    ++_projectCollections[templateId][projectId][collectionId].mintCount;
  ...
  function mintFree(
    ...
    if (_tempData.collectionURIs.length <= variationId) revert InvalidVariation();
    uint256 _tokenId = _tempData.minTokenId + _tempData.mintCount;
    _tokenInfo[_tokenId] = TokenInfo(true,_tempData.royaltyReciever,_tempData.collectionURIs[variationId]);
    ++_projectCollections[templateId][projectId][collectionId].mintCount;
  ...
  function mintFreeWithPreURI(
    ...
    if (!_verifyCollectionURIEditSignature(signature, signer, projectId, templateId, collectionId, uri))
      revert VerificationFailed();
    uint256 _tokenId = _tempData.minTokenId + _tempData.mintCount;
    _tokenInfo[_tokenId] = TokenInfo(true,_tempData.royaltyReciever,uri);
    ++_projectCollections[templateId][projectId][collectionId].mintCount;
    _mint(msg.sender, _tokenId);
  ...
  function mintBatch(
    ...
    for (uint256 i = 0; i < _templateIdsLength; ) {
      ...
      for (uint256 ii = 0; ii < _mintAmount; ) {
        ...
        _mint(to, _tokenId);
        ++_tempData.mintCount;
        _tokenInfo[_tokenId] = TokenInfo(false,_tempData.royaltyReciever,_tempData.collectionURIs[variationIds[i]]);
        emit NFTMinted(
          projectId,
          templateIds[i],
          collectionIds[i],
