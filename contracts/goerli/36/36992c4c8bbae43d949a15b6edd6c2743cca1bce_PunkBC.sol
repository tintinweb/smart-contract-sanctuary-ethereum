...
// File: https://github.com/ProjectOpenSea/operator-filter-registry/blob/a780f44b2dd4fc10b0c27556711cac5f74e56fda/src/IOperatorFilterRegistry.sol
...
// File: https://github.com/ProjectOpenSea/operator-filter-registry/blob/a780f44b2dd4fc10b0c27556711cac5f74e56fda/src/OperatorFilterer.sol
...
// File: https://github.com/ProjectOpenSea/operator-filter-registry/blob/a780f44b2dd4fc10b0c27556711cac5f74e56fda/src/DefaultOperatorFilterer.sol
...
contract PunkBC is ERC721A, Ownable, OperatorFilterer {

    constructor() ERC721A("Punk BC", "PKBC") OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), false) {}
    ...
    string internal baseURI = "ipfs://bafybeiblhvaooqflry3raqpoycuhv5zwt5lwhfm2nwo5cmwhdingdwgvf4/";
    ...
    modifier isMaxTxReached(uint256 quantity) {
        require(_numberMinted(msg.sender) + quantity <= MAX_TX_PER_WALLET, "Exceeded wallet limit");
        _;
    }
    ...
    function mintForAddress(address[] memory _recipients, uint256[] memory _amount)
        public
        virtual
        onlyOwner
        isUser
    {
        ...
        require(totalSupply() + _amount[i] <= MAX_SUPPLY, "Out of stock");
