...
contract C7C is ERC721, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 10000;
    uint private constant TOKENS_RESERVED = 4;
    uint public price = 0.0123 ether;
    ...
    constructor() ERC721("C7C", "C7C") {
        baseUri = "https://blush-obedient-jackal-530.mypinata.cloud/ipfs/QmaZZdXYp1nxkVhx6argrfDFBr7UAMw5ifi97u4C188CeN/";
