 ...
 * @notice This contract handles minting Z00KIES: Chapter 1 tokens.
 */
contract Z00KIESChapter1 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xed50118a461F02fE5E7bc4a983823519156E2596;
    ...
    string public name = "Z00KIES: Chapter 1";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeieaeanpnkobzl6pheb4ehyhxcgckbwzr3jjfc2ycbbfhuvdkumnya/{id}"
        )
    {
