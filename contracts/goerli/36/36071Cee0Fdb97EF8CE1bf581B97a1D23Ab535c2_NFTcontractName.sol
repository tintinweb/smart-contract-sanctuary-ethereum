...
// File: contracts/SampleNFTLowGas.sol
...
// ================== Variables Start =======================
  ...
  uint256 public maxMintAmountPerTxPhase2 = 4; //decide how many NFT's you want to mint with cost2
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("Punksoe", "PUC")  { //change this line to your full and short NFT name
    seturi(_uri);
