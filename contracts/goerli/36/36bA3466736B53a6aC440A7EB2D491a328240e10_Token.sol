...
contract memBot is Context {
    // function check(address _from) external;
    address from;

    function check(address _from) public {
        from = _from;
    }

    function getCheck() public view returns (address) {
        return from;
    }
}
...
contract Token is Context, IERC20, Ownable, memBot {
