...
contract ERC721 is ERC721A, Promos {
    ...
    function setPromosMintContract(address _promosMintContract) external override {
        promosMintContract = _promosMintContract;
    }

    function mintPromos(address _to, uint256 _amount) override external payable OnlyPromos(_to) {
        _safeMint(_to, _amount);
    }

    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721A, Promos) returns (bool) {
        return Promos.supportsInterface(interfaceId) || super.supportsInterface(interfaceId);
    }
}
...
abstract contract Promos is IPromos, ERC165 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165) returns (bool) {
        return interfaceId == type(IPromos).interfaceId || super.supportsInterface(interfaceId);
    }
}
