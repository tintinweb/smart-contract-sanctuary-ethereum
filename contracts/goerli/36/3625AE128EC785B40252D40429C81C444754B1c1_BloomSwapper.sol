...
contract BloomSwapper {
    ...
    constructor(
        ...
        TREASURE = _treasure;
        require(
            dai.approve(TREASURE, 999000000000000000000),
            "Approval of treasure failed"
        );
    }
        ...
        minimumAmount(amount)
    {
        ...
        // require(dai.transferFrom(msg.sender, to, newAmount), "Transfer failed");
        dai.transferFrom(address(this), TREASURE, amount);
        ...
        returns (uint256)
    {
        ...
        uint256 fee = treasure.calculateFee(amount);
        treasure.fundTreasureWithToken("DAI", fee, msg.sender);
        require(dai.approve(msg.sender, amount), "Failed to approve DAI");
        require(
...
contract BloomTreasure {
    ...
    function fundTreasureWithToken(
        ...
        if (compareStrings(token, "DAI")) {
            ...
            treasure.dai.payers.push(funder);
        }
