...
contract AggregatorV2 is Aggregator {
    ...
    function setTotalUnwithdrawAmounts(uint256 amount)external onlyDao {
        emit TotalUnwithdrawAmountsChanged(totalUnwithdrawAmounts,  amount);
    ...
    function reportExitStatus(uint256[] calldata tokenIds, uint256[] calldata amounts) public onlyDao {
        ...
        for (uint256 i = 0; i < tokenIds.length; ++i) {
            ...
            withdrawAmounts[tokenId] = amounts[i];
            totalReportAmounts += amounts[i];
    ...
    function claimETH(uint256 claimNumber) public {
