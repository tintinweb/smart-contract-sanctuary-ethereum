...
contract SatoshiverseBiosynths is ERC721WithEIP2981 {
    constructor()
        ERC721WithEIP2981("Satoshiverse Biosynths", "SATOSHIVERSE_BIOSYNTHS")
    {}

    string public baseURI = "";
    uint16 mintIndex = 1;

    uint16 public royaltyPercent = 500;
    ...
    function setRoyaltyPercent(uint16 _royaltyPercent) public onlyOperator {
    ...
    function burnItem(uint256 tokenId) public {
        if (_msgSender() != address(0)) {
            ...
            require(owner == _msgSender(), "Only the owner of NFT can burn it");
        }
