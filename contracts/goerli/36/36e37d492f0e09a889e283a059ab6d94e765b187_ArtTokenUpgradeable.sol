...
//import "./utils/AllowListUpgradeable.sol";
    ...
    MerkleAllowListUpgradeable
{
    ...
    function mintWithProof(uint256 _quantity, uint256 _max, bytes32[] memory _proof) external payable {
        ...
        _checkAllowList(_quantity, _max, _proof);
    ...
    OwnableUpgradeable
{
    ...
    function _checkAllowList(uint256 _quantity, uint256 _max, bytes32[] memory _proof) internal {
