 ...
 * @notice This contract handles minting mp3 test tokens.
 */
contract Mp3Test is
    ERC721A,
    ERC721AQueryable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x523213125a77aBf1CeFD4e92C5F1FbF60A67C032;
    ...
    string public baseTokenURI =
        "ipfs://bafybeiciux3ftn7qpcgyehqgn5rotolrkuuvxmu7uiz7fmoxfmxgza5b6u/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 10;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 10;
    uint256 public presaleMintsAllowedPerAddress = 10;
    uint256 public presaleMintsAllowedPerTransaction = 10;
    ...
    uint256[] public payoutBasisPoints = [1000, 9000];
    uint96 public royaltyFee = 500;

    constructor()
        ERC721A("mp3 test", "mp3 test")
        RevokableOperatorFilterer(
