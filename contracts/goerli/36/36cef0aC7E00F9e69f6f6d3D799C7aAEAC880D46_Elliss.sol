...
contract Elliss is ERC721A, Ownable {
	uint16 public maxSupply = 1000;
	uint16 public maxPerWallet = 50;
	uint64 public price = 0.001 ether;
	string private baseURI = "ipfs://bafybeictumnxogrn5voug37dwcvkq75uqegt55iva26zjdv2klibrhwic4/";

	constructor() ERC721A("Elliss", "ELS") {}
