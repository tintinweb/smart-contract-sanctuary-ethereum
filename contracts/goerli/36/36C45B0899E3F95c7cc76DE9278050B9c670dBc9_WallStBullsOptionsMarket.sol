...
contract WallStBullsOptionsMarket is ERC721Holder, Ownable {
    ...
    constructor(
        ...
        graveyardWallet = _graveyardWallet;
    ...
    function setGraveyardWallet(address _graveyardWallet) external onlyOwner {
        graveyardWallet = _graveyardWallet;
    }
    ...
    event RollEvent(State _state, uint256 _roll);

    function rollTest(uint256 _tokenId) external {
        uint256 r = _roll(_tokenId);
        stateCount += 1;
        emit RollEvent(_rollToState(r), r);
    }
}
