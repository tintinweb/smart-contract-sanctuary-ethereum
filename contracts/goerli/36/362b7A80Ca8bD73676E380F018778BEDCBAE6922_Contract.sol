...
contract Contract is ERC721Drop, PermissionsEnumerable, PlatformFee {
    ...
    function getMinimumParticipants() public view returns (uint256) {
    ...
    {
        uint256 participants = _totalMinted();
        require(participants >= getMinimumParticipants(), "participants must be >= minimum number of participants");
        uint256 tokenId = generateRandomNumber() % participants;
