...
library StopLoss {
  ...
  function run(
    ...
    require(order.path.length > 1 && order.amountOut > 0, "StopLoss::_runStopLoss: stop loss disabled");
    require(inTokens.length <= 256, "StopLoss::_runStopLoss: too many in tokens");
    ...
    require(baseBalance > 0, "StopLoss::_runStopLoss: insufficient balance of base token");
    ...
    require(amountsOut[amountsOut.length - 1] <= order.amountOut, "StopLoss::_runStopLoss: invalid output amount");
