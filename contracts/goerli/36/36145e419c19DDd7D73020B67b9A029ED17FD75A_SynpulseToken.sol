...
// This contract was designed and deployed by : Janis Heibel, Roy Hove, Adil Anees and Vishwa Ratna on behalf of Synpulse.
...
contract SynpulseToken is ERC20, Pausable {
    ...
    address public vaultContract = 0xEcDA1249Af9498C7486f0b9D6774d75C02D7927a;//0x7eff474f44D384Ee5D48a89cD5A473AC6Fe24CE2; // Synpulse Vault address;
    address public administrator = 0x0000000000000000000000000000000000000000; // Administrator address;

    constructor(uint256 initialSupply)
        ERC20("vSynpulse Token of YYYY", "vSYNYY")
    {
    ...
    function sendTokensToMultipleAdresses(
        ...
        for (uint256 z = 0; z < listOfAddresses_ToSend_To.length; z++) {
            _transfer(vaultContract,listOfAddresses_ToSend_To[z], amountToSend);
        }
    } 
