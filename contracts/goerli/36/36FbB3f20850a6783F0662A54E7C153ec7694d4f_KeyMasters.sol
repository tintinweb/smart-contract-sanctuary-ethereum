...
contract KeyMasters is Initializable {
    ...
    */
    function distribute(uint _amount) external onlyDev {
        ...
        uint256 wallet1Share = (_amount / 100) * 14;
        uint256 wallet2Share = (_amount / 100) * 8;
        uint256 wallet3Share = (_amount / 100) * 16;
        uint256 wallet4Share = (_amount / 100) * 18;
        uint256 wallet5Share = (_amount / 100) * 7;
        uint256 wallet6Share = (_amount / 100) * 15;
        uint256 wallet7Share = (_amount / 100) * 22;
