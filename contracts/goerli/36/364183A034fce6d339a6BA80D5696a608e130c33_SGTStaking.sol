...
contract SGTStaking is Ownable, ReentrancyGuard {
    ...
    */
    constructor(address _stakingToken , address _mintingToken) {
        ...
        createRewardPlan("6 Months" , 180 days , 5 , 50);
        createRewardPlan("12 Months" , 360 days , 7 , 75);
        createRewardPlan("18 Months" , 540 days , 9 , 100);
        createRewardPlan("24 Months" , 720 days , 11 , 150);
        createRewardPlan("30 Months" , 900 days , 13 , 200);
        createRewardPlan("36 Months" , 1080 days , 15 , 300);
        createRewardPlan("42 Months" , 1260 days , 17 , 500);
    }
