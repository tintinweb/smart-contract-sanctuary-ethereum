    ...
    UUPSUpgradeable
{
    ...
    function initialize(address admin, address blacklist) public initializer {
        __Minterceptor_init(admin, blacklist);
    }

    function __Minterceptor_init(address admin, address blacklist)
        internal
        onlyInitializing
    {
        __Ownable_init();
        __UUPSUpgradeable_init();
        __Minterceptor_init_unchained(admin, blacklist);
    }

    function __Minterceptor_init_unchained(address admin, address blacklist)
        internal
        onlyInitializing
    {
    ...
    function mintByUri(
        ...
        string memory uri,
        bytes memory data
    ) public payable onlyRole(MANAGER_ROLE) isNotBlackListed(to) {
        emit MintForwarded(collectionContract, to, uri, data);
