...
// Updated SVG code for a multiplex pattern design
    ...
    return
        string(
            abi.encodePacked(
                ...
                '" fill="',
                rectangle.border,
                '" /> <pattern id="pattern" width="20" height="20" patternUnits="userSpaceOnUse" > <circle cx="10" cy="10" r="10" fill="white"></circle> <rect x="0" y="0" width="20" height="20" fill="black"></rect> </pattern> <circle cx="',
                uint2str(rectangle.x + rectangle.width - 150),
                '" cy="',
                uint2str(rectangle.y + rectangle.height - 50),
                '" r="100" fill="url(#pattern)"></circle>'
            )
        );
}
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '" cy="',
                    uint2str(y),
                    '" r="40" fill="#ffffff"><animate attributeType="XML" attributeName="fill" values="#ffffff00;#ffffff00;#ffffff00;#ffffff00;#ffffff00;#ffffff;#ffffff00;#ffffff00;#ffffff00;#ffffff00;" dur="3s" repeatCount="indefinite"/></circle>'
                )
            );
    }
