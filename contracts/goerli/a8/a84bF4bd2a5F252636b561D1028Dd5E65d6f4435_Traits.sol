...
contract Traits is ERC1155LazyMint {
    ...
    function verifyClaim(address _claimer, uint256 _tokenId, uint256 _quantity) public view virtual override {
        uint256 balance = lootboxRequirement * _quantity;
        require(lootbox.balanceOf(_claimer, _tokenId) >= balance, 'You do not have enough Lootboxes to make that transaction.');
    }
