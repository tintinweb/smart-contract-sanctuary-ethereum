...
contract Registry is IRegistry, Ownable2Step {
    ...
    function setPrincipalTokenFactory(
        ...
        _checkOwner();
        require(
            _newPrincipalTokenFactory != address(0),
            "Registry: Cannot set principalToken factory to zero address"
        );
    ...
    function addPrincipalToken(address _principalToken) external override {
        _checkOwner();
        require(
            principalTokens.add(_principalToken),
            "Registry: ERR_FUTURE_ADD"
        );
    ...
    function removePrincipalToken(address _principalToken) external override {
        _checkOwner();
        require(
            principalTokens.remove(_principalToken),
            "Registry: ERR_FUTURE_RM"
        );
