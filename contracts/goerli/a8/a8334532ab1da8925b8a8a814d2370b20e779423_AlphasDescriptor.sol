...
contract AlphasDescriptor is IAlphasDescriptor, Ownable {
     ...
     */
    function dataURI(uint256 tokenId, IAlphasSeeder.Seed memory seed, uint256 birthday) public view override returns (string memory) {
     ...
     */
    function _getAttributesForSeed(IAlphasSeeder.Seed memory seed, uint256 birthday) internal view returns (string[] memory) {
        ...
        _attributes[4] = birthday.toString();
        return _attributes;
    }
}
