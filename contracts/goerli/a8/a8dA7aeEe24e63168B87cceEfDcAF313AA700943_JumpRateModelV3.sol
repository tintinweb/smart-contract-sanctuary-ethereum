...
/**
  ...
  * @notice Version 3 modifies Version 2 by enabling updateable parameters.
  */
contract JumpRateModelV3 is Initializable, InterestRateModel, AccessControlUpgradeable {
    ...
    event NewInterest(address blending, uint appliedBlock, uint interestRatePerBlock);
   ...
   //************* MODERATOR FUNCTIONS ********************************
    ...
    function storeBorrowRate(uint cash, uint borrows, uint reserves) public onlyBlendingToken() override returns (uint) {
        ...
        emit NewInterest(msg.sender, block.number, interestRate);
