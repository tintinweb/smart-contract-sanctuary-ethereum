 ...
 * @notice This contract handles minting Wallet Drainers tokens.
 */
contract LaunchpadWalletDrainers is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0x3a9238D6806889f8A26f01344a9CE407c8369c35;
    address[] public payoutAddresses = [
        0x3a9238D6806889f8A26f01344a9CE407c8369c35
    ];
    ...
    bool public usePublicSaleTimes = true;
    string public baseTokenURI =
        "ipfs://bafybeifswnu5qglmwb42ar4gvlavnpcllhxy32aomtidshnzkh2vm2ygma/";
    ...
    uint256 public publicPrice = 0.1111111 ether;
    uint256 public publicSaleEndTime = 1979767462;
    uint256 public publicSaleStartTime = 1664521200;
    uint256[] public payoutPercentages = [100];
    uint96 public royaltyFee = 10000;

    constructor() ERC721A("Wallet Drainers", "WADR") {
     ...
     */
    function setPublicSaleEndTime(uint256 _publicSaleEndTime) public onlyOwner {
     ...
     */
    function setUsePublicSaleTimes(bool _usePublicSaleTimes) public onlyOwner {
        require(
            usePublicSaleTimes != _usePublicSaleTimes,
            "NEW_STATE_IDENTICAL_TO_OLD_STATE"
        );
        usePublicSaleTimes = _usePublicSaleTimes;
    }
    ...
    /**
     * @notice Returns if public sale times are active
     */
    function publicSaleTimeIsActive() public view returns (bool) {
        if (usePublicSaleTimes == false) {
            return true;
        }
        return
    ...
    function mint(uint256 numTokens) external payable originalUser {
        ...
        require(publicSaleTimeIsActive(), "PUBLIC_SALE_IS_NOT_ACTIVE");
        require(
