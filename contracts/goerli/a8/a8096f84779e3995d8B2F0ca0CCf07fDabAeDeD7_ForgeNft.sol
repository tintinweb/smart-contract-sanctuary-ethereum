...
contract ForgeNft is ERC721AQueryable, ReentrancyGuard, Ownable, Pausable {
  ...
  address public WARM_CONTRACT_ADDRESS =
    0xC3AA9bc72Bd623168860a1e5c6a4530d3D80456c;

  constructor() ERC721A("ForgeNft", "FORGE") {}

  function setWarmContractAddress(
    address warmContractAddress
  ) public onlyOwner {
    WARM_CONTRACT_ADDRESS = warmContractAddress;
  }
