...
// File: contracts/PCNFTCollection.sol
...
contract PCNFTCollection is ERC721URIStorage, Ownable, Pausable{
    ...
    event NFTTokenURIUpdated (uint indexed id, string tokenURI);
    event MaxTokensUpdated (uint indexed newAmount);
        ...
        onlyOwner
    {
        ...
        emit NFTTokenURIUpdated(_tokenId, _newURI);
    }        
        ...
        returns(uint256)
    {
        ...
        emit MaxTokensUpdated(_newAmount);
