...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B, 0x6cf9b5865848A36514e5Ce6c779fCad2a89D96bE];
  address public erc20Payable = 0x6cf9b5865848A36514e5Ce6c779fCad2a89D96bE;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 1;
...

{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 1) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicmo2xax3kaag3onb7wxotoqzgklig4zfuce6brmsp6zqmn4pc3cm";
...
// File: contracts/AofwContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ayu_Contract is ERC721APlus {
    constructor() ERC721APlus("ayu", "liao"){}
}