...
contract Factory {
    ...
    */
    ...
    function changeOwner(address _account) public {
...
contract Kollab_Share {
    ...
    */
    ...
    /**
    * @notice Loops through each user and pays out outstanding balance.
    * @dev Funnction is internal and only called when contract receives monies.
    */
    function automaticPayout() internal {
        for(uint i = 0; i < payees.length; i++) {
