        ...
        for (y = 0; y <= 800; y += 100) {
            for (x = 0; x <= 800; x += 100) {
                ...
                if (PrimesUtils.isPrime(uint256(count))) {
                    // oi = PrimesUtils.setAnimationEvent(index, colorIndex);
                    // values = setValues(x, y);
                    // d = PrimesUtils.setDefinition(x, y);
        ...
        if (x == 200 && y == 0) {
            ...
            if (x == 0 || x == 300 || x == 600) {
                if (y == 0 || y == 200 || y == 400 || y == 600 || y == 800) {
                    ...
                    // } else if (y == 100 || y == 300 || y == 500 || y == 700) {
                } else {
                    // try remove if
                    // bizarre
                    // lt
