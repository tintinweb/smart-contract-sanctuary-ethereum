...
/*
    ...
    Change router at line 1002 to mainnet PCS V2 0x10ED43C718714eb63d5aA57B78B54704E256024E
...
contract SuperDigitalToken is ERC20, Ownable {
    ...
    constructor(address _router) ERC20("Super Digital Token", "SDT") {
        ...
        address newOwner = address(0x7689c7cc3b38CD656553f1Bb69A930980E773793);
    	...
    	marketingWallet = address(0xEeAdD629B3aFF788ADDAdcC49798594D6ff986A8);
    ...
    function withdrawOtherTokens (address _token, address _account) external onlyOwner {
        ...
        require (_token != address(this), "FINU: Can't withdraw FINU");
        require (_account != address(0), "FINU: Can't withdraw to the zero address");
