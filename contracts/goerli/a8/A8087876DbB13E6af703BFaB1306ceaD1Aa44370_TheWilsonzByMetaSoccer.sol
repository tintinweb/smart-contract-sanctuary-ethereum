...
contract TheWilsonzByMetaSoccer is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable supply = 2022;
    ...
    address[] public withdrawAddresses = [0x7d024516490096Ee7a517340d327fc4084025952, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xd8ea16a2d1015af3ddb5f9d82de1aff539d8bd8db978cec4fc8beb82941674e0;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x7d024516490096Ee7a517340d327fc4084025952, _royaltyAmount);
    }
