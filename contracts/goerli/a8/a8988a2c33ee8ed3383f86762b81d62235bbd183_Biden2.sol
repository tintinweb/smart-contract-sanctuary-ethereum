...
Supply: 100,000,000 Biden Inu

Tax: 10/15 for the first 10 minutes, 0/0 final
...
contract Biden2 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Biden Inu 2";
    string private constant _symbol = "Biden2";
