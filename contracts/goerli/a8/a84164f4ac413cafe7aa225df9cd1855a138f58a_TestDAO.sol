...
contract TestDAO is ERC20, Ownable {
    ...
    address public receiveBuyFeeWallet = 0x982b4C94955F6B566C0a46f8DD65B00bF61897c5;   //买入手续费钱包
    address public receiveSellFeeWallet = 0x54Db7B1e507ae8B7AAF9f25be8ba474Fe4Df927b; //卖出手续费钱包
    IWrap public wrap = IWrap(0x2E6D6966d69b9EAE828F8cb8E556B5e836dB2b67);
    IUniswapV2Router02 public uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Test DAO", "TD", 8, 5000 * 10 ** 8){
        address msgSender = _msgSender();
