...
/**
 * @title CATest
 * CATest - a non-fungible token smart contract for 
 * paintings from the www.catest.io collection
 */
contract CATest is ERC721Token, Ownable {

    // Token id to painting image file hash mapping
    mapping (uint256 => uint256) public tokenIdToHash;

    constructor() ERC721Token("CATest", "CARTE") public { }
  /**
