...
contract TomiStates {
    ...
    struct ProposalSendTokenData {
        /// @notice Unique id for looking up a proposal
        uint256 id;
        /// @notice Type of token to transfer
    ...
    function executeSendToken(uint256 proposalId) external {
        ...
        if (state(proposalId) == ProposalState.Succeeded) {
            ...
            if (proposalData.transferType == 0) {
                ...
                treasury.withdrawToken(usdToken, proposalData.executionTarget, proposalData.executionAmount);
            } else if (proposalData.transferType == 2) {
                treasury.withdrawToken(tomiToken, proposalData.executionTarget, proposalData.executionAmount);
            }
