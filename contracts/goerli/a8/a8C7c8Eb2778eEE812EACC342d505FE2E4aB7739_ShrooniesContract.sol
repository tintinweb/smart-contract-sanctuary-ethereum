...
//
//    _____ __                           _          
//   / ___// /_  _________  ____  ____  (_)__  _____
//   \__ \/ __ \/ ___/ __ \/ __ \/ __ \/ / _ \/ ___/
//  ___/ / / / / /  / /_/ / /_/ / / / / /  __(__  ) 
// /____/_/ /_/_/   \____/\____/_/ /_/_/\___/____/  
//                                                  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1666720800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1666713600;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x9A91Bd9312A147A703edb0184e45C11568a4a394];
  address public erc20Payable = 0x9A91Bd9312A147A703edb0184e45C11568a4a394;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdrrgUbqmkXbLvnGW7CE9QLBHcTDe7NTTyEcBo4LzzWcG/";
...
// File: contracts/ShrooniesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ShrooniesContract is RamppERC721A {
    constructor() RamppERC721A("Shroonies", "SHR"){}
}
