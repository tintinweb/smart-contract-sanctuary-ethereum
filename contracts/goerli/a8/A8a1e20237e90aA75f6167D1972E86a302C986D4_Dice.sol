...
contract Dice is ReentrancyGuard {
    ...
    event WinAmount(uint256 indexed _betId, uint256 indexed _winningAmount);
    ...
    modifier whitelisted() {
        require(
            isWhitelistedMember[msg.sender] || msg.sender == owner,
   ...
   */
    ...
    function withdrawEtherWinnings(uint256 amount) external nonReentrant {
        ...
        require(
            ...
            "Sorry, Contract does not have enough reserve"
        );
        winningsInEther[msg.sender] -= amount;
