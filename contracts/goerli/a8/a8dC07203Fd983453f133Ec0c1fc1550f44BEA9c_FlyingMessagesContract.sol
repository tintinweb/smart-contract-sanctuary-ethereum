...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x151e9c051142f59F2ddB009C7b5DE3eCBa804b92];
  address public erc20Payable = 0x151e9c051142f59F2ddB009C7b5DE3eCBa804b92;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 1000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaijxvb7pyudeh7smg5cyfhqboayrsqhlteou4beavdwtxlide2iu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/huqyElXeOxIIDmVlg27E/contract-metadata";
  }
...
// File: contracts/FlyingMessagesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FlyingMessagesContract is ERC721APlus {
    constructor() ERC721APlus("Flying Messages", "FM"){}
}
  /*******************************************************/
  /*                                                     */
