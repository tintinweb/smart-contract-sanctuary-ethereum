...
pragma abicoder v2; // for sending nexted array or struct as calldata
...
contract SingleSwap {
    ...
    // clear contructor or delete it since we will delete params
    constructor() {}
    ...
    function swapExactInputSingle(uint256 amountIn) external returns (uint256 amountOut) {
        ...
        // linkToken.safeTransferFrom(LINK, msg.sender, address(this), amountIn);
        ...
        ISwapRouter.ExactInputSingleParams memory params = ISwapRouter.ExactInputSingleParams({
            ...
            tokenOut: WETH,
            fee: poolFee,
            recipient: address(this), // change from msg.sender to address(this)
    ...
    {
        // Transfer the specified amount of LINK to this contract.
        // linkToken.safeTransferFrom(LINK, msg.sender, address(this), amountInMaximum);
