...
contract OSMSubscription is Subscribable {  
    ...
    function mint(uint numberOfDays) external payable {  
        ...
        uint256 fee = determineFee(numberOfDays,blank);
...
abstract contract Subscribable is TokenReceiver {
    ...
    function validSubscription(uint256 numberOfDays) public view {
        subs.validateSubscription(numberOfDays);
    }

    function validSubscription(uint256 numberOfDays, string calldata discountCode) public view {
