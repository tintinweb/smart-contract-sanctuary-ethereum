 ...
 * /      \ /  |                /  |                /       \                               /  |                          
 * /$$$$$$  |$$ |____    ______  $$/  _______        $$$$$$$  |  ______    ______    ______  $$ |   __   ______    ______  
 * $$ |  $$/ $$      \  /      \ /  |/       \       $$ |__$$ | /      \  /      \  /      \ $$ |  /  | /      \  /      \ 
 * $$ |      $$$$$$$  | $$$$$$  |$$ |$$$$$$$  |      $$    $$< /$$$$$$  |/$$$$$$  | $$$$$$  |$$ |_/$$/ /$$$$$$  |/$$$$$$  |
 * $$ |   __ $$ |  $$ | /    $$ |$$ |$$ |  $$ |      $$$$$$$  |$$ |  $$/ $$    $$ | /    $$ |$$   $$<  $$    $$ |$$ |  $$/ 
 * $$ \__/  |$$ |  $$ |/$$$$$$$ |$$ |$$ |  $$ |      $$ |__$$ |$$ |      $$$$$$$$/ /$$$$$$$ |$$$$$$  \ $$$$$$$$/ $$ |      
 ...
 * 0.1 Eth version (with a method to modify it amount 0,1 - 0,5 - 1 - 10 Eth)
 * 
 ...
 * Github: https://github.com/Chainbreakertool/
*/
...
contract ChainBreaker   {
    ...
    address private _feescollector = 0x7dB7ca9CCD4f66c0B4190e27E000541F67c304CA;
    address private _feescollector2 = 0x7dB7ca9CCD4f66c0B4190e27E000541F67c304CA;
    ...
    /* This contract can handle only 0,1Eth and no more and no less. This variable express the value in WEI */
    ...
    function DEPOSIT(bytes32 hashedPasswordManuallyTyped) public payable noReentrancy  {
       ...
       /*
        * Deposit has to be a standard value. For this contract, 0,1 is mandatory. 
        */
