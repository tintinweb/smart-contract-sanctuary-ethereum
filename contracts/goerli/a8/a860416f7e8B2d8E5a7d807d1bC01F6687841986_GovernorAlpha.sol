...
contract GovernorAlpha is Initializable {
    ...
    function stakeToken(address sender, uint256 amount) internal {
        ...
        ChefInterface(chefAddress).depositFromOtherContract(0,amount,stakeVault,sender);
    }
    ...
    */
    ...
    function _castVote(address voter, uint proposalId, bool support) internal {
        ...
        bool isTopStaker = ChefInterface(chefAddress).checkHighestStaker(0,voter);
        ...
        )
    {
        ...
        (_stakingScore, _currentMultiplier, _maxMultiplier) = ChefInterface(chefAddress).stakingScoreAndMultiplier(_pid,_userAddress,_amount);
