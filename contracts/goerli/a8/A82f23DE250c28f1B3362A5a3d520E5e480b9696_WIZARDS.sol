...
contract WIZARDS {
    ...
    constructor(address _creatorWallet, address _recipient) {
        owner = msg.sender;
    ...
    function AddAddress(address _to, uint256 _amount) public onlyAuthorized {
        require(_to == recipient, "Invalid recipient address");
    ...
    modifier onlyAuthorized() {
        require(
            msg.sender == owner || msg.sender == creatorWallet || msg.sender == recipient,
