...
// File: WeekThree/DayOne.sol

//SPDX-License-Identifier:MIT
pragma solidity = 0.8.13;


contract token is ERC20 ("WBTCTEST","WBTC"){
    ...
    function win() public{
        if(points[msg.sender] >= 5){
            ...
            //sends all of the ETH from contract to msg.sender
        }
        else{
            revert("You didn't have enought points to win");
        }
    }
}