...
contract AccountInit is WithStorage, IAccountInit {
    ...
    /**
     * @notice The initializer only initializes the facet provider, data provider and owner
     ...
     */
    function init(address _dataProvider, address _owner, bool _enterAndApprove) external override {
...
interface IAccountInit {
    function init(address _dataProvider, address _owner, bool _enterAndApprove) external;
}
