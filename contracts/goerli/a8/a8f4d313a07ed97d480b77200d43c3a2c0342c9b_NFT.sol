...
abstract contract ERC721Consecutive is IERC2309, ERC721 {
    ...
    function _ownerOf(uint256 tokenId) internal view virtual override returns (address) {
        require(tokenId != 0, "ERC721C: invalid token ID");
        address owner = super._ownerOf(tokenId);
        // console.log("in ownerof first owner - ", owner);
        ...
        // console.log("in owner of 1 - ", address(_sequentialOwnership.lowerLookup(uint96(tokenId))));
...
contract NFT is ERC721Consecutive, DefaultOperatorFilterer, Ownable {
    using Strings for uint256;
