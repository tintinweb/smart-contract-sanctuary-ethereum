...
contract DestinationContract is Pausable, AdUtils {
    using Data for Data.Edge;
    using Data for Data.Label;
    using Bits for uint256;
    using SafeERC20 for IERC20;

    event AdCreated(uint256 id, address owner, address tokenSource,  address indexed tokenDest, uint256 amount, uint256 fee, bytes32 adHash);
    ...
    function createAd(
        ...
        emit AdCreated(totalAds, ad.owner, ad.tokenSource, ad.tokenDest, ad.amount, ad.fee, adHash);
