...
// File: @openzeppelin/contracts/token/ERC721/extensio ns/ERC721Enumerable.sol
...
//////////////////////////////////////
//////////////////////////////////////
//@File  INonFungibleSeaDropToken.sol
//////////////////////////////////////
//////////////////////////////////////
...
////////////////////////
//@File ERC721SeaDropStructsErrorsAndEvents
////////////////////////
...
contract AdamLegion is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721SeaDropStructsErrorsAndEvents, INonFungibleSeaDropToken, ReentrancyGuard{
    ...
    bool public pauseOtherMint = true;
    ...
    function _numberMinted(address minter) internal view virtual returns (uint256) {
        return balanceOf(minter);
    }
    ...
    function getMintStats(address minter)
        ...
        returns (
            uint256 minterNumMinted,
            uint256 currentTotalSupply,
            uint256 maxSupplyNum
        )
    {
        minterNumMinted = _numberMinted(minter);
        currentTotalSupply = _totalMinted();
        maxSupplyNum = _maxSupply();
    }
    ...
    constructor(
        ...
        uint256 _maxSupplyNum, 
        string memory _initBaseURI
    ) 
    ERC721(_name, _symbol)
        {   
            maxSupply = _maxSupplyNum;
  ...
  // public
    function mint(uint256 _mintAmount) public payable {
        require(!pauseOtherMint, "Mint Paused");
        uint256 supply = totalSupply();
   
        require(_mintAmount > 0);
        require(_mintAmount <= maxMintAmount, "Mint amount larger than the maxMintAmount");
        require(supply + _mintAmount <= maxSupply, "Purchase would exceed max supply of robot");
    ...
    function soldCount() public view returns (uint256) {
        ...
        return totalSupply() - balanceOf(ownerAddress);
    }
