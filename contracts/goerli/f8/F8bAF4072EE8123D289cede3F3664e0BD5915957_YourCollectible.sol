...
contract YourCollectible is ERC721, Ownable, AccessControl, IMintableERC721, ERC721Enumerable {
  ...
  string private baseUri = "https://api.arcadians.io/";
  ...
  constructor() ERC721("Arcadians", "ARC") {
    // _setBaseURI("https://api.arcadians.io/");
    _tokenIds.increment();

    promoAddress = 0x1e55C85801a2C4F0beC57c84742a8eF3d72dE57B;

    mintBatch(promoAddress, 200);

    console.log("YourCollectible deployer address: ",  msg.sender);
      ...
      override(ERC721, ERC721Enumerable)
  {
    ...
    function mint(address user, uint256 tokenId) external override {
      require(hasRole(MINTER_ROLE, user), "User does not have permission to mint");
  ...
  // }
    ...
    */
    ...
    function supportsInterface(bytes4 interfaceId) public view override (AccessControl, ERC721, IERC165, ERC721Enumerable) returns (bool) {
        return AccessControl.supportsInterface(interfaceId) || ERC721.supportsInterface(interfaceId) || ERC721Enumerable.supportsInterface(interfaceId);
    }
}
