...
import {TesCol} from "contracts/lib/collateral/testcol.sol";
...
import {GemJoinT} from "contracts/lib/collateral/testcoljoin.sol";
...
contract SpotFabT {
    ...
    TesCol public tescol;
    GemJoinT public tescoljoin;

    DSValue public pipTesCol;

    function myfunc(address vat)
        public
        returns (GemJoinT tescoljoin, DSValue pipTesCol)
    {
        tescol = new TesCol();
        tescoljoin = new GemJoinT();
        pipTesCol = new DSValue();
        address pipTesColaddr = address(pipTesCol);
        address TesColJoinaddr = address(tescoljoin);
    }
}
...
contract TesCol is DSMath {
    uint256 public totalSupply;
    mapping(address => uint256) public balanceOf;
    mapping(address => mapping(address => uint256)) public allowance;
    string public symbol = "TesCol";
...
// Copyright (C) 2018 Rain <[email protected]>
// Copyright (C) 2018 Lev Livnev <[email protected]uk>
...
contract GemJoinT {
    ...
    function init(bytes32 ilk_) public {
        wards[msg.sender] = 1;
        live = 1;
        vat = VatLike(address(0x2c57C8545894acEBf25D6245Ab1151Da8af54120));
        ilk = ilk_;
        gem = GemLike(address(0x89863a35D96a364d24219933750e3a9861adc908));
        dec = gem.decimals();
        emit Rely(msg.sender);
    }
