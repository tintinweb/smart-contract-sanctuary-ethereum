...
contract WhatIsThisNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public preRevealMetadataURI = 'ipfs://QmZ5wdNNKVhxqhwoyLNFkBcQCjd3CyyEQmBspzLte84P7Z/';
    ...
    function mintPublic(uint256 _amount) external payable nonReentrant {
        ...
        require(_amount <= maxPerTXN && _amount > 0, "Max 5 per TXN.");
