...
// Stefs Version 6 - ERC721 + onchain traits
...
contract VenturePass is ERC721, Ownable, OperatorFilterer {
    bool public operatorFilteringEnabled;
    address private ApeLiquid = 0xa2ec462e0Fa83b5A33e48399E0788c2640edf0cD;
    address private TheForge = 0xd7ff9F4593C15E6778038D3bDF565413d1C7D774;
    address private metl = 0xE94201fBC6a6BCFD71a8A8A60781889DF8cB07b5;
    string private unlockedImg = "https://ipfs.io/ipfs/QmZ3SJB2oV8DxDGcAaiSGaGj7apjiawfzXj4pxFsAgJxdF";
    string private lockedImg = "https://ipfs.io/ipfs/QmQ6xLY94h5kdm5xy759Gvz9FVSFaqbvgdR3KtzPTuMgor";
    ...
    constructor() ERC721("Venture Pass", "VPASS") {
 ...
 function uint2str(uint _i) internal pure returns (string memory _uintAsString) {
    ...
    function _buildTokenURI(uint256 tokenId) internal view returns (string memory) {
        string memory json = Base64.encode(
            bytes(string(
                abi.encodePacked(
                    '{"name": "Venture Pass # ', uint2str(tokenId), '",',
                    ...
                    '"attributes": [{"trait_type": "Liquid METL", "value": "', uint2str(calculateRewards(tokenId) / 1e18), '"},',
    ...
    function mintApe(uint256 tokenId) internal {
        ...
        attributes[tokenId].image = unlockedImg;
    ...
    function lockToken(uint256 tokenId) external {
        ...
        // set image to "locked"
        attributes[tokenId].image = lockedImg;
