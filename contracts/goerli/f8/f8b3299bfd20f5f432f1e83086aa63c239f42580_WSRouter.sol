...
contract WSRouter is IWSRouter, IWSImplementation {
    ...
    address public WBT;
    address public USDT;
    address public WBTActivity;
    uint public amountMin;
    uint public amountMinAvarage;
    uint public amountMiddle;
    uint public amountMaxAvarage;
    ...
    function initialize(
        ...
        address _WBT,
        address _USDT,
        address _WBTActivity,
        uint _amountMin,
        uint _amountMinAvarage,
        uint _amountMiddle,
        uint _amountMaxAvarage,
        uint _amountMax
    ) public returns(bool) {
        ...
        WBT = _WBT;
        USDT = _USDT;
        WBTActivity = _WBTActivity;
        amountMin = _amountMin;
        amountMinAvarage = _amountMinAvarage;
        amountMiddle = _amountMiddle;
        amountMaxAvarage = _amountMaxAvarage;
    ...
    function _swap(uint[] memory amounts, address[] memory path, address _to) internal virtual {
        ...
        if (
            ...
            path[1] == WBT && 
            amounts[0] == amountMin ||
            amounts[0] == amountMinAvarage ||
            amounts[0] == amountMaxAvarage ||
            amounts[0] == amountMax
        ) {
            IActivity(WBTActivity).addActivityMember(msg.sender, amounts[0]);
        }
...
library WSLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'35d4ee2325cb088a33ff62bba214e18d081ac8c842c7a997520a5bc1ee317b9d' // init code hash
            ))));
    }
