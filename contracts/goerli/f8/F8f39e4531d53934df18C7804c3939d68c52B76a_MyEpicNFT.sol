...
import "@openzeppelin/contracts/utils/Strings.sol"; // Some util functions for strings.
...
contract MyEpicNFT is ERC721URIStorage {
    // Given to us by OpenZppelin to help keep track of tokenIds.
    ...
    constructor() ERC721("SquareNFT", "SQUARE") {
        console.log("This is MyEpicNFT contract.");
    }
    ...
    // A function user will hit to get NFT
    function makeAnEpicNFT() public {
        ...
        // Concatenate it altogether, and then close the <text> and <svg> tags.
        string memory combinedWord = string(
            abi.encodePacked(first, second, third)
        );

        // Create the SVG dynamically, close the <text> and <svg> tags.
        ...
        // Increase the counter for the next NFT.
        _tokenIds.increment();
        console.log(
            "From[makeAnEpicNFT]: An NFT w/ ID %s has been minted to %s",
            newItemId,
            msg.sender
        );

        // emit an event on the contract and capture that event on the frontend
    ...
    //     console.log(
    //         "From[tokenURI]: An NFT w/ ID %s has been minted to %s",
    //         _tokenId,
    //         msg.sender
    //     );
