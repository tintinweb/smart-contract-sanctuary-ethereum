...
import "@openzeppelin/contracts4.7.3/utils/cryptography/MerkleProof.sol";
...
contract CHARACTER_SHOP is ReentrancyGuard, Pausable, Ownable {
    ...
    function _isInAllowList(bytes32 merkleRoot, bytes32[] memory merkleProof)
        internal
        view
        returns (bool)
    {
        return MerkleProof.verify(merkleProof, merkleRoot, toBytes32(msg.sender));
    }
        ...
        minPriceDoesNotExceedLimit(_buyNowPrice, _minPrice)
    {
        ...
        nftContractAuctions[_nftContractAddress][_tokenId].allowListRoot = _allowListRoot;
    }
        ...
        increasePercentageAboveMinimum(_bidIncreasePercentage)
    {
        ...
        require(length == _tokenURIs.length, "TokenIds Length and _tokenURIs length are not matched");
    ...
    {
        bytes32 root = nftContractAuctions[_nftContractAddress][_tokenId].allowListRoot;
        require(root == bytes32(0) || _isInAllowList(root, merkleProof), "invalid merkle proof");
        _makeBid(_nftContractAddress, _tokenId);
        if (_isASale(_nftContractAddress, _tokenId)) {
            createSale(_nftContractAddress, _tokenId);
        }
    }
    ...
    function _mintNftAndTransferPayment(
        ...
        CHARACTER_V1(_nftContractAddress).mint(_tokenId, _nftRecipient, _tokenUri);
    ...
    function _payout(
        ...
        (bool success, ) = payable(_toAddress).call{
            value: _amount,
            gas: 20000
        }("");
        ...
        if (!success) {
            ...
            emit FailedPayout(_nftContractAddress, _tokenId, _toAddress, _amount);
        }
    }
    ...
    */
    function withdrawAllFailedCredits() external onlyOwner {
...
import "@openzeppelin/contracts4.7.3/token/ERC721/extensions/ERC721URIStorage.sol";
...
import "@openzeppelin/contracts4.7.3/access/Ownable.sol";
import "@openzeppelin/contracts4.7.3/token/ERC721/extensions/ERC721Burnable.sol";
