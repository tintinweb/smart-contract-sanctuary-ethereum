...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    bytes32 private constant TIER_2_MERKLE_ROOT = 0xffd880a699a2ad445dde5f7392bea391cff2b1b5a06dd3ddca8700581d070868;
    ...
    string[] private layerNames = [unicode"item", unicode"cloth", unicode"face", unicode"background"];
    bool private shouldWrapSVG = true;
    address private indelibleProContractAddress = 0xf3DAEb3772B00dFB3BBb1Ad4fB3494ea6b9Be4fE;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0xffd880a699a2ad445dde5f7392bea391cff2b1b5a06dd3ddca8700581d070868;
    ...
    ContractData public contractData = ContractData(unicode"test", unicode"test", "https://files.indelible.xyz/profile/4a20f660-bfde-418d-a276-ded08cd9e7be", "https://files.indelible.xyz/banner/4a20f660-bfde-418d-a276-ded08cd9e7be", "", 0, "0x3Be022dC290a41062e615f0f28989babe6e55A28");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"test", unicode"test") {
        tiers[0] = [133,113,103,80,60,53,44,40,38,35,34,31,26,23,22,22,22,17,17,15,13,12,9,9,9,9,4,4,3];
        tiers[1] = [238,160,140,121,78,52,50,44,30,27,24,21,9,4,2];
        tiers[2] = [193,147,141,138,130,73,67,46,23,19,17,6];
        tiers[3] = [1000];
