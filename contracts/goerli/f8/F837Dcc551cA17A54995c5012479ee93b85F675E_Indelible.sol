...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Head", unicode"Mouth", unicode"Face", unicode"Eyes", unicode"Shirt", unicode"Skin", unicode"Background"];
    ...
    constructor() ERC721A(unicode"OnChainKevinTest", unicode"DERPT") {
        tiers[0] = [14,17,20,21,25,37,55,70,83,98,112,114,120,134,152,153,311,464];
        tiers[1] = [5,9,9,124,184,188,213,370,419,479];
        tiers[2] = [6,16,25,32,42,58,59,62,86,115,117,119,217,299,312,435];
        tiers[3] = [45,94,222,229,250,370,790];
        tiers[4] = [4,14,23,25,26,32,39,89,97,98,100,101,124,149,318,761];
        tiers[5] = [191,264,1545];
        tiers[6] = [9,10,22,29,90,140,146,191,405,457,501];
