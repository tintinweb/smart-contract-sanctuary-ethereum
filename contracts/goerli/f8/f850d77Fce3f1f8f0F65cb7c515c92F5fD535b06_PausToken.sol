...
contract PausToken is ERC1155, AccessControl {
    ...
    function transfer(address _to, uint256 _id) external returns (bool) {
        require(balanceOf(msg.sender, _id) != 0, "You don't have this token");
        safeTransferFrom(msg.sender, _to, _id, 1, '0x');
        return true;
    }
