...
contract CoursePack is ERC721, AccessControl {
    ...
    mapping(Course => uint256) public eurPrices;
    ...
    constructor(
        ...
        eurPrices[Course.V1] = 23000;
        eurPrices[Course.V2] = 29000;
    }
     ...
     * @param _course Course selected
     */
    function buyInETH(Course _course, address _to) public payable {
        uint256 ethPrice = getNFTPriceInETH(_course);
        require(
    ...
    function _safeMint(address _to, Course _pack) internal virtual {
        _tokenIdCounter.increment();
        uint256 tokenId = _tokenIdCounter.current();
        super._safeMint(_to, tokenId);
        emit mintCourse(_pack, _to, tokenId);
    }
