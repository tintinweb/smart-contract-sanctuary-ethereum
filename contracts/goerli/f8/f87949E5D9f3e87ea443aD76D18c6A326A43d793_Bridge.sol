...
contract Bridge is AccessControl, IBridge {
    ...
    function decodeSwapMessage(bytes memory _payload)
        private
        pure
        returns (IAssetRouter.SwapMessage memory swapMessage)
    {
        uint16 scrPoolId;
        uint16 dstPoolId;
        address receiver;
    ...
    function decodeLiquidityMessage(bytes memory _payload)
        private
        pure
    ...
    function getReceivedSwaps(uint16 srcChain_, bytes32 id_)
        external
        view
        override
