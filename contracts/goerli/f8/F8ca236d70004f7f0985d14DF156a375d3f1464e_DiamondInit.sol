...
import {GuildStorage} from "../../guild/GuildStorage.sol";
...
contract DiamondInit {
    function init(Parameters calldata params) external {
        // Add ERC165 data
        ...
        // Guild
        GuildStorage.Layout storage gs = GuildStorage.layout();
        ...
        // Guild ID
        ERC721Storage.layout()._name = params.guildIDName;
        ERC721Storage.layout()._symbol = params.guildIDSymbol;
