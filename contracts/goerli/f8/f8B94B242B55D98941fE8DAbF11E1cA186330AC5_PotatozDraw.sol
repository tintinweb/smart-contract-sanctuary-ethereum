...
contract PotatozDraw is VRFConsumerBaseV2 {
    ...
    uint32 public randomWordsMultiplier = 2;
    ...
    function setRandomWordsMultiplier(uint32 _randomWordsMultiplier) external onlyOwner {
        randomWordsMultiplier = _randomWordsMultiplier;
    }
    ...
    function doDraw(uint32 numFinalists) external onlyOwnerOrHelper {
        ...
        s_requestId = COORDINATOR.requestRandomWords(
            ...
            callbackGasLimit,
            numFinalists * randomWordsMultiplier
        );
    }
