...
contract StakedNotablesPassport is ERC721, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string private _baseTokenURI = "";

    constructor (address stakingContract) ERC721("sNOTABLES", "sNOTABLES") {
    ...
    function _beforeTokenTransfer(
        ...
        require(from == address(0) || to == address(0), "Staked NOTABLES can not be transferred!");
    }
}
