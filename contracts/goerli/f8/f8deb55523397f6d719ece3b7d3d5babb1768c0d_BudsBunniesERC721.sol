...
contract BudsBunniesERC721 is ERC721A, Ownable {
  ...
  uint256 public constant MAX_TOKENS = 2420;
  uint256 public constant MAX_TEAM_TOKENS = 69;
  ...
  constructor(address _signer) ERC721A("Buds Bunnies Club", "BUDS") {
    signer = _signer;
  }
