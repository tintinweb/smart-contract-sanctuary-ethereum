/**
 * Make registry as rolecheckable
 * Set token factory
 * Add vault
 */
...
contract Registry is Initializable, AccessControlUpgradeable, IRegistry {
    ...
    bytes32 public constant FUTURE_MANAGER_ROLE =
        keccak256("FUTURE_MANAGER_ROLE");
     ...
     */
    function setTokensFactory(address _newTokenFactory)
        public
        override
        onlyRole(ADMIN_ROLE)
    {
     ...
     */
    function getTokensFactoryAddress() public view override returns (address) {
     ...
     */
    function addFutureVault(address _future)
        external
        override
        onlyRole(FUTURE_MANAGER_ROLE)
    {
     ...
     */
    function removeFutureVault(address _future)
        external
        override
        onlyRole(FUTURE_MANAGER_ROLE)
    {
     ...
     */
    function getFutureVaultAt(uint256 _index)
        external
        view
        override
        returns (address)
