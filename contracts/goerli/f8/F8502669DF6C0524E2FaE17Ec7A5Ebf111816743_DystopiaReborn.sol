...
// @author: https://twitter.com/sandgine1
...
contract DystopiaReborn is ERC721, Ownable {

    using Strings for uint;
    using Counters for Counters.Counter;

    // URI
    string public bronzeURI = ""; // TODO
    string public silverURI = ""; // TODO
    string public goldURI = ""; // TODO

    uint32 saleStartTime;

    // PRICE
    uint256 public BRONZE_PRICE = 0.000025 ether; // TODO
    uint256 public SILVER_PRICE = 0.00004 ether; // TODO
    uint256 public GOLD_PRICE = 0.00005 ether; // TODO
    ...
    constructor() ERC721("Dystopia Reborn", "DR") { // TODO
        // Set sale start time
        saleStartTime = 1634318892; // TODO https://www.timestamp.fr/
    ...
    **/
    function tokenURI(uint256  _tokenId) public view virtual override returns (string memory) {
        ...
        if(_tokenId <= 200) return string(abi.encodePacked(bronzeURI, _tokenId.toString(), ".json"));
        if(_tokenId <= 275) return string(abi.encodePacked(silverURI, _tokenId.toString(), ".json"));
        if(_tokenId <= 325) return string(abi.encodePacked(goldURI, _tokenId.toString(), ".json"));
