...
contract NadirOracle is ChainlinkClient, ConfirmedOwner {
     ...
     */
    function requestAccumulatedLiquidations(string memory _symbol, string memory _priceDescendant) public {
    ...
    function fulfillMultipleParameters(
        ...
        emit RequestAccumulatedLiquidations(requestId, btcResponse, usdResponse, eurResponse);
        accumulatedLiquidations = btcResponse;
        unit = usdResponse;
        slippage = eurResponse;
    }
