...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract TestnettesteThree is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;


  string private uriPrefix;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://replace";
  ...
  uint8 public maxMintAmountPerTx = 7;
  ...
  constructor() ERC721A("TestnetTestttttttt", "Test") {
  }
