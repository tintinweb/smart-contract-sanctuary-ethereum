...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xe20EC33028f6356727E8b506cbe40f59ED505365];
  address public erc20Payable = 0xe20EC33028f6356727E8b506cbe40f59ED505365;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 243) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifj34rcmrw6hh4ioijaojrbjifsnky77d4pj3nowu5bqdinhmd4vi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/uEZpRR2tLdSisaeyYEIm/contract-metadata";
  }
...
// File: contracts/CanadasWonderlandbyLsdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CanadasWonderlandbyLsdContract is RamppERC721A {
    constructor() RamppERC721A("Canadas Wonderland by LSD", "WonderLSD"){}
}
