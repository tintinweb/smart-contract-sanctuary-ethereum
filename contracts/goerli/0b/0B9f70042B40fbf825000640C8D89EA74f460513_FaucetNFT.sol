...
contract FaucetNFT is ERC721A, Ownable, ReentrancyGuard  {
    ...
    uint256 public immutable maxMintSupply = 200;
    ...
    constructor(string memory contractName, string memory ticker, string memory _baseURI) ERC721A(contractName, ticker) {
        baseURI = _baseURI;
    }
