...
contract ExchangeNft is ERC721URIStorage, ERC721Enumerable, Ownable{
    ...
    // コンストラクトが作られた時にconstructorは一度だけ実行される
    constructor() ERC721("ExchangeNft", "EXNFT") {}


    /**
     * @dev
     * - 誰にtokenIdの何番か、どんなURIでNFTをmintしたかをログのように記録する
     */
    event TokenURIChanged(address indexed to, uint256 indexed tokenId, string uri);

    /**
     * @dev
     * - NFTをMintするための関数　全体の何番目かを取得し、それをtokenIdにしている
     */
