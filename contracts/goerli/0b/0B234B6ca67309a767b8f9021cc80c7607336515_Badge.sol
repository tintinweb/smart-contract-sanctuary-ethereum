...
import {IERC165} from "openzeppelin-solidity/contracts/interfaces/IERC2981.sol";
import "openzeppelin-solidity/contracts/utils/cryptography/ECDSA.sol";

contract Badge is ERC721, Ownable, ReentrancyGuard {
    ...
    function mintBadge(
        ...
        //require(_validateData(msg.sender, signature));
    ...
    function _beforeTokenTransfer(
        ...
        require(from == address(0), "ERC721: transfer disabled");
