...
contract RunnerRegistry is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    /// @notice Check whether an address is runner or not.
    ...
    /// @notice Used to bond as a runner
    ...
    /// @notice Used to unbond as a runner and get the bonded tokens back.
    ...
    ///@notice Used to slash runners if they do a bad/malicious job.
    ...
    function slash(address _runner, uint256 _amount) external {
        require(keeperRegistry.isKeeper(msg.sender), "Only keeper can slash");
    ...
    ///@notice Used to withdraw the tokens that were slashed from runners doing a bad/malicious job.
