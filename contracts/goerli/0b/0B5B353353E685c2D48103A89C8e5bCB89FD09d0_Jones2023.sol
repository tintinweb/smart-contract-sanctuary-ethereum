...
contract Jones2023 is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xFaa4533ce5BB9c10cd9ECED5CC2a09C61BFE737B);
    address payable private _marketingAddress = payable(0xFaa4533ce5BB9c10cd9ECED5CC2a09C61BFE737B);
