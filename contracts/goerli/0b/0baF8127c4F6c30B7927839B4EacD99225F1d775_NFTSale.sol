...
contract NFTSale {
    ...
    function isFeePercentagesLessThanMaximum(uint32[] memory _feePercentages) 
    ...
    function correctFeeRecipientsAndPercentages(
        uint256 _recipientsLength,
        uint256 _percentagesLength
    ) internal view returns (bool) {
        return( _recipientsLength == _percentagesLength);
    }
    ...
    function _transferNftAndPaySeller(
        ...
        require(
            ...
            "Percentage sum more than 10000"
            );
        require( 
