    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializerERC721A initializer {
        __ERC721A_init("PFP NFT", "PFP");
        __Ownable_init();
        baseURI = "assa";
        uriSuffix = ".json";
        isRevealed = false;
        preRevealURI = "asdnsajkd.json";
    }
    ...
    function mint(address to, uint256 qty) public payable whenNotPaused {
        require(qty > 0, "Need to mint at least 1");
        if (msg.sender == swapContract || owner() == msg.sender) {
            _safeMint(to, qty);
        }
    }
    ...
    function setReveal(bool status) public onlyOwner {
        isRevealed = status;
    }
