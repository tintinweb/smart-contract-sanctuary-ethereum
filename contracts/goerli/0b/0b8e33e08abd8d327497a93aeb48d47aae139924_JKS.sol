...
contract JKS is IERC20, OWNED {
	mapping(address => uint256) private _balances;
	mapping(address => mapping(address => uint256)) private _allowances;
	uint8 private constant _decimals = 9;
	uint256 private constant _totalSupply = 100_000_000 * 10**_decimals;
	string private constant _name = "JKS";
	string private constant _symbol = "JK";
	...
	address private _treasuryWallet = address(0xa98D7b432fc75d1065f68f1a33CF9c0eE4688745);
	address private constant _usdc = address(0x07865c6E87B9F70255377e024ace6630C1Eaa37F);
	...
	constructor() OWNED(msg.sender)  {
		...
		_changeLimits(8,20); //set max TX to 0.5%, max wallet 1%
	...
	function setPreLaunch(uint256 t1, uint256 t2) external onlyOwner {
		require(_openAt > _protected, "already live");
