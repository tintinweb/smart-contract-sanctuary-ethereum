...
contract Nanoz is Ownable, ERC721A, PaymentSplitter, CantBeEvil {
    ...
    function supportsInterface(bytes4 interfaceId) public view override(ERC721A, CantBeEvil) returns (bool) {
