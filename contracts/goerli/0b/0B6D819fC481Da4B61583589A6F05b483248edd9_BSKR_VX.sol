...
contract BSKR_VX is BaseBSKR {
     ...
     */
    function _airdropTransfer(Airdrop[] calldata receivers) internal override {
    ...
    Manageable
{
    ...
    function _airdropTransfer(Airdrop[] calldata receivers) internal virtual;
