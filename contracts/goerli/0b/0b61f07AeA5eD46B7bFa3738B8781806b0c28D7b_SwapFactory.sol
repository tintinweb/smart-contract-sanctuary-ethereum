...
abstract contract BaseSwap is Ownable, ISwap, Pausable {
    ...
    function updateBuySpotDifference(uint _newDifference) external onlyComdexAdmin{
        dexSettings.buySpotDifference = _newDifference;
        emit BuySpotDifferenceUpdated(_newDifference);
    }
    
    function updateSellSpotDifference(uint _newDifference) external onlyComdexAdmin{
