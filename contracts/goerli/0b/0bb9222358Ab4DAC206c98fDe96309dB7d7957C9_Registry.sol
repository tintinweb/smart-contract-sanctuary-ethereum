 ...
 */
contract Registry is AccessControlEnumerable, Allowlist, Blocklist, IRegistry {
    constructor() {
     ...
     */
    function isAllowedOperator(address operator)
        external
        view
        virtual
        returns (bool)
     ...
     */
    function setIsAllowlistDisabled(bool disabled)
        external
        virtual
     ...
     */
    function setIsBlocklistDisabled(bool disabled)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     */
    function addAllowedContractAddress(address contractAddress)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     * @param contractAddress Address of allowed operator
     */
    function removeAllowedContractAddress(address contractAddress)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     */
    function addAllowedCodeHash(bytes32 codeHash)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     * @param codeHash Code hash of allowed contract
     */
    function removeAllowedCodeHash(bytes32 codeHash)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     */
    function addBlockedContractAddress(address contractAddress)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     * @param contractAddress Address of blocked operator
     */
    function removeBlockedContractAddress(address contractAddress)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     */
    function addBlockedCodeHash(bytes32 codeHash)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     * @param codeHash Code hash of blocked contract
     */
    function removeBlockedCodeHash(bytes32 codeHash)
        external
        virtual
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
...
contract Allowlist is IAllowlist {
     ...
     */
    function _setIsAllowlistDisabled(bool disabled) internal virtual {
     ...
     */
    function _addAllowedContractAddress(address contractAddress)
        internal
        virtual
    {
     ...
     * @param contractAddress - Contract address
     */
    function _isAllowedContractAddress(address contractAddress)
        internal
        view
        virtual
        returns (bool)
     ...
     * @param contractAddress - Contract address
     */
    function isAllowedContractAddress(address contractAddress)
        external
        view
        virtual
        returns (bool)
     ...
     * @param contractAddress - Contract address
     */
    function _removeAllowedContractAddress(address contractAddress)
        internal
        virtual
    {
     ...
     */
    function _isAllowedCodeHash(bytes32 codeHash)
        internal
        view
        virtual
        returns (bool)
     ...
     * @param contractAddress - Contract address
     */
    function isAllowedCodeHash(address contractAddress)
        external
        view
        virtual
        returns (bool)
...
contract Blocklist is IBlocklist {
     ...
     */
    function _setIsBlocklistDisabled(bool disabled) internal virtual {
     ...
     */
    function isBlockedContractAddress(address operator)
        external
        view
        returns (bool)
    {
     ...
     * @param operator - Contract address
     */
    function _isBlockedContractAddress(address operator)
        internal
        view
        returns (bool)
    {
     ...
     * @param contractAddress - Contract address
     */
    function isBlockedCodeHash(address contractAddress)
        external
        view
        returns (bool)
    {
     ...
     * @param contractAddress - Contract address
     */
    function _addBlockedContractAddress(address contractAddress)
        internal
        virtual
    {
     ...
     * @param contractAddress - Contract address
     */
    function _removeBlockedContractAddress(address contractAddress)
        internal
        virtual
    {
...
interface IAllowlist {
     ...
     */
    function isAllowedContractAddress(address operator)
        external
        view
        returns (bool);
