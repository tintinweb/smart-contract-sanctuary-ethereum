...
/**
 * @author Created with Hey Mint Launchpad https://launchpad.heymint.xyz
 * @notice This contract handles minting New deployment flow test tokens.
 */
contract NewDeploymentFlowTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0x85591f07918069566ED1210b39a5fAb6bFb5dBeC;
    address[] public payoutAddresses = [
        0x85591f07918069566ED1210b39a5fAb6bFb5dBeC
    ];
    bool public isPublicSaleActive = false;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeidzenj7ct6m3h2w5posttltn4ozghprobq7zktbiqavfy4epuloj4";
    ...
    constructor() ERC721A("New deployment flow test", "NDFT") {
