...
contract Kingship is ERC721A, Ownable, ReentrancyGuard, Pausable, ERC2981 {
    ...
    uint256[] public priceList = [
        0.001 ether, // ApeCoin price in ETH
        0.001 ether, // Allowlist wave 1 price
        0.001 ether, // Allowlist wave 2 price
        0.001 ether, // Allowlist wave 3 price
        0.001 ether // Public Sale price
    ];
    ...
    uint256 public mintsAllowedPerAddress = 10;
