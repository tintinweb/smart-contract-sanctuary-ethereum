...
contract CollectionManager {
    ...
    // Add NFT Collection Name to collectionnameexists
    function add(string memory _nftcontractname, address _addr) public {
        collectionnameexists[_nftcontractname] = true;
        nftcollectionsbyname[_nftcontractname] = NFTCollection(_addr);
    }
}