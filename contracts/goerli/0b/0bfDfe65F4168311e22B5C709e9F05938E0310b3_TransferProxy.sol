//@title TransferProxy is used for communicating with RAJNFT721, RAJNFT1155, tokens(WETH, WBNB, WMATIC,...).
...
contract TransferProxy is AccessControl, ITransferProxy {
    ...
    //@notice the function transfers RAJNFT721 NFTs to users.
    //@param token, RAJNFT721 address @dev see {IERC721}.
    ...
    //@notice the function transfers RAJNFT721 NFTs to users.
    //@param token, RAJNFT1155 @dev see {IERC1155}.
    //@param from, seller address, NFTs to be transferrred from this address.
    //@param to, buyer address, NFTs to be received to this address.
    //@param tokenId, unique NFT id to be transfer.
    ...
    //@notice function used for RAJNFT1155Lazymint, it does NFT minting and NFT transfer.
    //@param nftAddress, RAJNFT1155 @dev see {IERC1155}.
    ...
    //@notice function used for RAJNFT721Lazymint, it does NFT minting and NFT transfer.
    //@param nftAddress, RAJNFT721 address @dev see {IERC721}.
    //@param from, NFT to be minted on this address.
    //@param to, NFT to be transffered from address to this address.
    //@param _tokenURI, IPFS URI of NFT to be Minted.
    //@param _royaltyFee, fee permiles for secondary sale.
...
//@title ITransferProxy is used for communicating with RAJNFT721, RAJNFT1155, tokens(WETH, WBNB, WMATIC,...).
//@notice the interface used for transferring NFTs from sender wallet address to receiver wallet address.
//@notice andalso transfers the assetFee, royaltyFee, platform fee from users.
...
//@title ILazyMint interface used for communicating with RAJNFT721, RAJNFT1155.
//@dev see{RAJNFT721, RAJNFT1155}.
