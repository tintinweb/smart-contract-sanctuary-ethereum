...
//        emit Transfer(address(0), to, tokenId);
    ...
    function _mintRandom(address to, uint _quantity) internal virtual returns (uint256[] memory) {
        require(to != address(0), "0");
        ...
        for (uint256 i = 0; i < _quantity; i++) { // Do this ++ unchecked?
            ...
            require(updatedNumAvailableTokens > 0, "unat0_miwbu"); // delete this eventually
...
//    uint256 public phunkClaimsMade;
...
//            numMintedRegular += _quantity;
            require(_quantity >= _numFree, "q<nf_mm"); // delete this eventually
