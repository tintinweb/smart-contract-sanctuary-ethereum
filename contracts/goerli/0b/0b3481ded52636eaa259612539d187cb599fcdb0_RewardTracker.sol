...
contract RewardTracker is ERC4626, AccessControl, ReentrancyGuard {
	...
	uint64 _DURATION,
	address owner
    ) ERC4626(_stakeToken, _name, _symbol) {
    ...
    function deposit(uint256 assets, address receiver) public override updateReward returns (uint256 shares) {
	shares = super.deposit(assets, receiver);
    }
    
    function mint(uint256 assets, address receiver) public override updateReward returns (uint256 shares) {
	shares = super.deposit(assets, receiver);
    }

    function afterDeposit(uint256, uint256) internal override {}
    function beforeWithdraw(uint256, uint256) internal updateReward override {}

    function claimRewards(address _receiver) external updateReward nonReentrant returns (uint256 reward) {
