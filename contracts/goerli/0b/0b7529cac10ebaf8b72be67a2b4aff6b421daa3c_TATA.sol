...
contract TATA is Context, IERC20, Ownable {
    ...
    string private constant _name = "TATA";
    string private constant _symbol = "TATA";
    ...
    address payable private _developmentAddress = payable(0x947B4BA4b8B5C6094eeD22f2fBA2bd8521FE7773); 
    address payable private _marketingAddress = payable(0x947B4BA4b8B5C6094eeD22f2fBA2bd8521FE7773);
