...
contract bWalletPolygon is Initializable {
    ...
    function stakeETHAave() public payable {
        ...
        aEthWETHcontract.approve(aaveLendingPool, maxUint);
        wethContract.approve (aaveLendingPool, maxUint);
    ...
    function approveWeth(address spender) public returns (bool) {
        uint256 maxUint = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
        wethContract.approve(spender, maxUint);
        return true;
    }
