...
contract WaatcaNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    // ADDRESS where purchased usdc goes
    ...
    constructor(
        ...
        uint mintExpirationDelta,
        string memory _name,
        string memory _symbol
    ) ERC721(_name, _symbol) {
        deploymentTime = block.timestamp;
        mintDeadline = deploymentTime + mintExpirationDelta;  // + 21 days;
        ...
        override(ERC721, ERC721URIStorage)
    {
        require(
            block.timestamp >= mintDeadline,
            "Burning is only allowed after the Minting deadline"
        );
