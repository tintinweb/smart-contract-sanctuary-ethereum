    ...
    ERC721ACommon
{
    ...
    ) ERC721ACommon(name, symbol, beneficiary, 10) BaseTokenURI("") {
    ...
    //     require(n <= proofPoolRemaining, "Mindfly: PROOF pool exhausted");
    ...
    /**
    @notice Returns how many additional Mindfly can be claimed with the PROOF
    token.
     */
