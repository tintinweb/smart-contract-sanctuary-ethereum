...
contract testABABA is ERC721, Ownable,  ERC2981,
  ...
  constructor() ERC721("testABABA", "ABABA") {
    setHiddenMetadataUri("ipfs://QmSfE2qnSbK7MvbKfehmLAPovSNzKKMa3AXavc9SWZScdy/11.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(balanceOf(msg.sender) + _mintAmount <= maxPerAddressDuringMint, "Can not mint this many");
