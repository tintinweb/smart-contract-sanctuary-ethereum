...
contract optimismChainImplementer is AccessControlEnumerable, L2ChainImplementerBase {
    ...
    function setL2Recipient(address _l2Recipient) external onlyRole(CONTRACT_ADMIN) {
        require(l2Recipient == address(0x0), "FxBaseRootTunnel: CHILD_TUNNEL_ALREADY_SET");
    ...
    function createCommunity(
        ...
        require(l2Recipient != address(0),"fxChildTunnel not set");

        ovmL1CrossDomainMessenger.sendMessage(
            l2Recipient, 
            abi.encodeWithSignature(
                "crossCreateCommunity(uint32,address,string)",
                community_id,
                community_admin,
                community_name
            ),
