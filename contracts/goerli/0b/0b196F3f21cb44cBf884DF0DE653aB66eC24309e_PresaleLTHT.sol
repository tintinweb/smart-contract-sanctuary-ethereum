...
$$ |                                         \__$$  __|        $$ |                                  $$ |  $$ |           $$ |                    \__$$  __|        $$ |              
$$ |      $$$$$$\ $$\    $$\  $$$$$$\           $$ | $$$$$$\ $$$$$$\    $$$$$$\                      $$ |  $$ | $$$$$$\ $$$$$$\    $$$$$$\           $$ | $$$$$$\ $$$$$$\    $$$$$$\  
$$ |     $$  __$$\\$$\  $$  |$$  __$$\          $$ | \____$$\\_$$  _|  $$  __$$\       $$$$$$\       $$$$$$$$ | \____$$\\_$$  _|  $$  __$$\          $$ | \____$$\\_$$  _|  $$  __$$\ 
$$ |     $$ /  $$ |\$$\$$  / $$$$$$$$ |         $$ | $$$$$$$ | $$ |    $$$$$$$$ |      \______|      $$  __$$ | $$$$$$$ | $$ |    $$$$$$$$ |         $$ | $$$$$$$ | $$ |    $$$$$$$$ |
$$ |     $$ |  $$ | \$$$  /  $$   ____|         $$ |$$  __$$ | $$ |$$\ $$   ____|                    $$ |  $$ |$$  __$$ | $$ |$$\ $$   ____|         $$ |$$  __$$ | $$ |$$\ $$   ____|
$$$$$$$$\\$$$$$$  |  \$  /   \$$$$$$$\          $$ |\$$$$$$$ | \$$$$  |\$$$$$$$\                     $$ |  $$ |\$$$$$$$ | \$$$$  |\$$$$$$$\          $$ |\$$$$$$$ | \$$$$  |\$$$$$$$\ 
\________|\______/    \_/     \_______|         \__| \_______|  \____/  \_______|                    \__|  \__| \_______|  \____/  \_______|         \__| \_______|  \____/  \_______|                                                                                                                                                                                  
  */                                                                                                                                                                                    
    ...
    PausableUpgradeable
{
    ...
    mapping(address => uint256) public userDepositsLove;
    mapping(address => uint256) public userDepositsHate;
    mapping(address => bool) public hasClaimed;
    uint256 public totalTokenSoldLove;
    uint256 public totalTokenSoldHate;
    uint256 public usdRaisedLove;
    uint256 public usdRaisedHate;
    ...
    //  * @param _rounds uint256[][2] details abount number of rounds,
    //  * @param _maxTokensToBuy max amount of tokens user can buy in one transaction
    //  */
    function initialize(
        address _oracle,
        address _usdt,
    ...
    function buyWithUSDT(
        ...
        if (_type == 0) {
            usdRaisedLove += usdPrice;
            totalTokenSoldLove += amount;
            userDepositsLove[_msgSender()] += (amount * baseDecimals);
        }
        if (_type == 1) {
            usdRaisedHate += usdPrice;
            totalTokenSoldHate += amount;
            userDepositsHate[_msgSender()] += (amount * baseDecimals);
        }
    ...
    function claim() external whenNotPaused returns (bool) {
        ...
        uint256 amount = userDepositsLove[_msgSender()] +
            userDepositsLove[_msgSender()];
        require(amount > 0, "Nothing to claim");
        delete userDepositsLove[_msgSender()];
        delete userDepositsHate[_msgSender()];
        ...
        returns (bool)
    {
        ...
        if (_type == 0) {
            usdRaisedLove += usdPrice;
            totalTokenSoldLove += amount;
            userDepositsLove[user] += (amount * baseDecimals);
        }
        if (_type == 1) {
            usdRaisedHate += usdPrice;
            totalTokenSoldHate += amount;
            userDepositsHate[user] += (amount * baseDecimals);
        }
    ...
    /**
     * @dev To change max tokens to buy.
     * @param _maxTokensToBuy No of tokens
     */
    ...
    /**
     * @dev To change rounds data.
     * @param _rounds array of no. of tokens to be sold and respective price
     */
