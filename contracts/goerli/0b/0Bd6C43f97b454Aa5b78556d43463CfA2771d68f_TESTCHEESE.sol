...
contract TESTCHEESE is ERC721, Ownable {
    ...
    uint256 private constant presalePrice = 1 ether;
    uint256 private constant reservedAmount = 50;
    uint256 private constant maxMintsPerAddressPresale = 1;
    uint256 private constant maxMintsPerAddressSale = 10;
    uint256 public reservedMintedAlready;

    uint256 public constant presaleStartDate = 1642885200;
    uint256 public constant saleStartDate = 1642971600;

    string private baseUri = 'https://www.tasdasdasdsadsd.asd/';
    ...
    function mintReserved(address receiver, uint256 amount) external onlyOwner {
        ...
        require(
            reservedMintedAlready + amount <= reservedAmount,
            'Reserved Max reached'
        );
    ...
    function mintWhitelist(bytes32[] calldata proof) external payable onlyEOA {
        ...
        require(
            mintedTokensByAddress[msg.sender] + 1 <= maxMintsPerAddressPresale,
            'Already minted'
        );
