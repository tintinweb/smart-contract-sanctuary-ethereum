...
contract DeathClock is EIP712, ERC721r, Whitelist, Ownable, ReentrancyGuard {
    ...
    function setMerkleRoot(uint256 merkleRootIndex, bytes32 merkleRoot)
        external
        onlyOwner
    {
    ...
    function setWebAppUrl(string memory _WEB_APP_URL) external onlyOwner {
        _descriptor.setWebAppUrl(_WEB_APP_URL);
    }

    function setPreviewsUrl(string memory _WEB_PREVIEW_URL) external onlyOwner {
        _descriptor.setPreviewsUrl(_WEB_PREVIEW_URL);
    }
...
interface IDeathClockDescriptor {
    ...
    function setWebAppUrl(string memory _WEBAPP_URL) external;

    function setPreviewsUrl(string memory _PREVIEW_URL) external;
