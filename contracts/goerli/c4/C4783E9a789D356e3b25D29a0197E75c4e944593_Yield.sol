...
contract Yield is Ownable, ReentrancyGuard {
    ...
    constructor() {
        ratesGdc[0] = 5 * 1e18;        // 10 $LASM daily for standard rarity
        ratesGdc[1] = 8 * 1e18;        // 20 $LASM daily for rare rarity
        ratesGdc[2] = 15 * 1e18;        // 40 $LASM dailf for super rare rarity
    }
