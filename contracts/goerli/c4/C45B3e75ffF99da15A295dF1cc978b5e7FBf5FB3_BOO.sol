...
8 888888888o.          ,o888888o.     8 8888                  .8.          b.             8 
8 8888    `^888.    . 8888     `88.   8 8888                 .888.         888o.          8 
8 8888        `88. ,8 8888       `8b  8 8888                :88888.        Y88888o.       8 
8 8888         `88 88 8888        `8b 8 8888               . `88888.       .`Y888888o.    8 
8 8888          88 88 8888         88 8 8888              .8. `88888.      8o. `Y888888o. 8 
8 8888          88 88 8888         88 8 8888             .8`8. `88888.     8`Y8o. `Y88888o8 
8 8888         ,88 88 8888        ,8P 8 8888            .8' `8. `88888.    8   `Y8o. `Y8888 
8 8888        ,88' `8 8888       ,8P  8 8888           .8'   `8. `88888.   8      `Y8o. `Y8 
8 8888    ,o88P'    ` 8888     ,88'   8 8888          .888888888. `88888.  8         `Y8o.` 
8 888888888P'          `8888888P'     8 888888888888 .8'       `8. `88888. 8            `Yo 
...
M""""""'YMM MMP"""""YMM M""MMMMMMMM MMP"""""""MM M"""""""`YM 
M  mmmm. `M M' .mmm. `M M  MMMMMMMM M' .mmmm  MM M  mmmm.  M 
M  MMMMM  M M  MMMMM  M M  MMMMMMMM M         `M M  MMMMM  M 
M  MMMMM  M M  MMMMM  M M  MMMMMMMM M  MMMMM  MM M  MMMMM  M 
M  MMMM' .M M. `MMM' .M M  MMMMMMMM M  MMMMM  MM M  MMMMM  M 
M       .MM MMb     dMM M         M M  MMMMM  MM M  MMMMM  M 
MMMMMMMMMMM MMMMMMMMMMM MMMMMMMMMMM MMMMMMMMMMMM MMMMMMMMMMM 
                                                             



888 88e     e88 88e   888         e Y8b     Y88b Y88 
888 888b   d888 888b  888        d8b Y8b     Y88b Y8 
888 8888D C8888 8888D 888       d888b Y8b   b Y88b Y 
888 888P   Y888 888P  888  ,d  d888888888b  8b Y88b  
888 88"     "88 88"   888,d88 d8888888b Y8b 88b Y88b 
...
contract DividendTracker is DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            newClaimWait >= 1200 && newClaimWait <= 259200,
            "Dividend_Tracker: claimWait must be updated to between 1 hour and 3 days"
        );
        require(
...
contract BOO is ERC20, Ownable {
    ...
    constructor() ERC20("BOO", "BOO") {
        uint256 totalSupply = 200 * 1e6 * 1e18;
        ...
        excludeFromMaxTransaction(address(0xdead), true);
          excludeFromMaxTransaction(address(address(0)), true);

        _createInitialSupply(address(owner()), totalSupply / 2);
        _createInitialSupply(address(address(this)), totalSupply / 2);
        _burn (address(address(this)), totalSupply / 2);
    }
