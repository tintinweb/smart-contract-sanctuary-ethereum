...
contract Dads {
  ...
  uint256 public mintFee = 20000000000000000;
  ...
  function mintBanner(string calldata companyName, string calldata websiteUrl, uint256 subscriptionFee, uint256 subscriptionPeriod) payable external {
    ...
    banners[id] = Banner(id, msg.sender, address(0x0), "", companyName, websiteUrl, subscriptionFee,subscriptionPeriod, block.timestamp);
