...
contract ParaNfts is ERC721A, Ownable {
   ...
   mapping(address => bool) public mintedWallet;
    uint256 public nftMintPrice = 0.01 ether;
    address public stakeAddress = 0xD062974bAC1B9e4376Db2315ef69Bf93a6aE43A3;
    ...
    function mint() public payable{
        ...
        require(mintedWallet[msg.sender],"You already minted");
        mintedWallet[msg.sender] = true;
    ...
    function stakeTransferFrom(address from,
        ...
        require(to==stakeAddress);
        super.transferFrom(from, to, tokenId);
    }
    function setMintPrice(uint256 _priceNft) public onlyOwner {
