...
contract SecurityOracle {
    ...
    // Internal incase others acquire the data
    //public now for testing
    mapping(address => bool) public _blacklist;
    mapping(address => uint) public timeElapse;
    ...
    function startCounter(address addr) external{
        timeElapse[addr] = block.number;
    }

    function isBlacklisted(address addr) external view returns(bool) {
        require(block.number > timeElapse[addr] + interval, "Not finish Analyzing Yet!");
