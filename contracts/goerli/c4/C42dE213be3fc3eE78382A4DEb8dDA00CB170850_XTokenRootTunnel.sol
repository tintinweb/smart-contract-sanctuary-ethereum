...
import {FxERC20, IFxERC20} from "@maticnetwork/fx-portal/contracts/tokens/FxERC20.sol";
...
import {SafeMath} from "@maticnetwork/fx-portal/contracts/lib/SafeMath.sol";
import {SafeERC20, IERC20} from "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";

address constant GOERLI_CP_MANAGER = 0x2890bA17EfE978480615e330ecB65333b880928e;
address constant GOERLI_FX_ROOT = 0x3d1d3E34f7fB6D26245E6640E1c50710eFFf15bA;

contract XTokenRootTunnel is FxBaseRootTunnel, Create2 {
    ...
    bytes32 childTokenTemplateCodeHash;
    mapping(address => address) public rootToChildTokens;


    constructor(address _XTOKEN) FxBaseRootTunnel(GOERLI_CP_MANAGER, GOERLI_FX_ROOT) {
        childTokenTemplateCodeHash = keccak256(minimalProxyCreationCode(_XTOKEN));
    }
