 ...
 * @notice This contract handles minting Espresso Morning by gray tokens.
 */
contract EspressoMorningByGray is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address public royaltyAddress = 0xDa4Ff807954bB130D794c90a675B8972D88f4091;
    ...
    string public baseTokenURI =
        "ipfs://bafybeie4wrfxoshplrtxyeff2oxwtm2ofi3myexjk5ruf5ejrcc5gz72xu/";
    ...
    uint256 public publicMintsAllowedPerTransaction = 12;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Espresso Morning by gray", "EM")
        RevokableOperatorFilterer(
