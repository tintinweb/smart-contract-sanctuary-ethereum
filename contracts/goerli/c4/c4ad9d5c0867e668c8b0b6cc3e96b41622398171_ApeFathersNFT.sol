...
/**
 * @author gsknnft.eth
 * @notice This contract handles minting The ApeFathers NFT tokens.
 */
contract ApeFathersNFT is ERC721A, ERC721AQueryable, ERC4907A, Ownable, Pausable, ReentrancyGuard, ERC2981 {
    ...
    address[] public payoutAddresses = [
        0x12a20728E6afafBf494efE9073952A27866116c5,
    ...
    // The respective share of funds to be sent
    ...
    /**
     * @dev directly approve a token for transfers by the current msg.sender
     */
    ...
    /**
     * @notice Change the address where royalties are sent
     */
    ...
    /**
     * @notice Allow owner to send 'mintNumber' tokens without cost
     */
    ...
    /**
     * @notice Allow contract owner to forcibly unstake a token
     */
    ...
    /**
     * @notice Return amount of time a token has been staked
     */
    ...
    /**
     * @notice Owner to allow burning to claim a token
     */
