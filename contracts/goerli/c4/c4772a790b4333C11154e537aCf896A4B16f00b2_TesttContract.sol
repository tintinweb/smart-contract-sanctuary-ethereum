...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5e9451aFb6344df726B5436b70545Fc6F15f49b1];
  address public erc20Payable = 0x5e9451aFb6344df726B5436b70545Fc6F15f49b1;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihfx5ls3xav3c37lo73mrqjhfwmhyshkl6znq5ulgc3y7yymiy5g4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/QWryuQ2md8ZO6JvEH56a/contract-metadata";
  }
...
// File: contracts/TesttContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TesttContract is RamppERC721A {
    constructor() RamppERC721A("testt", "test"){}
}
