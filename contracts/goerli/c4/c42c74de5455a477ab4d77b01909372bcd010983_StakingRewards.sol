...
contract StakingRewards is Initializable {
  ...
  /// @notice Flag for the BAL_REWARD_POOL
  ...
  event DepositTokenAndBalRewardPoolConfigured(address indexed _depositToken, address indexed _balRewardPool, bool _useBalRewardPool);
   ...
   * @param _useBalRewardPool flag for the bal reward pool
   */ 
  function configDepositTokenAndBalRewardPool(
    ...
    emit DepositTokenAndBalRewardPoolConfigured(_depositToken, _balRewardPool, _useBalRewardPool);
  }
  ...
  function claimBALRewards() public {
    require(USE_BAL_REWARD_POOL, 'USE_BAL_REWARD_POOL_SHOULD_BE_TRUE');
    require(BAL_REWARD_POOL != address(0), 'INVALID_BAL_REWARD_POOL');
