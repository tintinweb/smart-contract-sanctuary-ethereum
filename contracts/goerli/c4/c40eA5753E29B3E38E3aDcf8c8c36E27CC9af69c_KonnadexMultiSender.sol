...
contract KonnadexMultiSender {
    ...
    mapping(bytes8 => address) private tokens;
    ...
    function reverseFund(uint256 amount, uint256 totalTokenSent)
        public
        payable
        onlyOwner
    {
        (bool sendBackSuccess, ) = payable(msg.sender).call{
            value: amount - totalTokenSent
        }("");
    ...
    function distributeNativeCoin(
        ...
        uint256 recipientAmount = totalAmount.sub(feeAmount);
        //send fee to contract
        ...
        for (uint256 i = 0; i < _addresses.length; i += 1) {
            ...
            if (!sent) {
                ...
                reverseFund(recipientAmount, totalTokensSent);
        ...
        returns (bool)
    {
        ...
        IERC20(tokens[_symbol]).transferFrom(msg.sender, _to, recipientAmount);
