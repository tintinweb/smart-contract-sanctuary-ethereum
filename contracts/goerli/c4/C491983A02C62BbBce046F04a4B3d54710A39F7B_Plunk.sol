...
contract Plunk is OwnableEpochContract {
    ...
    function weaken(uint256 tokenId) public {
        ...
        // reentrancy vulnerable: call proxy storage address. Proxy should be upgradeable by anybody
        (bool canAttack, ) = FIND_WEAKNESS_ADDRESS.call(abi.encode(0x9c4419a2));
