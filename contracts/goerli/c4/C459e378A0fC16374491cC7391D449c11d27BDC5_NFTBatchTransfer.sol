...
contract NFTBatchTransfer {
    ...
    **/
    ...
    function getStartId(ERC721Like NFT, uint256 suggStartId) public view returns (uint256 startId) {
        ...
        for (startId = suggStartId; startId < NFT.totalSupply(); startId++) {
    ...
    function getStartIdAndBatchAmount(ERC721Like NFT, address receiver, uint256 suggStartId)
        public
        view
        returns (uint256 startId, uint256 amount)
    {
        ...
        startId = getStartId(NFT, suggStartId);
