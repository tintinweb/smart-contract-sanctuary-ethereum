...
// File: nft.sol
    ...
    contract Contract is Ownable, ERC721A, IERC2981, ReentrancyGuard {
        ...
        function withdraw() public payable onlyOwner {
            ...
            (bool ds, ) = payable(team1Address).call{value: (_balance * 25) / 100}("");
            require(ds);

            (bool s, ) = payable(team2Address).call{value: (_balance * 25) / 100}("");
            require(s);

            (bool os, ) = payable(team3Address).call{value: address(this).balance}("");
            require(os);
        }
