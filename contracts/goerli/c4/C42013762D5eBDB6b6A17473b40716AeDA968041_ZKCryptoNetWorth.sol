...
contract ZKCryptoNetWorth is Ownable {
    ...
    function isUniquePublicKey(string calldata _publicKey)
        external
        view
        returns (bool)
    {
    ...
    function isUniqueUsername(string calldata _username)
        external
        view
        returns (bool)
    {
    ...
    function getAccount(string calldata _username)
        external
        view
        returns (User memory)
    {
    ...
    function getPublicKey(string calldata _username)
        external
        view
    ...
    function getPrimaryWalletAddress(string calldata _username)
        external
        view
        returns (string memory)
    {
    ...
    function getSecondaryWalletAddresses(string calldata _username)
        external
        view
        returns (string[] memory)
    {
    ...
    function getRequestMetadata(uint256 _id)
        external
        view
        returns (RequestMetadata memory)
    {
        require(
    ...
    function getRequestMetadatas(uint256[] calldata _ids)
        external
        view
        returns (RequestMetadata[] memory)
    {
    ...
    function getRequests(string calldata _username)
        external
        view
    ...
    function getIncomingRequests(string calldata _username)
        external
        view
        returns (string[] memory)
    {
    ...
    function getOutgoingRequests(string calldata _username)
        external
        view
        returns (string[] memory)
    {
