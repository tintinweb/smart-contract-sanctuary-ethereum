...
contract DOTS is ERC721AQueryable, AccessControl, VRFConsumerBaseV2 {
    ...
    function fulfillRandomWords(
        ...
        uint256[] memory _currentEvoIds = currentEvoDots[shinyRoll.evoStage];
        ...
        while (numAssigned < shinyRoll.shinyAmount) {
            tempShinyToken = _currentEvoIds[uint256(keccak256(abi.encodePacked(randomWords[0], nonce))) % _currentEvoIds.length];

            if(!metadata[tempShinyToken].isShiny) {
