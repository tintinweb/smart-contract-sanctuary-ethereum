    ...
    IMSDropERC721
{
    ...
    function lazyMint(
        ...
        emit TokensLazyMinted(startId, startId + _amount - 1, _baseURIForTokens, _data, royaltyRecipient);
    }
    ...
    function verifyAdminClaim(uint256 _quantity) public view virtual {
...
interface IMSDropERC721 is IERC721Upgradeable, IDropClaimCondition {
    ...
    event TokensLazyMinted(uint256 startTokenId, uint256 endTokenId, string baseURI, bytes encryptedBaseURI, address indexed artist);
