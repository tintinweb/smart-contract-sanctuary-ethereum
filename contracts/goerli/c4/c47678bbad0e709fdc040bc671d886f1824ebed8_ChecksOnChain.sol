    ...
    DefaultOperatorFilterer
{
    ...
    // FIXME: consider adding public visibility
    mapping(string => bool) colorsIsUsed;
    mapping(uint256 => string) tokenColors;
    mapping(string => string) codeToHexColor;

    uint256[] private _shares = [34, 33, 33];
    address[] private _shareholders = [
        0xfA5D30fDcC053E4dEe8dDBB5FE4eF9F325A8d85B,
        0x821Ab25EccC355f4216396c4b25385B21F252FDb,
        0xe3Ca6a73214C0a0B378977e131129D0Ac69D0af2
    ];

    constructor()
        ERC721("CHECKED", "CHECKED")
    ...
    function image(uint256 token) internal view returns (string memory) {
        ...
        return
            string(
                abi.encodePacked(
                    '<svg width="800" height="800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 802 802"><rect x="0" y="0" fill="black" width="100%" height="100%"/><rect x="232" y="191" fill="white" width="335" height="418"/><svg x="247" y="206" fill="#fff" width="304" height="380" viewBox="0 0 306 382">',
                    content,
                    "</svg></svg>"
                )
            );
