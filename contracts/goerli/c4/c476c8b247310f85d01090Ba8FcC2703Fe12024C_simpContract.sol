...
abstract contract Project {
    // need to update just a demo address 
    address public marketingWallet = 0x0F8bacfae87AEe49a2eEC86dF0c6B958eC3Fd4Fd;
    address public devWallet = 0x0F8bacfae87AEe49a2eEC86dF0c6B958eC3Fd4Fd;

    string constant _name = "Simp";
    string constant _symbol = "SIMP";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 1e15 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply / 100; // _totalSupply / 100 [this equals 1%]
    ...
    uint256 public swapDev            = 1;
    uint256 public swapTreasuryFee    = 2;
    uint256 public swapTotalFee       = swapMarketing + swapDev + swapLpFee + swapTreasuryFee;
 ...
 * MainContract
 */
contract simpContract is Project, IERC20, Ownable {
