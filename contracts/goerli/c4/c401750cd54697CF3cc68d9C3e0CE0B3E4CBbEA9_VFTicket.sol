...
import "./VFTokenExtensions.sol";
import {Context} from "@openzeppelin/contracts/utils/Context.sol";

contract VFTicket is ERC4907VF, VFTokenExtensions {
    //Token base URI
    ...
    function setUser(
        ...
        address user,
        uint64 expires
    ) public override onlyRoles(getMinterRoles()) {
...
abstract contract VFTokenExtensions is
