...
contract Composable is Ownable, ERC721URIStorage, ReentrancyGuard{
    ...
    Artist methods:
        ...
        -criar a Sample 
    */
    function generateNFTArtist(address to, string memory value, string memory nameSample_, string memory tokenURI_) 
        public
        returns (uint256)
    {
...
*/
        ...
        returns (uint256)
    {
        ...
        sample.walletOwner = recipient;
        sample.idToken = newItemId;
        sample.samples = samplesEmpty;

        //Add sample to record of musics
        nfts[newItemId]=sample; 
