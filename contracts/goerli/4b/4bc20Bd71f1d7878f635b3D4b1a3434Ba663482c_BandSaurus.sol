...
contract BandSaurus is IBandSaurus,  ERC721Enumerable, EIP2981RoyaltyOverrideCore, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721('BAND SAURUS', 'SAURUS') {
        TokenRoyalty memory royalty;
        royalty.bps = 1000;
        royalty.recipient = owner();
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override (ERC721Enumerable, EIP2981RoyaltyOverrideCore,IERC165)
        returns (bool)
    {
...
// With modifications by ChimneyTown DAO.
