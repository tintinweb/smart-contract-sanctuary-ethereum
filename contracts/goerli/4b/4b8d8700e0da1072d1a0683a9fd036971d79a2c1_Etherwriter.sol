...
contract Etherwriter is Context, ERC721Burnable {
	...
	function _createTextBlock(uint256 tokenId, uint256 level) internal view returns(string memory) {
		...
		return string(
			abi.encodePacked(
				'<text id="t', level, '" visibility="hidden" x="100" y="', level, '90" font-family="Xe" font-size="40" fill="', tokenData[tokenId].color, '">',
				text
			)
		);
	}
	...
	function generateAnimation(uint256 tokenId) public view returns(string memory) {
		bytes memory svg = abi.encodePacked(
			'<svg xmlns="http://www.w3.org/2000/svg" width="1160" height="460"><title>Etherwriter #',
			tokenId,
			'</title><defs><style type="text/css">@font-face {font-family: "Xe";src: url("data:application/x-font-ttf;base64,',
			_font,
			'")}</style></defs>',
			...
			'<set id="set51" begin="mv6.end" to="visible" attributeType="auto" attributeName="visibility"></set><set id="set52" begin="mv8.end" to="hidden" attributeType="auto" attributeName="visibility"></set></text><g id="cursor"><rect x="100" y="40" width="23.5" height="60" fill="#333"><animate id="bl1" begin="1; mv8.end" to="#AAA" dur="0.5s" repeatCount="5" attributeType="auto" attributeName="fill"></animate><animate id="blink2" begin="mv1.end" to="#AAA" dur="0.5s" repeatCount="5" attributeType="auto" attributeName="fill"></animate><animate id="bl3" begin="mv2.end" to="#AAA" dur="0.5s" repeatCount="5" attributeType="auto" attributeName="fill"></animate><animate id="bl4" begin="mv3.end" to="#AAA" dur="0.5s" repeatCount="5" attributeType="auto" attributeName="fill"></animate><animate id="bl5" begin="mv4.end" to="#AAA" dur="0.5s" repeatCount="5" attributeType="auto" attributeName="fill"></animate><animate id="bl6" begin="mv5.end" to="#AAA" dur="0.5s" repeatCount="5" attributeType="auto" attributeName="fill"></animate><animate id="bl7" begin="mv6.end" to="#AAA" dur="0.5s" repeatCount="5" attributeType="auto" attributeName="fill"></animate><animate id="bl8" begin="mv7.end" to="#AAA" dur="0.5s" repeatCount="5" attributeType="auto" attributeName="fill"></animate><set id="set11" begin="mv2.begin" to="140" fill="freeze" attributeType="auto" attributeName="y"></set><set id="set12" begin="mv4.begin" to="240" fill="freeze" attributeType="auto" attributeName="y"></set><set id="set13" begin="mv6.begin" to="340" fill="freeze" attributeType="auto" attributeName="y"></set><set id="set14" begin="mv8.begin" to="40" fill="freeze" attributeType="auto" attributeName="y"></set></rect><rect x="125" y="40" width="1000" height="60" fill="#FFF"><set id="set21" begin="mv2.begin" to="140" fill="freeze" attributeType="auto" attributeName="y"></set><set id="set22" begin="mv4.begin" to="240" fill="freeze" attributeType="auto" attributeName="y"></set><set id="set23" begin="mv6.begin" to="340" fill="freeze" attributeType="auto" attributeName="y"></set><set id="set24" begin="mv8.begin" to="40" fill="freeze" attributeType="auto" attributeName="y"></set></rect><animateTransform id="mv1" begin="bl1.end" attributeName="transform" type="translate" from="0,0" to="23.5,0" dur="0.10s" accumulate="sum" calcMode="discrete" repeatCount="',
			_stringLength(tokenData[tokenId].texta),
			'" fill="freeze"></animateTransform><animateTransform id="mv2" begin="blink2.end" attributeName="transform" type="translate" from="456,0" to="0,0" dur="0.10s" fill="freeze"></animateTransform><animateTransform id="mv3" begin="bl3.end" attributeName="transform" type="translate" from="0,0" to="23.5,0" dur="0.10s" accumulate="sum" calcMode="discrete" repeatCount="',
