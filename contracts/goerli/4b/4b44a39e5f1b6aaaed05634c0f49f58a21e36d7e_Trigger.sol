...
contract Trigger is ERC2771Context, Ownable {
    ...
    // check if the msg sender is the owner
        require(rocket.ownerOf(tokenId) == msg.sender, "You don't own the given Rocket");
        rocket.setNewTokenURI(typeOfURI, tokenId, newURI);
    }
    
    ////////////  BURN TRIGGER TESTING ////////////////////
    ...
    ////////////  Mint TRIGGER TESTING ////////////////////

    function  MintTrigger() external  {
    ...
    //   function  MintTrigger() external  {
    //     require(rocket._mintCounter[_msgSender()] < 1 , "You already minted a rocket!");
    //     require(_triggerCounter[_msgSender()] < 1 ,"You already minted a Rocket!");
    //         rocket._minterMint(_msgSender());
    //      _triggerCounter[_msgSender()] = _triggerCounter[_msgSender()] + 1;
    // }
