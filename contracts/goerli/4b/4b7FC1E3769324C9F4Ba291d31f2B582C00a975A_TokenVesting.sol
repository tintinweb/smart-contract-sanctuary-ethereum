...
contract TokenVesting is Ownable {
    ...
    function createVestingSchedule(
        ...
        vestingSchedules[_name] = VestingSchedule(_name, _terms, _cliff, _duration, _amount, 0, 0, false);
    ...
    function revokeVestingSchedule(string memory _name) public onlyOwner {
        ...
        uint256 scheduleUnreleasedAmount = vestingSchedules[_name].totalAmount.sub(
            vestingSchedules[_name].releasedAmount
        );
     ...
     */
    function getVestingSchedule(string memory _name) public view returns (VestingSchedule memory) {
        return vestingSchedules[_name];
    }

    /**
     * @dev Gets all vesting schedules
     * @return VestingSchedule structure list
     */
