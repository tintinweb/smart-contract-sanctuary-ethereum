...
contract AdvancedNFT is ERC721EnumerableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public publicSaleNftPrice; // ex: 1000000000000000 wei => 0,001 ETH
    uint256 public whitelisteSaleNftStartingPrice; // ex: 80000000000000000 wei => 0.08 ETH
    ...
    function initialize(string memory _name, string memory _symbol, uint256 _MAX_SUPPLY_NFT, uint256 _publicSaleNftPrice, uint256 _maxNftPurchase) initializer public {
        __ERC721_init(_name, _symbol);
        MAX_SUPPLY_NFT = _MAX_SUPPLY_NFT;
    ...
    function mintNft(uint256 _ammount) external payable nonReentrant {
        ...
        require(msg.value > publicSaleNftPrice, "You don't have enough funds.");
    ...
    // burnNft() --> reducde the supply if the collection has trouble to be sold
    ...
    // pause() --> pause the contract to fix a bug or anything else
    ...
    // isRevealed() --> check revealed status
