...
contract MetaKozo is ERC721A, Pausable, Ownable {
    // Address information
    ...
    uint64 public preCost = 0.02 ether;
    ...
    uint256 preSaleStartTime = 1577804880; // 2020/01/01 00:00:00 UTC
    uint256 publicSaleStartTime = 1669478400; // 2022/11/27 01:00:00 UTC 
    ...
    constructor (
        ...
        _baseTokenURI = "https://metadata.metakozo-dao.xyz/ipfs/Qmcpsgx3ZATrEBxY8CvHCxdapBwpHzx7SruANhuQATeviq/";
        ownerMint(222);
    }
