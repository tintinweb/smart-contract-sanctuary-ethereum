...
contract ReentalDividends is UUPSUpgradeableByRole, RefundableUpgradeable {
  ...
  function claim(
    ...
    _distribute(index, account, amount, merkleProof, account, distribution);
  }
  ...
  function claimAll(
    ...
    uint256 distribution = claimable(index, account, amount, merkleProof);
    claim(index, account, amount, merkleProof, distribution);
  }
