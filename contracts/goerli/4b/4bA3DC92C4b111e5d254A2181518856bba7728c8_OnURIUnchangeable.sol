...
contract OnURIUnchangeable is ERC721URIStorage, Ownable {
    ...
    /**
     * @dev
     * - _tokenIds は Counters の前関数が利用可能
     */
    ...
    /**
     * @dev
     * - URI 設定時に誰がどのtokenIdに何のURIを設定したかを記録する
     *-mint の際に URI を設定 _setTokenURI()
     */
     ...
     * - tokenId をインクリメントする _tokenIds.increment()
     * -　nftMint 関数のアドレスに tokenId を紐付け
     * - mint の際に URI を設定 _setTokenURI()
    ...
    function nftMint() public onlyOwner {
        ...
        string memory imageData = '\
            ...
            <polygon points="50 175, 175 50, 300 175, 175 300" stroke="black" fill="blue" /> \
            </svg>\
        ';
