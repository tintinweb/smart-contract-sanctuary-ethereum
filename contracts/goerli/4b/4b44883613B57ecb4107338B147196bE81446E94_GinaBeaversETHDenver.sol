...
contract GinaBeaversETHDenver is BaseCollectionETHDenver {
    ...
    uint256 internal immutable _tokenOffset;
    ...
    ) BaseCollectionETHDenver(name_, symbol_, 500, 5, 0.0036 ether, coaProxy_, artist_) {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return
            bytes(tokenBaseURI).length > 0
                ? string(abi.encodePacked(tokenBaseURI, (tokenId + _tokenOffset).toString()))
                : "";
    }
}
