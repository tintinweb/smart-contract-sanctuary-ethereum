    ...
    UUPSUpgradeable
{
    ...
    function playSlip(
        ...
        if(gameType_ == 1){
            ...
            require(accOddPoint_.mul(amount_).div(100) <= 500000 * 10**8);
        ...
        //Multi-flex Game
            ...
            require(accOddPoint_.mul(amount_).div(100) <= 10000 * 10**18);
    ...
    function updateGameResult(uint256 _leagueId, uint256 _date) external {
