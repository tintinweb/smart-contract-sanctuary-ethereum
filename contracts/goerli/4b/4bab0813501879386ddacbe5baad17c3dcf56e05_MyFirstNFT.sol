...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "ipfs://QmdP8kZMAFsjuUrjdaG8Sujyh2C3QCt7o5p392PELRZQEj"; // 這一行是 NFT 該去哪裡找你的 MetaData
    bool public paused = false; // 可以拿來暫停或者開啟 Mint
    uint256 public cost = 0.0001 ether; // Mint 價格
    uint256 public maxSupply = 3; // 只有三個 NFT
    uint256 public maxMintAmount = 1; // 一次最多只能 Mint 一個

    constructor() ERC721("GameCard", "game") payable {
        // 剛開始我們先自己 Mint 一個
