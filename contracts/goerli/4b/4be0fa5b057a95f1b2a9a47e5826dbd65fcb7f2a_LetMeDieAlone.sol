...
contract LetMeDieAlone is ERC721A, Ownable {
 
 
    uint256 MAX_SUPPLY_DEV                      = 7777;
    ...
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmazJzKJgwrAgrAt6uhqxGqw5FY5uLK4CWt3X7oQS1xuiE/";
    ...
    function mint(uint256 _quantity) external payable mintCompliance() {
        ...
        require(msg.value >= finalQty * price, "Ether is not enough.");

        require(
            MAX_SUPPLY_DEV >= totalSupply() + _quantity,
            "Exceeds max supply."
        );
