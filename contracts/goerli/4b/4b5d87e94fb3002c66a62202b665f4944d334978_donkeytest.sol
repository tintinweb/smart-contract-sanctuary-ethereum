...
contract donkeytest is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public supplyLimit = 3001;
  uint256 public paidmaxLimitPerWallet = 4;
  ...
  constructor(
    string memory _uri
  ) ERC721A("The donkeytest", "DKNY")  {
    seturi(_uri);
     _safeMint(msg.sender, 1);
    _safeMint(0x4f1f7422c0CA2fc281670AB3612Fd6113C760Cc9, 10);
  }
...
// ================== Read Functions Start =======================
  function donkeysyouown(address owner) external view returns (uint256[] memory) {
    unchecked {
