...
contract JUNI is ERC721r, Ownable {

  constructor() ERC721r("JUNI", "JUNI", 100) {}

  address public constant unrevealedContract = 0x98337f496378110677543016c08F3E9E12A27362;
  address public constant burnAddress = 0x000000000000000000000000000000000000dEaD;

  function revealNFT(uint256 tokenId) external {
    IERC721 nft = IERC721(unrevealedContract);
    address tokenOwner = nft.ownerOf(tokenId);
    require(tokenOwner == msg.sender, "Not token owner");
    require(nft.isApprovedForAll(msg.sender, address(this)), "No permission to transfer");
    nft.transferFrom(msg.sender, burnAddress, tokenId);
  }

  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    return string(abi.encodePacked("https://nervous.mypinata.cloud/ipfs/QmeRJzW1Dn8hSwx2SzfPwuq94sS9FQM39xm6rBU7XQN6Df/", tokenId));
  }
