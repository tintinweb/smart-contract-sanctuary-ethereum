...
contract NicoleNFT is ERC721A, ERC721AQueryable, ERC721ABurnable, IERC4906, ERC2981, Ownable, Pausable, DefaultOperatorFilterer, AccessControl {
    ...
    uint256 public bestShotCost = 0.1256 ether;
    ...
    constructor(bool mintERC2309Flg) ERC721A("NicoleNFT", "NICOLE") {
        _grantRole(DEFAULT_ADMIN_ROLE, 0xb06D25745F8c5f6920614EFace10E75e22ecA41B);
        _setDefaultRoyalty(0xb06D25745F8c5f6920614EFace10E75e22ecA41B, 1000);
        if (mintERC2309Flg == true) {
            _mintERC2309(0xb06D25745F8c5f6920614EFace10E75e22ecA41B, 15);
        }
    }
