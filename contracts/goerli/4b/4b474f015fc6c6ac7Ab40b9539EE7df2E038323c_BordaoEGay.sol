...
contract BordaoEGay is ERC721, ERC721Enumerable, Ownable {
    ...
    using NftMetadataUtils for NftMetadata;
    ...
    function setpreviewUrl(string memory _previewUrl) external onlyOwner {
        previewUrl = _previewUrl;
    }
    ...
    function tokenURI(
        ...
        return
            NftMetadata(name, description, previewUrl, websiteUrl, animationUrl)
                .toUrl();
    }
