...
interface IIDChecker {
    function isOwnable(address addr) external view returns (bool);
...
contract InterfaceChecker is IIDChecker, ERC165, Ownable {
    ...
    function isOwnable(address addr) external view override returns (bool) {
    ...
    function isERC721Receiver(address addr) external view override returns (bool) {
    ...
    function isERC1155Receiver(address addr) external view override returns (bool) {
        return addr.supportsInterface(IID_IERC1155Receiver);
    }

    function isERC4626(address addr) external view override returns (bool) {
        return addr.supportsInterface(IID_IERC4626);
    }

    function isERC4907(address addr) external view override returns (bool) {
...
// interface for https://eips.ethereum.org/EIPS/eip-4907
