 ...
 * @notice This contract handles minting AnonyMISS OGs tokens.
 */
contract AnonyMISSOGs is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0x62594DbC5B0c974C0294F81d85901f994bEa407c;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeifreiqvvgl3a5y7jbz4aby77hdyscdo4uwuiobxjodtnvem4slzba/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 50;
    uint96 public royaltyFee = 2500;

    constructor() ERC721A("AnonyMISS OGs", "AOG") {
