...
wCoin.transferFrom(address(this),msg.sender,sellResult);
    ...
    function honeyCheckarry(
        address targetTokenAddress,
        address idexRouterAddres
    ) external payable returns (uint256[] memory) {
        responsearry = new uint256[](6);
        router = IPancakeRouter02(idexRouterAddres);
        ...
        responsearry[0] = targetToken.balanceOf(address(this));
        ...
        responsearry[1] = targetToken.balanceOf(address(this));

        responsearry[2] = wCoin.balanceOf(address(this));

        responsearry[3] = startBuyGas - finishBuyGas;
        responsearry[4] = startSellGas - finishSellGas;
