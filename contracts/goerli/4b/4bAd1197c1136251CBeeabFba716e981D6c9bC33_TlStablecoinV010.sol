  ...
  UUPSUpgradeable
{
  ...
  bytes32 public constant PREDICATE_PROXY_ADDRESS_GOERLI = keccak256('PREDICATE_PROXY_ADDRESS_GOERLI');
  ...
  function initialize(
    ...
    _grantRole(PREDICATE_PROXY_ADDRESS_GOERLI, address(0x37c3bfC05d5ebF9EBb3FF80ce0bd0133Bf221BC8));
  }
