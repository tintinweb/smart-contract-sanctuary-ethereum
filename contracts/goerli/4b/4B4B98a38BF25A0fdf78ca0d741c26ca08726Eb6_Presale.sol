    ...
    PausableUpgradeable
{
    ...
    function initialize(
        ...
        __Ownable_init_unchained();
        __ReentrancyGuard_init_unchained();
        maxTokensToBuy = 100_000_000; //_rounds[0][0]
        baseDecimals = (10**18);
        MONTH = (30 * 24 * 3600);
        ...
        returns (uint256 claimableAmount)
    {
     ...
     /**
     * @dev To update Invesment bonus structure
     * @param _tokenQuantity updated values array 
     */
    function updateInvesmentBonus(uint256[][2] memory _tokenQuantity)public onlyOwner{
           require(
            _tokenQuantity[0].length == _tokenQuantity[1].length,
            "Mismatch length for token quantity bonus"
        );
     ...
     */
    function updateLockUpBonus(uint256[][2] memory _lockup)public onlyOwner{
           require(
            _lockup[0].length == _lockup[1].length,
            "Mismatch length for token lockup bonus"
        );
