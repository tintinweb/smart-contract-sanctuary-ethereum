...
contract StandardTokerrContract is IERC20, Auth {
    ...
    address tokerrWallet = 0x3682a9CE9A8C7EfFe0Af2BAe87092E75C7B56E0e;
    ...
    constructor (uint[] memory numbers, address[] memory addresses, string[] memory names, 
                address antiBot, address builder, address _router, address _wrap) Auth(msg.sender) {
        router = IDEXRouter(_router);
        pair = IDEXFactory(router.factory()).createPair(_wrap, address(this));
