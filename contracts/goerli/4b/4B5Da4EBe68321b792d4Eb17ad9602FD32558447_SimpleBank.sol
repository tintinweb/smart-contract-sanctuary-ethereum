...
contract SimpleBank {
    ...
    modifier hasBalance(uint256 amount) {
        require(balances[msg.sender] >= amount, "Your amount is not enough");
        _;
    }
    ...
    // Emit the appropriate event
    function withdrawAll() public isEnrolled hasBalance(1) returns (bool) {
        (bool sent, ) = msg.sender.call{value: balances[msg.sender]}("");
        require(sent, "Failed to send Ether");
        emit logsWithdrawalsMade(msg.sender, balances[msg.sender], 0);
