...
//
//                                __     __            __ 
//    _________ _____ ___  ____  / /__  / /____  _____/ /_
//   / ___/ __ `/ __ `__ \/ __ \/ / _ \/ __/ _ \/ ___/ __/
//  (__  ) /_/ / / / / / / /_/ / /  __/ /_/  __(__  ) /_  
// /____/\__,_/_/ /_/ /_/ .___/_/\___/\__/\___/____/\__/  
//                     /_/                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1663773000;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x25ca43Eeba56799E3BeCEa37e7935b8BeD3A639e];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x25ca43Eeba56799E3BeCEa37e7935b8BeD3A639e;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibhdx64vitxb726ugliqigmvxf6r3e7omipmqas4lfaciut5msz7a/";
...
// File: contracts/SampletestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SampletestContract is RamppERC721A {
    constructor() RamppERC721A("sampletest", "sample"){}
}
