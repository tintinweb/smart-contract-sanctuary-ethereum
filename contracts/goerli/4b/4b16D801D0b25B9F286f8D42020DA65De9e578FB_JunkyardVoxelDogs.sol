...
contract JunkyardVoxelDogs is Ownable, ERC721A {
  ...
  function purchase(uint256 amount) public payable {
    ...
    require(_nextTokenId() + amount <= purchaseableLimit, "Not enough purchaseable");
  ...
  function toggleBreeding(bool active) public onlyOwner {
    isBreedingActive = active;
  }
  ...
  function _baseURI() internal pure override returns (string memory) {
    return "https://api.junkyarddogs.io/voxeldogs/";
  }
}
