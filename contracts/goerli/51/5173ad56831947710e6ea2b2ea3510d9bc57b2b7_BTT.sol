...
// File: metabloq_flat.sol

pragma solidity 0.8.17;
contract BTT is ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable {
...
//    }
    ...
    function mint(address to, uint256 amount) public onlyOwner {
        require (!isBlackListed(to), "Token Mint not allowed. Receiver is on blacklist");
    ...
    override
    {
        ...
        require (!isBlackListed(from), "Token transfer not allowed. Sender is on Blacklist");
