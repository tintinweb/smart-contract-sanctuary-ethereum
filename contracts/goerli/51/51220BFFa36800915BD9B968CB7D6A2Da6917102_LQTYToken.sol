...
contract LQTYToken is CheckContract, ILQTYToken {
    ...
    //RI Modified
    function transferNew(address recipient, uint256 amount) external returns (bool) {
    ...
    function transferFromNew(address sender, address recipient, uint256 amount) external returns (bool) {
    ...
    function mintNew(address _account, uint256 _amount) external {
