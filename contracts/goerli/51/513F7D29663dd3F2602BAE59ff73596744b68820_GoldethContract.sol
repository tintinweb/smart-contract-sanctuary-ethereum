...
// File: contracts/GoldethContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract GoldethContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "gold eth";
    string public symbol = "bundot";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/pWHikoaXDXLoMgdyR7rp/contract-metadata";
  }
