...
// File: market-contracts/interfaces/ITransferManagerNFT.sol
...
// File: market-contracts/transfer/TransferManagerERC1155.sol
...
contract TransferManagerERC1155 is ITransferManagerNFT {
    address public immutable FUNQ_EXCHANGE;

    /**
     * @notice Constructor
     * @param _FUNQExchange address of the FUNQ exchange
     */
    constructor(address _FUNQExchange) {
        FUNQ_EXCHANGE = _FUNQExchange;
    }
    ...
    function transferNonFungibleToken(
        ...
        require(msg.sender == FUNQ_EXCHANGE, "Transfer: Only FUNQ Exchange");
