...
contract Pieces is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable {
    
    event ArtworkAdded(address indexed creator, string indexed name, uint80 price, uint16 maxSupply);
    ...
    function getTokenInfo(uint256 tokenId) public view returns(Layer memory) {
        return layers[tokenId];
    }
}
