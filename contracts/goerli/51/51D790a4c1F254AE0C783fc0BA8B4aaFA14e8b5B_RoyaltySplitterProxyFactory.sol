    ...
    function createProxyContract(
        ...
        GenericProxy newProxy = new GenericProxy(
            ...
            abi.encodeWithSelector(
                RoyaltySplitter(payable(address(_config.masterCopy))).initialize.selector, 
                _config.shares,
                _config.receivers,
                _config.collection,
                _config.creator
...
contract RoyaltySplitter is Initializable, OwnableUpgradeable, ERC2771ContextUpgradeable
{
    ...
    function initialize(uint256[] memory shares_, address[] memory _receivers, address _collection, address _owner)
        public
    {
        ...
        // set royalty address in collection contract
