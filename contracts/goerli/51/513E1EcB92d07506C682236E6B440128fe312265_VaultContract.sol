...
contract VaultContract is FlashLoanReceiverBase {
     ...
     * @param amountIn The address of the collateral being liquidated
     * @param Pool_Fee The address of the reserve
     * @param ColletralToken The address of the user being liquidated
     * @param BorrowToken The total amount liquidated
     * @param Borrower The amount of collateral being liquidated
     * @param recieveAToken true if the liquidator wants to receive aTokens, false otherwise
     **/
     ...
     * @param new_gas_wallet The Account Address of new GasWallet
     **/
    ...
    /**
     * @dev Owner can update OwnerWallet.
     * @param new_owner_wallet The Account Address of new Owner of the Contract
     **/
    ...
    /**
     * @dev Owner can update OwnerWallet.
     * @param token_address The token address to withdraw all the funds from the contract
     **/
    ...
    function executeOperation(
        ...
        // Convert Remaining Colletral to USDC
        uint256 SwapResult1 = swapExactInputSingle(
            _ColletralToken,
            _BorrowToken,
            _PoolFee,
            balanceColletral,
