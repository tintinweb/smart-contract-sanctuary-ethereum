...
contract Doodle is ERC721ABurnable, ERC721AQueryable, Ownable{
  ...
  mapping(address => bool) public burntTartClaimed;
  //*********************************************************************
  ...
  uint256 public constant salePrice = 0.0001 ether;
  //*********************************************************************
  


  //********************** Constructor **********************************
  constructor(string memory _hiddenMetadata) ERC721A("TartFriends", "TART") {
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    require(msg.value >= salePrice * _mintAmount, 'Insufficient funds!');
    _;
  }
  //***************************************************************************
  ...
  function burnMint() public {
    ...
    require(!burntTartClaimed[_msgSender()], "Address already claimed a burnt Tart.");

    burntTartClaimed[_msgSender()] = true;
  ...
  function setTartLocation(string memory _location) public onlyOwner {
    tartLocation = _location;
  }
