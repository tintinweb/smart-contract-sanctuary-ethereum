...
contract Pork1984ChapterIII is ERC721A, Ownable, Pausable {
    ...
    constructor() ERC721A("Pork1984 Chapter III", "PORK1984-C3") {
        ...
        // goerli testnet
        _chapter1Contract = IERC721(0xEDaea3A8500128d0f4A4665fcB7245BEe9FC4f62);
        _chapter2Contract = IERC721(0x9BE17D6AB17Dd48A4B129510Ce4D7d88BCf99424);
        _vaccinesContract = IVaccine(0x4957DB591769988d6423749645D954029423c3c8);

        _pause();
        __baseURI = 'https://api.pork1984.io/api/token/chapter3/';
    }
...
interface IVaccine {
    function isFullyVaccinated(uint256 porkId) external view returns(bool);

    function getMaxVaccinationProgress() external pure returns(uint8);

    function vaccinationProgress(uint256 porkId) external view returns(uint8);
}
