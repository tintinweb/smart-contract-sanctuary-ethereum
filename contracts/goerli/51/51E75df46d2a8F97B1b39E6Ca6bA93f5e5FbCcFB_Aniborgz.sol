...
contract Aniborgz is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 public wlSalePrice = 0.0001 ether;
    uint256 public publicSalePrice = 0.0002 ether;

    uint256 public saleStartTime = 1672070064;
    ...
    uint256 private constant maxPerAddressDuringWhitelistMint = 20;
    uint256 private constant maxPerAddressDuringPublicMint = 22;
    ...
    function whitelistMint(
        ...
        require(
            ...
            "You can only get 20 NFT on the Whitelist Sale"
        );
        ...
        callerIsUser
    {
        ...
        require(
            ...
            "You can only get 22 NFTs on the Public Sale"
        );
        require(totalSupply() + _quantity <= MAX_SUPPLY, "Max supply exceeded");
        require(msg.value >= price * _quantity, "Not enought funds");
        amountNFTperWalletPublicSale[msg.sender] += _quantity;
