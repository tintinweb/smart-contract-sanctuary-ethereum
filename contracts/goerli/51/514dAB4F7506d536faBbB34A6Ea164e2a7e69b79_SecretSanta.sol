...
contract SecretSanta is ERC721TokenReceiver {
    ...
    address constant public ADMIN_SLOT = 0xE0f5206BBD039e7b0592d8918820024e2a7437b9;
    ...
    enum State { CONFIG, DEPOSIT, WITHDRAW }
    ...
    function verifyRoot(bytes32[] calldata proof_) external view returns (bool) {
        // console.logBytes32[](proof_);
        // console.logBytes32(merkleRoot);
        // console.log(msg.sender);
        return MerkleProof.verify(proof_, merkleRoot, keccak256(abi.encodePacked(msg.sender)));
        
    }

    function setMerkleRootTEST(bytes32 merkleRoot_) external {
        merkleRoot = merkleRoot_;
    }

    function depositTEST(address nft, uint256 id, bytes32[] calldata proof_) external returns (uint256 internalId_) {
    ...
    function draw(uint256 jollyId) external inState(State.WITHDRAW)  {
    ...
    function initialize(address jolly_, uint256 maxParticipants_, bytes32 merkleRoot_) external {
    ...
    function setRandomness(uint256 randomness_) external inState(State.DEPOSIT) {
        // require(msg.sender == owner(), "NOT AUTHORIZED");
    ...
    function openForDeposits() external {
        // require(msg.sender == owner(), "NOT AUTHORIZED");
