...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function modifyTransLimit(uint limit) public isOwner { 
        require (limit >= minLimitTrans, "The limit can not be under 500K IDS");
        limitTrans = limit; 
    }
    ...
    function _beforeTokenTransfer(
        ...
        require (amount <= (limitTrans * 10 ** decimals()), "you can not exceed the limit");
    }
