...
/**
 * JiraCentral - A composable solution for allowing off-chain JIRAx generation.
 */
...
contract JiraCentral is Ownable {
    ...
    // TBD if we are going to include this here.
    // function depositToken(uint256 amount) public {
    //     IERC20Like(JIRA).transferFrom(
    //         msg.sender,
    //         address(this),
    //         amount
    //     );
    //     emit increaseBalance(msg.sender, amount);
    // }
}
