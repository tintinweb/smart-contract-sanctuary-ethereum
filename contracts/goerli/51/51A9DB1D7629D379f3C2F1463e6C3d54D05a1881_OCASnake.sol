...
contract OCASnakeArt is Ownable, ReentrancyGuard {
    ...
    function funkCreator(string[] memory colors)
        private
        pure
        returns (bytes memory)
    {
    ...
    function allYourBaseAreBelongToUs(uint256 tokenId)
        ...
        returns (string memory)
    {
        string[] memory selectedColors;
        string[] memory colors;
        selectedColors = retrofy(tokenId, 20, 0, selectedColors, colors);
    ...
    function retrofy(
        ...
        parts[i] = string(funkCreator(colors));
