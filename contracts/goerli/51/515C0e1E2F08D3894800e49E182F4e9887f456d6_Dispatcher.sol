    ...
    IDispatcher
{
    ...
    /// @dev List of managers, who can createRecord, deleteRecord, updateFee
    ...
    /**
     * @dev Return all whitelisted pool managers
     * @return Whitelisted addresses
     */
    function managerWhitelist() external view returns (address[] memory) {
