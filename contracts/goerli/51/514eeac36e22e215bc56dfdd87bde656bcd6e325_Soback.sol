...
contract Soback is ERC20, Ownable {
    ...
    constructor() ERC20("sob", "soback") {
        ...
        marketingWallet = address(0xE78168Ff62c96685662A9a65C93A766CD72d6a14); // set as marketing wallet
        devWallet = address(0xE78168Ff62c96685662A9a65C93A766CD72d6a14); // set as dev wallet
