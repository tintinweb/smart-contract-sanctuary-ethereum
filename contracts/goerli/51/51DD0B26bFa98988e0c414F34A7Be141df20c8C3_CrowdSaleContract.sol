...
contract CrowdSaleContract is Ownable {
    ...
    uint256 public tokensPerETH = 222910;
    ...
    mapping(address => ContributionUsdt) public contributions_usdt;
    ...
    function changeTokensPerETH(uint256 _tokensPerETH) public onlyOwner() {
     ...
     function buyTokensByUSDTwithoutReferral(address beneficiary, uint256 _amount) external {
        ...
        uint256 tokenAmount = _amount * tokensPerUSDT.div(10**12);

        contributions_usdt[beneficiary].contribution = contributions_usdt[beneficiary].contribution.add(_amount);
     ...
     function buyTokensByUSDTwithReferral(address beneficiary, address _referral, uint256 _amount) external {
        ...
        require(contributions_usdt[_referral].contribution > 0, "Invalid referral id.");
        ...
        contributions_usdt[beneficiary].contribution = contributions_usdt[beneficiary].contribution.add(_amount);
        contributions_usdt[beneficiary].referralBonus = contributions_usdt[beneficiary].referralBonus.add(referralUserBonus);
        contributions_usdt[_referral].referralBonus = contributions_usdt[_referral].referralBonus.add(referralBonus);
