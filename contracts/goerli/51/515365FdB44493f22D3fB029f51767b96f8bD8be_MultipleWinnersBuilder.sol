...
import "@dtribe/dtribe-rng-contracts/contracts/RNGInterface.sol";
import "@dtribe/fixed-point/contracts/FixedPoint.sol";
...
import "@dtribe/uniform-random-number/contracts/UniformRandomNumber.sol";
...
contract Ticket is ControlledToken, TicketInterface {
  ...
  bytes32 constant private TREE_KEY = keccak256("dTribe/Ticket");
