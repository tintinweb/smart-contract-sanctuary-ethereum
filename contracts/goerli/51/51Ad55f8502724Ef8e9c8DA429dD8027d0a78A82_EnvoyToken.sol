 ...
 */
contract EnvoyToken is Ownable, ERC20 {
    // MAX_SUPPLY is 500M
     ...
     */
    constructor() ERC20("Envoy Token", "VOY") {
        // Initial supply is 50M
        _mint(_msgSender(), 50_000_000 ether);
    }
     ...
     */
    function mint(address to, uint256 amount, bytes32 cordaTxHash) public onlyOwner {
        uint256 _totalSupply = totalSupply();
        require(amount <= MAX_SUPPLY - _totalSupply, "EnvoyToken: MAX_SUPPLY is out");
        _mint(to, amount);
