...
contract newtest is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("new test", "test") {
    setBaseURI("https://blam-staging.fly.dev/api/new-test-ZWO5Zq4/token/");
  ...
  function withdraw() public onlyOwner {
    ...
    uint256 payoutPayment1 = balance * (5) / (200);
    address payoutAddress2 = payable(0x8fc1F1F48cBB2e4A0f1dfeB9e6019606b307C3c4);
    uint256 payoutPayment2 = balance * (15) / (200);
