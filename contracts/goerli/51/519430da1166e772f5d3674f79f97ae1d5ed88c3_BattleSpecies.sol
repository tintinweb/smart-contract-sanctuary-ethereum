...
contract BattleSpecies is ERC721Profile, BattlespeciesWithdrawer, OperatorFilterer {
    ...
    constructor(address _hyperwarpManager, address _utilityHub, bytes32 _wlRoot) ERC721Profile("Battlespecies", "BATTLE") {
        ...
        /* switches to Web3 before metadata freeze */
        ...
        _mintERC2309(owner, 30);
        rewardableBalanceOf[owner] = 30;
    ...
    function _baseMint(address _mintRecip, uint256 _numberOfTokens, bool _autoManifest, uint256 _mintPrice) internal {
    ...
    function _remoteMint(address _mintRecip, uint256 _numberOfTokens, bool _autoManifest, uint256 _mintPrice) external {
    ...
    function mint(uint256 _numberOfTokens, bool _autoManifest) public payable {
        _baseMint(_msgSender(), _numberOfTokens, _autoManifest, mintPrice);
    }

    function mintWhitelist(uint256 _numberOfTokens, bool _autoManifest, bytes32[] calldata _wlProof) public payable {
