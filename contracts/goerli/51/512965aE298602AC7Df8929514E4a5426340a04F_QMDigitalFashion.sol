...
contract QMDigitalFashion is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155URIStorageUpgradeable {
    ...
    function adminMint(
        ...
        adminMint(receiver, tokenId, info, metadataUrl, Promocode(0, 0, ''));
    }
    ...
    function adminMint(
        ...
        createAndMintInternal(receiver, tokenId, 1, info, promocode, metadataUrl);
    }
    ...
    function createAndMint(
        ...
        createAndMint(stableCoinAddress, stableCoinAmount, receiver, tokenId, info, metadataUrl, Promocode(0, 0, ''));
    }
