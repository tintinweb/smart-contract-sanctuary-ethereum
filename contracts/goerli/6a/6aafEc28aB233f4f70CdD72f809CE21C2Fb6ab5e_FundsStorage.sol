...
contract FundsStorage is IFundsStorage {
    ...
    modifier onlyAdminRole() {
        accessController.checkFundsAdminRole(msg.sender);
        _;
    }
    ...
    function transfer() external payable override {
        emit FundsReceived(msg.sender, msg.value);
    }
    ...
    function withdraw() external override onlyAdminRole {
