...
UUPSUpgradeable
{
    ...
    function changeCreatorPaymentAddress(address payable _to) public onlyOwner {
    ...
    function setCategory(Categories memory _category, uint8 position) public onlyRole(ADMIN_ROLE) {
    ...
    function setTokenSupply(uint256 _expectedTokenSupply) public onlyRole(ADMIN_ROLE) {
        expectedTokenSupply = _expectedTokenSupply;
    }
