...
contract GoCryptoTokenContract is ERC20, ERC20Burnable, AccessControlEnumerable {
    
    bytes32 public constant MODERATOR_ROLE = keccak256("MODERATOR_ROLE");

	bool private _initialised;

	constructor() ERC20("GoCryptoToken", "GoC") {
	...
	function init(
		...
		_grantRole(MODERATOR_ROLE, minterAddress_);
    ...
    // *************** MODERATOR REGION *****************
    // **************************************************
	function safeMint(address to_, uint256 amount_) public onlyRole(MODERATOR_ROLE) {
		_mint(to_, amount_);
