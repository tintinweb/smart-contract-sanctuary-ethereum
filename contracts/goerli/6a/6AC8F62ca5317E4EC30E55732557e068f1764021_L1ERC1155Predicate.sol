  ...
  ERC1155Holder
{
  ...
  function initialize(address _multisig, address _registry, address _l2Predicate) public initializer {
  ...
  // verified
  function _initiateDeposit(address _l1Token, address _from, address _to, uint256[] memory _ids, uint256[] memory _amount) internal {
