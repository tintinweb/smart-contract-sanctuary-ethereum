...
contract PunnyPickles is ERC721Enumerable, Pausable, Ownable {
    ...
    function safeMint(address to, uint256 _numTokens) public payable {
        ...
        require(balanceOf(msg.sender) + _numTokens <= MAX_MINT, "The specified address already holds the maximum number of mintable NFTs.");
    ...
    function setSupply(uint _MAX_SUPPLY) external onlyOwner {
        if (_MAX_SUPPLY <= 5555 && _MAX_SUPPLY > _tokenIdCounter.current()) {
