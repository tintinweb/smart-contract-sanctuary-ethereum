    ...
    OwnableUpgradeable
{
    ...
    function mint(
        ...
        _incrementTokenId();
        _tokenBalances[tokenId] = _tokenBalances[tokenId] + balance;
     ...
     **/
    function mintServerDropNFT(address claimer, bytes memory data, NFTVoucher calldata voucher)
        public onlyProxy
    {
        uint256 tokenId = getNextTokenId();
        ...
        _incrementTokenId();
        _tokenBalances[tokenId] = _tokenBalances[tokenId] + voucher.balance;
    ...
    /**
     * @notice Transfer specified token.
