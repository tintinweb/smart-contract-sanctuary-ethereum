...
contract PadealCash is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint8 public buyReward = 7;
    uint8 public sellReward = 7;
    ...
    constructor()  ERC20("PadelCash", "PLD") {
...
//0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        _mint(owner(),  43 * 10 **7 * 10**18);
        _mint(address(this),  7 * 10**7 * 10**18);
    }
