...
contract BettingAdmin is Storage, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function createPool(uint256 numberOfTeams_, string memory eventName_, uint256 startTime_, uint256 duration_, address mint_, string[] memory teams_) external onlyRole(ADMIN_ROLE) {
