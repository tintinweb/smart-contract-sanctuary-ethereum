    ...
    UUPSUpgradeable
{
    ...
    function purchase(uint id) public onlyOwner idcheck(id) {
        IndexInterface(indexAddressArray[id]).purchase();
    }

    function sell(uint id) public onlyOwner idcheck(id) {
        IndexInterface(indexAddressArray[id]).sell(feeGetter);
    }

    function rebalancePurchase(uint id) public onlyOwner idcheck(id) {
        IndexInterface(indexAddressArray[id]).rebalancepurchase();
    }

    function rebalanceSell(uint id) public onlyOwner idcheck(id) {
        IndexInterface(indexAddressArray[id]).rebalancesell();
    }

    function deposit(uint id, uint amount) public onlyOwner idcheck(id) {
    ...
    function stake(
        ...
        IndexInterface(indexAddressArray[id]).stake(target, _func, token);
    }
    ...
    function approvetoken(uint id, address _stakingContract,address token)
        public
        onlyOwner
        idcheck(id)
    {
        IndexInterface(indexAddressArray[id]).approvetoken(_stakingContract,token);
    }
...
interface IndexInterface {
    ...
    function approvetoken(address _stakingContract, address token) external;
