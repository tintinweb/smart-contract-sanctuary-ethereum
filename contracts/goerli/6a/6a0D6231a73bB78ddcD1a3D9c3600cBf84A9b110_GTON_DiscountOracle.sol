...
import { iGTON_DiscountOracle } from "./iGTON_DiscountOracle.sol";
import { Lib_AddressResolver } from "../libraries/resolver/Lib_AddressResolver.sol";

contract GTON_DiscountOracle is iGTON_DiscountOracle, Lib_AddressResolver{
    ...
    modifier onlyManager() {
        require(
            ...
            "GTON_DiscountOracle: Function can only be called by the GCD_MANAGER."
        );
        _;
    }
...
interface iGTON_DiscountOracle{
