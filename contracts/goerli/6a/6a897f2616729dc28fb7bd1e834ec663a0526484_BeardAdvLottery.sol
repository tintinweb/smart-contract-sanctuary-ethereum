...
contract BeardAdvLottery is VRFConsumerBaseV2 {
    ...
    uint256 public _mintBet = 0.001 ether; // 單注金額 # 1000000000000000 wei
    uint256 public _minPick = 0.002 ether; // 開獎需達成的金額 # 2000000000000000 wei
    ...
    event RewardLottery(uint256 _round, address _to, uint256 _prize);
