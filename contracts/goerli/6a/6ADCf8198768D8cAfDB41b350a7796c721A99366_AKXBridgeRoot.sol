...
import {FxBaseRootTunnel} from "../vendor/fx-portal/tunnel/FxBaseRootTunnel.sol";
import {Create2} from "../vendor/fx-portal/lib/Create2.sol";
import {SafeMath} from "../vendor/fx-portal/lib/SafeMath.sol";
import {FxERC20} from "../vendor/fx-portal/tokens/FxERC20.sol";
...
contract AKXBridgeRoot is FxBaseRootTunnel, Create2 {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    bytes4 public constant DEPOSIT = bytes4(keccak256("DEPOSIT"));

    mapping(address => address) public rootToChildTokens;
    address public rootTokenTemplate;
    bytes32 public childTokenTemplateCodeHash;

    constructor(address _rootTokenTemplate)
    ...
    function _processMessageFromChild(bytes memory data) internal override {
        ...
        if (
            ...
            require(
                ...
                "FxMintableERC20RootTunnel: ROOT_TOKEN_CREATION_MISMATCH"
            );
        }
