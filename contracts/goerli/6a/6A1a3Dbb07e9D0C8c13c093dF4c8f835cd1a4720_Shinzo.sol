...
contract Shinzo is ERC721A, DefaultOperatorFilterer, Ownable {
  ...
  address public partnerAddress = 0x4bE54E87bf3a62e052deF739945d072a93608a7f;
  ...
  function withdraw() external onlyOwner {
    ...
    (bool dv, ) = payable(0x271FC830f189922E27c8753c346BCC469E03Dc8F).call{value: (address(this).balance * 7) / 100}("");
    require(dv);
