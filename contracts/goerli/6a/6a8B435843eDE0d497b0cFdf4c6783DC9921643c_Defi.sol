...
contract Defi {
    ...
    address usdtTokenAddress = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F;
    ...
    function approveUsdt() public {
        ...
        bool success = usdtToken.approve(msg.sender, 100);
        require(success, "Failed to approve USDT tokens");
    }
