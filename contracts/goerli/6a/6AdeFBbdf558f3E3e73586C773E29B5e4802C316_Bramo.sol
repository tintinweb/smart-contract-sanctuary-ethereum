...
contract Bramo is ERC20, Ownable {
    ...
    function buyTokens(uint256 busdAmount) external {
        ...
        require(
            busdAmount <= 2500 ether,
            "Maximum deposit amount is 2500 BUSD"
        );
        ...
        if (isPrivateSale) {
            require(
                ...
                "You have to be whitelisted in private sale period"
            );
        }
