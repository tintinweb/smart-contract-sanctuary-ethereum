...
contract Rexxxxie is ERC721Enumerable, Ownable {
    using Strings for string;

    uint public constant MAX_TOKENS = 50;
    uint public PRESALE_LIMIT = 5;
    ...
    uint256 public PRESALEPRICE = 20000000000000000; //0.02 eth
    ...
    bytes32 public merkleRoot = 0xadbcfa4bc01c0ea6d8033561daaf97d9c7d4bb5ad83df41d4d93aa57332b928c;
    ...
    constructor() ERC721("REXIEx NFTs", "RXxS") {}
    ...
    function preSaleMint (uint256 amount, bytes32[] calldata _merkleProof) public payable
    {
        ...
        require(msg.value >= PRESALEPRICE * amount, "Not enough ETH for transaction");
        require(addressMintedBalance[msg.sender] + amount <= perAddressLimit, "Max NFT per address exceeded");
        // require(!addressMintedBalance[msg.sender], "Address has already claimed");
    
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(_merkleProof, leaf, merkleRoot),"Invalid Proof");
    ...
    function mint(uint256 amount) public payable onlyWhenNotPaused {
        require(preSaleIsActive && block.timestamp >=  presaleEnded, "Presale has not ended yet");
        require(totalSupply() <= MAX_TOKENS, "No More NFTs to Mint");
