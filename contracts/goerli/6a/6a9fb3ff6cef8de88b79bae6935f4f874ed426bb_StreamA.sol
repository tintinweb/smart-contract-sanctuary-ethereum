...
contract StreamA is Ownable, ERC721Royalty {
    ...
    address[] public approvedcollections = [
        0xBE44B56bf60b5eE6141345C2B1380BeA2915d991,
        0x417c365aA28d36614ADEE085A7cF295F4dfAe43c,
        ...
        0xeE4446483Fb92B6D21488Fd4937053A09a53b7b6,
        ...
        0x4be16F296eC5d579882F104721fC99cc9562ac91,
        0x1343b286f44aac0afEc4F079E8EFd7eE23276434,
        0xDFBe0317Ce520b4958a2F13dbAa9da8CECB72FB5,
        0x1D07749A72e8F66FBe626e3d66B7c6A257a4CF86,
        0x5275916a9Db5b7A04A557A4Ad0CC1330ECbE4F68,
    ...
    */
    ...
    function walletHoldsToken(address _wallet) internal view returns (bool) {
        address[] memory _approvedcollections = approvedcollections;
        uint256 contractLength = _approvedcollections.length;
        bool results = false;
        while (!results) {
            for (uint256 i = 0; i < contractLength; i = unsafe_inc(i)) {
                address contractaddress = _approvedcollections[i];
