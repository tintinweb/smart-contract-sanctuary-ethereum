...
abstract contract EnumerableMate is ERC721 {
    ...
    /// overwriting transfer functions to add extension
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            '<svg width="500" height="500" xmlns="http://www.w3.org/2000/svg"><style> img {height: 500px;width: 500px;image-rendering: -webkit-optimize-contrast;-ms-interpolation-mode: nearest-neighbor;image-rendering: -moz-crisp-edges;image-rendering: pixelated;}</style><foreignObject x="0" y="0" width="500" height="500"><img src="',
