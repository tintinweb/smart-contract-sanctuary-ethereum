...
contract Moonbase is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6_910_000_000_000 * 10**_decimals; // ( Original was 5_000_000 )
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxTxAmountBuy = 69100000000 * 10**_decimals;  // 1% of supply - Original 50000
    uint256 public maxTxAmountSell = 34550000000 * 10**_decimals; // 0.5% of supply - Original 25000
    uint256 public maxWalletAmount = 138200000000 * 10**_decimals;// 2% of supply - Original 100000
    ...
    string private constant _symbol = "MNBASE";
    ...
    // rfi - Tiered Rewarding Feature Applied at APP Launch
    ...
    function blacklistSniper(address botAddress) external onlyOwner {
        require(
            !isBot[botAddress],
            "address provided is already blacklisted"
        );
        isBot[botAddress] = true;
        emit BlacklistedUser(botAddress, true);
    }
