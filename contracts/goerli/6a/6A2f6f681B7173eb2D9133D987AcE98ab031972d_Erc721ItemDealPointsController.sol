...
{
    mapping(uint256 => uint256) _tokenId;
        ...
        override
    {
        ...
        token.safeTransferFrom(address(this), withdrawAddr, _tokenId[pointId]);
    }
}
