...
/**
 * @title GalleassTranspierced
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract GalleassTranspierced is ERC20Burnable, ERC20Permit, ReentrancyGuard {
    address private _owner;

    constructor() ERC20("Galleass Transpierced","GTAC")  ERC20Permit("Galleass Transpierced") { 
        _owner = _msgSender();
     }
