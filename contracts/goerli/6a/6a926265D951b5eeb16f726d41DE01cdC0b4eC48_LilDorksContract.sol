...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x855003927b801b40EF06D5EaEbfa34BaE0D127dC];
  address public erc20Payable = 0x855003927b801b40EF06D5EaEbfa34BaE0D127dC;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmThBwKTjCJ9iQLkzXB7butpAwm7cWmVPPdxE9R2fqH7Gv/";
...
// File: contracts/LilDorksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LilDorksContract is RamppERC721A {
    constructor() RamppERC721A("Lil Dorks", "DORK"){}
}
