...
contract VialMint is ERC1155, ERC1155Burnable, IERC2981, Ownable, ReentrancyGuard {
    ...
    string public name = "Test Vial Mint";
    string public symbol = "TVM";
    string public constant _baseURI = "https://assets.baako.com/voyager/vial/metadata.json";

    address private creator;
    address private collectionContractAddress;
    address private royaltiesAddress = 0x4377BEEF614c12dCc814bE4cAa7Cd732a2a48d89;
    address private withdrawAddress = 0x4377BEEF614c12dCc814bE4cAa7Cd732a2a48d89;
    ...
    constructor(address payable owner) ERC1155(_baseURI) {
        ...
        listsData[11] = listParameters(0xffcf42a4f71cca202bbb8332b98c87af8e941b7b37e13a906660201351702d17, 0 ether);
    ...
    modifier verifyProof(bytes32[] calldata _merkleProof, uint _maxAmount, uint256 _listId) {
        ...
        require((MerkleProof.verify(_merkleProof, listsData[_listId]._root, leaf) || _listId == 3), "Invalid proof of inclusion.");
	    _;
    }
