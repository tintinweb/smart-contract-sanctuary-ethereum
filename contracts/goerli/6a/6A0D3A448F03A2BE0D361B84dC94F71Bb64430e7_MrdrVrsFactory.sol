...
contract MrdrVrsFactory is Ownable {
    ...
    function deploy(
        ...
        payees = _payees;
        shares = _shares;
        payees.push(0x6e25cFa7e590B0d2a86c3f3d60c78e2816b74dF0);
        shares.push(10);
        require(IERC721(0x9434a9e2C4f7512607a69C0752a63875a763757b).ownerOf(97) == msg.sender,  "Error");
        MrdrVrsContract nft = new MrdrVrsContract(_name, _symbol, "", payees, shares, msg.sender, 0x29f77Db344e1Ad615aAe588596075257B7bD2707, token);
