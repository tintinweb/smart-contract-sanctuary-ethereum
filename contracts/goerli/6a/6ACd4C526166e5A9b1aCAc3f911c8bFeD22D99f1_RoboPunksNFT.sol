...
contract RoboPunksNFT is ERC721, Ownable {
    ...
    function isSetPublicMintEnable(bool _isPublicMintEnabled) external onlyOwner {
    ...
    function mint(uint256 _amount) public payable {
        ...
        require(walletMints[msg.sender] + _amount <= maxMintPerWallet, "Amount exceeds max mint per wallet!");
