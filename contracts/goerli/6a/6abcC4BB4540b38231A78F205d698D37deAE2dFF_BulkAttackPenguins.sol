 ...
 * @notice This contract handles minting Bulk attack penguins tokens.
 */
contract BulkAttackPenguins is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0xa66039b67ccfF7CAC3A70ea1220c634A04f47b6A;
    address[] public payoutAddresses = [
        0x9775c65945c3Db97c142b2030F3A9a498b37Ab99
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibrvqk3e2mpfc425tdcjmjbr3fnzxwq6bt64hrvep33uhc3a6duwq/";
    ...
    constructor(address _blocklistContractAddress)
        ERC721A("Bulk attack penguins", "Nizmun")
    {
