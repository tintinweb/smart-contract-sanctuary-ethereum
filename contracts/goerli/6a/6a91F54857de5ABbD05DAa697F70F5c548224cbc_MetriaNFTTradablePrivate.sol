...
/**
 * @title MetriaNFTTradablePrivate
 * MetriaNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract MetriaNFTTradablePrivate is ERC721, Ownable {
    ...
    */
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Metria auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Metria contracts to enable gas-less listings.
     */
