...
// File contracts/farm/SafeOwnable.sol
...
// File contracts/mock/MockKIKIToken.sol



pragma solidity ^0.8.0;
contract MockKIKIToken is ERC20Capped, SafeOwnable {
    ...
    constructor() ERC20Capped(MAX_SUPPLY) ERC20("MOCK_KIKI", "MK") SafeOwnable(msg.sender) {
        addMinter(msg.sender, type(uint).max);
    }
