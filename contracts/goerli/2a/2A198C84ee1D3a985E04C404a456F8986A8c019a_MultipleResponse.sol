...
contract MultipleResponse is ChainlinkClient, ConfirmedOwner {
    ...
    constructor() ConfirmedOwner(msg.sender) {
        ...
        setChainlinkOracle(0x3A4Ba320d3C61f9D4abbD913Ee76cb7878579154);
        jobId = 'dc0b327c3b5e4cd3901087c32fc2ae57';
    ...
    function requestMultipleParameters() public {
        ...
        req.add('get', 'https://min-api.cryptocompare.com/data/price?fsym=ETH&tsyms=BTC');
        req.add('path', 'BTC');
