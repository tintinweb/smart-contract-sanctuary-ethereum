...
//    |/       \_______/(_______)|/    )_)                                                            //
//                                                                                                    //
//     _        _______  _______  _        _______  ______   _______    _        _______ _________    //
//    ( \      (  ___  )(  ____ \( \      (  ___  )(  ___ \ (  ____ \  ( (    /|(  ____ \\__   __/    //
//    | (      | (   ) || (    \/| (      | (   ) || (   ) )| (    \/  |  \  ( || (    \/   ) (       //
//    | |      | |   | || |      | |      | |   | || (__/ / | (__      |   \ | || (__       | |       //
//    | |      | |   | || | ____ | |      | |   | ||  __ (  |  __)     | (\ \) ||  __)      | |       //
//    | |      | |   | || | \_  )| |      | |   | || (  \ \ | (        | | \   || (         | |       //
//    | (____/\| (___) || (___) || (____/\| (___) || )___) )| (____/\  | )  \  || )         | |       //
//    (_______/(_______)(_______)(_______/(_______)|/ \___/ (_______/  |/    )_)|/          )_(       //
//                                                                                                    //
//                                                                                                    //
//                                                                                                    //
//                                                                                                    //
...
contract PION is ERC1155Creator {
    constructor() ERC1155Creator("Pion LoGlobe", "PION") {}
}
