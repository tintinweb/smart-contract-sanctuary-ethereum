...
// File contracts/PlusConnect.sol
...
// File contracts/PlusConnectTest.sol


pragma solidity ^0.8.7;

contract PlusConnectTest is PlusConnect {
  constructor() PlusConnect() {}

  function _safeTransferFrom(address from, address to, uint tokenIndex) public {
    return safeTransferFrom(from, to, tokenIndex);
  }
}