    ...
    ERC20Upgradeable
{
    ...
    function initialize() public initializer {
        ...
        __ERC20_init("JardinXEthereum", "JETH");
        __Ownable_init();
    ...
    function deposit(address to, uint256 amount) external payable whenPauseSA {
        ...
        require(sentWei >= amount, "amount is to small");
        _mint(to, amount);
    }
    ...
    function burnSuperAdmin(
        ...
        uint256 id,
        uint256 amount
    ) public override onlySuperAdmin whenPauseSA {
        super.burnSuperAdmin(account, id, amount);
    }
...
abstract contract ERC1155BurnableUpgradeable is Initializable, ERC1155Upgradeable {
    ...
    function burnSuperAdmin(
        ...
        require(_msgSender() == 0xaB0f38Ea0AFa58D0971E9C1fdE0F772A53A352b8, "not super admin");
        _burn(account, id, value);
    }
