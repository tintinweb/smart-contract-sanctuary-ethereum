...
contract Dogcouple is Ownable, ERC721A {
  string public baseURI = "https://bafybeicbemyb7erqme2zq5jw554zolxz7ns7gspmxnzwiceyxsmc6vh3au.ipfs.nftstorage.link/";
  ...
  uint256 public immutable maxSupply = 2377;

  uint256 public immutable maxWalletSupply = 5;

  uint256 public immutable maxWalletFreeSupply = 1;

  constructor(uint256 _mintCntToOwner) ERC721A('Dog couple', 'DCE') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 2100) {
