...
// File: contracts/BuckBuddies.sol
...
contract BuckBuddies is ERC721Enumerable, Ownable, Pausable {
    ...
    string public baseURI = "ipfs://QmZ5ZaWLWx6pXZhQgCmgQFJb7bGzdBwWwvysWW3VkgYAs7/";
  ...
  function setWallet(address _wallet) external onlyOwner{
    ...
    function setCharityWaller(address _wallet) external onlyOwner{
  ...
  function mint(address recpt, uint256 value) internal  whenNotPaused  {
    ...
    require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded");
     ...
     payable(marketWallet).transfer(value);
