...
contract atak721 is  ERC721Upgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    address constant SNContract = 0x0900de010acEeA49b5787F31279Ba0f90eb8180b;
    address constant souvenirNFTAddress = 0x8D9b961989c98Dcb46037EbC4c67683CCd0fFe28;//DEĞİŞ
    ...
    function mint(uint256[] calldata tokenIds) external hasSN(msg.sender){
        ...
        IMinter(souvenirNFTAddress).mint(to);
    }
