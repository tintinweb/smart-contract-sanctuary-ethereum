...
contract tomiStaking{
   ...
   constructor (IERC20 _tomi) {
    ...
    function stakeForPioneer(uint amountToStake ) public {
        ...
        stakesForPioneer[msg.sender][stakerIndexPioneer[msg.sender]].endTime =block.timestamp+12*15552000; 
        
        stakerIndexPioneer[msg.sender]++;
       
        amountToStake == 0 ? PioneerNFT.mintPioneer(msg.sender) : MiniPioneerNFT.mintMiniPioneer(msg.sender);
    ...
    // function calculateReward2()  public {
