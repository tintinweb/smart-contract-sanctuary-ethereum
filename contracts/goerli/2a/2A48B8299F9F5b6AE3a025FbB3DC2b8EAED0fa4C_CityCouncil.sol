...
contract CityCouncil is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    IERC721 public MetaTopiaCityCouncil = IERC721(0x3dE412E1Db31529F327a3E5bD9F3620B09F570fB);
    ...
    address public TOPIA = 0x649E1135b1232b68468A354f36DBfcE32813D49a;
    address payable dev;
    ...
    function claimCouncilMembers(uint16[] calldata _ids, bool unstake) external payable nonReentrant notContract() {
        ...
        for (uint i = 0; i < length;) {
            ...
            CouncilStake[_ids[i]].value = uint16(block.timestamp); // reset value
            unchecked { i++; }
        }
        if (unstake) {
            NumberOfStakedCouncilMembers[msg.sender] -= length;
