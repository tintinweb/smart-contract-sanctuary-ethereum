...
contract AlienPad is IERC20, Auth {
    ...
    string private constant  _name = "AlienPad";
    ...
    address payable public marketingWallet = payable(0x469C2B9767A97AcCB21AdEf522B811f25c5c08A8);
    ...
    uint256 public numTokensSellToAddToLiquidity = 500000 * 10**_decimals;
    ...
    function setFee (uint256 _sellFeeRate, uint256 _buyFeeRate) external onlyOwner {
        require (_sellFeeRate <= 30, "Fee can't exceed 30%");
