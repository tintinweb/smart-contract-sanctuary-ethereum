...
contract BridgeEth is Ownable, ReentrancyGuard {
    ...
    enum SourceChainTokensAvailable{ ETH, BNB, TOKEN }
    enum DestinationChainTokensAvailable{ ETH, BNB, TOKEN }
    ...
    event LockedEther(address _from, address _to,  SourceChainTokensAvailable tokensAvailableFromSourceChain, DestinationChainTokensAvailable tokensAvailableFromDestinationChain, uint256 indexed _value);
    ...
    function lockEther(
        ...
        emit LockedEther(msg.sender, address(this), tokensAvailableFromSourceChain, tokensAvailableFromDestinationChain, value);
