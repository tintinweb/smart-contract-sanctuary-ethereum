...
contract RiftRoot is Initializable, RiftRootGP {
    ...
    function transferToL2(
    ...
    ) external onlyEOA whenNotPaused contractsAreSet {
        ...
        bytes memory message = _getMessageForChild(
            _gpAmount,
            _wndTokenIds,
            _saIds,
            _saAmounts
    ...
    function _getMessageForChild(
        ...
        if (_saIds.length > 0) {
            ...
            sacrificialAlter.safeBatchTransferFrom(
                msg.sender,
                address(this),
                _saIds,
                _saAmounts,
...
abstract contract RiftRootContracts is Initializable, RiftRootState {
    ...
    modifier contractsAreSet() {
        require(address(gp) != address(0)
            ...
            && address(rootTunnel) != address(0), "Contracts aren't set");
