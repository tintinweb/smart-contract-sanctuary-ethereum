...
contract MSSContractFactory {
  ...
  function initialize(address _treasury) initializer external {
    require(_treasury != address(0), "Initializable: treasury address is not valid");
    //require(_treasury.isContract(), "Initializable: treasury address is not a contract");
  ...
  function contractMoneypipe(uint256 id, Member[] calldata members) external returns (address contractAddress) {
