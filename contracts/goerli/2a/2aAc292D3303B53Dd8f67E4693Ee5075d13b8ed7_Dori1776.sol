...
interface IDoriStaking {
    function getBurnedTokens(address _owner, address _contract)
        external
        view
    ...
    DefaultOperatorFilterer
{
    ...
    function balanceOBurned(address _owner) external view returns (uint256) {
        return
            IDoriStaking(doriStaking)
                .getBurnedTokens(_owner, address(this))
                .length;
    }
