    ...
    ILoyaltyLedger2
{
    ...
    function exists(uint256 _id) public view returns (bool) {
        uint256 currentCounter = _tokenTypeCounter.current();
        if (currentCounter == 0 || currentCounter <= _id) {
            return false;
        }
        return true;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (address(beforeTransfersModule) != address(0)) {
            beforeTransfersModule.beforeTokenTransfers(_msgSender(), from, to, ids, amounts);
        }
