...
contract AMM_VPT2MMT {
    ...
    uint public reserveVPT;
    uint public reserveMMT;
    ...
    function swapVPT2MMT(uint amount) external {
        ...
        reserveVPT = IERC20(token1).balanceOf(address(this));
        reserveMMT = IERC20(token2).balanceOf(address(this));    
        ...
        IERC20(token2).approve(address(this), amount);
    ...
    function addLiquidity(uint amount1, uint amount2) external {
        ...
        IERC20(token2).approve(address(this), amount2);
