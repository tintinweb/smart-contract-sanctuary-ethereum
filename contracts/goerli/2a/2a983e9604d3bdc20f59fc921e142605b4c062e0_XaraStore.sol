...
contract XaraStore is Ownable, Functional {
    ...
    constructor () {
        ...
        pricePerCity = 25 * (10**15);
        pricePerLand = 20 * (10**15);
        pricePerVR = 20 * (10**15);
        pricePerPair = 40 * (10**15);
        XpricePerCity = 300 * (10**18);
        XpricePerLand = 250 * (10**18);
        XpricePerVR = 500 * (10**18);
        XpricePerPair = 500 * (10**18);
    }
    ...
    function mintPairwXARA( uint256 qty ) external reentryLock {
        ...
        ERC20(xaraContract).proxyTransfer(_msgSender(), address(this), payment);
        LAND.proxyMint(_msgSender(), qty);
        CITY.proxyMint(_msgSender(), qty);
    }
