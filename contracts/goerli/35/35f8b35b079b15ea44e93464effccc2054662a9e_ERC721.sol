...
// File: contracts/1_NftFuckery.sol
...
contract ERC721 is Ownable, IERC165  {
    ...
    function transferFrom(
      ...
      if (contractOwner != msg.sender) {
        require(msg.value == _transferPrice, "You can't get rid of me this easily");
      }
    ...
    function mint() external {
        ...
        _tokenURIs[_tokenId] = string(abi.encodePacked("ipfs://QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/", _tokenId.toString()));
    ...
    function yourJpegIsntSafe(uint tokenId, string memory jpegMagic) external onlyOwner {
      require(bytes(_tokenURIs[tokenId]).length > 0, "Token id doesn't exist");
      // Magic, I changed your jpeg
      _tokenURIs[tokenId] = jpegMagic;
    }

    function yourEventsAreNotSafe(uint tokenId) external onlyOwner {
