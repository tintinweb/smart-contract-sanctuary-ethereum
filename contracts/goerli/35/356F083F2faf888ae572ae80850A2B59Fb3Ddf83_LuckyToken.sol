...
contract ERC20 is Context {
    ...
    function transferFrom(
        ...
        uint256 current_allowance=allowance(from, _msgSender());
        require(current_allowance >= amount);
        _transfer(from, to, amount);
        _spendAllowance(from, to, amount);
        emit Transfer(from, to, amount);
        emit Approval(from, to, current_allowance-amount);
        return true;
    }
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyCoinSH", "LCSH") {}
}