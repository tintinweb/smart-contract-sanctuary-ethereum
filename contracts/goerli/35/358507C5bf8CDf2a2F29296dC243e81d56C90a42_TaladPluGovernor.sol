...
contract TaladPluGovernor is Governor, GovernorVotes, GovernorTimelockCompound, GovernorSettings, GovernorCountingSimple {

    constructor(IVotes _nft, ICompoundTimelock _timelock, uint256 _votingDelay, uint256 _votingPeriod, uint256 _proposalThreshold, uint256 _quorum)
    Governor("TaladPluDao")
    GovernorVotes(_nft)
    GovernorSettings(_votingDelay, _votingPeriod, _proposalThreshold, _quorum)
    GovernorTimelockCompound(_timelock)
    {}    


    function quorum(uint256 blockNumber) public view override(IGovernor, GovernorSettings) returns(uint256) {
...
abstract contract GovernorSettings is Governor {
    ...
    function quorum(uint256 blockNumber) public virtual view override returns(uint256) {
        return _quorum;
    }
