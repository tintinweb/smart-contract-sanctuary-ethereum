...
/**
 * @title SensillaSkeletonisingToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract SensillaSkeletonisingToken is ERC20Snapshot, Pausable, ERC165 {
    address private _owner;

    constructor() ERC20("Sensilla Skeletonising Token","NLK")   { 
        _owner = _msgSender();
     }
