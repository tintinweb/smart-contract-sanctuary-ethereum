...
contract FIREFLY is Context, IERC20, Ownable {
	...
	address public constant swaprouter = address(0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45);
    ...
    string private _symbol = "FIREFLY V1";
	...
	bool public addLiquidityEnable = true;
	...
	function setAddLiquidityEnable(bool _enabled) public onlyOwner {
        addLiquidityEnable = _enabled;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (canSwap && !swapping && _automatedMarketMakerPairs[to] && swapAndLiquifyEnabled) 
		{
			...
			if(newBalance > 0 && addLiquidityEnable)
			{
