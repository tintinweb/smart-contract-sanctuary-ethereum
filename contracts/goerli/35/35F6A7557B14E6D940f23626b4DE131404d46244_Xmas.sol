...
contract Xmas is ERC721Tradable {
    ...
    string private constant TX_1     = '</text></g><g stroke="none" stroke-width="1" font-family="ArialMT, Arial" font-size="40" font-weight="normal" letter-spacing="0.0166" line-spacing="79"><text x="50%" y="930" dominant-baseline="middle" text-anchor="middle" fill="#FFFFFF">';
    ...
    constructor(address _proxyRegistryAddress) ERC721Tradable("DonateXMas", "XMAS", _proxyRegistryAddress) {
        ...
        // Hat
        ICONS[5][1] = '<path d="m219 604 4.418-22.1C284.678 275.35 411.178 211 506.51 211c69.681 0 146.008 34.207 226.878 101.65l50.011 41.71-64.437-9.226c-21.431-3.067-39.967-4.62-55.12-4.62-29.233 0-42.305 5.79-44.828 11.21-10.154 21.827 49.075 92.324 88.28 138.973 24.249 28.862 49.335 58.709 66.566 84.577L793 604H219Z" fill="';
        ICONS[5][2] = '"/><path d="M794.658 418.77c-30.512 0-55.342-24.85-55.342-55.385 0-30.536 24.83-55.385 55.342-55.385S850 332.85 850 363.385c0 30.535-24.83 55.384-55.342 55.384ZM241.237 788C190.37 788 149 746.597 149 695.692c0-50.905 41.37-92.307 92.237-92.307h516.526c50.866 0 92.237 41.402 92.237 92.307S808.63 788 757.763 788H241.237Z" fill="';
        ICONS[5][3] = '"/><path d="M241.7 807h516.599C819.442 807 869 757.429 869 696.267c0-44.084-25.942-81.819-63.223-99.645-4.6-10.667-9.9-21.249-16.776-31.56-17.786-26.686-43.186-56.904-67.736-86.112-27.675-32.913-77.49-92.167-84.045-117.056 4.39-1.206 12.521-2.622 26.408-2.622 14.304 0 31.98 1.49 52.558 4.43 1.746.246 3.492.369 5.214.369 0 40.773 33.039 73.821 73.8 73.821 40.761 0 73.8-33.048 73.8-73.821 0-40.774-33.039-73.822-73.8-73.822-16.752 0-32.029 5.795-44.427 15.22-1.734-2.35-3.431-4.737-5.757-6.657C660.811 228.607 580.553 193 506.52 193c-102.164 0-237.328 66.833-300.992 385.3-.96 4.812-1.107 9.549-1.699 14.322C161.43 608.137 131 648.48 131 696.267 131 757.43 180.557 807 241.7 807Zm553.499-479.84c20.343 0 36.9 16.56 36.9 36.91 0 20.35-16.557 36.91-36.9 36.91-20.344 0-36.9-16.56-36.9-36.91 0-20.35 16.556-36.91 36.9-36.91Zm-288.694-97.25c65.067 0 137.748 32.938 214.894 97.248-22.891-3.274-41.98-4.799-57.773-4.799-162.408.025 27.417 162.261 94.673 263.174h-516.6C289.78 345.048 384.848 229.9 506.506 229.911ZM241.7 622.447h516.599c40.688 0 73.8 33.109 73.8 73.821 0 40.7-33.112 73.822-73.8 73.822h-516.6c-40.687 0-73.8-33.121-73.8-73.822 0-40.7 33.113-73.821 73.8-73.821Z" fill="';
        ICONS[5][4] = '"/><path fill="';
        ICONS[5][5] = '"></path>';
        ...
        // // Luca Snowman
        ICONS[9][1] = '<defs><path id="a" d="M95 95h810v810H95z"/></defs><mask id="b" fill="white"><use xlink:href="#a"/></mask><g/><circle fill="';
        ICONS[9][2] = '" mask="url(#b)" cx="500.75" cy="297.5" r="202.5"/><path fill="';
        ICONS[9][3] = '" mask="url(#b)" transform="rotate(90 601.625 297.5)" d="m601.625 195.875 37.5 203.25h-75z"/><path d="M905 905H95c0-27.464 2.75-54.86 8.228-81.773a403.927 403.927 0 0 1 60.94-145.086 406.285 406.285 0 0 1 178.187-147.005 402.443 402.443 0 0 1 76.023-23.643 408.214 408.214 0 0 1 163.244 0 402.384 402.384 0 0 1 144.818 61.05C838.238 643.996 905.174 770.123 905 905Z" fill="';
        ICONS[9][4] = '" mask="url(#b)"/><path fill="';
        ICONS[9][5] = '"></path>';


        // Luca Ball
        ICONS[10][1] = '<path d="M920 500.852H80a425.15 425.15 0 0 1 8.533-84.802 418.887 418.887 0 0 1 63.196-150.46 421.332 421.332 0 0 1 184.788-152.45 417.349 417.349 0 0 1 78.838-24.517 423.334 423.334 0 0 1 169.29 0 417.287 417.287 0 0 1 150.181 63.31C850.765 230.182 920.18 360.98 920 500.853Z" fill="';
        ICONS[10][2] = '"/><path d="M920 500.074H80a425.15 425.15 0 0 0 8.533 84.801 419.249 419.249 0 0 0 24.472 78.985 421.068 421.068 0 0 0 38.724 71.478 423.631 423.631 0 0 0 51.287 62.274 423.177 423.177 0 0 0 62.159 51.381 419.802 419.802 0 0 0 71.343 38.795 417.355 417.355 0 0 0 78.838 24.518A422.349 422.349 0 0 0 500 920.852a422.35 422.35 0 0 0 84.645-8.55 417.349 417.349 0 0 0 78.84-24.517 419.813 419.813 0 0 0 71.342-38.795 423.18 423.18 0 0 0 62.158-51.381 423.625 423.625 0 0 0 51.286-62.275 421.07 421.07 0 0 0 38.724-71.478 419.249 419.249 0 0 0 24.473-78.984A425.155 425.155 0 0 0 920 500.074Z" fill="';
        ICONS[10][3] = '"/><path fill="';
        ICONS[10][4] = '"></path><path fill="';
        ICONS[10][5] = '"></path>';
    ...
    string private constant TEXT_1   = '<g stroke="none" stroke-width="1" font-family="ArialMT, Arial" font-size="83" font-weight="normal" letter-spacing="0.0166" line-spacing="79"><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#FFFFFF">';
    ...
    string[] private COLORS          = [
        ...
        // Greens [3-6]
        '#8FAB70', '#2FA783', '#27906B', '#1E644C',

        // Blues  [7-10]
        '#0E1F4E', '#0B2A69', '#295FB3', '#94BAAF',
