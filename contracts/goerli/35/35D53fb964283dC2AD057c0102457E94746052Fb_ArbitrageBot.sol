...
contract ArbitrageBot is FlashLoanSimpleReceiverBase, AccessControl {
    ...
    function TradeFunction(
        ...
        if (trade3[0] == address(0)) {
            if (trade1[1] == WETH) {
                ...
                //trade1
                uint256 swapedAmount = swapETHtoToken(
                    trade1[0],
                    trade1[2],
                    amount
                );
                ...
                Checktrade(tokenAcquired, (amount));
                ...
                uint256 swapedAmount = swapTokenToEth(
                    trade1[0],
                    trade1[1],
                    amount
                );
                //trade2
                uint256 tokenAcquired = swapETHtoToken(
                    trade2[0],
                    trade2[2],
                    swapedAmount
                );
                ...
                uint256 swapedAmount = swapTokenForToken(
                    trade1[0],
                    trade1[1],
                    trade1[2],
                    amount
            ...
            if (trade1[1] == WETH && trade2[1] != WETH && trade3[1] != WETH) {
                ...
                uint256 swapedAmount1 = swapETHtoToken(
                    trade1[0],
                    trade1[2],
                    amount
                );
                ...
                uint256 swapedAmount1 = swapTokenToEth(
                    trade1[0],
                    trade1[1],
                    amount
                );
                //trade2
                uint256 swapedAmount2 = swapETHtoToken(
                    trade2[0],
                    trade2[2],
                    swapedAmount1
                );
                ...
                uint256 swapedAmount1 = swapTokenForToken(
                    trade1[0],
                    trade1[1],
                    trade1[2],
                    amount
    ...
    function swapETHtoToken(
        ...
        uint256[] memory amounts = IUniswapV2Router01(router)
            .swapExactETHForTokens{value: amount}(
            0,
            path,
            address(this),
            block.timestamp + 300 seconds
