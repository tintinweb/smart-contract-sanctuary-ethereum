...
contract OzV2 is ERC1155, ERC1155CollectionBase {
    ...
    address constant public OZ_V1_ADDRESS = 0xb2c2316a409E52732E525A8AA696CE64acBe1e76;
    ...
    */
    ...
    function exchange(uint16 tokenId) external { 
        ERC1155(OZ_V1_ADDRESS).safeTransferFrom(msg.sender, address(this), tokenId, 1, "0x11");
        _mintERC1155(msg.sender, 1);
    }
