...
import { ERC721ABridgeBRC } from "ERC721BridgeBRC/src/extensions/ERC721ABridgeBRC.sol";
...
contract TougenkyouBTC is AccessControl, ERC2981, ERC721ABridgeBRC {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721ABridgeBRC, ERC2981, AccessControl) returns (bool) {
        return ERC721ABridgeBRC.supportsInterface(interfaceId) || ERC2981.supportsInterface(interfaceId) || AccessControl.supportsInterface(interfaceId);
    }
