...
contract TurkishGalleryArtistDrop is TurkishGalleryArtistDropSplitsAndRoyalties, TurkishGalleryArtistDropBase {
    ...
    // Goerli only
    function reserveSet() external payable onlyOwner {
        //_saveTokenFlavor(_canMint(1, 100000,  false,  10 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 100000);
        _saveTokenFlavor(_canMint(1, 200100,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200100);
        _saveTokenFlavor(_canMint(1, 200101,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200101);
        _saveTokenFlavor(_canMint(1, 200102,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200102);
        _saveTokenFlavor(_canMint(1, 200103,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200103);
        _saveTokenFlavor(_canMint(1, 200104,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200104);
        _saveTokenFlavor(_canMint(1, 200105,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200105);
        _saveTokenFlavor(_canMint(1, 200106,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200106);
        _saveTokenFlavor(_canMint(1, 200107,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200107);
        _saveTokenFlavor(_canMint(1, 200108,  false,  6 ether     )); _internalMintTokensOfFlavor(msg.sender, 1, 200108);
        _saveTokenFlavor(_canMint(1, 200109,  false,   6 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200109);
        _saveTokenFlavor(_canMint(1, 200200,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200200);
        _saveTokenFlavor(_canMint(1, 200201,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200201);
        _saveTokenFlavor(_canMint(1, 200202,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200202);
        _saveTokenFlavor(_canMint(1, 200203,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200203);
        _saveTokenFlavor(_canMint(1, 200204,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200204);
        _saveTokenFlavor(_canMint(1, 200205,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200205);
        _saveTokenFlavor(_canMint(1, 200206,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200206);
        _saveTokenFlavor(_canMint(1, 200207,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200207);
        _saveTokenFlavor(_canMint(1, 200208,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200208);
        _saveTokenFlavor(_canMint(1, 200209,  false,   3.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 1, 200209);
        _saveTokenFlavor(_canMint(1, 200300,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200300);
        _saveTokenFlavor(_canMint(1, 200301,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200301);
        _saveTokenFlavor(_canMint(1, 200302,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200302);
        _saveTokenFlavor(_canMint(1, 200303,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200303);
        _saveTokenFlavor(_canMint(1, 200304,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200304);
        _saveTokenFlavor(_canMint(1, 200305,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200305);
        _saveTokenFlavor(_canMint(1, 200306,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200306);
        _saveTokenFlavor(_canMint(1, 200307,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200307);
        _saveTokenFlavor(_canMint(1, 200308,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200308);
        _saveTokenFlavor(_canMint(1, 200309,  false,   2 ether    )); _internalMintTokensOfFlavor(msg.sender, 1, 200309);
        _saveTokenFlavor(_canMint(3, 300100,  false,   0.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 3, 300100);
        _saveTokenFlavor(_canMint(3, 300101,  false,   0.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 3, 300101);
        _saveTokenFlavor(_canMint(3, 300102,  false,   0.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 3, 300102);
        _saveTokenFlavor(_canMint(3, 300103,  false,   0.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 3, 300103);
        _saveTokenFlavor(_canMint(3, 300104,  false,   0.5 ether  )); _internalMintTokensOfFlavor(msg.sender, 3, 300104);
        _saveTokenFlavor(_canMint(2, 400100,  false,   0.2 ether  )); _internalMintTokensOfFlavor(msg.sender, 2, 400100);
        _saveTokenFlavor(_canMint(2, 400101,  false,   0.2 ether  )); _internalMintTokensOfFlavor(msg.sender, 2, 400101);
        _saveTokenFlavor(_canMint(2, 500000,  false,   0.06 ether )); _internalMintTokensOfFlavor(msg.sender, 2, 500000);
    }
}
