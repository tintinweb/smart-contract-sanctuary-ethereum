...
contract IDOContract is Ownable, ReentrancyGuard {
    ...
    function verifySignature(
        ...
        bytes32 messageHash = keccak256(
            abi.encodePacked(_buyer, _currency, _amountIn, _amountOut, _cohort, _price, _validBefore, _nonce)
        );
    ...
    function buy(
        ...
        require(
            verifySignature(
                _buyer, _currency, _amountIn, _amountOut, _cohort, _price, _validBefore, _nonce, v, r, s
            )
        );
