...
contract ArcadePass is ERC721, ERC721Burnable, ERC2981, Ownable, Pausable {
    ...
    uint256 public maxPerWallet = 2000; // TODO: Fix for mainnet
    ...
    ) ERC721("NonFungibleArcade Pass", "PASS") {
    ...
    function mint(uint256 _qty, bytes32[] calldata _proof) external whenNotPaused {
        ...
        require(USDC.transferFrom(msg.sender, address(this), mintPrice * _qty), "!value");
