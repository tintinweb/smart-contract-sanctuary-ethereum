...
contract OGCollection is ERC721URIStorage {
    ...
    constructor() ERC721("Original Collection", "OGC") {}
        ...
        function mintNft() public {
            ...
            string memory finalSvg = string(abi.encodePacked(baseSvg, Strings.toString(tokenId), "</text></svg>"));
                ...
                bytes(
                    string(
                        ...
                        '{"name": "',
                            ...
                            '", "description": "OG test collection", "image": "data:image/svg+xml;base64,',
