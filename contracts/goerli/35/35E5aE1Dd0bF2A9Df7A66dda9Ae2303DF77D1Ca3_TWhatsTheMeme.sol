...
contract TWhatsTheMeme is ERC1155, Ownable {
    string public name = "TWhatsTheMeme";
    string public symbol = "TWTM";

    uint256 remaining = 1000;
    uint256 public updatePrice = 4206900000000000; // 0.0042069 ETH
    string public contractUriLocation = "https://arweave.net/5n999-NBZEhf-T61O9H0Erchun24xLU8BD-aDd5JZHU";
