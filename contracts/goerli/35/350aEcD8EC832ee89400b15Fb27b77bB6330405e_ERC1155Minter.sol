    ...
    ERC1155Burnable
{
    ...
    function initialize(bytes calldata _data) external {
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, //harcoded value for keccak256("EIP712Domain(string name,uint256 chainId,address verifyingContract)") DOMAIN_TYPEHASH
    ...
    constructor(address factory_) {
        // todo hardode constant and remove from constructor
