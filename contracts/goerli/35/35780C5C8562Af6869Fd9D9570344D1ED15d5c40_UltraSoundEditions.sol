    ...
    function metadata(
        ...
        string memory json = string(
            abi.encodePacked(
                '{"name":"',
                tokenName,
                '", "attributes":[{"trait_type":"Version","value":"',
                version,
                '"},{"trait_type":"Block Time","display_type": "date","value":',
                blockTime,
                '},{"trait_type":"Base Fee","display_type": "number","value":',
                baseFee,
                '}], "description":"',
                tokenDescription,
    ...
    DefaultOperatorFilterer
{
    ...
    function safeMint(address to, uint256 version) public onlyOwner {
        ...
        info.blockTime = block.timestamp;
        info.seed = uint256(
            keccak256(
                abi.encodePacked(
                    block.timestamp,
        ...
        returns (string memory)
    {
        ...
        return
            SVG721.metadata(
                ...
                info.blockTime.toString(),
                info.baseFee.toString(),
                svg
            );
    }
