...
contract DaftSwapPair is ReentrancyGuard, NoDelegateCall {
	...
	function getTokenYForExactTokenX(uint256 tokenXAmount) external view returns (uint256 tokenYAmountRequired) {
	...
	function getExactTokenYForTokenX(uint256 tokenYAmount) external view returns (uint256 tokenXAmountOut) {
		//TODO: executs limit orders with lowest price
