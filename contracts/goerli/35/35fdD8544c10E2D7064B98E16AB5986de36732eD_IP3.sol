...
contract IP3 is Initializable {
    ...
    function initialize(IERC20 instanceAddress) public initializer {
    ...
    function getCurrentPrice(bytes32 _hashedNft)
        ...
        returns (uint256)
    {
        uint256 _currentPrice = authroizeRecordMap[_hashedNft]
            .authorizedNFT
            .currentPrice;
        uint256 _lastActive = authroizeRecordMap[_hashedNft]
            .authorizedNFT
            .lastActive;
    ...
    function getCurrentClaimable(address _address)
        external
        view
        returns (uint256)
    {
