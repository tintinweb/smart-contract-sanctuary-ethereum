...
contract dAgoraShallNotBeNamedFactory is Ownable, ReentrancyGuard {
    ...
    event ShallNotBeNamedCreated(address shallNotBeNamedContract, address owner, uint256 shallNotBeNamedIndex);
        ...
        nonReentrant
    {
        ...
        emit ShallNotBeNamedCreated(address(noName), msg.sender, shallNotBeNamedCount);
    }
