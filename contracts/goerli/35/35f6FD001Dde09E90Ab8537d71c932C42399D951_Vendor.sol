...
contract Vendor is Ownable {
    ...
    function buyTokens() public payable {
        ...
        require(purchaseAmount > 0, "Buy tokens");
    ...
    function sellTokens(uint256 _amount) public {
        require(_amount >= 0, "Sell tokens");
        uint256 allowed = yourToken.allowance(msg.sender, address(this));
        require(allowed >= _amount, "Increase please");
        uint256 saleInEth = _amount / tokensPerEth;
        require(address(this).balance >= saleInEth, "Contract has no funds");
