...
contract TradingBotV2 is ReentrancyGuard, ChainlinkClient {
    ...
    bytes32 public getPriceJobId;
    uint256 public getPriceFee;
    ...
    constructor(
        ...
        getPriceJobId = _getPriceJobId;
        getPriceFee = _getPriceFee;
    }
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        Chainlink.Request memory req = buildChainlinkRequest(getPriceJobId, address(this), this.fulfill.selector);
        ...
        // Sends the request
        return sendChainlinkRequest(req, getPriceFee);
    }
