...
contract MtestNFT is ERC721, RevokableDefaultOperatorFilterer, Ownable {
  ...
  string internal baseTokenUri = 'ipfs://bafybeiea73uubfbrfhi3m6rwlw3hhduoykqge32tfbi5qskke6ofnzdoza/';
  ...
  constructor() payable ERC721('MTEST2', '369') {
      ...
      partMaxSupply = 368;
       ...
       /**
    * @dev setIsAkuListActive 
    * Parameters:
    * `_isAkuListActive` true or false.
    * 
    * Requirements:
    * 
    ...
    * return:
    * 
    * - how many token is allowed to mint in mintAkuList .
    */
    ...
    * @dev mintAkuList 
    * Parameters:
    * `numberOfTokens` Number of tokens want to mint.
    * 
    * Requirements:
    * 
    * - isAkuListActive must be enabled.
    * - caller must be in akuList and have enough spots to mint.
    * - Caller must send enough ether to pay for `numberOfTokens` at mintPrice.
    */
 ...
 /**
  ...
  /**
    * @dev Mint `quantity_` Number of tokens want to mint.
    * 
    * Requirements:
    * 
  ...
  function mint(uint256 quantity_) public payable {
    ...
    * Parameters:
    *
    * `quantity_` Number of tokens want to mint.
    * `userWallet_` wallet address to mint.
    * 
    * Requirements:
    * 
    * - Only Owner can call this.
