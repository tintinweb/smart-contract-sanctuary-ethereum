...
contract KnowBox is ERC721, Ownable, RandomHelp {
	using Strings for uint256;
	...
	uint256 private maxBalance = 10;

	uint256 private total;

	string private baseURI;
	//7 * 24 * 60 * 60
	uint256 private openDelay = 3 * 60;

	mapping(uint256 => KnowBoxInfo.BoxInfo) private _boxInfo;
	mapping(string => bool) private _cdkeyMap;

	string public nonOpenUri = "https://sky.infura-ipfs.io/ipfs/Qmd9SsHeHSJ9BeAkwDp7ALYHZ7pFAbdWgjoHVjZeG7AFD6";
	...
	constructor(uint256 _maxSupply, string memory baseURI_) ERC721("KnowBox", "CBK") RandomHelp(_maxSupply) {
		maxSupply = _maxSupply;
		baseURI = baseURI_;
		DOMAIN_SEPARATOR = keccak256(
			abi.encode(
				0x8b73c3c69bb8fe3d512ecc4cf759cc79239f7b179b0ffacaa9a75d522b39400f, //keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)")
				0x545a712f02f365da9d9517134f9a5d25d56b9fdb8d344bd43f7457d18b3ef54a, //keccak256("KnowBox CBK")
	...
	function setNonOpenUri(string calldata _nonOpenUri) external onlyOwner {
		nonOpenUri = _nonOpenUri;
	}
