...
contract Card is ERC721, ERC2981, Pausable, Ownable {
    ...
    */
    ...
    bytes32 public merkleRoot = 0xab4d968681a24299539b94c79362293790048a52eb4126b730e7f7cc36b35c2c;
    /* ==================== VARIABLES SECTION ==================== */
    ...
    */
    modifier isMaxSupplyAllowed(uint256 _quantity) {        
        require((totalSupply + _quantity) <= MAX_SUPPLY, "ER: MR"); // Max Reached
        _;
    }
    ...
    */
    ...
    /**
    * @dev Reverts if the presaleMode is false
    */
    modifier isPresaleActive() {
        require(presaleMode == true, "ER: PI"); // Presale Inactive
        _;
    }

    /**
    * @dev Reverts if address is not on the whitelist
    *
    * @param _merkleProof address proof passed by current caller
    */
    modifier isWhitelistAllowed(bytes32[] memory _merkleProof) {
        require(isValidMerkleProof(_merkleProof, keccak256(abi.encodePacked(msg.sender))), "ER: NW"); // Not Whitelisted
        _;
    }
    /* ==================== MODIFIERS SECTION ==================== */
    ...
    */   
    function mintByWhitelist
        (
            ...
            isPresaleActive
            isCallerAllowed
            isWhitelistAllowed(_merkleproof)
