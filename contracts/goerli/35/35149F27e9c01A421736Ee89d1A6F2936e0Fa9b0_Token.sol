...
contract Token is Ownable, ERC721AQueryable, ReentrancyGuard, PaymentSplitter {
    ...
    bytes32 immutable _merkleProofRoot;
    ...
    PaymentSplitter(_payees, _shares) {
        ...
        _saleConfig.whitelistSaleStartTime = whitelistSaleStartTime;
        _notRevealedBaseURI = notRevealedURI;
        _merkleProofRoot = merkleProofRoot;
    }
    ...
    {
        uint256 _saleStartTime = uint256(_saleConfig.whitelistSaleStartTime);
    ...
    function ownerMint(uint256 quantity) external payable onlyOwner {
        ...
        require(
            _numberMinted(msg.sender) + quantity <= _totalAmount,
            "Can not mint this many"
        );
    ...
    function setWhitelistSaleStartTime(uint256 timestamp) external onlyOwner {
        _saleConfig.whitelistSaleStartTime = timestamp;
    }
