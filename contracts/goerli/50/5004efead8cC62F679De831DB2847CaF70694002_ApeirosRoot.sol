    ...
    IMintableERC20
{
    ...
    constructor(address _mintableERC20PredicateProxy) ERC20("Apeiros617", "APRS617") {
        _setupRole(PREDICATE_ROLE, _mintableERC20PredicateProxy);
    }
