...
contract StakingSBT is ERC721ABase, IStakingSBT {
    ...
    function tokenURI(uint256 tokenId) public pure override(IERC721A, ERC721A) returns (string memory) {
        return "https://metadata.atticc.xyz/staking-token";
    }
    ...
    function ownerOf(uint256 tokenId) public view override(IERC721A, ERC721A, IStakingSBT) returns (address) {
