...
// Main Contract Logic 
// --------------------------------------------------------------
contract TrumpMil is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Trump Million";
    string private _symbol = "$TrumpM";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x7FAc5a756Adb52e8970f402aB22972d2a5f8ebC4);
    address payable public operationsWallet =  payable(0x7FAc5a756Adb52e8970f402aB22972d2a5f8ebC4);
    ...
    // distribution ratio
    uint256 public _liquiditySharePercentage = 25;
    uint256 public _operationsSharePercentage = 75;
