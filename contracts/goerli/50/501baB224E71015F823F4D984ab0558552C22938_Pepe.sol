...
contract Pepe is ERC721A, ReentrancyGuard, Ownable {
    ...
    uint256 public PRICE = 11000000000000000;
    ...
    function AlphaMint(address[] calldata _to, uint256 _count) external onlyOwner payable nonReentrant {
	...
	require( saleWLActive, "WL Sale not active" );
    ...
    function setSaleActive(bool _sale) external onlyOwner {
	saleActive = _sale;
    }
    bool public saleOGActive = false;
    function setSaleOGActive(bool _sale) external onlyOwner {
	saleOGActive = _sale;
    }
    bool public saleWLActive = false;
    function setSaleWLActive(bool _sale) external onlyOwner {
	saleWLActive = _sale;
    }
