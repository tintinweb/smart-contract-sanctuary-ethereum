...
contract LockdropFactory {
    ...
    constructor(address _poolsController, address _positionManager) {
        poolsController = _poolsController;
    ...
    function deployNewLockdrop(
        ...
        AtlendisLockdrop deployedLockdrop = new AtlendisLockdrop(
            poolsController,
            positionManager,
            poolHash,
            maxMultiplier,
        ...
        // register lockdrop
        lockdrops[id] = address(deployedLockdrop);

        // give ownership back to creator
        deployedLockdrop.transferOwnership(msg.sender);

        emit LockdropCreated(
            address(deployedLockdrop),
            poolHash,
            maxMultiplier,
            minLockingPeriod,
            maxLockingPeriod,
