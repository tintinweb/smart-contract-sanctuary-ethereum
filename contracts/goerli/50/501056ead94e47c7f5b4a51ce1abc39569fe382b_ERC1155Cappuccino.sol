...
contract ERC1155YuzuInternal is Ownable, AccessControl, ERC1155Supply {
     ...
     */
    constructor(address owner, string memory name_, string memory symbol_) Ownable() ERC1155("") {
...
contract ERC1155Marketplace is ERC1155YuzuInternal, ReentrancyGuard {
    ...
    constructor(
        IERC20 _paymentToken, address _owner, address _admin,
    ...
    function updateAdmin(address _admin, IERC20 _paymentToken) external onlyOwner() {
        admin = _admin;
        paymentToken = _paymentToken;
    }
...
contract ERC1155Cappuccino is ERC1155Marketplace, EIP712 {
    ...
    constructor(IERC20 _paymentToken, address _owner, address _admin,
        string memory name, string memory symbol)
        ERC1155Marketplace(_paymentToken, _owner, _admin, name, symbol)
