...
// File: contracts/DynamicArray.sol
...
contract Clu3 is Ownable, ERC721A, ReentrancyGuard, Verify {
    ...
    constructor(uint8 _saleState, string memory _collectionName, string memory _symbol, uint _batchSize, uint _supply, address _publicKey) ERC721A(_collectionName, _symbol, _batchSize, _supply) Verify(_publicKey){
        saleStage = _saleState;
    }
