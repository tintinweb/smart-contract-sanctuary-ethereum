...
contract Engine is ERC721Upgradeable, IEngineEvents {
    ...
    // @notice
    function shouldRunOpen() public view returns (bool) {
        return
            opens.length > openOrderToExecute &&
            oracle.getPrice().timestamp > opens[openOrderToExecute].timestamp;
    }

    function shouldRunClose() public view returns (bool) {
        return
