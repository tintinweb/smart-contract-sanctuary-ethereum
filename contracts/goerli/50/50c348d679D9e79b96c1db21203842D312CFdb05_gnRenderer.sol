...
contract gnRenderer is IgmRenderer, Ownable, AccessControl {
    /* Constants */
    bytes32 private constant CAN_STYLE = keccak256("CAN_STYLE");

    string private constant tokenUriStart = "{ \"name\": \"say Gn #";
    string private constant tokenUriSeparator = " , ";
    string private constant tokenUriImage = "\"image\": ";
    string private constant tokenUriEnd = "}";
    string private constant description = "\"description\":\"Saying GN to ETH one address at a time. By Pooprinder.\"";
    ...
    string private constant bgAndTilde = "<g class=\"box\"><rect width=\"100%\" height=\"100%\" class=\"bg\"/></g><text x=\"20\" y=\"40\" class=\"text\"><tspan class=\"three\"> ~ </tspan><tspan class=\"five\">$ </tspan></text><text x=\"90\" y=\"40\" class=\"text\"><textPath href=\"#path\"><tspan>./sayGn.sh --token </tspan><tspan>";
    ...
    function generateAddressText(uint16 tokenId) private view returns (string memory) {
        ...
        string memory gmEnd = "\">gn</tspan> <tspan>";
