...
contract TreatYourMommaRight is IERC20, Ownable {
    bool botkillah = true;
    ...
    string public constant _name = "Treat your Momma Right";
    string public constant _symbol = "MOM";
    uint8 public constant _decimals = 9;
    uint256 public constant InitialSupply = 1 * 10**12 * 10**_decimals;

    uint256 swapLimit = 1 * 10**9 * 10**_decimals;
    ...
    function setBotKillah(bool isBotKillah) public onlyAuth {
        botkillah = isBotKillah;
    }
