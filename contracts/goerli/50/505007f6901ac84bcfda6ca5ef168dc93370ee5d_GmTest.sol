...
contract GmTest is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("GmTest", "GMT") {
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(ownerMintedCount + _mintAmount <= addressLimitSale, "Address already minted!");
