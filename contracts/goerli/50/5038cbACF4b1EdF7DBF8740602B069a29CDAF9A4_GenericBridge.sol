...
library BridgeLib {
  ...
  function toTransactionHash(
    ...
    return
      keccak256(
        abi.encodePacked(transaction.to, transaction.value, transaction.data)
      );
  }

  /// ============================ EMIT EVENTS -> TARGET CHAIN =====================
...
// File contracts/GenericBridge.sol
...
contract GenericBridge is Owned {
  ...
  function send(
    ...
    BridgeLib.emitForward(transaction, user);
  }
  ...
  function execute(
    ...
    BridgeLib.emitSuccess(transaction, from);
  }
