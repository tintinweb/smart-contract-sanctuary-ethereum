...
contract KiddoyOOts is ReentrancyGuard,ERC721A("KiddoyOOts", "KyOOts"), ERC721ABurnable, Ownable {
    ...
    function setYOOts(string calldata _yOOts) external onlyOwner { 
        yOOts= _yOOts;
    }
    ...
    function preMint(uint256 amount, bytes32[] calldata _merkleProof) external payable{
        require(currentPhase == Phase.KIDDO, "Pre mint not started");  
