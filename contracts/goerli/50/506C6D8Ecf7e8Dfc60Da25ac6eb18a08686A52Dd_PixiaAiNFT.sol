...
contract PixiaAiNFT is ERC721A, Initializable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory addressString = addressToString(address(this));
        return bytes(currentBaseURI).length > 0 ? string(abi.encodePacked(currentBaseURI, addressString, "/", tokenId.toString())) : "";
    }
