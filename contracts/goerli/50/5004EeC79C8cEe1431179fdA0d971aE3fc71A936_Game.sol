...
contract Game {
    ...
    function createGame(string memory _answer, uint256 _costToPlay) public {
    ...
    function playGame(uint256 _gameId, string memory _guess) public {
        ...
        if (keccak256(abi.encodePacked(_guess)) == keccak256(abi.encodePacked(answers[_gameId]))){
