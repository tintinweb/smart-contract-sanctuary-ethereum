...
contract CONNORS is ERC721, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public publicMintPrice = 0.06942 ether;
    uint256 public whitelistMintPrice = 0.06942 ether;
    ...
    function mintWhitelist(bytes32[] memory _proof, bytes32 _leaf) public payable supplyChecks(1) {
        ...
        //needs valid merkle proof attached to address
        //each whitelisted address can only mint 1
        //mintedByAddressWhitelist[sender] is incremented before _safeMint();
        //amountMinted is incremented before _safeMint();
