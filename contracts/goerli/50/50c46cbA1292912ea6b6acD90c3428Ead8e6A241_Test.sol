...
library Segments {
    ...
    string constant svg0 = '<svg width="300" height="300"><circle cx="100" cy="100" r="90" stroke="black" stroke-width="4" fill="white" />';
    string constant svg1 = '<g transform="rotate(0,100,100)"><line x1="100" y1="100" x2="100" y2="60" stroke="black" stroke-width="6" /></g>';
    string constant svg2 = '<g transform="rotate(0,100,100)"><line x1="100" y1="100" x2="100" y2="40" stroke="black" stroke-width="4" /></g>';
    ...
    string constant svg5 = '<circle cx="100" cy="100" r="4" stroke="black" stroke-width="0" fill="black" />';
    string constant svg6 = '<g transform="rotate(30,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g>';
    string constant svg7 = '<g transform="rotate(60,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g>';
    string constant svg8 = '<g transform="rotate(90,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g>';
    string constant svg9 = '<g transform="rotate(120,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g><g transform="rotate(150,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g><g transform="rotate(180,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g><g transform="rotate(210,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g><g transform="rotate(240,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g><g transform="rotate(270,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g><g transform="rotate(300,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g><g transform="rotate(330,100,100)"><line x1="100" y1="20" x2="100" y2="30" stroke="black" stroke-width="2" /></g></svg>';
    ...
    function renderSvg() public view returns (string memory) {
        string memory second = string(abi.encodePacked(
            '"',
            'rotate(',
            utils.uint2str(block.timestamp % 360),
            ',100,100)">' 
        ));
        string memory suffix = '<line x1="100" y1="100" x2="100" y2="30" stroke="red" stroke-width="2" /></g>';
...
contract Test is ERC721Simple, MetaDataGenerate {
        ...
        returns (string memory) 
    {
        ...
        if (time[tokenId] == 0) {
            ...
            value = (block.timestamp - time[tokenId]) / 60;
        }   
