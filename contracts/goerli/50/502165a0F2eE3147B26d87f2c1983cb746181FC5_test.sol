...
contract test is ERC20, Ownable {
    ...
    constructor() ERC20("test", "testtoday") {
        ...
        marketingWallet = address(0x56DEEF4733D7AF0DF12ac73372a2b2F52b272de6); 
        developmentWallet = address(0x51185f6B8ad0C377d8e69b4EF4B9261266b9CdB2); 
