...
contract Lux is ERC721Base, Permissions {

      // Mapping from roken ID to the power level of that NFT
    ...
    {
        // Set up the DEFAULT ADMIN ROLER
    ...
    function mintTo(address _to, string memory _tokenURI) public virtual override {
        // Grav the nedxt available token ID
        uint256 tokenId = nextTokenIdToMint();
        
        // Actually the mint of the NFT (using the underlying logic)
