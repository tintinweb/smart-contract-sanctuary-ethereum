...
contract FINAPE is ERC721Enumerable, Ownable{
    ...
    string public FINAPE_PROVENANCE = "";
    ...
    constructor(uint256 saleStart) ERC721("FINAPE", "FAPE"){
        REVEAL_TIMESTAMP = saleStart + (86400 * 3);
    }

    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        FINAPE_PROVENANCE = provenanceHash;
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override(ERC721) returns (string memory) {
        ...
        if (startingIndex > 0) { 
            sequenceId = ((tokenId + startingIndex) % MAX_ELEMENTS).toString();
        } else {
            sequenceId = "-1";
        }
