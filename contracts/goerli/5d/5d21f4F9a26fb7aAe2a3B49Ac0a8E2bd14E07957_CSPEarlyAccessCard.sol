...
contract CSPEarlyAccessCard is ERC721, Pausable, AccessControl, TransferWhitelistable {
    ...
    constructor(address[] memory initialWhitelist, address initAdminWallet) ERC721("CSPEarlyAccessCard", "CEA") TransferWhitelistable(initialWhitelist) {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmXGg64KiavbJQhMZss9uCw962cPUmCphKP6TxnwFuRZD3/";
    }
