    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public WHITELIST_SUPPLY = 250;
    uint256 public WHITELIST_ALLOCATION = 10;
    ...
    // ======== SALE TIME ========
    uint256 public whitelistBatchTime = 1676635200; // Date and time (GMT): Friday, 17 February 2023 12:00:00
    ...
    // ======== MINTING ========
    function crossmintWhitelist(address _to, uint256 _quantity) public payable
    ...
    modifier canPublicMint() {
        require(totalSupply() >= WHITELIST_SUPPLY, "Whitelist mint supply not finished");
        _;
    }
}
