...
contract SokoToken is owned {
    ...
    string constant private _name = "SOKO Token";
    string constant private _symbol = "SOKO";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply = 2000000 * (10**_decimals);         //2 million tokens
    uint256 constant public maxSupply = 2000000 * (10**_decimals);    //2 million tokens
