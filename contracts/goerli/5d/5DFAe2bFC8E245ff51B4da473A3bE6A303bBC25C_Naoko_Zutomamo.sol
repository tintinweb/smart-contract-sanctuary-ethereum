...
// File: contracts/Naoko_Zutomamo.sol
...
contract Naoko_Zutomamo is Ownable, ERC721A ,AccessControl {

    constructor(
    ) ERC721A("Naoko_Zutomamo", "NZM") {
        ...
        setBaseURI("https://nft.naokomamablog.com/zutomamo/images/");
    ...
    address public constant withdrawAddress = 0x35F4A47228866399ff3A406dd11fAd80e3F74744;
    ...
    string public stage = "elementary-school-student";
    ...
    function setStage(string memory _value) external onlyOwner {
        stage = _value;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(baseURI, ERC721A.tokenURI(tokenId), "/", stage, baseExtension));
    }
