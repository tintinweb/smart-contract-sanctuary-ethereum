...
//0xd8Ef8AcD719d884Df7b94622965feF5F42b6f3eF

contract WRLiquidityV3 is IERC721Receiver {
    ...
    /// @return amount0 The amount of token0
    /// @return amount1 The amount of token1
    function mintNewPositions( address token0, address token1, uint256 amount0ToMint, uint256 amount1ToMint, uint24 poolFee)
        external
        returns (
            uint256 tokenId,
            uint128 liquidity,
        ...
        )
    {
        ...
        // Note that the pool defined by Token0/Token1 and fee tier XX% must already be created and initialized in order to mint
