...
contract Staking3 is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event Deposit(address indexed user, uint128 stakeAmount, uint128 stakeType, uint128 stakePeriod);
    event Withdraw(address indexed user, uint128 stakeAmount, uint128 stakeType, uint128 rewardAmount);
    event Compound(address indexed user, uint128 rewardAmount, uint128 stakeType);
    event Claim(address indexed user, uint128 rewardAmount, uint128 stakeType);
    ...
    function deposit(uint128 _amount, uint128 _stakeType) external nonReentrant {
        ...
        if(stakes.stakeAmount == 0) {
            ...
            emit Deposit(msg.sender, actualAmount, _stakeType, stakeType.stakePeriod);
            ...
            emit Deposit(msg.sender, totalDepositAmount, _stakeType, stakeType.stakePeriod);
    ...
    function compound(uint128 _stakeType) external nonReentrant {
        ...
        uint128 stakeTimeTillNow;
            ...
            emit Compound(msg.sender, totalRewardTillNow, _stakeType);
    ...
    function withdraw(uint128 _amount, uint128 _stakeType) external nonReentrant {
        ...
        emit Withdraw(msg.sender, actualAmount, _stakeType, rewardTillNow);
    ...
    function claim(uint128 _stakeType) external nonReentrant returns(bool) {
        ...
        emit Claim(msg.sender, totalRewardTillNow, _stakeType);
        return true;
