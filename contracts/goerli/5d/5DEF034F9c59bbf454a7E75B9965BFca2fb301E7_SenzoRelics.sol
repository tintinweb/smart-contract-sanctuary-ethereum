 ...
 */
import "./IbutsuOperatorFilterer.sol";
...
contract SenzoRelics is ERC721AUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IbutsuOperatorFilterer {
    ...
    // v2 operator-filter-registry
    bool public filterRegistered;
    ...
    function operatorFilterRegister() public {
        require(!filterRegistered, "operator filterer is registered");
        operatorFiltererInit(CANONICAL_CORI_SUBSCRIPTION, true);
...
contract IbutsuOperatorFilterer is DefaultOperatorFilterer {
    function operatorFiltererInit(address subscriptionOrRegistrantToCopy, bool subscribe) internal {
