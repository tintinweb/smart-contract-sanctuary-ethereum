...
"investors will not be surprised.";
    ...
    struct Duration {
        ...
        uint256 duration;
        uint256 referralPercentagePerTenThousand;
    }
    ...
    event RefundAsking(address indexed investor, uint investmentIndex, uint usdtToSend, string email);
    ...
    constructor(address alf, address usdt) {
        ...
        durations.push(
            Duration({
                ...
                referralPercentagePerTenThousand: 100
            })
        );
        durations.push(
            Duration({
                ...
                referralPercentagePerTenThousand: 200
            })
        );
        durations.push(
            Duration({
                ...
                referralPercentagePerTenThousand: 300
            })
        );
        durations.push(
            Duration({
                ...
                referralPercentagePerTenThousand: 600
            })
        );
        investPlans.push(
            InvestPlan({
    ...
    function invest(uint256 _usdtAmount, uint _investPlan, uint _duration, address _referrant) external {
        ...
        require(_usdtAmount < chosenInvestPlan.maximumUsdtToInvest, "Cannot invest more than maximum amount permitted by chosen invest plan");
        ...
        if(_referrant != address(0) && investors[investorPosition - 1].investments.length == 0){
            ...
            referralUsdtAmount = _usdtAmount.mul(chosenDuration.referralPercentagePerTenThousand).div(10_000);
        ...
        emit NewInvestment(msg.sender, investors[investorPosition - 1].investments.length - 1, _usdtAmount, chosenDuration.apyPerTenThousand, referralUsdtAmount, timestamp + chosenDuration.duration);
    ...
    function askRefund(uint _investmentIndex, string calldata email) external {
        ...
        emit RefundAsking(msg.sender, _investmentIndex, investment.usdtInvested.mul(refundPerTenThousand).div(10_000), email);
    ...
    function updateDuration(
        ...
        uint _referralPercentagePerTenThousand
    ) external onlyOwner {
        require(durations.length - 1 >= _durationIndex, "Specified duration doesn't exist");
        ...
        duration.referralPercentagePerTenThousand = _referralPercentagePerTenThousand;
    ...
    function addDuration(
        ...
        durations.push(
            Duration({
                ...
                referralPercentagePerTenThousand: _referralPercentagePerTenThousand
            })
        );
    }
    ...
    function getInvestors() external onlyOwner view returns(Investor[] memory)  {
        return investors;
    }
