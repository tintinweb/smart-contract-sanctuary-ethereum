...
contract MYCONTRACTMERKLE3 is ERC721A__Initializable, OwnableUpgradeable, ERC721AQueryableUpgradeable{
    ...
    //     string memory _name, 
    //     string memory _symbol
    // ) __ERC721ABurnable_init initializer public {
    //     __ERC721A_init(_name, _symbol);
    //     __Ownable_init();
    // }
    function __ERC721ABurnable_init(
        string memory _name, 
        string memory _symbol
