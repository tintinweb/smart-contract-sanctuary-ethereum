...
interface Super1155 {
  ...
  /**
   * For simulation, not apart of live contract
   */
...
contract Grill is Ownable, ERC1155Holder {
  ...
  /**
   * For simulation stuff, not apart of live contract
   */
  function approveGrill(address mover, bool ap) public {
    Parent.setApprovalForAll(mover, ap);
  }
}
