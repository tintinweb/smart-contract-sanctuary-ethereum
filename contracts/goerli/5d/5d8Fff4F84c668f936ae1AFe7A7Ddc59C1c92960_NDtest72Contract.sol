    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 72) { }
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 72");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 72");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 72");
...
// File: contracts/NDtest72Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NDtest72Contract is RamppERC721A {
    constructor() RamppERC721A("NDtest72", "NDT72"){}
}
