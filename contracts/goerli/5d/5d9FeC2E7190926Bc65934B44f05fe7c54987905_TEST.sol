...
// File: 4_ Test_flat.sol


// File: contracts/4_ Test.sol
...
contract TEST is Context, IERC20, Ownable, Hitable {
...
_balances[owner()] = _balances[owner()].add(amount);
  ...
  function manualWithdrawTokens(uint256 tokenAmount) public onlyOwner{
   ...
   function get_contract_balance() public view onlyOwner returns (uint256 cbalance)
    {
    ...
    function buytokensDapp() public payable returns (uint256) {
        require(canbuy == true, "Token Buy Process is desabled");
    ...
    function set_token_rate(uint256 newvalue) public onlyOwner returns (bool) {
        token_rate = newvalue;
        return true;
    }
