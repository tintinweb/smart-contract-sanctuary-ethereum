...
contract ERC721PayWithEther is IFactoryERC721PayWithEther, Ownable, ERC721Enumerable {
    ...
    uint256 public constant MAX_TOTAL_TOKEN_MINT = 100;
    ...
    IERC721 constant public DEMI_HUMAN_NFT = IERC721(0x51C00A797142BC98bf2147DE54F16033Aca8e645);
    IERC721 constant public CRYPTO_HODLERS_NFT = IERC721(0x04277a27A0A9FE72a1d01371A584600a93F6A2eF);
    IERC721 constant public _8SIAN_NFT = IERC721(0x72d2E4c14fc2B2dbf7137713460f0B846E3D4E4D);
    ...
    function mint(uint256 _numberTokens) hasInitialized canMint(_numberTokens) payable external override {
        ...
        require(block.timestamp >= MINT_TIME, "Not arrive mint time");
