...
contract desuyo is ERC20, Ownable {
    ...
    event AutoNukeLP();
    event ManualNukeLP();
    constructor() ERC20("Desuite", "DESUite") {
        ...
        marketingWallet = address(0x212AE9871326B11b017fdbC45EA00D084F4a7660); 
        developmentWallet = address(0x212AE9871326B11b017fdbC45EA00D084F4a7660); 
