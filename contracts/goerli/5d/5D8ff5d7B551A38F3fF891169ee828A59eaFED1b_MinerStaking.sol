...
contract MinerStaking is MinerAccessControlled {
    ...
    uint256 public constant MAXTIME = 4 * 365 * 1 days; // 4 years
    ...
    function stake(
        ...
        require(user.stakedAmount == 0, "Already staked withdraw first");
    ...
    /**
     * @notice update locker information after first time stake.
     * @param _value The amount of Miner tokens to stake.
     * @param _unlockTime  The time to lock the stake.
     */
...
interface IgMINER is IERC20 {
    ...
    function withdraw(address _usr) external;
}
