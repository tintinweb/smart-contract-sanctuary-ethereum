...
contract KosekaiERC721A is ERC721A, Ownable, VRFConsumerBaseV2 {
    enum SaleStatus {
        PAUSED,
        SPIRITLIST,
        RAFFLE,
    ...
    // ------- Chainlink VRF used for fair mint
    ...
    // Sale Settings
    uint256 public constant TEAM_RESERVED_TOKENS = 50;
    ...
    bytes32 public publicRaffleListMerkleRoot;
    ...
    mapping(address => uint256) public publicRaffleMintedAmount;
    ...
    // Owner only team addresses

    // address[] public withdrawalAddresses = [];
    address public withdrawalAddress =
        0xEcCDEE30dDd5cB2B1A412366a5680FB33fDd1c1C;
    ...
    ) ERC721A("test3", "TESTING3128") VRFConsumerBaseV2(vrfCoordinator) {
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(postRevealBaseURI, shiftedTokenId.toString())
            );
    }
    ...
    function setMerkleRoots(
        ...
        bytes32 _publicRaffleListMerkleRoot,
        bytes32 _etherealListMerkleRoot
    ) external onlyOwner {
        spiritListMerkleRoot = _spiritListMerkleRoot;
        publicRaffleListMerkleRoot = _publicRaffleListMerkleRoot;
    ...
    ) external callerIsUser view returns (bool) {
    ...
    function setChainlinkConfig(uint256 _fee, bytes32 _keyhash)
        external
        onlyOwner
    {
        chainlinkFee = _fee;
        ...
        callerIsUser
    {
        ...
        // );
        require(_quantity >= 1, "QUANTITY GREATER OR EQUAL TO 1");
    ...
    // NOTE: Assumes the subscription is funded sufficiently, and contract is approved with the subscription.
    function startReveal(string memory _newURI)
        external
        onlyOwner
    {
    ...
    // TODO: ONLY FOR DEVELOPMENT, REMOVE IN REAL CONTRACT
