...
contract Staking {
    ...
    IERC721A private _mainContract = IERC721A(0xBB9dcf263df4603ac026b06C378261f77224535f);
    ITicket _ticketContract = ITicket(0x676CA7a4E6014530c8b7Ef5A00d51369a5E31185);
    ...
    function stakingTimes() public view returns (uint[2] memory) {
        return [_stakingTimes[TicketTypes.SILVER], _stakingTimes[TicketTypes.GOLD]];
    }
