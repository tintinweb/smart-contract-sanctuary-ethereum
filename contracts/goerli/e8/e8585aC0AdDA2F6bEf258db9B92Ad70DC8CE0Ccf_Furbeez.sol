...
contract Furbeez is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    uint256 public constant MINT_SINGLE_PRICE = 0.01 ether;
    ...
    function mint() external payable {
        ...
        require(msg.value == MINT_SINGLE_PRICE, "wrong price");
    ...
    function mintMultiple(uint256 quantity) external payable {
        ...
        require(msg.value * quantity == MINT_MULTIPLE_PRICE, "Incorrect wrong price");
        require(msg.sender == tx.origin, "No smart contracts");
    ...
    function reserve() public onlyOwner {
        uint256 _currentIndex = currentIndex;
        require(_currentIndex + 10 < MAX_ID_PLUS_ONE, "Not enough NFTs left to reserve");

        uint256[] memory _amounts = new uint256[](10);
        uint256[] memory _ids = new uint256[](10);
