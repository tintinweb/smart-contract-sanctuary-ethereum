...
contract blockchain_Quiz
{
    function Try(string memory _response) public payable
    {
        ...
        //console.log("responseHash: ", Strings.toHexString(uint256(responseHash)));
        //console.log("RESPONSE: " , Strings.toHexString(uint256(keccak256(abi.encode(_response)))));

        //console.log("Setting admin is awful: ", Strings.toHexString(uint256(keccak256(abi.encodePacked(msg.sender)))));
