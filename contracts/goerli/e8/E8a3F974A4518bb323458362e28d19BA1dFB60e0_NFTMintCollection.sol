...
Initializable
{
    ...
    /// Contract name
    string public NAME = _deploymentConfig.name;

    /// Contract version, semver-style uint X_YY_ZZ
    uint256 public VERSION = _deploymentConfig.version;
    ...
    pure
    {
        ...
        require(
            config.charityAddress != address(0),
            "Charity address cannot be null"
        );
