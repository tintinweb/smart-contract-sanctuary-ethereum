...
interface IERC1155 is IERC165 {
     ...
     */
    event TransferSingleMSFT(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value);
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    function _safeTransferFrom(
        ...
        emit TransferSingleMSFT(operator, from, to, id, amount);
    ...
    function _mint(
        ...
        _balances[id][to] += amount;
        emit TransferSingleMSFT(operator, address(0), to, id, amount);
    ...
    function _burn(
        ...
        emit TransferSingleMSFT(operator, from, address(0), id, amount);
    }
...
| ▓▓  \▓ | ▓▓   ▓▓ \\▓▓    ▓▓ ▓▓  | ▓▓ ▓▓        | ▓▓   \▓▓    ▓▓
 \▓▓      \▓▓\▓▓▓▓▓▓ \▓▓▓▓▓▓ \▓▓   \▓▓\▓▓         \▓▓    \▓▓▓▓▓▓ 
           ...
           MISnFTS | Membership Contract | October 22                                                                   
*/
