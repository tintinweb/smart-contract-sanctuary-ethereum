...
contract RektBirbs is Ownable, ERC721A{
    ...
    string internal BASE_URI = "https://ipfs.io/ipfs//";
    ...
    address internal w = 0x9A10cB1DB1D88064658534E33425C1b135A31290;

    constructor() ERC721A("RektBirbs", "BIRB") {}
    ...
    function withdrawAll() public payable onlyOwner {
      require(payable(w).send(address(this).balance));
    }
