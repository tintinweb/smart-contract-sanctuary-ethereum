...
contract TokenRelease   {
    ...
    function releasesCount() public view virtual returns (uint256) {
    ...
    */
    function getNumberOfTimesToHalve() public view virtual returns (uint256) {
        uint256 numberOfTimesToHalve =  block.timestamp.sub(_firstReleaseTime)%_halfCycle;//Calculate the number of halved cycles
