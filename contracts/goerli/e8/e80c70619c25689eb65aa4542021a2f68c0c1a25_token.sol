...
contract token is ERC20Capped {
    ...
    constructor() ERC20("Test Token", "TTEST") ERC20Capped(maxSupply * (10 ** decimals())) {
        ...
        mintRewardsContract = payable(0x03D8EFD7Ce803551a849a2ab71BE4AF4EC6a95Ea);
    ...
    */
    function mintRestOfTokens() external {
        require(block.timestamp - timeStampMint > 1 minutes, 'Can only be minted after one year.');
