...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xC1A783d1FD04D9d8fb6B996e6092baBAC9F32BFa];
  address public erc20Payable = 0xC1A783d1FD04D9d8fb6B996e6092baBAC9F32BFa;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeie57sioz2wg5zqog2pskkxpjbpz7j77enbetjlwbbegwzeox5jnwe/";
...
// File: contracts/FacezContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FacezContract is RamppERC721A {
    constructor() RamppERC721A("Facez", "FACEZ"){}
}
