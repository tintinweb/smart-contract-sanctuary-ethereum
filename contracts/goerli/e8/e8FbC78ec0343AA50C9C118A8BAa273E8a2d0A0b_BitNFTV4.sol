    ...
    OwnableUpgradeable
{
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public virtual override(ERC721Upgradeable, IERC721Upgradeable) onlyOwner {
    ...
    function fulfillTransferRequest(
        address nftOwner,
        uint256 tokenId,
        address to
    ) public onlyOwner {
        transferFrom(nftOwner, owner(), tokenId);
