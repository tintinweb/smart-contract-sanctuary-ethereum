...
interface IP3CurrencyManagerInterface {
...
import {IP3CurrencyManagerInterface} from "../interfaces/IP3CurrencyManagerInterface.sol";

/**
 * @title CurrencyManager
 * @notice It allows adding/removing currencies for IP3 Marketplace.
 */
contract IP3CurrencyManager is IP3CurrencyManagerInterface, Ownable {
    using EnumerableSet for EnumerableSet.AddressSet;

    EnumerableSet.AddressSet internal _whitelistedCurrencies;
