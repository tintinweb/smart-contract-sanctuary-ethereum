...
abstract contract ERC721ABurnable is ERC721A, IERC721ABurnable, Ownable {
  ...
  _;
    ...
    function whiteListChange(address _addr, bool isWhiteListed) public onlyOwner {
    whitelist[_addr] = isWhiteListed;
}

    function burn(uint256 tokenId) isWhitelisted(msg.sender) public virtual override {
        _burn(tokenId, true);
    }
}
