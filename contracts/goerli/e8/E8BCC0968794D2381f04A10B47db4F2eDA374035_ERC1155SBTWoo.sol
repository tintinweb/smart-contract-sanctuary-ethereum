 ...
 * @notice This contract handles minting ERC1155SBTWoo tokens.
 */
contract ERC1155SBTWoo is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x73932c2540619DE3232eb1D9dAd24a1FC0278d6E;
    ...
    string public name = "ERC1155SBTWoo";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeihm3wtxftnuymcumjipyw4yjvvdtuabnbudgxnojapza27f7wrkjq/{id}"
        )
        RevokableOperatorFilterer(
