...
import "./OperatorFilterer721.sol";
...
contract SantaPos is ERC2981, ERC721A, ERC721AQueryable, ERC721ABurnable, ERC4907A, Ownable, DefaultOperatorFilterer721{
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 50;
    uint256 public constant MAX_PUBLIC_MINT = 10;
    uint256 public constant TEAM_NFTS = 25;
    uint256 public PUBLIC_SALE_PRICE = .2 ether;
    ...
    constructor() ERC721A("SantaPos", "SPOS") {}

    modifier callerIsUser() {
        require(tx.origin == msg.sender, "BGG :: Cannot be called by a contract");
        _;
    }
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require(msg.value >= (PUBLIC_SALE_PRICE * _quantity), "Not Enough Eth");
        _safeMint(msg.sender, _quantity);
    }

    function teamMint() external onlyOwner{
        require(!teamMinted, "Team NFTs already minted");
        teamMinted = true;
        _safeMint(msg.sender, TEAM_NFTS);
    }
    ...
    function walletOf() external view returns(uint256[] memory){
        return this.tokensOfOwner(msg.sender);
    }
    ...
    function setRoyaltyInfo(uint96 _royaltyFeesInBips) public onlyOwner{
        _setDefaultRoyalty(msg.sender, _royaltyFeesInBips);
    }

    function contractURI() public pure returns(string memory){
        return "data:application/json;base64,";
    }
}
