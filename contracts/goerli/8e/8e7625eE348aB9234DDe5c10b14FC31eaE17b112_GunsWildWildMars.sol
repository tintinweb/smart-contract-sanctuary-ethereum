...
contract GunsWildWildMars is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    uint public maxSupply = 6000;
    uint public normalMintPrice = 0.000 ether;
    ...
    constructor() ERC721A("GunsWildWildMars", "GWM") EIP712("GunsWildWildMars", "1.0.0") {
    }
