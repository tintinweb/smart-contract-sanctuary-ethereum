...
// File contracts/ERC721A-Facets/initializeERC721A.sol

pragma solidity ^0.8.0;
contract initialize {
    function init() external {
        LibDiamond.DiamondStorage storage pointer = LibDiamond.diamondStorage();

        LibDiamond.enforceIsContractOwner();

        pointer._name = "P360 Dev Test Token";
        pointer._symbol = "PDV";
    }
}