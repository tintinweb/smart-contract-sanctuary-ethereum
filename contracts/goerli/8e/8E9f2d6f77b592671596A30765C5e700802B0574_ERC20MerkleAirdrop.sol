...
contract ERC20MerkleAirdrop is Ownable {
    ...
    bytes32 public immutable merkleRoot = 0x218b2adfc04285294b77aa50b6aaff65d20e55622ae08f59f60f053dbd79e077;

    //this value should be set by template; ERC20 token address that will be used for airdrop
    address public immutable tokenAddress = 0x0000000000000000000000000000000000000000;

    //comes from template, timestamp of start and end data of compaign
    uint256 public immutable startAt = 1668252107105;
    uint256 public immutable endAt = 1668277800000;

    //id of airdrop created in database
    uint256 public immutable airdropID = 2;

    //comes from template too
    uint256 public immutable totalTokens = 0x11c37937e08000;
    uint256 public claimedTokens  = 0;
    uint256 public availableTokens = 5000000000000000;
