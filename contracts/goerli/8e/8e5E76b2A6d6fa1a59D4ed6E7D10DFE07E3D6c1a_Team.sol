...
contract Team {
    ...
    //特斯拉合约
    mapping(address=>bool) private _TeslaContract;
    ...
    * 修改特斯拉合约
    */
    function setTeslaContract_(address TeslaContract_,bool authority_) public Owner returns (bool){
        _TeslaContract[TeslaContract_] = authority_;
        return true;
    }
    /**
    * 特斯拉合约是否有权限
    */
    function TeslaContract(address TeslaContract_) public view returns (bool){
        return _TeslaContract[TeslaContract_];
    }
