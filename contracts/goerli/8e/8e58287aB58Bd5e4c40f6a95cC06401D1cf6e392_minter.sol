...
{   
    ...
    address public myERC721 = 0x176D29AF1271D5d3C27faAF8Fdd77590A9f07aC5;

    INephte nepht = INephte(myERC721);
    IERC721 nft = IERC721(myERC721);
    ...
    {
        uint256 nft_id = nepht.mintage(msg.sender); 
        nft.safeTransferFrom(address(this), msg.sender, nft_id);
        return nft_id;
    }
