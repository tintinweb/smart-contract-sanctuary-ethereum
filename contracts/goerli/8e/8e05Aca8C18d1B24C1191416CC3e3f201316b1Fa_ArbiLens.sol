...
contract ArbiLens is ERC20, Ownable {
  using SafeMath for uint256;
  address routerAdress = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
  address DEAD = 0x000000000000000000000000000000000000dEaD;

  string constant _name = "Arbilens";
  string constant _symbol = "LENS";
  ...
  address public marketingFeeReceiver =
    0xc3F2BA58Fc5Acb89E4a1Ab49C54918C5E57dbcE0;
  ...
  constructor() Ownable(msg.sender) {
    ...
    isFeeExempt[0xc3F2BA58Fc5Acb89E4a1Ab49C54918C5E57dbcE0] = true;
    isTxLimitExempt[address(router)] = true;
    isTxLimitExempt[_owner] = true;
    isTxLimitExempt[0xc3F2BA58Fc5Acb89E4a1Ab49C54918C5E57dbcE0] = true;
