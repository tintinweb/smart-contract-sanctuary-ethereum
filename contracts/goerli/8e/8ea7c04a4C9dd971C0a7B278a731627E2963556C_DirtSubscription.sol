...
contract DirtSubscription is ERC721ABurnable, ERC721AQueryable, OperatorFilterer, AccessControlEnumerable {
    ...
    mapping(uint256 => uint256) private _tokenSoulBoundExpiry;
