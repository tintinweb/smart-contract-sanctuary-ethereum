...
contract Streamer is Ownable {
    ...
    function withdrawEarnings(Voucher calldata voucher) onlyOwner public {
        ...
        require(balances[signer]>voucher.updatedBalance,"less balance the updated balance");
   ...
   function defundChannel() public{
    require(canCloseAt[msg.sender]!=0,"not closing channel");
    require(canCloseAt[msg.sender] < block.timestamp,"notclosed, still in challenging period");
