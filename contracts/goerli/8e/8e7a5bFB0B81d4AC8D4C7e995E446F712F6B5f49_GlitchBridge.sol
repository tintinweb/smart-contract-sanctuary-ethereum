...
contract GlitchBridge is Ownable, Pausable {
    ...
    /* ========== EVENTS ========== */
    event TransferToGlitch(string _glitchAddress, uint256 _amount);
    ...
    {
        glitchToken.safeTransferFrom(msg.sender, address(this), _amount);

        emit TransferToGlitch(_glitchAddress, _amount);
    }
