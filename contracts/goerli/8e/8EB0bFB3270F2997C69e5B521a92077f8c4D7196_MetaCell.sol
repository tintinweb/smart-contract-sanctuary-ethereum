 ...
 * @title Interface for interaction with particular cell
 */
abstract contract ACellRepository is ICellRepository, MulticallUpgradeable {
    using SafeMathUpgradeable for uint256;
    using CountersUpgradeable for CountersUpgradeable.Counter;

    //  are meta cells
    EnumerableSetUpgradeable.UintSet private idSet;
    ...
    function _addMetaCell(CellData.Cell memory _cell) internal {
        ...
        EnumerableSetUpgradeable.add(idSet, _cell.tokenId);
    ...
    function _removeMetaCell(address _user, uint256 _tokenId) internal {
        ...
        EnumerableSetUpgradeable.remove(idSet, _tokenId);
    ...
    {
        if (!EnumerableSetUpgradeable.contains(idSet, _tokenId)) {
            return _metaCell;
        }
