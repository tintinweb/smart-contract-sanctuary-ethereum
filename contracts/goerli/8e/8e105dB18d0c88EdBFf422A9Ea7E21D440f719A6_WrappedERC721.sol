...
contract WrappedERC721 is Ownable, ERC721 {
    ...
    function mint(uint256 idToken)
        ...
        returns (bool)
    {
        _mainContract.transferFrom(msg.sender, address(this), idToken);
        ...
        returns (bool)
    {
        ...
        _mainContract.transferFrom(address(this), msg.sender, idToken);
