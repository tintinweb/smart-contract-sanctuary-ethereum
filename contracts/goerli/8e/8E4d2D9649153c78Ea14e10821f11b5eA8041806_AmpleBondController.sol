 ...
 *       for AMPL. (and other non-dilutive rebasing tokens)
 *
 * Tranche amounts are scaled by the bond's CDR. Previously the it was scaled by
 * a factor of (totalDebt/collateralBalance). However, This can be manipulated by
 * transferring more collateral tokens into the bond.
 *
