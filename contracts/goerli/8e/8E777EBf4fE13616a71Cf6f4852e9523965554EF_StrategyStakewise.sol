...
import "./interfaces/IStakewisePool.sol";



/**
 * @title Stakewise pool
 */
contract StrategyStakewise is IStrategyPool, Ownable {
    ...
    address public immutable token; // Stakewise token
    address public immutable pool; // Stakewise pool address
    ...
    function getBalance() public view returns(uint256 outputAmt){
      outputAmt = IERC20(token).balanceOf(address(this));
   }
