...
contract TestDeploymentContract is Context, IERC20, Ownable {
    ...
    address private _owner = 0x25A3232B44729fCBb26f6bd27270320b289A1353;
    ...
    uint256 private constant _tTotal = 1 * 1e12 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "TestDeploymentContract";
    string private constant _symbol = "TestDeploymentContract";
    ...
    uint256 private gasPriceLimit = 450 * 1 gwei; // do not allow over 450 gwei for launch
    ...
    constructor() payable {
        _rOwned[_owner] = _rTotal / 1000 * 500;
        _rOwned[address(this)] = _rTotal / 1000 * 500;

        maxTransactionAmount = _tTotal * 100 / 1000; // 10% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 20 / 1000; // 2.0% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 2 / 10000; // 0.02% swap tokens amount

        marketingAddress = payable(0x2fe825974f1D38f6b0276fD37f12DeC7737F3A8b); // Marketing Address

        devAddress = payable(0x2fe825974f1D38f6b0276fD37f12DeC7737F3A8b); // Dev Address
        ...
        emit Transfer(address(0), address(0xdead), _tTotal * 500 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 500 / 1000);
    }
