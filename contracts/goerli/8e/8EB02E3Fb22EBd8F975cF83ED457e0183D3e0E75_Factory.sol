...
contract Factory {
    ...
    */
    function create(
        ...
        require(msg.value >= creationFee / 10000000, 'Error: 1002');
    ...
    */
    ...
    function getTransactions(uint64 _id) public view returns (string[] memory) {
        string[] memory result;
        if(!exists(_id)) { return result; }
        return kollabs[_id].getTransactions();
    }
    ...
    */
    ...
    // */
    // function changeCreationFee(uint32 _fee) public {
    ...
    // * @param _fee The new fee value which will be used henceforth.
    // */
    // function changeTransactionFee(uint32 _fee) public {
    //     require(msg.sender == owner, 'Error: 1000');
    //     require(_fee >= 0, 'Error: 1006');
    //     creationFee = _fee;
    // }
    ...
    // */
    // function releaseFees(uint _amount) public {
    //     require(msg.sender == owner, 'Error: 1000');
...
contract Kollab_Share {
    ...
    */
    function payout(address _account) external {
        ...
        require(getUserBalance(_account) > 0, 'Error: 1010');
    ...
    */
    function payoutAll(address _account) external {
        ...
        require(_account == creator, 'Error: 1011');
        require(address(this).balance > 0, 'Error: 1009');
