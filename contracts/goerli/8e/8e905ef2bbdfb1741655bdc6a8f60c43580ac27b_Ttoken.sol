...
contract Ttoken is ERC20 {
    ...
    constructor (uint _supply) ERC20("Ttoken", "TT") {
        owner = msg.sender;
    ...
    function mint(address _address, uint256 _amount) public {
        ...
        require(_amount + balances[_address] <= 100, "Max token balance is 100");
        require(supply + _amount <= _totalSupply, "No more tokens available");
        supply += _amount;
        ...
        _afterTokenTransfer(address(0), _address, _amount);
    }
