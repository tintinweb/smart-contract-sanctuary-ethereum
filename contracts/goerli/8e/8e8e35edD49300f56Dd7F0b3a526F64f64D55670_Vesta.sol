...
contract Vesta is ERC721, ERC721Enumerable, VestaDNA {
        ...
        returns(string memory) 
    {
        ...
        string memory typo = userI.typology;
            ...
            bytes(
                string(
                    ...
                    abi.encodePacked(
                        ...
                        '","image":"', userI.image,
                        '","attributes":[{"trait_type":"Typology","value":"', typo, '"},{"trait_type": "Year built","value":"', userI.yearBuilt.toString(), '"},{"trait_type": "Square meters","value":"', userI.sqm.toString(), '"},{"trait_type": "Rooms","value":"', userI.rooms.toString(), '"},{"trait_type": "Bathrooms","value":"', userI.bathrooms.toString(), '"},{"trait_type": "Levels","value":"', userI.levels.toString(), '"},{"trait_type": "Parkings","value":"', userI.parkings.toString(), '"},{"trait_type": "Yard","value":"',  boolToString(userI.yard), '"},{"trait_type": "Pool","value":"',  boolToString(userI.pool), '"},{"trait_type": "Location","value":"', userI.location, '"}]}'
                    )
                )
            )
        );
