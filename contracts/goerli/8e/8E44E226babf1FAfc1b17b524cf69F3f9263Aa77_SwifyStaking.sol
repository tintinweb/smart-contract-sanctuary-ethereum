...
/*
Hello sir happy holidays, this is the staking contract, I'm aware you have experience deploying contracts but still wanted
to leave so instructions and notes in case you need some help, first I'll describe the steps to take to deploy, then then the 
things to do to deploy and some final notes.
...
- Create a new file and called it "SwifyStaking.sol" or something like that and paste this code.
- Compile with version 0.8.0.
- Deploy the contract called "SwifyStaking", the deploy button will be red, this means that you can send eth to the contract in the same
...
contract SwifyStaking is ReentrancyGuard {
    ...
    uint public amountOfTokenPerEth = 154985;
    uint public apr = 100;
