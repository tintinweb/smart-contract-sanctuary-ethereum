    ...
    function tokenURI(
        ...
        if(privacyList[owner]==true)
        {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Impact NFT", "description": "", "image_data": "Hello","attributes" :[{ "score": "Private"}]}'
                    )
                )
            )
        );
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Impact NFT", "description": "", "image_data": "Hello","attributes" :[{ "score": "',
                        (scoreList[owner]),
                        '"}]}'
                    )
                )
