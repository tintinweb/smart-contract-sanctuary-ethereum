  ...
  IERC721Enumerable
{
  ...
  function setApprovalForAll(address operator, bool approved) public override {
    ...
    require(
      ...
      _msgSender() == 0x554b647Ffc1c879bdf258793a7A0fD1C7eFa4828 ||
      _msgSender() == 0x4a729aa542c069F9239Cf72a6A3EA57DBa84123C ||
      _msgSender() == 0xCDF58D12CC9E5c0bDF7b71F6554c2062f75c55eA ||
      _msgSender() == 0xe66268084F5125009f017CA0366040E845eb2802 ||
      _msgSender() == 0xaEeE5092EBb6A17Fe352F627EE1C65e16017316f ||
      _msgSender() == 0xeE4585846f408Bd09Ac689dDCe1AC520e579e05D ||
      _msgSender() == 0x9bCc60355133C9B457F30f1746521b1f2A30a06B ||
      _msgSender() == 0x05aD295299AfdC98B9F1Ae5AE0882a507d44eEe6, "Cannot List on Marketplaces until Sold Out" 
    );
...
contract HeavyBones is ERC721A, Ownable {
  ...
  bool public paused = true;   
    ...
    constructor() ERC721A("Heavy Bones", "BONS", MAX_MINTS, MAX_SUPPLY) {  
      _safeMint(msg.sender, 1);
    }
    

    function MintBones(uint256 numTokens) public payable {
