...
contract FuglyAliens is ERC721A, Ownable, ERC2981, ReentrancyGuard{
    ...
    uint256 public constant MAX_PUBLIC_MINT = 23;
    ...
    constructor(uint96 _royaltyFeesInBips, string memory URI, address _royal) ERC721A("FuglyAliens", "FA"){
    ...
    function mint(uint256 _quantity) payable external callerIsUser{
