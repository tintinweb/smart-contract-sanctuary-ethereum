...
contract RamperToken721 is ERC721Enumerable, IRamperInterface721 {
    uint256 constant public MAX_TOKENS = 800;
    uint256 constant public MAX_TOKENS_PER_TXN = 2;
    uint256 constant public MAX_TOKENS_PER_ADDRESS = 6;
    uint256 constant public TOKEN_PRICE = 0.0013 ether;

    string public baseTokenURI = "ipfs://bafybeia6etyx7udxoitjsjd7opc225wf3u5kbo54kiuyixqkmqsxqulm44/";

    constructor() ERC721("Supernormal Influencer Test", "SNINTST") {
