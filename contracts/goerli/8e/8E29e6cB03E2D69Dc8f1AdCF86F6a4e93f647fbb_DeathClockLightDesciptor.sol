...
import './MetadataLightGenerator.sol';
import 'hardhat/console.sol';
import './IDeathClockLightDescriptor.sol';

contract DeathClockLightDesciptor is
    IDeathClockLightDescriptor,
    Ownable,
    MetadataLightGenerator
{
    ...
    function getMetadataJSON(
        ...
        // uint256 previewId = 9999;
        return
            generateMetadataJSON(
                MetadataLightGenerator.metadataPayload(
                    tokenId,
                    metadataPayload.minted,
                    metadataPayload.expDate,
                    string.concat(previewCID, '/', '9999', '.gif'),
...
contract MetadataLightGenerator {
    ...
    function generateMetadataJSON(
        ...
        string memory p1 = string.concat('?id=', idStr);
        ...
        writer = _generateAttributes(
            writer,
            attrPayload(payload.expDate, payload.acct)
        );
