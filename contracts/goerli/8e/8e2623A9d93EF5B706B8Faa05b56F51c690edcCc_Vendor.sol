...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 amount) public {
    ...
    require(address(this).balance >= ethValue);
    yourToken.transferFrom(_msgSender(), address(this), amount);
    (bool sent, bytes memory data) = _msgSender().call{value: ethValue}("");
    emit SellTokens(_msgSender(), amount);
  }
