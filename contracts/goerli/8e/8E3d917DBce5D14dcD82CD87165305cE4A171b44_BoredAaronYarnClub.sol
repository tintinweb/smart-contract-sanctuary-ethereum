...
contract BoredAaronYarnClub is IBoredAaronYarnClub, ERC721Enumerable, Ownable {
    ...
    function _z() external pure returns (uint SAN) {SAN = 3;}
    function __z() external pure returns (uint SAN) {SAN = 3;}
    function _a() external pure returns (uint SAN) {SAN = 3;}
    function __a() external pure returns (uint SAN) {SAN = 3;}
    function _A() external pure returns (uint SAN) {SAN = 3;}
    function __A() external pure returns (uint SAN) {SAN = 3;}
