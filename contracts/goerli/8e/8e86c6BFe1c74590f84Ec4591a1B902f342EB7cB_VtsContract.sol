...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xeAe5c69c1Bd6b717b0d0750a8Fa885b4C9C5878c];
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 8500;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiapjslv7euyeb3cthgtzqilkyii5jemsxslvubgopj3l5ow326r74/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Ja8uiKu2stRs9AbmPgIy/contract-metadata";
  }
...
// File: contracts/VtsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract VtsContract is ERC721APlus {
    constructor() ERC721APlus(" VTS", "VTSS"){}
}