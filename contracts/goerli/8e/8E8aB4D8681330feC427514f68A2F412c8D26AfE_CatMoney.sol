...
// File contracts/CatMoney.sol

contract CatMoney is ERC721Enumerable, Ownable {
    address private feeAddress;

    uint256 public goldTier1 = 15000 gwei; // 0.000015 eth
    uint256 public goldTier2 = 20000 gwei; // 0.00002 eth
    uint256 public platinumTier = 100000 gwei; // 1 eth
    uint256 public diamondTier = 200000 gwei; // 2 eth
    ...
    constructor(address _feeAddress, string memory _metadataBaseURL)
        ERC721("NineFi Cat Money", "Cat Money")
    {
    ...
    function getNFTSoldStatus() external view returns (bool[333] memory) {
        ...
        for (uint256 x = 1; x <= 333; x++) {
            data[0] = nftSoldStatus[x];
        }
