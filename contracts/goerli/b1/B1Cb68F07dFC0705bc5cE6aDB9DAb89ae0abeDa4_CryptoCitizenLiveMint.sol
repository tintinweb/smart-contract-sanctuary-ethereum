...
{   
    ...
    { 
        ...
        ArtistMintPasses[_CurrentCityIndex][13] = address(0); 
        ArtistMintPasses[_CurrentCityIndex][14] = address(0); 
        ArtistMintPasses[_CurrentCityIndex][15] = address(0); 
        ArtistMintPasses[_CurrentCityIndex][16] = address(0); 
        ArtistMintPasses[_CurrentCityIndex][17] = address(0); 
        ArtistMintPasses[_CurrentCityIndex][18] = address(0); 
