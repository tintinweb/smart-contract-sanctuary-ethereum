...
/*    function withdraw(address to) external onlyOwner {
     ...
     * @return 生成したEggのID
     */
    function spawn(uint256 matrixId, string calldata metadataHash, address to) external returns (uint256) {
        require(registered[matrixId] != address(0x0), "MatrixMaster: invalid matrixId");
        ...
        uint256 allowance = IAnima(_animaContract).allowance(msg.sender,address(this));
