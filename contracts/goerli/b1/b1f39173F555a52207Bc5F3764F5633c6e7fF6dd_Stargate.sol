...
contract Stargate is Transfer, IStargateReceiver {
    ...
    constructor(address _bridgeToken, address _stargateRouter, address _swapRouter) Transfer(_bridgeToken, _stargateRouter, _swapRouter) {}
    ...
    function bridge(
        ...
        // bridge slippage is in basis points
        uint256 minAmountOut = _bridgeTokenAmount - ((_bridgeTokenAmount * _bridgeTxn.bridgeSlippage) / 10000);

        // Stargate's Router.swap() function sends the tokens to the destination chain.
        IStargateRouter(bridgeRouter).swap{value:_bridgeTxn.fee}(
            ...
            IStargateRouter.lzTxObj(_bridgeTxn.dstChainGasFee, 0, "0x"),        // lzTxObj object
    ...
    function sgReceive(
        ...
        completeTransfer(_token, amountLD, _payload);
    }
    ...
    function quoteLayerZeroFee(
        ...
        return IStargateRouter(bridgeRouter).quoteLayerZeroFee(
            _dstChainId,
