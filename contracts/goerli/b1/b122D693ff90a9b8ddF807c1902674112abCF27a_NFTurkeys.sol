...
contract NFTurkeys is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
            if (ArtistMintList[msg.sender] == true) {
                ...
                require(msg.value >= freeMint * _mintAmount);
    ...
    function addQueerFrensMintList(address _user) public onlyOwner {
        FrensMintList[_user] = true;
    }

    function removeQueerFrensMintList(address _user) public onlyOwner {
