...
contract JAGZ is ERC721AQueryable, Ownable {
  using Strings for uint256;
  uint256 public MAX_SUPPLY = 9999;
  uint256 public MAX_FREE = 6999;
  uint256 public maxFreeMintPerWallet = 3;
  uint256 public maxPublicMintPerWallet = 30;
  uint256 public publicTokenPrice = .001 ether;
  string _contractURI;
  ...
  constructor() ERC721A("JAGZ", "JAGZ") {
  _baseTokenURI = "ipfs://bafybeiefp7grqfgxuesxs3blfnj3g3zti77xkld2iybf3zmz5ngdhepcta/";
  }

  modifier callerIsUser() {
    require(tx.origin == msg.sender, 'JAGZ: The caller is another contract');
    _;
  }
