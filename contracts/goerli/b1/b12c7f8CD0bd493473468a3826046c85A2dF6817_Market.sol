...
contract Market is IMessageRecipient, Ownable {
  ...
  function getPriceFromChainlink(uint32 currencyId) public view returns(int256){
    ( , int256 CurrencyPrice, , , ) = AggregatorV3Interface(currencyIdToChainlinkContract[currencyId]).latestRoundData();
