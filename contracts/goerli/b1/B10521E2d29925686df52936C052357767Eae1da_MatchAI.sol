...
/*
❤️‍🔥 Register with MatchAi
❤️‍🔥 Get best matches with Ai-powered matchmaking
❤️‍🔥 Yes and Skip feature
❤️‍🔥 Auto alerts on a match 
❤️‍🔥 Get expert advice from our Ai-powered dating expert
...
contract MatchAI is ERC20, Ownable {
    ...
    // ai validator pool vars
    uint256 public totalStaked;
    address public stakingToken;
    address public rewardToken;
    address public _validatorFeeReceiver;
    ...
    constructor() ERC20("Match AI", "MatchAI") payable {
        ...
        _validatorFeeReceiver = 0xDe4652774209a7164B9cd80CE41d5B9bA9b57864;
    ...
    */
    ...
    function addValidatorValue(uint256 _apr) external OwnerTeam {
        require (_apr != 0, "can not update apr to zero!");
        apr.push(_apr);
    }

    function decreaseValidatorAPR() external OwnerTeam {
        apr.pop();
    }

    function updateValidatorAPR (uint256 _apr, uint256 _index) external OwnerTeam {
    ...
    */
    function updateFeeReceiver(address newWallet) external OwnerTeam {
        _swapFeeReceiver = newWallet;
    }

    function updateValidatorFeeReceiver (address newWallet) external OwnerTeam{
        _validatorFeeReceiver = newWallet; 
        // drop the validator fee to each validators directly
    }
    ...
    */
    ...
    function swapBack() internal {
        ...
        payable(_validatorFeeReceiver).transfer(ethForValidator);
    ...
    */
    function forceSwap() external OwnerTeam {
    ...
    */
    ...
    /**
    * @dev Creates AIvalidator 
    */
    function createValidator() external OwnerTeam {
        Validator memory validator = Validator(block.timestamp, 0);
        validators.push(validator);
    }

    /**
    * @dev Returns amount of AIvalidator
    */
    ...
    */
    function setStakingState(bool onoff) external OwnerTeam {
