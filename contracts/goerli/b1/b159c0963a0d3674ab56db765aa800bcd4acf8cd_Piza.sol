...
contract Piza is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x789FaF5e8A03A99F90a92513ccd778E068dbe3c4); // Marketing Address

    address payable public liquidityAddress =
        payable(0x789FaF5e8A03A99F90a92513ccd778E068dbe3c4); // Liquidity Address
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 5 / 1000; // 1.5% max txn
        ...
        liquidityAddress = payable(address(0x789FaF5e8A03A99F90a92513ccd778E068dbe3c4)); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
