...
contract testing is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "teste";//
    ...
    address payable private _developmentAddress = payable(0x654DA774B731688F532F2ba9bbE53F18c0959D08);//
    address payable private _marketingAddress = payable(0x2381C54d155E36BD89a17cdDce8daeDb966C4B78);//
