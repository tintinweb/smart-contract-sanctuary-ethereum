...
contract Exchange is SuAuthenticated, IExchange {
    ...
    function getOutAmountEDecimals(address tokenA, address tokenB, uint256 amountA, uint256 timePassed, DiscountType discountType) public view returns (uint256) {
        ...
        if (amountA != res * priceB / priceA) {
            // Here we lose some precision during dividing in getOutAmountEDecimals() => we roundUp
            return res + 1;
        }
        return res;
    }
...
//        console.log(maxOutAmount, 'maxOutAmount');
...
//        console.log(priceB, 'priceB');
        ...
        console.log(order.amountLeft, 'amountLeft');
        ...
        console.log(order.token2buy, msg.sender, outAmount);
        console.log(IERC20Metadata(order.token2buy).balanceOf(msg.sender));
