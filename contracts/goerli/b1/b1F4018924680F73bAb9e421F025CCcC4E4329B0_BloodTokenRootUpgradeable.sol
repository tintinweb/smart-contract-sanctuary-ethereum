...
contract BloodTokenRootUpgradeable is ERC20Upgradeable, ERC20BurnableUpgradeable, AccessControlMixinUpgradeable, NativeMetaTransactionUpgradeable, ContextMixinUpgradeable, IMintableERC20 {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override(ERC20Upgradeable, IERC20Upgradeable) returns (bool) {
        uint256 amountAfterTax = _calculateTransferAmountAfterTax(recipient, amount);
