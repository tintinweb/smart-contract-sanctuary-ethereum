...
contract TEST052208 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Test8", "Test8"){}
  ...
  function freeMint(uint256 amt) external callerIsUser {
    ...
    require(amt <= 10, "Max free mint per TX reached");
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on dear...");
