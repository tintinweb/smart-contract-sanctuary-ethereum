 ...
 */
contract SBT is Context, ERC165, ISBT721, IERC721Metadata {
    ...
    function attest(address to) external returns (uint256) {
        require(_msgSender() == _operator, "Only the owner can attest the SBT");
    ...
    function revoke(address from) external {
        require(_msgSender() == _operator, "Only the owner can revoke the SBT");
    ...
    function setBaseTokenURI(string memory uri) public {
        require(_msgSender() == _operator, "Only the owner can set the base token URI");
