...
/*
    ...
    intentionally to encourage artists to fork robohash and create their own sets. Robohash was
    ...
    * Humans/"set5" were uploaded by Simon Franz, MIT Licensed (derived from the repo). Variants: 1.141T Avatars.
...
contract shadowNFT is ERC721, Ownable {
    ...
    constructor() ERC721("ENS_Robohash", "ensBots") {
        // ENS Registrar Rinkeby: 0x283Af0B28c62C092C9727F1Ee09c02CA627EB7F5
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(
            "data:application/json;utf8,{'name':'ENS%20Robohash','description':'A%20template%20that%20gives%20each%20ENS%20name%20an%20untransferable%20Robohash','image':'",
            "https://robohash.org/", 
            tokenId.toString(),
            ".png?set=set5&size=1200x1200&bgset=bg2'}"));
    }
    ...
    */
    function ownerOf(uint256 tokenId) public view virtual override returns (address) {
        address owner = caster.ownerOf(tokenId);
    ...
    */
    ...
    function emitTransferEvent(uint256 tokenId) public virtual {
        //require(to != address(0), "ERC721: mint to the zero address");

        // Requires that the token actually exists
        require(_exists(tokenId), "ERC721: token does not exists");
