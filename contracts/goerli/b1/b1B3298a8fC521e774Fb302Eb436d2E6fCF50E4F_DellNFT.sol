...
contract DellNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    ...
    constructor() ERC721("DWNFT04", "DELL03") {
        collectionName = name();
    ...
    function createDellNFT() public returns(uint256) {
        ...
        string memory combinedWord = string(abi.encodePacked("https://kongz.herokuapp.com/api/metadata-vx/",Strings.toString(newItemId)));


        // string memory finalTokenURI = string("https://kongz.herokuapp.com/api/metadata-vx/1");
    
        _safeMint(msg.sender, newItemId);
        _setTokenURI(newItemId, combinedWord);
