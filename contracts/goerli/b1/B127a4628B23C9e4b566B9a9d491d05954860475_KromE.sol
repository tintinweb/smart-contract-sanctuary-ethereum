    ...
    PaymentSplitter
{
    ...
    uint256 _price = 90000000000000000; // 0.09 ETH

    Counters.Counter private _tokenIds;

    uint256[] private _teamShares = [40]; // 3 PEOPLE IN THE TEAM
    address[] private _team = [
        0x643D0e4f66Ea66639956b18b63654ef414470246 // VIP Account gets 40% of the total revenue
    ];
