...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract Chopangtest is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;


  string private uriPrefix = "ipfs://QmUjPvugCCU48UBfnj4TaNuzb9yPAw6bETjaA65NEGimhu/" ; 
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmSdxwaVnAJQ67aM3ugxXv5QVGo7bTEbn5arX3ubY9Z44K/";
  ...
  constructor() ERC721A("Chopang", "CHP") {
  }
  ...
  function Reserve(uint16 _mintAmount, address _receiver) external onlyOwner {
     uint16 totalSupply = uint16(totalSupply());
    require(totalSupply + _mintAmount <= maxSupply, "Exceedes max supply.");
