...
contract CNPG is ERC721A('DUMY', 'DUMY'), Ownable, AccessControl, DefaultOperatorFilterer, ERC2981 {
    enum Phase {
        BeforeMint,
        PrivateMint,
        PreMint1,
    ...
    // address public constant withdrawAddress = 0x2A0522e7f9FD372e6fe320bFBe230F62964f5c9c;
    address public constant withdrawAddress = 0x997Aa5d16619fDCb25A7108C83444a5ca42D8bf8;
    uint256 public constant maxSupply = 16500;
    string public constant baseExtension = '.json';

    string public baseURI = 'https://data.syou-nft.com/dumy/';
    ...
    constructor() {
        ...
        // _safeMint(0x2A0522e7f9FD372e6fe320bFBe230F62964f5c9c, 3300);
        // _setDefaultRoyalty(0x0AB10c7d3f097d45D086cEA54b20D9bF763580e6, 1000);
        _safeMint(0x997Aa5d16619fDCb25A7108C83444a5ca42D8bf8, 3300);
        _setDefaultRoyalty(0x997Aa5d16619fDCb25A7108C83444a5ca42D8bf8, 1000);
    }
