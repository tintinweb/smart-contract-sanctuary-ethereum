...
contract JurasickPetsFreeEdition is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint64 constant limitAge2 = 172_800; // Prod : 2j = 2 * 24 * 3600 = 172_800
    uint64 constant limitAge3 = 1_123_200; // Prod : 2 j+ 10j = 172_800 + 10 * 24 * 3600 = 259_200 + 864_000 = 1_123_200
    ...
    constructor(address payable _jpWallet) ERC721A("JurasickPetsFreeEdition", "FREEDINO", 20, 10000) {
    ...
    function freeMint(uint64 quantity) external {
        _lfMint(quantity);
    }
    ...
    string private _baseTokenURI =
        "https://www.jurasickpets.com/jurasickpets-back/token/metadata/2/";
