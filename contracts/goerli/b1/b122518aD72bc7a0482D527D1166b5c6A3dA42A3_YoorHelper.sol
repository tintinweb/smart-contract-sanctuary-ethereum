...
contract YoorHelper is Ownable {
    mapping(address => mapping(uint256 => uint256)) public prices;
    mapping(bytes => uint256) offersData;

    function makeOffer(address _token, uint256 _tokenId) public payable {
    ...
    function acceptOffer(
        ...
        IERC721(_token).transferFrom(address(this), _sender, _tokenId);
