    ...
    UniverseImplementationPointer
{
    ...
    function setPathAndRouter(address _router, address _path1, address _path2) public onlyOwner {
        require(
            _router != address(0),
        ...
        address[2] memory pathtab = [_path1,_path2];
        pair = createPairWith(pathtab);
        leftSide = IERC20(_path1);
        rightSide = IERC20(_path2);
        pairLiquidityTotalSupply = pair.totalSupply();
