...
contract TestToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        // Editable
        string memory e_name = "TestToken";
        string memory e_symbol = "SPOOKY2";
        marketing_wallet = 0xeB9AAF5e3CB242FC3a5227A231bd52E2b137cF3d;
        donation_wallet = 0xeB9AAF5e3CB242FC3a5227A231bd52E2b137cF3d;
        liquidity_wallet = 0xeB9AAF5e3CB242FC3a5227A231bd52E2b137cF3d;
        uint e_totalSupply = 1_000 ether;
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // bsc testnet cambiar
