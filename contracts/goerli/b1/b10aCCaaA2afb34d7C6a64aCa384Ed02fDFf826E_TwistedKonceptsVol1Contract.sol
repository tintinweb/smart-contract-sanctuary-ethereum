...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1676648700;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1676646000;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x406F45A5013764734C2c7898FF33B4b54ab4FD49];
  address public erc20Payable = 0x406F45A5013764734C2c7898FF33B4b54ab4FD49;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.021 ether;
  uint256 public earlyMintTokenIdCap = 202;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 404) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeie6qnfcwnl3miucs6oi525kdt5hbm3oneiwvykuxsuz4oact6h3ve/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/A4rxu0GxqEuU71eWYxST/contract-metadata";
  }
...
// File: contracts/TwistedKonceptsVol1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TwistedKonceptsVol1Contract is RamppERC721A {
    constructor() RamppERC721A("Twisted Koncepts Vol1 ", "TWK"){}
}
