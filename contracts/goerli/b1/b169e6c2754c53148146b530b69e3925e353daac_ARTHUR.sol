...
contract ARTHUR is ERC20, Ownable {
    ...
    constructor() ERC20("ARTHUR", "ART") {
        ...
        marketingWallet = address(0x5670a29a40a4Fd24FBFE8392E34F3F54f8F702fE);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            // on buy
            else if (automatedMarketMakerPairs[to] && buyTotalFees > 0) {
