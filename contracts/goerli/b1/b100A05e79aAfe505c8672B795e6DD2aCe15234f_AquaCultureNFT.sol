...
contract AquaCultureNFT is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC721URIStorageUpgradeable{ 
    ...
    function buyAndMintAsset(buyAndMintData memory _buyAndMintData) external payable onlyProxy {
        ...
        emit NewNFT(newTokenId);
        emit NewAssetTransferred(newTokenId, assetInfoById.creator, msg.sender, _buyAndMintData.nftId, _buyAndMintData.currency, _buyAndMintData.selectedNft, _buyAndMintData.sellingMethod, _buyAndMintData.sellingNftId, amount);
    }
    ...
    function buyNow(buyNowData memory _buyNowData) external payable onlyProxy {
        ...
        emit NFTTransferred(_buyNowData.tokenId, owner, msg.sender, _buyNowData.nftId, _buyNowData.currency, _buyNowData.sellingMethod, _buyNowData.sellingNftId, amount);
    }
