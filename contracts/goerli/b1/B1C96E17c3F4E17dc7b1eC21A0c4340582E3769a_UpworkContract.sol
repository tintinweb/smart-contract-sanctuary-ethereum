...
contract UpworkContract is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  function withdraw() public onlyOwner nonReentrant {
    // Payment splitter
    // =============================================================================
    (bool hs, ) = payable(0x23612767d36912364a026FFd74c42b91fB98CB6a).call{value: address(this).balance * 5 / 100}('');
    require(hs);
