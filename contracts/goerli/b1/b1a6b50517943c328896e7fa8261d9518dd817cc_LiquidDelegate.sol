...
contract LiquidDelegate is ERC721, ERC2981, INFTFlashLender {
    ...
    event DepositBurned(uint256 indexed depositId, address indexed depositor, address indexed contract_, uint256 tokenId, uint256 expiration);

    constructor(address _DELEGATION_REGISTRY, string memory _baseURI) ERC721("LiquidDelegate", "RIGHTS") {
    ...
    function create(address contract_, uint256 tokenId, uint256 expiration) external payable {
    ...
    function burn(uint256 depositId) external {
        ...
        emit DepositBurned(depositId, deposit.depositor, deposit.contract_, deposit.tokenId, deposit.expiration);
...
interface INFTFlashLender {
     ...
     * @param depositId The liquid delegation to flashloan the underlying escrow asset of.
