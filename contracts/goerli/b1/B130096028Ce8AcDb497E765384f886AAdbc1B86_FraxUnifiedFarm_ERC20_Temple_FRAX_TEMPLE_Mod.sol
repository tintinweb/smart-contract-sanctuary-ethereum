...
contract FraxUnifiedFarmTemplateMod is Owned, ReentrancyGuard {
    ...
    uint256 public lock_time_for_max_multiplier = 3 * 86400; // 3 days
    ...
    uint256 public rewardsDuration = 2 * 86400; // 2 * 86400  (2 days)
...
contract FraxUnifiedFarm_ERC20_Mod is FraxUnifiedFarmTemplateMod {
    ...
    FraxUnifiedFarmTemplateMod(_owner, _vefxs, _frax, _rewardTokens, _rewardManagers, _rewardRatesManual, _gaugeControllers, _rewardDistributors)
    {
...
contract FraxUnifiedFarm_ERC20_Temple_FRAX_TEMPLE_Mod is FraxUnifiedFarm_ERC20_Mod {
    constructor (
        address _owner,
        address _vefxs,
        address _frax,
    ...
    FraxUnifiedFarm_ERC20_Mod(_owner , _vefxs, _frax, _rewardTokens, _rewardManagers, _rewardRates, _gaugeControllers, _rewardDistributors, _stakingToken)
    {}
}