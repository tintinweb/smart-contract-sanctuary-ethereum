...
contract Particular is Initializable {
    ...
    // DATA FEED POLYGON -> 0xF9680D99D6C9589e2a93a78A04A279e509205945
    IChainlink constant chainlink = IChainlink(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e);
    IUniswapRouter constant swapRouter = IUniswapRouter(0xE592427A0AEce92De3Edee1F18E0157C05861564);
    address public admin;
    address public wallet;
    //REVIEW - > CAN´T BE CHANGED RIGHT NOW AND CAN´T DEPLOY OTHER PARTICULAR CONTRACT
    ...
    */
    receive() external payable {
        ...
        uint256 amountOutMin = (toStable * price) * 98 / 100;
        ...
        swapRouter.exactInputSingle{value: toStable}(params);
        swapRouter.refundETH();
        uint256 totalConverted = IERC20(0x07865c6E87B9F70255377e024ace6630C1Eaa37F).balanceOf(address(this));
        emit Converted(totalConverted);
        ...
        //TransferHelper.safeTransfer(0x07865c6E87B9F70255377e024ace6630C1Eaa37F, wallet, amountToSave);
        //TODO: 2 wallets -> 1 for kindly and 1 for ongs and fetch addresses from factory
        //TransferHelper.safeTransfer(0x07865c6E87B9F70255377e024ace6630C1Eaa37F, 0xF2D03fc122038172F6D1ef7893135E8650C30542, amountToKindly);
        (bool success, ) = wallet.call{value: address(this).balance}("");
        require(success, "Error: could not send ETH to your desired address");
        //emit Transaction(admin, 0xF2D03fc122038172F6D1ef7893135E8650C30542, amountToKindly, address(this).balance);
    }
