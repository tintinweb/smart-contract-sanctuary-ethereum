...
contract CTZN is ERC20, ReentrancyGuard, Ownable
{
    ...
    constructor() ERC20("CTZN", "CTZN") 
    {
        ...
        ActiveBRTContracts = 1;
        CitizenContracts[0] = CitizenContract('CryptoGalacticans', 0x90Ef8A02bB1E9f9763C142F63dD2c6cb67d37149, 0, 1000);
        CitizenContracts[1] = CitizenContract('CryptoVenetians', 0x90Ef8A02bB1E9f9763C142F63dD2c6cb67d37149, 0, 1000);
        CitizenContracts[2] = CitizenContract('CryptoNewYorkers', 0x90Ef8A02bB1E9f9763C142F63dD2c6cb67d37149, 0, 1000);
        CitizenContracts[3] = CitizenContract('CryptoBerliners', 0x90Ef8A02bB1E9f9763C142F63dD2c6cb67d37149, 0, 1000);
        CitizenContracts[4] = CitizenContract('CryptoLondoners', 0x90Ef8A02bB1E9f9763C142F63dD2c6cb67d37149, 0, 1000);
    ...
    function DelegateCitizens(address Recipient, uint[][] calldata TokenIDs) public nonReentrant
    {
        for(uint x; x < TokenIDs.length; x++)
        {
            for(uint y; y < TokenIDs[x].length; y++)
            {
                ...
                {
                    AddressDelegatedCitizens[CitizenDelegation[TokenIDs[x][y]]]--;
                }
