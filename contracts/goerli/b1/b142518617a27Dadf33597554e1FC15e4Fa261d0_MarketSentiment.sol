...
// Checking to see if the ticker they tryna vote for actually exists
    ...
    function getTokenExistence(string memory _token) public view returns (bool){
        return tokenNameToTokenInfo[_token].exists;
    }
    ...
    function isPersonVoter(address voter,string memory _token) public view returns (bool) {
        return tokenNameToTokenInfo[_token].Voters[voter];
    }
