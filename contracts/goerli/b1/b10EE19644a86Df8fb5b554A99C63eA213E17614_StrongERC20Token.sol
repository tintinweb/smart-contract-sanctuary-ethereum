...
contract StrongERC20Token is ERC20Permit, VaultOwned {

    using LowGasSafeMath for uint256;

    // https://docs.soliditylang.org/en/v0.8.11/contracts.html?highlight=constructor#constructors
    constructor() ERC20("Strong", "STNG", 9) {
    }
