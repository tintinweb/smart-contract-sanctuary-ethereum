// SPDX-License-Identifier: MIT
    ...
    contract IndelibleERC721A is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"ant", unicode"eye", unicode"body", unicode"legs", unicode"back"];
        ...
        uint256 public allowListPrice = 0.000 ether;
        uint256 public maxPerAllowList = 1;
        bool public isAllowListActive;
        
        ContractData public contractData = ContractData(unicode"weis", unicode"My", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/231e450b-9a23-4b96-98f4-d47427370c03", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/231e450b-9a23-4b96-98f4-d47427370c03", "", 300, "0x1B03463FE6793961c3a24cC98bC835909A3aAC95");

        constructor() ERC721A(unicode"weis", unicode"WEI") {
            TIERS[0] = [49,73,121,160,208,389];
TIERS[1] = [41,76,120,126,179,458];
TIERS[2] = [36,41,50,159,163,551];
TIERS[3] = [500,500];
TIERS[4] = [85,115,216,239,345];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"weis #");
