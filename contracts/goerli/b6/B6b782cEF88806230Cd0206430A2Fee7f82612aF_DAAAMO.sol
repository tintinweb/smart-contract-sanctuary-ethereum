...
contract DAAAMO is ERC721A, ERC4907A, OperatorFilterer, ERC721AQueryable, IERC4906, ERC721ABurnable, ERC2981, Ownable, Pausable, AccessControl {
    ...
    address private constant FUND_ADDRESS = 0xEc77367447d202f76d282695c2673Ca8fB69D2fd;
    ...
    function setPresalePhase(bool _state, Ticket ticket) external onlyOwner {
        presalePhase[ticket] = _state;
    }

    function setPresaleMaxMint(uint256 _preMaxMint, Ticket ticket) external onlyOwner {
        presaleMaxMint[ticket] = _preMaxMint;
    }

    function setPresaleCost(uint256 _preCost, Ticket ticket) external onlyOwner {
