...
import "./interfaces/IAnomuraEquipment.sol";
    ...
    IAnomuraEquipment
{
    ...
    /// @dev Emit an event when the merkle root for claim is updated
    ...
    function initialize() external initializer {
        __ERC721A_init("Anomura Equipment", "AnmEqup");
        ...
        claimLive = true; // to be false on production
    ...
    */
    function setContractPaused(bool _isPaused)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        isPaused = _isPaused;
