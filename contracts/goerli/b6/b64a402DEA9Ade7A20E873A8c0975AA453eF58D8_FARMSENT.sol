...
contract FARMSENT is
     ...
     */
    function addMultipleAccountToBlacklist(address[] calldata _beneficiers)
        external
        onlyOwner
    {
     ...
     * @param _beneficiary address of the account.
     */
    function checkBlacklisted(address _beneficiary)
        external
        view
        returns (bool)
    {
     ...
     * @param _beneficiers address of the account.
     */
    function addMultipleAccountToWhitelist(address[] calldata _beneficiers)
        external
        onlyOwner
    {
        for (uint256 i = 0; i < _beneficiers.length; i++) {
     ...
     * @param _beneficiary address of the account.
     */
    function checkWhitelisted(address _beneficiary)
        external
        view
        returns (bool)
    {
