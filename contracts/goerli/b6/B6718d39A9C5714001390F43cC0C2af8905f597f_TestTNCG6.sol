...
contract TestTNCG6 is ERC721, Ownable, ReentrancyGuard {

    address public founderAddress = 0xE3cF924Bb3B2d243FBd2661b02eAcE3811528416; //0xb9Cc3F6cd058Cdf7e9b5E960505aefd1b0195D16;
    ...
    uint256 public _maxTokens = 5000;
    uint256 public _price = 0.088 ether;
    uint256 public _foundersTokens = 628;
    bytes32 public _merkleRoot = 0x8b988b2dda55fe0b69bf0659b6e40a719084f1bc5f19fa237cd34816017d83ad;
    
    mapping(address => uint256) private _walletMints;
    mapping(uint256 => bool)    public _founderMints;

    constructor() ERC721("TestTNCG6", "TNCG") {}
