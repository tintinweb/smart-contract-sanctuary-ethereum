...
/**
   ...
   @dev This contract issues ERC-20 Token of corresponding Coins/Tokens on origin networks
*/
contract Vault is ERC20 {
    IGovernance public gov;
    uint256 public _decimals_;

    modifier onlyAuthorizer() {
        require(gov.iService() == msg.sender, "Unauthorized");
        _;
    }
    ...
    */
    function mint(address _to, uint256 _value) external onlyAuthorizer isMaintenance {
        _mint(_to, _value);
    }
    ...
    */
    function burn(uint256 _value) external isMaintenance {
        _burn(msg.sender, _value);
    }

    function decimals() public view override returns (uint8) {
        return uint8(_decimals_);
    }
}
