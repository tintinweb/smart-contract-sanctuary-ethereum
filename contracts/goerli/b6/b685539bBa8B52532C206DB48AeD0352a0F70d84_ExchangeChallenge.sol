...
contract ExchangeChallenge is ERC20Challenge, NFTChallenge {
    ...
    constructor(address token) ERC20Challenge(token) NFTChallenge(token) {}
}
...
abstract contract ERC20Challenge is Ownable, Challenge, IERC20Challenge {
    ...
    function addTokenChallenge(
        ...
        challengeToken.transferFrom(_msgSender(), address(this), escrowAmount);
        return challengeId;
    }
    ...
    function airdropTokenChallenge(
        ...
        challengeToken.transfer(owner(), challenge.airdropFee);

        challengeToken.transfer(receiver, challenge.tokenAmount);
...
import "@openzeppelin/contracts/access/Ownable.sol";
 ...
 abstract contract Challenge is Ownable{
    ...
    address public PRIMARY_TOKEN = 0xB7fF000273faf6cdD98C524689e15258f250B656; //WOM token address
