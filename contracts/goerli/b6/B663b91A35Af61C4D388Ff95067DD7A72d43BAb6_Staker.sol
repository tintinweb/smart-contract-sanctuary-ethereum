...
contract Staker {
  ...
  event Returned(address, uint256);
  ...
  modifier notCompleted() {
    require(exampleExternalContract.completed() == false, "The execution is completed already.");
    _;
  }
  ...
  function withdraw() public notCompleted {
    ...
    require(sent, "Failed for withdrawal");

    emit Returned(recipient, value);
  }
  ...
  function execute() public notCompleted {
    ...
    if (address(this).balance >= threshold) {
      ...
      exampleExternalContract.complete{ value: value }();
