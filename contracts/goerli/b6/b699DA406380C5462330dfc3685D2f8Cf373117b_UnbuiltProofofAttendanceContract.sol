...
// File: contracts/UnbuiltProofofAttendanceContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract UnbuiltProofofAttendanceContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Unbuilt Proof of Attendance";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/bWHJYxnTONVPKUl1HjnH/contract-metadata";
  }
