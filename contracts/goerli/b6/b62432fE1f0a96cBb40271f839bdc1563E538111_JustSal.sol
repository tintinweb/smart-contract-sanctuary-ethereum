 ...
 * @notice This contract handles minting Just Sal tokens.
 */
contract JustSal is
    ERC721A,
    ERC721AQueryable,
    ...
    RevokableOperatorFilterer
{
    ...
    address public royaltyAddress = 0x373c83fD87A9ca5152736C8a612F698a79396243;
    address[] public payoutAddresses = [
        0x373c83fD87A9ca5152736C8a612F698a79396243
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibyyzvnuj7giteogdysnpwp665atupzumznen2t3dziat7gquo6xe/";
    ...
    uint96 public royaltyFee = 696;

    constructor(uint256 _heymintFeePerToken)
        ERC721A("Just Sal", "SAL")
        RevokableOperatorFilterer(
