...
contract PoorPleb is ERC20, Ownable {
    ...
    /**
     * @notice Update allow users mint once without be on whitelist
     */
    function setMintOnceWithoutWhitelist(bool val) external onlyOwner {
        mintOnceWithoutWhitelist = val;
    }
    ...
    function claim() external {
        ...
        if (!mintOnceWithoutWhitelist) {
            require(claimListAmounts[msg.sender] > 0, "max claimed amount exceded");
        }
    ...
    /**
     * @notice Return limit date for claim
     */
