...
contract CryptaSubscription is Ownable, Pausable, ReentrancyGuard {
    ...
    */
     ...
     */
    address[] passes;
    // HashMap of active subscriptions per addresses
    mapping(address => Subscription) public subscribers;
    // HashMap of subscription ID's and payment 
    ...
    constructor() { 
        ...
        subscriptionTypes[5] = SubscriptionType(4, "partner");
    ...
    /*
    * Check if subscription by ID is paid
    ...
    */
     ...
     * @param _customer An address of active subscription's wallet
     */
    function executePayment(
        ...
        subscribers[_customer].endTime = _calculateExpireTimestap(subscribers[_customer].timeId);
    }
    ...
    function _comissionPayoutErc20(address _token, address _to, uint256 _purchaseAmount, uint256 _comission) internal {
       if (_purchaseAmount > 0 && _comission > 0) {
            ...
            if (tokenInterface.balanceOf(address(this)) >= fee) {
                tokenInterface.transferFrom(address(this), _to, fee);
            }
       }
    }
