...
import "../../ERC173/interfaces/IERC173Upgradeable.sol";
import "./IERC5727MetadataUpgradeable.sol";

/**
 *    interfaceId = 0x0349722d
 */
interface IERC5727RegistrantUpgradeable is
    ...
    ERC721EnumerableUpgradeable
{
    ...
    function __ERC5727Registry_init(
        ...
        __ERC5727Registry_init_unchained(admin_, uri_);
    }
    ...
    function __ERC5727Registry_init_unchained(
        ...
        OwnableUpgradeable._transferOwnership(admin_);
    }
    ...
    function transferOwnership(
        ...
        address newOwner
    ) public virtual override onlyRegistrantOrOwner(contractAddr) {
        safeTransferFrom(_msgSender(), newOwner, entryOf(contractAddr));
    }
