...
// File: contracts/CartoonBunch.sol
...
contract CartoonBunch is ERC721Enumerable, Ownable {
  ...
  uint256 public cost = 1 ether;   // 10k uKrown
  uint256 public maxSupply = 1000;
  uint256 public NAME_CHANGE_PRICE = 1 ether;
  uint256 public maxMintAmount = 1000;
  bool public paused = false;
  address private _ukrownAddress;
  ...
  function changeName(uint256 tokenId, string memory newName) public {
      ...
      IERC20(_ukrownAddress).transferFrom(msg.sender, address(this), NAME_CHANGE_PRICE);
  ...
  function mint(uint256 _mintAmount) public {
    ...
    if (msg.sender != owner()) {
        IERC20(_ukrownAddress).transferFrom(msg.sender, address(this), cost * _mintAmount);
    }
