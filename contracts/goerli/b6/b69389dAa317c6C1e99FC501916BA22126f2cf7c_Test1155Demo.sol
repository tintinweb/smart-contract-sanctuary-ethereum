 ...
 * @notice This contract handles minting Test 1155 demo tokens.
 */
contract Test1155Demo is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x32fadcFAdC293995e597BB370b23b6372D7E7096;
    ...
    string public name = "Test 1155 demo";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeiaibikalnfm2tksrn3unbqjw5xeqm4qo5npaayjamqgwpwzl6stnq/{id}"
        )
    {
        ...
        tokenMaxSupply[777] = 1000;
        tokenPublicPrice[777] = 0.01 ether;
        tokenPublicMintsPerAddress[777] = 1000;
        require(
