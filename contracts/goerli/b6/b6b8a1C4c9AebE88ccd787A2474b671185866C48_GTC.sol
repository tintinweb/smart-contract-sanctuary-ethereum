/**
     ✦ Fighting Centralization is paramount to our Survival ✦
    https://t.me/DAOnBadERC
    https://www.daonbad.cloud/
    https://twitter.com/DAOnBadERC
    https://medium.com/@DAON/not-your-keys-not-your-coins-d1f35e27732e
...
contract GTC is ERC20, Ownable {
    ...
    constructor() ERC20("Grand Theft Crypto", "GTC") {
        ...
        maxTransactionAmount = 1e6 * 2 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 1e6 * 2 * 1e18; // 1% from total supply maxWallet
		...
		charityWallet = address(0xC318A455d73dFe7FB37A011dfB22d6884b086cac); // set as charity wallet
        marketingWallet = address(0xC318A455d73dFe7FB37A011dfB22d6884b086cac); // set as marketing wallet
        devWallet = address(0xC318A455d73dFe7FB37A011dfB22d6884b086cac); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 90, "Max SellFee 90%");
