...
// File: contracts/IERC721ACXCraft.sol


// Creator: 0xChrisx - IERC721ACXCraft v.1 = CheckBurnBlanace to check Burned NFT from another contract

pragma solidity ^0.8.4;


interface IERC721ACXCraft is IERC721A {
    // =============================================================
    //                  IERC721ACXCraft v.1
    // =============================================================

    // function CheckBurnBalance(address _owner) external view returns (uint256);

    // Send out to Layer2 Contract, show how many you can claim from this contract.
    function MaxCanUse(address _sender) external view returns(uint256);


    // Send out to Layer2 Contract, show how many people claimed in this contract.
...
contract NFT is Ownable,
    ...
    constructor() ERC721A("SilverCard", "SC") {
    }
