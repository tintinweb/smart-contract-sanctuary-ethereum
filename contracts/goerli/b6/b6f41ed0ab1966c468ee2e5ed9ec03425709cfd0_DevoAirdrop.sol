...
contract DevoAirdrop is Context, Ownable {
    ...
    constructor(IERC20 _token,address _tokenHolder,bytes32 _root) {
        require(
            address(_token) != address(0),
            "Devo: token is 0 address"
        );
    ...
    function claim(
        ...
        token.safeTransferFrom(tokenHolder, _msgSender(), amount);
    }
