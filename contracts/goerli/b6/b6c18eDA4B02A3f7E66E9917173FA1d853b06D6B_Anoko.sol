...
/// @title: Anoko
/// @author: Kaishiba
/// @dev: This contract using NFTBoil (https://github.com/faiasu/NFTBoil)
...
contract Anoko is ERC721A, ERC2981 , Ownable, Pausable, CantBeEvil(LicenseVersion.CBE_NECR_HS)  {
    ...
    uint256 constant public MAX_SUPPLY = 2525;
