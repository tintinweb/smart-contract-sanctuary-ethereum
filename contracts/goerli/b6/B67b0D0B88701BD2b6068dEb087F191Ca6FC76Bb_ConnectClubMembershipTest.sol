...
/**
 * @title ConnectClubMembershipTest
 * ConnectClubMembershipTest - clubs membership.
 */
contract ConnectClubMembershipTest is MintableERC1155 {
  constructor()
  MintableERC1155(
    "https://nft.stage.connect.club/membership/",
    "ConnectClub Membership",
    "CLUB"
  ) {}
...
contract MintableERC1155 is ERC1155, Ownable {
        ...
        payable
    {
        ...
        (bool sent, bytes memory data) = creator.call{value: msg.value.div(1000).mul(25)}("");
