...
contract DPSGameSettings is Ownable, ReentrancyGuard {
    ...
    constructor() {
        ...
        voyageConfigPerType[0].gapBetweenInteractions = 3600;
        ...
        voyageConfigPerType[1].gapBetweenInteractions = 3600;
        ...
        voyageConfigPerType[2].gapBetweenInteractions = 3600;
        ...
        voyageConfigPerType[3].gapBetweenInteractions = 3600;
        ...
        doubloonPerFlagshipUpgradePerLevel[0] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[1] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[2] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[3] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[4] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[5] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[6] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[7] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[8] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[9] = 750 * 1e18;
        doubloonPerFlagshipUpgradePerLevel[10] = 750 * 1e18;
    }
    ...
    // function getVoyageDebuffs(uint256 _type) external view returns (uint16) {
