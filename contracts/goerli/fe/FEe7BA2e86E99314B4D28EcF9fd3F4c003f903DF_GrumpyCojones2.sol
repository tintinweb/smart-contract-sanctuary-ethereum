...
/*
        GGGGGGGGGGGGG  DDDDDDDDDD
     GGGGGGGGGGGGGGGG  DDDDDDDDDDDDD
   GGGGGGGGGGGGGGGGGG  DDDDDDDDDDDDDDDD
  GGGGGGGGGGGGGGGGGGG  DDDD     DDDDDDDDD
 GGGGGGG       GGGGGG  DDDD       DDDDDDDD
GGGGGGG                DDDD         DDDDDDD
GGGGGGG                DDDD          DDDDDDD
GGGGGGG    GGGGGGGGGG  DDDD           DDDDDD
GGGGGGG    GGGGGGGGGG  DDDD           DDDDDD
GGGGGGG    GGGGGGGGGG  DDDD           DDDDDD
GGGGGGG        GGGGGG  DDDD          DDDDDDD
GGGGGGG        GGGGGG  DDDD         DDDDDDD
 GGGGGGG       GGGGGG  DDDD       DDDDDDDD
  GGGGGGGGGGGGGGGGGGG  DDDD     DDDDDDDDD
   GGGGGGGGGGGGGGGGGG  DDDDDDDDDDDDDDDD
...
/*
Cojones were a race of Not-so-Middle-earth also known as the Khazâd (in their own tongue) or Casari, Naugrim, meaning 'Stunted People', and Gonnhirrim, the 'Masters of Stone'. Grumpy Cojonesis a ethereum based blockain project created to bring these Cojones to the Digital Age.
**/
...
// File: contracts/GrumpyCojones2.sol
...
/**
    ...
    GrumpyCojones will not be responsible or liable for all loss or 
...
contract GrumpyCojones2 is ERC721, Ownable {

    uint constant public MAX_SUPPLY = 50;
    uint constant public PRICE = 0.01 ether;

    string public baseURI = "ipfs://QmU9KjjpS94xZQGAHKodpSg3FA7WBnfLQSc6zmENN6GaLB/";
    ...
    uint public mintingStartTimestamp = 1643582203;
    uint public reservedSupply = 5;

    uint public totalSupply;
    mapping(address => uint) public mintedNFTs;

    constructor() ERC721("GrumpyCojones2", "GC2") {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x40eC6fbcc1A9362b9E705A418A8e73174C3E9795).transfer(balance);
    }
