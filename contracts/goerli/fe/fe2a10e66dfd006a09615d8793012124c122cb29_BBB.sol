...
contract BBB is ERC20 {
    uint256 public thresholdForLiquiditySwap = 1500 gwei;
    uint256 public amountForLiquiditySwap = 750 gwei;

    uint8 public developmentFee = 4;
    uint256 public maximumHold = 100000 gwei;
        ...
        if (from == uniswapV2Pair || to == uniswapV2Pair && !inSwapAndLiquify) {
            ...
            if (from != uniswapV2Pair) {
                ...
                if (contractTokenBalance >= thresholdForLiquiditySwap) {
                    contractLiquify(amountForLiquiditySwap);
                    
//                    try uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
//                        amountForLiquiditySwap,
//                        0,
//                        path,
//                        address(this),
//                        (block.timestamp + 300)
...
//                    } catch {}
    ...
    function contractLiquify(uint256 amount) private lockTheSwap {
        ...
        emit SwapAndLiquify(amount, newBalance, amount);
    }
    ...
    function updateContractLiquiditySwap(uint256 newThresholdForLiquiditySwap, uint256 newAmountForLiquiditySwap) external onlyOwner {
        ...
        require (newThresholdForLiquiditySwap >= (newAmountForLiquiditySwap * 2), "newThresholdForLiquiditySwap must be 2x greater than newAmountForLiquiditySwap");
