...
contract VerificationTest is ERC721, Ownable, DefaultOperatorFilterer {
    ...
    uint public constant COLLECTION_SIZE = 333;
    ...
    constructor() ERC721("VerificationTest", "TST"){}
    
    
    function contractURI() public pure returns (string memory) {
        return "data:application/json;base64,eyJuYW1lIjoiWmVyb0NvZGVORlRUZXN0OTk5OCIsImRlc2NyaXB0aW9uIjpudWxsLCJleHRlcm5hbF91cmwiOm51bGwsImZlZV9yZWNpcGllbnQiOiIweEFiYjY4MkE5ZTAwRDc4OEQ5RGNCNjNGY0E2NTNCMTFhMUQwMzA4YkYiLCJzZWxsZXJfZmVlX2Jhc2lzX3BvaW50cyI6NDAwfQ==";
    }
    ...
    function calcTotal(uint count) public view returns(uint) {
        require(saleStatus != SaleStatus.PAUSED, "VerificationTest: Sales are off");
    ...
    function mint(uint count) external payable {
        require(saleStatus != SaleStatus.PAUSED, "VerificationTest: Sales are off");
        require(_tokenIds.current() + count <= COLLECTION_SIZE, "VerificationTest: Number of requested tokens will exceed collection size");
        
        
        require(msg.value >= calcTotal(count), "VerificationTest: Ether value sent is not sufficient");
