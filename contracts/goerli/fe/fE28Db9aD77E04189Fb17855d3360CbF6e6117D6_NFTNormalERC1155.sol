...
contract NFTNormalERC1155 is ERC1155, Ownable {
    //--------------------------------------------------------------------
    // VARIABLES
    ...
    // Number of nfts is limited to 1 per user during whitelisting
    ...
    function mint(uint256 _mintAmount) external payable {
        ...
        if(block.timestamp < whitelistStarttime) {
            revert NFT__NotWhitelistTime();
        }else if(block.timestamp >= whitelistStarttime && block.timestamp < publicStarttime)
        {
