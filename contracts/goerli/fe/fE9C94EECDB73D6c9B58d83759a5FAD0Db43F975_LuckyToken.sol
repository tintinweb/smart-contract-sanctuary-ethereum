...
contract ERC20 is Context {
        ...
        returns (bool)
    {
        ...
        require(_balances[caller] >= amount);
        ...
        returns (bool)
    {
        ...
        require(spender != address(0));
        address caller = _msgSender();
        require(allowance(caller, spender) >= subtractedValue);
         _approve(caller, spender, allowance(caller, spender) - subtractedValue);
        return true;
    }
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyCoinJZH1", "LCJZH1") {}
}