...
contract TESTERC721A is ERC721A, Ownable {
    ...
    uint256 public auctionTimestamp;
    bytes32 public merkleRoot ;

    // Tokenization
    string  public baseURI;
    uint256 public price = 0 ether;
    uint256 public publicCurrentSupply = 10000;
    ...
    function mintPublicByState(uint256 quantity) public payable callerIsUser {
    ...
    function mintPublicByTimestamp(uint256 quantity) public payable callerIsUser {
        require(block.timestamp >= auctionTimestamp, "Public minting not available"); 
    ...
    function mintPrivateByState(uint256 quantity, bytes32[] calldata proof) public payable callerIsUser {
    ...
    function mintPrivateByTimestamp(uint256 quantity, bytes32[] calldata proof) public payable callerIsUser {
       require(block.timestamp >= auctionTimestamp, "Private minting not available");
        require(canMintPrivate(msg.sender, proof), "Failed wallet verification");
    ...
    function setPrice(uint256 desiredPrice) public onlyOwner {
        price = desiredPrice;
    }

    function setAuctionTimestamp(uint256 timestamp) public onlyOwner{
    ...
    function getPrivateMintedForAddress(address account) external view returns (uint256) {
