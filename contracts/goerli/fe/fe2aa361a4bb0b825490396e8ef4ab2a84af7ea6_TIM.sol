...
contract TIM is ERC1155, Ownable {
    ...
    constructor() ERC1155("") {
        header = string(abi.encodePacked(
                        ...
                        '<text style="white-space:pre;fill:rgb(0,255,0);font:normal 16px Courier, Monospace, serif;" x="7" y="17">'));
        ...
        footer = string(abi.encodePacked(
            ...
            '<text style="font:bold 10px Courier, Monospace, serif;fill:rgb(0, 127, 0)" x="7" y="294">',
            domain,
            '</text>'));
