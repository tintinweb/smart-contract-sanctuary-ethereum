...
contract Try2 is ERC721, Ownable {
  using Counters for Counters.Counter;
    ...
    constructor(string memory _customBaseURI) ERC721("Try2", "Try")  {
    ...
    function mint(uint256 numberOfMints) external payable {
        ...
        require(supply+numberOfMints <= maxSupply, "Payment exceeds total supply");
