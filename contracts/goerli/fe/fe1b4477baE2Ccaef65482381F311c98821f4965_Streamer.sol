...
contract Streamer is Ownable {
    ...
    function withdrawEarnings(Voucher calldata voucher) public onlyOwner {
        ...
        */
        ...
        require(balances[signer] > voucher.updatedBalance, "must have running channel");
    ...
    */
	function challengeChannel() public {
		require(balances[msg.sender] != 0, "You don't have a running channel!");
    ...
    */
	function defundChannel() public {
		require(canCloseAt[msg.sender] > 0, "You don't have a closing channel!");
		require(canCloseAt[msg.sender] < block.timestamp, "Chellenge period not over!");
