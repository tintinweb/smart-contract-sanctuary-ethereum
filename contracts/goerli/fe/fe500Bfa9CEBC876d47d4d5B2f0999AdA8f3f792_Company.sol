...
// Set up all restrictoins tru DAO?
    ...
    // Solution #3 (restriction to add new employee)
     ...
     function validToAddNew(uint _newRate)public view returns(bool){
...
contract StreamLogic is TokenAdmin {
    ...
    //------------ MAIN FUNCS [STREAM]----------
    function startStream(address _recipient, uint256 _rate) public isLiquidationHappaned{
...
contract TokenAdmin {
    ...
    function balanceContract()public view onlyOwner returns(uint){
...
// -------------- Access roles ---------------
    ...
    // modifier employeeAccess(){

    // }

    // function checkEmployee(address _who) internal returns(bool){
