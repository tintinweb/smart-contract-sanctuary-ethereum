...
import { IPicardyDomainMetadata } from "./picardyDomainMetadata.sol";
import {IPicardyDomain} from "./IPicardyDomain.sol";
...
/// @author @blok_hamster
/// @notice Dynamically generated NFT contract
contract PicardyDomain is IPicardyDomain, ERC721, Ownable, ReentrancyGuard {
  ...
  mapping (string => Domain) public override domains; // mapping (domain name => Domain struct); Domain struct is defined in IPicardyDomain
