...
contract SoulAether is NotablesERC721A {
    ...
    uint16 public constant maxSupply = 69;
    uint8 constant reserve = 3;
    
    uint256 public constant worthyCost = 0.00005 ether;
    uint256 public constant cost = 0.000075 ether;
    uint256 public constant publicCost = 0.0001 ether;
    ...
    constructor() ERC721A("SoulAether", "SAE") {
        waveTimes = [block.timestamp - 6 hours, block.timestamp - 4 hours, block.timestamp - 2 hours, block.timestamp];
    }
