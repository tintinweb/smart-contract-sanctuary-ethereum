...
contract Directory is IDirectory, Ownable {
    ...
    function setContractDescription(uint256 index_, string memory description)
        external
        onlyOwner
    {
        contractRecordAt[index_].description = description;
        emit ContractDescriptionSet(index_, description);
    }
