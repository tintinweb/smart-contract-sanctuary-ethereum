    ...
    IService
{
    ...
    /// @dev block delay for executeBallot to mitigate FlashLoan attacks. Number of blocks.
    ...
    event ExecuteBallotBlockDelayChanged(uint8 executeBallotBlockDelay);
    ...
    /**
     * @dev Sets executeBallotBlockDelay. Allows 0 block delay to be set.
     * @param _executeBallotBlockDelay block delay, number of blocks.
     */
    function setExecuteBallotBlockDelay(uint8 _executeBallotBlockDelay)
        public
        onlyOwner
    {
        executeBallotBlockDelay = _executeBallotBlockDelay;
    }
