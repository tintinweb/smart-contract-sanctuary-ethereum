    ...
    ERC1155Holder
{
    ...
    function unstake() public {
        _transfer(address(this), msg.sender, Staked[msg.sender].amount);
        claim();
    ...
    function feeDistributor(uint256 _fee) internal {
        uint256 lndxFee = _fee * lndxHoldersPercentage / 10000;
        uint256 operationalFee = _fee * landXOpertationsPercentage / 10000;
