...
contract FUCK is ERC20, Ownable {
    ...
    constructor() ERC20("FUCK", "FUCK") {
        ...
        marketingWallet = address(0x27F1B28CB32e0AB3e7D8ABA513B28416108C1ABb); // set as marketing wallet
        devWallet = address(0x6799a57d5aF4679847974406BC4D2ECC921cfF86); // set as dev wallet
