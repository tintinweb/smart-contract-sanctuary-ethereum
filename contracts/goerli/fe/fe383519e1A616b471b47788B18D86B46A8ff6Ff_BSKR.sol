...
contract BSKR is IERC20, Ownable, Manageable, Pausable {
    ...
    address private constant DEXV2_ROUTER_ADDR =
        0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // UniswapV2Router02
    address private constant DEXV3_FACTORY_ADDR =
        0x1F98431c8aD98523631AE4a59f267346ea31F984; // UniswapV3Factory
    address private constant DEXV3_ROUTER_ADDR =
        0xE592427A0AEce92De3Edee1F18E0157C05861564; // SwapRouter
    address private constant NFPOSMAN_ADDR =
    ...
    IUniswapV2Router02 private immutable dexRouterV2;
    ...
    bool private addLPEnabled = true;
    ...
    uint256 private numTokensForLP = _TOTAL_SUPPLY / 1000; // 0.1% of the total supply
    uint256 private maxTxAmount = _TOTAL_SUPPLY / 25; // 4% of the total supply
    ...
    constructor(
        ...
        IUniswapV2Router02 _dexRouterV2 = IUniswapV2Router02(DEXV2_ROUTER_ADDR);
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            require(amount <= maxTxAmount, "EMTA");
        }
    ...
    function isUniswapV2Pair(address target) internal returns (bool) {
        ...
        string memory targetSymbol = callAndParseStringReturn(
            target,
            hex"95d89b41"
        );
        ...
        if (compare(targetSymbol, "UNI-V2")) {
            IUniswapV2Pair pairContract = IUniswapV2Pair(target);
