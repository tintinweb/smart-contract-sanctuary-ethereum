...
/// @title ParentOpenTherapoid
/// @notice ERC-20 implementation of ParentOpenTherapoid token
contract ParentOpenTherapoid is ERC20, Ownable, Pausable {
    ...
    /**
     * @dev Sets the values for {name = ScienceCoin}, {totalSupply = 5000000}, {decimals = 18} and {symbol = SCI}.
     *
    ...
    constructor(
    ...
    ) ERC20("ScienceCoinParentProd", "SCIPP") {
        //solhint-disable-next-line reason-string
        require(
        ...
        // Mint SCN tokens to contractOwner address
        super._mint(contractOwner, fixedSupply); // Since Total supply 500 Million SCI
