...
contract VibrantShapes is ERC721A, Ownable, DefaultOperatorFilterer {
    string baseURI;
    string baseExtension = ".json";
    bool saleLive;

    uint256 public constant maxSupply = 143;
    uint256 public immutable maxMintAmount = 5;
    mapping(address => uint256) public Minted;

    constructor(string memory _BaseURI) ERC721A("Vibrant Shapes", "VSHAPES") {
        setBaseURI(_BaseURI);
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (_mintAmount > maxMintAmount) revert OverMintLimit();
