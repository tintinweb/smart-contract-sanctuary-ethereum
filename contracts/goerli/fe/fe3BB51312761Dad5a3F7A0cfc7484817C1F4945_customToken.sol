...
contract customToken is ERC20,Ownable {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _price) ERC20(_name, _symbol) {
      ...
      function mint(uint256 _amount) public {
        ...
        require (IERC20(usdcAddress).balanceOf(msg.sender) >= _amount*priceInUSDC, "Insufficient balance of USDC");
        require(IERC20(usdcAddress).allowance(msg.sender, address(this)) >= _amount*priceInUSDC  , "The smart contract require your approval to transfer your USDC on your behalf" );

        IERC20(usdcAddress).transferFrom(msg.sender,address(this),_amount*priceInUSDC);
