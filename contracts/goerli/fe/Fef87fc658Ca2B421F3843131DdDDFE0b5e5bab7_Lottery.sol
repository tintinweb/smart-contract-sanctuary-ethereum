...
error Lottery__UpkeepNotNeeded(uint256 balance, uint256 playerCount, uint256 state);
...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /**
     * @dev This method is used to by chainlink node to check if conditions are met to call the performUpkepp method.
     */
    ...
    /**
     * @dev This method is used by chainlink node to execute custom actions once conditions are met. This is where it picks the winner
     */
