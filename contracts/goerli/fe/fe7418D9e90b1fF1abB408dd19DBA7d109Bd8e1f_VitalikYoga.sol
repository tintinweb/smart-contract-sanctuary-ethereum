...
contract VitalikYoga is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public totalFreeMint = 4000;

    string public baseURI = "ipfs.io/ipfs/Qmd3NmQYZqVhfMtM92JtPjG2KxUTZJfxig9xGdWq8Mryrj/";
        ...
        mintValidation(_mintAmount)
    {
        ...
        } else if (YogaPractitioner[msg.sender] < freeMintPerWallet) {
    ...
    // Set total free mint
    function setTotalFreeMint(uint256 _amount) public onlyOwner {
        totalFreeMint = _amount;
    }
