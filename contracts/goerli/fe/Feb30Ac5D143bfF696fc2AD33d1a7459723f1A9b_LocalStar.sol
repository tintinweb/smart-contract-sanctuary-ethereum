...
contract LocalStar is ERC721AQueryable, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  ...
  mapping(address => bool) public isWhitelistFreeMintClaimed;
  mapping(address => bool) public isPublicSaleFreeClaimed;

  mapping(address => uint) public whitelistClaimedCounter;
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) {
    ...
    require(!isWhitelistClaimed[tx.origin], "you're already mint in wl");
