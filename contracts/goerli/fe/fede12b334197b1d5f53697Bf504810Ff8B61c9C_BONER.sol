    ...
    Ownable
{
    ...
    constructor() {
        ...
        rewardTokens.push(address(0xe46Aeb8952EC91Ce06508a3C6F363bdB053Bed11)); // Test: 0xe46Aeb8952EC91Ce06508a3C6F363bdB053Bed11
...
contract BONER is ERC20, Ownable {
    ...
    constructor() ERC20("BONER", "BONER") {
        uint256 totalSupply = 1 * 1e9 * 1e18; // 1 Billion total supply
        ...
        _createInitialSupply(address(msg.sender), (totalSupply * 30) / 100);
    }
