...
contract Bridge is AccessControl, IBridge {
    ...
    function decodeSwapMessage(
        ...
        // console.log("srcPoolId ", scrPoolId);
        // console.log("dstPoolId ", dstPoolId);
        // console.log("receiver ", receiver);
        // console.log("amount ", amount);
        // console.log("fee ", fee);
        // console.log("vouchers ", vouchers);
        // console.log("optimalDstBandwidth ", optimalDstBandwidth);
...
interface IBridge is ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    function getReceivedSwaps(uint16 _srcChainId, bytes32 _id)
        external
        view
        returns (IAssetRouter.SwapMessage memory);
