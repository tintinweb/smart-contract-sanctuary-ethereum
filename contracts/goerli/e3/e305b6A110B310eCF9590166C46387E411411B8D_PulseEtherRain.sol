...
contract PulseEtherRain is Context, IERC20, Ownable {  
    ...
    string private _name = "PulseEtherRain";
    string private _symbol = "PEr";
    uint8 private _decimals = 18;
    uint256 public _maxWalletLimit = 10000000000 * 10 ** 18;
    uint256 public _maxBuy = 100000 * 10 ** 18;
    uint256 public _maxSell = 100000 * 10 ** 18;
    ...
    function updateBuyAndSell(uint256 _buyAmount,uint256 _sellAmount) public onlyOwner {
        _maxBuy = _buyAmount;
        _maxSell = _sellAmount;
