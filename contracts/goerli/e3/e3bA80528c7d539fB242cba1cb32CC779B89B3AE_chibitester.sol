...
contract chibitester is ERC721A, ERC2981, OperatorFilterer, Ownable {
    ...
    address public constant w1 = 0x343b0724C77ec64e706E2E975Cc56AF01559D66D;

    constructor() ERC721A("chibitester", "chibitest"){
    ...
    function mint(uint256 amount) external payable {
        ...
        require(totalSupply() + amount <= maxSupply, "cb full");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!revealed) {
            return "https://gateway.pinata.cloud/ipfs/Qmb2kCDn8eZWjzCBmxeRYJtfKHR36v9mYhKkC8VwieTJWd";
        }
	    string memory currentBaseURI = _baseURI();
	    return bytes(currentBaseURI).length > 0	? string(abi.encodePacked(currentBaseURI, tokenId.toString())) : "https://gateway.pinata.cloud/ipfs/QmcE9rBpdVP27hievCMSpBTCQ79zbFxSf8dKWKLpZzT6pY/1.json";
    }
