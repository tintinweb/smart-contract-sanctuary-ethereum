...
/* Library Imports */
import { CrossDomainEnabled } from "../libraries/CrossDomainEnabled.sol";
 ...
 */
contract L1ERC721Bridge is IL1ERC721Bridge, CrossDomainEnabled, Ownable {
    /********************************
    ...
    function depositERC721(
        ...
        address _l2Token = l1ToL2Token[_l1Token];
        require(_l2Token == address(0), "not mapped");
    ...
    function _initiateERC721Deposit(
        ...
        bytes memory message = abi.encodeWithSelector(
            IERC721Bridge.finalizeDeposit.selector,
            _l1Token,
            _l2Token,
            _from,
            _to,
        ...
        emit ERC721DepositInitiated(_l1Token, _l2Token, _from, _to, _tokenId, _tokenURI, _data);
    }
