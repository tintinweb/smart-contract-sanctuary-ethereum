...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Base", unicode"Wire Color", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"EN - Episode 2: Connections", unicode"2nd Component and Collection of EP 1: Mysterious Microchips. Episode 2 will be released on medium prior to mint. Holders of EP1 will get AL to mint EP2. Holders of EP1 & EP2 get priority mint for EP3", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/1667ae5a-2440-4918-8288-3e0111f18d3e", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/1667ae5a-2440-4918-8288-3e0111f18d3e", "https://medium.com/@hopefrancis338", 1000, "0xDf5b5259586E003b30ba911f4541F904305272CE");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"EN - Episode 2: Connections", unicode"EN-EP1-WIRES") {
        tiers[0] = [105];
        tiers[1] = [5,10,18,18,18,18,18];
        tiers[2] = [21,21,21,21,21];
