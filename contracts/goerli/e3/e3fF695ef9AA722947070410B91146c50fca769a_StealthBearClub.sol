...
// File: openzeppelin-contracts/contracts/token/ERC721/extensions/ERC721Burnable.sol
...
// File: openzeppelin-contracts/contracts/token/ERC721/extensions/ERC721Pausable.sol
...
// File: stealthbears/stealthbears.sol
contract StealthBearClub is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;
    uint256 public constant MAX_ELEMENTS = 8888;
    uint256 public constant PRICE = 15 * 10**16; // 0.15 ETH
    uint256 public constant MAX_BY_MINT = 20;
    string public baseTokenURI;
    event CreateBear(uint256 indexed id);
    constructor(string memory baseURI) ERC721("StealthBearClub", "SBC") {
        setBaseURI(baseURI);
        pause(true);
    }
    modifier saleIsOpen {
    ...
    function fiatMint(address _to, uint256 _count) public onlyOwner saleIsOpen {
        uint256 total = _totalSupply();
        require(total + _count <= MAX_ELEMENTS, "Max limit");
        require(total <= MAX_ELEMENTS, "Sale end");
        for (uint256 i = 0; i < _count; i++) {
