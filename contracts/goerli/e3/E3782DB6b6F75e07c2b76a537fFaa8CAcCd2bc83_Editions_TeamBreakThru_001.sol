...
contract Editions_TeamBreakThru_001 is ERC1155Burnable, Ownable, DefaultOperatorFilterer {
    string public name = "Editions_TeamBreakThru_001";
    string public symbol = "ETBT001";
    string public contractUri = "https://dev.teambreakthru.net/collections/Editions_TeamBreakThru_001/contract";
    address CouponSigner = 0x0000000000000000000000000000000000000000; // Address of the wallet that generated the coupons 
    address MintSender;
    uint256 public MintPrice = 0 ether; // Price of each NFT in Ethereum during Public Sale
    bool public MintEnabled = false;
    bool public MintPublic = false;
    bool public TokenTypeSingle = true;
    uint256 public MaxTokenAmount = 0;
    struct MintTypes {
        uint256 _MintsByAddress; // Mint type used to track number of public mints by address
	}
    struct Coupon {
		bytes32 r;
		bytes32 s;
    ...
    constructor() ERC1155("https://dev.teambreakthru.net/collections/Editions_TeamBreakThru_001/token_{id}") {
        idTracker.increment();
    }
