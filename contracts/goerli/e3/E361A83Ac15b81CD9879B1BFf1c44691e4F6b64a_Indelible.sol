...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    ContractData public contractData = ContractData(unicode"gm nouns", unicode"gm 🤝 nouns // artwork 100% on-chain, forever // free mint x 3369 // cc0 artwork courtesy of legendary nouns.wtf // gm glasses by me", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/c0f87cef-5b5f-4295-b4f3-240db2f195d4", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/c0f87cef-5b5f-4295-b4f3-240db2f195d4", "", 500, "0x1f1177e1EA1D5f7761B7A9083af1064369303E30");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"gm nouns", unicode"GMN") {
        tiers[0] = [9,26,38,39,40,53,74,78,83,91,172,176,178,190,224,233,306,347,393,619];
        tiers[1] = [1,3,4,5,8,10,12,14,15,16,17,18,18,19,19,22,22,24,24,24,34,37,39,42,44,44,46,46,46,50,54,56,57,61,61,62,64,69,79,85,86,89,89,111,113,125,132,135,144,204,245,259,266];
        tiers[2] = [1,2,3,3,4,6,6,7,9,9,10,12,12,15,16,17,19,20,23,25,27,27,29,30,31,31,32,33,35,36,37,37,39,44,52,55,55,56,56,57,58,64,68,69,72,73,74,80,81,83,97,104,107,137,188,266,296,434];
        tiers[3] = [2,20,27,30,37,40,46,48,50,76,93,94,110,115,144,148,156,160,199,202,219,593,760];
        tiers[4] = [484,2885];
