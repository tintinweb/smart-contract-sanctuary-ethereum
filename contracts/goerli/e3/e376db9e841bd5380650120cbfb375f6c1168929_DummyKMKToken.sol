...
// File: contracts/ERC20-KMK-Root-2.sol
...
contract DummyKMKToken is ERC20, AccessControl, ERC20Pausable {
    bytes32 public constant GOV_ROLE = keccak256("GOV_ROLE");
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    constructor(address rootChainManager) ERC20("DummyKMKToken", "DKMKT") {
        ...
        _grantRole(PREDICATE_ROLE, rootChainManager);
    }
