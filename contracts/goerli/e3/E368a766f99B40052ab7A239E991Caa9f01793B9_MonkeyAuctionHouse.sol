    ...
    ReentrancyGuardUpgradeable
{
    ...
    // Minimum time left in the auction before it ends
     ...
     */
    function initialize(address payable _splitter, address _svgGen, address _tnmtToken, uint256 _timeBuffer, uint8 _minBidIncrementPercentage, uint256 _duration, uint256 _lastauctionId, uint256 _minColorDifValue) external initializer {
        __Pausable_init();
