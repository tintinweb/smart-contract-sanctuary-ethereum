...
contract Collections is Initializable, UUPSUpgradeable {
    ...
    */
     ...
     */
    function mint(ERC1155Lockable Collection, uint256 supply, bytes calldata uri_, uint256 royaltyValue, address royaltyRecipient, string memory PrivateFilesURI) public payable  {
