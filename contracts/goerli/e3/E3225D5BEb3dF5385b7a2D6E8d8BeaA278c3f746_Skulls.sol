...
contract Skulls is ERC721Enumerable, Ownable {
    ...
    function generateSeed(uint256 tokenId) private view returns (uint256) {
        ...
        uint256 eyeSeed = 100 * ((r >> 96) % 9 + 10) + ((r >> 96) % 20 + 10);
        uint256 bodySeed = 100 * ((r >> 144) % 5 + 10) + ((r >> 144) % 20 + 10);
        return 10000 * (10000 * (10000 * headSeed + eyeSeed) + bodySeed);
        // return 10000 * (10000 * (10000 * headSeed + eyeSeed) + bodySeed) + legsSeed;
    }
