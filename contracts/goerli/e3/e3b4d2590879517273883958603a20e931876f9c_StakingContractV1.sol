...
contract StakingContractV1 is StakeStructs, IStakingContractV1, StakeOpsController, Pausable {
    ...
    modifier checkWithdrawalConditions(address _addr) {
        ...
        require(block.timestamp >= (stkData[_addr].unstakeTimestamp + (60*60)), "StakingContractV1:checkWithdrawalConditions: 7 days need to pass before you can withdraw");
        _;
    }
