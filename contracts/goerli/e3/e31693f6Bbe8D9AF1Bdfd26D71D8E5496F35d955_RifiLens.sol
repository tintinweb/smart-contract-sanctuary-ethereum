...
contract GovernorAlpha {
    ...
    string public constant name = "Rifi Governor Alpha";

    /// @notice The number of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    function quorumVotes() public pure returns (uint) { return 400000e18; } // 400,000 = 4% of Rifi

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public pure returns (uint) { return 100000e18; } // 100,000 = 1% of Rifi
    ...
    /// @notice The address of the Rifi Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Rifi governance token
    RifiInterface public rifi;
    ...
    constructor(address timelock_, address rifi_, address guardian_) public {
        timelock = TimelockInterface(timelock_);
        rifi = RifiInterface(rifi_);
        guardian = guardian_;
    }
