...
contract MarketplaceDutch is Ownable, ReentrancyGuard
{
    ...
    function ViewWalletSaleInformation(
        ...
        bool Verified;
        bool VerifiedAmount;
        bool Ended = SalesInternal[SaleIndex]._ActiveBrightList || SalesInternal[SaleIndex]._ActivePublic;
        ...
        return(
            _UserSaleInformation(
                ...
                MaxAmount - UserInfo[SaleIndex][Wallet]._PurchasedAmount,                  // The User's Remaining Purchase Allocation
