...
contract CreationBabies is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard, ERC2981 {  
    ...
    //FOR GOERLI, CHANGE LATER
    address public pieContractAddress = 0x2c5b329906B4A75a17fc1E4B490986ebDC30E92C;
    address public cakeContractAddress = 0xba4243eE4c2aE134Efc0CCb832410a00DD67f1F1;
    ...
    uint256 private cakeOrPieBasePrice = 0.06 ether;
    uint256 private cakeAndPieBasePrice = 0.03 ether;
    ...
    function updateCakeOrPieBasePrice(uint256 _cakeOrPieBasePrice) public onlyOwner {
        cakeOrPieBasePrice = _cakeOrPieBasePrice;
    }
    ...
    function checkPrice(uint256 quantity, address user) public view returns (uint256) {
        ...
        } else if (hasPie || hasCake) {
            price = cakeOrPieBasePrice;
        }
    ...
    function mint(uint256 quantity) public payable nonReentrant callerIsUser {
        ...
        for (uint256 id = minTokenID; id <= maxTokenID; id++) {
            ...
            _setTokenRoyalty(id, split, royaltyBps);
        }
    }
