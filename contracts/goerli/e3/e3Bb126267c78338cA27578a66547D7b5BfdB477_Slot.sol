...
contract Slot is VRFConsumerBaseV2, Ownable, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        unchecked {
            i_refreshStoredSpinsLength = (refreshStoredWords * NUMBERS_PER_WORD) / NUM_REELS;
            i_startingStoredSpinsLength = (startingStoredWords * NUMBERS_PER_WORD) / NUM_REELS;
            i_startingStoredNumbers = startingStoredWords * NUMBERS_PER_WORD;
        }
    }
