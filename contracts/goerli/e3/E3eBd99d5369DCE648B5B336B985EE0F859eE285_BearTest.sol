...
contract BearTest is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    uint256 public maxSupply = 10;
    uint256 public maxNormalMintPerAccount = 5;
    uint256 public maxWhitelistMintPerAccount = 5;
    uint256 public publicSalesTimestamp = 1669075516;
    uint256 public whitelistSalesTimestamp = 1669075516;
    ...
    uint256 public whitelistMintPrice = 0.002 ether;
    ...
    constructor() ERC721A("BearTest", "BF") EIP712("BearTest", "1.0.0") {}
    ...
    function _hash(address account) private view returns (bytes32) {
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256("BearTest(address account)"),
                        account
                    )
                )
            );
