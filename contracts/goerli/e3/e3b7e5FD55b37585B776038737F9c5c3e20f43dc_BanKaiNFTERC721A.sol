...
contract BanKaiNFTERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public saleStartTime = 1661166000;
    ...
    address[] private _team = [
        ...
        0x7a89c716f52b472a15E1A115adaBE6B8448410eB
    ];
    ...
    ERC721A("Ban-Kai NFT", "BK") 
    PaymentSplitter(_team, _teamShares) {
        merkleRoot = _merkleRoot;
        baseURI= _baseURI;
        teamLength = _team.length;
        _safeMint(0x7a89c716f52b472a15E1A115adaBE6B8448410eB, 1);
    }
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        require(!isPaused, "Contract is Paused");
        require(currentTime() >= saleStartTime + 2 hours, "Public sale has not started yet");
        require(currentTime() < saleStartTime + 3 hours, "Public Sale is finished");
