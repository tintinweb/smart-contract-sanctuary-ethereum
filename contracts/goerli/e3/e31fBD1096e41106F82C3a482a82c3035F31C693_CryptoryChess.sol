...
contract CryptoryChess is ERC721A, Ownable, ReentrancyGuard, Pausable {
    ...
    ) ERC721A("Cryptory Chess", "Cryptory Chess") {
        // Commented to test
        // metadataUri = _metadataUri;
        // _setSaleInfo(_saleInfoList);
        metadataUri = "https://marketsaigon.s3.ap-southeast-1.amazonaws.com/metadatas/";
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        if (!isOpened) {
            return string(abi.encodePacked(metadataUri, "unopened"));
        }
    ...
    function setIsOpened(bool _isOpened) external onlyOwner {
        isOpened = _isOpened;
    }
