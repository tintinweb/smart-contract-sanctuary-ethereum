    ...
    PaymentSplitter
{
    ...
    address[] private _team = [
        0x774301acEA2782BaF62C7EF9C79b53553eF52a6C,
        0x675720fEaCFb8551e0AF7C611010e1ff90A147c8
    ];
    ...
    uint256 public _freeparentsPerWallet = 2;
    // Max Number of parental figures in wallet
    uint256 public _parentsPerWallet = 10;
    ...
    constructor()
        payable
        ERC721A("PLENTYOFIT", "PLENTYOFIT")
        PaymentSplitter(_team, _teamShares)
    {
        _owner = msg.sender;
        _currentIndex = _startTokenId();
        setBaseURI("https://ipfs.io/ipfs/CID/");
    }
...
/*---------- ----------- ---------- Public Functions ---------- ----------- ----------*/
    ...
    ///@notice First one free, then after is 0.0039 ether
    function _mint(uint256 count) external payable {
    ...
    function _isSaleActive() public view returns(bool){
        return _parentsFighting;
    }
    ...
    function tokenURI(
        ...
        require(block.timestamp >= timeOfSetApprovalForAll[msg.sender] + 2 minutes, "You must hold this token for 24 hours in order to see the revealed image");
