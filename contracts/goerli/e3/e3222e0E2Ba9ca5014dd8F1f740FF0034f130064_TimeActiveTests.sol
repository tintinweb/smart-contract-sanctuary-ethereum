 ...
 * @notice This contract handles minting time active tests tokens.
 */
contract TimeActiveTests is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x31c1B62A10509A392F86a7134E6166e88FbdD85b;
    ...
    string public name = "time active tests";
        ...
        )
    {
        ...
        tokenURI[1] = "https://artdrops.curiousaddys.com/tokens/1";
