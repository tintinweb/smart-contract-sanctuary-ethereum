...
contract CrimsonDAO is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    constructor(IVotes _token)
        Governor("CrimsonDAO")
        GovernorSettings(1 /* 1 block */, 1800 /* 6 hour */, 1)
