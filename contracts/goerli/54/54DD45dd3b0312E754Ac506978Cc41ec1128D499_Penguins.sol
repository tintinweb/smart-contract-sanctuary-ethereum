...
IPenguinDescriptor public descriptor;
uint256 public maxSupply = 10000;
bool public minting = false;
bool public canUpdateSeed = true;

constructor(IPenguinDescriptor newDescriptor) ERC721("Penguins", "PENG") {
...
function setDescriptor(IPenguinDescriptor newDescriptor) external onlyOwner {
    descriptor = newDescriptor;
}
...
function getSeed(uint256 tokenId) public view returns (uint256) {
    require(_exists(tokenId), "Penguin does not exist.");
...
function generateSeed(uint256 tokenId) private view returns (uint256) {
    ...
    uint256 hatSeed = 100 * (r % 9 + 1);
    uint256 faceSeed = 100 * ((r >> 48) % 9 + 1) + ((r >> 72) % 9 + 1);
    uint256 bellySeed = 100 * ((r >> 96) % 9 + 1) + ((r >> 120) % 9 + 1);
    uint256 feetSeed = 100 * ((r >> 144) % 9 + 1) + ((r >> 168) % 9 + 1);
    return 1000000 * (1000000 * (10000 * hatSeed + faceSeed) + bellySeed) + feetSeed;
}
