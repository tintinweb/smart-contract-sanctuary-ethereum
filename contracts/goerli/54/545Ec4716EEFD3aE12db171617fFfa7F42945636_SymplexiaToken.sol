...
abstract contract AutoLiquidity is Adjustable {
    ...
    address             internal   liquidityPair;
    bool                internal autoLiquidity;
    bool                internal inLiquidityProcess; 
    
    event AutoLiquidityIssued(uint256 tokensSent);    
...
//   ====================================== 
    ...
    function _autoLiquidity(uint256 _amount) internal {
        ...
        ILiquidityVault(liquidityVault).autoLiquidity(_amount);
        emit AutoLiquidityIssued(_amount);
    }
//   ======================================
//          External Functions                    
//   ======================================    
    ...
    function updateRouter(address _swapRouter) external  onlyRole(Contract_Manager) {
        swapRouter = IUniswapV2Router02(_swapRouter);
        liquidityPair = IUniswapV2Factory(swapRouter.factory()).getPair(address(this),swapRouter.WETH());
    }
...
//   ==========================================
    ...
    function _beforeTokenTransfer (address sender, address recipient, uint256 amount) internal { 
        uint256 _newTokenPrice = ILiquidityVault(liquidityVault).getTokenPrice();
