 ...
 *
 * Ownership will be transferred to the owner address creation
 * at the end of initialise function.
 *
 * Features:
 * Owner can mint,burn,pause and unpause
 * Anti-Bot features such as Whitelisting accounts, Maximum account balance limt and Maximum transaction limit
 */

contract BAIRToken is
  Initializable,
  ERC20Upgradeable,
  ...
  OwnableUpgradeable
{
  ...
  function initialize(
    ...
    _walletBalanceLimit = walletBalanceLimit_ * (10**uint256(decimals_));
    _transactionLimit = transactionLimit_ * (10**uint256(decimals_));
    _decimals = decimals_;
  ...
  /**
   * @dev     Overriding the inherited function transfer to include anti-bot protection.
  ...
  function transfer(address to, uint256 amount) public virtual override returns (bool) {
    if (_antiBotProtection) {
      ...
      require(
        ...
        'Wallet balance limit exceeded after performing transaction : Please send lesser amounts.'
      );
    }
