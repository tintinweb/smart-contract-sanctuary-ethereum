...
contract Pool is IModule, IYieldFarmingV1Pool, Initializable  {
    ...
    function initialize(PoolConfig memory cfg) public initializer {
        __Pool_init(cfg);
    }

    function __Pool_init(PoolConfig memory cfg) internal onlyInitializing {
        __Pool_init_unchained(cfg);
    }

    function __Pool_init_unchained(PoolConfig memory cfg) internal onlyInitializing {
...
interface IYieldFarmingV1Pool {
    ...
    function initialize(PoolConfig memory cfg) external;
