...
contract PrimaryIndexTokenWrappedTokenGateway is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    function leveragedBorrowWithProjectETH(address _lendingToken, uint _notionalExposure, uint _marginCollateralAmount, bytes memory buyCalldata) public payable nonReentrant{
