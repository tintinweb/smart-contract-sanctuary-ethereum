...
contract AGEEN is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("AGEEN", "") {
  ...
  string private customContractURI =
    "ipfs://bafybeiaavog5i2eivjas2c6m75lzh576jxivccip75zuefwvycgbstzkfu";
