...
contract WenMyFrens is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable supply = 448;
    ...
    address[] public withdrawAddresses = [0x977003Da3A26c9255E034AC852cD0E1eD0c41072, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x9c63d2e3ba2036e6df8906f7045156f71fef49e8501c5457d378664b12a22f23;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x977003Da3A26c9255E034AC852cD0E1eD0c41072, _royaltyAmount);
    }
