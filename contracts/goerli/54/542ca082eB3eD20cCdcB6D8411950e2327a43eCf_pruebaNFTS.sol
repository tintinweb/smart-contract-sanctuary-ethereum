...
contract pruebaNFTS is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://ipfs.io/ipfs/QmSmWtSwofbKbNpjkqFY9RQFprzxSR6CGh7JgA2u5zzeJT/";

  constructor() 
    ERC721("PRUEBANFTS", "PRUNFTS")
