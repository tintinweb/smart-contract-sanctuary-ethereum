...
contract Aniborgz is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 private constant MAX_PUBLIC = 4136;
    ...
    uint256 public saleStartTime = 1670672526; // 03 dec 2022 19:33:00
    ...
    uint256 private constant maxPerAddressDuringWhitelistMint = 5;
    ...
    uint256[] private _teamShares = [48, 48, 4];
        ...
        callerIsUser
    {
        ...
        require(
            currentTime() < saleStartTime + 336 hours,
