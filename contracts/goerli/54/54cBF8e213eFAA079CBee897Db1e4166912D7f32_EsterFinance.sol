...
contract EsterFinance is ERC20, Ownable {
    ...
    constructor() ERC20("EsterFinance", "UNIFI") Ownable(msg.sender, msg.sender) {

        LPTokenReceiver = msg.sender;
        devReceiver = 0x9A8e04881aA201aD8fa4d78F8053Febd0be3a7aC;
        marketingReceiver = 0xcD966Bd7b11B2c766B4cF2FfEBB1992634e8E0DB;
