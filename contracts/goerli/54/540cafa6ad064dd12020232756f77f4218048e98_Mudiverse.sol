...
contract Mudiverse is ERC721A, Ownable {
    ...
    mapping(address => uint16) internal playerPositions;
    ...
    /**
     * Create a new location represented in NFT form.
     */
    ...
    function setMetadata(uint16 tokenId, Location calldata data) external {
        ...
        // Prevent gas from outrageous and the strings being too long to fit the SVG
    ...
    /**
     * Moves the calling player's position to any location marked as a respawn point.
     */
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        traits[1] = string(abi.encodePacked('{"trait_type":"South","value":"', (data.south > 0 ? _toString(data.south) : "n/a"), '"},'));
        traits[2] = string(abi.encodePacked('{"trait_type":"East","value":"', (data.east > 0 ? _toString(data.east) : "n/a"), '"},'));
        traits[3] = string(abi.encodePacked('{"trait_type":"West","value":"', (data.west > 0 ? _toString(data.west) : "n/a"), '"}'));
