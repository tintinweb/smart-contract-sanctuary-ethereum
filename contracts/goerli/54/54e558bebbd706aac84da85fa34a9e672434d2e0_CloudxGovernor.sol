...
contract CloudxGovernor is Governor, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    ...
    function castVote(uint256 proposalId, uint8 support) public virtual override(Governor) returns (uint256) {
