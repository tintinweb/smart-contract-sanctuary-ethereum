...
contract ADTradeDividendDispatcher is Swapable {
    ...
    function _dividendToDead(uint256 amount) internal virtual {
        require(amount>0,"ADTradeDividendDispatcher _dividendToDead amount must > 0");
    ...
    function _dividendToFund(uint256 amount) internal virtual {
        ...
        require(amount>0,"ADTradeDividendDispatcher _dividendToFund amount must > 0");
    ...
    function _dividendToHolding(uint256 amount) internal virtual {
        ...
        require(amount>0,"ADTradeDividendDispatcher _dividendToHolding amount must > 0");

        TOKEN.safeTransfer(holdingRewardAddress, amount);
    ...
    function _dividendToHoldingForBuy(uint256 amount) internal virtual {
        ...
        require(amount>0,"ADTradeDividendDispatcher _dividendToHoldingForBuy token amount must > 0");
        ...
        require(swapETHBalance>0,"ADTradeDividendDispatcher _dividendToHoldingForBuy eth amount must > 0");
