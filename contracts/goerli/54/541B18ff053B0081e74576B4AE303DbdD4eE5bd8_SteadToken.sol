...
contract SteadToken is ERC20, Arkpad {
    address public marketPlace = address(0x0);
    ...
    constructor() ERC20("Stead Token", "STEAD") {
        _mint(msg.sender, 0);
    }
    ...
    /**
     * @dev initialises the Stead Token by connecting it to the Marketplace
     * @param _market address of the Marketplace
     */
    function init(address _market) external byArkpadOnly {
        require(_init == false, "104");
        marketPlace = _market;
    ...
    /**
     * @dev mints token supply based on a created seastead sale
     * @param amount the amount to mint
     * @return bool success or not
     */
    function generateSupply(uint48 amount) external returns (bool) {
        require(_init == true, "104");

        bool isActive = Market.activeSales(msg.sender);
        require(isActive == false, "401");
    ...
    /**
     * @dev reduces the token supply - deflation
     * @return bool success or not
     */
