...
contract Reaperz is ERC2981, ERC721A, Ownable {
    using Strings for uint256;

    // 总量
    uint32 public constant MAX_SUPPLY = 888;
    // 免费总量
    uint32 public FREE_SUPPLY = 333;
    ...
    string public _prerevealURI = "ipfs://Qmdsa6hdCbiuAsniZxzKtb64WCAchtAWoA5c1d8jY9SdKE";
    string public _matadataURI;

    constructor() ERC721A("Reaperz", "RZ") {
        // 版税
