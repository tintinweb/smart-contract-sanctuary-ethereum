...
contract BestBudsBurn is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool artistSuccess, ) = payable(0xCB063dcfB08661993e4105880aDaF7935396f76D).call{value: artistPayment}('');
