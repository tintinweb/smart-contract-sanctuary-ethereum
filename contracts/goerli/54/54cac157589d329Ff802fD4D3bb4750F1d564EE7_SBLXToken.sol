...
/**
 * Premilary implementaion of the SocialBlox ERC20 root contract.
 * TODO:
 * - support Polygon bridge to transfer tokens between layer-1 and 2
 * - mint support?
 * - voting support?
 * - determine MAX_SUPPLY (volgens mij al bepaald in oud contract??)
 * - ??
 */
contract SBLXToken is
    ERC20,
    ERC20Pausable,
    ERC20Capped,
    ERC20Snapshot,
    ...
    ERC2771Context
{
    /// This role is assigned to accounts that can temporarily suspend token
    /// actions.
