...
contract MyContract {
    ...
    // TetherToken usdtToken = TetherToken(address(0xd9145CCE52D386f254917e481eB44e9943F39138));
    ...
    function approveToken(uint256 _amount) external returns (uint256) {
    ...
    function deposittoken(uint256 _amount) external returns (uint256) {
        ...
        require(usdtToken.balanceOf(msg.sender) > _amount, "Your token is insufficient");
        require(usdtToken.allowance(msg.sender, address(this)) >= _amount, "rerrrr");
    ...
    function getSmartContractBalance() external view returns(uint) {
     ...
     // NOTE: You can check how many tokens have your smart contract balance   
    function getSmartContractBalanceOfAddress(address _buyer) external view returns(uint) {
        return usdtToken.balanceOf(address(_buyer));
    }
