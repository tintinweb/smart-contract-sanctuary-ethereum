...
contract TEST3NAME is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public maxTxAmount = initialTotalSupply.mul(300).div(denominator); // 2% of the supply
    uint256 public maxWalletAmount = initialTotalSupply.mul(300).div(denominator); // 2% of the supply
    ...
    //constructor(string memory name, string memory symbol) ERC20(name, symbol) {
		constructor() ERC20("TEST3NAME", "T3EST") {
        devWallet = owner();
    ...
    function _transfer(
        ...
        if (!tradingEnabled) {
            //require(from != address(uniswapV2Router), "Token: trading isn't enabled yet");
