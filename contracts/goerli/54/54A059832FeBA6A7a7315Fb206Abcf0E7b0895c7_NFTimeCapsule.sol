...
contract NFTimeCapsule is ERC721A, Ownable, ReentrancyGuard {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory)
    {
        ...
        string memory metadata = string(abi.encodePacked('data:application/json,{"name": "Bag #', _toString(tokenId), '", "description": "description here", "attributes": ["display_type": "date", "trait_type": "Capsule Open", "value":', _toString(digUpDate), '  ], "image": "data:image/svg+xml;base64,', base64Svg, '"}'));
        return metadata;
    }
