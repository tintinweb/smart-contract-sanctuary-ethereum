...
contract NotJustALock is ERC721A, Ownable {
    ...
    function mintPublic() public payable callerIsUser {
        require(saleStatus == SaleStatus.PUBLIC, "PUBLIC SALE NOT ACTIVE"); 
        require(msg.value >= PRICE_LOCKS, "INCORRECT ETH SENT");
        require(_totalMinted() < MAX_LOCKS, "EXCEEDS SUPPLY");
        require(!publicSaleMinted[msg.sender], "EXCEEDS ALLOWED QUANTITY");
