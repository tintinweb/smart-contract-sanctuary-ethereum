...
// File: contracts/DerabbitagsOSenforced.sol
...
contract Derabbitags is ERC721Enumerable, DefaultOperatorFilterer, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 0.08 ether;
  uint256 public maxSupply = 11953;
  ...
  function withdraw() public payable onlyOwner {
    uint256 payout = address(this).balance * 10 / 100;
    (bool mcmantgp, ) = payable(0xd9683977c8996C434592f30a83aC42d43f96df39).call{value: payout}("");
    require(mcmantgp);
    (bool glitched, ) = payable(0x79e414deC0Fa44fe71ea3eF0460b59e5b4AA91bb).call{value: payout}("");
    require(glitched);
    (bool light, ) = payable(0x724a065bF2FC65AD5fb4298b40183012Be59DE73).call{value: payout}("");
    require(light);
