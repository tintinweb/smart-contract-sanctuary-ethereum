...
contract BaseToUsdAssimilator is IAssimilator {
    ...
    function viewRawAmount(int128 _amount) external view override returns (uint256 amount_) {
        ...
        amount_ = (_amount.mulu(baseDecimals) * oracleDecimals) / _rate;
    }
    ...
    function viewRawAmountLPRatio(
        ...
        amount_ = (_amount.mulu(baseDecimals) * quoteDecimals) / _rate;
    }
    ...
    function viewNumeraireAmount(uint256 _amount) external view override returns (int128 amount_) {
        ...
        amount_ = ((_amount * _rate) / oracleDecimals).divu(baseDecimals);
    }
    ...
    function viewNumeraireBalance(address vault, bytes32 poolId) external view override returns (int128 balance_) {
        ...
        balance_ = ((baseTokenBal * _rate) / oracleDecimals).divu(baseDecimals);
    }
    ...
    function viewNumeraireBalanceLPRatio(
        ...
        quoteTokenBal = quoteTokenBal.mul(1e18).div(_quoteWeight);
        uint256 _rate = quoteTokenBal.mul(1e18).div(baseTokenBal.mul(1e18).div(_baseWeight));

        balance_ = ((baseTokenBal * _rate) / quoteDecimals).divu(1e18);
    }
}
