...
// File: contracts/testburnandredeemcontract3.sol
...
contract ToBeRedeemedREAL3 is ERC721A, Ownable, ReentrancyGuard {
    IERC1155 public accessKeysCollection3;
  ...
  constructor(
      address _accessKeysCollection3
          ...
          accessKeysCollection3 = IERC1155(_accessKeysCollection3);
          }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(totalSupply() + amount < maxSupply + 1,"Reached max supply");
    require(mintEnabled, "Minting is not live yet, hold on...");
    require( amount < maxPerTx + 1, "Max per TX reached.");
    require(
      accessKeysCollection3.balanceOf(msg.sender, 1) >= amount
      );
