...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"ROLES", unicode"TOPS", unicode"EYES", unicode"BASE", unicode"BG"];
    ...
    ContractData public contractData = ContractData(unicode"OnChain Creeds", unicode"5555 Generative Art Living OnChain", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/eea26906-2801-43bc-9fac-332b73daee36", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/eea26906-2801-43bc-9fac-332b73daee36", "https://twitter.com/0xtinkaeth", 400, "0x9c4f52cf0f6537031d64B0C8BA7ea1729f0d1087");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"OnChain Creeds", unicode"OC") {
        tiers[0] = [97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,97,123];
        tiers[1] = [11,38,51,79,89,135,164,191,230,296,296,396,408,674,675,709,1113];
        tiers[2] = [135,173,373,687,2030,2157];
        tiers[3] = [33,47,48,55,55,58,91,142,174,213,249,250,251,263,331,435,441,550,555,1314];
        tiers[4] = [77,878,918,1520,2162];
