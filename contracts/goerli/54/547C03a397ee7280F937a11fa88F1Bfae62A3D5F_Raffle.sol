...
contract Raffle is  VRFConsumerBaseV2, AutomationCompatible{
    ...
    constructor(uint256 interval,uint256 entranceFee,address vrfcordinatorv2,bytes32 gas_lane,uint64 subscriptionId,uint16 callBackGasLimit)
   ...
   function getPlayer(uint256 pIndex)public view returns(address){
      return s_players[pIndex];
