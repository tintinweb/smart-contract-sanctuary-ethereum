...
import "../SYLToken/UsingSYLToken.sol";
...
contract SYLVestingWallet is Ownable {
    ...
    constructor(
        ...
        require(beneficiaryAddress != address(0), "Beneficiary cannot be null");
    ...
    function vestedAmount(uint64 timestamp) public view virtual returns (uint256) {
        console.log(_erc20.balanceOf(address(this)));
...
abstract contract UsingSYLToken {
    IERC20 private _erc20;
    ...
    function _setErc20(address erc20Address) internal {
        _erc20 = IERC20(erc20Address);
    }
}