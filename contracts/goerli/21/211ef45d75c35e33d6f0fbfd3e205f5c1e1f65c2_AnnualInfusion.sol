...
// File: contracts/AnnualInfusion.sol
...
/**
 * @title Annual Infusion
 * @notice This contract handles minting Annual Infusion 1/1 tokens.
 */
contract AnnualInfusion is
    ERC721A,
    ERC721AQueryable,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0x5a2880870f5bFCDD082a62D611E6aa5241dA70F9;
    ...
    function reduceMaxSupply(uint256 _newMaxSupply) external onlyOwner {
        require(_newMaxSupply < maxSupply, "NEW_MAX_SUPPLY_TOO_HIGH");
        require(
     ...
     * @param _mintNumber Array of number of tokens to send to each address
     */
