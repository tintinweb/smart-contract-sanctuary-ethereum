...
contract AlphaGang is ERC1155, Ownable, ReentrancyGuard {
    ...
    string public baseURI =
        "ipfs://QmNUNPskQ1tw4FncGn9rPz6HF3hUnatCwkGa1Pca6y94Q5/";
    ...
    function mintPresale(bytes32[] calldata _merkleProof)
        external
        nonReentrant
    {
        PresaleConfig memory _config = presaleConfig;
        require(!_config.salePaused, "Presale is paused!");
        // require(
    ...
    function mintPublic() external payable nonReentrant {
        // require(
    ...
    function configurePresale(uint32 _startTime, uint32 _endTime)
        external
        onlyOwner
    {
    ...
    function togglePresale() external onlyOwner {
        presaleConfig.salePaused = !presaleConfig.salePaused;
    }
