...
contract Water is ERC20, Ownable {
    ...
    function getAddresses() public view returns (string[] memory, address[] memory) {
        string[] memory names = new string[](3);
        address[] memory addresses = new address[](3);

        names[0] = "Dev Wallet";
        addresses[0] = _devWallet;

        names[1] = "Partnership Token Address";
        addresses[1] = _partnershipTokenAddress;

        names[2] = "Dead Wallet";
        addresses[2] = deadWallet;
    ...
    function getTaxBalances() public view returns (string[] memory, uint256[] memory) {
        string[] memory names = new string[](4);
        uint256[] memory amounts = new uint256[](4);
    
        names[0] = "Dev Fee Balance";
        amounts[0] = devFeeBalance;
    
        names[1] = "Partnerships Balance";
        amounts[1] = partnershipsBalance;

        names[2] = "Auto Burn Balance";
        amounts[2] = autoBurnBalance;
    
        names[3] = "Maintenance Balance";
        amounts[3] = maintenanceBalance;
