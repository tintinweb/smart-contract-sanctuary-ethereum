...
library RenderTime {
    ...
    string constant svg0 = '<?xml version="1.0" standalone="no"?><svg xmlns="http://www.w3.org/2000/svg" width="800" height="800" style="background-color:black">';
    string constant svg1 = '<g transform=';
    string constant svg2 = '<g transform=';
    string constant svg3 = '<g transform=';
    string constant svg4 = '<circle cx="400" cy="400" r="1.5" stroke="white" stroke-width="1" fill="white" /><rect x="300" y="300" width="200" height="200" stroke="#F2F2F2" stroke-width="0.5" fill="none" rx="5" ry="5"/></svg>';

    function getMetadata(uint tokenId, uint value) internal pure returns (string memory) {
        string memory json;
        ...
        json = string(abi.encodePacked(
            ...
            '} ,{"trait_type": "Age", "max_value": 273, "value": ',
    ...
    function renderSvg(uint age) internal pure returns (string memory) {
        uint angleSec = (age % 60) * 6;
        uint angleMin = ((age / 60) % 60) * 6;
        uint angleHr = ((age / 600) % 60) * 1;
        ...
        string memory second = string(abi.encodePacked(
            ...
            ',400,400)">',
            '<line x1="400" y1="400" x2="400" y2="330" stroke="#F4F4F4" stroke-width="0.4" /></g>' 
        ));
        string memory minute = string(abi.encodePacked(
            ...
            ',400,400)">',
            '<line x1="400" y1="400" x2="400" y2="350" stroke="#D3D3D3" stroke-width="1.2" /></g>'
        ));
        string memory hour = string(abi.encodePacked(
            ...
            ',400,400)">'
            '<line x1="400" y1="400" x2="400" y2="370" stroke="#EAEAEA" stroke-width="2.2" /></g>'
        ));
...
contract Test is ERC721Simple, MetaDataGenerate {
    ...
    function svgCheck(uint age) external pure returns (string memory) {
        return RenderTime.renderSvg(age);
    }
        ...
        returns (string memory) 
    {
        ...
        return RenderTime.getMetadata(tokenId, value);
    }
}
