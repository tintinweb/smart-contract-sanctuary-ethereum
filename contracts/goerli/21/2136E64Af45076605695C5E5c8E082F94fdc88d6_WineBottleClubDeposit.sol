...
/// @title Wine Bottle Club, Deposit
/// @author Consultec, FZCO
contract WineBottleClubDeposit is ERC721, Ownable {
    ...
    constructor(string memory baseTokenURI)
        ERC721("WineBottleClubDeposit", "WBCDep")
    {
    ...
    function mint(address to, uint16 count) external payable {
        _mintMany(to, TOKEN_PRICE, count);
    }
