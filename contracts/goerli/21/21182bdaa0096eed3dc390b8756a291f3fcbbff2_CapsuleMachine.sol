...
contract CapsuleMachine is VRFConsumerBaseV2, Ownable {
    ...
    function buyCapsulePartition(uint256 _capId, uint32 requestAmt) public payable
    {
        ...
        // update 
        for (uint256 i = c.soldPartition; i < c.soldPartition + requestAmt; i++) {
            c.buyers[i] = msg.sender;
        }
