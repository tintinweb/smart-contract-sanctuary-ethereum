    ...
    ReentrancyGuard
{
    ...
    uint256 public constant INVESTOR_MIN_CAP = 0.01 ether;
    uint256 public constant INVESTOR_MAX_CAP = 10.0 ether;

    uint256 public constant PRE_ICO_LIMIT = 15 * 1000 * 1000 ether;
    uint256 public constant PRE_ICO_AND_ICO_LIMIT = 50 * 1000 * 1000 ether;
    ...
    {
        assert(PRE_ICO_LIMIT < PRE_ICO_AND_ICO_LIMIT);
        assert(INVESTOR_MIN_CAP < INVESTOR_MAX_CAP);
        ...
        public payable validAddress(beneficiary) whenNotPaused nonReentrant
    {
        ...
        if (currentStage == Stage.PreICO) {
            ...
            assert(totalTokensPurchased < PRE_ICO_AND_ICO_LIMIT);
        }
        ...
        require(newPayment >= INVESTOR_MIN_CAP,
            "ExenoTokenIco: investment is below min cap");

        require(newPayment <= INVESTOR_MAX_CAP,
        ...
        && totalTokensPurchased >= PRE_ICO_AND_ICO_LIMIT) {
