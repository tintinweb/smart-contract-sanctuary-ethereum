    ...
    EIP2981RoyaltyOverrideCore
{
    ...
    constructor() ERC1155("") {
        // default royalty set
        _setDefaultRoyalty(
            IEIP2981RoyaltyOverride.TokenRoyalty({bps: 1000, recipient: 0x6A1Ebf8f64aA793b4113E9D76864ea2264A5d482})
        );
        _grantRole(ADMIN, msg.sender);
        _grantRole(MINTER, msg.sender);
        _grantRole(BURNER, msg.sender);
        //_mint(0x6A1Ebf8f64aA793b4113E9D76864ea2264A5d482, 100_000, 1, "");
