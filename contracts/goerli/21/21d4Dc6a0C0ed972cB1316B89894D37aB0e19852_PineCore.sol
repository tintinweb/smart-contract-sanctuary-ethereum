...
contract ChainlinkUpkeeper is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");
...
contract OrderStorage is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");
    bytes32 public constant ORDER_CREATOR_ROLE = keccak256("ORDER_CREATOR_ROLE");
...
contract LimitOrders is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");
...
contract UniswapV2Handler is IHandler {
    ...
    // bytes32 _codeHash
    {
        FACTORY = 0x0Ce853Bcb17179Ef56eAC6a4D78AF71eAc13278F; //_factory;
        WETH = IWETH(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6); // goerli //_weth;
        // WETH = IWETH(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd); // bsc test //_weth;
        FACTORY_CODE_HASH = hex"42cf62e1532656d6022c54c7da0c6c0da57e5e588a5bbadc2d69498ecfaecccd"; //_codeHash; ARYZE_Pair
    }
...
contract UniswapV1Handler is IHandler, Order {
    ...
    function _tokenToEth(
        ...
        if (prevAllowance < _amount) {
            ...
            _token.approve(address(uniswap), type(uint256).max);
        }
...
abstract contract IUniswapExchange {
    ...
    function ethToTokenTransferInput(
        ...
        uint256 deadline,
        address recipient
    ) external payable virtual returns (uint256 tokens_bought);
    ...
    function ethToTokenTransferOutput(
        ...
        uint256 deadline,
        address recipient
    ) external payable virtual returns (uint256 eth_sold);
...
abstract contract IUniswapFactory {
    ...
    function getExchange(address token) external view virtual returns (IUniswapExchange exchange);

    function getToken(address exchange) external view virtual returns (IERC20 token);
