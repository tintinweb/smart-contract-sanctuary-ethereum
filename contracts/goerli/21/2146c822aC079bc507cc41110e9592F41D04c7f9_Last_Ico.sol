...
contract Last_Ico is ReentrancyGuard  {
    ...
    function buyTokens(address beneficiary, uint256 amount) public nonReentrant {
        ...
        require(_totalDistribution.add(tokens) <= _presaleSupply, "Crowdsale: token distribution completed");
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(weiAmount <= _maxContribution, "Crowdsale: amount exceeds maximum purchase limit");
