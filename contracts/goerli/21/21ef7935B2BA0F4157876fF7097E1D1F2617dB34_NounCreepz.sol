...
contract NounCreepz is ERC721DelayedReveal {
        ...
        override
    {
        ...
        address[] memory eggBalanceAddresses = new address[](2);
        ...
        uint256[] memory eggBalanceIds = new uint256[](2);
        ...
        returns (uint256)
    {
        ...
        uint256[] memory eggBurnQuantities = new uint256[](2);
