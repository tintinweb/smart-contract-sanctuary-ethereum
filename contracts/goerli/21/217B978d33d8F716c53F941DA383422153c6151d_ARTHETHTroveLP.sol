...
contract ARTHETHTroveLP is StakingRewardsChild, MerkleWhitelist {
    ...
    function withdraw(
        ...
        revert("Seems that decrease liquidity is working");
        ...
        revert("Seems that swap is also working is working");
        ...
        revert("Seems adjust trove is also working");
        // 6. Flush, send back the amount received with dust.
        _flush(msg.sender, true, ethOutMin);
        revert("Seems flush swap is not working");
