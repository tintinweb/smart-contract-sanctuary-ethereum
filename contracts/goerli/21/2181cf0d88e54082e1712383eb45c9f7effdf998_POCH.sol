...
contract POCH is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Proof of Cheems";//
    string private constant _symbol = "POCH";//
    ...
    address payable private _developmentAddress = payable(0xFF352a09FF1fD2e5080b5C1C2c12B4767154B134);//
    address payable private _marketingAddress = payable(0xFF352a09FF1fD2e5080b5C1C2c12B4767154B134);//
