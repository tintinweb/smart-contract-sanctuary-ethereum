    ...
    ERC721RoyaltyUpgradeable
{
    ...
    function initialize() initializer public {
        __ERC721_init("ART DROP CONTRACT PLACEHOLDER", "TOKEN NAME PLACEHOLDER");
        ...
        isLive = false;
        maxSupply = 0;
        uriPrefix = "https://meta.tonic.xyz/project/";
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://meta.tonix.xyz/metadata-link";
    }
    ...
    modifier mintCompliant() {
        require(totalSupply() < maxSupply, "Purchase would exceed max tokens");
        _;
    }
    ...
    function getClaimIneligibilityReason() external view returns (string memory) {
        ...
        else if (totalSupply() + 1 > maxSupply) {
    ...
    function setLive(bool _isLive) public onlyOwner {
        isLive = _isLive;
    }
