...
struct StatusResposta {
 ...
 struct Documento {
    ...
    event NovoQuestionarioEvent(Cliente cliente, Auditor auditor, QuestionarioType questionario,
    ...
    function addQuestionario(
        ...
        emit NovoQuestionarioEvent(cliente_, auditor_, questionario_, fazenda_, anotacao_campo_);    
    }   
