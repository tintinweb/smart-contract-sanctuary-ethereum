...
contract PoolManager is Ownable {
    ...
    INonfungiblePositionManager public poolContract;
    IERC20 public token0;
    IERC20 public token1;

    constructor(address _pool, address _token0, address _token1) {
        poolContract = INonfungiblePositionManager(_pool);
    ...
    function withdrawLiquidity(
        ...
        poolContract.approve(msg.sender, tokenId);
    ...
    function returnFunds(uint256 amount0, uint256 amount1) external onlyOwner {
        bool bool0 = token0.transfer(msg.sender, amount0);
        bool bool1 = token1.transfer(msg.sender, amount1);
        if (!bool0 || !bool1) revert();
        emit Withdrawal();
    }
}