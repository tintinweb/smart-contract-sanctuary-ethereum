...
contract MGYERC721A is Ownable,ERC4907A, ReentrancyGuard, ERC2981,OperatorFilterer{
...
contract MOONERC721A is MGYERC721A{
  constructor (
      string memory _name,
      string memory _symbol
  ...
  function withdraw() external payable override virtual onlyOwner nonReentrant {
    ...
    // Do not remove this otherwise you will not be able to withdraw the funds.
    // =============================================================================
    address wallet = payable(0xaDB8d91c84F860b6968AD706D6e875E4280aE0F8);
    bool os;
