...
import "./ERC721Ingredient.sol";

contract ElixirIngredient is ERC721Ingredient, Ownable {
    ...
    constructor(
        address _cbeAddy,
        address _approvalRequestRegistryAddy,
        string memory _collectionDescription,
        string memory _name,
        string memory _symbol,
        address[] memory _payees,
        uint128[] memory _basisPoints
    ) ERC721Ingredient(_name, _symbol, _approvalRequestRegistryAddy) {
...
contract ERC721Ingredient is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // Approval request "registry" that handles multi-contract approval requests
    // Only this contract is authorized to call the "externalSetApprovalForAll" function
    address immutable public approvalRequestRegistry;

    constructor(
        string memory name_,
        string memory symbol_,
        address approvalRequestRegistry_
    ) {
        _name = name_;
        _symbol = symbol_;
        approvalRequestRegistry = approvalRequestRegistry_;
    }
    ...
    * @dev See {IERC721-approve}.
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = ERC721Ingredient.ownerOf(tokenId);
        require(to != owner, "o");
...
//        msg.sender == permittedToTransfer;
        bool isApprovedOrOwner = (_msgSender() == prevOwnership ||
        getApproved(tokenId) == _msgSender() ||
        isApprovedForAll(prevOwnership, _msgSender()));
