...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Item", unicode"Stuff", unicode"Nose", unicode"Eyes", unicode"Skull", unicode"Phantom body", unicode"Background feature", unicode"base"];
    ...
    ContractData public contractData = ContractData(unicode"Pixel Phantoms", unicode"Pixel Phantoms - designed by Hazey", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/d6d9487e-ebc6-40de-834f-e01c67e1b79f", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/d6d9487e-ebc6-40de-834f-e01c67e1b79f", "https://hazeynft.com/", 700, "0x38a03B0046CC20A21eC6d96507741317D418EDE0");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Pixel Phantoms", unicode"PHTMS") {
        tiers[0] = [2,8,16,25,28,29,38,38,49,51,56,93,123,164,171,246];
        tiers[1] = [16,20,25,46,77,78,123,201,250,301];
        tiers[2] = [5,250,402,480];
        tiers[3] = [7,8,11,22,29,33,37,42,51,59,64,90,123,123,130,133,175];
        tiers[4] = [10,14,17,26,37,81,85,93,100,168,506];
        tiers[5] = [5,10,18,18,41,42,44,85,86,93,133,262,300];
        tiers[6] = [7,15,15,50,100,100,150,700];
        tiers[7] = [19,86,91,115,134,146,163,383];
