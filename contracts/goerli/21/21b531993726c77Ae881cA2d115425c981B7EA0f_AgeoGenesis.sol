...
contract AgeoGenesis is ERC721A, IERC4906, ERC721AQueryable, AccessControl, ERC721ABurnable, ERC2981, Ownable, Pausable, DefaultOperatorFilterer {
    string private baseURI = "https://arweave.net/OtAeSn4HAmQ3oE8mO7FxqU2-aNzFxq8PzE0PGhPMT_g/";
    ...
    constructor(bool mintERC2309Flg, bool _callerIsUserFlg) ERC721A("AgeoGenesis", "AGEO") {
        ...
        if (mintERC2309Flg == true) {
            _mintERC2309(ADMIN_ADDRESS, 100);
