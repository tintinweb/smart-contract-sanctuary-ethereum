...
// ================== Mint Functions Start =======================
    ...
    for (uint256 i = 1; i <= _mintAmount; i++) {
      ...
      _safeMint(msg.sender, supply & reservedTokensMinted + i);
    }
  }
// Set Functions Start
// uri
...
//  WL users in array
    function wlAdreeses(address[] calldata users) public onlyOwner{
        for (uint i = 0; i < users.length; i++){userAddr[users[i]] = true;}
    }
// WL check
