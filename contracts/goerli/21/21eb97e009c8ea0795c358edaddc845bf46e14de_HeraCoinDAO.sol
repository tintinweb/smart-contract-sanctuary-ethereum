...
contract HeraCoinDAO is ERC20, Ownable {
    ...
    constructor (ISwapRouter _swapRouter) ERC20("Hera Coin DAO", "HERADAO", 8, 1000000000000 * 10 ** 8){
        address msgSender = _msgSender();
    ...
    function _swapTokensForUsdt(uint256 amountIn, address to) private returns (uint256 amountOut) {
        ...
        // token, from, to, value
        TransferHelper.safeTransferFrom(tokenIn, address(this), address(swapRouter), amountIn);
