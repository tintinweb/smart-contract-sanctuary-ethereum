...
abstract contract IncentivizedERC20 is Initializable, IERC20MetadataUpgradeable, ERC20Upgradeable {
  ...
  /**
   * @return Abstract function implemented by the child ULToken/UDToken.
   * Done this way in order to not break compatibility with previous versions of ULTokens/UDTokens
   **/
 ...
 * @author Ubiloan
 */
contract ULToken is Initializable, IULToken, IncentivizedERC20 {
  ...
  function initialize(
    ...
    __IncentivizedERC20_init(ULTokenName, ULTokenSymbol, ULTokenDecimals);
  ...
  /**
   * @dev calculates the total supply of the specific ULToken
  ...
  /**
   * @dev Returns the address of the Ubiloan treasury, receiving the fees on this ULToken
   **/
  ...
  /**
   * @dev Returns the address of the lending pool where this ULToken is used
   **/
   ...
   * @dev Transfers the underlying asset to `target`. Used by the LendPool to transfer
   * assets in borrow(), withdraw() and flashLoan()
   * @param target The recipient of the ULTokens
   * @param amount The amount getting transferred
   * @return The amount transferred
   **/
  ...
  /**
   * @dev Transfers the ULTokens between two users. Validates the transfer
