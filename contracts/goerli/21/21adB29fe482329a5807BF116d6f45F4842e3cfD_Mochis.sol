...
// File: contracts/mochis.sol

pragma solidity ^0.8.0;

// Storage for a mochis token
contract mochis {
...
// File: contracts/IMOCHIS.sol

pragma solidity ^0.8.0;

abstract contract IMOCHIS {
    /**
...
contract Mochis is ERC20PresetMinterRebaser, Ownable, IMOCHIS {
    using SafeMath for uint256;
    ...
    uint256 private INIT_SUPPLY = 6666666666666 * 10**18;
    uint256 private _totalSupply;
    ...
    constructor() ERC20PresetMinterRebaser("mochis", "mochis") {
    ...
    function permit(
        ...
        require(block.timestamp <= deadline, "mochis/permit-expired");
        ...
        require(owner != address(0), "mochis/invalid-address-0");
        require(owner == ecrecover(digest, v, r, s), "mochis/invalid-permit");
    ...
    function eggsToFragment(uint256 mochis) public view returns (uint256) {
        return _eggsToFragment(mochis);
    }
    ...
    function _eggsToFragment(uint256 mochis) internal view returns (uint256) {
        return mochis.mul(eggssScalingFactor).div(internalDecimals);
    }
