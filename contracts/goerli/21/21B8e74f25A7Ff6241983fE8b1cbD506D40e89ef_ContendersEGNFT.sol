    ...
    OperatorFiltererUpgradeable
{
    ...
    function isValidWhite(bytes32[] memory _proof, bytes32 _leaf)
        public
        view
        returns (bool)
    {
        return MerkleProofUpgradeable.verify(_proof, rootWhite, _leaf);
    }

     function isValidSuper(bytes32[] memory _proof, bytes32 _leaf)
        public
        view
        returns (bool)
    {
        return MerkleProofUpgradeable.verify(_proof, rootSuper, _leaf);
    }
    ...
    function mintPublic(uint256 _numberOfNFTs, bytes32 _leaf, bytes32[] memory _proof) public payable nonReentrant {
        address _buyer = msg.sender;
        require(!isStopped, "Mint Stopped");
        require(!isValidWhite(_proof, _leaf), "Not whitelisted");
        require(
    ...
    function mintSuper(bytes32 _leaf, bytes32[] memory _proof) public payable nonReentrant {
        require(!isStopped, "Mint Stopped");
        require(!isValidSuper(_proof, _leaf), "Not super-whitelisted");
