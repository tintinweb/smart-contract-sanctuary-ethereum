...
uint256 _maxSupply = 8900;
uint256 maxMintAmountPerWallet = 4;
string baseURL = "";
...
constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("fdgdgd", "LX") {
