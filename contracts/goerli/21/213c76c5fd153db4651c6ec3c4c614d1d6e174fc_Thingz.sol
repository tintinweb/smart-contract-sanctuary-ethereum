...
contract Thingz is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Thingz", "THINGZ", maxBatchSize_, collectionSize_) {
  ...
  function mint(uint256 quantity) external payable callerIsUser {
    ...
    require(numberMinted(msg.sender) + quantity <= maxPerAddress, "max 5 per address");
