...
interface IPicklePeople {
    function mint(address _to, uint _count) external;
}
...
contract PickleSale is AccessControl {
    ...
    bytes32 public root;
    IPicklePeople public picklePeopleNFT = IPicklePeople(address(0));
...
// Mint 
    ...
    function mint(bytes32[] memory _proof, uint256 _quota, uint numberOfTokens) public {
        ...
        for (uint256 i = 0; i < numberOfTokens; ++i) {
            picklePeopleNFT.mint(_msgSender(), numberOfTokens);
        }
