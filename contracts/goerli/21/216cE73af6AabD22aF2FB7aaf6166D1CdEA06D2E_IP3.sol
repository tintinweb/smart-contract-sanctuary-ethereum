...
contract IP3 {
    ...
    function purchaseByAmount(
        ...
        // incrementByCount: for example 0.1 erc20 / count
        //TODO: could be NFT specific feature
        uint256 incrementByCount = 10**5;

        // compute the current termPrice by smart price engine
        // function computeAuthroizedPriceByCount(uint256 count, uint256 incrementByCount, uint256 currentStartPrice )
...
library SmartPriceEngine {
    ...
    function computeAuthroizedPriceByCount(
        ...
        uint256 authorizedPrice = currentStartPrice + count * incrementByCount / TIME_INTERVAL;
