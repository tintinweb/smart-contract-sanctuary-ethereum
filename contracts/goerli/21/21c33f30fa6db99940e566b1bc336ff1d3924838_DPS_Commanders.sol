...
// File contracts/DPS_Commanders_Mint/DPS_Commanders.sol
...
contract DPS_Commanders is Initializable, ERC721RoyaltyUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;

    OpenSeaProxyRegistry private proxyRegistry;
    ...
    function initialize(address _proxyRegistryAddress, address _owner, string calldata __baseURI, string calldata __contractURI) initializer public {
        __ERC721_init("DEEPSPACE Commanders", "DPS-Commanders");
        ...
        proxyRegistry = OpenSeaProxyRegistry(_proxyRegistryAddress);
    ...
    // Mint initial amount for team, mods, givaways, etc.
    ...
    function setProxyState(address proxyAddress, bool _bool) public onlyOwner {
        projectProxy[proxyAddress] = _bool;
    }

    function isApprovedForAll(address owner, address operator) public view override returns (bool)
    {
        // Whitelist OpenSea proxy contract for easy trading.
        // Also allow for whitelisting project addresses to reduce gas fees
    ...
    function setRoyaltyNumerator(uint96 _royaltyFeeNumerator) external onlyOwner {
        _setDefaultRoyalty(owner(), _royaltyFeeNumerator);
    }
