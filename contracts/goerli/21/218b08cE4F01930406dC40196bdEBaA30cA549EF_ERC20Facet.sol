...
contract ERC20Facet is IERC20Metadata, IERC20Permit {
  uint256 internal immutable INITIAL_CHAIN_ID;
  bytes32 internal immutable INITIAL_DOMAIN_SEPARATOR;
  string internal constant ERC20_VERSION = "1.0.0";

  constructor() {
    INITIAL_CHAIN_ID = block.chainid;
    INITIAL_DOMAIN_SEPARATOR = LibERC20.computeDomainSeparator(ERC20_VERSION);
  }
  ...
  function balanceOf(address _owner) external view override returns (uint256) {
    return LibERC20.balanceOf(_owner);
  }

  function transfer(address _to, uint256 _value) external override returns (bool) {
    return LibERC20.transfer(_to, _value);
  }
  ...
  function approve(address _spender, uint256 _value) external override returns (bool) {
    return LibERC20.approve(msg.sender, _spender, _value);
  }
  ...
  function transferFrom(
    ...
    return LibERC20.transferFrom(_from, _to, _value);
  }

  function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    return LibERC20.increaseAllowance(msg.sender, spender, addedValue);
  }
  ...
  function decreaseAllowance(
    ...
    return LibERC20.decreaseAllowance(msg.sender, spender, subtractedValue);
  }
  ...
  function _domain_separator() internal view returns (bytes32) {
    return
      (INITIAL_CHAIN_ID == block.chainid)
        ...
        : LibERC20.computeDomainSeparator(ERC20_VERSION);
  }
  ...
  function permit(
    ...
    LibERC20.permit(owner, spender, value, deadline, v, r, s, _domain_separator());
  }

  function nonces(address owner) external view returns (uint256) {
    return LibERC20.nonces(owner);
  }
}
