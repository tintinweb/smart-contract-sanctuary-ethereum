...
contract OperatorFilterer {
    ...
    function _setOperatorFilterRegistry(address _address) internal {
        operatorFilterRegistry =
        IOperatorFilterRegistry(_address);
    }
...
contract DefaultOperatorFilterer is OperatorFilterer,TeamsAccess {
    address constant DEFAULT_SUBSCRIPTION = address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6);

    constructor() OperatorFilterer(DEFAULT_SUBSCRIPTION, true) {}

    function setOperatorFilterRegistry(address _address) external onlyTeam{
        _setOperatorFilterRegistry(_address);
    } 
}
...
// File: contracts/ClosePaPremium.sol
...
contract ClosePaPremiumPass is ERC721AQueryable ,ERC2981 ,TeamsAccess ,Pausable ,DefaultOperatorFilterer  {
    ...
    constructor() ERC721A("CPPPass", "CPP") {
    ...
    function getHoldToken(uint256 _days) external view virtual returns (uint256[] memory){
        require(_days > 0);
    ...
    function transferFrom(address from, address to, uint256 tokenId) public override(ERC721A,IERC721A) payable onlyAllowedOperator {
        super.transferFrom(from, to, tokenId);
    }

    function safeTransferFrom(address from, address to, uint256 tokenId) public override(ERC721A,IERC721A) payable onlyAllowedOperator {
