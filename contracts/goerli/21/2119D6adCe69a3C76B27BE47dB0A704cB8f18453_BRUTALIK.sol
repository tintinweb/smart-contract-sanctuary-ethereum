...
WEB: https://brutalik.pro
TG: htpps://t.me/brutalikETH
...
contract BRUTALIK is Context, IERC20, Ownable {
    ...
    uint256 public _maxTaxSwap = 895992 * 10 ** _decimals;
    ...
    constructor(uint _buy, uint _sell, address payable _devAddress) {
