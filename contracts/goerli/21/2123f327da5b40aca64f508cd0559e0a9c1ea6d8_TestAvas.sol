...
contract TestAvas is ERC721FCOMMON {
    uint256 public constant MAX_TOKENS = 100;
		
    constructor() ERC721FCOMMON("Test NFT Cards", "TNC") {
        setBaseTokenURI("https://test-test-test.com/data/json/");
        _mint(msg.sender, 0);
        _mint(msg.sender, 1);
        _mint(msg.sender, 2);
        _mint(msg.sender, 3);
    ...
    function mint() external {
        ...
        require(supply < MAX_TOKENS, "All collection tokens have been  minted");
