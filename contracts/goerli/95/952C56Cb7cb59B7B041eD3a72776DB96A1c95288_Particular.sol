...
contract Particular is Initializable {
    ...
    event ToSee(uint256 price, uint256 amountOutMin, uint256 amountToSave, uint256 amountToKindly);
    ...
    function initialize (address _admin, uint256 _percent, address _wallet) virtual public initializer {
        ...
        chainlink = IChainlink(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e);
    ...
    */
    receive() external payable {
        ...
        uint256 toKindly = rest * 2 / 100;
        uint256 toONGs = rest * 15 / 1000;
        ...
        // ADRESS OF USDC ON MUMBAI -> 0x0fa8781a83e46826621b3bc094ea2a0212e71b23
        path[1] = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F;
        ...
        uint256 amountToSave = (toSave * price);
        //TODO: 2 wallets -> 1 for kindly and 1 for ongs
        uint256 amountToKindly = amountOutMin - amountToSave;
        emit ToSee(price, amountOutMin, amountToSave, amountToKindly);
        uniswap.swapExactETHForTokens{value: toStable}(40, path, address(this), block.timestamp + 5 minutes);
        ...
        (bool success, ) = wallet.call{value: toWallet}("");
