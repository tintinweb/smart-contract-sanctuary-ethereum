...
contract UniblockERC20Presale is Initializable, AccessControl {
    ...
    bytes32 public constant IMPLEMENTATION_TYPE = keccak256("UNIBLOCK_ERC20_PRESALE");
    ...
    function withdraw(uint256 amount) public configured {
        ...
        if (claimableTokens[msg.sender] < amount) {
    ...
    function ownerWithdrawAll(address _tokenAddress) public onlyOwner {
        ...
        if (_tokenAddress == address(0)) {
            ...
            // Transfer the tokens to the payment receiver
            tokenContract.transfer(paymentReceiver, withdrawAmount);
            emit OwnerWithdraw(paymentReceiver, _tokenAddress, withdrawAmount);
        }
    }
