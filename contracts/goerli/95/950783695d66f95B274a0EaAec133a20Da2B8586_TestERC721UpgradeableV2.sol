...
import "./TestERC721UpgradeableV1.sol";
import "./DefaultOperatorFiltererUpgradeable.sol";

contract TestERC721UpgradeableV2 is TestERC721UpgradeableV1, DefaultOperatorFiltererUpgradeable {
    function initialize(
        string memory name_,
        string memory symbol_,
        string memory defaultURI_
    ) public override virtual initializer {
        super.initialize(name_, symbol_, defaultURI_);
...
contract TestERC721UpgradeableV1 is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function tokenURI(uint256 tokenId_) public view virtual override returns (string memory) {
        require(_exists(tokenId_), "TestERC721: URI query for nonexistent token");
        return _defaultURI;
    }

    function setDefaultURI(string memory defaultURI_) public virtual onlyOwner {
    ...
    function mintTokenBatch(address recipient_, uint256 tokenCount_) external virtual onlyOwner {
        require(recipient_ != address(0), "TestERC721: invalid address");
        require(tokenCount_ > 0 && tokenCount_ <= _BATCH_LIMIT, "TestERC721: invalid token count");
