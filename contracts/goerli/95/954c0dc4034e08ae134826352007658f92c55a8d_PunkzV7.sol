...
contract PunkzV7 is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint public MAX_SUPPLY = 2;

    constructor() ERC721("PunkzV6", "PNKZ") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeiblhvaooqflry3raqpoycuhv5zwt5lwhfm2nwo5cmwhdingdwgvf4/";
    }

    function safeMint(address to) public payable {
        require(totalSupply() < MAX_SUPPLY, "OOS bruh");
