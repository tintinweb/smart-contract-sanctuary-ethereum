...
// File: contracts/TestBunnyDoodle.sol
...
contract TestDoodleBunny is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Test Bunny Doodles", "TDB") {
    setHiddenMetadataUri("ipfs://QmVrRMDRXobPiePRWpPXVSEaPBWfXks3xeDdUDW5HDeBm2/hidden.json");
  }
