...
contract StabilityPool is LiquityBase, OwnableUpgradeable, IStabilityPool {
    ...
    */
    ...
    function setAddresses(
        ...
        CheckContract.isContract(_lpTokenAddress);
        ...
        CheckContract.isContract(_communityIssuanceAddress);
    ...
    */
    ...
    function _moveOffsetCollAndDebt(uint _collToAdd, uint _debtToOffset) internal {
        ...
        activePoolCached.sendLPToken(lpTokenAddress, address(this), _collToAdd);
    }
