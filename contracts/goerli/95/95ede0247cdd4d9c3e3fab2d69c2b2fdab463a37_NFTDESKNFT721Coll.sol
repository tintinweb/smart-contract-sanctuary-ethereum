...

{
    ...
    NFTDESKNFT721 public NFTDESKNFT721M;
    ...
    {   
        ...
        NFTDESKNFT721 _NFTDESKNFT721M = NFTDESKNFT721(originalContract);
        // set the rest of the contract variables
        NFTDESKNFT721M = _NFTDESKNFT721M;
    ...
    function getServiceFeeESC() public view returns (uint256) {
        return  NFTDESKNFT721M.getServiceFeeESC();
    }

    function getServiceFee() public view returns (uint256) {
        return  NFTDESKNFT721M.getServiceFee();
    }
    ...
    function newtokenasbid(
        ...
        uint256 serviceVal = NFTDESKNFT721M.getServiceFee();
        if(keccak256(bytes(tokenAss)) == keccak256(bytes("NIL")))
        {
             serviceVal = NFTDESKNFT721M.getServiceFeeESC();
        }

        address payable admin =  payable(NFTDESKNFT721M.getOwner());
