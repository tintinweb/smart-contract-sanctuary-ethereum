...
contract RSaleContract is Ownable, ReentrancyGuard {
    ...
    // set time
    uint64 public immutable whitelistStartTime = 1376431800;
    uint64 public immutable whitelistEndTime = 1976432400;
    uint64 public immutable publicStartTime = 1376433000;
    uint64 public immutable publicEndTime = 1976433600;
