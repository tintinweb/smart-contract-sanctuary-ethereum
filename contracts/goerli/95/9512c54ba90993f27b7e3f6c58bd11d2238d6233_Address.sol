...
contract RoomDevils is ERC721, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("RoomDevils", "RoomDevils") {}
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        uint256 w1 = balance.mul(5).div(100);
        uint256 w2 = balance.mul(10).div(100);
        uint256 w3 = balance.mul(15).div(100);
        payable(0xfb5D5d07cd909DfcAD822361Fcc24e8271542E6E).transfer(w1);
        payable(0x7286C485415c4D16F3CDa1bD0FCAA560483d2b8A).transfer(w2);
        payable(0x246FEc5f6a5487b354D5E014f31e1685b05275a2).transfer(w3);
