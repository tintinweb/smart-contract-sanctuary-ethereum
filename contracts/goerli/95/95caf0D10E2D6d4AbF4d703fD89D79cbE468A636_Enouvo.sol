...
contract Enouvo is ERC20("Enouvo", "ENV"), ERC20Burnable, Ownable {
    ...
    function getLatestNftFloorPrice() public view returns (int) {
        (
            ,
            /*uint80 roundID*/
            int nftFloorPrice, /*uint startedAt*/
            ,
            ,
    ...
    //         ,
    //         /*uint80 roundID*/
    //         int reserve, /*uint startedAt*/ /*uint timeStamp*/ /*uint80 answeredInRound*/
    //         ,
    //         ,
