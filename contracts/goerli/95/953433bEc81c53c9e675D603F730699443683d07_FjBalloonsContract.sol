...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x099d117B6354780e626E5f4DD17F00BA9Bb3Ca33,0x135D79D13E90b46b6F94e17e39d7966Debd63341];
  address public erc20Payable = 0x099d117B6354780e626E5f4DD17F00BA9Bb3Ca33;
  uint256[] public payableFees = [2,95,3];
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 0.077 ether;
  uint256 public earlyMintOwnershipCap = 5;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRC2YCBsAX9m8qWgHQPoUguEawBZ6s1p2JTaJj2R4d9sa/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/yyoKvqJewMiiTfGZWOln/contract-metadata";
  }
...
// File: contracts/FjBalloonsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FjBalloonsContract is ERC721APlus {
    constructor() ERC721APlus("FJBalloons", "FJB"){}
}