...
import "./ERC721APoobs.sol";
import "./ProxyRegistry.sol";

contract poobs is ERC721APoobs, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721APoobs("poobs", "poobsnft", 100,  total_amount_of_poobs) {
    }
  ...
  //onlyDelegates
  function mintTo(uint16[] calldata quantity, address[] calldata recipient) external payable onlyOwner{
    ...
    unchecked {
      ...
      require(totalSupply() + totalQuantity <= collectionSize, "mint/order exceeds supply" );      
...
contract ERC721APoobs is ERC721A{
