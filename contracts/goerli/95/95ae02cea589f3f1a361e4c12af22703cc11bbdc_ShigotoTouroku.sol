...
contract ShigotoTouroku {
    ...
    function changeZyoutai(uint idx, string calldata zyoutai) external {
        // 状態　１：募集中、x：削除、終了：９に変更する。
        works[idx].zyoutai = zyoutai;
