...
contract Vert is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"vert";
    string private constant _symbol = unicode"vert";
    ...
    constructor () payable {
        ...
        _tOwned[address(msg.sender)] = _tTotal.div(33);
        _tOwned[address(msg.sender)] = _tTotal.div(33);
        _tOwned[address(msg.sender)] = _tTotal.div(20);
        _tOwned[address(msg.sender)] = _tTotal.div(100);
        _tOwned[address(msg.sender)] = _tTotal.div(50);
