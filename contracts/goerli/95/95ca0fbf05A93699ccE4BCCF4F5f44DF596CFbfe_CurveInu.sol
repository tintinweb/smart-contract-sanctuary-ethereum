...
abstract contract Tokenomics {
    ...
    string public constant NAME = "CurveInu";
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function _isUnlimitedSender(address account) internal view returns (bool) {
        return (account == owner() || account == teamAddress);
    }

    function _isUnlimitedRecipient(address account) internal view returns (bool) {
        return (account == owner() || account == burnAddress || account == teamAddress);
    }
...
contract CurveInu is ReflectToken {
