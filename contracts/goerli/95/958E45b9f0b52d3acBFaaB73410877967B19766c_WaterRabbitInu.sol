...
contract WaterRabbitInu is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0x8A423c3143178Fd5F69a9e6F0f97998574bF4587);
    address public ManualBurnWallet =
        0xBa656f2dD3bcb795c2bd782356429Dad487Ef5f1;
    ...
    string private constant _name = "Water Rabbit Inu";
    string private constant _symbol = "WRI";
    uint8 private constant _decimals = 9;

    uint256 public _wTwtaxFee = 0;
    uint256 private _previousTaxFee = _wTwtaxFee;

    uint256 public _wTwMarketingFee = 2;
    ...
    uint256 public _maxWalletHoldingLimit = 100 * 10**6 * 10**9;
    ...
    function takeManualBurn(
        ...
        uint256 tManualBurn = tAmount.mul(_wTwManualBurnFee).div(feeDenominator);
