...
//♪	♫ ♩ ♬ ♭ ♮ ♯ 🎼
contract MetamorphicGG is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public ablumSaleStartTime = block.timestamp - 1; // TODO: set it
    ...
    /*///////////////////////////////////////////////////////////////
                         START Metamorphic
    //////////////////////////////////////////////////////////////*/
    constructor() ERC721A("Methamorphic", "MORPH") {
        _setDefaultRoyalty(0xE7a697036a3E9b229Fc70d837F0C95daeef8e3c4, 10000); //TODO: SET THIS!
    }

    function version2() internal {}
    ...
    function buyAlbum(bytes32[] calldata proof)
        ...
        notContract
    {
        require(block.timestamp >= ablumSaleStartTime, "not live");
    ...
    /**
	 ...
	 @param proof - merkle proof
	  */
    function buySong(bytes32[] calldata proof)
        external
        payable
        nonReentrant
        notContract
    {
        ...
        require(songPrice == msg.value, "exact amount needed");
        require(totalSupply() + 1 <= MAX_SUPPLY, "out of stock");
        require(isProofValid2(msg.sender, 1, proof), "invalid proof");

        nftContract.safeTransferFrom(artistWallet, _msgSender(), songCounter);
        songCounter += 1;
        _mint(msg.sender, 1);
    }

    /**
	@dev non whitelist phase
	  */
	...
	*/
    ...
    function setStartTimes(
        ...
        ablumSaleStartTime = newAlbumTime;
    ...
    function setNFTContract(address newContract) external onlyOwner {
        nftContract = IERC721(newContract);
    }
    ...
    function setPricePerToken(uint256 newAlbumPrice, uint256 newSongPrice)
        external
        onlyOwner
    {
