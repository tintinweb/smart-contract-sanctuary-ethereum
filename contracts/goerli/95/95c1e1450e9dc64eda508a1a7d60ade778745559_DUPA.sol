...
contract DUPA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DUPA", "DUPA") {
        ...
        marketingWallet = address(0x7f8796488C13Dc3b460010309231A2C18f5f87c3); // set as marketing wallet
    	maintenanceWallet = address(0x7f8796488C13Dc3b460010309231A2C18f5f87c3); // set as maintenance wallet
