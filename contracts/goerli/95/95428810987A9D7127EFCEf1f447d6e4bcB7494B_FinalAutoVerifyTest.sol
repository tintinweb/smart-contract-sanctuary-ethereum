...
contract FinalAutoVerifyTest is
    ERC721ABurnable,
    Ownable,
    Signature
{
    ...
    constructor(bool isPaying, uint256 deploymentPrice) ERC721A("Final Auto Verify Test", "favt") payable {
        if(isPaying){
...
contract Signature is Ownable {
    ...
    bytes32 private immutable NAME = keccak256("Final Auto Verify Test");
