...
// File: contracts/EuphoricUtopia1.sol
...
contract NFT is ERC721, Ownable {
    ...
    uint public constant MAX_TOKENS = 222;
    ...
    constructor() ERC721("Euphoric Utopia by Sora", "UTOPIA") {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xCdB6375E1962c1839545DB814827ef5033F87146).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xf0198D7D24e9713bf723308077c31Ca1Adc5Ae05).call{value: balanceTwo}("");
