...
contract SaneTest is IERC20, Auth {
    ...
    string private constant _name = "SaneTest";
    string private constant _symbol = "STD1";
    ...
    address public developmentWallet = payable(0x1eE18045c867e366978cB303c8994CeC9a4BC24f);
