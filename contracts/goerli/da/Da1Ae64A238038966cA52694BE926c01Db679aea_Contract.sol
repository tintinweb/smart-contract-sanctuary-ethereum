...
contract Contract is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(address _e1, address _f2, string memory _baseTokenURI) ERC721A("Contract", "Contract")  {
  ...
  function mint(uint256 _e1, uint256 _f2) public {
    require(
