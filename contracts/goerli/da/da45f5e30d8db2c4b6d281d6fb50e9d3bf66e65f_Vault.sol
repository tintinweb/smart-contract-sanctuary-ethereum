...
// File: contracts/tokenlistv2.sol
...
contract Vault is Ownable, Tokenlist {
    ...
    function depositTokens(uint256 _amount, address _tokenAddress) external isWhitelisted(_tokenAddress){
    ...
    function withdrawAll(address _tokenAddress) external {
        ERC20(_tokenAddress).transfer(msg.sender, Balances[msg.sender][_tokenAddress]);
