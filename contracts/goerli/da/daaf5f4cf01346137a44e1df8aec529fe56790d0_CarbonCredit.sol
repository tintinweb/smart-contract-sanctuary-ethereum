...
contract CarbonCredit {
    ...
    event CarbonCreditCreated(string indexed carbonCreditTokenId, string ownerAddress);
    event CarbonCreditRetired(string indexed carbonCreditTokenId);
    event CarbonCreditChanged(string indexed carbonCreditTokenId, string oldOwner, string newOwner);
