    ...
    EIP712
{
    ...
    string private _name = "Birds Aren't Real";
    ...
    address private immutable _UNISWAPV2_ROUTER_ADDR;
    ...
    constructor(address _stable_coin, address _layerZeroEndpoint, address _uniswap, address _daiContract)
        EIP712(_name, "1")
    {
        // layer zero
        ...
        _UNISWAPV2_ROUTER_ADDR = _uniswap;
        DAI = _daiContract;
    ...
    {
        if (status) {
            // avoid any test in prod moments
            for (uint256 i; i < addresses.length; ++i) {
                require(
                    addresses[i] != address(uniswapV2Router) &&
