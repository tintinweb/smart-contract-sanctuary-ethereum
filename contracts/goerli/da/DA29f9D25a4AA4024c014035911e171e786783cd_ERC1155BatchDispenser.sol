...
contract ERC1155BatchDispenser is
    ERC1155Holder
{
    ...
    function setTokenIds(uint256[] calldata _tokenIds) public onlyTeam {
        tokenIds = _tokenIds;
    }
    ...
    function setRecipient(address _recipient) public onlyTeam {
