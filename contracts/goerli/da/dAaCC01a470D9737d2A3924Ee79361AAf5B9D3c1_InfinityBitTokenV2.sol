...
contract InfinityBitTokenV2 is IERC20, Ownable {
    ...
    address payable private _marketingWallet = payable(0xb9B23Cc434596ABa6f83d5C6662DD3Cf4B1e099C);

    // Developer Tax
    uint8 private _devTax = 0; // 1.8%
    address payable private _devWallet = payable(0xe83842e599b9BC6951A265dC75c3745bA9B88201);
