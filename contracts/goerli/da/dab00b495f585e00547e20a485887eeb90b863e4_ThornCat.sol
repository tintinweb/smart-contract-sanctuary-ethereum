...
contract ThornCat is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://babydogev2.com/nft/";
    ...
    constructor(
    ) ERC721A("ThornCat", "ThornCat", 100, maxSupply) {
    }
