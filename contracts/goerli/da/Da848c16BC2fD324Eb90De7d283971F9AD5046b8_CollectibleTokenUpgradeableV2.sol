...
contract CollectibleTokenUpgradeableV2 is OwnableUpgradeable, AccessControlEnumerableUpgradeable, ERC721Upgradeable, IMintableERC721 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Upgradeable, AccessControlEnumerableUpgradeable, IERC165Upgradeable) returns (bool) {
    ...
    /** BEGIN: IMintableERC721 Implementation **/
    function mint(address user, uint256 tokenId) external virtual override {
        require(hasRole(MINTER_ROLE, msg.sender) || hasRole(PREDICATE_ROLE, msg.sender), "Must have role to mint");
          
        _safeMint(user, tokenId, "");
    }
    
    function mint(address user, uint256 tokenId, bytes calldata metaData) external virtual override {
        require(hasRole(MINTER_ROLE, msg.sender) || hasRole(PREDICATE_ROLE, msg.sender), "Must have role to mint");
    ...
    /** END: IMintableERC721 Implementation **/
