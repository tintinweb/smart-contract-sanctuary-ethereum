...
contract ApeMatcherHelper {
	...
	function getDashboardData() external view returns(uint256[3] memory depositCounts, uint256[3] memory balMatcher, uint256[3] memory balSmooth, uint256[4] memory apys) {
