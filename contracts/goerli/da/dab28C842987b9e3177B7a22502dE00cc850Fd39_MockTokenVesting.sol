...
contract MockTokenVesting is TokenVesting {
    uint256 mockTimestamp = 0;

    constructor(address _tokenContractAddress) TokenVesting(_tokenContractAddress) {}

    function setCurrentTimestamp(uint256 _timestamp) external {
        mockTimestamp = _timestamp;
    }

    function getCurrentTimestamp() internal view virtual override returns (uint256) {
