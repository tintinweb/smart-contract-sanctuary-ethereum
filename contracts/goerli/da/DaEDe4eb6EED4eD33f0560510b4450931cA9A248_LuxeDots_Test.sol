...
////////////////////////////////////////////////////////////////////////////////////////////
//  OperatorFilterRegistry  >>  Constants.sol
////////////////////////////////////////////////////////////////////////////////////////////
 ...
 * {ERC721Enumerable}.
 */
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, DefaultOperatorFilterer {
    ...
    /**
     * @dev Returns the total amount of tokens were burned.
     */
    function totalBurned() internal view virtual returns (uint) {
        return _burnCount;
    }
     ...
     *
     * Calling conditions: - When `from` and `to` are both non-zero, ``from``'s tokens will be transferred to `to`.
     ...
     * used, the hook may be called as part of a consecutive (batch) mint, as indicated by `batchSize` greater than 1.
     *
     * Calling conditions: - When `from` and `to` are both non-zero, ``from``'s tokens were transferred to `to`.
...
contract LuxeDots_Test is ERC721, Ownable {    
     ...
     */
    constructor() ERC721("LuxeDots_Test", "LXTT") {
        _paused = false;
    }
     ...
     * @dev setBaseURI.
     */
    function setBaseURI(string memory base_uri) public virtual onlyOwner {
        BASE_URI = base_uri;
    }
    ...
    function totalSupply() public view returns (uint) {
        return _tokenIdCounter.current() - totalBurned();
    }
    ...
    /**
     * @notice Mints specified quantity of tokens for the owner.
     */
    function internalMint(uint amount) external onlyOwner {
        safeMint(msg.sender, amount);
    }

    /**
     * @dev Allows owner to mint tokens to a specified address.
     */
    function airdrop(address to, uint amount) external onlyOwner {
        require(to != address(0) , "Transfer from incorrect address");
    ...
    function safeMint(address to, uint amount) internal {
        ...
        require(_tokenIdCounter.current() + amount <= collection_Size, "Request exceeds collection size");
