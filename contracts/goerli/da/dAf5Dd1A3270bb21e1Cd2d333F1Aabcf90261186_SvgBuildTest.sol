...
contract SvgBuildTest is ERC721A{

    constructor() ERC721A("kiloGANs", "KILO") {}
    ...
    string public collectionName = "kiloGANs by Pindar Van Arman";

    function mint(uint256 quantity, uint256 _tokenId, string memory _SVG ) external {
