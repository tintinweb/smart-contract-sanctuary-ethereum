...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0x0458298688916cdc99693B21f80aA05FC81D1538];
...
// File: contracts/BetterInfraBadgesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract BetterInfraBadgesContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "BetterInfra Badges";
    string public symbol = "BFRPR";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Eicwiy1T9PnP53ZoohNg/contract-metadata";
  }
