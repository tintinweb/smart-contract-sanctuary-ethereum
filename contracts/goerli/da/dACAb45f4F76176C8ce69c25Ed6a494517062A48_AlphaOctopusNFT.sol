...
contract AlphaOctopusNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public PRICE = 888 * 10**15; // 0.888 ETH
    uint256 public PRESALE_PRICE = 755 * 10**15; //0.755 ETH
    uint256 public constant MAX_BY_MINT = 5;
    uint256 public constant MAX_BY_MINT_WHITELIST = 3;
    uint256 public MAX_RESERVE_COUNT = 10;
    uint256 public SALE_START = 1657497600; //Sunday, July 11, 2022, 00:00:00 UTC
    uint256 public PRESALE_START = 1657324800; //Monday, July 09, 2022, 00:00:00 UTC
    ...
    string private notRevealedtokenUri =
        "https://alphaoctopus.mypinata.cloud/ipfs/Qmd7iQyxGG1qc2qFPRuVFZwBqZ1Xkyrf1zBbErNqBTDnSb";
    string public baseTokenURI;

    event CreateAlphaOctopusNFT(uint256 indexed id);

    constructor(string memory baseURI) ERC721("Alpha Octopus", "ALPHA") {
        setBaseURI(baseURI);
