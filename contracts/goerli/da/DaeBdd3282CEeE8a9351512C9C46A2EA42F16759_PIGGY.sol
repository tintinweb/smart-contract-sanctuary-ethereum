...
contract PIGGYFACTORY is Ownable, ContractMetadata  {
    ...
    string public name = "PIGGYFACTORY-TEST";
...
contract PIGGY is ERC1155 {
    ...
    constructor(
        ...
        uint256 _targetBalance) payable ERC1155(_contract_name, '') {
            ...
            contractURI = _createContractURI(_contract_name, _contract_description, _image_url, _external_url);
    ...
    function _createContractURI(string memory name, string memory description, string memory image_url, string memory external_url) internal view virtual returns (string memory) {
