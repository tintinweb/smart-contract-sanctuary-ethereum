...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x2934b6B741DCcFF47373c470E6FCBa2E81F2F32e];
...
// File: contracts/AtmanAcademyCrystalArtefactContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract AtmanAcademyCrystalArtefactContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Atman Academy Crystal Artefact";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/kLOTnzC9pZE7iPAVbw7N/contract-metadata";
  }
