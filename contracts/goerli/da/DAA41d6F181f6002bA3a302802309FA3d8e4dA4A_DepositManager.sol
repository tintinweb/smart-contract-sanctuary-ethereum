...
contract DepositManager is BaseGovernanceWithUserUpgradable {
     ...
     */
    function split(uint256 originId, uint256 lockedPart, uint256[] memory splitParts, address[] memory addresses) external onlyLockContract returns(uint256[] memory){
