...
library utils {
    ...
    function initValue(uint tokenId) internal pure returns (uint value) {
        if (tokenId < 1000) {
            value = random(tokenId, 1, 70);
        } else if (tokenId < 2000) {
            value = random(tokenId, 1, 63);
        }  else if (tokenId < 3000) {
            value = random(tokenId, 1, 56);
        }  else if (tokenId < 4000) {
            value = random(tokenId, 1, 49);
        }  else if (tokenId < 5000) {
            value = random(tokenId, 1, 42);
        }  else if (tokenId < 6000) {
            value = random(tokenId, 1, 35);
        }  else if (tokenId < 7000) {
            value = random(tokenId, 1, 28);
        }  else if (tokenId < 8000) {
            value = random(tokenId, 1, 21);
        }  else if (tokenId < 9000) {
            value = random(tokenId, 1, 14);
        }  else if (tokenId < 10000) {
            value = random(tokenId, 1, 7);
        } else {
            value = 1;
        }
        return value;
