...
contract MdexCrossChainSwap is Ownable, Pausable {
    ...
    function _crossChainSwap(uint256 amount,bytes calldata payload, bytes calldata apiPayload) private {
...
abstract contract IMdexCrossChainSwap {
    ...
    function _swap(uint256 amount, bytes calldata payload, bytes calldata apiPayload) internal virtual;

    function swap(uint256 amount, bytes calldata payload, bytes calldata apiPayload) public onlyThisContract {
