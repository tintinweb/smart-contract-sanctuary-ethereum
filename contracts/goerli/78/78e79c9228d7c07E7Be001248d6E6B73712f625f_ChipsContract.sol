...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x4B46DDfb9167066f2b0B1163B12B7f9E710478E2];
  address public erc20Payable = 0x4B46DDfb9167066f2b0B1163B12B7f9E710478E2;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 666) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieswwoyvomqko7a3dibdvlz5xkc3tfgarwkderylwxprnaep4m5gm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/JSE6iAHMoN6m3CE7vo88/contract-metadata";
  }
...
// File: contracts/ChipsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ChipsContract is RamppERC721A {
    constructor() RamppERC721A("CHIPS", "CHP"){}
}
