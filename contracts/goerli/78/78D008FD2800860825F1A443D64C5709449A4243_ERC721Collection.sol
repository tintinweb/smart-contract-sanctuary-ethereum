...
contract ERC721BaseCollection is Ownable, ERC721 {
     ...
     */
    function setAllowed(address _operator, bool _allowed) public  {
     ...
     */
    function addWearables(bytes32[] calldata _wearableIds, uint256[] calldata _maxIssuances) external  {
     ...
     */
    function addWearable(string memory _wearableId, uint256 _maxIssuance) public virtual {
