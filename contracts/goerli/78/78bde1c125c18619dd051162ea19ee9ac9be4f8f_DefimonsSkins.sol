...
contract DefimonsSkins is AccessControl, ONFT1155 {
    ...
    event Airdrop(address[] addresses, uint256[][] ids, uint256[][] amounts);
    ...
    /**
     * @notice Airdrops Skins to each address present in the list.
     ...
     * @param ids_      The IDs of the Skins to airdrop.
     * @param amounts_  The amount of each token ID to airdrop to each address.
     */
    function airdrop(
        ...
        emit Airdrop(addrs_, ids_, amounts_);
