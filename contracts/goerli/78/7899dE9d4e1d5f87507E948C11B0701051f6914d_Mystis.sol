...
contract Mystis is ERC1155, Ownable {
    ...
    uint256 public mintRate_Normal = 0.001 ether;
    uint256 public mintRate_Rare = 0.002 ether;
    uint256 public mintRate_Premium = 0.003 ether;
