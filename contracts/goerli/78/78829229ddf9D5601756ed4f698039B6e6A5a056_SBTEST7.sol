...
/*************************************************************************************
 * TESTING:  Insted of importing the OZ PaymentSplitter contract
 * [OpenZeppelin Contracts v4.4.1 (finance/PaymentSplitter.sol)]
 * We are pasting it here in its entirety, with the following CHANGES:
 * -- comments at top removed (SPDX license identifiers, OZ contract version)
 * -- pragma solidity 0.8.4;
 * -- import statements updated so that they work
 * -- release() is now internal instead of public
 **************************************************************************************/
...
contract SBTEST7 is Ownable, ERC721A, PaymentSplitter {
