...
contract PoemsByEzra is ERC721Enumerable, Ownable {
  ...
  constructor() ERC721("Poems", "EZRA") {}

  // public
  function mint(string memory _title, string memory _bgHue, string memory _textHue, string memory _poem) public onlyOwner {
  ...
  function buildImage(uint256 _tokenId) public view returns(string memory) {
      ...
      return Base64.encode(bytes(
          abi.encodePacked(
              ...
              '<text x="50%" y="50%" dominant-baseline="middle" fill="hsl(',currentWord.textHue,', 100%, 80%)" text-anchor="middle" font-size="41">',currentWord.poem,'</text>',
              '</svg>'
          )
      ));
  }
