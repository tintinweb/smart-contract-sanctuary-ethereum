...
contract RentalMarketVaultFacet is ERC1155Holder, ERC721Holder {
    ...
    //     RentalStorageLib.setVaultAddress(address(this));
    // }

    function Finishrental(address renter, address collection, uint256 tokenId) external {
        IERC721(collection).safeTransferFrom(renter, address(this), tokenId);
    }
}