...
contract Staker is StakerStorage, OwnableUpgradeable {
    ...
    function deposit(uint256 _amount) external onlyWhitelist {
        require(
    ...
    function withdrawRequest(uint256 _amount) external onlyWhitelist {
    ...
    function claimWithdrawal(uint256 _withdrawID) external onlyWhitelist {
        require(
    ...
    function claimUnbond(uint256 _unbondNonce) external {
