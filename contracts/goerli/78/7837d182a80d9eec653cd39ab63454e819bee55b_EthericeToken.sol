...
contract EthericeToken is ERC20, ReentrancyGuard, Ownable {
    ...
    address public rewards_addr = 0x9AE3fc0708b4409ad4679F5A55C1B2E2fc7aB27b;
    ...
    */
    function _mintDailyAuctionTokens(uint256 _day) internal {
        uint256 _nextAuctionTokens = lastAuctionTokens -
            ((lastAuctionTokens * dailyTokenReductionPercent) / 1000); // decrease by 3%
        ...
        if (_entryDay < currentDay) {
            _tokenValue =
                (auctionTokens[_entryDay] *
                    mapUserAuctionEntry[_address][_Day].totalDeposits) /
                auctionDeposits[_entryDay];
        } else {
            _tokenValue = 0;
        }
