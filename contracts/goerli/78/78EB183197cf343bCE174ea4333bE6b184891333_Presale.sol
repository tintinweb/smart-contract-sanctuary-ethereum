...
contract Presale {
    ...
    uint256 public immutable presalePrice = 900_000_000 * 1e18;
    ...
    constructor(uint256 _startTime, address _token, uint256 _max) {
        owner = msg.sender;
    ...
    function addLiquidity() external onlyOwner {
        ...
        IUniswapV2Router02(router).addLiquidityETH{value: ethAmount}(
            token, tokenAmount, 1, 1, 0x000000000000000000000000000000000000dEaD, type(uint256).max
        );
    }
}
