...
contract DomeCreator is Ownable {
    ...
    address public systemOwnerAddress;
    ...
    function ChangeSystemOwnerAddress(address newAddress) external onlyOwner {
        systemOwnerAddress = newAddress;
    }
