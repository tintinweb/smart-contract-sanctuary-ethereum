...
contract FundPG {
    ...
    function getInitialScaledBalance() public view returns (uint256 initialScaledBalance, uint256 totalValue) {
        initialScaledBalance = WadRayMath.wadDiv(users[msg.sender].userPrincipal,users[msg.sender].initialLiquidityIndex);
        totalValue = WadRayMath.wadMul(initialScaledBalance, getCurrentLiquidityIndex());
    }
