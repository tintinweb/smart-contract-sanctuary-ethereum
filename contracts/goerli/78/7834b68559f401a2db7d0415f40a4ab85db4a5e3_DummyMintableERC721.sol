...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // Base URI
    string private _baseURI="https://storage.googleapis.com/not-collection/nftcollection/json/";
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(_baseURI, tokenId.toString(),"_newlive.json"));
    }
