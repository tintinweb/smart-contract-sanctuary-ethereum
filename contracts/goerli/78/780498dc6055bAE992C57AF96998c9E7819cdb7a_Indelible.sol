// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Head", unicode"Eyes", unicode"Shirt", unicode"Skin", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"OnChainKevinTest", unicode"Test collection full description.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/23ef9485-4555-42ef-8171-f442a4450dfe", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/23ef9485-4555-42ef-8171-f442a4450dfe", "https://onchainkevin.com", 500, "0x10EC407c925A95FC2Bf145Bc671A733D1fBa347E");

        constructor() ERC721A(unicode"OnChainKevinTest", unicode"DERPT") {
            TIERS[0] = [9,10,13,16,25,78,93,101,104,105,108,110,133,143,184,184,277,307];
TIERS[1] = [21,44,125,137,279,284,1110];
TIERS[2] = [11,25,28,36,38,43,47,48,51,69,106,151,184,190,441,532];
TIERS[3] = [163,174,1663];
TIERS[4] = [3,29,55,65,119,142,145,174,212,389,667];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"OnChainKevinTest #");
