...
contract MPBRT is ERC721MP, Ownable, ReentrancyGuard
{
    ...
    {
        address _ArtBlocksMintingContract;  // [0] -> MintPassInfo._ArtBlocksMintingContract
        uint _ArtBlocksProjectID;           // [1] -> MintPassInfo._ArtBlocksProjectID
        uint _Price;                        // [2] -> _Price
        uint _TotalAvailableForPurchase;    // [3] -> _TotalAvailableForPurchase
        uint _UnixSaleStartTimeBrightlist;  // [4] -> SaleInfo._UnixSaleStartTimeBrightlist
        uint _UnixSaleStartTimePublic;      // [5] -> SaleInfo._UnixSaleStartTimePublic
        uint _UnixUserRedeemTimestamp;      // [6] -> _UnixUserRedeemTimestamp
        uint _MaxPurchaseAmountPerTx;       // [7] -> _MaxPurchaseAmountPerTx
        bytes32 _Root;                      // [8] -> _Root
        bytes32 _MINTER_ROLE;               // [9] -> _MINTER_ROLE
        bool _AllArtistPassesMinted;        // [10] -> _AllArtistPassesMinted
    }
    MintPassInformation public MintPassInfo = MintPassInformation(
        address(0),               // [0] -> MintPassInfo._ArtBlocksMintingContract
        10,                       // [1] -> MintPassInfo._ArtBlocksProjectID
        0.000018 ether,           // [2] -> _Price
        2,                        // [3] -> _TotalAvailableForPurchase
        1662490800,               // [4] -> SaleInfo._UnixSaleStartTimeBrightlist
        1662492600,               // [5] -> SaleInfo._UnixSaleStartTimePublic
    ...
    *******************/
    ...
    {
        require(_totalMinted() == MintPassInfo._TotalAvailableForPurchase, "MPBRT: One-Time Run");
        ...
        MintPassInfo._AllArtistPassesMinted = true;
    }
    ...
    {
        require(!MintPassInfo._AllArtistPassesMinted, "LiveMint Artist Already Complete");
        require(_totalMinted() == MintPassInfo._TotalAvailableForPurchase, "MP: Cannot Mint Metadata Token Before All Mint Passes Have Been Minted");
     ...
     */
    function __NewMaxPurchaseAmount(uint Amount) external onlyOwner { MintPassInfo._MaxPurchaseAmountPerTx = Amount; }
     ...
     */
    function __NewUnixStartTimeUserMints(uint Timestamp) external onlyOwner { MintPassInfo._UnixUserRedeemTimestamp = Timestamp; }
