...
contract MessageSender is IMessageSender, OwnableUpgradeable {
	...
	modifier onlySrcChainPayment() {
		require(msg.sender == srcChainPayment, 'MessageSenderUpgradeable: caller is not payment contract');
		_;
	}
	...
	function sendMessageWithTransfer(
		...
		return MessageSenderLib.sendMessageWithTransfer(receiver, token, amount, dstChainId, nonce, maxSlippage, message, bridgeSendType, messageBus, msg.value);
	}
