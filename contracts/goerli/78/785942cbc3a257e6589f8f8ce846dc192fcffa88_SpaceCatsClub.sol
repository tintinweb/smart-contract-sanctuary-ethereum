...
contract SpaceCatsClub is ERC721A, Ownable {
    enum SaleStatus{ PAUSED, PRESALE, PUBLIC }

    uint public constant COLLECTION_SIZE = 5000;
    uint public constant FIRSTXFREE = 5;
    uint public constant TOKENS_PER_TRAN_LIMIT = 20;
    uint public constant TOKENS_PER_PERSON_PUB_LIMIT = 5000;
    ...
    constructor() ERC721A("SpaceCatsClub", "SCC"){}
    ...
    function mint(uint count) external payable {
        ...
        require(_mintedCount[msg.sender] + count <= TOKENS_PER_PERSON_PUB_LIMIT, "SpaceCatsClub: Number of requested tokens exceeds allowance (5000)");
