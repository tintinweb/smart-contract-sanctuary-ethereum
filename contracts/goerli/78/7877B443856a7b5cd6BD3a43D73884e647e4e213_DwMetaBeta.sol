...
contract DwMetaBeta is ERC721, ERC721Burnable, Ownable {
    ...
    event MessageLog1(string turi);
    
    mapping(uint256 => string) private _tokenURIs;

    mapping(uint256 => int) private _tokenLuck;
    ...
    /// @param tokenId        ID of the token
    function retrieve721(uint256 l2ContractAddress, uint256 tokenId) external {
        ...
        _receiveFromL1ReMint(msg.sender, tokenId);
    }

    function _receiveFromL1ReMint(address to, uint256 tokenId) internal virtual  {
