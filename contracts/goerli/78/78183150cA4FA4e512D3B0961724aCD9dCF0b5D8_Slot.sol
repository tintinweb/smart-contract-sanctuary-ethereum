...
contract Slot is VRFConsumerBaseV2, Ownable, KeeperCompatibleInterface {
    ...
    uint256 private constant PAYOUT_CUSHION = 416666666666667000; // using 1 5x doge (lucky_payout * 10 ** 3). this should really be equal to the max payout * 10 since someone could theoretically hit 10 5x doeges in a row...
