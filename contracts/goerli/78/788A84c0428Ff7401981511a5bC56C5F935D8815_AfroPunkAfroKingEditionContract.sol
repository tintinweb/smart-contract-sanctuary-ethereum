...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5478D62322328cb1FA565E8847eCcD5e3428480B];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x5478D62322328cb1FA565E8847eCcD5e3428480B;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihkow7rgqedzqywyzsyrsy5vaf7uy4b2dbyfdvaku44v4rcdxq4oy/";
...
// File: contracts/AfroPunkAfroKingEditionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AfroPunkAfroKingEditionContract is RamppERC721A {
    constructor() RamppERC721A("AfroPunk AfroKing Edition", "AFRKNG"){}
}
