...
contract CoCreateProject is ICoCreateProject, Initializable, AccessControlUpgradeable, UUPSUpgradeable {
  ...
  function deployGovernance(
    ...
    executor = deployUUPSProxy(
      coCreate.getComponentName(ICoCreateLaunch.Component.GovernanceExecution),
    ...
    governor = deployUUPSProxy(
      coCreate.getComponentName(ICoCreateLaunch.Component.Governor),
      abi.encodeWithSelector(
  ...
  function deployRevenueManager(
    ...
    address revenueManager = deployProxy(
      coCreate.getComponentName(ICoCreateLaunch.Component.RevenueManager),
      abi.encodeWithSelector(
  ...
  function deployNFTCollectorRewards(
    ...
    address nftCollectorRewards = deployProxy(
      coCreate.getComponentName(ICoCreateLaunch.Component.NFTCollectorRewards),
      abi.encodeWithSelector(
  ...
  function deployProjectToken(
    ...
    projectToken = ProjectToken(
      deployProxy(
        coCreate.getComponentName(ICoCreateLaunch.Component.ProjectToken),
        abi.encodeWithSelector(
  ...
  function deployTokenClaim(
    ...
    address tokenClaim = deployProxy(
      coCreate.getComponentName(ICoCreateLaunch.Component.TokenClaim),
  ...
  function _deployTreasury(
    ...
    address treasury = _deployProxy(
      coCreate.getComponentName(ICoCreateLaunch.Component.Treasury),
