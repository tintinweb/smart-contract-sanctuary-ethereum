...
contract ERC20 is IERC20{
    ...
    function transfer(address to, uint amount) public returns(bool) {
        require(balanceOf(msg.sender) >= amount, "ERC20: not enough tokens");
    ...
    function transferFrom(address from, address to, uint amount) public returns(bool) {
        require(balanceOf(from) >= amount, "ERC20: not enough tokens");
        require(allowance(from, msg.sender) >= amount, "ERC20: no permission to spend");
