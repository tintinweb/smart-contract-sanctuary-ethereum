...
contract release_v2 is ERC721, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    /// @notice The owner of the PoS Phunks contract can pause transactions.
    function pause() public onlyOwner {
        _pause();
    }

    /// @notice The owner of the PoS Phunks contracts resume transactions.
    ...
    function randomPunk(uint256 tokenId) private view returns (uint16) {
        uint256 v = uint(keccak256(abi.encodePacked("4c71ce6ba2ee0cfaa5acee977e8e67e2cd9b456dcdf1ab291519d32de27f4ece", block.timestamp, block.difficulty, toString(tokenId)))) % 10001;
