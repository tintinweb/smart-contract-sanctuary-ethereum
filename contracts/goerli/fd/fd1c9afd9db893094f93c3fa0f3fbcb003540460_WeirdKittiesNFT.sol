    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC1155_init(
            "https://ipfs.io/ipfs/QmUZdwpwf7vkuytXxYUhqfofznQkUw9ksDASjVCjGf6YTB/{id}.json"
        );
        __Ownable_init();
    ...
    function mintOwner(address receiver, uint256[] memory ids, uint256[] memory amounts)
        public
        onlyOwner
    {
        bool enough_amount = true;
