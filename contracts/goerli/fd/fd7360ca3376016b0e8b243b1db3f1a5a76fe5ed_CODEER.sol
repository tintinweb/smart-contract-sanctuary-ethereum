...
contract CODEER is ERC20, Ownable {
    ...
    Taxes public buy;
    Taxes public sell;
    Taxes private launch;

    uint256 public buyTotalFees;
    uint256 public sellTotalFees;
    uint256 private launchTotalFees;
    ...
    constructor(
        ...
        uint256 totalSupply = _totalSupply.mul(10**decimals());
        ...
        buy = Taxes(_taxes[0][0], _taxes[0][1], _taxes[0][2]);
        sell = Taxes(_taxes[1][0], _taxes[1][1], _taxes[1][2]);
        launch = Taxes(_taxes[2][0], _taxes[2][1], _taxes[2][2]);

        buyTotalFees = buy.marketing + buy.liquidity + buy.burn;
        sellTotalFees = sell.marketing + sell.liquidity + sell.burn;
        launchTotalFees = launch.marketing + launch.liquidity + launch.burn;

        marketingWallet = address(0xe33FDaF9753f02b6a04Df2C3BE6C564a402BD805);
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _burnFee) external onlyOwner {
        ...
        sell.burn = _burnFee;
        sellTotalFees = sell.marketing + sell.liquidity + buy.burn;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (takeFee) {
            if (
                ...
                fees = amount.mul(launchTotalFees).div(100);
                tokensForMarketing += (fees * launch.marketing) / launchTotalFees;
                tokensForLiquidity += (fees * launch.liquidity) / launchTotalFees;
                tokensForBurn += (fees * launch.burn) / launchTotalFees;
            }
