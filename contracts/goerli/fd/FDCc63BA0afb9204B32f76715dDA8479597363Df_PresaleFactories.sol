...
contract PresaleFactories is Ownable {
    ...
    function CreateNewPresale(
        ...
        require(IERC20(_token).balanceOf(msg.sender) >= initialInfo[4] * initialInfo[3]* 10**_tokenDecimals, "Not enough amount");
        ...
        IERC20(_token).transferFrom(msg.sender, address (presale), initialInfo[4] * initialInfo[3]* 10**_tokenDecimals);
