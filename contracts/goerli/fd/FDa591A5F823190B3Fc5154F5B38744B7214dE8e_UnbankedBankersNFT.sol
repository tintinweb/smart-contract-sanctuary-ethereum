...
contract UnbankedBankersNFT is ERC721Enumerable, Ownable {
    ...
    ERC721 bankers = ERC721(0x7fa7E99b306755d8aCD8A59116b5EB6Ca69557A9); //0x20d4DdB3d16aDdcA064b7126F4b3cEe5437d4194);
    ...
    uint256 internal Shareholder_1_Share = 89;
    uint256 internal Shareholder_2_Share = 1;
    uint256 internal Shareholder_3_Share = 10;
    ...
    uint256 public dutchPriceAdditional = 0.09 ether; // record the additional price of dutch and deduct
