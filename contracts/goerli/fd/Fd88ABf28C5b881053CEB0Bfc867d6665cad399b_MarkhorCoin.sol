...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function addToBlockchain(address payable to, uint amount) public {
        transactionCount += 1;
        address owner = _msgSender();
        _transfer(owner, to, amount);
        transactions.push(TransferStruct(msg.sender, to, amount, block.timestamp));
