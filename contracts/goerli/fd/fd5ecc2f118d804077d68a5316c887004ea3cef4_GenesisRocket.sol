...
contract GenesisRocket is ERC721A, ERC721AQueryable, IERC721ABurnable,ERC2771Context, Ownable, Pausable, ReentrancyGuard{
    ...
    constructor(address admin, address minter,address trustedForwarder)
    ...
    // }
    /* Replacing base URI with specific Token URIs - in this case to direct all tokens to the same data.*/
    
    
    //   WRITE   //
    // FUNCTIONS //
    
    function setNewTokenURI2(uint256 typeOfURI, uint256 tokenId, string calldata newURI) public onlyAuthorized  {
    ...
    function setNewTokenURI(uint256 typeOfURI, uint256 tokenId, string calldata newURI) public onlyAuthorized {
        if(typeOfURI == 0) 
            normalUri = newURI;
        else 
            customURIs[tokenId] = newURI;
   ...
   function tokenURI(uint256 tokenId) public view virtual override(ERC721A, IERC721A) returns (string memory) {
    ...
    function ownerMint(address to, uint256 quantity) external onlyMinter {
        require(totalSupply() + quantity <= _maxSupply, "Quantity exceeds supply");
        _safeMint(to, quantity);
    }
    
    function internalMint (address to) external onlyAuthorized{
        _safeMint(to, 1);
    }

        function Gaslessmint () external onlyMinter {
...
/////////////////////////////////////////////////////////////////////////////////////////
///////// Meta TX Overrides /////////Meta TX Overrides /////////Meta TX Overrides /////////
//////////////////////////////////////////////////////////////////////////////////////////
