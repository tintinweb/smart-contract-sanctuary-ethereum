...
contract NABOZARI is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("NABOZARI", "NABOZAR") {
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(mintedPerWallet[msg.sender] + _numTokens <= MAX_MINT_PER_TX, "You can only miny 3 per wallet.");
