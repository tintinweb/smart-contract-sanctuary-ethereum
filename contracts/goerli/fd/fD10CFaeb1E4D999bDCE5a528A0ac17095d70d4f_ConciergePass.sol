    ...
    EIP712Base
{
    ...
    address payable constant BOOST = payable(address(0x447EAA443C017284EcFB7Fa39a6548B6908f7f0e));
    ...
    */
    ...
    function purchaseTokenMarketPlaceRecipient(
        ...
        // transfer 2% and the onboardingFee for that tier to concierge service
