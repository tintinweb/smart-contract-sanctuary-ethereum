...
contract ERC20Module is CoreStorage, IModule, Executor {
    // keccak256('Wallet.ERC20Module.lockedERC20')
    bytes32 private constant LOCKER_SLOT = 0x684f90f307640f1acce8782c1eed8c5e793edb6bb0353c065b2ac3f1bbcb7daa;
    ...
    function handleTransaction(
        ...
        if (
            ...
            uint256 lockedAmount = getLockedAmount(to);
    ...
    function getLockedAmount(address collection) public view returns (uint256 amount) {
        amount = _getLockedTokens()[collection];
    }
