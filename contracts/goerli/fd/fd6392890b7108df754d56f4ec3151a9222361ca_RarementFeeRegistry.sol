...
/**
 * @title RarementFeeRegistry
 * @author rmnt.xyz
 */
contract RarementFeeRegistry is IRarementFeeRegistry, OwnableRoles {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @dev The Rarement protocol's address that receives platform fees.
     */
    address public override rarementFeeAddress;
    ...
    constructor(address rarementFeeAddress_, uint16 platformFeeBPS_)
        onlyValidRarementFeeAddress(rarementFeeAddress_)
        onlyValidPlatformFeeBPS(platformFeeBPS_)
    {
        rarementFeeAddress = rarementFeeAddress_;
    ...
    /**
     * @inheritdoc IRarementFeeRegistry
     */
    function setRarementFeeAddress(address rarementFeeAddress_)
        external
        onlyOwner
        onlyValidRarementFeeAddress(rarementFeeAddress_)
    {
        rarementFeeAddress = rarementFeeAddress_;
        emit RarementFeeAddressSet(rarementFeeAddress_);
    }
    ...
    /**
     * @dev Restricts the rarement fee address to be address(0).
     * @param rarementFeeAddress_ The rarement fee address.
     */
    modifier onlyValidRarementFeeAddress(address rarementFeeAddress_) {
        if (rarementFeeAddress_ == address(0)) revert InvalidRarementFeeAddress();
        _;
    }
