...
contract CreateCollection {
    address imx = address(0x5FDCCA53617f4d2b9134B29090C87D01058e27e9); // Immutable X Ethereum Mainnet Bridge

    mapping(address => address[]) public deployedAddrs;
    ...
    function createContract(
    ...
    ) external returns (address newSC) {
        newSC = address(
        ...
        deployedAddrs[msg.sender].push(newSC);
