...
contract CRYM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Crypto Miniverse", "CRYM") {

        address newOwner = address(0xF55eec8AAa7Ec3caf3Fc52639933f5C80A717BE1);
    	...
    	marketingWallet = address(0x8bCe2642C78ada62DEE27B57aF95d3C59A48fC56); // set as marketing wallet
