...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x433D1d51BDE1E8e6DecCc352eFA28b7b3AD2Ac86];
  address public erc20Payable = 0x433D1d51BDE1E8e6DecCc352eFA28b7b3AD2Ac86;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 106) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigtppp2s5pwhowcb4rngkldlhubndct5pvndsqz3n2zrctch2q7ku/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/zLtHuN07EdB6aVf3nTFG/contract-metadata";
  }
...
// File: contracts/SpaceTrumpsTradingCardsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpaceTrumpsTradingCardsContract is RamppERC721A {
    constructor() RamppERC721A("Space Trumps Trading Cards", "TP"){}
}
