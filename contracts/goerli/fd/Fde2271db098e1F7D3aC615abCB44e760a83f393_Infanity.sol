...
contract Infanity is ERC1155, ERC2981, IInfanity, DefaultOperatorFilterer, AccessControl  {
        ...
        payable 
    {
        ...
        if (item.enabledTokenGated) {
            ...
            uint256 tokenGatedBalance = getTokenGatedBalance(msg.sender, address(item.tokenGated), _itemId);
    ...
    function getTokenGatedBalance(address caller, address tokenAddrs, uint256 tokenId) public view returns (uint256) {
        ...
        } else if (tokenAddrs.supportsInterface(type(IERC721A).interfaceId)) {
    ...
    function getTokenGatedType(address tokenAddrs) public view returns (string memory) {
        if (tokenAddrs.supportsInterface(type(IERC1155).interfaceId)) {
            return "1155";
        } else if (tokenAddrs.supportsInterface(type(IERC721).interfaceId)) {
            return "ERC721";
    ...
    function getTokenGatedType2(address tokenAddrs) public view returns (string memory) {
        if (tokenAddrs.supportsInterface(type(IERC721).interfaceId)) {
            return "ERC721";
        } else if (tokenAddrs.supportsInterface(type(IERC721A).interfaceId)) {
            return "ERC721A";
        } else if (tokenAddrs.supportsInterface(type(IERC1155).interfaceId)) {
            return "1155";
        }  else {
            return "None";
        }
