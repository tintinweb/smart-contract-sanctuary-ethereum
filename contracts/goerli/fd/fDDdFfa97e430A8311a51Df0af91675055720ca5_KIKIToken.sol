...
contract KIKIToken is ERC20Capped, SafeOwnable {
    ...
    modifier onlyMinter(uint _amount) {
        require(
            ...
            "caller is not minter or not enough"
        );
        _;
    }
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "KIKI::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "KIKI::delegateBySig: invalid nonce"
        );
        require(
            block.timestamp <= expiry,
            "KIKI::delegateBySig: signature expired"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "KIKI::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "KIKI::_writeCheckpoint: block number exceeds 32 bits"
        );
