...
contract Lottory is  VRFConsumerBaseV2, ConfirmedOwner{
    ...
    function fulfillRandomWords(
        ...
        require(Draws[_requestId].exists, "request not found");
        Draws[_requestId].fulfilled = true;
        Draws[_requestId].randomWords = _randomWords[0] % 1000000;
        Draws[_requestId].drawId = _totalDraws;
        checkForWinners;
    ...
    function getDraw(
        ...
        require(Draws[_requestId].exists, "request not found");
        Draw memory request = Draws[_requestId];
    ...
    function checkForWinners () public {
        require(Draws[lastRequestId].randomWords != 0, "request not found");
        Ticket[] storage thisDrawTickets;
        thisDrawTickets = drawToTickets[_totalDraws];
        uint256 drawResult = Draws[lastRequestId].randomWords;
