...
// ================== Variables Start =======================
    ...
    address private ADD_1 = 0x679d3a90e1d0A048700F52FB6832A0F1E63ef8Ad; //7.5
    address private ADD_2 = 0x309FD812478ce828F42AAE274921989a48F1af76; //5
    address private ADD_3 = 0x27e4537A79CF4594dC708efb2fB6F971939DFeb3; //5
    address private ADD_4 = 0x2610A6dC27423831489842b0325E1dbcC6142408; //5
    address private ADD_DEV = 0x4a40Ef1DA0e73A0df142D06470D7a2cfFC677D2f; //5
    address private ADD_O = 0xA08E3c71550D73D3AFCc74a2ea906BB2a3562f42; //7.5
...
// ================== Mint Functions Start =======================
    ...
    function PreMint() public nonReentrant {
        require(premintBalance[msg.sender] < 1, 'Already minted via PreMint please wait and use publicminting');

        uint256 supply = totalSupply();

        require(IERC721A(0xFc6f1dDf79d3589d4d3Cf3107cAD96FA8EB3de80).balanceOf(msg.sender) >= 1, 'No previous tokens owned!');
        uint256 count = IERC721A(0xFc6f1dDf79d3589d4d3Cf3107cAD96FA8EB3de80).balanceOf(msg.sender);
        require(count > 0, 'Not allowed to mint via PreMint, please mint via the Mint method.');

        uint256 amtToMint = count; //set minting to 1 for 1
        // Normal requirements 
        require(count > 0 && count <= maxMintAmountPerTx, 'Invalid mint amount!');
        require(supply + count <= maxSupply, 'Max supply exceeded!');
...
// ================== Withdraw Function Start =======================
     ...
     function withdraw() public onlyOwner {
        ...
        require(_balance > 0);
        _withdraw(ADD_1, (_balance * 50) / 1000);
        _withdraw(ADD_2, (_balance * 50) / 1000);
        _withdraw(ADD_3, (_balance * 50) / 1000);
        _withdraw(ADD_4, (_balance * 50) / 1000);
        _withdraw(ADD_DEV, (_balance * 75) / 1000);
        _withdraw(ADD_O, (_balance * 75) / 1000);
