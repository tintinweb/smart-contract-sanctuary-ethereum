...
contract NFT is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  function mintPack(uint256 _mintAmount) public payable nonReentrant {
    uint256 amount = _mintAmount * 5;
  ...
  function setPauseAt(uint256 _newPause) public onlyOwner() {
    pauseAt = _newPause;
  }
