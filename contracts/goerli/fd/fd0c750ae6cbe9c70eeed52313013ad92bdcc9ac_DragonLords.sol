...
// Medium : https://medium.com/@DragonLordsETH
...
contract DragonLords is Ownable, IERC20 {
    ...
    string constant private _name = "Dragon Lords";
    string constant private _symbol = "LORDS";
    ...
    function ReduceTheTaxes(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBetFee, uint256 newNativeFee, uint256 extra) public DLET{
