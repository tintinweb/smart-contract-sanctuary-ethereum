...
contract NadaiGirlNFT is KeeperCompatibleInterface, ERC721, ERC721URIStorage  {
    ...
    string[] IpfsUri = [
        "https://ipfs.io/ipfs/QmchVKquSF9f4Sthiqu5PPpWakgheAGkrFnbT8hzuzoSeu/NadaiGirlNFT.json",
        "https://ipfs.io/ipfs/QmchVKquSF9f4Sthiqu5PPpWakgheAGkrFnbT8hzuzoSeu/NadaiGirlNFT1.json",
        "https://ipfs.io/ipfs/QmchVKquSF9f4Sthiqu5PPpWakgheAGkrFnbT8hzuzoSeu/NadaiGirlNFT2.json",
        "https://ipfs.io/ipfs/QmchVKquSF9f4Sthiqu5PPpWakgheAGkrFnbT8hzuzoSeu/NadaiGirlNFT3.json"
    ];

    uint interval;
    uint lastTimeStamp;

    constructor(uint _interval) ERC721("NadaiGirl", "dNFT") {
        interval = _interval;
    ...
    function pympMyRide(uint256 _tokenId) public{
        require(NadaiGirlLevel(_tokenId) < 3, "Maximo nivel alcanzado!");
        //if(NadaiGirlLevel(_tokenId) >= 3) {return;}    

        // obtiene el valor actual del Nadai Girl y le suma 1
        uint256 newVal = NadaiGirlLevel(_tokenId) + 1;
        // store the new URI
    ...
    // helper functions
    //
    function NadaiGirlLevel(uint256 _tokenId) public view returns(uint256){
