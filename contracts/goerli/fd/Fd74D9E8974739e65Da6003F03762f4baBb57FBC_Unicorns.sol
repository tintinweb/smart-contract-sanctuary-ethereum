...
contract Unicorns is ERC721, ERC721Burnable, Ownable {
    ...
    uint8 maxSupply = 255;
    event MyTransfer(address from, address to, uint256 tokenId);
    ...
    constructor() ERC721("Unicorns", "UNC") {}
    ...
    function safeMint(address to) public onlyOwner {
        ...
        unicorns.push(Unicorn(tokenId, 100, false));
    ...
    function attack(uint8 tokenId) public {
        ...
        //require(ownerUnicornCount[msg.sender] > 0,"You dont own a unicorn");
        //require(UnicornToOwner[tokenId] == msg.sender,"This unicorn is not yours");
        unicorns[tokenId].cooldown = true;
        bossContract.decreaseHealth(unicorns[tokenId].power);
    }
}