...
contract FundMe {
    ...
    //what if we want to require instead usd value-> here is where the oracle comes in, welcome chainlimk
    ...
    // We might do better by creating a library for our math operations 4:25:00-> PriceConverter.sol
    ...
    modifier onlyOwner() {
        ...
        if (msg.sender != i_owner) {
            revert NotOwner();
        } //this saves us lot of gas since we dont have to store "Only owner can withdraw"
        _;
        //do the require first then all the following code
    }
