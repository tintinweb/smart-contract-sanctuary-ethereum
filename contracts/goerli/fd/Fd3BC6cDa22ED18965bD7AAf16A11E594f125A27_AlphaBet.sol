...
// File @openzeppelin/contracts/token/ERC721/extensions/IERC721Metadata.s[email protected]
...
contract AlphaBet is ERC721, ERC721URIStorage, Ownable, ERC2981 {
    ...
    mapping(address => uint) numberOfWordMinted;
    ...
    function setTos(string memory _tos) public onlyOwner {
        s_tos = _tos;
    }
