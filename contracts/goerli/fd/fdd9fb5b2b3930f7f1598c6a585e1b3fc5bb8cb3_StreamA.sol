...
// File @openzeppelin/contracts/utils/cryptography/EC[email protected]
...
contract StreamA is Ownable, ERC721B {
    ...
    address[] public approvecollections;
    ...
    */
    ...
    function presaleBuy(uint256 tokenQuantity) external payable {
        ...
        uint256 supply = _owners.length;
        require(supply + tokenQuantity < PRESALE_LIMIT, "EXCEED_MAX_SALE_SUPPLY");
