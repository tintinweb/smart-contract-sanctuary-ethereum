...
contract EdoMarketplaceManagement is EdoMarketplaceManagementAdmin {
    ...
    function withdraw(address paymentContractAddress) external onlyAgentOrOwner {
        ...
        IERC20(paymentContractAddress).transferFrom(depositAddress, edoVerseFoundationAddress, edoVerseFoundationProfit);
        IERC20(paymentContractAddress).transferFrom(depositAddress, edoVerseIncAddress, edoVerseIncProfit);
        IERC20(paymentContractAddress).transferFrom(depositAddress, agentRefundAddress, agentRefundProfit);
    }
}
