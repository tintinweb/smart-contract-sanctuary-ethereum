...
contract SWEEPER is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Votes {
    ...
    /// @notice minimum price to mint and sell. This is in USDC
    /// We can use SWEEP at minimumPrice * <sweep target_price>
    uint256 public minimumPrice;

    /// @notice maximum price to buy and burn
    ...
    function setMintBurnAddress(address newMintBurnAddress) external onlyOwner {
        require(mintBurnAddress != address(0), "Zero address detected");
    ...
    function setMinimumPrice(uint256 newMinimumPrice) public onlyOwner {
        ...
        emit MinimumPriceSet(newMinimumPrice);
    }

    function setMaximumPrice(uint256 newMaximumPrice) public onlyOwner {
        maximumPrice = newMaximumPrice;

        emit MaximumPriceSet(newMaximumPrice);
    }
    ...
    event MinimumPriceSet(uint256 minimumPrice);
    event MaximumPriceSet(uint256 maximumPrice);
}
