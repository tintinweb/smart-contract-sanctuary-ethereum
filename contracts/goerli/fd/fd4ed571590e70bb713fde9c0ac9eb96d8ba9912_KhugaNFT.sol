    ...
    DefaultOperatorFilterer
{
    ...
    constructor(
		...
		miawlistMintStage.enabled = false;
		...
		allowlistMintStage.enabled = false;
    ...
    function setMintStageStatus(uint8 _stage, bool _state) public onlyOwner {
		require(_stage <= 2, "Invalid Mint Stage");
        mintStages[_stage].enabled = _state;
    }

	function getMintStageStatus(uint8 _stage) public view returns (bool) {
		require(_stage <= 2, "Invalid Mint Stage");
        return mintStages[_stage].enabled;
    }
