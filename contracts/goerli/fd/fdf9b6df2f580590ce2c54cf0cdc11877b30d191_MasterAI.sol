...
contract MasterAI is ERC20, Ownable {
    ...
    constructor() ERC20("MASTER AI", "MAI") payable {
    	...
    	marketingWallet = address(0x2f2a29DAC51d8eA896A188ea67cDa2c96688d32F); // set as Marketing wallet
        devWallet = address(0x931Ac7d5669044C0Bc46895DF7081e7F8CA46Ba6); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x2f2a29DAC51d8eA896A188ea67cDa2c96688d32F, true);
        excludeFromFees(0x931Ac7d5669044C0Bc46895DF7081e7F8CA46Ba6, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x2f2a29DAC51d8eA896A188ea67cDa2c96688d32F, true);
        excludeFromMaxTransaction(0x931Ac7d5669044C0Bc46895DF7081e7F8CA46Ba6, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x931Ac7d5669044C0Bc46895DF7081e7F8CA46Ba6,
            block.timestamp
        );
    }
