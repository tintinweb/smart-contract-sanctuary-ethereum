...
contract LimitOrderManager is
    ...
    function initialize(
        ...
        ERC721Upgradeable.__ERC721_init("Ergo Position", "ERGO-POS");
    ...
    function processLimitOrder(
        ...
        _transferTokenTo(address(ERGO), _serviceFeePaid, msg.sender);
    ...
    function addFunding(uint256 _amount) external {
        ...
        TransferHelper.safeTransferFrom(address(ERGO), msg.sender, address(this), _amount);
    ...
    function withdrawFunding(uint256 _amount) external {
        ...
        TransferHelper.safeTransfer(address(ERGO), msg.sender, _amount);
    ...
    function quoteERGO(uint256 _weiAmount) public override returns (uint256 quote) {

        return utils.quoteERGO(
            factory,
            address(WETH),
            address(ERGO),
            _weiAmount
...
interface IUniswapUtils {
    ...
    function quoteERGO(IUniswapV3Factory factory, address WETH, address ERGO, uint256 _weiAmount)
