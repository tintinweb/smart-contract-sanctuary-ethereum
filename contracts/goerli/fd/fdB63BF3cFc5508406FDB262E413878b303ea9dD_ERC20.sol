...
contract POO is ERC20, Ownable {
    ...
    constructor() ERC20("POO GAMES", "POO") {
        ...
        marketingWallet = address(0xe816A40493295C6ebEcD2f57AfF622F416EDbB77); 
        developmentWallet = address(0xe816A40493295C6ebEcD2f57AfF622F416EDbB77); 
    ...
    function enablePoo() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
