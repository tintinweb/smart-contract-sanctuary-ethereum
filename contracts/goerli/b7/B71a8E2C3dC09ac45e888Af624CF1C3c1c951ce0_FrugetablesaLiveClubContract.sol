...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7F718BF64D2470EaD9eC714763142b0F894A840d];
  address public erc20Payable = 0x7F718BF64D2470EaD9eC714763142b0F894A840d;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 2222) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "http://api.frugetables.live/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/OLNHMpeB06z8N5aX0XHm/contract-metadata";
  }
...
// File: contracts/FrugetablesaLiveClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FrugetablesaLiveClubContract is ERC721APlus {
    constructor() ERC721APlus("Frugetables aLive Club", "FAC"){}
}