...
contract Concert is ERC721, Pausable, Ownable, ERC721Burnable {
    mapping (address => uint256) public ticketHolder;
  
    constructor() ERC721("Concert", "CRT") {}

    function awardTicket (address _user, uint256 _amount) public {
        addTicket(_user, _amount);
    } 

     function invalidateTicket (address _user, uint256 _amount) public {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmckwAtZfyVLKt1LDiUcrpa7SmSkkMoBU53KcnZUYJ6GH1/";
    }
