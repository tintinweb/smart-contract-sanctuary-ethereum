...
contract Governance is OwnableUpgradeable {
    ...
    function initialize(address _pixt, uint256 _period) public initializer {
        ...
        __Ownable_init();
        hoichiToken = IERC20Upgradeable(_pixt);
        period = _period;
    }
    ...
    function voting(
        ...
        require(
            hoichiToken.balanceOf(msg.sender) + _proposal.delegated[msg.sender] >= _amount,
    ...
    function delegatePower(
        ...
        Proposal storage _proposal = proposal[_pid];
        hoichiToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function withdrawDelegatedPower(uint256 _pid) external {
        ...
        Proposal storage _proposal = proposal[_pid];
        hoichiToken.transfer(msg.sender, _proposal.delegate[msg.sender]);
    ...
    function withdraw(uint256 _pid) external {
        ...
        hoichiToken.transfer(msg.sender, _proposal.staked[msg.sender]);
