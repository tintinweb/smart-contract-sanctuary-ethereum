...
contract IMBUE_GymProfileSetUp
    ...
    function CreateOnlineClass(string memory _name,string memory _date, uint _time,uint _duration, string memory _description, uint _price,string memory _thumbnail ) public {
        OnlineClassDetails[ClassCount] = OnlineStruct(ClassCount, msg.sender, _name,_date, _time,_duration, _description, _price, _thumbnail);
        ClassCount+=1;
    }
