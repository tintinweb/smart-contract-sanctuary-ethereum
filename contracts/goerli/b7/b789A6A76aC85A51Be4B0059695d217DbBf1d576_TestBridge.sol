...
contract TestBridge is IStargateReceiver {
    ...
    function sgReceive(
        ...
        // require(!userNonce[sender][_nonce], "Invalid nonce");
        // userNonce[sender][_nonce] = true;

        emit SGReceive(sender, nftId, _token, amountLD);
    }
    ...
    function sendRequest(
        ...
        IStargateRouter(sgRouter).swap{value: msg.value}(
            ...
            _tokenAmt,
            0,
            IStargateRouter.lzTxObj(0, 0, abi.encodePacked(msg.sender)),
