...
contract walletsManager is ERC2771Recipient{

uint8 private Counter1 = 1;
...
function deleteAddress(address _walletAddress, address _lastOwner,uint8 _index) public {
require(EOAwallets[_lastOwner]._addresses[_index]== _walletAddress , "Wallet not in index or owner");
    delete EOAwallets[_lastOwner]._addresses[_index];
}
}