...
contract PelikanNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    */
    function mintedInFirstPhasePreSale() public view returns (uint256) {
        return firstPhaseWalletMintedInPresale[msg.sender];
    }

    function mintedInFirstPhasePublicSale() public view returns (uint256) {
        return firstPhaseWalletMintedInPublicSale[msg.sender];
    }

     function mintedInSecondPhasePreSale() public view returns (uint256) {
        return secondPhaseWalletMintedInPresale[msg.sender];
    }

    function mintedInSecondPhasePublicSale() public view returns (uint256) {
