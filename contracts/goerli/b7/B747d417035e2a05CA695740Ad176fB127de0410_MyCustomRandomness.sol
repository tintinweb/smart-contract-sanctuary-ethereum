...
// Part: witnet/[email protected]/IWitnetRequest
...
// Part: witnet/[email protected]/IWitnetRequestBoardEvents
...
// Part: witnet/[email protected]/IWitnetRequestBoardReporter
...
// Part: witnet/[email protected]/IWitnetRequestBoardView
...
// Part: witnet/[email protected]/IWitnetRequestParser
...
// Part: witnet/[email protected]/IWitnetRequestBoardRequestor
...
// Part: witnet/[email protected]/Witnet
...
// Part: witnet/[email protected]/WitnetRequestBase
...
// Part: witnet/[email protected]/WitnetRequest
...
// Part: witnet/[email protected]/WitnetRequestBoard
...
// Part: witnet/[email protected]/UsingWitnet
...
// File: MyCustomRandomness.sol

contract MyCustomRandomness
    is
        UsingWitnet
{
    ...
    /// @dev Save the block in which the randomizing request was posted
        ...
        UsingWitnet(_witnet)
    {
        witnetRequest = new WitnetRequest(
            hex"0a0f120508021a01801a0210022202100b1080c2d72f180a20c0843d28333080c8afa025"
        );
    }
    ...
    function requestRandomness() external payable {
        ...
        if (_witnetReward < msg.value) {
            payable(msg.sender).transfer(msg.value - _witnetReward);
        }
    }

    function isRandomized() external returns (bool)
    {
    ...
    function fetchRandomness() external
    {
        ...
        if (_result.success) {
            randomness = witnet.asBytes32(_result);
        } else {
