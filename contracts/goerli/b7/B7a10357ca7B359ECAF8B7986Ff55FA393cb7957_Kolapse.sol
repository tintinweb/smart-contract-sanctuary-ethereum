...
contract Kolapse is ERC1155Supply, Ownable , ReentrancyGuard{
    ...
    string public baseURI= "https://firebasestorage.googleapis.com/v0/b/kolapse-web.appspot.com/o/genesis_collection%2Fmetadata%2F";
    string public suffixURI= "?alt=media&token=89ae8914-74f1-402e-aea4-78a0a130074b";
    ...
    function uri(uint256 _id) override public view returns (string memory){
        ...
        return(
            string(abi.encodePacked(baseURI,Strings.toString(_id),".json",suffixURI))
        );
    }
