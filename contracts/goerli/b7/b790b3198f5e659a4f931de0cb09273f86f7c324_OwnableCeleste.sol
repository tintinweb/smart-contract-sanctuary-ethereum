...
interface IArbitrator {
    ...
    function submitEvidence(
        IArbitrable _subject, uint256 _disputeId, address _submitter, bytes calldata _evidence
    ) external;
...
contract OwnableCeleste is IArbitrator {
    ...
    */
    function changeFundsGovernor(address _newFundsGovernor) public {
        emit FundsGovernorChanged(address(this), _newFundsGovernor);
    }
    ...
    */
    function changeConfigGovernor(address _newConfigGovernor) public {
        emit ConfigGovernorChanged(address(this), _newConfigGovernor);
    }
    ...
    */
    function changeFeesUpdater(address _newFeesUpdater) public {
        emit FeesUpdaterChanged(address(this), _newFeesUpdater);
    }
    ...
    */
    function changeModulesGovernor(address _newModulesGovernor) public {
        emit ModulesGovernorChanged(address(this), _newModulesGovernor);
    }
    ...
    */
    function ejectFundsGovernor() public {
        emit FundsGovernorChanged(address(this), ZERO_ADDRESS);
    }
