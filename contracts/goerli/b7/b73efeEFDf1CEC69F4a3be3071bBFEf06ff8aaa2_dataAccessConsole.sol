...
contract dataAccessConsole is AccessControl {
    ...
    function assignHospitalRole(address _address)
        public
    ...
    function assignApprover(address _address)
        public
    ...
    function consumerApproval(address _address, uint state)
        public
        onlyRole(APPROVER)
    {
        if (state == 1) {
    ...
    function assignDataConsumer(address _address, bytes32 role)
        public
        onlyRole(HOSPITAL)
    {
    ...
    function checkApprovedConsumers()
        public
        view
        returns (dataConsumer[] memory)
    {
    ...
    function returnPatientPermissionState(address add)
        public
        view
        returns (bool)
    {
