...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xFaa205b608A8f5cEcBb9578155637bB52917B186];
...
// File: contracts/UnbuiltPoapContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract UnbuiltPoapContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Unbuilt POAP";
    string public symbol = "Unbuilt";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/uMiU1euMbo7UIPZL5hm6/contract-metadata";
  }
