...
import {IStrategyJob, IDataFeedStrategy, IDataFeed, IOracleSidechain} from '../interfaces/IStrategyJob.sol';
...
contract StrategyJob is IStrategyJob, Keep3rJob {
  ...
  function work(
    ...
    dataFeedStrategy.strategicSendObservations(_chainId, _poolSalt, _poolNonce, _observationsData);
  }
  ...
  function workable(
    ...
    if (_whitelistedNonce != 0 && _whitelistedNonce <= _poolNonce) return dataFeedStrategy.isStrategic(_chainId, _poolSalt, _poolNonce);
  }
