...
// File: contracts/EPS/IDelegationContainer.sol
...
// File: contracts/EPS/IEPSDelegateRegister.sol
...
// File: contracts/EPS/DelegationContainer.sol
...
contract DelegationContainer is IDelegationContainer, IERC721Receiver, Context {
  ...
  /**
   *
   * @dev _changeDelegationDetails: unified processing for changes to container details.
   *
   */
  function _changeDelegationDetails(
    uint64 provider_,
    uint96 fee_,
    uint24 duration_,
    address delegate_,
