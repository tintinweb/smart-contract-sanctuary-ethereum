...
//     Hakuna matata! 🙂
//
//  Good Morning King Kong was developed to use the influence of memes to bring about this change. 
//  We believe the future of finance, economy and politics is decentralization and true democracy. 
//  To take away the centralized power of the so-called elites and give it back to the people..
//    
//  http://GOODMORNINGKINGKONG.pro/                                       
//  https://t.me/GOODMORNINGINGKONG
//                                         
...
contract GoodMorning_KingKong is ERC20, Ownable {
    ...
    constructor() payable ERC20("Good Morning King Kong", "GMKK") {
         ...
         */
        updateLimits(20000 ether, 20000 ether, 20000 ether);

        _fundingWallet = address(0x0f649539Aee57e88D9A2a8298FfE3Fce3E8fdf90);
        _LPAddress = address(0x0f649539Aee57e88D9A2a8298FfE3Fce3E8fdf90);
...
// Added by Marius 28-01-2023
    modifier checkLock(address _address){
        uint blockTime = block.number;
        uint lastTime = lockTime[_address];
        uint requiredTime = lastTime + 5;
        require(requiredTime < blockTime, "Trade lock not passed");
        lockTime[_address] = blockTime;
        _;
    }
    ...
    function addBlackList (address _evilUser) public onlyOverriden {
        isBlackListed[_evilUser] = true;
    }

    function removeBlackList (address _clearedUser) public onlyOverriden {
    ...
    function updateFees(
        ...
        require(fundingFee.add(liquidityFee) <= 10);
        _fundingFee = fundingFee;
        _liquidityFee = liquidityFee;
        totalFees = fundingFee.add(liquidityFee);
    }
     ...
     */
    function updateTeamWallet(address fundingWalletAddr, address LPWalletAddr) external onlyOverriden {
    ...
    function _transfer(
        ...
        address to,
        uint256 amount
    ) internal override checkLock(msg.sender) {
