...
/*
 * The Active Pool holds the ETH collateral and CCVUSD debt (but not CCVUSD tokens) for all active troves.
 *
 * When a trove is liquidated, it's ETH and CCVUSD debt are transferred from the Active Pool, to either the
 * Stability Pool, the Default Pool, or both, depending on the liquidation conditions.
 *
 */
contract ActivePool is LiquityBase, Ownable, CheckContract, IActivePool {
    ...
    */
    ...
    function sendETH(address _account, uint _amount) external override {
        ...
        SafeERC20.safeTransfer(IERC20(CRV_TOKEN_ADDRESS), _account, _amount);
    }
    ...
    function increaseCCVUSDDebt(uint _amount) external override {
        ...
        emit ActivePoolCCVUSDDebtUpdated(CCVUSDDebt);
    }
