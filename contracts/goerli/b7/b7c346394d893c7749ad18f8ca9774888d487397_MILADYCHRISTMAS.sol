...
contract MILADYCHRISTMAS is ERC721A, DefaultOperatorFilterer, Ownable {       
    address public constant TEST_NFT = 0xDaA3812B8FD34D01711105a6DFb669c50ab8fee3;
    ...
    constructor(
        ...
        bytes32 _merkleRoot) ERC721A(_name, _symbol) {   
    ...
    modifier miladyFriends() {
        require(
            ...
            (ERC721(TEST_NFT).balanceOf(msg.sender) >= 1) ||
    ...
    function radBroMint(bytes32[] calldata _merkleProof)
    external 
    payable {
    ...
    function setPause(bool _newStatus) public onlyOwner {
        paused = _newStatus;
    }

    function setAllowListActive(bool _newStatus) public onlyOwner {
