...
contract BuyAndBurn is ReentrancyGuard {
    ...
    // Constants
    uint128 public constant MAX_PROCESSABLE_CARN = 500 * 1e12; // 500 CARNs will be processed on each call
    ...
    function processCarn(Ops op, uint128 amountToProcess) external nonReentrant {
        ...
        uint128 callerReward = (amountToProcess * 10000) / 1000000; // amount *10000 gives 1% of the carn amount * 625 give 0.0625% of the carn
