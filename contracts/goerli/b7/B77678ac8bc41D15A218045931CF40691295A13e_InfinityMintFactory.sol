...
contract ERC721 is ERC165, IERC721, IERC721Metadata {
    ...
    */
	...
	function transferFrom(
		...
		require(beforeTransfer(_from, _to, _tokenId), "failed before transfer");
		...
		returns (bool)
	{
		return (ERC721.ownerOf(tokenId) == addr ||
			isAllowed(addr, tokenId) ||
			isApprovedForAll(ERC721.ownerOf(tokenId), addr));
	}
...
contract InfinityMintStickers is Stickers, ERC721 {
	...
	) ERC721("EAS Sticker", "EAS-S") Stickers(valuesContract) {
