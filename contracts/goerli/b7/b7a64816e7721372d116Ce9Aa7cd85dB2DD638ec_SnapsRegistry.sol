...
contract SnapsRegistry is ERC721, AccessControl {
  ...
  string public constant SNAP_IMAGE = "data:image/svg+xml;base64,";
  
  // events
  event SnapCreated(uint256 indexed snapId, address indexed owner, string indexed name, string description, string externalUrl);
  ...
  error NonSnapOwner(address snapOwner, address msgSender);
  ...
  /// @param docExternalUrl Developers documentation external url
  /// @param author Author of the snap
  /// @param typology Typology of the snap
  /// @return id Identifier assigned to the new snap
  function createSnap(string memory name, string memory description, string memory externalUrl, string memory docExternalUrl, string memory author, uint256 typology) external returns (uint256 id) {
    ...
    newSnap.externalUrl = externalUrl;
    newSnap.docExternalUrl = docExternalUrl;
    newSnap.author = author;
    newSnap.typology = typology;

    emit SnapCreated(snapId, msg.sender, name, description, externalUrl);
  ...
  function releaseSnapVersion(uint256 snapId, string memory version, string memory location, string memory checksum, string memory signature, string memory log) external {
    if (msg.sender != ownerOf(snapId)) revert NonSnapOwner(msg.sender, ownerOf(snapId));
    ...
    if (bytes(location).length < 4) revert InvalidSnapLocation(location);
    if (bytes(checksum).length < 64) revert InvalidSnapChecksum(checksum);
    if (bytes(checksum).length < 64) revert InvalidSnapSignature(signature);
    if (bytes(log).length == 0) revert EmptyField(log);
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    ...
    return string(abi.encodePacked('data:application/json;base64,', _getFromatedMetadata(tokenId)));
  }

  function _getFromatedMetadata(uint tokenId) private view returns (string memory) {
    return Base64.encode(bytes(string(abi.encodePacked(
      '{"name":"', snaps[tokenId].name,'","description":"', snaps[tokenId].description,'","external_url":"', snaps[tokenId].externalUrl,'","image_data":"', bytes(SNAP_IMAGE), '","attributes":[{"trait_type":"Author","value":"', snaps[tokenId].author, '"},{"trait_type":"Type","value":"1"}]}'))));
  }
  ...
  /// @param externalUrl External Url
  /// @param docExternalUrl Developers documentation external url
  function updateSnapMetadata(uint256 snapId, string memory name, string memory description, string memory externalUrl, string memory docExternalUrl, string memory author, uint256 typology) external {
    if (msg.sender != ownerOf(snapId)) revert NonSnapOwner(msg.sender, ownerOf(snapId));

    if (bytes(name).length != 0) snaps[snapId].name = name;
    if (bytes(description).length != 0) snaps[snapId].description = description;
    if (bytes(externalUrl).length != 0) snaps[snapId].externalUrl = externalUrl;
    if (bytes(docExternalUrl).length != 0) snaps[snapId].docExternalUrl = docExternalUrl;
    if (bytes(author).length != 0) snaps[snapId].author = author;
    if (typology != 0) snaps[snapId].typology = typology;
  }
  ...
  function setSnapStatus(uint256 snapId, string memory version, Status status, string memory reason) external {
    ...
    if (status > Status.DEPRECATED) revert InvalidStatus(status);
