    ...
    EmergencyBreak
{
    ...
    function emergencyBreak(string memory reason)
        external
        override
        onlyRole(EMERGENCY_BREAK_ROLE)
    {
        ...
        onlyRole(EMERGENCY_BREAK_ROLE)
    {
        ...
        emit EmergencyBreakDeactivated(
            msg.sender,
            emergencyBreakActivationReason,
            true,
            block.timestamp
        );
    }
    ...
    function getQuoteWithQty(uint256 qty)
        public
        view
        emergencyNotEnabled
        returns (uint256)
...
/**
    ...
    @author AKX Labs <[email protected]>
 */
