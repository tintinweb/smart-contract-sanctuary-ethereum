...
// File: contracts/IRTDEGOLDToken.sol

// 
pragma solidity ^0.8.5;

/**
 * @title IRTDEGOLDToken
 ...
 */
contract IRTDEGOLDToken is ERC777 {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC777("IRTDEGOLD", "IRDAG", new address[](0)) {
        _mint(msg.sender, 675300 * 10 ** 18, "", "");
    }
}
