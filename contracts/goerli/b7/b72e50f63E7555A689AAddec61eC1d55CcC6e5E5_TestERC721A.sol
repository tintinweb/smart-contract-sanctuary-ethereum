...
contract TestERC721A is ERC721APurgatory, Ownable {
...
contract ERC721APurgatory is ERC721A {
    ...
    // _beforeTokenTransfers is overridden to apply checks for any non safeTransferFrom transfers
    ...
    // approve is overridden to perform checks and updating approval mappings with
    // approval statuses and determining whether the user is opted in or out. The specific
    // tokenId is not relevant in this flow as we only care about the generic approval
    function approve(address to, uint256 tokenId) public payable virtual override {
        purgatory.validateApproval(to, msg.sender, true);
