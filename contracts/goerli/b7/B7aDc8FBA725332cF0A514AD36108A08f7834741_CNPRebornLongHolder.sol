...
contract CNPRebornLongHolder is ERC721A, AccessControl, Ownable {
    // ==================================================================
    // Constants
    // ==================================================================
    bytes32 public constant ADMIN = "ADMIN";
    ...
    constructor(address rebornAddress, address ownerAddress)
        ERC721A("CNP Reborn Long Holder", "CNPRebornLH")
    {
    ...
    function getLevel(uint256 tokenId) public view returns (uint256) {
        uint256 term = _reborn.dateOfMeeting(_reborn.ownerOf(tokenId)) - block.timestamp;

        if (term > 4 hours) {
            return 3;
        } else if (term > 2 hours) {
            return 2;
        } else {
            return 1;
        }
