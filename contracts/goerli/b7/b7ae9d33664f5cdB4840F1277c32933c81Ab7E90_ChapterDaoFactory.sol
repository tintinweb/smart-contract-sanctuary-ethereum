...
contract ChapterDaoFactory is Ownable {
    ...
    function createChapterDao(
        ...
        console.log("AMBASSADOR::", ambassador_);
    ...
    function setFeeTo(address _feeTo) external {
        require(msg.sender == feeToSetter, "ChapterDaoFactory: FORBIDDEN");
        feeTo = _feeTo;
    }
    ...
    function getCollection2() public view returns (address[] memory) {
