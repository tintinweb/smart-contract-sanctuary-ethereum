...
error UniforgeCollection__CallerIsNotTheDeployer();
error UniforgeCollection__NeedMoreETHSent();
error UniforgeCollection__TransferFailed();
error UniforgeCollection__SoldOut();

contract UniforgeCollection is ERC721URIStorage {
    ...
    function mintNft() public payable returns (uint256) {
        ...
        if (s_tokenCounter >= i_maxSupply) {
            revert UniforgeCollection__SoldOut();
        }
        _safeMint(msg.sender, s_tokenCounter);
        _setTokenURI(s_tokenCounter, s_baseURI);
        s_tokenCounter += 1;
    ...
    function withdraw() public {
        if (i_owner != msg.sender) {
            revert UniforgeCollection__CallerIsNotTheDeployer();
        }
...
contract UniforgeDeployerV0 {
    ...
    function deployNewCollection(
        ...
        address newUniforgeCollection = address(
            new UniforgeCollection(_name, _symbol, _owner, _maxSupply, _baseURI, _mintFee)
        );
