...
contract WagerRegistry is IWagerRegistry {
    ...
    function enterWager(
        ...
        require(msg.value >= wager.wagerAmount, "W9");
        require(
            (wager.partyTwoWagerData.length == 0 && wager.partyTwo == address(0)) ||
                ((wager.partyTwoWagerData.length > 0 && partyTwoWagerData.length > 0) &&
    ...
    function executeWinner(uint256 wagerId) external override {
        ...
        emit WagerCompleted(winner, wager.wagerAmount * 2, wagerId);
    }
