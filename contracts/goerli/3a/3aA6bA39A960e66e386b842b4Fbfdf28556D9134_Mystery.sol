...
contract Mystery is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    uint256 public cards = 5;
    uint256 public _totalSeekers = 0;
    uint256 public cardsTillOpen = 4;
    ...
    constructor(address _contractAddress, string memory _baseuri)ERC721A('CrystalBall', 'BALL') { 
