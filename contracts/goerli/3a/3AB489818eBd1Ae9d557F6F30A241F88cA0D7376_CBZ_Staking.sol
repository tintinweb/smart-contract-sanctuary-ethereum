...
contract CBZ_Tokens is ERC165, IERC1155Receiver, ReentrancyGuard {
    ...
    CBZ_token public immutable Flowers = CBZ_token(0x851c04CAfc5ec9e994cff8ad63D76AD2BB501295);
    ...
    uint256 internal boxInterval    = 60;     // 30 days
...
contract CBZ_Staking is CBZ_Tokens, IERC721Receiver, Signed {
    ...
    IERC721 public immutable CornerBoyz = IERC721(0x75d3f7428c8795CaF4086Fa501BcBDd362a25e4a);
    IERC721 public immutable Seeds = IERC721(0x9677556bdC31686f660B6d2725ebA9bF718CD28A);

    uint256 private maxSeedPerCorner  = 1;
    uint256 private maxCBZperSeed     = 4;
    uint256 private minimumHarvest    = 420;    // 420
    uint256 private seedInterval      = 60;     // 1 days but now 60 secs to emulate day in min
    uint256 private seedReward        = 10;     // 42 max, 10 with one CBZ 21 w/2 ...
    uint256 private seedMaxReward     = 4200;   // 100.000 cuz its 42.000.000 / 420  (temp 4200 around 100min of life)
    
    uint256 private quarter = seedMaxReward / 4;
