...
contract NftMarketplace is Auctions {
    ...
    modifier isOwner(
        ...
        NFT nft = NFT(_addressNFTCollection);
    ...
    function acceptOffer(uint256 _offerId) public payable nonReentrant {
        ...
        NFT(offer._addressNFTCollection).safeTransferFrom(
            listedItem.seller,
            payable(msg.sender),
            offer.id
        );
        ...
        nonReentrant
    {
        ...
        NFT(_addressNFTCollection).safeTransferFrom(
            listedItem.seller,
            payable(msg.sender),
            nftId
        );
    ...
    function createAuction(
        ...
        NFT nftCollection = NFT(_addressNFTCollection);
    ...
    function claimNFT(uint256 _auctionIndex) external {
        ...
        // Get NFT collection contract
        NFT nftCollection = NFT(auction.addressNFTCollection);
...
contract Auctions is IERC721Receiver, ReentrancyGuard, Calculations, Royalties {
    // Index of auctions
...
contract Calculations is Ownable {
