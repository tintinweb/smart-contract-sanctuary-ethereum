...
contract Token is ERC20, Ownable, AccessControl, Pausable, ChainlinkClient {
    using Chainlink for Chainlink.Request;

    mapping(address => bool) internal _blacklist;
    uint256 public _rewardMultipler;
    ...
    function updateRewardMultipler() public returns (bytes32) {
    ...
    function oracleCallback(bytes32 _requestId, uint256 _result) public view {
        require(
            msg.sender == chainlinkOracleAddress(),
            "Only the oracle is allowed to call this function"
        );

        console.log(chainlinkOracleAddress());
