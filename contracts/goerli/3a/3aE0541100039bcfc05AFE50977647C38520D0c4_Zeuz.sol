...
// File: contracts/Zeuz-eth.sol

pragma solidity ^0.8.7;

contract Zeuz is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 0;
    uint256 MAX_MINT_ETHEREUM = 100;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "zeuz: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_ETHEREUM,
            "zeuz: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "zeuz: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "zeuz: Failed to withdraw Ether");
    }
