...
contract DynamicSvgNft is ERC721, Ownable {
    ...
    //This fn will takes any svg and spit us the img uri
        ...
        returns (string memory)
    {
        ...
        //here we re concat both and then encoded em to packed bytes impl and then we type cast back to str 
    ...
    // we wanna make sure that tokenURI returns the base64 encoded 
        ...
        returns (string memory)
    {
        ...
        return
            string( //concat the string
                abi.encodePacked(
                    _baseURI(), 
                    Base64.encode(
                        bytes(
                            abi.encodePacked( //baseuri + base64 encoded metadata
                                '{"name":"',
                                name(), // we can add whatever name here
