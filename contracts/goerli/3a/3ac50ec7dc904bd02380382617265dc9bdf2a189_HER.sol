...
contract HER is ERC20, Ownable {
    ...
    event AutoNukeLP();
    event ManualNukeLP();
    constructor() ERC20("Her Token", "HER") {
        ...
        marketingWallet = address(0xb2d3999f24334eD332b6C8002CA536dB8D1B04F6); // set as marketing wallet
        devWallet = address(0x2Ec6e549ec41249c05Ed4573CA425e7185D76C25); // set as dev wallet
