...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    bytes32 private constant TIER_2_MERKLE_ROOT = 0x154ebcf4536cb88331b163f3fefacf8821d2ab945af33c1d7662565df53ccf44;
    ...
    string[] private layerNames = [unicode"Smoke", unicode"Eyes", unicode"Earring", unicode"Mouth", unicode"Pests", unicode"Horns", unicode"Watch", unicode"Toad", unicode"Background"];
    bool private shouldWrapSVG = true;
    address private indelibleProContractAddress = 0xf3DAEb3772B00dFB3BBb1Ad4fB3494ea6b9Be4fE;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0x154ebcf4536cb88331b163f3fefacf8821d2ab945af33c1d7662565df53ccf44;
    ...
    ContractData public contractData = ContractData(unicode"Horny Toadz", unicode"On-Chain Horny Toadz! Zero utility, zero royalties. CC0 art for you to enjoy!", "https://files.indelible.xyz/profile/613a4916-8b3f-4bcb-bfec-e52fbf2c303b", "https://files.indelible.xyz/banner/613a4916-8b3f-4bcb-bfec-e52fbf2c303b", "", 0, "0x4936B305102F442080d4711F14C5F0318E3cAF74");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Horny Toadz", unicode"HTZ") {
        tiers[0] = [2685,850,561,173];
        tiers[1] = [736,633,574,429,371,243,222,161,150,146,106,86,76,76,58,56,54,48,44];
        tiers[2] = [2707,652,381,333,196];
        tiers[3] = [895,618,564,451,398,336,229,209,197,147,101,83,41];
        tiers[4] = [1380,1236,640,355,327,226,105];
        tiers[5] = [687,623,530,409,305,295,213,208,183,168,150,141,127,105,52,31,22,20];
        tiers[6] = [2935,1101,233];
        tiers[7] = [686,584,487,471,368,308,291,268,251,196,124,108,60,40,27];
        tiers[8] = [813,805,669,497,473,260,250,168,129,62,58,46,39];
