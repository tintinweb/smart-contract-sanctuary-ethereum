...
contract GFC_ORIGIN is ERC1155, AccessControl, RrpRequesterV0 {
    ...
    uint256 public apiCallForwardingValue = 0;//0.005 ether;
    uint256 public hyperlaneForwardingValue = 0;//0.005 ether;
    ...
    uint256 public mintPrice = 0.00001 ether; //0.001 ether for testing only 0.2 -> 0.3? make adjustable?
    uint256 public whitelistMintPrice = 0.00001 ether; //0.001 ether for testing only 0.2 -> 0.3? make adjustable?
