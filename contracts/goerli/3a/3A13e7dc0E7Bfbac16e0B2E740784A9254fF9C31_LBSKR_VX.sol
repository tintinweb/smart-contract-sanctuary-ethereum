...
contract LBSKR_VX is BaseBSKR, DSMath, Stakable {
    ...
    function _unstakeInternal(
        ...
        uint256 eligibleBasis = _BIPS -
            Utils._penaltyFor(stakeSince, block.timestamp);
        ...
        if (_BSKR.balanceOf(_inflationAddress) != 0) {
            ...
            if (eligibleBasis < _BIPS) {
                ...
                if (bskrToBurn != 0) {
                    require(
                        _BSKR.stakeTransfer(_inflationAddress, address(0), bskrToBurn),
        ...
        returns (uint256 penaltyBasis)
    {
        ...
        return Utils._penaltyFor(currStake.since, block.timestamp);
    }
        ...
        )
    {
        ...
        eligibleBasis = _BIPS - Utils._penaltyFor(currStake.since, block.timestamp);
