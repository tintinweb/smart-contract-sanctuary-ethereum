...
contract Blendfaces is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    uint256 public maxSupply = 10;
    uint256 public maxNormalMintPerAccount = 5;
    uint256 public maxWhitelistMintPerAccount = 1;
    uint256 public publicSalesTimestamp = 1668373718;
    uint256 public whitelistSalesTimestamp = 1668373718;
    uint256 public totalNormalMint;
    uint256 public totalWhitelistMint;
    uint256 public maxNormalSupply = 7;
    uint256 public maxWhitelistSupply = 3;
    uint256 public normalMintPrice = 0.002 ether;
    ...
    constructor() ERC721A("Blendfaces", "BF") EIP712("Blendfaces", "1.0.0") {}
    ...
    function _hash(address account) private view returns (bytes32) {
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256("Blendfaces(address account)"),
                        account
                    )
                )
            );
