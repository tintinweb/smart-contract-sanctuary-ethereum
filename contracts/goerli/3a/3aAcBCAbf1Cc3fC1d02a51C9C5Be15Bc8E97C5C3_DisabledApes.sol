...
contract DisabledApes is ERC721A, Ownable {
    ...
    function withdraw(address _to) external onlyOwner {
        ...
        require(
            ...
            keccak256(abi.encodePacked(("public"))) && (totalSupply() > 2),
            "Withdraw is not allowed since the owner allow it."
        );
        // require(
        //     isAllow == true,
        //     "Withdraw is not allowed since owner approved."
        // );
        // require(
        //     keccak256(abi.encodePacked((MINT_TYPE))) ==
        //     keccak256(abi.encodePacked(("public"))),
        //     "It is still private sale period."
        // );
        // require(
        //     totalSupply() > 2,
