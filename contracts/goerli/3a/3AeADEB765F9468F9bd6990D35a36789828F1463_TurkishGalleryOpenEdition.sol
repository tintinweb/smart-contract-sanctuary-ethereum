...
import './TurkishGalleryOpenEditionBase.sol';
import './TurkishGalleryOpenEditionSplitsAndRoyalties.sol';

// For goerli only
import '@nftculture/nftc-contracts-private/contracts/interfaces/IOperatorFiltererRegistry.sol';

/**
 * @title TurkishGalleryOpenEdition
 */
contract TurkishGalleryOpenEdition is TurkishGalleryOpenEditionSplitsAndRoyalties, TurkishGalleryOpenEditionBase {
    constructor()
        TurkishGalleryOpenEditionBase(
            'TurkishGalleryOpenEdition',
            'TGOE',
            'https://nftc-media.mypinata.cloud/ipfs/', // TODO: nftc-media gateway
            addresses,
            splits
        )
    {
    ...
    function _getInitialFlavors() internal pure override returns (FlavorInfo[] memory) {
        ...
        initialFlavors[0] = FlavorInfo(500000, 0.06 ether, 0, 0, 'QmPVf1U5SN4k9JRTSs1iEHSEWFdCnRJCw1HyQSFSApRMGk/token39');
...
contract TurkishGalleryOpenEditionSplitsAndRoyalties is ERC2981 {
    address[] internal addresses = [
        0x123400000000000000000000000000000000FAde, // Fake Studio Wallet
        0x05Ed4cf991c4ed7606930AB54dDbF27836C1f590 // Team Wallet
    ];

    uint256[] internal splits = [80, 20]; // TODO: Set TurkishGalleryOpenEdition Split(s)
