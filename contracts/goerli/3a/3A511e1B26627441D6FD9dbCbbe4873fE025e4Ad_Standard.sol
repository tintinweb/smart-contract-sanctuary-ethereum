...
contract Standard is ERC721A, ReentrancyGuard, Delegated {
    ...
    mapping(address => uint) public phase_2_num_minted;
    mapping(address => uint) public phase_3_num_minted;
        ...
        callerIsUser
    {
        ...
        require(totalSupply() < MAX_SUPPLY, "Max supply reached");
        require(phase_2_num_minted[msg.sender] <= 15 - (quantity * 2), "Exceeds Max Claim");
        phase_2_num_minted[msg.sender] += quantity * 2;
    ...
    function mintBatch3(uint quantity) external payable callerIsUser {
        ...
        require(totalSupply() < MAX_SUPPLY, "Max supply reached");
        require(phase_3_num_minted[msg.sender] <= 15 - (quantity), "Exceeds Max Claim");
        phase_3_num_minted[msg.sender] += quantity;
        _safeMint(msg.sender, quantity);
    }
