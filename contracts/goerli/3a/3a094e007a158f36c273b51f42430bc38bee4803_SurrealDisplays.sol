...
contract SurrealDisplays is DefaultOperatorFilterer, ERC721, Owned {
    ...
    string public _baseURI;  // TODO set private
    string public _imgBaseURI;  // TODO set private
    bool public _offchainMetadata;  // TODO set private
    ...
    constructor(string memory imgBaseURI, address operator_, address owner)
        ...
        ERC721("Display Modules by Surreal", "SDSP")
        Owned(owner) {
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        ...
        bytes memory dataURI = abi.encodePacked(
            ...
            ', "description": "This module displays key parameters on your journey, such as what loot is in your bag. Also, it gives you early access to the iOS beta and unlocks special features in the app. More: surr.app/modules"',
