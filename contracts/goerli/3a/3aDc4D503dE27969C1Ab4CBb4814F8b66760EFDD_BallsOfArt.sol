...
contract BallsOfArt is ERC721, Ownable {
    ...
    function generateFinalSvg(
        ...
        '<circle cx="500" cy="500" r="280" class="case"> </circle>',
        '<circle cx="500" cy="187.5" r="143" class="bg" transform="rotate(60,500,500)"> </circle>',
        '<circle cx="500" cy="187.5" r="143" class="bg" transform="rotate(180,500,500)"> </circle>',
        '<circle cx="500" cy="187.5" r="143" class="bg" transform="rotate(300,500,500)"> </circle>'
        );
