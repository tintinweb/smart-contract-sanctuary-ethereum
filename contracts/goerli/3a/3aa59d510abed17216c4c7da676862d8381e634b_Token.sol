...
// ERC1155 Sample
//---------------------
contract Token is Ownable, ERC1155, ERC2981, DefaultOperatorFilterer {
    //-----------------------------------------
    // constant
    //-----------------------------------------
    uint96 constant private ROYALTY_FEE_NUMERATOR = 990;   // 9.9%

    //-----------------------------------------
    // strage
    //-----------------------------------------
    mapping( uint256 => string ) private _map_uri;
    ...
    function uri(uint256 tokenId ) public view virtual override returns (string memory) {
        return( _map_uri[tokenId] );
    }

    //-----------------------------------------
    // [external/onlyOwner] set uri
    //-----------------------------------------
    function setUri( uint256 tokenId, string calldata __uri ) external onlyOwner {
        _map_uri[tokenId] = __uri;
    }

    //-----------------------------------------
    // [external/onlyOwner] mint
    //-----------------------------------------
    function mintTokenWithAmount( uint256 tokenId, uint256 amount ) external onlyOwner {
        require( bytes(_map_uri[tokenId]).length > 0, "no uri" );
