...
contract Vox is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    string public constant PROVENANCE = "367ac30ed963e3807e6fe1de61099c51871e2b05cbcdeb8c6ddb33166565ad7d";
    ...
    function reveal() public {
        ...
        offset = uint(blockhash(offsetBlock)) % maxSupply;
        // Just a sanity case in the worst case if this function is called late (EVM only stores last 256 block hashes)
        if (block.number.sub(offsetBlock) > 255) {
            offset = uint(blockhash(block.number-1)) % maxSupply;
        }
