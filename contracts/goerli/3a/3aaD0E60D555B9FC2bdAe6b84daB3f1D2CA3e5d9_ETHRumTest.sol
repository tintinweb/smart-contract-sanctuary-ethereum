...
contract ETHRumTest is ERC721 {
    ...
    constructor(
        ...
        uint8 _numberOfWinners) ERC721(name, symbol) {
    ...
    /**
     * @dev TODO limit to randomizer contract
     */
    function revealStatus(uint256 _randomness) external onlyRandomizer {
    ...
    */
    ...
    modifier onlyRandomizer() {
        //        require(msg.sender == randomizer, "ETHRum: only randomizer"); //TODO
        _;
    }
}
