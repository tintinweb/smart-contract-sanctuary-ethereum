...
contract Ferryman is ERC721Enumerable, Ownable, DefaultOperatorFilterer {
    ...
    address public signerAddress = 0x196A54De04Be9ffBD68805b86f2F6682267360a1;

    bool public isPublic = true;
    bool public isAllowList = true;

    address payable internal constant po =
        payable(0xEaE432f1AAe3d99FABfE5665944Ab1F754fD735f);

    address public soulContract = 0x1027aBbecb16F7d2c89e3189Ee6D06388dEad090;

    mapping(bytes => bool) public usedSignatures;

    constructor(string memory newBaseURI, string memory newSuffix)
        ERC721("Ferryman", "Ferryman")
    {
        ...
        payable
    {
        ...
        require(len <= maxPerTx, "Max per tx");
