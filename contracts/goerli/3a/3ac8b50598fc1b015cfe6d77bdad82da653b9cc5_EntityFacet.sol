...
contract EntityFacet is Modifiers, ReentrancyGuard {
    ...
    function updateEntity(bytes32 _entityId, Entity calldata _entity) external assertSysMgr {
...
library LibEntity {
    ...
    function _startTokenSale(
        ...
        LibMarket._executeLimitOffer(_entityId, _entityId, _amount, entity.assetId, _totalPrice, LibConstants.FEE_SCHEDULE_STANDARD);
    }

    function _updateEntity(bytes32 _entityId, Entity calldata _entity) internal {
        AppStorage storage s = LibAppStorage.diamondStorage();
