...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xdDff2aB24a7d08d7f6cf6Eb251305856bBC043cD];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xdDff2aB24a7d08d7f6cf6Eb251305856bBC043cD;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 1999) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidojbcbmy2rmokmsqnrdhd6clhde57sgbpdebamlsqgnmmio3stmm/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1999");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1999");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1999");
...
// File: contracts/TogoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TogoContract is RamppERC721A {
    constructor() RamppERC721A("TOGO", "TOGO"){}
}
