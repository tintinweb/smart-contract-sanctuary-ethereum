...
contract QUARTEROFSHIB is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "QUATER OF SHIB";
 string private _symbol = "0.25 SHIB";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x042e2BD46a306D45549cefaa9Bb053DDD9B952CB);
 ...
 uint256 QUARTEROFSHIBDaycooldown = 0;
 ...
 //Tokenomics related functions
  function QUARTEROFSHIBDay() public onlyOwner{
      require(block.timestamp > QUARTEROFSHIBDaycooldown, "Quarter Of Shib");
 ...
 function QUARTEROFSHIBCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      QUARTEROFSHIBDaycooldown = block.timestamp + 86400;
 }
