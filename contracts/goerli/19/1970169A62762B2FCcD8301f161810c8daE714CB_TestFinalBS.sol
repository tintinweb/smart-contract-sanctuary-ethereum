...
// File: contracts/TestFinalBS.sol

pragma solidity ^0.8.13;

//Tittle: TESTV2 NFT

contract TestFinalBS is Ownable, ERC721A, PaymentSplitter, ReentrancyGuard, OperatorFilterer {
    ...
    uint256 public wlprice = 0.00006 ether;
    uint256 public pubprice = 0.00009 ether;
    ...
    uint96 private royaltyFeesInBeeps = 750;
