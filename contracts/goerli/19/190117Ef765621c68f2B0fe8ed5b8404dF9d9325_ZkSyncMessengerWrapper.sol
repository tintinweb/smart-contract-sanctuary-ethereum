...
contract ZkSyncMessengerWrapper is MessengerWrapper {
    ...
    function sendCrossDomainMessage(bytes memory _calldata) public override onlyL1Bridge {
        ...
        uint256 _l2GasLimit = 500000;
        uint256 _l2GasPerPubdataByteLimit = 10000000;
        uint256 fee = zkSyncL1Bridge.l2TransactionBaseCost(block.basefee, _l2GasLimit, _calldata.length); 
