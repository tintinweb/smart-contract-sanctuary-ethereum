...
contract CollectibleToken is ERC721URIStorage, Ownable {
  ...
  constructor(
    ...
    require(_maxPerUser <= _maxSupply, "Max per user cannot be greater than max supply!");
    ...
    if (_creatorAddress != msg.sender) {
      transferOwnership(_creatorAddress);
    }
  }
  ...
  modifier startTime() {
    require(
      startMintBlock == 0 || block.timestamp > startMintBlock,
