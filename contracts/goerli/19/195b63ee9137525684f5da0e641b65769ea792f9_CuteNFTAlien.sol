...
// File: contracts/CuteNFTAlien.sol
...
contract CuteNFTAlien is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 69;
    uint public _price = 0.005 ether;
    uint256 public maxBuyPerTx = 20;
    bool public paused;
    

    constructor() ERC721A("CuteNFTAlien", "CNA") {
        paused = true;
    }
    // Read the price
