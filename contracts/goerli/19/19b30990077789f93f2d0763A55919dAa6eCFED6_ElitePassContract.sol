...
// File: contracts/ElitePassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract ElitePassContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/nJrbySKDjTLFTRAfHGdO/contract-metadata";
  }
