...
contract BaseRegistrarImplementation is ERC721, ERC721Enumerable, ERC721URIStorage,ERC721Burnable,IBaseRegistrar, Ownable {
    //ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable
...
/*    constructor(NNS _nns, bytes32 _baseNode) ERC721("", "") {
        nns = _nns;
        baseNode = _baseNode;
    }*/

    function __initialize(NNS _nns, bytes32 _baseNode) initializer public {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        return super.supportsInterface(interfaceId)||interfaceId == INTERFACE_META_ID ||
            interfaceId == ERC721_ID ||
            interfaceId == RECLAIM_ID;
    }
