...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xf347b8Bb36C2c59451cf9d0fD1C137424Eff217A];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xf347b8Bb36C2c59451cf9d0fD1C137424Eff217A;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 7000;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmeCdBEr2tXtEnoKv6PjHkhydnQnfms2Umqx1yAXH9kdNo/";
...
// File: contracts/PositiveFrensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PositiveFrensContract is RamppERC721A {
    constructor() RamppERC721A("Positive Frens", "POSFREN"){}
}
