...
contract AirdropNoFly is Ownable, ReentrancyGuard {
    IERC20 public tokenContractAddress =
        IERC20(0x89b7D46C7C9a0D3bE2e1421700e10b496DD5c12f);
    uint8 private constant _tokenDecimals = 18;

    ITokenVestingFLYY public vestingContractAddress =
        ITokenVestingFLYY(0x62293e76A9dD2067De32DB6208381b1e9D0dAa38);
