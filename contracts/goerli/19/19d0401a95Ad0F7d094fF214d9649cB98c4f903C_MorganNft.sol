...
// File contracts/MorganNftADN.sol


pragma solidity ^0.8.9;

contract MorganNftADN {
    ...
    // Esta funcion pseudo random es determinista y no debe ser usado en produccion
...
// File contracts/MorganNft.sol


pragma solidity ^0.8.9;
contract MorganNft is ERC721, ERC721Enumerable, MorganNftADN {
    //inicializar parametros de la libreria counters
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private _idCounter;
    // utilizamos una variable para limitar cantidad de existencia de nft
    uint256 public maxSupply;

    // Apunta desde el token id (cualquier numero) al ADN (cualquier numero)
    mapping(uint256 => uint256) public tokenDNA;

    // Requiere definir stock al despliegue de contrato, para limitar existencias
    constructor(uint256 _maxSupply) ERC721("MorganNft", "MOR") {
