...
contract TheInu is ERC20, Ownable {
    ...
    uint256 private whitelistTime = 300;                   // whitelist time 30mins
    ...
    uint256 public swapAndLiquidityTokenAmount = 10**6 * 10**18;    // Swap and add liquidity when balance is more than 1B
