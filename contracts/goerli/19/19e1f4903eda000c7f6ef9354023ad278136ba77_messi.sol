...
contract messi is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint public constant maxSupply = 30;
    uint private constant TOKENS_RESERVED = 1;
    uint public price = 0.001 ether;
    uint public wlprice = 0.001 ether;
    uint256 public constant MAX_MINT_PER_TX = 3;
    uint256 public constant MAXMINTWL = 4;
    ...
    constructor() ERC721A("messi", "OPPIE") {
