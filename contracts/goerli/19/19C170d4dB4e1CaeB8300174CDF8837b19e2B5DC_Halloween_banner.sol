...
contract Halloween_banner is ERC1155, Ownable, ERC2981, DefaultOperatorFilterer {
    string public name;
    string public symbol;
    // Creator fee 500=5%, 1000=10%
    uint96 public feeNumerator = 1000;
    // Each ID has BaseURI for day and night 
    string[] public dayBaseURI = ["ipfs://Qma396tWx5FYNAJGT3DiDfoyPNcvaNzxzd2nohJnGtTv6B/"];
    string[] public nightBaseURI = ["ipfs://QmRHUL7UTwWrpWxrBFLjHEXxFaJSZvRQQi6QgwTwNZ7W96/"];
