...
contract LastLock is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "LastLock";
    string constant _symbol = "LastLock";
        ...
        require(
            stonkModeEnabled ||
                (amIStopExempt(_recipient) &&
                    amILocked(_recipient) != block.number),
    ...
    function amILocked(address _request) public view returns (uint256) {
