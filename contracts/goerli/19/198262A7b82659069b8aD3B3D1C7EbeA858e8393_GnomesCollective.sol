...
contract GnomesCollective is ERC721Enumerable, Ownable{
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(walletMints[msg.sender] < maxMintAmount + 1, 'Exceed max wallet'); //Whitelist can mint again after Free mint and before public
    require(_mintAmount > 0, 'Amount has to be > 0');
    require(_mintAmount <= maxMintAmount + 1, 'Amount is > max'); //@dev Whitelist can Mint 1 Free + 1 Additional
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function seltWalletMint (address _user, uint256 _state) public onlyOwner{
