...
contract BaseContract is Ownable, ERC721A, ReentrancyGuard,ERC2981{
    // struct SaleConfig{
    ...
    ) ERC721A(name_, symbol_, collectionSize_, defaultURI_) {}

    /**
     * @notice mint nft 
     * @param to address of the receiver
     * @param quantity number of minted NFT 
     */
...
contract ERC721A is IERC721A {
     ...
     * by default, it can be overridden in child contracts.
     */
    function _updateBaseURI(string memory newURI_) internal {
        _defaultURI = newURI_;
    }
