...
contract NFT is ERC721 {
  ...
  constructor() ERC721("betoo test NFT", "btNFT") {} 
  ...
  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    ...
    if (_exists(tokenId)){
        ...
        _tokenURI = string(abi.encodePacked(baseURL,
        ...
        Base64.encode(
            ...
            '"description": "betoo test NFT ", ',

            '"attributes":"", ',

            '"image": "https://upload.wikimedia.org/wikipedia/commons/d/d6/1Mcolors.png"}'
