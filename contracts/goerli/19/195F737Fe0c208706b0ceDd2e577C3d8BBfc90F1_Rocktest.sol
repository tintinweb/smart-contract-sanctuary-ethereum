...
contract Rocktest is ERC721AQueryable, Ownable, ReentrancyGuard {

  using Strings for uint256;

  bytes32 public merkleRoot;
  mapping(address => bool) public whitelistClaimed;
  mapping(address => mapping(uint256 => uint256)) public lastPaymentTimestamp;
  mapping(address => mapping(uint256 => uint256)) public costPerDay;
