    ...
    ContextMixin
{
    ...
    {
        _setupContractId("CommitteeArtDao");
    ...
    function burnNFT( bytes calldata tokenID) external  only(PREDICATE_ROLE) {
        uint _tokenID = abi.decode(tokenID,(uint256));
        _burn(  _tokenID );
    }
