...
contract OttomanToken is ERC20, Ownable {
    ...
    uint256 public constant maxMintableAmount = 6230;
    ...
    constructor(uint256 _initialSupply, address _priceFeedAddress) public ERC20("OttomanToken", "OTT") {
    ...
    function mintToken(uint256 _amount) public payable {
        ...
        require(
            ...
            "Maximum 6230 tokens are allowed to mint!"
        );
        require(
            minting_state == MINTING_STATE.OPEN,
