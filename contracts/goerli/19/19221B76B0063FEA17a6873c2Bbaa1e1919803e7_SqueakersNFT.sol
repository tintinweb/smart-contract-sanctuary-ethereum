...
contract SqueakersNFT is DefaultOperatorFilterer, ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable{
    ...
    mapping (address => uint256) public ownerQty;
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant UPDATER_ROLE = keccak256("UPDATER_ROLE");
    uint256 public tokenIdFromContract;
    ...
    constructor() ERC721("Squeakers", "SQUEAK") {
        ...
        baseURI = "ipfs://bafybeicg7vywhndsizj3rhm3hseh7rp3kinnnt246timoy3taqxiox72zy/";
    }
    ...
    function mint() public payable{
        require(ownerQty[msg.sender] < 5, "You can only mint 5 NFTs");
        uint256 tokenId = _tokenIdCounter.current();
        safeMint(msg.sender, baseURI, tokenId);
        _tokenIdCounter.increment();
        ownerQty[msg.sender] += 1;
    }
