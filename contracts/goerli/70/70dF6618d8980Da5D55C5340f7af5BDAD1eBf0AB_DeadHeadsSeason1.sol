...
contract DeadHeadsSeason1 is ERC1155, AccessControl {
    ...
    constructor() ERC1155("") {
        ...
        _deadHeads = DeadHeads(0x8512F72EA197b029ABe13b5D2c1e705Aa7e27Dfa);
        _deadTickets = DeadTickets(0x45c42bB268428293C4794A36F1c465f0F88fF564);
    }
    ...
    function setMaxTicketId(uint maxId) external onlyAdmin {
        maxTicketId = maxId;
    }
