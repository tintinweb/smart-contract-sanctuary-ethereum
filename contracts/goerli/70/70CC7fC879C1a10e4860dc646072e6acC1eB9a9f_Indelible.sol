// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Special Item", unicode"Terrain", unicode"Mouth", unicode"Eyes", unicode"Character", unicode"Bottom", unicode"Top", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"PX Doods", unicode"The smaller follow up collection for PXCC.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/bdfb3189-4fbb-4e93-8559-139b8c6a7604", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/bdfb3189-4fbb-4e93-8559-139b8c6a7604", "", 600, "0xAf7a60900bF698814B7D4F5E3995361F9CEE9150");

        constructor() ERC721A(unicode"PX Doods", unicode"PXD") {
            TIERS[0] = [25,41,48,65,82,88,91,105,128,438];
            TIERS[1] = [35,56,57,57,110,164,275,357];
            TIERS[2] = [48,58,92,162,246,248,257];
            TIERS[3] = [26,64,200,233,292,296];
            TIERS[4] = [5,15,26,32,44,78,91,99,137,140,177,267];
            TIERS[5] = [365,367,379];
            TIERS[6] = [37,64,75,76,102,164,273,320];
            TIERS[7] = [11,13,58,60,60,61,61,62,62,62,62,66,67,67,67,68,68,68,68];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"PX Doods #");
