...
// File: contracts/testrowdypickles.sol

pragma solidity >=0.8.0 <0.9.0;

contract testROWDYPICKLES is ERC721AQueryable, Ownable, ReentrancyGuard, OperatorFilterer {
  ...
  uint256 public costWL = 0.015 ether;

  uint256 public maxSupply = 1000;
  uint256 public PHASE_MAX_SUPPLY = 250;
  ...
  constructor( address _signerAddress ) ERC721A ( "ROWDYPKLS", "RP" ) OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), true) {
