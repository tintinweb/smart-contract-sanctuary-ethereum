// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        constructor() ERC721A(unicode"On Chain Death", unicode"DEATH") {
            TIERS[0] = [5,19,23,28,29,30,34,35,36,37,37,39,39,41,43,43,47,49,52,53,55,62,63,64,69,70,70,71,73,74,77,78,95,95,95,95,97];
            TIERS[1] = [4,7,12,14,16,16,18,20,21,21,22,24,24,25,28,28,32,36,36,36,37,38,39,39,41,43,48,48,50,57,57,59,63,64,65,70,71,73,74,75,75,77,79,80,80,80];
            TIERS[2] = [98,105,115,117,158,158,162,271,338,500];
            TIERS[3] = [103,221,485,513,700];
            TIERS[4] = [98,112,200,200,200,250,250,353,359];
            TIERS[5] = [202,284,493,493,550];
