...
contract Staking is Ownable, ERC721Holder {
    ...
    IERC721 public NFT = IERC721(0x49fb061A8332777D10c3A591168db7091afd6f95);  //original one
    IERC20 public Token = IERC20(0x122bB68EC91169E792249524Ef8Fc3CDcF62f472);

    uint256 public perSecReward = 30;  //0.003 dec 4
    uint256 public minHolding;

    uint256 public minStakeDuration = 300; //7 days
