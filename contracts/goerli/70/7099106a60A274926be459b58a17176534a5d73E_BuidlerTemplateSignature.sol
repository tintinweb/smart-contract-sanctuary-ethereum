...
contract BuidlerTemplateSignature is Context, Ownable, ReentrancyGuard, ERC2981, ERC721A, DefaultOperatorFilterer {
    ...
    */
    ...
    uint256 public dtStartHolders = 1677092400; //16h00
    uint256 public dtCloseHolders = 1677094800; //16h40
    uint256 public dtCloseWhiteList = 1677097200; //17h20
    uint256 public dtClosePublic = 1677183600; // 17h20 23;02
    ...
    function contractURI() public view returns (string memory) {
        return "https://buidler.it/minters/demos/buidler/json/contractmetadata";
    }
    ...
    constructor() ERC721A("TESTE ALFREDO 2", "ALFT2") {
        _baseTokenURI = 'https://buidler.it/minters/demos/buidler/json/';
        isOpenPublic = false;
        isOpenWhite = false;
        isOpenHolders = false;

        /*set royalties*/
        address _receiver = 0xB6Ff3745DA5D42625F9CDb6e36331F5eb3a421a0;
        _setDefaultRoyalty(_receiver, 600);
        address _receiver1 = 0x939e9b90998c70602ccF6b0cBaA9B36A97403a1F;
        _setDefaultRoyalty(_receiver1, 150);
    }
   ...
   /*do Free Mint*/
    function freeMint(uint256 _amount, uint quota, bytes memory signature) external {
    ...
    function sendBuidlerFee(uint256 value) private {
        ...
        address __buidler_wallet = 0x939e9b90998c70602ccF6b0cBaA9B36A97403a1F;
