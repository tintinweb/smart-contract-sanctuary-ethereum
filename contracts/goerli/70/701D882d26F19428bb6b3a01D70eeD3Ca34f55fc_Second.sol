...
contract Second is ERC721A, Ownable, ReentrancyGuard {
  ...
  ) ERC721A("Second", "SEC") {  // change the name and symbol for your collection
...
/// @dev free mint
    ...
    require(_numberMinted(_msgSenderERC721A()) + tokens <= MaxperWalletFree + cost * tokens, "Max NFT Per Wallet exceeded");
    require(tokens <= MaxperWalletFree + cost * tokens, "max mint per Tx exceeded");
    require(totalSupply() + tokens <= FreeSupply, "Soldout");
