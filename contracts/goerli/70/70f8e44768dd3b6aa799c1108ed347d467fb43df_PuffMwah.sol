    ...
    ERC721A
{
    ...
    string public baseURI = "ipfs://QmTzGvU343VCCh2bXKVrqHoJGQFedLnpzmbtNdu5ZRNqiN/";

    /// @dev Track whether minting is paused
    bool public mintPaused = false;

    /// @notice Contract URI with metadata
    string internal _contractURI = "ipfs://QmTWFyGvWTgfQ3wNzsF7XETLLtYD4Yo47UAjn7jUAUw6rn";
    ...
    modifier mintable(uint64 amount) {
        if(_getAux(msg.sender) + amount > maxMintsPerAddress) revert ExceedsMaxMintAmount();
    ...
    constructor() Ownable() ERC721A("KFNC_TEST", "KFNC_TEST") {
    ...
    function setMaxMintsPerAddress(uint64 _maxMintsPerAddress)
        ...
        onlyOwner
    {
        if(_maxMintsPerAddress < maxMintsPerAddress) revert NewValueMustBeGreaterThanPrevious();
