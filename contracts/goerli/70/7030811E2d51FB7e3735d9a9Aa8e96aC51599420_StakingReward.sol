...
contract StakingReward is Ownable{
        ...
        function totalStakedTokens() public view returns (uint) {
            return _totalSupply;
        }

        function tokenStakeByUser(address _user) public view returns (uint) {
            return _balances[_user];
        }

        function totalRewardGetByUser(address _user) public view returns (uint) {
