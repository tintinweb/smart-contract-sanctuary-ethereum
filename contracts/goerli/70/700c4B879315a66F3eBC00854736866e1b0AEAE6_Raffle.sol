...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    enum RaffleState {
        OPEN,
        CALCULATING
    } // 0 = open, 1 = calculating. In background these are uint256
    ...
    /** @dev this upkeep checks if the upkeepneeded results into "true", if yes the preformUpkeep function is called
* The following should be true for UpkeepNeeded to be true:
0. The lottery should be in an "open" state
...
*/
    ...
    /* performUpkeep => requesting a winner, what should be done when chekUpkeep results to true */
