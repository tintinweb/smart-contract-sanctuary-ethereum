...
contract VRFv2DirectFundingConsumer is VRFV2WrapperConsumerBase, ConfirmedOwner {
    ...
    function requestRandomWordsWithNums(uint32 _numWords) external onlyOwner returns (uint256 requestId) {
    ...
    function getRandomWordsByRequestId(uint256 _requestId)
    public
