...
contract VestaDNA {
    ...
    function set_house_detail(uint256 l, int f, int r, int b, string memory loc) public {
    ...
    // }
    function get_house_info() public view returns (uint256) { 
        return(userI.libro); 
    }
}
        ...
        string memory jsonURI = Base64.encode(
            bytes(
                string(
                    ...
                    //     '","attributes":[{"trait_type":"Libro","value":"', metad.toString(), '"},{"Folio":"District","value":"', "23456", '"},{"trait_type": "Habitaciones","value":"', "3", '"}]}'
                    // )
                )
            )
        );
