...
contract WavePortal7 is ERC20, ERC2771Context, Ownable {
    ...
    string public constant VERSION = "1.0.1";// Minor updates after 09.11.2022
    ...
    function changeTokenPolicy(uint256 _saleCap, uint256 _exchangeRate, uint256 _promoDays, uint256 _promoAmount) external onlyOwner {
        saleCap = _saleCap;
