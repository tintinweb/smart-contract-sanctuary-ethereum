...
// 0xb99c77618052Bd747F003215810C74c8b639dA7f
    ...
    function updateLiquiditySellFee(uint8 _liquiditySellFee) external onlyOwner {
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        ...
        uint256 rLiquidityBuyBackWallet = tLiquidityBuyBackWallet.mul(currentRate);
        _rOwned[devWallet] = _rOwned[devWallet].add(
            rLiquidityDev
        );

        _tOwned[devWallet] = _tOwned[devWallet].add(
            tLiquidityDev
        );
