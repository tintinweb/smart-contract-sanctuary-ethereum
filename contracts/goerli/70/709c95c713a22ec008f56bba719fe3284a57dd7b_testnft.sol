...
// testnft Edition ERC721 

// Calling mint mints a random testnft until 10,000 have been minted
// Mint costs 0.04 Ether
// testnft
...
contract testnft is ERC721, Ownable, RandomlyAssigned {
  ...
  string public baseURI = "https://ipfs.io/bafybeielscd42jpmbqxsu6jvlf5nvqg2tue5ztajwstnf57abvshqkmnpy/";

  constructor() 
    ERC721("testnft", "TN")
    RandomlyAssigned(43,1) // Max. 43 NFTs available; Start counting from 1 (instead of 0)
    {
       for (uint256 a = 1; a <= 43; a++) {
            mint(msg.sender);
        }
    }
