...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x539252eF9473086216bF8ED14DaF383539d12Fbe];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmQ7DP6nH77znBw6FutYBsDu4TMsx18ccYgTXWikspcfX2/";
...
contract TestprojectContract is RamppERC721A {
    constructor() RamppERC721A("Test project", "RAMPPP"){}
}
