...
/**
 * @title KoreanConsonant
 * KoreanConsonant - a contract for my non-fungible KoreanConsonants.
 */
contract SimpleNFT is ERC721Tradable {
    constructor() ERC721Tradable("SnowBallTestNFT", "SNOWBALL", address(0x00)) {
        for (uint256 i = 0; i < 100; i++) {
            mintTo(address(0x7D0479eB884C41311F5a6581d42B8b784fA8c1b6)); // Dekey account #2
            // mintTo(msg.sender);
        }
    }
