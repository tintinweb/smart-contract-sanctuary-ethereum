...
contract $ARCHIE is Context, IERC20, Ownable {
    ...
    address public _ownerAddress = 0x4113ccD05D440f9580d55B2B34C92d6cC82eAB3c;
    address public _marketingAddress = 0x0cd1a956BFc918398129E2cF7F9FDdAbdCC559bE;
    address public _treasuryAddress = 0xDE3DF272A4225852c93b5331750e8a1Ce34504FD;
    address public _foundationAddress = 0xB4c81e9150CC2A1EA32F1A525bDA1bca4Aaaf8dF;
   ...
   // External Read functions 
    ...
    function setNumTokensSellToAddToLiquidityPercentageAndmaxwalletamount(uint256 _numTokensSellToAddToLiquidity, uint256 _maxwalletamounts) external onlyOwner() {
       numTokensSellToAddToLiquidity = _numTokensSellToAddToLiquidity;
       _maxwalletamount = _maxwalletamounts;

       emit NumTokenSellToAddToLiquidityPercentageAndMaxwalletAmount(_numTokensSellToAddToLiquidity, _maxwalletamounts);
    }

    function setDailymaxTxAmountAndmaxTxAmount(uint256 dailymaxTxAmount, uint256 maxTxAmount) external onlyOwner() {
        _dailymaxTxAmount = dailymaxTxAmount;
