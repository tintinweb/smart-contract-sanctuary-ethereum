    ...
    Governor
{
  ...
  function initialize(
    ...
    require(ballotQuorumThreshold_ <= 10000, ExceptionsLibrary.INVALID_QUORUM);
    require(
      ballotDecisionThreshold_ <= 10000,
      ExceptionsLibrary.INVALID_DECISION
    );
    require(ballotLifespan_ > 0, ExceptionsLibrary.INVALID_LIFESPAN);
...
library ExceptionsLibrary {
    ...
    string public constant INVALID_QUORUM = "INVALID_QUORUM";
    string public constant INVALID_DECISION = "INVALID_DECISION";
    string public constant INVALID_LIFESPAN = "INVALID_LIFESPAN";
    ...
    string public constant NO_LOCKED_BALANCE = "CLAIM_NOT_AVAILABLE";
    ...
    string public constant REMAINING_SUPPLY_OVERFLOW = "REMAINING_SUPPLY_OVERFLOW";
    ...
    string public constant INVALID_SERIAL_NUMBER = "INVALID_SERIAL_NUMBER";
