...
contract CLICK2 is Ownable, ERC721Holder {
    ...
    uint256 public oneMinute = 0; //60
    uint256 public oneWeek = 604800;
    ...
    constructor() payable {
        gen2 = 0x8d7586418E81A6A3b0AA4C653C82e49b79505eBC;
        live = true;
        startTimestamp = block.timestamp;
        // payable(address(this)).transfer(msg.value); //.01
    }
    ...
    function mintNFT() public payable {
        ...
        mints++;
        NFT(gen2).mint(1);
        uint256 id = NFT(gen2).tokensByOwner(address(this))[0];
        NFT(gen2).safeTransferFrom(address(this), msg.sender, id);
