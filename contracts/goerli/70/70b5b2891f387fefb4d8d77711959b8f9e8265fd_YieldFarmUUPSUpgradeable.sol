...
contract YieldFarmUUPSUpgradeable is IYieldFarmUUPSUpgradeable, YieldFarm, UUPSUpgradeable {
...
contract YieldFarm is IYieldFarm, Initializable, AccessControlUpgradeable {
    ...
    function __YieldFarm_init_unchained(YieldFarmConfig memory cfg, address roleAdmin) internal onlyInitializing {
        ...
        staking = IStaking(cfg.stakingAddress);
