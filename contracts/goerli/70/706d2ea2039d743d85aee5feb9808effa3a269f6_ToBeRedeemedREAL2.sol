...
contract ToBeRedeemedREAL2 is ERC721A, Ownable, ReentrancyGuard {
    ERC721A public accessKeysCollection2;
  ...
  constructor(
      address _accessKeysCollection2
      ) ERC721A("To Be Redeemed REAL", "TBR2") {
          accessKeysCollection2 = ERC721A(_accessKeysCollection2);
          }
  ...
  {
    uint cost = price;
    require(accessKeysCollection2.balanceOf(msg.sender) >= amt,"Rejected: Claimer does not have access key"); 
