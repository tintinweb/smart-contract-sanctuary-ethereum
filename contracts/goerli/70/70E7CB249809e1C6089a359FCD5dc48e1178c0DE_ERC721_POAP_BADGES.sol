...
contract ERC721_POAP_BADGES is ERC721B2FAEnumLitePausable {
    ...
    uint256 public mint_price = 0.00042 ether;
    ...
    constructor() ERC721B2FAEnumLitePausable("POAP_BADGES", "POAPB", 1) {}
    ...
    IERC721Enumerable
{
    ...
    function toggleTransfersBlocked(bool block_transfers) public onlyDelegates {
    ...
    Delegated
{
    ...
    bool public transfers_blocked = false;
