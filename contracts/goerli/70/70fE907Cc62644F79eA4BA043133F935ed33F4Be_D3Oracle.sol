...
contract D3Oracle is ID3Oracle, InitializableOwnable {
    ...
    function setTokenOracleFeasible(address token, bool _isAvailable) external onlyOwner {
        priceSources[token].isWhitelisted = _isAvailable;
    }
    ...
    function getPrice(address token) public view override returns (uint256) {
        ...
        return uint256(price) * 10**(18 - priceSources[token].priceDecimal);
    }
