    ...
    ICrowdfundEvents
{
        ...
        returns (uint256 minted)
    {
        ...
        require(isRaiseOpen(), "Pool closed to contributions");
    ...
    function endRaise() public virtual override {
        endDuration = 0;
        emit ForceEndRaise();
    }
...
import {NewShipModule, ShipSetupArgs} from "szns/zodiac/modules/NewShipModule.sol";
...
contract ShipDeployer is IDeployerEvents, IDeployerActions {
    ...
    CaptainGuard
{
    ...
    // TODO: Update this with onlyCaptain modifier
    function endRaise() public override {
        if (endDuration == 0) {
            //If raise was already closed
            revert RaiseClosed();
        } else if (isRaiseOpen()) {
            ...
            require(nftBought, "NFT not bought yet");
        }
    ...
    function contribute() public payable override returns (uint256 minted) {
        minted = super.contribute();
