...
contract Zator is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Zator";
    string private constant _symbol = "Zator";
    ...
    address payable private _developmentAddress = payable(0xE482B2616dF48aEF0B0663fb0260DA5a36FD3179);
    address payable private _marketingAddress = payable(0xE482B2616dF48aEF0B0663fb0260DA5a36FD3179);
