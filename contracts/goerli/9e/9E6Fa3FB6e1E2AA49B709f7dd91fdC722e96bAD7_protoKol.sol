   ...
   */
    function blackListKOL(
        ...
        if (campaigns[_campaignId].campaignData.preSaleToken != _USDT) {
            ...
            // uint256 leftOverReward = (eligibleRwd +
            //     ((campaigns[_campaignId].campaignData.stakingAmount *
            //         investedCampaignDetails[msg.sender][_campaignId].investShare) /
            //         (campaigns[_campaignId].campaignData.requiredInvestment * 1e18))) -
            //     _reward -
