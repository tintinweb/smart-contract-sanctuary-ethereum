...
contract MySvgNFT is ERC721URIStorage {
    ...
    string[] secondWords = ["Cute", "Shy", "Young", "Loyal", "Famous", "Old"];
    string[] thirdWords = [
        "Pellman",
        "Kranich",
        "Joaida",
    ...
    event NewSvgNFTMinted(address sender, uint256 tokenId);

    constructor() ERC721("DynSvgNFT", "DYNSVG") {
    ...
    function makeAnSvgNFT() public {
        ...
        emit NewSvgNFTMinted(msg.sender, newItemId);
    }
}
