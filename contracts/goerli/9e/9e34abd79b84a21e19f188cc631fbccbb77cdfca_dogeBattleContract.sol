...
abstract contract Project {
    ...
    address public devWallet = 0x115526aeC86461e3B144C7B3CEcA2FAEb5D6A88b;

    string constant _name = "Doge Battle";
    string constant _symbol = "DBTL";
 ...
 * MainContract
 */
contract dogeBattleContract is Project, IERC20, Ownable {
