...
contract DEX {
    ...
    function init(uint256 tokens) public payable returns (uint256) {
        require(totalLiquidity == 0, "DEX already has liquidty"); // checking initial liquidity
        totalLiquidity = address(this).balance; // adding liquidity via ourselves
        liquidity[msg.sender] = totalLiquidity; // mapping our txn
