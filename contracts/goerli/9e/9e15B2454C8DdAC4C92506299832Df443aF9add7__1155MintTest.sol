 ...
 * @notice This contract handles minting 1155 mint test tokens.
 */
contract _1155MintTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xF07E6c5A89048bAC9963E43Ea74FCF9b403aeEB3;
    ...
    string public name = "1155 mint test";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeihskgcr6hlwj47c2cfmrmm3yo3ab7pks7oh4civxhwkoqd6fp4tge/{id}"
        )
    {
        ...
        tokenPublicMintsPerAddress[1] = 5000;
