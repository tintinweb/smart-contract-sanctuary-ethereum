...
contract BoardtheBin is IERC20, Ownable {
    IWETH private weth = IWETH(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);

    UniswapV3 private uni = new UniswapV3();

    string private constant CONTRACT_NAME = "BoardtheBin";
    string private constant CONTRACT_SYMBOL = "BB";

    uint256 public constant TOTAL_SUPPLY = 1000000000000000;
    uint256 public  maxAmountPerWallet = TOTAL_SUPPLY / 100;

    uint256 public purchasingFee = 4;
    uint256 public sellingFee = 4;
    ...
    // Owner can claim the contract's ether balance
    ...
    function setFees(uint256 purchasing, uint256 selling) public onlyOwner {
