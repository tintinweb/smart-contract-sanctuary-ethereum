...
contract Auction is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    event BidMade(address bidder, uint256 ethAmount, uint256 auctionId);
    event BidIncreased(address bidder, uint256 ethAmount, uint256 auctionId);
    ...
    function placeBid(uint256 auctionId) public payable contractActive {
        require(
        ...
        if (block.timestamp < SeasonDataMapping[Season].auctionEnd) {
            ...
            emit BidMade(msg.sender, msg.value, auctionId);
        } else if (
    ...
    function increaseBid(uint256 auctionId) public payable contractActive {
        if (bidsAddressMapping[Season][msg.sender] == 0) {
        ...
        emit BidIncreased(msg.sender, msg.value, auctionId);
    }
