...
//    /   |  _____/ /_   / __ )____ _________  / /  /   |  ____  ___  _____   |__ \
//   / /| | / ___/ __/  / __  / __ `/ ___/ _ \/ /  / /| | / __ \/ _ \/ ___/   __/ /
//  / ___ |/ /  / /_   / /_/ / /_/ (__  )  __/ /  / ___ |/ /_/ /  __(__  )   / __/ 
// /_/  |_/_/   \__/  /_____/\__,_/____/\___/_/  /_/  |_/ .___/\___/____/   /____/ 
//                                                     /_/                         
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 177) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibucxffdvysthflsyec3qkhnncotqjbacmjh3zxtwchntbo2aktqe/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/IhPb2ZaRZ9BFEPsakui3/contract-metadata";
  }
...
// File: contracts/ArtBaselApes2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArtBaselApes2Contract is RamppERC721A {
    constructor() RamppERC721A("Art Basel Apes 2", "ABA"){}
}
