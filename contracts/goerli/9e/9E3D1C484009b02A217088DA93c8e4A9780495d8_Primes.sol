...
contract Primes is ERC721r, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 15; // 1575 +1
    uint256 private constant RESERVE = 5; // 75
    ...
    // setting
    function setAllowlisting(address[] calldata _addresses) public onlyOwner {
        delete allowlisting;
        allowlisting = _addresses;
    }
