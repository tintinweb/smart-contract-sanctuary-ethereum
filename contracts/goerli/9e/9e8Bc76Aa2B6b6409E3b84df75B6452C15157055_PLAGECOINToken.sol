...
// File: contracts/PLAGECOINToken.sol

// 
pragma solidity ^0.8.5;

/**
 * @title PLAGECOINToken
 ...
 */
contract PLAGECOINToken is ERC777 {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC777("PLAGECOIN", "PLAGE", new address[](0)) {
        _mint(msg.sender, 23252 * 10 ** 18, "", "");
    }
}
