 ...
 *
 */
contract NewHereClaim2 is ERC1155Supply, Ownable {
  ...
  function claim(
    ...
    require(isClaimActive[_allowlistNum], "Sale is not active for the specified token id");
    require(
    ...
    require(
      quantity <= allowlistQuantities[_allowlistNum][msg.sender] + 1,
      "Quantity is greater than the allocated amount"
    );
    allowlistQuantities[_allowlistNum][msg.sender] -= quantity;
