...
// File: contracts/NFT Sale/CLERC20.sol
...
contract CLToken is ERC20, Ownable, ICLToken {
    ...
    constructor(
        ...
        require(_cap > _premintAmount, "CL: Premint amount is greater than cap");
