...
contract SpaceRander is DesiderNft {
    ...
    {
        DesiderNft.starknetCore = starknetCore_;
    }
    ...
    function _mintDwMeta(uint256 tokenQuantity, bytes32[] calldata merkleProof, bytes32 merkleRoot) internal isValidMerkleProof(merkleProof, merkleRoot) {
        _mintNftMeta(tokenQuantity, msg.sender);
    }

    function _mintNftMeta(uint256 tokenQuantity, address to) internal {
