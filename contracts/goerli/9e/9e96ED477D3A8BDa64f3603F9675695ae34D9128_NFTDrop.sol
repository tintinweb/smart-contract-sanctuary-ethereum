    ...
    ERC721EnumerableUpgradeable
{
    ...
    function claimWithCrossmint(
        ...
        require(_msgSender() == crossmintAddy, "Non-CM-Addy");
    ...
    */
    ...
    /// @dev Checks whether platform fee info can be set in the given execution context.
    function _canSetSalesPhases() internal view override returns (bool) {
        return hasRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }
...
abstract contract Drop is IDrop {
    ...
    */
    ...
    /// @dev Determine what wallet can update sales phases
    function _canSetSalesPhases() internal view virtual returns (bool);
}
