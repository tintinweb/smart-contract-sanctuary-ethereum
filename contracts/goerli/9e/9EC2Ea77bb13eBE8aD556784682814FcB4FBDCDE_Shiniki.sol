    ...
    ShinikiTransfer
{
    ...
    event Lock(address locker, uint256[] tokenIds, uint64 startTimestampLock);
    event UnLock(address unlocker, uint256[] tokenIds);
    ...
    function lock(uint256[] memory tokenIds) public override {
        ...
        emit Lock(msg.sender, tokenIds, timeStampNow);
    }
    ...
    function unlock(uint256[] memory tokenIds) public override {
        ...
        emit UnLock(msg.sender, tokenIds);
    }
    ...
    function _beforeTokenTransfers(
        ...
        if (from != address(0)) {
            require(!locked[tokenId], "Shiniki: staking");
        }
    }
