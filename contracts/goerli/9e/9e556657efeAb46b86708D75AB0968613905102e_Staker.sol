...
contract Staker {
  ...
  modifier notCompleted() {
    require(!exampleExternalContract.completed() && !openToWithdraw, 'contract deadline completed cannot send more ETH or execute');
    _;
  }
  ...
  function execute() public notCompleted {
    require(block.timestamp > deadline, 'deadline has not finished');
  ...
  function withdraw() public {
    require(openToWithdraw, 'contract is not open to withdrawal');
