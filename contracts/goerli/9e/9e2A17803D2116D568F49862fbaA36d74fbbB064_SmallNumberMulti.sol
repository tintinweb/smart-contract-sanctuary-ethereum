...
contract SmallNumberMulti is ERC721Psi, Ownable {
    ...
    uint256 public stage1 = 10;
    // Phase 2 total supply
    uint256 public stage2 = 20;
    // Phase 3 total supply
    uint256 public stage3 = 30;
    // Phase 4 total supply
    uint256 public stage4 = 40;
    // Phase 5 total supply
    uint256 public stage5 = 45;
    ...
    */
    ...
    returns (string memory) {
        ...
        } if (revealed == true && tokenId < 1) { 
      
            return string(abi.encodePacked(baseURI, imgEnd, "/", tokenId.toString(), ""));
        } 

         if ( revealed2 == false && tokenId == 10 && tokenId < 20) {
            return notRevealed2Uri;
        } if (revealed2 == true && tokenId == 10 && tokenId < 20) {
            return string(abi.encodePacked(baseURI2,"/", tokenId.toString(), "")); 
        }

         if ( revealed3 == false && tokenId == 20 && tokenId < 30) {
            return notRevealed3Uri;
        } if (revealed3 == true && tokenId == 20 && tokenId < 30) {
            return string(abi.encodePacked(baseURI3,"/", tokenId.toString(), "")); 
        }

          if ( revealed4 == false && tokenId == 30 && tokenId < 40) {
            return notRevealed4Uri;
        } if (revealed4 == true && tokenId == 30 && tokenId < 40) {
            return string(abi.encodePacked(baseURI4,"/", tokenId.toString(), "")); 
        }

          if ( revealed5 == false && tokenId == 40 && tokenId < 45) {
            return notRevealed5Uri;
        } if (revealed5 == true && tokenId == 40 && tokenId < 45) {
    ...
    function Reveal2() public onlyOwner {
        revealed2 = true;
    }

    function Reveal3() public onlyOwner {
        revealed3 = true;
    }

    function Reveal4() public onlyOwner {
        revealed4 = true;
    }

    function Reveal5() public onlyOwner {
        revealed5 = true;
    }
    ...
    */   
    function mint(uint256 quantity) external payable {
        ...
        if (totalSupply() < stage1 && saleIsActive){
            require(saleIsActive, "Phase 1 must be active to mint");
         _safeMint(msg.sender, quantity);
        }

        if (totalSupply() < stage2 && totalSupply() == stage1 && saleIsActive2){
            require(saleIsActive2, "Phase 2 must be active to mint");
         _safeMint(msg.sender, quantity);
        }

        if (totalSupply() < stage3 && totalSupply() == stage2 && saleIsActive3){
            require(saleIsActive3, "Phase 3 must be active to mint");
         _safeMint(msg.sender, quantity);
        }

        if (totalSupply() < stage4 && totalSupply() == stage3 && saleIsActive4){
            require(saleIsActive4, "Phase 4 must be active to mint");
         _safeMint(msg.sender, quantity);
        }

        if (totalSupply() < stage5 && totalSupply() == stage4 && saleIsActive5){
    ...
    function setImgEnd2(string calldata newImgEnd2) external onlyOwner {
        imgEnd2 = newImgEnd2;
    }
    ...
    function setSaleActive2() public onlyOwner {
        saleIsActive2 = !saleIsActive2;
    }

    function setSaleActive3() public onlyOwner {
        saleIsActive3 = !saleIsActive3;
    }

    function setSaleActive4() public onlyOwner {
        saleIsActive4 = !saleIsActive4;
    }

    function setSaleActive5() public onlyOwner {
