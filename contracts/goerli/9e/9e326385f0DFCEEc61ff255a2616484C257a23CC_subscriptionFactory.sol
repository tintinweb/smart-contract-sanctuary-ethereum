...
contract Subscription {
    ...
    function getDetails() public view returns(uint256[] memory) {
        ...
        uint256 sumBalance = uint256(USDc.balanceOf(address(this)))*1e12 + uint256(Dai.balanceOf(address(this))) + uint256(USDt.balanceOf(address(this))) + uint256(USDcx.balanceOf(address(this))) + uint256(Daix.balanceOf(address(this))) + uint256(USDtx.balanceOf(address(this)));
