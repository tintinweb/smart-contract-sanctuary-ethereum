...
contract Lock is BasicMetaTransaction {
    ...
    event deposited(address depositer,address token, uint256 amount, string tokenName, string symbol);
    ...
    function deposit(uint256 _amount, address token) external payable {
        ...
        emit deposited(_msgSender(), token, _amount, tokensName, tokensSymbol);
    }
