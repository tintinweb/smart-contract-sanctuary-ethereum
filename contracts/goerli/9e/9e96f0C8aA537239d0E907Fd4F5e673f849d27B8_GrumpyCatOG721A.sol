...
contract GrumpyCatOG721A is ERC721A, ReentrancyGuard, Ownable {
    ...
    uint256 public preMintPrice = 0.04 ether;
    ...
    constructor(bytes32 _merkleRoot, address[] memory _internalAccounts, string memory _prefix, string memory _contractURI) ERC721A("Grumpy Cat OG", "GCOG") {
    ...
    function preMint(bytes32[] calldata _merkleProof, uint256  _mintAmount) public payable preMintCompliance(_mintAmount) nonReentrant {
