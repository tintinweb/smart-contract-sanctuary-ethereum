...
contract ChillTuna is ERC721AUpgradeable, ERC721AQueryableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setOgMintLive() external onlyRole(MINTER_ROLE) {
        isMintLive.og = true;
    }
    ...
    function setMaxTxOg(uint256 _maxTx) external onlyRole(DEFAULT_ADMIN_ROLE) {
        maxTxOg = _maxTx;
    }

    function setMaxTxWl(uint256 _maxTx) external onlyRole(DEFAULT_ADMIN_ROLE) {
        maxTxWl = _maxTx;
    }

    function setMaxTxPub(uint256 _maxTx) external onlyRole(DEFAULT_ADMIN_ROLE) {
        maxTxPub = _maxTx;
    }
