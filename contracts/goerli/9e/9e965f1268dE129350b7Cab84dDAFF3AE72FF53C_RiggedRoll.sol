...
contract DiceGame {
    ...
    function rollTheDice() public payable {
        ...
        console.log('\t',"   Dice Game Nonce:",nonce);
...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) public onlyOwner {
        require(_addr != address(0), "The address should be valid");
        (bool sent, ) = _addr.call{value: _amount}("");
        require(sent, "Failed to send ether to adderss _to"); 
    }
    ...
    function riggedRoll() public {
        ...
        require(address(this).balance >= 0.002 ether, "The balance should be at least 0.002 ether to roll a riggedRoll");
        bytes32 prevHash = blockhash(block.number - 1);
        bytes32 hash = keccak256(abi.encodePacked(prevHash, address(diceGame), nonce));
        uint256 roll = uint256(hash) % 16;

        console.log('\t',"  Rigged Dice Game Roll:",roll);
        console.log('\t',"  Rigged Dice Game Nonce:",nonce);
