...
contract BitslicedStore is Initializable, ERC2981Upgradeable, ERC1155Upgradeable, OwnableUpgradeable {
    ...
    function uri(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(tokenURI).length > 0 ? tokenURI : string(abi.encodePacked(s_baseURI, tokenId.toString()));
    }
