...
contract ChainpassMarketplace_1_0 is MetaTxMixin, Ownable, ReentrancyGuard {
    ...
    function setSecondaryAsks(
        ...
        require(
            _msgSender() == address(ticketContract) || _msgSender() == ticketOwner,
     ...
     *  Buying tickets.
     */
    mapping (bytes32 => bool) internal attendeeNonces;
    ...
    function _buyTickets(
        ...
        transferUSDC(buyer, chainpassWallet(), chainpassCut);
        ...
        tansferTicketsAndPaySellers(
            ...
            buyer,
            attendee,
            totalPrice - royaltyAmount - chainpassCut,
            tokenIds,
            sharePerToken
        );
