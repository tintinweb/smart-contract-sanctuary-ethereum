...
contract UintsEdition is ERC721A, Ownable {
    ...
    uint animationIndex;
    uint public broadcastNumber;
    uint public lockedUntil;
    uint public broadcastCounter;

    mapping(uint => bool) usedTokens;

    address _uintsAddress = 0xEeFb1121Cf8506C8358Ca308764F588FC09Ad7C2;
    IUints _uintsContract = IUints(_uintsAddress);

    address _pobAddress = 0x991e2487a5Ef6Ae7c1d8ECf2878E47172cf1608e;
    ...
    function isArtLocked() external view returns (bool result) {
        if (block.timestamp <= lockedUntil) {
            return true;
        } else {
            return false;
