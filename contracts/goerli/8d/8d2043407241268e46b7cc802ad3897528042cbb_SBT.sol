...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function multipletransfer(
        ...
        for (uint256 i; i < recivers.length; i++) {
            transferFrom(msg.sender, recivers[i], amount[i]);
        }
    }
...
contract SBT is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("Soulsbound Token", "$SBT") {
        _mint(msg.sender, 1_000_000_000_000 * 10**decimals());
    }

    function airDrop( address[] memory receivers,uint256[] memory amount  ) public onlyOwner  { 
