...
contract Chapters is ERC1155Upgradeable, ERC2981Upgradeable {
    struct Chapter {
        string uri;
        uint256 totalSupply;
        uint256 __gap;
    ...
    function mintForeword(uint8 quantity) external whenNotPaused {
        ...
        _chapters[FOREWORD_ID].totalSupply += quantity;
    ...
    function claim(uint8 chapterId, uint256 tokenId) external whenNotPaused {
        ...
        ++chapter.totalSupply;
        _mint(_msgSender(), chapterId, 1, "");
    }

    //// GETTERS

    function isChapterCreator(address account) external view returns (bool) {
    ...
    function setChapterCreator(address creator, bool isCreator)
        external
        onlyAdmin
    {
