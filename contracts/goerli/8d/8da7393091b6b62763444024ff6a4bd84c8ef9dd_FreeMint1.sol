...
// File contracts/testkzfm1206.sol
...
contract FreeMint1 is ERC721Royalty, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    constructor() ERC721('name', 'symbol') {
        ...
        freeMintAmountMapping[0x9a51509DC149a70E1D59B69A2CC11891CfD2046a] = 200;
        freeMintAmountMapping[0x354678BDDb1c60071287853da0Ec6D2832a33aFa] = 200;
        freeMintAmountMapping[0x5A3b919496358098ED6549b235D578914a7Cc90b] = 200;
    }

    mapping(address => uint256) freeMintAmountMapping;

    // 12月25日22:00
    uint256 freeMintStartTime = 1571973200;

    // 12月26日10:00
    uint256 freeMintEndTime = 1972189200;
    uint256 freeMintMaxAmount = 800;
    uint256 freeMintCount;

    bool revealStatus = false;
    string baseURIbeforeReveal;
    ...
    function setFreeMint(address to, uint8 amount) public onlyOwner {
    ...
    // freemint期間が終了した際、ownerがmintできるようにする。
    ...
    function getURI(uint256 tokenId)
        ...
        returns(string memory)
    {
        // revealがtrueの時、リビール後の画像を開く。baseURIでのURL/id.json
