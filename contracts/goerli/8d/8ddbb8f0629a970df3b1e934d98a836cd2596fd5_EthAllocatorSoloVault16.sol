...
/** 
    ...
    @author Florian Lüffe <[email protected]>, Tobias Leinss <[email protected]>
...
*/
contract EthAllocatorSoloVault16 is ERC1155Supply, ReentrancyGuard, Ownable {
    ...
    string public constant name = "Blockscape Solo Vault NFTs Goerli";
    ...
    */
    ...
    function openSoloVault() public onlyOwner {
    ...
    function testDepositSoloVault() external payable nonReentrant {
        ...
        _metadataSoloVaultInternal(msg.value, msg.sender, tokenID);
        ...
        // close the vault
        //_closeSoloVaultInternal(); -> testing without closing the vault
    }
    ...
    */
    ...
    /**
        ...
        @param _staker the sender
        @param _tokenID Identifier of the vault
    */
    function _metadataSoloVaultInternal(
        uint256 _stakedETH,
        address _staker,
        uint256 _tokenID
    ) internal {
    ...
    function _closeSoloVaultInternal() internal {
        assembly {
            sstore(allowPubDeposit.slot, 0)
        }
    }
