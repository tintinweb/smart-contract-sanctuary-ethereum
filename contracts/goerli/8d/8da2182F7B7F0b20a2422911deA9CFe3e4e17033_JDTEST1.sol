...
contract JDTEST1 is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {

    uint public maxSupply  = 100;          // Hard-coded in setMaxSupply() also.
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[0]] = Account( 50, 0, 3 ); //
