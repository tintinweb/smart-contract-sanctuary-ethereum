...
contract Asset is DefaultOperatorFilterer, Ownable, ERC721, EIP2981 {
    ...
    function mintFor(address to, uint256 quantity, bytes calldata mintingBlob) external {
        require(msg.sender == imx || msg.sender == owner(), "Asset: caller not owner or IMX");
        require(quantity == 1, "Asset: invalid quantity");
