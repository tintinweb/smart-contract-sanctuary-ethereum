...
contract Merchandise is ERC721A, Ownable {
  using Strings for uint256;

  string public baseURI;
  bool public claimPeriodActive;
  // address public grabAddress;
  ...
  // function grab(address owner, uint256 tokenId) public onlyOwner {
  //   require(
  //     grabAddress != address(0),
  //     "Grab address is not set!"
  //   );
  //   require(
  //     ownerOf(tokenId) == owner,
  //     "Token is not owned by the specified address!"
  //   );

  //   safeTransferFrom(owner, grabAddress, tokenId);
  // }
  ...
  // function setGrabAddress(address newGrabAddress) public onlyOwner {
  //   grabAddress = newGrabAddress;
  // }
