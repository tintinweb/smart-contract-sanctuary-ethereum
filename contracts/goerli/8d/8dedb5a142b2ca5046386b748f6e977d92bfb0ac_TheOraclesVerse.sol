...
contract ERC2981 is IERC2981 {
    ...
    mapping(uint => address) public idToRoyaltySplitter;
    ...
    function royaltyInfo(uint256 tokenId, uint256 value)
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        require(idToRoyaltySplitter[tokenId] != address(0), "No receiving address set!");
        receiver = idToRoyaltySplitter[tokenId];
...
contract TheOraclesVerse is ERC721Enumerable, ERC2981, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("The Oracles Verse", "TOE") {
        baseURI = "ipfs://.../";

        //set the claimlock address
        //claimLock = IClaimLock(0x);
        ...
        idToRoyaltySplitter[1] = 0x4ab3748bBCaE1008C5ae60e74812c7595bB55A30;
        idToRoyaltySplitter[2] = 0x4ab3748bBCaE1008C5ae60e74812c7595bB55A30;
        idToRoyaltySplitter[3] = 0x4ab3748bBCaE1008C5ae60e74812c7595bB55A30;
        idToRoyaltySplitter[4] = 0x4ab3748bBCaE1008C5ae60e74812c7595bB55A30;
        idToRoyaltySplitter[5] = 0x4ab3748bBCaE1008C5ae60e74812c7595bB55A30;
        idToRoyaltySplitter[6] = 0x4ab3748bBCaE1008C5ae60e74812c7595bB55A30;
     ...
     */
    function setRoyaltySplitter(uint tokenId, address newSplitter) external onlyOwner {
        require(newSplitter != address(0), "Cannot be the 0 address!");
        require(tokenId <= totalSupply(), "Cannot be the 0 address!");
        idToRoyaltySplitter[tokenId] = newSplitter;
    }
    ...
    /**
     * Set ClaimLock Contract
     * @param newAddress The new address for the QEV token
     */
    function setClaimLock(address newAddress) external onlyOwner {
        require(newAddress != address(0), "Cannot be the 0 address!");
        claimLock = IClaimLock(newAddress);
    }
    ...
    function contribute(uint tokenId, string memory paragraph) external payable isContractState(ContractState.ON) {
        ...
        require(bytes(paragraph).length <= 100, "Maximum of 100 bytes are allowed!");
        ...
        IRoyaltySplitter royaltySplitter = IRoyaltySplitter(idToRoyaltySplitter[tokenId]);
        uint shares = royaltySplitter.shares(msg.sender);
        shares > 0 ? royaltySplitter.addShares(msg.sender, 100) : royaltySplitter.addPayee(msg.sender, 100);
