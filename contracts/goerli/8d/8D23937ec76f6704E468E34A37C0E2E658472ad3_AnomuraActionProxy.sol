    ...
    ERC5050
{
    ...
    function initialize(
        // address _anomuraAddress
        ) external initializer 
    {
        anomura = IERC721(0xc15d390572D7F5de61C459E6d713677ec181059C);
        isPaused = false;
    ...
    function canImplementInterfaceForAddress(bytes4 interfaceHash, address addr) external pure returns(bytes32) {
