...
contract SaleTicket is AccessControl, Pausable {
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    // Replace MY_USDC_ADDRESS with the address based on the blockchain below.
    IERC20 public usdc = IERC20(0x326C977E6efc84E512bB9C30f76E30c160eD06FB);
    ITicket public ticketContract =
        ITicket(0xF37d7Fa7EC328a945d666627C78C0F1b2cEAE58F);
    uint256 priceInUsdc = 5 * 10 ** 8;
    ...
    function mint(uint256 quantity, address to) external payable whenNotPaused {
        ...
        ticketContract.mint(to, 0, quantity, "");
    }
}
