...
contract Presale is Ownable {
    ...
    uint256 public hardcap = 10000*1e18;  // Total Eth Valu
    address private dev;
    ...
    function closePrsale() external onlyOwnerAndAdmin {
    ...
    function getTokens(uint256 _amountInUSD) public view returns(uint256) {
        ...
        return (per*_amountInUSD*10**(tokenDecimals-rateDecimals));
...
contract TimeLockedWallet {
    ...
    uint256 public launchDate;
     ...
     constructor(
        ...
        launchDate = _launchDate;
        unlockDate = launchDate + _unlockDate;    // launchDate+_unlockDate
...
interface ITimeLockedWalletFactory {
    ...
    function newTimeLockedWallet(address _owner,uint256 _launchDate,uint256 _unlockDate)
        external
...
contract TimeLockedWalletFactory is ITimeLockedWalletFactory{
    ...
    {
        // Create new wallet.
        wallet = address(new TimeLockedWallet(msg.sender,_owner,_launchDate,_unlockDate));
