...
//  /      \
// /        \
// ----------__  __                    ____         _                \ \/ /__  ____  ____     / __ \___    (_)__  ____  ____ 
//  \  / _ \/ __ \/ __ \   / / / / _ \  / / _ \/ __ \/ __ \
//  / /  __/ / / / / / /  / /_/ /  __/ / /  __/ / / / / / /
// /_/\___/_/ /_/_/ /_/  /_____/\___/_/ /\___/_/ /_/_/ /_/ 
//                                 /___/                   
//
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xf7a9f176F96BD00f627781634Ba6Ad27aA03310d];
  address public erc20Payable = 0xf7a9f176F96BD00f627781634Ba6Ad27aA03310d;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeig2bhhovhkpcdebvesjn32xxy5av3uw6ddvkqpy7tdxx23sswzm2e/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/yXWqUvSSriWnk0s9eUU0/contract-metadata";
  }
...
// File: contracts/YennDejennContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YennDejennContract is RamppERC721A {
    constructor() RamppERC721A("Yenn Dejenn", "YENN"){}
}