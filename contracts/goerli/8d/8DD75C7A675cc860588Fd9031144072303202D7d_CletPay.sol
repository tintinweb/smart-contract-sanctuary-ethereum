...
contract CletPay is Ownable {
    ...
    AggregatorV3Interface constant priceFeed =
        AggregatorV3Interface(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e); //!!! CHANGE TO MAINNET ADDRESS BEFORE MAINNET!!!
    ...
    function unlock(
        ...
        emit Paid(_name, _years, _address, _soldBy, _amountPaid / TenPow18, _partnerCut);
    }
    ...
    // @notice Checks if is unavailable
