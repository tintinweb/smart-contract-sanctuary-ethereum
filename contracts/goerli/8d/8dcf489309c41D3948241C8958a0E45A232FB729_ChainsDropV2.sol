...
// https://bafybeicnmeaqivwxle7lsawvxtxgqoe2a5j2fxiuicmlxppmxlpt65voju.ipfs.nftstorage.link/
...
contract ChainsDropV2 is ERC1155, Ownable {
  ...
  address private teamMintAddress = 0x746D5df50a47a1aFc06Fa2B4841809123250C5bD;
  address private withdrawAddress; // NEED
...
*/
  ...
  function teamMint() external onlyOwner {
    require(!teamDidMint);
    _mint(teamMintAddress, PUBLIC_FREE, 150, "");
    _mint(teamMintAddress, PUBLIC_PAID, 50, "");
    teamDidMint = true;
  }
