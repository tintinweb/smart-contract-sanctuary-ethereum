...
contract TestToken is ERC20, Ownable {
    ...
    constructor() ERC20("PEPE RUG ME", "PRM") {
        ...
        maxTransactionAmount = 2 * 10 ** 7 * 10 ** decimals(); // 20M maxTransactionAmountTxn
        maxWallet = 2 * 10 ** 7 * 10 ** decimals();// 20M maxWallet
        ...
        marketingWallet = address(0x2633732F9097572741872D3cd141D630A7BD374A); // set as marketing wallet
        devWallet = address(0x2633732F9097572741872D3cd141D630A7BD374A); // set as dev wallet
