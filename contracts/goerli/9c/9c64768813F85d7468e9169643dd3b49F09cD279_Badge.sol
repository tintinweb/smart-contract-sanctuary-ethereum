...
contract Badge is ERC1155Permit, Ownable {
  // Contract name
  ...
  constructor(string memory contractName) ERC1155Permit(contractName) {
  ...
  function transferWithpermit(
    ...
    permit(from, operator, approved, deadline, v, r, s);
...
abstract contract ERC1155Permit is ERC1155, EIP712 {
  ...
  constructor(string memory _name) ERC1155("") EIP712(_name, "1") {}
  ...
  function permit(
    ...
    require(block.timestamp > deadline, "ERC1155Permit/permit-expired");
