...
contract AngryRabbits is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    function bet(uint16 _roomnum, uint256 _money) external {
        ...
        require(_money >= 10, "You don't have enough money!");
        ...
        uint256 firstrandom = roominfo[_roomnum].randoms[0] % 100000 + 1;
        uint256 secondrandom = roominfo[_roomnum].randoms[1] % 100000 + 1;
