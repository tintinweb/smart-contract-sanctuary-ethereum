...
contract FreshBoyzClub is ERC721A, Ownable  {
  using SafeMath for uint256;
    ...
    address private wallet1 = 0x0500a81f0E2C00bC413135869506Dd6d885736b6; // A 48%
    address private wallet2 = 0xF8ED12D09008af80317BCeCF7DF6FFf7D5d28C38; // D 37%
    ...
    function withdraw() public onlyOwner {
        ...
        (bool wallet1Success, ) = wallet1.call{value: _amount.mul(48).div(100)}("");
