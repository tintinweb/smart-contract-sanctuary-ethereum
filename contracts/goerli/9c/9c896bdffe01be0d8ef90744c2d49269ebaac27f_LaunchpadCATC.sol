 ...
 * @notice This contract handles minting CATC tokens.
 */
contract LaunchpadCATC is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    mapping(address => bool) public msgSenders;
    ...
    constructor() ERC721A("CATC", "CATC213") {
