...
contract Router is Ownable, Pausable, ReentrancyGuard {
     ...
     */
    constructor(address _owner, address _dsq, address _esdsq, address _dsqStaking, address _esdsqStaking) {
     ...
     */
    function harvestDSQStaking() external nonReentrant {
        dsqStaking.getReward(msg.sender, msg.sender);
    }
    ...
    function harvestDSQStakingAndStakeESDSQStaking() external whenNotPaused nonReentrant {
        ...
        esdsqStaking.stake(msg.sender, bal, false);
    }
