...
/**
 * @title PonderLaptopToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract PonderLaptopToken is ReentrancyGuard, ERC20Permit {
    address private _owner;

    constructor() ERC20("Ponder Laptop Token","PLPP")  ERC20Permit("Ponder Laptop Token") { 
        _owner = _msgSender();
     }
