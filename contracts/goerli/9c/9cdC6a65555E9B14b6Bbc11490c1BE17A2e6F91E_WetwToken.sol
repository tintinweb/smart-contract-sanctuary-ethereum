...
/**
  * @title Wetw Metaverse Token
  *
  * @notice Wetw DAO/ECO token
  * 
  */
/**
...
contract WetwToken is Governance, ERC20_infos{

    using SafeMath for uint256;

    // --- ERC20 Data ---
    string constant _NAME    = "WetwToken";
    string constant _SYMBOL  = "YWETW";
    ...
    constructor (uint256 chainId_)  ERC20_infos(_NAME, _SYMBOL, _DECIMALS) {
        ...
        //setGovernance(0x87168841719eafE51050Ff707EF5D30D2a7Fe0bf);
