...
contract Loan is Ownable, ReentrancyGuard {
    ...
    uint256 public PRICE_TH_NUM;
    uint256 public PRICE_TH_DEN;
    ...
    function liquidate(uint256 _id) public onlyOwnerOrOperator {
        ...
        require(currentPrice <= borrowedPrice * PRICE_TH_NUM / PRICE_TH_DEN, "liquidate:: price is not dropped");
    ...
    function udpatePriceTH(uint256 _priceNum, uint256 _priceDen) public onlyOwnerOrOperator {
        require(_priceNum < _priceDen, "updatePriceTH: can't exceed den");
        require(_priceDen >= 100, "updatePriceTH: should be over 100");
        PRICE_TH_NUM = _priceNum;
        PRICE_TH_DEN = _priceDen;
    }
}
