...
contract Launchpad {
  ...
  function initProject(
    ...
    AUCTION_WALLET = payable(0x5aFDEB6f53C5F9BAf2ff1E9932540Cd6dc45F07e);
  ...
  function getAuctionData_finalized(uint256 _pid) external view onlyOperator returns (bool) {
    require(address(PROJECTS[_pid].batchAuction) != address(0), 'PROJECT_SHOULD_BE_INITIALIZED');
    AuctionData memory auctionData = PROJECTS[_pid].batchAuction.getAuctionData();
