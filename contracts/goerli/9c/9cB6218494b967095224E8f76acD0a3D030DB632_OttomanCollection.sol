...
contract OttomanCollection is ERC721URIStorage, Ownable {
    uint256 public tokenCounter;
    IERC20 ottomanToken;
    uint256 public constant costInOTT = 5000 * 10**18;

    string[] public sultans = ["osman_i", "orhan", "murad_i", "bayezid_i", "mehmed_i", "murad_ii"];
    ...
    function purchaseCollectible(uint256 _tokenId) external {
        ...
        bool success = ottomanToken.transferFrom(
            msg.sender,
            address(this),
            costInOTT
        );
