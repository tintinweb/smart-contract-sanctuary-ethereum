 ...
 */
contract GreyMarket is Ownable, ReentrancyGuard, GreyMarketStorage, GreyMarketEvent, EIP712 {
    using SafeERC20 for IERC20;

    constructor(address _proofSigner, address _usdc) EIP712("GreyMarket Contract", "1.0.0") {
