...
contract AFAFAFAF is ERC2981, ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(uint256 _maxSupply, uint256 _amountForDev, address _teamAddress, uint96 royaltyFees) ERC721A("AAAA", "AAAAAAAA"){
     ...
     * @dev Mint for public.
     */
    function mint(bytes32 hash, bytes memory signature) external callerIsUser {
