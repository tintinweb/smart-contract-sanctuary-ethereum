...
contract MyNFT is ERC721, Ownable {
    ...
    uint256 public nftValue = 1 ether;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmWkVtE2PdnYMu4UbV3rsx9q6Zs3MmzVKt3DnXgE7Z2Lr8/";
    }

    function mintNFT()
        public payable isWhitelisted
        returns (uint256)
    {
        require(msg.value >= nftValue, "Must Send At Least NFT Value");
