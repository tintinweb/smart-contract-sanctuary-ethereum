...
contract BoredMooseAssClub is ERC721A, Ownable, ReentrancyGuard, OperatorFilterer {
  ...
  constructor() ERC721A("BoredMooseAssClub", "BMAC") OperatorFilterer(address(0), false) {
