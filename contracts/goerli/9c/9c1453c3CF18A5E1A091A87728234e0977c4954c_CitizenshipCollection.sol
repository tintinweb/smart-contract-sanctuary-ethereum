    ...
    VRFConsumerBaseV2
{
    ...
    //mapping of token owner to identity
    mapping(address => uint256) private _identityPrimary;
    ...
    function setPrimary(uint256 tokenId) external returns (bool successful) {
        ...
        _identityPrimary[msg.sender] = tokenId;
    ...
    function revokePrimary() external returns (bool successful) {
        delete _identityPrimary[msg.sender];
    ...
    function getPrimaryIdentity(address account)
        ...
        returns (uint256)
    {
        return _identityPrimary[account];
    }
    ...
    function _isPrimaryIdentity(address account, uint256 tokenId)
        ...
        returns (bool successful)
    {
        successful = _identityPrimary[account] == tokenId;
    }
}
