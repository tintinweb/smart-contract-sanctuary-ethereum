...
contract FakeCollection/* is ICollection*/
{
    ...
    uint public baseLevel = 0;
    uint public relativeLevel = 0;
    ...
    function setBaseLevel(uint level) public
    {
        baseLevel = level % 5;
    }

    function setRelativeLevel(uint level) public
    {
        relativeLevel = level % 5;
    }
}
