...
contract TestBalancer {
  ...
  function testBalancerSwap(uint256 amount, address assetIn, address assetOut, address recipient, bytes32 poolId) external returns (uint256) {
