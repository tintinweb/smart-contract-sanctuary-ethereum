...
contract Vendor is Ownable {
  ...
  //event Approval(address seller, bool aproved);
  // event Approval(address indexed owner, address indexed spender, uint256 value);
...
mapping(address => bool) public allowed;
  ...
  function approve(address seller) public returns (bool) {
    allowed[seller] = true;
    return true;
}
  ...
  function sellTokens(uint256 amountToSell)public payable{
    uint256 tokensToSell = amountToSell;
    uint256 value = amountToSell / tokensPerEth;
