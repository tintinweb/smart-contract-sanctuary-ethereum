...
contract CoCreateLaunch is ICoCreateLaunch, Initializable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  function getComponentName(Component component) public pure override returns (string memory) {
    if (component == Component.Governor) {
      return "Governor";
    } else if (component == Component.GovernanceExecution) {
      return "GovernanceExecution";
    } else if (component == Component.Staking) {
      return "Staking";
    } else if (component == Component.ProjectToken) {
      return "ProjectToken";
    } else if (component == Component.TokenClaim) {
      return "TokenClaim";
    } else if (component == Component.NFTCollectorRewards) {
      return "NFTCollectorRewards";
    } else if (component == Component.RevenueManager) {
      return "RevenueManager";
    } else if (component == Component.Treasury) {
      return "Treasury";
    } else if (component == Component.VestingWallet) {
      return "VestingWallet";
    } else if (component == Component.Raffle) {
      return "Raffle";
    }
    return "";
  }
