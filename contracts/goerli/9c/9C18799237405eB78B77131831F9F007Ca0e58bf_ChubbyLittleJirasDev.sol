...
contract ChubbyLittleJirasDev is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor () ERC721A("Chubby Little Jiras", "CLJ") {
        _safeMint(0xEd55a54d1259C381D380E1E66Cd0C144db570c31, 50);
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return string(abi.encodePacked("https://chubbylittlejiras.io/metadata_dev/", tokenId.toString(), ".json"));
    }   
