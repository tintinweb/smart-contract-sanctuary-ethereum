...
contract nftdeployer is ERC721A, Ownable{
    ...
    modifier callerIsUser() {
        require(tx.origin == msg.sender, "NFT NAME :: Cannot be called by a contract");
        _;
    }
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "Already minted 100 times!");
