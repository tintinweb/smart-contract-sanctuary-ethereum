...
/**
 * @title TestRandomNumber contract
 */
...
contract TestRandomNumber4 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("RandomTest4", "RT"){}
  ...
  function openMint(uint256 amt) external onlyOwner
  {
    ...
    function tellWinner() external onlyOwner {
        Winner =  uint(keccak256(abi.encodePacked(block.timestamp,block.difficulty,  
        msg.sender))) % 555;
    }
