 ...
 * @notice
 */
contract Character is ICharacter, ERC721, MinterManaged {
    uint256 public totalSupply;
    string public baseURI;

    mapping(address => uint256) private _minted; // tokens minted by the wallet
    mapping(uint256 => address) private _burned; // token burned by the wallet
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(MinterManaged, ERC721, ICharacter)
        returns (bool)
    {
    ...
    /**
     * @notice Who burned specific token?
     * @return address of the burner
     */
    function getBurner(uint256 tokenId) public view returns (address) {
