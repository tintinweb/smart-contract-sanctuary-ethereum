...
contract KeenSight is ERC721, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("KeenSight", "KSC") {
    ...
    function preMint( uint256  _mintAmount) public payable preMintCompliance(_mintAmount) nonReentrant {
        require(!(sponsorFor[msg.sender] == 0x0000000000000000000000000000000000000000), "You are not on the list");
