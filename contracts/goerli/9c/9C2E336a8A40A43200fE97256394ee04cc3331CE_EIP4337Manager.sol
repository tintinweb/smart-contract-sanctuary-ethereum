...
contract EIP4337Manager is GnosisSafe, IWallet {
    ...
    function setupEIP4337(
        ...
        require(_friendsThreshold <= _friends.length, "Number of friends can't be less than threshold");
        
        //social recovery module will not be added if threshold is less than 2
