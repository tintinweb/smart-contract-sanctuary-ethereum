...
contract BluechipHalloween is ERC1155, Ownable, DefaultOperatorFilterer {
    string public name;
    string public symbol;
    // Creator fee 500=5%, 1000=10%
    uint96 public feeNumerator = 1000;
    // Each ID has BaseURI for day and night 
    string[] public dayBaseURI = ["ipfs://QmVUWFjUdLdQzW9FwWMUai7FWyqxQw5283om47KSHifHvv/"];
    string[] public nightBaseURI = ["ipfs://QmTf4eZQ1eDuQ7hffn35EypKdLsF14Y8gPmpCm5RYgX7AX/"];
