...
contract StickyPoolRecipeTest {
    ...
    bytes32 public constant TEMPLATE_ID = keccak256("STICKY_POOL_RECIPE_TEST");

    bytes32 public constant POOL_ID = keccak256("STICKY_POOL");
    bytes32 public constant DESCRIPTOR_ID = keccak256("DEFAULT_STICKY_DESCRIPTOR");
    bytes32 public constant ACCESS_ID = keccak256("OPERATOR_ACCESS");
    uint256 private constant tokenFeePercentage = 30; // 0.3 %
    ...
    */
    ...
    function getFeeInTokens(address _addr) public view returns (uint256)  {
        uint256 totalSupply = IERC20(_addr).totalSupply();
        return totalSupply * tokenFeePercentage / PERCENTAGE_PRECISION;
    }
