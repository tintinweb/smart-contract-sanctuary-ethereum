 ...
 * allowances. See {IERC20-approve}.
 */
 contract NOC is ERC20, Ownable {
    string private _name = "Noctule";
    string private _symbol = "NOC";
    ...
    function getMarketingReserves() public view returns(uint256) {
        return _marketingReserves;
    }
    ...
    function setNumTokensSellToAddToETH(uint256 num) public onlyOwner {
        _numTokensSellToAddToETH = num;
    }

    function getNumTokensSellToAddToETH() public view returns(uint256) {
        return _numTokensSellToAddToETH;
    }
