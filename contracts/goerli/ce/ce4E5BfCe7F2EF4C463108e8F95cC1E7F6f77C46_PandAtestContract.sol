...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xBB10Ae600d06eDBfE0383F62e936dA96A428cDb3];
  address public erc20Payable = 0xBB10Ae600d06eDBfE0383F62e936dA96A428cDb3;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.001 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiekyeczkmbnetjztj5vtt3cy3ppkigo7zgasyhfwisrfbqhxnbe2u/";
...
// File: contracts/PandAtestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PandAtestContract is RamppERC721A {
    constructor() RamppERC721A("PANDAtest", "PDA"){}
}
