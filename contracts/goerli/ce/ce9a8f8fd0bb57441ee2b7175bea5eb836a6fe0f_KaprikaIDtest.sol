...
contract KaprikaIDtest is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable, EIP712, ERC721Votes {
    ...
    ) ERC721("KaprikaIDtest1", "KIDt") EIP712("KaprikaIDtest", "1") {

    }

    function safeMint(address to, string memory uri) public payable  {
        uint256 tokenId = _tokenIdCounter.current();
        require(addresCanMint(to), 'Oops! address alredy have Kaprika ID');
    ...
    function addresCanMint(address _address) public view returns (bool) {
