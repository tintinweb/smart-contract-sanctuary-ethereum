...
contract mining{
    ...
    ERC20 token = ERC20(0x4038635E3B78d3a2A863763740bce842272EeB83);
    ERC721 my_nft = ERC721(0xE5311Fd5feC1f84F309E345cdF3700FEB7487376);

    mapping( uint256 => uint256) last_block;
    
    function sume_mint(uint256 nft_id) public{
        if(my_nft.ownerOf( nft_id ) == msg.sender ){
            ...
            if(last_block[nft_id] == 0){
                ...
                uint256 amount = 20*(block.number) - last_block[nft_id];
                last_block[nft_id] = block.number;
