    ...
    ERC165
{
    ...
    mapping(address => mapping(address => uint256)) private _requiredAllowance;
    ...
    function pendingBuys(
        address addr
    ) external view anyAdmin returns (uint256) {
    ...
    function _completeSwap(uint256 swapNumber_) private {
        ...
        require(
            _restrictedTokenBalanceBefore + swap.restrictedTokenAmount ==
                _restrictedTokenBalanceAfter,
