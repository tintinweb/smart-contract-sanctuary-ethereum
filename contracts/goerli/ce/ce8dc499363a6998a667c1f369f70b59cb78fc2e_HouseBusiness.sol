...
contract HouseBusiness is ERC721, ERC721URIStorage {
    ...
    function buyHouseNft(uint tokenId) public payable {
        ...
        address payable company = payable(address(this));
        // send token's worth of ethers to the owner
        sendTo.transfer(house.price*9200/10000);
        creator.transfer(house.price*600/10000);
        company.transfer(house.price*200/10000);
    ...
    // Royalty
    function getRoyalty() public view returns(uint) { return royalty; }

    function setRoyalty(uint _royalty) public { onlyMember(); royalty = _royalty; }
}