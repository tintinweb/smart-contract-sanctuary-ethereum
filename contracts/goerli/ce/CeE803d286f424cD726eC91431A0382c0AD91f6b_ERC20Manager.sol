...
contract ERC20Manager is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(IToken _erc20Token) ERC20("ERC20Manager", "ERC20MGR") {
    ...
    function claim(
        ...
        require(
            ...
            "You have already claimed your available rewards."
        );

        erc20Token.mint(address(this), _amount);
        erc20Token.transfer(_msgSender(), _amount);
