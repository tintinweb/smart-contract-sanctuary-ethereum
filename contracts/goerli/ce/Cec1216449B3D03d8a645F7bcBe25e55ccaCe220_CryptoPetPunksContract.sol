...
//   / ____/______  ______  / /_____     / __ \___  / /_/ __ \__  ______  / /_______
//  / /   / ___/ / / / __ \/ __/ __ \   / /_/ / _ \/ __/ /_/ / / / / __ \/ //_/ ___/
// / /___/ /  / /_/ / /_/ / /_/ /_/ /  / ____/  __/ /_/ ____/ /_/ / / / / ,< (__  ) 
// \____/_/   \__, / .___/\__/\____/  /_/    \___/\__/_/    \__,_/_/ /_/_/|_/____/  
//           /____/_/                                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xf894F0629C63d6a44Ab7769d03cc3835eca43104];
  address public erc20Payable = 0xf894F0629C63d6a44Ab7769d03cc3835eca43104;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 48) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeid5nfvdniqfnd2qzqvehi7tajpveyy73rfd3dz235q7r443a6hr3y/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gnVuVBIFvS6FTlOLGSSu/contract-metadata";
  }
...
// File: contracts/CryptoPetPunksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoPetPunksContract is RamppERC721A {
    constructor() RamppERC721A("Crypto PetPunks", "PetPunks"){}
}
