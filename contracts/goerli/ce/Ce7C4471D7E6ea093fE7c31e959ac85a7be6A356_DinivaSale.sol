    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        tokenAddress = 0x537F220005777CCC96F62414CdE20C3b2bE40106;
        dotsToken = IERC20(0x6660E482CD59E6a86bAf7807D0ad8f03c38224d5);
        lastDistributionTime = 1676678400;
        referrals = [500, 500, 300, 200, 100, 100, 100, 100, 100, 50];
        minAmount = 55 ether;
    ...
    function payReferral(
        ...
        if (_index >= referrals.length) {
            ...
            if (userReferral[_userAddress] != address(0)) {
                ...
                setReferralIncome(userReferral[_userAddress], transferAmount);
                // }
