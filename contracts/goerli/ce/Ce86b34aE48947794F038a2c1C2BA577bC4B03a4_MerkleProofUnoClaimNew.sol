...
contract MerkleProofUnoClaimNew is Ownable, ReentrancyGuard {
    ...
    mapping(address => UserInfo) public newUserInfo;
    ...
    function userInfo(address _account) public view returns (UserInfo memory) {
        ...
        actualInfo.claimed = newUserInfo[_account].claimed;
    ...
    function airdropUNO(
        ...
        require(!newUserInfo[_account].claimed, "UnoRe: Claimed already.");
        ...
        newUserInfo[_account].claimed = true;
