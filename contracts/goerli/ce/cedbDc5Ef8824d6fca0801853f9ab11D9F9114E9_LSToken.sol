...
// File contracts/token/LSToken.sol
...
contract LSToken is ERC20 {
  ...
  function mint() external {
    ...
    uint256 projectAmount = (projectShare * mintAmount * 1e18) / TOTALSHARE;
  ...
  function recordForWhiteList(uint256 _mintAmount, address _receiver) external onlyFund {
    require(!fund.checkProjectCompleted(tokenProjectId), "project has been completed");
