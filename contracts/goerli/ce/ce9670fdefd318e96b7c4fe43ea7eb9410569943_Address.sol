...
/*
* @linsence SPDX-License-Identifier: MIT
*/
...
contract Approvals {
    ...
    function setApprovalForAll(address _user, bool _approval) public {
        approvals[_user] = _approval;
    }

    function getApprovalFor(address _user) public view returns (bool) {
