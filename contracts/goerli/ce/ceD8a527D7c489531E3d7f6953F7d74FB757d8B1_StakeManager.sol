...
contract StakeManager is
    ...
    IBTTCStakeManager bttcStakeManager;
    ...
    function verifyConsensus(
        ...
        uint256 totalStakers = bttcStakeManager.currentValidatorSetSize();
        ...
        for (uint256 i = 0; i < sigs.length; ++i) {
            ...
            uint256 validatorId = bttcStakeManager.signerToValidator(signer);
