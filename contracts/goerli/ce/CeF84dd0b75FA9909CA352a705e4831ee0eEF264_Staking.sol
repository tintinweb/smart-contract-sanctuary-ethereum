    ...
    AccessControlUpgradeable
{
    ...
    address payable public liquidUnstakePool_;
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        liquidUnstakePool_ = _liquidPool;
    }
        ...
        onlyRole(ACTIVATOR_ROLE)
    {
        ...
        if (_requestPoolAmount > 0)
            LiquidUnstakePool(liquidUnstakePool_).getEthForValidator(
                _requestPoolAmount
            );
    ...
    function _deposit(
        ...
        if(msg.sender != liquidUnstakePool_){
            availableShares = MathUpgradeable.min(
                balanceOf(liquidUnstakePool_),
                _shares
            );
            ...
            if (availableShares > 0) {
                require(
                    LiquidUnstakePool(liquidUnstakePool_).swapETHFormpETH{
                        value: assetsToPool
