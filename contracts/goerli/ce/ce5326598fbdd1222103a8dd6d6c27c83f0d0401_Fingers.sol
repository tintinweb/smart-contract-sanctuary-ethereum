...
contract Fingers is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Hole";
    string private constant _symbol = unicode"GUT";
