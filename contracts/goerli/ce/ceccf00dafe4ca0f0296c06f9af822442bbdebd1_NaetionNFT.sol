...
contract NaetionNFT is ERC721A, Ownable {
    ...
    uint256 public price_Public = 0.1 ether;
    uint256 public price_WL = 0.1 ether;
    ...
    function switch_WL() public onlyOwner {
        status_WL = !status_WL;
    }
    function switch_Public() public onlyOwner {
        status_Public = !status_Public;
    }
    function switch_Freemint() public onlyOwner {
        status_Freemint = !status_Freemint;
    }
    ...
    bytes32 public merkleRoot_WL = 0x6dda27bb24289cd482fe990e245166cbe0ee289047013366bf025558e08fc9ce;
    bytes32 public merkleRoot_Free = 0x6dda27bb24289cd482fe990e245166cbe0ee289047013366bf025558e08fc9ce;
    ...
    function mint_WL(uint256 quantity, bytes32[] calldata merkleproof) public payable {
        ...
        require(totalSupply().add(quantity) <= collectionSize - reserve, "Mint exceeds Collection size!!");
    ...
    function mint_Public(uint256 quantity) public payable {
        require(status_Public, "Whitelist Minting not active!!");
        require(numberMinted(msg.sender).add(quantity) <= mint_perAdd && quantity > 0, "Invalid mint quantity!!");
