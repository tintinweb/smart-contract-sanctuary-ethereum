...
abstract contract APPcore is  Ownable{
    ...
    address public constant withdrawAddress = 0x6277A815CB471ec4FDf84C599D8293DB7BbFF437;
    ...
    string public baseURI = "https://nft.aopanda.ainy-llc.com/testapp0928/metadata/";
...
contract APP is APPadmin {
    ...
    constructor() ERC721A('Test Panda 1002', 'TST') {
    ...
    function _beforeTokenTransfers(
        ...
        for(uint256 i = 0; i < rewardaddress.length; i++){
            if(from == rewardaddress[i]){
                ...
                //test 10/3 20:00
                require(block.timestamp > 1664794800,"Transfer is not possible during lockup.");
            }
        }
    }
