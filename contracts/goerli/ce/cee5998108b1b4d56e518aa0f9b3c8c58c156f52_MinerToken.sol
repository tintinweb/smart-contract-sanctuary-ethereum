...
contract MinerToken is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    event Pause (address index, uint256 time);
    event UnPause(address index, uint256 time);
    event Tax(address index ,  uint256 tax);
    event Burn(address burn , uint256 amount);
