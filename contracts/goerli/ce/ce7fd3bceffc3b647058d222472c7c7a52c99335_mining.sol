...
contract mining{
    ...
    ERC20 token = ERC20(0x0336FAB1badf3548fD6A3FC35435DcF462a131E5);
    ERC721 my_nft = ERC721(0xaF79627c93abd530B90DBDC117E4be79f35BDDC6);

    mapping ( uint256 => uint256 ) last_block;

    function mining_class(uint256 nft_id) public {
