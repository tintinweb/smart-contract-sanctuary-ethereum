...
contract DEX {
     ...
     */
    event EthToTokenSwap(address sender, string message, uint256 value, uint256 tokenOutput);
    /**
     ...
     *
     */
    function getLiquidity(address lp) public view returns (uint256) { return liquidity[lp];}
