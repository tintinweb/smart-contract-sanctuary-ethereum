...
// @@@@@@@@@@@@@@@@@@@@@&[email protected]@@@@@@@&PPPPPPPPPPPPJ????[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@&&&&&&Y?????B&&&@@@@@@@@@&&&PPPPP5J???777775&&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
...
contract OCASnake is Ownable, ERC721A, ERC2981, ReentrancyGuard, OCASnakeArt {
    ...
    function compareArrayCreation(uint256 index, uint256 seed)
        public
        view
        returns (uint256[4] memory)
    {
        ...
        for (uint256 i = 0; i < 4; i++) {
            ...
            result[i] = snakeNameIndexCompare * adjectiveIndexCompare;
        }
    ...
    function recursiveNameFind(
        ...
        uint256[4] memory compareArray = compareArrayCreation(index, seed);
