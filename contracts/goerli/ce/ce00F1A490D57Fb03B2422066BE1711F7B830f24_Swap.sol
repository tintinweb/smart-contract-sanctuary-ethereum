...
contract Swap is ZetaInteractor, ZetaReceiver, Pausable, ISwap {
            ...
            ZetaInterfaces.SendInput({
                ...
                message: abi.encode(
                    XcMessage({
                        ...
                        secondLegZetaAmount: args.secondLegZetaAmount
                    })
                ),
        ...
        isValidMessageCall(zetaMessage)
    {
        ...
        // TODO: Slippage allowance - Update secondLegCalldata with actual ZETA amount from firstLeg trade
        if (zetaMessage.zetaValue < xcMessage.secondLegZetaAmount)
