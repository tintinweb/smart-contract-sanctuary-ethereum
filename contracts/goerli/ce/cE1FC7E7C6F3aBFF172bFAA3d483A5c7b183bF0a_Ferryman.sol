...
contract Ferryman is ERC721Enumerable, Ownable, DefaultOperatorFilterer, PaymentSplitter {
    ...
    constructor(string memory newBaseURI, string memory newSuffix, address[] memory _team, uint[] memory _teamShares)
        ERC721("Ferryman", "Ferryman") PaymentSplitter(_team, _teamShares)
    {
