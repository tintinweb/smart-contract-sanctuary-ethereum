...
contract GVKPayment is Ownable,ReentrancyGuard{
    ...
    constructor( address payable _withdrawAddress, address _gvkContract){
        ...
        //when SaleTime start
        salesStartTime = 1668534575;
        preSaleDuration = 30 minutes;
    ...
    function purchasePreSale(
        ...
        // require(preSaleWalletLimit <= balancePerWallet[msg.sender].add(_tokenId.length), "PreSale: Sale Limit exceeded ");
