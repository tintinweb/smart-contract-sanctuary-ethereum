...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    uint256 private s_entranceFeeInUsd;
    ...
    /*Functions */
    constructor(
        address vrfCoordinatorV2, // address of the Coordinator that makes the random number verification.
        address priceFeed,
    ...
    function setEntranceFee(uint256 _entranceFee) public onlyOwner {
        s_entranceFeeInUsd = _entranceFee * 10 ** 18;
    }

    function enterRaffle() public payable {
        require(
            msg.value.getConversionRate(i_priceFeed) >= s_entranceFeeInUsd,
            "Raffle: Entrance fee too low."
        );
