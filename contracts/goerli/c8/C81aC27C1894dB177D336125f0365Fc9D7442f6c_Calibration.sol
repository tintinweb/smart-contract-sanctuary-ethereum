...
contract Access {
    ...
    address public manager = 0x4f20ce2E3670c467408dc3f2194f1D1DF156541c; 
  ...
  modifier CalibVendMan(){
    ...
    function changeAddressC1(address c1) public onlyManager returns(bool) {
     ...
     function changeAddressC2(address c2) public onlyManager returns(bool) {
        calibTech2 = c2;
        return true;
    }
     function changeAddressC3(address c3) public onlyManager returns(bool) {
        calibTech3 = c3;
        return true;
    }
     function changeAddressC4(address c4) public onlyManager returns(bool) {
        calibTech4 = c4;
        return true;
    }
     function changeAddressC5(address c5) public onlyManager returns(bool) {
        calibTech5 = c5;
        return true;
    }
     function changeAddressV1(address v1) public onlyManager returns(bool) {
        vendor1 = v1;
        return true;
    }
     function changeAddressV2(address v2) public onlyManager returns(bool) {
        vendor2 = v2;
        return true;
    }
     function changeAddressV3(address v3) public onlyManager returns(bool) {
        vendor3 = v3;
        return true;
    }
    ...
    function changeManager(address _manager) public onlyManager returns(bool) {
     ...
     function changeAddressC6(address c6) public onlyManager returns(bool) {
     ...
     function changeAddressC7(address c7) public onlyManager returns(bool) {
       if(calibTech7!= address(0)){
        calibTech7 = c7;
        return true;
         }
          else{
     ...
     function changeAddressC8(address c8) public onlyManager returns(bool) {
        if(calibTech8!= address(0)){
            calibTech8 = c8;
            return true;
         }
         else{
     ...
     function changeAddressC9(address c9) public onlyManager returns(bool) {
        if(calibTech9!= address(0)){
        calibTech9 = c9;
        return true;
         }
          else{
     ...
     function changeAddressC10(address c10) public onlyManager returns(bool) {
        if(calibTech10!= address(0)){
        calibTech10 = c10;
        return true;
         }
          else{
    ...
    function changeAddressV4(address v4) public onlyManager returns(bool) {
     ...
     function changeAddressV5(address v5) public onlyManager returns(bool) {
        if(vendor5!= address(0)){
            vendor5 = v5;
            return true;
         }
          else{
     ...
     function changeAddressV6(address v6) public onlyManager returns(bool) {
        if(vendor6!= address(0)){
        vendor6 = v6;
        return true;
         }
          else{
...
contract Database is Access{
    ...
    approvTmde [] internal ApprovTmde ;
...
contract Calibration is Access, Database{
    ...
    function CalibrationFailed(uint256 _assetTag, uint256 _invoice, uint256 _costToService) public onlyVendor{
        ...
        RejecTmde.push(rejecTmde(true,_assetTag, _invoice, _costToService));
    ...
    function ApproveInvoice(uint256 _assetTag, uint256 invoice) public payable onlyManager{
        ...
        ApprovTmde.push(approvTmde(_assetTag, invoice));
    ...
    function alertMang() public view onlyManager returns(rejecTmde[] memory){
        return RejecTmde;
    }

    function alertVend() public view onlyVendor returns(approvTmde[] memory){
        return ApprovTmde;
    }
