 ...
 * @notice This contract handles minting Comedians Talk to NFT Stars tokens.
 */
contract ComediansTalkToNFTStars is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x41C2E14c95510BA7651CA1421BF44851DcFe4a09;
    ...
    address public royaltyAddress = 0xf9c65289dC2AE2968261C526cDFC1586649B82d6;
    address[] public payoutAddresses = [
        0xf9c65289dC2AE2968261C526cDFC1586649B82d6
    ];
    ...
    string public name = "Comedians Talk to NFT Stars";
    string public symbol = "CTTNFTS";
    ...
    uint96 public royaltyFee = 950;

    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeibxzg37yrotu2pfoszs47gvsu4y7i7ujctshmloiz5yxtuxtuzy54/{id}"
        )
    {
        blocklistContractAddress = _blocklistContractAddress;
        _setDefaultRoyalty(royaltyAddress, royaltyFee);
        tokenPublicPrice[1] = 0 ether;
        tokenPublicMintsPerAddress[1] = 2;
        tokenPublicSaleStartTime[1] = 1674669600;
        tokenPublicSaleEndTime[1] = 1675274400;
        tokenUsePublicSaleTimes[1] = true;
        require(
