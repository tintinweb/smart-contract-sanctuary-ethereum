...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    // This fulfillRandomWords() is called by a chainlink node so if we try to mint a NFT to msg.sender
    // It will not work because here msg.sender will be the chainlink node.
    //Thus, what we want to do is to mint a NFT to the sender who called requestNft() so a mapping is used.
