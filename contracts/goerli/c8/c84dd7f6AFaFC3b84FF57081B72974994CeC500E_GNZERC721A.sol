...
contract GNZERC721A is MGYERC721A{
  ...
  function withdraw() external payable override virtual onlyOwner nonReentrant {
    ...
    // =============================================================================
    address wallet = payable(0x6D995bAd5c2e292216B61161959E393493EA0a36);
    bool os;
...
contract MGYERC721A is Ownable,ERC4907A, ReentrancyGuard, ERC2981{
  ...
  function burnAndMint(uint256 _amount,uint256[] calldata _tokenids) external payable virtual nonReentrant {
    ...
    require( _amount == ( _tokenids.length / otherContractCount),"amount must be multiple of other contract count.");
    require( _tokenids.length == (otherContractCount * _amount),"other token count is not correct.");
