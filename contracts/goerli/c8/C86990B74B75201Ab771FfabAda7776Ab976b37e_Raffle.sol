...
//Pick a randim winner (verifiable random)
//Winner to be selected every x minutes --> completely automated
//Chainlink oracle-> Randmness, Automated execution(chainlink keepers)
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        s_raffleState = RaffleState(0); // RaffleState.OPEN
    ...
    function performUpkeep(
        ...
        //Once we get it, we do somethimg with it
        //Chainlink VRF is a 2 transaction process
        //if it is one transaction they can simulate call this transaction
        //fullfillransomwords is  the function that chainlink node calls
