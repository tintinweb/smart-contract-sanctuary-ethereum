...
contract Koalas is ERC721Enumerable, Ownable {
    ...
    uint256 public maxKoalaSupply = 5051; //Actial Max Supply is 5050
    uint256 public constant maxKoalaPerMint = 11; //Actual Max Mint Amount is 10
    ...
    function setMaxKoalas(uint256 _maxKoalaAmount) public onlyOwner {
        maxKoalaSupply = _maxKoalaAmount;
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        uint256 totalSupply = _owners.length;
        require(publicMint, "Public Minting is not currently available");
        require(
            _mintAmount < maxKoalaPerMint,
            "max mint amount per Mint exceeded"
        );
        require(
            totalSupply + _mintAmount < maxKoalaSupply,
            "Sorry, This would exceed maximum Koala mints"
        );
        require(msg.value == cost * _mintAmount, "Wrong amount of Ether sent");
    ...
    function withdraw() public payable onlyOwner {
        ...
        require(success, "No funds have been withdrawn");
    }
