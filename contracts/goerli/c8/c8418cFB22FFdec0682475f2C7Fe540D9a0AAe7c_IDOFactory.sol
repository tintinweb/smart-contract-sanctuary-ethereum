...
contract IDOFactory is Ownable {
    ...
    function createIDO(
        ...
        uint256 transferAmount = getTokenAmount(_finInfo.hardCap, _finInfo.tokenPrice, tokenDecimals) + getTokenAmount(_finInfo.hardCap * _finInfo.lpInterestRate / 100, _finInfo.listingPrice, tokenDecimals);
    ...
    function getTokenAmount(uint256 ethAmount, uint256 oneTokenInWei, uint8 decimals)
        ...
        returns (uint256)
    {
        return ethAmount.div(oneTokenInWei).mul(10**decimals);
    }
