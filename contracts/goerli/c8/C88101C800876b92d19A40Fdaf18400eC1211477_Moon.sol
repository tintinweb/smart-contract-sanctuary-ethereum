    ...
    DefaultOperatorFilterer
{
    ...
    uint private constant tokensReserved = 20;
    bool public isMinting = true;
    bool public canUpdateSeed = true;

    IDescriptor public descriptor;

    constructor(IDescriptor newDescriptor) ERC721("MOON", "moon")
    {
    ...
    function setDescriptor(IDescriptor newDescriptor) external onlyOwner {
        descriptor = newDescriptor;
    }
