 ...
 * @notice This contract handles minting Test Contract tokens.
 */
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xfA7C6407942107F84FDB4eD6f22acF8199b40988;
    ...
    uint256[] public payoutBasisPoints = [7565, 2435];
    ...
    {
        require(
            _newPresaleMaxSupply < presaleMaxSupply,
    ...
    function presaleMint(
        ...
        require(
            totalSupply() + numTokens <= presaleMaxSupply,
            "MAX_SUPPLY_EXCEEDED"
        );
        ...
        if (totalSupply() >= presaleMaxSupply) {
