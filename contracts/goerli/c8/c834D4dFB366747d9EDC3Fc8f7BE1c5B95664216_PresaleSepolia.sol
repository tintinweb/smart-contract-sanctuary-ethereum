...
// File: contracts/goerliPresale.sol
...
contract PresaleSepolia is ReentrancyGuard, Ownable, Pausable {
    ...
    IERC20 public token;
    IERC20 public USDC = IERC20(0x65aFADD39029741B3b8f0756952C74678c9cEC93);  // USDT Goerli Address
    IERC20 public WETH = IERC20(0xCCB14936C2E000ED8393A571D15A2672537838Ad);  // WETH Goerli Address
    ...
    function buyTokensWithUSDC(uint256 _amount) external nonReentrant {
        ...
        USDC.safeTransferFrom(msg.sender, ownerAddress, _amount);  // USDC transferred to the deployer
