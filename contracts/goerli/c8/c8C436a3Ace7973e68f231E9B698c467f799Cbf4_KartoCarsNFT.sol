...
contract KartoCarsNFT is ERC721A, Ownable, VRFConsumerBaseV2 {
    ...
    uint256 public SALE_ROUND_SUPPLY; // Allows the changing of totalSupply minters can mint per sale round. 
    ...
    constructor(
      ...
      VRFConsumerBaseV2(0x271682DEB8C4E0901D1a1550aD2e64D568E69909) { 
        ...
        SALE_ROUND_SUPPLY = _saleRoundMax; 
    ...
    function processMint(uint256 _quantity) internal {
      ...
      require(totalSupply() + _quantity <= SALE_ROUND_SUPPLY, "Current Sale is Sold out"); 
      _mint(msg.sender, _quantity);
    }

    // ~~~~~~~~~~~~~~~~~~ Whitelist Sale Function ~~~~~~~~~~~~~~~~~~
    function whitelistMint(uint256 _mintAmount, uint8 _maxAllowed, bytes32[] memory _proof) external payable callerIsUser {
      require(saleStatus == SaleStatus.WHITELIST, "WL SALE NOT ACTIVE");
      bytes32 leaf = keccak256(abi.encodePacked(msg.sender, _maxAllowed)); 
      require(MerkleProof.verify(_proof, whitelistMerkleRoot, leaf),"INVALID PROOF");
      require(_mintAmount <= wlPerWallet, "SURPASSED WL TX LIMIT"); 
      require(_mintAmount + wlMintedAmt[msg.sender] <= wlPerWallet , "MAX WL MINTED");
      wlMintedAmt[msg.sender]+= _mintAmount; 

      processMint(_mintAmount);
    }
  ...
  function airDrop(
    ...
    require(totalSupply() + _quantity <= MAX_KC);
    ...
    function changeSaleRoundMax(uint256 _saleRoundMax) public onlyOwner {
      SALE_ROUND_SUPPLY = _saleRoundMax; 
    }
