...
contract Testes {
    ...
    function getCadernoCampoByPublicKey(address adr, string memory property_name, uint256 number) external  view returns(CadernoCampo memory) {
        return cadernoCampo_[adr][property_name][number];
    }
