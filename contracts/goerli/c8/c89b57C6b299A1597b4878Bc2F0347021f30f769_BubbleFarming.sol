...
contract BubbleFarming is Ownable {
    ...
    IPair public pair = IPair(0x58771330C569b3534e8A4bfdca43D21c8A2AEEf0);
    ...
    function stake(uint256 _amount, uint256 _planIndex) public {
        ...
        userStake.reward = calculateReward(userStake.tokenAmount, _planIndex);
    ...
    function calculateReward(uint256 _amount, uint256 _planIndex)
        public
        view
        returns (uint256 _reward)
    {
        ...
        _reward =
            (_amount *
                poolInfo.poolRewrad *
                poolInfo.poolDuration *
                poolInfo.rewardMultiplier) /
            percentDivider;
    }
