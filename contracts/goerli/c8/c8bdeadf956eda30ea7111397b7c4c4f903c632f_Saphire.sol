 ...
 function internalMint(uint256 _teamAmount) external onlyOwner  {
  ...
  function withdraw() public onlyOwner nonReentrant {
      uint256 balance = address(this).balance;
        (bool c1, ) = payable(0xD55467459c886e3ef58c562A15162F5e130C5D6E).call{value: balance * 15 / 100}('');
        require(c1);
        (bool c2, ) = payable(msg.sender).call{value: balance * 85 / 100}('');
        require(c2);
    }
