...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    bytes32 private constant TIER_2_MERKLE_ROOT = 0xd3fed5e9b318c5709fa089f34dab11e8a3fb028e4d98eeefca99a644298132c2;
    ...
    uint[][15] private tiers;
    string[] private layerNames = [unicode"Eye extra", unicode"Clothes three", unicode"Clothes two", unicode"Outfit", unicode"Jewellery", unicode"Hair", unicode"eyebrows", unicode"Eye Color", unicode"lips", unicode"nose", unicode"facial features", unicode"face", unicode"body", unicode"long hair", unicode"Background"];
    bool private shouldWrapSVG = true;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0xd3fed5e9b318c5709fa089f34dab11e8a3fb028e4d98eeefca99a644298132c2;
    ...
    ContractData public contractData = ContractData(unicode"WONC V2", unicode"yadda yadd", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/7cb8f082-62ab-4cf2-9178-2944c0812f76", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/7cb8f082-62ab-4cf2-9178-2944c0812f76", "", 700, "0x7CE5C931BEeA68A6Bba6551fF5d993C86fA121C5");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"WONC V2", unicode"WONC") {
        tiers[0] = [439,412,386,361,336,325,310,277,271,250,206,200,200,194,150,150,139,100,100,80,64,29,15,1,1,1,1,1,1];
        tiers[1] = [599,550,500,428,400,400,300,300,250,222,201,200,200,200,200,50,0,0,0,0,0,0];
        tiers[2] = [556,538,533,521,493,475,372,300,300,200,200,180,140,140,50,2,0,0,0,0,0,0];
        tiers[3] = [565,553,507,492,480,429,400,350,273,250,205,200,101,75,64,50,1,1,1,1,1,1];
        tiers[4] = [800,800,700,700,700,600,200,200,200,100,0,0,0,0,0,0];
        tiers[5] = [399,399,399,399,399,399,399,399,399,398,398,144,141,99,69,49,44,35,21,11,0,0,0,0,0,0,0];
        tiers[6] = [940,940,940,940,940,300,0,0,0,0,0,0];
        tiers[7] = [1800,1799,1401,0,0,0,0,0,0];
        tiers[8] = [956,750,700,637,600,556,400,300,101,0,0,0,0,0,0];
        tiers[9] = [940,940,940,940,940,300,0,0,0,0,0,0];
        tiers[10] = [809,650,635,630,600,500,330,300,185,100,90,90,50,31,0,0,0,0,0,0];
        tiers[11] = [939,939,939,939,938,300,1,1,1,1,1,1];
        tiers[12] = [940,940,940,940,939,301,0,0,0,0,0,0];
        tiers[13] = [758,749,609,576,433,226,223,221,173,136,127,111,107,104,99,88,80,74,52,42,12,0,0,0,0,0,0,0];
        tiers[14] = [1976,1967,567,368,122,0,0,0,0,0,0];
