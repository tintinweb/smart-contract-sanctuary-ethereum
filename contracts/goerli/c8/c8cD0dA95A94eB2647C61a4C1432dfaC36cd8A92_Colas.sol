...
contract Colas is Ownable, ReentrancyGuard {
    ...
    mapping(address => ReservaDeCompra) public reservasPorOwnerCompradas;
    ...
    function cancelarReserva(uint _id) public payable onlyOwner {
        require(_id > 0 && _id <= numeroReservas, "La reserva no existe");
        require(msg.sender == owner(), "Solo el owner del contrato puede cancelarla");
    ...
    function comprarReserva(
        ...
        reservasPorId[_id].propietario.transfer(reservasPorId[_id].precioVenta);
        reservasPorId[_id].propietario = payable(msg.sender);
        ...
        reservasPorOwnerCompradas[payable(msg.sender)] = 
        ReservaDeCompra(
            _id,             
            reservasPorId[_id].precioVenta, 
            payable(msg.sender), 
