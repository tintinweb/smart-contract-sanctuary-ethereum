...
contract Staking {
    ...
    event GameEvent(Game game, string eventType);
    ...
    function createBet() public payable contractAvailable returns (bytes32) {
        ...
        emit GameEvent(newGame, "created");
    ...
    function takeBet(bytes32 _gameId) external payable contractAvailable {
        ...
        emit GameEvent(currentGame, "accepted");
    }
    ...
    function withdraw(
        ...
        emit GameEvent(currentGame, "completed");
    ...
    function cancel(bytes32 _gameId) public contractAvailable {
        ...
        emit GameEvent(currentGame, "cancelled");
