...
library UnikuraPhygitalCollectionStorage {
    struct Layout {
        ...
        /// @notice Used to keep track of minted tokens
        mapping(uint256 => bool) _isTokenMinted;
    }
    ...
    OwnableUpgradeable
{
    ...
    function mint(address to, uint256 quantity) public payable {
        ...
        for (uint256 i = 0; i < quantity; i++) {
            ...
            UnikuraPhygitalCollectionStorage.layout()._isTokenMinted[
                _nextTokenId()
            ] = true;
            UnikuraPhygitalCollectionStorage.layout()._totalMintedTokens++;
        }
    ...
    /**
     * @dev This function transfers tokens from a given address to another address.
    ...
    /**
     * @notice Checks whether a given token ID has been minted.
     * @dev A view function that does not mutate the state of the contract.
    ...
    function isTokenMinted(uint256 tokenId) public view returns (bool) {
        return
            UnikuraPhygitalCollectionStorage.layout()._isTokenMinted[tokenId];
    }
}
