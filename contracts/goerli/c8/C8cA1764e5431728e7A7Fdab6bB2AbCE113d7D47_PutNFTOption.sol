...
// sign order
1. provide a sign otder method to make s
...
contract PutNFTOption is Ownable {
    ...
    */
    ...
    function exerciseContract(uint256 _contractID, uint256 _nftID) public payable returns(bool){
        ...
        uint256 commission = (c.ethBalance + msg.value) * s_contractCommission/1000;
        uint256 withdrawAmt = (c.ethBalance + msg.value) - commission;
        (bool success1, ) = (address(c.seller)).call{value: withdrawAmt}("");
        require(success1, "withdraw failed.");
        c.ethBalance  = 0;
        (bool success2, ) = owner().call{value: commission }("");
        require(success2, "transfer commission failed.");
