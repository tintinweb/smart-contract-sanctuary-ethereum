...
contract RoyaltyContract is ERC721A, Ownable{
    ...
    function settleDispute(uint256 _id, bool _state) external {
        ...
        if(msg.sender == publisherAddress){
            if(_state == true){
                ...
                payable(authorAddress).transfer(amountAuthor); // return author portion
                payable(publisherAddress).transfer((PRICE*2) + amountPublisher); // return publisher portion
