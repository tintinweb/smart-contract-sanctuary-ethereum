...
contract Svg is ERC721, ERC721Enumerable, Ownable {
    ...
    function mint(uint256 tokenId, string memory _name, string memory _material, uint256 _speed, uint256 _attack, uint256 _defense) external onlyOwner {
        _safeMint(msg.sender, tokenId);
        attributes[tokenId] = Attr(_name, _material, _speed, _attack, _defense);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        string memory json = Base64.encode(bytes(string(abi.encodePacked(
            ...
            '"attributes": [{"trait_type": "Speed", "value": ', Strings.toString(attributes[tokenId].speed), '},',
            '{"trait_type": "Attack", "value": ', Strings.toString(attributes[tokenId].attack), '},',
            '{"trait_type": "Defence", "value": ', Strings.toString(attributes[tokenId].defense), '},',
