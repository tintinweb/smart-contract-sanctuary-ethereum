...
contract NounsToken is INounsToken, Ownable, ERC721Checkpointable {
    ...
    uint256 private noundersDAOReward;
    ...
    constructor(
        ...
        root = merkleroot;
        noundersDAOReward = 10; //_noundersDAOReward;
    }
     ...
     * Noun. Nounders reward Nouns are minted every X Nouns, starting at 0,
     * until 183 nounder Nouns have been minted (5 years w/ 24 hour auctions).
     * @dev Call _mintTo with the to address(es).
     */
    function mint() public override onlyMinter returns (uint256) {
        if (_currentNounId % noundersDAOReward == 0) {
    ...
    function setNoundersDaoReward(uint256 _noundersDAOReward) public onlyOwner {
        require(_noundersDAOReward >= 10);
        noundersDAOReward = _noundersDAOReward;
    }
