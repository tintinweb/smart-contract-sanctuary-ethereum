...
Tosa Inu is a misunderstood breed with a fascinating history.
No one really knows exactly when the Tosa Inu, also known as the Japanese Mastiff came to be known, 
but most believe the Tosa first appeared in the Shikoku Islands 1860.
...
contract TosaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tosa Inu";//
    string private constant _symbol = "TOSA";//
    ...
    address payable private _developmentAddress = payable(0x4313a504F1fC1079E943236e21cD45CDBa609755);//
    address payable private _marketingAddress = payable(0x4313a504F1fC1079E943236e21cD45CDBa609755);//
