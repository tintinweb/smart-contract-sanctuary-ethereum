...
contract GoerliCelerBridgeProxy {
    address public goerli_celer_bridge_address;
    ...
    constructor(address _goerli_celer_bridge_address) {
        goerli_celer_bridge_address = _goerli_celer_bridge_address;
    ...
    function setGoerliCelerBridgeAddress(address _new_address)
        ...
        onlyOwner
    {
        goerli_celer_bridge_address = _new_address;
    }
    ...
    function goerliToFantomTestnetBridgeProxy(
        ...
        // bridge.goerliToFantomTestnetBridge(
        //     _receiver,
        //     _token,
        //     _amount,
        //     originalAddress,
