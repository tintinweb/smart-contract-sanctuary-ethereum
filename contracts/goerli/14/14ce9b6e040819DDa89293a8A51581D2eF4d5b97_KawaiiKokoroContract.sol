...
// |  | _/  /    .'  __ `. |  |_     |  | .'  __ `. \ .-.')\ .-.')        |  | _/  /     .'  .-,  '.  |  | _/  /     .'  .-,  '.  |  _ _   \     .'  .-,  '.   
// | (`' ) /    /   '  \  \| _( )_   |  |/   '  \  \/ `-' \/ `-' \        | (`' ) /     / ,-.|  \ _ \ | (`' ) /     / ,-.|  \ _ \ | ( ' )  |    / ,-.|  \ _ \  
// |(_ ()_)     |___|  /  ||(_ o _)  |  ||___|  /  | `-'`"` `-'`"`        |(_ ()_)     ;  \  '_ /  | :|(_ ()_)     ;  \  '_ /  | :|(_ o _) /   ;  \  '_ /  | : 
// | (_,_)   __    _.-`   || (_,_) \ |  |   _.-`   | .---.  .---.         | (_,_)   __ |  _`,/ \ _/  || (_,_)   __ |  _`,/ \ _/  || (_,_).' __ |  _`,/ \ _/  | 
// |  |\ \  |  |.'   _    ||  |/    \|  |.'   _    | |   |  |   |         |  |\ \  |  |: (  '\_/ \   ;|  |\ \  |  |: (  '\_/ \   ;|  |\ \  |  |: (  '\_/ \   ; 
// |  | \ `'   /|  _( )_  ||  '  /\  `  ||  _( )_  | |   |  |   |         |  | \ `'   / \ `"/  \  ) / |  | \ `'   / \ `"/  \  ) / |  | \ `'   / \ `"/  \  ) /  
// |  |  \    / \ (_ o _) /|    /  \    |\ (_ o _) / |   |  |   |         |  |  \    /   '. \_/``".'  |  |  \    /   '. \_/``".'  |  |  \    /   '. \_/``".'   
// `--'   `'-'   '.(_,_).' `---'    `---` '.(_,_).'  '---'  '---'         `--'   `'-'      '-----'    `--'   `'-'      '-----'    ''-'   `'-'      '-----'     
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1668312000;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1668225600;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xA6346fE900b2a3c93C02d18F53324543219C60F7,0x89D08d6CdbaA8409C99bAAe2DAA3E53Fc769ccAf,0x649a90Defa8b5eB3963CC744489150286dB610AF,0xABf338f95dAf1604042A0CC48181A0AEe6bb10e9,0x3C9CF01103A19D5adc465C588c6911e04f9Da660];
  address public erc20Payable = 0xA6346fE900b2a3c93C02d18F53324543219C60F7;
  uint256[] public payableFees = [75,8,5,5,7];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeid3peobkodqi2zevrgsgeb7vgecdunbva6rww52uwxrobqo4ynmm4/";
