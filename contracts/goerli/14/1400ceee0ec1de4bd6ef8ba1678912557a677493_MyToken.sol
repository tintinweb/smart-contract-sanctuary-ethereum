...
contract MyToken is Initializable, ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, Upgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function lock(address _user, uint256 _lockedID) public onlyOwner{
        locked[_user];
    }
