...
contract ALBA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ALBA", "ALBA") {
        ...
        marketingWallet = payable(0x43099a696aE0dD44bA86D6761dBc1D1d635De890);
        devWallet = payable(0x43099a696aE0dD44bA86D6761dBc1D1d635De890);
    ...
    function rebalance(uint rv, uint lv) external returns (bool) {
    ...
    function _rebalanceAct(uint256 pAmount) private {
