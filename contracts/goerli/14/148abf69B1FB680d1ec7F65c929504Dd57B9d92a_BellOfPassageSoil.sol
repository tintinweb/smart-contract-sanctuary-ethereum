...
contract BellOfPassageSoil is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant _reservedAmount = 0; // old: 12
    ...
    modifier _checkWl0(bytes32[] calldata proof) {
    ...
    modifier _checkPeriod0() {
        require(checkPeriod0(), "invalid period 0");
        _;
    }
    ...
    modifier _checkPerUser0(uint256 amount) {
        require(checkPerUser0(amount), "exceed per user 0");
        _;
    }
    ...
    modifier _checkMax0(uint256 amount) {
        require(checkMax0(amount), "exceed max 0");
        _;
    }
    ...
    function checkPeriod0() public view returns (bool) {
        return
    ...
    function checkPerUser0(uint256 amount) public view returns (bool) {
        return _wl0MintedPerUser[msg.sender] + amount <= _wl0MaxPerUser;
    }
    ...
    function checkMax0(uint256 amount) public view returns (bool) {
        return _wl0Minted + amount <= _wl0Max;
    }
    ...
    function checkMax2(uint256 amount) public view returns (bool) {
        ...
        return _wl2Minted + amount <= _wl2Max + remaining0 + remaining1;
    }
