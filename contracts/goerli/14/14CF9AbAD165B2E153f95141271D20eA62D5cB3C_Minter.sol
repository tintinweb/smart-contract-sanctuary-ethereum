...
contract Minter is Ownable {
    ...
    function sendETH(uint256 _startId, uint256 _endId) public payable onlyOwner checkId(_startId, _endId) {
    ...
    function withdrawNFT(uint256 _startId, uint256 _endId, address _contract, uint256[] calldata tokenId) public checkId(_startId, _endId) {
        uint256 idx;
        for (uint256 i = _startId; i <= _endId; i++) {
