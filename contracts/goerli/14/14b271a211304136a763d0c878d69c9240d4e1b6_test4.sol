...
contract test4 is StandardToken {

  string public constant name = "test44"; // solium-disable-line uppercase
  string public constant symbol = "test44"; // solium-disable-line uppercase
