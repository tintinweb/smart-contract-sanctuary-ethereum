...
/*    NNS immutable nns;
    ...
    address public trustedNNSController;
    ...
    function __initialize(NNS _nns,
        INameWrapper wrapperAddress,
        address _trustedNNSController,
        address _trustedReverseRegistrar) public initializer 
    {
        __PublicResolver_init(_nns,wrapperAddress,_trustedNNSController,_trustedReverseRegistrar);
    }    

    function __PublicResolver_init(NNS _nns,
        INameWrapper wrapperAddress,
        address _trustedNNSController,
        address _trustedReverseRegistrar) internal onlyInitializing 
    {
        __PublicResolver_init_unchained(_nns,wrapperAddress,_trustedNNSController,_trustedReverseRegistrar);
    }

    function __PublicResolver_init_unchained(NNS _nns,
        INameWrapper wrapperAddress,
        address _trustedNNSController,
        address _trustedReverseRegistrar) internal onlyInitializing {
        nns = _nns;
        nameWrapper = wrapperAddress;
        trustedNNSController = _trustedNNSController;
        trustedReverseRegistrar = _trustedReverseRegistrar;
    }
    ...
    function isAuthorised(bytes32 node) internal view override returns (bool) {
        if (
            msg.sender == trustedNNSController ||
