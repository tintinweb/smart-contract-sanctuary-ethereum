    ...
    UUPSUpgradeable
{
    ...
    CountersUpgradeable.Counter private _baycGenesisTokenIds;

    uint256 public START_TOKENID_BAYC_GENESIS;
    ...
    function initialize() public initializer {
        __ERC721_init("Glob Test", "GT");
        __Pausable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();

        START_TOKENID_BAYC_GENESIS = 1;
        MAX_SUPPLY_BAYC_GENESIS = 20;
        MAX_PER_TRANSACTION_BAYC_GENESIS = 20;
        PRICE_BAYC_GENESIS = 0 ether;
    }
    ...
    function _mintEachBaycGenesis() private {
        uint256 newTokenID = _baycGenesisTokenIds.current() +
            START_TOKENID_BAYC_GENESIS;
