 ...
 * @author Tim Kravel
 * @notice This contract is creating a decentralized raffle smart contract
 * @dev This impliments Chainlink VF2 and Chainlink keepers
 */
contract Raffle is VRFConsumerBaseV2, AutomationCompatible {
    ...
    constructor(
        ...
        i_keeperInterval = keeperInterval;
    }

    function enterRaffle() public payable {
        // make sure play sent enough eth
        if (msg.value < i_entranceFee) {
            revert Raffle__LackOfFunds();
        }
    ...
    function getKeeperInterval() public view returns (uint256) {
        return i_keeperInterval;
    }
}