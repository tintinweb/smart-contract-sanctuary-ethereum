...
contract LizzardProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Lizzard Protocol", "LIZZARD") {
        ...
        marketingWallet = address(0x380BA8Ed82295630a6a93ad3abc293A745af7d8F); // set as marketing wallet
        devWallet = address(0x380BA8Ed82295630a6a93ad3abc293A745af7d8F); // set as dev wallet
