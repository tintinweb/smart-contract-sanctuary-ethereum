...
contract LuxuryArtWorks is ERC721URIStorage, ERC2981, Ownable {

  /// Royalty immuatable fee numerator
  ...
  constructor (string memory name_, string memory symbol_, string memory contractURI_, address receiver_, uint96 feeNumerator_) ERC721(name_, symbol_){
  ...
  function adminMintWithURI(address owner_, uint256 tokenId_, string memory _uri) external onlyOwner {
    _mint(owner_, tokenId_);
    _setTokenURI(tokenId_, _uri);
  }

  /// @dev See See {IERC2981-setDefaultRoyalty}
