...
contract SummonV2Manager {
  ...
  event TokenLendedFrom(address indexed lender, address indexed summon, bytes encodedToken);
  event TokenWithdrawnTo(address indexed lender, address indexed summon, bytes encodedToken);
