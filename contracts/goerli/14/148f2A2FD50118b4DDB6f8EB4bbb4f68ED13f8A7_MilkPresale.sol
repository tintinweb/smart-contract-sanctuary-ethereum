...
contract MilkPresale {
    ...
    address public immutable MILK;
    address public immutable CAMELOT_ROUTER = 0xc873fEcbd354f5A56E00E710B90EF4201db2448d;

    constructor(uint256 _startTime, address _MILK, uint256 _max) {
        owner = msg.sender;
        startTime = _startTime;
        endTime = _startTime + 0.01 days;
        MILK = _MILK;
        presaleMax = _max;
    }
    ...
    function claim() external {
        ...
        IERC20(MILK).transfer(msg.sender, amount);
    }
    ...
    function addLiquidity() external onlyOwner {
        ...
        IERC20(MILK).approve(CAMELOT_ROUTER, type(uint256).max);
