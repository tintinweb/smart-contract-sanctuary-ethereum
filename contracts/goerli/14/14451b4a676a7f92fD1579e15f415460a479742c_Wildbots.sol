 ...
 */
contract Wildbots is ERC1155, ERC2981, AccessControl, DefaultOperatorFilterer {
     ...
     * 
     * @param _name should be "WinkyVerse Collections"
     * @param _symbol should be "WVC"
     */
    constructor (
        string memory _name,
    ...
    /**
     * @dev Returns token details:  totalSupply, maxSupply
     */
   ...
   // Adding internal function for getClaimIneligibilityReason to optimise gas for minting functions
    
    /**
     *  Verifications to run before minting a token
     */
