...
/**
 * @notice The unverified verifier bypasses all verification
 * and freely mints a new NFR after each verification request.
 */
contract UnverifiedVerifier is BaseVerifier {
