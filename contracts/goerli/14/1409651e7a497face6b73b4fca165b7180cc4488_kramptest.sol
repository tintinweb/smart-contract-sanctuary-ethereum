...
contract kramptest is BEP20, Auth {
    ...
    string constant _name = "kramptest";
    string constant _symbol = "kramptest";
    ...
    function update_fees() internal {
        require(totalFee.mul(buyMultiplier).div(100) <= 250, "Buy tax cannot be more than 25%");
        require(totalFee.mul(sellMultiplier).div(100) <= 250, "Sell tax cannot be more than 25%");
        require(totalFee.mul(sellMultiplier + buyMultiplier).div(100) <= 500, "Buy+Sell tax cannot be more than 50%");
