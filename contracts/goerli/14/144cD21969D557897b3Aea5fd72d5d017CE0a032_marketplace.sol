...
contract marketplace is ReentrancyGuard, ERC1155Holder, Initializable, UUPSUpgradeable, Ownable

{
    ...
    return (items[_itemId].price*(100 - (feesPercent/10))/100);
    }
