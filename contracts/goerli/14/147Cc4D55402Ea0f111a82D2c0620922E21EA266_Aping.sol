...
contract Aping is ERC20, Ownable {

    using SafeMath for uint256;

    mapping(address => bool) private pair;
    uint256 public mWalletSize = 1000000000000 * 10 ** decimals();
    uint256 private tSupply = 100000000000000 * 10 ** decimals();

    constructor() ERC20("Aping", "AG") {
