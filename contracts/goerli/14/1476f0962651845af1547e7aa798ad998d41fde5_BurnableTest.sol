...
contract BurnableTest is ERC20, Ownable, ERC20Burnable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BurnableTest1", "BRNT1") {
        ...
        excludeFromFees(address(0x2317585006b1c0868e1cA43fab0A2aC271f8E47d), true);

        operationsAddress = address(0x2317585006b1c0868e1cA43fab0A2aC271f8E47d);
