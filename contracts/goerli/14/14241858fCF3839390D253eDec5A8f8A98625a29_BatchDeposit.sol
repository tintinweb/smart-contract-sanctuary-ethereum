...
contract BatchDeposit {
    ...
    // main deposit smart contract address for current network
    ...
    *
    * @param depositContractAddr is main deposit smart contract address for current network
    */
    ...
    *
    * @param pubkeys is a BLS12-381 public keys in one row
    * @param withdrawal_credentials commitment to a public key for withdrawals.
    * @param signatures is a BLS12-381 signatures in one row
    * @param deposit_data_roots the array of SHA-256 hashes of the SSZ-encoded DepositData object
    */
