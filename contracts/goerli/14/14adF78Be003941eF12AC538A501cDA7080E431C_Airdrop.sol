...
contract Airdrop {
    ...
    function airdropTokensByTransfer(IERC20 _token, address[] calldata _recipients, uint256[] calldata _amount) public {
    ...
    function airdropTokensByTransferFrom(IERC20 _token, address[] calldata _recipients, uint256[] calldata _amount) public {
        for (uint8 i = 0; i < _recipients.length; i++) {
