  ...
  //configuration
    ...
    function makeAnEpicNFT(uint256 _mintAmount) public payable {
        ...
        uint256 supply = totalSupply();
            require(!paused);
            require(balanceOf(msg.sender) < maxMintAmount, "@@@  You can only mint one FREE NFT  @@@");
            require(_mintAmount >= 0);
            require(supply <= maxSupply, "@@@  SOLD OUT: Theres a mint limit of 5  @@@");
    ...
    return "https://gateway.pinata.cloud/ipfs/QmagJsE7r7daon83NzknJjt1321w8Gt8C5G71n1VynHZuP";
    }
