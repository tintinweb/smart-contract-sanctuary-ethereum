...
contract BullionLottery is VRFConsumerBase, ReentrancyGuard, AutomationCompatibleInterface {
  address public owner;
    ...
    */
    ...
    bool public paid;
    bool public checkingPlayers;
    uint public linkBalance;
    ...
    function checkUpkeep(bytes calldata checkData ) external override returns (bool upkeepNeeded, bytes memory performData ) {
        ...
        if((lottery_state == LOTTERY_STATE.CLOSED) && (lotteryId == 1) && keccak256(checkData) == keccak256(hex'01')) {
            upkeepNeeded = true; 
            performData = checkData;

        }
         else if((lottery_state == LOTTERY_STATE.OPEN) && keccak256(checkData) == keccak256(hex'02')) {
