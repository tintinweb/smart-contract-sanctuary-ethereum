    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Y7WF3LtuPuv3P2I3S1xA/contract-metadata";
  }
...
// File: contracts/RexbitstesterttContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RexbitstesterttContract is ERC721APlus {
    constructor() ERC721APlus("REXBITSTESTERTT", "RXBT"){}
}