...
contract JSH is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("JSH", "JH", maxBatchSize_, collectionSize_) {
  ...
  uint256 public constant PRICE = 0.15 ether; //在这个位置修改价格
...
//提款钱包
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xeD9D6088837f3DC39043208502bE813633333333);
