...
contract APLogic {
    ...
    //create a function that will get all the invoices in the invoices contract and return the count of invoices
    function getInvoiceCount() public view returns (uint256) {
        
        //return the length of the array

        return invoicesContract.getAllActiveInvoices().length;
    }
