...
contract ADVC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1e10 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
 
    
    uint256 public swapTokensAtAmount = 200_000 * 10**_decimals;
    uint256 public maxTxAmount = 1e12 * 10**_decimals;
    ...
    string private constant _symbol = "ADVC";
