...
contract USMMinterUpgradeable is OwnableUpgradeable {
    ...
    mapping(IERC20=>IUniswapV2Router02) public routers;
    ...
    function initialize(
        ...
        routers[dvd] = IUniswapV2Router02(_dvdRouter); // dvd=>usdc
        routers[d33d] = IUniswapV2Router02(_d33dRouter); //d33d=>usdc
    }

    modifier onlyAllowed {
        require(msg.sender == tx.origin || allowedContract[msg.sender], "Not allowed");
        _;
    }
    ...
    function setDvdLpSwapRouter(address _swapRouter) external onlyOwner(){
        routers[dvd] = IUniswapV2Router02(_swapRouter);
    }
    function setD33dLpSwapRouter(address _swapRouter) external onlyOwner(){
        routers[d33d] = IUniswapV2Router02(_swapRouter);
    }
    ...
    function getUsdcAmountOut(IERC20 _token, uint _tokenAmount) view public returns(uint _usdcAmount){
        if (_token == d33d) {
