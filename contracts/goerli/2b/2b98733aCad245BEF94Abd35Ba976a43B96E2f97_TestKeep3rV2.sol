...
import './TestKeep3rParameters.sol';
import './peripherals/DustCollector.sol';

contract TestKeep3rV2 is DustCollector, Keep3rJobs, Keep3rKeepers {
  constructor(
    address _governance,
...
abstract contract TestKeep3rParameters is IKeep3rParameters, Keep3rAccountance, Keep3rRoles {
  ...
  /// @inheritdoc IKeep3rParameters
  uint256 public override bondTime = 3 minutes;

  /// @inheritdoc IKeep3rParameters
  uint256 public override unbondTime = 14 minutes;

  /// @inheritdoc IKeep3rParameters
  uint256 public override liquidityMinimum = 3 ether;

  /// @inheritdoc IKeep3rParameters
  uint256 public override rewardPeriodTime = 5 minutes;

  /// @inheritdoc IKeep3rParameters
  uint256 public override inflationPeriod = 34 minutes;
  ...
  uint256 internal constant _MIN_REWARD_PERIOD_TIME = 1 minutes;
...
abstract contract Keep3rParameters is IKeep3rParameters, Keep3rAccountance, Keep3rRoles {
  ...
  /// @inheritdoc IKeep3rParameters
  uint256 public override liquidityMinimum;
