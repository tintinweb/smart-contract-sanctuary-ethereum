...
contract ANIMETA is ERC1155URIStorage, Ownable {
    event mintTo(address indexed  minter,address indexed  owner,string indexed tokenUri, uint tokenId,uint amount);
        ...
        onlyOwner
    {
        ...
        _setURI(tokenId,uri);
        emit mintTo(msg.sender,account,uri,tokenId,amount);
    }
