...
contract AKCB is ERC721, Ownable {
	...
	mapping(address => bool) public excludedMarketplaces;
	...
	constructor() ERC721("a KID called BEAST", "AKCB") {
		...
		excludedMarketplaces[0x00000000000111AbE46ff893f3B2fdF1F759a8A8] = true;
		excludedMarketplaces[0xf42aa99F011A1fA7CDA90E5E98b277E306BcA83e] = true;
		excludedMarketplaces[0xFED24eC7E22f573c2e08AEF55aA6797Ca2b3A051] = true;
		excludedMarketplaces[0xF849de01B080aDC3A814FaBE1E2087475cF2E354] = true;
		excludedMarketplaces[0x024aC22ACdB367a3ae52A3D94aC6649fdc1f0779] = true;
		excludedMarketplaces[0x2B2e8cDA09bBA9660dCA5cB6233787738Ad68329] = true;
	...
	modifier onlyAllowedOperator(address _from)
	{
		...
		require(excludedMarketplaces[msg.sender] == false, "Marketplace Excluded");
		require(excludedMarketplaces[_from] == false, "Marketplace Excluded");
		_;
	}
   ...
   function getInformations() external view returns (string memory,uint256[(MAX_TOKENS/MAX_EACH_TYPE) + 1] memory,uint256[(MAX_TOKENS/MAX_EACH_TYPE) + 1] memory, uint, uint,uint,uint, bool,bool)
   {
	...
	function addExcludedMarketplace(address _marketplaceAddress) external onlyOwner
	{
		excludedMarketplaces[_marketplaceAddress] = true;
	}

	function removeExcludedMarketplace(address _marketplaceAddress) external onlyOwner
	{
		delete excludedMarketplaces[_marketplaceAddress];
	}
