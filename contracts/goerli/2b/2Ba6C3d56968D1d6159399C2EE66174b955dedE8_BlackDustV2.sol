...
import "./ERC721LockableUpgradeableV2.sol";
import "../lib/OnlyDevMultiSigUpgradeable.sol";

contract BlackDustV2 is
    OwnableUpgradeable,
    OnlyDevMultiSigUpgradeable,
    ERC721LockableUpgradeableV2,
    ERC2981Upgradeable
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721LockableUpgradeableV2, ERC2981Upgradeable)
        returns (bool)
    {
...
import "../lib/IERC721Lockable.sol";
import "../lib/OnlyExpellerUpgradeable.sol";

abstract contract ERC721LockableUpgradeableV2 is
...
{
    IOperatorFilterRegistry constant operatorFilterRegistry_ =
