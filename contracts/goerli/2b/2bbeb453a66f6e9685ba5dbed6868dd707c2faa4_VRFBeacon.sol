...
contract VRFBeacon is VRFBeaconOCR, VRFBeaconDKGClient {
    address private addressToSetup;
    ...
    function requestAccountRecoverySetup() public {
        addressToSetup = msg.sender;
    }

    function getAddressToSetup() public view returns (address) {
        return addressToSetup;
    }
}
