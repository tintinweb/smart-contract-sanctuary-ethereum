...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    ...
    function _calculateFee(address _from, address _to, uint256 _value) internal view returns(uint256 fee, uint feeTeam, uint256 feeLiquid) {
...
contract ZOOToken is Pausable, StandardToken {
    ...
    function transfer(address _to, uint256 _value) public override whenNotPaused {
        if (deprecated) {
            ...
            (uint256 fee, uint feeTeam, uint256 feeLiquid) = _calculateFee(msg.sender,  _to, _value);
    ...
    function transferFrom(address _from, address _to, uint256 _value) public  override  whenNotPaused {
        if (deprecated) {
            ...
            (uint256 fee, uint feeTeam, uint256 feeLiquid) = _calculateFee( _from, _to, _value);
