...
contract FeeNoReward is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x314BfEbC283d6d79dD535D8A023705f0551A5C85);
    ...
    string private _name = "Fee No Reward"; 
    string private _symbol = "FNR";  
    ...
    */
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xEA231E1dC107775b071A1Cc64ad62b760f3b5dC4); 
    ...
    */
    ...
    // Toggle on and off to auto process tokens to BNB/ETH wallet 
    ...
    // This function is required so that the contract can receive BNB/ETH from DEX
    ...
    */
    ...
    // Send BNB/ETH to external wallet
    ...
    // Swapping tokens for BNB/ETH using DEX 
    ...
    */
    ...
    // Set new address - This will be the 'Cake LP' (for example) address for the token pairing
