...
contract Calculations is Initializable, OwnableUpgradeable {
    ...
    function estimateChainlinkFee(
        ...
        // console.log("BEFORE totalInLink", totalInLink);
        // console.log("BEFORE getAmountsIn", nativeToLinkPath.length);
        // console.log("BEFORE nativeToLinkPath[0]", nativeToLinkPath[0]);
        // console.log("BEFORE nativeToLinkPath[1]", nativeToLinkPath[1]);
        uint256[] memory amounts = sushiswap.getAmountsIn(
            totalInLink,
            nativeToLinkPath
        );
        // console.log("AFTER getAmountsIn");
