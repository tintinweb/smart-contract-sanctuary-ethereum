...
contract TaskManager {
    ...
    event TaskCreated(address indexed user, uint256 indexed taskId, string name, string description, uint256 dueDate);
    event TaskUpdated(address indexed user, uint256 indexed taskId, bool isComplete);

    function createTask(string memory _name, string memory _description, uint256 _dueDate) public {
