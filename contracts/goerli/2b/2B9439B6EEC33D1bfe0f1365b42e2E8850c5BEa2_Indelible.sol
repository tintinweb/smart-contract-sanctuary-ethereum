// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Head", unicode"Eyes", unicode"Body", unicode"Skin", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"The Steves", unicode"Steves for everyone", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/2aa0ddfe-6296-4054-84dd-f6018d5fbac7", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/2aa0ddfe-6296-4054-84dd-f6018d5fbac7", "", 0, "0x0a430adbc11f1582581fb323019C5971FC303E4c");

        constructor() ERC721A(unicode"The Steves", unicode"STEVE") {
            TIERS[0] = [5,5,10,10,15,15,40];
            TIERS[1] = [5,5,15,15,60];
            TIERS[2] = [100];
            TIERS[3] = [5,10,15,20,20,30];
            TIERS[4] = [5,10,10,15,20,40];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"The Steves #");
