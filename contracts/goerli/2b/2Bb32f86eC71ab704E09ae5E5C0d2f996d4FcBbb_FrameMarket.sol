...
contract FrameMarket is Ownable, ERC1155Holder {
	...
	struct Transaction { 
		address collection;
		uint256 tokenId;
		uint256 actionId; //Listing, Offer, Auction
		uint256 _amount;
		uint256 _price;
		address tokenAdr;
		uint256 royalty;
    ...
    function onBuyOrder(
		...
		IMultipleNFT nft = IMultipleNFT(_transaction.collection);
		...
		nft.safeTransferFrom(_transaction.owner, msg.sender, _transaction.tokenId, _transaction._amount, "buy from Marketplace");
    }
