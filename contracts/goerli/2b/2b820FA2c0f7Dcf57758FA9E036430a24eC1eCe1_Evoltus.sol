...
contract Evoltus is ERC1155LazyMint {
    constructor(
        string memory _name,
        string memory _symbol
    ...
    function verifyClaim(
        ...
        require(_tokenId == 0, "Only name token are claimable!");
        require(_quantity == 1, "Only 1 name token are claimable!");
    }

    function evolves() public {
