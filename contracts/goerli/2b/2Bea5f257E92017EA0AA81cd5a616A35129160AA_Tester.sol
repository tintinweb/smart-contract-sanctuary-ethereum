...
contract Tester is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Testin";
    ...
    **/
    ...
    constructor() payable {
        ...
        _isExcludedFromFees[0x6Ddb1Ab414F105bE0460671c192Bdfa4EF19913F] = true;
        ...
        maxTransactionAmount = ((100000000000000 * 10**9) * 5) / 100;
        maxWallet = ((100000000000000 * 10**9) * 10) / 100;
