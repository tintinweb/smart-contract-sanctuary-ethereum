    ...
    DefaultOperatorFilterer
{
    ...
    function image(uint256 token) internal view returns (string memory) {
        ...
        return
            string(
                abi.encodePacked(
                    '<svg width="900" height="900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 902 902"><rect x="0" y="0" fill="#F3F4F6" width="100%" height="100%"/><rect x="282" y="241" fill="white" width="335" height="418"/><svg x="297" y="256" fill="#fff" width="304" height="380" viewBox="0 0 306 382">',
                    content,
                    "</svg></svg>"
                )
            );
