...
contract Dao {
    ...
    constructor() payable {
        nextProposal = 1;
        daoContract = IdaoContract(0x2953399124F0cBB46d2CbACD8A89cF0599974963); //TODO: need NFT from start of video
        validTokens = [
            25933327669116593989530010249536803032860289833636850057395686272453014716417
        ]; //TODO: need NFT from start of video
        owner = msg.sender;
    }
