...
/*
    ...
    Base for Building ERC721 by Martin McConnell aka OffGridGecko
...
contract ANON2 is IERC721, Proxy, Functional, DefaultOperatorFilterer {
    ...
    VAULT public KEYS; ///Define interaction contract
    ...
    constructor() {
        ...
        KEYS = VAULT(0x1A1cA9C6484F88CECeD1304dfa558aa0115dE3A8);  //  MAINNET VAULT
        KEYS = VAULT(0xE20eF334929480E70C74FF6a980259FE50b03432);  //  TESTNET ONLY!! TODO: REMOVE THIS LINE
        
        totalTokens = 2000;
        price = 5 * (10 ** 15); // Replace leading value with price in finney
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == ANON2.onERC721Received.selector;
    }
    ...
    function keyholderMint(uint256 qty) external reentryLock {
        address _to = _msgSender();
        require(KHMintActive, "Mint: Not Open");
        require((qty + numberMinted) <= totalTokens, "Mint: Not enough avaialability");
        require((_mintTracker[_to] + qty) <= KEYS.balanceOf(_to), "Mint: Max per wallet exceeded");
    ...
    function publicMint(uint256 qty) external payable reentryLock {
        ...
        require((qty + numberMinted) <= totalTokens, "Mint: Not enough avaialability");
        require((_mintTracker[_to] + qty) <= maxPerTxn, "Mint: Max tkn per wallet exceeded");
    ...
    function activateKeyholderMint() public onlyOwner {
        KHMintActive = true;
    }
    
    function deactivateKeyholderMint() public onlyOwner {
        KHMintActive = false;
    }
