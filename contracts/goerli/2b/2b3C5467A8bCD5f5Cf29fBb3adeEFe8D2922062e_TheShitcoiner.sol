...
*    _____  _             ___    _         _
*   (_   _)( )           (  _`\ ( )     _ ( )_                _
*     | |  | |__     __  | (_(_)| |__  (_)| ,_)   ___    _   (_)  ___     __   _ __           _   _  ____
*     | |  |  _ `\ /'__`\`\__ \ |  _ `\| || |   /'___) /'_`\ | |/' _ `\ /'__`\( '__)   (`\/')( ) ( )(_  ,)
*     | |  | | | |(  ___/( )_) || | | || || |_ ( (___ ( (_) )| || ( ) |(  ___/| |    _  >  < | (_) | /'/_
*     (_)  (_) (_)`\____)`\____)(_) (_)(_)`\__)`\____)`\___/'(_)(_) (_)`\____)(_)   (_)(_/\_)`\__, |(____)
*                                                                                            ( )_| |
*                                                                                            `\___/'
*   - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
*
*   The other half of this collection is on Bitcoin via Stacks:
*   Contract: SP3VMWQKPN8XXHKD65J0VX4WAX12S4MMHA8ZZRM1X.the-shitcoiner
*   Website: https://theshitcoiner.xyz
*   Marketplace: https://gamma.io/collections/the-shitcoiner
*/
...
/**
 * @title The Shitcoiner
 * @notice Official NFT collection for "The Shitcoiner" story by Ethen Bunzel - visit https://theshitcoiner.xyz to learn more.
 * @author Brian Laughlan - @bruffstar
 */
contract TheShitcoiner is ERC721, ERC2981ContractWideRoyalties, Ownable {
     ...
     */
    constructor(uint256 _royaltiesPercentage) ERC721("TheShitcoiner", "TSC") {
        require(
    ...
    /**
     * @dev Gives the ability to mint a token.
     */
    function mintToken() public {
        require(saleIsActive, "Sale must be active");
        require(balanceOf(msg.sender) == 0, "Max mint per wallet reached");
        require(totalSupply().add(1) <= MAX_SUPPLY, "Not enough tokens left");

        _mintToken();
    }

    /**
     * @dev The internal minting function for owner.
     */
    function mintTokens(uint numberOfTokens) external onlyOwner {
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Not enough tokens left");
    ...
    /**
     * @notice Get the IPFS link for a token ID.
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string.concat(string(abi.encodePacked("ipfs://QmZNjMT4M8NU5UyTyngsEoMHZ3PDCpxkXs9ZTsNBnMf6Wf/", tokenId.toString())), ".json");
    }
     ...
     */
    function activateSale(bool _isActive) external onlyOwner {
