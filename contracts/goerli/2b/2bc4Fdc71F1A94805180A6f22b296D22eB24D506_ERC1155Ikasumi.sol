...
contract ERC1155YuzuInternal is Ownable, AccessControl, ERC1155Pausable, ERC1155Supply {
    // Token name
    ...
    function _beforeTokenTransfer(address operator, address from, address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) internal virtual override (ERC1155Pausable, ERC1155Supply) {
...
contract ERC1155Ikasumi is ERC1155YuzuInternal, ReentrancyGuard {
   ...
   constructor(
        ...
        bool _anyoneCanMint,
        string memory uri
    ) ERC1155YuzuInternal(uri, name, symbol, _anyoneCanMint) {}
