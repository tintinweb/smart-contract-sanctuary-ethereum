...
contract PortfolioScoreOracle is PortfolioScore, ChainlinkClient
{
	...
	function fulfill(bytes32 requestId, uint256 apy) public recordChainlinkFulfillment(requestId)
	{
		emit Received(apy);
	}
