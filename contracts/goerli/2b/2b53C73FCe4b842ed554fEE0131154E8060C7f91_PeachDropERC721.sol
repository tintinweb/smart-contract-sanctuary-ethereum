...
contract PeachDropERC721 is ERC721, Ownable {
    ...
    uint256 public activationTimestamp = 1682530000;

    // Timestamp for deactivating sale and redemption
    uint256 public deactivationTimestamp = 1687262460;

    // Address of payment safe
    address public beneficiary = 0xAe2f0Af98a3fE6504321F00DC3f7Dae0d2150AD0;

    // Max supply of total tokens
    uint256 public maxSupply = 50;

    // Mint price of each token (0.001 ETH)
    ...
    string private _baseURIUnredeemed = "ipfs://QmdZ7tNdJGjz8hjWAiNCqsmBL9yuD8QLLeMabCJaqPBHXk";

    // baseURI_ String to prepend to redeemed token IDs
    string private _baseURIRedeemed = "ipfs://QmdZ7tNdJGjz8hjWAiNCqsmBL9yuD8QLLeMabCJaqPBHXk";
    ...
    /**
     * @dev Mints 1 nft to multiple addresses
