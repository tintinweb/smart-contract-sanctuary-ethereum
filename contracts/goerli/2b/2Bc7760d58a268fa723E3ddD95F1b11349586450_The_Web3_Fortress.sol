...
contract The_Web3_Fortress is ERC721, Ownable {
  using Strings for uint256;
  ...
  string public _initRevealedUri;


  constructor(
    
  ) ERC721('The Web3 Fortress', 'W3F') {
    setBaseURI(_initBaseURI);
    setRevealedURI(_initRevealedUri);
    totalSupply = 0;
    _initRevealedUri = 'ipfs://QmfBo5z2duTdFGhTAsWrQ7cSNWNw6P76LCQ53q9arudQoT/TheW3FAccessPass.json';
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(walletMints[msg.sender] + _mintAmount <= maxMintAmount);
