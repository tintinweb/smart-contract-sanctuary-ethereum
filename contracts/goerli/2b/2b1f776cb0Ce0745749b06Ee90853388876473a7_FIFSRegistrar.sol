...
contract FIFSRegistrar {
    // Address of the ENS registrar for example.eth
    ENS ens;
    // Namehash of the root node that we administer (i.e. namehash("example.eth"))
    bytes32 rootNode;
    ...
    function register(bytes32 subnode, address owner) public {
        ...
        require(currentOwner != address(0), 'NAME_ALREADY_ASSIGNED');

        ens.setSubnodeOwner(node, subnode, owner);
    }
}
