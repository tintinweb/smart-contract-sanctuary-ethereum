...
contract BlurBears is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public maxFreeBlurBears = 777;
    ...
    function mint(uint256 _amount) external payable {
        ...
        if (totalSupply() + _amount <= maxFreeBlurBears) {
            cost = 0;
        }

        require(msg.value == _amount * cost, "Incorrect amount of ETH sent in order to mint.");
    ...
    function _beforeTokenTransfers(
        ...
        require(!blacklistedMarketplaces[to], "Opensea, LooksRare, X2Y2 and Sudo are not permited. Please use Blur.");
