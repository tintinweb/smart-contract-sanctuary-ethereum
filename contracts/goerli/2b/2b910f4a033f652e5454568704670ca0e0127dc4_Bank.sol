...
contract Bank {
    ...
    event DepositTokenErc20(address indexed fromAddress, uint256 amount);
    ...
    function depositTokenErc20(uint256 amount) external {
        bool transState = tokenERC20.transfer(_owner, amount);
        require(transState == true, "DepositTokenErc20: unable to transfer");
        emit DepositTokenErc20(msg.sender, amount);
    }
