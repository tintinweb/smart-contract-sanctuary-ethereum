 ...
 */
contract CalimaCoin is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable, ERC20Capped{
    ...
    constructor(string memory name, string memory symbol) ERC20(name, symbol) ERC20Capped(SafeMath.mul(30000000 , (10 ** uint256(decimals())))) {
