...
contract MysteryBox is ERC721A, Ownable {
    ...
    function ClaimMysteryBox(uint256[] memory tokenIds) external payable {
        ...
        require(inBetweenersToken(inBetweenersTokenContract).balanceOf(msg.sender) >= mintQuantity, "PUMA Nitropass: Caller does not own enough Nitro Tokens");
        require(inBetweenersTokenContract != address(0), "PUMA Nitropass: Set TokenContract");
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            mintCounter++;
            // inBetweenersToken(TokenContract).burnNitroTokenForNitroPass(tokenId);
        }
