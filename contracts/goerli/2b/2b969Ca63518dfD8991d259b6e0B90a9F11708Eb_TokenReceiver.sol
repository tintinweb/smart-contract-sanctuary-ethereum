...
contract TokenReceiver is ERC721, ReentrancyGuard, Ownable {
    ...
    string public uriContract = "ipfs://abc123";
    ...
    uint256 public maxOwnerMintAmount = 1;
    ...
    constructor() ERC721("Token Receiver", "TR") {
        setHiddenMetadataUri("ipfs://abc123/hidden.json"); // initialize what will be displayed before sale is revealed
    ...
    function getCityOwner(uint _tokenId) public view returns (address) {
    ...
    // TODO remove this from here and tests
    function transferThis(address _from, address _to, uint _tokenId) public onlyOwner{
