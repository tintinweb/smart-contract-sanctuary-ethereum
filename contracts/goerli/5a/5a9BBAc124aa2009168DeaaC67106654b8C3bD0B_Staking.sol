...
contract Migrate {
    ...
    address constant OLD_CELL = 0x09757DabaC779e8420b40df0315962Bbc9833C73; // addr old cell token
    address constant LP_V2 = 0x49dF46326D45166Ff50664b73Cf7FE4de787BD61; // addr old lp token
    //address WETH = IUniswapV2Router01(RouterV1).WETH();
    address WETH = 0x474673756595c91d137b68762D66a7658Cf250bb;
    address constant CELL = 0xF7fd4F3E82B10Ce246dd6b3a42EBCdb8D4A6bcC0; // addr new cell token
    ...
    function migrateV2toV3(uint amountLP) public returns(uint256 tokenId,
        ...
        IERC20(LP_V2).approve(RouterV1,amountLP);
        ...
        IERC20(OLD_CELL).transfer(address(1),balanceSender[msg.sender][CELL]);
