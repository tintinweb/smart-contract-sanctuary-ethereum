...
contract BaseVault is ERC1155TokenReceiver, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
     ...
     */
    function requestWithdraw(uint256 _numShares) external virtual nonReentrant {
     ...
     */
    function redeemFor(address _depositor, uint256 _numShares, bool _isMax) external virtual nonReentrant {
     ...
     * @param _isMax is flag for when callers do a max redemption
     */
    function _redeem(address _depositor, uint256 _numShares, bool _isMax) internal {
    ...
    // this function is only meant to be used in the external function requestWithdraw() which has a reentrancy guard modifier
