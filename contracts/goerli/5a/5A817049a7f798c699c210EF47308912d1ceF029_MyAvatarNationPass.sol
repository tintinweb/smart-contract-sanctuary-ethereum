...
contract MyAvatarNationPass is ERC721A, Ownable {
    ...
    uint256 public constant CITIZEN_MAX_SUPPLY = 1111; // TODO: TBD
    uint256 public guardiansMinted;
    uint256 public citizensMinted;

    // Guardian Sale Settings
    uint256 public guardianMintPrice = 1 wei;
    mapping(address => bool) public guardianSaleMinted;

    // Citizen Sale Settings
    uint256 public citizenMintPrice = 1 wei; // TODO: TBD
     ...
     */
    function guardianMint(bytes memory signature) external payable {
        ...
        // Check if user has already minted Guardian Pass
        require(
            !guardianSaleMinted[msg.sender],
            "MyAvatarNationPass: Guardian Pass Already Minted!"
        );

        _safeMint(msg.sender, 1);
        guardiansMinted++;
        guardianSaleMinted[msg.sender] = true;
