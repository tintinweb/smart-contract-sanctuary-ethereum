...
import "chainlink/src/v0.8/interfaces/VRFCoordinatorV2Interface.sol";
import "chainlink/src/v0.8/VRFConsumerBaseV2.sol";
import "openzeppelin/token/ERC721/extensions/ERC721URIStorage.sol";
import "openzeppelin/access/Ownable.sol";

error WrongAmountOfEthSent();
...
contract RandomNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    uint256 internal constant maxChanceValue = 100;
    ...
    constructor(
        ...
        uint256 _mintFee
    ) VRFConsumerBaseV2(_vrfCoordinator) ERC721("DogNFT", "DOG") {
