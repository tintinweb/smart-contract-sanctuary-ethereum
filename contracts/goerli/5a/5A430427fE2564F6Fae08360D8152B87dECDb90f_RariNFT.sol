...
contract RariNFT is ERC721URIStorage {
    ...
    function _pickRandomFirstWord(uint256 tokenId, string[9] memory firstWords)
        internal
        pure
    ...
    function _pickRandomSecondWord(
        uint256 tokenId,
        string[8] memory secondWords
    ...
    function _pickRandomThirdWord(uint256 tokeId, string[9] memory thirdWords)
        internal
        pure
        returns (string memory)
    {
        uint256 rand = random(
            string(abi.encodePacked("THIRD_WORD", Strings.toString(tokeId)))
        );
        rand = rand % thirdWords.length;
        return thirdWords[rand];
    }

    function _pickRandomColor(uint256 tokenId, string[6] memory colors)
        internal
        pure
        returns (string memory)
    {
    ...
    function _combineWords(uint256 newItemId)
        internal
        pure
        returns (string memory)
    {
    ...
    function _tokenURI(uint256 newItemId) public pure returns (string memory) {
        string
            memory svgPartOne = "<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 350 350'><style>.base { fill: white; font-family: serif; font-size: 24px; }</style><rect width='100%' height='100%' fill='";
        string
            memory svgPartTwo = "'/><text x='50%' y='50%' class='base' dominant-baseline='middle' text-anchor='middle'>";
