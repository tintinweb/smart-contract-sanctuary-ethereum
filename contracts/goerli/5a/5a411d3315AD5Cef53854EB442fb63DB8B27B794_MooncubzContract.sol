...
//  | |\/| |/ _ \ / _ \| '_ \ / __| | | | '_ \_  /
//  | |  | | (_) | (_) | | | | (__| |_| | |_) / / 
//  |_|  |_|\___/ \___/|_| |_|\___|\__,_|_.__/___|
//                                                
//                                                
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xA076064A9c3617Ba33b5BB3a94bBa65931A3e95F];
  address public erc20Payable = 0xA076064A9c3617Ba33b5BB3a94bBa65931A3e95F;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicqf76bhcvl3pleofdczgu4ymf67axl3wqio3bjcughvllconiana/";
...
// File: contracts/MooncubzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MooncubzContract is RamppERC721A {
    constructor() RamppERC721A("Mooncubz", "MOONCUBZ"){}
}