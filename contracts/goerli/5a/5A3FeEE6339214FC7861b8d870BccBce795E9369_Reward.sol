...
contract Reward is Context, Ownable {
    ...
    function setTimes1(uint256 times1One) public onlyOwner() {
        times1 = times1One;
    }
    ...
    function balanceOfOne(address addr, uint256 indexI) public view returns (uint256){
        ...
        if (pushOne[6] == 1) {//
            ...
            if (pushOne[0] == 2) {//
                ...
                if (pushOne[1] == rewardHistory[iss][0] && pushOne[2] == rewardHistory[iss][1] && pushOne[3] == rewardHistory[iss][2] && pushOne[4] == rewardHistory[iss][3] && pushOne[5] == rewardHistory[iss][4]) {
                    return toTalBalance * times5 * fee / baseFee / 10;
                } else if ((pushOne[1] == rewardHistory[iss][0] && pushOne[2] == rewardHistory[iss][1] && pushOne[3] == rewardHistory[iss][2] && pushOne[4] == rewardHistory[iss][3]) || (pushOne[2] == rewardHistory[iss][1] && pushOne[3] == rewardHistory[iss][2] && pushOne[4] == rewardHistory[iss][3] && pushOne[5] == rewardHistory[iss][4])) {
                    return toTalBalance * times3 * fee / baseFee / 10;
                } else if ((pushOne[1] == rewardHistory[iss][0] && pushOne[2] == rewardHistory[iss][1] && pushOne[3] == rewardHistory[iss][2]) || (pushOne[3] == rewardHistory[iss][2] && pushOne[4] == rewardHistory[iss][3] && pushOne[5] == rewardHistory[iss][4])) {
                    return toTalBalance * times2 * fee / baseFee / 10;
                } else if ((pushOne[1] == rewardHistory[iss][0] && pushOne[2] == rewardHistory[iss][1]) || (pushOne[4] == rewardHistory[iss][3] && pushOne[5] == rewardHistory[iss][4])) {
                    return toTalBalance * times1 * fee / baseFee / 10;
                } else {
                    return 0;
                }
            }
