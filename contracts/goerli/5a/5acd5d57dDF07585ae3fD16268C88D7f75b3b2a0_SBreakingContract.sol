    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 118) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidticf2oozufsn7ukwonmwwla56odc2okll7tg5mk6rbrrelghbti/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 118");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 118");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 118");
...
// File: contracts/SBreakingContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SBreakingContract is RamppERC721A {
    constructor() RamppERC721A("S Breaking", "SBB"){}
}
