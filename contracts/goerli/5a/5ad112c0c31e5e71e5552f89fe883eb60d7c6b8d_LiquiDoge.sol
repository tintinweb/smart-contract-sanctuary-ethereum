...
contract LiquiDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "LiquiDoge"; //
    string private constant _symbol = unicode"LDOGE"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x7357702227eaDe81a6b040c766c34F6adB61268A;
