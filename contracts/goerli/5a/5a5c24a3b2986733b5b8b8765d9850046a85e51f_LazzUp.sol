...
// File: ..\node_modules\erc721a\contracts\extensions\IERC721AQueryable.sol
...
// File: ..\node_modules\erc721a\contracts\ERC721A.sol
...
contract LazzUp is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("LazzMeUp", "LMU") {}
        ...
        returns (string memory)
    {
        ...
        if (bytes(baseURI).length != 0) {
            return
                string(abi.encodePacked(baseURI, _toString(imageId), ".json"));
        }
