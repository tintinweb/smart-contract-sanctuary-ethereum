...
contract JJAI is ERC20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() ERC20("JJ AI", "JAI") { // 
        marketingWallet = payable(0xB1C92073a017a79781fE96b104b71ECb2f1a2A75); // 
        devWallet = payable(0xB1C92073a017a79781fE96b104b71ECb2f1a2A75); // 
