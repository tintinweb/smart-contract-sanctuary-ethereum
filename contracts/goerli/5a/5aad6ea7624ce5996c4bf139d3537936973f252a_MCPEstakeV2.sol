...
contract MCPEstakeV2 is Ownable {
    ...
    function unstakeAll() public {
        ...
        for (uint256 i = stakerToTokenIds[msg.sender].length; i > 0; i--) {
            ...
            if((block.timestamp - tokenIdToTimeStamp[tokenId]) >= minClaimTime){
                totalRewards =
                    (totalRewards +
    ...
    function unstakeByIds(uint256[] memory tokenIds) public {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            if((block.timestamp - tokenIdToTimeStamp[tokenIds[i]]) >= minClaimTime){
    ...
    function claimByTokenId(uint256 tokenId) public {
        ...
        require((block.timestamp - tokenIdToTimeStamp[tokenId]) >= minClaimTime,"Can't claim yet");
