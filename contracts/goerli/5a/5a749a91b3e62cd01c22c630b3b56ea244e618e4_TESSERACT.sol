...
contract TESSERACT is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 50000000 * 10**18; // 1% of max supply 
    uint256 public numTokensSellToAddToLiquidity = 5000000 *10**18;

    uint256 public maxWalletToken = 200000000 * (10**18); // 4%
    uint256 public maxSellTransactionAmount = 50000000 * (10**18); //0.5 %
    uint256 public maxBuyTransactionAmount = 50000000 * (10**18); // 0.5 %
    ...
    constructor() {
        ...
        _MarketingWalletAddress = 0x788a6A12Ee53a87566f41e06b8f0FE09Acc2Cc3B;
