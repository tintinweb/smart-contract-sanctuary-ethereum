...
contract TougenkyouBTC is AccessControl, ERC2981, ERC721ABridgeBRC {
    ...
    address private constant FUND_ADDRESS = 0xb956E7C37065991b9ABF6E2164C9D4315c573B0c;
    address private constant ADMIN_ADDRESS = 0xb956E7C37065991b9ABF6E2164C9D4315c573B0c;
    address private constant DEV_ADDRESS = 0x1d5E687dB64D34236A5ad6Ff54d44f993C6ca49C;
    ...
    constructor(bool _callerIsUserFlg, address _originalContract) ERC721ABridgeBRC("TougenkyouBTC", "momoBTC", _originalContract) {
    ...
    function publicMint(address _to, uint256 _mintAmount) external payable callerIsUser whenMintable {
        if (totalSupply() + _mintAmount > registCount) revert MaxSupplyOver();
    ...
    function preMint(uint256 _mintAmount, uint256 _presaleMax, bytes32[] calldata _merkleProof, BTCTicketID ticket) external payable whenMintable {
        if (totalSupply() + _mintAmount > registCount) revert MaxSupplyOver();
        if (msg.value == 0 || msg.value < presaleCost[ticket] * _mintAmount) revert NotEnoughFunds(msg.value);
