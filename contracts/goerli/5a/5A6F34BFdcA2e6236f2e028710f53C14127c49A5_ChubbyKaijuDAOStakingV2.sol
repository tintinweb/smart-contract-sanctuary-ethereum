...
contract ChubbyKaijuDAOStakingV2 is IChubbyKaijuDAOStakingV2, OwnableUpgradeable, IERC721ReceiverUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  mapping(uint256 => uint16) public gen2Hierarchy; 
  ...
  function claimRewardsAndUnstake(uint256[] calldata tokenIds, bool unstake) external whenNotPaused nonReentrant _updateEarnings {
