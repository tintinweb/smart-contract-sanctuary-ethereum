...
contract Bridge is Ownable {
    ...
    function claim(address l1_contract_address, uint256 tokenId, address l2_owner_address, uint256 amount) public {
        ...
        uint256 l2_owner_address_ = uint256(uint160(l2_owner_address));

        payload[0] = l1_owner_address_;
        payload[1] = l2_owner_address_;
