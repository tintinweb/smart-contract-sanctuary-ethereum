 ...
 */
contract GourdsRelaid is Pausable, ERC20Permit, ERC20Capped {
    address private _owner;

    constructor() ERC20("Gourds Relaid","WAZV") ERC20Capped(1000000000 * (10**uint256(decimals()))) ERC20Permit("Gourds Relaid") { 
        _owner = _msgSender();
     }
