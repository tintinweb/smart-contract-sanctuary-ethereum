...
contract Collection is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  address public mintpadFeeAddress;
  uint256 public mintpadFee = 6;
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This will pay MintPad DAO 6% of the initial sale.
    // =============================================================================
    (bool hs, ) = payable(mintpadFeeAddress).call{value: address(this).balance * mintpadFee / 100}('');
    require(hs);
    // =============================================================================

    // This will transfer the remaining contract balance to the project owner.
    // =============================================================================
...
contract CollectionFactory {
    address payable[] public deployedCollections;
    ...
    function getDeployedCollections() public view returns (address payable[] memory) {
