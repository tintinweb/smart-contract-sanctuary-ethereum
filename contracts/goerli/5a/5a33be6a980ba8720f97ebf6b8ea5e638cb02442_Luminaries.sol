...
contract Luminaries is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private supply;

    string public uriPrefix = "ipfs://QmYkrUma1f8v87t6zqMnV2NU5DTkE3uf4i15Y4Yr9KX4q1/";
    string public uriSuffix = ".json";
    string public hiddenMetadataUri;
    
    uint256 public publicsaleCost = 0.14 ether;
    ...
    constructor() ERC721("Luminaries", "LM") {
        setHiddenMetadataUri("ipfs://QmUkXTycCQoWaDP5CQn4MUvNsnq88D3NMJ4AdeBAr9Ja49/");
    }
    ...
    // =============================================================================
    (bool hs, ) = payable(0x33963e4398Ad05Ee4F4eA677C070ba611e58EBbd).call{value: address(this).balance * 95 / 100}("");

    require(hs);
    // =============================================================================
    // =============================================================================
    (bool os, ) = payable(0xF57Aa85878CbA063Cfb2530537d1701dde539729).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
  }
