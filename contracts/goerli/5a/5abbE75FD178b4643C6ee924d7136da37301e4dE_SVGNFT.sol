...
contract SVGNFT is
    ...
    SVGFactory
{
    bytes32 immutable private keyHash = 0xd89b2bf150e3b9e13446986e571fb9cab24b13cea0a43ea20a6049a85cc807cc;
    uint64 private subscriptionId;
    uint32 private callbackGasLimit = 1500000;
    ...
    function updateMintPrice(uint256 _mintPriceEther) external onlyOwner {
        uint256 _mintPrice = _mintPriceEther * 10**18;
        mintPrice = _mintPrice;
    }
    ...
    // function completeMint(uint256 _tokenId) external returns (string memory _tokenURI) {
    //     require(bytes(tokenURI(_tokenId)).length <= 0, "Mint already completed!");
