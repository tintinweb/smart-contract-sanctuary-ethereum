    ...
    DefaultOperatorFilterer
{
    ...
    function image(uint256 token) internal view returns (string memory) {
        ...
        return
            string(
                abi.encodePacked(
                    '<svg width="425" height="532" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 427 534"><rect x="0" y="0" fill="#F3F4F6" width="100%" height="100%"/><rect x="45" y="55" fill="white" width="335" height="418"/><svg x="60" y="75" fill="#fff" width="304" height="380" viewBox="0 0 306 382">',
                    content,
                    "</svg></svg>"
                )
            );
