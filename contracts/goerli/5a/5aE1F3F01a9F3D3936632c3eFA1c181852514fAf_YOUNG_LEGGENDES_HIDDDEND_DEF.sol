...
contract YOUNG_LEGGENDES_HIDDDEND_DEF is ERC721A, Ownable {
    ...
    function isWhitelistMintStarted() public view returns(bool) {
        return WHITELIST_STARTED;
    }

    function isPublicMintStarted() public view returns(bool) {
