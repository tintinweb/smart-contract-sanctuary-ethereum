    ...
    IERC5050Receiver
{
    ...
    ITransferableMana iTransferableMana;
    ...
    function clearSpell(uint256 crystalId, address collection, uint256 characterId)
        ...
        iTransferableMana.transferFrom(tx.origin, spellCasts[crystalId].from, 20 * crystalsMap[crystalId].focus * crystalsMap[crystalId].attunement);
    ...
    function ownerSetManaAddress(address addr) external onlyOwner {
        iMana = IMana(addr);
        iTransferableMana = ITransferableMana(addr);
    }
