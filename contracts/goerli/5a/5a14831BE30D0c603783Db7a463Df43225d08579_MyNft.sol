...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x11eec0923C7c49796482cdEB4F158b348166a783, 0x17814275E78965C6C403Ad226AC3E10778C20c3A];
    uint256[] public withdrawPercentages = [78, 22];


    bytes32 public merkleRoot = 0x583e2ec8d2fd363678733a2be646dbea31ddc7ce3d8702d4a3fa98fbdf3de3df;

    constructor() ERC721("NFTOOL Demo", "NFTOOL") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1602316654298329090/metadata/";
        _setDefaultRoyalty(0x11eec0923C7c49796482cdEB4F158b348166a783, uint96(1000));
    }
