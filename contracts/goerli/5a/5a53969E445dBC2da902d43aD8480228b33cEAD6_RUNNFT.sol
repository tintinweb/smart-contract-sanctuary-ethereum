...
contract RUNNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    bool public isSaleActive = false;
    string public PROVENANCE = "-";
    uint public constant MAX_PER_MINT = 1; // 单个账户mint的数量
    uint256 public constant PRICE = 100000000000000000; // 你要出售的价格0.1 ETH
    uint256 public MAX_SUPPLY = 10000; // 生成NFT的数量
    address[] private distributions;
    string private baseURI;
    string public baseTokenURI;
    string public contractURI;

    constructor() ERC721("RUN NFT", "RUN") {
        baseURI = "ipfs://QmPeCeFKX3tJKNLe94eGNH4dSiaZ6eR64ADF3ijUHe2BgB/"; // 填写您的baseURI
        baseTokenURI = "ipfs://QmPeCeFKX3tJKNLe94eGNH4dSiaZ6eR64ADF3ijUHe2BgB/";
        contractURI = "";
    }
    ...
    function mint(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MAX_PER_MINT, "Max 1 tokens can be minted in one batch");
