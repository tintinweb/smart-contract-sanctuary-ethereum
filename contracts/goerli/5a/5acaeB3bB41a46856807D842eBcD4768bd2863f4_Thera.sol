...
pragma solidity 0.7.3 <0.8.9;

/*
* This Contract was created with the finality of generating a new Amazon rainforest and society, the Thera token is an open source ERC-20 created by the Thera Fintech Department.
* Each Thera gives exclusive art and music, and many other projects are being created to bring in to fruitation a true Crypto program that helps humanity come back on track
* Developed by Derek Santos Sidi, Amazonas, Manaus.
* 22/12/12
*/
...
contract TheraSpecial is TheraFounding {
...
contract TheraUnique is TheraFounding {
    uint256 internal constant RATE = 79060000000000000;
