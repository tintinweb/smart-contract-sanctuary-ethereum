    ...
    Ownable
{
     ...
     */
    uint public interval; /*immutable*/
    ...
    event TokensUpdated(State marketTrend);
    ...
    constructor(uint _updateInterval, address _pricefeed)
        ...
        returns (bool upkeepNeeded, bytes memory performData)
    {
        ...
        performData = ""; // AVOID Warning: Unnamed return variable can remain unassigned.
    }
    ...
    function performUpkeep(
        ...
        if (latestPrice < currentPrice) {
            ...
            updateAllTokenUris(State.Bear);
        } else {
            // bull
            console.log("ITS BULL TIME");
            updateAllTokenUris(State.Bull);
        }
    ...
    function getLatestPrice() public view returns (int256) {
        ...
        return price; //  example price returned 3034715771688 -> 30347.15771688
    }

    function updateAllTokenUris(State trend) internal {
        if (State.Bear == trend) {
            console.log(" UPDATING TOKEN URIS WITH ", "bear");
            for (uint i = 0; i < _tokenIdCounter.current(); i++) {
                _setTokenURI(i, bearUrisIpfs[0]);
            }
        } else {
            console.log(" UPDATING TOKEN URIS WITH ", "bull");
            for (uint i = 0; i < _tokenIdCounter.current(); i++) {
