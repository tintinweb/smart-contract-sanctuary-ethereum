...
contract CommHistory is Ownable {
    ...
    function isSpecialTree(address _user) public view returns(bool isSpecial, uint _round) {
        address _refferBy;
        address from = _user;
        for(uint i = 0; i < 7; i++) {
    ...
    function isSpecial2Tree(address _user) public view returns(bool isSpecial, uint _round) {
        address _refferBy;
        address from = _user;
        for(uint i = 0; i < 7; i++) {
            (, _refferBy,,,,) = refer.userInfos(from);
