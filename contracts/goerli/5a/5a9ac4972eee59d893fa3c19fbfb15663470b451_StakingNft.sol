...
contract StakingNft is Ownable {
    ...
    uint256 public minClaimTime = 30 minutes;
    ...
    function unstakeAll() public {
        ...
        for (uint256 i = stakerToTokenIds[msg.sender].length; i > 0; i--) {
            ...
            if(tokenIdToTimeStamp[tokenId] >= minClaimTime){
                totalRewards =
                    (totalRewards +
    ...
    function unstakeByIds(uint256[] memory tokenIds) public {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            if(tokenIdToTimeStamp[tokenIds[i]] >= minClaimTime ){
    ...
    function setMinClaimTime(uint256 newTime) external onlyOwner{
        minClaimTime = newTime;
    }
    ...
    function claimByTokenId(uint256 tokenId) public {
        ...
        require(tokenIdToTimeStamp[tokenId] > minClaimTime,"Can't claim yet");
