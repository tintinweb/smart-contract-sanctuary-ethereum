...
contract StakingFactory is Ownable, IStakingFactory {
     ...
     */
    uint256 public totalBlocksPerYear = 365 * 24 * 60 * 60;
    ...
    function _createPool(
        ...
        pools[_pool] = Pool({
            ...
            weight: _poolWeight,
            isPool: true,
            ufoPool: poolIndex % 2 == 0,
            allocPoint: 0,
            lastRewardUfoTimeStamp: 0,
            lastRewardPlasmaTimeStamp: 0,
            accRewardUfoPerShare: 0,
            accRewardPlasmaPerShare: 0
        });
    ...
    {
        Pool storage pool = pools[msg.sender];
        uint256 rewardPerSecondUfo = pool.ufoPool ? ufoRewardPerSecondOfUfoPool : ufoRewardPerSecondOfLpPool;
        uint256 rewardPerSecondPlasma = pool.ufoPool ? plasmaRewardPerSecondOfUfoPool : plasmaRewardPerSecondOfLpPool;
        return (
            pool.accRewardUfoPerShare,
            pool.accRewardPlasmaPerShare,
            pool.lastRewardUfoTimeStamp,
            pool.lastRewardPlasmaTimeStamp,
            pool.allocPoint,
            totalAllocPoint,
            rewardPerSecondUfo,
            rewardPerSecondPlasma
        );
    }
