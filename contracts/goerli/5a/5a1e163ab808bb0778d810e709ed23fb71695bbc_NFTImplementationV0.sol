...
contract NFTImplementationV0 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("OpenEarthNFTV0", "OE");
    ...
    function set_version() public onlyOwner {
        version = "v0";
    }
