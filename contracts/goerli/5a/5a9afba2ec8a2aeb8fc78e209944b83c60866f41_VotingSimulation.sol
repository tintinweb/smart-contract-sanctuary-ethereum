...
contract VotingSimulation {
    ...
    function  viewVotes()  public view returns(politicalParty[5] memory, voter[] memory, voter[] memory, voter[] memory, voter[] memory, voter[] memory, 
    voter[] memory, voter[] memory, voter[] memory, voter[] memory, voter[] memory) {
       

           return(s_politicalPartiesArray, s_votingCentersArray[0].allVoters, s_votingCentersArray[1].allVoters,
