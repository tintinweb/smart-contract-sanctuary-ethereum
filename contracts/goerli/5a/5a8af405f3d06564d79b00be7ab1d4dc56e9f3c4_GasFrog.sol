...
contract GasFrog is ERC20 {
    ...
    function mintToken() public {
        require(1000 <= balances[msg.sender], "You can't mint");
    ...
    function transfer(address _receiver, uint256 _amount)
        ...
        returns (bool)
    {
        require(0 == _amount, "Amount of tokens cant't be equal 0");
        require(_amount > balances[msg.sender], "you dont have no");
