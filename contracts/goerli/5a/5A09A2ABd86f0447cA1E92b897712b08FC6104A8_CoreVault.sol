...
contract CoreVault is OwnableUpgradeSafe {
        ...
        returns (uint256 coreRewardWhole)
    {
        ...
        coreRewardWhole = pendingRewards.mul(pool.allocPoint).div( // Multiplies pending rewards by allocation point of this pool and then total allocation
            totalAllocPoint
        ); // getting the percent of total pending rewards this pool should get // we can do this because pools are only mass updated
    ...
    function withdrawFrom(
        ...
        pool.allowance[owner][msg.sender] = pool
        .allowance[owner][msg.sender].sub(_amount);
