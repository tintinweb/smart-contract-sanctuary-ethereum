...
contract NFTUsecase is ERC721, Ownable {
    uint256 public mintPrice;
    uint256 public totalSupply;
    uint256 public maxSupply;
    uint256 public maxPerWallet;
    bool public isPublicMintEnabled;
    string internal baseTokenUri; //tell to opensea where the imagees are located
   ...
   constructor() ERC721("NFTUsecase", "NFTU") {
    ...
    function brunNFT(uint256 tokenId) public{
