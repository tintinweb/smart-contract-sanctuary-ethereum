...
contract NFTStaking is Ownable, Pausable{
    ...
    uint256 public rewardPeriod = 30 minutes;
    ...
    function rewardForTokenInUSD(address user, uint256 tokenID) public view returns(uint256) {
        ...
        uint256 stakedPeriod = (block.timestamp-info.staked[tokenID])/rewardPeriod;
        uint256 rewardPerCycle = rewardForRarity[rarity[tokenID-1]-1];
        return (stakedPeriod*rewardPeriod*rewardPerCycle/rewardCycle) - info.totalWithdrawnInUSD;
    }
