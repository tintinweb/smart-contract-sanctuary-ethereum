...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 LUNC_WORMHOLE = IERC20(0x326C977E6efc84E512bB9C30f76E30c160eD06FB); // Goerli link
    address public WETH = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6; //testnet
    IDEXRouter router;
...
contract LUNATICS is IERC20, Auth {
    ...
    address LUNC_WORMHOLE = 0x326C977E6efc84E512bB9C30f76E30c160eD06FB; // Goerli link
    address public WETH = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6; //testnet
    ...
    string constant _symbol = "LUNATICS";
...
// Trading once enabled, can't be disabled
    ...
    function setFees(
        ...
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(burnFee);
    ...
    function clearStuckTokens(address _tokenContract) public authorized {
          require(_tokenContract != address(this), "Cannot withdraw native token");
