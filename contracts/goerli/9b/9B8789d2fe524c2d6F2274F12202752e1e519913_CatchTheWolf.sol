...
contract CatchTheWolf {
    address internal constant WOOLF_ADDRESS = 0x6a4F2F0a14822B3ACD740352eEC3067E8D01dcB9;

    Woolf private constant WGAME = Woolf(WOOLF_ADDRESS);

    mapping(uint256 => uint256) public seedToPrn;
    ...
    function view_wolf() public view returns (uint16) {
        return minted;
    }

    function view_prn(uint256 seed) public view returns (uint256) {
        return seedToPrn[seed];
    }
