    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 4500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibepr4mgj3yl5ycjfmpoqfypi7nkzhnb5xlqe73y4lujcflotkv5m/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/WQntYmJ6vGRk7J5zWmJd/contract-metadata";
  }
...
// File: contracts/CzsafUclubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CzsafUclubContract is RamppERC721A {
    constructor() RamppERC721A("CZ SAFU club", "CZ SAFU club"){}
}
