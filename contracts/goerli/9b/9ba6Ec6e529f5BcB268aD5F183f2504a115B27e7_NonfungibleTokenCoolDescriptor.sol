...
interface INonfungibleTokenCoolDescriptor {
    function tokenURI(
        uint256 tokenId
...
import "./interfaces/INonfungibleTokenCoolDescriptor.sol";

contract NonfungibleTokenCoolDescriptor is INonfungibleTokenCoolDescriptor{
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"Cool NFT"',
                                ', "description":"This is Cool NFT!", "image": "',
