...
contract SeedPresaleCvg is ERC721Enumerable, Ownable {
    ...
    /// @dev Prices Info
    uint256 public constant PRICE_PRESEED = 10; //0.13$
    uint256 public constant PRICE_SEED = 13; //0.1$
    ...
    constructor(IERC20 _Dai, IERC20 _Frax, address multisieg) ERC721("PresaleSeed CVG", "pCVG") {
        Dai = _Dai;
        Frax = _Frax;
        transferOwnership(multisieg);
    }
