	...
	Context
{
        ...
        payable
	{
        ...
        require(verifySignedAddress(_v, _r, _s, getState().mintNonce[_msgSender()]), "Invalid signature");
    ...
    function verifySignedAddress(
        ...
        bytes32 prefixedHashMessage = keccak256(abi.encodePacked(Constants.PREFIX, keccak256(abi.encodePacked(msg.sender, nonce))));
