...
contract DEMOONE is Context, IERC20, Ownable {
    ...
    address public devWalletOne;
    address public devWalletTwo;
    ...
    uint256 public devFeePercent = 25;
    ...
    function setDevWalletOne(address walletAddress) public onlyOwner {
        devWalletOne = walletAddress;
    }

    function setDevWalletTwo(address walletAddress) public onlyOwner {
        devWalletTwo = walletAddress;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        payable(devWalletOne).transfer(marketingshare1);
        newBalance -= marketingshare1;
        uint256 marketingshare2 = newBalance.mul(devFeePercent).div(100);
        payable(devWalletTwo).transfer(marketingshare2);
        newBalance -= marketingshare2;
