...
/// @title Treasury
/// @notice The contract stores some portion of reward tokens in the system (including XBF), 
/// converts them to XBF if needed and transfer them to VSR to distribute it between stakers. 
/// Some authorized person or backend can call toVoters to convert specific reward tokens to 
/// XBF (via purchase on uniswap or its equivalent), and immediately send them to VSR for 
