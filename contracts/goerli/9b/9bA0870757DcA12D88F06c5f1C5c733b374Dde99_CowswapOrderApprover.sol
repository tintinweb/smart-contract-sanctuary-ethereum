...
contract CowswapOrderApprover {
    ...
    constructor(address _signing) { 
        signing = GPv2Signing(_signing);
    }

    function approveOrder(GPv2Order.Data memory order) external {
        bytes32 domainSeparator = signing.domainSeparator();
