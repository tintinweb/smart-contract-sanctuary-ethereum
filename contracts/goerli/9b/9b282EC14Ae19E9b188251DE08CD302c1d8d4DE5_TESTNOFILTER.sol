...
contract TESTNOFILTER is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("TEST NO FILTER", "TNF") {
    setBaseURI("http://localhost:4000/api/test-no-filter/token/");
