...
contract NonBscVault is Ownable, Pausable {
    ...
    function deposit(uint256 _pid, uint256 _amount) external payable whenNotPaused notContract {
        ...
        // send message
        (bool success, bytes memory data) = CROSS_FARMING_ETH_CONTRACT.call{value: msg.value}(
            abi.encodeWithSignature("sendFarmMessage(address,address,uint256,uint256,uint8,uint64)",
