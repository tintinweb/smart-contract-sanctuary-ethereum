...
contract NyxRedeemProposal is NyxProposal, INyxRedeemProposal {
        ...
        returns (RedeemProposalParams memory)
    {
        ...
        {
            (uint256 param1, uint256 param2, uint256 param3) = abi.decode(params, (uint256, uint256, uint256));
        ...
        returns (bytes[nparams][] memory props)
    {
        ...
        for (uint256 idx = 0; idx < proposalBytesArr.length; idx++)
        {
            ...
            props[idx] = [abi.encode(params.action), abi.encode(params.nNfts), abi.encode(params.redeemPrice)];
        }
    }
}
