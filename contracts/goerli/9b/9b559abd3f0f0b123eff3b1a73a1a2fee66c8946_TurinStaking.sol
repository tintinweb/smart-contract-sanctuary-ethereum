...
abstract contract StakingWithFeeUpgradeable is StakingUpgradeable {
    ...
    function _canUpdateFees() internal view virtual returns (bool);
    ...
    // solhint-disable-next-line
    function __StakingWithFeeUpgradeable_init(uint256 feeInterval_, uint256 minFee_, uint256 maxFee_)
        internal
        onlyInitializing
    {
...
contract TurinStaking is StakingWithFeeUpgradeable {
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize(
        ...
        __StakingWithFeeUpgradeable_init(feeInterval_, minFee_, maxFee_);
    }

    function _canUpdateFees() internal pure override returns (bool) {
        // TODO
        return true;
    }
