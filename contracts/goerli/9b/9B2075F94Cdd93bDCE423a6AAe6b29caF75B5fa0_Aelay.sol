...
contract Aelay is Ownable {
    ...
    function viewConnector(string memory _yieldProtocol) public view returns (address) {         // delete
    ...
    function viewTokenAllowance(address _token, string memory _yieldProtocol) public view returns (bool) {         // delete
    ...
    */
        ...
        public checkConnector(_yieldProtocol) checkTokenAllowance(_token, _yieldProtocol)
    {
        ...
        if (senderPrincipalIndex == 0 && amountPrev == 0) {         // sets a new principal
            ...
            SenderPrincipal storage senderPrincipal = senderPrincipalsArray.push();
