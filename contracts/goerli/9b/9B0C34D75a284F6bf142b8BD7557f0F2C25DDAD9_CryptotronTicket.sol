...
contract CryptotronTicket is ERC721, ERC721Enumerable, ERC721Burnable {
    ...
    /**
     * @dev Function that's being used by parent contract to get the amount of participating tickets
     */
    ...
    /**
     * @dev Function that's being used by parent contract to change the URI of the winning ticket
     */
    function _resetWinningURI(uint256 tokenId) external virtual onlyParent {
    ...
    /**
     * @dev used for setting parent contract
     */
    function _setParent(address parentAddress) public onlyOwner {
        parent = payable(parentAddress);
    }

    /**
     * @dev used for preparing new URI to get set by parent contract in case of winning
     */
    function _winningURI(string memory _newURI) public onlyOwner {
        _wonTokenURI = _newURI;
    }
