...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Glasses", unicode"Head", unicode"Accessory", unicode"Body", unicode"Background"];
    bool private shouldWrapSVG = true;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0x0dc5889faa8cccada5caf0488bb8b22cf915d55e29135044579bd8948c76b6cb;
    string private networkId = "5";

    bool public isContractSealed;
    uint public maxSupply = 3669;
    ...
    ContractData public contractData = ContractData(unicode"gmNouns", unicode"gm 🤝 nouns // artwork 100% on-chain, forever // free mint x 3669 // derivative project: cc0 artwork from nouns.wtf // gm glasses by me", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/2c93b3e5-ec34-4e5c-9143-ccbcfc57ef70", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/2c93b3e5-ec34-4e5c-9143-ccbcfc57ef70", "", 700, "0xb895E66567A6130124d1eaAe9526dE8eEE861437");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"gmNouns", unicode"GMN") {
        tiers[0] = [77,88,99,99,143,143,176,176,176,356,356,356,356,356,356,356];
        tiers[1] = [20,22,24,26,27,27,27,29,31,33,37,42,43,43,44,50,55,58,59,67,67,67,67,74,75,75,76,77,77,77,78,79,88,88,88,89,89,98,99,99,99,99,99,99,105,111,111,111,111,111,111,111];
        tiers[2] = [33,41,41,44,44,44,44,44,44,49,49,51,56,56,56,56,56,59,67,69,77,77,77,77,77,77,77,77,88,88,88,91,91,91,91,91,91,91,91,91,91,91,91,91,91,101,101,101,102,107];
        tiers[3] = [262,262,262,262,262,262,262,262,262,262,262,262,262,263];
        tiers[4] = [1793,1876];
        withdrawRecipients.push(WithdrawRecipient(unicode"null",unicode"null", 0xA1D327A808F6322a1eb2Dd48612274bbC4A36D1C, 10000));
        randomSeed = uint(
            keccak256(
                abi.encodePacked(
                    tx.gasprice,
...
/// @author Modified from (https://github.com/Brechtpd/base64/blob/main/base64.sol) by Brecht Devos - <bre[email protected]>.
library Base64 {
