...
contract Degden1 is ERC20, Ownable {
    ...
    constructor() ERC20("DEGDEN1", "DGD1") {
        ...
        marketingWallet = address(0x8F0AB272F4063a317f2a81dB8849fA97AE106568); // set as marketing wallet
        devWallet = address(0x67e256b584201eC94533f4FD3E396982C6Af1515); // set as dev wallet
