...
contract GhozaliAI is Ownable, ERC721A, MerkleWhitelist, ReentrancyGuard{
    ...
    string public CONTRACT_URI; //TODO Need Napolean to confirm contract file, the images file doesn't load. We can then set this. 
    mapping(address => bool) public userHasMintedPublicWL;
    bool public REVEALED;
    string public UNREVEALED_URI = "ipfs://";  //TODO: need this from Napoleon too
    string public BASE_URI;
    bool public isPublicMintEnabled = false;
    uint public COLLECTION_SIZE = 1000;
    uint public MINT_PRICE = 0.1 ether;  //TODO: need this 
