...
contract TokyoRebels is ERC721A, Ownable, ERC2981 {
    ...
    constructor(address receiver, uint96 feeNumerator) ERC721A("Tokyo Rebels", "REBEL") {
    ...
    function overrideMint(uint256 _amount) external payable {
        ...
        if (msg.value < _calculateTotalPrice(overrideCost, _amount))
            revert NotEnoughEth();
