...
contract Troublemkrs is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    bytes32 public root;
	...
	uint public whitelistPrice = 0.2 ether;
    ...
    address[] public awardableWallets = [0xC07183E35c6139CE334Dd89eeE736A8366221E20];

    mapping (address => uint) public depositStatus;

	constructor()
	ERC721A('Troublemkrs', 'TROUBLE') {
    }
