...
import "../interface/IReswapFactory.sol";
...
interface IReswapConcentratedPool {
    ...
    function reswapFactory() external view returns (IReswapFactory);
...
interface IReswapFactory is IBeacon {
...
contract ReswapConcentratedPool is IReswapConcentratedPool, ReentrancyGuardUpgradeable, OwnableUpgradeable, ERC721SafeHolderUpgradeable{
    IReswapFactory public override reswapFactory;
    ...
    function __ReswapPool_init(
        ...
        reswapFactory = IReswapFactory(msg.sender);
        ...
        )
    {
        ...
        _mintReToken(params.nftIds, params.amounts, amount0Desired);
        ...
        INonfungiblePositionManager.MintParams
            memory mintParams = INonfungiblePositionManager.MintParams({
                ...
                recipient: address(this), //params.recipient,
    ...
    function _mintReToken(uint[] memory nftIds, uint[] memory amounts, uint256 amount) 
        internal 
        {
            uint256 nftCount = nftIds.length;
            require(amount == nftCount * BASE, "RESWAP: Fraction amount desired error");
        ...
        )
    {
        ...
        (uint256 amount0Desired, uint256 amount1Desired) = _sortAmount(params.fractionAmountDesired, params.tokenAmountDesired);
    ...
    function buyNft(uint256 [] memory specifiedNftIds, uint256 randomNftAmount, uint256 reTokenAmountIn, ISwapRouter.ExactInputSingleParams memory params)
        ...
        returns (
            ...
            console.log('buy nft tokenAmount', tokenAmount);
    ...
    function sellNft(uint256 [] memory nftIds, uint[] memory amounts, ISwapRouter.ExactInputSingleParams memory params)
        ...
        returns (
            ...
            uint256 amountIn = params.amountIn;
            _mintReToken(nftIds, amounts, amountIn);
