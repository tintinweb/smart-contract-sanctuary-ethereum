...
contract MockedSP {
    ...
    event PrintInputIssueTransportCard(
        string uuid,
        uint32  serviceDescriptor,
        address recipient,
        uint256 credits,
        ...
        returns (uint256)
    {
        ...
        emit PrintInputIssueTransportCard(
            payload.uuid, 
            payload.serviceDescriptor, 
            payload.recipient, 
            payload.credits,
            payload.erc20IncomeAmount,
            payload.erc20IncomeToken,
            payload.serviceRevenuePermille,
            payload.resellerRevenuePermille,
            payload.tokenURI
        );
        cardId ++;
