...
//        require(msg.value >= fee * _amount, "underpriced");
//        IZoo(zoo).mint(_user, _amount);
//    }
    ...
    function mintByUSDT(
        ...
        if (referral1 != address(0)) {
            rewardsByReferral[referral1] += (fee * _amount) / 10;
        }
        if (referral2 != address(0)) {
            rewardsByReferral[referral2] += (fee * _amount) / 20;
        }
    }
    ...
    function claimRewards() public {
        ...
        IERC20(usdt).transfer(_msgSender(), rewardsByReferral[_msgSender()]);
