...
contract ShopMacherNFT is ERC721, Ownable {
    ...
    string _savedBaseURI;

    constructor() ERC721("ShopMacherNFT", "SMNFT") {
        _savedBaseURI = "https://sm-nft-test.s3.ap-southeast-1.amazonaws.com/";
    }
    ...
    function setBaseURI(string memory newBaseURI) public onlyOwner {
        _savedBaseURI = newBaseURI;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        _requireMinted(tokenId);
        return (bytes(_savedBaseURI).length > 0) ? string(abi.encodePacked(_savedBaseURI, tokenId.toString(), ".json")) : "";
    }
