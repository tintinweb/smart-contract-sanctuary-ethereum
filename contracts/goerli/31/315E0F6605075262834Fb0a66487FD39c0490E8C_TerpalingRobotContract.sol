...
//  /_  __/__  _________  ____ _/ (_)___  ____ _/ __ \____  / /_  ____  / /_
//   / / / _ \/ ___/ __ \/ __ `/ / / __ \/ __ `/ /_/ / __ \/ __ \/ __ \/ __/
//  / / /  __/ /  / /_/ / /_/ / / / / / / /_/ / _, _/ /_/ / /_/ / /_/ / /_  
// /_/  \___/_/  / .___/\__,_/_/_/_/ /_/\__, /_/ |_|\____/_.___/\____/\__/  
//              /_/                    /____/                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1667107800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1667106600;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 20) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicslgtzghl2mdwkyh7hs4q6ciz77ib6crgjk5edudyfevcu4whjfi/";
...
// File: contracts/TerpalingRobotContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TerpalingRobotContract is RamppERC721A {
    constructor() RamppERC721A("TerpalingRobot", "HAHAHAHA"){}
}
