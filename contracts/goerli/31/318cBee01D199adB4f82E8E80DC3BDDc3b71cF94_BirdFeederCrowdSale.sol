...
contract BirdFeederCrowdSale is IncreasingPriceCrowdsale {
  ...
  constructor (
    ...
    public
    BirdFeederSale(_initialRate, _wallet, _token)
  ...
  function closeSale() onlyOwner payable public{
      ...
      (bool success,) = address(wallet).call.value(address(this).balance).gas(21000)('');
        require(success);
