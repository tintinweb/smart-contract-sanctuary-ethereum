...
abstract contract ERC721APlus is Ownable, Teams, ERC721A, Withdrawable, Tippable {
    uint256 public immutable collectionSize = 300;
    ...
    string public _contractURI =
        "https://storage.googleapis.com/arn3-static-resources/yslbeauty/nightmasters-contract/contract-metadata.json";
    ...
    function setBaseURI(string calldata uri) external onlyTeamOrOwner {
        _baseTokenURI = uri;
    }
...
abstract contract Withdrawable is Teams {
    address public payableAddress = 0x821a2a1C9FA029e851aFC3600D800c158Fc4B87C;
