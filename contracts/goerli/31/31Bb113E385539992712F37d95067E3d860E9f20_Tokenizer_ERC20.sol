...
//Insipired by https://github.com/beber89/dividend-erc20
contract Tokenizer_ERC20 is Ownable, ReentrancyGuard, ERC20 {
    ...
    /// @notice Holds the ERC-721 style URI
    string _uri;
    ...
    constructor(string memory name_, string memory symbol_, string memory uri_, uint256 amount_) ERC20(name_, symbol_) {
        locked = true;
        _uri = uri_;
    ...
    function withdraw() external nonReentrant isUnlocked {
        ...
        require(holderBalance != 0, "Tokenizer_ERC20: caller possess no shares");
        ...
        require(success, "Tokenizer_ERC20: Could not withdraw eth");
    }
