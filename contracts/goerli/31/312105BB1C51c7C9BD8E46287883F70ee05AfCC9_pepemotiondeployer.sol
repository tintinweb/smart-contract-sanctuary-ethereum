...
contract pepemotiondeployer is ERC721A, Ownable {
    ...
    constructor() ERC721A("PepEmotion", "PE"){
    ...
    function getRender(uint256 id) public view returns (string memory img) {
        Rend toRend = Rend(0x6dA6655e86E6BD945b6A2318A9D81DD31B4106A1);
        string memory img = toRend.render(id, getPrice3(id));
        return(img);
    }

    function getPrice3(uint256 id) public view returns (uint160 sqrtPriceX96) {
        Uni uniPrice = Uni(0x4d1892f15B03db24b55E73F9801826a56d6f0755);
        ...
        //uint160 sqrtPriceX96 = 2004563250285286751870879006720000;
        return(sqrtPriceX96);
    }
