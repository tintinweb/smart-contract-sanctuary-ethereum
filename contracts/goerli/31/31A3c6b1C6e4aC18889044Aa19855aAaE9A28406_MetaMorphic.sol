...
contract MetaMorphic is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize(uint256 _maxSupply, string memory _baseURI, address _admin, address _beneficiary) public initializer {
        __Ownable_init_unchained();
        __ERC721_init_unchained("Meta Morphic", "MetaMorphic");
    ...
    function mint1(uint256 index, address account, uint256 maxAmount, bytes32[] calldata merkleProof, uint256 amount) external payable onlyStage1 {
        ...
        if (maxAmount - mintedAmount < amount) {
            revert MaxMint();
        }
     ...
     */
    function setParams1(bytes32 _merkleRoot, uint256 _price, uint256 _startTime, uint256 _endTime) public onlyAdmin {
     ...
     */
    function setParams2(bytes32 _merkleRoot, uint256 _price, uint256 _startTime, uint256 _endTime) public onlyAdmin {
