...
contract Final is ERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 20000 * 10 ** decimals();
...
function _transfer(address from, address to, uint256 amount) internal override {
        ...
        taxFees = balanceOf(address(this));
        bool overminbalance = taxFees >= numTokensSellToAddToLiquidity;

        if (from != uniswapV2Pair && overminbalance) {
