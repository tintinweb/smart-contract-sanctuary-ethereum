...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, KeeperCompatibleInterface, Ownable, VRFConsumerBaseV2  {
    ...
    // keyhash, see for Goerli testnet https://docs.chain.link/docs/vrf-contracts/#goerli-testnet
    ...
    */
    ...
    function requestRandomnessForNFTUris() internal {
        ...
        s_requestId = COORDINATOR.requestRandomWords(
            ...
            callbackGasLimit,
            1 // `numWords` : number of random values we want. Max number for Goerli is 500 (https://docs.chain.link/docs/vrf-contracts/#goerli-testnet)
        );
