...
import "./interfaces/IXinobiAccessControl.sol";

contract XinobiAccessControl is AccessControl, Ownable, IXinobiAccessControl {
    bytes32 public ADMIN = "ADMIN";
    bytes32 public BROKER = "BROKER";

    constructor(address[] memory admins) {
        _setRoleAdmin(ADMIN, DEFAULT_ADMIN_ROLE);
        _setRoleAdmin(BROKER, ADMIN);
    ...
    modifier notAdminRole(bytes32 role) {
        require(role != ADMIN, "only owner can add to admin role");
        _;
    }
