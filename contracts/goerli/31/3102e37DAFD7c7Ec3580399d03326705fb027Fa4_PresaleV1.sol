    ...
    PausableUpgradeable
{
    ...
    function initialize(
        ...
        salePrice = 0.08 * (10**18); //0.08 USD
        totalTokens = 120_000_000; // 120 Million
        inSale = totalTokens;
        baseDecimals = (10**18);
    ...
    {
        uint256 totalSold = totalTokens - inSale; // 120 - 90

        if (totalSold + _amount <= 60_000_000) {
            ...
            if (totalSold + _amount >= 60_000_000 || totalSold + _amount <= 100_000_000) {
                _salePrice = 0.10 * (10**18);

                return(_amount * _salePrice);
       
            } else if(totalSold >100_000_000) {
                _salePrice = 0.12 *  (10**18);
                return(_amount * _salePrice);           
            }
        }
    }
