...
contract NyxAllocationProposal is NyxProposal {
        ...
        returns (AllocationProposalParams memory)
    {
        ...
        return AllocationProposalParams(bytesToUint(params[0]),
    ...
    function getProposal(bytes memory proposalBytes)
        ...
        returns (bytes[] memory)
    {
        AllocationProposalParams memory params = parseProposalParams(proposalBytes);
        ...
        returns (bytes[nparams][] memory props)
    {
        ...
        {
            AllocationProposalParams memory params = parseProposalParams(proposalBytesArr[idx]);
...
abstract contract NyxProposal is Ownable, Converter {
    // Proposal Creators
    /////////////////////
