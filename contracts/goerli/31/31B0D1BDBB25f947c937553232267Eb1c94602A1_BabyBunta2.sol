...
abstract contract BabyBunta2State {
    ...
    address public constant WITHDRAW_ADDRESS =
        0x158a3D60565D59A487C8cBfd4c4Ef9a272c8c82b;
    ...
    uint256[3] public timeStart = [
        1669719600, /* 11/29 2000 */
        1669806000, /* 11/30 2000 */
        1669892400 /* 12/1 2000*/
    ];
    ...
    ///////////////////////////////////////////////////////////////////////////
    error ZeroAddress();
    error InvlidRoyalityFee(uint256 fee);
    error SaleIsPaused();
    ...
    ERC721Psi
{
    ...
    function setLoyalityAddress(address _new) external onlyAdmin {
        if (_new == address(0)) revert ZeroAddress();
        royaltyAddress = _new;
    }

    function setLoyalityFee(uint96 _new) external onlyAdmin {
        if (_new >= 10000) revert InvlidRoyalityFee(_new);
        royaltyFee = _new;
    }
    ...
    function setTimeDuration(uint256 index, uint256 newDuration) external onlyAdmin {
    ...
    modifier whenOnSale() {
        if (paused) {
            if (!usePeriodSale) {
                ...
                if ( block.timestamp > start + timeDuration[phase]) revert SaleIsPaused();
            }
        }
        _;
    }
...
contract BabyBunta2 is BabyBunta2Admin {
    ...
    constructor() ERC721Psi("BBCTest", "BBCT") {
