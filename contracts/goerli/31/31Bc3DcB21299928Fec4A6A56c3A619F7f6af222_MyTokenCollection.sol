...
// [ ] Change the editor to @pxxxx_io
// [ ] Change contract name: MyTokenCollection.
// [ ] Change contract name: MyToken.
// [ ] Change contract abbrev. name: MT.
// [ ] Change baseURI in baseURI = "ipfs://mynft.io/meta/";
// [ ] Change craftBaseURI in craftBaseURI = "ipfs://mynftcraft.io/meta/";
// [ ] Change whitelistMerkleRoot in merkleRwhitelistMerkleRootoot = 0x42e089ff413a4f412fc90163cc749d032a00e636391ceced4d4037681e3bfe94;
// [ ] Change waitingListMerkleRoot in waitingListMerkleRoot = 0x42e089ff413a4f412fc90163cc749d032a00e636391ceced4d4037681e3bfe94;
// [ ] Change MINT_PROVENANCE.
// [ ] Change CRAFT_PROVENANCE.
// [ ] Check MAX_SUPPLY.
// [ ] check whitelistMintStartTime.
// [ ] check waitingListMintStartTime.
// [ ] check mintStartTime.
// [ ] check craftStartTime.
// [ ] Check MINT_PER_WHITELIST_ADDRESS_LIMIT.
// [ ] Check MINT_PER_WAITING_LIST_ADDRESS_LIMIT.
...
contract MyTokenCollection is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public craftBaseURI;

  string public constant CONCEALED_TOKEN_URI = string(abi.encodePacked("ipfs://QmY1gmScR4fQ7jhoREBxa7LVpwgE2ZGTk32T57udRMXqa5"));

  // PROVENANCE: Use the same hash mechanism as BAYC's.
  string public constant MINT_PROVENANCE = "1882b4372387d44488fc0217d15b312c75e90ff6292ae6419272269b4044f113";
  string public constant CRAFT_PROVENANCE = "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855";
  ...
  constructor() ERC721("MyToken", "MT") {
    baseURI = "ipfs://QmNbxSpk5z1FqXmJmfGsA1nUsj5EaWEv2Nk2towmH6xxkt/";
    craftBaseURI = "ipfs://QmXDHy7psUeJ1EUU8zhuBvYYzVc2WLZmQcdU2eNm3AEuuZ/";
    whitelistMerkleRoot = 0xdd6feb34f5d25e6a661f96dc58370fbec87235e476f20d1eb43d2e23fe0311ec;
    waitingListMerkleRoot = 0x5d68aca2684cefc03e8f98bf2051e261cad764ae46a5aac69de2ddccd9560e00;
    whitelistMintStartTime = 1667782800;
    waitingListMintStartTime = 1667826000;
    mintStartTime = 1667833200;
