...
contract PINKY is ERC20, Ownable {
    ...
    constructor() ERC20("PINKY", "PINKY") {
        ...
        marketingWallet = address(0x44Cbde513Afda0255242e3C40d0Ba7C86b47247a); //
        devWallet = address(0x61f73fA1a8ADB87E2878B3EFf26202e91D17D7B7); //
