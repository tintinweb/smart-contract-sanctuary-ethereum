...
contract Pixlcanz is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 233;
    ...
    address[] public withdrawAddresses = [0xeC69F2414ba6E5d5c0682C41eeC9453a967323a2, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xfc33ee1bf16b63c0432cc031b7bbe9065c66fe3192279b696d827601bb905bda;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xeC69F2414ba6E5d5c0682C41eeC9453a967323a2, _royaltyAmount);
    }
