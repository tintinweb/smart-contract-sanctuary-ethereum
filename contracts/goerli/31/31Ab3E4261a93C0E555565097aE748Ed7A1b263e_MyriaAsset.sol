...
contract MyriaAsset is ERC721, Mintable, ERC721Enumerable, ERC721URIStorage { 
    ...
    constructor(
        ...
        address _myria
    ) ERC721(_name, _symbol) Mintable(_owner, _myria) {baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmPntnZozH1ZjGvwNxvp2ZnByXxQHMqo2VfBUAeppHP2go/";}
    ...
    //  MintTo function to skip L2 withdrawl time.
