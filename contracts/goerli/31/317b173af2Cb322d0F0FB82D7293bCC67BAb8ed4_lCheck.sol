...
import {Whitelist} from "../base/Whitelist.sol";

contract lCheck is ERC20 {
    uint8 private constant DECIMALS = 6;
    uint256 private constant MAX_SUPPLY = 100_000_000_000 * (10**DECIMALS);
...
contract ERC20Mintable is IERC20Mintable, Ownable, AccessControl, ERC20Pausable {
    ...
    function mint(address account, uint256 amount) external override onlyRole(MINTER_ROLE) {
        require(ERC20.totalSupply() + amount <= _maxSupply, "ERC20Mintable: max supply");
...
abstract contract Whitelist is IWhitelist, Ownable {
     ...
     */
    function addMember(address account) public override onlyOwner {
     ...
     */
    function removeMember(address account) public override onlyOwner {
