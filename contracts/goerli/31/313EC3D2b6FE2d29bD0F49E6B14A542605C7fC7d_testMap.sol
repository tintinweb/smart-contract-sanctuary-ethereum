...
contract testMap is ERC721A, ReentrancyGuard, Ownable, DefaultOperatorFilterer {
    ...
    mapping(address => mapping(uint => uint256)) public mintedClasses;
	...
	require( classCounter[0] + 1 <= limitByClass[0], "Exceeds max class supply" );
	...
	addItems( msg.sender, 1, totalSupply(), 0 );
    }
	...
	require( classCounter[_class] + 1 <= limitByClass[_class], "Exceeds max class supply" );
