  ...
  function uri(uint256 ensID) public view returns (string memory) {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        ...
        ' an 3gate.domains name","external_url":"3gate.domains","name":"',
        ensToTokenData[ensID].label,
