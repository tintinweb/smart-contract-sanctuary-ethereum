...
/** 
 * @title Use pixel cloud as default image, unless set by user.
 */
    ...
    */
    function _compileAttributes(uint256 _id) internal view returns (string memory) {
        ...
        return string(abi.encodePacked(
            ...
            ",",
            EncodeUtils.attributeForTypeAndValue(string(abi.encodePacked("L7L rewards", _suffix)), _locked ? _uint2floatstr(_l7l) : "0.00", true),
            "]"
        ));
    }
