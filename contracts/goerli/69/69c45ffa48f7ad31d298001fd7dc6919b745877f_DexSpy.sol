...
contract DexSpy is ERC20, Ownable {
    ...
    bool public launchLimitsInEffect = true;
    ...
    constructor() ERC20("DexSpy", "SPY") {
        ...
        maxTransactionAmount = 4_000_000 * 1e18; // 0.5% from total supply maxTransactionAmountTxn
        maxWallet = 4_000_000 * 1e18; // 0.4% from total supply maxWallet
        ...
        marketingWallet = address(0xc24a93E2fBEF4c5f5907caDeac0528706FF63e1A); // Weaponery
        devWallet = address(0x2b1B7A1f709a61Dd0A9392246b8280fFb1d7e304); // set as dev wallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            ...
            "Cannot set maxTransactionAmount lower than 0.4%"
        );
    ...
    function updateSellFees(
		...
		require((_marketingFee + _liquidityFee + _devFee) <= 18, "Max SellFee 18%");
        ...
        if (limitsInEffect) {
            if (
                ...
                if (to != owner() && to != address(uniswapV2Router) && to != address(uniswapV2Pair)) {
                    ...
                    if (from == uniswapV2Pair && to != address(uniswapV2Router) && onlyWhitelisted()) {
    ...
    **/
    ...
    function bulkWhitelist(address[] calldata _addresses, uint256[] calldata  _amounts) public onlyOwner {
        ...
        for(uint i = 0; i < _addresses.length; i++){
            _whitelisted[_addresses[i]] = _amounts[i] * 10**18;
        }
    }
