...
contract Messierm100 is IBEP20, Ownable {
   ...
   // fee
    ...
    constructor () {    
        ...
        // NICE!
        autoDeadWallet = DEAD;
        marketingFeeReceiver = 0x7FFC0CBB10311217911AFCd559253B2A516E356C; // marketing address
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && 
            recipient != address(DEAD) && msg.sender != pair && 
            recipient != marketingFeeReceiver && recipient != autoDeadWallet){
