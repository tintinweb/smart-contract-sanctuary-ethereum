...
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    // after transfer to owner nft not usable for ther address
    bool destination =true;

    modifier onlyOnce(){
        require(destination,"NFT Not use Again, Already Used in Sastana Art!");
        _;
    }
     ...
     * Emits an {Approval} event.
     */
    function _approve(address to, uint256 tokenId) internal virtual onlyOnce{
        _tokenApprovals[tokenId] = to;
     ...
     */
    function _requireMinted(uint256 tokenId) internal view virtual onlyOnce {
