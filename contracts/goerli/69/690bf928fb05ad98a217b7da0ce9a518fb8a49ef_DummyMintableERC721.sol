...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        // If there is a URI, return the URI.
...
interface IMintableERC721 is IERC721 {
     ...
     * @param tokenURI tokenURI being minted
     */
    function mint(address user, uint256 tokenId, string calldata tokenURI) external;
    ...
    ContextMixin
{
     ...
     */
    function mint(address user, uint256 tokenId, string calldata tokenURI) external override only(PREDICATE_ROLE) {
        _mint(user, tokenId);
    ...
    */
    function setBaseURI(string calldata baseURI_) external only(DEFAULT_ADMIN_ROLE) returns (bool)  {
