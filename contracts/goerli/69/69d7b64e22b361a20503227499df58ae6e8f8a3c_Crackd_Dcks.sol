...
// File: contracts/crackd_dcks.sol
...
contract Crackd_Dcks is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public whitecost = 0.020 ether;
  uint256 public maxSupply = 4790;
  ...
  constructor() ERC721("Crackd Dcks", "CD") {
    setHiddenMetadataUri("ipfs://QmfAvzNwJ32extumcwZjKNpVeo8CSzAqUYvH5YjMSHYHpd/hidden.json");
  }
  ...
  function Whitelist_Mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require( whitelist[msg.sender] == true);
    require(!paused, "The contract is paused!");
    require(msg.value >= whitecost * _mintAmount, "Insufficient funds!");
    require( perWallet[msg.sender] + _mintAmount <= maxMintWhiteList, "You are exceeding limit of per wallet" );
