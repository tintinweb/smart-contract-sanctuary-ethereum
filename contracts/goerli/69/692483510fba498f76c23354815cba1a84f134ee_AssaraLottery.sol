...
contract AssaraLottery is Context, Ownable{
    ...
    function CalforpayWithdraw(uint64 _tickCode, uint256 _TotalLockedTokens, uint256 _TotalVals) public view returns(uint256){
        ...
        uint256 _SumTokensPay = tokenPersonLocked.add(_PrizeStakePerson);
