...
contract RwaUrn {
    ...
    // --- init ---
    constructor(
        address vat_, address jug_, address gemJoin_, address daiJoin_, address outputConduit_, address spot_, uint256 tokenId_, bytes32 ilk_
    ) public {
    ...
    function free(uint256 wad) external operator {
        ...
        vat.frob(ilk, address(this), address(this), address(this), -int(wad), 0);
        gemJoin.exit(msg.sender, ilk, wad);
