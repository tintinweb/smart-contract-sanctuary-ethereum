...
contract WillSmithAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WillSmith AI";
    string private constant _symbol = unicode"WillSmith AI";
