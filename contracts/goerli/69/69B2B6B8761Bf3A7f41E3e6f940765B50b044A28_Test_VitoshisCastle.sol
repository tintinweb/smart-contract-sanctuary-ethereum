...
contract Test_VitoshisCastle is ERC721Enumerable, Ownable {
  ...
  bytes32 public constant merkleRoot = 0x4bd5c4832b7aebbdfd6b4912a8a8096d4d0d981fbbeb4fd9309df7a4705fda01;
  uint256 public constant TOTAL_SUPPLY_LIMIT = 300;
  uint256 public constant MINT_PRICE = 0.000000008 ether;
  uint256 public constant WHITELIST_LIMIT_PER_WALLET = 8;
  string public baseTokenURI ="someURI";
  ...
  modifier CheckSupply() {
    _;
    require(tokenID <= TOTAL_SUPPLY_LIMIT, "Max supply reached");
  }

  constructor() ERC721("Test_Vitoshis Castle", "T_VITC") {
  }
  ...
  function mintFromWhitelist(bytes32[] calldata _merkleProof,uint contestantsToMint) CheckSupply public payable {
    ...
    require(contestantsToMint + amountClaimed[msg.sender] <= 8, "Cannot Exceed 8 Per Wallet");
    ...
    amountClaimed[msg.sender] = amountClaimed[msg.sender] + contestantsToMint;
