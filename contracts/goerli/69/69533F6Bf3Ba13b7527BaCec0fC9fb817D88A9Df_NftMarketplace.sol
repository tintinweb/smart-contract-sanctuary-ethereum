...
contract NftMarketplace is ReentrancyGuard, Ownable {
    ...
    // For the front, should we create an array instead of a mapping ? NO, too much gas inefficient
    // We don't want too much to change our protocol for juste the front-end
    // Off chains services can access events though !
