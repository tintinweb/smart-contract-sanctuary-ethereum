...
contract TEST_MUSIC_NFT is ERC1155Burnable, ERC2981, Ownable, DefaultOperatorFilterer {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenCounter;

    string private _baseTokenURI = "https://example.com/contracts/ctrc-9f1388c5422981f4fea5/";
    ...
    function mint(uint256 _amount) public onlyOwner {
        ...
        require(
            _QUANTITY_LIMIT >= tokenQuantity[tokenId] + _amount,
    ...
    function addMint(uint256 _tokenId, uint256 _amount) public onlyOwner {
        ...
        require(
            _QUANTITY_LIMIT >= tokenQuantity[_tokenId] + _amount,
            "Issuance limit exceeded."
        );
