...
contract ERC20 is Context {
     ...
     */
    // Is emitted when `from` transfers `value` to `to`
     ...
     */
    // Is emitted when `owner` allows `spender` to spend `value` on his behalf 
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        // define 10^18 to display as the standard
        _decimals = 18;
    }
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenTH", "LCTH") {}
}