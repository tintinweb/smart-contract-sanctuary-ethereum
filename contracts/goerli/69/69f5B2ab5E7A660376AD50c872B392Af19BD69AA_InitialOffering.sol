...
contract InitialOffering is Ownable {
    ...
    struct IssuingData {
        // Creator of campaign
        address beneficiary;
        // admin address whom collect fees
        address admin;
        uint256 feePerThousand;
    ...
    //    uint256 public amountFees;
    //    uint256 public pledgedAfterFees;
    ...
    //        rapidBondzContract = IERC20Upgradeable(__rapidBondzContract);
    //    }



    function addStableCoinContract(
        address __stableCoin
    ) public onlyOwner {
        stableCoin = IERC20(__stableCoin);
    }

    function addRapidBondzTokenContract(
    ...
    function launch(
        ...
        // assure the launch of initial offering is in the future with 24h margin (is not already started)
...
//        require(_endAt <= block.timestamp + 90 days, "end at > max duration");
        ...
        emit Launch(_beneficiary, _admin, _feePerThousand, _minimalAmount, _maximalAmount, _startAt, _endAt);
    }
    ...
    function pledge(uint256 _amount) external {
        ...
        // require disabled for testing purpose
        //        require(block.timestamp + 60 >= initialOffering.startAt, "not started");
    ...
    function settlement() public {
        feesData.amountFees = (initialOffering.pledged * initialOffering.feePerThousand) / 1000;
        feesData.pledgedAfterFees = initialOffering.pledged - feesData.amountFees;
        ...
        stableCoin.transfer(initialOffering.beneficiary, feesData.pledgedAfterFees);
