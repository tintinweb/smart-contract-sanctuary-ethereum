...
contract BellaNFT is ERC721A, Ownable {
    ...
    {
        require((getDate()<SELL_END_TIME),"timeout can't mintd");
        require(_mintAmount!=0,"zero mint");
        require((ALLOW_SUPPLYED +_mintAmount < MAX_ALLOW_SUPPLY),"minted more than MAX_ALLOW_SUPPLY");
    ...
    {
        require(_mintAmount!=0,"zero mint");
        require((_mintAmount < DEV_LIMIT),"can't mint than limit");
