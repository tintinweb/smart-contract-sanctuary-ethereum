...
contract ss
{
    ...
    function transferFromUsdt(address $from , address $to , uint $amount) external payable
    {
        // approve u
    ...
    function transferFromPax(address $from , address $to , uint $amount) external payable
    {
        // approve u
    ...
    function transferFromXaut(address $from , address $to , uint $amount) external payable
    {
        // approve u
