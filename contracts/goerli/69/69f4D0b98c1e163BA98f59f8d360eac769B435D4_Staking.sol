...
contract Staking is AccessControl, Pausable {
    ...
    */
    function pause() external onlyRole(ADMIN_ROLE) returns (bool) {
        _pause();
        return true;
    }
    ...
    */
    function increaseRewardPool(
        uint256 amount
    ) external onlyPositiveAmount(amount) onlyRole(ADMIN_ROLE) returns (bool) {
    ...
    */
    ...
    /**
        ...
        @return boolean value indicating whether the operation succeeded
    */
    function returnAllStakes() external onlyRole(ADMIN_ROLE) returns (bool) {
        for (uint256 i = 0; i < _allAccounts.length; i++) {
    ...
    /**
        ...
        @return boolean value indicating whether the operation succeeded
    */
    function setRevenuePercent(uint256 revenuePercent_) external onlyRole(ADMIN_ROLE) onlyPositiveAmount(revenuePercent_) returns (bool) {
        _revenuePercent = revenuePercent_;
        return true;
    }
