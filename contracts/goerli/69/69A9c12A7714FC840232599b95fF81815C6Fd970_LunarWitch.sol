...
contract LunarWitch is ERC721A, DefaultOperatorFilterer, Ownable, PaymentSplitter {
    ...
    uint256 public maxTokens = 66;
    uint256 public tokenReserve = 25;

    bool public publicMintActive = false;
    uint256 public publicMintPrice = 0.002 ether;
    uint256 public maxTokenPurchase = 5;
    
    bool public presaleMintActive = false;
    uint256 public constant presaleMintPrice = 0.0015 ether;
    uint256 public constant presaleMintMax = 3;
    ...
    */
    ...
    address[] private teamWallets = [
        0xE3c223d4180BC03d7fa2350eF0148E3eA8eC0e3d, // Founder *** GOERLI ***
        0xD3EBeaABD0F749829B4e5E3a466976935B9D6bEE, // Founder *** GOERLI ***
        0x7ed64be1BBd96425Ce5074c010807B3632f8FC4D, // Partner *** GOERLI ***
        0x3426c74CdB7B677a139a702A79350fb492910921  // Project *** GOERLI ***
    ];
    uint256[] private teamShares = [3750, 3750, 500, 2000];
    ...
    constructor()
        PaymentSplitter(teamWallets, teamShares)
        ERC721A("Test 2712-01", "TEST271201")
    {}
