...
string constant CollectionName = "GM Beta4.2.0";
string constant CollectionSymbol = "GMBeta420";

contract GMB4_2_0 is ERC721, ERC721URIStorage, ERC721Enumerable, ERC721Burnable, Ownable, CantBeEvil {
    ...
    function genesisMint() public onlyCursed() {
        require ((totalSupply() < _mintLimit), "Cannot Mint: Mint limit reached");
    ...
    function remix(uint256 tokenId) public {
        ...
        // TODO: consider applying similar pattern against accounts to mints, to
        // enforce 1 mint per account with a global limit similarly
    ...
    function totalRemixes() public view returns (uint256) { // TODO: prob want to also count total remixes
