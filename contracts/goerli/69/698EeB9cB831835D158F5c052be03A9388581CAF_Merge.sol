      ...
      Base64.encode(
        bytes(
          string(abi.encodePacked(
            ...
            "viewBox=\"0 0 1024 1024\" stroke-linecap=\"round\" ",
            "xmlns=\"http://www.w3.org/2000/svg\" ",
            "xmlns:xlink=\"http://www.w3.org/1999/xlink\">",
            "<style>.small { font: 64px sans-serif; text-anchor: middle; } .merge { stroke-dasharray: 25; stroke-dashoffset: 100; animation: dash 1s linear forwards; animation-iteration-count: infinite; } @keyframes dash { to { stroke-dashoffset: 0; } }</style>",
            "<rect width=\"100%\" height=\"100%\" fill=\"black\"/>",
            "<text x=\"33%\" y=\"95%\" fill=\"white\" class=\"small\">",
            "The Merge, 5.875e22",
            "</text>",
            "<path id=\"pow\" class=\"merge\" stroke=\"red\" stroke-width=\"8\" d=\"M 0 0 C 0 0, 128 0, 128 512\" fill=\"transparent\"/>",
            "<path id=\"beacon\" class=\"merge\" stroke=\"blue\" stroke-width=\"8\" d=\"M 0 1024 C 0 1024, 256 1024, 128 512\" fill=\"transparent\"/>",
            "<path id=\"merge\" class=\"merge\" stroke=\"white\" stroke-width=\"8\" d=\"M 128 512 C 128 512, 256 0, 512 512 C 512 512, 768 1024, 1024 512\" fill=\"transparent\"/>",
            "<animate id=\"pulse\" href=\"#merge\" attributeName=\"d\" begin=\"0s;first.end\" values=\"M 128 512 C 128 512, 256 0, 512 512 C 512 512, 768 1024, 1024 512;M 128 512 C 128 512, 128 0, 512 512 C 512 512, 768 768, 1024 512;M 128 512 C 128 512, 256 0, 512 512 C 512 512, 768 1024, 1024 512\" dur=\"3s\" />",
            "<animate id=\"color\" href=\"#merge\" attributeName=\"stroke\" begin=\"0s;color.end\" values=\"#FFFFFF;#FF0000;#00FF00;#0000FF;#FFFFFF\" dur=\"3s\" />",
            "</svg>"
          ))
        )
      )
