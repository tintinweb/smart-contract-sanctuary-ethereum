 ...
 * @notice This contract handles minting test 1155 empty string tokens.
 */
contract Test1155EmptyString is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xE58fD48a2A4714182A6CDCbbA0680d12AcC86a0a;
    ...
    string public name = "test 1155 empty string";
    ...
    constructor() ERC1155("") {
        ...
        tokenMaxSupply[99] = 100;
        tokenURI[99] = "https://google.com";
        tokenPublicPrice[99] = 0.25 ether;
        tokenPublicMintsPerAddress[99] = 100;
        require(
