...
contract LDPSFlagship is AccessControlEnumerable, ERC721Enumerable {
    ...
    constructor() ERC721("Lent DPS Flagship", "LDPSFlagship") {
    ...
    function upgradePart(
        ...
        if (!hasRole(UPGRADE_ROLE, msg.sender) && msg.sender != address(lender)) revert Unauthorized();
        ...
        lender.upgradeFlagshipPartHook(_tokenId, _part, _level);
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        return lender.getFlagshipUri(_tokenId);
    }
    ...
    function _beforeTokenTransfer(
        ...
        lender.beforeTransferHookFlagship(_from, _to, _tokenId);
    ...
    function _afterTokenTransfer(
        ...
        lender.afterTransferHookFlagship(_from, _to, _tokenId);
