...
import "../MetaclubbersStakeHolder.sol";
...
contract StakeableNFT is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    MetaclubbersStakeHolder public stakeHolder;
    MetashotToken public currency;
    ...
    function initialize(MetashotToken _currency) initializer public {
    ...
    function setStakeHolder(MetaclubbersStakeHolder _stakeHolder) public onlyOwner {
