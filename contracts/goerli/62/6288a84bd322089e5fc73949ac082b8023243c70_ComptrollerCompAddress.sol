 ...
 * @author Compound
 */
contract ComptrollerCompAddress is ComptrollerV7Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getCompAddress() virtual public view returns (address) {
        return 0xE64b34aaDB240BB6541bE0Af796B6E55e1407351;
    }
}