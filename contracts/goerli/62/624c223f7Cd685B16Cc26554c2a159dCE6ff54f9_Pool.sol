...
abstract contract Governor {
    ...
    function _executeBallot(
        ...
        if (
            ...
            service.addEvent(IDirectory.EventType.TransferETH, proposalId, proposal.description);
        }

        if (
            proposal.proposalType == IProposalGateway.ProposalType.TransferERC20
        ) {
            service.addEvent(IDirectory.EventType.TransferERC20, proposalId, proposal.description);
        }
        ...
        if (proposal.proposalType == IProposalGateway.ProposalType.GovernanceSettings) {
            service.addEvent(IDirectory.EventType.GovernanceSettings, proposalId, "");
        }
        /*
