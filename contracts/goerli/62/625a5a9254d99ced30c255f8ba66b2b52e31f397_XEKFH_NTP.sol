...
contract XEKFH_NTP is ERC721A, ERC721AQueryable, ERC721ABurnable, IERC4906, ERC2981, Ownable, Pausable, DefaultOperatorFilterer, AccessControl {
    ...
    address private constant ADMIN_ADDRESS = 0xC27EEAeAB71718934be0EA41852d9eB885946F93;
    address private constant FUND_ADDRESS = 0x9710D13A2b9aDD48756ca4a8636a94ab1fDA2bfd;
    ...
    constructor(bool mintERC2309Flg) ERC721A("XEKFH_NTP", "XEKFHNTP") {
        ...
        _setDefaultRoyalty(0x24c6dcfD4A5cBc35b22F474803dB9C0305E8Eb41, 700);
        if (mintERC2309Flg == true) {
            _mintERC2309(ADMIN_ADDRESS, 222);
        }
    }
