...
interface ILendingPool {
    ...
    function deposit(address _reserve, uint256 _amount,address _address ,uint16 _referralCode) external payable;
...
contract EPNSCoreV1_Temp is Initializable, EPNSCoreStorageV1_5, PausableUpgradeable {
    ...
    *************** */
    ...
    function _depositFundsToPool(uint256 amount) private {
        ...
        IERC20(daiAddress).approve(provider.getLendingPoolCore(), amount);
        // Deposit to AAVE
        // lendingPool.deposit(daiAddress,address(this),amount, uint16(REFERRAL_CODE)); // set to 0 in constructor presently
    }
