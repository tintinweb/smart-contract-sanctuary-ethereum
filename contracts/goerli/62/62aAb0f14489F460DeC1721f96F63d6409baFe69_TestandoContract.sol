...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1665684240;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xCC5adAe6cE5B920FE9005eDFFa7BA29935cf2bdA];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xCC5adAe6cE5B920FE9005eDFFa7BA29935cf2bdA;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeie6hpdoyskd6fdqb33fpeb6xoled3og6z7h3zre43ba7nbkpchuea/";
...
// File: contracts/TestandoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestandoContract is RamppERC721A {
    constructor() RamppERC721A("testando", "testa"){}
}
