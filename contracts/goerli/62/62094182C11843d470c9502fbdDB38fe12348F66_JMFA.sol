...
//                                                                                                            //
//                                                                                                            //
//    This NFT is the sole license to use the attached asset. The license details are as follows:             //
//                                                                                                            //
//    The NFT owner can display this art privately and in groups with less than 100 participants,             //
//    including virtual galleries, documentaries, and essays by individuals holding the NFT.                  //
//    Ownership of this NFT provides no rights to create commercial merchandise, commercial distribution,     //
//    or derivative works.                                                                                    //
//                                                                                                            //
//    A commercial license can be agreed upon via email.                                                      //
//    Please write to the artist to request clarification or permissions regarding the                        //
...
//                                                                                                            //
//    All of my work truly comes from my heart and is much labored over in both my gut and                    //
//    my mind before it reaches a place in which I feel it is worthy of being released.                       //
//    That you've seen the value in my art, are supporting me through ownership, and are join                 //
//    my community through holding this token means the world to me.                                          //
//                                                                                                            //
//                                                                                                            //
//                                                                                                            //
//                                                                                                            //
