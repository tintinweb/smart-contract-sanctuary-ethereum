...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3dd9D183D2891B05F0D7f30834f2d8D84e30F6fA];
  address public erc20Payable = 0x3dd9D183D2891B05F0D7f30834f2d8D84e30F6fA;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 25) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbWpMYvMkWrKNEkcDZMaYuChDxh2S1qpnRWRBkbp3ot4T/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/wXeIwCJOkqj68buRmhXe/contract-metadata";
  }
...
// File: contracts/TestNft20Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestNft20Contract is RamppERC721A {
    constructor() RamppERC721A("Test NFT 20", "TEST"){}
}
