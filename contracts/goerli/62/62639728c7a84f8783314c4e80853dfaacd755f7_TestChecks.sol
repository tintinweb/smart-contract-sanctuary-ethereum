...
contract TestChecks is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    string public BaseURI="ipfs://QmX5rFpMLjs2DnH6VTXeVbXjmN272DpPeuxuy2BgNX2sWT/";

    constructor () ERC721A("TestChecks", "TEST") {
        paused = true;
    }
    ...
    modifier compliant(uint256 amount) {
        require(msg.value >= (amount - freeMintAmountPerTx) * mintPrice);
        _;
    }
