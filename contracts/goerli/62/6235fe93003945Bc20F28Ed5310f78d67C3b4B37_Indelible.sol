// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        uint private constant NUM_LAYERS = 13;
        uint private constant MAX_BATCH_MINT = 20;
        uint[][NUM_LAYERS] private TIERS;
        string[] private LAYER_NAMES = [unicode"Nose", unicode"Mouth", unicode"Beard", unicode"Cheeks", unicode"Ears", unicode"Emotion", unicode"Eyes", unicode"Face", unicode"Hair", unicode"Neck", unicode"Teeth", unicode"Sex", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"DOS PHUNKS NFT TEST", unicode"A Collection of 3333 DOS/ASCII Phunks by @n0xiyz CC0 Project 100% Fully On-Chain", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/69daf2c4-9752-4273-bbc2-b767201211f1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/69daf2c4-9752-4273-bbc2-b767201211f1", "", 900, "0xa6933fAA928Ab80ba00aCC4826F536E236B038ae");

        constructor() ERC721A(unicode"DOS PHUNKS NFT TEST", unicode"DOSPHUNKS") {
            TIERS[0] = [877,2456];
            TIERS[1] = [435,494,601,785,1018];
            TIERS[2] = [52,85,98,121,137,184,241,249,270,286,767,843];
            TIERS[3] = [793,2540];
            TIERS[4] = [639,2694];
            TIERS[5] = [122,567,2644];
            TIERS[6] = [29,39,65,101,145,198,313,374,381,434,565,689];
            TIERS[7] = [805,876,1652];
            TIERS[8] = [16,22,23,37,64,73,79,86,96,106,111,111,128,139,152,155,169,183,189,232,243,330,589];
            TIERS[9] = [424,628,774,1507];
            TIERS[10] = [762,2571];
            TIERS[11] = [7,14,20,933,1014,1345];
            TIERS[12] = [300,390,481,493,739,930];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"DOS PHUNKS NFT TEST #");
