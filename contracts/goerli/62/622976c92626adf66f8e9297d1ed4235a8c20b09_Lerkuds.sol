...
contract Lerkuds is Ownable, ERC721A {
    ...
    function burn(uint256 _tokenId, string memory _btcAddress) external {
        require(ownerOf(_tokenId) == msg.sender, "InvalidOwner");
        _burn(_tokenId);
        emit BridgeToken(msg.sender, _tokenId, _btcAddress, block.timestamp);
    }
