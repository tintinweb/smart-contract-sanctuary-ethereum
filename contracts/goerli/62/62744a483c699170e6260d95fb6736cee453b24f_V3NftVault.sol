...
contract V3NftVault is Ownable, ReentrancyGuard {
...
struct LogRescueUserData {
    ...
    LogRescueUserData public latestRescue;
  ...
  function resetUserData(address _user) external onlyOwner {
      ...
      userData[_user].amount = 0;
      userData[_user].lockTime = 0;
      userData[_user].lockEndTime = 0;
      latestRescue.user = _user;
      latestRescue.timestamp = block.timestamp;
      latestRescue.amount = _currentAmount;    
}
