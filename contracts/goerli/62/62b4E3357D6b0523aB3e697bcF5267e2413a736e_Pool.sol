...
abstract contract Governor {
        ...
        returns (ProposalState)
    {
        ...
        if (
            totalCastVotes * 10000 >= quorumVotes &&
...
interface IDispatcher {
    ...
    function validateTGEInfo(ITGE.TGEInfo calldata info, address token_) external view returns (bool);
...
interface IGovernanceToken is IERC20Upgradeable {
    ...
    function initialize(address pool_, string memory symbol_, uint256 cap_) external;
...
interface IService {
    function initialize(
        ...
        address tgeBeacon_,
        address preferenceTokenBeacon_,
        address preferenceTGEBeacon_,
    ...
    function createSecondaryTGE(ITGE.TGEInfo calldata tgeInfo, bool isPreferenceTokenCreation) external;
...
interface ITGE {
    ...
    function lockupTVLReached() external view returns (bool);
}
