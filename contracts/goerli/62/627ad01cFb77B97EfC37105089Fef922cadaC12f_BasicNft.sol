 ...
 * {ERC721Enumerable}.
 */
contract ERC7211 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function approve(address to, uint256 tokenId) public virtual override {
    address owner = ERC7211.ownerOf(tokenId);
  ...
  function _approve(address to, uint256 tokenId) internal virtual {
    ...
    emit Approval(ERC7211.ownerOf(tokenId), to, tokenId);
  }
