...
contract Poker is Ownable, ReentrancyGuard{
    ...
    function setDefaultSettings(uint96 defaultWithdraftDelay) public onlyOwner {
    ...
    function setUserSettings(address user, uint96 withdraftDelay) public onlyOwner {
    ...
    function resetUserSettings(address user) public onlyOwner {

        UserSettings storage _UserSettings = UsersSettings[user];

        /*
        _UserSettings.withdraftAmountLimit = 0;
        _UserSettings.withdraftAmountFrom = 0;
        _UserSettings.topupAmountFrom = 0;
        _UserSettings.withdraftPeriod = 0;
        */
        _UserSettings.withdraftDelay = 0;
    ...
    function getUserSettings(address user) public view returns(bool, uint96, uint256, uint256, uint256){
        ...
        */
        ...
        return(_UserSettings.freeze, withdraftDelay, _UserSettings.balance, _UserSettings.requestTime, _decimals);
