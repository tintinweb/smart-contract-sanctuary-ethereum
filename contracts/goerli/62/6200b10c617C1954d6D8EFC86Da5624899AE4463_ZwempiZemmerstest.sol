...
contract ZwempiZemmerstest is ERC721A, Ownable, ReentrancyGuard {

    using Strings for uint256;

    // CONFIG
    mapping(address => uint) public mintedPerAddress;
    string internal baseUri = "ipfs://bafybeigkg2xe7wvpb73foqcfbkkpzjtcxuxphiqlmux7xex5gcguygalte/";
    uint256 public mintCost = 0.001 ether;
    uint256 public maxSupply = 5000;
    uint256 public maxPerTXN = 5;
    bool private saleStarted = false;
    
    constructor() ERC721A("Zwempi Zemmers test", "ZZT") {}
    ...
    function mintModifier(uint256 _amount) internal {
        require(_amount <= maxPerTXN && _amount > 0, "Max 5 per Wallet.");
        uint256 free = mintedPerAddress[msg.sender] == 0 ? 1 : 0;
        require(msg.value >= mintCost * (_amount - free), "First mint is free, the rest is 0.0001 ETH.");
