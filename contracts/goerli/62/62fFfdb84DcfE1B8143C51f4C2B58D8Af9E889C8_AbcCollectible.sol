...
contract AbcCollectible is ERC721, VRFConsumerBase {
    ...
    /**
     * Creates a collectible using ChainlinkVRF as RNG
    ...
    /**
     * The oracle fulfills the RNG request and returns the generated number
    ...
    /**
     * If the given spender is authorized to, set the tokenId to the tokenURI
    ...
    /**
     * Checks wether the given spender can transfer a given token ID
     * @param tokenId - ID of the collectible
     */
