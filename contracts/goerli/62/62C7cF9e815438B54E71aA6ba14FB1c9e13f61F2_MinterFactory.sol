...
contract MinterFactory is IRoles {
  ...
  constructor (address _admin, address _dev) {
    ...
    _logic = address(new ERC1155Minter());
  }
...
/*
    address proxy = deployBeaconProxy(
                      _logic
                    , payload(_backend, _dev, _admin, _start, _end)
                    );
*/
    emit MinterCreated(address(proxy));
