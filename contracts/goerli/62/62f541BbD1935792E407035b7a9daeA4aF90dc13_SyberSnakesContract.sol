...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xBfF2175c1ff64AE23FEa0e5A532C57c030995C90];
  address public erc20Payable = 0xBfF2175c1ff64AE23FEa0e5A532C57c030995C90;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 888) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeih3ygj2urbwlw2kmjzxa34ijpxewwdyolpkeibjaaqnprpkhjky7m/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/VaxubHuSrGHyzaqNTEm2/contract-metadata";
  }
...
// File: contracts/SyberSnakesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SyberSnakesContract is RamppERC721A {
    constructor() RamppERC721A("Syber Snakes", "SNAK"){}
}
