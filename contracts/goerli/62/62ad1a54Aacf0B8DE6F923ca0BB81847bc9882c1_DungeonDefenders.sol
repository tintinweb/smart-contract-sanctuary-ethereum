...
contract DefenderFactory is ContractUtils, Ownable {
    ...
    function _createDefender(bytes32 _name) internal returns (uint) {
        ...
        defenders.push(Defender(
            _name,
            1,
            _generateRandomUintValueInBounds(_name, tokenId, "CHARACTER_TYPE", 0, NUM_OF_CHARACTER_TYPES),
            _generateRandomUintValueInBounds(_name, tokenId, "HEALTH", INIT_ATTR_MIN, INIT_ATTR_MAX),
            _generateRandomUintValueInBounds(_name, tokenId, "SPEED", INIT_ATTR_MIN, INIT_ATTR_MAX),
            _generateRandomUintValueInBounds(_name, tokenId, "STRENGTH", INIT_ATTR_MIN, INIT_ATTR_MAX),
            _generateRandomUintValueInBounds(_name, tokenId, "DEFENSE", INIT_ATTR_MIN, INIT_ATTR_MAX),
            0,
            0
        ));
        aesthetics.push(Aesthetics(
            0,
            0,
            0,
            0,
