...
contract ERC721StakingDeployer is Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    function deploy(
        ...
        if (_price > 0) {
            (bool approved) = usdc.approve(address(this), _price);
            require(approved, "Not Approved");
            (bool sent) = usdc.transferFrom(msg.sender, address(this), _price);
        ...
        // transfer ownership
        ERC20Token(_erc20Contract).transferOwnership(msg.sender);
