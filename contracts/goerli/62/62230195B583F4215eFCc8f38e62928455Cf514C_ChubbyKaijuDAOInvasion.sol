...
import "IERC721.sol";
import "IChubbyKaijuDAOGear.sol";
/***************************************************************************************************
...
contract ChubbyKaijuDAOInvasion is ERC721Enumerable, Ownable{
    ...
    IChubbyKaijuDAOGear private chubbykaijudaogear;

    constructor(address _serumAddress) ERC721("ChubbyKaijuDAOInvasion", "CKAIJU2"){
        chubbykaijudaogear = IChubbyKaijuDAOGear(_serumAddress);
    }
    ...
    function mutateWithSerum(uint256 typeId, uint256 zombieId) external {
        ...
        require(chubbykaijudaogear.balanceOf(msg.sender, typeId)>0,"Must own this type of gear");

        if(typeId == 0){ // RADIO
            chubbykaijudaogear.burnGearForAddress(typeId, msg.sender);
            alienMinted++;
