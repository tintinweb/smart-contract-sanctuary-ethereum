...
/// @title Uniswap V3 Swapper Oracle
/// @notice Oracle contract for price quoting and swapping against Uniswap V3 pools
contract SwapperOracle is ISwapperOracle {
    ...
    /// @param _UNISWAP_V3_FACTORY Uniswap v3 factory address
    /// @param _UNISWAP_V3_ROUTER Uniswap v3 router address
    constructor(IUniswapV3Factory _UNISWAP_V3_FACTORY, ISwapRouter _UNISWAP_V3_ROUTER) {
    ...
    function addNewFeeTier(uint24 _feeTier) external override {
        require(UNISWAP_V3_FACTORY.feeAmountTickSpacing(_feeTier) != 0, "SWP: INVALID FEE TIER");
        for (uint256 i; i < _knownFeeTiers.length; i++) {
            require(_knownFeeTiers[i] != _feeTier, "SWP: TIER ALREADY SUPPORTED");
        }
    ...
    function _quote(
        ...
        require(_pools.length > 0, "SWP: NO DEFINED POOLS");
