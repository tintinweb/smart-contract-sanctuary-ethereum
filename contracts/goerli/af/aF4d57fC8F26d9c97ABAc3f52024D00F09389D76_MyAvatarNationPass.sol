...
contract MyAvatarNationPass is ERC721A, Ownable {
     ...
     */
    function guardianMint(uint256 _mintAmount, bytes memory signature)
        external
        payable
    {
        ...
        require(
            guardiansMinted + 1 <= GUARDIAN_MAX_SUPPLY,
     ...
     */
    function whitelistSigned(address sender, bytes memory signature)
        private
        view
        returns (bool)
    {
     ...
     */
    function ownersOf(uint256[] memory tokenIds)
        public
        view
