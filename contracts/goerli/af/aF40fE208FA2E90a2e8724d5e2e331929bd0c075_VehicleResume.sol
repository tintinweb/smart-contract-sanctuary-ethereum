...
contract VehicleResume is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function safeMintWithMetadata(
        ...
        _setValue(tokenId, key_token_image, abi.encode(string(abi.encodePacked('http://vehicleresume.io/svg/','',ivdl))));
        //
        ...
        _setValue(tokenId, key_token_external_url, abi.encode(string(abi.encodePacked('http://vehicleresume.io/','',ivdl))));
    ...
    function updateToken(
        ...
        bytes memory ivdl = _getValue(tokenId, key_token_ivdl);
