...
library voucher{
    ...
    event buyShare(address seller, address buyer, uint256 amountBought);
    ...
    EIP712Upgradeable
{
        ...
        external
    {
        ...
        if (_isGlobal) {
            ...
            require(offerDetails.offeree == msg.sender, "IO"); //Invalid Offeree
            require(
    ...
    function refundFunds(
        ...
        if (_isGlobal) {
            require(offers[msg.sender].globalOffers[_OfferNo] != 0, "IO"); //Invalid Offer No.
            require(offers[msg.sender].globalOffers[_OfferNo] > 0, "AR"); //Already Refunded
            uint256 paidPrice = offers[msg.sender].globalOffers[_OfferNo];
            ...
            offers[msg.sender].globalOffers[_OfferNo] = 0;
            IERC20(usdc).transfer(msg.sender, refundPrice);
        } else {
            require(offers[msg.sender].singleOffers[_OfferNo] != 0, "IO"); //Invalid Offer No.
            require(offers[msg.sender].singleOffers[_OfferNo] > 0, "AR"); //Already Refunded
            uint256 refundPrice = offers[msg.sender].singleOffers[_OfferNo];
            offers[msg.sender].singleOffers[_OfferNo] = 0;
            IERC20(usdc).transfer(msg.sender, refundPrice);
        }
    }
    ...
    function setAdmin(address _newAdmin) external onlyOperator {
        ...
        admin = _newAdmin;
        emit voucher.newAdmin(_newAdmin);
    }
