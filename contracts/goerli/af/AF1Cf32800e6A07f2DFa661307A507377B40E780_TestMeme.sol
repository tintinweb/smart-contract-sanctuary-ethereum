...
contract TestMeme is ERC20, Ownable {
    ...
    uint256 public constant buyOperationsFee = 0;

    //zero sell fees applied
    ...
    uint256 public constant sellOperationsFee = 0;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForOperations += (fees * sellOperationsFee).div(sellTotalFees);
            }
            // on buy
                ...
                tokensForOperations += (fees * buyOperationsFee).div(buyTotalFees);
            }
