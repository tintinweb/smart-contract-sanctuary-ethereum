...
contract MyCryptoNinja is ERC721A, Ownable {
    ...
    uint256 public whitelistStartTime = 1667480400 - 30; // Nov 3 2022 20:00:00 GMT+07 - 30s

    uint256 public publicStartTime = 1667484000 - 30; // Nov 3 2022 21:00:00 GMT+07 - 30s
    ...
    uint256 constant public DAY_SECOND = 60;
    ...
    constructor(string memory baseTokenURI_, bytes32 merkleRoot_) ERC721A("MyCryptoNinja", "MCN") {
    ...
    function publicMint(uint256 quantity) external callerIsUser payable {
        require(block.timestamp >= publicStartTime || whitelistMinted >= 2000, "Not in public stage");
        require(_totalMinted() + quantity <= maxSupply, "Exceed supply");
