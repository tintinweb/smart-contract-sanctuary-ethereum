...
contract GoldenSlags is ERC20, ERC20Burnable, Ownable {
    ...
    mapping(address => bool) public mintingAccess;
    constructor() ERC20("GoldenSlags", "GS") {}

    modifier isAllowed() {
        require(mintingAccess[msg.sender], "You don't have access");
        _;
    } 

    function addAccess(address _accessor) public onlyOwner {
        mintingAccess[_accessor] = true;
    }
    
    function mint(address to, uint256 amount) public isAllowed {
        _mint(to, amount);
    }
}
...
contract NFTStaker is Ownable {
    ...
    constructor() {
        ...
        rewardToken = GoldenSlags(0x356996917156D5e953B9a48f51FFdc109cdDCDda);
        nftToken = ERC721(0x675db9248A462CE3481a9708B0C63E01A7959260);
    }
