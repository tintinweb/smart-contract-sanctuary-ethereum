...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, AutomationCompatibleInterface, VRFConsumerBaseV2 {
    ...
    */
    ...
    AggregatorV3Interface public priceFeed = priceFeed = AggregatorV3Interface(0xA39434A63A52E749F02807ae27335515BA4b07F7);
    int public currentPrice = getLatestPrice();

    // VRF
    VRFCoordinatorV2Interface public COORDINATOR = VRFCoordinatorV2Interface(0x2Ca8E0C643bDe4C2E08ab1fA0da3401AdAD7734D);
    uint256[] public s_randomWords;
    uint256 public s_requestId;
    uint32 public callbackGasLimit = 500000; // set higher as fulfillRandomWords is doing a LOT of heavy lifting.
    uint64 private s_subscriptionId = 4657; // private.
    ...
    string[] bullUrisIpfs = [
        "https://ipfs.filebase.io/ipfs/bafkreifd7e7zmbdujgek25xfiwyfxsxs54raub25mhgonqcwa2v7m5u7um?filename=gamer_bull.json",
        "https://ipfs.filebase.io/ipfs/bafkreidicvtx6wvenwdki3kpqasbtyvhkkmpsla3kbexvxihrlt44s6vsm?filename=party_bull.json",
        "https://ipfs.filebase.io/ipfs/bafkreihafahupy763xdycy4buy5yxmjamo7hzids277qtlwtwnf5mf5tcu?filename=simple_bull.json"
    ];
    string[] bearUrisIpfs = [
        "https://ipfs.filebase.io/ipfs/bafkreialva6e4cxkbrndp25elz32hvw5waov3m3ksmcnle2pewhmymlvym?filename=beanie_bear.json",
        "https://ipfs.filebase.io/ipfs/bafkreiciktjlk6rvcto6gmyb4c3khddkt4ag3qs6pxt52dq5c7hmrpn3uy?filename=coolio_bear.json",
        "https://ipfs.filebase.io/ipfs/bafkreib3hxifmpfwatuosybzzggsxrxpeovdte5owgfzqkqrlnssmrwirm?filename=simple_bear.json"
    ];

    event TokensUpdated(string marketTrend);

    constructor() VRFConsumerBaseV2(0x2Ca8E0C643bDe4C2E08ab1fA0da3401AdAD7734D) ERC721("Bull&Bear", "BBTK") {
