...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    constructor() ERC20("Zee", "ZEE") {
        ...
        uint256 _buyTreasuryFee = 13;
        uint256 _buyLiquidityFee = 0;
        uint256 _buyDevFee = 0;

        uint256 _sellTreasuryFee = 13;
    ...
    function reduceBuyFees(uint256 _treasuryFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
    ...
    function reduceSellFees(uint256 _treasuryFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
