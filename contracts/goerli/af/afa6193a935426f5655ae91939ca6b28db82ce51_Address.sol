...
contract TheSmokers is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 333;
    uint public PRESALE_LIMIT = 333;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 0;
    uint256 public PRICE = 3000000000000000; //0.003 eth
    ...
    constructor() ERC721("TheSmokers", "TS") {}
