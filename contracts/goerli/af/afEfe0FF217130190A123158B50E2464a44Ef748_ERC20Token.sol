...
contract ERC20Token is NonReentrant, ERC20TokenAutoProxy, IERC20Token {
    ...
    constructor(
        ...
        eRC20TokenStorage = new ERC20TokenStorage(_airdropService, _name, _symbol, _decimals);
    }
    ...
    function burn(address recipient, uint256 amount) external onlyERC20TokenOwner {
        _burn(recipient, amount);
        IERC20TokenGovernedProxy(proxy).emitTransfer(recipient, address(0x0), amount);
    }
