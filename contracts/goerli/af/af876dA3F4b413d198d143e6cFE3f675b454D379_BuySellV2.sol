    ...
    IERC721ReceiverUpgradeable
{
    ...
    function changeDefaultFeePercentages(uint32 newDefaultFeePercentages)
        external
        onlyOwner isPercentageInBounds(newDefaultFeePercentages)
    {
    ...
    function changeFirstOwnerFeePercentage(uint32 newFirstOwnerFeePercentage)
        external
        onlyOwner isPercentageInBounds(newFirstOwnerFeePercentage)
    {
    ...
    function _payFeesAndSeller(
        ...
        _payout(nftContractAddress, tokenId, defaultFeeRecipient, fee);
        _payout(
            nftContractAddress,
            tokenId,
            nftSeller,
    ...
    function _payout(
        ...
        address saleERC20Token = nftContractSales[nftContractAddress][tokenId]
            .ERC20Token;
