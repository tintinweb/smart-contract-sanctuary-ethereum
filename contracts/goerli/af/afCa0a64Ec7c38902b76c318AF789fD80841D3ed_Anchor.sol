...
contract Anchor {
    ...
    constructor() {
        ...
        transparentProxy = 0x887E3Cb462BbdED7D3030A99A21626B36Bad2B65 ;

    }

   function getCurrentImplementation() public view returns (address){               
        return IProxy(0x2fDeF7b501250C2187c9f86c5fC633eD372b81F9).getProxyImplementation(transparentProxy); // Proxy Admin
   }
   ...
   function storeOracleData(string memory _feeds, bool flag, uint targetDB) public returns(string memory){
       return ISupra(getCurrentImplementation()).storeFeed(_feeds, flag, targetDB); // Supra V1
   }
