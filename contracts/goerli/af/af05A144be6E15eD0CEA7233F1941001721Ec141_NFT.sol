...
contract NFT is ERC721, Ownable {
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= MAX_MINT_PER_TX, "You cannot mint a maximum of 10 NFT's in one transaction.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xEc375667b52AAaa42211B73eB15fAd6bcc5ced4A).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xEc375667b52AAaa42211B73eB15fAd6bcc5ced4A).call{value: balanceTwo}("");
