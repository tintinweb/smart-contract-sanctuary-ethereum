...
contract elonminatitwo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Elonminati2.0";
    string private constant _symbol = unicode"ELONMINATI2";
