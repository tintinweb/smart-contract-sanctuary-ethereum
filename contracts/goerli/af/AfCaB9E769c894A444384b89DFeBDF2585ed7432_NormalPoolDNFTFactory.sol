...
//    mapping(uint256 => uint256) upgadeValidUntil;
...
//        address ownerOf = IERC721(this).ownerOf(tokenId);
//        require(whiteListMap[ownerOf], "Not Selected WhiteList Builder.");
//        uint256 prePaidSubscriptionFee = highestOffer * taxNumerator * 365 days / taxDenominator;
//        require(msg.value >= prePaidSubscriptionFee, "Not sufficient fund for the upgrade.");
//
//        //TODO: distribute the profit but delay it.
//        //TODO: do the NFT type upgrade.
//    }
//
    ...
    function taxOwed(uint256 tokenId) public view returns (uint256) {
        if(ownerOf(tokenId) == address(this) || !_exists(tokenId)) {
            return 0;
        }
