...
contract ERC721A is IERC721A, Ownable {
    ...
    // Boolean mapping for operator address
    mapping(address => bool) public operatorBanned;
     ...
     */
    function setOperatorBanState(address operator, bool banned)
        public
        onlyOwner
    {
        operatorBanned[operator] = banned;
    }
    ...
    function approve(address to, uint256 tokenId)
        ...
        override
    {
        require(operatorBanned[to] == false, "This contract is banned");
    ...
    function setApprovalForAll(address operator, bool approved)
        ...
        override
    {
        require(operatorBanned[operator] == false, "This contract is banned");
