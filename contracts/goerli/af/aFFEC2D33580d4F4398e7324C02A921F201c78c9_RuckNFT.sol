...
/// @title RuckNFT
/// @author RuckPlus, Inc.
/// @notice It is a smart contract with basic functions to provide NFT
contract RuckNFT is
    Ownable,
    ReentrancyGuard,
    Pausable,
    ...
    ERC2981
{
    ...
    constructor(
        uint256 _stageZeroStartTime,
        uint256 _stageFirstStartTime,
        uint256 _stageSecondStartTime,
        uint256 _stageThirdStartTime
    ) ERC721A("RuckNFT", "RUCK") {
        ...
        stages.push();
        stages[0].startTime = _stageZeroStartTime;
        stages[0].priceWei = 0;
        ...
        stages.push();
        stages[1].startTime = _stageFirstStartTime;
        ...
        // Stage 2: Public sale
        stages.push();
        stages[2].startTime = _stageSecondStartTime;
        ...
        stages.push();
        stages[3].startTime = _stageThirdStartTime;
        stages[3].priceWei = 0;
    ...
    function mint(address to, uint256 quantity) public whenNotPaused {
