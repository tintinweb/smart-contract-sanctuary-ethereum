...
// File: @openzeppelin/[email protected]/interfaces/IERC2309.sol
...
// import "OpenZeppelin/[email protected]/contracts/interfaces/IERC2309.sol";
// import "OpenZeppelin/[email protected]/contracts/utils/structs/BitMaps.sol";
// import "OpenZeppelin/[email protected]/contracts/utils/Checkpoints.sol";
...
contract ERC721CE is ERC721, IERC721Enumerable, IERC2309 {
    ...
    // number of tokens minted byond consecutive range
    uint256 private _mintCounter;
    // number of token burned inside consecutive range
        ...
        returns (uint256)
    {
        ...
        if (virtual_index == 0) {
            ...
            return virtual_index - 1; //overflow is imposible becuase the virtual_Index is not 0
        }
    }
...
// File: ConsecutiveEnumerable.sol
...
contract ConsecutiveEnumerable is ERC721CE, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // mapping(uint256 => color) private colorMap;
    ///
    string private name_ = "ConsecutiveEnumerable";
    string private symbol_ = "ERC721CE";
    address[] private receivers = [0xEAb057eB4259F482751970c3B1A5482c807D6ab2,0xB26A40d0E6a55859701aa9850BBD37DeC40Bd41c,0xbB4Df52E4C0F6fFb73b0F270ca0d34092863D5B0];
    uint96[] private amounts = [7000,5000,4999];
    //
    ...
    constructor()
        ERC721CE(name_, symbol_, receivers, amounts)
    {}
    ...
    function mintTokenId(uint256 tokenId) external virtual nonReentrant{
