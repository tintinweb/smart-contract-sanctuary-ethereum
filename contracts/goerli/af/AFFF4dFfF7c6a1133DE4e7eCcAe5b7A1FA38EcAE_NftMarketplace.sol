...
contract NftMarketplace is ERC721URIStorage, ReentrancyGuard {
    ...
    function updateListingPrice(uint256 _listingPrice) public payable {
        ...
        // need to get tokeid
        emit ItemListed(msg.sender, owner, 11, listingPrice);
    }
    ...
    function createMarketItem(uint256 tokenId, uint256 price) private nonReentrant {
        ...
        if (msg.value != listingPrice) {
            revert NftMarketplace_PriceMustEqual(msg.value, listingPrice);
        }
        ...
        // emit ItemListed(msg.sender, address(this), tokenId, price);
    ...
    function resellToken(uint256 tokenId, uint256 price) public payable {
        ...
        _transfer(msg.sender, address(this), tokenId);
        emit ItemBought(payable(msg.sender), payable(address(this)), tokenId, price);
    }
