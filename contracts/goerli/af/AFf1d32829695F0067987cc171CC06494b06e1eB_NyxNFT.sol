...
contract NyxNFT is ERC1155Supply, Ownable
{
        ...
        private
    {
        ...
        waveMintableSupply[wave] = _waveMaxSupply - nyx_mint_pct * _waveMaxSupply / 100;
        ...
        public onlyApproved
    {
        ...
        uint256 mint_amount = waveCurrentSupply[wave] * nyx_mint_pct / 100;
        if (mint_amount > 0)
        {
        ...
        public payable
    {
        ...
        require(waveMints[currentTokenId][recipient] + nMint <= max_holding, "Max holded NFTs is reached");
        ...
        public payable
    {
        ...
        require(waveMints[currentTokenId][recipient] + nMint <= max_holding_whitelist, "Max holded NFTs is reached");
        require(msg.value >= wavePrice[currentTokenId] * nMint, "Not enough ETH to mint");
        return _mintNFT(nMint, recipient);
    }
    ...
    function withdrawOnceCall(uint256 wave)
        external onlyOwner
    {
        (uint256 allowedWithdraw, uint256 restWithdraw) = getAmountToWithdraw(wave);
