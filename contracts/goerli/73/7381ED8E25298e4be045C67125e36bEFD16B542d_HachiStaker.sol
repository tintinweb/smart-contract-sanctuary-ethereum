...
contract HachiStaker is Ownable {
    ...
    uint constant rewardDuration = 10; // Every 60 seconds
    uint private calculationFactor = 10**5;
    uint private minimumBalance = 100**5;
    //string constant public lockPeriod = '1 week';  // locked period in text to be shown by the GUI
    uint256 private contractLockPeriod = 100; // 1 week in seconds 
    ...
    */
    function getMinimummBalance() public view onlyOwner returns(uint) {
    ...
    */
    function setMinimumBalance(uint _minimumBalance) public onlyOwner {
    ...
    * returns the calculation factor
    */
    function getContractLockPeriod() public view onlyOwner returns(uint) {
    ...
    * sets the calculation factor
    */
    function setContractLockPeriod(uint _contractLockPeriod) public onlyOwner {
