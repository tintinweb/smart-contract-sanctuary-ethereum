...
contract DesignCompeNFT is ERC721URIStorage, Ownable, IERC2981 {
    ...
    constructor() ERC721("LideruTest", "LTEST") {
    ...
    function setDefaultRoyaltiesReceipientAddress(address payable defaultRoyaltiesReceipientAddress_) external onlyOwner {
        defaultRoyaltiesReceipientAddress = defaultRoyaltiesReceipientAddress_;
    }

    function royaltyInfo(uint256, uint256 salePrice_) external view override returns (address, uint256) {
        return (defaultRoyaltiesReceipientAddress, (salePrice_ * defaultPercentageBasisPoints) / 10000);
    }
