...
contract CantolaunchXYZ is ERC721A, Ownable, ERC2981, ReentrancyGuard {
    ...
    constructor(
        ...
        bool _startMint, 
        uint96 _defaultRoyaltyPercentBps, 
        address _defaultRoyaltyWallet, 
        string memory _contractName, 
        string memory _contractSymbol, 
        string memory _tokenPrefixURI
    ) ERC721A(_contractName, _contractSymbol) {
        maxSupply = _maxSupply;
        price = _publicPrice * 10**18;
        maxPerWallet = _maxPerWallet;
        defaultRoyaltyPercent = _defaultRoyaltyPercentBps;
        defaultRoyaltyWallet = _defaultRoyaltyWallet;
        baseURI = _tokenPrefixURI;
        isPublicMint = _startMint;
    ...
    */
    ...
    function mint(uint256 count) external payable {
        ...
        require(count <= maxPerWallet, "Exceeds max per wallet");
        require(
    ...
    */
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 _payable1 = (balance * 90) / 100;
        payable(msg.sender).transfer(_payable1);

        address _wallet2 = 0xd6e67ce446dC04dcF3F3556B8150F370D4c52A62;
        uint256 _payable2 = (balance * 10) / 100;
    ...
    */
    ...
    function setPriceWei(uint256 _price) external onlyOwner {
        price = _price;
    }
