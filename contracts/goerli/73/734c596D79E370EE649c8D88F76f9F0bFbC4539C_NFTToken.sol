    ...
    VerifySignature
{
    ...
    bytes32 public constant transferRole = keccak256("TRANSFER_ROLE");
        ...
        ERC721(_tokenName, _tokenSymbol)
    {
        ...
        _setupRole(transferRole, msg.sender);
    }
    ...
    {
        return
            string(abi.encodePacked(getBaseURI(_tokenId), _tokenId.toString()));
    }
...
contract BatchMintMetadata {
    ...
    function getBatchId(uint256 _tokenId)
        internal
        view
    ...
    function getBaseURI(uint256 _tokenId)
        internal
        view
        returns (string memory)
    {
