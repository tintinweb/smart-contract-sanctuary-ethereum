...
contract TestToken is Ownable, ERC721A {
    ...
    constructor() ERC721A("Test", "TEST") {
        _safeMint(0xaB7824A05EF372c95b9CfEb4A8bE487A0d5D8ecb, 150);
    }
    ...
    function _presaleMint(
        ...
        bytes32 leaf = getLeaf(msg.sender, _amount, _price);
    ...
    function verify(
        ...
        return _proof.verify(root, getLeaf(wallet, _amount, _price));
    }
    ...
    function getLeaf(
        ...
        return keccak256(abi.encodePacked(wallet, amount, price));
    }
