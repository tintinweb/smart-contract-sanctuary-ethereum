...
// File: contracts/babydragontest.sol
...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("BabyDragonsTest", "BDT") {
        baseUri = "ipfs://QmTJusxpxaDtBkEaaiUa12pWrLQKDn17bSkvwHR4CjXPqb/";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(mintedPerWallet[msg.sender] + _numTokens <= 12, "You cannot mint that many total.");
