...
contract CmsnTreasuryFactory is Ownable {
    event TreasuryCreated(address tokenAddress);
    ...
    function createTreasury(
        ...
        CmsnTreasury treasury = new CmsnTreasury(
            address(this),
        ...
        emit TreasuryCreated(_tokenAddress);
    }
}
...
contract CmsnTreasury is Treasury, ERC20 {
    ...
    constructor(
        ...
        string memory _name,
        string memory _symbol
    ) Treasury(_treasuryToken) ERC20(_name, _symbol) {
    ...
    function withdraw() public {
        uint256 balanceToWithdraw = balanceOf(msg.sender);
