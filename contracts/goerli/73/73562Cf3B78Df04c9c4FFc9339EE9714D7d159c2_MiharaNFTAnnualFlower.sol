...
import "./IMiharaLimitedNFT.sol";
import "operator-filter-registry/src/DefaultOperatorFilterer.sol";


contract MiharaNFTAnnualFlower is IMiharaLimitedNFT, ERC721, Ownable, ReentrancyGuard, DefaultOperatorFilterer {

    using Strings for uint256;

    uint256 public constant PRICE = 60 ether;
    address payable public constant RECIPIENT = payable(0x9852A6f70aE998F865B16E5Bc89Bec9bAbd0a75c);


    uint256 private _remainingFree = 10;
    uint256 private _remainingSales = 10;
    bool private _isOnSale;
    uint256 private _nextTokenId = 1;

    constructor() ERC721("Mihara NFT Annual Flower", "MIHARA") {}
    ...
    //******************************
    // No transfer until sold out
    //******************************

    function _beforeTokenTransfer(address from,address to,uint256 tokenId) internal view override {
        require(from == address(0) || from == RECIPIENT || _remainingSales == 0, "No transfer until sold out");
    }
    ...
    function remainingSales() external view override returns (uint256) {
        return _remainingSales;
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory){
        ...
        return string(
            abi.encodePacked(
                ...
                Base64.encode(bytes(abi.encodePacked('{"name":"Mihara NFT Annual Flower #',  Strings.toString(tokenId),'","description": "The world\'s No. 1 garden and landscape designer Kazuyuki Ishihara aims to make Mihara-cho, his hometown, the most sacred place in the world full of flowers, greenery and smiles, and to make it a paradise.\\n\\nWe will create a town and garden that the world wants to visit, and pass on the message of love and peace from Miharacho to the world, to our children and grandchildren.","image": "https://arweave.net/iZlZ_WiHYiouxq_S03Fhd3KEJ1duVE4c7VQ868zqdQ4","attributes": [{"trait_type": "License","value": "Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)"}]}')))
            )
        );
    }
    ...
    function buy() external override nonReentrant payable {
        ...
        require(_remainingSales > 0, "Sold out");
