...
contract NemoLandV2 is Admin, ERC721Upgradeable {
    ...
    event mintDiscount(uint256 indexed orignalPrice, uint8 indexed discountPercentage, uint256 indexed currencyType);
    ...
    function mintLand(
        ...
        uint8 discountPercentage = getDiscount(msg.sender, currencyType);
        ...
        // emit discountPercentage event 
        emit mintDiscount(amtRequired, discountPercentage, currencyType);

        // give discountPercentage
        discountedPrice = amtRequired - amtRequired*discountPercentage/100;
