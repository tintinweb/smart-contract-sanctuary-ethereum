...
contract dztest is ERC721A, ERC2981, OperatorFilterer, Ownable {
    using Strings for uint256;
    address public constant TeamWallet = 0xFa82e60f3C425159f1C064A59f93D3DA41Ed18ED;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!revealed) {
            return "https://ipfs.io/ipfs/QmS9L73U7EpAyFP5doXcxB1F8TSmjVwoFmVMSsW62164XK/";
        }
    ...
    function Reserve(uint256 tokens) external onlyOwner {
        ...
        require(_walletMints[_msgSender()] + tokens <= 3000, "fail");

        _walletMints[_msgSender()] += tokens;
        _safeMint(_msgSender(), tokens);
    }
    function GinAirdrop(address _address, uint256 _amount) external onlyOwner {
        require(
