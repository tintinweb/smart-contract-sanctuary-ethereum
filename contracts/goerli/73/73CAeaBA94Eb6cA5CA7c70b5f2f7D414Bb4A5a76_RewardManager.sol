...
contract RewardManager is Ownable, ReentrancyGuard {
    ...
    uint256 internal constant LOCK_LENGTH = 12;
    ...
    event Minted(address indexed user, uint256 amount, bool withPenalty);
    ...
    function mint(
        ...
        emit Minted(user, amount, withPenalty);
        return true;
    }
