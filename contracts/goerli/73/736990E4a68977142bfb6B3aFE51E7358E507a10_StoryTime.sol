...
contract StoryTime is ERC1155, Ownable, Pausable, ERC1155Supply {
    ...
    function mintNewToken(uint256 id, uint256 amount) public onlyOwner
    {
    ...
    function mintListeners(uint256 id) external payable callerIsUser {
        ...
        require(totalSupply(id) + amount <= maxEditions, 'exceeds max editions');
