...
contract TrueFace is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("True Face", "TF") {
    setHiddenMetadataUri("ipfs://QmWK2kSHdfHaNbAhQTxoG5RPvDJusrhWF2foozoHoB6Aiq/hidden.json");
  }
