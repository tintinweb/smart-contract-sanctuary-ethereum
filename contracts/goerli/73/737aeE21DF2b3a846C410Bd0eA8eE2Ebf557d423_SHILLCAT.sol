...
contract SHILLCAT is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            // on buy
                ...
                tokensForOperations += (fees * buyMarketingOperations) / buyTotalFees;
            }
    ...
    function swapBack() private {
        ...
        (success, ) = address(OperationsAddr).call{
            value: address(this).balance / 2  // 50% of the ETH goes to the Operations wallet
        }("");
               (success, ) = address(MarketingAddr).call{
            value: address(this).balance / 2 // 50% of the ETH goes to the Marketing wallet
        }("");
    }
    ...
    function setOperationsAddress(address _OperationsAddr)
        external
        onlyOwner
    {
