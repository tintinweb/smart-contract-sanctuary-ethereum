 ...
 * account.
 */
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable,IERC2981 {
...
contract FitMint is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
      ...
      // get last  tokenID
       ...
       event minted(address creator, uint tokenID);
    constructor() ERC721("FitMint", "FITMINT") {
