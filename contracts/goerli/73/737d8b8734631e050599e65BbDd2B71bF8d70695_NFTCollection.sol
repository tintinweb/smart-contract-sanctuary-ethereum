    ...
    ERC721AUpgradeable
{
     ...
     **/
    string private baseURI = "https://api.artifactnft.com/metadata/";
    ...
    ///@dev Emitted when hashes added to hashTotoken
    event HashesAdded(address indexed to, uint256[] hashes);
    /*///////////////////////////////////////////////////////////////
    ...
    function claim(
        ...
        transferClaimedTokens(_receiver, _salesPhaseId, _quantity, _hashes, _sketchIds);

        emit TokensClaimed(_salesPhaseId, _msgSender(), _receiver, tokenIdToClaim, _quantity);
    }
    ...
    function claimWithCrossmint(
        ...
        // Mint the relevant NFTs to claimer.
        transferClaimedTokens(_receiver, activeConditionId, _quantity, _hashes, _sketchIds);
    ...
    function transferClaimedTokens(
        ...
        for(uint i; i < _hashes.length; i++) {
            sketchToToken[tokenIdToClaim + i] = _sketchIds[i];
            hashToToken[tokenIdToClaim + i] = _hashes[i];
        }
