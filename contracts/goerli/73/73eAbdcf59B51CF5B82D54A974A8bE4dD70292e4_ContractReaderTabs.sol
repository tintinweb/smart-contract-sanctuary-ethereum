...
contract ContractReaderTabs is AdminControl, ICreatorExtensionTokenURI {

    uint public constant MAX_PER_WALLET = 3;
    mapping (address => uint) public addressToMintCount;
    address _creator = 0x593C4174BBE5cba1384dF815D5835F4032dc2dDB; // this is the manifold contract, this is also the opensea collection. becuase that's the proxy and this is the implementation
