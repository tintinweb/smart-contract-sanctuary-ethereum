...
contract TestAWP2 is Ownable, ERC721A, ReentrancyGuard {
    ...
    function OGMint(uint256 quantity, bytes32[] calldata ogMerkleProof) external payable callerIsUser {
        ...
        require(quantity > 0);
        require(quantity <= 1, "You cannot mint more than one OG TestAWP2 at this stage in the mint");
        require(
            totalSupply() + quantity <= _collectionSize,
            "sold out"
        );
    ...
    function WLMint(uint256 quantity, bytes32[] calldata wlMerkleProof) external payable callerIsUser {
        ...
        require(quantity > 0);
        require(quantity <= 1, "You cannot mint more than one WL TestAWP2 at this stage in the mint");
        require(
            totalSupply() + quantity <= _collectionSize,
            "sold out"
        );
    ...
    function FreePublicMint(uint256 quantity) external payable callerIsUser {
        ...
        require(quantity > 0);
        require(quantity <= 1, "you cannot mint more than one Free TestAWP2. You can mint as many as you like through the PublicMint method.");
        require(
            totalSupply() + quantity <= _collectionSize,
            "sold out"
        );
    ...
    function PublicMint(uint256 quantity) external payable callerIsUser {
        ...
        require(quantity > 0);
        require(quantity <= 10, "You cannot mint more than 10 TestAWP2 in a single transaction");
        require(
            totalSupply() + quantity <= _collectionSize,
            "sold out"
        );
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory tokenIdString = Strings.toString(tokenId + 1);
