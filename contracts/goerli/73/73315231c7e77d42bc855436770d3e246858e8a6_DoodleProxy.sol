...
// DoodleProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract DoodleProxy is DoodleProxyStorage {
    constructor(
        string memory name_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'DoodleProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'DoodleProxy::_setImplementation: invalid implementation address');
