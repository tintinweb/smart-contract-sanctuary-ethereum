...
contract COANFTProxy is Ownable {
    ...
    function digitalArtCreate(
        ...
        nftContract_.functionCallWithValue(contractFunctionData_, (msg.value - payment_.amount));
    ...
    function digitalArtTransfer(
        ...
        coa.safeTransferFrom(msg.sender, to_, certificateId_, 1, "");
    ...
    function physicalArtTransfer(
        ...
        coa.safeTransferFrom(msg.sender, to_, certificateId_, 1, "");
        bytes32 dataHash = keccak256(abi.encode(to_, certificateId_));
        _payment(payment_, dataHash);
    }
