...
contract OasisX1155 is ERC1155Supply, Pausable {
    ...
    function getMaxId() public view returns (uint8) {
        return maxId;
    }
    ...
    function adminMint(
        ...
        require(id <= maxId, "OasisX1155: Token id mismatch");
    ...
    function burn(
        ...
        uint256 id,
        uint256 value
    ) public virtual ownerOrFactory(account) {
     ...
     */
    function changeFactoryAddress(address factoryAddress_) public onlyOwner {
        require(
