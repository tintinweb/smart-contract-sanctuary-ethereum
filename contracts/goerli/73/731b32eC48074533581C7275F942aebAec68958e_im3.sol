...
contract im3 {
    ...
    function addIm(
        ...
        ims.push(Im(_imId, _ownerId1, _imDate)
        );

        // Emit a NewMemo event with details about the memo.
        emit NewIm(_imId, _ownerId1, _imDate);
    }
    //2
    ...
    function addOwner(
        ...
        // Add the memo to storage!
        owners.push(Owner(_ownerId2, _ownerName, _ownerPhone));

        // Emit a NewMemo event with details about the memo.
        emit NewOwner(_ownerId2, _ownerName, _ownerPhone);
    }
    ...
    function addExport(
        ...
        // Add the memo to storage!
        exports.push(Export(_exportId, _ownerId3, _exportDate));

        // Emit a NewMemo event with details about the memo.
        emit NewExport(_exportId, _ownerId3, _exportDate);
    }
