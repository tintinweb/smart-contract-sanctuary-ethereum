...
contract CnnProject is ERC721A, Ownable {
    ...
    constructor(
    ) ERC721A ('CnnProject','CNN'){ // コレクション名：　CnnProject、　トークンの名前：CNN
        setBaseURI('https://bafybeig7bpb42ey5br6jefnoc3kpqobzgtletoilmpyeejettw3mviyeca.ipfs.nftstorage.link/');
    }
    // チェック
