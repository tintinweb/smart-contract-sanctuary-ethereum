...
contract NEURAL is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(address _ocaAddress) ERC20("NEURAL", "NEURAL") {
        controllers[msg.sender] = true;
        controllers[_ocaAddress] = true;
        ai = TheAIArtGame(_ocaAddress);
    }
...
contract TheAIArtGame is Ownable, ERC2981, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A("On chain AI NFT Game. ", "AI_ART_GAME") {
    ...
    function testController() public callerIsNeo {
        ...
        returns (string memory)
    {
        ...
        string[3] memory metadataVars = [
            string(unhideWord ? grabWord(tokenId) : "Waiting on reveal..."),
            "svgwebsitehre",
        ...
        attributesNumbers[1] = AttributesNumbers(
            "Re-Word",
            "",
            generateNumber(generateSeed(tokenId), 5) + 1,
            5
        );
        attributesNumbers[2] = AttributesNumbers(
            "Yoinks",
            "",
            generateNumber(generateSeed(tokenId + 420), 5) + 1,
            5
        );
        count[1] = 1;
    ...
    function _mint(address to, uint256 quantity) internal virtual override {
        ...
        unchecked {
            ...
            assembly {
                ...
                for {
                    // mstore(0, startTokenId)
                    // mstore(32, tokenInfo.slot)
                    // let hashFirst := keccak256(0, 64)
                    // sstore(hashFirst, ts)
    ...
    function attributeCreator(
        ...
        for (uint8 i = 0; i < sizes[0]; i++) {
            ...
            attributeBytes = i == 0
                ...
                : i == 1
                ? abi.encodePacked(attribute, numberAttributeBytes)
