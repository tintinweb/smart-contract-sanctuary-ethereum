...
contract Ninjai is ERC721AQueryable, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
  ...
  uint256 public maxCost = 0.014 ether;
  /** Price per token */
  ...
  /** Hidden Metadata Uri */
  string public hiddenMetadataUri = "ipfs://bafybeiceeyvh2msig7rpfqqnpebom7mn4mkgyrpcwoxaxoyl4midmmloy4/hidden.json";
  /** Reveal state */
  ...
  function reserve(uint256 _amt) external onlyOwner callerIsUser {
    ...
    if (revealed == false) { revealed = true; }
