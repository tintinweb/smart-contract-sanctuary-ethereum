...
contract TIM is ERC1155, Ownable {
    ...
    constructor() ERC1155("") {
        header = string(abi.encodePacked(
                        ...
                        '<text style="white-space:pre;fill:rgb(0,127,0);font:normal 16px Courier, Monospace, serif;" x="7" y="17">'));

        footer = string(abi.encodePacked(
            '<rect x="3" y="245" rx="0" ry="0" width="194" height="52" style="fill:rgb(0, 255, 0);stroke-width:0;opacity:0.0;"></rect>',
            '<text style="font:bold 10px Courier, Monospace, serif;fill:rgb(0, 255, 0)" x="7" y="294">',
            domain,
            '</text>'));
