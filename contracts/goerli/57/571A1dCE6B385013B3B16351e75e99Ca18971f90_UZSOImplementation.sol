...
contract UZSOImplementation is ERC20, Ownable{
    // INITIALIZATION DATA
    ...
    */
    ...
    function mintToCustomer(address payable to, uint256 amount) public onlySupplyController {
         _mint(to, amount);
    }
