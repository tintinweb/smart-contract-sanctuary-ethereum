...
//TRII Token Audited by TRII DIENSTLEISTUNG S.A.R.L
...
contract TRII is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x17Bed6A3Ad90797753500a3f7E7FC3E42128eB51;
    ...
    string private constant _name = "SES TEST2";
    string private constant _symbol = "SES2";
    ...
    Taxes public taxes = Taxes(1, 3, 2, 2, 2);
    Taxes public sellTaxes = Taxes(1, 3, 2, 2, 2);
    Taxes public highTaxes = Taxes(10, 30, 20, 20, 20);
