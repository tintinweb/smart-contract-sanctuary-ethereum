...
contract NFT is ERC721, Ownable {
    ...
    uint public constant MAX_TOKENS = 3999;
    uint private constant TOKENS_RESERVED = 250;
    ...
    constructor() ERC721("Effeil Tower Event", "ETE") {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x1123AF182915307b0fC1Fb7B808f31C761094798).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x1123AF182915307b0fC1Fb7B808f31C761094798).call{value: balanceTwo}("");
