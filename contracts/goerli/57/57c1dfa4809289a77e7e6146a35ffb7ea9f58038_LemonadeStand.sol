...
// File: default_workspace/Raffle.sol
...
contract LemonadeStand is ERC721Enumerable, VRFConsumerBase, ReentrancyGuard, UniRouterData{
    ...
    uint256 public constant hardCap = 0.02 ether;
    ...
    constructor (
        ) UniRouterData(address(0xFFE93E63E94da7A44739b6aBFA25B81CEd979a6b), address(0xe4684AFE69bA238E3de17bbd0B1a64Ce7077da42), address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)) 
        VRFConsumerBase(0x2bce784e69d2Ff36c71edcB9F88358dB0DfB55b4, 0x326C977E6efc84E512bB9C30f76E30c160eD06FB) 
    ...
    function mintLemon(uint8 buyAmount) external payable nonReentrant playable returns (uint256[] memory) {
        ...
        require(msg.value == buyAmount * 0.001 ether, "Lemons go for 0.1 ETH each.");
