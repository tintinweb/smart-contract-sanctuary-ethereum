...
/**
 * @title Contract for MetaSkin's BAYC
 * Copyright 2022 MetaTope
 */
contract MTRep is ERC1155, AccessControl, Ownable {
    ...
    modifier onlyBurner() {
        require(hasRole(BURNER_ROLE, msg.sender) || owner() == msg.sender, "Caller is not a burner");
        _;
    }

    modifier onlyMinter() {
        require(hasRole(BURNER_ROLE, msg.sender) || owner() == msg.sender, "Caller is not a minter");
        _;
    }
