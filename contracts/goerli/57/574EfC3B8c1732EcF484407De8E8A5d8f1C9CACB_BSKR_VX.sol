...
contract BSKR_VX is BaseBSKR {
    ...
    /**
     * @notice Reinitializes BSKR contract with new implementation version
     * @param version Implementation version
     * @param nameA Token name
     * @param symbolA Token symbol
     * @param growthAddressA Growth address
    ...
    function __BSKR_VX_init(
        ...
        __BaseBSKR_init_unchained(nameA, symbolA, growthAddressA, sisterOAsA);
        __BSKR_VX_init_unchained(paydayAddressA, lbskrAddrA);
    }

    function __BSKR_VX_init_unchained(
        address paydayAddressA,
        address lbskrAddrA
