    ...
    IService
{
    ...
    function getMaxHardCap2(address _pool) public view returns (uint256) {
        if (directory.typeOf(_pool) == IDirectory.ContractType.Pool) {
            return 34;
    ...
    function getMaxHardCap3(address _pool)
        public
        view
        returns (IDirectory.ContractType)
    {
        return directory.typeOf(_pool);
    }
