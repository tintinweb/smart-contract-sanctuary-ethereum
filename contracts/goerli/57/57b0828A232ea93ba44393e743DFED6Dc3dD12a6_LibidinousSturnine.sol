...
/**
 * @title LibidinousSturnine
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract LibidinousSturnine is ERC20Capped, ERC20Burnable {
    address private _owner;

    constructor() ERC20("Libidinous Sturnine","BOU") ERC20Capped(1000000000 * (10**uint256(decimals())))  { 
        _owner = _msgSender();
     }
