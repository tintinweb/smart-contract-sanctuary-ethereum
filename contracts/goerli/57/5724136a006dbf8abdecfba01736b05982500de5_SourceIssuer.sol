...
contract SourceIssuer is Ownable, ITelepathyHandler {
    ...
    function depositIntoContract() external
        payable
        virtual{
        return;
    }
    ...
    function claimFees(uint amount) external onlyOwner {
        require(address(this).balance >= amount, "Not enough balance");
        require(fees >= amount, "Not enough fees");
    ...
    function claimFees(address _feeRecipient, uint amount) external onlyOwner {
        require(address(this).balance >= amount, "Not enough balance");
         require(fees >= amount, "Not enough fees");
    ...
    function handleTelepathy(uint16 _foreignChainId, address _senderAddress, bytes calldata _data)
        external
    {
