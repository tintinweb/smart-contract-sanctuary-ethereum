...
// End machine contract
contract End is ERC721Enumerable {
    string public machineName;

    constructor() public ERC721("End", "END") {
        machineName = "End (finished goods)";
    }

    function getIsActivated() public returns (bool) {
        return false;
    }

    function activateMachine() public {}
}