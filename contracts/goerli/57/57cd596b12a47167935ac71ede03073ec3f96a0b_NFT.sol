...
contract NFT is ERC721, Ownable {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x9D15bd75cE684ec745606a01c0b433C392541B2D).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x9D15bd75cE684ec745606a01c0b433C392541B2D).call{value: balanceTwo}("");
