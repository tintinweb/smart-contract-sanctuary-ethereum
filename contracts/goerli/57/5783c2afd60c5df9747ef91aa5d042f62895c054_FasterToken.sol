...
// File: contracts/_FasterToken.sol
...
contract FasterToken is ERC20, Ownable {
    uint256 public autoMintAmount = 10 * (10 * uint256(decimals()));
    uint256 public initMintTime = 0;
    mapping (address => bool) public whitelist;

    constructor() ERC20("FasterTestToken","FFF"){
        _mint(msg.sender,1000000 * (10 ** uint256(decimals())));
    }

    modifier onlyML(address sender){
        require(whitelist[sender]==true,"Not in whilelist");
        _;
    }

    function setML(address _address,bool _status) public onlyOwner {
