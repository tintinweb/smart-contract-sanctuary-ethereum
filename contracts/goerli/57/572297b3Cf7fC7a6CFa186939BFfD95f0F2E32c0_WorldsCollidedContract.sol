...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x8dad10bCc61052433A0970ec106df9E87A77cBC2];
  address public erc20Payable = 0x8dad10bCc61052433A0970ec106df9E87A77cBC2;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigmynozikrj22fh6565shrw3lbn3ypkgmppskv5dht7oapbgvwel4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/mt14Hk6xitREyGAx3ngq/contract-metadata";
  }
...
// File: contracts/WorldsCollidedContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WorldsCollidedContract is RamppERC721A {
    constructor() RamppERC721A("Worlds Collided", "ETO"){}
}
