...
contract PunkOS is ERC721A, ERC2981, Ownable, OperatorFilterer, ReentrancyGuard {

    constructor() ERC721A("Punk OS", "PKOS") OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), false) {
    _setDefaultRoyalty(owner(), ROYALTY_FEE_NUMERATOR);
    }

    ContractStatus public CONTRACT_STATUS = ContractStatus.disable;

    uint96 public immutable ROYALTY_FEE_NUMERATOR = 250;
