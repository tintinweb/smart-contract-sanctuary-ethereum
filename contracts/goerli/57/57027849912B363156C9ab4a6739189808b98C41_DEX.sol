...
contract DEX {
    ...
    function ethToToken() public payable returns (uint256 tokenOutput) {
        ...
        require(
            ...
            "Can't transfer token to sender, revert"
        );
        emit EthToTokenSwap(
            msg.sender,
            "ETH to Baloons",
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        require(
            ...
            "Can't transfer token to ETH, revert"
        );
        (bool sent, ) = msg.sender.call{value: ethOutput}("");
        require(sent, "Can't transfer ETH to sender, revert");
        emit TokenToEthSwap(msg.sender, "Baloon to ETH", ethOutput, tokenInput);
        return ethOutput;
    }
        ...
        returns (uint256 eth_amount, uint256 token_amount)
    {
        require(
            ...
            "sender doesn't have enough liquidity to withdraw"
        );
        uint256 tokenReserve = token.balanceOf(address(this));
        ...
        require(sent, "Can't transfer eth to sender");
