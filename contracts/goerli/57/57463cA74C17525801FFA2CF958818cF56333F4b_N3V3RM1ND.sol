...
contract N3V3RM1ND is ERC721A, Ownable, VRFv2DirectFundingConsumer {
    constructor() ERC721A("NVMNF7", "N3V3RM1ND") {
    ...
    function cu7m4x5upply(uint256 m4x) external onlyOwner {
        ...
        require(m4x <= c0nf16.m4xm1n7ph453, "1nv4l1d.");
        c0nf16.m4xm1n7ph453 = m4x;
    }
...
contract VRFv2DirectFundingConsumer is VRFV2WrapperConsumerBase {
    ...
    uint256[4] internal h45h = [1,2,3,4];
