...
contract RandomWinnerGame is Ownable, VRFConsumerBase {
    ...
    event GameStarted(uint gameID, uint8 maxPlayer, uint256 entryFee);
    ...
    constructor(
        ...
        bytes32 vrfKeyHash,
        uint vrfFee
    ) VRFConsumerBase(vrfCoord, linkToken) {
        keyHash = vrfKeyHash;
        fee = vrfFee;
        gameStarted = false;
    }
    ...
    function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        ...
        require(!gameStarted, "Wait for the game finished.");
    ...
    function joinGame() public payable{
        ...
        require(msg.value==entryFee,"You should pay the entry fee !");
