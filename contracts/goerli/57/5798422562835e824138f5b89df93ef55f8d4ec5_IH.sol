...
//            _inviteeData[msg.sender] += (1<<(8 + uint8(color)));
    ...
    **/
    function puzzleInvite(address[] calldata invitees, HeartColor[] calldata colors) public {
        require(invitees.length == colors.length, "lm");
    ...
    **/
    function solvePuzzle(string[] calldata solution) public {
        ...
        _solverData[msg.sender].auxData += 1;
    }
...
//        _mintMain(msg.sender, puzzleColor(msg.sender));
        StorageLayerProto(STORAGE_LAYER_ADDRESS).mint(msg.sender, puzzleColor(msg.sender));
    }
    ...
    **/
    function mintFromPuzzle() public payable {
...
//    /**
//     * @dev Mints an inactive heart from a liquidated active heart
//     * @notice The resulting inactive heart mint will mark the owner as "invited"
//    **/
//    function crossMint(address owner, uint256 tokenId, HeartColor color) public onlyActive {
//        _mintTokenId(owner, tokenId, uint8(color));
//
//        if (!invited(owner)) {
//            _inviteeData[owner] = _inviteeData[owner] | 1;
//            _inviteeData[owner] += (1<<(8 + uint8(color)));
//        }
//    }
...
//        if (_freeActivations[msg.sender]) {
//            _freeActivations[msg.sender] = false;
//        }
//        else {
//            require(msg.value == mintPrice, "rekt");
//        }
    ...
    function batchEmitTransfers(address from, address to, uint256 tokenId) public onlyStorage {
        emit Transfer(from, to, tokenId);
    }
...
//        StorageLayerProto(STORAGE_LAYER_ADDRESS).storage_transferFrom(from, to, tokenId);
//    }
//
//    function safeGift(
//        address from,
...
//        uint256 tokenId
//    ) public {
//        StorageLayerProto(STORAGE_LAYER_ADDRESS).storage_safeTransferFrom(from, to, tokenId);
//    }
...
abstract contract StorageLayerProto {
    ...
    function mint(address to, HeartColor color) public virtual;
