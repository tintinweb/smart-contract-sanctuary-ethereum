...
contract Nexus is ERC721A, ERC2981, AccessControl {
    ...
    function mintSilver(address _address, bytes32[] calldata _merkleProof) external {
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
    ...
    function mintBronze(address _address, bytes32[] calldata _merkleProof) external {
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
    ...
    //set URI
    function setKindG_URI(string calldata baseURI) external onlyOwner {
        _kindGTokenURI = baseURI;
    }
    function setKindS_URI(string calldata baseURI) external onlyOwner {
        _kindSTokenURI = baseURI;
    }
    function setKindB_URI(string calldata baseURI) external onlyOwner {
        _kindBTokenURI = baseURI;
    }
    function setKindB1_URI(string calldata baseURI) external onlyOwner {
        _kindB1TokenURI = baseURI;
    }
    function setKindB2_URI(string calldata baseURI) external onlyOwner {
    ...
    function setMerkleRootB(bytes32 _merkleRoot) external onlyOwner {
