...
contract TestKKNFTV4 is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  mapping(address => uint256) _freemint3Counter;
  ...
  bytes32 public freemint3MerkleRoot;
  ...
  constructor(
    ...
    freeMintListRoot = 0x7bd66a52777d1b903d5809c24283cab20a1c1c8b20d6e4fecec0ff2118929aa9;
    specialFreemintListRoot = 0x42439b23dac9c8a95d67217af7b87c6547eb4efe90ec31ba2c86ddc353dbdebe;
    whitelistMerkleRoot = 0xa2f79a64a38c5a749c9e61f8064967b1e81fc9ab7f24aae45fb84598306482f3;
    specialWhitelistMerkleRoot = 0x8e1dc77c38041b5f518f7abf41e3ced78966a3d059f6445ea237887e6f233ddf;
    freemint3MerkleRoot = 0x2dc7e6416dde39b6e423a15a22dbda87cee0ae96d17c07178d1fdd4e4c5b4b48;
    freemint4MerkleRoot = 0x67e46d82d7b7c91d3b6219d51e600968aeb95446ff31d8aeac77c5e3ba606f43;
    freemint10MerkleRoot = 0x275db11f43d60183db995b1e3737886527dd511e5594807587991f67d83a6a13;
  }
  ...
  function freeMint(uint256 _mintAmount, bytes32[] calldata _merkleProof)
        ...
        mintPriceCompliance(_mintAmount)
    {
      ...
      // Verify freemintlist requirements
        ...
        } else if (MerkleProof.verify(_merkleProof, freemint3MerkleRoot, leaf)){

          _freemint3Counter[msg.sender] += _mintAmount;
          require(_freemint3Counter[msg.sender] <= 4, "You are going over your maximum free mint count!");

        } else if (MerkleProof.verify(_merkleProof, freemint4MerkleRoot, leaf)){

          _freemint4Counter[msg.sender] += _mintAmount;
          require(_freemint4Counter[msg.sender] <= 6, "You are going over your maximum free mint count!");
        }
