...
contract TEST1 is Ownable, ERC721A, ReentrancyGuard {
    ...
    function TEST_BLAH(uint256 _mintAmount) public payable callerIsUser  {
    ...
    function TESTLOAD(uint256 _mintAmount, address destination) public onlyOwner  {
        uint256 supply = totalSupply();
        require(_mintAmount > 0, "mint amount > 0");
