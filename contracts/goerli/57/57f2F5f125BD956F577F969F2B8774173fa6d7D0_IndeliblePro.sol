...
abstract contract ERC721X is ERC721, Ownable {
    ...
    function setApprovalLifespanDays(uint numberOfDays) public onlyOwner {
        approvalLifespan = numberOfDays * 1 days;
    }
}
...
contract IndeliblePro is ERC721X, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    function burnToMint(uint[] calldata tokenIds, address recipient)
        ...
        whenFreeMintActive
    {
        require(totalFreeMinted + tokenIds.length <= MAX_SUPPLY_TIER_2, "All tokens are gone");
        ...
        for (uint i; i < tokenIds.length; i += 1) {
            ...
            totalFreeMinted = totalFreeMinted + tokenIds.length;
        }
        ...
        whenPaidMintActive
    {
        ...
        require(totalPaidMinted + count <= MAX_SUPPLY_TIER_1, "All tokens are gone");
        ...
        totalPaidMinted = totalPaidMinted + count;
    }
