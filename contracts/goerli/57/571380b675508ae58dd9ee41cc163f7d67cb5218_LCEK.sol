...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        ...
        //TODO: return address of the message sender    DONE
        return msg.sender;
...
contract ERC20 is Context {
    ...
    // TODO: create a `Transfer` event DONE
    /**
    ...
    // TODO: create an `Approval` event DONE 
    /**
    ...
    function name() public view virtual returns (string memory) {
        return _name;
        //TODO: return token name set in the constructor DONE
    }
    ...
    function symbol() public view virtual returns (string memory) {
        //TODO: return token symbol set in the constructor DONE
        return _symbol;
    }
        ...
        returns (bool)
    {
        ...
        require(currentAllowance >= subtractedValue, "decreased allowance < 0");
        unchecked {
    ...
    function _transfer(
        ...
        require(fromBalance >= amount, "transfer amount > balance");
        unchecked {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(accountBalance >= amount, "burn amount > balance");
        unchecked {
...
contract LCEK is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenEK", "LCEK") {
    //   hasMinterRole(0x8486d18449d95b95715419179f0c957650E5107b);
    //   mint(0xC97a154231B0FEaaF980133c1335309Aa401b0CF,2);
    }
...
// LCEK.hasMinterRole() ;
// (0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2,0x8486d18449d95b95715419179f0c957650E5107b,3);