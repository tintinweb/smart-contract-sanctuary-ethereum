...
contract Pulset is Context, IERC20, Ownable {
    ...
    uint256 public _buyAdvestisementFee = 1;

    uint256 public _sellTaxFee = 0;
    uint256 public _sellAdvestisementFee = 1;
    ...
    address public advertisementWallet =
        0x655c49D4a6a62c23d7AFe5aFFA0b3bE40d10d945;
    ...
    uint256 public _maxWalletAmount = 20;
    ...
    function changeStakeAdvestisementWallets(address wallet, address stakeWallet) public onlyOwner {
    ...
    function calculateAdvestisementFee(uint256 _amount)
        ...
        returns (uint256)
    {
        return _amount.mul(_advestisementFee).div(10**3);
    }
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && !_isExcludedMaxWallet[to])
            require(
