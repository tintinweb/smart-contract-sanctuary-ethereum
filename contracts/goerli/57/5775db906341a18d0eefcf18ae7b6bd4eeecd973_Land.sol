...
contract Land is ERC721A, Ownable {
    ...
    uint256 public constant MAX_INVESTOR_LANDS = 3000;
    uint256 public constant INVESTOR_MINT_PRICE = 0.000001 ether;
    ...
    uint256 public MINT_END_PRICE = 0.0000006 ether;
    uint256 public DISCOUNT_RATE = 0.00000002 ether;
    ...
    constructor(uint256 maxLands) ERC721A("TTPB", "TTPB") {
        MAX_LANDS = maxLands;
    }
    ...
    function allowListR2MintLands(
        ...
        external
        payable
        inTime(allowListR2StartTime, investorR1StartTime)
    ...
    function investorR1MintLands(
        ...
        external
        payable
        inTime(investorR1StartTime, investorR2StartTime)
    ...
    function investorR2MintLands(
        ...
        external
        payable
        inTime(investorR2StartTime, claimableStartTime)
        onlyVerified(Round.InvestorR2, maxLands, signature)
        mustMatchPrice(INVESTOR_MINT_PRICE, numLands)
    {
        _investorMintLands(numLands, maxLands);
    }
    ...
    function _getMintPrice() internal view returns (uint256) {
        ...
        if (MINT_START_PRICE < DISCOUNT_RATE * _m) {
            return MINT_END_PRICE;
        }
        uint256 price = MINT_START_PRICE - DISCOUNT_RATE * _m;
    ...
    function _beforeTokenTransfers(
        ...
        if (mintStartTokenId == 0 || startTokenId < mintStartTokenId) {
            require(
                transferEnabled,
    ...
    function setMintStartTime(uint256 _mintStartTime, uint256 _mintEndTime)
        external /*onlyOwner*/
    {
