...
contract VermCity is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    ) ERC721A("Verm City NFT", "VERM CITY") {
        uint256 _maxSupply = 10000;
        maxPhaseNum = 2000;

        preSaleStartTime = 1657857600; // 17th July 3.30 PM IST
        preSaleEndTime = 1658034000;// 17th July 3.30 PM IST
        privateStartTime = 1658034000; // 17th July 3.30 PM IST
        privateEndTime = 9655902800; // 17th July 2278 3.30 PM IST
        publicStartTime = 1658034000; // 17th July 3.30 PM IST
