...
contract NFCStorage is Ownable {
    ...
    function append721Coupon(address[] calldata _nft_contracts, uint256[] calldata _phases) external onlyFromNftContract {
    ...
    function updatePhase(uint256 _phase) external onlyFromNftContract {
