...
contract BA is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) private alreadyMinted;
    ...
    modifier verifyMint(uint256 _price, Status _status){
        ...
        require(alreadyMinted[msg.sender] == 0, "already minted");
    ...
    //---------- Whitelist Mint ----------
    function whitelistMint(bytes32[] calldata _merkleProof) public payable verifyMint(cost, Status.Whitelist) {
    ...
    //----------- Waitlist Mint ----------
    function waitlistMint(bytes32[] calldata _merkleProof) public payable verifyMint(cost, Status.Waitlist) {
