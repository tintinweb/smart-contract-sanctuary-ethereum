 ...
 * @notice This contract handles minting 1155 mints to burn tokens.
 */
contract _1155MintsToBurn is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xFd1eb3aAA6393F2A3e0631AE00DB5E22f4C23C9c;
    ...
    string public name = "1155 mints to burn";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeibjjsavga3tuslbjuytu2umzogy25wchr4z72pjs3hq6wfseydltm/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[111] = 1000;
        tokenPublicPrice[111] = 0 ether;
        tokenPublicMintsPerAddress[111] = 1000;
        require(
