...
// File: Whitelisting/interfaces/IBEP165.sol
...
// File: Whitelisting/interfaces/IBEP721.sol
...
// File: Whitelisting/Addons/SafeMath.sol
...
// File: Whitelisting/interfaces/IBEP20.sol
...
// File: Whitelisting/Addons/Context.sol
...
// File: Whitelisting/Addons/Ownable.sol
...
// File: Whitelisting/Addons/Whitelisting.sol
...
// File: Whitelisting/Addons/TaxOptions.sol
...
contract TaxOptions is Ownable {
    ...
    uint private previousBurnTax = _burnTax;
    uint256 public _TeamTax = 2;
    uint private previousTeamTax = _TeamTax;
    uint256 public _liquidityTax = 2;
    uint private previousLiquidityTax = _liquidityTax;
    uint256 public _rAndDTax = 2;
    uint private previousRAndDTax = _rAndDTax;
    uint256 public _marketingTax = 2;
    uint private previousMarketingTax = _marketingTax;
...
// File: Whitelisting/Addons/MaxTxLimit.sol
...
contract MaxTxLimit is Ownable {
    ...
    function addInMaxTxLimitExclude(address _address) public virtual onlyOwner {
    ...
    WhiteListing
{
    ...
    constructor(
        ...
        _mint(owner(), supply);
        addInMaxTxLimitExclude(owner());
        addInMaxTxLimitExclude(address(this));
    ...
    function _transfer(
        ...
        if (!_isExcludedFromMxTxLimit[msg.sender])
            require(amount < maxTxLimit(), "Amount Exceeded");
        unchecked {
