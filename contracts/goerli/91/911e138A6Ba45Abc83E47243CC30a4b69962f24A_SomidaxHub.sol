...
contract SomidaxHub is ReentrancyGuard {
    ...
    // 0x40a42Baf86Fc821f972Ad2aC878729063CeEF403 localhost smdx
    address public constant SMDXADDRESS =
        0x7019B818a21545Fd062A20A2aC768539B34B9AC7;
    ...
    // /**
    // * @dev: This checks to ensure that the nft hasn't be listed already
    // */
    ...
    function buy_item(
        ...
        if (isRoyalty == true) {
            (address receiver, uint256 royaltyAmount) = IERC2981(nftAddress)
                .royaltyInfo(tokenId, price);

            s_procceeds[receiver].smdxBalance =
                s_procceeds[receiver].smdxBalance +
                royaltyAmount;

            uint256 priceToSeller = price - royaltyAmount;
