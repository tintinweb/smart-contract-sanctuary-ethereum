...
contract NftMarketplace is Ownable {
    ...
    uint256 public totalListTransactions;
    uint256 public totalSoldTransactions;
    uint256 public totalTransactions = totalListTransactions + totalSoldTransactions;
    ...
    function listItemERC721(
        ...
        totalListTransactions++;
        emit ERC721Listed(nftAddress, msg.sender, tokenId, price, block.timestamp);
    }
    ...
    function listItemERC1155(
        ...
        totalListTransactions++;
        emit ERC1155Listed(nftAddress, msg.sender, tokenId, amount, price, block.timestamp);
    }
    ...
    function listItemERC20(
        ...
        totalListTransactions++;
        emit ERC20Listed(tokenAddress, msg.sender, price, tokenERC20Listing, block.timestamp);
    }
