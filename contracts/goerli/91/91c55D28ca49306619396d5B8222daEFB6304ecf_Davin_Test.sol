...
contract Davin_Test is ERC721A, Ownable, ReentrancyGuard {
    // declares the maximum amount of tokens that can be minted
    uint256 public constant MAX_TOTAL_TOKENS = 10000;

    // max number of mints per transaction
    uint256 public free_mint_max = 1;
    uint256 public allowlist_mint_max = 3;
    uint256 public pub_mint_max_per_tx = 5;

    // price of mints depending on state of sale
    uint256 public item_price_al = 0.03 ether;
    uint256 public item_price_public = 0.05 ether;
    ...
    string private unrevealedURI = "test";
    ...
    constructor (bytes32 _root_al, bytes32 _root_free) ERC721A("Davin_Test", "DTEST") {
        root_al = _root_al;
