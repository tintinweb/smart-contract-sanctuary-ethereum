...
// https://artglixxx.io/xollections/bgantowers/
// by @berkozdemir
...
contract BGANTOWERSFACTORY is ERC721AQueryable, Ownable {

    // ISTHISBASTARDHYPEDAF BGANHYPE = ISTHISBASTARDHYPEDAF(0xA44dE1E10Ad532c33f7aA6CbFC256A615c7164F9);
    ISTHISBASTARDHYPEDAF BGANHYPE = ISTHISBASTARDHYPEDAF(0x05D3171a9c38665036a6Dd2577812b2Ef0606989); //GOERLI
    ...
    constructor() ERC721A("HYPEDAFTOWERS", "HYPEDAFTOWERS") {
    ...
    function mint(address _to, uint256[] calldata _bgans) external {
        require(mintOpen, "SALE ISN'T OPEN FREN");
    ...
    function testMint(address _to, uint256[] calldata _bgans) external {
        require(mintOpen, "SALE ISN'T OPEN FREN");
        bool[] memory isHyped = BGANHYPE.isThisBastardHypedAF_BATCH(_bgans);
        uint start = totalSupply() / 2;
        for (uint i = 0; i < _bgans.length; i++) {
