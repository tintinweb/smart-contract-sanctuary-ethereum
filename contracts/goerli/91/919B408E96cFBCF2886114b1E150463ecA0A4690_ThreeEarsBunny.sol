...
contract ThreeEarsBunny is AccessControl, ERC721ALockable, DefaultOperatorFilterer, ERC2981 {
    ...
    uint256 public publicPrice = 1e15;
    uint256 public guaranteeWhiteListPrice = 7e14;
    uint256 public nonGuaranteeWhiteListPrice = 75e13;
    ...
    function mintForWhiteList(
        ...
        require(Address.isContract(msg.sender) == false, "TEB: Prohibit contract calls");
        require(quantity <= maxCount, "TEB: Mint would exceed max batch size");
        ...
        bytes32 digest = keccak256(abi.encodePacked(msg.sender, maxCount, nonce));
    ...
    function getConfig() external view returns (uint256, uint256, uint256, uint256, uint256, uint256){
        return (
