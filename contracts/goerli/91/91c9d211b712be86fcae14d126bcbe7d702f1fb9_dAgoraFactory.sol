...
import {RonaldWeasley} from './dAgoraWizard/Simple-NFT-OZ.sol';
import {AlbusDumbledore} from './dAgoraWizard/Simple-WL-Royalty-NFT.sol';
import {MadEyeMoody} from './dAgoraWizard/SimpleNFTRoyaltyStandard.sol';
import {HarryPotter} from './dAgoraWizard/SimpleNFTWhiteList-A.sol';
import {ShallNotBeNamed} from './dAgoraWizard/SimpleNFTWhitelist-Oz.sol';

contract dAgoraFactory is Ownable, ReentrancyGuard {

    SimpleNFTA[] public simpleNFTa;
    RonaldWeasley[] public weasley;
    AlbusDumbledore[] public dumbledore;
    MadEyeMoody[] public moody;
    HarryPotter[] public potter;
    ShallNotBeNamed[] public voldemort;

    uint256 public NFTAIndex;
    uint256 public weasleyIndex;
    uint256 public dumbledoreIndex;
    uint256 public moodyIndex;
    uint256 public potterIndex;
    uint256 public voldemortIndex;
    ...
    event SimpleNftACreated(address indexed contractAddress, address indexed owner, uint256 indexed Id);
    event RonWeasleyCreated(address indexed contractAddress, address indexed owner, uint256 indexed Id);
    event AlbusDumbledoreCreated(address indexed contractAddress, address indexed owner, uint256 indexed Id);
        ...
        nonReentrant
    {
        ...
        SimpleNFTA nfta = new SimpleNFTA(
            _name,
            _symbol,
            _baseURI,
            _mintCost,
        ...
        simpleNFTa.push(nfta);

        NFTAIndex = simpleNFTa.length;

        emit SimpleNftACreated(address(nfta), msg.sender, NFTAIndex);
    }

    function createRonWeasly(
        string memory _name,
        string memory _symbol,
        string memory _baseURI,
        uint256 _mintCost,
        ...
        nonReentrant
    {
        ...
        RonaldWeasley nft = new RonaldWeasley(
            _name,
            _symbol,
            _baseURI,
            _mintCost,
        ...
        weasley.push(nft);
        weasleyIndex = weasley.length;
        emit RonWeasleyCreated(address(nft), msg.sender, weasleyIndex);
    }
...
contract RonaldWeasley is ERC721, ERC721Enumerable, Ownable {
