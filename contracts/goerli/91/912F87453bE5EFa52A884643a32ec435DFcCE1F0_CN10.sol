...
contract CN10 is ERC20, Ownable {
    ...
    constructor() ERC20("CN10", "CN") {
		...
		charityWallet = address(0xdA3d78F507595ad3365e568751a8c312C47F2cFF); // 
        marketingWallet = address(0x682a321a1104375CF46227fed2D44Eb7252578E9); // Weaponery
