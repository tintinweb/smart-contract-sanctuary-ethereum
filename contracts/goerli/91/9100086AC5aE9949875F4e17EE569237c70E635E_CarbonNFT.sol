    ...
    ERC721Enumerable
{
    ...
    modifier callerIsOperator() {
        require(
            isOperator[msg.sender] || owner() == msg.sender,
            "caller is not operator"
        );
        _;
    }

    constructor(string memory _baseTokenURI, address _operator)
        ERC721("Carbon", "CARBON")
    {
    ...
    /**
     * @notice mint nft
     * @param to 'address' owner new nft
     */
