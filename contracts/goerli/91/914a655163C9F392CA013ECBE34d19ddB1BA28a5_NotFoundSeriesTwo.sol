...
contract NotFoundSeriesTwo is DefaultOperatorFilterer, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Not Found - Series Two", "TWO") {}
    ...
    function allowListMint() public payable {
        ...
        require(msg.value >= 0.0404 ether, "Incorrect value");
        internalMint();
    }

    function waitListMint() public payable {
    ...
    function internalMint() internal {
        require(totalSupply() < maxSupply, "No tokens remaining");
    ...
    uint256 newSupply = currentSupply + batchSize;
    uint256 max = maxSupply;

    require(newSupply <= max, "Cannot exceed max supply");
