...
contract FreeKicksV1 is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 2323;
    uint public PRESALE_LIMIT = 1000;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 8;
    ...
    constructor() ERC721("FreeKicksV1", "FKCV1") {}
