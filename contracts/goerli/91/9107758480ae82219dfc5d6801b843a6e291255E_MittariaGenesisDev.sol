...
contract MittariaGenesisDev is Ownable, ERC721, DefaultOperatorFilterer {
  // vars
  string public baseUri = "ipfs://Qma5dySa3HtYmgmRdYm1fSXqFzDgVuj3jy7aps87c3FAhN/";
  uint256 public currIdx;
  ...
  function tokenURI(uint256 _id) public view virtual override returns (string memory) {
    require(_exists(_id), "Non exist token");
