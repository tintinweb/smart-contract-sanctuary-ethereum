...
contract LastOneForReal is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "LastOneForReal";
    string constant _symbol = "LastOneForReal";
    ...
    uint256 marketingFee = 40; // 5% of taxes. We'll stonk you with rewards and great marketing.
