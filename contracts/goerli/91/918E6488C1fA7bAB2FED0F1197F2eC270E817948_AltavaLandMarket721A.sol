...
contract AltavaLandMarket721A is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    event mintLandsAndRegisterForSaleEvent(uint256 indexed beginTokenId, uint256 quantity, address indexed coinContract, uint256 price);
     ...
     * 랜드 NFT 민팅
     */
    function mintLands(address to, uint256 quantity, address coinContract, uint256 price) public virtual onlyOwner {
        ...
        emit mintLandsAndRegisterForSaleEvent(nextTokenId, quantity, coinContract, price);
        //----------------------//
    }
...
contract AltavaLandNFT721A is Initializable, ERC721AUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    using SafeMathUpgradeable for uint256;
     ...
     */
    function mintByOwner(address to, uint256 quantity) public virtual onlyOwner {
