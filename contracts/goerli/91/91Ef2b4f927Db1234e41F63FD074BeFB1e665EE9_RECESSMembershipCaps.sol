...
contract RECESSMembershipCaps is ERC721BaseTokenURI {
    ...
    constructor(string memory baseTokenURI)
        ERC721BaseTokenURI('RECESSMembershipCaps', 'CAPS', baseTokenURI)
    {}
    ...
    modifier hasntClaimed(address addr) {
        require(!hasMintedRecess[addr], 'Already claimed your RECESS Membership Cap!');
        _;
    }
