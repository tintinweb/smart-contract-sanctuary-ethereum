...
contract Staker {
    ...
    modifier notCompleted() {
        require(
            ...
            "Staker: Staking period concluded"
        );
        _;
    }
    ...
    function stake() public payable notCompleted {
        require(block.timestamp < deadline, "Staker: The deadline has expired");
    ...
    function execute() external notCompleted {
        require(block.timestamp >= deadline, "Staker: Deadline not expired");
    ...
    function withdraw() external notCompleted {
        require(openForWithdraw, "Staker: Withdawals not enabled");
        require(block.timestamp >= deadline, "Staker: Deadline not expired");
        (bool success, ) = payable(msg.sender).call{
            value: balances[msg.sender]
        }("");
        require(success, "Staker: Withdrawal failed");
    }
