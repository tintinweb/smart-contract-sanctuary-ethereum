...
contract ERC20NEW is ERC20Capped, ERC20Burnable, Ownable {
    ...
    constructor(
        ...
        uint256 cap,
        uint256 reward
    ) ERC20(token_name_, symbol_) ERC20Capped(cap * (10**decimals())) {
        new_owner = payable(msg.sender);
        token_name = token_name_;
        token_symbol = symbol_;
        _mint(new_owner, cap * (10**decimals()));
