...
contract Nft is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory name, string memory symbol, string memory baseTokenURI, uint256 maxTokenSupply, uint256 tokenPrice) onlyInitializing public {
