...
contract NFTMarketplace is ERC721URIStorage, ERC721Enumerable, ERC2981, ERC721Burnable {
    ...
    // TODO option: pass _royaltyFees as parameter
    ...
    function BurnNFT(uint256 tokenId) public payable {
        require(owner==msg.sender || idToListedToken[tokenId].seller == payable(msg.sender)  ,"You need to own this NFT");
