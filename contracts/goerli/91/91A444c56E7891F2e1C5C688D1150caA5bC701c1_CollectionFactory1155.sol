...
contract CollectionFactory1155 is Initializable, OwnableUpgradeable, PausableUpgradeable {
     ...
     */
    function create1155Collection(uint96 _royalty, string memory _uri) public returns (address) {
        NiftyCollection1155 collection = new NiftyCollection1155(_royalty, _uri, msg.sender);
...
contract NiftyCollection1155 is Pausable, Ownable, Niftyco1155Default {
    ...
    constructor(
        ...
        string memory _uri,
        address _admin
    ) Niftyco1155Default(_royalty, _uri, _admin) {
