...
contract YamTest1 is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    constructor(IVotes _token)
        Governor("YamTest1")
        GovernorSettings(1 /* 1 block */, 14400 /* 2 days */, 1)
