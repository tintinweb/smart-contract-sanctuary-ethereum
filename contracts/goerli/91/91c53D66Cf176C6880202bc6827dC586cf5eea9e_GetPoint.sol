...
contract GetPoint is OwnControll {
    ...
    IERC721 public ERC721NTP = IERC721(0xd6af46AD1B94a3AD48b8091da8014ce9937De727);
    IERC721 public ERC721ROARS = IERC721(0xECb49Ccc2929C18c28929bf9aA85b45c92AB0050);
    IPoint public Point = IPoint(0xB101721F00D4a0Fc71C50b44CD5573CF89e79962);

    uint256 public yieldStartTime = 1685255400; //28/05/2023 9pm JST
    uint256 public yieldEndTime = 2000894400; //28/05/2033 9pm JST (changable)

    uint256 public yieldRatePerPointNTP = 200;
    uint256 public yieldRatePerPointROARS = 10;
