    ...
    UUPSUpgradeable
{
    ...
    function safeMint(address to, string memory uri) public payable minAmount {
    ...
    // this will make the contract receive payments
