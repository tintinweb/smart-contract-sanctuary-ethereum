...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xe583769738b6dd4E7CAF8451050d1948BE717679);//USDT
...
;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //testnet router 0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45        _token = msg.sender;
    }
...
contract CONTRACTNAME is IBEP20, Auth {
    ...
    address REWARDS = 0xe583769738b6dd4E7CAF8451050d1948BE717679;//usdt goerli
    address NATIVE = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6
; //weth goerli
