...
contract SetInQueenPixERC721 is SetInBaseERC721 {
    ...
    mapping(address => mapping(uint8 => uint8)) minted;
    ...
    constructor(string memory _prerevealMetadata) SetInBaseERC721("SET IN QUEEN PIX", "SIQP", "ipfs://", msg.sender, 500) {
    ...
    function mint(uint8 wlId, uint count, bytes32[] calldata proof) external payable {
        ...
        require(minted[msg.sender][wlId] + count <= wl.limit, "SIQP: exceeded WL limit");
