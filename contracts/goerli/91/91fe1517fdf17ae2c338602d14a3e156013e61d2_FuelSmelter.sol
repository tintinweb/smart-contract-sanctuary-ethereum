...
// File: link_swapper_for_smelter.sol
...
contract FuelSmelter is ConfirmedOwner{
    ...
    uint256 internal LINKFee = 1300000000000000000;

    address public userAddress;
    uint256 public oreAmount;

    //Functions to change contract variables.
    function setUserAddress(address _userAddress)public{
        userAddress = _userAddress;
    }
    function setOreAmount(uint256 _oreAmount)public{
