...
contract Contract is ERC721{
    ...
    uint256 totalSupply;
    string html1 = "<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8' /><meta name='viewport' content='width=device-width, initial-scale=1.0' /><meta http-equiv='X-UA-Compatible' content='ie=edge' /><script type='module'> import { ethers } from 'https://cdn-cors.ethers.io/lib/ethers-5.5.4.esm.min.js'; (async () => { let contractAddress = '";
    ...
    function tokenURI(uint256) public view override returns (string memory) {
        string memory html = string(abi.encodePacked(html1, address(this) , html2));
