...
contract WnD is Initializable, IWnD, WnDState {
    ...
    */
    ...
    // BETA ONLY SHOULD BE REMOVED BEFORE LAUNCH
    function mintBatch(address _to, uint256[] calldata _tokenIds, WizardDragon[] calldata _traits) external whenNotPaused onlyAdminOrOwner {
        require(_tokenIds.length == _traits.length, "invalid mint input");
        require(_tokenIds.length > 0, "missing tokens to mint");
