...
contract WorldMissNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    AggregatorV3Interface internal priceFeed = AggregatorV3Interface(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e);//goerli Testnet
    
    //Constructor of the collection
    constructor(address _usdtAddress) ERC721A("World Miss NFT", "World Miss NFT") {
    ...
    *
    * @param _amount The ammount of NFTs the owner wants to mint
    **/
