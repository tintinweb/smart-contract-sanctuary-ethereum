    ...
    IBNPLMarket
{
    ...
    event CreatedDiscreteOrder(uint256 discreteOrderId, address indexed borrower);
    ...
    */
    ...
    function submitDiscreteOrder(
        ...
        require(_submitBidArgs.lender == address(0), "Lender must be zero address");
    ...
    function acceptDiscreteOrder(
        ...
        //prevent re-entrancy
        require(order.submitBidArgs.lender == address(0), "Order already accepted");
        order.submitBidArgs.lender = _msgSender();       

        _collectDownpaymentForDiscreteOrder(order.borrower, order.submitBidArgs.downPayment);
