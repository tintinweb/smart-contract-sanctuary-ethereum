...
contract PFPRaffle is ERC721A, Ownable {
    constructor(
        string memory name,
    ...
    uint256 private nTotalSupply = 10000;
    ...
    event RaffleEmitted(address tokenMinter, uint256 mintedTokenId, address minterContractAddress, uint256 mintedTokenID);
   ...
   /* function hashTransaction(address sender, uint256 qty, string memory nonce) private pure returns(bytes32) {
    ...
    function setTotalSupply(uint256 _total) public onlyOwner() {
        nTotalSupply = _total;
    }
     ...
     */
    function mintRaffle(bytes memory signature, address contractAddress, 
    ...
    {   
        ...
        require( matchAddresSignature(hashTransaction(recipient, address(this), contractAddress, contractToken, uri), signature),   "4");
       
        require( supply < nTotalSupply, "3" );
        require( msg.value >= _price, "4" ); 
        ...
        require(contractAddress != address(this), "Cannot mint the raffles");
        ...
        emit RaffleEmitted(recipient, _mintedTokens, contractAddress, contractToken);
    }
