...
import "../extensions/ERC721AdminMintable.sol";

contract ERC721PresetAdminMintableURI is ERC721AdminMintable {
    ...
    ) ERC721AdminMintable(_name, _symbol) {
...
contract ERC721AdminMintable is ERC721, AccessControl, ERC721URIStorage {
    ...
    /// @param to user's unique transaction ID
    /// @param uri token metadata

    function mint(address to, string memory uri) external onlySigner {
