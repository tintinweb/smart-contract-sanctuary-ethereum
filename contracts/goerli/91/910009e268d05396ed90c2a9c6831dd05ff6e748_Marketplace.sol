...
interface ERC1155Interface {
  ...
  function safeTransferFrom(address _from, address _to, uint256 _tokenId,uint256 amount,
...
contract MarketplaceStorage {
  ...
  // From ERC1155 registry tokenId to Order (to avoid asset collision)
  mapping (address => mapping(uint256 => Asset)) public orderBytokenId;
...
/**
    ...
    internal
  {
    ...
    orderBytokenId[nftAddress][tokenId] = Asset({
      id: orderId,
      tokenId:tokenId,
      seller: assetOwner,
...
function _cancelOrder(address nftAddress, uint256 tokenId) internal returns (Asset memory) {
    address sender = _msgSender();
    Asset memory order = orderBytokenId[nftAddress][tokenId];
    ...
    delete orderBytokenId[nftAddress][tokenId];
   ...
   internal returns (Asset memory)
  {
    ...
    require(seller == ownerOf[tokenId], "The seller is no longer the owner");
  ...
  function _requireERC1155(address nftAddress) internal view {
    ...
    ERC1155Interface nftRegistry = ERC1155Interface(nftAddress);
    require(
      nftRegistry.supportsInterface(ERC1155_Interface),
