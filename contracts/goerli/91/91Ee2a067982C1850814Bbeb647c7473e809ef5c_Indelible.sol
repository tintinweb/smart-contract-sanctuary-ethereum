...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Hands", unicode"eyes", unicode"mouth", unicode"Skin", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"Frog Central", unicode"Frog Central - is the central for all the enthusiasts who were wishing for the generational wealth in Crypto space, but ended up losing their wages, family, frens and money. But we are here to change it. The community that might be build will solve all the problems and sweeps all the Ls you caught. Join the legion, be a part of the gang, be a member of the Frog Central. 🐸 🤝 🐸", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/49273eab-7924-4550-8a2d-2998f2d5eeae", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/49273eab-7924-4550-8a2d-2998f2d5eeae", "", 500, "0x37d245b218FfD8d546B5d16CC1f95442F70aC6Ec");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Frog Central", unicode"FrogCentral") {
        tiers[0] = [1,1,1,1,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,40,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,41,42,42,42,42,42,42,42,42,42,45,50,50,50,50,50,50,50,55];
        tiers[1] = [3,3,3,3,3,3,3,3,3,3,3,3,3,5,5,5,5,5,5,5,19,19,26,44,45,45,45,46,50,55,55,55,55,66,71,75,77,80,83,88,98,99,109,109,112,112,117,119,122,126,127,130,139,150,158,176,180,190,201,253];
        tiers[2] = [2,11,11,11,11,11,11,77,80,85,111,120,129,143,160,189,200,202,222,299,301,312,350,402,550];
        tiers[3] = [50,100,150,300,300,400,400,400,400,450,525,525];
        tiers[4] = [50,100,300,550,600,700,800,900];
