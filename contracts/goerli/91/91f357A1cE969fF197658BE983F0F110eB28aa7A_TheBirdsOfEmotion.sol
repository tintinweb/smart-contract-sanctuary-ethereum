...
contract TheBirdsOfEmotion is ERC721A, Ownable, ERC2981, VRFV2WrapperConsumerBase {
    ...
    */
    ...
    {
        _mintERC2309(withdrawAddress_, RESERVED_TOKENS);
        ...
        isSaleState(SaleState.Public)
    {
        ...
        if (_totalMinted() + quantity_ > (maxSupply - RESERVED_TOKENS)) revert SupplyExceeded();
    ...
    function fulfillRandomWords(
        ...
        startingIndex = _randomWords[0] % maxSupply;
