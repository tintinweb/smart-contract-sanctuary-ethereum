...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xAD55Fb4464cEb5990dB3E169D3C037829820731B];
  address public erc20Payable = 0xAD55Fb4464cEb5990dB3E169D3C037829820731B;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicpdpvh57zmf6m6sb6goscqlo6lzuhzqrg2is6afwwxkrlepscw24/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/tniW9FGblfdGmXNYnlJu/contract-metadata";
  }
...
// File: contracts/CscscsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CscscsContract is RamppERC721A {
    constructor() RamppERC721A("CSCSCS", "CS"){}
}
