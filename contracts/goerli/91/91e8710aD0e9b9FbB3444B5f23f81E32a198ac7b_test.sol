...
contract test is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public PRO_SUPPLY = 50;
    
    bool public IS_PRO_ACTIVE = false;

    
    uint256 public PRO_TX_LIMIT = 50;

    
    uint256 public PRO_WALLET_LIMIT = 50;

    
    uint256 public PRO_PRICE = 0.000001 ether;
    ...
    mapping(address => uint) public PRO_Minted;

    bool public _revealed = false;

    string private baseURI = "";
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmSmduEkmuNfw26bSN1gLZZg3rz2QaNZaK9CjnpQ1572bh";

    mapping(address => uint256) addressBlockBought;

    address public constant RL_ADDRESS = 0xc9b5553910bA47719e0202fF9F617B8BE06b3A09; 

    constructor() ERC721A("test", "MOIST") {
    ...
    function PROMint(uint256 numberOfTokens) external isSecured(PRO_PRICE * numberOfTokens) payable {
        validateMint(IS_PRO_ACTIVE, PRO_COUNT, PRO_SUPPLY, PRO_Minted[msg.sender], PRO_WALLET_LIMIT, PRO_TX_LIMIT, numberOfTokens, true);
