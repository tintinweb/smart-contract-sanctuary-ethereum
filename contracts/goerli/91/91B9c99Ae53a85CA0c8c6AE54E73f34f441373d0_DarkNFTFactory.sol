...
/* Dark NFT Factory
    Create new Dark NFT collection
*/
contract DarkNFTFactory {
    // owner address => nft list
    mapping(address => address[]) private nfts;

    mapping(address => bool) private dfktNFT;
    ...
    function isDarkNFT(address _nft) external view returns (bool) {
        return dfktNFT[_nft];
    }
}
...
/* Dark NFT-ERC721 */
contract DarkNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
