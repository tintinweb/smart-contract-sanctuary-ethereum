...
contract TRIP3 is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {

    uint public maxSupply  = 8282;          // Hard-coded in setMaxSupply() also.
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[0]] = Account( 25, 0, 3 ); // jdtest
        accounts[teamclaim[1]] = Account( 25, 0, 3 ); // jdtest
    ...
    function setMaxSupply(uint _maxSupply) external onlyOwner {
        require(_maxSupply <= 8282, 'Error: New max supply cannot exceed original max.');        
...
contract PaymentSplitter is Context {
     ...
     * total shares and their previous withdrawals. (RELEASE CHANGED HERE AND BELOW TO INTERNAL)
     */
