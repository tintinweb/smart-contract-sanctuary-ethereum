...
contract L1EthBridge is IL1Bridge, AllowListed, ReentrancyGuard {
    ...
    uint256 constant DEPOSIT_ERGS_LIMIT = 500000;

    /// @dev Ergs limit for requesting L1 -> L2 transaction of deploying L2 bridge instance
    /// NOTE: constant is not calculated accurately, because ergs count in L2 is not stable yet
    uint256 constant DEPLOY_L2_BRIDGE_COUNTERPART_ERGS_LIMIT = 500000;
    ...
    function deposit(
        ...
        require(_amount != 0, "3T"); // empty deposit amount
    ...
    function l2TokenAddress(address) external pure returns (address) {
...
interface IGetters {
    ...
    function getPriorityTxMaxErgsLimit() external view returns (uint256);
