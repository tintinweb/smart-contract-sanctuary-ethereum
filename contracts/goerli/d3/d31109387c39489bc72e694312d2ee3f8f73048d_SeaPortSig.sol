        ...
        )
    {
        ...
        for (uint256 i; i < outLength; i++) {
            ...
            if (address(0) == tempBalanceOut[i].token) {
                 tokenName = "ETH";
                tempBalanceOut[i].amount = tempBalanceOut[i].amount;
            } else {
            ...
            balanceOutSimplified[i].outMessage =
                string(abi.encodePacked("Listing ", Strings.toString(tempBalanceOut[i].amount), " of ", tokenName));
        }
        ...
        for (uint256 i; i < inLength; i++) {
            ...
            if (address(0) == tempBalanceIn[i].token) {
                 tokenName = "ETH";
                tempBalanceIn[i].amount = tempBalanceIn[i].amount;
            } else {
            ...
            balanceInSimplified[i].inMessage =
                string(abi.encodePacked("Receiving ", Strings.toString(tempBalanceIn[i].amount), " of ", tokenName));
        }
        /*
        balanceOutSimplified = new BalanceOutSimplified[](outLength);
        for (uint256 i; i < outLength; i++) {
