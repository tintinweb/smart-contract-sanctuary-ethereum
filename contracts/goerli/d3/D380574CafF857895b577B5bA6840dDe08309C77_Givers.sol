...
contract Givers is Context, IERC20, Ownable {
    ...
    uint256 private _liquidityFee = liquidityFee.add(charityFee);
    uint256 private _previousLiquidityFee = _liquidityFee;
	
	uint256 public _burnFee = 1;
    uint256 private _previousBurnFee = _burnFee;

    uint256 private _charityPartAfterSwap = 2;
    uint256 private _liquidityPartAfterSwap = 1;
    uint256 private _charityLiquidity = _charityPartAfterSwap.add(_liquidityPartAfterSwap);
    ...
    function FromTokreflectionen(uint256 tAmount, bool deductTransferFee) public view returns(uint256) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap 
	{
		...
		uint256 liquidityPart = newBalance.div(_charityLiquidity).mul(_liquidityPartAfterSwap);
		        
		uint256 charityPart   = newBalance.div(_charityLiquidity).mul(_charityPartAfterSwap);
