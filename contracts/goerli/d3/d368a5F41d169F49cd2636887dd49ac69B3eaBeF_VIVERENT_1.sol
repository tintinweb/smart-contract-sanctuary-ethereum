...
contract VIVERENT_1 is ERC20, Ownable, ReentrancyGuard {
    ...
    address private mintAddress = 0x593cd62B3e5C6186Cd852450B89cC02B88a1948f;

    constructor() ERC20("VIVERENT_1", "VIV_1") {
