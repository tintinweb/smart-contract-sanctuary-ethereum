...
contract Tokenier is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
    using Address for address;
 
    string private _name = "fuckAI";
    string private _symbol = unicode"fkAI";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x10d2eDe7b64E5807060cBf0795d260894A50a4D9));
        marketingWallet = payable(address(0x556770301F2c44ba143A355439C9Dc979C99e798));
