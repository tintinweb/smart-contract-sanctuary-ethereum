            ...
            base64String = Base64.encode(bytes(
                abi.encodePacked(
                    '<svg width="500" height="500" xmlns="http://www.w3.org/2000/svg">',
                        ...
                        '<rect transform="rotate(90 250 350)" fill="hsl(',currentBlock.bar1Hue,', 80%, 50%)" x="215" y="285" width="70" height="',bar1,'"/>',
                        '<rect transform="rotate(90 250 250)" fill="hsl(',currentBlock.bar2Hue,', 70%, 60%)" x="215" y="175" width="70" height="',bar2,'"/>',
                        '<rect transform="rotate(90 250 150)" fill="hsl(',currentBlock.bar3Hue,', 75%, 75%)" x="215" y="65" width="70" height="',bar3,'"/>',
                    '</svg>'
                )
            ));
        }
