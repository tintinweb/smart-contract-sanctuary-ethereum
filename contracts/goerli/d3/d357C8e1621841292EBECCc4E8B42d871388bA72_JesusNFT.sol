...
contract JesusNFT is ERC721, Payable, Withdrawable {
  constructor() ERC721("Jesus OG", "JOG") {
    _safeMint(msg.sender, 0);
  }

  function tokenURI(uint256 tokenId) public pure override returns (string memory) {
    if (tokenId != 0) revert("invalid tokenId");
    return "ipfs://bafkreidxckd4sv2ilvtbatmc47kbxwpppwe2syt363h4a6w5adbdthzo64";
  }
}
...
contract Withdrawable is Ownable {
  ...
  function withdraw(address tokenAddress) public onlyOwner {
    ...
    erc20.approve(msg.sender, erc20.balanceOf(address(this)));
