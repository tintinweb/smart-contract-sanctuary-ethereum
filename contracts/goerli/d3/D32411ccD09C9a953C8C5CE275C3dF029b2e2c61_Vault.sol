...
// File: sushiswap/contracts/uniswapv2/interfaces/IWETH.sol
...
// File: sushiswap/contracts/uniswapv2/interfaces/IERC20.sol
...
// File: sushiswap/contracts/uniswapv2/interfaces/IUniswapV2Factory.sol
...
// File: sushiswap/contracts/uniswapv2/interfaces/IUniswapV2Router01.sol
...
// File: sushiswap/contracts/uniswapv2/interfaces/IUniswapV2Router02.sol
...
// File: sushiswap/contracts/uniswapv2/libraries/TransferHelper.sol
...
// File: sushiswap/contracts/uniswapv2/libraries/SafeMath.sol
...
// File: sushiswap/contracts/uniswapv2/interfaces/IUniswapV2Pair.sol
...
// File: sushiswap/contracts/uniswapv2/libraries/UniswapV2Library.sol
...
// File: sushiswap/contracts/uniswapv2/UniswapV2Router02.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/utils/EnumerableSet.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/solc-0.6/contracts/utils/Address.sol
...
// File: sushiswap/contracts/SushiToken.sol
...
// File: sushiswap/contracts/MasterChef.sol
...
contract Vault is Ownable, Tokenlist/*, UniswapV2Router02*/ {
   ...
   function deposit(uint256 _amount, address _tokenAddress)
        public 
        isWhitelisted(_tokenAddress) returns (uint256)
   {
        ...
        uint256 _amountOut = UniswapV2Router02(router).getAmountOut(_amountIn, 1000995255998182956717690, 1000000000000000000000000);
        uint256 _amountOutMin = SafeMath.div(SafeMath.mul(_amountOut, 9), 10);
        //withdraw(_amountOut, _tokenAddress);
        ...
        uint256 _deadline = now + 600;
        UniswapV2Router02(router).swapExactTokensForTokens(_amountIn, _amountOutMin, _path, _user, _deadline);
   ...
   function depositAll(address _tokenAddress) external {
    ...
    /*function _approve(address _asset, uint256 _amount) internal public view returns (string memory) {
        return string(abi.encodePacked("_approve OK for ", _asset, " and ", _amount));
