...
import "./tERC721B2FAEnumLitePausable.sol";
import "@openzeppelin/contracts/utils/cryptography/MerkleProof.sol";
import "@openzeppelin/contracts/utils/Address.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract ghostyTest is tERC721B2FAEnumLitePausable {
    ...
    constructor() tERC721B2FAEnumLitePausable("The Time is DAO", "TTDAO", 1) {}
...
abstract contract tERC721B2FAEnumLitePausable is
    tERC721B,
    ...
    IERC721Enumerable
{
    constructor(
        ...
        uint256 _offset
    ) tERC721B(_name, _symbol, _offset) {}
    ...
    function totalSupply()
        public
        view
        override(tERC721B, IERC721Enumerable)
        returns (uint256)
    {
    ...
    Delegated
{
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        emit Transfer(address(0), 0xA94F799A34887582987eC8C050f080e252B70A21, tokenId);
    }
