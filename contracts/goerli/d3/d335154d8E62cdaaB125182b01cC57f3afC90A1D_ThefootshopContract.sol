    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 30000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigym4vhfvoepfoy5gp4ketzorcq36iz3c5fajdd3kj336oh4nkjzm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/efTi3kijBtyf8rjLolXE/contract-metadata";
  }
...
contract ThefootshopContract is ERC721APlus {
    constructor() ERC721APlus("THE FOOT SHOP", "MINTPLEX"){}
}
