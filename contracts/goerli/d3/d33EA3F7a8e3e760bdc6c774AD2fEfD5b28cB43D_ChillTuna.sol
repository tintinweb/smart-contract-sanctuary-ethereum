...
contract ChillTuna is ERC721AUpgradeable, ERC721AQueryableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function ogMint(address to, uint256 quantity, bytes32[] memory _proof) external payable nonReentrant {
    ...
    function wlMint(address to, uint256 quantity, bytes32[] memory _proof) external payable nonReentrant {
