...
contract OPCH is ERC20Burnable, ERC20Storage {
    ...
    uint256 public constant MarketingLimit = 25 * (10**7) * 10**18;
    uint256 public constant TeamLimit = 6 * (10**7) * 10**18;
    uint256 public constant StrategicLimit = 10 * (10**7) * 10**18;
    uint256 public constant PublicSaleLimit = 25 * (10**7) * 10**18;
    uint256 public constant LiquidityLimit = 10 * (10**7) * 10**18;
    uint256 public constant PrivateSaleLimit = 10 * (10**7) * 10**18;
    uint256 public constant FoundationLimit = 10 * (10**7) * 10**18;
    uint256 public constant AdvisersLimit = 4 * (10**7) * 10**18;
