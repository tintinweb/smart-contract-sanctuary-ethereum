...
contract AirdropToNftHolder is Ownable  {
    
    uint256 public airDrop = 10 ether;
    Revoltage rewards;

    constructor(Revoltage _rewards) {
        rewards = _rewards;
    }

    function issueAirDropREVO(address[] calldata holder) public onlyOwner {
        rewards.transferAirdrop(holder, airDrop);
    }

    function stopIssueAirDropREVO() public onlyOwner {
        rewards.removeController();
    }
}
