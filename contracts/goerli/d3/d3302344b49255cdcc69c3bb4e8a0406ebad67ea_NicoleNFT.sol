...
contract NicoleNFT is ERC721A, ERC721AQueryable, ERC721ABurnable, ERC2981, Ownable, Pausable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    constructor(bool mintERC2309Flg, bool _callerIsUserFlg) ERC721A("JohnSkater", "JOHN") {
        ...
        if (mintERC2309Flg == true) {
            _mintERC2309(0x61a0B31c6e8182584AeF37F58A2e859b9bc2B73d, 50);
        }
    }
    ...
    function publicMint(uint256 _mintAmount) external payable whenNotPaused callerIsUser whenMintable {
        checkPublicEligibility(_mintAmount, msg.value);
        _mint(msg.sender, _mintAmount);
    }

    function checkPublicEligibility(uint256 _mintAmount, uint256 _value) public view {
