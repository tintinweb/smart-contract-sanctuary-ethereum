...
contract Portal is OwnableUpgradeable {
    ...
    function addInvestment(
        ...
        ); // Cannot override existing investment
    ...
    function investPoolTwo(
        ...
        require(
            amount <= _investment.investAmountAvailable,
    ...
    function settlePoolTwo(uint256 investmentId) external onlyOwner {
        ...
        if (
            _investment.pool2TotalCommited > _investment.investAmountAvailable
        ) {
