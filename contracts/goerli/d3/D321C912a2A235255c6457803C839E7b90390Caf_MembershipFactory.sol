...
contract Membership is IMembership, Ownable, ReentrancyGuard {
    ...
    /**
     * @dev getMemberAddress
     * @return address of the MemberContract from the protocol directory
     */
    function getMemberAddress() public view returns (address) {
        return IProtocolDirectory(directoryAddress).getMemberContract();
    }
}
