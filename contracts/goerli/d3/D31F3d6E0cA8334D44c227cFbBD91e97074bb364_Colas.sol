...
contract Colas {
    ...
    function comprarReserva(uint256 _idReserva, string memory _nombre, string memory _apellido, uint256 _dni, uint256 _precioVenta) public payable {
        ...
        reserva.nombre = _nombre;
        reserva.apellido = _apellido;
        reserva.dni = _dni;
        ...
        emit ReservaComprada(reserva.idReserva, reserva.nombre, reserva.apellido, reserva.dni, reserva.precioVenta, reserva.dueno);
    }
