...
contract PizzaV3 is Pizza {
    ...
    function mytestv2func2(uint256 _sayi) external pure returns (uint256) {
        uint256 sayi = _sayi * 6;
        return sayi;
    }

    function mytestv2fun3(uint256 _sayi) external pure returns (uint256) {
        uint256 sayi = _sayi * 4;
        return sayi;
    }
}
...
contract Pizza is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function mytestv1func6() external pure returns(uint256) {
        return 6;
    }
}
