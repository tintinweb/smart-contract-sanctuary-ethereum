...
contract DinoEgg is ERC721, ERC721Burnable, Ownable {
    ...
    //checks owner balance for token and returns true/false
    ...
    function vipAndTeamMint(uint quantity) public
    {
        ...
        require(quantity <= 10, "preventing you from minting the entire supply on the first swing.");
    ...
    function stakersMint(uint quantity) public {
        ...
        require(quantity <= 3, "preventing you from minting the entire supply on the first swing.");
        require(stakersMintCount[msg.sender] <= stakerLimits, "you've minted the max amount for this phase");
        require(dinoToken.transferFrom(msg.sender, address(this), (1000 * 10 ** 18) * quantity),"either no approval or not enough dino");
    ...
    {   
        ...
        require(dinoToken.transferFrom(msg.sender, address(this), (1000 * 10 ** 18) * quantity),"either no approval or not enough dino");
        //throttle to prevent exploitation of mapping limit
        require(quantity <= pubMintThrottle, "cant mint more than the throttle at one time");
