...
/**
 * @title A contract for MetaInfluencers
 * @author Akileus
 * @notice NFT Minting
 */
...
contract AlphaBallerz is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_BATCH_SIZE = 5;

    uint256 private MAX_MINT = 1;
    ...
    uint256 public pulicSupply = 0;

    event PublicMint(uint256 supply);

    constructor(string memory _initBaseURI) ERC721A("Ballerz", "blz") {
