...
contract PutFactory is Ownable {
    ...
    */
    ...
    function createPutMarket(
        ...
        AoriPut putMarket = new AoriPut(AoriSeats(AORISEATSADD).getFeeMultiplier(), strikeInUSDC, duration, USDC, UNDERLYING, oracle, AoriSeats(AORISEATSADD), name_, symbol_);
