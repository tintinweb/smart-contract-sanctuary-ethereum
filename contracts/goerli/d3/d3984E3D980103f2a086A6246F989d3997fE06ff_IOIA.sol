...
contract IOIA is ERC721, Ownable, ReentrancyGuard {
   ...
   uint public maxSupply = 310;
   uint8 public TOKENS_PER_PERSON_PUB_LIMIT = 1;
   uint public MINT_PRICE = 0 ether;
   SaleStatus public saleStatus = SaleStatus.PAUSED;
   string private _baseURL = "https://black-traditional-tiger-884.mypinata.cloud/ipfs/QmNpQCi7EJhpdUeQkUgV7VLP9qbQtuX2x25wMp5BeU9rfK/"; 
   bytes32 public root;
   ...
   string private _websiteDomain = "ioinvestmentacademy.com";
   ...
   function calcTotal(uint count) public view returns(uint) {
    ...
    function privateMint(uint8 numberOfTokens, string memory domain) nonReentrant external payable {
    require(keccak256(abi.encodePacked(domain)) == keccak256(abi.encodePacked(_websiteDomain)), "Unauthorized website domain");
    ...
    _tokenIds = Counters.Counter(currentTokenId);
