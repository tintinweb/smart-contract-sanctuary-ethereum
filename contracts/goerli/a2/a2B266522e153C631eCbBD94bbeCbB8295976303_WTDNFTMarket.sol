    ...
    Ownable
{
    ...
    event ListingCreated(uint256 listingId, uint256 tokenId, address sellerAddress, uint256 startPrice);
    event ListingUpdated(uint256 indexed listingId);
    event ListingCanceled(uint256 indexed listingId);
    event ListingBidPlaced(uint256 indexed listingId);
    event FixedPricePurchased(uint256 indexed listingId, uint256 fixedPrice);
    ...
    function createListing(
        ...
        emit ListingCreated(listingId, tokenId, msg.sender, startPrice);
    }
    ...
    function purchaseFixedPrice(uint256 listingId) public payable nonReentrant {
        ...
        emit FixedPricePurchased(listingId, listing.amount);
