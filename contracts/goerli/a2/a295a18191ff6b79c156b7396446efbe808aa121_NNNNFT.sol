...
contract NNNNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("NoNutNov", "NNN") {}
    ...
    modifier mintActiveCompliance(uint256 _count) {
        require(mintActive, "Nut is not active");
        _;
    }
    ...
    function reserveTokens(uint256 _count)
        external
        nonReentrant
        onlyOwner
    {
