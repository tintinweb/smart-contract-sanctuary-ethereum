...
library Traits {
    ...
    function generateTokenInventory() internal pure returns (Raids.RaidInventory memory) {
        return Raids.RaidInventory(Raids.Gear("","","",0),Raids.Gear("","","",0),Raids.Gear("","","",0),Raids.Gear("","","",0),Raids.Gear("","","",0),Raids.Gear("","","",0),Raids.Gear("","","",0),Raids.Gear("","","",0),Raids.Gear("","","",0),Raids.Gear("","","",0));
    }
}