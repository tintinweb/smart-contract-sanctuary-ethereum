...
contract MergeGatorsMock is MergeGators {
    ...
    //11
    address constant collection = 0x1Cff8CC7Feb4fa27f6A66Ac818edaC1705E439FB;
...
contract MergeGators is Ownable, VRFConsumerBaseV2 {
    ...
    function merge(
        ...
        alligators.merge(_1st, _2nd, _3rd, to);

        emit mergeFulfilled(alligators.currentMergeId());
    }


    function mergeWithJoker(
        uint256 _1st,
        uint256 _2nd,
        uint256 _3rd,
        address to
    ...
    function _isValidRequest(uint256 _1st, uint256 _2nd, uint256 _3rd, address _owner) internal view returns (uint state) {
        require(
            alligators.ownerOf(_1st) == _owner && alligators.ownerOf(_2nd) == _owner && alligators.ownerOf(_3rd) == _owner,
                "Failed AUTH");
        return state = 1;
    }
