...
contract NFTIntegrationDemo is Ownable, ReentrancyGuard, ERC721, DefaultOperatorFilterer {
    ...
    constructor(string memory _uri, uint256 _MAX_TOTAL_SUPPLY, address _signerMint, address _vault) ERC721("Test NFT", "TNFT") {
        uri = _uri;
    ...
    function approve(address to, uint256 tokenId) public virtual override(ERC721) onlyAllowedOperatorApproval(to) {
        super.approve(to, tokenId);
    }

    function setApprovalForAll(address operator, bool approved) public virtual override(ERC721) onlyAllowedOperatorApproval(operator) {
    ...
    eoaOnly
    {
        ...
        require(MAX_TOTAL_SUPPLY - totalSupply() >= 1, "Max supply reached");
        ...
        emit Mint(msg.sender, whiteListMintPrice, totalSupply() - 1, status);
    }
    ...
    eoaOnly
    {
        ...
        emit Mint(msg.sender, publicMintPrice, totalSupply() - 1, status);
    }
