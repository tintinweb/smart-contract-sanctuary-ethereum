...
contract SpaceBuns is ERC721A, ReentrancyGuard, Ownable {
    ...
    uint256 public alMintPrice = 0.004 ether;
    ...
    constructor() payable ERC721A("SPACEBUNS", "BB") {
      ...
      billionBuns = IERC721Enumerable(0x51d3388DA997c155BA8aB3A9FD925475CfFee09E);
    }
    ...
    function _priceCalc(uint _quantity) private view {
      ...
      require(maxSupply - reserveSupply >= totalSupply() + _quantity, "Sold out or Exceeds max tokens");
    }
    ...
    function ogMint(bytes32[] calldata _merkleProof) external nonReentrant {
      ...
      require(billionBuns.balanceOf(msg.sender) > 0, "You do not own an original Billion Buns NFT");
    ...
    function unclaimedSupply() public view returns (uint256) {
      return maxSupply - reserveSupply - totalSupply();
    }
    ...
    function claimTo(address _userWallet, uint256 _quantity, uint256 _tokenId) public payable nonReentrant priceCalc(_quantity) {
      require(isAlMint || isPublicMint, "Minting is not live.");
