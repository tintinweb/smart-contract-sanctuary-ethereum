...
import "./SqueakersNFT.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";
import "@openzeppelin/contracts/utils/Counters.sol";

contract SqueakerSale is AccessControl {
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIdCounter;
    mapping (address => uint256) public ownerQty;

    SqueakersNFT public nft;
    string public baseURI;

    constructor() {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        nft = new SqueakersNFT();
    ...
    function mint() public payable{
        ...
        SqueakersNFT(nft).safeMint(msg.sender, baseURI, tokenId);
        _tokenIdCounter.increment();
        ownerQty[msg.sender] += 1;
    }

    // function mintBatch(uint _qty) public payable {
    //     require(_qty <= 5, "You can only mint 5 NFTs");
...
contract SqueakersNFT is DefaultOperatorFilterer, ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable{
    ...
    constructor() ERC721("MyToken", "MTK") {
        ...
        _grantRole(UPDATER_ROLE, tx.origin);
    }
    ...
    function safeMint(address to, string memory uri, uint256 tokenId) public onlyRole(MINTER_ROLE) {
        tokenIdFromContract = tokenId;
        _safeMint(to, tokenIdFromContract);
