...
contract ReactorFactory {
    ...
    address comiteFiducia = 0x000000000000000000000000000000000000dEaD; // address de la Fiducia
    address public admin = 0x000000000000000000000000000000000000dEaD; // address del admin (Titanius)
...
contract Reactor is ERC1155, Pausable {
    ...
    address public admin = 0xf6a2fc52561b6f3073AFaECe361A94604BC22C07; // address del admin (Titanius)
