...
contract BatchReader 
{
    ...
    constructor()
    {
        ...
        CitizenCities.push(CitizenCity('CryptoGalacticans', 0x536A54bBa9b0683FCC6657B40273d48BE1Cb8DFb, 0, 100));
        CitizenCities.push(CitizenCity('CryptoVenetians', 0x536A54bBa9b0683FCC6657B40273d48BE1Cb8DFb, 0, 100));
        CitizenCities.push(CitizenCity('CryptoNewYorkers', 0x536A54bBa9b0683FCC6657B40273d48BE1Cb8DFb, 0, 100));
        CitizenCities.push(CitizenCity('CryptoBerliners', 0x536A54bBa9b0683FCC6657B40273d48BE1Cb8DFb, 0, 100));
    }
    ...
    function readNFTOwners(
        ...
        for(uint x; x < NFTAddresses.length; x++)
        {
            uint Range = EndingIndex - StartingIndex + 1;
            IERC721 NFT = IERC721(NFTAddresses[x]);
            address[] memory temp = new address[](Range);
            uint counter;
            for(uint y = StartingIndex; y <= EndingIndex; y++)
            {
                try NFT.ownerOf(y) 
                {
