...
contract AGStake is Ownable, ERC1155Holder {
    ...
    function _claim(address account, bool hardClaim) internal {
        ...
        uint256 bonusBase = 250_000_000_000_000_000;
        uint256 bonus = 10**18; // multiplier of 1
    ...
    function getPendingRewards(address account, bool hardClaim)
        external
        view
