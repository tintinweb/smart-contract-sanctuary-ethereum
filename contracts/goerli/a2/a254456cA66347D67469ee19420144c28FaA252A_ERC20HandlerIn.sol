...
contract ERC20HandlerIn is
     ...
     */
    function init(address bridgeAddress, address WETH) external initializer proxied {
        __UUPSUpgradeable_init();
        __AdminProxyManager_init(_msgSender());
        __HandlerHelpersCustom_init(bridgeAddress);
...
contract HandlerHelpersCustom is
    ...
    /**
        @param bridgeAddress Contract address of previously deployed Bridge.
     */
    function __HandlerHelpersCustom_init(address bridgeAddress) internal onlyInitializing {
        __HandlerHelpersCustom_init_unchained(bridgeAddress);
    }

    function __HandlerHelpersCustom_init_unchained(address bridgeAddress) internal onlyInitializing {
        __Ownable_init();
        __Pausable_init();
