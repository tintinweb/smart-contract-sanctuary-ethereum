...
contract D00sh3stest is Ownable, ERC721A, DefaultOperatorFilterer {
    ...
    uint256 public constant MAX_MINT_PER_WALLET_ALLOWLIST = 3;
    uint256 public constant MAX_MINT_PER_WALLET_PUBLIC = 3;

    uint256 public priceAL = 0.0001 ether;
    uint256 public pricePub = 0.0001 ether;
    //ipfs://QmY9KAGLABS9EuSXvBMkrmQHye9LPjhjtF25ad4SKxjFcE/
    string private baseTokenURI; //ipfs://QmZVEPYWVmBb3yus6bWxNYQAKcCD4SP2JnFKv9N86nK8Zx/
    bool public stateDL;
    bool public stateAL;
    ...
    ) ERC721A("D00sh3stest", "D00sh3stest") {
        rootDL = _rootDL;
        rootAL = _rootAL;
    ...
    //[0x4892b8fa30a7cf17f5d65eec8a74b238bc22ac6606802d2515b27f53d969b16f,0x07145bc07469baae6433707af88b8bdf01fa157cda5d3f27651c567794915b41,0x795d0f5440dd5d4a1cc3a348101824ebfc214967662bdfadb5d97cb24d0e0464]
    ...
    /*
    function switchMetadata() external onlyOwner {
        string memory help = baseTokenURI;
        baseTokenURI = baseTokenURI2;
        baseTokenURI2 = help;
    }
*/
