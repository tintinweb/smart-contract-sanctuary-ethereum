...
//*********************************************************************//
//
//     __  ___           _         _   ______________                        _ 
//    /  |/  /_  _______(_)____   / | / / ____/_  __/____   ____ _____ ___  (_)
//   / /|_/ / / / / ___/ / ___/  /  |/ / /_    / / / ___/  / __ `/ __ `__ \/ / 
//  / /  / / /_/ (__  ) / /__   / /|  / __/   / / (__  )  / /_/ / / / / / / /  
// /_/  /_/\__,_/____/_/\___/  /_/ |_/_/     /_/ /____/   \__, /_/ /_/ /_/_/   
//                                                       /____/                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xd35D60B1746cAEc2289c892EAC7351D66d63455B];
...
// File: contracts/MusicNfTsgmiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MusicNfTsgmiContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Music NFTs gmi";
    string public symbol = "CRITTIE";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ilIlsfmdR50ZT0oAhXTH/contract-metadata";
  }
