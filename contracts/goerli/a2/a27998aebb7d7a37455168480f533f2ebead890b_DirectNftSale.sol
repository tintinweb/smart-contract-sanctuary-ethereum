...
// File: contracts/24_rabbit_nft_sale.sol

/**
 *Submitted for verification at Etherscan.io on 2022-09-09
*/

// File: contracts/DirectNftSale.sol
...
contract DirectNftSale {  
    ...
    function createMintedSale(
        ...
        uint256 _tokenId
            ...
            require((_tokenId) > 0, "the NFT tokenId can not be empty");
            require((_price > 0),"the price should be greater than 0 ");
            require(_current_owner != address(0), "the current owner can not be empty");
         ...
         tokenId : _tokenId
            ...
            sales.push(_sale);
            RBTHLNFT.approve(address(this),_tokenId);//>>>>>call method to approve
    ...
    function _transferNftToAuctionContract(
        ...
        if (isOwnerOf(_tokenId,_nftSeller)) {
            RBTHLNFT.transferFrom(
                _nftSeller,
                address(this),
                _tokenId
            );
            require(
                isOwnerOf(_tokenId,address(this)),
                "nft transfer failed"
            );
        } else {
            require(
...
function BuyNonMintedArtEther(
    ...
    //    someAddress.call{value: 1 ether}('');
        ...
        RBTHLNFT.transferFrom(salefound.owner,_buyerAddress, salefound.tokenId);
    ...
    function BuyNonMintedArtFiat(
        ...
        RBTHLNFT.transferFrom(salefound.owner,_buyerAddress, salefound.tokenId);  //transfer the NFT
