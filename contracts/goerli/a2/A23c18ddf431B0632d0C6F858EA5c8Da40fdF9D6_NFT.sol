...
contract NFT is ERC721, Ownable {
  ...
  function mintBatch(uint256 fromTokenId, uint256 toTokenId, address from, address toAddress) public payable {
    emit ConsecutiveTransfer(fromTokenId, toTokenId, from, toAddress);
  }
