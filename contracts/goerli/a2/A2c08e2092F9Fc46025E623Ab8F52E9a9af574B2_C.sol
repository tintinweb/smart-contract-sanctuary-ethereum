...
contract C {
    ...
    function _mintToken(NewTokenData calldata _newTokenData) public returns (bool) {        
        uint256 newTokenId;
        unchecked {
    ...
    function _setTokenURI(uint256 tokenId, NewTokenData calldata _newTokenData) public {
