...
contract v1 is ERC721A, Ownable {
    uint256 MAX_MINTS = 20;
    uint256 MAX_SUPPLY = 11070;
    uint256 public mintRate = 0.00365 ether;
  ...
  uint256 private royaltyBasisPoints = 100; // 10%
    ...
    event Mintedus(uint256 indexed _quantity);

    string public baseURI ="";

    constructor() ERC721A("v1", "v1") {}
