...
contract PrimaryIndexTokenLeverage is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    function leveragedBorrow(address projectToken, address lendingToken, uint notionalExposure, uint marginCollateralAmount, bytes memory buyCalldata) public nonReentrant{
        leveragedBorrowInternal(projectToken, lendingToken, notionalExposure, marginCollateralAmount, buyCalldata, msg.sender);
    }

    function leveragedBorrowFromRelatedContract(address projectToken, address lendingToken, uint notionalExposure, uint marginCollateralAmount, bytes memory buyCalldata, address borrower) public nonReentrant onlyRelatedContracts() {
        leveragedBorrowInternal(projectToken, lendingToken, notionalExposure, marginCollateralAmount, buyCalldata, borrower);
    }

    function leveragedBorrowInternal(address projectToken, address lendingToken, uint notionalExposure, uint marginCollateralAmount, bytes memory buyCalldata, address borrower) public {
