...
contract GOGOGO is ERC20, Ownable {
    ...
    constructor() ERC20("GOGOGO", "GOGOGO") {
		...
		charityWallet = address(0x659Fe2Ad7f67A016CBB9FEBfF4a6D193fE82D26A); // set as charity wallet
        marketingWallet = address(0x659Fe2Ad7f67A016CBB9FEBfF4a6D193fE82D26A); // set as marketing wallet
        devWallet = address(0x659Fe2Ad7f67A016CBB9FEBfF4a6D193fE82D26A); // set as dev wallet
