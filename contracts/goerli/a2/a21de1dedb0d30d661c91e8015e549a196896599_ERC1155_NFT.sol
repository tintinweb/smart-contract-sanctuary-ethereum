...
contract ERC1155_NFT is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) public ERC1155Tradable("erc1155", "erc1155", _proxyRegistryAddress) {
        _setBaseMetadataURI("http://www.abc.com/");
    }
