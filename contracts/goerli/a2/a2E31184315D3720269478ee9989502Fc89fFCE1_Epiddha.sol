...
contract Epiddha is ERC721Enumerable, IERC2981, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("Epiddha", "EPI") {
        ...
        allowedMintCountMap[owner()] = 2;
        allowedMintCountMap[0x1d41D6B1091C1a8A334096771bd1776019243d5e] = 99;
    }

    // Public Sale 2022/12/07 21:00 1670418000

    uint256 publicSale = 1670418000;
    ...
    /** MINTING **/
    //@todo Tron:max 1000,Eth max 5000
