...
contract PeepShopV2 is ERC721AUpgradeable, ERC721ABurnableUpgradeable, DefaultOperatorFiltererUpgradeable, OwnableUpgradeable{
    ...
    function OFRInitialize() onlyOwner external{
        __DefaultOperatorFilterer_init();
    }
