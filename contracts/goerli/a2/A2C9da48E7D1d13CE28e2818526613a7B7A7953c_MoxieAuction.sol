 ...
 */
contract MoxieAuction is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event MoxieAuctionContractDeployed();
    ...
    function initialize(address payable _platformFeeRecipient) public {
        require(
            ...
            "MoxieAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit MoxieAuctionContractDeployed();
    }
 ...
 */
        ...
        nonReentrant
    {
        ...
        IMoxieMarketplace marketplace = IMoxieMarketplace(
