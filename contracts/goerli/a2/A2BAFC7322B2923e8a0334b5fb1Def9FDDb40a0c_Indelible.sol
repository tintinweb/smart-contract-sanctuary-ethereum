...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"NFT"];
    ...
    ContractData public contractData = ContractData(unicode"OSH Aquarius Genesis Pass", unicode"Holding this nft will give you free mints and allowlist spots for the life of the nft. The first airdrop, Open Seahorses, will be free for holders and will go live one week after the genesis collection's mint opens. Anyone who mints one of the 23 1/1s in our first drop (Open Seahorses) will also receive $100 in ethereum as a bonus! Future free mints & airdrops will be announced on our twitter account. Please turn on notifications, we're very busy fish.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/f0e6226d-0ccb-49a0-970e-7c9e595d4c6d", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/f0e6226d-0ccb-49a0-970e-7c9e595d4c6d", "", 500, "0x93683BdE0bC9dFb044Dcd07D888E225E933646A4");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"OSH Aquarius Genesis Pass", unicode"OSH") {
        tiers[0] = [2023];
        withdrawRecipients.push(WithdrawRecipient(unicode"null",unicode"null", 0x29f6967EE4086E6FE8caCc524fb0a4f9b5cc4b52, 1900));
        withdrawRecipients.push(WithdrawRecipient(unicode"null",unicode"null", 0x3c5Ca06ceF9289B7ceE3C3b23604ba4b88cF8394, 1900));
        withdrawRecipients.push(WithdrawRecipient(unicode"null",unicode"null", 0x12d14A8c91d42C57CED397dc15Da80aF9eB8b6B1, 1900));
        withdrawRecipients.push(WithdrawRecipient(unicode"null",unicode"null", 0xE9DB111C7E6b1595580434c451dB391AB76D5CbC, 1900));
        randomSeed = uint(
            keccak256(
                abi.encodePacked(
                    tx.gasprice,
