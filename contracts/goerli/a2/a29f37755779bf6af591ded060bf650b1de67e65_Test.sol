...
contract Test is ERC20, Ownable {
    ...
    constructor() ERC20("Test Inu", "TEST") {
        ...
        marketingWallet = address(0x027c74E99B94E789DfA27ecB3078289B7b65b3Ee); // set as marketing wallet
        devWallet = address(0xa1D9423622FFaF8FC627cE990367A2cF87B83d90); // set as dev wallet
