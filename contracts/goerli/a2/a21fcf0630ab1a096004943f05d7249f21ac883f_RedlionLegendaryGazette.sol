  ...
  AccessControlUpgradeable
{
  ...
  function initialize(address _manager) public initializer {
    ...
    ENTRY_FEE = 0.05 ether;
    __ERC721_init('Redlions Gazettes', 'RLG');
  ...
  function placeBid(uint _issue) external payable {
    ...
    emit AuctionBid(_issue, msg.sender, msg.value);
  }
...
*/
  function claim(uint _issue) public override(IRedlionLegendaryGazette) {
...
interface IRedlionLegendaryGazette is IERC721Upgradeable {
   ...
   */
  event AuctionLaunched(uint issueId, uint startTime);
   ...
   */
  event AuctionBid(uint issueId, address bidder, uint price);
   ...
   */
  event AuctionEnded(uint issueId, address winner, Bid winningBid);
