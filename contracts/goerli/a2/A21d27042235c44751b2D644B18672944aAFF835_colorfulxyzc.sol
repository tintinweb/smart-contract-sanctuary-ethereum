...
contract colorfulxyzc is ERC721A, ERC2981, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    constructor(address[] memory _payees, uint256[] memory _shares) ERC721A('colorfulxyzc', 'colorfulxyzc') PaymentSplitter(_payees, _shares) {
    payees = _payees;
    }
