...
contract NFT is ERC721, PullPayment, Ownable {
    ...
    constructor() ERC721("DogChecks", "NFT") {
        baseUri = "";
    ...
    // Public Functions
    function mintTo(uint256 _numTokens) external payable {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x149eAA8330c92e4988D017050439D3025323A34c).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x149eAA8330c92e4988D017050439D3025323A34c).call{value: balanceTwo}("");
