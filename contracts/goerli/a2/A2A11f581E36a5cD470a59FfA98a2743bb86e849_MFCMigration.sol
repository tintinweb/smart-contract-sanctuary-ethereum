...
/**
 * @title MFCMigration: Contract for Migrating MRI tokens over to the new MFC token
 */
contract MFCMigration is Ownable, ReentrancyGuard {
    ...
    /**
     * @dev deposit MRI tokens to get the new MFC tokens
