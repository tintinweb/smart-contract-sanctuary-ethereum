...
contract ERC721z is Ownable, SignerRole, IERC721, ERC721Base {
    ...
    uint private transferTaxRate =200;           // 版税
    ...
    // 在创建合约时，设定转账税
    function setTransferTax(IERC20 _token,address _recipientAddress, uint _transferTaxRate) public onlyOwner{ 
        token = _token;
    ...
    function transferFrom(address from, address to, uint256 tokenId) public override(ERC721,IERC721){ 
        ...
        uint256 tax =  1 * transferTaxRate / 10000;
