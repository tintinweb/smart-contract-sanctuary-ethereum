...
contract DREAM is Context, IERC20, Ownable {
    ...
    string private constant _name = "DREAM INU";//
    ...
    address payable private _developmentAddress = payable(0x157Ea8Cd331804252C2B0b72E80690847d2c2f2b);//
    address payable private _marketingAddress = payable(0x157Ea8Cd331804252C2B0b72E80690847d2c2f2b);//
