...
contract SwapAdapterV3 is SwapAdapterBase {
    /// @notice sorted LP tokens hash => fee
    ...
    function swapExactEthForTokens(
        ...
        emit SwapExactEthForTokens(msg.sender, msg.value, tokenOut, amountOut);
    }
    ...
    function swapExactTokensForEth(
        ...
        emit SwapExactTokensForEth(msg.sender, tokenIn, amountIn, amountOut);
    }
...
abstract contract SwapAdapterBase is ISwap, ModuleAccessController {
    ...
    constructor(address routerAddress, address config)
        ModuleAccessController(IProtocolConfig(config).getGAC())
    {
...
interface IUniswapV3Router is ISwapRouter {
    ...
    function unwrapWETH9(uint amountMinimum, address recipient)
        external
        payable;
...
library SwapLibV3 {
    ...
    /// @notice See more on {_swapExactEthForTokensV3}
    function swapExactEthForTokens(
        address router,
        address tokenOut,
        address recipient,
    ...
    /// @notice See more on {_swapExactTokensForEthV3}
    function swapExactTokensForEth(
        address router,
        address tokenIn,
        uint amountIn,
    ...
    /// @notice See more on {_swapExactTokensForTokensV3}
    function swapExactTokensForTokens(
        address router,
        address tokenIn,
        uint amountIn,
    ...
    /// @notice See more on {_swapExactTokensForTokensMultV3}
    function swapExactTokensForTokensMult(
        address router,
        bytes memory path,
        uint amountIn,
    ...
    function _swapExactTokensForTokensMultV3(
        ...
        address tokenFrom = path.toAddress(0);

        IERC20(tokenFrom).safeTransferFrom(msg.sender, address(this), amountIn);

        if (IERC20(tokenFrom).allowance(address(this), router) < amountIn)
