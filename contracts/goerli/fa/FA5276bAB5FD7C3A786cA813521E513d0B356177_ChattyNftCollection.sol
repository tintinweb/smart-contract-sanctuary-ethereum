...
contract ChattyNftCollection is
    ERC721,
    Ownable,
    ReentrancyGuard,
    PaymentSplitter
{
    ...
    string public notRevealedUri = "https://gateway.pinata.cloud/ipfs/QmcJjWfUd51hCPtvez1mDguDvgE3J2i8vKi4iPGJ6b7EHe/hiddin.json";
    ...
    address[] private _team = [
        0xB7E666406e46B4f00EEE607b544763e982A2c5DE, // Admin Account gets 60% of the total revenue
        0x6EbA6BE41067d47987d01C4cAEc33d6268A2fD90 // VIP Account gets 40% of the total revenue
    ];
    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("ChattyNft", "Chat")
    ...
    onlyAccounts
    {
        ...
        require(
            current + _amount <= maxSupply,"max supply exceeded"
        );
        require(
