...
contract Madiko3 is ERC721A, ERC721AQueryable, Owned, DefaultOperatorFilterer {
  ...
  string tokenBaseUri = "ipfs://QmSpJTexj4QqBuX7ShjfvT3FvE2WbM9t3sQQEHwvwNusuz/";

  bool public paused = true;

  mapping(address => uint256) private _freeMintedCount;

  constructor() ERC721A("Madiko3", "MDDKK") Owned(msg.sender) {}
