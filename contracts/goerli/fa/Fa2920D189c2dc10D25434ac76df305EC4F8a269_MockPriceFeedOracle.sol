...
contract MockPriceFeedOracle is PriceOracle {
    ...
    function getCTokenPrice(CToken _cToken) external view returns (uint256) {
        return getUnderlyingPrice(_getUnderlyingAddress(_cToken));
    }
    ...
    function clearReportedUnderlyingPrice(address _underlyingAddress) external {
        reportedPricesByUnderlyingAddress[_underlyingAddress] = 0;
    }
