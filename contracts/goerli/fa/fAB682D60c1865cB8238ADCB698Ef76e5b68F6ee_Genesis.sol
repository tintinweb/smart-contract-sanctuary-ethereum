...
contract Genesis is ERC721Enumerable, Ownable {
    ...
    // Constant values
    // Latest price from ESG is 0.1 Eth - make sure this is correct before deploying
    // TODO update this before launch
    uint256 internal constant costPerToken = 0.01 ether;

    //TODO: Update public key with official one -- make sure its check-summed
    // address internal constant publicKey = 0x376CadfE0fc72F24eCb2dF422843028948f97A60;
    address internal constant publicKey = 0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199;

    // This is ESG's Gnosis Safe Wallet
    address internal constant legendaryWallet = 0x4AAe0981Ec489eE1710C6cB1F6b203ab6e020754;

    constructor() ERC721('RPlanet', '$RPlanet') {
        ...
        //TODO: make sure production URL not test
        ...
        // TODO need official address (this is localhost)
    ...
    function withdraw() public onlyOwner {
        (bool os, ) = payable(legendaryWallet).call{value: address(this).balance}('');
