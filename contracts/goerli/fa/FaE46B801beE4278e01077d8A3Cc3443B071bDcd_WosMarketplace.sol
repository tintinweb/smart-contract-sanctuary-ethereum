...
import "../Security2/Interfaces/IUAC.sol";
...
abstract contract CollateralWrapper is CriticalTracer {
    ...
    constructor(address _collateral, IECDSASignature2 _signature, IUAC _uac) {
...
abstract contract MarketplaceBase {
    ...
    function _registerArtifact(
        ...
        artifacts[contractAddress] = Artifact(
            contractAddress,
            available,
            0
        );
