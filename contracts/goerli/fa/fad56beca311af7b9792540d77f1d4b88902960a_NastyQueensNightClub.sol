...
..  ..  ..  ..  ,@@@@@@@@@@@@@@&#*      .   .  ..  ..  ..  ..  ..  ..  ..  ..  ..  .    ,#@@@@@@@@@@@@@@@ ..  ..  ..  ..                                                                                                                    
  ...
  | $$\  $$$| $$  | $$ /$$  \ $$   | $$       | $$          | $$/$$ $$| $$  | $$| $$      | $$      | $$\  $$$ /$$  \ $$     
  | $$ \  $$| $$  | $$|  $$$$$$/   | $$       | $$          |  $$$$$$/|  $$$$$$/| $$$$$$$$| $$$$$$$$| $$ \  $$|  $$$$$$/      
  |__/  \__/|__/  |__/ \______/    |__/       |__/           \____ $$$ \______/ |________/|________/|__/  \__/ \______/       
                                                                 \__/                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
              /$$   /$$ /$$$$$$  /$$$$$$  /$$   /$$ /$$$$$$$$        /$$$$$$  /$$       /$$   /$$ /$$$$$$$ 
             | $$$ | $$|_  $$_/ /$$__  $$| $$  | $$|__  $$__/       /$$__  $$| $$      | $$  | $$| $$__  $$
             | $$$$| $$  | $$  | $$  \__/| $$  | $$   | $$         | $$  \__/| $$      | $$  | $$| $$  \ $$
             ...
             | $$\  $$$  | $$  | $$  \ $$| $$  | $$   | $$         | $$    $$| $$      | $$  | $$| $$  \ $$
             | $$ \  $$ /$$$$$$|  $$$$$$/| $$  | $$   | $$         |  $$$$$$/| $$$$$$$$|  $$$$$$/| $$$$$$$/
             |__/  \__/|______/ \______/ |__/  |__/   |__/          \______/ |________/ \______/ |_______/ 
...
contract NastyQueensNightClub is ERC721Enumerable, Ownable, Pausable {
  ...
  uint256 public PricePS = 0.08 ether;
  uint256 public MaxCollection = 10000;
  uint256 public RS = 100;

  constructor(string memory _BaseURI,string memory _NotRevealedUri)
    ERC721("Nasty Queens Night Club", "NQNC") {
    setURIBase(_BaseURI); setNotRevealedURI(_NotRevealedUri);
  }
  ...
  function mint(uint256 _Amount) public payable {
    ...
    if (msg.sender != owner()) {
        require(supply + _Amount + RS <= MaxCollection, "Public Sold Out");
        if (isPresalesMode == true) {
            require(isWW(msg.sender), "Wallet not Whitelisted");
            uint256 ownerMintedCount = WB[msg.sender];
            require(ownerMintedCount + _Amount <= 3, "PS: Max NFT per Wallet Reached");
            require(supply + _Amount <= 1500, "PS: Max NFT Minted");
            require(msg.value >= PricePS * _Amount, "PS: Balance Insufficient");
        }
        else {
            require(!isPresalesMode, "");
            uint256 ownerMintedCount = WB[msg.sender];
            require(ownerMintedCount + _Amount <= 5, "MS: Max NFT per Wallet Reached");
            require(msg.value >= Price * _Amount, "MS: Balance Insufficient"); 
        }
    }
  ...
  function setRS(uint256 _newRS) public onlyOwner {
    RS = _newRS;
  }
