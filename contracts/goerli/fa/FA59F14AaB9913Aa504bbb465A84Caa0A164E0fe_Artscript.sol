...
contract Artscript is ERC1155Upgradeable, OwnableUpgradeable {
    ...
    function initialize(IMetadataServer _metadataServer) public initializer {
        __ERC1155_init("");
        __Ownable_init();
    ...
    function setContractInfo(IMetadataServer.ContractInfo memory _contractInfo) external onlyOwner {
        metadataServer.setContractInfo(_contractInfo);
    }
...
interface IMetadataServer {
    ...
    function setContractInfo(ContractInfo memory _contractInfo) external;
