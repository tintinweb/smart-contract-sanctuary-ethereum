...
/// @title: Manifold-BlueRose-Goerli
/// @author: manifold.xyz
...
//    | |    \ |,-./  )   |   .'  | |/ ( ` )   '        | ( ' )  |   / ,-.|  \ _ \ (`' )/`--'/ ( ` )   '     //
//    | |____/ /\  '_ '`) .'  '_  | . (_ o _)  |        |(_ o _) /  ;  \  '_ /  | (_ o _).  . (_ o _)  |     //
...
contract ManBRg is ERC1155Creator {
    constructor() ERC1155Creator("Manifold-BlueRose-Goerli", "ManBRg") {}
}
