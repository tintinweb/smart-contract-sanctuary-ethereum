...
contract Particular is Initializable {
    ...
    event ToSee(uint256 price, uint256 amountOutMin, uint256 amountToSave, uint256 amountToKindly, uint[] amounts);
    ...
    */
    receive() external payable {
        ...
        (uint[] memory amounts) = uniswap.swapExactETHForTokens{value: toStable}(amountOutMin, path, address(this), block.timestamp + 5 minutes);
        
        emit ToSee(price, amountOutMin, amountToSave, amountToKindly, amounts);
