...
contract Chronicles is ERC721A, ERC721AQueryable, Ownable {
    ...
    */
    ...
    struct ClbBurnPreference {
        uint16 department;        // This is set for yellow (legendary) and purple (uncommon) CLBs.  See above comment for ID mapping.
     ...
     * GIVEAWAY
     */ 
    uint256 public numReservedForGiveAways = 100;
