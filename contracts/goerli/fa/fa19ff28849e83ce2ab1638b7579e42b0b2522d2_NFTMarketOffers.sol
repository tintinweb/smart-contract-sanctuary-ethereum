...
abstract contract MarketTools is Ownable, Pausable {
  ...
  function getNFTOwnerAmount(
    ...
    function erc1155SafeTransferFrom(
        ...
        require(
            from == msg.sender || IERC1155(nftContract).isApprovedForAll(from, msg.sender),
            "ERC1155: test response if not owner"
        );
        IERC1155(nftContract).safeTransferFrom(from, to, id, amount, data);
    }
