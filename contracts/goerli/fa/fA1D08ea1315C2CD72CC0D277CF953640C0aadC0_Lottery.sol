...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /* State Variables */
    // Lottery Variables
    uint256 public lotteryBaseUSDCValue; // total current USDC deposit withOut interests
    ...
    function performUpkeep(bytes memory performData) external override {
        ...
        if (keccak256(performData) == keccak256(hex"02")) {
            // set Winner GAINS
            lotteryBaseUSDCValue = s_totalNumTickets * i_lotteryTicketPrice; // total current USDC deposit withOut interests
