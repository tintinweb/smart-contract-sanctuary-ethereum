...
contract Composable is Ownable, ERC721URIStorage, ReentrancyGuard{
    ...
    */
    ...
    Artist methods:
        ...
        -criar a Sample 
    */
    function generateNFTArtist(address to, uint256 value, string calldata nameSample, string memory tokenURI_) public payable virtual{
...
*/
        ...
        returns (uint256)
    {
        ...
        //Add sample to record of musics
        nfts[newSampleId]=sample; 
