...
contract WCAA is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    enum MintState {
        ALLOW,
        PUBLIC,
        FREE,
    ...
    // TODO: Change to real price before release
    uint256 public mintPrice = 0.0001 ether;
    MintState public mintState = MintState.PUBLIC;
    ...
    constructor() ERC721A("Wild Cat Ad Agency", "WCAA") {
        // Avoid empty constructor warning
        mintState = MintState.DISABLED;
    }
    ...
    function freeMint(bytes32[] calldata proof) public nonReentrant {
        ...
        require(
            freeMintedList[msg.sender] == false,
            "Can't mint more than 1 token"
        );
    ...
    function withdrawFunds(address receiver) public onlyOwner {
