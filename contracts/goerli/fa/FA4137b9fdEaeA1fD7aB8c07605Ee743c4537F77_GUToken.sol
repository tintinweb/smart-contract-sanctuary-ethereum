...
contract GUToken is ERC20 {
    ...
    constructor() ERC20("Rigel Coin", "RC") {
        _mint(msg.sender, 1800000000 * 10**9); //mint tokens for private, closed, public
        _mint(RESERVED_TOKEN_ADDRESS, 1000000000 * 10**9); //here mint tokens for reserve
        _mint(TEAM_TOKEN_ADDRESS, 2500000000 * 10**9); //here mint tokens for team
