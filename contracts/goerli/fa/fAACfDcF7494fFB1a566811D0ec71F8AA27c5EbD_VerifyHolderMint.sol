...
contract VerifyHolderMint is ERC721Drop {
    ERC721Drop public immutable requiredNft;
    ...
    {
        requiredNft = ERC721Drop(_requiredNftAddress);
        _primarySaleRecipient = _primarySaleRecipient;
    ...
    {
        require(
            requiredNft.balanceOf(_claimer) >= _quantity,
            "You don't own enough Required NFTs"
        );
    }
