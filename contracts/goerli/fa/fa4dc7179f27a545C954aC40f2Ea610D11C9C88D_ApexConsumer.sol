...
contract ApexConsumer is Initializable, ProxyOwned, ProxyPausable {
    ...
    function fulfillMetaData(
        ...
        emit RequestMetaDataFulfilled(_requestId, _event_id, _bet_type, _event_name, _qualifying_start_time);
    ...
    function fulfillMatchup(
        ...
        game.startTime = _timestamp;

        _createGameFulfill(game, supportedSportId[sport]);
    ...
    function _createGameFulfill(GameCreate memory _game, uint _sportId) internal {
