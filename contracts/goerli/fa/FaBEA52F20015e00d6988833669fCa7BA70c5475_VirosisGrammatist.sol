...
/**
 * @title VirosisGrammatist
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract VirosisGrammatist is ERC20Permit, Pausable, ERC20Burnable {
    address private _owner;

    constructor() ERC20("Virosis Grammatist","IGI")  ERC20Permit("Virosis Grammatist") { 
        _owner = _msgSender();
     }
