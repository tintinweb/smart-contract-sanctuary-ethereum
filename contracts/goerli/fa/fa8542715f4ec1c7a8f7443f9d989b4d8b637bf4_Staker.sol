...
contract Staker is ERC1155Holder, ERC721Holder, ReentrancyGuard, Ownable {
    ...
    */
    ...
    function test() public onlyOwner {
        AddNFT("Cinder coin", 0x288e154aDf46d7E32aCce64a5c95308E40922609, true, 20, 0, 0, 0, 1, 0);
		pause(1, false);
        AddNFT("Cinder coin", 0x288e154aDf46d7E32aCce64a5c95308E40922609, false, 20, 36500, 0, 100, 1, 0);
		pause(2, false);
        AddNFT("Black nft 10", 0x9F9E5F00f19f3Dc51F88A02532Aa2DD62db6A213, false, 1155, 36500, 0, 100, 10, 0);
		pause(3, false);
        AddNFT("Wizard NFT", 0x73e6E8ef2F14878574D435B3c670275baabd9b88, true, 721, 0, 0, 0, 5, 0);
		pause(4, false);
        AddNFT("Wizard NFT", 0x73e6E8ef2F14878574D435B3c670275baabd9b88, false, 721, 36500, 0, 100, 5, 0);
		pause(5, false);
    }
    ...
    function AddNFT(string memory _tokenName, address _stakingToken, bool _rewardToken, uint16 _stakeType, uint16 _APY, uint16 _stakeID, uint16 _duration, uint256 _stakeValue, uint16 _rewardCost) public onlyOwner {
        ...
        if (_stakeType == 721) {
            ...
            require(_stakeType == 1, "Staking: wrong stake type");
        }
    ...
    */
    ...
    function stake(uint256 id, uint16[] memory tokenIds, uint256 count) external payable nonReentrant {
    ...
    function getReward(uint256 stakeId, uint256 rewardId, uint256 count) public payable  nonReentrant {
        require(!nfts[stakeId].rewardToken, "Staking: this token must be staked");
