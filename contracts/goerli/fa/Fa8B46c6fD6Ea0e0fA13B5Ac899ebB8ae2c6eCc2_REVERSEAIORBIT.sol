...
contract REVERSEAIORBIT is ERC721, Ownable {
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        string memory name = string(abi.encodePacked("REVERSE AIORBIT #", Strings.toString(_tokenId)));
        string memory description = "Reverse Orbits generated on-chain by AI with 6,976,080,000 possibilities.";
