...
contract ArityClaimV2_3 {
    ...
    function init() external {
        usdtST = IERC20Upgradeable(address(0x07865c6E87B9F70255377e024ace6630C1Eaa37F));
    }
    ...
    function bono() external returns(uint256) {
        ...
        require((userTokensGold + userTokensSilver) > 0, "User is not owner of tokens");
        require(bonoPayedChristmas[msg.sender] < 1, "User has been payed");

        uint256 amount = (userTokensGold + userTokensSilver)*50000000;
