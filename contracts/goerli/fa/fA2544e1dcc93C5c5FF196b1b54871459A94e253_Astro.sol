...
contract Astro is ERC721A, Ownable, ReentrancyGuard {
    uint256 public mintLimit = 1;
    uint256 public supply = 4222;
    ...
    constructor() ERC721A("Astro", "ASTR") {}
    ...
    // ---- Stage 1: White List Mint ----
    // @note only people from the white list are allawed to mint for free
        ...
        public
    {
        require(
            ...
            "Mint count exeeds free mint supply"
        );
    ...
    // ---- Stage 2: Free Mint ----
    // @note More free mints are availiable after the white list mint
    ...
    // ---- Stage 2: Free Mint ----
    // @note anyone can mint at this point
