 ...
 * @notice This contract handles minting testre tokens.
 */
contract Testre is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0xea4a55BeD9D18c6D90F66Ea91EEE20783da71ECD;
    address[] public payoutAddresses = [
        0xea4a55BeD9D18c6D90F66Ea91EEE20783da71ECD
    ];
    ...
    uint256 public publicMintsAllowedPerAddress = 1111;
    ...
    constructor(address _blocklistContractAddress) ERC721A("testre", "testre") {
