...
contract XCLUB is ERC721A, ERC2981, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public nftsPeerAddress = 50;

    bool public paused = false;
    bool public revealed = true;

    mapping(address => uint256) addressNfts;
    ...
    function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        require(addressNfts[msg.sender] + _mintAmount <= nftsPeerAddress, "Reached limit of minting");
    ...
    function setNftsPeerAddress(uint256 _nftsPeerAddress) public onlyOwner {
        nftsPeerAddress = _nftsPeerAddress;
    }
