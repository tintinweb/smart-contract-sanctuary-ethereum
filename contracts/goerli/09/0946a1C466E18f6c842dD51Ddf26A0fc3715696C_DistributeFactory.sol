...
contract DistributeFactory is Ownable, ReentrancyGuard {
    ...
    uint96 public constant SEED_GROUP = 1;
    uint96 public constant SIMPLE_ROLLING_GROUP = 2;
    uint96 public constant CUSTOM_ROLLING_GROUP = 3;
    uint96 public constant CUSTOM_GROUP = 4;
        ...
        onlyOwner
    {
        ...
        Group memory group = Group(SEED_GROUP, address(groupContract));
        ...
        onlyOwner
    {
        ...
        Group memory group = Group(SIMPLE_ROLLING_GROUP, address(groupContract));
        ...
        onlyOwner 
    {
        ...
        Group memory group = Group(CUSTOM_ROLLING_GROUP, address(groupContract));
        ...
        onlyOwner 
    {
        ...
        Group memory group = Group(CUSTOM_GROUP, address(groupContract));
