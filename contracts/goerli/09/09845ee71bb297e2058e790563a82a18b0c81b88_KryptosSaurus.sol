 ...
 function _baseURI() internal view virtual override returns (string memory) {
    ...
    function mintToken(uint256 amount, bytes32[] memory proof) external payable {
       ...
       require(preSaleIsActive || saleIsActive, "Sale must be active to mint");
        ...
        require(!preSaleIsActive || presaleTokensSold + amount <= PRESALE_LIMIT, "presale mint out !!");
        require(totalSupply() + amount <= MAX_TOKENS - (NUMBER_RESERVED_TOKENS - reservedTokensMinted), "We Are Sold Out !!");
