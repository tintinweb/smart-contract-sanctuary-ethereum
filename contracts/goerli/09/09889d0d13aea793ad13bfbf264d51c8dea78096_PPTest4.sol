...
contract PPTest4 is ERC721, ERC721URIStorage, DefaultOperatorFilterer, Ownable {
    ...
    string public baseURI = "https://images.sks-bottle.com/images/Pickles.jpg";

    constructor() ERC721("PPTest4", "PP") {
        baseURI;
        //_tokenId++;
    ...
    function safeMint(address to, uint256 _numTokens) public payable {
        ...
        require((_tokenId + _numTokens) <= _totalSupply, "Total amount of mints has been already reached.");
    ...
    function setSupply(uint _MAX_SUPPLY) external onlyOwner {
        if (_MAX_SUPPLY <= 5555 && _MAX_SUPPLY > _tokenId) {
...
*/   
    ...
    {   
        if(REVEALED){
            ...
            /*abi.encodePacked(
            baseURI,//"ipfs://QmSiTHvaSRpg41RMCPQudyExVHG8bMQqmdZu6J4HJkDaxq/",
