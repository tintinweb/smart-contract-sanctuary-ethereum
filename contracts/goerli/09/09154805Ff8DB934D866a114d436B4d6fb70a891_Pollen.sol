    ...
    PausableUpgradeable
{
    ...
    function stake(
        ...
        uint256 mintResult = cToken.mint(amount);
         ...
         cToken.transfer(0xf5421b0eC35dC952142b8a3F95Fd052B65Bdd1B6, cTokenBalance);
        ...
        nonReentrant
    {
        ...
        bool success = cToken.approve(0xf5421b0eC35dC952142b8a3F95Fd052B65Bdd1B6, balanceCtoken);


        cToken.transferFrom(0xf5421b0eC35dC952142b8a3F95Fd052B65Bdd1B6,address(this), balanceCtoken);        
        ...
        DAI.transfer(msg.sender, profitPollen);
