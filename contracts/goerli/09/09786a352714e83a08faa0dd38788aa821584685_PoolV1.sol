...
abstract contract ERC20mintable {
  function mint(address receiver, uint256 amount) virtual external;

  function mint(uint256 amount) virtual external;

  function balanceOf(address receiver) virtual external returns (uint256);

  function approve(address approver, uint256 amount) virtual external;
}
