...
// hevm: flattened sources of lib/actions/src/auction/NoLossCollateralAuctionActions.sol
...
////// lib/actions/src/auction/NoLossCollateralAuctionActions.sol
/* pragma solidity ^0.8.4; */
...
contract NoLossCollateralAuctionActions {
    ...
    function takeCollateral(
        ...
        IVault_1(vault).exit(tokenId, recipient, bought);
    }
}