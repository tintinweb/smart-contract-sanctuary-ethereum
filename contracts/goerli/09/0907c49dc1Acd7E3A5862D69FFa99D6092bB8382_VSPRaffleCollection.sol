...
contract VSPRaffleCollection is ERC1155 {
    using Strings for uint256;

    string public name = "VSP IRL Experiences Mock";
    string public symbol = "VSPIRLMOCK";
    ...
    function updateClaimEndDate(uint256 index, uint256 newEndDate) external
    {
        claimExpirationDates[index] = newEndDate;
    }

    function airdropWinners(address[] calldata owners, uint256 id) external
    {
    ...
    function setRaffleURI(uint256 tokenId, string memory baseURI) external
    {
