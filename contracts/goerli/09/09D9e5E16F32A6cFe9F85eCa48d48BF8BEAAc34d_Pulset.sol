...
contract Pulset is Context, IERC20, Ownable {
    ...
    string private _name = "TEST 5";
    string private _symbol = "TEST";
    uint8 private _decimals = 18;

    uint256 private _buyAdvestisementFee = 1;

    uint256 private _sellAdvestisementFee = 1;

    address public marketingWallet =
        0xa8Df1F3C90F8eb5e10a955bAfa704f66Fd1c85BF;

    address public stakingWallet =
        0x9a47142aacB5127Cde57b1d9940A547578C3c990;
    ...
    uint256 public _maxWalletAmount = 200000 ether;
    ...
    function _transferBothExcluded(
        ...
        if(tAdvertisement != 0) {
            uint256 half = tAdvertisement.div(2);
            uint256 otherHalf = tAdvertisement.sub(half);
            _takeAdvertisement(half);
            _takeLiquidity(otherHalf);
        }
        ...
        )
    {
        ...
        uint256 tTransferAmount = tAmount.sub(tAdvertisement);

        return (tTransferAmount, tAdvertisement);
    }
        ...
        )
    {
        ...
        uint256 rTransferAmount = rAmount.sub(rAdvertisement);
