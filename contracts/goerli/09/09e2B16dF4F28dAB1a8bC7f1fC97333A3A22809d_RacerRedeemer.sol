...
contract RacerRedeemer is AccessControlEnumerable {
    ...
    uint256 public constant MAX_BATCH_SIZE = 10000; // Need to figure out what actual number to use...
    ...
    // function getRedeemersQuantities()
    //     public
    //     view
    //     returns (address[] memory, uint256[] memory)
    // {
    //     return (getRedeemers(), getRedeemedQuantities());
    // }
    ...
    // function getRedeemedQuantities() public view returns (uint256[] memory) {
        ...
        returns (address[] memory)
    {
        ...
        uint256 maxIndex = endIndex > _redeemers.length
            ? _redeemers.length
            : endIndex;
        ...
        for (uint256 i = minIndex; i < size; i++) {
    ...
    Ownable
{
    ...
    constructor(
        ...
        // Should assign the following after contract creation
        // URI_SETTER_ROLE, MINTER_ROLE, PAUSER_ROLE, SPENDER_ROLE
    ...
    function setNewMinter(address newMinter)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        grantRole(MINTER_ROLE, newMinter);
    ...
    function setNewPauser(address newPauser)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        grantRole(PAUSER_ROLE, newPauser);
    ...
    /* PROTOCOL + RACER WALLET INTERACTIONS */
