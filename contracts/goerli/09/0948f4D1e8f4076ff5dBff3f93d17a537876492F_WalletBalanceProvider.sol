...
import {Address} from "../../../core-v3/contracts/dependencies/openzeppelin/contracts/Address.sol";
 ...
 * @author Aqualis, influenced by https://github.com/wbobeirne/eth-balance-checker/blob/master/contracts/BalanceChecker.sol
 * @notice Implements a logic of getting multiple tokens balance for one user address
 * @dev NOTE: THIS CONTRACT IS NOT USED WITHIN THE AQUALIS PROTOCOL. It's an accessory contract used to reduce the number of calls
 * towards the blockchain from the Aqualis backend.
 **/
