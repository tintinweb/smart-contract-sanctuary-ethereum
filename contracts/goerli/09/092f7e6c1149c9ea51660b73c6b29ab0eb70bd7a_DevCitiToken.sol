...
contract DevToken is BaseToken 
{
     ...
     */
    function __DevToken_init(string memory _name, string memory _symbol, address admin) 
        internal 
        onlyInitializing 
    {
...
contract Versioned {
    string public constant version = "0xc63f08bd51fd9f3a5eb08884ec5ade1e2edcd03c";
}
