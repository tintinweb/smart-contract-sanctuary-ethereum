...
// Cosmic Mutations v1.0

contract CosmicMutations is ERC721A, Ownable, CosmicMutationVoucherSigner {
    ...
    function mintMutation(CosmicMutationVoucher.Voucher calldata v) public {
        ...
        require(CosmicMutationVoucher.validateVoucher(v, getVoucherSigner()),"Invalid Voucher.");
