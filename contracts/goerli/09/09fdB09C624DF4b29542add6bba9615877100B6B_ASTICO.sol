...
/**
 * @title ASTICO
 * @dev ASTICO contract is Ownable
 **/
contract ASTICO is OwnableUpgradeable,PausableUpgradeable,ReentrancyGuardUpgradeable {
  ...
  uint256 public cap; // Cap in Ether
  uint256 public start; // Oct 17, 2022 @ 12:00 EST
  uint256 public _days; // 45 Day
 ...
 function startTokenSale(uint256 _rate, uint256 _cap, uint256 _start,uint256 _ddays) external whenNotPaused onlyOwner{
        rate = _rate;
        cap = _cap;
        start = _start;
        _days = _ddays;
  ...
  function isActive() public view returns (bool) {
    return (
        ...
        block.timestamp <= start + (_days * 1 days) && // Must be before the end date
  ...
  function calculateToken(uint amount) public view returns(uint){
    return amount/rate;
  }
  /**
   * buyTokens
