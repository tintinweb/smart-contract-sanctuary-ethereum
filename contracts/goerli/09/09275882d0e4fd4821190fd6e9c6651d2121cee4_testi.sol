...
contract testi is StandardToken {

  string public constant name = "testi1"; // solium-disable-line uppercase
  string public constant symbol = "TESTI"; // solium-disable-line uppercase
