...
contract Claiming is ERC721, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
// ================== Mint Functions Start =======================
  function Claim(uint256 _tokenID, address receiver) public nonReentrant{
    // requirements 
    require(claiming, 'Claiming hasnt started yet!');
    require(tokenIDClaimed[_tokenID] == false, 'Token ID already claimed');
    require(msg.sender == mintingContract, 'You are not the contract');
