...
contract ERC20MetaProxyFactory is MetaProxyFactory {
    ...
    function createERC20Proxy(
        ...
        address proxyAddress = _metaProxyFromBytes(
            address(new ERC20Proxy()),
            metadata
        );

        //initialize the newly deployed proxy;
        ERC20Proxy(proxyAddress).initialize(
            _name,
            _symbol,
            _initialSupply
        );
...
//600b380380600b3d393df3 <==> 363d3d373d3d3d3d60368038038091363936013d73bebebebebebebebebebebebebebebebebebebebe5af43d3d93803e603457fd5bf3
//363d3d373d3d3d3d60368038038091363936013d73bebebebebebebebebebebebebebebebebebebebe5af43d3d93803e603457fd5bf3
...
contract ERC20Proxy is ERC20Upgradeable {
    ...
    /// returns the metadata of this (ERC20 MetaProxy) contract.
...
contract MetaProxyFactory {
    ...
    function _metaProxyFromCalldata(
