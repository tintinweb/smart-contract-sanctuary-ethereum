...
contract MonkeyBusinessCreatures is ERC721Enumerable, ERC721Burnable, Ownable, AccessControl {
    ...
    uint256 private MAX_MINT = 10000;
    ...
    function mintNFT(uint256 quantity) public payable {
        ...
        require(quantity <= MAX_MINT_PER_TX, "CAN ONLY MINT 30 NFT AT A TIME");
        require(totalSupply() + quantity <= MAX_MINT, "MINT EXCEEDS MAXIMUM SUPPLY");
        require(getNFTPrice() * quantity == msg.value, "INCORRECT ETH AMOUNT SENT");
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 9900) {
            return 100000000000000000000; // 9900 - 10000 100 ETH
        } else if (currentSupply >= 7000) {
            return 3000000000000000000; // 7000 - 9899 3.0 ETH
        } else if (currentSupply >= 5000) {
            return 1700000000000000000; // 5000  - 6999 1.7 ETH
        } else if (currentSupply >= 3000) {
            return 900000000000000000; // 3000 - 4999 0.9 ETH
        } else if (currentSupply >= 7000) {
            return 500000000000000000; // 7000 - 10999 0.5 ETH
        } else if (currentSupply >= 3000) {
            return 8000000000000000000; // 3000 - 6999 0.08 ETH
        } else {
            return 5000000000000000000; // 0 - 999 0.05 ETH
        }
    }
