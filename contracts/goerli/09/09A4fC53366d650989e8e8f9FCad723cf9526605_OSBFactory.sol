...
contract OSBFactory is IOSBFactory, ContextUpgradeable {
     ...
     * @return Token address after creation.
     */
    function crossmintCreate(bool _isSingle, address _owner, uint256 _quantity, address _controller, string memory _uri, string memory _name, string memory _symbol, address _defaultReceiverRoyalty, uint96 _defaultPercentageRoyalty) external payable returns (address) {
