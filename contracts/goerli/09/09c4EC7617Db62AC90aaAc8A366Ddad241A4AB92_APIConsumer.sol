...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    event RequestVolume(bytes32 indexed requestId, uint256 balance);
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        ...
        string memory url = "https://lubi.ai/demo.json?address=123";
    ...
    function fulfill(
        ...
        emit RequestVolume(_requestId, _balance);
        balance = _balance;
    }
