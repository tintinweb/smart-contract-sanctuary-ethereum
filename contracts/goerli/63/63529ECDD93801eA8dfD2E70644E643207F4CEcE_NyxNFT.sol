...
contract NyxNFT is ERC1155Supply, Ownable
{
        ...
        uint256 teamMintPct, uint256 teamFeePct) ERC1155(metadata_url)
    {
        ...
        initWave(currentTokenId, _wavePrice, _waveMintableSupply, BASE_VOTING_POWER, teamMintPct, teamFeePct);
    }
    ...
    function initWave(uint256 wave, uint256 _wavePrice, uint256 _waveMintableSupply, uint256 votingPower,
    ...
    function startNewWave(uint256 _wavePrice, uint256 _waveMintableSupply, uint256 votingPower, uint256 teamMintPct, uint256 teamFeePct)
        private onlyApproved
    {
        ...
        currentTokenId += 1;
        initWave(currentTokenId, _wavePrice, _waveMintableSupply, votingPower, teamMintPct, teamFeePct);
        _isMinting = false;
    }

    function createNewTokenId(uint256 _wavePrice, uint256 _waveMintableSupply, uint256 votingPower, uint256 teamMintPct, uint256 teamFeePct)
        external onlyApproved
    {
        startNewWave(_wavePrice, _waveMintableSupply, votingPower, teamMintPct, teamFeePct);
    }
