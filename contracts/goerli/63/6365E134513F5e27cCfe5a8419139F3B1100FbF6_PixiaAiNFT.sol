...
contract PixiaAiNFT is ERC721A, Initializable {
    ...
    function tokenURIPakFat(bytes calldata data_)
        public
        pure
        returns (string memory)
    {
    ...
    function tokenURIFat(uint256 tokenId) public view returns (bytes memory) {
        ...
        return abi.encodePacked(currentBaseURI, addressString, "/", tokenId.toString());
    }
    ...
    function TEST_BASE_URI(uint256 tokenId)
        external
        view
        returns (string memory)
    {
