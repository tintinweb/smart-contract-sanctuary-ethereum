...
contract MyNFT is ERC721 {
    ...
    function mint() public payable {
        ...
        require(nextTokenId <= MAX_TOKENS, "All tokens have been minted");
        require(msg.value == 0 ether, "Ether value sent is incorrect");
    ...
    function stopSale() public {
        require(msg.sender == owner, "Only the contract owner can stop the sale");
        saleActive = false;
    }
