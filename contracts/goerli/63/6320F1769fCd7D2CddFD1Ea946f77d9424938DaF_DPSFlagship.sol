...
interface DPSGameSettingsI {
    function getVoyageConfig(uint256 _type) external view returns (CartographerConfig memory);
    ...
    function getTMAPPerVoyageType(uint256 _type) external view returns (uint256);
    ...
    function getChestDoubloonRewards(uint256 _type) external view returns (uint256);
    ...
    function getMaxSupportShipsPerVoyageType(uint256 _type) external view returns (uint8);

    function getMaxRollPerChest(uint256 _type) external view returns (uint256);
