 ...
 * @notice This contract handles minting Oska test Genesis Pass tokens.
 */
contract OskaTestGenesisPass is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x26171DeA349CD6E68823245a8844AA40538409d8;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xee7Ae65533f3cfb4E74839292B46D8a170A96f90;
    address[] public payoutAddresses = [
        0xee7Ae65533f3cfb4E74839292B46D8a170A96f90
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeihlundb3vthn7ph257ouapdys4ld465mpjmhcrfghi5y6csielko4/";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Oska test Genesis Pass", "OTGP")
        RevokableOperatorFilterer(
