...
//   _   _ _____ _____   ____    _                  ____        _ _                 _       _       
//  | \ | |  ___|_   _| |  _ \  / \   _ __  _ __   | __ )  ___ (_) | ___ _ __ _ __ | | __ _| |_ ___ 
//  |  \| | |_    | |   | | | |/ _ \ | '_ \| '_ \  |  _ \ / _ \| | |/ _ \ '__| '_ \| |/ _` | __/ _ \
//  | |\  |  _|   | |   | |_| / ___ \| |_) | |_) | | |_) | (_) | | |  __/ |  | |_) | | (_| | ||  __/
//  |_| \_|_|     |_|   |____/_/   \_\ .__/| .__/  |____/ \___/|_|_|\___|_|  | .__/|_|\__,_|\__\___|
//                                   |_|   |_|                               |_|                    

contract NFTDApp is ERC721, Ownable, ERC721Enumerable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant tokenPrice = 100000000000000; // 0.0001 ETH
    uint256 public constant maxTokenPurchase = 3;
    uint256 public constant MAX_TOKENS = 14;

    uint256 public constant publicMaxPerWallet = 5;
    uint256 public constant whitelistMaxPerWallet = 3;

    string public contractURI =
        "https://ipfs.io/ipfs/QmawAzar3xa4UggeKCsZhSn1TE82ZXxFC8p7e6hbYUgkNi/contract.json";
    ...
    event NDBMinted(uint256 tokenId, address owner);

    constructor() ERC721("NFT DApp Boilerplate", "NDB") {}
    ...
    function mintNDB(uint256 numberOfTokens) external payable {
    ...
    function presaleNDB(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
    {
        ...
        if (isRevealed == false) {
            return
                "ipfs://QmawAzar3xa4UggeKCsZhSn1TE82ZXxFC8p7e6hbYUgkNi/hidden.json";
        }
