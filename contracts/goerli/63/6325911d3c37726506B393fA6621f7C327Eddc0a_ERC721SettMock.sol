...
contract ERC721SettMock is L1ERC721 {
    constructor(
...
abstract contract BridgeStore is AccessControlUpgradeable {
    address private _bridge;

    event SetBridge(address indexed oldBridge, address indexed newBridge);

    // solhint-disable-next-line func-name-mixedcase
    function __BridgeStore_init() internal onlyInitializing {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }
...
abstract contract L1Lib is BridgeStore {
    ...
    function finalizeRollup(
        ...
        require(msg.sender == getBridge(), "L1Lib: not from bridge");
