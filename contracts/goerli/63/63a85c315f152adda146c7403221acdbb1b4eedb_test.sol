...
contract test is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x1aE0EA34a72D944a8C7603FfB3eC30a6669E454C);
    address payable public teamWallet = payable(0x583031D1113aD414F02576BD6afaBfb302140225);
    ...
    function updateBuyFee(uint256 _liqFee, uint256 _markFee, uint256 _teamFee, uint256 _burnFee) public onlyOwner {
        ...
        require(totalBuyFees <= 10, "tax too high");
    }
    ...
    function updateSellFee(uint256 _liqFee, uint256 _markFee, uint256 _teamFee, uint256 _burnFee) public onlyOwner {
        ...
        require(totalSellFees <= 10, "tax too high");
    }
