...
//
//        __                    _          _       ___      __  
//       / /___ __      ______ ( )_____   | |     / (_)____/ /__
//  __  / / __ `/ | /| / / __ \|// ___/   | | /| / / / ___/ //_/
// / /_/ / /_/ /| |/ |/ / / / / (__  )    | |/ |/ / / /__/ ,<   
// \____/\__,_/ |__/|__/_/ /_/ /____/     |__/|__/_/\___/_/|_|  
//                                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7132eA8F1d5E13455e50C36DC8BCb6DD02e68d64];
  address public erc20Payable = 0x7132eA8F1d5E13455e50C36DC8BCb6DD02e68d64;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifj2rivg5yliq7klkcftorf3p7dkqd5dhz22nkmze7edhj4dirmc4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/F97zlXw0xbn13AQ4SlJl/contract-metadata";
  }
...
// File: contracts/JawnsWickContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JawnsWickContract is ERC721APlus {
    constructor() ERC721APlus("Jawns Wick", "JW4"){}
}
