...
*/
contract D8aDaoGoldV2 is Initializable, ERC721AUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    */
    function withdrawBalance() external onlyOwner {
        ...
        (bool sentBalance, bytes memory dataBalance) = wallet7.call{value: balance}("");
        require(sentBalance, "Failed to send Ether to Wallet");
