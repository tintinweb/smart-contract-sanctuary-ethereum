...
//*********************************************************************//
//
// http://patorjk.com/software/taag/#p=display&f=Slant&t=AiNinjas
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihngv55cshon7ja7z4odcmzaksmbm46altkzo2yiaqizqdg6mmk4y/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/WBGavzGvVr2XAEF6jZSu/contract-metadata";
  }
...
// File: contracts/AiNinjasContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AiNinjasContract is RamppERC721A {
    constructor() RamppERC721A("AiNinjas", "AIN"){}
}
