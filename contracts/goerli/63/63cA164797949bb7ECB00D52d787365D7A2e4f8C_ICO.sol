...
contract ICO is Ownable, ICOEvents, ReentrancyGuard {
    ...
    uint32 public constant price = 50000; //in 10**5
    uint32 public constant lockInTime = 10 minutes; //270 days for tresting 9 months
    ...
    function buyTokens(
        ...
        require(_amountInUSD >= (350 * (10**(usdtInstance.decimals()))),"You can't purachase under 350USD");
