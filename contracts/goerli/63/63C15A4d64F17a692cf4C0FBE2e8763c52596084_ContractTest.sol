...
contract ContractTest is ERC721A, Ownable {
  ...
  uint256 public PricePreSale = 0.007 ether;
  uint256 public PricePublic = 0.015 ether;
  ...
  constructor() ERC721A("Contract Test", "CNAME") {sellingStep = Steps.Launch;}
