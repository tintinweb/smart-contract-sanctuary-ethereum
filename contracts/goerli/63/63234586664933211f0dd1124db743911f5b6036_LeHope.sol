...
contract LeHope is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    string private _baseTokenURI =
        "ipfs://QmegdqTqRHSpPF8ooK2Y3FqnbmbcmyKytFuTPj5sPkivZJ";
    ...
    constructor() ERC721A("LeHope", "LeHope") {}
    ...
    function setPresaleCost(uint8 _presaleCost) external onlyOwner {
        presaleCost = _presaleCost;
    }

        function setPublicCost(uint8 _publicCost) external onlyOwner {
