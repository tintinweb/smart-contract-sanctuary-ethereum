...
contract Subscription {
    ...
    function getDetails() public view returns(int256[] memory) {
        int256[] memory detailList = new int256[](7);
        detailList[0] = int256(USDc.balanceOf(address(this)));
        detailList[1] = int256(Dai.balanceOf(address(this)));
        detailList[2] = int256(USDt.balanceOf(address(this)));
        detailList[3] = int256(USDcx.balanceOf(address(this)));
        detailList[4] = int256(Daix.balanceOf(address(this)));
        detailList[5] = int256(USDtx.balanceOf(address(this)));
