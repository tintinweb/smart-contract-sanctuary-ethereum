...
contract Assets is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, IERC1155Receiver {
    ...
    function setApprovalForAll(address owner, address operator, bool approved) public onlyOwner {
        ...
        require(owner == msg.sender, "Not the correct Owner");
    ...
    function transferBatch(address from, address to, uint256[] memory ids, uint256[] memory amounts) public whenNotPaused {
    ...
    function supportsInterface(bytes4 interfaceId) public pure override(ERC1155Upgradeable, IERC165) returns(bool) {
