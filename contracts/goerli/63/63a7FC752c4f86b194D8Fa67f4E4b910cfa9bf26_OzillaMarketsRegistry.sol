...
/**
 * @title OzillaMarketsRegistry
 * @author Ozilla
 * @dev Registry that allow external services to keep track of the deployments Ozilla Markets
 */
contract OzillaMarketsRegistry is Ownable {
