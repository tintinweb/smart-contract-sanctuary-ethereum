...
contract Staker {
  ...
  modifier notCompleted() {
    if (exampleExternalContract.completed()) revert Staker__alreadyCompleted();
    _;
  }
  ...
  function stake() public payable notCompleted {
    // require(!exampleExternalContract.completed(), 'The threshold has been already complete');
  ...
  function execute() public notCompleted {
    require(block.timestamp > deadline || address(this).balance >= threshold, "The deadline isn't complete");
    if (address(this).balance >= threshold) {
  ...
  function withdraw() public notCompleted {
    require(openForWithdraw, "The contract isn't open for withdraw");
