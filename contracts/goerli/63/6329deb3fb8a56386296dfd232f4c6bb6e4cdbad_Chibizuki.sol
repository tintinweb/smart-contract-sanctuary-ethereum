...
contract Chibizuki is ERC721A, Ownable, DefaultOperatorFilterer {
  ...
  uint256 public publicWalletLimitation = 10;

  mapping(address => uint256) private _publicWalletMints;


  constructor(string memory baseURI) ERC721A("CHIBIZUKI", "CHKI") {
    setBaseURI(baseURI);
  }
