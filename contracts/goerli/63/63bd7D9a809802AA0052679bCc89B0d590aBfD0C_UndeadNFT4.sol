...
contract UndeadNFT4 is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, AccessControlUpgradeable {
  ...
  function __UndeadNFT4_init() external initializer {
    __Ownable_init();
    __ERC721_init("Undead Blocks - GameStop Collection", "UNDEADGAMESTOP");
