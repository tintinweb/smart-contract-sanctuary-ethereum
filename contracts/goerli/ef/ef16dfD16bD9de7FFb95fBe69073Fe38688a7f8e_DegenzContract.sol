...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xe60C31BCA36A59825814588eEAa9412743F1bfA3];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xe60C31BCA36A59825814588eEAa9412743F1bfA3;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmYsDiUSKkkQbQE6QMGtmcnYuNiddNgftqtnC3ynUj4V6b/";
...
// File: contracts/DegenzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DegenzContract is RamppERC721A {
    constructor() RamppERC721A("DEGENZ", "DEGENZ"){}
}
