...
/// @author Solmate (https://github.com/transmissions11/solmate/blob/main/src/mixins/ERC4626.sol)
   contract ERC4626 is ERC20 {
    ...
    function totalUnderlying() public view returns (uint256)
    {
        ...
        // the total underlying is this contract's balance of the underyling asset
        return supply;
    }

    function totalAssets() public view returns (uint256)
    {
        uint256 supply = totalSupply; //total amount of vault share tokens there are
        return supply;
    }
    ...
    function convertToShares(uint256 assets) public view returns (uint256) {
        ...
        return supply == 0 ? assets : assets.mulDivDown(supply, totalUnderlying());
    }

    function convertToAssets(uint256 shares) public view returns (uint256) {
        uint256 supply = totalSupply; // Saves an extra SLOAD if totalSupply is non-zero.

        return supply == 0 ? shares : shares.mulDivDown(totalUnderlying(), supply);
    }
    ...
    function previewMint(uint256 shares) public view returns (uint256) {
        ...
        return supply == 0 ? shares : shares.mulDivUp(totalUnderlying(), supply);
    ...
    function previewWithdraw(uint256 assets) public view returns (uint256) {
        ...
        return supply == 0 ? assets : assets.mulDivUp(supply, totalUnderlying());
