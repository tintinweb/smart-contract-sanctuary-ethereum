...
/**
 * @title MTest06A Contract
 * @notice This contract handles minting and distribution of tokens.
 */
contract MTest06A is ERC721A, Ownable, ReentrancyGuard {
    ...
    **/
     ...
     */
    function mint(bytes32[] calldata _proof) external payable isValidMerkleProof(_proof) nonReentrant onlyAccounts {
        ...
        require(addressClaimed[msg.sender] + quantity <= MAX_MINTS, "You can't mint so much tokens.");         
        addressClaimed[msg.sender] += quantity;
     ...
     */
    function setMint(bool _value) public onlyOwner {
        enableMint = _value;
    }
