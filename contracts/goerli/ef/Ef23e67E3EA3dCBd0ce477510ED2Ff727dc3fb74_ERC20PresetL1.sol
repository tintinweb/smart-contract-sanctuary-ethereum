...
import "./ERC20PresetPauserMinter.sol";
import "../ERC20Settleable.sol";

contract ERC20PresetL1 is ERC20Settleable, ERC20PresetPauserMinter {
    constructor(
        address bridgeAddress,
        string memory name,
        string memory symbol
    ) ERC20Settleable(bridgeAddress) ERC20PresetPauserMinter(name, symbol) {}
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual override(ERC20, ERC20PresetPauserMinter) {
