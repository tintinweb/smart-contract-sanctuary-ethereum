...
/**
 * @title RoyaltyFeeSetterOverride
 * @notice It is used to allow owner nft to set royalty parameters in the RoyaltyFeeRegistry.
 */
contract RoyaltyFeeSetterOverride {
    // ERC721 interfaceID
    ...
    address public immutable royaltyFeeSetter;

    /**
     * @notice Constructor
     * @param _royaltyFeeSetter address of the royalty fee registry
     */
    constructor(address _royaltyFeeSetter) {
        royaltyFeeSetter = _royaltyFeeSetter;
    }
    ...
    function _updateRoyaltyInfoForCollectionIfOwner(
        ...
        IRoyaltyFeeRegistry(royaltyFeeSetter).updateRoyaltyInfoForCollection(
            collection,
            setter,
            receiver,
            fee
