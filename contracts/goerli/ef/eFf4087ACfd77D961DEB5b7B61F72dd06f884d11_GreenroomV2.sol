...
contract GreenroomV2 is ERC1155, Ownable, EIP712 {
    ...
    constructor() ERC1155("") EIP712("GreenRoom", "1.0.0") {
        address showAddress = 0x1dD4d0D2ADB23546a33D87ec50d1Ea61d243d0eC;
        signerAddress = 0xa2bcd5Cc70E1e568Dd31C475FcB19E8c367B2202;
        showTokenAddr = showAddress;
        baseUri = "https://greenroom-api-dev.herokuapp.com/items/metadata/";
    ...
    function mint(
        ...
        require(
            ...
            "Quantity exceeds the supply."
        );
        
        __mint(_itemId, item.purchaseType, _price, _quantity);
    }
    ...
    function createItem(
        ...
        if (items[_itemId].maxSupply > 0) {
            ...
            __mint(_itemId, _purchaseType, _quantity, _price);
        }
    }
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "CREATE(uint256 maxSupply,uint256 price,uint256 purchaseType,uint256 id,address caller)"
                        ),
                        _maxSupply,
                        _price,
                        _purchaseType,
    ...
    function recoverAddress(
        ...
        return
            ECDSA.recover(
                _hash(_maxSupply, _price, _purchaseType, _id, _account),
                signature
            );
    }
