...
interface DateTimeParser {
    function parseTimestamp(uint timestamp) external view returns (DateTime memory dt);
}
...
contract NFTimeCapsule is ERC721A, Ownable, ReentrancyGuard {
    ...
    address public dateTimeParserContract;
    ...
    constructor() ERC721A("NFTimeCapsule", "NFTime") {
        ...
        // dev
        dateTimeParserContract = 0xCD9FC987b91125bD6a17b7841B5ED8B839fd3740;
    }
    ...
    function setDateTimeParserContract(address parserContract) external onlyOwner {
        dateTimeParserContract = parserContract;
    }
 }
