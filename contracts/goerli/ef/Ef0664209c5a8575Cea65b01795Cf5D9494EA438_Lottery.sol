...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    uint256 public fee; //fee for chainlink vrf
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 adjustedPrice = uint256(price) * 10**10; //price has 8 decimals, make it to 18 compatible with gui
        uint256 costToEnter = (usdEntryFee * 10**18) / adjustedPrice; //match the units
        return costToEnter;
    }
