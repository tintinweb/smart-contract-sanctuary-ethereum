...
contract Metazoku is ERC721A, Ownable {
     ...
     * and hash from params - caller address and amount. See {Metazoku - _checkMessage}
     *
     * Requirements:
    ...
    function mintPresale(uint256 amount, bytes32 message, bytes calldata signature) external payable {
        ...
        require(_checkMessage(message, address(msg.sender), amount), "Metazoku: invalid message");
        require(!_isCollectionFreeze, "Metazoku: collection is freeze");
