...
/**
 * @title Clone Factory
 * @notice Clone Factory Contract
 * @author ghadimhawej.eth
 **/
contract CloneFactory is Ownable, ReentrancyGuard {
     ...
     **/
    constructor(address payable _protocolAddress) {
        ...
        nonReentrant
    {
        ...
        require(
            received == ContractsBase_[_baseId].contractFee,
            "CloneFactory: Ether sent mismatch with contract fee"
        );
    ...
    function addBaseContract(
        ...
        ContractsBase_[contractTypeTracker_.current()]
    ...
    /**
     * @notice Change Protocol Address
     * @param _protocolAddress new address of protocol
     */
    function changeProtocolAddress(address payable _protocolAddress)
        external
        onlyOwner
    {
        protocolAddress = _protocolAddress;
    ...
    /**
     * @notice Change Contract Fee
     * @param _baseId Id of base contract to be changed
     * @param _contractFee new contract fee
     */
    function changeContractFee(uint256 _baseId, uint64 _contractFee)
        external
        onlyOwner
    {
        ContractsBase_[_baseId].contractFee = _contractFee;
    }
        ...
        )
    {
        return (
            ...
            ContractsBase_[_baseId].contractFee
        );
    }
    ...
    function _forwardFunds(uint256 received) internal {
        ...
        (bool success, ) = protocolAddress.call{value: received}("");
        require(success, "CloneFactory: Failed to forward funds");
    }
