...
contract EIP712Allowlisting is Ownable {
    ...
    // and passed into the implementation with the ERC721 / ERC721A name
    // constructor(string memory name, string memory symbol) ERC721(name, symbol) EIP712Allowlisting(name)
  ...
  SalesTimestamps
{
  ...
  ) ERC721A(name, symbol) EIP712Allowlisting(name) {}
