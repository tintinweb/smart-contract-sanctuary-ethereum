...
contract releasev1 is ERC721, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    /// @param tokenId The tokenId for which to retreive a description.
    ...
    /// @param tokenId The tokenId for which an svg is to be retreived.
