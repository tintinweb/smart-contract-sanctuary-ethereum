...
contract Phase4 is ERC721, ERC721Burnable,DefaultOperatorFilterer, ERC721Enumerable, Ownable{
    ...
    address public phase3NFTAddress;
    string private URI;
    ...
    constructor(string memory _name, string memory _symbol, address _phase2NFTAddress, address _phase3NFTAddress) ERC721(_name,_symbol) {
        phase2NFTAddress = _phase2NFTAddress;
        phase3NFTAddress = _phase3NFTAddress;
    ...
    */
    ...
    @params phase3TokenId: TokenId for phase3
    */
    function merge(uint256 phase2TokenId, uint256 phase3TokenId) public {
        require(toggle == true, "Phase4: Toggle is off");
        require(revelTime !=0, "Phase4: Set revel Timer");
        require(block.timestamp > revelTime, "Phase4: Redeem has not started yet");
        require(IERC721(phase2NFTAddress).ownerOf(phase2TokenId) == msg.sender, "Phase4: You are not the owner of this NFT");
        require(IERC721(phase3NFTAddress).ownerOf(phase3TokenId) == msg.sender, "Phase4: You are not the owner of this NFT");
        ...
        IERC721Burn(phase3NFTAddress).burn(phase3TokenId);
