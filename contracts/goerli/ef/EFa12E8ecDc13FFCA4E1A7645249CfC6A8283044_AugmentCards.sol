 ...
 * Total supply of each augmented card is 20% of the Parallel Alpha card.
 */
contract AugmentCards is Ownable, ERC1155Holder {
    ...
    /// @notice Address that will receive PRIME payment
    ...
    function _signCards(
        ...
        prime.safeTransferFrom(_from, feeReceiver, totalPrice);
