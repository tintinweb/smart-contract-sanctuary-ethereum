// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Ring", unicode"Nail", unicode"Skin", unicode"Finger tip", unicode"Background"];
        ...
        uint public publicMintPrice = 0.050 ether;
        string public baseURI = "";
        bool public isPublicMintActive;
        
        ContractData public contractData = ContractData(unicode"Middle Finger Floaty", unicode"Crypto-starter for Middle Finger Floaty Product.  Owners will have first access to pre-order physical pool floaty.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/e7e17b85-a3c8-41ff-96b0-6ff71a0d6565", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/e7e17b85-a3c8-41ff-96b0-6ff71a0d6565", "Middlefingerfloaty.com", 0, "0xA5726d993e48d5CAA1ae40fa1b76873AcBaA70cd");

        constructor() ERC721A(unicode"Middle Finger Floaty", unicode"MFFNFT") {
            TIERS[0] = [37,39,58,79,103,108,122,216,237];
TIERS[1] = [54,73,130,132,202,203,205];
TIERS[2] = [14,33,33,205,211,241,262];
TIERS[3] = [96,109,133,133,230,298];
TIERS[4] = [55,65,123,125,134,150,160,187];
        }
