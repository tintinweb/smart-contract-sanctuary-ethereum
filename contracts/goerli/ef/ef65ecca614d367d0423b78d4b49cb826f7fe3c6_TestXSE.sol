...
contract TestXSE is Ownable, Functional, ERC721, DefaultOperatorFilterer{ //contract StrippMFers is Ownable, Functional {
using Address for address;
    ...
    constructor(address _cham, address _gas, address _love) ERC721("",""){
        ...
        gasFactoryAddress = IERC20(_gas);   //GasFactory contract address.
        loveTokenAddress = IERC20(_love);   //LoveToken contract address.
    }
