...
contract Activator1 {
    ...
    constructor() {
        syntheticToken = 0x9BE6f906A337609416C0301bb51e679462736DaB;
    }
    ...
    function approval(uint256 amount) external {
        IERC20(syntheticToken).approve(address(this), amount);
    }

    function deposit(uint256 amount) external {
        IERC20(syntheticToken).transferFrom(msg.sender, address(this), amount);
        _updateAccount(
            UpdateAccount({
                user: msg.sender,
