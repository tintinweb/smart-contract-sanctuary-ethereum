...
contract Smart3 {
    ...
    event Transferred(address sender, address receiver, uint256 senderAmount, uint256 receiverAmount);
    ...
    function mint(address receiver, uint256 amount) public {
        ...
        emit Minted(receiver, balances[receiver]);
    }
    ...
    function transferFromMe(address receiver, uint256 amount) public {
        ...
        balances[receiver] = balances[receiver] + amount;
        emit Transferred(msg.sender, receiver, balances[msg.sender], balances[receiver]);
    }
    ...
    function transfer(address sender, address receiver, uint256 amount) public {
        ...
        balances[receiver] = balances[receiver] + amount;
        emit Transferred(sender, receiver, balances[sender], balances[receiver]);
    }
