...
// File: ../interfaces/IGovernedProxy_New.sol
...
// File: RoyaltiesRegistryGovernedProxy.sol
...
contract RoyaltiesRegistryGovernedProxy is NonReentrant, IGovernedContract, IGovernedProxy_New {
    ...
    modifier senderOrigin {
        ...
        require (tx.origin == msg.sender, 'RoyaltiesRegistryGovernedProxy: Only direct calls are allowed!');
        _;
    }
    ...
    function proposeUpgrade(IGovernedContract _newImplementation, uint _period)
        ...
        returns(IUpgradeProposal)
    {
        require (_newImplementation != implementation, 'RoyaltiesRegistryGovernedProxy: Already active!');
        require (_newImplementation.proxy() == address(this), 'RoyaltiesRegistryGovernedProxy: Wrong proxy!');
        ...
        noReentry
    {
        ...
        require (newImplementation != implementation, 'RoyaltiesRegistryGovernedProxy: Already active!');
        // in case it changes in the flight
        require (address(newImplementation) != address(0), 'RoyaltiesRegistryGovernedProxy: Not registered!');
