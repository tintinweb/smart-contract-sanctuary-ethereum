...
contract CreditFund {
    ...
    function setMinimumPayment(uint min) public onlyLender {
        minPayment = min;
    }
    ...
    modifier onlyLender() {
        require(lender == msg.sender, "Only the lender can call this function");
        _;
    }
}