...
/**
 * @title UngarnishedUnclouds
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract UngarnishedUnclouds is ERC20Permit, Pausable, ERC165 {
    address private _owner;

    constructor() ERC20("Ungarnished Unclouds","GLO")  ERC20Permit("Ungarnished Unclouds") { 
        _owner = _msgSender();
     }
