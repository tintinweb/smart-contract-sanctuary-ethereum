...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        ...
        req.add('get', 'https://gold-price-live.p.rapidapi.com/get_metal_prices');
        ...
        req.add("X-RapidAPI-Key", "22416cf0d0mshe810c72c5018d9dp1e1d40jsn7ae8c66dfdd9");
    	req.add("X-RapidAPI-Host", "gold-price-live.p.rapidapi.com");
