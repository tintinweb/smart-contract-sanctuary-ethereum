...
//                                                                                         //
//                                                                                         //
//     _______  ___   __   __  _______  ___      ___   _______  ___   _______  __   __     //
//    |       ||   | |  |_|  ||       ||   |    |   | |       ||   | |       ||  | |  |    //
//    |  _____||   | |       ||    _  ||   |    |   | |       ||   | |_     _||  |_|  |    //
//    | |_____ |   | |       ||   |_| ||   |    |   | |       ||   |   |   |  |       |    //
//    |_____  ||   | |       ||    ___||   |___ |   | |      _||   |   |   |  |_     _|    //
//     _____| ||   | | ||_|| ||   |    |       ||   | |     |_ |   |   |   |    |   |      //
//    |_______||___| |_|   |_||___|    |_______||___| |_______||___|   |___|    |___|      //
//                                                                                         //
//                                                                                         //
//                                                                                         //
/////////////////////////////////////////////////////////////////////////////////////////////
...
contract Simpl is ERC1155Creator {
    constructor() ERC1155Creator("Simplicity", "Simpl") {}
}
