...
interface IStructuredPortfolioFactory is IAccessControlEnumerable {
     ...
     * @param allowedLoansContracts List of contracts on which loans managed by this portfolio can be created
    ...
    function createPortfolio(
        IERC20WithDecimals underlyingToken,
        ILoans[] calldata allowedLoansContracts,
...
import {IStructuredPortfolioFactory, TrancheData, ITrancheVault, IERC20WithDecimals, IStructuredPortfolio, IProtocolConfig, PortfolioParams, ExpectedEquityRate, TrancheInitData} from "IStructuredPortfolioFactory.sol";
import {ILoans} from "ILoans.sol";
