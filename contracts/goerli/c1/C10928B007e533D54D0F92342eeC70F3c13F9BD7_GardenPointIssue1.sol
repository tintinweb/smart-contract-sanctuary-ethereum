    ...
    Ownable
{
    ...
    constructor(
        ...
        _setDefaultRoyalty(_royaltyAddress, 600);
    }
    ...
    function privateSaleMint(
        ...
        PrivateSale storage privateSale = privateSales[_kind];
        ...
        require(
            _privateSale.quantity <= _privateSale.txLimit,
            "TX_LIMIT_EXCEEDED"
        );
        require(
        ...
        require(
            privateSale.capCounter + _privateSale.quantity <= privateSale.cap,
            "CAP_PHASE_EXCEDEED"
        );
        require(
        ...
        PrivateSaleMinter[msg.sender] += _privateSale.quantity;
        privateSale.capCounter += _privateSale.quantity;
    ...
    function publicSaleMint(uint256 _quantity) external payable {
        ...
        require(
            publicSale.capCounter + _quantity <= publicSale.cap,
            "CAP_PHASE_EXCEDEED"
        );
        require(
        ...
        publicSale.capCounter += _quantity;
    ...
    function withdrawAll() external onlyOwner {
        ...
        sendValue(payable(WALLET), walletBalance);
    }
