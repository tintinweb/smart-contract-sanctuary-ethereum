...
contract EndangeredKingdom is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 2512;
  uint256 public maxMintAmountPerPublicAccount = 30;
  ...
  constructor() ERC721("Endangered Kingdom", "Endangered Kingdom") {
    
    _mintLoop(msg.sender,12);
