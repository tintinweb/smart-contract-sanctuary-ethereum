   ...
   uint256 reserveCount = 903;
    ...
    constructor(
        ...
        uint256 _maxElements) ERC721("RoyalFoolsHalloween", "RFH") {
            ...
            token = IRoyalFools(0x53538d2B8155C99DcD4e14B4f42980ab73133ed9);
    }
    ...
    function claim(uint256 yourFool) public claimIsOpen {
    ...
    function addClaimers(uint256[] calldata tokens) public onlyOwner {
