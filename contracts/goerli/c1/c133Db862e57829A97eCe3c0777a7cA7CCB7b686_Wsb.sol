...
contract Wsb is ERC1155, ERC1155Supply, Ownable {
    uint256 public WSB_SUPPLY = 50;

    uint256 public constant WSB = 0;

    uint256 public WSB_PRICE = 0.001 ether;
    ...
    constructor(string memory _name, string memory _symbol) ERC1155("https://api.w3bmint.xyz/api/tokens/636d2273f92342a07ab3cfb7") {
        name = _name;
        symbol = _symbol;
