...
contract TESTDARKPHOBIA is Context, IERC20, Ownable {
    ...
    string private constant _name = "TESTDARKPHOBIA";
    string private constant _symbol = "TESTPHOBIA";
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tReflect, uint256 tTeam) = _getTValues(tAmount, _reflectionFee, _marketingFee);
