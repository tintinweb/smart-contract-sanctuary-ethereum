...
contract Reddio721MintFor is Reddio721General {
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI_) Reddio721General(name_, symbol_, operatorAddress, false, baseURI_) {
    }
    ...
    function mintFor(address to, uint256 amount, bytes calldata mintingBlob) 
        public
        onlyOperator
        returns (uint256)
    {
