...
contract BrazueraBrasao is DefaultOperatorFilterer, ERC1155, Ownable {
    ...
    function approve(address operator, uint256 tokenId) public view virtual onlyAllowedOperatorApproval(operator) {
