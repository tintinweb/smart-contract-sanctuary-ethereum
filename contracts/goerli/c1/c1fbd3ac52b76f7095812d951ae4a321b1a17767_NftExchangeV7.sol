...
// File: contracts\NftExchangeV7.sol
...
contract NftExchangeV7 is Initializable, ERC1155SupplyUpgradeable, EIP712Upgradeable {
    address owner;
    ...
    function _redeemVoucherForNftFixedPrice(
        ...
        if (
            ...
            if (params.tokenContractType == NftContractType.ERC1155) {
                require(
                    ERC165(params.tokenContractAddress).supportsInterface(IERC1155_INTERFACE_ID),
                    EXTERNAL_CONTRACT_DOES_NOT_SUPPORT_1155_INTERFACE
                );
            } else if (params.tokenContractType == NftContractType.ERC721) {
                require(
                    ERC165(params.tokenContractAddress).supportsInterface(IERC721_INTERFACE_ID),
        ...
        if (nftContractLocation == NftContractLocation.INTERNAL) {
            ...
            if (nftContractType == NftContractType.ERC721) {
                require(
                    ERC721(params.tokenContractAddress).ownerOf(params.tokenId) == params.seller,
                    SELLER_TOKEN_SUPPLY_INSUFFICIENT
                );
                require(
                    ERC721(params.tokenContractAddress).isApprovedForAll(
                        params.seller,
                        address(this)
                    ),
                ...
                ERC721(params.tokenContractAddress).safeTransferFrom(
                    params.seller,
                    params.buyer,
                    params.tokenId
                );
                ...
                require(
                    ERC1155(params.tokenContractAddress).balanceOf(params.seller, params.tokenId) >=
                        params.quantityToPurchase,
                    SELLER_TOKEN_SUPPLY_INSUFFICIENT
                );
                require(
                    ERC1155(params.tokenContractAddress).isApprovedForAll(
                        params.seller,
                        address(this)
                    ),
                    EXTERNAL_CONTRACT_APPROVAL_MISSING
                ...
                ERC1155(params.tokenContractAddress).safeTransferFrom(
                    params.seller,
                    params.buyer,
                    params.tokenId,
                    params.quantityToPurchase,
    ...
    function _acceptOfferForSale(
        ...
        if (
            ...
            if (params.buyVoucherTokenContractType == NftContractType.ERC1155) {
                require(
                    ERC165(params.buyVoucherTokenContractAddress).supportsInterface(
        ...
        if (nftContractLocation == NftContractLocation.INTERNAL) {
            ...
            if (nftContractType == NftContractType.ERC721) {
                require(
                    ERC721(params.buyVoucherTokenContractAddress).ownerOf(
                        params.buyVoucherTokenId
                    ) == params.seller,
                    SELLER_TOKEN_SUPPLY_INSUFFICIENT
                );
                require(
                    ERC721(params.buyVoucherTokenContractAddress).isApprovedForAll(
                        params.seller,
                        address(this)
                    ),
                    EXTERNAL_CONTRACT_APPROVAL_MISSING
                ...
                ERC721(params.buyVoucherTokenContractAddress).safeTransferFrom(
                    params.seller,
                    params.buyer,
                    params.buyVoucherTokenId
                );
                ...
                require(
                    ERC1155(params.buyVoucherTokenContractAddress).balanceOf(
                        params.seller,
                        params.buyVoucherTokenId
                    ) >= params.buyVoucherQuantityToPurchase,
                    SELLER_TOKEN_SUPPLY_INSUFFICIENT
                ...
                require(
                    ERC1155(params.buyVoucherTokenContractAddress).isApprovedForAll(
                        params.seller,
                        address(this)
                    ),
                    EXTERNAL_CONTRACT_APPROVAL_MISSING
                ...
                ERC1155(params.buyVoucherTokenContractAddress).safeTransferFrom(
                    params.seller,
                    params.buyer,
                    params.buyVoucherTokenId,
                    params.buyVoucherQuantityToPurchase,
