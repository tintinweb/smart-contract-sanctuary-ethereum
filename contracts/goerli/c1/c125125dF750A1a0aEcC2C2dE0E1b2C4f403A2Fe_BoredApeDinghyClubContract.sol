...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x736bdB5eD6159d0Bed90fbE3D27B7CB1150dB5E1];
  address public erc20Payable = 0x736bdB5eD6159d0Bed90fbE3D27B7CB1150dB5E1;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 5) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmajM2EgiTCRjB5Gue8889U1yLW1uSBGgtWvpQJvEGQcbs/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/VP69dEqvE3ZBjw4BU0DV/contract-metadata";
  }
...
// File: contracts/BoredApeDinghyClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BoredApeDinghyClubContract is ERC721APlus {
    constructor() ERC721APlus("Bored Ape Dinghy Club", "B8DC"){}
}
  /*******************************************************/
  /*                                                     */
