...
contract TestSimple is ERC1155Burnable, Ownable, IERC2981 {
    ...
    string private _baseTokenURI = "https://metadata.tokenfy-dev.aegas.it/1/metadata/";
	string private _contractURI = "https://tokenfy-dev-public-bucket.s3.us-east-2.amazonaws.com/1/contract-uri";

    uint256 public royaltyBps = 1500;
