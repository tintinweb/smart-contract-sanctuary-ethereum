...
contract OwnerId is ERC721A, AccessControl {
    ...
    /**
     * @notice MINT ROLE WAS COMMENTED FOR TESTING PURPOSES
     ...
     */
    function mint(string memory _ownerName) public canMint(_ownerName)
//    onlyRole(MINT_ROLE)
    {
     ...
     */
    function updateProfileData(uint256 _ownerId, string memory _newCid) public {
