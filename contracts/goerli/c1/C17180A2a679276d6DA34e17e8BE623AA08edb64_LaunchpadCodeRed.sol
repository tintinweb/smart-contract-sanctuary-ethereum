 ...
 * @notice This contract handles minting Code Red tokens.
 */
contract LaunchpadCodeRed is
    ReentrancyGuard,
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x392F822Fb082Bba8d00b109FA061E7a0e1457Ee8;
    ...
    uint256 public presaleEndTime = 1979769741;
    ...
    uint256 public presaleStartTime = 1664409600;
    ...
    uint256 public publicSaleEndTime = 1979769741;
    uint256 public publicSaleStartTime = 1664409601;
    ...
    uint256[] public payoutPercentages = [30, 40, 30];
    uint96 public royaltyFee = 500;

    constructor() ERC721A("Code Red", "CG") {
