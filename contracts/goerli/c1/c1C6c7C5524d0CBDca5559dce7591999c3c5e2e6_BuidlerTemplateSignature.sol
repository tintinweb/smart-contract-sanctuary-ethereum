...
contract BuidlerTemplateSignature is Context, Ownable, ReentrancyGuard, ERC2981, ERC721A, DefaultOperatorFilterer {
    ...
    */
    ...
    uint256 public immutable supplyCap = 20;

    uint256 public immutable batchMintCap = 5;

    /** @notice Capped max supply for free claim */
    uint256 public immutable freeClaimCap = 6;
    ...
    uint256 public dtStartHolders = 1677089700; /*15:15*/
    uint256 public dtCloseHolders = 1677090600; /*15:30*/
    uint256 public dtCloseWhiteList = 1677094200; /*16:15*/
    uint256 public dtClosePublic = 1677153600; /*tom. 09:00*/
    ...
    constructor() ERC721A("TESTE ALFREDO 1", "ALFT") {
