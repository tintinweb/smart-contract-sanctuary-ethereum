...
contract NFT is ERC721, Ownable {
    ...
    //UPDATE THE BASEURI FOR METADATA
    function setIsJson(bool _isJson) public onlySeapadOrOwner {
        isJson = _isJson;
    }
...
interface Parent {
    ...
    function getPackBaseURL() external view returns (string memory);
}
...
contract Pack is ERC721, Ownable {
    ...
    string public baseURL = "https://nfts.seapad.io/metadata/";
    ...
    receive() external payable {
        //calculate seapadRoyaltyPercentage% to seapad and rest to owner in solidity
    ...
    constructor(
        ...
        networkid = _networkid;
        baseURL = Parent(_seapadAddress).getPackBaseURL();
    }

    function updateBaseURL(string memory newBaseURL) public onlySeapad {
        baseURL = newBaseURL;
    }
