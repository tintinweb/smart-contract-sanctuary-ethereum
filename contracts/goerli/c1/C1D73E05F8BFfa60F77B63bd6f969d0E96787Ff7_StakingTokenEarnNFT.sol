...
contract StakingTokenEarnNFT is Pausable, Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => packageInfo) public packageInfoList;
    ...
    function stake(string memory _idTurn, uint8 _ndays, uint256 _tokenId, uint8 _quality, uint8 _type) public
    {
    ...
    function checkNftInfo(uint256 _tokenId, uint8 _quality, uint8 _type) internal view returns(bool _result)
    {
        uint8 quality;
        uint8 types;
