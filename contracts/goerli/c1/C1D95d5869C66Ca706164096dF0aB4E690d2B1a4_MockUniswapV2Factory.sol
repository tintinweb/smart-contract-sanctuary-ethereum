...
import { UniswapV2FactoryCustomFee } from "../uniswap/UniswapV2FactoryCustomFee.sol";

contract MockUniswapV2Factory is UniswapV2FactoryCustomFee {
	constructor(address _feeToSetter) public UniswapV2FactoryCustomFee(_feeToSetter) {
    }
}
