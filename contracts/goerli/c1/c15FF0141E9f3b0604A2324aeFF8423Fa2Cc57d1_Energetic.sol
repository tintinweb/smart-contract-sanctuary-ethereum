...
contract Energetic is ERC721, Ownable, ReentrancyGuard {
    ...
    function generateEnergy() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    SVG_RECT_OPENER,
                    '<animate attributeName="rx" values="10;250;10" dur="',
    ...
    function firstStop() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
    ...
    function secondStop() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
    ...
    function thirdStop() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
