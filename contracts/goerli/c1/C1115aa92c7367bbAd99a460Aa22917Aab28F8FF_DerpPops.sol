...
contract DerpPops is Ownable, ERC721A, ReentrancyGuard {

    string public baseURI;

    uint256 public teamDerpPops = 50;
    ...
    uint256 public maxDPSupply = 100;
    ...
    ERC721A("Derp Pop", "DERPPOP", 50, 100)  {
    }
    ...
    function mintPublic(
        ...
        require(totalSupply() + maxPublicMint <= maxDPSupply, "EXCEEDS_MAX_SUPPLY" );
    ...
    /**
     * Mint Derps for the Team
     */
    function mintDPForTeam(uint256 numberOfTokens) external onlyOwner {
        require(teamDerpPops > 0, "NFTS_FOR_THE_TEAM_HAS_BEEN_MINTED");
        require(numberOfTokens <= teamDerpPops, "EXCEEDS_MAX_MINT_FOR_TEAM");

        teamDerpPops -= numberOfTokens;
        _safeMint(msg.sender, numberOfTokens);
    }

    /**
     * Returns Derp Pops of the Caller
     */
