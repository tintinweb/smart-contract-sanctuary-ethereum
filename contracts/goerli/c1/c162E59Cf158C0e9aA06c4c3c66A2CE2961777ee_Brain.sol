...
contract Brain is ERC20, Ownable {
    ...
    constructor() ERC20("Black Rabbit AI", "BRAIN") {
        uint256 _totalSupply = 10_000_000 * 1e18;
        maxTxAmount = (_totalSupply * 2) / 100; //2%
        maxWallet = (_totalSupply * 2) / 100; //2%
        swapBackAtAmount = 5000 * 1e18;
        liquidityWallet = payable(address(0xc78e91B086Eaf2A4891055ebc16C7D5AC2C0bdb7));
        devWallet = payable(address(0xa218200D783CBA081A22B145A9905333451FE967));
