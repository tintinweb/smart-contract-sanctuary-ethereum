...
contract AdvancedCollection is CollectionStorage {
    ...
    /// @param _centPremintAmount The amount of tokens to mint at deployment, shuld be 10% of totalsupply.
        ...
        ERC721A(_name, _symbol)
    {
        ...
        _mintERC2309(_CentaurifyPrimintedNFTs, _centPremintAmount);
    }
...
abstract contract CollectionStorage is AccessControl, Ownable, ERC721A, ERC721AQueryable, ERC2981 {
    ...
    address internal _CentaurifyPrimintedNFTs = payable(0x7e5c63372C8C382Fc3fFC1700F54B5acE3b93c93);
...
/* ------------------------------------------------------------  ADMIN FUNCTIONS  ----------------------------------------------------------- */
    ...
    function setStatus(uint256 _status) external onlyRole(OPERATOR_ROLE) {
        ...
        endTimestamp = block.timestamp + 1 minutes;
        emit StatusChange(status, startTimestamp, endTimestamp);
    }
}
