...
contract PepeDrive is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {

    string public PEPEDRIVE = "";
    string private baseURI;
    uint256 public constant MAX_TOKENS = 3333  + 2; // 3333 max tokens +2 is for gas optimization
    uint256 public mintingTokenIndex = 101;
    uint256 public numTokensMinted = 0;
    uint256 public numTokensBurned = 0;
    uint256 public tokenPrice = 0.0333 ether; 
    ...
    constructor() ERC721("PepeDrive", "SD") {}
    ...
    */
    ...
    function setPepeHash(string memory pepeHash) external onlyOwner {
        PEPEDRIVE = pepeHash;
    }
