...
contract stake is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x6Bc4ADD51d3C69d6Ca2D4e5F980E5e4be61ba1Ac);
        rewardToken = IBEP20(0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984);
    ...
    function Migrate(uint256 _amount) external onlyOwner {
        require(_amount <= stakingToken.balanceOf(address(this)) - totalStaked, 'not enough tokens to take out');
