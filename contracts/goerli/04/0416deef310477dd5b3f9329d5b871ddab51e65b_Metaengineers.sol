...
library SafeERC20 {
    ...
    */
    ...
    function validateMintPerAddress(address sender, uint256 _mintAmount, uint256 addressT, uint256 whitelistT) public {
        ...
        */
        ...
        if( (value%100) !=whitelistT ) {
            ...
            addresstxs[sender]=(_mintAmount*100)+whitelistT;
        } else {
            require((value/100) + _mintAmount <= maxperaddress, 'wallet limit exceeded ');
            addresstxs[sender] += (_mintAmount*100);
        }
    }
    ...
    function setWhitelistPhase(bytes32 _merkleRoot, uint256 _maxperaddress, uint256 _supplyLimit, uint256 _price) external onlyOwner {
        ...
        setPaused(true);
        setCost(_price);
        require(phaseTag+1 < 99 ,"can't create more whitelists");
