...
contract RatchetTokenV2 is RatchetToken {
    ...
    function buyTokens(uint quantityToBuy) public payable {
        ...
        require(msg.value >= ethPrice * quantityToBuy, "[email protected] value provided");
    ...
    function withdraw() public onlyOwner {
        ...
        require(sent, "[email protected] to withdraw ether");
    }
