...
abstract contract BaseContract is Initializable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    /**
     * Setup.
     * @dev This method can be called at antime in order to set up important
     * contract parameters. This method should never be destructive if called
     * more than once! This allows us to not use any setters, therefore
     * requiring a contract upgrade in order to change parameters.
     */
