...
contract Curve is Ownable, I_Curve {
     ...
     * @return collateralRequired uint256 The cost to buy the _amount of tokens
     *         in the collateral currency (see collateral token).
     */
     ...
     *         How much collateral is needed to collateralized the bonding curve.
     */
