...
contract ScholarResearchObjectQA is ERC721URIStorage, Ownable {
    ...
    string private _baseURIStr = "ipfs://";

    constructor() ERC721("Scholar Research Object QA", "SCHOLARQA") {
    }
    ...
    function updateTokenURI(uint256 tokenId, string memory tokenURI) onlyOwner public {
