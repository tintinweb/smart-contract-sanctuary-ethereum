...
contract PIGGYFACTORY is Ownable, ContractMetadata  {
    ...
    string public name = "PIGGYFACTORY-TEST-1";
    ...
    function makePiggy(
        ...
        PIGGY piglet = new PIGGY(contract_name, contract_description, contract_image, external_url, msg.sender, amount, piggy_name, unlockTime, targetBalance);
