...
contract Staker {
  ...
  function stake() public payable {
    require(block.timestamp < deadline, "Cannot staker anymore");
  ...
  function execute() external notCompleted notCompleted {
    require(hasExcecuted == false, "Already executed");
