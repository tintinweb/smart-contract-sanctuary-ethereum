...
contract TGC is Context, IERC20, Ownable {
	...
	IStaking public stakingContract = IStaking(0xC9Ba750FB4aB1A7e2b197e17aD76Bc1BE7265e31);
	...
	uint256 public maxBuyPerWallet = 2000000000 * (10**18);
    ...
    constructor () {
		...
		_isExcludedFromMaxBuyPerWallet[uniswapV2Pair] = true;
