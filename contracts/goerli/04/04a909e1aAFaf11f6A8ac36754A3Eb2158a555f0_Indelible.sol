...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    bytes32 private constant TIER_2_MERKLE_ROOT = 0x408c6c9bacf9733b358c525a2327e810e9966deb111819a9141f7c72fcaf5639;
    ...
    bytes32 private merkleRoot = 0x408c6c9bacf9733b358c525a2327e810e9966deb111819a9141f7c72fcaf5639;
    string private networkId = "5";
    string private placeholderImage = "https://files-staging.indelible.xyz/placeholder/a70bb9b4-2714-4913-a96e-8a0ef81d75d1";
    ...
    ContractData public contractData = ContractData(unicode"Golly Ghosts", unicode"bOoOoOoOoOoOoOo", "https://files-staging.indelible.xyz/profile/a70bb9b4-2714-4913-a96e-8a0ef81d75d1", "https://files-staging.indelible.xyz/banner/a70bb9b4-2714-4913-a96e-8a0ef81d75d1", "", 0, "0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Golly Ghosts", unicode"BOO") {
        tiers[0] = [96,73,64,52,46,34,32,32,25,21,21,4];
        tiers[1] = [131,84,81,71,58,45,30];
        tiers[2] = [184,137,125,54];
        tiers[3] = [114,113,71,57,52,41,28,24];
        tiers[4] = [121,99,75,68,56,30,27,24];
        tiers[5] = [137,115,110,65,31,28,14];
