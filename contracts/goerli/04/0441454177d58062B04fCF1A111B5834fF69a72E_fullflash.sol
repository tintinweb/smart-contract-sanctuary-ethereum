...
contract fullflash {
    ...
    function getWeth() public payable onlyOwner {
        IWETH(weth_token).deposit();
    }

    function transferWethtocontract(uint256 valu) public {
        IWETH(weth_token).transferFrom(msg.sender, address(this), valu);
    }
    ...
    function REALperformWithdrawWeth() public view onlyOwner returns (IWETH) {
        return WETH;
    }
