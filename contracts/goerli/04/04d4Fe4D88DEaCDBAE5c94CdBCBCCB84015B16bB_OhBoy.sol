...
contract OhBoy is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    function safeMint(address to) public payable {
        require(totalSupply() < MAX_SUPPLY, "Cant mint anymore NFT");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/bafkreicooo546fjzntqe5xbfclaghnym6my5peoxlgx32upppa6fuyzhnu/";
    }
