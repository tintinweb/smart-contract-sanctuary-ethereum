...
contract FNT is GSNContext, IERC20, Pausable {
     ...
     * @param _wallet is the address being quieried.
     */
     ...
     * @param _from is the wallet which tokens should be taken from.
     ...
     * @param _spender is the wallet which is taking/spending tokens.
     ...
     */
    function mint(uint256 _amount) public whenPaused() onlyOwner() {
