...
contract Emitter is Initializable,AccessControl {
    ...
    function createDao(address _ownerAddress,address _proxy,string memory _name, string memory _symbol, uint256 _totalDeposit,uint256 _minDeposit, uint256 _maxDeposit, uint256 _ownerFee, uint256 _totalDays,bool _feeUSDC,uint256 _quorum,uint256 _threshold,address _emitter, address _usdc) public onlyOwner{
        ...
        emit NewUser(_proxy, tx.origin, _usdc, 0, block.timestamp,0);
    }
