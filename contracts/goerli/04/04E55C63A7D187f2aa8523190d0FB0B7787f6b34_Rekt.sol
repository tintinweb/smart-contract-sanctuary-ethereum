...
/**
 * Features:
 *  1. Limited limit, set on deployment, cannot be changed
 *  2. Toggle sale on and off
 *  3. Set base uri on deployment, cannot be changed
 *  4. Change limit per wallet (mostly testing purposes/ can be removed)
 *  5. Custom errors
 */
...
contract Rekt is ERC1155 {
    ...
    constructor(uint256 _limit, string memory _uri) ERC1155(_uri) {
        owner = msg.sender;
        limit = _limit;
        minted = 0;
        limitPerWallet = 1;
