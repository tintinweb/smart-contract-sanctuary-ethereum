...
contract NFTMarketplace {
  ...
  function fillOffer(string memory _collectionName, uint256 _offerId) public payable {
    ...
    userFunds[_collectionName][_offer.user] += msg.value*8/100;
    // Marketing fee 2%
    payable(0xaaaffAb7763fB811f3d4C692BdA070A8474BcE93).transfer(msg.value*2/100);
    payable(_offer.user).transfer(msg.value*8/100);
