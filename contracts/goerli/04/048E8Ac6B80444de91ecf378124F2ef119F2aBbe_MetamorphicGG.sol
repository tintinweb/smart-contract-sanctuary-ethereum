    ...
    ReentrancyGuard
{
    ...
    bytes32 public root =
        0x275f4612b10aae9faf2dad922daedb6b6fcf28488665f0f492a28b7fbbe89d34;
    ...
    IERC721 public songContract =
        IERC721(0x574C0ceDe30CE68B9121bA2F1b80ECb341e05a38);
    ...
    //admin mint reserved for0x574C0ceDe30CE68B9121bA2F1b80ECb341e05a38
    ...
    function claimAlbum(
        ...
        if (
            keccak256(abi.encode(nonce, to)).toEthSignedMessageHash().recover(
                _signature
            ) == backendSigner
        ) {
            noncesUsed[nonce] = true;
            _mint(to, 1); //mints one album NFT
        }
    }
