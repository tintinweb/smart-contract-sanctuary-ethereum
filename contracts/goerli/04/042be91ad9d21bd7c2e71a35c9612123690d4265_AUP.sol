...
/**
 * @title Automatic Protocol
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing Automatic Protocol (AUP)
...
contract AUP {
    ...
    string public constant name = "Automatic Protocol"; // solium-disable-line
    string public constant symbol = "AUP"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all AUP at the contract address.
     * This sends the AUP tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimAUP() external onlyOwner {
