...
contract HangryHippoElite is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

mapping(address => bool) whitelistedAddresses;

  constructor(string memory customBaseURI_) ERC721("Hangry Hippo Elite", "HHE") {
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    function preMint(uint256 count) isWhitelisted(msg.sender) public payable nonReentrant {
