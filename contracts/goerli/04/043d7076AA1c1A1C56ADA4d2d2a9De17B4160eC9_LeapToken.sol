...
contract LeapToken is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public initialTotalSupply = 1 * 10**9 * (10**18);

    uint256 public swapTokensAtAmount = initialTotalSupply.mul(100).div(denominator);

    uint256 public maxBuyAmount = initialTotalSupply.mul(100).div(denominator); // 1% of the supply
    ...
    address payable public marketingWallet = payable(address(0xdead)); //  MARKETING WALLET
    address payable public devWallet = payable(address(0xdead)); //  DEV WALLET
    ...
    constructor() ERC20("Leapy", "LEAPY") {
       
        buyFee.marketingFee = 300;
        buyFee.liquidityFee = 600;
        buyFee.devFee = 200;
        totalBuyFee = 1100;
        
        sellFee.marketingFee = 300;
        sellFee.liquidityFee = 600;
        sellFee.devFee = 200;
        totalSellFee = 1100;
    ...
    function setBuyFees(
       ...
       uint16 dev
        ...
        totalBuyFee = marketing + liquidity + dev;
     ...
     function setSellFees(
       ...
       uint16 dev
        ...
        totalSellFee = marketing + liquidity + dev;
