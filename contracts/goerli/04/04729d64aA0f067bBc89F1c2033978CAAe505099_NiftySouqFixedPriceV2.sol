...
contract NiftySouqFixedPriceV2 is Initializable {
    ...
    function sell(SellData calldata sell_) external isNiftyMarketplace {
    ...
    //Update Price
    function updateSalePrice(uint256 offerId_, uint256 updatedPrice_, address seller_)
        external
        isNiftyMarketplace
    {
    ...
    function makeOffer(
        ...
        uint256 offerPrice
            ...
            require(offeredBy!= _sale[offerId_].seller,"user should not be seller");
