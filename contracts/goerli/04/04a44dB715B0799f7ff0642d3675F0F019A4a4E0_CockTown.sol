...
/**
 * @title  Smart Contract for the CockTown.wtf Project
 * @notice NFT Minting
 */
...
contract CockTown is ERC721A, DefaultOperatorFilterer, Ownable, PaymentSplitter {
    ...
    address[] private teamWallets = [
        ...
        0x39010C2E22281629E9E7aC94f5c78dB38FDD8a7E 

    ];
    uint256[] private teamShares = [8000, 2000];

    // Constructor
    constructor()
        PaymentSplitter(teamWallets, teamShares)
        ERC721A("Test Town", "TEST")
    {}
