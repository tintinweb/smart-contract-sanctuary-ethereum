...
contract NFTcontract is Ownable, ERC721A, ERC721AQueryable, ReentrancyGuard{
    ...
    constructor( string memory _nameCollection,
    ...
    ERC721A(_nameCollection, _Symbol)
     {
    ...
    function getBalance() public view returns (uint) {
      ...
      function SetMAX_SUPPLY(uint _MAX_SUPPLY) external onlyOwner {
        MAX_SUPPLY = _MAX_SUPPLY;
    }
