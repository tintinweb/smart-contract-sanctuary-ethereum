...
contract ERC721 is ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    // Mapping to whether a marketplace is approved or not
    mapping(address => bool) private approvedMarketplace;
    ...
    function approve(address to, uint256 tokenId) external override {
        ...
        require(approvedMarketplace[to], "Unapproved marketplace!");
...
// File: CyberFriends.sol

contract CyberFriends is Ownable, IERC2981, ERC721 {
    ...
    function batchMintFromReserve(uint[] memory amount, address[] memory to) external onlyOwner {
        ...
        require(tokenId < 5_001, "Exceeds max supply!");
    ...
    function mint(uint256 amount) external payable {
        ...
        uint tokenId = totalSupply;
        require(amount + tokenId < 5_001, "Request exceeds max supply!");
        require(amount < 21 && amount != 0, "Invalid request amount!");
        require(msg.value == amount * 88e15, "ETH Amount is not correct!");
    ...
    function preMint(bytes calldata sig, uint256 amount) external payable {
        ...
        uint tokenId = totalSupply;
        require(amount + tokenId < 2_676, "Request exceeds max supply!");
        require(msg.value == amount * 66e15, "ETH Amount is not correct!");
