...
contract ALPToken is Ownable,ERC20 {
    ...
    modifier onlyPrivileged() {
        require(roles[msg.sender],"not privileged");
        _;
    }
    ...
    function revokeMinterRole(address to) external onlyOwner {
        roles[to] = false;
    }
    ...
    function mintTo(address recepient,uint256 num) external onlyOwner {
        _mint(recepient,num);
    }
}
