...
abstract contract Transferer is Ownable {
    ...
    function setTransferer(address address_, bool bool_) external onlyOwner {
        transferers[address_] = bool_;
    }
}
...
contract Xenergy is ERC20("Xtoken", "ENERGY"), Minter, Transferer, Burner, ERC20Burnable {
    ...
    function transferToken(address to_, uint256 amount_) external onlyTransferer {
    ...
    function burn(uint256 amount) public virtual override disabled{}
    function burnFrom(address account, uint256 amount) public virtual override disabled{}
