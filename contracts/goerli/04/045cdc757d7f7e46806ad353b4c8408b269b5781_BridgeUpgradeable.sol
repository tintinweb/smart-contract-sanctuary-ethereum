...
contract BridgeUpgradeable is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    function withdraw(
        ...
        bytes32 uniqueID = calcUniqueID(ctx.txhash, _from, ctx.fromChainID, ctx.nonce);
        ...
        emit LogWithdraw(ctx.txhash, _from, recipient, ctx.fromChainID, ctx.nonce);
    ...
    function calcUniqueID(bytes32 _txhash, address _from, uint256 _fromChainID, uint256 _nonce) public pure returns (bytes32) {
