 ...
 * @author Aqualis, inspired by the Openzeppelin ERC20 implementation
...
abstract contract IncentivizedERC20 is Context, IERC20Detailed {
    ...
    IAqualisIncentivesController internal _incentivesController;
    ...
    function getIncentivesController()
        ...
        view
        virtual
        returns (IAqualisIncentivesController)
    {
     ...
     **/
    function setIncentivesController(IAqualisIncentivesController controller)
        external
        onlyPoolAdmin
    {
    ...
    function _transfer(
        ...
        IAqualisIncentivesController incentivesControllerLocal = _incentivesController;
