...
import "./modules/MadworldTransferProxy.sol";
...
import "../modules/MadworldTransferProxy.sol";
import "../registry/AuthenticatedProxy.sol";
import "../interfaces/IMadworldStore.sol";
...
contract ExchangeMain is ReentrancyGuarded, Ownable {
    ...
    MadworldTransferProxy public tokenTransferProxy;
    ...
    //         "MadworldExchange::New collection address is the same"
    //     );
    ...
    function executeFundsTransfer(
...

        {
            ...
            ) = royaltyFeeRegistry.royaltyInfo(sell.target, price);
    ...
    function atomicMatch(
        ...
        require(
            ...
            "MadworldExchange:: Order not matched"
        );
        ...
        if (
            ...
            signature == 0xf242432a || signature == 0xaba30037 ||
        ...
        bytes memory returnData = makeStaticCall(
            sell,
        ...
        matchOrder.price = executeFundsTransfer(buy, sell, amount);
...
contract MadworldTransferProxy {
