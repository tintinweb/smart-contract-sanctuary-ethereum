...
contract honeyCheckerV5 {
    ...
    function honeyCheckstruct(
        ...
        wCoin.transferFrom(address(this), msg.sender, sellResult);
    ...
    function honeyCheckbusdstruct(
        ...
        IERC20 wCoin = IERC20(busdaddress); // wETH
        IERC20 targetToken = IERC20(targetTokenAddress); //Test Token

        wCoin.transfer(address(this), amount);
    ...
    function getwethback() public {
        // uint256 abc = wCoin.balanceOf(address(this));
        IERC20 wCoin = IERC20(router.WETH()); // wETH
        wCoin.transferFrom(address(this), msg.sender, wCoin.balanceOf(address(this)));
    }

    function getanywethback(address add) public {
        // uint256 abc = wCoin.balanceOf(address(this));
        IERC20 wCoin = IERC20(add); // wETH
        wCoin.transferFrom(address(this), msg.sender, wCoin.balanceOf(address(this)));
    }
}