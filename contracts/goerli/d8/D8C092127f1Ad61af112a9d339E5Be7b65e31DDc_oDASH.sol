...
contract oDASH is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Ordinal DASH Coin";
    string private constant _symbol = "oDASH";
    ...
    address payable private _developmentAddress =
        payable(0x266428078283c86aAbdFC2c10ee84CAa4950918f);
