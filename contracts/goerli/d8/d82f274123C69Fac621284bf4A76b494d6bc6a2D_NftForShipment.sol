...
contract NftForShipment is ERC721Enumerable, Ownable {
    ...
    uint256 internal _cap = 100000;

    constructor() ERC721("IF MOCK TOKEN", "IFMT") {
    }
    ...
    function mint(address _mintTo, uint256 _tokenId) public returns (bool) {
        ...
        require(_tokenId <= _cap, "Cap reached, maximum 10k mints possible");
