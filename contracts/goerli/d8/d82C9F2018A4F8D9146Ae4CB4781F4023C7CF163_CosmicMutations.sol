...
// Cosmic Mutations v1.1

contract CosmicMutations is ERC721Enumerable, Ownable, CosmicMutationVoucherSigner {
    using Address for address;
    ...
    // Token Supply
    uint256 public MAX_SUPPLY = 4444; // Max Collection Supply.
    ...
    function mintMutation(CosmicMutationVoucher.Voucher calldata v) public {
        ...
        require(claimedVouchers[v.voucherId] < 1, "Voucher already claimed.");
...
library CosmicMutationVoucher {
  ...
  {
    bytes32 h1 = keccak256(abi.encodePacked(v.voucherId, v.to, v.head, v.eyes, v.mouth, v.body, v.skin, v.background));
