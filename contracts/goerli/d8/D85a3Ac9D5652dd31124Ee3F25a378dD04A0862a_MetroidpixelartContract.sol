...
//*********************************************************************//
//
//  __       __  ________  ________  _______    ______   ______  _______  
// |  \     /  \|        \|        \|       \  /      \ |      \|       \ 
// | $$\   /  $$| $$$$$$$$ \$$$$$$$$| $$$$$$$\|  $$$$$$\ \$$$$$$| $$$$$$$\
// | $$$\ /  $$$| $$__       | $$   | $$__| $$| $$  | $$  | $$  | $$  | $$
// | $$$$\  $$$$| $$  \      | $$   | $$    $$| $$  | $$  | $$  | $$  | $$
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xDDAda5530653CEd35185F56cFf644cFc3F8ed2cb];
  address public erc20Payable = 0xDDAda5530653CEd35185F56cFf644cFc3F8ed2cb;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibgfohtk7vk5hhrylwwmovfxfyebec4fpmsmq2ax3x2pmdnjr36r4/";
...
// File: contracts/MetroidpixelartContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MetroidpixelartContract is RamppERC721A {
    constructor() RamppERC721A("METROID PIXEL ART", "SAMUS"){}
}
