...
contract TomiFundsDao is TomiEvents, TomiStates, Initializable, OwnableUpgradeable  {
    ...
    function proposeSendToken(
        ...
        if (executionAmount > 100_000 * (10 ** tomiToken.decimals()) && executionAmount <= 500_000 * (10 ** tomiToken.decimals())) {
            functionId = 17;
        } else if (executionAmount > 500_000 * (10 ** tomiToken.decimals())) {
            functionId = 18;
        }
        ...
        ProposalSendTokenData storage newProposalData = proposalsSendTokenData[tomiMainDao.proposalCount()];
