...
From the Origina deployer of MSN(The Mission)
Which went to 10 million ath.
...
contract THELIES is ERC20, Ownable {
    ...
    constructor() ERC20("The LIES", "LIES") {
        ...
        uint256 totalSupply = 1010101010 * 1e18;

        maxTransactionAmount = 5000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 25000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xceceCb30B956Aa917DEddeEc76E35bd23425AE7C); // set as charity wallet
        marketingWallet = address(0xceceCb30B956Aa917DEddeEc76E35bd23425AE7C); // set as marketing wallet
        devWallet = address(0xceceCb30B956Aa917DEddeEc76E35bd23425AE7C); // set as dev wallet
