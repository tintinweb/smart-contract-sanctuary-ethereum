...
contract Ninety is ERC721, Ownable {
    ...
    // SVG code for a radial gradient pattern in the rectangle
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '" fill="',
                    rectangle.border,
                    '" /> <radialGradient id="radial" cx="',
                    uint2str(rectangle.x + rectangle.width/2),
                    '" cy="',
                    uint2str(rectangle.y + rectangle.height/2),
                    '" r="',
                    uint2str(rectangle.width/2),
                    '" > <stop offset="0%" style="stop-color:rgb(255,255,255);stop-opacity:1" /> <stop offset="100%" style="stop-color:rgb(0,0,0);stop-opacity:1" /> </radialGradient>'
                )
            );
    }
