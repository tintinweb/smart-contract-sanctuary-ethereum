...
// File: contracts/nft/StarWarBoxNFT.sol
 ...
 * Pet EGG NFT ERC721
 */
contract StarWarBoxNFT is ERC721Tradable {
    ...
    public {
  	...
  	modifier onlyMint() {
  		require(_msgSender() == owner() || minters[msg.sender], "CatEgg: not minter");
  		_;
  	}
    ...
    // Create BOX NFT
    function createBox(address _to,
                      bytes memory _data) public onlyMint returns (uint256){
           uint256 _newTokenId = mint(_to, _data);
           return _newTokenId;
    }
