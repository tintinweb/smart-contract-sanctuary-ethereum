...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Hat", unicode"Mouth", unicode"Eyes", unicode"Head", unicode"Neck", unicode"Coat", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"Cute Kevin", unicode"1,111 Cute Kevins ready to go out and take over the PFP scene. All on-chain, these little Kevins are too cute to burn. The more Cute Kevins you hold the better your chance of winning the prizes and giveaways!", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/9e31b41a-3c49-49a6-a3be-11a5c91d0969", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/9e31b41a-3c49-49a6-a3be-11a5c91d0969", "", 500, "0x42f575Ebe22D4be35fE9e5906C7736416D70e58E");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Cute Kevin", unicode"CUTE") {
        tiers[0] = [15,50,80,92,100,138,148,149,164,175];
        tiers[1] = [130,151,166,200,209,255];
        tiers[2] = [10,20,30,40,50,59,64,80,100,105,179,181,193];
        tiers[3] = [4,127,184,194,205,397];
        tiers[4] = [1,50,100,200,760];
        tiers[5] = [5,30,52,95,164,165,300,300];
        tiers[6] = [10,10,43,80,90,90,90,100,100,123,175,200];
