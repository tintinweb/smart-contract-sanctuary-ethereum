...
contract KongFu is ERC721A, Ownable, ReentrancyGuard {
    address public megaKongsContract =
        0x0D7cbFa90a214fc0D8EA692779626fC3dfEbBE08;
    uint256 public price = 0.01 ether;
    uint256 public maxSupply = 16000;
    uint256 public initialSaleSupply = 10000;
    address public treasury = 0x0D7cbFa90a214fc0D8EA692779626fC3dfEbBE08;
    ...
    /**
     * @notice Checks if the given token has been claimed.
     *
    ...
    function mint(uint256 quantity) public payable nonReentrant {
        ...
        require(
            totalSupply() + quantity <= getCurrentMaxSupply(),
    ...
    function claim(uint256[] memory tokenIds) public nonReentrant {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            require(
                IERC721(megaKongsContract).ownerOf(tokenIds[i]) == msg.sender,
                "You do not own this MegaKong"
            );
     ...
     * will be returned from the contract's `baseURI` state variable.
     *
    ...
    function setMegaKongsContract(address _megaKongsContract) public onlyOwner {
        require(
            _megaKongsContract != address(0),
            "MegaKongs contract cannot be 0 address"
        );
    ...
    function setClaimActive(bool _claimActive) public onlyOwner {
     ...
     */
    function setInitialSaleFinished(bool _initialSaleFinished)
        public
        onlyOwner
    {
    ...
    function setMetadataInterface(MetadataInterface _metadataInterface)
        public
        onlyOwner
    {
