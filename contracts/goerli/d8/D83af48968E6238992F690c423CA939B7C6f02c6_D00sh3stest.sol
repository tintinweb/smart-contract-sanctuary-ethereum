...
contract D00sh3stest is Ownable, ERC721A, DefaultOperatorFilterer {
    ...
    uint256 public constant DOOSHLIST_SUPPLY = 2;
    ...
    constructor(
        ...
        baseTokenURI2 = tokenURI2;
    }

    function checkTokenURIs()
        external
        view
        returns (string memory uri, string memory uri2)
    {
        return (baseTokenURI, baseTokenURI2);
    }
    ...
    function switchURIs() external onlyOwner {
