...
contract DutchAuction is PausableUpgradeable, 
    ...
    function mintNFT(uint256 stage, bytes32[] calldata whitelistProof) public payable 
        ...
        emit NFTMinted(stage, tokenId, sender, currentPrice, refund, _nftContract, merkleRoot != 0);
        return tokenId;
    }
    ...
    modifier whenHasAllowance(uint256 stage) {
        require(allowance(stage, _msgSender()) > 0, "no allowance");
        _;
    }
}
