...
contract CoinPhrase is TwoStage {
    function initialize(
        ...
        __ERC721A_init("CoinPhrase", "CoinPhrase");
         __DefaultOperatorFilterer_init();
        __Ownable_init();
        __AdminManager_init_unchained();
        __Supply_init_unchained(2500);
        __AdminMint_init_unchained();
        __Whitelist_init_unchained();
        __BalanceLimit_init_unchained();
        __UriManager_init_unchained(
            "https://ipfs.io/ipfs/Qmc5HHobzGqf39vENwcH1AEkPZPwWSyaKe8saKupB9XxAU/",
            ".json"
        );
        ...
        setPrice(uint8(Stage.Public), 0.045 ether);
    }
