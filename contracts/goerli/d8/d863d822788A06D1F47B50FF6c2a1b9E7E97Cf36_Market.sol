...
contract Market is ReentrancyGuard {
        ...
        isOwner(nftAddress, tokenId, msg.sender)
    {
        ...
        s_listings[nftAddress][tokenId] = Listing(caluculatePrice(nftAddress,tokenId), msg.sender);
        emit ItemListed(msg.sender, nftAddress, tokenId, caluculatePrice(nftAddress,tokenId));
    }
        ...
        isListed(nftAddress, tokenId)
    {
        ...
        if (msg.value < caluculatePrice(nftAddress, tokenId)) {
