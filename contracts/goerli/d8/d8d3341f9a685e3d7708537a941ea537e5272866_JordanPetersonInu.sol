...
contract JordanPetersonInu is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**9; //
    string private constant _name = unicode"Jordan Peterson Inu"; // 
    string private constant _symbol = unicode"JPINU"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xA2755DCf944D46Ece6E93b4dd7a69378091bA94f;
