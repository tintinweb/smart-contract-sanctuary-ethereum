    ...
    BasicMetaTransaction
{
    ...
    function mint(
        ...
        _beforeTokenMint(id, amount, royalty, _tokenURI);

        creator[id] = msgSender();
        tokenRoyalty[id] = royalty;

        _setTokenURI(id, _tokenURI);

        emit Mint(msgSender(), id, amount, royalty, _tokenURI);

        _mint(msgSender(), id, amount, "");
    }
    ...
    function _beforeTokenMint(
        ...
        require(royalty <= 9, "Royalty amount must be between 0 and 9.");
