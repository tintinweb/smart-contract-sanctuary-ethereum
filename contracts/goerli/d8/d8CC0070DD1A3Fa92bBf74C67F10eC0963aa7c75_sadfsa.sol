...
// SPDX-License-Identifier: MIT
        ...
        contract sadfsa is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer{
            ...
            bytes32 public MerkleGroupRoot = 0x7470f050478e849bbb577659909b7c8b8fea3bbe12f272747a4a8397444b6282;
            uint256 public MerklePrice = 0.01 ether;
            uint256 public MerkleMaxWallet = 10;
            ...
            constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet, string memory _initNotRevealedUri) ERC721A("abc", "abc") {
        ...
        modifier whitelistMintPriceCompliance(bytes32[] calldata _merkleProof, uint256 _mintAmount) {
          ...
          _;
            ...
            function checkPricePerUser(bytes32[] memory _merkleProof, bytes32 leaf) view public returns (uint256){
                ...
                if(MerkleProof.verify(_merkleProof, MerkleGroupRoot, leaf)) return MerklePrice ;
            ...
            function checkMaxMintPerUser(bytes32[] memory _merkleProof, bytes32 leaf, uint256 amount) view public returns (bool){
              ...
              if(MerkleProof.verify(_merkleProof, MerkleGroupRoot, leaf)) {
                  if(balance <= MerkleMaxWallet) return true;
                  else return false;
                }
