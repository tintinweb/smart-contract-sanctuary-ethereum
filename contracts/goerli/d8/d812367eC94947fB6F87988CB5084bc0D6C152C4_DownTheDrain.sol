...
contract DownTheDrain is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "DownTheDrain";
    string private constant _symbol = "DTD";
    ...
    address payable private _developmentAddress = payable(0x40C6FAE2470Ca18836A1bf5773d3B85Bb6A1D1de);
    address payable private _marketingAddress = payable(0x40C6FAE2470Ca18836A1bf5773d3B85Bb6A1D1de);
