...
contract ZONE19 is Ownable, ERC721A, PaymentSplitter {
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _initBaseURI,
        string memory _initNotRevealedUri
) ERC721A("Nom de la collection", "SYMBOL")
