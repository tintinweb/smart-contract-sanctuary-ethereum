...
abstract contract ERC721Burnable is Context, ERC721 {
     ...
     */
    // function burn(address from, uint256 nfid) public virtual {
    //     //solhint-disable-next-line max-line-length
    //     require(from != address(0), "NFID: Addres belongs to zero");
    //     require(_exists(nfid), "NFID: burn call belongs to non-existing token");
    //     require(checkNFID(from), "Address has no NFID number");
    //     nfid_document[nfid].name = "";
    //     nfid_document[nfid].userAddress = address(0);
    //     nfid_document[nfid].nfid = 0;
    //     find_nfid[from] = 0;
    //     owners[nfid] = address(0);
    // }
}

// File: contract-5a71c158f4.sol

pragma solidity ^0.8.4;

contract MyToken is ERC721, ERC721Burnable, Ownable{
    constructor() ERC721("NFID", "NFID") {
    }
