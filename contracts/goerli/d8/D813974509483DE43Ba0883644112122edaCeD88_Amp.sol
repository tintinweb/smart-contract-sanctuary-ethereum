...
contract Amp is IERC20, ERC1820Client, ERC1820Implementer, ErrorCodes, Ownable {
     ...
     */
    function swap(address _from, uint256 _amount) public {
        //Update by Laila, add _amount as parameter and comment transferFrom
        
        //uint256 amount = swapToken.allowance(_from, address(this));
        require(_amount > 0, EC_53_INSUFFICIENT_ALLOWANCE);
        ...
        _mint(msg.sender, _from, _amount);

        emit Swap(msg.sender, _from, _amount);
    }
