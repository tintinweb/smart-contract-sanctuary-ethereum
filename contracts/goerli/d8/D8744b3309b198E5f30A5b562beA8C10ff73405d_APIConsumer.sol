...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        ...
        req.add('get', 'https://fantasy.premierleague.com/api/bootstrap-static/');

        req.add('path', 'events.most_captained'); // Chainlink nodes 1.0.0 and later support this format
