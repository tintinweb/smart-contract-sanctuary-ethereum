...
contract CastleHeroes is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint16 private presaleMaxItemsPerWallet = 1;
    uint16 private presaleMaxItemsPerTransaction = 1;
    uint16 private maxItemsPerWallet = 1;
    uint16 private maxItemsPerTransaction = 1;
    ...
    // ===== Whitelisting =====
    // TODO this works with merkle proof -> how is the proof generated?
    ...
    // changed from uint8 to 16 for testing...
    function setPresaleMaxItemsPerWallet(uint16 value) external onlyOwner {
        presaleMaxItemsPerWallet = value;
    }

    function setPresaleMaxItemsPerTransaction(uint16 value) external onlyOwner {
        presaleMaxItemsPerTransaction = value;
    }

    function setMaxItemsPerWallet(uint16 value) external onlyOwner {
        maxItemsPerWallet = value;
    }

    function setMaxItemsPerTransaction(uint16 value) external onlyOwner {
