...
contract FimbRSTestToken2 is ERC20Snapshot, Ownable {
    ...
    uint256 public constant START_PAYMENT = 33.48 * 1 ether;
    ...
    // Name of the token
    string public constant TOKEN_NAME = "FimbRSTestToken2";
    // Symbol of the token
    string public constant TOKEN_SYMBOL = "FRSTT02";
