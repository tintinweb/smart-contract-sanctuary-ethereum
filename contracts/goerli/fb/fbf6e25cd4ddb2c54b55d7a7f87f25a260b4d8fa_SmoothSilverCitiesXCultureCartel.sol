...
// File: DefaultOperatorFilterer/IOperatorFilterRegistry.sol
...
// File: DefaultOperatorFilterer/OperatorFilterer.sol
...
// File: culturecartelRoyalties.sol
...
contract SmoothSilverCitiesXCultureCartel is
    ERC721A,
    ERC2981,
    ReentrancyGuard,
    ...
    Ownable
{
    ...
    {
        _setDefaultRoyalty(0xcd5613779c8389f6cb3464B170A70c8266Af1623, 800);
    }
        ...
        onlyOwner
    {
        ...
        require(_quantity % 100 == 0, "Can only mint a multiple of 100");

        uint256 numChunks = _quantity / 100;
    ...
    function setMaxSupply(uint256 _maxSupply) public onlyOwner {
        ...
        require(_maxSupply % 100 == 0, "Can only mint a multiple of 100");
