...
contract SyncStatus {
    ...
    mapping(address => uint8) public userStatus;
    ...
    function updateStatus(
        ...
        bytes memory message = abi.encode(
            Request({account: msg.sender, status: _status})
        );
    ...
    function executeMessage(
        ...
        // decode the message
        Request memory message = abi.decode((_message), (Request));
        userStatus[message.account] = message.status;
