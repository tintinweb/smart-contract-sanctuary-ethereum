...
// config parameter
    ...
    address public tokenAddress = 0xc7117B3181FA42ee78130B71E9146AAc119039f2; // TEST reward ERC20token
    ...
    mapping(uint256 => uint256) lastClaims; //tokenId => claimTime
    ...
    function claimToken() external nonReentrant {
        ...
        tokenAmount = timeAmount * dayReward; //get dayreward / 86400minutes(1day)
        tokenContract.mintToken(_owner, tokenAmount); //mintToken
    }
