...
Introducing Royalty Inu, a revolutionary new cryptocurrency that combines the power of web3 and DeFi technologies to create a truly decentralized and democratized financial system.


Brought to you by the $WPI & $ANARCHY Developer (2m+ mcap ATH, and ANARCHY hit nearly 10 million). (Check etherscan)

- $ROYALTY SOCIALS:

- TELEGRAM: HTTPS://T.me/royaltyinu
- WEBSITE: Royaltyinu.site
...
contract ROYALTY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ROYALTY INU";
    string private constant _symbol = unicode"ROYALTY";
