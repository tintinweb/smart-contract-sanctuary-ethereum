    ...
    ITelepathyReceiver
{
        ...
        internal
    {
        ...
        if (data.length == 32) {
            ...
            implementsHandler = magic == ITelepathyHandler.rawHandleTelepathy.selector;
        }
...
/// @author Succinct Labs
/// @notice Executes the messages sent from the source chain on the target chain.
contract Telepathy is SourceAMB, TargetAMB, UUPSUpgradeable {
...
contract TelepathyStorage {
    ...
    /// @notice The guardian multisig that can control the `frozen` mapping and `sendingEnabled`.
    ...
    modifier onlyGuardian() {
        require(msg.sender == guardian, "Telepathy: only guardian can call this function");
        _;
    }
}
