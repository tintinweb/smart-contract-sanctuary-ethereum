 ...
 *
 *  Hypothetical docstring below this line.
 *
 * ---------------------------------------------------------------------------
 *
 ...
 *  Initiating a swap:
 *
 *    Anyone can initiate a swap by specifying the terms of the swap, including the address of the
 *    counterparty, the tokens to be swapped, and the amounts. Party A's tokens are then
 *    transfered to this contract and held in escrow.
 *
 *  After initiating a swap, one of two things can happen:
 *
    ...
    Rescuable
{
     ...
     *
     *  Requires that the sender is party A and has an allowance set on this contract for token A.
     */
     ...
     * @notice Initiate a swap.
     *
     *  Requires a signature from party A.
     *  Requires that party A has an allowance set on this contract for token A.
     */
     ...
     *
     *  Requires that the sender is party B and has an allowance set on this contract for token B.
     */
     ...
     * @notice Complete a swap.
     *
     *  Requires a signature from party B.
     *  Requires that party B has an allowance set on this contract for token B.
     */
