...
contract EstateRegistry is Migratable, IEstateRegistry, ERC721Token, ERC721Receiver, Ownable, EstateStorage {
    ...
    modifier canSetUpdateOperator(uint256 estateId) {
        ...
        require(isApprovedOrOwner(msg.sender, estateId) || updateManager[owner][msg.sender], "unauthorized user");
        _;
    }
    ...
    function _isLandUpdateAuthorized(address operator, uint256 estateId, uint256 landId) internal returns (bool) {
     ...
     * Testnet Goerli: 0x53922FE396FFbB42feCB74697d854e667B9FB835
     */
    function setEstateLandBalanceToken() external {
        require(estateLandBalance == address(0), "estateLandBalance was set");
        _setEstateLandBalanceToken(address(0x53922FE396FFbB42feCB74697d854e667B9FB835));
    }
}
