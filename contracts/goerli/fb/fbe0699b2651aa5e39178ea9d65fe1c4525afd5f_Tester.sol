...
contract Tester is Context, IERC20, Ownable {
    ...
    uint256 public _devShare = 5; // original 12
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountTeam = amountReceived.mul(_devShare).div(totalFee);
        ...
        if(amountTeam > 0)
            transferToAddressETH(DevAddress, amountTeam);
