...
contract OracleV1 is OwnableUpgradeable{
  // Contract owner
  // address public owner;

  // Eth2 Validator Rewards
  uint public validatorRewards;
  ...
  // function updateValidatorRewards() public {
  ...
  function getValidatorRewards() view public returns (uint256) {
