...
contract DEX {
    ...
    function ethToToken() public payable returns(uint256 tokenOutput) {
        ...
        bool success = token.transferFrom(address(this), msg.sender, tokenOutput);
    ...
    function tokenToEth(uint256 tokenInput) public returns(uint256 ethOutput) {
        ...
        require(tokenSent, "BAL - Transfer failed!");
    ...
    function deposit() public payable returns(uint256 BAL_Deposited) {
        ...
        bool success = token.transferFrom(msg.sender, address(this), BAL_Deposited);
