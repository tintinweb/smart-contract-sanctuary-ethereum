...
contract NFTStakingPerToken is Context, IERC721Receiver {
    ...
    // mapping(address => uint256) public rewardModifier;
    ...
    function available(address account) public view returns (uint256) {
        ...
        uint256 earned = ((balanceOf[account] *
            timeElapsed *
            rewardPerTokenPerDay) / 60); /** rewardModifier[account];*/ // seconds
        return reward[account] + earned;
    }

    /**
     * @dev returns the amount of time left before you accumulate a reward
     * @param account account
     */
    function timeLeft(address account) public view returns (uint256) {
