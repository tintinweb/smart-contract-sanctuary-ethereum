...
contract ProofOfGoblins is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public TotalCollectionSize_ = 2222; // total number of nfts
    ...
    string private baseTokenURI = "https://xmas.omakasea.com/metadata/";

    bytes32 public merkleRoot;

    constructor()
        ERC721A("ProofOfGoblins", "POG", MaxMintPerBatch_, TotalCollectionSize_)
    {}
    ...
    function airDropRandomToAccounts(address[] calldata to) public onlyOwner {
    ...
    {
        require(totalSupply() + address_.length * tokenCount <= TotalCollectionSize_, "This exceeds the maximum number of NFTs on sale!");
