...
contract Bayplay is ERC721A, Ownable, RoyaltiesV2, DefaultOperatorFilterer {
    ...
    SalesEndTime public salesEndTime = SalesEndTime(0, 0);
    ...
    function pre1Mint(uint256 quantity, bytes calldata signature) external payable {
        ...
        require(block.timestamp <= salesEndTime.pre1EndAt, "Presale1 mint ended");
    ...
    function pre2Mint(uint256 quantity, bytes calldata signature) external payable {
        ...
        require(block.timestamp <= salesEndTime.pre2EndAt, "Presale2 mint ended");
    ...
    function setSalesEndTime(uint256 pre1, uint256 pre2) external onlyOwner {
