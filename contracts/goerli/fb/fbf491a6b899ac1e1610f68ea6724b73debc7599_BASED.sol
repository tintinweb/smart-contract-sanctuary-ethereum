...
/*
 ...
 Website: https://BasedERC.com/
 Twitter: https://twitter.com/BasedERC
 Telegram: https://twitter.com/BasedERCToken
 Medium: https://medium.com/@basederc

 Multiple combinations.. Only one is right.. It might take all your power and might, 
 but it will be clear for those with $BASED sight.
...
contract BASED is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Based", "BASED") {
        ...
        maxWallet = (totalSupply * 1 / 100) + (1 * 1e9); // 1% max wallet
    	...
    	marketingWallet = address(0xd390941c2E84E3DECE2b36723D9A165033a9A034); // Marketing wallet
        ...
        /*
        00111000 01110111 00110111 01001101 01110111 01001111
        */
