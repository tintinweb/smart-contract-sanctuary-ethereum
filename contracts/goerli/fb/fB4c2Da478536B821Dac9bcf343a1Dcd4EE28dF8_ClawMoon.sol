...
contract ClawMoon is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1068895 * 10**_decimals;
    string private constant _name = unicode"ClawMoon";
    string private constant _symbol = unicode"CLAM";
