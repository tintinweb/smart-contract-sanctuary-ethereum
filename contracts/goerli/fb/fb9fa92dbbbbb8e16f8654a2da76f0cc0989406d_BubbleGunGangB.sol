...
contract BubbleGunGangB is ERC721A, Ownable, ReentrancyGuard {
    ...
    // TESTNET TODO: DELETE AND REPLACE WITH MAINNET
    IERC721A bggOG = IERC721A(0x30d71dA51Fc35beA5095d3dA6660D3794b40cF06);

    modifier onlyDev() {
        require(msg.sender == dev, "Only the dev can call this");
        _;
    }
    ...
    constructor() ERC721A("BGGTest", "BGGT") {
