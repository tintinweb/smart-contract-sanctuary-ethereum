...
contract EthereumTaipe is TaipeNFT {
...
contract TaipeNFT is ERC721Enumerable, ERC2981, AccessControl {
    ...
    uint96 constant INITIAL_PERCENTAGE = 250; // 2.5%
...
library TaipeLib {
    uint public constant TOTAL_TIER_1 = 25;
    uint public constant TOTAL_TIER_2 = 4500;
    uint public constant TOTAL_TIER_3 = 7475;
    ...
    function getStartingId(Tier tier) public pure returns (uint) {
        if (tier == Tier.TIER_1) return 0;
        else if (tier == Tier.TIER_2) return TOTAL_TIER_1;
        return TOTAL_TIER_1 + TOTAL_TIER_2;
    }

    function getAvailableCount(Tier tier) public pure returns (uint) {
