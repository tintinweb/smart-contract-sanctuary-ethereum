...
contract TestOnChain is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {

    uint public normalMintPrice = 0.004 ether;
    uint public whitelistMintPrice = 0 ether;
    uint public maxNormalMintPerAccount = 30;
    uint public maxWhitelistMintPerAccount = 5;
    ...
    uint public maxSupply = 33;
    uint public maxNormalSupply = 33;
    uint public maxWhitelistSupply = 5;
    ...
    constructor() ERC721A("Test OnChain", "TOC") EIP712("TestOnChain", "1.0.0") {
    }
    ...
    function _hash(address account) private view returns (bytes32) {
        return _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256("TestOnChain(address account)"),
                    account
                )
            )
        );
