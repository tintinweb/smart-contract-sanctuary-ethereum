    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xFbbd4f422CDf3859134817102b0C73b595e90377;
    ...
    uint256 public maxPerPerson = 1111;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("tEST ONLY CONTRACT", "TOC") ClampedRandomizer(maxSupply) {     
