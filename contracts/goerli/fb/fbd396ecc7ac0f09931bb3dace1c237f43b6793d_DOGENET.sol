...
contract DOGENET is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private totalBuySellFees;
    ...
    constructor() ERC20("DogeNet", "DNET") {
    ...
    function updateFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _buyDevFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee, uint256 _sellDevFee) external onlyOwner {
        ...
        totalBuySellFees = buyMarketingFee + buyLiquidityFee + buyDevFee + sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(totalBuySellFees <= 20, "Must keep fees at 20% or less");
    }
