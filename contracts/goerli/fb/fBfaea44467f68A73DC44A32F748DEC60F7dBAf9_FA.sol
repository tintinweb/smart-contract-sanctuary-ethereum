...
contract FA is ERC721A, Ownable{
    using Strings for uint256;

    constructor() ERC721A("FFF","F") {}
    ...
    event OwnerMint(address indexed to, uint256 indexed quanlity);
    ...
    function ownerMint(uint256 _quanlity, address _to) external onlyOwner {
        require(_quanlity > 0, "Wrong amount of minting");
        require(totalSupply() + _quanlity <= maxSupply, "Exceed the limit of mint amount");
        _mint(_to, _quanlity);
        emit OwnerMint(_to, _quanlity);
    }
