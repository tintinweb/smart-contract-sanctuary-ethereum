...
contract ClearingHouseV2 is IClearingHouseV2, Ownable, Pausable {
  ...
  // A backend wallet that can generate valid signatures
  address public walletWithSignGenPermission;
  ...
  constructor(
    ...
    address _walletWithSignGenPermission
  ) {
    ...
    _checkZeroAddress(_walletWithSignGenPermission);
    ...
    // governor = _governor;
    walletWithSignGenPermission = _walletWithSignGenPermission;
  ...
  function _verifySignature(
    ...
    if (messageSigner != walletWithSignGenPermission) {
  ...
  function setMessageSignerWallet(address _wallet) external {
    _checkZeroAddress(address(_wallet));
    walletWithSignGenPermission = _wallet;
  }
