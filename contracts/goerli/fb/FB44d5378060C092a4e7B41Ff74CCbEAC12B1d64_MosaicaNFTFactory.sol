...
import "./MosaicaNFT.sol";

/* 
    Mosaica NFT Factory
    Creates new Mosaica NFT collection
*/

contract MosaicaNFTFactory {
        // owner address => nft list
    mapping(address => address[]) private nfts;

    mapping(address => bool) private mosaicaNFT;
...
/* Mosaica NFT-ERC721 */
contract MosaicaNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
