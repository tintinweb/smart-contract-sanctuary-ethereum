...
import "../interfaces/IECDSASignatureWell.sol";

contract ECDSASignatureWell is ECDSASignatureBase, IECDSASignatureWell {
    ...
    function hashingCreateWellMessage(uint256 price, uint barsAmount) external pure returns (bytes32) {
        return keccak256(abi.encodePacked(price, barsAmount));
    }
