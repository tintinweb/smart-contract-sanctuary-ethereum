...
contract Xmas is ERC721Tradable {
    ...
    mapping (uint256 => string ) private ICON_NAMEs;
    ...
    constructor(address _proxyRegistryAddress) ERC721Tradable("DonateXMas", "XMAS", _proxyRegistryAddress) {
        ...
        DONAs    [    1000000000000000] = '"},{"trait_type":"Donated amount","value":"0.001 ETH"},';
        DONAs    [   50000000000000000] = '"},{"trait_type":"Donated amount","value":"0.05 ETH"},';
        DONAs    [  100000000000000000] = '"},{"trait_type":"Donated amount","value":"0.1 ETH"},';
        DONAs    [  250000000000000000] = '"},{"trait_type":"Donated amount","value":"0.25 ETH"},';
        DONAs    [  500000000000000000] = '"},{"trait_type":"Donated amount","value":"0.5 ETH"},';
        DONAs    [ 1000000000000000000] = '"},{"trait_type":"Donated amount","value":"1 ETH"},';
        DONAs    [ 5000000000000000000] = '"},{"trait_type":"Donated amount","value":"5 ETH"},';
        DONAs    [10000000000000000000] = '"},{"trait_type":"Donated amount","value":"10 ETH"},';

        DONATIONs[    1000000000000000] = con(TX_1, "0.001 ETH donated to ");
        ...
        // Icons
            ICON_NAMEs[1]  =  '{"trait_type":"Icon","value":"Trees"}]}';
            ICON_NAMEs[2]  =  '{"trait_type":"Icon","value":"Star"}]}';
            ICON_NAMEs[3]  =  '{"trait_type":"Icon","value":"Reindeer"}]}';
            ICON_NAMEs[4]  =  '{"trait_type":"Icon","value":"Ball"}]}';
            ICON_NAMEs[5]  =  '{"trait_type":"Icon","value":"Hat"}]}';
            ICON_NAMEs[6]  =  '{"trait_type":"Icon","value":"Tree 3"}]}';
            ICON_NAMEs[7]  =  '{"trait_type":"Icon","value":"Tree 1"}]}';
            ICON_NAMEs[8]  =  '{"trait_type":"Icon","value":"Tree 2"}]}';
            ICON_NAMEs[9]  =  '{"trait_type":"Icon","value":"Snowman"}]}';
            ICON_NAMEs[10] =  '{"trait_type":"Icon","value":"Ball"}]}';
            ICON_NAMEs[11] =  '{"trait_type":"Icon","value":"Snowflakes"}]}';
            ICON_NAMEs[12] =  '{"trait_type":"Icon","value":"Gift"}]}';
            ...
            // Ball
            ICONS[11][1] = '<g fill="none"><path d="m834.82 160.327 2.687 2.706C850.94 176.565 859 198.216 859 217.16c0 21.65-8.06 40.595-21.493 54.126l-37.611 37.889a26.226 26.226 0 0 1-1.907 2.537c.312 19.683-6.475 39.526-20.653 56.288-16.182-32.377-35.061-62.055-62.031-86.338l-.86-.949c-24.112-26.475-53.461-45.108-85.445-61.106 16.79-12.92 36.672-19.653 56.39-19.607a39.7 39.7 0 0 1 1.67-1.784l37.612-37.889c29.552-29.77 80.597-29.77 110.149 0Zm-75.223 40.595-16.12 18.944 34.926 35.182 18.806-18.944c5.373-5.413 8.06-10.825 8.06-16.238 0-5.412-2.687-13.531-8.06-16.238l-2.687-2.706c-8.06-8.119-24.179-8.119-34.925 0Z" fill="';
            ICONS[11][2] = '"/><path d="M679.015 319.9c-110.726-110.58-286.268-121.368-410.497-32.366l35.109 35.061c54.012 53.94 118.827 91.699 191.745 110.578 81.019 21.576 156.636 64.728 216.05 124.063l51.312 51.243c24.306-99.79-5.401-210.367-83.72-288.58Z" fill="';
            ICONS[11][3] = '"/><path d="M589.894 770.301c-54.013-53.94-118.828-91.698-191.745-110.577-81.02-21.577-156.637-64.729-216.05-124.063l-37.81-37.759c-16.204 97.093 13.503 199.58 89.121 272.4C295.525 832.331 376.544 862 457.563 862c59.414 0 121.528-16.182 172.84-51.243l-40.51-40.456Z" fill="';
            ICONS[11][4] = '"/><path d="M676.314 597.692c-54.013-53.94-118.828-91.699-191.745-110.578-81.019-21.576-156.637-64.728-216.05-124.063l-40.51-40.455c-32.408 32.364-54.013 70.123-70.217 110.578l62.115 62.031c54.013 53.94 118.828 91.699 191.745 110.578 81.019 21.576 156.637 64.729 216.05 124.063l37.81 37.758 5.4 5.394 8.103-8.09c29.707-29.668 51.312-64.73 67.515-99.79-2.7 0-5.4-2.697-8.101-5.394l-62.115-62.032Z" fill="';
            ICONS[11][5] = '"/></g>';
    ...
    function getAttributes(uint256 _tokenId) public view returns (string memory) {
        ...
        string memory json = con( 
            '", "attributes":[  {"trait_type":"Donated to","value":"', 
            NAMEs[card.NGO_id], 
            DONAs[card.donated],
            ICON_NAMEs[card.icon_id]
            );
        return json;
        ...
        return string(
            abi.encodePacked(
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            '{"name":"Donate Xmas Card', getTOKEN(_tokenId), getAttributes(_tokenId)
                        )
                    )
                )
            )
