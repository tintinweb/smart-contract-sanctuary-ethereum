...
// File: contracts/ChallengeUSDT.sol
 ...
 */
contract ChallengeUSDT is ERC20 {

    constructor() ERC20('ChallengeUSDT', 'USDT') {
 ...
 */
contract Challenge {
    // Adress - reference to the USDT test token contract
    ...
    event Buy(string token, uint256 amount);
    event Sell(string token, uint256 amount);
    ...
    function buy() payable public {
        ...
        emit Buy('ETH', msg.value);
    }

    // This method spends ERC20 tokens - as such the token contract needs to approve the 
    // challenge contract to spend funds first (check out the approve method)
