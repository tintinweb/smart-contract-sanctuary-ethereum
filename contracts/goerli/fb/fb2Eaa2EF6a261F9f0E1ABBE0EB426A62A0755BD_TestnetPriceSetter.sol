...
contract TestnetPriceSetter {
    ...
    function setPrices() public {
        ...
        oracle.setUnderlyingPrice(CToken(cETH), uint256(price) * 10**(18 - decs));
    }
}
