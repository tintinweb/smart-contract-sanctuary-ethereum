...
contract RL2022 is ERC721Enumerable, Ownable {
    ...
    SaleStates public saleState = SaleStates.PUBLIC;
    ...
    uint256 public tokenIdUnity = 500;
    uint256 public tokenIdMindful = 2000;

    uint256 public mindfulPrice = 0.02 ether; // 2000000000000000000 wei
    uint256 public unityPrice = 0.03 ether; // 3500000000000000000 wei
    ...
    /*--------------------------MINT FUNCTIONS----------------------------*/
    function mintUnity(uint256 nMints, address _recipient)
        external
        payable
        checkMint(nMints, isPublicMintActive, unityPrice, SaleStates.PUBLIC)
    {
        mint(_recipient, nMints, tokenIdUnity);
        tokenIdUnity = tokenIdUnity + nMints;
        emit Minted(_recipient, nMints);
    }

    function mintMindful(uint256 nMints, address _recipient)
        external
        payable
        checkMint(nMints, isPublicMintActive, mindfulPrice, SaleStates.PUBLIC)
    {
        mint(_recipient, nMints, tokenIdMindful);
        tokenIdMindful = tokenIdMindful + nMints;
        emit Minted(_recipient, nMints);
    }
    ...
    function setMindfulPrice(uint256 _price) external onlyOwner {
        mindfulPrice = _price;
    }
