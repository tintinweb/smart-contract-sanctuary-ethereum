...
contract Synthia is Ownable, ERC721Enumerable {
  ...
  uint16 public constant MAX_PER_WALLET = 5;
  uint16 public totalClaimed; // public + WL
  uint16 public boundary = 333; // random based on this

  uint256 public constant MINT_PRICE = 0.2 ether;

  // 14/11 1800 est
  uint256 public whitelistSalesStart = 1668463200;
  // 15/11 1800 est
  // public start is same as whitelist end
  uint256 public publicSalesStart = 1668549600;
  ...
  function whitelistMint(
    ...
    require(whitelistSalesStart <= block.timestamp && block.timestamp < publicSalesStart, "Sales inactive");
