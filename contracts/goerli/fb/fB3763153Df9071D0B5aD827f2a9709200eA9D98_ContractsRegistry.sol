...
import "./helpers/AccessControlUpgradeable.sol";
...
contract ContractsRegistry is IContractsRegistry, AccessControlUpgradeable {
    ...
    Networks public override currentNetwork;

    bytes32 public constant REGISTRY_ADMIN_ROLE = keccak256("REGISTRY_ADMIN_ROLE");

    bytes32 public constant AMM_ROUTER_NAME = keccak256("AMM_ROUTER");
    bytes32 public constant AMM_DEIN_TO_ETH_PAIR_NAME = keccak256("AMM_DEIN_ETH_PAIR");
    ...
    bytes32 public constant DEIN_STAKING_NAME = keccak256("DEIN_STAKING");
    bytes32 public constant DEINNFT_STAKING_NAME = keccak256("DEINNFT_STAKING");
    ...
    bytes32 public constant DEIN_TREASURY_NAME = keccak256("DEIN_TREASURY");
    ...
    bytes32 public constant DEIN_NAME = keccak256("DEIN");
    ...
    bytes32 public constant REWARD_POOL_NAME = keccak256("REWARD_POOL");
    bytes32 public constant COMPOUND_POOL_NAME = keccak256("COMPOUND_POOL");
    ...
    bytes32 public constant DEMAND_BOOK_NAME = keccak256("DEMAND_BOOK");
    bytes32 public constant DEMAND_BOOK_LIQUIDITY_NAME = keccak256("DEMAND_BOOK_LIQUIDITY");

    bytes32 public constant SWAP_EVENT_NAME = keccak256("SWAP_EVENT");
    bytes32 public constant VESTING_NAME = keccak256("VESTING");
    ...
    function __ContractsRegistry_init(Networks _network) external initializer {
    ...
    function getAMMDEINToETHPairContract() external view override returns (address) {
        return getContract(AMM_DEIN_TO_ETH_PAIR_NAME);
    }
    ...
    function getDEINContract() external view override returns (address) {
        return getContract(DEIN_NAME);
    }
    ...
    function getDEINTreasuryContract() external view override returns (address) {
        return getContract(DEIN_TREASURY_NAME);
    }
    ...
    function getRewardPoolContract() external view override returns (address) {
        return getContract(REWARD_POOL_NAME);
    }

    function getCompoundPoolContract() external view override returns (address) {
        return getContract(COMPOUND_POOL_NAME);
    }
    ...
    function getDEINStakingContract() external view override returns (address) {
        return getContract(DEIN_STAKING_NAME);
    }

    function getDEINNFTStakingContract() external view override returns (address) {
        return getContract(DEINNFT_STAKING_NAME);
    }
    ...
    function getDemandBookContract() external view override returns (address) {
        return getContract(DEMAND_BOOK_NAME);
    }

    function getDemandBookLiquidityContract() external view override returns (address) {
        return getContract(DEMAND_BOOK_LIQUIDITY_NAME);
    }

    function getSwapEventContract() external view override returns (address) {
        return getContract(SWAP_EVENT_NAME);
    }

    function getVestingContract() external view override returns (address) {
        return getContract(VESTING_NAME);
    }
    ...
    function configureNetwork(Networks _network) public onlyAdmin {
        currentNetwork = _network;
    }
}
...
/**
 * COPIED FROM https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/blob/release-v3.4/contracts/access/AccessControlUpgradeable.sol
