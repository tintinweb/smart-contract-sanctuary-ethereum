    ...
    ERC721AUpgradeable
{
        ...
        returns (address signer)
    {
        ...
        // "MintRequest(address userAddress,uint256 mintNumber,uint256 nftPrice,address paymentToken,uint128 validityStartTimestamp,uint128 validityEndTimestamp)"
...
interface IClaimCondition {
     ...
     *                                        condition.
     *
     *  @param price                  The price required to pay per token claimed.
     *
     *  @param paymentToken                       The paymentToken in which the `price` must be paid.
     *
...
abstract contract SignatureMintERC721Upgradeable is Initializable, EIP712Upgradeable, ISignatureMintERC721 {
    ...
    function _processRequest(MintRequest calldata _req, bytes calldata _signature) internal view returns (address signer) {
        bool success;
        ...
        require(_req.mintNumber > 0, "0 qty");
