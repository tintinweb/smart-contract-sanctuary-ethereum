...
contract ERC721Staking is ERC721Holder, ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 public periodFinish = 1679304642; // Mon Mar 20 2023 09:30:42 GMT+0000
    uint256 public rewardRate = 166666666666666666; // 10 tokens in a minute
    ...
    modifier updateReward(address account) {
        rewardPerTokenStored = rewardPerToken() * 1e18;
        lastUpdateTime = lastTimeRewardApplicable();
        if (account != address(0)) {
            rewards[account] = earned(account) * 1e18;
