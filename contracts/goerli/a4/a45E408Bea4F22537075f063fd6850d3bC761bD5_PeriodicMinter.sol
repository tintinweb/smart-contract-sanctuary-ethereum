...
contract PeriodicMinter is AccessControl, Pausable, ReentrancyGuard, BidManager, BidVerifier {
    ...
    uint256 public mintsRemaining = 500; // TODO - Find better way to test
    ...
    constructor(string memory name) BidVerifier(name) {
        ...
        _factory = IERC721Abstract(0x639946bDdBB11258C8830e4aA48a05e14EF61CE1);
    ...
    function createBid(
        ...
        if (!hasValidBids()) auctionEndTime = block.timestamp + 300;
