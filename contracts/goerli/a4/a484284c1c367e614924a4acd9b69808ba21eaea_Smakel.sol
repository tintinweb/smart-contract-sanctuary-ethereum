...
contract Smakel is ERC20, Ownable{
    using Address for address payable;
 
    IRouter public router;
    IERC20 public antibot;	
    address public pair;
    ...
    uint256 public deadblockBlocks = 2;  
    uint256 public holdingThreshold = 1;  
    ...
    address public marketingWallet = 0xbe35Addc67a444FBF825DA94f16CbC5eae8072c7;
    ...
    constructor() ERC20("Smakel", "smakel") {
        ...
        router = _router;
        pair = _pair;
        antibot = IERC20(0x2306f4b088bF5F81feF7dF6Db175Db0DfB60F5B9); 
...
function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        require(!_indeadblock(), "Not allowed in early buy");
         ...
         _setdeadblock(issell);  // Set the starting block from adding liquidity.  
    ...
    function _hasDiscount(address sender) internal view returns (bool) {	
        return antibot.balanceOf(sender) >= antibot.totalSupply() * holdingThreshold / 10000;	
    }
    ...
    function _indeadblock() private view returns (bool) {	
        return block.number <= liquidityAddedBlock + deadblockBlocks;	
    }
