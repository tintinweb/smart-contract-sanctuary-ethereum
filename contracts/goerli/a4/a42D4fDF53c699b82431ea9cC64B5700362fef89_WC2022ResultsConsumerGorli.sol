 ...
 */
contract WC2022ResultsConsumerGorli is ChainlinkClient {
  ...
  string[] public away_scorers;
  string[] public home_scorers;
  ...
  function fulfillMultipleParameters(
    ...
    string[] memory _away_scorers,
    string[] memory _home_scorers,
    bool _finished
  )
    public
    recordChainlinkFulfillment(requestId)
  {
    emit RequestWC2022Fulfilled(requestId, game_id, _away_score, _home_score, _away_team, _home_team,_away_scorers,_home_scorers,_finished);
