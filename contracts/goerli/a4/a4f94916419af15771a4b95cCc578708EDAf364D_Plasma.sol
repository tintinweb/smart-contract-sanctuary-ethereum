...
import '../interfaces/IRootToken.sol';
/*
...
contract Plasma is ERC20, AccessControlMixin, NativeMetaTransaction, ContextMixin, IMintableERC20, IRootToken {
     ...
     * @dev See {IMintableERC20-mint}.
     */
    function publicMint(address user, uint256 amount) external override only(MINTER_ROLE) {
        _mint(user, amount);
    }
