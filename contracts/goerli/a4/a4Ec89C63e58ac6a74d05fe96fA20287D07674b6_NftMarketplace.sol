...
error NftMarketplace__NotApprovedForMarkeplace();
...
contract NftMarketplace is ReentrancyGuard {
    ...
    function listItem(
        ...
        //2.owner can still hold their nft, and give the marketplace the approval to sell the nft for them.

        IERC721 nft = IERC721(nftAddress);
        if (nft.getApproved(tokenId) != address(this)) {
            revert NftMarketplace__NotApprovedForMarkeplace();
        }
