...
// Chainling Oracle -> Randomness, Automated Execution (Chainlink Keepers)
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
     ...
     * The following hshould be true in order to return true
     * 1. Our time interval should have passed
     * 2. lottery should have at least one participant
    ...
    function checkUpkeep(bytes memory /* checkData */) public view override returns (bool upkeepNeeded, bytes memory /* performData */) {
        ...
        bool timePassed = ((block.timestamp - s_lastTimestamp) > i_interval); // feels like s_lastTimestamp isn't being updated 
