 ...
 * @notice It is protected from minting/burning except by an assigned role.
 * @notice This is a sub contract for the BetMatchupWithLP app.
 * @notice Accesshandler is Initializable.
 */
contract LPToken is ILPToken, ERC20, AccessHandler {

    /**
     * @notice Simple constructor, just sets the admin
     */
    constructor() Initializable() ERC20("LP Token", "LPT") {
     ...
     */
    function initialize(address tokenHandler)
        public
        notInitialized
     ...
     *         Replaces default burn to protect the owner from accidental
     *         burning, the owner can still transfer the tokens though.
     ...
     *         Replaces default burnFrom to protect the owner from accidental
     *         burning, the owner can still transfer the tokens though.
