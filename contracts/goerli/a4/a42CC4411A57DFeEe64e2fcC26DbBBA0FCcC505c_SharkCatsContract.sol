...
//  `--. \ '_ \ / _` | '__| |/ / | |    / _` | __/ __| | | | | | __ 
// /\__/ / | | | (_| | |  |   <  | \__/\ (_| | |_\__ \ \ \_/ / |_\ \
// \____/|_| |_|\__,_|_|  |_|\_\  \____/\__,_|\__|___/  \___/ \____/
//                                                                  
//                                                                  
//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1674001980;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xaDA37f634E9261DFd044c9Be8d8da2890A49C5Ce];
  address public erc20Payable = 0xaDA37f634E9261DFd044c9Be8d8da2890A49C5Ce;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 0.0127 ether;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 25, 2500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihdm73r2ldl3lcwfnqlbfxv4rx4pwubiygogooot7px663sbbx7eu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/YXQIZlj1Ig1pS6DG5x4t/contract-metadata";
  }
...
// File: contracts/SharkCatsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SharkCatsContract is RamppERC721A {
    constructor() RamppERC721A("Shark Cats", "SharkCats"){}
}
