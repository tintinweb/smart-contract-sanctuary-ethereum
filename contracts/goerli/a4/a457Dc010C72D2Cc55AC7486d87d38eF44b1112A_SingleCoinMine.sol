...
contract SingleCoinMine is Ownable {
    ...
    // 映射:某挖矿对某质押用户是否自动将收益转成本金来挖矿:
    mapping(string => mapping(string => mapping(address => bool))) private autoTransformMap;
    ...
    // 查询某挖矿对某用户是否自动将收益转化为本金来挖矿
    function queryAutoTransformOrNot(
        string memory _stakeSymbol,
        string memory _rewardSymbol,
        address _address     
        ) public virtual view returns(bool) {
        return(_queryAutoTransformOrNot(_stakeSymbol, _rewardSymbol, _address));
    }
    ...
    function stake(
        ...
        _stake(_stakeToken, _rewardToken, _amount, _autoTransform);
    }
    ...
    // 内部辅助函数,用来查询某挖矿对某用户是否自动将收益转化为本金来挖矿:
    function _queryAutoTransformOrNot(
        string memory _stakeSymbol,
        string memory _rewardSymbol,
        address _address
        ) public virtual view returns(bool) {
        ...
        return(autoTransformMap[_stakeSymbol][_rewardSymbol][_address]);
    }
    ...
    function _stake(
        ...
        // 更新对应的信息(包括份额,质押人信息,是否要自动将收益转为本金挖矿):
        _updateStakeInfo(_stakeSymbol, _rewardSymbol, _amount, _staker, _autoTransform);
    ...
    function _updateStakeInfo(
        ...
        // 更新是否自动将收益转为本金挖矿:
        autoTransformMap[_stakeSymbol][_rewardSymbol][_staker] = _autoTransform;
    }
