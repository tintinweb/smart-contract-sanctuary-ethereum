...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xce325f8e7A2B3632D77d3E6028a35562ee0486B8];
...
// File: contracts/GoerliCreativesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract GoerliCreativesContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Goerli CREATIVES";
    string public symbol = "CREATIVES";
