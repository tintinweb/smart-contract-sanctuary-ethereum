...
contract FuelBridgeReceiver is IFuelBridgeReceiver {
    ...
    constructor(address rootToken_, address stakingContract_) {
    ...
    function transferToStakers() external override {
        ...
        rootToken.transfer(stakingContract, rootTokenBalance_);
...
interface IFuelBridgeReceiver {
    /**
     * @notice Emitted when childToken is burnt for the Polygon PoS withdrawal.
