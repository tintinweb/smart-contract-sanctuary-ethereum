 ...
 */
abstract contract ERC721A is Context, DefaultOperatorFilterer, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
...
// File: contract/y00tsAnchorClub.sol
...
contract Y00tsAnchorClub is ERC721A, Ownable, ReentrancyGuard {
  ...
  Iy00tsYachtClub public oldContract;
  address public communityWallet = address(0x9c3Ce8721a275C9C1e14aBEfdCC16d973FCA3c21);
  ...
  function setApprovalForAll(address operator, bool approved) public override onlyAllowedOperatorApproval(operator) {
    ...
    function getYYCBelongingToOwner(address _owner) internal view returns (uint256[] memory) {
