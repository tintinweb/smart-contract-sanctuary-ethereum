...
contract BakedBuds is ERC721A, ERC2981, Ownable, Pausable, PaymentSplitter {
    ...
    uint256 public maxQuantityForPresale = 5;
    ...
    uint256 private _reservedTokensAmount = 10;
    ...
    function publicMint(uint256 quantity) external payable whenNotPaused {
        ...
        require(msg.value == publicPrice * quantity, 'NonEqualValue');
        _mintToken(quantity);
    }
        ...
        whenNotPaused
    {
        ...
        require(msg.value == presalePrice * quantity, 'NonEqualValue');
    ...
    function setPresalePrice(uint256 amount) external onlyOwner {
        presalePrice = amount;
    }
