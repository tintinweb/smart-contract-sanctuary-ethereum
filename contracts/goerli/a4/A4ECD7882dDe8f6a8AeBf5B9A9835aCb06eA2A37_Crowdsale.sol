...
contract Crowdsale is Ownable {
    ...
    uint256 public constant VESTING_DURATION = 365 days; // The period of time (in seconds) over which the vesting occurs
    uint256 public startTime = 0; // The timestamp of activation, when vesting begins
