...
contract LittleMutants is AccessControl, ERC2981, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ReentrancyGuard {
    ...
    uint256 public MINT_TRANSACTION_LIMIT;
    ...
    constructor(
        ...
        //pauses minting until whitelist sale begins. can never be paused again
        // _pause();
    }
    ...
    function mint(uint256 amount) external payable nonReentrant {
        ...
        require( supply + amount <= COLLECTION_SIZE, "Exceeds maximum supply" );
