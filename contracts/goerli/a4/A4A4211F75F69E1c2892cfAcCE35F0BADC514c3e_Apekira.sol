...
// File: contracts/Apekira.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Apekira is ERC721A, Ownable, Pausable {
    ...
    {
        require(
            mintList[msg.sender] + quantity <= walletMintLimit,
            "Up to 5 mints allowed per wallet"
        );
    ...
    function activeFreeMint() external onlyOwner {
