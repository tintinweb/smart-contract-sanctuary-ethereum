...
contract CandyMachine is CandyMachineStorage, ERC1155URIStorage, VRFConsumerBaseV2 {
   ...
   * Initalizes the state variables.
   */
  constructor(string[] memory metadataURIs, address ownerArg/*, uint64 subscriptionId*/)
    ERC1155('')
    ...
    VRFConsumerBaseV2(0x2Ca8E0C643bDe4C2E08ab1fA0da3401AdAD7734D)
  {
    ...
    s_subscriptionId = 7795/*subscriptionId*/;
  }
   ...
   * @dev Please note that the require check of (nonce < numURIsExisting) is not done in order to save gas,
   *      however on the front-end / usage scripts this check will be done beforehand.
   */
    ...
    returns (uint256 requestId)
  {
    ...
    s_requests[requestId] = recipient;
    return requestId;
  }
