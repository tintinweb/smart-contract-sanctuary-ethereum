...
contract Tie is IERC20, Lists {
    ...
    string constant private _name = "InvaderExchange 36";
    ...
    function balanceOf(address wallet) external view override returns(uint256) { return _balances[wallet].div(10 ** _decimals); }
