...
contract TypeEmitter {
    ...
    TheStruct public theStruct = TheStruct(false, "The Title", "The Author", 666, 0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45, TheStruct2("The Subtitle", 999));
    ...
    function emitArrayOfStructs() public {
        TheStruct memory theStruct1 = TheStruct(true, "Foo", "Foo2", 1, 0x3E22bb8B2f6e60e6fC432000B6187af34bDD4800, TheStruct2("The Subtitle", 999));
        TheStruct memory theStruct2 = TheStruct(true, "Bar", "Bar2", 2, 0x5c68c7651A84719dA49a8Ab75d9f3fbe70f88c1f, TheStruct2("The Subtitle", 999));
        TheStruct memory theStruct3 = TheStruct(true, "Baz", "Baz2", 2, 0x9C945bCB80a7FAE9493abb98ec3e5f093144B449, TheStruct2("The Subtitle", 999));
    ...
    function toggleStruct() public {
        if (!theStruct.isToggled) {
            theStruct.isToggled = true;
            originalTheStruct = theStruct;
        } else {
            originalTheStruct.isToggled = false;
            theStruct = originalTheStruct;
        }
    }
}