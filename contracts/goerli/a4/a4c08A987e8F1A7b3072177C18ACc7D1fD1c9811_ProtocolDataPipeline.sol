...
interface IDebtToken is IERC20Metadata {
  ...
  /// @notice Emitted when the state of the debt token is updated
  /// @param totalSupply The updated total supply of the debt token
  /// @param timestamp The timestamp when the state of the debt token is updated
  event UpdateDebtTokenState(
    uint256 totalSupply,
    uint256 timestamp
  );
