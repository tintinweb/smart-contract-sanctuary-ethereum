 ...
 * address.
 */
contract PublicResolver is Multicallable, ABIResolver, AddrResolver, ContentHashResolver, DNSResolver, InterfaceResolver, NameResolver, PubkeyResolver, TextResolver, Ownable {
    MarsCard Marscard;
    ...
    constructor(MarsCard _Marscard, INameWrapper wrapperAddress){
        Marscard = _Marscard;
    ...
    function isAuthorised(bytes32 node) internal override view returns(bool) {
        address owner = Marscard.owner(node);
...
abstract contract ABIResolver is IABIResolver, ResolverBase {
    ...
    /**
     * Sets the ABI associated with an MetaCard node.
...
abstract contract AddrResolver is IAddrResolver, IAddressResolver, ResolverBase {
    ...
    /**
     * Sets the address associated with an MetaCard node.
     * May only be called by the owner of that node in the MetaCard registry.
     * @param node The node to update.
...
abstract contract ContentHashResolver is IContentHashResolver, ResolverBase {
    ...
    /**
     * Sets the contenthash associated with an MetaCard node.
     * May only be called by the owner of that node in the MetaCard registry.
     * @param node The node to update.
...
abstract contract NameResolver is INameResolver, ResolverBase {
    ...
    /**
     * Sets the name associated with an MetaCard node, for reverse records.
     * May only be called by the owner of that node in the MetaCard registry.
     * @param node The node to update.
     */
...
abstract contract PubkeyResolver is IPubkeyResolver, ResolverBase {
    ...
    /**
     * Sets the SECP256k1 public key associated with an MetaCard node.
     * @param node The MetaCard node to query
...
abstract contract TextResolver is ITextResolver, ResolverBase {
    ...
    /**
     * Sets the text data associated with an MetaCard node and key.
     * May only be called by the owner of that node in the MetaCard registry.
     * @param node The node to update.
