    ...
    ReentrancyGuard
{
        ...
        internal
    {
        ...
        emit ValidatorParted(validatorPubKey, from, transferTimestamp);

        _joinPool(validatorPubKey, to, transferTimestamp);
        emit ValidatorJoined(validatorPubKey, to, transferTimestamp);
...
interface IStakefishTransactionFeePoolV2 {
    ...
    event ValidatorTransferred(bytes indexed validatorPubkey, address indexed from, address indexed to, uint256 timestamp);
...
contract StakefishTransactionStorageV2 {
    ...
    mapping(address => IStakefishTransactionFeePoolV2.UserSummary) internal users;
    ...
    IStakefishTransactionFeePoolV2.ComputationCache internal cache;
