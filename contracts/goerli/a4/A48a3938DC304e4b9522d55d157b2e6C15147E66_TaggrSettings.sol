...
// TODO: Convert to Upgradeable Contract
  ...
  BlackholePrevention
{
  ...
  function getMembershipFee() public view override returns (uint256) {
    return membershipFee;
  }

  function getProjectLaunchFee() public view override returns (uint256) {
    return projectLaunchFee;
  }

  function getMembershipFeeToken() public view override returns (address) {
    return membershipFeeToken;
  }

  function getProjectLaunchFeeToken() public view override returns (address) {
...
interface ITaggr {
  ...
  function launchNewProject(string memory projectId, string memory projectName, string memory projectSymbol, uint256 contractType, uint256 maxSupply, uint96 royaltiesPct) external;
}
