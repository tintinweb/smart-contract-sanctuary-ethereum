...
contract NFTExchange is ExchangeInterface, IERC721Receiver, NFTExchangeLayout {
    ...
    /**
     * @notice Close the given order and Open a new one.
     */
    function reopen(bytes32 orderHash) external override nonReentrant {
        _close(orderHash, false, true);
    }
...
interface ExchangeInterface {
    ...
    ///
    function reopen(bytes32 orderHash) external;
