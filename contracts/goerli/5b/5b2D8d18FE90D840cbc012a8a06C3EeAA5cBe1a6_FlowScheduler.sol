...
contract FlowScheduler is IFlowScheduler, SuperAppBase {
    ...
    //ID = KECCAK(sender, receiver, superToken) => FlowSchedule(startDate, startDateValidFor, endDate, flowRate)
    ...
    function createFlowSchedule(
        ...
        if (sender == address(0) || receiver == address(0) || receiver == sender) revert AccountInvalid();
