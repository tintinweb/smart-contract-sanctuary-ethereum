...
contract NFTContract is ERC721, Pausable, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    bool public sale;
    bool public preSale;
 ...
 // start presale for minting for 4 days 
    function mintNFT(address _address, uint256 quantity) public payable returns (uint256){
    ...
    function checkClaimEligibility(uint256 quantity) external view returns (string memory){
        ...
        } else if (totalSupply + quantity > 1000) {
