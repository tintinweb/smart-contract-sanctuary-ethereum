...
contract SevenDAYNFT is ERC721A, Ownable {
    uint256 public MAXSUPPLY = 9504;
    uint256 public MintSupply = 1920;
    ...
    address public treasury = 0x37eAB6100016E6527629B13488e85eFD8773F620;
    ...
    constructor()
        ERC721A("SevenDAYNFT", "7N")
    {
        merkleRoot = 0xc415801bdae002fd56f61e89f86f53985ce62542e5fbf7f51fdf1edc3af5755d;
        uriPrefix = "ar://ruwoIvbk7oLa87xKUTd-_DY4MGJ6UR8iWEE3egRkfOI/";
    }
    ...
    function setTreaTury(address _treasury) external onlyOwner {
        treasury = _treasury;
    }
