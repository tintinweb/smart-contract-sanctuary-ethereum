...
///////#@&***************@&..,,[email protected]*********&@///////////////////////////////////
/////@@#&***************@#%@@@@************@@///////////////////////////////////
contract LoserClubTest is ERC721A, Ownable {
  // general
  ...
  constructor() payable ERC721A('LoserClubTest', 'LOSERCLUBTEST') {
    // maxSupply = 5555;
    maxSupply = 5;
    maxPerTxnPublic = 5;
    ...
    maxPerTxnAllowlistOg = 3;
    maxPerWalletAllowlistOg = 3;
    publicSaleTime = 1646514000; // (March 5, 9:00 PM UTC) // @todo set real publicSaleTime
    allowlistSaleTime = 1646427600; // (March 4, 9:00 PM UTC) // @todo set real allowlistSaleTime
    allowlistOgSaleTime = 1646427600; // (March 4, 9:00 PM UTC) // @todo set real allowlistOgSaleTime
