...
contract LgoAuctionFactory is Ownable {
    ...
    function createAuction(
        ...
        LgoDutchAuction _newAuction = new LgoDutchAuction(
            ...
            admin,
            treasury);
        IAuctionTreasury(treasury).transferLGO(msg.sender, address(_newAuction), _totalTokens);
...
interface IAuctionTreasury {
    ...
    function transferLGO(address from, address _to, uint256 _amount) external;
