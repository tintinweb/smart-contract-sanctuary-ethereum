...
contract TESTINGV95686 is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public MAX_SUPPLY = 222;
    uint256 public MAX_PUBLIC_SUPPLY = 155;
    uint256 public MAX_PUBLIC_MINT = 2;
    uint256 public MAX_WHITELIST_MINT = 1;
    uint256 public PUBLIC_SALE_PRICE = .0001 ether;
    ...
    constructor() ERC721A("TESTINGV95686", "TEST") {}
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity)
        ...
        payable
    {
        require(stage == MintStage.WHITELIST, "Whitelist sale is not active yet.");
        require(
