...
contract Composable is Ownable, ERC721URIStorage, ReentrancyGuard{
    ...
    */
    ...
    function generateNFTMusic(address to, uint256 value, string memory nameSample_, string memory tokenURI_) public payable virtual{ //public payable virtual means that you are allowed to pay the contract to execute this function. 
