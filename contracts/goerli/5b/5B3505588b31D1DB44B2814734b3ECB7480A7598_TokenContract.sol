...
contract TokenContract is DefaultOperatorFilterer, ITokenContract, AccessControl, ERC721Royalty {
...
/// @notice Contract will be deployed multiple times with different symbols and names to form part of the claiming and droping system
...
interface ITokenRegistry is IGrtWines {
  ...
  /// @dev Token URIs may only be updated oncem, and this function will call {lockBatchMetadata}
  /// @dev Only accessible to TOKEN_CONTRACT_ROLE
