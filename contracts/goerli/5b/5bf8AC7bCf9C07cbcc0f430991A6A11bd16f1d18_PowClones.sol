...
contract PowClones is Ownable, ERC721A, ERC721APausable {
    ...
    address payable public fundsWallet = payable(0x9a41cc7Cf4Ba03811656BfF4847Bfdd43fdb3B81);
    address payable public devWallet = payable(0x6C79c92168aD985A1399c9D2974e7378F9451048);
    ...
    function mintOperation(address to, uint256 count) internal {
        ...
        if (totalMinted.add(count) > maxFree){
            ...
            uint dev = (msg.value.mul(2)).div(10);
            (bool success, ) = devWallet.call{ value: dev}("");
            (bool success2, ) = fundsWallet.call{ value: msg.value.sub(dev) }("");

            require(success, "Address: unable to send value, recipient may have reverted");
            require(success2, "Address: unable to send value2, recipient may have reverted");
        }
