...
contract Buffer is ReentrancyGuard {
    ...
    address public owner = 0x54A6534BD00Ae984380e77074f86cb867430CCF2;
    uint256 public immutable royaltyFeePercent = 1000;
    uint256 private immutable montageShare = 1000;
    address public immutable marketWallet = 0x54A6534BD00Ae984380e77074f86cb867430CCF2; 
    ...
    function addValidPayee(address _newPayee, bytes32 _validDest, address _dest) external onlyOwner onlyGoodAddy {
