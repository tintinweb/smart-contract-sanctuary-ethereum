...
error Raffle__raffleNotOpen(uint256 current_raffleState);
error Raffle__upkeepNotNeeded(
    uint256 numPlayers,
    uint256 current_balance,
    uint256 current_raffleState
);
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function raffleEnter() public payable {
        ...
        if (s_raffleState != RaffleState.OPEN) {
            revert Raffle__raffleNotOpen(uint256(s_raffleState));
        }
    ...
    function getCurrentRaffleState() public view returns (RaffleState) {
