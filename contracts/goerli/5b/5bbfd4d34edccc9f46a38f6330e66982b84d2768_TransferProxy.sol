...
contract TransferProxy is Ownable {
  ...
  function sendETH(uint256 amount, address payable recipient, bytes32 id) public payable {
  ...
  function sendERC20(address tokenAddress, uint256 amount, address recipient, bytes32 id) public {
