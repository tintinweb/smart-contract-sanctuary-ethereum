...
contract Distributor is Context, Ownable, Pausable, EIP712DataValidator, ReentrancyGuard {
    ...
    function distributePrizes(bytes calldata data) external nonReentrant {
        ...
        cyopContract.transfer(results.luckyUser, cycleFunds[results.cycleIndex].luckyUserAmount);
    }
    ...
    function _transferTokenReward(
        ...
        require(path[path.length - 1] == tokenAddress, "INVALID_PATH_OR_TOKEN_ADDRESS");
    ...
    function _transferPrize(
        ...
        if (isToken) {
            ...
            cyopContract.transfer(winnerAddress, amount);
        }
    }
