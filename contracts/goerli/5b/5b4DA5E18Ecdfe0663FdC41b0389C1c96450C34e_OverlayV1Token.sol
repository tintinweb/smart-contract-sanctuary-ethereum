...
contract OverlayV1Token is IOverlayV1Token, AccessControlEnumerable, ERC20("Overlay", "OVL") {
    constructor() {
        address foundation = 0xbaC7c53f0d9Edcf2EFE81a2e546EA4CA54276355;
        _grantRole(DEFAULT_ADMIN_ROLE, foundation);
        _grantRole(GUARDIAN_ROLE, foundation);
        _grantRole(GOVERNOR_ROLE, foundation);
        _mint(foundation, 8000000000000000000000000);
    }
