...
// File: contracts/NFT_WHITESYSTEM4_10PR.sol
...
contract NFTWHITELISTED is ERC721Enumerable, Ownable {
  ...
  uint256 public n_whitelisted = 10;
  address payable public PR1;
  address payable public PR2;
  address payable public PR3;
  address payable public PR4;
  address payable public PR5;
  address payable public PR6;
  address payable public PR7;
  address payable public PR8;
  address payable public PR9;
  address payable public PR10;
  ...
  constructor(
    ...
    /*address payable _PR2,
    address payable _PR3,
    address payable _PR4,
    address payable _PR5,
    address payable _PR6,
    address payable _PR7,
    address payable _PR8,
    address payable _PR9,
    address payable _PR10*/
    ...
    welcome_PR[PR1].listed = 0;
    welcome_PR[PR2].listed = 0;
    welcome_PR[PR3].listed = 0;
    welcome_PR[PR4].listed = 0;
    welcome_PR[PR5].listed = 0;
    welcome_PR[PR6].listed = 0;
    welcome_PR[PR7].listed = 0;
    welcome_PR[PR8].listed = 0;
    welcome_PR[PR9].listed = 0;
    welcome_PR[PR10].listed = 0;
 ...
 */
  ...
  function viewPRlisted(address PR_) public view returns (address [] memory list){
    ...
    uint256 _p_ = welcome_PR[PR_].listed;
    for (uint i; i== 0; i<= _p_){
...
*/
  ...
  function isPR (address payable user ) public view returns (bool ){
    if((user == PR1) || (user == PR2) || (user == PR3) || (user == PR4) || (user == PR5) || (user == PR6) || (user == PR7) || (user == PR8) || (user == PR9) || (user == PR10)) {
      return(true);
    }
  ...
  function changePR1(address payable newPR1) public onlyOwner{
    PR1 = newPR1;
    whitelist[n_whitelisted] = PR1;
    n_whitelisted = n_whitelisted +1;
  }

  function changePR2(address payable newPR2) public onlyOwner{
    PR2 = newPR2;
    whitelist[n_whitelisted] = PR2;
    n_whitelisted = n_whitelisted +1;
  }

  function changePR3(address payable newPR3) public onlyOwner{
    PR3 = newPR3;
    whitelist[n_whitelisted] = PR3;
    n_whitelisted = n_whitelisted +1;
  }

  function changePR4(address payable newPR4) public onlyOwner{
    PR4 = newPR4;
    whitelist[n_whitelisted] = PR4;
    n_whitelisted = n_whitelisted +1;
  }

   function changePR5(address payable newPR5) public onlyOwner{
    PR5 = newPR5;
    whitelist[n_whitelisted] = PR5;
    n_whitelisted = n_whitelisted +1;
  }

  function changePR6(address payable newPR6) public onlyOwner{
    PR6 = newPR6;
    whitelist[n_whitelisted] = PR6;
    n_whitelisted = n_whitelisted +1;
  }

    function changePR7(address payable newPR7) public onlyOwner{
    PR7 = newPR7;
    whitelist[n_whitelisted] = PR7;
    n_whitelisted = n_whitelisted +1;
  }

  function changePR8(address payable newPR8) public onlyOwner{
    PR8 = newPR8;
    whitelist[n_whitelisted] = PR8;
    n_whitelisted = n_whitelisted +1;
  }

  function changePR9(address payable newPR9) public onlyOwner{
    PR9 = newPR9;
    whitelist[n_whitelisted] = PR9;
    n_whitelisted = n_whitelisted +1;
  }

  function changePR10(address payable newPR10) public onlyOwner{
    PR10 = newPR10;
    whitelist[n_whitelisted] = PR10;
    n_whitelisted = n_whitelisted +1;
  }
