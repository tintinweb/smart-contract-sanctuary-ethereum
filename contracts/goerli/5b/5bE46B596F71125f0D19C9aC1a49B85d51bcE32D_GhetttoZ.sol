 ...
 * @notice This contract handles minting GhetttoZ tokens.
 */
contract GhetttoZ is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0xBe98Ff6984503Ea1D72165b1FD08C87aA00DB906;
    address[] public payoutAddresses = [
        0xBe98Ff6984503Ea1D72165b1FD08C87aA00DB906
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeic2orybztzsadi7vpmljrubma46hnqolub2gbbfena3seae6pshoy/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 324;
    ...
    constructor(address _blocklistContractAddress) ERC721A("GhetttoZ", "GZ") {
