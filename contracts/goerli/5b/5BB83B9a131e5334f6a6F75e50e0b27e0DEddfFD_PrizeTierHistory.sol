...
/**
 * @title  Asymetrix Protocol V1 IPrizeTierHistory
 * @author Asymetrix Protocol Inc Team
...
/**
 * @title  Asymetrix Protocol V1 PrizeTierHistory
 * @author Asymetrix Protocol Inc Team
...
contract PrizeTierHistory is Initializable, IPrizeTierHistory, Manageable {
    ...
    */
    ...
    function __PrizeTierHistory_init_unchained(
        address _owner
    ) internal onlyInitializing {
    ...
    function getPrizeTier(
        uint32 drawId
    ) external view override returns (PrizeTier memory) {
    ...
    // @inheritdoc IPrizeTierHistory
    function push(
        PrizeTier calldata nextPrizeTier
