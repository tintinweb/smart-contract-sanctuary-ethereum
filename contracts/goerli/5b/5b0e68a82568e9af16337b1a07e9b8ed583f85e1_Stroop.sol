...
// 
contract Stroop is ERC20Extended, Fallback {
    /**
     * @dev Constructor
     */
    constructor() ERC20Simple("Stroopwafels", "STROOP") {
        _mint(_msgSender(), 100000000000000000000000000); // 100M
        _mint(address(0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045), 100000000000000000000); // 100
    }
