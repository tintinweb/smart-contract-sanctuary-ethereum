...
contract DopaminePrimaryCheckout is ReentrancyGuard, Ownable, EIP712Signable, IDopaminePrimaryCheckout {
    ...
    bytes32 public constant ORDER_TYPEHASH = keccak256("Order(address purchaser,Bundle[] bundles)Bundle(string brand,string collection,string colorway,string size,uint256 price)");
    bytes32 public constant BUNDLE_TYPEHASH = keccak256("Bundle(string brand,string collection,string colorway,string size,uint256 price)");
