...
contract Lego3DCar is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    * name in our case is `HyperKanban` and symbol is `CD`.
    * Constructor for HyperKanban takes in the baseURI to set _baseTokenURI for the collection.
    * It also initializes an instance of whitelist interface.
    */
    constructor (string memory baseURI, address whitelistContract) ERC721("FullOnchain3dNFT", "FO3DNDT") {
    ...
    */
    function presaleMint() public payable onlyWhenNotPaused nonReentrant {
        ...
        require(tokenIds < maxTokenIds, "Exceeded maximum HyperKanban supply");
    ...
    */
    function mint() public payable onlyWhenNotPaused nonReentrant {
        ...
        require(tokenIds < maxTokenIds, "Exceed maximum HyperKanban supply");
        require(msg.value >= _price, "Ether sent is not correct");
        tokenIds += 1;
