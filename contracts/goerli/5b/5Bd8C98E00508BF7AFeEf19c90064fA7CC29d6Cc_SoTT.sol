...
//  ............................................................................................
    ...
    function TimeTravelerMint (bool whitelisted, uint256 nonce, bytes memory signature) external payable {
        ...
        if (whitelisted) {
            ...
            if (msg.value < 100000000000000000) { // minimum 0.1 ether
    ...
    function checkLockAndSale() external view returns (bool TransferLocked, bool saleOpen) {
        return (quantumStorage.TransferLocked, quantumStorage.SaleOpen);
    }
    ////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////// Overrides /////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////
