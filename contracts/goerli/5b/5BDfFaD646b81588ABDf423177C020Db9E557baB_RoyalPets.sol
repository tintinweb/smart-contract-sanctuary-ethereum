...
contract RoyalPets is ERC721URIStorage, ERC2981, DefaultOperatorFilterer, Ownable {
  ...
  function mintNFTWithRoyalty(address recipient, string memory tokenURI, address royaltyReceiver, uint96 feeNumerator)
    ...
    function contractURI() public pure returns (string memory) {
      uint256 basisPoint = 100;
      address receiver = address(0x3AB8866082dcef761FB61F48aaBe7C5741fae889);
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    basisPoint.toString(),
                    // solium-disable-next-line quotes
                    ', "payout_address": "', // solhint-disable-line quotes
                    uint256(uint160(receiver)).toHexString(20),
                    // solium-disable-next-line quotes
