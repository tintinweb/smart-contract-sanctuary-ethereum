...
//    CharExtraStats[] public charExtraStats;
...
//    function rollExtraStats(uint256 tokenId) public {
//        // roll attribute data
////        string memory style = DiceUtilities.rollToStyle(DiceUtilities.dieRoll(50));
////        parts[8] = DiceUtilities.rollToStyle(DiceUtilities.dieRoll(50));
//
...
//
//        charExtraStats[tokenId].style = style;
//    }
...
//        string memory style = DiceUtilities.rollToStyle(DiceUtilities.dieRoll(50));
//        parts[8] = DiceUtilities.rollToStyle(DiceUtilities.dieRoll(50));
//        parts[8] = charExtraStats[id].style;
...
//                    ', {"trait_type": "Style", "value": ', parts[8],'}'
//                    ', {"trait_type": "Style", "value": "myStyle"}'
...
//            addedUp += uint8(uint256(keccak256(abi.encodePacked(randomValue, i, tx.gasprice))) % die + 1);
    ...
    function rollToStyle(uint roll) internal pure returns (string memory) {
        return CyborgTables.getStyle(roll);
    }
    ...
    function rollToFeature(uint roll) internal pure returns (string memory) {
        return CyborgTables.getFeature(roll);
    }
    ...
    function rollToObsession(uint roll) internal pure returns (string memory) {
        return CyborgTables.getObsession(roll);
    }
    ...
    function rollToWants(uint roll) internal pure returns (string memory) {
        return CyborgTables.getWants(roll);
    }
    ...
    function rollToQuirk(uint roll) internal pure returns (string memory) {
        return CyborgTables.getQuirk(roll);
    }
