...
contract NFTOptimize is ERC721, Ownable, INFT {
    ...
    // [    14 bit    |      14 bits     | 50 bits |  178 bits ]
    // [ MSB                                               LSB ]
    bytes32 private _nftState;
    uint256 private constant _TOTAL_SUPPLY_OFFSET = 242;
    uint256 private constant _CURRENT_TOKEN_ID_OFFSET = 228;
    uint256 private constant _MINT_PRICE_OFFSET = 178;
...
interface INFT {
    ...
    function MINT_PRICE() external returns (uint256);
