...
contract AdvancedNFT is ERC721EnumerableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    uint256 public publicSaleNftPrice; // ex: 80000000000000000 wei => 0.08 ETH
    ...
    function mintNft(uint256 _ammount) external payable nonReentrant {
        ...
        require(sellingStep == Steps.NotStarted, "Sale has not started yet.");
