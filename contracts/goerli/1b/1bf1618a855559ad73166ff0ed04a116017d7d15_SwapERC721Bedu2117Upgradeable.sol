...
contract SwapERC721Bedu2117Upgradeable is Initializable, ContextUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // Use `trustedRecipientAddress` in claiming
    bool private _useTrustedRecipientAddressInClaiming;
    ...
    // Emitted when flag `useTrustedRecipientAddressInClaiming` updated
    event UseTrustedRecipientAddressInClaimingUpdated(bool status);
    ...
    function config() external view virtual returns (
        ...
        bool useTrustedRecipientAddressInClaiming
    ) {
        return (
            ...
            _useTrustedRecipientAddressInClaiming
        );
    }
    ...
    function updateUseTrustedRecipientAddressInClaiming(bool status_) external virtual onlyOwner {
        _useTrustedRecipientAddressInClaiming = status_;
        emit UseTrustedRecipientAddressInClaimingUpdated(status_);
    }
    ...
    function _claimToken(
        ...
        _sendEthToTrustedRecipientAddress(ethAmount_);
        // mint erc721 tokens
    ...
    function _sendEthToTrustedRecipientAddress(uint256 ethAmount_) internal virtual {
        if (_useTrustedRecipientAddressInClaiming && ethAmount_ != 0 && _trustedRecipientAddress != address(0)) {
            AddressUpgradeable.sendValue(payable(_trustedRecipientAddress), ethAmount_);
        }
    }
}
