...
contract TestPresale is Ownable, ReentrancyGuard {
    ...
    constructor() {
        collectedFunds = payable(address(0x7F00A7a76BbA39eb95c21530b2Bfee5b53678c09));
        saleActive = false;
        claimStarted = false;
        currentTier = 1;
        startTime = 0;
    ...
    function endSale() external onlyOwner {
        require(saleActive);
        require(block.timestamp >= endTime, "Sale End Time: INVALID_VALUE");
        saleActive = false;
