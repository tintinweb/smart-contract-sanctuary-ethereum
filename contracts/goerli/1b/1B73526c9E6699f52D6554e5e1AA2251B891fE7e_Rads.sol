 ...
 * @notice This contract handles minting Rads tokens.
 */
contract Rads is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    address public royaltyAddress = 0xC1A783d1FD04D9d8fb6B996e6092baBAC9F32BFa;
    address[] public payoutAddresses = [
        0xC1A783d1FD04D9d8fb6B996e6092baBAC9F32BFa
    ];
    bool public isPublicSaleActive = false;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeidl5gruxhk63ao6mdmufgwszokvlfkt5ljssl2gg7csj6us2rmchq/";
