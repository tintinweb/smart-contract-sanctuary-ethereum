...
contract testBSAPE is Context, IERC20, Ownable {
  ...
  uint256 public _maxTxAmount = _tTotal.mul(5).div(100); // 0.5%
  uint256 public _maxWalletSize = _tTotal.mul(10).div(100); // 2.0%
  uint256 public _maximumBuyAmount = _tTotal.mul(5).div(100); // 0.3%
