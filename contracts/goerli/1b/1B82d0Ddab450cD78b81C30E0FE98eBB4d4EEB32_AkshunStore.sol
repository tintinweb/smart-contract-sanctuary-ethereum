...
contract AkshunStore is OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, Signable {
    ...
    function initialize(address payable _treasury, IAkshun _akshun)
        public
        initializer
    {
        __Ownable_init();
        ...
        nonReentrant
    {
        ...
        require(msgSender.balance > akshunTier.price * _quantity, "AskhunNFT: Not enough ETH");

        treasury.transfer(akshunTier.price * _quantity);
