...
contract golors is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public PRICE = 0.005 ether; //for the airdrop in 24 hours after mint. shhh!
    uint256 public MAX_SUPPLY = 777; 
    uint256 public FREE_MINT_LIMIT_PER_WALLET = 1; 
    uint256 public MAX_MINT_AMOUNT_PER_TX = 10; 
    uint256 public FREE_MINT_IS_ALLOWED_UNTIL = 100;
    ...
    string public notRevealedUri = "ipfs://bafybeidr32lrvfinulx6buxe7quttvygo43yp4hnqeo4thtll3t6qamww4"; 
    
    mapping(address => uint256) private freeMintCountMap;

    constructor() ERC721A("4eonverse", "4eon") {}
    ...
    returns (string memory)
  {
    ...
    // withdraw address
  address t1 = 0x98ff1C68DbE759F3fc772563bF786DcF80dbcd16; 
