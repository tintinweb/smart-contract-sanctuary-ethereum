...
contract IndeliblePro is ERC721, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("IndeliblePro", "INDELIBLE") {}
    ...
    function setChunksCount(uint count)
        external
        onlyOwner
    {
        _chunks = new address[](count);
    }
    ...
    function setOCKAddress(address ockAddress) external onlyOwner {
        OnChainKevin = IERC721(ockAddress);
    }
