...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    uint private constant DEVELOPER_FEE = 1000; // of 10,000
    ...
    string[] private layerNames = [unicode"Background", unicode"Skin", unicode"Shirt", unicode"Eyes", unicode"Face", unicode"Mouth", unicode"Head"];
    ...
    string private placeholderImage = "undefined/placeholder/3236b899-80e0-4c5c-b5a5-95d1a94cfa22";
    ...
    ContractData public contractData = ContractData(unicode"SurpriseReveal", unicode"My surprise reveal", "undefined/profile/3236b899-80e0-4c5c-b5a5-95d1a94cfa22", "undefined/banner/3236b899-80e0-4c5c-b5a5-95d1a94cfa22", "", 0, "0x47E1c3ce1418893d681741abFeb87040d0149661");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"SurpriseReveal", unicode"SURPVEAL") {
        tiers[0] = [54,53,18,16,14,13,9,8,8,4,3];
        tiers[1] = [90,73,37];
        tiers[2] = [34,32,28,19,13,13,12,10,9,7,6,5,5,4,2,1];
        tiers[3] = [67,63,30,15,11,11,3];
        tiers[4] = [61,21,16,16,11,11,11,9,8,8,8,7,6,4,2,1];
        tiers[5] = [58,33,31,23,19,15,11,5,4,1];
        tiers[6] = [27,27,23,18,15,11,11,11,10,10,10,10,5,4,3,2,2,1];
