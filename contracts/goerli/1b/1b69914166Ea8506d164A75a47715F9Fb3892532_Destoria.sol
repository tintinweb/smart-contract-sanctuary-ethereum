...
contract Destoria is ERC721A, Promos {
    ...
    constructor() ERC721A("Destoria", "Destoria") {}
    ...
    function mintPublic(uint256 _amount) external payable {
        ...
        uint256 newWalletTokensAmount = tokensPerWallet[msg.sender].add(
            _amount
        );
        require(newWalletTokensAmount <= maxPerWallet, "Max per wallet");

        tokensPerWallet[msg.sender] = newWalletTokensAmount;
