...
contract L_Monkey is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    constructor() ERC721("L_Monkey", "LM") {}

    function safeMint(address to, string memory uri) public {
        require(to == _msgSender(), "Wrong mint address");
        require(_tokenIdCounter.current() <= MAX_SUPPLY, "I'm sorry we reached the cap");
        require(balances[to] < 5, "One person can mint up to 5 NFTs");
