    ...
    ReentrancyGuard
{
    ...
    IERC20 public immutable EDT_TOKEN; //staking token
    uint256 public immutable MIN_EDT_TOKEN = 1 ether;
    address public winner;
    uint256 public duration = 691200; // 1 week + 1 day
    struct UserData {
        bool isParticipant; 
    ...
    constructor(
        ...
        EDT_TOKEN = bob_token_address;
    }

    function getTokensBack() external onlyOwner nonReentrant {
        EDT_TOKEN.transfer(msg.sender, EDT_TOKEN.balanceOf(address(this)));
    }
    ...
    function execute() external nonReentrant {
        ...
        require(EDT_TOKEN.transferFrom(msg.sender, address(this), MIN_EDT_TOKEN), "transfer failed");
