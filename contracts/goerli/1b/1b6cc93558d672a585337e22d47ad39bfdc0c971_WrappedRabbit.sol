...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 USDC = IERC20(0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C);
...
contract WrappedRabbit is IERC20, Auth {
    ...
    uint256 public _maxTxAmount = 10000e9; // 1%
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        if(inSwap){ return _basicTransfer(sender, recipient, amount); }
         ...
         if(!isTxLimitExempt[recipient]) {
            require(_maxTxAmount >=  balanceOf(recipient).add(amount), "ERC20: maxAmount >= amount");
        }
        //
