...
abstract contract BasePool is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function addLiquidity(
        ...
        if (token != UniERC20.ETH) {
            ...
            require(msg.value == amount, "Pool: invalid value sent");
        }
    ...
    function removeLiquidity(
        ...
        require(lastMint[msg.sender] + redeemCooldown <= block.timestamp, "BasePool: redeem is cooling down");
        ...
        require(outAmount >= minOut, "BasePool: slippage reached");
    ...
    function _swap(
        ...
        require(priceIn > 0 && priceOut > 0, "Pool: price not available");
        uint256 amountIn = _getAmountIn(_tokenIn);
        // TODO: calculate fee
        uint256 amountOut = (amountIn * priceIn) / priceOut;
        require(amountOut >= _minOut, "Pool: less than min amount out");
    ...
    function _addLiquidity(
        ...
        require(lpAmount >= minLpAmount, "BasePool: >slippage");
        lastMint[to] = block.timestamp;
