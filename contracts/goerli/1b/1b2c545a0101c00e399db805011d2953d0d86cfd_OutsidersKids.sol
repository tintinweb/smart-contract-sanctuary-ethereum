...
contract OutsidersKids is ERC721A, Ownable {
  ...
  string public uriPrefix = "ipfs://QmPEEBexPNKhCTPeZcB68KGHPot5msjXMGu5jEC38uurhE/";
  ...
  //Cost for Whitelist Mint is 0.08 eth
   uint256 public WLcost = 0.08 ether;
  //Cost will be 0.1 for Public Mint
 ...
 // Max Mints
  ...
  function mintPublic(uint256 _mintAmount) public payable {
   ...
   require( _mintAmount <= maxMintPublic , "Exceeds Max mint Per Wallet!");
