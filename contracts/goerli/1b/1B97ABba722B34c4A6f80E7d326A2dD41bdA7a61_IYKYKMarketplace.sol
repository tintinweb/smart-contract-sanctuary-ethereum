...
contract IYKYKMarketplace is ERC1155Holder, ERC721Holder{
    ...
    function addERC1155(uint256 tokenId, address contractAddress, uint256 amount, uint256 price) public onlyOwner {
        require(erc1155Contract.balanceOf(msg.sender, tokenId) >= amount, "Sender doesnt have the specified amount of tokens");
    ...
    function buyToken(uint256 tokenId, address contractAddress) public {
        ...
        require(paymentToken.transferFrom(msg.sender, owner, listings[index].price), "Payment token transfer failed");
