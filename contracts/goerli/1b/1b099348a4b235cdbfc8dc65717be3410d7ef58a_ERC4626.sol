...
/// @author Solmate (https://github.com/transmissions11/solmate/blob/main/src/mixins/ERC4626.sol)
   contract ERC4626 is ERC20 {
    ...
    function transferFundsBackFromStrategy() public onlyStrategy()
    {
        ...
        asset.safeApprove(address(this), balanceOfStrategy); //Approve this address to transfer the strategy's balance
        asset.safeTransferFrom(msg.sender, address(this), balanceOfStrategy); //transfer from the strategy (msg.sender) to this contract, all of the strategy's assets
        _updateUnderlying(); //Update the underlying value in this contract.
    }

    //Function for strategy to transfer all funds to this vault, update underlying AND open interactions
    //Theoretically this should work because sequential but if not...it can always be done using top option
