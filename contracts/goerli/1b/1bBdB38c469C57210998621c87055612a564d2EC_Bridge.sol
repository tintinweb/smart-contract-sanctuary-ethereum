...
contract Bridge is Ownable {
    ...
    function deposit(
        ...
        payload[0] = l2OwnerAddress;
        payload[1] = uint256(uint160(l1TokenAddress));
        payload[2] = tokenId;
        payload[3] = strToUint(symbol);
        payload[4] = strToUint(name);

        // payload[6] = strToUint("https://screenshot.co/m/1");
