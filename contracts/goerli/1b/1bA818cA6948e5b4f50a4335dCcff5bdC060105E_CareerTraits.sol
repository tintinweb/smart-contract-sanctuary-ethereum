...
contract CareerTraits is ERC721, ERC721Enumerable, Ownable {
    ...
    struct Attr {
        string name;
        string careerDiscipline;
        string careerRoleType;

    }

    constructor() ERC721("Career Traits", "CAREER TRAITS") {}
        ...
        string memory json = Base64.encode(
            bytes(string(
                abi.encodePacked(
                    ...
                    '"image_data": "', getSvg(), '",',
                    '"attributes": [{"trait_type": "Career Discipline", "value": "', attributes[tokenId].careerDiscipline, '"},',
                    '{"trait_type": "Career Role Type", "value": "', attributes[tokenId].careerRoleType, '"}',
                    ']}'
                )
            ))
        );
