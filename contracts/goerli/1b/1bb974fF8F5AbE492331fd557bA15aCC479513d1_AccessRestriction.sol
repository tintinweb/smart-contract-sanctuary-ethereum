...
contract AccessRestriction is
    ...
    IAccessRestriction
{
    bytes32 public constant WORLDCUP_CONTRACT_ROLE = keccak256("WORLDCUP_CONTRACT_ROLE");
    ...
    /// @inheritdoc IAccessRestriction
    function ifWolrdcupContract(address _address) external view override {
        require(isWolrdcupContract(_address), "Caller not worldcup contract");
    }
    ...
    /// @inheritdoc IAccessRestriction
    function isWolrdcupContract(address _address)
        public
        view
        override
        returns (bool)
    {
        return hasRole(WORLDCUP_CONTRACT_ROLE, _address);
    }
