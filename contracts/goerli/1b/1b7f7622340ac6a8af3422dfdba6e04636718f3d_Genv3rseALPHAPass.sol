...
contract Genv3rseALPHAPass is ERC721A, ERC2981, Ownable, Pausable, ReentrancyGuard {
    ...
    function ownerMint(uint256 amount) external nonReentrant onlyOwner {
        require(amount <= reservedSupply, "You cannot mint more than reservedSupply tokens.");
