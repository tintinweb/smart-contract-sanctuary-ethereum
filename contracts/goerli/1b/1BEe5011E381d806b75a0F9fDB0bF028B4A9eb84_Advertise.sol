...
contract Advertise is ERC721, ReentrancyGuard, Ownable {
	...
	function tokenURI(uint256 tokenId) public view override returns (string memory) {
		...
		bytes memory json = abi.encodePacked(
			'{"name": "',
			string(abi.encodePacked("Receipt #", Strings.toString(tokenId))),
		...
		return
			string(
				abi.encodePacked(
					...
					");--sub:hsl(",
					subColor,
					');}svg{font-family:"din";font-size:45px;letter-spacing:-0.04em;fill:var(--sub);}.l{stroke:var(--sub);}.b{stroke-width:14;}.s{stroke-width:2;}@font-face{font-family:"din";src:url("',
					font.base64(),
					'")format("woff2")};</style><rect width="1080" height="1080" fill="var(--main)"/><clipPath id="m"><rect width="1080" height="1080"/></clipPath><g clip-path="url(#m)"><text x="33" y="67">RECEIPT #',
					plusZero(tokenId),
