// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        uint public maxPerAddress = 3000;
        uint public publicMintPrice = 0.0000001 ether;
        string public baseURI = "";
        bool public isPublicMintActive;
        
        ContractData public contractData = ContractData(unicode"Middle Finger Floaty", unicode"Crypto-starter for Middle Finger Floaty.  Holders will be eligible to pre-order IRL product.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/e7e17b85-a3c8-41ff-96b0-6ff71a0d6565", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/e7e17b85-a3c8-41ff-96b0-6ff71a0d6565", "Middlefingerfloaty.com", 0, "0xA5726d993e48d5CAA1ae40fa1b76873AcBaA70cd");
...
TIERS[2] = [218,361,481,604,728,775,835,900,951,954,999,1032,1161];
TIERS[3] = [145,520,656,788,2157,2822,2911];
TIERS[4] = [16,24,88,478,2104,2176,2367,2746];
