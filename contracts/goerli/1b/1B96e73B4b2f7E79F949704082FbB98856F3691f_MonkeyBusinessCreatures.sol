...
contract MonkeyBusinessCreatures is ERC721Enumerable, ERC721Burnable, Ownable, AccessControl {
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 9500) {
            return 12000000000000000000; // 9000 - 9499 0.12 ETH
        } else if (currentSupply >= 9000) {
            return 10000000000000000000; // 7000 - 8999 0.1 ETH
        } else if (currentSupply >= 7000) {
            return 9000000000000000000; // 5000  - 6999 0.09 ETH
        } else if (currentSupply >= 5000) {
            return 8000000000000000000; // 5000 - 6999 0.08 ETH
        } else if (currentSupply >= 3000) {
            return 7000000000000000000; // 3000 - 4999 0.07 ETH
        } else if (currentSupply >= 1000) {
            return 6000000000000000000; // 1000 - 2999 0.06 ETH
        } else {
