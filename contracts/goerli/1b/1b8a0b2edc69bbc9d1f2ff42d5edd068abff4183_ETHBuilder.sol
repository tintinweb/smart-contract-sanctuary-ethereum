...
library Address{
 ...
 contract ETHBuilder is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x543a6482bCDAcC2E261771Ef2Fe5E321b3656121;
    address public donationWallet = 0x543a6482bCDAcC2E261771Ef2Fe5E321b3656121;

    string private constant _name = "ETHBuilder";
    string private constant _symbol = "ETHBuilder";
    ...
    Taxes public taxes = Taxes(0, 1, 2, 1);
    Taxes public sellTaxes = Taxes(0, 1, 2, 1);
