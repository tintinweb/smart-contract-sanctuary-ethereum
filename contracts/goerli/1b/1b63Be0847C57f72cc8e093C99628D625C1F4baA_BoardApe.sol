...
/*                                                                                                                                                                                
BBBBBBBBBBBBBBBBB        OOOOOOOOO                 AAA               RRRRRRRRRRRRRRRRR   DDDDDDDDDDDDD                            AAA               PPPPPPPPPPPPPPPPP   EEEEEEEEEEEEEEEEEEEEEE
B::::::::::::::::B     OO:::::::::OO              A:::A              R::::::::::::::::R  D::::::::::::DDD                        A:::A              P::::::::::::::::P  E::::::::::::::::::::E
B::::::BBBBBB:::::B  OO:::::::::::::OO           A:::::A             R::::::RRRRRR:::::R D:::::::::::::::DD                     A:::::A             P::::::PPPPPP:::::P E::::::::::::::::::::E
BB:::::B     B:::::BO:::::::OOO:::::::O         A:::::::A            RR:::::R     R:::::RDDD:::::DDDDD:::::D                   A:::::::A            PP:::::P     P:::::PEE::::::EEEEEEEEE::::E
  B::::B     B:::::BO::::::O   O::::::O        A:::::::::A             R::::R     R:::::R  D:::::D    D:::::D                 A:::::::::A             P::::P     P:::::P  E:::::E       EEEEEE
  B::::B     B:::::BO:::::O     O:::::O       A:::::A:::::A            R::::R     R:::::R  D:::::D     D:::::D               A:::::A:::::A            P::::P     P:::::P  E:::::E             
  B::::BBBBBB:::::B O:::::O     O:::::O      A:::::A A:::::A           R::::RRRRRR:::::R   D:::::D     D:::::D              A:::::A A:::::A           P::::PPPPPP:::::P   E::::::EEEEEEEEEE   
  B:::::::::::::BB  O:::::O     O:::::O     A:::::A   A:::::A          R:::::::::::::RR    D:::::D     D:::::D             A:::::A   A:::::A          P:::::::::::::PP    E:::::::::::::::E   
  B::::BBBBBB:::::B O:::::O     O:::::O    A:::::A     A:::::A         R::::RRRRRR:::::R   D:::::D     D:::::D            A:::::A     A:::::A         P::::PPPPPPPPP      E:::::::::::::::E   
  B::::B     B:::::BO:::::O     O:::::O   A:::::AAAAAAAAA:::::A        R::::R     R:::::R  D:::::D     D:::::D           A:::::AAAAAAAAA:::::A        P::::P              E::::::EEEEEEEEEE   
  B::::B     B:::::BO:::::O     O:::::O  A:::::::::::::::::::::A       R::::R     R:::::R  D:::::D     D:::::D          A:::::::::::::::::::::A       P::::P              E:::::E             
  B::::B     B:::::BO::::::O   O::::::O A:::::AAAAAAAAAAAAA:::::A      R::::R     R:::::R  D:::::D    D:::::D          A:::::AAAAAAAAAAAAA:::::A      P::::P              E:::::E       EEEEEE
BB:::::BBBBBB::::::BO:::::::OOO:::::::OA:::::A             A:::::A   RR:::::R     R:::::RDDD:::::DDDDD:::::D          A:::::A             A:::::A   PP::::::PP          EE::::::EEEEEEEE:::::E
B:::::::::::::::::B  OO:::::::::::::OOA:::::A               A:::::A  R::::::R     R:::::RD:::::::::::::::DD          A:::::A               A:::::A  P::::::::P          E::::::::::::::::::::E
B::::::::::::::::B     OO:::::::::OO A:::::A                 A:::::A R::::::R     R:::::RD::::::::::::DDD           A:::::A                 A:::::A P::::::::P          E::::::::::::::::::::E
BBBBBBBBBBBBBBBBB        OOOOOOOOO  AAAAAAA                   AAAAAAARRRRRRRR     RRRRRRRDDDDDDDDDDDDD             AAAAAAA                   AAAAAAAPPPPPPPPPP          EEEEEEEEEEEEEEEEEEEEEE
*/                                                                                                                                                                                  
 ...
 */
contract BoardApe is ERC721SeaDrop {
    /**
...
import {
    IERC165
} from "../node_modules/@openzeppelin/contracts/utils/introspection/IERC165.sol";

import {
    DefaultOperatorFilterer721
} from "./lib/DefaultOperatorFilterer721.sol";
