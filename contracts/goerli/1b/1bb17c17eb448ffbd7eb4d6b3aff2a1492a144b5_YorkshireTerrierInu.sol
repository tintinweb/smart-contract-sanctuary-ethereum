...
// Telegram: http://t.me/YorkieInuERC
// Twitter: https://twitter.com/YorkieInuERC

// Yorkshire Terriers, commonly known as Yorkies, are a small breed of dog 
// known for their long, silky hair and playful personalities. 

// Inspired by Clavell in attempt to create massive demand via supply shock.

// MEV-FREE,SANDWHICH-FREE, AND FRONT-RUN-FREE FUNCTIONALITIES INSIDE
...
contract YorkshireTerrierInu is ERC20, Ownable {
    ...
    constructor() payable ERC20("Not Terrier Inu", "Nothing") {
        ...
        MarketingAddr = payable(0x2bF5E500807F66f9aFe114bD038429C35bF32f4E);
