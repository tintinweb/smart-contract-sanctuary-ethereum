...
/// @title Community Token - v2
/// @notice Smart contract to store, generate and manage access token for BELLA Community Creator using ERC1155 standard
contract CommunityToken is ERC1155, AccessControl, ERC1155Burnable, ERC1155Supply, ReentrancyGuard, ERC1155Holder {

    // CT-ERR-1		Cannot remove approval to community token manager
    // CT-ERR-2		Community already generated
    // CT-ERR-3		Cannot set uri twice
    ...
    function setApprovalForAll(address operator, bool approved) public override {
        require(!hasRole(COMMUNITY_TOKEN_MANAGER_ROLE, operator), "CT-ERR-1");
    ...
    {
        require(communityIdToTokenId[communityId] == 0, "CT-ERR-2");
