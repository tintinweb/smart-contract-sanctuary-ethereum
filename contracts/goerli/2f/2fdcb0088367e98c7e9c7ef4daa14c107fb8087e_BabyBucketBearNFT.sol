...
contract BabyBucketBearNFT is DefaultOperatorFilterer, Ownable, AccessControl , ERC721A{

    constructor(
    ) ERC721A("BabyBucketBearNFT", "BBBNFT") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(MINTER_ROLE       , msg.sender);
        _setupRole(AIRDROP_ROLE      , msg.sender);
        setBaseURI("ipfs://QmZDtjnA528ZsvajLJfe5CgjerqiUKwVE4ZK8qpmit7z4H/");
        _safeMint(0x129eE29Cc8De925B51f390dDd69BC4B7c3343e28, 1); // あとで変更
    }
    ...
    address public constant withdrawAddress = 0x129eE29Cc8De925B51f390dDd69BC4B7c3343e28; // あとで変更
