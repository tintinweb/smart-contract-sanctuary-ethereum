...
contract MessagingAsset is Ownable {
    ...
    function mintAssetFromL2(
        ...
        uint256[] memory sender_payload = new uint256[](8);
        sender_payload[0] = l2TokenContractAddress;
        sender_payload[1] = l2_user;
        sender_payload[2] = uint256(keccak256(abi.encodePacked(_product_key)));
        sender_payload[3] = uint256(keccak256(abi.encodePacked(_area)));
        sender_payload[4] = uint256(keccak256(abi.encodePacked(_surface)));
        sender_payload[5] = _price;
        sender_payload[6] = uint256(keccak256(abi.encodePacked(_name_token)));
        sender_payload[7] = uint256(keccak256(abi.encodePacked(_symbol_token)));
