...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    // MetaData，就是上傳 Pinata Jsons 檔案的 CID
    string public baseURI =
        "ipfs://QmcPmK14MqmpSgyzkVtT8bQ3nwiCLEBH5CwRDf561DMSio";
    // 可以拿來暫停或者開啟 Mint
    ...
    constructor() payable ERC721("WoodElf", "Wood") {
        // 開始時先 Mint 一個
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "You can only adopt 1 BigBenFun at a time"
        );
        // Mint 的價格不可以少於自訂的價格
        require(
