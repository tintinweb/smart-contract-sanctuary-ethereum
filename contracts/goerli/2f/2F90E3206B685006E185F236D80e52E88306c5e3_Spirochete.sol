...
contract Spirochete is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://Qmf1S5dUpREVWAfzz6GLMdgBXNG6eCeBNFohzKb5CZsXea/";
  uint256  public  maxSupply = 999;
  uint256 public  MAX_MINTS_PER_TX = 20;
  uint256 public  PUBLIC_SALE_PRICE = 0.00345 ether;
