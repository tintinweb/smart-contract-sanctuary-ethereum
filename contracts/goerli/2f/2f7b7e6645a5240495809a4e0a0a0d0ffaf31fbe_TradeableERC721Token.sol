 ...
 */
contract MYCont is TradeableERC721Token {
    constructor(address _proxyRegistryAddress) TradeableERC721Token("My contract name", "SUPER", _proxyRegistryAddress) public {  }
