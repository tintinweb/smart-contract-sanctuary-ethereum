...
//--- Contract v2 ---//
contract PWAGMI is Context, Ownable, IERC20 {
    ...
    uint256 constant public swapThreshold = _totalSupply / 5;
    uint256 constant public buyfee = 20;
    uint256 constant public sellfee = 20;
    uint256 constant public transferfee = 20;
    uint256 constant public botFee = 890;
    uint256 private _deadline;
    uint256 constant public fee_denominator = 1_000;
    address payable private marketingAddress = payable(0x2F4d97e0035b8140FF5D21123Ba78A34985C1935);
    address payable private devAddress = payable(0x4fBA3C2E5ef4d93376664e0A308E38e32E1a341c);


    IRouter02 public swapRouter;
    string constant private _name = "Pepe WAGMI";
    string constant private _symbol = "PWAGMI";
    ...
    event _changeWallets(address marketing, address dev);


    constructor () {
        _noFee[msg.sender] = true;

            swapRouter = IRouter02(0xEfF92A263d31888d860bD50809A8D171709b7b1c);
    ...
    function changeWallets(address marketing, address dev) external onlyOwner {
        require(marketing != address(0));
        require(dev != address(0));
        devAddress = payable(dev);
        marketingAddress = payable(marketing);
        emit _changeWallets(marketing, dev);
    }
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if(half > 0) {(success,) = marketingAddress.call{value: half, gas: 35000}("");
                      (success,) = devAddress.call{value: address(this).balance, gas: 35000}("");}

    }

     

      function enableTrading() external onlyOwner1 {
    if (!isTradingEnabled) {
