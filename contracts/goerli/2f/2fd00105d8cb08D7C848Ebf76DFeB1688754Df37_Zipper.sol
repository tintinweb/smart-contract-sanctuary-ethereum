...
contract Zipper is ERC20, SimpleAccess {
    ...
    function _transfer(
        ...
        if (liquidityPair[from] && !noFee[to])
            ...
            transferAmount -= this.getSellTax(from, transferAmount);
    ...
    function createNewPair() internal onlyOwner {
        address myAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
