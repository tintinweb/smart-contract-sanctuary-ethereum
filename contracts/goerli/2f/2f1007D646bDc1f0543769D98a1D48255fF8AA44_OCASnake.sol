    ...
    function retrofy(uint256 tokenId) private view returns (string[20] memory) {
        ...
        for (uint256 i = 0; i < 20; i++) {
            parts[i] = funkToString(
                ...
                Strings.toString(
                    uint256(generateAppleSeed(tokenId, 0)) % uint256(128)
                ),
                uint256(generateAppleSeed(tokenId, i) + i)
            );
        }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        selectedColors[
                            uint256(generateAppleSeed(tokenId, 1)) % uint256(20)
                        ],
                        "'",
                        'onload="df=',
                        selectDifficulty(),
                        ...
                        selectedColors[
                            uint256(generateAppleSeed(tokenId, 2)) % uint256(20)
                        ],
                        "',z)(0);",
                        "G('",
                        selectedColors[
                        ...
                        selectedColors[
                            uint256(generateAppleSeed(tokenId, 5)) % uint256(20)
                        ],
