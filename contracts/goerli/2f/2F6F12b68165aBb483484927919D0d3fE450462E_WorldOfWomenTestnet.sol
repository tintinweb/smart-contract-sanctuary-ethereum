...
contract WorldOfWomen is ERC721, ERC721Enumerable, Ownable, Clubs {
    ...
    uint256 internal _price = 0.08 ether;
    ...
    function mint(uint256 _nbTokens) external payable virtual whenSaleStarted {
...
contract WorldOfWomenTestnet is WorldOfWomen {
    ...
    function mint(uint256 id) external payable override whenSaleStarted {
        uint _nbTokens = 1;
        uint256 supply = totalSupply();
        require(id <= maxSupply, "Too big ID");
        require(supply + _nbTokens <= maxSupply - _reserved, "Not enough Tokens left.");
