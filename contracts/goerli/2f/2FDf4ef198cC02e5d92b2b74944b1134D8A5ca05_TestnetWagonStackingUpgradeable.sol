...
contract TestnetWagonStackingUpgradeable is Initializable, PausableUpgradeable, ReentrancyGuardUpgradeable, AccessControlUpgradeable, UUPSUpgradeable  {
    ...
    modifier isAbleToUncompound() {
        ...
        uint256 day = BokkyPooBahsDateTimeLibrary.getDayOfWeek(block.timestamp);
        console.log("time: ", block.timestamp);
        console.log("day: ", day);

        require(day >= 6, "Unable to uncompound before the specified date.");
        _;
    }
    ...
    function getCurrentPeriod() public view returns (uint256) {
        ...
        uint256 diffDays = BokkyPooBahsDateTimeLibrary.diffDays(firstLockTime, timeNow);
        uint256 period = diffDays / 7;
    ...
    function removeAutoCompound(uint256 _amount) public isAbleToUncompound nonReentrant{
    ...
    function getLockTimePeriod(uint256 period) public view returns (uint256) {
        ...
        return BokkyPooBahsDateTimeLibrary.addDays(firstLockTime , (period - 1) * 7);
    }
