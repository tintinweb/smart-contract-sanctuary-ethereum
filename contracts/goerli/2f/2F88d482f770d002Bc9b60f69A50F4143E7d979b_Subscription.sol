...
contract Subscription {
    ...
    function getUser(address subscriber) external view returns (User memory) {
        return users[subscriber];
    }

    function checkMembership(address subscriber) external view returns (bool) {
        if (users[subscriber].expiryDate < block.timestamp) {
            return false;
        } else {
            return true;
        }
...
// 0x4B95a8B2658996f9834946aEecAf0b9a03cFA7bd
// 0x4B95a8B2658996f9834946aEecAf0b9a03cFA7bd