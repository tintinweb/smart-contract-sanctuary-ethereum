...
contract NFT001 is ERC2981, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    //For OpenSea royalty support
    ...
    function mintNFT(
        ...
        tokenCollaborator[newItemId] = _tokenCollaborator;
    ...
    function mintNFTWithCustomRoyalty(
        ...
        uint256 tokenId = mintNFT(_recipient, _tokenURI, _tokenCollaborator);
 ...
 */
    ...
    /**
     * @dev This function is called when the NFT is sold for first time.
        ...
        onlyOwner
    {
        ...
        address payable collaborator = payable(tokenCollaborator[tokenId]);
    ...
    /**
    * @dev This function is called when any streaming revenue is received for a token.  
