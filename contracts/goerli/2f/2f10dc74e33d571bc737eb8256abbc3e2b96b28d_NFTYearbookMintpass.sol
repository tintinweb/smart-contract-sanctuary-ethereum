...
contract NFTYearbookMintpass is ERC721A, Ownable, ReentrancyGuard{
...
// ================== Variables Start =======================
  ...
  string public hiddenMetadataUri = "ipfs://bafybeidfjdsrtws45wcfji5eq5e2ez2dl6g7qsly5zzkhragfyq63iufxy/1.json";
  ...
  uint256 public usdcwlprice = 1000000;  
...
// ================== Constructor Start =======================
  ...
  constructor(
    string memory _uri
  ) ERC721A("NFT Mintpass Test", "NFTMP")  {
    seturi(_uri);
  }
