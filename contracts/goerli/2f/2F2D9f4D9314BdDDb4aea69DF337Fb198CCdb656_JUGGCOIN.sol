...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C); //USDC
    address NATIVE = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6; //WETH
    IDEXRouter router;
...
contract JUGGCOIN is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARDS = 0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C; //USDC
    address NATIVE = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6; //WETH
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "JUGG COIN";
    string constant _symbol = "JUGG";
   ...
   function swapBack() internal swapping {
        uint256 dynamicLiquidityFee = isOverLiquified(targetLiquidity, targetLiquidityDenominator) ? 100 : liquidityFee;
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) external authorized {
