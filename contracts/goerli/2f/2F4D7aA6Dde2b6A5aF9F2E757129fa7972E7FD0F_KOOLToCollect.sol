    ...
    PullPayment
{
    ...
    bool public mintOncePerAddress;
        ...
        )
    {
        ...
        // dev things
        toggleMintOncePerAddress(false);
    }
    ...
    function toggleMintOncePerAddress(bool mintOncePerAddress_) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender));
        mintOncePerAddress = mintOncePerAddress_;
    }
    ...
    function mint(
        ...
        require(
            !(mintOncePerAddress && hasMinted(msg.sender, tokenId)),
