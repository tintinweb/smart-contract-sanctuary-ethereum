...
contract MockNFT is ERC721Enumerable,Ownable{
    ...
    uint256 public constant MAX_PURCHASE_TOKENS = 20;
    bool public saleIsActive = false;
    using SafeMath for uint256;
    
    constructor() ERC721("MockNFT", "MOCK NFT") {
        tokenCounter=0;
    }
    ...
    */
    ...
    function mintNFT(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens <= MAX_PURCHASE_TOKENS, string(abi.encodePacked("Can only mint ", MAX_PURCHASE_TOKENS," tokens at a time")));
