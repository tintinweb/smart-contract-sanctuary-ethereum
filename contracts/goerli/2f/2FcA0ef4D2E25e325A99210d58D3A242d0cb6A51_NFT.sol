...
contract NFT is ERC721A, IERC2981, Ownable, Pausable, ReentrancyGuard {

    using Strings for uint256;

    string public contractURIstr = "ipfs://xxxxxxxxxxxxxxxxxxxxxxxxx";
    string public notRevealedUri = "ipfs://xxxxxxxxxxxxxxxxxxxxxxxxx";
    ...
    uint256 public royalty = 55; // 55 is divided by 10 in the royalty info function to make 5.5%
    uint256 public constant NUMBER_RESERVED_TOKENS = 2050;
    uint256 public currentId = 0;
    uint256 public whitelistMint = 0;
    uint256 public reservedTokensMinted = 0;

    constructor() ERC721A("HGHJGHJG", "HGG") {
    }

    function mintWhitelist(bytes32[] calldata merkleProof, uint256 numberOfTokens) external payable
        isEOA
    ...
    function mintReservedToken(address to, uint256 numberOfTokens) external
    ...
    function setBaseURI(string memory _newBaseURI) public onlyOwner isNotFrozen {
        baseURI = _newBaseURI;
    }
    ...
    /// @dev Royalty should be added as whole number example 8.5 should be added as 85
    function updateSaleDetails(uint256 _royalty, uint256 _maxPerTransaction, uint256 _maxPerWallet, uint256 _mintPrice) external
        isNonZero(_royalty)
        isNonZero(_maxPerTransaction)
        isNonZero(_maxPerWallet)
        isNonZero(_mintPrice)
        onlyOwner
    {
        royalty = _royalty;
