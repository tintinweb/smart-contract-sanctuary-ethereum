...
contract DrawBuffer is IDrawBuffer, Manageable {
     ...
     */
    function initialize(address _owner, uint8 _cardinality)
        public
        virtual
        initializer
    {
    ...
    function __DrawBuffer_init_unchained(address _owner, uint8 _cardinality)
        internal
        onlyInitializing
    {
    ...
    /// @inheritdoc IDrawBuffer
    function setDraw(IDrawBeacon.Draw memory _newDraw)
        external
        override
        onlyOwner
        returns (uint32)
     ...
     * @return Draw.drawId
     */
    function _pushDraw(IDrawBeacon.Draw memory _newDraw)
        internal
        returns (uint32)
    {
