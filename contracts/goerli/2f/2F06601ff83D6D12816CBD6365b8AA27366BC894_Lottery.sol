...
contract Lottery is Ownable, VRFConsumerBaseV2 {
    ...
    event fulfilled(uint256 requestId, uint256 value);
    ...
    function fulfillRandomWords(
        ...
        lottery_state = LOTTERY_STATE.CLOSED;
        emit fulfilled(_requestId, randomWord);
    }
}
