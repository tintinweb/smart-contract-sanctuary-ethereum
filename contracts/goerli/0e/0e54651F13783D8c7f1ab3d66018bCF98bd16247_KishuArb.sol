...
contract KishuArb is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; // 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 uniswap
    ...
    constructor() ERC20("Kisha", "KISHA") {
        ...
        uint256 totalSupply = 12_345_678_912_345_678 * 1e18;

        maxTransactionAmount = 246_913_578_246_914 * 1e18; // 2% max txn
        maxWallet = 246_913_578_246_914 * 1e18; // 2% max wallet
        ...
        mktgWallet = address(0x460Cb02c09e1dDCbFb1E1eb34078A0a435bE1785); 
        devWallet = address(0x947bE92F7D572B6EA975be751C9e343C1Fe401f3); 
        liqWallet = address(0x460Cb02c09e1dDCbFb1E1eb34078A0a435bE1785); 
        operationsWallet = address(0x460Cb02c09e1dDCbFb1E1eb34078A0a435bE1785);
