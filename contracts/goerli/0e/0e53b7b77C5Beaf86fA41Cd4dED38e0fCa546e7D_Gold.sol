...
contract Gold is ERC721, PaymentSplitter, AccessControl, Ownable {
  ...
  function claimBonusPlates(uint256 tokenId, uint8 milestone) external {
    ...
    if (milestone == 1) {
      ...
      uint256 eligibleAt = lastTransferTimestamp + (6 * 30 hours);
    ...
    if (milestone == 2) {
      ...
      uint256 eligibleAt = lastTransferTimestamp + (12 * 30 hours);
    ...
    if (milestone == 3) {
      ...
      uint256 eligibleAt = lastTransferTimestamp + (24 * 30 hours);
    ...
    if (milestone == 4) {
      ...
      uint256 eligibleAt = lastTransferTimestamp + (60 * 30 hours);
    ...
    if (milestone == 5) {
      ...
      uint256 eligibleAt = lastTransferTimestamp + (120 * 30 hours);
    ...
    if (milestone == 6) {
      ...
      uint256 eligibleAt = lastTransferTimestamp + (240 * 30 hours);
