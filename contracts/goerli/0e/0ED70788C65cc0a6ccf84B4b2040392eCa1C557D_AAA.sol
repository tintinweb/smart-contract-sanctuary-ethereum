...
contract AAA is ERC721Enumerable, ReentrancyGuard, Ownable, DefaultOperatorFilterer {
    ...
    function pluck(
     ...
     function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 700 700"><style>.base { fill: #fff; font-family: sans-serif; font-size: 22px; font-weight: bold;}</style><rect width="100%" height="100%" fill="#0C0C0C" /><g transform="translate(0.000000,700.000000) scale(0.017500,-0.017500)" fill="#fff" stroke="none"><text x="50" y="460" class="base">';
