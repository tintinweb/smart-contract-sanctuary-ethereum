...
contract Tok is ERC20Burnable, Ownable {
    ...
    struct Fees {
        ...
        uint256 treasuryFeesPerTenThousand;
    ...
    uint _treasuryFeeBalance;
    uint _marketingFeeBalance;
    uint _LPFeeBalance;
    ...
    event TreasuryBuyFeesUpdated(uint256 previousFeesPerTenThousand, uint256 newFeesPerTenThousand);
    ...
    event BuyFeesUpdated(
        ...
        uint256 previousTreasuryFeesPerTenThousand, uint256 newTreasuryFeesPerTenThousand,
    ...
    event TreasurySellFeesUpdated(uint256 previousFeesPerTenThousand, uint256 newFeesPerTenThousand);
    event MarketingSellFeesUpdated(uint256 previousFeesPerTenThousand, uint256 newFeesPerTenThousand);
    event SellFeesUpdated(
        uint256 previousLiquidityFeesPerTenThousand, uint256 newLiquidityFeesPerTenThousand,
        uint256 previousTreasuryFeesPerTenThousand, uint256 newTreasuryFeesPerTenThousand,
        uint256 previousMarketingFeesPerTenThousand, uint256 newMarketingFeesPerTenThousand);
    event FeesSentToWallet(address indexed wallet, uint256 tokenAmount, uint256 busdAmount);
    event ExcludeFromFees(address indexed account, bool isExcluded);
    event SetAutomatedMarketMakerPair(address indexed pair, bool indexed value);
    event SwapAndLiquify(uint256 tokensSwapped, uint256 ethReceived, uint256 tokensIntoLiqudity);

    address public initialPairAddress;

    address _busd = 0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C;//0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;//0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    ...
    function buyFees() public view returns (
        ...
        return (
            ...
            _buyFees.treasuryFeesPerTenThousand,
    ...
    function totalBuyFees() public view returns (uint256) {
        return (
            _buyFees.liquidityFeesPerTenThousand
                .add(_buyFees.treasuryFeesPerTenThousand)
    ...
    function sellFees() public view returns (
        ...
        return (
            ...
            _sellFees.treasuryFeesPerTenThousand,
    ...
    function totalSellFees() public view returns (uint256) {
        return (
            _sellFees.liquidityFeesPerTenThousand
                .add(_sellFees.treasuryFeesPerTenThousand)
    ...
    function updateTeamWallet(address payable newWallet) external onlyOwner {
        require(newWallet != _treasuryWallet, "Token: The team wallet already has that address");

        address previousWallet = _treasuryWallet;
    ...
    function updateMarketingWallet(address payable newWallet) external onlyOwner {
        require(newWallet != _marketingWallet, "Token: The marketing wallet already has that address");
    ...
    function updateBuyFees (
        uint256 liquidityFeesPerTenThousand,
        uint256 treasuryFeesPerTenThousand,
        uint256 marketingFeesPerTenThousand) external onlyOwner {
        require(
            liquidityFeesPerTenThousand != _buyFees.liquidityFeesPerTenThousand ||
            treasuryFeesPerTenThousand != _buyFees.treasuryFeesPerTenThousand ||
            marketingFeesPerTenThousand != _buyFees.marketingFeesPerTenThousand, "Token: Buy fees has already the same values");
        ...
        uint256 previousTreasuryFeesPerTenThousand = _buyFees.treasuryFeesPerTenThousand;
        _buyFees.treasuryFeesPerTenThousand = treasuryFeesPerTenThousand;
        ...
        emit BuyFeesUpdated(
            ...
            previousTreasuryFeesPerTenThousand, treasuryFeesPerTenThousand,
    ...
    function updateLiquidityBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(feesPerTenThousand != _buyFees.liquidityFeesPerTenThousand, "Token: Liquidity buy fees has already the same value");
    ...
    function updateTreasuryBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(feesPerTenThousand != _buyFees.treasuryFeesPerTenThousand, "Token: Treasury buy fees has already the same value");

        uint256 previousfeesPerTenThousand = _buyFees.treasuryFeesPerTenThousand;
        _buyFees.treasuryFeesPerTenThousand = feesPerTenThousand;

        emit TreasuryBuyFeesUpdated(previousfeesPerTenThousand, feesPerTenThousand);
    }

   

    function updateMarketingBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(feesPerTenThousand != _buyFees.marketingFeesPerTenThousand, "Token: Marketing buy fees has already the same value");
    ...
    function updateSellFees (
        ...
        require(
            ...
            treasuryFeesPerTenThousand != _sellFees.treasuryFeesPerTenThousand ||
            marketingFeesPerTenThousand != _sellFees.marketingFeesPerTenThousand, "Token: Sell fees has already the same values");
        ...
        uint256 previousTreasuryFeesPerTenThousand = _sellFees.treasuryFeesPerTenThousand;
        _sellFees.treasuryFeesPerTenThousand = treasuryFeesPerTenThousand;
    ...
    function updateLiquiditySellFees(uint256 feesPerTenThousand) external onlyOwner {
        require(feesPerTenThousand != _sellFees.liquidityFeesPerTenThousand, "Token: Liquidity sell fees has already the same value");
    ...
    function updateTreasurySellFees(uint256 feesPerTenThousand) external onlyOwner {
        require(feesPerTenThousand != _sellFees.treasuryFeesPerTenThousand, "Token: Treasury sell fees has already the same value");

        uint256 previousfeesPerTenThousand = _sellFees.treasuryFeesPerTenThousand;
        _sellFees.treasuryFeesPerTenThousand = feesPerTenThousand;

        emit TreasurySellFeesUpdated(previousfeesPerTenThousand, feesPerTenThousand);
    }



    function updateMarketingSellFees(uint256 feesPerTenThousand) external onlyOwner {
        require(feesPerTenThousand != _sellFees.marketingFeesPerTenThousand, "Token: Marketing sell fees has already the same value");
    ...
    function _currentFees() private view returns (uint256, uint256, uint256, uint256) {
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(_isAutomatedMarketMakerPairs[newPair] != value, "Token: Automated market maker pair is already set to that value");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        require(!_isBlacklisted[sender] && !_isBlacklisted[recipient], 'Token: Blacklisted address');
        ...
        if (_shouldTakeFees(sender, recipient)) {
            ...
            uint256 lpFeeAmount = amount.mul(liquidityFeesPerTenThousand).div(10_000);
            uint256 marketingFeeAmount = amount.mul(marketingFeesPerTenThousand).div(10_000);
            uint256 treasuryFeeAmount = amount.mul(treasuryFeesPerTenThousand).div(10_000);
        	
            _marketingFeeBalance += marketingFeeAmount;
            _treasuryFeeBalance += treasuryFeeAmount;
            _LPFeeBalance += lpFeeAmount;
    ...
    function _shouldTakeFees(address sender, address recipient) private view returns (bool) {
        return
            ...
            sender != _treasuryWallet && recipient != _treasuryWallet &&
    ...
    function _shouldSwap(address sender, address recipient) private view returns (bool) {
        return
            !_inSwap &&
            _treasuryFeeBalance != 0 && _marketingFeeBalance != 0 && _LPFeeBalance != 0 &&
            sender != owner() && recipient != owner() &&
            sender != _treasuryWallet && recipient != _treasuryWallet &&
            sender != _marketingWallet && recipient != _marketingWallet &&
            (_isAutomatedMarketMakerPairs[sender] || _isAutomatedMarketMakerPairs[recipient]);
    ...
    function _swapSendFeesAndLiquify() private swapping {
        // Get total amount of token to swap to busd
        uint totalToSwap = _treasuryFeeBalance + _marketingFeeBalance;

        // Get initial balance of busd of contract
        uint256 initialBUSDBalance = IERC20(_busd).balanceOf(address(this));
        // Swap token to busd
        if(totalToSwap != 0 ){
            swapTokensForBusd(totalToSwap);
            uint256 newBalance = (IERC20(_busd).balanceOf(address(this))).sub(initialBUSDBalance);

            // Calculate amount of busd to transfer to wallets based on percentage in initial token amount
            uint treasuryBusd = newBalance.mul(_treasuryFeeBalance).div(totalToSwap);
            uint marketingBusd = newBalance.mul(_marketingFeeBalance).div(totalToSwap);
            
            // Transfer busd on wallets
            //IUSDT(_busd).approve(_treasuryWallet, treasuryBusd);
            //IUSDT(_busd).approve(address(this), treasuryBusd);
            IERC20(_busd).safeTransfer(_treasuryWallet, treasuryBusd);
            IERC20(_busd).safeTransfer(_marketingWallet, marketingBusd);
        }
        // Get number of busd swapped
        

        // Swap and add liquidity
        if(_LPFeeBalance != 0)
            swapAndLiquify(_LPFeeBalance);

        // Reset fee balances
        _treasuryFeeBalance = 0;
        _marketingFeeBalance = 0;
        _LPFeeBalance = balanceOf(address(this));
