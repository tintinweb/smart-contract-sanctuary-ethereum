...
{   
    ...
    constructor()
    { 
        Artists[0]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[1]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[2]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[3]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[4]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[5]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[6]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[7]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[8]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
        Artists[9]._MintPass = 0x08851a91bD8C26F2B2bDD5D08EF796CE6E9980d1;
    ...
    function _LiveMintArtist(uint ArtistID, uint[] calldata TicketIDs) external onlyMinter 
    {
        unchecked
        {
            ...
            {
                require(!MintedArtist[ArtistID][TicketIDs[TicketID]], "LiveMint: Artist Mint Pass Already Minted");
                address Recipient;
    ...
    {
        require(ArtistIDs.length == NewAddresses.length, "Arrays Must Be Of Equal Length");
