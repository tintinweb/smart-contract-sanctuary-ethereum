...
contract MMNERC721 is Context, ERC721{
    ...
    constructor(string memory name, string memory symbol, uint256 _maxSupply, uint256 _startTime, uint256 _endTime, uint256 _MMNID, uint _MaxPurchase, address _sOwnerAddr, address _sMMNAddr) ERC721(name, symbol) {
