...
contract AtomicSwapERC20 {
    ...
    function open(
        ...
        require(
            _erc20Value <= erc20Contract.allowance(msg.sender, address(this))
        );
        require(
            erc20Contract.transferFrom(msg.sender, address(this), _erc20Value)
        );
    ...
    function close(bytes32 _swapID, bytes memory _secretKey)
        public
    ...
    function check(bytes32 _swapID)
        public
        view
        returns (
            uint256 timelock,
    ...
    function checkSecretKey(bytes32 _swapID)
        public
        view
