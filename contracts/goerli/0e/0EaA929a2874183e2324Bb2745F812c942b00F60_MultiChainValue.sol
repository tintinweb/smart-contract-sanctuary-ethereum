...
import "@zetachain/protocol-contracts/contracts/evm/ZetaEth.sol";
...
contract MultiChainValue is Ownable {
    ...
    constructor(address _zetaConnector, address _zetaTokenInput) {
        zetaConnector = _zetaConnector;
        zetaToken = _zetaTokenInput;
        connector = ZetaConnector(_zetaConnector);
    }
