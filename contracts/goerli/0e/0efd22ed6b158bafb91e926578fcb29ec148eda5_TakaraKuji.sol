...
contract TakaraKuji is ERC20, Ownable, VRFConsumerBaseV2 {
  ...
  constructor(
    ...
    pickLotteryWinnerAtAmount = (totalSupply * 1) / 1000; // 0.1% from total supply (100_000_000) for pick a new lottery winner
  ...
  function swapBack() private {
    ...
    if (
      lotteryState == LotteryState.OPEN && lotteryTickets.length > 0 && totalLotteryTokens > pickLotteryWinnerAtAmount
    ) {
      requestRandomWinner();
    }
  ...
  function fulfillRandomWords(
    ...
    uint256 numTokens = totalLotteryTokens;
