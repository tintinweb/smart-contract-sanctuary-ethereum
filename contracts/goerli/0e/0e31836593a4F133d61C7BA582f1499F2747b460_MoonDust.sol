...
contract MoonDust is Ownable, ERC20 {
    ...
    uint256 public sellFee = 9000; // Leave it 900 to avoid mev bot
    ...
    constructor() ERC20("MoonDust", "$_LCK") {
        ...
        // uniswapV2Pair = IUniswapV2Factory(0x1715a3e4a142d8b698131108995174f37aeba10d).createPair(address(this), 0x00a1077a294dde1b09bb078844df40758a5d0f9a27);
    }
