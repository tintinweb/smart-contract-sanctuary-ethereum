...
contract RatRace is ERC721, Ownable {
  ...
  uint256 public whitelistedCost = 0.012 ether;
  uint256 public maxSupply = 1111;
  uint256 public maxFreeMint = 622; // -> what will be the maxFreeMint?
  uint256 public maxMintAmountPerTx = 3;
  uint256 public maxMintAmountPerTxWhitelist = 1;
  uint public allFreeMinted = 0;
  uint public maxMintPreWallet = 3;
  uint public maxMintPreWalletWhitelist = 1;
  ...
  constructor() ERC721("1969 Bulls", "RR") { // Symbol??
  ...
  * @param _mintAmount The number of NFTs to mint
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(isWhitelistminting || isPublicMinting, "Minting has not started");

    if(isWhitelistminting){
        require(_mintAmount <= maxMintAmountPerTxWhitelist);
        require(walletOfOwner(msg.sender).length + _mintAmount <= maxMintPreWalletWhitelist);
    }else{
  ...
  function airdrop() public onlyOwner{
    ...
    function setMinting(bool _whitelistStatus, bool _publicStatus) public onlyOwner{
        isWhitelistminting = _whitelistStatus;
        isPublicMinting = _publicStatus;
    }
  ...
  function setCost(uint256 _cost, uint _whitelistCost) public onlyOwner {
    cost = _cost;
    whitelistedCost = _whitelistCost;
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool os, ) = payable(0xE017be2d7375Af4bCD886686808302016BA56435).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
  }
