    ...
    DefaultOperatorFilterer
{
    ...
    */
    ...
    function burn(uint256[] calldata tokenIds) external {
        ...
        for (uint256 i; i < tokenIds.length; i++) {
            ...
            // calculate the burn reward
            uint256 burnReward = _calculateReward(i);
            burnRewards[msg.sender] += burnReward;
            userBurnTokens[msg.sender].push(i);
            burnData[i] = block.timestamp;
            Dori1776.transferFrom(msg.sender, burnAddress, i);
    ...
    */
        ...
        returns (uint256)
    {
        ...
        return (timeSinceStake * lockReward * 1e18) / 86400;
    }
