...
contract Loot is ERC721A, Ownable {
    ...
    string[] private weapons = [
        "Bu on-chain NFT ______'a girsin.",
        "Biyik burkula burkula, ______ sikile sile"
    ];
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Card #', toString(tokenId), '", "description": "tgbrk was here.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
