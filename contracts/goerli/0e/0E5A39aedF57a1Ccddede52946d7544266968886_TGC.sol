...
contract TGC is Context, IERC20, Ownable {
	...
	address public USDC = address(0x07865c6E87B9F70255377e024ace6630C1Eaa37F);
	IStaking public stakingContract = IStaking(0xE6fB748657bD99a02f46B6d63e37E1A0a012c6D1);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (canSwap && !swapping && _automatedMarketMakerPairs[to] && swapAndLiquifyEnabled) 
		{
			...
			_tokenTransfer(address(this), address(LPProviderAddress), otherHalf, false, false);
			LPProvider.provideLiquidity(USDCFinal, otherHalf);
			swapping = false;
        }
