...
interface Raffle {
    ...
    function finalGame() external returns (address[20] memory);
...
contract RaffleImpl is Ownable, Raffle {
    ...
    function enterRaffle() external payable opened {
        ...
        uint256 tokenId = ticketNft.mint(msg.sender, sumOfTicket);
        ticketsLeft -= 1;
...
contract Ticket is ERC721, Ownable {
    ...
    string baseUri = "https://veritty-backend.herokuapp.com/metadata/";
