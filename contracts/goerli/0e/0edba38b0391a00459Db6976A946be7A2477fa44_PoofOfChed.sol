...
contract PoofOfChed is ERC721A, Ownable, OperatorFilterer, MerkleProof {
    ...
    uint256 public chadlistMintPrice = 0.001 ether;
    uint256 public pbmintPrice = 0.002 ether;
    ...
    constructor() ERC721A("Poof of Ched", "POC") OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), true) {
