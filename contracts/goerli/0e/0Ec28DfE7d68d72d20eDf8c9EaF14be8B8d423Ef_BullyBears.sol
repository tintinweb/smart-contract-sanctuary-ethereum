...
contract BullyBears is ERC2981, ERC721A, Ownable {
    using Address for address payable;
    using ECDSA for bytes32;
    using Strings for uint256;

    uint256 public  mintPrice = 0.01 ether;
    uint32 public constant TXLIMIT = 10;
    uint32 public constant MAXSUPPLY = 2222;

    bool public started;
    string public _contractBaseURI;

    constructor(string memory baseURI) ERC721A("BullyBears", "BBears") {
    ...
    function mint(uint32 amount) external payable {
        ...
        if (amount > TXLIMIT) revert ErrorExceedTransactionLimit();
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory baseURI = _contractBaseURI;
