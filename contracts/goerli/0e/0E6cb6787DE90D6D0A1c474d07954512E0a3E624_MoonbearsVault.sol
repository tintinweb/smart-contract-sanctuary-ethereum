...
contract MoonbearsVault is Context, IERC721Receiver, ERC20, Ownable, ReentrancyGuard {
    IERC721 immutable MOONBEARS_ERC721;
    
    event MoonbearStaked(uint256 indexed tokenId);
    event MoonbearUnstaked(uint256 indexed tokenId);
