...
contract LXP is ERC20Burnable, Ownable, AccessControl {
     ...
     */
    function grantMintAllowance(address _address, uint _amount) public onlyOwner {
     ...
     */
    function increaseMintAllowance(address _address, uint _amount) public onlyOwner {
     ...
     * @param _amount The amount of LXP to mint
     */
    function decreaseMintAllowance(address _address, uint _amount) public onlyOwner {
        _grantMintAllowance(_address, mintAllowanceOf[_address] - _amount);
    }
