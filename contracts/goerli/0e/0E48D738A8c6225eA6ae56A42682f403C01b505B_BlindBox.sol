...
contract BlindBox is ERC1155, Ownable, Pausable {
    ...
    IERC20 public swapToken = IERC20(0xACedb6d978Ab5CfecA8Ca7cc49bbD01159FDBC70); // usdt
    ...
    event BuyBox(address indexed user, uint boxId, uint value);
    ...
    function buyBox(uint boxId_, uint num_, address referrer_) public whenNotPaused {
        ...
        emit BuyBox(_msgSender(), boxId_, num_);
    }
