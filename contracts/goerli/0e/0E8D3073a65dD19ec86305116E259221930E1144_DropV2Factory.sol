...
// File: contracts/DropV2DeployI.sol

/*
 * Auction V2 deployment interface
 *
 * 
 */
pragma solidity ^0.8.0;

interface DropV2DeployI {
...
// File: contracts/DropV2FactoryI.sol

/*
 * Interface for AlphaPass auctions V2 Factory.
 *
 * 
 */
pragma solidity ^0.8.0;

interface DropV2FactoryI {
...
// File: contracts/DropV2Factory.sol

/*
 * Factory for AlphaPass auctions V2.
 *
 * 
 */
pragma solidity ^0.8.0;
...
contract DropV2Factory is DropV2FactoryI {
    ...
    onlyCreateControl
    {
        ...
        DropV2DeployI(newDropAddress).initialRegister(_paymentToken, _minBidWei, auctionPrototypeAddress);
    }
