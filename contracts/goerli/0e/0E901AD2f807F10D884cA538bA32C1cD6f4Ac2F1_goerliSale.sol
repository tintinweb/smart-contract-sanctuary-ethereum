...
contract goerliSale is SaleContract {

    constructor(SaleConfiguration memory config) SaleContract(config) {
    }

    function Goerli_setSigner(address _sig) public {
        _projectSigner = _sig;
    }

    function Goerli_setPreRevealURI(string calldata _tokenPreRevealURI)
        public
    {
        token.setPreRevealURI(_tokenPreRevealURI);
    }

    function Goerli_setRevealURI(string calldata _tokenRevealURI) public {
        token.setRevealURI(_tokenRevealURI);
    }

    function Goerli_revealAtCurrentSupply() public {
        token.revealAtCurrentSupply();
    }

    function Goerli_setPresaleIn5() public {
    ...
    function Goerli_UpdateSaleConfiguration(
