...
contract SourSopKidz is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://mint.soursopkidz.com/nft/metadata/0000.json";
    bool public reveal = true;

    bool public endSale = false;

    string private _baseURIextended = "https://mint.soursopkidz.com/nft/metadata/";
    uint256 private _priceextended = 20000000000000000;
    ...
    constructor() ERC721("Sour Sop kidz", "TSK") {
    }
    ...
    function mintNFT(uint256 _cnt) public payable {
        ...
        require(!pauseMint, "Paused!");
        require(tokenMinted < MAX_NFT_SUPPLY, "Sale has already ended");
        require(balanceOf(msg.sender).add(_cnt) <= 5, "Exceded the Minting Count per Wallet. Max Mint per account is 5");
