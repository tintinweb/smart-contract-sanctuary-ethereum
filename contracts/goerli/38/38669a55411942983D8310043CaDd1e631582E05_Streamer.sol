...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
        require(balances[msg.sender] == 0, "STR: Channel already open");
        balances[msg.sender] = msg.value;
        emit Opened(msg.sender, msg.value);
    }

    function timeLeft(address channel) public view returns (uint256) {
        require(canCloseAt[channel] != 0, "STR: Channel is not closing");
    ...
    function withdrawEarnings(Voucher calldata voucher)  public onlyOwner {
        ...
        */
        ...
        require(balances[signer] > voucher.updatedBalance, "STR: Insufficient funds");
   ...
   function challengeChannel() public{
        require(balances[msg.sender] != 0, "STR: Channel is not open");
    ...
    */
    function defundChannel() public{
        require(canCloseAt[msg.sender] != 0, "STR: Channel is not closing");
        require(block.timestamp > canCloseAt[msg.sender], "STR: Channel can not close");
