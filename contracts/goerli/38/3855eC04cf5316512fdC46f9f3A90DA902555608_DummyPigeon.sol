...
contract DummyPigeon is ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
	using Strings for uint256;

	string private _baseTokenURI = "https://gutterspecies.guttercatgang.com/metadata/birds/";
