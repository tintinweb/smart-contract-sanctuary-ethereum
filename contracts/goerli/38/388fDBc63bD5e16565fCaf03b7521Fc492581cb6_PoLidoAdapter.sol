...
contract PoLidoAdapter is Helpers, Initializable, OwnableUpgradeable {
    ...
    function oneInchSwap(
        ...
        console.log('finalSellAmt ',finalSellAmt);
        uint256 _sellAmt18 = convertTo18(_sellDec, finalSellAmt);
        uint256 _slippageAmt = convert18ToDec(
            _buyDec,
            wmul(oneInchData.unitAmt, finalSellAmt)
        );
        console.log('_slippageAmt ',_slippageAmt);

        uint256 initalBal = getTokenBal(buyToken);
        console.log('buyToken ',address(buyToken));

        console.log('before eth balance : ',address(this).balance);

        // solium-disable-next-line security/no-call-value
        (bool success, ) = oneInchAddr.call{value: ethAmt}(
            oneInchData.callData
        );
        console.log('after eth balance : ',address(this).balance);
        ...
        console.log('_sellAmt18 ',_sellAmt18);
        console.log('_slippageAmt ',_slippageAmt);
    ...
    function _swapAndStake(
        ...
        console.log('oneInchData._buyAmt ',oneInchData._buyAmt);
