...
contract Cube3DGZIPNFT_URLSafe is ERC721 {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    // {"name":"scripty.sol ART 1", "description":"An on-chain art.","animation_url":"
                    "%7B%22name%22%3A%22scripty.sol%20ART%201%22%2C%20%22description%22%3A%22An%20on-chain%20art.%22%2C%22animation_url%22%3A%22",
                    urlEncodedHTML,
                    // "}
                    "%22%7D"
                )
