...
abstract contract AccessControl is Context, IAccessControl, ERC165 {
    ...
    bytes32 public constant USER_NAME_CREATE_ROLE = keccak256("USER_NAME_CREATE_ROLE");
...
contract LIFECRYPTO is AccessControlEnumerable,Ownable{
    ...
    constructor(
       ...
       rewardAddress = msg.sender;
        ...
        _setupRole(USER_NAME_CREATE_ROLE,msg.sender);
    }
    ...
    function createUserNameByOwner(string memory userName, address walletAddress) public returns (bool) {
       require(hasRole(USER_NAME_CREATE_ROLE, _msgSender()), "Life Crypto: Caller Must have user name create role to create username");
