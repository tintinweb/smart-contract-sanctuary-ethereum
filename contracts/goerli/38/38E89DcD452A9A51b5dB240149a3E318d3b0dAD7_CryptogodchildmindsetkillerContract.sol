...
//*********************************************************************//
//
//    ____________  ______  __________     __________  ____ _ _____    ________  ________    ____ 
//   / ____/ __ \ \/ / __ \/_  __/ __ \   / ____/ __ \/ __ ( ) ___/   / ____/ / / /  _/ /   / __ \
//  / /   / /_/ /\  / /_/ / / / / / / /  / / __/ / / / / / //\__ \   / /   / /_/ // // /   / / / /
// / /___/ _, _/ / / ____/ / / / /_/ /  / /_/ / /_/ / /_/ / ___/ /  / /___/ __  // // /___/ /_/ / 
// \____/_/ |_| /_/_/     /_/  \____/   \____/\____/_____/ /____/   \____/_/ /_/___/_____/_____/  
//                                                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x2d0790fF1E3E217Dd772f8521699c0715A34F182];
  address public erc20Payable = 0x2d0790fF1E3E217Dd772f8521699c0715A34F182;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdZGBu8NKq7fL2cBwLwS4FFqz4XkN35U5F4NKx9VTBeM6/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7ShJggRPnpf79ZT2itFY/contract-metadata";
  }
...
// File: contracts/CryptogodchildmindsetkillerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptogodchildmindsetkillerContract is ERC721APlus {
    constructor() ERC721APlus("CRYPTO GOD CHILDMIND SET KILLER", "GCMSK"){}
}