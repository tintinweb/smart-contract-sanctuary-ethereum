...
contract GentsCroquetClub is ERC721A, Ownable, ReentrancyGuard
{
    ...
    uint public constant MAX_TOKENS = 975; // This is your total supply limit
    uint public constant NUMBER_RESERVED_TOKENS = 250; // This supply will be airdropped to holders who have prepaid
    uint public mainSaleLimit = 1; // main sale purchase limit
    uint public overflowSaleLimit = 1; // overflow sale purchase limit

    bool public mainSale = false; // whitelist 1 and whitelist 2
    bool public overflowSale = false; // whitelist 3 overflow sale
    ...
    address payable private devguy = payable(0x8F7c913dFa300BB84C3A562A8D44165133029c68); // Payment Splitter (MORE DETAILS ON THE PAYMENT SPLITTER PROVIDED BELOW)
    ...
    function withdraw() external nonReentrant
    {
        ...
        (bool success, ) = devguy.call{value: address(this).balance / 100 * 2}(""); // set to split 2% upon withdrawal
        (bool success2, ) = owner().call{value: address(this).balance}(""); // Don't remove this line or you will not be able to withdraw your funds from the contract
    ...
    function withdrawERC20() external nonReentrant
    {
        ...
        uint256 devguySplit = totalBalance / 100 * 2; // set split to 2%
