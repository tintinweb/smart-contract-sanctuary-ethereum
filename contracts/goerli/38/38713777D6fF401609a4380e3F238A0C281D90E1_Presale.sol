...
contract Presale is Ownable {
    /**
    * @notice Card Contract
    *
    * @dev Should be set to card contract address upon deployment
    *
    */
    Card card;
    ...
    */
    ...
    bytes32 merkleRoot = 0xab4d968681a24299539b94c79362293790048a52eb4126b730e7f7cc36b35c2c;
    ...
    */
    ...
    /**
    * @param _cardContract address of the Card smart contract
    */
    constructor(Card _cardContract) {
        card = Card(_cardContract);
    }

    /**
    * @dev Call the `mint()` of card smart contract
    *
    *     
    * @param _ids id of the tokens
    * @param _tiers which tiers they want to use
    * @param _merkleproof the hash value to determine if the caller is part of whitelisted pool
    */
    function callMint(uint256[] calldata _ids, uint256[] calldata _tiers, string[] memory _uris, bytes32[] memory _merkleproof)
        external 
        payable 
        isWhitelistAllowed(_merkleproof)
    {
        card.mint{value: msg.value}(msg.sender, _ids, _tiers, _uris);
    }

    /**
    * @dev Pause the contract. This will disallowed to execute `callMint()`
    */
    ...
    /**
    * @dev Pause the contract. This will allowed to execute `callMint()`
    */
    function callPause()
        external 
        onlyOwner()
    ...
    /**
    * @dev Transfer the ownership of the card smart contract.
    */
    function callTransferOwnershipOfCard(address _newOwner) 
        external
        onlyOwner
    {
