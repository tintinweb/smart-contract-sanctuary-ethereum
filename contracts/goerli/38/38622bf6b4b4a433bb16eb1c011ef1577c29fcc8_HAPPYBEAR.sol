...
contract HAPPYBEAR is ERC20, Ownable {
    ...
    constructor() ERC20("HAPPYBEAR", "HAPPY") payable {
    	...
    	marketingWallet = address(0x60B21b6C3528c66fB7eE213e8d4a176837f3e159); // set as Marketing wallet
        devWallet = address(0x60B21b6C3528c66fB7eE213e8d4a176837f3e159); //set as devolper wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x60B21b6C3528c66fB7eE213e8d4a176837f3e159,
            block.timestamp
        );
    }
