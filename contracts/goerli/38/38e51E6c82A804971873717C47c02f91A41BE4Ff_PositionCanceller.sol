    ...
    AccessControlUpgradeable
{
    function cancelPosition(uint256 _positionKey) external {
        ...
        uint256 receivedCollateral = position.collateralToken ==
            order.poolData.token0
            ? order.transferedToken0
            : order.transferedToken1;
        uint256 receivedSecondToken = position.collateralToken ==
            order.poolData.token0
            ? order.transferedToken1
            : order.transferedToken0;
        ...
        address secondToken = position.collateralToken == order.poolData.token0
        ...
        if (receivedSecondToken > 0) {
            ...
            marketOrdersController.swapExactInputMultiHop(
                secondToken,
