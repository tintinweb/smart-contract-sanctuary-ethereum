...
// File @openzeppelin/contracts-upgradeable/utils/ContextUpgradeable.s[email protected]
...
contract YashaLaunchpad is OwnableUpgradeable {
    ...
    function contribute(
        ...
        _userContributes[simpleHash(_msgSender(), icoId_)] += amount_;
        _fundedTokens[icoId_] += amount_;
