...
contract ProxyStake is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    constructor(address _signerUnStake) public {
        signer = _signerUnStake;
        erc721 = IERC721Enumerable(0x07bE7B30c4609CDC668ba7631aA7785eEc80B4D9);
    }
    ...
    function _stake(uint256 _tokenId, uint256 _stakeType) internal {
        ...
        stakeList[_tokenId] = StakeInfo(_tokenId, msg.sender, _stakeType, block.timestamp);
    ...
    function unStake(string calldata _salt, bytes calldata _signature,  uint256 _tokenId) public nonReentrant eoaOnly{
        ...
        require(stakeList[_tokenId].staker == msg.sender, "Only staker can unStake");

        require(verifiedList[_salt] != msg.sender, "Already verified");

        require(_verify(signer, _hash(_salt, msg.sender), _signature), "Invalid signature");
