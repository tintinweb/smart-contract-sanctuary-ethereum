...
contract BBKTest1 is ERC721, Ownable {
    ...
    constructor() ERC721("BBKTest1", "BBKT1") {
    ...
    function batch1Mint(bytes32[] calldata proof)
        ...
        callerIsUser
    {
        require(batch1Active, "Batch 1 mint is not active!");
    ...
    function batch2Mint(bytes32[] calldata proof)
        ...
        callerIsUser
    {
        require(batch2Active, "Batch 2 mint is not active!");
    ...
    function publicMint(uint256 quantity) external payable callerIsUser {
        ...
        require(msg.value >= mintPrice * quantity, "ETH amount insufficient!");
    ...
    function checkRequirements(
        ...
        require(msg.value >= mintPrice, "ETH amount insufficient!");
    }
