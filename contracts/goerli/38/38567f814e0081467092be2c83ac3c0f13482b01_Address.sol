...
contract BoredRicksWubbaClub is ERC721A, Ownable, ReentrancyGuard {
    ...
    function reservedMint(uint256 Amount) external onlyOwner
    {
        ...
        require(totalSupply() + Amount <= maxRicks, "No more Morty to Be minted");
    ...
    function mint(uint256 Amount) external payable {
        ...
        {
        require(totalSupply() + Amount <= maxRicks, "No more Morty to Be minted");
        require(mintEnabled, "Not live yet, Morty's are coming");
        ...
        require(mintEnabled, "Not live yet, Mortys are coming");
