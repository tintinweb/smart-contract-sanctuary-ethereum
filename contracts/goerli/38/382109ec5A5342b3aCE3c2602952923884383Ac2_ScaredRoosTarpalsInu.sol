...
contract ScaredRoosTarpalsInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x02d3445Ab57f19aFE702901d2d8061e2Ea079471); 
    address payable public Wallet_Utility = payable(0x02d3445Ab57f19aFE702901d2d8061e2Ea079471);
    ...
    string private constant _name = "Scared Roos Tarpals Inu"; 
    string private constant _symbol = "Scared Roos Tarpals Inu"; 

    uint8 private txCount = 0;
    uint8 private swapTrigger = 17; 

    uint256 public _Tax__n_Buy = 10;
    uint256 public _Tax__n_Sell = 6;
    ...
    event SwapAndLiquifyEnabledUpdated(bool true__r_false);
    ...
    constructor () {
        ...
        __wner = 0x02d3445Ab57f19aFE702901d2d8061e2Ea079471;
        emit OwnershipTransferred(address(0), __wner);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent__f_Tokens) public returns(bool _sent){
        require(random_Token_Address != address(this), "Can not remove native token");
        uint256 totalRandom = IERC20(random_Token_Address).balanceOf(address(this));
        uint256 removeRandom = totalRandom*percent__f_Tokens/100;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_Tax__n_Buy/100;
            ...
            uint256 sellFEE = tAmount*_Tax__n_Sell/100;
