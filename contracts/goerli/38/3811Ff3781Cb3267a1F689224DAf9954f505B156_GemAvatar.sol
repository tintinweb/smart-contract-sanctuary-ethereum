...
contract GemAvatar is ERC721Enumerable, ERC721Burnable, Ownable, Pausable {
    using Strings for uint256;
    ...
    // Base URI
    string private baseURI = "https://meta.evergem.xyz/";
    string private baseExt = ".json";

    constructor() ERC721("GemAvatar", "GEM") {}
    ...
    function mint() external payable whenNotPaused onlyOwner returns (uint256) {
        _tokenIds.increment();
