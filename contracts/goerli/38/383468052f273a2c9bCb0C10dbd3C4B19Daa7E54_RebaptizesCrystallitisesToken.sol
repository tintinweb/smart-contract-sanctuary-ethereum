...
/**
 * @title RebaptizesCrystallitisesToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract RebaptizesCrystallitisesToken is ReentrancyGuard, ERC20Snapshot, ERC165 {
    address private _owner;

    constructor() ERC20("Rebaptizes Crystallitises Token","ZETL")   { 
        _owner = _msgSender();
     }
