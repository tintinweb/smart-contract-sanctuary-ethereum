...
contract ERC721DelegateTest is IDelegate, AccessControl, IERC721Receiver {
...
library Market {
  ...
  struct RunInput {
    Order[] orders; // 原始订单-上架或offer的原始信息
    SettleDetail[] details; //清算详情， 实际成交item
    SettleShared shared; //清算公共信息，交易发起方，交易总价格，交易有效期
    // signature  平台签名信息
    bytes32 r;
    bytes32 s;
    uint8 v;
