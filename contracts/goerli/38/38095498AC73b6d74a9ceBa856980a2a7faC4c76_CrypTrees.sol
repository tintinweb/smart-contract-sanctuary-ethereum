    ...
    Paid 
{
    ...
    uint256 public immutable __maxSupply;
    ...
    constructor(
        ...
        ERC721ASeaDrop(name_, symbol_, allowedSeaDrop_)
    {
     ...
     *
     * @param seaDropImpl The allowed SeaDrop contract.
     * @param dropURI_     The new drop URI.
     */
    function updateDropURI(address seaDropImpl, string calldata dropURI_)
        external
        override
        onlyOwner
    ...
    {
        // Update the drop URI.
        ISeaDrop(seaDropImpl).updateDropURI(dropURI_);
    }
    /**
     * @dev Use this if you are code, so we can talk
     * - second parameter is QUANTITY not TOKENID
    ...
    function _mintGuard(
        ...
        require(totalSupply() + quantity_ < __maxSupply + 1, "No more");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeicbgn4j7b6ak2fsgup4px4bnxlg5mu2msftsqsafjtcnevhfirc2i/";
    }
}
