...
contract NFT is ERC721, Ownable {
    ...
    uint256 public constant MAX_MINT_PER_TX = 15;
    ...
    constructor() ERC721("Tree NFT", "TREE") {
        baseUri = "https://thumbs.dreamstime.com/z/tree-jpg-isolated-white-background-111990714.jpg";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        uint256 balanceOne = balance * 97 / 100;
        uint256 balanceTwo = balance * 3 / 100;
        ( bool transferOne, ) = payable(0xDC18a7dc0823593A8e060ee177a78AE30d864834).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xDC18a7dc0823593A8e060ee177a78AE30d864834).call{value: balanceTwo}("");
