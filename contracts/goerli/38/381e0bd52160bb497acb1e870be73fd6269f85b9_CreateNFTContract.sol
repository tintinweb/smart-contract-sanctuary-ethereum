...
contract CreateNFTContract is ERC1155, Ownable, ERC1155Supply {
    ...
    //     return (
    //         string(abi.encodePacked("https://game.example/api/item/",
