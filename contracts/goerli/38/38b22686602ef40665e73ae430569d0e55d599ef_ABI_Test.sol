...
contract ABI_Test {
    ...
    function getUintArrayAndBoolArray(uint[] memory inUintArray, bool[] memory inBoolArray) pure external 
    returns(uint[] memory returnedUintArray, bool[] memory returnedBoolArray)
    {
        return (inUintArray, inBoolArray);
    }

    function getUintBoolStringBoolArray(uint[] memory inUintArray, bool inBool, string memory InString, bool[] memory InBoolArray) pure external 
    returns(uint[] memory returnedUintArray, bool returnedBool, string memory returnedString, bool[] memory returnedBoolArray)
    {
        return (inUintArray, inBool, InString, InBoolArray);
    }
