...
contract Marketplace is OrderCombiner, ConsiderationInterface{
constructor(address channelController) OrderCombiner(channelController){}
...
import { Side, ItemType } from "./MarketplaceEnums.sol";
