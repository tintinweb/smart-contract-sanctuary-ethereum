...
/**
 * @title Collection type interface.
 * @author reggieag
 */
...
abstract contract SequentialMintCollection is ITokenCreator, Initializable, ERC721BurnableUpgradeable {
  ...
  function _initializeSequentialMintCollection(address payable _creator) internal onlyInitializing {
    owner = _creator;
  }
 ...
 */
abstract contract TokenLimitedCollection is Initializable, SequentialMintCollection {
  /**
  ...
  function _initializeTokenLimitedCollection(uint32 _maxTokenId) internal onlyInitializing {
   ...
   */
  function numberOfTokensAvailableToMint() public view virtual returns (uint256 count) {
