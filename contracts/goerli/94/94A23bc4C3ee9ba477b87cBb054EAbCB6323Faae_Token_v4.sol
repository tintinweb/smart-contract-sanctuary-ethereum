...
contract Token_v4 is Token_v3 {
    bool private initializedV4 = false;
    event UpdateMetadata(string indexed _newName, string indexed _newSymbol);

    function initializeV4(string memory _newName, string memory _newSymbol)
        public
    {
        require(!initializedV4, "V4 had initialized");
        setName(_newName);
