...
contract EXODUS is ERC721Psi, ERC2981, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    bytes32 public vipMerkleRoot = 0xadeb344bb15d33148f98b0832a9bfa15fc2fe22090aac29d53401a0ff2863ab2;//本番デプロイ時変更
    bytes32 public merkleRoot = 0x1424c902139155fae74e2997fc94779e63e245318e96bb91756515a0e4617e5d;//本番デプロイ時変更
    bytes32 public dandyMerkleRoot = 0xaa74698227612eeb5bc9b92180c22af4460a5172e2389213a28fdca23ebc06ec;//本番デプロイ時変更
    bool public revealed = false;
    string private _baseTokenURI = "https://arweave.net/Qdm47JmC-XDrY_05m290PBM5hbm9hYvItg7MlSZQHOA/";//本番デプロイ時内容削除
    ...
    constructor() ERC721Psi("EXODUS", "EX") {
        _setDefaultRoyalty(0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f, 420);//本番デプロイ時変更

        _member.member1 = 0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f;//本番デプロイ時変更
        _member.member2 = 0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f;//本番デプロイ時変更
        _member.member3 = 0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f;//本番デプロイ時変更
        _member.member4 = 0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f;//本番デプロイ時変更
        _member.member5 = 0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f;//本番デプロイ時変更
        _member.member6 = 0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f;//本番デプロイ時変更
        _member.member7 = 0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f;//本番デプロイ時変更
        _member.treasury = 0x6cA14b1692B822479d95f1DDdA21AEd08f6eC961;//本番デプロイ時変更
    }
    ...
    function withdraw() external onlyOwner {
        ...
        Address.sendValue(payable(_member.member1), ((balance * 1000) / 10000));//本番デプロイ時変更
        Address.sendValue(payable(_member.member2),((balance * 1000) / 10000));//本番デプロイ時変更
        Address.sendValue(payable(_member.member3), ((balance * 1000) / 10000));//本番デプロイ時変更
        Address.sendValue(payable(_member.member4), ((balance * 1000) / 10000));//本番デプロイ時変更
        Address.sendValue(payable(_member.member5),((balance * 1000) / 10000));//本番デプロイ時変更
        Address.sendValue(payable(_member.member6),((balance * 1000) / 10000));//本番デプロイ時変更
        Address.sendValue(payable(_member.member7),((balance * 1000) / 10000));//本番デプロイ時変更
        Address.sendValue(payable(_member.treasury),((balance * 3000) / 10000));//本番デプロイ時変更
    }
