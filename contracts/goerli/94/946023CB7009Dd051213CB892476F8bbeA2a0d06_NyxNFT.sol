...
contract NyxNFT is ERC1155Supply, Ownable
{
        ...
        private
    {
        ...
        require(waveCurrentSupply[currentTokenId] + nMint <= (100 - nyx_mint_pct) * waveMaxSupply[currentTokenId] / 100, "No more NFT to mint for this wave");
        ...
        public payable
    {
        ...
        require(balanceOf(recipient, currentTokenId) + nMint <= max_holding, "Max holded NFTs is reached");
