 ...
 * allowances. See {IERC20-approve}.
 */
contract ARCADEDAOERC is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "$PLAY - DEFLATIONARY WEB3 GAMES";
    string private _symbol = "PLAY";
    uint8 private _decimals = 9;
    uint256 private _supply = 10000000;
    address private authorizedNFTcontractDeployer;
    mapping(address => uint256) private _burnedBy;
    ...
    address public marketingWallet = 0x20F0813541a63f15dFA7628F1eBAAA20E29b92eE;
    // TOKENOMICS END ============================================================>
    ...
    function marketingPayout(address _to, uint256 _amount) public {
        require(
            msg.sender == owner(),
        ...
        // Ensure that the contract has enough balance to transfer
        require(
    ...
    function burn(uint256 _value) public {
        ...
        _transfer(msg.sender, deadAddress, _value);
