...
contract Trade is AccessControl {
    ...
    */
    ...
    //@param assetAddress NFT contract address(RAJNFT721, RAJNFT1155)
    ...
    /** 
        @notice transfer and Mint the NFTs(RAJNFT721, RAJNFT1155) and tokens through the transferproxy.
...
//@title IRoyaltyInfo is used for communicating with RAJNFT contracts for getting royalty info.
