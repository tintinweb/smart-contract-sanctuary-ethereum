...
contract Sumotori is ERC20, Ownable {
    ...
    function setFeeSell(uint256 _marketing, uint256 _poolStaking) external onlyOwner{
        ...
        require(_feeSell.totalFee <= 10, "Max fee allowed is 10%");
    }
    ...
    function setFeeBuy(uint256 _marketing, uint256 _poolStaking) external onlyOwner{
        ...
        require(_feeBuy.totalFee <= 10, "Max fee allowed is 10%");
    }       
    ...
    function setFeeExempt(address addr, bool _isFeeExempt) external onlyOwner{
    ...
    function clearStuckToken(ERC20 token, address recipient, uint256 value) external onlyOwner {
