...
contract TESTONME is ERC20 , Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TESTONME", "TESTONME") {
        ...
        uint256 totalSupply = 10000 * 1e2 * 1e18;
 
        maxTransactionAmount = totalSupply * 15 / 1000; // 1% 
        maxWallet = totalSupply * 30 / 1000; // 1.5% 
        ...
        marketingWallet = address(0xF03a883EE51Ea3E10ebdd436b70dB6Dd7a1Cf31b); // set as marketing wallet
        devWallet = address(0x4859567e309A9e141677A9f73b575279ceCBAEC5); // set as dev wallet
