...
contract NFTcontract is ERC721Enumerable, ReentrancyGuard {
    ...
    ////////////////////////////added///////////////////////////////
    function _isVerifiedCoupon(bytes32 digest, bytes32 r, bytes32 s, uint8 v) internal view returns (bool) {
    ...
    function mintWithSig(
        ...
        nonReentrant
    {
        uint256 firstId = tokenId;
        address _winner = winner;
        require(_winner == msg.sender, "invalid-winner");
        bytes32 digest = getDigest(auctionType, firstId, bidPrice, _winner, address(this));
        require(_isVerifiedCoupon(digest, r, s, v), "invalid-coupon");
        _mint(_winner, firstId);
        emit TokenMinted(firstId, 1, address(this), _winner);
    }

    function updateSigner(address _signer) external onlyOwner {
        require(couponSigner != _signer, "already-added");
