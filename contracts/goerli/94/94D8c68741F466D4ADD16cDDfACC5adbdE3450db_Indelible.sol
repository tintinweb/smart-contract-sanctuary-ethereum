// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Extra", unicode"mouth", unicode"head", unicode"cheeks", unicode"Glasses", unicode"tattoo", unicode"suspenders", unicode"eyes", unicode"shoes", unicode"Pants", unicode"smul", unicode"background"];
        ...
        uint public publicMintPrice = 0.00333 ether;
        ...
        ContractData public contractData = ContractData(unicode"smul", unicode"smuls are a mysterious anon onchain maxie cult. we smul a lot. we waer our undies over our pants. we like to wear da big boots and has tattoos. we onchain maxi. you? we like to surprise humans wif onchain gifts. believe in the process.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/070175b1-2f7b-4725-8480-753f7e69574a", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/070175b1-2f7b-4725-8480-753f7e69574a", "", 700, "0xe75699de99D2b9284F6B6e5eE7E36Ab6074a40c2");

        constructor() ERC721A(unicode"smul", unicode"smul") {
            TIERS[0] = [206,265,417];
            TIERS[1] = [30,40,50,60,99,122,233,254];
            TIERS[2] = [30,30,44,50,56,62,117,118,121,123,137];
            TIERS[3] = [122,226,540];
            TIERS[4] = [15,50,100,111,140,146,160,166];
            TIERS[5] = [54,118,153,254,309];
            TIERS[6] = [10,88,790];
            TIERS[7] = [0,0,0,0,222,222,222,222];
            TIERS[8] = [45,45,168,630];
            TIERS[9] = [30,105,211,245,297];
            TIERS[10] = [65,81,137,605];
            TIERS[11] = [888];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"smul #");
