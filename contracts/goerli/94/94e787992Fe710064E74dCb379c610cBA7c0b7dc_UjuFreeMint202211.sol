    ...
    Ownable
{
    ...
    ) internal virtual override(ERC721, ERC721Lockable) {
        ERC721Lockable._beforeTokenTransfer(from, to, startTokenId);
    }
    ...
    function _afterTokenTransfer(
        ...
        ERC721Lockable._afterTokenTransfer(from, to, startTokenId);
        ERC721RestrictApprove._afterTokenTransfer(from, to, startTokenId);
    }
...
abstract contract ERC721Lockable is ERC721, IERC721Lockable {
    ...
    function _startTokenId() view internal virtual returns(uint256);
    function _nextTokenId() view internal virtual returns(uint256);
...
abstract contract ERC721RestrictApprove is ERC721, IERC721RestrictApprove {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    AccessControl
{
        ...
        )
    {
        ...
        for (uint256 i = 0; i < ownerMintAmount; i++) {
            _safeMint(ownerAddress, tokenCount);
            tokenCount++;
        }
    }
    ...
    {
        return
            string(abi.encodePacked(ERC721.tokenURI(tokenId), baseExtension));
    }
    ...
    function _totalSupply() internal view override returns (uint256) {
        return tokenCount - _startTokenId();
    }
