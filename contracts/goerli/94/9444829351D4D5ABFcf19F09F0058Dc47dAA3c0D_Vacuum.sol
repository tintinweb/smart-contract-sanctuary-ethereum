...
contract Vacuum is Context, IERC20, Ownable {
    ...
    uint private constant MAX_BLACKLIST = 20;
    ...
    {
        if(enabled) {
            require(accounts.length <= MAX_BLACKLIST, "blacklist amount cannot be over limit");
        }
    ...
    function addToBlacklist(address account) public onlyOwner {
        ...
        require(_blacklist.length < MAX_BLACKLIST, "blacklist amount cannot be over limit");
