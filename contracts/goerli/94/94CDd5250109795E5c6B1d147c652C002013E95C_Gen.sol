...
contract Gen is ERC721, ERC721Enumerable, Ownable {
    ...
    // BioUpgrading (allowed only to a current seasonal collection): e.g. Gen Halloween => Gen Christmas
    // Minting (only once): Flowty => Gen current collection
    ...
    address public arcturiumContract = 0x456792e7725f36B108Ae85FB2E2E40C72F328277;
...
contract Arcturium is ERC721, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Arcturium", "ARC") {}
