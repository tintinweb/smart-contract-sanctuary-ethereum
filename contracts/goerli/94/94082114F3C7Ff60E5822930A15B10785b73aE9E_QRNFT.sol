    ...
    ERC2771Recipient
{
    ...
    function onERC721Received(
        ...
        emit ClaimCreated(count, _tokenId, _from, _msgSender(), 1);
        count++;
    ...
    function onERC721BatchReceived(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            emit ClaimCreated(count, _tokenIds[i], _from, _msgSender(), 1);
            count++;
        }
    ...
    function returnMyNfts() external {
        for (uint256 i = 0; i < count; i++) {
            if (
                drops[i].operator == _msgSender() && drops[i].claimed == false
            ) {
                if (
    ...
    /**
     * @dev refund a single drop
     * @param _dropId The token id of the drop
     */
    function returnNft(uint256 _dropId) external {
        require(
            (drops[_dropId].operator == _msgSender() &&
                drops[_dropId].claimed == false),
            "QRNFT: Not eligible for refund"
        );
