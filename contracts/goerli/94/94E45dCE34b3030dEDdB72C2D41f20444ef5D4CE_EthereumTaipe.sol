...
interface IOperatorFilterRegistry {
    ...
    function subscriberAt(address registrant, uint index)
        external
        returns (address);
    ...
    function filteredOperatorAt(address registrant, uint index)
        external
        returns (address);

    function filteredCodeHashAt(address registrant, uint index)
        external
        returns (bytes32);
