...
contract WTF is ERC20Burnable, Ownable {
    ...
    mapping(uint256 => address) public authorizedAddress;
    mapping(uint256 => uint256) public emissionRate;
    address public angryThreadAddress;

    constructor() ERC20("WTF", "WTF") {}

    function setAuthorizedAddressData(
        uint256 index,
        ...
        name[index] = name_;
        authorizedAddress[index] = address_;
    ...
    function claimRewards(uint256 index_, uint256 total_) public {
        if (msg.sender != authorizedAddress[index_]) revert Unauthorized();
