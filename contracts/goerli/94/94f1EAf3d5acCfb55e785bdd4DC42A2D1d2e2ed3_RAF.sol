...
//                                                                                                 //
//                                                                                                 //
//     _     _  ______    _______  _______  ___   _  ___   _______  ______    _______  _______     //
//    | | _ | ||    _ |  |       ||       ||   | | ||   | |       ||    _ |  |   _   ||       |    //
//    | || || ||   | ||  |    ___||       ||   |_| ||   | |_     _||   | ||  |  |_|  ||    ___|    //
//    |       ||   |_||_ |   |___ |       ||      _||   |   |   |  |   |_||_ |       ||   |___     //
//    |       ||    __  ||    ___||      _||     |_ |   |   |   |  |    __  ||       ||    ___|    //
//    |   _   ||   |  | ||   |___ |     |_ |    _  ||   |   |   |  |   |  | ||   _   ||   |        //
//    |__| |__||___|  |_||_______||_______||___| |_||___|   |___|  |___|  |_||__| |__||___|        //
//                                                                                                 //
//                                                                                                 //
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
contract RAF is ERC721Creator {
    constructor() ERC721Creator("RAF Editions", "RAF") {}
}
