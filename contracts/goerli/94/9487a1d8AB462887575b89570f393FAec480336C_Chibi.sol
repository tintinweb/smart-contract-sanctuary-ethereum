...
contract Chibi is ERC721Enumerable, Ownable {
    ...
    uint256 public price = 55_000_000_000_000_000;
    ...
    constructor(string memory baseURI, uint256 maxPurchaseTokens) ERC721("chibilegends", "Chibi")  {
        changeBaseURI(baseURI);
        maxPurchase = maxPurchaseTokens;
    }
    ...
    function mintChibi(uint256 qty) public payable mintingIsAvailable {
        ...
        require(qty <= maxPurchase, "Buying too many per transaction.");
