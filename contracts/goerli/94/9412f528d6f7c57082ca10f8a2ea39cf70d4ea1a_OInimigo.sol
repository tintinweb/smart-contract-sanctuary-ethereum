...
contract OInimigo is ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 private _nftEtherValue = 55000000000000000;
    uint256 private nftEtherValueConselheiros = 25000000000000000;
    uint256 private nftEtherValueBad = 35000000000000000;
    ...
    function mintBadlist(
        ...
        if (onlyWhitelisted) {
            require(!whitelistClaimed[endUser], "Address ja reivindicado");
            require(isValidBadList(proof, keccak256(abi.encodePacked(endUser))), "Nao faz parte da Whitelist");
        }
