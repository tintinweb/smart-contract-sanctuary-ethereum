...
contract Bacon is IOGBacon, ERC721Enumerable, Pausable, Ownable, ReentrancyGuard, PaymentSplitter {
	...
	// max mint qty
	uint16 public MAX_MINT_QTY = 20;
	// whitelist mint max for discounted price
	uint256 public WHITELIST_MINT_MAX = 0;
