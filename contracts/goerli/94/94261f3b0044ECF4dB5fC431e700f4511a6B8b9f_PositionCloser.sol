    ...
    AccessControlUpgradeable
{
        ...
        returns (uint256 orderId)
    {
        ...
        Position storage position = positions[_params.positionId];
        ...
        if (_params.receivingToken == position.collateralToken) {
            ...
            position.closeToken = position.collateralToken;
            marketToPositionId[orderId] = position.positionId;
        } else if (
            _params.receivingToken ==
            IUniswapV3Pool(position.poolAddress).token0() ||
            _params.receivingToken ==
            IUniswapV3Pool(position.poolAddress).token1()
        ) {
            ...
            revert("Wrong receiving token address");
        }
        emit ClosePosition(
            _params.positionId,
