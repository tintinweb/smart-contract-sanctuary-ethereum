...
contract GarbageUniversityToken is ERC721, ERC721URIStorage, Ownable {
    ...
    event Revoke(address indexed to, uint256 indexed tokenId);
     ...
     constructor() ERC721("Garbage University Token", "GUT") {}

    function safeMint(string memory uri) public {
        require(!_minted[msg.sender], "You can only mint one NFT per wallet");
