...
// most of this contract was shamelessly stolen from MRI

contract GoodLuck is ERC20, ILPToken, Ownable {
    ...
    constructor(address splitter, address lottery) ERC20("Good Luck", "GL") {
        ...
        marketingWallet = lottery; // set as marketing wallet
        devWallet = splitter; // set as dev wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(lottery), true);

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(lottery), true);
    ...
    function updateBuyFees(
        ...
        require(_liquidityFee == 0, "No liquidity fee");
        require(_marketingFee >= 4, "Lottery tax must be >= 4%");
    ...
    function reserves()
        external
        view
        returns (uint256 ethAmount, uint256 thisAmount)
    {
        IUniswapV2Pair pair = IUniswapV2Pair(uniswapV2Pair);
