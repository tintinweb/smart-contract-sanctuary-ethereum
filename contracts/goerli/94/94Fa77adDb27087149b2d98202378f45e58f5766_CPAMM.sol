...
contract Staking {
    ...
    */
    ...
    uint public total_amount_stacked = 0;
    /**
        ...
        returns (uint256)
    {
        ...
        return
            (((block.timestamp - since) / 1 minutes) *
                amount) / rewardPerHour;
    }
        ...
        returns (uint256)
    {
        ...
        uint256 reward = calculateStakeReward(current_stake.since, current_stake.amount);
        total_amount_stacked -= amount;
