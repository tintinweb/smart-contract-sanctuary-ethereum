...
contract DiceGame {
    ...
    function rollTheDice() public payable {
        ...
        // console.log("Transferring from %s to %s %s tokens",msg.sender,hash,roll);
        ...
        if (roll > 2 ) {
            console.log("You lose with roll %s", roll);
            return;
        }

        console.log("You won with roll %s", roll);
...
contract RiggedRoll is Ownable {
  ...
  function withdraw(address payable _addr, uint256 _amount) public onlyOwner {
    ...
    // console.log("Result is %s", sent);
    require(sent, "Transfer failed");
    // console.log("End of withdraw called");
  ...
  function riggedRoll() public {
    ...
    require(address(this).balance >= 0.002 ether, "Not ethough eth in RiggedRoll contracr");
    
    // console.log("RiggedRolled!");
    ...
    require(roll <= 2, "Roll is not favourable");

    // console.log("Winning roll: %s !", roll);
