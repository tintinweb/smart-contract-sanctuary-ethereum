    ...
    ERC721URIStorage
{
    ...
    function setBaseURI(string memory baseURI_) public onlyLaunchpad {
    ...
    function mint(address to, string memory uri) external onlyLaunchpad {
        _safeMint(to, _tokenIds.current());
        _setTokenURI(_tokenIds.current(), uri);
        _tokenIds.increment();
    }

    function burn(uint256 tokenId) external onlyLaunchpad {
        _burn(tokenId);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerable, ERC721, ERC2981, ERC721Enumerable)
        returns (bool)
    {
