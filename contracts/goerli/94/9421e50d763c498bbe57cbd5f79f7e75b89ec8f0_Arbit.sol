...
contract Arbit {
        ...
        isDecisionMaker(caseId)
    {
        ...
        emit CaseEdited(caseId, msg.sender);
    }

    function approveCase(uint256 caseId) public isJudgeOrParty(caseId) {
        Case storage case_ = cases[caseId];
        case_.approvals[msg.sender] = true;
        // might not need this
        ...
        emit CaseApproved(caseId, msg.sender);
    }
    ...
    // should i add if it's only your turn?
