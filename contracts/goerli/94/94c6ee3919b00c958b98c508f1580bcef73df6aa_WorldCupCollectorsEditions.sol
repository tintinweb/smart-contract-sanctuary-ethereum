...
// File: WorldCupCollectorsEditions.sol
...
contract WorldCupCollectorsEditions is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public mintRate = 0.013 ether ;
    uint public MAX_SUPPLY = 422;

    constructor() ERC721("World Cup Collectors Editions", "WCCE") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeidntd636vxpzl4pyziyyturzoeu2nzm6eeroxxet4h7rjlvcih5te/";
    }
