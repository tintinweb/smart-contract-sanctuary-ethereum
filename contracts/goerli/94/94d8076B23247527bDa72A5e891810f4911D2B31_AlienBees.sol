...
contract AlienBees is ERC721, Ownable, ReentrancyGuard, RandomlyAssigned{
    ...
    function mintBee(uint256 quantity) public payable {
        ...
        require(HPSale == true, "Minting is not live.");
        require( (quantity + tokenCount()) <= totalSupply(), "Mint Completed"); 
        require(msg.value >= (mintPrice * quantity), "Mint price cannot be empty.");
        require(HpSaleWallets[msg.sender] == true && HPSale == true || whiteListedWallets[msg.sender] == true && whiteListSale == true || publicSale == true, "Minting is not live.");
