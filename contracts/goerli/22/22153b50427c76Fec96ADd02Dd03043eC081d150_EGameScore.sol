...
import "@thirdweb-dev/contracts/drop/DropERC20.sol"; // for my ERC20 token
import "@openzeppelin/contracts/security/ReentrancyGuard.sol"; // for security

contract EGameScore is ReentrancyGuard {

  DropERC20 public immutable tokenContract; // store the token contract
  ...
  constructor(DropERC20 addressTokenContract) {
  ...
  function updateToken(uint256 _subToken) public {
