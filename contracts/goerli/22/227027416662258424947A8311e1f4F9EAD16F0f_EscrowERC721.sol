...
contract EscrowERC721 {
  ...
  OptimisticOracleV2Interface oo = OptimisticOracleV2Interface(0xeE3Afe347D5C74317041E2618C49534dAf887c24);
  // bytes
  ...
  // payment assertion
  function assertpayment(bytes32 _identifier) public buyerOnly {
      identifier = _identifier;
      uint256 requestTime = block.timestamp;
      IERC20 bondCurrency = IERC20(0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa);
      uint256 reward = 0;
