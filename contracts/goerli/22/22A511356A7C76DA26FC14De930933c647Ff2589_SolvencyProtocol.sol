...
contract SolvencyProtocol {
    ...
    function addVerifyingKey(uint[2] memory alpha1,
        ...
        Pairing.G1Point memory IC5 = Pairing.G1Point(IC[5][0], IC[5][1]);
    ...
    function verify(uint[] memory input, Pairing.Proof memory proof, Pairing.VerifyingKey memory verifyingKey) internal view returns (bool) {
        ...
        require(input.length + 1 == 6,"verifier-bad-input");
        ...
        require(input[4] < snark_scalar_field,"verifier-gte-snark-scalar-field");
        vk_x = Pairing.addition(vk_x, Pairing.scalar_mul(verifyingKey.IC5, input[4]));
