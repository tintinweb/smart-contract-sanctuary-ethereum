...
contract AccessExtension is AccessControl {
     ...
     */
    function changeAdmin(address newAdmin_)
        external
     ...
     */
    function addCreator(address newCreater_)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     */
    function addUpdateDelete(address newUpdateDeleter_)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     */
    function removeCreator(address oldCreater_)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
     ...
     */
    function removeUpdateDeleteRole(address oldDeleter_)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function _checkSignature(
        ...
        // check if the signer has the create role or is the authority in the identity
...
contract COA is TokenExtension, AccessExtension {
    ...
    modifier isUnique(bytes calldata signature_) {
        ...
        if (usedSignatures[keccak256(signature_)]) {
    ...
    function cloneCertificate(
        ...
        SCOA.Certificate memory certificate = readCertificate(tokenId_);
        _checkSignatureMemory(
            to_,
            certificate,
            identity[certificate.identity].owner,
            signature_
        );
    ...
    function cloneCertificate(
        ...
        for (uint256 i = 0; i < tokenId_.length; i++) {
            ...
            cloneCertificate(to_[i], tokenId_[i], signature_[i]);
        }
    }
     ...
     */
    function readIdentity(uint256 tokenId_)
        public
        view
        identityExists(tokenId_)
        returns (SCOA.Identity memory)
    {
        // return the identity
     ...
     */
    function readIdentity(uint256[] calldata tokenId_)
        external
        view
        returns (SCOA.Identity[] memory)
    {
     ...
     */
    function readCertificate(uint256 tokenId_)
        public
        view
        certificateExists(tokenId_)
        returns (SCOA.Certificate memory)
    {
     ...
     */
    function readCertificate(uint256[] calldata tokenId_)
        external
        view
        returns (SCOA.Certificate[] memory)
    {
        // create an array of certificates
        SCOA.Certificate[] memory certs = new SCOA.Certificate[](
            tokenId_.length
        );
        // loop through the array of token ids
        for (uint256 i = 0; i < tokenId_.length; i++) {
     ...
     */
    function updateIdentity(uint256 tokenId_, SCOA.Identity calldata identity_)
        public
        isOwnerOrAuthorized(tokenId_)
    {
        // update the identity
     ...
     */
    function deleteIdentity(uint256 tokenId_)
        public
        isOwnerOrAuthorized(tokenId_)
    {
        // delete the identity
     ...
     */
    function deleteId(uint256[] calldata tokenId_) external {
        // loop through the array of token ids
        for (uint256 i = 0; i < tokenId_.length; i++) {
     ...
     */
    function deleteCertificate(uint256 tokenId_)
        public
        isOwnerOrAuthorized(tokenId_)
    {
     ...
     */
    function burnCertificate(uint256 tokenId_, uint256 amount_) public {
        // burn the certificate
        _burnCertificates(tokenId_, amount_);
    }
    ...
    function burnCertificate(
        ...
        for (uint256 i = 0; i < tokenId_.length; i++) {
            ...
            burnCertificate(tokenId_[i], amount_[i]);
        }
    }
...
contract TokenExtension is ERC1155 {
     ...
     */
    function validCertificate(uint256 tokenId_)
        external
        view
        certificateExists(tokenId_)
        returns (bool)
     ...
     * @param tokenId_ the token id
     */
    function getMetadata(TokenType tokenType_, uint256 tokenId_)
        public
        view
        returns (string memory)
    {
     ...
     * @return the identity metadata
     */
    function identityMetadata(uint256 tokenId_)
        public
        view
        returns (string memory)
    {
     ...
     * @return the certificate metadata
     */
    function certificateMetadata(uint256 tokenId_)
        public
        view
        returns (string memory)
    {
     ...
     * @param identity_ the identity to mint
     */
    function _mintIdentity(address to_, SCOA.Identity calldata identity_)
        internal
    {
        // get next tokenId
     ...
     */
    function _cloneCertificate(address to_, uint256 tokenId_)
        public
        certificateExists(tokenId_)
    {
        // mint the token
     ...
     * @param identity_ the new identity
     */
    function _updateIdentity(uint256 tokenId_, SCOA.Identity calldata identity_)
        internal
        identityExists(tokenId_)
    {
        // update the identity
     ...
     */
    function _deleteIdentity(uint256 tokenId_)
        internal
        identityExists(tokenId_)
    {
     ...
     * @param tokenId_ the token id to delete
     */
    function _deleteCertificate(uint256 tokenId_)
        internal
        certificateExists(tokenId_)
    {
        // set tokenType to deleted
        tokenType[tokenId_] = TokenType.DELETED_CERTIFICATE;
        // delete the tokenType
        delete certificate[tokenId_];
    }
     ...
     */
    function _burnCertificates(uint256 tokenId_, uint256 amount_) internal {
        // check the tokenType
        if (
     ...
     */
    function _bytesToHex(bytes memory buffer)
        internal
        pure
        returns (string memory)
    {
