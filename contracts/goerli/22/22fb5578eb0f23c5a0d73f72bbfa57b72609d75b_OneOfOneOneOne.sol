...
contract OneOfOneOneOne is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {  
    ...
    constructor() ERC721A("OneOfOneOneOne", "ONEONEONE") {
