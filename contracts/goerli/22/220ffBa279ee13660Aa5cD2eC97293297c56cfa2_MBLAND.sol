 ...
 * @notice This contract handles minting MBLAND tokens.
 */
contract MBLAND is
    ERC721A,
    ERC721AQueryable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x061d286d21de4f0bc512a72df9C0315bb2D5FDfC;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x417dBB64aee4176fFc274D9a3B1EcFB965bbF322;
    address[] public payoutAddresses = [
        0x417dBB64aee4176fFc274D9a3B1EcFB965bbF322
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeihchjkpnl5u3e43tnt2xs6g74tttieakblkspokpht32rpxltihbe/";
    ...
    uint256 public presaleMintsAllowedPerAddress = 3000;
