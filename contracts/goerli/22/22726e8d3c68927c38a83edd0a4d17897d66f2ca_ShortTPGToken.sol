...
import "topos/TPGToken.sol";

/// @title Short Topos token
contract ShortTPGToken is TPGToken {
    constructor() TPGToken("Short Topos Token", "sTPG", 18) {}
}