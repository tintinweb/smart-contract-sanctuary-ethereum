...
// ApeRidesPhotoBook Contract
// ERC721A with amendments by cryptonthat
// Infinite Supply, Conditional Base URIs, Conditional Mints and Transfer Events
// To Mint an Ape on a Ride, go to: "LINK"
...
contract ApeRidesPhotobook is ERC721A, Ownable {
  using Strings for uint256;
  ...
  //last occupied maps the ride token id to the currently occupied AOR
  ...
  constructor(
    ...
    supportedCollectionAddresses[0xa3a23775230Eeb7cFc99E4dd54Ac92668A193347] = true;
    supportedCollectionAddresses[0xA9CF03AF3b9B8f251F52F180D4d2cf64ceD5157C] = true;
    supportedCollectionAddresses[0x0B8b9bb60355aEe7C97335eFaDe3DD2De5acceC0] = true;
    supportedCollectionAddresses[0x9BA133034D2249B6144ddd46B1132641BF3FF7D6] = true;
    supportedCollectionAddresses[0x6b489a43b071B582f13980197438c852E826f7f4] = true;
    supportedCollectionAddresses[0x6C4088086193Af3032aC68eD5CAD0e4670bbBAa3] = true;
    supportedCollectionAddresses[0x3cEFBEC0d08ed5f3F0E59979a1E4D0C594b78caf] = true;
    supportedCollectionAddresses[0x94Db85Fda0Af39Fc37A08aa93B6bEd5B7B14F608] = true;
    supportedCollectionAddresses[0xDf23323d629250f15f4DaD8a45F57aDAD121723C] = true;
    supportedCollectionAddresses[0x94Db85Fda0Af39Fc37A08aa93B6bEd5B7B14F608] = true;
        supportedCollectionAddresses[0x231427A58115Cc117b3475A4f26ff04D9e99ef7d] = true;
            supportedCollectionAddresses[0x699a4ce2CFa770287Bff92Dc14680774e95a2446] = true;
    supportedRideCollectionAddresses[0x46405fa77213E86623dAC9CDb62452d970926601] = true;
  }
  ...
  function mint(address _apeAddress, uint256 _apeId, address _rideAddress, uint256 _rideId, address _receivingAddress) public payable {
    ...
    uint256 _exitTime = apeOnRideInfo[currentlyOccupied[_rideId]].exitTime;
    if (_exitTime > 0) {
        require(block.timestamp-_exitTime>86400, "The paperwork is still going through for this Ape Rider");
    }
    if (isApeOnRideOccupied[currentlyOccupied[_rideId]]) {
        if (apeOnRideInfo[currentlyOccupied[_rideId]].apeAddress == _apeAddress) {
          require(apeOnRideInfo[currentlyOccupied[_rideId]].apeId!=_apeId, "This ape is already on this ride.");
        }
    }
