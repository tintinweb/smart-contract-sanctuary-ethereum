...
/**
 * @title Nft
 * @dev ERC721 mock contract (implements with openzeppelin presets)
 */
contract Nft is ERC721PresetMinterPauserAutoId {
    constructor(
        ...
        ERC721PresetMinterPauserAutoId(
            name,
            symbol,
            'https://ipfs.io/ipfs/QmNq4kMDCqq7yFTaAb2RxdsPnXrTDzbzALcbi31UWQctcS/'
        )
    {}

    function mintn(uint n, address to) public {
        require(n > 0);
        do {
            mint(to);
        } while (--n > 0);
