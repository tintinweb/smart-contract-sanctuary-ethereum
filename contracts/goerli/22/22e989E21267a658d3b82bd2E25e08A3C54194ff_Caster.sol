...
/**
    TODO:
    - Use getter for spells, 
        totalSpells()
    - Use constants for spells
    - Use a config setter to configure spell, emit 1 event with spell ID
    - configure every aspect of spell, "base price, price multiplier, base effect value, effect multiplier, etc .etc
    - Use a separate CA for wizard data (with this you can update the logic here)
    - Number of cast helyett, XP legyen, XP-t spellek után kapsz és adott XP után tudsz lvl uppolni
 */
...
interface ICaster {
    ...
    struct SpellBookData {
        uint256 currentXp;
        uint256 createdAt;
        //mapping(uint8 => EffectData) effects;
        uint8 level;
    }
