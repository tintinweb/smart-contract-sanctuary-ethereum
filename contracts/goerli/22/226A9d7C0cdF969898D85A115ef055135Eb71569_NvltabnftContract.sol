...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xbE184F8C9951b266BA28F076aA1641f29Ab4095a];
  address public erc20Payable = 0xbE184F8C9951b266BA28F076aA1641f29Ab4095a;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihvfe7mciabbd6ryw3izbx7edxidv26oouf64pbkl3pj2fyjidj24/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/125QwihtvbthaJGeSfvv/contract-metadata";
  }
...
// File: contracts/NvltabnftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NvltabnftContract is RamppERC721A {
    constructor() RamppERC721A("NVLTABNFT", "NLNT"){}
}
