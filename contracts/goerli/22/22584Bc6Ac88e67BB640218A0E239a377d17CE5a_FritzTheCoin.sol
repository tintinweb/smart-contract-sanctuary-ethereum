...
contract FritzTheCoin is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 1e15;
    uint256 public maxWallet = 10_000_000_000_000 * 1e18;
    ...
    uint256 public weeklyRewardDay = 6;
    uint256 public weeklyRewardHour = 21;

    uint256 public dailyRewardHour = 9;

    bool public rewardEnabled = true;

    bool public _isDailyRewarded = true;
    bool public _isWeeklyRewarded = true;
    ...
    function pairRateReserve1() external view returns (uint256) {
    ...
    function pairRateReserve2() external view returns (uint256) {
        IUniswapV2Pair pair = IUniswapV2Pair(uniswapV2Pair);
