...
contract Bingo is ERC721Enumerable, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    constructor() ERC721("Bingo", "BINGO") {}
    ...
    function mintCollectionNFT(
        ...
        require(
            ...
            "GODS: Supply would be exceeded"
        );
        for (uint256 i; i < amount; i++) {
            _safeMint(collector, totalSupply() + 1);
        }
    }
