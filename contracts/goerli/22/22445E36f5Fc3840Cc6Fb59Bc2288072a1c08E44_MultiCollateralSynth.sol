...
contract MultiCollateralSynth is Synth {
     ...
     */
    function issue(address account, uint256 amount) override external onlyInternalContracts {
    ...
    function _isInternalContract(address account) internal override view returns (bool) {
...
contract Synth is Owned, ExternStateToken, MixinResolver {
    ...
    function _isInternalContract(address account) internal virtual view returns (bool) {
        return
