...
// File assets/contracts/MetadventureGen1.sol
...
contract MetadventureGen1 is ERC721Enumerable, ERC721Royalty, VRFConsumerBaseV2, Ownable {
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(msg.value >= cost, "Invalid amount of eth");
    ...
    function setPermanentBaseURI(string memory _newPermanentBaseUri) public onlyOwner {
        baseURI = _newPermanentBaseUri;
    }
