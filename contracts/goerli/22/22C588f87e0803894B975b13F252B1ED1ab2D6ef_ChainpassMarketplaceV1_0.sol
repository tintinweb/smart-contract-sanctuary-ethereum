...
contract ChainpassMarketplaceV1_0 is AuthHelper, ReentrancyGuard {
    ...
    function buyTickets(
        ...
        require(isSigner(attendee, attendeeMetaTXInput), "Incorrect attendee signature.");
        require(isSigner(buyer, buyerMetaTXInput), "Incorrect buyer signature.");
