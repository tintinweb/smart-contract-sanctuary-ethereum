...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.0005 ether;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/pbsajpYofru4L1XX3VCy/contract-metadata";
  }
...
// File: contracts/AsdfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AsdfContract is ERC721APlus {
    constructor() ERC721APlus("asdf", "aa"){}
}
