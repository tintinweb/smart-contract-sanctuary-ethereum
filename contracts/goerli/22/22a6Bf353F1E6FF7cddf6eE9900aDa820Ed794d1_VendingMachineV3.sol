...
contract VendingMachineV3 is Initializable {
  ...
  mapping(address=>uint) sodaBought;
  ...
  function purchaseSoda() public payable {
    ...
    numSodas--;
    sodaBought[msg.sender]+=1;
    // challenge: add a mapping to keep track of user soda purchases!
  }

  function returnSoda(uint _return) public {
    require(sodaBought[msg.sender]>=_return);
    uint val = _return * 1000;
