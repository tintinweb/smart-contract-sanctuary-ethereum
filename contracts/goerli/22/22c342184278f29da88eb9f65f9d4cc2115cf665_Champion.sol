...
contract Champion is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("Champion", "CHAM");
        __Ownable_init();
        __UUPSUpgradeable_init();
    }

    function safeMint(uint8 num, address to) public onlyOwner {
        require(_tokenIdCounter.current() + num <= MAX_ELEMENTS, "Not enough tokens");
