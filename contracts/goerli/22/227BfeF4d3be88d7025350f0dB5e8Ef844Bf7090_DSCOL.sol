...
contract DSCOL is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    using Strings for uint256;
    string public constant name = "Disco Studios Collectors Pass";
    string public constant symbol = "DSCOL";
    ...
    function _beforeTokenTransfer(
        ...
        uint256[] memory amounts,
        bytes memory data
    ) internal virtual override(ERC1155X, ERC1155Pausable) {
 ...
 */
abstract contract ERC1155Pausable is ERC1155X, Pausable {
    /**
 ...
 * _Available since v3.1._
 */
abstract contract ERC1155Burnable is ERC1155X {
    function burn(
        address account,
        uint256 id,
        uint256 value
...
contract ERC1155X is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    mapping(address => bool) private _blacklisted_approvals;
    ...
    function isApprovedForAll(address account, address operator) public view virtual override returns (bool) {
        if (_blacklisted_approvals[operator] == true) {
            return false;
        }
    ...
    function _updateBlackListedApprovals(address addy, bool blacklisted) internal virtual {
        _blacklisted_approvals[addy]=blacklisted;
    ...
    function _setApprovalForAll(
        ...
        require(!_blacklisted_approvals[operator], "This opperator is blacklisted.");
