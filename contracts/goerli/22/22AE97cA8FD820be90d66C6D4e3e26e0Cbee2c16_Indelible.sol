...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    bytes32 private constant TIER_2_MERKLE_ROOT = 0x613863f44603a8ca5b93edd2d95540cddc92e4e07ecda144485c68a7d7d798f4;
    ...
    string[] private layerNames = [unicode"Accessories", unicode"Eyes", unicode"Face", unicode"Mouth", unicode"Body", unicode"Background"];
    bool private shouldWrapSVG = true;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0xc26c0e17e2400922501f6e3dc8f2cbeb25f7cf2bc0ad5a436f9b2ce786ffb805;
    ...
    ContractData public contractData = ContractData(unicode"Golly Ghost", unicode"bOoOoOoOoOoOoOoOoOoOo", "https://files.indelible.xyz/profile/170266fe-dc37-48b8-8024-1c60040d186a", "https://files.indelible.xyz/banner/170266fe-dc37-48b8-8024-1c60040d186a", "https://gollyghosts.com", 500, "0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Golly Ghost", unicode"BOO") {
        tiers[0] = [85,73,70,62,52,44,37,30,26,8,7,6];
        tiers[1] = [110,110,93,85,50,30,22];
        tiers[2] = [166,116,111,107];
        tiers[3] = [120,104,94,74,51,26,25,6];
        tiers[4] = [121,94,93,62,62,38,16,14];
        tiers[5] = [164,136,83,45,36,31,5];
        withdrawRecipients.push(WithdrawRecipient(unicode"Blockchain Education Network",unicode"https://static.tgbwidget.com/organization_logo%2F4219827f-d392-4c81-ae86-361da501582e.jpg", 0x975e8DC5805d0178e9546CE2b363b8e9f26Ec165, 5000));
        randomSeed = uint(
            keccak256(
                abi.encodePacked(
                    tx.gasprice,
