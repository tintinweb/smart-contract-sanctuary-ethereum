...
contract PRT is ERC1155, Ownable, ReentrancyGuard {
    ...
    constructor(address _proxyRegistryAddress) 
        ERC1155(
            "ipfs://QmWewvsPoVdjAiK59ia4KMCL4ZJhBxsMZHdje53ZvphwGd/{id}.json" //default way
    ...
    function mintTest(uint id) external onlyAccounts {
    ...
    //mint with price
     function mintPayable(uint256 tokenID, uint weiPrice) public payable onlyAccounts nonReentrant isNotOwnedNFT {
