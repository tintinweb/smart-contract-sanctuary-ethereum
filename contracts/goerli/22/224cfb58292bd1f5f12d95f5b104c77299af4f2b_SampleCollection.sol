...
// File: contracts/SampleCollection.sol
...
contract SampleCollection is ERC721A, Ownable, ReentrancyGuard, Pausable{
    ...
    // Constructor
    // https://filesite/CID/
    // initialize cid(Pinata, ipfs etc) for baseUri, make sure / is at end and metadata files named as "x.png" "x.json" not "name x.png" etc
    // https://gateway.pinata.cloud/ipfs/CID/
    // initialize pre-reveal cid, baseExtension has to be hidden.json
    ...
    // turn on/off public and whitelist mint
    ...
    // withdraw to owner(), i.e only if msg.sender is owner
    function withdrawCall() external onlyOwner nonReentrant userOnly {
