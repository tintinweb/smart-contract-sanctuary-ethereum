...
contract Ref is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        _name = name_;
        _symbol = symbol_;
        _decimals = 18; // done change here

        totalSupply_ = totalSupply_ * 10**18; // done change here
        ...
        numTokensSellToAddToLiquidity = totalSupply_.div(10**6); // 0.1% done change here
