...
contract TokenMasksLabs is ERC721A, Ownable {
    ...
    ) ERC721A ('ETH MASKS V3','EM'){
        //コレクション名：ETH MASKS、トークンの名前
        setBaseURI('https://bafybeihrxtud6s5ajrjsvlnlzczobthl3rszr3vhjrzmkym7zgs3tjnfem.ipfs.nftstorage.link/');
    }
    ...
    function mint(uint _mintAmount) public payable {
        if(paused) revert("Please specify 1 or more");
        ...
        if(supply + _mintAmount > maxSupply) revert ("max NFT limit exseeded");
