...
contract Project is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(string memory _placeholderTokenURI, bytes32 _merkleRoot, address[] memory _admins) payable ERC721("Testing token 7", "TST") // Will be Board to Death, BTD
    {
