...
contract BlueChipmuskLottery is VRFV2WrapperConsumerBase, ConfirmedOwner {
    ...
    MinimalIERC721 public collection = MinimalIERC721(address(0x0));
    ...
    function setCollectionAddress(address _collectionAddress) public onlyOwner {
        collection = MinimalIERC721(_collectionAddress);
    }
    ...
    function extractWinner() external onlyOwner returns (uint256 requestId) {
