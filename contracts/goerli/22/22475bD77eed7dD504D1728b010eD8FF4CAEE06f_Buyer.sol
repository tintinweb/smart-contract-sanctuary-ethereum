...
contract Buyer is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  uint256 public maxSupply = 5555; // change the max supply
  uint256 public maxMintAmountPerWallet = 5; // change the max Amount per wallet
  uint256 public maxFreeMintAmountPerWallet = 1; // Change the free mint amount per wallet
  uint256 public teamSupply = 300; // change the team supply

  mapping(address => bool) freeMint;

  uint256 public publicMintCost = 0.001 ether; // mint price
