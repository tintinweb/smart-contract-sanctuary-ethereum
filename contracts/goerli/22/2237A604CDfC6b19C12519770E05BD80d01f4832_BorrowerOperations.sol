...
contract BorrowerOperations is DfrancBase, CheckContract, IBorrowerOperations {
    ...
    function openTrove(
        ...
        _requireICRisAboveMCR(vars.asset, vars.ICR); // Normal mode
        ...
        _requireNewTCRisAboveLimit(vars.asset, newTCR);
    ...
    function _adjustTrove(
        ...
        _requireValidAdjustment(vars.asset, _isDebtIncrease, vars);
    ...
    function _triggerBorrowingFee(
        ...
        _DCHFToken.mint(_asset, address(feeContract), DCHFFee);
