...
contract $FutureQuestOG9 is FutureQuestOG9 {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(address couponSigner) FutureQuestOG9(couponSigner) {}
...
contract FutureQuestOG9 is ERC1155PS, ERC2981Base, AccessControl {
  ...
  constructor(address couponSigner) ERC1155PS("") {
    ...
    _setupRole(ADMIN_ROLE, 0xD1Cae96C39635068e7066CACD76046b4D953C307);
