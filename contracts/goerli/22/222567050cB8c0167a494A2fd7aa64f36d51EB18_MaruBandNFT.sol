...
contract MaruBandNFT is Ownable, SalesTimestamps, ERC721A {
  ...
  uint256 private maxPerAddressDuringPrivateMint = 2;
  ...
  // XXX let anyone set the baseURI
    ...
    isInValidPublicSalePeriod
  {
    ...
    require(
      numberMinted(msg.sender) + quantity <= maxPerAddressDuringPrivateMint,
