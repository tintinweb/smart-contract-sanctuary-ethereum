...
contract P5jsOnChainMetadata is ERC721OnChainMetadata {
    constructor()
        ...
        returns (bytes memory)
    {
        return
            abi.encodePacked(
                ...
                '", "',
                'url": "',
                "ipfs://QmT8utUbMh3TJ51tGi37GNw41rTtrgR6EBy6M6Bs8zRvLA",
                '"}'
            );
    }
    ...
    function getContractMetadataJSON() public view returns (bytes memory) {
        return
            abi.encodePacked(
                ...
                '", "',
                'external_link": "',
                "https://github.com/SweetmanTech/p5js-on-chain-metadata",
                '", "',
                ...
                Strings.toHexString(
                    uint256(
                        uint160(0xcfBf34d385EA2d5Eb947063b67eA226dcDA3DC38)
                    ),
                    20
                ),
                '"}'
