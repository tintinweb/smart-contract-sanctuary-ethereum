...
contract Peah is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("Peahgineer Tokens Deploy", "PTEERs Deploy");
        __Ownable_init();
        __UUPSUpgradeable_init();
        _mint(msg.sender, 55505);
    }
