...
contract WinDex is Ownable, ERC721, ERC721Enumerable {
    ...
    constructor (address _win, address _usdt) ERC721("WinDex Ticket", "WINT") Ownable() {
        win = IERC20(_win);
        usdt = IERC20(_usdt);
        ticketPrices[uint8(TicketType.ONE)] = 100000*10**9;
        ticketPrices[uint8(TicketType.TWO)] = 120000*10**9;
        ticketPrices[uint8(TicketType.THREE)] = 150000*10**9;
        ticketPrices[uint8(TicketType.FOUR)] = 180000*10**9;
        ticketPrices[uint8(TicketType.FIVE)] = 200000*10**9;
    }
