...
contract TestOfWill is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("The Test of Will", "TOFW"){}
  ...
  {
    uint cost = price;
    require(msg.sender == tx.origin,"Be yourself, fucker.");
    require(msg.value >= amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more will...");
  ...
  function testBatchMint(uint256 amt) external onlyOwner
  {
