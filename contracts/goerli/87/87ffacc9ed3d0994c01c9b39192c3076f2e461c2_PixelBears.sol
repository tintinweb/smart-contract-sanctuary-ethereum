...
contract PixelBears is IERC2981, ERC721 {
    ...
    modifier mintFunc(uint16 qty, uint maxMintSupply, uint price) {
    ...
    function getSalesStatus() external view returns(bool whitelistEnabled, bool publicEnabled, uint publicSalePrice) {
