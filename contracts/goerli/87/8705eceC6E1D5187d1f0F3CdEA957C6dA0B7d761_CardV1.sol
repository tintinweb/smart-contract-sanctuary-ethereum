...
contract CardV1 is Initializable, UUPSUpgradeable, ERC721Upgradeable, ERC2981, PausableUpgradeable, OwnableUpgradeable {
    /* ==================== VARIABLES SECTION ==================== */
    /**
    ...
    * @notice Maps key => pair value
    *
    * @dev use tier index to fetch supply
    */
    ...
    * @param _prices tier prices of the nft collection
    */
    function initialize
        (
            string memory _name,
    ...
    * @dev Set Mint Limit
    *
    * @param _limit array for limit. the value will be fetched via indexes
    */
