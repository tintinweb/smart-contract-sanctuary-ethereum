...
contract TheAIArtGame is Ownable, ERC2981, ERC721A, ReentrancyGuard {
    ...
    {
        //assigned numbers 1 to 5 to the gladiators randomly, but don't allow the same number to be assigned to two gladiators.
        ...
        else return this.battleArena(gladiators, randomSeed);
        // if (key < 4) return this.battleArena(gladiators, _seed * 2);
        // else return gladiators;
    }

    function grabFiveGladiators(uint256 tokenId) public view returns (uint256) {
