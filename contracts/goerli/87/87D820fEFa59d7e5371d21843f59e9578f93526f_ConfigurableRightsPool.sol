...
contract ConfigurableRightsPool is PCToken, DesynOwnable, DesynReentrancyGuard, WhiteToken {
    ...
    SmartPoolManager.Fund public beginFund;
    SmartPoolManager.Fund public endFund;
    ...
    uint public claimPeriod = 15 minutes;
    ...
    // bool public hasSetCollectEndTime;
    ...
    function exitPool(uint poolAmountIn, uint[] calldata minAmountsOut) external logs lock needsBPool notPaused {
        ...
        if(etype == SmartPoolManager.Etypes.CLOSED && hasSetBeginFund && !hasSetEndFund) snapshotEndAssets();
        ...
        if (etype == SmartPoolManager.Etypes.CLOSED) {
            ...
            if (isCloseEtfCollectEndWithFailure) {
                ...
                // TODO
                require(etfStatus.closureEndTime + 5 minutes <= block.timestamp,"ERR_CLOSURE_TIME_NOT_ARRIVED!");
    ...
    function snapshotBeginAssets() external {
        ...
        // TODO
        require(!hasSetBeginFund && isCompletedCollect && etype == SmartPoolManager.Etypes.CLOSED && nowTime <= (etfStatus.collectEndTime + 15 minutes) , "ERR_CONDITIONS_NOT_MET");

        // TODO
        // bool inT1 = nowTime <= (etfStatus.collectEndTime + 1 days) ;
        bool inT1 = nowTime <= (etfStatus.collectEndTime + 5 minutes) ; // for test
    ...
    function snapshotEndAssets() public {
        ...
        // TODO
        bool inT1 = (etfStatus.closureEndTime + 5 minutes) >= nowTime ; // for test
    ...
    function snapshotAssets() public returns(SmartPoolManager.Fund memory){
        ...
        tempFund.fundAmount = Oracles(oracleAddress).getAllPrice(tempFund.tokens, tempFund.tokensAmount);
