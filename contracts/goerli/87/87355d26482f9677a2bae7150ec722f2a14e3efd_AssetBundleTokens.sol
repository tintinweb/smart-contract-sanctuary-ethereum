...
contract AssetBundleTokens is ERC1155PresetMinterPauser, Ownable, IERC1155Receiver {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(super.uri(index), lookupmap[index])
            );
    }

    function getUserTokenBalanceByAssetBundleId(address account, string calldata assetBundleID) public view returns(uint256 balance) {
        return balanceOf(account, idmap[assetBundleID]);
    }

    function getUserTokenBalanceByIndex(address account, uint256 index) public view returns(uint256 balance) {
        return balanceOf(account, index);
    }

    function getContractTokenBalanceByAssetBundleId(string calldata assetBundleID) public view returns(uint256 balance) {
        return balanceOf(address(this), idmap[assetBundleID]);
    }

    function getContractTokenBalanceByIndex(uint256 index) public view returns(uint256 balance) {
    ...
    function onERC1155Received(address, address, uint256, uint256, bytes memory) override public virtual returns (bytes4) {
        return this.onERC1155Received.selector;
    }

    function onERC1155BatchReceived(address, address, uint256[] memory, uint256[] memory, bytes memory) override public virtual returns (bytes4) {
