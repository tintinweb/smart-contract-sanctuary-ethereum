...
abstract contract AuditInherit {
    ...
    /// ADDRESS OF WHO AUDITED... DESCRIPTION OF CONTRACT AUDITOR GAVE ///
    function auditDetails() external view returns (address auditor_, string memory description_) {
        (auditor_, , , description_, ) = IDatabase(database).audits(address(this));
    }
