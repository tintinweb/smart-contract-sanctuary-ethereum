...
contract lottery {
    ...
    uint start_block = 8336870;
    uint close_block = 8336885;
    ...
    function check_total_user(uint) public view returns(uint) {
        return total_users;
    }

    function check_winners(uint) public view returns(uint) {
        return winners[winning_number];
    }
