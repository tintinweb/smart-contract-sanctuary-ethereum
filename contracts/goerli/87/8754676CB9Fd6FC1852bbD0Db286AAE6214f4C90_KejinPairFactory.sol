...
import {KejinPairETH} from "./KejinPairETH.sol";
import {ICurve} from "./bondingcurve/ICurve.sol";
import {KejinPairERC20} from "./KejinPairERC20.sol";
import {KejinPairCloner} from "./lib/KejinPairCloner.sol";
import {IKejinPairFactoryLike} from "./KejinPairFactoryLike.sol";
import {KejinPairEnumerableETH} from "./KejinPairEnumerableETH.sol";
import {KejinPairEnumerableERC20} from "./KejinPairEnumerableERC20.sol";
import {KejinPairMissingEnumerableETH} from "./KejinPairMissingEnumerableETH.sol";
import {KejinPairMissingEnumerableERC20} from "./KejinPairMissingEnumerableERC20.sol";
///Inspired by 0xmons; Modified from https://github.com/sudoswap/lssvm 
contract KejinPairFactory is Ownable, IKejinPairFactoryLike {
    using KejinPairCloner for address;
    ...
    KejinPairEnumerableETH public immutable enumerableETHTemplate;
    KejinPairMissingEnumerableETH public immutable missingEnumerableETHTemplate;
    KejinPairEnumerableERC20 public immutable enumerableERC20Template;
    KejinPairMissingEnumerableERC20
    ...
    mapping(KejinRouter => RouterStatus) public override routerStatus;
    ...
    event RouterStatusUpdate(KejinRouter router, bool isAllowed);
    ...
    /**
        @notice Checks if an address is a KejinPair. Uses the fact that the pairs are EIP-1167 minimal proxies.
        ...
        returns (bool)
    {
        if (variant == PairVariant.ENUMERABLE_ERC20) {
            return
                KejinPairCloner.isERC20PairClone(
                    address(this),
                    address(enumerableERC20Template),
                    potentialPair
                );
            ...
            return
                KejinPairCloner.isETHPairClone(
                    address(this),
                    address(enumerableETHTemplate),
                    potentialPair
                );
        ...
        onlyOwner
    {
        ...
        if (isAllowed) {
            require(
                !routerStatus[KejinRouter(target)].wasEverAllowed,
                "Can't call router"
            );
        }
    ...
    /**
        ...
        @param isAllowed True to whitelist, false to remove from whitelist
     */
    function setRouterAllowed(KejinRouter _router, bool isAllowed)
        external
        onlyOwner
    {
    ...
    */
    ...
    function depositERC20(
        ...
        if (
            ...
            if (token == KejinPairERC20(recipient).token()) {
...
/**
    ...
    Inspired by 0xmons; Modified from https://github.com/sudoswap/lssvm 
 */
abstract contract KejinPairETH is KejinPair {
    using SafeTransferLib for address payable;
    using SafeTransferLib for ERC20;
...
library KejinPairCloner {
    ...
    /**
     * @notice Checks if a contract is a clone of a KejinPairETH.
     * @dev Only checks the runtime bytecode, does not check the extra data.
     * @param factory the factory that deployed the clone
     * @param implementation the KejinPairETH implementation contract
    ...
    /**
     * @notice Checks if a contract is a clone of a KejinPairERC20.
     * @dev Only checks the runtime bytecode, does not check the extra data.
     * @param implementation the KejinPairERC20 implementation contract
     * @param query the contract to check
     * @return result True if the contract is a clone, false otherwise
     */
...
/**
    ...
    Inspired by 0xmons; Modified from https://github.com/sudoswap/lssvm
 */
contract KejinPairEnumerableETH is KejinPairEnumerable, KejinPairETH {
    /**
    ...
    function pairVariant()
        ...
        returns (IKejinPairFactoryLike.PairVariant)
    {
        return IKejinPairFactoryLike.PairVariant.ENUMERABLE_ETH;
    }
}
...
import {KejinPairETH} from "./KejinPairETH.sol";
import {KejinPairMissingEnumerable} from "./KejinPairMissingEnumerable.sol";
import {IKejinPairFactoryLike} from "./KejinPairFactoryLike.sol";

contract KejinPairMissingEnumerableETH is
    KejinPairMissingEnumerable,
    KejinPairETH
{
    function pairVariant()
        public
        ...
        returns (IKejinPairFactoryLike.PairVariant)
    {
        return IKejinPairFactoryLike.PairVariant.MISSING_ENUMERABLE_ETH;
    }
}
...
contract KejinPairMissingEnumerableERC20 is
    KejinPairMissingEnumerable,
    KejinPairERC20
{
    function pairVariant()
        ...
        returns (IKejinPairFactoryLike.PairVariant)
    {
        return IKejinPairFactoryLike.PairVariant.MISSING_ENUMERABLE_ERC20;
    }
}
...
/**
    ...
    Inspired by 0xmons; Modified from https://github.com/sudoswap/lssvm 
 */
abstract contract KejinPairMissingEnumerable is KejinPair {
