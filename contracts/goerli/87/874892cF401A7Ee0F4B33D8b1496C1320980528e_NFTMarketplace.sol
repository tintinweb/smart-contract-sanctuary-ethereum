...
contract NFTMarketplace is ReentrancyGuard, Ownable {
    ...
    function _createMarketSale(
        ...
        if (Address.isContract(_nftContract) == false || _status != ListingStatus.Active || _conductKey == nullBytes || _conductKey != marketRegistrations[_nftContract]) {
        ...
        if (successSeller == false || successFee == false) {
    ...
    function createBulkMarketSale(
        ...
        if (_conductKeys.length != _prices.length || sum != msg.value) {
    ...
    function cancelSale(
        ...
        if (Address.isContract(_nftContract) == false || _status != ListingStatus.Active || msg.sender != _seller || _conductKey != marketRegistrations[_nftContract] || _conductKey == nullBytes) {
    ...
    function setFeeInfo(
        ...
        if (Address.isContract(_nftContract) == false || temp > 10000) {
