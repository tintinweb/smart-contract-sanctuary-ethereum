...
//fee percentages
    ...
    event BuyPowerVoteETH(uint256 value,uint256 id);
    event BuyPowerVoteERC20(uint256 value,uint256 id,address _tokenContract);
