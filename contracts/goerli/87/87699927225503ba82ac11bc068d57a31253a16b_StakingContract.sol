...
contract StakingContract {
    ...
    event withdrawThreePercentage(address withdrawerAddress, uint256 withdrawAmount);
    event withdrawFivePercentage(address withdrawerAddress, uint256 withdrawAmount);
    event withdrawSevenPercentage(address withdrawerAddress, uint256 withdrawAmount);
    ...
    function LeaveBattle(uint256 count) public {
       ...
       Battle storage battle = battles[count];
        ...
        if(!battle.joined){
            ...
            console.log("loserFinalGenReward: ", loserFinalGenReward);
            console.log("winnerAreenaReward: ", winnerAreenaReward);
            console.log("sendWinnerGenReward: ", sendWinnerGenReward);
            console.log("sendLoserGenReward: ", sendLoserGenReward);
    ...
    function GenWithdraw(uint256 _percentage) external {
        ...
        if(_percentage == 3){
            ...
            genToken.transferFrom(treasuryWallet,address(this),sendgenReward);
            genToken.transfer(msg.sender,sendgenReward);
            player.genAmountPlusBonus -= sendgenReward;

            emit withdrawThreePercentage(msg.sender, sendgenReward);
        }
            ...
            player.genAmountPlusBonus -= sendgenReward;
             ...
             emit withdrawFivePercentage(msg.sender, sendgenReward);
        }
            ...
            emit withdrawSevenPercentage(msg.sender, sendgenReward);
