...
import "./BUMPTokenV2.sol";

///@title BUMP ERC20 Token
contract BUMPTokenV3 is BUMPTokenV2, ERC20VotesUpgradeable {
    using SafeERC20 for IERC20;

    /// @notice Withdraws tokens from BUMP contract
    /// @param tokenAddress - address of token to withdraw
    /// @param amount - amount of token
    /// @param to - where to transfer tokens
    ...
    function transfer(address recipient, uint amount)
        public
        virtual
        override(BUMPTokenV2, ERC20Upgradeable)
        returns (bool)
    {
        return BUMPTokenV2.transfer(recipient, amount);
    }
    ...
    function approve(address spender, uint amount)
        ...
        returns (bool)
    {
        return BUMPTokenV2.approve(spender, amount);
    }
    ...
    function transferFrom(
        ...
        address recipient,
        uint amount
    ) public virtual override(BUMPTokenV2, ERC20Upgradeable) returns (bool) {
        return BUMPTokenV2.transferFrom(sender, recipient, amount);
    }

    /// @notice See ERC20VotesUpgradeable annotaion
...
///@title BUMP ERC20 Token
contract BUMPTokenV3Fixed is BUMPTokenV3 {

    function init() external {
        _initialized = false;
        __ERC20_init("BUMP", "BUMP");
        __ERC20Permit_init("BUMP");
    }
}
...
abstract contract ERC20PermitUpgradeable is Initializable, ERC20Upgradeable, IERC20PermitUpgradeable, EIP712Upgradeable {
    ...
    function __ERC20Permit_init_unchained(string memory) internal {
...
contract Blacklistable is OwnableUpgradeable {
    ...
    modifier onlyBlacklister() {
        require(msg.sender == blacklister, "!blacklister");
        _;
    }
