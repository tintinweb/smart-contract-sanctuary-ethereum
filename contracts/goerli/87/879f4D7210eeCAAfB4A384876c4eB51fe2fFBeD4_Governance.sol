...
// Importar la interfaz del contrato de contador en L2
import "./Counter.sol";

contract Governance {
    address public governor;

    // Crear una variable para almacenar la dirección del contrato de contador en L2
    ...
    function callZkSync(
        ...
        zksync.requestL2Transaction{value: msg.value}(contractAddr, 10000000000000000, data, gasLimit, 0, new bytes[](0), msg.sender);
    }

    // Agregar una función para obtener el valor del contador en L2
