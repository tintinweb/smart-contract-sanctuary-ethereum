...
contract RaffleClone {
    ...
    function createRaffle (
        ...
        uint256 _maxTicketsPerWallet
            ...
            Raffle raffle = Raffle(newRaffleAddress);

            raffle.initialize(_raffleName, _ticketPrice, _totalTickets, _rngesusContract, _raffleCreator, _feeAddresses, _feePercentages, _durationDays, _maxTicketsPerWallet);
...
contract Raffle is ReentrancyGuard, IERC721Receiver, Initializable {
    ...
    function transferNftToRaffle(address _nftContract, uint256 _nftTokenId) public nonReentrant  {
        ...
        IERC721(_nftContract).safeTransferFrom(developer, address(this), _nftTokenId);
    ...
    function returnNftTodeveloper() public  nonReentrant {
        ...
        IERC721(nftContract).safeTransferFrom(address(this), developer, nftTokenId);
