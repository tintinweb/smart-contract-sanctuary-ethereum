...
contract BasicFunctions {
    ...
    // function (string _var1, int _variable2) public view/pure returns(bool) {}
    ...
    // this function uses for loop and multiplies params and string comparison
    ...
    // update a map
    function addCoin(string memory _coin, string memory _symbol, uint _supply) external {
        myCoins[msg.sender] = Coin(_coin, _symbol, _supply);
    }

    // f to get coin from the mapping
