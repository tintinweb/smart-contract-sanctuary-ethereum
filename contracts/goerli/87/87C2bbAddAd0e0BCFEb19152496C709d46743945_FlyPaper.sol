...
contract FlyPaper is Context, IERC20, Ownable {
    ...
    string private _name = "FlyPaper";
    string private _symbol = "STICKY";
    ...
    uint256 private _maxTxAmount = 500000000e9;
    // We will set a minimum amount of tokens to be swaped => 1K
    uint256 private _numOfTokensToExchangeForCharity = 1 * 10 ** 4 * 10 ** 9;
    ...
    function _transfer(
        ...
        // also, don't get caught in a circular charity/marketing event.
    ...
    function _setFlyPaperFee(uint256 charityFee) external onlyOwner {
        require(
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
        require(maxTxAmount >= 5e9, "maxTxAmount should be greater than 5e9");
