...
contract JumboSausage is IERC20Metadata, Ownable, ReentrancyGuard {
    ...
    string constant _name = "Jumbo Sausage";
    string constant _symbol = "JUMBO";
    ...
    uint256 public maxTxAmount = _totalSupply / 25; // 1% of the total supply
