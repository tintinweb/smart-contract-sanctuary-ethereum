...
contract Plants is ERC721PausableUpgradeable, ERC721BurnableUpgradeable, ERC721RoyaltyUpgradeable, OwnableUpgradeable {
  ...
  uint8 private _requirementThreshold;
  ...
  function initialize(address spysContract, string memory initialBaseUri, string memory initialContractUri, address receiver, uint96 amount, uint8 threshold) initializer public {
    __Ownable_init();
