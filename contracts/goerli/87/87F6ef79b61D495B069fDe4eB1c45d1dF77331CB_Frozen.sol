...
contract Frozen is Ownable, ERC721A, ReentrancyGuard {  
    using Strings for uint256;
    
    string private _baseURIextended = "";
    string public unrevealURI = "https://product.mypinata.cloud/ipfs/QmNyeHjK4JHqSQ8h2YDjqwEGkaQN7u8FSWjY9LzfmoFty2";
    ...
    constructor() ERC721A("Frozen NFT", "$FZN") {
        uint256 _preSaleStartTime = block.timestamp;
        saleConfig = SaleConfig(
            _preSaleStartTime,
            _preSaleStartTime + 10,
            0.002 ether,
            0.003 ether,
            2,
            4
