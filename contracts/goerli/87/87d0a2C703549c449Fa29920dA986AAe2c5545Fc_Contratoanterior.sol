...
contract Contratoanterior is ERC721, Ownable {
    ...
    uint256 private constant min_price = 0.00000 ether;
    ...
    constructor(string memory _baseURIextended) ERC721("ContratoAnterior", "CA"){
