          ...
          Base64.encode(
            bytes(
              abi.encodePacked(
                ...
                operatorsSet ? uint2str(uint(poolOperators[0])) : "Not Set",
                '"},{"trait_type": "operator2", "value": "',
                operatorsSet ? uint2str(uint(poolOperators[1])) : "Not Set",
                '"},{"trait_type": "operator3", "value": "',
                operatorsSet ? uint2str(uint(poolOperators[2])) : "Not Set",
                '"},{"trait_type": "operator4", "value": "',
                operatorsSet ? uint2str(uint(poolOperators[4])) : "Not Set",
                '"}], "image": "',
