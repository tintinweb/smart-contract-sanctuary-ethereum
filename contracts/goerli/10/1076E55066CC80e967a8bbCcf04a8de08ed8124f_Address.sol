...
/*
Dwarves were a race of Not-so-Middle-earth also known as the Khazâd (in their own tongue) or Casari, Naugrim, meaning 'Stunted People', and Gonnhirrim, the 'Masters of Stone'. Grumpy Dwarves is a ethereum based blockain project created to bring these dwarves to the Digital Age.
**/
...
contract GrumpyDwarves is ERC721, Ownable {
    ...
    uint constant public MAX_SUPPLY = 20;
    ...
    constructor() ERC721("Grumpy Dwarves", "GC") {
        setHiddenMetadataUri("ipfs://QmQ8ymUG8cX5DaXmXocB3ZN4G2vAHGc5qrFcvemgJf8NqA/hidden.json");
    }
