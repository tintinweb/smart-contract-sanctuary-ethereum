...
import {TypeCasts} from "telepathy-contracts/src/libraries/Typecast.sol";
...
import {TypeCasts} from "../../libraries/Typecast.sol";
...
contract MockTelepathy is ITelepathyBroadcaster {
        ...
        returns (bytes32)
    {
        (Message memory message,, bytes32 messageRoot) =
            _getMessageAndRoot(_recipientChainId, _recipientAddress, _data);
        // console.log("this is the sent nonce and the message chain", sentNonce, message.recipientChainId, address(this));
        sentMessages[++sentNonce] = message;
        // console.log("this is the stuff in the dict",  sentMessages[sentNonce].recipientChainId, address(this));
        return messageRoot;
    }
