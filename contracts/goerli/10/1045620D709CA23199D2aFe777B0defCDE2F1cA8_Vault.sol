...
contract Vault is IVault, VaultManager, VaultGovernance {
    ...
    function initialize(
        ...
        _register(creator);
        emit VaultUserRegistered(creator, _userPublicKeyForEncryption);
    }
    ...
    function register(
        ...
        emit VaultUserRegistered(msg.sender, _userPublicKeyForEncryption);
    }
    ...
    function userCompleteVault(
        ...
        _completeVault();
        emit VaultCompleted(userAddresses, encryptedShares, _masterPubKey);
    }
