...
import { BasePaymaster, GsnTypes, GsnUtils } from "@opengsn/contracts/src/BasePaymaster.sol";
...
contract OzuPaymaster is BasePaymaster {
   ...
   */
  function checkWhitelistMethod(address target, bytes4 method) public view returns (bool) {
