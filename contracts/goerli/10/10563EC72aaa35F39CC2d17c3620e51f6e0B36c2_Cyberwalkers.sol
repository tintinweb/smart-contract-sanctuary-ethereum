...
contract Cyberwalkers is ERC721, Pausable, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Cyberwalkers", "CW") {
        ...
        saleConfig.presaleMintPrice = 0.00008 ether;
        saleConfig.publicSaleMintPrice = 0.0001 ether;
        
        saleConfig.eliteSaleStartTime = 1665050400;
        saleConfig.presaleStartTime = 1665057600;
        saleConfig.publicSaleStartTime = 1665064800;
        saleConfig.freeMintStartTime = 1665072000;
