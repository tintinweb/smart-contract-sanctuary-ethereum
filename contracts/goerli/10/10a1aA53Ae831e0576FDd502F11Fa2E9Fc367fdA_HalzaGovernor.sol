...
contract HalzaGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
    Governor("TokenGovernor")
    GovernorSettings(5 /* 5 block */, 25 /* 5 minutes */, 0)
