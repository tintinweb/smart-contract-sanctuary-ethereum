...
contract W3Card is ERC721AURIStorage, Ownable, ReentrancyGuard {    
     ...
     */
    function mint(address to, uint quantity, string memory cardTier, string memory stampTier, uint transferAmount, uint transferDate, bool isDonation) public virtual payable returns (uint) {
