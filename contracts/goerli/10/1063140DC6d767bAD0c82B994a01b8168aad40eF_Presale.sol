...
contract Presale is Context, Ownable, ReentrancyGuard {
    ...
    function buyTokens() public payable nonReentrant ifPresaleOn {
    ...
    function buyTokensBusd(uint256 busdAmount) public payable nonReentrant ifPresaleOn {
        require(whitelists[_msgSender()], "Privatesale: Wallet is not whitelisted");
        require(_busd.allowance(msg.sender, address(this)) >= busdAmount, "Please approve BUSD amount.");
        ...
        contributionsBusd[_msgSender()] = contributionsBusd[_msgSender()].add(busdAmount);
    ...
    function generalIfo() external view returns(uint256, uint256, uint256){
        ...
        return (_softCap, _hardCap, totalTokenSold);
    }
