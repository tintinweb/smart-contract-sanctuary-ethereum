...
contract CHIZURequestMaker is Initializable, RequestValidator {
    uint40 internal constant TIMELIMIT = 3 minutes;
...
abstract contract RequestValidator is RequestCore {
    ...
    /**
     * @dev The internal function that validate register signature of user and node for currency
     */
    ...
    /**
     * @dev The internal function that validate register signature of user and node for nft
     */
