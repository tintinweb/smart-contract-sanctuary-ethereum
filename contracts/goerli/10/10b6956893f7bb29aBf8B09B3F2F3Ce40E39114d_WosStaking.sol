...
contract WosStaking is OnlyAuthorized, CollateralWrapper {
    ...
    constructor(IERC20 _erc20_contract_address, address _collateral, address _signatureCollateral) CollateralWrapper(_collateral, _signatureCollateral){
    ...
    function distribute() external onlyAuthorized {
        ...
        for (uint256 index = 0; index < stakers.length; index++) {
            ...
            uint256 toTransfer = (percentageDistribute * availableCollateral) / 100;
