      ...
      SVG
        .list(
          [
            ...
            SVG
              .group([SVG.circle(16, 16, 16), SVG.circle(48, 16, 16), SVG.circle(80, 16, 16), SVG.circle(112, 16, 16)])
              .id('dot32_4'),
            SVG
              .group(
                [
            ...
            SVG
              ...
              .id('dot32_1024'),
            SVG.mask('dot32mask', SVG.list([SVG.rect().fill('black'), SVG.use('dot32_1024').fill('white')])),
            SVG.group([SVG.rect().fill('#d5d7e1'), SVG.use(tag0).mask('dot32mask')]).id(tag)
          ]
        )
        .svg()
    );
