...
contract AZGA is ERC721A, ERC2981, OperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PRE_MINT = 6; // This actually means 5 mints but we say 6 for minor gas saving
    ...
    constructor(string memory _cURI, string memory _metaBURI, address _developer, address _treasury) public ERC721A ("AZGA", "Assassin") {
        ...
        _setDefaultRoyalty(_treasury, 750);
    }
