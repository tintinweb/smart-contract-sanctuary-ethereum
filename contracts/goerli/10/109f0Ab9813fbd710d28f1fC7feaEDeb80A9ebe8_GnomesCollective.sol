...
contract GnomesCollective is ERC721Enumerable, Ownable{
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(!walletMints[msg.sender], 'Exceed max wallet');
    ...
    if(whitelisted[msg.sender] != true) {
          require(publicPaused, 'Public _state=false');
          if(msg.sender != owner()){
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function seltWalletMint (address _user, bool _state) public onlyOwner{
