 ...
 */
contract ERC20Handler is Initializable,IDepositExecute, HandlerHelpers, ERC20Safe {
    /**
...
/**
    ...
    @notice This contract is intended to be used with the Bridge contract.
 */
contract HandlerHelpers is Initializable, IERCHandler {
