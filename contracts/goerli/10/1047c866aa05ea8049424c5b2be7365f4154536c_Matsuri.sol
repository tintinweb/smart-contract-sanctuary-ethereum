...
contract Matsuri is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public prerevealURL = 'ipfs://bafybeiarbrlktehltdqm4hb6ys337sjf4g7zgg3rqq7qim3tkklvgcbwlm/unrevealed';
    ...
    constructor() ERC721A("Matsuri Test", "MatsuriT") Ownable() ReentrancyGuard() { }
    ...
    function mint(uint16 quantity) public payable nonReentrant {
        ...
        if (msg.sender != owner()) {
            ...
            require(info.publicSale || info.wlSale, "Sale has not started");
    ...
    modifier onlyContractor() {
        require(msg.sender == _contractor, "Not contractor");
        _;
    }

    bool private withdrawAllowance = false;

    function allowWithdraw() external onlyContractor {
        withdrawAllowance = true;
    }

    function setContractor(address contractor) external {
