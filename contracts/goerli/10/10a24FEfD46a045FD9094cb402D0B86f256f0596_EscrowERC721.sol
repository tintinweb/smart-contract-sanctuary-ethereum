...
contract EscrowERC721 {
  ...
  // for the oracle (NOTE: THIS IS MAINNET POLYGON)
  OptimisticOracleV2Interface oo = OptimisticOracleV2Interface(0xA5B9d8a0B0Fa04Ba71BDD68069661ED5C0848884);
  // bytes
  bytes ancillaryData = bytes("Pago");
  bytes32 identifier = bytes32("Payment");
  ...
  // payment assertion
  function assertpayment() public buyerOnly {
      ...
      // requestTime: already defined block.timestamp
      // ancillaryData: String of status
    ...
    // modifies value
    oo.proposePrice(address(this), identifier, requestTime, ancillaryData, 1e18);
...
// 8:08: 0x98BBC6863D824344F12Fea5aba3F866797f531a7
// 2124: 0x70676D3F1Cd6368f35D611227E01Bf48D13E506D