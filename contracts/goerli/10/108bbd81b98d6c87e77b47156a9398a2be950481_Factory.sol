...
contract Factory{
    ...
    function create(string memory name, string memory symbol) external{
      RewardToken instance = new RewardToken(name, symbol);
      contracts[contractCounter] = address(instance);
      contractCounter ++;
    }
...
contract RewardToken is ERC721{
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory){
        ...
        return "ipfs://QmRdnibKbuDpp1AMsrC7wMGsL1dMvmg2CjEHzriBVPZcQB/jazzPharaoh10.json";
    }
}
