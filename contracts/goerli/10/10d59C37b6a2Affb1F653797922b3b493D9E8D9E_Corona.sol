...
contract CommonUtil{
    ...
    event LogSender(address indexed _sender, address indexed _from, address indexed _receiver, uint256 _value);
...
// ------------------------FOR SIGNER AND SYSTEM WALLET ------------------------
  ...
  requiredTransfer(_sender, _from, _receiver, _amount) returns (bool){
        ...
        emit LogSender(_sender, _from, _receiver, _feePercent);
        _transfer(_from, _receiver, _amount);
        // if(_feePercent == 0){
        //     _transfer(_from, _receiver, _amount);
        //     return true;
        ...
        // _transfer(_from, _receiver, _amount - _fee);
        return true;
  }
