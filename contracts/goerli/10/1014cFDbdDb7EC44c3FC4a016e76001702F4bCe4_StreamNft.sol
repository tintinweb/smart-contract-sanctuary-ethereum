...
contract StreamNft is NftPilarofEducation {
    ...
    mapping(address => mapping(address => bool)) public closeFriends;
    ...
    modifier onlyOwner() {
     ...
     function makeCloseFriend(address to) onlyOwner external {
        closeFriends[msg.sender][to] = true;
    }
    ...
    function mintNft(uint256 value, address _streamer,address _to) public {
        require(closeFriends[_streamer][_to], "sorry we arent that close");
