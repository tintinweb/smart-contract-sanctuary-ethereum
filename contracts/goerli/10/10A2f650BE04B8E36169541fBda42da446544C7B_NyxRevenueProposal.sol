...
contract NyxRevenueProposal is Ownable, converter {
    string public constant name = "Nyx Proposal - Revenue";
        ...
        returns (RevenueProposalParams memory)
    {
        ...
        return RevenueProposalParams(converter.bytesToUint(params[0]),
        ...
        returns (RevenueProposalParams memory)
    {
        ...
        return RevenueProposalParams(converter.bytesToUint(param1), converter.bytesToUint(param2),
            converter.bytesToUint(param3), converter.bytesToUint(param4));
    }
    ...
    function getProposal(bytes memory proposalBytes)
        ...
        returns (bytes[] memory)
    {
        RevenueProposalParams memory params = parseProposalParams2(proposalBytes);
        ...
        returns (bytes[nparams][] memory props)
    {
        ...
        {
            RevenueProposalParams memory params = parseProposalParams2(proposalBytesArr[idx]);
