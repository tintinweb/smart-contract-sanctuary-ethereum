...
contract ArminAAA is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public MAX_PRESALE_SUPPLY = 4000;
    ...
    function mintPreSaleTokens(
        ...
        require(
            _preSaleListCounter[to] + quantity <= maxPresale,
        ...
        require(
            allowlistMinted + quantity <= MAX_PRESALE_SUPPLY,
            "Purchase would exceed max supply of Tokens"
        );
    ...
    // public mint
    function publicSaleMint(address to, uint8 quantity)
        external
        payable
        nonReentrant
        callerIsUser
    ...
    // backup withdraw to owner wallet - only to be used if splits change
