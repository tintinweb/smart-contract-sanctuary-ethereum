...
contract Loony_Pirates is ERC721A, ReentrancyGuard, Ownable {
    ...
    constructor(string memory _unrevealedUri) ERC721A("Loony Pirate's", "LOONY"){
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalMint[msg.sender] +_quantity) <= 3, "Already Minted 3 Times!");
    ...
    function gift(address _to, uint _quantity) external onlyOwner nonReentrant{
