    ...
    PaymentSplitter 
{
    ...
    uint256 _price = 1; // 0.03 ETH  Wieder zurücksetzen 30000000000000000
    uint256 public maxSupply = 6969;

    uint256[] private _teamShares = [50, 50]; // 2 PEOPLE IN THE TEAM
    address[] private _team = [
        0xAd2e70cD1EE5e500d38C369F319c691F3047916B, // 50% Account 1
        0xDC93eF183cc57D877c954514093f984e6ba05a88 // 50% Account 2
    ];

    constructor(string memory uri, address _proxyRegistryAddress, uint256 amount, uint256 startFrom)
    ...
    payable
    {
        ...
        require(msg.sender == tx.origin, "lilshidzb: Can't mint through another contract");
        require(amount <= maxMintsPerAddress);
        require(
