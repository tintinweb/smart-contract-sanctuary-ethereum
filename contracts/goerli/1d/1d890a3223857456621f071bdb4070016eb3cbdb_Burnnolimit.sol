...
contract Burnnolimit is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "burnnilimit";
    string private constant _symbol = "burnnolimit";
