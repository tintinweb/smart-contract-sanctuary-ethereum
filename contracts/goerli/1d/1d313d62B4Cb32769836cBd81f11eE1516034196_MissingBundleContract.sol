    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeic6hyu23vq3sbamwoof4ytvbtcb5ty5qscqjeylhcyqc3stm5hkq4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/QPnPJuMtBdtsW5iFMZDk/contract-metadata";
  }
...
// File: contracts/MissingBundleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MissingBundleContract is RamppERC721A {
    constructor() RamppERC721A("Missing Bundle", "SNEK"){}
}