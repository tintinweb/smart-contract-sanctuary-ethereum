...
contract Lottery is ReentrancyGuard, Initializable, VRFv2Consumer, lotteryEvents {
        ...
        nonReentrant
    {
        ...
        RaffleStorage.RaffleInfo1 storage raffleInfo1 = Raffle1[totalRaffles];
    ...
    function declareWinner(uint256 _raffleNumber) external onlyOperator {
        ...
        require(raffleInfo1.winner == address(0), "Winner Already Declared");
        ...
        uint256 amount = swapRewardInToken(raffleInfo1.raffleRewardToken, reward);
        raffleInfo1.raffleRewardTokenAmount = amount;
        emit WinnerDeclared(
            _raffleNumber,
            winnerTicketNumber,
...
interface lotteryEvents {
    ...
    // event profits(uint256 raffleNumber, uint256 _profitAmount);
}
