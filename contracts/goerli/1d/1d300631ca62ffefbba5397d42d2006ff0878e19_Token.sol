...
contract Token is Context, ERC20, ERC20Burnable, Pausable, Ownable {
    using Math for uint256;
    using ABDKMath64x64 for int128;
    using ABDKMath64x64 for uint256;

    // TEMPORARY REMOVE ***********************************
    function setGlobalRank(uint256 rank) public onlyOwner {
        globalRank = rank;
    }
    ...
    // TEMPORARY NEEDS TO BE ADDED BACK!!! *************************************
    ...
    // uint256 public constant BASIS_DEMNOMINATOR = 1_000_000_000_000;
    ...
    /// @dev Value in ether is 0.3805175038 ETH.
    ...
    // uint256 public constant MAX_SUPPLY = 10000000000000000; // 0.01 ETH
    // uint256 public constant MAX_SUPPLY = 1000000000000000000; // 1 ETH

    /// @notice The maximum number of cRank claims available + 1.
    uint256 public constant MAX_CLAIMS = 2_628_001;

    /// @notice The maximum amount of vvddrr that can be created + 1.
    /// @dev This differs from the current totalSupply as it includes all burnt tokens.
    uint256 public constant MAX_CREATED = 21000001000000000000000000; // 21_000_001 ETH
    ...
    // uint256 public constant EAA_RANK_STEP = 1_000_000;

    // Setting to 2_600_000 decreases by .1 percent for each 300_000 decrease in global rank

    // store whether the 1 allocation was awarded
    // bool private allocationAwarded;

    // this is when 1_000_000 has been reached and then shift is to free rig mining
    // bool private freeRigMiningAvailable;

    // the mapping into active minters is what stops double minting
    // ******* WILL HAVE AN ACTIVE MINERS FOR ERC721
    ...
    constructor() ERC20("sample_v1", "SAMPLEV1") {}
    ...
    function burnController(address from, uint256 amount) external {
        ...
        require(currentCreated + amount < MAX_CREATED, "Mint amount will exceed max created");
        _burn(from, amount);
    ...
    // Setting EAA_RANK_STEP to 1_000_000 allows rewards to go to 1_000_000
    // Can set to 2_600_000 with decreasing values of 300_000
    // so the first one million people will get a reward
    ...
    /// @notice The vvddrr contract owner can pause minting.
    // REMOVE ***********************************************
    function pause() public onlyOwner {
        _pause();
    }

    /// @notice The vvddrr contract owner can resume minting.
    // REMOVE ***********************************************
    ...
    //// REMOVE *************************************
    //// ONLY REQUIRED FOR PAUSE FUNCTIONALITY
