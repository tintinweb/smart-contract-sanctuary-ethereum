 ...
 * @notice This contract handles minting 10-22-22 deployment fixes tokens.
 */
contract Launchpad102222DeploymentFixes is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0x6ab23d49027f2661F7CB05D4319107374d539C71;
    address[] public payoutAddresses = [
        0x6ab23d49027f2661F7CB05D4319107374d539C71
    ];
    bool public isPublicSaleActive = false;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeiffhnp5lkvmjql57vcxp5hg6cjiky5rqn2kpy6tidk4gxbxqlpukq/";
    ...
    constructor() ERC721A("10-22-22 deployment fixes", "TEST") {
