...
/******************************** basic concepts *************************
 *  get price in eth, decimals: 18
 *  get price in usd, decimals: 8
 ******************************** basic concepts *************************/
...
contract ChainlinkPriceOracleV3 is BasePriceOracle {
    ...
    */
    ...
    //refer to: https://docs.chain.link/docs/feed-registry/
    ...
    function getEthUsdPrice() external view returns (uint256, uint8) {
        ...
        uint8 decimals = feedRegistry.decimals(Denominations.ETH, Denominations.USD);
        require(answeredInRound == roundId, "Chainlink round timed out.");

        return (uint256(priceUSD), decimals);
    }

    /**
     * @dev Returns the price in ETH of `token`
     * @return price in ETH, decimals
     */
    function getTokenEthPrice(address token) external view override returns (uint256, uint8) {
        return _price(token);
    }
     ...
     */
    function _price(address underlying) internal view returns (uint256, uint8) {
        // Return 1e18 for WETH
        if (underlying == WETH) return (1e18, 18);
        ...
        returns (
            ...
            require(answeredInRound == roundId, "Chainlink round timed out.");
            if (tokenEthPrice <= 0) return (0, 0);

            // console.log("tokenEthPrice:", uint256(tokenEthPrice));
