...
contract HSDev3 is ERC721A, DefaultOperatorFilterer721, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    uint256 projectWalletBal = balance * 35 / 100;
    uint256 founderBal = balance * 30 / 100;
    uint256 artistBal = balance * 20 / 100;
    uint256 communityManagerBal = balance * 5 / 100;
    uint256 developerBal = balance * 10 / 100;

    (bool ps, ) = payable(0xBEb40E2a5a2536DD4E5C432a253f09420EAe9D18).call{value: projectWalletBal}('');
    require(ps);

    (bool fs, ) = payable(0xBEb40E2a5a2536DD4E5C432a253f09420EAe9D18).call{value: founderBal}('');
    require(fs);

    (bool cs, ) = payable(0xBEb40E2a5a2536DD4E5C432a253f09420EAe9D18).call{value: artistBal}('');
    require(cs);

    (bool ms, ) = payable(0xBEb40E2a5a2536DD4E5C432a253f09420EAe9D18).call{value: communityManagerBal}('');
    require(ms);

    (bool ds, ) = payable(0xBEb40E2a5a2536DD4E5C432a253f09420EAe9D18).call{value: developerBal}('');
    require(ds);
