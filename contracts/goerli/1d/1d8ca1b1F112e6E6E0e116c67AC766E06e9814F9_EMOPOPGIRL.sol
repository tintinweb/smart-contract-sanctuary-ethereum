...
contract EMOPOPGIRL is ERC721A, ERC2981 , Ownable, Pausable {
    ...
    uint256 public publicMintMax = 300;
    // uint256 public publicMaxPerTx = 300;
    uint256 constant public MAX_SUPPLY = 10000;

    address public royaltyAddress;
    uint96 public royaltyFee = 1000;
    address constant private DEFAULT_ROYALITY_ADDRESS = 0x914d78f78AD8b2Ed20fa8718c08a44Fd9b89cb04;
        ...
        callerIsUser
    {
        ...
        require(saleState == PRE_SALE_FLAG, "PreSale is not active.");
        ...
        require(
            _preMintClaimed[msg.sender] + _mintAmount <= _preMintMax,
            "Already claimed max"
        );
        ...
        callerIsUser
    {
        ...
        require(
            _tsubasaMintClaimed[msg.sender] + _mintAmount <= _tsubasaMintMax,
            "Already claimed max"
        );
        // require(
        ...
        callerIsUser
    {
        ...
        // require(_mintAmount <= publicMaxPerTx,
        //     "Mint amount over"
        // );
        require(
            _publicMintClaimed[msg.sender] + _mintAmount <= publicMintMax,
            "Already claimed max"
        );
    ...
    function withdrawTeamShare() external onlyOwner {
        ...
        address artist = payable(0xf12ed8C04c5ba0cBeB40B4602320940EE92c90b2);
        address admin = payable(0xb84e9eb4D635e0682d207D34d64A93817A0006e0);
        bool success;
        (success, ) = artist.call{value: (sendBalance * 900/1000)}("");
        require(success, "Failed to withdraw for artist");
        (success, ) = admin.call{value: (sendBalance * 100/1000)}("");
        require(success, "Failed to withdraw for admin");
    }
