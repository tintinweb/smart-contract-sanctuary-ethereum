...
contract DescriptorBBC is IDescriptor, Ownable {
    ...
    string private _baseURL = "https://arweave.net/MG52sdjiZEJAj_7IerEHQhbiXYKCKrFgQD74sdy4pJo/";
    string private _baseURLVeil = "https://arweave.net/MG52sdjiZEJAj_7IerEHQhbiXYKCKrFgQD74sdy4pJo/";
    string private _imageExt = ".png";
    string private _imageExtVeil = ".jpg";
    string private _name = "BabyBunta 2nd collection";
    ...
    function tokenURI(uint256 tokenId) external view override returns(string memory){
        ...
        if (revealed) {
            ...
            imageId = (uint256(keccak256(abi.encodePacked("BBC#", tokenId))) % 3).toString();
        }
        ...
        return string.concat(
            ...
            _description,
            '","image":"',
            _baseURLVeil, imageId, _imageExtVeil,
            '","attributes":{}}'
        );
