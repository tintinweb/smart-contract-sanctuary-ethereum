...
contract Auction is Ownable {
    ...
    function finalizeAuction() public onlyOwner ownerOwnsNft auctionDidntDie {
        ...
        require(biddingCurrency.allowance(getHighestBidder(), address(this)) >= getHighestBidAmount(), 'buyer hasnt approved enough token');
    ...
    function getAuctionStatus() public view returns (string memory message) {
        if (auctionDied) message = 'auction died, go away';
...
contract FrenchToastken is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("FrenchToastken", "FTK") {
...
pragma solidity ^0.8.14;
contract FrenchToastFlavors is ERC721, Ownable {
   using Counters for Counters.Counter;
