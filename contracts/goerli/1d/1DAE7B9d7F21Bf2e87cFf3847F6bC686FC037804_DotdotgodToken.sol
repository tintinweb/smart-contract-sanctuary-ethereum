...
// File: @openzeppelin/contracts-[email protected]/proxy/utils/Initializable.sol
...
contract DotdotgodToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, ERC20FlashMintUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("DotdotgodToken", "$DDGT");
        __ERC20Burnable_init();
        __ERC20Snapshot_init();
        __AccessControl_init();
        __Pausable_init();
        __ERC20Permit_init("DotdotgodToken");
        __ERC20Votes_init();
        ...
        _mint(msg.sender, 1990062836193515 * 10 ** decimals());
