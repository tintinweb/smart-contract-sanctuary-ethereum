...
contract NFT is ERC721URIStorage, Ownable{
    ...
    string public Name="MY Fungible Token";
    ...
    uint256 public mintingRate = 0.0005 ether;
     
     constructor() ERC721(Name, Symbol) {
               nftowner = payable(msg.sender);

     }
     function NFTattributes(string memory _name, string memory _symbol) public{
        Name = _name;
        Symbol = _symbol;
     } 

     function getAttributes() public view returns(string memory, string memory){
        return (Name, Symbol);
     }
    ...
    function setMaxSupply(uint256 supply)public{
     Maxsupply = supply;
    ...
    function setMintingRate(uint256 rate)public{
      mintingRate = rate;
    }
