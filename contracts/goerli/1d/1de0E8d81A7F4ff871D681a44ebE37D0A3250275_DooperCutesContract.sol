...
//
//     ____                              ______      __           
//    / __ \____  ____  ____  ___  _____/ ____/_  __/ /____  _____
//   / / / / __ \/ __ \/ __ \/ _ \/ ___/ /   / / / / __/ _ \/ ___/
//  / /_/ / /_/ / /_/ / /_/ /  __/ /  / /___/ /_/ / /_/  __(__  ) 
// /_____/\____/\____/ .___/\___/_/   \____/\__,_/\__/\___/____/  
//                  /_/                                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xa47c7B6061edb2226A2E81C7C51d6349581743FF];
  address public erc20Payable = 0xa47c7B6061edb2226A2E81C7C51d6349581743FF;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 145) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicff6f4khjwdbrmd5haejeyrqthpeylz2ulamkhzxsmqmdvgoyh3q/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hnjkb03LErWOq2qNyLWu/contract-metadata";
  }
...
// File: contracts/DooperCutesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DooperCutesContract is RamppERC721A {
    constructor() RamppERC721A("DooperCutes", "DOOP"){}
}
