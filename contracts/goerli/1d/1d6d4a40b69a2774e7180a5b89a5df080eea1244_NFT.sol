...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("Knight Catz", "KnightCat") {
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= MAX_MINT_PER_TX, "You cannot mint more than 3 in one transaction.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xF2ddB2107bC008dfcd0fEB9982dD3206cb2CEcf8).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xF2ddB2107bC008dfcd0fEB9982dD3206cb2CEcf8).call{value: balanceTwo}("");
