...
contract Vincents is Ownable, ERC721A, ReentrancyGuard, Pausable{
    ...
    uint16 public collectionSize = 10000;
    uint16 public maxBatchSize = 100;
    bool private _isRevealed = false;
    
    string private _blindboxURI; //= "ipfs://bafybeihmw4oi4ff35szzhvum5wvcyjvlojy3ih7kr26oq5ziyiecszaf3a";

 
    string  private _baseTokenURI; // = "ipfs://bafybeiasifdqxiqiqe5vx2jutv3ra6wkfy3j42xnga5hndbvahdkfq4fbq/";
    ...
    */
    ...
    constructor(string memory name,
       ...
       saleStages[0].startTime = 0;
       saleStages[0].price = 0.1 ether;
       saleStages[0].maxSupply = collectionSize;
       saleStages[1].startTime = 0;
       saleStages[1].price = 0.08 ether;
       saleStages[1].maxSupply = collectionSize;
       saleStages[2].startTime = 0;
       saleStages[2].price = 0.09 ether;
