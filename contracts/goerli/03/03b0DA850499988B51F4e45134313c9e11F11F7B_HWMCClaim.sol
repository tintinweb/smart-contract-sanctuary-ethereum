...
contract HWMCClaim is Pausable, Ownable {
    ...
    ERC20 public usdcAddress = ERC20(0x326C977E6efc84E512bB9C30f76E30c160eD06FB);
    ERC20 public wbtcAddress = ERC20(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6);  
   ...
   struct Reward {
    ...
    function claimReward (uint256[] memory _nftId, uint256 _dropId)  public {
        ...
        for(uint i = 0 ; i<_nftId.length; i++) {
            ...
            address isOwner = IERC721(0x3fD1605cbE36a816F6EE7876043690b436ce76d9).ownerOf(_nftId[i]);
        ...
        usdcAddress.transfer(msg.sender,_nftId.length*Rewards[_dropId].eachUSDC);
        wbtcAddress.transfer(msg.sender,_nftId.length*Rewards[_dropId].eachwBTC);


        if(airDropIdNo>1 && _dropId <airDropIdNo){
            Rewards[_dropId].remUSDC -= _nftId.length*Rewards[_dropId].eachUSDC;
            Rewards[_dropId].remwBTC -= _nftId.length*Rewards[_dropId].eachwBTC;
        }  
