...
contract SYUUPT is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
	...
	function showMyName() public pure returns (string memory)
	{
        string memory ggString = "MyName";
		return ggString;
	}
}