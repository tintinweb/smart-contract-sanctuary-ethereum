...
contract Lassygoerli {
    ...
    // create a public variable called normalAddress that is an address and is accessible by any part of this contract, and retrievable by anyone who calls this contract
    ...
    // ensure that normalsLength is properly defined and declared as a public variable of type uint256 and begins with a value of 0
    uint256 public normalsLength;

    // ensure that bigsLength is properly defined and declared as a public variable of type uint256 and begins with a value of 0
    uint256 public bigsLength;

    // ensure that biggestsLengths is properly defined and declared as a public variable of type uint256 and begins with a value of 0
    ...
    // function that allows anyone to return the entire alltickets array
    ...
    function chooseWinner() external {
        ...
        payable(0x13e8bB335B5d267cfab6C7326778c0cd7A254049).transfer(address(this).balance);
