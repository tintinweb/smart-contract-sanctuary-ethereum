...
// SPDX-License-Identifier: MIT
// ERC721A OpenSea Contracts v1.0.0
// Creator: FDHightech
...
contract GeometricVision is ERC721A, Ownable {

    uint256 private immutable collection_size;
    string private baseURI;
    using Strings for uint;

    constructor(string memory _collectionName, string memory _collectionSymbol, uint256 _collection_size, string memory _baseURI) ERC721A(_collectionName, _collectionSymbol) {
    ...
    function contractURI() public pure returns(string memory) {
        return "ipfs://bafybeidcwwbqlwoxckvzd64uepcevhklyce3vhu3t3gfwdwymnhf2bh7eq/CollectionMetadata.json";
    }
