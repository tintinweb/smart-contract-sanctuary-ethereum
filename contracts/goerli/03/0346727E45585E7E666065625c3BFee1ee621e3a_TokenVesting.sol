...
contract TokenVesting is Ownable {
    ...
    function getNextVesting(string memory _vestingScheduleName) public view returns (Vesting memory) {
        ...
        uint256 termsPassed = getVestingSchedulePassedDuration(_vestingScheduleName) / vestingSchedule.terms;
    ...
    /**
     * @dev Returns the amount of tokens that can be withdrawn from contract
     ...
     */
    function getVestingSchedulePassedDuration(string memory _vestingScheduleName) internal view returns (uint256) {
        VestingSchedule memory vestingSchedule = vestingSchedules[_vestingScheduleName];
        ...
        returns (uint256)
    {
        ...
        return ((getVestingSchedulePassedDuration(_vestingScheduleName) / vestingSchedule.terms) * allocationPerTerm);
    }
