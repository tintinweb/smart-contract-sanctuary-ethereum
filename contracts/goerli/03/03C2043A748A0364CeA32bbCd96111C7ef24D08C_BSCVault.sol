...
contract BSCVault is AccessControl, ReentrancyGuard, EIP712 {
    ...
    constructor(
        ...
        signer = _signer;
        _setRoleAdmin(SIGNER_ROLE, BIG_GUARDIAN_ROLE);
    ...
    function grantSigner(address _signer) public onlyRole(BIG_GUARDIAN_ROLE) {
