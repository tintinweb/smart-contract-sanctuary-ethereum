...
contract OPGPrivateSale is Ownable {
    ...
    event BuyOPG(address buyer, uint256 amountOfETH, uint256 amountOfTokens);
    event SendOPG(
        address buyer,
        uint256 mainBalance,
    ...
    function buyTokens() public payable {
        ...
        emit BuyOPG(msg.sender, msg.value, amountToBuy);
    }
