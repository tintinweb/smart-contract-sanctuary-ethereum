...
contract GoonsPack is ERC721, Mintable {
    int public packsMinted = 0;
    int public MAX_PACKS = 78800;
    ...
    function _mintFor(
        ...
        require(packsMinted < MAX_PACKS, "Max supply reached, cannot mint any more");
        _safeMint(user, id);
        packsMinted += 1;
    }
