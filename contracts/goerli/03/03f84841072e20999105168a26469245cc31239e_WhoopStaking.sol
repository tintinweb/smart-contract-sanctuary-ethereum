...
contract WhoopStaking is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    // Interfaces for ERC20 and ERC721
    IERC20 public immutable rewardsToken;
    IERC721 public immutable nftCollection;
    IERC721 public immutable upgradeCollection;
    ...
    // Mapping of Upgrade Item Power Levels
    uint[] public powerLevels;
    // Mapping of Faction By Token ID
    uint[] private factions;
    ...
    constructor(IERC721 _nftCollection, IERC721 _upgradeCollection, IERC20 _rewardsToken) {
        nftCollection = _nftCollection;
        upgradeCollection = _upgradeCollection;
        rewardsToken = _rewardsToken;
    }

    function setWeaponPowerLevels(uint[] calldata _powerLevels) external onlyOwner {
        for (uint256 i = 0; i < _powerLevels.length; i++) {
            powerLevels.push(_powerLevels[i]);
        }
    }
