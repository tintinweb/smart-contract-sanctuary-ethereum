...
// Date of creation: 2022-05-26T13:12:29.764Z
...
contract Maskies is ERC721Psi, Pausable, Ownable, ReentrancyGuard, WhiteList {
    ...
    event FlipPreSaleState(bool newState);
    event FlipPublicSaleState(bool newState);
    ...
    function mint(address minter, uint256 maxMints, uint256 amount, bytes32[] memory proof) external payable whenNotPaused nonReentrant {
        ...
        //
        // It is assumed that is presale is always before a public sale
        // and that a presale will not be activated after the public sale has started.
