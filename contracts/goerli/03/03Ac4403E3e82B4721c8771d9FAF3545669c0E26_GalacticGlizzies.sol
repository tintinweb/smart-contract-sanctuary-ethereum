    ...
    ERC2981
{
    ...
    uint256 public price = 0.01666 ether;

    bytes32 public ogMerkleRoot;
    bytes32 public starseedMerkleRoot;
        ...
        ERC721A("Galactic Glizzies", "GLIZZ")
    {
        ...
        starseedMerkleRoot = _starseedMerkleRoot;
    ...
    modifier verifyProof(bytes32[] calldata _merkleProof, bytes32 merkleRoot) {
    ...
    function setStarseedMerkleRoot(bytes32 _starseedMerkleRoot) external onlyOwner {
        starseedMerkleRoot = _starseedMerkleRoot;
    }
    ...
    function mintOG(bytes32[] calldata _merkleProof, uint256 _amount)
        ...
        verifyProof(_merkleProof, ogMerkleRoot)
    ...
    function mintStarseed(bytes32[] calldata _merkleProof, uint256 _amount)
        external
        payable
        verifySaleStage(SaleStage.Starseed)
        verifyProof(_merkleProof, starseedMerkleRoot)
