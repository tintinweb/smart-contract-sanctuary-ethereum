...
import "./interfaces/IOrganisationRegistry.sol";

import "./interfaces/ITokenV1.sol";
import "./interfaces/ITokenV1UUPSUpgradeable.sol";
import "./interfaces/IDAOV1Staking.sol";
import "./interfaces/IDAOV1StakingUUPSUpgradeable.sol";
import "./interfaces/IDAOV1Governance.sol";
import "./interfaces/IRewardsEscrowV1.sol";
import "./interfaces/IRewardsEscrowV1UUPSUpgradeable.sol";
import "./interfaces/IDAOV1Rewards.sol";
import "./interfaces/IDAOV1RewardsUUPSUpgradeable.sol";
...
import "./interfaces/IVestingV1Epochs.sol";
import "./interfaces/IVestingV1EpochsUUPSUpgradeable.sol";
import "./interfaces/IVestingV1Cliffs.sol";
import "./interfaces/IVestingV1CliffsUUPSUpgradeable.sol";
import "./interfaces/IAirdropV1Simple.sol";
import "./interfaces/IAirdropV1SimpleUUPSUpgradeable.sol";
import "./interfaces/IAirdropV1Gamified.sol";
import "./interfaces/IAirdropV1GamifiedUUPSUpgradeable.sol";

contract OrganisationRegistry is IOrganisationRegistry, Initializable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function createOrganisation(string memory _name) public {
        ...
        require(Strings.isAlphanumeric(_name), "OrganisationRegistry: organisation name must be alpha-numeric");
    ...
    function deployTokenV1(
        ...
        if (upgrader == address(0)) {
            ...
            token = factory.deployModuleUUPS{value : msg.value}(
                Modules.TOKEN_V1,
                abi.encodeWithSelector(
                    ITokenV1UUPSUpgradeable.initializeUUPS.selector,
                    cfg,
                    roleAdmin,
                    upgrader
                )
        ...
        emit OrganisationAddedModule(id, Modules.TOKEN_V1, upgrader != address(0), token);
    }
    ...
    function deployDAOV1Staking(
        ...
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        _requireModuleExists(org.tokenV1);
        _requireModuleNotExists(org.daoV1.staking);
        ...
        if (upgrader == address(0)) {
            daoStaking = factory.deployModuleClone{value : msg.value}(
                ...
                abi.encodeWithSelector(
                    IDAOV1Staking.initialize.selector,
                    IDAOV1Staking.DAOStakingConfig(org.tokenV1),
                    roleAdmin
                )
            );
        } else {
            daoStaking = factory.deployModuleUUPS{value : msg.value}(
                Modules.DAO_V1_STAKING,
                abi.encodeWithSelector(
                    IDAOV1StakingUUPSUpgradeable.initializeUUPS.selector,
                    IDAOV1Staking.DAOStakingConfig(org.tokenV1),
                    roleAdmin,
                    upgrader
                )
        ...
        org.daoV1.staking = daoStaking;
        org.modules.push(Modules.DAO_V1_STAKING);

        emit OrganisationAddedModule(id, Modules.DAO_V1_STAKING, upgrader != address(0), daoStaking);
    }

    function deployDAOV1Governance(
        bytes32 id,
        IDAOV1Governance.GovernanceConfig memory cfg,
        bool upgradeable
    ) public payable {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        _requireModuleExists(org.daoV1.staking);
        _requireModuleNotExists(org.daoV1.governance);

        cfg.daoStakingAddr = org.daoV1.staking;
        ...
        if (!upgradeable) {
            governance = factory.deployModuleClone{value : msg.value}(
                ...
                abi.encodeWithSelector(
                    IDAOV1Governance.initialize.selector,
                    cfg
                )
            );
        } else {
        ...
        org.daoV1.governance = governance;
        org.modules.push(Modules.DAO_V1_GOVERNANCE);

        emit OrganisationAddedModule(id, Modules.DAO_V1_GOVERNANCE, upgradeable, governance);
    }
    ...
    function deployRewardsEscrowV1(
        ...
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        _requireModuleNotExists(org.rewardsEscrowV1);
        ...
        if (upgrader == address(0)) {
            rewardsEscrow = factory.deployModuleClone{value : msg.value}(
                ...
                abi.encodeWithSelector(
                    IRewardsEscrowV1.initialize.selector,
                    roleAdmin
                )
            );
        } else {
            rewardsEscrow = factory.deployModuleUUPS{value : msg.value}(
                Modules.REWARDS_ESCROW_V1,
                abi.encodeWithSelector(
                    IRewardsEscrowV1UUPSUpgradeable.initializeUUPS.selector,
                    roleAdmin,
                    upgrader
                )
            );
        ...
        org.rewardsEscrowV1 = rewardsEscrow;
        org.modules.push(Modules.REWARDS_ESCROW_V1);

        emit OrganisationAddedModule(id, Modules.REWARDS_ESCROW_V1, upgrader != address(0), rewardsEscrow);
    }

    function deployDAOV1Rewards(
        bytes32 id,
        IDAOV1Rewards.RewardsConfig memory cfg,
        address roleAdmin,
        address upgrader
    ) public payable {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        ...
        cfg.daoStaking = org.daoV1.staking;
        ...
        if (upgrader == address(0)) {
            rewards = factory.deployModuleClone{value : msg.value}(
                ...
                abi.encodeWithSelector(
                    IDAOV1Rewards.initialize.selector,
                    cfg,
                    roleAdmin
                )
            );
            ...
            rewards = factory.deployModuleUUPS{value : msg.value}(
                Modules.DAO_V1_REWARDS,
                abi.encodeWithSelector(
                    IDAOV1RewardsUUPSUpgradeable.initializeUUPS.selector,
                    cfg,
                    roleAdmin,
                    upgrader
                )
        ...
        org.daoV1.rewards.push(rewards);

        emit OrganisationAddedModule(id, Modules.DAO_V1_REWARDS, upgrader != address(0), rewards);
    }

    function deployYieldFarmingV1Staking(
        bytes32 id,
        IYieldFarmingV1Staking.StakingConfig memory cfg,
        address roleAdmin,
        address upgrader
    ) public payable {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        _requireModuleNotExists(org.yieldFarmingV1.staking);

        address staking;
        if (upgrader == address(0)) {
            staking = factory.deployModuleClone{value : msg.value}(
                Modules.YIELDFARMING_V1_STAKING,
                abi.encodeWithSelector(
                    IYieldFarmingV1Staking.initialize.selector,
                    cfg,
                    roleAdmin
                )
            );
            ...
            staking = factory.deployModuleUUPS{value : msg.value}(
                Modules.YIELDFARMING_V1_STAKING,
                abi.encodeWithSelector(
                    IYieldFarmingV1StakingUUPSUpgradeable.initializeUUPS.selector,
                    cfg,
                    roleAdmin,
                    upgrader
                )
        ...
        org.modules.push(Modules.YIELDFARMING_V1_STAKING);
        org.yieldFarmingV1.staking = staking;

        emit OrganisationAddedModule(id, Modules.YIELDFARMING_V1_STAKING, upgrader != address(0), staking);
    }

    function deployYieldFarmingV1Pool(
        bytes32 id,
        IYieldFarmingV1Pool.PoolConfig memory cfg,
        address roleAdmin,
        address upgrader
    ) public payable {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        _requireModuleExists(org.yieldFarmingV1.staking);
        _requireModuleExists(org.rewardsEscrowV1);

        cfg.stakingAddress = org.yieldFarmingV1.staking;
        cfg.rewardsEscrowAddress = org.rewardsEscrowV1;

        address pool;
        if (upgrader == address(0)) {
            pool = factory.deployModuleClone{value : msg.value}(
                Modules.YIELDFARMING_V1_POOL,
                abi.encodeWithSelector(
                    IYieldFarmingV1Pool.initialize.selector,
                    cfg,
                    roleAdmin
                )
            );
            ...
            pool = factory.deployModuleUUPS{value : msg.value}(
                Modules.YIELDFARMING_V1_POOL,
                abi.encodeWithSelector(
                    IYieldFarmingV1PoolUUPSUpgradeable.initializeUUPS.selector,
                    cfg,
                    roleAdmin,
                    upgrader
                )
        ...
        _pushModuleIfNotExists(org, Modules.YIELDFARMING_V1_POOL);
        org.yieldFarmingV1.pools.push(pool);

        emit OrganisationAddedModule(id, Modules.YIELDFARMING_V1_POOL, upgrader != address(0), pool);
    }

    function deployVestingV1Epochs(
        bytes32 id,
        IVestingV1Epochs.VestingEpochsConfig memory cfg,
        address roleAdmin,
        address upgrader
    ) public payable {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        ...
        if (upgrader == address(0)) {
            vesting = factory.deployModuleClone{value : msg.value}(
                Modules.VESTING_V1_EPOCHS,
                abi.encodeWithSelector(
                    IVestingV1Epochs.initialize.selector,
                    cfg,
                    roleAdmin
                )
            );
            ...
            vesting = factory.deployModuleUUPS{value : msg.value}(
                Modules.VESTING_V1_EPOCHS,
                abi.encodeWithSelector(
                    IVestingV1EpochsUUPSUpgradeable.initializeUUPS.selector,
                    cfg,
                    roleAdmin,
                    upgrader
                )
        ...
        _pushModuleIfNotExists(org, Modules.VESTING_V1_EPOCHS);
        org.vestingV1.epochs.push(vesting);

        emit OrganisationAddedModule(id, Modules.VESTING_V1_EPOCHS, upgrader != address(0), vesting);
    }

    function deployVestingV1Cliffs(
        bytes32 id,
        IVestingV1Cliffs.VestingCliffsConfig memory cfg,
        address roleAdmin,
        address upgrader
    ) public payable {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        ...
        if (upgrader == address(0)) {
            vestingCliffs = factory.deployModuleClone{value : msg.value}(
                Modules.VESTING_V1_CLIFFS,
                abi.encodeWithSelector(
                    IVestingV1Cliffs.initialize.selector,
                    cfg,
                    roleAdmin
                )
            );
            ...
            vestingCliffs = factory.deployModuleUUPS{value : msg.value}(
                Modules.VESTING_V1_CLIFFS,
                abi.encodeWithSelector(
                    IVestingV1CliffsUUPSUpgradeable.initializeUUPS.selector,
                    cfg,
                    roleAdmin,
                    upgrader
                )
        ...
        _pushModuleIfNotExists(org, Modules.VESTING_V1_CLIFFS);
        org.vestingV1.cliffs.push(vestingCliffs);

        emit OrganisationAddedModule(id, Modules.VESTING_V1_CLIFFS, upgrader != address(0), vestingCliffs);
    }

    function deployAirdropV1Simple(
        bytes32 id,
        IAirdropV1Simple.AirdropConfig memory cfg,
        address roleAdmin,
        address upgrader
    ) public payable {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        ...
        if (upgrader == address(0)) {
            airdropSimple = factory.deployModuleClone{value : msg.value}(
                Modules.AIRDROP_V1_SIMPLE,
                abi.encodeWithSelector(
                    IAirdropV1Simple.initialize.selector,
                    cfg,
                    roleAdmin
                )
            );
            ...
            airdropSimple = factory.deployModuleUUPS{value : msg.value}(
                Modules.AIRDROP_V1_SIMPLE,
                abi.encodeWithSelector(
                    IAirdropV1SimpleUUPSUpgradeable.initializeUUPS.selector,
                    cfg,
                    roleAdmin,
                    upgrader
                )
        ...
        _pushModuleIfNotExists(org, Modules.AIRDROP_V1_SIMPLE);
        org.airdropV1.simple.push(airdropSimple);

        emit OrganisationAddedModule(id, Modules.AIRDROP_V1_SIMPLE, upgrader != address(0), airdropSimple);
    }

    function deployAirdropV1Gamified(
        bytes32 id,
        IAirdropV1Gamified.AirdropGamifiedConfig memory cfg,
        address roleAdmin,
        address upgrader
    ) public payable {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);
        ...
        if (upgrader == address(0)) {
            airdropGamified = factory.deployModuleClone{value : msg.value}(
                Modules.AIRDROP_V1_GAMIFIED,
                abi.encodeWithSelector(
                    IAirdropV1Gamified.initialize.selector,
                    cfg,
                    roleAdmin
                )
            );
            ...
            airdropGamified = factory.deployModuleUUPS{value : msg.value}(
                Modules.AIRDROP_V1_GAMIFIED,
                abi.encodeWithSelector(
                    IAirdropV1GamifiedUUPSUpgradeable.initializeUUPS.selector,
                    cfg,
                    roleAdmin,
                    upgrader
                )
        ...
        _pushModuleIfNotExists(org, Modules.AIRDROP_V1_GAMIFIED);
        org.airdropV1.gamified.push(airdropGamified);

        emit OrganisationAddedModule(id, Modules.AIRDROP_V1_GAMIFIED, upgrader != address(0), airdropGamified);
    }

    function removeYieldFarmingV1Pool(bytes32 id, uint256 index, address poolAddr) public {
        Organisation storage org = _getOrganisationWithOwnerOrRevert(id, msg.sender);

        require(org.yieldFarmingV1.pools[index] == poolAddr, "OrganisationRegistry: pool address does not match");

        uint256 last = org.yieldFarmingV1.pools.length - 1;
        if (index != last) {
            org.yieldFarmingV1.pools[index] = org.yieldFarmingV1.pools[last];
        }
        org.yieldFarmingV1.pools.pop();

        if (org.yieldFarmingV1.pools.length == 0) {
            _removeModule(org, Modules.YIELDFARMING_V1_POOL);
        }

        emit OrganisationRemovedModule(id, Modules.YIELDFARMING_V1_POOL, poolAddr);
    }
    ...
    function getOrganisationModules(bytes32 id) external view returns (bytes32[] memory) {
    ...
    function _removeModule(Organisation storage org, bytes32 module) internal {
        ...
        if (found) {
            if (index != org.modules.length - 1) {
                org.modules[index] = org.modules[org.modules.length - 1];
            }
            org.modules.pop();
        }
    }
...
interface IOrganisationRegistry {
    ...
    struct YieldFarmingV1Config {
        address staking;
        address[] pools;
    }

    struct VestingV1Config {
        address[] epochs;
        address[] cliffs;
    }

    struct AirdropV1Config {
        address[] simple;
        address[] gamified;
    }
    ...
    struct Organisation {
        ...
        DAOV1Config daoV1;
        YieldFarmingV1Config yieldFarmingV1;
        VestingV1Config vestingV1;
        AirdropV1Config airdropV1;
    }
}
...
interface ITokenV1UUPSUpgradeable is ITokenV1 {
    function initializeUUPS(ITokenV1.TokenConfig memory cfg, address roleAdmin, address upgrader) external;
}
...
import "./IDAOV1Staking.sol";

interface IDAOV1StakingUUPSUpgradeable is IDAOV1Staking {
...
import "./IDAOV1Rewards.sol";

interface IDAOV1RewardsUUPSUpgradeable is IDAOV1Rewards {
...
import "./IVestingV1Epochs.sol";

interface IVestingV1EpochsUUPSUpgradeable is IVestingV1Epochs {
    function initializeUUPS(
        VestingEpochsConfig memory cfg,
        address roleAdmin,
        address upgrader
    ) external;
}
...
import "./IVestingV1Cliffs.sol";

interface IVestingV1CliffsUUPSUpgradeable is IVestingV1Cliffs {
    function initializeUUPS(
...
import "./IAirdropV1Simple.sol";

interface IAirdropV1SimpleUUPSUpgradeable is IAirdropV1Simple {
...
import "./IAirdropV1Gamified.sol";

interface IAirdropV1GamifiedUUPSUpgradeable is IAirdropV1Gamified {
