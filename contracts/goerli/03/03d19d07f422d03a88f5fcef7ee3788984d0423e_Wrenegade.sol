...
contract Wrenegade is Authorized, ERC1155Supply, PaymentSplitter {
    ...
    */
    ...
    {
        if (_tokenID == 0) {
            require(diamondCheck(msg.sender), "mint: Not eligible to mint");
        }
    ...
    */
    function mintTo(
        ...
        if (_tokenID == 0) {
            require(diamondCheck(_to), "mintTo: Not eligible to mint");
        }
    ...
    */
    function diamondCheck(address _address) internal view returns (bool) {
