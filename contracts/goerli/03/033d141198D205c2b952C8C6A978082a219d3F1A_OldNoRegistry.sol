...
contract OldNoRegistry is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    function registerAndSubscribeToRegistry(address subscription, address operatorFilterRegistry) external onlyOwner {
        IOperatorFilterRegistry registry = IOperatorFilterRegistry(operatorFilterRegistry);
