...
contract LPStakingV4 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function getDyanmicAPR(
        ...
        return (((ETHPerDay * _ETHUSD) / _totalLpStaked) * APRTime * 100 * 1000)/10**18;
    }
    ...
    function calculateReward(
        ...
        reward =
            stakeDetail.reward +
            _calculateReward(_stakeHolder, _dId, _ethUSD, _mpwrUSD, _amount, _totalLpStaked, isProrata);
    }
    ...
    function stake(
        ...
        bool dynamic = poolPeriodEth[_poolId][_period] == 0 ? false : true;
    ...
    function withdraw(
        ...
        uint256 reward = _calculateReward(msg.sender, _dId, _ethUSD, _mpwrUSD, _stake, _totalLpStaked, isForceWithdraw);
