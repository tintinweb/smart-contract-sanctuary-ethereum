...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
     ...
     *
     */
    function creatorOf(uint256 _id) public view virtual returns (address) {
        // return address(uint160(_id >> (INDEX_BITS + SUPPLY_BITS)));
        return address(uint160(_id % 10**50));
    }
     ...
     *
     */
    function totalSupplyCapOf(uint256 _id)
        public
        view
        virtual
        returns (uint256)
...
contract NFTVastSharedCollection is ERC1155, Ownable {
    string public baseURI;

    constructor(string memory _baseURI) ERC1155("NFTVastToken") {
        baseURI = _baseURI;
    }
