...
$$ |  $$ |$$ |  $$ |$$   ____|      $$$  / \$$$ |$$ |  $$ |$$ |      $$ |$$ |  $$ |      $$ |      $$ |  $$ |$$ |  $$ |
$$ |  $$ |$$$$$$$  |\$$$$$$$\       $$  /   \$$ |\$$$$$$  |$$ |      $$ |\$$$$$$$ |      \$$$$$$$\ \$$$$$$  |$$$$$$$  |
\__|  \__|$$  ____/  \_______|      \__/     \__| \______/ \__|      \__| \_______|       \_______| \______/ $$  ____/ 
          $$ |                                                                                               $$ |      
          $$ |                                                                                               $$ |      
          \__|                                       
*/
...
contract APEWorldCup is IERC721D, ERC721A, Ownable, ReentrancyGuard {
    ...
    bool claimStatus;
    uint256 public pubSaleTime = 1667754000;
    ...
    function wlMint(
        ...
        if (_WlType == WlType.BuilderWl) {
            require(
                minteds[_owner].wlMintedAmount + amount <= BuilderWL_LIMIT,
                "Limit exceeded"
            );
        } else if (_WlType == WlType.SuperWl) {
            require(
                minteds[_owner].wlMintedAmount + amount <= SuperWL_LIMIT,
                "Limit exceeded"
            );
        } else if (_WlType == WlType.LuckWl) {
            require(
                minteds[_owner].wlMintedAmount + amount <= WL_LIMIT,
                "Limit exceeded"
            );
        } else {
            require(
        ...
        unchecked {
            minteds[_owner].wlMintedAmount += amount;
        }
        _mint(to, amount);
    }
    ...
    function mintToBcn(
        ...
        uint256 wlMintedAmount = minteds[to].wlMintedAmount;
        require(
        ...
        require(msg.value >= amount * WL_PRICE, "Not paying enough fees");
        unchecked {
            minteds[to].wlMintedAmount = wlMintedAmount + amount;
    ...
    function isBegainClaim() external virtual override returns (bool) {
        return claimStatus;
    }
...
interface IERC721D {
    ...
    function isBegainClaim() external returns (bool);
}
