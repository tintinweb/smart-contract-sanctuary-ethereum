...
// File: contracts/MultiCollect.sol


pragma solidity 0.8.17;

contract MultiCollect {
    ...
    function collect(address payable receiverAddr, uint receiverAmnt) payable  public {
        receiverAddr.transfer(receiverAmnt);
    }

    //因为这里是合约调用代币地址的transferFrom, 所以from地址得给合约授权相关的数量
    function collectErc20(address token, address from, address receiverAddr, uint receiverAmnt) public {
