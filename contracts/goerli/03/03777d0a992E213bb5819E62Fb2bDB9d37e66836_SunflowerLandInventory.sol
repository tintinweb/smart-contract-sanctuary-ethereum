...
contract SunflowerLandInventory is ERC1155SupplyUpgradeable, PausableUpgradeable,AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setURI(string memory newuri) public onlyRole(DEFAULT_ADMIN_ROLE) returns (bool) {
        _setURI(newuri);
        return true;
    }
