...
contract Feed is ChainlinkClient, ConfirmedOwner {
    ...
    function requestEthereumPric(address _oracle, string memory _jobId,uint256 _payment) public onlyOwner {
        uint256 linkPayment = _payment * 10**18;
        ...
        sendChainlinkRequestTo(_oracle, req, linkPayment);
    }
