...
contract PRoyaltyContract is ERC721AQueryable, Ownable{
    ...
    event MD5HashTokenProvidedToCustomers(address customers,string token, string hashFile);
    ...
    function provideHashAndTokenToCustomers(address customers,string calldata token) external onlyAuthor() {

        emit MD5HashTokenProvidedToCustomers(customers, token, md5FileHash);
    }
