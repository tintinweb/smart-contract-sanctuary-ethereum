...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDCToken = IBEP20(0xdD69DB25F6D620A7baD3023c5d32761D353D3De9);
...
contract GoerliMoon is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Goerli Moon";                             //Contract By TechAddict YT
    string constant _symbol = "GOON";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address USDCToken = 0xdD69DB25F6D620A7baD3023c5d32761D353D3De9; 

    uint256 _totalSupply = 1000000000000 * 10**12 * (10 ** _decimals);
