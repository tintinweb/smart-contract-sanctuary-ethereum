...
contract DAO is ERC721A, Pausable, Ownable {
    ...
    uint256 public OG_PRICE = 0.03 ether;
    ...
    string public preRevealURI = "https://google.com/traka";
    ...
    function mint(address to, uint256 quantity) external payable {
        ...
        require(quantity + current_supply <= TOTAL_SUPPLY, "Max supply reached");
        if (current_supply < 42) {
            require(
                msg.value >= (OG_PRICE * quantity),
                "Transaction value did not equal the mint price"
            );
        } else if (current_supply < 420) {
            require(
