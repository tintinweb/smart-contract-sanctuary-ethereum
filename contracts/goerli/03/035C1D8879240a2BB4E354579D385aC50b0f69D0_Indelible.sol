...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Eyes", unicode"Head", unicode"Mouth", unicode"Fur", unicode"Background"];
    ...
    uint public publicMintPrice = 0.0055 ether;
    string public baseURI;
    bool public isPublicMintActive;
    uint public allowListPrice = 0.0033 ether;
    uint public maxPerAllowList = 4;
    bool public isAllowListActive;

    ContractData public contractData = ContractData(unicode"The Camels - 12 Days of Xmas Giveaway", unicode"The Camels NFT is a fun pixel art Camel which takes inspiration from Cryptopunks, Saudis and Habibiz and gives back to some of my favorite communities that have been helpful to me in the form of giveaways of their NFTs. Additionally the Camels will be donating a portion of proceeds to Riley's Children's Hospital Endowment in the USA, automatically on chain using the Giving Block. Minting a Camel could grant you a Christmas gift of 1 of 12 NFTs valued from 1.6 to 0.06 Eth. For each of 12 days a trait will be picked and hinted at on twitter. The wallets holding that trait will be put into a raffle for the 12 prizes which are: 1x Otherdeed, 1x Chimper, 2x Ethlizards, 1x Dre's Alpha VIP Pass, 1x On Chain Kevin, 2x Saudis and 2x Habibiz and 2x Fat Cats DAO. The grand prize (Otherdeed) will only be upon successful mint out, all others trigger every 370 mints starting with the lowest prize going up.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/75fb131d-b709-4f73-92f0-bd7741488a5f", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/75fb131d-b709-4f73-92f0-bd7741488a5f", "", 500, "0xDf5b5259586E003b30ba911f4541F904305272CE");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"The Camels - 12 Days of Xmas Giveaway", unicode"The Camels") {
        tiers[0] = [50,72,79,128,140,163,189,219,225,340,358,367,408,414,420,423,449];
        tiers[1] = [10,58,98,125,300,369,400,450,488,530,535,536,545];
        tiers[2] = [291,407,635,676,691,825,919];
        tiers[3] = [50,420,700,742,801,852,879];
        tiers[4] = [454,509,570,572,575,576,583,605];
        withdrawRecipients.push(WithdrawRecipient(unicode"Riley Children's Endowment",unicode"https://static.tgbwidget.com/organization_logo/998b6a33-b110-4c88-9b44-d2ed2a14298a.jpg", 0x9908D253bC44CD9F702cd3a71a3d61dAcEEaa728, 500));
        withdrawRecipients.push(WithdrawRecipient(unicode"null",unicode"null", 0xaFc89A56589297E8E35EEF242f88953021b6F943, 9500));
        randomSeed = uint(
            keccak256(
                abi.encodePacked(
                    tx.gasprice,
