 ...
 * @title Test_E
 */
contract EgoNFT is ERC721,ERC721Enumerable,ERC721URIStorage , Ownable {
    using Counters for Counters.Counter;
    mapping(address => bool) private _minters;
    bool public whitelist_active = false;
    bool public sale_active = true;//false;
    string public contract_ipfs_json;
    Counters.Counter private _tokenIdCounter;
    uint256 public minting_price = 0.008 ether;//0.08 ether;
    uint256 public HARD_CAP = 10000;
    uint256 public SOFT_CAP = 9500;
    uint256 public MAX_AMOUNT = 5;
    bytes32 public MERKLE_ROOT;
    bool public is_collection_revealed = true;//false;
    bool public is_collection_locked = false;
    string public notrevealed_nft = "https://ipfs.io/ipfs/QmNmNpPoYE5yowvbSZZdWN1b98rcskzgKriyeKvPY3P6NJ";//"https://ipfs.io/ipfs/Qm......./unrevealed.json";
    string public contract_base_uri = "https://ipfs.io/ipfs/QmRoL5CyS6rHXFXxMazwLCZ5Xtr21u5gbA1WFnByyicGaA/";//"https://ipfs.io/ipfs/";
    address public vault_address;
    mapping(address => uint) public walletMints;

     // Address of the royalties recipient
    address private _royaltiesReceiver=0xB57ce9f0996C8a08a809B7eAF178B53112714d42;
    ...
    */
    function buyNFT(address recipient,uint256 numberOfNFTs ,bytes32[] calldata _merkleProof) public payable {
        ...
        require(
            canMint && numberOfNFTs % minting_price == 0,
            "Sorry you can't mint right now"
        );
        uint256 amount = numberOfNFTs / minting_price;
        require(
    ...
    function royaltiesReceiver() public view returns(address,uint256) {
        return (_royaltiesReceiver,royaltiesPercentage);
    }
    ...
    function setRoyaltiesReceiver(address newRoyaltiesReceiver,uint256 newRoyaltiesPercentage )
    external onlyOwner {
