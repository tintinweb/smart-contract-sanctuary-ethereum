...
contract JellyMaps is ERC721 {
  ...
  constructor(
    string[] memory mapNames,
    string[] memory mapImageURIs
  ) ERC721("JellyMaps", "JYMP")
  {
    for(uint i = 0; i < mapNames.length; i += 1) {
      defaultMaps.push(MapAttributes({
        levelIndex: i,
        name: mapNames[i],
  ...
  function mintMapNFT(uint _levelIndex) external {
    ...
    console.log("Minted NFT w/ tokenId %s and levelIndex %s", newItemId, _levelIndex);
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    function checkIfUserHasNFT() public view returns (MapAttributes memory) {
      ...
      // Else, return an empty map.
        ...
        MapAttributes memory emptyStruct;
        return emptyStruct;
      }
    }
