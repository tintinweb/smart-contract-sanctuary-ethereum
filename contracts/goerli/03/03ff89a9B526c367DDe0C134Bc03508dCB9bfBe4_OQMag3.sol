...
contract OQMag3 is ERC721, Ownable, PaymentSplitter {
  ...
  uint256 public finalMaxSupply = 500;
  ...
  constructor(address[] memory _payees, uint256[] memory _shares) PaymentSplitter(_payees, _shares) payable ERC721("OQ Magazine", "OQ")  {
    setHiddenMetadataUri("https://owmag.mypinata.cloud/ipfs/QmTLtQE7X4UAEjv5SXJjV3nqmstWH9iywQbmQzKiughgz2/hiddenMeta.json");
  }
  ...
  function preSale(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
        require(isAllowlistAddress[msg.sender], "Address is not allowlisted");
        require(!paused, "The contract is paused!");
        require(msg.value >= cost * _mintAmount / 2, "Insufficient funds!");
  ...
  function preSaleMint(uint256 _mintAmount) private mintCompliance(_mintAmount) {
    require(!paused, "The contract is paused!");
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    function adminMint(uint256 _mintAmount) public onlyOwner mintCompliance(_mintAmount) {
