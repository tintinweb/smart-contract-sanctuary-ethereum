...
contract Vendor is Ownable {
  ...
  event SelTokens(address seller, uint256 amountOfETH, uint256 amountOfTokens);
  ...
  function withdraw() external onlyOwner {
    ...
    require(balance > 0, "Balance is equal zero");
  ...
  function sellTokens(uint256 amount) external {
    uint256 userAllowance = yourToken.allowance(msg.sender, address(this));
    require(userAllowance >= amount, "Allowance exceeded");
    ...
    emit SelTokens(msg.sender, amount / tokensPerEth, amount);
  }
}
