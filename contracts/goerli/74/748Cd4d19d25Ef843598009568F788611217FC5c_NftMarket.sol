...
contract NftMarket is Ownable {
    ...
    event askChanged(address nftAddress, uint256 tokenId, uint256 newAsk);
    ...
    function changeAsk(
        ...
        if (getBondState(_tokenId, _tokenAddress) == 3) {
            ...
            emit askChanged(_tokenAddress, _tokenId, _newAsk);
        }
    }
