...
contract VRFD20 is VRFConsumerBaseV2 {
    ...
    function lottery_in(uint256 number) public payable {
        require(number > 0 && number < 101, "winning number range: 1~100");
    ...
    function lottery_set() public {
        require(msg.sender == s_owner, "Only the owner can set the lottery winning number");
