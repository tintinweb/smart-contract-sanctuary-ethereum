...
contract OCASnake is Ownable, ERC721A, ERC2981, ReentrancyGuard, OCASnakeArt {
    ...
    function recursiveCompareArrayCreation(
        ...
        } else return [array[0], array[1], array[2], array[3]];
    }
    ...
    function recursiveNameFind(
        ...
        bool found;
        uint256[] memory arr;
        uint256[4] memory compareArray = recursiveCompareArrayCreation(
            index,
            seed,
            arr
        );
        ...
        if (index < 1997 && !found) {
        ...
        } else if (found && tokenId < index) {
            uint256 supremeIndex = (generateAppleSeed(tokenId, seed) %
                supremeAdjectives.length);
            snakeNameIndexes[0] = (420 + tokenId) % 17;
            snakeNameIndexes[1] = (69 + tokenId) % 250;
            ...
            return setNameToString(snakeNameIndexes, "");
        }
    }
