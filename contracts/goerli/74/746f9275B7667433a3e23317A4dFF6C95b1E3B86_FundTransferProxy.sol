  ...
  UUPSUpgradeable
{
   ...
   */
  function depositNativeTokenToVault(address sender) external payable virtual override {
    require(sender != address(0), "FundTransferProxy:depositETHToVault invalid sender");
   ...
   */
  function transferNativeTokenFromVault(address to, uint256 amount)
    external
    virtual
    override
    onlyAdmin
