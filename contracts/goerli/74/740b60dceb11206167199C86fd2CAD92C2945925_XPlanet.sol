...
contract XPlanet is ERC721Enumerable, Ownable {
    ...
    IERC20 usdc = IERC20(USDC_CONTRACT);
    ...
    function allow( uint256 _price ) public returns (address){
    ...
    function mint(uint256 _numberOfTokens) public {
        ...
        uint256 _amount = MINT_PRICE * _numberOfTokens;
        ...
        require( balanceOfUsdc(msg.sender) >= _amount, "not-enough-usdc" );
        ...
        usdc.transferFrom(sender, address(this), _amount * 1000000);
        ...
        for (uint256 i = 0; i < _numberOfTokens; i++) {
            if (totalSupply() < MAX_SUPPLY) {
                ...
                usdc.transferFrom( address(this), sender,  (_numberOfTokens - i) * MINT_PRICE * 1000000); 
                break;
            }
        }
    }
    ...
    function withdraw() external onlyOwner{
        ...
        usdc.transferFrom(address(this), FEES_RECEIVER, balance);
