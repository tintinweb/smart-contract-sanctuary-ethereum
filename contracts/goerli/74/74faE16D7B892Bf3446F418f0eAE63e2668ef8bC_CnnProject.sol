...
contract CnnProject is ERC721A, Ownable, DefaultOperatorFilterer{
    ...
    constructor(
    ) ERC721A ('CNN / CryptoNinja Nouns','CNN'){ // コレクション名：　CNN / CryptoNinja Nouns、　トークンの名前：CNN
        setBaseURI('https://bafybeieenjaqxksrsuli4ev3hxfylj5p65vy2hbzpjanzwti35kvnramdy.ipfs.nftstorage.link/');
    }
    // チェック
