...
contract TokenFarm is Ownable {
    ...
    function unstakeToken(address _token) public {
        ...
        require(balance > 0, "Staking balacne can't be 0!");
    ...
    function loopStakers(address _staker) internal view returns (uint256) {
    ...
    function removeStaker(address _staker) internal {
        uint256 stakerIndex = loopStakers(_staker);
