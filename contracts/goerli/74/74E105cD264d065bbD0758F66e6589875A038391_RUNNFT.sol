...
contract RUNNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PRICE = 1000000000000000000 * 0.1; // 你要出售的价格0.1 ETH
    uint256 public MAX_SUPPLY = 10000; // 生成NFT的数量
    address[] private distributions;
    string private baseURI;

    constructor() ERC721("RUN NFT", "RUN") {
        baseURI = "https://ipfs.nftr.run/ipfs/QmY8v5y8XaoRg38nQn35rPaqiGxGhSgGjufaVDzb2qdjaH/"; // 填写您的baseURI
    }
