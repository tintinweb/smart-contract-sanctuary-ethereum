    ...
    Ownable
{
    ...
    function publicSaleMint(
        ...
        require(totalSupply() + _amount <= maxSupply, "SUPPLY_EXCEEDED");
        require(msg.value >= publicSalePrice, "INSUFFICIENT_FUND");
    ...
    function withdrawAll() external onlyOwner {
        ...
        uint256 walletABalance = address(this).balance * 2625 / 1000;
        uint256 walletBBalance = address(this).balance * 3000 / 1000;
        uint256 walletCBalance = address(this).balance * 875 / 1000;
        uint256 walletDBalance = address(this).balance * 3500 / 1000;
