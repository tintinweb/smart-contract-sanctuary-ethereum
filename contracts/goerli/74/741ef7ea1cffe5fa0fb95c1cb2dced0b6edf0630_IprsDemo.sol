 ...
 * simply including this module, only once the modifiers are put in place.
 */
abstract contract FeaturePausable is Context {
    /**
     * @dev Emitted when the pause is triggered by `account`.
     */
    ...
    /**
     * @dev By default the contract's feature is in unpaused state as bool defaults to false;
     */
    // constructor() {
    //     // _paused = false;
    // }
    ...
    function _requireFeatureNotPaused(bytes32 feature) internal view virtual {
        require(!featurePaused(feature), "Pausable: paused");
    }
    ...
    function _requireFeaturePaused(bytes32 feature) internal view virtual {
        require(featurePaused(feature), "Pausable: not paused");
    }
...
import "./FeaturePausable.sol";

/**
 * @title IPRS demo
 * @custom:security-contact [email protected]
 */
contract IprsDemo is ERC20, Pausable, FeaturePausable, AccessControl, ERC20Permit, ERC20FlashMint {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 public constant FLASH_MINT_PAUSER_ROLE = keccak256("FLASH_MINT_PAUSER_ROLE");

    bytes32 public constant FLASH_MINT_FEATURE = keccak256("FLASH_MINT_FEATURE");

    constructor() ERC20("IPRS demo", "IPRS") ERC20Permit("IPRS demo") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        _grantRole(BURNER_ROLE, msg.sender);
        _grantRole(FLASH_MINT_PAUSER_ROLE, msg.sender);
    }
    ...
    function flashMintPause() public onlyRole(FLASH_MINT_PAUSER_ROLE) {
        _pauseFeature(FLASH_MINT_FEATURE);
    }

    function flashMintUnpause() public onlyRole(FLASH_MINT_PAUSER_ROLE) {
    ...
    function flashLoan(
        ...
        uint256 amount,
        bytes calldata data
    ) public override whenNotPaused whenFeatureNotPaused(FLASH_MINT_FEATURE) returns (bool) {
