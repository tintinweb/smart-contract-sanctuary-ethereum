...
contract Blokemon is ERC721Enumerable, Ownable{
    ...
    function _pickRandomUniqueId(uint256 random) public returns (uint256 id) {
    ...
    function mint(uint256 quantity_) public payable {
        ...
        require(mintedWallets[msg.sender] + quantity_ <= maxPerWallet, 'exceed max wallet');
        ...
        for(uint256 i; i < quantity_; i++){
            ...
            totalAmount++;
            uint256 tokenId = _pickRandomUniqueId(25);
