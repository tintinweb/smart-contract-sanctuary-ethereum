...
contract TMinter is Context, IERC20, Ownable, Pausable {
  ...
  constructor(string memory name_, string memory symbol_, uint8 decimal, uint256 totalsupply, address _owner) Pausable() {
    _name = name_;
    _symbol = symbol_;
   _decimals = decimal;
