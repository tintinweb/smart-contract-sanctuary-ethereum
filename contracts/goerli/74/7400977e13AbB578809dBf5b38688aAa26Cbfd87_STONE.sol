...
contract STONE is ERC20, AccessControl, ReentrancyGuard {
    ...
    constructor(address _owner) ERC20("STONE", "STONE") {
        ...
        teamWallet = address(0xF28b147045665722665713510903FafB08C14c33);
        publicWallet = address(0x8F7C056f42F34bC30e2281B4131Ed9F13d4EB19e);
        liquidityWallet = address(0x0234b6Be6722CE2c9E827D1d717644A3B3977EFe);
        treasuryWallet = address(0x9AEf500f3275e77bc9881fDF0a0AcDB53636f01d);
