...
// @author: g56d
//
// Primes is a series of 1575 unique NFTs based on the advent of prime numbers,
// a collection of scalable, animated and interactive digital art generated on-chain.
// Human interaction creates and renews the unique experience of Primes, of harmony in disorder.
...
contract Primes is ERC721r, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 1575 + 1; // 0
    uint256 public gifts = 75;
    ...
    mapping(uint256 => Row) public Stats;
    ...
    // test only //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    function mintAtIndex(uint256 _serial) public onlyOwner {
        _mintAtIndex(owner(), _serial);
    }
    ...
    function setStatsMap() internal {
        Row memory n1 = Row("1", "0.06");
        Stats[1] = n1;
        Row memory n2 = Row("4", "0.25");
        Stats[2] = n2;
        Row memory n3 = Row("29", "1.84");
        Stats[3] = n3;
        Row memory n4 = Row("64", "4.06");
        Stats[4] = n4;
        Row memory n5 = Row("135", "8.57");
        Stats[5] = n5;
        Row memory n6 = Row("224", "14.22");
        Stats[6] = n6;
        Row memory n7 = Row("317", "20.13");
        Stats[7] = n7;
        Row memory n8 = Row("316", "20.06");
        Stats[8] = n8;
        Row memory n9 = Row("225", "14.29");
        Stats[9] = n9;
        Row memory n10 = Row("146", "9.27");
        Stats[10] = n10;
        Row memory n11 = Row("68", "4.32");
        Stats[11] = n11;
        Row memory n12 = Row("25", "1.59");
        Stats[12] = n12;
        Row memory n13 = Row("14", "0.89");
        Stats[13] = n13;
        Row memory n14 = Row("2", "0.13");
        Stats[14] = n14;
        Row memory n15 = Row("3", "0.19");
        Stats[15] = n15;
        Row memory n16 = Row("1", "0.06");
        Stats[16] = n16;
        Row memory n22 = Row("1", "0.06");
        Stats[22] = n22;
    }

    function getNumerator(uint256 _k)
        external
        view
        returns (string memory numerator)
    {
        numerator = Stats[_k].numerator;
    }

    function getPercentage(uint256 _k)
        external
        view
        returns (string memory percentage)
    {
        ...
        returns (string memory)
    {
        ...
        string
            memory description = "Primes is the first collection of scalable, animated and interactive vector graphics NFTs on-chain by g56d";
        // string[] memory stats;
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(
                    '<svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 900 900" width="900px" height="900px">',
                    title,
                    ...
                    paths = concatenate(
                        ...
                        string(
                            abi.encodePacked(
                                ...
                                count.toString(),
                                'ms" ',
                                setAnimationEvent(index, _tokenId),
                                '="click"></animate></path>'
                            )
                        )
                    );
    ...
    function randomOI(uint256 _seed, uint256 _salt)
        internal
        view
        returns (uint256 number)
    {
        number =
            uint256(
                keccak256(abi.encodePacked(msg.value, msg.sender, _seed, _salt))
            ) %
            2;
    }

    function setAnimationEvent(uint256 _seed, uint256 _salt)
        internal
        view
        returns (string memory initAnimation)
    {
    ...
    function isPrime(uint256 _n) public pure returns (bool) {
        uint256 p = sqrt(_n);
