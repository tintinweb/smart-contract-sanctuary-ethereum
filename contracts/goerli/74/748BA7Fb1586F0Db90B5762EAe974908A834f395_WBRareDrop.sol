  ...
  UUPSUpgradeable
{
    ...
    function initialize(address _owner) initializerERC721A initializer public {
        __ERC721A_init("WBRD", "WBRD");
        __Ownable_init();
    ...
    function claimItems(
        ...
        require(
            _verify(keccak256(abi.encodePacked(_recipient, _nonce, _amount, _expiredTime)), _signature),
            "WBRareDrop: invalid signature"
        );
        require(_expiredTime > block.timestamp, "WBRareDrop: claim date is expired");
        require(!nonceUsed[_nonce], "WBRareDrop: nonce already used");
