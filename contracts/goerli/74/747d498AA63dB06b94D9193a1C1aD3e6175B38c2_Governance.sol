...
contract Governance is IModule, IDAOV1Governance, Initializable {
    ...
    function enforcePrerequisites(address registryAddr, bytes32 orgId) external view {
        ...
        require(!registry.hasModule(orgId, Modules.DAO_V1_GOVERNANCE), "Prerequisites: module already exists");
