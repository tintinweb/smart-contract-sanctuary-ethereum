...
DefaultOperatorFilterer, ERC2981, ERC173 {
  ...
  // *****    BYTECODE  VARIABLES     *****
  // **************************************
    uint256 public constant DEFAULT_SERIES_ID = 0;
    string public constant name = "Dexa";
    string public constant symbol = "DEXA";
  // **************************************
    ...
    // ************
      ...
      */
      function isApprovedForAll(address owner_, address operator_) public view override returns (bool) {
        return
          _operatorApprovals[owner_ ][ operator_];
      }
    // ************
