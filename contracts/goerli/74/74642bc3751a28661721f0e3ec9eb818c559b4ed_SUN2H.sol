...
//       .---. .-. .-..-. .-.,---.  ,-.   .---. ,---.           .--.      .---.  .---.  .-. .-.  ,--,     .---.  ,---.  _______ .-.  .-. .---.    .-. .-..-. .-.          .--.  .-. .-.   .---.     //
//      ( .-._)| | | ||  \| || .-.\ |(|  ( .-._)| .-'          / /\ \    ( .-._)/ .-. ) |  \| |.' .'     / .-. ) | .-' |__   __|| |/\| |/ .-. )   | | | || | | ||\    /| / /\ \ |  \| |  ( .-._)    //
//     (_) \   | | | ||   | || `-'/ (_) (_) \   | `-.____.___ / /__\ \  (_) \   | | |(_)|   | ||  |  __  | | |(_)| `-.   )| |   | /  \ || | |(_)  | `-' || | | ||(\  / |/ /__\ \|   | | (_) \       //
//     _  \ \  | | | || |\  ||   (  | | _  \ \  | .-'`----==='|  __  |  _  \ \  | | | | | |\  |\  \ ( _) | | | | | .-'  (_) |   |  /\  || | | |   | .-. || | | |(_)\/  ||  __  || |\  | _  \ \      //
//    ( `-'  ) | `-')|| | |)|| |\ \ | |( `-'  ) |  `--.       | |  |)| ( `-'  ) \ `-' / | | |)| \  `-) ) \ `-' / | |      | |   |(/  \ |\ `-' /   | | |)|| `-')|| \  / || |  |)|| | |)|( `-'  )     //
//     `----'  `---(_)/(  (_)|_| \)\`-' `----'  /( __.'       |_|  (_)  `----'   )---'  /(  (_) )\____/   )---'  )\|      `-'   (_)   \| )---'    /(  (_)`---(_)| |\/| ||_|  (_)/(  (_) `----'      //
...
contract SUN2H is ERC721Creator {
    constructor() ERC721Creator("Sunrise-A Song of Two Humans", "SUN2H") {}
}
