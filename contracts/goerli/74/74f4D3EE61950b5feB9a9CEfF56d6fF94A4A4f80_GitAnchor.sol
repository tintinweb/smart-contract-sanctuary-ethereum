...
contract GitAnchor {
    ...
    /// @param anchorHashReadable Required because the indexed anchorHash will only be available as keccak256 hash in the logs
    /// @param anchorTimestamp The anchor's timestamp
    /// @param anchorOrigin The EOA of the creator of the anchor
    event Anchored(string indexed anchorHash, string anchorHashReadable, uint256 indexed anchorTimestamp, address indexed anchorOrigin);
