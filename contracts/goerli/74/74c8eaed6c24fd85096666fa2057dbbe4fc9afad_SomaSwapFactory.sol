...
import "../../TemplateFactory/TemplateFactoryLibrary.sol";
...
/**
 * @notice Implementation of the {ISomaSwapFactory} interface.
 */
contract SomaSwapFactory is ISomaSwapFactory, TemplateDeployer, Accessible {
     ...
     * @param templateVersion The template version to construct.
     * @custom:requirement The template must not be deprecated.
     */
    constructor(uint256 templateVersion)
    TemplateDeployer(bytes32('SomaSwapPair'), templateVersion) {}

    /**
     * @notice Checks if SomaSwapFactory inherits a given contract interface.
    ...
    function createPair(address tokenA, address tokenB) external whenNotPaused onlyRole(CREATE_PAIR_ROLE) override returns (address pair) {
        ...
        pair = _deploy(keccak256(abi.encodePacked(token0, token1)));
...
library TemplateFactoryLibrary {
    ...
    ITemplateFactory internal constant FACTORY = ITemplateFactory(0xAbf37CcDbbD2E8936C4479465F8a4BF4fe1EbcAe);

    /**
     * @notice See {ITemplateFactory-predictDeployAddress}.
     */
    function predictDeployAddress(ITemplateFactory factory, bytes32 templateId, uint256 version, bytes memory args) internal view returns (address) {
     ...
     */
    function predictCloneAddress(ITemplateFactory factory, bytes32 templateId, uint256 version) internal view returns (address) {
     ...
     */
    function deployTemplateLATEST(ITemplateFactory factory, bytes32 templateId, bytes memory args) internal returns (address instance) {
     ...
     * @notice See {TemplateFactoryLibrary-deployTemplateLATEST}.
     */
    function deployTemplateLATEST(ITemplateFactory factory, bytes32 templateId, bytes memory args, bytes32 salt) internal returns (address instance) {
     ...
     * @notice See {TemplateFactoryLibrary-deployTemplateLATEST}.
     */
    function deployTemplateLATEST(ITemplateFactory factory, bytes32 templateId, bytes memory args, bytes[] memory functionCalls) internal returns (address instance) {
     ...
     */
    function deployTemplateLATEST(ITemplateFactory factory, bytes32 templateId, bytes memory args, bytes[] memory functionCalls, bytes32 salt) internal returns (address instance) {
     ...
     */
    function deployTemplate(ITemplateFactory factory, bytes32 templateId, uint256 version, bytes memory args) internal returns (address instance) {
     ...
     * @notice See {ITemplateFactory-deployTemplate}.
     */
    function deployTemplate(ITemplateFactory factory, bytes32 templateId, uint256 version, bytes memory args, bytes32 salt) internal returns (address instance) {
     ...
     * @notice See {ITemplateFactory-deployTemplate}.
     */
    function deployTemplate(ITemplateFactory factory, bytes32 templateId, uint256 version, bytes memory args, bytes[] memory functionCalls) internal returns (address instance) {
     ...
     * @notice See {ITemplateFactory-deployTemplate}.
     */
    function deployTemplate(ITemplateFactory factory, bytes32 templateId, uint256 version, bytes memory args, bytes[] memory functionCalls, bytes32 salt) internal returns (address instance) {
     ...
     * @notice See {TemplateFactoryLibrary-cloneTemplateLATEST}.
     */
    function cloneTemplateLATEST(ITemplateFactory factory, bytes32 templateId, bytes32 salt) internal returns (address instance) {
     ...
     * @notice See {TemplateFactoryLibrary-cloneTemplateLATEST}.
     */
    function cloneTemplateLATEST(ITemplateFactory factory, bytes32 templateId, bytes[] memory functionCalls) internal returns (address instance) {
     ...
     */
    function cloneTemplateLATEST(ITemplateFactory factory, bytes32 templateId, bytes[] memory functionCalls, bytes32 salt) internal returns (address instance) {
     ...
     */
    function cloneTemplate(ITemplateFactory factory, bytes32 templateId, uint256 version) internal returns (address instance) {
     ...
     * @notice See {ITemplateFactory-cloneTemplate}.
     */
    function cloneTemplate(ITemplateFactory factory, bytes32 templateId, uint256 version, bytes32 salt) internal returns (address instance) {
     ...
     * @notice See {ITemplateFactory-cloneTemplate}.
     */
    function cloneTemplate(ITemplateFactory factory, bytes32 templateId, uint256 version, bytes[] memory functionCalls) internal returns (address instance) {
     ...
     * @notice See {ITemplateFactory-cloneTemplate}.
     */
    function cloneTemplate(ITemplateFactory factory, bytes32 templateId, uint256 version, bytes[] memory functionCalls, bytes32 salt) internal returns (address instance) {
     ...
     */
    function initCodeHash(ITemplateFactory factory, bytes32 templateId, uint256 version) internal view returns (bytes32) {
...
contract TemplateDeployer is ITemplateDeployer, Context {
    ...
    // slither-disable-next-line external-function
    function deployment(uint256 index) public override view returns (address) {
        return _deployments[index];
    }

    function totalDeployments() public override view returns (uint256) {
        return _deployments.length;
    }

    // slither-disable-next-line external-function
    function deployed(address target) public override view returns (bool) {
        return deploymentInfo(target).sender == address(this);
    }

    function deploymentInfo(address target) public override view returns (ITemplateFactory.DeploymentInfo memory) {
