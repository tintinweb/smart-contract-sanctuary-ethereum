...
contract BitRoyaleTrainer is ERC721Enumerable {
    ...
    constructor(address _bcomp) ERC721("Royale Trainer", "RTNER") {
        BCOMP = IERC20(_bcomp);
    ...
    function setBCOMP(address _tokenAddress) public onlyOwner {
    ...
    function withdrawERC20(uint256 _amount, address _tokenAddress)
        external
        onlyOwner
    {
        require(
