 ...
 */
contract ESEerc721r is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ESEerc721r.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(ESEerc721r.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ESEerc721r.ownerOf(tokenId), to, tokenId);
    }
