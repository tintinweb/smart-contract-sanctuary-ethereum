...
contract BatchAuction is Ownable, ReentrancyGuard {
  ...
  constructor() {
    ...
    // GOERLI
    BALANCER_VAULT = IBalancerVault(0xBA12222222228d8Ba445958a75a0704d566BF2C8);
    balancerWeightedPoolFactory = IWeightedPoolFactory(0x8E9aa87E45e92bad84D5F8DD1bff34Fb92637dE9);
  ...
  function withdrawETH(uint256 _amount) private nonReentrant {
    require(COMMIT_CURRENCY == ETH_ADDRESS, "COMMIT_CURRENCY_IS_NOT_ETH");
