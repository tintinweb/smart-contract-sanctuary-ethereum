    ...
    AccessControlEnumerable
{
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "TokenForge721: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "TokenForge721: must have pauser role to unpause");
        _unpause();
    }
