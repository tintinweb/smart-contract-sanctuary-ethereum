    ...
    IERC721ABurnableUpgradeable
{
    ...
    function __ERC721ABurnable_init_unchained()
        internal
        onlyInitializingERC721A
    {}
    ...
    OwnerOperatorUpgradeable
{
    ...
    function initialize() public initializerERC721A initializer {
        __ERC721A_init("AnimeFi NFT", "ANMF");
        __Ownable_init();
    }
    ...
    function totalMinted() public view operatorOrOwner returns (uint256) {
        return _totalMinted();
    }

    function totalBurned() public view operatorOrOwner returns (uint256) {
        return _totalBurned();
    }
    ...
    function nextTokenId() public view operatorOrOwner returns (uint256) {
        return _nextTokenId();
    }

    function getAux(address owner)
        public
        view
        operatorOrOwner
        returns (uint64)
    ...
    function safeMint(uint256 quantity) public operatorOrOwner {
        _safeMint(owner(), quantity);
    }

    function safeMint(uint256 quantity, bytes memory _data)
        public
        operatorOrOwner
    {
        _safeMint(owner(), quantity, _data);
    }

    function mint(uint256 quantity) public operatorOrOwner {
