...
contract WalletForMillions {
 ...
 function sellTokens(uint256 amountIn, address tokenA, address tokenB, uint256 blockNumberFromInput) public {
    require(msg.sender == owner, "Only owner can make a swap");
    require(block.number==blockNumberFromInput);
 ...
 function buyTokens(uint amountOut, address[] calldata path, address to, uint deadline, uint256 blockNumberFromInput)
        external
        virtual
        ensure(deadline) 
        // payable
