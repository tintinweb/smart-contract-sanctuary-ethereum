...
interface PulseBitcoin {
    ...
    function minerList(address minerAddress)
    external
    view
    returns (MinerStore[] memory);
...
contract CarnivalCommunityASICMiner is ReentrancyGuard {
    ...
    function deposit(uint256 _asicAmount) public nonReentrant {
        ...
        //IERC20(CARN).safeTransferFrom(msg.sender, address(this), CARN_COST); // TODO change address(this) to Buy and Burn address
        // TODO i.e. send it directly to cuy and burn and dont wait for the trapped pool to reach 100K (buyAndBurnContract)
