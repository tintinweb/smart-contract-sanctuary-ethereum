...
interface RenderDays {
    function get1(uint256 value) external pure returns (string memory number);
    function get2(uint256 value) external pure returns (string memory number);
    function get3(uint256 value) external pure returns (string memory number);
}

abstract contract RenderTime {
    string constant svg0 = '<svg width="800" height="800" style="background-color:#232323"><g id="clock" transform="translate(0, -70)" ><g><linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="70%" style="stop-color:rgb(35,35,35)" /><stop offset="100%" style="stop-color:rgb(255,255,255)" /></linearGradient>';
    ...
    RenderDays private renderDays = RenderDays(0x48e2cd9216a9F76dDB0D924426d7F7A33D559ea7);
