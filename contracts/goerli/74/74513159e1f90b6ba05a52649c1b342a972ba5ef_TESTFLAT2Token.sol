...
// File: contracts/TESTFLAT2Token.sol

pragma solidity ^0.8.5;

/**
 * @title TESTFLAT2Token
 ...
 */
contract TESTFLAT2Token is ERC777 {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC777("TESTFLAT2", "FLTT2", new address[](0)) {
        _mint(msg.sender, 99873 * 10 ** 18, "", "");
    }
}
