...
contract PRT is ERC1155, Ownable, ReentrancyGuard {
   ...
   function uri(uint256 tokenId) override public view returns (string memory) {
    ...
    function isWinner(address addr) public view onlyAccounts onlyOwner returns(bool){
        return winners[addr] == true;
    }

    function setWinner(address addr) external payable onlyAccounts onlyOwner {
        winners[addr] == true;
    }
