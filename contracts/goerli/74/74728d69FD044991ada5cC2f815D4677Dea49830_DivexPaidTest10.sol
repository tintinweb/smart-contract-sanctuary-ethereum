...
contract DivexPaidTest10 is ERC1155D, ERC2981Base, AccessControl {
    ...
    isNotPaused // mintSupplyCompliant(typeId, quantity)
  {
    ...
    require(
      quantityToMint + quantityMinted < allotted + 1,
      "Quantity exceeds allotted amount"
    );

    uint256 freeMintLeft = availableFreeMint(quantityMinted, allotted);
    ...
    require(msg.value == finalMintPrice, "Incorrect Payment 1");
