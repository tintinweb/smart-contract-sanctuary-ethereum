...
contract denji is ERC20, Ownable {
    ...
    constructor() ERC20("Chainsaw Man", "denji") 
    {
        initialSupply = 1000000000 * (10**18); // 1 Billion tokens
        maxWallet = initialSupply * 2 / 100; //2% of the supply
        _setOwner(msg.sender);
        uniswapV2Router02 = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //uniswap V2 router
        uniswapV2Factory = IUniswapV2Factory(uniswapV2Router02.factory());
        uniswapV2Pair = IUniswapV2Pair(uniswapV2Factory.createPair(address(this), uniswapV2Router02.WETH()));

        taxWallets["liquidity"] = address(0x921b1ED9d2cebC313A891Cc02215cef099417Fe6); //
        setBuyTax(5,1); //marketing tax, liquidity tax
        setSellTax(5,1); //marketing tax, liquidity tax
    ...
    /**
    *@dev Claimed stucked tokens or ether
    */
    ...
    /**
     * @dev Returns All tax values for Buy/sell.
     */
    function taxeInfo() public view returns (uint256 buyMarketing, uint256 buyLiquidity,uint256 sellMarketing, uint256 sellLiquidity ){
