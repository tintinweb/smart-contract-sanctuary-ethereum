...
//The Gardens Random Generator Contract - VRF enabled
...
contract GardensRandomSeed is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    mapping(uint256 => uint256) public s_random;
    ...
    function random() external onlyOwner returns (uint256) {
        ...
        s_random[lastSRandomId] = randomnumber;
        lastSRandomId++;
        return randomnumber;
    }
    ...
    // Returns the most recent random word from the last request.
    // if request is not fulfilled, it will return 0.
