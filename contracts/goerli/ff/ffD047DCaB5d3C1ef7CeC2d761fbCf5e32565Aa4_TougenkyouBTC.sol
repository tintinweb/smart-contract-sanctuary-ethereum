...
import { ERC721BridgeBRCTokenURL, IERC721, ERC721 } from "ERC721BridgeBRC/src/extensions/ERC721BridgeBRCTokenURL.sol";
...
contract TougenkyouBTC is AccessControl, ERC2981, ERC721BridgeBRCTokenURL {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721, ERC2981, AccessControl) returns (bool) {
        return ERC721.supportsInterface(interfaceId) || ERC2981.supportsInterface(interfaceId) || AccessControl.supportsInterface(interfaceId);
    }
