    ...
    Pausable
{
    ...
    /**
     * Override isApprovedForAll to whitelist user's StormSpace proxy accounts to enable gas-free listings.
     */
    ...
    {
        // Whitelist StormSpace proxy contracts for easy trading.
    ...
    /**
     * This is used instead of msg.sender as transactions won't be sent by the original token owner, but by StormSpace.
     */
...
contract AssetContract is ERC1155Tradable {
    ...
    /**
     * Compat for factory interfaces on StormSpace
