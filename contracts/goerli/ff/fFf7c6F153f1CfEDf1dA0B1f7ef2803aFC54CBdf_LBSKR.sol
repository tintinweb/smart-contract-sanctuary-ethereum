...
contract LBSKR is BaseBSKR, DSMath, Stakable {
        ...
        whenNotPaused
    {
        ...
        uint256 lbskrToSend = ((((balanceOf(address(this)) +
            _totalLBSKRStakes) * lbskrShares2Deduct) /
            _totalLBSKRShares -
        ...
        if (eligibleBasis < _BIPS) {
            uint256 lbskrToBurn = ((((balanceOf(address(this)) +
                _totalLBSKRStakes) * lbskrShares2Deduct) /
                _totalLBSKRShares -
            ...
            uint256 bskrToBurn = (((_BSKR.balanceOf(_inflationAddress)) *
                bskrShares2Deduct) * (_BIPS - eligibleBasis)) /
                _totalBSKRShares /
                _BIPS;
