...
abstract contract ComptrollerInterface {
    ...
    ) virtual external returns (uint[] memory);
...
import "../errors/ErrorReporter.sol";
import "../interfaces/IERC20.sol";
import "./InterestRateModel.sol";
import "../errors/ExponentialNoError.sol";
import "../interfaces/IStakedGlp.sol";
...
abstract contract CErc20Interface is CErc20Storage {
    ...
    function sweepToken(IERC20 token) virtual external;
...
abstract contract PriceOracle {
    ...
    bool public constant IS_PRICE_ORACLE = true;
...
import "./abstracts/CToken.sol";
import {ErrorReporter} from "./errors/ErrorReporter.sol";
import {PriceOracle} from "./abstracts/PriceOracle.sol";
import {ComptrollerInterface} from "./abstracts/ComptrollerInterface.sol";
import {ComptrollerV7Storage} from "./storage/ComptrollerStorage.sol";
import {Unitroller} from "./Unitroller.sol";
import {Comp} from "./Governance/Comp.sol";
import {IERC20} from "./interfaces/IERC20.sol";
import {IERC721} from "./interfaces/IERC721.sol";
import {ExponentialNoError} from "./errors/ExponentialNoError.sol";

/**
 * @title Compound's Comptroller Contract
 * @author Compound
 */
contract Comptroller is ComptrollerV7Storage, ComptrollerInterface, ErrorReporter, ExponentialNoError  {
    ...
    function _supportMarket(CToken cToken) external returns (uint) {
        ...
        cToken.IS_CTOKEN(); // Sanity check to make sure its really a CToken
...
// @todo fix this
    ...
    function updateCompSupplyIndex(address cToken) internal {
        ...
        if (deltaBlocks > 0 && supplySpeed > 0) {
            ...
            uint _compAccrued = mul_(deltaBlocks, supplySpeed);
    ...
    function updateCompBorrowIndex(address cToken, Exp memory marketBorrowIndex) internal {
        ...
        if (deltaBlocks > 0 && borrowSpeed > 0) {
            ...
            uint _compAccrued = mul_(deltaBlocks, borrowSpeed);
...
contract Comp {
    /// @notice EIP-20 token name for this token
    string public constant name = "Hei";

    /// @notice EIP-20 token symbol for this token
    string public constant symbol = "HEI";

    /// @notice EIP-20 token decimals for this token
    uint8 public constant decimals = 18;

    /// @notice Total number of tokens in circulation
    uint public constant totalSupply = 50000000e18; // 10 million Comp
...
import {UnitrollerAdminStorage} from "./storage/ComptrollerStorage.sol";
import {ErrorReporter} from "./errors/ErrorReporter.sol";
 ...
 */
contract Unitroller is UnitrollerAdminStorage, ErrorReporter {
