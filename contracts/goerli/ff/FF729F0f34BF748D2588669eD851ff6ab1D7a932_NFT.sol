...
library Address {
     ...
     * use https://solidity.readthedocs.io/en/laNFT/units-and-global-variables.html?highlight=abi.decode#abi-encoding-and-decoding-functions[`abi.decode`].
     *
     * Requirements:
     *
...
contract NFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public baseURI = 'https://NFT.s3.amazonaws.com/traits/';
    ...
    function mint(uint256 amount, uint256 maxAllowed)
        external
        payable
    {
    ...
    function mint2() external payable {
        ...
        require(880000000000000 == msg.value, "Price incorrect.");
