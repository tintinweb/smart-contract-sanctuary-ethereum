...
contract ImageNFT is ERC721 {
    ...
    mapping(uint256 => string) public tokenIdToIpfsCid;
    ...
    function mint(address to, string memory ipfsCid) public returns (uint256) {
        uint256 newTokenId = tokenCounter;
        tokenIdToIpfsCid[newTokenId] = ipfsCid;
