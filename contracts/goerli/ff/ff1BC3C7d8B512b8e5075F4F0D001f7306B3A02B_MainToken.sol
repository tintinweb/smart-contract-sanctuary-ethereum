...
contract MainToken is 
    ...
    function mint(address _to, uint256 _amount) public virtual override onlyVault {
        _mint(_to, _amount);
    }
    ...
    function burnFrom(address _from, uint256 _amount) public virtual override onlyVault {
        _burn(_from, _amount);
    }
