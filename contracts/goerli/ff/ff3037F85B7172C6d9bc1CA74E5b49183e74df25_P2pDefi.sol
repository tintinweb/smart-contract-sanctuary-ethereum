...
contract P2pDefi is Ownable {
    ...
    function createLendOrder(
        ...
        if (orderLendMap[_lendingToken][msg.sender][i].id == 0) {
            orderLendMap[_lendingToken][msg.sender][i] = OrderLendData(
                i,
                _lendingToken,
                _termPeriodInDays,
    ...
    function createBorrowOrder(
        ...
        if (orderBorrowMap[_borrowingToken][msg.sender][i].id == 0) {
            orderBorrowMap[_borrowingToken][msg.sender][i] = OrderBorrowData(
                i,
                _borrowingToken,
                _termPeriodInDays,
                _borrowingAmount,
    ...
    function getLendOrder(
        ...
        address user,
        uint256 id
    ) public view returns (OrderLendData memory) {
