...
contract Laboratory {
    ...
    function NewStreamWallet(address[] memory _beneficiaries, uint256[] memory _shares, bytes32 root) external returns (address) {
        ...
        teamWallet.initialize(_beneficiaries, _shares, root);
