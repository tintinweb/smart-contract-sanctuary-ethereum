...
contract AntMan is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable maxPerAddressDuringMint; // TODO: Check applyt to all minters
    uint256 public immutable maxPerAllowlistMint; // maxPerAllowlistMint <= maxPerAddressDuringMint TODO: Remove for Tiered mint
    uint256 public immutable amountForDevs; // TODO: Pending Discussion
    uint256 public immutable collectionSize;

    // TODO: DEV-14: Gas scan
    enum Tier {
        OG,
        GOLD,
        SILVER
    ...
    constructor(
        uint256 maxBatchSize_, // TODO: TBD
        uint256 maxAllowlistMint_, // TODO: Remove
        uint256 collectionSize_,
        uint256 amountForDevs_
    ) ERC721A("AntMan", "ANTMAN") {
        require(
            maxAllowlistMint_ <= maxBatchSize_,
            "maxAllowlistMint should be smaller than maxBatchSize"
        ); // TODO: Remove
        require(
        ...
        maxPerAllowlistMint = maxAllowlistMint_;
        ...
        allowlistTierConfig[Tier.SILVER].maxTotalMint = 1;
    }
        ...
        callerIsUser
    {
        ...
        // TODO: Instead of using balanceOf, we should use numberMinted
        require(
    ...
    // Owner Coontrols
    // TODO: No need to list seperately
    function shutdownAllowlistMint() public onlyOwner {
        saleConfig.allowlistMintStartTime = 0;
    }
