    ...
    ICollection
{
    ...
    constructor(TargetInit memory params, bytes memory data)
        ERC721ABase("Quantum Art Studio", "QAS")
    {
        _name = "Quantum Art Studio";
        _symbol = "QAS";
        baseURI = "https://core-api.quantum.art/v1/drop/metadata/studio/";
        ipfsURI = "ipfs://";
        isContractLocked = false;
        isMetadataLocked = false;
        _primaryPayoutAddress = params.creator;
    ...
    function initialize(TargetInit calldata params, bytes memory data)
        public
        virtual
        initializer
    {
    ...
    function primaryPayoutAddress() public view returns (address) {
        return _primaryPayoutAddress;
    }
    ...
    */
    ...
    function mint(
        ...
        if (bytes(uri).length > 0) tokenURIs[totalSupply() + 1] = uri;
        _safeMint(to, 1);
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721ABase, ERC2981, AccessControlEnumerable)
        returns (bool)
    {
        return
...
interface IPayout {
    function primaryPayoutAddress() external view returns (address);
}
...
interface ICollection is ICollectionSupply, IPayout, IMintByUri {}
