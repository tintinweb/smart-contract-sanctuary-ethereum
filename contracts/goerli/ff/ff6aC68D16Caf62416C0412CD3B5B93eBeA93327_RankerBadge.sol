...
contract RankerBadge is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI, address _tokenAddress) ERC721(name_, symbol_) {
        ...
        badges[0] = Badge(BRONZE, 20_000, 0, Counters.Counter(0), false, 0, 0, 0, false, true);
        badges[1] = Badge(SILVER, 100_000, 0, Counters.Counter(0), false, 0, 0, 0, false, true);
        badges[2] = Badge(GOLD, 500_000, 25, Counters.Counter(0), false, 0, 0, 0, false, true);
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, Strings.toString(_tokenIdToTokenType[tokenId]))) : "";
    }
