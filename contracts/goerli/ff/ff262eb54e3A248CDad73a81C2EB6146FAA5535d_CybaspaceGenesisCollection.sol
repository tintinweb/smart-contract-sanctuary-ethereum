    ...
    ICybaspaceGenesisCollection
{
     ...
     * MintingIsFrozen
     *
     * @param switch_ switch to turn off/on minting phase
     */
    function disableMinting(bool switch_) external onlyOwner {
        mintingFrozen = switch_;
    }
     ...
     * 
     * @param baseImageURI_ base uri of image to set
     */
     ...
     * @param switch_ switch to turn off/on minting phase
     */
    function setPhase(bool switch_) external onlyOwner {

        investorPhase = switch_;
    }
