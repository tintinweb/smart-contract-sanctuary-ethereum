...
//       / /_  __  __/ /____  / ____/   |  / | / /__________ 
//      / __ \/ / / / __/ _ \/ / __/ /| | /  |/ / __  / ___/ 
//     / /_/ / /_/ / /_/  __/ /_/ / ___ |/ /|  / /_/ /\__ \ 
//    /_.___/\__, /\__/\___/\____/_/  |_/_/ |_/\__, /\____/  
//          /____/                            /____/         
//
//    byteGANgs on-chained
//
//
//
//
...
contract THEBYTEGANGS is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public collectionName = "byteGAN 1/1s by Pindar Van Arman";
  ...
  function base64GIF(uint _tokenId) public view returns (string memory) {
      return string(abi.encodePacked(
              'data:image/gif;base64,',tokens[_tokenId].GIF));
  }   
...
//Set permissions for relayer
  ...
  function buildImage(uint256 _tokenId) public view returns(string memory) {
      return Base64.encode(bytes(
          abi.encodePacked(
            //pp'<svg width="500" height="500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"> <image width="500" height="500" xlink:href="data:image/gif;base64,',tokens[_tokenId].GIF,'"/> </svg>'
            '',tokens[_tokenId].GIF,''
          )
      ));
  }
