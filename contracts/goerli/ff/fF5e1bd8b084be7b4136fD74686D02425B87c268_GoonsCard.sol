...
contract GoonsCard is ERC721, Mintable {
    int public cardsMinted = 0;
    int public MAX_CARDS = 394000;
    ...
    function _mintFor(
        ...
        require(cardsMinted < MAX_CARDS, "Max supply reached, cannot mint any more");
        _safeMint(user, id);
        cardsMinted += 1;
    }
