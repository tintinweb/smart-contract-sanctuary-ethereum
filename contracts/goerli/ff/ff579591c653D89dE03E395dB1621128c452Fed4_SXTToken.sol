...
contract SXTToken is Admin, Initializer, ERC20, ISXTToken {
    ...
    /**
     * Initialize SXTToken
     * @param tokenName SXTToken name
     * @param tokenSymbol SXTToken symbol
     */
    ...
    /**
     * Mint SXTToken
     * @param to SXTToken receiver address
     * @param amount SXTToken amount
     */
    ...
    /**
     * Add minter
     * @param minter SXTToken minter address
     */
    ...
    modifier onlyMinter() {
        require(minters[msg.sender], "SXTToken: only minter can call");
        _;
    }
}
