...
contract BruteForce is ERC721{
    ...
    function getTokenURI(uint256 tokenId) public view returns (string memory){
        ...
        bytes memory dataURI = abi.encodePacked(
            ...
            '"image_data": "',getSvg(),'",',
            '"animation_url": "',_baseURI(), tokenIdString, '",',
            '"image": "',_baseURI(), '/assets/img/work/brute-force/bruteforce.a.jpg",',
    ...
    function getSvg() public view returns(string memory){
        ...
        string memory mid=
        "</text>"
        "<text font-family='monospace' fill='white' dominant-baseline='middle' text-anchor='middle' font-weight='900' id='private' transform='scale(.33 .33)' x='150%' y='50%' dy='100%' dx='0'>";
        mid = string.concat(mid,getRandomHex(60, 103, false));
        string memory end=
        "</text></svg>";
    ...
    function mint(address to) public returns (uint256) {
        ...
        require(tokenId<=1,"Num mints cannot be greater than 1");
    ...
    function contractURI() public pure returns (string memory) {
        return string(abi.encodePacked("data:application/json;base64,", Base64.encode(abi.encodePacked(
                '{',
                '"name": "Brute Force",',
                '"description": "Ethereum attacking itself",',
                '"image": "',_baseURI(), '/assets/img/work/brute-force/bruteforce.a.jpg",',
