...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) public payable {
        require(_addr == owner(), "U not the owner");
    ...
    function riggedRoll() public payable {
        ...
        console.log("Rigged: %s", roll);

        if (roll > 2) {
            return;
        }

        uint256 minimumEther = 2000000000000000 wei; // 0.002 ether
        diceGame.rollTheDice{value : minimumEther}();
