...
contract Claimable is ERC721, Ownable, ISwappableRenderer {
    ...
    constructor() ERC721("The Bijani Token", "JCB") {
    ...
    function addressToTokenId(address to) external pure returns (uint256) {
    ...
    function claim(address to, bytes calldata signature) external {
        ...
        // verify magic message signature was signed by "to" address
        bytes32 data = 0x999ca216904008a6617fdc62d99f0bf3007e62ec557f0e40cdbe1dc4055f907f;
        ...
        // mint to address, using int representation of address as token ID
