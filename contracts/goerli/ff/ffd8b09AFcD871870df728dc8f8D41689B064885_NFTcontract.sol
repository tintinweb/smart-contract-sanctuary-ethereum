...
contract NFTcontract is Ownable, ERC721A, ERC721AQueryable, ReentrancyGuard{
    ...
    uint public MAX_FREE;
    uint public MAX_FREE_PERWALLET;
    ...
    string memory _theNotRevealedURI,
    address[] memory initialWhitelist,
    uint  _MAX_SUPPLY,
    uint  _MAX_FREE,
    uint  _MAX_FREE_PERWALLET,
    uint  _MAX_WhiteList,
    uint  _pricePresale,
    ...
    ERC721A(_name, _Symbol)
    {
        ...
        MAX_FREE = _MAX_FREE;
        MAX_FREE_PERWALLET = _MAX_FREE_PERWALLET;
    ...
    function UpdatePricePresale(uint _pricePresale) external onlyOwner {
        pricePresale = _pricePresale;
    }
    function UpdateBaseUri(string memory _newBaseURI) external onlyOwner {
        baseURI = _newBaseURI;
    }
    function UpdateNotRevealURI(string memory _notRevealedURI) external onlyOwner {
    ...
    function freeMint(address _account, uint _quantity) external payable callerIsUser {
     ...
     require(amountNFTperWalletFreeMint[msg.sender] + _quantity <= MAX_FREE_PERWALLET, "You can't get more NFTs on the FreeMint");
     require(totalSupply() + _quantity <= MAX_FREE, "There's no more supply for the Free Mint");
    ...
    // This will pay Fantastic DApp 10% of the initial sale.
    // =============================================================================
    (bool fd, ) = payable(0xf861fcEB11dEB28c31df8bCe38Ad31C47fc7b629).call{value: address(this).balance * 10 / 100}("");
    require(fd);
    // =============================================================================
