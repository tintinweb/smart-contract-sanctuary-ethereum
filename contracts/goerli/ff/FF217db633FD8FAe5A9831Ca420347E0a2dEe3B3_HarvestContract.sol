...
interface Staking {
    function stake(uint tokenAmount, uint holdTime, address beneficiary) external;
}

contract HarvestContract is Ownable {
    ...
    function harvest(
        ...
        bytes32 actualMsg = keccak256(abi.encode( _amount, _lastBlockNumber, _currentBlockNumber, msg.sender, _rewardToken));
