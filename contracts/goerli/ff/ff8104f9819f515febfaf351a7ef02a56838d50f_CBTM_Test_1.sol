...
contract CBTM_Test_1 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CBTM Mint 1 Test 1", "CBTM-TEST-1") {  }
  ...
  function contractState() public view returns (
      ...
      uint256 totalSupplyMinted
        ...
        return ( paused, revealed, maxSupply, maxMintAmountPerTx, _totalSupplyMinted );
    }
