        ...
        if (usdtTotalReciveAmount < usdtSoftCapInt) {
            ...
            for (roopStart; roopStart < roopEnd; roopStart++) {
                if (userInfo[userAddress[roopStart]].amount != 0) {
                    ...
                    userInfo[userAddress[roopStart]].totalReward -= userInfo[userAddress[roopStart]]
                        .amount
                        .div(
                        ...
                        .mul(PLX_ACC_PRECESION);
                    usdtTotalReciveAmount -= userInfo[userAddress[roopStart]].amount;
        ...
        if (usdtTotalReciveAmountP2 < usdtSoftCapInt) {
            ...
            for (roopStart; roopStart < roopEnd; roopStart++) {
                if (userInfo[userAddressP2[roopStart]].amountP2 != 0) {
                    ...
                    userInfo[userAddressP2[roopStart]].totalReward -= userInfo[userAddressP2[roopStart]]
                        .amountP2
                        .div(
                        ...
                        .mul(PLX_ACC_PRECESION);
                    usdtTotalReciveAmountP2 -= userInfo[userAddressP2[roopStart]].amountP2;
