...
import "./interfaces/IGatewayRouter2.sol";

contract Token is ERC20, ICustomToken, AccessControl {
    ...
    function balanceOf(
        address account
    ) public view virtual override(ERC20, ICustomToken) returns (uint256) {
