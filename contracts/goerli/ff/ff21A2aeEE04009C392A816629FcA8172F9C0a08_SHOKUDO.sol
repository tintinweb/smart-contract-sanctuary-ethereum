...
contract SHOKUDO is OwnControll {
    ...
    ICHANCO public CHANCO = ICHANCO(0x36565eC8466C1c686252B2Adcb7c904DAB5Dd439);

    uint256 public itemCount;
    uint256 public discountRate = 4;
    ...
    function getWlItems(uint256 _id) public view returns (wlItems memory) {
        return wlVending[_id];
    }
