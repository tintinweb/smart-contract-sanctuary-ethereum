...
contract MelaniaTrumpTradingCards is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  ...
  uint256 public  NUM_FREE_MINTS = 2500;
  ...
  ) ERC721A("MelaniaTrumpTradingCards", "MelaniaTrumpTradingCards") {
