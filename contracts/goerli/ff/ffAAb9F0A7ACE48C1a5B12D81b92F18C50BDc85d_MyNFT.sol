...
contract MyNFT is myERC721, Ownable {
    ...
    function mintToken(string memory tokenUrl) public payable returns (uint) {
        ...
        idToNftItem[newTokenId] = NftItem(newTokenId, msg.value, msg.sender, false);
        emit NftItemCreated(newTokenId, msg.value, msg.sender, false);
        return newTokenId;
    }
