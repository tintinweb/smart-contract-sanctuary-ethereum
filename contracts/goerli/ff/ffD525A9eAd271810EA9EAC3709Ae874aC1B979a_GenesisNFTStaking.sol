...
contract GenesisNFTStaking is Ownable {
    ...
    event UpdateGenesisNFTContract(address oldAddress, address newAddress);
    ...
    function getGenesisNFTContract() external view returns(address) {
        return _genesisNFTcontractAddress;
    }

    function setGenesisNFTContract(address newGenesisNFTContract) external onlyOwner{
        address old = _genesisNFTcontractAddress;
        _genesisNFTcontractAddress = newGenesisNFTContract;
        emit UpdateGenesisNFTContract(old, _genesisNFTcontractAddress);
    }
    ...
    function stakeGenesisNFT(uint256 tokenID) external {
        ...
        // calling address must not already have a staked token
    ...
    function unstakeGenesisNFT(uint256 tokenID) external {
        // caller must own the staked token
