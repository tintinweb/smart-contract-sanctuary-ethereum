...
contract PublicFace is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public publicMintCost = 0.0055 ether;
  ...
  modifier callerIsUser() {
    require(tx.origin == msg.sender, "Caller should be user!");
    _;
  }

  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0, "Min ammount is 1");
  ...
  function updatePrice(uint256 _publicMintCost) public onlyOwner {
