...
contract Bridge is Ownable {
    ...
    // uint256 tokenId
    function deposit(address l1TokenAddress) public payable {
        ...
        // payload[0] = uint256(uint160(msg.sender)); // l1_owner_address
        // payload[1] = l2OwnerAddress; // l2_owner_address
        // payload[2] = uint256(uint160(l1TokenAddress)); // l1_contract_address
        // payload[3] = tokenId; // token_id
