...
// File: contracts/StorageAgoverse.sol
    ...
    UUPSUpgradeable
{
    ...
    function store(
        ...
        allDataList[_email].push(
            Data(_firstName, _middleName, _lastName, _phoneNo, _link)
        );
    }
    ...
    function update(
        ...
        allDataList[_email][index].firstName = _firstName;
        allDataList[_email][index].middleName = _middleName;
        allDataList[_email][index].lastName = _lastName;
        allDataList[_email][index].phoneNo = _phoneNo;
        allDataList[_email][index].link = _link;
    }
}