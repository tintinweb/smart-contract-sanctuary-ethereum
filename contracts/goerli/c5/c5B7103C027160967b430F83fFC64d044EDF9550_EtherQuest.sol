...
function renderTokenById(uint256 tokenId) public view returns (string memory) {
    string memory render = string(abi.encodePacked(
          '<rect id="face" fill="hsl(',randomNum(361,3,3).toString(),',90%,85%)" x="0" y="104.52146" width="512" height="172.8173"/>',
          '<rect id="bottomHelmet" fill="hsl(',randomNum(361,3,9).toString(),',90%,15%)" x="0" y="277" width="512" height="233.88556"/>',
          '<rect id="helmetTop" fill="hsl(',randomNum(361,3,9).toString(),',90%,15%)" x="0" y="-0.33397" width="512" height="110.68075"/>',
          '<rect id="nosePiece" fill="hsl(',randomNum(361,3,3).toString(),',90%,25%)" x="211.33936" y="69.56966" width="89.3213" height="332.0422" stroke="#000000"/>',
