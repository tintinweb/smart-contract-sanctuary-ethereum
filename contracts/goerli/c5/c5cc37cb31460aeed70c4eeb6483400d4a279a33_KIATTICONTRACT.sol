...
pragma solidity >= 0.8.9;
contract KIATTICONTRACT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KIATTI", "KIT") {
        ...
        maxTransactionAmount = supply * maxTransaction / 100000;
        swapTokensAtAmount = supply * 5 / 100000000;
        maxWalletTotal = supply * maxWallet / 100000;
    ...
    function updateLimits() private {
        maxTransactionAmount = supply * maxTransaction / 100000;
        swapTokensAtAmount = supply * 5 / 10000000;
        maxWalletTotal = supply * maxWallet / 100000;
    }
