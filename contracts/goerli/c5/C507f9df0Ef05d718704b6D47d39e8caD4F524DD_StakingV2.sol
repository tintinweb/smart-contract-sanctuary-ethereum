...
contract StakingV2 is ReentrancyGuard, Ownable {
    ...
    // address rewardToken = 0x657e801e5939487f376044916872467d323af997; // ZK
    address rewardToken = 0xdE723b4C4231f4E011F69f6521b6033e63180a45; // goerli

    // address WETH = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;
    // address WETH = 0x20b28B1e4665FFf290650586ad76E977EAb90c5D; // ZK
    ...
    mapping(address => User[]) public users; // store user information
    ...
    function createPool(
        ...
        emit PoolCreated(_stakeToken, _rewardAmount, newPool);
    }
    ...
    function deposit(
        ...
        if (pool.stakeToken != rewardToken) {
            if (pool.stakeToken == ETH) {
                ...
                require(
                    minimumStakeAmount <= amountsOut[1] &&
                        maximumStakeAmount >= amountsOut[1],
        ...
        console.log("Actual :", newPosition.actualAmount);
        stakingPosition[msg.sender].push(newPosition);
        pool.totalStakeAmount += _amount; // TODO: change to totalStakedAmount per pool
    ...
    function withdraw(
        ...
        console.log("Withdraw ID", withdrawPosition.id);
        ...
        if (pools[withdrawPosition.poolId].stakeToken == ETH) {
            ...
            require(
                afterBalance == beforeBalance - withdrawPosition.actualAmount,
        ...
        console.log("Stake token:", pools[withdrawPosition.poolId].stakeToken);

        console.log("Actual Amount:", withdrawPosition.actualAmount);
    ...
    function _getClaimableReward(
        ...
        uint256 totalReward = rewardPerPeriodLength * profitPeriod;
        // if more than 365, not calculate rewardRemainingDays
        if (remainingDays > 0 && _position.lastTimeReward < _position.timeEnd) {
            rewardRemainingDays =
                (
                    (((_position.stakedAmount * annualInterestRate) / 100) *
                        remainingDays)
                ) /
                365;
