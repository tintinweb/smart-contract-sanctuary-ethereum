...
contract BNN is OperatorAccessControl {
    //类目列表
    ...
    constructor() {
        ...
        categorys[1] = Category(1, "clothing");
        categorys[2] = Category(2, "shoe");
        categorys[3] = Category(3, "trousers");
        categorys[4] = Category(4, "glasses");
    }
    ...
    function setCategory(
        ...
        categorys[identifier] = Category(identifier, name);
    }
}