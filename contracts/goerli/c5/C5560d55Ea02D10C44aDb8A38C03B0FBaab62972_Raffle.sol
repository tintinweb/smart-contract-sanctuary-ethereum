...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    /* Functions */
    constructor(
        address vrfCoordinatorV2, // need to deploy a mock for to test on a local chain
        uint256 entranceFee,
        bytes32 gasLane,
    ...
    function fulfillRandomWords(
        ...
        /**
         *  Using the random number from requestRandomWinner function we select the random winner and send him all the balance the contract holds and opens the lottery back again.
         */
