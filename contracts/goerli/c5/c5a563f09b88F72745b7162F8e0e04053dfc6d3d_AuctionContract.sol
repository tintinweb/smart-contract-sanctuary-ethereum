...
contract AuctionContract is ERC721A, ERC2981, ReentrancyGuard, AccessControl, Ownable {
    ...
    constructor(address payable withdrawAddress_) ERC721A("Auction Token", "AUCToken") {
