...
// File: contracts/BurnerBoyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract BurnerBoyContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "BurnerBoy";
    string public symbol = "Fees";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "http://localhost:8787/QATJKxEBN5bXDEtxnKHc/contract-metadata";
  }
