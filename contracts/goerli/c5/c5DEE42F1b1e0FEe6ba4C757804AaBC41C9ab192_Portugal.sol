...
contract Portugal is AdminControl, IIdentityVerifier, ICreatorExtensionTokenURI {
    ...
    function configure(address marketplace, uint listingId, Customizations calldata customization, string memory baseURI) public adminRequired {
    ...
    function tokenURI(address creator, uint256 tokenId) external view override returns (string memory) {
        ...
        return string(
          abi.encodePacked('data:application/json;utf8,',
            ...
            '"animation":"',
            string(abi.encodePacked(_baseURI, "style=", _customization.style.toString(), "&spread=", _customization.spread.toString(), "&inverse=", _customization.inverse.toString(), "&palette=", _customization.palette.toString())),
            '","animation_url":"',
            string(abi.encodePacked(_baseURI, "style=", _customization.style.toString(), "&spread=", _customization.spread.toString(), "&inverse=", _customization.inverse.toString(), "&palette=", _customization.palette.toString())),
            '"}'
          )
