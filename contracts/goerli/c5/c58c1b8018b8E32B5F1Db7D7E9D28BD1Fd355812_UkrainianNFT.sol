...
contract UkrainianNFT is ERC721, Ownable {
    string private baseURI =
        "ipfs://QmacaiCgCHY6NYHRmt7uk5amQo52iZKJBs6zhjAbBvTHZJ/";
    uint256 internal currentIndex;
    address _minter;

    constructor() ERC721("TestUK", "TestUK") {
        _minter = msg.sender;
        _mint(msg.sender, 7, "", false);
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmPs8vSvUpPiPHzJDkUE4pFPFYqtSgzRecFYUvfZZyGD9U";
    }
