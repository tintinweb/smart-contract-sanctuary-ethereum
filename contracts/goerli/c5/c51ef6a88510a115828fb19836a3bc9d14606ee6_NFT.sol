...
contract NFT is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("ON THE GROUNDUP", "OTGUP") {
    ...
    function batchMint(uint256 numTokens) external onlyOwner {
        uint256 curTotalSupply = totalSupply;
        require(curTotalSupply + numTokens <= MAX_TOKENS, "Exceeds total supply.");
