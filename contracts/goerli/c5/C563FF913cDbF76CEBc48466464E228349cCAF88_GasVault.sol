    ...
    UUPSUpgradeable
{
    ...
    function transactionsRemaining(
        ...
        uint256 totalGweiPerMethod = info.maxGasPerAction * info.maxGasCost;
        ...
        returns (uint256)
    {
        ...
        require(ethBalances[_targetAddress] >= tx.gasprice * gasAvailable);
...
interface IVaultRegistry {
    ...
    event BeaconRegistered(bytes32 _name, address _address, string _ipfsConfigForBeacon);

    /// @notice Beacon deregisteration event
    /// @param _name The name of the beacon getting registered
    event BeaconDeregistered(bytes32 _name);
    ...
    /// @param _ipfsConfigForBeacon IPFS hash for the config of this beacon
    function registerBeacon(bytes32 _name, address _address, string memory _ipfsConfigForBeacon)
        external;
    ...
    /// @param _ipfsConfigForBeacon IPFS hash for the config of this beacon
    function deployAndRegisterBeacon(address _address, bytes32 _name, string memory _ipfsConfigForBeacon)
    ...
    function deregisterBeacon(bytes32 _name) external;
