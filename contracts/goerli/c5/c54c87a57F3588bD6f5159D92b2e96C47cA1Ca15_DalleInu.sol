...
/**
    ...
    The First MEME token brings the Benefits of MEME, Defi, and AI
    together. Transform Your Thoughts into NFTs with Dalle Inu.

    Website: dalleinu.ai
    Twitter: twitter.com/Dalle_Inu
    Telegram: t.me/Dalleainu
...
contract DalleInu is ERC20, Ownable {
    ...
    constructor() ERC20("Dalle Inu", "Dalle") {
        ...
        maxTransactionAmount = 20_000_000 * 1e18; // 2% max txn
        ...
        buyTotalFees = buyMktgFee + buyLiquidityFee + buyOperationsFee;

        sellMktgFee = _sellMktgFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellOperationsFee = _sellOperationsFee;
        sellTotalFees = sellMktgFee + sellLiquidityFee + sellOperationsFee;

        mktgWallet = address(0xAc093acA60F050528745F4c4aE2341a5Bea759C0);
        liqWallet = address(0x3AAC9E4936B6514332Fc1F7A7139A5DecDB14d5D);
        operationsWallet = address(0x7be38FBe8A64E10d60b3963C674a974ff8fBd551);
    ...
    function multiBlock(address[] calldata blockees, bool shouldBlock)
        external
        onlyOwner
    {
