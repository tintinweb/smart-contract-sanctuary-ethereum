...
contract EMOPOPGIRL is ERC721A, ERC2981 , Ownable, Pausable {
    ...
    address constant private BULK_TRANSFER_ADDRESS = 0x6218Df03B15f314A8C08eCC3D868e1DECE8B22C8;
    address constant public TEAM_WALLET_ADDRESS = 0xb84e9eb4D635e0682d207D34d64A93817A0006e0;
    ...
    constructor(
        ...
        _safeMint(BULK_TRANSFER_ADDRESS, 20);
    }
    ...
    function withdrawTeamWallet() external onlyOwner {
        uint256 sendBalance = address(this).balance;
        (bool success, ) = payable(TEAM_WALLET_ADDRESS).call{value: sendBalance}("");
