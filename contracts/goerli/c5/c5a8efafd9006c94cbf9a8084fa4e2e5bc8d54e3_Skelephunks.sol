...
contract Skelephunks is ERC721Y, Ownable {
    using Address for address;
    using Strings for uint256;
...
//    bytes32 public phunksMerkleRoot = 0x27ac3c141722e15297742e6ad4ce20e09c86dc00ca276ea9184e633e1ab5bf30;
...
//    bytes32 public merkleRoot = 0x27ac3c141722e15297742e6ad4ce20e09c86dc00ca276ea9184e633e1ab5bf30;
...
//        if ((quantity + numMinted[wallet]) == maxMintsPerWallet(wallet, _phunkProof, _alProof)) {
    ...
    function _mintMain(address _to, uint256 _quantity, uint256 _gd, bool isReserve) private {
        require(!paused, "p");
//        require(
...
//            numMintedRegular + _quantity <= maxMintableSupply, "mmpw/mps");
        ...
        _totalClaimsMade[msg.sender] += numFree;


        totalReceived += msg.value;
        _mintMain(msg.sender, _quantity, genderDirection, false);
    }
    ...
    function mintReserve(
        ...
        _mintMain(_to, _quantity, genderDirection, true);
    }
