...
contract RolesManager is AccessControl, IRolesManager {
    ...
    constructor() {
        ...
        _setRoleAdmin(_consts().PIXU_MINTER_ROLE(), _consts().OWNER_ROLE());
        _setRoleAdmin(_consts().PIXUCATS_MINTER_ROLE(), _consts().OWNER_ROLE());
    ...
    function multiGrantRole(bytes32 role, address[] calldata accounts) external override {
        require(accounts.length > 0, "ACCOUNTS_MUSTNT_BE_EMPTY");
    ...
    function setConsts(address newConstsAddress) external override {
