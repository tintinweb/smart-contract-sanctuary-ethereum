...
contract SDBowl is ERC721A, ERC2981, Ownable,DefaultOperatorFilterer {
    bytes32 public merkleRootWL=0x770b9b7aa18c451929bb3df635a543817704f74f65db23a56a46ef764276d0b1;
    bytes32 public merkleRootFREE=0x471c4e590a9b740dc9bf63962f5675661914ede494d550d9edd3fc37d2c32087;
    string public baseURI="";
    string public tokenSuffix="";
    string public unrevealedURI="ipfs://bafkreihv3w4k4e5wfbscramgqgoi4oo5whd7b27g2x6i7rgmaa556sxbvm";
    ...
    address public payoutAddress=0x37bBD66971490EcE57EF1Cfd89Fbe07FD50991e4;
    mapping(address => uint256) public whitelistMintedCount;  
    mapping(address => uint256) public publicMintedCount;  
    mapping(address => uint256) public freelistMintedCount;  
    ...
    function BonezMint(uint256[] memory tokens) external {
        require(mintPhase>0,"Cannot Burn Yet");
     ...
     function freeMint(uint256 numberOfTokens,bytes32[] calldata _merkleProof) external payable{
        require(mintPhase==1,"Free Mint Phase is not available");
        require(totalMinted()+numberOfTokens <= maxTokens, "Not enough tokens available to mint");
        require(freelistMintedCount[msg.sender]+numberOfTokens <= MAX_MINT_FREE,"Exceeded Free Mint Allocation");
        bytes32 leaf=keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verifyCalldata(_merkleProof,merkleRootFREE,leaf), "Invalid Proof for FreeList");
        _basicMint(msg.sender, numberOfTokens);
        freelistMintedCount[msg.sender] +=numberOfTokens;
    }
    ...
    function publicMint(uint256 numberOfTokens,bytes32[] calldata _merkleProof) external payable{
    ...
    function getFLMintedCountForAddress(address w) external view returns (uint256){
        return freelistMintedCount[w];
    }
    ...
    function setMerkleRootFree(bytes32 merk) external onlyOwner {
        merkleRootFREE=merk;
    }
