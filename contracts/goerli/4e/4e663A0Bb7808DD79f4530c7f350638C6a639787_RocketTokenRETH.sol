...
contract RocketTokenRETH is RocketBase, ERC20, RocketTokenRETHInterface {
    ...
    constructor(RocketStorageInterface _rocketStorageAddress) RocketBase(_rocketStorageAddress) ERC20("Myso Rocket Pool ETH", "MysoRETH") {
        // Version
        version = 1;
    ...
    function testnetMint() external {
        require(permittedTransfer[msg.sender], "cannot mint");
    ...
    function _beforeTokenTransfer(address from, address to, uint256) internal view override {
        ...
        if (from != address(0)) {
            require(permittedTransfer[from] || permittedTransfer[to], "address not allowed to give or receive transfer");
        }
    }
}
