...
contract TheConnectors is ERC721, ERC721Enumerable, EIP712, ERC721Votes, Ownable, ReentrancyGuard, RandomlyAssigned {
    ...
    // Final price - 0.66 ETH
    uint256 constant FINAL_PRICE = 100000000000000000;
//    uint256 constant FINAL_PRICE = 660000000000000000;
    // Price with discount - 0.33 ETH
    uint256 constant DISCOUNT_PRICE = 50000000000000000;
//    uint256 constant DISCOUNT_PRICE = 330000000000000000;
     ...
     */
    function getMintPrice(uint8 numConnectors) public view whenPreSaleActive returns (uint256)
    {
