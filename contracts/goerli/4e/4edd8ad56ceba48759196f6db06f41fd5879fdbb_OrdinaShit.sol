...
//     *     .----------------.  .----------------.  .----------------.  .----------------.  .-----------------. .----------------.  .----------------.     //
//     *    | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |    //
//     *    | |     ____     | || |  _______     | || |  ________    | || |     _____    | || | ____  _____  | || |      __      | || |   _____      | |    //
//     *    | |   .'    `.   | || | |_   __ \    | || | |_   ___ `.  | || |    |_   _|   | || ||_   \|_   _| | || |     /  \     | || |  |_   _|     | |    //
//     *    | |  /  .--.  \  | || |   | |__) |   | || |   | |   `. \ | || |      | |     | || |  |   \ | |   | || |    / /\ \    | || |    | |       | |    //
//     *    | |  | |    | |  | || |   |  __ /    | || |   | |    | | | || |      | |     | || |  | |\ \| |   | || |   / ____ \   | || |    | |   _   | |    //
//     *    | |  \  `--'  /  | || |  _| |  \ \_  | || |  _| |___.' / | || |     _| |_    | || | _| |_\   |_  | || | _/ /    \ \_ | || |   _| |__/ |  | |    //
//     *    | |   `.____.'   | || | |____| |___| | || | |________.'  | || |    |_____|   | || ||_____|\____| | || ||____|  |____|| || |  |________|  | |    //
//     *    | |              | || |              | || |              | || |              | || |              | || |              | || |              | |    //
//     *    | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |    //
//     *     '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'     //
//     */                                                                                                                                                   //
...
contract OrdinaShit is ERC721Creator {
    constructor() ERC721Creator("Ordina Shit", "OrdinaShit") {}
}
