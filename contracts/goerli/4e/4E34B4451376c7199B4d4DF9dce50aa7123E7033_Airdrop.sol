...
contract Airdrop is IAirDrop, Initializable, PausableUpgradeable, OwnableUpgradeable {
    ...
    mapping(uint256 => bool) private airdropCreated;
    ...
    function airdrop(bytes32 _merkleRoot) external override onlyOwner whenNotPaused {
        require(!airdropCreated[airdropId], "Airdrop Id is created");
        airdropDatas[airdropId] = _merkleRoot;
        airdropCreated[airdropId] = true;
    ...
    function claim(
        ...
        require(!airdropClaimed[airdropKey] == true, "Airdrop is claimed");
