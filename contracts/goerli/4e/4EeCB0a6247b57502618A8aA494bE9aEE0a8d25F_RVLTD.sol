...
contract TOKEN is ERC721Psi, ERC2981, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    function withdraw() external onlyOwner {
        ...
        Address.sendValue(payable(_member.founder), ((balance * 4000) / 10000));
    ...
    function supportsInterface(bytes4 _interfaceId) public view virtual override(ERC721Psi, ERC2981) returns (bool) {
        return ERC721Psi.supportsInterface(_interfaceId) || ERC2981.supportsInterface(_interfaceId);
    }
}
