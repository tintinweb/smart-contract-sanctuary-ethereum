...
contract WereAreTest is ERC721A, Ownable, ReentrancyGuard {
    ...
    event welcomeToWereAreTest(uint256 indexed totalMinted);

    constructor(string memory _initNotRevealedUri)
        ERC721A("WereAreTest", "OLDI")
    {
    ...
    function mint(
        ...
        emit welcomeToWereAreTest(totalSupply());
    }
