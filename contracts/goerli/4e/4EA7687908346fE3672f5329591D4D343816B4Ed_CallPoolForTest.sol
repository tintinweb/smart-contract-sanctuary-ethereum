...
contract CallPoolForTest is ICallPool, Pausable {
    ...
    function _deposit(
        ...
        emit PreferenceUpdated(nft, tokenId, lowerStrikePriceGapIdx, upperDurationIdx, lowerLimitOfStrikePrice);
    }
...
interface ICallPoolEvents {
    ...
    event PreferenceUpdated(address indexed nft, uint256 indexed tokenId, uint8 lowerStrikePriceGapIdx, uint8 upperDurationIdx, uint256 lowerLimitOfStrikePrice);
