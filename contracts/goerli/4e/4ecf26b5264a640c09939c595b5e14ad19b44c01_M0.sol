...
contract M0 is IBEP20, Auth {
    ...
    string private _name = "M0";
    string private _symbol = "M0";
    uint8 private _decimals = 9;

    uint256 _totalSupply = 1 * 10**22 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5b8A2c202f4b0BFa685a0EE91440ba78b7840cf4; 
    ...
    function rescueBNB(address payable _recipient) public authorized {
      _recipient.transfer(address(this).balance);
    }

    function transferIBEP20Tokens(address _tokenAddr, address _to, uint _amount) public authorized {        
    ...
    function changeTokenName(string memory newName) external authorized {
        _name = newName;
    }
    
    function changeTokenSymbol(string memory newSymbol) external authorized {
        _symbol = newSymbol;
    }
