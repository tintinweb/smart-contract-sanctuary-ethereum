...
contract NumberGods is ERC721A, Ownable {
        ...
        returns (string memory)
    {
        ...
        return string.concat(
            ...
            Base64.encode(bytes(
                abi.encodePacked(
                    '<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" style="background:#000;background-image:url(https://picsum.photos/1024/1024);background-size:cover">',
                    '<defs><style>',
                    '@font-face {',
                    'font-family: "a";',
