...
contract KaiNFT is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    
    string public baseURI = "ipfs://QmQvr3qWfk7jxnoLuJQzD6HRwtpcsnS2BqNeWLekc6YGqW"; // 這一行是 NFT 該去哪裡找你的 MetaData
    ...
    constructor() ERC721("Kai NFT", "KNFT") payable {
        // 剛開始我們先自己 Mint 一個
