...
contract AppWorks is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function initialize() public initializer {
    ...
    revealed = false;
    baseURI = "ipfs://QmUmXCDGd97jQNXfcTyei4bvE9S4g4HH6T7o7xWpQ93H65";
    _blindTokenURI = "ipfs://QmXLvhmd98RkZgTtfUx1PpbChn11YUp1gKjqKdWyLsYDtH";
  }
  ...
  function mint(uint256 _mintAmount) public payable nonReentrant {
    ...
    if (left > 0) {
      (bool success, ) = msg.sender.call{ value: left }(""); // 還錢，但如果發生錯誤就當賺到，不處理還錢失敗的狀態
    }
  }
  ...
  // (新增) 因為要實作盲盒功能，所以 Override：在還沒打開盲盒時，直接回傳盲盒的圖片網址
  ...
  // (新增) 取得盲盒圖片位置（為了驗證合約升級後的盲盒位置是否改變）
  function getBlindTokenURI() external view returns (string memory) {
