...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
     ...
     */
    function requestBid() public returns (bytes32 requestId) {
        ...
        req.add(
            "get",
            "https://48dwhuvs2h.execute-api.eu-west-1.amazonaws.com/dev/quote?price=1000&maturity=30&option-type=call"
        );
    ...
    function fulfill(
        ...
        emit RequestVolume(_requestId, _bid);
        bid = _bid;
    }
