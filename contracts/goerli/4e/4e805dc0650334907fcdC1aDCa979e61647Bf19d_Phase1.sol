...
contract Phase1 is IPhase1, ReentrancyGuard, Ownable {
    ...
    uint256 private constant DURATION = 300 days;
    uint256 private constant DEPOSIT_END = 100 days;
    /// @dev WITHDRAW_1_END < WITHDRAW_2_END < DURATION
    uint256 private constant WITHDRAW_1_END = 150 days;
    uint256 private constant WITHDRAW_2_END = 160 days;
