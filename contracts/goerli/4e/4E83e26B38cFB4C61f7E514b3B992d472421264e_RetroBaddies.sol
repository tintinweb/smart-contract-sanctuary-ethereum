...
contract RetroBaddies is ERC721A, Ownable, ERC721AQueryable, ERC721ABurnable, ERC2981 {
    constructor() 
        ERC721A("RetroBaddies", "RETRO") {
    ...
    //mapping(uint32 => bool) private _isRevealed;
    ...
    function revealWithRandomOffset () 
        public 
        onlyOwner 
    {
        ...
        // does not require mint to be over to be called this is left up to owner
        ...
        // Token is revealed so use the revealed URI.
            {
                ...
                return bytes(_baseURI()).length != 0 ? string(abi.encodePacked(baseURI, _toString(tokenId+randomOffset),".json")) : '';
            }
