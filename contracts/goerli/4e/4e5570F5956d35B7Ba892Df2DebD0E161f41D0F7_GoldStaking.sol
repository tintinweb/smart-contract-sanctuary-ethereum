...
contract GoldStaking is Ownable {
    ...
    mapping (address => mapping (uint8 => META_DATA[])) public tokenStakeData;
    mapping (address => mapping (uint8 => META_DATA[])) public lpStakeData;
    ...
    function getTokenPrice() public view returns (uint256) {
        ...
        if(goldLP.token0() == address(goldToken))
            tokenPrice = (ethPrice * reserve1 / reserve0 / (10 ** (18 - goldToken.decimals())));
        else
            tokenPrice = (ethPrice * reserve0 / reserve1 / (10 ** (18 - goldToken.decimals())));
    ...
    function getLpPrice() public view returns (uint256) {
        ...
        if(goldLP.token0() == address(goldToken))
            ...
            lpPrice = (ethPrice * reserve0 * 2 / lpTotalSupply);
        return lpPrice;
    }
}
