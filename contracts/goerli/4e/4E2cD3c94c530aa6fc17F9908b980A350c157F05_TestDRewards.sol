...
contract TestDRewards is ITestDRewards, Ownable {
...
contract TestD is Context, IERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 private _uniswapV2Router;

    TestDRewards private _rewards;
    ...
    string private constant _name = "TestD";
    string private constant _symbol = "TSTD";
    ...
    constructor (address liquidityWalletAddy, address treasuryWalletAddy, address developmentWalletAddy) {
        ...
        _rewards = new TestDRewards(address(this));
