...
contract RevoltageDataTest is Ownable {
    ...
    mapping(address => StakeItem[]) internal stakes;
    ...
    //     item.end = end;
    //     revoltage.transfer(msg.sender, total);
    //     //Remove from balance
    //     balance[msg.sender] = balance[msg.sender] - item.amount;
    // }
    ...
    function getStakeItems() public view returns (StakeItem[] memory) {
