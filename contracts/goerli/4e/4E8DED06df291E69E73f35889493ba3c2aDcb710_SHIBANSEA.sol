...
/******************************************************************************
The first NFT marketplace of the Shibarium network
********************************************************************************/
...
contract SHIBANSEA is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBANSEA";
    string private _symbol = "SHIBSEA";
    ...
    address payable public marketingWallet = payable(0x5431E009a248346315091dadDa66391fD5995F35);

    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;

    uint256 public numTokensSellToAddToLiquidity = 500000 * 10**8;
