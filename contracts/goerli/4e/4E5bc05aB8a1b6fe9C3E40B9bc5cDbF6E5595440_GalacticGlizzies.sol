    ...
    ERC2981
{
    ...
    uint256 public constant PRICE = 0.000000001 ether;
    ...
    function mintPublic(uint256 _amount)
        ...
        verifyAvailableSupply(_amount)
    {
        uint256 walletMints = _getAux(msg.sender) + _amount;
        _setAux(msg.sender, uint64(walletMints));

        if (walletMints > MAX_MINTS_PER_WALLET)
