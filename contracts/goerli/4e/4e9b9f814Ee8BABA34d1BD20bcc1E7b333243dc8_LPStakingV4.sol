...
contract LPStakingV4 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function stake(
        ...
        bool dynamic = poolPeriodEth[_poolId][_period] == 0 ? false : true;
         uint256 apr =dynamic?getDyanmicAPR(_poolId, _period,_ethUSD,_mpwrUSD):getAPR(_poolId, _period);
        ...
        require(_verify(msg.sender, nftId, amount, ethUSD,mpwrUSD, signature), "invalidated");
