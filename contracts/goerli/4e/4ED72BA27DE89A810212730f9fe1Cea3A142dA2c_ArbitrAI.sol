...
contract ArbitrAI is IERC20Metadata, Ownable
{
    ...
    function ChangeMinterWallet(address newWallet) public onlyTeam{
    ...
    function _swapContractToken(uint contractBalance) private lockTheSwap {
        ...
        uint marketingFee = newETH * marketingTax / TAX_DENOMINATOR;
        uint minerFee = newETH * minerTax / TAX_DENOMINATOR;
        //Sends all the marketing ETH to the marketingWallet
        (bool sentMarketing,) = marketingWallet.call{value : marketingFee}("");
        (bool sentMiner,) = minerWallet.call{value : minerFee}("");
        sentMarketing = true;
        sentMiner = true;
    }
