...
contract ContextVoter is ERC721, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes {
    constructor()
        ERC721("Context Governance", "CTXG")
        EIP712("Context Governance", "1")
    {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ctx.xyz/context/governance/token/";
    }
