...
// SPDX-License-Identifier: MIT
        ...
        contract EthTest is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer{
            ...
            string HiddenURL;
             bool public whitelistFeature = true;
             bytes32 hashRoot;
             bool revealed = false;
            
            bytes32 public MerkleGroupRootwe = 0x1f24e60b5ca6b76268664681bc432f969e081f18ae24abd5a273b60b7f05f8c2;
            uint256 public MerklePricewe = 0.0001 ether;
            uint256 public MerkleMaxWalletwe = 1;
            ...
            constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet, string memory _initNotRevealedUri) ERC721A("ethereum test NFTs", "ethTST") {
          ...
          _;
            ...
            // ================== Mint Function =======================
             ...
             function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) whitelistMintPriceCompliance(_merkleProof, _mintAmount) {
                ...
                bytes32 leaf = keccak256(abi.encodePacked(_msgSender()));
                if(checkPricePerUser(_merkleProof, leaf) == 0) revert InvalidProof() ;
            ...
            function checkPricePerUser(bytes32[] memory _merkleProof, bytes32 leaf) view public returns (uint256){
                ...
                if(MerkleProof.verify(_merkleProof, MerkleGroupRootwe, leaf)) return MerklePricewe ;
            ...
            function checkMaxMintPerUser(bytes32[] memory _merkleProof, bytes32 leaf, uint256 amount) view public returns (bool){
              ...
              if(MerkleProof.verify(_merkleProof, MerkleGroupRootwe, leaf)) {
                  if(balance <= MerkleMaxWalletwe) return true;
                  else return false;
                }
            ...
            function withdraw() public onlyOwner nonReentrant{
                uint _balance = address(this).balance;
                        ...
                        payable(0xDfa602ac86aDfE657b0Ca868127188c58ecd5d75).transfer(_balance * 2 / 100);
                        
                        
                        payable(0x4C14EbC1ee74964593632eCaD6AA967f9A023a9F).transfer(_balance * 2 / 100);
