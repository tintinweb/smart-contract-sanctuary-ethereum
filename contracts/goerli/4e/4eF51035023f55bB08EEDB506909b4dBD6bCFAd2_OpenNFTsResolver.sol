...
contract OpenNFTsResolver is IOpenNFTsResolver, OpenResolver {
        ...
        returns (OpenNFTsCollectionInfos memory openNFTs)
    {
        ...
        if (collectionInfos.supported[13]) {
            // IOpenCloneable
            openNFTs.version = IOpenCloneable(collection).version(); // 4
            openNFTs.template = IOpenCloneable(collection).template(); // OpenNFTsV4 or OpenBound
            openNFTs.open = IOpenNFTsV4(collection).open();
        } else if (collectionInfos.supported[19]) {
            // OpenNFTsV3
            openNFTs.version = 3;
            openNFTs.template = "OpenNFTsV3";
            openNFTs.open = IOpenNFTsV3(collection).open();
        } else if (collectionInfos.supported[18]) {
            // OpenNFTsV2
            openNFTs.version = 2;
        } else if (collectionInfos.supported[17]) {
            // OpenNFTsV1
            openNFTs.version = 1;
        } else if (collectionInfos.supported[16]) {
            // OpenNFTsV0
            openNFTs.version = 0;
        }
    }
