    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    function initialize() public initializerERC721A initializer {
        ...
        revealUri = "ar://g84agNL0vN3nUwlfe1AoghLqHHK-OKs-cui7v1nqAZs";     //@Todo:本物に要変更
        preCost = 0.033 ether;
    ...
    function withdraw() external onlyTeam {
        bool success;
        // (success, ) = payable(0x6abb96ff62603B0646624f2CB517476194263fc8).call{value: (address(this).balance)}("");  //本番用
        (success, ) = payable(0x9A2c7b7B5E3cc2C2232341211f3F9F9D53b51D2E).call{value: (address(this).balance)}("");     //テスト用
