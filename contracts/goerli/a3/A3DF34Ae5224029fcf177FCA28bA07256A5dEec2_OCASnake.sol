    ...
    function cloneSnake(uint256 tokenId) private view returns (bytes memory) {
        ...
        return
            abi.encodePacked(
                ...
                selectedColors[generateAppleSeed(tokenId, 69) % uint256(19)],
                " } .Rrrrr { font: italic 40px serif; fill:",
                selectedColors[generateAppleSeed(tokenId, 1337) % uint256(19)],
                "; }</style><rect x='25' y='25' width='400' height='400' style='fill:",
                selectedColors[1],
                "; stroke:",
                selectedColors[generateAppleSeed(tokenId, 143) % uint256(19)],
                "; stroke-width:5; stroke-opacity:0.9;' /> <rect x='50' y='50' width='12' height='12' style='fill:",
                selectedColors[
                    uint256(generateAppleSeed(tokenId, 1337)) % uint256(20)
                ],
                ";'  />",
                string(svgData),
