...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xc274F2e0969704fA509A09203f6349449525fD9F,0x000000000000000000000000000000000000dEaD,0x000000000000000000000000000000000000dEaD,0x000000000000000000000000000000000000dEaD];
  uint256[] public payableFees = [5,80,5,5,5];
...
contract TestdemoContract is RamppERC721A {
    constructor() RamppERC721A("test demo", "SNEK"){}
}
