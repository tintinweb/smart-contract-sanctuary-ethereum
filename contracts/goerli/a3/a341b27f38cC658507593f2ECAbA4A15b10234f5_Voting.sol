...
contract Voting is DaoMembers {
    ...
    function newVotingOption (string memory _question) public onlyRole(MEMBER_ROLE) {
    ...
    function memberVoting(uint _voteId, bool _yesNo) public onlyRole(MEMBER_ROLE) {
    ...
    function getVoting(uint _voteId) public view returns (string memory, address, Status, Outcome, uint, Counters.Counter memory, Counters.Counter memory) {
        individualVoting storage idVote = votesDataBase[_voteId];

        return (idVote.question, idVote.createdBy, idVote.status, idVote.outcome, idVote.endDate, idVote.countYes, idVote.countNo);
    }

    
    //DELETE after test
    function getVotingTest() public view returns (string memory, address, Status, Outcome, uint, Counters.Counter memory, Counters.Counter memory) {
