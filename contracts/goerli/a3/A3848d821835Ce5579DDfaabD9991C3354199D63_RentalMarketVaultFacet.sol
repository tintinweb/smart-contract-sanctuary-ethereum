...
contract RentalMarketVaultFacet is ERC1155Holder, ERC721Holder {
    ...
    constructor(uint256 _overDueSafeLineamount, uint256 _overDueLimitamount) {
        LibRentalStorage.setMarketOverDue(_overDueSafeLineamount, _overDueLimitamount);
    }
    ...
    {
        return LibRentalStorage.getRentalDetails(_collection, _tokenId);
    }
    ...
    function getRenterDetails(
        ...
        return LibRentalStorage.getRenterDetails(_collection, _tokenId);
    }
    ...
    function getClaimableCollateral(
        ...
        return LibRentalStorage.getClaimableCollateral(_collection, _tokenId);
    }
    ...
    function getLeftCollateral(
        ...
        return LibRentalStorage.getLeftCollateral(_collection, _tokenId);
    }
    ...
    function getCollateralDetails(
        ...
        returns (bool returned, uint256 _collateralClaimed, uint256 _collateralToBeClaimed)
    {
        return LibRentalStorage.getCollateralDetails(_collection, _tokenId);
    }

    function getMarketRevenueBalance() external view returns (uint256) {
        return LibRentalStorage.getMarketRevenueBalance();
    }
    ...
    function getMarketOverDue()
        ...
        returns (uint256 _overDueSafeLineamount, uint256 _overDueLimitamount)
    {
        return LibRentalStorage.getMarketOverDue();
    }
    ...
    function withdrawRevenue() external onlyOwner {
        uint256 RevenueBalance = LibRentalStorage.getMarketRevenueBalance();
        (bool callSuccess, ) = payable(msg.sender).call{value: RevenueBalance}("");
        require(callSuccess, "Call failed");
        LibRentalStorage.setMarketRevenueBalance(false, RevenueBalance);
    }
    ...
    function withdrawERC1155Token(
        ...
        // IERC1155(_erc1155ContractAddress).approve(_to, _tokenId);
        IERC1155(_erc1155ContractAddress).safeBatchTransferFrom(
            address(this),
            _to,
            ids,
            amounts,
