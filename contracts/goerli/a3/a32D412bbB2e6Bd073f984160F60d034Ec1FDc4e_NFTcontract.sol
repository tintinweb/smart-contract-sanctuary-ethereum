...
contract NFTcontract is ERC721Enumerable, ReentrancyGuard {
    ...
    function updateOperatorsFliter(address[] calldata _operators, bool _filtered) external onlyOwner {
        require(_operators.length > 0, "Please input at least one operator address.");
        operatorFilterRegistry.updateOperators(address(this), _operators, _filtered);
    }
