...
contract ERC721AContract is ERC721A, Ownable, PaymentSplitter, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    event Referral(address indexed _referrer, uint256 _quantity);
    ...
    function mint(
        ...
        require(msg.sender != _referrer, "Referrer same as sender");
        ...
        _payReferral(_referrer, _quantity);
        
    }

    function _payReferral(address payable _referrer, uint256 _quantity) internal {
        if (_referrer != address(0)) {
            emit Referral(_referrer, _quantity);
