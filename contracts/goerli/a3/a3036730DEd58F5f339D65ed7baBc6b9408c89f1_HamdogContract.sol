...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x484c74b1E0F25C2fb52722C816f64A006cF883e4];
...
// File: contracts/HamdogContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract HamdogContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Hamdog";
    string public symbol = "Hamdog";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7UGjfDsW7AxQgHuvQYLX/contract-metadata";
  }
