 ...
 * @notice This contract handles minting The Great Flip tokens.
 */
contract TheGreatFlip is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xCa535d34EB9C1ef266a60eCEbFAd2870Bff3175B;
    ...
    address public royaltyAddress = 0x5f67ffa4b3f77DD16C9C34A1A82CaB8dAea03191;
    ...
    string public name = "The Great Flip";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeidzpfev6pwlfqsjjebzvbeitiwhza4judzalqhwfvmwqfznesmcqi/{id}"
        )
    {
