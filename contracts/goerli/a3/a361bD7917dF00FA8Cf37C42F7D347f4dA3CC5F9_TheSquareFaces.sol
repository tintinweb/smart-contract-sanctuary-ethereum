...
contract TheSquareFaces is ERC721Enumerable, Ownable, ReentrancyGuard{
    ...
    uint256 public publicDropTime = 1672527660;
    bool public enforcePresaleDropTime = true;
    uint256 public presaleDropTime = 1668034860;
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        if (!publicDropTimePassed() && presaleDropTimePassed()) {
            //general public
            require(!paused);
            require(msg.value >= presaleCost * _mintAmount,"amount problem");
