...
/**
 * @title Crowdsale
 * @dev Borrow from https://github.dev/OpenZeppelin/openzeppelin-contracts/blob/docs-v2.x/contracts/crowdsale/Crowdsale.sol and upgrade to solidity v0.8.0
 * @dev Crowdsale is a base contract for managing a token crowdsale,
 * allowing investors to purchase tokens with ether. This contract implements
 * such functionality in its most fundamental form and can be extended to provide additional
 * functionality and/or custom behavior. This contract extends Crowdsale.sol to use an ERC20 
 * stablecoin as the asset for purchasing the crowdsaled token.
...
contract MinimaCrowdsale is Context, Ownable, Pausable, ReentrancyGuard {
	...
	/**
	 * @param rates Array of number of token units a buyer gets per wei
	...
	/**
	 * @return the amount of wMinima sold.
	 */
	...
	/**
	 * @return the maximum cap of USDT to raise.
	 */
	...
	/**
	 * @return the purchaseToken being used to purchase token.
	 */
	...
	/**
	 * @return the signer being used to sign EIP712 signatures.
	 */
	 ...
	 *     require(usdtRaised().add(usdtAmount) <= cap);
	 * @param beneficiary Address performing the token purchase
	 * @param usdtAmount Value in USDT wei (6 decimals) involved in the purchase
	 */
