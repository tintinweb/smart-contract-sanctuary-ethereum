...
/**
 * @title BreechCreamsToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract BreechCreamsToken is ERC20Capped, ERC20Permit, Pausable {
    address private _owner;

    constructor() ERC20("Breech Creams Token","ECCM") ERC20Capped(1000000000 * (10**uint256(decimals()))) ERC20Permit("Breech Creams Token") { 
        _owner = _msgSender();
     }
