...
// File: contracts/BBGMTokenETH.sol
...
contract BBGMTokenETH is ERC20,IMintableERC20,Ownable {
...
// "MintableERC1155PredicateProxy": "0x72d6066F486bd0052eefB9114B66ae40e0A6031a",
    constructor(address predicate) ERC20("BBGMTokenETH", "BBGM") {
     ...
     */
    function mint(address user, uint256 amount) external override onlyPredicate {
        _mint(user, amount);
    }
    ...
    modifier onlyPredicate {
      require(msg.sender == predicateAddress, "only bridge has access to this child token function");
      _;
    }
}