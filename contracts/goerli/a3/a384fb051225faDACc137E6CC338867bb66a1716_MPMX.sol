...
{    
    ...
    { 
        ...
        { 
            require(VerifyBrightList(msg.sender, Proof, MintPassSale._Root), "Merkle: User Is Not On BrightList"); 
            require(
        ...
        MintPassInternalSale._AmountSold = MintPassInternalSale._AmountSold + Amount;
