    ...
    UUPSUpgradeable
{
    ...
    function initialize(bytes32 _merkleRoot) public initializer {
        ...
        baseURI = "https://nftstorage.link/ipfs/bafybeiafaubm34qzt6xqwwyywjolvgcyt5yotcnxz77ike6saav4ubxsoy";
        MEMBER_WHALE_TYPE = 0;
    ...
    function airdrop(
        ...
        _airdrop(
            _memberAddresses,
            _boardMemberAddresses,
            _advisorAddresses,
            _investorAddresses,
            _staffAddresses,
            _mediaGuestAddresses,
            _vipAddresses,
            _oculusAddress
        );
    }
    ...
    function _airdrop(
        ...
        if (!HAS_OCULUS_WHALE_BEEN_DISTRIBUTED) {
