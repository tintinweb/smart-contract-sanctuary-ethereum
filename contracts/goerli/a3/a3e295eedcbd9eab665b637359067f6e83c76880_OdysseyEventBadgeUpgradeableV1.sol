    ...
    UUPSUpgradeable
{
    ...
    function addNewEvent(string calldata eventName) external onlyOwner {
        require(eventBadgeIdStore[eventName] == 0, "Event is already exists");
        eventBadgeIdStore[eventName] = ++badgeIdCounter;
        eventStore.push(eventName);
    }
