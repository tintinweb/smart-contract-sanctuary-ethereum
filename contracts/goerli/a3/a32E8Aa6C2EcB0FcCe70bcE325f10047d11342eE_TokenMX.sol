...
contract TokenMX {
    ...
    string public name = "MinlongXToken"; // replace with your name
    string public symbol = "MX";  // replace with your initials
    uint256 public immutable decimals = 11; // replace with your decimals
    ...
    constructor() {
        ...
        mint(msg.sender, 1e20);  // this is 1 billion times 1eMyDecimals, 1e6*1e9
    }
