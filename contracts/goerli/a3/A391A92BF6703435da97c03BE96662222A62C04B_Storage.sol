...
contract Storage {
    ...
    function storeWithSigner(uint256 num, Sig memory storeRSV) public {
        bytes32 message = messageHash(abi.encodePacked(msg.sender, num));
        require(verifySigner(msg.sender, message, storeRSV), "ChangePrice: RSV invalid");
        sender = msg.sender;
        number = num;
    }
