...
// File contracts/Honkhonk.sol


pragma solidity ^0.8.9;
contract Honkhonk is ERC721A, Ownable {
    ...
    constructor(string memory initialBaseURI, bytes32 _wlRoot) ERC721A("Honkhonk", "HONK") {
    ...
    function setPresaleMint(bool _presaleActive) external {
        isPresaleActive = _presaleActive;
    }

    function setPublicMint(bool _publicActive) external {
