...
contract Test_Gotchi_1 is ERC721Enumerable, VRFConsumerBase, Ownable {
    ...
    address internal tokenAddress = 0x4bb0A8b1985ada204074DdB4d735FEa5Cbb5e42d; // goerli
    ...
    uint256 internal vrfFee = 2500000000000000000; // .25
    ...
    constructor(
        ...
        ERC721("Test Gotchi 1", "test_pet_1") 
    {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "test_gotchi #', Utils.toString(tokenId), '", "description": "Keep your nft pet alive and earn crypto.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
