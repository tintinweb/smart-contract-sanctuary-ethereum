...
contract TWSTTT is Context, iBEP20, Ownable {
 ...
 /**
  ...
  /** @dev destroys `amount` tokens and assigns them to `0x`, decreasing
   * the total supply over a period of time.
   *
  ...
  function _Approve(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: Approve the zero address");
