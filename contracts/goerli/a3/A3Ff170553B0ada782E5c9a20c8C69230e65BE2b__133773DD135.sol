 ...
 * @notice This contract handles minting 1337 73DD135 tokens.
 */
contract _133773DD135 is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x190727D008992394c00c5f181bD2377A6195abF5;
    address public freeClaimContractAddress =
        0x9251dEC8DF720C2ADF3B6f46d968107cbBADf4d4;
    // The address to which refunded tokens are returned
    address public refundAddress = 0x0901A2B056C925A39d2163332E87200355d2a300;
    address public royaltyAddress = 0x0901A2B056C925A39d2163332E87200355d2a300;
    address[] public payoutAddresses = [
        0x0901A2B056C925A39d2163332E87200355d2a300
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeignmn4elcbijcfeij27u6vv4fcdyyhuexisorugivvq3syb3y2uaa/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 7331;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 1466;
    ...
    uint256 public presalePrice = 0.0042 ether;
    ...
    // The total amount of time the refund period is active after refundStartTime
    uint256 public refundDuration = 1 days;
    // The amount of money to be returned in a refund
    uint256 public refundPrice = 0.0042 ether;
    // The start time from which the refund period begins
    ...
    constructor() ERC721A("1337 73DD135", "73DD135") {
    ...
    function refundGuaranteeActive() public view returns (bool) {
        return (block.timestamp < (refundStartTime + refundDuration));
    }
    ...
    function increaseRefundDuration(uint256 _refundDurationIncrease)
        external
        onlyOwner
    {
        refundDuration += _refundDurationIncrease;
    }
    ...
    function refund(uint256 _tokenId) external nonReentrant {
        ...
        safeTransferFrom(msg.sender, refundAddress, _tokenId);
