...
// File: contracts/VlinNFTFactory.sol
...
/* Vlin NFT Factory
    Create new Vlin NFT collection
*/
contract VlinNFTFactory {
    // owner address => nft list
    mapping(address => address[]) private nfts;

    mapping(address => bool) private vlinNFT;
