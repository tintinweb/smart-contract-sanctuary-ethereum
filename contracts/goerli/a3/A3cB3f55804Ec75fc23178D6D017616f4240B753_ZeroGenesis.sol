...
/// @title Zero Genesis
/// @author audie.eth
/// @notice An NFT that includes lifetime access to the Zero application by Probably0.
...
contract ZeroGenesis is ERC721, ERC721Burnable, ERC2981, Ownable, DefaultOperatorFilterer {
     ...
     */
    constructor(string memory name, string memory symbol, string memory startingContractURI, string memory startingTokenURI)
        ERC2981()
        ERC721(name, symbol)
        ...
        Ownable()
    {
        ...
        _tokenURI = startingTokenURI;
        contractURI = startingContractURI;
    }
    ...
    /**
     * @notice Boolean indicating if the minting is currently open
     */
    bool public mintOpen = true;

    /**
     * @notice Boolean indicating if the Allow List Mint is currently open
     */
    ...
    /**
     * @notice This percent of purchase price to set aside for creator fees, royaltyPercent/10000
     */
    ...
    /**
     *  @notice Public mint function. Just checks the mint is open and sender sent enough ETH
     */
     ...
     *  @param proof A merkle proof that uses the calling address as the data
     ...
     *   @return mintedSupply Returns total existing supply
     */
     ...
     *  @return canMint A boolean indicating whether the address give can mint with the given proof
     */
