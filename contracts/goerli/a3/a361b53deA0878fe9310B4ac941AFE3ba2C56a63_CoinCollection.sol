...
// File: contracts/CoinCollection.sol
...
contract CoinCollection is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    mapping(uint8 => uint256) public tokenPrice; // Create a struct?
    mapping(uint8 => uint32) public tokenSupplyLimit;

// >>> Func to trace funds for specific address
...
////////////////////////////////  DEFAULT FUNC \\\\\\\\\\\\\\\\\\\\\\\\\\\\
    function setURI(string memory newuri) public onlyOwner {
        _setURI(newuri); //????? Does it change previous uri?
    }
