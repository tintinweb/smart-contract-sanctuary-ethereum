...
contract Primes is ERC721, Ownable {
    ...
    function setSerialUl(uint32[] calldata _serialUl) public onlyOwner {
        delete serialUl;
        serialUl = _serialUl;
    }
    ...
    function tokenSVG(
        ...
        require(_exists(_serial), "Non-extistent token");
        svg_ = generateSVG(_serial);
    }
    ...
    function generateSVG(
        ...
        string memory title = string(
            abi.encodePacked("<title>Primes #", _serial.toString(), "</title>")
        );
        string memory paths = generatePaths(_serial);
        return
            string(
                abi.encodePacked(
