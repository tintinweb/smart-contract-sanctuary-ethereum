...
contract W3Card is ERC721AURIStorage, Ownable, ReentrancyGuard {    
    ...
    function initialize() initializer public {
        ...
        uri = "https://foreverfrens-staging.com/api/v1/tokens/";
    ...
    function mint(
        address to,
        uint quantity,
        string memory cardTier,
        string memory stampTier,
        uint transferAmount,
        uint transferDate,
        bool isDonation
        ) public virtual payable mintCompliance(quantity, transferDate) {
