...
contract MyGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(string memory _name, uint256 _delayInBlocks, uint256 _periodInBlocks, uint256 _proposalThreshold, IVotes _token, uint256 _quorum, TimelockController _timelock)
        Governor(_name)
        GovernorSettings(_delayInBlocks, _periodInBlocks, _proposalThreshold)
