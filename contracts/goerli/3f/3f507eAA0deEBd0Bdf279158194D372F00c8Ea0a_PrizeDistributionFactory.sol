 ...
 * @author Asymetrix Protocol Inc.
 * @notice The Prize Distribution Factory populates a Prize Distribution Buffer for a prize pool.  It uses Draw Buffer and Ticket
 */
contract PrizeDistributionFactory is Initializable, Manageable {
    ...
    /// @param totalNetworkTicketSupply The total network ticket supply that was used to compute the number of picks
     ...
     * The Draw for the given draw id will be pulled in, and the total network ticket supply will be used to calculate number of picks.
     ...
     * The Draw for the given draw id will be pulled in, and the total network ticket supply will be used to calculate the number of picks.
    ...
    /**
     * @notice Allows the owner or manager to override the minimum pick cost. The minimum pick cost will affect the
     * amount of picks that each user gets.
    ...
    /**
     * @notice Allows the owner or manager to override the end timestamps offset.
     * @param _endTimestampOffset The new timestamps offset to set for future prize distributions
     */
     ...
     * @return userPicks Partial amount of picks that a user has in the active draw.
     * @return totalPicks Partial amount of total picks supply in the active draw.
     */
     ...
     * @return PrizeDistribution The result will include startTimestampOffset, endTimestampOffset, numberOfPicks.
     */
    ...
    /**
     * @notice Calculates what the prize distribution will be, given a draw timestamp and the beacon period
     * @param _beaconPeriodSeconds The beacon period in seconds
     * @param _drawTimestamp The timestamp at which the draw started.
     * @return PrizeDistribution The calculated prize distributed based on the given params for the passed draw id
     */
