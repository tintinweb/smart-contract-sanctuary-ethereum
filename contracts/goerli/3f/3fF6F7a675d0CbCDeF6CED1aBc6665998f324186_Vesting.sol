...
contract Vesting {
    ...
    IERC20 public immutable hinata;

    uint256 public vestingId;
    mapping(uint256 => VestingInfo) public vestings;
    mapping(address => uint256[]) public vestingIds;

    constructor(IERC20 hinata_) {
        require(address(hinata_) != address(0), "Vesting: INVALID_HINATA");
        hinata = hinata_;
    }
    ...
    function claim() public returns (uint256 claimed) {
        ...
        hinata.safeTransfer(msg.sender, claimed);
    ...
    function _initVesting(VestingInfo calldata vesting_) private {
        ...
        hinata.safeTransferFrom(msg.sender, address(this), vesting_.amount);
