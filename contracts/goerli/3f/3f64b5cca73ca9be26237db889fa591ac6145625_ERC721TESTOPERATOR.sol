...
contract ERC721TESTOPERATOR is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721("ERC721 TEST OPERATOR", "TO") {
    setBaseURI("http://localhost:4000/api/erc721-test-operator/token/");
