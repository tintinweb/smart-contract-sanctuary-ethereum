    ...
    **/
    ...
    function drinkBottle(
        ...
        **/
        ...
        ElixirConsumer(msg.sender).applyElixir(targetId, element, attributes);
    }
    ...
    function withdrawTokens(address tokenAddress) external onlyOwner() {
        for (uint256 i = 0; i < payees.length; i++) {
            IERC20(tokenAddress).transfer(payees[i], (IERC20(tokenAddress).balanceOf(address(this))/10000)*paymentInfo[payees[i]]);
        }
    }
    /*** PAYMENT LOGIC (End) *******************************************/
    /*******************************************************************/
...
abstract contract ElixirConsumer {
