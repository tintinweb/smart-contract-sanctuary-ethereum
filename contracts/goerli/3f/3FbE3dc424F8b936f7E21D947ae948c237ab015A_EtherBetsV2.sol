...
contract EtherBetsV2 is VRFConsumerBaseV2{
    ...
    */
    ...
    constructor(string memory _name, uint _betCost, uint8 _maximumNumber, uint8 _picks, uint256 _timeBetweenDraws, uint64 subscriptionId) VRFConsumerBaseV2(vrfCoordinator){
        name = _name;
        betCost = _betCost;
    ...
    function getDetails() public view returns (string memory, uint, uint8, uint8, uint, uint, bool, uint, uint, uint8[] memory, uint256){
        return (name, betCost, maximumNumber, picks, timeBetweenDraws, lastDrawTime, paused, draw, address(this).balance, winningNumbers, randomNumber);
    }
