...
contract Tokens is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public treasuryWallet =
        payable(0xA7Ba49728F765e7fd52B73A792178C89b481e453);
    address payable public marketingWallet =
        payable(0xCAe4f9aaCdf12ACA96929047BCa07e4b178dF096);
    ...
    string private constant _name = "dop";
    ...
    uint256 public swapAtAmount = _tTotal.div(10000);
    ...
    function initContract() external onlyOwner {
        ...
        _isExcludedFee[marketingWallet] = true;
    }
    ...
    function AddSniper(address[] memory account) public onlyOwner {
    ...
    function perdonSniper(address account) external onlyOwner {
