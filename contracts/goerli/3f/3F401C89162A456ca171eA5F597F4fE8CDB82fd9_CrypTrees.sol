...
import {ERC721ASeaDrop} from "./tokens/ERC721/extensions/ERC721ASeadrop.sol";

contract CrypTrees is 
    ERC721ASeaDrop
{
    constructor(
        string memory name_, 
        ...
        ERC721ASeaDrop(name_, symbol_, allowedSeaDrop)
    {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(uri).length != 0 ? 
            string(abi.encodePacked(uri, _toString(tokenId), ".json")) : 
            '';
    }

    /**
     * Disables or enables the Operator Registry Filter system
     * - we do not want to be forever locked in
     * - when it stops making sense, it will be disabled.
     */
...
import {
    ERC721AContractMetadata,
    ISeaDropTokenContractMetadata
} from "./ERC721AContractMetadata.sol";
...
import {
    IERC165
} from "../../../interfaces/IERC165.oz.sol";

import {
    OpenSeaDefaultOperatorFilterer
} from "../../../access/OperatorFilterer.sol";
    ...
    OpenSeaDefaultOperatorFilterer
{
    ...
    constructor(
        ...
        address[] memory allowedSeaDrop
    ) ERC721AContractMetadata(name, symbol) {
 ...
 */
contract ERC721AContractMetadata is
    ERC721A,
    TwoStepOwnable,
    ISeaDropTokenContractMetadata
{
