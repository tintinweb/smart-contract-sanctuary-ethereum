...
import "@1hive/minime/contracts/MiniMeToken.sol";
import "@1hive/minime/contracts/ITokenController.sol";
...
contract BaseTemplate is APMNamehash, IsContract {
    ...
    bytes32 internal constant PAYROLL_APP_ID = 0x463f596a96d808cb28b5d080181e4a398bc793df2c222f6445189eb801001991;
    ...
    function _unwrapPayrollSettings(uint256[4] memory _payrollSettings)
        internal
        pure
        returns (
