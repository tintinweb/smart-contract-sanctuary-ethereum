 ...
 * @notice This contract handles minting Check Letter´s Editin tokens.
 */
contract CheckLetterSEditin is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x96611b6688aCd7dd75DC8bAC92dF4c01874f3294;
    ...
    string public baseTokenURI =
        "ipfs://bafybeiebnzkumtc33leg6s5dxuvbg6coslrvfamari2w73wb7zms3y3q6a/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 4444;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 1420;
    uint256 public presaleMintsAllowedPerAddress = 4444;
    uint256 public presaleMintsAllowedPerTransaction = 4444;
    uint256 public presalePrice = 0.003 ether;
    uint256 public publicMintsAllowedPerAddress = 5;
    uint256 public publicMintsAllowedPerTransaction = 4444;
    ...
    constructor()
        ERC721A("Check Letters Editin", "Checks")
        RevokableOperatorFilterer(
