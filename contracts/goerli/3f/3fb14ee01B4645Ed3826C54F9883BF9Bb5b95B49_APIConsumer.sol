...
// File: creditConsumerContractV2.sol
...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    uint256 private fee;
    event RequestScore(bytes32 indexed requestId, uint256 volume);

    //constructor function
    constructor() ConfirmedOwner(msg.sender) {
        setChainlinkToken(0x326C977E6efc84E512bB9C30f76E30c160eD06FB);
        setChainlinkOracle(0x6F5C09d496D4449723916d47d9a5d185fd467Bbb);
        jobId = "bc7b057b54e147708fd1a29ca08fe96b";
     ...
     */
    function requestScore(string memory _address)
        public
    ...
    {
        emit RequestScore(_requestId, _volume);
        creditScore = _volume;
    }
