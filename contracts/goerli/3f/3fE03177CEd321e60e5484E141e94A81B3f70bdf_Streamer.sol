...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        require(balances[msg.sender] ==0,"A Stream is already continued");
...
function challengeChannel() public{
    require(balances[msg.sender] !=0,"A channel is not opened");
...
require(canCloseAt[msg.sender] !=0,"You don't have a channel");
require(block.timestamp > canCloseAt[msg.sender],"Time stamp is not reached");
