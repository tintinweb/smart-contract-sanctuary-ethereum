...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xE2Be06Bfa78BfDF5bfA5D7293DFf0B4C43F225E7];
  address public erc20Payable = 0xE2Be06Bfa78BfDF5bfA5D7293DFf0B4C43F225E7;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 0.0039 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, type(uint256).max) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibo45uepxdcqepd6ntph7i2p7bzsn65tlp35sfho3aukrw5jk5ggy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ay579AHgi3Dj9QE1UZy1/contract-metadata";
  }
...
contract MyMintplexProjectContract is ERC721APlus {
    constructor() ERC721APlus("My Mintplex Project", "MINTPLEX"){}
}
