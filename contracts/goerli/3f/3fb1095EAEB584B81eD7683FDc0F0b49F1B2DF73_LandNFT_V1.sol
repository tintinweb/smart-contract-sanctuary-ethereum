...
contract LandNFT_V1 is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    ) external returns(string[MINT_LIMIT] memory) {
     ...
     */
    function transferTokens(uint256 _mintNum, uint256 _tokenPrice) internal returns(string[MINT_LIMIT] memory) {
        string[MINT_LIMIT] memory tokenHashList;
