...
contract thecollecteve is ERC721A, Ownable, DefaultOperatorFilterer  {
  using SafeMath for uint256;
    ...
    function updatewl2MerkleRoot(bytes32 newMerkleRoot) external onlyOwner {
        wl2MerkleRoot = newMerkleRoot;
    }

    function updatewl3MerkleRoot(bytes32 newMerkleRoot) external onlyOwner {
        wl3MerkleRoot = newMerkleRoot;
    }
    ...
    function whitelistMint2(uint256 numberOfTokens, bytes32[] calldata merkleProof ) payable external callerIsUser {
        ...
        // Verify the merkle proof
        require(MerkleProof.verify(merkleProof, wl2MerkleRoot,  keccak256(abi.encodePacked(msg.sender))  ), "Invalid proof");
    ...
    function whitelistMint3(uint256 numberOfTokens, bytes32[] calldata merkleProof ) payable external callerIsUser {
        ...
        // Verify the merkle proof
        require(MerkleProof.verify(merkleProof, wl3MerkleRoot,  keccak256(abi.encodePacked(msg.sender))  ), "Invalid proof");
