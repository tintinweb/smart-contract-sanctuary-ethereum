...
contract IntoTheFuture is ERC721A, Ownable, ReentrancyGuard {
...
// ================== Variables Start =======================
  ...
  string public names= "Into The Future";
  string public symbols= "Into The Future (Land)";
  uint256 public maxLimitPerWallet2 = 5;
  uint256 public whitelistsupply=10000;
  bool public whitelist = false;
  uint256 public whitelistsupplyminted;
  mapping (address => uint256) public addressminted;
  mapping(address=> bool) public freemintclaimed;
  bytes32 public root = 0x580dd5fa7fd174743840299c732e9d8cade2b955f32334611a92deae1b15c074; 
...
function mint(uint256 qty, bytes32[] calldata _merkleProof)public payable {
    ...
    require(cost*qty<= msg.value, "Not Enough Ether Sent");
    ...
    _safeMint(msg.sender, qty);          
       ...
       if(q==false) {
    require(publicsale==true,"Sale hasn't began yet");  
    uint256 newsupply=(whitelist ? 6667 : 10000);
    require(cost*qty<= msg.value, "Not Enough Ether Sent");
...
// ================== Constructor Start =======================
  ...
  constructor(
    ...
    seturi("https://www.intothefuture.xyz/unreveal/");
  }
...
// ================== Withdraw Function Start =======================
  ...
  function withdraw() public onlyOwner nonReentrant {
    //owner withdraw
                require(payable(team).send(address(this).balance));
