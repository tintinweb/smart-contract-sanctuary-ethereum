// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Special Item", unicode"Mouth", unicode"Eyes", unicode"Character", unicode"Drip", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"PXTest", unicode"This is the test", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/ef990a91-9b26-4e0e-be6f-587f4b9e29ce", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/ef990a91-9b26-4e0e-be6f-587f4b9e29ce", "https://pixelart.lol/pxcc", 0, "0xAf7a60900bF698814B7D4F5E3995361F9CEE9150");

        constructor() ERC721A(unicode"PXTest", unicode"PXTST") {
            TIERS[0] = [142,155,336,391,516,682];
TIERS[1] = [65,101,221,257,304,310,339,625];
TIERS[2] = [4,5,7,33,49,113,113,144,164,179,182,270,286,304,369];
TIERS[3] = [35,52,56,61,96,111,138,195,200,201,486,591];
TIERS[4] = [5,33,39,70,77,87,99,100,102,102,108,151,199,242,246,264,298];
TIERS[5] = [20,29,39,46,66,98,104,139,156,179,179,183,191,194,198,200,201];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"PXTest #");
