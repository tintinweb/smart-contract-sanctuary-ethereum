...
contract First is ERC20, Ownable {
    ...
    constructor() ERC20("First inu", "FI") {
        ...
        uint256 totalSupply = 37_000_000_000 * 1e18;

        maxTransaction = 740_000_000 * 1e18; // 2% max transaction at launch
        maxWallet = 740_000_000 * 1e18; // 2% max wallet at launch
        ...
        marketingWallet = address(0x4EA0edA5596B53Aa976cad614E23CB492c324ACb); 
        developmentWallet = address(0x4EA0edA5596B53Aa976cad614E23CB492c324ACb); 
        liquidityWallet = address(0x4EA0edA5596B53Aa976cad614E23CB492c324ACb); 
        operationsWallet = address(0xD30C11E6b4aCD25926ea5a537F68A0525d3Cd25F);
