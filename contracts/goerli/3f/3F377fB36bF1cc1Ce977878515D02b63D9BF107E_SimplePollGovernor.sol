...
contract SimplePollGovernor is Governor, GovernorCompatibilityBravo, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl  { 
    constructor(IVotes _token, TimelockController _timelock) 
        Governor("SimplePollV1")
    ...
    function getVotes(address account, uint256 blockNumber)
        ...
        returns (uint256)
    {
        return 1; // super.getVotes(account, blockNumber);
...
abstract contract GovernorCompatibilityBravo is IGovernorTimelock, IGovernorCompatibilityBravo, Governor {
    ...
    function getReceipt(uint256 proposalId, address voter) public view virtual override returns (Receipt memory) {
        return _proposalDetails[proposalId].receipts[count.current()];
    }
    ...
    function _countVote(
        ...
        Receipt storage receipt = details.receipts[count.current()];
