...
contract ProjectCurseNFT is ERC721A, Ownable, PaymentSplitter {
    ...
    uint256 public saleStartTime = 1668804300;
    ...
    address[] private _team = [0x103cC0F2f6F09039FBE87f6f8885c0BaFf2F948a];
    ...
    function SetWhitelistPrice(uint256 _PRICE_WHITELIST) public onlyOwner {
        PRICE_WHITELIST = _PRICE_WHITELIST;
    }

    function SetPublicPrice(uint256 _PRICE_PUBLIC) public onlyOwner {
        PRICE_PUBLIC = _PRICE_PUBLIC;
    }
