...
/**
 * @title PoisonBatchToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract PoisonBatchToken is ERC165, ERC20Capped {
    address private _owner;

    constructor() ERC20("Poison Batch Token","ISB") ERC20Capped(1000000000 * (10**uint256(decimals())))  { 
        _owner = _msgSender();
     }
