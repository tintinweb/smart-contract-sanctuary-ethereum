...
contract BitsRelay2 is Ownable, ReentrancyGuard {
    ...
    function depositEthAndSwap(address tokenAddress ) public payable nonReentrant
    {
        require(msg.value > 0, "You must send some ETH");
    ...
    function swapTokensForToken(address tokenIn, uint amountIn, address tokenOut, address to ) public nonReentrant {
    ...
    function swapToEth(address tokenIn, uint256 amount, address to ) public {
