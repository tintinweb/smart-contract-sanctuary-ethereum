...
contract LiveMintArtist is Ownable, ReentrancyGuard, CTZNPlugin
{   
    /*-------------------*/
    /*  STATE VARIABLES  */
    /*-------------------*/
    ...
    mapping(uint => mapping(uint => uint)) public MintedWorks;
    ...
    mapping(uint => mapping(uint=>bytes32[][])) private _Data; // TicketID => Data
     ...
     */
    event LiveMintCompleteArtist(address indexed Recipient, uint ArtistID, uint TicketID, uint MintedWorkNumber);
     ...
     */
    event ArtistMintPassRedeemed(address indexed Redeemer, uint ArtistID, uint TicketID, bytes32 Data);
    ...
    constructor()
    { 
        Artists[0]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[1]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[2]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[3]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[4]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[5]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[6]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[7]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[8]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;
        Artists[9]._MintPass = 0x6f6a6815268f298c05dCe7492921ED15AFE77BAd;

        Artists[0]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[1]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[2]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[3]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[4]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[5]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[6]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[7]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[8]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        Artists[9]._Minter = 0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B;
        ...
        IERC20(0x9B067ff0bE00e3c9a7F5511D58C4b564D7793784).approve( // CryptoCitizens
            Artists[0]._Minter,
    ...
    function RedeemArtistPass(
        ...
        unchecked
        {
            for(uint x; x < ArtistIDs.length; x++)
            {
                ...
                _Data[ArtistIDs[x]][TicketIDs[x]].push(Data);
                emit ArtistMintPassRedeemed(msg.sender, ArtistIDs[x], TicketIDs[x], Data[x]);
            }
    ...
    function _LiveMintArtist(uint ArtistID, uint[] calldata TicketIDs) external onlyMinter 
    {
        unchecked
        {
            for(uint TicketID; TicketID < TicketIDs.length; TicketID++)
            {
                ...
                MintedWorks[ArtistID][TicketIDs[TicketID]] = MintedWorkTokenID;
                // if(!DelegateStatus[ArtistID][TicketIDs[TicketID]]) { ICTZN(CTZN).IncrementCTZN(Recipient, _RewardRates[2]); } 
     ...
     * @dev Sets QR Index
     */
    function __ChangeQRIndex(uint ArtistID, uint NewIndex) external onlyOwner { Artists[ArtistID]._CurrentQR = NewIndex; }
    ...
    function __NewArtist(
        ...
        Artists[_NumTotalArtists]._Name = Name;
        Artists[_NumTotalArtists]._ProjectID = ProjectID;
        Artists[_NumTotalArtists]._MintPass = MintPass;
        Artists[_NumTotalArtists]._Minter = Minter;
        Artists[_NumTotalArtists]._ERC20 = ERC20;
        Artists[_NumTotalArtists]._Root = Root;
        Artists[_NumTotalArtists]._MaxQR = MaxQR;
        Artists[_NumTotalArtists]._CurrentQR = CurrentQR;
        Artists[_NumTotalArtists]._ERC20 = ERC20;
        IERC20(Artists[_NumTotalArtists]._ERC20).approve(Minter, 0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffff);
        emit NewArtist(_NumTotalArtists);
        _NumTotalArtists++;
    }
    ...
    //  */
    // function readData(uint[] calldata ArtistIDs, uint Range) public view returns(bytes32[][] memory Datas)
    // {
    //     bytes32[][] memory AllData = new bytes32[][](Range);
    //     for(uint ArtistID; ArtistID < ArtistIDs.length; ArtistID++)
    //     {
    //         for(uint TicketID; TicketID < Range; TicketID++) 
    //         { 
    //             for(uint DataLength; DataLength < _Data[ArtistID][TicketID].length; DataLength++)
    //             {
    //                 AllData[ArtistIDs[ArtistID]] = _Data[ArtistID][TicketID]; 
    //             }
    //         }
    //     }
    //     return AllData;
     ...
     */
    function readUnmintedArtistTicketIDs(uint[] calldata ArtistIDs, uint Range) public view returns(uint[][] memory TokenIDs)
    {
