...
contract SweepDollarCoin is BaseSweep {
    ...
    function sweep_info() public view returns (uint256, uint256, uint256, uint256) {
        return (
    ...
    function setETHUSDOracle(address _eth_usd_consumer_address) public onlyByOwnGov {
...
import '../Uniswap/V2/UniswapV2OracleLibrary.sol';
