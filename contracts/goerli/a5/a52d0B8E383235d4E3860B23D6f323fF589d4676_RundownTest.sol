...
// IMPORTED FROM THERUNDOWN
// View contract here: https://market.link/nodes/TheRundown/integrations
...
contract RundownTest is ChainlinkClient {
    ...
    /**
     * Add the LINK token address and the Operator.sol contract address.
     */
    constructor() {
    ...
    function getGamesCreated(
        bytes32 _requestId,
        uint256 _idx
    ) external view returns (GameCreate memory) {
    ...
    function getGamesResolved(
        bytes32 _requestId,
        uint256 _idx
    ) external view returns (GameResolve memory) {
    ...
    function _bytes32ArrayToString(
