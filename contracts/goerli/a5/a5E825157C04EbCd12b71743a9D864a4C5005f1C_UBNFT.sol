...
contract UBNFT is ERC721 {
    ...
    constructor() public ERC721("UBLogos", "UB") {
        tockenCounter=0;
    }
    function createLogoNFT(string memory _tokenURI) public returns(bytes32){
        require(tockenCounter<=maxLogs,"maximun quantity of logs emitted");
        uint256 newTokenID = tockenCounter;
