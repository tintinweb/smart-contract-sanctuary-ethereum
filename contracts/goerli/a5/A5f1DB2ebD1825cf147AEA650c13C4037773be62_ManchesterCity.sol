...
contract ManchesterCity is Ownable, ERC721AQueryable {
    ...
    modifier mintChecker(
        ...
        if (_totalMinted() + _amount > mintConfig.freeMintLimit) {
    ...
    function whitelisted(bytes32[] calldata _merkleProof) external view returns (bool) {
