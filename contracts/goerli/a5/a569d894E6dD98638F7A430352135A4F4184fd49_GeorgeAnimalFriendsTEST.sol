...
contract GeorgeAnimalFriendsTEST is ERC721A, Ownable, ReentrancyGuard {

    string baseURI = "ipfs://bafybeihuzsnvcmt2rvk6sjkahdfl4cmvgs5wgeqp7h5rgmpsollhpowiru/";
    string public baseExtension = ".json";
    uint256 public cost = 0;
    uint256 public maxSupply = 230;
    uint256 public preSaleSupply = 230;
...
//onlyOwner block
    ...
    function airdropMint(address[] calldata _airdropAddresses , uint256[] memory _airdropAmount) public onlyOwner{
        uint256 supply = totalSupply();
        ...
        for(uint256 i = 0; i < _airdropAmount.length; i++) {
           _safeMint(_airdropAddresses[i], _airdropAmount[i] );
        }
    }
