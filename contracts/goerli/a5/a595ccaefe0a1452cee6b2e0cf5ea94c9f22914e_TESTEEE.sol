...
contract TESTEEE is IERC20Metadata, Ownable, ReentrancyGuard {
    ...
    address public devolpmentWallet = 0x25cAA5B80bd27cd47524cec0480D6EA6C84CBaD6;
    
    string constant _name = "testeee";
    string constant _symbol = "TESTEEE";
    ...
    uint256 public devolpmentFee = 30; // 3%
    uint256 public lpFee = 30; // 3%
    uint256 private totalFee;
    
    // Total = 100% (1000)
    uint256 public marketingPortionOfSwap = 250; // 25%
    uint256 public devolpmentPortionOfSwap = 375; // 37.5%
    ...
    function swapBack() private nonReentrant {
        ...
        uint256 amountERCDevolpment = amountERC.mul(devolpmentPortionOfSwap).div(FEES_DIVISOR);
        ...
        transferToAddress(payable(devolpmentWallet), amountERCDevolpment);
