...
contract DssSpellAction is DssAction, DssSpellCollateralOnboardingAction {
    ...
    function actions() public override {
        ...
        DssExecLib.setIlkStabilityFee("ETH-A", TWO_PT_FIVE_PCT_RATE, true);

        DssExecLib.setIlkStabilityFee("ETH-B", FIVE_PCT_RATE, true);

        DssExecLib.setIlkStabilityFee("WSTETH-A", TWO_PT_TWO_FIVE_PCT_RATE, true);
        ...
        DssExecLib.setIlkStabilityFee("GUNIV3DAIUSDC2-A", ZERO_PT_SEVEN_FIVE_PCT_RATE, true);

        DssExecLib.setIlkStabilityFee("TUSD-A", ZERO_PT_TWO_FIVE_PCT_RATE, true);


        /// Maximum Debt Ceiling Changes

        DssExecLib.setIlkAutoLineDebtCeiling("GUNIV3DAIUSDC1-A", 200 * MILLION);

        DssExecLib.setIlkAutoLineParameters("GUNIV3DAIUSDC2-A", 950 * MILLION, 50 * MILLION, 8 hours);
