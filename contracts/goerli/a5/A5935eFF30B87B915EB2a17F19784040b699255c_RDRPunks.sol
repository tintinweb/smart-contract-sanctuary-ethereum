...
import "https://github.com/FrankNFT-labs/ERC721F/blob/v4.7.2/contracts/token/ERC721/ERC721FCOMMON.sol";
import "https://github.com/FrankNFT-labs/ERC721F/blob/v4.7.2/contracts/utils/AllowListWithAmount.sol";
...
contract RDRPunks is ERC721FCOMMON, AllowListWithAmount {
    ...
    */
    ...
    function mint(uint256 numberOfTokens) external payable{
        ...
        require(getSalePrice(numberOfTokens) <= msg.value, "Ether value sent is not correct"); 
    ...
    function getSalePrice(uint256 numberOfTokens) public view returns (uint256) {
