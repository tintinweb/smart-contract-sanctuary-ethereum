...
import "../child/AkxChildBridge.sol";
...
contract AkxRootBridge is FxBaseRootTunnel {
    ...
    return abi.encodeWithSelector(AkxChildBridge.setNumberForParentChain.selector, newNumber);
}
}
