...
contract ConnectFour is IConnectFour, ERC721, Ownable {
    ...
    constructor() payable ERC721("Connect Four", "C4") {}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory image = string.concat(baseURI, tokenId.toString());
