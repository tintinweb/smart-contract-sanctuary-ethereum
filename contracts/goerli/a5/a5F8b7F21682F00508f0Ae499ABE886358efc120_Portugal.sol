...
contract Portugal is AdminControl, IIdentityVerifier, ICreatorExtensionTokenURI {
    ...
    Customizations _customization;

    function configure(address marketplace, uint listingId, address creator, Customizations calldata customization, string memory baseURI) public adminRequired {
    ...
    function tokenURI(address creator, uint256 tokenId) external view override returns (string memory) {
        ...
        return string(abi.encodePacked(_baseURI, "style=", _customization.style.toString(), "&spread=", _customization.spread.toString(), "&inverse=", _customization.inverse.toString()));
    }
}
