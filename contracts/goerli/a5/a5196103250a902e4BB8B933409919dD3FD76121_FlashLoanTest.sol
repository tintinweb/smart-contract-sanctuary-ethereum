...
import {IFlashLoanSimpleReceiver} from "./interface/IFlashLoanSimpleReceiver.sol";

// import {IWETH9} from "./interface/IWETH9.sol";
// import {IPriceOracleGetter} from "./interface/IPriceOracleGetter.sol";
// import {Ownable} from "./access/Ownable.sol";

contract FlashLoanTest is LeverageStorage, IFlashLoanSimpleReceiver {
    constructor() {}
...
contract LeverageStorage {
    ...
    function _addUserBalances(
        address account,
        address _asset,
        uint256 _amount
    ) internal {
        balance[msg.sender][_asset] += _amount;
    }
