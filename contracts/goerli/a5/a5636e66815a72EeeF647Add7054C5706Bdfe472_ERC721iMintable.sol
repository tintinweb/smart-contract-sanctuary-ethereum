...
import {ERC721i} from "./ERC721i/ERC721i.sol";
import {ERC721iEnumerable} from "./ERC721i/ERC721i.sol";
 ...
 */
contract ERC721iMintable is ERC721i, ERC2981 {
    ...
    constructor(
        ...
        address minter,
        uint256 maxSupply
    ) ERC721i(_name, _symbol, minter, maxSupply) {
        // 1%
    ...
    function supportsInterface(bytes4 interfaceId) public view override (ERC721iEnumerable, ERC2981) returns (bool) {
...
contract ERC721i is Ownable, ERC721iEnumerable {
     ...
     */
    constructor(string memory name, string memory symbol, address minter, uint256 maxSupply) ERC721(name, symbol) {
