...
contract Energetic is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    string constant DESCRIPTION =
        "A mega description for the project. This and that, it's all love :o)";
    ...
    constructor() ERC721("ElTeste", "TSTSTSTSTST") {}
    ...
    function flipIsSaleActive(bool _isSaleActive) external onlyOwner {
        isSaleActive = _isSaleActive;
    }

    function reserveForGifting(
        uint256 numOfTokensToReserve
    ) external nonReentrant onlyOwner canGiftTokens(numOfTokensToReserve) {
    ...
    // ================= "RANDOM NUMBERS" ================= //
    // ==================================================== //
    function randomNumber(uint256 _modulus) public view returns (uint256) {
        return
            uint256(
                keccak256(
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    randomNumber(360).toString(),
                    ', 100%, 50%)">',
                    '<animate attributeName="stop-color" values="orange;hsl(0, 100%, 50%);hsl(130, 100%, 50%);hsl(244, 100%, 50%);hsl(12, 100%, 50%);hsl(120, 100%, 50%);hsl(334, 100%, 50%);orange" dur="',
                    randomNumber(120).toString(),
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    randomNumber(360).toString(),
                    ', 100%, 50%)" >',
                    '<animate attributeName="stop-color" values="orange;hsl(176, 100%, 50%);hsl(48, 100%, 50%);hsl(244, 100%, 50%);hsl(332, 100%, 50%);hsl(320, 100%, 50%);hsl(134, 100%, 50%);orange" dur="',
                    randomNumber(120).toString(),
                    's" repeatCount="indefinite" />',
                    '<animate attributeName="offset" values=".95;.80;.60;.40;.20;0;.20;.40;.60;.80;.95" dur="',
                    randomNumber(120).toString(),
    ...
    function generateEnergyCore() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    SVG_RECT_OPENER,
                    '<animate attributeName="rx" values="10;280;10" dur="',
                    randomNumber(220).toString(),
                    's" repeatCount="indefinite" />',
                    SVG_RECT_CLOSER
                )
            );
    ...
    function tokenURI(
        ...
        bytes memory TOKENID = abi.encodePacked(tokenId.toString());
