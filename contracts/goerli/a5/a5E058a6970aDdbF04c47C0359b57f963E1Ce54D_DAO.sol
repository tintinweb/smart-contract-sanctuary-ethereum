...
contract DAO is OwnableUpgradeable {
        ...
        function createProposal(string calldata title, string calldata description, uint256 amount) external {
            require(hoichiToken.balanceOf(msg.sender) >= 1e18, "createProposal: insufficiency balance");
        ...
        function getProposals(uint256 proposalId) public view returns(DaoProposals memory) {
