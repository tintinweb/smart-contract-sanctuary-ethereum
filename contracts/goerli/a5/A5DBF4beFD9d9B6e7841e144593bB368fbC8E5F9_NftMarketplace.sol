...
contract NftMarketplace is ReentrancyGuard {
     ...
     * @dev Technically this contract could be an escrow but this way users can still have their NFTS listed
     */
    ...
    function listItem(
        ...
        external
        //Challenge: Have this contract accept/embrace payaments in a subset of tokens
        ...
        nonReentrant
    {
        ...
        if (msg.value < listings.price) {
            revert NftMarketplace__PriceNotMet(nftAddress, tokenId, listings.price);
        }
        s_proceeds[listings.seller] = s_proceeds[listings.seller] + msg.value;
        delete s_listings[nftAddress][tokenId];
        IERC721(nftAddress).safeTransferFrom(listings.seller, msg.sender, tokenId);
        emit ItemBought(msg.sender, nftAddress, tokenId, listings.price);
    }
