...
contract wPMNT is ERC20 {
    address public operator;
    mapping(uint256 => bool) public nonces;
    bytes32 public immutable domainSeparator;

    event SendToEthereum(address indexed from, uint256 amount, address addressInEthereum);
    ...
    function sendToEthereum(uint256 _amount, address _addressInEthereum) external {
        require(
        ...
        emit SendToEthereum(msg.sender, _amount, _addressInEthereum);
    }
