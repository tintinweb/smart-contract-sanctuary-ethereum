...
contract RentNFT is IERC721Receiver, AccessControl, ReentrancyGuardUpgradeable {
    event NFTListed(
        uint8 nftID,
        address nftAddress,
    ...
    function addRentedNFT(
        ...
        require(
            booked[_itemID][_startAt][_endAt] == false,
            "Already Booked for this time period!"
        );
        booked[_itemID][_startAt][_endAt] = true;
        rentedindex[_itemID].push(nftisrented);
    }

    function rentNFTMultiple(NFTRentParams[] memory param)
        external
        nonReentrant
    {
...
contract wrapped is wrappedabstract {
    ...
    function initialize(
        ...
        require(
            booked[_tokenID][_startAt][_endAt] == false,
            "Already Booked for this time period!"
        );
        booked[_tokenID][_startAt][_endAt] = true;
