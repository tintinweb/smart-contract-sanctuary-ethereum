...
contract PRBLYLifetimePassNFT is ERC721, ERC721Burnable, ERC2981, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _nextTokenId;

    // the maximum number that can be minted
    string private _baseTokenURI =
        'https://probably0.mypinata.cloud/ipfs/QmZqZ6o9WGB3DtCaDzuGq21mStBRSVJ2vunGwjug7ch8bc';

    // the total number that have been minted
    uint256 private _mintedSupply;
    mapping(address => bool) private _claims;

    string public contractURI = 'https://probably0.mypinata.cloud/ipfs/QmSttj6CZMczCx6yTjw3U9jACGXFzJVgk9W8Svmf1FCWGd';
     ...
     */
    constructor(string memory name, string memory symbol) ERC2981() ERC721(name, symbol) Ownable() {
     ...
     */
    function ownerMint(address account, uint96 numberToMint) external onlyOwner {
