    ...
    ITGE
{
    ...
    function initialize(
        ...
        IGovernanceToken(token_).service().dispatcher().validateTGEInfo(info_, token_);
        ...
        whenPoolNotPaused
    {
        ...
        uint256 lockedAmount = (amount * info.lockupPercent + 99) / 100;
