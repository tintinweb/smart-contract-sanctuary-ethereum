...
contract SkebClaim is TGPausable, ReentrancyGuard, VerifySignature, ISkebClaim {
    ...
    function claim(
        ...
        require(currentTermId - 1 > latestUserTermId[user], "Invalid term Id");
        require(
            validateSignature(signer, user, amount, expiry, sig, currentTermId),
            "Error: Invalid Signature"
        );
        staking.stakeFor(user, uint128(amount));
        latestUserTermId[user] = currentTermId - 1;
    }
...
contract VerifySignature {
    ...
    0x993dab3dd91f5c6dc28e17439be475478f5635c92a56
    e17e82349d3fb2f166196f466c0b4e0c146f285204f0dcb13e5ae67bc33f4b888ec32dfe0a063e8f3f781b
    */
    ...
    nonce = 1
    signature =
        0x993dab3dd91f5c6dc28e17439be475478f5635c92a56e17e82349d3fb2f166196f46
        6c0b4e0c146f285204f0dcb13e5ae67bc33f4b888ec32dfe0a063e8f3f781b
    */
    function verify(
        address _signer,
        bytes32 messageHash,
