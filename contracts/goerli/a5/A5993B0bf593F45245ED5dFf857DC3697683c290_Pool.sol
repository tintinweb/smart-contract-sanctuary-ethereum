...
contract Pool is Ownable {
    ...
    function resetPool() public onlyOwner returns (bool) {
        ...
        uint256 lpTokenSupply = i_lpToken.totalSupply();
        _burnLiquidityPoolTokens(lpTokenSupply);
        return true;
    }
