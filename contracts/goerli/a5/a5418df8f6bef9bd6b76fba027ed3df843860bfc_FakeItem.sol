...
contract FakeItem is ERC721, DefaultOperatorFilterer, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("FakeItem", "FKE") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://minio.dev.quarkto.com/fake/tokens/";
    }
