...
//*********************************************************************//
//
//     __ __ _ __                           __ __ _               ____                   _                __  ___          __  
//    / //_/(_) /________  ______  ___     / //_/(_)___  _____   / __ )__  ___________  (_)___  ____ _   /  |/  /__  _____/ /_ 
//   / ,<  / / __/ ___/ / / / __ \/ _ \   / ,<  / / __ \/ ___/  / __  / / / / ___/ __ \/ / __ \/ __ `/  / /|_/ / _ \/ ___/ __ \
//  / /| |/ / /_(__  ) /_/ / / / /  __/  / /| |/ / / / (__  )  / /_/ / /_/ / /  / / / / / / / / /_/ /  / /  / /  __/ /__/ / / /
// /_/ |_/_/\__/____/\__,_/_/ /_/\___/  /_/ |_/_/_/ /_/____/  /_____/\__,_/_/  /_/ /_/_/_/ /_/\__, /  /_/  /_/\___/\___/_/ /_/ 
//                                                                                           /____/                           
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1667908800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1667822400;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xC4dFC1286d9ab50646d864D5f1FDB78cA95CA896,0x2D18E5C6bABa4e3ba8671f33BEA218ACDD631Fc0];
  address public erc20Payable = 0xC4dFC1286d9ab50646d864D5f1FDB78cA95CA896;
  uint256[] public payableFees = [50,50];
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 2000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmULXo5y2Gi3FuMTrjxwPJRL1gETVoUt6P5rrbZjSMX3Z8/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2000");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2000");
...
// File: contracts/KitsuneKinsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KitsuneKinsContract is RamppERC721A {
    constructor() RamppERC721A("Kitsune Kins ", "KK"){}
}
