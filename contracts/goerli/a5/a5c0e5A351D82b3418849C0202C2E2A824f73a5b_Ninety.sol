...
contract Ninety is ERC721, Ownable {
    ...
    // SVG code for an even more elaborate pattern of rectangles
    function generateLineSvg(uint lineNumber, uint randomSeed)
        public
        pure
        returns (string memory)
    {
        ...
        uint y = randomSeed % 150; // Default y for row 1
        if (lineNumber == 2) {
            y = randomSeed % 475; // Default y for row 2
        } else if (lineNumber == 3) {
            y = randomSeed % 800; // Default y for row 3
        }
        ...
        // Slot 5
        // Size of rectangle at slot 5
        uint rectangleSize5 = drawRectangleSize(3, randomSeed >> 13);
        // console.log("Rectangle size 5: ", rectangleSize5);

        // Rectangle size 1x? Paint 1x at slot 5
        if (rectangleSize5 == 1) {
            Rectangle memory rectangle5 = createRectangleStruct(
                randomSeed % 1350,
                y,
                150,
                150,
            ...
            lineSvg = string.concat(lineSvg, RectangleSvg(rectangle5));

            // Rectangle size 2x? Paint 2x at slot 5
        } else if (rectangleSize5 == 2) {
            Rectangle memory rectangle5 = createRectangleStruct(
                randomSeed % 1350,
                y,
                300,
            ...
            // Rectangle size 3x? Paint 3x at slot 5
        } else if (rectangleSize5 == 3) {
            Rectangle memory rectangle5 = createRectangleStruct(
                randomSeed % 1350,
                y,
                450,
