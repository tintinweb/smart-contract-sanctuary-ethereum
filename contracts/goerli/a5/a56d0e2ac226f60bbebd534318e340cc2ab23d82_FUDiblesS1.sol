...
contract FUDiblesS1 is ERC721A, ERC2981, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("FUDibles Season 1 Test", "FUDibles-S1-Test") {
        owner = msg.sender;
