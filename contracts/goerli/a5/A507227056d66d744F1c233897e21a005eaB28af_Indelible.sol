// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Stem", unicode"Nose", unicode"Mouth", unicode"Eyes", unicode"Head", unicode"Background"];
        ...
        uint public constant maxSupply = 1031;
        uint public maxPerAddress = 5;
        uint public publicMintPrice = 0.0031 ether;
        ...
        ContractData public contractData = ContractData(unicode"Phunkins", unicode"Inspired by my favorite holiday, Halloween, and my love for on chain pixel art, Phunkin's are a generative collection of 1031 NFTs that will live forever, 100% on the Ethereum Blockchain. Happy Halloween!", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/74ff57d3-7248-4931-881b-b0863fc42160", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/74ff57d3-7248-4931-881b-b0863fc42160", "", 300, "0x8A651D64E05E1Ebd6612e36ecec5184F549e4106");

        constructor() ERC721A(unicode"Phunkins", unicode"PHNKN") {
            TIERS[0] = [5,10,20,30,50,75,100,110,150,481];
TIERS[1] = [26,50,150,150,160,165,165,165];
TIERS[2] = [13,20,35,35,50,50,165,165,165,165,168];
TIERS[3] = [5,13,17,30,50,50,85,100,121,125,145,145,145];
TIERS[4] = [15,28,45,50,69,100,288,436];
TIERS[5] = [13,69,315,317,317];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Phunkins #");
