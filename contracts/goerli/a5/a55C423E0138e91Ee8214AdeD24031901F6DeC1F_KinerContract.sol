...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x06B6b6c3d7bb876295a96Afcc5cf4e88fc079B22,0x74E06aE8546e4ef0B1c24B4d0fCA0E7f766AAea2];
  address public erc20Payable = 0x06B6b6c3d7bb876295a96Afcc5cf4e88fc079B22;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiaxev5xml2o7pgn2n265gsiyioqkmjqsbytf42dpnov3o5kq45cle/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/C8O8AwPkvSrK5XiufGsU/contract-metadata";
  }
...
// File: contracts/KinerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KinerContract is RamppERC721A {
    constructor() RamppERC721A("kiner", "kiner"){}
}
