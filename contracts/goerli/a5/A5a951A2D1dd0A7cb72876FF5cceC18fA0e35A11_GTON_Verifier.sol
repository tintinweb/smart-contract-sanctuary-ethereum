...
contract GTON_Verifier is Lib_AddressResolver {
     ...
     * Constants *
     *************/
    string constant public CONFIG_OWNER_KEY = "GTON_MANAGER";
    ...
    modifier onlyManager {
        require(
            ...
            "GTON_Verifier: Function can only be called by the GTON_MANAGER."
        );
        _;
    }
