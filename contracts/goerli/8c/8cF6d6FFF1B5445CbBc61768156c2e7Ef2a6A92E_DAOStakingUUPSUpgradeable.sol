...
contract DAOStakingUUPSUpgradeable is IDAOStakingUUPSUpgradeable, DAOStaking, UUPSUpgradeable {
    ...
    function _authorizeUpgrade(address) internal view override {
        require(hasRole(UPGRADER_ROLE, msg.sender), "DAOStaking: caller does not have upgrader role");
    }
