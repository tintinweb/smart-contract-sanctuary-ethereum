...
contract ZooverseGen2Controller is BaseMint {
    ...
    uint256 public discountedPrice = 0.12 ether;
    ...
    constructor() {
        // claim
        sales[1] = Sale(genesisLimit, 1, 0xb5a6bb2cc4b728758434b1f7ecd0adb554042e634148dc3f26f5839a88cb8c90);
        // diamondhand
        sales[2] = Sale(genesisLimit + 1, 1, 0xebfa2549ea9a2dc050663a729e693f41ad5a6b7f5c6391cd27012514f34209c7);
        // genesis
        sales[3] = Sale(genesisLimit, 1, 0x207f406b5bf6ea89b273467d8ab4da3f063ceedb2d4b6afd6f24577d1d1b3523);
        // whitelist
        sales[4] = Sale(1, 1, 0xcbaade1954da1a67c617919e4a16a68bad53ebdf9ba73a720e3bc2f08c13b6f5); 
        // waitlist
        sales[5] = Sale(1, 2, "");
        _lastSaleType = 5;
    }
    ...
    function salesMint(uint256 quantity, bytes32[] calldata proof, uint256 saleType) 
        ...
        payable 
        callerIsUser
        enoughPrice(quantity, discountedPrice) 
    ...
    function updateSale(uint256 saleType, uint256 limit, uint256 liveIndex) external adminOnly {
    ...
    function updateDiscountedPrice(uint256 _price) external adminOnly {
