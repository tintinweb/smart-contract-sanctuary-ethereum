...
abstract contract BaseLockdrop is Ownable {
    ...
    mapping(address => uint256) public rates; // base tokens per nft value unit per second of locking
    ...
    function lock(
        ...
        bytes32 leaf = keccak256(abi.encode(_msgSender(), baseAllocation));
        require(!claimedAllocations[leaf], "Base allocation already claimed");
