...
error PriceNotMet(address nftAddress, uint256 tokenId, uint256 receivedAmount);
...
error NftMarketplace__PriceSameAsOldOne();
...
contract NftMarketplace is ReentrancyGuard {
    ...
    function updateListing(
        ...
        if (s_listings[nftAddress][tokenId].price == newPrice) {
            revert NftMarketplace__PriceSameAsOldOne();
        }
