...
contract Trade is AccessControl {
    ...
    //uint256 public mintingFee = mintFee * 10 ** 18; //custom?
    ...
    function mintingFee() external view virtual returns (uint256) {
        return mintingFeePermille;
    }
    ...
    */
    ...
    function setMintingFee(uint8 _mintFee)
        external
        onlyRole("ADMIN_ROLE")
        returns (bool)
    {
        mintingFeePermille = _mintFee * 10 ** 18;
        emit MintFee(mintingFeePermille);
        return true;
    }
    ...
    */
        ...
        returns(bool)
    {
        ...
        if(mintingFeePermille != 0) {
            transferProxy.erc20safeTransferFrom(IERC20(usdt), msg.sender, owner, mintingFeePermille);
        }
