...
abstract contract bNFTBase is ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable, IPositionNFT {
    ...
    modifier onlyMarket() {
        require(msg.sender == market, "NFTB-not-market");
        _ ;
    }

    modifier whenMarketNotPaused() {
        require(PausableUpgradeable(market).paused() == false, "NFTB-market-paused" );
        _ ;
    }
    ...
    function transferFrom(
        ...
        // @TODO: Viktor let's get rid of such comments
    ...
    function _transfer(
        ...
        require(ownerOf(tokenId) == from, "ERC721: transfer must be called by owner");
