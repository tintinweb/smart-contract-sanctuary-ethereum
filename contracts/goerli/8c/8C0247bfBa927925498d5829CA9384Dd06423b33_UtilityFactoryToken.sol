...
contract UtilityFactoryToken is Ownable, ERC721A, ReentrancyGuard {
    uint constant tokenPrice = 0.0005 ether;
    uint constant nbFreeAtATime = 3;
    bool publicSale = false;
    uint256 nbFree = 10;
    
    constructor() ERC721A("UtilityFactoryToken", "UFT", 20, 10000) {}
    ...
    function freeMint(uint256 quantity) external callerIsUser {
        ...
        require(quantity <= nbFreeAtATime, "can not mint this many free at a time");
    ...
    string private _baseTokenURI =
        "https://utilityfactory.xyz/token_metadata/";
