...
contract burnvegen is ERC721Enumerable, Ownable {
...
for(uint i = 0; i < quantity; i++) {
  ...
  function devmint(uint256 quantity,uint256 tokenId) public payable onlyOwner {
    uint256 supply = totalSupply();
     require(
            e69.ownerOf(tokenId) == msg.sender,
