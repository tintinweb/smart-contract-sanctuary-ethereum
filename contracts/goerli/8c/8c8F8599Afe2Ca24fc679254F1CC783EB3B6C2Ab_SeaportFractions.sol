...
contract SeaportFractions
{
	fallback () external payable
	{
		assembly {
			...
			let result := delegatecall(gas(), 0x0fD1847691627b27F6ce7Ec40F623CB9C9E8FCf3, 0, calldatasize(), 0, 0)
...
contract SeaportFractionsImpl is ERC721Holder, ERC20, ReentrancyGuard
{
	...
	address constant SEAPORT = 0x1E0049783F008A0085193E00003D00cd54003c71;
	address constant SEAPORT_ENCODER = 0x5D1ec229cA493Be87A6586efE343B02F90b82e89;
