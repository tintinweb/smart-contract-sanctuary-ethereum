...
contract PolymorphRootTunnel is FxBaseRootTunnel, PolymorphTunnel {
        ...
        onlyOwner(tokenId)
    {
        ...
        // console.log(address(polymorphContract));

        // console.log(polymorphContract.geneOf(tokenId));
        // console.log(polymorphContract.isNotVirgin(tokenId));
        // console.log(polymorphContract.genomeChanges(tokenId));
