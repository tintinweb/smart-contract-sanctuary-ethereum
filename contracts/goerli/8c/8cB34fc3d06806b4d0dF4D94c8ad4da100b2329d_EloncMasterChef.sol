...
// File contracts/elonc/EloncMasterChef.sol



pragma solidity ^0.8.0;
contract EloncMasterChef is Ownable {
    ...
    struct UserInfo {
        ...
        uint256 pending; // Pending reward amount
        uint256 earned; // Earned so far
    }

    // Info of each pool.
    struct PoolInfo {
        IERC20 lpToken; // Address of LP token contract.
        uint256 lpSupply; // LP staked supply
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (user.amount > 0) {
            ...
            if (pending > 0) {
                ...
                user.earned = user.earned.add(rewardTransferred);
     ...
     */
    function recoverRewardToken(uint256 _amount) external onlyOwner {
