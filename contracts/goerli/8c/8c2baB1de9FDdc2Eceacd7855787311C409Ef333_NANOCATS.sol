...
contract NANOCATS is ERC1155Supply, Ownable, ReentrancyGuard, IERC2981 {
    ...
    uint32 public redeemStart;              // May 27, 2022 9am EST
    ...
    function setRedeemDates(uint32 _redeemStart, uint32 _redeemEnd) public {
    ...
    function sendRedeem(address _account, uint256[] memory _ids) external {
