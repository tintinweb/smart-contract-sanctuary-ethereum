...
contract Land is ERC721A, Ownable {
    ...
    uint256 public constant ALLOW_LIST_MINT_PRICE = 0.0025 ether;
    ...
    function setPresaleStartTime(uint256 _r1StartTime, uint256 _r2StartTime) external {
        presaleR1StartTime = _r1StartTime;
        presaleR2StartTime = _r2StartTime;
    }

    function setAllowListStartTime(uint256 _r1StartTime, uint256 _r2StartTime) external {
        allowListR1StartTime = _r1StartTime;
        allowListR2StartTime = _r2StartTime;
    }

    function setClaimableStartTime(uint256 _startTime) external {
        claimableStartTime = _startTime;
    }

    function setMintStartTime(uint256 _mintStartTime, uint256 _mintEndTime) external {
