...
contract Sure is ERC20, Ownable {
    ...
    uint256 public _maxWalletSize = 10000000 * 10**decimals();
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            // TODO: Check below buy/sell/transfer checks work (would there ever be non-uniswap exchange?)
    ...
    function addLiquidity() external payable onlyOwner {
        uint256 tokenAmount = (totalSupply() * 94) / 100;
