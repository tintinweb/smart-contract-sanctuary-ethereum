...
contract ERC20Staking {
    ...
    function transferFrom(address _from, address _to, uint256 _value) external isAddrNull(_from) isAddrNull(_to) returns (bool success) {
        uint256 value = _value * decimals();
        require(value > 0 && value <= allowances[_from][msg.sender], "Not enough tokens allowed");
        require (balanceOf(_from) >= value, "Not enough tokens");
