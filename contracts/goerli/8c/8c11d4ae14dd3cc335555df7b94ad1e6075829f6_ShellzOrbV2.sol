    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    function OperatorFiltererInitialize() public initializer {
        __DefaultOperatorFilterer_init();
    }

    /**
     *  @notice Operator filter requires exchanges to enforce creator royalties to not be blacklisted.
     ...
     *  @notice Operator filter requires exchanges to enforce creator royalties to not be blacklisted.
     *          https://github.com/ProjectOpenSea/operator-filter-registry
     *  @notice Retreating-based approval control: The users cannot approve their token if it is retreating.
     */
