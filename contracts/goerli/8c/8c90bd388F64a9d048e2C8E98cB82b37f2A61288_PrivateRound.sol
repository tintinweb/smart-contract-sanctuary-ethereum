...
contract PrivateRound{
    ...
    */
    ...
    // function tokenStatus(uint _roundId, address _founder, address _investor) public view returns(uint unlockedAmount, uint lockedAmount, uint withdrawnTokensByFounder, uint lockRemaining){
    //     uint unlockedTokens;
    //     uint lockedTokens;
    ...
    //             rem = remainingTokensOfInvestor[_roundId][_investor];
    //         }
    //     }
    //     return(
    //         unlockedTokens,
    ...
    function tokenStatus(uint _roundId, address _founder, address _investor) public view returns(uint unlockedAmount, uint lockedAmount, uint lockRemaining){
        uint unlockedTokens;
        uint lockedTokens;
        uint withdrawnTokens;
        // remove this below line:
