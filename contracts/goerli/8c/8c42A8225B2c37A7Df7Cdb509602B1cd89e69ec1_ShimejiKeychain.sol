...
contract ShimejiKeychain is ERC721A, ERC2981 , Ownable, Pausable, CantBeEvil(LicenseVersion.CBE_NECR_HS)  {
    ...
    address constant private OWNER_TRANSFER_ADDRESS = 0x04334E35573C6a3d3B5aa2cCf783024cf45c5Dc3;
    ...
    constructor(
        ...
        _mintERC2309(OWNER_TRANSFER_ADDRESS, 30);
        _mintERC2309(BULK_TRANSFER_ADDRESS, 58);
        for (uint256 i; i < 4; ++i) {
