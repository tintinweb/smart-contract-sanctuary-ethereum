...
contract Gethering is ERC721, ERC721Burnable, Ownable {
    ...
    function gether(uint token1, uint token2) public 
    {
        ...
        tokenInfo[totalSupply].code = mask1.code | mask2.code;
        ...
        /*
        if (MASK_SIZE < 16) {
            tokenInfo[totalSupply].code %= MINT_SIZE;
        }
        */
    ...
    function burnToken(uint token) private
    {
