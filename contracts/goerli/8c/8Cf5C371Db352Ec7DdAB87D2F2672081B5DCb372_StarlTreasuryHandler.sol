 ...
 * liquidity pool.
 */
contract StarlTreasuryHandler is ITreasuryHandler, LenientReentrancyGuard, Ownable {
    ...
    function setLiquidityBasisPoints(uint256 newBasisPoints) external onlyOwner {
        require(
            ...
            "StarlTreasuryHandler:setLiquidityPercentage:INVALID_PERCENTAGE: Cannot set more than 10,000 basis points."
        );
    ...
    function setPriceImpactBasisPoints(uint256 newBasisPoints) external onlyOwner {
        require(
            newBasisPoints < 1500,
            "StarlTreasuryHandler:setPriceImpactBasisPoints:OUT_OF_BOUNDS: Cannot set price impact too high."
        );
    ...
    function setTreasury(address newTreasuryAddress) external onlyOwner {
        require(
            ...
            "StarlTreasuryHandler:setTreasury:ZERO_TREASURY: Cannot set zero address as treasury."
        );
    ...
    function withdraw(address tokenAddress, uint256 amount) external onlyOwner {
        require(
            ...
            "StarlTreasuryHandler:withdraw:INVALID_TOKEN: Not allowed to withdraw token required for swaps."
        );
    ...
    function updateTaxSwap(uint256 taxSwap) external onlyOwner {
        require(taxSwap > 0, "StarlTreasuryHandler:updateTaxSwap: Invalid taxSwap");
        _taxSwap = taxSwap;
    }
