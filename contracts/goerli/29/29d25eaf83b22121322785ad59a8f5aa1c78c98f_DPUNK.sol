...
// Part 2: OpenZeppelin/[email protected]/Address
...
// Part3: OpenZeppelin/[email protected]/Context
...
// Part4: OpenZeppelin/[email protected]/IERC20
...
// Part5: OpenZeppelin/[email protected]/SafeMath
...
// Part7: OpenZeppelin/[email protected]/ERC20
...
contract DPUNK is ERC20("$DPUNK", "$DPUNK") {
	using SafeMath for uint256;

    uint256 constant public rewardtimeframe = 86400; //86400 = 1 day
	uint256 public BASE_RATE = 10 ether; 
	uint256 public FirstRedeemRate = 50 ether; 
	...
	function getRewards(uint256[] calldata _tokenIds) external {
		...
		uint256 time = block.timestamp;
		 ...
		 require(tamount > 1, "Your punks did not work hard enough");	
