...
contract AlwaysTired is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    mapping(address => uint16) public publicMints; // TODO: remove this
    ...
    // TODO free up / delete fields for gas
    // function reset() external onlyOwner whenPaused {
    //     delete mode;
    //     delete baseURI;
    //     delete placeholderURI;
    //     delete revealed;
    //     delete ogRoot;
    //     delete freemintRoot;
    //     delete whitelistRoot;
    //     // delete ogMints;
    //     // delete freeMints;
    //     // delete whitelistMints;
    //     delete snoozeToken;
    // }
    ...
    function _beforeTokenTransfers(
        ...
        if (address(snoozeToken) != address(0)) {
            snoozeToken.updateRewards(_from, _to, uint16(_quantity));
        }
    }
    ...
    //     uint256 _quantity
    // ) internal virtual override {
    //     super._afterTokenTransfers(_from, _to, startTokenId_, _quantity);
    //     if (address(snoozeToken) != address(0)) {
    //         snoozeToken.updateRewards(_from, _to, uint16(_quantity));
    //     }
    // }
