...
contract Staking is Migrate{
    ...
    function stake(uint _sum,uint8 count,string memory addrCN,uint8 procentage) public  returns(uint32) {
        ...
        emit staked(msg.sender,_sum,count,LP_V2,addrCN,block.timestamp,
