    ...
    ICollection
{
    ...
    function __ERC721A_target_init(
        // WIP QS-450:
        ...
        __ERC721A_target_init_unchained(admin, manager, minter, creator, data);
    }

    function __ERC721A_target_init_unchained(
        address admin,
        address manager,
        address minter,
        address creator,
        ...
        es.primaryPayoutAddress = creator;
    ...
    {
        // revert(ERC721AStorage.layout().baseURI);
        return ERC721AStorage.layout().baseURI;
    }

    function primaryPayoutAddress() public view returns (address) {
        return ERC721AStorage.layout().primaryPayoutAddress;
    }
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        ERC721AStorage.layout().baseURI = baseURI;
    }
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        ERC721AStorage.layout().ipfsURI = ipfsURI;
    }
    ...
    function setCID(string calldata cid) public onlyRole(MANAGER_ROLE) {
        ERC721AStorage.layout().CID = cid;
    }

    /// @notice configure drop
    /// @param _maxSupply maximum items in the drop
    function setSupply(uint128 _maxSupply) public onlyRole(MANAGER_ROLE) {
        ERC721AStorage.layout().maxSupply = _maxSupply;
    }
    ...
    */
    ...
    function mint(
        ...
        if (uri.length > 0) es.tokenURIs[totalSupply() + 1] = string(uri);
        _safeMint(to, 1);
    }
    ...
    function maxSupply() public view returns (uint256) {
        return ERC721AStorage.layout().maxSupply;
    }
...
interface ICollectionSupply {
    ...
    function setSupply(uint128 _maxSupply) external;
}
