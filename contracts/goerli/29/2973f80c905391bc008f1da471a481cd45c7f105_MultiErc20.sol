...
// File: contracts/CustomErc20Mint.sol
...
contract MultiErc20 is ERC721A, Ownable, ReentrancyGuard, Pausable{

    // public mint variables
    uint256 public maxSupply = 5000;
    uint256 public maxMint = 8;
    uint256 public mintPrice = 0.001 ether; // @dev 10 finney = 0.01 ether
    ...
    constructor (
        ...
        ) ERC721A("Test NFT", "TFT") {
            tokenAddress = IERC20(_tokenAddress);
            wlRoot = _wlRoot;
            pumlxRoot = _pumlxRoot;
            setBaseURI(_initBaseURI); 
            setNotRevealedURI(_initNotRevealedUri); 
            // addToken("0x8c088775e4139af116Ac1FA6f281Bbf71E8c1c73",)
    }
    ...
    function pumlxMint(uint256 _quantity, bytes32[] memory proof) external payable whenNotPaused userOnly nonReentrant {
        ...
        require((totalTokenMint[msg.sender] + _quantity) <= pumlxMaxMint, "Error: Cannot mint more than the max");
    ...
    function whitelistMint(uint256 _quantity, bytes32[] memory proof) external payable whenNotPaused userOnly nonReentrant {
        ...
        require(totalSupply() + _quantity <= maxSupply, "Error: max supply reached");
        require((totalWlMint[msg.sender] + _quantity) <= wlMaxMint, "Error: Cannot mint more than 3");
    ...
    function withdraw() external onlyOwner nonReentrant userOnly{
        payable(owner()).transfer(address(this).balance);
    }

    // withdraw ERC20 within contract by pid value
