...
// File contracts/InterstellarSamuraiNFTProxy.sol

pragma solidity ^0.8.17;
contract InterstellarSamuraiNFTProxy is
    ERC721A,
    Ownable,
    DefaultOperatorFilterer
{
    InterstellarSamuraiNFT public interstellarSamuraiNFT;

    constructor(
        InterstellarSamuraiNFT addr,
        string memory _name,
        string memory _symbol
    ) ERC721A(_name, _symbol) {
        interstellarSamuraiNFT = addr;
    ...
    function ownerOf(uint256 tokenId)
        ...
        returns (address)
    {
        return ERC721A(interstellarSamuraiNFT).ownerOf(tokenId);
    }
    ...
    function balanceOf(address owner)
        ...
        returns (uint256)
    {
        return ERC721A(interstellarSamuraiNFT).balanceOf(owner);
    }
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
    {
        return ERC721A(interstellarSamuraiNFT).tokenURI(tokenId);
    }

    function totalSupply() public view virtual override returns (uint256) {
        return ERC721A(interstellarSamuraiNFT).totalSupply();
    }
    ...
    {
        ERC721A(interstellarSamuraiNFT).setApprovalForAll(operator, approved);
    }
    ...
    function approve(address operator, uint256 tokenId)
        ...
        onlyAllowedOperatorApproval(operator)
    {
        ERC721A(interstellarSamuraiNFT).approve(operator, tokenId);
    }
    ...
    function transferFrom(
        ...
        ERC721A(interstellarSamuraiNFT).transferFrom(from, to, tokenId);
    }
    ...
    function safeTransferFrom(
        ...
        ERC721A(interstellarSamuraiNFT).safeTransferFrom(from, to, tokenId);
    }
    ...
    function safeTransferFrom(
        ...
        ERC721A(interstellarSamuraiNFT).safeTransferFrom(from, to, tokenId, data);
    }
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        return ERC721A(interstellarSamuraiNFT).isApprovedForAll(owner, operator);
    }
    ...
    function getApproved(uint256 tokenId)
        ...
        returns (address)
    {
        return ERC721A(interstellarSamuraiNFT).getApproved(tokenId);
    }
}