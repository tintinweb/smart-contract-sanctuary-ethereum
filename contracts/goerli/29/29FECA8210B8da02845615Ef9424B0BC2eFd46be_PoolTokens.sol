...
library ConfigurableRoyaltyStandard {
  ...
  function setRoyaltyParams(RoyaltyParams storage params, address newReceiver, uint256 newRoyaltyPercent) internal {
...
contract PoolTokens is IPoolTokens, ERC721PresetMinterPauserAutoIdUpgradeSafe, HasAdmin, IERC2981 {
  ...
  event ConfigUpdated(address indexed who, address configAddress);
  ...
  */
  // solhint-disable-next-line func-name-mixedcase
  function __initialize__(address owner, Config _config) external initializer {
    ...
    __ERC721_init_unchained("OASIS Pool Tokens", "OAS-PT");
    __Pausable_init_unchained();
    __ERC721Pausable_init_unchained();
  ...
  modifier onlyGoldfinchFactory() {
    require(_msgSender() == config.factoryAddress(), "Only Goldfinch factory is allowed");
    _;
  }
