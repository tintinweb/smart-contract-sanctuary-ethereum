...
contract PIGGYFACTORY is Ownable, ContractMetadata  {
    ...
    string public name = "PIGGYFACTORY-TEST-3";
...
contract PIGGY is ERC1155 {
    ...
    function _getSvg() internal view returns (string memory) {
        ...
        {
            markup = string(abi.encodePacked(markup, ' ETH</tspan></text><text class="b" x="180" y="280"><tspan>Piggy has </tspan><tspan id="CurrentBalance">'));
        }
        ...
        {
           markup = string(abi.encodePacked(markup, '</text><script type="text/javascript">document.getElementById("CurrentBalance").innerText = Math.round(124323/235235, 2)</script></svg>')); 
        }
         
        return markup;
    }

    function _createContractURI(string memory contract_name, string memory description, string memory image_url, string memory external_url) internal view virtual returns (string memory) {
