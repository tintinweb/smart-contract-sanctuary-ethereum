...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        // _baseURI() got overridden in our CryptoDevs NFT contract, returns (string _baseTokenURI)
        // that we supply as an arg. to the constructor at deployment
    ...
    function _safeMint(
        ...
        _mint(to, tokenId);
        require(
            // if contract (true) => implemented IERC721Receiver, return true, else revert
            // if contract (false) => return true (means its an EOA)
            // make sure we run this check after sufficient time has passed by since to.contract creation
            // rest, copy # 8 @ Jan 12
