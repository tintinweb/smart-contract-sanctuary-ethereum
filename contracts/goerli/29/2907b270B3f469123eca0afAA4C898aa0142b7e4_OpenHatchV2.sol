...
// File: contracts/OpenHatchV2 (3).sol
...
contract OpenHatchV2 is OwnableUpgradeable {
   ...
   struct create_form  {
    ...
    function submit_openHatch(
        ...
        uint256 fee_admin = totalFee - fee_rewards;
         ...
         ERC20Upgradeable( mix_addresses[2]).safeTransferFrom(msg.sender,address(this), totalFee);
        //send to fund box
