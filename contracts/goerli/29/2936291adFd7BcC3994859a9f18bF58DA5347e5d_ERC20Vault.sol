...
contract ERC20Vault {
    ...
    function releaseERC20(address erc20Addr, uint256 amount) private {
    ...
    modifier checkLockUSDC(uint256 amount) {
        require(amount > 10**12, "Lock amount is too small!");
    ...
    function releaseUSDC(address erc20Addr, uint256 amount) private {
        _token.transferFrom(address(this), erc20Addr, amount);
