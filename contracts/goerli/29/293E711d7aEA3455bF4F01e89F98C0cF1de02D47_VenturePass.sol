            ...
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        ...
                        '<style type="text/css"><![CDATA[text { font-family: monospace; font-size: 21px;} .h1 {font-size: 20px; font-weight: 600;}]]></style>',
                        '<image href="ipfs://QmZ3SJB2oV8DxDGcAaiSGaGj7apjiawfzXj4pxFsAgJxdF" height="400" width="400"/>',
