    ...
    PausableUpgradeable
{
        ...
        initializer
    {
        ...
        ERC20Upgradeable.__ERC20_init("VB Charity DAO", "VBC");
        ERC20PermitUpgradeable.__ERC20Permit_init("vbc");
    ...
    function setTreasuryAddress(address _treasury) external onlyOwner {
        require(_treasury != address(0), "setTreasuryAddress: No address");
        treasury = _treasury;
