...
contract TLE is Ownable, ERC721, ReentrancyGuard {
    using Strings for uint256;

    uint256 public constant PRICE = 0.0001 ether;
    //    uint256 public constant PRICE = 1 ether;
    uint256 public constant MAX_TOKENS_PURCHASE = 2; // maximum mints per wallet
    uint256 public constant MAX_TOKENS = 10000; // maximum supply of tokens
    ...
    function mint(uint256 amount) external payable mintGuard(amount) {
        ...
        uint256 startIndex = tokenIndex;
        uint256 endIndex = tokenIndex + amount;
        tokenIndex += amount;
