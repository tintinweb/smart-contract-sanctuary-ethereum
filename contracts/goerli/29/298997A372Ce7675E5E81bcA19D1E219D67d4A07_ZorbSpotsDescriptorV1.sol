...
contract ZorbSpotsDescriptorV1 is Initializable, OwnableUpgradeable {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '<path fill="#EBEBEB" d="M100 0H0V100H100V0Z"/><path fill="white" d="M77.3615 16.3496H22.6504V83.6461H77.3615V16.3496Z"/>',
                    zorbs,
                    '</svg>'
                )
            );
    ...
    function buildZorbs(uint256 tokenId) internal view returns (string memory) {
        ...
        if (totalSupply < tokenId + zorbCount) {
            zorbs = totalSupply - tokenId;
            startingZorbTokenId = totalSupply - zorbs;
        }
