...
// hevm: flattened sources of src/relays/BasicRelay.sol
...
interface WormholeOracleAuthLike {
    ...
    function wormholeJoin() external view returns (WormholeJoinLike_2);
}

interface WormholeJoinLike_2 {
