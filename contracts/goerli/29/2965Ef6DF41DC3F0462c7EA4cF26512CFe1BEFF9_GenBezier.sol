...
contract GenBezier is ERC721URIStorage {
    uint256 public tokenCounter;
    event CreatedSVGNFT(uint256 indexed tokenId, string tokenURI);

    constructor() ERC721("Random Bezier Curve", "RBC") {
        tokenCounter = 0;
    }
    ...
    {
        // <svg>xxxxx</svg> -> format image URI
            ...
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"Random Bezier Curve", ',
                                '"description": "Generative Bezier Curve ", ',
                                '"attributes": "", ',
                                '"image": "',
                                _imageURI,
                                '"}'
