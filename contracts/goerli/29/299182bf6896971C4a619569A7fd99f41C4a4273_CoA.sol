...
contract CoA is AdminControl, ICreatorExtensionTokenURI {
    ...
    string private _createdBy;
    string private _description;
    string private _attributes;
    string private _previewImage;

    PublicResolver resolver = PublicResolver(0x4B1488B7a6B320d2D721406204aBc3eeAa9AD329);
    ...
    function mint(address to, string memory _tokenURI) public adminRequired {
      uint tokenId = IERC721CreatorCore(_creator).mintExtension(to);
      tokenURIs[tokenId] = _tokenURI;
    }

    function configureMeta(string memory name, string memory createdBy, string memory description, string memory attributes) public adminRequired {
      _name = name;
    ...
    function configurePreviewImage(string memory previewImage) public adminRequired {
    ...
    function getAnimationURL(uint tokenId) private view returns (string memory) {
        ...
        return string(abi.encodePacked(tokenURIs[tokenId], "?owner=", name));
    }
