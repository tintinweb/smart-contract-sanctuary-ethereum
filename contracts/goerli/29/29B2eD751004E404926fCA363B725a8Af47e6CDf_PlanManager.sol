...
contract PlanManager is IPlanManager, Initializable, OwnableUpgradeable {
    ...
    {
        planIndex = merchantTokenIdNextPlanIndex[plan.merchantTokenId];
        merchantTokenIdToPlans[plan.merchantTokenId][planIndex] = plan;
        merchantTokenIdNextPlanIndex[plan.merchantTokenId]++;
    }
    ...
    function updatePlan(
        ...
        Plan storage plan = merchantTokenIdToPlans[merchantTokenId][planIndex];
        plan.name = _plan.name;
        plan.description = _plan.description;
        plan.payeeAddress = _plan.payeeAddress;
        plan.enabled = _plan.enabled;
    }

//    function disablePlan(uint256 merchantTokenId, uint256 planIndex)
//        external
//        override
//        onlyManager
//    {
