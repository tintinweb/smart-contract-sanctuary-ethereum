...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    // use ChainLink VRF to get a random number
    // use that number, to get a random NFT
    // Pug, Shiba Inu, St. Bernard 八哥犬，柴犬，圣伯纳犬。
    // Pug super rare
    // Shiba sort of rare
    // St. bernard common
    ...
    constructor(
        ...
        uint256 mintFee
    ) VRFConsumerBaseV2(vrfCoordinatorV2) ERC721("RandomDog", "DOG") {
