...
contract GHT is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
  ...
  ) ERC721A("GH 11", "GH", maxBatchSize_, collectionSize_) {
    ...
    function mint(uint quantity) public
        ...
        if (startSale < block.timestamp && startSale + 180 > block.timestamp) {
