// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Accessories", unicode"\\\"Face\\\"", unicode"Eyes", unicode"Mouth", unicode"Body", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Golly Ghosts", unicode"\\\"bOoOoOoOoOoOoOoOoOoOo\\\"", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/170266fe-dc37-48b8-8024-1c60040d186a", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/170266fe-dc37-48b8-8024-1c60040d186a", "https://gollyghosts.com", 500, "0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");

        constructor() ERC721A(unicode"Golly Ghosts", unicode"BOO") {
            TIERS[0] = [4,7,18,19,21,27,46,48,62,72,88,88];
TIERS[1] = [107,111,116,166];
TIERS[2] = [22,30,50,85,93,110,110];
TIERS[3] = [6,25,26,51,74,94,104,120];
TIERS[4] = [14,16,38,62,62,93,94,121];
TIERS[5] = [27,50,68,80,90,90,95];
...
632927012893602565676075421341685619761332234876041339403653
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Golly Ghosts #");
