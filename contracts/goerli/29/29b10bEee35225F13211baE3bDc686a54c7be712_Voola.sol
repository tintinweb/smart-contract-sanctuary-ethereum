...
contract Voola is ERC1155, Ownable, ReentrancyGuard {
    uint256[] supplies = [1000, 1000, 1000];
    ...
    constructor()
        ERC1155("ipfs://QmPMc4tcBsMqLRuCQtPmPe84bpSjrC3Ky7t3JWuHXYB4aS/{id}")
    {}
    ...
    function presaleMint(
        ...
        require(msg.value >= amount * presaleCost, "Not enough ether sent");
    ...
    function mint(uint256 id, uint256 amount) external payable callerIsUser {
        ...
        if (addressMintedBalance[msg.sender] + amount > maxMintAmount)
            revert MaxPerWalletExceeded();
        require(msg.value >= amount * publicCost, "Not enough ether sent");
        _mint(msg.sender, id, amount, "");
        minted[index] += amount;
        addressMintedBalance[msg.sender] += amount;
    }
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        (bool os1, ) = payable(owner()).call{value: balance}("");
        require(os1);
    }
}