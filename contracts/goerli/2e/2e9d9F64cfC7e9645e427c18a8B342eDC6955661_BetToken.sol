...
contract BetToken is ERC20, AllowTokens, TokenValue {
    uint256 public buyableBET;
    ...
    constructor(uint256 initialSupply) ERC20("Bet Token", "BET") {
        buyableBET = initialSupply / 2;
        _mint(address(this), buyableBET);
        _mint(msg.sender, initialSupply - buyableBET);
    }
