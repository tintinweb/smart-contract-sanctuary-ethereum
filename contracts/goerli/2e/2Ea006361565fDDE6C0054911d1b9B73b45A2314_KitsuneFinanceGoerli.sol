...
contract KitsuneFinanceGoerli {
    ...
    address constant TRANSFORM_ERC20_FEATURE = 0x0fb70AF941a2F848f952d2C69E621B106821236a;
    function executeTokensToETH(
        ...
        for (uint256 i = 0; i < len; i++) {
            ...
            //test?
            require(IERC20(_tokens[i]).approve(TRANSFORM_ERC20_FEATURE, _amounts[i]));
