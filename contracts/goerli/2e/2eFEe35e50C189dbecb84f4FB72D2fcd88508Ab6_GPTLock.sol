...
import "./interfaces/IGPTLock.sol";

contract GPTLock is IGPTLock, OwnableUpgradeable, UUPSUpgradeable {
    ...
    // If sender is a pool generated by HNWsale,
    // skip checking fee
    modifier feePaid() {
    ...
    function isLpToken(address token) public view returns (bool) {
        ...
        if (possibleFactoryAddress != address(0) && _isValidLpToken(token, possibleFactoryAddress)) {
            _isLpToken = true;
        }
        return _isLpToken;
    }
