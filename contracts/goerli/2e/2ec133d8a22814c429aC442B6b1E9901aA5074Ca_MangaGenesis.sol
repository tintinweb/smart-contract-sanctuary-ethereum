...
contract MangaGenesis is ERC721A, ERC2981, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public MAX_SUPPLY = 104;
    // uint256 public constant WALLET_MINT_CAP = 1;
    uint256 public constant WALLET_MINT_CAP = 10000;
    ...
    function setMaxTest(uint256 max) external onlyOwner {
        MAX_SUPPLY = max;
    }
    ...
    constructor() ERC721A("MangaGenesis", "MG") {
        ...
        _setDefaultRoyalty(msg.sender, 750); // Royalty 5%
    }
        ...
        return string(abi.encodePacked('data:application/json;base64,', Base64.encode(
            abi.encodePacked(
                '{',
                    ...
                    '"description":"MangaGenesis NFT is a limited edition collection of digital manga art created by a team of talented artists from around the world. Each NFT is unique and showcases the diverse range of art styles in the manga genre.",',
                    '"image":"', _imageUri, '",',
