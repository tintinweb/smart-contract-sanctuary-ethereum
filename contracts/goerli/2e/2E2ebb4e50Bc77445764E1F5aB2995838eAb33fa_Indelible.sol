...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Accessories", unicode"Face", unicode"Eyes", unicode"Mouth", unicode"Body", unicode"Background"];
    bool private shouldWrapSVG = true;
    string private backgroundColor = "transparent";

    uint private randomSeed;
    bytes32 private merkleRoot = 0;
    uint private networkId = 1;
    ...
    constructor() ERC721A(unicode"Golly", unicode"BOO3") {
