...
contract Frontlines is OwnableEpochContract {
  ...
  IERC721 q00tants = IERC721(0xDc62d438EfFE36B3c4f49BC97274aD7bAeC95e71);
  ...
  function conductHeist(uint256 _tokenId) external {
    ...
    if (unguardedAt > block.timestamp) revert GlitterIsGuarded();
