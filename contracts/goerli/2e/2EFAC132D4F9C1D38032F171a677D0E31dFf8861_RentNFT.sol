...
contract RentNFT is IERC721Receiver, AccessControl {
    ...
    function rentnftinternal(
        ...
        addRentedNFT(wrapped(clone), _startAt, _endAt, _itemID);
    ...
    function isavailableforrent(
        ...
        for (uint i = 0; i < rentedindex[_itemID].length; i++) {
            if (
        ...
        returns (NFTRented[] memory)
    {
        ...
        for (uint i = 0; i < rentedindex[_itemID].length; ) {
