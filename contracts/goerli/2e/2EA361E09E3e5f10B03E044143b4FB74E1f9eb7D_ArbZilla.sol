...
contract ArbZilla is ERC20, Ownable {
    ...
    constructor() ERC20("ArbZilla", "ZILLA") {
        ...
        // launch sell fees
        uint256 _sellMktgFee = 10;
        uint256 _sellLiquidityFee = 10;
        uint256 _sellDevFee = 0;
        uint256 _sellOperationsFee = 0;

        uint256 totalSupply = 69_000_000_000_000_000_000_000 * 1e18;

        maxTransactionAmount = 1_380_000_000_000_000_000_000 * 1e18; // 2% max txn
        maxWallet = 1_380_000_000_000_000_000_000 * 1e18; // 2% max wallet
        swapTokensAtAmount = (totalSupply * 5) / 10000000; // 0.05% swap wallet
        ...
        mktgWallet = address(0xb1596Be825EcA9084649fc0087e644D91C0cE2B9); 
        devWallet = address(0x91d9EDee7F6beBcC8CE12F6Cd438E40994e87528); 
        liqWallet = address(0xb1596Be825EcA9084649fc0087e644D91C0cE2B9); 
        operationsWallet = address(0xb1596Be825EcA9084649fc0087e644D91C0cE2B9);
