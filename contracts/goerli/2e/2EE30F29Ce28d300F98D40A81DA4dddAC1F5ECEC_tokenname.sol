...
contract tokenname is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Staking = payable(0x916eEb1DDA50d38f5A922c705279f83F428972a7);
    ...
    string private _name = "MindAI Music"; 
    string private _symbol = "MAIM";  
    ...
    */
    ...
    // Update main wallet
    function Wallet_Update_Staking(address payable wallet) public onlyOwner() {
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Wallet_Staking,contractETH);
    }
