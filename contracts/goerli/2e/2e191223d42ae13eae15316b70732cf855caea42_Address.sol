...
// File: contracts/LowGasNFTCollection.sol
...
contract BlobGuysLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Blob Guys", "BG") {
    setHiddenMetadataUri("ipfs://QmR8j3q3YidZAxn86vQQxbTTQfo27eKnsz9pjqNsipLLn5/hidden.json");
  }
