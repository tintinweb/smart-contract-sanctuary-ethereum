...
contract MyEpicNFT is ERC721URIStorage {
    ...
    event NewEpicNFTMinted(address sender, uint256 tokenId, uint256 maxId);
    event MintedNFTCount(uint256 MintedtokenId);
    ...
    function makeAnEpicNFT() public {
        ...
        require(newItemId < _maxId, "Over maxId");
        ...
        emit NewEpicNFTMinted(msg.sender, newItemId, _maxId);
    }
}
