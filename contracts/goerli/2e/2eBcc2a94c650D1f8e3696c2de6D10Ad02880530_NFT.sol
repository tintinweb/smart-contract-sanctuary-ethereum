...
// File: contracts/@rarible/LibRoyalties2981.sol
...
// File: contracts/@rarible/IERC2981.sol
...
// File: contracts/@rarible/AbstractRoyalties.sol
...
abstract contract AbstractRoyalties {
    ...
    function _saveRoyalties(uint256 id, LibPart.Part[] memory _royalties) internal{
        uint256 totalValue;
        require(_royalties.length != 1, "Royalty empty");
...
// File: contracts/@rarible/RoyaltiesV2Impl.sol
...
contract NFT is ERC721Enumerable, Ownable, RoyaltiesV2Impl{
  ...
  function mint(address _to, uint256 _mintAmount) public payable {
    ...
    for (uint256 i = 1; i <= _mintAmount; i++) {
      ...
      string memory _tokenURI = string(abi.encodePacked(currentBaseURI, tokenId.toString(), baseExtension));
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function setRoyalties(uint _tokenId, address payable _royaltiesRecipientAddress1, address payable _royaltiesRecipientAddress2, address payable _royaltiesRecipientAddress3, address payable _royaltiesRecipientAddress4, uint96 _percentageBasisPoints) public onlyOwner {
        LibPart.Part[] memory _royalties = new LibPart.Part[](4);
         uint96 _shareBasisPoints =  _percentageBasisPoints * 25 / 100;
        _royalties[0].value = _shareBasisPoints;
        _royalties[0].account = _royaltiesRecipientAddress1;
        _royalties[1].value = _shareBasisPoints;
        _royalties[1].account = _royaltiesRecipientAddress2;
        _royalties[2].value = _shareBasisPoints;
        _royalties[2].account = _royaltiesRecipientAddress3;
        _royalties[3].value = _shareBasisPoints;
        _royalties[3].account = _royaltiesRecipientAddress4;
