...
contract Token is ERC20 {
    ...
    function mint() public payable {
        ...
        //msg. value will be denominated in eth, so expecting decimal here
        require(msg.value > 0);
        //cahnged 'div' to 'mul' below - can't have decimals as uint256?
        uint256 val = msg.value.mul(1000000000);
    ...
    function getVotes(address _sender) public view returns (uint256) {
        return hasVotes[_sender];
    }

    function verifyVoters(address _sender, uint256 _proposalId)
        public
        view
        returns (bool)
    {
