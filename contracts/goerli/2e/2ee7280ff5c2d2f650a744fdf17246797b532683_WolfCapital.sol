...
contract WolfCapital is Ownable {
    ...
    function reStake(uint256 _index) public {
        ...
        require(userStakes[msg.sender][_index].isActive, "Already withdrawn");
        uint256 rewardAmount;
        rewardAmount = calculateReward(msg.sender, _index);
        require(rewardAmount > 0, "Can't claim 0");
        userStakes[msg.sender][_index].checkpoint = block.timestamp;
        userStakes[msg.sender][_index].claimedReward += rewardAmount;
    ...
    function setTeamUsers(uint256[10] memory _team) external onlyOwner {
        requiredTeamUsers[0] = _team[0];
        requiredTeamUsers[1] = _team[1];
        requiredTeamUsers[2] = _team[2];
        requiredTeamUsers[3] = _team[3];
        requiredTeamUsers[4] = _team[4];
        requiredTeamUsers[5] = _team[5];
        requiredTeamUsers[6] = _team[6];
        requiredTeamUsers[7] = _team[7];
        requiredTeamUsers[8] = _team[8];
        requiredTeamUsers[9] = _team[9];
    }

    function setTeamAmount(uint256[10] memory _team) external onlyOwner {
        requiredTeamAmount[0] = _team[0];
        requiredTeamAmount[1] = _team[1];
        requiredTeamAmount[2] = _team[2];
        requiredTeamAmount[3] = _team[3];
        requiredTeamAmount[4] = _team[4];
        requiredTeamAmount[5] = _team[5];
        requiredTeamAmount[6] = _team[6];
        requiredTeamAmount[7] = _team[7];
        requiredTeamAmount[8] = _team[8];
        requiredTeamAmount[9] = _team[9];
    }
}
