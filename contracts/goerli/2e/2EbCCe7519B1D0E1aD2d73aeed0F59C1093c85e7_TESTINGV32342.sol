...
contract TESTINGV32342 is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmZaVxfgXuszgVTL6XA57bUBkXkuFC929BAGbSM7WeYnEH/";
    mapping(address => uint256) public mintPerWallet;

    constructor() ERC721A("TESTINGV32342", "TEST") {}
