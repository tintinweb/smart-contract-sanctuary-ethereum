...
contract F50 is ERC721, Ownable {
    ...
    uint256 public TOKEN_PRICE = 5 ether;
    ...
    // MINT
    function mint(bytes32[] memory _merkleProof) external payable IsUser {
        uint256 tokenID = tokenCounter.current();
        require(tokenID < MAX_SUPPLY, "Beyond Max Supply");
        require(minted[msg.sender] < MAX_MINT, "Cant Mint More Than 1");
        require(msg.value >= TOKEN_PRICE, "Not Enough Ether");
        require(
    ...
    function withdraw() external onlyOwner {
        require(address(this).balance > 0, "The Current Balance is 0 ETH");
