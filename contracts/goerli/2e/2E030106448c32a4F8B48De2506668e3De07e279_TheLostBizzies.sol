 ...
 * @notice This contract handles minting The Lost Bizzies tokens.
 */
contract TheLostBizzies is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x94e6daD0361DCBDD8dd46BCE17949C93Afa9F9C2;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x8d4dAbA34C92E581F928fCA40e018382f7A0282a;
    ...
    string public baseTokenURI =
        "ipfs://bafybeibk4un5eq4kqumdcqiheffpbvknwuisa5cjpblddico6gjml4a3oq/";
    ...
    uint256 public presaleMintsAllowedPerTransaction = 25;
    uint256 public presalePrice = 0 ether;
    uint256 public publicMintsAllowedPerAddress = 1;
    uint256 public publicMintsAllowedPerTransaction = 25;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("The Lost Bizzies", "BIZZIES")
        RevokableOperatorFilterer(
