...
contract PunksBook is ERC721, Ownable {
  constructor() ERC721("Punks Book", "PB") {}

  string private uri = "placeholder";
  ...
  function mint(uint tokenId, bytes memory signature) public payable {
    ...
    require(msg.value >= priceWei, "Not enough funds sent");
