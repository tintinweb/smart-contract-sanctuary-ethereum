...
contract Pool is IPool {
  ...
  uint256 public constant INDEX = 1e27;
  ...
  function supply(
    ...
    bool isFirstSupply = IAToken(A_TOKEN_ADDRESS).mint(
      ...
      onBehalfOf,
      amount,
      INDEX // we maintain the index at 1 as AAVE aToken will not increase as there is no borrowing
    );
  }
  ...
  function withdraw(
    ...
    IAToken(A_TOKEN_ADDRESS).burn(msg.sender, to, amountToWithdraw, INDEX);
