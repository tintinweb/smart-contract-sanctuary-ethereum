...
//Importing the ERC20 Standard from openzepplin
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract gNGN is ERC20, Ownable {
    ...
    modifier notBlacklisted(address sender, address recipient) {
        require(!_blacklist[sender] && !_blacklist[recipient]," Token transfer not allowed");
_;
}
    ...
    constructor() ERC20("G-Naira", "gNGN"){
     ...
     function blacklist(address account) public onlyGovernor {
      ...
      function transfer(address recipient, uint256 amount) public override
       notBlacklisted(msg.sender, recipient) returns (bool){
