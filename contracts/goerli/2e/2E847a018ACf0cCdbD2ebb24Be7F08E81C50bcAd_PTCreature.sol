 ...
 */
contract PTCreature is ERC721Tradable {
    constructor()//address _proxyRegistryAddress)
        ERC721Tradable("PTCreature", "PTOSC")//, _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://testpl1234.s3.ap-northeast-1.amazonaws.com/json/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://testpl1234.s3.ap-northeast-1.amazonaws.com/contract.json";
    }
}