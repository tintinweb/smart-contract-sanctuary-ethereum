...
contract NftSwapProxy is Ownable {
    ...
    function swap(
        ...
        uint256 mintpassAmount = Vault(_vaultAddress).swap{value: msg.value}(singleSwap, funds, limit, deadline);
        TransferHelper.safeApprove(singleSwap.assetOut, _nftContractAddress, mintpassAmount);
        ...
        for (uint256 i = 0; i < mintpassAmount; i++) {
            ...
            uint256 tokenId = ERC721(_nftContractAddress).mint();
