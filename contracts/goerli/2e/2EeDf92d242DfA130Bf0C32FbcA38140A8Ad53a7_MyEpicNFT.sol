...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["CAT", "DOG", "HUMAN", "FOX", "BIRD", "BAER"];
    string[] secondWords = ["WALK", "PLAY", "SWIM", "EAT", "FLY", "SLEEP"];
    string[] thirdWords = ["STREET", "CITY", "MEET", "FISH", "SKY", "BED"];
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        // '", "description": "A highly acclaimed collection of squares.", "image_data": "data:image/svg+xml;base64,',
