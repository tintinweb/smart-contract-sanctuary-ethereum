...
contract PunksDNA {
    ...
    function getFacialHairColor(uint256 _dna) public view
    ...
    function getFacialHairType(uint256 _dna) public view
        returns (string memory)
    {
...
contract PlatziPunks is ERC721, ERC721Enumerable, PunksDNA {
   ...
   //variables
    ...
    //clave: tokenId, valor: DNA del punk
        ...
        returns (string memory) 
    {
        ...
        //lectura del mapping utilizando el [tokenId]
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "PlatziPunks #',
                tokenId,
                '", description": "Platzi Punks are randomized avatars stored on chain to teach dApp development", "image": "',
                image,
                '"}'
            )
        );
