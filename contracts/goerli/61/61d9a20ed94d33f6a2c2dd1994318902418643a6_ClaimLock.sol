...
contract ClaimLock is IClaimLock, Ownable {
    ...
    //stores info if an address has claims frozen
    ...
    constructor() {
        approved[msg.sender] = true; //The Oracles Verse
        approved[0x8DedB5a142B2CA5046386b748f6e977D92BFb0aC] = true; //The Oracles Verse

        QEV = IERC20(0x48Fc9AFF4C3C76d6e4D1F574c1E31Bfa5b8b999F);
        platformTreasury = 0x318cBF186eB13C74533943b054959867eE44eFFE;
    }
    ...
    function claim() external {
        require(!QEVClaims[msg.sender].isFrozen, "Claim is Frozen!");
    ...
    /**
     * @dev allows the owner to freeze a claim
     */
    function freezeClaim(address claimer) external onlyOwner {
        require(claimer != address(0), "Invalid Address");
        QEVClaims[msg.sender].isFrozen = true;
    }

    /**
     * @dev Allows owner to edit a claim
     */
    function editClaim(address claimer, uint256 newUnclaimed) external onlyOwner {
        require(claimer != address(0), "Invalid Address");
        QEVClaims[msg.sender].unclaimed = newUnclaimed;
    }
