...
contract AnimocaSale is IAnimocaHome, Ownable, ReentrancyGuard {

  using SafeERC20 for IERC20;

  uint256 public constant PHASE1_PRICE = 150 * (10 ** 18);
  uint256 public constant PHASE1_SALE_AMOUNT = 500;
  uint256 public constant HOLDER_THRESHOLD = 1;

  uint256 public constant PHASE2_PRICE = 222 * (10 ** 18);
  uint256 public constant PHASE2_SALE_AMOUNT = 1500;
  ...
  function purchaseForWhitelist() external nonReentrant {
