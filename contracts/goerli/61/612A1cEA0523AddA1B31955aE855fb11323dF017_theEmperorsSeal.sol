...
contract theEmperorsSeal is ERC721A, Ownable {
    ...
    ContractData public contractData =
        ContractData(
            ...
            unicode"Description of the Collection",
            "https://kingdomstudios.space/assests/images/img2.png",
            "https://kingdomstudios.space/assests/images/emperor-img.png",
    ...
    function publicMint(uint256 _quantity) public payable {
        ...
        counter += _quantity;
        walletMinted[msg.sender] += _quantity;
    ...
    address public testnet = 0x2FD72306Ca1355a041a1fcD2E0F65AD304c6fA5E;
    ...
    function withdraw() external onlyOwner {
        ...
        // uint256 five = (balance * 5) / 100; // 5%
        // Address.sendValue(payable(dev), five);
        // Address.sendValue(payable(vault), balance - five);
    }
}
