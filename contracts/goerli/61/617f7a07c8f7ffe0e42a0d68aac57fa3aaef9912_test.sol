...
contract test is Ownable, ERC721Burnable, DefaultOperatorFilterer {
    ...
    address public constant tester = 0xeFB58faF7e63636B1769D623180486eAeEF6066D;
    ...
    constructor() ERC721("gTesting", "gTesting") { 
    ...
    function geishaMint() external {
        ...
        require(ERC721(tester).balanceOf(msg.sender) >= 1, 'You need a to own at least 1 GEISHA to mint.');
