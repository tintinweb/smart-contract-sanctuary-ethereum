...
contract DellNFT is ERC721URIStorage {
    ...
    constructor() ERC721("DellNFT", "DELL") {
        collectionName = name();
    ...
    function createDellNFT() public returns(uint256) {
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    ...
                    '{"name": "',
                        combinedWord,
                        '", "description": "A highly acclaimed collection DELL Warriors", "image": "data:image/svg+xml;base64,',
