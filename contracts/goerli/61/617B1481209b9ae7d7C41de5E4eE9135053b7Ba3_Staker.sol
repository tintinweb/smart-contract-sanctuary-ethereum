...
contract Staker {
  ...
  modifier dealineStatus(bool deadlinePassed){
  ...
  function stake() public payable dealineStatus(false) notCompleted{
  ...
  function withdraw(address payable _to) public dealineStatus(true) notCompleted {
