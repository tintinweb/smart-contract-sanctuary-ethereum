...
contract CapanionsTest is ERC721A, Ownable, ReentrancyGuard {
    ...
    string private notRevealedUri = "ipfs://QmP6ouSiTwosEna2d52oKo6AVbT418tzfPF1TdN5ZDB8Ag/notRevealed.json";
    ...
    function setRevealedStatus(bool _revealedStatus) public onlyOwner {
        revealed = _revealedStatus;
    }
