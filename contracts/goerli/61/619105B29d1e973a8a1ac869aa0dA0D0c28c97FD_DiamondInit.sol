...
contract DiamondInit {
  ...
  function init_StakingRewardsFacet(
    address stakingToken,
    address rewardToken,
    uint8 rewardRate
  ) external {
    LibDiamond.StakingStorage storage ss = LibDiamond.stakingStorage();
    ss.stakingToken = IERC20(stakingToken);
    ss.rewardToken = IERC20(rewardToken);
    ss.rewardRate = rewardRate;
  }
}