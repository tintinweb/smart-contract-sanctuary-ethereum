...
contract NFT721A is ERC721AUpgradeable, AccessControlUpgradeable {
    ...
    */
    ...
    function setBaseURI(string memory _newBaseURI) public adminOnly {
...
contract WowTNft721A is NFT721A, VRFConsumerBaseV2Upgradeable {
    ...
    // 1 - mint
    event TokensSold(address market, uint256 tokenId, address buyer);
    ...
    function mint(uint256 from, uint256 to) public adminOnly {
        for (uint256 i = from; i < to; i++) {
            ...
            emit TokensSold(address(this), i, tokenIdToAddress[i].buyer);
        }
    }
