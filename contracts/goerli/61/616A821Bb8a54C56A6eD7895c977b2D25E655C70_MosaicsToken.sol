...
contract MosaicsToken is IMosaicsToken, Ownable, ERC721URIStorage {
     ...
     * @dev Only callable by the owner.
     */
    function setMosaicURIHash(uint256 tokenId, string memory mosaicURIHash) external onlyAdmin {
     ...
     * @dev Only callable by the owner.
     */
    function setDefaultMosaicURIHash(string memory defaultMosaicURIHash) external onlyAdmin {
