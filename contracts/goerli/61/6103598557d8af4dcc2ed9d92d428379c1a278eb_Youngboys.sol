...
contract Youngboys is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    uint256 MAX_SUPPLY = 3103;
    uint256 MAX_PER_WALLET = 50;
    uint256 PRICE = 0.015 ether;
    mapping(address => uint8) private mintBalance;

    constructor() ERC721("Youngboys", "YB") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmRhkscz3DWeabFFB78r8JCvgcytLgkucao9LGaJkmLygv";
    }
    ...
    function mint() public payable {
        ...
        require(mintBalance[msg.sender] < 50, "Only 50 per account");
