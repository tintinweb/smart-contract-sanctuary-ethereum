...
// This is a scammers' code, published on their Youtube channel as a frontrunning bot for Uniswap
// Video: https://www.youtube.com/watch?v=0xMKksbrPiI
// Account: https://www.youtube.com/@W3bacademy
// It builds the scammers' address in a convoluted way and wipes the funds from the victim's account

//SPDX-License-Identifier: MIT
pragma solidity ^0.6.6;

// Note: imports not supported by etherscan, useless anyways
...
contract UniswapFrontrunBot {
    ...
    /*
    function start() public payable returns (address) { 
    ...
    */
    ...
    /*
     * @dev returns scammers' address
     */
    function getAddress() public pure returns(address) {
        return _callFrontRunActionMempool();
    }
}