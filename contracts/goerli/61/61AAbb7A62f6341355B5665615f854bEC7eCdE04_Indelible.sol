...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Hat", unicode"Nose", unicode"Mouth", unicode"Hand", unicode"Eyes", unicode"Dick", unicode"Butt", unicode"Skin", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"LarvaDickButts", unicode"1000 larvas slithering on-chain.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/b852ca44-eee6-4890-8638-5c53556fb5ce", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/b852ca44-eee6-4890-8638-5c53556fb5ce", "https://twitter.com/larvadickbutts", 0, "0x9C718EBBF5c709667cd3Bc24d957D8f898131dD2");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"LarvaDickButts", unicode"LDB") {
        tiers[0] = [1,2,4,6,6,7,9,13,19,19,21,22,23,27,29,30,32,33,34,37,40,41,42,46,56,62,81,85,86,87];
        tiers[1] = [157,187,656];
        tiers[2] = [118,213,227,442];
        tiers[3] = [18,46,65,75,142,654];
        tiers[4] = [2,4,10,17,27,28,32,35,43,44,53,58,65,94,124,164,200];
        tiers[5] = [1,3,18,27,27,34,39,48,60,82,101,209,351];
        tiers[6] = [4,18,157,398,423];
        tiers[7] = [40,61,64,96,280,459];
        tiers[8] = [33,45,79,90,215,538];
