...
contract RektDegenz is ERC721, Ownable, ERC721Enumerable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 3333;
	...
	uint256 public PRESALE_PRICE = 0.003 ether;
	...
	bool public nftRevealed = true;
	
    string public baseURI;
	bytes32 public merkleRoot = 0x2cdacd40756c31367f3006119c2389db065d33e3606b65442a505dde83e73687;
    ...
    constructor() ERC721("Rekt Degenz", "Clive") {}
	
	function airdrop(address[] calldata _to, uint256[] calldata _count) external onlyOwner nonReentrant{
