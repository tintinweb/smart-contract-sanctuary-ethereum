    ...
    IERC4906
{
    ...
    // Royalty
    address public royaltyAddress = 0x7d8F441BF65FF8cdA99059FB5137AF720DE562fB;
    uint96 public royaltyFee = 1000;

    // Switching Duration
    uint160 public duration = 1350;
     ...
     * Constructor
     */
    constructor() ERC721Psi("EkigoriTest", "EGT") {
        ...
        setBaseURI("https://ekigori-test.mapplek.com/json/");
        ...
        returns (string memory)
    {
        if(useInterfaceMetadata == true) {
            ...
            uint256 timeSeed = time / duration;
            bytes32 randomValue = keccak256(abi.encodePacked(msg.sender, "-", _tokenId, "-", timeSeed));
            uint256 yijingNum = uint256(randomValue) % 64 + 1;
    ...
    function setDuration(uint160 _duration)
        public
        onlyRole(ADMIN)
    {
        duration = _duration;
