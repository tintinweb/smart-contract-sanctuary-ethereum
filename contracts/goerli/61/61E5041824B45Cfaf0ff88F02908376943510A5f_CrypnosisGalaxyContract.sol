...
contract CrypnosisGalaxyContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Crypnosis Galaxy";
    string public symbol = "KRPCR";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hv4qi6uUg08lJ3Uaq2uR/contract-metadata";
  }
