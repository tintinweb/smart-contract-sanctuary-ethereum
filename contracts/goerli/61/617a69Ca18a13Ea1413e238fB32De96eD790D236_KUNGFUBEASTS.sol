...
contract KUNGFUBEASTS is ERC721A, ReentrancyGuard, Ownable, DefaultOperatorFilterer {
    ...
    uint256 private immutable _underGroundShare = 3;
    address private immutable _underGroundWallet = 0x07D185256FeD6e539c7a8a025b429a94D1F6CA9b;
    ...
    */
    ...
    function withdraw() external onlyOwner {
        ...
        uint ugShareAmount = balance.mul(_underGroundShare).div(100);
        uint remaining = balance.sub(ugShareAmount);

        payable(_underGroundWallet).transfer(ugShareAmount);
        payable(_treasury).transfer(remaining);
    }
