 ...
 * @notice This contract handles minting Curious Addys tokens.
 */
contract LaunchpadCuriousAddys is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public freeClaimContractAddress =
        0x7A4dF7B461f1bE3e88373a4d933aeefE2FAdcE71;
    address public royaltyAddress = 0xD3371FD388664Bd16A267788dbE977582B850f5b;
    ...
    string public baseTokenURI =
        "ipfs://bafybeifm3np3zk7l3vlxb47hmoeo5hznoty6pm6yjoyqk2f6vwi4e6aale/";
    ...
    constructor() ERC721A("Curious Addys", "CATC") {
    ...
    function freeClaim(uint256[] calldata _tokenIDs) public originalUser {
        ...
        require(
            totalSupply() + (_tokenIDs.length * 1) <= MAX_SUPPLY,
            "MAX_SUPPLY_EXCEEDED"
        );
        ...
        _safeMint(msg.sender, _tokenIDs.length * 1);
    }
