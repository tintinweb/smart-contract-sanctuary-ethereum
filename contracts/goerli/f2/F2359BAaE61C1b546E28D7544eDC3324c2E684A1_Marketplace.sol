...
contract Marketplace is Auth, ERC721Holder {
    ...
    // BidSuccess event is fired when user placed a bid
    ...
    function createAuction(address _collection, uint256 _token_id, uint256 _startPrice, uint256 _startTime, uint256 _endTime) OnlyItemOwner(_collection, _token_id) public {
