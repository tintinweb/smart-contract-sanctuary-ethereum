...
contract Estate is ERC721URIStorage, Ownable {
    ...
    event Inspected(
        address indexed inspecter,
        address indexed cont,
    ...
    function realEstate(string calldata tokenURI) public {
        ...
        emit EstateMapped(currentId, msg.sender, tokenURI, 0);
    }
    ...
    function listEstate(
        ...
        emit EstateListed(msg.sender, address(this), tokenId, price);
    }
    ...
    function inspect(
        ...
        emit Inspected(msg.sender, address(this), tokenId);
    }
    ...
    function buyEstate(
        ...
        emit ItemBought(msg.sender, tokenId, _list[tokenId].price);
