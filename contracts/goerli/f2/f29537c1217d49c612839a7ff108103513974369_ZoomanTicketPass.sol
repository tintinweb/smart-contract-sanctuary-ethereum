...
contract ZoomanTicketPass is ERC721Royalty, AccessControl {
    ...
    constructor(address _listaddress) ERC721("Zoo-man Ticket", "ZMT") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        ...
        _safeMint(0x5A3b919496358098ED6549b235D578914a7Cc90b, regularPassCounter++);
        _safeMint(0x5A3b919496358098ED6549b235D578914a7Cc90b, regularPassCounter++);
        for (uint8 i = 0; i < 5; i++){
            _safeMint(0x5A3b919496358098ED6549b235D578914a7Cc90b, regularPassCounter++);
        }
    ...
    uint256 reservationMintFinishTime;
    uint256 usualMintFinishTime;
    ...
    bool firstMintEnable = true;

    mapping(uint256 => bool) mangaMintFinish;
    ...
    function firstMint()public onlyRole(DEFAULT_ADMIN_ROLE) {
        require(firstMintEnable == true);
    ...
    function premiumPassMint() public payable {
        ...
        require(ticketaddresslist(listAddress).premiumPassUseCheck(msg.sender) != true);
    ...
    {
        if(tokenId < 10) {
            return string(abi.encodePacked(baseURI, "premiumpass.json"));
        } else {
            return string(abi.encodePacked(baseURI, "regularpass.json"));
        }
    }
