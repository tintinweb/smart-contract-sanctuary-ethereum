...
contract KelePoolStaking  is Initializable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        _system.eth2 = 0x4242424242424242424242424242424242424242; // eth2.0 contract address
    ...
    // create validator
    function createValidator(uint8 role,bytes calldata pubkeys,bytes calldata withdrawal_credentials,bytes calldata signatures,bytes32[] calldata deposit_data_roots) external payable onlyEnable 
    {
        // check parameters
    ...
    // withdraw
    function withdraw(address receiver,uint256 amount) public onlyOperator {    
    ...
    // take out fee
    function takeOutFee(address receiver) public onlyOperator {
        require(receiver != address(0), "Invalid receiver");
    ...
    // change eth2 
    function changeETH2(address eth2) public {
        _system.eth2 = eth2;
    }
}
