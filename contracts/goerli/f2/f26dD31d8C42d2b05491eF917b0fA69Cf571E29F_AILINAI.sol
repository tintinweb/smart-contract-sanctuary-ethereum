 ...
 * @notice This contract handles minting AI:LIN (AI) tokens.
 */
contract AILINAI is
    ERC721A,
    ERC721AQueryable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xbf3f8D40E779ab21935fa8298ab203D8243ECA8b;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x94da09fFF46eE54697e4aaB8Df09b113e6553f7e;
    address[] public payoutAddresses = [
        0x3c21dAB16C8C1d350CEfDDB4990c9E1419b8961d,
        0x94da09fFF46eE54697e4aaB8Df09b113e6553f7e
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeiaklvgsmxo2fgeu3ccdrhsb6kp55jo4ts4bbeoheuqkhfty73qbf4/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 10000;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 10000;
