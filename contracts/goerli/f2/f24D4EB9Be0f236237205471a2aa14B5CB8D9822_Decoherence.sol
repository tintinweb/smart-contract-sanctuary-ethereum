...
contract Decoherence is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function approve(address to, uint256 tokenId) public payable virtual override (IERC721A, ERC721A) checkList(to) {
    super.approve(to, tokenId);
  }

  function setApprovalForAll(address operator, bool approved) public virtual override (IERC721A, ERC721A) checkList(operator) {
