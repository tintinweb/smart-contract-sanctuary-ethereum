...
contract test is  ERC721, ReentrancyGuard, OwnableRoles, DefaultOperatorFilterer, ERC2981{
  ...
  constructor (
    string memory tokenName, //GalacticGaylords
    ...
    string memory contractURI_ //ipfs://QmZb6BSDdQFnjreBzbCk5sApkz71yRXJxzkBswdsbq6qMR
   ) ERC721(tokenName, tokenSymbol) { // GalacticGaylords, $GG
    _initializeOwner(0x8AB5496a45c92c36eC293d2681F1d3706eaff85D);  // 0x1a178ecF995eba436aD2bc89364413C4D0D43472
