...
contract Totem is ReentrancyGuard {
    ...
    function submitChallenge(
        ...
        require(courses[courseId].Challenges[challengeCount[courseId]].rewardAmount > 0, 'Challenge doesnt Exist');
    ...
    function validateSubmit(
        ...
        courses[courseId].Challenges[challengeCount[courseId]].studentReward[studentAddress] =
            (score / 100) *
            courses[courseId].Challenges[challengeCount[courseId]].rewardAmount;
        emit ValidatedSubmit(challengeId, courseId,score,
            courses[courseId].Challenges[challengeCount[courseId]].rewardAmount , studentAddress
        );
    }
    ...
    function Claim(uint256 challengeId, uint256 courseId) public {
        ...
        IERC20(courses[courseCount].stakedTokenAddress).transfer(
            msg.sender,
            courses[courseId].Challenges[challengeCount[courseId]].studentReward[msg.sender]
        );
        emit Claimed(challengeId,courseId, msg.sender, courses[courseId].Challenges[challengeCount[courseId]].rewardAmount);
    }
