        ...
        if (index == 1) {
            eye = string(
                abi.encodePacked(
                    ...
                    "/>",
                    '<circle class="cls-eye-15" cx="354.94" cy="205.78" r="6.06" />',
                    "<path",
                    '    class="cls-eye-16"',
            ...
            eye = string(
                abi.encodePacked(
                    ...
                    "    </style>",
                    "</defs>",
                    '<path class="cls-eye-18" d="M344.31,194.92s24.16,15.86,34.91,32.9" />',
                    '<path class="cls-eye-18" d="M372.12,190.41s-11,31.44-25.16,41.66" />'
                )
            );
        } else if (index == 4) {
            eye = string(
                abi.encodePacked(
                    ...
                    "/>",
                    '<circle class="cls-eye-14" cx="388.14" cy="243.48" r="4.84" />',
                    "<path",
                    ...
                    "/>",
                    '<circle class="cls-eye-14" cx="394.19" cy="256.68" r="4.84" />',
                    "<path",
                    ...
                    "/>",
                    '<circle class="cls-eye-17" cx="356.18" cy="203.49" r="6.06" />'
                )
            );
        } else {
            eye = string(
                abi.encodePacked(
                    ...
                    "/>",
                    '<circle class="cls-eye-19" cx="355.83" cy="206.04" r="6.06" />'
                )
            );
        }
        return eye;
