...
contract Dao is IDao {
    ...
    function vote(uint _proposalId, bool _answer) external override {
        Answer answer;
        Proposal storage proposal = proposals[_proposalId];
        bool alreadyVoted;
    ...
    function finish(uint _proposalId) external override {
    ...
    function withdrawal(uint _amount) external override {
    ...
    function changeParam (uint _percent, uint _days) 
        external
        override 
        onlyDao 
    {
