...
contract voting {
    ...
    constructor(string memory _title, string[] memory _candidates) {
        ...
        v.done = false;
        v.names = _candidates;
        v.numberOfVotes = new uint[](_candidates.length);
    ...
    function create_vote(string calldata _title, string[] calldata _candidates)
        public
        onlyOwner
    {
        Vote memory v;
    ...
    function vote(uint _voteKey, uint _candidateKey) public onlyOwner {
        ...
        console.log("voting for %s", v.names[_candidateKey]);

        v.numberOfVotes[_candidateKey]++;

        console.log(
            "%s has %s votes now !",
            v.names[_candidateKey],
            v.numberOfVotes[_candidateKey]
        );
    }

    function close_vote(uint _key) public onlyOwner {
