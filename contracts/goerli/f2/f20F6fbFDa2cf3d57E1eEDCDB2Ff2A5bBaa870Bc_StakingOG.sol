...
contract StakingOG is ERC721URIStorage, Ownable {
    ...
    IERC20Extended StakedMatic;
    constructor() ERC721("Ownest Staking OGs", "OWNG"){
        StakedMatic = IERC20Extended(0x1B09895C2AD5a0C6Be4053E5627C3575757C6705); // dev: 0xE097d6B3100777DC31B34dC2c58fB524C2e76921, prod: 0xD14a87025109013B0a2354a775cB335F926Af65A
        mintEnabled = true;
        setNodeAPR(500);
    ...
    function getERC20BalanceNormalised(address _address) public view returns(uint256) {
        return StakedMatic.balanceOf(_address)/10**StakedMatic.decimals();
    }

    function getERC20BalanceNormalisedString(address _address) public view returns(string memory balanceNormalised) {
        (, , balanceNormalised) = division(1, StakedMatic.balanceOf(_address), 10**StakedMatic.decimals());
    }
     ...
     * @dev Mint OG NFT
     */
    function mint(address[] calldata addresses) public onlyOwner {
