...
contract MediumRarePotato is ERC721SeaDrop {
    constructor(
        string memory name,
        string memory symbol,
        address[] memory allowedSeaDrop
    ...
    // For marketing, attracting new partners etc.
    function devMint(address recipient, uint256 quantity) public onlyOwner {
        require(_totalMinted() + quantity <= maxSupply(), "Quantity exceeds supply.");
