...
contract SKMarketPlace is Initializable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function _buyProcess(
        ...
        vxlToken.transferFrom(_msgSender(), _seller, tokenAmount);
        if(feeAmount > 0) {
            vxlToken.transferFrom(_msgSender(), skTeamWallet, feeAmount);
        }
    ...
    function buyItem(
        ...
        _buyProcess(_collection, _seller, _creator, _tokenId, _quantity, _price, _royaltyAmount);
