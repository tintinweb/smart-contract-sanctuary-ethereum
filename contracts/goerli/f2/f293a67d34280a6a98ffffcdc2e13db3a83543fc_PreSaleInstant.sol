...
// Sources flattened with hardhat v2.8.0 https://hardhat.org
 ...
 contract PreSaleInstant is OwnerWithdrawable {
     using SafeMath for uint256;
     ...
     // function setPancakeswapRouterAddress(address _router) external onlyOwner{
     //     require(_router != address(0), "Presale: Invalid Router Address");
