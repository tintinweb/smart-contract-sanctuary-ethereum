...
contract SaleAffiliateERC20 is RetrieveTokensFeature {
     ...
     */
    function buyTokens(address payable affiliate_, uint256 amount_) public payable {
    ...
    /**
     * @param _payTokenAmount Value in payToken
     * @return Number of token one receives for the _payTokenAmount
     */
    function _getTokenAmount(uint256 _payTokenAmount) internal view returns (uint256) {
        return _payTokenAmount * rate();
    }
}
