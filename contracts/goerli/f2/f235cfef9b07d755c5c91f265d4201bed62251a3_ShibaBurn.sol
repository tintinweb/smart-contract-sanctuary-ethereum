...
contract ShibaBurn is Ownable {
  ...
  // ShibaSwap router:
  ISwapper public router = ISwapper(0xe3B57adF77673E963c8BA7A26f08C9A3B87E70b7);

  // Ledgendary burn address that holds tokens burnt of the SHIB ecosystem:
  address public burnAddress = 0x000000000000000000000000000000000000dEaD;
  address public wethAddress = 0xF83486d401F3247b8a6356Ef1E48828f7153C9aF;

  // Addresses of SHIB ecosystem tokens:
  address public shibAddress = 0x6f1D8eC96095414CbC1cdd4CAf76425eF044274f;
  address public flameAddress = 0xE33cc1DB35d629079A2EDE0c59BbB5a6976D8107;
  address public donaAddress = 0x0216a640C4d53F2a6603042d4E14A2B890efcD45;
  address public ryoshiAddress = 0x1aED12E373bC0AD8F52118181bDa821BC1EB4dB8;
  ...
  */
  function shouldTrackIndex(address tokenAddress, uint256 poolIndex, uint256 amount) internal view returns (bool) {
  ...
  */
   ...
   *
  */
  function burnDona(uint256 amount) external {
    burnToken(donaAddress, amount);
  }
   ...
   *
  */
  function burnFlame(uint256 amount) external {
    burnToken(flameAddress, amount);
  }
