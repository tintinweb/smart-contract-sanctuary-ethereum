...
contract FeralfileExhibitionV3_3 is FeralfileExhibitionV3_2 {
    ...
    function getArtworkIDByTokenID(uint256 _tokenId)
        public
        view
        returns (uint256)
    {
    ...
    /// @notice mintArtworkEdition use for mint token from burn contract
    /// @param _artworkID - the id of artwork
    /// @param _owner - the owner will be received minted token
    function mintArtworkEdition(uint256 _artworkID, address _owner)
        public
        onlyMinter
    {
        require(
        ...
        tokenCounter.increment(); // Should be start from 1
