...
contract DividendDistributor is IDividendDistributor {
  ...
  // IERC20 MAGIC = IERC20(0x539bdE0d7Dbd336b79148AA742883198BBF60342);
  IERC20 MAGIC = IERC20(0x07865c6E87B9F70255377e024ace6630C1Eaa37F); // USDC Testnet
...
contract Merlin is IERC20, Auth {
  using SafeMath for uint256;

  // address MAGIC = 0x539bdE0d7Dbd336b79148AA742883198BBF60342; // MAGIC Mainnet
  address private constant MAGIC = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F; // USDC Testnet
  address private constant ROUTER = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
  address private constant WETH = 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
  address private constant  DEAD = 0x000000000000000000000000000000000000dEaD;
  address private constant ZERO = 0x0000000000000000000000000000000000000000;

  string private constant _name = "MERLIN";
  string private constant _symbol = "MERLIN";
  ...
  uint256 public marketingFeeBuy = 500;
  ...
  uint256 public marketingFeeSell = 500;
  ...
  address public marketingFeeReceiver = 0x0C58b6833719033ADBf45615B4eBa144C74cC003;
  ...
  function setSellFees(
    ...
    totalFeeSell = _liquidityFee + (_buybackFee) + (_reflectionFee) + (_marketingFee);
  }
  ...
  function setBuyFees(
    ...
    totalFeeBuy = _liquidityFee + (_buybackFee) + (_reflectionFee) + (_marketingFee);
  }
