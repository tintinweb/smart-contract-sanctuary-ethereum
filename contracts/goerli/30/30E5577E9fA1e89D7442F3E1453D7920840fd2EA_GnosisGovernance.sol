...
/// @title GnosisGovernance - Gnosis Safe module. Allows CompanyDAO Pool.executeBallot transactions to execute without approval.
contract GnosisGovernance is Initializable {
    ...
    address public pool12;
    address public pool13;
    address public pool14;
    address public pool15;
    address public pool16;
    address public pool17;
    address public pool18;
    address public pool19;
    address public pool20;
    address public pool21;
    address public pool22;
    address public pool23;
    address public pool24;
    address public pool25;
    address public pool26;
    address public pool27;
    address public pool28;
    address public pool29;
    address public pool30;
    address public pool31;
    address public pool32;
    address public pool33;
    address public pool34;
    address public pool35;
    address public pool36;
    ...
    function transfer(
        ...
        if (token == address(0)) {
            ...
            require(
                GnosisSafe(IPool(pool).gnosisSafe()).execTransactionFromModule(
                    to,
                    amount,
                    "",
                    Operation.Call
    ...
    function setupModules(address _pool) public {
        require(false, "88844");
    }
}
