...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Laser", unicode"Face", unicode"Mouth", unicode"Skin", unicode"Shirt", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"FirstTestTwoss", unicode"First test collection in indelibles two", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/ac4e7e8e-e7b0-442c-8831-96c5240326b1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/ac4e7e8e-e7b0-442c-8831-96c5240326b1", "https://indelible.xyz", 0, "0x10EC407c925A95FC2Bf145Bc671A733D1fBa347E");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"FirstTestTwoss", unicode"FTCTWO") {
        tiers[0] = [54,91,141,201,232,283];
        tiers[1] = [1,2,2,5,6,15,22,42,54,62,63,71,75,89,129,364];
        tiers[2] = [1,3,27,29,54,89,92,94,205,408];
        tiers[3] = [212,290,500];
        tiers[4] = [8,16,16,17,19,26,32,47,47,57,73,79,94,144,163,164];
        tiers[5] = [20,43,50,123,134,232,400];
