...
contract GelatoStuff is OpsReady {
    ...
    function increaseCount() external {
        require(block.timestamp - lastExecuted > 180, "time not elapsed");
        count = count++;
        ...
        returns (bool canExec, bytes memory execPayload)
    {
        ...
        execPayload = abi.encodeWithSelector(this.increaseCount.selector);
    }
}
