...
contract WARBOTS is Ownable, ReentrancyGuard, RrpRequesterV0 {
    ...
    mapping(address => uint8) public gameMode;
    ...
    //function DrawCard(uint256 _amount,uint8 _mode) public payable {
    ...
    function RevealResults() public nonReentrant {        
        ...
        uint8 mode = gameMode[msg.sender];
        uint256 winAmount;
