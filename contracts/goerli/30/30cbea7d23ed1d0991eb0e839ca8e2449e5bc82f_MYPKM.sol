...
// File: contract-fb7b6abe6d_flat.sol
...
contract MYPKM is ERC721, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("MY PKM", "PKM") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://voluble-panda-90368f.netlify.app/";
    }
