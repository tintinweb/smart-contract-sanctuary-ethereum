...
contract BasedDoge is ERC20, Ownable{
    ...
    constructor() ERC20("Based Doge", "BDOGE")
    {
...
contract BDOGEPolicy is Ownable {
    using SafeMath for uint256;
    ...
    onlyOrchestrator
    {
        ...
        if(supplyDelta == 0) {
            ...
            require(lastRebaseTimestampSec + 24 hours < block.timestamp, "24 hours has not passed since the last rebase");
            ...
            require(lastRebaseTimestampSec.add(minRebaseTimeIntervalSec) < block.timestamp , "30 minutes has not passed since last rebase");
    ...
    constructor(BasedDoge uFrags_, uint256 _token_price)
    {
        ...
        returns (int256)
    {
        ...
        return uFrags.totalSupply().toInt256Safe() * (new_price.toInt256Safe() - (targetRateSigned)) / (targetRateSigned);
    }
