...
contract Jingle is Context, IERC20, Ownable {
    ...
    // Context";
    string private _name = "Elons Jingle Balls";
    string private _symbol = "$Balls";
    uint8 private _decimals = 18;

    // Supply 
    uint256 private _totalSupply = 25 * 1e4 * 1e18;    
    uint256 private minimumTokensBeforeSwap = _totalSupply * 1 / 100;    
    ...
    // wallets
    address payable public liquidityWallet = payable(0xa91554cE4d239B8ad2112cd25829c252B69856E7);
    address payable public operationsWallet =  payable(0xa91554cE4d239B8ad2112cd25829c252B69856E7);
    ...
    uint256 public maxTotalFeeSell = 65;
