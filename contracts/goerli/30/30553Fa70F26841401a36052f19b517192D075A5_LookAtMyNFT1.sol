...
contract LookAtMyNFT1 is ERC721A, Ownable {
    using Strings for uint256;
    ...
    string public hiddenMetadataUri = "ipfs://ipfs-url";

    uint256 public allowlistCost = 0.04 ether;
    uint256 public publicCost = 0.0001 ether;
    ...
    address private myAddr = 0x84Fa1FA238D3Ed69816D3d747c31089D7a3C9915;

    constructor() ERC721A("Look At My NFT", "LOOK") {}
    ...
    function setMyAddr(address _addr) public onlyOwner {
        myAddr = _addr;
    }
