...
contract Presale {
    ...
    IToken public SMAI = IToken(0x954be599F142F1eeCa2A7fF7c11DaEBb1bc2B8E3);
    IToken public USDT = IToken(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    AggregatorV3Interface public priceFeedEth;

    address payable public owner;

    uint256 public tokenPerUsd = 300300000000000000000;
    ...
    constructor() {
        owner = payable(0xc35444d4208437DCFCa53C4844BdcBd466b3D2a9);
    ...
    function buyTokenEth() public payable {
        ...
        SMAI.transfer(msg.sender, numberOfTokens);
    ...
    function getContractTokenApproval() external view returns (uint256) {
        return SMAI.allowance(owner, address(this));
    }
}
