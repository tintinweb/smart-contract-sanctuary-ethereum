...
contract PixelNFT is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {

    uint256 internal constant MAX_PIXEL_NFT = 20;

    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
    string public _baseTokenURI;
    constructor(string memory _uri) ERC721("Pixel Raffle NFT", "PRN") {
