...
contract NFTCollectionFactory is IHasRolesContract, Initializable, Gap10000 {
   ...
   */
  event NFTCollectionWithOperatorFiltererCreated(
   ...
   */
  event NFTDropCollectionWithOperatorFiltererCreated(
    address indexed collection,
    address indexed creator,
  ...
  function createNFTCollection(
    ...
    INFTCollectionInitializer(collection).initialize(payable(msg.sender), name, symbol, subscriptionOrRegistrantToCopy);

    emit NFTCollectionWithOperatorFiltererCreated(
      collection,
      msg.sender,
      versionNFTCollection,
      name,
  ...
  function _createNFTDropCollection(
    ...
    // emit NFTDropCollectionWithOperatorFiltererCreated(
    //   collection,
    //   msg.sender,
    //   approvedMinter,
    //   name,
