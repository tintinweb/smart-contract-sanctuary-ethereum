...
contract Munks is Ownable, ERC721r {
    enum PunkAttributeType {SEX, HAIR, EYES, BEARD, EARS, LIPS, MOUTH,
                                FACE, EMOTION, NECK, NOSE, CHEEKS, TEETH}
    ...
    uint public constant costPerToken = 0.0001 ether;
    bool public isMintActive;
    bytes public constant externalLink = "https://cnn.com";
    bool public contractSealed;
    
    bytes constant tokenDescription = "One of 10,000 tokens in the Munks collection.";
    ...
    function constructTokenURI(uint16 tokenId) private view returns (string memory) {
        ...
        bytes memory title = abi.encodePacked("Munk #", tokenId.toString());
    ...
    function tokenImage(uint16 tokenId) public view returns (string memory) {
        ...
        svgBytes.appendSafe('<svg width="1200" height="1200" shape-rendering="crispEdges" xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 24 24" transform="scale(-1, 1) translate(0, 0)"><style>rect{width:1px;height:1px}</style><defs><filter id="roughpaper"><feTurbulence type="fractalNoise" baseFrequency="50" numOctaves="2" /><feBlend in="SourceGraphic" mode="multiply" /></filter></defs>');
        
        svgBytes.appendSafe('<g filter="url(#roughpaper)"><rect x="0" y="0" style="width:100%;height:100%" fill="#5387d4" />');
    ...
    address constant doveAddress = 0xb967e348E1c83a24F50e1dabc539822f6c18e223;
    address constant middleAddress = 0xb967e348E1c83a24F50e1dabc539822f6c18e223;
