...
contract _1984Serum is ERC721Enumerable, Ownable {
  ...
  bool public is_burn_active = false;
  ...
  function mintNFTs(uint256 _count) public payable {
    ...
    uint256 currentBalance = addressToMinted[msg.sender];
    uint256 tokensToMint = _count + currentBalance;
  ...
  function setIsBurnActive(bool newVal) public onlyOwner {
    is_burn_active = newVal;
  }

  function burn(uint256[] calldata ids, uint256 reduxTargetId) external {
    require(is_burn_active, "Burn phase has yet to commence");
