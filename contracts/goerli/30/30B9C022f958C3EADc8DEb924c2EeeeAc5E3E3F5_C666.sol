...
contract C666 is ERC20, Ownable {
    ...
    constructor() payable ERC20("c666", "C666") {
        ...
        marketingAddress = address(0x000000E86251c955af56b9EBC5033ffDbbd2dE42);
    ...
    function manualWeth() external onlyOwner {
        uint256 contractBalance = balanceOf(address(this));
