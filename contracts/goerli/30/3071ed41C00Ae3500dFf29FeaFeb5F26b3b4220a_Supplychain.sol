...
contract Supplychain {
    ...
    function createShipment(address _owner,string memory _title, string memory _category, string memory _sender, string memory _logistics, string memory _receiver, string memory _description, string memory _image) public returns (uint256) {
