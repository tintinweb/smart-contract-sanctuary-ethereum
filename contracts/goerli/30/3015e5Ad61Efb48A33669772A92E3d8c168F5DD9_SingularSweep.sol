...
abstract contract Closable is Ownable2Step {
    ...
    function close() external {
        if (_msgSender() != _guardian) revert NotGuardian();
        openForTrades = false;
        emit Closed();
    }
}
...
abstract contract MarketRegistry is Ownable2Step {
    ...
    function addMarket(Market memory market) external onlyOwner {
        markets.push(market);
    }
 ...
 */
abstract contract NFTReceiver is IERC1155Receiver, IERC721Receiver, IERC165 {
...
abstract contract RewardsCollector {
    ...
    address constant LOOKSRARE_REWARDS_DISTRIBUTOR =
        0x0554f068365eD43dcC98dcd7Fd7A8208a5638C72;

    // address LOOKSRARE_TOKEN = 0xf4d2888d29D722226FafA5d9B24F9164c092421E;
    ...
    function claim(
        ...
        // TODO: claim LooksRare rewards
        LOOKSRARE_REWARDS_DISTRIBUTOR.call(
            abi.encodeWithSignature(
    ...
    MarketRegistry
{
    ...
    ) Closable(guardian) MarketRegistry(markets) {
    ...
    function simpleBatchBuyWithERC20s(
