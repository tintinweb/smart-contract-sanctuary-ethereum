...
import "./utils/Allowlists.sol";
import "./utils/ERC1155Burnable.sol";
import "./utils/Pausable.sol";
import "./libraries/AllowlistsLib.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

/// @author NitroLeague.
contract DriverPerformanceParts is
    ERC1155,
    Mintable,
    ClaimContext,
    Allowlists,
    ...
    Pausable
{
    ...
    uint private constant maxAllowlistTokenID = 4;
    ...
    {
        (uint[] memory ids, uint[] memory amounts) = AllowlistsLib.getTokenIDs(
            _quantity,
            maxAllowlistTokenID
        );
...
library AllowlistsLib {
    function getTokenIDs(uint256 _quantity, uint256 maxAllowlistTokenID)
        internal
        view
        returns (uint[] memory ids, uint[] memory amounts)
    {
