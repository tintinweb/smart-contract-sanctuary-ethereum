 ...
 *
 */
contract BowlineMonsterFood is ERC777 {
    uint256 public BASE_SUPPLY = 500000000000000000000000000;
    address public NFT_STAKING_CONTRACT;
    address public RESERVES_MANAGER;

    /**
     * @dev Mints 50% of BASE_SUPPLY amount of token and transfers them to `the contract itself`.
     *
     */
    constructor(
        string memory name,
        ...
        onlyTokenReserveManager
    {
        require(
            ...
            "Bowline Monster Food: Staking Contract can't be empty"
        );
    ...
    /**
     * @dev Fund Staking Pool ont NFT_STAKING_CONTRACT
     *
     */
    function fundStakingPool() external {
        require(
            balanceOf(NFT_STAKING_CONTRACT) < BASE_SUPPLY / 5,
            "Bowline Monster Food: Staking Reward Pool has enough funds."
        );
        // Mint First batch to Staking contract
        _mint(NFT_STAKING_CONTRACT, BASE_SUPPLY, "", "");
    }
    ...
    modifier onlyTokenReserveManager() {
        require(
            ...
            "Bowline Monster Food: Only Reserves Manager can withdrawal."
        );
        _;
    }
}
