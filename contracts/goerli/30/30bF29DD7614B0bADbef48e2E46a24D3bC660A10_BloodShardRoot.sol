...
import {ERC1155Burnable} from "../shared/ERC1155Burnable.sol";
...
contract BloodShardRoot is ERC1155Burnable, AccessControlMixin, NativeMetaTransaction, ContextMixin, IMintableERC1155 {
    ...
    constructor(
        ...
        _name = name_;
        _symbol = symbol_;
        _setupContractId("BloodShardRoot");
...
import {IERC1155} from "../../shared/interface/IERC1155.sol";
