...
contract TokenSale is Ownable, ReentrancyGuard {
    ...
    event SaleStarted(uint256 tokensPerWeiPublic, uint128 startTime, uint128 publicSaleEnd);
    ...
    uint256 public constant MAX_RAISE = 1 ether;
    ...
    function startSale(uint256 _tokensPerWeiPublic, uint128 _startTime, uint128 _publicEnd) external onlyOwner {
        ...
        require(_startTime > block.timestamp, "Dates");
        ...
        emit SaleStarted(_tokensPerWeiPublic, _startTime, _publicEnd);
    }
    ...
    function purchasePublic() external payable nonReentrant returns (uint256) {
        ...
        require(block.timestamp < publicSaleEnd, "Phase");
