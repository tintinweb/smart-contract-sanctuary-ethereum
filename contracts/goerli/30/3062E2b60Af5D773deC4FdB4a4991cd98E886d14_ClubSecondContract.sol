...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x23793a62DCc8eb457B4e00b676c6765a2762eF28];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x23793a62DCc8eb457B4e00b676c6765a2762eF28;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 2222) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmY9QwoY5Fu2TNuwF7biqmZv44E8GwK7acegKXC6JNTnGo/";
...
// File: contracts/ClubSecondContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ClubSecondContract is RamppERC721A {
    constructor() RamppERC721A("Club Second ", "2ND"){}
}
