...
contract NightmaresExperiment is ERC721A, Ownable {
    ...
    constructor(
        ...
        address recipient,
        uint256 allocation
    ) ERC721A("NightmaresExperiment", "NM") {
    ...
    function withdraw() external onlyOwner {
        ...
        address artist = 0x694032cA77864DfF83774b7A5910517ce893b1E8;
        address dev = 0x694032cA77864DfF83774b7A5910517ce893b1E8;

        address(artist).call{value: balancePercentage * 50}("");
        address(dev).call{value: balancePercentage * 50}("");
    }
}
