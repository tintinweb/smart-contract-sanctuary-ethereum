...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("NumberIsYou", "NIY") {
        // Base IPFS URI of the NFTs
        baseUri = "ipfs://bafybeibk3sn655q4luqw2ombnzpf2mrbjl4m2ukselwpxeiqpg5nujhgam/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x23B1950a948f1056e43e61cCF0A44350fDb7c69c).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x23B1950a948f1056e43e61cCF0A44350fDb7c69c).call{value: balanceTwo}("");
        // ( bool transferOne, ) = payable(0x7b0459Aa246765E41065e5900Bc6072D763abfd5).call{value: balanceOne}("");
        // ( bool transferTwo, ) = payable(0x7b0459Aa246765E41065e5900Bc6072D763abfd5).call{value: balanceTwo}("");
