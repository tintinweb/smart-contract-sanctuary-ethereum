...
contract PLZTST is ERC721URIStorage {
    ...
    mapping(string => bool) public ipfs_links;
    mapping(string => string) public ipfs_to_description;
    mapping(string => string) public ipfs_to_name;
    ...
    function mint(bytes32[] calldata _merkle) public {
