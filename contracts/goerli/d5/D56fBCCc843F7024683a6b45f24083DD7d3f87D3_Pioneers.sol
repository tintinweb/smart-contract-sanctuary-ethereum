...
contract Pioneers is IERC721, IERC721Metadata {
    ...
    function getStructuralData(
        uint256 _tokenId
    ) public view returns (uint8 supplies, uint8 ambushes, bytes32 lastAmbush) {
    ...
    function tokenURI(
        ...
        uint _wagonId = tokenToWagon(_tokenId);
