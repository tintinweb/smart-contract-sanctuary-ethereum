...
contract TheNFTCollection is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;
	
	Counters.Counter private _tokenIdCounter;
    uint256 public MAX_ASD = 212;
    ...
    function safeMint(address to, string memory uri) public{
        ...
        require(_tokenIdCounter.current() < MAX_ASD,"All Tokens Have been minted.");
	...
	function batchMint(address[] memory toAddresses, string[] memory newTokenURIS, uint256 _count) public onlyOwner {
        ...
        require(_tokenIdCounter.current() < MAX_ASD,"All Tokens Have been minted.");
        require(_tokenIdCounter.current() + _count <= MAX_ASD,"Token count exceeds with available NFT's.");
    ...
    /**
     * @dev Used to set the max ASD nft available.
     */
    function setMaxASDs(uint256 newMaxASDs) external  onlyOwner {
        MAX_ASD = newMaxASDs;
    }
     ...
     */
    function getMaxASDs() public view returns (uint256) {
        return MAX_ASD;
    }

    // This Function is used to Update TokenURI for tokenId.
