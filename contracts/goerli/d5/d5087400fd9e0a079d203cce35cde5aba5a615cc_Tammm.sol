...
contract Tammm is ERC20, Ownable, Pausable {
    using SafeMath for uint;

    bool private tradingOpen;

    uint private _initialSupply = 10000 * 10 ** 18;
    ...
    uint private _taxFeePercentSell = 2000; // 100 = 1%
