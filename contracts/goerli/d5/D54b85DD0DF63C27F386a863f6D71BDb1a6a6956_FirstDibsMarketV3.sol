...
error InvalidAssetClass(bytes4 assetClass, uint256 listingId);
    ...
    FirstDibsFeeSupport
{
    ...
    function initialize(
        ...
        AccessControlUpgradeable._setupRole(DEFAULT_ADMIN_ROLE, ContextUpgradeable._msgSender()); // deployer of the contract gets admin permissions
    ...
    function createListing(
        ...
        address validSeller = _getValidSeller(_tokenContract, _tokenId, _quantity, _assetClass);
        ...
        _listings[_listingIdCounter].assetClass = _getValidAssetClass(_assetClass);
    ...
    function purchaseFromListing(
        ...
        if (listing.assetClass == ERC721_ASSET_CLASS) {
            ...
            if (_listings[_listingId].quantity == 0) {
                // Remove the listing from state if there are no more tokens left for sale
                _removeSellerListing(listing.seller, _listingId);
            }
        }
    ...
    function _getValidSeller(
        ...
        if (_assetClass == ERC721_ASSET_CLASS) {
            ...
            revert InvalidAssetClass({ assetClass: _assetClass, listingId: 0 });
        }
    }
    ...
    /**
     * @dev Set the assetClass on the listing
     * @param _assetClass The assset class to validate
     */
    function _getValidAssetClass(bytes4 _assetClass) private pure returns (bytes4) {
...
contract FirstDibsFeeSupport is Initializable, AccessControlUpgradeable, PullPaymentUpgradeable {
     ...
     * @param amount The amount of royalty paid
     */
    event RoyaltyPayout(
        uint256 listingId,
        uint256 orderId,
