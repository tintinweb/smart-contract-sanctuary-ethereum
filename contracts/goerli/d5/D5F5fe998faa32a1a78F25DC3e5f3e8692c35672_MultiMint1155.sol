...
contract MultiMint1155 is ERC1155, Signable, IERC2981, AccessControl {
    ...
    function minterMint(
        ...
        _mintLogic(to, tokenId, amount, data);
    }
    ...
    function mint(
        ...
        _mintLogic(msg.sender, tokenId, amount, data);
    }
    ...
    function _mintSignLogic(
        ...
        for (uint i = 0; i < tmpArgsArr.length; ) {
            ...
            _mintLogic(msg.sender, tmpArgs.tokenId, tmpArgs.amount, tmpData);
    ...
    function _mintLogic(
        ...
        if (minted[to][tokenId] + amount > getMaxMintPerToken(tokenId)) {
