...
uint256 public constant tokensPerEth = 100;
  ...
  function buyTokens() public payable {
      ...
      require(yourToken.balanceOf(address(this)) >= msg.value * tokensPerEth, "Not enough tokens.");
  ...
  function sellTokens(uint256 amount) public {
    require(amount > 0, "Value can not be 0 ...");
    require(yourToken.balanceOf(msg.sender) >= amount, "Not enough tokens.");
    require(address(this).balance > amount/tokensPerEth, "Not enough ETH ...");
    (bool sent) = yourToken.transferFrom(msg.sender, address(this), amount);
    require(sent, "something went wrong ...");
    (bool ethSent, ) = msg.sender.call{value: amount/tokensPerEth }("");
