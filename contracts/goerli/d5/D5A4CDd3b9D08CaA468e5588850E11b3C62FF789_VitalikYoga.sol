...
contract VitalikYoga is ERC721A, Ownable, ReentrancyGuard {
    ...
    mapping(address => uint256) public YogaPractitioner;
    uint256 public yogaFee;
    uint256 public maxYogaPractitioner;
    uint256 public maxMintAmountPerTx = 5;
    bool public freeMintpaused = false;
    bool public paused = false;
    uint256 public freeMintPerWallet = 1;

    string public baseURI = "ipfs.io/ipfs/QmZY4dMc7qacduA9dgSUHAx8fjsurRERhDaUfEYJJuGqLd/";
    ...
    constructor(
        ...
        yogaFee = 0.005 ether;
        maxYogaPractitioner = 5000;
    }

    modifier mintValidation(uint256 _mintAmount) {
        require(
            YogaPractitioner[msg.sender] <= maxMintAmountPerTx,
            "Invalid mint amount!"
        );
        require(
        ...
        require(
            totalSupply() + _mintAmount <= maxYogaPractitioner,
            "Max supply exceeded!"
        );
        _;
    }
