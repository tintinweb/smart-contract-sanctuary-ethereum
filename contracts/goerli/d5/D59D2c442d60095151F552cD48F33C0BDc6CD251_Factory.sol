    ...
    UUPSUpgradeable
{
    ...
    function deposit(
      ...
      console.log(indexAddressArray[id]);
       ...
       uint indexdepositamount= amount-fees;
        ...
        IndexInterface(indexAddressArray[id]).deposit(indexdepositamount,msg.sender);
    }
    ...
    function distributeamount(uint id) public onlyOwner{

        IndexInterface(indexAddressArray[id]).distributeamount();
    }


    function getAmountsBytesData(uint id) public view onlyOwner returns(bytes[] memory) {

       return IndexInterface(indexAddressArray[id]).getAmountsBytesData();
    }

   function stake(uint id,address target,
        string calldata _func,
        bytes[] memory _data) public  onlyOwner  {

     IndexInterface(indexAddressArray[id]).stake(target,_func,_data);
    }

    function approvetokens(uint id,address _stakingContract) public onlyOwner{
