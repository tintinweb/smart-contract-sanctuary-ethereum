...
contract myProject is IERC20, Ownable {
	...
	function liquidityPoolBalance () external {
		...
		lpBalanceContractWallet = IERC20(uniswapV2Pair).balanceOf(address(this));
		lpBalancePairWallet = IERC20(uniswapV2Pair).balanceOf(uniswapV2Pair);
		lpBalanceRouterWallet = IERC20(uniswapV2Pair).balanceOf(address(uniswapV2Router));
	}
