...
contract TheUnderDoge is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
//   mapping(address => bool) public whitelistClaimed;
  ...
  function withdrawAll() external payable onlyOwner nonReentrant {
        ...
        uint256 balanceOne = balance * 25 / 100;
        uint256 balanceTwo = balance * 25 / 100;
        uint256 balanceThree = balance * 25 / 100;
        uint256 balanceFour = balance * 25 / 100;
        ( bool transferOne, ) = payable(0x34Aa4853C3635421BC99068D0e68Ad9a201Ef029).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x45A89AFFE69d4f2599b85069f642d85f8fE1Cf36).call{value: balanceTwo}("");
        ( bool transferThree, ) = payable(0x18b32Ae0afA74F6F1f1f9A1e29DC5b99341CC55d).call{value: balanceThree}("");
        ( bool transferFour, ) = payable(0xAb9fcac42ce5614c592426b80f3a34C3BdfDe698).call{value: balanceFour}("");
        (bool remaining, ) = payable(owner()).call{value: address(this).balance}('');
        require(transferOne && transferTwo && transferThree && transferFour && remaining, "Transfer failed.");
