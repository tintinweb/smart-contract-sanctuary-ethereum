...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 600 && newClaimWait <= 86_400, "claimWait must be updated to between 10 minutes to 24 hours");
...
contract DM is ERC20, Ownable {
    ...
    constructor() payable ERC20("Dollar Mission", "DM") {
        ...
        marketingWallet = 0xA8933C91d793EE2bC34774FFfcB5435396A9923E;
