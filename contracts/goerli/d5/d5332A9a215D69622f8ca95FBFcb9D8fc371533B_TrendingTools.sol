...
/**
     Trending Tools is a unique DEFI project with a vision to support all active crypto holders and blockchain projects out in the crypto space.

     Project utilities:
     Investments, fully functional and live utility bots (Raid bot and burn bot) and Passive income
...
contract TrendingTools is ERC20, Ownable {
    ...
    constructor() ERC20("Trending Tools", "TTools") {
