...
import "./generated/deploy/BaseCedarDeployerV0.sol";
import "./CedarERC721PremintV0Factory.sol";
import "./drop/CedarERC721DropV0Factory.sol";

contract CedarDeployerV0 is Initializable, UUPSUpgradeable, OwnableUpgradeable, BaseCedarDeployerV0 {
    CedarERC721PremintV0Factory premintV0Factory;
    CedarERC721DropV0Factory dropV0Factory;

    function initialize(CedarERC721PremintV0Factory _premintV0Factory, CedarERC721DropV0Factory _dropV0Factory) public initializer {
        premintV0Factory = _premintV0Factory;
        dropV0Factory = _dropV0Factory;
        __Ownable_init();
    }

    function reinitialize(CedarERC721PremintV0Factory _premintV0Factory, CedarERC721DropV0Factory _dropV0Factory) public onlyOwner {
        premintV0Factory = _premintV0Factory;
        dropV0Factory = _dropV0Factory;
    }
    ...
    function deployCedarERC721PremintV0(
    ...
    ) external override returns (ICedarERC721PremintV0) {
        CedarERC721PremintV0 newContract = premintV0Factory.deploy(
            adminAddress,
            _name,
            _symbol,
            _maxLimit,
        ...
        emit CedarInterfaceDeployed(address(newContract), major, minor, patch, "ICedarERC721PremintV0");
        return newContract;
    }
    ...
    function deployCedarERC721DropV0(
        ...
        uint128 _royaltyBps,
        string memory _userAgreement
    ) external override returns (ICedarERC721DropV0 newContract) {
        newContract = dropV0Factory.deploy(_defaultAdmin, _name, _symbol, _contractURI, _trustedForwarders, _saleRecipient, _royaltyRecipient, _royaltyBps, _userAgreement);

        (uint256 major, uint256 minor, uint256 patch) = newContract.implementationVersion();
        emit CedarInterfaceDeployed(address(newContract), major, minor, patch, "ICedarERC721DropV0");
    }
    ...
    returns (
        ...
        return premintV0Factory.implementationVersion();
    }
    ...
    returns (
        ...
        return dropV0Factory.implementationVersion();
    }
...
// Filename: './BaseCedarDeployerV0.sol'
...
abstract contract BaseCedarDeployerV0 is ICedarDeployerV0 {
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165).interfaceId) || ((interfaceID == type(ICedarVersionedV0).interfaceId) || (interfaceID == type(ICedarDeployerEventsV0).interfaceId));
    }
}
...
import "@openzeppelin/contracts/proxy/Clones.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "./CedarERC721DropV0.sol";
import "../api/deploy/ICedarDeployer.sol";
import "../SignatureVerifier.sol";

contract CedarERC721DropV0Factory is Ownable, ICedarDeployerEventsV0, ICedarImplementationVersionedV0 {
    CedarERC721DropV0 public implementation;
    address public greenlistManagerAddress;
    ...
    constructor(address _greenlistManagerAddress) {
        greenlistManagerAddress = _greenlistManagerAddress;
        // Deploy the implementation contract
        implementation = new CedarERC721DropV0();
        implementation.initialize(_msgSender(), "default", "default", "", new address[](0), address(0), address(0), 0, "", address(0), address(0));
        (uint256 major, uint256 minor, uint256 patch) = implementation.implementationVersion();
        emit CedarImplementationDeployed(address(implementation), major, minor, patch, "CedarERC721DropV0");
    }

    function emitEvent(
        EventParams memory params
    ) private {
        emit CedarERC721DropV0Deployment(params.contractAddress, params.majorVersion, params.minorVersion, params.patchVersion, params.defaultAdmin, params.name, params.symbol, params.contractURI, params.trustedForwarders, params.saleRecipient, params.royaltyRecipient, params.royaltyBps, params.userAgreement);
    }
    ...
    function deploy(
        ...
        uint128 _royaltyBps,
        string memory _userAgreement
    ) external onlyOwner returns (CedarERC721DropV0 newClone) {
        newClone = CedarERC721DropV0(Clones.clone(address(implementation)));
        SignatureVerifier signatureVerifier = new SignatureVerifier(_userAgreement, "_", "_");
...
interface ICedarVersionedV0 is ICedarImplementationVersionedV0, ICedarMinorVersionedV0, IERC165 {
}
...
abstract contract BaseCedarERC721PremintV0 is ICedarERC721PremintV0 {
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165).interfaceId) || ((interfaceID == type(ICedarFeaturesV0).interfaceId) || ((interfaceID == type(ICedarVersionedV0).interfaceId) || ((interfaceID == type(ICedarPremintV0).interfaceId) || ((interfaceID == type(ICedarAgreementV0).interfaceId) || (interfaceID == type(IMulticallableV0).interfaceId)))));
    }
