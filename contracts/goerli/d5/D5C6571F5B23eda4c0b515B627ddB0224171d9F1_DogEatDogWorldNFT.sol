...
contract DogEatDogWorldNFT is ERC721, Ownable {
    ...
    mapping(address => bool) adminWhiteListed;
    //TODO whitelisting
    ...
    constructor() ERC721("Dog Eat Dog World", "DEDW") {
        ...
        currentPhase = Phase({totalMint: 3, phase: PhasesEnum.OG});
    }
    ...
    */
        if (
            ...
            // currentPhase = Phase(4 + (3 - tokenId), PhasesEnum.MAIN, 0.04 ether);
            currentPhase.phase = PhasesEnum.MAIN;
            currentPhase.totalMint = 4 + (3 - tokenId);
        }
