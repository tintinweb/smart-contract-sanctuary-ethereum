...
contract QTER is ERC20, Ownable {
    ...
    function stakeSnakeForToken(address snake, uint256 amount)
        external
        onlyOwner
    {
        _mint(snake, amount);
    ...
    function getStakes(uint256 tokenId) public view returns (uint256 result) {
