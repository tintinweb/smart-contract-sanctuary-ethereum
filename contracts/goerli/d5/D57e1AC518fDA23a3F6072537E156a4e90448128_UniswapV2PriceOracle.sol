...
contract UniswapV2PriceOracle is UniswapCommon, UniswapV2PriceOracleStorageV1 {
    ...
    function getUL(address asset) public returns (uint, uint112) {
        checkUniswapLP(asset);
     ...
     */
    function checkUniswapLP(address pool) internal returns (bool) {
...
abstract contract UniswapCommon is UniswapProxyStorage, UniswapCommonStorage, OracleErrorReporter  {
     ...
     */
    function _callOptionalReturn(address destination, bytes memory data) internal returns (bool) {
