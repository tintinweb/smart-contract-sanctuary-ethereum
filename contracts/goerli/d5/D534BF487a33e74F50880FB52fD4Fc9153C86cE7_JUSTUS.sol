...
contract JUSTUS is ERC721A, Ownable {
  ...
  string private baseTokenURIPrereveal = 'ipfs://bafkreiafxg5eh5gagqxkny7nkh2flwo4kbjakczafvuo2xbpqx4sq4j6be';
  string private baseTokenURI;
  bool private _paused = false;
  bool private _wlPeriod = true;
  bool private revealed = false;
  address private constant freeMintWallet = 0x4C83C661C52647Bcd04362da24F0F137A55E9069;
  ...
  function setBaseURIPrereveal(string calldata baseURI) external onlyOwner {
    baseTokenURIPrereveal = baseURI;
  }

  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        if (!_exists(tokenId)) revert URIQueryForNonexistentToken();
        if (!revealed) return baseTokenURIPrereveal;
        string memory baseURI = _baseURI();
