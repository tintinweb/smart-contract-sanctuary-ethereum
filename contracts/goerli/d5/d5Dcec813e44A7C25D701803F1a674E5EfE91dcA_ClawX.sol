...
contract ClawX is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1087620 * 10**_decimals;
    string private constant _name = unicode"ClawX";
    string private constant _symbol = unicode"CLAX";
