...
contract Test is ERC721ACommon, LinearDutchAuction, BaseTokenURI {
    ...
    constructor(
        ...
        ERC721ACommon("Test", "TST", beneficiary, 1000)
        BaseTokenURI("ar://nDOtal12l3VMlB-Lx8khjWDI0XpxydEn7fmpnO2UmEw/")
        LinearDutchAuction(
            LinearDutchAuction.DutchAuctionConfig({
                startPoint: block.timestamp, // For testing purposes we use the block.timestamp when deploying, but later It will be set manually.
                startPrice: 0.0002 ether,
                unit: AuctionIntervalUnit.Time,
                decreaseInterval: 60, // 10 minutes --> 600sec
                decreaseSize: 0.00001 ether,
                numDecreases: 18
            }),
            0.00002 ether,
            Seller.SellerConfig({
    ...
    {
        setContractURI("https://api.jsonstorage.net/v1/json/ee014a52-3201-470f-83c1-15264c0dba57/9e7ed39f-92ba-43b6-8384-f2ba778842f3");
    }
