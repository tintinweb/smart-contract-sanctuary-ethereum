...
// hevm: flattened sources of src/tokens/TokenWrapper.sol
...
contract TokenWrapper is ITokenWrapper, ERC20 {
    ...
    function doWrap(address gal, uint256 value) private {
        ...
        uint256 wad = DSMathCustom_3.wad(value);
        require(
            totalSupply().add(wad) <= DSMathCustom_3.wad(token.getBalance(address(this))),
