...
contract NFTApp is ERC721A, Ownable {
    ...
    constructor() ERC721A("NFTApp", "NA") {
        setHiddenMetadataUri(
            "ipfs://QmcyWHCppM5Na2RL3enTQBFc5k8bY5yFgKVtF1AgtGRuje"
        );
    }
        ...
        onlyOwner
    {
        ...
        uint256 totalPerWallet = perWallet[_receiver] + _mintAmount;
        require(
            totalPerWallet <= maxPerWallet,
            "Max Procrastinators per wallet"
        );
        ...
        perWallet[_receiver] += _mintAmount;
    }
    ...
    function startStage3() public onlyOwner {
        ...
        paused = true;
        uint256 totalMinted = totalSupply();
        maxSupply = totalMinted + 8500;
        mintCost = 0.015 ether;
        stage = 3;
    }
}