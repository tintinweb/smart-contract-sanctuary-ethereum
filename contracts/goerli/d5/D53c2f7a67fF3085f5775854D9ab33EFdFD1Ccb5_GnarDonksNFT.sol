    ...
    ERC2981
{
    ...
    function releasable(address token, address account) external returns (uint256 total) {
...
import "./meta-transactions/Math.sol";
 ...
 */
abstract contract ERC2981 is IERC2981, ERC165, Math {
    struct RoyaltyInfo {
        address receiver;
