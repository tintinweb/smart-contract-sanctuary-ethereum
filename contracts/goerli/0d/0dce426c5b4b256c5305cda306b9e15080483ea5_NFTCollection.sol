...
contract NFTCollection is DefaultOperatorFilterer, ERC721Enumerable, Ownable, ERC2981 {
    ...
    address public constant WITHDRAW_ADDRESS = 0x8D2857E6B2f9dF6981cf18C1079250132a39E78f;

    string public baseTokenURI;

    constructor(string memory baseURI, string memory name, string memory symbol) ERC721(name, symbol) {
        setBaseURI(baseURI);
        _setDefaultRoyalty(WITHDRAW_ADDRESS, 50); // Default Royalty is 5% if a NFT Platform supports ERC-2981
    }
