...
contract LFiFarms2 is AccessControlUpgradeable {
    ...
    function setRewardToken(address _tokenAdress) external onlyRole(MANAGER_ROLE) {
        reward = IERC20Upgradeable(_tokenAdress);
    }
