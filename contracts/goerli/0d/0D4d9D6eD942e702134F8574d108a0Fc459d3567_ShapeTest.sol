...
contract ShapeTest is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("ShapeTest", "ST") {
  ...
  function mint() public payable nonReentrant {
    ...
    require(msg.value >= PRICE, "Insufficient payment, 0.001 ETH per item");
  ...
  function withdraw() public nonReentrant {
    ...
    Address.sendValue(payable(owner()), balance * 80 / 100);
