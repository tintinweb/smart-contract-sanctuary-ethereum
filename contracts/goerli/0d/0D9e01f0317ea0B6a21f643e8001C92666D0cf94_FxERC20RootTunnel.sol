...
contract FxERC20RootTunnel is FxBaseRootTunnel, Create2 {
    ...
    function setRootToChildTokens(address rootToken, address childToken) external {
        require(ownerAddress == msg.sender, "FxERC20RootTunnel: can not set root To child token");
        rootToChildTokens[rootToken] = childToken;
    }
}
