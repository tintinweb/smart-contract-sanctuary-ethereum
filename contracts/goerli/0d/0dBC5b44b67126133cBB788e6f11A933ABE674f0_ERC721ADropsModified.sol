...
contract ERC721ADropsModified is ERC721A, Ownable, BatchMintMetadata, ContractMetadata, Multicall {
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        //require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "Mint limit reached");
