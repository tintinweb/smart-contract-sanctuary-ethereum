...
import {ERC721} from "../shared/ERC721.sol";
import {ERC721Burnable} from "../shared/ERC721Burnable.sol";
import {AccessControlMixin} from "../shared/AccessControlMixin.sol";
import {NativeMetaTransaction} from "../shared/NativeMetaTransaction.sol";
import {IMintableERC721} from "./shared/IMintableERC721.sol";
import {ContextMixin} from "../shared/ContextMixin.sol";


contract Gen0Root is ERC721Burnable, AccessControlMixin, NativeMetaTransaction, IMintableERC721, ContextMixin {

    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    constructor(string memory name_, string memory symbol_) public ERC721(name_, symbol_) {
        _setupContractId("Gen0Root");
...
import "./library/EnumerableMap.sol";
...
import {IERC721} from "../../shared/interface/IERC721.sol";
