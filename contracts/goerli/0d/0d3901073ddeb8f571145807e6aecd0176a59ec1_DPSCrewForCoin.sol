...
contract DPSCrewForCoin is IERC721Receiver, Ownable, ReentrancyGuard {
    ...
    function redeemDPS(uint256 _tokenId) external nonReentrant {
        ...
        if (lDPS.ownerOf(_tokenId) == address(this) || lDPS.ownerOf(_tokenId) == asset.lender) {
            burned = true;
            lDPS.burn(_tokenId);
        }
    ...
    function redeemFlagship(uint256 _tokenId) external nonReentrant {
        ...
        if (lFlagship.ownerOf(_tokenId) == address(this) || lFlagship.ownerOf(_tokenId) == asset.lender) {
            burned = true;
    ...
    function setDoubloonsForTreasuryPercentage(uint16 newDoubloonsForTreasuryPercentage) external onlyOwner {
        if (newDoubloonsForTreasuryPercentage > 1_000) {
            revert InvalidDoubloonsForTreasuryPercentage();
        }
        doubloonsForTreasuryPercentage = newDoubloonsForTreasuryPercentage;
        emit SetDoubloonsForTreasuryPercentage(newDoubloonsForTreasuryPercentage);
    }
    ...
    event SetDoubloonsForTreasuryPercentage(uint256 newDoubloonsForTreasuryPercentage);
