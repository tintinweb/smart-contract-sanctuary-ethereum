...
contract Mooks is ERC721A, Ownable, ReentrancyGuard {
    ...
    function mint(uint256 amount) external payable
    {
        ...
        if(WalletMint[msg.sender] < claimFree) 
        {
           ...
           require(msg.value >= (amount - claimFree) * mintPrice,"Insufficient Funds");
            WalletMint[msg.sender] += amount;
           _safeMint(msg.sender, amount);
        }
        else
        {
           require(msg.value >= amount * mintPrice,"Insufficent Funds");
            WalletMint[msg.sender] += amount;
           _safeMint(msg.sender, amount);
        }
    }
