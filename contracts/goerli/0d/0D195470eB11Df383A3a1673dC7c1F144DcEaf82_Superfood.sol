...
contract Superfood is ERC721A, Ownable , Royalties {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 10000;
    uint256 public constant PRICE_PER_NFT = 0.00008 ether;
    uint256 public constant DISCOUNT_PRICE = 0.0000008 ether;
    bool public isWhitelist = true;
    mapping (address => bool) public whitelisted;

    constructor() ERC721A("Superfood NFT", "SNFT") {
        whitelisted[_msgSender()] = true;
        _setDefaultRoyalty(_msgSender(), 900);
    }

    function mintNFT(address to , uint256 quantity) public payable{
        require(_currentIndex < MAX_SUPPLY , "All tokens minted"); 
        require(quantity != 0 && getPrice(_msgSender()) * quantity == msg.value , "in correct ethereum supply"); 
             _mint(to , quantity);
