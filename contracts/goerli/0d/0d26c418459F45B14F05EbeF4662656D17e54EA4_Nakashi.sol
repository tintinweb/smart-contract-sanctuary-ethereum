...
contract Nakashi is ERC721URIStorage, RoyaltiesV2Impl, VRFConsumerBaseV2 {
    ...
    address public OWNER = 0x11159a7d3F8a8cd35305dAF5751828Cb9C3c8E4a;
    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;
        ...
        ERC721("Nakashi Manga", "NM")
    {
        ...
        for (uint8 i = 0; i < packs.length; i++) {
            ...
            s_randomWords = [
                21321312223123134567676868672133654654757676587867989098089070898707800421332
            ];
    ...
    function mint() public payable {
        ...
        uint256 randWord = (s_randomWords[0] % packs.length) + 1;
        _Newmint(packs[randWord]);
        requestRandomWords();
    }
