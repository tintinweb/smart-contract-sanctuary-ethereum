...
contract Marketplace {
    ...
    function getMintedInfo() public view returns (uint256, uint256, uint256, uint256) {
        return (typeMinted[msg.sender].silver, typeMinted[msg.sender].gold, typeMinted[msg.sender].platinum, typeMinted[msg.sender].diamond);
    }
