...
function addLiquidity(
    ...
    function removeLiq(uint amountLP,string memory _tokenName) internal returns(uint256 token0,uint256 token1) {
...
contract Staking is Migrate{
    ...
    function claimFund(uint _tokenID) external {
        ...
        retrieveNFT(_tokenID,checkPart[_tokenID].sender);
        checkPart[_tokenID].staked = false;
