...
contract BoredPunkYachtClub is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI;
    uint public price = 0.000000000000000003 ether;
    ...
    constructor(address _adminOne, address _adminTwo, string memory _baseUri) ERC721A("Bored Punk Yacht Club", "BPYC"){
        adminOne = _adminOne;
        adminTwo = _adminTwo;
        baseURI = _baseUri;
    }
    ...
    function mint(uint256 count) external payable {
        ...
        require(msg.value >= (count * price) - ((maxPerFree - _mintedFreeAmount[msg.sender]) * price), "Please send the exact ETH amount");
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        (bool secondSucces, ) =  address(adminTwo).call{value: address(this).balance / 2}("");
