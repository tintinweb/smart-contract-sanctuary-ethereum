...
contract CRI is ERC20, Ownable {
    ...
    constructor() ERC20("Crypto Relief Inu", "CRI") {
        ...
        uint256 totalSupply = 100_00_000 * 1e18; // iluvw foxh (719)

        maxTransactionAmount = 1_50_000 * 1e18; // 1.5%
        maxWallet = 3_00_000 * 1e18; // 3%
        ...
        devWallet = address(0x2CD4dD6cd149DA75F687f0190b53e5f53315b693); // set as dev wallet
