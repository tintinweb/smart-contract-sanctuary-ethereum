...
contract DirtFounder is ERC721ABurnable, ERC721AQueryable, AccessControlEnumerable {
    ...
    function mintFounderAllowList(uint256 quantity) external payable {
        ...
        require(allowList[msg.sender] >= quantity, "Exceed allowlist mint");
    ...
    /// @dev only run once per address to avoid overide quanitity
    function seedAllowList(address[] calldata addresses, uint256 quanitity) external onlyRole(DEFAULT_ADMIN_ROLE) {
