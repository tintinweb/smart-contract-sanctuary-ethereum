...
{    
    ...
    MintPass public MintPassSale = MintPass(
        ...
        1663108200, // [3] -> _StartingBlockUnixTimestamp
        677,        // [4] -> _SecondsBetweenPriceDecay
        false,       // [5] -> _ActivePublic
        true,      // [6] -> _ActiveBrightList
        0xc000a33d5d3f892b84e50d56b81cc07e0a4f7ea363e4a2604bb72b39c6926d6d
    ); 
    MintPack public MintPackSale = MintPack(
        ...
        false,       // [5] -> _ActivePublic
        true,      // [6] -> _ActiveBrightList
        0x2ae7b007e7023d92459c40ee2059296989f8691ba44d468001ac195ec0ce0616
    );
    ...
    mapping(address=>bool) public Role;                        // `Wallet` => `Enabled Minter`

    string public baseURI = "ipfs://IPFS_HASH/";
    uint[] public MintPackStartingIndexes;
    bool public OptionsActive;
    address public Option = 0xb47a1C8DEeF716a37D4B26d8BC52C70e5DB63564;
    address public _BRT_MULTISIG = 0x2596a3df23725F1F2DfaDAf4a132175165aB6744;  
    address public _LiveMint = 0x457Db3137258322d2571b76c1E75488a7d5B05B9;
    ...
    event ArtistNamesSeeded(string[] Names, string TxHashLink);
    ...
    event RandomArtistIDsSeeded(uint[] NewArtistIDs, string TxHashLink);
    ...
    { 
        ...
        _WalletAllocationsMintPass[0x4191933782DC9EF12d18F832670dFE021179d891] = 60;
        _WalletAllocationsMintPass[0x18B7511938FBe2EE08ADf3d4A24edB00A5C9B783] = 65;
        _WalletAllocationsMintPass[0x91594b5E5d74FCCB3f71674eE74C5F4D44f333D5] = 77;
        _WalletAllocationsMintPass[0xc375A30913B61b0d7750aB613cDd8793AaBa9272] = 30;
        _WalletAllocationsMintPass[0x062Eed02C619FB9Fd5D3Bbc07a1e56f1C550D5e5] = 30;
        _WalletAllocationsMintPass[0xB8559AF91377e5BaB052A4E9a5088cB65a9a4d63] = 69;
        _WalletAllocationsMintPass[0x65d674F2220Fa844c1e390AAf6739eC07519146E] = 25;
        _WalletAllocationsMintPass[0x4Aa23d4684ddc1D97D777FacdE06aa85E69bBb66] = 24;
        _WalletAllocationsMintPass[0x6d956FC4774A4057b3Cf8f548ee69eC616bC8A60] = 20;
        _WalletAllocationsMintPass[0x53b1bC8E7694C0F6a6a2961e94a537cE0953C2e4] = 45;
        _WalletAllocationsMintPass[0x1a9304153F41d492d2E278Cc2c13CB6989cEbdc0] = 65;
        _WalletAllocationsMintPass[0x66716B476C1d24C0d229748daa4C023E252eBAA7] = 20;
        _WalletAllocationsMintPass[0xf69d9E01f4155111f859b138d869B63340d6032f] = 20;
        _WalletAllocationsMintPass[0xB211F7b941d4c6feC843D39741f69bcA297fc939] = 20;
        _WalletAllocationsMintPass[0x1423255C13DC5686cA09575D42205B794148b7c5] = 14;

        _WalletAllocationsMintPack[0x38E27a59d3cffB945aC8d41b7c398618354c08F6] = 10;
        _WalletAllocationsMintPack[0x4191933782DC9EF12d18F832670dFE021179d891] = 10;
        _WalletAllocationsMintPack[0x18B7511938FBe2EE08ADf3d4A24edB00A5C9B783] = 10;
        _WalletAllocationsMintPack[0x91594b5E5d74FCCB3f71674eE74C5F4D44f333D5] = 10;
        _WalletAllocationsMintPack[0xc375A30913B61b0d7750aB613cDd8793AaBa9272] = 10;
        _WalletAllocationsMintPack[0x062Eed02C619FB9Fd5D3Bbc07a1e56f1C550D5e5] = 10;
        _WalletAllocationsMintPack[0xB8559AF91377e5BaB052A4E9a5088cB65a9a4d63] = 10;
        _WalletAllocationsMintPack[0x65d674F2220Fa844c1e390AAf6739eC07519146E] = 10;
        _WalletAllocationsMintPack[0x4Aa23d4684ddc1D97D777FacdE06aa85E69bBb66] = 10;
        _WalletAllocationsMintPack[0x6d956FC4774A4057b3Cf8f548ee69eC616bC8A60] = 10;
        _WalletAllocationsMintPack[0x53b1bC8E7694C0F6a6a2961e94a537cE0953C2e4] = 10;
    ...
    function PurchasePack(uint Amount, bytes32[] calldata Proof) external payable nonReentrant
    {
        ...
        MintPackStartingIndexes.push(_totalMinted());
     ...
     */
    function __SeedRandomArtistIDs(uint[] calldata NewArtistIDs, string calldata TxHashLink) external onlyOwner
    {
        unchecked
        {
            ...
            emit RandomArtistIDsSeeded(NewArtistIDs, TxHashLink);
        }
    }
     ...
     */
    function __SeedRandomArtistNames(string[] calldata Names, string calldata TxHashLink) external onlyOwner
    {
        for(uint x; x < Names.length; x++) 
        { 
            ArtistNames[x] = Names[x]; 
        }
        emit ArtistNamesSeeded(Names, TxHashLink);
    }
     ...
     * @dev Returns A Wallet's Owned `TokenIDs` & Corresponding `ArtistIDs`
     */
    function ViewWalletOptionHoldings(address Wallet) public view returns (uint[] memory, uint[] memory)
    {
        unchecked
        {
