...
contract RandomTest7 is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("RandomTest7", "RandomTest7"){}
...
uint[] public winnersList; 
    ...
    function getItems() external view returns(uint[] memory) {
        return winnersList;
