...
contract PageOracle is Initializable, OwnableUpgradeable, IPageOracle {
     ...
     * @param _uniV3Pool Address of our pool contract
     */
    function initialize(address _token, address _uniV3Pool) public initializer {
        __Ownable_init();
        require(_token != address(0), "PageOracle: wrong address");
        require(_uniV3Pool != address(0), "PageOracle: wrong address");

        PAGE_TOKEN = _token;
        pool = IUniswapV3Pool(_uniV3Pool);
