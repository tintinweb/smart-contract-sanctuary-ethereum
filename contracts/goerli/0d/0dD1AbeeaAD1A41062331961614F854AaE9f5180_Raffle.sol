...
// Enter into lottery after paying some amount
// Pick a random winner (varifiably random)
// Winner to be selected every X minutes -> completely atomated
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    uint16 private constant REQUEST_CONRIFMATIONS = 3;
     ...
     * they look for `updateUpKeep` to return true.
