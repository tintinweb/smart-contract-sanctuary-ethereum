...
contract NFT is ERC721, Ownable {
    ...
    function setUnrevealedUrl(string memory _unrevealedURI) public onlyOwner{
        unrevealedURI = _unrevealedURI;
    }

    function setRevealedUrl(string memory _revealedURI) public onlyOwner{
    ...
    function mint() public payable {
        require(_tokenIds.current() < maxAmount, "exceed max amount");
