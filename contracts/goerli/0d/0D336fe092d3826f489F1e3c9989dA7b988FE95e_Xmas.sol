...
contract Xmas is ERC721Tradable {
    ...
    constructor(address _proxyRegistryAddress) ERC721Tradable("DonateXMas", "XMAS", _proxyRegistryAddress) {
        ...
        // Icons
            ...
            ICON_NAMEs[2]  =  '{"trait_type":"Icon","value":"Star 1"}]}';
            ...
            ICON_NAMEs[13] =  '{"trait_type":"Icon","value":"Snowflake"}]}';
            ICON_NAMEs[14] =  '{"trait_type":"Icon","value":"Mountains"}]}';
            ICON_NAMEs[15] =  '{"trait_type":"Icon","value":"Star 2"}]}';
            ICON_NAMEs[16] =  '{"trait_type":"Icon","value":"Hat 2"}]}';
            ...
            // Snowflake
                ICONS[13][1] = '<circle fill="';
                ICONS[13][2] = '" transform="rotate(90 750 500)" cx="750" cy="500" r="250"/><circle fill="';
                ICONS[13][3] = '" transform="rotate(90 250 500)" cx="250" cy="500" r="250"/><circle fill="';
                ICONS[13][4] = '" cx="500" cy="250" r="250"/><circle fill="';
                ICONS[13][5] = '" cx="500" cy="750" r="250"/>';

            // Mountains
                ICONS[14][1] = '<path fill="';
                ICONS[14][2] = '" d="m500 1 500 500H0z"/><path fill="';
                ICONS[14][3] = '" d="m500 501 500 500H0z"/><path d="m500 1 250 250H250zM333.333 334l-83.334-83h166.667zm333.334 0-83.333-83h166.667zM500 334l-83.333-83h166.666z" fill="';
                ICONS[14][4] = '"/><path d="m500 501 250 250H250zM333.333 834l-83.334-83h166.667zm333.334 0-83.333-83h166.667zM500 834l-83.333-83h166.666z" fill="';
                ICONS[14][5] = '"/>';

            // Star 2
                ICONS[15][1] = '<g fill="';
                ICONS[15][2] = '"><circle cx="962.963" cy="500" r="37.037"/><circle cx="37.037" cy="500" r="37.037"/></g><g fill="';
                ICONS[15][3] = '"><circle cx="500" cy="37.037" r="37.037"/><circle cx="500" cy="962.963" r="37.037"/></g><path fill="';
                ICONS[15][4] = '" d="m499.926 74 76.24 241.865 224.935-117.114-117.116 224.934 241.867 76.24-241.866 76.241 117.115 224.935-224.935-117.115-76.24 241.866-76.241-241.866L198.75 801.101l117.115-224.935L74 499.926l241.865-76.241-117.114-224.934 224.934 117.115z"/><path fill="';
                ICONS[15][5] = '" />';
                
            // Hat 2
                ICONS[16][1] = '<path class="color_1" fill="';
                ICONS[16][2] = '" d="m500 185.185 500 629.63H0z"/><circle class="color_2" fill="';
                ICONS[16][3] = '" cx="500" cy="92.593" r="92.593"/><path class="color_3" fill="';
                ICONS[16][4] = '" d="M.463 815.278h999.074v184.259H.463z"/><path class="color_4" fill="';
                ICONS[16][5] = '"/>';
        ...
        // NGOs
            ...
            NGOs[11] = 0xA4166BC4Be559b762B346CB4AAad3b051E584E39;
            NGOs[12] = 0x968DC9065969bBf2652639658b963E287336bF34;
            ...
            NAMEs[11] = "Razom";
            NAMEs[12] = "Operation Broken Silence";
    }
        ...
        return string(
            abi.encodePacked(
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            con('{"name":"Donate Xmas Card #', Strings.toString(_tokenId)), 
                            getTOKEN(_tokenId), 
   ...
   function contractURI() public pure returns (string memory) {
    ...
    function set_new_icon(
        uint256 icon_id, 
        string memory name,
        string memory icon_1,
        string memory icon_2,
        string memory icon_3,
        string memory icon_4,
        string memory icon_5
    ) external {
        require(msg.sender == owner(), 'Only the owner can do this');
        require(bytes(ICON_NAMEs[icon_id]).length == 0, "Icon id already used");
        ICON_NAMEs[icon_id] = name;
        ICONS[icon_id][1] = icon_1;
        ICONS[icon_id][2] = icon_2;
        ICONS[icon_id][3] = icon_3;
        ICONS[icon_id][4] = icon_4;
        ICONS[icon_id][5] = icon_5;
    }

    function set_new_NGO(
        uint256 NGO_id, 
        string memory name,
        address addr
    ) external {
        require(msg.sender == owner(), 'Only the owner can do this');
        require(bytes(NAMEs[NGO_id]).length == 0, "NGO_id already used");
        NAMEs[NGO_id] = name;
        NGOs[NGO_id] = addr;
