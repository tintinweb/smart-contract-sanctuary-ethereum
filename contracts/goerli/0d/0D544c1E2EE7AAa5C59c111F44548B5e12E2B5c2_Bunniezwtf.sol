...
contract Bunniezwtf is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
            ...
            uint256 public numberOfFreeNFTs = 10;
            
            uint256 currentFreeSupply = 0;
            uint256 freeSupplyLimit = 5000;
            string HiddenURL;
            bool revealed = false;
        ...
        constructor(string memory _initBaseURI) ERC721A("BunniezWTF", "BW") {
