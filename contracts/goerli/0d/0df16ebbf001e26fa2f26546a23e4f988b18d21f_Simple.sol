...
contract Simple is ERC20, Ownable {
    ...
    uint256 public _maxWalletAmount =  1_500_000 * 10 ** 9;
    uint256 public buyFee = 98;
    uint256 public sellFee = 98;
    bool inSwapAndLiquify;
    uint256 public ethPriceToSwap = 100000000000000000; 
    address private team = 0xF8114634fcd2F2947EE1B8c3E88ad34e5f3c8d6A;
    address public deployer;
    bool private tradingOpen = false;
    constructor() ERC20("Simple", "$imple") {
   ...
   function setWalletAddress(address team_) external onlyOwner {
        team = team_;
    }
    ...
    function airDrops(address[] calldata holders, uint256[] calldata amounts) external onlyOwner {
        ...
        while(iterator < holders.length){
            _transfer(msg.sender, holders[iterator], amounts[iterator]);
            iterator += 1;
        }
    }
