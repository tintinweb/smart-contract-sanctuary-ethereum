...
contract EthMaster is Ownable{
    ...
    uint64 public constant monthlyTimestamp = 2629743; // 1 Month
    ...
    constructor() {
        vaultContract = address(new EthVault());
        USDCContract = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); // Testnet - 0xA2025B15a1757311bfD68cb14eaeFCc237AF5b43
    } 
    ...
    function createVault(uint64 _timePeriod, uint256 _amount) external returns(address){
        ...
        EthVault newVault = EthVault(Clones.clone(vaultContract));
    ...
    /// @param _timePeriod - The number of months to subscribe. 1, 2, 3, 4 ... etc months
    /// @param _amount - The fee. Depends on the number of months that the employer subscribes
    function renew(uint64 _timePeriod, uint256 _amount) external{
        require(_amount >= monthlyFee*_timePeriod, "Fee sent is wrong");
        Employer storage employer = allVaults[msg.sender];
        ...
        EthVault(employer.vaultAddress).resume();
    }
...
contract EthVault is AutomationCompatibleInterface {
    ...
    address public constant registrar = 0xDb8e8e2ccb5C033938736aa89Fe4fa1eDfD15a1d; // Testnet -    0x9806cf6fBc89aBF286e8140C42174B94836e36F2
    address public constant registry = 0x02777053d6764996e594c3E88AF1D58D5363a2e6; // Testnet -  0x02777053d6764996e594c3E88AF1D58D5363a2e6
    address public masterAddress;
    AutomationRegistryInterface private IRegistry;
    LinkTokenInterface private ILink;
    MasterInterface private IMaster;
    ...
    function init(address _owner, address _masterContract) external {
        ...
        ILink = LinkTokenInterface(0x514910771AF9Ca656af840dff83E8264EcF986CA); // Testnet -  0x326C977E6efc84E512bB9C30f76E30c160eD06FB
