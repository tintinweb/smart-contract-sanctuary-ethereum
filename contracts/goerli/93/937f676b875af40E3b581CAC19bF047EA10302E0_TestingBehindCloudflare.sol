 ...
 * @notice This contract handles minting Testing behind cloudflare tokens.
 */
contract TestingBehindCloudflare is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xFae0045AF573294df52f494c93Ab6435058c4cc8;
    ...
    string public name = "Testing behind cloudflare";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeielciwzcehif3ll7igj7spjdxisij6xvb4xky2lbycikgqly34v2y/{id}"
        )
    {
