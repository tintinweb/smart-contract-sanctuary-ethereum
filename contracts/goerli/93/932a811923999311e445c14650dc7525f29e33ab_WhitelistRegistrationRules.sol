...
function registerSubdomain(uint256 _id, string calldata _label, bytes32[] calldata _proofs) payable external;
...
contract WhitelistRegistrationRules is IRegister, PrimaryEns, IERC721Receiver {
    ...
    function registerSubdomain(uint256 _id, string calldata _label, bytes32[] calldata _proofs) external payable {
