...
contract MoonStakingS2 is ERC721Holder, Ownable, ReentrancyGuard {
    ...
    constructor(address _genesis, address _mooonstakings1) {
        ...
        _yieldmapping[150] = 250;
        _yieldmapping[180] = 300;
        _yieldmapping[210] = 350;
        _yieldmapping[240] = 425;
        _yieldmapping[300] = 500;
    }
    ...
    function getTokenYield(
        ...
        uint256 tokenYield = _rarityMultiplyer[contractAddress][tokenId] *
            _baseRates[contractAddress];
        if (tokenYield == 0) {
    ...
    function balanceOf(address user) public view returns (uint256) {
        uint oldBalanceOf = MoonStakingS1.balanceOf(_msgSender());
        return _stakers[user].stakedGENESIS.length;
    }
    ...
    function setMUTANTContract(
        ...
        _baseRates[_mutant] = _baseReward;
    }
