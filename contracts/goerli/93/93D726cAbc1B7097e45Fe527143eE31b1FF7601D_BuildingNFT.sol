...
contract BuildingNFT is Initializable, UUPSUpgradeable, ContextUpgradeable {
    ...
    */
     ...
     */
    function mint(uint256 isleId, uint256 landId, uint256 combineId, uint256 durability, uint256 stakeWeight, address maker) public onlyRole(MINTER_C_ROLE) returns(uint256){
        require(isleId > 0,"NFT/isleId_is_0");

        _nfts[++_currentId].isleId = isleId;
        _nfts[_currentId].landId = landId;
        _nfts[_currentId].combineId = combineId;
        _nfts[_currentId].durability = durability;
     ...
     */
    function increasedStakeWeight(uint256 id, uint256 value) public onlyRole(MINTER_C_ROLE) {
        NFTInfo storage building = _nfts[id];
     ...
     */
    function decreaseStakeWeight(uint256 id, uint256 value) public onlyRole(MINTER_C_ROLE) {
        NFTInfo storage building = _nfts[id];
     ...
     */
    function increasedDurability(uint256 id, uint256 value) public onlyRole(MINTER_C_ROLE) {
        NFTInfo storage building = _nfts[id];
     ...
     */
    function decreaseDurability(uint256 id, uint256 value) public onlyRole(MINTER_C_ROLE) {
        NFTInfo storage building = _nfts[id];
