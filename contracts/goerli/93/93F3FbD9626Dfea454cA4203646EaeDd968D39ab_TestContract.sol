...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x0bf5B319A6a683f1DD942edcCaC40eE51Ed0f5aa];
  address public erc20Payable = 0x0bf5B319A6a683f1DD942edcCaC40eE51Ed0f5aa;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 840;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 4200) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihhz4gcnax45i4ugkpk5high7z6rvxa3xhq7mym5gnhofcyhp5qna/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Iuz0Qh5XXFPpnGaYqVny/contract-metadata";
  }
...
contract TestContract is RamppERC721A {
    constructor() RamppERC721A("test", "zz"){}
}
