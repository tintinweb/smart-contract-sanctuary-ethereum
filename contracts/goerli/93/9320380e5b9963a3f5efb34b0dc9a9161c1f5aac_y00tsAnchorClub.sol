...
// File: contracts/y00tsAnchorClub.sol
...
contract y00tsAnchorClub is ERC721Enumerable, AccessControl {
    ...
    constructor() ERC721("y00ts Anchor Club", "YAC") {
    ...
    function unwrapActive() external onlyRole(DEFAULT_ADMIN_ROLE) {
        isActive = !isActive;
    }
