...
contract GLOBE is ERC20, Ownable {
    ...
    {   
        ...
        _totalFeesOnBuy    = liquidityFeeOnBuy  + marketingFeeOnBuy + devFee;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell + devFee;

        marketingWallet = 0x48b371e1FEa4F055546eE9869227781Cc896CCbA;
        devWallet   = 0xdAe1adb439184E8312B54c60eeFA30dAf1d05327;
...
//------------------Transfer------------------//
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            if (devFee > 0) {
                uint256 devTokens = contractTokenBalance * (devFee * 2) / totalFee;
