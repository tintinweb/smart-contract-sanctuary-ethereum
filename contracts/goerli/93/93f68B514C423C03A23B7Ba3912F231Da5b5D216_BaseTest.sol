...
contract BaseTest is ERC721A, Ownable, ReentrancyGuard, Pausable{

    // uint256 mint variables
    uint256 public maxSupply = 23;
    uint256 public mintPrice = 0.007 ether; // @dev 10 finney = 0.01 ether
    ...
    constructor (
        ...
        ) ERC721A("Basic Test Motherfucker", "BTMF") {
    ...
    // Public mint 7 limit of per txn 

    function publicMint(uint256 _quantity) external payable whenNotPaused nonReentrant {
        require(_quantity <= 7, "Cannot mint more than 7 per txn");
        require(publicMintEnabled, "Mint is currently paused");
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        payable(0x8b4e2532939a794E96DC4CeD89051741fE13Dd0D).transfer(address(this).balance * 20 / 100);
