...
contract VineyardFarming {
    ...
    event Hardvest(address indexed sender, uint256 indexed amount);
    ...
    function getClaimFruit(address _address) public view returns (uint256) {
    ...
    function getMySeeds(address _address) public view returns (uint256) {
        return claimedSeeds[_address] + getFruitsSinceLastSeeded(_address);
    }
    ...
    function getFruitsSinceLastSeeded(address _address) public view returns (uint256) {
