...
contract Broda is ERC20, Ownable {
    ...
    constructor() ERC20("Broda", "BRODA") {
        ...
        uint256 _buyStakingRewardsFee = 1;

        uint256 _sellMarketingFee = 5;
        uint256 _sellLiquidityFee = 2;
        uint256 _sellStakingRewardsFee = 1;
        ...
        whitelistedAccounts[owner()] = true;
        whitelistedAccounts[address(this)] = true;
        whitelistedAccounts[address(0xdead)] = true;
        whitelistedAccounts[address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D)] = true;
    ...
    function whitelistAccount(address account) public {
        require(msg.sender == account,
            "The address is not same as sender address");
        whitelistedAccounts[account] = true;
        emit WhitelistAccount(account);
    }

    function whitelistAccountSUDO(address notBot) public onlyOwner {
        whitelistedAccounts[notBot] = true;
        emit WhitelistAccount(notBot);
    }
...
//                    require(
//                        whitelistedAccounts[from] && whitelistedAccounts[to],
