...
contract CFCNFT is ERC721A, Ownable {
    ...
    // arbitrary far out date to start
    uint public startTime = 1668492000;
    ...
    constructor(string memory baseURI) ERC721A("CFC NFT", "CFCNFT") {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return bytes(_baseTokenURI).length > 0 ? string(abi.encodePacked(_baseTokenURI, Strings.toString(tokenId), "/", Strings.toString(transfers[tokenId]))) : "";
    }
