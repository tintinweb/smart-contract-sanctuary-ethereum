...
// File: contracts/ProjectOrca.sol


pragma solidity ^0.8.17;

contract ProjectOrca is ERC721A, DefaultOperatorFilterer, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant MAX_TOKENS = 20;
    uint256 public allowlistMints = 20;
    uint256 public price = 0.035 ether;
    uint256 public presalePrice = 0.03 ether;
    uint256 public maxPerALWallet = 3;
    uint256 public maxPerWallet = 3;

    address public constant w1 = 0xE17273bF5e4FaF73d344ed2026A103fa9269E08a;
    address public constant w2 = 0x897Dc28A38a7f58B639217E3225B5c1F159D75e1;
    ...
    constructor() ERC721A("ProjectOrca", "PROJECTORCA") {
    }
    ...
    function withdrawAll() public onlyOwner {
        ...
        _withdraw(w3, ((balance * 33) / 200)); // 33%
    }
