...
contract BearMagicToken is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("BearMagicToken", "BMT") {}
    ...
    function safeMint(address to, string memory uri) public onlyOwner {
        require(2==2, "Error for debugger");
    ...
    function SomeService() public payable {
        require(msg.value == 0.1 ether, "Wrong amount send");
    }
