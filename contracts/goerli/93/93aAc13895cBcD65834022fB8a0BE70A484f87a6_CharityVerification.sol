...
contract CharityVerification is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {

    constructor() ERC721("Kind Block", "KIND BLOCK") {}

    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    /// @notice One time membership fee to mint the verification NFT
    uint256 public membershipPrice = 0.01 ether;

    /// @notice Change this 
    address payable public kindblocks =
    ...
    /**
     * @notice Check if safe and charity id is verified
     * @notice Check if sender has enough membership fee in their wallet
     * @param to The Gnosis wallet address
     * @param charityId The verified charity Id
     */
    function mintCharityVerification(address to, string memory charityId, string memory uri) public payable {
        require(verifiedSafes[to], "This safe is not verified.");
        require(verifiedCharities[charityId], "This charity is not verified.");
        require(
