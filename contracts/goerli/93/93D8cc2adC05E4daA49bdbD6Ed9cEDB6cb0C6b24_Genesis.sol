...
contract Genesis is ERC721AQueryable, Ownable, Pausable {
    ...
    uint256 public COST_PRICE = 0.1 ether;

    bool public saleStatus = false;

    string public tokenBaseURI = "https://idgafnft.s3.us-west-2.amazonaws.com/metadata/";

    address ourBoss;

    constructor() ERC721A("Genesis", "GEN-0") {
        ourBoss = msg.sender;
    }

    function mintGenesis(uint256 numTokens) external payable {
    ...
    function updateBoss(address _boss) public onlyOwner {
        ourBoss = _boss;
    }
}
