...
contract MerchBox is ERC1155Guardable, Owned {
  ...
  function setMerchBoxConsumer(address _consumer) external onlyOwner {
  ...
  function burn(address from, uint256 amount) external {
    if (msg.sender != consumer) revert InvalidCaller();
