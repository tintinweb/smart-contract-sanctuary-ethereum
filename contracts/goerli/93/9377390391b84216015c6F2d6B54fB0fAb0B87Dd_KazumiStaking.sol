...
contract KazumiStaking is Ownable, ReentrancyGuard {
    ...
    address public constant token = 0xCB90572b897591249A84c2CDf71E09625118943A;

    address public constant deadAddress = address(0xdead);
    // address public constant USDC = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
    address public constant USDC = 0xDb956a5DC260a969a09Aba476B80F8Aa9C020EC8;

    // uint256 public MIN_LOCK_DURATION = 30 * 24 * 60 * 60;
    uint256 public MIN_LOCK_DURATION = 2 * 60;
    // uint256 public MIN_THRESHOLD_TOKENS = 100000 * 10**18;
    uint256 public MIN_THRESHOLD_TOKENS = 1 * 10**18;
