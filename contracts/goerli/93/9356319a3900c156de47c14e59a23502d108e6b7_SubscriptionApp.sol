...
//    }
//
    function addYears(uint timestamp, uint _years) external view returns (uint newTimestamp) {
        uint year;
        uint month;
        uint day;
        (year, month, day) = _daysToDate(timestamp / SECONDS_PER_DAY);
    ...
    function addMonths(uint timestamp, uint _months) external view returns (uint newTimestamp) {
        uint year;
        uint month;
        uint day;
        (year, month, day) = _daysToDate(timestamp / SECONDS_PER_DAY);
...
//        require(newTimestamp >= timestamp);
//    }
//    function addHours(uint timestamp, uint _hours) external view pure returns (uint newTimestamp) {
//        newTimestamp = timestamp + _hours * SECONDS_PER_HOUR;
//        require(newTimestamp >= timestamp);
//    }
//    function addMinutes(uint timestamp, uint _minutes) external view pure returns (uint newTimestamp) {
//        newTimestamp = timestamp + _minutes * SECONDS_PER_MINUTE;
//        require(newTimestamp >= timestamp);
//    }
//    function addSeconds(uint timestamp, uint _seconds) external view pure returns (uint newTimestamp) {
