...
contract Lottery is VRFV2WrapperConsumerBase {
    ...
    mapping(uint256 => CoinFlipStatus) public statues;
    ...
    //uint128 constant entryFees = 0.0001 ether;
   ...
   function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override{
       require(statues[requestId].fees > 0, "Request not found");

       statues[requestId].fulfilled = true;
       statues[requestId].randomWord = randomWords[0];
