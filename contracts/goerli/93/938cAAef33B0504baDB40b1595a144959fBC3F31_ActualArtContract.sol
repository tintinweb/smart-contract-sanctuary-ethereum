...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xb6D5af73e2965e75fBaf1b41C5640E19Bac59E8F];
  address public erc20Payable = 0xb6D5af73e2965e75fBaf1b41C5640E19Bac59E8F;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 250) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeid7wu475vmqrlftlwklwmoyh62hdggyofwtphk4flapzy3lqkezem/";
    ...
    */
    function canMintAmount(address _address, uint256 _amount) private view returns(bool) {
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/dBwB0tjsf1lTRmjMyUiy/contract-metadata";
  }
...
// File: contracts/ActualArtContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ActualArtContract is RamppERC721A {
    constructor() RamppERC721A("Actual Art", "ACTUALYYYY"){}
}
