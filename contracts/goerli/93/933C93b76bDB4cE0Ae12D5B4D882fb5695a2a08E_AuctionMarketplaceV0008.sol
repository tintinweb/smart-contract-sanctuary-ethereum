...
contract AuctionMarketplaceV0008 is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    function setPlatformFeeAccount(address payable _feeAccount) onlyOwner external {
        feeAccount = _feeAccount;
    }

    // initializeOwnership
    function initializeOwnership(address _owner) external {
        require(owner() == address(0), "An owner has already been seet");
