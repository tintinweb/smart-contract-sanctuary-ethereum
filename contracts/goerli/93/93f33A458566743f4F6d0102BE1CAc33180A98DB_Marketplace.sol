...
contract Marketplace is Ownable, Pausable, ERC165 {
    ...
    function removeMarketID(
        ...
        uint256[] storage marketIDs = marketIDsbyTypeandTokenID[
            SilksContractsbyAddress[marketItems[marketIDToRemove].nftContract]
        ][tokenID];
    ...
    function createMarketItem(
        ...
        if (is1155[nftContract] == true) {
            ...
            if (
                marketIDsbyTypeandTokenID[SilksContractsbyAddress[nftContract]][
                    tokenID
                ].length != 0
            ) {
                ...
                for (
                    ...
                    marketIDsbyTypeandTokenID[
                        SilksContractsbyAddress[nftContract]
                    ][tokenID].length;
                    i++
                ) {
        ...
        marketIDsbyTypeandTokenID[SilksContractsbyAddress[nftContract]][tokenID]
            .push(itemID);
    ...
    function deleteOffer(
        ...
        //     );
        // } else {
        //     revert("MUST BE OFFERER OR (OWNER OF TOKEN AND NO 1115)");
        // }
    ...
    function _deleteOffer(
        ...
        // Shift the offers down
        for (
            uint256 i = index;
            i < offers[nftContract][tokenID].length - 1;
            i++
        ) {
            offers[nftContract][tokenID][i] = offers[nftContract][tokenID][
                i + 1
            ];
        }

        // Decrease the length of the offers array
        offers[nftContract][tokenID].pop();
    }
