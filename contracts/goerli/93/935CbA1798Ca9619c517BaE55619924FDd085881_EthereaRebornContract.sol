...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664816400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1664730000;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiciiyvp7ebonqeqe4zbrdksz55y26hwqseu2opbzq3exgb2ckfmpy/";
...
contract EthereaRebornContract is RamppERC721A {
    constructor() RamppERC721A("Etherea Reborn", "ETHR"){}
}
