...
contract AvatarX is ERC721A, ERC2981, AccessControl {
    ...
    constructor() ERC721A("Avatar X", "Avatar X") {
    ...
    */
    ...
    function setMaxSupply(uint256 _maxSupply) external onlyRole(ADMIN_ROLE) {
        require(_maxSupply > 0 && _maxSupply <= 10000, "Max supply must be greater than 0 and less than or equal to 100000");
    ...
    /**
     * @notice check address is whitelist address
     * @param _address: check the whitelist addresses
     */
    function checkWhitelistAddresses(address _address) public view returns(bool) {
