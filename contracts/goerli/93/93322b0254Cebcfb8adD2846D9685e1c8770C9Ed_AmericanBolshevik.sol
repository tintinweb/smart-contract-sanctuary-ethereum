...
contract AmericanBolshevik is ERC721A, Ownable {
  string public _baseTokenURI;
  uint256 public publicMintPrice = 0.06 ether;
  uint256 public MAX_SUPPLY = 3333;
  bool public isSale = false;

  constructor(string memory baseURI) ERC721A("American Bolshevik", "BOLSH") {
    setBaseURI(baseURI);
  }
  ...
  function mint(uint256 _count, address _address) public payable saleIsOpen {
