...
//
//   ______                    __         __  ___            __                  
//  /_  __/_______  ____  ____/ /_  __   /  |/  /___  ____  / /_____  __  _______
//   / / / ___/ _ \/ __ \/ __  / / / /  / /|_/ / __ \/ __ \/ //_/ _ \/ / / / ___/
//  / / / /  /  __/ / / / /_/ / /_/ /  / /  / / /_/ / / / / ,< /  __/ /_/ (__  ) 
// /_/ /_/   \___/_/ /_/\__,_/\__, /  /_/  /_/\____/_/ /_/_/|_|\___/\__, /____/  
//                           /____/                                /____/            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x2FA8a92cC35dd018378ceE6f1b7EB8921EF7441D];
  address public erc20Payable = 0x2FA8a92cC35dd018378ceE6f1b7EB8921EF7441D;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 8888, 8888) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibrcjxevukhxk4gn5fst4j4lttlipnau2e5teoxzzihss4qfh2zqa/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/OsRqRDbSG4EUPoKkbejX/contract-metadata";
  }
...
// File: contracts/TrendyMonkeysContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TrendyMonkeysContract is RamppERC721A {
    constructor() RamppERC721A("Trendy Monkeys", "TM"){}
}