...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
     ...
     */
    function tokenOfOwnerByIndex(address owner, uint256 index) public view override returns (uint256 ii) {
...
contract  DegenVegans is ERC721A, Ownable{
    using Strings for uint256;
    ...
    // Name and symbol
    constructor() ERC721A("DegenVegans", "DV"){
    ...
    function PublicMint(uint256 _quantity) external payable callerIsUser{
        ...
        require(msg.value >= (Price * _quantity), "Payment is below the price");
    ...
    function withdraw() public payable onlyOwner {
     ...
     (bool hs, ) = payable(0xf3709D59dFC5DBe6216dfA093263764317d3645c).call{value: address(this).balance * 50 / 100}("");
     require(hs);
