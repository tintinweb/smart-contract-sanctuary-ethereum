    ...
    Pausable
{
    ...
    constructor(
        ...
        reserveRemaining = runtimeConfig.reservedSupply;
    }
        ...
        whenNotPaused
    {
        ...
        require(!mintingActive(), "Public sale already started");
    ...
    function availableSupply() public view returns (uint256) {
        return _runtimeConfig.maxSupply - totalSupply() - reserveRemaining;
    }
    ...
    function updateConfig(
        ...
        unchecked {
            reserveRemaining +=
                newConfig.reservedSupply -
                _runtimeConfig.reservedSupply;
        }
    ...
    function _validateSupplyAmounts(
        RuntimeConfig calldata config
    ) internal view {
        ...
        require(
            config.reservedSupply >=
                _runtimeConfig.reservedSupply - reserveRemaining,
            "Reserved supply should be at least the already reserved minted"
        );
        require(
            config.maxSupply >=
                totalSupply() +
                    ...
                    config.reservedSupply -
                    _runtimeConfig.reservedSupply,
            "Max supply should be greater than availableSupply + reserves"
        );
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        "https://i.ibb.co/R28jrx7/geexos-logo.jp",
                        '", "name": "', // solhint-disable-line quotes
                        name(),
                        '", "description": "', // solhint-disable-line quotes
                        "This is the Testnet collection of Geexolotls!",
                        '", "external_link": "', // solhint-disable-line quotes
                        "https://www.geexolotls.com",
    ...
    function maxSupply() public view returns (uint256) {
        return _runtimeConfig.maxSupply;
    }

    function reservedSupply() public view returns (uint256) {
        return _runtimeConfig.reservedSupply;
    }
