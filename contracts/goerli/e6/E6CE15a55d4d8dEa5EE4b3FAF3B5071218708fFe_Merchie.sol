    ...
    ERC2981
{
    ...
    function initialize() public initializer {
        __ERC721_init("Merchie", "M3RCH");
        __ERC721Enumerable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC721Burnable_init();
        __UUPSUpgradeable_init();
        _setDefaultRoyalty(0xF77E68bAD99fb64477e48C7A6d775C0c98B21Ea4, 1000);
    ...
    function _baseURI() internal pure override returns (string memory) {
        return
            "https://bafybeigjfjc3lhul6edcbr7p5muxvxet2awqb4prxbmiiblk2g3xgi5hku.ipfs.nftstorage.link/";
    }
    ...
    function safeMint(uint256 amount) public {
        require((totalSupply() + amount) <= 10000, "Exceeds Supply");
        require((balanceOf(msg.sender) + amount) <= 3, "3 Mint Per Wallet");
        _mint(amount);
    }
