...
contract TokenLockFactory is AccessControl {
    bytes32 public constant FACTORY_ADMIN_ROLE = keccak256("FACTORY ADMIN");
    event Create(address collectible);
    ...
    function create(
        ...
        TokenLock newTokenLockContract = new TokenLock(_token, _depositDeadline, _lockDuration, _name, _symbol);
        emit Create(address(newTokenLockContract));
    }
