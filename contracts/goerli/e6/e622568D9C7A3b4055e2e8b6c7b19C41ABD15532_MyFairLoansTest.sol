...
contract MyFairLoansTest is ERC20Burnable, Ownable, Math {
    ...
    IERC20 public constant dai =
        IERC20(0x73967c6a0904aA032C103b4104747E88c566B1A2);
    ...
    function removeCollateral(uint256 _amount) external {
        ...
        uint256 amountLeft = mulExp(collateral, ethPrice).sub(borrowed);
    ...
    function liquidation(address _user) external payable onlyOwner {
        ...
        if (10 > percentage(collateralToUsd, maxLTV)) {
