...
/**
 * @title TokenSplitter
 * @notice It splits HTGs to team/treasury/trading volume reward accounts based on shares.
 */
contract TokenSplitter is Ownable, ReentrancyGuard {
    ...
    // Total hunter governance tokens distributed across all accounts
     ...
     * @param _hunterGovernanceToken address of the hunter governance token
     */
    constructor(
        address[] memory _accounts,
        uint256[] memory _shares,
        address _hunterGovernanceToken
    ) {
        ...
        hunterGovernanceToken = IERC20(_hunterGovernanceToken);
    }

    /**
     * @notice Release hunter governance token tokens to the account
    ...
    function releaseTokens(address account) external nonReentrant {
        ...
        uint256 totalTokensReceived = hunterGovernanceToken.balanceOf(address(this)) + totalTokensDistributed;
        ...
        hunterGovernanceToken.safeTransfer(account, pendingRewards);
    ...
    /**
     * @notice Retrieve amount of hunter governance tokens that can be transferred
     * @param account address of the account
     */
