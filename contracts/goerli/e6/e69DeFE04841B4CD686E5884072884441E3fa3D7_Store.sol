...
contract Store {
    ...
    uint[] private viewProducts;
    uint[] private viewOwnedProducts;
    ...
    function viewProductIds() public view returns (uint[] memory) {
        return viewProducts;
    }

    function viewOwnedProductIds() public view returns (uint[] memory) {
