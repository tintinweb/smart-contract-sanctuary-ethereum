...
contract MrBlue is ERC721A, Ownable, ReentrancyGuard {
  ...
  function freeMint(uint256 amt) external callerIsUser {
    ...
    require(totalSupply() + amt <= totalFree, "Max free MB");
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more MB");
