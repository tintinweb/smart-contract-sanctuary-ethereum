...
contract OZMockERC721 is ERC721URIStorage {
    string public baseURI;
    uint256 public currentId;

    constructor(string memory _uri) ERC721("OZ Mock ERC721", "OZ721") {
        baseURI = _uri;
    }
