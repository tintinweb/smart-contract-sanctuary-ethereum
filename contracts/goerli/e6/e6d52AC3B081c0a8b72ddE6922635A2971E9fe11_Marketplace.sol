    ...
    IERC1155ReceiverUpgradeable
{
    ...
    */
    ...
    function createListing(ListingParameters memory _params) external override {
        ...
        require(tokenAmountToList > 0, "Marketplace: QUANTITY");
        ...
        if (newListing.listingType == ListingType.Auction) {
            require(newListing.buyoutPricePerToken >= newListing.reservePricePerToken, "Marketplace: RESERVE");
    ...
    function updateListing(
        ...
        require(safeNewQuantity != 0, "Marketplace: QUANTITY");

        // Can only edit auction listing before it starts.
        if (isAuction) {
            require(block.timestamp < targetListing.startTime, "Marketplace: STARTED");
            require(_buyoutPricePerToken >= _reservePricePerToken, "Marketplace: RESERVE");
        }
    ...
    */
    ...
    function offer(
        ...
        if (targetListing.listingType == ListingType.Auction) {
            ...
            require(msg.value == 0, "Marketplace: no value needed");
    ...
    */
    ...
    function validateDirectListingSale(
        ...
        require(
            ...
            "Marketplace: invalid amount of tokens."
        );
        ...
        if (_currency == CurrencyTransferLib.NATIVE_TOKEN) {
            require(msg.value == settledTotalPrice, "Marketplace: msg.value != price");
        } else {
