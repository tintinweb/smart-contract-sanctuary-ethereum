    ...
    IRenderer
{
    ...
    string private _ARTGENE_SCRIPT =
        "";
    ...
    function tokenHTML(
        ...
        requests[0].name = "artgene.js.gz";
        requests[0].scriptContent = abi.encodePacked(_ARTGENE_SCRIPT);
        requests[0].wrapType = 2;

        requests[1].name = "sketch.js.gz";
        requests[1].scriptContent = abi.encodePacked(artScript);
        ...
        requests[3].contractAddress = scriptyStorage;
