...
contract ProxyFactory {
    ...
    function deployNewInstances(uint256 instanceAmount) external returns (address[] memory dsts) {
        // copy init code into memory
        // and immutable ExchangeDeposit address onto stack
        bytes memory initCodeMem = INIT_CODE;
        address payable addrStack = mainAddress;
    ...
    function deployNewInstances(uint256 instanceAmount, uint256 from) external returns (address[] memory dsts) {
        // copy init code into memory
        // and immutable ExchangeDeposit address onto stack
        bytes memory initCodeMem = INIT_CODE;
        address payable addrStack = mainAddress;
    ...
    function deployError(uint256 instanceAmount) external returns (address[] memory dsts) {
        // copy init code into memory
        // and immutable ExchangeDeposit address onto stack
        bytes memory initCodeMem = INIT_CODE;
        address payable addrStack = mainAddress;
