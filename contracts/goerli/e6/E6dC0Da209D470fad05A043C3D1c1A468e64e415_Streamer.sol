...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
        require(
            ...
            "fundChannel: You already have a running channel"
        );
    ...
    function withdrawEarnings(Voucher calldata voucher) public onlyOwner {
        ...
        */
        ...
        require(
            ...
            "withdraw failed: signer dosn't have the balance"
        );
        uint256 payment = balances[signer] - voucher.updatedBalance;
        balances[signer] = voucher.updatedBalance;
        (bool sent, ) = owner().call{value: payment}("");
        require(sent, "withdraw failed: ETH transfer failed!");
    ...
    function defundChannel() public {
        ...
        */
        require(canCloseAt[msg.sender] > 0, "not a closing channel!");
        require(
            block.timestamp > canCloseAt[msg.sender],
            "not a closing channel!"
        );
