...
contract PsychedelicMonkeys is ERC721A, Ownable, ERC2981, OperatorFilterer {
    uint256 public price = 0.0025 ether;
    
    

    uint256 public immutable supply = 33;
    ...
    address[] public withdrawAddresses = [0xd024c93588fB2fC5Da321eba704d2302D2c9443A, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xd024c93588fB2fC5Da321eba704d2302D2c9443A, _royaltyAmount);
    }
