 ...
 * @notice This contract handles minting Senseering tokens.
 */
contract Senseering is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xeC1D80A4287C484a6b014647209002E946bd1308;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x091840Ced4b2B71e0492aFabdB6BB7E09eF329C6;
    address[] public payoutAddresses = [
        0x091840Ced4b2B71e0492aFabdB6BB7E09eF329C6
    ];
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeigwas2iqsuupk4v57eyzflyptlrlgvllxrmv6nodp66rs4spiewlu/{id}"
        )
        RevokableOperatorFilterer(
