...
//*********************************************************************//
//
// oOoOOoOOo  o                o.OOOo.                                     Oo                  o                         
//     o     O                  O    `o                                   o  O                O     o                    
//     o     o                  o      O                                 O    o               o                          
//     O     O                  O      o                                oOooOoOo              O                          
//     o     OoOo. .oOo.        o      O .oOo. .oOoO .oOo. 'OoOo.       o      O `OoOo. .oOo  OoOo. O  `o   O .oOo. ooOO 
//     O     o   o OooO'        O      o OooO' o   O OooO'  o   O       O      o  o     O     o   o o   O   o OooO'   o  
//     O     o   O O            o    .O' O     O   o O      O   o       o      O  O     o     o   O O   o  O  O      O   
//     o'    O   o `OoO'        OooOO'   `OoO' `OoOo `OoO'  o   O       O.     O  o     `OoO' O   o o'  `o'   `OoO' OooO 
//                                                 O                                                                     
//                                              OoO'  
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x765232aE96cfe1A5e2E0eCF01c06b98EaBC80b85];
  address public erc20Payable = 0x765232aE96cfe1A5e2E0eCF01c06b98EaBC80b85;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiaplhp5tdempiunfnlng675bbo5whddex7ypz7peclquhhn4gnnte/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/qI167LjTIVBEYiB4Uqqs/contract-metadata";
  }
...
// File: contracts/TheDegenArchivezContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDegenArchivezContract is ERC721APlus {
    constructor() ERC721APlus("The Degen Archivez", "DGA"){}
}