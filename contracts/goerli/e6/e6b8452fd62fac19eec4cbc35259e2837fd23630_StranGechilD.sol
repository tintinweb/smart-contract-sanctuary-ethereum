...
contract StranGechilD is Ownable, ERC721A {
  string public baseURI = "https://nftstorage.link/ipfs/bafybeicouv6vw5gohgjrteumbjnsj6bd54qnnkxjz2yk647wg2tbx7kiwa/";
  ...
  constructor(uint256 _mintCntToOwner) ERC721A('StranGe chilD', 'SGD') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 800) {
