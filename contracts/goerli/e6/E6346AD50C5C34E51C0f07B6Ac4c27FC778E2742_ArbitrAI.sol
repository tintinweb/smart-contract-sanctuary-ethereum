...
contract ArbitrAI is IERC20Metadata, Ownable
{
    ...
    function _swapContractToken(uint contractToken) private lockTheSwap {
        ...
        _swapTokenForETH(contractToken);

        uint marketingETH = (contractToken * marketingTax) / TAX_DENOMINATOR;
        uint minerETH = (contractToken * minerTax) / TAX_DENOMINATOR;
