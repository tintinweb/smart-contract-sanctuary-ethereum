...
contract ChaosAndCouture is AdminControl, ICreatorExtensionTokenURI {
    enum ContractStatus {
        Paused,
        Premint,
        Open
    ...
    constructor(address creator, uint256 price) {
        _creator = creator;
        _price = price;
    }
    ...
    function approvedForPremint(address account, bytes32[] calldata proof)
        public
        view
        returns (bool)
    {
    ...
    {
        require(
            approvedForPremint(msg.sender, proof),
            'Not on the approved premint list'
        );
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked('Chaos', ' #', Strings.toString(tokenId)));
    }
