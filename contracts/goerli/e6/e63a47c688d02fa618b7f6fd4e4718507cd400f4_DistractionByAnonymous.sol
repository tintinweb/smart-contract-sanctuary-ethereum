...
contract DistractionByAnonymous is ERC721A, Ownable {
    ...
    string private baseUri = "ipfs://bafybeierprn3smajknkdlh7na3mndl54ou3mau7s2qvrt3atutotleko3q";

    mapping(address => uint256) private _freeMintedCount;

    constructor() ERC721A("Distraction By Anonymous", "DBB") {}
