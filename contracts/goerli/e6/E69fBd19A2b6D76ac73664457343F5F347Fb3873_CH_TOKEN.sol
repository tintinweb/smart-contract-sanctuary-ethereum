...
contract CH_TOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("CH2", "CH2") payable {
        ...
        maxTransactionAmount = totalSupply * 2000 / 100000;
        maxWallet = totalSupply * 300 / 10000;
        swapTokensThreshold = totalSupply * 1 / 1000;

        _feeReceiver = 0xd6ECf7d7F7A3242Cb438b52e66A1E4CdDCF2a25B;

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(_feeReceiver, true);
