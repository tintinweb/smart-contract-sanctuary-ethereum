...
contract Staker {
  ...
  modifier canDeposit {
    require(block.timestamp <= deadline, "deadline has passed, you cannnot deposit anymore");
    _;
  }
  ...
  function stake() payable public canDeposit{
  ...
  function execute() payable public deadlinePassed {
    if(!executed && address(this).balance >= threshold){
  ...
  function withdraw() payable public {
    ...
    require(openForWithdraw, "threshold has been met");
