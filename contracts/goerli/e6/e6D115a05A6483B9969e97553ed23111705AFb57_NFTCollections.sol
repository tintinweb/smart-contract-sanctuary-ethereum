...
contract NFTCollections is ERC721Upgradeable, OwnableUpgradeable {
     ...
     * 
     */
    function internalMintFromCollection(uint256 collectionId, uint256 tokenIdInCollection, address mintTo, bool fromAdmin, bool checkPrice) internal {
     ...
     */
    function mintFromCollection(uint256 collectionId, uint256 tokenIdInCollection) public payable {
        internalMintFromCollection(collectionId, tokenIdInCollection, msg.sender, false, true);
    }

    /**
     * @dev Mint multiple tokens from collections
     */
    function mintFromCollectionMultiple(uint256[] calldata collectionIds, uint256[] calldata tokenIdsInCollection) public payable {
        ...
        for (uint256 i=0; i < collectionIds.length;) {
            internalMintFromCollection(collectionIds[i], tokenIdsInCollection[i], msg.sender, false, false);
            unchecked{i++;}
        }
    }
    ...
    function runAirdrop(uint256[] calldata collectionIds, uint256[] calldata tokenIds) external {
        ...
        for (uint256 i = 0; i < collectionIds.length;) {
            ...
            internalMintFromCollection(collectionIds[i], tokenIds[i], wallet, true, false);
            unchecked{i++;}
        }
    }
    ...
    function runAirdropFreeForAll(uint256[] calldata collectionIds, uint256[] calldata tokenIds, address[] calldata owners) external {
        ...
        for (uint256 i = 0; i < tokenIds.length;) {
            ...
            internalMintFromCollection(collectionIds[i], tokenIds[i], owners[i], true, false);
            unchecked{i++;}
        }
    }
