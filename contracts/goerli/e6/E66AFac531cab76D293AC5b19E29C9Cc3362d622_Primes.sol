...
contract Primes is ERC721r, Ownable {
        ...
        for (y = 0; y <= 800; y += 100) {
            for (x = 0; x <= 800; x += 100) {
                ...
                if (isPrime(uint256(index), 2)) {
                    ...
                    anime = string(
                        abi.encodePacked(
                            '<animate xmlns="http://www.w3.org/2000/svg" attributeName="d" values="',
                            // generateCoordinatesAnimation(x, y),
                            string(
                                abi.encodePacked(
                                    (x + 50).toString(),
                                    " ",
    ...
    function generateCoordinatesAnimation(uint256 _x, uint256 _y)
        internal
        pure
        returns (string memory)
    {
