...
contract itoken is Context, IERC20 {
     ...
     * construction.
     */
    constructor (string memory name, string memory symbol,address _daaaddress,address _managerAddress, uint8 _decimalValue) public {
        _name = name;
        _symbol = symbol;
        _decimals = _decimalValue;
...
contract itokendeployer {
     ...
     */
    function updateDecimalValue(uint8 _decimalValue) public onlyOnwer { 
