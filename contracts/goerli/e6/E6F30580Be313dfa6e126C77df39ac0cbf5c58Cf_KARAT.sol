...
contract KARAT is ERC20, Ownable {
    ...
    constructor() ERC20("Twenty Four Karat Inu", "$KARAT") {
        ...
        treasuryWallet = address(0xC54FF7b11a279368F14976261551B816282e9efE); // set as treasury wallet
        devWallet = address(0xD6979c60CD3Ec33cEc5e408016738C44b4f4C15A); // set as dev wallet
