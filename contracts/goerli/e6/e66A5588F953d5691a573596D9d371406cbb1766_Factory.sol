...
contract Factory {
    ...
    function deploy(
        ...
        addr = address(
            new CXLDNFT721V2{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        CXLDNFT721V2 token = CXLDNFT721V2(address(addr));
