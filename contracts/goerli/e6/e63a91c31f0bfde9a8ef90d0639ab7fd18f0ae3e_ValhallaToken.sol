...
/** 
 * @title Valhalla Network Token Interface
 * @author audie.eth
 * @notice This is the interface for Valhalla Network's utility token
 */
...
interface IValhallaToken is IERC20 {
...
/** 
 * @title Valhalla Network Token
 * @author audie.eth
 * @notice This is the utility token for the Valhalla Network DAO
 */
...
import "./IValhallaToken.sol";

contract ValhallaToken is
    IValhallaToken,
    ERC20Capped,
    Ownable,
    ERC20Burnable
