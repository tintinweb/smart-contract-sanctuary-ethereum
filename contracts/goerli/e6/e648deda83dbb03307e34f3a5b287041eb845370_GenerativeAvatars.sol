...
contract GenerativeAvatars is ERC721A {
    ...
    modifier dungeonsStaked() {
        ...
        require(block.timestamp - dungeonRewardsContract.dungeonFirstStaked(msg.sender) > 7 days, "Dungeons have not been staked for 7 days");
        _;
    }
    ...
    function mintFree(uint256 quantity) external payable callerIsUser dungeonsStaked nonReentrant {
