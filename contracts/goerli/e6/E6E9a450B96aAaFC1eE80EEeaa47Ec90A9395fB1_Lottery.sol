...
contract Lottery is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    event Lottery_RandomWinner(uint256 indexed randomWinner);
    event WinnerPicked(address indexed  player);


    constructor (uint64 subscriptionId, address vrfCoordinatorV2,bytes32 keyHash, uint32 callbackGasLimit,uint256 interval, uint256 _entranceFee) VRFConsumerBaseV2(vrfCoordinatorV2) {
     ...
     */
    function checkUpkeep(bytes memory /*calldata*/) public view override returns(bool upkeepNeeded,
            bytes memory /* performData */){
                 bool isTimePassed = ((block.timestamp - prevTimeStamp) >  i_interval);
    ...
    function performUpkeep(bytes calldata /* performData */) external  override {
        ...
        uint256 requestID =  i_vrfCoordinator.requestRandomWords(i_keyHash,i_subscriptionId,REQUEST_CONFIRMATIONS,i_callbackGasLimit,NUM_WORDS);
        emit Lottery_RandomWinner(requestID);
