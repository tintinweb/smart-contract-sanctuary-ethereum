...
contract BaseSweep is Initializable, ERC20Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    // Core
    address public timelock_address;
    ...
    */
    ...
    function addMinter(address minter_address, uint256 max_mint_amount) public onlyOwner {
    ...
    function setMinterMaxAmount(address minter_address, uint256 max_mint_amount) external onlyOwner {
        require(minters[minter_address].is_listed == true, "Minter nonexistant");
    ...
    function setMinterEnabled(address minter_address, bool is_enabled) external onlyOwner {
        require(minters[minter_address].is_listed == true, "Minter nonexistant");
