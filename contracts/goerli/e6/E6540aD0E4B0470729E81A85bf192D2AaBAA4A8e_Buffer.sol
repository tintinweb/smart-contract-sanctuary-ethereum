...
contract Buffer is Initializable, ReentrancyGuard {
    ...
    function withdraw(
        ...
        for (i = 0; i < tokenIDs.length; i++) {
            ...
            _shareData[creatorsGroup[index]].shareAmount += shareDetails[3] * prices[i] * royaltyFee / 10000 / totalShares;
            if (sellerAddresses[i] != deadAddress) {
                _shareData[sellerAddresses[i]].shareAmount += shareDetails[4] * prices[i] * royaltyFee / 10000 / totalShares;
            }
        }
