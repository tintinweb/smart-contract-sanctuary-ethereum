...
import "BalReentrancyGuard.sol";
import "BalSafeMath.sol";
import "BalEIP712.sol";
import "EOASignaturesValidator.sol";

contract BalancerMinter is IBalancerMinter, BalReentrancyGuard, EOASignaturesValidator {
    ...
    constructor(IBalancerTokenAdmin tokenAdmin, IGaugeController gaugeController) BalEIP712("Balancer Minter", "1") {
...
// Based on the BalReentrancyGuard library from OpenZeppelin Contracts, altered to reduce bytecode size.
 ...
 *
 * Inheriting from `BalReentrancyGuard` will make the {nonReentrant} modifier
 ...
 */
abstract contract BalReentrancyGuard {
