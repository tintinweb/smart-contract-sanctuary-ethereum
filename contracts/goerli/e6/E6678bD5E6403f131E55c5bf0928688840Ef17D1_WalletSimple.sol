...
contract WalletSimple is IERC721Receiver, ERC1155Receiver {
  ...
  /**
   * Execute a ether flush from one of the forwarder addresses. This transfer needs only a single signature and can be done by any signer
   *
   * @param forwarderAddress the address of the forwarder address to flush the ether from
   */
  function flushForwarderEth(address payable forwarderAddress)
    external
    onlySigner
  {
