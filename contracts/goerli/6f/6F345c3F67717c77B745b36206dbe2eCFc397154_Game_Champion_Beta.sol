...
import './Game_Champion_BetaBase.sol';
import './Game_Champion_BetaSplitsAndRoyalties.sol';

/**
 * @title Game_Champion_Beta
 */
contract Game_Champion_Beta is Game_Champion_BetaSplitsAndRoyalties, Game_Champion_BetaBase {
    constructor()
        Game_Champion_BetaBase(
            'Game_Champion_Beta',
            'GM_C_2',
    ...
    function _getInitialFlavors() internal pure override returns (TokenFlavor[] memory) {
        TokenFlavor memory glowingGreen = TokenFlavor(
            ...
            500,
            0,
            'QmXLg9McEaxbiRGfBw7UsvirmNjZjbA9FRdvSmXaachcrF/token1'
        );
...
contract Game_Champion_BetaSplitsAndRoyalties is ERC2981 {
