...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xFa82e60f3C425159f1C064A59f93D3DA41Ed18ED];
  address public erc20Payable = 0xFa82e60f3C425159f1C064A59f93D3DA41Ed18ED;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigsmvr3mbe34j4uqp6it3gw3repb6rd7o2fkid6i5sy54utfbfiry/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/J0oygHYdrZgEeKCQrGFT/contract-metadata";
  }
...
// File: contracts/TestsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestsContract is RamppERC721A {
    constructor() RamppERC721A("tests", "test"){}
}
