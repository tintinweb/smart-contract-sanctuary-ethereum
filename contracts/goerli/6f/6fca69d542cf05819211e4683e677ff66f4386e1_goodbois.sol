...
contract goodbois is ERC721, Ownable {
  ...
  string public uriPrefix = "ipfs://QmcimWwADSwi3VLhbyyd3qEB9Lmtuvv3rgZVkAeQDYJiVY";
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, "max 30 per transaction. sory bout ya gas");
    require(supply.current() + _mintAmount <= maxSupply, "too slow sport, sold out");
    _;
  }
