...
// File: contracts/LockRegistry.sol
...
// File: contracts/ILockERC721.sol
...
// File: contracts/GuardianLiteB2FA.sol
...
// File: contracts/ERC721BLockRegistry.sol
...
// File: contracts/ERC721B2FAEnumLitePausable.sol
...
// File: contracts/GhostyERC721Ctr.sol

pragma solidity ^0.8.15;

contract GhostyERC721Ctr is ERC721B2FAEnumLitePausable, GuardianLiteB2FA {
    using Address for address;
    ...
    constructor()
        ERC721B2FAEnumLitePausable(
            "GhostyERC721Ctr_NAME_TO_REPLACE",
            "G0x2a",
            1
        )
    {
    ...
    // Mint fns
    function ownerMints(uint256 quantity, address[] memory recipients)
        external
        onlyDelegates
    {
