...
contract UniversalRoyaltyRegistry is ITest, IERC165,Ownable {
    ...
    mapping(address => authContra) public AuthContra;
    ...
    function setAuthContra(
        address _contractAddress
    ) public onlyOwner {
        require(_contractAddress.supportsInterface(IID_IERC721), "Not a ERC721 Contract");
        require(_contractAddress!= address(0));
        authContra storage authContract = AuthContra[_contractAddress];
        authContract.status = true;
        authContract.contractAddress = _contractAddress;
    }
    ...
    function checkAuthContra(address _contractAddress) external view returns(bool){
        require(_contractAddress.supportsInterface(IID_IERC721), "Not a ERC721 Contract");
        authContra storage authContract = AuthContra[_contractAddress];
        return authContract.status;
    }
}