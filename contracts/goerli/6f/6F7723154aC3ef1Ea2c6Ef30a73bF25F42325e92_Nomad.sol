...
contract Nomad is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("TEST_Nomad", "NMD") {}
    ...
    // !! Main
    function mint(uint256 _quantity, bytes32[] memory _proof) public payable {
        ...
        require(MerkleProof.verify(_proof, merkleRoot, leaf), "Incorrect proof");
