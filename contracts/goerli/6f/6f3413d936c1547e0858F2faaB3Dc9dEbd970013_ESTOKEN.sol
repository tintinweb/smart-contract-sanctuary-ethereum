...
contract ESTOKEN is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("ESTOKEN", "MTK") {
        //assign the address that is creating the transaction for deploying the smart contract 
    ...
    function safeMint(address to, string memory uri) public payable onlyOwner {
        ...
        require(msg.value == 100000000 gwei, "Not enough ETH sent, price is 0.1 ETH");
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, uri);
    }
    
    //function to get balance of the smartcontract addres
    function getBalance () public view returns (uint){
        return address(this).balance;
    }

    //function to withdraw eth from smartcontract address
