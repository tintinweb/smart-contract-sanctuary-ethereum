...
// SPDX-License-Identifier: MIT
        ...
        contract cscscs is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer{
            ...
            bytes32 public MerkleGroupRoot1 = 0xe55a6e61a46801f0cf517390e9eff41440bf02ac4accd087bbfe3855b31beae0;
            uint256 public MerklePrice1 = 0.004 ether;
            uint256 public MerkleMaxWallet1 = 3;
            ...
            constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet, string memory _initNotRevealedUri) ERC721A("cscscscsc", "cs") {
        ...
        modifier whitelistMintPriceCompliance(bytes32[] calldata _merkleProof, uint256 _mintAmount) {
          ...
          _;
            ...
            function checkPricePerUser(bytes32[] memory _merkleProof, bytes32 leaf) view public returns (uint256){
                ...
                if(MerkleProof.verify(_merkleProof, MerkleGroupRoot1, leaf)) return MerklePrice1 ;
            ...
            function checkMaxMintPerUser(bytes32[] memory _merkleProof, bytes32 leaf, uint256 amount) view public returns (bool){
              ...
              if(MerkleProof.verify(_merkleProof, MerkleGroupRoot1, leaf)) {
                  if(balance <= MerkleMaxWallet1) return true;
                  else return false;
                }
