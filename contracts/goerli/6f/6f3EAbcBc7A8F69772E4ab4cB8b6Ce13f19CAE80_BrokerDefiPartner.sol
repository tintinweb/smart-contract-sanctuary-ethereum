...
import "./interfaces/IBrokerDefiPriceConsumer.sol";
import "./interfaces/IBrokerDefiPro.sol";
...
contract BrokerDefiPartner is ERC721, Ownable, ReentrancyGuard {
    ...
    address public BROKER_DEFI_PRICE_CONSUMER;
    ...
    function setCode(uint tokenId) private {
        uint code = (block.timestamp + tokenId) % 10000000;
