...
// File @openzeppelin/contracts-upgradeable/utils/escrow/[email protected]
    ...
    UUPSUpgradeable
{
    ...
    function setArtpoint(address art) external onlyRole(DEFAULT_ADMIN_ROLE) {
        artpoint = art;
    }
    ...
    function redeem(
        ...
        require(
            ...
            "Redeem - Invalid signature"
        );
        //  PullPaymentUpgradeable._asyncTransfer(bank, msg.value); // The bank will withdraw later

        IArtpoint(artpoint).safeMint(account, tokenId, uri);
    }
