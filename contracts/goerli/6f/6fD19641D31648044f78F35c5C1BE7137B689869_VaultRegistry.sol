    ...
    IVaultRegistry
{
    ...
    //Total vault count, starts from 1
    ...
    function createVault(
        ...
        emit VaultCreated(msg.sender, deployedAddress, _tokenId);
...
// SPDX-License-Identifier: BUSL-1.1
pragma solidity 0.8.12;
pragma abicoder v2;  //Used this beacuse function getAssetSymbols uses string[2]
