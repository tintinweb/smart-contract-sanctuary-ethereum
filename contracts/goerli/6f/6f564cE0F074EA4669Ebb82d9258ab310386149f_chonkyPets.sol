...
pragma solidity ^0.8.0;
  ...
  uint256 public cost = 0 ether; // FreeMint for Larva Chad Holders - Others at 0.0069 eth - 6900000000000000 wei
  ...
  IMain Main = IMain(mainAddress); //Address of NFT contract that's the key for WL Mint
  ...
  function whitelistMint(uint8 _mintAmount) external  {
   ...
   function setWLenabled() external onlyOwner {
    WLenabled = !WLenabled;
    paused = true;
    }
