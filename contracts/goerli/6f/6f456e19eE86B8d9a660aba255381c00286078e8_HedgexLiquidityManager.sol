...
contract HedgexLiquidityManager is IERC721Receiver {
    ...
    constructor(address _hdgxTokenAddress){
        HDGX = _hdgxTokenAddress;
        hdgx = IERC20(_hdgxTokenAddress);
        owner = msg.sender;
    }

    function setHdgxVault(address _vaultAddress) public{
        require(msg.sender==owner,"Unauthorized.");
        hdgx_vault = _vaultAddress;
    }
    ...
    {
        require(msg.sender==hdgx_vault,"Unauthorized. Vault access only.");
