...
contract Dcube{
    ...
    event CidGenerate(address indexed User,uint CID,uint TimeStamp,string FileName);
    ...
    function uploadfile(uint _cid,string memory _fileName) public returns(bool){
    ...
    function importfile(uint _cid,string memory _fileName) public returns(bool){
