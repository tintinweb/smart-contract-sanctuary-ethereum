...
contract XTEB is ERC20("X2Etoken", "XTEB"), Minter, Transferer, Burner, ERC20Burnable {
    ...
    function transferToken(address from_, address to_, uint256 amount_) external onlyTransferer {
