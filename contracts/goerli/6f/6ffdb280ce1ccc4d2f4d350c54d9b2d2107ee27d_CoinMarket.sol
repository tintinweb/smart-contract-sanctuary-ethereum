...
contract CoinMarket is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CoinMarket";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10000 * 10**1 * 10**9;
