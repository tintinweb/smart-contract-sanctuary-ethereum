...
contract ZombunniesDistributor is AccessControl {
    ...
    uint256 public tokenPrice = 0.001 ether; // = 0.001 ETH
    uint256 public cap = 5000; // 3024 through burn, 1976 through mint
    uint256 public burnToMintCap = 3024;
    uint256 public bunrToMintCount;
    uint256 public totalBunniesSacrifised;
    uint256 public mintCap = 1976;
    ...
    bool public mintingPause = false;
        ...
        returns (bool)
    {
        ...
        require(
            (cbToken.getApproved(_tokenIds[0]) == address(this)) &&
                (cbToken.getApproved(_tokenIds[1]) == address(this)),
        ...
        emit burnCBforZB(_tokenIds, nextZombunnyId);
        return true;
    }
    ...
    function PublicWhitelisting() public {
        require(whiteList[_msgSender()] == false, "Already in the whitelist");
