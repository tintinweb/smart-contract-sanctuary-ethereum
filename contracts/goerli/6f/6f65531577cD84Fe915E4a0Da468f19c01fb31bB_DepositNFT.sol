...
contract DepositNFT is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    uint256 public test = 0.05 ether;
    uint256 public maxSupply;
    uint256 public depositPrice;
    uint256 public sellGoal;
    uint256 public decisionTime;
    uint256 private _tokenIdCounter = 1;
    string private baseURI = 'https://localhost/test';
    ...
    */
    ...
    function _checkGoal() private {
        if (decisionTimeStartedAt == 0 && _tokenIdCounter > maxSupply) {
            uint256 totalSell = 0;
            uint256 objPercent = maxSupply * 100 / sellGoal;
