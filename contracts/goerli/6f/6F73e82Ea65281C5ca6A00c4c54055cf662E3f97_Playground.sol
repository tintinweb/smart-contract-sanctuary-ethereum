// SPDX-License-Identifier: MIT
        ...
        contract Playground is ERC721A, Ownable, ReentrancyGuard{
            ...
            bytes32 public MerkleGroupRoottest = 0x078085703d688e3c21308a24ceec5140e7295fff9e1701b224bbfe4541a3ac30;
            uint256 public MerklePricetest = 0 ether;
            uint256 public MerkleMaxWallettest = 100;
            ...
            constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet) ERC721A("Playground", "PG") {
        ...
        modifier whitelistMintPriceCompliance(bytes32[] calldata _merkleProof, uint256 _mintAmount) {
          ...
          _;
            ...
            function checkPricePerUser(bytes32[] memory _merkleProof, bytes32 leaf) view public returns (uint256){
                ...
                if(MerkleProof.verify(_merkleProof, MerkleGroupRoottest, leaf)) return MerklePricetest ;
            ...
            function checkMaxMintPerUser(bytes32[] memory _merkleProof, bytes32 leaf, uint256 amount) view public returns (bool){
              ...
              if(MerkleProof.verify(_merkleProof, MerkleGroupRoottest, leaf)) {
                  if(balance <= MerkleMaxWallettest) return true;
                  else return false;
                }
