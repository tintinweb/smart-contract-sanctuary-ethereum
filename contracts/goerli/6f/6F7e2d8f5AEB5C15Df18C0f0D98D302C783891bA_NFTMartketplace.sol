    ...
    PriceFeed
{
    ...
    function getNFTPrice(uint256 _nftPrice) public view returns (uint256){
    
        
        uint result = PriceFeed.getEthPrice() * (_nftPrice);
...
// implementation contract ---- 0x6F7e2d8f5AEB5C15Df18C0f0D98D302C783891bA