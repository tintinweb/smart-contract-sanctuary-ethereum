...
contract GH0STINTH3CITY is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 666;
    uint256 public TEAM_MINT_MAX = 0;
    ...
    string public revealedURI = "ipfs://bafybeiewspcujy4uiittliimsa2woc523jtr7l6j4bgstmhh7vniytoyv4/";

    string public hiddenURI = "ipfs://Qmb4UnZEq4taUQKLakuDbg3pDXHUmVNt16HWTG3oC6f5dt";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://Qmb4UnZEq4taUQKLakuDbg3pDXHUmVNt16HWTG3oC6f5dt";

    bool public paused = true;
    bool public revealed = false;
    bool public publicSale = true;

    address constant internal CHARITY_ADDRESS = 0xbBb4885AF5BA71F4E8cC3cB6b94bc155910095B6;
    address public teamWallet = 0x716F328933Dc617C06C25F35f550277b062A3E99;

    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("GH0STINTH3CITY", "GHST") {}
    ...
    */
    ...
    function teamMint(uint256 quantity) public payable mintCompliance(quantity) {
        ...
        require(totalSupply() >= 10, "Team mints after public sale");
    ...
    */
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool succ, ) = payable(CHARITY_ADDRESS).call{
            value: (currBalance * 4500) / 10000
        }("");
