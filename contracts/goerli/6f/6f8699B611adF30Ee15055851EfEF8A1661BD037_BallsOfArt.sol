    ...
    function generateFinalSvg(
        ...
        string memory finalSvg = string(
            abi.encodePacked(
                ...
                '<defs>' '<style>' '.bg{fill:none} .bg:hover{fill:aquamarine}' '</style>' '</defs>',
                backgroundCode,
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name": "Balls of Art #',
                                uint2str(tokenId),
                                '", "description": "Balls of Art are an assortment of 111 fully on-chain, randomly generated, happy art balls", "attributes": "", "animation_url":"data:image/svg+xml;base64,',
