...
contract a404 is ERC721ATLMerkle, BlockList, StoryContract {
    ...
    ERC721ATLMerkle(name, symbol, royaltyRecipient, royaltyPercentage, price, supply, merkleRoot, admin, payout)
    BlockList()
    StoryContract(true)
    {
        // blocklist
