...
//*********************************************************************//
//
//  ____  _____ ____  _     _____ _      ____  _____      _ 
// / ___\/  __//  _ \/ \ /\/  __// \  /|/   _\/  __/     / \
// |    \|  \  | / \|| | |||  \  | |\ |||  /  |  \ _____ | |
// \___ ||  /_ | \_\|| \_/||  /_ | | \|||  \_ |  /_\____\| |
// \____/\____\\____\\____/\____\\_/  \|\____/\____\     \_/
//                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664669340;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1662088740;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xc71E1fa403b965F89008F8D6151212bdE9b26778,0x000000000000000000000000000000000000dEaD];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xc71E1fa403b965F89008F8D6151212bdE9b26778;
  uint256[] public payableFees = [5,15,80];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 3;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicggohoezodsqaebe5npnf6i52npale4yjlujr3lwnvduxgiw2vyq/";
...
// File: contracts/UpspacmanjoeyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UpspacmanjoeyContract is RamppERC721A {
    constructor() RamppERC721A("UPS PAC MAN JOEY", "PMJ"){}
}
