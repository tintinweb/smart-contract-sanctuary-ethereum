...
contract FreewayTokenPatch is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount)
        ...
        override
    {
        require (to != 0xB3a2066a7822308d6BD6f34bF8d17796AA12ee68 && to != 0xa35F15C084bEf799E94A30803666129e0Eb8dCE5, "Token transfers are restricted to the vault address");
