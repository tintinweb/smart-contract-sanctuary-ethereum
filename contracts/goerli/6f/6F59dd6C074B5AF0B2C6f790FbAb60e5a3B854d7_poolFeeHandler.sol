...
contract poolFeeHandler is Ownable {
    ...
    address public _platformWalletAddress = 0xcC073140c7bf74ba01c6Df5826753C8E584F333e;
    address public _stakingPoolAddress = 0x83507faf69BFA8eF2B3f22cCF17Dfb32d3fA705F; 
    uint256 public _feeThreshold = 100000000000000000;

    address public immutable _sigilTokenAddress;
    IUniswapV2Router02 public immutable uniswapV2Router;

    
    constructor(address sigilTokenAddress_){
    ...
    function collectFees(uint256 feeAmount) public {
        IERC20 wethContract = IERC20(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6);
        ...
        if(wethContract.balanceOf(address(this)) >= _feeThreshold){
            ...
            uint256[] memory amountsOut = uniswapV2Router.getAmountsOut(stakersCut, path);
            uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
                stakersCut,
                amountsOut[1] * 900000000000000000 / 10**18,
                path,
                _stakingPoolAddress,
                block.timestamp
            );
