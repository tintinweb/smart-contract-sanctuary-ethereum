...
contract OrangeadNFT is ERC721A, Ownable {
    ...
    uint256 private mintPricePresale = 3 ether;
    ...
    modifier NoSaleOnly() {
        require(
            ...
            "Presale state has already been activated!"
        );
        _;
    }
    ...
    constructor() ERC721A("OrangeadNFT", "OA") {
        ...
        unrevealedURI = "ipfs://QmYv8eVois1VUacK46cVLbvS7GBXBGHjnKz7oZrgpCxGmf/";
    }
    ...
    /**
     * @dev revert() the renounceOwnership() function
     */
     ...
     * @param _baseTokenURI New base URI for the metadata
     */
     ...
     * @param _maxSupply New total supply of the contract
     */
    function setMaxSupply(uint256 _maxSupply) public onlyOwner NoSaleOnly {
        maxSupply = _maxSupply;
    }

    /**
     * @dev Set the new maximum allowed amount of mints per address, only at NoSale state
     * @param _maxMint New maximum allowed amount of mints per address
     */
    function setMaxMintPresale(uint256 _maxMint) public onlyOwner NoSaleOnly {
        maxMintPresale = _maxMint;
    }

    /**
     * @dev Set new minting price, Presale phase
     * @param _mintPrice New minting price
     */
    function setMintPricePresale(uint256 _mintPrice) public onlyOwner NoSaleOnly {
     ...
     */
    function setToPresale() public onlyOwner NoSaleOnly {
    ...
    function presaleMint(uint256 _quantity) public payable {
        ...
        require(
            _quantity <= maxMintPresale,
            "Maximum allowed amount of mint is exceeded!"
        );
     ...
     * @return The URI for the given _tokenId
     */
        ...
        returns (string memory)
    {
        ...
        revealTime == 0 ? baseURI = _unrevealedURI() : baseURI = _baseURI();
    ...
    function burnTokens(string memory _message) public onlyOwner {
        require(
            ...
            "Confirmation message is not correct!"
        );
    ...
    /**
     * @dev Send a desired amount of funds to a shareholder´s wallet
     */
    ...
    /**
     * @dev Set the NFTs to be revealed
     */
     ...
     * @return 3 ETH if presale is open, 0 ETH otherwise
     */
     ...
     */
    function freelySetMaxSupply(uint256 _totalSupply) public onlyOwner {
        maxSupply = _totalSupply;
    }

    /**
     * @dev Set the new maximum allowed amount of mints per address
     */
    function freelySetMaxMintPresale(uint256 _newMaxMint) public onlyOwner {
        maxMintPresale = _newMaxMint;
    }
     ...
     */
    function freelySetMintPricePresale(uint256 _mintPrice) public onlyOwner {
        mintPricePresale = _mintPrice;
    }
}
