...
contract sosstester2 is ERC721A, Ownable {
    uint256 public constant MINT_PRICE = 0.0000505 ether;
    uint256 public constant MAX_SUPPLY = 20;
    uint256 public constant MAX_PER_WALLET = 20;
    uint8 public constant MAX_PER_WALLET_WHITELIST = 3;
    bytes32 public merkleRoot = 0xffecf00f2d295e6965208dc3b9957f2636ae9945b9134432d5e62784c742c403;
    mapping(address => uint8) private _whiteList;
    constructor() ERC721A("sosstester2", "sosstester2") {}
    ...
    function setWhiteList(address[] calldata addresses) external onlyOwner {
        for (uint256 i = 0; i < addresses.length; i++) {
            _whiteList[addresses[i]] = MAX_PER_WALLET_WHITELIST;
        }
    }

    function mintWhiteList(uint8 numberOfTokens) external payable hasCorrectAmount(msg.value, numberOfTokens)
        withinMaximumSupply(numberOfTokens) {
        uint256 ts = totalSupply();
        require(whitelistSale, "Allow list is not active");
    ...
    address private constant treasuryAddress =
        0x31A25B951d27854dA2ff117d4886e7c35891f21c;
