...
contract ERC1155Mock is IAnimeMetaverseReward, Ownable {
    ...
    function COMPONENT_TOKEN_TYPE() external view override returns(uint256) {
        return 3;
    }
    function BOOSTER_TOKEN_TYPE() external view override returns(uint256) {
        return 4;
    }
