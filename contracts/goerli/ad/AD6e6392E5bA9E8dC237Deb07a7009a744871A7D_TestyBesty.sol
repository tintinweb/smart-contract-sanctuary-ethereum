...
contract TestyBesty is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    bool public saleActive;
        ...
        constructor() ERC721A("TestyBest", "TestyBesty") {}

    function mint(uint256 _amount) external payable nonReentrant {

        require(msg.value == _amount * mintPrice, "Not enough ETH sent.");
        require(totalSupply() + _amount <= maxSupply, "Sold out! Best of luck on secondary.");
        require(tx.origin == msg.sender, "The caller is another contract");
        require(saleActive, "Sale not live keener");
        require(numberMinted(msg.sender) + _amount <= maxPerWallet, "You're already a max minter");
        require(_amount <= maxPerTx, "Don't be greedy ser");
