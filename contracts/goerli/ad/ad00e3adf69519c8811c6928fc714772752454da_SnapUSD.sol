...
/**
 * @title Snap USD
 * @dev Snap implementation of ERC20 token for SUSD stable coin 
 */
...
contract SnapUSD is ERC20PresetMinterPauser {
    ...
    /**
     * @dev gets the amount of allowance a minter has
     */
    function getMinterAlloance(address _minter) public view returns (uint256) {
    ...
    /**
     * @dev minting new tokens if have MINTER or ADMIN role and enough allowance
     */
