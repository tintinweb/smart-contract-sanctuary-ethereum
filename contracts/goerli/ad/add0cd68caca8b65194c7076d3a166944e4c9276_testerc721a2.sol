...
contract testerc721a2 is Ownable, ERC721A, ReentrancyGuard {
    bool publicSale = true;
    uint256 nbFree = 12;
    uint256 public price = 0.0009 ether;

    constructor() ERC721A("Test", "TST", 4, 50) {}
    ...
    function freeMint(uint256 quantity) external callerIsUser {
        ...
        require(quantity <= 4, "can not mint this many free at a time");
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        require(quantity <= 4, "can not mint this many at a time");
        require(
