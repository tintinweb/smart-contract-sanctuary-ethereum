...
contract PositionRouter is BasePositionManager, IPositionRouter {
    ...
    function _callRequestCallback(
        ...
        bool success;
        try IPositionRouterCallbackReceiver(_callbackTarget).divPositionCallback{ gas: _gasLimit }(_key, _wasExecuted, _isIncrease) {
            success = true;
        } catch {}
...
interface IPositionRouterCallbackReceiver {
    function divPositionCallback(bytes32 positionKey, bool isExecuted, bool isIncrease) external;
}
