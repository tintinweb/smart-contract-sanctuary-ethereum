...
contract BattleRoyaleNFT is IBattleRoyaleNFT, ERC721Enumerable, Ownable, ReentrancyGuard, EIP712, DefaultOperatorFilterer {
    ...
    mapping(address => uint) private _mintedByAddress;
    ...
    function mint(uint amount) external payable {
        require(_mintedByAddress[msg.sender] + amount <= MAX_PER_WALLET, "mint too many");
        _mintedByAddress[msg.sender] += amount;
    ...
    function mintWL(uint8 v, bytes32 r, bytes32 s) external {
        require(_mintedByAddress[msg.sender] == 0, "minted");
        _mintedByAddress[msg.sender] = WL_MINT_AMOUNT;
