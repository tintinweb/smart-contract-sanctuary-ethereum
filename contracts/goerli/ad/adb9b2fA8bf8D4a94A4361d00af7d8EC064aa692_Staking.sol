...
contract Staking is ReentrancyGuard {
    ...
    uint256 public constant REWARD_RATE = 100000000000000000;
    ...
    constructor(IERC20 _nftCollection, IERC20 _rewardsToken) {
        ...
        moreThanZero(amount)
    {
        ...
        bool success = nftCollection.transferFrom(msg.sender, address(this), amount);
        if (!success) {
    ...
    function withdraw(uint256 amount) external updateReward(msg.sender) nonReentrant {
        ...
        bool success = nftCollection.transfer(msg.sender, amount);
        if (!success) {
            revert TransferFailed();
        }
    }
