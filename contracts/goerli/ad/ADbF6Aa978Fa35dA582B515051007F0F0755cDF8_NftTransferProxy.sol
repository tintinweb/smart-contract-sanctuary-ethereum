  ...
  UUPSUpgradeable
{
   ...
   */
  function __NftTransferProxy_init(address uzuSharedCollectionAddress_)
    external
    initializer
  {
    __ERC165_init();
   ...
   */
  function setUzuSharedCollectionAddress(address newAddress)
    public
    virtual
    override
    onlyAdmin
  ...
  function proxyNftTransfer(
    ...
    if (isLazyMint) {
      ...
      if (collectionType == Domain.NFTKind.ERC721) {
        // ERC721
        require(transferAmount == 1, "NftTransferProxy: ERC721 invalid nft amount");
