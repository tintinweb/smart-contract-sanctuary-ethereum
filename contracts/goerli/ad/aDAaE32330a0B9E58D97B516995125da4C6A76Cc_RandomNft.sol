...
contract RandomNft is ERC721URIStorage, VRFConsumerBaseV2, Ownable {
    ...
    constructor(
    ...
    ) VRFConsumerBaseV2(vrfCoordinatorV2) ERC721("Kung Fu Panda", "KFP") {
        ...
        s_tokenCounter = 0;
        i_mintFee = mintFee;
        _initializedContract(tokenUris);
    }
        ...
        override
    {
        ...
        _setTokenURI(tokenId, s_tokenUris[uint256(character)]);
        emit NftMinted(character, owner);
    }
    ...
    function _initializedContract(string[3] memory tokenUris) private {
        if (s_initialized) {
