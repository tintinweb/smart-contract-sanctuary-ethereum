...
contract Airdrop is OwnableExt {
    ...
    */
    ...
    function addCollection(
        address collection
    ) external virtual onlyAdmin checkRemoveCollection(collection) {
    ...
    function removeCollection(
        address collection
    ) external virtual onlyAdmin checkAddCollection(collection) {
...
contract Presale is Airdrop {
    ...
    function addCollection(address collection) external override {}
    ...
    function removeCollection(
        address collection
    ) external override onlyAdmin checkAddCollection(collection) {
    ...
    function burnAll(address collection, uint256 amount) external onlyAdmin {
        ERC721Collection erc721 = ERC721Collection(collection);
    ...
    function withdraw(address _collection, uint256 _amount) external onlyAdmin {
        IERC20 erc20 = IERC20(collectionInformations[_collection].erc20Address);
        ERC721Collection collection = ERC721Collection(_collection);

        require(
            !collection.isBurnt() &&
                (collection.totalSupply() == collection.maxSupply()),
            "Collection is not sold"
        );
        ...
        if (_amount <= balanceContract) {
            erc20.safeTransfer(ownerContract, _amount);
        } else {
            erc20.safeTransfer(ownerContract, balanceContract);
        }
    }
    ...
    function getTokens(
        ...
        erc20.safeTransferFrom(msg.sender, address(this), cTotalPrice);
    ...
    function returnFunds(
        address collection
    ) external checkAddCollection(collection) {
        ERC721Collection erc721 = ERC721Collection(collection);
    ...
    function getTotalPriceCollection(
        ...
        Collection storage collectionInformation = collectionInformations[
            _collection
        ];
    ...
    function _beforeAddCollection(
        ...
        require(
            ...
            "Presale: 'startWhitelistTimestamp' must be less than 'startPublicTimestamp'!"
        );
        require(
        ...
        require(
            ...
            "Presale: 'startPublicTimestamp' must be less than 'stopTimestamp'!"
        );
    }
