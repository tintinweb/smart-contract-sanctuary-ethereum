...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1670256000;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeidenyrmeeajgsuiax2t4rhfb6y2kbu4wcnpxyqrhmgof2zjpo3bq4/";
...
contract TeruContract is RamppERC721A {
    constructor() RamppERC721A("TERU", "TR"){}
}
