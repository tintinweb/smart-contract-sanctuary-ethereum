...
{    
    ...
    { 
        ...
        if(MintPassSale._ActiveBrightList) { require(VerifyBrightList(msg.sender, Proof, MintPassSale._Root), "Merkle: User Is Not On BrightList"); }
    ...
    function PurchaseMintPack(uint Amount, bytes32[] calldata Proof) public payable nonReentrant
    {
        ...
        if(MintPackSale._ActiveBrightList) { require(VerifyBrightList(msg.sender, Proof, MintPackSale._Root), "Merkle: User Is Not On BrightList"); }
        ...
        _MintPackPurchasedAmt[msg.sender] += Amount;
