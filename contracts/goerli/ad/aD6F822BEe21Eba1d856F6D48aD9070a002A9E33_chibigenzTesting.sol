...
contract chibigenzTesting is ERC721A, ERC2981, OperatorFilterer, Ownable {
    ...
    address public constant TeamWallet = 0xb192856bb4DB441B61dB4C8FA88bc72a6a500DeF;
    mapping(address => uint256) public _walletMints;
    

    constructor() ERC721A("Chibigenztesting", "CBZtesting"){
