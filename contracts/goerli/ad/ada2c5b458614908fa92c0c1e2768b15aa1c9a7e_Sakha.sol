...
contract Sakha is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Sakha", "SG") {}
 
    address Employee;
 
    modifier empOnly() {
        require(msg.sender == address(Employee),"Employee only operation");
        _;
    } 
 
    function setemp(address emp) public onlyOwner {
        Employee = emp;
    }
 
    function safeMint(address to) public empOnly {
   ...
   function _beforeTokenTransfer(address from, address to, uint256)
       pure override(ERC721, ERC721Enumerable) internal
    {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "ipfs://QmbqXQtmGmDdutByKC3EC9zY4ZH6QBF7T5zLdPEVAxK8y8/";
    }
}