...
contract GoldenBone is ERC721A, Ownable {
    ...
    constructor(address _pixelPuppersAddress) ERC721A("GoldenBone", "GBN") {
        ...
        pixelPuppersContract = IPixelPuppers(_pixelPuppersAddress);
    }
    ...
    function claimBone(uint16[] calldata _pupperTokenIds) public callerIsUser {
        ...
        require(_pupperTokenIds.length == 4, "Must provide 4 pupper token ids");
    ...
    function setIsActive(bool _isActive) public onlyOwner { // TODO: Add to testcases
        isActive = _isActive;
    }
