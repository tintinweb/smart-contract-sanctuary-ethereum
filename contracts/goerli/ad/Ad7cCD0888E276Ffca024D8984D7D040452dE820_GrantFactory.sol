...
//SPDX-License-Identifier: MIT
/**
This is my take on a grant funding contract. As I am unsure of some of the points made, here are my assumptions:
- the deployer is the grant creator and funder
- therefore, no one else is able to fund the grants
 */
