...
contract PriceFeed is IPriceFeed {
  ...
  uint32 public constant UPDATE_INTERVAL = 100; // replace with 30 minutes;
    ...
    returns (uint128 harmonicMeanLiquidity, int56[] memory tickCumulatives)
  {
    ...
    if (success) {
      ...
      // We are multiplying here instead of shifting or using a constant to ensure that harmonicMeanLiquidity
      // doesn't overflow uint128
      // uint192 secondsAgoX160 = 100 * type(uint160).max;
