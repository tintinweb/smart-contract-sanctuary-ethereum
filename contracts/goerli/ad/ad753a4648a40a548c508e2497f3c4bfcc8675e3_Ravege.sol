...
// A Ravege Edition ERC721 

// Calling mint mints a random  ravege until 10,000 have been minted
...
contract Ravege is ERC721, Ownable, RandomlyAssigned {
  ...
  string public baseURI = "https://ipfs.io/ipfs/bafybeiblu3xjy5oy3mmzigjs26kipjkkaaq3fegbxd6n5z22gnhiymu3hq/";

  constructor() 
    ERC721("Ravege", "ravege")
    RandomlyAssigned(4000,1) // Max. 4000 NFTs available; Start counting from 1 (instead of 0)
    {
