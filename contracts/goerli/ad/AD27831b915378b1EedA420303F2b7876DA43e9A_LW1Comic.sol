    ...
    ERC721EnumerableUpgradeable
{
    ...
    function mint(uint256 _qty) external payable {
        ...
        require(msg.value >= (discountPrice>0?discountPrice*discountList[_to]: 0) + mintPrice*(_qty-(discountPrice>0?discountList[_to]: 0)), "You need to pay more");
        require(getQty(_to, 0)+(discountList[_to]>0?discountList[_to]:0)>=_qty, "You cannot buy this amount of NFTs");
