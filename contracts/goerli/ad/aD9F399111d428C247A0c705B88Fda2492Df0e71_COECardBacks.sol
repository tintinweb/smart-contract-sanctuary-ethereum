...
//        d8888        888   888                     .d8888b.
//       d88888        888   888                    d88P  Y88b
//      d88P888        888   888                    888    888
//     d88P 888 .d88b. 88888888888b.  .d88b. 888d888888        8888b. 88888b.d88b.  .d88b. .d8888b
//    d88P  888d8P  Y8b888   888 "88bd8P  Y8b888P"  888  88888    "88b888 "888 "88bd8P  Y8b88K
//   d88P   88888888888888   888  88888888888888    888    888.d888888888  888  88888888888"Y8888b.
//  d8888888888Y8b.    Y88b. 888  888Y8b.    888    Y88b  d88P888  888888  888  888Y8b.         X88
// d88P     888 "Y8888  "Y888888  888 "Y8888 888     "Y8888P88"Y888888888  888  888 "Y8888  88888P'
...
contract COECardBacks is ERC1155, ERC1155Burnable {
  struct Token {
    uint256 mintCount;
    uint256 price;
    string uri;
  ...
  mapping(uint256 => Token) private tokens; //tokenID => Token struct
  mapping(address => uint256) public addressMinted; //address => amount minted
  uint256 public randomPrice; //price to mint a random token (in $AEG)
  ...
  constructor() ERC1155("") {
    ...
    //create a token for each rarity <-----------------  REMOVE WHEN NOT TESTING
  ...
  // this function will be called from the burn and mint contract to mintRandom AND mint from fp
  function fpMint(
    address _address,
    uint256 _id,
    uint256 _amount
  ) public payable onlyRole(MINTER) {
    ...
    addressMinted[_address] += _amount;
  }
  ...
  //override burn function to update mintCount or maxsupply.  problem is that what if people burn before the token is minted out?
  //currently burning doesn't update totalsupply
  //might need to add a burnCount to the struct
  ...
  function addNewTokens(
    ...
    require(
      // _ids.length == _maxSupplies.length &&
    ...
    for (uint256 i = 0; i < _ids.length; i++) {
      ...
      newToken.price = _price[i];
      newToken.uri = _uris[i];
      newToken.exists = true;

      if (isNew) totalTokens++;
    }
  }
  ...
  // function randomPrice() public view returns (uint256) {
  //   return randomPrice;
  // }
  ...
  //   uint256[] memory amounts,
  //   bytes memory data
  // ) internal override(ERC1155, ERC1155Pausable) whenNotPaused {
