...
contract AnimeMetaverseMerchandise is NFTokenMetadata, Ownable {
    /**
    ...
    /**
     * @dev Map of how many NFTs have been airdropped per address.
     */
    ...
    /**
     * @dev constractor for AnimeMetaverseMerchandise. During the contract creation set the tokenName
     * and tokenSymbol.
     */
    constructor() {
        nftName = "Soulmate Merch Line";
        nftSymbol = "AMM";
    }
    ...
    function setMaxAirdropLimit(uint256 _airdropLimit) external onlyOwner {
         ...
         */
        require(
            _airdropLimit + current_minted <= maxNft,
    ...
    /**
     * @notice The Contract Owner is responsible to confirm that `_URI` is the base URL for
     * token metadata and provides metadata with format <_URI><tokenID>.json
