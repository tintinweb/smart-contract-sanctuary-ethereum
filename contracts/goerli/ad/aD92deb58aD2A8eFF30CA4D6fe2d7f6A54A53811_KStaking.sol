...
contract KStaking is Ownable, ReentrancyGuard {
    ...
    bool public _active;
    uint256 public rewardsPerHour = 0;
    ...
    modifier isApprovedForAll() {
        require(
            ...
            "Must approved contract permissions first."
        );
        _;
    }

    function stake(uint256[] calldata _tokenIds) external nonReentrant isApprovedForAll {
    ...
    function claimRewards() external {
        require(_active, "Claiming rewards is currently disabled");
        uint256 rewards = calculateRewards(msg.sender) +
