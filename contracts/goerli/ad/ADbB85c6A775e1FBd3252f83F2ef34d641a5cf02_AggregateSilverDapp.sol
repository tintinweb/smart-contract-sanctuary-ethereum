...
contract AggregateSilverDapp is ERC20, Ownable {
    ...
    constructor() ERC20("Aggregate Silver Dapp", "ASD") {
        ...
        uint256 totalSupply = 10000000000*decimals();
    ...
    function excludeFromMaxTransaction(address updAds, bool isEx) external onlyOwner {
        if(!isEx){
            require(updAds != PairAddress, "Cannot remove UNIV2 pair from max txn");
        }
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        // generate the UNIV2 pair path of token -> weth
