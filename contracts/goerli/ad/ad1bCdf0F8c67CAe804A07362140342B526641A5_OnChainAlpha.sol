...
contract OnChainAlpha is ERC721A, ReentrancyGuard, Ownable {
    ...
    string[] private LAYER_NAMES = [unicode"Light Saber", unicode"Outwear", unicode"Headwear", unicode"Mouth", unicode"Ears", unicode"Eyes", unicode"Body", unicode"BodyRing", unicode"Background"];
    ...
    constructor() ERC721A("On-Chain Alpha", "OCA") {
        TIERS[0] = [8999,300,50,100,550];
        TIERS[1] = [7099,300,400,700,700,500,100,200];
        TIERS[2] = [3000,100,100,100,100,100,100,100,100,100,100,100,100,100,100,200,300,300,300,300,300,300,300,300,300,500,500,500,500,200,500];
        TIERS[3] = [0,100,100,100,100,100,200,200,200,200,200,200,300,300,300,300,400,400,400,400,400,500,500,500,500,1000,2100];
        TIERS[4] = [0,500,1000,2000,2500,4000];
        TIERS[5] = [0,100,100,100,100,100,100,100,200,200,200,200,200,200,300,300,300,300,300,300,300,300,300,300,300,400,400,400,400,400,400,400,500,500,1000];
        TIERS[6] = [50,150,500,700,900,900,1000,1600,2000,2200];
        TIERS[7] = [50,100,700,200,500,1000,5449,2000];
        TIERS[8] = [0,700,4000,1200,1000,100,3000];
    }
        ...
        returns (string memory)
    {
        ...
        for (uint i = 0; i < NUM_LAYERS; i++) {
            ...
            if(!_traitDetails[i][0].name.compareTo("_")){
