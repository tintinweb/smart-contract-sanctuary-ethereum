...
contract LunarWitch is ERC721A, DefaultOperatorFilterer, Ownable, PaymentSplitter {
    ...
    */
    ...
    address[] private teamWallets = [
        0xE3c223d4180BC03d7fa2350eF0148E3eA8eC0e3d, 
        0x2902FE8CbCf1cCeB73AF6217070D1b97FFAaACDf, 
        0x7ed64be1BBd96425Ce5074c010807B3632f8FC4D, 
        0x3426c74CdB7B677a139a702A79350fb492910921, 
        0x10D348f61Cc5BC7f091d9db094f85138Bcaff80A, 
        0x4A2500c8da4cbdc32420E19Ac8562D80F702ea0d
    ];
    ...
    constructor()
        PaymentSplitter(teamWallets, teamShares)
        ERC721A("Test 0501-01", "TEST050101")
    {}
