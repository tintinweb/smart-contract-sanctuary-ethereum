...
/**
    Test Token
 */
contract TestTokenEthereum is ERC20, ERC20Permit, AccessControl {
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    constructor(address predicateProxy) ERC20("TEST TOKEN (Ethereum)", "TEST") ERC20Permit("TEST TOKEN (Ethereum)") {
