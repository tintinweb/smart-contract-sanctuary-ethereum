...
// Defines a contract name `HelloWorld`
// A contract is a collection of functions and data (its state). Once deployed, a contract resides
// at a specific address on the Ethereum blockchain. Learn more:
...
contract HelloWorld {
    ...
    // on the blockchain to your front-end, which can be listening for certain events and take 
    ...
    // Constructors are used to initialize the contracts data. Learn more:
