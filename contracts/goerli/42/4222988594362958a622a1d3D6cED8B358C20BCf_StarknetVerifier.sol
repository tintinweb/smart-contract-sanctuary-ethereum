...
contract StarknetVerifier is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function verifiedStorageValue(
        ...
        require(
            ...
            "block number is doesn't match with starknet core contract!"
        );
        ...
        require(stateHash > 0, "stateroot hash is not fetched completed.");
        ...
        require(
            ...
            "hashes don't match. hashes are different!"
        );
