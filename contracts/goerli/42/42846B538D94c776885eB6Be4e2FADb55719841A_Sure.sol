...
contract Sure is ERC20, Ownable {
    ...
    constructor() ERC20("Sure", "SURE") {
        ...
        // devWallet = address(0x779Bd9D7E3f2571a7Dc7B3Be5fFF1a281a9b9649);

        _mint(msg.sender, _totalSupply);
    }

    // function sure() external payable onlyOwner {
    //     // Launch the token
    ...
    //     // Initial Allocations: 94% Liquidity; 2% Marketing; 4% Dev
    ...
    //     // Before Adding LP, contract must hold tokens (not owner)
    ...
    function setMaxWalletSize(uint256 maxWalletSize) external onlyOwner {
        ...
        // );
        // require(maxWalletSize > 0, "Max wallet size must be greater than 0");
    ...
    // function setTaxOff(bool _taxOff) external onlyOwner {
    //     taxOff = _taxOff;
    // }
    ...
    function _transfer(
        ...
        // Skip checks if adding LP
        // if (_addingLP) {
        //     super._transfer(from, to, amount);
        //     return;
        // }
        // TODO: check if we should skip checks for owner
        // // // Skip checks if the sender or recipient is the owner
        ...
        if (from != owner() && to != owner()) {
            ...
            require(amount <= _maxWalletSize, "Amount exceeds maximum wallet size");
    ...
    //     // Need enough tokens under contract address else fails
