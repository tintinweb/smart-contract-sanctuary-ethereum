...
contract GLORYHOUSE is Context, IERC20, Ownable { //!
    ...
    uint256 private _buyCount=0; //! private

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1000000 * 10**_decimals;
    string private constant _name = unicode"GLORYHOUSE"; //! 
    string private constant _symbol = unicode"GLORYHOUSE"; //!
