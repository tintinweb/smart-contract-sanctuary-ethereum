...
contract OathStoreTransactor is AccessControlEnumerable, Signable, Pausable, ReentrancyGuard {
    ...
    function buyTokens(GenericBuyV3Lib.GenericBuyV3 calldata buy) public payable whenNotPaused nonReentrant {

        console.log("buy.paymentToken   ", buy.paymentToken);
        console.log("isAllowedToken[buy.paymentToken]   ", isAllowedToken[buy.paymentToken]);
        ...
        if (paymentToken == ETH_CONSTANT) {
            ...
            IERC20(paymentToken).safeTransfer(multisig, buy.totalPrice);
        } else {
