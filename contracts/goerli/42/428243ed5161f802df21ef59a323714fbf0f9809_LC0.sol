...
contract ERC20 is Context {
    ...
    function transferFrom(
        ...
        require(_balances[from] >= amount, "balances not enough");
    ...
    {
        // TODO: use `_approve` defined later in the contract
        require(spender != address(0), "ERC20: add to the zero address");
    ...
    {
        // TODO: use `_approve` defined later in the contract
        require(spender != address(0), "ERC20: subtract to the zero address");
        require(_allowances[msg.sender][spender] >= subtractedValue, "ERC20: allowance less than substractvalue");
        unchecked {
            _approve(_msgSender(), spender, _allowances[msg.sender][spender] - subtractedValue);
        }
        return true;
    }
    ...
    function _transfer(
        ...
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(_balances[from] >= amount, "ERC20: balance amount less than transfer amount");
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= amount, "ERC20: allowance is not enough");
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenYYL", "LCYYL") {}
}