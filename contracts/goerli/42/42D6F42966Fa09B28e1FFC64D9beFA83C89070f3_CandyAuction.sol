...
contract CandyAuction is Ownable, Pausable {
    ...
    constructor() {
        ...
        // candyshop = ICandyShop(0xf46AbB1865Fbef39c2a02B33C0EBAE2Fb9E897AB);
         // Mainnet
    ...
    function claim(address _to) public whenNotPaused {
        ...
        candies.mint(_to);
        emit Claimed(_to, bids[highBidderIndex(_to)].value);
    }
...
// View
    ...
    function highBidderIndex(address _addr) public view returns (uint) {
        ...
        revert("Address not found in high bidders.");
    }
