 ...
 * @notice This contract handles minting My penguin tokens.
 */
contract MyPenguin is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xFD4f9A31f09D8bf0B92CF4181a98beE0Db72303c;
    ...
    string public name = "My penguin";
    string public symbol = "PNGN";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeifh67eq3ok3v4veswcad2wkyquapwlosqsw5fleywzel5eu25k2pq/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 1000;
        tokenPublicPrice[1] = 0.01 ether;
        tokenPublicMintsPerAddress[1] = 1000;
        tokenPresaleMaxSupply[1] = 1000;
        tokenPresalePrice[1] = 0.005 ether;
        tokenPresaleMintsPerAddress[1] = 0;
        tokenMaxSupply[2] = 100;
        tokenPublicPrice[2] = 0.0003 ether;
        tokenPublicMintsPerAddress[2] = 100;
        tokenPresaleMaxSupply[2] = 100;
        tokenPresalePrice[2] = 0.0004 ether;
