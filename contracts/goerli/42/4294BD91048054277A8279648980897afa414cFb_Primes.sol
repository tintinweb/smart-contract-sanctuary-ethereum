...
contract Primes is ERC721r, Ownable {
    ...
    function setValues(uint x, uint y) internal pure returns (string memory) {
        string memory minV = PrimesUtils.getMinValuesAnimation(x, y);
        string memory maxV = PrimesUtils.getMaxValuesAnimation(x, y);
        return
            string(
                abi.encodePacked(
                    string(minV),
...
library PrimesUtils {
    ...
    function concatenate(
        ...
        result = string(abi.encodePacked(bytes(a), bytes(b)));
    }
    ...
    // function setValues(uint x, uint y) internal pure returns (string memory a) {
    //     string memory minV = getMinValuesAnimation(x, y);
    //     string memory maxV = getMaxValuesAnimation(x, y);
    //     return
    //         string(
    //             abi.encodePacked(
    //                 string(minV),
