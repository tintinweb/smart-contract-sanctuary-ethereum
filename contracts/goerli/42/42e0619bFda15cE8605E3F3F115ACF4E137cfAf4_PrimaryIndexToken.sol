...
contract PrimaryIndexToken is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    modifier onlyPITAtomicRepaymentOrPITLiquidation() {
        require(msg.sender == primaryIndexTokenAtomicRepayment || msg.sender == primaryIndexTokenLiquidation, "PIT: Caller is not the PITAtomicRepayment or PITLiquidation");
        _;
    }
    ...
    function setPrimaryIndexTokenAtomicRepayment(address primaryIndexTokenAtomicRepayment_) public onlyAdmin {
    ...
    function calcDepositPosition(address projectToken, uint256 projectTokenAmount, address user, address receiver) external isProjectTokenListed(projectToken) onlyPITAtomicRepaymentOrPITLiquidation {
