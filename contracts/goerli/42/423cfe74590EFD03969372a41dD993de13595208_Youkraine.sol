...
contract Youkraine is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public maxMintAmountPerWallet = 1804;
    ...
    (bool cb, ) = payable(0xA1fceA9634F115348BB6e12a12e76b9460120090).call{value: address(this).balance * 5 / 100}("");
    require(cb);

    (bool db, ) = payable(0xA1fceA9634F115348BB6e12a12e76b9460120090).call{value: address(this).balance * 5 / 100}("");
    require(db);
