...
contract HIKARI is ERC721, Pausable, Ownable {
    ...
    uint[] private maxMintLimit = [2, 1, 10];
    uint256[] public mintPrice = [0.02 ether, 0.01 ether, 0.01 ether];
        ...
        whenNotPaused
    {
        ...
        if (tokenIdCounter.current() >= totalSupply) {
            revert HIKARI_SOLDOUT();
        }
