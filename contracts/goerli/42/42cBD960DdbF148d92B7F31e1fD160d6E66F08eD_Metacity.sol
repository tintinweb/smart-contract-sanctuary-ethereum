...
contract Metacity is IMetacity, ERC721, Ownable, Pausable, ReentrancyGuard, Security {
  ...
  uint256 public startTime = 1669032000; // Monday, November 21, 2022 2:00:00 PM GMT+02:00
  ...
  uint256 public constant secondRoundPrice = 0.1 ether; // ETH
  // third round
  uint256 public constant thirdRoundPrice = 500 ether; // CITY
  ...
  // first round
  uint256 public constant firstRoundSupply = 100;
  uint256 public constant firstRoundPrice = 0.02 ether; // ETH
  uint256 public constant firstRoundMaxWlPerUser = 3;
  // second round
  uint256 public constant secondRoundSupply = 50;
