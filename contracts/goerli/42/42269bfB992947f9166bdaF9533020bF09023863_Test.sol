...
library RenderTime {
    ...
    string constant svg4 = '<circle cx="450" cy="450" r="1.5" stroke="white" stroke-width="1" fill="white" />';
    string constant svg5 = '<rect x="350" y="350" width="200" height="200" stroke="#F2F2F2" stroke-width="0.5" fill="none" rx="5" ry="5"/>';
