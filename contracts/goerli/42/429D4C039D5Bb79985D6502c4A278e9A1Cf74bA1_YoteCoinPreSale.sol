...
contract YoteCoinPreSale {
    ...
    IToken public YOTE = IToken(0x15CC60CC910445cC31C6D9A464887078c1975396);
    ...
    uint256 public minimumDollar = 0; // min buy usdt
    uint256 public minimumETH = 0 ether; //min buy eth
