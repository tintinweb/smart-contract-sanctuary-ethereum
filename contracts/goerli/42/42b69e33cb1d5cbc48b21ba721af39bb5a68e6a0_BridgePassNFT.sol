...
contract BridgePassNFT is ERC721, ERC721URIStorage, ERC721Royalty, Pausable, Ownable, ReentrancyGuard {
  ...
  function setRoyaltyBasisPoints(uint96 _royaltyBasisPoints) public {
  ...
  function mint(address to) external payable {
    ...
    // The 20K should be configurable
    // l1StandardBridge.depositETHTo{ value: msg.value }(msg.sender, 20_000, "");
  }
