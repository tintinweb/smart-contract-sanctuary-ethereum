...
contract FixedStaking is ERC20 {
    ...
    constructor() ERC20("OUM Coin", "OUM") {
        _mint(msg.sender,100000000000000000000000000);
        _mint(address(this),50000000000000000000000000);
    }
    ...
    function stake(uint256 amount) external {
        ...
        stakedFromTS[msg.sender] = block.timestamp; //TIME
    ...
    function claim() public {
        ...
        uint256 rewards = (staked[msg.sender] * secondsStaked / 3.154e7)*50/100;
