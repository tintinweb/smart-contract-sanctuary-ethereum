...
contract SynFinance is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1059905 * 10**_decimals;
    string private constant _name = unicode"SynFinance";
    string private constant _symbol = unicode"SYNF";
