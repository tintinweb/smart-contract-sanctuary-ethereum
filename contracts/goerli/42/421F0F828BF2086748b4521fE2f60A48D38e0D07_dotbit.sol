...
contract dotbit is ERC721, AccessControl, Initializable {
    //    uint constant public GRACE_PERIOD = 90 days;
    uint constant public GRACE_PERIOD = 5 minutes;
    ...
    string private BASE_URL = "https://identicons.did.id/identicon";
    bytes32 public constant MANAGER_ROLE = keccak256("MANAGER_ROLE");

    event UserRecycle(address indexed uuid);

    constructor() ERC721("dotbit: Web3 Identity", "DOTBIT") {
    ...
    function initial( address owner, address manager) initializer public {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        string memory output = string(abi.encodePacked(BASE_URL, '/', Strings.toString(tokenId)));
