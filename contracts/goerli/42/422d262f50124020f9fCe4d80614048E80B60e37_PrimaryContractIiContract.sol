...
// File: contracts/PrimaryContractIiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract PrimaryContractIiContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Primary ContractII";
    string public symbol = "PRIMARY";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "http://localhost:8787/4fIWZyy4JCLRSPn9mfsC/contract-metadata";
  }
