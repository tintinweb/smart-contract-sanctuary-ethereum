...
contract PipudosGame is ERC721 {
    ...
    ) ERC721("[email protected]", "[email protected]") {
        ...
        returns (string memory)
    {
        ...
        string memory json = Base64.encode(
            abi.encodePacked(
                ...
                '", "description": "This is an NFT that lets people play in the game Metaverse Mafia!", "image": "',
    ...
    function randomMod(uint256 _modulus) internal returns (uint256) {
