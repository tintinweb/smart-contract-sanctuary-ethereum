...
//                MarketPlace marketPlaceContract = MarketPlace(_indexContract.getAddress("Marketplace"));
//                marketPlaceContract.extDeleteMarketItems("HorsePartnership", from, id, amounts[i]);
            }
            ...
            if (to != address(0)){
                ...
                if (from != address(0)){
                    ...
                    address owner = ERC721(_indexContract.getAddress("Horse")).ownerOf(id);
    ...
    onlyOwner
    {
        ...
        for (uint8 i = 0; i < accounts.length; i++){
            _mintPartnershipTokenType(msg.sender, accounts[i], horseIds[i], maxPartnershipShares, "");
        }
    }
