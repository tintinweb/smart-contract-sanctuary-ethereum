...
contract DataFeedStrategy is IDataFeedStrategy, Governable {
  ...
  function strategicSendObservations(
    ...
    // TODO: change criteria for isStrategic (if there's a new nonce, bridge)
    if (!isStrategic(_chainId, _poolSalt, _poolNonce)) revert NotStrategic();
  ...
  function isStrategic(
    ...
    bytes32 _poolSalt,
    uint24 _poolNonce
  ) public view returns (bool _isStrategic) {
