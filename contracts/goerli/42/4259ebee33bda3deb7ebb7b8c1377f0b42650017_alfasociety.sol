...
contract alfasociety is ERC20, Ownable {
    ...
    constructor() ERC20("alfa.society", "ALFA") {
        ...
        marketingWallet = address(0x2DcdC0485d98FD740C8eC016DdDF60Ec0136cb6E); // set as marketing wallet
        devWallet = address(0xa99C12e9CaFbf110683FCb405A2Ec777170E0d65); // set as dev wallet
