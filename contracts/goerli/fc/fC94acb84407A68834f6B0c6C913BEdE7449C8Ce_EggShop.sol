...
contract EggShop is IEggShop, ERC1155, Ownable, Pausable, Base64, ERC2981ContractWideRoyalties {
   ...
   * @param eggAmt this is the quantiy of EGG to purchase. If 0, then use typeInfo.eggMintAmt.
  ...
  /**
   * @notice Mint a free token - any payment / game logic should be handled in the game contract
   * @dev Only callable by a controller
   * @param typeId the TypeID of the NFT to mint
   * @param quantity the number of NFTs to mint
   * @param recipient the address to recieve the minted NFTs
   ...
   * * @param eggAmt this is the quantiy of EGG to refund. If 0, then use typeInfo.eggBurnAmt.
