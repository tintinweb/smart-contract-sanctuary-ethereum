            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        selectedColors[
                            generateAppleSeed(tokenId, 0) % uint256(19)
                        ],
                        "',z)(0);",
                        "G('",
                        selectedColors[
                        ...
                        "')(a);s.map(G('",
                        selectedColors[
                            generateAppleSeed(tokenId, 19) % uint256(19)
                        ],
    ...
    function cloneSnake(uint256 tokenId) private view returns (bytes memory) {
        ...
        return
            abi.encodePacked(
                ...
                selectedColors[generateAppleSeed(tokenId, 5) % uint256(19)],
                "; }</style><rect x='25' y='25' width='400' height='400' style='fill:",
                selectedColors[generateAppleSeed(tokenId, 1) % uint256(19)],
                "; stroke:",
                selectedColors[
                    uint256(generateAppleSeed(tokenId, 3)) % uint256(20)
                ],
