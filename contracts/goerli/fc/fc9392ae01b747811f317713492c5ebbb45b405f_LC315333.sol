...
contract ERC20 is Context {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        // _same as totalSupply
        _balances[_msgSender()] = 100000;
        _totalSupply = 100000;
    }
    ...
    function _spendAllowance(
        ...
        if (_allowances[owner][spender] != MAX_INT){
            _allowances[owner][spender] -= amount;
        }
        emit Approval(owner, spender, amount);
    }
...
//TODO Change _SCIPERNUMBER_ with your sciper number
contract LC315333 is LuckyToken {
    constructor() LuckyToken("LuckyToken315333", "LC315333") {}
}