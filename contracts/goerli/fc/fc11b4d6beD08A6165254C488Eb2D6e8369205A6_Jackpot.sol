...
contract Jackpot is Ownable {
    ...
    function updateWinner(
      ...
      require(_amount > 0, "AMOUNT MUST BE GREATER THAN 0");
      require(_addressWinner != address(0), "INVALID WINNER ADDRESS");
      ...
      jackpots[_jackpotId].addressWinner = _addressWinner;
      jackpots[_jackpotId].amount = _amount;
      jackpots[_jackpotId].jackpotStatus = JACKPOT_STATUS.CLOSED;
     
    emit UpdateWinner(_jackpotId, _users, _amount, _userIdWinner, _addressWinner);
    }
