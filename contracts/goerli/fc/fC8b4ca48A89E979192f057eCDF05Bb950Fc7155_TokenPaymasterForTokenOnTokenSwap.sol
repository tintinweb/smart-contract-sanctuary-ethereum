...
contract TokenPaymasterForTokenOnTokenSwap is BasePaymaster {
    ...
    uint256 public minGas = gasUsedByPost + PRE_RELAYED_CALL_GAS_LIMIT + FORWARDER_HUB_OVERHEAD;
    ...
    function _verifyPreRelayed(IForwarder.ForwardRequest calldata request, address tokenIn, uint256 amount) private view {
        ...
        require(relayHub.balanceOf(address(this)) >= minBalance, "Not enough balance on Paymaster");
        ...
        returns (bytes memory, bool)
    {
        ...
        require(_router.getAmountsOut(amount, path)[2] > ethMaxCharge, "Not enough to pay for tx");
