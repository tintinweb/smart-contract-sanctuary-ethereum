...
// TODO: User joins the dungeon
// TODO: Spawn a new demon (ownableDelegateProxy)
// TODO: Save the association in the dungeon -- 
// do we really need to save this? emitting an event seems sufficient

pragma solidity ^0.8.7;
import "@openzeppelin/contracts/access/Ownable.sol";
import "./SechsDemon.sol";


contract SechsDungeon is Ownable {
    event DemonCreated(address createdBy, address demon);
    constructor(){

    }

    function createDemon() public {
        SechsDemon sechsDemon = new SechsDemon("demonBaby", "123");
        emit DemonCreated(msg.sender, address(sechsDemon));
    }
}
...
// TODO: Approve this contract to spend the eth of the owner
...
contract SechsDemon is Ownable, Pausable, EIP712 {
