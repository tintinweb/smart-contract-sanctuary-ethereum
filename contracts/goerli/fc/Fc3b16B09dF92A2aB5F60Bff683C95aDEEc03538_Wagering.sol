...
contract Wagering {
  ...
  uint16 private constant commissionRate = 90;
  ...
  function betOnMatch(
    ...
    IERC20Upgradeable(mt.paymentToken).transferFrom(msg.sender, address(this), amount);
  ...
  modifier onlyOwnerOrReferee() {
    ...
    require(msg.sender == owner || referees[msg.sender] == true, errorMsg);
    _;
  }
  ...
  function createPvPMatchAndBet(uint256 _amount, address _paymentToken) external returns (uint256 matchId, uint256 betId) {
    address[] memory participants = new address[](2);
    matchId = this.createMatch(participants, _paymentToken);
    betId = this.betOnMatch(matchId, _amount, msg.sender);
  }
