...
contract AccessPassTest is Ownable, ERC721A {
    uint256 public maxAccessPasses = 50;
    ...
    constructor() ERC721A("AccessPassTest", "ACCESSPASSTEST") {}
    ...
    function ownerMint(address receiver, uint256 quantity) external onlyOwner {
        if (_totalMinted() + quantity > maxAccessPasses) revert("Supply exceeded.");
