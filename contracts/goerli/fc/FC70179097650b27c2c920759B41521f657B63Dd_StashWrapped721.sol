  ...
  P2ERoyalties
{
  ...
  function factoryWrapAndSetApprovalForAll(
    ...
    _wrapAndSetApprovalForAll(owner, tokenId, operator);
  }
  ...
  function wrapAndSetApprovalForAll(uint256 tokenId, address operator) external {
    _wrapAndSetApprovalForAll(msg.sender, tokenId, operator);
  }

  function unwrap(uint256 tokenId) external {
    require(ownerOf(tokenId) == msg.sender, "Must be called by the owner");
    require(userOf(tokenId) == address(0), "NFT is rented");
  ...
  function supportsInterface(bytes4 interfaceId)
    public
    view
    override(ERC165Upgradeable, ERC721Upgradeable, ERC4907, P2ERoyalties)
 ...
 * @author batu-inal & HardlyDifficult
 */
abstract contract ERC4907 is IERC4907, ERC721Upgradeable {
  struct UserInfo {
  ...
  function setUser(
    ...
    require(info.expires < block.timestamp, "NFT is already rented");
    info.user = user;
  ...
  function _beforeTokenTransfer(
    ...
    // Only clear the rental terms if the new owner was the renter.
    if (_users[tokenId].user == to && to != address(0)) {
...
contract $StashWrapped721 is StashWrapped721 {
    ...
    constructor(address payable weth, address _contractFactory, uint16 _renterRoyaltyInBasisPoints, uint16 _operatorRoyaltyInBasisPoints) StashWrapped721(weth, _contractFactory, _renterRoyaltyInBasisPoints, _operatorRoyaltyInBasisPoints) {}
