...
contract EzzyBrezzy is ERC721A, Ownable {
    ...
    address private _operator = address(0xc429C9A7Db096B4e5795D280A203f8dBC284c9d7);

    address public whiteListSigningAddress = address(0xc429C9A7Db096B4e5795D280A203f8dBC284c9d7);


    address public constant wdAddress = address(0xF76f4E9dFB7C7C8f0F0f0295f94c50B474B2cE0A);
    ...
    modifier onlyOP {
        require (_msgSender() == owner() || _msgSender() == getOperator() );
        _;
    }
    ...
    //Set OP, that can use some functions
    ...
    function setSaleState(uint newState) external onlyOP {
    ...
    function setBaseURI(string memory baseURI) public onlyOP {
        baseTokenURI = baseURI;
    }

     function setPrice(uint256 newPrice) public onlyOP {
        PRICE = newPrice;
    }

     function setMaxElements(uint256 newMax) public onlyOP {
        MAX_ELEMENTS = newMax;
    }
    //compat
    ...
    function airdrop(address to, uint16 quantity) external onlyOP {
    ...
    function widthdraw() external onlyOP {
