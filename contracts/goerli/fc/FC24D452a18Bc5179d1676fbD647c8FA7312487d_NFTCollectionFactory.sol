  ...
  NFTCollectionFactoryTemplateInitializer
{
  ...
  function _createCollection(
    ...
    collection = implementation.cloneDeterministic(_getSalt(_msgSender(), nonce));
...
abstract contract NFTCollectionFactoryNFTCollections is Context, NFTCollectionFactorySharedTemplates {
  ...
  function createNFTCollection(
    ...
    uint256 version;
    (collection, version) = _createCollection(CollectionType.NFTCollection, nonce, symbol);
...
error NFTCollectionFactoryNFTDropCollections_Max_Token_Id_Must_Not_Be_Zero();
...
abstract contract NFTCollectionFactoryNFTDropCollections is Context, NFTCollectionFactorySharedTemplates {
  ...
  function _createNFTDropCollection(
    ...
    if (creationConfig.maxTokenId == 0) {
      revert NFTCollectionFactoryNFTDropCollections_Max_Token_Id_Must_Not_Be_Zero();
    }
...
error NFTCollectionFactoryNFTTimedEditionCollections_Mint_End_Time_Must_Be_In_The_Future();

/**
 * @title A factory to create NFTTimedEditionCollection contracts.
 */
abstract contract NFTCollectionFactoryNFTTimedEditionCollections is Context, NFTCollectionFactorySharedTemplates {
  ...
  function _createNFTTimedEditionCollection(
    ...
    if (creationConfig.mintEndTime.hasBeenReached()) {
      revert NFTCollectionFactoryNFTTimedEditionCollections_Mint_End_Time_Must_Be_In_The_Future();
    }
