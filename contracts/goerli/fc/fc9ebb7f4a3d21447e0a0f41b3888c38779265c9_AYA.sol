...
//                :%`  ~#$$$m:    7   ~!~ ?$$$$$$     //
//              :!`.-   ~T$$$$8xx.  .xWW- ~""##*"     //
//    .....   -~~:<` !    ~?T#[email protected]@[email protected]*?$$ 2    /`      //
//    [email protected]@M!!! .!~~ !!     .:XUW$W!~ `"~: 7  :        //
//    #"~~`.:x%`!!  !H:   !WM$$$$Ti.: .!WUn+!`        //
//    :::~:!!`:X~ .: ?H.!u "$$$B$$$!W:U!T$$M~         //
//    .~~   :[email protected]!.-~   ?2WTWo("*$$$W$TH$! `            //
//    Wi.~!X$?!-~    : ?7$$B$Wu("**$RM!               //
...
contract AYA is ERC1155Creator {
    constructor() ERC1155Creator("Adam Yates Art", "AYA") {}
}
