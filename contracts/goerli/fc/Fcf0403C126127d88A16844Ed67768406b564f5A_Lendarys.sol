...
contract Lendarys is Ownable, ERC721A , ReentrancyGuard{
    ...
    uint constant public TOKEN_PRICE  = 0.1 ether;
    uint constant public WHITELIS_PRICE  = 0.1 ether;
    ...
    constructor(string memory _URI, address payable _teamAddress) ERC721A("Lendarys", "LEND") {
        revealURI = _URI;
