...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  uint256 public PRICE = 0.1234 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 33, 1) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafkreico2yybzdjwjwvwkrhzxsph4vcwhlsnvm334ir6uwxvykpc4yzlcq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gQgMVXkcM4swmLk4F1Ne/contract-metadata";
  }
...
contract AofwContract is ERC721APlus {
    constructor() ERC721APlus("aofw", "tc1"){}
}
  /*******************************************************/
  /*                                                     */
