...
contract General is ERC20, Ownable {
    // Namings
    string private projectName = "ReTest New Contract";
    string private tokenName = "rTNC";

    // Wallets
    address payable public devWallet = payable(0x4c0CF2c40650D9cd0a20270a5Bc9bee55bea891A);
    address public marketingWallet = address(0x4c0CF2c40650D9cd0a20270a5Bc9bee55bea891A);
    ...
    // Limits
    uint256 public maxTransactionAmount = 210000 * (10 ** decimals()); // 1% from total supply maxTransactionAmountTxn;
    uint256 public swapTokensAtAmount;
    uint256 public maxWalletAmount = 210000 * (10 ** decimals()); // 1% from total supply maxWalletAmount;
   ...
   // Exlcude from fees and max transaction amount
    ...
    function setBuyFees(
		...
		require((_devFee + _marketingFee + _liquidityFee) <= 20, "Max buy fee is <= 20%");
		buyDevFee = _devFee;
    ...
    function setSellFees(
		...
		require((_devFee + _marketingFee + _liquidityFee) <= 20, "Max sell fee is <= 20%");
		sellDevFee = _devFee;
