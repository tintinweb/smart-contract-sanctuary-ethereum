...
contract Staker is ReentrancyGuard, Pausable, Ownable {
    ...
    function stakeToken(
        ...
        emit Staked(msg.sender, _amountTokens, unlockDate, currentPositionId);
    }
    ...
    function closePosition(uint256 positionId) external onlyOwner {
        ...
        if (block.timestamp > positions[positionId].unlockDate) {
            ...
            balances[address(this)].push(positionId);
            emit ClosedPosition(
            ...
            uint256 interest = contractBalance - amount;
            positions[positionId].tokenInterest = interest;
            balances[address(this)].push(positionId);
