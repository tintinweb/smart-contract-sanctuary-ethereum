...
contract ApeFriends is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ape Friends", "AF") {
    setHiddenMetadataUri("ipfs://Qmd2mMPEbb7EinZwLHr81JmpiR1wFLjaGLUukCJvj18cxM/hidden.json");
  }
  ...
  {
      if(_supply < 300 && cost == 16900000000000000){
           return 0.00 ether;
       } 
      else if (_supply < 300 && cost != 16900000000000000){
           return cost;
       }
      else if (_supply <= maxSupply && cost == 16900000000000000){
           return 0.0169 ether;
       }
       else if (_supply <= maxSupply && cost != 16900000000000000){
           return cost;
  ...
  {
       if(_supply < 300 && maxTokensPerWallet == 2) {
           return 2;
       } 
       else if (_supply < 300 &&  maxTokensPerWallet != 2){
           return maxTokensPerWallet;
       }
       else if (_supply <= maxSupply && maxTokensPerWallet == 2){
           return 100;
       }
        else if (_supply <= maxSupply && maxTokensPerWallet != 2){
           return maxTokensPerWallet;
