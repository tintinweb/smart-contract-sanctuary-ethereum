    ...
    SilksERC1155Burnable
{
    ...
    modifier whenFractionalizationNotPaused() {
        _requireFractionalizationNotPaused();
        _;
    }
    
    modifier whenReconstitutionNotPaused() {
        _requireReconstitutionNotPaused();
        _;
    }
    
    // *********** Internal Functions
    function _requireFractionalizationNotPaused() internal view virtual {
        require(!fractionalizationPaused, "FRACTIONALIZATION-PAUSED");
    }
    
    function _requireReconstitutionNotPaused() internal view virtual {
    ...
    {
        require(
            ERC721(_indexContract.getAddress("Horse")).ownerOf(horseId) == account,
            "NOT-TOKEN-OWNER"
        );
...
abstract contract SilksPausable {
    ...
    function _setContractPaused(bool _paused)
    internal
    {
        paused = _paused;
    }
