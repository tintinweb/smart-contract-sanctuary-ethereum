...
contract MetalorianSwap is ERC20, Ownable {
    ...
    event NewLiquidity( address user, uint amountToken1, uint amountToken2, uint totalSupply );
    ...
    //// @param totalSupply LP tokens total supply
    event LiquidityWithdraw( address user, uint amountToken1, uint amountToken2, uint totalSupply );
    ...
    function addLiquidity( uint _amountToken1, uint _amountToken2 ) public returns ( bool )  {
        ...
        emit NewLiquidity( msg.sender, _amountToken1, _amountToken2, totalSupply() );
    ...
    function removeLiquidity( uint _shares ) public isActive checkShares( _shares ) returns ( bool ) {
        ...
        emit LiquidityWithdraw( msg.sender, amount1, amount2, totalSupply() );
