...
contract Tabenomics is ERC721A, Ownable, ERC721ABurnable, ERC721AQueryable{
    ...
    uint256 constant NftSalePrice = 3000000000000000;   //プレセール値
    uint256 constant NftPrice = 5000000000000000;   //パブリックセール値
    ...
    */
    ...
    function TokenTransfers(uint amount) public{
        emit TokenTransfer(msg.sender, payable(owner()), amount);
    }
