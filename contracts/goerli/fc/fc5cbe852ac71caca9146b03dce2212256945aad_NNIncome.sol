...
contract NestBase {
    ...
    // TODO:
    address constant NEST_TOKEN_ADDRESS = 0xE2975bf674617bbCE57D2c72dCfC926716D8AC1F;
...
contract NNIncome is NestBase, INNIncome {
    ...
    address constant NEST_NODE_ADDRESS = 0x4474ddECBa0940B1B4a699c87d9B76Cf1F200548;
    ...
    function increment() public view override returns (uint) {
        ...
        // TODO:
        return _reduction(block.number - 7913863) * (block.number - _blockCursor) * 3.75 ether / 400;
    }
