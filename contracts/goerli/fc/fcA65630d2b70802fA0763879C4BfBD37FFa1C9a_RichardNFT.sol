...
contract RichardNFT is ERC721Enumerable, Ownable {    
    ...
    uint256 _mintTimeSWhite = 1672020000;  // white mint start time
    uint256 _mintTimeEWhite = 1672021800;  // white mint end time
    bytes32 _merkleRoot = 0xc5a825a61b9dc93e6d3cf3a0bab4162ff8eaa26dea31a6c0026cdf97fb17d1c8; // white merkleRoot

    uint256 _mintTimeS = 1672022400;  // start mint time
    uint256 _mintTimeE = 1672023600;  // end mint time
    mapping(address => bool) public _claimed;  // claimed address
    address public _withdrawAddress; // withdraw address
    string _myBaseUri = 'https://apiuat.the365.io/token/';
