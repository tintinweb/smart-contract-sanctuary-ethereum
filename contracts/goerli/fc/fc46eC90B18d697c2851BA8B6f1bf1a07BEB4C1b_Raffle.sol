...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function fulfillRandomWords(
        ...
        require(randomWords.length == NUM_WORDS, "Invalid random words");

        uint256 winnerIndex = randomWords[0] % s_players.length;
        recentWinner = s_players[winnerIndex];
     ...
     * 2. The lotter should have at least 1 player, and have some ETH
