 ...
 * @dev This implements the Chainlink VRF Version 2 and chainlink keeper
 */
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    // state of the lottery can be open, pending, closed and calculating
    ...
    function enterRaffle() public payable {
        ...
        // emit an events when we have to update dynamic array or mapping
     ...
     * 2. lottery have atleast one player and have some eth
     * 3. then our subscription will funded with links
