...
/** 
 * Set slippage to 4-5% : 1% to LP, 3% tax for Development.
*/
 ...
 * allowances. See {IERC20-approve}.
 */
 contract TestnetAI is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Testnet AI";
    string private _symbol = "TestnetAI";
    ...
    uint256 public maxTxAmount = 8888889 * 10**_decimals;
    uint256 public maxWalletAmount = 17777778 * 10**_decimals;
    address public marketingWallet = 0xfFcF2F37b818A58a922dD180831E58965f786994;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public _marketingReserves = 0;
    mapping(address => bool) public _isExcludedFromFee;
    uint256 public numTokensSellToAddToLiquidity = 177778 * 10**_decimals;
    uint256 public numTokensSellToAddToETH = 88889 * 10**_decimals;

    function postLaunch() external onlyOwner {
        taxForLiquidity = 1;
        taxForMarketing = 3;
        maxTxAmount = 8888889 * 10**_decimals;
        maxWalletAmount = 17777778 * 10**_decimals;
    }
    // TOKENOMICS END ============================================================>
