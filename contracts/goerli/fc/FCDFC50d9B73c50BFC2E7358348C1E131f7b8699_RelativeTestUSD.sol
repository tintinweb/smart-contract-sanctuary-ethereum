...
contract RelativeTestUSD is ERC20, ERC20Burnable, Pausable, AccessControl {
  ...
  constructor() ERC20("RelativeTestUSD", "RUSD") {
    ...
    // Allow Minting & Burning of Tokens
  ...
  function revokeMinterRole(address oldMinter)
    public
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
  ...
  function grantTransferRole(address newTransferer)
    public
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    grantRole(TRANSFER_ROLE, newTransferer);
  }

  function revokeTransferRole(address oldTransferer)
    public
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    revokeRole(TRANSFER_ROLE, oldTransferer);
  }
