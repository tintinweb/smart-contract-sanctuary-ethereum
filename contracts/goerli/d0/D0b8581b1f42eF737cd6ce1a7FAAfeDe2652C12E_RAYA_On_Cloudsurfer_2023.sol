  ...
  DefaultOperatorFilterer721
{
  ...
  uint256 private constant NUMBER_OF_OG_CLAIM_CLOUDSURFER = 34; // there are 40 TempReserved Cloudsurfer OG Claim NFTs , will be released on tempReservedTimestamp date
  ...
  /// @dev To override existing transferFrom and implement operator-filter-registry from ProjectOpenSea
