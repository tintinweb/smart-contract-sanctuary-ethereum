...
contract stakingdragon is ERC721Holder {
    ...
    mapping(address => uint256) public stakedNFTs;  //stake counter
    ...
    function stake(uint256 _nftId) public {
        ...
        stakedNFTs[msg.sender] ++; //adds 1 to the tally
    ...
    function unstake(uint256 _nftId) public {
        ...
        mintTokenInternal(stakedTime[_nftId] / 86400); 
...
contract DenOfDragons is ERC721, Ownable {
  ...
  address oldSmartContractA = 0x93e581BE9BDcCD0Cd96f5F4cbA6E5ADeA79c65ee;
