...
contract Tomin is ERC20, Ownable {
  uint256 constant initialSupply = 20_000_000 * (10**18);
  uint256 public supplyCapAmount = 200_000_000 * (10**18);

  mapping(address => bool) onlyApprovedContractAddress;

  constructor() ERC20('Tomin', 'TMIN') {
  ...
  function mint(address add, uint256 amount) external {
    ...
    require(totalSupply() + amount <= supplyCapAmount, '$TOMIN limit reached');
