...
contract HZNToken is ERC721ABurnable, ReentrancyGuard, Ownable {
    ...
    // ======== SALE TIME ========
    uint256 public wlBatchTime = 2342343;
    uint256 public publicBatchTime = 234234234;
    ...
    function setPrice(uint256 _whitelist, uint256 _public) external onlyOwner {
