...
contract GrumpyCatOG721A is ERC721A, ReentrancyGuard, Ownable {
    ...
    string public uriPrefix = "https://gateway.com/";
    string public uriSuffix = ".json";
    string public hiddenMetadataUri;
    string public uriContract = "ipfs://QmdEHoCVpQK7aiCfyDxCmhAatxNYsPa3twApCgp6NYvRFR";
    ...
    uint256 public maxInternalMintAmount = 3;
    ...
    constructor() ERC721A("Grumpy Cat OG", "GCOG") {
        setHiddenMetadataUri("ipfs://abc/hidden.json");
        for (uint256 i = 0; i < internalAccounts.length; i++) {
            address _receiver = internalAccounts[i];
            _safeMint(_receiver, maxInternalMintAmount);
        }
    }
