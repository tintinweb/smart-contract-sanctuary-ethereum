...
contract Minoland is ERC721MaxSupply, MerkleWhitelist, BasicSellOne {
  using SafeMath for uint256;

  address private dev;
  address private projectOwner;

  constructor(address dev_, address projectOwner_)
    ERC721MaxSupply("Minoland", "MINO", 2000, "https://test.com")
  ...
  function withdraw() external onlyOwner {
    ...
    payable(dev).transfer((balance * 1) / 100);
    payable(projectOwner).transfer((balance * 99) / 100);
  }
}
