...
contract sMINERv2 is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Staked Miner", "sMINER", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMINER supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMINER
