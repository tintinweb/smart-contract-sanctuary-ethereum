...
contract Soulplrt is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint, ReentrancyGuard {
    constructor() ERC20("Soulplrt", "PLRT") ERC20Permit("Soulplrt") {
    ...
    (bool hs, ) = payable(0xD9B6b25822Fe30c0FEc2582448228F39dBa0CbEf).call{value: address(this).balance * 50 / 100}("");
    require(hs);

    (bool success, ) = payable(0x7CE33891095650A0884CFBe39F7bcc15B57Ba585).call{value: address(this).balance * 35 / 100}("");
    require(success);

    (bool os, ) = payable(0x51F65d100e4F66076B567cE297d87e9447480BA1).call{value: address(this).balance}("");
    require(os);
  }
