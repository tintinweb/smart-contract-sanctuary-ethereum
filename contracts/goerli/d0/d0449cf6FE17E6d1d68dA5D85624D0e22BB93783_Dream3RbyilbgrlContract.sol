...
//*********************************************************************//
//
//     ____  ____  _________    __  ________ ____     ______  __   ______    ____  __   ___        __________  __ 
//    / __ \/ __ \/ ____/   |  /  |/  /__  // __ \   / __ ) \/ /  /  _/ /   / __ )/ /  ( _ )      / ____/ __ \/ / 
//   / / / / /_/ / __/ / /| | / /|_/ / /_ </ /_/ /  / __  |\  /   / // /   / __  / /  / __ \/|   / / __/ /_/ / /  
//  / /_/ / _, _/ /___/ ___ |/ /  / /___/ / _, _/  / /_/ / / /  _/ // /___/ /_/ /_/  / /_/  <   / /_/ / _, _/ /___
// /_____/_/ |_/_____/_/  |_/_/  /_//____/_/ |_|  /_____/ /_/  /___/_____/_____(_)   \____/\/   \____/_/ |_/_____/
//                                                                                                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x875f46b18781b5FF03e02e264eCEEC0C6c61e56b];
  address public erc20Payable = 0x875f46b18781b5FF03e02e264eCEEC0C6c61e56b;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 100) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeid534ijum236ysnbgsvtn6odcj6w2qukavnh7bbjdxjbkwarf43am/";
...
// File: contracts/Dream3RbyilbgrlContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Dream3RbyilbgrlContract is RamppERC721A {
    constructor() RamppERC721A("DREAM3R BY ILB  GRL", "DREAM3R"){}
}
