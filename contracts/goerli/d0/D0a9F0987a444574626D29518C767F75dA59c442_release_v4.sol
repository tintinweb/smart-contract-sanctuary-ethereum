...
contract release_v4 is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Releasev4", "RV4") Ownable() {}
    ...
    function backgroundColor(uint256 tokenId) private pure returns (string memory) {
        ...
        string memory c;
        uint256 v = uint(keccak256(abi.encodePacked("a8f71cb43dedd4e7213aa5508325496c2f89e81ec48be005c3bd5b3e6c7c3090", toString(tokenId)))) % 101;
    ...
    function makeAttributes(uint256 tokenId) private view returns (string memory) {
        ...
        traits[2] = string(abi.encodePacked('{"trait_type":"Original Punk Traits: ","value":"', getAttributes(tokenId), '"}'));
    ...
    function getAttributes(uint256 tokenId) public view returns (string memory) {
        ...
        string memory punkAttributes = cryptopunksData.punkAttributes(t);
