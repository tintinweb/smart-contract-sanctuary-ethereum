    ...
    IVaultDepositRouter
{
    ...
    // ========== Core Functions ==========
    /**
     * @dev See { IVaultDepositRouter-depositERC721 }.
     */
    function depositERC721 (
        ...
        _depositERC721(owner, vault, token, id);
    }
    ...
    function depositERC721Batch (
        ...
        for (uint256 i = 0; i < tokens.length; i++) {
            _depositERC721(owner, vault, tokens[i], ids[i]);
        }
    }
    ...
    /**
     * @notice Collect an ERC721 from the caller
     *
    ...
    function _depositERC721 (
        ...
        address vaultAddress = IVaultFactory(factory).instanceAt(vault);
        bool isEnabled = IAssetVault(vaultAddress).withdrawEnabled();
