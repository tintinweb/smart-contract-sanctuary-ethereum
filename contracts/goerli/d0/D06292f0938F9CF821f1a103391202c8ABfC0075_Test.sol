...
contract Test is ERC20, Ownable {
    ...
    constructor() ERC20("Finaltest", "$LOVUrsS") {
        ...
        maxTransactionAmount = 10_000 * 1e18; // 1% max transaction at launch
        ...
        markWallet = address(0x9674fb8D4B7B7a0fb847daA9788714DA5553F0aa); 
        devWallet = address(0x9674fb8D4B7B7a0fb847daA9788714DA5553F0aa); 
        liqWallet = address(0x9674fb8D4B7B7a0fb847daA9788714DA5553F0aa); 
        operationsWallet = address(0x9674fb8D4B7B7a0fb847daA9788714DA5553F0aa);
