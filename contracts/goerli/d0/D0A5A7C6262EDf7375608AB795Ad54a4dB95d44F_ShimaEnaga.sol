...
contract ShimaEnaga is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  string public uriPrefix = 'ipfs://bafybeic4mpp5fvbqxfr2dmjcikur74ccl7vuk4vklkoceesyvqoc5k5tyy/';
  ...
  function currentPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 91) {
            return cost10;
        } else if (currentSupply >= 81) {
            return cost9;
        } else if (currentSupply >= 71) {
            return cost8;
            ...
            return cost5;
        } else if (currentSupply >= 31) {
            return cost4;
        } else if (currentSupply >= 21) {
            return cost3;
