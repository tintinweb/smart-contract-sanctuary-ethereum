 ...
 */
contract ERC20_V2 is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    constructor() {
        ...
        _burn(_msgSender(), _initialSupply);
    }
    ...
    function migrateMint(address to, uint amount) public virtual override returns (bool) {
