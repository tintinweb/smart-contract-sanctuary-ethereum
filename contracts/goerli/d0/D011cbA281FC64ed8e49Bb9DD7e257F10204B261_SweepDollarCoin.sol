...
contract SweepDollarCoin is BaseSweep {
     ...
     */
    function setInterestRate(int256 _new_interest_rate) public onlyOwnerOrBalancer {
     ...
     */
    function setCollateralAgent(address _agent_address) public onlyOwner {
     ...
     */
    function setStepValue(int256 _new_step_value) public onlyOwner {
