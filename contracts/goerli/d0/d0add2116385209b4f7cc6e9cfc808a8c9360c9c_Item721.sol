...
// File: contracts/MSNFTCounters.sol
...
// File: contracts/Item721Royalty.sol
    ...
    IMS721
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(AccessControlEnumerable, ERC721, ERC721Enumerable, ERC721Royalty, IERC165)
        returns (bool)
    {
        return super.supportsInterface(interfaceId);
    }
    ...
    function setDefaultRoyalty(address receiver, uint96 feeNumerator) public virtual onlyMinter {
        _setDefaultRoyalty(receiver, feeNumerator);
    }

    function setTokenRoyalty(uint256 tokenId, address receiver, uint96 feeNumerator) public virtual onlyMinter {
