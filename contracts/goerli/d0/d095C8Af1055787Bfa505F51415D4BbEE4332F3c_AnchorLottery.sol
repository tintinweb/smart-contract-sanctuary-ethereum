...
/** @title AnchorLottery Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract AnchorLottery is ReentrancyGuard, IAnchorLottery, Ownable {
    ...
    uint256 public minPriceTicket = 0.0000000005 ether;

    uint256 public pendingInjectionNextLottery;

    uint256 public constant MIN_DISCOUNT_DIVISOR = 300;
    uint256 public constant MIN_LENGTH_LOTTERY = 30 seconds; // 4 hours
        ...
        nonReentrant
    {
        ...
        // Calculate number of ETH to this contract
        ...
        require(msg.value == amountToTransfer, "Price not met");
    ...
    function claimTickets(
        ...
        (bool success, ) = msg.sender.call{value: rewardToTransfer}("");
    ...
    /**
     * @notice Draw the final number, calculate reward in ETH per group, and make lottery claimable
     * @param _lotteryId: lottery id
        ...
        nonReentrant
    {
        ...
        // Calculate prizes in ETH for each bracket by starting from the highest one
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                // A. No ETH to distribute, they are added to the amount to withdraw to treasury address
            } else {
        ...
        // Transfer ETH to treasury address
        (bool success, ) = treasuryAddress.call{value: amountToWithdrawToTreasury}("");
        require(success, "Transfer failed");
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in ETH token
     ...
     * @param _priceTicket: price of a ticket in ETH
