...
// Root file: contracts/true-currencies/TokenControllerV3.sol
...
// import {IHook} from "contracts/true-currencies/interface/IHook.sol";
// import {TrueCurrencyWithPoR as TrueCurrency} from "contracts/true-currencies/TrueCurrencyWithPoR.sol";
...
contract TokenControllerV3 {
    ...
    TrueCurrencyWithPoR public token;
    ...
    event SetToken(TrueCurrencyWithPoR newContract);
    ...
    */
     ...
     */
    function setToken(TrueCurrencyWithPoR _newContract) external onlyOwner {
        token = _newContract;
