...
contract ControllerFreedom is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    */
     ...
     */
    function addMemberToGroup(address addr, uint256 groupId, uint256 commId) external  returns (bool){  //onlyProxy
        // require(assertVotingContractAddr() == true, "Unauthorized user.");
     ...
     */
    function removeMemberToGroup(address addr, uint256 groupId, uint256 commId) external returns (bool){ //onlyProxy 
        // require(assertVotingContractAddr() == true, "Unauthorized user.");
