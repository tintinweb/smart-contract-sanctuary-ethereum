...
contract HODLVesting is AccessControl, ERC20 {
    ...
    IERC20 public hfd; // Vested token
    ...
    function setBonding(address _newBonding) external onlyAdmin {
        bondingContract = _newBonding;
    }
    ...
    function removeStuckToken(address _address) external onlyAdmin {
