...
TIERS[8] = [25,25,50,50];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"\\\"Anti-viral\\\" potion #");
