...
contract ERC721AMetadataFacet is Modifiers {
    ...
    function setMetadata(MetadataContract memory _contract) external {
        ...
        MetadataLib.metadataStorage().metadata= _contract;
    }
...
library SVGTemplatesLib {
    ...
    function _svgAddress(
        ...
        return Create2.computeAddress(
            keccak256(abi.encodePacked(erc, _name)), 
    ...
    function _svgString(
        ...
        try SVGTemplate(_svgAddress(self, erc,_name)).svgString() returns (string memory _data) {
            data_ = _data;
        } catch (bytes memory) {}
    }
        ...
        returns (address _tplAddress)
    {
        ...
        address targetTplAddress = _svgAddress(self, erc, _name);
...
contract SVGManager is Controllable {
    ...
    function svgAddress(string memory _name) external view returns (address _svgAddress) {
        _svgAddress = SVGTemplatesLib.svgStorage().svgTemplates._svgAddress(address(this), _name);
    }
    ...
    function svgString(string memory _name) external view returns (string memory data_) {
        ...
        try SVGTemplate(SVGTemplatesLib.svgStorage().svgTemplates._svgAddress(address(this), _name)).svgString() returns (string memory _data) {
            data_ = _data;
        } catch (bytes memory) {}
    }
    ...
    function createSVG(address erc, address sender, string memory _name) external onlyController returns(address _tplAddress) {
        ...
        _tplAddress = SVGTemplatesLib.svgStorage().svgTemplates._createSVG(erc, sender, _name);
