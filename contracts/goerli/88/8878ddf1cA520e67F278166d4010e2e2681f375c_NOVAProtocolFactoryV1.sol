...
import "./NOVAProtocolPair.sol";

contract NOVAProtocolFactoryV1 is INOVAProtocolFactory {
        ...
        returns (address pair)
    {
        ...
        bytes memory bytecode = type(NOVAProtocolPair).creationCode;
    ...
    function setFeeTo(address _feeTo) external {
        require(msg.sender == feeToSetter, "NOVAProtocol: FORBIDDEN");
        feeTo = _feeTo;
    }
...
contract NOVAProtocolPair is INOVAProtocolPair, NOVAProtocolERC20 {
...
contract NOVAProtocolERC20 is INOVAProtocolERC20 {
    using SafeMath for uint256;

    string public constant name = "NOVAProtocol-LP";
    string public constant symbol = "NOVA-LP";
