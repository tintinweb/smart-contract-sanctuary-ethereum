...
contract ConsumerContract is ChainlinkClient, ConfirmedOwner {
    ...
    function requestInfo(address _oracle, string memory _jobId) public onlyOwner {
        Chainlink.Request memory req = buildChainlinkRequest(
            stringToBytes32(_jobId),
            address(this),
            this.fulfillRequestInfo.selector
        );
        // req.add('get', 'http://numbersapi.com'); 
        // req.add('path', 'USD');
        // req.addInt('times', 100);

        req.add("number", "72");
        req.add("infoType", "trivia");
        sendChainlinkRequestTo(_oracle, req, ORACLE_PAYMENT);
    }

    function fulfillRequestInfo(bytes32 _requestId, string memory _info) public recordChainlinkFulfillment(_requestId) {
    ...
    */ 
    ...
    function contractBalances() public view returns (uint256 eth , uint256 link) {
        ...
        LinkTokenInterface linkContract = LinkTokenInterface(chainlinkTokenAddress());
