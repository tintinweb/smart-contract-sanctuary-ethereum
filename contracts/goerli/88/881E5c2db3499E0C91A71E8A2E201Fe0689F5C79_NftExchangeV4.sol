...
contract NftExchangeV4 is Initializable, ERC1155SupplyUpgradeable, EIP712Upgradeable {
    address owner;
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            'BuyerVoucherV3(uint8 buyVoucherType,uint256 voucherId,uint256 offerVoucherId,uint256 tokenId,uint256 quantityToPurchase,uint256 unitPriceWei,address wethSmartContractAddress,bool hasEndDate,uint256 endDate)'
                        ),
                        voucher.buyVoucherType,
                        voucher.voucherId,
                        voucher.offerVoucherId,
