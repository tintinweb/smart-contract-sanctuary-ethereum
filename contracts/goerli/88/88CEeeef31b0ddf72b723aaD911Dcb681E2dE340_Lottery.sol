...
contract Lottery is VRFConsumerBaseV2, Ownable {
    uint256 private constant ROLL_IN_PROGRESS = 42;   // as of docu  
    VRFCoordinatorV2Interface COORDINATOR;    // as of docu
    ...
    uint256[] public recentRandomWorks;
    ...
    function fulfillRandomWords(uint256 requestId , uint256[] memory randomWords) internal override {
        ...
        recentRandomWorks.push(randomWords[0]);
