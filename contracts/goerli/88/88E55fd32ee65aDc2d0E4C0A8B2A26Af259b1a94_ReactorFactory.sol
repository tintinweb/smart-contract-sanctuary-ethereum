...
contract ReactorFactory {
    ...
    address comiteFiducia = msg.sender;
...
contract Reactor is ERC1155, Pausable {
    ...
    uint256 public constant MAX_TOKEN_ID_PLUS_ONE = 1; // 1 tokens numbered 0 inclusive
    uint256 public AL_TIMER;
    uint256 public MAX_MINT = 5;
    uint256 public max_mint_wl = 5;
    uint256 public MAX_AL_MINT = 5;   
    ...
    address payable public comiteFiducia;
    ...
    constructor (
        ...
        comiteFiducia = _feeAddress;
        owner = _deployerAddress;

        contractUri = "https://continentkey-opensea.mypinata.cloud/ipfs/QmTSyPXvWQLqK6EzjvpwQpygYD3XT9uKYhC9MB2phy54ir"; // json contract metadata file for OpenSea
        ...
        for (uint256 i = 0; i < MAX_TOKEN_ID_PLUS_ONE; ++i) {
            _ids[i] = i;
            _amounts[i] = 50;
            tokenIdToExistingSupply[i] = 50;
        }
        _mintBatch(comiteFiducia, _ids, _amounts, "");
    }
    ...
    function setFeesCollector(address _feeAddress) external onlycomiteFiducia {
        require(_feeAddress != address(0), "Cannot set address 0");
        comiteFiducia = payable(_feeAddress);
    }
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "Only 5 Nfts by allowlists address."
        );
        require(_id < MAX_TOKEN_ID_PLUS_ONE, "id must be < 1");
        ...
        require(msg.value == _amount * tokenPrices, "incorrect ETH");
        require(msg.sender == tx.origin, "no smart contracts");

        payable(comiteFiducia).transfer(_amount * tokenPrices);    
        ...
        payable whenNotPaused
    {
        ...
        require(msg.value == sumAmounts * tokenPrices, "incorrect ETH");
