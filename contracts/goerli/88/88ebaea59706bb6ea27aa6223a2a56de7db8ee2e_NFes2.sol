...
abstract contract NFes2State {
    ...
    uint256[4] public timeStart = [
        1676160000, /* 2/12 0900JST */
        1676178000, /* 2/12 1400JST */
        1676203200, /* 2/12 2100JST*/
        0
    ];
    ...
    ERC721PsiAddressData
{
    ...
    modifier onlyValidMinter() {
        if (allowLists[salePhase][msg.sender] == 0) revert NoAllocationInThisSale();
        _;
    }
    ...
    modifier whenValidMintAmount(uint256 amount) {
        ...
        uint256 alloc = allowLists[salePhase][msg.sender];
        if (
            alloc <
