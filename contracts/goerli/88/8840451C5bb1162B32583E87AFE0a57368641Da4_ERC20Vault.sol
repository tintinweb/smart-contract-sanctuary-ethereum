...
contract ERC20Vault is ReentrancyGuard {
    ...
    function lockERC20(string calldata destNetwork, string calldata walletAddr)
        external
        payable
        checkLockERC20
    {
    ...
    function releaseERC20(address erc20Addr, uint256 amount)
        private
        nonReentrant
    {
    ...
    function releaseUSDC(address erc20Addr, uint256 amount)
        private
        nonReentrant
    {
        TransferHelper.safeApprove(_token, erc20Addr, amount);
