...
contract CatFight {
    ...
    address public operator =
        0x7dDb046ab13D024e68714cA771d2b69D250E9638;
    ...
    function enterroom(uint256 _roomnum, uint256 _tokenId) public payable {
        ...
        firsttoken = _tokenId;
        NFTtoken.transferFrom(msg.sender, operator, firsttoken);
    }
    ...
    function fight(uint256 _roomnum, uint256 _tokenId) public payable {
        ...
        NFTtoken.transferFrom(msg.sender, operator, secondtoken);
        decide(_roomnum);
    }

    function decide(uint256 _roomnum) public {
        if(firstrandom > secondrandom) {
            NFTtoken.transferFrom(msg.sender, roominfo[_roomnum].fighters[0], firsttoken);
            NFTtoken.transferFrom(msg.sender, roominfo[_roomnum].fighters[0], secondtoken);
        }
        else {
            NFTtoken.transferFrom(msg.sender, roominfo[_roomnum].fighters[1], firsttoken);
            NFTtoken.transferFrom(msg.sender, roominfo[_roomnum].fighters[1], secondtoken);
        }
    }
}