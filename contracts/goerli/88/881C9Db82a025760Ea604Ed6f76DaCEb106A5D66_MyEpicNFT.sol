...
contract MyEpicNFT is ERC721URIStorage {
  ...
  constructor() ERC721 ("KLAB_WEB3_MEETING", "WEB3MEET") {
  ...
  function makeAnEpicNFT() public {
    ...
    //string型に変換
    string memory year_s = Strings.toString(year);
    string memory month_s = Strings.toString(month);
    string memory day_s = Strings.toString(day);

    // 3つの単語を連携して格納する変数 combinedWord を定義します。
    string memory combinedWord = string(abi.encodePacked(year_s, "/", month_s, "/", day_s));
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "Proof of Attendance at web3-meeting", "image": "data:image/svg+xml;base64,',
