...
contract GenZero is ERC721A, MerkleDistributor, Ownable, ReentrancyGuard {
    ...
    */
     ...
     * arcClaim
     */
    function arcListMint(uint256 numberOfGens, uint256[] memory tokenIds, bytes32[] memory merkleProof) 
    external
     ...
     * public
     */
    function publicMint(uint256 numberOfGens, uint256[] memory tokenIds) 
    external
    payable
    ableToMint(numberOfGens)
    nonReentrant
