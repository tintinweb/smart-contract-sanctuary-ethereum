...
contract SwapERC721Bedu2117Upgradeable is Initializable, ContextUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function checkBeforeClaim(address payer_, address receiver_, uint256 tokenAmount_) public view virtual returns (bool) {
        // validate params
    ...
    function _claimToken(address payer_, address receiver_, uint256 tokenAmount_, uint256 ethAmount_, uint256 nonce_) internal virtual {
        // check before claim
