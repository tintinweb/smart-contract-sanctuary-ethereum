...
contract ERC721_POAP_BADGES is ERC721B2FAEnumLitePausable {
    ...
    function initializz() external {
        if (!init_ran) {
            init_ran = true;
            initializz_erc721_enum("POAP_BADGES", "POAPB", 1);
        }
    }
    ...
    IERC721Enumerable
{
    ...
    function initializz_erc721_enum(
        string memory name_,
        string memory symbol_,
        uint256 offset
    ) internal {
        initializz_erc721(name_, symbol_, offset);
    }
