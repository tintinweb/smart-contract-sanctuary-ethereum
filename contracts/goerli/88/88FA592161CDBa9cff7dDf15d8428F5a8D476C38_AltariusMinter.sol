 ...
 *
 * Full metadata is divided in 3 parts:
 * - Name: Stores the name of the card.
 * - Metadata: Stores cards metadata to be used by other contracts.
 * - Images: Stores the IPFS CID of the images of the card.
 *
 * Type, rarity and edition strings are linked on their respective mappings for efficiency.
 */
