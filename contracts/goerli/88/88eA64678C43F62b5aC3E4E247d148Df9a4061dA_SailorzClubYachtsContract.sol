...
//*********************************************************************//
//
//    _____       _ __                    ________      __       __  __           __    __      
//   / ___/____ _(_) /___  _________     / ____/ /_  __/ /_      \ \/ /___ ______/ /_  / /______
//   \__ \/ __ `/ / / __ \/ ___/_  /    / /   / / / / / __ \      \  / __ `/ ___/ __ \/ __/ ___/
//  ___/ / /_/ / / / /_/ / /    / /_   / /___/ / /_/ / /_/ /      / / /_/ / /__/ / / / /_(__  ) 
// /____/\__,_/_/_/\____/_/    /___/   \____/_/\__,_/_.___/      /_/\__,_/\___/_/ /_/\__/____/  
//                                                                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x43BeAA2560BD4f1A6E8CE358A592f4f4C77f59d3];
  address public erc20Payable = 0x43BeAA2560BD4f1A6E8CE358A592f4f4C77f59d3;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifxrykf43kzh44mpnckq6ulqztglhhq4r6ntkjgyupeshivyls2oy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/M8a1WIfDXU9Z2Kntuget/contract-metadata";
  }
...
// File: contracts/SailorzClubYachtsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SailorzClubYachtsContract is RamppERC721A {
    constructor() RamppERC721A("Sailorz Club Yachts", "SCY"){}
}
