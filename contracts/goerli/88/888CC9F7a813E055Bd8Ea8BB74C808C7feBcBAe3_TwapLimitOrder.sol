...
contract TwapLimitOrder is ITwapLimitOrder {
    ...
    function sellWithExpiration(
        ...
        require(expiration >= EXPIRATION_LOWER_LIMIT, 'TL5C');
        require(expiration <= EXPIRATION_UPPER_LIMIT, 'TL5D');
        require(_isTwapIntervalValid(sellParams.tokenIn, sellParams.tokenOut, twapInterval), 'TL5E');
    ...
    function buyWithExpiration(
        ...
        require(expiration >= EXPIRATION_LOWER_LIMIT, 'TL5C');
        require(expiration <= EXPIRATION_UPPER_LIMIT, 'TL5D');
        require(_isTwapIntervalValid(buyParams.tokenIn, buyParams.tokenOut, twapInterval), 'TL5E');
    ...
    function _validateOrder(StoredOrder memory order) internal view {
        ...
        require(order.status == LimitOrderStatus.Waiting, 'TL5F');
