...
contract PriceFeed is IPriceFeed {
  ...
  uint24 public constant UPDATE_INTERVAL = 100; // replace with 30 minutes;
    ...
    returns (uint128 harmonicMeanLiquidity, int56[] memory tickCumulatives)
  {
    ...
    if (success) {
      ...
      uint192 secondsAgoX160 = UPDATE_INTERVAL * type(uint160).max;
