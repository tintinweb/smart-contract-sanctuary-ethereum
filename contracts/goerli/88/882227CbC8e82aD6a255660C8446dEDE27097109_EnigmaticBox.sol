...
contract EnigmaticBox is ERC721AQueryable, Ownable, DefaultOperatorFilterer {
    ...
    bool private offChainFallback = false;
                ...
                abi.encodePacked(
                    ...
                    //Base64.encode(
                        //abi.encodePacked(
                            ...
                            _toString(tokenId),
                            '", "image": "',
                            offChainFallback?string.concat(baseURI,_toString(btype)):renderImage(btype),
                            '","attributes":[{"trait_type":"',
                            explicitOwnershipOf(tokenId).burned?'Burned Boxes':'Type',
                            '","value":"',
                            boxNames[btype],
