...
contract erc2981test is Ownable, ReentrancyGuard,ERC721AQueryable,ERC2981,DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Erc2981test", "erc2981test") {
        _safeMint(msg.sender, 1);
        _setDefaultRoyalty(0x4d8067b12bedCb69FfB3FFD8c9cDbc1840D61441, 3000);
    }  
