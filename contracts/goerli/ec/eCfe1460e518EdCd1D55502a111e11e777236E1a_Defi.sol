...
contract Defi {
    ...
    address usdcTokenAddress = 0xC2C527C0CACF457746Bd31B2a698Fe89de2b6d49;
    ...
    function approveusdc(address contractAddress, uint256 amount) public {
        bool success = IERC20(usdcTokenAddress).approve(
            contractAddress,
            type(uint256).max
        );
