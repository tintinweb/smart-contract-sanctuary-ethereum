// SPDX-License-Identifier: MIT
    ...
    ******************************************************************
                     ...
                     Contract DEGEN PIGEONS LAUNCHPAD
...
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
    ...
    contract TheFrogs  is ERC721A, Ownable, ReentrancyGuard {
        using Strings for uint256;
    
        constructor() ERC721A("$thefrogs", "tfg") {}
        ...
        string public hiddenMetadataUri= "ipfs://Qme9R8ozsysnmiGpT3icbcJiMS3FA1LqfrmETsa9H3Z5yJ/"; 
        
        uint256 public cost = 0.0099 ether; 
        uint256 public WLcost = 0.0099 ether;
        uint256 public maxSupply = 900;
        uint256 public wlSupply = 900;
