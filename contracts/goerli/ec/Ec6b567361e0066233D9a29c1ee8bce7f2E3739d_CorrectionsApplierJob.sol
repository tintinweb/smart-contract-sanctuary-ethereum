 ...
 */
interface ICorrectionsApplierJob is IKeep3rMeteredJob {
  /*///////////////////////////////////////////////////////////////
                              EVENTS
  //////////////////////////////////////////////////////////////*/
...
contract CorrectionsApplierJob is ICorrectionsApplierJob, Keep3rMeteredJob {
  ...
  /// @inheritdoc ICorrectionsApplierJob
  function work(IUniswapV3Pool _pool, uint16 _manipulatedIndex, uint16 _period)
    external
    upkeepMetered(msg.sender)
    notPaused
  {
    if (!POOL_MANAGER_FACTORY.isSupportedPool(_pool)) {
      revert CorrectionsApplierJob_InvalidPool(_pool);
    }
