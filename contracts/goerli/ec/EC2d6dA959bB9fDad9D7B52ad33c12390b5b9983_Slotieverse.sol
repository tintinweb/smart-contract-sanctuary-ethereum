...
contract Slotieverse is WattsBurnerUpgradable, PausableUpgradeable {
    ...
    function AddAmmoId(uint256 ammoId, uint256 price, bytes32 identifier) external whenNotPaused() onlyRole(GameAdminRole) {
    ...
    function UpdateAmmoId(uint256 ammoId, uint256 price, bytes32 identifier) external whenNotPaused() onlyRole(GameAdminRole) validAmmo(ammoId) {
        ammoPrice[ammoId] = price;
