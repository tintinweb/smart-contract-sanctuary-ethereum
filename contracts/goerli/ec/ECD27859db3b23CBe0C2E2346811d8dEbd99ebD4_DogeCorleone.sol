...
contract DogeCorleone is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0xbDeb37D8E1AFD261cCf5ee0a6FAe7Fc316A1ee34);
    ...
    uint256 public _maxTxAmount = 520650000 * 10**9; //0.75
    uint256 public _maxWalletSize = 2082600000 * 10**9; //3.0
