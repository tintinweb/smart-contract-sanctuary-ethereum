...
contract RoseInvasionStake is ReentrancyGuard, Ownable, IERC721Receiver {
    ...
    function changeStakingStartTime(uint256 tokenId, uint256 startTime) external onlyOwner {
