...
contract DeathGirlGenesis is ERC721A, Ownable, ReentrancyGuard {
        ...
        callerIsUser
    {
        ...
        require(totalSupply() + amount <= collectionSize, "Hit max supply");
        require(amount <= allowedMintsPerAddress, "The limit is 2");
        require(
            MerkleProof.verify(
                merkleProof,
                deathlistMerkleRoot,
        ...
        require(
            amountMinted(msg.sender) + amount <= allowedMintsPerAddress,
