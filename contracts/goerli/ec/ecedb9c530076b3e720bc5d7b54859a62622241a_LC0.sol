...
contract ERC20 is Context {
        ...
        returns (bool)
    {
        ...
        require(_balances[_msgSender()] >= amount, "ERC20: balances too low");
    ...
    function transferFrom(
        ...
        require( _balances[from] >= amount, "ERC20: balances too low");
        require(_allowances[from][_msgSender()] >= amount, "ERC20: allowances too low");
        ...
        returns (bool)
    {
        // TODO: use `_approve` defined later in the contract
        require(spender != address(0), "ERC20: approve to the zero address");
        // `allowance(_msgSender(), spender) is the current allowance`
        require(allowance(_msgSender(), spender) >= subtractedValue, "ERC20: decreased allowance below zero");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(_balances[account] >= amount, "ERC20: balances too low");
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenLQTK", "LCLQTK") {}
}