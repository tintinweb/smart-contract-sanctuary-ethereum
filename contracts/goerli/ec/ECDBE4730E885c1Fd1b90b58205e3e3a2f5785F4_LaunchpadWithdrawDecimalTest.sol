 ...
 * @notice This contract handles minting Withdraw decimal test tokens.
 */
contract LaunchpadWithdrawDecimalTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    uint256[] public payoutBasisPoints = [250, 9750];
    uint96 public royaltyFee = 250;

    constructor() ERC721A("Withdraw decimal test", "WTWT") {
