...
contract DeploymentFactory is Ownable {
    ...
    string public Token_erc20Name;
    string public Token_erc20Symbol;
    uint8 public Token_decimals;
    uint256 public Token_cap;
    address[] public Token_mintAddresses;
    uint256[] public Token_mintAmounts;
    ...
    constructor(
        ...
        Token_erc20Name = _erc20Name;
        Token_erc20Symbol = _erc20Symbol;
        Token_decimals = _decimals;
        Token_cap = _cap;
        Token_mintAddresses = _mintAddresses;
        Token_mintAmounts = _mintAmounts;
    }

    // Execute deployment
    function deploy() public onlyOwner {
        require(contractAddress != address(0), "Contract already deployed");
