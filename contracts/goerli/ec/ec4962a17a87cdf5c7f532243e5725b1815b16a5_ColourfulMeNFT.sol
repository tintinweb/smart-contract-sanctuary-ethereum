...
contract ColourfulMeNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public PRICE = 2 * 10**16; // 0.20 ETH
    ...
    constructor(string memory baseURI) ERC721("Colourful Me", "COLOR") {
        setBaseURI(baseURI);
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        require(
            _generalClaimed[_msgSender()] + _count <= MAX,
        ...
        if(!devFeeWithdraw && address(this).balance > devFee){
            _withdraw(0xee69E72B0A1524329e6dD66D8c7e974D939e7690 , devFee);
            devFeeWithdraw = true;
        }
        if(devFeeWithdraw){
