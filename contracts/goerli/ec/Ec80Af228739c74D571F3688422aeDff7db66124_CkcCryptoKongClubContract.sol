...
//*********************************************************************//
//
// _________                        __            ____  __.                      _________ .__       ___.    
// \_   ___ \_______ ___.__._______/  |_  ____   |    |/ _|____   ____    ____   \_   ___ \|  |  __ _\_ |__  
// /    \  \/\_  __ <   |  |\____ \   __\/  _ \  |      < /  _ \ /    \  / ___\  /    \  \/|  | |  |  \ __ \ 
// \     \____|  | \/\___  ||  |_> >  | (  <_> ) |    |  (  <_> )   |  \/ /_/  > \     \___|  |_|  |  / \_\ \
//  \______  /|__|   / ____||   __/|__|  \____/  |____|__ \____/|___|  /\___  /   \______  /____/____/|___  /
//         \/        \/     |__|                         \/          \//_____/           \/               \/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664380800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1664208000;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xd4c198DF54f6C1e14aE50F7bE6C877f3bAA8937F,0x4f7184A6e159D722840a9AB15DD3aa817D7d2034];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xd4c198DF54f6C1e14aE50F7bE6C877f3bAA8937F;
  uint256[] public payableFees = [5,48,47];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 6500;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 6500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTmAkSzqVnwPvqUcbUgwQkvro2k622HDtPmdGmsHMdQMa/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 6500");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6500");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6500");
...
// File: contracts/CkcCryptoKongClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CkcCryptoKongClubContract is RamppERC721A {
    constructor() RamppERC721A("CKCCryptoKongClub", "CKC"){}
}
