 ...
 * @notice This contract handles minting TEST tokens.
 */
contract TEST is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xA3267Df802F680e79C95Bfe7f4274fF6B1b6cc1d;
    address public royaltyAddress = 0x4fC909c2c29dBC0d5D3f9CbB6a06A9908FC97b7d;
    address[] public payoutAddresses = [
        0x4fC909c2c29dBC0d5D3f9CbB6a06A9908FC97b7d
    ];
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeiektf6fc3bfhws2u6syyv3qbymw67ghnv45ydewhxijnubn44td6q/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[1] = 0.001 ether;
        tokenPublicMintsPerAddress[1] = 0;
        tokenPresaleMaxSupply[1] = 0;
        tokenPresalePrice[1] = 0.001 ether;
