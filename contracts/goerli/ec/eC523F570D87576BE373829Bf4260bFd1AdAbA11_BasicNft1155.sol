...
\_|\_/|   ||   ||   \__| \_/|| \__\__|_)
 */
contract BasicNft1155 is ERC1155, Ownable {
    ...
    //"ipfs://bafybeibx2ejzd6obhdqlalljk3eon66h2dc75kudmbpuphqz6tmfagklo4/{id}"
    constructor()
        ERC1155(
            "ipfs://bafybeigoqglmuentlc4lmcjfmur2bzcc36can25thiq3wwz5dcf7jpilvq/{id}"
        ){
        mint(1,2);
        mint(2,3);
    }
