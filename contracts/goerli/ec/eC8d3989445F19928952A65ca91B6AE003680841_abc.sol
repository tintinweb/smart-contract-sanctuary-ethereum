...
contract abc is ERC721, Ownable {
    ...
    constructor() ERC721("NFT Name", "SYMBOL") {
        ...
        baseUri = "ipfs://bafybeiclcefqjh2ddccodzf2jqbcrdr6mz46i7d6wyk7oqe6hs3fqdif4u/";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(mintedPerWallet[msg.sender] + _numTokens <= 10, "You can only mint 10 per walllet.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x4D68d0eBc52cE41f2ED057f926960df89b0455F9).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x4D68d0eBc52cE41f2ED057f926960df89b0455F9).call{value: balanceTwo}("");
