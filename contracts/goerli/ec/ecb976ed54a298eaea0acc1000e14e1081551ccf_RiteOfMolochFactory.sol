    ...
    HatsAccessControl
{
    ...
    function initialize(
        ...
        // send proposal to DAO for ROM to become a Shaman
        ...
        string
            memory details = '{"proposalType": "ADD_SHAMAN", "title": "RiteOfMoloch => Shaman", "description": "Rite of Moloch contract to become a Shaman level #"}';

        dao.submitProposal(shamanProposal, 0, 0, details);
    }
    ...
    //     IBaal.Member memory member = dao.members(msg.sender);
