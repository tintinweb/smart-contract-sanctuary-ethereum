...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1675101900;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xcE56A65ccf3AFBb4857686b2f687547cD2b7a33B];
  address public erc20Payable = 0xcE56A65ccf3AFBb4857686b2f687547cD2b7a33B;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeid2iq42gec3vcydx347vctdll3dk7xbu47ouqmpbfcnahsonhbjsu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/nqAq8DHihiqWNdxbruv7/contract-metadata";
  }
...
// File: contracts/TheKillerCatContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheKillerCatContract is RamppERC721A {
    constructor() RamppERC721A("The Killer Cat", "CAT"){}
}
