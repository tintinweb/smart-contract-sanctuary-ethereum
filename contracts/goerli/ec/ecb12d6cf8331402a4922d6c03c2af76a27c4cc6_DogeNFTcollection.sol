...
contract DogeNFTcollection is ERC721Creator  {
  constructor() ERC721Creator ("Doge NFT collection", "DNC721", msg.sender) {}
}
...
contract ERC721Creator is AdminControl, ERC721, ERC721CreatorCore {
     ...
     * @dev See {ICreatorCore-setTokenURIExtension}.
     */
    function setTokenURIExtension(uint256[] memory tokenIds, string[] calldata uris)
        external
        override
        extensionRequired
    {
...
abstract contract CreatorCore is ReentrancyGuard, ICreatorCore, ERC165 {
    ...
    // the baseURI for which a given extension
    ...
    modifier extensionRequired() {
        require(_extensions.contains(msg.sender), "must be a registered extension");
        _;
    }
