...
contract PropertyVaultUUPS is AccessControlUpgradeable, UUPSUpgradeable, IPropertyVaultUUPS {
  ...
  function claim(
    ...
    // Verify that tokens and cumulativeAmountxws have the same length
  ...
  function _staticTransferFrom(
    ...
    bytes4 transferFromSelector = IBridgeToken.transferFrom.selector;
    bytes memory encodedTransferSelector = abi.encodeWithSelector(transferFromSelector, _from, _to, _value);
