...
contract RamperToken721 is ERC721A, Ownable, ReentrancyGuard, IRamperInterface721 {
    
    constructor() ERC721A("kollecttestv1", "ktv1") {
    }
    uint256 public immutable MAX_TOKENS = 200;
    uint256 public immutable MAX_TOKENS_PER_TXN = 10;
    uint256 public immutable MAX_TOKENS_PER_ADDRESS = 20;
    uint256 public immutable TOKEN_PRICE = 0.001 ether;
