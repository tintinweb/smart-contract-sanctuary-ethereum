...
contract test1155D is ERC1155Upgradeable, IERC2981 { /*TODO: 1155D, withdraw*/
    ...
    uint256 public constant maxNFTWhitelist = 3;

    uint256 public constant maxNFTPublic = 3;
...
function mintWhitelist(bytes32[] calldata _merkleProof, uint256 _amount) public payable {
    ...
    require((id + _amount) <= totalSupply, "Error: more than max supply will be reached");
    require(WLClaimed[msg.sender] + _amount <= maxNFTWhitelist, "Error: more than max whitelist will be reached");
...
function contractURI() virtual public view returns (string memory) { /**TODO: setter?? */
    return (contractUri);
}
