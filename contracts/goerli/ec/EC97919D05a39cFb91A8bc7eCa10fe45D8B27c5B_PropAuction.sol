...
contract PropAuction is Ownable,ReentrancyGuard {
    ...
    */
     ...
     *  returns     bool                        
    */    
    function successfulAuction(uint256 orderId_,address glodContract_,address to_,uint256 transactionPrice_)
        nonReentrant
        public
        payable
        onlyOwner()
        returns(bool)
        {
            ...
            if(glodContract_ != address(0x00)){
                //代币交易
                //初始化币种合约地址
                IERC20 coinContract = IERC20(glodContract_);                          //买家付款
