...
contract CollectingMeta is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public costOne = 0.007 ether;
    uint256 public costTwo = 0.008 ether;
    uint256 public costThree = 0.01 ether;
    uint256 public tokenTierOne = 2;
    uint256 public tokenTierTwo = 4;
        ...
        returns (uint256 _passBalance)
    {
        uint256 passBalance = IERC721Enumerable(
            ...
            0x793803B621077a74FB69705642984a6DF3472bD3
        ).balanceOf(_user);
        return passBalance;
    }
