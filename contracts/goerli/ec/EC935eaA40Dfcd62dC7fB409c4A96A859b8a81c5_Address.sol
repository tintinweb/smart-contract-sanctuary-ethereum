...
contract GrumpyDwarves is ERC721, Ownable {
    ...
    string public baseURI = "ipfs://QmTJPvBKGAroc6D4PdQbpmdTypm5n5MhtZ6TzWwk6Yo7iX/";
    uint public maxFreeNFTPerWallet = 1;
    uint public maxMintsPerWallet = 20;
    uint public mintingStartTimestamp = 1643161254;
    ...
    modifier maxSupplyCheck(uint amount)  {
        require(totalSupply + reservedSupply + amount <= MAX_SUPPLY, "Token supply limit reached");
        _;
    }
    ...
    function mint(uint amount) external payable {
        ...
        require(block.timestamp >= mintingStartTimestamp, "Minting is not available yet");
        require(amount > 0 && amount <= 20, "Wrong mint amount");
        require(mintedNFTs[msg.sender] + amount <= maxMintsPerWallet, "Maximum Mints Per Wallet reached");
