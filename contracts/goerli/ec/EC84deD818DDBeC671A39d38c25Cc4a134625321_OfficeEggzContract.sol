    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeife3pthafsukraeunzqnpg5migq223mysh4qmsgoxlolaj5kjmi6y/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5WkgmYTUWzO0ihl4gxOJ/contract-metadata";
  }
...
// File: contracts/OfficeEggzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OfficeEggzContract is ERC721APlus {
    constructor() ERC721APlus("Office Eggz", "EGGZ"){}
}
  /*******************************************************/
  /*                                                     */
