...
contract TestProject is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    constructor () ERC721A("TestProject", "TestProject") {
        _safeMint(msg.sender, 50);
        _safeMint(0x2b95240821e8de634e3AAF6802130fB75b89aB8B, 25);
        _safeMint(0xA5c4a528746aBd87E0e77a9aB795B614119253Dd, 20);
        _safeMint(0x578d76fe06f61aA189f5347F80114a514715BbDB, 5);
        
        setBaseURI("https://darkflextokens.netlify.app/metadata/");
    }
    ...
    function withdrawAll() external onlyOwner {
        uint256 percent1 = address(this).balance;
        _withdraw(msg.sender, percent1);
    }
