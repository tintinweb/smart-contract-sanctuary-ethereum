...
contract SevenThreeTwoSeven is ERC721, Ownable {
    ...
    uint256 public TIER_MAX_SUPPLY = 0;

    address r1 = 0xb333449fd966227cF3Af0FfD3aAF9d4Ff6F7C3e4;

    constructor() ERC721("SevenThreeTwoSeven", "STTS") {
    ...
    function mint(uint256 numberOfTokens) public payable {
        ...
        require(totalSupply() + numberOfTokens <= TIER_MAX_SUPPLY, "Exceeds max supply.");
    ...
    // set next tier max supply
    function setNextTierMaxSupply(uint256 _maxSupply) external onlyOwner {
        TIER_MAX_SUPPLY = _maxSupply;
    }

    // return current tier max supply
    function currentTierMaxSupply() public view returns (uint256) {
        return TIER_MAX_SUPPLY;
    }
