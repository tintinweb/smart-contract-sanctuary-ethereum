    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    uint256 private constant _TOTAL_SUPPLY = 20;
    ...
    function generateLocation(
        ...
        uint8 source = (uint8(pseudorandomness) % 8) + 1;
        if (source == 1) {
            return Location("London", 515073219, -1276474);
        } else if (source == 2) {
            return Location("Los Angeles", 340536909, -1182427660);
        } else if (source == 3) {
            return Location("Chicago", 418755616, -876244212);
        } else if (source == 4) {
            return Location("Houston", 297589382, -953676974);
        } else if (source == 5) {
            return Location("Phoenix", 334483771, -1120740373);
        } else if (source == 6) {
            return Location("Japan", 356894875, 1396917064);
        } else if (source == 7) {
            return Location("New York", 407127753, -740059728);
        } else if (source == 8) {
            return Location("San Jose", 373361663, -1218905910);
        } else {
            revert();
        }
    }
