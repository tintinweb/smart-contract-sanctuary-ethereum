...
contract Sure is ERC20, Ownable {
    ...
    // uint256 public _maxWalletSize = 5000000 * 10**decimals();
    // uint256 private _totalSupply = 500000000 * 10**decimals();

    // TEMP
    uint256 public _maxWalletSize = 50000 * 10**decimals();
    uint256 private _totalSupply = 5000000 * 10**decimals();

    address public marketingWallet;

    uint256 public taxAmount = 3;
    ...
    constructor() ERC20("Sure", "SURE") {
        ...
        marketingWallet = address(0x6107148068e7eeCDD2A54fF9FEC6302387e35Fc8);
    ...
    function setMaxWalletSize(uint256 maxWalletSize) external onlyOwner {
        require(
            ...
            "Max Wallet Size cannot be less than 1% of totalsupply."
        );
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            // Check wallet size limit
            require(
                amount <= _maxWalletSize,
            ...
            // Buy/Sell - tax to marketing wallet
            uint256 tax = 0;
            if (from == uniswapV2Pair || to == uniswapV2Pair) {
