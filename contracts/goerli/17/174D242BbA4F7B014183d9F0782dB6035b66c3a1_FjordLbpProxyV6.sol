...
contract FjordLbpProxyV6 is FjordLbpAbstractV1 {
    ...
    function createWeightedPoolForLBP(
        ...
        // rateProviders[0] = address(0x0000000000000000000000000000000000000000);
        // rateProviders[1] = address(0x0000000000000000000000000000000000000000);
        ...
        address weightedPool = WeightedPoolFactory(WeightedPoolFactoryAddress).create(
            ...
            weightedPoolConfig.rateProviders,
