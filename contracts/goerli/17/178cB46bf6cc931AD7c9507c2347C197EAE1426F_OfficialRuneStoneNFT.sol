...
// if they buy before rewrds are added they get those 
// so reveal, turn pub mint on
// let them mint then add a reward and they can claim it untill the next one
...
function ClaimOneToken(IERC20 token) public {
