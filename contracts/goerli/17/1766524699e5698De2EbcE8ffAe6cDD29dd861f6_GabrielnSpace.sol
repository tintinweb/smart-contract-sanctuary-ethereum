...
contract GabrielnSpace is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 664;
    ...
    address[] public withdrawAddresses = [0x9C708562D453d635C5357883b8152A55c8818de3, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x9C708562D453d635C5357883b8152A55c8818de3, _royaltyAmount);
    }
