...
contract Treelemma is ERC721A, Ownable {
    ...
    constructor() ERC721A("Treelemma", "TREE") {}

    function mintHaiku(string memory _ipfs) external onlyOwner{
        require(!paused, "Minting is paused");
        uint256 supply = totalSupply();
        require(supply + 1 <= maxSupply, "Sorry, we have reached the max supply");
        ipfs[supply] = _ipfs;
