    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public normalMintPrice = 0.005 ether;
    ...
    uint256 public publicSalesTimestamp = 1666153819;
    uint256 public whitelistSalesTimestamp = 1666153819;
    ...
    address private _signerPublicKey =
        0x3794dD48499272Bf9b312067E38c3e337FB85767;

    string private _contractUri;
    string private _baseUri;

    constructor() ERC721A("Table Test", "TABLE") EIP712("TableTest", "1.0.0") {}
    ...
    function _hash(address account) private view returns (bytes32) {
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(keccak256("TableTest(address account)"), account)
                )
            );
    }
