...
contract Revive is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Revive Coin", "REVIVE") {
        ...
        deployerAddress = address(0xbF016CCf042F6BBA524b246f7d90aAC0Ac83a656);
        marketingWallet = address(0xbF016CCf042F6BBA524b246f7d90aAC0Ac83a656);
