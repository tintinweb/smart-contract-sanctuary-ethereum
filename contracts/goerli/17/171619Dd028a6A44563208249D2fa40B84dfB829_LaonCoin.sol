...
abstract contract ERC20Mintable is ERC20, Ownable {
     ...
     */
    function mint (uint256 _amount) onlyOwner virtual public {
       _mint(msg.sender, _amount);

    }
}

abstract contract LAONToken is ERC20Burnable, ERC20Pausable, ERC20Mintable {
   ...
   function increaseAllowance(address spender, uint256 addedValue) public whenNotPaused override returns (bool) {
    ...
    function burnFrom(address _account,uint256 _value) whenNotPaused public override {
        super.burnFrom(_account,_value);
    }

    function mint(uint _amount) whenNotPaused public override {
        super.mint(_amount);
    }
}
