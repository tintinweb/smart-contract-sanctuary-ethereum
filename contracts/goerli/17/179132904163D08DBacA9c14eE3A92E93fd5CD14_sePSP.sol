...
contract TimeLockedERC20 is ERC20Permit, Ownable, Pausable {
    ...
    constructor(
        ...
        require(_timeLockDuration >= _minTimeLockDuration && _timeLockDuration <= _maxTimeLockDuration, "timelock out of range");
    ...
    function changeTimeLock(uint256 newTimeLockDuration) external onlyOwner {
        require(newTimeLockDuration >= minTimeLockDuration && newTimeLockDuration <= maxTimeLockDuration, "timelock out of range");
