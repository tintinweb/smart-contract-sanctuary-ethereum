...
contract Staking is BaseContract, ERC721 {
    ...
    function tokenURI(uint256 tokenId_) public view override returns (string memory)
    {
        ...
        if(_tokenType(tokenId_) == 2) _type_ = 'Red Carpet';
        if(_tokenType(tokenId_) == 3) _type_ = 'Dead';
        bytes memory _meta_ = abi.encodePacked(
            ...
            '"attributes": [',
            abi.encodePacked(
                '{"trait_type": "Stake Type", "value": "', _tokenType(tokenId_), '"},',
                '{"trait_type": "Stake Amount", "value": "', _stakeAmount[tokenId_].toString(), '"},',
                '{"trait_type": "Stake Start", "value": "', _stakeStart[tokenId_].toString(), '"}'
            ),
            ']',
            '}'
        );
