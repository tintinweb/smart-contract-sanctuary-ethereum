...
contract GeorgeAnimalFriends is Ownable, ERC721A, ReentrancyGuard {
    constructor() ERC721A("GeorgeAnimalFriends", "GAF") {
        _safeMint(owner(), 1);
    }

    string public baseURI = "ipfs://bafybeictjya6qf4qknyvoq7hk7o2e2y4l75ddpv6rduk3gejchuhwxl274/";
    string public baseExtension = ".json";
    uint256 public cost = 0;
    uint256 public maxSupply = 30;
    uint256 public maxMintAmountPerTx = 5;
    uint256 public publicSaleMaxMintAmountPerAddress = 100;
    uint256 public burnMintedTotalSupply;
    bool public burnMintMode = false;
...
//onlyOwner block
    ...
    function setBurnMintMode(bool _burnMintMode) public onlyOwner {
        burnMintMode = _burnMintMode;
    }
