...
contract AutoMinterERC20 is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    // function initialize(address fundsContract_, address stakingContract_) public initializer  {
    ...
    function initialize(address stakingContract_, address fundsContract_) public virtual initializer {
    ...
    {
        // todo: require contract caller to be a registered contract to avoid direct mints
        ...
        uint256 volumeRewardsQuantity = diff  * 35 / 98;
        uint256 stakingRewardsQuantity = diff  * 17 / 98;
        uint256 fundsQuantity = diff  * 46 / 98;

        // mint tokens based on new allocation (getAllocation)
        _mint(msg.sender, volumeRewardsQuantity);
     ...
     */
    function hasClaimedAirdrop(address account) onlyOwner() external view returns (bool)
    {
    ...
    function _getTotalAllocation(uint256 amount) pure private returns (uint256)
    {
        ...
        uint256 supply = 20000000 + (980000000 * amount + 10000) / (amount + 20000050);
