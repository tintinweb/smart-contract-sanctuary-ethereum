...
contract HelloWorld is Ownable, ERC721A {
    ...
    constructor(string memory _baseURI) ERC721A("Eterna", "ETERNA") {
        baseURI = _baseURI;
    }
    ...
    function contractURI() public pure returns (string memory) {
        return "https://eterna.io/opensea/contract_metadata.json";
    }
    ...
    function withdraw() public onlyOwner {
        ...
        emit widthrawToWallet(msg.sender);
    }
}
