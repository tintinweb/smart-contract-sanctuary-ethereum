...
contract WethController is BaseController {
    ...
    constructor (
        ...
        address registry,
        IWETH wethContract
    ) public BaseController(manager, registry) {
        require(address(wethContract) != address(0));
        weth = wethContract;
    }
    ...
    function wrap(uint256 amount) external payable onlyManager {
    ...
    function unwrap(uint256 amount) external onlyManager {
...
contract PoolTransferController is BaseController {
    ...
    // solhint-disable-next-line no-empty-blocks
    constructor(address manager, address registry) public BaseController(manager, registry) {}
    ...
    function transferToPool(address[] calldata pools, uint256[] calldata amounts) external onlyManager {
