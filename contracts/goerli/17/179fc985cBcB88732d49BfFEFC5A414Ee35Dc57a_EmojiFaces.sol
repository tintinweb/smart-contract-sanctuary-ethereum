...
contract EmojiFaces is ERC721, ERC721Enumerable, Ownable{
    ...
    uint256 public constant tokenPrice= 1900000000000000;//nft mintleme ücreti gibi 0.019 ETH
    uint256 public constant maxTokenPurchase=3; // toplamda 10 tane nft mintleyebilir
    uint256 public constant MAX_TOKENS=15;

    string public baseURI=""; // IPFS URI'SI TÜM TOKENLER SATILDIKTAN SONRA AYARLANACAK.
    ...
    constructor() ERC721("EmojiFaces", "EFC"){}
        ...
        returns (string memory)
    {
         require(
             _exists(tokenId),
             "ERC721Metadata: Var olmayan belirtec icin URI sorgusu"
         );

         string memory currentBaseURI = _baseURI();

         if(isRevealed==false){
             return "ipfs://QmQ6PMPtmfefgHeeMzDFytK5ZxAs6EXM3BTNXas1sL6hb9/hidden.json";
         }
