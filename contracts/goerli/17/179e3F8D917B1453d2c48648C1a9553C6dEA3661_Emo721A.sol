...
// --------------- MINTING --------------- \\
    ...
    function mint(uint256 _quantity, address to) external payable nonReentrant {
    ...
    function mintWhiteList(uint256 _quantity, address to) external payable nonReentrant onlyWhitelisted {
        require(!paused, "Minting is paused");
        require(msg.sender == tx.origin, "Be yourself");
        require(msg.value == _quantity * price, "Please send the exact amount.");
