...
/// @title Fallback Manager - A contract that manages fallback calls made to this contract
/// @author Richard Meissner - <r[email protected]>
...
library Sealib {
    ...
    function buildOrderFor(
        ...
        // Build this first to prevent rounding errors when calculating opensea 2.5% fee
        uint256 offererRevenue = (amount * (100e18 - 2.5e18)) / 100e18; // 97.5%
        ...
        for (uint256 i = 2; i < countRecipientsRoyalties; ) {
            ...
            considerations[i] = considerationRoyalty;
