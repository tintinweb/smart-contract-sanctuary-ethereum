...
// File: https://github.com/net2devcrypto/n2dstaking/MTECRewards.sol

pragma solidity ^0.8.9;

contract MTECRewards is ERC20, ERC20Burnable, Ownable {
    mapping(address => bool) controllers;

    constructor() ERC20("MTECRewards", "N2DR") {}
...
contract NFTStaking is Ownable, IERC721Receiver {
    ...
    constructor(Collection _nft, MTECRewards _token) {
        nft = _nft;
        token = _token;
    }
