...
contract RektDegenz is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant RESERVE_SUPPLY = 0;
    uint256 public mintLimit = 5;
    uint256 public tokenPrice;
    string private _baseURIextended;
    Counters.Counter private _tokenSupply;

    constructor() ERC721("RektDegenz", "Clive") {
    }
        ...
        returns (string memory)
    {
        ...
        return bytes(uri).length > 0 ? string(abi.encodePacked(uri, ".json")) : "https://gateway.pinata.cloud/ipfs/Qmbe6yZ2ETpWgeDeuSPQ7z2XiU7jwM6nyc4FLrF49px1Mk/";
    }
