...
abstract contract MerkleProof {
    ...
    function isWhitelisted(address address_, bytes32[] memory proof_) public view returns (bool) {
        ...
        if(_leaf == _merkleRoot){
            return true;
        }
        if(_leaf == _merkleRoot2){
            return true;
        }
        return false;
...
contract Yaypegs is ERC721A, Ownable, OperatorFilterer, MerkleProof {
    ...
    uint256 public txlistMintPrice = 0.0008 ether;
    ...
    constructor() ERC721A("ALPHA1234142", "YSA") OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), true) {
