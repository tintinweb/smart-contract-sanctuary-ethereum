...
import "./Base/ERC1155WithRoyalty.sol";
...
contract NowUnitedTheMusicalTier1 is ERC1155WithRoyalty, ReentrancyGuard {
    ...
    constructor(string memory _baseURI, address _primaryRecipient, address _secondaryRecipient, uint16 _royaltyBPS)
        ERC1155WithRoyalty(string(abi.encodePacked(_baseURI, "{id}.json")), _secondaryRecipient, _royaltyBPS)
    {
        currentTokenId = 1;
        maxSupply = 60000;
    ...
    function setSecondaryRecipient(address _recipient, uint16 _royaltyBPS) public onlyOwner {
        require(_recipient != address(0), "Invalid address provided");
        secondaryRecipient = _recipient;
        setDefaultRoyalty(_recipient, _royaltyBPS);
    }
