...
// , AragonApp 
{
    ...
    */
    ...
    function swap(uint256 _amount, address to) external returns (uint256) {
        require(_amount <= _sharesOf(msg.sender), "KiKiStaking::swap: not enough balance");
        require(address(0) != to, "KiKiStaking::swap: transfer to zero address");
    ...
    */
    ...
    function _getBufferedEther() internal view returns (uint256) {
        ...
        require(address(this).balance >= buffered, "KiKiStaking::_getBufferedEther: buffered ether error");
    ...
    */
    ...
    function destroyContract(address recipient) external auth(TEMPORARY_WITHDRAW_ROLE) returns (uint256) {
        require(recipient != address(0), "KiKiStaking::destroyContract: Transfer to zero address");
