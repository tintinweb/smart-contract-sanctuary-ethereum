...
contract DreamEyeRoyaltyUpgrV1 is 
  ...
  uint256 public publicSaleTokenCntNew;

  bool public sideCarsEnabled;     
  ...
  function initialize(string memory _tokenName,
    ...
    uint96 _royaltyPercent) public initializer {
  ...
  //TODO check Upgradeable interface
  function setDefaultRoyalty(address receiver, uint96 numerator) external onlyOwner {
      ERC2981Upgradeable._setDefaultRoyalty(receiver, numerator);
  }
  ...
  //TODO - check Upgradeable interfaces
  function supportsInterface(bytes4 interfaceId) public view override(ERC721AUpgradeable, ERC2981Upgradeable, IERC165Upgradeable) returns (bool) {
  ...
  function _afterTokenTransfers(address from, address to, uint256 tokenId, uint256 quantity) internal override {
    ...
    // function setApprovalForAll(address operator, bool approved) public override(ERC721AUpgradeable, IERC721Upgradeable) onlyAllowedOperatorApproval(operator) {
    //     super.setApprovalForAll(operator, approved);
    // }

    // function approve(address operator, uint256 tokenId) public override(ERC721AUpgradeable, IERC721Upgradeable) onlyAllowedOperatorApproval(operator) {
    //     super.approve(operator, tokenId);
    // }

    function transferFrom(address from, address to, uint256 tokenId) public override(ERC721AUpgradeable, IERC721Upgradeable) onlyAllowedOperator(from) {
        super.transferFrom(from, to, tokenId);
    }

    function safeTransferFrom(address from, address to, uint256 tokenId) public override(ERC721AUpgradeable, IERC721Upgradeable) onlyAllowedOperator(from) {
