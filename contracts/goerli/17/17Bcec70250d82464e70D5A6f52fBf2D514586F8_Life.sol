...
contract Life is ERC20, Ownable, Pausable {
    ...
    /// @notice Only NFT contract address can call this function
    ...
    function claimStakingRewards(uint256 tokenId) public whenNotPaused {
        ...
        // @note if the answer on tha above questions are true,
        // mint new ERC20 tokens. Claimable amount will be minted on the property owner
        _mint(
...
/// @notice TODO: handle the open Bids if selling of a property has been cancelled
