...
interface ITradeCoin {
    ...
    function withdrawPayment(uint256 tokenIdOfTokenizer) external;
    ...
    function addInformationToCommodity(uint256 tokenId, string memory data)
        external;

    function checkQualityOfCommodity(uint256 tokenId, string memory data)
        external;
    ...
    function burnCommodity(uint256 tokenId) external;

    function batchCommodities(uint256[] memory tokenIds) external;

    function splitCommodity(uint256 tokenId, uint256[] memory partitions)
        external;
}
