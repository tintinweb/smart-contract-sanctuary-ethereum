...
contract TokenSwapWith0x {
    ...
    uint256 public amount_pre;
    uint256 public amount_after;
    ...
    function _processBuyToken(
      ...
      if(address(buyToken) == ADDRESS_ETH_ZERO ){
        ...
        amount_ = boughtAmount;
        amount_pre = currentBuyTokenBalance;
        amount_after = address(this).balance;
        // WETH.transfer(msg.sender, boughtAmount);
