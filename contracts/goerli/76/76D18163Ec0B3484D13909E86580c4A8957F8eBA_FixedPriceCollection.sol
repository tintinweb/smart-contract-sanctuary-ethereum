  ...
  ITokenCreator
{
  ...
  function _updateMaxTokenId(uint32 _maxTokenId) internal {
    require(_maxTokenId != 0, "FixedPriceCollection: `_maxTokenId` may not be 0");
    require(_maxTokenId < maxTokenId || totalSupply() == 0, "FixedPriceCollection: `_maxTokenId` may not increase");
    require(latestTokenId <= _maxTokenId, "FixedPriceCollection: `_maxTokenId` must be >= to last tokenId");
    maxTokenId = _maxTokenId;
