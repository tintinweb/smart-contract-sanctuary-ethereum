...
contract MyNFT is ERC721, Ownable {
    ...
    constructor() ERC721("MyNFT #3", "NFT") {
        mintPrice = 0.01 ether;
        totalSupply = 0;
        maxSupply = 1000;
        maxPerWallet = 3;
        withdrawalWallet = payable(0xcF13D0D9f6097F56d04513C76a31F9B041107Ca7);

        isMintEnabled = false;
        
        baseTokenUri = "ipfs://QmP5vwaxXmZG5mteBhyiR4GGpwqo4pQ6V8GSEirBCP8m1U/";
    }
    ...
    function airdrop(uint256 quantity_) public onlyOwner {
        for(uint256 i = 0; i < quantity_; i++){
            uint256 newTokenId = totalSupply + 1;
            totalSupply++;
            _safeMint(withdrawalWallet, newTokenId);
        }
    }
}