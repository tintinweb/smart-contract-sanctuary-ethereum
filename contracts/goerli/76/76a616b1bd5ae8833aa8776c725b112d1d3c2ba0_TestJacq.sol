...
contract TestJacq is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint256 public pricePresale = 0.007 ether; //set NFT price
    uint256 public pricePublic = 0.007 ether; //set NFT price
