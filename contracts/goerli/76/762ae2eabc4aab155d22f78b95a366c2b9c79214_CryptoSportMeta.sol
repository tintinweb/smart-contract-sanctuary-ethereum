...
contract CryptoSportMeta is ERC721Enumerable, Ownable {
    ...
    ) ERC721("Crypto Sport Meta Ordinary", "CSM") {
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(nftsPerWallet[_to] < maxMintAmount, "You can only get 1 NFT on the sale");
        //general public
        require(msg.value >= cost * _mintAmount);
       

        // Increment the number of NFTs this user minted
        nftsPerWallet[_to] += _mintAmount;
    ...
    *
    * @param _account The account of the happy new owner of 2000 NFT
    **/
