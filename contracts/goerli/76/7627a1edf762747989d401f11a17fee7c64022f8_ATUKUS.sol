...
// ERC721A Smart Contract & Web3 Technology by NFTElite.com
...
contract ATUKUS is ERC721A, Ownable, DefaultOperatorFilterer  {
  using SafeMath for uint256;
    ...
    address private wallet1 = 0x7a29d9a21A45E269F1bFFFa15a84c16BA0050E27; // Wallet 1 50% - This are just for test purposes
    address private wallet2 = 0x7a29d9a21A45E269F1bFFFa15a84c16BA0050E27; // Wallet 2 40% - This are just for test purposes
    address private wallet3 = 0x7a29d9a21A45E269F1bFFFa15a84c16BA0050E27; // Wallet 3 10% - This are just for test purposes
    ...
    constructor() ERC721A("ATUKUS", "ATUKUS") {}
  ...
  // What is this? A secret function? The first person to take a screenshot of this message and open a ticket with it gets a secret prize, sausage pays
    ...
    function mint(address to, uint256 numberOfTokens) external payable callerIsUser {
        ...
        require(numberMinted(to).add(numberOfTokens) <= maxPurchase,"Exceeds Max mints allowed per wallet");
