...
contract TokenWizardAuto is AutomationCompatibleInterface {
    ...
    /** @notice users have ability to pass in a variety of arguments to customize the contract terms to fit their needs
      @param _objectUri: URI with name, description, and image uri  (basically an NFT URI but without actually implementing ERC721) 
      @param borrower: address of the user borrowing liquidity by using their physical object as collateral  
      @param lender: address of the user lending their liqudity. (receives interest if applicable) 
      @param financialTerms: struct of uints representing the financial terms of the contract  */
    constructor(
