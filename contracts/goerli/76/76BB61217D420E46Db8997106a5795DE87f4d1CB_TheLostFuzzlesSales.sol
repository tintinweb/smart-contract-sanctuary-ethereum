    ...
    ReentrancyGuard
{
    ...
    constructor(address nftAddress, address galaAddress) {
        nft = nftAddress;
        gala = IERC20(galaAddress); // 0x15D4c048F83bd7e37d49eA4C83a07267Ec4203dA mainnet
        purchasePriceInEth = 0.008 ether;
        maxPurchase = 10;
    }
