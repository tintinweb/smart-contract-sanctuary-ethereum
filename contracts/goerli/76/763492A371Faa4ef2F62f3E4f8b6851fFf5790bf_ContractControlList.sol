...
contract ContractControlList is AccessControl {
    ...
    bytes32 public constant EARTHLING_ADMIN_ROLE =
        keccak256("EARTHLING_ADMIN_ROLE");
    ...
    bytes32 public constant EARTHLING_MINTER_ROLE =
        keccak256("EARTHLING_MINTER_ROLE");
    bytes32 public constant ROYALTY_INFO_CHANGER_ROLE =
        keccak256("ROYALTY_INFO_CHANGER_ROLE");

    // Land, Earthling and Founder contracts should have this role assigned for acl-s checks between them
    bytes32 public constant LAND_ROLE = keccak256("LAND_ROLE");
    bytes32 public constant EARTHLING_ROLE = keccak256("EARTHLING_ROLE");
    bytes32 public constant FOUNDER_ROLE = keccak256("EARTHLING_ROLE");
    ...
    constructor(address admin_) {
        ...
        _setupRole(EARTHLING_ADMIN_ROLE, admin_);
        ...
        _setRoleAdmin(EARTHLING_MINTER_ROLE, EARTHLING_ADMIN_ROLE);
        _setRoleAdmin(EARTHLING_ROLE, EARTHLING_ADMIN_ROLE);
        _setRoleAdmin(FOUNDER_ROLE, EARTHLING_ADMIN_ROLE);
    ...
    function grantEarthlingMinterRole(address addr_) external {
        grantRole(EARTHLING_MINTER_ROLE, addr_);
    }

    function grantEarthlingAdminRole(address addr_) external {
        grantRole(EARTHLING_ADMIN_ROLE, addr_);
    }
    ...
    function grantEarthlingRole(address addr_) external {
        grantRole(EARTHLING_ROLE, addr_);
    }
    ...
    function checkEarthlingMinterRole(address addr_) external view {
        _checkRole(EARTHLING_MINTER_ROLE, addr_);
    }

    function checkEarthlingAdminRole(address addr_) external view {
        _checkRole(EARTHLING_ADMIN_ROLE, addr_);
    }
    ...
    function checkEarthlingRole(address addr_) external view {
        _checkRole(EARTHLING_ROLE, addr_);
    }
    ...
    function hasEarthlingMinterRole(address addr) external view returns (bool) {
        return hasRole(EARTHLING_MINTER_ROLE, addr);
    }
}
