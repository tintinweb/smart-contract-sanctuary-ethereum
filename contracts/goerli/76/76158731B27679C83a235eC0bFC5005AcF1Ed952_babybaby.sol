...
contract babybaby is Ownable, ERC721A, ReentrancyGuard {
    ...
    string public BASE_URI="https://data.punk13.net/metadata/";
    ...
    constructor() ERC721A("babybaby", "babybaby") {
        _safeMint(msg.sender, 1);
    }  
    
    function info(address user) public view returns (Info memory) {
        return  Info(maxSupply,totalSupply(),PRICE,0,_numberMinted(user),LIMIT,_isActive);
    }
