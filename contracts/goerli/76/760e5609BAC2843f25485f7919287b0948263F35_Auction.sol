...
contract Auction is Ownable{
    ...
    event CreatedAuction(uint auctionID, address _token, uint _tokenAmount, uint _tokenType, uint _endTime, uint256 time);
    ...
    function createAuction(address _token, uint _tokenAmount, uint _tokenType, uint _endTime) onlyOwner payable public {
        ...
        auctionID++;
        emit CreatedAuction(auctionID, _token, _tokenAmount, _tokenType, _endTime, block.timestamp);
    }
