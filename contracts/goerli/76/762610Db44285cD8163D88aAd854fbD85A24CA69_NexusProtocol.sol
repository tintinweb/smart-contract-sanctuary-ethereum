...
contract NexusProtocol is Ownable {
    ...
    // ensure approval for collection made before listing
    // TODO: if not owner of token ID, cannot list token
    function createListing(
        ...
        require(
            ...
            "Contract must be approved for all"
        );
        ...
        // check allowance, if not failure
        ...
        payable
    {
        ...
        require(msg.value >= listing.price, "Insufficient value");

        // protocol takes 1% fee for each purchase facilitated
        payable(listing.seller).transfer((msg.value * 99) / 100);
