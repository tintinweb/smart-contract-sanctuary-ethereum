 ...
 *
 * Special note: This implementation uses Operator Filter Registry from OpenZeppelin
 */

contract ERC721VGE is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    /**
     * ========================
     *          Events
     * ========================
    ...
    constructor(
        ...
        require(
            saleSettings_.amountForFounders <= saleSettings_.collectionSize,
            "larger collection size needed"
        );
        // check withdraw entry data
        require(
            saleSettings_.withdrawAddresses.length > 1,
            "withdrawAddresses size must be minimum 2"
        );
        require(
            saleSettings_.withdrawAddresses.length ==
                saleSettings_.withdrawPercentages.length,
