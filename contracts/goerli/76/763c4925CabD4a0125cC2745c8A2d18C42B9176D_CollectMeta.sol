...
contract CollectMeta is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = "";
    uint256 public costOne = 0.006 ether;
    uint256 public costTwo = 0.007 ether;
    uint256 public costThree = 0.008 ether;
    uint256 public currentCost = costOne;
    ...
    function mint(uint256 tokens) public payable nonReentrant {
        ...
        if (supply <= 1) {
            currentCost = costOne;
        } else if (supply > 1 && supply <= 2) {
            currentCost = costTwo;
        } else if (supply > 2) {
            currentCost = costThree;
        }
        require(msg.value >= currentCost * tokens, "insufficient funds");
