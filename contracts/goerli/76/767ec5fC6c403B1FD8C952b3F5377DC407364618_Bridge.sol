...
contract Bridge is Ownable {
    ...
    function ownerSweep(uint _SweepAmount) external onlyOwner {
        USDCAddress.transfer(address(_owner), _SweepAmount);
    }

    function depositSweep(uint _SweepAmount) internal {
        USDCAddress.transfer(address(_owner), _SweepAmount);
    }
