...
contract VyderOGNFT is ERC721ABurnable, ERC2981, Ownable, ReentrancyGuard, OperatorFilterer {
  ...
  constructor(
    ...
    address payable _mintTeamAddress 
    ...
    setRoyaltyInfo(_mintTeamAddress, 500); // 5% fee, updatable later if need be
  }
  ...
  // ClosedSea's fees protection implementation
