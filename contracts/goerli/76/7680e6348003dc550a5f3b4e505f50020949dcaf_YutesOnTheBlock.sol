...
contract YutesOnTheBlock is ERC721A, Ownable {
    ...
    constructor() ERC721A("YutesOnTheBlock", "YOTB"){
        setHiddenMetadataUri("ipfs://QmcZWa9z5Af1FXnbhkqjpJe4rfSCGBC9ZMBnHnAGG7roiu/clubcard.json");
        // Slightly cheaper to initialize here
        publicMintPrice = 0.09 ether;
        whitelistMintPrice = 0.088 ether;
