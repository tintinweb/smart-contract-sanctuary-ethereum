...
contract LizhiNiubi is ERC721, Ownable {
    ...
    constructor() ERC721("Lizhiniubi", "SYMBOL") {
        baseUri = "ipfs://QmaqVgKwtoyuWvj7JqiPexmcvik125Km2FhVmAsTKncPss/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x06B7e5DDE9056cF007b65585B9A14ce200b672B3).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x06B7e5DDE9056cF007b65585B9A14ce200b672B3).call{value: balanceTwo}("");
    ...
    function addUserAddressToWhitelist(address _addressToWhitelist) public onlyOwner {
        require(
            ...
            "Error: Sender already bean whitelisted"
        );
    ...
    function removeUserAddressFromWhitelist(address _addressToRemove) public onlyOwner {
        require(
            whitelistedAddresses[_addressToRemove],
            "Error: Sendner is ot whitelisted"
        );
