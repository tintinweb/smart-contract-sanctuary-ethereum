...
contract Pulsedoge is ERC20, ERC20Burnable {
    ...
    uint256 private constant CONTRACT_MINT_AMOUNT = 985000000; // 09/12/2022 audit
    uint256 private constant DEPLOYER_MINT_AMOUNT = 15000000; // 09/12/2022 audit
    ...
    // CONSTRUCTOR ------------------------------------------------------------------------------------------
    constructor(address _managerAddress) ERC20("Pulsedoge", "Pulsedoge") {
        require(_managerAddress != address(0), "Manager: address is zero"); // 09/12/2022 audit
    ...
    function setManagerAddress(address _managerAddress) public onlyOwner {
        ...
        managerAddress = _managerAddress;
        emit ManagerTransferred(oldManager, _managerAddress); // 09/12/2022 audit
    }
