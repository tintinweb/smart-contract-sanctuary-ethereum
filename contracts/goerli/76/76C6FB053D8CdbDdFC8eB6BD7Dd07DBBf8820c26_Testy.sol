...
// File: contracts/RudeSpecial/lib/Constants.sol
...
// File: contracts/RudeSpecial/IOperatorFilterRegistry.sol
...
// File: contracts/RudeSpecial/OperatorFilterer.sol
...
// File: contracts/RudeSpecial/DefaultOperatorFilterer.sol
...
// File: contracts/RudeSpecial/TestyBae.sol
...
contract Testy is ERC721A, Ownable, ReentrancyGuard, Pausable, DefaultOperatorFilterer{
    ...
    function mint(uint256 _quantity) external payable whenNotPaused nonReentrant {
        if (totalSupply() <= cap1) { // EXECUTE LOGIC BELOW IF SUPPLY IS LOWER THEN CAP1 VARIABLE
            ...
            require(mintEnabled, 'TestNFT: Public Sale paused');
            // NO CONTRACT MINTING
            require(tx.origin == msg.sender, 'TestNFT: No contracts');
            // SETTING MAX SUPPLY CAP
            require(totalSupply() + _quantity <= maxSupply, "Error: max supply reached");
            // ENFORCING MAX MINTS PER WALLET
            require(previous + _quantity <= maxMintPerWallet, "Error: Cannot mint more than 10");
