...
{    
    ...
    struct InternalSale
    {
        ...
        uint _CurrentIndex;       // [3] -> _CurrentIndex
        uint _MaxIndex;           // [4] -> _MaxIndex
    }
    ...
    MintPass public MintPassSale = MintPass(
        0.0020 ether,   // [0] -> _PriceStart    
        0.00005 ether,  // [1] -> _PriceEnd   
        417,        // [2] -> _MaximumAvailableForSale
        1662286500, // [3] -> _StartingBlockUnixTimestamp
        677,        // [4] -> _SecondsBetweenPriceDecay
        true,      // [5] -> _ActivePublic
        false,       // [6] -> _ActiveBrightList
        0xbc29d58cc89288efad9feccab08e243e1b6c1feda75f51e0ba312499642c84a1
    ); 
    MintPack public MintPackSale = MintPack(
        0.020 ether,   // [0] -> _PriceStart     
        0.0005 ether,    // [1] -> _PriceEnd     
        10,         // [2] -> _MaximumAvailableForSale
        1662286500, // [3] -> _StartingBlockUnixTimestamp
        677,        // [4] -> _SecondsBetweenPriceDecay
        true,      // [5] -> _ActivePublic
        false,       // [6] -> _ActiveBrightList
        0x4d89b0b61e8eff235bdbf26547b7b90efea5063f9347f3a20b045cfaaa5e88a0
    );
    ...
    InternalSaleMintPack public MintPackInternalSale = InternalSaleMintPack(
        0,   // [0] -> _AmountSold
        0,   // [1] -> _FinalClearingPrice
        483, // [3] -> _MintPackIndex
        582  // [4] -> _MintPackMaxIndex
    );
    ...
    address public Option = 0x36077FA75C36c161e625792a8266002804AADF05;
    ...
    event PurchasedMintPack(address Recipient, uint Amount, uint MessageValue, uint AmountSold);
    ...
    { 
        ...
        _mint(_BRT_MULTISIG, 150);  // Artist Reservation & BM Dao: [TokenIDs: 333 - 482] (150)
                                    ...
                                    //                                                      =
                                    //                                                    (1000) TOTAL
        _WalletAllocationsMintPack[0xA5B3eb6f8e4EDA06D04901E360C9ebD41883E907] = 5;
        _WalletAllocationsMintPack[0x86bF2d1f3528bc8CBf60D7A323cDd22830eDef1e] = 5;
        _WalletAllocationsMintPack[0x91594b5E5d74FCCB3f71674eE74C5F4D44f333D5] = 5;
        _WalletAllocationsMintPack[0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937] = 5;

        _WalletAllocationsMintPass[0xA5B3eb6f8e4EDA06D04901E360C9ebD41883E907] = 200;
        _WalletAllocationsMintPass[0x86bF2d1f3528bc8CBf60D7A323cDd22830eDef1e] = 200;
        _WalletAllocationsMintPass[0x91594b5E5d74FCCB3f71674eE74C5F4D44f333D5] = 200;
        _WalletAllocationsMintPass[0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937] = 200;
    ...
    function PurchasePack(uint Amount, bytes32[] calldata Proof) external payable nonReentrant
    {
        ...
        emit PurchasedMintPack(msg.sender, Amount, msg.value, NewAmountSold);
    }
    ...
    function RedeemOption(uint[] calldata TokenIDs) external payable nonReentrant
    {
        ...
        require(MintPassInternalSale._FinalClearingPrice > 0, "MPMX: Final Clearing Price Not Seeded");
    ...
    {
        for(uint x; x < Wallets.length;) 
        { 
            _WalletAllocationsMintPass[Wallets[x]] = Allocations[x]; 
            unchecked { x++; }
        }
    }
    ...
    function __SeedWalletAllocationsMintPack(address[] calldata Wallets, uint[] calldata Allocations) external onlyOwner
    {
        for(uint x; x < Wallets.length;) 
        { 
            _WalletAllocationsMintPack[Wallets[x]] = Allocations[x]; 
            unchecked { x++; }
        }
    }
    ...
    {
        for(uint x; x < NewArtistIDs.length;) 
        { 
            ArtistID[(StartingIndex+x)] = NewArtistIDs[x]; 
            unchecked { x++; }
        }
    ...
    {
        for(uint x; x < Indexes.length;) 
        { 
            ArtistNames[Indexes[x]] = Names[x]; 
            unchecked { x++; }
        }
     ...
     */
    function __NewClearingPrice(uint FinalClearingPrice) external onlyOwner { MintPassInternalSale._FinalClearingPrice = FinalClearingPrice; }

    /**
     * @dev Instantiates New Multisig Address
     */
    function __NewMultisigAddress(address NewAddress) external onlyOwner { _BRT_MULTISIG = NewAddress; }
    ...
    function ____VRF2GenerateRandomArtistIDs(uint AmountToIterate) external onlyOwner
    {
        ...
        for(_GeneratedArtistIDs; _GeneratedArtistIDs < StartingIndex + AmountToIterate;) 
        { 
            _ArtistID[_GeneratedArtistIDs] = (uint(keccak256(abi.encode(randomResults, _GeneratedArtistIDs))) % 10) + 1;
            unchecked { _GeneratedArtistIDs++; }
        } 
    }
    ...
    { 
        ...
        for(uint x = CurrentIndex; x < CurrentIndex + Amount;)
        {
    ...
    function ____VRF4ExecuteArtistNameMapping(uint AmountToIterate) external onlyOwner
    {
        ...
        for(NumbersIteratedUpon; NumbersIteratedUpon < StartingIndex + AmountToIterate;)
        {
    ...
    function ViewCurrentPriceMintPass() internal view returns (uint Price) 
    {
        ...
        else if(MintPassInternalSale._FinalClearingPrice > 0) { return MintPassInternalSale._FinalClearingPrice; } // Sale Finished
    ...
    function ViewCurrentPriceMintPack() internal view returns (uint Price) 
    {
        ...
        else if(MintPassInternalSale._FinalClearingPrice > 0) { return MintPackInternalSale._FinalClearingPrice; } // Sale Finished
