...
interface IGemJoin {
    ...
    function ilk() external returns (address);
...
contract DssProxyActions {
    ...
    function freeETH(
        ...
        address weth = IGemJoin(ethJoin).ilk();
    ...
    //     GemLike(IGemJoin(gntJoin).ilk()).transfer(bag, amtC);
