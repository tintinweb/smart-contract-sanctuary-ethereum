	...
	Mint1155Validator
{
     ...
     */
    bytes4 constant _INTERFACE_ID_ERC1155_GHOSTMARKET =
        bytes4(keccak256("_INTERFACE_ID_ERC1155_GHOSTMARKET"));
    ...
    function mintGhostWithSignature(
        ...
        if (lazyMintData.minter != _msgSender()) {
            validate(
                lazyMintData.minter,
                LibERC1155LazyMint.hash(lazyMintData),
                lazyMintData.signature
            );
        }
        this.mintGhost(to, amount, data, royalties, externalURI, metadata, lockedcontent);
    }
...
library LibERC1155LazyMint {
    ...
    bytes32 public constant MINT_AND_TRANSFER_TYPEHASH = keccak256("Mint1155(uint256 tokenId,string tokenURI,uint256 amount,address minter)");
