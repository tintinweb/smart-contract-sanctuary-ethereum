...
contract Testiment is ERC721A, Ownable {
	...
	string public prerevealURL = 'ipfs://QmdfAsuxiPp4m8MjAHFnorCWVkcaiSmp6cZ9Y2gpjyzDAN/hidden.json';
	mapping(address => uint) private _walletMintedCount;

    // Name
	constructor()
	ERC721A('Testiment Yes', 'TESTTOKEN') {
    }
