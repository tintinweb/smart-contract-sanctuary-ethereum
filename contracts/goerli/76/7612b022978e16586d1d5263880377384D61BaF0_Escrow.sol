...
contract Escrow is IEscrow, Initializable, ReentrancyGuard, Multicall {
    ...
    function release(uint256 _amount)
        ...
        nonReentrant
    {
        bool isClient = msg.sender == talent;
    ...
    function _release(uint256 _amount) internal {
        released += _amount;
        emit Released(talent, address(0), _amount, released);
    ...
    function _release(address _token, uint256 _amount) internal {
        ...
        emit Released(talent, _token, _amount, released);
    }
    ...
    function calcShare(uint256 _amount) internal pure returns (uint256) {
