...
contract GoerliNFT is ERC721URIStorage, Ownable {
    ...
    uint256 public constant COST = 0.00001 ether;

    constructor() ERC721("Goerli_NFT", "G_NFT") {}
            ...
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        ...
                        '<text class="h1" x="50" y="70">Gift</text>',
                        '<text class="h1" x="80" y="120" >NFTS</text>',
                        unicode'<text x="210" y="305">👋 Hello, # ',
                        utils.uint2str(id),
                        "</text>",
                        "</svg>"
                    )
            ...
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"Gift NFTS", "image":"',
                                image,
                                unicode'", "description": "Gift NFTs description"}'
                            )
                        )
                    )
                )
