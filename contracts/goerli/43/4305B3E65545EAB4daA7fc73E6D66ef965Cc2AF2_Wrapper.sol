...
contract Wrapper is ERC721, IERC721Receiver, Pausable, Ownable {
    ...
    //Variables
    address public ruggedproject; //address of Rugged NFT
    ...
    bool public wrapenabled; //Enable/Disable Wrapping
    bool public dynamicart = true; //Bool to enable dynamic art
    string public defaulturi = ""; //Default URI
