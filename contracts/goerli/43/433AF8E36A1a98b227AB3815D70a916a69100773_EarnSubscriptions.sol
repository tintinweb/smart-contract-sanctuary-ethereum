...
contract EarnSubscriptions is Ownable, Pausable {
    /*///////////////////////////////////////////////////////////////
                             VARIABLES
    //////////////////////////////////////////////////////////////*/
    ...
    function subscribe(uint256 subType) external whenNotPaused {
        // Check that the user amount of months is valid
        require(subType >= 0 && subType <= 2, 'INVALID_SUB_TYPE');
        // check that the user has not an active pass
        require(
            subscriptions[msg.sender] < block.timestamp || !hasValidSubcription(msg.sender),
        ...
        // emit the event
        emit Subscribed(msg.sender, subType, totalPrice);
    }

    function hasValidSubcription(address user) public view returns (bool) {
        return subscriptions[user] > block.timestamp || IERC721(VERIFIER).balanceOf(user) != 0;
    }
