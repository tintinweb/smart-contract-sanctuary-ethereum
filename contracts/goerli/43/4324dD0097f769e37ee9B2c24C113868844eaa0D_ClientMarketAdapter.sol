...
contract ClientMarketAdapter is ModuleAccessController, IClientMarketAdapter {
    ...
    function close(
        ...
        if (payout.stableAmount == 0 && payout.assetAmount == 0){ // notify frontend side that position premium reached position size
    ...
    {       
        ...
        require(payout.assetAmount > 0 || payout.stableAmount > 0, "CMA: liquidate-only" );
