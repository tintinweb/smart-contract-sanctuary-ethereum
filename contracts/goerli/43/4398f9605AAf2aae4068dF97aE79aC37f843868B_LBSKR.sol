...
contract LBSKR is BaseBSKR, DSMath, Stakable {
    ...
    function _setBSKRAddress(address newBSKRAddr) private {
        ...
        address _ammBSKRPair = _dexFactoryV2.getPair(address(this), newBSKRAddr);
