...
contract assignmentToken {
    ...
    event eTransfer(address indexed _from, address indexed _to, uint _amount);
    ...
    function burn(uint256 amount) public returns (bool) {
        ...
        emit eTransfer(msg.sender, address(0), amount);
        supply -= amount;
        return true;
    }
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        balances[_to] += _value;
        emit eTransfer(msg.sender, _to, _value);
        return true;
    }
    ...
    function transferFrom(
        ...
        balances[_to] += _value;
        emit eTransfer(_from, _to, _value);
        return true;
    }
