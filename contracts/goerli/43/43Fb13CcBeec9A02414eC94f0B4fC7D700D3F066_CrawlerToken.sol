...
contract CrawlerToken is ERC721, ERC721Enumerable, Ownable, ICrawlerToken {
  ...
  ICrawlerPlayer public _player;
	...
	constructor(address index, address player, address signer) ERC721('Endless Crawler', 'CRWLR') {
		setIndexContract(index);
		sePlayerContract(player);
		setSigner(signer);
	...
	/// @notice Admin function
	function sePlayerContract(address player_) public onlyOwner {
