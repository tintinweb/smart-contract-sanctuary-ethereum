...
contract Tougenkyou is ERC721A, ERC721AQueryable, ERC721ABurnable, ERC2981, Ownable, Pausable, DefaultOperatorFilterer {
    ...
    string private baseURI = "ar://hEeZuySA6rNWz9wN_h4ZnEPH5yFmz_pDGJsB26qKBtg/";
    ...
    constructor(bool mintERC2309Flg, address _adminAddress) ERC721A("TESTTOKEN", "TEST") Ownable(_msgSender()) {
        _setDefaultRoyalty(0x37df2D6523265a68975e2429e74E841d524b6BB9, 1000);
        if (mintERC2309Flg == true) {
            _mintERC2309(_adminAddress, 3000);
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x37df2D6523265a68975e2429e74E841d524b6BB9).transfer(balance);
    }
