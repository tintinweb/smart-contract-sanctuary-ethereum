...
/**
 * @title AnecdotalismStrook
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract AnecdotalismStrook is ERC20Permit, ReentrancyGuard, ERC20Burnable {
    address private _owner;

    constructor() ERC20("Anecdotalism Strook","COA")  ERC20Permit("Anecdotalism Strook") { 
        _owner = _msgSender();
     }
