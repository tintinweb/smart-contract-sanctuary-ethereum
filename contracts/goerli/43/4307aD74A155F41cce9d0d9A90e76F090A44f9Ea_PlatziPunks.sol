...
contract PlatziPunksDNA {
  ...
  // TODO: Calculate DNA
  function calculateDna(uint256 _tokenId, address _minter)
    public
    pure
    returns (uint256)
  {
    ...
    bytes32 hasedParams = keccak256(encodeParams);
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
  ...
  function mint() public {
    ...
    require(current < maxSupply, "No platzi punks lefts");
    tokenDna[current] = calculateDna(current, msg.sender);
