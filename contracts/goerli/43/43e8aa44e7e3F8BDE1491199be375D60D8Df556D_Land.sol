...
contract Land is ERC721, ERC2981, ReentrancyGuard, Ownable, Pausable {
    ...
    */
    ...
    /**
    * @dev Throws if allowance is not enough
    *
    * @param _nftQty quantity of nft to mint
    */
    modifier isValidAmount(uint256 _nftQty) {
        uint256 wETHAllowance = IERC20(wETHAddress).allowance(msg.sender, address(this));
        require(wETHAllowance == (mintPrice * _nftQty), "Invalid wETH allowance");
        _;
    }

    /**
    * @dev Throws if this contract's balance is 0
    *
    */
    ...
    */
    ...
    /**
    * @dev Set wETH contract address onlyOwner
    *
    */
    ...
    */
    ...
    /**
    * @dev Private function being called by withdraw and withdrawAll
    *
    * @param _amount amount to withdraw
    */
