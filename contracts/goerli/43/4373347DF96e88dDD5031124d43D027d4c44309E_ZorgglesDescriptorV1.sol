...
contract ZorgglesDescriptorV1 is Initializable, OwnableUpgradeable {
    ...
    IERC721Upgradeable public tokenContract;

    event ZoraDropUpdated(IERC721Drop zoraDrop);
    event TokenContractUpdated(IERC721Upgradeable tokenContract);
    ...
    function buildZorbs(uint256 tokenId) internal view returns (string memory) {
        ...
        // uint256 totalSupply = zoraDrop.saleDetails().totalMinted;
        ...
        for (uint i; i < 10; ++i) {
            address ownerAddress = tokenContract.ownerOf(i);
    ...
    */
    ...
    function setTokenContract(IERC721Upgradeable _tokenContract) external {
        require(msg.sender == _owner, "Rejected: not owner");
