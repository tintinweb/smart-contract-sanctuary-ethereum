...
contract RandoMintFinale is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    ...
    constructor(address _royaltyRecipient) ERC721("RandoMintFinale", "RDMF") Ownable() 
    {
