...
contract BACardV1 is Initializable, UUPSUpgradeable, ERC721Upgradeable, ERC2981, PausableUpgradeable, OwnableUpgradeable {
    ...
    */
            ...
            public 
    {
        ...
        withdrawalAddress = 0x1BA8f5D548Bf698d5b33d0BD5628C2EB76253264; // NOTE: changed before mainnet deployment
        revealURIMode = false; // initialized to false as per default
        royaltyReceiverAddress = 0x1BA8f5D548Bf698d5b33d0BD5628C2EB76253264; // NOTE: changed before mainnet deployment
        royaltyFeesInBips = 100; // NOTE: changed before mainnet deployment
