...
contract st2 is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeicyzliage2jscwrsw6bslcliml4hzfzysyxbvmp7esve3d4sqflf4/";
    ...
    function ownerMint(uint256 count)
   public onlyOwner { 
                  uint256 supply =totalSupply();
                  require(count > 0, "need to mint at least 1 NFT");
                   require(supply + count <=  maxSupply, "max NFT limit exceeded") ;
