    ...
    ReentrancyGuard
{
    ...
    bool public isUniqueImage = false;
    ...
    // NFT upgrade
    function upgradeNFT(address user, uint256[] memory tokenIds)
        external
        nonReentrant
        beforeUpgradeCheck(user, tokenIds)
    {
        _upgradeNFT(user, tokenIds);
    }
