...
contract Vendor is Ownable {
  ...
  function buyTokens() payable public {
    ...
    require (tokenAmount > 0, "Eth amount not enough for at least one token");
    yourToken.transfer(payable(msg.sender), tokenAmount);
  ...
  function sellTokens(uint256 _amount) public {
    require (yourToken.balanceOf(msg.sender) >= _amount, "Not enough token.");
