...
interface IBAYCSewerPass {
    function mintSewerPass(address to, uint256 mintdata)
        external
        returns (uint256);
}
...
contract YugaVerify {
     ...
     */
    function verifyTokenOwner(address tokenContract, uint256 tokenId)
        internal
        view
        returns (bool)
    {
...
contract BAYCSewerPassClaim is Operator, YugaVerify, ReentrancyGuard {
     ...
     */
    function claimBaycBakc(uint256 baycTokenId, uint256 bakcTokenId)
        external
        claimable
        nonReentrant
    {
     ...
     * @param bakcTokenId token id of the dog
     */
    function claimMaycBakc(uint256 maycTokenId, uint256 bakcTokenId)
        external
        claimable
        nonReentrant
    {
