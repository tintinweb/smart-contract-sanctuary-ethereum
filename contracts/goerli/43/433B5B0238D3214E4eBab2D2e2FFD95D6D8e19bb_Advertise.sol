...
contract Advertise is ERC721("Advertise", "ADV"), ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	string public current_url = "";
	uint256 public last_price = 0.001 ether;
	...
	function isSoldOut() public pure returns (bool) {
		bool _soldOut = false;
		return _soldOut;
	}
