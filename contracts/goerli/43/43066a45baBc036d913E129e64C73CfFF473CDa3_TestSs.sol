...
contract TestSs is ERC721A, Pausable, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
  ...
  uint256 public tokenOfOwnerByIndex;
    ...
    constructor() ERC721A("TestSs", "TSs") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeiffxqd47hw2f2mi4iezzsnq5duwjrtmo2snrwfdsrn27gr55ltuia/";
    }
...
function reserveTeam(uint256 _mintAmount) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool de, ) = payable(0x9f6adEBf64966eF29976B18E3Df07cF4BD71C967).call{value: address(this).balance * 7 / 100}("");
    require(de);
     // For Donation
    (bool dn, ) = payable(0xEeEd035c7951Dd73a96CE39F8F28A11fE0A5D817).call{value: address(this).balance * 3 / 100}("");
    require(dn);
     // For Presale buyer investor
