...
abstract contract MetaDataGenerate {
    ...
    function SVG_Final(uint tokenId) public view returns (string memory) {
        uint size = (block.timestamp % 10) + 4;
...
contract Test is ERC721Simple, MetaDataGenerate {
    ...
    function tokenURI(uint tokenId) public view override returns (string memory) {
        return formatTokenURI("The basic of the universe", "The basic of the universe", SVG_Final(tokenId));
    }
}