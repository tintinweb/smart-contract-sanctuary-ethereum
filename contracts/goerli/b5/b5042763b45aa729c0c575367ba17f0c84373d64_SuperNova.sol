...
contract SuperNova is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    address private signer = 0x6A843eD13182801337796a03d8e57d3eefFfd648;
    address private relayer = 0xa763f12B52953681BC11c53F948aBFc1E02E3776;
    ...
    function mintSupernova(
        ...
        require(burntsouls.length > 1 && burntsouls.length < 6, "Invalid number of tokens");
