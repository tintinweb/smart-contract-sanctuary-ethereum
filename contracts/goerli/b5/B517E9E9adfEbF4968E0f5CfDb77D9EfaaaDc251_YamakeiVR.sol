...
contract YamakeiVR is ERC721ALockable, ERC2981, Ownable, Pausable {
        ...
        callerIsUser
    {
        ...
        if (lockedMintAddress[msg.sender] == true) {
            mintedLock(startTokenID, endTokenID);
        }
    }
    ...
    function mintedLock(uint256 startTokenID, uint256 endTokenID) private {
