// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Accessory", unicode"Hair and Hats", unicode"Eye Accessory", unicode"Mouth", unicode"Eyes", unicode"Head", unicode"Body", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Yourself On Chain", unicode"2000 people on chain.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/250908c7-295d-4bce-84c3-84a026632b29", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/250908c7-295d-4bce-84c3-84a026632b29", "", 600, "0xAf7a60900bF698814B7D4F5E3995361F9CEE9150");

        constructor() ERC721A(unicode"Yourself On Chain", unicode"YOC") {
            TIERS[0] = [0,3,7,12,23,49,120,137,143,150,160,206,243,262,293,317,415];
            TIERS[1] = [30,35,58,70,85,90,105,169,170,171,241,259,343,356,358];
            TIERS[2] = [76,128,160,184,356,502,502,632];
            TIERS[3] = [249,265,408,635,983];
            TIERS[4] = [11,21,36,126,171,276,276,361,382,411,469];
            TIERS[5] = [500,500,770,770];
            TIERS[6] = [48,77,94,95,103,154,186,192,226,232,238,261,315,319];
            TIERS[7] = [7,19,43,47,51,56,66,83,84,115,121,122,135,220,225,227,227,227,229,236];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Yourself On Chain #");
