...
// File: contract-allow-list/contracts/proxy/interface/IContractAllowListProxy.sol
...
// File: contract-allow-list/contracts/ERC721AntiScam/restrictApprove/IERC721RestrictApprove.sol
...
// File: contract-allow-list/contracts/ERC721AntiScam/restrictApprove/ERC721RestrictApprove.sol
...
// File: contracts/CNPBaby_contract.sol
...
//tokenURI interface
interface iTokenURI {
    function tokenURI_future(
        uint256 _tokenId
    ) external view returns (string memory);
}

// ★あとで変更する
contract testCNPBabyPsi5 is
    AccessControl,
    Ownable,
    ...
    ERC721RestrictApprove
{
    ...
    address public WITHDRAW_ADDRESS =
        0x35F4A47228866399ff3A406dd11fAd80e3F74744; // ★0xdEcf4B112d4120B6998e5020a6B4819E490F7db6
    ...
    // ★名前あとで変更する
    constructor() ERC721Psi("testCNPBaby5", "TCNPB5") {
        //Role initialization
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        _grantRole(AIRDROP_ROLE, msg.sender);
        _grantRole(ADMIN, msg.sender);
        _grantRole(ADMIN, 0x85EFB8eE85195896c14929126a4d48d0F3D9bF39);
        _grantRole(AIRDROP_ROLE, 0x85EFB8eE85195896c14929126a4d48d0F3D9bF39);

        //first mint
        _safeMint(0x35F4A47228866399ff3A406dd11fAd80e3F74744, 1);
    }
    ...
    uint256 public maxMintAmountPerTransaction = 30; //１トランザクションごとのミント最大数
