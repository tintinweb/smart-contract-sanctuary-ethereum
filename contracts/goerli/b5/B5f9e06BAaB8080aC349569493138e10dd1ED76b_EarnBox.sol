...
contract EarnBox {
    ...
    event ProfitInjected(
        ...
        uint256 eth_amount_injected,
        uint256 number_of_stakers,
        uint256 drvs_pool_balance
    );
    ...
    function inject_profit() external payable{
        ...
        emit ProfitInjected(block.timestamp, msg.value*4, msg.value, stakers.length, drvs_pool_balance);
    } 
