...
contract Particular is Initializable {
    ...
    */
    receive() external payable {
        ...
        uint256 price = getLatestPrice(); // FORMATO DEL PRICE:  170882557272 
        uint256 amountOutMin = (toStable * price) / 10**18;
        uint256 amountToSave = (toSave * price) / 10**18;
        //TODO: 2 wallets -> 1 for kindly and 1 for ongs
        uint256 amountToKindly = ((toKindly + toONGs) * price) / 10**18;
