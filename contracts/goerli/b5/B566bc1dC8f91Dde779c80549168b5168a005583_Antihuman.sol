...
contract Antihuman is ERC721A, Pausable, Ownable {
    uint256 public MAXSUPPLY = 3333;
    uint256 public MAXTOKENPERMINT = 3;
    bytes32 public merkleRoot;
    uint256 public price = 0.033 ether;

    uint256 public whitelistMaxAmount = 3;
    ...
    event PublicMinted(address indexed minter, address indexed receiver, uint256 amount);
    ...
    constructor(string memory _baseuri, bytes32 _root) ERC721A("Antihuman", "AH") {
        merkleRoot = _root;
        uriPrefix = _baseuri;
    }
     ...
     * @param _merkleProof Wl merkle proof
        ...
        mintCompliance(_mintAmount)
    {
        ...
        // payattention q2, price , not check for now
    ...
    /**
     * @notice Set token locked
     */
    function setLocked(uint256 _tokenId) external onlyOwner {
        locked[_tokenId] = true;
        emit TokenLocked(_tokenId);
    }
