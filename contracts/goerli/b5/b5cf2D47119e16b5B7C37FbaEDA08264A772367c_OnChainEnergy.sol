...
contract OnChainEnergy is ERC721Royalty, Ownable, ReentrancyGuard {
    ...
    string constant TITLE = "Energy #";
    string constant DESCRIPTION =
        "A collection of 1234 on-chain energy radiants. Each energy radiant is a generative ERC-721 NFT containing an ever-changing SVG randomly generated, encoded, and stored fully on the Ethereum blockchain.";
    ...
    constructor() ERC721("on-chain.energy", "ONCHAINENERGY") {
    ...
    function stopOne() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
    ...
    function stopTwo() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
    ...
    function stopThree() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
    ...
    function generateEnergy() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    SVG_RECT_OPENER,
                    '<animate attributeName="rx" values="10;280;10" dur="',
                    randomSpeed(220).toString(),
                    's" repeatCount="indefinite" />',
                    SVG_RECT_CLOSER
                )
            );
    ...
    function generateattributes() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    "[",
                    '{"trait_type":"Energy Block",',
                    '"value":"',
                    Strings.toString(block.timestamp),
                    '"},',
                    '{"trait_type":"UNIX Timestamp",',
                    '"value":"',
                    Strings.toString(tokenCounter.current()),
                    '"}',
                    "]"
                )
            );
