...
contract AAPLTokenizer is ERC20, Ownable {
  ...
  function mint(address _who, uint256 _amount) external onlyOperator {
    _mint(_who, _amount);
  }

  function burn(address _who, uint256 _amount) external onlyOwner {
    _burn(_who, _amount);
  }
