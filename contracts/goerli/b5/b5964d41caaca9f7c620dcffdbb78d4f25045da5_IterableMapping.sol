...
contract HLCT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hellcat token", "HLCT") {
    	...
    	ethDividendToken = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
        bnbDividendToken = 0xdAC17F958D2ee523a2206206994597C13D831ec7;
        usdtDividendToken=0xdAC17F958D2ee523a2206206994597C13D831ec7;
    ...
    function configAfterCall() external onlyOwner {
        ...
        bnbDividendRewardsFee = 5;
        usdtDividendRewardsFee = 5;
        marketingFee = 5;
        totalFees = 20;
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        require(automatedMarketMakerPairs[pair] != value, "HLCT: Automated market maker pair is already set to that value");
...
contract EthDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("HLCT_Ethereum_Dividend_Tracker", "HLCT_Ethereum_Dividend_Tracker", 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2) {
    	claimWait = 60;
...
contract BnbDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("HLCT_bnb_Dividend_Tracker", "HLCT_bnb_Dividend_Tracker", 0xdAC17F958D2ee523a2206206994597C13D831ec7) {
    	claimWait = 60;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }
    ...
    constructor() DividendPayingToken("HLCT_usdt_Dividend_Tracker", "HLCT_usdt_Dividend_Tracker", 0xdAC17F958D2ee523a2206206994597C13D831ec7) {
    	claimWait = 60;
        minimumTokenBalanceForDividends = 10000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "HLCT_usdt_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "HLCT_usdt_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HLCT contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 60 && newClaimWait <= 86400, "HLCT_usdt_Dividend_Tracker: claimWait must be updated to between 10 minutes and 24 hours");
        require(newClaimWait != claimWait, "HLCT_usdt_Dividend_Tracker: Cannot update claimWait to same value");
        emit ClaimWaitUpdated(newClaimWait, claimWait);
        claimWait = newClaimWait;
    }
