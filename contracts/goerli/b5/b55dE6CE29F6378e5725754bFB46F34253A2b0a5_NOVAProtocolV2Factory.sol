...
contract NOVAProtocolV2Pair is INOVAProtocolPair, NOVAProtocolV2ERC20 {
...
contract NOVAProtocolV2ERC20 is INOVAProtocolERC20 {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'NOVAProtocol: INVALID_SIGNATURE');
