...
contract MyTokenCollection is ERC721Enumerable, Ownable {
  ...
  string public constant UNREVEALED_TOKEN_URI = string(abi.encodePacked("https://nft.ppape.io/ag/unreveal.json"));

  // PROVENANCE: Use the same hash mechanism as BAYC's.
  string public constant MINT_PROVENANCE = "2965601204d1000fb591031e3a9792593099abc17c63790754fa8f80c6c9df8f";
  string public constant CRAFT_PROVENANCE = "8757d08972c115ca2648d0b5e68dfd20d459e8706117e447cf22b41586dfcca8";
  ...
  constructor() ERC721("MyToken", "MT") {
    ...
    whitelistMintStartTime = 1667224800;
    waitingListMintStartTime = 1667232000;
    mintStartTime = 1667233800;
    craftStartTime = 1667235000;
