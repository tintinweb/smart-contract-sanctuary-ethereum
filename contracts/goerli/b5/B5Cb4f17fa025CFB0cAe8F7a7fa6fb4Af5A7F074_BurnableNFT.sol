...
contract BurnableNFT is ERC721URIStorage , ERC721Burnable , Ownable{
    ...
    */
    function nftMint() public onlyOwner {
        ...
        //https://nft.storage/files/ にフォルダでアップロードすればファイル名を指定できる
        // */metadata1.json , */metadata2.json　など・・・*の部分は_baseURI
     ...
     * @dev
     * URIプレフィックスの設定
     * ERC721.solの中でstring memory baseURI = _baseURI();となっている。
     */
    ...
    /**
     * @dev
     * オーバーライド(_burnがかぶっているので、まとめた)
     * もとのERC721.solから宣言をもってきた
     */
