    ...
    CustomErrors
{
    ...
    /**
     * @dev getUserStateMetadataHashByUserID is used to get user state metadata hash info of a user by their by userID.
     *
     * Requirement:
    ...
    /**
     * @dev getGameStateMetadataHashByUserID is used to get game state metadata hash info of a user by their by userID.
     *
     * Requirement:
     * - This function can called by anyone.
     *
    ...
    /**
     * @dev updateAllStates is used to update all states of the existing users against their userID.
     * Requirement:
     * - This function can only be called by manger role.
     *
     * @param _userID - new user's ID.
