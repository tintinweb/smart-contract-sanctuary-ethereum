...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
        require(balances[msg.sender] == 0, "Already have a state channel");
    ...
    function withdrawEarnings(Voucher calldata voucher) public {
        ...
        */
        ...
        require(balances[signer] > voucher.updatedBalance, "not enough funds");
    ...
    */
    function challengeChannel() public {
        require(balances[msg.sender] != 0, "channel is closed");
        canCloseAt[msg.sender] = block.timestamp + 30 seconds;
        emit Challenged(msg.sender);
    }

    function defundChannel() public {
        require(canCloseAt[msg.sender] != 0, "channel is still open");
        require(block.timestamp > canCloseAt[msg.sender], "channel cant close");
