...
contract TokenSwap is ERC2771Recipient {
  ...
  // function swapTokenForTokens(address[] memory path, uint256 amountIn) external updateSender {
  //   emit Gas(gasleft());

  //   IERC20 erc20_1 = IERC20(path[0]);
  //   erc20_1.transferFrom(_sender, address(this), amountIn);
  //   erc20_1.approve(address(_router), amountIn);
  ...
  //   IERC20 erc20_2 = IERC20(path[1]);
  //   uint256 amountOut = erc20_2.balanceOf(address(this));
  //   erc20_2.approve(address(_router), amountOut);

  //   //TODO: calculate gas fee
  //   uint256 gasFee = 400000;
  //   // block.
  //   // uint256 gasPrice = _router.getTokenToEthOutputPrice();

  //   _router.swapExactTokensForETHSupportingFeeOnTransferTokens(
  //       amountIn,
  //       0,
  //       path,
  //       address(this), //TODO: should go to paymaster
  //       block.timestamp
  //   );
