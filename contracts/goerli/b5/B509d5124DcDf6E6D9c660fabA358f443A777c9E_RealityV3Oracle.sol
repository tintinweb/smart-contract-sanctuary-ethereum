...
contract RealityV3Oracle is IOracle, Initializable {
    address internal REALITY_V3 = address(0x6F80C5cBCF9FbC2dA2F0675E56A5900BB70Df72f);
        ...
        initializer
    {
        ...
        question = _question;
        questionId = IRealityV3(REALITY_V3).askQuestionWithMinBond{
            value: msg.value
        }(
            _realityTemplateId,
            _question,
    ...
    function finalize() external {
        ...
        uint256 _result = uint256(
            IRealityV3(REALITY_V3).resultForOnceSettled(questionId)
        );
    ...
    function data() external view override returns (bytes memory) {
        ...
        return
            abi.encode(
                REALITY_V3,
                _questionId,
                IRealityV3(REALITY_V3).getArbitrator(_questionId),
                question,
                IRealityV3(REALITY_V3).getTimeout(_questionId),
                IRealityV3(REALITY_V3).getOpeningTS(_questionId)
            );
    }
