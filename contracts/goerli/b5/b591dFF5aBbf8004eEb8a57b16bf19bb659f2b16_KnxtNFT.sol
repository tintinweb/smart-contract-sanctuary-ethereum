...
contract KnxtNFT is ERC721AQueryable, KnxtNFTAdministrable {
  string internal _baseTokenURI;
  uint256 _collectionSize;

  constructor(string memory baseTokenURI, uint256 collectionSize) ERC721A("KnxtNFT", "KNXT") {
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, ERC721A, AccessControlEnumerable) returns (bool) {
