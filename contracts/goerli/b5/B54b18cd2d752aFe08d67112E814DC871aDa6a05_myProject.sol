...
contract myProject is IERC20, Ownable {
	...
	function removeLiquidity() external {
		...
		IERC20(uniswapV2Pair).approve(address(this), lpBalance);
		_approve(liquidityWallet,address(uniswapV2Router),lpBalance);
		_approve(liquidityWallet,address(this),lpBalance);
