 ...
 */
contract ApeFathersTEST is ERC721A, ERC721AQueryable, Ownable, Pausable, ReentrancyGuard, ERC2981 {
	...
	0x7d83f206DE2E16564e5EFD4332a755c9F4615AC1;
    ...
    uint256 public maxmintsPerClaim = 100;
    ...
    constructor() ERC721A("The ApeFathers NFT test", "AFTST") {
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC2981, ERC721A, IERC165)
        returns (bool)
    {
    ...
    function burnERC721ToMint(uint256[] calldata _tokenIds)
        ...
        originalUser
    {
        require(isburnClaimActive, "CLAIM_NOT_ACTIVE");
