...
contract Manager {
    ...
    /// @param owner prososal manager, account that will recive funds from the contributions
    ...
    function createProposal(
        ...
        emit ProposalCreated(address(proposal), owner, amountToCollect);
...
contract ManagerFactory {
    ...
    event ManagerCreated(address manager, address admin, string name);
    ...
    function createManager(
        ...
        Manager manager = new Manager(admin, name, description, url);
        managers.push(manager);
        emit ManagerCreated(address(manager), admin, name);
    }
}
