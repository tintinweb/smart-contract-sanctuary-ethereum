    ...
    OwnableUpgradeable
{
    ...
    event AirdropBlacklisted(address indexed _user, bool indexed _status);
    ...
    function blackListAddresses(
        ...
        for (uint256 i = 0; i < _addresses.length; i++) {
            ...
            emit AirdropBlacklisted(_addresses[i], true);
        }
    }
    ...
    function removeBlackListAddresses(
        ...
        for (uint256 i = 0; i < _addresses.length; i++) {
            ...
            emit AirdropBlacklisted(_addresses[i], false);
        }
    }
}
