...
contract shadowHunter is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer, Pausable  {
  ...
  function mint(uint256 tokens) public payable nonReentrant whenNotPaused {
  ...
  function setKilled(uint256 _tokenId, bytes memory  _signature) public nonReentrant whenNotPaused {
   address msgSender = _msgSenderERC721A();
    ...
    address msgSigner = signatureWallet(msgSender,_tokenId,_signature);
