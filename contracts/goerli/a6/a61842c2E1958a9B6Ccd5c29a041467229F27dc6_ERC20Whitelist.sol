...
contract ERC20Whitelist is Ownable, ReentrancyGuard {
    ...
    uint256 private immutable claimablePeriod;
    ...
    constructor(address _token) {
        ...
        claimablePeriod = block.timestamp + (365 * 24 * 60 * 60);
    }
    ...
    function _addWalletToWhitelist(address wallet, uint256 _amount) private onlyOwner {
...
library SafeERC20 {
    ...
    function _callOptionalReturn(IERC20 token, bytes memory data) private {
        ...
        bytes memory returndata = address(token).functionCall(data, "SafeERC20: low-lvl call failed");
...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        require(success, "Address: transfer failed");
    }
