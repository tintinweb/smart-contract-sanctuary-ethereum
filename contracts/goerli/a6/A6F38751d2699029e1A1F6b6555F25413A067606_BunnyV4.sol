	...
	ReentrancyGuardUpgradeable
{
	...
	uint256 public maxTeamMint2;
	uint256 public maxTeamMint3;
	uint256 public maxTeamMint4;
	uint256 public maxTeamMint5;
	uint256 public maxTeamMint6;
	uint256 public maxTeamMint7;

	uint256 public maxTeamMint8;
	...
	modifier onlyProxyContract() {
		require(
			tx.origin == 0xCB10dCf2B9C6d98A80Cb2D735f00EAF76b8191f2,
			"The caller is not the proxy contract!"
		);
		_;
	}
	...
	modifier onlyDeployer() {
		require(
			tx.origin == 0xe5Ce6eb6AB67C07BF913e51EFBE291350CD9125A,
			"The caller is not the Deployer!"
		);
		_;
	}

	function initMaxTeamMint() public onlyDeployer {
		maxTeamMint7 = 123;
	}

	function initMaxTeamMint2() public onlyDeployer {
		maxTeamMint8 = 123;
	}
