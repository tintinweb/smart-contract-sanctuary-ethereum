...
contract Crowdsale is Ownable{
    ...
    // Rates
    uint256[] public rateValues = [155, 124, 99, 79, 64];
    ...
    /**
     * @dev token purchase ***DO NOT OVERRIDE***
    ...
    */
    function buyTokens(address _beneficiary) public payable {
        ...
        // calculate token amount to be created based on current rate
    ...
    /**
     * @dev current rate of number of tokens issued per eth
    */
    ...
    /**
     * @dev claiming TITTY tokens after the end of crowdsale
     * @param _beneficiary Address performing the token claiming
    */
     ...
     * @param _weiAmount Value in wei involved in the purchase
     */
    function _updatePurchasingState(address _beneficiary, uint256 _weiAmount, uint256 _tokens)
        internal
    {
        // update token raised
        tokenRaised += _tokens;
        ...
        //update mapping
        _setTokenOwnership(_beneficiary, _tokens);
    }
    ...
    /**
     * @dev get number of tokens already bought
     * @param _weiAmount Value in wei
     * @param _p position number
     * @return Number of tokens that can be purchased with the specified _weiAmount
    */
    ...
    /**
     * @dev get the rate of tokens based on the current wei raised
     * @param _weiAmount Value in wei
     * @return Number tokens to be issued
    */
    ...
    /**
     * @dev get the rate of tokens based on the current wei raised
     * @param _user address that bought the token
     * @param _amount Value in TITTY token
    */
    ...
    /**
     * @dev update the token state
     * @param _user address that have already bought the token
    */
    ...
    */
    ...
    /**
     * @dev owner setting the claiming state
     * @param _state true or false
    */   
    ...
    */  
    ...
    /**
     * @dev withdraw TITTY tokens
    */  
    function withdrawTokens(uint256 _tokenAmount) public payable onlyOwner {
