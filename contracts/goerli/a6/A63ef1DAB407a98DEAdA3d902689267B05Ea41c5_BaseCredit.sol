    ...
    BaseLoans
{
    ...
    function unwhitelistCollateral(address _collateralAddress)
        external
        whenNotZeroCollateralAddress(_collateralAddress)
        onlyOwner
    ...
    function unwhitelistLoanCurrency(address _loanCurrencyAddress)
        external
        whenNotZeroLoanCurrencyAddress(_loanCurrencyAddress)
        onlyOwner
    ...
    function requestOffer(OfferTerm calldata _offer)
        external
