...
contract AIProduct is ERC721, ERC721Enumerable, Ownable {
    ...
    // sent all eth from contract to msg.sender, that is the creator address of contract.
