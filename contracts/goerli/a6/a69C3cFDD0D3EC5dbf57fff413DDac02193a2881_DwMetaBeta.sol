...
contract DwMetaBeta is ERC721, ERC721Burnable, Ownable {
    ...
    string baseURI = "ipfs://QmdcvQnSGT6yoQnL5WQapyNszgSJqG2vrW8H4rkMrtBgTK/";
    ...
    function send721ToL2(uint256 l2ContractAddress, uint256 l2UserAddress, uint256 tokenId) external {
        ...
        // Prepare the payload
        uint256[] memory registerPayload = new uint256[](6);
    ...
    function retrieve721(uint256 l2ContractAddress, uint256 tokenId, uint256 lucky) external {
        uint256[] memory rcvPayload = new uint256[](6);
        ...
        rcvPayload[5] = lucky / (2**128);                // token_id_high
