    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public goldenTouchPrice = 0.001 ether;
    ...
    uint256 public lovelistFreeLimit = 2;
    uint256 public lovelistSupply = 5000;
    uint256 public lovelistLimit = 5;
    uint256 public lovelistMintPrice = 0.005 ether;
    ...
    bool public allowedFreePublic = true;
    ...
    function publicMint(
        ...
        if (
            _totalMinted() + quantity_ > (maxSupply - lovelistSupply - reserved)
        ) revert SoldOut();
