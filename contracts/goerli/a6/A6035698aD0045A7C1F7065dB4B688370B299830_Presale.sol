...
contract Presale is Ownable{
    ...
    constructor(address owner, address payment) {
	   ...
	   tokenAmount = [
	      4_970_976_000_000  * 10**18, 
		  8_388_522_000_000  * 10**18, 
		  10_252_638_000_000 * 10**18, 
		  14_912_928_000_000 * 10**18, 
		  17_398_416_000_000 * 10**18, 
		  20_815_962_000_000 * 10**18, 
		  36_660_948_000_000 * 10**18, 
		  42_874_668_000_000 * 10**18, 
		  25_165_566_000_000 * 10**18, 
		  17_709_102_000_000 * 10**18, 
		  18_641_160_000_000 * 10**18, 
		  20_815_962_000_000 * 10**18, 
		  11_806_068_000_000 * 10**18, 
		  15_844_986_000_000 * 10**18, 
		  9_631_266_000_000  * 10**18, 
		  13_670_184_000_000 * 10**18, 
		  8_699_208_000_000  * 10**18, 
		  12_427_440_000_000 * 10**18
	   ];
	   remainingAmount = [
	      4_970_976_000_000  * 10**18, 
		  8_388_522_000_000  * 10**18, 
	...
	function buyWithUSDT(uint256 amount, string memory rcode, string memory myrcode, uint256 avatar) external {
	   ...
	   {
	      amount = availableToken * 10**6 / price;
	   ...
	   else
	   {
          ...
          if(remainingAmount[currentRound] == 0)
		  {
		     currentRound += 1;
		  }	
		  mapBuyTokenInfo[address(msg.sender)].usdPaid += amount;
	...
	function updateClaimStatus(bool status) external onlyOwner{
        require(claimStatus != status, "Presale is already set to that value");
		require(!refundStatus, "Sale already cancel");
		if(status)
		{
	...
	function cancelSale() external onlyOwner {
	   ...
	   preSaleStatus = false;
	   refundStatus = true;
	   IERC20(USDT).safeTransferFrom(address(msg.sender), address(this), usdRaised);
    }
}
