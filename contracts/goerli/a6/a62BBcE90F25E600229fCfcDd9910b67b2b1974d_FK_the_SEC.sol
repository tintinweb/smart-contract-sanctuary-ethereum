...
contract FK_the_SEC is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public PUBLIC_SUPPLY = 700;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmXZrBLpo5j8YaDLBnd14orcGQVwygNfQyUVYQaipPZdZ8";
    ...
    constructor() ERC721A("FK_the_SEC", "FTS") {
        ...
        _safeMint(0x26e342f9468BE77B993dAb0F523C901964670D35, 77);
    }
