...
contract ERC721Soulbound is Soulbound, IERC165, IERC721CreatorExtensionApproveTransfer {
    ...
    /**
     * @dev Set whether or not the Creator Contract will use this extension to determine token transfer approval. Enabled by default on extension registration.
     */
    ...
    /**
     * @dev Can be called by the Creator Contract to approve a transfer
     */
    ...
    /**
     * @dev Returns true only for transfer to and from the zero address (minting and burning)
     */
...
abstract contract Soulbound {
    ...
    // Mapping of the index that an address is in the soulboundOwners array
    mapping(address => uint256) internal soulboundOwnerIndex;
