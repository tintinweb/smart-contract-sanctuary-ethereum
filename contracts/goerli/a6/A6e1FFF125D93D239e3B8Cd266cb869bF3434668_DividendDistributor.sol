...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RewardToken = IERC20(0x73967c6a0904aA032C103b4104747E88c566B1A2); // <--- ADD REWARD ERC20 TOKEN // Set to: DAI - Goerli
    IDEXRouter router;
...
contract RewardTokenERC is IERC20, Ownable {
    using SafeMath for uint256;
 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
 
    string constant _name = "RewardTokenERC";
    string constant _symbol = "RewardTokenERC";
    uint8 constant _decimals = 9;
 
    uint256 _totalSupply = 1_000_000 * (10 ** _decimals); // Is 1,000,000 Tokens
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // Set to 1%
    uint256 public _maxWalletSize = (_totalSupply * 2) / 100; // Set to 2%
    ...
    address private marketingFeeReceiver = msg.sender; // <---  ADD WALLET if not Deployer
    ...
    uint256 distributorGas = 500000; // Increase if Network is overloaded
    ...
    constructor () Ownable(msg.sender) {
        router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Set for Uniswap V2
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalETHFee = (totalBuyFee + totalSellFee).sub((liquidityFee).div(2));
