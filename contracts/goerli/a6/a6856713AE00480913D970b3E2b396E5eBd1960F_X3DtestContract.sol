...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xeEDC5178BeCfC7A3dcAd28F15D048518eaFCC325];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xeEDC5178BeCfC7A3dcAd28F15D048518eaFCC325;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://pinnieblog.mypinata.cloud/ipfs/QmWmcX9ikvNTJtCmuX9oWiUvTABQZ6tC6UARqa7ozBh2Ry?filename=Pinnie.glb/";
...
// File: contracts/X3DtestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X3DtestContract is RamppERC721A {
    constructor() RamppERC721A("3d test ", "3d test "){}
}
