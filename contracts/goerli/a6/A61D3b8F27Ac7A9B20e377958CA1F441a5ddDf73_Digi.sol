...
contract Digi is ERC1155Supply, Ownable{
    ...
    */
    ...
    function editPeriod(
        ...
        uint expiry,
        bytes32 merkleRoot
    ) external onlyOwner validatePeriodId(periodId) {
        Periods[periodId] = Period(
            periodId,
            cost,
            supply,
    ...
    function editSupply(
        uint periodId,
        uint supply
    ) external onlyOwner validatePeriodId(periodId) validateSupply(periodId, supply) {
