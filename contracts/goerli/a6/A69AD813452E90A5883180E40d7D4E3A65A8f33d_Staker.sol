...
contract Staker {
  ...
  function stake() public payable NotYetCompleted {
    require(deadline >= block.timestamp, 'TOO LATE TO STAKE!!!');
  ...
  function execute() public NotYetCompleted {
    require(deadline <= block.timestamp, 'NOT YET READY!!!');
  ...
  function withdraw() public NotYetCompleted {
