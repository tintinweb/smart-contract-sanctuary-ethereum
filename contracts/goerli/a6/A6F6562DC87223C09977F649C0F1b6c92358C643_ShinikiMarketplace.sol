...
contract ShinikiMarketplace is ShinikiMarketplaceCore, TransferManager {
    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    function matchAndTransfer(
        ...
        } else if (msg.sender == orderRight.maker) {
            emit Match(
                msg.sender,
                orderLeft.salt,
    ...
    */
    ...
    function withdraw(uint256 amount) external onlyOwner {
        address(msg.sender).transferEth(amount);
    }

    uint256[48] private __gap;
    address private TRUSTED_PARTY;
}
    ...
    ITransferExecutor
{
    ...
    function transfer(
        ...
        if (asset.assetType.assetClass == LibAsset.ETH_ASSET_CLASS) {
            ...
            IERC20Upgradeable(token).transferFrom(from, to, asset.value);
