...
///////////////////////////////////  Getters  ////////////////////////////////////////////////////////
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) internal pure returns (uint256) {
        uint256 numMintedSoFar = 10;
        uint256 tokenIdsIdx;
...
abstract contract Whitelistable is WhitelistableI, Ownable {
    ...
    function invalidateHashes(bytes32[] memory _hashes)
        external
        override
        onlyAdmin
    {
    ...
    function checkWhitelisted(bytes32 _rawHash, bytes memory _sig)
        public
        view
        returns (bool)
    {
