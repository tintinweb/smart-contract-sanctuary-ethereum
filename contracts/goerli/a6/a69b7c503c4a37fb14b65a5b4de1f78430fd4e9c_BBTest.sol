...
contract BBTest is ERC721, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    // price
    uint256 public constant PRICE_PRESALE = 0.00018 ether;
    uint256 public constant PRICE_MAINSALE = 0.00025 ether;
    ...
    constructor()
        ERC721("BBTest", "BBT")
    {
        MintPass = ERC1155Burnable(0x0bF2002cFaB13370949962985c984c94cD5D5C17);
        MintPassTokenId = 1;
    }
