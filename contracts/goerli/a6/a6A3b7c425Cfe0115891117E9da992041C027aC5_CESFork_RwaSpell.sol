...
contract SpellAction_1 {
    ...
    address constant MCD_JOIN_TEST1_RWA001_A = 0x2093ea40eCB44DC6813f49507537C4F48D1Be10f;
    ...
    function execute() external {
        ...
        bytes32 ilk = "TEST1-RWA001-A";

        // Add RWA007SGHWOFH1 contract to the changelog
        CHANGELOG.setAddress("RWA007", RWA007);
        CHANGELOG.setAddress("MCD_JOIN_TEST1_RWA001_A", MCD_JOIN_TEST1_RWA001_A);
        ...
        // Sanity checks
        require(GemJoinAbstract(MCD_JOIN_TEST1_RWA001_A).vat() == MCD_VAT, "join-vat-not-match");
        require(GemJoinAbstract(MCD_JOIN_TEST1_RWA001_A).ilk() == ilk, "join-ilk-not-match");
        require(GemJoinAbstract(MCD_JOIN_TEST1_RWA001_A).gem() == RWA007, "join-gem-not-match");
        require(GemJoinAbstract(MCD_JOIN_TEST1_RWA001_A).dec() == DSTokenAbstract(RWA007).decimals(), "join-dec-not-match");
        ...
        VatAbstract(MCD_VAT).rely(MCD_JOIN_TEST1_RWA001_A);
        ...
        GemJoinAbstract(MCD_JOIN_TEST1_RWA001_A).rely(RWA007_A_URN);
