...
contract NFTNAME is ERC721A, ERC721AQueryable, Ownable, PaymentSplitter {
    ...
    Step public step;
    uint256 public saleStartTime = 1672653726;
    bytes32 public merkleRoot;
    string public baseURI;

    constructor(bytes32 _merkleRoot, string memory _baseURI)
        ERC721A("NFT Alyra", "NFT Aly")
        ...
        whenNotPaused
    {
        ...
        require(
            ...
            "Max supply exceeded"
        ); // FIXME: error with this constant I think
