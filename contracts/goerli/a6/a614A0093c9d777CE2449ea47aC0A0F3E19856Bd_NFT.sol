...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("jjq1111", "SYMBOL") {
        baseUri = "ipfs://111111/";
    ...
    function mintFree(uint256 _numTokens) external payable {
        ...
        require(mintedPerWalletFree[msg.sender] + mintedPerWalletCost[msg.sender] + _numTokens <= freeSupplyWallet, "You cannot mint that many total.");
        uint256 curTotalSupply = totalSupply;
        require(curTotalSupply + _numTokens <= freeSupplyWallet, "Exceeds total supply.");
