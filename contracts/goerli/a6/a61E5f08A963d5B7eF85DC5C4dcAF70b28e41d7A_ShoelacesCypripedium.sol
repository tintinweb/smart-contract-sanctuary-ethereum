...
/**
 * @title ShoelacesCypripedium
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract ShoelacesCypripedium is ERC20Burnable, ERC20Capped, Pausable {
    address private _owner;

    constructor() ERC20("Shoelaces Cypripedium","SDI") ERC20Capped(1000000000 * (10**uint256(decimals())))  { 
        _owner = _msgSender();
     }
