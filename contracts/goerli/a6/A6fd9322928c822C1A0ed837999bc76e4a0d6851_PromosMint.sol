...
interface IPromos {
    function mintPromos(address _to, uint256 _amount) external payable returns (bool);
...
contract PromosMint is Ownable {
        ...
        payable
    {
        ...
        bool _minted = IPromos(mintRequest.collectionAddress).mintPromos(
            msg.sender,
            mintRequest.amount
        );
        require(_minted, "Mint went wrong");
