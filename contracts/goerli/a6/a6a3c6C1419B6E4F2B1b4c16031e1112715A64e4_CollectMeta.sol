...
contract CollectMeta is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public costOne = 0.06 ether;
    uint256 public costTwo = 0.07 ether;
    uint256 public costThree = 0.08 ether;
    ...
    constructor() ERC721A("Collect Meta", "COLLECTMETA") {
        setBaseURI("http://api.collectmeta.com/api/");
    }
