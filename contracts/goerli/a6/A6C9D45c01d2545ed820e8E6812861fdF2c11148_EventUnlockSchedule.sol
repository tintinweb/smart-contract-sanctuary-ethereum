...
contract EventUnlockSchedule is BaseGovernanceWithUserUpgradable, KeeperCompatibleInterface {
    ...
    //////////TESTING ONLY///////////
    int public feedPrice;
    int public triggerCount;
    //////////TESTING ONLY///////////
    ...
    function checkUpkeep(bytes calldata checkData) external view override returns (bool upkeepNeeded, bytes memory performData) {
        ...
        if(block.timestamp < lockStart()){
            ...
            upkeepNeeded = false;
            performData = abi.encode(offsetPrices.length,lockAddress,upkeepConsumer);
        }else{
    ...
    function _removeEventSchedule(uint _idx) internal {
        ...
        for(uint i = _idx; i < offsetPrices.length-1; i++){
