...
contract Degen is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xf680143F40F902C2e474D523c1aA2273e20AeD8F);
    address payable private _marketingAddress = payable(0x3FD5337B138899BA935493DD6D0ecBF0823Ec035);
    ...
    uint256 public _maxWalletSize = 29027610000 * 10 ** _decimals;
