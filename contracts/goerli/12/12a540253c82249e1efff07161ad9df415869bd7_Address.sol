...
// File: contracts/n00xMint_v1.sol
...
contract n00xMint_v1 is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 15;
    ...
    constructor() ERC721("n00x", "n0x") {
        baseUri = "ipfs://QmRQAKoxdsdvycfNqd4pLV8LT1dbVwyCk25u95WYguJmYX/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x77b7d63Cbbcac5db08B0C338E6087B3E8D9E80CE).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x77b7d63Cbbcac5db08B0C338E6087B3E8D9E80CE).call{value: balanceTwo}("");
