...
- Your minted Check Turtz NFT will recieve a Colors trait based on the number of Tiny Winged Turtlez and/or Checks NFTs you hold
...
- For example, if your Check Turtz NFT has a Colors trait value of 5, its artwork will have 5 pseudo-randomly colored and positioned elements
- The color palette is inspired by the original Checks piece designed by @jackbutcher
- Traits and artwork are assigned at mint time and will NOT change thereafter
...
contract CheckTurtz is ERC721, Ownable, CheckTurtzDelegateBalance {
    ...
    error BurnerNotApprovedOrOwner();
    ...
    function getFrame() internal pure returns (string memory) {
        return
    ...
    function getDefaultTurt() internal pure returns (string memory) {
        return
            "<path d='M35.093 0.897949H0.893005V57.8979H35.093L35.093 46.498H46.493V12.298H35.093L35.093 0.897949ZM35.093 35.098H12.293V12.298H35.093V35.098Z' fill='#65bc48' /><path d='M35.1 23.7H23.7V35.1H35.1V23.7Z' fill='#000000' />";
    }
    ...
    function getCheckTurt(
        ...
        return
            string(
                abi.encodePacked(
                    "<path d='M35.093 0.897949H0.893005V57.8979H35.093L35.093 46.498H46.493V12.298H35.093L35.093 0.897949ZM35.093 35.098H12.293V12.298H35.093V35.098Z' fill='",
                    colorpalette[colorpaletteIndex],
                    "' /><path d='M35.1 23.7H23.7V35.1H35.1V23.7Z' fill='#000000' />"
                )
            );
    }
    ...
    function shufflePositions(
        uint256 tokenId
    ) private view returns (uint8[80] memory) {
    ...
    function getTokenIdSvg(
        ...
        return
            string(
                abi.encodePacked(
                    "<svg id='checkturt' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 2000 2000'>",
                    getFrame(),
                    getTurtGrid(tokenId),
                    "<style>#checkturt{shape-rendering:crispedges;}</style></svg>"
                )
            );
    }
    ...
    function burn(uint256 tokenId) public {
        if (!_isApprovedOrOwner(msg.sender, tokenId)) {
            revert BurnerNotApprovedOrOwner();
        }
