...
//     .----------------.  .----------------.  .----------------.  .-----------------. .----------------.  .----------------.     //
//    | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |    //
//    | |   _____      | || |      __      | || | _____  _____ | || | ____  _____  | || |     ______   | || |  ____  ____  | |    //
//    | |  |_   _|     | || |     /  \     | || ||_   _||_   _|| || ||_   \|_   _| | || |   .' ___  |  | || | |_   ||   _| | |    //
//    | |    | |       | || |    / /\ \    | || |  | |    | |  | || |  |   \ | |   | || |  / .'   \_|  | || |   | |__| |   | |    //
//    | |    | |   _   | || |   / ____ \   | || |  | '    ' |  | || |  | |\ \| |   | || |  | |         | || |   |  __  |   | |    //
//    | |   _| |__/ |  | || | _/ /    \ \_ | || |   \ `--' /   | || | _| |_\   |_  | || |  \ `.___.'\  | || |  _| |  | |_  | |    //
//    | |  |________|  | || ||____|  |____|| || |    `.__.'    | || ||_____|\____| | || |   `._____.'  | || | |____||____| | |    //
//    | |              | || |              | || |              | || |              | || |              | || |              | |    //
//    | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |    //
//     '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'     //
//     .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.     //
//    | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |    //
//    | |   _____      | || |     _____    | || |   ________   | || |      __      | || |  _______     | || |  ________    | |    //
//    | |  |_   _|     | || |    |_   _|   | || |  |  __   _|  | || |     /  \     | || | |_   __ \    | || | |_   ___ `.  | |    //
//    | |    | |       | || |      | |     | || |  |_/  / /    | || |    / /\ \    | || |   | |__) |   | || |   | |   `. \ | |    //
//    | |    | |   _   | || |      | |     | || |     .'.' _   | || |   / ____ \   | || |   |  __ /    | || |   | |    | | | |    //
//    | |   _| |__/ |  | || |     _| |_    | || |   _/ /__/ |  | || | _/ /    \ \_ | || |  _| |  \ \_  | || |  _| |___.' / | |    //
//    | |  |________|  | || |    |_____|   | || |  |________|  | || ||____|  |____|| || | |____| |___| | || | |________.'  | |    //
//    | |              | || |              | || |              | || |              | || |              | || |              | |    //
//    | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |    //
//     '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'     //
//                                                                                                                                //
...
contract LLMK is ERC721Creator {
    constructor() ERC721Creator("Launch Lizard MK", "LLMK") {}
}
