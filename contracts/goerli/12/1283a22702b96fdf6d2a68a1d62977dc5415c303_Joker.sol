...
contract Joker is ERC721, Ownable {
    ...
    function publicMint(uint256 amount) external payable {
        ...
        unchecked { // unchecked because the math itself isn't able to overflow
            for (uint256 ii = 0; ii < amount; ii++) {
                ownerOf[currentId + ii] = msg.sender; // in the case of amount == 10, currentId + 0 all the way to currentId + 9
    ...
    // function whitelistMint(address amount, bytes32[] calldata _merkleProof ) external payable {
