...
contract AwesomeCuteTarsiers is ERC721, ERC721URIStorage, Ownable {
    ...
    string constant personalURI =
        "ipfs://bafybeiauffks3fdntisymyne6a4jsqhmzhd2rbd4ejeoh2wv2m23enchiu/personal/";
    string constant companyURI =
        "ipfs://bafybeiauffks3fdntisymyne6a4jsqhmzhd2rbd4ejeoh2wv2m23enchiu/company/";
    ...
    constructor() ERC721("Awesome Cute Tarsiers", "ACT") {
        counter = 43;
    }
    ...
    function safeMint() external payable {
        ...
        if (counter >= 43 && counter <= 721) {
            if (counter <= 150) {
                require(msg.value >= 1.05 ether);
                personalMint();
            } else if (counter <= 400) {
                ...
                require(msg.value >= 1.15 ether);
                personalMint();
            }
        } else if (counter >= 722 && counter <= 1000) {
            if (counter <= 822) {
                require(msg.value >= 1.22 ether);
                companyMint();
            } else if (counter <= 900) {
                require(msg.value >= 1.25 ether);
                companyMint();
            } else if (counter <= 1000) {
                require(msg.value >= 1.29 ether);
                companyMint();
            }
        }
    }
    ...
    function getNFTIdentity(uint256 _id)
        public
        view
        returns (string memory, uint256)
    {
        if (_id >= 43 && _id <= 721) {
            return ("Personal NFT", 0);
        } else if (_id >= 722 && _id <= 1000) {
            return ("Company NFT", 1);
        }
    }
}
