...
contract elOtro is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(uint256 collectionSize_) ERC721A("elOtro", "EO") {
        MAX_SUPPLY = collectionSize_;
    }

    //Establece metadata para opensea (fees, imagen predeterminada de la colleccion)
