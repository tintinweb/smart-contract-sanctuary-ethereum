...
import {ZapLib} from "../../VaultsV3/library/ZapLib.sol";

contract JonesZapMock {
    function ZapIn(
        address _fromToken,
    ...
    function ZapOut(
        ...
        return ZapLib.ZapOut(_pair, _tokenOut, _amount, _minOut);
    }
    ...
    function quoteZapOut(
        ...
        return ZapLib.quoteZapOut(_pair, _tokenOut, _amount);
    }
}
