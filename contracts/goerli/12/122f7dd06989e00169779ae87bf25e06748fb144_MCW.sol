...
contract MCW is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MANA CLINIC";
    ...
    address payable public liquidityFeeReceiver = payable(0xE3Ffc8C7eAECE0C9e8a8EAb8df4A52dc08E3b294);
    address payable public marketingFeeReceiver = payable(0xE3Ffc8C7eAECE0C9e8a8EAb8df4A52dc08E3b294);
