...
contract ERC721Staking is Ownable, ReentrancyGuard {
    ...
    uint256 private rewardsPerHour = 380000000000000000000;
    ...
    function userStakedTokenIds(address _user)
        public
        view
        returns (uint256[] memory)
    {
        return (stakers[_user].tokenIdsStaked);
    }

    function userStakeInfo(address _user)
        public
        view
        returns (uint256 _tokensStaked, uint256 _availableRewards, uint256 _claimedRewards)
    {
        return (stakers[_user].amountStaked, availableRewards(_user), stakers[_user].claimedRewards);
    }
