...
//
//         __    _                             __           ____                          _                               _ _ 
//   _____/ /_  (_)___  ____ ___  __  ______  / /_______   / __/________  ____ ___       (_)_  ______ ___  ____ _____    (_|_)
//  / ___/ __ \/ / __ \/ __ `__ \/ / / / __ \/ //_/ ___/  / /_/ ___/ __ \/ __ `__ \     / / / / / __ `__ \/ __ `/ __ \  / / / 
// / /__/ / / / / /_/ / / / / / / /_/ / / / / ,< (__  )  / __/ /  / /_/ / / / / / /    / / /_/ / / / / / / /_/ / / / / / / /  
// \___/_/ /_/_/ .___/_/ /_/ /_/\__,_/_/ /_/_/|_/____/  /_/ /_/   \____/_/ /_/ /_/  __/ /\__,_/_/ /_/ /_/\__,_/_/ /_/_/ /_/   
//            /_/                                                                  /___/                           /___/      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7779097DA3d58752053929a3a0D79D6E8C2acD77];
  address public erc20Payable = 0x7779097DA3d58752053929a3a0D79D6E8C2acD77;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 50, 481) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQh3x1t84iVRDbR8NT1wZHhxYYZjGuDjjEkHjTQ1sNQ3d/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/uRyS6jn8a2XMKpbfDtJA/contract-metadata";
  }
...
// File: contracts/ChipmunksfromjumanjiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ChipmunksfromjumanjiContract is RamppERC721A {
    constructor() RamppERC721A("chipmunks from jumanji", "chipmunks"){}
}
