...
contract Testing7 is ERC20, Ownable {
    ...
    constructor() ERC20("Testing7", "TST7") {
        ...
        maxTransactionAmount = totalSupply * 3 / 100; // 3% transaction threshold

        swapTokensAtAmount = totalSupply * 3 / 100; // 3% swap threshold
