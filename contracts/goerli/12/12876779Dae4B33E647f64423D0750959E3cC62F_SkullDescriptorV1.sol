...
contract SkullDescriptorV1 is ISkullDescriptor {
    ...
    function tokenURI(uint256 tokenId, uint256 seed) external pure override returns (string memory) {
        Trait memory headwear = getHeadwear(seed / 100000000000000);
        Trait memory eyes = getEyes(seed % 1000000000000 / 10000000000);
        Trait memory body = getBody(seed % 100000000 / 1000000);
