...
contract MonoWallet is Verify {
    ...
    event Deposit(uint256 indexed _userId, uint256 _amount, address _tokenAddress);
    event Withdraw(uint256 indexed _userId, uint256 _amount, address _tokenAddress, address _receiver);
    event AdminClaimToken(address indexed _caller, uint256 _amount, address _tokenAddress);
    event SendTokenToJackpotContract(address indexed _caller, uint256 _amount, address _tokenAddress);
    ...
    function updateJackpotAddress(address _jackotAddress) external onlyAdmin onlyOperator{
