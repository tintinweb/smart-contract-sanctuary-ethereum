...
contract Learnwith is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Variables Start =======================
  ...
  uint256 public maxMintAmountPerTxPhase1 = 10; //decide how many NFT's you want to mint with cost1
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("learnwithl", "LEARNWITHL")  { //change this line to your full and short NFT name
    seturi(_uri);
