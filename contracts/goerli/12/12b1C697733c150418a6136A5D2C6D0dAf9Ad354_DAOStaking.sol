...
contract DAOStaking is IDAOStaking, Initializable, AccessControlUpgradeable {
    ...
    function deposit(uint256 amount) public {
        ...
        if (address(rewards) != address(0)) {
            rewards.registerUserAction(msg.sender);
        }
    ...
    function changeRewardsAddress(address _rewards) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "DAOStaking: only owner can change rewards address");
