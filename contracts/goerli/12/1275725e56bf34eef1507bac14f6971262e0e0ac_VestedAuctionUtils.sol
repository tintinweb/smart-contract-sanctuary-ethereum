...
contract VestedAuctionUtils {
    ...
    bool public eligibilityKeyValid;
    ...
    function reset() external {
        eligibilityKeyValid = false;
    }

    function claimPack(uint256 packId, uint256[] memory cardIds, bytes memory eligibilityKey) external {
        bytes32 validationString = keccak256(abi.encodePacked(packId, "-", msg.sender));
        ...
        eligibilityKeyValid = validateSignature(validationString, eligibilityKey, keyValidatorAddress);
