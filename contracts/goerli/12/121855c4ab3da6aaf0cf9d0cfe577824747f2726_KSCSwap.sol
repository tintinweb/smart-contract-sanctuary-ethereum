...
contract KSCSwap is Ownable {
    ...
    constructor() Ownable(msg.sender) {
        token = IERC20(0x20c125B69aaa61704A2CF7c999aA2235432B95b3);
        ...
        usdt = IERC20(0x53A60129620826bda30b4385689e6aD90C2bA565);
        tokenPerUsd = 3;
    ...
    function modifyPriceFeed(address _address) public onlyOwner {
        priceFeed = AggregatorV3Interface(
            _address
        );
    }

    function modifyPriceFeedBNBUSD(address _address) public onlyOwner {
        priceFeedBNBUSD = AggregatorV3Interface(
            _address
        );
    }
