...
contract TrashPile is TrashBase, EIP712Whitelisting {
    ...
    uint8[8] private ntraits = [7, 6, 5, 8, 7, 8, 5, 7];

    uint256 public constant maxMinted = 8995; // Max supply is 10000, 9996 are sold at mint, three at a time 
    uint256 public constant maxLegendaries = 4; // 4 unique legendaries airdropped to random holders after mint

    uint256 public presaleStartTime;
    uint256 public presaleEndTime;
    uint256 public constant maxPresale = 1000;
    ...
    function mint() public payable {
        require(msg.sender == tx.origin, "Contract mint not allowed");
        // Number of NFTs minted until now must be less than 9999 in order to not drive the NFTs above 9999
        // Last batch will be with _minted at 9996, it will mint 3 NFTs driving the total to 9999
