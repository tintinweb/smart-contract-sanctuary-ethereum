...
contract TPCore is AccessControl {
    ...
    //uint48 public tpyRewardPerInterval = 23972603 * 7 * 4 * (10**6); // 239726.03
    //uint48 public tpyRewardPerInterval = 25_000 * (10 ** 8);// todo test
    
    // 32 (max 1 year)
    //uint32 public tpyInterval = 4 weeks; 
    uint32 public tpyInterval = 15 * 60 seconds;//todo test
    ...
    function unstake(uint104 amount) external {
        ...
        // recalculation 
        uint104 stakingAmountPart = amount * userStaking[_msgSender()].amount / estimatedRewards;
