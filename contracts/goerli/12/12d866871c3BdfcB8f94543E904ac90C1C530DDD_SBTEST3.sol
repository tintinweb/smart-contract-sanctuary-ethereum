...
contract SBTEST3 is Ownable, ERC721A, PaymentSplitter {
    ...
    // A new functionality in the NFT space, by GenerativeNFTs.io (GN). :-)
    
    function GN_affiliateAdd(address _addr, string memory affiliateRef, uint fee) external onlyOwner { 
        ...
        require(GN_affiliateValidateName(affiliateRef), "Error: Affiliate Reference code used doesn't pass validations.");
    ...
    function GN_affiliateDisable(string memory affiliateRef) external onlyOwner {
    ...
    function GN_affiliateEnable(string memory affiliateRef) external onlyOwner { 
       	require(affiliateAccounts[affiliateRef].affiliateFee > 0 , "Error: Affiliate reference likely wrong.");
        affiliateAccounts[affiliateRef].affiliateIsActive = true;
    }

    function GN_affiliateValidateName(string memory str) public pure returns (bool){
        ...
        for( uint i; i < b.length; i++ ){
            ...
            //   But if you want UC as well, add:
