...
contract Artisan_NFT is Ownable, ERC721Enumerable {
    ...
    constructor(
        ...
        fee = fee_;
        whitelistAddresses(whitelistAdds);
    }
    ...
    function mintArtisan_NFT(uint256 quantityToMint) external payable returns(uint256[] memory) {
