...
abstract contract Governor {
     ...
     * @param creationBlock Voting creation block
        ...
        returns (ProposalState)
    {
        ...
        if ( block.number < proposal.vote.startBlock ) 
                return ProposalState.AwaitingStart;
    ...
    function _castVote(uint256 proposalId, bool support) internal {
        ...
        uint256 votes = _getPastVotes(
            msg.sender,
            proposals[proposalId].vote.creationBlock - 1
        );
