...
contract ERC721Core is ERC721Enumerable, AccessControl, Ownable {
    ...
    string public URI = "https://nft-content.herokuapp.com/api/ethumans/metadata/";
    ...
    function setBaseURI(string memory baseURI) public isAdminOperator {
        URI = baseURI;
    }
    ...
    function updateTokenURI(string memory _URI) external isAdminOperator {
        URI = _URI;
    }
