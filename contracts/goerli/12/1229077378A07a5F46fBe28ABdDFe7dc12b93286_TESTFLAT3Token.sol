...
// File: contracts/TESTFLAT3Token.sol

// 
pragma solidity ^0.8.5;

/**
 * @title TESTFLAT3Token
 ...
 */
contract TESTFLAT3Token is ERC777 {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC777("TESTFLAT3", "FLTT3", new address[](0)) {
        _mint(msg.sender, 554672 * 10 ** 18, "", "");
    }
}
