...
abstract contract KeyEnum {
    ...
    uint256 constant internal KEY_REGISTRAR = 2;
    uint256 constant internal KEY_RESOLVER = 3;

    uint256 constant internal KEY_NFT_METADATA = 4;
    uint256 constant internal KEY_NFT_METADATA_URI = 5;
    uint256 constant internal KEY_NFT_OBJECT = 6; // NFT Image, Audio, Video...
    uint256 constant internal KEY_NFT_OBJECT_URI = 7;
    uint256 constant internal KEY_ALIAS = 8;
...
contract Ledger is Meta {
    ...
    function withdraw(bytes32 node, uint256 amount, bytes memory signature) external {
        ...
        (address signer, bytes32 hash, uint64 date) = verify_signature(node, amount, signature);
