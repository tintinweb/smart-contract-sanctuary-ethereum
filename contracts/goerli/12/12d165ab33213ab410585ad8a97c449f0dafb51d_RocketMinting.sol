...
contract RocketMinting is AuctionBase {
    ...
    constructor (string memory _baseUri, address _elononeAddress) {
        _setBaseURI(_baseUri);
        elonone = _elononeAddress;
    }

    IERC20 _elonone = IERC20(elonone);

    function mintElononeRocket() external {
        require(_elonone.balanceOf(msg.sender) >= elononeRequirement, "Buy more #ELONONE ;)");
        promoCreatedCount++;
