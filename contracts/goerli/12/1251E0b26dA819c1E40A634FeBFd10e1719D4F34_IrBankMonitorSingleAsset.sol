...
contract IrBankMonitorSingleAsset {
   ...
   */
        address stakeRewardsHelper;
        stakeRewardsHelper = IrBankStrategyInterface(irBankStrategy).pool();
   ...
   */   address stakeRewardsHelper;
    ...
    function getAllParams(address _underlying) external view returns (address, address, address, address, uint256, uint256) {
        ...
        return (_stakeRewardsHelper, _factory, _pToken, _stakeReward, _decimals, _baseUnit);
    ...
    function getPool() external view returns (address) {
        ...
        _stakeRewardsHelper = IrBankStrategyInterface(irBankStrategy).pool();
        return _stakeRewardsHelper;

    }

    function _getPoolInternal() internal view returns (address) {
    ...
    function getFactory() external view returns (address)  {
        ...
        _stakeRewardsHelper = _getPoolInternal();
    ...
    function getPtoken(address _underlying) external view returns (address)  {
        address _pToken;
        address _factory;

        _factory = _getFactoryInternal();
    ...
    function _getPtokenInternal(address _underlying) internal view returns (address)  {
        address _pToken;
        address _factory;
    ...
    function getStakeReward(address _underlying) external view returns (address)  {
        address _pToken;
        address _factory;
        address _stakeReward;
        ...
        _pToken = _getPtokenInternal(_underlying);


        _stakeReward = StakingRewardsFactoryInterface(_factory).getStakingRewards(
            _pToken
        );
        return _stakeReward;
    ...
    function getBaseUint(address _underlying) external view returns (uint256)  {
        uint256 _baseUint;
        uint256 _decimals;
        _decimals = IERC20(_underlying).decimals();
        _baseUint =  10**_decimals;
        return _baseUint;
