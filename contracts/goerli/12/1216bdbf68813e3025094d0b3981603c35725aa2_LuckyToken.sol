...
contract ERC20 is Context {
    ...
    string private _name = "LuckyCoin342844";
    string private _symbol = "LC342844";
    ...
    function name() public view virtual returns (string memory) {
        //return token name set in the constructor
        return _name;
    }
    ...
    function symbol() public view virtual returns (string memory) {
        //return token symbol set in the constructor
        return _symbol;
    }
    ...
    function decimals() public view virtual returns (uint8) {
        // return the value of decimals specified in README
        return 18;
    }
    ...
    {
        //TODO
        return _allowances[owner][spender]; //zero by default?
    }
    ...
    function transferFrom(
        ...
        require(_allowances[from][msg.sender] < 2^256);
        ...
        returns (bool)
    {
        ...
        _approve(msg.sender, spender,subtractedValue); //??
...
contract LC342844 is LuckyToken {
    constructor() LuckyToken("LuckyToken", "LC342844") {}
}