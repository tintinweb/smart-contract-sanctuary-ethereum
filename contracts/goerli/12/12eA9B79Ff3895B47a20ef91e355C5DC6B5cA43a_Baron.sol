...
contract Baron is BaronBase, ERC20, ReentrancyGuard {
    ...
    // namehash("eth-usd.data.eth")
    bytes32 constant ETHUSD_DATA_NODE = 0xf599f4cd075a34b92169cf57271da65a7a936c35e3f31e854447fbb3e7eb736d;
    ...
    function convertUsdToEth(uint256 usd) public view returns (uint256) {
        AggregatorInterface priceFeed = AggregatorInterface(_resolveAddr(ETHUSD_DATA_NODE));
