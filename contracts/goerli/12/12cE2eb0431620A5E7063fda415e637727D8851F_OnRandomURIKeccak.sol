...
contract OnRandomURIKeccak is ERC721URIStorage, Ownable {
    ...
    function _getImage(string memory colorCode) internal pure returns (string memory) {
        return (
            string(
                abi.encodePacked(
                    '<svg width="270" height="350" viewBox="0 0 270 350" xmlns="http://www.w3.org/2000/svg" fill="',
                    colorCode,
                    '" >',
                    '<rect x="0" y="0" width="119" height="39"/><rect x="151" y="0" width="119" height="39" />',
                    '<rect x="0" y="63" width="119" height="39"/><rect x="151" y="63" width="119" height="39" />',
                    '<rect x="0" y="125" width="119" height="39"/><rect x="151" y="125" width="119" height="39" />',
                    '<rect x="0" y="187" width="119" height="39"/><rect x="151" y="187" width="119" height="39" />',
                    '<rect x="0" y="249" width="119" height="39"/><rect x="151" y="249" width="119" height="39" />',
                    '<rect x="0" y="311" width="119" height="39"/><rect x="151" y="311" width="119" height="39" />',
                    '</svg>'
                )
            )
        );        
