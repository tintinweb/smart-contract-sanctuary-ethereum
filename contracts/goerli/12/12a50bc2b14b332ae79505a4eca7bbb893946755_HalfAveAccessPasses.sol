...
contract HalfAveAccessPasses is ERC721, Ownable, DefaultOperatorFilterer {
    ...
    uint128 public maxSupply = 800;

    uint64 public generalMintMaxSupply = 400;
    uint64 public azukiMintMaxSupply = 133;
    uint64 public cloneXMintMaxSupply = 133;
    uint64 public BAYCMintMaxSupply = 134;
    ...
    function generalMint(uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        for (uint256 i = 0; i < _mintAmount; i++) {
            supply.increment();
            _safeMint(msg.sender, 401 + azukiAmountMinted);
        }
    ...
    function azukiMint(uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        for (uint256 i = 0; i < _mintAmount; i++) {
            supply.increment();
            _safeMint(msg.sender, 401 + azukiAmountMinted + i);
        }
    ...
    function cloneXMint(uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        for (uint256 i = 0; i < _mintAmount; i++) {
            supply.increment();
            _safeMint(msg.sender, 534 + cloneXAmountMinted + i);
        }
    ...
    function BAYCMint(uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        for (uint256 i = 0; i < _mintAmount; i++) {
            supply.increment();
            _safeMint(msg.sender, 667 + BAYCAmountMinted + i);
        }
