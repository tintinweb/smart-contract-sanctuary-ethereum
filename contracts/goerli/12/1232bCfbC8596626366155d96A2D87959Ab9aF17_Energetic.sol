        ...
        return
            string(
                abi.encodePacked(
                    ...
                    randomNumber(359).toString(),
                    ', 100%, 50%)">',
                    '<animate attributeName="stop-color" values="hsl(',
                    randomNumber(358).toString(),
                    ", 100%, 50%);hsl(130, 100%, 50%);hsl(244, 100%, 50%);hsl(12, 100%, 50%);hsl(120, 100%, 50%);hsl(",
                    randomNumber(358).toString(),
                    ', 100%, 50%);" dur="',
                    randomNumber(120).toString(),
                    's" repeatCount="indefinite" />',
                    '<animate attributeName="offset" values=".95;.80;.60;.40;.20;0;.20;.40;.60;.80;.95" dur="',
                    randomNumber(119).toString(),
                    's" repeatCount="indefinite"/>',
                    "</stop>"
                )
            );
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    randomNumber(357).toString(),
                    ', 100%, 50%)" >',
                    '<animate attributeName="stop-color" values="hsl(',
                    randomNumber(356).toString(),
                    ", 100%, 50%);hsl(48, 100%, 50%);hsl(244, 100%, 50%);hsl(332, 100%, 50%);hsl(320, 100%, 50%);hsl(",
                    randomNumber(356).toString(),
                    ', 100%, 50%)" dur="',
                    randomNumber(118).toString(),
                    's" repeatCount="indefinite" />',
                    '<animate attributeName="offset" values=".95;.80;.60;.40;.20;0;.20;.40;.60;.80;.95" dur="',
                    randomNumber(117).toString(),
                    's" repeatCount="indefinite" />',
                    "</stop>"
                )
            );
