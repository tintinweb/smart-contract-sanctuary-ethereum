 ...
 */
contract RMZERC20 is ERC20Upgradeable, IBurnableMintableERC677Token, ERC20PausableUpgradeable, Ownable, Blacklistable, Rescuable  {
    ...
    function initialize(uint256 initialIssue) public initializer {
        __ERC20_init("RMZ", "RMZ");
        setOwner(msg.sender);
