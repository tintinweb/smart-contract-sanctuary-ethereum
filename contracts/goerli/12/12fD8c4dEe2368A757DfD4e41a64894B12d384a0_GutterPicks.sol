...
contract GutterPicks is Ownable {
    ...
    event NewLineup(string contestId, address participant, uint256 lineupId, uint256 lineup);
    event EditLineup(string contestId, address participant, uint256 lineupId, uint256 lineup);
    ...
    */
    ...
    function createLineup(string calldata contestId, uint256 lineup) external {
        ...
        emit NewLineup(contestId, msg.sender, entryId, lineup);
    }
    ...
    function editLineup(string calldata contestId, uint256 lineupId, uint256 lineup) external {
        ...
        emit EditLineup(contestId, msg.sender, lineupId, lineup);
    }
