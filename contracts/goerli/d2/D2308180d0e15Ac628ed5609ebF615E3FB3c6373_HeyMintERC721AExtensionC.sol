...
struct BaseConfig {
    ...
    // The amount of centiETH that must be raised in fundingDuration seconds since contract deploy or funds are refundable - multiply by 10^16
...
struct AdvancedConfig {
    ...
    uint8 mintsPerBurn;
    // The payment required alongside burning in order to mint in 1/100,000 ETH
    uint32 burnPayment;
