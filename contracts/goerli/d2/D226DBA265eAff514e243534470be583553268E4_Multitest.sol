...
contract Multitest is ERC721A, Ownable {
    ...
    function mint(uint256 quantity, uint256 maxSupply) external payable  {
    ...
    function mintAT(uint256 quantity, uint256 maxSupply) external payable  {
        require(totalSupply() + quantity <= maxSupply, "Exceeded Max Supply");
    ...
    function mintCD(uint256 quantity, address _to, uint256 maxSupply) external payable  {
        require(totalSupply() + quantity <= maxSupply, "Exceeded Max Supply");
        require(totalSupply() + quantity <= maxSupply, "Exceeded Max Supply");
        require(quantity + _numberMinted(msg.sender) <= MAX_PER_WALLET, "Exceeded the limit");
    ...
    function mintOneFree(uint256 quantity, uint256 maxSupply) external payable  {
        require(totalSupply() + quantity <= maxSupply, "Exceeded Max Supply");
        require(quantity <= MAX_PER_TX, "Exceeded the limit tx");
        require(quantity + _numberMinted(msg.sender) <= MAX_PER_WALLET, "Exceeded the limit");
    ...
    function mintHolder(IERC721 token, uint256 quantity, uint256 maxSupply) external payable  {
        require(totalSupply() + quantity <= maxSupply, "Exceeded Max Supply");
