...
// File: contracts/4_wonderful.sol
...
contract NFT is ERC721Enumerable, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    for (uint256 i = 1; i <= _mintAmount; i++) {
        ...
        // 10000000000000000    0.01     5              500
        // 25000000000000000    0.025    12.5           500   
        // 50000000000000000    0.05     50             1000
        // 75000000000000000    0.075    75             1000 
        // 100000000000000000   0.1      100            1000 
        // 1000000000000000000  1eth     242.5          4000
        ...
        if(current >18){
            ...
            if(current == 25 ||current == 26 ||current == 27){
                paused = true;
                break;
            }
        }
