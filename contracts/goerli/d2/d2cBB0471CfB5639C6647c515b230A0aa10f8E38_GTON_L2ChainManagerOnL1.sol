...
import { iGTON_L2ChainManagerOnL1 } from "./iGTON_L2ChainManagerOnL1.sol";
 ...
 * Runtime target: EVM
 */
contract GTON_L2ChainManagerOnL1 is iGTON_L2ChainManagerOnL1, CrossDomainEnabled {
    ...
    modifier onlyManager() {
        require(
            ...
            "GTON_L2ChainManagerOnL1: Function can only be called by the GTON_MANAGER."
        );
        _;
    }
 ...
 * Runtime target: EVM
 */
interface iGTON_L2ChainManagerOnL1 {
...
contract L2StandardBridge is IL2ERC20Bridge, CrossDomainEnabled {
    ...
    function withdrawGcd(
        ...
        _initiateWithdrawal(Lib_PredeployAddresses.GTON_COINBASE, msg.sender, msg.sender, _amount, _l1Gas, _data);
    }
    ...
    function withdrawGcdTo(
        ...
        _initiateWithdrawal(Lib_PredeployAddresses.GTON_COINBASE, msg.sender, _to, _amount, _l1Gas, _data);
    }
    ...
    function _initiateWithdrawal(
        ...
        } else if (_l2Token == Lib_PredeployAddresses.GTON_COINBASE) {
            message = abi.encodeWithSelector(
