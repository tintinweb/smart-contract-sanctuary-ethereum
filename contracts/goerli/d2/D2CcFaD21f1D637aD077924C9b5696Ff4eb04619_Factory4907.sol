  ...
  function deployVault(
    ...
    address _vault = address(
      new Vault4907(
        ...
        msg.sender,
        _market,
        _minDuration, // day -> sec
        _maxDuration, // day -> sec
...
contract Vault721 is ERC721, Pausable {
  ...
  mapping(uint256 => uint256) public tokenIdAllowed;
...
interface IVault {
  ...
  function tokenIdAllowed(uint256 _tokenId) external view returns (bool);
