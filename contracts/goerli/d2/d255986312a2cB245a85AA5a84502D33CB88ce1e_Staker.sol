...
contract Staker {
  ...
  function execute() public {
    ...
    // require that staking is incomplete, has not happened
  ...
  function withdraw() public {
    ...
    require(userBalance > 0, 'insufficient funds!');
    // reset sender's balance
    balances[msg.sender] = 0;
    (bool sent, ) = msg.sender.call{value: userBalance}('');
    require(sent, 'failed to withdraw to user');
  }
