...
contract ConnectorTest is IConnector, ERC721, ERC721Holder, Ownable {
    ...
    constructor() payable ERC721("ConnectorTest", "C4") {
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        string memory winner = (game.winner == address(0)) ? "N/A" : uint160(game.winner).toHexString(20);
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '",',
                    '", "value":"',
                        uint160(player1).toHexString(20),
                    '"},',
                    '{"trait_type":"',
                        checker2,
                    '", "value":"',
                        uint160(player2).toHexString(20),
                    '"},',
                    '{"trait_type":"Moves", "value":"',
                        moves.toString(),
                    '"},',
                    '{"trait_type":"Turn", "value":"',
                        uint160(turn).toHexString(20),
                    '"},',
...
contract Render is IRender, Ownable {
    using Strings for uint256;
    string public constant BLUE = "#DB2B39";
    string public constant RED = "#29335c";
    ...
    function register(uint256 _gameId) external onlyOwner {
        ...
        display.base = palette[_gameId % 3];
        display.player1 = palette[(_gameId+1) % 3];
        display.player2 = palette[(_gameId+2) % 3];
    }
