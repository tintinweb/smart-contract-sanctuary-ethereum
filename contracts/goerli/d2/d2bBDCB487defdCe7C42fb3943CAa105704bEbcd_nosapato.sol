...
contract nosapato is ERC721A, Ownable {
    ...
    string public prerevealURL = "ipfs://QmYCN4g8ye3usTEM4CAT6KNN1hLR2narpvTYJzcHmVfbMA/hidden.json" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("nosapato", "ns") {}
