...
contract LastofTesttona is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Last of Testona";
    string private constant _symbol = unicode"LastOFtest";
