...
contract FxStateRootTunnel is FxBaseRootTunnel {
    ...
    constructor(address childTunnel, address _checkpointManager, address _fxRoot) FxBaseRootTunnel(_checkpointManager, _fxRoot) {
        _setFxChildTunnel(childTunnel);
    }
...
abstract contract FxBaseRootTunnel {
    ...
    function _setFxChildTunnel(address _fxChildTunnel) internal virtual {
