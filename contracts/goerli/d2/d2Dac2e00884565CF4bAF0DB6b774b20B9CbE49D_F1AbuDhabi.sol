 ...
 * @notice This contract handles minting F1 Abu Dhabi tokens.
 */
contract F1AbuDhabi is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    string public name = "F1 Abu Dhabi";
    string public symbol = "Abu Dhabi GP";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeidn35z7syd6v2pj5e5cms5d5yuds5ziwvqluwhsxxex2h6uf4jtr4/{id}"
        )
    {
