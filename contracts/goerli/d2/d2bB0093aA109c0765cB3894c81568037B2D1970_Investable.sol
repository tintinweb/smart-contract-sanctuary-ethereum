    ...
    constructor(address alf, address usdt) {
        ...
        investPlans.push(
            InvestPlan({
                name: "Fox Vault 1",
                desc: "A desc",
                alfToLock: 100 * 10 ** ERC20(alfAddress).decimals(), // TODO à définir
                minimumUsdtToInvest: 100 * 10 ** ERC20(usdtAddress).decimals(),
                maximumUsdtToInvest: 500 * 10 ** ERC20(usdtAddress).decimals()
        }));
        ...
        investPlans.push(
            InvestPlan({
                ...
                minimumUsdtToInvest: 500 * 10 ** ERC20(usdtAddress).decimals(), // TODO à définir
