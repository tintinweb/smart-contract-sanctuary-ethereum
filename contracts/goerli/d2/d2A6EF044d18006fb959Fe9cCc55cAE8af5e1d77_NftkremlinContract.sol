...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x658BfEd16067FA793D01C7384aD1Fc28B94205fD];
  address public erc20Payable = 0x658BfEd16067FA793D01C7384aD1Fc28B94205fD;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmUm1bkUkSBJznf8owgFwUfFNRqaA6U5DaYhUBbtyg1DuU/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lyLvbDExdOVsaIAsIBpT/contract-metadata";
  }
...
// File: contracts/NftkremlinContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftkremlinContract is RamppERC721A {
    constructor() RamppERC721A("NFT KREMLIN", "NFTK"){}
}
