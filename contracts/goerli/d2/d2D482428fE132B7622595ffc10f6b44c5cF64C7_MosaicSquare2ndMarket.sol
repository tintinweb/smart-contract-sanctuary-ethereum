...
****************************************************************************************************/
  function createFixedPrice(address nftContract, uint256 tokenId, uint256 price, uint256 duration, uint256 offerPrice) public {
    ...
    if (offerPrice > 0) {
      ...
      require(price > offerPrice, "MarketFixedPrice: The offer start price should be lower than the Fixed Price");
...
****************************************************************************************************/
  function _createOffer(address nftContract, uint256 tokenId, address seller, uint256 amount, uint256 fixedPriceEndTime) internal {
    nftContractToTokenIdToOffer[nftContract][tokenId] = Offer(payable(seller), fixedPriceEndTime, amount, payable(0), marketFee);
  }
