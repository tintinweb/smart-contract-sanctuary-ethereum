...
contract AnchorUSDVxUSDT is ReentrancyGuard, Ownable {
    ...
    function swapFrom(uint256 amount) external nonReentrant {
        ...
        // for every 1.02 usdt we get 1.00 usdv
            // 1020000 we get 1000000000000000000

        uint256 amountToSend = amount * 100000000000000 / usdtRate;
    ...
    function swapTo(uint256 amount) external nonReentrant {
        ...
        uint256 amountToSend = amount * usdvRate / 100000000000000;

        require(usdt.balanceOf(address(this)) >= amountToSend, "swapTo: Not enough usdv in reserves");
