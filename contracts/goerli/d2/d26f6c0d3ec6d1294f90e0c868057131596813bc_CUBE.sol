...
contract CUBE is ERC20, Ownable {
    ...
    constructor() ERC20("CUBE", "CD") {
     ...
     uint256 totalSupply = 3 * 10 ** 9 * 10 ** decimals();
        ...
        MarketingWallet = address(0x50f1bE6a609fE3dcb2782596c0de56Efe95ee7d7); // set as Marketing wallet
        DevWallet = address(0x50f1bE6a609fE3dcb2782596c0de56Efe95ee7d7); // set as dev wallet
