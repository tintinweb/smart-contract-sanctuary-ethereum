...
//    / ____/_  ______________  __   / ____/___  / __/ __/__  ___     / __ \____ ______/ /___  __
//   / /_  / / / / ___/ ___/ / / /  / /   / __ \/ /_/ /_/ _ \/ _ \   / /_/ / __ `/ ___/ __/ / / /
//  / __/ / /_/ / /  / /  / /_/ /  / /___/ /_/ / __/ __/  __/  __/  / ____/ /_/ / /  / /_/ /_/ / 
// /_/    \__,_/_/  /_/   \__, /   \____/\____/_/ /_/  \___/\___/  /_/    \__,_/_/   \__/\__, /  
//                       /____/                                                         /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3985D50a9A38A93d968F213d5ddc0A9e1f3824f7];
  address public erc20Payable = 0x3985D50a9A38A93d968F213d5ddc0A9e1f3824f7;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 3000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidju2yqcs2l6f2gg7kygvsdmyv4qrfbmg76xoq7eir2tn4sv5axhm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/C5ZzyCRM5ksO0CO9noft/contract-metadata";
  }
...
// File: contracts/FurryCoffeePartyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FurryCoffeePartyContract is RamppERC721A {
    constructor() RamppERC721A("Furry Coffee Party", "FCP"){}
}
