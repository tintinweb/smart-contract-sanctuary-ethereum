...
contract JiraverseVX is ERC721, Ownable {
    using Strings for uint256;
    ...
    string private base_uri = "https://ipfs.io/ipfs/xxx/"; // TODO : update
    ...
    // TESTING:
    address public constant JIRAVERSE_CONTRACT = 0x41B819305411Bb2bd4bB8e45f5dac7D6546fE09c;

    constructor () ERC721("JIRAVERSE VX", "JIRAVX") {
    }
    ...
    function gen1Claim(uint _gen1_id) external {
    ...
    function publicMint(uint _pass_id) external {
        require(public_sale_running, "Public sale is not running");
    ...
    function getOwnerOfJiraversePass(uint _pass_id) external view returns (address) {
        return IERC721(JIRAVERSE_CONTRACT).ownerOf(_pass_id);
    }
}