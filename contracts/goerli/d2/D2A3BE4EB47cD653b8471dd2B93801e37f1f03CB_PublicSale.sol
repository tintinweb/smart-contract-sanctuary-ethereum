...
contract PublicSale is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setMiPrimerTokenAdd(address _miPrimerToken) external onlyRole(OWNER_ROLE){
        miPrimerToken = IERC20Upgradeable(_miPrimerToken);
    }

    function setGnosisSafeWalletAdd(address _gnosisSafeWallet) external onlyRole(OWNER_ROLE){
    ...
    function recuperarTokens() public onlyRole(OWNER_ROLE){
