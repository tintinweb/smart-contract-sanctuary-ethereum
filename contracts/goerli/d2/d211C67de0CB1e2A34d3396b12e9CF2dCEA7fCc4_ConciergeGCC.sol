...
contract ConciergeGCC is Ownable, ReentrancyGuard {
    ...
    /// @notice GCC Address
    address public gccAddress;

    /// @notice Set GCC Address
    /// @param _gccAddress GCC Address
    function setGccAddress(address _gccAddress) public onlyOwner {
        gccAddress = _gccAddress;
    }
    ...
    function stakeAndPurchase(uint256 tokenId) public payable nonReentrant {
        ...
        require(gccAddress != address(0), "ConciergeGCC: GCC Address not set");
        require(
