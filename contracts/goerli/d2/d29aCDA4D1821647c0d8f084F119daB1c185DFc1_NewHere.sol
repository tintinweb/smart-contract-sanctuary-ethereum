    ...
    Ownable
{
    ...
    // Merkle tree roots
    bytes32 public immutable PRE_SALE_FREE_ROOT;
    bytes32 public immutable PRE_SALE_PAID_ROOT;
    ...
    constructor(
        ...
        bytes32 _PRE_SALE_FREE_ROOT,
        bytes32 _PRE_SALE_PAID_ROOT,
        uint256 _MAX_SUPPLY
    ) ERC721A("NewHere", "NEWHERE") {
        _uri = _baseURI_;
        PRE_SALE_FREE_ROOT = _PRE_SALE_FREE_ROOT;
        PRE_SALE_PAID_ROOT = _PRE_SALE_PAID_ROOT;
