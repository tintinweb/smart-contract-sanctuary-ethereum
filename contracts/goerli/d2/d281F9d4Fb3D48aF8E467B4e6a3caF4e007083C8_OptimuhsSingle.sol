...
contract OptimuhsSingle is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ReentrancyGuard {
    ...
    constructor(
        ...
        salesConfig.mintPrice = 0;
        salesConfig.amountPerWallet = 1;
        salesConfig.totalSupply = 100;
    }
    ...
    function mintNFT() public payable{
        require(mintList[msg.sender] < salesConfig.amountPerWallet ,"Max mint limit per wallet reached");
