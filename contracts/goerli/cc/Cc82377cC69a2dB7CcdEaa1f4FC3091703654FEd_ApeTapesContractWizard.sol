...
import "./IERC721JFullUpgradeable.sol";
import "./IERC721JFreeClaimsUpgradeable.sol";
import "./IERC721JEnumerableUpgradeable.sol";
    ...
    OwnableUpgradeable
{
    ...
    function freeClaim(address _contract, uint256 tokenId) public {
        ...
        address claimOwner = _claimContract.ownerOf(tokenId);
        if (claimOwner != msg.sender ||
        _claimContract.getApproved(tokenId) != msg.sender || 
        !_claimContract.isApprovedForAll(claimOwner, msg.sender))
