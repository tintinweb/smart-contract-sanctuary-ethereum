    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public publicMintCost = 2000000000000000; // 0.02 ETH
    ...
    function allowListMint(uint256[] calldata tokenIds, bytes32[] memory proof)
        external
        payable
        nonReentrant
    {
        ...
        require(len <= 10, "Can burn/mint max 10 tokens at a time");
