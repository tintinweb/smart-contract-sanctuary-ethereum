	...
	ReentrancyGuardUpgradeable
{
	...
	modifier mintCompliance(uint256 _mintAmount) {
		require(
			_mintAmount > 0 &&
				...
				_mintedAmount[msg.sender] <= maxMintAmountPerWallet,
			"Invalid mint amount!"
		);
		require(
	...
	function teamMint(
		...
		require(_mintAmount > 0 && _mintAmount <= 500, "Invalid mint amount!");
		require(
	...
	function withdraw() public onlyOwner nonReentrant {
		...
		//project team
		address n1 = payable(0x13E04b99fFBA696584D4c8Ff8950a89CE247DB52);
		//vc team
		address n2 = payable(0x3CA9AE818ebc8f4c2fdc76DE1E48D7d3C7578060);
		bool success;
