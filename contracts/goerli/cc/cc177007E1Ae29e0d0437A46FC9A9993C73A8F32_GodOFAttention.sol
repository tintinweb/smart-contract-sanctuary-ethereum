...
contract GodOFAttention is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 private constant _TotalCollectionSize = 150; // 8888/100
    uint256 public MAX_PER_Transaction = 2; //Decide how many you can buy at a time
    uint256 public MAX_PER_Address_FOR_ALLOW_LIST = 15; // for who met coco mint 

    // set each spots 
    uint256 private teamNFTsTaked;
    uint16 private teamLimit = 5; 
    
    uint256 private soldElder;
    uint256 private elderSpots = 50;  

    uint256 private soldBaptized;
    uint256 private BaptizedSpots = 50; 
     
    constructor( string memory _hiddenURI, uint96 _royaltyFeesInBips, bytes32 _root, address _teamWallet) ERC721A("God Of Attenton Coco","GOA")
    {
    ...
    function getSoldNum() public view returns (uint256) { //total supply 가 불가능하므로 
