...
contract rinkebySale is SaleContract {
    ...
    function Rinkeby_setPresaleIn5() public {
        _presaleStart   = block.timestamp + 60 * 5;
        _presaleEnd     = _presaleStart + 60 * 15;
        _saleStart      = _presaleEnd;
        _saleEnd        = _saleStart + 60 * 15;
    }

    function Rinkeby_UpdateSaleConfiguration(
        uint256 __presaleStart,
        uint256 __presaleEnd,
        uint256 __saleStart,
        uint256 __saleEnd 
    ) public {

        _presaleStart   = __presaleStart;
        _presaleEnd     = __presaleEnd;
        _saleStart      = __saleStart;
        _saleEnd        = __saleEnd;
    }
