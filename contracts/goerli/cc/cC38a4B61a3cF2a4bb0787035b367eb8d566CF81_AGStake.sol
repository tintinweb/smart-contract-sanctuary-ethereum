 ...
 * 79045 claimHard
 * 72843 claimSoft
 * 143715 unstakeSingle
 * 40782 unstakedBalanceOf
 * 31399 stakedBalanceOf
 */
contract AGStake is Ownable, ERC1155Holder {
     ...
     * multiplier: multiplier that was applied to get the amount(divide by 10_000 to get real value)
    ...
    function stakeSingle(uint256 tokenId, uint256 tokenCount) external {
        ...
        // claim unstaked tokens, since these will change
    ...
    function _claim(address account, bool hardClaim) internal {
        ...
        unchecked {
            ...
            // calculate total bonus to be applied, we start adding bonus for additional hodls
        ...
        uint256 earned = ((bonus * stakeRate * (timestamp - stakedAt)) /
            7 days) * 10**15;
