...
contract Test_RSAM is ERC20, Ownable {
  struct Tax {
  ...
  //Swapping
  uint256 public swapTokensAtAmount = _totalSupply / 200; //after 0.05% of total supply, swap them
  bool public swapAndLiquifyEnabled = true;
  bool public isSwapping = false;
  bool public tradingStatus = false;

  //Wallets
  address public MarketingWallet = 0xE400094ae74C3E0786FB8ad1DB13aDF401F90D86;

  // Maximiums
  uint public maxWallet = (_totalSupply * 3) / 100;
  uint public maxTx = (_totalSupply * 2) / 100;
  ...
  function _takeTax(
    ...
    if (_to == pairAddress) {
      ...
      require(
        ...
        "can not exceed max wallet"
      );
    }
    require(_amount <= maxTx, "can not exceed max tx");
