...
error Raffle__UpkeepNotNeeded(uint256 currentbalance, uint256 numberPlayers, uint256 rafflestate);
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
     ...
     * 3. Our sunbscription is funded with link
     * 4. Lootery should be in open state
     */
    ...
    function fulfillRandomWords(
        ...
        s_lastTimeStamp = block.timestamp;
        // send all money to recent winner
