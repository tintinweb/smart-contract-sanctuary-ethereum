...
contract GenesisOfRealm is ERC721A, Ownable {
  using Strings for uint256;
    ...
    uint256 public constant SALE_PRICE = 0.010 ether;
  ...
  constructor(bytes32 _merkleroot) ERC721A("Genesis", "GOR") {
  ...
  function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalMint[msg.sender] +_quantity) <= MAX_MINT, "Already minted 2 times!");
        require(msg.value >= (SALE_PRICE * _quantity), "Below");
        
        totalMint[msg.sender] += _quantity;
        _stageMintedCountsPerWallet[totalSupply()][msg.sender] += _quantity;
  ...
  function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable callerIsUser{
        ...
        require((totalMint[msg.sender] + _quantity)  <= MAX_MINT, "Cannot mint beyond whitelist max mint!");
    ...
    function sendMintTokens(uint256 mintStage, address to) public onlyOwner{
        ...
        qty -= prev;
        //require((totalSupply() + qty) > MAX_SUPPLY, "Hataaaaaa");
  ...
  function withdraw() external onlyOwner{
        ...
        payable(0x5a02398f30b703Fe40DDAbc343Cc6ADDD68Dabbb).transfer(withdrawAmount_10);
        payable(0xDcaD686747D745Da1d3299593ed5B926D8A0435F).transfer(withdrawAmount_15);
        payable(0x11F07871f360442A0EF6d1962fCfa5C66a5797eA).transfer(withdrawAmount_15);
        payable(0xd26f7F6B3bDACF9B34AA3884962FF0d4F151c7B0).transfer(withdrawAmount_15);        
        payable(0x1877D917B64260b83dAc8d5E09Dc925F20E7B507).transfer(withdrawAmount_5);
        payable(0xC6988fbB9ae786e6A4C19C7Ffe75A8F6ef28ad27).transfer(withdrawAmount_5);
        payable(0x8deaB4F52b02B625FFd3D6001059C93b5810fd95).transfer(withdrawAmount_5);
