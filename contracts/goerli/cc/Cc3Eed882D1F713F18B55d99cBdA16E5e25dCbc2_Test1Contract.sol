...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x919fC964bcf320cFF57fc9f55154Dde756Fb06B7,0xd45063B486C6df3489519f38Cb979A0392dd1fD7];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmfMgFjY39wbfE3Ca9uaGwvPwGnbA1eB8A8Zvjh829q9px/";
...
// File: contracts/Test1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Test1Contract is RamppERC721A {
    constructor() RamppERC721A("Test1", "test"){}
}
