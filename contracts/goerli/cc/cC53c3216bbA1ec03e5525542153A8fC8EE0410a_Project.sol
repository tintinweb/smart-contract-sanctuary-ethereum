...
contract Project is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function withdrawAll() public payable onlyOwner {
        require(
            withdrawAddr != address(0),
            "Not set The address for withdraw."
        );
    ...
    function mintTo(address _to, uint256 _n) public onlyOwner {
        uint toeknId = totalSupply();
        require(toeknId + _n <= maxTotal, "Exceed to MaxSupply");
        _minNFT(_to, _n);
    }
}
