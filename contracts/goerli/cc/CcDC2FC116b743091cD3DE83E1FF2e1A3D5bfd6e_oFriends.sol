...
contract oFriends is ERC721AQueryable, ReentrancyGuard, ERC2981, Ownable {
    ...
    uint64 private _oFriendIdCounter = 10_000;
    ...
    constructor() ERC721A("oFriend", "OF") {}    
    ...
    function openHouse(uint256 houseId) public nonReentrant() returns (uint256) {
        ...
        uint64 oFriendTokenId = _oFriendIdCounter;
        _mint(to, oFriendTokenId);
    ...
    function findPuppy(bytes calldata sig) external payable {
        ...
        _setAux(msg.sender, oPuppyTokenId);
        _mint(msg.sender, oPuppyTokenId);
    ...
    function individualOpened(address addr) external view returns (uint256) {
