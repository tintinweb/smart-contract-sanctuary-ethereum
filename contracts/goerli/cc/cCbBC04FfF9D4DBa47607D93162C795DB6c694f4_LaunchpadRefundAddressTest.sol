 ...
 * @notice This contract handles minting Refund address test tokens.
 */
contract LaunchpadRefundAddressTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    uint256 public refundPrice = 0.8 ether;
    ...
    constructor() ERC721A("Refund address test", "RAT") {
