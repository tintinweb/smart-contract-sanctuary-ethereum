...
contract transferUSDC {
    ...
    constructor() public {
        ...
        ENTRToken = ERC20Token(0x59cDC482370C36CC55162926C4270570894b2cAD);
    }

    function depositTokens(uint256 amount) public {
        uint256 playersUsdcBalance = USDc.balanceOf(address(msg.sender));
        require(amount > 0);
        ...
        ENTRToken.transferFrom(address(this), msg.sender, 10**18);
    ...
    function withdrawalPlayers(uint256 _amount) public {
        ...
        ENTRToken.transferFrom(msg.sender, address(this), 10**18);
