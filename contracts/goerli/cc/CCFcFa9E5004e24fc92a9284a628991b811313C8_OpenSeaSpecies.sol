...
contract OpenSeaSpecies is ERC721Namable, ERC721Enumerable, BattlespeciesWithdrawer, RevokableOperatorFilterer {
    ...
    uint256 public mintPrice = 55000000 gwei; //0.055 ETH
    ...
    constructor(address _hyperwarpManager, address _utilityHub, bytes32 _wlRoot) 
        ERC721Namable("Battlespecies", "BATTLE") 
