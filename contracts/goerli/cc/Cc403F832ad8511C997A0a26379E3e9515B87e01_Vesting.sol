...
//expiry1= expiry+2592200;
    ...
    function withdraw() external {
        ...
        if(block.timestamp>=expiry1){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry2){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry3){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry4){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry5){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry6){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry7){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry8){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry9){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry10){
          token.transfer(receiver, amount/12);  
        }
        else if(block.timestamp>=expiry11){
          token.transfer(receiver, amount/12);  
        }
