...
contract FundManager is Ownable {
    ...
    constructor(address _fundsToken,IHumaPool _humaPool, ITokenMessanger _tokenMessanger) public Ownable()  {
    ...
    function portUSDCtoAalanche(address recipient, uint256 amount, bytes32 mintRecipient, address usdc) external {

        tokenMessanger.depositForBurn(amount, AVAX_DESTINATION_DOMAIN, mintRecipient, usdc);
    }
