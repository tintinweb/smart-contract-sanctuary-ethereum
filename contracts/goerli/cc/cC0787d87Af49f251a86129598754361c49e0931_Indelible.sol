...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    ContractData public contractData = ContractData(unicode"M.O.A.N. : The Space/Time Dimension", unicode"View of the lost glitches from The Harvest: The Red Earth Dimension", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/fd1c0bef-f81b-4dfe-92e0-aea4bee350b5", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/fd1c0bef-f81b-4dfe-92e0-aea4bee350b5", "", 400, "0xf376A6a24B0c36A86024AeA15841893B43cF35f8");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"M.O.A.N. : The Space/Time Dimension", unicode"MOAN") {
        tiers[0] = [153];
        tiers[1] = [153];
        tiers[2] = [153];
        tiers[3] = [153];
