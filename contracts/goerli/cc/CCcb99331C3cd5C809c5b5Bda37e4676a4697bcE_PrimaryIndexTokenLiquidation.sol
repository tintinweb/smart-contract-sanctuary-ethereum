...
interface IPrimaryIndexToken {
    ...
    function calcDepositPosition(address projectToken, uint256 projectTokenAmount, address user, address receiver) external;
...
contract PrimaryIndexTokenLiquidation is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    function distributeReward(address _account, address _projectToken, uint256 projectTokenToSendToLiquidator) internal {
        ...
        primaryIndexToken.calcDepositPosition(_projectToken, projectTokenToSendToLiquidator, _account, msg.sender);
    }
    ...
    function getMaxLiquidatorRewardAmount(address _account, address _projectToken, address _lendingToken) public view returns (uint256 maxLA) {
        ...
        uint256 totalOutstandingInUSD = primaryIndexToken.getProjectTokenEvaluation(_lendingToken, loanBody + accrual);
