...
FOR UNISWAP V3: Only Claim Tax, no buy/sell tax.

*/

contract GFC_TOKEN_FEE_ON_TRANSFER is ERC20, ERC20Snapshot, ERC20Burnable, AccessControl, ReentrancyGuard, ChainlinkClient, ConfirmedOwner, GFC_Helpers, Taxable {
    ...
    function claimTokens(uint256 _claimAmount) public nonReentrant {
        ...
        uint256 taxAmount = (_claimAmount * thetax())/taxDenominator;
