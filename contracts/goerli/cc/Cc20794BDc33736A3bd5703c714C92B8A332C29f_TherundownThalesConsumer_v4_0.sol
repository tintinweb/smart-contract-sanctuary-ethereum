...
contract TherundownThalesConsumer_v4_0 is ConfirmedOwner, ChainlinkClient {
    ...
    function fulfillSchedules(bytes32 _requestId, bytes[] memory _games)
        external
    ...
    function requestOddsPaginating(
        bytes32 _specId,
        uint256 _payment,
        uint256 _sportId,
        uint256 _date,
    ...
    function requestOddsPaginating(
        ...
        req.addUint("date", _date);
        req.addUint("limit", _limit);
        req.add("startAfterGameId", _bytes32ToString(_startAfterGameId));
    ...
    function requestSchedules(
        ...
        Chainlink.Request memory req = buildOperatorRequest(_specId, this.fulfillSchedules.selector);
    ...
    function requestSchedulesPaginating(
        bytes32 _specId,
        uint256 _payment,
        string calldata _market,
        uint256 _sportId,
