...
contract BeeWharf is ICurrency, Ownable {
    ...
    // 支持新的 token 支付
    function addNewSupportToken(address tokenAddress) public onlyOwner {
    ...
    function payEth(string calldata orderId) payable public override {}
    function withdrawEth(uint256 amount, string calldata billId) public override onlyOwner {}
    function refundETH(address to, uint256 amount, string calldata billId) public override onlyOwner {}
    function balanceOfETH() public view override returns (uint256) {}

    /* override ERC20 */

    function balanceOfERC20(address tokenAddress) public view override returns (uint256) {
