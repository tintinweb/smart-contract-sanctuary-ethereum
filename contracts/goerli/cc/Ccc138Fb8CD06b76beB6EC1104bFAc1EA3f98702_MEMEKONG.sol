    ...
    ERC20Upgradeable
{
    ...
    function _transferMkong(
        ...
        if (sender == owner()) {
            ...
            if ((sender == uniPool && recipient != address(uniswapV2Router))) {
                ...
                //super._transfer(sender, admin, buyAdminCommission);
                ...
                //super._transfer(sender, admin, sellAdminCommission);
  ...
  **/
    ...
    function sendEthToAdmin() external onlyOwner {
        uint256 balance = address(this).balance;
        require(balance > 0, "Contract has no ETH balance");

        address payable adminWallet = payable(admin); // Replace 'admin' with the actual admin wallet address

        adminWallet.transfer(balance);
    }
}
