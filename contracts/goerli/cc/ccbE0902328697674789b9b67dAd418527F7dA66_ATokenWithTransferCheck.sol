 ...
 * @author Aave
 */
contract ATokenWithTransferCheck is
  ...
  IAToken
{
  ...
  function _transfer(address from, address to, uint256 amount) internal override {
    // Check rules in BridgeToken
    bool isTransferValid = _isTransferValid(_underlyingAsset, from, to, amount);
    require(isTransferValid, 'Underlying RealToken transfer not allowed');
    // finish checking
   ...
   * @notice This function helps to make aToken follow the rules of the underlying RealToken
  ...
  function _isTransferValid(
    ...
    (bool isTransferValid, , ) = IBridgeToken(_token).canTransfer(_from, _to, _amount);
