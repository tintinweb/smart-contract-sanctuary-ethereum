...
contract AdSpaceFactory is ERC721Holder {
    ...
    constructor(address tablelandAddress) {
        ...
        _campaigntableid = _createTable(
            "CREATE TABLE Campaigns (deal_id INTEGER PRIMARY KEY UNIQUE, campaign_id_fk INTEGER, adspace_id_fk INTEGER, duration_deal INTEGER, price INTEGER, started_at INTEGER);"
        );
        ...
        _dealtableid = _createTable(
            "CREATE TABLE Deals (campaign_id INTEGER PRIMARY KEY UNIQUE, cid TEXT, size TEXT, link TEXT)"
        );
