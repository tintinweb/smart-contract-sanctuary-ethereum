 ...
 * @notice This contract handles minting EditionERC1155 tokens.
 */
contract EditionERC1155 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xfbF3474C72D1ee28982255FB4684cB30894685Cd;
    ...
    string public name = "EditionERC1155";
    string public symbol = "EE1155";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeia4gr2kkgzwa5gogltnzk4vgj3m4lbjlfz4asly5sbx5rxizgy7tq/{id}"
        )
        RevokableOperatorFilterer(
