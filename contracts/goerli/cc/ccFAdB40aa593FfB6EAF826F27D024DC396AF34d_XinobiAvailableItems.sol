...
import "./interfaces/IXinobiAvailableItems.sol";
import "../Utils/AccessCotrolled.sol";

contract XinobiAvailableItems is IXinobiAvailableItems, AccessCotrolled {
    ...
    function addCollection(address collectionAddress) external onlyAdmin {
        _collectionAddresses.add(collectionAddress);
    }

    function removeCollection(address collectionAddress) external onlyAdmin {
        _collectionAddresses.remove(collectionAddress);
    }

    function getCollections() external view returns (address[] memory) {
        return _collectionAddresses.values();
    }
    
    function isHandled(address collectionAddress) external view returns (bool) {
        return _collectionAddresses.contains(collectionAddress);
    }
}
