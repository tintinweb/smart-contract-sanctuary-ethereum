...
contract createAuctionContract is IERC721Receiver, Ownable {
        ...
        returns (bool)
    {
      ...
      //storing bid data
       Bid storage bidbyuser= bids[_auctionIndex][msg.sender];
       bidbyuser.auctionIndex= _auctionIndex;
       bidbyuser.bidder= msg.sender;
    ...
    function bidByUser(uint256 _auctionIndex) public view returns(uint256 _bid){
        Bid storage bidByUsers= bids[_auctionIndex][msg.sender];
        _bid= bidByUsers.newbid;
        return _bid;
    }
}