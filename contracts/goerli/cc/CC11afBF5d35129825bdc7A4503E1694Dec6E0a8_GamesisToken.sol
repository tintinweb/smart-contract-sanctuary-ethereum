...
contract GamesisToken is ERC721A, ERC721AQueryable, Ownable {
    ...
    address public constant DEV_ADDRESS = 0xB3c431cfe2B882C5078f6adfae84B3d819c051A5;
    ...
    constructor(string memory baseURI) ERC721A("Gamesis Season 0", "Gamesis Sn 0") {
        setBaseURI(baseURI);
        saleEnabled = false;
    ...
    function mint( uint256 _count, bytes32[] calldata _merkleProof ) public payable saleIsOpen {
        ...
        if (whitelistEnabled == true) {
            ...
            require(
                validClaim(msg.sender, _merkleProof),
