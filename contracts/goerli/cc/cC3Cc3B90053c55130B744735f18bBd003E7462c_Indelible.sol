...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    ContractData public contractData = ContractData(unicode"Deconstructed Pepe Punk Burbs", unicode"On-Chain Art inspired by @batzdu's GM Pepes and Cryptoburbs", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/a2a11e73-9b4f-4685-be38-22220884eead", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/a2a11e73-9b4f-4685-be38-22220884eead", "commonopoly.com", 1000, "0x3dd1a54a8F84D34929e182e03371D2A2F4D47002");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Deconstructed Pepe Punk Burbs", unicode"PPPB") {
        tiers[0] = [0,1,2,2,2,3,4,5,5,5,6,6,7,8,8,8,8,8,8,8,8,9,10,11,12,12,14,14,14,14,14,14,14,15,15,16,16,16,17,19,21,21];
        tiers[1] = [1,4,5,5,5,6,8,9,9,11,13,14,14,20,21,22,23,24,27,27,27,30,30,32,33];
        tiers[2] = [1,4,4,6,7,7,7,8,8,8,9,9,9,9,9,10,10,10,10,11,11,11,11,11,11,11,12,13,14,14,14,15,15,16,16,16,17,18,18];
        tiers[3] = [2,13,30,82,82,211];
        tiers[4] = [20,80,80,80,80,80];
