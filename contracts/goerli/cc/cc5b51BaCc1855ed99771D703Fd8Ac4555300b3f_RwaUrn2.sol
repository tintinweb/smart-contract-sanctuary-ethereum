...
// hevm: flattened sources of src/RwaUrn2.sol
...
contract RwaUrn2 {
    ...
    function lock(uint256 wad) external operator {
        ...
        require(M_1.add(ink, wad) <= gemCap, "RwaUrn2/gemcap-exceeded");
    ...
    function draw(uint256 wad) external operator {
        ...
        uint256 dart = M_1.divup(M_1.rad(wad), rate);
