...
interface IUniftyERC1155 {
  ...
  function isApprovedForAll(address _owner, address _operator) external view returns (bool isOperator);
    ...
    function mintToAdmin(address _address, uint256 _id, uint256 _qty) external; 
}
...
contract CommunityMintControl is AccessControl, ERC1155Holder {
    ...
    function withdrawNFT(address _erc1155, uint256 _tokenID, uint256 _amount) public onlyRole(ADMIN) {
        IUniftyERC1155 nft = IUniftyERC1155(_erc1155);
        nft.safeTransferFrom(address(this), _msgSender(), _tokenID, _amount, new bytes(0));
    }
    ...
    */
     ...
     function createToken(
            ...
            Collection.createToken(
                _tokenSupplyCap,
                _tokenTransactionCap,
                _tokenFeeInWei,
                _isOpenDefaultStatus,
                _allowTradingDefaultStatus,
                _enableWalletCap,
                _walletCap,
                _isOpenEdition,
                _tokenURI
            ...
            Collection.mintToAdmin(_msgSender(), tokenID, _mintamount);
            return tokenID;
        }
