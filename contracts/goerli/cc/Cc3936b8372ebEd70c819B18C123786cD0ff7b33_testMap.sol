...
contract testMap is ERC721A, ReentrancyGuard, Ownable, DefaultOperatorFilterer {
    ...
    uint256[] public priceByClassWL = [  100000000000000,  200000000000000,  300000000000000,  400000000000000 ];
    uint256[] public priceByClass   = [ 1000000000000000, 2000000000000000, 3000000000000000, 4000000000000000 ];
