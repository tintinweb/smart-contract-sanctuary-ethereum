...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x48DE239DdFBB06a77e9CD3cb7B7F956A7750e281];
  address public erc20Payable = 0x48DE239DdFBB06a77e9CD3cb7B7F956A7750e281;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.008 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeib3vpmd46jzestrgjetquvgvw5c4raiueva3clxlrjpqd6xv44yrm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/acx5034r1YwSOVa9VCzP/contract-metadata";
  }
...
contract TestContract is RamppERC721A {
    constructor() RamppERC721A("test", "tststs"){}
}
