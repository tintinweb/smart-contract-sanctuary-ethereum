...
contract DummyClifford is ERC721A, Ownable, VRFConsumerBaseV2 {
  ...
  uint private constant AUCTION_LENGTH = 5 minutes; // 1 weeks;

  // Time after auction ends that users can claim their nfts and refunds
  // Also the time cypher holders have to claim their NFT
  uint private constant CLAIM_PERIOD = 5 minutes; // 1 weeks;

  uint private constant TIME_OFFSET = 0; // 2 weeks - 5 minutes;

  uint private constant BID_EXTENSION_LENGTH = 5 minutes; // 15 minutes;
