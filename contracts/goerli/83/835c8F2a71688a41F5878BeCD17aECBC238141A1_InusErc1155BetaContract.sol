...
// File: contracts/InusErc1155BetaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract InusErc1155BetaContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "INUSErc1155BETA";
    string public symbol = "INUS1155";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/B0F8bY8ineRyD4ipNO2f/contract-metadata";
  }
