...
contract Signwitch is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmSWjdBBGoAaDb1rx2mY7utbuRKXedaGX64arrD3aKnAXa";
    address private openSeaProxyRegistryAddress = 0x8BD760820231dc41E5b0A82503C1f2487068A80C;
    ...
    constructor(
    ) ERC721A("witch", "witch", 100, maxSupply) {
    }
