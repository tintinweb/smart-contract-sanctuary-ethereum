...
/**
 * @title ReimplantsKekeno
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract ReimplantsKekeno is ReentrancyGuard, Pausable, ERC20Permit {
    address private _owner;

    constructor() ERC20("Reimplants Kekeno","ETE")  ERC20Permit("Reimplants Kekeno") { 
        _owner = _msgSender();
     }
