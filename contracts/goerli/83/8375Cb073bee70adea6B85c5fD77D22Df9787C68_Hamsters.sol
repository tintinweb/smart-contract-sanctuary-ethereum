...
contract Hamsters is ERC721A, Ownable {
    ...
    string public nonRevealURI = "ipfs://QmPdC5iMH6QagcGoRVnodCcPj9BaWMYMCgY98tjJ13fzxz/reveal.json";

    constructor() ERC721A("Hamsters", "HNFT") {}
    ...
    function mintTo(uint256 _quantity, address _receiver) public onlyOwner {
