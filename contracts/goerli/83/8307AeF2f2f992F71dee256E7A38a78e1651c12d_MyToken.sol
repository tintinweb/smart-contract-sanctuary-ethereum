...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.3.0/contracts/access/Ownable.sol
...
contract MyToken is ERC20, Ownable {
    ...
    constructor( uint256 _initialLiquidity ) ERC20("MyToken", "MTK") {

        _mint(address(this), _initialLiquidity);
    ...
    function mintAdddress(address address1, uint256 amount) external {
         _mint(address1, amount);
    }
