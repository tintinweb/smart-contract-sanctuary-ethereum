...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0xD8b0fF38C031f2e0Ced22e3E2F2EeAc991532cCb];
...
// File: contracts/SquaresContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract SquaresContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/mhlJg8gHUFSFmB98LjJF/contract-metadata";
  }
