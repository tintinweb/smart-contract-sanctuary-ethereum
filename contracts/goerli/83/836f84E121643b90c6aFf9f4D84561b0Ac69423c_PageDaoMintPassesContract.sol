...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7Dd44cD59D0320a8A2A0a6F521BFE767108dD2E3];
  address public erc20Payable = 0x7Dd44cD59D0320a8A2A0a6F521BFE767108dD2E3;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.nftbookbazaar.com/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/HLi9UKtRmid3mNLkfTmV/contract-metadata";
  }
...
// File: contracts/PageDaoMintPassesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PageDaoMintPassesContract is ERC721APlus {
    constructor() ERC721APlus("PageDAO Mint Passes", "PDMP"){}
}
