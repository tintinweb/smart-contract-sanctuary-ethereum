...
contract SheenaIni is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Sheena Ini";
    string private constant _symbol = "SHEENAINI";
    ...
    uint256 public _swapTokensAtAmount = _tTotal*3/10000;
