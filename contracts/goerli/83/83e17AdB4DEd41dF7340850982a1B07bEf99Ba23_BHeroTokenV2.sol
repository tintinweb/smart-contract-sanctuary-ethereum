...
//   IBEP20 public coinToken;
  ...
  function mint(uint256 count) external {
    ...
    require(tokenIds[to].length + count <= tokenLimit, "User limit reached");

    createToken(to, count);
  }
  ...
  //     require(index + 1 <= tokenLimit, "User limit reached");
  //   }
  // }
}
