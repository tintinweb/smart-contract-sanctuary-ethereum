    ...
    ITGE
{
    ...
    function redeem() external override onlyState(State.Failed) nonReentrant {
        ...
        require(purchaseOf[msg.sender] > 0, ExceptionsLibrary.ZERO_PURCHASE_AMOUNT);
        ...
        uint256 balanceToRedeem = MathUpgradeable.min(token.minUnlockedBalanceOf(msg.sender), purchaseOf[msg.sender]);
