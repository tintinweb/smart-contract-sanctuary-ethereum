...
contract OrigamasksBlock is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    ...
    function mintBlocks(
        ...
        if (msg.sender != secondKitAddress) revert NotAuthorized();
    ...
    function setSecondKitAddress(address newAddress_) public onlyOwner {
        secondKitAddress = newAddress_;
    }
