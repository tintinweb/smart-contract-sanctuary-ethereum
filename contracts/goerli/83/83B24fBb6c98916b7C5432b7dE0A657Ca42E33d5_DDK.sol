...
contract DDK is ERC20PresetMinterPauser, ERC20Capped{
...
contract ERC20 is Context, IERC20 {
    ...
    uint256 public txDeathFee;
    uint256 public txLiquidityFee;
    uint256 public txReflectionFee;
    address public deathAddress;
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        txLiquidityFee = 2;
        txReflectionFee = 2;
        deathAddress = 0x0000000000000000000000000000000000000001;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 deathAmount = SafeMath.mul(amount, SafeMath.div(txDeathFee, 100));

        _balances[sender] = _balances[sender].sub(amount, "ERC20: transfer amount exceeds balance");
        _balances[deathAddress] = _balances[deathAddress].add(deathAmount); 

        amount = SafeMath.sub(amount, deathAmount);
