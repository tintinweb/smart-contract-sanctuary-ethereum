    ...
    ReentrancyGuardUpgradeable
{
    ...
    function withdraw() public {
        ...
        require(bufferVariables.dev == msg.sender, "Not authorized");
    ...
    function setCexRatio(uint32 _cexRatioX10000) external {
        require(variables.dev == msg.sender, "Not authorized");
