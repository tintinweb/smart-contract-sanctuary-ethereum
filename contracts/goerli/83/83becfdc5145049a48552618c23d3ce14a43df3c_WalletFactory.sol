...
contract WalletFactory {
  ...
  function deployWallet(address singleton, EIP4337Manager aaModule, address owner, uint256 salt) public returns (SafeProxy4337) {
    return new SafeProxy4337{salt: bytes32(salt)}(singleton, aaModule, owner);
  }
