...
contract Streamer is Ownable {
    ...
    */
    function challengeChannel() public {
        require(balances[msg.sender] > 0, "caller has no open channel");
        canCloseAt[msg.sender] = block.timestamp + 180;
    ...
    */
    function defundChannel() public payable {
        require(canCloseAt[msg.sender] > 0, "caller doesnt have closing channel");
        require(canCloseAt[msg.sender] <= block.timestamp, "challenge period not over");
