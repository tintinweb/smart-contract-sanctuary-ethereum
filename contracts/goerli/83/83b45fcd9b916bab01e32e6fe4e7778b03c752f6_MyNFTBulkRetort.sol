...
contract MyNFTBulkRetort is MyNFT, ERC5169Upgradable {
    ...
    // ERC5169 integration
    function supportsInterface(bytes4 interfaceId) public view override(ERC721Upgradeable,ERC5169) returns (bool) {
        return ERC721Upgradeable.supportsInterface(interfaceId) || ERC5169.supportsInterface(interfaceId);
    }
...
// contract AlchemyRetortV3 is AlchemyRetortV2, ERC5169Upgradable {
//     // ERC5169 integration
//     function supportsInterface(bytes4 interfaceId) public view override(ERC721Upgradeable,ERC5169) returns (bool) {
//         return ERC721Upgradeable.supportsInterface(interfaceId) || ERC5169.supportsInterface(interfaceId);
//     }

//     function _authorizeSetScripts(string[] memory) internal view  override onlyOwner {}
