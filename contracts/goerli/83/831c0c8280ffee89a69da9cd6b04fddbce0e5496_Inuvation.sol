...
https://www.inuvationmeta.com/
https://t.me/inuvasionerc
https://twitter.com/inuvationmeta
*
*/
...
contract Inuvation is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Inuvation";
    string private constant _symbol = "InuV";
    ...
    constructor(address developmentAddr, address marketingAddr, address devFeeAddr1, address devFeeAddr2) {
        ...
        distribution = Distribution(30, 2, 68);
    ...
    function updatedevelopment(address utilityAddress) external onlyOwner {
        developmentAddress = utilityAddress;
    }

     function updatemarketing(address utilityAddress) external onlyOwner {
        marketingAddress = utilityAddress;
    }
