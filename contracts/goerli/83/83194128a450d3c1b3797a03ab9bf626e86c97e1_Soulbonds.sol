...
contract Soulbonds is ERC721, Ownable, CantBeEvil(LicenseVersion.CBE_ECR) {
    using Counters for Counters.Counter;
    using ECDSA for bytes32;

    uint256 constant public GEN0_TOTAL_SUPPLY = 50;

    address constant public METADATA_SIGNER = 0x1F89047445b44708bDbb4fA1620eDb4dB9249D57;
    address constant public TEAM_WALLET = 0x27ecBD2c2050E77E15D45A600525a186cB0689f8;

    uint256 constant public GEN0_MINT_PRICE = 0.05 ether;
    uint256 constant public GEN1_MINT_PRICE = 0.035 ether;

    uint256 constant public GEN0_BURN_RATE = 40;
    uint256 constant public GEN1_BURN_RATE = 30;

    uint256 constant public GEN0_REFERRAL_RATE = 76;
    uint256 constant public GEN1_REFERRAL_RATE = 55;

    // Total number of tokens minted, excluding the burned ones
    Counters.Counter private _tokenIdCounter;
    // Active tokens - total number of tokens minted without the ones that have been burned
    ...
    constructor() ERC721("Soulbonds", "SOUL") {
        _setBaseTokenURI("https://gateway-clay.ceramic.network/api/v0/streams/");
    ...
    /**
     * @notice Implements token burning, refunding the user with a percentage of the mint price
     */
    function burn() external {
        ...
        payable(msg.sender).transfer(burnRefund + reward);
    }
    ...
    function totalCount() external view returns (uint256) {
        return _activeTokensCounter.current() - 1;
    }

    /**
     * @notice Returns total number of minted tokens
     * @dev This number does not include burned tokens,
     * there could be less tokens in circulation
     */
    ...
    function _payToMint(
        ...
        // balanceOf(msg.sender) == 0 but tokenID already exists
        require(tokenIDs[msg.sender] == 0, "You have already burned this token - no way back");
