...
contract Retrogression is ERC721A, ERC2981, Ownable {
  ...
  constructor(
    ...
    uint256 _ogMaxMint, // 2
    uint256 _whiteListMaxMint, // 2
    uint256 _totalMaxSupply, // 5050
    uint256 _ogMaxSupply, // 555
    uint256 _whiteListMaxSupply, // 100
    uint256 _mintRate, // 0.98
    uint256 _whiteListMintRate, // 0.98
    address _royaltyReceiver,
    uint96 _feeNumerator // 1500 = 15%_ogMaxMint
