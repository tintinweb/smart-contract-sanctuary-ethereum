...
contract test2 is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public freeMintCount = 1;
    bool public mintActive;
    mapping (address => uint256) public walletPublic;


    constructor () ERC721A("Test2", "TEST2") {
        mintActive = false;
    }
    ...
    function Mint(uint256 numTokens) public payable {
        ...
        if (freeMintCount > 0) {
            require(msg.sender == msg.sender, "Free mints have been used.");
            freeMintCount--;
        } else {
