    ...
    ContextMixin
{
   ...
   /**
     ...
     * - `tokenId` must exist.
     */
    function setTokenURI(uint256 tokenId, string memory _tokenURI) public virtual only(DEFAULT_ADMIN_ROLE) {
    ...
    function setBaseURI(string memory uri) public virtual only(DEFAULT_ADMIN_ROLE) {
        baseTokenURI = uri;
    }
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721, AccessControl, IERC165, ERC721Enumerable) returns (bool) {
