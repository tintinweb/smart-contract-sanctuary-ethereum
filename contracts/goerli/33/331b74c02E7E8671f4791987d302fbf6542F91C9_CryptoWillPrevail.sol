    ...
    Ownable
{
        ...
        returns (address)
    {
        ...
        else return leaders[uint256(id)].addr;
    }
    ...
    function leadersCount() public view returns (uint256) {
...
contract ZZPass is DefaultOperatorFilterer, ERC721Enumerable, Ownable {
    ...
    function batchGetNFT(uint startIdx, uint count) public view returns(address[] memory) {
