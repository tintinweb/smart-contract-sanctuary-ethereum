...
// File: src/bonding-curves/CurveErrorCodes.sol
...
// File: src/bonding-curves/ICurve.sol
...
// File: src/lib/IOwnershipTransferCallback.sol
...
// File: src/lib/OwnableWithTransferCallback.sol
...
// File: src/ILSSVMPairFactoryLike.sol
...
contract LSSVMRouter {
    ...
    /**
        ...
        @return remainingValue The unspent token amount
     */
    function swapETHToWETHForSpecificNFTs(
        PairSwapSpecific[] calldata swapList,
        uint256 inputAmount,
        address nftRecipient,
        uint256 deadline,
