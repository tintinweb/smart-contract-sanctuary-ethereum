...
contract FactoryFair {
    event NewFairLaunch(address fairLaunch);
    ...
    function createPreSale(
        ...
        FairLaunch preSaleContract = new FairLaunch(_token);
        ...
        emit NewFairLaunch(address(preSaleContract));
    }
}
...
contract FairLaunch {
    ...
    function createPreSale(
        ...
        require(msg.sender == factoryContract, "Not Authorized");
        require(_token != address(0), "PreSale: token is the zero address");
    ...
    function addLiquidity() external payable {
        ...
        }(token, amount, 0, 0, sale.owner, block.timestamp + 1000);
