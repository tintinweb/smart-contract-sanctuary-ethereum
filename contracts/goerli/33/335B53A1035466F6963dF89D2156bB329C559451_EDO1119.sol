...
contract EDO1119 is ERC721A, Ownable {
    ...
    address public constant WITHDRAW_ADDRESS = 0x72055004578e5084F6F6581e652182a94865Bc40;
    ...
    constructor(
        ...
        _safeMint(0x1fa6096F902220528b42963a84D171e4de67aC85, 200);
        _safeMint(0x72055004578e5084F6F6581e652182a94865Bc40, 10);
        setMerkleRoot(0x2776da08384c34d3f29e8c99edc0942674549ebba68ca6b1527065daa1574d90);
    }
    ...
    function _baseURI() internal view virtual override returns (string memory) {
      ...
      function mint(uint256 _mintAmount , uint256 _maxMintAmount , bytes32[] calldata _merkleProof) public payable callerIsUser{
          ...
          if(freeMint == true) {
              ...
              require(_mintAmount <= whitelistMaxMintAmountPerAddress - whitelistMintedAmount[msg.sender] , "user is not whitelisted");
              if(mintCount == true){
