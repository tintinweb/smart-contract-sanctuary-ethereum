...
contract SweepersAuctionHouse is ISweepersAuctionHouse, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function setSweepersToken(address _sweepers) external override onlyOwner {
        sweepers = ISweepersToken(_sweepers);
    }
...
interface ISweepersAuctionHouse {
    ...
    function setSweepersToken(address _sweepers) external;
