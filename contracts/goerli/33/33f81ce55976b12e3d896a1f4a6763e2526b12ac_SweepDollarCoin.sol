...
contract SweepDollarCoin is BaseSweep {
     ...
     * Period_start is reset by setting the period time.
     * @param _period_time.
     */
     ...
     * @param _new_interest_rate Interest rate.
     */
     ...
     */
    function setUniswapOracle(address _uniswap_oracle_address)
        public
        onlyOwner
    {
    ...
    */
    ...
    /**
     * @notice Reset Target Price
     * @param _amm_price Sweep Price that comes from UniswapV3TWAPOracle.
     */
    function refreshTargetPrice(uint256 _amm_price) public onlyMinters {
        previous_target_price = current_target_price;
