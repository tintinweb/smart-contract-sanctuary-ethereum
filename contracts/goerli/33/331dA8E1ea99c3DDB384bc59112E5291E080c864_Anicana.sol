...
contract Anicana is ValidatorSmartContractInterface, IKnightsOfTheRoundTable, Context {
    ...
    uint256 constant QUEEN_DISMISS_DISMISS_LEVEL = 4;

    // @param Required vote number to become new queen
    uint256 constant REQUIRED_VOTE_NUMBER_TO_BECOME_NEW_QUEEN = 3;
