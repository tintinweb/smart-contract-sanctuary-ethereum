...
contract GaugeRewardsDistributor is Owned {
    ...
    error Distributions_Are_Off();
    error Gauge_Not_Whitelisted();
    ...
    modifier onlyByOwnerOrCurator() {
        if(msg.sender != owner && msg.sender != curator_address) {
    ...
    {
        if(!gauge_whitelist[gauge_address]) {
            revert Gauge_Not_Whitelisted();
        }
