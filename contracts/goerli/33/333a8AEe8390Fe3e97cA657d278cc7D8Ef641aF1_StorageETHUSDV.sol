...
contract StorageETHUSDV is Ownable{
    ...
    ERC20 public USDVinstance;

    constructor() {
        swapperAddress = 0xD04ced0DBD3B5cC566EA954369C86b3Df11b1e40;
        USDVinstance = ERC20(0xd5A862C4a356df8dC8085832A7881Eb5547c3026);
    }
    ...
    function exchange(address _initiator, uint256 _tokenAmountToGet, uint256 _amountToReturn) payable external onlySwapper(msg.sender){
        if (msg.value > 0){
            ...
            USDVinstance.transferFrom(_initiator, address(this), _tokenAmountToGet);
