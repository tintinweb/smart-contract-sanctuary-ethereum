...
contract ConciergeGCC is Ownable, ReentrancyGuard {
    ...
    address erc20Contract = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F; // USDC goerli testnet
    ...
    constructor() {
        if (block.chainid == 1) {
            ...
            // goerli
            gccNftAddress = 0x24F0b4836Ce356Fcd0D65058c65dcB12aE8aE3be;
        }
    ...
    /// @param price The price paid for the token
