...
contract TestRaoToken is Context, IERC20, Ownable {
    ...
    uint256 public totalFee = taxFee.add(liquidityFee).add(treasuryFee);
    ...
    /// @notice Defines the permission to conduct operations
    ...
    constructor(
        ...
        maxTxAmount = ((_tTotal * 5) / 1000) * 10 ** _decimals;
