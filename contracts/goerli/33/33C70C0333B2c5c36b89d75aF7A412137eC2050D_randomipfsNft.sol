...
contract randomipfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    ...
    // VRF helper
    mapping(uint => address) public s_requestIsToSender;
    ...
    constructor(
        ...
        uint256 mintFee
    ) VRFConsumerBaseV2(vrfCordinatorV2) ERC721("Random Ipfs Nft", "RIN") {
    ...
    function requestNft() public payable returns (uint256 requestId) {
        ...
        s_requestIsToSender[requestId] = msg.sender;
    ...
    function fulfillRandomWords(
        ...
        address nftOwner = s_requestIsToSender[_requestId];

        uint256 moddedRange = _randomWords[0] % MAX_CHANCE_VALUE;
        Breed dogBreed = getBreedFroModdedRange(moddedRange);
    ...
    function getBreedFroModdedRange(uint256 moddedRange) public pure returns (Breed) {
