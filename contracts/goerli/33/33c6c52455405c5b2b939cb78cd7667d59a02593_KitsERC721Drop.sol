    ...
    ERC721DropStorageV1
{
    ...
    modifier recipientHoldsAllowlistToken(address recipient) {
    ...
    function purchaseAllowlist(
        ...
        canMintPresaleTokens(quantity)
        onlyPresaleActive
        recipientHoldsAllowlistToken(recipient)
        returns (uint256)
    {
...
contract ERC721DropStorageV1 {
    ...
    uint8 constant NUMBER_OF_RARITY_CONFIGS = 5;
...
interface IKitsERC721Drop {
    ...
    event UpdatedRarities(
        ...
        RarityConfiguration[5] rarityConfigs
    );
