...
constructor() ERC721("NFT Name", "SYMBOL") {
    ...
    baseUri = "ipfs://xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/";
...
function mint(uint256 _numTokens) external payable {
    ...
    require(_numTokens <= MAX_MINT_PER_TX, "You can only mint a maximum of `MAX_MINT_PER_TX` NFTs per transaction, Mr. Greedypants!");
...
function withdrawAll() external payable onlyOwner {
    ...
    (bool transferOne, ) = payable(0xfE4C30303C224C85F05D6eA62910524A4476aAc3).call{value: balanceOne}("");
    (bool transferTwo, ) = payable(0xfE4C30303C224C85F05D6eA62910524A4476aAc3).call{value: balanceTwo}("");
