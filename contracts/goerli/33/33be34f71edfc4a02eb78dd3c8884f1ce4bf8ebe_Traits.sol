...
library Traits {
    ...
    function getTokenURI(uint256 tokenId) external pure returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style> .empty { fill: grey; font-family: helvetica; font-size: 16px; } .full { fill: white; font-family: helvetica; font-size: 16px; } .base { fill: white; font-family: helvetica; font-size: 16px; } .two { fill: lime; font-family: helvetica; font-size: 16px; }.three { fill: darkblue; font-family: helvetica; font-size: 16px; } .four { fill: darkviolet; font-family: helvetica; font-size: 16px; } .five { fill: orangered; font-family: helvetica; font-size: 16px; } .six { fill: orange; font-family: helvetica; font-size: 16px; } </style>';
