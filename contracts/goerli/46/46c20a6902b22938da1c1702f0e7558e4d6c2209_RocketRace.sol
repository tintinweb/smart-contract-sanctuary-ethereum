...
contract RocketRace is Ownable {
    ...
    mapping(uint256 => mapping(uint256 => uint256)) public rocketRaceInfo;
    ...
    function deposit(uint256 _raceID,uint256 _rocketID, uint256 _blockTime, uint8 _V, bytes32 _R, bytes32 _S) external payable{
        require(rocketRaceInfo[_raceID][_rocketID] == 0,"already deposited");
        ...
        rocketRaceInfo[_raceID][_rocketID] = msg.value;
