...
contract Vision is ERC721, ERC721Enumerable, Ownable {
    string public constant R =
        "You miss 100% of the shots you don't take. - Marcus Shreklius";
    ...
    constructor() ERC721("Vision1", "VIS1") {}
    ...
    // Mint new token(s)
    function mintVision(uint8 _quantityToMint) public payable {
