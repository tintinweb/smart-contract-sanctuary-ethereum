    ...
    PaymentSplitter
{
    ...
    mapping(uint => bool) public claimInfo;
    mapping(uint => address) public claimInfoAddress;
    ...
    function claimLand(
        ...
        require(
            totalSupply() + _fluffToken.length / 3 <= MAX_SUPPLY,
            "Max supply exceeded"
        );
        ...
        _safeMint(msg.sender, _fluffToken.length / 3);
    }
