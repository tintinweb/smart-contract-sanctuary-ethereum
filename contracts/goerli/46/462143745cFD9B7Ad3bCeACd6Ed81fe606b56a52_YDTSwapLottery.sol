...
contract YDTSwapLottery is ReentrancyGuard, IYDTSwapLottery, Ownable {
     ...
     */
    constructor(address _YDTtokenAddress, address _RYDTtokenAddress, address _randomGeneratorAddress) {
        YDTtoken = IERC20(_YDTtokenAddress);
        RYDTtoken = IERC20(_RYDTtokenAddress);
    ...
    function claimTickets(
        ...
        RYDTtoken.safeTransfer(msg.sender, rewardInYDTToTransfer);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override {
        ...
        RYDTtoken.safeTransferFrom(address(msg.sender), address(this), _amount);
