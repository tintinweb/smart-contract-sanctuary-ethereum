...
contract IG is ERC721Enumerable, ERC2981, Ownable {
    ...
    */
    ...
    function _setDefaultRoyalty(address _artist, uint96 _royaltyFee) internal virtual override {
        require(_royaltyFee <= _feeDenominator(), "ERC2981: royalty fee will exceed salePrice");
        require(_artist != address(0), "ERC2981: invalid receiver");

        _defaultRoyaltyInfo = RoyaltyInfo(_artist, _royaltyFee);
    }
