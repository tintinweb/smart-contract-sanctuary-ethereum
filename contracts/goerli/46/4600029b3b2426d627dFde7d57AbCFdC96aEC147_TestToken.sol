...
interface IAddressPool {
    ...
    function useVault(string memory chain, string memory vaultAddress) external;
...
//    }
    ...
    function getAvailableVault(string memory chain_) external view override returns (string memory vaultAddress) {
    ...
    function useVault(string memory chain_, string memory vaultAddress_) external override onlyOwner {
        ...
        emit UsingVault(chain_, vaultAddress_);
    }
...
contract TestToken is Ownable, ERC20Burnable, ERC20Pausable {
