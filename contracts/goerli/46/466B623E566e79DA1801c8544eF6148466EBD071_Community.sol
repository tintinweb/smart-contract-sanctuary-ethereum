...
contract Community is AccessControl {
    ...
    // calculate time in second like 24hrs, 60min, 60 second
    uint256 timInSecond = 600;
    ...
    function endTime(uint256 commId) external onlyOwner {
        ...
        uint256 completeTime = _startTime + ((_cliff + _vested) * timInSecond);
