...
ReentrancyGuard
{
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        if (block.timestamp < mintStartAt) {
            ...
            if (whitelist[_msgSender()]) {
                currentPrice = quantity * mintWLPrice;
                require(mintCount[_msgSender()] <= maxQuantityPerMint, "Mint quantity limit 5 per address");
            }
        } else {
