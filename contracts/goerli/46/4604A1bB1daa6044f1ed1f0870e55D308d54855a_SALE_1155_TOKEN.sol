...
contract SALE_1155_TOKEN is ERC1155Burnable, ERC2981, ReentrancyGuard, Ownable, DefaultOperatorFilterer {
    string private _baseTokenURI =
        "https://sound-desert-upload-test.s3.ap-northeast-1.amazonaws.com/nft_assets/goerli/0x0E8Bf65970739724969a6c2cdbfe8AE1DffCB1c9/";
    ...
    function ownerMint(uint256 _tokenId, uint256 _quantity, address _address) public onlyOwner nonReentrant {
        require(
            maxSupply[_tokenId] >= totalSupply[_tokenId] + _quantity,
            "maxSupply over."
        );
