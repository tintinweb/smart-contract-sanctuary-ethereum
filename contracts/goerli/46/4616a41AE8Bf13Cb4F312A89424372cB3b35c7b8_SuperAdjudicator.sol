...
contract SuperAdjudicator {
  ...
  // XXX: changed this event signature!!!
  event Appealed(
  ...
  uint256 public bountySize; // in wei
  ...
  function enactRuling(uint256 disputeId) external {
    ...
    ); // XXX: is memory zero by default in solidity?
    ...
    _appeal.profileId = 0; // mark the appeal as handled
