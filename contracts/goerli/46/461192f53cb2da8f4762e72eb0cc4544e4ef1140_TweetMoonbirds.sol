...
// File: contracts/TweetMoonbirds.sol
...
contract TweetMoonbirds is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  mapping (address => bool) public team;
   ...
   constructor(
    ...
    string memory _initHiddenMetadatadURI
  ) ERC721A(_name, _symbol) {
    setBaseURI(_initBaseURI);
    setHiddenMetadataUri(_initHiddenMetadatadURI);
  }
