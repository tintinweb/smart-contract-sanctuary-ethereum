...
contract NeonTigerSocietyFunding {
    ...
    constructor(address _stakingToken, address _rewardToken,  address _feeAddress) {
        owner = msg.sender;
    ...
    function setPOSToken(address _posToken) external onlyOwner {
