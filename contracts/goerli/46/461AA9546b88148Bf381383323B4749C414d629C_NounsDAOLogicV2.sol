...
/// @title The XNouns DAO logic version 2
...
// max quorum votes using the current XNoun supply.
...
contract NounsDAOLogicV2 is NounsDAOStorageV2, NounsDAOEventsV2 {
    ...
    string public constant name = 'XNouns DAO';
    ...
    /**
     * @notice Current proposal threshold using XNoun Total Supply
     ...
     * @param totalSupply The total supply of XNouns at the time of proposal creation
    ...
    /**
     * @notice Current min quorum votes using XNoun total supply
     */
    ...
    /**
     * @notice Current max quorum votes using XNoun total supply
     */
...
//
// MODIFICATIONS
// NounsDAOEvents, NounsDAOProxyStorage, NounsDAOStorageV1 add support for changes made by XNouns DAO to GovernorBravo.sol
...
contract NounsDAOStorageV1 is NounsDAOProxyStorage {
    ...
    /// @notice The address of the XNouns DAO Executor NounsDAOExecutor
