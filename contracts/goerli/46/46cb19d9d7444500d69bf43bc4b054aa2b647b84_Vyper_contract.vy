...
@external
@pure
def to_eth_signed_message_data(data: String[32], lenData: String[2]) -> bytes32:
    _ethMessage: String[32] = concat("\x19Ethereum Signed Message:\n", lenData)
    return keccak256(concat(_ethMessage, data))