...
import "../../contracts/test/CyOpProtocol.sol";
...
contract $CyOpProtocol is CyOpProtocol {
    constructor(address _treasury1, address _treasury2) CyOpProtocol(_treasury1, _treasury2) {}

    function $manualsend() external {
        return super.manualsend();
    }
