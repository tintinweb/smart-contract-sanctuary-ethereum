...
import {ONE_DAY, PPT_DIVISOR} from "./Constants.sol";

/**
 * @title HomeFi v0.2.5 HomeFi Contract.
    ...
    ERC2771ContextUpgradeable
{
    ...
    modifier nonEqual(address _oldAddress, address _newAddress) {
        ...
        nonZero(_tokenCurrency3)
    {
        ...
        require(lenderFee < PPT_DIVISOR, "HomeFi::invalid lenderFee");

        // Initialize variables
        admin = msg.sender;
        emit AdminReplaced(admin);
        treasury = _treasury;
        lenderFee = _lenderFee; // the percentage must be multiplied by 10
    ...
    function proposeAdminReplace(address _newAdmin)
        ...
        onlyAdmin
        nonZero(_newAdmin)
        nonEqual(proposedAdmin, _newAdmin)
    {
    ...
    function replaceTreasury(address _newTreasury)
        ...
        nonEqual(treasury, _newTreasury)
    {
        // Replace treasury
    ...
    function replaceLenderFee(uint256 _newLenderFee)
        ...
        onlyAdmin
    {
        // Lender fee must be lesser than PPT_DIVISOR
        require(_newLenderFee < PPT_DIVISOR, "HomeFi::invalid lenderFee");
    ...
    function replaceTrustedForwarder(address _newForwarder)
        ...
        payable
        onlyAdmin
        nonEqual(trustedForwarder, _newForwarder)
    {
    ...
    /// @inheritdoc IHomeFi
    function validCurrency(address _currency) public view {
...
interface IHomeFi {
     ...
     * for example: for 1% lender fee, pass the amount 10.
     */
    function replaceLenderFee(uint256 _lenderFee) external payable;
