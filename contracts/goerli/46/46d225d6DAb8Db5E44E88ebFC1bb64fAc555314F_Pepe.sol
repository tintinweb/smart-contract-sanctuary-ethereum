...
contract Pepe is ERC721A, ReentrancyGuard, Ownable, ERC2981 {
    ...
    uint256 public WL_SUPPLY = 60;
    function setConfigWL(uint256 _count) external onlyOwner {
	WL_SUPPLY = _count;
    }
    uint256 public OG_SUPPLY = 10;
    function setConfigOG(uint256 _count) external onlyOwner {
	OG_SUPPLY = _count;
    }
    ...
    uint256 public PRICE = 1500000000000000;
    function setPRICE(uint256 _price) external onlyOwner {
	PRICE = _price;
    }
    uint256 public PRICE_WL = 800000000000000;
    function setPRICE_WL(uint256 _price) external onlyOwner {
	PRICE_WL = _price;
    }
    uint256 public PRICE_OG = 800000000000000;
