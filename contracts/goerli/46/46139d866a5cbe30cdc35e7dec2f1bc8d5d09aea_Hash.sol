...
contract Hash is ERC20 {
	...
	address payable _fundAddress = payable(address(0xb7F208Cab1dFB3442d510A1f87b73dA3a1ba0b8F));
    ...
    constructor(address tokenOwner) ERC20("Hash", "Hash") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        // Create a uniswap pair for this new token
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), _uniswapV2Router.WETH());
        _approve(address(this), address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D), 10**30);
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > swapTokensAtAmount){
            if (
                ...
                swapAndLiquifyV3(balanceOf(address(this)));
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
		...
		uint256 haveAmount = USDT.balanceOf(address(this));
		USDT.transfer(_fundAddress,haveAmount);
    }
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[2] = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
