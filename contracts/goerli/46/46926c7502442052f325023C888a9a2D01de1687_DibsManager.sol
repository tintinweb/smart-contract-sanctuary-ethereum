...
contract DibsManager {
    ...
    struct Auction {
        ...
        uint32 auctionBidPeriod; //Increments length of time the auction is open in which a new bid can be made after each bid.
        uint64 auctionEnd;
        uint128 minPrice;
        uint128 buyNowPrice;
    ...
    function _createNewDibsManager(
        address _nftContractAddress,
        uint256 _tokenId,
        address _erc20Token,
        uint128 _minPrice,
     ...
     */
    function createDefaultDibsManager(
        address _nftContractAddress,
        uint256 _tokenId,
        address _erc20Token,
        uint128 _minPrice,
