...
//  .----------------.  .----------------.  .----------------.   .-----------------. .----------------.  .----------------. 
// | .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. |
// | |  _________   | || |    _______   | || |  _________   | | | | ____  _____  | || |  _________   | || |  _________   | |
// | | |  _   _  |  | || |   /  ___  |  | || | |  _   _  |  | | | ||_   \|_   _| | || | |_   ___  |  | || | |  _   _  |  | |
// | | |_/ | | \_|  | || |  |  (__ \_|  | || | |_/ | | \_|  | | | |  |   \ | |   | || |   | |_  \_|  | || | |_/ | | \_|  | |
// | |     | |      | || |   '.___`-.   | || |     | |      | | | |  | |\ \| |   | || |   |  _|      | || |     | |      | |
// | |    _| |_     | || |  |`\____) |  | || |    _| |_     | | | | _| |_\   |_  | || |  _| |_       | || |    _| |_     | |
// | |   |_____|    | || |  |_______.'  | || |   |_____|    | | | ||_____|\____| | || | |_____|      | || |   |_____|    | |
// | |              | || |              | || |              | | | |              | || |              | || |              | |
// | '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' |
//  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------' 
//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x827a8157393C6e2510673D8BbF34d5150B686109];
  address public erc20Payable = 0x827a8157393C6e2510673D8BbF34d5150B686109;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicrgwzptzljyohpjga4p7ivkhip4ul4kypydsnz22qgfqbdtcom2e/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/7Pv9KnlknOsMbCkCI89k/contract-metadata";
  }
