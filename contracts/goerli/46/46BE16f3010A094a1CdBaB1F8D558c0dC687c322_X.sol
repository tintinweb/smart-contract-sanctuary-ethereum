...
contract X is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public milkListSalePrice = 0.018 ether;
    uint256 public reserveListSalePrice = 0.022 ether;
    ...
    constructor(string memory _baseURI, uint256 _maxCats) ERC721("x", "x") {
        baseURI = _baseURI;
        maxCats = _maxCats;
    }
