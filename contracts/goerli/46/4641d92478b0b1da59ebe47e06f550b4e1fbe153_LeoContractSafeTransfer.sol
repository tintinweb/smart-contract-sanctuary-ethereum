...
contract LeoContractSafeTransfer is ERC721A, ReentrancyGuard, Ownable, Pausable {
    ...
    address private signerAddress = 0x637f2BBE663a3d4e286f4dF554906EDce1d7a474;
    ...
    function withdrawAll() external onlyOwner {
        ...
        require(payable(0x637f2BBE663a3d4e286f4dF554906EDce1d7a474).send(balance));
    }
}
