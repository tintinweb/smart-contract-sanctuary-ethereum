...
contract Zep is Context, ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public DividendsToken = address(0xddBB3a280D140Fb1241885857497A2E1d1A596Ac);

    bool private swapping;
    bool private trading;
    bool public burning;

   ZepDevDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Zep Threat", "ZT") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 2;
        _buyMarketingFee = 6;
        _buyDevFee = 2;
        ...
        dividendTracker = new ZepDevDividendTracker();

        liquidityWallet = owner();
        
        marketingWallet = payable(0xE8DEB4B036cfC1193c71e56654F3A7A14A1130D3);
        _devWallet = payable(0xE0640a8501361b522C6fF096Fc1495686b742950);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "ZepDev: The dividend tracker already has that address");

        ZepDevDividendTracker newDividendTracker = ZepDevDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ZepDev: The new dividend tracker must be owned by the Zep Threat token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "Zep Threat: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Zep Threat: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Zep Threat: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Zep Threat: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Zep Threat: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Zep Threat: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Zep Threat: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "Zep Threat: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Zep Threat: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Zep Threat: Cannot update gasForProcessing to same value");
...
contract ZepDevDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("ZepDev_Dividend_Tracker", "ZepDev_Dividend_Tracker") {
        claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "ZepDev_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Zep Threat contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "ZepDev_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "ZepDev_Dividend_Tracker: Cannot update claimWait to same value");
