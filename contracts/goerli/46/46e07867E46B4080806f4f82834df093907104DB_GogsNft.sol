...
contract GogsNft is ERC721A, Ownable {
    ...
    string[] private tpfsToken;

    constructor(string memory _baseURL) ERC721A("DOG NFT", "DNFT") {
        baseURI = _baseURL;
    }
    ...
    function freeMint(bytes32[] calldata _data) public {
        require(freesale, "free sale is not started!");
    ...
    function allowMint(uint256 _qty, bytes32[] calldata _data) public payable {
        require(allowsale, "Allow list sale is not started!");
    ...
    function setIpfs(string[] memory _IpfsURI) external onlyOwner {
        tpfsToken = _IpfsURI;
    }
