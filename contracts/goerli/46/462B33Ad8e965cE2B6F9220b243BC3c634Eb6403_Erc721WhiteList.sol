...
import "./security/ReentrancyGuard.sol"; //防止重入攻击
import "./erc20/IERC20.sol";

//import "hardhat/console.sol"; //增加数据控制台


//如果需要验证合约 需要先在配置文件中配置好 API KEY
//yarn hardhat verify 0x0001 --network goerli
...
contract Erc721WhiteList is ERC721URIStorage, ReentrancyGuard,Ownable{
  ...
  //10,5000,"0xBBa535a0939705e95064749f70990C86334E2b29",utils.parseEther('10'),utils.parseEther('1'),"erc721test","test","http://nft.a111a123.club/process?type=nft&id="
  ...
  constructor(
    ...
    //add Whitelist
    /*
    addToWhitelist(0x1C8Ec996420DB47C0859A5AAed0148Fd23426bBf);
    addToWhitelist(0xEC58b14bEa51362454E3da9307Ba415D4BED3D6A);
    addToWhitelist(0xfC004E9052Fd1740A662Fac99c61C9cC73D41Db8);
    addToWhitelist(0xE5A9748caB1A4A5756563C0Eb4a281A9345e0acD);
    addToWhitelist(0x4895F244Da1Ed321BE86444C6E644a0e57499B8c);
    */
  }
  ...
  function whiteMint(uint256 _usdtAmount,bytes32[] calldata proof) public  onlyWhiteMinted {
  ...
  function buyMint(uint256 _usdtAmount) public onlyBuy {
  ...
  //add whitelist
  /*
  function addToWhitelist() public payable nonReentrant{
    ...
    emit DebugMsg("addToWhitelist",address(msg.sender),"",whitelistedNumber);
  ...
  /*  
  function addToWhitelist(address addr) internal{

    //emit DebugMsg("addToWhitelist",addr,"",whitelistedNumber);
