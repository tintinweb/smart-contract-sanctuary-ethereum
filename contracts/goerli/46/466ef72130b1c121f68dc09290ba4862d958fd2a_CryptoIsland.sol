...
contract CryptoIsland is ERC20, Ownable {
    ...
    address public liquidityWallet = 0xdf27F4CCA1560e6BC4A9180a26137455790A7FE3;
    address public projectWallet   = 0xdf27F4CCA1560e6BC4A9180a26137455790A7FE3;
    ...
    constructor () ERC20("Crypto Island", "CISLA") 
    {   
        transferOwnership(0xdf27F4CCA1560e6BC4A9180a26137455790A7FE3);
    ...
    function updateBuyFees(
        ...
        _totalFeesOnBuy   = liquidityFeeOnBuy + _projectFeeOnBuy;
    ...
    function _transfer(
        ...
        if (swapEnabled &&
            ...
            {   
                ...
                sendETH(payable(projectWallet), projectETH);
            }
