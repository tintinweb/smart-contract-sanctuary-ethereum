...
//----------------------------------------
   ...
   //public register  roundTime 7
    ...
    //round8
    function voucherRegisterWithConfig(string calldata name, address[] calldata  ora,uint8 v, bytes32 r, bytes32 s,uint amount,uint nonce) external payable { // ora:address owner,address resolver, address addr
        //require(timeBegin(roundTime[6].begin,roundTime[6].end,true),"time limit");
        require(available(name,false),"name unavailable");
        //require(!isLimit(name,msg.sender),"limit"); //reserve
    ...
    //round9
    function channelRegisterWithConfig(string calldata name, address[] calldata  ora,string calldata channelId) external payable { // ora:address owner,address resolver, address addr
