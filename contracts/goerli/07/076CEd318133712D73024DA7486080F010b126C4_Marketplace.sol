    ...
    IERC1155ReceiverUpgradeable
{
     ...
     * @param auctionId id of the auction
     */
    event AuctionNFTFulfilled(uint256 indexed auctionId, Auction auction);
     ...
     * @param auctionId id of the auction
     */
    event AuctionPaymentFulfilled(uint256 indexed auctionId, Auction auction);
    ...
    // Sales
    function createSale(CreateSale memory _params) external payable onlyListers {
    ...
    //Auctions
    function createAuction(CreateAuction memory _params) external payable onlyListers {
    ...
    function bid(uint256 _auctionId, uint256 _price) external payable {
        Auction memory auction = auctions[_auctionId];
        ...
        if (_price > auction.maximumPrice) {
            revert BidTooHigh();
        }
    ...
    function claimAuctionNFT(uint256 _auctionId) external {
        ...
        emit AuctionNFTFulfilled(_auctionId, auctions[_auctionId]);
    }
    ...
    function claimAuctionPayment(uint256 _auctionId) external {
        ...
        emit AuctionPaymentFulfilled(_auctionId, auctions[_auctionId]);
    }
