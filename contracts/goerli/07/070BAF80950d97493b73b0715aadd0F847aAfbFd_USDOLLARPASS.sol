...
contract USDOLLARPASS is ERC721, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("US DOLLAR PASS", "USD") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://profound-liger-66e846.netlify.app/";
    }
