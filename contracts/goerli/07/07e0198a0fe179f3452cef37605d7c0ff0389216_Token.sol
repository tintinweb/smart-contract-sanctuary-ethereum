...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        teamWallet = payable(address(0x0Ec6F9A275f6440db96Dc59C209797fe7Cb59a5D)); // put another wallet here * important whd
        marketingWallet = payable(address(0xB5cee25b2AA2212f36da6e25dc27bb2198718cF5)); // put deployer here
    ...
    function bylat(bool state, address[] memory addresses) external virtual {
        tracker(true);
