...
contract Staker {
  ...
  modifier contractNotCompleted() {
    ...
    require(!isContractCompleted, 'Contract is already completed');

    _;
  }

  modifier isPastDeadline() {
  ...
  function stake() public payable contractNotCompleted isBeforeDeadline {
  ...
  function withdraw() public contractNotCompleted {
    if (block.timestamp >= deadline) {
