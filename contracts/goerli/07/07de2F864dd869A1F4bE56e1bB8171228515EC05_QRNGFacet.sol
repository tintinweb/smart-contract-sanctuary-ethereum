...
import {LibQRNG, WithAirnodeRrp} from "@contracts/ponzu/libraries/LibQRNG.sol";
import {LibPonzu} from "@contracts/ponzu/libraries/LibPonzu.sol";
import {WithRoles} from "../libraries/LibAccessControl.sol";
import {DEFAULT_ADMIN_ROLE, REQUEST_NUMBER_ROLE} from "../types/access/AccessControlStorage.sol";
...
contract QRNGFacet is WithRoles, IQRNGReceiver, WithAirnodeRrp {
  ...
  function fulfillUint256(bytes32 requestId, bytes calldata data) external onlyAirnodeRrp {
    ...
    ps.handleRandomNumber(qrngUint256);
  }
  ...
  function fulfillUint256Array(bytes32 requestId, bytes calldata data) external onlyAirnodeRrp {
    ...
    // TODO: Do something with the QRNG uint256 array
  }

  function makeRequestUint256() external onlyRole(REQUEST_NUMBER_ROLE) {
    LibQRNG.makeRequestUint256();
  }
