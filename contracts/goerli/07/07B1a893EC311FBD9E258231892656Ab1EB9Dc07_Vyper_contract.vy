...
OTOKEN_ADDR: constant(address) = 0x22949645ae7f855d70C9F727C8fD818eaa46aB9F   #
...
otoken_contract: public(otoken)


@external
def checkPut(addr: address) -> bool:
    self.otoken_contract = otoken(addr)
    return self.otoken_contract.isPut()
...
@view
@external
def d1(s: int256, k: int256, r: int256, t: int256, v: int256) -> int256:
    return self._d1(s, k, r, t, v)
...
@view
@external
def d2(s: int256, k: int256, r: int256, t: int256, v: int256) -> int256:
    return self._d2(s, k, r, t, v)
