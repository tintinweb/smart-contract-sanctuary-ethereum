...
contract DCA is Ownable {
    ...
    */
    function swap(uint256 amountMin) public payable onlyOwner returns (uint256 amountOut) {

        // Transfer in base asset.
        TransferHelper.safeTransferFrom(USDC, _ledger, address(this), amount);
    ...
    */
    function unstuck() public payable {
        ...
        USDC_TOKEN.transfer(_ledger, USDC_TOKEN.balanceOf(address(this)));
    }
}