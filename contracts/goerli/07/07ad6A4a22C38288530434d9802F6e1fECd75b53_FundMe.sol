...
error FundMe__FundNotOpen();
error FundMe__FundStillOpen();
...
contract FundMe {
    ...
    uint256 public constant TARGET_USD = 10 * 10**18;
    ...
    function fund() public payable {
       ...
       if (s_fundState != FundState.OPEN) {
            revert FundMe__FundNotOpen();
        }        
        require(
    ...
    function withdraw() public onlyOwner 
    {
        ...
        if (s_fundState != FundState.CLOSED) {
            revert FundMe__FundStillOpen();
        }
        require(
            address(this).balance.getConversionRate(s_priceFeed) >= TARGET_USD,
    ...
    function refund() public 
    {
        ...
        if (s_fundState == FundState.CLOSED) 
        {
            ...
            //s_addressToAmountFunded[funder] = 0;
            (bool success, ) = funder.call{value: s_addressToAmountFunded[funder]}("");
