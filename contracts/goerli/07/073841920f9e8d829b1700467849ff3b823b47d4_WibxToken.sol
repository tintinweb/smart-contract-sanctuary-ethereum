...
contract BCHHandled
{
    ...
    constructor(address bchAddress)
    {
...
contract Taxable is Ownable
{
    ...
    constructor(address taxRecipientAddr_)
    {
        _taxRecipientAddr = taxRecipientAddr_;
 ...
 */
contract WibxToken is ERC20Pausable, Taxable, BCHHandled
{
    /**
