...
import { MadEye } from "../dAgoraWizard/MadEye.sol";
import '../IdAgoraMembership.sol';

contract dAgoraMadEyeFactory is Ownable, ReentrancyGuard {
    MadEye moody;
        ...
        nonReentrant
    {
        ...
        _deployedContracts[msg.sender].ContractAddress.push(address(moody));
        _deployedContracts[msg.sender].Owner = msg.sender;
        _deployedContracts[msg.sender].moodyIndex = moodyCount;
        
        emit MadEyeMoodyCreated(
            address(moody),
            msg.sender,
            _addressDeployCount[msg.sender],
            moodyCount
