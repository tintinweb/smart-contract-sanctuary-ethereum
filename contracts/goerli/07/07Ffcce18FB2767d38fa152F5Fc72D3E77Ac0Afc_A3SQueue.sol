...
contract A3SQueue is IA3SQueue, Ownable {
    ...
    //Locking Period: in seconds, default is , might be updated in future
    ...
    function _jumpToTail(address _addr) internal {
        ...
        require(addressNode[_addr].stat == A3SQueueHelper.queueStatus.INQUEUE, "A3S: invalid queue status - must be inqueue to jump");
        ...
        emit JumpToTail(_addr, headIdx, tailIdx, curQueueLength, _payment, token);
    }
}
