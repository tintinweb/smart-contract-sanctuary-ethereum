...
contract FlashLoan is FlashLoanSimpleReceiverBase {
    ...
    address private constant USDC = 0xA2025B15a1757311bfD68cb14eaeFCc237AF5b43;
    address private constant WETH = 0x2e3A2fb8473316A02b8A297B982498E661E1f6f5;
    ...
    function executeOperation(
        ...
        IERC20(fromToken).approve(address(UNISWAP_ROUTER), MAX_INT);
        IERC20(USDC).approve(address(UNISWAP_ROUTER), MAX_INT);
        IERC20(fromToken).approve(address(UNISWAP_FACTORY), MAX_INT);
        IERC20(USDC).approve(address(UNISWAP_FACTORY), MAX_INT);
        ...
        require(amountOwed >= trade2Acquired, "not sufficieant balance");
