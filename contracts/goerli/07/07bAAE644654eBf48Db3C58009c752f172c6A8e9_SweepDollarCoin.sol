...
contract SweepDollarCoin is BaseSweep {
    ...
    // Constants
    uint256 public constant GENESIS_SUPPLY = 10000e18; // 10K SWEEP (only for testing). This is to help with establishing the Uniswap pools, as they need liquidity
    ...
    /**
     * @notice Begin New Period
     * @param _interest_rate.
     * @param _current_target_price.
     * @param _next_target_price.
     */
    function beginNewPeriod(uint256 _interest_rate, uint256 _current_target_price, uint256 _next_target_price) public onlyOwnerOrBalancer {
        require(
            block.timestamp - period_start >= period_time,
            "Must wait for the period time since previos period"
        );
