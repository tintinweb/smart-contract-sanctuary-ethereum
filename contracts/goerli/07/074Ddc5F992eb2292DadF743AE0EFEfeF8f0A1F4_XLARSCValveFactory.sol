...
contract XLARSCValveFactory {
    ...
    function createRSCValve(
        ...
        address payable [] calldata _initialRecipients,
...
contract XLARSCValve is Initializable, OwnableUpgradeable {
    ...
    // Throw when auto distribution is enabled
    error EthAutoDistributionEnabledError();
    ...
    function redistributeEth() external onlyDistributor {
        if (autoEthDistribution) {
            revert EthAutoDistributionEnabledError();
        }
