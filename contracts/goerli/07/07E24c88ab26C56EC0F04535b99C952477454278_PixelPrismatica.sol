...
contract PixelPrismatica is StandardContract, IERC1155MetadataURI, IERC2981 {
    ...
    */
    ...
    /// @notice Returns the animation duration of the NFT in seconds.
    /// @param _id The ID of the NFT.
    /// @return The animation duration of the NFT in seconds.
    function get_duration(uint256 _id) external view returns (uint256) {
        return getDuration(_id);
    }
