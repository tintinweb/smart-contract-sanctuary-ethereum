// TO TEST: PLACE THIS FILE INSIDE OF CONTRACT FOLDER
...
contract OnChainKevinRenderer is ERC721Enumerable, ReentrancyGuard {
    ...
    uint256 private constant MAX_PER_MINT = 2000;
...
*/
    ...
    function isPublicSaleOpen() public view returns (bool) {
        return _tokenIds.current() >= FREE_EARLY_RESERVE_AMOUNT && _tokenIds.current() < MAX_KEVINS;
    }
