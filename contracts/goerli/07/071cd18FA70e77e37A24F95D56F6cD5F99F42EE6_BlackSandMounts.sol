    ...
    ReentrancyGuard
{
      ...
      string private baseURI = "cultcontent.wtf/blacksand/uri/";
      string private secondaryTokenURI = "cultcontent.wtf/blacksand/uri2/"; 
      ...
      /// @param mintCount The amount of babies intended to be minted.
    ...
    constructor() ERC721A("BlackSandMounts", "BSMOUNTS") {
 ...
 /// @notice Returns whether or not you, the person calling this method, have minted a baby.

 function generalMint(uint mintCount) validateMint(mintCount) requireCorrectEth(mintCount) nonReentrant external payable {
 ...
 */
 ...
 function setBaseURI(string memory baseURI_) external onlyOwner {
  ...
  function setSecondaryURI(string memory secondaryTokenURI_) external onlyOwner {
     require(!baseURILocked, "setBaseURI is locked");
     secondaryTokenURI = secondaryTokenURI_;
 }
