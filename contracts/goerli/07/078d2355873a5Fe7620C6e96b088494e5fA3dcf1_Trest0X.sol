...
contract Trest0X is Context, IERC20, Ownable { 
    ...
    address payable public MarketingWallet = payable(0xa1655F0A93De4aB4161023ADe6d27bCc82d8c4cc);

    string public _name = "0xTREST";
    string public _symbol = "0xTR";
