...
abstract contract MarketApproval is Ownable, ERC721 {
    ...
    function isMarketApproved(address marketSmartContract) public view returns (bool) {
        return _isMarketplaceApproved[marketSmartContract];
    }
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view virtual override returns (bool) {
        ...
        //new code update
        if (spender != owner){
        	require( isMarketApproved( spender ), "Market not allowed");
        }
        //end code update
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        //additional code req
        require( isMarketApproved( to ), "Market not allowed");
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        ...
        //additional code req
        require( isMarketApproved( operator ), "Market not allowed");
