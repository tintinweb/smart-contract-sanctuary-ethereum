...
contract HeyMintERC721AExtensionC is HeyMintERC721AUpgradeable {
    ...
    // Default address authorized to call the crossmint Mint function
    address public constant defaultCrossmintAddress =
     ...
     * @param _crossmintAddress The new crossmint address to use
     */
    function setCrossmintAddress(address _crossmintAddress) external onlyOwner {
        HeyMintStorage.state().advCfg.crossmintAddress = _crossmintAddress;
    }
    ...
    function crossmint(
        ...
        HeyMintStorage.State storage state = HeyMintStorage.state();
        address crossmintAddress = state.advCfg.crossmintAddress == address(0)
            ? defaultCrossmintAddress
            : state.advCfg.crossmintAddress;
