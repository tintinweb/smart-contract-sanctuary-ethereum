...
contract NFTRaffle{
    ...
    event CreateRaffle(uint raffleId, address owner, address nftCollectionAddress, uint nftTokenId, uint reservePrice, uint ticketPrice);
    ...
    function createRaffle(address _nftCollectionAddress, uint _nftTokenId, uint _reservePrice, uint _ticketPrice ) public {
        ...
        emit CreateRaffle(raffleCount.current()-1, msg.sender, _nftCollectionAddress, _nftTokenId, _reservePrice, _ticketPrice);
    }
