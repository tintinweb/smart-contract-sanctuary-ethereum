...
contract BigDay is Ownable, ERC721Royalty, Pausable, ReentrancyGuard, SignatureValidator, TokenAsDate, BoundCurve {
        ...
        whenNotPaused
    {
        ...
        token.events.push(Events.Event(address(this), voucher.tokenId, 0, "", "", "", false));
        ...
        onlyOwner
    {
        ...
        token.events.push(Events.Event(address(this), payload.tokenId, 0, "", "", payload.imageUrl, false));
