...
contract BammArbitrage is FlashLoanSimpleReceiverBase {
    ...
    address public constant LUSD = 0x000000000000000000000000000000000000dEaD;
    address public constant WETH = 0x000000000000000000000000000000000000dEaD;
    address public constant USDC = 0x000000000000000000000000000000000000dEaD;
    uint24 public constant poolFee = 500; // 0.5%
    uint160 public constant MIN_SQRT_RATIO = 4295128739;

    ISwapRouter public immutable swapRouter = ISwapRouter(0x000000000000000000000000000000000000dEaD);
    IBAmm public immutable bamm = IBAmm(0x000000000000000000000000000000000000dEaD);
    ...
    constructor() FlashLoanSimpleReceiverBase(IPoolAddressesProvider(0xC911B590248d127aD18546B186cC6B324e99F02c)) {
