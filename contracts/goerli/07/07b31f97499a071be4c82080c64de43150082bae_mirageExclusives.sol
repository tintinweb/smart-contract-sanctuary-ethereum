...
contract mirageExclusives is TinyERC721, RevokableDefaultOperatorFilterer, Ownable, ERC2981Base {
    using Strings for uint256;
    ...
    function addArtwork(string memory artworkName, string memory artistName, address artistAddress, string memory artworkDescription, string memory license, string memory website, string memory metadataCID, string memory imageCID) public onlyOwner {
        ...
        details[artworkID].license = license;
        details[artworkID].website = website;
    ...
    function updateDetails(uint256 artworkID, string memory artworkName, string memory artistName, address artistAddress, string memory artworkDescription, string memory license, string memory website, string memory metadataCID, string memory imageCID) public onlyOwner {
    ...
    function getDetails(uint256 _artworkID) public view returns (string memory artworkName, string memory artistName, address artistAddress, string memory artworkDescription, string memory license, string memory website, string memory metadataCID, string memory imageCID, uint256 artworkID, bool detailsFrozen) {
        ...
        license = details[artworkID].license;
        website = details[artworkID].website;
