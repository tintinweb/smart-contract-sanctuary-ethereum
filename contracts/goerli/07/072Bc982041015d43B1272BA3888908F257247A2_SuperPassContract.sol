...
abstract contract TimedDrop is Teams {
  ...
  */
  ...
  uint256 public allowlistDropTime = 1667657400;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 55) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://https://amaranth-kind-parrotfish-134.mypinata.cloud/ipfs/Qmf2khVeXtXaNJmsX1goczKAjzU8RdxETRvB4cpL7QUs1J/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 55");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 55");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 55");
...
// File: contracts/SuperPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SuperPassContract is RamppERC721A {
    constructor() RamppERC721A("Super Pass", "Superwall"){}
}
