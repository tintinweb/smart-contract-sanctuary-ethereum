...
import "./CryptoforuNFT.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "@openzeppelin/contracts/utils/Counters.sol";

contract CryptoforuMarket is ReentrancyGuard {
    ...
    function createMarketItem(
        ...
        address creator = CryptoforuNFT(nftContractAddress).getTokenCreatorById(
            tokenId
        );
...
contract CryptoforuNFT is ERC721URIStorage {
    using Counters for Counters.Counter;
    ...
    constructor(address _marketplaceAddress)
        ERC721("CryptoforuTOKEN", "CFTOKEN")
    {
