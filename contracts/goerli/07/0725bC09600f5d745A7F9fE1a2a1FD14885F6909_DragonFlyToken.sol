...
--- 4% Marketing (the earnings of the developer and the use of the same also for marketing to ensure the longevity of the project).
- Other features:
-- Set seconds Sell Delay Timer for anti-whale and bot-flip function (wallets cannot sell for 90 seconds after making any transaction).
-- Max wallet: 80% supply.
-- Max transaction: 60% supply.
...
contract DragonFlyToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DragonFly", "DRGF") {
        ...
        marketingAddress = 0x498f583953cb7c9Ab7824f892a090E5335f19f09;
