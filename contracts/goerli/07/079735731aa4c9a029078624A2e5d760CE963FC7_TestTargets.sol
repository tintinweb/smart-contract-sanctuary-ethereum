...
contract TestTargets {
    ...
    function increaseBytes(bytes32 initial_target) public pure returns (bytes32[32*niter] memory) {
       
        bytes32[32*niter] memory outputs;
        outputs[0] = initial_target; //hex"0000000000000000000000000000000000000000";
