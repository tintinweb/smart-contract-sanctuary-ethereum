...
contract MLC is ERC20Base, IMLC {
    ...
    * @param _amount   Quantity of tokens to mint.
    */
    function mintTo(address _to, uint256 _amount) external override(ERC20Base, IMLC) {
    ...
    */
    function burn(uint256 _amount) external override(ERC20Base, IMLC) {
        require(balanceOf(msg.sender) >= _amount, "Not enough balance!");
    ...
    function _canMint() internal view override returns (bool) {
        return msg.sender == owner() || msg.sender == _minter;
    }
}