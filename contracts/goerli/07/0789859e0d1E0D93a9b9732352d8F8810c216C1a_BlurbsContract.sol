...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xc9744ACD65Bc1EBc417cba66FE43E6af7E78CD71];
  address public erc20Payable = 0xc9744ACD65Bc1EBc417cba66FE43E6af7E78CD71;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 4250) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidvxza5knvti74eacosf7laldewp7s2lytqhffskaeo7gelmxqxdq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vbu5KtRYTSONJBo8SPL3/contract-metadata";
  }
...
// File: contracts/BlurbsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BlurbsContract is ERC721APlus {
    constructor() ERC721APlus("BLURBS", "BLURB"){}
}