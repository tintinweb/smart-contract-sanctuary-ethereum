...
contract CuriousCat is ERC721A, Ownable, ReentrancyGuard {
  ...
  string  public  baseTokenURI = "https://curiouscats.club/assets/collection/metadata";

  uint256 public  maxSupply = 2000;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = .0065 ether;
  ...
  function setSaleLive(bool _saleLive)
      external
      onlyOwner
  {
      saleLive = _saleLive;
