...
contract Frens is ERC721, Ownable {
    ...
    //     return string.concat(baseURI, "SELECT%20*%20FROM%20", _tables["frens"]);
    // }

    // function attributesURI() public view returns (string memory) {
    //     return string.concat(baseURI, "SELECT%20*%20FROM%20", _tables["attributes"]);
    // }

    // function collectionsURI() public view returns (string memory) {
    //     return string.concat(baseURI, "SELECT%20*%20FROM%20", _tables["collections"]);
    // }
}
