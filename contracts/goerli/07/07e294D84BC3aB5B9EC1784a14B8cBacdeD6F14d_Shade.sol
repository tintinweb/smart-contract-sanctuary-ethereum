...
contract Shade is ERC721, Ownable {
    ...
    // Randomly picka a Shade size: 1, 2, or 3x
...
function RectangleSvg(Rectangle memory rectangle) public pure returns (string memory) {
        ...
        returns (string memory)
    {
        ...
        // Size of Shade at slot 1
        uint rectangleSize1 = drawRectangleSize(3, randomSeed);
        // console.log("Shade size 1: ", ShadeSize1);

        // Shade size 1x? Paint 1x at slot 1
        if (rectangleSize1 == 1) {
            ...
            // Slot 2
            // Size of Shade at slot 2
            uint rectangleSize2 = drawRectangleSize(2, randomSeed >> 1);
            // console.log("Shade size 2: ", ShadelSize2);

            // Shade size 1x? Paint 1x at slot 2 and 1x at slot 3
            if (rectangleSize2 == 1) {
                ...
                // Shade size 2x? Paint 2x at slot 2
            ...
            // Shade size 2x? Paint 2x at slot 1 and 1x at slot 3
            ...
            // Shade size 3x? Paint 3x at slot 1
