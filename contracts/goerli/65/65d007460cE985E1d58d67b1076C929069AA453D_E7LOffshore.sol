...
contract E7LOffshore is ERC721Linkable {
    ...
    constructor(
        ...
        address burnableContract_
    ) ERC721Linkable(name_, symbol_, parentContract_) {
        owner = tx.origin;
        burnableContract = burnableContract_;
        URI = URI_;
    }
    ...
    function transferOwnership(address wallet_) public onlyOwner {
        require(wallet_ != msg.sender, "Cannot be the same wallet");
        owner = wallet_;
    }

    function setBurnableContract(address _burnableContract) public onlyAdmin {
