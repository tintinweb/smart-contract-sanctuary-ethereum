...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x477DF803ed55413797CE1d2ed672E330132011B8];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x477DF803ed55413797CE1d2ed672E330132011B8;
  uint256[] public payableFees = [3,4,93];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 501) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidc6dxtkpyaldx7gmycij7wobcoawc6ukfp4l5eb3q6nikte4bxkq/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 501");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 501");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 501");
...
// File: contracts/RinkebyUsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RinkebyUsContract is RamppERC721A {
    constructor() RamppERC721A("Rinkeby Us", "RCREW"){}
}
