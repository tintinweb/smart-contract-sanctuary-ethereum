...
contract XaraCity is DefaultOperatorFilterer, IERC721, Proxy, Functional {
    ...
    constructor() {
        ...
        _name = "Xara City";
        _symbol = "XaraB"; //B for buildings
        _baseURI = "https://bafybeiekunybl3ribenql6kt7hqoh53au52hymradulrwsf2d65fj3hynm.ipfs.nftstorage.link/";

        payoutWallet = 0xf1A1Be8B3F056E72402828C9Ca8a956F2b165F62;
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == XaraCity.onERC721Received.selector;
    }
    ...
    function proxyMint(address _to, uint256 _qty) external proxyAccess {
        // Checks and balances handled mostly by the proxy contract
        require((numberMinted + _qty) <= totalTokens, "Cannot fill order");
