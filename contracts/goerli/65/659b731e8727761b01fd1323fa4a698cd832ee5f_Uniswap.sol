...
import "lib/uniswap-governance/contracts/Timelock.sol";
import "lib/uniswap-governance/contracts/GovernorAlpha.sol";
...
contract Uniswap {
    ...
    constructor() public {
        timelock = new Timelock(msg.sender, 0);
        governor = new GovernorAlpha(address(timelock));
    }
}