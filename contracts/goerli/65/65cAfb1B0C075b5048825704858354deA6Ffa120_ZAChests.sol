 ...
 * @notice This contract handles minting ZA-Chests tokens.
 */
contract ZAChests is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public freeClaimContractAddress =
        0x90170a47762182C9A25b0391e66c0B4B783B8B0A;
    ...
    constructor() ERC721A("ZA-Chests", "ZACHSTS") {
