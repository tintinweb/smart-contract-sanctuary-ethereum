 ...
 //Erc2981Contract
  ...
  function _setURI(uint256 _id, string memory data) internal  {
    ...
    function uri(uint256 _id) public view override  returns (string memory)  {
        ...
        return bytes(_uri).length > 0 ? string(abi.encodePacked(_uri, _id)) : "";
    ...
    IMintableERC1155
{
  ...
  string private _name;
    ...
    string private baseURI = "https://bafybeicflkal52zcarjhzrzd2d4xtziuqmtfu3kv77sncgqla6wo4ebdwu.ipfs.infura-ipfs.io/";
