...
contract UniswapCrossFlash {
    ...
    function checkTriangularPossibleTrade(
        ...
        pair = IUniswapV2Factory(Router).getPair(_Token2,_Token3);
        console.log(pair);
        path[0] = _Token2 ;
        path[1] = _Token3;
        ...
        pair = IUniswapV2Factory(Router).getPair(_Token3,_Token1);
        console.log(pair);
        path[0] = _Token3;
        path[1] = _Token1;
        ...
        pair = IUniswapV2Factory(Router).getPair(_toToken,_fromToken);
        console.log(pair);
        path[0] = _toToken ;
        path[1] = _fromToken;
