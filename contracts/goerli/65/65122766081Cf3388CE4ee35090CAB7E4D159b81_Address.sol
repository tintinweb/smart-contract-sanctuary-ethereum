...
contract Bunniezwtf is ERC721Enumerable, Ownable, RandomlyAssigned {
  using Strings for uint256;
  
  string public baseExtension = "";
  uint256 public cost = 0 ether;
  uint256 public maxBR = 5555;
  uint256 public maxMintAmount = 10;
  bool public paused = false;
  
  string public baseURI = "https://ipfs.io/ipfs/QmWXJXRdExse2YHRY21Wvh4pjRxNRQcWVhcKw4DLVnqGqs/";

  constructor(
  ) ERC721("Bunniezwtf", "BW")
