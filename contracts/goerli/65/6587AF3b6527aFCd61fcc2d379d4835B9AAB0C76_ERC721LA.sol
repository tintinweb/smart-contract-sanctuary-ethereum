 ...
 */
contract ERC721LA is ERC721LACore, AirDropable, Burnable, Whitelistable {
...
library ERC721State {
    ...
    struct Edition {
        ...
        // If editionned == false, all tokens in this edition will have the same metadata
        bool editionned;
    }
    ...
    IERC721LA
{
    ...
    function initialize(
        ...
        _setWinterWallet(0xd541da4C37e268b9eC4d7D541Df19AdCf564c6A9);
    ...
    function _transferCore(address from, address to, uint256 tokenId) internal {
        ...
        (, uint256 nextTokenNumber) = parseEditionFromTokenId(
            nextTokenId
        );
        (uint256 currentEditionId, ) = parseEditionFromTokenId(
            tokenId
        );
