...
contract P2pDefi is Ownable {
    ...
    function getOrder(
        ...
        detail = getP2pDefiDetail(
            P2pDefiLibrary.EnmTxType.ORDER,
            detailId,
            lendingToken,
            assetToken,
            user
    ...
    function getP2pDefiDetail(
        ...
        address assetToken,
        address user
    ) private view returns (P2pDefiLibrary.SrtDetail memory detail) {
    ...
    function createBorrowOrder(
        ...
        detailId = createP2pDefiDetail(
            P2pDefiLibrary.EnmTxType.ORDER,
            P2pDefiLibrary.EnmSide.BORROW,
            rateOfInterest,
            termPeriodInDays,
            lendingAmount,
            lendingToken,
    ...
    function createP2pDefiDetail(
        ...
        address lendingToken,
        address assetToken
    ) private returns (uint256 detailId) {
