...
contract NFT is ERC721Royalty {
    ...
    function _baseURI() override internal pure returns (string memory) {
        return "https://bafybeidgizxtypu4reuqe7lkkta45iqx5zjc7o7jaudgl2x47m4hiekwe4.ipfs.w3s.link/metadata/";
    }

    function setRoyalties(address receiver, uint96 feeNumerator) internal virtual {
...
function mint(uint256 amountOfNFTs) external payable {
  ...
  require(_tokenIds.current() < totalSupply, "SOLD_OUT");
  require(
    publicAmountMinted + amountOfNFTs <= totalSupply - presaleSupply,
      "EXCEEDS_MAX_SUPPLY"
  );
