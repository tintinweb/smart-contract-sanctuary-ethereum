...
contract CrazyHeadsV2 is Initializable, ERC721AQueryableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function someNewFunction() public pure returns (string memory){
    return "ok";
  }
}
