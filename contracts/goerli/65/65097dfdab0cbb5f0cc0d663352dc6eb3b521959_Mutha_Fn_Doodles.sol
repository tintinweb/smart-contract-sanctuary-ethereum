...
contract Mutha_Fn_Doodles is Ownable, ERC721A {
    ...
    uint256 public MFD_PRICE_500 = 0.01 ether;
    ...
    function mint(uint256 tokenQuantity) external payable callerIsUser {
        ...
        require(
            (MFD_PRICE * tokenQuantity <= msg.value &&
                tokenMintsCounter >= 500) ||
                (MFD_PRICE_500 * tokenQuantity <= msg.value &&
                    tokenMintsCounter < 500),
            "INSUFFICIENT_ETH"
        );
    ...
    function withdraw() external onlyOwner {
        payable(0x1e36E683f3a577234cdEf6f38C27Cc30b0BE7E4e).transfer(address(this).balance / 5);
