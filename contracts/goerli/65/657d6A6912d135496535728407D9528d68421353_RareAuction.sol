...
contract RareAuction is Ownable, ReentrancyGuard{
  ...
  constructor (string memory _auctionItem,
    uint256 _timeBuffer,
    uint256 _reservePrice, 
    uint256 _minBidIncrementPercentage,
    uint256 _startTime, 
    uint256 _endTime) payable {
  ...
  function bid () public payable nonReentrant {
    ...
    if (msg.value < topBid.amount + (topBid.amount * minBidIncrementPercentage) / 100) {
