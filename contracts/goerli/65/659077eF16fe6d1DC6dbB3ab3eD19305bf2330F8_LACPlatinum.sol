...
contract LACPlatinum is ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    function mint(address _to) external {
        ...
        require(supply + 1 <= MAX_SUPPLY, "Exceeds maximum token supply");
    ...
    function upgrade() external {
        ...
        require(ownerTokenIds.length >= 2, "You do not have enought tokens to upgrade");

        for (uint256 i = 1; i <= 2; i++) {
            burn(ownerTokenIds[i]);
        }
