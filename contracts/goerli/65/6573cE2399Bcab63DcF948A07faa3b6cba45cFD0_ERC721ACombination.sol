...
contract ERC721ACombination is ERC721A, Ownable, Pausable {
  ...
  function setMaxSupply(uint256 _maxSupply) public onlyOwner {
    require(_maxSupply >= maxSupply, "Can't not set less");
    maxSupply = _maxSupply;
  }

  function setMaxPerAddressMint(uint256 _maxPerAddressMint) public onlyOwner {
    maxPerAddressMint = _maxPerAddressMint;
  }
  ...
  function setBlindBoxOpened(bool _status) external onlyOwner {
