...
contract MarketMaker is OwnableExt, ExchangeDomain {
    ...
    function setAliveUntliSigner(address newAliveUntilSigner)
        external
        onlyOwner
    {
    ...
    function validateAliveUntilSig(
        ...
        require(
            ...
            "incorrect signature aliveUntil"
        );
    ...
    function prepareAliveUntilMessage(Order memory order, uint256 aliveUntil)
        private
        pure
        returns (bytes32)
    {
