...
// File: FutureNFT/IERC721AQueryable.sol
...
// File: FutureNFT/ERC721AQueryable.sol
...
// File: FutureNFT/NFTcontract.sol
...
contract NFTcontract is Ownable, ERC721A, ERC721AQueryable, ReentrancyGuard{
    ...
    function getBalance() public view returns (uint) {
     ...
     function SetMAX_FREE(uint _MAX_FREE) external onlyOwner {
        MAX_FREE = _MAX_FREE;
    }
       function SetMAX_FREE_PERWALLET(uint _MAX_FREE_PERWALLET) external onlyOwner {
        MAX_FREE_PERWALLET = _MAX_FREE_PERWALLET;
    }
