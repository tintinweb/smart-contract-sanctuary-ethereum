 ...
 * @notice This contract handles minting Third Layer Events tokens.
 */
contract ThirdLayerEvents is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x38CC57Cc1b882C3a7A21fE6bEde154fCBB49f5cF;
    ...
    address public royaltyAddress = 0xBeC16539d77067976B8c807148b2C36eD9731fDe;
    address[] public payoutAddresses = [
        0xBeC16539d77067976B8c807148b2C36eD9731fDe
    ];
    ...
    string public name = "Third Layer Events";
    string public symbol = "TL Events";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeicrnwjvxikrvsiznbpwgmjmrbcg6jgfagu6tb6zhcd6otztns7bfq/{id}"
        )
    {
