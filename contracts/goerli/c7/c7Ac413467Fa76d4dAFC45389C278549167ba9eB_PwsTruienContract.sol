...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x9252054E786f50F86600c925013d89f1CEBD7A6E];
  address public erc20Payable = 0x9252054E786f50F86600c925013d89f1CEBD7A6E;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmZ7Dr5krGadZ5QRn3rURGET7yrk3bykFdNDkzMMLRRGom/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/EMAq9BZgpXlQZf3yZH0j/contract-metadata";
  }
...
// File: contracts/PwsTruienContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PwsTruienContract is RamppERC721A {
    constructor() RamppERC721A("PWS Truien", "Trui"){}
}
