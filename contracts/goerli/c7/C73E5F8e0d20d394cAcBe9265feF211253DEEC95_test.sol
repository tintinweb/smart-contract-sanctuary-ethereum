...
contract EnglishAuctionHouse is IWCNFTErrorCodes {
    ...
    /// The requested English auction has not been settled
        ...
        returns (bool)
    {
        ...
        // if ea.endTime == 0 : auction never started / does not exist
        // else :
        // if ea.endTime <= block.timestamp : auction has ended
        // if ea.endTime > block.timestamp : auction still active
    ...
    ERC721
{
     ...
     *  getDutchAuctionInfoInSuburb(cityId, suburbId)
     *
