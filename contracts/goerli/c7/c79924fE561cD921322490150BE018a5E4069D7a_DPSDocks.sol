...
contract DPSDocks is ERC721Holder, ERC1155Holder, Ownable {
    ...
    /**
     * @notice we can have multiple colections acting as pirates
     */
    mapping(IERC721Metadata => bool) public pirates;

    /**
     * @notice we can have multiple colections acting as flagships
     */
    ...
    function awardRewards(
        ...
        if (_voyageResult.healthDamage > 0)
            _lockedVoyage.flagship.upgradePart(FLAGSHIP_PART.HEALTH, _lockedVoyage.flagshipId, 100 - _voyageResult.healthDamage);
