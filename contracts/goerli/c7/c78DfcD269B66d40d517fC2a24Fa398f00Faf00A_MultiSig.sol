...
contract MultiSig {
    ...
    function deposit(address receiver, uint256 amount, uint256 payout_timestamp) public returns(uint256) {
    ...
    function payout(uint256 deposit_index) public {
        ...
        require(msg.sender == this_deposit.depositor || msg.sender == owner, "You are neither the depositor nor the owner");
    ...
    function refund(uint256 deposit_index) public {
        Deposit memory this_deposit = deposits[deposit_index];
        require(this_deposit.tokens > 0, "This deposit has already been withdrawn");
        require(msg.sender == this_deposit.receiver || msg.sender == owner, "You are neither the owner nor the receiver");
        deposits[deposit_index].tokens = 0;
