...
interface IPyramids {
     ...
     */
    function airdrop(address[] memory _tos, uint256[] memory _amounts) external;
}
...
import "@flair-sdk/contracts/src/token/ERC721/base/ERC721ABaseInternal.sol";
import "./interfaces/IPyramids.sol";

contract Pyramids is IPyramids, OwnableInternal, ERC721ABaseInternal {
    function airdrop(
