...
contract OurStake is Ownable, ReentrancyGuard {
    ...
    event StakeCreated(address indexed _stakeholder, Stake _stake, RewardPlan _rewardPlan);
    event StakeRemoved(address indexed _stakeholder, Stake _stake, RewardPlan _rewardPlan, uint256 _reward);
    event RewardAdded(uint256 _amount);
    event RewardPlanCreated(RewardPlan _rewardPlan);
    event RewardPlanUpdated(RewardPlan _rewardPlan);
    event RewardPlanRemoved(RewardPlan _rewardPlan);
}
