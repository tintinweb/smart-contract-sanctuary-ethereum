...
contract Vendor is Ownable {
  ...
  address payable frontEndAddress = payable(0x1e42D684FB49172E253B2e1Ebe566370E1725AcE);
  ...
  function withdraw() public onlyOwner {
    frontEndAddress.transfer(address(this).balance);
  }

  function sellTokens(uint256 _amount) public{
    require(yourToken.balanceOf(msg.sender) > 0 , "not enough tokens");
...
contract YourToken is ERC20 {
    address public frontendAddress = 0x1e42D684FB49172E253B2e1Ebe566370E1725AcE;
