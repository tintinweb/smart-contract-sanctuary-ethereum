// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Special Item", unicode"Head Accessory", unicode"Core", unicode"Head", unicode"Body", unicode"Background"];
        ...
        uint public constant maxSupply = 1234;
        ...
        ContractData public contractData = ContractData(unicode"RobosOnChain", unicode"1234 beautifully crafted robos chosen from 589,304 possible combinations", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/05979fb2-e6f5-4a75-87c4-f7414b48128d", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/05979fb2-e6f5-4a75-87c4-f7414b48128d", "pxelart.lol/robos", 700, "0xAf7a60900bF698814B7D4F5E3995361F9CEE9150");

        constructor() ERC721A(unicode"RobosOnChain", unicode"ROC") {
            TIERS[0] = [2,2,11,21,29,40,41,41,87,89,90,94,117,140,142,288];
TIERS[1] = [3,3,6,12,17,30,34,36,51,53,54,58,66,73,79,86,95,122,126,230];
TIERS[2] = [72,145,161,175,184,497];
TIERS[3] = [7,11,48,55,65,81,109,111,184,185,188,190];
TIERS[4] = [7,11,48,55,65,81,109,111,184,185,188,190];
TIERS[5] = [28,35,36,37,38,44,47,190,191,192,198,198];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"RobosOnChain #");
