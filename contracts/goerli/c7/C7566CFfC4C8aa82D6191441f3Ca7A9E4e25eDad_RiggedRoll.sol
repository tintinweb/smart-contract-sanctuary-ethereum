...
/**
 * Deployed At: 0x64982034A814726348efbeA84F26C982D5c33Ef1
 * Frontend At: knotty-texture.surge.sh
 */
...
contract RiggedRoll is Ownable {
    ...
    constructor(address payable _diceGameAddress) payable {
    ...
    function withdraw(address _addr, uint256 _amount) public onlyOwner {
        require(
            _addr != address(0x0),
            "RiggedRoll_Receiving address is 0x0 address"
        );
        require(
            address(this).balance >= _amount,
            "RiggedRoll_Contract doesn't have emough balance"
        );
    ...
    function riggedRoll() public payable {
        require(
            ...
            "RiggedRoll_Contract doesn't have enough balance."
        );
