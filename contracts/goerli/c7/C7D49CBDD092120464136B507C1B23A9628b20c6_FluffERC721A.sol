...
contract FluffERC721A is Ownable, ERC721A, ERC2981, PaymentSplitter {
    ...
    uint private constant MAX_GIFT = 2200;
    ...
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        ...
        require(amountNFTsperWalletWl[msg.sender] + _quantity <= maxPerAddressWl, 
    ...
    function publicSaleMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(amountNFTsperWalletPublic[msg.sender] + _quantity <= maxPerAddressPublic, 
