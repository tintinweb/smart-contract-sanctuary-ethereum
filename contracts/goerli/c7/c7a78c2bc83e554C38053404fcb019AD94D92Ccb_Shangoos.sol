...
contract Shangoos is ERC721, ERC2981, Pausable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
   ...
   // Base URI:
   string private baseMetadataURI;   // <<----------- DO I EVEN NEED THIS??? <------ ALSO: originally "private" - WHY??????
   ...
   event OSRegistryUsageStateUpdated(bool OSUsageState);
   ...
   bool public workWithOpenSeaRegistry;


   constructor() ERC721("ShangoosNFTs!", "SHoNG") {   
      console.log("\n\n>In the 'ShenanigansMinter' constructor()!!!\n");

      workWithOpenSeaRegistry = true;
   ...
   function toggleWorkWithOpenSeaRegistry() public onlyOwner() {
   // function toggleWorkWithOpenSeaRegistry() public onlyOwner() returns(bool newState) {
      console.log("\n\n>In 'toggleWorkWithOpenSeaRegistry()'");
      console.log("\n   >Currently 'workWithOpenSeaRegistry' = %s", workWithOpenSeaRegistry);
      console.log("\n   >Will now TOGGLE it's value...");
      workWithOpenSeaRegistry = !workWithOpenSeaRegistry;
      console.log("\n   >Just toggled  'workWithOpenSeaRegistry' value to: %s", workWithOpenSeaRegistry);

      emit OSRegistryUsageStateUpdated(workWithOpenSeaRegistry);

      // return workWithOpenSeaRegistry;
   }
   ...
   function transferFrom(address from, address to, uint256 tokenId) public override {
      console.log("\n\n>In 'transferFrom()'\n");
      // Check to see if I'm working with OpenSea "filtered Registry" of compliant Marketplaces. MEANING: OpenSea maintains
      // a list - or registry - or MarketPlaces that DO respect and ENFORCE Creator Royalties. And OpenSea now (as of Nov. 2022)
      // insists that if you want to receive Royalties from selling your NFTs you HAVE to work with and through this 
      // registry of theirs.
      // Of course, this is very CENTRALIZED. OpenSea is basically FORCING me/us to use this registry of theirs - thereby BLOCKING
      // OUT all other Marketplaces. So this sorta stinks, and could possibly REALLY stink in the future if they change policies
      // and become bona-fide bad actors. 
      // SO...I might want to override this registry of theirs.
      // For that reason, I'm adding my own Bool flag - called "workWithOpenSeaRegistry" - which I can turn ON and OFF at will...
      // SO...

      if(workWithOpenSeaRegistry == true) {
         console.log("\n>'workWithOpenSeaRegistry' = true!");
         // Check with their Filtered Registry:
         if(from != msg.sender) {
            console.log("\n>'fro'm != 'msg.sender' !!!");
         ...
         console.log("\n>'workWithOpenSeaRegistry' = FALSE!");
      }

      console.log("\n>Will now call 'super.transferFrom()'!");
