...
contract Competition {
     ...
     */
    function installParticipants(address payable[] memory _participants) public onlyOwner {
        ...
        for(uint i=0; i<_participants.length; i++) {
            ...
            installedParticipants[_participants[i]] = true;
        }
    }

    /* 
     * Helper function to return a list of installed participants
     */
