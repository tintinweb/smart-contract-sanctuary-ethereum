...
contract ButterFlyPresale is Ownable {
    ...
    uint256 public totalHardCap = 1e21;
    ...
    /* Update Hard Cap */
    function updateTotalHardCap(uint256 newTotalHardcapValue) public onlyOwner {
        totalHardCap = newTotalHardcapValue;
    }


     /* Update  total Hard Cap */
