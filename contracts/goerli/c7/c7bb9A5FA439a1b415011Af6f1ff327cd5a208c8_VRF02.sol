...
//
contract VRF02 is VRFConsumerBaseV2 {
    // 宣告物件，建構子內會建立物件
    ...
    // 每產生一組隨機數通常只需要 20000 gas，因為但這邊也要包含到你的其它邏輯
    // 所以當 callback 邏輯較複雜的話，需設定一個上限避免太過耗 gas
    // 暫定 100000 為預設值
    ...
    // 內部函數：會將隨機數字存入 s_randomWords 陣列
