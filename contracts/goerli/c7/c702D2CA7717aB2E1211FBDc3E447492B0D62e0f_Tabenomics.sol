...
contract Tabenomics is ERC721A, Ownable, ERC721ABurnable, ERC721AQueryable{
    ...
    uint256 cost = NftSalePrice;   //NFT価格初期設定
    ...
    bool public onlyconfirmWhitelisted = true;   //確定ホワイトリストメンバーしかミントできない状態
    bool public onlyWhitelisted = true;   //ホワイトリストメンバーしかミントできない状態
    ...
    */
    ...
    NosingOverMints(quantity) 
    {
        ...
        if(onlyconfirmWhitelisted == true){
            require(confirmisWhitelisted(msg.sender),"user is not confirmwhitelisted");
