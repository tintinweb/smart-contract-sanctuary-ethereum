...
contract ConnextBridgeToken is IBridgeToken, Ownable {
    ...
    function callController(uint256 newValue) external {
        value = newValue;
        // sender address
        // token address * desination
        // chainId sourcChain
        // chianId destinationChain
    }
...
contract BridgeController is Ownable {
    ...
    function _bridge(
        ...
        IBridgeToken(registeredBridge[_chainId]).bridge{value: msg.value}(
            amount,
            _chainId,
            header,
