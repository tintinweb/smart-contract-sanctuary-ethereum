...
/**
 * @title ERC20 UDToken
 * @dev Implementation of the interest bearing token for the Ubiloan protocol
 * @author Ubiloan
 */
contract UDToken is Initializable, IUDToken, IncentivizedERC20 {
  ...
  function initialize(
    ...
    __IncentivizedERC20_init(UDTokenName, UDTokenSymbol, UDTokenDecimals);
  ...
  /**
   * @dev calculates the total supply of the specific UDToken
  ...
  /**
   * @dev Returns the address of the Ubiloan treasury, receiving the fees on this UDToken
   **/
  ...
  /**
   * @dev Returns the address of the lending pool where this UDToken is used
   **/
   ...
   * @param target The recipient of the UDTokens
  ...
  /**
   * @dev Transfers the UDTokens between two users. Validates the transfer
...
abstract contract IncentivizedERC20 is Initializable, IERC20MetadataUpgradeable, ERC20Upgradeable {
  ...
  /**
   * @return Abstract function implemented by the child UDToken/UBToken.
   * Done this way in order to not break compatibility with previous versions of UDTokens/UBTokens
   **/
