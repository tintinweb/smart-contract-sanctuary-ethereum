...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1669036200;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x113c41C64dC0Ef1171605E1112200103Ca7327fD];
  address public erc20Payable = 0x113c41C64dC0Ef1171605E1112200103Ca7327fD;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmeLmP7umHTYDkgTzTFbieu6usg2jzZpbneTHweDMsccQZ/";
...
// File: contracts/KurContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KurContract is RamppERC721A {
    constructor() RamppERC721A("Kur", "KUR"){}
}
