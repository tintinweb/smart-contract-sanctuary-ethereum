...
import "./root/RootToken/DummyMintableERC1155.sol";

/**
 * @title ConnectClubEvents
 * ConnectClubEvents - a contract for my semi-fungible tokens.
 */
contract ConnectClubEvents is DummyMintableERC1155 {
  constructor()
    ...
    IMintableERC1155
{
    ...
    constructor(string memory uri_, address _predicate_address) public ERC1155(uri_) {
