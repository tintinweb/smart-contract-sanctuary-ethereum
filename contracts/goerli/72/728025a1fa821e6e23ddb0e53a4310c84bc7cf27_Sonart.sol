...
contract Sonart is ERC721, Ownable, DefaultOperatorFilterer {
   ...
   */
  string public uriPrefix = "https://s3.amazonaws.com/sonart.metadata/";
  ...
  constructor( string memory _contractURI, bytes32 _Goldlist_root, bytes32 _Whitelist_root) ERC721("Sonart", "ST") {
   contractURI = _contractURI;
   Goldlist_root = _Goldlist_root ;
