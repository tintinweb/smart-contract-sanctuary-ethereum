...
contract BucketAuction is ReentrancyGuard, AccessControl, Ownable {
    ...
    uint256 public minimumContribution = 0.0001 ether;
    ...
    uint256 public endTimestamp = 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff;
    ...
    modifier isAuctionNotActive() {
        require(block.timestamp > endTimestamp, "Auction has started");
        _;
    }
    ...
    */
    function setPrice(uint256 priceInWei_) external onlyRole(SUPPORT_ROLE) isAuctionNotActive {
        price = priceInWei_;
