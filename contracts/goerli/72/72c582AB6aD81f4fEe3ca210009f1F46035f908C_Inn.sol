...
contract Inn is ERC2981A, MintLimits {
    ...
    function mint(uint256 quantity) external payable onlyUnderLimit(quantity) {
        ...
        if (msg.value < MINT_PRICE * quantity) revert EthValueTooLow();
    ...
    function withdrawFunds() external onlyOwner {
        ...
        require(adminWallet != address(0), "No admin wallet set");
...
import { InnState } from "../InnState.sol";
import { ERC721A } from "ERC721A/ERC721A.sol";
import { Ownable } from "openzeppelin-contracts/contracts/access/Ownable.sol";
import { ERC2981 } from "openzeppelin-contracts/contracts/token/common/ERC2981.sol";

abstract contract ERC2981A is ERC721A, InnState, Ownable, ERC2981 {
