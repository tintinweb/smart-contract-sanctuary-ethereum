    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 7) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZ9ZzHgVE7HMuhVLJkNcD8A9jbUChRpYqAKiUqaC8DbXD/";
...
// File: contracts/PxlartContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PxlartContract is RamppERC721A {
    constructor() RamppERC721A("pxlart", "pxlart"){}
}
