...
contract StandardToken is Token {
 ...
 contract CryptoBankRuptcy is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function CryptoBankRuptcy() {
        ...
        name = "Crypto.comBankRuptcy";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "FUCKCRO";                                             // Set the symbol for display purposes (CHANGE THIS)
