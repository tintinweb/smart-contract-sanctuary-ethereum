...
contract Phase0 is ERC721,ERC2981, ERC721Burnable,DefaultOperatorFilterer, ERC721Enumerable, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, address _ticketAddress, uint96 _feeNumerator) ERC721(_name,_symbol) {
    ...
    */
    ...
    function safeTransferFrom(address from,address to,uint256 tokenId,bytes memory _data) public override(ERC721) onlyAllowedOperator(from)  {
