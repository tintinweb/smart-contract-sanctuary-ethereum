...
// File: contracts/RAIKYRIE.sol
                ...
                //                   ###&#&&&&&#BBBBBBB#B#    &B   #                                   
                //                JB###&&&&&&BBBBB#B####BBBB &B                                        
                //               &#B##&&&##&#BBBB##[email protected]                                         
                //              &&&&&&&&###&BBBBBBB#BBBBBGPB                                           
                //             &&&&&&&&&#&&&BGGB!7B  BGPBGGB.      .                                   
                //            @&&&&&&&&&&&#&BBBB  B   &BBBBBB                                          
                //            &&&&&&&&&&&&#&#BBB  ?     #BBBBB   7:                                    
                //           @&&&&&&&&&&&&&#&BB&    :    [email protected] Y                                       
                //           @&&&&&&&&&&&&@&&BB#  P  Y?7777BB  ?B                                      
                //           @&&&&&&&&&&&&[email protected]&&B:P   ?!~^.G PB...B                                      
                //          &@&&&&&&&&&&&@. J&&:   G  :.:  [email protected] ..##                                     
                //          &@&&&&&&&&&&& .  .&&           B   @B#                                     
                //           &&&&&&&&&&&&?!!J  7&#           @&@B##                                    
                //         & 7&&&&&&&&&&@.:7  .            #[email protected]@[email protected]#                                    
                //         & .&&&&&&&&&&Y                 ..&BBB#B##                                   
                //            &&&&&&&&&&&&         .    B^BBBBBBBB##5                                  
                //            &&&&&&&&&@&&&@@       @&&^^:^BBBBBBB###                                  
                //        &   &&&&&&&&&@&@@@@@@@&&&&&&&G^::&[email protected]@##&                                 
                ...
                //            &&&&&&&&@@&&[email protected]&&&&&&&&&&&&^::^&&@.      @B                              
                //            &&&&@&&&@@@@#5#@&&&&&&&&&&&@:::@&@    .         .                        
                //            &&&&@&&@@&&@@&[email protected]&&&&&&&&&&&55::&#        ...    P                       
                //       :    &&@@@&&@@@@@@@@5#@&&&&&&&&&[email protected]:B B#5  ..^......                           
                //       &    &&@@@&&@@@@@@@&[email protected]@&@@&&&&BB&G:^ BB  ...:......  B                       
                //       &    &@@@@&&@@@@@@@G5Y.&&&&&&BBBB&&P^!BBB     [email protected]@                      
                //       #    &@@@@&&@@@@@@@^ 5&&&&@BBBBBB&@::^BBB#    .....&BBB                       
                //       #     @@@@&@@@@@@@@[email protected]&&@BBBBBBBB&@^:^BBBB# . ..~&&&#@                        
                //       #     @@@@&@@@@@@&Y5J&@&BBBBBBBBB&@^::BBBBB#. .&&&&@ @#&                      
                //       J     @@@@&@@@@@&755##BB&@@@@@@@@@@^:^&5G#B#G [email protected]@@&&#BBB#                     
                //             @@@@&@@@@@@55!BB#BBBBBBB&&&&&^::@&#&&&&[email protected]&&&@&#BB#                     
                //        &    @@@@&@@@@@7^^@&#BBB##[email protected]&&&&^::&&&&&&#B#@&&&&&##BB                     
                //        &    @@@@@@@@@&^^^@@@&#######B&&&&^::7&&&&[email protected]@&&&&###B                     
                //        Y    @@@@@@@@@&^^&@@@@@@&&&&BBBB#@^::~&#[email protected]@@&&&@###B&                    
                //         &   @@@@@@@@@@^^@@@@@@@#BBBBBBB#&^::^[email protected]@@@&&@&###B                    
                //          &# @@@@@@@@&&^^@@@@@@@@#BB#BB##&~::[email protected]@@@@&&&&###B                    
                //           &&@@@@@@@@&#^^@@@[email protected]@@@@BBB&@@@&^::?^[email protected]@@@@@&&@&###^                   
                //            [email protected]@@@@@@@@7^^@@@@@@@@@&BB&@@@@^::#&&&[email protected]@@@@@&&&&###@                   
                //            &@@@@@@@@@^^^@@@@@@@@@@BB#&@@@~::@&&&[email protected]@@@@@@@&&@&##&                   
                //            @@@@&@@@@@^^[email protected]@@@@@@@@#B#B&&&~::&&#BB&@@@@@@@@&&&@###                   
                //            @@@@&@@@@@^^BB#@@@@@@@@BBBBB&&!::[email protected]@@@@@@@@&&&@&##&                  
                //            @@@@&@@@@@^^#B&@@@@@@@&####BBB^::B&[email protected]@@@@@@@@@@&&@&@#B&                 
                //            @@@&&@&&@@^^[email protected]@@@@@@@&#&####BB~::&&#[email protected]@@@@@@@@@@&&@&@&BB?                
                //           @@@&&@&&&@B^[email protected]@@@@@@@@#&&#####&~::@&[email protected]#@@@@@@@@@&&&&@&BBB                
                //           @@@&&&&&&@!^!&@@@@@@@@#&&#####&~::@[email protected]&@@@@@@@@&&&&@#BBBB               
                //           @@&&&&&&&&~~5&&@@@@@@&B&&####B&~::@@[email protected]@@@@@@@@@&&@&BBBB&              
                //          @@@&&&&&&&&~~B&&@@@@@@B&&&&###B&~^^@BBBBBB&@@@@@@@@ &&&@BBBBB              
                //          @@&&&&&&@@&~!&&&@@@@@@B&&&&&&##&~^^@BBBBBB##@@@@@@@ &&&@#[email protected]             
                //         @@&&&&@&#@&&~!&&&&@@@@@B&&&&&&&#&!^^&[email protected]#[email protected]@@@@@@  @&&@#BBBB             
                //         @@&&&&@@&&&&~!&&&&&@@@@#&&&&&&&#&!^^[email protected]#[email protected]@@@@@@   &&&&[email protected]@@          
                //        &&&&&@&@@&&&&!!&&&&&&&@@@&&&&&&&&&!^^B&#B#[email protected]#@@@@    &&&&##@#BB          
                //       [email protected]&@&@&&B&&&&&[email protected]&&&&&&&@@@&&&&&&&&Y^^&B#BBBBBB&J&@@@@    @@@##BBBBB.         
                //       &&&&&&&[email protected]&&&&J!!&&&&&&&&&&&@@&&&&&&7^^B#BBGBBBB&[email protected]@@@   @&&@&#[email protected]         
                //      [email protected]&&@&&BB&&&&&7!7&&@&@&@@@@@@@@&&&&@J^^BBBB5BBBB&JJ&@@@    @@@@@&BBBB#         
                //      &&&@&&BB#&&&&&7!7&&@@@@@@@@@@@@@@@@&5^^[email protected]@@@     @@@@@#BBBB         
                //      &&&@&@[email protected]&&&&&7!!&&&@@@@@@@@@@@@@@&&G^^#BBBBBBBB#[email protected]@@      [email protected]@@&#BBB         
                //      @&&&&BBB&&&&&&!!7&&&&@@@@@@@@@@@@@@@#^^&[email protected]@@       &@&##BBB^        
                //     @@@&&@BB#&&&&&&!!?&&&&@@@@@@@@@@@@@@&#^^@BBBBBBBBJJ?#@@@        &&&BBBB&        
                //     @&&&&@BB&&&&&&&!!?&&&&@@@@   @@@@@@&&&^^&[email protected]@@@         @&&#BB#        
                //     &@&&&@[email protected]&&&&&&!!#&&&&&@@@   @@@@@&&&&^^[email protected]@@@&         &&@#B&        
                //     @@&&&&[email protected]&&&&&&!!&&&&&&@@@#  @@@@@@&&@^^^BBBBBBB#[email protected]@@@@@        &&&&BBB        
                //     @&&&&&[email protected]&&&&&&!!&&&&&&@@@@ @@@@@@@&@@^^^BBBBBBB#[email protected]@@@@@        &&&&B&BB       
                //     @&&&&#[email protected]&&&&&#!!&&&&&@@@@@ @@@@@@@@&&^^^[email protected]@@@@@@       @&&&#BBB#       
                //     &&&&&&&[email protected]&&&&&G!!&&&&&&@@@@ @@@@@@@&&&^^^[email protected]@@@@@@@      &&&&&B&BBB#      
                //    .&&&&&&##@&&&&&Y7?&&&&&@@@@@ @@@@@@@&&&~~^&[email protected]@@@@@@@@     @@G??##BBBB&B     
                //    &&&&&&##&@&&&&&&&&&&&&&&&@@: @@@@@@&@&&#[email protected]@@@@@@@@    :&@   ?&#@@&@@@    
                //    @&&&&&###@&&&&&&&&&&&&&&@@@  @@@@@@&&&&#BGBBBBB&@@@@@@@@@@    &&     &@@&BB&&    
                //    @&&&&&&##@&&&&&&&&&&&&&&@@@  @@@@@&&&&&#[email protected]@@@@@@@@@@@           &[email protected]#&B&    
                //       &@@&&#&&&&&&&&&&&&&&&@@@  @@@@@@&&&&#[email protected]@@@@@@@@@@@@            &#&&&&    
...
contract Raikyrie is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeid3p6g4v4h3rdcjcqec626oql2bwymnclebdhgkpyu4h2mmqwvbby/";
    ...
    constructor() ERC721A("Raikyrie", "ACA"){}
