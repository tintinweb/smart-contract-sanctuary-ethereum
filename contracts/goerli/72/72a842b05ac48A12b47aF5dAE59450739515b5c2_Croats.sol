...
contract Croats is ERC721, ERC721Enumerable, Ownable, ERC2981 {
    uint256 public constant maxTokenSupply = 1152;
    ...
    uint256 internal preFillBase = 100;
    uint256 private _currentIndex;

    constructor(address openSea, string memory base) ERC721("Lroats", "LRO") {
    ...
    //TODO test what happens when this is not run and what happens if pools is emppty
