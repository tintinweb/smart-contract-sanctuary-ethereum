...
contract MidasNFT is ERC721Enumerable, AccessControl {
    ...
    uint256 public cap = 250;

    constructor() ERC721("MidasNFT", "MidasNFT") {
    ...
    function mint(address user) public onlyRole(MINTER_ROLE) {
        ...
        require(tokenId <= cap, "MidasNFT: cap exceeded");
