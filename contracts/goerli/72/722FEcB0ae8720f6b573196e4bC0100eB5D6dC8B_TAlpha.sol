...
contract TAlpha is ERC20, Ownable {
    ...
    event UpdatedMarketingAndBuybackAddress(address indexed newWallet);
    ...
    constructor() ERC20("T", "T") {
        ...
        if(block.chainid == 1){
            ...
            stablecoinAddress = 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8; //  USDC
            _dexRouter = 0xc873fEcbd354f5A56E00E710B90EF4201db2448d;
        } else {
        ...
        buyMarketingAndBuybackTax = 200;
        buyLiquidityTax = 100;
        buyDevelopmentTax = 100;
        buyRewardTax = 100;
        buyTotalTax = buyMarketingAndBuybackTax + buyLiquidityTax + buyDevelopmentTax + buyRewardTax;


        sellMarketingAndBuybackTax = 250;
        sellLiquidityTax = 100;
        sellDevelopmentTax = 250;
        sellRewardTax = 100;
        sellTotalTax = sellMarketingAndBuybackTax + sellLiquidityTax + sellDevelopmentTax + sellRewardTax;

        // @dev update these!
        marketingAndBuybackAddress = address(msg.sender);
        ...
        _excludeFromMaxTransaction(address(marketingAndBuybackAddress), true);
        ...
        excludeFromTax(address(marketingAndBuybackAddress), true);
    ...
    function updateBuyTax(uint256 _marketingAndBuybackTax, uint256 _liquidityTax, uint256 _developmentTax, uint256 _rewardTax) external onlyOwner {
        buyMarketingAndBuybackTax = _marketingAndBuybackTax;
    ...
    function updateSellTax(uint256 _marketingAndBuybackTax, uint256 _liquidityTax, uint256 _developmentTax, uint256 _rewardTax) external onlyOwner {
        sellMarketingAndBuybackTax = _marketingAndBuybackTax;
    ...
    function _transfer(address from, address to, uint256 amt) internal override {
        ...
        if(takeTax){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalTax > 0){
                ...
                tokensForMarketingAndBuyback += tax * sellMarketingAndBuybackTax / sellTotalTax;
            ...
            // on buy
        	    ...
        	    tokensForMarketingAndBuyback += tax * buyMarketingAndBuybackTax / buyTotalTax;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketingAndBuyback + tokensForDevelopment + tokensForReward;
        ...
        tokensForMarketingAndBuyback = 0;
        ...
        if(PAIREDTOKEN.balanceOf(address(this)) > 0){
            SafeERC20.safeTransfer(PAIREDTOKEN, marketingAndBuybackAddress, PAIREDTOKEN.balanceOf(address(this)));
        }
    }

    function setMarketingAndBuybackAddress(address _marketingAndBuybackAddress) external onlyOwner {
        require(_marketingAndBuybackAddress != address(0), "address cannot be 0");
        marketingAndBuybackAddress = payable(_marketingAndBuybackAddress);
        emit UpdatedMarketingAndBuybackAddress(_marketingAndBuybackAddress);
    }
