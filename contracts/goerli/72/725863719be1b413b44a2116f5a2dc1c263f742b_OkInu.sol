...
contract OkInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ok Inu";//
    ...
    address payable private _developmentAddress = payable(0x3306BDcBeCf2779C8D10d1D8b7989FD09629285b);//
    address payable private _marketingAddress = payable(0x3306BDcBeCf2779C8D10d1D8b7989FD09629285b);//
