...
import "../factory/IGivitNFTFactory.sol";

contract GivitNFT is ERC165, IERC721, IERC721Metadata, IERC2981 {
    ...
    function initialize(
        ...
        require(owner == address(0), "InitializedYet");
    ...
    function safeMint(address _to, uint256 _tokenId) external virtual {
        require(IGivitNFTFactory(factory).minter() == _msgSender(), "OnlyMinter");
        _mint(_to, _tokenId);
    }
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        return string.concat(uri, uint256(_tokenId).toString(), ".json");
    }

    function royaltyInfo(uint256 /*_tokenId*/, uint256 _salePrice) external view virtual returns (address, uint256) {
        return (salesWallet, (_salePrice * salesFeeInBips) / 10000);
    }
    ...
    function burn(uint256 _tokenId) external {
        require(ownerOf(_tokenId) == _msgSender(), "OnlyOwner");
        _burn(_tokenId);
    }
    ...
    function _burn(uint256 _tokenId) internal virtual {
        ...
        _beforeTokenTransfer(_owner, address(0), _tokenId);
        ...
        _afterTokenTransfer(_owner, address(0), _tokenId);
    }
