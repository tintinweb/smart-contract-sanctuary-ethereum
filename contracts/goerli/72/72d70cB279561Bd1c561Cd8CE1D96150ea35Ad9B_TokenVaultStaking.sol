    ...
    ERC20VotesUpgradeable
{
    ...
    function addRewardToken(address _addr) external onlyOwner {
        ...
        rewardInfo.sharedPerTokensByPool[1] = Constants
            .REWARD_PER_SHARE_PRECISION;
        rewardInfo.sharedPerTokensByPool[2] = Constants
            .REWARD_PER_SHARE_PRECISION;
        ...
        validPool(poolId)
    {
        ...
        require(success, Errors.VAULT_STAKING_TRANSFER_FAILED);
        //
    ...
    function withdraw(uint256 sId, uint256 amount) external {
        ...
        for (uint256 i; i < _len; i++) {
            ...
            if (infoSharedPerToken == 0) {
                infoSharedPerToken = Constants.REWARD_PER_SHARE_PRECISION;
            }
            uint256 rewardAmt = (
                (tokenAmt *
