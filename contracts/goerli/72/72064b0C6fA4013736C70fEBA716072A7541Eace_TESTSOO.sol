...
contract TESTSOO is ERC20, Ownable {
    ...
    constructor() ERC20( "EMPTEST", "TOTEST") {
        ...
        maxBuyAmount = totalSupply * 30 / 1000; // 3% Buy
        maxSellAmount = totalSupply * 30 / 1000; // 3% Sell
        maxWalletAmount = totalSupply * 30 / 1000; // 3% Total
        ...
        operationsAddress = address(0x9741C297Fd8F7d8A1Ebfdf1DBA1b8277Cd624277);  
        TaxAddress = address(0x9741C297Fd8F7d8A1Ebfdf1DBA1b8277Cd624277);
