...
contract Wonderubictest is ERC721A, Ownable {
    ...
    constructor(string memory initBaseURI) ERC721A("Wonderubictest", "wrt") {
        baseURI = initBaseURI;
    }
    ...
    function mintWonderubic(address _to, uint256 count) external payable {
        require(mintStarted, "Minting is not live yet.");
