...
contract Staker {
    ...
    // Whether the tokens are locked or not
    ...
    function timeLeft() public view returns (uint) {
        ...
        // Otherwise, we have positive time left, so return the difference
