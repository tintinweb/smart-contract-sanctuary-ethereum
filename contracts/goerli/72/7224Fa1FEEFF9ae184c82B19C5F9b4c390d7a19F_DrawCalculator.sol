 ...
 * @notice The DrawCalculator calculates the amount of user picks based on the user average weighted balance (during each draw period)
 */
contract DrawCalculator is Initializable, IDrawCalculator {
     ...
     * @param _prizeDistributions The distribution to consider (needed for draw timestamp offsets)
