...
contract DividendDistributor is IDividendDistributor {
   ...
   // IERC20 LUNC_WARMHOLE = IERC20(0xbd31EA8212119f94A611FA969881CBa3EA06Fa3d); //mainnet
   // address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //mainnet

    IERC20 LUNC_WARMHOLE = IERC20(0x326C977E6efc84E512bB9C30f76E30c160eD06FB); // Goerli link
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LUNC_WARMHOLE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WETH;
        path[1] = address(LUNC_WARMHOLE);
        ...
        uint256 amount = LUNC_WARMHOLE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LUNC_WARMHOLE.transfer(shareholder, amount);
...
contract LUNATICS is IERC20, Auth {
   ...
   // address LUNC_WARMHOLE = 0xbd31EA8212119f94A611FA969881CBa3EA06Fa3d; //mainnet
    //address public WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //mainnet

    address LUNC_WARMHOLE = 0x326C977E6efc84E512bB9C30f76E30c160eD06FB; // Goerli link
    address public WETH = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6; //testnet
