 ...
 */
contract Character is ICharacter, ERC721Royalty, MinterManaged, Base58 {
    uint256 public totalSupply;
    string public baseURI;

    mapping(address => uint256[]) private _minted; // tokens minted by the wallet
    mapping(uint256 => bytes32) private _hash; // tokenId => hashId (ipfs hash)
