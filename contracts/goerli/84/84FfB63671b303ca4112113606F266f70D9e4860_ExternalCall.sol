...
contract ExternalCall is IExternalCall {
    ...
    function exeUpdate(uint256 whatExtCallId_) external onlyDAO returns (bool r) {
        ...
        if (r)  { delete lastExecutedorCreatedAt[whatExtCallId_][msg.sender]; 
        } else {
         if (lastExecutedorCreatedAt[whatExtCallId_][msg.sender] ==0) lastExecutedorCreatedAt[whatExtCallId_][msg.sender] = block.timestamp; 
        }
