...
contract DogPadTokenLaunch is ERC20, Ownable {
    ...
    constructor(
        ...
        maxTransactionAmount = _maxTransactionAmount * 10000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = _maxWallet * 10000 * 1e18; // 2% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 40) / 10000; // 0.4% swap wallet

		buyRewardsFee = _buyFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyTotalFees = buyRewardsFee + buyMarketingFee + buyLiquidityFee + buyDevFee;

		sellRewardsFee = _sellFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellTotalFees = sellRewardsFee + sellMarketingFee + sellLiquidityFee + sellDevFee;

		rewardsWallet = address(_taxWallet); // set as rewards wallet
    ...
    function updateBuyFees(
		...
		require((_rewardsFee + _marketingFee + _liquidityFee + _devFee) <= 50, "Max BuyFee 50%");
    ...
    function updateSellFees(
		...
		require((_rewardsFee + _marketingFee + _liquidityFee + _devFee) <= 50, "Max SellFee 50%");
