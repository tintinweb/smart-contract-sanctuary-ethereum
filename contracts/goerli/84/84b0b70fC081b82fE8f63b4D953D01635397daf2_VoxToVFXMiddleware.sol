...
error VOXETH_Only_Owner_Allowed();
/**
...
contract VOXETH {
  ...
  address payable private voxToVFXMarket;
   ...
   */
  constructor(uint256 _lockupDuration) {
  ...
  function setVoxToVFXMarket(address payable _voxToVFXMarket) public {

    if (msg.sender != owner) {
      revert VOXETH_Only_Owner_Allowed();
    }
