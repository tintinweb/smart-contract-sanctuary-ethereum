...
// Main Contract Logic 
// --------------------------------------------------------------
contract TheRoadToRyoshi is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "XSer";
    string private _symbol = "XSER";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x75EcA8F1A05B0860ECD97e5b3546e143C204087f);
    address payable public operationsWallet =  payable(0x75EcA8F1A05B0860ECD97e5b3546e143C204087f);
