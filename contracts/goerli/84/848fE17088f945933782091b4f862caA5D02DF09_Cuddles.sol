...
contract Cuddles is ERC721EnumerableUpgradeable, OwnableUpgradeable {
  ...
  function flipLocationSaleState() external onlyOwner {
    locationSaleIsActive = !locationSaleIsActive;
  }
  ...
  function reserveCuddles(uint numberOfTokens) external onlyOwner {
  ...
  receive() external payable {
    require(locationSaleIsActive, "Location sale must be active to mint");
    uint256 numberOfTokens = msg.value / LOCATION_PRICE;
    require(numberOfTokens <= 50, "Maximum 50 per transaction");
  ...
  */
  ...
  function initialize() initializer public {
    ...
    locationSaleIsActive = false;
    publicSaleIsActive = false;
    LOCATION_PRICE = 10000000000000000; // 0.01 ETH
    ...
    setBaseURI("https://api.whoiscuddles.com/prereveal");
  }
}
