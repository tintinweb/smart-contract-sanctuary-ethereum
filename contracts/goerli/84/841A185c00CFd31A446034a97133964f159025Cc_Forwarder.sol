...
contract Forwarder is ForwarderBase {
    constructor(string memory name, string memory version) {
        __ForwarderBase_init(name, version);
    }
...
/**
 * @title ForwarderBase
 * ForwarderBase - The Forwarder central contract.
 * @dev Simple minimal forwarder to be used together with an ERC2771 compatible contract. See {ERC2771Context}.
 */
contract ForwarderBase is EIP712Upgradeable, MinimalForwarderUpgradeable {
    function __ForwarderBase_init(string memory name, string memory version)
        public
        initializer
    {
