...
contract LimitlessCollection is ERC721, ERC721Burnable, ERC721URIStorage, Ownable {
    ...
    function buyNFT(uint256 quantity, bytes32[] calldata merkleProof) external payable {
    ...
    function reveal(string memory baseURIValue) external onlyOwner whenDistributionEnded {
    ...
    function _requireWhitelisted(bytes32[] calldata merkleProof) private view {
        ...
        bool isWhitelisted = MerkleProof.verify(merkleProof, whitelistMerkleTreeRoot, leaf);
        require(
            isWhitelisted,
            "Not whitelisted"
        );
    ...
    function withdrawAEFee(address to) external onlyOwner whenDistributionEnded {
    ...
    function contractURI() public view returns (string memory) {
        return "ipfs://QmdaAJ45spcuJHige5K8aPs36VjpQ89FRujfw3qK6NucBh";
    }
