...
contract EMOPOPGIRL is ERC721A, ERC2981 , Ownable, Pausable {
    ...
    uint256 public publicMaxPerTx = 50;
    ...
    function publicMint(uint256 _mintAmount, uint256 _publicMintMax, bytes32[] calldata _merkleProof)
        public
        payable
        whenNotPaused
        whenMintable
    ...
    function numMint(address addr) public view returns (uint256) {
        return claimed[addr];
    }
