...
//    }
    ...
    function mint(address to, HeartColor color) public onlyHearts returns (uint256) {
...
//        require(_exists(false, tokenId), "e_inact");
        ...
        ActiveHearts(msg.sender).initExpiryTime(tokenId);
...
//        require(allExist, "e_act_batch");
    ...
    function storage_batchActivate(uint256[] calldata tokenIds) public onlyActive {
//        bool allExist = true;
        //        for (uint256 i = 0; i < tokenIds.length; i++) {
        ////            allExist = allExist && _exists(true, tokenIds[i]);
        //        }
