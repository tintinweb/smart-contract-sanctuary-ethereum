...
contract BearWithUs is ERC721A, Ownable {
    ...
    uint256 public publicMintSupply = 800;
    ...
    function mint(uint256 _mintQuantity) public payable {
        ...
        require(totalSupply() + _mintQuantity <= maxSupply, "All NFTs are minted!");
        require(!freeClaimCanMint, "Cannot mint. Free mint is already active.");
        ...
        if (msg.sender != owner()) {
            ...
            if (publicCanMint) {
                require(
                    totalSupply() + _mintQuantity <= publicMintSupply,
                    "Exceeded the total supply for public minting"
                );
            }
        }
    ...
    function freeMint() public {
        require(!paused, "the contract is paused");
        require(freeClaimCanMint, "Free mint cannot be availed yet.");
    ...
    function setPublicMintSupply(uint256 _newPublicMintSupply) public onlyOwner {
        publicMintSupply = _newPublicMintSupply;
    }
