...
contract TOKEN is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 1000;
    uint256 public constant PRE_PRICE = 0.002 ether;
    uint256 public constant PUB_PRICE = 0.004 ether;
        ...
        returns (string memory)
    {
        if (revealed[_tokenId]) {
            return
                string(abi.encodePacked(ERC721A.tokenURI(_tokenId), ".json"));
        } else {
    ...
    function _reveal(uint256 _tokenId) private {
