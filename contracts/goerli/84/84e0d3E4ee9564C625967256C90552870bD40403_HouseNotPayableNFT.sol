...
contract HouseNotPayableNFT is ERC721Enumerable, Ownable{
  ...
  function mint(uint256 units) public {
    ...
    for (i = 1; i <= units; i++) {
       ...
       _mint(_msgSender(), _tokenIdTracker.current());//_safeMint(_msgSender(), _tokenIdTracker.current());
    }
