...
contract DOGFACE is ERC20, Ownable {
    ...
    constructor() ERC20("DOG FACE", unicode"(;´༎ຶД༎ຶ`)") payable {
    	...
    	marketingWallet = address(0x931Ac7d5669044C0Bc46895DF7081e7F8CA46Ba6); // set as Marketing wallet
        ...
        excludeFromFees(0x931Ac7d5669044C0Bc46895DF7081e7F8CA46Ba6, true);
        ...
        */
        _createInitialSupply(0x931Ac7d5669044C0Bc46895DF7081e7F8CA46Ba6, totalSupply*8/100);
