...
contract owned {
        ...
        constructor() public {
            owner = 0x6d3b2835eF6ae5e6D472f5C1bfA76fc1c84Aa2b4;
        }
...
contract AccessHousing is owned, IERC20{
    
    using SafeMath for uint256;
    
    uint256 public _totalSupply = 10000000000000000000000000;
 
    string public constant symbol = 'AhouZ';

    string public constant name = 'Access Housing';
