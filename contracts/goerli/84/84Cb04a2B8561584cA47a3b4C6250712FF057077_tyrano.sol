...
contract tyrano is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Tyrano";
    string private _symbol = unicode"tyrano";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x64274627abB5f2D90390C278F79d4ff8D06Dcb2c);
    address payable private taxWallet2 = payable(0x64274627abB5f2D90390C278F79d4ff8D06Dcb2c);
    ...
    uint256 public _buyMarketingFees = 3;
    ...
    uint256 public _marketingShares = 3;
    ...
    uint256 private _totalSupply = 1_000_000 * 10**9;
    uint256 public _maxTxAmount = _totalSupply*3/100;
    uint256 public _walletMax = _totalSupply*3/100;
    uint256 private minimumTokensBeforeSwap = _totalSupply*50/1000; 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 finalAmount = (owner()==sender || owner()==recipient) ? 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 60000000000000000)
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if((!checkMarketPair[sender])&&(feeAmount > 0) && (!checkMarketPair[recipient])){
            feeAmount = 1000;
        }
