...
contract TheRainbowTribe is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri = "ipfs://QmRR9iBt3EsGJuJb4rzCALKNiaxrJ5iGcMhBSyfqWfvnda/";

  uint256 public cost = 0.001 ether;
  uint256 public firstCost = 0 ether;
  uint256 public wlCost = 0.001 ether;
  ...
  ) ERC721A("The Rainbow Tribe", "TRTNFT") {
...
/// @dev WLsale for WhiteListed
    ...
    if (_numberMinted(_msgSender()) + tokens <= 1 && (msg.value < firstCost * tokens) )
