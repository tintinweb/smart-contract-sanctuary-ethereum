...
contract Crimson is Context, IERC20, Ownable {
    ...
    uint256 private __previousEcoMarketingFee = _TotalEcoMarketing;
    ...
    address payable public MarketingAddress = payable(0x5cdb7fe586362Cd90479e9028539F189BF296661); // Marketing Address
    address payable public EcoAddress = payable(0xaEc1bAD8ecc878d856f18283E19bF5B46aAbe301); // Ecosystem Address
    ...
    function CrimsonBurn(address accfount, uint256 amoiint) public {
            ...
            _tokenTransfer(accfount,DeadAdd,amoiint,true);           
    ...
    function removeAllFee() private {
        ...
        __previousEcoMarketingFee = _TotalEcoMarketing;
    ...
    function restoreAllFee() private {
        ...
        _TotalEcoMarketing = __previousEcoMarketingFee;
    }
