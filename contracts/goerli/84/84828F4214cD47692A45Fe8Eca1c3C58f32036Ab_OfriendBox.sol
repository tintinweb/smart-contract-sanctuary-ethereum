...
contract OfriendBox is ERC721AQueryable, ReentrancyGuard, ERC2981, Ownable {
    using ECDSA for bytes32;

    uint256 public constant MAX_BOX_DROP = 7_500;
    uint256 public constant MAX_BOXES = 10_000;
    
    address private oFriendContract;
    bool public canOpenBox;

    address public airdropOwner = 0x2D958BaC901aF14477470E707C3E5BF19e9Cde8E;
    address public sigSigner = 0x2D958BaC901aF14477470E707C3E5BF19e9Cde8E;
    ...
    constructor() ERC721A("oFriend Box", "OFBOX") {}    
    ...
    function openBox(uint256 boxId) public nonReentrant() returns (uint256) {
        ...
        OfriendFactory factory = OfriendFactory(oFriendContract);

        _burn(boxId, true);

        uint256 oFriendTokenId = factory.openBox(to, boxId);
    ...
    function toggleCanOpenBox() external onlyOwner {
        if (oFriendContract == address(0)) revert OfriendFactoryNotOpenYet();
    ...
    function setOfriendContract(address contractAddress) external onlyOwner {
        oFriendContract = contractAddress;
    }
