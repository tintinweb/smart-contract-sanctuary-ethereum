...
contract Staking is Migrate{
    ...
    function stake(uint _sum,uint8 count,string memory addrCN,uint8 procentage,string memory _tokenName) public  returns(uint32) {
        ...
        participant = Participant(msg.sender,block.timestamp,addrCN,_sum,_timeUnlock,tokens[_tokenName].tokenAddr,true);
        ...
        IERC20(tokens[_tokenName].tokenAddr).transferFrom(msg.sender,address(this),_sum);
