...
contract TestToken is Ownable, ERC721A {
    ...
    bool private _isPresaleSaleActive = false;
    string public baseURI = "";
    uint256 public PUBLIC_MINT_PRICE = 0.1 * 10**18;
    uint256 public PRESALE_MINT_PRICE = 0.1 * 10**18;
    ...
    function setPublicSaleStats(bool _active) public onlyOwner {
        _isPublicSaleActive = _active;
    }

    function isPresaleActive() public view virtual returns (bool) {
        return _isPresaleSaleActive;
    }

    function setPreSaleStats(bool _active) public onlyOwner {
        _isPresaleSaleActive = _active;
    }
    ...
    function presaleMint(bytes32[] memory _proof, uint256 _amount)
        public
        payable
    {
        _presaleMint(_proof, _amount);
    }
    ...
    function _publicMint(uint256 _amount) internal {
        ...
        require(
            ...
            "The wallet has already minted public sale"
        );
    ...
    function _presaleMint(bytes32[] memory _proof, uint256 _amount) internal {
        ...
        require(
            ...
            "The wallet has already minted during presale."
        );
        require(msg.value >= PRESALE_MINT_PRICE * _amount, "Error price");
        require(
            totalSupply() + _amount <= maxTotalSupply,
            "Max supply exceeded"
        );
    ...
    function verify(
        ...
        return _proof.verify(root, leaf(wallet, _amount));
    }

    function leaf(address wallet, uint256 amount)
        public
        view
        returns (bytes32)
    {
        return keccak256(abi.encodePacked(wallet, amount));
    }
