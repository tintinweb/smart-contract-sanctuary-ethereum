...
contract PolimiNFT is ERC721, Ownable {
    ...
    function mint() external payable {
        ...
        require(isSaleActive, "La vendita di NFTs non e ancora aperta");
        require(tokenId <= MAX_TOKENS, "Tutti gli NFTs sono stati mintati");
        require(PRICE == msg.value, "Non hai abbastabza Eth per mintare l'NFT");
    ...
    function withdrawAll(address payable _to) external payable onlyOwner {
        ...
        require(myTransfer, "Trasferimento fondi fallito");
    }

    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: Query URI fatta per un token inesistente");
