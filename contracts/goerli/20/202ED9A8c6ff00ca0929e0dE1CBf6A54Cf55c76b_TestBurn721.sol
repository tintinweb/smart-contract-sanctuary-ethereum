 ...
 * @notice This contract handles minting test burn 721 tokens.
 */
contract TestBurn721 is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address public royaltyAddress = 0x6ab23d49027f2661f7cb05d4319107374d539c72;
    ...
    string public baseTokenURI =
        "ipfs://bafybeif65um6fjq3ax5g4daqbewoooxmekof4urvt7nxt7pf73fgxq4ixm/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 5;
    uint256 public mintsPerBurn = 2;
        ...
        )
    {
        ...
        burnTokens.push(
            BurnToken(0x91D5BcaF20B0368238E5E1A8E00571a7FffBfaa1, 2, 5, 111)
        );
        burnTokens.push(
            BurnToken(0x1a00842BBf4451c3b440665c58B7B8e60538578d, 1, 1, 0)
        );
    }
     ...
     * @param _timesToBurn The number of burns to perform in a single transaction (for multiple burns at once)
     */
    function burnToMint(
        ...
        require(
            totalSupply() + (_timesToBurn * mintsPerBurn) <= MAX_SUPPLY,
            "MAX_SUPPLY_EXCEEDED"
        );
        for (uint256 i = 0; i < burnTokenLength; i++) {
            ...
            if (burnToken.tokenType == 1) {
                ...
                require(
                    burnToken.tokensPerBurn * _timesToBurn == _tokenIdsLength,
                ...
                require(
                    burnToken.tokensPerBurn * _timesToBurn == amountToBurn,
                    "INCORRECT_NO_OF_TOKENS_TO_BURN"
                );
        ...
        _safeMint(msg.sender, _timesToBurn * mintsPerBurn);
    }
