...
import { IDittoOracle, PriceData } from "../../../oracle/IDittoOracle.sol";
...
contract DittoPoolApp is DittoPool {
     ...
     */
    function oracle() public view returns (IDittoOracle) {
        return _oracle;
    }
...
/**
 * @title Ditto Oracle Interface
 */
interface IDittoOracle {
    // ***************************************************************
    // * ========================= EVENTS ========================== *
    // ***************************************************************
    event DittoOracleAdminSetAuthenticator(address authenticator);
    event DittoOracleAdminSetNonce();

    // ***************************************************************
    // * ========================= ERRORS ========================== *
    // ***************************************************************
    error DittoOracleInvalidPriceTime();
    error DittoOracleInvalidSigner();
    error DittoOracleInvalidNonce();
    ...
    /**
     * @notice Decode the token prices from the encoded ditto price data
     */
