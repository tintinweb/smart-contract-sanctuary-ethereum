...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    require(msg.value > 0, "Not ether recieved");
    uint256 amountOfTokens = msg.value * tokensPerEth; // msg.value in wei but no problem we mulitple by 100 no probelm
    // transfer the tokens
  ...
  function withdraw() public payable onlyOwner{
    require(address(this).balance > 0, "The vendor does not have eth");
