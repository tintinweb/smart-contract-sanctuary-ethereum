...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x193fb825A0a470C2506Bf83B2f400288C05Cfdda];
  address public erc20Payable = 0x193fb825A0a470C2506Bf83B2f400288C05Cfdda;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 1500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://nftstorage.link/ipfs/bafybeig3mljp6q5gcofetdrmqbou56ihureai2puhq4qplisxffcj5egc4/";
...
// File: contracts/MmkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MmkContract is RamppERC721A {
    constructor() RamppERC721A("MMK", "MMK"){}
}
