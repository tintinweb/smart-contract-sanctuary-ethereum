...
contract SharkzRewardsV1 is Initializable, UUPSUpgradeable, AdminableUpgradeable, EIP712WhitelistTypedUpgradeable {
    ...
    function claimPrize(bytes calldata _signature, uint256 prize) 
        external 
        payable 
        callerIsWallet 
        checkWhitelist(_signature,_toString(prize))
    {
        // send prize in ethers
    ...
    /**
     * @dev Returns whether an address is external token owner
     */
