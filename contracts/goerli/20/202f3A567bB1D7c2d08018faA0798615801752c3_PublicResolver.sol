...
abstract contract ABIResolver is IABIResolver, ResolverBase {
    ...
    /**
     * Sets the ABI associated with an DNS node.
...
abstract contract ContentHashResolver is IContentHashResolver, ResolverBase {
    ...
    /**
     * Sets the contenthash associated with an DNS node.
     * May only be called by the owner of that node in the DNS registry.
     * @param node The node to update.
...
abstract contract NameResolver is INameResolver, ResolverBase {
    ...
    /**
     * Sets the name associated with an DNS node, for reverse records.
     * May only be called by the owner of that node in the DNS registry.
     * @param node The node to update.
     */
...
abstract contract PubkeyResolver is IPubkeyResolver, ResolverBase {
    ...
    /**
     * Sets the SECP256k1 public key associated with an DNS node.
     * @param node The DNS node to query
...
abstract contract TextResolver is ITextResolver, ResolverBase {
    ...
    /**
     * Sets the text data associated with an DNS node and key.
     * May only be called by the owner of that node in the DNS registry.
     * @param node The node to update.
