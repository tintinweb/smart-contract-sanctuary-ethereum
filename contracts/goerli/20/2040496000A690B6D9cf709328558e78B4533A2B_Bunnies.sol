...
contract Bunnies is ERC721Enumerable, Ownable {
    ...
    function setDescriptor(IBunnyDescriptor newDescriptor) external onlyOwner {
        descriptor = newDescriptor;
    }
