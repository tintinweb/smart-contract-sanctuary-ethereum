...
/// @title Callback for IXSwapPoolActions#swap
/// @notice Any contract that calls IXSwapPoolActions#swap must implement this interface
interface IXSwapCallback {
...
interface IPeripheryImmutableState {
    /// @return Returns the address of the XSwap factory
...
interface IXSwapPoolActions {
    ...
    /// @dev The caller of this method receives a callback in the form of IXSwapMintCallback#XSwapMintCallback
    ...
    /// @dev The caller of this method receives a callback in the form of IXSwapSwapCallback#XSwapSwapCallback
    ...
    /// @dev The caller of this method receives a callback in the form of IXSwapFlashCallback#XSwapFlashCallback
...
interface IXSwapPoolDerivedState {
...
interface IXSwapPoolImmutables {
    /// @notice The contract that deployed the pool, which must adhere to the IXSwapV3Factory interface
...
interface IXSwapPoolState {
    ...
    /// Returns _liquidity The amount of liquidity in the position,
...
import "../interfaces/IXSwapPool.sol";
import "../interfaces/callback/IXSwapCallback.sol";
...
contract QuoterV2 is IQuoterV2, IXSwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IXSwapPool;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IXSwapPool) {
        return
            IXSwapPool(
    ...
    function xswapCallback(
        ...
        IXSwapPool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IXSwapPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
...
library PoolAddress {
    ...
    /// @param factory The XSwap factory contract address
