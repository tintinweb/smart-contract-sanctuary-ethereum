...
//
//
//     __  ___     __           _____           _ __             ______                     _     
//    /  |/  /__  / /_____ _   / ___/____ ___  (_) /__  _____   / ____/__  ____  ___  _____(_)____
//   / /|_/ / _ \/ __/ __ `/   \__ \/ __ `__ \/ / / _ \/ ___/  / / __/ _ \/ __ \/ _ \/ ___/ / ___/
//  / /  / /  __/ /_/ /_/ /   ___/ / / / / / / / /  __(__  )  / /_/ /  __/ / / /  __(__  ) (__  ) 
// /_/  /_/\___/\__/\__,_/   /____/_/ /_/ /_/_/_/\___/____/   \____/\___/_/ /_/\___/____/_/____/  
//                                                                                                
//
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xbb430747eE76BFF988e963b09C93d56b8Ec4289a];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xbb430747eE76BFF988e963b09C93d56b8Ec4289a;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 350) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibybsir2ugtrcsc2nfp443oymahma3coeniijj3iim6owxikxomua/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 350");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 350");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 350");
...
// File: contracts/SmileeesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SmileeesContract is RamppERC721A {
    constructor() RamppERC721A("Smileees", "MSG"){}
}
