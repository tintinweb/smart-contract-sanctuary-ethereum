...
contract Token is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public constant teamWallet = 0x9068EE33EDA4029ac224E1D72ED1CfA89e02e6Ef;
    ...
    constructor() {
        ...
        _symbol = "XAX";
        _decimals = 18;
        MaxSupply = 100_000_000 * 10**_decimals; // Max supply

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D  // Do not change
        );
        ...
        _mint(_msgSender(), 100_000_000); // total supply
    }
    ...
    function transferFrom(
        ...
        if (from != msg.sender) {
            ...
            if (allowed != type(uint256).max) {
                require(
                    allowed >= value,
                    "ERC20: request exceeds allowance"
                );
