...
contract SubscriptionManager {
    ...
    bytes4 private constant registerSig =
    ...
    function withdrawLink(uint256 value) external {
        i_link.transfer(msg.sender, value);
    }

    function createVRFSubscription() private onlyOwner {
    ...
    function addConsumer(address consumerAddress) internal onlyOwner {
