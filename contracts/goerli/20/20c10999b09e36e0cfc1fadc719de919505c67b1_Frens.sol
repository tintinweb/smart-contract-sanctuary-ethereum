...
struct Fren {
    ...
    uint256 tokenId;
    string image;
    FrenAttribute[] attributes;
}

contract Frens is ERC721, Ownable {
    mapping(uint256 => Fren) private frens;
    mapping(uint256 => Collection) private collections;
    mapping(uint256 => CollectionAttribute) private collectionAttributes;
    ...
    function safeMint(address to) public returns (uint256) {
        uint256 newItemID = ++counters["frens"];
