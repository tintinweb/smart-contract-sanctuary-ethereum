...
contract Test721PsiFlatten is ERC721Psi {
    ...
    function setBaseTokenURI(string memory newDefaultTokenBaseURI) external {
        string memory previous = _baseTokenURI;
        _baseTokenURI = newDefaultTokenBaseURI;
    ...
    //     return isRevealed() ? _tokenBaseURI : _baseTokenURI;
    // }
