    ...
    UUPSUpgradeable
{
    ...
    /**
     * @dev returns total ethers in the treasury
     */
    function totalEthers() external view returns (uint) {
    ...
    /**
     * @dev returns total tokens amount in the treasury
     * @param token valid registered ERC20 token address
     */
    function totalTokens(address token)
        external
        view
    ...
    /**
     * @dev transfer specified tokens amount from threasury to specified destination
    ...
    /**
     * @dev transfer specified nft from threasury to specified destination
     * @param _nft nft contract containing nft item
     * @param _to destination address
        ...
        notZeroAddress(_to)
    {
        ...
        emit ERC721Transfered(_to, _nft, _tokenId);
    }
    ...
    /**
     * @dev required for ERC721 receiver contracts
     */
    ...
    {
        return
            interfaceId == type(ITreasuryV1).interfaceId ||
...
interface ITreasuryV1 is IERC721Receiver, IERC165Upgradeable {
    ...
    function totalTokens(address token) external view returns (uint);
