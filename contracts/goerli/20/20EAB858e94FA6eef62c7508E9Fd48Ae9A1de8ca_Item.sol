...
contract Item is ERC721, VRFConsumerBase {
    ...
    event requestedItem(bytes32 indexed requestId, address requester);
    event categoryAssigned(uint256 indexed tokenId, Category category);
    ...
    function createItem() public returns (bytes32) {
        ...
        emit requestedItem(requestId, msg.sender);
    }
