...
contract GAMBINO is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 7770;
	uint256 public GIVEAWAY_NFT = 7;
    ...
    constructor() ERC721P('Crypto Gambinos', 'GAMBINO') {}
