...
contract SampleForTest is ERC1155Supply, Ownable {
    ...
    uint256 public constant PRE_SALE_DISCOUNT_PRICE = 35000000000000000;
    uint256 public constant PUBLIC_SALE_PRICE = 80000000000000000;

    uint256 public preSaleWindowOpens = 0;
    uint256 public publicSaleWindowOpens = 0;
    uint256 public publicSaleWindowCloses = 166647240000;
    ...
    function checkPreSaleClaimEligibility(address toAddress, uint256 amount)
        external
        view
    ...
    function _tokenId(address toAddress) private returns (uint256) {
        ...
        if (number == 0) {
            ...
            return 8;
        } else if (18 <= number && number <= 20) {
            return 9;
        } else if (21 <= number && number <= 23) {
            return 10;
        } else if (24 <= number && number <= 26) {
            return 11;
        } else {
            return 12;
        }
