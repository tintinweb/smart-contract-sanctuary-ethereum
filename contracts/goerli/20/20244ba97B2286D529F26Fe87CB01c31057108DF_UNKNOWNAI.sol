...
/**
  ...
  ---------------------------------------------------
   |                                              | 
    |    WEBSITE: https://t.me/UnKnownERC20      |
   |                                              |
    |                                            |
   |     TELEGRAM: https://www.unknowntoken.ai/   |
    |                                            |
   |                                              |
    |    TWITTER: https://twitter.com/AiUnkown   |
   |                                              |
  ---------------------------------------------------
...
contract UNKNOWNAI is ERC20, Ownable {
    ...
    constructor () ERC20("UNKNOWN AI", "$UAI") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc;
        ...
        _isExcludedFromMaxTxLimit[0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc] = true; //pinklock
        
        _isExcludedFromMaxWalletLimit[owner()] = true;
        _isExcludedFromMaxWalletLimit[address(this)] = true;
        _isExcludedFromMaxWalletLimit[address(0xdead)] = true;
        _isExcludedFromMaxWalletLimit[marketingWallet] = true;
        _isExcludedFromMaxWalletLimit[0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc] = true; //pinklock

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[marketingWallet] = true;
        _isExcludedFromFees[0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc] = true; //pinklock
    ...
    function setMaxWalletAmount(uint256 _maxWalletAmount) external onlyOwner {
        require(_maxWalletAmount >= (totalSupply() / (20 ** decimals())) / 100, "Max wallet percentage cannot be lower than 1%");
        maxWalletAmount = _maxWalletAmount * (20 ** decimals());
