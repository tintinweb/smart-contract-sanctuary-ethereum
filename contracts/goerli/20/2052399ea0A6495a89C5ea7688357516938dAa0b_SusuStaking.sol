...
contract SusuStaking is Ownable, ReentrancyGuard {
    ...
    IERC721SU public immutable nftCollection;
    ...
    uint256 private rewardsPerHour = 100 * 1e18;
    ...
    // constructor(IERC721SU _nftCollection, IERC20 _rewardsToken) {
    //     nftCollection = _nftCollection;
    //     rewardsToken = _rewardsToken;
    // }
    constructor() {
        nftCollection = IERC721SU(0x8842D22C4F6e97e974dfbACB30b770A3a78653e9);
        rewardsToken = IERC20(0xFA2ab1BfFe9b55182eF7f8a6B947DaC5e6A58B01);
    }
    ...
    function stake(uint256[] calldata _tokenIds) external nonReentrant {
        ...
        for (uint256 i; i < len; ++i) {
            ...
            // nftCollection.approve(address(this), _tokenIds[i]);
    ...
    function getNFTLevel(uint256 _tokenId) public view returns (string memory) {
        return nftCollection.getPassLevel(_tokenId);
    }
