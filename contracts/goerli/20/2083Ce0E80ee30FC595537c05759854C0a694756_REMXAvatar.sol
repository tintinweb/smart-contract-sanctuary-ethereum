...
/**
 * @title remx NFT Avatar collection
 * @author Paul Spencer, Zak James
 * @notice
 *
 * future considerations:
 * [ ] - https://eips.ethereum.org/EIPS/eip-4906 for batch notifications of metadata updates
 *
 */
    ...
    ERC721PsiUpgradeable
{
    ...
    function mint(
        ...
        require(
            _totalMinted() + quantity_ <= _maxSupply,
            "RMX: max supply would be exceeded"
        );
