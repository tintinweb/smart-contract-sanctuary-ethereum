...
contract AstroLama is ERC721AQueryable, Ownable {
    ...
    function gift(address to, uint256 quantity) external onlyOwner {
        if (to != owner()) {
            require(_numberMinted(to) + quantity <= maxQuantityPerGift, "Gift quantity limit 5 per address");
        }
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        require(_numberMinted(_msgSenderERC721A()) + quantity <= maxQuantityPerMint, "Mint quantity limit 5 per address");
