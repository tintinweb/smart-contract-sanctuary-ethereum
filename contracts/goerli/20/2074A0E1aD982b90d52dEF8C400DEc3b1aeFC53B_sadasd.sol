...
pragma solidity 0.8.7;
    ...
    contract sadasd is ERC1155Burnable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(string memory _name, string memory _symbol,string memory  _baseURI,uint256 _maxsupply) ERC1155(_baseURI) {
      minter = msg.sender;
