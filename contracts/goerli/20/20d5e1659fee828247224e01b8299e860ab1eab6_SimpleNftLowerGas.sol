...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("NFT Test", "WTGP") {
    //setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    setUriPrefix("ipfs://QmeojrP66jsAYZid2TQpEXrABCTiyGcKb3GepCyx9G4Wb4/");
    mintToDev();
  }
  ...
  function mint(uint256 _mintAmount) public payable onlyOwner {
    ...
    //function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
  function mintToDev() public payable onlyOwner {
    _mintLoop(0x0ad73d32603dBB4AbFcB11566e82a88f1b6Bb162, maxSupply);
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    //(bool hs, ) = payable(WALLET).call{value: address(this).balance * 5 / 100}("");
    //require(hs);
    // =============================================================================
