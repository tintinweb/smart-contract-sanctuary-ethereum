...
contract Raffle is Ownable, VRFConsumerBaseV2, AutomationCompatible {
    ...
    function initialiseWinnersVesting(uint256 _timePeriod, uint256 _timePeriodBreakdown) public onlyAdmin(msg.sender) {
      require(_timePeriod > _timePeriodBreakdown, "Invalid entry!");
      VestingBreakdown memory option = VestingBreakdown(_timePeriod, _timePeriodBreakdown);
      VestingOptions[true] = option;
    }
    ...
    function enterRaffleInToken(uint256 _amount) public {
        ...
        ShittyToken.approve(address(this), _amount);
    ...
    function fulfillRandomWords(
        ...
        winnerDetails memory details = winnerDetails(true, address_balance, block.timestamp);
