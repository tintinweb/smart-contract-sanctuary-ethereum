...
contract AquaCultureNFT is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC721URIStorageUpgradeable{ 
    ...
    event NewAssetTransferred(uint256 indexed tokenId, address from, address to, string nftId, uint8 currency, uint8 selectedNft, uint8 sellingMethod, string sellingNftId);
    ...
    function buyAndMintAsset(buyAndMintData memory _buyAndMintData) external payable onlyProxy {
        ...
        emit NewNFT(newTokenId);
        emit NewAssetTransferred(newTokenId, assetInfoById.creator, msg.sender, _buyAndMintData.nftId, _buyAndMintData.currency, _buyAndMintData.selectedNft, _buyAndMintData.sellingMethod, _buyAndMintData.sellingNftId);
    }
    function buyAndMintAssetByAccept(buyAndMintAssetAcceptData memory _buyAndMintAssetAcceptData) external payable onlyProxy{
        ...
        emit NewNFT(newTokenId);
        emit NewAssetTransferred(newTokenId, assetInfoById.creator, msg.sender, _buyAndMintAssetAcceptData.nftId, _buyAndMintAssetAcceptData.currency, _buyAndMintAssetAcceptData.selectedNft, _buyAndMintAssetAcceptData.sellingMethod, _buyAndMintAssetAcceptData.sellingNftId);
    }
