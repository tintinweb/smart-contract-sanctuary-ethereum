...
contract ProofOfEgg is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://Qmc75CEUq2WRPQb7HAHGLYXsgjvuhSssN2SLGq43rV29Cd/Eggs";

  uint256 public  maxSupply = 3333;
  uint256 public  MAX_MINTS_PER_TX = 3;
  uint256 public  FREE_MINTS_PER_TX = 1;
  uint256 public  PUBLIC_SALE_PRICE = 0.003 ether;
  uint256 public  TOTAL_FREE_MINTS = 3333;
