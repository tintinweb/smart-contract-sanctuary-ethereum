    ...
    */
    ...
    function buyTickets( bytes calldata signature,  uint256 quantity,  uint256 tokenIdHolding,  uint256 miningLevel) external payable nonReentrant {
        ...
        for(uint256 i= 0;i<quantity; i++){
            ...
            nftTicketHolding[msg.sender][roundId][tokenIdHolding].push(round.ticketsSold);
    ...
    function getWinningOre(uint256 roundId, uint256 TicketKey_, uint256 multiplier) private view returns(Ores Ore){
