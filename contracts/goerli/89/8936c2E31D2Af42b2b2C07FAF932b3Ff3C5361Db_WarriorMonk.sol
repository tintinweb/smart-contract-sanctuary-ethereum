...
contract WarriorMonk is ERC721, DefaultOperatorFilterer, Ownable {
    ...
    constructor(string memory _uri, address _primaryRecipient) ERC721("Warrior Monk", "WM") {
        currentTokenId = 1;
    ...
    function mintPublic(uint256 _quantity) external payable {
        ...
        require(_minted[_msgSender()] + _quantity <= maxAmountPerAddr, "Can not mint that many tokens per wallet.");
