    ...
    ReentrancyGuardUpgradeable
{
    ...
    function refundNft(
        ...
        require(
            refundNftCompleted[_nonce].tokenId.length == _tokenId.length,
            "Not mapping length array tokenId"
        );
        for (uint256 i; i < _tokenId.length; i++) {
            require(
...
contract Validator is EIP712Upgradeable {
    ...
    // keccak256("RefundNft(address _nftAddr,address _recipient,uint256[] _tokenId,uint256 _nonce,uint256 _timeEnd)");
    bytes32 public constant REFUND_NFT_TYPEHASH =
        0x1885b259aa1b321985b19b0aa40793e19a44ec6bac3b52ae44f58b160f53dc8c;
    ...
    // keccak256("ClaimNft(address _nftAddr,address _recipient,uint256[] _arrTokenIdDest,uint256[] _arrTokenIdSource,bytes32 _interchainTX,uint256 _chainIdDest,uint256 _chainIdSource,uint256 _numberMint,uint256 _timeEnd)");
