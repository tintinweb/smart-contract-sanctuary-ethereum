// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Top", unicode"Accessory", unicode"Ear Accessory", unicode"Eyes", unicode"Nose", unicode"Mouth", unicode"Beard", unicode"Clothing", unicode"Body", unicode"Background"];
        ...
        constructor() ERC721A(unicode"The Appraisoors", unicode"DN") {
            TIERS[0] = [1,1,3,3,4,5,6,7,7,12,15,15,20,23,28,30,30,34,43,54,57,61,66,70,72,72,89,118,124,165,245];
TIERS[1] = [4,5,7,13,15,17,55,60,62,66,67,79,93,110,119,152,159,159,258];
TIERS[2] = [5,28,28,39,100,100,100,100,1000];
TIERS[3] = [4,25,28,36,46,56,160,186,477,482];
TIERS[4] = [34,73,151,163,179,359,541];
TIERS[5] = [1,46,192,336,439,486];
TIERS[6] = [146,402,416,536];
TIERS[7] = [31,42,98,103,125,131,139,174,235,422];
TIERS[8] = [20,20,60,350,450,600];
TIERS[9] = [2,3,4,6,8,9,9,18,22,23,26,36,40,49,50,50,72,78,94,96,110,128,173,184,210];
