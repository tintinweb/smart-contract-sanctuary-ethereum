...
contract Dev is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        //string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Dev #', toString(tokenId), '", \
        //"description": "Sample dev NFT collection for Web3 Challenge.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '", "attributes": ',"[",'{"trait_type": "OS",','"value":"', parts[1],'"}',"]",}'  ))));
        ...
        //                         '{"name": "Person # ',
        //                         toString(tokenId),'"', 
        //                         '"description":"Test NFT collection for Web3 challenge"',
        //                         '"image": "',
        //                         "data:image/svg+xml;base64,",
        //                         Base64.encode(bytes(output)),
        //                         '", "attributes": ',
        //                         "[",
        //                         '{"trait_type": "OS Skills",',
        //                         '"value":"',
        //                         parts[1],
        //                         '"}',
        //                         '{"trait_type": "Industry",',
    ...
    constructor() ERC721("Web3 Challenge - Devs", "DEVS") Ownable() {}
}
