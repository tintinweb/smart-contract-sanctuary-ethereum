...
contract OwlDescriptorV1 is IOwlDescriptor {
    ...
    function getHead(uint256 seed, uint256 colorSeed) private pure returns (Trait memory) {
        ...
        if (seed == 10) {
            content = unicode"|￣￣￣￣￣￣￣￣￣￣￣|"
                      unicode"|    FUCKKKKKKKKK    |"
                      unicode"|＿＿＿＿＿＿＿＿＿＿＿|";
            name = "Ears";
        }
        if (seed == 11) {
            content = unicode"|￣￣￣￣￣￣￣￣￣￣￣|"
                      unicode"|    DUDEEEEEEEEE    |"
                      unicode"|＿＿＿＿＿＿＿＿＿＿＿|";
            name = "Bald";
        }
        if (seed == 12) {
            content = unicode"|￣￣￣￣￣￣￣￣￣￣￣|"
                      unicode"|    HEHEHEHEHEHE    |"
                      unicode"|＿＿＿＿＿＿＿＿＿＿＿|";
            name = "Pigtails";
        }
        if (seed == 13) {
            content = unicode"|￣￣￣￣￣￣￣￣￣￣￣|"
                      unicode"|    XDXDXDXDXDXD    |"
                      unicode"|＿＿＿＿＿＿＿＿＿＿＿|";
            name = "Punk";
        }
        if (seed == 14) {
            content = unicode"|￣￣￣￣￣￣￣￣￣￣￣|"
                      unicode"|    MMMMMMMMMMMM    |"
                      unicode"|＿＿＿＿＿＿＿＿＿＿＿|";
            name = "Feathers";
        }
        if (seed == 15) {
            content = unicode"|￣￣￣￣￣￣￣￣￣￣￣|"
                      unicode"|    DDDDDDDDDDDD    |"
                      unicode"|＿＿＿＿＿＿＿＿＿＿＿|";
            name = "Horns";
        }
        if (seed == 16) {
            content = unicode"|￣￣￣￣￣￣￣￣￣￣￣|"
                      unicode"|    Bruhhhhhhhhh    |"
                      unicode"|＿＿＿＿＿＿＿＿＿＿＿|";
            name = "Curly hair";
        }
