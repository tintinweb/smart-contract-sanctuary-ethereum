...
contract Lottery is VrfConsumer {
    ...
    event WinnerPicked(uint indexed winner);
     ...
     * Requests a winner
     */
    function requestWinner() external returns (uint) {
...
abstract contract VrfConsumer is Ownable, VRFConsumerBaseV2 {
    VRFCoordinatorV2Interface private immutable vrfCoordinator;
    uint64 private immutable subscriptionId;
    bytes32 private immutable gasLane;
    uint32 private immutable callbackGasLimit;
    uint16 private constant NUMBER_OF_CONFIRMATIONS = 3;
