 ...
 */
contract SuperGalatic is Initializable, OwnableUpgradeable, ERC721EnumerableUpgradeable, ERC721HolderUpgradeable, ISuperGalatic {
     ...
     */
    event mintGensisNFT(uint256 nftId, address owner, uint256 blockNumber);
    ...
    function createGenesis(address receiver) external {        
        ...
        emit mintGensisNFT(newID, receiver, block.number);
    }
}