...
contract Ruggy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWallet = payable(0x53051a7390CC630A67314C6CAf9A03BB55897475); // Marketing Wallet
    address payable public charityWallet = payable (0x53051a7390CC630A67314C6CAf9A03BB55897475); // charity Wallet
    ...
    string private _name = "Testy Ruggy";
    string private _symbol = "Ruggy";
    

    uint256 public _maxWalletToken = _tTotal.div(1000).mul(35); //3.5%
