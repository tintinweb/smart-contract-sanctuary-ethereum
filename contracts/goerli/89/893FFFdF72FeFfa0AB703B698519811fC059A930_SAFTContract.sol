...
contract SAFTContract is Ownable {
    ...
    event AddedSAFTPartner(address partnerAddress, uint256 usdCost, uint256 tokenAmount, bytes32 affCode);
     ...
     * @param _partner address of parter who bought tokens through SAFT
     * @param _tokens amount of tokens user wants to buy
     */
    function addSAFTPartner(address _partner, uint256 _tokens, bytes32 _affCode) public onlyOwner {
        ...
        emit AddedSAFTPartner(_partner, cost, _tokens, _affCode);
    }
