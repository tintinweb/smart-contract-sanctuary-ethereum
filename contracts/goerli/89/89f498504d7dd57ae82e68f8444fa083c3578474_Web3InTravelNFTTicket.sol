...
contract Web3InTravelNFTTicket is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 public constant INITIAL_SPONSOR_PRICE = 0.1 ether;
    ...
    constructor() ERC721("Web3 In Travel NFT Ticket", "WEB3INTRAVEL") Ownable(){
        ...
        price = INITIAL_PRICE;
        treasurer = 0xd59521d33C36BA129e9094A95eF73e3D2DAB30A5; // test Address
        paused = true;
        dateTime = 1672509659; // Sat Dec 31 2022 18:00:59 UTC 
    }
