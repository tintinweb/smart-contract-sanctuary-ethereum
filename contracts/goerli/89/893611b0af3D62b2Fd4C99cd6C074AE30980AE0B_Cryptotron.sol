...
contract Cryptotron is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    function performUpkeep(
        bytes calldata
    ) external override checkBadness {
        enterCryptotron();
    ...
    function changeAddress(address newAddress) public onlyOwner checkBadness contractRestriction {
        currentContract = newAddress;
    }

    function emergencyRefund() public approveBadness {
    ...
    function fundCryptotron() public payable checkBadness {}

    function fulfillRandomWords(
        uint256, 
        uint256[] memory randomWords
    ) internal override checkBadness {
    ...
    function enterCryptotron() internal checkBadness {
