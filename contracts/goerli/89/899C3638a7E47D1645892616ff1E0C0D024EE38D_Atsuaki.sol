...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable, ReentrancyGuard {
...
contract Atsuaki is ERC721A {
  ...
  uint256 public salePrice = 0.016 ether;

  uint256 public maxWLTx = 2;
  uint256 public maxTx = 2;

  uint256 public maxWLSupply = 777;
  ...
  constructor() ERC721A('Atsuaki', 'ASAK') {
   ...
   * @notice Atsuaki Mint
   */
  function atsuakiMint(uint256 _quantity, bytes32[] calldata _merkleProof) external payable {
