...
contract TicketingSystem is ERC721Enumerable, Ownable {
    ...
    event TicketCreated(string ticketType, uint256 validUntil,address owner, uint amount, uint ticketId);
    ...
    function mint(string memory _ticketType, uint256 _validUntil) public payable {  
        ...
        ticketId++;
        emit TicketCreated (_ticketType, _validUntil, msg.sender, msg.value, ticketId);
    }
