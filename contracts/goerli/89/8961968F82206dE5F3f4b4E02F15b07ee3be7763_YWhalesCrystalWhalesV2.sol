    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        baseURI = "https://tomato-capitalist-mollusk-258.mypinata.cloud/ipfs/QmSdKRqRe8DADVGCmQMTweVHrKT9PQR8uGcuVKaQxEHbJ2/";
        MEMBER_WHALE_TYPE = 0;
        BOARD_MEMBER_WHALE_TYPE = 1;
        ADVISOR_WHALE_TYPE = 2;
        INVESTOR_WHALE_TYPE = 3;
        STAFF_WHALE_TYPE = 4;
        MEDIA_GUEST_WHALE_TYPE = 5;
        VIP_WHALE_TYPE = 6;
    ...
    function airdrop(
        ...
        address[] memory _mediaGuestAddresses,
        ...
        for (uint256 i = 0; i < _mediaGuestAddresses.length; i++) {
            uint256 tokenId = _mint(_mediaGuestAddresses[i]);
