...
abstract contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    uint256 internal burnedTokenCount;
...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    function totalSupply() public view virtual override returns (uint256) {
        return _owners.length - burnedTokenCount;
    }
...
contract NYXSoulmateAI is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public MAX_VARIABLE_SUPPLY = 3500;
    ...
    function mint(uint256 count) external payable nonReentrant {
        ...
        require(supply + count <= MAX_VARIABLE_SUPPLY, "Max supply reached");
        ...
        onlyOwner
    {
        ...
        uint256 supply = _owners.length;
        require(
            supply + totalQuantity <= MAX_VARIABLE_SUPPLY,
            "Max supply reached"
        );
    ...
    function toggleBurningAllowed() external onlyOwner {
        require(!isPresale && !isPresale, "Check sales value");
    ...
    function setMaxSupply(uint256 maxSupply) external onlyOwner {
        ...
        require(
            maxSupply > MAX_VARIABLE_SUPPLY,
            "New max supply must be higher than MAX_VARIABLE_SUPPLY"
        );
        MAX_VARIABLE_SUPPLY = maxSupply;
    }
