...
contract CollybusDiscountRateRelayer is Guarded, ICollybusDiscountRateRelayer {
    ...
    function setMinimumThresholdValue(address oracle_, uint256 value_) public checkCaller{
        _oraclesData[oracle_].minimumThresholdValue = value_;
    }
