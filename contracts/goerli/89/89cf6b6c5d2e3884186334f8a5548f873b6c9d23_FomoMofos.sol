...
contract FomoMofos is ERC721, Ownable {
    ...
    string public baseTokenURI = "ipfs://Qme1vxGNw9Wuh7RM3y6p5VvQWzui1gyMb3RfLoWcst3M8n/";
    ...
    function airdrop(uint256 _count, address to) public onlyOwner {
        uint256 total = totalSupply();
        require(total + _count <= MAX_ELEMENTS, "Sale end");
