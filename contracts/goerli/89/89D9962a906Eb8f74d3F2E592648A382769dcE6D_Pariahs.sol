...
contract Pariahs is ERC721AUpgradeable, OwnableUpgradeable {
    ...
    function publicMint(
        uint256 _mintAmount
    ) public payable mintCompliancePublic(_mintAmount) {
        require(publicMintEnabled, "The public mint has not been enabled.");
    ...
    ) public payable mintComplianceWhitelist(_mintAmount) {
        require(
            whitelistMintEnabled,
            "The whitelist sale has not started. Come check again later!"
        );
        require(
            !whitelistClaimed[_msgSenderERC721A()],
