...
contract AmericanBolshevik is ERC721A, Ownable {
  ...
  address address1 = 0xA4087EA6d1De1Dc9f84A8f8d63657cf4AD456817;
  address address2 = 0x4BB5F9A669C5Bb720091AA163E323C2832E10Cd8;
  ...
  function mint(uint256 _count, bytes32[] calldata _merkleProof, address _address) public payable saleIsOpen {
    ...
    if (_address != owner()) {
      ...
      payable(address1).transfer(amount * 10 / 100);
      payable(address2).transfer(amount * 90 / 100);
    }
