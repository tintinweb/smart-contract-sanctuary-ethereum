...
{
    IERC721Upgradeable public farmerV1;
    ...
    function initialize(
        ...
        address _farmerV1Address
    ) external initializer {
        __Ownable_init();
        __Pausable_init();
        __ReentrancyGuard_init();
        __ERC721_init("Farmer", "FARMER");
        __DefaultOperatorFilterer_init();

        baseURI = _baseURI;
        farmerV1 = IERC721Upgradeable(_farmerV1Address);
    }
    ...
    function migrate(uint256[] calldata _tokenIds) external whenNotPaused nonReentrant {
        ...
        for (uint256 _index = 0; _index < _tokenIdsNumber; _index++) {
            farmerV1.transferFrom(_msgSender(), address(this), _tokenIds[_index]);
