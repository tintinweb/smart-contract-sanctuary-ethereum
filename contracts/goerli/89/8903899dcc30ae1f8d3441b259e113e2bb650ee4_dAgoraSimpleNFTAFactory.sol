...
error ContractsPaused(bool paused);
error BulkBuyOverMaxSupply(uint256 bulkBuyLimit, uint256 maxSupply);
error ZeroMaxSupply(uint256 maxSupply);
error CantCreateFactory(bool canCreate);
...
contract dAgoraSimpleNFTAFactory is Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        emit FactoryContractCreated(address(nfta), msg.sender, nftACount);
    }
