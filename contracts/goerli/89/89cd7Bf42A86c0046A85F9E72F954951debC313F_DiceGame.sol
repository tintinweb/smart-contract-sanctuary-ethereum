...
contract DiceGame is Initializable, RandomNumber {
    ...
    function exchangeAndPayLinkFee(uint256 nativePrice, uint256 linkPrice)
        private
    {
        // console.log("nativeToLinkPath[0]", nativeToLinkPath[0]);
        // console.log("nativeToLinkPath[1]", nativeToLinkPath[1]);
        // console.log("nativeToLinkPath[2]", nativeToLinkPath[2]);
        // console.log("erc20LinkToken", erc20LinkToken);
        // console.log("linkToken", address(linkToken));
        // console.log(
        //     "BEFORE SWAP The ERC677 link is: ",
        //     linkToken.balanceOf(address(this))
        // );
        // console.log(
        //     "BEFORE SWAP The ERC20 link is: ",
        //     IERC20Upgradeable(erc20LinkToken).balanceOf(address(this))
        // );
        ...
        // console.log(
        //     "AFTER SWAP The ERC677 link is: ",
        //     linkToken.balanceOf(address(this))
        // );
        // console.log(
        //     "AFTER SWAP The ERC20 link is: ",
        //     IERC20Upgradeable(erc20LinkToken).balanceOf(address(this))
        // );
        if (address(linkPegSwap) != address(0)) {
            // console.log("INSIDE ERC20=>ERC677");
            ...
            // console.log(
            //     "AFTER PEGSWAP The ERC677 link is: ",
            //     linkToken.balanceOf(address(this))
            // );
            // console.log(
            //     "AFTER PEGSWAP The ERC20 link is: ",
            //     IERC20Upgradeable(erc20LinkToken).balanceOf(address(this))
            // );
        }
        bool successCoordinator = linkToken.transferAndCall(
            address(coordinator),
            amounts[amounts.length - 1], // Obtained Link Amount
            abi.encode(subscriptionId)
        );
        require(successCoordinator, "DiceGame: Failed sending chainlink fee");
        // console.log(
        //     "LAST The ERC677 link is: ",
        //     linkToken.balanceOf(address(this))
        // );
        // console.log(
        //     "LAST The ERC20 link is: ",
        //     IERC20Upgradeable(erc20LinkToken).balanceOf(address(this))
        // );
    }
