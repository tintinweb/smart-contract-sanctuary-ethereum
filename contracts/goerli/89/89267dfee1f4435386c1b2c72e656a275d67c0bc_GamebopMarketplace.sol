...
contract GamebopMarketplace is ReentrancyGuard {
  using Counters for Counters.Counter;
  Counters.Counter private _itemCounter; // start from 1
  Counters.Counter private _itemSoldCounter;

  address payable public marketowner;
  uint public serviceFeeForInitialSale = 10;
  ...
  function createMarketItem(
    ...
    if (isSingle) {
        ...
        ERC1155(nftContract).safeTransferFrom(msg.sender, address(this), tokenId, supply, "");
