...
contract RiggedRoll is Ownable {
    ...
    function riggedRoll() public {
        ...
        console.log("-------------Calculated Dice ------------");
        console.log("block.number",block.number);
        console.log("prevHash:");
        console.logBytes32(prevHash);
        console.log("dice Adress:",address(diceGame));
        console.log("nonce: ",diceGame.nonce());
        console.log("roll calculated",roll);
        console.log("---------------------------------------");
        require(roll <= 2, "number is bigger than 10");
        console.log("--------Goint to DiceGame--------------");
        console.log('\t',"   Predicting number :",roll);
        console.log("-------------+++++++++++---------------");

        require(address(this).balance >= 0.002 ether , "Contract not enought balance");
