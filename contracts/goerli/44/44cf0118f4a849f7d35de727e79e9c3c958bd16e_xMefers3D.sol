...
contract xMefers3D is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("xMefers 3D", "M3D") {
    setHiddenMetadataUri("ipfs://QmWep8a9vpmBeJtuN7Hou2Ch6r5zK7VeDvG98CHWGh7yxs/hidden.json");
  }
  ...
  {
      if(_supply < 500 && cost == 24000000000000000){
           return 0.00 ether;
       } 
      else if (_supply < 500 && cost != 24000000000000000){
           return cost;
       }
      else if (_supply <= maxSupply && cost == 24000000000000000){
           return 0.024 ether;
       }
       else if (_supply <= maxSupply && cost != 24000000000000000){
           return cost;
  ...
  {
       if(_supply < 500 && maxTokensPerWallet == 2) {
           return 2;
       } 
       else if (_supply < 500 &&  maxTokensPerWallet != 2){
