...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        string private IPFSTokenURI = "ipfs://QmS4QprUHbKdAuRhyBef3GR81j2u4De2KDUobEKEfUGATN/";
        ...
        constructor(
            ...
            payableAddresses.push(0xC470A3C749aea502D80B4dC1C957A69a027f17f9);
    ...
    // File: contracts/coolTeensContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract CoolTeensContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Cool Teens", "CT", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/bIJ7mmD7cBmblD3THB58/contract-metadata";
        }
    }