...
/*
 ...
 Join our portal, Telegram link above, and allow us to welcome you.
...
contract BASED is ERC20, Ownable {
    ...
    constructor() ERC20("Based", "BASED") {
        ...
        maxTransactionAmount = (totalSupply * 1 / 100) +1; // 1% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 25 / 100000; // 0.025% swap wallet
        maxWallet = (totalSupply * 1 / 100) +1; // 1% max wallet
