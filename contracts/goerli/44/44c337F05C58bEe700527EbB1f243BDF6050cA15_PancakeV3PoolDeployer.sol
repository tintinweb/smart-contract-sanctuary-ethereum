...
contract PancakeV3Pool is IPancakeV3Pool {
    ...
    /// @dev Prevents calling a function from anyone except the address returned by IPancakeV3Factory#owner()
    modifier onlyFactoryOwner() {
        require(msg.sender == IPancakeV3Factory(factory).owner());
        _;
    }
    ...
    function setLmPool(IPancakeV3LmPool _lmPool) external onlyFactoryOwner {
      lmPool = _lmPool;
