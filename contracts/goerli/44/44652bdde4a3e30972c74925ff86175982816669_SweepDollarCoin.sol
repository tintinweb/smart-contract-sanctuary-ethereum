...
contract BaseSweep is Initializable, ERC20Upgradeable, AccessControlUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    // Core
    address public timelock_address;
    ...
    // Pause Sweep
    function pause() external onlyByOwnGov whenNotPaused {
        _pause();
    }

    // Unpause Sweep
    function unpause() external onlyByOwnGov whenPaused {
        _unpause();
    }
    ...
    */
    function _beforeTokenTransfer(
        ...
        require(transferApprover.checkTransfer(from, to) == true, "Sender or receiver is blacklisted");
        super._beforeTokenTransfer(from, to, amount);
    }

    // Used by minters when user redeems
    function minter_burn_from(uint256 b_amount) public onlyMinters whenNotPaused {
    ...
    function minter_mint(address m_address, uint256 m_amount) public onlyMinters whenNotPaused {
...
contract SweepDollarCoin is BaseSweep {
    ...
    public initializer {
        BaseSweep.__Sweep_init(_timelock_address, _transfer_approver_address, "SWEEP Dollar Coin", "SWEEP");
    ...
    function setInterestRate(uint256 _new_interest_rate) public onlyByOwnGov {
    ...
    */
    ...
    function hello_world() public view returns (uint256) {
        return 100;
    }
