...
contract Contract is Ownable{ 
    ...
    IERC20Metadata constant raizeToken=IERC20Metadata(0x73D4bF2f48a8BF7ADa3C6A373a129755971e662e);
    address constant public ContractToken=0x73D4bF2f48a8BF7ADa3C6A373a129755971e662e;
    ...
    function unlock(address to) external onlyOwner{
        ...
        raizeToken.safeTransfer(to, raizeToken.balanceOf(address(this)));
    ...
    function buyWithToken(uint256 _amount) external {
        require(_amount > 0);
        raizeToken.safeTransferFrom(msg.sender, address(this), _amount);
        for(uint256 i=0;i<receivers.length;i++){
            if(receiversRatio[receivers[i]]>0){
                raizeToken.safeTransfer(receivers[i], _amount*receiversRatio[receivers[i]]/totalRatio);
            }
        }
