...
contract PioneerNFT is Initializable, ERC721AUpgradeable, OwnableUpgradeable {
     ...
     */
    function inititalize(address saleContract_, ITomi tomi_
    ) public initializerERC721A initializer {
        __ERC721A_init("Pioneer NFT", "PIONEER NFT");
        __Ownable_init();
    ...
    function saleMint(address buyer, uint amount) external  {
        _mint(buyer, amount);
    ...
    function setTomiAddress (ITomi _tomi) public {
        tomi = _tomi;
    }
