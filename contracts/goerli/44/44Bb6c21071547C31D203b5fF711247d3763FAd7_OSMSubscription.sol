...
abstract contract Contractable is Mintable {  
    ...
    function allowContract(address allowed, string calldata urlPath, string calldata erc, bool isStaking, bool isProxy) public {
        contractables.allowContract(allowed, urlPath, erc, isStaking, isProxy);
    }
