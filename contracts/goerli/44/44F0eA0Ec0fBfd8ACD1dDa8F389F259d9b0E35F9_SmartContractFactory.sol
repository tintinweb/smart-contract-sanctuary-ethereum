...
contract SmartContractFactory {
    ...
    ERC1155SelfMinter private ecr1155SelfMinterTemplate;
    ...
    constructor(){
        ...
        ecr1155SelfMinterTemplate = new ERC1155SelfMinter();
    }
    ...
    function createERC1155SelfMinter(
        address _multisig,
        address _token,
        string memory _baseURI,
        string memory _name,
        ...
        address payable clone = createClone(address(ecr1155SelfMinterTemplate));
        ERC1155SelfMinter(clone).initialize( _multisig, _token, _baseURI, _name, _symbol, _fees, tiersNumbers, limitPerWalletPerTier, starts, ends, merkleRoots, isTierPublic);
        emit Created(clone);
    }
