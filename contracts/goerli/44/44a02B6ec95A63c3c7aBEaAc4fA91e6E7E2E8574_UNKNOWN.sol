...
contract UNKNOWN is ERC20, Auth {
    ...
    string public constant name = "UNKNOWN";
    string public constant symbol = "$APOLLO";
    uint8 public constant decimals = 9;

    uint256 public constant totalSupply = 100 * 10**6 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply / 25;
    ...
    uint256 public operationsFee = 20;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5D3653f18075B247b5482d9c38ca567a4d8Acc9B;
        operationsFeeReceiver = 0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc;
