...
//
//     __  ___                 __       ____             
//    /  |/  /___  _________  / /_     / __ \____  ____ _
//   / /|_/ / __ \/ ___/ __ \/ __ \   / / / / __ \/ __ `/
//  / /  / / /_/ / /  / /_/ / / / /  / /_/ / / / / /_/ / 
// /_/  /_/\____/_/  / .___/_/ /_/  /_____/_/ /_/\__,_/  
//                  /_/                                  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x12ecb2912C060BC4348991A30Eec6936523B4bD4];
  address public erc20Payable = 0x12ecb2912C060BC4348991A30Eec6936523B4bD4;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmaBwXYFUNkG2QGGcno2CuD9aaLrFpDaQccyMuA6rr5KJD/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/px3UxjQSLvjoQ6DZjzqs/contract-metadata";
  }
...
// File: contracts/MorphDnaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MorphDnaContract is RamppERC721A {
    constructor() RamppERC721A("Morph Dna", "MDNA"){}
}
