...
// File contracts/DatyraPunksDNA.sol



pragma solidity ^0.8.0;

contract DatyraPunksDNA {
...
// File contracts/DatyraPunksVI.sol
...
contract DatyraPunksVI is ERC721, ERC721Enumerable, DatyraPunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("DatyraPunksVI", "DTYRPNKVI") {
        maxSupply = _maxSupply;
    }

    function mint() public {
        uint256 current = _idCounter.current();
        require(current <= maxSupply, "No datyra punks left :.(");
    ...
    function tokenURI(
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "DatyraPunks #',
                tokenId.toString(),
                '", "description": "Datyra Punks smart contract", "image":"',
                image,
                '"}'
            )
        );
