...
contract WithdrawBitcoinX {
    ...
    ERC20 public token;
    uint256 public minAmount = 10000000000000000000000000;
    uint256 public maxAmount = 1000000000000000000000000000;
    ...
    function withdrawTokens(uint256 amount) external {
        require(amount >= minAmount, " Too Low Amount");
        require(amount <= maxAmount, " Too Much Amount");
    ...
    function setWhitedListedAdress(address payable _address) public onlyOwner {
        whitelistedAddresses[_address] = true;
    }

    function SetBlackListedAdress(address payable _address) public onlyOwner {
