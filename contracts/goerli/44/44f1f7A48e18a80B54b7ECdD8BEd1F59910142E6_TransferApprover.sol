 ...
 * @dev Allows accounts to be blacklisted or whitelisted by admin role
 */
contract TransferApprover is Ownable {
    ...
    */
    function checkTransfer(address _from, address _to) external view returns (bool) {
        ...
        if (currentApproverType == ApproverType.Blacklist) {
    ...
    function setApproverType(ApproverType _newType) external onlyAdmin {
        currentApproverType = _newType;
        emit ApproverTypeChanged(_newType);
    }
