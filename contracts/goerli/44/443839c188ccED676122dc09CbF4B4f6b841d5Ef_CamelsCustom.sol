...
// File contracts/CamelsCustom.sol

pragma solidity ^0.8.13;
contract CamelsCustom is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory initialBaseURI) ERC721A("CamelsCustom", "CamelsCustom") {
