...
contract testBSAPE is Context, IERC20, Ownable {
  ...
  string private constant _name = 'testBABYSAFUAPE';
  string private constant _symbol = 'tBSAPE';
  ...
  uint256 public buybackUpperLimit = 50000000000000; //0.00005 ether
