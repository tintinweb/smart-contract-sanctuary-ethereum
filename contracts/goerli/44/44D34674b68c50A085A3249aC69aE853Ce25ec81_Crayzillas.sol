...
abstract contract ERCColorable {
    ...
    function _setStateSender(address newStateSender) internal {
        require(newStateSender != address(0), "Crayzillas: Invalid State Sender");
        _isStateSenderSet = true;
        _stateSender = IStateSender(newStateSender);
    }

    function _setChildStateReceiver(address newChildStateReceiver) internal {
        require(newChildStateReceiver != address(0), "Crayzillas: Invalid child state receiver");
...
abstract contract AllowlistMint {
    ...
    function _isAllowlistMintEnabled() internal {
      require(
...
abstract contract PubRaffleMint {
    ...
    function _isPubRaffleMintEnabled() internal {
      require(
...
abstract contract PublicMint {
    ...
    function _isPublicMintEnabled() internal {
      require(
