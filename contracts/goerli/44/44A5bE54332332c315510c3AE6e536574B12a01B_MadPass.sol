...
contract MadPass is ERC1155, Ownable {
    ...
    /* ========== STATE VARIABLES ========== */
    bool FOLLOWOZREGISTRY = true; //apply OZ blacklist
    bool public canMint;
    ...
    function _beforeTokenTransfer(
        ...
        require(_isAllowedOperator(from) && _isAllowedOperator(to), "MADPASS: frozen");
    ...
    function setMadCharacterAddress(address preComputedMadCharacter)
        ...
        onlyOwner
    {
        require(canChangeMadCharacterAddress, "Resetting of MadCharacterAddress has been renounced by Admin");
