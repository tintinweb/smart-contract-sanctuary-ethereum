...
import "./ERC721Leftovertest.sol";
import "@openzeppelin/contracts/utils/Strings.sol";


contract Leftovertest is Ownable, ERC721Leftovertest, ReentrancyGuard {
    ...
    // status booleans for each active mint type
 ...
 */
contract ERC721Leftovertest is
  Context,
  ERC165,
  IERC721,
  IERC721Metadata,
  IERC721Enumerable
{
  ...
  function approve(address to, uint256 tokenId) public override {
    address owner = ERC721Leftovertest.ownerOf(tokenId);
