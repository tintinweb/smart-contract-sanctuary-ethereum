...
contract GoerliTest is ERC721A, ERC2981, Ownable, ReentrancyGuard, Pausable{
    ...
    function setRoyaltyInfo(address _receiver, uint96 _royaltyFee) public onlyOwner nonReentrant{
        _setDefaultRoyalty(_receiver, _royaltyFee);
    }
