...
contract PoorPlebMerkleOnce is ERC20, ERC20Burnable, Ownable {
    ...
    constructor(bytes32 _merkleRoot) ERC20("PoorPleb", "PP") {
        ...
        allowClaimAllDate = block.timestamp + 7 days; // 7 days claim phase for testing
        //allowClaimAllDate = block.timestamp + 69 days; // on main net
    }
