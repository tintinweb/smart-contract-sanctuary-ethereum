...
// Distinctive and unique: A crypto token that stands out from the crowd and has 
// a unique value proposition, just like a Keeshond with its thick and fluffy coat.
//
// Telegram: http://t.me/Keeshondinu
// Twitter: https://twitter.com/KEESHinu
...
contract Keeshondinu is ERC20, Ownable {
    ...
    constructor() payable ERC20("Keeshond Inu", "KEESH") {
        ...
        communityAddress = address(0x29f4472f046452FA62b4694e13182a0dCA77c19a);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x2bF5E500807F66f9aFe114bD038429C35bF32f4E),
            block.timestamp
        );
    }
