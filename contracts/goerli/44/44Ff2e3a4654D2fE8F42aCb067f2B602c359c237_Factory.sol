    ...
    AutomationCompatibleInterface
{
    ...
    function getRugDays(uint256 index) public view returns (uint256) {
        return _rugDays[index];
    }
    ...
    function distributeRewardsAndRugLoser() public {
    ...
    function gameEndTime() public view returns (uint256) {
        return _gameEndTime + gameStartTime;
    }
        ...
        returns (bool upkeepNeeded, bytes memory performData)
    {
        ...
        else if (block.timestamp > gameEndTime()) upkeepNeeded = false;
        else {
