...
// SPDX-License-Identifier: MIT
// Creator: Chiru Labs
// Modified to function with OZ's upgradeable proxies. NOTE: There is no reserved space at the end of this
// contract. If new variables need to be added, then add them to child contract accordingly
