...
contract MyNFT is ERC721, Ownable {
    ...
    // Mapping user addresses to their amount of minted images. Used for limiting per wallet
    mapping(address => uint256) public walletMints; 

    // Deprecated: Mapping tokens' ID to URIs
    mapping(uint256 => string) private _tokenURIs;

    constructor() ERC721("MyNFT #2", "NFT") {
    ...
    function mint(uint256 quantity_) public payable {
        ...
        require(walletMints[msg.sender] + quantity_ <= maxPerWallet, "Mint limit exceeded");
