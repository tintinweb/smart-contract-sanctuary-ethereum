...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    ...
    require(yourToken.balanceOf(address(this)) >= tokensAmount, 'Not enough tokens in the reserve');
  ...
  function sellTokens(uint256 amount) public {
    ...
    require(ethAmount <= address(this).balance, "Not enough ETH in the reserve");
    require(yourToken.allowance(msg.sender, address(this)) >= amount, "You must approve tokens before selling");
