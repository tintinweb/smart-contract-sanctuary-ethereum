...
contract OzV2 is ERC1155, ERC1155CollectionBase {
    ...
    */
    ...
    function exchange(uint16 tokenId) external {
        require(TOKEN_ID_EXCHANGE <= MAX_SUPPLY_EXCHANGE, "Exchange limit reached");
        ERC1155(OZ_V1_ADDRESS).safeTransferFrom(msg.sender, address(0x000000000000000000000000000000000000dEaD), tokenId, 1, "");
    ...
    function setFreezeList(address _address, bool _freeze) external adminRequired {
    ...
    function _beforeTokenTransfer(address operator, address from, address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) internal virtual override {
        ...
        require(!freezeList[from], "Transfers of the pass are frozen for this address");
    }
...
abstract contract ERC1155CollectionBase is CollectionBase, IERC1155Collection, AdminControl {
    // Token ID to mint
    uint16 internal TOKEN_ID = 171;
    uint16 internal TOKEN_ID_EXCHANGE = 1;
    uint16 internal MAX_SUPPLY_MINT = 330;
    uint16 internal MAX_SUPPLY_EXCHANGE = 170;
