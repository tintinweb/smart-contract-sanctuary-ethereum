...
contract DollarHedgerV2 {
    ...
    event PartialLiquidation(uint256 tokenBBalance, uint256 tokenBBalanceToRefund);
    ...
    // WBTC: 0xf4423F4152966eBb106261740da907662A3569C5
    // USDC: 0x9FD21bE27A2B059a288229361E2fA632D8D2d074 - 50% is 5000
    ...
    function liquidatePosition(address _tokenA, address _tokenB, uint256 aaveInterestRateMode, uint256 liquidationPercentage) public {
        ...
        if (liquidationPercentage > 0) { 
            ...
            uint256 tokenBBalanceToRefund = ((tokenBBalance * liquidationPercentage )/10000);
            ...
            emit PartialLiquidation(tokenBBalance, tokenBBalanceToRefund);
        } else {
