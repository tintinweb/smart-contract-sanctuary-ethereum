...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xf5fcF8d0Bf8F9f7902e8E2Dd2F5f03601c5A4FD0];
  address public erc20Payable = 0xf5fcF8d0Bf8F9f7902e8E2Dd2F5f03601c5A4FD0;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 3300) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRHGDqxY5ec8x8f5vTzeC9vS15Af71tkPAo9cH3QdqtaS/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 3300");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3300");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3300");
...
// File: contracts/TheDickheadAmongUsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDickheadAmongUsContract is RamppERC721A {
    constructor() RamppERC721A("The Dickhead Among Us", "TDAU"){}
}
