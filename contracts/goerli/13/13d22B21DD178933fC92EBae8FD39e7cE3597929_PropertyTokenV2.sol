    ...
    ReentrancyGuardUpgradeable
{
    ...
    function setCurrency(address currencyToUse) external {
    ...
    function setMaxToBuy(uint128 _maxToBuy) external {
        require(_maxToBuy > 100 ether, "TLCD");
        require(variables.dev == msg.sender, "Not authorized");
        variables.MaxToBuy = _maxToBuy;
    }

    function changeDev(address newOne) external onlyOwner {
        variables.dev = newOne;
    }
}
