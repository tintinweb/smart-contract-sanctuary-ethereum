...
contract ClearCryptos is ERC20Upgradeable, OwnableUpgradeable {
     ...
     */
    function getFeeState() public view virtual returns (
        uint8,
        uint8,
        uint8,
        address
     ...
     */
    function isTrading() public view virtual returns (bool) {
        return s_trading;
    }
     ...
     */
    function isInitializedLiquidityProvider() public view virtual returns (bool) {
     ...
     */
    function isOperational(address _operationalAddress) public view virtual returns (bool) {
     ...
     */
    function isLiquidityProvider(address _liquidityprovider) public view virtual returns (bool) {
    ...
    function _transfer(
        ...
        if (!s_isOperational[from] && !s_isOperational[to]) {
            ...
            if (currentFee != 0) {
                uint256 feeAmount = amount * currentFee / 100;
