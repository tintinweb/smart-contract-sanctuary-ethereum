...
contract PoolFactory is OwnableUpgradeable {
    ...
    function setCurrency(
        address currency,
        bool allowed
    ) external onlyOwner notZeroAddress(currency) {
    ...
    function setPoolBeacon(
        address poolBeacon_
    ) external onlyOwner notZeroAddress(poolBeacon_) {
        poolBeacon = poolBeacon_;
    ...
    function setAuction(
        address auction_
    ) external onlyOwner notZeroAddress(auction_) {
        auction = auction_;
    ...
    function setTreasury(
        address treasury_
    ) external onlyOwner notZeroAddress(treasury_) {
        treasury = treasury_;
    ...
    function setPoolRewardPerSecond(
        address pool,
