    ...
    IERC721ReceiverUpgradeable
{
    ...
    */
    ...
    function createAuction(ListingParameters memory _params) external override {
        ...
        if (startTime < block.timestamp) {
            ...
            require(block.timestamp - startTime < 1 hours, "Marketplace: ST");
    ...
    function updateAuction(
        ...
        if (_startTime < block.timestamp) {
            // do not allow listing to start in the past (1 hour buffer)
            require(block.timestamp - _startTime < 1 hours, "Marketplace: ST");
    ...
    */
    ...
    function payout(
        ...
        CurrencyTransferLib.transferCurrency(_currencyToUse, _payer, royaltyRecipient, royaltyCut);
        CurrencyTransferLib.transferCurrency(
            _currencyToUse,
            _payer,
            _payee,
