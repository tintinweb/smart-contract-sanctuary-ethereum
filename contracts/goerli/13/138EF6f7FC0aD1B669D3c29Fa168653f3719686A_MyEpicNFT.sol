...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Snake", "Parmesan", "dolatello", "iBiscus", "cHannEl", "skeWd"];
  string[] secondWords = ["Parcel", "Sol", "KANYE", "ShaFT", "Armstrong", "stuttgart"];
  string[] thirdWords = ["celpaR", "djor", "electrica", "Cunan", "sleik", "beige"];
  ...
  function makeAnEpicNFT() public {
    ...
    // Update your URI!!!
    _setTokenURI(newItemId, 'ipfs://QmeDy9iYakZCXzjrVcRqge8p4W5QXii1oenpUVPu6EdZTj');
