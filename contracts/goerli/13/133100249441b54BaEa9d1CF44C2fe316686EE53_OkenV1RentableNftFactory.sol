...
interface IOkenV1RentableNftFactory {
    ...
    /// @dev The transaction will revert if the contract is not ERC4907 or has already been added to the factory. A `NftContractAdded` event is be emitted.
    ...
    /// @dev The transaction will revert if the contract doesn't exist in the factory. A `NftContractRemoved` event is be emitted.
    /// @param nftContract Address of the ERC4907 contract
...
interface IOkenV1AddressRegistry {
    /// @notice This function returns the deployment address of the `OkenV1TokenRegistry` contract.
    /// @return Address of `OkenV1TokenRegistry`
    function tokenRegistry() external view returns (address);

    /// @notice This function modifies the deployment address of the `OkenV1TokenRegistry` contract.
    /// @dev This function will revert if `msg.sender` is not the contract owner
    /// @param newTokenRegistry Address of new `OkenV1TokenRegistry` contract
    function updateTokenRegistry(address newTokenRegistry) external;

    /// @notice This function returns the deployment address of the `OkenV1NftFactory` contract.
    function nftFactory() external view returns (address);

    /// @notice This function modifies the deployment address of the `OkenV1NftFactory` contract.
    /// @dev This function will revert if `msg.sender` is not the contract owner.
    /// @param newNftFactory Address of new `OkenV1NftFactory` contract
    function updateNftFactory(address newNftFactory) external;

    /// @notice This function returns the deployment address of the `OkenV1RentableNftFactory` contract.
    function rentableNftFactory() external view returns (address);

    /// @notice This function modifies the deployment address of the `OkenV1RentableNftFactory` contract.
    /// @dev This function will revert if `msg.sender` is not the contract owner.
    ...
    /// @notice This function returns the deployment address of the `OkenV1WrappedNftFactory` contract.
    function wrappedNftFactory() external view returns (address);

    /// @notice This function modifies the deployment address of the `OkenV1WrappedNftFactory` contract.
    /// @dev This function will revert if `msg.sender` is not the contract owner.
    ...
    /// @notice This function returns the deployment address of the `OkenV1RentMarketplace` contract.
    function rentMarketplace() external view returns (address);

    /// @notice This function modifies the deployment address of the `OkenV1RentMarketplace` contract.
    /// @dev This function will revert if `msg.sender` is not the contract owner.
    ...
    /// @notice This function returns the deployment address of the `OkenV1SellMarketplace` contract.
    function sellMarketplace() external view returns (address);

    /// @notice This function modifies the deployment address of the `OkenV1SellMarketplace` contract.
    /// @dev This function will revert if `msg.sender` is not the contract owner.
