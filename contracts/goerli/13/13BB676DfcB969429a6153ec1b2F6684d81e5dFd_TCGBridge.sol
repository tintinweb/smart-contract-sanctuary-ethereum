...
contract TCGBridge is AccessControl, ReentrancyGuard {
    ...
    mapping(bytes32 => mapping(uint256 => bool)) private processedNonces;
    ...
    function bridge(uint256 _amount, bytes32 _targetChain) external nonReentrant {
    ...
    function release(
        ...
        require(processedNonces[_sourceChain][nonce] == false, "Released already done");
        processedNonces[_sourceChain][nonce] = true;
