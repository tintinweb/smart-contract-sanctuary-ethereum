...
contract Market is ReentrancyGuard, OperatorAccessControl {
    ...
    //用户是否购买此商品
    mapping(address => mapping(uint256 => bool)) private userProductMap;
    ...
    function buy(uint256 productId) public payable nonReentrant {
        ...
        if (payContractAddress == ETH_ADDRESS) {
            ...
            beforeAssets = address(systemIncomeAddress).balance;
            ...
            afterAssets = address(systemIncomeAddress).balance;
        } else {
            ...
            beforeAssets = _erc20.balanceOf(systemIncomeAddress);
            ...
            afterAssets = _erc20.balanceOf(systemIncomeAddress);
        }
