...
contract CXGPET is ERC721LazyMint {
    ERC1155Drop public immutable cxgegg;
    ...
    function verifyClaim(address _claimer, uint256 _quantity)
        ...
        override
    {
        require(cxgegg.balanceOf(_claimer, 0) >= _quantity, "You don't own enough CXGegg NFTs");
    }
