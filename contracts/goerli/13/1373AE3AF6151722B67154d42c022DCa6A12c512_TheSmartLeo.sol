 ...
 */
contract TheSmartLeo is ERC721A, Ownable {
    ...
    uint256 public associationShares = 20;
    ...
    function transferFrom(
        ...
        // Appel de la fonction de transfert standard
        super.transferFrom(from, to, tokenId);

        // Retrait de l'identifiant du jeton transféré du tableau de l'adresse de l'expéditeur
        ...
        // Ajout de l'identifiant de jeton transféré dans le tableau de l'adresse du destinataire
    ...
    function airdrop(
        ...
        require(
            recipients.length == numNFTs.length,
