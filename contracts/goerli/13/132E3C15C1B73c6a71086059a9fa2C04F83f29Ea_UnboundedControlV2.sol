...
contract UnboundedControlV2 is ReentrancyGuard, PullPayment {
  ...
  event MetaverseRegistered(address metaverse,address company, uint256 metaverseId, string metaverseName,string companyName,string thumbnail, string metaverseMetadata);
  ...
  function registerMetaverse(
    ...
    unchecked {
      ...
      emit MetaverseRegistered(_wallet,_companyWallet, id, _name, _companyName, _thumbnail,_metaverseMetadataTemplate);
    }
  }
  ...
  */
  ...
  function selectTemplates(uint256[] calldata _baseIds) external {
    ...
    for (uint256 i; i < _baseIds.length; i++) {
      require(templateMintPrice[_baseIds[i]] > 0,"Can't select unset template!");
