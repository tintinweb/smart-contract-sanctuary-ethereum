...
contract Coliseum is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_TRADEABLE_SUPPLY = 3; //10;
    uint256 public constant MINT_PRICE_TIER_ONE = 0;
    uint256 public constant MINT_PRICE_TIER_TWO = 0.003 ether; // 3 ether;
    uint256 public constant MINT_PRICE_TIER_THREE = 0.004 ether; // 4 ether;
