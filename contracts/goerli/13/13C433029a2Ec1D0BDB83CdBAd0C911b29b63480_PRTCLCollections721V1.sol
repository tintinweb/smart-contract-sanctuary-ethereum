    ...
    ReentrancyGuard
{
     ...
     */
    function proceeds(uint256 _collectionId, uint256 _salePrice, uint256 _tokens) onlyValidCollectionId(_collectionId) external view returns (uint256) {
        // Multiply first to avoid rounding errors as much as possible
        return _salePrice * _tokens / collections[_collectionId].maxParticles;
    }
