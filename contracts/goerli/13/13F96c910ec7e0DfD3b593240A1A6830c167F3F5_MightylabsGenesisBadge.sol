...
contract MightylabsGenesisBadge is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 private pricePublic = 1 ether;
    uint256 private priceWL = 1 ether;
    ...
    constructor() ERC721A("Genesis Sheriff Badge", "BADGE") {}
