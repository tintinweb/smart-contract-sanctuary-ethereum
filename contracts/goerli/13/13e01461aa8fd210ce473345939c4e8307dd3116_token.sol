...
contract token is ERC20("WBCTEST", "WBCT"){
    ...
    constructor() payable{  
        //the code inside constructor is run whenever you deploy the contract
        //we make it payable so that we can deposit ether into the contract
        owner = msg.sender;
    }
    ...
    function win() public{
        if(points[msg.sender] >= 5){
            ...
            //takes the contact off the blockchain and sends all of the money inside it to the address
        }else{
