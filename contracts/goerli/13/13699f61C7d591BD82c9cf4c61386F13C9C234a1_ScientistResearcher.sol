...
contract ScientistResearcher is IScientistResearcher {
     ...
     * NOTE Explainations about function:
     * - Scientist will gain 2 points biology at the first researching
    ...
    /**
     * @dev Research technical level 2 - Engineering
     * NOTE Explainations about function:
     * - Scientist will gain 1 point physics and 1 point mathematics for each researching
     * - Allows MAD Nanocells created from splits permanently get +1 to a random attribute
     * @param _scientist is scientist data
     */
    ...
    /**
     * @dev Research technical level 2 - Astro Physics
     * NOTE Explainations about function:
     * - Scientist will gain 1 point physics and 1 point mathematics for each researching
     * - Allows MAD Nanocells created from splits permanently get +1 to a random attribute
     * @param _scientist is scientist data
    ...
    /**
     * @dev Research technical level 2 - Economics
     * NOTE Explainations about function:
     * - Scientist will gain 2 points mathematics at the first researching
     *   and 1 point mathematics for next researching
     * - Allows MAD Metacells to have a permanent 1% higher chance to split into Nanocells
     * @param _scientist is scientist data
     */
    ...
    /**
     * @dev Research technical level 2 - Computer Science
     * NOTE Explainations about function:
     * - Scientist will gain 2 points mathematics at the first researching
     *   and 1 point mathematics for next researching
     * - Allows MAD Metacells to have a permanent 1% higher chance to split into Nanocells
