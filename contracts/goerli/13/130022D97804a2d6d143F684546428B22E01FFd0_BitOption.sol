...
contract BitOption is Pausable, Ownable, ReentrancyGuard {
    ...
    bool private _canStake = false; // set user can or not use staking function
    mapping(address => bool) private _isAdmin;
    mapping(address => mapping(uint256 => StakeTokenInfo)) private stakeInfo;
    mapping(address => UserInfo) private userInfo;

    address public B2OToken = 0x34Ed09236E55C575e0359ACE42d8B4ec2A5048B6;
    ...
    modifier canStake() {
        require(_canStake, "BitOption: can not stake or unstake now");
        _;
    }
