...
abstract contract ERC3525SlotEnumerableUpgradeable is ERC3525Upgradeable, IERC3525SlotEnumerableUpgradeable {
...
contract ERC3525Upgradeable is IERC3525Upgradeable, IERC3525MetadataUpgradeable, ERC721EnumerableUpgradeable {
    ...
    mapping(uint256 => EnumerableMapUpgradeable.AddressToUintMap) private _valueApprovals;
    ...
    function __ERC3525_init_unchained(uint8 decimals_) internal onlyInitializing {
        _decimals = decimals_;
    }
    ...
    function _spendAllowance(
        ...
        uint256 currentAllowance = ERC3525Upgradeable.allowance(tokenId, operator);
        if (
...
abstract contract ERC5727ClaimableUpgradeable is IERC5727ClaimableUpgradeable, ERC5727Upgradeable {
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.UintSet;
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(IERC165Upgradeable, ERC5727Upgradeable) returns (bool) {
        return
...
abstract contract ERC5727DelegateUpgradeable is IERC5727DelegateUpgradeable, ERC5727Upgradeable {
    ...
    ERC3525SlotEnumerableUpgradeable
{
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(IERC165Upgradeable, ERC3525Upgradeable, ERC5727Upgradeable) returns (bool) {
        return
    ...
    function _beforeTokenTransfer(
        ...
        uint256 batchSize
    ) internal virtual override(ERC721EnumerableUpgradeable, ERC5727Upgradeable) {
    ...
    function _beforeValueTransfer(
        ...
        uint256 slot,
        uint256 value
    ) internal virtual override(ERC3525SlotEnumerableUpgradeable, ERC5727Upgradeable) {
    ...
    function _afterValueTransfer(
        ...
        uint256 slot,
        uint256 value
    ) internal virtual override(ERC3525SlotEnumerableUpgradeable, ERC3525Upgradeable) {
...
abstract contract ERC5727ExpirableUpgradeable is IERC5727ExpirableUpgradeable, ERC5727Upgradeable {
...
abstract contract ERC5727GovernanceUpgradeable is IERC5727GovernanceUpgradeable, ERC5727Upgradeable {
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.AddressSet;
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.UintSet;
    ...
    function __ERC5727Governance_init_unchained(address[] memory voters_) internal onlyInitializing {
...
abstract contract ERC5727RecoveryUpgradeable is IERC5727RecoveryUpgradeable, ERC5727EnumerableUpgradeable {
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(IERC165Upgradeable, ERC5727EnumerableUpgradeable) returns (bool) {
        return
...
contract ERC5727Upgradeable is EIP712Upgradeable, AccessControlEnumerableUpgradeable, ERC3525Upgradeable, IERC5727MetadataUpgradeable {
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.UintSet;
    using EnumerableSetUpgradeable for EnumerableSetUpgradeable.AddressSet;
    using SignatureCheckerUpgradeable for address;
    ...
    function __ERC5727_init_unchained(address admin_) internal onlyInitializing {
    ...
    function _beforeTokenTransfer(
        ...
        if (from != address(0) && to != address(0) && !_unlocked[firstTokenId]) revert Soulbound();
    ...
    function supportsInterface(
        ...
        view
        virtual
        override(IERC165Upgradeable, ERC3525Upgradeable, AccessControlEnumerableUpgradeable)
        returns (bool)
    {
        return
 ...
 */
interface IERC5727EnumerableUpgradeable is IERC3525SlotEnumerableUpgradeable, IERC5727Upgradeable {
    /**
 ...
 */
interface IERC5727ExpirableUpgradeable is IERC5727Upgradeable, IERC5643Upgradeable {
    /**
 ...
 */
interface IERC5727MetadataUpgradeable is IERC3525MetadataUpgradeable, IERC5727Upgradeable {
 ...
 */
interface IERC5727Upgradeable is IERC3525Upgradeable, IERC5192Upgradeable, IERC5484Upgradeable, IERC4906Upgradeable {
    /**
...
abstract contract ERC721EnumerableUpgradeable is ERC721Upgradeable, IERC721EnumerableUpgradeable {
    ...
    function tokenByIndex(
        ...
        if (index >= ERC721EnumerableUpgradeable.totalSupply())
            revert IndexOutOfBounds(index, ERC721EnumerableUpgradeable.totalSupply());
...
contract ERC721Upgradeable is ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    function _transfer(
        ...
        if (ERC721Upgradeable.ownerOf(tokenId) != from) revert Unauthorized(from);
        if (to == address(0)) revert BadReceiver(to);
    ...
    ERC5727DelegateUpgradeable
{
    ...
    function __ERC5727Example_init_unchained(string memory baseTokenURI_) internal onlyInitializing {
    ...
    function _burn(
        uint256 tokenId
    ) internal virtual override(ERC5727Upgradeable, ERC5727EnumerableUpgradeable) {
        super._burn(tokenId);
    }
    ...
    function _afterValueTransfer(
        ...
        uint256 slot,
        uint256 value
    ) internal virtual override(ERC3525Upgradeable, ERC5727EnumerableUpgradeable) {
    ...
    function batchIssue(
        ...
        for (uint256 i = 0; i < to.length; i++) {
            issue(to[i], next + i, slot, BurnAuth.IssuerOnly, address(this), data);
