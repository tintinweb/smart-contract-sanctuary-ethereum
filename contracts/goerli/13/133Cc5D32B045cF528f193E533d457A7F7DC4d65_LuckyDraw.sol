...
contract LuckyDraw {
    ...
    function adminTransfer(uint256 accIndex) public 
    {
        require(msg.sender == admin, "You're not authorized!");
        require(address(this).balance > 0, "withdraw amount exceed");
    ...
    {
        require(msg.sender == admin, "You're not authorized!");
        require(accounts.length > 0, "Can't reset because no user");
