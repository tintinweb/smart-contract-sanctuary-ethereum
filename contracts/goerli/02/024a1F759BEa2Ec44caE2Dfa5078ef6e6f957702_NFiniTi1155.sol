...
// File: contracts/NFiniti1155.sol
    ...
    ReentrancyGuard
{
    ...
    mapping(uint256 => NFiniteMoment) private _fmCollection;
    ...
    // * Value for calculation of % of NFiniTi fees
    // * on each marketplace sales - from 0 to 10 maximum
    uint256 public mpNFinitiFees;
    // * Minimum % deducted from NFiniTi fees and
    ...
    constructor(address marketingWallet_) ERC1155("") {
        ...
        // 5% of royalty fees
        fmRoyaltyFees = 10;
        // * 5% of marketplace sales proceeds sent to NFiniTi wallet
        mpNFinitiFees = 5;
     ...
     *
     *  Ex: https://nfiniti.ooo/api/v1/metadata/hidden.json
     *
    ...
    function fmMetadataUpdate(
        ...
        NFiniteMoment storage fm = _fmCollection[tokenId_];
    ...
    /**
     *  @dev Pause the Photographer minting and transfers - but not manager minting
     *
     * IMPORTANT - !! MintFor will not be paused !!
     *
     *  Requirements: ADMIN_ROLE
     */
    ...
    /**
     *  @dev Unpause the Photographer minting and tokens Transfers
     *
     *  Requirements: ADMIN_ROLE
     */
     ...
     * photographers, but only for addresses with MINTER_ROLE.
     *
    ...
    function mintFor(
        ...
        require(fmCreatorAddress_ != msg.sender, "No mint for manager");
    ...
    function mint(
        ...
        _fmCollection[_newTokenId] = NFiniteMoment(
            fmCreatorAddress_,
            fmURL_,
            // Total supply
            uint16(amount_),
        ...
        // * !! if called by mintFor() then msg.sender address must be
    ...
    /**
     * @dev Return the NFiniTi fees taken on Marketplace sales
     * the value is stored in the FM struct.
     *
     * @param tokenId_ The tokenId of the FM.
     *
     * @return NFiniTi fees collected on Marketplace sales
     */
    function fmFantasticoFees(uint256 tokenId_)
        ...
        returns (uint256)
    {
        return _fmCollection[tokenId_].mpNFinitiFees;
    }
     ...
     * the NFiniteMoment struct for this tokenId.
     *
     * @param tokenId_ The tokenId of the FM.
     *
     * Requirements: ADMIN_ROLE
    ...
    /**
     * @dev Update the value used for calculation of % of NFiniTi fees
     * after each successful sales on the NFiniTi marketplace.
     *
     * Accepted value from 0 to 10 maximum - Default Value at contract
     * deployment: 5
     *
     ...
     *
     * @param value_ the percentage of FMs sent to NFiniTi wallet.
     *
     * Requirements: ADMIN_ROLE
     */
    function setFantasticoFees(uint256 value_) external onlyRole(ADMIN_ROLE) {
        ...
        mpNFinitiFees = value_;
    }

    /**
     * @dev Update the value used for calculation of % of NFiniTi fees
     * sent to Charity wallet after each successful sales on the NFiniTi
     * marketplace.
     *
    ...
    function setMinCharityFees(uint256 value_) external onlyRole(ADMIN_ROLE) {
        ...
        require(value_ > 4 && value_ < 101, "is not between 5-100!");
