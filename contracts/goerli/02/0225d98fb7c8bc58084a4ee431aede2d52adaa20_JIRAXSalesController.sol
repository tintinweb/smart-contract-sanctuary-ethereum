...
contract JIRAXSalesController is Ownable {
    ...
    function deposit(address partner) public payable {
    ...
    function setPartner(address partner, uint256 split) public onlyOwner {
    ...
    function setDeveloperSplit(uint256 _developerSplit) public onlyOwner {
        developerSplit = _developerSplit;
    }
}