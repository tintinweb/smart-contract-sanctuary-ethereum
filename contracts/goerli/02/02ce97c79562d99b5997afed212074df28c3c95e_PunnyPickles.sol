...
contract PunnyPickles is ERC721, ERC721URIStorage, Pausable, DefaultOperatorFilterer, Ownable {
    ...
    string public baseURI = "ipfs://QmVHFfAWuFTxKu6eL1JDnN7Pam5Ns7v9v5qPmaugRSvGJJ/";

    constructor() ERC721("PPTest1", "PP") {
        baseURI;
    ...
    function safeMint(address to, uint256 _numTokens) public payable {
        ...
        require((_tokenIdCounter.current() + _numTokens) <= _totalSupply, "Total amount of mints has been already reached.");
