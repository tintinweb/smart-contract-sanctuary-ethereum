...
contract MarketPlace is ERC721, ERC721URIStorage, Ownable {
    ...
    function BuyNfts(uint256 _tokenId, uint256 amount) public {
        ...
        if (Sale[_tokenId].saleCounter < 1) {
            uint256 ownerPercentage = (amount * rewardPercentage1) /
                PercentageDivider;
            amount -= ownerPercentage;
            require(
            ...
            uint256 ownerPercentage = (amount * rewardPercentage2) /
                PercentageDivider;
            uint256 firstOwnerPrecentage = (amount * rewardPercentage3) /
                PercentageDivider;
            amount = amount - (ownerPercentage + firstOwnerPrecentage);
            require(
                IERC20(Token).transferFrom(
                    msg.sender,
                    owner(),
