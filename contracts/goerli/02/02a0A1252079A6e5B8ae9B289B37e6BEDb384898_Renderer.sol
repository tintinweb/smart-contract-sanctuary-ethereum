        ...
        returns (string memory)
    {
        return
            string.concat(
                ...
                getDayAttribute(":", "126", "-3", "200", "40", "720", "520"),
                getDayAttribute(
                    date.hour,
                    "142",
                    "0",
                ...
                getDayAttribute(date.day, "11", "0", "20", "20", "334", "730")
            );
    }
    ...
    function prepareSVGStyle() internal pure returns (string memory) {
        return
            string.concat(
                ...
                '<defs><style>@font-face{font-family:"HelveticaNowDisplayBd";src:url("./HelveticaNowDisplayBd.woff") format("woff"); font-weight:normal;font-style:normal;} div {height: 100%; display:flex; flex-direction:bolumn; align-items:center; justify-content:center} p {color:white; margin:0;}<style></defs>'
            );
    }
