    ...
    constructor(address _tableland) ERC721("FrensFactory", "FRENS") {
        ...
        tableIDs["frens"] = tableland.createTable(
            ...
            string.concat(
                ...
                " (id INT, name TEXT NOT NULL, skin TEXT NOT NULL, ears TEXT NOT NULL, head TEXT NOT NULL, hair TEXT NOT NULL DEFAULT '', eyes TEXT NOT NULL, clothes TEXT NOT NULL DEFAULT '', mouth TEXT NOT NULL DEFAULT '', accessory TEXT NOT NULL DEFAULT '', background TEXT NOT NULL DEFAULT '');"
            )
        );
        ...
        tableIDs["attributes"] = tableland.createTable(
            ...
            string.concat(
                ...
                Strings.toString(block.chainid),
                " (id INT, slug TEXT NOT NULL UNIQUE, name TEXT NOT NULL, type TEXT NOT NULL CHECK(type IN ('skin', 'ears', 'head', 'hair', 'eyes', 'clothes', 'mouth', 'accessory', 'background')), cost TEXT NOT NULL, collection_slug TEXT NOT NULL, image_url TEXT NOT NULL, available INT NOT NULL, total INT NOT NULL);"
            )
        );
        ...
        tableIDs["collections"] = tableland.createTable(
            ...
            string.concat(
                ...
                Strings.toString(block.chainid),
                " (id INT, slug TEXT NOT NULL, name TEXT NOT NULL, collection_address TEXT, royalty_address TEXT, royalty_percent REAL NOT NULL DEFAULT 0);"
            )
        );
    ...
    function safeMint(address to) public returns (uint256) {
        ...
        tableland.runSQL(
            ...
            string.concat(
                "INSERT INTO ",
                tables["frens"],
                " (id, name, skin, ears, head, eyes) VALUES (",
                Strings.toString(newItemId),
                ", 'Fren-1', 'skin-1', 'ears-1', 'head-1', 'eyes-1')"
            )
        );
