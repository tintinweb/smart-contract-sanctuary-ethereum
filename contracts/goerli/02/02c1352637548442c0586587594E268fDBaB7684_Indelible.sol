// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"Test", unicode"TESTTTT", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/fdacc73a-d8ed-4297-927b-7eb4cfabffe5", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/fdacc73a-d8ed-4297-927b-7eb4cfabffe5", "test.xyz", 0, "0xEa3BC00e7FBe881D8D10931714Fa55Ba83E1c54F");

        constructor() ERC721A(unicode"Test", unicode"TST") {
            TIERS[0] = [32,102,112,121,148,158,161,180,192,217,3577];
            TIERS[1] = [2,2,8,8,14,15,15,15,19,27,31,32,36,42,51,56,58,60,61,62,63,65,66,68,85,86,90,98,102,104,108,114,128,129,130,136,148,152,161,177,213,242,269,270,355,396,431];
            TIERS[2] = [358,716,801,1234,1891];
            TIERS[3] = [654,1921,2425];
            TIERS[4] = [1,10,38,61,70,81,136,137,138,156,158,177,181,234,240,241,310,316,361,388,429,444,693];
            TIERS[5] = [95,170,200,371,449,738,864,1053,1060];
            TIERS[6] = [85,395,556,659,808,2497];
