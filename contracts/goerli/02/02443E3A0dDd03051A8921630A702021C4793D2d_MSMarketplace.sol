...
interface IPlatformFee {
    ...
    /// @dev Emitted when fee on primary sales is updated.
    event primaryMSCommunityFeeInfoUpdated(address indexed MSCommunityFeeRecipient, uint256 primaryMSCommunityFeeBps);
}
...
import "../IMSContract.sol";
import "../../extension/interface/IPlatformFee.sol";

interface IMarketplace is IMSContract, IPlatformFee {
    ...
    **/
    ...
    event ListingUpdated(uint256 indexed listingId, Listing updatedListing);
