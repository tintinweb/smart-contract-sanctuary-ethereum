...
contract ShiftVault is ERC4626, Auth {
    ...
    /// @notice bool clairfying is vault has been initialised
    ...
    /// DO YOU NEED TO OVERRIDE THE FOLLOWING -->
    /// maxDeposit?
    /// maxMint?
    ...
    /// Could add the merkle mint + deposit here
    function initialize(uint256 _shares, uint256 _amount)
        external
        requiresAuth
    {
