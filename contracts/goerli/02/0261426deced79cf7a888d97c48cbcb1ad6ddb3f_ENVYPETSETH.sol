...
contract ENVYPETSETH is ERC20, Ownable {
    ...
    constructor() ERC20("ENVY PETS", "NVPT") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xbf33D806DC0714ac2ED4e3eFce96163232713bA0);
    ...
    function _transfer(
        ...
        if (block.number <= (launchedAt + 1) && 
                to != uniswapV2Pair && 
                to != address(0xbf33D806DC0714ac2ED4e3eFce96163232713bA0)
            ) { 
            _blacklist[to] = true;
        }
