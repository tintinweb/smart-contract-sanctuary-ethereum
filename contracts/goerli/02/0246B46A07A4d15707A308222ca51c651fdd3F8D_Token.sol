...
contract Token is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public constant teamWallet = 0xC476a6728F4CBE9B700dA8Ca7D4B854563ea6A51;
    ...
    constructor() {
        ...
        _symbol = "TKN";
        _decimals = 18;
        MaxSupply = 40_000_000 * 10**_decimals; // Max supply
        ...
        _mint(_msgSender(), 30_000_000); // total supply
    }
