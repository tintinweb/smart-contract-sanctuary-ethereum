    ...
    PausableUpgradeable
{
    ...
    IERC20Upgradeable public token; // reward token
     ...
     * @notice initialzie
     *
     * @param _token            {IERC20Upgradeable}    Address of reward token
    ...
    function setEmergencyWithdrawFee(uint256 _emergencyWithdrawFee) external onlyOwner {
        require(_emergencyWithdrawFee < FEE_MULTIPLIER, "Fee can't be 100%");
