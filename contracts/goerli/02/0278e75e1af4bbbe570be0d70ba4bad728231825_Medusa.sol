...
contract Medusa is ERC721EnumerableCustom, Ownable {
  ...
  uint256 public presalePrice = 89000000; // USDC
  uint256 public publicPrice = 99000000; // USDC
  ...
  constructor(address _paperKey, bool isGoerli)
    ERC721Custom("Medusa", "Medusa")
  {
    address _paperKeyManagerAddress = 0x678a3F64A1bF33Ba0746fFD88Ba749B40B565Da5;

    if (isGoerli) {
      usdcAddress = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F;
      _paperKeyManagerAddress = 0x7924D04fd976B2A3dE32D9CEDCBC90Be4400353e;
      presaleOpen = true;
      publicSaleOpen = true;
      whitelistedAddresses[msg.sender] = true;
    }

    setPaperKeys(_paperKeyManagerAddress, _paperKey);
  }
  ...
  function setPaperKeys(address _paperKeyManagerAddress, address _paperKey)
    public
    onlyOwner
  {
  ...
  function ineligibilityReason(uint256 quantity)
    external
    view
    returns (string memory)
  {
