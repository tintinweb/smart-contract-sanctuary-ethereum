...
contract MadMaraudersOfTheAccidentalApocalypse is ERC721Guardable, Owned {
    ...
    MintableTokenDetails public enforcerTokenDetails; // max supply 5007 (enforced by MadMarauderBoxOBadGuys contract)
    MintableTokenDetails public warlordTokenDetails; // max supply 3038 (enforced by MadMarauderBoxOBadGuys contract)
