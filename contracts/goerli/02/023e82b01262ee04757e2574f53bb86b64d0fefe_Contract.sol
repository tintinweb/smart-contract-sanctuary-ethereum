...
contract Contract is ERC721A, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public presaleCost = 70 ether;
    uint256 public publicCost = 100 ether;


    constructor(string memory _hiddenMetadataURI) ERC721A("Test Contract", "TC") {
