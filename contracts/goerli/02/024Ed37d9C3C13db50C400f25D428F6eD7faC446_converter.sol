...
import "../utils_smart_contract/converter.sol";
...
contract NyxProposalHandler is Ownable {
        ...
        returns (ProposalConf memory)
    {
        ...
        return ProposalConf(
            converter.bytesToUint(confBytesArray[0]),
            converter.bytesToUint(confBytesArray[1]),
            converter.bytesToBool(confBytesArray[2]),
            converter.bytesToAddress(confBytesArray[3]),
            converter.bytesToAddress(confBytesArray[4]),
            converter.bytesToBool(confBytesArray[5])
        );
    }
