...
contract CC0PY is ERC721, ERC721Burnable, Ownable, ReentrancyGuard {
    ...
    string private hiddenMetadataUri;   // ipfs://QmWFfq5QytKVLuMi2P2bsbpA8eBJV45PJQicstM3pDcL5C/   TEST
    string private baseMetadataUri;     // ipfs://QmesrGRGMB1KyLbEGoHyCT6o8EUugFGE3Hvu3bQh8Q9kpq/   TEST

    uint256 public maxSupply = 666;
    uint256 public totalSupply;
    uint256 public mintPrice = 0.0099 ether; // TEST make it 0.099

    bool public isWhitelistMintOpen = true;
    bool public isPublicMintOpen = false;
    bool public isRevealed = true;          // Start false, change it TEST
    ...
    function publicMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) nonReentrant {
        ...
        if (totalSupply > 20){ // TEST make it 200
            require(msg.value >= mintPrice * _mintAmount, "Invalid price input!");
        }
