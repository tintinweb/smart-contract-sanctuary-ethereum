...
//*********************************************************************//
//
//                                     __            ____  __              ______      __           __   _   ______________   ______            __             __ 
//   _________  ____ ___  ____  __  __/ /____  _____/ __ )/ /__  __  __   / ____/___ _/ /____  ____/ /  / | / / ____/_  __/  / ____/___  ____  / /____  ____  / /_
//  / ___/ __ \/ __ `__ \/ __ \/ / / / __/ _ \/ ___/ __  / / _ \/ / / /  / / __/ __ `/ __/ _ \/ __  /  /  |/ / /_    / /    / /   / __ \/ __ \/ __/ _ \/ __ \/ __/
// / /__/ /_/ / / / / / / /_/ / /_/ / /_/  __/ /  / /_/ / /  __/ /_/ /  / /_/ / /_/ / /_/  __/ /_/ /  / /|  / __/   / /    / /___/ /_/ / / / / /_/  __/ / / / /_  
// \___/\____/_/ /_/ /_/ .___/\__,_/\__/\___/_/  /_____/_/\___/\__,_/   \____/\__,_/\__/\___/\__,_/  /_/ |_/_/     /_/     \____/\____/_/ /_/\__/\___/_/ /_/\__/  
//                    /_/                                                                                                                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3EbAaB0476FCE274c58942Ea89589934801d88b3];
  address public erc20Payable = 0x3EbAaB0476FCE274c58942Ea89589934801d88b3;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmNsnDLGAYdFHZFsQo7hXKN5cVQXdQNNmcBRNyNCFpx8uH/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/l4w0JoMhxh939yeIjld3/contract-metadata";
  }
...
// File: contracts/ComputerBleuGatedNftContentContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ComputerBleuGatedNftContentContract is RamppERC721A {
    constructor() RamppERC721A("computerBleu Gated NFT Content", "CPBLEU"){}
}
