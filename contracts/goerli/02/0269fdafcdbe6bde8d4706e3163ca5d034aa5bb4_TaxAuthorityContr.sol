...
contract TaxAuthorityContr {

    /* ---------------------------------------------------------------- */
    /* --------------------------- CONTRACT --------------------------- */
    /* ---------------------------------------------------------------- */

    BankContr BankContrVar;
    function instantiateBankContr(address _addr) public {
        BankContrVar = BankContr(_addr);
    }
    ...
    /* Read citizen */
    function getTotalTaxAmt() public view returns(uint) {
        return BankContrVar.getTotalTaxAmt();
    }
