...
contract OSB1155 is ERC1155Upgradeable, ERC2981Upgradeable, OwnableUpgradeable {
    ...
    event MintWithRoyalty(address indexed to, uint256 amount, string tokenUri, address indexed receiverRoyaltyFee, uint96 indexed percentageRoyaltyFee);
     ...
     * @return tokenId Token id of owner
     */
    function mintWithRoyalty(address _to, uint256 _amount, string memory _tokenUri, address _receiverRoyaltyFee, uint96 _percentageRoyaltyFee) external onlyOwnerOrController returns (uint256 tokenId) {
        ...
        emit MintWithRoyalty(_to, _amount, _tokenUri, _receiverRoyaltyFee, _percentageRoyaltyFee);
    }
     ...
     * @return tokenIds The list of owned tokens
     */
    function mintBatchWithRoyalty(address _to, uint256[] memory _amounts, string[] memory _tokenUris, address[] memory _receiverRoyaltyFees, uint96[] memory _percentageRoyaltyFees) external onlyOwnerOrController returns (uint256[] memory tokenIds) {
