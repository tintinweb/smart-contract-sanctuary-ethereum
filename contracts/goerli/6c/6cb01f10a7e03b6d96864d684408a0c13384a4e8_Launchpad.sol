...
constructor(address _adminAddress,address _offeringToken, address _projectOwner, address _wkdCommit, uint256 _launchPercentShare) {
    ...
    function initialize(
        ...
        // projectOwner = _projectOwner;
        // wkdCommit = WKDCommit(_wkdCommit);
        emit init(_startBlock, _endBlock, _raisingAmount, _offeringAmount);
    }
