...
//    CalendarData public calendarData;
    ...
    event IssuedBond(
        ...
        uint256 _interest_rate, string _currency, uint256 _start_date,
        uint256 _par_value
    );
    ...
    function _storeBaseData(
        ...
        baseData = baseData_;
        emit IssuedBase(baseData_.name, baseData_.symbol, baseData_.token_id, baseData_.terms);
    }
    ...
    function _storeBondData(
        ...
        bondData = bondData_;
        emit IssuedBond(bondData_.maturity_date, bondData_.interest_rate, bondData_.currency, bondData_.start_date, bondData_.par_value);
    }
