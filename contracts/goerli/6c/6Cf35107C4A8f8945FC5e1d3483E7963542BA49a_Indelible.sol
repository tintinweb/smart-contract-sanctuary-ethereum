// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Thong", unicode"Box"];
        ...
        ContractData public contractData = ContractData(unicode"New Collection", unicode"Description", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/1104f393-e1e4-4c1c-9aeb-53d69a6d78b1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/1104f393-e1e4-4c1c-9aeb-53d69a6d78b1", "", 500, "0xD84E30d07990E853fb195C93E76BD5740A7aD0fF");

        constructor() ERC721A(unicode"New Collection", unicode"thong") {
...
TIERS[1] = [100];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"New Collection #");
