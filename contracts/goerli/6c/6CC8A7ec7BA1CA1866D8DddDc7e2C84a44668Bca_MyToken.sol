...
/*
  ...
  Upgradeable contracts are not fully supported in Remix
*/
...
contract MyToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    bytes32 public constant BLOCKLISTED_ROLE = keccak256("BLOCKLIST_ROLE");
    ...
    function initialize( address admin, address blockLister) initializer public {
        __ERC20_init("MyTokenV1", "MTKV1");
        ...
        // An account with this role will be able to manage any other role, unless _setRoleAdmin is used to select a new admin role.
    ...
    function mint(address to, uint256 amount) external {
        require(hasRole(MINTER_ROLE, msg.sender), "Caller has no minter rights.");
        _mint(to, amount);
    ...
    function burn(uint256 amount) public override {
        require(hasRole(MINTER_ROLE, msg.sender), "Caller has no burner rights.");
    ...
    function blockList(address _blockListedAddress) external {
        require(hasRole(BLOCKLISTER_ROLE, msg.sender), "Caller has no blocklister rights.");
    ...
    function destroyBlockFunds(address _blockListedAddress) public {
        require(hasRole(DESTROYER_ROLE, msg.sender), "Caller has not the destroyer role");
