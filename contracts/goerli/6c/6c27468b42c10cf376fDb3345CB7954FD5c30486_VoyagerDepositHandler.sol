    ...
    IApplication
{
    ...
    function depositReserveToken(
        ...
        gatewayContract.requestToRouter(payload, routerBridge, 1000000, Utils.FeePayer.APP);

        // emit Deposit(1, nonce, swapDetails.destChainIdBytes, executeDetails.widgetID, isUsdcDeposit);
    }
    ...
    function depositReseveTokenAndExecute(
        ...
        // emit Deposit(2, nonce, swapDetails.destChainIdBytes, executeDetails.widgetID, isUsdcDeposit);
    }
    ...
    function depositLPToken(bytes memory swapData, bytes memory executeData) external nonReentrant whenNotPaused {
        ...
        // emit Deposit(3, nonce, swapDetails.destChainIdBytes, executeDetails.widgetID, false);
    }
    ...
    function depositLPTokenAndExecute(
        ...
        // emit Deposit(4, nonce, swapDetails.destChainIdBytes, executeDetails.widgetID, false);
    }
    ...
    function depositNonReserveToken(
        ...
        // emit Deposit(5, nonce, swapDetails.destChainIdBytes, executeDetails.widgetID, isUsdcDeposit);
    }
    ...
    function depositNonReserveTokenAndExecute(
        ...
        // emit Deposit(6, nonce, swapDetails.destChainIdBytes, executeDetails.widgetID, isUsdcDeposit);
    }
        ...
        returns (uint64)
    {
        ...
        _reserve.lockERC20(swapDetails.srcTokenAddress, msg.sender, _oneSplitAddress, swapDetails.srcTokenAmount);
