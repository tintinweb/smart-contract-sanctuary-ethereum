...
contract MetatopiaRNG is VRFConsumerBaseV2 {
  ...
  address public PyeMarketContract;
  ...
  function setPyeMarketContract(address _address) external onlyOwner {
    PyeMarketContract = _address;
  }

  modifier onlyPyeMarketContract() {
    require(msg.sender == PyeMarketContract , "Only BullRun.sol");
    _;
  }
