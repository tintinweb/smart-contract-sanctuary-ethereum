...
contract RandomSeed is VRFConsumerBaseV2, AccessControl, ConfirmedOwner {
    ...
    function revokeAdmin(address _admin) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function revokeOracle(address _oracle) external onlyRole(ADMIN_ROLE) {
