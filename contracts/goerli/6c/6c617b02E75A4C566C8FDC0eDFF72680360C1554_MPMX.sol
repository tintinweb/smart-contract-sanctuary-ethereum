...
{    
    ...
    MintPass public MintPassSale = MintPass(
        ...
        999,          // [2] -> _DefaultMaxUserPurchaseableAmount
        417,        // [3] -> _MaximumAvailableForSale
        1662286500, // [4] -> _StartingBlockUnixTimestamp
        667,        // [5] -> _SecondsBetweenPriceDecay
        true,      // [7] -> _ActivePublic
        false,       // [8] -> _ActiveBrightList
        true,       // [6] -> _AllowMultiplePurchases
        false,      // [9] -> _ActiveRespend
        0xdbc139e38ba2175e38f11d2a753dccc580cb826e7415e104c2e775b38b026a73
    ); 
    MintPack public MintPackSale = MintPack(
        ...
        1662286500, // [4] -> _StartingBlockUnixTimestamp
        667,        // [5] -> _SecondsBetweenPriceDecay
        true,      // [6] -> _ActivePublic
        false,       // [7] -> _ActiveBrightList
        true,       // [8] -> _AllowMultiplePurchases
        false,      // [9] -> _ActiveRespend
        0x0fe0ce4e02ceb1721642927337e42acb926974618ba79bb5402725380375e03d
    );
    ...
    { 
        ...
        _mint(address(this), 417);  // Remaining For Sale:                  [TokenIDs: 483 - 899] (417)
     ...
     * @dev Purchases NFTs
     */
    function PurchasePass(uint Amount, bytes32[] calldata Proof) public payable nonReentrant
    { 
     ...
     */
    function PurchasePack(uint Amount, bytes32[] calldata Proof) public payable nonReentrant
    {
        ...
        MintPackInternalSale._MintPackIndex += AmountToMint;
        ...
        emit PurchasedMintPack(msg.sender, Amount, msg.value, MintPackInternalSale._AmountSold);
    }
     ...
     * @dev Returns Current Dutch Price For Mint Pass
     */
    function CurrentPriceMintPass(uint CurrentUnixTimestamp) public view returns (uint Price) 
    {
        if(CurrentUnixTimestamp <= MintPackSale._StartingBlockUnixTimestamp) { return MintPassSale._PriceStart; }
        uint CurrentPrice = MintPassSale._PriceStart;
        uint SecondsElapsed = CurrentUnixTimestamp - MintPassSale._StartingBlockUnixTimestamp;
        CurrentPrice >>= SecondsElapsed / MintPassSale._SecondsBetweenPriceDecay; // Div/2 For Each Half Life Iterated Upon
        CurrentPrice -= (CurrentPrice * (SecondsElapsed % MintPassSale._SecondsBetweenPriceDecay)) / MintPassSale._SecondsBetweenPriceDecay / 2;
        if(MintPassInternalSale._FinalClearingPrice > 0) { return MintPassInternalSale._FinalClearingPrice; } // Sale Finished
        if(CurrentPrice <= MintPassSale._PriceEnd) { return MintPassSale._PriceEnd; } // Sale Ended At Resting Band
