...
// File: contracts/testcryptodozies.sol
...
contract CryptoDoziesTestB is ERC721, Ownable {
    using Strings for uint256;
    ...
    function whitelistMint(uint256 amount, bytes32[] calldata merkleProof) public payable {
        require(!mintState, "Mint deactivated");
        require(!whitelistMintState, "Whitelist Mint deactivated");
    ...
    function mint(uint256 amount) public payable {
        require(!mintState, "Mint deactivated");
        require(whitelistMintState, "Whitelist Mint activated");
