...
import { IEACAggregatorProxy } from "./deps/IEACAggregatorProxy.sol";
import { Errors } from "./deps/Errors.sol";
import { IACLManager } from "./deps/IACLManager.sol";
import { IPoolAddressesProvider } from "./deps/IPoolAddressesProvider.sol";
...
contract ERC721OracleWrapper is IEACAggregatorProxy {
    ...
    function setOracle(address _oracleAddress) external onlyAssetListingOrPoolAdmins {
        oracleAddress = INFTFloorOracle(_oracleAddress);
    }
