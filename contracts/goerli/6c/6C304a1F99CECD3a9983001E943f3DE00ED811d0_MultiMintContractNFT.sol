...
// TODO: Rename before final upload
contract MultiMintContractNFT is ERC721, ReentrancyGuard, Signable {
    ...
    function mint(uint256 amount) external payable costs(amount) phaseRequired(Phase.MAIN_SALE) {
