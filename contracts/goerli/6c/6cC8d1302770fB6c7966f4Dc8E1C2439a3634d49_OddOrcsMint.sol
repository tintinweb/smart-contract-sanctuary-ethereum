    ...
    ReentrancyGuardUpgradeable
{
    ...
    */
    function initialize(
        ...
        spectrumPassHoldersSale.startTime = 1670227094;
        spectrumPassHoldersSale.endTime = spectrumPassHoldersSale.startTime + 12 hours;
        spectrumPassHoldersSale.limit = 1;
        spectrumPassHoldersSale.remainingTokens = 1000;
        spectrumPassHoldersSale.mintPrice = 0 ether;

        whitelistSale.startTime = spectrumPassHoldersSale.endTime;
        whitelistSale.endTime = whitelistSale.startTime + 12 hours;
        whitelistSale.limit = 3;
        whitelistSale.remainingTokens = 9900;
        whitelistSale.mintPrice = 0.005 ether;

        publicSale.startTime = whitelistSale.endTime;
        publicSale.endTime = publicSale.startTime + 2400 hours;
        publicSale.limit = 3;
        publicSale.remainingTokens = 9900;
        publicSale.mintPrice = 0.005 ether;
    }
    ...
    */
    function whitelistSaleMint(
        ...
        require(msg.value > whitelistSale.mintPrice, "WhitelistSale: Not Enough Funds paid");
    ...
    */
    function publicMint(uint256 _amount) external payable whenNotPaused nonReentrant checkSupply(_amount) {
        ...
        require(msg.value > publicSale.mintPrice, "PublicSale: Not Enough Funds paid");
