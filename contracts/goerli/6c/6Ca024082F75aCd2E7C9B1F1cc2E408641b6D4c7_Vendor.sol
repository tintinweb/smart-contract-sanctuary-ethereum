...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 amountTokens) public {
    yourToken.transferFrom(msg.sender, address(this), amountTokens);
    uint256 tokensToEth = amountTokens / tokensPerEth;
    address(msg.sender).call{value: tokensToEth}('');
    emit SellTokens(msg.sender, tokensToEth, amountTokens);
  }
}
