...
contract SpitYard is FxBaseRootTunnel, Ownable {
    ...
    ///@notice check to see if this reverts without requiring owner verification
    ...
    function getUserStake(address _address) public view returns (uint256[] memory) {
    ...
    function setSpitBuddies(address _spitBuddiesContract) public onlyOwner {
        spitBuddies = IERC721A(_spitBuddiesContract);
    }

    /// @notice Set the contract addresses for all contract instances.
    /// @param _jiraCentral The contract address of JiraCentral.
    function setJiraCentral(address _jiraCentral) public onlyOwner {
