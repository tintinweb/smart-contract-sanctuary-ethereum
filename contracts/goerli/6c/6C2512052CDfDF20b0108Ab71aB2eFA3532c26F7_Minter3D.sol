...
contract Minter3D is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    //Initial Settings ->
    string public tokenName = "Minter Test";
    string public tokenSymbol = "MinterTST";
    uint256 public maxSupply = 10000;
    uint256 public maxReservedSupply = 0;
    uint256 public reservedSupplyMinted = 0;
    
    uint256 public firstWaveSupply = 1000;
