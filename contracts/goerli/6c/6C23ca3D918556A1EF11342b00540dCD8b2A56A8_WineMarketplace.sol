...
contract WineMarketplace{
    ...
    // }
     function createLot(address _seller, string memory _name, uint256 _date,  string memory _origin, uint256 _price, string memory _description, uint256 _stock, string memory _image) public returns (uint256) {
        Lot storage lot = lots[numberOfLots];
