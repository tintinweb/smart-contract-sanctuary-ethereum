...
contract TheMetaRobbersVault is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard{
 ...
 constructor(
  ...
  function mintVault(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
