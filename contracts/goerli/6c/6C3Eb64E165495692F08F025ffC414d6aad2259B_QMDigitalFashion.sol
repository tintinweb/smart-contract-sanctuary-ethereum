...
contract QMDigitalFashion is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155URIStorageUpgradeable {
    ...
    struct Promocode {
        ...
        uint256 discountedPriceInTokens;
        string code;
    }
    /**
    ...
    function getNftInfo(uint256 tokenId) public view returns (NftInfo memory) {
        ...
        info.maxSupply = totalSupply(tokenId);
        info.priceInTokens = getPriceInTokens(tokenId, '');
        return info;
    }
    ...
    function mintForAddress(
        ...
        validateStableCoins(stableCoinAddress, stableCoinAmount, tokenId, promocode);
    ...
    function validateStableCoins(
        ...
        require(stableCoinAmount == getPriceInTokens(tokenId, promocode), "Not enough tokens sent to mint");
    ...
    function getPriceInUsd(uint256 tokenId, string memory promocode) public view returns (uint256) {
        ...
        if (nftInfo[tokenId].priceInUsd > 0) {
