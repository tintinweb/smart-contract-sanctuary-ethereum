...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xA946b68c41896bFA8F58D50D1950C38a054e88e1];
  address public erc20Payable = 0xA946b68c41896bFA8F58D50D1950C38a054e88e1;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 3) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdfesFXsAZpS7hSvYUMM1dVQbqTYxK2g4iz35JbPcAyQ8/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XDvdM6Usl4wRPkv2zc08/contract-metadata";
  }
...
contract MyMintplexProjectContract is RamppERC721A {
    constructor() RamppERC721A("My Mintplex Project", "RGI"){}
}
