...
contract CatalystApp is AragonApp {
     ...
     */
    function addCatalyst(address _owner, string _domain) external auth(MODIFY_ROLE) {
        ...
        catalystById[id] = Catalyst({id: id, owner: _owner, domain: _domain, startTime: startTime, endTime: 0});
