...
import { iGTON_DiscountOracle } from "../../GTON/iGTON_DiscountOracle.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint256 constant DEFAULT_CHAINID = 1000;
    ...
    function sendMessage(
        ...
        iGTON_DiscountOracle oracle = iGTON_DiscountOracle(resolve('GTON_DiscountOracle'));
...
library Lib_PredeployAddresses {
    ...
    address internal constant GTON_CHAIN_CONFIG = 0x4200000000000000000000000000000000000005;
    address internal constant OVM_ETH = 0x420000000000000000000000000000000000000A;
    address internal constant GTON_COINBASE = 0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000;
