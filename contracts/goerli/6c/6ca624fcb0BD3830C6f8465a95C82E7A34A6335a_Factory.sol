...
contract Factory {
    ...
    mapping(address => address) public _ownerToWallets;

    /// @notice Mapping of the wallet address to the owner address.
    mapping(address => address) public _walletToOwners;
    ...
    function getOrDeployWallet(address owner) external returns (address wallet) {
        ...
        (bool success, ) = wallet.call(abi.encodeWithSignature("initiate(address)", owner));
