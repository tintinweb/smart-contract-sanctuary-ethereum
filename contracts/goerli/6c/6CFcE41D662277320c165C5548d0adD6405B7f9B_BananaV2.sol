...
contract BananaV2 is ERC20("Banana", "BANANA") {
	...
	address public yieldHub;
	IOldeNana public oldeNana;

	constructor(address _nana, address _yieldHub) public {
		// should this be changed
		require(_yieldHub != address(0), "null address");
		_mint(msg.sender, 3_350_000 ether);
		oldeNana = IOldeNana(_nana);
		yieldHub = _yieldHub;
	}
	...
	function swap(uint256 _amount) public {
		oldeNana.transferFrom(msg.sender, address(this), _amount);
