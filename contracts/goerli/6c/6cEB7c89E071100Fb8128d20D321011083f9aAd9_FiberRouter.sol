...
contract FiberRouter is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function swapAndCrossETH(
        ...
        // uint currentChainId = getChainId();
        require(getChainId() != crossTargetNetwork && path[0] != crossTargetToken, "ERROR: SAME TOKEN WITH SAME NETWORK");
    ...
    */
    ...
    ) internal 
    {
        ...
        FundManager(pool).swapToAddress(crossToken, amountCrossMin, crossTargetNetwork, crossTargetToken, to);
    }
