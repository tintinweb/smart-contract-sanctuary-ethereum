...
contract ExponentialCurve is ICurve, CurveErrorCodes {
    ...
    function test1111111(
        uint256 x,//50000000000000
        uint256 n,//10
        uint256 baseUnit//5000000000000000
    ) external pure returns (uint256 z,uint256 n1,uint256 n2,uint256 count1,uint256 count2) {
        assembly {
            switch x
            case 0 {
                switch n
