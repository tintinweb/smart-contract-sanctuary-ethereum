...
contract RetToken is
    ERC20PermitUpgradeable,
    AccessControlUpgradeable,
    ReentrancyGuardUpgradeable
{
    bytes32 public constant DEV = keccak256("DEV");
    bytes32 public constant KONKRETE = keccak256("KONKRETE");
    ...
    function setSeller(address _seller) external onlyRole(KONKRETE) {
        seller = _seller;
    }

    function mint(address _to, uint256 _amount) external {
        require(msg.sender == seller, "Only Official Seller");
        _mint(_to, _amount);
    }
}
