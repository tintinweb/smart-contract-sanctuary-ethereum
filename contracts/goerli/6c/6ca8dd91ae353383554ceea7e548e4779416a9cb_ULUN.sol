...
contract ULUN is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ULUN";
    string private constant _symbol = "ULUN";
    ...
    address payable private _developmentAddress = payable(0x5053A536598F77C0e8473D39D223C87c582a2372);
    address payable private _marketingAddress = payable(0x5053A536598F77C0e8473D39D223C87c582a2372);
    ...
    function setBot(address[] calldata accounts, bool excluded) public onlyOwner {
