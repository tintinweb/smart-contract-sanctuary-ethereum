...
contract BBBB is ERC20, Ownable {
    ...
    function updateFees(uint8 _liquidityFee, uint8 _developmentFee) public onlyOwner {
        liquidityFee = _liquidityFee;
        developmentFee = _developmentFee;
    }

    function updateMaximumHold(uint256 _maximumHold) public onlyOwner {
        maximumHold = _maximumHold;
    }

    // Allow owner to claim mis-directed Ξ
