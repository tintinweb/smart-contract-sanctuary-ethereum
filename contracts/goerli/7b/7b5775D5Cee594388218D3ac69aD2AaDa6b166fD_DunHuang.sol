...
contract DunHuang is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint64 public constant MAX_TOKEN = 6000;
    ...
    constructor() ERC721A("Dun Huang", "DH") {}
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return bytes(baseURI).length != 0 ? baseURI : revealingURI;
    }
