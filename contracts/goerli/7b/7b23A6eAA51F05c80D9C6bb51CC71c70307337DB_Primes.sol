...
// @author: g56d
//
// Primes is an on-chain collection of 1575 unique scalable, animated and interactive artworks created by g56d
//
...
contract Primes is ERC721, Ownable {
    ...
    function tokenURI(
        ...
        string
            memory description = "Primes is an on-chain collection of 1575 unique scalable, animated and interactive artworks created by g56d";
    ...
    function testValues(uint x, uint y) public pure returns (string memory) {
        string memory minV = PrimesUtils.setMinValuesAnimation(x, y);
        string memory maxV = PrimesUtils.setMaxValuesAnimation(x, y);
        return string(abi.encodePacked(minV, ";", maxV, ";", minV));
    }

    function testPath(uint x, uint y) public pure returns (string memory) {
        string memory d = PrimesUtils.setDefinition(x, y);
        return d;
    }

    function testMinValues(uint x, uint y) public pure returns (string memory) {
        string memory v = PrimesUtils.setMinValuesAnimation(x, y);
        return v;
    }

    function testMaxValues(uint x, uint y) public pure returns (string memory) {
        string memory v = PrimesUtils.setMaxValuesAnimation(x, y);
        return v;
    }
    ...
    function setMaxValuesAnimation(
        ...
        if (x == 200 && y == 0) {
            ...
            if (x == 0 || x == 300 || x == 600) {
                if (y == 0 || y == 200 || y == 400 || y == 600 || y == 800) {
                    // lb
                    string memory _m = y == 0 ? "M-50" : "M";
                    string memory _h = y == 0 ? "H-50" : "H";
