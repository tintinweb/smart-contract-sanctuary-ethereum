...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x41341180712FeC3702141e927BFc84a0055c2D59];
  address public erc20Payable = 0x41341180712FeC3702141e927BFc84a0055c2D59;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeieqpctz5dnleguvfpqpcrk6cn2p2c3lvcwl4a442fnmoyflb7gao4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gppr4zhhR0Agu95MRvPm/contract-metadata";
  }
...
// File: contracts/DukatoBearContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DukatoBearContract is RamppERC721A {
    constructor() RamppERC721A("Dukato Bear", "DUKATOBEAR"){}
}
