...
contract DellNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    ...
    constructor() ERC721("DWNFT03", "DELL03") {
        collectionName = name();
    ...
    function createDellNFT() public returns(uint256) {
        ...
        //             '{"name": "',
        //                 combinedWord,
        //                 '", "description": "A highly acclaimed collection DELL Warriors", "image": "https://n6s5kx63jkf5m7l3sicagmxu3uicgplw5crqlzhos3dofhm6atya.arweave.net/b6XVX9tKi9Z9e5IEAzL03RAjPXboowXk7pbG4p2eBPA"}'
        //             )
        //         )
        //     )
        // );

        string memory finalTokenURI = string("https://arweave.net/IelWkzMr7O-XIctrzhtqClVy_D_AGDGN4hPFQz_DPqw");
