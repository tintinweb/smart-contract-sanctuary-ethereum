...
contract LalaV2 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("djkdj", "hdghdg");
        __ERC20Burnable_init();
        __AccessControl_init();
        __ERC20Permit_init("dhhd");
    ...
    function mintBulk(address[] memory accounts, uint256[] memory amounts) public onlyRole(MINTER_ROLE)
        returns (bool)
    {
    ...
    function permit(
        ...
        bytes32 r,
        bytes32 s
    ) override public notBlacklisted(owner) notBlacklisted(spender) {
