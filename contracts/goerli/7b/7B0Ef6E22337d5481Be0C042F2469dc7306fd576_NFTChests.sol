...
contract NFTChests is ERC721, CustomNFT, Ownable {
    ...
    function receiveNFT(address _to, uint256 id) external override {
        require(msg.sender == nftSale, "Only nftsale can call this func");

        _safeMint(_to, id);
    }

    function setNftSale(address _addr) external onlyOwner {
        nftSale = _addr;
    }
