...
// | | | | | ||  _ `\| || |   /'__`\ | | | |/',__)| |     | | | |/' _ `\ | | ( ) ( )
// | (_/ \_) || | | || || |_ (  ___/ | | | |\__, \| |_    | (_) || ( ) | | | | (_) |
// `\___x___/'(_) (_)(_)`\__)`\____)(___)(_)(____/`\__)   (_____)(_) (_)(___)`\__, |
//                                                                           ( )_| |
//                                                                           `\___/'
...
contract WhitelistWhitelist is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    uint public maxSupply = 1000;
    uint public maxWhitelistSupply = 1000;
    uint public normalMintPrice = 1 ether;
    ...
    address private _signerPublicKey = 0xf07dfC9C32e11Ec764c14eFBBf5f16D40324Aaaa;
    string private _contractUri;
    string private _baseUri;

    constructor() ERC721A("Whitelist Whitelist", "WW") EIP712("Whitelist Whitelist", "1.0.0") {
    }
    ...
    function _hash(address account) private view returns (bytes32) {
        return _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256("Whitelistwhitelist(address account)"),
                    account
                )
            )
        );
