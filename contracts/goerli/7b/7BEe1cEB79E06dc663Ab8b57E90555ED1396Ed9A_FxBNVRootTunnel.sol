    ...
    FxBaseRootTunnel
{
    ...
    function mapToken(address rootToken, address childToken) public {
        ...
        bytes memory message = abi.encode(
            MAP_TOKEN,
            abi.encode(rootToken, childToken)
        );
    ...
    function deposit(
        ...
        require(rootToChildTokens[rootToken]==childToken, "Tokens mismatched!");
    ...
    function _processMessageFromChild(bytes memory data) internal override {
        (
            ...
            uint256 lastSoldPrice
                ...
                data,
                (address, address, address, uint256, uint256, string, uint256)
            );
        ...
        IBNVTokenBase(rootToken).mint(to, tokenId, dropId, uri, lastSoldPrice);
