...
contract EXODUS is ERC721Psi, ERC2981, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    bytes32 public merkleRoot = 0xadeb344bb15d33148f98b0832a9bfa15fc2fe22090aac29d53401a0ff2863ab2;//本番デプロイ時変更
    bool public revealed = false;
    string private _baseTokenURI = "https://arweave.net/Qdm47JmC-XDrY_05m290PBM5hbm9hYvItg7MlSZQHOA/";//本番デプロイ時内容削除
    string private hiddenUri = "https://arweave.net/DpkUU1d0dbtQV5xv1OEDDwJ8OB431fv_wbbx1Pz4OG8/0.json";//本番デプロイ時変更
    ...
    constructor() ERC721Psi("EXODUS", "EX") {
        ...
        _member.treasury = 0x8Fce30a3Efd31200DC3cfc1298B9cd1D71D5f02f;//本番デプロイ時変更
    }
    ...
    function _vipMintCheck(
        ...
        require(
            vipClaimedCount[msg.sender] + 1 <= vipMintLimit,
            "Already claimed max"
        );
    }

    function checkVipMerkleProof(bytes32[] calldata _merkleProof)
        public
        view
        returns (bool)
    {
