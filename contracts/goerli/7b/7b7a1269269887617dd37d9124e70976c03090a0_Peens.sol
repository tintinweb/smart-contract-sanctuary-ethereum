...
contract Peens is ERC721A, Ownable, ERC2981 {
    ...
    function chadMint(uint256 qty) external payable mintCompliance(qty) {
        uint balance = IERC721(0x4BCC33Ec4aEc37F618b515ad09ab783434f7Baa2).balanceOf(msg.sender); //Chad
        uint balance2 = IERC721(0xE492a92a6148eBA1eD139d8a09a2A50a3ec48224).balanceOf(msg.sender); //Honorary
