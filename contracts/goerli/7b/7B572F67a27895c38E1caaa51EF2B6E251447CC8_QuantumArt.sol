...
contract QuantumArt is ERC2981, OSContractURI, Ownable, Manageable, ERC721Enumerable {
    ...
    function mintTo(uint256 dropId, address to) onlyRole(MINTER_ROLE) public returns (uint256) {
    ...
    function getArtist(uint256 dropId) public view returns (address) {
