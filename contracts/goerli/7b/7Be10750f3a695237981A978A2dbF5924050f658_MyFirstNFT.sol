...
contract MyFirstNFT is ERC721Enumerable, Ownable {
    ...
    string public baseURI = "ipfs://QmRdcwGy292fUsh5HUW5kNxPEXo8toYksj8ifXJME6JAD8"; // 這一行是 NFT 該去哪裡找你的 MetaData
    bool public paused = false; // 可以拿來暫停或者開啟 Mint
    uint256 public cost = 0.001 ether; // Mint 價格
    uint256 public maxSupply = 3; // 只有3個 NFT
    uint256 public maxMintAmount = 1; // 一次最多只能 Mint 一個

    constructor() ERC721("2023test", "2t") payable {
        // 剛開始我們先自己 Mint 一個
