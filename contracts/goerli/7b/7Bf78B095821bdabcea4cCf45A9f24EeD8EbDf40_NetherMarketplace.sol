...
contract NetherMarketplace is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address _register, address _weth) public initializer {
        ...
        changeCreateFee(.0001 ether, .0001 ether, .0001 ether);
    }
    ...
    function createCollection(string memory name, string memory symbol, string memory uri, uint256 maxSupply) public payable onlyRegisterUser returns(address) {
