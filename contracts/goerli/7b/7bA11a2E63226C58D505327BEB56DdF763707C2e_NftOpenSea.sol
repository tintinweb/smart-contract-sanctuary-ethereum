...
contract NftOpenSea is ERC721A, Ownable {

    uint256 private immutable collection_size;
    string private baseURI;
    string private osContractURI;
    using Strings for uint;

    constructor(string memory _collectionName, string memory _collectionSymbol, uint256 _collection_size, string memory _baseURI, string memory _contractURI) ERC721A(_collectionName, _collectionSymbol) {
        collection_size = _collection_size;
        baseURI = _baseURI;
        osContractURI = _contractURI;
    }
