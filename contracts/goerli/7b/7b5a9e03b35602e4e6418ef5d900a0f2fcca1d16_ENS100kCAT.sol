...
abstract contract ENSCAT {
    ...
    uint16 public royalty = 800; // TESTNET

    /// @dev : IPFS hash of metadata directory
    string public metaIPFS = "QmdSREkqj8unV4ms8JRijBZ8xArpqFdpMJFCfznbUYAkfh"; // TESTNET
...
contract ENS100kCAT is ENSCAT {
    ...
    constructor(address _resolver, uint256 _maxSupply) {
        contractURI = "ipfs://QmUfTgV6r1QsEnDtS8SGdPY7nfzvXTiaUWronJ9yDKBJDR"; // TESTNET
        Dev = msg.sender;
