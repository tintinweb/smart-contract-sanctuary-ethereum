...
contract OnionMeta is ERC721, Ownable {
    ...
    address private _signerAddress = 0x4322E8912748cCBB56F273B45CE545A84c25f548;
    ...
    function getOnionMetaByOwner(address _owner)
        public
        view
    ...
    function auctionMintOnionMeta(uint256 tokenQuantity) public payable {
        require(
            totalSupply + tokenQuantity <= tierSupply,
    ...
    function whiteListMintOnionMetas(uint256 tokenQuantity) public payable {
        require(
            _isWhiteListSaleActive,
            "Sale must be active to mint OnionMetas"
        );
