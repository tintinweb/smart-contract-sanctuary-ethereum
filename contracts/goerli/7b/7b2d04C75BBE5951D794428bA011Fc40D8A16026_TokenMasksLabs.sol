...
contract TokenMasksLabs is ERC721A, Ownable {
    ...
    function mint(uint _mintAmount) public payable {
        ...
        if(!(_mintAmount > 0)) revert("Please specfy 1 or more");
    ...
    function airdropMint(address[] calldata _airdoropAddresses, uint[] memory _userMintAmount) public onlyOwner {
        uint supply = totalSupply();
        ...
        for(uint i = 0; i < _airdoropAddresses.length;i++){
            _safeMint(_airdoropAddresses[i], _userMintAmount[i]);
        }
    }
