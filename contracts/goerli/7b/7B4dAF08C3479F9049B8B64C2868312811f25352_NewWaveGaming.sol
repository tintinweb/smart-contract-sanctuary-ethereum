...
contract NewWaveGaming is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  uint256 public constant MAX_MINT_PER_WALLET_PER_PHASE = 10;
  ...
  modifier mintCompliance(uint256 _mintAmount, MintPhase _phase) {
    ...
    require(_mintAmount > 0 && _mintAmount <= MAX_MINT_PER_WALLET_PER_PHASE, 'Invalid mint amount!');
    require(balancePerType[_msgSender()][_phase] + _mintAmount <= MAX_MINT_PER_WALLET_PER_PHASE, 'Exceed amount!');
  ...
  modifier mintPriceCompliance(uint256 _mintAmount) {
    ...
    if (msg.value > MINT_PRICE * _mintAmount) {
      (bool rs, ) = payable(msg.sender).call{value: msg.value - MINT_PRICE * _mintAmount}("");
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount, MintPhase.PUBLIC_MINT) mintPriceCompliance(_mintAmount) {
