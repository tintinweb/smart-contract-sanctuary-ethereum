...
/**
 * Please do not invest in this contract. 
 * The contract is being tested on mainnet. 
 * Dev team is working on validating the contract. If you invest, you will lose your ETH
*/
...
contract TextChillBro is Context, IERC20, Ownable {
    ...
    string private _name = "TestChillBro"; // token name
    string private _symbol = "cbro"; // token ticker
