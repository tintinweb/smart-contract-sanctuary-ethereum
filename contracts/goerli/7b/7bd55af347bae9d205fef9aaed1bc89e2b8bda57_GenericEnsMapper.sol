    ...
    PrimaryEns
{
    ...
    {
        require(isEnsApprovedOrOwner(_ensHash, 0));
    ...
    function isEnsApprovedOrOwner(bytes32 _ensHash, uint256 _ensId) private view returns(bool) {
    ...
    function namehashFromId(uint256 _id) public view returns(bytes32 _namehash){
             _namehash = keccak256(
                abi.encodePacked(
