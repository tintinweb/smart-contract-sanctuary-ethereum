...
contract SECApes is ERC721A, Ownable {
 ...
 constructor(
    ...
    address _lead,
    address _secApesV1
  )ERC721A("SEC Apes", "SECA") {
    baseURI = _baseURI;
    lead = _lead;
    secApesV1 = _secApesV1;
  }
 ...
 function _startTokenId() internal view override virtual returns (uint256) {
  ...
  function setSECApesV1Address(address _secApesV1) public onlyOwner {
    secApesV1 =_secApesV1;
  }
