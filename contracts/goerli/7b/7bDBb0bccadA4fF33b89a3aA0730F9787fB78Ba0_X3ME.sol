 ...
 *
 *  The `X3ME` contract uses the `ERC721Base` contract, along with the `SignatureMintERC721` extension.
 *
...
contract X3ME is ERC721Base, SignatureMintERC721 {
    ...
    constructor(
        ...
        address _admin
    ) ERC721Base(_name, _symbol, _initialMintPrice) {
        admin = _admin;
    }
    ...
    {
        require(msg.value >= mintPrice, 'ETH sent are not enough to mint');
...
abstract contract SignatureMintERC721 is EIP712, ISignatureMintERC721 {
    ...
    bytes32 private constant TYPEHASH =
        keccak256(
            "MintRequest(address to,string uri,uint128 validityStartTimestamp,uint128 validityEndTimestamp,bytes32 uid)"
        );
...
contract ERC721Base is ERC721, Ownable, ERC721Enumerable {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _initialMintPrice) 
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
       //TODO: implement token uri correctly
       return 'uri';
    }
