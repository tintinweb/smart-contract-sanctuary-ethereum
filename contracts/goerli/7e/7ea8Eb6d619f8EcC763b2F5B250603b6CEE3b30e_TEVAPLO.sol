...
contract TEVAPLO is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if (addressClaimed[_msgSender()] < maxFreeMintAmountPerWallet) {
      uint256 costAmount = _mintAmount - maxFreeMintAmountPerWallet;
