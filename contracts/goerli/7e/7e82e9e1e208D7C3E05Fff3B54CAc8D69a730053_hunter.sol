...
contract hunter is ERC721Burnable, ERC2981, Ownable, ReentrancyGuard {
    ...
    address public YureiAddress;
    IERC721 public Yurei;
    //only approved operators
    mapping (address => bool) public ApprovedAddr; 

    constructor(address _RoyaltyReceiver, uint96 _royaltyAmount,address _contr)  ERC721("Pixel Yurei", "0xYurei")  {
