...
/**
 * @title Kolapse
 * WhoIsSamot - an 1155 contract for  Kolapse
 */
contract Kolapse is ERC1155Supply, Ownable , ReentrancyGuard{
    ...
    function createItem(uint256 _id, uint256 _maxPerWallet, uint256 _maxToMint,uint256 _maxSupply,uint256 _publicPrice,uint256 _whitelistPrice,bool _saleIdActive ) external onlyOwner{
        idStats[_id].maxPerWallet = _maxPerWallet;
        idStats[_id].maxToMint = _maxToMint;
        idStats[_id].maxSupply = _maxSupply;
        idStats[_id].publicPrice = _publicPrice;
