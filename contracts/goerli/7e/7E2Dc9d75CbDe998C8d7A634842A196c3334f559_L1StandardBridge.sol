...
contract L1StandardBridge is IL1StandardBridge, CrossDomainEnabled {
        ...
        internal
    {
        ...
        iGTON_DiscountOracle oracle = iGTON_DiscountOracle(Lib_AddressManager(addressmgr).getAddress('GTON_DiscountOracle'));
        ...
        internal
    {
        ...
        if (_l1Token == gcd) {
            // Construct calldata for finalizeDeposit call
          _l2Token = Lib_PredeployAddresses.GTON_COINBASE;
          message =
            abi.encodeWithSelector(
                IL2ERC20Bridge.finalizeDeposit.selector,
                address(0),
                Lib_PredeployAddresses.GTON_COINBASE,
                _from,
                _to,
                _amount,
                _data
    ...
    function finalizeGcdWithdrawalByChainId(
        ...
        onlyFromCrossDomainAccount(l2TokenBridge)
    {
        _finalizeERC20WithdrawalByChainId(_chainid, gcd, Lib_PredeployAddresses.GTON_COINBASE, _from, _to, _amount, _data);
    }
