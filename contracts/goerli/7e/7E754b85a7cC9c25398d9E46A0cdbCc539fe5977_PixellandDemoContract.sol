...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xa81581cB6E6f1a090FB6811064def18f6bDD66ef];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xa81581cB6E6f1a090FB6811064def18f6bDD66ef;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihkokz3pdufx4sdnlvdru3jutzyxb52aroji3qcjpg2qmrnmdhblm/";
...
// File: contracts/PixellandDemoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixellandDemoContract is RamppERC721A {
    constructor() RamppERC721A("PixellandDemo", "PXLDEMO"){}
}
