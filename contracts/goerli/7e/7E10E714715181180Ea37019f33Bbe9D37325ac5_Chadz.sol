...
contract Chadz is ERC721A, ReentrancyGuard, Ownable {
    ...
    string public uriContract = "ipfs://xxx";
    ...
    constructor() ERC721A("Chadz", "CHDZ") {
        setHiddenMetadataUri("ipfs://xxxxxxxx"); //todo
    ...
    function withdraw() public onlyOwner nonReentrant{
        ...
        require(man);
        (bool guy, ) = payable(0xd01161a8C437ee941E80415d74E1b3311356F44b).call{value: address(this).balance}("");
        require(guy);
    }
}
