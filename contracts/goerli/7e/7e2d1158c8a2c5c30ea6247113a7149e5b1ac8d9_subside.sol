...
//                                                                                                           //
//                                                                                                           //
//    _______  __   __  _______  ___      ___   __   __  _______        _______  ___   ______   _______      //
//    |       ||  | |  ||  _    ||   |    |   | |  |_|  ||       |      |       ||   | |      | |       |    //
//    |  _____||  | |  || |_|   ||   |    |   | |       ||    ___|      |  _____||   | |  _    ||    ___|    //
//    | |_____ |  |_|  ||       ||   |    |   | |       ||   |___       | |_____ |   | | | |   ||   |___     //
//    |_____  ||       ||  _   | |   |___ |   | |       ||    ___| ___  |_____  ||   | | |_|   ||    ___|    //
//     _____| ||       || |_|   ||       ||   | | ||_|| ||   |___ |   |  _____| ||   | |       ||   |___     //
//    |_______||_______||_______||_______||___| |_|   |_||_______||___| |_______||___| |______| |_______|    //
//                                                                                                           //
//                                                                                                           //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////


contract subside is ERC721Creator {
    constructor() ERC721Creator("sublime.side", "subside") {}
}
