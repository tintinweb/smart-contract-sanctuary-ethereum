...
contract TOD is ERC721, Ownable {

    uint private mintPrice = 1 ether;
    uint private maxItems = 5000;
    uint private totalSupply = 0;
    string private _baseTokenURI = 'https://tod-lootboxes.fra1.digitaloceanspaces.com/metadata/';
    bool private publicMintPaused = false;
    uint private startTimestamp = 1664960400;

    event Mint(address indexed owner, uint indexed tokenId);

    constructor() ERC721("Tales of darkness", "TOD") {}
    ...
    function publicMint() external payable {
        ...
        require(totalSupply <= maxItems, "publicMint: Sold out");
        require(msg.value == mintPrice, "publicMint: Mint price is not correct");
        totalSupply += 1;
     ...
     */
    function tokenURI(uint256 _tokenId) public onlyOwner view override returns (string memory) {
