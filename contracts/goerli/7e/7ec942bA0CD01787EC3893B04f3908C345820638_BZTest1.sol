...
contract BZTest1 is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 3;
    uint public _price = 0.03 ether;
    uint256 public maxBuyPerTx = 1;
    bool public paused;
    

    constructor() ERC721A("BZTest1", "BeautifulZombies1Test") {
        paused = true;
    }
    // Read the price
