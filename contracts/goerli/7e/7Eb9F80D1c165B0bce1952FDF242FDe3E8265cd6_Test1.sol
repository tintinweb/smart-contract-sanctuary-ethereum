...
contract Test1 is Ownable, ERC721A, ReentrancyGuard {
    ...
    /// @notice You can mint with the mintKey (get mintKey on the website)
    ...
    function whiteListMint(bytes calldata mintKey) external nonReentrant {
        ...
        require(!claimedKeys[mintKey], "Address was used!");
        require(checkSignature(whiteListSigner, msg.sender, mintKey), "Not on the Whitelist");
    ...
    function waitListMint(bytes calldata mintKey) external nonReentrant {
        ...
        require(totalSupply() + maxMint <= COLLECTION_SIZE, "Maximum!");
        require(!claimedKeys[mintKey], "Address was used!");
        require(checkSignature(waitListSigner, msg.sender, mintKey), "Not on the WaitList");
        claimedKeys[mintKey] = true;
        _safeMint(msg.sender, maxMint);
    }
