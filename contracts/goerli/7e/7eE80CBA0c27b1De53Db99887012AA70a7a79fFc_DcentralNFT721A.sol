...
import "../extensions/721a/ERC721A.sol";


contract DcentralNFT721A is Ownable, ERC721A, ERC2981, ReentrancyGuard{
    ...
    function mint(uint256 quantity) external onlyOwner {
        require(totalSupply() + quantity <= maxSupply, 'Too many already minted');
