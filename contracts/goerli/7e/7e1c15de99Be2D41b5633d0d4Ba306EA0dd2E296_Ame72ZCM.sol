    ...
    ReentrancyGuard
{
    ...
    function setZ(address Z) public onlyOwner {
        _zingot = Zingot2(Z);
    }
    ...
    function mint(
        ...
        require(_zingot.allowance(msg.sender, address(this)) >= price, "increase allowance");
        _zingot.transferFrom(msg.sender, address(this), price);
...
contract Zingot2 is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, UUPSUpgradeable, ERC2771ContextUpgradeable {
  ...
  /// @custom:oz-upgrades-unsafe-allow constructor
  constructor() ERC2771ContextUpgradeable(0xeb862fF4b8104d4BAe22427367A9a3A16694B486) {
    _disableInitializers();
  }
  ...
  function initialize() initializer public {
    ...
    _mint(msg.sender, 498_000_000 * 10 ** decimals());
