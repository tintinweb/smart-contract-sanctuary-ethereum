 ...
 */
 ...
 contract token3 is ERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
      ...
      if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
          transferAmount = amount;
                ...
                _swapTokensForEth(tokensToSellEth);
    ...
    {   
        ...
        require(_maxTxAmount >= minValue, 'Cannot set maxTxAmount to less than .5% of the supply');
    ...
    {   
        ...
        require(_maxWalletAmount >= minValue, 'Cannot set maxWalletAmount to less than .5% of the supply');
