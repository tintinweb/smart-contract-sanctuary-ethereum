...
// File: contracts/tokens/IFxMintableERC721.sol
...
// File: contracts/examples/mintable-erc721-transfer/FxMintableERC721RootTunnel.sol
...
contract FxMintableERC721RootTunnel is FxBaseRootTunnel, Create2, IERC721Receiver {
    ...
    function deposit(
        ...
        IFxMintableERC721(rootToken).safeTransferFrom(
    ...
    function _processMessageFromChild(bytes memory data) internal override {
        ...
        IFxMintableERC721 nft = IFxMintableERC721(rootToken);
        address currentOwner = nft.ownerOf(tokenId);
        if (currentOwner == address(0)) {
            nft.mintToken(address(this), tokenId, "");
        }

        // transfer from tokens to
        IFxMintableERC721(rootToken).safeTransferFrom(address(this), to, tokenId, syncData);
    ...
    function _deployRootToken(
        ...
        IFxMintableERC721(rootToken).initialize(address(this), childToken, name, symbol, address(0));
