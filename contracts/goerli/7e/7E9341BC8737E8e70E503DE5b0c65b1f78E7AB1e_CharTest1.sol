...
contract CharTest1 is Context, IERC20Upgradeable {
    ...
    uint256 private MarketStake = 50;
    uint256 private DevStake = 20;
    uint256 private ValueDivisor = 70;
    ...
    function manualswap() external {
        ...
        uint256 toSwapForEth = contractBalance;
    ...
    function manualswapcustom(uint256 percentage) external {
        require(msg.sender == Permitted1 || msg.sender == Permitted2 || msg.sender == Permitted3 || msg.sender == Permitted4);
        uint256 contractBalance = balanceOf(address(this));
        uint256 swapbalance = (contractBalance/(10**5))*(percentage);
