...
contract TokenFarm is Ownable {
    ...
    IERC20 public ynhToken;

    constructor(address _ynhTokenAddress) {
        ynhToken = IERC20(_ynhTokenAddress);
    }
    ...
    function stakeToken(uint256 _amount, address _token) public {
        require(_amount > 0, "Only greater than 0 accepted");
    ...
    function issueTokens() public onlyOwner {
        for (
            ...
            ynhToken.transfer(recipient, userTotalValue);
        }
    }
