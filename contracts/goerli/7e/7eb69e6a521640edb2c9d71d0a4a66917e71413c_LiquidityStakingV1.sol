...
function setBorrowingPermission(
    address borrower,
    ...
    nonReentrant
  {
    _setBorrowingPermission(borrower, isBorrowingAllowed);
  }
  ...
  LS1StakedBalances
{
 ...
 /**
   ...
   * @dev Restrict a borrower from further borrowing.
   */
  function _setBorrowingPermission(
    address borrower,
    bool isBorrowingAllowed
  )
    internal
...
abstract contract LS1Borrowing is LS1Staking, LS1BorrowerAllocations {
    ...
    function borrow(uint256 amount) external nonReentrant {
        ...
        require(_BORROWER_PERMISSIONS_[borrower], "Restricted");
        ...
        returns (uint256)
    {
        if (
            ...
            !_BORROWER_PERMISSIONS_[borrower]
        ) {
            return 0;
        }
  ...
  LS1BorrowerAllocations
{
    ...
    nonReentrant
  {
    ...
    _setBorrowingPermission(borrower, false);
  }
