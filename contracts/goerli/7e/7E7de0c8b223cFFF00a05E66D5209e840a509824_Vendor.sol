...
contract Vendor is Ownable {
  ...
  function buyTokens() external payable {
    ...
    require(amountOfEth > 0, "No Eth sent");

    uint amountOfTokens = amountOfEth * tokensPerEth;
    uint256 vendorBalance = yourToken.balanceOf(address(this));
    require(vendorBalance >= amountOfTokens, "Not enough tokens");
  ...
  function withdraw() public onlyOwner {
    ...
    require(vendorBalance > 0, "Vendor does not have ETH to withdraw");
  ...
  function sellTokens(uint256 amount) public {
    ...
    require(vendorEthBalance > amountOfEth, "Vendor doesn't have enough ETH");

// yourToken.transferFrom(user, address(this), amount);
