// SPDX-License-Identifier: MIT
        ...
        contract LTest is ERC721A, Ownable, ReentrancyGuard  , DefaultOperatorFilterer{
        ...
        constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("LTest Collection", "LT") {
        ...
        function withdraw() public onlyOwner nonReentrant{
          ...
          payable(0xfe990e57E70951FEBC5e90A3B750C9a8a916B966).transfer(_balance * 40 / 100);

          
          payable(0xfe990e57E70951FEBC5e90A3B750C9a8a916B966).transfer(_balance * 60 / 100);
