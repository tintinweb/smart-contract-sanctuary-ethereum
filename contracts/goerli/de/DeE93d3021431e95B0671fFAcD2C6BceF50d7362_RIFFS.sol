...
//                     MMMMMBMBMBMBMBMBBBBBBBMMMBMBMBBBMBMBMBMBMBMBBBMBMMMM[email protected];  ;MMBMMMr                   //
...
contract RIFFS is ERC1155Creator {
    constructor() ERC1155Creator("NiftyRiffs Editions", "RIFFS") {}
}
