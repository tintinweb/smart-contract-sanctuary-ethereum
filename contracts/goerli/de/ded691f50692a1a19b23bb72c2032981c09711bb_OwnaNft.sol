...
contract OwnaNft is Initializable, ERC721Upgradeable,  ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    // function ownaOf(uint256 tokenId) public view returns (address)
    // {
    //     return OwnaDetails[tokenId].owna ;
    // }
}