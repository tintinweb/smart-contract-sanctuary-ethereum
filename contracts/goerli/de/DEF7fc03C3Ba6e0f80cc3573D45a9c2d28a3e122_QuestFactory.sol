...
contract Erc1155Quest is Quest, ERC1155Holder {
    ...
    function withdrawRemainingTokens() external onlyOwner onlyWithdrawAfterEnd {
        ...
        uint nonClaimableTokens = IERC1155(rewardToken).balanceOf(address(this), rewardAmountInWeiOrTokenId) - unclaimedTokens;
 ...
 * the owner.
 */
abstract contract OwnableUpgradeablez is Initializable, ContextUpgradeable {
    address private _owner;
...
import {OwnableUpgradeablez} from './OwnableUpgradeablez.sol';
...
contract QuestFactory is Initializable, OwnableUpgradeablez, AccessControlUpgradeable, IQuestFactory {
