...
//            _inviteeData[msg.sender] += (1<<(8 + uint8(color)));
    ...
    **/
    function puzzleInvite(
        ...
        for (uint256 i = 0; i < invitees.length; i++) {
            ...
            require(!invited(invitee), "ai");
            require(color != HeartColor.Length, "bhc");
    ...
    **/
    ...
    function activationCost(uint256 numToActivate) public view returns (uint256) {
        ...
        toReturn = string(
            abi.encodePacked(
                toReturn,
                    ...
                    "\"},{\"trait_type\":\"Lineage Parent\",\"value\":\"", uint256(uint160(parentOf(tokenId))).toHexString(),
                    "\"},{\"trait_type\":\"Lineage Depth\",\"value\":", lineageDepthOf(tokenId),
                    "},{\"trait_type\":\"Number of Children\",\"value\":", numChildrenOf(tokenId),
