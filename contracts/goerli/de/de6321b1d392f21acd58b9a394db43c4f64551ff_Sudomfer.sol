...
/**
    @title Sudomfer minting contract forked from https://github.com/fazelpejmanfar/NFT-Smart-Contracts.git
    @author saneoda 
 */
contract Sudomfer is ERC721A, Ownable, ReentrancyGuard {
