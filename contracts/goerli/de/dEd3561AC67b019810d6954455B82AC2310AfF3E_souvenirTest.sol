...
contract souvenirTest is  ERC721AUpgradeable, DefaultOperatorFiltererUpgradeable,
    ...
    modifier minterRole(address minter){
        require(minter == minterContract,"You aren't the minter contract.");
        _;
    }
    ...
    function mint(address _to) external minterRole(msg.sender){
        _mint(_to, 1);
    }
