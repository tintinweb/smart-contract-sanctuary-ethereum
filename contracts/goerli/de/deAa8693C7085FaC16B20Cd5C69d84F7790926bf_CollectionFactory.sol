...
contract CollectionFactory {
    ...
    function setupERC721GeneralCollectionWithNewTokenEtherAuction(
        ...
        IAuctionManager(auctionManagerAddress).createAuctionForNewToken(auction);
...
interface IAuctionManager {
     ...
     */
    event EndTimeUpdated(uint256 indexed auctionId, address indexed owner, uint256 indexed newEndTime);
     ...
     */
    function createAuctionForNewToken(EnglishAuction memory auction) external returns (uint256);

    /**
     * @notice Create an auction for an existing NFT
     * @param auction The auction details
     */
    function createAuctionForExistingToken(EnglishAuction memory auction) external returns (uint256);
     ...
     */
    function updatePaymentRecipient(uint256 auctionId, address payable newPaymentRecipient) external;
     ...
     */
    function fulfillAuction(uint256 auctionId) external;
     ...
     */
    function cancelAuctionOnChain(uint256 auctionId) external;
     ...
     * @param newEndTime New end time
     */
    function updateEndTime(uint256 auctionId, uint256 newEndTime) external;
     ...
     * @param auctionId ID of auction
     */
    function getFullAuctionData(uint256 auctionId)
        external
        view
     ...
     */
    function getFullAuctionsData(uint256[] calldata auctionIds)
        external
        view
        returns (EnglishAuction[] memory, HighestBidderData[] memory);
}
