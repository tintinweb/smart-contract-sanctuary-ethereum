...
// File: contracts/bridge/BridgeUpgradeable.sol
...

{
    ...
    function initialize(address _multiSig, uint256 evmChainId) initializer public {
    ...
    function _transferETH() internal returns (TransferResult memory transferResult) {
    ...
    function cashIn(
        ...
        TransferResult memory transferResult = _transferTokens(
    ...
    function _transferTokens(
    ...
    ) internal returns (TransferResult memory transferResult) {
        ...
        SafeERC20Upgradeable.safeTransferFrom(ERC20Upgradeable(token), msg.sender, address(this), amount);
    ...
    */
    ...
    function withdraw(
        ...
        emit WithdrawalFinalized(ctx.txhash, _from, recipient, ctx.fromChainID, ctx.nonce, amount);
