...
import "hardhat/console.sol"; // TODO: only for testing purposes
...
contract MicroBuddyWaterBear is Ownable, Pausable, ERC721A {
    uint256 public WHITE_LIST_START_TIME = 1663420500;
    ...
    uint256 public RESTING_PRICE = 0.00063 ether;
    uint16 public MAX_SUPPLY = 1785;
    ...
    function mintGenZeroWL(uint16 quantity) public payable whenNotPaused {
        ...
        require(genZeroList[msg.sender] >= quantity, "Not enough Gen 0s!");
    ...
    function withdrawFinalFunds() public onlyOwner {
        require(
            block.timestamp >= WHITE_LIST_START_TIME + 3600 * 24 * 7,
            "Not allowed to transfer out funds yet"
        );
