...
contract ERC1967Proxy is Proxy, ERC1967Upgrade {
    ...
    constructor(address _logic) payable {
        _upgradeToAndCall(_logic, _empty, false);
    }
...
contract Fatory {
    ...
    function getData() external {
        MyToken tokens = (new MyToken)();
        ERC1967Proxy sale = (new ERC1967Proxy)(address(tokens));
        listAddress.push(address(tokens));
        listAddress.push(address(sale));
    }
}