  ...
  ERC721Pausable
{
  ...
  function withdraw(address recipient) external onlyOwners {        
  ...
  /**
   * @dev Mints the specified amount of tokens to the recipient addresses
   * @param amount Amount of tokens that will be minted
   */
  function mint(uint256 amount) external payable { 
    require(amount >= 1, "ERC721: invalid token amount");
    ...
    if (amount > 1) {
      ...
      for (uint256 i = startTokenId; i < amount; i++) {
