...
/**
 * @title Voting-Escrowed AUXO Token (veAUXO)
 * @notice veAUXO has the following key properties:
 ...
 */
contract VeAuxo is ERC20, ERC20Votes {
    ...
    modifier onlyTokenLocker() {
        require(tokenLocker == msg.sender, "veAUXO: caller is not the TokenLocker");
        _;
    }
    ...
    /**
     * @notice supply of veAUXO (minting and burning) is entirely controlled
