 ...
 * @dev Each Asset Vault is created via "intializeBundle", and uses a specified template
    ...
    IVaultFactory
{
    ...
    function initialize (
        ...
        if (_vaultAddress == address(0)) revert Errors.InvalidProxyAddress(_vaultAddress);
        __Ownable_init();
    ...
    function create (
        ...
        uint256 encrypted = uint256(uint160(vault)); 
