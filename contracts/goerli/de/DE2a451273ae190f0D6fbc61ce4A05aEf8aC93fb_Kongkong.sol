...
contract Kongkong is ERC721, Ownable {
    ...
    constructor() ERC721("KongKong", "KK") {
        baseUri = "ipfs://bafybeibasvgsgmcsfsmn4xvmvy7nk5edgopkaxlfse3ebxgn35fxc54vwm/";
    }

    // Public Functions
    function safeMint(uint256 _amount) public payable {
        require(isSaleActive, "The sale is paused.");
        require(_amount > 0 && _amount < MAX_MINT_PER_TX + 1, "Amount of tokens too big");
        ...
        for(uint256 i = 1; i <= _amount; ++i) {
            _safeMint(msg.sender, MAX_TOKENS + i);
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xCCC1f76062dE1a0f971694bA81A980422f879f30).call{value: balanceOne}("");
