                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                name,
                                '", "description":"An NFT that changes based on the Chainlink Feed ', name, '", ',
                                '"image":"',
                                imageURI,
                                '"}'
                            )
