...
contract Governor is IGovernor, Ownable, ERC721Holder {
  ...
  IDonationsRouter public override donationsRouter;
  ...
  function setClearingHouse(IClearingHouse _implementation) external onlyOwner {
    _checkZeroAddress(address(_implementation));
...
interface IGovernor {
  ...
  function setClearingHouse(IClearingHouse _implementation) external;
  ...
  function clearingHouse()
    external
    view
    returns (IClearingHouse implementation);
