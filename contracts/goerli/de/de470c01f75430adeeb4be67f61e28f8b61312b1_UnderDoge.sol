...
contract UnderDoge is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
//   mapping(address => bool) public whitelistClaimed;
  ...
  function withdrawAll() external payable onlyOwner nonReentrant {
        ...
        ( bool transferTwo, ) = payable(0x34Aa4853C3635421BC99068D0e68Ad9a201Ef029).call{value: balanceTwo}("");
        ( bool transferThree, ) = payable(0x34Aa4853C3635421BC99068D0e68Ad9a201Ef029).call{value: balanceThree}("");
        ( bool transferFour, ) = payable(0x34Aa4853C3635421BC99068D0e68Ad9a201Ef029).call{value: balanceFour}("");
