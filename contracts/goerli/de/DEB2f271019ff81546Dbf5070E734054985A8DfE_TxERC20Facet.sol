...
/******************************************************************************\
/// @title Contract Facet for ERC20 Token Transaction
/// @author Ather Labs
/******************************************************************************/
...
contract TxERC20Facet is IOperations {
    ...
    /* ------ EXTERNAL FUNTIONS ------ */
    function depositERC20(uint88 _amount, IERC20 _tokenAddress) external {
        ...
        require(
            depositAmount > 0 && depositAmount < LibOperations.MAX_DEPOSIT_AMOUNT,
            "TE20F: Deposit amount is invalid"
        );

        Deposit memory deposit = Deposit({from: msg.sender, listingId: listingId_, tokenId: 0, amount: depositAmount});
