    ...
    ReentrancyGuard
{
    ...
    IERC721 constant private polymorphsV2Contract = IERC721(0xCcA89336F67749C0A80926E6a640F8F84C0fa4e2);
    IERC721 constant private facesContract = IERC721(0xA4F2D0d0B88122B4a37866aF1350FFB11F5F1C4d);
    IERC721 constant private lobstersContract = IERC721(0xA4F2D0d0B88122B4a37866aF1350FFB11F5F1C4d);
    ...
    function discountMint(
        ...
        require(msg.value >= (discountPrice * totalTokens), "Not enough ETH sent");
