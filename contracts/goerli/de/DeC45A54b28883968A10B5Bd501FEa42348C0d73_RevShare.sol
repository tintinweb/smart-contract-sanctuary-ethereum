...
import { NounsAuctionHouseProxy } from './proxies/NounsAuctionHouseProxy.sol';
...
contract RevShare {
    ...
    function returnNouns() public view returns (INounsToken){
       return NounsAuctionHouse(auctionHouseProxy).nouns();
    }
