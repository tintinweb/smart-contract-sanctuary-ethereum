...
contract NFC2023 is ERC721, ERC721Enumerable, ERC2981ContractWideRoyalties, Ownable {
    ...
    */
    ...
    constructor(address _secondaryRoyaltyWallet, address _paidWallet, address _primaryRoyaltyWallet, bytes32 _merkleRoot, uint256 _basePrice, string memory _jsonForFetchingOnly, address _storageAddress)
        ERC721("Non Fungible Conference 2023", "NFCSummit2023") 
    {
        _setRoyalties(_secondaryRoyaltyWallet, 1000);
    ...
    function append721Coupon(address[] calldata _nft_contracts, uint256[] calldata _phases) external onlyOwner  {
        storageContract.append721Coupon(_nft_contracts, _phases);
    }
    ...
    function normalMint() external payable onlyDuringPublicSales onlyFromWallet payWallets {
        require(!salesLocked, "Sales are closed.");
    ...
    function _approve(address _to, uint256 _tokenId) internal override(ERC721) onlyDuringPublicSales {
        super._approve(_to, _tokenId);
    }

    function _setApprovalForAll(address _owner, address _operator, bool _approved) internal override(ERC721) onlyDuringPublicSales {
        super._setApprovalForAll(_owner, _operator, _approved);
    }

    function _transfer(address _from, address _to, uint256 _tokenId) internal override(ERC721) onlyDuringPublicSales {
