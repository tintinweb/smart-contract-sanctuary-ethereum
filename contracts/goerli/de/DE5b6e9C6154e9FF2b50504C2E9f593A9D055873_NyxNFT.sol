...
contract NyxNFT is ERC1155Supply, Ownable
{
    ...
    // function _replace(uint256 a, uint256 b) private pure returns (uint256) {
    //     return b;
    // }
    ...
    /**
    * @notice overriding to include the induced balance changes in balanceHistory
    *
    * @param from : the address from which the transfer occurs
    */
        ...
        private
    {
        ...
        // M1 : Minting team nfts AT THE BEGINNING of a wave
        ...
        public onlyApproved
    {
        ...
        //     _isMinting = false;
        // }
        // M2 : Minting team nfts AT THE END of a wave
        if (waveCurrentSupply[wave] >= 10)
        {
            uint256 mint_amount = waveCurrentSupply[wave] * nyx_premint_pct / 100;
