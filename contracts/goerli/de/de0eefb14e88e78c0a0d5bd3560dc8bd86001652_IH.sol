...
//            abi.encodePacked(
//                "data:application/json;utf8,{\"name\":\"Heart%20%23", tokenId.toString(), "\",",
//                "\"description\":\"This%20is%20a%20", _colorToString[uint256(uint8(color))], "%20Heart.%20It's%20dangerous%20to%20go%20alone.\",",
//                "\"image\":\"",
...
//            abi.encodePacked(
//                toReturn,
//                    "\",\"attributes\":[{\"trait_type\":\"Heart%20Color\",\"value\":\"", _colorToString[uint256(uint8(color))],
//                    "\"},{\"trait_type\":\"Genome\",\"value\":\"", genomeOf(tokenId),
//                    "\"},{\"trait_type\":\"Lineage%20Parent\",\"value\":\"", uint256(uint160(parentOf(tokenId))).toHexString(),
//                    "\"},{\"trait_type\":\"Lineage%20Depth\",\"value\":", lineageDepthOf(tokenId),
//                    "},{\"trait_type\":\"Number%20of%20Children\",\"value\":", numChildrenOf(tokenId),
...
//                    "\"},{\"trait_type\":\"Lineage Depth\",\"display_type\":\"number\",\"value\":", lineageDepthOf(tokenId).toString()
//            )
//        );
        toReturn = string(
            abi.encodePacked(
