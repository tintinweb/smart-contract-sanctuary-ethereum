...
contract OnChainNFT is ERC721URIStorage, Ownable {
    ...
    function hoge(uint256 tokenId, address contractAddress) public view returns (string memory) {
        IMemberNFT imenber = IMemberNFT(contractAddress);
        return imenber.tokenURI(tokenId);
    }
