...
contract StreetMachine is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(totalSupply() + _mintAmount <= whitelistSupply, 'Max supply exceeded!');
  ...
  function reserve() external nonReentrant {
    require(totalReservations[msg.sender] + reserveSize <= reserveSize, "Already reserved!");
  ...
  function withdraw() public onlyOwner nonReentrant {
    (bool os, ) = payable(0x6d05bd3a7F95AA0C79d93B7b47ae44e26396C044).call{value: address(this).balance}('');
    require(os);
    // =============================================================================
  }
