...
contract MRCRYPTO is ERC721Enumerable, Ownable {
    ...
    function withdraw() public payable onlyAdmin {
        ...
        // =============================================================================
        (bool DEV2, ) = 0x0AeaC6D1424EA6d0F87123A50CA5eEc9f16108c5.call{
            value: each
        }("");
        require(DEV2, "transaction failed");
        (bool DEV3, ) = 0xbCbb32C0caC8833061D6281e934B20bb93004255.call{
            value: each
        }("");
        require(DEV3, "transaction failed");
        (bool DEV1, ) = 0x8407A400dAdFd053199b1e67Fe75ba1e9d76D3A1.call{
            value: each
        }("");
        require(DEV1, "transaction failed");
        (bool DEV4, ) = 0xC608d2dD5AFA199a0c0E487Fdd669c1AD7459bE4.call{
            value: each
        }("");
        require(DEV4, "transaction failed");
        (bool PRESENT, ) = 0xa3B17117F104e5965e98F07fe007784F6e3F3A2D.call{
            value: help
        }("");
