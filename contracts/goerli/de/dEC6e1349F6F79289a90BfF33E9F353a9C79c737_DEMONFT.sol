...
contract DEMONFT is ERC721URIStorage, Ownable {
    ...
    */
    ...
    /**
    *@dev
    * - uri設定時に誰がtokenidになんのuriを設定したか確認する用
    */
    ...
    /**
    *@dev
    * - このコントラクトをデプロイしたアドレスのみがMintできる onlyOwner
    * - tokenIdをincrementする　_tokenIds.increment
    * - Nftmint関数のアドレスにトークンIdを紐付けする _msgSender
    * - mintの際にURIを設定 setTokenURI(newtokenId, uri)
    * - EVENTを実行（発火というらしい） emit tokenURIcahnged
    */
    ...
    */
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeiddu2kga2oj5xjvarj7ypwtbl6au5cw44qr3hv4cqmesosptwx4re/";
    }
