...
contract WIZ is Context, IERC20 {
    ...
    Ratios public ratios = Ratios({liquidity: 200, treasury: 600, total: 800});
    ...
    address public constant marketingWallet = 0xDc6085035e331d7289126fDD27bAFD84feC5DC67;

    address public constant treasuryWallet = 0x4CA0483A4234bcad8fa64010B71086B344001aF3;
    ...
    function _transfer(
        ...
        bool feesAndLimitsAllowed = block.timestamp >= _feesAndLimitsStartTimestamp;
        ...
        bool takeFee = feesAndLimitsAllowed
            && !(
                msg.sender == address(dexRouter) // adding liquidity
                || (msg.sender == lpPair_ && to == address(dexRouter)) // removing liquidity
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 toLiquify = ((contractTokenBalance * ratios_.liquidity) /
            ratios_.total) / 2;
    ...
    function _getValues(
        ...
        if (takeFee) {
          ...
          if (Address.isContract(to)) {
                currentReflect = sellFees.reflect;
                currentBurn = sellFees.burn;
                currentMarketing = sellFees.marketing;
                currentSwap = sellFees.totalSwap;
            } else if (Address.isContract(from)) {
                currentReflect = buyFees.reflect;
                currentBurn = buyFees.burn;
                currentMarketing = buyFees.marketing;
                currentSwap = buyFees.totalSwap;
            }
