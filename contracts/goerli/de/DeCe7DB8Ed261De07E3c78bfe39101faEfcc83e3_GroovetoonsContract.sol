...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xFD5AE68100e4841351145BD17EB6154654D4afe7];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xFD5AE68100e4841351145BD17EB6154654D4afe7;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 253) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSh6P79xTJsniCVmrtykrCaPNxyBErTpgFQm4qzxERrne/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 253");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 253");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 253");
...
// File: contracts/GroovetoonsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GroovetoonsContract is RamppERC721A {
    constructor() RamppERC721A("Groove toons", "Groove"){}
}
