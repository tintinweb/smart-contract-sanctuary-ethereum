...
contract ClutchNFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("ClutchNFT", "CNFT"){}
  ...
  function freeMint(uint256 amt) external callerIsUser {
    ...
    require(totalSupply() + amt <= totalFree, "Max free CNFT");
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more CNFT");
