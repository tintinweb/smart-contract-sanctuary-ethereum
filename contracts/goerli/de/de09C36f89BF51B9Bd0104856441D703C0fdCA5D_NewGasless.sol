...
contract NewGasless is ERC721AQueryable,ERC2771Context, Ownable{
    ...
    function setMaxSupply(uint256 _newmaxSupply) public onlyOwnerOrAdmin {
        maxSupply = _newmaxSupply;
    } 

    function setMaxPerMint(uint256 _newMaxperMint) public onlyOwnerOrAdmin {
        maxPerMint = _newMaxperMint;
    }     

    function setActive(bool isActive) external onlyOwnerOrAdmin {
        _isActive = isActive;
    }
    ...
    function airdrop(address to) public onlyOwnerOrAdmin  {
        uint256 totalMinted = _tokenIds.current();
        require(totalMinted < maxSupply, "Not enough NFTs left!");  
        _tokenIds.increment();
        uint256 tokenId = _tokenIds.current();        
