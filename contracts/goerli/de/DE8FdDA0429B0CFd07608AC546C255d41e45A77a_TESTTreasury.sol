...
contract TESTTreasury is Ownable {
    ...
    enum MANAGING { RESERVEDEPOSITOR, RESERVESPENDER, RESERVETOKEN, RESERVEMANAGER, LIQUIDITYDEPOSITOR, LIQUIDITYTOKEN, LIQUIDITYMANAGER, DEBTOR, REWARDMANAGER, STEST }
    ...
    uint public sTESTQueue; // Delays change to sTEST address
    ...
    constructor (
        ...
        isReserveToken[ _sTEST ] = true;
        reserveTokens.push( _sTEST );
    ...
    function incurDebt( uint _amount, address _token ) external {
        ...
        uint maximumDebt = IERC20( sTEST ).balanceOf( msg.sender ); // Can only borrow against sTEST held
    ...
    /**
        ...
        @param _amount uint
     */
    function repayDebtWithTEST( uint _amount ) external {
        require( isDebtor[ msg.sender ], "Not approved" );
    ...
    function queue( MANAGING _managing, address _address ) external onlyManager() returns ( bool ) {
        ...
        } else if ( _managing == MANAGING.STEST ) { // 9
