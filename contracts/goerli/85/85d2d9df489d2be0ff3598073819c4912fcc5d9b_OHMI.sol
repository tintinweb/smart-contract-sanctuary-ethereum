...
//
// https://ohminu.com
// https://twitter.com/OHMInuERC
//
// One goal. $100m market cap.
// The top 100 holders will receive an INSANE reward
// when the market cap goal is reached -- a reward
// that has never been seen in crypto.
//
*/
...
contract OHMI is StandardToken {
  ...
  string public constant name = "One Hundred Million Inu"; // solium-disable-line uppercase
