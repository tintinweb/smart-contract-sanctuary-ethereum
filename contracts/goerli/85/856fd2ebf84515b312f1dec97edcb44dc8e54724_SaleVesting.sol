...
contract SaleVesting is Context, Ownable, Initializable {
    ...
    IERC20 USDT = IERC20(0x6B51Ad77da1d1386301c795d9FF5D83a418061Ac); // ERC20 
    IERC20 USDC = IERC20(0xac1588086cb736eC0367bBBE6Bf29eFe4B24ee6B); // ERC20
    IERC20 BUSD = IERC20(0x5e425C8BE17b9696639CcB6D416371E11f6223DA); // ERC20
    IERC20 BEC;
    ...
    uint256 private TGE;
    uint256 private biWeekly = 240; // 1209600
    ...
    address private liquidity = address(0x0A70c7294f9Deffe389E437347ba1B6De531D16C);
