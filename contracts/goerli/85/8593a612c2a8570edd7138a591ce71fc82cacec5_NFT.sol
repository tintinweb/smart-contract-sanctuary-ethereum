...
contract NFT is ERC721, Ownable {
  ...
  uint256 public maxMintAmountPerTx = 5;
    ...
    constructor() ERC721("NFT Name", "SYMBOL") {
        baseUri = "ipfs://QmXz29TJH298sQPMxM3Jfk3oA1yB69vs9qpoyhdFgHWWzd/";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= maxMintAmountPerTx, "You cannot mint that many in one transaction.");
        require(mintedPerWallet[msg.sender] + _numTokens <= maxMintAmountPerTx, "You cannot mint that many total.");
        uint256 curTotalSupply = totalSupply;
        require(curTotalSupply + _numTokens <= maxSupply, "Exceeds total supply.");
        require(_numTokens * cost <= msg.value, "Insufficient funds.");
