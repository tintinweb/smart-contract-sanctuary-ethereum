...
contract Hero is ERC721, ERC721Burnable, Ownable {
    ...
    uint256 public next_hero = 1;
    mapping(uint256 => address) public minters;
    mapping(uint256 => uint256) public xp;
    mapping(uint256 => uint256) public class_id;
    mapping(uint256 => uint256) public level;
    mapping(uint256 => uint256) public health;
    mapping(uint256 => uint256) public damage;
    mapping(uint256 => bool) public is_alive;

    constructor() ERC721("Hero", "HR") {}

    function recruit(uint256 _class) external {
    ...
    function hero_info(uint256 _hero)
        external
        view
        returns (
            uint256 _xp,
