...
contract MyERC721 is Initializable, ERC721Upgradeable, AccessControlUpgradeable , UUPSUpgradeable{
    //==============================
    ...
    function setBaseURI(string memory buri) public onlyRole(DEFAULT_ADMIN_ROLE) {
