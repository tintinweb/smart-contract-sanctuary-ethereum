...
contract FreeMintTestkzfm1206 is ERC721Royalty, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    function freeMint() public {
        require(freeMintAmountMapping[msg.sender] - balanceOf(msg.sender) >= 1, "NOT WL HOLDER");
        require((freeMintCount + 1) <= freeMintMaxAmount, "There is already no remainder.");
