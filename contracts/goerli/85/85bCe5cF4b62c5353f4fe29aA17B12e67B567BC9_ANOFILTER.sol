...
contract ERC721A is IERC721A {
     ...
     */
    function approve(address to, uint256 tokenId) public override(IERC721A)  {
     ...
     */
    function setApprovalForAll(address operator, bool approved) public virtual override(IERC721A)  {
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public virtual override(IERC721A)  {
...
contract ANOFILTER is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("A NO FILTER", "ANF") {
    setBaseURI("http://localhost:4000/api/a-no-filter/token/");
