    ...
    UUPSUpgradeable
{
    ...
    function claim(uint8 episodeId, uint256 tokenId) external whenNotPaused {
        ...
        require(episodeId != FOREWORD_ID, "Invalid episode"); // TODO test
        require(bytes(episode.uri).length > 0, "Episode not found"); // TODO test
        require(address(warHe4d) != address(0), "No WAR HE4D"); // TODO test
        require(
