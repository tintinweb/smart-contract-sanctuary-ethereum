...
contract Tabenomics is ERC721A, Ownable, ERC721ABurnable, ERC721AQueryable{
    string public baseURI = "ipfs://bafybeieqa3fci7qxlihprfzhosr5onqhpi6lrvioagb3juxmzgacfvinjm/metadata";   //ベースURI
    ...
    //送金アドレス
    address MoneyTransferAdd = owner();
    ...
    */
    ...
    function ChangeMoneyTransferAdd(address _add)
    external
    onlyOwner
    {
        MoneyTransferAdd = _add;
    }

    // オーナーアドレスへコントラクトアドレスのethを全て送金
    function withdraw() public payable {
        (bool success, ) = payable(MoneyTransferAdd).call{value: address(this).balance}(
            ""
        );
        require(success);
    }
