...
contract BFMVault is UntransferableERC721, IERC721Receiver {
    ...
    ) UntransferableERC721("BFMVault", "BFMv") {
        erc721Address = _erc721Address;
        erc20Address = _erc20Address;
        setBaseURI("ipfs://QmXXmbb6ZZoBNdfboayEU7trLwM3YZJZUQdvRqaYJ7N4im/");
    ...
    function _claimRewards(uint256[] calldata tokenIds) private {
        ...
        emit ClaimedBFC(msg.sender, tokenIds, reward, block.number);
