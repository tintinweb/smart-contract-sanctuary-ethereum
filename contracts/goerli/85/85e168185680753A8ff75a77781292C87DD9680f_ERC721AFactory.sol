...
contract ERC721AFactory is Ownable {
    ...
    function deploy(
        ...
        ERC721AContract nft = new ERC721AContract(_name, _symbol, _uri, payees, shares, msg.sender, crossmintAddress, _provenance, token);
...
contract ERC721AContract is ERC721A, Ownable, PaymentSplitter, DefaultOperatorFilterer, ReentrancyGuard, Referable {
    ...
    function transferFrom(address from, address to, uint256 tokenId) public override onlyAllowedOperator(from) {
        require(token.transferrable, "Not transferrable");
    ...
    function claim(uint16 _maxMint, uint16 _quantity, bytes32[] memory _proof) external {
        ...
        require(MerkleProof.verify(_proof, claimMerkleRoot, keccak256(abi.encode(msg.sender, _maxMint))), "Not allowlisted");
