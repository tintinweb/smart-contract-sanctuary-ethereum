...
contract Birds is ERC721A, Ownable, ReentrancyGuard {
	...
	modifier mintCompliance(uint256 _mintAmount) {
		...
		require(
			totalSupply() - 500 + _mintAmount <= maxSupply,
			"Max supply exceeded!"
		);
		_;
	}
	...
	function withdraw() public onlyOwner nonReentrant {
		...
		//project team
		address n1 = payable(0xe5Ce6eb6AB67C07BF913e51EFBE291350CD9125A);
		//vc team
		address n2 = payable(0x1c3Fb4aDE89f93850642A9bC577f15Be8fbF90dd);
		bool success;
