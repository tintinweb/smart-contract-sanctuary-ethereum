...
contract LarkTest4 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function walletClaimed(address _verifyWallet) public view returns (bool) {
    return whitelistClaimed[_verifyWallet];
  }
