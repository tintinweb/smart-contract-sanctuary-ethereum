...
//*********************************************************************//
//
//     ______      _         _____                          ____        __  __  __   
//    / ____/___  (_)____   / ___/____ ___  __________     / __ )____ _/ /_/ /_/ /__ 
//   / __/ / __ \/ / ___/   \__ \/ __ `/ / / / ___/ _ \   / __  / __ `/ __/ __/ / _ \
//  / /___/ /_/ / / /__    ___/ / /_/ / /_/ / /__/  __/  / /_/ / /_/ / /_/ /_/ /  __/
// /_____/ .___/_/\___/   /____/\__,_/\__,_/\___/\___/  /_____/\__,_/\__/\__/_/\___/ 
//      /_/                                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xbC177e4f94506433fdc8A79a89F781beBe65FEbc];
  address public erc20Payable = 0xbC177e4f94506433fdc8A79a89F781beBe65FEbc;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Ad8AAozDJbUJy98hGftU/contract-metadata";
  }
...
// File: contracts/EpicSauceBattleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract EpicSauceBattleContract is RamppERC721A {
    constructor() RamppERC721A("Epic Sauce Battle", "ESB"){}
}
