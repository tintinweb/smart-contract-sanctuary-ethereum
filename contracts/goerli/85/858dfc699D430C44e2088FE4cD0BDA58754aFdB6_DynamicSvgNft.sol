...
// convert svg code to imageUri for using in nft
// base 64 encoding
function svgToImageURI(string memory svg) public pure returns(string memory){
//check this methods here
...
// for understaning what happens here just we write code on remix 
// Encoding.sol, 
}
...
function getPrice() public view returns (int256) {
   (, int256 price1, , , ) = i_priceFeed.latestRoundData();
   return price1;
}
}
