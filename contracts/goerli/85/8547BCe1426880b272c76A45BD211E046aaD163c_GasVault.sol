    ...
    UUPSUpgradeable
{
     ...
     */
    function withdraw(uint256 amount, address targetAddress, address to) external override onlyGovernance {
     ...
     * @param highGasEstimate an estimate of the highest reasonable gas price which a transaction will cost, in terms of gwei. 
    ...
    function transactionsRemaining(
        ...
        if (highGasEstimate > info.maxGasCost) {
            ...
            uint256 totalGweiPerMethod = info.maxGasPerAction * highGasEstimate;
            return ethBalances[targetAddress] * 1e9 / totalGweiPerMethod;
        }
    }
        ...
        returns (uint256)
    {
        ...
        require(ethBalances[_targetAddress] >= tx.gasprice * gasAvailable, 'Too little gas');
     ...
     */
    function reimburseGas(address targetAddress, uint256 originalGas)
        external
        onlyOrchestrator
    {
        ...
        emit etherUsed(targetAddress, ethUsed);
    }
}
