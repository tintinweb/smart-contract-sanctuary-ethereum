...
contract NFT721A is ERC721AUpgradeable, AccessControlUpgradeable {
    ...
    */
    ...
    function setPausable(bool _pausable) public adminOnly {
        pausable = _pausable;
    }
    ...
    function setContractUri(string memory _newContractUri) public adminOnly {
...
contract WowTNft721A is NFT721A, VRFConsumerBaseV2Upgradeable {
    ...
    function publicBuyToken(uint256 quantity) private whenMintable {
        require(totalTokenSold + quantity < maxSupply, "Maximum supply reached");
