...
contract UniqueBuilding is Building {
    mapping(uint256 => uint256) private _prices;

    constructor(string memory baseUri, address townBuilderAddress)
        Building(baseUri, townBuilderAddress)
    {}
    ...
    function safeTransferFrom(
        ...
        require(
            price > 0,
            "UniqueBuilding: Building with this id does not exist"
        );

        _townBuilder.burnBonus(to, price * amount);
    ...
    function safeBatchTransferFrom(
        ...
        _townBuilder.burnBonus(to, totalPrice);
    ...
    function mint(
        ...
        uint256[] calldata,
        string[] calldata
    ) public virtual override onlyOwnerOrApproved {
        revert("UniqueBuilding: Use mintUnique() function instead of this one");
    }
    ...
    ) public virtual onlyOwnerOrApproved {
...
contract Building is ERC1155, OwnableOrApproved, BaseTownsLand, IBuilding {
    ...
    mapping(uint256 => uint256) internal _tokenIdToTownType;
    ...
    function burn(
        ...
        uint256 id,
        uint256 amount
    ) external virtual onlyTownBuilder {
