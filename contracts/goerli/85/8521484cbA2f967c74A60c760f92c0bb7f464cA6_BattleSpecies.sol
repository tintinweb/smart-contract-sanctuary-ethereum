...
import "./../operator-filter-registry/src/custom/CustomOperatorFilterer.sol";
import "./../operator-filter-registry/src/custom/CustomRevokableOperatorFilterer.sol";
...
contract BattleSpecies is ERC721Namable, ERC721Enumerable, BattlespeciesWithdrawer, CustomRevokableOperatorFilterer {
    ...
    constructor(address _hyperwarpManager, address _utilityHub, bytes32 _wlRoot) ERC721Namable("Battlespecies", "BATTLE") CustomOperatorFilterer(currentOperatorFiltererRegistry, currentOperatorFiltererSubscriber, true){
 ...
 */
abstract contract CustomOperatorFilterer {
