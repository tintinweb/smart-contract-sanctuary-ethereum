...
contract CTF is Ownable {
    ...
    mapping(address => address) private solutions; // SolutionAdress => StudentAdress - Checks solutions is deployed by owner
    bool private canSubmit;
    address constant NULL = address(0);

    
    modifier examInProgress {
        require(canSubmit == true);
      _; 
    }
