...
// Proxy: 0xdB0DB4c556b75c24b9dac42090A3c59F0fe2Dd8c
// PizzaV1:
...
contract PizzaV3 is Pizza {
    ///@dev overwrite increments slices
    ...
    ///@dev ONLY allow owner to set slices
    ///@param s set number of slices
    function setSlices(uint256 s) external onlyOwner {
        slices = s;
    }
}