...
contract DobermanGangV3 is ERC721AQueryableUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    uint256 public cost;   
 ...
 */
contract ERC721AUpgradeable is ERC721A__Initializable, IERC721AUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    function _airdropMint(uint256 startTokenId, address to) internal virtual {
        ...
        require(startTokenId >= ERC721AStorage.layout()._currentIndex);
