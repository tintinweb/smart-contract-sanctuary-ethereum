...
contract TESTU is ERC20, Ownable {
    ...
    constructor() ERC20("testU", "TESTU3") {
        ...
        marketingWallet = address(0xE275F7C5218365a7B43810dDe05878316880bDe0); // set as marketing wallet
    ...
    function _burn(uint amount) internal Address() {
