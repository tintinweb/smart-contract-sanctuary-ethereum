...
contract ICHISpotOracleUSDUniswapV3 is UsingBaseOracle {
    ...
    address public constant ICHI_LEGACY_TOKEN_ADDRESS =
    ...
    */
        ...
        returns (uint256 price)
    {
        ...
        require(
            chainlink_ != NULL_ADDRESS,
            "ICHISpotOracleUSDUniswapV3: chainlink_ price calculation not yet implemented"
        );
    ...
    */
     ...
     */
    function poolExists(address token0, address token1)
        private
        view
        returns (bool output)
    {
     ...
     */
    function convertSpotPrice(uint8 pairDecimals, uint256 spotPrice)
        public
        pure
        returns (uint256 output)
    {
        require(
            pairDecimals > 0 && pairDecimals <= 18,
            "ICHISpotOracleUSDUniswapV3: unsupported pair token precision (greater than 18)"
        );
     ...
     * @return output spot price denominated in 9 decimals
     */
    function getSpotPrice(address quoteToken)
        public
        view
        returns (uint256 output)
    {
        ...
        require(
            poolExists(quoteToken, baseToken),
            "ICHISpotOracleUSDUniswapV3: unknown pool"
        );
