    ...
    Ownable
{
        ...
        external
    {
        ...
        //todo: depending on below comment, might need to do a check on whether oneToOneAddressReserve is 0, and if it is, start ignoring it
        // require(
        //     uint256(quantity) <= oneToOneAddressReserve,
        //     "Minting quantity exceeds allocation left for reserve"
        // );
        ...
        external
    {
        ...
        //todo: depending on below comment, might need to do a check on whether publicSaleFreeAllowlistReserve is 0, and if it is, start ignoring it
        // require(
        //     uint256(quantity) <= publicSaleFreeAllowlistReserve,
        //     "Minting quantity exceeds allocation left for reserve"
        // );
     ...
     */
    function stake(uint256 quantity, uint256[] calldata tokenIds)
        external
    {
        require(
            isStakingActive,
     ...
     */
    function unstake(uint256 quantity, uint256[] calldata tokenIds)
        external
    {
        require(
            quantity == tokenIds.length,
