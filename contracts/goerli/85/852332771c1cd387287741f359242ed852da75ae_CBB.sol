...
LHMI - Last Hudred Million Inu

Telegram: Https://T.me/LMHIportal
...
contract CBB is Context, IERC20, Ownable {
    ...
    bool public transferDelayEnabled = true; ///fights againts MEV drainer
    ...
    string private constant _name = unicode"Can Byb Bui";
    string private constant _symbol = unicode"CBB";
    ...
    function removeLimits() external onlyOwner{
        ...
        transferDelayEnabled=false;   ///if needed can be removed
