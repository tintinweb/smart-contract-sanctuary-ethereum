...
import "./interfaces/INyxRedeemProposal.sol";

contract NyxRedeemProposal is NyxProposal, INyxRedeemProposal {
    string public constant name = "NyxRedeemProposal";
        ...
        returns (RedeemProposalParams memory)
    {
        ...
        return RedeemProposalParams(RedeemAction(bytesToUint(params[0])),
    ...
    function getProposal(bytes memory proposalBytes)
        ...
        returns (bytes[] memory)
    {
        RedeemProposalParams memory params = parseProposalParams(proposalBytes);
        ...
        returns (bytes[nparams][] memory props)
    {
        ...
        {
            RedeemProposalParams memory params = parseProposalParams(proposalBytesArr[idx]);
...
// @title INyxRedeemProposal for Nyx DAO
// @author TheV
...
interface INyxRedeemProposal {
    ...
    function parseProposalParams(bytes[] memory params) external pure returns (RedeemProposalParams memory);
    function parseProposalParams(bytes memory params) external pure returns (RedeemProposalParams memory);
    function proposalToBytes(RedeemProposal memory proposal) external pure returns (bytes memory);
