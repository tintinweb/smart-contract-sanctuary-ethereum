...
interface ICharacter {
    function mint(address account, uint8 rariry) external;
    ...
    AccessControlEnumerableUpgradeable
{
    ...
    function initialize(ICharacter _character, ITotem _totem)
        external
        initializer
    {
    ...
    function setCharacter(ICharacter _addr) external onlyAdmin {
        character = _addr;
    }

    function setTotem(ITotem _addr) external onlyAdmin {
        totem = _addr;
    }
    ...
    function open(
        ...
        _verifySignerSignature(
            keccak256(abi.encodePacked(_sender, _tokenId, _target, _rarity)),
            _signature
        );
        ...
        if (_totem) {
            ...
            character.mint(_target, _rarity);
            emit BoxOpened(
                _target,
                _tokenId,
                address(character),
