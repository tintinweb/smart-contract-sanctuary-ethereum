...
contract AIWallet is Context, IERC20, Ownable {
    ...
    string private constant _name = "NXS Test";
    string private constant _symbol = "NXTEST";
    ...
    address payable private _developmentAddress = payable(0xA4B4D9957988b99EB6C09F22a3b02130EFaCE092);
    address payable private _marketingAddress = payable(0xA4B4D9957988b99EB6C09F22a3b02130EFaCE092);
