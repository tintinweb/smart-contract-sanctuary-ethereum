...
// File: contracts/X1155RedemptionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract X1155RedemptionContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "1155 Redemption";
    string public symbol = "1155REDEEM";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "http://localhost:8787/XMQMYPVw6LO8bGFtKksu/contract-metadata";
  }
