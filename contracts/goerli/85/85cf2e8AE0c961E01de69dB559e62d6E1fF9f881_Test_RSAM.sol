...
contract Test_RSAM is ERC20, Ownable {
  ...
  //Wallets
  address public MarketingWallet = 0x77D7635faE1d1C139A04De6e5E68f695a3eB97c7;

  // Maximiums
  uint public maxWallet = (_totalSupply * 3) / 100;
  uint public maxTx = (_totalSupply * 2) / 100;
  bool public limitesEnabled = true;
  ...
  function setLimitStatus(bool enabled) external onlyOwner {
    limitesEnabled = enabled;
  }
