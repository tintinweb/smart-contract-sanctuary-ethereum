...
contract GenesisToken is ERC721Drop, IERC721Enumerable {
    ...
    function getLastTransferTimestamp(uint256 _tokenId) public view virtual returns (uint64 timestamp) {
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Drop) returns (bool) {
