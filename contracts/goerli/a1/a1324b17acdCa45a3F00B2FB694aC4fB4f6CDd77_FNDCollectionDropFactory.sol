...
contract FNDCollectionDropFactory is Initializable, ICollectionFactory {
  ...
  /**
   * @notice Emitted when the market contract used by collections is updated.
   * @param marketContract The new market contract address.
   */
  ...
  function _updateMarketContract(address _marketContract) private {
