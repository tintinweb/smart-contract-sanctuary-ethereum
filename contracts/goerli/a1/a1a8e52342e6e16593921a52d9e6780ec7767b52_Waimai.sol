...
contract Waimai is ERC721A, Ownable {
    ...
    uint256 private publicListMintPrice = 0.050000 ether;
    ...
    uint256 whiteListMintAmount = 288;

    constructor() ERC721A("waimai", "WMT", 5, 888) {}
    
    // metadata URI
    string private _baseTokenURI = "ipfs://QmTQAnMtK72GC1U4u2iYxaDa3UXnBwSSDsAGAMKu8cGXL8/";
