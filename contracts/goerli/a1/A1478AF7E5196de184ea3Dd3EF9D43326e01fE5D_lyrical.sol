...
contract lyrical is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable MAX_SUPPLY = 500;
    uint256 public constant PRICE = 0.00001 ether; //0.5 ether;
    uint256 public maxPresale = 1;
    uint256 public maxPublicTx = 1;

    uint256 public immutable amountForTeam = 50;
    ...
    constructor(
        ...
        ERC721A("ly", "ly", 1, 5)
    {
        publicRoot = 0xe89f3060fa212ed961b1c77ffeb590c8ab81e3c93ef5074db417bb4b26a74975;
    }
