...
contract TheSociety is ERC721A, ReentrancyGuard, Ownable, PaymentSplitter {

    // Minting Variables
    uint256 public mintPrice = 0.000069 ether;
    uint256 public maxPurchase = 11;
    uint256 public maxSupply = 3333;
    address public ogIvacAddress; // = 0xd33fb3aa635448117455093e763928a5e93a51e8;

    address[] public _payees = [
        0x4e4CC29ab82cf8aa4EcD3578A26409E57793de4b,  // dev
        0xFBA83ffcb2D1a7bDc76382F182a6dC193820a3a0,  // contract

        0x2488Fe1C7caFc496cb59C4870D07c9e44Fbb1f77   // community
    ];
    uint256[] private _shares = [5, 45, 50];
    ...
    string _basePassURI = "http://ipfs.io/ipfs/QmU1MSagkzwvxKJ51QHvi8aoBwQa5Cbs7H879yKhW7kp2U/";
    ...
    constructor() ERC721A("TheSociety ", "THESOC") PaymentSplitter(_payees, _shares) {
    ...
    function passURIprep(uint256 tokenId) public view virtual  returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");

        string memory baseURI = _basePassURI;
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, Strings.toString(tokenId))) : "";
    }

   function passURI(uint256 tokenId) public view  returns (string memory){
        return string(abi.encodePacked(passURIprep(tokenId), ".json"));
