...
contract KW is ERC721A, Ownable {
    ...
    string  public baseTokenURI = "ipx";
    string  public defaultTokenURI;
    uint256 public maxSupply = 2023;
    uint256 public publicSalePrice = 0.0018 ether;
    uint256 public allowListSalePrice = 0.0018 ether;

    address payable public payMent;
    mapping(address => uint256) public usermint;
    mapping(address => uint256) public allowlistmint;

    bytes32 private _merkleRoot = 0x5b0abc08220b640a643845024ef4178e39a5233d9070f38b2f54dafb865813e1;


    constructor() ERC721A ("KW", "KW") {
    ...
    function allowListMint(bytes32[] calldata _merkleProof, uint256 _quantity) external payable  {
        require(publicMintStatus == EPublicMintStatus.PUBLIC_MINT, "Allowlist sale closed");
        require(totalSupply() + _quantity <= maxSupply, "Exceed supply");
        require(allowlistmint[msg.sender] + _quantity <= 5, "Exceed supply");
        require(msg.value >= allowListSalePrice * _quantity);
