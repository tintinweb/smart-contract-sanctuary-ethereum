...
contract MintPass is ERC721AQueryable, Ownable, ERC2981 {
    ...
    string public BASE_URI = "ipfs://Qmai7uXemnCbddcpFqDM2hykkPujgp8UxXcbYwm1oFeuqX/";
    ...
    ) external payable canMint(PRE_MINT_SUPPLY) {
    ...
    function openMint(
        bytes calldata _signature
    ) external payable canMint(MAX_SUPPLY) {
