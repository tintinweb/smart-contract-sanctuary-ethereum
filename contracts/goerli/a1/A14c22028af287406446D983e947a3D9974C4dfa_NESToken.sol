...
contract NESToken is ERC721x {
    ...
    constructor(
        ...
        _defaultRoyaltyInfo = RoyaltyInfo({
            ...
            royaltyFraction: uint96(_royaltyBps)
        });
        _tokenRoyaltyInfo[0] = RoyaltyInfo({
            receiver: _royaltyFeeRecipient,
            royaltyFraction: uint96(10000 - _royaltyBps)
        });
    }
