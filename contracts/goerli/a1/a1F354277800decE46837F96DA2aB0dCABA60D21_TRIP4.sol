...
contract TRIP4 is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint public transactionLimit = 5;      // Test amt.
    uint public walletLimit = 5;          // Test amt.
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[0]] = Account( 100, 0, 1 ); // jdtest
        accounts[teamclaim[1]] = Account(  21, 0, 3 ); // jdtest
        accounts[teamclaim[2]] = Account(  20, 0, 1 ); // tbd
        accounts[teamclaim[3]] = Account(  21, 0, 1 ); // tbd
        accounts[teamclaim[4]] = Account(  20, 0, 1 ); // tbd
