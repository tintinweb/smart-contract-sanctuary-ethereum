...
contract LinRevealTest3 is ERC721A, Ownable, ReentrancyGuard { 
    ...
    constructor(string memory _hiddenMetadataUri,string memory initBaseURI) ERC721A("LinRevealTest3", "LinRevealTest3") {
