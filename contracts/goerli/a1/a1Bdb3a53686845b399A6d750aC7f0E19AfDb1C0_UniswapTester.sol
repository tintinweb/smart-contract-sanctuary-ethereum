...
// Goerli swapRouter: 0xE592427A0AEce92De3Edee1F18E0157C05861564
...
contract UniswapTester {
        ...
        returns (uint256 amountOut)
    {
        ...
        // approve router to spend it now
        TransferHelper.safeApprove(USDC, address(swapRouter), amountIn);

        // IMPORTANT!!! amount out minimum is set to zero...BUT!!!
        // this value needs to be set based on the on-chain oracle to prevent
        // a front-running sandwich
