...
contract LixHodl is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1057199 * 10**_decimals;
    string private constant _name = unicode"LixHodl";
    string private constant _symbol = unicode"LIXH";
