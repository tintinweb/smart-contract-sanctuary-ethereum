...
contract BalancerVaultUpgradable is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function initialize(address _dusd, address _dai, address _fluid, address _fluidTreasury, address _balancerVault, bytes32 _balancerPoolId, address _dusdDaiPool) public initializer {
    __Ownable_init();
