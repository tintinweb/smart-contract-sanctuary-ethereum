...
contract TrailTwo is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Hidden", "TR2") {
    setHiddenMetadataUri("ipfs://QmY1LcKor7Foc6EsGNFytCqjmsZZtjCc352XwJ71uMS7Da/hidden.json");
  }
