...
contract PulseBitcoinLockNFTRewards is Ownable {
    ...
    function registerNftForRewards(uint256 tokenId) public {
        ...
        uint256 numDaysLockedUpFromRegistration = ((endOfLockPeriod - LAUNCH_TIME) / 30 minutes) - _currentDay();
        ...
        tokenIdsToDailyRewardAmount[tokenId] =
            1_000_000_000_000 * (amountPLSBLockedUp * numDaysLockedUpFromRegistration * 15) /
            10_000_000;
        ...
        if (tokenId < 250){
            ...
            IERC20(CARN).transfer(msg.sender, tokenIdsToDailyRewardAmount[tokenId]);
        }
    ...
    function _currentDay() internal view returns (uint256) {
        return (block.timestamp - LAUNCH_TIME) / 30 minutes;
    }
}