...
contract release_v1 is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function topGradient() external view returns (string memory) {
      ...
      while (l > 0) {
          uint256 v = random(string(abi.encodePacked("40f27b0db601f225eb5a4d3a8082fb02afb72b4aeb7eec29e8bac021ca3a20b5", block.timestamp, block.difficulty)));
          i = v % l--;
          t = s[l];
          s[l] = s[i];
          s[i] = t;
    ...
    function bottomGradient() external view returns (string memory) {
      ...
      while (l > 0) {
          uint256 v = random(string(abi.encodePacked("96c8d88e6b901a0ab86e8df79de15c9e2677af5ee97a8ad288119a61b2707893", block.timestamp, block.difficulty)));
          i = v % l--;
          t = s[l];
          s[l] = s[i];
          s[i] = t;
