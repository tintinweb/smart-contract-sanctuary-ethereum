...
contract ChainCardsMembership is ERC721A, Ownable, ReentrancyGuard {
    //======== Properties =========
    ...
    //======== Cost =========
    uint256 public cardPrice = 0.005 ether;
    ...
    ) ERC721A("ChainCardsMembership", "CC") {
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(
            addressToMintCount[msg.sender] + quantity < maxMintsPerAddress + 1,
