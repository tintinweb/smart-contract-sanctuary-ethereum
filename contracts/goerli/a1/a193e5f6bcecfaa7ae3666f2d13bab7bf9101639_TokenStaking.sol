...
contract TokenStaking is Ownable, ReentrancyGuard {
    ...
    function updateYield(address _address, uint256 _yield) external view onlyOwner {
        require(stakingMetaList[_address].yieldUpdatedAt == 0, "TokenStaking: updateYield: An updated account exists.");
        require(msg.sender != address(0), "TokenStaking: updateYield: Cannot execute at zero address.");
        ...
        meta.yield = _yield;
        meta.totalReward = totalReward;
        meta.yieldUpdatedAt = block.timestamp;
    }
