...
contract Juiceboxes is ERC721A, Ownable {
    ...
    address private payoutWallet = 0x9FB12a62a37cEcc3Da9337FeF9339fF58329Bee5;
    ...
    function mintWithPoint(address _address, uint256 _points, bool _topHolder, bytes calldata _voucher) external payable {
        ...
        if (block.timestamp < mintStart + 43200) {
            ...
            uint256 requiredPoints = 11 - (block.timestamp - (mintStart + 43200)) / 3600;
    ...
    function pointsRequired() external view returns (uint256) {
        ...
        return 12 - (block.timestamp - (mintStart + 43200)) / 3600;
    }

    function pointMintActive() public view returns (bool) {
        return (block.timestamp > mintStart && block.timestamp < mintStart + 86400);
    }
    //
