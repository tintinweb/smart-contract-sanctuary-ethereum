...
contract FutureForgeTest10 is AccessControl, ERC1155Holder {
  ...
  function getRandomArtifactId(
    ...
    console.log("[getRandomArtifactId] forge#", forgeIteration);
    ...
    if (tier == 1) {
      ...
      // console.log("[getRandomArtifactId] if tier3, forge#", forgeIteration);
      totalWeight = calculateTotalWeight(
        _tier3Artifacts,
        tier3MapLength,
        tier3startId
      ...
      // console.log("randomNum: %s", randomNum);
      // console.log("totalWeight: %s", totalWeight);
      // console.log("tier3MapLength: %s", tier3MapLength);
      // console.log("tier3startId: %s", tier3startId);

      for (uint256 i = tier3startId; i < tier3MapLength + tier3startId; i++) {
        // console.log("forge i: %s", i);
        // console.log(
        //   "forge _tier3Artifacts[i].maxSupply: %s",
        //   _tier3Artifacts[i].maxSupply
        // );
        // console.log(
        //   "forge _tier3Artifacts[i].mintedSupply: %s",
  ...
  function calculateTotalWeight(
    ...
    // console.log("[calculateTotalWeight] forge#", forgeIteration);
    uint256 totalWeight = 0;

    for (uint8 i = 0; i < mapSize; i++) {
      // console.log("calculateTotalWeight i: %s", i);

      // console.log("Artifact mintedSupply: %s", artifacts[i].mintedSupply);

      // console.log("Artifact maxSupply: %s", artifacts[i + startId].maxSupply);

      totalWeight += (artifacts[i + startId].maxSupply -
        artifacts[i + startId].mintedSupply);
    }
    // console.log("[calculateTotalWeight] return forge#", forgeIteration);
    // console.log("returned totalWeight: %s", totalWeight);
    return totalWeight;
  }
  ...
  function forge(uint256 _dragonQuantity) public returns (uint256) {
    console.log("[forge] forge#", forgeIteration);
    require(
      _dragonQuantity > 2,
    ...
    console.log("artifactId: %s", artifactId);
  ...
  function mintArtifact(
    ...
    if (tier == 3) {
      console.log("[mintArtifact] forge#", forgeIteration);
      console.log("------------- MINTING ID -------------> ", _artifactId);
      console.log("tier3Supply: %s", tier3Supply);
      console.log("tier3MaxSupply: %s", TIER_3_MAX_SUPPLY);

      console.log("mintedSupply", _tier3Artifacts[_artifactId].mintedSupply);
      console.log("maxSupply", _tier3Artifacts[_artifactId].maxSupply);
