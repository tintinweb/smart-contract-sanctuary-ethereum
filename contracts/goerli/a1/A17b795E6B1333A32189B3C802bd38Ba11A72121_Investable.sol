...
"investors will not be surprised.";
    ...
    constructor(address alf, address usdt) {
        ...
        investPlans.push(
            InvestPlan({
                name: "Rookie",
                desc: "A desc",
                alfToLock: 2_500, // TODO à définir
                minimumUsdtToInvest: 500 * 10 ** ERC20(usdtAddress).decimals(),
                maximumUsdtToInvest: 1000 * 10 ** ERC20(usdtAddress).decimals()
        }));
        ...
        investPlans.push(
            InvestPlan({
                name: "Sophomore",
                desc: "A desc",
                alfToLock: 2_000, // TODO à définir
                minimumUsdtToInvest: 1000 * 10 ** ERC20(usdtAddress).decimals(), // TODO à définir
                maximumUsdtToInvest: 5000 * 10 ** ERC20(usdtAddress).decimals()
        }));
        ...
        investPlans.push(
            InvestPlan({
                name: "Professional",
                desc: "A desc",
                alfToLock: 1_500, // TODO à définir
                minimumUsdtToInvest: 5000 * 10 ** ERC20(usdtAddress).decimals(), // TODO à définir
                maximumUsdtToInvest: 10000 * 10 ** ERC20(usdtAddress).decimals()
        }));
        ...
        investPlans.push(
            InvestPlan({
                name: "All-Star",
                desc: "A desc",
                alfToLock: 1_000, // TODO à définir
                minimumUsdtToInvest: 10000 * 10 ** ERC20(usdtAddress).decimals(), // TODO à définir
                maximumUsdtToInvest: 50000 * 10 ** ERC20(usdtAddress).decimals()
        }));
        investPlans.push(
            InvestPlan({
                name: "Legend",
                desc: "A desc",
                alfToLock: 500, // TODO à définir
                minimumUsdtToInvest: 50000 * 10 ** ERC20(usdtAddress).decimals(), // TODO à définir
                maximumUsdtToInvest: 0 * 10 ** ERC20(usdtAddress).decimals()
        }));
    ...
    function getAlfToLock(address investor, uint percentage, uint amount) internal view returns(uint256) {
        ...
        return amount.mul(ERC20(alfAddress).decimals()).mul(percentage).mul(10**decimalsApproval).div(10_000).div(priceApproval);
    ...
    function invest(uint256 _usdtAmount, uint _investPlan, uint _duration, address _referrant) external {
        ...
        require(ERC20(alfAddress).balanceOf(msg.sender) >= alfToLock, "Not enough ALF to lock !");
        require(ERC20(usdtAddress).balanceOf(msg.sender) >= _usdtAmount, "Not enough Usdt to invest !");

        require(ERC20(alfAddress).allowance(msg.sender, address(this)) >= alfToLock, "Not allowed to withdraw this amount of alf!");
    ...
    function addInvestPlan(
        ...
        investPlans.push(
            InvestPlan({
                ...
                minimumUsdtToInvest: _minimumUsdtToInvest, // TODO à définir
                maximumUsdtToInvest: _maximumUsdtToInvest
        }));
    }
