...
contract LotteryGame is VRFConsumerBase, Ownable {
    ...
    event RequestedRandomness(address winner, bytes32 requestId);
    event EndGame(bytes32 requestId);
   ...
   */
    ...
    */
    function startGame(uint256 _entryFee) public onlyOwner {
        ...
        require(lottery_state == LOTTERY_STATE.CLOSED, "Can't start a new game yet!");
    ...
    function endGame() public onlyOwner {
        ...
        emit RequestedRandomness(recentWinner, requestId);
        // lottery_state = LOTTERY_STATE.CLOSED;
    }
