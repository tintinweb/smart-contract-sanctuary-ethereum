...
contract Pool7 is Initializable, ERC777Upgradeable, IERC721ReceiverUpgradeable {
    ...
    */
    function borrow(uint256 amount, uint256 maxRate, uint256 propTokenId) public {
        ...
        uint256 newTokensMinted = getProportionalPoolTokens(amount.div(100));
    ...
    */
    ...
    function repay(uint256 loanId, uint256 amount) public {        
        ...
        uint256 newTokensMinted = getProportionalPoolTokens(servicerFeeInERC);
        super._mint(servicer, newTokensMinted, "", "");
    }
