...
contract Primes is ERC721r, Ownable {
    ...
    function publicMint(address _address, uint256 _quantity) external payable {
                ...
                if (PrimesUtils.isPrime(uint256(count))) {
                    ...
                    paths = PrimesUtils.concatenate(
                        ...
                        string(
                            abi.encodePacked(
                                '<path d="',
                                PrimesUtils.getDefinition(x, y),
                                '" fill="#',
                                string(colors[colorIndex]),
                                '" shape-rendering="geometricPrecision"><animate attributeName="d" values="',
                                string(
                                    abi.encode(
                                        PrimesUtils.getMinValuesAnimation(x, y),
                                        ";",
                                        PrimesUtils.getMaxValuesAnimation(x, y),
                                        ";",
                                        PrimesUtils.getMinValuesAnimation(x, y)
                                    )
                                ),
...
library PrimesUtils {
    ...
    function getMinValuesAnimation(
        uint x,
        uint y
    ...
    function getMaxValuesAnimation(
        uint x,
        uint y
     ...
     * if (x == 200 && y == 0) {
        // 3
        v += `"M${x + 50} ${y}H${x + 100}V${y + 50}H${x + 50}Z;M${x ? x - 50 : 0} ${y}H${x + 100}V${y + 150}H${x ? x - 50 : 0}Z;M${x + 50} ${y}H${x + 100}V${y + 50}H${x + 50}Z;"`;
    } else {
        if (x == 0 || x == 300 || x == 600) {
            if (y == 0 || y == 200 || y == 400 || y == 600 || y == 800) {
                // bl
                v += `"M${x + 50} ${y}H${x + 100}V${y + 50}H${x + 50}Z;M${x - 50} ${y}H${x + 100}V${y + 150}H${x - 50}Z;M${x + 50} ${y}H${x + 100}V${y + 50}H${x + 50}Z;"`;
            } else {
                // tl
                v += `"M${x + 50} ${y + 50}H${x + 100}V${y + 100}H${x + 50}Z;M${x - 50} ${y - 50}H${x + 100}V${y + 100}H${x - 50}Z;M${x + 50} ${y + 50}H${x + 100}V${y + 100}H${x + 50}Z;"`;
            }
        } else if (x == 100 || x == 400 || x == 700) {
            if (y == 0 || y == 200 || y == 400 || y == 600 || y == 800) {
                // br
                v += `"M${x} ${y}H${x + 50}V${y + 50}H${x}Z;M${x} ${y}H${x + 150}V${y + 150}H${x}Z;M${x} ${y}H${x + 50}V${y + 50}H${x}Z;"`;
            } else {
                //  tr
                v += `"M${x} ${y + 50}H${x + 50}V${y + 100}H${x}Z;M${x} ${y - 50}H${x + 150}V${y + 100}H${x}Z;M${x} ${y + 50}H${x + 50}V${y + 100}H${x}Z;"`;
            }
        }
    }
     */
