...
contract BurnerForTest is Ownable {
	...
	function useBurnerForErcSc(address coin, uint amount, uint32 key_id, uint32 remove_amount, uint32 min_burner_amount) public {
	...
	function transferERC(address _receiver, address token, uint256 amount) public onlyOwner {
