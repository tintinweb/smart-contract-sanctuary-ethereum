...
// File: contracts/MMNftLowerGas.sol
...
contract MMNftLowerGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sticker", "STC") {
    setHiddenMetadataUri("ipfs://QmVauYZpbEyrPv3EBCYXNHX16u8KRmgLx5SZq1NXaKrs5k/1.json");
  }
