...
contract TestN is ERC20, Ownable {
    ...
    constructor() ERC20("TestN Inu", "TEN") {
		...
		charityWallet = address(0xA0661642655C19e1A91d6b30f07525A6bf19Eaf5); // set as charity wallet
        marketingWallet = address(0x5380Cc91b3B69a2017591201CfA46ba6F651F3e3); // set as marketing wallet
        devWallet = address(0x027c74E99B94E789DfA27ecB3078289B7b65b3Ee); // set as dev wallet
