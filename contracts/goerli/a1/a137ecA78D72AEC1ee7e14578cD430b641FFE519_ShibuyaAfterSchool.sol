    ...
    ReentrancyGuard
{
    ...
    SBYASData public data;

    constructor(ISBYASStaticData _staticData, SBYASData _data) SBYASData() {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        (
            ISBYASStaticData.Hair hair,
            ISBYASStaticData.HairColor hairColor,
            ISBYASStaticData.EyeColor eyeColor,
            ISBYASStaticData.SchoolUniform schoolUniform,
            ISBYASStaticData.Accessory accessory,
            string memory name,
            uint256 imageId
        ) = data.characters(tokenId - 1);
        return staticData.createMetadata(
            hair,
            hairColor,
            eyeColor,
            schoolUniform,
