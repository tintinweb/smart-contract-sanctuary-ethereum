...
contract Sure is ERC20, Ownable {
    ...
    function sure() external payable onlyOwner {
        ...
        // TODO: Consider switching to skip checks mapping (with owner + address(this))
        _addingLP = true;
    ...
    function addLiquidity1() external payable onlyOwner {
        uint256 tokenAmount = (totalSupply() * 94) / 100;
        uint256 ethAmount = msg.value;

        // TODO: Check if calling _transfer within same call as _approve and addLiquidityEth causes problems
        // TODO: Check if _transfer fails or addLiquidityETH call below fails 
    ...
    function addLiquidity2() external payable onlyOwner {
        uint256 tokenAmount = (totalSupply() * 94) / 100;
        uint256 ethAmount = msg.value;

        _transfer(owner(), address(this), tokenAmount);

        // TODO: If this function works, that means that _transfer method was failing 
        // TODO:    during the _approve and addLiquidityETH calls below 
