...
contract MyExercise is IExerciceSolution, IFlashLoanSimpleReceiver{

    ERC20 public _aDAI;  
    ERC20 public _USDC ; 
    ERC20 public _variableDebtUSDC;
    ERC20 public DAI;  
    ERC20 public USDC; 
    IPool public pool;
    Evaluator public eval;
    address public owner;
    

    constructor() public{
        _aDAI = ERC20(address(0xADD98B0342e4094Ec32f3b67Ccfd3242C876ff7a)); 
        _USDC = ERC20(address(0x65aFADD39029741B3b8f0756952C74678c9cEC93)); 
        _variableDebtUSDC = ERC20(address(0x4DAe67e69aCed5ca8f99018246e6476F82eBF9ab)); 
        DAI = ERC20(address(0xBa8DCeD3512925e52FE67b1b5329187589072A55)); 
        USDC = ERC20(address(0x65aFADD39029741B3b8f0756952C74678c9cEC93)); 
        pool = IPool(address(0x7b5C526B7F8dfdff278b4a3e045083FBA4028790));
        eval = Evaluator(payable(0xaeaD98593a19074375cCf3ec22E111ce48C02c7E));
        owner = msg.sender;
    ...
    function depositSomeTokens() external override {
        ...
        require(DAI.approve(address(pool), amount), "approve failed");
    ...
    function borrowSomeTokens() external override {
        ...
        require(DAI.approve(address(pool), amount), "approve failed");
        require(USDC.approve(address(pool), amount), "approve failed");
    ...
    function doAFlashLoan() external override {
        // require(USDC.approve(address(pool), 1000000*10**6), "approve failed");
        // pool.flashLoanSimple(address(this),address(USDC), 1000000*10**6, "",0);
    }
    ...
    eval.ex9_performFlashLoan();
    return true;

  }

function ADDRESSES_PROVIDER() external override view returns (IPoolAddressesProvider){
    return IPoolAddressesProvider(address(0x7b5C526B7F8dfdff278b4a3e045083FBA4028790));
}
...
// 0x1fFb6E20849a681e3004195D19132cc68777C520
//truffle run verify [email protected] --network goerli
