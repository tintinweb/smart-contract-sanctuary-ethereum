...
contract TEST is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 30_000_000 * 10**18;
    uint256 public maxSellLimit = 10_000_000 * 10**18;
    uint256 public maxWalletLimit = 30_000_000 * 10**18;
    ...
    address public marketingWallet = 0x66414626710FC3B8Ad95AEc6100Aa28815776244;
    address public devWallet = 0x66414626710FC3B8Ad95AEc6100Aa28815776244;
    address public operationsWallet = 0x66414626710FC3B8Ad95AEc6100Aa28815776244;
    address public charityWallet = 0x66414626710FC3B8Ad95AEc6100Aa28815776244;
    ...
    Taxes public taxes = Taxes(4, 0, 1, 1, 2, 0);
    Taxes public sellTaxes = Taxes(4, 0, 1, 1, 2, 0);
    ...
    constructor(address routerAdd) ERC20("TEST", "TEST") {
