...
contract ERC1155ABClone is ERC1155Upgradeable, OwnableUpgradeable {
    ...
    function mintBatch(
        ...
        _mintBatch(_to, _collectionIds, _amounts, '');
    }
    ...
    function initDrop(
        ...
        collections[collectionCount] = Collection(_maxSupply, _price);

        // Initialize payout index
        payoutContract.initPayoutIndex(uint32(collectionCount));

        // Mint Genesis (?)
        if (_mintGenesis) _mint(msg.sender, collectionCount, 1, '');
    ...
    function _beforeTokenTransfer(
        ...
        payoutContract.updatePayout1155(_from, _to, _collectionIds, _amounts);
    }
}
