...
contract Vendor is Ownable {
    ...
    function buyTokens() public payable {
        ...
        // Transfert tokens from the vendor to the user that triggers the buyTokens function
        yourToken.transfer(address(msg.sender), amount);
    ...
    function sellTokens(uint256 _amount) public payable {
        ...
        (bool success, ) = msg.sender.call{value: theAmount}("");
