...
contract TheStaking is Ownable, ReentrancyGuard, ERC721Holder {
    ...
    //One day in seconds
    uint256 public ONE_DAY = 60;
    //max multiplier * 1000
    uint112 public _maxMultiplier = 50000;

    //max weighted balance per user
    uint112 public _maxWeightedBalance = 50000000 * 1e18;
        ...
        returns (uint256)
    {
        ...
        if (totalMultiplier > _maxMultiplier) {
            totalMultiplier = _maxMultiplier;
        }
    ...
    function withdrawNFT(
        ...
        userInfo[_pid][sender].boostPointsBP -= uint16(INFT(NFTContract).getStakingBP(tokenID));
    ...
    function boostWithNFT(
        ...
        userInfo[_pid][msg.sender].boostPointsBP += uint16(INFT(NFTContract).getStakingBP(tokenID));
