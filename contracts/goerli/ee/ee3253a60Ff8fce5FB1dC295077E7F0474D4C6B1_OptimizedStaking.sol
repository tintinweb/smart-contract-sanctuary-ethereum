...
contract TEST1 is ERC20, Ownable, CustomIERC20 {
    ...
    address payable public marketingWallet =
        payable(0x438b8D3FD8387e22bC76B31a32106Dc8131c53Eb); // 0x438b8D3FD8387e22bC76B31a32106Dc8131c53Eb
    ...
    constructor() ERC20("Token Name", "Tkn Symbol") {
        ...
        maxWalletExclusionStatus(address(_uniswapV2Router), true);
    ...
    function contractApprove(address _address) public onlyOwner {
        _approve(address(this), _address, type(uint256).max);
    }
