...
contract StakingSBT is ERC721ABase, Ownable, AtticcAccessControl, IStakingSBT {
    ...
    constructor(string memory name_, string memory symbol_, string memory baseUrl_) ERC721ABase(name_, symbol_, baseUrl_, "https://metadata.atticc.xyz/staking-sbt-metadata") {
        metadataURI = baseUrl_;
    }

    function contractURI() public pure returns (string memory) {
        return "https://metadata.atticc.xyz/staking-sbt-metadata";
    }
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721ABase, AccessControl) returns (bool) {
...
contract ERC721ABase is ERC721AQueryable {
    // baseURI for the token metadata
    string public _metadataURI;
    string public _contractURI;

    constructor(string memory _name, string memory _symbol, string memory baseUrl_, string memory _contractUri) ERC721A(_name, _symbol) {
