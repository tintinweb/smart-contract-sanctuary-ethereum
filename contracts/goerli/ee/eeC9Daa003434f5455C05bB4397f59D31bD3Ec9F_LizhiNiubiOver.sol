...
contract LizhiNiubiOver is ERC721, Ownable {
    ...
    constructor() ERC721("LizhiNiubiOver", "SYMBOL") {
        baseUri = "ipfs://QmaqVgKwtoyuWvj7JqiPexmcvik125Km2FhVmAsTKncPss/";
    }

    // Public Functions
    function mint(uint256 _numTokens, bytes32[] memory proof) external payable {
