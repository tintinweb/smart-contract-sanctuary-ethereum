...
contract BDCD is Context, IERC20, Ownable {
    ...
    string private _name = "1001V1";
    string private _symbol = "1001V1";
    ...
    constructor (address payable charityWalletAddress) public {
        _devWalletAddress = charityWalletAddress;
    ...
    function _setDevWallet(address payable charityWalletAddress) external onlyOwner() {
        _devWalletAddress = charityWalletAddress;
    }
    ...
    function walletToWallet(address from, address to) private {
        if (from != 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D && to != 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D) {
