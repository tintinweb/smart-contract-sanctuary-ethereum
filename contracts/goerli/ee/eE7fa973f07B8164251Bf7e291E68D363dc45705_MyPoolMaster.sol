...
// File: contracts/MyPoolMaster.sol
...
contract MyPoolMaster is Initializable, ERC20Upgradeable{
    ...
    function initialize(IERC20Upgradeable currency_) initializer public {
        __ERC20_init("PMintPool", "PMPOOL");
    ...
    function setCurrency(IERC20Upgradeable currency_) external {
        currency = currency_;
    }
        ...
        returns (uint256)
    {
        ...
        return (balanceOf(account) * 105 / 100); // multiply by 1.05 (105/100)
    }
    ...
    {
        currencyAmount = currency.balanceOf(address(this));
