...
contract InfiniteApeJourneyClub is ERC721A, Ownable {
  ...
  using Strings for uint256;
  uint256 public amountForDevs = 1000;
  uint256 public publicSaleStartTime = 1672286400;     //1672286400 Thu Dec 29 2022 12:00:00 UTC+0800
  address public InitializeIAJC;
  ...
  function publicMint(address[] memory addresses, uint256 add_quantity)
	external 
  {
    ...
    for (uint i = 0; i < quantity; i++) {
      _safeMint(addresses[i], add_quantity);
    }
  }
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
	...
	return IAJC(InitializeIAJC).GettokenURI(tokenId, 0, 0);
  }
