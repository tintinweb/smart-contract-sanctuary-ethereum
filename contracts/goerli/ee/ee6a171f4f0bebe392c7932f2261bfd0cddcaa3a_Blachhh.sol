...
contract Blachhh is ERC20, Ownable {
    ...
    string constant _name = "Blachhh";
    string constant _symbol = "$BLACHhh";
    uint8 constant _decimals = 9;

    uint256 constant _totalSupply = 10_000 * (10 ** _decimals); 
    uint256 public _maxWalletAmount = _totalSupply.mul(11).div(1000); 
    uint256 public _maxTx = _totalSupply.mul(11).div(1000); 
