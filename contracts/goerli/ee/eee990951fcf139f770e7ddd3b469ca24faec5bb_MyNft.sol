...
library Math {
    ...
    function mulDiv(
        ...
        unchecked {
            ...
            // less than 2^256, this is the final result. We don't need to compute the high bits of the result and prod1            // is no longer required.
    ...
    ERC721Pausable
{
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721PresetMinterPauserAutoId: must have pauser role to unpause");        _unpause();
    }
...
contract MyNft is ERC721PresetMinterPauserAutoId {
    constructor() ERC721PresetMinterPauserAutoId("KimSun", "SuNFT", "https://031418d9-a6e4-4348-accd-af31c5441e0d.mock.pstmn.io/nfttest/") {
