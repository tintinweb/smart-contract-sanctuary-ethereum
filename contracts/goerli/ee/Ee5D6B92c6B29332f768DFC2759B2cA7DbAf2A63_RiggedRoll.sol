...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 amount) external onlyOwner {
    ...
    function riggedRoll() public {
        require(address(this).balance >= 0.002 ether, "Contract Balnce Too Low");
