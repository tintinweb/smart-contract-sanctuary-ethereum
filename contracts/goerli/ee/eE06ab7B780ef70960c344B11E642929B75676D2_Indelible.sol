...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    ContractData public contractData = ContractData("OnChainBandits",unicode"On-chain game coming soon.","https://files.indelible.xyz/profile/682fb9ae-6703-46ad-8521-85defc92a8ec","https://files.indelible.xyz/banner/682fb9ae-6703-46ad-8521-85defc92a8ec","https://app.indelible.xyz/mint/onchainbandits",500,"0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A("OnChainBandits", "BANDIT") {
        tiers[0] = [4000,3000,2000,550,400,50];
        tiers[1] = [2500,2000,1700,1500,800,500,400,300,200,100];
        tiers[2] = [2500,2200,1800,1500,800,500,400,200,100];
        tiers[3] = [4000,3000,2000,1000];
        tiers[4] = [4000,3000,2000,550,400,50];
        tiers[5] = [5000,3000,1500,500];
        randomSeed = uint(
            keccak256(
                abi.encodePacked(
                    tx.gasprice,
