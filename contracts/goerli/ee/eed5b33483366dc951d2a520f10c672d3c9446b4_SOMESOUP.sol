...
/*                                                   
   _________  ____ ___  ___  _________  __  ______ 
  / ___/ __ \/ __ `__ \/ _ \/ ___/ __ \/ / / / __ \
 (__  ) /_/ / / / / / /  __(__  ) /_/ / /_/ / /_/ /
/____/\____/_/ /_/ /_/\___/____/\____/\__,_/ .___/ 
                                          /_/      

    Token Name: SomeSoup
    Symbol: SOSO
    Total Supply: 9 Trillion Tokens
...
contract SOMESOUP is Context, Ownable, IERC20, ERC20Detailed {
    ...
    uint256 public sellLiquidityFee = 900; // 9% on Sell
    uint256 public sellTotalFee = sellLiquidityFee;

    uint256 private buyMarketingFee = 0; 
    uint256 public buyLiquidityFee = 700; // 7% on Buy
    ...
    uint256 public numTokensSellToAddToLiquidity = 81000000000 * 10**18; //0.1%
    ...
    constructor () ERC20Detailed("SomeSoup", "SOSO", 18) {
    
    _totalSupply = 9000000000000 * (10**18); // 9 Trillion
    
	_balances[owner()] = _totalSupply;

	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //ETH_MAINNET
