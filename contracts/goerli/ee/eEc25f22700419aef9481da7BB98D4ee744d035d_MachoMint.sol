...
contract MachoMint is ERC721Transferable, Ownable {
    ...
    constructor() ERC721("MachoKats", "MK") {}
    ...
    function mint() public {
        ...
        require(
            _nextTokenId.current() <= maxSupply,
            "MachoMint: Max supply has been minted!"
        );
        ...
        override
    {
        require(
            ...
            "MachoMint: You do not have permission to set transferable status"
        );
        require(
            tokenId < _nextTokenId.current(),
            "MachoMint: Invalid MachoKat ID"
        );
        _isTransferable[tokenId] = canTransfer;
    }

    function setContractApproval(address contractAdd, bool approve)
        public
        override
        onlyOwner
    {
        require(
            !_isApprovedContract[contractAdd] == approve,
            "MachoMint: Provided contract does not need updated"
        );
        _isApprovedContract[contractAdd] = approve;
    }
...
/**
    @dev Extension of {ERC721} that allows tokens classified as 'transferable' or 'non-transferable'
 ...
 */
abstract contract ERC721Transferable is ERC721, IERC721Transferable {
