...
contract TwaliContract is Initializable, ReentrancyGuard {
    ...
    function initialize(
        ...
        workdetails[_adminClient][0] = WorkDetails(_adminClient, _sowMetaData, _contract_payment_amount, _contract_start_date, _contract_end_date, _contract_created_on, false, false, false);
        isInitialized = true;
