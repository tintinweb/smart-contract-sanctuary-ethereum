...
contract Erthling is DotEarthERC721, IErthling, ISoftStaking {
    ...
    modifier onlyMinterRole() {
        accessController.checkErthlingMinterRole(_msgSender());
        _;
    }

    function getAdminRole() public view override returns(bytes32) {
        return accessController.ERTHLING_ADMIN_ROLE();
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(lastStakingStarted_[tokenId] == 0, "Erthling: token is staking");
