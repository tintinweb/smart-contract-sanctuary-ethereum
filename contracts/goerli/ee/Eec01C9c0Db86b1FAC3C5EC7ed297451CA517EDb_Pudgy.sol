...
contract Pudgy is ERC721A, Ownable, ReentrancyGuard {
  ...
  ) ERC721A("Pudgy", "PUD") {  // change the name and symbol for your collection
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(_numberMinted(_msgSenderERC721A()) + tokens <= MaxperWalletFree + MaxperWallet, "max mint amount per tx exceeded");
