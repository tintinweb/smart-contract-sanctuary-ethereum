...
contract NFTCoin is ERC721, ERC721Enumerable, ERC721Royalty, Ownable {
    ...
    function bulkAirDrop(address[] calldata recipients) public onlyOwner {
        require(recipients.length > 0, "Recipients list must not be empty");
    ...
    function mint(uint256 quantity) public payable {
        require(_mintEnabled, "Mint is not enabled");
        require(quantity > 0, "Quantity must be greater than 0");
