...
import "@openzeppelin/contracts-upgradeable/interfaces/IERC2309Upgradeable.sol";

contract ERC7212309Upgradeable is
    Initializable,
    ContextUpgradeable,
    IERC2309Upgradeable,
    ERC721Upgradeable
{
    ...
    function __ERC7212309_init(string memory name_, string memory symbol_)
        internal
        onlyInitializing
    {
    ...
    function __ERC7212309_init_unchained(
        string memory name_,
        ...
        returns (uint96)
    {
        ...
        if (batchSize > 0) {
            ...
            if(batchSize == 1) {
                _mint(to, uint256(first));
                _sequentialOwnership.push(first, uint160(to));
            } else {
                // hook before
