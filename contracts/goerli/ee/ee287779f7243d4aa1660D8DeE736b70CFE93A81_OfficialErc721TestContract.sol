...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xCf20820EF55e343E7D196575829335C60A3F1A29];
  address public erc20Payable = 0xCf20820EF55e343E7D196575829335C60A3F1A29;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 315) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/akHVDyubPf3VliQXTq0M/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/fyonZPpTSpP6uIqQxn7D/contract-metadata";
  }
...
// File: contracts/OfficialErc721TestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OfficialErc721TestContract is ERC721APlus {
    constructor() ERC721APlus("Official ERC721 Test", "ERCYA"){}
}
