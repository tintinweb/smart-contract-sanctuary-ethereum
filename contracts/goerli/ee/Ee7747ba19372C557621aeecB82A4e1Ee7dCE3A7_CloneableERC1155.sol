...
contract CloneableERC1155 is ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable {
    ...
    event PolicyCreated(uint256 indexed tokenId, address indexed createdBy);
    ...
    function addPolicy() public onlyWhitelistAddress {
    ...
    function _unpackPolicies(uint256 tokenId) private view returns (string memory) {
        ...
        string[] memory _unpackedPolicies = _policies[tokenId];
