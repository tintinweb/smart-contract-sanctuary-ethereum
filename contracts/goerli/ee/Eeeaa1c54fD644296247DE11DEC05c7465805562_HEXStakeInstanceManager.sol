...
contract HEXStakeInstanceManager is ERC721, ERC721Enumerable, RoyaltiesV2Impl {
     ...
     */
    function _pruneHSI(address[] storage hsiList, uint256 hsiIndex) internal {
     ...
     */
    function hsiCount(address user) public view returns (uint256) {
    ...
    {
        require(
            amount <= _hx.balanceOf(msg.sender),
        ...
        require(
            _hx.transferFrom(msg.sender, hsiAddress, amount),
        ...
        returns (uint256)
    {
        ...
        if (hsiBalance > 0) {
            require(
                _hx.transferFrom(hsiAddress, msg.sender, hsiBalance),
    ...
    function hsiTransfer(
        ...
        require(
            hsiAddress == hsiListCurrent[hsiIndex],
            "HSIM: HSI index address mismatch"
        );
