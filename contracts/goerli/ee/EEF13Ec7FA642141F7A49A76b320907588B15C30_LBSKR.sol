...
contract LBSKR is LBSKRCore {
    ...
    function setInitialRatio(
        ...
        require(
            ...
            totalShares == 0 && this.balanceOf(address(this)) == 0,
            "Non-zero Stakes"
        );
        ...
        require(
            ...
            this.transferFrom(msg.sender, address(this), stakeAmount),
            "Transfer Failed"
        );
    ...
    function removeStake(uint256 stakeAmount) external whenNotPaused {
        ...
        uint256 currentRatio = (this.balanceOf(address(this))) / totalShares;
        ...
        require(
            ...
            this.transfer(msg.sender, stakeAmount + rewards),
            "Transfer Failed"
        );
    ...
    function getBSKRPerShare() external view returns (uint256) {
        ...
        return (this.balanceOf(address(this)) + inflation) / totalShares;
    }
    ...
    function rewardOf(address stakeholder) external view returns (uint256) {
        ...
        uint256 stakedRatio = (stakeholderStake) / stakeholderShares;
        // uint256 currentRatio = (bskrERC20.balanceOf(address(this))) /
        uint256 currentRatio = (this.balanceOf(address(this)) + inflation) /
            totalShares;
    ...
    function getCurrentRewards() external view returns (uint256) {
        ...
        uint256 inflation = calcInflation(block.timestamp);
        return this.balanceOf(address(this)) + inflation - totalStakes;
    }
