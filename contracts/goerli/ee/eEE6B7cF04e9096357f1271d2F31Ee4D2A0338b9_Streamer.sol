...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
        ...
        require(
            ...
            "You already have a running channel."
        );
        require(
            msg.value > 0,
            "You must provide a positive value to open a channel."
        );
    ...
    */
    ...
    function challengeChannel() public {
        require(balances[msg.sender] > 0, "channel not opened.");
