...
contract MeetusVRReward is AccessControl, ERC721Holder, ERC1155Holder, Rescueable {
    ...
    bytes32 public constant TOKEN_CLAIM_TYPEHASH =
        keccak256(
            "TokenClaim(address user,uint256 nonce,uint8 tokenStandard,uint256 tokenId,uint256 amount,uint8 claimMethod,uint256 signatureTimestamp,uint256 deadline)"
        );
