...
contract NFT is ERC721Enumerable, Ownable, RoyaltiesV2Impl{
  ...
  // public
  function mint(address payable _to, uint256 _mintAmount) public payable {
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function removeWhitelistUser(address _user) public onlyOwner {
    ...
    function setRoyalties(uint _tokenId, address payable _royaltiesRecipientAddress1, uint96 _percentageBasisPoints) public onlyOwner {
