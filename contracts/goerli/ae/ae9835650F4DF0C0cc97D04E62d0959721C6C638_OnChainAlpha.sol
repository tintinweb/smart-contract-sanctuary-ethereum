...
contract OnChainAlpha is ERC721A, ReentrancyGuard, Ownable {
    ...
    string[] private LAYER_NAMES = [unicode"Background", unicode"Body", unicode"Eyes", unicode"Ears", unicode"Mouth", unicode"Eyewear", unicode"Headwear", unicode"Outwear", unicode"Mouth Special"];
    ...
    uint public publicMintPrice = 0.00069 ether;
    ...
    constructor() ERC721A("On-Chain Alpha", "OCA") {
        TIERS[0] = [9999]; //background and 1/1's
        TIERS[1] = [200,500,700,900,900,1000,1600,2000,2200]; //body 9
        TIERS[2] = [100,200,300,500,600,650,700,750,800,1000,1100,1200,2100]; //13
        TIERS[3] = [500,1000,2000,2500,4000]; //5
        TIERS[4] = [1000,1500,2000,5499]; //4
        TIERS[5] = [100,200,300,500,600,650,700,750,800,1000,1100,3300]; //13
        TIERS[6] = [100,100,100,100,100,100,100,100,100,100,200,200,200,200,200,200,200,200,200,300,300,300,300,300,300,300,500,500,500,500,500,600,2000]; //33
        TIERS[7] = [3000,2000,1500,1500,900,800,300]; //5
        TIERS[8] = [100,200,300,500,600,1000,1500,2300,3500]; //4
    }
