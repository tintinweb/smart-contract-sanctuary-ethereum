...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xC2C527C0CACF457746Bd31B2a698Fe89de2b6d49);
...
contract Test is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7684bc19D508a502B7328C4827ecC1B15339073e;
        ecosystemfeeReceiver = 0x265506a91CAEd623c44F5db59f0Dd71d7456E53f;
    ...
    function shouldNotTakeFee(address sender) internal view returns (bool) {
        return (sender != pair);
    }
