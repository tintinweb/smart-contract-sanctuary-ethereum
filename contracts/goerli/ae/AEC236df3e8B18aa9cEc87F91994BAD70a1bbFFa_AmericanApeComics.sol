    ...
    ReentrancyGuard
{
    ...
    function mintComic(uint256 _qty) external payable nonReentrant {
        ...
        require(
            _qty <= comics[comicMintId].maxPerTxnPublic,
    ...
    function burnMint(uint256 _burnTokenId) external nonReentrant {
        ...
        require(
            _nextTokenId() + 1 <= comics[comicMintId].endTokenId + 1,
            "Not enough tokens left to mint that many"
        );
        ...
        require(
            _burnTokenId >= comics[comicMintId].startBurnableTokenId &&
                _burnTokenId <= comics[comicMintId].endBurnableTokenId,
        ...
        nonReentrant
    {
        ...
        require(mintIsActiveBurn, "Mint is not active");
        require(
            _nextTokenId() + _burnTokenIds.length <=
                comics[comicMintId].endTokenId + 1,
            "Not enough tokens left to mint that many"
        );
    ...
    function mintPresaleMerkle(
        ...
        require(
            comics[comicMintId].tokenPricePresale * _qty <= msg.value,
            "You sent the incorrect amount of ETH"
        );
        require(
