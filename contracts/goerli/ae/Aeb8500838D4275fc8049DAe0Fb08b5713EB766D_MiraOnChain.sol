            ...
            base64String = Base64.encode(bytes(
                abi.encodePacked(
                    '<svg width="500" height="500" xmlns="http://www.w3.org/2000/svg">',
                        ...
                        '<rect fill="hsl(',currentBlock.bar1Hue,', 80%, 50%)" x="200" y="300" width="70" height="',bar1,'"/>',
                        '<rect fill="hsl(',currentBlock.bar2Hue,', 70%, 60%)" x="175" y="215.25" width="70" height="',bar2,'"/>',
                        '<rect fill="hsl(',currentBlock.bar3Hue,', 75%, 75%)" x="150" y="130" width="70" height="',bar3,'"/>',
                    '</svg>'
                )
            ));
        }
