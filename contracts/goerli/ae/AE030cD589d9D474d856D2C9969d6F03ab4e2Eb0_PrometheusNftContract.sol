...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xa64de978376Eb36a0CfFB7e4c859FFCF72937039];
  address public erc20Payable = 0xa64de978376Eb36a0CfFB7e4c859FFCF72937039;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 3333) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicyw2kz2ewoaxjgflmtvuvvj2aovcf3a7ubowhqzysc4umj4mdlx4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PDe7Vrt1PjFBIDuqH2Hx/contract-metadata";
  }
...
// File: contracts/PrometheusNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PrometheusNftContract is RamppERC721A {
    constructor() RamppERC721A("Prometheus NFT", "PRMS"){}
}
