...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x46e738E243B57565F76921663D08e2aA0B1de707];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x46e738E243B57565F76921663D08e2aA0B1de707;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmbfZtwUvHuAQwhTPz5k35yCbHSrVoDn5wrs7pauJtNS9S/";
...
// File: contracts/BlockwowmaxContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BlockwowmaxContract is RamppERC721A {
    constructor() RamppERC721A("BLOCKWOWMAX", "BLOCKWOW"){}
}
