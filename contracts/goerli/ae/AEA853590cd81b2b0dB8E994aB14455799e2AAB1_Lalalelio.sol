 ...
 * @notice This contract handles minting lalalelio tokens.
 */
contract Lalalelio is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xee289AC532c2eCF8c4fB8E2F502649b32D30de69;
    ...
    string public name = "lalalelio";
    string public symbol = "LLL";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeighcpk4x4a5l3nsr63afrkeg2mz5ryx4coc4luyj6wpimwtrrdtxi/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1000] = 100;
        tokenPublicPrice[1000] = 0.01 ether;
        tokenPublicMintsPerAddress[1000] = 100;
        require(
