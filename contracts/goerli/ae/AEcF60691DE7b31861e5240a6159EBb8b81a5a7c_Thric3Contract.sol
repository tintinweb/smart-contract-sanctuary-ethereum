...
//*********************************************************************//
//
// Full rights and privileges for thric3 Digital Assets are detailed in the thric3 Terms of Service at https://www.thric3.io.  In general and subject to the Terms of Service referenced above, the owner of this thric3 Digital Asset has full general and commercial use rights to the Digital Asset as long as the Digital Asset is not used for any illegal or unauthorized purpose, nor may the owner violate any laws in the owner's jurisdiction including, but not limited to, copyright laws.  Further, a 6% royalty fee paid to thric3 LLC applies on the re-sale of all Digital Assets. As such, if you sell a thric3 Digital Asset on a third-party NFT marketplace, you agree to include a statement substantially similar to the following in the description of the Digital Asset: 6% Royalty Applies. See thric3 Terms of Service for details.
//
//*********************************************************************//
//*********************************************************************//
...
// @author Mintplex.xyz (Rampp Labs Inc) (Twitter: @MintplexNFT)
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x831A082f577068530bE4e01F373A50d062CC9C71];
  address public erc20Payable = 0x831A082f577068530bE4e01F373A50d062CC9C71;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3000, type(uint256).max) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigsmbbbje6v27rinrj3o6zfyz25bn4xadalfrkk5doityrrvrprau/";
...
// File: contracts/Thric3Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Thric3Contract is RamppERC721A {
    constructor() RamppERC721A("thric3 ", "EDP"){}
}