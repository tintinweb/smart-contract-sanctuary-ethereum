...
contract Echo is IBridgeReceiver {
    IBridge public bridge;
    address echo_pallet_address = 0x00000000000000000000000070696E67706F6e67;
    uint64 public session_id = 1;

    constructor(IBridge _bridge) {
        bridge = _bridge;
    }

    function pingSeed() external {
        bytes memory message = abi.encode(1, session_id++, address(this));
        bridge.sendMessage(echo_pallet_address, message);
    }
