...
contract DeKingsNft is ERC721AQueryable, AccessControlEnumerable, DefaultOperatorFilterer{
    ...
    function mintWhitelist(uint256 amount, bytes32[] calldata _merkleProof) public payable {
        ...
        require((_nextTokenId() + amount) <= (whitelistSupply + 1), "mintWhitelist: max whitelist supply reached");
    ...
    function setWhitelistSupply(uint256 _whitelistSupply) public{
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "setWhitelistSupply: Action is not allowed");
