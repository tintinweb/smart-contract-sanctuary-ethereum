    ...
    Signature
{
    ...
    /** MINTING **/
    function mint(uint64 count, bytes calldata signature) external payable requiresSignature(signature) {
    ...
    /** SIGNATURE **/
    function checkSignature(bytes calldata signature)
        public
        view
...
contract Signature is Ownable {
    ...
    bytes32 private immutable NAME = keccak256("Goblin Sinz");
