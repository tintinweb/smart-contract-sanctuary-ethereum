 ...
 * @notice This contract handles minting test 1155 burn tokens.
 */
contract Test1155Burn is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x13659deaaa2393D7dF6b60B419C5ac4D86129A87;
    ...
    string public name = "test 1155 burn";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeib7af7lrcyblgk4vrki3h5tnprnbfpeloopoz35lfz6lsprlkb7jq/{id}"
        )
        RevokableOperatorFilterer(
    ...
    function burnToMint(
        ...
        require(
            msg.value == heymintFeePerToken * _tokensToMint,
            "PAYMENT_INCORRECT"
        );
