...
contract SBNFTX is ERC721, Ownable, ReentrancyGuard {
    ...
    function mintToAddress(address _to, uint256 _mintAmount) external onlyOwner {
        ...
        require(_tokenSupply.current() + _mintAmount <= maxSupply, "Error: Can't mint more than the max supply.");
    ...
    function setMaxSupply(uint256 _newSupply) external onlyOwner {
        require(maxSupply < _newSupply, "Error: You can only increase the supply.");
