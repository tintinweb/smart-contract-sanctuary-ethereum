...
contract Token is Ownable, ERC721AQueryable, ReentrancyGuard, PaymentSplitter {
    ...
    ERC721AQueryable public constant BrainPodToken = ERC721AQueryable(0x3E4157Ff1B8beE9E173509fb0911DCc39B606502);
    ...
    function test(address owner) public view virtual returns (uint256) {
        uint256[] memory tokenIds = BrainPodToken.tokensOfOwner(owner);
