...
contract Square is 
    ...
    function setRevealed(uint256 _tokenId, uint256 _xPos, uint256 _yPos)
        external 
        override 
        // onlyMinter //TODO cleanup 
        returns(bool)
    {
        squareMetadata.setRevealedPosition(_tokenId, _xPos, _yPos);
    }
}
...
abstract contract SquareMintable is Initializable, SquareContracts {
        ...
        contractsAreSet
    {
        ...
        // require(
        //     _amount == _xPos.length 
        //     && _amount == _yPos.length,
        //     "SquareMintable: Amount and positions not correct"
        // );
        for (uint256 i = 0; i < _amount; i++) {
            // uint256 posX = _xPos[i];
            // uint256 posY = _yPos[i];
            _mint(_to);
        }
    }
		...
		private
	{
        ...
        // squareMetadata.setInitialPosition(_tokenId, _x, _y);
	...
	AdminableUpgradeable
{
	...
	function __SquareState_init() internal initializer {
		...
		ERC721Upgradeable.__ERC721_init("Fuego Squares", "FUEGO_SQUARE");
