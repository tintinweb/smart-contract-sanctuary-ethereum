...
contract Bridge is Pausable, BridgeAccessControl, IExecuteRollup {
    ...
    /// - {msg.sender} must be registered token address.
    ///
    ...
    function executeRollup(
        ...
        address tokenAddress = RollupHandler(rollupHandlerAddress)
            ._resourceIDToTokenContractAddress(resourceID);
        require(tokenAddress == msg.sender, "invalid token address");
