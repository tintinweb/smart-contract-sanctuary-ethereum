...
// File: contracts/ERC721FancyMint.sol
...
contract rTest is ERC721FancyMint, Ownable {
    using Strings for uint256;
    ...
    string private head = '<svg width="240" height="80" viewBox="0 0 240 80" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="40" style="fill:rgb(0,0,255);stroke-width:3;stroke:rgb(0,0,0)" /><text x="20" y="70" >';
    string private tail = "</text></svg>";

    constructor()
        ERC721FancyMint("Fancy first try", "fft", maxSupply_, preOwner_)
    {}
