...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1669298400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1669276800;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 12) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmW2uiQTuNkGaFE3XKixzLU3bYhAMwooRrCorVmyY4aGs6/";
...
contract HumbleHoldersContract is RamppERC721A {
    constructor() RamppERC721A("Humble Holders", "GTHH"){}
}
