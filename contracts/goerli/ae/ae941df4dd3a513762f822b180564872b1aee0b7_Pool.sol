...
contract Pool is IPool, ERC20Permit {
    ...
    int128 public override ts; // 1 / Seconds in 10 years, in 64.64
    int128 public override g1; // To be used when selling base to the pool
    int128 public override g2; // To be used when selling fyToken to the pool
        ...
        )
    {
        ...
        uint256 maturity_ = fyToken.maturity();
        require(
    ...
    function setG1(int128 g) external {
        g1 = g;
    }

    function setG2(int128 g) external {
        g2 = g;
    }

    function setTs(int128 t) external {
        ts = t;
    }
