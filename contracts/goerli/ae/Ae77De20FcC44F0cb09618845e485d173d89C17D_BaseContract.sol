...
contract BaseContract is ERC721A, Seller, ReentrancyGuard {
    ...
    constructor(
        ...
        // allowlist sale 
        setAllowlistSale(1666252112, 1697788112, 20000000000, 5, 0xe12e7B6DDA6bC392b8441240459f7960E016D7Cb, false);
        // waitlist sale 
        setWaitlistSale(1666252112, 1697788112, 20000000000, 5, 0xe12e7B6DDA6bC392b8441240459f7960E016D7Cb, false);
        // public sale
        setPublicSale(1666252112, 1697788112, 20000000000, 5);
    }
...
contract Seller is Ownable {
    ...
    SaleConfig private allowlistConfig = SaleConfig(0, 0, 0, 0, address(0), false, false, false);
    SaleConfig private waitlistConfig = SaleConfig(0, 0, 0, 0, address(0), false, false, false);
    SaleConfig private publicConfig = SaleConfig(0, 0, 0, 0, address(0), false, false, false);
    ...
    function setAllowlistSale(uint256 startDate, uint256 duration, uint256 price, uint256 quantityLimit, address signer, bool checkUsedKeys) public onlyOwner {
        allowlistConfig = SaleConfig(startDate, duration, price, quantityLimit, signer, false, checkUsedKeys, true);
    }
    ...
    function setWaitlistSale(uint256 startDate, uint256 duration, uint256 price, uint256 quantityLimit, address signer, bool checkUsedKeys) public onlyOwner {
       waitlistConfig = SaleConfig(startDate, duration, price, quantityLimit, signer, false, checkUsedKeys, true);
    }
    ...
    function setPublicSale(uint256 startDate, uint256 duration, uint256 price, uint256 quantityLimit) public onlyOwner {
        publicConfig = SaleConfig(startDate, duration, price, quantityLimit, address(0), true, false, true);
    }
