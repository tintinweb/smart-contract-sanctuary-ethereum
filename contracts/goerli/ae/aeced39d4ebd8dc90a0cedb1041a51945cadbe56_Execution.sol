...
contract Execution is Ownable {
  ...
  //Goerli
  address private constant ETH_TOKEN = 0x0000000000000000000000000000000000001010;
  ...
  function _notETHToken(address token) internal pure {
    require(token != ETH_TOKEN, 'Not support matic token');
  }
