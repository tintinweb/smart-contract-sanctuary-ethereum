    ...
    IService
{
    ...
    uint24 public protocolTokenFee;
    ...
    event ProtocolTokenFeeChanged(uint24 protocolTokenFee);
    ...
    function createPool(
        ...
        tge.initialize(msg.sender, address(token), tgeInfo, address(this));
    ...
    */
    function setProtocolTokenFee(uint24 _protocolTokenFee) public onlyOwner {
