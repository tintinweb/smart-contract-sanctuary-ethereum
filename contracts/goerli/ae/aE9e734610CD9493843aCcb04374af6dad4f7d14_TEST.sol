...
contract TEST is ERC721Enumerable, Ownable {
    ...
    address public constant MIA_CONTRACT_ADDRESS =
        0xE482b3E53eEcE86349aD0A21daD565d53b6De0f4;
    ...
    constructor(string memory _initBaseURI) ERC721("MiaStep", "MSTP") {
    ...
    function mint(address to) public payable {
        ...
        require(supply + 1 <= maxSupply, "Cannot exceed maxSupply");
        ...
        return
            bytes(currentBaseURI).length > 0
                ? string(
                    abi.encodePacked(
                        currentBaseURI,
                        getLevel(ownerOf(tokenId)).toString(),
                        baseExtension
                    )
                )
                : "";
    ...
    function setApprovalForAll(address operator, bool approved)
        ...
        override
    {
        require(false, "SetApprovalForAll is prohibited");
        super.setApprovalForAll(operator, approved);
    }

    function approve(address to, uint256 tokenId) public override {
        require(false, "Approve is prohibited");
