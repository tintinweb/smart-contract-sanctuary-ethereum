...
// Dependency file: contracts/TokenControllerV3.sol
...
// Root file: contracts/mocks/TokenControllerMock.sol
...
// import {TokenControllerV3} from "contracts/TokenControllerV3.sol";
...
contract TokenControllerPauseMock is TokenControllerMock {
    ...
    function pauseToken() external override onlyOwner {
        IOwnedUpgradeabilityProxy(uint160(address(token))).upgradeTo(pausedImplementation);
    }
}