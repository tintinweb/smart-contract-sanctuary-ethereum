...
import "./PawradiseERC1155.sol";

contract MockPawradiseERC1155 is PawradiseERC1155 {
    constructor() PawradiseERC1155() {}

    uint256 mockTime = 1669208400;

    function setCurrentTime(uint256 _time) public onlyOwner {
        mockTime = _time;
    }
...
contract PawradiseERC1155 is Ownable, ERC1155URIStorage {
    ...
    constructor() ERC1155("https://pawradise.xyz/") {
    ...
    function mint(uint256 id) public {
        ...
        if (minters[msg.sender]) {
            require(
                ...
                "You have reached your max mint (2 NFT)"
            );
            ...
            require(
                ...
                "You have reached your max mint (1 NFT)"
            );
            _mint(msg.sender, id, 1, "");
            mintSupply[msg.sender] += 1;
            supply[id] = supply[id] + 1;
