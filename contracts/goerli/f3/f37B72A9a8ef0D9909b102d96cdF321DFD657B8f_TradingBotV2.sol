...
contract TradingBotV2 is ReentrancyGuard, ChainlinkClient {
    ...
    string lastError; // for testing pourposes
    ...
    function swapTokensForTokens(
        ...
        if (stakingBalance[sender] >= amountIn) {
            ...
            lastError = 'The Userr does not have staked enough WETH';
            return 0;
        }
    ...
    function requestPriceAndSwapToken(uint256 botId) public {
        ...
        bytes32 requestId = sendChainlinkRequest(req, i_getPriceFee);
