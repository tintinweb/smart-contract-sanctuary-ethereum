...
contract ERC721Factory {
    ...
    function createNewNftContract(string memory _name, string memory _symbol) public returns(ERC721) {
        ERC721 newNftContract = new ERC721(_name, _symbol);
        emit NftContractCreated(_name, _symbol, address(newNftContract), msg.sender);
