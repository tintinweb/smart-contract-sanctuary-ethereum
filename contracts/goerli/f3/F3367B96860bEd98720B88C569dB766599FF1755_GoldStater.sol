...
contract GoldStater is ERC20CappedUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    modifier notFrozen(address _address) {
        require(!_frozen[_address], "Address frozen");
        _;
    }
