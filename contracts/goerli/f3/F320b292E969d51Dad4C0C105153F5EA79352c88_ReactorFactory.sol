...
contract ReactorFactory {
    ...
    address comiteFiducia = 0x6666Ec43dEb25910121Dd544E89301a86165Fa6b;
    address public admin = 0x583d2A624acFC4a01ad93cdDE2a759ad344992A6;

    mapping(address => bool) public allowlistsAddresses;

    modifier onlyAdmin() {
        require(msg.sender == admin, "caller is not the manager");
        _;
    }   
...
contract Reactor is ERC1155, Pausable {
    ...
    address public usdt = 0x3Dd723167fDd49d8Ece168Acc689154ac5538237;
    ...
    constructor (
        ...
        contractUri = "ipfs//"; // json contract metadata file for OpenSea
    ...
    function setFiducia(address _addressFiducia) external onlyAdmin {
        require(_addressFiducia != address(0), "Cannot set address 0");
    ...
    function setAllowlistsActive(bool _wlEnd) external onlyOwner {
        AL_TIMER = block.timestamp + 1 days;
        ...
        nonReentrant
    {
        ...
        IERC20(usdt).transferFrom(msg.sender, comiteFiducia, _amount * tokenPrices);    
