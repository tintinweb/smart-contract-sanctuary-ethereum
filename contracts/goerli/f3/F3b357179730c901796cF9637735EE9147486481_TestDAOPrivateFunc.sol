...
contract TestDAOPrivateFunc is GovernorPreventLateQuorum, GovernorCountingSimple, GovernorSettings, GovernorVotesQuorumFraction, GovernorTimelockControl {
  ...
  function _addNumberPublic(uint _number) public {savedNumbers.push(_number);}
  function _addNumberPrivate(uint _number) private {savedNumbers.push(_number);}
}
