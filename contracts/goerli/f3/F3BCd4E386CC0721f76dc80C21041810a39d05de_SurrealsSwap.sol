...
contract SurrealsSwap is Ownable, IERC721Receiver {
     ...
     */
    function createPool(uint256[] calldata _initialNFTIDs) external onlyOwner {
        LSSVMPairFactory(payable(pairFactory)).createPairETH{value: 0}(
            IERC721(nftContract), //nft collection
