...
contract BallsOfArt is ERC721, Ownable {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '" fill="',
                    ball.fill,
                    '" rx="150" /> <path class="bg" fill="none" stroke="#ffffff" stroke-width="20" stroke-linecap="round" d="M ',
    ...
    function generateFinalSvg(
        ...
        bytes memory backgroundCode = abi.encodePacked(
            '<circle cx="500" cy="500" r="280" fill="',          backgroundColors(randomSeed1 % 7), '"/>', 
            '<circle cx="500" cy="187.5" r="170" fill="',          backgroundColors(randomSeed1 % 7), '"/>', 
            '<circle cx="500" cy="187.5" r="170" fill="',          backgroundColors(randomSeed1 % 7), '"/>'
        );
        ...
        string memory finalSvg = string(
            abi.encodePacked(
                ...
                '<defs>' '<style>' '.bg{fill:none} .bg:hover{fill:aquamarine}' 'div { width: 100px;height: 100px;background: red;position: relative;animation-name: example;animation-duration: 3s;  animation-fill-mode: forwards;}' '@keyframes example {from {top: 0px;}to {top: 200px; background-color: blue;}}' '</style>' '</defs>',
                backgroundCode,
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name": "Balls of Art #',
                                uint2str(tokenId),
                                '", "description": "Balls of Art are an assortment of 111 fully on-chain, randomly generated, happy art balls", "attributes": "", "animation_url":"data:animation_url/svg+xml;base64,',
