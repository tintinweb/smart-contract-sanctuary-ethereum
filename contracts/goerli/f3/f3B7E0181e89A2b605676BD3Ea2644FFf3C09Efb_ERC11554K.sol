    ...
    RevokableDefaultOperatorFiltererUpgradeable
{
    ...
    /**
     * @notice Overrided setApprovalForAll method for RevokableDefaultOperatorFilterer.
     * @param operator, operator address to be set approval status.
     * @param approved, approval status to set for an operator.
     */
    ...
    /**
     * @notice Overrided safeTransferFrom method for RevokableDefaultOperatorFilterer.
     * @param from, from address
     * @param to, destination address
     * @param tokenId, which token id to transfer
     * @param amount, amount of token with tokenId to transfer
    ...
    /**
     * @notice Overrided safeBatchTransferFrom method for RevokableDefaultOperatorFilterer.
     * @param from, from address
     * @param to, destination address
     * @param ids, which token ids to transfer
     * @param amounts, amounts of token with ids to transfer
     * @param data, transfer bytes data.
     */
    ...
    /**
     * @notice Overrided owner method for RevokableDefaultOperatorFilterer.
     */
    function owner()
        public
        view
    ...
    /**
     * @dev Internal wrapper method for ERC2981 _setDefaultRoyalty used by setGlobalRoyalty.
     */
 ...
 */
interface IERC11554K is IERC1155Upgradeable {
    function controllerMint(
        address mintAddress,
        uint256 tokenId,
        uint256 amount
