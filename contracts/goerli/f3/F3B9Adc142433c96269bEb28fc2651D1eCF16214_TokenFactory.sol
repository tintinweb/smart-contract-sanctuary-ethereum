...
import "./CirculatingSupplyERC20.sol";
...
contract TokenFactory  {
    ...
    ) external returns (MockToken, CirculatingSupplyERC20) {
        MockToken daoToken = new MockToken(name, symbol);
        CirculatingSupplyERC20 supplyToken = new CirculatingSupplyERC20(msg.sender, address(daoToken), exclusions);
        emit TokenCreated(address(daoToken), address(supplyToken), msg.sender, exclusions);
        return (daoToken, supplyToken);
    }
}
