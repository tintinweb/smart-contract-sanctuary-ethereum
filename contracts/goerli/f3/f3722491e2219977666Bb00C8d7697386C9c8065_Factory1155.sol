/** @notice The Factory contracts have the responceblity for deploying 1155 own contracts which can be used for  Minting NFTs , transferring , burning NFTs from the wallets
