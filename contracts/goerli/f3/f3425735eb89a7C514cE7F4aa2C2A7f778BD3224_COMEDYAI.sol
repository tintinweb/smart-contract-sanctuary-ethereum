...
contract COMEDYAI is ERC20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() ERC20("COMEDY AI", "CAI") { // 
        marketingWallet = payable(0x7E976EBAb4d0F0D28cC74c65D19f49EfBBDEcDb2); // 
        devWallet = payable(0x7E976EBAb4d0F0D28cC74c65D19f49EfBBDEcDb2); // 
