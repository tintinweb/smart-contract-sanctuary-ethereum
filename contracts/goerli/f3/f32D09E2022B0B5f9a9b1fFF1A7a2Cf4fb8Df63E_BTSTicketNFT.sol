...
contract BTSTicketNFT is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("BTSTicketNFT", "BTS") {
        _setBaseURI("ipfs://");
    }
    ...
    function mintCollectionNFT(address collector, string memory metadataURI) public onlyOwner returns (uint256) {
