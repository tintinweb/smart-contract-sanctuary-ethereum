...
contract Escrow is ERC1155Holder{
    ...
    function PlaceOrder(address token_address,address seller,uint256 token_Id,uint256 num_coppies,uint256 pricePerNFT,SaleType saletypes,address paymentToken) public{
    ...
    function placeBid(uint256 order_number,uint256 bid_value) public payable{
      Order storage orders = ordersdetail[order_number];
