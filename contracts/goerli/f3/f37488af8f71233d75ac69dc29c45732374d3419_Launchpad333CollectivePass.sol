...
// File: contracts/333CollectivePass.sol
...
pragma solidity ^0.8.15;
     ...
     * @notice This contract handles minting 333 Collective Pass tokens.
     */
    contract Launchpad333CollectivePass is ERC721A,ERC721AQueryable,ERC4907A,Ownable,Pausable,ERC2981 {
    ...
    constructor() ERC721A("333 Collective Pass", "3COL") {
...
function _directApproveMsgSenderFor(uint256 tokenId) internal {
  ...
  */
  ...
  function burnERC1155ToMint(uint256 amount) public {
      ...
      require(ExternalERC1155BurnContract.balanceOf(msg.sender, 333) >= amount, "NOT_ENOUGH_TOKENS_OWNED");
      ExternalERC1155BurnContract.safeTransferFrom(msg.sender, burnAddress, 333, amount, '');
