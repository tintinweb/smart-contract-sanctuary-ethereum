...
contract SaintRobotica is ERC721, EIP712, Ownable, OperatorFilterer {
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(
            _tokenIdCounter.current() + quantity <= maxSupply - reservedCount,
        ...
        require(
            ...
            "The quantity exceeds the remaining amount of mint limit per wallet for public sale."
        );
        require(msg.value >= price * quantity, "Not enough ethers.");
    ...
    function presaleMint(
        ...
        require(
            ...
            "The quantity exceeds the remaining amount of mint limit per wallet for presale."
        );
        require(msg.value >= quantity * price, "Not enough ethers.");
