...
contract RewardVaultFactory is IRewardVaultFactory, OwnableUpgradeable {
    ...
    event RewardVaultLaunched(
        ...
        uint8 projectTokenDecimal,
        uint8 rewardTokenDecimal
    );
    ...
    function launchVault(
        ...
        emit RewardVaultLaunched(
            ...
            minInvestAmt_,
            maxInvestAmt_,
            uint8(IERC20Upgradeable(projectToken_).universalDecimals()),
            uint8(IERC20Upgradeable(rewardToken_).universalDecimals())
        );
    }
