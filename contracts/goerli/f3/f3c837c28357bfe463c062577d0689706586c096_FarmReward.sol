...
contract FarmReward is IFarmReward, Initializable, Pausable, Ownable {
    ...
    function _calcStakingRewardAmount(address userAddr, uint256 stakingIndex, Model.StakingRecord memory stakingRecord) private view returns(uint256) {
        ...
        Model.Checkpoint[] storage checkpoints = checkpointMap[userAddr][stakingIndex];
    ...
    function getClaimedAmount(address userAddr, uint256 tokenId) public view returns(uint256) {
