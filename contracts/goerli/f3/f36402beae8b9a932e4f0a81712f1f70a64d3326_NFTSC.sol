...
contract NFTSC is ERC721, ERC721Enumerable, Ownable, Pausable, ERC721Burnable {
    ...
    uint256 public maxMintAmount = 1; // max mint amout per transaction
    uint256 public nftPerAddressLimit = 1;
    bool public revealed = true;
    bool public onlyWhitelisted = true;
    address[] public whitelistedAddresses = [0x5baA0f14D09864929c5fC8AbDfDc466dcb72be9d, 0xD109fc566401ca57445810b9A3C187876cf44544, 0x64DC48F2Ae171f7Ae966f15844eF2f8751665110];
    ...
    function _beforeConsecutiveTokenTransfer(
       ...
       super._beforeConsecutiveTokenTransfer(from, to, 1, size);
    }
