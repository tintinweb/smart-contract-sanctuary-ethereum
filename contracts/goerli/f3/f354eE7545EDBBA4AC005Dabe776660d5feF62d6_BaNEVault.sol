...
contract BaNEVault is Ownable {
    ...
    */
    function removeNodeOperator(address addressToRemove) external payable {
    ...
    */
    function approveWallet(address addressToApprove)
        external
        payable
        onlyOwner
    {
    ...
    */
    function resetApproval(address addressToReset) external payable {
    ...
    */
    function changeOwnership(address newOwner) external payable onlyOwner {
    ...
    */
    function deleteOwnership() external payable onlyOwner {
        renounceOwnership();
    }
}
