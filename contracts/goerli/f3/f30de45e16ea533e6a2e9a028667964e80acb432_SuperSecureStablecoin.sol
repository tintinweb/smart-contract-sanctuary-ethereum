...
// File @openzeppelin/contracts-upgradeable/crosschain/[email protected]
...
// File contracts/SuperSecureStablecoin.sol
...
contract SuperSecureStablecoin is
    Initializable,
    ERC20Upgradeable,
    ...
    AccessControlCrossChainUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC20_init("SuperSecureStablecoin", "SSS");
        __ERC20Burnable_init();
        __Pausable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();
        __AccessControl_init();
        _grantRole(_crossChainRoleAlias(DEFAULT_ADMIN_ROLE), 0x8a3b26d230976bF24E9915e2C99CAF7BeCDe2855);
    }
