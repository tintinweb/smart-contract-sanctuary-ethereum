...
contract MarketMaker is OwnableExt, ExchangeDomain {
    ...
    function exchange(
        ...
        if (buyer == address(0x0)) {
            ...
            require(admins[msg.sender], "Invalid buyer");
        }
...
contract TransferProxy is OwnableExt {
    ...
    /// @dev Can be called only by admin.
    /// @param token Token ERC1155
    /// @param from Account address from where to transfer
    /// @param to Account address where to transfer
    /// @param id Token Id ERC1155
    /// @param value The number tokens
    /// @param data Data ERC1155
