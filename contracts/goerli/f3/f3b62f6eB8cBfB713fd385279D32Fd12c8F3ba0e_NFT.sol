...
contract NFT is ERC721URIStorage, ERC721Enumerable, Permissions {
    ...
    function mint(uint _tokenId, string memory _tokenURI, address _owner) external onlyAuthorisedPersonnel {
        tokenCount ++;
...
contract Permissions {
   ...
   modifier onlyAuthorisedPersonnel {
      require(isAuthorised[msg.sender], "User is not authorised!");
      _;
   }

   function authoriseUser(address _user) external onlyOwner {
      isAuthorised[_user] = true;
   }
