...
contract Bond is BondBase {
    ...
    function initialize(address _gac, address _bondToken) external initializer {
        __BondBase__init(_gac, _bondToken);
    }
...
abstract contract BondBase is ModuleAccessControllerUpgradeable, IBond {
    ...
    function __BondBase__init(address _gac, address _bondToken)
        internal
        onlyInitializing
    {
    ...
    function depositWithPermit(
        ...
        IERC20Permit(BOND_TOKEN_ADDRESS()).permit(
            msg.sender,
            address(this),
            amount,
            deadline,
