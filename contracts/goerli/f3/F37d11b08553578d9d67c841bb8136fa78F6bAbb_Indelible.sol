// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Shadow", unicode"Item", unicode"Top", unicode"Eyes", unicode"Face", unicode"Neck", unicode"Head", unicode"Body", unicode"Attunement"];
            bool private shouldWrapSVG = true;
            string private backgroundColor = "transparent";
            
        WithdrawRecipient[] public withdrawRecipients;
        bool public isContractSealed;
        uint public constant maxSupply = 2524;
        ...
        uint public allowListPrice = 0.008 ether;
        uint public maxPerAllowList = 1;
        bool public isAllowListActive;
        
        ContractData public contractData = ContractData(unicode"Council of Mages", unicode"The Council of Mages have assembled to unlock the secrets hidden in the Scroll of Mages. Follow along on twitter: @councilofmages.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/4a88e3b0-e020-49fb-9e21-7b9cc0bddcfa", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/4a88e3b0-e020-49fb-9e21-7b9cc0bddcfa", "councilofmages.xyz", 800, "0x8931d16B81EAC47FF04cE23036AE524c6a2A1A17");

        constructor() ERC721A(unicode"Council of Mages", unicode"MAGES") {
            TIERS[0] = [2524];
TIERS[1] = [128,164,164,196,936,936];
TIERS[2] = [0,16,16,64,64,64,64,120,120,120,120,120,120,120,120,120,120,120,120,120,120,120,120,120,196];
TIERS[3] = [500,500,500,500,524];
TIERS[4] = [504,504,504,504,508];
TIERS[5] = [64,412,524,524,1000];
TIERS[6] = [92,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128,128];
TIERS[7] = [32,32,32,32,32,64,100,116,116,116,116,116,116,116,116,116,116,116,116,116,116,116,460];
TIERS[8] = [0,0,0,631,631,631,631];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Council of Mages #");
