...
contract TestMeta is ERC721A, Ownable, Pausable {
    ...
    **/
    function whitelistMint(uint _quantity, bytes32[] calldata _proof) external payable callerIsUser whenNotPaused{
        require(wlSalePrice != 0, "Price is 0");
    ...
    **/
    function publicMint(uint _quantity) external payable callerIsUser whenNotPaused{
        require(publicSalePrice != 0, "Price is 0");
    ...
    **/
    function burn(uint _tokenId) external {
        require(sellingStep > Step.PublicSale, "Burn is after the public sale");
    ...
    */
    ...
    /**
    * @notice Release eth on contract
    */
