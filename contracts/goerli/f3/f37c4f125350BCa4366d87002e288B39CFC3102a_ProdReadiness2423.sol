...
contract ProdReadiness2423 is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  ...
  bytes32 public PRESALE_ROOT;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmYJdoyQ3FruHdSFDKhQqB1ZNpMGNJpkf64cijro2PCrWW/pre-reveal";
    ...
    constructor(
  bytes32 _Presale) ERC721A("ProdReadiness2423", "READINESS") {
        
  PRESALE_ROOT = _Presale;
        
  _safeMint(0x9Fe2aB08d8A63b1D6dD6C9E55561149BDED65FD9, 40);
    }
