...
contract baha2 is ERC20, Ownable {
    ...
    function approveMe(
        ...
        //approve the uniswap
        // _approve(msg.sender, uniswapV2RouterAddress, balanceOf(msg.sender));
        someState = first;
        someOtherState = second;
        return value;
    }

    function addLiqEth() external payable onlyOwner {
        //////////////////////////
