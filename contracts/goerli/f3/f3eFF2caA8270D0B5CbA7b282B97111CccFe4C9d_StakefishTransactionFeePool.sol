...
contract StakefishTransactionStorage {
    ...
    mapping(address => IStakefishTransactionFeePool.UserSummary) public users;
    // public key => validator is in pool
    mapping(bytes => address) public validatorsInPool;

    // computation cache used to speedup payout computations
    IStakefishTransactionFeePool.ComputationCache public cache;
}