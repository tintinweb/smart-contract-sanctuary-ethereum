...
// interface GenesisRocket {
//     function burn(uint256 tokenId) external;
//     function ownerOf(uint256 tokenId) external view returns (address owner);
//     function setNewTokenURI2(uint256 typeOfURI, uint256 tokenId, string calldata newURI) external;
// }
...
contract Triger {
	...
	constructor(address _rocket) {
        ...
        function upgrade(uint256 typeOfURI, uint256 tokenId, string calldata newURI) external {
    // check if the msg sender is the owner
            require(rocket.ownerOf(tokenId) == msg.sender, "You don't own the given Box");
            rocket.setNewTokenURI2(typeOfURI, tokenId, newURI);
        }
// function upgrade(uint256 typeOfURI, uint256 tokenId, string newURI) public returns{
// }
// //contract Trigger {

//BoxContract private BOX;

// constructor(address boxContract){
//     BOX = BoxContract(boxContract);
// }

// function upgrade() external returns(bool){
// require(BOX.OwnerOf(tokenId) == msg.sender, "You don't own the given box");
...
// }
    ...
    //function upgrade()external nonReentrant callerIsUser{
    // check if the msg sender is the owner
            //equire(BOX.ownerOf(tokenId) == msg.sender, "You don't own the given Box");

            //
            //BOX.setNewTokenURI2(typeOfURI, tokenId, newURI);
