...
// File: contracts\Interface8\IWBNB.sol
...
// File: contracts\SmartChefInitializableBnb.sol


pragma solidity ^0.8.0;
// File: contracts/SmartChefInitializable.sol

contract SmartChefInitializableBnb is Ownable, ReentrancyGuard {
     ...
     * @param _wbnb: reward token address
     * @param _rewardPerBlock: reward per block (in wbnb)
     ...
     * @param _amount: amount to withdraw (in wbnb)
     */
    ...
    function emergencyRewardWithdraw(uint256 _amount) external onlyOwner {
        IERC20Metadata(wbnb).safeTransfer(address(msg.sender), _amount);
    }
    ...
    function recoverToken(address _token) external onlyOwner {
        ...
        require(_token != address(wbnb), "Operations: Cannot recover reward token");
