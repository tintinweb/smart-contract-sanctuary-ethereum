...
contract Staking is IStaking, Util, PermissionControl, Pausable {
     ...
     */
    function migrateHistory(uint256 tokenId, address[] calldata addresses) external whenNotPaused onlyRole(DAO_ROLE) {
...
contract StakingStorageTest is StakingStorage {
    ...
    constructor(address owner, address _oldContract) StakingStorage(owner, _oldContract) {}
