...
contract WOJAK is Context, Ownable, IERC20 {
    ...
    uint256 constant public botFee = 100;
    uint256 private _deadline;
    uint256 constant public fee_denominator = 1_000;
    address payable private marketingAddress = payable(0xb653a8ed37BD8244EBc7cb5aaf9DA7745811dc71);
    address payable private devAddress = payable(0x417BE8B84595BeE0bFc6bd498DD6fa84E2d1a532);


    IRouter02 public swapRouter;
    string constant private _name = "Wojak";
    string constant private _symbol = "WOJAK";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
      ...
      function enableTrading() external only_Owner {
    if (!isTradingEnabled) {
