...
contract TwapRelayer is ITwapRelayer, IInitializable {
    using SafeMath for uint256;
    ...
    /*
     * DO NOT CHANGE ANY THING OF THE BELOW STATE VARIABLES.
     * REMOVE OR REORDER OR INSERT STATE VARIABLES WILL CAUSE STORAGE COLLISION.
    ...
    /*
     * DO NOT CHANGE ANY THING OF THE ABOVE STATE VARIABLES.
     * REMOVE OR REORDER OR INSERT STATE VARIABLES WILL CAUSE STORAGE COLLISION.
     * NEW VARIABLES SHOULD BE ADDED BELOW THESE VARIABLES TO AVOID STORAGE COLLISION.
     */
    ...
    // This contract is a implementation contract of a Proxy Pattern.
    // The constructor is to set the values so that no one can abuse this implementation contract for scamming.
    // Setting locked = 1 can make the core fetures, e.g. buy(), to always revert.
    constructor() {
        owner = msg.sender;
        initialized = 1;
        locked = 1;
    ...
    // This initialize() function is supposed to be called throught proxy contract to set initial values in storage of the proxy contract.
    function initialize(
        address _factory,
        address _delay,
        address _weth
