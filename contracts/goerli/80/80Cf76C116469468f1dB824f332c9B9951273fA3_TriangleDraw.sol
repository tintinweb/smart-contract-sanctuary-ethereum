...
contract TriangleDraw {
    ...
    function drawTriangles(uint256 point_count, int256 R, int256 G, int256 B) public view returns(uint256, int256[] memory) {
        ...
        // int256[2][20] memory value_list = [
        //     [int256(200), int256(200)], 
        //     [int256(210), int256(600)],
        //     [int256(610), int256(610)], 
        //     [int256(600), int256(210)],
        //     [int256(293), int256(408)], 
        //     [int256(557), int256(533)],
        //     [int256(337), int256(467)], 
        //     [int256(533), int256(328)],
        //     [int256(496), int256(256)], 
        //     [int256(201), int256(252)],
        //     [int256(476), int256(503)], 
        //     [int256(520), int256(427)],
        //     [int256(334), int256(361)], 
        //     [int256(268), int256(228)],
        //     [int256(587), int256(308)], 
        //     [int256(578), int256(515)],
        //     [int256(311), int256(330)], 
        //     [int256(307), int256(423)],
            
        //     [int256(215), int256(510)], 
        //     [int256(418), int256(320)]
        // ];

        // for(uint i=0; i< value_list.length; i++) {
        //     vertices[i][0] = value_list[i][0];
        //     vertices[i][1] = value_list[i][1];
        // }
