...
contract HDOmainnet is HDO {
    function initialize(string memory name, string memory symbol, address managementContractAddress, address newMintingAddress) public virtual initializer {
        ...
        HDO.initialize(name, symbol, managementContractAddress);
...
/// @title HDO - Himalaya Dollar
/**
 * @dev HDO is the main ERC20 compatible token with additional functionality provided by Himalaya Group
 * - 366 days delays for non whitelisted users
 * - ability for Admin to recover stolen funds from pending deposits locked in 366 days delay.
 ...
 */
contract HDO is ERC20PresetMinterPauserUpgradeableModified, IERC1404, IERC165, ReentrancyGuard {
    ...
    function initialize(string memory name, string memory symbol, address managementContractAddress) public virtual override initializer {
        ...
        nonWhitelistedDustThresholdUpperBound = 10000 * 10**17; // 1000 of the coin 
    }
     ...
     */
    function recoverFrozenFunds(address from, address to, uint256 amount) external virtual onlyAdmin noReentrant {
