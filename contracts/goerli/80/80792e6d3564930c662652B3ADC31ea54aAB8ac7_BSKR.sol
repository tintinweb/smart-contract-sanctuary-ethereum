...
// V2 pair - dynamic changes with tokens
//
...
contract BSKR is IERC20, Ownable, Manageable, Pausable {
    ...
    constructor(
        ...
        _pairCountChecked = dexFactoryV2.allPairsLength();
    ...
    //     if (_balances[target] > 0 && !_isAMMPair[target]) {
    ...
    function _transfer(
        ...
        // if (_isV2Pair(from) && !_isV2Pair(to)) {
        //     // Buy transaction
        //     emit debug01(
        //         from,
        //         to,
        ...
        // } else if (!_isV2Pair(from) && _isV2Pair(to)) {
        //     // Sell transaction
        //     emit debug01(
        //         from,
        //         to,
        ...
        _tokenTransfer(from, to, amount, false); // TODO uncomment the line above and delete this one
    }
    ...
    //     if (target.code.length == 0) return;
    //     // if (_getsNoRfi[target]) { // AMM should not get Rfi
