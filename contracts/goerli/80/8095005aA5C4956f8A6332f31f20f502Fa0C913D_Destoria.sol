...
This smart-contract is powered by GOMINT.
https://gomint.art

*/

contract Destoria is ERC721A, Promos {
    ...
    uint256 public maxPrivateMintTokensPerWallet = 2;

    mapping(address => uint256) public privateMintTokensPerWallet;
    mapping(address => EnumerableSet.UintSet) addressUsedNonces;

    constructor() ERC721A("Destoria: Founder`s Pass", "DFP") {}
    ...
    function mintPrivate(
        ...
        uint256 newWalletPrivateMintTokensAmount = privateMintTokensPerWallet[msg.sender].add(_amount);
        require(newWalletPrivateMintTokensAmount <= maxPrivateMintTokensPerWallet, "Max per wallet");

        privateMintTokensPerWallet[msg.sender] = newWalletPrivateMintTokensAmount;
    ...
    function setMaxPrivateMintTokensPerWallet(uint256 _maxPrivateMintTokensPerWallet) external onlyOwner {
        maxPrivateMintTokensPerWallet = _maxPrivateMintTokensPerWallet;
    }
