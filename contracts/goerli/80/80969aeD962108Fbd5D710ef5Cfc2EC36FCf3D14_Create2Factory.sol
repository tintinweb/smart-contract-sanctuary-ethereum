...
import "./upgradeability/InitializableAdminUpgradeabilityProxy.sol";
...
contract Create2Factory {
    ...
    function _deployProxy(
        ...
        InitializableAdminUpgradeabilityProxy proxy = _createProxy(
            _salt,
            _sender
        );
        ...
        returns (InitializableAdminUpgradeabilityProxy)
    {
        ...
        bytes memory code = type(InitializableAdminUpgradeabilityProxy)
            .creationCode;
...
contract InitializableUpgradeabilityProxy is BaseUpgradeabilityProxy {
    ...
    function initialize(address _logic, bytes memory _data) public {
        ...
        if (_data.length > 0) {
            require(
                OpenZeppelinUpgradesAddress.isContract(_logic),
