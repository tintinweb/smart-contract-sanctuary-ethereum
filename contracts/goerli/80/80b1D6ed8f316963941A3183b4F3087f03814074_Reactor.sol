...
/// @title Smart Contract for managing Reactors.
/// @author Hernan Abeldaño
/// @notice Implements ERC1155 Standard with specific mint.


contract Reactor is ERC1155 {
    
    address payable public owner;
    address payable public managerFee;
    ...
    constructor (
        ...
        name = _proyectName;
        tokenSupply = _cantidadSupply;
        tokenPrices = _tokenPrices;
        managerFee = _feeAddress;
