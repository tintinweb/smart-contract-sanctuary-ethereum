...
//          __        __  __  __                  __                    __              
// /  |      /  |/  |/  |                /  |                  /  |             
// $$ |   __ $$/ $$ |$$ |  ______        $$ |____    ______   _$$ |_   ________ 
// $$ |  /  |/  |$$ |$$ | /      \       $$      \  /      \ / $$   | /        |
// $$ |_/$$/ $$ |$$ |$$ | $$$$$$  |      $$$$$$$  |/$$$$$$  |$$$$$$/  $$$$$$$$/ 
// $$   $$<  $$ |$$ |$$ | /    $$ |      $$ |  $$ |$$ |  $$ |  $$ | __  /  $$/  
// $$$$$$  \ $$ |$$ |$$ |/$$$$$$$ |      $$ |__$$ |$$ \__$$ |  $$ |/  |/$$$$/__ 
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x7835fd1aA20A917B8595CaB2E3c4343a07396f93];
  address public erc20Payable = 0x7835fd1aA20A917B8595CaB2E3c4343a07396f93;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 50) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigx7tno5gu4zijczzqaqonlcrz47v3e7ngl4rwkphmjjdxqes3cle/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 50");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 50");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 50");
...
// File: contracts/KillabotzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KillabotzContract is RamppERC721A {
    constructor() RamppERC721A("killa botz", "botz"){}
}
