...
contract SpitYard is FxBaseRootTunnel, Ownable {
    ...
    function stake(uint256[] memory tokenIds) public {
        ...
        //_sendMessageToChild(abi.encode(msg.sender, value, true)); commented out for unit testing
    ...
    function unstake(uint256[] memory tokenIds) public {
        ...
        //_sendMessageToChild(abi.encode(msg.sender, value, false)); commented out for unit testing
