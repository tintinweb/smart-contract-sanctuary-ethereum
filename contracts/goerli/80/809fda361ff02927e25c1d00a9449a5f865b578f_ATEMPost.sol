...
contract ATEMPost is ERC1155Pausable, Ownable, ReentrancyGuard {
    ...
    function setCreatorPayment(address _to) external {
        require(
            _to != address(0),
            "ATEMPost#setCreatorPayment: invalid address"
        );
    ...
    {  
        ...
        require(
            ...
            "ATEMPost#mint: incorrect payment value"
        );
        ...
        require(
            ...
            "ATEMPost#mint: not enough balance"
        );
    ...
    ) public payable nonReentrant()
    {
        require(
            ...
            "ATEMPost#mintBatch: parameters must have the same length"
        );
