...
contract Seapad is VRFV2WrapperConsumerBase, ChainlinkClient {
    ...
    // VARIABLES
    address owner;
    string PACK_BASE_URL = "https://seapad.io/pack/";
    ...
    function updateContract(
        ...
        string calldata _PACK_BASE_URL
    )
        public
        ...
        onlyOwner
    {
        ...
        PACK_BASE_URL = _PACK_BASE_URL;
        // jobId = SeapadHelper.stringToBytes32(_jobId);
    }

    function getPackBaseURL() public view returns (string memory) {
        return PACK_BASE_URL;
    }
    ...
    */
    ...
    function createTokenPart2(
        ...
        // uint256 seapadProfit = msg.value;
