...
contract CrowdFunding {
    ...
    function donateToCampaign(uint256 _id) public payable {
        ...
        require(amount <= (campaign.target - campaign.amountCollected), "Donation exceeds campaign target.");
        require( block.timestamp < campaign.deadline, "Deadline have been finished");
    ...
    require(campaigns[_id].owner == msg.sender, "Only the owner can delete a campaign.");
