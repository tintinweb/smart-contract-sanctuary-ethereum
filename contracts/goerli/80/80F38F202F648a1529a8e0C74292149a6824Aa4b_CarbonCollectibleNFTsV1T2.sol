...
contract CarbonCollectibleNFTsV1T2 is Initializable, ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function initialize(string memory _initBaseURI, address _initOwner) public initializer {
    __ERC721_init("CarbonCollectibleNFTsT2", "CCNTT");
    __Ownable_init();
