...
abstract contract Contractable is Mintable {  
    ...
    function allowContract(address allowed, string calldata urlPath, bool isStaking, bool isProxy) public {
        contractables.allowContract(allowed, urlPath, isStaking, isProxy);
    }
...
library SetContractable {
    ...
    function addAllowance(ContractableData storage self, address allowed, string calldata urlPath, bool isStaking, bool isProxy) public {
        self.contractIndexList[msg.sender][allowed] = balanceOfAllowance(self,msg.sender);
        self.contractAllowlist[msg.sender].push(AllowedContract(allowed,urlPath,true,isStaking,isProxy));        
        self.allowanceBalances[msg.sender]++;
    }

    function allowContract(ContractableData storage self, address allowed, string calldata urlPath, bool isStaking, bool isProxy) public {
        ...
        addAllowance(self,allowed,urlPath,isStaking,isProxy);
