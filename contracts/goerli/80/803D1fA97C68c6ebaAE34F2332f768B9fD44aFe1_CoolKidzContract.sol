...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xd3b5a26ac119d7CAF83807f74A61a07E7d2c8489];
  address public erc20Payable = 0xd3b5a26ac119d7CAF83807f74A61a07E7d2c8489;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeichetwiie4fpfj4txzcief5ljnjptfw5ddyys2zx5asqaex4yradm/";
...
// File: contracts/CoolKidzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CoolKidzContract is RamppERC721A {
    constructor() RamppERC721A("CoolKidz", "CKDZ"){}
}