...
contract SBTEST is Ownable, ERC721A, PaymentSplitter {

    // DETAILS TBD ON THIS DROP...
    uint public MAXSUPPLY = 11111;  // Hard-coded in setMaxSupply() also.
    uint public THEMINTPRICE = 0.01 ether; // .
    uint public WALLETLIMIT = 55; // TEST AMT HERE... Presale 10 , Public 1000 (none)
    uint public TRANSACTIONLIMIT = 10;  // Using this instead of wallet limit.
