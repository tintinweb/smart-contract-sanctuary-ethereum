    ...
    IERC721ReceiverUpgradeable
{
    ...
    function _page(uint256 total, uint256 pageNum, DataTypes.LoanData[] memory loanDatas) internal pure returns(uint256, DataTypes.LoanData[] memory) {
        uint256 id;
