...
contract Fuc is ERC721A, Ownable, ReentrancyGuard ,DefaultOperatorFilterer{
    ...
    struct TimeConfig {
        uint24 partnerStartTime;
        uint24 partnerEndTime;
        uint24 fucthelistStartTime;
        uint24 fucthelistEndTime;
        uint24 whitelistStartTime;
        uint24 whitelistEndTime;
    }
    //--------add--------
     ...
     */
    function setTime(uint24 startTime , uint24 endTime ,int8 timeType) public onlyOwner fucStatus{
