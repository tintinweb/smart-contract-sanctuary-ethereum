...
contract SYLBankV1 is Initializable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    ISYLVestingWallet public vestingWallet;
    mapping(address => uint256) public claimables;

    function initialize(address erc20Address, address vestingWalletAddress) public initializer {
        __Pausable_init();
        __AccessControl_init();
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        erc20 = ERC20Burnable(erc20Address);
        vestingWallet = ISYLVestingWallet(vestingWalletAddress);
    }
