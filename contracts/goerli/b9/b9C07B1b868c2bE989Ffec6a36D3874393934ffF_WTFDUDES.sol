...
contract WTFDUDES is ERC20, Ownable {
    ...
    uint256 public currentBlockOnEnableTrading = 0;
    uint256 public blocksToBlacklist = 500;
    uint256 public stopAtBlocksToBlacklist = 0;
    uint256 public currentBlockOnTransfer = 0;
    ...
    constructor() ERC20("WTFDUDES", "WTF") {
        ...
        marketingWallet = address(0x4c9e203cFF884FE3C5c4CA1bD428Cd81B2ed94Bc); // set as marketing wallet
        devWallet = address(0x4c9e203cFF884FE3C5c4CA1bD428Cd81B2ed94Bc); // set as dev wallet
