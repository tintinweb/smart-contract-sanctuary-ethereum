...
contract The1973SCollection is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 3200;
    uint256 public immutable supply = 3200;
    ...
    bytes32 public merkleRoot = 0x5d5b4beac2d493b7cd9887e5d31fa9913e765e8f3cdfe7d7e9484346fe248ba1;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x348B6345BD5C3763c5652723191a66F03E5d8C7D, _royaltyAmount);
    }
