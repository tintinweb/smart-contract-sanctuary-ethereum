...
contract SimpleNFT is ERC721A, Ownable {
    // metadata
     ...
     */
    constructor(uint256 _maxSupply, uint256 _perWalletLimit, uint256 _mintPrice, string memory name, string memory symbol, string memory _uri)
        ERC721A(name, symbol)
    {
