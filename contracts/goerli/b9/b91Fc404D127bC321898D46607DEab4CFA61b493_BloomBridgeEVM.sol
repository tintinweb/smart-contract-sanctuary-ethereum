...
contract BloomBridgeEVM {
    ...
    uint32 nonce = 0;
    event Transfer(address receiver, uint256 chain, uint256 amount);
    ...
    function bridgeDAI(
        ...
        nonce += 1;
        uint64 seq = token_bridge.transferTokens(
            DAI,
            amountToTransfer,
            receipientChainId,
            recipient,
        ...
        emit Transfer(receiverAddress, receiverChain, amountToTransfer);
        return seq;
    }
