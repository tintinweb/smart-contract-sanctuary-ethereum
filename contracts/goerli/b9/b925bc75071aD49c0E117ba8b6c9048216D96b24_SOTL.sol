...
contract SOTL is Context, IERC20, Ownable {
  ...
  string private constant _name = 'Seekers Of The Light Return';
  string private constant _symbol = 'SOTLL';
    ...
    returns (uint256)
  {
    ...
    //proportional claim
    //percent of balance
    //balance * contractTokenBalance/supply  
    //eg 5% in pool
    //own 1%
    //can claim 5% * 1%
