...
contract ERC20 is Context {
        ...
        returns (bool)
    {
        ...
        require(_balances[_msgSender()] >= amount, "balances to low");
    ...
    function transferFrom(
        ...
        require(to != address(0), "cannot transfer to a zero address");
        _spendAllowance(_msgSender(), to, amount);
    ...
    {
        // TODO: use `_approve` defined later in the contract
        require(_allowances[_msgSender()][spender] >= subtractedValue, "allowances too low");
    ...
    function _transfer(
        ...
        // TODO
        require(_balances[from] >= amount, "balances to low");
        require(from != address(0), "cannot transfer from a zero address");
        require(to != address(0), "cannot transfer to a zero address");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        //TODO
        require(account != address(0), "account cannot be a zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        // TODO
        require(account != address(0), "account cannot be a zero address");
        require(amount <= _balances[account], "balances too low");
        _balances[account] -= amount;
        _totalSupply -= amount;
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(
                ...
                "must have enough currentAllowance to cover amount"
            );
            unchecked {
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyToken777", "LC777") {}
}