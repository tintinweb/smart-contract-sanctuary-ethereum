...
contract RacingStarClub is ERC721, Ownable {
    string public baseURI="http://qa-aug-gql.433live.com:3000/nft/json/";
    ...
    constructor() ERC721("Racing Star Club", "RSC") {}
    ...
    function safeMint(uint8 quantity)  public payable   {
        require(quantity < 6, "Maximum of 5 tokens to buy at once.");
        require(msg.value == cost * quantity, "Price must be equal to listing price.");
