...
contract LiquidatorConfig is Ownable {
  ...
  /**
   * @dev update `uniswapV2Router` address
   */
  function setUniswapV2Router(IUniswapV2Router02 _uniswapV2Router)
    public
    onlyOwner
  {
    uniswapV2Router = _uniswapV2Router;
  ...
  IERC1271
{
  ...
  constructor(LiquidatorConfig config, address _moonBirds)
    LiquidatorBase(config)
  {
    MOONBIRDS = IMoonBird(_moonBirds);
  }
  ...
  function _flashLoanAndExecute(
    ...
    if (_flashLoanParams.flashLoanToDebtSwapPath.length == 0) {
      amounts[0] = _liquidateParams.debtToCover;
    } else {
      IUniswapV2Router02 flashLoanToDebtRouter = IUniswapV2Router02(
        _flashLoanParams.flashLoanToDebtRouter
      );
      uint256[] memory _amounts = flashLoanToDebtRouter.getAmountsIn(
  ...
  function _executeOperationForNFTX(
    ...
    MarketAdaptor.nftxMintAndSell721(
      params.quote,
      params.liquidateParams.collateralAsset,
      params.market
    );
  ...
  function _executeOperationForSudo(
    ...
    MarketAdaptor.sudoSwapNFTsForToken(
      params.quote,
      params.liquidateParams.collateralAsset,
      params.market
    );
  ...
  function _beforeSellNFT(
    ...
    if (_flashLoanParams.flashLoanToDebtSwapPath.length != 0) {
      ...
      flashLoanToDebtRouter.swapTokensForExactTokens(
        _liquidateParams.debtToCover,
        amounts[0],
        _flashLoanParams.flashLoanToDebtSwapPath,
        address(this),
    ...
    if (_liquidateParams.collateralAsset == address(MOONBIRDS)) {
  ...
  function _afterSellNFT(
    ...
    if (_offerToken != _flashLoanParams.flashLoanAsset) {
      IUniswapV2Router02 offerToFlashLoanRouter = IUniswapV2Router02(
        _flashLoanParams.offerToFlashLoanRouter
      );
      ...
      offerToFlashLoanRouter.swapTokensForExactTokens(
        amountNeeded,
        IERC20(_offerToken).balanceOf(address(this)),
