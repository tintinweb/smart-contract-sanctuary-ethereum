...
contract Kenomi is Ownable, Utils {
    ...
    function addWhiteListItem(
        ...
        whiteListItem.index = whiteListItems.length;
    ...
    function addAuctionItem(
        ...
        auctionItem.index = auctionItems.length;
        ...
        requireSignature(signature)
    {
        ...
        whiteListItems[itemIndex].index = itemIndex;
        whiteListItems.pop();
