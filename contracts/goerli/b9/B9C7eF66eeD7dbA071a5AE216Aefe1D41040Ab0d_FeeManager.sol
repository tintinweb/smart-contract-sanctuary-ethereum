...
import {ICardinalityJob} from '@interfaces/jobs/ICardinalityJob.sol';
import {ILockManager} from '@interfaces/ILockManager.sol';

import {Roles} from 'solidity-utils/contracts/Roles.sol';
...
import {IERC20} from 'isolmate/interfaces/tokens/IERC20.sol';
import {IUniswapV3Pool} from 'uni-v3-core/interfaces/IUniswapV3Pool.sol';
import {IRoles} from 'solidity-utils/interfaces/IRoles.sol';
...
interface IFeeManager is IRoles {
   ...
   */
  function poolManagerDeposits(IPoolManager _poolManager) external view returns (uint256 _wethForFullRange, uint256 _tokenForFullRange);
...
import {ILockManagerGovernor} from '@interfaces/ILockManagerGovernor.sol';
import {IPriceOracle} from '@interfaces/periphery/IPriceOracle.sol';
...
import {IPoolManagerFactory} from '@interfaces/IPoolManagerFactory.sol';
import {IPoolManager} from '@interfaces/IPoolManager.sol';
import {IGovernorMiniBravo} from '@interfaces/periphery/IGovernorMiniBravo.sol';
import {IFeeManager} from '@interfaces/IFeeManager.sol';
...
import {ILockManager} from '@interfaces/ILockManager.sol';
import {IStrategy} from '@interfaces/strategies/IStrategy.sol';
import {IPoolManagerGovernor} from '@interfaces/IPoolManagerGovernor.sol';
import {IPoolManagerFactory} from '@interfaces/IPoolManagerFactory.sol';
...
import {IPoolManager} from '@interfaces/IPoolManager.sol';
import {ILockManagerFactory} from '@interfaces/ILockManagerFactory.sol';
import {IPoolManagerDeployer} from '@interfaces/IPoolManagerDeployer.sol';
import {IFeeManager} from '@interfaces/IFeeManager.sol';
import {IPriceOracle} from '@interfaces/periphery/IPriceOracle.sol';
import {IStrategy} from '@interfaces/strategies/IStrategy.sol';
import {IFeeCollectorJob} from '@interfaces/jobs/IFeeCollectorJob.sol';
...
import {IKeep3r} from 'keep3r/interfaces/IKeep3r.sol';
import {IPausable} from 'solidity-utils/interfaces/IPausable.sol';
