...
contract Staker {
  ...
  function execute () public notCompleted {
    require ( block.timestamp >= deadline, "not enough time has passed, chill");
  ...
  function withdraw () public payable notCompleted {
    require(msg.sender.balance > 0, "no balance");
    require(openForWithdraw == true, "withdrawals not enabled yet");
