...
contract fake is ERC721A, Ownable, ReentrancyGuard {
    ...
    string public hiddenMetadataUri = "ipfs://QmUgYj9uEZxhwYnXKQakD6siFZkCLn5xSDnUcg176uDnsK"; //Base token URI


    uint256 public publicCost = 0.03 ether;
    uint256 public maxPerWalletPublic = 3;
    uint256 public maxSupply = 300000000000000000000;
    ...
    function withdraw() public onlyOwner {
        ...
        (success, ) = payable(0x05A4987F84a6822Af4C2bad5d123Dd7733020eD5).call{
            value: (50 * contractBalance) / 100
        }("");
