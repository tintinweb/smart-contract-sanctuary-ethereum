...
contract MinterContract is Ownable {
    ...
    function _mint (string memory charityId, uint256 amount, address tokenOwner, bytes memory signature ) public {
    ...
    function _mintforOwner (string memory charityId, uint256 amount, address tokenOwner) public onlyOwner {
        _charity.addCharity(charityId, amount);
        _starify.safeMint(tokenOwner, amount, charityId);
    }
...
contract Starify is Initializable, ERC721A, OwnableUpgradeable {
    ...
    event tokenCreated(uint256 quantity, address tokenOwner, string CharityId);
    ...
    function safeMint(address to, uint256 quantity, string memory charityId) public onlyMinter {
        if(isLimitSet) {
    ...
    IERC721EnumerableUpgradeable
{
    ...
    struct TokenOwnership {
        ...
        string charityId; //////////////////////////add charityId///////////////////////////
    }
