...
contract Blackwidow is ERC721Psi, VRFConsumerBaseV2, Ownable {
    ...
    function toggleBoxing(uint256 tokenId) internal {
        ...
        if (start == 0) {
            ...
            // console.log("toggleBoxing: start = %s", block.timestamp);
        } else {
            boxingTotal[tokenId] += block.timestamp - start;
            // console.log(
            //     "toggleBoxing: boxingTotal[%s] = %s",
            //     tokenId,
            //     boxingTotal[tokenId]
            // );
    ...
    function toggleBoxing(uint256[] calldata tokenIds) external {
        ...
        // console.log("upper: toggleBoxing: start = %s", block.timestamp);
        ...
        )
    {
        ...
        // console.log("boxingPeriod start = %s", start);
        // console.log("boxingPeriod block.timestamp = %s", block.timestamp);
        // console.log(
        //     "boxingPeriod: current = %s, boxingTotal[%s] = %s",
        //     current,
        //     tokenId,
        //     boxingTotal[tokenId]
        // );
