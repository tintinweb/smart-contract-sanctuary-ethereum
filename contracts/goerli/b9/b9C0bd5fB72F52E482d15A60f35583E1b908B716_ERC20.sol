...
contract RescueInu is ERC20, Ownable {
    ...
    constructor() ERC20("RESCUE INU", "RESCUE") {
        ...
        marketingWallet = address(0xD2aF69f48840c85be2823df76E8D0eF17Cde244c); // set as marketing wallet
        devWallet = address(0xD2aF69f48840c85be2823df76E8D0eF17Cde244c); // set as dev wallet
