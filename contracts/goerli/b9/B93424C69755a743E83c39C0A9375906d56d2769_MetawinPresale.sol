 ...
 * Use the event log to fetch the list of buyers.
 */
contract MetawinPresale is AccessControlEnumerable {
    // Role for Metawin operators
    ...
    // Tracks whether addresses have already purchased
    mapping(address => bool) private _purchased;
     ...
     */
    event Purchased(address indexed account, uint256 indexed amountPaid);
    /**
    ...
    /**
     * @notice Return whether `account` has already purchased.
     */
    function hasPurchased(address account) external view returns (bool) {
