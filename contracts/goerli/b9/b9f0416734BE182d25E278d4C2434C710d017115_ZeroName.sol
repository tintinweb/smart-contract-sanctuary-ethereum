...
import "./extension/UniversalZeroName.sol";

contract ZeroName is UniversalZeroName {
    constructor(address _layerZeroEndpoint, uint _startMintId, uint _endMintId, string memory _BASE_URI) UniversalZeroName("Zero Name DID", "ZeroName", _layerZeroEndpoint, _startMintId, _endMintId, _BASE_URI) {}
}
...
contract UniversalZeroName is ONFT721 {
    using Strings for uint256;
    ...
    constructor(string memory _name, string memory _symbol, address _layerZeroEndpoint, uint _startMintId, uint _endMintId, string memory _BASE_URI) ONFT721(_name, _symbol, _layerZeroEndpoint) {
        nextMintId = _startMintId;
        maxMintId = _endMintId;
        BASE_URI = _BASE_URI;
    }

    function mint() external payable returns (uint256 newId) {
