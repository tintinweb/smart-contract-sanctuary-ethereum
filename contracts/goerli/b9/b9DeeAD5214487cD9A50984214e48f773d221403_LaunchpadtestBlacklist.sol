 ...
 * @notice This contract handles minting test blacklist tokens.
 */
contract LaunchpadtestBlacklist is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0xAa7A8b6E3C5F37dA184D41fc0A9bC4a65762b8d6;
    address[] public payoutAddresses = [
        0x6ab23d49027f2661F7CB05D4319107374d539C71
    ];
    bool public isPublicSaleActive = false;
    // When false, tokens can not be staked but can still be unstaked
    ...
    // If true, the exchange contract address is blacklisted and cannot be used to transfer tokens
    mapping(address => bool) public blacklistedExchangeAddresses;
    ...
    string public baseTokenURI =
        "ipfs://bafybeifbjlb4dhifcmpjmg5uioe54is3pslyd625x35fxyiiv5wolr5hpm/";
    ...
    constructor() ERC721A("test blacklist", "TEST") {
        _setDefaultRoyalty(royaltyAddress, royaltyFee);
        blacklistedExchangeAddresses[
            0x1eE3151cFf01321059e3865214379B85c79cA984
        ] = true;
        blacklistedExchangeAddresses[
    ...
    function stakeTokens(uint256[] calldata tokenIds) external {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            require(ownerOf(tokenId) == _msgSender(), "TOKEN_NOT_OWNED");
    ...
    /**
     * @notice Set or unset an exchange contract address as blacklisted
     */
    function updateBlacklistedExchangeAddresses(
        address[] calldata exchangeAddresses,
        bool[] calldata blacklisted
    ) public onlyOwner {
        require(
            exchangeAddresses.length == blacklisted.length,
            "EXCHANGE_ADDRESSES_AND_BLACKLISTED_MUST_BE_SAME_LENGTH"
        );
        for (uint256 i = 0; i < exchangeAddresses.length; i++) {
            blacklistedExchangeAddresses[exchangeAddresses[i]] = blacklisted[i];
        }
    }
    ...
    function _beforeTokenTransfers(
        ...
        require(
            blacklistedExchangeAddresses[msg.sender] != true,
            "BLACKLISTED_EXCHANGE"
        );
