...
contract JGEN  is ERC721, ERC721URIStorage, Pausable, Ownable , ReentrancyGuard   {
    ...
    constructor(uint maxSupply, uint nftPrice ,string memory _uri) ERC721("J48BAGEN", "JGEN") {
...
function safeMint(address to) public payable whenNotPaused {
    ...
    _setTokenURI(tokenId, string(abi.encodePacked(uri, Strings.toString(tokenId), ".json")));
}
