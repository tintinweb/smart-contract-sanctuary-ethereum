...
contract AnimeMetaverseReward is ERC1155, Ownable, AmvUtils, IAnimeMetaverseReward{
    ...
    function mintBatch(
        ...
        emit RewardMintBatch(_drawIndex,_activityId, msg.sender, _to, _ids, _amounts);
    }
        ...
        validMintingAmount(_amount)
    {
        ...
        emit RewardMint(_drawIndex,_activityId, msg.sender, _to, _id, _amount);
    }
