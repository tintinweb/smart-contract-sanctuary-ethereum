...
contract SuperordinaryFriends is ERC1155, ERC1155Supply, Ownable {
    ...
    uint256 public SF_PRICE = 0.05 ether;
    uint256 public SF_MINT_LIMIT = 2;
    ...
    function publicMint(uint256 numOfTokens, uint8 mintPhase) external isSecured(mintPhase) checkPhaseSupply(mintPhase, numOfTokens) payable {
        require(mintedSF[msg.sender] + numOfTokens < SF_MINT_LIMIT, "MINTED_ALREADY");
        require(msg.value == SF_PRICE * numOfTokens, "WRONG_ETH_VALUE");
