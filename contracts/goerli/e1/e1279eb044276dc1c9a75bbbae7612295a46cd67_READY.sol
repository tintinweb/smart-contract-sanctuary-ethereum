...
/*
 ...
 Website: https://readyerctoken.com/
 Twitter: https://twitter.com/readyerc
 Telegram: https://t.me/ReadyERCPortal
 Medium: https://medium.com/@ercready
 Email: [email protected]

 If you're reading this I know you're $READY. 
 Join our portal, Telegram link above, and allow us to welcome you the $READY-way.
...
contract READY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ready", "READY") {
        ...
        maxWallet = totalSupply * 25 / 1000; // 2.5% max wallet
    	...
    	marketingWallet = address(0x4E3Baa979df51Be9118fD84572B7F03bD09fE672); // Marketing wallet
        lpLocker = address(0x663A5C229c09b049E36dCc11a9B0d4a8Eb9db214); // set LP Locker CA (Unicrypt)
