...
contract FLVRMERC721A is MGYERC721A{
  constructor (
      string memory _name,
...
contract MGYERC721A is Ownable,ERC4907A, ReentrancyGuard, ERC2981,OperatorFilterer{
 ...
 //Burn&MintSale mint. external
  ...
  function burnAndMintWithGenesis(uint256 _amount,uint256[] calldata _tokenids,uint256 _tokenidGenesis) external payable virtual nonReentrant {
    require(otherContractGenesis != address(0),"not set otherContractGenesis.");
    require(_otherContractGenesisFactory.ownerOf(_tokenidGenesis) == msg.sender,"You are not owner of this tokenidGenesis.");
    _burnAndMint(_amount,_tokenids);
  }
