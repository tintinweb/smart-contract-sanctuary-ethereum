...
contract TREX is ERC721A, EIP712, Ownable {
    ...
    address artist = 0xAd275728fd641B5cF66688bA47d2bE0df0cBcaf5; //check wallets
	address dev = 0x507CdC308B1d62BC52cB6C292a12A21E669318E5; //check wallets
   ...
   /* (bool hs, ) = payable(artist).call{value: address(this).balance * 30 / 100}("");
    require(hs); */
	    ...
	    (bool hs, ) = payable(dev).call{value: address(this).balance * 6 / 100}("");
    require(hs);
