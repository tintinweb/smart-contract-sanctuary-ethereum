...
contract metareel is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x6891D9b4b5f296Ec017Eae0E4428E259A149d43A); // Marketing Address

    address payable public teamAddress =
        payable(0x9D8660D1092881a0043C0d38f1a05d2e660C74e3); // Team Address

    address payable public liquidityAddress =
        payable(0x7F9c98E3fEc26974C013d53762fAF53d9e416536); // Liquidity Address
