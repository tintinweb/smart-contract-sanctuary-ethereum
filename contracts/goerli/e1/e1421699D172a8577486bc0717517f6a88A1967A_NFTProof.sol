...
contract NFTProof is ERC721, AccessControl {
    bytes32 public constant LOAN_COORDINATOR_ROLE =
     ...
     * @param _loanCoordinator - Initial loan coordinator, should be maincredit proxy contract address
    ...
    function setBaseURI(string memory newBaseURI) public onlyRole(BASE_URI_ROLE) {
    ...
    function mint(
        ...
        (address collateralAddress, uint256 collateralId) = abi.decode(_data, (address, uint256));
        loanData[_tokenId] = LoanData({collateralAddress: collateralAddress, collateralId: collateralId});
