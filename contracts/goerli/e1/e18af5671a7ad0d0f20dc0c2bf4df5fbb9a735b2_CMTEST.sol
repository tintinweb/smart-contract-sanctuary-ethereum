...
contract CMTEST is ERC721A, Ownable {
    ...
    constructor( uint256 newMaxSupply, address newSignerAddress, string memory newBaseURI, bool newStakingStatus, uint256 newRevealTime ) ERC721A("CMTEST", "CMTEST") {
    ...
    function tokensOf(address owner) external view returns (uint256[] memory) {
        unchecked {
            ...
            for (uint256 i; i < (totalSupply() - 1); i++) {
