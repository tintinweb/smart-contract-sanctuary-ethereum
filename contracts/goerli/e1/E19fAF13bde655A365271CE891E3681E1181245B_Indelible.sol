// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        constructor() ERC721A(unicode"PXCC", unicode"PXCC") {
            TIERS[0] = [1,1,1,2219];
TIERS[1] = [0,143,155,336,390,516,682];
TIERS[2] = [0,65,101,221,257,304,310,339,625];
TIERS[3] = [0,4,5,7,34,49,113,113,144,164,179,182,270,286,304,368];
TIERS[4] = [0,35,52,56,61,97,111,138,195,200,201,486,590];
TIERS[5] = [0,5,33,39,71,77,87,99,100,102,102,108,151,199,242,246,264,297];
TIERS[6] = [0,21,29,39,46,66,98,104,139,156,179,179,183,191,194,198,200,200];
