...
contract PTest is ERC721AQueryable, PaymentSplitter, Ownable{
    ...
    uint256 public whitelistMintDate = 1669644000; // 2022-11-28T14:00:00Z
    uint256 public publicMintDate = 1669723200; // 2022-11-29T12:00:00Z
...
// event PermanentURI(string _value, uint256 indexed _id);
    ...
    function getPersonalWhitelistMintCount() public view returns (uint256) {
        return _whitelistMinted[_msgSender()];
    }
    function getPersonalPublicCount() public view returns (uint256) {
        return _publicMinted[_msgSender()];
    }
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts (last updated v4.7.0) (finance/PaymentSplitter.sol) - Modified by removing ERC20
...
//    }
     ...
     */
    function totalReleased() private view returns (uint256) {
...
//    }
     ...
     */
    function released(address account) private view returns (uint256) {
     ...
     */
    function payee(uint256 index) private view returns (address) {
