...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x5AaE0ca701Cb9EeC93CaCc0D3d8159680B80bac8];
  address public erc20Payable = 0x5AaE0ca701Cb9EeC93CaCc0D3d8159680B80bac8;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.0321 ether;
  uint256 public earlyMintTokenIdCap = 3600;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 4321) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Wpv2GDhz6dQEHIuLTL6M/contract-metadata";
  }
...
// File: contracts/Rexbitstest8Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Rexbitstest8Contract is ERC721APlus {
    constructor() ERC721APlus("REXBITSTEST8", "RXBT"){}
}