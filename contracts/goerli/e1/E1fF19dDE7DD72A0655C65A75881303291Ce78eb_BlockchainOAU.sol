...
// File: contracts/blockchainOAU.sol
...
contract BlockchainOAU is ERC721{

    string uri = "ipfs://QmdU72kYD1BWuitH7zXJTw17K3HBxBgiSdDbT5VvFNsa8s";

    constructor() ERC721("BlockchainOAU", "BOAU"){
        _mint(msg.sender, 0);
