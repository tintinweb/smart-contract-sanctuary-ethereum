...
contract BAKE is ERC20("BakeryToken", "BAKE") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "BAKE::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "BAKE::delegateBySig: invalid nonce"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "BAKE::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "BAKE::_writeCheckpoint: block number exceeds 32 bits"
        );
