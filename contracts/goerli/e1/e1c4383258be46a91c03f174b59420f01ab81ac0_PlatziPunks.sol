...
contract PlatziPunksDNA {
    ...
    function deterministic(uint256 _tokenId, address _minter)
        public
        pure
        returns (uint256)
    {
...
contract PlatziPunks is ERC721, ERC721Enumerable, PlatziPunksDNA {
    ...
    using Strings for uint256;
    // Define Counters.Counter
    Counters.Counter private _idCounter;
    // Define the number of tokens to mint
    uint256 public maxSupply;
    mapping(uint256 => uint256) public tokenDNA;

    constructor(uint256 _maxSupply) ERC721("PlatziPunks", "PZP") {
        // Define the maxSupply
    ...
    function mint() public {
        ...
        tokenDNA[current] = deterministic(current, msg.sender);
