...
// File: contracts/SeriousPhilosophyNFTBooks.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract SeriousPhilosophyNFTBooks is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Serious Philosophy NFTBooks";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/q2T3qtWEnjnffo8CLvVf/contract-metadata";
  }
