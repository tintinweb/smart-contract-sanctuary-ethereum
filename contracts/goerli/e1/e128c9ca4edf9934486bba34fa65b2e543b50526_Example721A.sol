...
/// Solmate's gas optimized string lib (using awesome assembly!) is included to handle tokenIds and not necessary for PikaPool integration.

contract Example721A is ERC721A, Pikapatible {

    string public baseURI = "https://pikapool.cool/cryptopikachus/img/";
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        // custom CryptoPikachus hosted by PikaPool, created with Dalle by 0xArceus
        string memory _baseURI = baseURI;
        return string.concat(_baseURI, LibString.toString(tokenId), ".json");
    }
