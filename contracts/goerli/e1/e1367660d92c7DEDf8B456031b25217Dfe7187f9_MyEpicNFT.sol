...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Fucking", "Greatful", "Awesome", "CHAOS", "Strange", "Psycho"];
  string[] secondWords = ["Sound", "Punk", "Core", "Metal", "Pop", "Blues"];
  string[] thirdWords = ["Club", "Team", "Group", "World", "Time", "Man"];
