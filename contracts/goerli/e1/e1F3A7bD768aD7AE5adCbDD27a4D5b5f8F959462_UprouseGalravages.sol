...
/**
 * @title UprouseGalravages
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract UprouseGalravages is Ownable, ERC20Capped {

    constructor() ERC20("Uprouse Galravages","RLRE") ERC20Capped(1000000000 * (10**uint256(decimals())))  { 
     }
