...
contract Token is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public maxTxAmount = initialTotalSupply.mul(300).div(denominator); // 3% of the supply
    uint256 public maxWalletAmount = initialTotalSupply.mul(300).div(denominator); // 3% of the supply

    bool public swapEnabled = false;
    bool public tradingEnabled = false;

    address public devWallet = address(0x69E6d2A67fAf1549504b81B15E27eb26f03bbE87); //  DEV WALLET
