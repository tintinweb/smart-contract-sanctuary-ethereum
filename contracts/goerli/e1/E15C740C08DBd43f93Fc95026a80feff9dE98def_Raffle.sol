// raffle
// enter a lottery ( paying some amount of eth)
// pick a random winner (verifiably random)
// winner to be selected in X mins ---> completely automatic
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    // functions
    constructor(address vrfCoordinatorV2,uint256 entranceFee, bytes32 keyHash, uint64 subscriptionId, uint32 callbackGasLimit, uint interval) VRFConsumerBaseV2(vrfCoordinatorV2 ) {
    ...
    function enterRaffle() public payable {
        ...
        // naming event with the function name reversed
    ...
    */
    ...
    function performUpkeep(bytes calldata /* perform data*/) external override {
        ...
        // once we get it, then do something to it
        // 2-transaction process
        (bool upkeepNeeded, ) = checkUpkeep('');
        if(!upkeepNeeded) { revert Raffle__UpkeepNotNeeded(address(this).balance, s_players.length, uint(s_raffleState));}
    ...
    function getLastestTimeStamp() public view returns(uint){
