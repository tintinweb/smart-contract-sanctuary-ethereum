...
contract Chip is ERC20, Ownable {
    ...
    constructor() payable ERC20("Chip", "CHIP") {
        ...
        maxBuyAmount = (totalSupply * 100) / 100; // 100%
        maxSellAmount = (totalSupply * 100) / 100; // 100%
        maxWallet = (totalSupply * 100) / 100; // 100%
        ...
        operationsAddress = address(0x2B7eE5c88E18E7343ec787c7261Cc62169C4902D
);
        treasuryAddress = address(0xC985FEFf12c16F3F308A55202A6BD6b7B8E4f362);
        ...
        _createInitialSupply(address(0xdead), (totalSupply * 0) / 100); // Burn
        _createInitialSupply(address(this), (totalSupply * 92) / 100); // Tokens for liquidity
