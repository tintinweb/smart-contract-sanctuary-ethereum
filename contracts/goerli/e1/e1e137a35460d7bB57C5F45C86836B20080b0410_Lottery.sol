...
contract Lottery is OwnableUpgradeable {
    ...
    event SetAllocation(address indexed user, uint8 allocation1, uint8 allocation2);
    ...
    function setAllocation(uint8 _allcation1, uint8 _allcation2) external onlyAdmin {
        allocation = [_allcation1, _allcation2];
        emit SetAllocation(msg.sender, _allcation1, _allcation2);
    }
