...
contract CollectionFactory {
    ...
    function CreateCollection(
        ...
        require(blacklist._isPermitted(msg.sender), "CollectionFactory: user is blacklisted");
...
import "contracts/utils/ERC721URIStorage.sol";
import "./utils/Iblacklist.sol";
...
contract Mintable is ERC721URIStorage, ERC721Royalty, AccessControl, Ownable {
        ...
        override
    {
        _tokenURIs[tokenId] = string(
            abi.encodePacked(baseURIPrefix, "", _tokenURI)
        );
    }
