...
contract EarnPass is ERC721Enumerable, Ownable {
     ...
     * Users are allowed to mint as long as they have enough $TOKEN
     */
    function mint() public {
        ...
        require(mintedWallets[msg.sender] == 0, 'ALREADY_MINTED');
        require(MAX_SUPPLY > totalSupply(), 'MAX_SUPPLY_REACHED');

        // Transfer tokens from ERC20 contract to this contract
     ...
     * Users are allowed to verify as long as they have a pass
     */
    ...
    /*
     * Public setMintingPrice function
     * Users are allowed to set the minting price as long are owners
     */
    ...
    /*
     * Public setTokenAddress function
     * Defines a new address for the token use to pay the mint
     */
    ...
    function tokenURI(uint256 _tokenId) public override view returns (string memory) {
        return string.concat(_baseURI(), Strings.toHexString(ownerOf(_tokenId)), '/', Strings.toString(_tokenId));
    }
