...
contract Renaissance is ERC721A, Ownable, ReentrancyGuard, ERC2981, OperatorFilterer721 {
    ...
    function auctionMint (uint256 amount) external payable {
        ...
        uint256 totalPrice = 2 * amount;
        _refundOverPayment(totalPrice);
    ...
    uint32 public auctionSaleStartTime = 0;
    uint256 public constant AUCTION_START_PRICE = 1 ether;
    uint256 public constant AUCTION_END_PRICE = 0.04 ether;
    ...
    function togglePublicSale () external onlyOwner {
        ...
        auctionSaleStartTime = uint32(block.timestamp);
    }
