...
contract PricedMint is BaseMintModuleCloneable, IMintingModule {
    ...
    /// @param _maxClaim The maximum amount of tokens per claim
    ...
    function initialize(
        ...
        __BaseMintModule_init(_admin, address(1), _maxClaim, _mintPrice);
    }
...
contract BaseMintModuleCloneable is Initializable, AccessControlUpgradeable {
    ...
    /// @param _maxClaim The number of tokens that can be minted per unique id
    /// @param _mintPrice The price per token
