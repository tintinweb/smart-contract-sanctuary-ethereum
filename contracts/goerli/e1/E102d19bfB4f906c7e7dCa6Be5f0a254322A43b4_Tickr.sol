...
contract Tickr is ERC20, Ownable {
    ...
    constructor() ERC20("Tickr", "TICKR") {
        ...
        maxWallet = 50_000_001 * 1e9; // 1% from total supply maxWallet
        ...
        marketingWallet = address(0xCD797c79DA583fda122E2AFe246a475E065A7FD8); // set as marketing wallet
        stakingRewardsWallet = address(0x04E970A474b74e8398FBd1375A67f6B25ffA0858); // set as staking rewards wallet
