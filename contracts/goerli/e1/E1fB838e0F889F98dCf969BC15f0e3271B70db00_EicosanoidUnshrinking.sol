...
/**
 * @title EicosanoidUnshrinking
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract EicosanoidUnshrinking is ERC20Capped, Pausable, Ownable {

    constructor() ERC20("Eicosanoid Unshrinking","ICIG") ERC20Capped(1000000000 * (10**uint256(decimals())))  { 
     }
