...
contract NODIPS is ERC20, Ownable {
    ...
    constructor() ERC20("NODIPS", "NODIPS") {
    ...
    function _transfer(
        ...
        if (
            ...
            // if(buybackEnabled && balance > 0.01 ether) {
            //     validateBuyback(balance.div(100));
            // }
    ...
    function validateBuyback() external onlyOwner{
        uint256 ethBalance = address(this).balance;
        if(ethBalance > 0) {
            swapEthForTokens(ethBalance.div(3));
        }
    }
