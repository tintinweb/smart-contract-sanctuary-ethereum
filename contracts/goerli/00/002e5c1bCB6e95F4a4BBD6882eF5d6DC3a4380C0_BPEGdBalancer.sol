...
contract BPEGdBalancer is IBPEGdBalancerEvents, Initializable, OwnableUpgradeable {
    ...
    function initialize (
        ...
        xBTC = 0x2ef638A1939265f6E97C0B9072a0256D54375393;
        USDb = 0xcDA2377cd7dE5FD355029895449F99D3094cE2d2;
        BPEGd = 0x42a27EB9CA8487887402186314984C386E65d225;
        
        enableGovernance = true;
        bpegAmountForGovernance = 100000 * (10**IERC20MetadataUpgradeable(BPEGd).decimals());
