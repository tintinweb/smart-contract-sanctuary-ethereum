...
contract LastofTestona is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Last of Testoooo";
    string private constant _symbol = unicode"LastOFKiddy";
