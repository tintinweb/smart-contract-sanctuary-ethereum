...
contract SAWGames is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(address _paperKeyManagerAddress) ERC721A("SAW Game", "SAW_GAME") {
    ...
    function fiatCanMint() public view returns(bool) {
        require(saleOpen, "Public sale not open");
        return true;
    }

    // Paper eligibilityMethod for fiat minting w/ discount code
    function fiatAllowlistCanMint(string memory nonce) public view returns(bool) {
    ...
    // TODO: Re-enable onlyPaper w/ paperKey
    ...
    function fiatMint(address addr, uint256 quantity) external payable {
    ...
    // TODO: Add onlyPaper
    function fiatAllowlistMint(address addr, uint256 quantity, string memory nonce) external payable {
