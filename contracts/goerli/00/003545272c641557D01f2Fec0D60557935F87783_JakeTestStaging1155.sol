 ...
 * @notice This contract handles minting Jake test staging 1155 tokens.
 */
contract JakeTestStaging1155 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x09A90e2d2fa74Ef1C80d421991973Ab446eB20BC;
    ...
    string public name = "Jake test staging 1155";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeic4us74t2fak7mao2tz4xtl7s5vnjcn2e7laigyl4gbr43moni554/{id}"
        )
    {
