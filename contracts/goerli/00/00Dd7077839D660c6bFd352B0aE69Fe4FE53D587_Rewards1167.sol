...
*/
    constructor(address payable treasury, uint16 royalty, string memory name, string memory symbol) {
        initialize(treasury, royalty, name, symbol);
    }

    function initialize(address payable treasury, uint16 royalty, string memory name, string memory symbol) initializer public {
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC721Upgradeable, AccessControlUpgradeable, ERC721RoyaltyUpgradeable, ERC721EnumerableUpgradeable)
        returns (bool)
    {
