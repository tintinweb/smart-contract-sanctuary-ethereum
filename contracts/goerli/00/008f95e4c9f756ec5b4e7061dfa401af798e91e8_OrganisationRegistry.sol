...
contract OrganisationRegistry is Initializable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    event OrganisationAddedModule(bytes32 indexed orgId, bytes32 module, bool upgradeable);
    ...
    function deployTokenV1(
        ...
        emit OrganisationAddedModule(id, Modules.TOKEN_V1, upgrader != address(0));
    }
    ...
    function deployDAOV1Staking(
        ...
        emit OrganisationAddedModule(id, Modules.DAO_V1_STAKING, upgrader != address(0));
    }
    ...
    function deployDAOV1Governance(
        ...
        emit OrganisationAddedModule(id, Modules.DAO_V1_GOVERNANCE, upgradeable);
    }
    ...
    function deployRewardsEscrowV1(
        ...
        emit OrganisationAddedModule(id, Modules.REWARDS_ESCROW_V1, upgrader != address(0));
    }
    ...
    function deployDAOV1Rewards(
        ...
        emit OrganisationAddedModule(id, Modules.DAO_V1_REWARDS, upgrader != address(0));
    }
    ...
    function deployYFV1Staking(
        ...
        emit OrganisationAddedModule(id, Modules.YF_V1_STAKING, upgrader != address(0));
    }
    ...
    function deployYFV1Pool(
        ...
        emit OrganisationAddedModule(id, Modules.YF_V1_POOL, upgrader != address(0));
    }
    ...
    function deployVestingV1(
        ...
        emit OrganisationAddedModule(id, Modules.VESTING_V1, upgrader != address(0));
    }
    ...
    function deployVestingCliffsV1(
        ...
        emit OrganisationAddedModule(id, Modules.VESTING_CLIFFS_V1, upgrader != address(0));
    }
    ...
    function deployAirdropSimpleV1(
        ...
        emit OrganisationAddedModule(id, Modules.AIRDROP_SIMPLE_V1, upgrader != address(0));
    }
    ...
    function deployAirdropGamifiedV1(
        ...
        emit OrganisationAddedModule(id, Modules.AIRDROP_GAMIFIED_V1, upgrader != address(0));
    }
...
library Modules {
    ...
    bytes32 constant public YF_V1_STAKING = keccak256("yf_v1_staking");
    bytes32 constant public YF_V1_POOL = keccak256("yf_v1_pool");
    bytes32 constant public VESTING_V1 = keccak256("vesting_v1");
    bytes32 constant public VESTING_CLIFFS_V1 = keccak256("vesting_cliffs_v1");
    bytes32 constant public AIRDROP_SIMPLE_V1 = keccak256("airdrop_simple_v1");
    bytes32 constant public AIRDROP_GAMIFIED_V1 = keccak256("airdrop_gamified_v1");
}
