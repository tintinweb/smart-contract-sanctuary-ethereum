    ...
    ReentrancyGuard
{
    ...
    uint256 public price = 0.081 ether;
    ...
    string public notRevealedUri = "ipfs://Qmf2yB9SJ8UB1ewfxEPaM3gDn1qaETaXA8z8j1EUBdYGar/";
    ...
    uint256 public whitelistPrice = 0.054 ether;
    bytes32 public merkleRoot =
        0x8545ca6348e4ebc8c95dc82ca66ffd65b4eb21232ac420aa1a4d08b9284033ce;
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        ...
        require(
            ...
            "You cant mint more,Decrease MintAmount or Wait For Opensea"
        );
        ...
        nonReentrant
    {
        ...
        require(
            _mintAmount + _totalMinted[msg.sender]._whitelist <=
                whitelistMaxMint,
    ...
    function setMaxSuuply(uint256 _newSupply) public onlyOwner{
        require(_newSupply <= 9999,"You cannot add more sushi on the market.");
