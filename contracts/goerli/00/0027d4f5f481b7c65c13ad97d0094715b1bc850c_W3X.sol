...
contract W3X is ERC721A, Ownable {
    ...
    //Constructor
    constructor(address _payments) ERC721A(" Web3 ", "W3X", 20) {
   ...
   function _onlySender() private view {
    ...
    //treasuryMint - Will we need a backend mint function. ?
    ...
    returns (string memory)
  {
    ...
    //owner only - Back end functions by Admin
