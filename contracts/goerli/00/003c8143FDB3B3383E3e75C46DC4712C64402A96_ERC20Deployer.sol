...
contract ERC20Deployer {
    ...
    function createL1Instance(
        ...
        bool success;
        (payload[0], success) = strToUint(tokenName);
        require(success, "Cannot parse token name");
        (payload[1], success) = strToUint(tokenSymbol);
        require(success, "Cannot parse token symbol");
