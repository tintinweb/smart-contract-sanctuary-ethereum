...
contract TradeImpl {
    ...
    function lock(uint _amount, address _addr) public {
        IERC20 _token = IERC20(_addr);
        _token.transferFrom(msg.sender, address(this), _amount);
    }

    function unlock(address to, uint amount, address addr) public {
        require(msg.sender == admin, "only admin is eligible to do unlock");
        IERC20 _token = IERC20(addr);
