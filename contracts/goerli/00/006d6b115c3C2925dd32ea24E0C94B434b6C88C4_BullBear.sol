    ...
    */
    ...
    function performUpkeep(bytes calldata /* performData */ ) external override {
        ...
        if ((block.timestamp - lastTimeStamp) > interval ) {
            ...
            //update the nft uri according to the currentMarketTrend enum value
    ...
    // This function is overides order by interface VRFConsumerBaseV2 
