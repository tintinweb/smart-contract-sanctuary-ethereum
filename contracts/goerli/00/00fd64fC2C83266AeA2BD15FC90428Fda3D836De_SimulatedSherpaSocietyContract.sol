...
//   \__ \/ / __ `__ \/ / / / / __ `/ __/ _ \/ __  / 
//  ___/ / / / / / / / /_/ / / /_/ / /_/  __/ /_/ /  
// /____/_/_/_/_/ /_/\__,_/_/\__,_/\__/\___/\__,_/   
//   / ___// /_  ___  _________  ____ _              
//   \__ \/ __ \/ _ \/ ___/ __ \/ __ `/              
//  ___/ / / / /  __/ /  / /_/ / /_/ /               
// /____/_/ /_/\___/_/  / .___/\__,_/                
//    _____            /_/    __                     
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x9a7752F2Db26bd0c4D37fa1D35b6B42EEFAABa1f,0x6c7B764E89DFdf3344f0E94Dd2490cA18eA57743,0x3b8209701c3C5cca477917f12781c1B683df56A0,0x623b6209B0fB669822c6B804676E51D91A93E0C5];
  address public erc20Payable = 0x9a7752F2Db26bd0c4D37fa1D35b6B42EEFAABa1f;
  uint256[] public payableFees = [55,15,15,15];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 201) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbDv1VW2a17AY1Tnz6d66coGcxKfh8Yq5zRuvrqBiZ24G/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/nC4Mhb0tLDByF92nkpQ9/contract-metadata";
  }
...
// File: contracts/SimulatedSherpaSocietyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SimulatedSherpaSocietyContract is RamppERC721A {
    constructor() RamppERC721A("Simulated Sherpa Society", "3XS"){}
}