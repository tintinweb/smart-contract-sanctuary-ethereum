...
contract MaPfpRoyaltiesGoerli is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  */
  function supportsInterface(bytes4 interfaceId) public view override(ERC2981, ERC721A, IERC165) returns (bool) {
