            ...
            bytes(
                string(
                    ...
                    abi.encodePacked(
                        ...
                        '","attributes":[{"trait_type":"Libro","value":"', userI.libro.toString(), '"},{"Habitaciones":"District","value":"', userI.rooms.toString(), '"},{"trait_type": "Ubicacion","value":"', userI.location, '"}]}'
                    )
                )
            )
        );
