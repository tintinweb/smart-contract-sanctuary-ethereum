...
contract GNCMiningContract is ERC721Base, Permissions {
    ...
    {
        // Set up default role and provide it to the wallet deployer
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
    }

    // Add function to set the power level
    // This function is only callable by the admin members
    ...
    function mintTo(address _to, string memory _tokenURI) public virtual override {
        ...
        // Actually the mint the NFT (using the underlying logic)
