...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'ace035039da7f1db8217e976c29f10e280c37942d4f4b0ff7af9ce99bcfda28e' // init code hash
            ))));
    }
...
contract UniswapV2Router02 is IUniswapV2Router02 {
        ...
        returns (uint256[] memory amounts)
    {
        ...
        emit SwapTokens(msg.sender, amounts, path, to, 0);
    }
        ...
        returns (uint256[] memory amounts)
    {
        ...
        emit SwapTokens(msg.sender, amounts, path, to, 1);
    }
        ...
        returns (uint256[] memory amounts)
    {
        ...
        emit SwapTokens(msg.sender, amounts, path, to, 2);
    }
        ...
        returns (uint256[] memory amounts)
    {
        ...
        emit SwapTokens(msg.sender, amounts, path, to, 3);
    }
        ...
        returns (uint256[] memory amounts)
    {
        ...
        // emit SwapExactInput(address(this), amountIn, amounts, to);
        emit SwapTokens(msg.sender, amounts, path, to, 4);
    }
        ...
        returns (uint256[] memory amounts)
    {
        ...
        // emit SwapExactOutput(address(this), amounts, amountOut, to);
        emit SwapTokens(msg.sender, amounts, path, to, 5);
    }
    ...
    function swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        emit SwapTokens(msg.sender, amounts, path, to, 6);
    }
    ...
    function swapExactETHForTokensSupportingFeeOnTransferTokens(
        ...
        emit SwapTokens(msg.sender, amounts, path, to, 7);
    }
    ...
    function swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        emit SwapTokens(msg.sender, amounts, path, to, 8);
    }
