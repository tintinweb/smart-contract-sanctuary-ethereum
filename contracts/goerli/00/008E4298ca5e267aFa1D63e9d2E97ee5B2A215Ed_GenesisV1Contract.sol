    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiesdkoxlwjfeprdy6ci4jtymrqrbv6ncipkm3tl6fbv2nueml2ery/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5PYa3VSKySyF0KLUmPkT/contract-metadata";
  }
...
// File: contracts/GenesisV1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GenesisV1Contract is RamppERC721A {
    constructor() RamppERC721A("GenesisV1", "SNEK"){}
}