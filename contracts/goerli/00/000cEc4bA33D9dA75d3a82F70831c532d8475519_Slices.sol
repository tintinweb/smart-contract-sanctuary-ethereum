...
contract Slices is ERC1155 {
  ...
  mapping(uint => mapping(address => uint)) private mMintedPerWallet;
  ...
  modifier onlyOwnerOrDev() {
    require(msg.sender == mOwner || msg.sender == mDev, "only the dev or owner can call this");
    _;
  }
  ...
  function transferOwner(address aNewOwner) public onlyOwner {
    require(aNewOwner != address(0), "can't set owner to null address");
    mOwner = aNewOwner;
  }
  ...
  {
    return (mOwner, (aSalePrice * mRoyaltyBasisPoints) / 10000);
  }
