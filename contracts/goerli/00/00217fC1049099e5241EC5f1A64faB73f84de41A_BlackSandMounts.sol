    ...
    ReentrancyGuard
{
      ...
      string private baseTokenURI = "cultcontent.wtf/blacksand/uri/";
 ...
 */
 function preSaleAdoption(bytes32[] memory merkleProof, uint adoptCount) validateAdoption(adoptCount) validatePreSaleAction nonReentrant external payable {
