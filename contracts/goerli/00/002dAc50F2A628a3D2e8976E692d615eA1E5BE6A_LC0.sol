...
contract ERC20 is Context {
     ...
     */
    // 'indexed' helps with filtering the logs to find the desired data
        ...
        returns (bool)
    {
        ...
        uint256 newAllowance = allowance(_msgSender(), spender) - subtractedValue;
        _approve(_msgSender(), spender, newAllowance);
        return true;
    }
    ...
    function _transfer(
        ...
        // TODO
        // the zero address (0x00...0000) is obtained with address(0)
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenFID", "LCFID") {}
}