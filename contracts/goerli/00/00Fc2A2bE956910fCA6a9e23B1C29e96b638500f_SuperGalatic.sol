 ...
 */
contract SuperGalatic is Initializable, OwnableUpgradeable, ERC721EnumerableUpgradeable, ERC721HolderUpgradeable {
     ...
     */
    event mintGensisNFT(uint256 nftId, address owner);
     ...
     */
    function createGenesis(address receiver) external {        
        uint256 newID = totalSupply() + 1;        
        _safeMint(receiver, newID);
        emit mintGensisNFT(newID, receiver);
    }
}
