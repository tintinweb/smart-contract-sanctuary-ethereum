...
contract Distribution {
    ...
    function addProfits(uint256 _projectID) external payable {
        ...
        projectTotalProfits[_projectID] += msg.value;
        
        distributeProfits(_projectID, msg.value);
    }
    ...
    function distributeProfits(uint256 _projectID, uint256 _amount) internal {
        ...
        for (uint256 x = 0; x < usersAddress.length; x++) {
            ...
            valueOfRewardsPerUserBeingClaimed[usersAddress[x]] += amount;

            (bool sent, ) = usersAddress[x].call{value: amount}("");
...
contract Bridge is ERC721A, Ownable {
    ...
    constructor(
        ...
        BridgeFactoryAddress = _factoryAddress;
    ...
    function preMint(
        ...
        _mint(_quantity, msg.value, _companyID, _projectId);
    }
    ...
    function _mint(
        ...
        for (uint256 x = 0; x < mintingDistributionRecipientsLength; x++) {
            ...
            (bool sent, ) = mintingDistributionRecipients[x].call{value: _amount}("");
            require(sent, "FAILED TO SEND ETHER");
