...
contract WTCStaking is Context, Ownable {
    ...
    bool public classicstaking = false; //bool to handle classic staking
    ...
    uint[] internal tokens; //Array to hold current staked tokens -> For Anti-game
    ///////////////////////////////////////////////////
  ...
  constructor () public {
      ...
      tokenslist[8888] = 0; //Set the initial index to 0
  ...
  ////////////STAKING FUNCTIONS//////////
   ...
   function removeStake() public
   {
       ...
       tempuser = wrappedcompanion(wrappedcompnft).ownerOf(tokenslist[i]);
       if(tempuser==msg.sender)
       {
           nftowners[tokenslist[i]] = 0x0000000000000000000000000000000000000000;
           //remove token from Array as its not being staked
           tokencount = tokencount.sub(1); // Minus a the count
 ...
 //Function to move funds back out to Token Contract//
  ...
  function returnTokens(uint _amountOfCTKN,address _reciever) public onlyOwner{
