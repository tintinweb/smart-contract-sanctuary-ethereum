...
contract Jar {
    ...
    /**
     * @notice Revert reason when the Dai balance of this contract is zero and `empty` is called.
     */
    error AlreadyEmpty();
     ...
     * @dev Requires `msg.sender` to have previously `approve`d this contract to spend at least `wad`.
     * @dev This effectively burns ERC-20 Dai and credits it to the internal Dai balance of the `vow` in the Vat.
     * @param wad The amount to pull.
     */
    function tip(uint256 wad) external {
