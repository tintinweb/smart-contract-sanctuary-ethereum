...
contract ChokinfoLottery {
    ...
    uint256 public PROJECT   = 10; /** revenue pour le owner 10 = 1% **/
    ...
    uint256 public LOTTERY_PERCENT = 995; /** 95% du CKIO sera envoyé au gagnant **/
    uint256 public LOTTERY_STEP = 24 * 60 * 60; /** Loterie se lance toute les 24H **/
