...
contract BridgeEth is Ownable, ReentrancyGuard {
    ...
    function lockToken(
        ...
        require(tokensAvailableFromSourceChain != SourceChainTokensAvailable.ETH && tokensAvailableFromSourceChain != SourceChainTokensAvailable.BNB && tokensAvailableFromDestinationChain != DestinationChainTokensAvailable.BNB, "Invalid source token");
    ...
    function transferEth(
        ...
        emit EtherTransferedToDestinationChain(address(this), recipient, value);
    ...
    function transferToken(
        ...
        require(recipient != address(0), "Address cannot be 0");
        require(amount != 0, "Insufficient amount");
        emit TokenTransferedToDestinationChain(tokenAddress, address(this), recipient, amount);
        token.transfer(
            recipient,
            amount
        );
    ...
    function lockTokenToContract(
        ...
        require(tokenAddress != address(0), "Address cannot be zero");
        require(amount != 0, "Insufficient amount");
        emit TokenTransferedToDestinationChain(tokenAddress, msg.sender, address(this), amount);
        token.transferFrom(
            msg.sender,
            address(this),
            amount
