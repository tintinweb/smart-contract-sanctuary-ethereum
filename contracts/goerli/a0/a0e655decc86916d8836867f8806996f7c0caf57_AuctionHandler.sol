    ...
    IERC721ReceiverUpgradeable
{
    ...
    function createMintAuction(
        ...
        try salesHandler.getListing(collection, itemID) {
            revert("sale listing exists");
        } catch {
    ...
    function createAuction(
        ...
        emit AuctionCreated(collection, itemID, duration, reservePrice);
    ...
    function placeBid(
        ...
        emit Bid(collection, itemID, _msgSender(), newBid);
    ...
    function cancelAuction(ICollection collection, uint256 itemID) external {
        ...
        delete auctions[auctionID];
        emit AuctionCancelled(collection, itemID);
