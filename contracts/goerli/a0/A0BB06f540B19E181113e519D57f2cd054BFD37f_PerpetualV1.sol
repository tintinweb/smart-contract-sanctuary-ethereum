    ...
    P1Settlement
{
    ...
    */
        ...
        nonReentrant
    {
        ...
        // Send the tokens.
        IERC20(_TOKEN_).transfer(msg.sender, amountToWithdraw);
    ...
    P1Getters
{
        ...
        nonReentrant
    {
        ...
        IERC20(_TOKEN_).transferFrom(msg.sender, address(this), amount);
        ...
        nonReentrant
    {
        ...
        IERC20(_TOKEN_).transfer(destination, amount);
    ...
    P1FinalSettlement
{
    ...
    {
        return trades[0].data;
    }

    function getPrice(
        address[] calldata accounts,
        TradeArg[] calldata trades
    ) noFinalSettlement external returns (uint256)
    {
        P1Types.Context memory context = _loadContext();
