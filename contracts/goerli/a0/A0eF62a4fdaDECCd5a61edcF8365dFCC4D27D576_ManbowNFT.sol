...
contract ManbowNFT is Initializable, ContextUpgradeable, ERC3525BurnableUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize(
        ...
        __ManbowNFT_init(name_, symbol_, decimals_);
    }

    // solhint-disable-next-line
    function __ManbowNFT_init(
        string memory name_,
        string memory symbol_,
        uint8 decimals_
    ) internal onlyInitializing {
    ...
    function mintValue(uint256 tokenId_, uint256 value_) public virtual override {
        ERC3525Upgradeable._mintValue(tokenId_, value_);
    }
}