    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public maxFreePerWalletWl = 1;
    ...
    modifier priceCompliance(uint256 quantity, bool isForWhitelist) {
        ...
        uint256 totalCost = paidCount * currentPrice;
        require(msg.value >= totalCost, "Insufficient funds");
        _;
    }

    modifier mintCompliance(uint256 quantity, bool isForWhitelist) {
        uint256 currentMaxPerWallet = isForWhitelist ? maxPerWalletWl : maxPerWallet;
        ...
        require(
            _numberMinted(msg.sender) + quantity <= currentMaxPerWallet,
