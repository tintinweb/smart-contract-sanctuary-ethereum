...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
     ...
     * @dev See {_setURI}.
     */
    constructor(string memory baseUri, address marketplace_) {
        string memory uri_ = string(
            abi.encodePacked(baseUri, address(this), "/")
        );
    ...
    function _mint(
        ...
        emit PermanentURI(
            string(abi.encodePacked(_uriBase, Strings.toString(id))),
            id
        );
    ...
    function _mintBatch(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            ...
            emit PermanentURI(
                string(abi.encodePacked(_uriBase, Strings.toString(ids[i]))),
                ids[i]
            );
        }
