...
// ERC2981 implements royalties

contract DDTestNFT is ERC721AQueryable, Ownable, DefaultOperatorFilterer, IERC4906, ERC2981 {
    ...
    uint256 public allowListMintPrice = 0.04 ether;
    ...
    constructor(uint64 _startTime) ERC721A("DD Test NFT 4", "DDT4") {
        ALLOWLIST_START_TIME = _startTime;
        PUBLIC_START_TIME = _startTime + 7200; // 7200 = 2 hours
    ...
    // TODO: This won't work until a receive function is defined
    ...
    //    Enforce royalty fees via contract by restricting marketplaces
