...
contract ERC20 is Context {
    ...
    {
        // TODO use _transfer
        require(to != address(0) && balanceOf(_msgSender()) >= amount);
    ...
    function transferFrom(
        ...
        require(balanceOf(from) >= amount && allowance(from, _msgSender()) >= amount);
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenLK", "LCLK") {}
}