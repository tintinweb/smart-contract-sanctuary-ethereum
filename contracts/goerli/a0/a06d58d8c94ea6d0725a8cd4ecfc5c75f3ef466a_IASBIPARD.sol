...
contract IASBIPARD {
    ...
    IAS[10] public attendedParticipants;
    ...
    function enroll(string memory _name, string memory _batch, uint8 _rank) public {
        require(isWhiteListed[msg.sender], "You are not whitelisted");
        uint256 index = attendedParticipants.length;
        attendedParticipants[index] = IAS({
            addr: msg.sender,
            name: _name,
            batch: _batch,
            rank: _rank
