...
contract Token is Ownable, ERC721AQueryable, ReentrancyGuard, PaymentSplitter {
    ...
    uint256 public eligibleAddressesAmountCount = 0;
     ...
     */
     function setEligebleAddresses(uint256 quantityPerAddress, address[] memory recipients) external onlyOwner {
        ...
        // add to counter
        eligibleAddressesAmountCount = eligibleAddressesAmountCount + (quantityPerAddress * recipients.length);
     }
     ...
     */
     function claimMint() external callerIsUser {
        ...
        // remove from counter
        eligibleAddressesAmountCount = eligibleAddressesAmountCount - quantity;
     }
     ...
     * Get unclaimed count
     */
    function unclaimedCount() internal view virtual returns (uint256) {
        return eligibleAddressesAmountCount;
    }

    /**
     * Get unclaimed count by sender
     */
    function getSendersUnclaimedCount() internal view virtual callerIsUser returns (uint256) {
        return eligibleAddressesAmount[msg.sender] | 0;
    }
