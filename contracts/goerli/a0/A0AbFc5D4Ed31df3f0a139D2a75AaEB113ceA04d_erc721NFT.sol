...
contract erc721NFT is ERC721, Ownable {
    ...
    function safeMint(uint256 _amount) external payable {
        require(msg.value >= nftPrice * _amount, "Incorrect price");
        require((userBalance[msg.sender] += _amount) <= maxPerUser, "you can't mint more than 3 nft");
        require((_amount += nftMinted) >= MaxSupply, "Max supply reached");
