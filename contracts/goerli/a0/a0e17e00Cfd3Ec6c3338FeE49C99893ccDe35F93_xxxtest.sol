...
contract xxxtest is
    ...
    // test Contract Addresss for Mint /unneaded in test contract. dummy
    NftContract public cNft =
        NftContract(0xa2B9f8336a3923291249EA7E19f03ef727cD8f1E);
...
//bitiocracy
    ...
    uint256 public MAX_PRESALE_MINTS_PLUS_ONE = 3;  //actual value 2 for public sale tx s
