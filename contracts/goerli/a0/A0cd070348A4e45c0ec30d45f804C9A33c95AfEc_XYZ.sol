...
contract XYZ is Ownable {
    ...
    event CompleteTaskRequestEvent(address tasker, uint256 taskId, address principal, uint256 requestId);
    ...
    function completeTask(address _principal, uint256 _taskId, uint256 _requestId, string calldata _proofLink) external {
        ...
        emit CompleteTaskRequestEvent(msg.sender, _taskId, _principal, _requestId);
    }
