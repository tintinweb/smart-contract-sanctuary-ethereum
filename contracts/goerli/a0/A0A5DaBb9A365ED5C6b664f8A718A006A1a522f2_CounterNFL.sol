...
contract CounterNFL is ERC721URIStorage, Ownable {

    /**
     * @dev
     * Auto increament token Id
     */
    ...
    /**
     * @dev
     * Log who set what URI to which tokenId on URI setup
     */
     ...
     * @dev tokenId changeable only when minting nft
     */
    constructor() ERC721("CounterNFL", "CNTNFL") {}
