...
contract MergeNFT is ERC721, Ownable {
    ...
    event MergeNFT_Deployed(address owner, address mergeCanvasContractAddress, string canvasUrl, uint16 opacity, uint256 canvasDimension);
        ...
        ERC721("MergeNFT", "MTK")
    {
        ...
        CANVAS_DIMENSION = uint256(mergeCanvasContract.CANVAS_DIMENSION());
                    ...
                    Base64.encode(
                        bytes(
                            string.concat(
                                ...
                                '", "description":"An NFT based on SVG!", "attributes":"", ',
                                ' "image":"https://neotokyos2.sfo3.cdn.digitaloceanspaces.com/citizen_images_png/3095.png", ',
                                '"animation_url": "https://neotokyos2.sfo3.cdn.digitaloceanspaces.com/citizen_images/3095.svg"',
                                '}'
                            )
                        )
                    )
    ...
    //                             '{"name":"',
    //                             "SVG NFT", // You can add whatever name here
    //                             '", "description":"An NFT based on SVG!", "attributes":"", "image_data":"',
    //                             _imageURI,
    //                             '"}'
    //                         )
    //                     )
