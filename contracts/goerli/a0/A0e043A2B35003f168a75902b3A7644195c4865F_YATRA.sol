...
contract YATRA is IYATRA, ERC721Enumerable, Ownable, Pausable {
    ...
    // mapeao para las wallet que ya mintearon
    ...
    string public baseUri =
        "https://gateway.pinata.cloud/ipfs/QmcXH92Ud9KoS8WbhMuyVBWMjiyAYMiN5q5Y9CZ2LQbtd1";
    ...
    constructor() ERC721("YATRA", "YATRA") {
        contractUri = "https://gateway.pinata.cloud/ipfs/QmVBhqsGSCY1Yd8a3rqDAnBEmFFBbzT7AAz558QsDFRFcZ"; // json contract metadata para OpenSea     
        Pausable._pause();
    } 
