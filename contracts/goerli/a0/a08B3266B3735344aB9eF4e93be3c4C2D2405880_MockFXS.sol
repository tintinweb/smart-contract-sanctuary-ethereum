...
contract MockFXS is ERC20 {
    ...
    constructor(IFRAX _frax) ERC20("Frax Share", "FXS") {
        admin = msg.sender;
        FRAX = _frax;
    }

    modifier onlyPools() {
        require(FRAX.frax_pools(msg.sender) == true, "ONLY_POOLS");
        _;
    }

    function setFrax(IFRAX _frax) external {
        FRAX = _frax;
    }
