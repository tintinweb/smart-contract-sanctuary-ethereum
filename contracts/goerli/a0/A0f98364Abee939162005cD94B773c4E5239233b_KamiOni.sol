...
contract KamiOni is ERC721A, RevokableDefaultOperatorFilterer, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, string memory defaultTokenURI) 
...
abstract contract RevokableOperatorFilterer is OperatorFilterer {
    ...
    function enableOperatorFilterRegistry() external {
        ...
        _isOperatorFilterRegistryRevoked = false;
    }
