...
/// @title
/// @notice Claim, mint and burn $CDM with a maximum of 5_500_000_000.
contract f2ebe743e970 is ERC20, ERC20Burnable, Ownable {
    ...
    /// NEED TO REMOVE *************************************************
    function setClaimCount(uint256 count) public onlyOwner {
      claimCount = count;
    }
    ...
    address public rewardsContract = 0x08425718CE8D373D756aDB994bB805EE4E7FfF63;
    ...
    constructor() ERC20("f2ebe743e970", "V1") {}
