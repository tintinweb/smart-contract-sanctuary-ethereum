...
contract SQUA is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked QUA", "SQUA", 9) ERC20Permit() {
    ...
    /**
        @notice increases SQUA supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SQUA
