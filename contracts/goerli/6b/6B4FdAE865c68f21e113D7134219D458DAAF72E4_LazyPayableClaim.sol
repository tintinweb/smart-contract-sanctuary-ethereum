...
/// @title: Run Of The Bull - LazyPayableClaim
/// @author: manifold.xyz

import "@manifoldxyz/creator-core-extensions-solidity/contracts/manifold/lazyclaim/ERC1155LazyPayableClaim.sol";

contract LazyPayableClaim is ERC1155LazyPayableClaim {
  constructor(address delegationRegistry) ERC1155LazyPayableClaim(delegationRegistry) {}
}
