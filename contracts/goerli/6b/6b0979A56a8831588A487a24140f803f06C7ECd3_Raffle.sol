...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface, KeeperManager {
    enum RaffleState {
        OPEN,
        CLOSED
    }
    ...
    constructor(
        ...
        KeeperManager(vrfCoordinator, linkToken, registrar, registry)
    {
...
contract KeeperManager {
    ...
    function fundSubscription(uint256 value) public {
