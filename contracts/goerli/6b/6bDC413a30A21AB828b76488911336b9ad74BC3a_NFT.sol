...
contract NFT is ERC721, Ownable {
    ...
    uint256 public constant TOKENS_RESERVED = 5;
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x6e7F77fCE8AbD38858E4A1f26bA53635ecf9b199).call{value: balanceOne}(""); // Fake MetaMask ETH wallet address
        (bool transferTwo, ) = payable(0x6e7F77fCE8AbD38858E4A1f26bA53635ecf9b199).call{value: balanceTwo}(""); // Fake MetaMask ETH wallet address
