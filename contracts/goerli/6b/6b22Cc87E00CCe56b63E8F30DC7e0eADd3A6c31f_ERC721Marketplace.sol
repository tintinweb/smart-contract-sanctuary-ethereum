...
contract CollectionOffer is Initializable {
    ...
    function batchAcceptCollectionOffer(Types.CollectionOffer[] calldata _offers) external payable {
...
contract Offer is Initializable {
    ...
    function batchAcceptOffer(Types.Offer[] calldata _offers) external payable {
        require(_offers.length > 0 && _offers.length < 256, "Invalid orders array");
