...
contract LootBoxesTestnet is ERC1155Holder, Ownable, ReentrancyGuard {
    /// @notice Cooldown period for power replenishment
    uint256 public constant POWER_COOLDOWN = 1 hours;
    ...
    function buyMethBag(uint256 amount, address to) external payable {
        uint256 price = bagPrice[amount];
