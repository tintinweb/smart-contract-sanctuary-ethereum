...
// 卵卵卵卵卵卵卵卵卵卵
contract CBE is ERC721, Ownable {
...
//    ENSResolver fancyFrenFinder;
    ...
    string collectionDescription = "CBE? CBE. CB(R)EEEEEEEEEEEE";
    string collecImg = "";
    string externalLink = "yeetilydeet.wtf";
...
//    }
    ...
    function contractURI() public view returns (string memory) {
        return string(
            abi.encodePacked(
                "data:application/json;utf8,{\"name\":\"CBE\",",
