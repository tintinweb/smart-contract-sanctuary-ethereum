...
contract MLKINU is ERC20, Ownable {
    ...
    constructor() ERC20("MLK INU", unicode"🗣️MLK") payable {
    	...
    	marketingWallet = address(0x99Eac8D7f969485e1125fE483f2638155D60f7d6); // set as Marketing wallet
        devWallet = address(0xCce6c966054395C35f8CA1FC6f39bC410f7DC0f1); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x99Eac8D7f969485e1125fE483f2638155D60f7d6, true);
        excludeFromFees(0xCce6c966054395C35f8CA1FC6f39bC410f7DC0f1, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x99Eac8D7f969485e1125fE483f2638155D60f7d6, true);
        excludeFromMaxTransaction(0xCce6c966054395C35f8CA1FC6f39bC410f7DC0f1, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xCce6c966054395C35f8CA1FC6f39bC410f7DC0f1,
            block.timestamp
        );
    }
