...
contract Crowdsale is Ownable {
    ...
    //uint256 public constant INITIAL_CLAIMABLE = 0 * 10 ** 18; // The amount of tokens claimable upon activation
    uint256 private constant VESTING_DURATION = 60 * 5; //365 days; // The period of time (in seconds) over which the vesting occurs
    ...
    mapping(address => Grant) public grants; //PRIVATE
    ...
    event VestingStarted(uint256 indexed timestamp);
    ...
    //INTERNAL
    function setGrant(address _recipient, uint256 _amount) public {
