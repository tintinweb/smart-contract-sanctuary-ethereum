...
contract PFP is ERC721A, OperatorAccessControl, ReentrancyGuard {
    ...
    */
    ...
    function superMint(
        ...
        require(totalMintCount < 30, "error: 10002 Limit 30");

        //支付数量不足
        require(
            msg.value == _superMintPrice * totalMintCount,
            "error:10003 msg.value is incorrect"
        );
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            require(
                ...
                "error:10004 No owner"
            );

            //超级锻造地址配置数量需大于0
            require(
                superAddress[contractAddress] > 0,
                "error:10005 Contract cannot mint"
            );
            ...
            require(
                superAddressToken[contractAddress][tokenId] + mintCount <=
                    superAddress[contractAddress],
                "error:10006 Greater than maximum quantity"
            );
