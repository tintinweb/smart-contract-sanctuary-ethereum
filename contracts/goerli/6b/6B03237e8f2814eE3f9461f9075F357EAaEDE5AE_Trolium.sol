...
contract Trolium is ERC20, ERC20Burnable, Pausable,ReentrancyGuard, AccessControl, ERC20FlashMint, ERC20Permit, DSNote {
    ...
    function burn(uint256 amount) public virtual override 
        ...
        nonReentrant
     {
        require(msg.sender != address(0), "Trolium: burn from the zero address");
        require(amount > 0, "Trolium: amount must be greater than zero");
        require(balanceOf(msg.sender) >= amount, "Trolium: burn amount exceeds balance");
        require(!paused(), "Trolium: token transfer while paused");
    ...
    function pull(address usr, uint wad) external { // Pulls TROL tokens from user
