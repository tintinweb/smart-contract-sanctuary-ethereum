...
// winner to be selected evere x minutes -> completly automated
...
contract Raffle is VRFConsumerBaseV2 {
    ...
    RuffleState private s_raffleState;

    event RaffleEnter(address indexed sender);
    event RequiestedRuffleWinner(uint256 requestId);
    ...
    constructor(
        ...
        s_raffleState = RuffleState.OPEN;
    ...
    function enterRaffle() external payable {
        ...
        if (s_raffleState != RuffleState.OPEN) {
    ...
    function checkUpkeep(
        ...
        bool isOpen = (RuffleState.OPEN == s_raffleState);
    ...
    function performUpkeep(bytes calldata /* performData */) external {
        ...
        s_raffleState = RuffleState.CALCULATING;
        uint256 requiesId = i_vrfCoordinator.requestRandomWords(
            i_gasLine,
            i_subscriptionId,
        ...
        emit RequiestedRuffleWinner(requiesId);
    }
