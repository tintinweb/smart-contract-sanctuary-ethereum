...
contract ATGSample6 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  uint256 public cost;
  uint256 public discountRate = 60;
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool os, ) = payable(0x8EDf649c896A7e762Dd1f34d099cAd54940De79f).call{value: address(this).balance}("");
    require(os);
    // =============================================================================
  }
