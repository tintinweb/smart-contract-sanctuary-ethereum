...
// File contracts/ERC20Shogun.sol

pragma solidity ^0.8.4;
string constant TOKEN_NAME = "SHOGUN Token";
string constant TOKEN_SYMBOL = "SGN";
uint256 constant INITIAL_VOLUME = 1000;
uint8 constant DECIMALS = 0;

contract ERC20Shogun is ERC20, ERC20Burnable, OwnerOperator {
    constructor() ERC20(TOKEN_NAME, TOKEN_SYMBOL) OwnerOperator() {
        _mint(msg.sender, INITIAL_VOLUME * 10**decimals());
    }
