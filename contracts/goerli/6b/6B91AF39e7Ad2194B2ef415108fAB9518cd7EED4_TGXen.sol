...
contract TGXen is ERC20, IERC165, IBurnRedeemable, Ownable { 
	...
	IBurnableToken public XEN_ADDRESS = IBurnableToken(0xca41f293A32d25c2216bC4B30f5b0Ab61b6ed2CB);
	address public TGC_ADDRESS = address(0x1a3855143c423b4fEB5FF8ce23b5aF968eB15Fb7);
	...
	uint256 public TGXen_PER_TGC = 100000000000000000000;
	uint256 public LAUNCH_TIME = 1685716566;
	...
	function burnTGC(uint256 amount) external {
	   ...
	   {
	       uint256 allocationDay = currentDay.add(currentDay.mul(3)).add(1);
		   if(mapTGXenClaim[_msgSender()][allocationDay].amount == 0)
		   {
		       claimCount[_msgSender()] += 1;
			   claimDays[_msgSender()].push(allocationDay);
		   }
	       mapTGXenClaim[_msgSender()][allocationDay].amount += amount.mul(TGXen_PER_TGC).div(10**18); 
           mapTGXenClaim[_msgSender()][allocationDay].hasCollected = false;
		   totalTGXenUnclaimed += amount.mul(TGXen_PER_TGC).mul(2).div(10**18);
	   }
