...
contract PutNFTOption is Ownable {
    ...
    constructor() {
        s_whitelistedAddresses[0x34d85c9CDeB23FA97cb08333b511ac86E1C4E258] = true; //otherdeed
        s_whitelistedAddresses[0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D] = true; //boredapeyachtclub
        s_whitelistedAddresses[0x49cF6f5d44E70224e2E23fDcdd2C053F30aDA28B] = true; //cloneX
        s_whitelistedAddresses[0x23581767a106ae21c074b2276D25e5C3e136a68b] = true; //proof-moonbirds
        s_whitelistedAddresses[0x394E3d3044fC89fCDd966D3cb35Ac0B32B0Cda91] = true; //renga
        s_whitelistedAddresses[0x8a90CAb2b38dba80c64b7734e58Ee1dB38B8992e] = true; //doodle
        s_whitelistedAddresses[0xbCe3781ae7Ca1a5e050Bd9C4c77369867eBc307e] = true; //goblintownwtf
        s_whitelistedAddresses[0x64Ad353BC90A04361c4810Ae7b3701f3bEb48D7e] = true; //renga-black-box
        s_whitelistedAddresses[0x1A92f7381B9F03921564a437210bB9396471050C] = true; //cool-cats-nft
        s_whitelistedAddresses[0xd1258DB6Ac08eB0e625B75b371C023dA478E94A9] = true; //digidaigaku
        s_whitelistedAddresses[0xED5AF388653567Af2F388E6224dC7C4b3241C544] = true; //azuki
    }
    ...
    */
    ...
    {   
        ...
        require(msg.value >= (_strikePrice), "your inputted amount is not enough");
    ...
    bytes memory _signature) public payable{
        ...
        bool verified = verify(_buyer, _assetAddress, _strikePrice, _premium, _duration, _effectiveDate, _salt, _signature);
        require(verified == true, "wrong signature!");
        require(s_invalidSignatures[_signature] != true, "offer no longer available.");
        ...
        uint256 _contractID = this.setUpContract(_assetAddress,  _strikePrice,  _premium,  _duration);
    ...
    function exerciseContract(uint256 _contractID, uint256 _nftID) public returns(bool){
        ...
        require(success1, "transfer commission failed.");
        ...
        uint256 strikeAmt = (c.order.strikePrice) - commission;

        (bool success3, ) = (address(c.buyer)).call{value: strikeAmt}("");
        require(success3, "transfer commission failed.");
        (bool success4, ) = owner().call{value: strikeCommission }("");
        require(success4, "withdraw failed.");
