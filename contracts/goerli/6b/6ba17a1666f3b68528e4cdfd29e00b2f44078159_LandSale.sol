...
contract LandSale {
    ...
    ITApeCoin private ApeCoinContract;
    ...
    constructor(string memory _tokenType, address apeCoin) {
        owner = msg.sender;
        ...
        ApeCoinContract = ITApeCoin(apeCoin);
    }
    ...
    function buyLandViaApeCoin(
        ...
        ApeCoinContract.transferFrom(msg.sender, address(this), amount);
