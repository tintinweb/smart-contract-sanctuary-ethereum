...
contract WrappedKevins is ERC721, ERC721Holder, Ownable {
    ...
    constructor() ERC721("Wrapped Pixelmon", "WPXLMN") {}
        ...
        return
            string(
                abi.encodePacked(
                    '{"name": "Kevin #',
                    tokenId.toString(),
                    '", "description": "Wrapped Kevins is a collection of arguably the most significant NFTs in all of history.", "image":"',
                    kevinImage,
    ...
    // function setKevinImage(string memory uri) external {
    //     kevinImage = uri;
    // }
}
