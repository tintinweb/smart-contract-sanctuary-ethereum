...
abstract contract ContractInfo {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 30) / 1000; // (_totalSupply * 10) / 1000 [this equals 3%]
    uint256 public _maxWalletHoldAmount = (_totalSupply * 30) / 1000; //
...
contract test is ContractInfo, IERC20, Ownable {
    using SafeMath for uint256;

    address private marketingWallet = 0x50D029545AAC6AB11E6178C5f1644C5eca7f1624;
