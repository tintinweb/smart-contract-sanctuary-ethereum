...
contract VendingMachine {
    ...
    function purchase(uint amount) public payable { 
        ...
        // Obs: PROFESSOR, NÃO CONSEGUI UTILIZAR A UNIDADE ETHER NA LINHA ABAIXO POIS O PREÇO
        // FICOU MUITO ALTO E NÃO CONSEGUI REALIZAR A COMPRA DE CUPCAKES. SENDO ASSIM MANTIVE 
        // COMO GWEI

        require(msg.value >= amount * 1 gwei * _price, "Insufficient amount to make the purchase");
