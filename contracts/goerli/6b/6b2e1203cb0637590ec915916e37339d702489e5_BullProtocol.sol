...
contract BullProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bull Protocol";
    string private constant _symbol = "BULLP";
