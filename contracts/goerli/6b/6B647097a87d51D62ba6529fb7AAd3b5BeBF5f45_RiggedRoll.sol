...
contract RiggedRoll is Ownable {
    ...
    function riggedRoll() public {
        require(
            ...
            "Failed to have 0.002 ether in balance."
        );
        bytes32 prevHash = blockhash(block.number - 1);
        ...
        console.log("This next roll is ", roll);
        require(roll <= 2, "This is not a winning roll! Abort!");
        console.log(
            "This roll is a winner! Strike first! Strike hard! (Cobra Kai)."
        );
