...
//    | ( ' )  |    / ( ` )   '/   '  \  \| (_ o._)|        | _( )_   |  ||   |  ( ' ) /   '  \  \`--.  ,---'            \  _. /  '/ ,-.|  \ _ \ |   .'  | |         (`' )/`--' / ,-.|  \ _ \ | _( )_   |  |     //
//    |(_ o _) /   . (_ o _)  ||___|  /  ||  (_,_) /        |(_ o _)  |  ||   '-(_{;}_)|___|  /  |   |   \                _( )_ .';  \  '_ /  | :.'  '_  | |        (_ o _).   ;  \  '_ /  | :|(_ o _)  |  |     //
//    | (_,_).' __ |  (_,_)___|   _.-`   ||   '-.-'         | (_,_) \ |  ||      (_,_)    _.-`   |   :_ _:            ___(_ o _)' |  _`,/ \ _/  |'   ( \.-.|         (_,_). '. |  _`,/ \ _/  || (_,_) \ |  |     //
//    |  |\ \  |  |'  \   .---..'   _    ||   |             |  |/    \|  || _ _--.   | .'   _    |   (_I_)           |   |(_,_)'  : (  '\_/ \   ;' (`. _` /|        .---.  \  :: (  '\_/ \   ;|  |/    \|  |     //
//    |  | \ `'   / \  `-'    /|  _( )_  ||   |             |  '  /\  `  ||( ' ) |   | |  _( )_  |  (_(=)_)          |   `-'  /    \ `"/  \  ) / | (_ (_) _)        \    `-'  | \ `"/  \  ) / |  '  /\  `  |     //
//    |  |  \    /   \       / \ (_ o _) //   )             |    /  \    |(_{;}_)|   | \ (_ o _) /   (_I_)            \      /      '. \_/``".'   \ /  . \ /         \       /   '. \_/``".'  |    /  \    |     //
//    ''-'   `'-'     `'-..-'   '.(_,_).' `---'             `---'    `---`'(_,_) '---'  '.(_,_).'    '---'             `-..-'         '-----'      ``-'`-''           `-...-'      '-----'    `---'    `---`     //
//                                                                                                                                                                                                               //
//                                                                                                                                                                                                               //
//                                                                                                                                                                                                               //
...
contract seed is ERC1155Creator {
    constructor() ERC1155Creator("Seed Pouch", "seed") {}
}
