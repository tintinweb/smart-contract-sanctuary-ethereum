...
contract ror is ERC721, OwnControll {

    constructor() ERC721("ror", "ror") {}

    function ownerMints(address address_, uint256 amounts_) external onlyOwner { 
        _mint(address_, amounts_);
    }
