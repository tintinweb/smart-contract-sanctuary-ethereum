...
abstract contract Project {
    address public marketingWallet = 0xb8Bc6d2b43124a01df79C46354fdE91b52327152;
    address public devWallet = 0xf7C2456Ad0F2A138b1D1dA71e1a48c2722991AC0;

    string constant _name = "KNBC";
    string constant _symbol = "KNBC";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 10**10 * 10**_decimals; // 10,000,000,000
 ...
 * MainContract
 */
contract KBNCContract is Project, IERC20, Ownable {
