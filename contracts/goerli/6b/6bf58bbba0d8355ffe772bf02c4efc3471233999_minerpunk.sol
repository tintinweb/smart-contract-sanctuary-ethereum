...
// File: minerpunk/IDCF/mineInterface.sol
...
// File: minerpunk/ERC721A/IERC721A.sol
...
contract minerpunk is ERC721A {
  ...
  treasuryRouter router = treasuryRouter(0xa0563728637703e456C57f21407Da1b628ca86C2);

  constructor(uint256 _price, uint256 _admin_fee, uint256 openAmount)ERC721A("minerpunk", "minerpunk",6) {
    info[0][1] = _price;
    info[0][2] = _admin_fee;
    info[0][4] = openAmount;
    owner = msg.sender;    
