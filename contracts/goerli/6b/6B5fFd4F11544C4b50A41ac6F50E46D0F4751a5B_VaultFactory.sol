...
contract VaultFactory is IDepositHandler {
    ...
    event VaultUnlocked(address indexed vault, uint256 timestamp, bool isCompletelyUnlocked);
    ...
    function notifyUnlock(bool isCompletelyUnlocked) external {
        ...
        emit VaultUnlocked(msg.sender, block.timestamp, isCompletelyUnlocked);
    }
