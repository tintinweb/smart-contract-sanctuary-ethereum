...
// File @openzeppelin/contracts-upgradeable/token/ERC20/extensions/[email protected]v4.8.1
...
// File contracts/v1/EdoMarketplaceManagementAdmin.sol
...
// File contracts/v1/EdoMarketplaceManagement.sol
...
// File contracts/v1/EdoMarketplace.sol
...
contract EdoMarketplace is EdoMarketplaceManagement, ReentrancyGuardUpgradeable {
        ...
        nonReentrant
    {
        ...
        bytes32 nftId = getHash(nftContractAddress, tokenId);
        tokenMeta[nftId].owner = address(0);
        tokenMeta[nftId].isListing = false;
        listingNftCount--;
    }
    ...
    function _setNftMeta(
        ...
        // Check owner == address(0) when calling from other than setListingNFT
