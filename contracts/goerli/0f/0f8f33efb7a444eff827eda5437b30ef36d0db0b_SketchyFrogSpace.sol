...
contract SketchyFrogSpace is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sketchy Frog Space", "SFS") {
    setHiddenMetadataUri("ipfs://QmYfi9rPwQamgh9rmJyKE2uiWPomKf9evVDr3KZJVdsBCB/Hidden.json");
  }
