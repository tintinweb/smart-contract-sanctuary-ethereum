...
contract GelatoRelayDev is IGelatoRelay, IGelato1Balance {
    ...
    function callWithSyncFee(
        ...
        _target.revertingContractCall(
            ...
            "GelatoRelayDev.callWithSyncFee:"
        );
    ...
    function callWithSyncFeeV2(
        ...
        _isRelayContext
            ? _target.revertingContractCall(
                ...
                "GelatoRelayDev.callWithSyncFeeV2:"
            )
            : _target.revertingContractCall(
    ...
    function sponsoredCall(
        ...
        require(
            ...
            "GelatoRelayDev.sponsoredCall:chainid"
        );

        // INTERACTIONS
        _call.target.revertingContractCall(
            _call.data,
            "GelatoRelayDev.sponsoredCall:"
        );
