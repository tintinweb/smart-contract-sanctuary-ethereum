    ...
    HashFunction
{
    ...
    function initialize(
        ...
        hashInitialize(_projectId, proof_Verifier);
    ...
    function initiateSale() external onlyModusFactory {
        require(
            ...
            "StableCoinPXTSwap: Already Initiated"
        );
    ...
    function swap(uint256 amount, bytes memory sig) external {
        ...
        bool signatureVerification = isMessageValid(
            msg.sender,
            amount,
            investorNonces[msg.sender],
            sig
        );
        require(signatureVerification, "StableCoinPXTSwap: Invalid Signature");
        require(
...
contract HashFunction is Initializable {
    ...
    function isMessageValid(
        ...
        if (signer == proofVerifier) isVerified = true;
        return isVerified;
    }
}
