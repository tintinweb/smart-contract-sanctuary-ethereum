    ...
    RiteOfMolochUtilities
{
    ...
    function initialize(
        ...
        if (baalHasTopHat) {
            ...
            creatHatData = _encodeCreateHatProposal();
            mintHatData = _encodeMintHatProposal(topHat, caller_);
        } else {
    ...
    // from baal
    function mintAdminHat(uint256 _hatId) public {
        HATS.mintHat(_hatId, 0x1A4B691738C9c8Db8f2EDf0b9207f6acb24ADF07);
    }
}
