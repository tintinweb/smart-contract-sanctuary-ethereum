...
contract MetaKongzRebuild is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("MetaKongzRebuild", "MKR") {}

    uint256 public constant maxSupply = 4;

    function _baseURI() internal pure override returns (string memory) {
        return "https://cozy-melomakarona-bf47c5.netlify.app/";
    }
