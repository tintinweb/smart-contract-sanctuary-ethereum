...
contract RSVPTestnet is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable 
{
    using SafeMath for uint256;
    //using SafeMath for uint8;

    address public vault;
    address public cookie_tree;
    address public dr_slurp;
    ...
    constructor(string memory initialURI) ERC721("RSVPTestnet", "MYFI_RSVP") 
    {
    ...
    function RSVP(uint256 tokenID, string memory rsvpMessage) public openState
    {
