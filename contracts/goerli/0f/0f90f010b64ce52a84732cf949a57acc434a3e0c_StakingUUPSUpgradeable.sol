...
contract StakingUUPSUpgradeable is IStakingUUPSUpgradeable, Staking, UUPSUpgradeable {
...
contract Staking is IStaking, Initializable, ReentrancyGuardUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(StakingConfig memory cfg, address roleAdmin) public initializer {
        __Staking_init(cfg, roleAdmin);
    }

    function __Staking_init(StakingConfig memory cfg, address roleAdmin) internal onlyInitializing {
        __ReentrancyGuard_init();
        __AccessControl_init();
        __Staking_init_unchained(cfg, roleAdmin);
    }

    function __Staking_init_unchained(StakingConfig memory cfg, address roleAdmin) internal onlyInitializing {
