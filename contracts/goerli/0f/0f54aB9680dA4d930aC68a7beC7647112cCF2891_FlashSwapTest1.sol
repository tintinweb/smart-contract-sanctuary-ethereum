...
contract FlashSwapTest1 is IUniswapV2Callee {
    ...
    function uniswapV2Call(address _sender, uint _amount0, uint _amount1, bytes calldata _data) override external {
        ...
        token.transferFrom(msg.sender, address(this), amountTokenBorrowed);
        uint amountReceived = sushi_router.swapExactTokensForTokens( amountTokenBorrowed, amountRequired, path, address(this), block.timestamp)[1]; 
        ...
        outputToken.transfer(address(this), amountRequired);   
