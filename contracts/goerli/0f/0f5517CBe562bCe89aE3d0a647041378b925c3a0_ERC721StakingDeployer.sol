...
contract ERC721StakingDeployer is Ownable, ReentrancyGuard {
    ...
    constructor(address _launchpassAddress, address payable _treasuryAddress, address _usdcAddress) {
    ...
    function deploy(
        ...
        if (_price > 0) {
            require(usdc.balanceOf(msg.sender) >= _price, "Insufficient funds");
            usdc.transferFrom(msg.sender, treasuryAddress, _price);
        }
