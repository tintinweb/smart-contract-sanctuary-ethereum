...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public presalePrice = 0.0000001 ether;
    ...
    address[] public withdrawAddresses = [0xb4082f8469795D49BD62DB1232561B4621BE127B, 0x329b743D7372b6Ec12FD6B8bb2b45Fc9EA948BaE];
    uint256[] public withdrawPercentages = [80, 20];


    bytes32 public merkleRoot = 0xfc82be7030d28c6a87bfda0e0ee41ea2bd2e10b32f45bc10081a2ab4c95fb910;

    constructor() ERC721("Stary-A", "A") {
        _baseTokenURI = "https://test-api.nftool.io/generator-server/api/contract/v1/oc5w4INT24jCRutX1/1605026692160397313/metadata/";
