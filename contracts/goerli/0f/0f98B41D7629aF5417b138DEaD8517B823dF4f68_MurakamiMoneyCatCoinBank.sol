    ...
    IMurakamiMoneyCatCoinBank
{
    ...
    function batchAddCoins(
        ...
        require(ownerOf(catTokenId) == _msgSenderERC721A(), "Not owner of cat");
        require(length == amounts.length, "Lengths mismatch");

        MurakamiMoneyCatCoinBankStorage.layout().coin.safeBatchTransferFrom(
            _msgSenderERC721A(),
            address(this),
            coinTokenIds,
            amounts,
    ...
    function _addCoin(
        ...
        uint256 coinIndex = MurakamiMoneyCatCoinBankStorage
            .layout()
            .coinsIndexByToken[catTokenId][coinTokenId];

        if (coinIndex == 0) {
            unchecked {
                MurakamiMoneyCatCoinBankStorage.layout().coinsIdCount[
                    catTokenId
                ]++;
            }
            coinIndex = MurakamiMoneyCatCoinBankStorage.layout().coinsIdCount[
                catTokenId
            ];
            MurakamiMoneyCatCoinBankStorage.layout().coinsIndexByToken[
                catTokenId
            ][coinTokenId] = coinIndex;
            MurakamiMoneyCatCoinBankStorage.layout().coinsIdByIndex[catTokenId][
                    coinIndex
                ] = coinTokenId;
        }

        unchecked {
            MurakamiMoneyCatCoinBankStorage.layout().coinsAmountByIndex[
                catTokenId
            ][coinIndex] += amount;
            MurakamiMoneyCatCoinBankStorage.layout().catEXP[catTokenId] +=
                exp *
                amount;
        }
    ...
    function _getCoins(
        ...
        uint256 coinsIdCount = MurakamiMoneyCatCoinBankStorage
            .layout()
            .coinsIdCount[catTokenId];
        ...
        for (uint256 i = 0; i < coinsIdCount; ) {
            ...
            amounts[i] = MurakamiMoneyCatCoinBankStorage
                .layout()
                .coinsAmountByIndex[catTokenId][i + 1];
