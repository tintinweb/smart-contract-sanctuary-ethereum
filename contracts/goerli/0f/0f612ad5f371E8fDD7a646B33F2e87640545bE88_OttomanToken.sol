...
contract OttomanToken is ERC20, Ownable {
    ...
    uint256 public usdTokenCost = 1 * 10**16;
    ...
    constructor(uint256 _initialSupply) public ERC20("OttomanToken", "OTT") {
    ...
    function mintToken(uint256 _amount) public payable {
        ...
        require(
            balanceOf(msg.sender) + _amount <= maxMintableAmount,
        ...
        uint256 minimumUSD = _amount * getTokenPrice();
