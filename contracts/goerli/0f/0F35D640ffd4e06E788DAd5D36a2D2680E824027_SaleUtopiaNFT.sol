...
//El owner mintea a coste 0
//Poder deslimitar whitelist
//Poder cambiar todas las variables de las fases
...
contract SaleUtopiaNFT is Ownable, ReentrancyGuard {
    ...
    function buy(uint256 quantity, address to) external payable callerIsUser {
        ...
        phase.priceInUSDPerNFT;
        phase.maxTotalSales;
        phase.maxSalesPerWallet;
        phase.whiteListRequired;
