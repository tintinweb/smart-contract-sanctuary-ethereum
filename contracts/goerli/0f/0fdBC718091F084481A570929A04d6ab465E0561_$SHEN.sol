...
contract $SHEN is ERC20, Ownable, ERC20Burnable {
    ...
    address private deadWallet = address(0x0000000000000000000000000000000000000000); //Default set to dead address.
    ...
    address payable public marketingWallet = payable(address(0x0000000000000000000000000000000000000001)); //Default set to sample address.
    ...
    constructor() ERC20("Shiba Enjin", "SHEN") {
        ...
        buyFee.reward = 0; //Default set to zero percent.
        buyFee.marketing = 0; //Default set to zero percent.
        buyFee.burn = 0; //Default set to zero percent.
        buyFee.autoLP = 0; //Default set to zero percent.
        
        totalBuyFee = buyFee.reward + buyFee.marketing + buyFee.burn + buyFee.autoLP;

        sellFee.reward = 0; //Default set to zero percent.
        sellFee.marketing = 0; //Default set to zero percent.
        sellFee.burn = 0; //Default set to zero percent.
        sellFee.autoLP = 0; //Default set to zero percent.
        ...
        maxTxAmount = totalSupply().mul(1).div(100); //Default set to 1 percent.
        maxWallet = totalSupply().mul(1).div(100); //Default set to 1 percent.
    }
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 1 * (10**18); //Default set to one token.
    }
