...
contract FIREFLY is Context, IERC20, Ownable {
    ...
    string private _symbol = "FIREFLY V6";
    ...
    constructor () {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(USDC));
        ...
        IERC20(USDC).approve(address(uniswapV2Pair), type(uint256).max);
