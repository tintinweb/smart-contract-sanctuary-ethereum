...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1672034400;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x2159019d05Fd453167b34e70e04378EAf4940dA9];
  address public erc20Payable = 0x2159019d05Fd453167b34e70e04378EAf4940dA9;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeicpxjokkygwxzfocof56a3dce5tsvv72gmuqxwrm4rjta6rso6ooy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/t14LjAN1yXVoHAHGy7co/contract-metadata";
  }
...
// File: contracts/CryptoDickBurbzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoDickBurbzContract is RamppERC721A {
    constructor() RamppERC721A("CryptoDickBurbz", "DickBurbz"){}
}
