    ...
    ERC721ACommon
{
    ...
    bool public startPremintPublic;

    function toggleStartPremintPublic() external onlyOwner {
        startPremintPublic = !startPremintPublic;
    }
    ...
    function preMint(
        ...
        require(startPremintPublic, "!premint start");
