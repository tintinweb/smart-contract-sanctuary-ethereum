...
// File contracts/arbitrium-contract.sol

pragma solidity ^0.8.0;


contract TheNativeLab is ERC1155, Ownable, ERC1155Supply {
    using SafeMath for uint256;
    using Strings for uint256;

    string public name       = "The Native Lab";
    string public symbol     = "TNL";
    uint256 public maxSupply = 5500;

    string public baseURI1 = "ipfs://QmcTCxhLSZNbVXnJcJ7gLH9zkoe49Nxz8KbGQ1L1mL2zhq";           
    
    bool public publicSaleActive = false;

    uint256 public publicSalePrice = 0.02 ether;

    constructor() ERC1155(baseURI1) {
    }
    ...
    function setURI(string memory _baseURI1) external onlyOwner {
        baseURI1 = _baseURI1;
    }
