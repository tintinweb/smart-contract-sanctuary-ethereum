...
/**
 *Submitted for verification at testnet.snowtrace.io on 2023-03-12
*/
...
contract BridgeContract {
    ...
    function unlock(address wrappedToken, uint256 amount) public {
        require(
            wrappedToSourceTokenMap[wrappedToken] != address(0),
            "Token unlock unpossible"
        );
        ...
        IERC20(wrappedToSourceTokenMap[wrappedToken]).transfer(
            msg.sender,
            amount
        );
    ...
    function mint(
        ...
        mint(sourceToken,amount);
    }

    // Mint when we have equivalent to the sourceToken
    function mint(address sourceToken, uint256 amount) public {
    ...
    function burn(address wrappedToken, uint256 amount) public {
        ...
        emit TokenBurned(address(wToken),msg.sender, amount);
    }
