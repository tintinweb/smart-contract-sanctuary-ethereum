...
import "./dependencies/uniswap-v2-core/contracts/interfaces/IUniswapV2Factory.sol";
...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function _addLiquidity(
        ...
        (amountA, amountB) = UniswapV2Library._addLiquidity(
            tokenA,
            tokenB,
            amountADesired,
            amountBDesired,
    ...
    {
        console.log("calling _addLiquidity");
        ...
        console.log("First safe transfer");
        TransferHelper.safeTransferFrom(tokenA, msg.sender, pair, amountA);
        console.log("Second safe transfer");
        TransferHelper.safeTransferFrom(tokenB, msg.sender, pair, amountB);
        console.log("calling mind function of IUniswapV2Pair");
        console.log("pair address is", pair);
        IERC20(pair).approve(address(this), 50000);
    ...
    function _swap(
        ...
        UniswapV2Library._swap(amounts, path, _to, factory);
    }
...
import "contracts/dependencies/uniswap-v2-core/contracts/interfaces/IUniswapV2Factory.sol";
import "./SafeMath.sol";
