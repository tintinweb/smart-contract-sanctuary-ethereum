...
contract Anicana is ValidatorSmartContractInterface, IKnightsOfTheRoundTable, Ownable {
    ...
    bool public isQueenVoting = true;
    ...
    */
    ...
    @param _reward reward distribution for queen
    @param _reward reward distribution for validator
    */
    event AlertDistributeRewards(
        address indexed _ANMPoolAddress,
        address _queenAddress,
        address _validatorAddr, 
        uint256 _rewardForCurrentQueen,
    ...
    */
    ...
    {   
        ...
        if (queenVotingList[indexQueenVoting.current()].proposedList[_validatorCandidaterAddress].length < REQUIRED_VOTE_NUMBER_TO_BECOME_NEW_QUEEN) {
            emit AlertQueenVoting(
                _validatorCandidaterAddress,
                currentQueen.queenAddr,
                "VOTE QUEEN DISMISS SUCCESSED"
        ...
        internal
    {
        ...
        QueenVoting storage currentQueenVoting = queenVotingList[indexQueenVoting.current()];
         for(uint256 i = 0; i < currentQueenVoting.proposedList[_newQueen].length; i++) {
            queenVotingHistory[currentQueenVoting.proposedList[_newQueen][i]].push(
            QueenVotingHistory(
                currentQueen.queenAddr,
    ...
    */
    ...
    function getNumberVoting(address _validatorCandidaterAddress) public view returns (uint256[] memory){        
        QueenVoting storage currentQueenVoting = queenVotingList[indexQueenVoting.current()];
