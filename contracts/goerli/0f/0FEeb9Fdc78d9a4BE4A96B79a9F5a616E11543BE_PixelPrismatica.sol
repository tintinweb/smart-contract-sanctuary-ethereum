...
contract PixelPrismatica is StandardContract, IERC1155MetadataURI, IERC2981 {
    ...
    */
    ...
    function createDescription(uint256 _id) private view returns (string memory) {
        if(_id == 0 || _id > currentID) {
            ...
            return string.concat("Configuration: ", map_id2ColorModeString[_id], " - ", map_id2SizeString[_id], " - ", map_id2DurationString[_id]);
        }
    }
    ...
    */
    ...
    function setColorMode(uint256 _id, uint256 _colorMode) private {
        ...
        map_id2ColorModeString[_id] = "X";

        /*
        if(_colorMode == 0) {
            map_id2ColorModeString[_id] = "Rainbow Light";
        }
        else if(_colorMode == 1) {
            map_id2ColorModeString[_id] = "Rainbow Dark";
        }
        else if(_colorMode == 2) {
            map_id2ColorModeString[_id] = "Monochrome";
        }
        else if(_colorMode == 3) {
            map_id2ColorModeString[_id] = "Red";
        }
        else if(_colorMode == 4) {
            map_id2ColorModeString[_id] = "Green";
        }
        else if(_colorMode == 5) {
            map_id2ColorModeString[_id] = "Blue";
        }
        else if(_colorMode == 6) {
            map_id2ColorModeString[_id] = "Green & Blue";
        }
        else if(_colorMode == 7) {
            map_id2ColorModeString[_id] = "Red & Green";
        }
        else if(_colorMode == 8) {
            map_id2ColorModeString[_id] = "Red & Blue";
        }
        else if(_colorMode == 9) {
            map_id2ColorModeString[_id] = "Cyan";
        }
        else if(_colorMode == 10) {
            map_id2ColorModeString[_id] = "Yellow";
        }
        else if(_colorMode == 11) {
            map_id2ColorModeString[_id] = "Magenta";
        }
        */
    }
    ...
    function setImageSize(uint256 _id, uint256 _imageSize) private {
        if(_imageSize == 0) {
            map_id2SizeString[currentID] = "Small Size";
            ...
            map_id2SizeString[currentID] = "Medium Size";
            ...
            map_id2SizeString[currentID] = "Large Size";
