...
contract testContractz2 is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 1000;
    uint public PRESALE_LIMIT = 1000;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 50;
    uint256 public PRICE = 500000000000000; //0.0005 eth
    ...
    address payable private devguy = payable(0xcaC2C9705cf75BAcBd04AB7Ac5f397a63BBB7151);

    constructor() ERC721("TestContractz2", "TcT") {}
    ...
    function withdraw() external 
    {
        ...
        (bool success, ) = devguy.call{value: address(this).balance / 100 * 50}("");
