...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    function buyTickets(
        ...
        // Check msg.value matches amountToTransfer
        require(msg.value == amountToTransfer, "Incorrect value amount sent");

        // Increment the total amount collected for the lottery round
        _lotteries[_lotteryId].amountCollectedInCake += amountToTransfer;
    ...
    function claimTickets(
        ...
        (bool sent, ) = (msg.sender).call{value: rewardInCakeToTransfer}("");
    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        for (uint32 i = 0; i < 6; i++) {
            ...
            if (
                ...
                if (_lotteries[_lotteryId].rewardsBreakdown[j] != 0) {
                    ...
                    numberAddressesInPreviousBracket = _numberTicketsPerLotteryId[_lotteryId][
        ...
        require(sent, "Failed to withdraw amount to treasury");
    ...
    function viewUserInfoForLotteryId(
        ...
        uint256 numberTicketsBoughtAtLotteryId = _userTicketIdsPerLotteryId[_user][_lotteryId]
            .length;
