...
contract KawaiiPlushies is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl {
    ...
    constructor(bytes32 _merkleRoot, uint _maxSupply, uint _startTimestamp) ERC721("KawaiiPlushies", "KP") {
