...
contract DelabsAdventurePass is  ERC721Enumerable, Ownable, ReentrancyGuard, ERC2981 {
    ...
    constructor() ERC721("DelabsAdventurePass", "DAP") {
        ...
        baseURI = "https://api.delabs/adventurepass/";
    ...
    function allowlistSaleMint(bytes memory sig) external payable nonReentrant {
        ...
        require(supply + 1 <= MAX_SUPPLY, "Further minting would exceed max supply");
    ...
    function adminMint(uint256 numberOfMints) external onlyOwner nonReentrant {
        ...
        require(supply + numberOfMints <= MAX_SUPPLY, "Further minting would exceed max supply");
