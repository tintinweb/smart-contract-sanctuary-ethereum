...
// import "moonbirds/Moonbirds.sol";
import "./moonbirds-modded/Moonbirds.sol";

contract StageBirbs is Moonbirds {
    constructor()
        Moonbirds(
            "aklsdjfhalksjdhf",
            "asdfasf",
        ...
        )
    {
        ...
        nestingOpen = true;
        sellerConfig.reserveFreeQuota = false;
        sellerConfig.totalInventory = 10000;
    }
        ...
        )
    {
        ...
        return super.nestingPeriod(tokenId);
    }

    function setAllNested(bool toggle) public {
        _allNested = toggle;
    }
}
...
import {ITokenURIGenerator} from "moonbirds/Moonbirds.sol";
