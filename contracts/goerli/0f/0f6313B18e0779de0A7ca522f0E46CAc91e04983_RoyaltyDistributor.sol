    ...
    ERC165Upgradeable
{
    ...
    function ownerOf(uint256 tokenId) public view virtual returns (address) {
        address owner = _ownership[tokenId].owner;
        require(
            owner != address(0),
    ...
    function approve(address to, uint256 tokenId) public virtual {
        address owner = ERC721Fundable.ownerOf(tokenId);
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        return _ownership[tokenId].owner != address(0);
    }
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        _balances[owner] -= 1;
        delete _ownership[tokenId].owner;
    ...
    function _transfer(
        ...
        require(
            ERC721Fundable.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721Fundable.ownerOf(tokenId), to, tokenId);
    }
