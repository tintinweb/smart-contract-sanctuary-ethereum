...
//17, 3, 14, 6, 3, 40, 5, 6, 3, 2
//10001 11 1110 110 11 101000 101 110 11 10
//5  2  4 3 2 6 3 3 2 2
//10001111110110111010001011101110
...
//    mapping (uint => string) public tokenCloth;
    ...
    function updateDNA(uint from_, uint[] calldata dnas_) external onlyOwner {
        for (uint i = from_; i < dnas_.length; i++) {
            ultraDna[i] = dnas_[i];
        }
    }
...
//             name: getName(tokenId_),
//             description: description,
//             background: background[backgroundIndex],
...
//        });
    ...
    function getPaddedString(uint num, uint length) public pure returns (string memory) {
