...
contract ido is Ownable {
    ...
    */
    ...
    //用户充值的总金额
     mapping ( address => uint256)  userRecharge;
        ...
        uint256  maxExchange;        // 项目方允许的最大单次兑换 数字 × 1000，最小 0.01
        ...
        bool     statusRun;            // 项目状态 true 已经充值 可以运行 false 未充值 无法运行
  ...
  constructor(
    ...
    */
    ...
    function setprojectData (uint     _startTime,
                             uint     _endTime,
                             uint256  _inTokenCapacity,
    ...
    //设置指定项位置数据
    function setlockUser(uint place,lockUser memory data)  public  onlyOwner {
