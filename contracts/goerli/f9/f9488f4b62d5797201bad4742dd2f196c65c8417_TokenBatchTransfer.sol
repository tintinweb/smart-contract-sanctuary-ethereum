...
// File: github/singnet/batch-token-transfer/contracts/TokenBatchTransfer.sol
...
contract TokenBatchTransfer is Ownable {
    ...
    onlyOperator
    {
        ...
        for(uint256 indx = 0; indx < tokenHolders.length; indx++) {
            require(token.transferFrom(transferOperator, tokenHolders[indx], amounts[indx]), "Unable to transfer token to the account");
        }
    }
}