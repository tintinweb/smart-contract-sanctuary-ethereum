...
contract MiharaNFTFlowerAndGreen is IMiharaNFT, ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 private _remainingFree = 50;
    bool private _isOnSale;
    uint256 private _nextTokenId = 1;

    constructor() ERC721("Mihara NFT Flower and Green ", "MIHARA") {}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory){
        require(_exists(tokenId), "Mihara NFT: URI query for nonexistent token");
    ...
    function buy() external override nonReentrant payable {
        require(_isOnSale, "Mihara NFT: Not on sale");
        require(msg.value == PRICE, "Mihara NFT: Invalid value");
