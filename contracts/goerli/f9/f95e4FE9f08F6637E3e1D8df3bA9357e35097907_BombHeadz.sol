...
import "../node_modules/@thirdweb-dev/contracts/base/ERC721LazyMint.sol";
import "../node_modules/@thirdweb-dev/contracts/base/ERC1155Base.sol";
import "../node_modules/@thirdweb-dev/contracts/base/ERC721Drop.sol";

contract BombHeadz is ERC721LazyMint {
    // Store constant values for the 2 NFT Collections:
    // 1. Is the SkullBombs NFT Collection
    ERC721LazyMint public immutable skullBombs;
        ...
        override
    {
        ...
        // - They own an NFT from the SkullBombslone contract
        require(
            skullBombs.balanceOf(_claimer) >= _quantity,
            "You don't own enough SkullBombs NFTs"
        );
        // - They own an NFT from the SerumClone contract
        require(
            serum.balanceOf(_claimer) == 5,
    ...
    function _transferTokensOnClaim(address _receiver, uint256 _quantity)
        ...
        returns (uint256)
    {
        serum.burn(_quantity);
        skullBombs.burn(_quantity);
