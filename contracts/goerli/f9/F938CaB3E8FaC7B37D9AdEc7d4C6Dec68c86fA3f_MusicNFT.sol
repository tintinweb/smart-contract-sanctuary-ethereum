...
/// @notice
///
contract MusicNFT is ERC721A, Ownable, Adminable {
    
    using Address for address payable;
    using SafeMath for uint256;

    uint256 public constant PRICE = 0; // FREE
    ...
    function mintPublic(uint64 quantity) public payable {
        require(PRICE.mul(quantity) <= msg.value, "Not enough ETH sent");
