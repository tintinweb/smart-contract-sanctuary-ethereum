...
contract MemeWorld is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 696900000000 * 10**9;
    ...
    uint256 public _maxTxAmount = 1393000000 * 10**9; //2%
    uint256 public _maxWalletSize = 1393000000 * 10**9; //2%
    uint256 public _swapTokensAtAmount = 696900000 * 10**9; //0.01%
