...
contract FjordLbpProxyV5 is FjordLbpAbstractV1 {
        ...
        returns (address)
    {
        ...
        bytes32 poolId = LBP(weightedPool).getPoolId();
     ...
     */
    function getWeithtedTokenBalance(address weithedPool) external view returns (uint256 weightedBalance) {
        return IERC20(weithedPool).balanceOf(address(this));
    }
}
