...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == anchorLottery, "Only AnchorLottery");
    ...
    /**
     * @notice Set the address for the AnchorLottery
     * @param _anchorLottery: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _anchorLottery) external onlyOwner {
        anchorLottery = _anchorLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IAnchorLottery(anchorLottery).viewCurrentLotteryId();
    }
}
