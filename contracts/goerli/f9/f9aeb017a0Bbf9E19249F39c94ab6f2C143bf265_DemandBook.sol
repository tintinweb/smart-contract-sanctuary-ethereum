...
contract DemandBook is IDemandBook, Initializable, AbstractDependant {
    ...
    uint256 public constant override EPOCH_DURATION = 2 hours;
    uint256 public constant MAXIMUM_EPOCHS = SECONDS_IN_THE_YEAR / EPOCH_DURATION;
    uint256 public constant MINIMUM_EPOCHS = SECONDS_IN_THE_MONTH / EPOCH_DURATION;
    uint256 public constant VIRTUAL_EPOCHS = 1;

    uint256 public constant override OPEN_PERIOD = 1 hours;
    uint256 public constant override PENDING_PERIOD = 30 minutes;
    uint256 public constant override STILL_CLAIMABLE_FOR = 2 hours;
    ...
    modifier onlyAdmin() {
        require(msg.sender == policyBookAdminAddress, "DemandBook: Not a PBA");
        _;
    }
    ...
    function setMaxEpoch(uint256 _maxEpoch) external override onlyAdmin {
        require(_maxEpoch >= MINIMUM_EPOCHS && _maxEpoch <= MAXIMUM_EPOCHS, "DB: Invalid data");
        maxEpoch = _maxEpoch;
    }
    ...
    function createDemand(
        ...
        require(_epochAmount > 0 && _epochAmount <= maxEpoch, "DemandBook: Wrong epoch duration");
...
interface IDemandBook {
    ...
    function setMaxEpoch(uint256 _maxEpoch) external;
