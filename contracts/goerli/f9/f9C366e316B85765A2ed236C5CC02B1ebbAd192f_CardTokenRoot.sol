...
// File: Polygon/IMintableERC721.sol
...
contract CardTokenRoot is ERC721, AccessControl, IMintableERC721 {
    ...
    constructor(string memory name_, string memory symbol_, address _predicateProxyAddress, string memory __baseURI) public ERC721(name_, symbol_) {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(PREDICATE_ROLE, _predicateProxyAddress);
