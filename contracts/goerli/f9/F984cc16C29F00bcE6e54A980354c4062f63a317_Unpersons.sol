...
contract Unpersons is ERC721A, Ownable {
    ...
    string public hiddenMetadataUri="ipfs://QmdGULgP8xHJ2fcXUy1Ynh3hgAUHSAReAEZ6FCFRMsLS2b/Hidden.json";
        ...
        payable
    {
        ...
        require(supply + quantity <= 555, "Maximum Free Mint Range Finished");
        require(
        ...
        require(
            ...
            "You're Not Allowed To Mint more than 3 NFTs"
        );
        //Check 1
        ...
        if(supply + quantity >= 555 && supply + quantity <=5555){
            presaleCost= 0.0069 ether;
        }
    ...
    function mint(uint256 quantity) external payable {
        ...
        if (msg.sender != owner()) {
           ...
           // require(msg.value >= publicCost * quantity, "Not enough ether!");
            //First People Who get the Free Ones
             if (balanceOf(msg.sender) < 1 && freeSupply >= supply) {
                require(msg.value >= publicCost * (quantity-1), "Not enough ether!");
            }else{
                require(msg.value >= publicCost * quantity, "Not enough ether!");
            }
