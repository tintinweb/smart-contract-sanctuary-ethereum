    ...
    ERC721URIStorage
{
    ...
    address public companyWallet = address(0x2DdaD7660e4cd0c4c13Ff23bb97607a90Cc1eC60);
    ...
    function setCompanyWallet(address companyWallet_) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ERC721: must have admin role to change companyWallet");
    ...
    //     emit Mint(address(0), _msgSender(), tokenId);
    // }
    function mint() public virtual {
        uint256 tokenId = totalSupply();
    ...
    // function mintMulti(uint256[] memory tokenId, address[] memory to) public virtual {
