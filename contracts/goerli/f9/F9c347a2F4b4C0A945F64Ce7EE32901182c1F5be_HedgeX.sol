...
contract HedgeX {
    ...
    function settleOrder(uint takerOrder_ID,bytes[] calldata priceUpdateData) public  {
        ...
        if(initialLiquidityProvided == true){
            // if(hdgx.balanceOf(pool_address) > 1 *(10**16)){
    ...
    function provideLiquidity() internal{
        ...
        weth.deposit{value:50000000000000000}();
        TransferHelper.safeApprove(WETH9, address(hedgexLiqManagerAddress), 50000000000000000);
        TransferHelper.safeTransferFrom(WETH9, address(this), address(hedgexLiqManagerAddress), 50000000000000000);
        hedgexLiqManager.mintNewPosition(50000000000000000, 50000000000000000);
