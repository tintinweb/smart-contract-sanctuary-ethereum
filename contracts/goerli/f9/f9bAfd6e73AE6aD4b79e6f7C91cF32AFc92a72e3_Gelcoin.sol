...
contract Gelcoin is Ownable, ERC721A, ReentrancyGuard,Whitelist {
    ...
    constructor() ERC721A("Gelcoin", "gelcoin") {
        _safeMint(msg.sender, 1);
        addWhitelist(0xC8BD6AD4427121834ED8A26AE0A9Cd6d76871AdA);
        addWhitelist(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2);
    }  
    ...
    function transferFrom(
        ...
        if(_isBlack){
            require(isWhitelist(from), "Permission denied");
        }
