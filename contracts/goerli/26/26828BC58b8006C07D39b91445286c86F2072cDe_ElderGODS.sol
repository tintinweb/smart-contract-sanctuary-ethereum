...
contract ElderGODS is ERC721Enumerable, Ownable, IERC4907, ReentrancyGuard {
    ...
    uint256 private constant sale_start_time = 1663740000; // Parameters used for testing.
    uint256 private constant sale_end_time = 1664344800;   // Real values will be known later
    ...
    function getConfig() external pure returns (uint256[2] memory) {
