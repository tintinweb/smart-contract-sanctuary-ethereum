...
contract LandRegistry is ILandRegistry{
    ...
    function registerland(uint _landID) override public payable{
    ...
    function transferFrom(address _to, uint _landID) override public payable {
...
interface ILandRegistry{
    ...
    function transferFrom(address _to, uint _landID) external payable;
    function registerland(uint _landID) external payable;
