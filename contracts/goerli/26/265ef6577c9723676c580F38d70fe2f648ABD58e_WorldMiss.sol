...
contract WorldMiss is ERC721A, ReentrancyGuard, IERC721Receiver, Ownable {
    ...
    constructor(address _nft_address, address _usdtAddress, string memory _name, string memory _symbol) ERC721A(_name, _symbol){
    ...
    function buyNFTWithETH(uint256 id) external payable nonReentrant {
        ERC721A token = ERC721A(nft_address);
        require(msg.value >= mint_price, "Not enough ether sent");
        
        addr_num1 = mint_price * addr_rate1 / 100;
        addr_num2 = mint_price * addr_rate2 / 100;
        addr_num3 = mint_price * addr_rate3 / 100;
    ...
    function buyNFTWithERC20(uint256 id) external nonReentrant {
        ERC721A token = ERC721A(nft_address);

        addr_num1 = mint_price*getLatestPrice()*(addr_rate1)/(100*1e18);
        addr_num2 = mint_price*getLatestPrice()*(addr_rate2)/(100*1e18);
        addr_num3 = mint_price*getLatestPrice()*(addr_rate3)/(100*1e18);
    ...
    function setMintRate(uint256 _mintPrice) public onlyOwner {
