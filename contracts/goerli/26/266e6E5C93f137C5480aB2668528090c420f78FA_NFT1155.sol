...
contract NFT1155 is ERC2981, EIP712, ERC1155URIStorage {
  ...
  event Mint(uint256 newItemId, address userAddress, uint256 amount);
  event Redeem(NFTVoucher voucher, address userAddress, uint256 amount);
  ...
  function redeem(
    ...
    emit Redeem(voucher, msg.sender, amount);
  }
  ...
  function createToken(
    ...
    emit Mint(newItemId, msg.sender, amount);
    return newItemId;
  }
