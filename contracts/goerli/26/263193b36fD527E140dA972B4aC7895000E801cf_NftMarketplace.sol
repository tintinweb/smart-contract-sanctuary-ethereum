...
contract NftMarketplace is ReentrancyGuard {
    ...
    function listItem(
        ...
        // 1. Send the NFT to the contract  第一种方式
        // 2. give approve 第二种方式
        IERC721 nft = IERC721(nftAddress);
    ...
    function buyItem(
        ...
        //我们不直接把钱发送给user，是因为 // https://fravoll.github.io/solidity-patterns/pull_over_push.html
