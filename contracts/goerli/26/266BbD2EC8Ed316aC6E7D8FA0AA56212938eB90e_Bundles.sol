...
contract Bundles {
   ...
   function PlaceBetValid(uint256 index,uint256 _bundleId,uint256 _amount) public view returns(bool) {
       bool status_1;
       bool status_2;
       bool status_3;
       bool status_4;
       bool status_5;
       if(_bundleId <= bundleId) status_1 = true;
       if(bundle_address.allowance(msg.sender,address(this))>=_amount) status_2 = true;
       Bundle storage b = bundle[_bundleId];
       //if(b.stakingends >= block.timestamp) status_3 = true;
       User storage us = user[msg.sender];
       if(us.active == true) status_4 = true;
       UserBets storage u = bets[msg.sender][_bundleId];
       if(u.bundles[index] == 0) status_5 = true;
       if(status_1 == true && status_2 == true && status_4 == true && status_5 == true) return true;
       else return false;
   }
   ...
   function updatebalValid(address _user,uint256 _bundleId,uint256 _reward) public view returns(bool) {
       bool status_1;
       bool status_2;
       bool status_3;
       bool status_4;
       if(msg.sender == owner) status_1 = true;
       if(_reward <= 120000) status_2 = true;
       User storage us = user[_user];
       if(us.active == true) status_3 = true;
       UserBets storage u = bets[_user][_bundleId];
       if(u.claimed == false) status_4 = true;
   }
   ...
   function fetchUserBets(address _user, uint256 _bundleId) public view returns(uint256[14] memory _bundles,uint256[14] memory _prices,uint256[14] memory _amounts,uint256 balance,uint256 totalbet){
       UserBets storage u = bets[_user][_bundleId];
