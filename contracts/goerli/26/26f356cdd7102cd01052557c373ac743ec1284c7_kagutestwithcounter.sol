...
contract kagutestwithcounter is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "kagucounter";
    string private constant _symbol = "kagucounter";
    ...
    function setStructure(
        ...
        transferFee = _trans;
        require(
            totalFee <= denominator.div(4) && sellFee <= denominator.div(4),
            "totalFee and sellFee cannot be more than 25%"
        );
    }
