...
Take a deeper dive into Artificial Intelligence technology through DeepAI,
a decentralized token built on the Ethereum network that will provide a deeper and 
more personalized experience into the use and development of AI technologies.

https://t.me/deepaierc
https://medium.com/@deepaieth
https://twitter.com/deepaieth
*/
...
contract Testing1 is IERC20, Ownable {
    ...
    constructor () {
        ...
        _taxFeeBuy = 0;
        _marketingFeeBuy = 2000;
        _liquidityFeeBuy = 900;
        _burnFeeBuy = 0;

        _taxFeeSell = 0;
        _marketingFeeSell = 1900;
        _liquidityFeeSell = 1000;
        _burnFeeSell = 0;
        ...
        marketingWallet = 0x4DdCD0ec1f671acF33774d7e4968a0Cf28ab4bcF;
