...
import "./MetriaArtTradable.sol";

contract MetriaArtFactory is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Metria marketplace contract address;
    address public marketplace;

    /// @notice Metria bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new MetriaArtTradable contract
        ...
        returns (address)
    {
        ...
        MetriaArtTradable nft = new MetriaArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing MetriaArtTradable contract
    ...
    /// @notice Method for disabling existing MetriaArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title MetriaArtTradable
 * MetriaArtTradable - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract MetriaArtTradable is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // Metria Marketplace contract
    address marketplace;
    // Metria Bundle Marketplace contract
    ...
    /**
     * Override isApprovedForAll to whitelist Metria contracts to enable gas-less listings.
     */
    ...
    {
        // Whitelist Metria marketplace, bundle marketplace contracts for easy trading.
