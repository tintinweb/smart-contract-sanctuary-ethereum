...
contract Staker {
  ...
  event Stake(address indexed _sender, uint _amount);
  ...
  constructor(address exampleExternalContractAddress) {
    ...
    // update the sender's balancey
  function stake() public payable {
    require(block.timestamp < deadline, "Cannot stake anymore");
    //require(address(this).balance <= threshold, "Cannot stake anymore, threshhold reached");
