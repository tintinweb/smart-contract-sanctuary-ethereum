...
contract BZ2test is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 2100;
    uint public _price = 0.01 ether;
    uint256 public maxBuyPerTx = 2100;
    bool public paused;
    

    constructor() ERC721A("BZ2test", "BZ2testcollection") {
        paused = true;
    }
    // Read the price
