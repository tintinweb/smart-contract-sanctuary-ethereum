...
contract crowdSale is IERC20, DividendPayingToken {
...
contract crowdSaleFactory {
    crowdSale public deployedCroudSale;
    ...
    function deployCroudSale(
        ...
        //deploy croudsale
        deployedCroudSale = new crowdSale(
            PROTOCOL_STABLE,
            _maxFund,
            _endTime,
            _benificiary,
...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface {
