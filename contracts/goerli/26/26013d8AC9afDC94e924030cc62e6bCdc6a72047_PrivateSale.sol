...
contract PrivateSale is Ownable{
    ...
    function purchasePackage(uint256 packageNumber) public {
        ...
        tokensLocked[0] = (packageAmount[packageNumber] * packageRate[packageNumber])/100;
        // tokensLocked[0] = 10000;
        investor[0] = msg.sender;
        setLockedTokens(investor, tokensLocked);
    }

    function setLockedTokens(address[] memory privateInvestors, uint256[] memory amounts) internal{
