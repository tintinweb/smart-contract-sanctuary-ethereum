...
contract MetaverseMonkeys is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public WHITELIST_PRICE = 0.92 ether;
    uint256 public PUBLIC_PRICE = 0.92 ether;
    uint256 public PUBLIC_MINT_LIMIT = 2;

    uint256 public SALE_STEP = 0; // 0 => NONE, 1 => WHITELIST, 2 => PUBLIC

    constructor() ERC721A("MetaverseMonkey", "MM") {}

    function setWhitelistRoot(bytes32 _root) external onlyOwner {
        WHITELIST_ROOT = _root;
    }
    function setMintPrice(uint256 whitelistPrice, uint256 publicPrice) external onlyOwner {
