...
interface IPaymentController {
    ...
    function getEstimate(address offeredToken_, uint baseTokenPrice) external view returns (uint[] memory estimatedPrice);
...
contract PaymentController is IPaymentController {
    ...
    function getEstimate(address offeredToken_, uint baseTokenPrice_) public view override returns (uint[] memory estimatedPrice) {
        
        //TODO better way of normalizing decimals?
        return _uniswapRouter.getAmountsIn(baseTokenPrice_, getPathForToken(offeredToken_));
    }
