...
contract Subscription {
        ...
        returns (bool success)
    {
        ...
        require( requiredToAddress == address(0) || to == requiredToAddress, "SUBSCRIPTION: ERROR 1");
        require( requiredTokenAddress == address(0) || tokenAddress == requiredTokenAddress, "SUBSCRIPTION: ERROR 2");
        require( requiredTokenAmount == 36000 || tokenAmount == requiredTokenAmount, "SUBSCRIPTION: ERROR 3");
        require( requiredPeriodSeconds == 36000 || periodSeconds == requiredPeriodSeconds, "SUBSCRIPTION: ERROR 4");
        require( requiredGasPrice == 0 || gasPrice == requiredGasPrice, "SUBSCRIPTION: ERROR 5");
