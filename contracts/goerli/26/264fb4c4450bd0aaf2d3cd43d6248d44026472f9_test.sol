...
contract test is ERC721A, Ownable {
    ...
    uint256 public constant MAX_SUPPLY = 100; // Total amount of mfers
    uint256 public constant PRICE = 0.012 ether; // Price
    uint256 public constant MAX_PER_WALLET = 10; // Max mint amount per address
    uint256 public constant MAX_FREE_SUPPLY = 1; // Max amount of free mfers

    // URI
    string public baseURI = "ipfs://test/";

    constructor() ERC721A("dfdsf", "fdsfds") {}
