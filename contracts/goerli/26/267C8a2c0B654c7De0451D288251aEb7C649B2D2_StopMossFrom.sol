...
contract StopMossFrom is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public MAX_WHITELIST_MINT = 5;
    ...
    constructor() ERC721A("StopMossFrom", "MOSS") { }
    ...
    function whitelistMint(bytes32[] memory _merkleProof, uint256 _quantity) external payable correctState(SaleState.AEROLIST) {
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "Beyond max supply.");
