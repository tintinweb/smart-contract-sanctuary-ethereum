...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1678154400;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x93959AC13e186953C37EA739893Ab10d3ec52834];
  address public erc20Payable = 0x93959AC13e186953C37EA739893Ab10d3ec52834;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 2050) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeica7yvhdwkg3jgb7qzib7rsd7ymfsbpjoqdllo3giewbb5rdrz4c4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5nsbhGXmofm3lmQXdqR6/contract-metadata";
  }
...
// File: contracts/AnnoyedBearsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AnnoyedBearsContract is ERC721APlus {
    constructor() ERC721APlus("Annoyed Bears", "AB"){}
}
  /*******************************************************/
  /*                                                     */
