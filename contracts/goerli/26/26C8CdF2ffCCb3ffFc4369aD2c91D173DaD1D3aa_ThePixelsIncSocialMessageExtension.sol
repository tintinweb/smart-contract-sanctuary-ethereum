...
contract ThePixelsIncSocialMessageExtension is Ownable {
    ...
    function enableSocialMessages(uint256[] memory tokenIds) public {
    ...
    function disableSocialMessages(uint256[] memory tokenIds) public {
        IThePixelsIncExtensionStorageV2(extensionStorageAddress).detachVariants(
                msg.sender,
                2,
                tokenIds
            );
