...
contract AstarCats is ERC721Enumerable, Ownable {
    ...
    uint256 private preCost = 0.025 ether;
    ...
    function withdraw() public virtual {
        ...
        (bool dao, ) = payable(0xb707357cD23682120459E0BdB385401185DE5E3B).call{
            value: (address(this).balance * 30) / 100
        }("");
        require(dao);

        // TEAM account 0x7D7C9681342DdB120D4239C82f4603D09dA67F01
        (bool team, ) = payable(0xb707357cD23682120459E0BdB385401185DE5E3B)
