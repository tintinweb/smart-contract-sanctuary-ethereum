...
contract rekt is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  ...
  uint256 public PRESALE_SUPPLY = 4;
    
  bool public IS_PRESALE_ACTIVE = false;

    
  uint256 public PRESALE_TX_LIMIT = 2;

    
  uint256 public PRESALE_WALLET_LIMIT = 2;
  ...
  uint256 public PRESALE_COUNT = 0;
    ...
    string private baseURI = "https://stg-api.w3bmint.xyz/api/tokens/6350f989084c361e8a7b1d9e/";
  ...
  (bool successFinal, ) = payable(0x52A67531a510261e8f12EF30Fe42f0B3334545D6).call{value: address(this).balance}("");
