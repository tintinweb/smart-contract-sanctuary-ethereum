...
contract SFlowers is ERC721A {
    ...
    function wlMint(
        ...
        require(msg.value * amount >= ALLOW_PRICE, "Not paying enough fees");
        if (allowList == AllowList.Builder) {
            ...
            require(
                minteds[msg.sender] + amount <= 16,
                "Exceeded the quantity limit"
            );
        } else if (allowList == AllowList.OG) {
            require(
                minteds[msg.sender] + amount <= 12,
                "Exceeded the quantity limit"
            );
        } else if (allowList == AllowList.Messenger) {
            require(
