    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeih3vmuuixtmguxxamqa4rorfvgd6cctzgbcobnxrbne6ooioclisy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/j6v3dMh7XuP7MvYsAzKK/contract-metadata";
  }
...
// File: contracts/FinaltestingContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FinaltestingContract is RamppERC721A {
    constructor() RamppERC721A("FINAL TESTING", "JJC"){}
}
