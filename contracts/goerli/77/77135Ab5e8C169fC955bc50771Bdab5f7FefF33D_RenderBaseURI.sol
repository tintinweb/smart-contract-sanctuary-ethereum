...
contract RenderBaseURI is IRender3NUM, Ownable {
    ...
    constructor(address _minter, string memory _name) {
        minter = _minter;
        name = _name;
    }
    ...
    function mintPFP(uint256 tokenId) external onlyMinter returns (uint256) {
        ...
        emit PFPMinted(name, tokenId, _subTokenId);
    ...
    function tokenURI(uint256 _tokenId) external view returns (string memory) {
        ...
        string memory Id = subId.toString();
