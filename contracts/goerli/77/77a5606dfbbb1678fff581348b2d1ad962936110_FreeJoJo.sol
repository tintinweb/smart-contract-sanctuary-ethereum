    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public mintSupply = 7777;
    ...
    constructor() ERC721A("FreeJoJo", "JOJO") {}
	...
	*/
    ...
    function setMaxMintSupply(uint256 _amount) public onlyOwner {
        mintSupply = _amount;
    }
	...
	*/
    ...
    // PHASE 1 CLAIM
    function claimJoJos(uint256 _mintAmount, bytes32[] calldata _merkleProof)
        public
        payable
    {
        require(
        ...
        require(claimsEnabled, "The whitelist sale is not enabled!");
    ...
    // PUBLIC MINT
    function mintJoJos(uint256 _mintAmount) public payable {
        require(
            _mintAmount > 0 && _mintAmount <= maxMintAmountPerTx,
            "Invalid mint amount!"
        );
