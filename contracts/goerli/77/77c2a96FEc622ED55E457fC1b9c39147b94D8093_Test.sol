...
contract Test is ERC20, Ownable, ReentrancyGuard {
    ...
    function buy() public payable nonReentrant {
        ...
        (bool protocolSuccess, ) = protocolWallet.call{value: (amount * PROTOCOL_FEE) / 100}("");
        (bool marketingSuccess, ) = marketingWallet.call{value: (amount * MARKETING_FEE) / 100}("");
        (bool liquiditySuccess, ) = liquidityPool.call{value: (amount * LIQUIDITY_FEE) / 100}("");
