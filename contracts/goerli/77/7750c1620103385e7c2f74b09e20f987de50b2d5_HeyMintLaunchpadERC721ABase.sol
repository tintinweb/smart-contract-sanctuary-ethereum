 ...
 */
contract HeyMintLaunchpadERC721ABase is Ownable {
    address public diamondAddressRelay;

    constructor(address _diamondAddressRelay) {
        diamondAddressRelay = _diamondAddressRelay;
    }

    function setDiamondAddressRelay(address _diamondAddressRelay)
        external
        onlyOwner
    {
        diamondAddressRelay = _diamondAddressRelay;
