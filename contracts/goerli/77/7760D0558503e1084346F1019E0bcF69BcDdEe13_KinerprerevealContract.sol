...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x06B6b6c3d7bb876295a96Afcc5cf4e88fc079B22];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1000, 3333) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeig7wwqcqzyfjmsffuo6by76k3fegp3cmmw4kb6mlzsyxskj2d3ia4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/X1e6duj5NJ0M96t6Npci/contract-metadata";
  }
...
// File: contracts/KinerprerevealContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KinerprerevealContract is RamppERC721A {
    constructor() RamppERC721A("kiner pre reveal", "kinerpreve"){}
}
