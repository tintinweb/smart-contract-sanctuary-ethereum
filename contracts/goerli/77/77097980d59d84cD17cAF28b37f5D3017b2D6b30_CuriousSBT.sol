 ...
 * @notice This contract handles minting Curious SBT tokens.
 */
contract CuriousSBT is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xF8801B0116aC51B24030360de62B6B2Af9cAE4Cb;
    ...
    uint256 public PRESALE_MAX_SUPPLY = 700;
    ...
    uint256[] public payoutBasisPoints = [7000, 1000, 2000];
    uint96 public royaltyFee = 500;

    constructor()
        ERC721A("Curious SBT", "CSBT")
        RevokableOperatorFilterer(
