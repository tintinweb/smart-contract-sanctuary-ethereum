...
/**
 * @title EngelsRefitsToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract EngelsRefitsToken is ERC20Capped, Ownable {

    constructor() ERC20("Engels Refits Token","NGRS") ERC20Capped(1000000000 * (10**uint256(decimals())))  { 
     }
