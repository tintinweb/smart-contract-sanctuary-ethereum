    ...
    ERC20BurnableUpgradeable
{
    ...
    function enableOrDisableWhitelist(bool isWhitelist) external onlyOwner {
        enableWhiteList_ = isWhitelist;
        emit EnableOrDisableWhitelist(isWhitelist);
    }

    /**
    @dev view whitelist enabled or not
     */
    ...
    function addToWhitelist(address _beneficiary) external onlyOwner {
        require(_beneficiary != address(0), "Account cant be zero address");
        require(!_whitelist[_beneficiary], "Account is blacklisted");
