...
contract StrongStaking is Ownable {
    ...
    IERC20 public immutable Strong;
    ...
    constructor ( 
        ...
        require( _Strong != address(0) );
        Strong = IERC20(_Strong);
    ...
    function stake( uint _amount, address _recipient ) external returns ( bool ) {
        ...
        Strong.safeTransferFrom( msg.sender, address(this), _amount );
    ...
    function forfeit() external {
        ...
        Strong.safeTransfer( msg.sender, info.deposit);
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        Strong.safeTransfer( msg.sender, _amount );
    ...
    function contractBalance() public view returns ( uint ) {
        return Strong.balanceOf( address(this) ).add( totalBonus );
    }
