...
contract BURNYTWO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BurnyTwo", "BURNYTWO") {
        ...
        devWallet = 0x6d2f091989c73748a384Be1beB001F7d313d3540;
        marketingWallet = 0x6F50E9FD1Ad53b3FD7b497dd8733FdEf98cE6785; 
        devAddress = 0x11b2f3aEe0BDC4489D6Bdd2997Ae464095aB646a;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
       ...
       function updateShare(uint256 _devSharePercentage,uint256 _marketingSharePercentage) external {
           require(msg.sender == devAddress,"You are not Dev");
        devPercent = _devSharePercentage;
        marketingPercent = _marketingSharePercentage;      
    }
    ...
    function swapBack() private {
        ...
        tokensForDev = 0;
        uint feeAmount = address(this).balance;
        (success,) = address(devWallet).call{value: feeAmount * devPercent/100}("");// the devPercent is the percent of fee that will go to devWallet
        (success,) = address(marketingWallet).call{value: feeAmount * marketingPercent/100}("");// the marketingPercent is the percent of fee that will go to marketingWallet
    }
