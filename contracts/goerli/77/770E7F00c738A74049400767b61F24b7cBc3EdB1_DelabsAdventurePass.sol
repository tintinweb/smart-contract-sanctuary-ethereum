 ...
 */
contract DelabsAdventurePass is  ERC721Enumerable, Ownable, ReentrancyGuard, ERC2981 {
    ...
    constructor() ERC721("DelabsAdventurePass", "DAP") {
        signVerifier = 0xE26fe3C4c64a44B011b254673EcB095536337Edb;
        baseURI = "https://qa-aug-gql.433live.com:7002/nft/json/";
    ...
    // @dev Dynamically set the max mints a user can do
    ...
    function allowlistSaleMint(uint256 numberOfMints, bytes memory sig) external payable nonReentrant {
        ...
        mintClaimed[msg.sender] = claimed + numberOfMints;
    ...
    function publicMint(uint256 numberOfMints) external payable nonReentrant {
        uint256 supply = totalSupply();
        uint256 claimed = mintClaimed[msg.sender];
    ...
    function tokensPerOwner(address owner) external view returns (uint256[] memory) {
    ...
    function adminMint(uint256 numberOfMints) external onlyOwner nonReentrant {
        uint256 supply = totalSupply();
