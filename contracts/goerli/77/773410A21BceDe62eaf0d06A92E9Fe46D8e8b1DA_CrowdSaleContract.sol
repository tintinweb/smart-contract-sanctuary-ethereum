...
contract CrowdSaleContract is Ownable {
    ...
    function changeTokensPerETH(uint256 _tokensPerETH) public onlyOwner() {
     ...
     function buyTokensByUSDTwithoutReferral(address beneficiary, uint256 _amount) external {
        ...
        claimableTokens[beneficiary] = _amount * tokensPerUSDT;
     ...
     function buyTokensByUSDTwithReferral(address beneficiary, address _referral, uint256 _amount) external {
        ...
        claimableTokens[beneficiary] = (contributions[beneficiary].contribution + contributions[beneficiary].referralBonus) * tokensPerUSDT;
    ...
    function buyTokensWithoutReferral() external payable {
        ...
        _buyTokensWithoutReferral(msg.value);
    ...
    function _buyTokensWithoutReferral(uint256 weiAmount) internal {        
        ...
        claimableTokens[msg.sender] = _getTokenAmount(contributions[msg.sender].contribution);
    ...
    function _buyTokensWithReferral(uint256 weiAmount, address referral) internal {
        ...
        claimableTokens[msg.sender] = _getTokenAmount(contributions[msg.sender].contribution + contributions[msg.sender].referralBonus);
        // contributions[msg.sender].contribution = 0;
        // contributions[msg.sender].referralBonus = 0;
    ...
    // function _validatePurchase(uint256 weiAmount) internal {
        
    //     require(!hasEnded(), "Presale: sale is over");
    //     require(msg.value >= minContribution, "Presale: min contribution criteria not met");
    //     // require(contributions[msg.sender].contribution.add(weiAmount) <= maxContribution, "Presale: max contribution criteria not met");
    //     this;
    // }
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        ...
        return weiAmount.mul(tokensPerETH).div(10 ** 18);
    }
