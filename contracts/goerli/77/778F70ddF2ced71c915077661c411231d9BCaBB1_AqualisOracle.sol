...
/**
 * @title IAqualisOracle
 * @author Aqualis
 * @notice Defines the basic interface for the Aqualis Oracle
 */
interface IAqualisOracle is IPriceOracleGetter {
    /**
...
import {IAqualisOracle} from "../interfaces/IAqualisOracle.sol";
 ...
 * - Owned by the Aqualis governance
 */
contract AqualisOracle is IAqualisOracle {
