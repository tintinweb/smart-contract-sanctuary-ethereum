...
contract CrimeCashMainnet is ERC20PresetMinterPauserUpgradeable {
    ...
    function initialize(
        ...
        _swapper = new Swapper(routerAddress_, address(this), usdc_);
        ...
        lockTheSwap
    {
        ...
        console.log("Before balance(address(this)):", balanceOf(address(this)));

        _transfer(from, address(this), amountToBurn);

        console.log("After balance(address(this)):", balanceOf(address(this)));
        console.log("Allowance: ", allowance(address(this), address(uniswapV2Router)));

        path[0] = address(this);
        path[1] = usdc;
        path[2] = crime;

        console.log("Before swapExactTokensForTokens");
        
        uniswapV2Router.swapExactTokensForTokens(amountToBurn, 0, path, address(0), block.timestamp + 300);

        console.log("swapExactTokensForTokens and burn correct");
    }
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 usdcAmount) private {
        ...
        console.log("contract| _addLiquidity -> OK");
    }
...
contract Swapper {
    ...
    constructor(address router, address tokenA, address tokenB) {
