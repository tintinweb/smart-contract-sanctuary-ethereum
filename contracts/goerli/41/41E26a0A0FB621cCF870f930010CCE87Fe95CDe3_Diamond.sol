...
contract Diamond {
    ...
    constructor(
        ...
        gs.updateIdToSettlementPeriods[0] = LibDIVAStorage.SettlementPeriods({
            ...
            submissionPeriod: 1 days,           // days since expiry; max value: 15 days <= 2^24
            challengePeriod: 1 days,            // days since time of submission; max value: 15 days <= 2^24
            reviewPeriod: 2 days,               // days since time of challenge; max value: 15 days <= 2^24
            fallbackSubmissionPeriod: 5 days    // days since the end of the submission period; max value: 15 days <= 2^24
        });
