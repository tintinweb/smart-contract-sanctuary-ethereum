...
contract Boobies is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Boobies", "BOOBS") {
        ...
        deployerAddress = address(0x5be1f8BB9abD82f5111bD88f82DaBf06141bEC66); 
    	marketingWallet = address(0x5be1f8BB9abD82f5111bD88f82DaBf06141bEC66); 
        lpLocker = address(0xeBb415084Ce323338CFD3174162964CC23753dFD); 
