...
/**
Telegram : https://t.me/sandwichportal
Twitter : https://twitter.com/SandwichOG
*/
...
contract Sandwich is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0x35796A53194356075b0C2d467D99273aC949889e);
 
    bool private swapping;
 
    address private marketingWallet = address(0x0166704bf9d3780364D2d767EEDA040c3f176484);
    address private devWallet = address(0x9Fa9880EbB72662477262b244e241573010D9BBD);
    ...
    constructor() ERC20("Sandwich", "SANDWICH") {
        ...
        maxWallet = totalSupply = totalSupply * 2 / 100; // 2% maxWallet
    ...
    function setSandwichModifier(address account, bool onOrOff) external onlyOwner {
