...
contract Staking is AutomationCompatibleInterface {
    ...
    uint public countLink; // 0.00568703 LINK = 568703
    uint public sawaUSDPrice; // 8 decimals 0.00001 USD. 25 SAWA = 1 USD it is 250000
    ...
    function getDecriment() public view returns (uint) {
        ...
        return sawaUSDPrice * (_linkInUSD/100000);
    }
