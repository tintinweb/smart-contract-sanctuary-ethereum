...
contract ChapterDao is ERC721PsiBurnable, ReentrancyGuard {
    ...
    function isWhitelistedForMint(address _address)
        external
        view
        returns (bool)
    {
    ...
    function whitelistForMint(address[] calldata _addresses, bool _toggle)
        external
        onlyAmbassador
    {
        if (_toggle) {
    ...
    function distributeBackFunds(uint256 amount)
        external
        payable
        onlyAmbassador
    {
