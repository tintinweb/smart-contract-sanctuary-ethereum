...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x8dB0C5754A6823893D2e12cD65023671F35c875e];
  address public erc20Payable = 0x8dB0C5754A6823893D2e12cD65023671F35c875e;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmd5Wqj5uRzSyFrx1JHrD6Yrb4k5eseT7N9cNAEgYYHEny/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/FjRJUerGmUr7kvcbJ95P/contract-metadata";
  }
...
// File: contracts/PepEverseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PepEverseContract is RamppERC721A {
    constructor() RamppERC721A("PEPEverse", "PEPEV"){}
}
