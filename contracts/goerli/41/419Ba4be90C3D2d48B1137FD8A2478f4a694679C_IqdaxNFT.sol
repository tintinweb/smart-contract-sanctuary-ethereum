...
contract IqdaxNFT is ERC721URIStorage, Ownable {
    ...
    uint256 public limitSell = 8000;

    constructor() ERC721("The IqdaxNFT", "IQDAX") {}

    function updateWhitelistStatus(uint256 _newLimit) external onlyOwner {
        limitSell = _newLimit;
    }
    ...
    function mint(uint tokenId) external payable {
        ...
        require(totalSupply + 1 <= limitSell, "Max limit");
        require(totalSupply + 1 <= MAX_NFT, "Max NFT");
