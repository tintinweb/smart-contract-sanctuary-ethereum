...
contract Nafta is INafta, ERC721, ERC721Holder, Ownable {
  ...
  /// @param flashFee - The fee user has to pay for a single rent (in WETH9) [Range: 0-4722.36648 ETH]
  /// @param pricePerBlock - If renting longterm - this is the price per block (0 if not renting longterm) [Range: 0-4722.36648 ETH]
