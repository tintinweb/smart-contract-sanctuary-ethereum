...
contract Soul is ERC721Enumerable {
    ...
    function toggleBurningAllowed() external {
    ...
    function setTmpMaxSupply(uint256 maxSupply) external {
        require(
    ...
    function setPublicMintCost(uint256 mintCost) external {
        publicMintCost = mintCost;
    }

    function setAllowListMintCost(uint256 mintCost) external {
    ...
    function setMaxPerWalletAL(uint256 _maxPerWallet) external {
