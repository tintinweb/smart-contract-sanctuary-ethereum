...
contract Trax is ERC20, Ownable {
    ...
    function burn(address account, uint256 ammount) public onlyOwner {
    ...
    function TransferTRX(
        ...
        transfer(to, amount);
        emit portfolioDetails(from, portName, ctHash, message);
    }
}