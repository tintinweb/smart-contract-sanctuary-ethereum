...
contract CryptoPunksMarket {
    ...
    function CryptoPunksMarket() payable {
        ...
        owner = msg.sender;
        totalSupply = MAX_TOTAL_SUPPLY;                        // Update total supply
        punksRemainingToAssign = totalSupply;
        name = "MOCKCRYPTOPUNKS";                                   // Set the name for display purposes
        symbol = "MOCKC";                               // Set the symbol for display purposes
    ...
    function setInitialOwner(address to, uint punkIndex) {
        ...
        if (punkIndex >= MAX_TOTAL_SUPPLY) throw;
