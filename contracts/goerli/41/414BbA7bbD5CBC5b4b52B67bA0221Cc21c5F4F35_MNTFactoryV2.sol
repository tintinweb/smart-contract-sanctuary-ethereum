...
contract MNTContractStandardV2 is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
...
import "./MNTContractStandardV2.sol";
...
contract MNTFactoryV2  is Ownable {
    ...
    external returns(address instance) {
        ...
        require(mntImplementationStandard == address(mntImplementationStandard), "invalid implementation address");

        instance = Clones.clone(mntImplementationStandard);

        (bool success1, ) = instance.call(abi.encodeWithSignature("initializeStandard(address, uint256, string, string, string, uint256, uint256)",_creator, _pinCode, _nftName,  _nftSymbol, _baseURL, _royalties, _maxSupply));
