...
contract MyEpicNFT is ERC721URIStorage {
    ...
    string[] firstWords = ["White", "Black", "Red", "Blue", "Green", "Yellow"];
    string[] secondWords = ["Big", "Small", "New", "Old", "Fast", "Small"];
    string[] thirdWords = [
        "Car",
        "Train",
        "Airplane",
    ...
    function makeAnEpicNFT() public {
        // 上限を設定する。
        require(_tokenIds.current() <= 50, "No more NFT can be issued.");
    ...
    function TotalMintCount() public view returns (uint256) {
        uint256 mintCount = _tokenIds.current();
        return mintCount;
    }
}
