...
contract SoundPlayer {
    ...
    function getScriptAndSong(
        ...
        bytes memory song = abi.encodePacked(
            ...
            ",rowLen:",
            Strings.toString(songs[_address][_index].rowLen),
            ",patternLen:",
            Strings.toString(songs[_address][_index].patternLen),
            ",endPattern:",
            Strings.toString(songs[_address][_index].endPattern),
            ",numChannels:",
            Strings.toString(songs[_address][_index].numChannels),
            "}"
        );
