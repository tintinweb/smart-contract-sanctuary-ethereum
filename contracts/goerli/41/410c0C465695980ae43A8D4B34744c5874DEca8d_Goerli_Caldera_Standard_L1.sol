...
contract Goerli_Caldera_Standard_L1 is IBridgeRouterBase {
    ...
    function initialize(address _singularityRouterAddress, address _nativeCurrencyWrappedAddress, address _nativeCurrencyAddress, address[] calldata _adminAddresses, address _opL1BridgeAddress) public initializer {
        IBridgeRouterBase_init(_singularityRouterAddress, _nativeCurrencyWrappedAddress, _nativeCurrencyAddress, _adminAddresses);
...
*/
    ...
    function performBridgeAction(
        ...
        if(_tokenAddress == nativeCurrencyWrappedAddress) {
    ...
    function _bridgeErc20Call(
        ...
        require(_destChainId == 10 || _destChainId == 9981, "Invalid ChainId");
...
abstract contract IBridgeRouterBase is Initializable, OwnableUpgradeable, ERC2771Recipient, PausableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function IBridgeRouterBase_init(address _singularityRouterAddress, address _nativeCurrencyWrappedAddress, address _nativeCurrencyAddress, address[] calldata _adminAddresses) internal onlyInitializing {
        __Pausable_init();
        __Ownable_init();
        __AccessControl_init();
        __ReentrancyGuard_init();

        IBridgeRouterBase_init_unchained(_singularityRouterAddress, _nativeCurrencyWrappedAddress, _nativeCurrencyAddress, _adminAddresses);
    }


    function IBridgeRouterBase_init_unchained(address _singularityRouterAddress, address _nativeCurrencyWrappedAddress, address _nativeCurrencyAddress, address[] calldata _adminAddresses) internal onlyInitializing {
