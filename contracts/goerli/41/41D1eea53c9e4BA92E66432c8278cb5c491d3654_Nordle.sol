    ...
    VRFConsumerBaseV2
{
    ...
    function _submitChainlinkApiRequest(
        ...
        req.add(
            "get",
            string.concat("https://c050-4-71-27-132.ngrok.io", phrase)
        );
    ...
    function _burnWord(uint256 tokenId) internal {
        ...
        userTokenIds[owner][index] = userTokenIds[owner][
            userTokenIds[owner].length - 1
        ];
    ...
    function getBurnedTokenIds(address user)
        public
        view
