    ...
    DefaultOperatorFilterer
{
    ...
    address[] public _payees = [0xf4FCD53F19F1a8d0675C96fE8DBfb12F20bcef37];
    ...
    ) external payable canMint(amount, price[Phases.WHITELIST]) nonReentrant {
        require(
    ...
    // Minting fee
    function setPrice(Phases _p, uint amount) external onlyOwner {
        price[_p] = amount;
    }
    ...
    function setSigner(Phases _p, address value) external onlyOwner {
        signer[_p] = value;
    }
