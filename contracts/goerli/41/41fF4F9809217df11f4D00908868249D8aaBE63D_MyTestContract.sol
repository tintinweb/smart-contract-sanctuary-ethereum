...
contract MyTestContract is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _initPreviewURI) ERC721A("Mr Test Stake Contract", "MTSC"){
    ...
    //OWNER FUNCTIONS
    //Reserved mint
    function reservedMint(uint256 _mintAmount) external callerIsUser onlyOwner {
        require(totalSupply() + _mintAmount <= maxSupply, "Total Supply Exceeded");
