...
contract Cantofornia is ERC721A, Ownable {
    ...
    //Pricing
    //***************************************************************************************************
    uint256 public pricePartner = .001 ether; //set NFT price
    uint256 public pricePresale = .001 ether; //set NFT price
    uint256 public pricePublic = .002 ether; //set NFT price

    //***************************************************************************************************
    //Supply and Reserve
    //***************************************************************************************************
    uint256 public maxSupply = 3333; // set max supply according to your need
    uint256 public reserve = 100; // management tokens

    //***************************************************************************************************
    //Max per Wallets
    //***************************************************************************************************
    uint256 public maxPartnerMint = 50; //set how many NFTs can be minted per wallet for partner
    uint256 public maxPreSaleMint = 50; //set how many NFTs can be minted per wallet in pre sale
