...
contract Posting is ERC721, IPosting {
    ...
    //在哪里用到？ 哪里用constructor create的posing contract？
    ...
    function post(
        ...
        //safeMint了个啥？ 一个新transaction？ //msg.sender 是啥？
    ...
    function update(
        ...
        // Update in PostStorage //这个是post到ethstorage上去的吗？
    ...
    function remove(uint256 itemId) external override {
        ...
        // Delete from PostStorage //意思是否从ethstorage上删除？
        bytes memory name = abi.encodePacked(getItem[itemId].category, itemId);
