...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x634957B35E5E6cE51D665201cc37C96c09b0B053];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x634957B35E5E6cE51D665201cc37C96c09b0B053;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/Qmdckae3QUcRy5asZvMrWRsBHt27zsRX6DxRdSMgFtTw7A/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1200");
...
// File: contracts/WildAntGameContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WildAntGameContract is RamppERC721A {
    constructor() RamppERC721A("Wild Ant Game", "Ant"){}
}
