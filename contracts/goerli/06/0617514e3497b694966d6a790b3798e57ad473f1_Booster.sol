...
contract Booster is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable {
    enum ContractStatus {
        Sale,
        Paused
    }
    ...
    function geQuantityMintedForAddress(address account) external view returns (uint256) {
    ...
    function burn(uint256 tokenId) public override callerIsBallerContract {
        setApprovalForAll(ballerContract, true);
        _burn(tokenId, false);
    }
