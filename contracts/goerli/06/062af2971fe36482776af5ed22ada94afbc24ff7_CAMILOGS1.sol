...
contract CAMILOGS1 is Ownable, ReentrancyGuard, ERC721A {
using Strings for uint256;

  uint256 public maxMintAmount = 4;
  bytes32 public AdminMerkleRoot;
  uint256 Price = 0.0000000001 ether;
  ...
  constructor() ERC721A("GS CAMILO", "V2") {
  }
