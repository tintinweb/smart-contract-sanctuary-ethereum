    ...
    PausableUpgradeable
{
    ...
    // constructor() initializer {}
      ...
      function initialize(
        ...
        uint256[8][2] memory _tokenQuantity = [
                [uint256 (1000), uint256 (3000), uint256 (10000), uint256 (25000), uint256 (50000), uint256 (100000), uint256 (250000), uint256 (500000)],
                [uint256 (100), uint256 (300), uint256 (600), uint256 (900), uint256 (1200), uint256 (1600), uint256 (2000), uint256 (2500)]
                ];
        uint256[8][2] memory _lockup = [
                [uint256 (6), uint256 (8), uint256 (10), uint256 (12), uint256 (15), uint256 (18), uint256 (21), uint256 (24)],
                [uint256 (100), uint256 (300), uint256 (600), uint256 (900), uint256 (1200), uint256 (1600), uint256 (2000), uint256 (2500)]];
        uint256 _defaultLockup =3;
        uint256 _initialClaimPercent = 0;
        // address _admin = "0xb2AeC2180211c53a938C116Ef4cdB99ec2bA9153";
        ...
        if (_amount + totalTokensSold > rounds[0][currentStep]) {
            ...
            if (linearStartTime == 0) {
                ...
                USDTAmount =
                    ...
                    (rounds[1][currentStep] +
                        ((rounds[1][currentStep] *
                            (((block.timestamp - linearStartTime) *
                                baseDecimals) / (endTime - linearStartTime))) /
                            baseDecimals));
            }
        }
        return USDTAmount;
