...
contract PengHelperEth is Initializable, OwnableUpgradeable, UUPSUpgradeable, PausableUpgradeable {
    ...
    address public pengTogetherHelper; // optimism
    ...
    function initialize(address _pengTogetherHelper) external initializer {
        __Ownable_init();
    ...
    function deposit(IERC20Upgradeable token, uint amount, uint amountOutMin) external payable {
        ...
        if (token == weth) {
            ...
            stargateRouter.swap{value: gas}(
                ...
                IStargateRouter.lzTxObj(40000, 0, "0x"), // TODO additional gasLimit increase // _lzTxParams
                abi.encodePacked(pengTogetherHelper), // _to
                abi.encode(msgSender, amountOutMin) // _payload
            );
            ...
            stargateRouter.swap{value: msgValue}(
                ...
                IStargateRouter.lzTxObj(40000, 0, "0x"), // TODO additional gasLimit increase // _lzTxParams
                abi.encodePacked(pengTogetherHelper), // _to
                abi.encodePacked(msgSender, amountOutMin) // _payload
            );
        }
    }
