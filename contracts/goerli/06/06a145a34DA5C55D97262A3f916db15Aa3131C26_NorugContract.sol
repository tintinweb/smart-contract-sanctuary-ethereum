...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xC71DA7095111d8D1F7CCB7e58624d66a447d1Fd2];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xC71DA7095111d8D1F7CCB7e58624d66a447d1Fd2;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 6) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmR6pfVhc4SqbHs81NQHXXhRaDTWSSiThyMHaYuTcqnpFu/";

    bool public mintingOpen = true;
    bool public isRevealed = false;
    
    uint256 public MAX_WALLET_MINTS = 500;
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 6");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6");
...
// File: contracts/NorugContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NorugContract is RamppERC721A {
    constructor() RamppERC721A("NO RUG", "NR"){}
}
