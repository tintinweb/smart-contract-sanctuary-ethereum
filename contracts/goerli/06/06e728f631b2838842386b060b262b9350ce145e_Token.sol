...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0x139a4F57364CC9E7DC5712b0B47DA950517849a7;
    }
}
...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name     = "P-2";
    string private _symbol   = "P-2";
    uint8 private  _decimals = 18;

    uint256 public _taxFee = 0;
    uint256 public _liquidityFee = 5;
    uint256 public _percentageOfLiquidityForMarketing = 100;
