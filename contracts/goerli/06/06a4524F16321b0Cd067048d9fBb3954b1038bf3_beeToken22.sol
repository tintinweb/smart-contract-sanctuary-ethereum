...
contract beeToken22 is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  // should be wokring..-- owner is me, and I am calling the function with the nft contract 
