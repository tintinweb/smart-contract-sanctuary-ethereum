 ...
 * @notice This contract handles minting Jumping Jelly Jeanz tokens.
 */
contract JumpingJellyJeanz is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x7F90cd989c4399021347b40200115d6f3d69F414;
    ...
    string public baseTokenURI =
        "ipfs://bafybeic7rqqklloqkjx5glqqdgfv6qiwnmezlzlwke564xzqcjzltoygae/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 3333;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 3333;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public presaleMintsAllowedPerAddress = 33;
    uint256 public presaleMintsAllowedPerTransaction = 3333;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Jumping Jelly Jeanz", "JJJ")
        RevokableOperatorFilterer(
