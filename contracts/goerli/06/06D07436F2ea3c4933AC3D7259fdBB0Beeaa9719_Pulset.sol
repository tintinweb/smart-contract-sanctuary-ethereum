...
contract Pulset is Context, IERC20, Ownable {
    ...
    uint256 public _marketingTaxFee = 50;
    ...
    bool public isGetMarketingFee = true;
    ...
    constructor() public {
        ...
        liquidityAddress = _uniswapV2Pair;
    ...
    function setMarketingFeePercent(uint256 _marketFee)
        external
        onlyOwner
    {
        _marketingTaxFee = _marketFee;
    }
    ...
    function _tokenTransfer(
        ...
        bool currentStateFee = isGetMarketingFee;
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            !ammPairs[recipient] &&
            ...
            //swap fee
            swapAndLiquify(contractTokenBalance.mul(_marketingTaxFee).div(100));
            isGetMarketingFee = false;
        }
        if (
            overMinTokenBalance &&
            !inSwapAndLiquify &&
            ...
            contractTokenBalance = numTokensSellToAddToLiquidity;
            //swap fee
            isGetMarketingFee = true;
            swapAndLiquifyLp(contractTokenBalance.sub(contractTokenBalance.mul(_marketingTaxFee).div(100)));
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(contractTokenBalance, advertisementWallet); // <- this breaks the ETH -> HATE swap when swap is triggered
    ...
    function swapAndLiquifyLp(uint256 contractTokenBalance) private lockTheSwap {
