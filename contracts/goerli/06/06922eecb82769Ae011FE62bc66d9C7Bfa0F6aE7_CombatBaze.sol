...
contract CombatBaze is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function setPrice(uint256 _ethPrice) external onlyOwner {
        ethPrice = _ethPrice;
    }

    function buyMembershipUsdt(uint256 _pid) external payable {
        TokenInfo storage tokens = AllowedCrypto[_pid];
        //IERC20 paytoken;
        paytoken = tokens.paytoken;
        uint256 cost;
        cost = tokens.costvalue;
        require(msg.value >= cost, "Price Error");
