 ...
 */
contract SingleCollection is Initializable, ContextUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, ERC721Base, SignerRole {
...
/*     constructor (string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) ERC721Base(name, symbol, contractURI, tokenURIPrefix) {
    ...
    function __SingleCollection_init(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) external initializer {
        __SingleCollection_init_unchained(name, symbol, contractURI, tokenURIPrefix, signer);
    }

    function __SingleCollection_init_unchained(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix, address signer) internal initializer {
...
/*     /// @notice The function for token minting. It creates a new token.
    ...
    function tokenURI(uint256 tokenId) public override(ERC721Base, ERC721Upgradeable) view returns (string memory) {
        require(_exists(tokenId), "ERC721Metadata: URI query for nonexistent token");
        return super._tokenURI(tokenId);
    }

    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Base, ERC721Upgradeable) returns (bool) {
        return super.supportsInterface(interfaceId);
    }

    function _beforeTokenTransfer(address from, address to, uint256 amount) internal override(ERC721Base, ERC721Upgradeable)
    {
...
/*     constructor(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix) SingleCollection(name, symbol, contractURI, tokenURIPrefix, address(this)) {} */
    ...
    function __SingleUserCollection_init(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix) external initializer {
        __SingleUserCollection_init_unchained(name, symbol, contractURI, tokenURIPrefix);
    }

    function __SingleUserCollection_init_unchained(string memory name, string memory symbol, string memory contractURI, string memory tokenURIPrefix) internal initializer {
        __SingleCollection_init_unchained(name, symbol, contractURI, tokenURIPrefix, address(this));
        // __HasSecondarySaleFees_init_unchained();
        __Context_init_unchained();
        __ERC165_init_unchained();
        __Ownable_init_unchained();
 ...
 */
contract ERC721Base is Initializable, ContextUpgradeable, OwnableUpgradeable, HasSecondarySaleFees, HasContractURI, HasTokenURI, ERC721BurnableUpgradeable, ERC721EnumerableUpgradeable {
...
/*     constructor (string memory _name, string memory _symbol, string memory contractURI, string memory _tokenURIPrefix) ERC721(_name, _symbol) HasContractURI(contractURI) HasTokenURI(_tokenURIPrefix) { */
    ...
    function __ERC721Base_init(string memory _name, string memory _symbol, string memory contractURI, string memory tokenURIPrefix) external initializer {
        __ERC721Base_init_unchained(_name, _symbol, contractURI, tokenURIPrefix);
    }

    function __ERC721Base_init_unchained(string memory _name, string memory _symbol, string memory contractURI, string memory tokenURIPrefix ) internal initializer {
        // _setBaseURI(baseURI);
        __HasSecondarySaleFees_init_unchained();
        __Context_init_unchained();
        __ERC165_init_unchained();
...
/*      `ERC721`: `burn(owner, tokenId)` was removed, use `burn(tokenId)` instead. ([#2125](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/2125)) */
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165StorageUpgradeable, ERC721EnumerableUpgradeable, ERC721Upgradeable) returns (bool) {
        return
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(ERC721Upgradeable, ERC721EnumerableUpgradeable)
    {
        super._beforeTokenTransfer(from, to, amount);
    }
}
