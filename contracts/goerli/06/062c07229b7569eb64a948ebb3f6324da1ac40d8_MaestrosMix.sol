...
contract MaestrosMix is ERC721A, Ownable {
    ...
    uint8 public maxOGFreePerWallet =5; //Max Free mint for WL
    uint8 public maxWLFreePerWallet =4; //Max Limit per Wallet for WL
    uint8 public maxPublicFreePerWallet =3; //Max Free mint for WL
    ...
    uint256 public totalOGLimit=25;
    uint256 public totalWLLimit=40;
    uint256 public totalPublicFreeLimit=30;
    uint256 public totalPaidLimit=220;
