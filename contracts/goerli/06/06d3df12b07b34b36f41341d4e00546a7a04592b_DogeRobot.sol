...
contract DogeRobot is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DogeRobot";
    string private constant _symbol = unicode"DGR";
