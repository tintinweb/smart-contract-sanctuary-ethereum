...
contract XPlanet is ERC721Enumerable, Ownable {
    ...
    function balanceOfUsdc(address _address) public view returns (uint256){
        return ERC20(USDC_CONTRACT).balanceOf(_address);
    }
    ...
    function mint(uint256 _numberOfTokens) public {
        ...
        ERC20(USDC_CONTRACT).approve(address(this),  MINT_PRICE * _numberOfTokens );
        ERC20(USDC_CONTRACT).transferFrom(msg.sender, address(this), MINT_PRICE * _numberOfTokens);
        ...
        for (uint256 i = 0; i < _numberOfTokens; i++) {
            if (totalSupply() < MAX_SUPPLY) {
                ...
                ERC20(USDC_CONTRACT).transferFrom( address(this), msg.sender,  (_numberOfTokens - i) * MINT_PRICE); 
                break;
            }
        }
    }
