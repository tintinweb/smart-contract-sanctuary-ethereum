...
contract GetPoint is OwnControll {
    ...
    IERC721 public ERC721NTP = IERC721(0x1FC8A11ccBce73376b69D6A684ce7F7a1393e84A);
    IERC721 public ERC721ROARS = IERC721(0x6b68D6e03a24B3BBC75be6614C511F57f6de997c);
    IPoint public Point = IPoint(0xB101721F00D4a0Fc71C50b44CD5573CF89e79962);

    uint256 public yieldStartTime = 1685268000; //28/05/2023 9pm JST
    uint256 public yieldEndTime = 2000894400; //28/05/2033 9pm JST (changable)

    uint256 public yieldRatePerPointNTP = 2000;
    uint256 public yieldRatePerPointROARS = 100;
