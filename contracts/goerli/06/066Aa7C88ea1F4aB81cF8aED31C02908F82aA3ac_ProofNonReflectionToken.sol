...
contract ProofNonReflectionToken is Context, IERC20, IERC20Metadata {
    //This token was created with PROOF, and audited by Solidity Finance ΓÇö https://proofplatform.io/projects
    ...
    function setLaunchedAt() external onlyDeployer {
    ...
    function _transfer(
        ...
        if(block.timestamp <= launchedAt + 150 seconds){
          require(IALLOW(allowlist).isAllowed(recipient), "Not allowed");
        }
