...
contract Pumpkin is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public publicMaxSupply = 1500;
    uint256 public publicMaxMintAmount = 2;
    // whitelist
    uint256 public wlCost = 0.012 ether;
    uint256 public wlMaxMintAmount = 2; // 722 left for wl
    // max supply
    ...
    constructor() ERC721A("PUMPKIN", "PUMPKIN") {}
    ...
    modifier publicMintCompliance(uint256 _mintAmount) {
        ...
        require(
            totalSupply() + _mintAmount <= publicMaxSupply,
...
/____/\___/\__/\__/\___/_/  /____/        
  */
    ...
    function setPublicMaxSupply(uint256 _maxSupply) public onlyOwner {
        require(
            _maxSupply <= maxSupply,
            "Public max supply cannot be higher than max supply"
        );
        publicMaxSupply = _maxSupply;
    }
