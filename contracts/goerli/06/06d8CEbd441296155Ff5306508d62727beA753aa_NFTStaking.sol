...
contract NFTStaking is Ownable, IERC721Receiver {
    ...
    constructor(GreenTreeCollection _nft, GTTRewards _token) {
        nft = _nft;
        token = _token;
    }
    ...
    Ownable
{
    ...
    constructor() payable ERC721("GreenTreeCollection", "GT") {
        mintPrice = 0.02 ether;
        isMintEnabled = true;
        baseTokenUri = "ipfs://QmTza6sDEEJDdREdMZdPQed5q7K8FF1YJ3ETbYv9ND4QRa/";
