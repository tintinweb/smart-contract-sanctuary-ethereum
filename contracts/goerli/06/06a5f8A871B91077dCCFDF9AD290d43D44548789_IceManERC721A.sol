...
contract IceManERC721A is Ownable, ERC721A {
    ...
    uint private constant maxPerAddressDuringPublicMint = 20;
    ...
    **/
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external callerIsUser{
        require(!isPaused, "Contract is paused");
        require(currentTime() >= saleStartTime, "Sale has not started yet");
        require(currentTime() < saleStartTime + 1 hours, "Sale is finished");
    ...
    **/
    function publicMint(address _account, uint _quantity) external callerIsUser {
        ...
        require(currentTime() < saleStartTime + 6 hours, "Public Sale is finished"); 
