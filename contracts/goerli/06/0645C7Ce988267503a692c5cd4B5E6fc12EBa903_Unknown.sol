...
contract Unknown is ERC721, ReentrancyGuard, Ownable {
  ...
  constructor(string memory customBaseURI_) ERC721("Unknown", "UNKN") {
  ...
  uint256 public constant PRICE = 9900000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.0099 ETH per item"
    );
