...
/* ======== DEPOSIT ======== */
  ...
  function deposit(
    ...
    uint256 reward = giveRewards(payout_, _referral);
  ...
  /**
    ...
    * @param _reward      the amount of PANA to be paid to FEO and DAO (combined)
    */
  function _sendToTreasury(uint256 _id, uint256 _amount, uint256 _payout, uint256 _reward) internal {
      ...
      if (market.quoteTokenIsReserve) {
          ...
          require(value > toMint, "Depository: zero or negative profit"); 
