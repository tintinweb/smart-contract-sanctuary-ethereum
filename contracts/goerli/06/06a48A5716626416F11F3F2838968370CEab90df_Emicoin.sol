...
//Compiler 0.8.9 optimizazion 200
...
// File: contracts/emicoin_eth.sol
...
contract Emicoin is ERC20, ERC20Burnable, ERC20Snapshot, AccessControl, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    ...
    constructor() ERC20("Emicoin", "EMI") ERC20Permit("Emicoin") {
    ...
    function deposit(address user, bytes calldata depositData) public onlyRole(DEPOSITOR_ROLE)
    {
