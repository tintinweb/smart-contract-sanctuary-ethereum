 ...
 */
contract BBDEggToken is ERC20, Ownable {
    ...
    constructor(address _treasuryWallet) ERC20("BBD Egg", "EGG") {
    ...
    function airdrop(address wallet, uint256 tokenAmount) public onlyOwner {
        ...
        require(_verifyEGGAvailability(tokenAmount), "400:EXCEEDS_SUPPLY");
    ...
    function claim(address wallet, uint256 tokenAmount) public {
        ...
        require(mintingMin <= tokenAmount, "300:INSUFFICIENT_EGG");
        require(_verifyEGGAvailability(tokenAmount), "400:EXCEEDS_SUPPLY");
        _mint(wallet, tokenAmount);
        claims[wallet] += tokenAmount;
    }
    ...
    function pay(uint256 paymentAmount, uint256 fee) public {
        ...
        require(balanceOf(tx.origin) >= paymentAmount, "300:INSUFFICIENT_EGG");
        uint256 _fee = fee;
    ...
    function _verifyEGGAvailability(uint256 tokenAmount)
        internal
        view
        returns (bool)
    {
