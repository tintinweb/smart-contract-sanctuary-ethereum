...
contract NFT is ERC721A, ERC721AQueryable, Ownable, PaymentSplitter {
    ...
    uint256 public saleStartTime = 1672589837;
    ...
    address[] private _team = [0x779f179b574fd8D305E34161701FBC8217B89a63];

    uint256[] private _teamShares = [100];

    constructor(bytes32 _merkleRoot, string memory _baseURI)
        ERC721A("NFT Alyra", "NFTAly")
    ...
    /**
     *@notice Modifier that runs the code only if the SC is not in pause
     */
    ...
    function whitelistMint(
        ...
        require(
            ...
            "You can only mint 1 NFT durint the Whitelist Sale"
        );
        require(
    ...
    /**
     *@notice allows to pause / unpause the SC
     *
     *@param _isPaused true or false if we want to pause or unpause the SC
     */
     ...
     *
     *@param _merklelRoot The new merkleRoot
     */
    ...
    /**
     *@notice Verify that an address is whitelisted or not (not yet merkle root creation)
     *
