...
contract Lottery {
    ...
    function selectRandomWinner() external {
        ...
        if (totalAmount == 0) {
            ...
            totalGamesPlayed += 1;
            address winner = participants[winNumber-1];
    ...
    function generateRandomNumber()public{
        uint256 _randomNumber = block.number + block.timestamp;
        randomNumber = _randomNumber;
    }

    function getRandomNumber(uint256 maxNumber) public returns(uint256){
        generateRandomNumber();
        uint256 rnNumber = randomNumber % maxNumber + 1;
        return rnNumber;
    }
