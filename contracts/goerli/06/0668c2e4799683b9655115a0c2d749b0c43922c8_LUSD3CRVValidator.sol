...
contract LUSD3CRVValidator is IProofValidator, IValidator {
    ...
    address public constant CURVE3POOL_ADDRESS =
        0x27dF10b439b0b2cc15f510e4B91E7B2A3478E938;
    bytes32 public constant CURVE3POOL_ADDRESS_HASH =
        keccak256(abi.encode(CURVE3POOL_ADDRESS));

    address public constant LUSD3POOL_ADDRESS =
        0xAb61fdA3DF7b3b94c992EeE3604aF57061277009;
    bytes32 public constant LUSD3POOL_ADDRESS_HASH =
        keccak256(abi.encode(LUSD3POOL_ADDRESS));
    ...
    bytes32 public constant TOKEN_ADDRESS_HASH =
        keccak256(abi.encode(TOKEN_ADDRESS));
    ...
    function validate(
        ...
        //Curve3PoolStorage memory curve3Pool = _verifyAndExtract3CurvePoolStorage(curve3PoolAccount.storageRoot,proofs);

        return (true, value_);
    }

    function _verifyAndExtract3CurvePoolStorage(bytes32 storageRoot, RLPReader.RLPItem[] memory proofs
