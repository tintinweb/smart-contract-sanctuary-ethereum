...
contract BM is ERC1155Burnable, ERC2981, Ownable, DefaultOperatorFilterer {
    ...
    function batchMint(
        ...
        tokenQuantity[_tokenId] += _receivers.length * _amount;
    }
    ...
    function addMint(uint256 _tokenId, uint256 _amount) public onlyOwner {
        ...
        tokenQuantity[_tokenId] += _amount;
    }
    ...
    function burn(
        ...
        require(tokenQuantity[_tokenId] >= _amount, "amount is incorrect.");
    ...
    function burnBatch(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            require(tokenQuantity[tokenId] >= amount, "amount is incorrect.");

            tokenQuantity[tokenId] -= amount;
        }
