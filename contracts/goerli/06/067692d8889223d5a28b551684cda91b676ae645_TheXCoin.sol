...
contract TheXCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "The X Coin"; 
    string private constant _symbol = "XOIN"; 
    ...
    address payable private _developmentWalletAddress = payable(0xAa23a9CD64Ac18be582e30f5e8F8a90Ca7bcfB30);
    address payable private _marketingWalletAddress = payable(0xAa23a9CD64Ac18be582e30f5e8F8a90Ca7bcfB30);
