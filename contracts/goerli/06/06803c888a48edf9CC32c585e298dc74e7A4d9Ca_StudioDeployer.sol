    ...
    UUPSUpgradeable
{
    ...
    function validateVoucher(
        ...
        if (StudioDeployerStorage.layout().noncesUsed[voucherId])
            revert VoucherUsed();
    ...
    /// @param deploymentAuth.minter address to set up as initial admin
    ...
    function validateDeploymentAuth(
    ...
    function deploy(DeploymentAuth calldata deploymentAuth, bytes calldata data)
        public
        ...
        returns (address)
    {
        ...
        ITargetInitializer clone = ITargetInitializer(implementation.clone());
        clone.initialize(admin, minter, data);

        emit DeployedContract(address(clone), admin, minter, data);
