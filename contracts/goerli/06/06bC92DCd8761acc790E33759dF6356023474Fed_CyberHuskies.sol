...
contract CyberHuskies is ERC721("Cyber Huskies", "HUSKY"), ERC721Enumerable, Ownable {
    ...
    address private constant contractOwnerAddress = 0x0ac6ebE34BFf52F09f9a61cFd7276975d81f5A88;
    uint256 public NFTPrice = 300000000000000000;  // 0.25 ETH
    bool public reveal;
    ...
    */
        ...
        onlyOwner 
    {
        ...
        payable(contractOwnerAddress).transfer(balance);
    }
