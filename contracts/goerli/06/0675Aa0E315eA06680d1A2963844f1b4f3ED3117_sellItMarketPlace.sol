...
//NFT Auction structures
    ...
    function safeMint(address to, string memory uri) public {
     ...
     function nonNftstartAuction(uint _biddingendtime , address payable _beneficiary , uint256 nonNftId) public {
       ...
       function bidNonNft( uint256 nonNftId) payable public{
        ...
        // payable(nonNftauctions[nonNftId].beneficiary).transfer(nonNftauctions[nonNftId].highestBid);
    ...
    // *****Buy Non-NFTs in Marketplace *****//
        function buyNonNft(uint256 nonNftId) public payable returns (bool) {
            //  require(nonNftauctions[nonNftId].OpenForBidding==false,"Already start the  bidding");
        ...
        // when auction has ended then user cannot buy nonNft
...
// bidding and return pendings//
    ...
    // (deduct the amount from buyer and save the address)****//
   function buy(uint256 tokenId) public payable returns (bool) {
    //   require(auctions[tokenId].OpenForBidding ==false && auctions[tokenId].highestBidder == address(0) && block.timestamp > auctions[tokenId].auctionEndTime,"Bidding in Process");  
        //  require(auctions[tokenId].OpenForBidding==false,"Already start the  bidding");
