...
contract MyNFTMarketplace_By_LoveBlockChain is ERC721URIStorage {

    using Counters for Counters.Counter;
    Counters.Counter private tokenIds;
    Counters.Counter private itemsSold;
    address payable owner;
    uint256 listPrice = 0.0002 ether;
    ...
    constructor() ERC721("MyNFTMarketplace_By_LoveBlockChain", "LCN") {
