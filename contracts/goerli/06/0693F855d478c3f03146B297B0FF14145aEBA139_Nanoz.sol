...
contract Nanoz is Ownable, ERC721A, ERC2981, PaymentSplitter, CantBeEvil {
    ...
    uint256[] private _shares = [3, 97];
    address[] private _shareholders = [
        0x42cf4F70Dc37d84F74f26801498216DaeC3b8646,
        0x7168f65DB8D5a263c208d2C1f38f844590ab4478
    ];
    

    constructor() ERC721A("Nanoz", "Nanoz") PaymentSplitter(_shareholders, _shares) CantBeEvil(LicenseVersion.CBE_NECR_HS) {
