...
contract sample_v1 is Context, ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    uint256 public MAX_SUPPLY = 21_000_001;
    ...
    uint256 public claimRewardBase = 380517503800000000;


    // the number of days waited / maximum claim term
    uint256 private termPercentage;
    ...
    // thus minimum T is set to 86399
    ...
    function _calculateMintReward(
        ...
        uint256 secsLate = block.timestamp - maturityTimestamp;
        uint256 penalty = _penalty(secsLate);
        uint256 rankDelta = Math.max(globalRank - cRank, 2);
        uint256 EAA = (1_000 + eeaRate);
        uint256 reward = getGrossReward(rankDelta, term, claimMaxTerm, EAA);
    ...
    function getGrossReward(
        ...
        // shift all terms to seconds value
        uint256 termBasis = term * 100;
        uint256 claimMaxTermBasis = claimMaxTerm * 100;
        uint256 basis = 10_000;
        // need to determines termsSeconds / maxTermSeconds
        // this is then added to the reward128 section
        uint256 termPercent = (1_000 + getPercentage(termBasis, basis, claimMaxTermBasis));
        int128 log128 = rankDelta.fromUInt().log_2();
        // here need to divide term by the current max term
        int128 reward128 = log128.mul(claimRewardBase.fromUInt()).mul(termPercent.fromUInt()).mul(eaa.fromUInt());
    ...
    function claimRank(uint256 term) external {
        ...
        // require(termSeconds > MIN_TERM, "CRank: Term less than min");
