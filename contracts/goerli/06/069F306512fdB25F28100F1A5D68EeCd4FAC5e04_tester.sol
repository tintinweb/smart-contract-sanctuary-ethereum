...
contract tester is  ERC721Upgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable {

    using Counters for Counters.Counter;
    
    address constant SNContract = 0xC461CD6f4aab1a53A3f22D16Bf9d0b0183D342D8;
    ...
    function mint(uint256[] calldata tokenIds) external {
        ...
        IMinter(0x74BBe6a4C991bd8758D03Fb6750bD3F1B5fb0C5d).mint(to);
    }
...
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    modifier isOwner {
        require(ownerTransferer == msg.sender,"Not owner");
        _;
    }

    function setOwnerAddress(address _owner) external isOwner{
        ownerTransferer = _owner;
    }
