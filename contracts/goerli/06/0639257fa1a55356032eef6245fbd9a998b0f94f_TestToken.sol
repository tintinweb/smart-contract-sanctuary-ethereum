...
contract TestToken is Ownable, ERC721A {
    ...
    uint256 public saleMode = 0;
    string public baseURI =
        "https://bafybeiayd3tmmu6kjjo3edmpovsivprqvbt7llws35got6rqf5pol5mppa.ipfs.nftstorage.link";
    ...
    constructor(address _devAddress) ERC721A("ClubDeBeaute", "CDB") {
    ...
    function setSaleMode(uint256 _saleMode) public onlyOwner {
        saleMode = _saleMode;
    }
