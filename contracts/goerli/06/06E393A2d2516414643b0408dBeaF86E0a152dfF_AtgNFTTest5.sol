...
contract AtgNFTTest5 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function setProjCover(string memory _projCover) public onlyOwner {
    projCover = _projCover;
  }
