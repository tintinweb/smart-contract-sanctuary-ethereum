...
function purchaseWithFixedPrice (
    ...
    bytes32 digest = keccak256(abi.encodePacked(salt, keccak256(abi.encodePacked(nonces[from] ++, nftAddress, tokenId, from, tokenAddr, price, burn_Method))));
...
function purchaseAuction(
  ...
  bytes memory signature 
    ...
    bytes32 digest = keccak256(abi.encodePacked(salt, keccak256(abi.encodePacked(nonces[from] ++, nftAddress, tokenId, from, tokenAddr, price))));
