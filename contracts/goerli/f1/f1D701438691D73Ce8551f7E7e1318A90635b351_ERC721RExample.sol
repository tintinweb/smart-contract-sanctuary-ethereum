...
import "./ERC721A.sol";
import "./VRF/VRFv2DirectFundingConsumer.sol";
...
contract ERC721RExample is ERC721A, Ownable {
    ...
    address vRFv2DirectFundingConsumer = 0xa499f5DAcB43852e5e6834db0c4F7243FA17e0BF;
    ...
    constructor() ERC721A("HongBao", "ERC721R") {
        refundAddress = msg.sender;
        toggleRefundCountdown();
    }

    mapping(address => uint32) public firstPrize;
    ...
    view
    returns (uint256) {
        return VRFv2DirectFundingConsumer(vRFv2DirectFundingConsumer).lastRequestId();
    }
    ...
    returns (uint256[] memory randomWords) {
        uint256 requestId = VRFv2DirectFundingConsumer(vRFv2DirectFundingConsumer).lastRequestId();
        return VRFv2DirectFundingConsumer(vRFv2DirectFundingConsumer).getRequestStatus(requestId);
    }
