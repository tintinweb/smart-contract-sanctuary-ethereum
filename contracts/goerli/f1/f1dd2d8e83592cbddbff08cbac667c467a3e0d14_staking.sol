...
contract staking is Ownable {
    ...
    event SetTax(uint256 depositeTax,uint256 withdrawTax);
    ...
    function setTax(uint256 _depoiteTax,uint256 _withdrawTax) public  onlyOwner{
        require(_depoiteTax<=200,"Deposite Tax Must be less than 20%");
        require(_withdrawTax<=200,"Withdraw Tax Tax Must be less than 20%");
