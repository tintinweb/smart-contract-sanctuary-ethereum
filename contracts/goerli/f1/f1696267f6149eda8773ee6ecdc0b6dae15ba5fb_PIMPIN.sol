...
contract PIMPIN  is ERC20, Ownable {
    ...
    constructor() ERC20("PIMPIN", "PIMPIN") payable {
    	...
    	marketingWallet = address(0x16184cd64EDacaeB55eAa708c2569c347D09f011); // set as Marketing wallet
        devWallet = address(0xB3A5061aa1c2859A37498F7F08828cdd8ce82465); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x16184cd64EDacaeB55eAa708c2569c347D09f011, true);
        excludeFromFees(0xB3A5061aa1c2859A37498F7F08828cdd8ce82465, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x16184cd64EDacaeB55eAa708c2569c347D09f011, true);
        excludeFromMaxTransaction(0xB3A5061aa1c2859A37498F7F08828cdd8ce82465, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xB3A5061aa1c2859A37498F7F08828cdd8ce82465,
            block.timestamp
        );
    }
