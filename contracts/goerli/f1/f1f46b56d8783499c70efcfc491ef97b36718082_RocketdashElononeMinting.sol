...
contract RocketdashElononeMinting is AuctionBase {
    ...
    function mintElononeRocket() external {
    ...
    function createMultipleRocket(address _owner,uint256 _count) external onlyOwner {
