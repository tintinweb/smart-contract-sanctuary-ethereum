...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xC29526662F1A0aeDEa48825D89d3700e6648F99C];
  address public erc20Payable = 0xC29526662F1A0aeDEa48825D89d3700e6648F99C;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeif3i3ynlljsg2ltdro3udrgkztp7w35ptadzlinmnynrwka67vmni/";
...
// File: contracts/SnowDayContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SnowDayContract is RamppERC721A {
    constructor() RamppERC721A("Snow Day", "GRNDY"){}
}
