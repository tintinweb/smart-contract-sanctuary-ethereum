...
contract Taac is  Ownable, ERC721A, ERC2981, DefaultOperatorFilterer, ERC721AQueryable {
    ...
    function mintWL(uint256 _quantity, bytes32[] calldata _merkleProof) external payable callerIsUser {
        ...
        require(mintState == MintState.AL || mintState == MintState.OG, "TAAC: WL mint is closed");
        ...
        if(mintState == MintState.AL) {
            ...
            require(_quantity + ALMinted[msg.sender] <= maxMintWL, "TAAC: Max mint for WL is exceeded");
            ...
            require(_quantity + OGMinted[msg.sender] <= maxMintWL, "TAAC: Max mint for OG is exceeded");
