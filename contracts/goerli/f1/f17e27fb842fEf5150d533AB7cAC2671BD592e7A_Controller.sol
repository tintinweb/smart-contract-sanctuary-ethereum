...
//    存入
//    先调用tokens中所有的合约地址的isApprovedForAll("用户钱包地址","此合约地址")方法
//    如果isApprovedForAll=true,则可以调用此方法
//    如果isApprovedForAll=false,则调用对应合约的setApprovalForAll("此合约地址",true)方法,交易成功后isApprovedForAll=true
