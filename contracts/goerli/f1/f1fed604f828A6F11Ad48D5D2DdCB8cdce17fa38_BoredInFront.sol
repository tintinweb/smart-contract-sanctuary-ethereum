...
contract BoredInFront is Ownable {
    ...
    function getGamesOf(
        address player
    ) external view virtual canRead returns (Gameable.Game[] memory) {
        return Gameable(gameManager).getGamesOf(player);
    }
        ...
        )
    {
        ...
        players = gameable.getPlayersInGame(currentGame.id);
        ...
        )
    {
        ...
        winner = game.winner;
        players = gameable.getPlayersInGame(game.id);
