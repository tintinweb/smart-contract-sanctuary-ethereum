...
interface ITokenPredicate {
     ...
     * @param localToken Token which gets withdrawn
     * @param value Valid sidechain log for data like amount, token id etc.
     */
    function exitTokens(
        address sender,
        address localToken,
...
contract ERC20Predicate is ITokenPredicate, AccessControlMixin, Initializable {
     ...
     * @param localToken Token which gets withdrawn
     * @param value Valid ERC20 burn log from child chain
     */
    function exitTokens(
        address sender,
        address localToken,
    ...
    {
        uint256 amount = abi.decode(value, (uint256));
        emit ExitedERC20(sender, localToken, amount);
        IERC20(localToken).safeTransfer(withdrawer, amount);
    }
