...
// |                                                                  |
// ====================================================================
// ================== OrionGaugeFXSRewardsDistributor ==================
// ====================================================================
...
// import "./OrionMiddlemanGauge.sol";
import './Uniswap/TransferHelper.sol';
import "./Owned.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";


contract OrionGaugeORNRewardsDistributor is Owned, ReentrancyGuard {
    ...
    IOrionGaugeController public gauge_controller;
    ...
    constructor (
        ...
        gauge_controller = IOrionGaugeController(_gauge_controller_address);
    ...
    function distributeReward(address gauge_address) public isDistributing nonReentrant returns (uint256 weeks_elapsed, uint256 reward_tally) {
        ...
        if (is_middleman[gauge_address]){
            ...
            // OrionMiddlemanGauge(gauge_address).pullAndBridge(reward_tally);
        }
        else {
