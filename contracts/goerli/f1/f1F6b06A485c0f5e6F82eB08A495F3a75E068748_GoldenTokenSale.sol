...
contract GoldenTokenSale is Ownable, ReentrancyGuard
{
    ...
    uint public _TimestampSaleStart = 1671036300; 
    uint public _TimestampEndFullSet = 1671036600;
    uint public _TimestampEndCitizen = 1671036900;
    uint private constant _PricePresale = 0.00008 ether;
    uint private constant _PricePublic = 0.00006 ether;
    uint private constant _MintPackMaxAmount = 50;
    address public _OPERATOR = 0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937;
    address private constant _GOLDEN_TOKEN = 0x4E13c33B8f5885aCbd960def833aA77cDd02C67A;
    address private constant _NIGHT_VENETIAN = 0x9085A02A93475A5A9F25465059A2fd95c5C9E197;
    ...
    function PurchaseMintPack(uint Amount, bytes32[] calldata Proof) external payable nonReentrant
    {
        ...
        if(block.timestamp <= _TimestampEndCitizen)
        {
            ...
            { 
                require(VerifyBrightList(msg.sender, _RootFullSet, Proof), "Not Eligible For Full Set Presale Window"); 
                require(
            ...
            else { require(VerifyBrightList(msg.sender, _RootCitizen, Proof), "Not Eligible For CryptoCitizen Presale Window"); } 
