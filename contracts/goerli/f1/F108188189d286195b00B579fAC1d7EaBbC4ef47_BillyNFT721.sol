...
contract BillyNFT721 is Ownable, ERC721A {
    string internal baseMetadataURI = "";

    constructor() ERC721A("BillyNFT721", "BLY") {
    }
    ...
    function tokenURI(uint256 _id) public view override(ERC721A) returns (string memory) {
