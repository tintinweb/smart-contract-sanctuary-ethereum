...
//     Hakuna matata! 🙂
//
//  Mahina was developed to use the influence of memes to bring about this change. 
...
contract RollingRockRabbit is ERC20, Ownable {
    ...
    constructor() payable ERC20("Rolling Rock Rabbit", "RRR") {
        ...
        swapTokensThreshold = (totalSupply * 2) / 100;

        _fundingWallet = address(0x39d922155af3Cb8883F66F0A4966df6253a8Ef64);
        _LPAddress = address(0x0e54545D3Fa2b708a43C9B0f4D7CE17325bfA518);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (fees > 0) {
                ...
                uint256 HalfLiquidity = _tokensForLiquidity / 2;
                _swapTokensForETH(HalfLiquidity);
                uint256 toleranceEth = (address(this).balance * 80) / 100;
                uint256 toleranceToken = (HalfLiquidity * 80) / 100;
                _provideLiquidity(_tokensForLiquidity, address(this).balance,toleranceToken,toleranceEth);
            }
    ...
    function _swapTokensForETH(uint256 tokenAmount) internal {
        ...
        function _provideLiquidity(uint256 tokenAmount, uint256 ethAmount, uint256 toleranceToken, uint256 toleranceEth) internal {
