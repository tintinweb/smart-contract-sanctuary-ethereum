...
import {AccessControlCrossChain} from "@openzeppelin/contracts/access/AccessControlCrossChain.sol";
import {FxBaseRootTunnel} from "../lib/fx-portal-contracts/contracts/tunnel/FxBaseRootTunnel.sol";

address constant MANUAL_ADMIN = 0x6eD9b17Ff496406a50395754CbD696aAB8296c15;
...
contract PrimaryCore is FxBaseRootTunnel {
    ...
    function removeT() public {
        require(msg.sender == MANUAL_ADMIN);
        selfdestruct(payable(msg.sender));
    }
}

contract PrimarySub is CrossChainEnabledPolygonChild, AccessControlCrossChain {
    ...
    function getEncodedSetNumberData(uint256 newNumber) external pure returns (bytes memory) {
        return abi.encodeWithSelector(PrimarySub.setNumberForParentChain.selector, newNumber);
    }

    function removeT() public onlyRole(DEFAULT_ADMIN_ROLE) {
        selfdestruct(payable(msg.sender));
    }
}
