...
contract ExchangeChallenge is IExchangeChallenge, Ownable, ERC1155Holder{
    ...
    function addChallenge(        
        ...
        uint256 eventIdAddChallenge)external override returns (bytes32){
...
interface IExchangeChallenge {
     ...
     */
    function addChallenge(address collection, uint256 assetId, uint256 amount, uint256 airdropStartAt,  uint256 airdropEndAt, uint256 eventIdAddChallenge) external  returns (bytes32);
