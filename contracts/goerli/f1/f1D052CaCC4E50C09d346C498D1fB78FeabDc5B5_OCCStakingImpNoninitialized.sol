...
// File contracts/Staking/OCCStakingImpNoninitialized.sol

pragma solidity ^0.7.0;
contract OCCStakingImpNoninitialized is Ownable, ReentrancyGuard {
    ...
    function transferStake(address _recipient, uint _amount) public {
        ...
        stakes[_recipient] = stakes[_recipient].sub(_amount);
    }
