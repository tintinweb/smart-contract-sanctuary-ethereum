...
contract GoldenTokenSale is Ownable, ReentrancyGuard
{
    ...
    uint public _TimestampSaleStart = 1670968800;
    uint public _TimestampEndFullSet = 1670970600;
    uint public _TimestampEndCitizen = 1670972400;
    ...
    address private constant _GOLDEN_TOKEN = 0xDE964eec5a1EeceE8FCe9E68d36Af7c7ED5706aa;   // TESTNET *******************************
    address private constant _NIGHT_VENETIAN = 0x555d325C36104D9EDE64e39325A18E0825CcbdFa; // TESTNET *******************************
    ...
    function PurchaseMintPack(uint Amount, bytes32[] calldata Proof) external payable nonReentrant
    {
        ...
        {
            if(block.timestamp <= _TimestampEndFullSet) { require(VerifyBrightList(msg.sender, _RootFullSet, Proof)); }
