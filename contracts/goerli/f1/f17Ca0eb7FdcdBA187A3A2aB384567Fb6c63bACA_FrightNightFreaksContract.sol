...
//
//           _  .-')                    ('-. .-..-') _       .-') _                  ('-. .-..-') _            _  .-')    ('-.  ('-.   .-. .-')  .-')    
//          ( \( -O )                  ( OO )  (  OO) )     ( OO ) )                ( OO )  (  OO) )          ( \( -O ) _(  OO)( OO ).-\  ( OO )( OO ).  
//    ,------,------. ,-.-')  ,----.   ,--. ,--/     '._,--./ ,--,',-.-')  ,----.   ,--. ,--/     '._   ,------,------.(,------/ . --. ,--. ,--(_)---\_) 
// ('-| _.---|   /`. '|  |OO)'  .-./-')|  | |  |'--...__|   \ |  |\|  |OO)'  .-./-')|  | |  |'--...__('-| _.---|   /`. '|  .---| \-.  \|  .'   /    _ |  
// (OO|(_\   |  /  | ||  |  \|  |_( O- |   .|  '--.  .--|    \|  | |  |  \|  |_( O- |   .|  '--.  .--(OO|(_\   |  /  | ||  | .-'-'  |  |      /\  :` `.  
// /  |  '--.|  |_.' ||  |(_/|  | .--, |       |  |  |  |  .     |/|  |(_/|  | .--, |       |  |  |  /  |  '--.|  |_.' (|  '--\| |_.'  |     ' _'..`''.) 
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xa52f85947A4a87023c05ef7c03366C5fD45A115d];
  address public erc20Payable = 0xa52f85947A4a87023c05ef7c03366C5fD45A115d;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmaQ68x8MNrKWDRxcvtXqGCo7yt4dBU82AdkuKpSJfRqEy/";
...
// File: contracts/FrightNightFreaksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FrightNightFreaksContract is RamppERC721A {
    constructor() RamppERC721A("FrightNightFreaks", "FNF"){}
}
