...
contract ERC20 is Context {
    ...
    function transferFrom(
        ...
        // If there is no check for 'to' being not the zero address
        // _spendAllowance may execute and decrease the allowance with amount
        // while _transfer will not execute and the transaction will fail
        require(to != address(0), "Address receiver is zero address");
        ...
        returns (bool)
    {
        ...
        _approve(msgSender, spender, currentAllowance + addedValue);
        return true;
    }
        ...
        returns (bool)
    {
        ...
        address msgSender = _msgSender();
        uint256 currentAllowance = allowance(msgSender, spender);
        require(currentAllowance >= subtractedValue, "Current allowance is less than the subtracted value!");
    ...
    function _transfer(
        ...
        // TODO
        require(from != address(0), "Address sender is zero address!");
        require(to != address(0), "Address receiver is zero address!");

        uint256 balance_from = balanceOf(from);
        require(balance_from >= amount, "Not enough tokens!");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        //TODO
        require(account != address(0), "Address receiver is zero address!");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 account_balance = balanceOf(account);
        require(account_balance >= amount, "Not enough tokens!");
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(
                ...
                currentAllowance >= amount, "Allowance is too low!"
            );
            unchecked {
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenSD", "LCSD") {}
}