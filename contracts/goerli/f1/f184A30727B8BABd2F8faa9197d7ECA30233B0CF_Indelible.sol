// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"WormsOnChain", unicode"WormsOnChain", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/0464989e-e8ea-4165-9310-086ae3ec0753", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/0464989e-e8ea-4165-9310-086ae3ec0753", "", 600, "0x06E14b037650E6d7c5e6a8eB329E1b44E2D7650C");

        constructor() ERC721A(unicode"WormsOnChain", unicode"WOC") {
            TIERS[0] = [2,8,10,87,100,133,146,168,312,400,422,426,457,1085,1244];
TIERS[1] = [26,28,289,361,736,1778,1782];
TIERS[2] = [23,26,66,69,71,89,105,163,165,247,273,364,638,982,1719];
TIERS[3] = [2,2,19,20,23,26,34,39,44,57,67,68,70,98,99,106,130,133,138,152,163,165,175,179,226,226,274,288,413,453,454,657];
TIERS[4] = [5,15,80,81,94,130,295,399,488,693,987,1733];
TIERS[5] = [33,62,91,168,298,308,452,589,635,707,805,852];
TIERS[6] = [59,199,345,356,441,525,820,876,1379];
        }
