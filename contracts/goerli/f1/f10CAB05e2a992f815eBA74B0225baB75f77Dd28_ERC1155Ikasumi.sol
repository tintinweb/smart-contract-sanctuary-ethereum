...
// File: contract-erc1155-token-20221018-a.sol
...
contract ERC1155YuzuInternal is Ownable, AccessControl, Pausable, ERC1155Supply {
 ...
 * ERC-1155 with tokens
 */
contract ERC1155Ikasumi is ERC1155YuzuInternal, ReentrancyGuard {
    ...
    constructor(
        address _owner, string memory name, string memory symbol, bool _anyoneCanMint, string memory uri) 
    ...
    function burn(address account, uint256 id, uint256 amount) public virtual {
        require(account == _msgSender() || isApprovedForAll(account, _msgSender()), "Ikasumi: caller is not token owner or approved");
