...
contract CirclePacking is ERC721 {
    ...
    function tokenURI(
        ...
        bytes memory metadata = abi.encodePacked(
            '{"name":"Circle Packing", "description":"Just a simple algorithm for displaying color outputs using p5js.","image":"',
