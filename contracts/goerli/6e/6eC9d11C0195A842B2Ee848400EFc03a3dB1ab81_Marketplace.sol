...
contract ManageLife is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    // @note TODO: Should be onlyOwner
    // This will mark the property as paid
    function markFullyPayed(uint256 tokenId) external onlyOwner {
        _fullyPayed[tokenId] = true;
        // @note initialized staking for this tokenId if the tokenId is not owned by the contract owner
...
contract Life is ERC20, Ownable {
    ...
    // @note Set the NFT contract after deployment
    ...
    // @note Only NFT contract address can call this function
    function initStakingRewards(uint256 tokenId) external {
        ...
        // Making sure the one who will trigger this function is the NFT contract:
        require(
    ...
    {
        if (
            _stakingRewards[tokenId] == 0 ||
            _manageLifeToken.fullyPayed(tokenId)
        ) {
            return 0;
        }
        return
