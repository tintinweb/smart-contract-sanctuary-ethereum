 ...
 */
    ...
    function art(
        ...
        string memory brows = _chooseEyeBrows(characterDNA, colors[colorGene][1]);
    ...
    function _chooseTops(
        ...
        string[27] memory hairs = [
            ...
            string(abi.encodePacked('<tspan fill="', _color,'">',"_______","</tspan>")),
            string(abi.encodePacked('<tspan fill="', _color,'">',"///////","</tspan>")),
            string(abi.encodePacked('<tspan fill="', _color,'">',"!!!!!!!","</tspan>")),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"║║║║║║║","</tspan>")),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"▄▄▄▄▄▄▄","</tspan>")),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"███████","</tspan>")),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"┌─────┐","</tspan>",
                                    '<tspan dy="20" x="160" fill="', _color,'">',unicode"│     │","</tspan>",
                                    '<tspan dy="20" x="160" fill="', _color,'">',unicode"─┴─────┴─","</tspan>" )),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"┌─────┐","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"├─────│","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"─┴─────┴─","</tspan>" )),
            ...
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"     ,/","</tspan>",
                            ...
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"└─┴▀▀▀▀▀┴──","</tspan>" )),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"       ","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode" /ˇˇˇ  ","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"┴─────┴","</tspan>" )),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"┌─────┐","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"┌┴─────┴┐","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"└───────┘","</tspan>" )),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode"       ","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"┌─────┐","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"|░░░░░░░|","</tspan>" )),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode" ,.O., ","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode" /»»»»» ","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"/«««««««","</tspan>" )),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode" ,.O., ","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"/AAAAA","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"/VVVVVVV","</tspan>" )),
            string(abi.encodePacked('<tspan fill="', _color,'">',unicode" ,.O., ","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"/WWWWW","</tspan>",
                            '<tspan dy="20" x="160" fill="', _color,'">',unicode"/MMMMMMM","</tspan>" ))
        ];
