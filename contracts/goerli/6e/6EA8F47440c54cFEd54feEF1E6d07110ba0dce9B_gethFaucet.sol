...
contract gethFaucet {
    ...
    //state variable to keep track of owner and amount of ETHER to dispense 0.2 geth
    address public owner;
    uint public amountAllowed = 200000000000000000; // 0.2 geth
    ...
    // function to call the balance of the contract
