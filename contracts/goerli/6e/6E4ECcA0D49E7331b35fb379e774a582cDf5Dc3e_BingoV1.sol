...
contract BingoV1 is ERC20, ERC20Pausable, Ownable {
    // CONTRACT ADDRESS
    // 0x0777208947320A0a073ff2A8bCf34e678E42796C

    receive() external payable {}

    event MaxTxAmountUpdated(uint256 _maxTxAmount, uint256 _maxTxWallet);
    ...
    constructor() ERC20("BingoV1", "Bingo") {
    ...
    function mint(uint256 amount) public payable {
        ...
        uint256 realTokenAmount = TOKEN_PRICE * amount;
        require(
        ...
        require(msg.value >= realTokenAmount, "Bingo: UNDER PRICE");
        ...
        _afterTokenTransfer(address(0), msg.sender, realTokenAmount);
    }
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        require(swapEnabled, "TRADE HASN'T STARTED");
