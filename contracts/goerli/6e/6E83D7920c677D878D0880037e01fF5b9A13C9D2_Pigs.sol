...
contract Pigs is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        costHolders = 0.10 ether;
        costWhiteListed = 0.15 ether;
        costAllowListed = 0.18 ether;
        costPublic = 0.20 ether;
    }
...
//    }
    ...
    function mint(uint256 _mintAmount) public whenNotPaused payable {
        ...
        if (msg.sender != owner()) {
            ...
            // require(msg.value == cost * _mintAmount, "transaction value did not equal the mint price");
        }

        for (uint256 i = 1; i <= _mintAmount; i++) {
            addressMintedBalance[msg.sender]++;
            _safeMint(msg.sender, supply + i);
            if (supply + i == _revealAfter) {
                revealed = true;
            }
        }
    }
...
//        address[] calldata _whiteListed
//    ) public onlyOwner {
//        // set first 1000 NFT with the _baseURI
//        for (uint i = 1; i <= 1_000; i++) {
//            _baseURITokens[i] = _baseURI;
//        }
//        notRevealedUri = _notRevealedUri;
//        whiteListed = _whiteListed;
//        unpause();
//    }
    ...
    function drop(
        ...
        whiteListed = _whiteListed;
        allowListed = _allowListed;
//        costHolders = _etherToWei(_costHolders);
//        costWhiteListed = _etherToWei(_costWhiteListed);
//        costAllowListed = _etherToWei(_costAllowListed);
//        costPublic = _etherToWei(_costPublic);
        allowHolders = _allowHolders;
        ...
        //        // set _baseURI to new NFT
//        for (uint i = firstTokenId; i <= currentMaxSupply; i++) {
//            _baseURITokens[i] = _baseURI;
//        }
    }

//    function nextDrop() public onlyOwner {
//        drop = drop + 1;
//        if (drop == 2) {
//            onlyWhitelisted = false;
//            currentMaxSupply = currentMaxSupply + 700;
//            cost = 0.18 ether;
//        } else if (drop == 3) {
//            currentMaxSupply = currentMaxSupply + 1000;
//            cost = 0.3 ether;
//        } else if (drop == 4) {
//            currentMaxSupply = currentMaxSupply + 3000;
//            cost = 0.4 ether;
//        } else if (drop == 5) {
//            currentMaxSupply = currentMaxSupply + 5000;
//            cost = 0.5 ether;
//        } else {
//            require(drop > 5, "cannot more than drop 5");
//        }
//        require(currentMaxSupply < finalMaxSupply, "exceeded finalMaxSupply");
//    }
...
//    }
    ...
    function setAllowPublic(bool value) public onlyOwner {
        allowPublic = value;
    }
