...
// 0x1d006e57D178d6F50E774e985c2B4Ac65E47E321
...
contract ChessMarket is Ownable{
   ...
   function withdrawRewards (address _creater, string calldata _apiurl, uint _indexAt)  external {
    Match[] storage _matches_ofuser = matches_ofuser[_creater];
    ...
    if (iswon) {
        ...
        payable(_winningAddress).transfer(_matches_ofuser[_indexAt].betvalue * 180 / 100);        // 10% fee.
    }
   }
