 ...
 *  @notice This contract and token connect to the UBI Dashboard contract to reward users
 *  for submitting information and voting in a DAO or city context.
 */

contract UBIToken is ERC20, Ownable {
    uint256 public startingTimeStamp;
    uint256 public ubiPayment = 1000000000000000000000; // 1000 with 18 decimal places.

    /// @notice Initial supply can be anything, but 0 is the best for everyone!
    constructor(uint256 initialSupply) ERC20("DAO UBI Token", "DUBI") {
     ...
     *  it can mint tokens and pay users. After ownership transfer, the only way
     *  to mint UBI is to complete UBI Dashboard rounds.
     */
    ...
    function ubiIssuanceHalving() public returns (uint256) {
