...
contract ERC721CollectionFactory is ERC2771Context {
    ...
    function cloneContract(
        ...
        ERC721NFTCustom(instance).initialize(deploymentConfig, runtimeConfig, rolesAddresses, address(_minimalForwarder));
        emit NewCollection(instance);
        return instance;
    }

    function updateRole(address _deployed, bytes32 _role, address account) public {
        ERC721NFTCustom(_deployed).grantRole(_role, account);
    }
}
...
contract ERC721NFTCustom is Initializable, ERC721URIStorage, GranularRoles, ERC2771Context {
