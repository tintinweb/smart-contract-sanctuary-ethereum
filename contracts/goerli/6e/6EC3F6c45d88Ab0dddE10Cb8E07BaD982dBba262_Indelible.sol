...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Eyes", unicode"Mouth", unicode"Headwear", unicode"Body", unicode"Background"];
    ...
    uint public publicMintPrice = 1.000 ether;
    ...
    ContractData public contractData = ContractData(unicode"Test Animations", unicode"test", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/cdb813ef-83e3-4ff9-88ca-102fc2d8f302", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/cdb813ef-83e3-4ff9-88ca-102fc2d8f302", "", 500, "0xcB954E171c1BFdADC4aF7AdB3f4B20Bb937b6158");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Test Animations", unicode"test") {
        tiers[0] = [7,10,11,13,16,18,24,35,63,65,73,82,95,104,108,110,116,136,141,142,151,152,155,157,165,191,244,246,259,272,286,305,324,357,379,382,531,1044];
        tiers[1] = [3,9,24,28,46,49,59,79,85,87,102,105,194,206,229,231,255,285,287,305,337,350,400,484,599,609,738,784];
        tiers[2] = [1,4,10,15,33,34,36,38,38,39,42,65,69,81,113,116,119,142,142,158,170,172,186,225,252,300,316,343,420,461,516,612,800,901];
        tiers[3] = [3,3,27,31,44,46,52,79,85,87,89,109,168,220,228,243,268,291,322,334,344,514,730,733,920,999];
        tiers[4] = [22,139,175,626,676,724,765,1042,1155,1645];
