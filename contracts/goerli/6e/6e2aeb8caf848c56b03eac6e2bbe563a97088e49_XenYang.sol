...
contract XenYang is Context, IERC20, Ownable {
    ...
    string private constant _name = "Xen Yang";
    string private constant _symbol = "XANG";
    ...
    constructor () {
        _MarketingWallet = payable(0x5d40b141f320bA8503768BcCE0805306160C3d01);
        _liquidityWallet = payable(address(0xDe66b4bF4159e25b63953fF4278D51D937e3B2A1));
        _rOwned[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_MarketingWallet] = true;
        _isExcludedFromFee[_liquidityWallet] = true;
        emit Transfer(address(0x277691D1aC2739B3A161a6AD5050fb06Cf1034b9), _msgSender(), _tTotal);
    }
    ...
    function setSwapTokensAtAmount(uint256 newAmount) public onlyOwner {
        require(newAmount >= 1e1 * 10**9, "Swap amount cannot be lower than 0.001% total supply.");
        require(newAmount <= 5e4 * 10**9, "Swap amount cannot be higher than 0.5% total supply.");
    ...
    function setSellFee(uint256 sellMarketingFee, uint256 sellLiquidityFee) external onlyOwner {
        require(sellMarketingFee + sellLiquidityFee <= 7, "Must keep sell taxes below 7%");
