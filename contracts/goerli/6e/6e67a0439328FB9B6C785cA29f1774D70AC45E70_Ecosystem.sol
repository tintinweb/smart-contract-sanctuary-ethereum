...
contract Ecosystem is ERC20Upgradeable, PausableUpgradeable, Manager {
    function initialize() public initializer {
        Manager.manager_initialize();
        __ERC20_init("Ecosystem", "ECO");
        __Pausable_init();
    ...
    function mint(address user, uint256 amount) public onlyManager {
        _mint(user, amount * 10**decimals());
    }

    function burn(address user, uint256 amount) public onlyManager {
...
contract Manager is Initializable {
    ...
    function manager_initialize() public onlyInitializing {
        manager[msg.sender] = true;
    }
    ...
    function updateManager(address _manager, bool _status) public onlyManager {
