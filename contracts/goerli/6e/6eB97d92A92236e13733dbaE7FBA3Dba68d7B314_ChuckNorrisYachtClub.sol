...
// SPDX-License-Identifier: MIT
        ...
        contract ChuckNorrisYachtClub is ERC721A, Ownable, ReentrancyGuard  , DefaultOperatorFilterer{
            using Strings for uint256;
            uint256 public _maxSupply = 3333;
            uint256 public maxMintAmountPerWallet = 111;
        ...
        constructor(string memory _initBaseURI) ERC721A("Chuck Norris YC", "CNYC") {
