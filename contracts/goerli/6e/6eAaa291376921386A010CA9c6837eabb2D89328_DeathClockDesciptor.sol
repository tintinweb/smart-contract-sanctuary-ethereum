...
contract DeathClockDesciptor is IDeathClockDescriptor, Ownable, MetadataGenerator {
    ...
    function setTokenParams(TokenParams[] memory _tokenParams, uint256 startWith) external onlyOwner {
