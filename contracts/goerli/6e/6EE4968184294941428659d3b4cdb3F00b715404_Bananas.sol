...
contract Bananas is ERC721A, Ownable{
    using Strings for uint256;

    IERC721 FunApesContract = IERC721(0xC0F799A176E10d45fA56C7298d54F813B51FD151);

    uint256 public constant MAX_SUPPLY = 10000;
    uint256 public constant MAX_PUBLIC_MINT = 10;
    uint256 public PUBLIC_SALE_PRICE = 0.007 ether;
    uint256 public WL_SALE_PRICE = 0.005 ether;
    ...
    constructor() ERC721A("Bananas", "BNS"){
    ...
    function mint(uint256 _quantity) external payable{
        ...
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "MAX_MINT");
    ...
    function whitelistMint(uint256 _quantity) external payable{
        ...
        require(WL_MINTS[msg.sender] + _quantity <= FunApesContract.balanceOf(msg.sender), "MAX_WL_MINTS");
        _safeMint(msg.sender, _quantity);
    }
