...
TIERS[6] = [84,106,143,170,192,307];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"FirstTestTwos #");
