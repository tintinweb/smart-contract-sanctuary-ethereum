...
contract morphingMuffins is ERC721A, Ownable, ReentrancyGuard
{
    uint public constant MAX_TOKENS = 10000; //This is your total supply limit
    uint public PRESALE_LIMIT = 10000; //This is your limit for the presale or whitelist
    ...
    constructor() ERC721A("morphingMuffins", "MORPH") {} //Name of Project and Token "Ticker"
    ...
    function setPresaleLimit(uint newLimit) external onlyOwner  //Set a new presale limit last minute in case you'd like to change the limit after the contract is deployed
    {
