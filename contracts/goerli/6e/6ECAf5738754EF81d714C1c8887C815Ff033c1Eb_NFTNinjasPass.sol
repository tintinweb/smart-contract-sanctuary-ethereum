...
contract NFTNinjasPass is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _ninjaCounter;
    uint public MAX_NINJA = 100;
    string public baseURI;
    address private _manager;

    constructor() ERC721("NFT NINJAS PASS", "NINJA PASS"){
    }
    ...
    function reserveMintNinja(uint256 reserveAmount, address mintAddress) public onlyOwnerOrManager {
        require(totalSupply() <= MAX_NINJA, "Mint would exceed max supply of Ninja Passes");
