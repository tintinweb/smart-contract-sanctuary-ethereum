...
contract Deploy is Base {
    function run() public {
        ...
        // if (true) {
        //     ClaimableWithSignature.SignedAllowance[] memory sigs =
        //         new ClaimableWithSignature.SignedAllowance[](1);
        //     sigs[0] = ClaimableWithSignature.SignedAllowance({
        //         allowance: ClaimableWithSignature.Allowance({
        //             receiver: 0x52d817bB3F83085ACA590d4c6Be40a1236c18BB9,
        //             nonce: 0,
        //             activeAfterTimestamp: 1_678_314_594
        //         }),
        //         signature:
        // hex"fe48cbcaa9e3161cfc9e95cfaef21f81621e5313abff14655bac1e33258f9860581d72c9833e78ec496538fd7826c6dc16ce3de4be1176314b92ee7db6234ad21c"
        //     });
        //     token.claimMultipleWithSignature(sigs);
        // }
...
abstract contract ClaimableWithSignature {
     ...
     * signer.
     */
    function claimMultipleWithSignature(SignedClaim[] calldata claims)
        external
