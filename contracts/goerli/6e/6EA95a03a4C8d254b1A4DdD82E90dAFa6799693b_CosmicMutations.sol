...
contract CosmicMutations is ERC721Enumerable, Ownable, CosmicMutationVoucherSigner {
    ...
    function adminMint(address _to, uint256 _tokenID) external onlyOwner {
        require(totalSupply() + _tokenID <= MAX_SUPPLY,"All planets have been claimed.");
...
library CosmicMutationVoucher {
  ...
  {
    bytes32 h1 = keccak256(abi.encodePacked(v.voucherId, v.to, v.traitlist.head, v.traitlist.eyes, v.traitlist.mouth, v.traitlist.body, v.traitlist.skin, v.traitlist.background));
