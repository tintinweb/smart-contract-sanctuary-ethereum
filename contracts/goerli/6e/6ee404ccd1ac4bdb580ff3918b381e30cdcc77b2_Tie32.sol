...
contract Tie32 is ERC20 {
    ...
    string constant private _name = "TieToken 32";
    string constant private _symbol = "TIE32";
    ...
    modifier owner { require(msg.sender == _owner); _; }
    modifier noreentrancy { require(!_reentrant, "Reentrancy hijack detected"); _reentrant = true; _; _reentrant = false; }
    function name() external pure returns(string memory) { return _name; }
    function symbol() external pure returns(string memory) { return _symbol; }
    function decimals() external pure returns(uint8) { return _decimals; }
    function totalSupply() public view virtual override returns(uint256) { return _supply.div( 10 ** _decimals); }       
    function balanceOf(address wallet) public view virtual override  returns(uint256) { return _balances[wallet]; }
