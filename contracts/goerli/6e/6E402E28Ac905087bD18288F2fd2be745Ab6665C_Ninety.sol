...
contract Ninety is ERC721, Ownable {
    // Structs
    struct Rectangle {
    ...
    //     if (rectangleSize1 == 1) {
    //         Rectangle memory rectangle1 = createRectangleStruct(150, y, 150, 150, randomSeed);
    ...
    // SVG code for a more elaborate pattern of rectangles
    function generateLineSvg(uint lineNumber, uint randomSeed)
        public
        pure
        returns (string memory)
    {
        ...
        // Size of rectangle at slot 1
        uint rectangleSize1 = drawRectangleSize(3, randomSeed);
        // console.log("Rectangle size 1: ", rectangleSize1);

        // Rectangle size 1x? Paint 1x at slot 1
        if (rectangleSize1 == 1) {
            Rectangle memory rectangle1 = createRectangleStruct(150, y, 150, 150, randomSeed);
            lineSvg = string.concat(lineSvg, RectangleSvg(rectangle1));

            // Slot 2
            // Size of rectangle at slot 2
            uint rectangleSize2 = drawRectangleSize(2, randomSeed >> 1);
            // console.log("Rectangle size 2: ", rectangleSize2);

            // Rectangle size 1x? Paint 1x at slot 2, 1x at slot 3, and 1x at slot 4
            if (rectangleSize2 == 1) {
                Rectangle memory rectangle2 = createRectangleStruct(
                    475,
                    y,
                ...
                Rectangle memory rectangle4 = createRectangleStruct(
                    1050,
                    y,
                    150,
                    150,
                ...
                lineSvg = string.concat(
                    ...
                    RectangleSvg(rectangle2),
                    RectangleSvg(rectangle3),
                    RectangleSvg(rectangle4)
                );

                // Rectangle size 2x? Paint 2x at slot 2
            } else if (rectangleSize2 == 2) {
                Rectangle memory rectangle2 = createRectangleStruct(
                    475,
                    y,
            ...
            // Rectangle size 2x? Paint 2x at slot 1, 1x at slot 3, and 1x at slot 4
        } else if (rectangleSize1 == 2) {
            Rectangle memory rectangle1 = createRectangleStruct(
                150,
                y,
            ...
            lineSvg = string.concat(
                lineSvg,
                RectangleSvg(rectangle1),
                RectangleSvg(rectangle3),
                RectangleSvg(rectangle4)
            );

            // Rectangle size 3x? Paint 3x at slot 1
        } else if (rectangleSize1 == 3) {
            Rectangle memory rectangle1 = createRectangleStruct(
                150,
                y,
        ...
        // Slot 4
        // Size of rectangle at slot 4
        uint rectangleSize4 = drawRectangleSize(2, randomSeed >> 10);
        // console.log("Rectangle size 4: ", rectangleSize4);

        // Rectangle size 1x? Paint 1x at slot 4
        if (rectangleSize4 == 1) {
            Rectangle memory rectangle4 = createRectangleStruct(
                1050,
                y,
            ...
            lineSvg = string.concat(lineSvg, RectangleSvg(rectangle4));

            // Rectangle size 2x? Paint 2x at slot 4
        } else if (rectangleSize4 == 2) {
            Rectangle memory rectangle4 = createRectangleStruct(
                1050,
                y,
                300,
    ...
    function generateFinalSvg(
        ...
        bytes memory backgroundCode = abi.encodePacked(
            ...
            backgroundColors(randomSeed1 % 2),
            '" />'
        );
        ...
        string memory finalSvg = string(
            abi.encodePacked(
                ...
                generateLineSvg(5, randomSeed5),
                generateLineSvg(6, randomSeed6),
