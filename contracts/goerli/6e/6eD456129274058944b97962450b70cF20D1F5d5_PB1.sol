...
contract PB1 is Ownable, ERC20Burnable, ERC20Pausable, AccessControlMixin {

    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    event BridgeMint(address indexed to, uint256 value);
    event OwnerMint(address indexed to, uint256 value);


    // constructor with ERC20
    constructor() ERC20("Parent4", "Pt4") {
    ...
    function ownerMint(uint256 amount) external onlyOwner {
        ...
        emit OwnerMint(msg.sender, amount);
    }
