...
function placedBet(uint8 _sliderValue, bool _isRollOver) internal {
  ...
  */
  ...
  function addWhitelistMembers(address member) external onlyAdmins {
  ...
  function withdrawEther(address _receiver, uint256 _amount) external onlyAdmins nonReentrant {
    require(
  ...
  function withdrawToken(address ERC20Address, address _receiver, uint256 _amount) external nonReentrant onlyAdmins {
    require(
