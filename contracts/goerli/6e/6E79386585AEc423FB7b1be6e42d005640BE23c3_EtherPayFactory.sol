...
abstract contract EtherPayAccess is Ownable {
    ...
    modifier onlyAdmin() {
        ...
        require(
            ...
            "EtherPayAccess: caller is not the owner nor admin"
        );
        _;
    }

    function setAdmin(address admin, bool access) public onlyAdmin {
        admins[admin] = access;
    }
}
...
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;
import "./EtherPayAccess.sol";
import "@openzeppelin/contracts/proxy/Clones.sol";
import "@openzeppelin/contracts/utils/Address.sol";

contract EtherPayFactory is EtherPayAccess {
    address public implementation;

    uint256 immutable platformFee = 5;
    address platformFeeReceiver;

    event Created(address instance);

    constructor(address implementation_, address platformFeeReceiver_) {
