...
contract ResidentCapsule is ERC721ABurnable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Resident Capsule", "RC") {
    }
    ...
    function hmn5Mint(uint256[] memory tokenIds) external payable nonReentrant {
        ...
        hmn5.giftMint(msg.sender, quantity);
    }
    ...
    function freeMint(uint256 quantity) external nonReentrant {
        ...
        require(msg.sender == tx.origin, "No contracts");
        require(quantity <= mintTransactionLimit, "Exceeds transaction limit");
        require(mintCount[msg.sender] + quantity <= walletLimit, "Exceeds wallet limit");
