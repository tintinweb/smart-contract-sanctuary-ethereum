...
contract NftMarketplace {
    ...
    function listItem(address nftAddress, uint256 tokenId, uint256 price) external notListed(nftAddress, tokenId, msg.sender) isOwner(nftAddress, tokenId, msg.sender){
        ...
        // Kind of confusing. The implementation of the interface is going to be at the nftAdress (which implements the interface)
        // The nft adress address will be of type ERC721 which inherits IERC721 and implements getApproved() So we can wrap it like this and use the function
        IERC721 nft = IERC721(nftAddress);
