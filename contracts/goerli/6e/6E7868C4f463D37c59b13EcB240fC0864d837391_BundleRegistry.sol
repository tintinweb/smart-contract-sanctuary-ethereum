...
import "./interfaces/IBundleRegistry.sol";
    ...
    PausableUpgradeable
{
        ...
        returns (DataSourceAdapter memory bundle)
    {
        ...
        emit BundleRegistered(_bundle, _host,_source,_output,_active, msg.sender);
...
interface IBundleRegistry {
    ...
    event BundleRegistered(string indexed bundle,string host,string source,string output,bool active,address creator);
    ...
    function register( 
        ...
        bool _active ) external  returns (DataSourceAdapter memory bundle) ;
