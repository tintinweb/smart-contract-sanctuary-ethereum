...
contract SLT is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor( uint256 _maxSupply, string memory _tokenURI, uint256 _maxMintPerWallet, uint256 _price, bool _paused ) ERC721A("SLT", "SLT") {
