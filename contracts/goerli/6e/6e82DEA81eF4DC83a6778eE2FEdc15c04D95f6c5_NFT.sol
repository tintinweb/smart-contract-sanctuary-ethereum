...
contract NFT is ERC721, Ownable {
    ...
    uint public constant MAX_NFT = 10000000;
    ...
    function mint(uint256 _numTokens) external payable {
        require(isSaleActive, "The MINT is paused.");
        ...
        require(curTotalSupply + _numTokens <= MAX_NFT, "Exceeds total supply.");
    ...
    // Owner-only functions - only owner can call this function
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xEE141c0c87Ac4f672772EEB562B7b745491eA443).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xEE141c0c87Ac4f672772EEB562B7b745491eA443).call{value: balanceTwo}("");
