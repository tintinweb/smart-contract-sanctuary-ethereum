...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    uint[][2] private tiers;
    string[] private layerNames = [unicode"spheres", unicode"First Layer"];
    ...
    ContractData public contractData = ContractData(unicode"TOKYO MOON", unicode"Onchain art has always been limited by the possibilities of what we can and can't do onchain. That is all changing fast. Before we get there, I wanted to create a collection that used minimal elements to show how much can be done with a little -  and pay homage to those who have worked to create the onchain community we have today. The collection uses four colours and one shape and is made up of only two layers.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/e88384a7-0936-40c2-851a-96681bf10fec", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/e88384a7-0936-40c2-851a-96681bf10fec", "", 1000, "0x4Ab64233AAbFf13402F4E94e76C648514edb27CD");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"TOKYO MOON", unicode"MOON") {
        tiers[0] = [3,3,5,5,5,5,5,6,6,7,8,8,8,8,8,9];
        tiers[1] = [3,3,3,3,3,5,5,6,7,7,7,7,8,8,8,8,8];
