...
contract Energetic is ERC721, Ownable, ReentrancyGuard {
    ...
    function animateOne() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
                    '<animate attributeName="stop-color" values="lightblue;blue;red;red;black;red;red;purple;lightblue" dur="',
                    randomNumber(60).toString(),
                    's" repeatCount="indefinite" />'
                )
            );
    }

    function animateTwo() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
    ...
    function animateThree() internal view returns (string memory) {
        return
            string(
                abi.encodePacked(
