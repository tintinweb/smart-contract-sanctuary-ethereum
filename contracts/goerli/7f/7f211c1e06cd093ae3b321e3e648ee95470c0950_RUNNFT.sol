...
contract RUNNFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PRICE = 80000000000000000; // 你要出售的价格0.08 ETH
    ...
    constructor() ERC721("RUN NFT", "RUN") {
        baseURI = "ipfs://QmURx3XsHdfQwNpTe99PdZQnwxZmwEBPp7NiiHPVk46s91/"; // 填写您的baseURI
        baseTokenURI = "ipfs://QmURx3XsHdfQwNpTe99PdZQnwxZmwEBPp7NiiHPVk46s91/";
        contractURI = "";
    }
