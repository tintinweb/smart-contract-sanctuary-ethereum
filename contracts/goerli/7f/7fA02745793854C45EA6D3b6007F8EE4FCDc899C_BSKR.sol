...
contract BSKR is IERC20, Ownable, Manageable, Pausable {
    ...
    function _transferTokens(
        ...
        if (
            ...
            _isBSKRLBSKRV3Pool(sender) ||
            _isBSKRLBSKRV3Pool(recipient) // TODO commented out to debug - enable later
        ) {
            reducedFees = 5;
        }
    ...
    {
        require(tAmount <= _TOTAL_SUPPLY, "ATH1");
