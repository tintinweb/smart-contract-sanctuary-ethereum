...
contract TeamAdvisors is AccessControl {
    ...
    mapping(uint256 => TeamAdvisor) public alltypes;
    ...
    function distributionStart() external onlyOwner {
        for (uint256 teamAdviId = 1; teamAdviId <= 3; ) {
            require(
                alltypes[teamAdviId].isdistStart != true,
                "Distribution Already Started"
            );
            alltypes[teamAdviId].startTime = block.timestamp;
            alltypes[teamAdviId].isdistStart = true;
            unchecked {
                teamAdviId++;
            }
    ...
    function distributionEnd(uint256 teamAdviId) external onlyOwner {
        uint256 _cliff = alltypes[teamAdviId].cliff;
        uint256 _vested = alltypes[teamAdviId].vested;
        uint256 _startTime = alltypes[teamAdviId].startTime;
        ...
        alltypes[teamAdviId].endTime = block.timestamp;
        alltypes[teamAdviId].isdistEnd = false;
    }
    ...
    function transferToken(
        ...
        require(
            alltypes[teamAdviId].unlockToken >= amount,
            "Insufficient Token!"
        );
    ...
    function checkCliff(uint256 teamAdviId) private {
        ...
        uint256 _vested = alltypes[teamAdviId].vested;
        uint256 _startTime = alltypes[teamAdviId].startTime;
        bool _distrStart = alltypes[teamAdviId].isdistStart;
        bool _distrEnd = alltypes[teamAdviId].isdistEnd;
    ...
    function _unlockToken(
        ...
        uint256 _unlocktoken = alltypes[_teamAdviId].unlockToken;
        uint256 _remaintoken = alltypes[_teamAdviId].remainToken;
        uint256 _avgtoken = alltypes[_teamAdviId].avgToken;
        ...
        alltypes[_teamAdviId].unlockToken = _unlocktoken;
        alltypes[_teamAdviId].remainToken = _remaintoken;
    }
