...
import "./interfaces/ILaunchpadCrowdsaleNftNoWhitelist.sol";

/**
 * @title LaunchpadCrowdsaleNftNoWhitelist
 * @author Enjinstarter
 * @dev Launchpad crowdsale where there is no delivery of tokens in each purchase.
 */
contract LaunchpadCrowdsaleNftNoWhitelist is
    NoDeliveryCrowdsale,
    CappedTokenSoldCrowdsaleHelper,
    IndividuallyCappedCrowdsaleHelper,
    TimedCrowdsaleHelper,
    Pausable,
    ILaunchpadCrowdsaleNftNoWhitelist
{
    ...
    modifier onlyBy(address account) {
        require(
            msg.sender == account,
            "LaunchpadCrowdsaleNftNoWhitelist: sender unauthorized"
        );
        _;
    }
        ...
        onlyBy(governanceAccount)
    {
        require(
            account != address(0),
            "LaunchpadCrowdsaleNftNoWhitelist: zero account"
        );
        ...
        tokenCapNotExceeded(tokensSold, tokenAmount)
    {
        ...
        if (
            ...
            revert(
                "LaunchpadCrowdsaleNftNoWhitelist: beneficiary cap exceeded"
            );
        }
...
/**
 * @title ILaunchpadCrowdsaleNftNoWhitelist
 * @author Enjinstarter
 */
interface ILaunchpadCrowdsaleNftNoWhitelist is ICrowdsale {
