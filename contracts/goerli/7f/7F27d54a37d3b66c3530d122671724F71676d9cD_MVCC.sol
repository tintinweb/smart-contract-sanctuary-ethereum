...
contract MVCCOnChainMetadata is Ownable {
        ...
        returns (string memory)
    {
        ...
        bytes memory dataURI = abi.encodePacked(
            ...
            '"attributes": [',
            attributes,
            '],   "name": "Metaverse Country Club #',
            tokenId.toString(),
            '", "description": "Metaverse Country Club"}'
        );
        ...
        )
    {
        ...
        if (
            ...
            if (race == Races.HUMAN) {
                ...
                selection[3] = mouthIndex == 11 ? 10 : mouthIndex + 1;
            } else if (race != Races.TIGER) {
                traits[3] = mouthIndex == 11 || mouthIndex == 14
                    ? layers[3][10]
                    : layers[3][mouthIndex + 1];
                selection[3] = mouthIndex == 11 || mouthIndex == 14
                    ? 10
                    : mouthIndex + 1;
            } else {
                traits[3] = "";
                selection[3] = RACEWEIGHT[race][3].length;
            }
        }
