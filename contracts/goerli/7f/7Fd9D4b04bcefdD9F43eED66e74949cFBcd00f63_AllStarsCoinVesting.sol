...
contract AllStarsCoinVesting is Ownable, ReentrancyGuard, TokenVestingWhitelist {
    ...
    // 1666137600 - 19 Oct 2022 00:00:00 UTC
    // 1667401200 - 02 Nov 2022 15:00:00 UTC
    constructor(uint256 tgeTime_, address token_) TokenVestingWhitelist(token_) {
        ...
        _addRound(
            ...
            365 days, /* duration */
            1, /* slice */
            9_000_000 * (10**18), /* totalTokens */
            450_000 * (10**18), /* initialTokens */
            false /* free */
        );
        ...
        _addRound(
            ...
            0, /* duration */
            1, /* slice */
            90_000_000 * (10**18), /* totalTokens */
            90_000_000 * (10**18), /* initialTokens */
            true /* free */
        );
...
abstract contract TokenVesting {
    ...
    function _release(
        ...
        if (round.free == false) {
            ...
            uint256 fundsToPay = tokens * price;
