...
contract TestRBB is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using Strings for uint256;
    
    address private _AdventureContract;
    uint16       constant       internal    collectionRoyaltyAmount = 80; // 8%
    ...
    constructor() ERC721A("Test Royalties BB", "TRBB") {}
