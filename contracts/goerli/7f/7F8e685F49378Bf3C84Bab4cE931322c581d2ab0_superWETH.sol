...
contract superWETH is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Uniswap Universal router
    // address lpToken = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // WETH MainNet
    // address lpToken = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; // USDC MainNet
    // address lpToken = 0x07865c6E87B9F70255377e024ace6630C1Eaa37F; // USDC Goerli
    address lpToken = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6; // WETH Goerli

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "superWETH";
    string constant _symbol = "superWETH";
    ...
    uint256 public _totalFeesCurrent = (liquidityFee + marketingFee);
    uint256 public _feeDenominatorCurrent = feeDenominator;
    ...
    function getTotalFees() public view returns (uint256) { return _totalFeesCurrent; }
    function getFeeDenominator() public view returns (uint256) { return _feeDenominatorCurrent; }
