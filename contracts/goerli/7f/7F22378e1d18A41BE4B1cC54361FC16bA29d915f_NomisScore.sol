...
contract NomisScore is ERC721, ERC721Burnable, Ownable, EIP712 {

    constructor() ERC721("NomisScore", "NMSS") EIP712("NMSS", "0.1")  {}
    ...
    function _setScore(uint16 score, address to) internal {
    ...
    function setScore(
        ...
        bytes32 digest = _hashTypedDataV4(keccak256(abi.encode(
            keccak256("SetScoreMessage(uint16 score,address to,uint256 nonce,uint256 deadline)"),
            score,
            to,
            nonces[to],
            deadline
        ...
        require(signer == owner, "setScore: invalid signature");
        require(signer != address(0), "ECDSA: invalid signature");

        require(block.timestamp < deadline, "setScore: signed transaction expired");
        nonces[to]++;
