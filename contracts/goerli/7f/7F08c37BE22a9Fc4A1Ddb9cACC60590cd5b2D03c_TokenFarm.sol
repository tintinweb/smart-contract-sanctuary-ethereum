...
contract TokenFarm is Ownable, ReentrancyGuard {
    ...
    function stakeTokens(uint256 _amount, address _token) public nonReentrant {
        ...
        if (
            ...
            keccak256("0x07865c6e87b9f70255377e024ace6630c1eaa37f")
        ) {
        ...
        if (
            keccak256(abi.encodePacked(_token)) ==
            keccak256("0xFab46E002BbF0b4509813474841E0716E6730136")
        ) {
            stakingBalance[_token][msg.sender] =
                stakingBalance[_token][msg.sender] +
                _amount;
        ...
        if (
            keccak256(abi.encodePacked(_token)) ==
            keccak256("0xd0A1E359811322d97991E03f863a0C30C2cF029C")
        ) {
            stakingBalance[_token][msg.sender] =
                stakingBalance[_token][msg.sender] +
                _amount;
