    ...
    ERC721Holder
{
    ...
    function stakeNonFungible(
        ...
        require(unlockProvider[_tokenAddress][_tokenId] != address(0), "MC_STAKING: NO UNLOCK PROVIDER SET");
        ...
        if (unlockProvider[_tokenAddress][_tokenId] != address(0)) {
            ...
            ILockProvider(_lockProvider).onTokenLocked(msg.sender, lockup.amount, _relayerFee);
        }
    ...
    function stakeSemiFungible(
        ...
        require(tokenWhitelisted[_tokenAddress][_tokenId], "MC_STAKING: TOKEN NOT WHITELISTED");
        require(IERC1155(_tokenAddress).balanceOf(msg.sender, _tokenId) >= _amount);
    ...
    function unstake(
        ...
        if (unlockProvider[_tokenAddress][_tokenId] != address(0)) {
            address _lockProvider = unlockProvider[_tokenAddress][_tokenId];
            ILockProvider(_lockProvider).onTokenUnlocked(msg.sender, lockup.amount, _relayerFee);
        }
