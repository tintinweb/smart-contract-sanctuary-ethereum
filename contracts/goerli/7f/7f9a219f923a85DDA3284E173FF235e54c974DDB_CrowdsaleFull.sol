...
contract CrowdsaleFull is ERC20Buyable, ERC20Vesting {
    ...
    constructor(
        ...
        ERC20Buyable(rate_)
        ERC20Vesting(token_, saleStart_ + saleDuration_, saleStart_ + saleDuration_ + vestingDuration_, saleStart_ + saleDuration_ + cliffDuration_)
    {
        saleStart    = saleStart_;
        saleStop     = saleStart_ + saleDuration_;
