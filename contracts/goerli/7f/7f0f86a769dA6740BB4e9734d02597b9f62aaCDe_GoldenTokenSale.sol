...
contract GoldenTokenSale is Ownable, ReentrancyGuard
{
    ...
    bytes32 public _RootCitizen = 0x3562ad0218db63ea58e23ebc4db839b9d0a58b0707c2f2f77defcac88cbca2a9;
    bytes32 public _RootPurchaseLimits;
    uint public _MintPacksSold;
    uint public _TimestampSaleStart = 1670972400;
    uint public _TimestampEndFullSet = 1670973000;
    uint public _TimestampEndCitizen = 1670973600;
    uint private constant _PricePresale = 0.008 ether;
    uint private constant _PricePublic = 0.006 ether;
    uint private constant _MintPackMaxAmount = 50;
    address private constant _GOLDEN_TOKEN = 0x9D13156Faab0cdB23CEa952CA66D3661c99574eC;   // TESTNET *******************************
    address private constant _NIGHT_VENETIAN = 0xD60681d10eFD69503E7becB2be851a42aC1925cf; // TESTNET *******************************
    address private constant _OPERATOR_GT = 0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937;    // TESTNET *******************************
    address private constant _OPERATOR_NTV = 0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937;   // TESTNET *******************************
    ...
    constructor()
    {
        ...
        NTV[19] = 19;
        NTV[20] = 20;
        UserMaximumPurchasableAmount[0x18B7511938FBe2EE08ADf3d4A24edB00A5C9B783] = 3;
    }

    /**
     * @dev Purchases Mint Pack
     */
    function PurchaseMintPack(uint Amount, bytes32[] calldata EligibilityProof) external payable nonReentrant
    {
        ...
        if(block.timestamp <= _TimestampEndCitizen)
        {
            ...
            { 
                require(VerifyBrightList(msg.sender, _RootFullSet, EligibilityProof)); 
                require(
            ...
            else { require(VerifyBrightList(msg.sender, _RootCitizen, EligibilityProof)); } 
        ...
        {
            for(uint y; y < 4; y++) { IERC721(_GOLDEN_TOKEN).transferFrom(_OPERATOR_GT, msg.sender, ((333 * y) + 50 + _MintPacksSold)); }
            if(!PresaleEnded) { IERC721(_NIGHT_VENETIAN).transferFrom(_OPERATOR_NTV, msg.sender, NTV[_MintPacksSold]); }
            _MintPacksSold += 1;
        }
    ...
    /**
     * @dev New Root Purchase Limits
     */
    function __NewRootPurchaseLimits(bytes32 Newroot) external onlyOwner { _RootPurchaseLimits = Newroot; }
    ...
    function Eligibility(
        ...
        return User(
            ...
            UserMaximumPurchasableAmount[_Wallet]           
        );
    }
