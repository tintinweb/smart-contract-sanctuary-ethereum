...
*/
contract D8aDao is Initializable, ERC1155Upgradeable {
    ...
    */
    function initialize(string memory _name, string memory _symbol, address _usdt) public initializer {   
        ...
        _devWallet = address(0x62518A35D0393A6aE48B0F869637a4F5d36D2483);
        ...
        _mint(address(msg.sender), 1, 2100, ""); //0x2749Fa69c1f011b1a0164A01A35BEF781832d21D
        _mint(address(msg.sender), 2, 300, "");
        _mint(address(msg.sender), 3, 100, "");
