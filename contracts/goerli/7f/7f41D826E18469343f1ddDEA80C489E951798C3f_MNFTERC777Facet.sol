...
struct ERC777Storage {
    IERC1820Registry _ERC1820_REGISTRY;
...
contract MNFTERC777Facet is IERC777, IERC20 {
    ...
    function _callTokensToSend(
        ...
        ERC777Storage storage es = getERC777Storage();
        address implementer = es._ERC1820_REGISTRY.getInterfaceImplementer(from, es._TOKENS_SENDER_INTERFACE_HASH);
    ...
    function _callTokensReceived(
        ...
        ERC777Storage storage es = getERC777Storage();
        address implementer = es._ERC1820_REGISTRY.getInterfaceImplementer(to, es._TOKENS_RECIPIENT_INTERFACE_HASH);
        if (implementer != address(0)) {
