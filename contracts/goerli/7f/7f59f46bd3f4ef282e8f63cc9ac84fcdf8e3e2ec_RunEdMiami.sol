    ...
    FeatureBlockable
{
     ...
     * @dev Reverts if the maximum number of airdrops is exceeded.
     */
    function airdrop(address[] calldata receivers)
        external
        onlyUnblockedFeature(uint256(Feature.Airdrop))
        onlyOwner
    {
    ...
    function blockFeature(Feature feature) public onlyOwner {
