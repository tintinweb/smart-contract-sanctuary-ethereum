...
contract PoolBet{
    ...
    function _stake(string calldata  betid, uint stakeAmount, address staker) internal returns(bool success){
    ...
    function finalise(string calldata  betid, uint amount, address reciever, uint fee, bool last) external{
