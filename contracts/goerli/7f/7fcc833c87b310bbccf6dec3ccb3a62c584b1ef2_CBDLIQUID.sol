...
contract CBDLIQUID is ERC3525 {
    ...
    mapping(uint => string) private _jsonBase64;

    //Associated Data 
    string private _fund;
    ...
    string private _seller_fee_basis_points;
    string private _image;
    string private _external_url;

    string private _test1;

    //Asset Attributes
    mapping(uint => mapping(string => string)) public attributes;
    mapping(uint => string) public indexAttributes;
    mapping(uint16 => uint) public maxAmountPerSlot;
    //mapping(uint16 => bool) public salesStatus
    ...
    //Events
    event TitleIssuanceLimitSet( uint16 indexed slot, uint limit);

    constructor()
        ERC3525("CANNABIS MEDICINAL PUCMED", "CBDLIQUID", 18) {
        _jsonBase64[1] = "";

        owner = payable(msg.sender);
        tokenCounter = 0;
        tokenToBuyer[tokenCounter] = msg.sender; 
    ...
    function mint(address to_, uint256 slot_, uint256 amount_) external {
        require(msg.sender == owner,
            "Cannabis Medicinal: only owner can mint");
        _mint(to_, slot_, amount_);
    }

    function setAmountPerSlot(uint16 slot, uint maxAmount) public onlyOwner {
        require(maxAmount > 0, "Invalid issuance amount.");
        require(maxAmountPerSlot[slot]==0,
            "The initial issuance of titles for this slot has already been set.");
        maxAmountPerSlot[slot]= maxAmount;
        emit TitleIssuanceLimitSet(slot, maxAmount);
    }

    // function increaseAmountPerSlot(uint8 slot, uint maxAmount){

    // }  

    //tem de ter funcao que permite e verifica se o slot foi liberado para venda

    function tokenURI(uint256 tokenId_) public view virtual override returns (string memory) {
        bytes memory json = abi.encodePacked("data:application/json;base64,", _jsonBase64[1]);
        string memory uri = string(json);
        return uri;
    }
