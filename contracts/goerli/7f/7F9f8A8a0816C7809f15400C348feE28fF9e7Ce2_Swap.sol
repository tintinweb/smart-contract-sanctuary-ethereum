...
contract Swap {
    ...
    function safeTransferWithApprove(address input, uint256 amountIn, address routerAddress)
        internal
    {
        ...
        TransferHelper.safeApprove(input, routerAddress, amountIn);
    }

    function swapExactInputSingle(address input, address output, uint256 amountIn)
        external
        returns (uint256 amountOut)
    {
        safeTransferWithApprove(input,amountIn, address(swapRouter));
