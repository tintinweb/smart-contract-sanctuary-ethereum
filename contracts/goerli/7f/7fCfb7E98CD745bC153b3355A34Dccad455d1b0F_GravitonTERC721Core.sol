...
contract MockRoyaltiesRegistry is IRoyaltiesProvider, OwnableUpgradeable {
...
import "./GravitonTERC721.sol";
import "@openzeppelin/contracts/utils/Counters.sol";

contract GravitonTERC721Core is GravitonTERC721 {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIds;

    constructor(string memory _tokenName, string memory _tokenSymbol)
        GravitonTERC721(_tokenName, _tokenSymbol)
    {}
    ...
    function mint(
        ...
        emit GravitonTERC721TokenMinted(newItemId, tokenURI, receiver, block.timestamp);
        return newItemId;
    }
}
...
contract GravitonTERC721 is ERC721Enumerable, ERC721URIStorage, ERC721Consumable, Ownable, HasSecondarySaleFees, ERC2981Royalties {
    using Counters for Counters.Counter;
    ...
    event GravitonTERC721TokenMinted(
        uint256 tokenId,
        string tokenURI,
        address receiver,
        uint256 time
    ...
    function mint(
        ...
        emit GravitonTERC721TokenMinted(newItemId, newTokenURI, receiver, block.timestamp);
        return newItemId;
    }
...
contract GravitonTERC721Factory is Ownable {
    address[] public deployedContracts;
    address public lastDeployedContractAddress;

    event LogGravitonTERC721ContractDeployed(
        string tokenName,
        string tokenSymbol,
    ...
    function deployGravitonTERC721(string memory tokenName, string memory tokenSymbol)
        external
        returns (address gravitonTNFTERC721Contract)
    {
        GravitonTERC721 deployedContract = new GravitonTERC721(tokenName, tokenSymbol);
        ...
        emit LogGravitonTERC721ContractDeployed(
            tokenName,
            tokenSymbol,
