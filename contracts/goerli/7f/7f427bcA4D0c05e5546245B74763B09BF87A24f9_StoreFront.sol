    ...
    ERC721EnumerableUpgradeable
{
    ...
    */
    ...
    function setMerkleRoot(
        ...
        _presales[tierId].merkleRoot = merkleRoot_;
    }
    ...
    */
    ...
    function updateTier(
        ...
        require(_tiers[id].id != 0, "TIER_NOT_INITIALIZED");
        require(maxSupply > 0, "INVALID_SUPPLY");
        require(maxPerTx > 0, "INVALID_MAX_PER_TX");
        require(maxPerWallet > 0, "INVALID_MAX_PER_WALLET");
        require(price > 0, "INVALID_PRICE");
    ...
    function initPreSale(
        ...
        require(merkleRoot_ != bytes32(0), "INVALID_MERKLE_ROOT");
    ...
    */
    ...
    function mint(
        ...
        for (uint256 i = 0; i < tokenTiers.length; i++) {
            ...
            // Mint tier
            _mintTier(msg.sender, tierId, tokenSize);
        }
    }
    ...
    */
    ...
    function _mintTier(address to, uint256 tierId, uint256 tokenSize) internal {
        ...
        for (uint256 j = 0; j < tokenSize; j++) {
            _safeMint(to, (tier.supply * _maxTiers) + tierId);
            tier.supply++;
            _ownerTierBalance[to][tierId]++;
            _ownerTierTokens[to][tierId][_ownerTierBalance[to][tierId] - 1] =
                (tier.supply * _maxTiers) +
                tierId;
        }
