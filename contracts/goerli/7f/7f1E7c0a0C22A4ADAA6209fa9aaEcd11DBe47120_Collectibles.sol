...
contract Collectibles is ERC721URIStorage, IERC2981 {
    ...
    function updateURI(string memory tokenURI, uint256 _tokenId) external {
        require(
            msg.sender == ownerOf(_tokenId),
            "Only owner can change the tokenURI"
        );
    ...
    function transferRoyaltyRights(
