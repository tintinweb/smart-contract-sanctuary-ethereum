...
contract TestCollectionCBD  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://bafkreihhyiw2c25svntrmtes2cwet6xlkusrmv5cprtpqvkxvovo377x5q";

    uint256 public immutable mintPrice = 0.01 ether;
    uint256 public immutable minMintable = 0.009 ether;
    ...
    constructor()
    ERC721A ("TestCollectionCBD", "TCBD") {
    }
    ...
    function mintMyClown(uint256 amount) public payable callerIsUser{
        require(msg.value > minMintable, "insufficient");
    ...
    function stakeNft(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
