...
contract UtilityFactoryCollab is ReentrancyGuard {
    ...
    function checkWL(
        ...
        return _checkList(collectionAddress, addr, v, r, s, 0);
    }
    ...
    function checkFreeMint(
        ...
        return _checkList(collectionAddress, addr, v, r, s, 1);
    }
    ...
    function _checkList(
        ...
        bytes32 digest = keccak256(
            abi.encodePacked(
                "\x19Ethereum Signed Message:\n32",
                keccak256(abi.encodePacked(collectionAddress, addr, checkType))
            )
        );
        address recovered = ecrecover(digest, v, r, s);
        return admins[recovered];
