...
// File: contracts/CryptoKaren_V4_ERC721A.sol
...
contract CryptoKaren_V4_ERC721A is ERC721A, Ownable {
    ...
    function setPrivateAllowList(address[] calldata addresses, uint8[] calldata amount) external onlyOwner {
