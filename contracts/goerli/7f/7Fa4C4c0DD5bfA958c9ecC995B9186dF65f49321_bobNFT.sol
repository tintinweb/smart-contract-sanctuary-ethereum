...
contract bobNFT is Ownable, PaymentSplitter, ERC721A, ReentrancyGuard {
    ...
    bool public _claimNftActive = false;
    ...
    function ClaimActive(bool isActive) external onlyOwner {
        _claimNftActive = isActive;
    }
    ...
    // claimnft
    function claimnft(uint8 quantity)
        external
        callerIsUser
        nonReentrant
    {
        require(_claimNftActive, "mint is not active");
        require(
            _claimListCounter[msg.sender] + quantity <= maxClaim,
