...
contract ControllorFacuet {
    ...
    function controllorCreateSignetor() external {
        ...
        (, address b, ) = STCrator.createSignetor("Signetor", "ST", msg.sender);
        LibSignetStorage.controllorCreateSignetor(msg.sender, b);
    ...
    ) public Joined returns (bool success) {
...
contract Signetors {
    ...
    constructor(address _controllor) {
        ControllorAddr = _controllor;
        setAddress();
    }
    ...
    function createSignetor(
        ...
        address crator
    ) external isControllor returns (address, address, uint256) {
