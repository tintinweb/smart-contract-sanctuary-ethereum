...
contract TokenMasksLabs is ERC721A, Ownable, DefaultOperatorFilterer{
    ...
    constructor(
    ) ERC721A ('ETH MASKS v2','EM'){// コレクション名：　ETH MASKS、　トークンの名前：EM
        setBaseURI('https://bafybeibl255bewdrtc4ct5hkt7pjnvagwuxu3snlf46npiyqnfixagfnj4.ipfs.nftstorage.link/');
    }
    ...
    */
    ...
    // mintするときにETHを送金する、コントラクトにたまるから、それを引っ張り出す
    function withdraw() public payable onlyOwner {
        (bool os, ) = payable(owner()).call{value: address(this).balance}(""); //正常にcallが動作したか,正常じゃないときは止める
        require(os);
    }
