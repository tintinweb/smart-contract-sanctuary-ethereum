...
contract LandNFT_V1 is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function buy(
        ...
        console.log("mintNum: ", _mintNum);
        console.log("balanceOf: ", usdcToken.balanceOf(msg.sender));
        console.log("tokenPrice: ", tokenPrice.mul(_mintNum));
        console.log("require: ", usdcToken.balanceOf(msg.sender) >= tokenPrice.mul(_mintNum));
    ...
    function transferTokens(uint256 _mintNum, uint256 _tokenPrice) internal {
        ...
        console.log(_tokenPrice.mul(_mintNum));
