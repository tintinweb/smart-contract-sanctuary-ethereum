...
*/
    ...
    contract MyCoolContract2 is ERC721, Ownable, ReentrancyGuard   {
        using Strings for uint256;
        ...
        constructor(uint256 _price, uint256 __maxSupply, string memory _initBaseURI, uint256 _maxMintAmountPerTx, uint256 _maxMintAmountPerWallet) ERC721("My Cool Collection 2", "MCC2") {
