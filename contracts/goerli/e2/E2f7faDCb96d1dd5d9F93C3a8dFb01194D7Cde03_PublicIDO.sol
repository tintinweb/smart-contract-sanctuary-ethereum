...
contract PublicIDO {
    ...
    constructor(address _usdt, address _plexus) public {
        ...
        // mainnet ERC20 PLX = "0x60b9c9C167bA57cc376b0FaafC68Df5C9882328e";
        usdt = _usdt;
        plexus = _plexus;
    ...
    function deposit(uint256 _userDepositAmount) public {
        ...
        if (userAddress.length == 0 || (userId[depositUser] == 0 && userAddress[0] != depositUser)) {
    ...
    function depositP2(uint256 _userDepositAmount) public {
        ...
        IERC20(usdt).transferFrom(depositUser, address(this), userDepositAmountInt);
        if (userAddressP2.length == 0 || (userIdP2[depositUser] == 0 && userAddressP2[0] != depositUser)) {
