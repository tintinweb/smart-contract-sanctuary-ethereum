...
pragma solidity ^0.8.0;
  ...
  string public hiddenURL = "ipfs://-----------";
  uint256 public cost = 0.0069 ether; // FreeMint for Larva Chad and Cryptodickbutts Holders 
  ...
  IMain Main = IMain(ogContractAddress); //Address of NFT contract that's the key for WL Mint

  
  constructor() ERC721A("chonkyPets", "CHP") {}
