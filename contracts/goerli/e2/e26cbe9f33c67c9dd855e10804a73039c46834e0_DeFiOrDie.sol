...
contract DeFiOrDie is ERC20, Ownable {
    using SafeMath for uint256;
...
Marketing
0x37a2B13921CCD713446fE9bdf5B1FbD34f38aEba
Dev Wallet
0xe1381Ef7A395459d6fe9A64b83E93b4f340BA3f7
*/
    constructor() ERC20("DeFi Or Die", "DORD") {

        address newOwner = address(0x9bcBE4Af33C43E12c82d2fcD77DF6AF7F82174A2);
    	...
    	marketingWallet = address(0x37a2B13921CCD713446fE9bdf5B1FbD34f38aEba); // set as marketing wallet
