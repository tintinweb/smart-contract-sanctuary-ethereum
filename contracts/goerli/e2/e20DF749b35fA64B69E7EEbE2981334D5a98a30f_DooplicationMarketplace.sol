...
contract DooplicationMarketplace is ReentrancyGuard, AccessControl {
    ...
    mapping(address => bool) public activeDooplications;
    ...
    // modifier areValidContracts(
    //     address dooplicationContract,
    //     address tokenAddress
    // ) {
    //     if (!activeDooplications[dooplicationContract]) {
    //         revert DooplicationContractNotActive(dooplicationContract);
    //     }
    //     // IDooplication dooplication = IDooplication(dooplicationContract);
    //     if (!IDooplication(dooplicationContract).contractApproved(tokenAddress)) {
    //         revert TokenContractNotApproved(dooplicationContract, tokenAddress);
    //     }
    //     _;
    // }
    ...
    function listItem(
        ...
        // TODO discomment me:
    // areValidContracts(dooplicationAddress, tokenAddress)
    {
        // if (!activeDooplications[dooplicationAddress]) {
     ...
     * The owner of an NFT could unapprove the marketplace,
     * which would cause this function to fail.
     * The owner of an NFT could also transfer the NFT to another address,
     * which would cause this function to fail.
     * @param dooplicationAddress Address of dooplication contract
     * @param tokenAddress Address of NFT contract
     * @param tokenId Token ID of NFT
        ...
        nonReentrant
    {
        ...
        // IDooplication dooplication = IDooplication(dooplicationContract);
        // TODO execute dooplicate function
    ...
    function setActiveValidDooplication(
        ...
        activeDooplications[dooplicationContract] = active;
    }
