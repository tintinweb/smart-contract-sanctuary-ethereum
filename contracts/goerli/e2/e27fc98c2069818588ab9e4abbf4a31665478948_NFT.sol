...
contract NFT is ERC721, Owned {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = string.concat('<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>path {fill: "', getColor(0, 255*tokenPower/MAX_INITIAL_POWER, 0), '"}</style><rect width="100%" height="100%" fill="', getColor(255, tokenHealth, tokenHealth), '" />');
