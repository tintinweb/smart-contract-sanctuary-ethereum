...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x062bbEC4712C6B0Cc993Eba7Fe3b16c6bC204B3B];
...
// File: contracts/TesterContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TesterContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/aPhFHbJfpNxgHCP6kh0I/contract-metadata";
  }
