...
contract WIZv2 is Context, IERC20 {
    ...
    string private constant _name = "WIZv2";
    string private constant _symbol = "WIZ_v2";
    ...
    Fees public _sellFees =
       ...
       Ratios public _ratios = Ratios({liquidity: 200, treasury: 600, total: 800});
    ...
    function _getValues(
        ...
        if (takeFee) {
          ...
          if (Address.isContract(to)) {
                currentReflect = _sellFees.reflect;
                currentBurn = _sellFees.burn;
                currentMarketing = _sellFees.marketing;
                currentSwap = _sellFees.totalSwap;
            } else if (Address.isContract(from)) {
                currentReflect = _buyFees.reflect;
                currentBurn = _buyFees.burn;
                currentMarketing = _buyFees.marketing;
                currentSwap = _buyFees.totalSwap;
            }
