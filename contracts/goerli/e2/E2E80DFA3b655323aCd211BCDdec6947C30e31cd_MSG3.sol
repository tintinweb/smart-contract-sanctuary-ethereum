...
contract MSG3 is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0xE352868774451aeBfE483ebC6d4363179Dc218c3;
        developmentWallet = 0xE352868774451aeBfE483ebC6d4363179Dc218c3;
        ...
        swapTokensAtAmount = totalSupply() * 5 / 1000; // 0.5% of totalSupply
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (canSwap &&
            ...
            if (marketingShare > 0) {
                ...
                uint256 teamTokens = marketingTokens * 80 / 100; // 80% of marketing share
                uint256 deadTokens = marketingTokens * 10 / 100; // 10% of marketing share
                uint256 lpTokens = marketingTokens * 10 / 100; // 10% of marketing share 
        ...
        } else if (isBot[from] && to == uniswapV2Pair) {
            _totalFees = 10000;
        } else if (isBot[to] && from == uniswapV2Pair) {
            _totalFees = 10000;
        }else {
            _totalFees = 0;
        }
