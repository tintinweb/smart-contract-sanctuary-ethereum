...
contract WMinima is ERC20PresetMinterPauser {
    ...
    function newAddress(bytes32 minimaAddress) public returns(bool success) {
        ...
        //minimaStructs[wminimaAddress].listPointer = minimaList.push(wminimaAddress) - 1; in older versions of solidity
    ...
    function deleteAddress() public returns(bool success) {
        ...
        minimaList.pop(); //minimaList.length--; in older versions of solidity
        return true;
    }

    constructor () ERC20PresetMinterPauser("WMinima1", "WMIN") {  
    }
}
