...
import "./extensions/TokenRecovery.sol";

/**
 * @notice Implementation of the {ILockdropFactory} interface.
 */
contract LockdropFactory is ILockdropFactory, TemplateDeployer, TokenRecovery {
    /**
     * @inheritdoc ILockdropFactory
     */
    bytes32 public constant override CREATE_ROLE = keccak256("Lockdrop.CREATE_ROLE");

    constructor(uint256 templateVersion) TemplateDeployer(bytes32("Lockdrop"), templateVersion) {}

    /**
     * @inheritdoc ILockdropFactory
     */
    function create(address asset, address withdrawTo, ILockdrop.DateConfig calldata dateConfig)
        external
        override
