...
contract NftLog is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
        ...
        mintPriceCompliance(_mintAmount)
    {
        ...
        require(
            _isWhitelisted(msg.sender, _merkleProof, merkleRoot),
            "Invalid proof"
        );
     ...
     */
    function giftMint(address[] calldata _receiver) external nonReentrant onlyOwner {
