...
contract FRG5 is ERC20, Ownable {
    ...
    {   
        ...
        marketingFeeOnBuy  = 4000; // 40%
        marketingFeeOnSell = 4000; // 40%

        _totalFeesOnBuy    = liquidityFeeOnBuy  + marketingFeeOnBuy;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell;

        marketingWallet = 0x3265403897b80DB188a240f3D49673b82ae60177;
        developmentWallet = 0xEcD9c2cB26a7D6DC56D41c2129FeBCc26d2E06f2;
        ...
        uint256 marketingSupply = _totalSupply * 690 / 10000; // 6.9%
        uint256 devSupply = _totalSupply * 1000 / 10000; // 10%
