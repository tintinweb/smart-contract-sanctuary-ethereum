...
contract WashingtonNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 1789;
  uint256 public maxMintAmountPerTx = 5;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Washington Digital Trading Cards", "WASHINGTON") {
    setHiddenMetadataUri("ipfs://QmPF8ayAR2PsUWwci9dX8RyHtS5KbLvYGQ627qnCYS6ER8/hidden.json");
