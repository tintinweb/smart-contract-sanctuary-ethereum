...
contract Q is ERC721, ERC721Enumerable, ERC721Burnable, ReentrancyGuard, Ownable {
    ...
    function check(string memory emoji) external returns (uint) {
        return bytes(emoji).length;
    }

    /**
    * @notice Cost is free! Tats are for life
    * @notice Once you mint this shit it's stuck in your wallet FOREVER. Pledge your allegiance ❓
    */
