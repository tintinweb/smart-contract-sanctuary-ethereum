...
// @author: @fritzgnad
// @title: Walking Poets
contract WalkingPoets is ERC721, Ownable, ERC2981{
    ...
    constructor() ERC721("Walking Poets", "wPoets") {
        signingAddress = msg.sender;
        baseURI = "https://walkingpoets.com/api/";
    }

    function ownerAwakePoet(address to, uint256 tokenId) public onlyOwner {
