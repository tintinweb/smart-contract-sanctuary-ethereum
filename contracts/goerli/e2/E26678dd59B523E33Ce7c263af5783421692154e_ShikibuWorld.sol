...
contract ShikibuWorld is
    ...
    bytes32 public burnMintMerkleRoot;
    ...
    SalePhase public phase = SalePhase.Pri1Sale;
...
//        bytes32 leaf = keccak256(abi.encodePacked(msg.sender, _alAllocated, _fcfsAllocated, _shikiBooking));
        require(
        ...
        // ミント数上限チェック
        require(
            pri1MintCount[msg.sender] + _mintAmount <= _alAllocated,
...
//        bytes32 leaf = keccak256(abi.encodePacked(msg.sender, _alAllocated, _fcfsAllocated, _shikiBooking));
    ...
    function burnMint(
        ...
        require(
            MerkleProof.verify(_merkleProof, burnMintMerkleRoot, leaf),
            "Invalid Merkle Proof"
        );
    ...
    /**
     * @notice Set the merkle root for the burn mint
     */
    function setBurnMintMerkleRoot(bytes32 _burnMintMerkleRoot) external onlyAdminOrOwner {
        burnMintMerkleRoot = _burnMintMerkleRoot;
    }
