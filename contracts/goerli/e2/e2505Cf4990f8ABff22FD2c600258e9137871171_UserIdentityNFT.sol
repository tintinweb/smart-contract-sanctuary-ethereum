...
contract UserIdentityNFT is ERC721URIStorage, ERC721Votes, IUserIdentityNFT {
    ...
    function redeem(UserIdVoucher memory voucher) public {
    ...
    function _hash(UserIdVoucher memory voucher) internal view returns (bytes32) {
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
    ...
    function verifySignature(UserIdVoucher memory voucher) public view returns (address) {
