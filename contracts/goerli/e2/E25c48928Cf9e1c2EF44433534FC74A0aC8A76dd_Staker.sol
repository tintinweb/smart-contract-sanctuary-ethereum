...
contract Staker {
    ...
    // Modifier that requires the deadline to be reached or not
    ...
    // Stake method that updates the user's balance
    ...
    // Allows users to withdraw their balance from the contract only if deadline is reached but the stake is not completed
    ...
    // The number of seconds remaining until the deadline is reached
