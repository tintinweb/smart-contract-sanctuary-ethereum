...
contract y00tsAnchorClub is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 internal nextMintableId = 0; // IDs start at 0
    ...
    function getYYCBelongingToOwner(address _owner, uint count)
        public
        view
        returns (uint256[] memory)
    {
       
        uint256 numPhunks = oldContract.balanceOf(_owner);
        require(count <= numPhunks, "Max mint count exceed");
