...
contract LuxNFT is ERC721Enumerable, Pausable, Ownable, ERC721Burnable
{
    ...
    function changeBaseURI(string memory newBaseURI1) external onlyOwner
    {
