 ...
 * Admin can create any number of bundles, each representing a mintable NFT,
 * its price, availability and rewards granted.
    ...
    function setupBundleMulti(
        ...
        for(uint i=0; i<data.length; ++i){
            _setupBundle(
                ...
                competitionContract // Competition contract address
            );
        }
    }
