...
contract TicketNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    //mapping from tokenID to bool (available true/false)
    mapping(uint256 => bool) private _validity;

    //mapping for tokenURIs for invalid tickets
    mapping(uint256 => string) private _invalidTokenURIs;
    ...
    function safeMint(
        ...
        _setInvalidTokenURI(tokenId, invalidURI);
    }

    function _setInvalidTokenURI(uint256 tokenId, string memory _tokenURI)
        internal
        virtual
    {
        require(
        ...
        _invalidTokenURIs[tokenId] = _tokenURI;
    }
        ...
        returns (string memory)
    {
        ...
        if (_validity[tokenId] == true) {
            ...
            return _invalidTokenURIs[tokenId];
        }
    }
