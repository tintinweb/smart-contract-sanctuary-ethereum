...
contract VaultFactory is Ownable {
    ...
    // add the address of the fee contract
    constructor(
        address vaultAddress,
        uint256 creationFee_,
        address feeContractAddress_
    ) {
        impl = vaultAddress;
    ...
    modifier collectFee() {
        require(msg.value == creationFee, "Fee not sufficient");
