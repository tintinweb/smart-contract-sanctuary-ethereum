...
contract Swoopahs is ERC721AQueryable, IERC721ABurnable, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public _maxMintPerPublicWallet = 500;
    ...
    function setSwoopahsMintRoot(bytes32 _root) external onlyOwner {
        swoopahsMintRoot = _root;
    }  

    function setSwoopahsPublicMintActive(bool isActive) external onlyOwner {
        _swoopahsPublicMintActive = isActive;
    }  

    function setSwoopahsWhitelistMintActive(bool isActive) external onlyOwner {
