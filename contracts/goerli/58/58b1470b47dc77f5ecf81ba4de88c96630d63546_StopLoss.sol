...
contract StopLoss is Ownable {
    ...
    int256 public constant ALERT_PRICE = 1200;
    ...
    function check() external {
        uint256 index = (block.timestamp / (1 minutes)) % MINUTES;
        prices[index] = getChainLinkLatestPrice();
        int256 total = 0;
        ...
        if (average < ALERT_PRICE**decimals) {
            sell();
        }
    }
