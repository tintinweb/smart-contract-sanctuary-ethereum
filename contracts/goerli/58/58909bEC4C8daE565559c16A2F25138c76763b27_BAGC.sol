...
contract BAGC is OwnableUpgradeable, ERC721URIStorageUpgradeable, ERC721EnumerableUpgradeable {
    ...
    uint256 private _userTokenBoundaries;
    ...
    /// @notice the function used to check if the token is a user volume token
    function isUserToken(uint256 tokenId) internal view returns (bool) {
        return
