...
contract test1155D is ERC1155DUpgradeable, IERC2981 {
...
/**
* @notice Function to check the implemented interafaces on the contract.
...
/**
* @notice Funtion to mint tokens.
*/
function mint() public payable {
    require(id <= MAX_SUPPLY, "Error: max supply reached");
    unchecked {id++;}
...
/**
* @notice Function to see the wallet of the admin.
...
/**
* @notice Function to see the contract URI.
* @return contractURI Contract URI of the contract.
 */
