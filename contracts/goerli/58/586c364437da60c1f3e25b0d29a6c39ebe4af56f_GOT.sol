...
contract GOT is Context, IERC20, Ownable {
    ...
    address public marketingWalletToken = 0xdAC17F958D2ee523a2206206994597C13D831ec7; //USDT
    ...
    constructor () {
        ...
        _marketingFeesGOT = 6;
        _burnFeesGOT = 2;
        _totalFeesGOT = _liquidityFeesGOT.add(_marketingFeesGOT).add(_burnFeesGOT);
    ...
    function setLiquidityFeePercent(uint256 newLiquidityFee) external onlyOwner() {
        ...
        require(newLiquidityFee.add(_burnFeesGOT).add(_marketingFeesGOT) <= _maxFeesGOT, "Fees are too high.");
    ...
    function setMarketingFeePercent(uint256 newMarketingFee) external onlyOwner() {
        require(!inSwapAndLiquify, "inSwapAndLiquify");
        require(_liquidityFeesGOT.add(_burnFeesGOT).add(newMarketingFee) <= _maxFeesGOT, "Fees are too high.");
    ...
    function setBurnFeePercent(uint256 newBurnFee) external onlyOwner() {
        require(_liquidityFeesGOT.add(newBurnFee).add(_marketingFeesGOT) <= _maxFeesGOT, "Fees are too high.");
        _burnFeesGOT = newBurnFee;
        _totalFeesGOT = _liquidityFeesGOT.add(_marketingFeesGOT).add(_burnFeesGOT);
        emit SetBurnFee(_burnFeesGOT);
    }
    ...
    function _transfer(
        ...
        if(
            ...
            !_isExcludedFromMaxBalanceGOT[to]  // is excludedFromMaxBalance
        ) {
            require(
        ...
        if(
            ...
            _totalFeesGOTContract > 0 &&                         // LiquidityFee + MarketingFee > 0
            from != owner() &&                                  // Not from Owner
            to != owner()                                       // Not to Owner
        ) {
            collectFees();
        ...
        if(
            ...
            uint256 toBurnAmount = amount.mul(_burnFeesGOT).div(100);
