...
contract VenturePassSVG is ERC721A, Ownable, OperatorFilterer {
    ...
    function _buildTokenURI(uint256 id) internal view returns (string memory) {
        ...
        if (isTokenLocked(id)) {
            lockText = string(
                abi.encodePacked(
                    unicode'<text class="h1" x="50" y="70">Token is locked</text>'
                )
            );
        }
            ...
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        ...
                        '<image href="ipfs://QmZ3SJB2oV8DxDGcAaiSGaGj7apjiawfzXj4pxFsAgJxdF" height="1024" width="1024" x="50" y="50"/>',
                        lockText,
                        '</svg>'
                    )
                )
            ...
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"Venture Pass", "image":"',
                                image,
                                unicode'", "description": "Venture Pass. Your guide to Mythic Journeys, The Arena, METL rewards, and much more."}'
                            )
                        )
                    )
                )
