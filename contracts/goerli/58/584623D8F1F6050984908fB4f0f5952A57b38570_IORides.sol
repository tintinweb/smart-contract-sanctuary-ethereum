...
contract IORides is ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, OperatorFilterer {
    ...
    constructor(string memory _name, string memory _symbol) ERC721(_name, _symbol) OperatorFilterer(msg.sender, true) {}
    ...
    function mintIORide(address to, uint256 tokenId) external virtual nonReentrant returns (uint256) {
