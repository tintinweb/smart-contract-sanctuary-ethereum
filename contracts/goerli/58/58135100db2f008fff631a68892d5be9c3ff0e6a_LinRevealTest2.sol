...
contract LinRevealTest2 is ERC721A, Ownable, ReentrancyGuard { 
    ...
    constructor(string memory _hiddenMetadataUri,string memory initBaseURI) ERC721A("LinRevealTest2", "LinRevealTest2") {
