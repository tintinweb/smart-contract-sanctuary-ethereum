...
contract FixedStaking is ERC20 {
    ...
    constructor() ERC20("MOD Coin", "MOD") {
        _mint(msg.sender,100000000000000000000000000); //recive word
    ...
    function claim() public {
        ...
        uint256 secondsStaked = block.timestamp - stakedFromTS[msg.sender]; //เก็บเวลาปัจจุบัน มาลบกับเวลาที่จะถอน
        uint256 rewards = (staked[msg.sender] * secondsStaked / 3.1536e10)*2;
