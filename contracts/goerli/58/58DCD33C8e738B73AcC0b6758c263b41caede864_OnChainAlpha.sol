...
contract OnChainAlpha is ERC721A, ReentrancyGuard, Ownable {
    ...
    string[] private LAYER_NAMES = [unicode"Light Saber", unicode"Mouth", unicode"Outerwear", unicode"Headwear", unicode"Ears", unicode"Eyes", unicode"Body", unicode"BodyRing", unicode"Background"];
    ...
    uint public publicMintPrice = 0.0001 ether;
    ...
    constructor() ERC721A("On-Chain Alpha", "OCA") {
        TIERS[0] = [0,8999,300,50,100,550];
        TIERS[1] = [0,2500,100,100,100,100,100,200,200,200,200,200,200,299,300,300,300,400,400,400,400,400,400,400,400,400,1000];
        TIERS[2] = [0,6299,300,400,400,400,700,700,500,100,200];
        TIERS[3] = [0,3000,100,100,100,100,100,100,100,100,100,100,100,100,100,100,200,300,300,300,300,300,300,300,300,300,500,500,500,500,200,500];
        TIERS[4] = [0,0,500,1000,2000,2500,4000];
        TIERS[5] = [0,3500,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,200,200,200,200,200,200,300,300,300,300,300,300,300,300,300,300,300,499];
        TIERS[6] = [0,50,150,500,700,900,900,1000,1100,1500,3200];
        TIERS[7] = [0,50,100,700,200,500,1000,5449,2000];
        TIERS[8] = [0,0,700,4000,1200,1000,100,3000];
    }
    ...
    function tokenIdToHash(uint _tokenId) public view returns (string memory) {
        ...
        //enable and disable layers here
    ...
    function tokenURI(uint _tokenId) public view override returns (string memory)
    {
        ...
        if (LibString.runeCount(tokenValues[_tokenId].userName) > 0)
        {
    ...
    function setProfile(uint256 _tokenId, string memory _username, string memory _twitter, string memory _primaryENS, string memory _website) external {
        ...
        tokenValues[_tokenId].profileName = LibString.concat(LibString.concat(_username, "#"), _toString(_tokenId));
