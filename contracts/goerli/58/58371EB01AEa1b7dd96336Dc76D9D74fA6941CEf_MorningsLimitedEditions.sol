 ...
 * @title  Mornings by Gutty Kreum
 * @notice Mornings is a collection of digital memories exploring morning ambience by pixel artist, Gutty Kreum.
 *         A limited release in collaboration with Fount Gallery, Mornings drops on June 15, 2023.
 *
 * Features:
 ...
 * @author Fount Gallery
 * @title  ERC721Base
 * @notice Base contract for Mornings to inherit from
 *
 * Features:
    ...
    OperatorFilterer
{
    ...
    string public constant SIGNING_DOMAIN = "Mornings";
