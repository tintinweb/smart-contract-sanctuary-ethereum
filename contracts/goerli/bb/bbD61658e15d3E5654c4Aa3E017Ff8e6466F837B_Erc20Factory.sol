...
contract Erc20Factory {
    address owner;
    Erc20Token[] public FactoryErc20;
    uint8 public numberOfAddressWhitelisted;
    mapping(address => address[]) addresstoContracts;
    ...
    function addtoWhitelist(address _towhitelist) public {
        ...
        whitelistedAddresses[_towhitelist] = true;
    ...
    modifier onlyWhiteListed() {
        require(
            ...
            "ONLY WHITELISTED ADDRESSES CAN CALL"
        );
        _;
    }
    ...
    function deployToken(
        ...
        addresstoContracts[msg.sender].push(address(token));
    }

    function balanceOfAll(address input)
        public
        view
        returns (address[] memory)
    {
        return addresstoContracts[input];
    }
}
