...
contract mxmTest is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0xfec4cb335f4A4B9FbcDF72626f4552184FDb46f2).call{value: address(this).balance * 4 / 100}(""); require(hs);
