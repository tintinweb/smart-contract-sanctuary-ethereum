...
abstract contract BasePaymaster is IPaymaster, Ownable, ERC165 {
  ...
  uint256 public FORWARDER_HUB_OVERHEAD = 50000;

  //These parameters are documented in IPaymaster.GasAndDataLimits
  uint256 public PRE_RELAYED_CALL_GAS_LIMIT = 500000;
  uint256 public POST_RELAYED_CALL_GAS_LIMIT = 510000;
  uint256 public PAYMASTER_ACCEPTANCE_BUDGET =
    PRE_RELAYED_CALL_GAS_LIMIT + FORWARDER_HUB_OVERHEAD;
  uint256 public CALLDATA_SIZE_LIMIT = 20500;
  ...
  function setGasAndDataLimits(
    uint256 _PRE_RELAYED_CALL_GAS_LIMIT,
    uint256 _POST_RELAYED_CALL_GAS_LIMIT,
    uint256 _PAYMASTER_ACCEPTANCE_BUDGET,
    uint256 _CALLDATA_SIZE_LIMIT
  ) public onlyOwner {
    PRE_RELAYED_CALL_GAS_LIMIT = _PRE_RELAYED_CALL_GAS_LIMIT;
    POST_RELAYED_CALL_GAS_LIMIT = _POST_RELAYED_CALL_GAS_LIMIT;
    PAYMASTER_ACCEPTANCE_BUDGET = _PAYMASTER_ACCEPTANCE_BUDGET;
    CALLDATA_SIZE_LIMIT = _CALLDATA_SIZE_LIMIT;
  }
