...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    function approve(address to, uint256 tokenId) onlyTransferAllowed(to) public virtual override {
    ...
    function _transfer(
        ...
        address to,
        uint256 tokenId
    )isNFTLock(tokenId) onlyTransferAllowed(msg.sender)  internal {
...
abstract contract EnforceFee is ERC721AQueryable, DefaultOperatorFilterer {
 ...
 */
contract Collection is ProxyBaseStorage, EnforceFee, Ownable, CollectionStorage{
using Strings for uint256;
