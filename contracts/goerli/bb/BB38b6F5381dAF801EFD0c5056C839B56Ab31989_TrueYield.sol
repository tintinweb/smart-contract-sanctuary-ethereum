...
contract TrueYield {
    ...
    function getUserLiquidityLendingPool(address _address) external view returns(uint, uint, uint, uint, uint, uint) {
        return iLendingPool.getUserAccountData(_address);
    }
