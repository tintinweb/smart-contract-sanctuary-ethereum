...
contract WaatcaNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    // records when the contract was deployed so we can stop the sale of WAATCA NFTs after 2 week.
    uint256 public deploymentTime;
    uint256 public twentyOneDaysAfterDeployment;
    ...
    constructor(
        ...
        twentyOneDaysAfterDeployment = deploymentTime + 21 days;
    ...
    function mintWaatcaNft(uint256 purchaseAmount, string memory uri) public {
        require(
            block.timestamp <= twentyOneDaysAfterDeployment,
    ...
    {
        require(
            block.timestamp >= twentyOneDaysAfterDeployment + 91 days,
            "Function can only be called within 112 days of deployment"
        ); // 101 days after the 21 day launch
