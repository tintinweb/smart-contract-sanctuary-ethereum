...
contract TokenProxy is Proxy {
    ...
    */
        ...
        public
    {
        ...
        symbol = _symbol;
        decimals = _decimals;
        owner = msg.sender; // msg.sender == IHomeMultiAMBErc20ToErc677 mediator
...
// File: contracts/upgradeable_contracts/multi_amb_erc20_to_erc677/IHomeMultiAMBErc20ToErc677.sol
    ...
    function bridgeSpecificActionsOnTokenTransfer(ERC677 _token, address _from, uint256 _value, bytes _data) internal {
        ...
        if (isKnownToken) {
            ...
            data = abi.encodeWithSelector(
                IHomeMultiAMBErc20ToErc677(this).deployAndHandleBridgedTokens.selector,
                _token,
                name,
                symbol,
                decimals,
