...
contract NFTTest is ERC721AURIStorage, Ownable, ReentrancyGuard {

    // This sets the name and symbol of our NFT contract when it is created.
    constructor() ERC721A("NFT Test", "NFTT") {}
    ...
    function updateMaxMintsAvailable(uint64 _NewMaxMintsAvailable) external onlyOwner {
        require(_NewMaxMintsAvailable >= totalSupply(), "Must be greater than current supply");
    ...
    uint128 public mintPrice = 1 ether;
