...
contract coPromotionNFT is ERC1155 {
    ...
    mapping(bytes32 => uint256) private _mintCodes;
     ...
     constructor () ERC1155("https://gateway.pinata.cloud/ipfs/QmP7Jo9TCgwNqtWcyLo9YFoU6Jzpj2pYruT1KZGLMRRXWS/{id}.json") {  
     ...
     function uri(uint256 _tokenId) override public pure returns (string memory) {
          return string(
               abi.encodePacked(
                    "https://gateway.pinata.cloud/ipfs/QmP7Jo9TCgwNqtWcyLo9YFoU6Jzpj2pYruT1KZGLMRRXWS/",
     ...
     function createMintCodes(bytes32[] memory hashes, uint256[] memory _tokenIds) public {
