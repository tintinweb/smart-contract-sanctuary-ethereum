...
library Builder {
    ...
    */
    ...
    function getTokenIdSvg(
        ...
        // Special BG for Rainbow Zorbs
        // if (seed.zorggleType == 3) {
        //     grad = string(
        //         abi.encodePacked(
        //             '<path fill="url(#grad)" d="M0 0h100v100H0z"/><defs><linearGradient id="grad" x1="60" x2="60" y1="0" y2="120" gradientUnits="userSpaceOnUse"><stop stop-color="#174299"/><stop offset="1" stop-color="#001E59"/></linearGradient>'
        //         )
        //     );
        // }
    ...
    function getSpecialZorb(
        uint256 zorbTypeIndex
...
@@@@@@@BBBBBBBBBBBBBBBBBBBBBB########RRRRRRRRRRRROOOOOOOOOOOOO[email protected]@@@@@@@@
