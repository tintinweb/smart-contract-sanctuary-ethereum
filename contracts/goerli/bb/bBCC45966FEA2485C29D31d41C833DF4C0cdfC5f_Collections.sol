...
contract Collections is Initializable, UUPSUpgradeable {
    ...
    */
     ...
     */
    function mint(ERC1155Lockable Collection, uint256 supply, bytes calldata uri_, bytes calldata key, uint256 royaltyValue, address royaltyRecipient) external payable {
