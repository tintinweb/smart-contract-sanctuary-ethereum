...
contract Contract is ERC1155Drop {
    ...
    function setTokenUri(uint256 _batchId, string memory _baseURI) external onlyOwner {
        require(!immutableTokenUri, "Immutable.");
        _setBaseURI(_batchId, _baseURI);
    }
    function setImmutableTokenUri() external onlyOwner {
        immutableTokenUri = true;
    }
