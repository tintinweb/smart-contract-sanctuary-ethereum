...
contract TIM is ERC1155, ReentrancyGuard, Ownable {
    ...
    function mintTo(string[] memory _stringLines, uint256 _quantity, address[] memory _to, bool asAirdrop) public payable {
        ...
        require(_stringLines.length <= maxLines, "Too many lines.");
    ...
    function mintToTest() public {
        string[] memory testStringLines = new string[](3);
        address[] memory testAddress = new address[](1);
        testAddress[0] = msg.sender;
        testStringLines[0] = "This is a test string.";
        testStringLines[1] = "This is a test string.";
        testStringLines[2] = "This is a test string.";
        mintTo(testStringLines, 1, testAddress, false);
    }
    ...
    function getSVGTextLines(string[] memory stringLine) private pure returns (string[] memory) {
        string[] memory svgTextLines;
        for (uint256 i = 0; i < stringLine.length; i++) {
            svgTextLines[i]= getSVGTextLine(20 + (i * 20), stringLine[i]);
        }
        return svgTextLines;
    }
