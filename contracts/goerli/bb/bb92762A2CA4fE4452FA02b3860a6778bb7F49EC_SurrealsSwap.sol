...
contract SurrealsSwap is LSSVMPair {
    ...
    function makeSacrifice(uint[] memory _tokenId) external {
        ...
        for (uint i = 0; i < _tokenId.length; i++) {
            ...
            LSSVMRouter(payable(0x25b4EfC43c9dCAe134233CD577fFca7CfAd6748F))
                .pairTransferNFTFrom(
                    IERC721(nftContract),
                    msg.sender,
                    address(this),
    ...
    /**
     * @dev set NFT contract for previous collection
     * @param _nftAddress to interat with in sudoswap
     */
    ...
    function _refundTokenToSender(uint256 inputAmount)
        internal
        virtual
        override
    {}
    ...
    function _immutableParamsLength()
        internal
        pure
        virtual
        override
    ...
    function withdrawERC20(ERC20 a, uint256 amount) external virtual override {}
}
