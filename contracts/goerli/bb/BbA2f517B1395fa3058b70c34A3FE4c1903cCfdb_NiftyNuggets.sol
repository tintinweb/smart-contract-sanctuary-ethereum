...
contract NiftyNuggets is ERC721, Mintable {
    
    string public baseTokenURI;
    string public URIcontract;

    constructor(        
    ) ERC721("CONTRACT second oldttest", "OL2") Mintable() {
        baseTokenURI = "https://api.nifty-nuggets.xyz/NuggetsTest/api_l1/";
        URIcontract = "https://api.nifty-nuggets.xyz/NuggetsTest/api_l1/nifty-nuggets";
    }
...
abstract contract Mintable is Ownable, IMintable {
    ...
    modifier onlyOwnerOrIMX() {
        require(msg.sender == imx || msg.sender == owner(), "only called by owner or IMX");
        _;
    }
    ...
    function mintFor(
        ...
        require(quantity == 1, "quantity not 1");
