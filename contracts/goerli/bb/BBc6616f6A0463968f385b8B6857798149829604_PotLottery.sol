...
contract PotLottery is Initializable, ReentrancyGuardUpgradeable {
    ...
    uint256 public airdropMinimum;
    uint256 public lotteryMinimum;
    ...
    function initialize(address _owner) public initializer {
        ...
        airdropMinimum = 5 * 10**17;
        lotteryMinimum = 5 * 10**17;
    ...
    event BurnSuccess(uint256 indexed amount);
    event AirdropSuccess(uint256 indexed amount);
    ...
    /**
     * @dev Sets minimum PLSP value to get airdropped
     *
     */
    function setAirdropMinimum(uint256 value) external onlyAdmin {
        airdropMinimum = value;
    }

    /**
     * @dev Sets minimum PLSP value to get lottery
     *
     */
    function setLotteryMinimum(uint256 value) external onlyAdmin {
        lotteryMinimum = value;
    }
