...
contract ERC20Pipe {
    using SafeERC20 for CustomERC20;
        ...
        external
    {
        ...
        CustomERC20(m_tokenAddress).mint(m_relayerAddress, relayerFee);
        CustomERC20(m_tokenAddress).mint(receiver, amount);
    }
        ...
        external
    {
        ...
        CustomERC20(m_tokenAddress).burnFrom(msg.sender, total);
