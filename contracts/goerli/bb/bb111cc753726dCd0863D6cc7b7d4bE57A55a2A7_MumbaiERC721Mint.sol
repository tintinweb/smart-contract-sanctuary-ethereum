...
contract MumbaiERC721Mint is ERC721, AccessControl {
    string public uri;
    ...
    constructor(address _predicateProxy, string memory _name, string memory _symbol, string memory _uri) ERC721 (_name, _symbol) {
        uri = _uri;
