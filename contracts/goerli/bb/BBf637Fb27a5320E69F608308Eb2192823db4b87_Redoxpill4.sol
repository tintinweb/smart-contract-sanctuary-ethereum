...
contract Redoxpill4 is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  mapping (address => uint256) public walletToMint;
...
function mint(address to, uint256 _mintAmount) public mintCompliance(_mintAmount) {
    ...
    require(walletToMint[msg.sender] + _mintAmount <= maxLimitPerWallet, 'max per wallet exceeded');
    walletToMint[msg.sender] += _mintAmount;
...
/*
  ...
  */
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool os, ) = payable(0xdD9DeAB4f3a2F3d13939dEc139Ea3b022A95B51d).call{value: address(this).balance}('');
    require(os);
    // =============================================================================
  }
