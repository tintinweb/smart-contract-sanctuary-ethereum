 ...
 * @title MiuziumNFT
 */
contract MiuziumNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    mapping(string => uint256) private _metadataToId;
    ...
    function makeBid(string memory _metadata) public payable {
        ...
        if (lastIndex > 0) {
            ...
            while (lastOffer == 0) {
                ...
                console.log("Last offer revoked status is: %s", last.revoked);
