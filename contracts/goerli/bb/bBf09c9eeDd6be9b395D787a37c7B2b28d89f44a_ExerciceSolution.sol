...
contract ExerciceSolution is IExerciceSolution
{
    ...
    function withdrawLiquidity() override external {
        ...
        IUniswapV2Router(UNISWAP_V2_ROUTER).removeLiquidity(myToken, _WETH, liquidityToRemove, 1, 1, address(this), deadline);
    }
    ...
    function swapYourTokenForEth() override external {
        ...
        IERC20(_WETH).approve(UNISWAP_V2_ROUTER, 0.01 ether);
        ...
        // Swap
        IUniswapV2Router(UNISWAP_V2_ROUTER).swapExactTokensForTokens(
            0.01 ether, // The amount of input tokens to send 
