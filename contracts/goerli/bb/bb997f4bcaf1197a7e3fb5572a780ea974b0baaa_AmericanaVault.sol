...
contract AmericanaVault is ERC721ARedeemable("Americana", "VAULT"), Ownable2Step, OperatorFilterer {
    ...
    event BundleCreated(address auxTokenAddress, uint48 auxTokenId, uint48 americanaTokenId, address redeemer);
    event BundleUnwrapped(
        address auxTokenAddress, uint48 auxTokenId, uint48 americanaTokenId, address redeemer, uint256 bundleId
    );
