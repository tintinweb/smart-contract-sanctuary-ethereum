...
contract DreamEyeBooster is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount) public onlyOwner {
    ...
    masterContract.evolve(_totalMinted(), 3);
  }
  ...
  function setTargetContract(address _masterContract) public onlyOwner {
