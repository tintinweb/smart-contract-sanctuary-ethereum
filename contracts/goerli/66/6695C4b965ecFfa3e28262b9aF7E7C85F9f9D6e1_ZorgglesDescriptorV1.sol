...
contract ZorgglesDescriptorV1 is Initializable, OwnableUpgradeable {
    ...
    function tokenURI(uint256 tokenId) public view
      returns (string memory) {   
        ...
        return constructTokenURI(tokenId, 0x8465EF4F44E5b12aB73EB72524EC71C7790B64A3);
    }
    ...
    function constructTokenURI(
        ...
        string memory image = string(
            abi.encodePacked(Base64.encode(bytes(getTokenIdSvg(tokenId, ownerAddress))))
        );
        return
            string(
                abi.encodePacked(
    ...
    function getTokenIdSvg(
        ...
        // string memory zorbs = buildZorbs(tokenId, ownerAddress);
    ...
    function buildZorbs(uint256 tokenId, address ownerAddress) internal view returns (string memory) {
        bytes memory list;
