    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    event Block(uint blockNumber, uint timestamp);
  ...
  //////////////////////////////////////////////////////////////*/
       ...
       MintCart memory cart;
        ...
        unchecked {
            ...
            for (uint256 i = 0; i < _quantities.length; i++) {
                ...
                minted[address(_msgSender())] += _quantities[i];
        ...
        emit Block(block.number, block.timestamp);
    ...
    function revertOnConfigCheckFailure(
       ...
       require(mintedByConfig[_config[0]] + _quantity <= configSupplyLimit[_config[0]], string( abi.encodePacked(_config[0], " supply exhausted.")));
    }
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function upsertConfigPrice(string calldata _config, uint256 _price)
      external
    ...
    function upsertConfigSupply(string calldata _config, uint256 _supply)
      external
      minRole(CONTRACT_ADMIN_ROLE)
    {
