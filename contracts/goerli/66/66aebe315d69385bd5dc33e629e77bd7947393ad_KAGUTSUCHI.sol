...
/**
Contact Telegram For Solidity , JS ,Web3 Developer
https://t.me/AS_Punjab
*/
...
contract KAGUTSUCHI is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Kami Of Fire";
    string private constant _symbol = "KAGUTSUCHI";
    ...
    uint256 private furnaceFee = 400;
    ...
    address internal constant development_receiver =
        0xEf7ca17Eb054420190332cf65B808DFA974714A8;
    address internal constant furnace_receiver =
        0xEf7ca17Eb054420190332cf65B808DFA974714A8;
    ...
    constructor() Ownable(msg.sender) {
        ...
        isFeeExempt[furnace_receiver] = true;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        uint256 _denominator = (
            liquidityFee.add(1).add(furnaceFee).add(developmentFee)
        ).mul(2);
        ...
        uint256 furnaceAmt = unitBalance.mul(2).mul(furnaceFee);
        if (furnaceAmt > 0) {
            payable(furnace_receiver).transfer(furnaceAmt);
        }
