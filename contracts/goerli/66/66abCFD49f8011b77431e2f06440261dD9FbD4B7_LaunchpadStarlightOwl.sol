 ...
 * @notice This contract handles minting Starlight Owl tokens.
 */
contract LaunchpadStarlightOwl is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x3F50363744C705D04fC45dAec2DEDc41ee8C13fd;
    address public royaltyAddress = 0x0C073ebED0B056C7c008C0c3044C878FB37691F9;
    address[] public payoutAddresses = [
        0x0C073ebED0B056C7c008C0c3044C878FB37691F9
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeifhhrk7cgev63omigqci7ikxamqrhd7jhtkbzkljlcedku6ivx5qy/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 1;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 1;
    ...
    constructor() ERC721A("Starlight Owl", "SO") {
