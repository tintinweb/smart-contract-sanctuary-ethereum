...
contract NounsVisionVRFDistributor is VRFv2Consumer {
    ...
    **/
    ...
    uint256 public constant CLAIM_WINDOW = 50; // 30 days in blocks
    ...
    **/
    ...
    /// @notice Returns number of GLASSES that are claimable by sender
    ...
    **/
    ...
    function claimGlasses() external {
      ...
      for (uint256 i; i < numberClaims; i++) {
        startId = NOUNS_VISION_BATCH_TRANSFER.getStartId();
