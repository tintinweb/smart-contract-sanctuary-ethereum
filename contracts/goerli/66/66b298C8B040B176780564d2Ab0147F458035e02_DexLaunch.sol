...
contract DexLaunch is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Template Test", "tempTest") payable {
        ...
        marketingWallet = address(0x501043512988CDcc6f73a3eD72e3D851002ef6B5); // set as marketing wallet
        devWallet = address(0xc21C81A0A6D14dc4B8522450caF1B141Fc6a3304); // set as dev wallet
        ...
        */
        ...
        _mint(owner(), totalSupply * 20 / 100);
    }
