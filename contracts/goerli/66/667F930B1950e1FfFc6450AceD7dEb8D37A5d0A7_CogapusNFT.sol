...
contract CogapusNFT is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("CogapusNFT", "Cogapus") {       
        baseURI = "ipfs://QmWi3VdvCWmkgiSLdLMyCnGrqd5b6YoP53DaVarE8ejHZC/"; //donde se hostea la metadata y las imgs
    }

    bool public saleStarted = true;
    uint256 public constant cogoPrice = 5; //0.000000000000000005 ETH, en wei
    uint256 public constant maxSupply = 9995;
    uint8 public constant maxSupplyPurchase = 20;
    ...
    //funcion para asignar un nft al usuario que pago
    function mint(bytes32[] memory proof, bytes32 leaf, uint256 numberOfTokens) public payable returns(uint256,uint256){
        ...
        (cond, res) = cogoPrice.tryMul(numberOfTokens);
        require(cond, "Overflow error");                        
    ...
    function setMerkleRoot(bytes32 _root) public onlyOwner{ //validar usuarios en waitlist
        merkleRoot = _root;
    }
