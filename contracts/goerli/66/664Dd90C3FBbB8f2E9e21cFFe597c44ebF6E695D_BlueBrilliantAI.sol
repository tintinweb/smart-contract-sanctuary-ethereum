...
contract BlueBrilliantAI is BEP20, Ownable {
    ...
    address public marketingWallet = 0x74B6a7b6d0d851113D861Bf04243E248C17a106D; 
    address public devWallet = 0x48b371e1FEa4F055546eE9869227781Cc896CCbA;
    address public bbWallet = 0xdAe1adb439184E8312B54c60eeFA30dAf1d05327;
    ...
    Taxes public taxes = Taxes(4, 0, 2, 4);
    Taxes public sellTaxes = Taxes(4, 0, 2, 4);
    ...
    constructor() BEP20("Blue Brilliant AI", "BRILL") {
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity + _bb + _dev) <= 10, "Must keep fees at 10% or less");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _bb + _dev) <= 14, "Must keep fees at 14% or less");
    }
