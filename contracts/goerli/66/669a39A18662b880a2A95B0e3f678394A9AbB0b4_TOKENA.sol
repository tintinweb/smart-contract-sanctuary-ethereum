...
contract TOKENA is ERC20, Ownable {
    ...
    function enableTrading() external onlyOwner {
        require(tradingEnabled == false, "TOKEN: The trading has been enabled.");
    ...
    function updateTaxFee(uint256 _taxFee) external onlyOwner {
        require(_taxFee <= 5, "TOKEN: Must keep fees at 5% or less.");
        taxFee = _taxFee;
    }
    ...
    function disableMaxTnxAmount() external onlyOwner {
        require(maxTnxAmountEnabled == true, "TOKEN: Max Tnx amount has been disabled.");
