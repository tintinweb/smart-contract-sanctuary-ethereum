...
contract MainnetSource is AccessControl {

    bytes32 public constant CONTRACT_ADMIN = keccak256("CONTRACT_ADMIN");
    bytes32 public constant POLYGON_TALKER = keccak256("POLYGON_TALKER");
