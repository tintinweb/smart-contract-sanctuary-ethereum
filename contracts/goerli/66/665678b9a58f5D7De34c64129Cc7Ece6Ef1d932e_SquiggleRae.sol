...
contract SquiggleRae is ERC721, Ownable {
    ...
    function tokenURI(
        ...
        bytes memory divContent = abi.encodePacked(
            '<style>body {text-align:center;} #container {display:inline-block;} #squiggle {width:400px; height:400px; overflow:hidden;}</style><div id="container"><div id="top"></div><div id="squiggle"></div><div id="bottom"></div></div>'
        );
        ...
        string memory description = string.concat("This vault contains Chromie Squiggle #", tokenIdStr, " created by Snowfro.");
...
/// @author Modified from (https://github.com/Brechtpd/base64/blob/main/base64.sol) by Brecht Devos - <brecht[email protected]>.
library Base64 {
