...
contract Waitlist is ReentrancyGuard
{
    ...
    mapping(uint => mapping(address => bool)) public WaitlistJoined;
    ...
    constructor()
    {
        Roots[0] = 0xc8b95747e5f7e1e90a2d50d2686b60e8548363f7d1ac949312bebe3b8fea610b;
     ...
     * @dev Joins Waitlist
     */
    function JoinWaitlist(uint WaitlistIndex, bytes32[] calldata Proof) external nonReentrant
    {
        require(VerifyBrightList(WaitlistIndex, msg.sender, Proof), "Waitlist: User Is Not On BrightList");
        require(WaitlistJoined[WaitlistIndex][msg.sender], "Waitlist: Already User Already Joined");
        WaitlistJoined[WaitlistIndex][msg.sender] = true;
        Waitlists[WaitlistIndex].push(msg.sender);
        CitizenAmounts[WaitlistIndex].push(readWalletNumCitizens(msg.sender));
    }
    ...
    function ClearWaitlist(uint WaitlistIndex) external onlyBRTAdmin 
    {
        ...
        {
            Waitlists[WaitlistIndex].pop();
            CitizenAmounts[WaitlistIndex].pop();
        }
    }
