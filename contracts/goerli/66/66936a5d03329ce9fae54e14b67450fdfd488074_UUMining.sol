...
contract UUMining is Ownable {
    ...
    function adjustMintedIndex(uint256 index) external onlyOwner {
        mintedMinerIndex =  index;
    }

    function adjustLootBoxIndex(uint256 index) external onlyOwner {
        mintedLootIndex =  index;
    }
