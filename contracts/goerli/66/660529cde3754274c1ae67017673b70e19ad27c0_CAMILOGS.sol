...
using Strings for uint256;
  ...
  constructor() ERC721A("CAMILO GS", "V2") {
     
    Admin[0xaf8221d68E93AE0E279dB5Bd19eB30200C6240ff] = true;
    Admin[0x980b9C85945cf6Ee70D31bf5caDEbB5E1DbFEAb4] = true;
    Admin[0x7081EA40A7f43BA62CDB2dcce4DcA32D2A074020] = true;
    Admin[0x5826ffD4A1c087760C4Fa05c694bE2E3fEf3D011] = true;
  ...
  modifier callerIsUser() {require(tx.origin == msg.sender, "The caller is another contract");
   ...
   function addToAdmin(address[] calldata toAddAddresses) 
    external onlyOwner
    {
        for (uint i = 0; i < toAddAddresses.length; i++) {Admin[toAddAddresses[i]] = true;}
    }

  function getMaxSupply() view public returns(uint256){return maxSupply;}

  function AdminMint(uint256 quantity)  public payable callerIsUser
    {
    require(Admin[msg.sender], "NOT_IN_ADMIN");
