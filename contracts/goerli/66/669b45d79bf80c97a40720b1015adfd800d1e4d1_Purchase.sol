...
contract Purchase {
    ...
    constructor() payable {
        ...
        item_details = "SET ITEM DETAILS Hi my name is m";// i want to see why the fuck this shit is not working is it becasause my string is too big? well we are about to find out.";
