...
interface IPrimaryIndexToken {
     ...
     */
    function supply(address lendingToken, uint256 lendingTokenAmount, address account, address onBehalfOf) external;
     ...
     */
    function redeem(address lendingToken, uint256 bLendingTokenAmount, address account, address onBehalfOf) external;
     ...
     */
    function borrow(address projectToken, address lendingToken, uint256 lendingTokenAmount, address account, address onBehalfOf) external;
...
contract PrimaryIndexTokenAtomicRepayment is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function repayAtomic(address prjToken, uint collateralAmount, bytes memory buyCalldata) public {
        ...
        IPrimaryIndexToken(primaryIndexToken).calcAndTransferDepositPosition(prjToken, collateralAmount, msg.sender, address(this));
