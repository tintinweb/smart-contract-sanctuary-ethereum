...
import "./AmaBooksUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new AmaBooksUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AmaBooksUser1155Token token = AmaBooksUser1155Token(address(addr));
...
contract AmaBooksUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
