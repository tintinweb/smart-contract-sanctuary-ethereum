...
contract VoiceMaskAlpha is IVoiceMaskAlpha, ERC721A, ERC721AQueryable, Ownable {
    ...
    uint256 public durationBlock = 60*30;//(60 * 60 * 24 * 91) / 12; //7862400 seconds / blocks
    ...
    // function _checkIfLockedOwner(address owner) public view returns (bool) {
    //     unchecked {
    //         for (uint256 i = _startTokenId(); i < teamCount; ++i) {
    //             if (owner != ownerOf(i)) {
    //                 continue;
    //             }
    //             if (birthdayBlock[i] + durationBlock < block.timestamp) {
    //                 return false;
    //             }
    //             return true;
    //         }
    ...
    function _checkIfLockedtoken(uint256 token) public view returns (bool) {
        // console.log(birthdayBlock[token]);
        // console.log(durationBlock);
