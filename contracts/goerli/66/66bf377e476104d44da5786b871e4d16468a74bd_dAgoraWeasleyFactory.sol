...
contract dAgoraWeasleyFactory is Ownable, ReentrancyGuard {
    ...
    event RonaldWeasleyCreated(address weasleyContract, address owner, uint256 weasleyIndex);
        ...
        nonReentrant
    {
        ...
        emit RonaldWeasleyCreated(address(weasley), msg.sender, weasleyCount);
    }
