...
// File: contracts/rental_marketplace.sol
...
contract RentalMarketplace is  ERC4907 , ReentrancyGuard {
    ...
    function removeNftFromRent(address nftContract, uint256 tokenId) public payable nonReentrant {
        Listing storage listing = _listingMap[nftContract][tokenId];
