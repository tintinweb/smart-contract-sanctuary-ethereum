...
// TODO: Add nice natspec descriptions to all functions.

contract UglyBitches is ERC721A, ReentrancyGuard, Ownable {
    ...
    bool public isPulicMintActive = false;

    uint256 private collectionSize;
    uint256 private reservedFreeMint;
    // TODO: change to correct price
    uint256 private mintPrice = 0.1 ether;
    // TODO: change to correct address
    address private devAddress = 0x0000000000000000000000000000000000000000;
    ...
    modifier publicMintActive() {
        require(isPulicMintActive, "Mint is not open.");
        _;
    }
    ...
    // TODO: Set to correct max number
    ...
    function setMintActive(bool _isMintActive) external onlyOwner {
        isPulicMintActive = _isMintActive;
    }
