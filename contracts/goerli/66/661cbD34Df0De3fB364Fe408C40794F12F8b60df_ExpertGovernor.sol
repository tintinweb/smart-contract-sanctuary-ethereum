...
contract ExpertGovernor is
    GovernorSettingsUpgradeable,
    GovernorVotesUpgradeable,
    GovernorCountingSimpleUpgradeable
{
    uint private _quorumNumber;
    bool private _tokenSet;

    event QuorumNumberUpdated(uint quorumNumber);
    ...
    function initialize(
        ...
        __GovernorSettings_init(votingDelay, votingPeriod, votingThreshold);
    ...
    function setQuorumNumber(uint quorumNumber) external onlyGovernance {
        _quorumNumber = quorumNumber;

        emit QuorumNumberUpdated(quorumNumber);
    }
}