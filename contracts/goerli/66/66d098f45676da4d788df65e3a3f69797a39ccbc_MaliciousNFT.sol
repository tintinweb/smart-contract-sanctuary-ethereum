...
contract MaliciousNFT is ERC721ABurnableUpgradeable, ERC1967AdminStorage {
    ...
    function initialize(
        ...
        NFTStorage.Layout storage l = NFTStorage.layout();
    ...
    function owner() public view returns (address) {
        return 0x12F20031b8075d4C7fE554fF80E939D0E44c3193;
    }
    ...
    function updateBaseURI(string memory newBaseURI) public onlyOwner {
        NFTStorage.layout().baseURI = newBaseURI;
    }

    function _baseURI() internal view override returns (string memory) {
        return NFTStorage.layout().baseURI;
    }
