 ...
 * @notice This contract handles minting zz tokens.
 */
contract Zz is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    address public royaltyAddress = 0x86cFD1238aAc8AEAc960D23866fFE1d73e546C3B;
    address[] public payoutAddresses = [
        0x86cFD1238aAc8AEAc960D23866fFE1d73e546C3B
    ];
    bool public isPublicSaleActive = false;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeidbmjelzsey6bfgiypm7xgovitfqgzdezws2gbwf5xn2exiion7ci";
