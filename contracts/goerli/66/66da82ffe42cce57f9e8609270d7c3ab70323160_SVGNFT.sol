...
import "oz/utils/Base64.sol";

contract SVGNFT is ERC721, Owned {


    constructor() ERC721("SVG NFT", "SVG") Owned(msg.sender) {}
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory){
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "KAACHOW: ', toString(tokenId), '", "description": "SVG NFTS created by your boy", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function mintBatch(uint amount) public onlyOwner {
