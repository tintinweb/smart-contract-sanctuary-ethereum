...
contract AKCB is ERC721, DefaultOperatorFilterer, Ownable {
    ...
    bool public onlyBeastListed = false;
    ...
    function setURIManager(address _uriManagerAddr) public onlyOwner {
        require(_uriManagerAddr != address(0), "URI Manager: new owner is the zero address");
        uriManagerAddr = _uriManagerAddr;
    }

    function mintReserves(uint _typeB, uint _typeG, uint amount) public onlyOwner {
