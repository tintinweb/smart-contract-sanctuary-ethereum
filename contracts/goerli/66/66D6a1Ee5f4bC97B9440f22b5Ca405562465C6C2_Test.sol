...
contract Test is ERC721A, Ownable  {
  ...
  function mint(uint256 _amount) external payable {
    ...
    require(_numberMinted(msg.sender) + _amount < maxPerWallet + 1, "Exceeds Max");
    require(_amount < maxPerTx + 1, "Exceeds Max Per Tx");
  ...
  function withdraw() external onlyOwner {
    ...
    (bool artistSuccess, ) = payable(0x080dcFBb5a225536a2eDA357c9135ad42AA636e8).call{value: artistPayment}('');
