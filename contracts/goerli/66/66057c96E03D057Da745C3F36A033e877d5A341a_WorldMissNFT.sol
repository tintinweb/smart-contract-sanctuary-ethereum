...
/// @title World Miss NFT Project
import "./ERC721A.sol";
import "./ReentrancyGuard.sol";
import "./Ownable.sol";
import "./Strings.sol";

contract WorldMissNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    *
    * @param _ammount The ammount of NFTs the owner wants to mint
    **/
    function saleMint(address addr, uint256 _ammount) external payable onlyOwner nonReentrant {
    ...
    **/
    function tokenURI(uint _nftId) public view override(ERC721A) returns (string memory) {
        ...
        return "https://econft.market/#/main";
    }   
