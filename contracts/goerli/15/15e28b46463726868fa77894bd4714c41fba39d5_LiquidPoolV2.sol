...
contract LiquidPoolV2 is Initializable, UUPSUpgradeable, ERC20Upgradeable, PriceResolver, BudgetApprovalExecuteeV2 {
...
contract BudgetApprovalExecuteeV2 is Initializable {
    using Concat for string;
