 ...
 */
library OrderTypes {
    // keccak256("MakerOrder(MakerRentConfig rentConfig,bool isOrderAsk,address signer,address strategy,uint256 nonce,uint256 startTime,uint256 endTime,bytes strategyParams)")
    bytes32 internal constant MAKER_ORDER_HASH = 0xe1f8e0abb26e4bbcda13ffde41cd4d7ec5191db856b27324bef18c8c67f45c62;

    // keccak256("MakerRentConfig(Target target,uint256 pricePerHour,uint256 minHours,uint256 maxHours,address currency)")
    bytes32 internal constant CONFIG_HASH = 0x5e5a83d44038b9baabd1f371eb020ca00ea7b92efde5cc3db7485782c317f8b3;
