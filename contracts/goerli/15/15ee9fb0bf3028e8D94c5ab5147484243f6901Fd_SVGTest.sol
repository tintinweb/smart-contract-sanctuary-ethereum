...
contract SVGTest is ERC721A, Ownable, OperatorFilterer {
    ...
    constructor() ERC721A("OnChain Pass", "VPASS") {
        ...
        string memory json = Base64.encode(
            bytes(string(
                abi.encodePacked(
                    ...
                    '{"trait_type": "Liquid METL", "value": "', uint2str(attributes[tokenId].metl), '"},',
