...
import "./interfaces/IDAOVotings.sol";
...
/**
 * @dev Interface of the DAOVotings.
 */
interface IDAOVotings {
    ...
    /// @dev Returns voter info (see 'Voter' struct)
    function voterInfo(address voter) external view returns (Voter memory);
}
