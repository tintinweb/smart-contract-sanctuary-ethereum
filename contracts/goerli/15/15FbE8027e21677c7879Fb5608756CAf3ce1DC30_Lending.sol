...
contract Lending is Ownable, ReentrancyGuard {
    ...
    function borrow(uint256 _loanAmount) public payable nonReentrant {
        ...
        require(msg.value == loan.collateralAmount, "Not enough collateral!");
        require(
    ...
    {
        uint256 loanAmountInUSDT = ((_interestRate / 100) * _loanAmount) +
            _loanAmount;
        uint256 loanAmount = (1 / getExchangeRate()) * loanAmountInUSDT;
        return (loanAmount, loanAmountInUSDT);
    }
