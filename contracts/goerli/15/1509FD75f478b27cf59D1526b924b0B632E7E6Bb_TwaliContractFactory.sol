...
contract TwaliContract is Initializable, ReentrancyGuard {
    ...
    bytes32 private DOMAIN_SEPARATOR = keccak256(abi.encode(
        ...
        5, // need to get upon contract deploy from `getChainId func or from solidity globals
        address(this)));
...
//   gnosisSafeProxyFactory: '0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2',
        ...
        // address[msg.sender].push(_contract_owner);
        ...
        // TODO: Check on `setup` variable for Gnosis safe
