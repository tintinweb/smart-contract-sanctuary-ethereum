...
contract TokenizedGoldMinter is Ownable {
    ...
    function _mintBars(
        ...
        string[] calldata barCommodity_,
        string[] calldata barMinter_,
        string[] calldata barIdentifier_,
        uint256[] calldata barWeight_) internal 
    ...
    function mintTokens(
        ...
        string[] calldata barMinter_, 
        string[] calldata barIdentifier_, 
        uint256[] calldata barWeight_) external onlyMinter {
        
        uint256 amount = _mintBars(beneficiary_, barCommodity_,barMinter_,barIdentifier_, barWeight_);
        if (chainlinkActive) {
            _chainlink(amount);
        }
...
contract BullionBar is ERC721PresetMinterPauserAutoId, Ownable {
    ...
    event BarMinted(uint256 tokenId, address beneficiary, string barComodity, string barMinter, string barIdentifier, uint256 barWeight);
    ...
    uint256 barWeight_) external onlyMinter {
        ...
        emit BarMinted(tokenId, beneficiary_, barCommodity_, barMinter_, barIdentifier_, barWeight_);
