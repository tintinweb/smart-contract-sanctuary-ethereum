    ...
    ERC721Pausable
{
    ...
    function mint(address to) external virtual {
        ...
        require(_tokenIdTracker.current() < _maxMint(), "all have been minted");
    ...
    function setURI(string calldata baseTokenURI) external virtual {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "ERC721PresetMinterPauserAutoId: must be default admin to set URI"
        );
        _baseTokenURI = baseTokenURI;
    }

    function setMaxMintAmount(uint256 maxMintAmount) external virtual {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "ERC721PresetMinterPauserAutoId: must be default admin to set max mint amount"
        );
        _maxMintAmount = maxMintAmount;
    }
