...
contract FPTest02 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        name = "Demo Day 1";
        _mint(msg.sender, token0, 10, "");
        _mint(msg.sender, token1, 20, "");
        _mint(msg.sender, token2, 30, "");
