...
library RenderTime {
    ...
    string constant svg4 = '<circle cx="100" cy="100" r="1.5" stroke="white" stroke-width="1" fill="white" />';
    string constant svg5 = '<rect x="25" y="15" width="150" height="150" stroke="#F2F2F2" stroke-width="0.5" fill="none" rx="5" ry="5"/></svg>';
    ...
    function renderSvg(uint age) internal pure returns (string memory) {
        ...
        string memory second = string(abi.encodePacked(
            ...
            ',450,450)">',
            '<line x1="450" y1="450" x2="450" y2="375" stroke="#F4F4F4" stroke-width="0.5" /></g>' 
        ));
        string memory minute = string(abi.encodePacked(
            ...
            ',450,450)">',
            '<line x1="450" y1="450" x2="450" y2="400" stroke="#D3D3D3" stroke-width="1.1" /></g>'
        ));
        string memory hour = string(abi.encodePacked(
            ...
            ',450,450)">'
            '<line x1="450" y1="450" x2="450" y2="420" stroke="#EAEAEA" stroke-width="2.2" /></g>'
        ));
