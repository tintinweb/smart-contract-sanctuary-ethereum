...
contract TheCollectorsNFTVaultDiamond is Ownable {
    ...
    constructor(
        ...
        _as.openseaFeeRecipients = [
            ...
            0x48649491D201Af42d5756Ca5Ea43420678e9cD70
        ];
    ...
    */
    function _getLogicFacetSelectors() internal pure returns (bytes4[] memory) {
        ...
        selectors[21] = TheCollectorsNFTVaultLogicFacet.startCancelListingProcess.selector;
        selectors[22] = TheCollectorsNFTVaultLogicFacet.isVaultPassedSellOrCancelSellOrderConsensus.selector;
        return selectors;
    }
    ...
    */
    function _getNFTVaultTokenManagerFacetSelectors() internal pure returns (bytes4[] memory) {
        ...
        selectors[21] = TheCollectorsNFTVaultTokenManagerFacet.isVaultSoldNFT.selector;
        selectors[22] = TheCollectorsNFTVaultTokenManagerFacet.name.selector;
        selectors[23] = TheCollectorsNFTVaultTokenManagerFacet.symbol.selector;
        return selectors;
    }
