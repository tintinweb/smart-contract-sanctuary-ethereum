...
//*********************************************************************//
//
//     __________________   ____________   __  ______ 
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1666851720;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 333) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib4yakzuea5btyhzvqj5c4i2huc4t7mx23adbucvxp4hnjkulb3ye/";
...
// File: contracts/TheChurchofEggContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheChurchofEggContract is RamppERC721A {
    constructor() RamppERC721A("The Church of EGG", "EGGUP"){}
}
