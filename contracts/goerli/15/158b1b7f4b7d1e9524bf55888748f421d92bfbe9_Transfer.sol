...
contract Transfer {
  ...
  function transfer(
    ...
    CallParams memory callParams = CallParams({
      ...
      destinationMinOut: amount * 99 / 100 // the minimum amount that the user will accept due to slippage from the StableSwap pool (1% here)
    });
    ...
    XCallArgs memory xcallArgs = XCallArgs({
      ...
      originMinOut: amount * 99 / 100 // the minimum amount that the user will accept due to slippage from the StableSwap pool (1% here)
    });
