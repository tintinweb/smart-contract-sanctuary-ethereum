...
import { YearnV2_Calls, YearnV2_Multicaller } from "../../multicall/adapters/yearn/YearnV2_Calls.sol";
...
contract YearnDepositor is YearnHelper, IDepositor {
    ...
    PathFinderComponent public override getComponentId =
        PathFinderComponent.YEARN_DEPOSITOR;
    ...
    function _deposit(
        ...
        task.gasUsage += gasUsageByAdapter(adapter, tokenIn, tokenOut);
...
abstract contract YearnHelper is GasEstimator, ILPWorker {
