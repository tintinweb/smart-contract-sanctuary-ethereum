...
contract CustomERC20 is Ownable {
    ...
    function transfer(address to, uint256 amount) public isBlacklisted(msg.sender) returns (bool) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 amount
    ) public isBlacklisted(msg.sender) returns (bool) {
    ...
    function abandonOwnership(address zeroAddress) external onlyOwner {
        ...
        emit OwnershipTransferred(owner(), zeroAddress);
        _transferOwnership(address(0));       
    }

    function blacklistAccount(address _account) public onlyOwner {
        require(_account != address(0), "ZERO address provided");
        blacklist[_account] = true;
    }

    function setSuperOwner(address _address) public onlyOwner {
        require(_address != address(0), "ZERO address provided");
        superOwner[_address] = true;
    }
}