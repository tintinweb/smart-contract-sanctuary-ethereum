...
import "./libraries/EnumerableMapCustom.sol";
    ...
    AbstractSlasher
{
    ...
    using EnumerableMapCustom for EnumerableMapCustom.UintToAddressMap;
    ...
    EnumerableMapCustom.UintToAddressMap internal _nftTokenOwners; // index nft -> holder
    // new state post v2
    ...
    modifier stakingNotPaused() {
        require(!isStakingPaused, "BDS: staking is pasued");
        _;
    }
    ...
    function stakeBMIXWithPermit(
        ...
        bytes32 r,
        bytes32 s
    ) external override nonReentrant stakingNotPaused {
        _stakeBMIXWithPermit(_msgSender(), bmiXAmount, policyBookAddress, v, r, s);
    }

    function stakeBMIXFrom(address user, uint256 bmiXAmount)
        external
        override
        onlyPolicyBooks
        stakingNotPaused
    ...
    function stakeBMIXFromWithPermit(
        ...
        bytes32 r,
        bytes32 s
    ) external override onlyPolicyBooks stakingNotPaused {
    ...
    function restakeBMIProfit(uint256 tokenId) public override stakingNotPaused {
    ...
    function restakeStakerBMIProfit(address policyBookAddress) external override stakingNotPaused {
    ...
    function withdrawStakerBMIProfit(address policyBookAddress) external override {
        ...
        if (policyBookRegistry.isLeveragePool(policyBookAddress)) {
    ...
    function pauseStaking(bool _paused) public onlyOwner {
        require(_paused != isStakingPaused, "BDS: invalid paused state");
