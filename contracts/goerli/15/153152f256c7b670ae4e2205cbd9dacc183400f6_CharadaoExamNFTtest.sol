...
// File: contracts/CharadaoExamNFT.sol
...
contract CharadaoExamNFTtest is ERC1155, Ownable {
    string private name;
    string private symbol;
    string[] private baseURI = ["https://interactive-shikibu.s3.ap-northeast-3.amazonaws.com/exam1Metadata.json"];
    bool public mintEnabled = false;
    using Strings for uint256;
    //mapping address => id => amount
    //idは0から「超入門」「初級」「中級」・・・
    mapping(address => mapping(uint256 => uint256)) private psMinted;

    constructor()
     ERC1155("") {
        name = "Bluechip Halloween";
        symbol = "BCH";
    }
    ...
    //    require(psMinted[msg.sender][id] == 0, "You've already minted!");
        require(to != address(0), "ERC1155: mint to the zero address");
    ...
    function enableMint(bool bool_) external onlyOwner {
        mintEnabled = bool_;
    }
