...
//*********************************************************************//
//
//     __  _______  _   ______________   _________    ____  __    ____     __             __  ___                         ____   ___       __         
//    /  |/  / __ \/ | / /_  __/ ____/  / ____/   |  / __ \/ /   / __ \   / /_  __  __   /  |/  /___ __  ___      _____  / / /  /   | ____/ /__  ____ 
//   / /|_/ / / / /  |/ / / / / __/    / /   / /| | / /_/ / /   / / / /  / __ \/ / / /  / /|_/ / __ `/ |/_/ | /| / / _ \/ / /  / /| |/ __  / _ \/ __ \
//  / /  / / /_/ / /|  / / / / /___   / /___/ ___ |/ _, _/ /___/ /_/ /  / /_/ / /_/ /  / /  / / /_/ />  < | |/ |/ /  __/ / /  / ___ / /_/ /  __/ / / /
// /_/  /_/\____/_/ |_/ /_/ /_____/   \____/_/  |_/_/ |_/_____/\____/  /_.___/\__, /  /_/  /_/\__,_/_/|_| |__/|__/\___/_/_/  /_/  |_\__,_/\___/_/ /_/ 
//                                                                           /____/                                                                   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x22E9ABdD7CE1Fe9662C60cA9c682E6DE989762D7];
  address public erc20Payable = 0x22E9ABdD7CE1Fe9662C60cA9c682E6DE989762D7;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 0.045 ether;
  uint256 public earlyMintTokenIdCap = 321;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 321) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/gf1rqrgZdDpOjlROo5hu/contract-metadata";
  }
...
// File: contracts/MontecarlObyMaxwellAdenContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MontecarlObyMaxwellAdenContract is ERC721APlus {
    constructor() ERC721APlus("MONTE CARLO by Maxwell Aden", "MC"){}
}