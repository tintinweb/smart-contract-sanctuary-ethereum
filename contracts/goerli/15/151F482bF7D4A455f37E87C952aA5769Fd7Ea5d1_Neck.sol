        ...
        if (index == 1) {
            ...
            neck = string(
                abi.encodePacked(
                    ...
                    "/>",
                    '<circle class="cls-neck-14" cx="370.49" cy="276.35" r="8.23" />'
                )
            );
        } else if (index == 3) {
            neck = string(
            ...
            neck = string(
                abi.encodePacked(
                    ...
                    "    </radialGradient>",
                    "</defs>",
                    '<circle class="cls-neck-12" cx="274.86" cy="345.03" r="27.38" />',
                    '<circle class="cls-neck-13" cx="274.86" cy="345.03" r="27.38" />',
                    '<ellipse class="cls-neck-14" cx="274" cy="319.31" rx="14.62" ry="6.09" />',
                    "<path",
