...
contract D3Oracle is ID3Oracle, InitializableOwnable {
    ...
    // 给定fromToken数量，最少价值多少toToken
    function getMinReceive(
        address fromToken,
        address toToken,
        uint256 fromAmount
...
interface ID3Oracle {
    function getMinReceive(address fromToken, address toToken, uint256 fromAmount) external view returns(uint256);
