...
//
//    ______                                  _         ______      __                
//   / ____/______  ______  ____  ____  _____(_)____   / ____/___ _/ /___ __  ____  __
//  / /   / ___/ / / / __ \/ __ \/ __ \/ ___/ / ___/  / / __/ __ `/ / __ `/ |/_/ / / /
// / /___/ /  / /_/ / /_/ / / / / /_/ (__  ) (__  )  / /_/ / /_/ / / /_/ />  </ /_/ / 
// \____/_/   \__, / .___/_/ /_/\____/____/_/____/   \____/\__,_/_/\__,_/_/|_|\__, /  
//           /____/_/                                                        /____/   
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1671529740;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1671184080;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF2844Dd7167AAeB5fe8F8beD7CFfa3c5F6476957];
  address public erc20Payable = 0xF2844Dd7167AAeB5fe8F8beD7CFfa3c5F6476957;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.02 ether;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 299) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib6olrvkhjpufvynbzyw445vuctgfzfib325fbugp3rgc272rz6ri/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/aSv4GWnWKnbh5OHGHcGq/contract-metadata";
  }
...
// File: contracts/CrypnosisGalaxyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CrypnosisGalaxyContract is RamppERC721A {
    constructor() RamppERC721A("Crypnosis Galaxy", "KRCRB"){}
}
