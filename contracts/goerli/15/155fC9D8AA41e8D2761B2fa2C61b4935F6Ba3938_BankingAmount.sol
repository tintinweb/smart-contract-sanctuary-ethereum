...
interface AutomationCompatibleInterface {
   ...
   * `abi.encode`.
   */
  function checkUpkeep(bytes calldata checkData,address sender) external returns (bool upkeepNeeded, bytes memory performData);
...
contract BankingAmount is AutomationCompatibleInterface {
    ...
    function checkUpkeep(
        ...
        upkeepNeeded = (((block.timestamp - lastTimeStamp) > i_interval) && !loanMapping[sender]);
    }
