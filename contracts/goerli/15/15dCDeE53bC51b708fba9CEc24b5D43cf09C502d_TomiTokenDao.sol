...
contract TomiTokenDao is TomiEvents, TomiStates, Initializable, OwnableUpgradeable {
    ...
    function proposeChangeEmission(
        ...
        uint256 proposalId = tomiMainDao.checkAndUpdate(nftIds, _msgSender());
        ...
        initializeProposal(nftIds, functionId, description, title, proposalId);

        ProposalChangeEmissionData storage newProposalData = proposalsChangeEmissionData[proposalId];
