...
contract Token is ERC20 {
  ...
  //  address private _MarketAddress = address(0xC60045314Fd865DA83e822bba4856b0bf0888888);
    ...
    constructor(address tokenOwner) ERC20("NwtToken", "NWT") {
        
        //mainnet    
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xEfF92A263d31888d860bD50809A8D171709b7b1c);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(0xB882c76886fBCF50F52B340451cb00F3E7AF0517));
        _approve(address(this), address(0xEfF92A263d31888d860bD50809A8D171709b7b1c), 10**34);
        ...
        USDT = IERC20(0xB882c76886fBCF50F52B340451cb00F3E7AF0517);//mainnet
     //   USDT = IERC20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);//testnet
        pair = IERC20(_uniswapV2Pair);
        uint256 total = 19970000000000*10**18;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(to == uniswapV2Pair){//卖出
                ...
                super._transfer(from, address(this), amount.div(100).mul(4));//分红1%

                amount = amount.div(100).mul(95);//98%
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = address(0xB882c76886fBCF50F52B340451cb00F3E7AF0517);//mainnet
