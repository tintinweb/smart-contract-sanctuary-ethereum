// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"hat", unicode"eyes", unicode"mouth", unicode"face", unicode"Clothing", unicode"BackGround"];
        ...
        ContractData public contractData = ContractData(unicode"Genuine Birds On-Chain", unicode"4500 On-Chain Birds, reimagined, This project is for the community. Genuine Birds pays homage to the MoonBirds culture as well as to the Genuine Undead.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/2ddeb7dc-3cf3-4d03-ab13-271d7868c083", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/2ddeb7dc-3cf3-4d03-ab13-271d7868c083", "", 700, "0xFdf3a3dd6a585f65802aC414A3779Bb18aC7E444");

        constructor() ERC721A(unicode"Genuine Birds On-Chain", unicode"GU") {
            TIERS[0] = [280,280,280,280,280,280,280,280,280,280,280,280,285,285,285,285];
TIERS[1] = [640,640,640,645,645,645,645];
TIERS[2] = [750,750,750,750,750,750];
TIERS[3] = [560,560,560,560,565,565,565,565];
TIERS[4] = [300,300,300,300,300,300,300,300,300,300,300,300,300,300,300];
TIERS[5] = [560,560,560,560,565,565,565,565];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Genuine Birds On-Chain #");
