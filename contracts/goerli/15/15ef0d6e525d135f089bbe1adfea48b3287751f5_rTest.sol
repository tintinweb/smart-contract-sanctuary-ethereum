...
contract ERC721FancyMint is Context, ERC165, IERC721, IERC721Metadata, IERC2309  {
    ...
    */
    ...
    //     if((_maxSupply - 1) <= (fiveKCounter+1)*5000 -1){
    //         end = _maxSupply - 1;
    //         emitFlag = false;
    //     }else{
    ...
    //     }
    //     if(first != end){
    //          emit ConsecutiveTransfer(first, end, address(0), _preOwner);
    //     }else{
    //         emit Transfer(address(0), _preOwner, first);
    //     }
    //     fiveKCounter++;
    //     i++;
    ...
    // function _ownersMap(uint256 _tokenId) public view returns (address) {
...
// File: contracts/ERC721FancyMintEnum.sol
...
contract rTest is ERC721FancyMintEnum, Ownable {
    using Strings for uint256;

    //
    address private preOwner_ = 0x42D184ccD43e84368ea95902847D137f5C49704C;
    uint256 private maxSupply_ = 500005;
    //
    uint256 private fiveKCounter = 0;
    bool private emitFlag = true;
    ...
    constructor()
        ERC721FancyMintEnum("riki", "kr", maxSupply_, preOwner_)
    {}
    ...
    function emitHandler() public onlyOwner{
