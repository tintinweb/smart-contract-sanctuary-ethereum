...
contract AssetContractShared is AssetContract, ReentrancyGuard {
    ...
    modifier creatorOnly(uint256 _id) {
        //console.log("creatorOnly: ",_id,_msgSender());
        require(
    ...
    function addSharedProxyAddress(address _address) public onlyOwnerOrProxy {
        console.log("addSharedProxyAddress>>> msg.sender: ",msg.sender);
    ...
    function _isCreatorOrProxy(uint256 _id, address _address)
        ...
        returns (bool)
    {
        //console.log("id, address: ",_id,_address);
    ...
    function _isProxyForUser(address _user, address _address)
        ...
        returns (bool)
    {
       // console.log("_isProxyForUser>> ",_user,_address,sharedProxyAddresses[_address],msg.sender);
       console.log("_isProxyForUser>>",_user,_address,sharedProxyAddresses[_address]);
       console.log("_isProxyForUser msg sender:",msg.sender);
...
contract AssetContract is ERC1155Tradable {
    ...
    function balanceOf(address _owner, uint256 _id)
        ...
        returns (uint256)
    {
        console.log("balanceOf>>",_owner,_id);
    ...
    Pausable
{
    ...
    modifier onlyOwnerOrProxy() {
        console.log("onlyOwnerOrProxy>>>(msgsender,owner) ",_msgSender(),owner());
        require(
    ...
    {
        console.log("isApprvoedForAll>> ",_owner,_operator);
    ...
    function _isProxyForUser(address _user, address _address)
        ...
        returns (bool)
    {
        console.log("1155 _isProxyForUser>>> ",proxyRegistryAddress.isContract());
        if (!proxyRegistryAddress.isContract()) {
            return false;
        }
        ProxyRegistry proxyRegistry = ProxyRegistry(proxyRegistryAddress);
        console.log("1155 _isProxyForUser>>> ",_user,_address);
        console.log("1155 _isProxyForUser>>> ",address(proxyRegistry.proxies(_user)));
