...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Doc Type"];
    ...
    ContractData public contractData = ContractData(unicode"Crypto Doc's", unicode"Crypto Doc's on-chain to help those in need with their special skill set", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/460eb46d-2829-4d27-9448-7ebff6169e73", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/460eb46d-2829-4d27-9448-7ebff6169e73", "", 500, "0x402D03DB7c92e408256307972399F217723cc1aC");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Crypto Doc's", unicode"CD") {
        tiers[0] = [5,21,21,25,40,90,105,106,108,165,314];
