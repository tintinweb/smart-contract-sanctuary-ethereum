...
contract TokenTransfer is ReentrancyGuardUpgradeable, AccessControlUpgradeable {
    ...
    event TransferSucceeded(address token, uint256 amount);
    ...
    function multiSend(
        ...
        uint256 amountToSend = receiverAddresses.length * value;
        ...
        emit TransferSucceeded(tokenAddress, amountToSend);
    }
}