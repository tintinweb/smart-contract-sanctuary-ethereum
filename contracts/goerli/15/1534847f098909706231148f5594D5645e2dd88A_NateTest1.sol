 ...
 * @notice This contract handles minting Nate Test 1 tokens.
 */
contract NateTest1 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x3AEf8E27B5Cae4C595f4283F639C33707282E897;
    ...
    string public name = "Nate Test 1";
    string public symbol = "NATE1";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeibiuzozpgb2p7d7z4vh6jbtq2w3hcdk5jyr7zz2yg2rn4fizoubvi/{id}"
        )
    {
        ...
        tokenURI[3] = "https://artdrops.curiousaddys.com/tokens/3";
        tokenPublicPrice[3] = 0.001 ether;
