...
contract GoldenTokenSale is Ownable, ReentrancyGuard
{
     ...
     * @dev Sale Timestamps
     */
    uint public _TimestampSaleStart = 1675752000;
    uint public _TimestampEndFullSet = 1675752600;
    uint public _TimestampEndCitizen = 1675753200;

    /**
     * @dev Prices
     */
    uint private constant _PricePresale = 0.25 ether;
    uint private constant _PricePublic = 0.30 ether;

    /**
     * @dev Constants
     */
    uint private constant _MaxForSale = 233;
    address private constant _GOLDEN_TOKEN = 0x1928F7F56942422DA271a6E3188b1Bfb7f7A02b6;
