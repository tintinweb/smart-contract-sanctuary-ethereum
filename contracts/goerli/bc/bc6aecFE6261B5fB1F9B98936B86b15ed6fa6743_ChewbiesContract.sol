...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0xEF4Ad33CC653450762b31Afe40907198a19aCF67];
...
// File: contracts/ChewbiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract ChewbiesContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Chewbies";
    string public symbol = "CHEWB";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/I1HpQr6k5IHTNWoKggRX/contract-metadata";
  }
