 ...
 */
contract Novo is ERC721FOnChain, Payable {
    ...
    uint256 public tokenPrice = 0.0014 ether;
    bool public saleIsActive;

    constructor() ERC721FOnChain("CryptoNovo", "NOVO", "The NOVO token") {}
    ...
    */
    ...
    function renderTokenById(
        ...
        parts[0] = svgHead;
        parts[1] = uint2hexstr(colours[pixels[id]]);
        parts[2] = svgFooter;
