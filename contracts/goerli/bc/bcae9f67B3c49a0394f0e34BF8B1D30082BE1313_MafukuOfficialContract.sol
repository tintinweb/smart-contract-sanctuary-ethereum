...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1663858800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1663855200;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x3B55fD08fD288d1fcb8eF96e790EABDA181667c6];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x3B55fD08fD288d1fcb8eF96e790EABDA181667c6;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 3000;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 6969) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQrLjGMxBetWDSCi1QuXYyJfKD2pFeVJy8kN2kpjnXDa9/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 6969");
...
// File: contracts/MafukuOfficialContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MafukuOfficialContract is RamppERC721A {
    constructor() RamppERC721A("Mafuku Official", "FUKU"){}
}
