...
contract TEST69 is ERC20, Ownable {
  ...
  constructor() ERC20("TEST69", "TEST69") {
    ...
    marketingWallet = address(0x031f8aCdA510d766288440e0CBe1579E4Fb48fe1); // set as marketing wallet
    devWallet = address(0x69c9c256C3e5C038e1E9e9F89726EfC23da09971); // set as dev wallet
