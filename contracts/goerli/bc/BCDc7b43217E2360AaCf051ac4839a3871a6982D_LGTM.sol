 ...
 * @notice This contract handles minting LGTM tokens.
 */
contract LGTM is
    ERC1155Supply,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x9d29BB885AB4aC667A4D64c47B247388d77De01f;
    ...
    address public soulboundAdminAddress = address(0);
    ...
    string public name = "LGTM";
    string public symbol = "LGTM";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeihkaf2qhve4ypit7sebozplqcomb74ksbou5lzcnu5xhlwvnfawdi/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 4974;
        tokenPublicPrice[1] = 0 ether;
        tokenPublicMintsPerAddress[1] = 4974;
        require(
