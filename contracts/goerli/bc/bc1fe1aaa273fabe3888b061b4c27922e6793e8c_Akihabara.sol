...
contract Akihabara is Ownable, ERC721A {
    uint256 constant public MaxSupply = 888;
    

    uint256 public publicPrice = 0.006 ether;

    uint256 constant public MaxprTX = 2;
    uint256 constant public MaxperWallet = 4;

    string public revealedURI = "ipfs://QmdSEobz3KnBLfM9qH4iBQeZtyQUz5guxdhUaVtWhscrBF/";
    ...
    address constant internal Owner = 0xD2f1b7534c293d2841A5bfdf5E2A82c8fceE7D45;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Akihabara", "AKBARA") { }
    ...
    function publicMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(quantity <= MaxprTX, "Quantity too high");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0xD2f1b7534c293d2841A5bfdf5E2A82c8fceE7D45");
