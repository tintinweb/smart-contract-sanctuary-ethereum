...
contract OnChainThirdweb is ERC721Base {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory){
        ...
        parts[1] = '<rect width="100%" height="100%" fill="#CCCCCC" /><circle cx="30" cy="30" r="8" fill="#DDDDDA" ><animate attributeName="cx" to="60" begin="1s" dur="0.5s" fill="freeze" /><animate attributeName="cx" from="0" to="-30" begin="1.5s" dur="0.5s" fill="freeze" additive="sum" /></circle> <circle cx="70" cy="70" r="8" fill="#DDDDAD" ><animate attributeName="cx" to="100" begin="1.5s" dur="0.5s" fill="freeze" /><animate attributeName="cx" from="0" to="-30" begin="2s" dur="0.5s" fill="freeze" additive="sum" /></circle><text x="5" y="230" class="base">7BD44460F6E69BA2F7A7087BAB3ED93F</text>';
