...
contract Hello {
    ...
    PerpetualPool public etherStore;
    ...
    constructor(address _etherStoreAddress) public {
        etherStore = PerpetualPool(_etherStoreAddress);
    }
    ...
    function deposit(uint256 _amount) public {
        etherStore.deposit(_amount);
    }

    function withdraw(uint256 _amount) public {
        etherStore.withdraw(_amount);
    }

    function approve(uint256 _amount) public {
        GREEN.safeApprove(address(this), _amount);
    }

    function withdrawTo(uint256 _amount) public {
        GREEN.safeTransfer(address(msg.sender), _amount);
    }
