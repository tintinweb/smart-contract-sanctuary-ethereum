...
contract MarketMap {
    ...
    mapping(address => uint256[]) public tokenIdsWithOrders;
    ...
    function sell(
        ...
        UniqueOrderParameters memory uniqueOrderParameters = UniqueOrderParameters({
            ...
            offer: order.parameters.offer[0],
            consideration: order.parameters.consideration[0],
    ...
    function composeOrder(
        ...
        offer[0] = uniqueOrderParameters.offer;
        ConsiderationItem[] memory consideration = new ConsiderationItem[](1);
        consideration[0] = uniqueOrderParameters.consideration;
        AdvancedOrder memory advancedOrder = AdvancedOrder({
            parameters: OrderParameters({
                offerer: uniqueOrderParameters.offerer,
                zone: uniqueOrderParameters.zone,
                offer: offer,
                consideration: consideration,
                orderType: uniqueOrderParameters.orderType,
                startTime: uniqueOrderParameters.startTime,
                endTime: uniqueOrderParameters.endTime,
                zoneHash: uniqueOrderParameters.zoneHash,
                salt: uniqueOrderParameters.salt,
                conduitKey: uniqueOrderParameters.conduitKey,
                totalOriginalConsiderationItems: uniqueOrderParameters.totalOriginalConsiderationItems
            }),
            numerator: 1,
            denominator: 1,
