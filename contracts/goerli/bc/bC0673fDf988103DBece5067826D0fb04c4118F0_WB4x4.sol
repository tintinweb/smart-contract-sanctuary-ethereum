...
//     .----------------.  .----------------.  .----------------.  .----------------.  .----------------.     //
//    | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |    //
//    | | _____  _____ | || |   ______     | || |   _    _     | || |  ____  ____  | || |   _    _     | |    //
//    | ||_   _||_   _|| || |  |_   _ \    | || |  | |  | |    | || | |_  _||_  _| | || |  | |  | |    | |    //
//    | |  | | /\ | |  | || |    | |_) |   | || |  | |__| |_   | || |   \ \  / /   | || |  | |__| |_   | |    //
//    | |  | |/  \| |  | || |    |  __'.   | || |  |____   _|  | || |    > `' <    | || |  |____   _|  | |    //
//    | |  |   /\   |  | || |   _| |__) |  | || |      _| |_   | || |  _/ /'`\ \_  | || |      _| |_   | |    //
//    | |  |__/  \__|  | || |  |_______/   | || |     |_____|  | || | |____||____| | || |     |_____|  | |    //
//    | |              | || |              | || |              | || |              | || |              | |    //
//    | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |    //
//     '----------------'  '----------------'  '----------------'  '----------------'  '----------------'     //
//                                                                                                            //
...
contract WB4x4 is ERC721Creator {
    constructor() ERC721Creator("Windows Block 4x4", "WB4x4") {}
}
