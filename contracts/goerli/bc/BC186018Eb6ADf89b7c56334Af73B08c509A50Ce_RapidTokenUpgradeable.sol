...
//    function findCouponPaymentsIndex(uint256 time)
//        public
//        returns (bool, uint256)
//    {
//        return _findCouponPaymentsIndex(time);
//    }
//
//    function findNextCouponPayments()
//        public
//        returns (uint256)
//    {
//        return _findNextCouponPayments();
//    }
...
abstract contract DataStorageModule is Initializable, ERC20Upgradeable {
    ...
    //    EnumerableSet.UintSet private couponPaymentsSet;
    //
    //    function addCouponPayment(uint256 couponPaymentTime) {
    //        add(couponPaymentsSet, couponPaymentTime);
    //    }
    //
    //    function removeCouponPayment(uint256 couponPaymentTime) {
    //        add(couponPaymentsSet, couponPaymentTime);
    //    }
    ...
    function _findCouponPaymentsSince(uint256 time) public view returns (uint256) {
...
//    function _findCouponPaymentsIndex(uint256 time)
//    public view returns (bool, uint256)
//    {
//        uint256[] memory _coupon_payments = bondData.coupon_payments;
//        uint len = _coupon_payments.length;
//        for (uint256 i = 0; i < len;) {
//            if (_coupon_payments[i] == time) {
//                return (true, i);
//            }
//            ++i;
//        }
...
//
//
//    function _findPastCouponPayments() public view returns (uint256)
//        //        internal
//        //        returns (uint256)
//    {
//        if (bondData.coupon_payments.length == 0) return 0;
//        uint256 mostRecent = 0;
//        for (uint256 i = 0; i < bondData.coupon_payments.length;) {
//            if (
//                bondData.coupon_payments[i] <= block.timestamp &&
//                bondData.coupon_payments[i] > mostRecent
//            ) {
//                mostRecent = bondData.coupon_payments[i];
//            }
//            ++i;
//        }
//        return mostRecent;
//    }
//
//    function _findNextCouponPayments() public returns (uint256)
//        //        internal
//        //        returns (uint256)
//    {
//        if (bondData.coupon_payments.length == 0) return 0;
//        uint256 mostRecent = bondData.coupon_payments[0];
//        uint256[] memory _coupon_payments = bondData.coupon_payments;
//        uint len = _coupon_payments.length;
//        for (uint256 i = 1; i < len;) {
//            if (
//                mostRecent <= block.timestamp &&
//                _coupon_payments[i] > mostRecent
//            ) {
//                mostRecent = _coupon_payments[i];
//            }
//            ++i;
//        }
//        return mostRecent;
