...
contract RAIbbitHoleTicket is 
    ...
    modifier timeCheck(uint256 _startTime, uint256 _endTime) {
    ...
    function setPublicMintPhase(
        ...
        override
        onlyAuthorized
        timeCheck(_startTime, _endTime)
    {
        // Check if burn & mint rate
        if (burnMintRateForRPFs == 0) {
        ...
        onlyOwner
    {
        ...
        emit AuthorizeAddressChange(_authorizer, _authorizedStatus);
    }
...
interface IRAIbbitHoleTicket {
  ...
  event Redeem(address indexed _from, uint256 _burnQuantity, uint256 _mintQuatity);
  ...
  // This event is triggered whenever a call to #setGalaxyFrensAddress and #setSigner succeeds.
  ...
  event AuthorizeAddressChange(address _addressChange, bool _status);
