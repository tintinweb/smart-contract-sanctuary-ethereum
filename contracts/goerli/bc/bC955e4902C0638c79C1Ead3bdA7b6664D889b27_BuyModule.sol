...
contract SailHelper is Ownable {
    ...
    error InvalidOpenseaFee();
    uint256 public openseaFee = 2.5e18;
    ...
    function setOpenseaFee(uint256 _fee) public onlyOwner {
        if (_fee == 0 || _fee > 100e18) {
            revert InvalidOpenseaFee();
        }
        openseaFee = _fee;
    }
}
...
contract ListModule is Module, IListEvents, IListActions, IERC721Receiver {
    ...
    address public immutable sailHelper;
    ...
    constructor(
        ...
        if (_sailHelper == address(0)) revert ZeroAddressListModule();
        sailHelper = _sailHelper;
        _disableInitializers();
    }
