...
contract RoyaltyFeeSetter is Ownable {
     ...
     */
    function updateRoyaltyInfoForCollectionIfOwner(address collection, address receiver, uint256 fee)
        external
    {
     ...
     * @param fee fee (500 = 5%, 1,000 = 10%)
     */
    function _updateRoyaltyInfoForCollectionIfOwner(address collection, address receiver, uint256 fee)
        internal
    {
        require(
            (
