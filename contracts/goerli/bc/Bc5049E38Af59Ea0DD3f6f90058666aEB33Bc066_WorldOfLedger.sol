...
contract WorldOfLedgerFactory is Ownable, VRFConsumerBaseV2 {
        ...
        override
    {
        ...
        uint256[] memory randomNumbers = s_requestIdToRandomWords[requestId];
        uint256 hp = (randomNumbers[0] % 100) + 1;
        uint256 damage = (randomNumbers[1] % 100) + 1;

        Character memory new_character = Character(hp, damage, 0, 0, true, 0);
        usersCharacters[msg.sender] = new_character;
    }
}
