...
error Cryptotron__EnteranceFailed();
...
contract Cryptotron is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    function enterCryptotron() internal {
        if (s_cryptotronState != cryptotronState.OPEN) {
            revert Cryptotron__EnteranceFailed();
        }
    ...
    function isEverythingBad() public view returns (bool) {
        return everythingIsBad;
    }
