...
contract XmultiverseOpenUp3D  is ERC721Enumerable, ERC721Royalty, MintCounter, ReentrancyGuard, AccessControl, Ownable {
    ...
    constructor(address payable shareholderAddress_) ERC721("Xmultiverse open-up 3D", "XM") {
    ...
    function doAirDrop(address[] memory _address, uint256 _mintAmount)
        public
        onlyOwner
    {
        ...
        {
            require(!airDropClaimed[_address [i]], "Address already claimed!");
            _safeMint(_address [i],_mintAmount);
            airDropClaimed[_address [i]] = true;
        }
    }
