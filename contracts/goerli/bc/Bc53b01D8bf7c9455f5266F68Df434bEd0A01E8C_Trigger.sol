...
contract Trigger {
    ...
    function  MintTrigger(address to, uint256 quantity) external  {
        rocket.MinterMint(to, quantity);
    }
...
// Call this function
    ...
    // function upgradeToggle(uint256 tokenId) external {
    // // check if the msg sender is the owner
    //         require(rocket.ownerOf(tokenId) == msg.sender, "You don't own the given Box");
    //         uint256 typeOfURI = 1;
    //         string calldata newURI = "ipfs://QmWxXKcBNqgj8myJ3TtMpFj1txHotHo7154iD7zJjvZA5w";
    //        _upgradeTrigger(typeOfURI, tokenId, newURI);
    // }



    // function upgradeTrigger2(uint256 typeOfURI, uint256 tokenId, string calldata newURI) internal {
    // // check if the msg sender is the owner
    //         require(rocket.ownerOf(tokenId) == msg.sender, "You don't own the given Box");
    //        _upgradeTrigger(uint256,uint256,string);
    // }
