...
contract ConnextBridgeToken is IBridgeToken, Ownable {
    ...
    function _bridge(
        ...
        _bridgeConnext(amount, chainId, header);
    }
}
...
contract BridgeController is Ownable, Pausable {
    ...
    function registerBridge(uint128 sourcChainId, address bridge)
        public
        onlyOwner
    {
        registeredBridge[sourcChainId] = bridge;
    }
