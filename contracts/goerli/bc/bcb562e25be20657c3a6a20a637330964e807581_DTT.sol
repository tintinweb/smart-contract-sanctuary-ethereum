...
// File: Frigg.eco/DTT.sol

contract DTT is ERC20Capped, AccessControl, IFrigg {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    using SafeERC20 for ERC20;

    //cap the supply of token to 5 for Goerli purposes only
    constructor(address _multisig, address _router) ERC20("D","DTT") ERC20Capped(5 * (10**18)) {
        
        //set DEFAULT_ADMIN_ROLE to multisig address controlled by Frigg on Goerli
        _grantRole(DEFAULT_ADMIN_ROLE, _multisig);

        //set minter role to router
