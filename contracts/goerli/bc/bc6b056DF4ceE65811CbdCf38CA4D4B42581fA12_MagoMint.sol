...
contract MagoMint is ERC721A, ERC2981 , Ownable, Pausable {
        ...
        whenMintable
    {
        ...
        require(
            whiteListClaimed[msg.sender] + _mintAmount <= presaleMaxMint,
            "Already claimed max"
        );
    ...
    function setPresaleMaxMint(uint256 _state) public onlyOwner {
        presaleMaxMint = _state;
    }
