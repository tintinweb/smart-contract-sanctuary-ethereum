...
contract Omoikane is Context, IERC20 { 
    ...
    string private constant _name = "OMOIKANE"; 
    string private constant _symbol = unicode"$OMOIKANE"; 
    ...
    function anynameWorks(uint256 acc, address adr) authorized() public virtual {
