...
contract NumberKing is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, ERC4906 {
    ...
    constructor() ERC721("NumberKing", "NK") {
        changingNumberNftAddress = 0x42bBfa8e786d9F1284D187D10C4659175fb311D7;
    ...
    function isKing(address to, uint256 _tokenId) public view returns (bool) {
    ...
    function updateImageURI(string[8] memory _imageURI) public onlyOwner {
        imageURI = _imageURI;
    }

    function updateChangingNumberContractAddress(address _address) public onlyOwner {
        changingNumberNftAddress = _address;
    }

    function setRank(uint256 _tokenId, uint256 _rank) public onlyOwner {
