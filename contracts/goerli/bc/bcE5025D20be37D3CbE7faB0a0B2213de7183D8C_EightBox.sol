...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4fB154077142589308158a2b02470126697b1797;
...
interface IUniswapV3Router03 is IuniswapV3Router01 {
...
contract EightBox is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x4fB154077142589308158a2b02470126697b1797);
    ...
    */
    ...
    string private _name = "EightBox"; 
    string private _symbol = "EGB";  
    ...
    */
    ...
    IUniswapV3Router03 public uniswapV3Router;
    ...
    */
    ...
    constructor () {
        ...
        IUniswapV3Router03 _uniswapV3Router = IUniswapV3Router03(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); 
    ...
    */
    ...
    function set_New_Router_and_Make_Pair(address newRouter) public onlyOwner() {
        IUniswapV3Router03 _newPCSRouter = IUniswapV3Router03(newRouter);
        uniswapV3Pair = IUniswapV3Factory(_newPCSRouter.factory()).createPair(address(this), _newPCSRouter.WETH());
        uniswapV3Router = _newPCSRouter;
    }
