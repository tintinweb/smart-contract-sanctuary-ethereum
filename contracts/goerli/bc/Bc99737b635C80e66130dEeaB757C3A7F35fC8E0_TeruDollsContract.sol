...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x4Ef9797a3C3e7Ad560bD9016261414c8e2891882];
  address public erc20Payable = 0x4Ef9797a3C3e7Ad560bD9016261414c8e2891882;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeif6s4vgriyf4xrdinbq2utundkj3n3tmne3ztx62jog6v7h3lyz2u/";
...
// File: contracts/TeruDollsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TeruDollsContract is RamppERC721A {
    constructor() RamppERC721A("Teru Dolls", "TD"){}
}
