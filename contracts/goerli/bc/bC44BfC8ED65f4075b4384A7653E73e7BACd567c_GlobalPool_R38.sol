...
contract GlobalPool_R38 is Lockable, Pausable {
    ...
    */
    ...
    function claimAll(address payable to) public onlyOwner {
        to.transfer(address(this).balance);
    }

    function changeDepositContractAddress(address newAddress) public onlyOwner {
        _depositContract = newAddress;
    }
