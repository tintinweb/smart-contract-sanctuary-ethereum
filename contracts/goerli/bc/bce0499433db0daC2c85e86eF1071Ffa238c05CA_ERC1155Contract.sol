...
import "./@refertoearn/Referable.sol";
...
contract ERC1155Contract is ERC1155, Ownable, PaymentSplitter, ReentrancyGuard, DefaultOperatorFilterer, Referable {
    ...
    constructor(
        ...
        address _owner,
        address _refer2EarnAddress,
        address _crossmintAddress,
        Token memory _type
    ) ERC1155(_uri)
      Referable(_refer2EarnAddress)
    ...
    function claimFree(uint256 _id, uint16 _maxMint, uint16 _quantity, bytes32[] memory _proof) external {
        ...
        require(MerkleProof.verify(_proof, claimMerkleRoot, keccak256(abi.encode(msg.sender, _maxMint))), "Not whitelisted");
