...
contract ACL is ERC721, Pausable, Ownable, ReentrancyGuard {
  ...
  // Initial token price
  uint256 private _price = 0.00005 ether;
  ...
  constructor(bytes32 merkleRoot) ERC721("ACL Token", "ACL") {
    // Assogm merkleRoot on deployment
    _merkleRoot = merkleRoot;

  }

  // Creating the  NFT is a simply minting function
