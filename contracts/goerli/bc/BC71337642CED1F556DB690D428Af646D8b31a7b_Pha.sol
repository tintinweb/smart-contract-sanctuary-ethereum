 ...
 * @notice This contract handles minting pha tokens.
 */
contract Pha is ERC1155Supply, Ownable, Pausable, ReentrancyGuard, ERC2981 {
    using ECDSA for bytes32;

    // Used to validate authorized presale mint addresses
    address private presaleSignerAddress =
        0xf150aBA07b32209f2bDd0824F04A419C7e867082;
    ...
    address public royaltyAddress = 0x388837624F6e4acE348f882191CB305A5eBd9dDA;
    address[] public payoutAddresses = [
        0x388837624F6e4acE348f882191CB305A5eBd9dDA
    ];
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeiajrqwqzl5pkgcjo7kwe2uxrqmylcqrvgtk7kvwcwpjzy5nscfnaq/{id}"
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1680193800;
        tokenPublicSaleEndTime[1] = 1680539400;
