...
contract FNDCollectionDropFactory is Initializable, ICollectionFactory {
  ...
  //  * @param _rolesContract The address of the contract defining roles for collections to use.
  //  */
  // function initialize(address _rolesContract, address _marketContract) external initializer {
  //   _updateRolesContract(_rolesContract);
  //   _updateMarketContract(_marketContract);
  // }
   ...
   * @param creator The address of the creator for the collection.
