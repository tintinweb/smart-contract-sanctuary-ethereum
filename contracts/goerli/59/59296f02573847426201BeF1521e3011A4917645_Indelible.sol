...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Headwear", unicode"Eyes", unicode"Mouth", unicode"Body", unicode"Background"];
    ...
    constructor() ERC721A(unicode"test", unicode"test") {
        tiers[0] = [6,11,11,33,39,39,49,50,56,59,63,92,96,102,122,148,155,172,180,184,190,199,225,234,245,324,327,392,394,781,801,1190];
        tiers[1] = [1,2,2,4,14,14,21,23,31,42,42,47,58,69,69,91,99,107,111,116,129,129,149,151,198,203,218,238,240,244,246,262,267,320,409,476,512,760,855];
        tiers[2] = [5,12,14,19,32,35,41,43,52,70,80,86,95,112,151,159,190,208,230,235,238,240,244,260,383,425,461,607,707,744,791];
        tiers[3] = [56,103,105,107,110,135,141,158,161,217,223,236,288,298,323,350,379,996,1256,1327];
        tiers[4] = [141,154,177,287,585,616,697,1130,1274,1908];
