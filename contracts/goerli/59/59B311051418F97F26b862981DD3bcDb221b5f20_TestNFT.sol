...
contract TestNFT is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  // uint256 public requested;
  uint256 public currentSupply = 0;
  
  string public baseURI = "https://gateway.pinata.cloud/ipfs/QmQw6nswa3TnRQjgYBhfT4z3es81cVoz3aHPbxaAi5B1Ly/";

  constructor() 
    ERC721("We Want Test", "WWT")
