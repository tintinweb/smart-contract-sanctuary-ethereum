...
contract erc1155 is ERC1155, Ownable, ERC1155Burnable {
    ...
    string public name = "Game Tools";
    function mint(address to, uint256 id, uint256 amount) public{
        _mint(to, id, amount, '');
        _setURI("https://gateway.pinata.cloud/ipfs/QmeL83V8huVw9NotUtiUujWsWGsJmoBvYBW1JXbhnpohrQ/{id}.json");
    }
    ...
    // function uri(uint id) override public pure returns(string memory){
    //     return string(
    //         abi.encodePacked(
    //             "https://gateway.pinata.cloud/ipfs/QmYXHrLLax44SpNbdjf6MiwK1bYTCdx9Wug4hdAUjZB26X/",
    //             Strings.toString(id),
    //             ".json"
    //         )
    //     );
