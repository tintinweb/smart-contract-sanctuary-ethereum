...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x390De40CF448729fA049e1734e9E954EF12c4083];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUnSestF1Pwazvp68EEqwvgimA3cn7Jf4fEfpBeCChi8h/";
...
// File: contracts/PpTestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PpTestContract is RamppERC721A {
    constructor() RamppERC721A("PP Test", "PP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/wZ8WInFVhqH1aAIsMV8g/contract-metadata";
    }
}
