...
contract Presale is Ownable, Pausable, Whitelist {
     ...
     */
    function buyTokensWithUSDT(uint256 value) public payable onlyWhitelisted whenNotPaused returns (bool) {
        uint256 ethBalance = balanceOfBuyer[msg.sender].balanceETH;
        uint256 usdtBalance = balanceOfBuyer[msg.sender].balanceUSDT;
     ...
     * @dev Claim TKNs.
     */
    function claim() public payable whenPaused returns (uint256) {
        uint256 ethBalance = balanceOfBuyer[msg.sender].balanceETH;
        uint256 usdtBalance = balanceOfBuyer[msg.sender].balanceUSDT;
