...
contract HashedTimelockERC20 {
     ...
     * @param _hashlock A sha-3 keccak256 hash hashlock.
        ...
        returns (bytes32 contractId)
    {
        ...
        emit HTLCERC20New(contractId, msg.sender, _receiver, _tokenContract, _amount, _hashlock, _timelock);
    }
    ...
    {
        if (haveContract(_contractId) == false) return (address(0), address(0), address(0), 0, 0, 0, false, false, "");
        LockContract storage c = contracts[_contractId];
        return (
            c.sender,
            c.receiver,
