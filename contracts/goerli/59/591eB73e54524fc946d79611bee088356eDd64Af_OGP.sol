...
contract OGP is ERC721, ERC2981 {
    ...
    constructor(string memory _baseUri, uint _price) ERC721("OG Potheads", "OGP") {
        baseUri = _baseUri;
        price = _price;
    ...
    function mintVaulted(address to, Rarity _rarity) public onlyAdmin {
        ...
        totalSupply++;
        rarity[totalSupply] = _rarity;
        supply[_rarity]++;

        emit MintVaulted(to, totalSupply, _rarity);
    }
