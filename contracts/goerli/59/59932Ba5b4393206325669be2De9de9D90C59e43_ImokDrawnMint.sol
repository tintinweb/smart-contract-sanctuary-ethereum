...
contract ImokDrawnMint is ERC721, Ownable {
    ...
    uint256 public PUBLIC_PRICE = 0.0012 ether;
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, hashes[_tokenId], ".json")) : "";
    }
    ...
    function withdraw() public onlyOwner {
        payable(0x5bdB3C6eDf96Aeed1028f97669D6dbE24B863C98).transfer(address(this).balance / 2);
        payable(0xC37eE21F0cDA37dE8254aACD8351005d0f6ab06D).transfer(address(this).balance);
    }
