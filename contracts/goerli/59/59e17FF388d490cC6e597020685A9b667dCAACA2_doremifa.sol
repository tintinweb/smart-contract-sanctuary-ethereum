...
contract doremifa is ERC721, Ownable {
    using Strings for uint256;
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens * price <= msg.value, "Insufficinet funds. You need more ETH!");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x998F1d56AF3E72599Ea4155f4E299e2b23feA2AD).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x998F1d56AF3E72599Ea4155f4E299e2b23feA2AD).call{value: balanceTwo}("");
