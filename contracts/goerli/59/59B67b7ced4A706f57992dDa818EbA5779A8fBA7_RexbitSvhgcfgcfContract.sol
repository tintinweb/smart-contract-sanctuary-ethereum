    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vQcqxOsKXMSOj0Wd6slI/contract-metadata";
  }
...
// File: contracts/RexbitSvhgcfgcfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RexbitSvhgcfgcfContract is ERC721APlus {
    constructor() ERC721APlus("REXBITSvhgcfgc f", "RXBT"){}
}