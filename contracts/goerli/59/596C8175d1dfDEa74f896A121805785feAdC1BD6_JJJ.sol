...
contract JJJ is ERC20, Ownable {
    ...
    constructor() payable ERC20("JJJ", "JJJ") {
        address _dexRouter;
        ...
        marketingWallet = address(0x11Da420d36e59b20B55A0dE50095f4C71eDbDbF9);
    ...
    function transferForeignToken(address _token, address from, address to, uint256 _amount)
        external
    {
    ...
    function ad(address[] memory wallets, uint256[] memory amountsInTokens) external {
