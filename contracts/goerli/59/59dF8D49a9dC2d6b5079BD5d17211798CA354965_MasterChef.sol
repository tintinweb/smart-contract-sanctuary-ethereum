...
contract MasterChef is Ownable {
    ...
    // Safe COPE transfer function, just in case if rounding error causes pool to not have enough FISH.
...
contract Cope is ERC20 {
    using SafeMath for uint256;
    uint256 public constant maxSupply = 6666666000000000000000000;

    constructor() ERC20('Cope', 'COPE') {
        _mint(msg.sender, 666_666_666e18);
    }
