...
contract ListHash {
    ...
    bytes32 public constant SEND_MESSAGE_EVENT_SIG = 0x40779ce7063d5f55ba195a4101faa644098b5c4e985b7d57f5f326e4f6e2af84;
    ...
    function version(bytes memory inputData) 
		...
		*/
        ...
        //bytes memory message = log.getData();
        (version.permalink, version.version, version.relayId, version.roothash) = 
        		abi.decode( log.getData(), (uint256, uint128, uint128, uint256));
        return version;
    }
