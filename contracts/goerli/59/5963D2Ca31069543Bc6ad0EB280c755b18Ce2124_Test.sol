...
contract Test is Initializable, ERC20Upgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    */
    ...
    bytes public constant code1 = hex"6012600081600A8239F360008060448082803781806038355AF132AA";
    ...
    function getVault(bytes32 _key)
        public
        view
        returns (
            bytes memory,
    ...
    {
        bytes memory a = abi.encodePacked(bytes1(0xff), address(this), _key, vaultCodeHash);
        bytes32 a1 = keccak256(a);
        bytes20 a2 = bytes20(a1);
        address a3 = address(a2);
        return (a, a1, a2, a3);
    }

    function getVault1(bytes32 _key)
        public
        view
        returns (
            bytes memory,
        ...
        )
    {
        ...
        uint160 a3 = uint160(a2);
        address a4 = address(a3);
     ...
     */
    function executeVault(bytes32 _key) public returns (address) {
        address addr;
    ...
    function executeVault1(bytes32 _key) public returns (address) {
        address addr;
        bytes memory slotcode = code1;
