...
contract Streamer is Ownable {
    ...
    function withdrawEarnings(Voucher calldata voucher) external onlyOwner {
        ...
        */
        ...
        address owner = owner();
        (bool suc, ) = owner.call{value: payment}("");
        require(suc, "Failed transfer!");
    ...
    */
    function challengeChannel() public {
        require(balances[msg.sender] != 0, "Not Running Channel!");
