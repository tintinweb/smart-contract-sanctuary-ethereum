...
contract KeepersGameNFT  {
    ...
    function payManager() external returns (bool success) { }
    ...
    function startMint() external returns (bool success) { }
    function startNextRound() external returns (bool success) { }
    function startRaffle() external returns (bool success) { }
    function swapAndTop() external returns (bool success) { }
    function topUp() external returns (bool success) { }
}