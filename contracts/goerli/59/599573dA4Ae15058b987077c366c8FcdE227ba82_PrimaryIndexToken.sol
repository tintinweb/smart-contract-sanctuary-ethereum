...
contract PrimaryIndexToken is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable
{
    ...
    function deposit(address projectToken, uint256 projectTokenAmount) public isProjectTokenListed(projectToken) nonReentrant() {
        depositInternal(projectToken, projectTokenAmount, msg.sender, msg.sender);
    }
    ...
    function depositFromRelatedContracts(address projectToken, uint256 projectTokenAmount, address user, address beneficiary) public isProjectTokenListed(projectToken) nonReentrant() onlyRelatedContracts() {
        depositInternal(projectToken, projectTokenAmount, user, beneficiary);
    }

    function depositInternal(address projectToken, uint256 projectTokenAmount, address user, address beneficiary) internal {
        ...
        calcDepositPositionInternal(projectToken, projectTokenAmount, beneficiary);
        emit Deposit(user, projectToken, usdcToken, projectTokenAmount, beneficiary);
    }

    function calcAndTransferDepositPosition(address projectToken, uint256 projectTokenAmount, address user, address receiver) external isProjectTokenListed(projectToken) onlyRelatedContracts() {
    ...
    function calcDepositPosition(address projectToken, uint256 projectTokenAmount, address user) public isProjectTokenListed(projectToken) onlyRelatedContracts() onlyRelatedContracts() {
        calcDepositPositionInternal(projectToken, projectTokenAmount, user);
    }

    function calcDepositPositionInternal(address projectToken, uint256 projectTokenAmount, address beneficiary) internal {
    ...
    function withdraw(address projectToken, uint256 projectTokenAmount) public isProjectTokenListed(projectToken) nonReentrant {
        withdrawInternal(projectToken, projectTokenAmount, msg.sender, msg.sender);
    }

    function withdrawFromRelatedContracts(address projectToken, uint256 projectTokenAmount, address user, address beneficiar) public isProjectTokenListed(projectToken) nonReentrant {
        withdrawInternal(projectToken, projectTokenAmount, user, beneficiar);
    }

    function withdrawInternal(address projectToken, uint256 projectTokenAmount, address user, address beneficiar) internal {
        ...
        address actualLendingToken = getLendingToken(msg.sender, projectToken);
        uint256 _totalOutstanding;
        if(actualLendingToken != address(0) && borrowPosition[msg.sender][projectToken][actualLendingToken].loanBody > 0) {
            updateInterestInBorrowPositions(msg.sender, actualLendingToken);
            _totalOutstanding = actualLendingToken == address(0) ? 0 : totalOutstandingInUSD(msg.sender, projectToken, actualLendingToken);
        }
        ...
        if (projectTokenAmount == type(uint256).max) {
            if (borrowPosition[msg.sender][projectToken][actualLendingToken].loanBody > 0) {
                ...
                uint256 collateralAvailableToWithdraw = getCollateralAvailableToWithdraw(msg.sender, projectToken);
    ...
    function supply(address lendingToken, uint256 lendingTokenAmount) public isLendingTokenListed(lendingToken) {
        supplyInternal(lendingToken, lendingTokenAmount, msg.sender);
    }

    function supplyFromRelatedContract(address lendingToken, uint256 lendingTokenAmount, address user) public isLendingTokenListed(lendingToken) onlyRelatedContracts() {
        supplyInternal(lendingToken, lendingTokenAmount, user);
    }

    function getCollateralAvailableToWithdraw(address account, address projectToken) internal view returns(uint collateralProjectToWithdraw) {
    ...
    function supplyInternal(address lendingToken, uint256 lendingTokenAmount, address user) public isLendingTokenListed(lendingToken) {
    ...
    function redeem(address lendingToken, uint256 bLendingTokenAmount) public isLendingTokenListed(lendingToken) {
        redeemInternal(lendingToken, bLendingTokenAmount, msg.sender);
    }

    function redeemFromRelatedContract(address lendingToken, uint256 bLendingTokenAmount, address user) public isLendingTokenListed(lendingToken) onlyRelatedContracts() {
        redeemInternal(lendingToken, bLendingTokenAmount, user);
    }

    function redeemInternal(address lendingToken, uint256 bLendingTokenAmount, address user) internal {
        require(!lendingTokenInfo[lendingToken].isPaused, "PIT: lending token is paused");
    ...
    function redeemUnderlying(address lendingToken, uint256 lendingTokenAmount) public isLendingTokenListed(lendingToken) {
        redeemUnderlyingInternal(lendingToken, lendingTokenAmount, msg.sender);
    }

    function redeemUnderlyingFromRelatedContract(address lendingToken, uint256 lendingTokenAmount, address user) public isLendingTokenListed(lendingToken) onlyRelatedContracts() {
        redeemUnderlyingInternal(lendingToken, lendingTokenAmount, user);
    }

    function redeemUnderlyingInternal(address lendingToken, uint256 lendingTokenAmount, address user) internal {
        require(!lendingTokenInfo[lendingToken].isPaused, "PIT: lending token is paused");
        require(lendingTokenAmount > 0, "PIT: lendingTokenAmount==0");
    ...
    function borrow(address projectToken, address lendingToken, uint256 lendingTokenAmount) public isProjectTokenListed(projectToken) isLendingTokenListed(lendingToken) {
        borrowInternal(projectToken, lendingToken, lendingTokenAmount, msg.sender);
    } 

    function borrowFromRelatedContract(address projectToken, address lendingToken, uint256 lendingTokenAmount, address user) public isProjectTokenListed(projectToken) isLendingTokenListed(lendingToken) onlyRelatedContracts {
        borrowInternal(projectToken, lendingToken, lendingTokenAmount, user);
    } 

    function borrowInternal(address projectToken, address lendingToken, uint256 lendingTokenAmount, address user) internal {
        ...
        calcBorrowPositionInternal(user, projectToken, lendingToken, lendingTokenAmount, _lendingToken); 
    ...
    function calcBorrowPosition(address borrower, address projectToken, address lendingToken, uint256 lendingTokenAmount, address currentLendingToken) external onlyRelatedContracts() {
        calcBorrowPositionInternal(borrower, projectToken, lendingToken, lendingTokenAmount, currentLendingToken); 
    }

    function calcBorrowPositionInternal(address borrower, address projectToken, address lendingToken, uint256 lendingTokenAmount, address currentLendingToken) internal {
    ...
    function repayFromRelatedContract(address projectToken, address lendingToken, uint256 lendingTokenAmount, address repairer, address borrower) public isProjectTokenListed(projectToken) isLendingTokenListed(lendingToken) returns (uint256) {
        require(lendingTokenAmount > 0, "PIT: lendingTokenAmount==0");
        return repayInternal(repairer, borrower, projectToken, lendingToken, lendingTokenAmount); // under normal conditions: repairer == borrower
    }
    ...
    function repayInternal(address repairer, address borrower, address projectToken, address lendingToken, uint256 lendingTokenAmount) internal returns (uint256) {
        ...
        if (borrowPositionsAmount == 1) {
            if (lendingTokenAmount > info.bLendingToken.borrowBalanceStored(borrower) || 
                ...
                amountRepaid = repayToInternal(repairer, borrower, info, type(uint256).max);   
                isPositionFullyRepaid = repayFullyInternal(borrower, projectToken, lendingToken, _borrowPosition);
            } else {
                uint256 lendingTokenAmountToRepay = lendingTokenAmount;
                amountRepaid = repayToInternal(repairer, borrower, info, lendingTokenAmountToRepay);   
                isPositionFullyRepaid = repayPartialyInternal(projectToken, lendingToken, lendingTokenAmountToRepay, _borrowPosition);
            }
        } else {
            if (lendingTokenAmount >= _totalOutstanding || lendingTokenAmount == type(uint256).max) {
                amountRepaid = repayToInternal(repairer, borrower, info, _totalOutstanding);   
                isPositionFullyRepaid = repayFullyInternal(borrower, projectToken, lendingToken, _borrowPosition);
            } else {
                uint256 lendingTokenAmountToRepay = lendingTokenAmount;
                amountRepaid = repayToInternal(repairer, borrower, info, lendingTokenAmountToRepay); 
    ...
    function repayFullyInternal(address borrower, address projectToken, address lendingToken, BorrowPosition storage _borrowPosition) internal returns(bool) {
    ...
    function repayPartialyInternal(address projectToken, address lendingToken, uint lendingTokenAmountToRepay, BorrowPosition storage _borrowPosition) internal returns(bool) {
    ...
    function repayToInternal(address repairer, address borrower, LendingTokenInfo memory info, uint lendingTokenAmountToRepay) internal returns(uint amountRepaid) {
    ...
    function pitRemaining(address account, address projectToken) public view returns (uint256) {
        ...
        uint remaining;
        if(_pit > 0) {
            remaining = lendingToken == address(0) ? _pit : _pitRemainingInternal(account, projectToken, lendingToken, _pit);
        } else {
            return 0;
        }
        return remaining;
    ...
    function convertPitRemaining(address account, address projectToken, address lendingToken) public view returns(uint256) {
        uint256 _pitRemaining = pitRemaining(account, projectToken);
        uint8 lendingTokenDecimals = ERC20Upgradeable(lendingToken).decimals();
        uint256 lendingTokenAmount = _pitRemaining * (10 ** lendingTokenDecimals) / getTokenEvaluation(lendingToken, 10 ** lendingTokenDecimals); 
