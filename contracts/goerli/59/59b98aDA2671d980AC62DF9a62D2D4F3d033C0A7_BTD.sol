...
contract BTD is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    string  public placeholderTokenURI; // for before reveal
    ...
    constructor(string memory _placeholderTokenURI, address[] memory _admins) payable ERC721("Bored To Death", "BTD")
    {
    ...
    modifier onlyOnce
    {
        // An address can only call this function once
        _;
    }
    ...
    /*
     * @dev Return the percentage of tokens minted.
     */
    ...
    /*
     * @dev Mint the URI stored in `uri` as an NFT under this contract.
     *
    ...
    /*
     * @dev Mint function to be used by all other functions
    ...
    function mintInternal(address to) internal
    {
        ...
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, placeholderTokenURI);
    }


    /*
     * @dev Pause transfers of NFT's
     */
    ...
    /*
     * @dev Function allows an admin to mint tokens for free and send them
    ...
    /*
     * @dev Admins can burn tokens if they need to.
     */
    ...
    /*
     * @dev Set the mint price for second time minters or
     *      the public.
     */
    ...
    /*
     * @dev Add an array of accounts to the white list..
     */
    ...
    /*
     * @dev Remove an array of accounts from the white list.
     */
    ...
    /*
     * @dev Allow white-listed accounts to mint up to 10 tokens, with the first 2 being free
    ...
    /*
     * @dev function handles public mint if we need to switch from wl only.
     */
