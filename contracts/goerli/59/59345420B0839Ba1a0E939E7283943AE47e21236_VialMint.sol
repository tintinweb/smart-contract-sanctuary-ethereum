...
contract VialMint is ERC1155, ERC1155Burnable, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(address payable owner) ERC1155(_baseURI) {
        ...
        listsData[1] = listParameters(0x0, 0 ether);
        listsData[2] = listParameters(0xffcf42a4f71cca202bbb8332b98c87af8e941b7b37e13a906660201351702d17, 0 ether);
        listsData[3] = listParameters(0x0, 0 ether);
    }
