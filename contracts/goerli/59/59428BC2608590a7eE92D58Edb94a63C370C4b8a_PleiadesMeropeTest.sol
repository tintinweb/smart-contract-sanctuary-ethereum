...
contract PleiadesMeropeTest is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    
    uint public constant Test = 1;

    constructor() ERC1155("ipfs://QmcX9Z71CnnJmA3eYWzd9W3ptnXjiMKSREVuNxJLHm6NUQ/{id}.json"){
        _mint(msg.sender, Test, 10000000, "");
    }
