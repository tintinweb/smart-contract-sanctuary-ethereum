...
contract SBTPen is ERC1155, ReentrancyGuard, AccessControl, ISBTPen, Pausable {
    ...
    /// @param usdc_ USDC的地址
    constructor(address usdc_) ERC1155("https://{id}.json") Pausable() {
        usdc = usdc_;
        ...
        uri_[LOW] = "https://bafybeiawbot3hyrvze2awul7sddvpbaco37jwsfd4yxorjvfw3kctyhbb4.ipfs.w3s.link/1.jpeg";
        uri_[MIDDLE] = "https://bafybeierpnivwdx73lgs4wjct7kzsedkdyq73xq5k5bb6wcmcirdinom6m.ipfs.w3s.link/2.jpeg";
        uri_[HIGH] = "https://bafybeianqpxtlnovazd3f4lldlcn72ql5454vgpiezpzbkseh5awhjo46a.ipfs.w3s.link/3.jpeg";

        // Set the price for each token type
        levelPrice[LOW] = 1 * 10**decimals;
        levelPrice[MIDDLE] = 2 * 10**decimals;
        levelPrice[HIGH] = 3 * 10**decimals;
    }
