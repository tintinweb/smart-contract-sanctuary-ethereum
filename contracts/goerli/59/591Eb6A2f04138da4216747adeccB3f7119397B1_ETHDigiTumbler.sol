...
contract MerkleTreeWithHistory {
    ...
    uint256 public constant ZERO_VALUE = 21663839004416932945382355908790599225266501822907911457504978515578255421292; // = keccak256("digiTumbler") % FIELD_SIZE
...
abstract contract DigiTumbler is MerkleTreeWithHistory, ReentrancyGuard {
...
contract ETHDigiTumbler is DigiTumbler {
    ...
    constructor(
        ...
        uint256 _denomination,
        uint32 _merkleTreeHeight
    ) DigiTumbler(_verifier, _hasher, _denomination, _merkleTreeHeight) {
        owner = msg.sender;
    }    
