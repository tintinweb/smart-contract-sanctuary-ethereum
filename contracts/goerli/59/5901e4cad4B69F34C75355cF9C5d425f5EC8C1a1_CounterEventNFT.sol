...
contract CounterEventNFT is ERC721URIStorage, Ownable {

    /** 
     * @dev
     * - _tokenIdはCountersの全関数が利用可能
     */
    ...
    /**
     * @dev
     * - URI設定時に誰がどのtokenIdを設定したか記録する
     */
    event TokenURIChanged(address indexed sender, uint256 indexed tokenId, string uri);

    constructor() ERC721("CounterEventNFT", "COUNT") {}

    /**
     * @dev 
     * - このコントラクトをデブロイしたアドレスだけがmint可能　 onlyOwner
