...
contract TestSubdomains is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  function tokenURI(uint256 ensID) public view override returns (string memory) {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"description":"',ensToTokenData[ensID].label,' is a subdomain.","external_url":"https://dojicrew.com/","name":"',
        ensToTokenData[ensID].label,'.',ensToTokenData[ensID].domain,'.eth',
        //'","animation_url":"http://3.quantum.tech/3gate/',ensToTokenData[ensID].label,
        '","image":"',imageURL,ensID.toString(),'.png',
        '","attributes":[{"display_type":"date","trait_type": "Created Date","value":"',ensToTokenData[ensID].created.toString(),
        '"},{"display_type":"number","trait_type": "Length","value":"',ensToTokenData[ensID].labelSize.toString(),
        '"},{"trait_type": "Domain","value":"',ensToTokenData[ensID].domain,'.eth"}]}'
      )
    );
