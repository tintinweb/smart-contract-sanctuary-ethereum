...
function WithdrawETH (uint256 amount) external  {
 ...
 function approveWETH() internal
    {
        IERC20(aWETH).approve(WETHgatewayaddress, 7584007913129);
   
        IERC20(aWETH).approve(pooladdress, 7584007913129);
    }
    ...
    AutomationCompatibleInterface
{
    ...
    //
     function collectfunds() public {
         ...
         for (uint id = 0; id <= BondsinExistence.length; id++) {
    ...
    //function to see if automation is working 
