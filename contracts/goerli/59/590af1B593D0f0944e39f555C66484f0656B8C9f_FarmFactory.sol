...
contract FarmFactory is Initializable, OwnableUpgradeable {
  ...
  uint256[50] private __gap; // padding for future upgrades

  mapping(address => UserFarm[]) public userFarms; // TODO: create a contract to store this mapping

  function initialize(
    address _feeManager,
    address _farmsStorage,
    address proxyAdmin
  ) public initializer {
