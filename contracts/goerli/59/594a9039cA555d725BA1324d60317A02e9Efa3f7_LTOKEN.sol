...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(_balances[account] >= amount, "ERC20: burn from the zero address");
        require(_totalSupply >= amount, "ERC20: burn from the zero address");
...
contract LTOKEN is ERC20Capped, Ownable {
    constructor(
        string memory name,
