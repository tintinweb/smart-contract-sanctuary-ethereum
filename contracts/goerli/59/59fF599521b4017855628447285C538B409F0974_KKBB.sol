...
// TODO Implement external functions and checks, write natspec, switch to custom errors
...
contract KKBB is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public publicPrice = 0.001 ether; // TESTING VALUE
    uint256 public whitelistPrice = 0.0005 ether; // TESTING VALUE
