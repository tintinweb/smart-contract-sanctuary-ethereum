...
contract Lock is BaseGovernanceWithUserUpgradable, ERC721EnumerableUpgradeable {
    ...
    modifier checkFirstRelease() {
        ...
        require(firstReleaseReached == false, "First release was reached, can't add/remove new beneficiaries");
        _;
    }
    ...
    function removeBeneficiaries(bytes calldata data) external checkFirstRelease onlyBeneficiaryManager {
        require(canRemoveBeneficiaries == true, "ERROR: Cannot remove beneficiaries");
