...
contract WagdieBeasts is ERC721AUpgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable {
     ...
     */
    function ordainedTame(uint256 quantity) external onlyOwner {
        if (quantity + totalSupply() > maxBeasts) revert ExceedsMaxSupply();
        _mint(msg.sender, quantity);
    }
