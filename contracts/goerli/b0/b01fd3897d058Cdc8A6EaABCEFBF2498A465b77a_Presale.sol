    ...
    PausableUpgradeable
{
    ...
    function initialize(
        ...
        // address _oracle = 0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419;
        // address _usdt = 0xb85C58b5359B6AB3decCc70122e2Af384C7A509C;
        // uint256 _startTime = block.timestamp + 5;
        // uint256 _endTime = block.timestamp + 600;
        // uint256[1][2] memory _rounds = [[uint256(600)], [uint256(16650000000000000)]];

        // uint256[8][2] memory _tokenQuantity = [[uint256(1000), uint256(3000), uint256(10000), uint256(25000), uint256(50000), uint256(100000), uint256(250000), uint256(500000)], [uint256(100), uint256(300), uint256(600), uint256(900), uint256(1200), uint256(1600), uint256(2000), uint256(2500)]];
        // uint256[8][2] memory _lockup = [[uint256(6), uint256(8), uint256(10), uint256(12), uint256(15), uint256(18), uint256(21), uint256(24)], [uint256(100), uint256(300), uint256(600), uint256(900), uint256(1200), uint256(1600), uint256(2000), uint256(2500)]];
        // uint256 _defaultLockup = 3;
        // uint256 _initialClaimPercent = 0;
