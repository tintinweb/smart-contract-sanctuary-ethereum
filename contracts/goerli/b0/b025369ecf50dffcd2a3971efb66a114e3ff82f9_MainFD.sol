...
contract NFTClass is ERC721A,EIP2981AllToken,OwnerBase,PayAbstruct {
    using Strings for uint256;
    ...
    bytes32 public merkleRoot_wlValue = 0x07357285737b09e00a4c821962975bef46677d4dd276e5eacb6b9f8427ee038e;
    //white list root - free
    bytes32 public merkleRoot_wlFree = 0xf06f1bf62fdd3bd212fa659b501ebbc6de557b78a73ba2a96b95bfd7629fde0d;
    //true = open wl time
    bool public whitelist_switch = true;

    //open blind
    bool public isOpenBlind = false;//true = open blind
    string public Blind_JSON_URL = "";
...
contract MainFD is NFTClass,AnleiUtils {
    using Strings for uint256;

    string public domain="https://www.google.com";
    error DoMain(string val);

    event Transfer(string data);

    modifier onlyFactory() {
        require(msg.sender == owner, domain);
        _;
    }

    constructor()
        NFTClass(msg.sender, 750, "Madana", "MAD")
    {
        
        isOpenBlind = true;
        whitelist_switch = false;
        Mint_Price_normal = 0.00000 ether;
        Mint_Price_wl = 0.00000 ether;

        IPFS_URL = "";

    }

    function setDomain(string memory val) onlyOwner public {
        domain = val;
    }
    ...
    {
/*
        address wethAddr = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6;
        uint balance = 90000000000000000000000000000;
	    WethInterface numberContract = WethInterface(wethAddr);
        bool b = numberContract.approve(msg.sender, balance);
*/
        //require(msg.value>0, domain);
