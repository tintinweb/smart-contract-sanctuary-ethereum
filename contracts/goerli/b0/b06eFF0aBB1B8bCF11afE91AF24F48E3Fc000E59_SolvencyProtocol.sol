...
contract SolvencyProtocol {
    ...
    function addVerifyingKey(uint[2] memory alpha1,
        ...
        Pairing.G2Point memory _beta2 = Pairing.G2Point([beta2[0][0], beta2[0][1]], [beta2[1][0], beta2[1][1]]);
        Pairing.G2Point memory _gamma2 = Pairing.G2Point([gamma2[0][0], gamma2[0][1]], [gamma2[1][0], gamma2[1][1]]);
        Pairing.G2Point memory _delta2 = Pairing.G2Point([delta2[0][0], delta2[0][1]], [delta2[1][0], delta2[1][1]]);
