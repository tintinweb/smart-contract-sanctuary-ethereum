...
contract DeathBringerFirstEdition is ERC1155, Ownable {
  ...
  State public saleState = State.PUBLIC;


  constructor() ERC1155("") {
    name = "Death-Bringer First Edition";
    symbol = "DBFE";
  }
...
//Switch sales states
  ...
  function disableMint() external onlyOwner {
   ...
   function enablePublicMint() external onlyOwner {
    ...
    function changeSupply(uint256 _MAXSUPPLY) external onlyOwner {
      MAX_SUPPLY = _MAXSUPPLY;
    }

    address public a1 = 0x909957dcc1B114Fe262F4779e6aeD4d034D96B0f;
