...
contract SAITAMASTER is Ownable {
    ...
    address public saita;
    address public rewardWallet;
    
    address public devaddr;
    
    uint256 public saitaPerBlock;
    ...
    constructor(
        ...
        address _devaddr,
        uint256 _saitaPerBlock,
        uint256 _startBlock,
        address _saita
    ) {
       
        devaddr = _devaddr;
        saitaPerBlock = _saitaPerBlock;
    ...
    function safeCakeTransfer(address _to, uint256 _amount) internal {
        ISaitama(saita).mint(_to, _amount);
    }
