...
// File contracts/vesting/MinimalProxyFactory.sol
...
// File contracts/interfaces/IBreederDaoTokenLock.sol
...
// File contracts/interfaces/IBreederDaoTokenLockManager.sol
...
// File contracts/vesting/BreederDaoTokenLockManager.sol
    ...
    IBreederDaoTokenLockManager
{
     ...
     */
    function isTokenDestination(address _dst)
        external
        view
        override
        returns (bool)
     ...
     * @param _signature Function signature
     */
    function unsetAuthFunctionCall(string calldata _signature)
        external
        override
        onlyOwner
    {
     ...
     * @notice Sets an authorized function call to target
     * @dev Input expected is the function signature as 'transfer(address,uint256)'
     * @dev Function signatures of BreederDao Protocol contracts to be used are known ahead of time
     * @param _signature Function signature
     * @param _target Address of the destination contract to call
     */
    function _setAuthFunctionCall(string calldata _signature, address _target)
        internal
    {
     ...
     * @return True if authorized
     */
    function isAuthFunctionCall(bytes4 _sigHash)
        external
        view
        override
        returns (bool)
     ...
     */
    function _toFunctionSigHash(string calldata _signature)
        internal
        pure
        returns (bytes4)
    {
     ...
     */
    function _convertToBytes4(bytes memory _signature)
        internal
        pure
        returns (bytes4)
    {
