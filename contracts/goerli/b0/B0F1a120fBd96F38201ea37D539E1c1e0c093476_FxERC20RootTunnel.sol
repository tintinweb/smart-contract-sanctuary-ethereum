...
contract ERC20 is IERC20 {
     ...
     *
     * To learn more about hooks, head to xref:ROOT:extending-contracts3.adoc#using-hooks[Using Hooks].
     */
...
contract ICheckpointManager {
     ...
     * @dev These checkpoints are submited by plasma contracts3
     */
...
library ExitPayloadReader {
    ...
    // copy paste of private copy() from RLPReader to avoid changing of existing contracts3
    function copy(
        uint256 src,
        uint256 dest,
        uint256 len
