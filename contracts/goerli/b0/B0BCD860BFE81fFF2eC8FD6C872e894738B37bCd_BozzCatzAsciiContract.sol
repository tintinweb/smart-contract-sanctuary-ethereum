...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x6D4947f811BF2c3E2613DB082f08652ea043E125];
  address public erc20Payable = 0x6D4947f811BF2c3E2613DB082f08652ea043E125;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 121;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 2121) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbHuxhP76Ev58XvHCoLNwDkhwbsx8GmoqPBpqGLHb3EzD/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XfBXq7YiRvzmjVqdamlv/contract-metadata";
  }
...
// File: contracts/BozzCatzAsciiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BozzCatzAsciiContract is ERC721APlus {
    constructor() ERC721APlus("BozzCatz ASCII", "BCASCII"){}
}
