...
contract OriginPool is SuperAppBase, IXReceiver {
    ...
    ISuperToken public immutable superToken =
        ISuperToken(0x3427910EBBdABAD8e02823DFe05D34a65564b1a0); // TESTx token
    IERC20 public erc20Token =
        IERC20(0x7ea6eA49B0b0Ae9c5db7907d139D9Cd3439862a1); // TEST token
    ...
    function _sendFlowMessage(
        ...
        // address sender, // sender can be msg.sender, because the user will be the one calling origin
        address receiver,
        int96 flowRate,
        ...
        if (bridgingToken == address(superToken)) {
            ...
            superToken.approve(address(connext), cost);
