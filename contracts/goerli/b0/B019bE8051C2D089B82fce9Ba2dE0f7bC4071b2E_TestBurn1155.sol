 ...
 * @notice This contract handles minting test burn 1155 tokens.
 */
contract TestBurn1155 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xb6596014Bc86e68F9FBb50dB75887186FaaB9450;
    ...
    string public name = "test burn 1155";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeifph4jd76mivkm5o2llygt5l23fil5edcgygdr6p4imwrpq3u6ehi/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMintsPerBurn[1] = 2;
        tokenBurnTokens[1].push(
            BurnToken(0x7a4Df7b461F1be3e88373A4d933AEEfE2faDCe72, 2, 5, 0)
        );
        require(
    ...
    function burnToMint(
        ...
        require(
            maxSupply == 0 ||
                totalSupply(_tokenId) + (_timesToBurn * mintsPerBurn) <=
                maxSupply,
            "MAX_SUPPLY_EXCEEDED"
        );
        ...
        _mint(msg.sender, _tokenId, _timesToBurn * mintsPerBurn, "");
    }
