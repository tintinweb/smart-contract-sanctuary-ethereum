...
import {IVault, InitInfo, Plugin} from "./interfaces/IVault.sol";
...
contract VaultRegistry is IVaultRegistry {
    ...
    function createFor(
        ...
        vault = _deployVault(_merkleRoot, _owner, fNFT, _plugins, _calls);
    }
    ...
    function createFor(
        ...
        vault = _deployVault(_merkleRoot, _owner, fNFT, _plugins);
    }
    ...
    function create(
        ...
        vault = createFor(_merkleRoot, address(this), _plugins, _calls);
    }
    ...
    {
        vault = createFor(_merkleRoot, address(this), _plugins);
    }
    ...
    function _deployVault(
        ...
        vault = VaultFactory(factory).deployFor(_merkleRoot, _owner, _plugins);
    ...
    function _deployVault(
        ...
        vaultToToken[vault] = VaultInfo(_token, ++nextId[_token]);
        VaultFactory(factory).deployFor(_merkleRoot, _owner, _plugins, _calls);
        emit VaultDeployed(vault, _token, nextId[_token]);
    }
}
