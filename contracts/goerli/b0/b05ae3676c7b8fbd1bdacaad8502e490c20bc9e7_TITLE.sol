...
contract TITLE is ERC721, Ownable, ERC721Burnable, DefaultOperatorFilterer {
    ...
    constructor(string memory _URI) ERC721("datest", "MMMTEST") {
        baseTokenUri = _URI;
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(!pause, "Public mint not available");
