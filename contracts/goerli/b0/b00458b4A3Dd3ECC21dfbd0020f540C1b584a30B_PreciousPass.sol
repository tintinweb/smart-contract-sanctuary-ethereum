    ...
    PriceConsumerV3
{
    ...
    address[] private _team = [0xcA7b37c62740B2706b0c195843ca06a61693Bb06,0xf814B7489003126D3118f86c2Ad1F42BE14F5aA2,0x93903df387B39d39844Dc35D50240Aac3AA774c3];
    ...
    * @notice randomly selects the diamond spots from chainlink oracle;
    ...
    function payment() external nonReentrant {
        ...
        require(address(this).balance >= (10 * 10 ** 8 / uint(_price)), "not enough balance");
