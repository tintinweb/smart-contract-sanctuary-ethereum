...
contract erc721aopensea is ERC721A, DefaultOperatorFilterer, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _baseTokenURI, string memory _placeholderURI) ERC721A("erc721a opensea", "YYY") {
