...
contract Confetti is ERC1155, ERC1155Supply, Ownable, ReentrancyGuard {
    ...
    mapping(Type => uint256) public maxSupplyForType;
    ...
    constructor(
        ...
        maxSupplyForType[Type.Sketch] = 1;
        maxSupplyForType[Type.Ruby9100M] = 1;
        maxSupplyForType[Type.BAFTA_Exclusive] = 20;
        maxSupplyForType[Type.Green] = 440;
        maxSupplyForType[Type.Yellow] = 440;
        maxSupplyForType[Type.Blue] = 440;
        maxSupplyForType[Type.Red] = 440;
        maxSupplyForType[Type.Pink] = 440;
    }
    ...
    function _pickRandomType(uint256 lastTokenType_) private returns (uint256) {
        ...
        if (totalSupply(tokenType) >= maxSupplyForType[t]) {
    ...
    function devMint(address recipient) external onlyOwner {
        ...
        amounts[0] = maxSupplyForType[Type.Sketch];
        amounts[1] = maxSupplyForType[Type.Ruby9100M];
        amounts[2] = maxSupplyForType[Type.BAFTA_Exclusive];
