...
contract RaffleFactory is Ownable {
    ...
    function setRNGesusContractAddress(address _rngesusContractAddress) public onlyOwner {
        
        rngesusContractAddress = _rngesusContractAddress;

    }

    function addPromotor(address _promotor) public onlyOwner {

        promotors[_promotor] = true;

    }

    function removePromotor(address _promotor) public onlyOwner {
