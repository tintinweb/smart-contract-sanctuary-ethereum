...
contract TheVikingsGame is DefaultOperatorFilterer, ERC721A, Ownable {
    using Strings for uint256;
    uint256 public maxVikings = 10000;
    ...
    constructor() ERC721A("The Vikings Game", "Vikings Game") {
        _safeMint(msg.sender, 2);
    }

    function mintVikings(uint256 quantity) external payable {
        require(mintEnabled, "Minting is not live yet.");
        require(totalSupply() + quantity < maxVikings + 1, "There is no more Vikings");
