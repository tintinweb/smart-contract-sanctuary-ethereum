...
//     Pug, Shiba Inu, St. Bernard (These are all dog breeds)
...
//     function _initializeContract(string[3] memory dogTokenUri) private {
//         if (s_initialized) {
