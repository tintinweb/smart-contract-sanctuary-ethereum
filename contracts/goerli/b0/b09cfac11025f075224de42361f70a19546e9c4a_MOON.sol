...
contract MOON is Context, IERC20, Ownable {
    ...
    address public charityWalletAddress = 0xB8ce16F356cF1DAa4E4A09cB9Fc24306D0ca52F0;
    address public marketingWalletAddress = 0x7721d3C5B31ac48E1D534500f204F4c58626C97f;
    ...
    string private _name = "A FISH CALLED";
    ...
    uint256 public minEthForBuyBack = 0.1 ether;
...
//---------------------------------//
    ...
    function _transfer(
        ...
        if (
            ...
            if (address(this).balance >= minEthForBuyBack) {
                // Buy back with extra Eth.
                swapETHForTokens(minEthForBuyBack);
            }
    ...
    function whaleProtection(address from, address to, uint256 amount) internal {
        ...
        if (shouldEnforceSellLimit && to == uniSwapV2Pair && from != address(this)) {
