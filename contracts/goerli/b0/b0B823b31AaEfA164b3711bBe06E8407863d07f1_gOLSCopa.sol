...
contract gOLSCopa is ERC721A, Ownable {
  using Address for address;
  using Strings for uint256;
  ...
  uint256 private _nftEtherValue = 0.0025 ether;
  ...
  constructor(
    ...
    function mint(
      ...
      require(_mintAmount + _freeMintAmountPerWallet[msg.sender] <= FreeMintPerAddressLimit, "Quantidade limite de mint free por carteira excedida.");
