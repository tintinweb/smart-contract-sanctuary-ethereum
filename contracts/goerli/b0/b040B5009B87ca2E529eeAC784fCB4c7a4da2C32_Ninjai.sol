...
contract Ninjai is ERC721AQueryable, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
  ...
  uint256 public maxCost = 0.01 ether;
  /** Price per token */
  uint256 public cost = 0.005 ether;
  /** Max free */
  uint256 public free = 400;
  /** Base URI */
  string public baseURI = "ipfs://QmcoH9an5mpiNymLfQzGky6dofiAiTvzRtn9XpEFzHAvqM/";
  /** Suffix URI */
  string private uriSuffix = ".json";
  /** Hidden Metadata Uri */
  string public hiddenMetadataUri = "ipfs://QmcoH9an5mpiNymLfQzGky6dofiAiTvzRtn9XpEFzHAvqM/1000.json";
  /** Reveal state */
  ...
  /// @param _state New presale state
  ...
  function preMint(uint256 _amt) external payable callerIsUser {
    ...
    if (free == 0) { presaleActive = false; saleActive = true; cost = maxCost; }
