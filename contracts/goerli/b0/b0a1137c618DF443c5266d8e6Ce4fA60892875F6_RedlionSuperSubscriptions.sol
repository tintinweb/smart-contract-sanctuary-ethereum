...
contract RedlionSuperSubscriptions is
  ERC721,
  ERC721Soulbound,
  Pausable,
  ISubscriptions,
  AccessControl
{
  ...
  string public baseURI = 'https://nft.redlion.news/subscription/super/';
  ...
  constructor(
    ...
    ERC721('Redlion Super Subscriptions', 'RLSSUB')
  ...
  function subscribe(address to) public onlyRole(MANAGER) whenNotPaused {
    require(index.current() < MAX_SUPPLY, 'MAX_SUPPLY_REACHED');
    require(
