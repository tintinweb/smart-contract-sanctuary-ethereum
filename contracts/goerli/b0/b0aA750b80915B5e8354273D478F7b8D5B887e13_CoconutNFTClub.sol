    ...
    ReentrancyGuard
{
    ...
    address public treasuryAddress = 0x583031D1113aD414F02576BD6afaBfb302140225; // TODO: add actual address
    ...
    constructor() ERC721A("CoconutNFTClub", "CNC") {
        ...
        whitelistSaleConfig = WhitelistSaleConfig({
            merkleRoot: 0x4788943e316c41e35040b281998d6ff0e9b9b436e0002983a89df19dad6839ce,
            startTime: 1669248000,
            price: 0.0001 ether,
            maxPerAddress: 2
        });
    }
