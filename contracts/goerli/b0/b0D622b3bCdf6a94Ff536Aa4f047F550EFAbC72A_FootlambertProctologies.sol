...
/**
 * @title FootlambertProctologies
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract FootlambertProctologies is ERC20Permit, ERC20FlashMint, Pausable {
    address private _owner;

    constructor() ERC20("Footlambert Proctologies","FOC")  ERC20Permit("Footlambert Proctologies") { 
        _owner = _msgSender();
     }
