...
contract SkyscraperERC721 is ERC721r, Ownable {
   ...
   modifier isAvailable(uint256 _quantity) {
      require(totalSupply() + _quantity <= MAX_SKYSCRAPER_SUPPLY, "Not enough tokens left for quantity");
      _;
   }
   ...
   function mintSpecific(uint _index) external onlyOwner {
      require(_index < 51, 'Index cannot be within rares or super rares');
