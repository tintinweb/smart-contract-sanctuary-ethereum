...
contract AccessManager is Ownable {
    ...
    /**
     * Only allow access from specified contracts
     */
    ...
    /**
     * Gets if the specified address has access
    ...
    /**
     * Enables access to the specified address
    ...
    /**
     * Disables access to the specified address
...
contract SmartTokenBRL is ERC20, Ownable, AccessManager {
    using SafeMath for uint256;

    constructor() public ERC20("Smart Token BRL", "BRLT") {}
    ...
    /**
     * Invest mints the funds on the _investor address
     */
    function invest(address _investor, uint256 _amount) public onlyAllowedAddress {
    ...
    /**
     * Failed sale is only called from failed sales
     */
