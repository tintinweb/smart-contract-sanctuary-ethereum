...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1677265200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1677267000;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xCA1EAf4c48dFD233029195316a94689C329f82c2];
  address public erc20Payable = 0xCA1EAf4c48dFD233029195316a94689C329f82c2;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.0049 ether;
  uint256 public earlyMintTokenIdCap = 3333;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifra3ekgprmcun3uxgtfeu3yqetw3h254ucstv5yboi2zyj3wuj3a/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/GFELqcGAzC3KppljhJSp/contract-metadata";
  }
...
// File: contracts/ClawToyzNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ClawToyzNftContract is ERC721APlus {
    constructor() ERC721APlus("ClawToyzNFT", "CTYZ"){}
}