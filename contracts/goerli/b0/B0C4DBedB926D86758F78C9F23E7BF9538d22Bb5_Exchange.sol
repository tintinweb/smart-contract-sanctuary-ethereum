...
contract Exchange is Ownable, ReentrancyGuard {
    ...
    // Variables
    address public feeAccount = 0xD2554B974389503C573BB0cAc9f5083f285a5A0f; // the account that receives exchange fees
    uint256 public feeNum = 10;
    uint256 public feeNativeNum = 10;
    uint256 public feeDen = 1000;
    uint256 public nativeTokenMin = 100000000000000000000;
    ...
    constructor(
        ...
        nativeTokenAddress = _natvieToken; //0xb6825d2e7b6520748c2b8a6509e5cd2cb16d4e74
    }
