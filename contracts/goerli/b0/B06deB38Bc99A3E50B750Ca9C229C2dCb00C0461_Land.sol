...
contract Land is ERC721Enumerable, Ownable {
    ...
    uint256 public immutable MAX_LANDS_WITH_FUTURE;
    uint256 public immutable MAX_ALPHA_NFT_AMOUNT;
    uint256 public immutable MAX_BETA_NFT_AMOUNT;
    uint256 public immutable MAX_PUBLIC_SALE_AMOUNT;
    uint256 public immutable RESERVED_CONTRIBUTORS_AMOUNT;
    ...
    event StartingIndexSetAlphaBeta(
        uint256 indexed _alphaOffset,
        uint256 indexed _betaOffset
    );

    event PublicSaleMint(
        address indexed sender,
        uint256 indexed numLands,
