...
contract EXODUS is ERC721Psi, ERC2981, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    bytes32 public dandyMerkleRoot = 0xadeb344bb15d33148f98b0832a9bfa15fc2fe22090aac29d53401a0ff2863ab2;//本番デプロイ時変更
    bool public revealed = false;
    string private _baseTokenURI = "https://arweave.net/Qdm47JmC-XDrY_05m290PBM5hbm9hYvItg7MlSZQHOA/";//本番デプロイ時内容削除
    string private hiddenUri = "https://arweave.net/B8fJtOKE_RvPkkrp8QMpFUmr5IL-wHYYeWtFqrluKik/hidden.json";
    ...
    function _preMintCheck(uint256 _quantity, uint256 _supply, uint256 _cost) private view {
        ...
        require(_quantity <= alMintLimit, "Mint quantity over");
        require(msg.value >= _cost, "Not enough funds");
    ...
    function _publicMintCheck(uint256 _quantity, uint256 _supply, uint256 _cost) private view {
        require(_supply + _quantity <= maxSupply, "Max supply over");
        require(_quantity <= publicMintLimit, "Mint quantity over");
        require(msg.value >= _cost, "Not enough funds");
    ...
    function _dandyMintCheck(uint256 _quantity,uint256 _supply,uint256 _cost) private view {
        require(_supply + _quantity <= maxSupply, "Max supply over");
        require(_quantity <= dandyMintLimit, "Mint quantity over");
        require(msg.value >= _cost, "Not enough funds");
