...
contract JoeBidenNFT is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmZ3XJJPkAFDZ4CieBxCmoYwqXQzrWdxj8gQoRBFj1QinH/";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 1111;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("JoeBidenNFT", "JB") {
        baseURI = initBaseURI;
