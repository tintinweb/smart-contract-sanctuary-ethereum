...
contract OnChainAlphaV2 is ERC721A, IERC721Receiver, Multicall, ReentrancyGuard, Ownable {
        ...
        returns (string memory)
    {
        ...
        bool trait11 = bytes(_traitDetails[11][HelperLib.parseInt(HelperLib._substring(_hash, 33, 36))].name).length > 2;
        bool trait12 = bytes(_traitDetails[12][HelperLib.parseInt(HelperLib._substring(_hash, 36, 39))].name).length > 2;
        bool trait13 = bytes(_traitDetails[13][HelperLib.parseInt(HelperLib._substring(_hash, 39, 42))].name).length > 2;
        bool trait14 = bytes(_traitDetails[14][HelperLib.parseInt(HelperLib._substring(_hash, 42, 45))].name).length > 2;
