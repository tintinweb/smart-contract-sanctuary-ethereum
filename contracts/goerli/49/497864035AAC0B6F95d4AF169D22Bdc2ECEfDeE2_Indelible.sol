// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Clothes", unicode"Headwear", unicode"Eyes", unicode"Base Character", unicode"background"];
        ...
        ContractData public contractData = ContractData(unicode"Sparroz", unicode"sparroz is cc0  and fully onchain collection of 5555 pixel birds. Our vision to provide attention towards the birds protection caused by human activities, The art was created by @Nickfnu where each traits has own eyesight..", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/c3b8f37e-7465-4c65-8497-c3ece1241cf3", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/c3b8f37e-7465-4c65-8497-c3ece1241cf3", "", 500, "0x07DB062BF908D39F10C25feA8Cc32FC654D882D1");

        constructor() ERC721A(unicode"Sparroz", unicode"Sprz") {
            TIERS[0] = [85,335,548,689,754,919,1092,1133];
            TIERS[1] = [38,62,98,107,109,120,174,175,181,249,326,334,388,602,638,665,1289];
            TIERS[2] = [336,2485,2734];
            TIERS[3] = [1587,1947,2021];
            TIERS[4] = [150,575,1027,1729,2074];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Sparroz #");
