...
contract SeaGoldTrade is Initializable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        address _ecoSystemFeesAuthority,
        ...
        ecoSystemFeesAuthority = _ecoSystemFeesAuthority;
    ...
    uint256 deci;
    address public ecoSystemFeesAuthority;
    ...
    function updateecoSystemFeesAuthority(address _ecoSystemFeesAuthority)
        public
        onlyOwner
    {
        ecoSystemFeesAuthority = _ecoSystemFeesAuthority;
    ...
    function setecoSystemFee(uint256 _ecoSystemFee) public {
        require(msg.sender == ecoSystemFeesAuthority, "Not a authorized person");
        ecoSystemFee = _ecoSystemFee * 1e18;
    }
    ...
    function updaterewardsContractAddress(address payable _rewardsContractAddress)
        public
        onlyOwner
    {
        rewardsContractAddress = _rewardsContractAddress;
    ...
    function acceptBId(
        ...
        (bool sent, ) = rewardsContractAddress.call{value: covertToken}("");
    ...
    function calculaterewardsBid(
        ...
        RewardsContract rewardsCont = RewardsContract(rewardsContractAddress);
