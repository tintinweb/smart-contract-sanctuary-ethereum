 ...
 * @author Aqualis, inspired by the OpenZeppelin Initializable contract
...
library BorrowLogic {
     ...
     * Aqualis protocol proportionally to their collateralization power. For isolated positions, it also increases the
     * isolated debt.
...
library SupplyLogic {
    ...
    /**
     * @notice Implements the supply feature. Through `supply()`, users supply assets to the Aqualis protocol.
     ...
     * previously supplied in the Aqualis protocol.
...
import {VersionedInitializable} from "../libraries/aqualis-upgradeability/VersionedInitializable.sol";
 ...
 * @title Pool contract
 * @author Aqualis
 * @notice Main point of interaction with an Aqualis protocol's market
 * - Users can:
 *   # Supply
 *   # Withdraw
 *   # Borrow
