...
contract Staker {
  ...
  function stake() public payable {
    require(msg.value > 0, "you didn't stake anything");
    // deadline = block.timestamp + 30 seconds;
    address staker = msg.sender;
    uint256 value = msg.value;
    balances[staker] += value;
    emit Stake(staker, value);
  }
  ...
  function execute() public notCompleted returns (uint256) {
  ...
  function withdraw() public notCompleted {
    ...
    uint256 withdrawValue = balances[msg.sender];
    balances[msg.sender] = 0;
    address(msg.sender).call{value: withdrawValue}('');
  }
}
