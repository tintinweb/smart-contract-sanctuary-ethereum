...
// , AragonApp 
{
    ...
    * @param _timestamp current timestamp off chain
    */
    function pushBeacon(uint256 _beaconValidators, uint256 _beaconBalance, uint256 _timestamp) external whenNotStopped {
        ...
        if (_beaconBalance > rewardBase) {
            ...
            getHelper().updateAPR(rewards, _timestamp);
        }
    }
...
interface IKiKiStakingHelper {
    ...
    function updateAPR(uint256 rewards, uint256 timestamp) external;
...
interface IKiKiStaking {
    ...
    /**
      ...
      * @param _timestamp current timestamp off chain
      */
    function pushBeacon(uint256 _beaconValidators, uint256 _beaconBalance, uint256 _timestamp) external;
