    ...
    EIP712
{
    ...
    address public adminAddress = 0xD27ceC2572D2f30BF8c076B504DCDf5Cd36c6BaF;
        ...
        returns(bool _whitelisted)
    {
          bytes32 hash = _hashTypedDataV4(keccak256(
                            abi.encode(
                                ...
                                keccak256(bytes("Signing this message will verify your address on WL")),
        ...
        return ECDSA.recover(hash, _signature) == adminAddress;
    }
    /**
    ...
    /**
     * @dev Burn an NFT
     * @param _tokenId The token Id to be burnt by owner
     */
