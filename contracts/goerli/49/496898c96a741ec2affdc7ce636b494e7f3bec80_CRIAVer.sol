...
contract CRIAVer is ERC4973 {
    ...
    event Verification(address wallet, string instagram, string linkedin, string facebook, uint256 idToken, string name);
    ...
    constructor () ERC4973("Criador Verificado", "CRIAVer", "CRIAVer") {
        owner = msg.sender;
        _contractUri = "https://ipfs.io/ipfs/QmTB7M8mBga1PB29wCPHNbnwAhAHgNWAmH2enRsqbYc9uR";
    ...
    function verifiedProfile(string memory uri, address payable endUser, string memory instagram, string memory linkedin, string memory facebook, string memory name) public {
        ...
        uris[Id] = uri;
        emit Verification(endUser, instagram, linkedin, facebook, Id, name);
    ...
    function _setTokenURI(uint256 tokenId, string memory uri, address payable endUser, string memory instagram, string memory linkedin, string memory facebook, string memory name) public {
        require(walletsOwner[msg.sender] == msg.sender, "Only wallets with permission");
    ...
    function getInfluencer(uint256 idStatus) public view returns (address, string memory, string memory, string memory, string memory) {
      return (hashToInfluencerChecked[idStatus].wallet, hashToInfluencerChecked[idStatus].instagram, hashToInfluencerChecked[idStatus].linkedin, hashToInfluencerChecked[idStatus].facebook, hashToInfluencerChecked[idStatus].name);
    }
