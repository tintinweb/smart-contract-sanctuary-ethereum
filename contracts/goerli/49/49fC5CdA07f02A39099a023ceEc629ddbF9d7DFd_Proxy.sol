...
contract Proxy {
    ...
    constructor(address _logic_contract, string memory _url, string memory _contractURI) {
       ...
       (bool success, ) = _logic_contract.delegatecall(abi.encodeWithSignature("initialize(string,string)", _url, _contractURI));
