...
contract MetaMorphic is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory _baseURI, address _admin, address _beneficiary) public initializer {
     ...
     */
    function setParams1(bytes32 _merkleRoot, uint256 _price, uint256 _startTime) public onlyAdmin {
     ...
     */
    function setParams2(bytes32 _merkleRoot, uint256 _price, uint256 _startTime) public onlyAdmin {
