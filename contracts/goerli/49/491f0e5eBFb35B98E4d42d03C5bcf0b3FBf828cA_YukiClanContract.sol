...
//
// __  __      __   _    ________          
// \ \/ /_  __/ /__(_)  / ____/ /___ _____ 
//  \  / / / / //_/ /  / /   / / __ `/ __ \
//  / / /_/ / ,< / /  / /___/ / /_/ / / / /
// /_/\__,_/_/|_/_/   \____/_/\__,_/_/ /_/ 
//                                         
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x8EFfc600875615176B62b7Ea8f28462895F202EB];
  address public erc20Payable = 0x8EFfc600875615176B62b7Ea8f28462895F202EB;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 960) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigtyqqjs43iwc3h2qqxx5vhywwjuuwahp2hqqtwrf3pfqlsmisisq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/x9aPseY603ghezmMqxxu/contract-metadata";
  }
...
// File: contracts/YukiClanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YukiClanContract is RamppERC721A {
    constructor() RamppERC721A("Yuki Clan", "YUKI"){}
}
