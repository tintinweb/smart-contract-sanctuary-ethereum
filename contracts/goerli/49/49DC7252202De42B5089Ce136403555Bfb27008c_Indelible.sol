...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    bytes32 private constant TIER_2_MERKLE_ROOT = 0x84059347a50f3c7fa911b027f31907809e5a535be506a93e23b686c6e1022798;
    ...
    string[] private layerNames = [unicode"4:20 Watch", unicode"Smoke", unicode"Hats", unicode"Headphones", unicode"Hair", unicode"Eyes", unicode"Mouth", unicode"Body", unicode"Type", unicode"Tag", unicode"Background"];
    bool private shouldWrapSVG = true;
    address private indelibleProContractAddress = 0xf3DAEb3772B00dFB3BBb1Ad4fB3494ea6b9Be4fE;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0x2c6baa6c944284569cf26d7486b835d3a3f9e523a9564ba8663b30c27ef69917;
    ...
    constructor() ERC721A(unicode"mfers OC", unicode"MFOC") {
        ...
        tiers[2] = [600,600,425,425,402,350,350,350,350,350,300,300,300,300,175,175,175,175,175,125,125,125,125,125,125,125,125,125,125,125,125];
        tiers[3] = [1300,1100,950,842,835,800,750,650,550];
        tiers[4] = [1504,730,685,590,550,518,500,500,450,400,400,325,325,300];
        tiers[5] = [1500,950,800,800,750,600,550,500,450,427,250,200];
        tiers[6] = [4000,2250,1527];
        tiers[7] = [1402,600,500,500,475,463,453,430,425,400,399,385,375,375,325,270];
        tiers[8] = [3750,3274,300,250,200,3];
        tiers[9] = [7777];
        tiers[10] = [1000,999,975,900,900,878,875,500,400,350];
