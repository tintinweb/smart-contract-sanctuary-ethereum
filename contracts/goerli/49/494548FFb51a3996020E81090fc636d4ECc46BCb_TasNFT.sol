...
Whitelist
{
    ...
    */
	...
	modifier checkSupply(uint256 _amount) {
		...
		require(_amount + totalSupply() <= (maxSupply - ownerReserve) + ownerMinted, "Sold out");
		_;
	}
    ...
    */
	function initialize(
		...
		WL.startTime = 1679377266; // 9 February 2023 5:00:00 PM GMT
		WL.endTime = WL.startTime + 3 hours;
		WL.buyLimit = 2;
