...
contract Prayer is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Royalty, Ownable {
    ...
    constructor() ERC721("Soul Scroll Test", "SOULT")  {
    ...
    function sonCreatePrayer(string memory prayerType, string memory prayer, string memory prayer2, string memory prayer3)
        public isInitiated(msg.sender) {
            // limit to 58 char
            require(sLen(prayerType) <= 14, "Type 14 character limit");
            require(sLen(prayer) <= 58 && sLen(prayer2) <= 58  && sLen(prayer3) <= 58 , "Line 58 character limit.");
    ...
    function createPrayer(string memory prayerType, string memory prayer1, string memory prayer2, string memory prayer3) internal {
        prayers[prayersLoaded].prayerType = prayerType;
        prayers[prayersLoaded].text = prayer1;
