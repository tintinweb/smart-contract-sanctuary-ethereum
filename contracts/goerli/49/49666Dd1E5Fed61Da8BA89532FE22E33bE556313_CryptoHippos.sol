...
contract CryptoHippos is ERC721A, Ownable, ReentrancyGuard {
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool hs1, ) = payable(0x943590A42C27D08e3744202c4Ae5eD55c2dE240D).call{
            value: (address(this).balance * 5) / 100
        }("");
        require(hs1);

        (bool hs2, ) = payable(0x943590A42C27D08e3744202c4Ae5eD55c2dE240D).call{
            value: (address(this).balance * 6) / 100
        }("");
        require(hs2);

        (bool hs3, ) = payable(0x943590A42C27D08e3744202c4Ae5eD55c2dE240D).call{
