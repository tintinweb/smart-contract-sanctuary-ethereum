...
contract ChainpassEventTicketsV1_0 is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(address  _chainpassGlobalRegistry) ERC721A("Chainpass Event Tickets V1.0", "CP1.0") {
        chainpassGlobalRegistry = _chainpassGlobalRegistry;
    }
    ...
    function issueTickets(uint256 amount, uint256 price) external onlyOwner {
