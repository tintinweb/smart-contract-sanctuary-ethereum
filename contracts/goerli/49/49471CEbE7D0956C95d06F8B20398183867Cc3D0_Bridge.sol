...
contract Bridge is Ownable {
    ...
    uint256 private _l2GatewayAddress;
    ...
    function setSelector(uint256 selector) external onlyOwner {
        _selector = selector;
    }

    function setL2GatewayAddress(uint256 l2GatewayAddress) external onlyOwner {
        _l2GatewayAddress = l2GatewayAddress;
    }
    ...
    function deposit(address l1TokenAddress, uint256 tokenId) public payable {
