...
contract SacrificedShibaCrypt is ERC20, Ownable {
    ...
    constructor() ERC20("Sacrificed ShibaCrypt", "xSCX") {
    	...
    	operationsWallet = address(0x05f9277806DaFCAe530154388Fd28DF10BdC1Be1); // set as operations wallet 
        buybackWallet = address(0x05f9277806DaFCAe530154388Fd28DF10BdC1Be1); // set as buyback wallet
    ...
    receive() external payable {
         ...
         //only the sacrifice contract can mint xSCX
