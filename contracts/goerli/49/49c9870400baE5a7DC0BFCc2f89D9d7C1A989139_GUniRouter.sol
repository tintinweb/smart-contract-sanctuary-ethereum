    ...
    OwnableUpgradeable
{
    ...
    {
        IERC20 token0 = pool.token0(); // get token0 from the vault
        IERC20 token1 = pool.token1(); // get token1 from the vault
    ...
    //     uint256 allowanceG = IERC20(address(pool)).allowance(
    //         receiver,
    //         _blacklistedRouter
    //     );
    //     require(
