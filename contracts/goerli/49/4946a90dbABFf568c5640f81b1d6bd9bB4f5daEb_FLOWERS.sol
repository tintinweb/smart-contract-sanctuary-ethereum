//SPDX-License-Identifier: ok ok ok i need the price to go up
 ...
 */
contract FLOWERS is IERC20 {
  using SafeMath for uint256;
  using SafeERC20 for FLOWERS;
  ...
  string public constant name = "flowers";
  string public constant symbol = "FLOWERS";
