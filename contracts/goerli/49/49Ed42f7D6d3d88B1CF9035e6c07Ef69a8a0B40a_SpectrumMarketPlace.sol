...
contract SpectrumMarketPlace is ERC1155Receiver, IERC721Receiver, ReentrancyGuard, Ownable {
    ...
    function createToken(string memory tokenURI) public returns (uint) {
        ...
        uint256 currentTokenId = mkNFT.create(msg.sender, _tokenIds.current(), 1, tokenURI, "");
