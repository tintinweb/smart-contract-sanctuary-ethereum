...
contract StonkInu is IERC20, Ownable {
    ...
    string constant _name = "Fuuuuuuuuuuuck";
    string constant _symbol = "Fuuuuuuuuuuuck";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100_000_000_0 * (10 ** _decimals);
    uint256 public _maxWalletAmount = (_totalSupply * 2) / 100; // 2% max wallet amount
    ...
    //Mapping for buyng with trade stopped
    mapping(address => bool) isStopExempt;

    uint256 liquidityFee = 0; // Auto liquidiy added & burned
    uint256 marketingFee = 40; // 4% of taxes. We'll stonk you with rewards and great marketing.
    ...
    constructor() Ownable(msg.sender) {
        ...
        isFeeExempt[0xe4A1CC608eE92e8a5eE9CC01D58526ba83f439a2] = true;
        //DEPLOYER CAN BUY WITH TRADING STOPPED
        isStopExempt[0xe4A1CC608eE92e8a5eE9CC01D58526ba83f439a2] = true;
        //UISWAP IS A TRUE STONKER
        isStopExempt[0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D] = true;
        //DEPLOYER DOES NOT HAVE TX LIMITS
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xe4A1CC608eE92e8a5eE9CC01D58526ba83f439a2] = true;
