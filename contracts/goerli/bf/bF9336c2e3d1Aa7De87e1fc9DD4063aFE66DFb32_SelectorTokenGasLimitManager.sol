    ...
    TokensBridgeLimits
{
    ...
    event AddMediatorBalance(address token, uint256 amount);
    ...
    function autoUpdateMediatorBalance(address _token) external onlyIfUpgradeabilityOwner {
        ...
        emit AddMediatorBalance(_token, diff);
    }
    ...
    function _prepareMessage(
        ...
        if (_nativeToken == address(0)) {
            ...
            require(isBridgedTokenDeployAcknowledged(_token), "Not registered to bridge");
...
contract TokenProxy is Proxy {
    ...
    constructor(
        ...
        symbol = _symbol;
        decimals = _decimals;
        owner = _owner; // _owner == HomeBrewlabsBridge/ForeignBrewlabsBridge mediator
