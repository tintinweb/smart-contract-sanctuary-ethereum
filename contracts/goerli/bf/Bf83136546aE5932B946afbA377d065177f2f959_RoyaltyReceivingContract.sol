...
contract RoyaltyReceivingContract {
    ...
    address WETH;
    address tokenToBuy;
    uint256 minWaitTime = 604800; //1 week in seconds
    ...
    function swapTokens() public {
        ...
        // Make sure the contract has enough Ether to cover the swap
        require(balance > 0, "Not enough Ether in contract");
