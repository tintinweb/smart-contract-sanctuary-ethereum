...
contract Exchange is Ownable{
    ...
    function cancelOrder(uint256 _id) public {
        ...
        tokenBalances[ETHER][msg.sender] = tokenBalances[ETHER][msg.sender].add(_order.feeEthAmount);
        tokenBalances[ETHER][feeAccount] = tokenBalances[ETHER][feeAccount].sub(_order.feeEthAmount);
