...
contract ARTECONFTUPGRADEABLEV2 is Initializable, ERC721EnumerableUpgradeable, ERC2981Upgradeable, OwnableUpgradeable {
    ...
    */
    ...
    function mintBySignature(bytes memory signature, uint256 tokenId) external payable {
        require(tokenIdToToken[tokenId].priceInWei > 0, "NFT has not been initialized");
        require(msg.value > tokenIdToToken[tokenId].priceInWei, "eth value too low for mint");
    ...
    function withdrawTo(address _address) external {
        ...
        require(withdrawalAmount > 0, "ARTECONFTV2: nothing to withdraw");
        withdrawal_AddressToAmount[_address] = 0;
        (bool success, ) = payable(_address).call{value: withdrawalAmount}("");
        require(success, "ARTECONFTV2: Failed to send Ether");
    }
}
