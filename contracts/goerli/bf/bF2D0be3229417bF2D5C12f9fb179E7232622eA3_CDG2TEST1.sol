...
/**
 * Plain, basic ERC721 for Goerli deploy.
 * CDG2TEST1
 */
...
contract CDG2TEST1 is Ownable, ERC721Enumerable, PaymentSplitter {

    uint public maxSupply  = 10000;       // unchangeable in this test
    uint public mintPrice  = 0.001 ether; // Test price
    ...
    function setBaseURI(string memory _newURI) external minAdmin1 {
        metadataURI = _newURI;
    }
    ...
    function releaseShares() external onlyOwner {
