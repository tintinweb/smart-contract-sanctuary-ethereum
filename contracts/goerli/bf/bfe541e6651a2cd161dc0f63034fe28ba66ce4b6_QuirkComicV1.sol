...
// File contracts/QuirkComicV1.sol
...
contract QuirkComicV1 is Ownable, ERC721, ReentrancyGuard {
    ...
    function withdraw() public payable onlyOwner {
        ...
        require(team3tx, "QuirkComicV1: Transfer 3 Failed");

        (bool team2tx, ) = payable(TEAM2).call{value: (_balance * 45) / 100}(
            ""
        );
        require(team2tx, "QuirkComicV1: Transfer 2 Failed");

        (bool team1tx, ) = payable(TEAM1).call{value: address(this).balance}(
            ""
        );
        require(team1tx, "QuirkComicV1: Transfer 1 Failed");
    }
...
// File contracts/FlattenQuirkComicV1.sol