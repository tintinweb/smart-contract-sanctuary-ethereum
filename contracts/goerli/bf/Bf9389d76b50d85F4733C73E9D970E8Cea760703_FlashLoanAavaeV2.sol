...
contract FlashLoanAavaeV2 is FlashLoanReceiverBase {
  ...
  function myFlashLoanCall() public {
        ...
        assets[0] = address(0xFFC97d72E13E01096502Cb8Eb52dEe56f74DAD7B); // Kovan AAVE
        assets[1] = address(0x05Ec93c0365baAeAbF7AefFb0972ea7ECdD39CF1); // Kovan BAT
        assets[2] = address(0x028171bCA77440897B824Ca71D1c56caC55b68A3); // Kovan DAI
        assets[3] = address(0xd109b2A304587569c84308c55465cd9fF0317bFB); // Kovan UNI
        assets[4] = address(0xb7c325266ec274fEb1354021D27FA3E3379D840d); // Kovan YFI
        assets[5] = address(0x5165d24277cD063F5ac44Efd447B27025e888f37); // Kovan LINK
        assets[6] = address(0x35f6B052C598d933D69A4EEC4D04c73A191fE6c2); // Kovan SNX
