...
import './AZooOfNoosBase.sol';
import './AZooOfNoosSplitsAndRoyalties.sol';

/**
 * @title AZooOfNoos
 */
contract AZooOfNoos is AZooOfNoosSplitsAndRoyalties, AZooOfNoosBase {
    constructor()
        AZooOfNoosBase(
            'AZooOfNoos',
            'AZON',
            'https://nftculture.mypinata.cloud/ipfs/Qmc92iFcDJMcEL4beyzBJBrbJ1TehqCMr2Hk4AoZyCNnxm/', // TODO: NFTCReference721-rinkeby-Metadata_V1
            addresses,
            splits,
            0 ether,
            0 ether,
...
// NFTC Open Source Contracts See: https://github.com/NFTCulture/nftc-open-contracts
import '@nftculture/nftc-contracts/contracts/security/GuardedAgainstContracts.sol';
    ...
    PhaseTwoIsTiered
{
    ...
    uint256 private constant PHASE_ONE_PURCHASE_LIMIT = 25;
    uint256 private constant PHASE_ONE_SUPPLY_CAP = 200;

    uint256 private constant PHASE_TWO_BATCH_SIZE = 25;
    uint256 private constant PHASE_TWO_PURCHASE_LIMIT = 25;
    uint256 private constant PHASE_TWO_SUPPLY_CAP = 200;

    uint256 private constant PUBLIC_MINT_BATCH_SIZE = 25;
    uint256 private constant PUBLIC_MINT_PURCHASE_LIMIT = 200; // Not Used
    uint256 private constant PUBLIC_MINT_SUPPLY_CAP = 200;
...
contract AZooOfNoosSplitsAndRoyalties is ERC2981 {
