...
contract Middleground is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("Middleground", "MDG") {
  ...
  uint256 public constant MAX_MULTIMINT = 9;
  ...
  function mint(uint256[] calldata ids) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 9 at a time");
