 ...
 * @notice This contract handles minting 12-8-22 lew 1155 MEGA tokens.
 */
contract _12822Lew1155MEGA is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x4e1BDBB65426e0AAc48Fd3C52883d26B0F40e46D;
    ...
    string public name = "12-8-22 lew 1155 MEGA";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeidowuxvk5oyed3w2zaisnutkermenwk5qasd6fgpurosjfcu2z4ju/{id}"
        )
    {
        ...
        tokenPublicSaleStartTime[2] = 1670389200;
        tokenPublicSaleEndTime[2] = 1670711400;
        tokenUsePublicSaleTimes[2] = true;
        tokenMaxSupply[3] = 100;
        tokenPublicPrice[3] = 0 ether;
        tokenPublicMintsPerAddress[3] = 10;
        tokenPresaleMaxSupply[3] = 50;
        tokenPresalePrice[3] = 0 ether;
        tokenPresaleMintsPerAddress[3] = 5;
        tokenPresaleSaleStartTime[3] = 1670630400;
        tokenPresaleSaleEndTime[3] = 1671226200;
        tokenUsePresaleTimes[3] = true;
        tokenURI[
            1000000
        ] = "ipfs://bafybeic6plxdvswmb7g4u23uj3zngmfcomah66s3jf443gzgo2niyxfy5y/nezuko-custom.json";
        tokenPublicPrice[1000000] = 0 ether;
        tokenPublicMintsPerAddress[1000000] = 0;
        require(
