...
contract OasisXLaunchFactory is Ownable, ReentrancyGuard {
    ...
    function create1155(bytes memory data) external payable nonReentrant {
        ...
        // IOasisXNFT1155(identicalChild).setProtocolParams();
     ...
     **/
    function changeCloneAccess() public onlyOwner {
        payableEntry = !payableEntry;
    }

    /**
     * @notice Returns the clone payment method
     **/
    function getAccessMethod() public view returns (bool) {
        return payableEntry;
    }
