    ...
    ReentrancyGuard
{
    ...
    address public treasuryAddress = 0xb032a61039d448e1679eB5f04c900627E74E4725; // TODO: goerli: 0xb032a61039d448e1679eB5f04c900627E74E4725, mainnet: ??
    ...
    string private _contractURI =
        "ipfs://QmSaJ97t8BzaZTwiiJNEWRZtafhib1HPNMtgLwhAfUDdGK/contracts/contract_uri"; // TODO: change contract image ? recipient ?
    string private _defaultTokenURI =
        "ipfs://Qmd2jV7VpEiH32ktRxtHXeSpzsjTKrNM5diYAFwQFkHMBe";

    constructor() ERC721A("CoconutNFTClub", "CNC") {
        // init configs
        publicSaleConfig = PublicSaleConfig({
            startTime: 1669370400, // TODO: 04/12/2022 1201
            price: 0.001 ether // TODO:0.18 ether
        });
        whitelistSaleConfig = WhitelistSaleConfig({
            merkleRoot: 0x4788943e316c41e35040b281998d6ff0e9b9b436e0002983a89df19dad6839ce, // TODO: change to actual root
            startTime: 1669248000, // TODO: 02/12/2022 1201am
            price: 0.0001 ether, // TODO: 0.15 ether
            maxPerAddress: 3
        });
    }
