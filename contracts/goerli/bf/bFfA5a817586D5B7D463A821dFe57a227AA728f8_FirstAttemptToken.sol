...
contract FirstAttemptToken is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("FirstAttemptToken", "FATK")
  {
    customBaseURI = customBaseURI_;

    allowedMintCountMap[owner()] = 10;
  }
