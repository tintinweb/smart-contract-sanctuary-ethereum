...
contract CandyRepublic is ERC721SeaDrop {
    ...
    bytes32 private _WHITELIST_A_ROOT =
        0x00e8e92031a3ebb515ac5cc188d169f561c00232a10c64c4101ea8dbcfaf6751;

    // The merkle tree root hash for the whitelistB addresses.
    bytes32 private _WHITELIST_B_ROOT =
        0xaf7f27a81fe9f7e5a51250d23b12306d01061a9a833c24723e1988f0fbecd23e;
    ...
    uint256[5] public unburnable;

    // For public mint
    mapping(address => bool) public didMintPublic;
        ...
        external
    {
        ...
        require(
            (2 * genesisLength) + currentSupply <= _TOTAL_SUPPLY,
            "Exceeding Limit!"
        );
    ...
    function publicMint(uint256 quantity) external payable {
        ...
        // Mint once!
        require(!didMintPublic[msg.sender], "Already minted public mint!");
    ...
    function enableBurn(uint256[5] calldata unburnables) external onlyOwner {
    ...
    function burn(uint256 tokenID) external {
        ...
        for (uint256 i; i < 5; ) {
            require(tokenID != unburnable[i], "Can't burn!");
            unchecked {
                ++i;
            }
        }
...
contract TestingContract is ERC721SeaDrop {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    // The Genesis NFT Collection smart contract address
    address private constant _GENESIS_COLLECTION_ADDRESS =
        0x748Dc6d68512d444dd9346A99f5f72f4788672F4;
    ...
    // NFT sale window
    uint256 private constant _MINT_START = 1677158100;

    // Genesis + Derivative = OG_WINDOW
    uint256 private constant _OG_WINDOW_START = _MINT_START;
    uint256 private constant _OG_WINDOW_END = _OG_WINDOW_START + 10 minutes;

    // Prospects + Whitelist A = WHITELIST_WINDOW
    uint256 private constant _WHITELIST_WINDOW_START = _MINT_START + 5 minutes;
    uint256 private constant _WHITELIST_WINDOW_END =
        _WHITELIST_WINDOW_START + 5 minutes;

    // Whitelist B = FINAL_WINDOW
    uint256 private constant _FINAL_WINDOW_START = _WHITELIST_WINDOW_END;
    uint256 private constant _FINAL_WINDOW_END =
        _FINAL_WINDOW_START + 5 minutes;
    ...
    // The maxmimum mint/wallet
    uint256 private constant _MINT_PRICE = 0.0008 ether;
    uint256 private constant _MINT_PRICE_PROSPECT = 0.0007 ether;
    uint256 private constant _MINT_CAP = 20;
    uint256 private constant _DERIVATIVES_FREE_MINT_CAP = 1;
    uint256 private constant _PUBLIC_MINT_CAP = 1;
    uint256 private constant _GENESIS_BITMAP_LENGTH = 2;
    ...
    // The merkle tree root hash for the whitelistA addresses.
    bytes32 private _WHITELIST_A_ROOT =
        0xeb8bdf29ae8d9db4818f61e1e161a495743c573b0e20118d334a17751970422e;

    // The merkle tree root hash for the whitelistB addresses.
    bytes32 private _WHITELIST_B_ROOT =
        0x2f4d7943c3b12b3eeda0428749a522d8e2fa153f54c4ce1971b20f45c46855a4;
...
import { TwoStepAdministered } from "lib/utility-contracts/src/TwoStepAdministered.sol";
