...
contract Firefly is Context, IERC20, Ownable {
    ...
    address public marketingWallet = address(0x760c5A41b67BE0b8E208Da61c9654d5aad1e92f2);
	address constant burnWallet = address(0x000000000000000000000000000000000000dEaD);
	address private USDC = address(0xD87Ba7A50B2E7E660f678A895E4B72E7CB4CCd9C);
    ...
    string private _symbol = "FIREFLY";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
		...
		else
		{
			...
			if(USDCRequired >= 20000 * 10**18)
			{
			    applyBuyFeeTierThree();
			}
			else if(USDCRequired >= 10000 * 10**18)
			{
			    applyBuyFeeTierTwo();
			}
			else
