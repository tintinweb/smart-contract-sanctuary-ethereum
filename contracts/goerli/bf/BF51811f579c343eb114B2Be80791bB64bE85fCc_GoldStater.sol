...
contract GoldStater is ERC20CappedUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function approve(address spender, uint256 amount)
        ...
        returns (bool)
    {
        require(!(amount != 0 && allowance(msg.sender, spender) != 0), "Allowance already approved");
    ...
    function isAddressFrozen(address accountAddress) view public returns(bool) {
        return _frozen[accountAddress];
    }
