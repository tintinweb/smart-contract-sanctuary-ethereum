...
contract CrimeCashTest is ERC20 {
...
//   address constant usdc = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
  address usdc_ccash_lp = 0x0A518f171ADeDb4f700b86BF33BeF9dc1f49EA1F;

  IUniswapV2Router02 public uniswapV2Router;
  address public uniswapV2Pair;

  constructor (Storage storage_, address routerAddress, address _usdc, address owner) public {
  ...
  function transferFrom(address from, address to, uint256 amount) public override returns (bool) {
    // uint256 _amount = _partialAddToLiquidity(from, to, amount);
    // console.log("OLD AMOUNT: ", amount);
    // console.log("NEW AMOUNT: ", _amount);

    // _transfer(from, to, _amount);
    // console.log("BALANCE SENDER: ", balanceOf(from));

    // console.log("TRANFERED!!!!");
    // console.log("ALLOWANCE OF ROUTER", allowance(from, _msgSender()));

    // _approve(from, _msgSender(), allowance(from, _msgSender()).sub(_amount, "ERC20: transfer amount exceeds allowance"));
    ...
    // return true;    
    return super.transferFrom(from, to, _partialAddToLiquidity(from, to, amount));
  }
  ...
  function swapAndLiquify(uint256 amountToLiquify, address from) private lockTheSwap {
