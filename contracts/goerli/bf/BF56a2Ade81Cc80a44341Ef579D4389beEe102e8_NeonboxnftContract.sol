...
//*********************************************************************//
//
//     _   ____________  _   __   ____  ____ _  __    _   ______________
//    / | / / ____/ __ \/ | / /  / __ )/ __ \ |/ /   / | / / ____/_  __/
//   /  |/ / __/ / / / /  |/ /  / __  / / / /   /   /  |/ / /_    / /   
//  / /|  / /___/ /_/ / /|  /  / /_/ / /_/ /   |   / /|  / __/   / /    
// /_/ |_/_____/\____/_/ |_/  /_____/\____/_/|_|  /_/ |_/_/     /_/     
//                                                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1661446800;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xF6B8834d4421BC990D0199f9506794BA5Bad5cB4];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xF6B8834d4421BC990D0199f9506794BA5Bad5cB4;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiepz5anxddwa5hpbedtpw5r5ejb6xqq2gepfdp24vz62ndq6biya4/";
...
// File: contracts/NeonboxnftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NeonboxnftContract is RamppERC721A {
    constructor() RamppERC721A("NEON BOX NFT", "NEON"){}
}
