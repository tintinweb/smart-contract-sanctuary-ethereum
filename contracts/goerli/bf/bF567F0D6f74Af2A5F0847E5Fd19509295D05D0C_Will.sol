...
*/
contract Will is AccessControl, ReentrancyGuard,Initializable{
...
*/
     ...
     */
     /**Initializer */
     function initialize(address payable _testator, address payable _executor, uint256 _waitTime) public initializer{
