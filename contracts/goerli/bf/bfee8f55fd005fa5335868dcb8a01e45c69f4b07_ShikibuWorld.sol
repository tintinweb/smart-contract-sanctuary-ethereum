...
//        _safeMint(CONTRIBUTOR_ADDRESS_5,RewardManages[CONTRIBUTOR_ADDRESS_5].rewardAmmount);
    ...
    function publicsaleMint(
        ...
        // 総ミント数上限チェック
        require(
            publicsaleMintCount[msg.sender] + _mintAmount <= maxPublicMintAmount,
    ...
    function setMaxPublicMintAmount(uint256 _value) public onlyAdmin {
        maxPublicMintAmount = _value;
    }
...
//                                           CONTRIBUTOR_ADDRESS_5,
    ...
    function getPublicsaleMintCount(address _address)
        external
        view
        returns (uint256)
    {
        return publicsaleMintCount[_address];
    }
