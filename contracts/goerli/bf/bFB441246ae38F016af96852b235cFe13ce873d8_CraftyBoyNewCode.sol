...
// File: contracts/CraftyBoyNewCode.sol
...
contract CraftyBoyNewCode is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("CraftyBoyNewCode", "CFTY") {
    ...
    function withdrawDks(address _addr) external onlyOwner {
