...
contract Shardwallet is ERC721, IShardwallet, Initializable, Ownable {
...
interface IShardwallet is IERC721 {
    ...
    /// Initializes the shardwallet, allocating the full genesis shard to the
    /// given owner. This can only be called once.
