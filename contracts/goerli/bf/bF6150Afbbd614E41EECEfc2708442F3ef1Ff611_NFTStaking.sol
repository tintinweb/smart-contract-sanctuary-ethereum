 ...
 * These NFTs are stakable and generate LBSKR yield. LBSKR is the best crypto currenct there is!!
 *
 ...
 * Tokenomics:
 *
 * LBSKR yield rewards: 5555 LBSKR per hour divided among all stakers proportionally
 *
 */
        ...
        for (uint256 i; i < stakersArray.length; ++i) {
            ...
            for (uint256 j; j < stakesMeta.stakes.length; ++j) {
                stakesMeta.stakes[j].unclaimedRewards +=
                    ...
                    countOfStakes /
                    3600;
                unclaimedRewardsSum += stakesMeta.stakes[j].unclaimedRewards;
            }
