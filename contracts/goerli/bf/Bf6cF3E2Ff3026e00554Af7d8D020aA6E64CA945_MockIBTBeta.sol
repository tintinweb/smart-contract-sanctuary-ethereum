 ...
 * _Available since v4.7._
 */
abstract contract SpectraERC4626Upgradeable is
    Initializable,
    ERC20Upgradeable,
    IERC4626Upgradeable
{
...
interface IMockToken is IERC20Upgradeable {
...
contract MockIBTBeta is
    ERC20Upgradeable,
    SpectraERC4626Upgradeable,
    Ownable2StepUpgradeable
{
    ...
    function withdraw(
        ...
        address receiver,
        address owner
    ) public override(IERC4626Upgradeable) returns (uint256 shares) {
        if (msg.sender != owner) {
    ...
    function updatePricePerFullShare() public {
        if (totalSupply() == 0) {
            ...
            pricePerFullShare =
                (underlying.balanceOf(address(this)) * IBT_UNIT) /
                totalSupply();
            return;
        }
    }
