...
contract testDOGENSTEIN is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x751bb6541dC75A3fb6b4633572cD9920dbB11b0A);
    address payable public teamWallet = payable(0xAf324019Ca08b2573a6F7DA270dAeaD209a83A12);
    ...
    constructor() ERC20("testDogeXFrankenstein", "tDOGENSTEIN") {
