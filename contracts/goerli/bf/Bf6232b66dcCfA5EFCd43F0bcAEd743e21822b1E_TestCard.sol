 ...
 * @notice TestCard
 */
contract TestCard is Ownable, ERC721Enumerable {
    using Strings for uint256;
    ...
    string public uriPrefix = "https://airxroom.herokuapp.com/api/token/";
    string public uriSuffix = "";
    string public hiddenMetadataUri;

    /// Price is 0.05 wETH in polygon
    uint256 public price = 0.05 ether;
    uint256 public maxPerTx = 11;

    constructor() ERC721("Test Cards", "TCC") {
        setHiddenMetadataUri(
            "ipfs://QmWikVGbrLmzQySRhS7zJci9yy9f2ENvWUwHjJu6XQoqRr/hidden.json"
        );
    }
