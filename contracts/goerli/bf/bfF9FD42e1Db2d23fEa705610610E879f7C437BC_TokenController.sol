...
contract TokenController is Ownable, ITokenController {
    bool transferEnabled = true;

    function setTransferEnabled(bool isEnabled) onlyOwner public {
        transferEnabled = isEnabled;
    }
...
contract MiniMeToken is Ownable, Controlled {
