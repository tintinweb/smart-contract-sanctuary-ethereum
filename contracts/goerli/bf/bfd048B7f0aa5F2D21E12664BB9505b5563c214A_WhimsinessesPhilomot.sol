...
/**
 * @title WhimsinessesPhilomot
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract WhimsinessesPhilomot is Pausable, ERC20Permit {
    address private _owner;

    constructor() ERC20("Whimsinesses Philomot","WHLT")  ERC20Permit("Whimsinesses Philomot") { 
        _owner = _msgSender();
     }
