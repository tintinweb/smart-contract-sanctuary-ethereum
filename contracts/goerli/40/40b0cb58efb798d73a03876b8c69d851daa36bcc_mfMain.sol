...
contract mfMain is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public DAILY_BASE_FEWL_RATE = 228 * 5 ether;
    uint256 public DAILY_TIER1_FEWL_RATE = 228 * 10 ether;
    uint256 public DAILY_TIER2_FEWL_RATE = 228 * 20 ether;
    uint256 public BONUS_FEWL_AMOUNT = 200 ether;

    // Time that must pass before a Locked Nft can receive bonus FEWL amount
    uint256 public MINIMUM_DAYS_TO_BONUS = 20 * 60;       
