...
contract BlockchainBillboard is ERC721, ReentrancyGuard, Ownable, Pausable {
  ...
  function mint(
    ...
    if (owner() != msg.sender) {
      require(msg.value >= feeAmount, "Insufficiant funds");
    }
    ...
    require(verifySignature(tokenId, cid, signature), "Invalid signature");
  ...
  function verifySignature(
    ...
    bytes32 payloadHash = keccak256(abi.encode(tokenId, cid));
