...
contract Swap is ReentrancyGuard {
    ...
    uint24 public poolFee = ConfigurationParam.POOLFEE;
    event Log(
        string funName,
        address from,
        address to,
    ...
    function swapExactInputSingle(
        ...
        require(amountIn > 0, "Value Anomaly");
    ...
    function swapExactOutputSingle(
        ...
        require(amountOut > 0, "Value Anomaly");
        require(amountInMaximum > 0, "Value Anomaly");
        TransferHelper.safeTransferFrom(
            tokenIn,
            msg.sender,
            address(this),
