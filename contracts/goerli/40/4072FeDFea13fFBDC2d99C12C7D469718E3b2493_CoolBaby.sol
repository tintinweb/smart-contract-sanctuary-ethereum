...
contract CoolBaby is ERC721AQueryable, Ownable, ReentrancyGuard {
...
function mint(uint256 _mintAmount, uint256 count ) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
       require(!paused, 'The contract is paused!');
        //uint256 cost = price;
