...
//Abdulkader Hajjouz         [email protected]
...
contract Payment {
    ...
    function setDue(address walletAddress) internal {
        ...
        uint fiveMinuteIncrements = timespanMinutes / 3;  //نتبه
    ...
    function makePayment(address walletAddress, uint amount) public isSlotTenant(walletAddress) {
        require(SlotTenants[walletAddress].due > 0, "You do not have anything due at this time.");  //دقق اكبر من الصفر فقط
