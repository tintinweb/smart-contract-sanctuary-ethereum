...
contract GrowmotionNFT is ERC721MaxSupplyBurnable, CouponWhitelist, AccessControl {
  ...
  constructor(
    ...
    ERC721MaxSupplyBurnable("GrowmotionNFT", "GM", 10000, "https://growmotion.cojodi.com/meta/")
  ...
  function burnAdmin(uint256 tokenId_) external onlyRole(ADMIN_ROLE) {
  ...
  function supportsInterface(
    bytes4 interfaceId
  ) public view virtual override(ERC721MaxSupplyBurnable, AccessControl) returns (bool) {
    return
      ERC721MaxSupplyBurnable.supportsInterface(interfaceId) ||
