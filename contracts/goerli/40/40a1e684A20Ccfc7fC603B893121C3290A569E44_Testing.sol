...
contract Testing is
    ...
    ERC721AOpensea
{
    uint256 public constant MAX_SUPPLY = 2003;
    uint256 public constant MAX_PUBLIC_MINT = 0;
    ...
    /**
     * @dev sets the PRICE_PER_TOKEN
     * @param PRICE_PER_TOKEN_ the PRICE_PER_TOKEN
     */
    function setPricePerToken(uint256 PRICE_PER_TOKEN_)
        external
        onlyRole(SUPPORT_ROLE)
    {
