...
contract GenericBridgeFacet is ILiFi {
    ...
    function startBridgeTokensGeneric(LiFiData memory _lifiData, BridgeData memory _bridgeData) public payable {
        ...
        if (sendingAssetId == address(0)) require(msg.value == _bridgeData.amount, "ERR_INVALID_AMOUNT");
        else {
            ...
            require(
                LibAsset.getOwnBalance(sendingAssetId) - _sendingAssetIdBalance == _bridgeData.amount,
                "ERR_INVALID_AMOUNT"
            );
        }
