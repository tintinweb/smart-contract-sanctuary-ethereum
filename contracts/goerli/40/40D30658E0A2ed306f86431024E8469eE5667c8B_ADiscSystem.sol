...
contract ADiscSystem is ERC721, ReentrancyGuard, Ownable {
  ...
  string[] private PALETTES = [
    ...
    "818596-17171b-89b8c2-84a0c6-c6c8d1",
  ...
  string[] private SHAPES = ["circle", "square"];

  bool public isOnSale;
  bool public isMetadataFrozen;
  mapping(uint256 => Params) public tokenIdToParams;
  ...
  function setImage(uint256 tokenId, string memory image) external {
    ...
    tokenIdToParams[tokenId].image = image;
  }
  ...
  function mintAndTransfer(address to, uint256 quantity) internal {
    ...
    for (uint256 i = 0; i < quantity; i++) {
      ...
      Params memory params = _generateParams(hash);
      tokenIdToParams[tokenId] = params;
  ...
  function _generateParams(bytes32 hash) internal view returns (Params memory) {
    ...
    return
      Params(hash, palette, "", shape, speed, size, weight, offset, dynamic);
  }
}
