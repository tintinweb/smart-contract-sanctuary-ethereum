 ...
 */
interface IBURGER {
  function burnBurger(address operator, uint256 quantity) external;
}
...
contract PhysicalBull is Ownable {
  ...
  /// contract instances ///
  IERC20 public erc20;
  IBURGER public immutable Burger;
  ...
  uint256 public erc20Cost = 5000000; // 5.000000 $USDC
  ...
  function claimBulls(uint256 quantity) public {
    ...
    if (Astro.groupBalances(1, msg.sender) == 0) {
    ...
    Burger.burnBurger(msg.sender, burnScalar * quantity);
