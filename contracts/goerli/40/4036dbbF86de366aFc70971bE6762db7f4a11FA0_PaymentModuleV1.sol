    ...
    function processFee(
        ...
        if (usdtAmount > 0) {
            ...
            if (msg.value > 0) {
                ...
                path[1] = address(USDT);
                routerForFloki.swapExactETHForTokens{ value: msg.value }(0, path, address(this), block.timestamp);
