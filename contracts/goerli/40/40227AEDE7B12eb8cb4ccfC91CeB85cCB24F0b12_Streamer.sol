...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
        require(balances[msg.sender]==0, "Address has already a running channel");
    ...
    function withdrawEarnings(Voucher calldata voucher) public onlyOwner {
        ...
        */
        ...
        require(balances[signer] > voucher.updatedBalance, "Signer has no running channel");
        uint256 payment = balances[signer] - voucher.updatedBalance;
        balances[signer] -= payment;
        (bool sent, bytes memory data) = payable(owner()).call{value: payment}("");
    ...
    */
    function defundChannel() public {
        ...
        require(canCloseAt[msg.sender] < block.timestamp, "There is still time left for the channel to be able to be closed.");
