...
contract DeathClock is EIP712, ERC721r, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    IDeathClockDescriptor private _descriptor;
    ...
    constructor(address deathWishSigner, address _descriptorAddress)
        ERC721r('Death Clock', 'DEATH', 500)
    ...
    function mintDeathClock(
        ...
        updateDates[tokenId] = block.timestamp;
    }
    ...
    //     updateDates[deathExtension.tokenId] = block.timestamp;
    //     fds[deathExtension.tokenId] = _msgSender();
        ...
        returns (uint256)
    {
        ...
        fds[deathClockTokenId] = _msgSender();
        ...
        returns (string memory)
    {
        ...
        return
            _descriptor.generateMetadataJSON(
...
contract ERC721r is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _mintIdWithoutBalanceUpdate(address to, uint256 tokenId) private {
        ...
        console.log('_mintIdWithoutBalanceUpdate', to, tokenId);
    ...
    function _safeMint(address to, uint256 tokenId) internal virtual {
        ...
        console.log('_safeMint', to, tokenId);
        _mintIdWithoutBalanceUpdate(to, tokenId);
        _balances[to] += 1;
    }
