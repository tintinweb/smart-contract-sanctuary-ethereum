...
contract Escrow is Ownable, ReentrancyGuard {
    ...
    function test(MintLicense memory _params) external view returns (
        bytes memory _hash,
        bytes32 _encoded,
        address _signer,
        bool _isEq
        ...
        _encoded = _hash.toEthSignedMessageHash();
        _signer = _encoded.recover(_params.signature);
        _isEq = signer == _signer;
    }
