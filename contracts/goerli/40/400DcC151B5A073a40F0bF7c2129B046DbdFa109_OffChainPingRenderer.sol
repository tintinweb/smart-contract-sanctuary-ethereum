...
contract OffChainPingRenderer is IPingRenderer, Ownable
{
    address public _paramsAddr;
    //fixme set base location
//    string public _artBaseURI = "https://ipfs.io/ipfs/QmbFDGZatLBiEEWXGAf9ojRW4wkGD92NYFANxR15UP2Zj1";
    string public _artBaseURI = "https://skies.wtf/ipfs/QmUQnPu8ZqZrjNZ5tXEYHr6qz1KnezXzdHFmGVcLLAguhD_v3";
        ...
        returns(string memory)
    {
        ...
        string memory paramsSequence = Base64.encode(bytes(
            pingParams.getParmsSequence(tokenId, atts, isSample)
        ));

        return string.concat(_artBaseURI, "?enc=1&tp=", paramsSequence);
    }
