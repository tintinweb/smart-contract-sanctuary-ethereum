...
contract PepesDog is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Pepesdog";
    ...
    address payable private _developmentAddress = payable(0xCfe2E50476470B7233d0D8347739B991Fc7DDc03);
    address payable private _marketingAddress = payable(0xCfe2E50476470B7233d0D8347739B991Fc7DDc03);
