...
interface ITokenVault {
     ...
     * @param depositor Address who pays for the tokens
     * @param depositReceiver Address who want to receive tokens on the ETH chain
     ...
     * @param rootToken Token on ETH chain that is withdrawn
