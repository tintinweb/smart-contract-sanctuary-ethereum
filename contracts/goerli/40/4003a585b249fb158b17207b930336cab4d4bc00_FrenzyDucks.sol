...
contract FrenzyDucks is ERC721Enumerable, Ownable, ERC2981Royalties {
    ...
    string baseURI;
    uint public MAX_FRENZYDUCKS = 5100;
    uint public MAX_SALE = 5;
    uint public MAX_PER_WALET = 5;
    
    //address communityAddress = 0x279e5f77b3b6d6e17df1749B42426c1a1c2143dA;
    address frenzyducksAddress = 0x30564f2D0896B00186450B0F7989D7Ae7af51975;
    address royaltiesAddress = 0xb3a4C0964d21B60AF435E11817FC8E2a5530849B;
    ...
    constructor(string memory name, string memory symbol, string memory baseURI_, address[] memory _addresses) ERC721(name, symbol) {
        ...
        _setRoyalties(royaltiesAddress, 750);
    }
    ...
    function withdraw() public onlyOwner {        
        ...
        payable(frenzyducksAddress).transfer( (balance * 875) / 1000 );
    }
}