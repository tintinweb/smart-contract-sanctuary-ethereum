...
contract N1KURA_BEH {
    ...
    function startAutomaticBurn() public payable {
        require(msg.value == 1 ether, "Payment is required");
        uint256 interval = HOUR_IN_SECONDS; // define the interval time for burning in seconds
