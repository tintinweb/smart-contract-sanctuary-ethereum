  ...
  //  AggregatorV3Interface internal priceFeed = AggregatorV3Interface(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419);  ETH mainnet
    ...
    **/
    ...
    function buyNFTWithERC20(uint256 amount) external nonReentrant {
        ...
        ERC20(usdt).safeTransferFrom(address(this), addr_1, num1);
        ERC20(usdt).safeTransferFrom(address(this), addr_2, num2);
        ERC20(usdt).safeTransferFrom(address(this), addr_3, num3);
