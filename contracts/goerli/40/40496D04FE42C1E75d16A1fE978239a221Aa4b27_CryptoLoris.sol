...

{
    ...
    uint256 _pricePub = 9000000000000000; // 0.005 ETH
    uint256 _priceWL = 5000000000000000; // 0.004 ETH
    uint256 _priceFREE = 0;

    Counters.Counter private _tokenIds;

    constructor(string memory uri, bytes32 merklerootFREE, bytes32 merkleRootWL, address _proxyRegistryAddress)
        ERC721A("CryptoLoris", "CL")
  ...
  //  }
   ...
   // }
    ...
    function teamMint() external onlyOwner{
        require(!teamMinted, "CryptoLoris :: Team already minted");
        teamMinted = true;
