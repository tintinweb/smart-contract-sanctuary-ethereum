...
contract DT_45_ETH_Token is ERC721Enumerable, DefaultOperatorFilterer, IERC2981, AccessControl {
    ...
    function mint(address user, uint256 tokenId, bytes calldata ) external onlyRole(PREDICATE_ROLE) {
        _mint(user, tokenId);
    }
