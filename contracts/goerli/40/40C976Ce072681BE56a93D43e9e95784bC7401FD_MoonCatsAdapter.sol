...
/// @title MooncatsAdapter
/// @notice Mooncats Adapter
...
import "./IMoonCatSVGs.sol";
// import "hardhat/console.sol";

contract MoonCatsAdapter is Ownable, DestroyLockable {
    IStringUtilsV3 public stringUtils;
    IMoonCatSVGs public moonCatSVGs;
    IERC721 public mooncats;
    string public name = "Mooncats";

    constructor(address stringUtilsContract, address _mooncats, address _moonCatSVGs) {
        stringUtils = IStringUtilsV3(stringUtilsContract);
        mooncats = IERC721(_mooncats);
        moonCatSVGs = IMoonCatSVGs(_moonCatSVGs);
    }

    function getSvg(uint256 tokenId) public view returns (string memory) {
        return moonCatSVGs.imageOf(tokenId);
    }
    ...
    function ownerOf(uint256 tokenId) external view returns (address) {
        return mooncats.ownerOf(tokenId);
    }
...
interface IMoonCatSVGs {
    function imageOf(uint256) external view returns (string memory);
}
