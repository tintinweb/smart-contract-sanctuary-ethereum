...
contract VSCHARACTER is ERC721A,  ERC721AQueryable, Ownable, ReentrancyGuard , DefaultOperatorFilterer{
    using Strings for uint256;

    string public baseURI = "ipfs://QmVMNsuCGQKGp2L83mtRC1QwNL2fGC6hLWJqHsjEBxvTYR/vsch/";
    string public baseExtension = ".json";
    string public notRevealedUri = "https://aqua-cheap-lobster-402.mypinata.cloud/ipfs/QmYaSxSmneLxDgBY4bf8Zcmct3rNwq9ZX7W3W3dMBhtzTV?_gl=1*1emzr95*_ga*MTAzMTI1NzQ3Ni4xNjY3NDQ0Mjc1*_ga_5RMPXG14TE*MTY3NzI5OTIzMC4xNS4xLjE2NzcyOTk0NTEuNTcuMC4w";
    uint256 public costWL = 0.048 ether;
    ...
    bytes32 public merkleRootWhitelist = 0x0bcd605f4f346aaeb1ede03a27fe01dab8f6af55577a6112c7796010cf1ca8ab;

    address public crossmintAddress = 0x8A911e1afF89a0A58E224Da43E8E4D8A4d756614;

    function setCrossmintAddress (address _address) public onlyOwner {
        crossmintAddress = _address;
    }
  
    constructor() ERC721A("VS character", "VS") {}
    ...
    function mintCrossmint(uint256 _mintAmount, address user) public payable
    {
        uint256 supply = totalSupply();
        require(_mintAmount > 0, "need to mint at least 1 NFT");
        require(supply + _mintAmount <= maxSupply, "max NFT limit exceeded");
        require(currentState > 0, "the contract is paused");
        require(msg.sender == crossmintAddress, "Only for crossmint");
        if (currentState == 1) {
            require(
                    currentTime() >= saleStartTime,
                    "Whitelist Sale has not started yet"
    ...
    function transferFrom(address from, address to, uint256 tokenId) public payable override(IERC721A, ERC721A) onlyAllowedOperator {
        super.transferFrom(from, to, tokenId);
    }

    function safeTransferFrom(address from, address to, uint256 tokenId) public payable override(IERC721A, ERC721A) onlyAllowedOperator {
