...
contract StableCoin is ERC20, Pausable, Ownable, AccessControl, ReentrancyGuard, BlackList, IStableCoin
{
    ...
    function addToBlackList(address _user) public override(IStableCoin) onlyOwner whenNotPaused returns (bool) {
        require(
            _user != ZERO_ADDRESS,
    ...
    function removeFromBlackList(address _user) public override(IStableCoin) onlyOwner whenNotPaused returns (bool) {
        require(
            _user != ZERO_ADDRESS,
            "account is the zero address"
        );
    ...
    // This function would be called before every transfer function and token transfers
