...
// Dependency file: @openzeppelin/contracts-upgradeable/token/ERC20/extensions/draft-IERC20PermitUpgradeable.sol
...
// Dependency file: @openzeppelin/contracts-upgradeable/interfaces/IERC4626Upgradeable.sol
...
// Dependency file: @openzeppelin/contracts-upgradeable/token/ERC20/extensions/ERC4626Upgradeable.sol
...
// Root file: contracts/PortfolioDebtToken.sol
...
contract PortfolioDebtToken is Initializable, ERC4626Upgradeable, OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    event Recovered(IERC20Upgradeable token, uint256 balance);
    ...
    function recoverToken(IERC20Upgradeable token, address targetAccount) external onlyOwner {
        require(address(token) != asset(), "PDT: Cannot recover asset token");
        uint256 balance = token.balanceOf(address(this));
        emit Recovered(token, balance);
        token.safeTransfer(targetAccount, balance);
    }
