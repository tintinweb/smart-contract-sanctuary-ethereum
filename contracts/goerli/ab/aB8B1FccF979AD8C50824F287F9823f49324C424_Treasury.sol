...
contract Treasury is ITreasury, AccessControl, ReentrancyGuard {
    ...
    event Shutdown();
    event DynamicNftAddressSet(address dynamicNftAddress, string Role1, string Role2);
    ...
    function setDynamicNFTAddress(address _dynamicNftAddress) public onlyRole(ADMIN_ROLE) {
        ...
        emit DynamicNftAddressSet(_dynamicNftAddress, "EXECUTOR_ROLE", "ADMIN_ROLE");
    }
    ...
    function setCoreContractAdress(address _coreContractAddress) public onlyRole(ADMIN_ROLE) {
        ...
        emit UpdatedCoreContractAddress(_coreContractAddress, "EXECUTOR_ROLE");
    }
    ...
    function payRefund(address _to, uint256 _amount) external nonReentrant onlyRole(ADMIN_ROLE) {
