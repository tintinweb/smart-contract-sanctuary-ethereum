...
contract GoerliTest is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(string memory initURI, address initSigner) ERC721A("Goerli Test", "GT", 3) {
        _uri = initURI;
        _signer = initSigner;
        maxTotalSupply = 5555;
        PreMaxMint = 2;
    ...
    function signature(string memory salt, address _address) internal view returns (bytes32)
    {
        return keccak256(abi.encode(salt, address(this), _address));
    }
