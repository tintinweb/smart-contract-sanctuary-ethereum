...
contract Collection is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Dante A NFT Collection", "DANFT") {
    ...
    function mint(address _to, uint256 _mintAmount, uint256 _pid) public payable {
        ...
        require(_mintAmount > 0,"Amount is 0");
        require(_mintAmount <= maxMintAmount, "You cannot mint that many in one transaction.");
