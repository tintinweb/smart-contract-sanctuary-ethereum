...
contract EtherBetsV2 is VRFConsumerBaseV2{
    ...
    */
    ...
    function getDetails() external view returns (string memory, uint, uint8, uint8, uint, uint, bool, uint, uint, uint8[] memory, uint256){
    ...
    function claimPrize(uint256 _draw) external payable{
