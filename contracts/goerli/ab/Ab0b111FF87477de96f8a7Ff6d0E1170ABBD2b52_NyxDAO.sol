...
contract NyxDAO is Ownable {
    ...
    //     uint256 nProp = getNumOfProposals(proposalTypeInt);
    //     bytes[] memory result = new bytes[](nProp);
    //     delete nProp;
    //     {
    //         NyxProposalHandler.ProposalReadable[] memory x = proposalCreator.getProposals(proposalTypeInt);
    //     }
    //     return result;
    //     
    // }
    ...
    function getProposalConf(uint256 proposalTypeInt)
        external view
        withProposalHandlerSetted
