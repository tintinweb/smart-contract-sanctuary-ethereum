...
//TODO update name
contract MMMMM is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable{
    ...
    address private constant withdrawAddress = 0x9d3682971F4E03869A1ABA2246C37B446239c744; //TODO update withdraw address
    ...
    function initialize() initializer public {
        __ERC721_init("MMMMM", "MMMMM"); //TODO update name
        ...
        yatc=YATC(0x5206ee27D8B4366f002EE2691e930384FAba898f);
        _packUri="ipfs://QmSa1bAW297vQBzsQY9U9S4L8A7nyABSFS4F2dj946VkBr"; //TODO update metadata
        
        isReveal = false;
        mintCost = 0.1 ether; //TODO update mint price
        saleState = 0;

        verifySigner = 0x9d3682971F4E03869A1ABA2246C37B446239c744; //TODO update Signer address
    ...
    function yatcMint() public payable checkState(1) {
        ...
        require(_yatcTokenId > 0 ,"All YATC have bean minted");
        
        uint256 total = currentTotalToken();

        // check matr1xList sum
        require(total + 1 <= MATR1XLIST_NUM, "Matr1xList soldout");
    ...
    function mlMint(string calldata _salt, bytes memory _signature) public payable checkState(1) {
        ...
        require(_publicNumberMinted[_msgSender()] < MAX_MINT_PER_ADDRESS,"Address Max limit");
    ...
    function llMint(string calldata _salt, bytes memory _signature) public payable checkState(2) {
        ...
        require(total + 1 <= (MATR1XLIST_NUM+LUCKYLIST_NUM), "LuckyList soldout");
        // check msg.value >= num*price
        require(msg.value >= price(mintCost,1), "Value below price");
    ...
    function airdropMint(address[] memory _yatcOwners) public checkState(3) onlyRole(MINTER_ROLE) nonReentrant {
        ...
        require(total + _yatcOwners.length <= MAX_ELEMENTS, "Matr1x2061 soldout");
