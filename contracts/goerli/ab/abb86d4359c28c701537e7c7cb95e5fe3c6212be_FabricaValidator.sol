...
// Dependency file: custom_flatten/IFabricaValidator.sol
...
// Root file: custom_flatten/FabricaValidator.sol
...
// import "custom_flatten/IFabricaValidator.sol";

contract FabricaValidator is Context, ERC165, Ownable, IFabricaValidator {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, IERC165) returns (bool) {
        return
        interfaceId == type(IFabricaValidator).interfaceId ||
     ...
     */
    function metadataUri(uint256 id) public view returns (string memory) {
        return(
            string.concat(
                _baseMetadataUri,
    ...
    function updateBaseMetadataUri(string memory baseUri) public onlyOwner returns (bool) {
        _baseMetadataUri = baseUri;
        emit UpdateMetadataBaseUri(_baseMetadataUri);
        return true;
    }
}