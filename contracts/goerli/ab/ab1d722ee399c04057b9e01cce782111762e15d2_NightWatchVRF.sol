...
contract NightWatchVRF is VRFV2WrapperConsumerBase, Owned {
    // Events
    ...
    uint32 internal _callbackGasLimit = 200000;

    uint16 internal _requestConfirmations = 3;

    uint32 internal _numWords = 2;

    address internal immutable _linkAddress;

    address internal immutable _wrapperAddress;
