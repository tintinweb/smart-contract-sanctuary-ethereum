...
contract VitalikTheDragon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vitalik the Dragon";
    string private constant _symbol = "VDT";
