...
contract SingleFixed is OwnableUpgradeable, ERC721HolderUpgradeable, Signature {
    ...
    function singleList(bytes calldata _signature, address _collection, uint256 _tokenId, uint256 _price) OnlyItemOwner(_collection,_tokenId) public {
		confirmSignature(
            address(this), 
            msg.sender, 
            "list", 
    ...
    function singleDelist(bytes calldata _signature, uint256 _id) external {  
    ...
    function singleBuy(bytes calldata _signature, uint256 _id) external payable {
		confirmSignature(
            address(this), 
            msg.sender, 
            "buy", 
