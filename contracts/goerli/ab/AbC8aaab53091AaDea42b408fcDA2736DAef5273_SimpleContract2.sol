...
contract SimpleContract2 is LivelyDiamond {
    constructor(
...
contract LivelyDiamond {
    ...
    constructor(
        ...
        // Set implementation slot // TODO: This is set to a goerli dummy diamond. Must be updated when new facets are deployed cross chain.
        LibDiamondEtherscan._setDummyImplementation(
            0x0f66F2B36c7D6408cb556933B27f04d8D368d45e
        );
    }
