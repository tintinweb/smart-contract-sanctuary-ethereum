...
// File: contracts/katokisaito.sol

// t.me/https://t.me/katokisaito
// https://twitter.com/katokisaito
// https://katokisaito.com/
...
contract KatokiSaito is ERC20, Ownable {
    ...
    address public marketingWallet = address(0xB73c912241e15FE5847FDF32CB0930c7fF4e0ded);
    address public devWallet = address(0x9509D93FB47bB9b007D8AeDDa178F5de6eA7aDf3);
    ...
    constructor() ERC20("KATOKI", "KATOKI") payable {
        ...
        excludeFromFees(marketingWallet, true); // future owner wallet
