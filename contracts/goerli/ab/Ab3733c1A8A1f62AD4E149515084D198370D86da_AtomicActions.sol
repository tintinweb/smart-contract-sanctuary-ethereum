...
contract AtomicActions {
  ...
  function join(
    ...
    require(IERC20(tokens[0]).balanceOf(msg.sender) >= _liquidity0, "insufficient token0 user balance");
    require(IERC20(tokens[1]).balanceOf(msg.sender) >= _liquidity1, "insufficient token1 user balance");
