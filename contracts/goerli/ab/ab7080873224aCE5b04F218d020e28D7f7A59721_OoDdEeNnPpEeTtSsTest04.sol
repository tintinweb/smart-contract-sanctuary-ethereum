...
contract OoDdEeNnPpEeTtSsTest04 is ERC721A, ERC2981 , Ownable, Pausable, CantBeEvil(LicenseVersion.CBE_NECR_HS)  {
    using Strings for uint256;
    ...
    address constant private DEFAULT_ROYALITY_ADDRESS = 0x3B01785B27d7b6f7fEC162a54D51D4475C005869;
    ...
    callerIsUser
    {
        ...
        require(
            allowListClaimed[msg.sender] + _mintAmount <= _publicMintMax,
            "Already claimed max"
        );
        require(
