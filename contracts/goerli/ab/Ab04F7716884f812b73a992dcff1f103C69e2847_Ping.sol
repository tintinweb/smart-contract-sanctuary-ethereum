...
contract Ping is IXReceiver {
  ...
  address constant token = 0x7ea6eA49B0b0Ae9c5db7907d139D9Cd3439862a1;

  constructor() {
    connext = IConnext(0xFCa08024A6D4bCc87275b1E4A1E22B71fAD7f649);
  }
  ...
  function sendPing(
    ...
    bytes memory _callData = abi.encode(pongs, address(this), relayerFee, message);
