    ...
    ICoin
{
    ...
    function initialize(
        ...
        CoinStorage.layout().name = name_;
        CoinStorage.layout().symbol = symbol_;
    ...
    function mintBatch(
        ...
        for (uint256 i = 0; i < length; ) {
            CoinStorage.layout().coinEXP[ids[i]] = exps[i];
            unchecked {
                i++;
            }
        }
    ...
    function revealBatch(
        ...
        require(
            length == tokenIds.length && length == exps.length,
            "Lengths mismatch"
        );
        for (uint256 i = 0; i < length; ) {
    ...
    function breakLuckyCatCoinBank(uint256 tokenId) external onlyActive {
        ...
        emit LuckyCatCoinBankBroken(tokenId, _msgSender());
    }
        ...
        returns (bool)
    {
        return
            ...
            ERC1155Upgradeable.isApprovedForAll(account, operator);
    }
