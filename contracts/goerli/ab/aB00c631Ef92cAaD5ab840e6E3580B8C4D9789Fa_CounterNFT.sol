...
contract CounterNFT  is ERC721URIStorage, Ownable {
    ...
    /**
     * @dev
     * - _tokenIdryptosはCountersの全関数が利用可能
     */
    ...
    /**
     * @dev
     * - URI設定時に誰がどのtokenIdに何のURIを設定したか記憶する
     */
    event TokenURIChanged(address indexed sender, uint256 indexed tokenId, string uri);

    /**
     * @dev
     * - このコントラクトをデプロイしたアドレス変数owner 
     */
    ...
    /**
     * @dev
     * - このコントラクトをデプロイしたアドレスがだけがmint可能 onlyOwner
     * - tokenIdをインクリメント _tokenIds.increment()
     * - nfftMint関数の実行アドレスにtokenIdを紐付け
