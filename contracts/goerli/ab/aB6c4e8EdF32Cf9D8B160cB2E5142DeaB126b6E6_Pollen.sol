    ...
    PausableUpgradeable
{
    ...
    function getTotalCtoken(uint256 tokenIndex ) public returns (uint256) {


       getCtokenBalance =  (rewards[tokenIndex].amount + cToken.totalBorrowsCurrent() - cToken.totalReserves()) / cToken.totalSupply();
