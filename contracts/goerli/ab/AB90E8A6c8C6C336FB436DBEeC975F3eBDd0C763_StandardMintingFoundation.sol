...
/**
 * @title StandardMintingFoundation ERC721A Smart Contract
 */

contract StandardMintingFoundation is Ownable, ReentrancyGuard, ERC721A {
    constructor(address authorizerAddress_, address distributorAddress_)
        ERC721A("StandardMintingFoundation", "SMF")
    {
