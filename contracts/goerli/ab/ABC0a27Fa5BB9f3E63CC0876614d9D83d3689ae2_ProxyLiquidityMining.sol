...
contract ProxyLiquidityMining is LiquidityMiningLogic, ReentrancyGuard {
    ...
    constructor(
        ...
        IERC20(_secondToken).approve(router_, MAX_INT);
        ...
        )
    {
        ...
        secondToken.transfer(
            msg.sender,
            amountsecondTokenDesired - amountsecondToken
        );
...
contract LiquidityMiningLogic is AccessControl {
    ...
    constructor(address _DFI, uint256 _rewardSpeed) {
        DFI = IERC20(_DFI);
    ...
    function _claimRewards(address recipient) internal {
        ...
        if (proxyBalance > rewardAccrueds[recipient]) {
            ...
            DFI.transfer(recipient, rewardToTransfer);
