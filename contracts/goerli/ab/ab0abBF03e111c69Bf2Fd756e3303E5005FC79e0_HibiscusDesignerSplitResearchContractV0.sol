...
contract HibiscusDesignerSplitResearchContractV0 is Owned, LiquidSplit, ERC721 {
    ...
    uint32[] public splitByTokenId = [
        333333, // fwb ** token 0
        333333, // hibiscus ** token 1
        7936,   // designer - orange shirt ** token 2
        70902,  // designer - creme hoodie ** token 3
        49736,  // designer - black l/s ** token 4
        47102,  // designer - white t ** token 5
        73350,  // designer - grey hoodie ** token 6
        36676,  // designer - black hat ** token 7
        31754,  // digitizer - fwb text ** token 8
        15878   // digitizer - fwb logo ** token 9
    ];
    ...
    constructor(
        ...
        ERC721("HibiscusDesignerSplitResearchContractV0", "FWBS5") 
        Owned(_owner) 
