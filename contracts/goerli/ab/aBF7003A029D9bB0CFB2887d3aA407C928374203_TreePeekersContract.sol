...
//*********************************************************************//
//
//  ____  _____  _____  _____    _____  _____  _____  __ ___ _____  _____  _____ 
// /    \/  _  \/   __\/   __\  /  _  \/   __\/   __\|  |  //   __\/  _  \/  ___>
// \-  -/|  _  <|   __||   __|  |   __/|   __||   __||  _ < |   __||  _  <|___  |
//  |__| \__|\_/\_____/\_____/  \__/   \_____/\_____/|__|__\\_____/\__|\_/<_____/
//                                                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xD38923aB5525775342D3D9ED41c651cF0dA4406d,0xb30e29B3A0F3751A0010fFCFcB6346d6EaEF3890];
  address public erc20Payable = 0xD38923aB5525775342D3D9ED41c651cF0dA4406d;
  uint256[] public payableFees = [2,88,10];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 3000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifpxejnjmuw4pdkbfujmtlwplqu4resur52mduu6ic24shcp2fv3y/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = false;
    bool public isRevealed;
    
    uint256 public MAX_WALLET_MINTS = 9;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/2QeSjAZw0HzVUZTtAjVe/contract-metadata";
  }
...
// File: contracts/TreePeekersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TreePeekersContract is RamppERC721A {
    constructor() RamppERC721A("Tree Peekers", "PEEKERS"){}
}
