...
contract Snowie is ERC1155RS, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
// ================== Mint Functions Start =======================
    ...
    function publicMint(uint256 _amount) external payable{
        require(tx.origin == msg.sender, "only eoa");
        require(mintedPerWallet[GENERATION][msg.sender] + _amount <= generations[GENERATION].walletLimit, "wallet limit reached");
        require(msg.value * _amount >= generations[GENERATION].publicPrice, "invalid value sent");
