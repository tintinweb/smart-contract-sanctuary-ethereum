...
contract VSStaking is ERC721Holder, Ownable {
    ...
    /// @notice Minimum Time an NFT has to be staked to recieve rewards (60 days)
    uint256 public constant MINIMUM_TIME = 5184000;
    ...
    function unstakeMany(uint256[] calldata tokenIds) public {
        uint256 tokenId;
    ...
    function isValidStaker(uint256 _tokenId) public view returns (bool, address) {
