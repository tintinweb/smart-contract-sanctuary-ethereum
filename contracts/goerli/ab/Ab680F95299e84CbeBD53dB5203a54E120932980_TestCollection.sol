...
/**
 *   @title Fr0ntierX Test Collection
...
contract TestCollection is ERC721, Pausable, Ownable, ERC721Burnable, Mintable {
  ...
  /**
     ...
     */
  constructor(address ownerInit, address imxInit) ERC721("Test Collection", "TC") Mintable(ownerInit, imxInit) {}
