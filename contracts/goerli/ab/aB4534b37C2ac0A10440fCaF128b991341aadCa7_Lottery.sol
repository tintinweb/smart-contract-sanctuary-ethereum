 ...
 * @dev This implements ChainLink VRF v2 and Chainlink upkeeper
 */
...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        s_lotteryState = LotteryState.OPEN; //equal to LotteryState(0)
    ...
    /**
     * @dev This is teh function that the Chainlink keeper needs call
     * they look for the "unkeepNeeded" to return true.
     * The following shoul dbe true in order to return true:
