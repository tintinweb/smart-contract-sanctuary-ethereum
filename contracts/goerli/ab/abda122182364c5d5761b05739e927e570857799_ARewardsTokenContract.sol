...
contract ARewardsTokenContract is ERC20, Ownable {
    ...
    address public marketingAndDevelopmentAddress;
    address public lossInsuranceAddress;
    ...
    uint256 public buyMarketingAndDevelopmentTax;
    uint256 public buyLossInsuranceTax;
    uint256 public buyRewardTax;

    uint256 public sellTotalTax;
    uint256 public sellMarketingAndDevelopmentTax;
    uint256 public sellLiquidityTax;
    uint256 public sellLossInsuranceTax;
    uint256 public sellRewardTax;

    uint256 public tokensForMarketingAndDevelopment;
    uint256 public tokensForLiquidity;
    uint256 public tokensForLossInsurance;
    ...
    event UpdatedMarketingAndDevelopmentAddress(address indexed newWallet);
    event UpdatedRewardsAddress(address indexed newWallet);
    event UpdatedLossInsuranceAddress(address indexed newWallet);
    ...
    constructor() ERC20("T", "T") {
        ...
        buyMarketingAndDevelopmentTax = 200;
        buyLiquidityTax = 100;
        buyLossInsuranceTax = 100;
        buyRewardTax = 100;
        buyTotalTax = buyMarketingAndDevelopmentTax + buyLiquidityTax + buyLossInsuranceTax + buyRewardTax;


        sellMarketingAndDevelopmentTax = 250;
        sellLiquidityTax = 100;
        sellLossInsuranceTax = 250;
        sellRewardTax = 100;
        sellTotalTax = sellMarketingAndDevelopmentTax + sellLiquidityTax + sellLossInsuranceTax + sellRewardTax;

        // @dev update these!
        marketingAndDevelopmentAddress = address(msg.sender);
        lossInsuranceAddress = address(msg.sender);
        ...
        _excludeFromMaxTransaction(address(marketingAndDevelopmentAddress), true);
        _excludeFromMaxTransaction(address(lossInsuranceAddress), true);
        ...
        excludeFromTax(address(marketingAndDevelopmentAddress), true);
        excludeFromTax(address(lossInsuranceAddress), true);
    ...
    function updateBuyTax(uint256 _marketingAndDevelopmentTax, uint256 _liquidityTax, uint256 _lossInsuranceTax, uint256 _rewardTax) external onlyOwner {
        buyMarketingAndDevelopmentTax = _marketingAndDevelopmentTax;
        buyLiquidityTax = _liquidityTax;
        buyLossInsuranceTax = _lossInsuranceTax;
        buyRewardTax = _rewardTax;
        buyTotalTax = buyMarketingAndDevelopmentTax + buyLiquidityTax + buyLossInsuranceTax;
        require(buyTotalTax <= 700, "Must keep tax at 7% or less");
        emit UpdatedBuyTax(buyTotalTax);
    }

    function updateSellTax(uint256 _marketingAndDevelopmentTax, uint256 _liquidityTax, uint256 _lossInsuranceTax, uint256 _rewardTax) external onlyOwner {
        sellMarketingAndDevelopmentTax = _marketingAndDevelopmentTax;
        sellLiquidityTax = _liquidityTax;
        sellLossInsuranceTax = _lossInsuranceTax;
    ...
    function _transfer(address from, address to, uint256 amt) internal override {
        ...
        if(takeTax){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalTax > 0){
                ...
                tokensForMarketingAndDevelopment += tax * sellMarketingAndDevelopmentTax / sellTotalTax;
                tokensForLossInsurance += tax * sellLossInsuranceTax / sellTotalTax;
            ...
            // on buy
        	    ...
        	    tokensForMarketingAndDevelopment += tax * buyMarketingAndDevelopmentTax / buyTotalTax;
        	    tokensForLiquidity += tax * buyLiquidityTax / buyTotalTax;
                tokensForLossInsurance += tax * buyLossInsuranceTax / buyTotalTax;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketingAndDevelopment + tokensForLossInsurance + tokensForReward;
        ...
        uint256 stablecoinForLossInsurance = stablecoinBalance * tokensForLossInsurance / totalTokensToSwap;
        uint256 stablecoinForReward = stablecoinBalance * tokensForReward / totalTokensToSwap;
            
        tokensForMarketingAndDevelopment = 0;
        tokensForLossInsurance = 0;
        tokensForReward = 0;

        if(stablecoinForLossInsurance > 0){
            SafeERC20.safeTransfer(PAIREDTOKEN, lossInsuranceAddress, stablecoinForLossInsurance);
        }
        ...
        if(PAIREDTOKEN.balanceOf(address(this)) > 0){
            SafeERC20.safeTransfer(PAIREDTOKEN, marketingAndDevelopmentAddress, PAIREDTOKEN.balanceOf(address(this)));
        }
    }

    function setMarketingAndDevelopmentAddress(address _marketingAndDevelopmentAddress) external onlyOwner {
        require(_marketingAndDevelopmentAddress != address(0), "address cannot be 0");
        marketingAndDevelopmentAddress = payable(_marketingAndDevelopmentAddress);
        emit UpdatedMarketingAndDevelopmentAddress(_marketingAndDevelopmentAddress);
    }

    function setLossInsuranceAddress(address _lossInsuranceAddress) external onlyOwner {
        require(_lossInsuranceAddress != address(0), "address cannot be 0");
        lossInsuranceAddress = payable(_lossInsuranceAddress);
        emit UpdatedLossInsuranceAddress(_lossInsuranceAddress);
    }
