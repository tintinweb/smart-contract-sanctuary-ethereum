...
contract ChessGame is Ownable, BaseGame {
    ...
    function newGame(
        ...
        bytes32 gameId = keccak256(abi.encode(address(this), player1, player2, 0, 0, nonce));
    ...
    function endGame(
        ...
        require(_hash.toEthSignedMessageHash().recover(signature) == verifier, "invalid signature");
        ...
        require(winner == player1.player || winner == player2.player, "invalid winner address");
