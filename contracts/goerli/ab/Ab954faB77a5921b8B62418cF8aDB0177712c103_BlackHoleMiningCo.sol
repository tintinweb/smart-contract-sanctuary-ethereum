...
contract BlackHoleMiningCo is ERC721, ERC721URIStorage, Ownable {
    ...
    {
        return string(abi.encodePacked(_baseTokenURI, isHidden ? "hidden" : Strings.toString(tokenId)));
    }
    ...
    function toggleIsHidden() public onlyOwner {
        isHidden = !isHidden;
    }
    ...
    function reserve(uint total) public onlyOwner {
