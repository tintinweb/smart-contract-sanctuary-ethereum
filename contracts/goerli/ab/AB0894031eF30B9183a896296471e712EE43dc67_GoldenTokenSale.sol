...
contract GoldenTokenSale is Ownable, ReentrancyGuard
{
    ...
    uint public _CurrentTokenIndex = 102;
    uint public _TimestampSaleStart = 1675733100; 
    uint public _TimestampEndFullSet = 1675733700;
    uint public _TimestampEndCitizen = 1675734300;
    ...
    function Purchase (
        ...
        require(_AmountSold + DesiredAmount <= _MaxForSale && DesiredAmount > 0, "Sale Ended");
        require(msg.value >= _Price && DesiredAmount > 0 && _Price > 0, "Invalid ETH Amount"); // Ensures ETH Amount Sent Is Correct
        if(msg.value > _Price) { __Refund(msg.sender, msg.value - _Price); } // Possible Refund
