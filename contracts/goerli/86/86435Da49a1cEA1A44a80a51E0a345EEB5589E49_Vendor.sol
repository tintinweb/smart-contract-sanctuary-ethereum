...
contract Vendor is Ownable{
  ...
  function buyTokens() public payable{
    uint256 ethAmount = msg.value/1**18;
    uint256 amountBought = ethAmount * tokensPerEth;

    yourToken.transfer(msg.sender, amountBought);
    
    emit BuyTokens(msg.sender, ethAmount, amountBought);
  }
