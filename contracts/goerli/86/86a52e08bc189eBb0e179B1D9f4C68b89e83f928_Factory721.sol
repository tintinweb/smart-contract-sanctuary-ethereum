...
import "./AmaBooksUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new AmaBooksUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        AmaBooksUser721Token token = AmaBooksUser721Token(address(addr));
...
contract AmaBooksUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
