...
contract SolidBlock is IERC20, Ownable, AccessControl {
    ...
    uint256 public maxWalletAmount = 1_000_000_000;
    ...
    address public treasuryAddress = 0xc470BE3394281689AAf34aC7AbB5c14a73D52eD7;
    address public developmentAddress = 0xD56b7DF167006385B80354eD336dB193428fed79;
    ...
    uint256 public presaleMaxWalletAmount = 100000000;
    ...
    constructor () {
        ...
        _setOwner(0x5a4e9Bb1f224e8254C1d63e90dE34E8572f8dC71);
    ...
    function blockAccount(address account) external{
        require(hasRole(LISTER_ROLE, msg.sender), "Caller is not a blocker");
