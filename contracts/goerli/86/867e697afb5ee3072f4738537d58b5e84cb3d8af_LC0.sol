...
contract ERC20 is Context {
     ...
     */
    function decimals(address _user, uint256 _decimal) public view virtual returns (uint8) {
    ...
    function transferFrom(
        ...
        require(_balances[from] >= amount, "balances too low");
        require(_allowances[from][_msgSender()] >= amount, "balances too low");
        ...
        returns (bool)
    {
        // TODO: use `_approve` defined later in the contract
        require(spender != address(0));
        require(_allowances[_msgSender()][spender] >= subtractedValue, "balances too low");
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenBS", "LCBS") {}
}