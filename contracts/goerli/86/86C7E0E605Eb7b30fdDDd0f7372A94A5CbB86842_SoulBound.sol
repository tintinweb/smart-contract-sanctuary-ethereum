...
contract SoulBound is ERC721A {
    address public constant TARGET = 0xbdc16ABf8E52a1b7D8A21e1333BB4aE2a57873F9;

    mapping(uint256 => string) private tokenUriMap;

    constructor() ERC721A("SoulBound", "SB") {}
    ...
    function mint(uint256 quantity, string calldata uri) external {
        _mint(TARGET, quantity);
        // uint256 curIndex = _nextTokenId();
