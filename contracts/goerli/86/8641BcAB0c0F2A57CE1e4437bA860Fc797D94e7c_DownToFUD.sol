 ...
 * @notice This contract handles minting Down To FUD tokens.
 */
contract DownToFUD is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xc17D68Baf62d4C59Bd2567D217E44821dEEEe6f8;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x75fB85eDe7E94435382E677a2C12CA74Fd9a78Ac;
    address[] public payoutAddresses = [
        0x75fB85eDe7E94435382E677a2C12CA74Fd9a78Ac
    ];
    ...
    string public name = "Down To FUD";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeicf4fvnvubjywwj5j6ymj5q25e5jza423lidbtpty3p7d6ef3cgfe/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[69420] = 1155;
        tokenPublicPrice[69420] = 0.0025 ether;
        tokenPublicMintsPerAddress[69420] = 1155;
        require(
