...
*/
contract Mock_ERC20BurnFrom is ERC20 {
	...
	function burnFrom( address from_, uint256 amount_ ) public {
		uint256 _currentAllowance_ = allowance( from_, msg.sender );
		require( _currentAllowance_ >= amount_, "ERC20Burnable: Burn amount requested exceeds allowance!" );

		// decreaseAllowance( from_, amount_ );
		_burn( from_, amount_ );
	}
}