...
contract LBSKR is IERC20, Ownable, Manageable, Pausable, DSMath {
    ...
    // uint256 public constant _INF_RATE_DAILY = 0x33B5896A56042D2D5000000; // ray (10E27 precision) value for 1.0002 (1 + 0.02%)
    ...
    uint8 public constant _INFLATION_BIPS = 2; // 0.02% of inflation vault balance
    ...
    mapping(address => Stake) public _stakeholderToStake;
        ...
        )
    {
        ...
        inflation = 0;
        if (hoursElapsed > 0) {
            uint256 infFrac = rpow(_INF_RATE_HRLY, hoursElapsed);
