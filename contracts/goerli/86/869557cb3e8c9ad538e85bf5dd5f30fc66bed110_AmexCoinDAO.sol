...
contract AmexCoinDAO is ERC20, Ownable {
    ...
    constructor () ERC20("Amex Coin DAO", "ACD", 8, 5000 * 10 ** 8){
        address msgSender = _msgSender();
        ...
        if (!freeOfCharge) {
            ...
            if (currentBalance > 0 && !swaping && sender != pancakePair) {
                ...
                if(_buyFeeAmount > 0) {
                    ...
                    uint256 amountETHToReceiveBuyFeeWallet = address(this).balance;
                ...
                if(_sellFeeAmount > 0) {
                    ...
                    uint256 amountETHToReceiveSellFeeWallet = address(this).balance;
