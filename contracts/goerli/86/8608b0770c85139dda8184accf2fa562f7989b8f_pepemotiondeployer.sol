...
contract pepemotiondeployer is ERC721A, Ownable {
    ...
    function getRender(uint256 id) public view returns (string memory img) {
        Rend toRend = Rend(0xdec94aA93974902963Ca3eAcD96e5A11e88d3A21);
        string memory img = toRend.render(id, getPrice3());
        return(img);
    }


    function getPrice3() public pure returns (uint160 p) {
        uint160 p = 1584563250285286751870879006720000;
        return(p);
    }
