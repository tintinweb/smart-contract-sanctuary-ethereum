...
contract ConxLbpSwapTargetV1 is IXReceiver {
    ...
    function xReceive(
        ...
        (SingleSwap memory singleSwap, FundManagement memory funds, uint256 limit, uint256 deadline, address lbpContractAddress, address swapRecipient) = abi.decode(_callData, (SingleSwap, FundManagement, uint256, uint256, address, address));
