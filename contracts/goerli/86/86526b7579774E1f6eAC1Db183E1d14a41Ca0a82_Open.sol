...
// File: contracts/FIVER/enforce/IOperatorFilterRegistry.sol
...
// File: contracts/FIVER/enforce/OperatorFilterer.sol
...
// File: contracts/FIVER/enforce/DefaultOperatorFilterer.sol
...
contract Open is ERC721A, Pausable, Ownable, DefaultOperatorFilterer {

    /*============================PARTNER_SALE_VARS======================================*/
    bytes32 public MERKLE_ROOT_PARTNER = 0x0;
    uint256 public PRICE_PARTNER       = 2 wei;
    bool    public PARTNER_MINT_STATUS = false;
    
    /*============================LEAGUELIST_SALE_VARS===================================*/
    bytes32 public MERKLE_ROOT_LEAGUELIST   = 0xa1ce0e25572d2ad5da769440b132f381b82eb21b24dd2c52fbc2b55b6aae11a6 ;
    uint256 public PRICE_LEAGUELIST         = 3 wei;
    bool    public LEAGUELIST_MINT_STATUS   = true;

    /*============================VIP_SALE_VARS==========================================*/
    bytes32 public MERKLE_ROOT_VIP = 0x54fc4bce02d109bff2e168951734d51476becb7f20e4799da2986f43a4afee14;
    bool    public VIP_MINT_STATUS = true;
    // Price is Free
    ...
    function mint(
        ...
        if (mintCheck(_merkleProof, MERKLE_ROOT_VIP, leaf) && VIP_MINT_STATUS) {
            ...
            _safeMint(to, qty);
        } else if (mintCheck(_merkleProof, MERKLE_ROOT_PARTNER, leaf) && PARTNER_MINT_STATUS) {
            require(msg.value >= PRICE_PARTNER * qty, "Error: Wrong Amount");
            walletMints[msg.sender] += qty;
            _safeMint(to, qty);
        } else if (mintCheck(_merkleProof, MERKLE_ROOT_LEAGUELIST, leaf) && LEAGUELIST_MINT_STATUS) {
