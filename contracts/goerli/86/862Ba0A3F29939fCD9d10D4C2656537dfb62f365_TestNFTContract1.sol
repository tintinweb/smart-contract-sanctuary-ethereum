    ...
    ReentrancyGuard
{
    ...
    uint64 public maxSupply = 1000000000; /// @notice The available total supply will decrease the longer the sale is open
    uint64 public constant MAX_PER_TX = 100;
    uint64 public constant MAX_PER_ADDR = 100000;
    uint64 public constant PRICE = 0.00 ether;
    ...
    constructor() ERC721A("TestNFTContract1", "TN1") {
        tokenBaseURI = "https://nil.com/";
