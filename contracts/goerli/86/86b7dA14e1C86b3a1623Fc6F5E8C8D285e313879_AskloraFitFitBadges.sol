 ...
 * @notice This contract handles minting Asklora FitFit Badges tokens.
 */
contract AskloraFitFitBadges is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xF9464456F22426BC426e569E73cAC4e5F7486840;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x573A06c7b86Aa780aCb8958bCF986883ce43cd00;
    ...
    string public name = "Asklora FitFit Badges";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeie2zxth734vnxytkmvksmcfdrqgyg5slau2lzztdbzarbpup2xu4u/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[2] = 300;
        tokenMaxSupply[3] = 300;
    }
