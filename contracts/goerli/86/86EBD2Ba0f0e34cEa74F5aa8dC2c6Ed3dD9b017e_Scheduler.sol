    ...
    SchedulerStorage
{
    ...
    function initialize(
        ...
        setUp(abi.encode(_owners, _ops, _safeFactory, _singleton, _fallbackHandler));
    }
        ...
        initializer
    {
        ...
        // create safe
        GnosisSafe safe = _createSafe(_owners, _safeFactory, _singleton, _fallbackHandler);
...
contract GnosisUtils is ISignatureValidator {
    ...
    // create safe
    function _createSafe(address[] memory _owners, address _safeFactory, address _singleton, address _fallbackHandler) internal returns(GnosisSafe safe) {
