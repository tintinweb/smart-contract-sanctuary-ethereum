...
contract SkullsOfMayhem is ITSCProject, OwnableUpgradeable, ERC721PsiUpgradeable, ERC2981Upgradeable, OperatorFilterer {
    
    address public constant CANISTERS = 0xa431A71B8F5D50212DBDCaEaafE27b029f6EEa01;//0x0fF1458cab4A4673b913040E011c14B81d656ceb;
    ...
    function initialize() external initializer {
        __ERC721Psi_init("Skulls of Mayhem", "MAYHEM");
        __ERC2981_init();
        __Ownable_init();
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://skullsofmayhem.nftapi.art/meta/";
    }

    function mintProject(address to, uint256 quantity) external returns(uint256) {
        require(msg.sender == CANISTERS, "TSCProject: Only canisters");
        _mint(to, quantity);
        return totalSupply();
    }
