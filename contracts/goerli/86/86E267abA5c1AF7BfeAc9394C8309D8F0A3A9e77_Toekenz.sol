...
// File: lib/BasicMetaTransaction.sol
    ...
    BasicMetaTransaction
{
    ...
    function mint(
        ...
        _beforeTokenMint(id, quantity, royalty, _tokenURI);
        ...
        emit Mint(msgSender(), id, quantity, royalty, _tokenURI);
    ...
    function mintBatch(
        ...
        _mintBatch(msgSender(), ids, quantities, "");
    }
