...
interface ERCItem {
    ...
    function getFarm(address account) external returns (Square[] memory);
}

contract OfferWall is ERC721Enumerable, Ownable {
    struct Offer {
        string name;
        address tokenAddr;
        uint8 reward;
    ...
    constructor() ERC721("OfferWall", "OWT") {}
    ...
    modifier onlyWhiteList() {
        ...
        require(_approved, "OfferWall: caller is not in the whitelist");
        _;
    }
