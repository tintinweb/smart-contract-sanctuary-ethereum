...
contract NFTcontract is Ownable, ERC721A, ERC721AQueryable, ReentrancyGuard{
    ...
    for (uint i = 0; i < toRemoveAddresses.length; i++) { delete whitelist[toRemoveAddresses[i]]; }}
    
    function WhiteListMint(address _account, uint _quantity) external payable callerIsUser {
