    ...
    IMintableERC20
{
    ...
    // constructor(address _mintableERC20PredicateProxy) ERC20("Apeiros", "APRS") {
    ...
    function initialize(
        ...
        address _mintableERC20PredicateProxy,
    ...
    // only _mintableERC20PredicateProxy on eth network can mint
    function mint(address user, uint256 amount)
        external
        override
        only(PREDICATE_ROLE)
    {
        require(totalSupply() + amount <= 1000000000 * 10 ** 18, "Over the total supply");
        _mint(user, amount);
    }
