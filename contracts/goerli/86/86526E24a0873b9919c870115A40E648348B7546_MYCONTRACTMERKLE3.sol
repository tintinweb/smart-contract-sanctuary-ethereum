...
contract MYCONTRACTMERKLE3 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, DefaultOperatorFiltererUpgradeable, ERC721AUpgradeable {  //ERC721AQueryableUpgradeable , ERC721ABurnableUpgradeable 
    ...
    function preMint(
        ...
        if(!(salePhase >= 1 && salePhase <= 4)) revert PresaleIsNotActive();      //フェーズ１−４の間のみ許可
