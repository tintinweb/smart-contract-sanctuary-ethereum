...
contract FRG2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FRG 3", "FRG3") {
        ...
        marketingWallet = address(0x382F938d9537d596c537e39a2Fa1993eD3EFd5a3);
        developmentWallet = address(0x8EDf649c896A7e762Dd1f34d099cAd54940De79f);
        ...
        */
        ...
        uint256 poolSupply = totalSupply - (marketingSupply + devSupply);
