 ...
 * @notice This contract handles minting Bored Rats tokens.
 */
contract BoredRats is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xa96F14893C4859Cdf7C9E2623e301A985901f5cf;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xaAba39f253a8d9181bfD9042C2A164878930e301;
    address[] public payoutAddresses = [
        0xaAba39f253a8d9181bfD9042C2A164878930e301
    ];
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 5050;
        tokenURI[
            1
        ] = "ipfs://QmQiSc414HqyKveVEakKj5hzGE4qadWpSX23FzbpaxTvHM/metamockup.json";
        tokenPublicPrice[1] = 0.1 ether;
        tokenPublicMintsPerAddress[1] = 5050;
        tokenPresaleMaxSupply[1] = 2500;
        tokenPresalePrice[1] = 0.075 ether;
