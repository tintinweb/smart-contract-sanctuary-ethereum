...
// File: @openzeppelin/contracts/token/ERC721/extensions/ERC721Consecutive.sol
...
// File: contracts/Consecutive721.sol
...
contract Item is ERC721, ERC721Consecutive, Ownable {
    using MSNFTCounters for MSNFTCounters.Counter;
    MSNFTCounters.Counter public tokenIdTracker;
    constructor(uint96 InitialMintAmount) ERC721("Item", "ITM") {
        _mintConsecutive(_msgSender(),InitialMintAmount);
        tokenIdTracker.set(InitialMintAmount);
    }
