...
contract BattleSpecies is ERC721Profile, ERC721Enumerable, BattlespeciesWithdrawer, OperatorFilterer {
    ...
    function _baseMint(uint8 _numberOfTokens, bool _autoManifest, uint256 _mintPrice) internal {
        ...
        if (hyperwarpManager.battlerHasUtility(_totalSupply + _numberOfTokens, 1)) {
            require(balanceOf(_msgSender()) + _numberOfTokens <= maxMintsPerWalletBeforeTranscendance, "MaxTokenAllotment: 1");
        }
        else {
            require(balanceOf(_msgSender()) + _numberOfTokens <= maxMintsPerWalletAfterTranscendance, "MaxTokenAllotment: 2");
        }
        ...
        require(_totalSupply + _numberOfTokens <= maxBattlers, "MaxTokenAllotment: 3");
        ...
        require(totalSupply() == _totalSupply + _numberOfTokens, "IncorrectMintedAmount");
    }
