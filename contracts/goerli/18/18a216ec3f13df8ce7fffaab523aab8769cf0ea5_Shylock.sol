...
// File: contracts/Shylock NFT new.sol
...
contract Shylock is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer, Pausable{
    ...
    uint256 public publicMaxMint = 6;
    ...
    // merkle root
    bytes32 public root = 0x0419b031a2b2fe33113ed5bf8c24458dfa3dfc477e579152bfc74254133f12d0;
    ...
    function whitelistMint(uint256 _quantity, bytes32[] memory proof) external payable whenNotPaused nonReentrant {
        ...
        if (totalFreeMints[msg.sender] == 0 && freeMax <= 1000) {
            require(freeMax <= 1000, "No more free left!");
    ...
    wlMaxMint = _wlMaxMint;
     ...
     function setmaxPublic(uint256 _publicMaxMint) external onlyOwner nonReentrant{
