...
contract BuyNowMarketplaceSignerV0006 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, EIP712Upgradeable {
    ...
    function purchaseMintSignerItem(MintSignerItem calldata mintSignerData) public payable nonReentrant {
        ...
        checkMintUnique(mintSignerData.isUniqueMint, mintSignerData.nft, mintSignerData.purchaser);
