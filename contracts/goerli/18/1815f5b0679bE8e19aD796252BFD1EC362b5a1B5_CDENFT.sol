...
contract CDENFT is ERC721Enumerable, Ownable, ReentrancyGuard {
    using SafeMath for uint256;

    bool public isSaleActive = false;
    string public PROVENANCE = "-";
    uint public constant maxMintBatch = 1; // 单个账户mint的数量
    uint256 public constant tokenPrice = 80000000000000000; // 你要出售的价格0.08 ETH
    uint256 public maxTokensCount = 10000; // 生成NFT的数量
    address[] private distributions;
    string private baseURI;
    string public baseTokenURI;
    string public contractURI;

    constructor() ERC721("CDE NFT", "CDE") {
        baseURI = "https://ipfs.io/ipfs/QmcZT5eSkFLm94pwLhQ1BfhaKGJ6KqaJCiVXQmLkYDpnQK"; // 填写您的baseURI
        baseTokenURI = "https://ipfs.io/ipfs/QmcZT5eSkFLm94pwLhQ1BfhaKGJ6KqaJCiVXQmLkYDpnQK";
        contractURI = "";
    }
