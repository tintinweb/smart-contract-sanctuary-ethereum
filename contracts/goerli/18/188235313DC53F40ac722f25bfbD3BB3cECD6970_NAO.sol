    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize() public initializerERC721A initializer {
        ...
        __ERC721A_init("NFT All Star Omikuji", "NAO");
        setMember(_msgSender(), true);
        baseURI = "";
        revealUri = "ar://aDu2sUUwXTGMMkT7VqPaLIW0XNN9e2hJX0wJ9EdbPqw";
        preCost = 0.001 ether;
    ...
    function publicMint(uint256 _mintAmount) external payable callerIsUser nonReentrant {
        ...
        if(!(salePhase == 3)) revert Errors.PresaleIsActive();
        if(_mintAmount > 20) revert Errors.MintAmountOver();
    ...
    function withdraw() external onlyTeam {
        ...
        bool success;
        (success, ) = payable(0x4A85C42Fe1C82dA31C56E1157cc418Bc7d0498Fb).call{value: (sendAmount * 800/1000)}("");
