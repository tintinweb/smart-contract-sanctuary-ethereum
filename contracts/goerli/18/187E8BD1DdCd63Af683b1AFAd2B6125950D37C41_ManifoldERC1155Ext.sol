...
contract ManifoldERC1155Ext is AdminControl, ICreatorExtensionTokenURI {
    ...
    // Write a constructor to setup _baseURI1 and _baseURI2
    constructor(string memory baseURI1, string memory baseURI2) {
        _baseURI1 = baseURI1;
        _baseURI2 = baseURI2;
    }
    ...
    function setBaseURI(string memory baseURI1, string memory baseURI2)
        public
        adminRequired
    {
        _baseURI1 = baseURI1;
