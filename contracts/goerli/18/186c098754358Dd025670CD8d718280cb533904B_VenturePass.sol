...
contract VenturePass is ERC721A, Ownable, OperatorFilterer {
    ...
    function _buildTokenURI(uint256 id) internal view returns (string memory) {
        ...
        string memory lockText = "unlocked";
        if (isTokenLocked(id)) {
            lockText = string(
                abi.encodePacked(
                    unicode'<text x="500" y="500">Token is locked</text>'
                )
            );
        }
            ...
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        ...
                        '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="0 0 1024 1024" preserveAspectRatio="xMidYMid meet">',
                        '<image href="https://apeliquid.io/vpass/pngs/vpass.png" height="1024" width="1024"/>',
                        lockText,
                        '</svg>'
                    )
                )
