...
contract Interactive is Ownable, ERC721A {
    ...
    string public hiddenURI =
        "ipfs://QmT8r8JxPqJSGGnKyzuiwxSDkermNcN1JRY3pq2HDKViZb";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI =
        "ipfs://QmRLEdPvw2z2mSYRCgGSxqektGtnFd5G1G2DsW6i3sRt2R";
    ...
    uint256 internal devWithdrawPercent = 4500;

    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("Interactive", "INT") {}
