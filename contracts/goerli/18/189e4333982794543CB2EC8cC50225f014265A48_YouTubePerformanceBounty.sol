...
// File: YouTubePerformanceBounty.sol
...
contract YouTubePerformanceBounty is ChainlinkClient, ConfirmedOwner {
    ...
    uint256 public desiredViewsCount;
    uint256 public desiredCommentsCount;
    ...
    event RequestMetricsFulfilled(bytes32 indexed requestId, uint256 views, uint256 comments);

    constructor(
        address _funder,
        address _receiver,
        string memory _videoId,
        uint256 _desiredViewsCount,
        uint256 _desiredCommentsCount,
        uint256 _deadline,
        ...
        setChainlinkToken(_linkAddress); // address of the LINK contract ie: on Goerli 0x326C977E6efc84E512bB9C30f76E30c160eD06FB
        setChainlinkOracle(_oracleAddress);  // address of the Chainlink Oracle/Operator contract ie: on Goerli 0x03cD282a023cB0A7311A5049A68399cfd43bB870
        fee = _chainlinkFee; // 0,1 * 10**18 (Varies by network and job)

        desiredViewsCount = _desiredViewsCount;
        desiredCommentsCount = _desiredCommentsCount;
        deadline = _deadline;
     ...
     * data
     */
    function requestMetrics() public returns (bytes32 requestId) {
    ...
    function fulfill(
        ...
        emit RequestMetricsFulfilled(_requestId, _views, _comments);
        views = _views;
        comments = _comments;
    }
