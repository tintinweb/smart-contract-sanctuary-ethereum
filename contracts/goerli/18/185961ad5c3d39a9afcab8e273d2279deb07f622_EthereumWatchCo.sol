...
// goerli deployed at: https://goerli.etherscan.io/address/0x8006e47ea33b956582e6efee627b6c63e724db65 
...
contract EthereumWatchCo is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 private constant MINT_PRICE = 0.00 ether;
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    encode(bytes(tokenURIJSON(_tokenId)))
                )
            );
    }
