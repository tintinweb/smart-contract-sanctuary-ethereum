...
contract BaseNFTSale is Ownable, ERC721Holder, ERC1155Holder {
    ...
    function nftTransfer(address nft, uint8 nftType, address from, address to, uint256 tokenId,  uint256 amount) internal {
    ...
    function withdrawNFT(address nft, uint8 nftType, address from, address to, uint256 tokenId, uint256 amount) external onlyOwner {
