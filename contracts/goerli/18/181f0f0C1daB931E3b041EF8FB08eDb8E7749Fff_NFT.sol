...
contract NFT is ERC721, Ownable {
    ...
    uint public constant MAX_TOKENS = 50000;
    ...
    constructor() ERC721("SHAREIO", "SHARE") {
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= MAX_MINT_PER_TX, "MAX 10 NFTS.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xd1425226ABA7a898F1f8261d67c369fbCba65265).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xd1425226ABA7a898F1f8261d67c369fbCba65265).call{value: balanceTwo}("");
