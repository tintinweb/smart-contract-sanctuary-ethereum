...
contract BlurFarmer is TinyERC721, Ownable, ReentrancyGuard {
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"BlurFarmer #',
                                _tokenId,
                                '", "description":"Use this to farm BLUR. Can be burned for 1E at any time", "image": "',
                                imageURI,
                                '"}'
                            )
                        )
    ...
    //         toString(tokenId),
    //         '",',
    //         '"description": "BlurFarmer is for BLUR farming. Token can be burned for 1 ETH.",',
    //         '"image": "',
    //         svg,
    //         '"',
    //         "}"
    //     );
    //     return string(abi.encodePacked(Base64.encode(dataURI)));
    // }
