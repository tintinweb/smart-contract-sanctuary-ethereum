...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, AccessControl {
    ...
    address public angelCardDataAddress =
        ...
        0x7A08cbA76746FBF45a099b92864cc9510C46b640;
    address public petCardDataAddress =
        // 0xB340686da996b8B3d486b4D27E38E38500A9E926;
        0xC65e296936Ef5062fC0f0809DCECF22Fa0Ee2563;
    ...
    address payable public paymentSplitter =
        payable(0x1A5E2ee2c68f6492971313340b1593713006Cd33);

    // Initial owner, angelbattles.eth
    address public owner =
        payable(0x20886Ba6fD8731ed974ba00108F043fC9006e1f8);
    ...
    function buyCard(uint8 _cardSeries) public payable {
        ...
        if (_cardSeries > 23 && _cardSeries < 43) {
            ...
            uint id = PetCardData.getTotalPets();
        ...
        if (_cardSeries > 42) {
            ...
            AccessoryCardData.setAccessory(
                _cardSeries - 42,
                address(this)
            );
            uint id = AccessoryCardData.getTotalAccessories();
