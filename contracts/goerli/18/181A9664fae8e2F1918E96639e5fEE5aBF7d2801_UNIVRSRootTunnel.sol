...
/**
 * @title UNIVRSRootTunnel
 */
contract UNIVRSRootTunnel is FxBaseRootTunnel, Create2 {
    ...
    function deposit(
        ...
        require(
            ...
            "UNIVRSRootTunnel: NO_MAPPING_FOUND"
        );
    ...
    function _processMessageFromChild(bytes memory data) internal override {
        ...
        if (
            ...
            require(
                ...
                "UNIVRSRootTunnel: ROOT_TOKEN_CREATION_MISMATCH"
            );
        }
