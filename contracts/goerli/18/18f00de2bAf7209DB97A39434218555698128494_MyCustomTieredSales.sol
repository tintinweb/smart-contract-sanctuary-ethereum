...
contract MyCustomTieredSales is OwnableInternal, TieredSales, ReentrancyGuard {
    ...
    bytes32 internal constant STORAGE_SLOT = keccak256("v1.my-team.contracts.storage.MyCustomTieredSales");
     ...
     */
    function setTargetTokenAddressFirst(address targetTokenAddressFirst) external onlyOwner {
        layout().targetTokenAddressFirst = targetTokenAddressFirst;
    }

    function setTargetTokenAddressSecond(address targetTokenAddressSecond) external onlyOwner {
        layout().targetTokenAddressSecond = targetTokenAddressSecond;
    }
