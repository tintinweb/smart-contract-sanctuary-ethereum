...
// import { ERC5050Receiver, IERC5050Receiver, Action } from "./helpers/ERC5050/standard/ERC5050Receiver.sol";
    ...
    IRiftBurnable
{
    ...
    address private openSeaProxyRegistryAddress; // deprecated
    bool private isOpenSeaProxyActive; // deprecated

    IRiftData public iRiftData;

    // HYPERXP
    IHXP public hyperXP;
    IERC721 spellsContract;
        ...
        public 
    {
        ...
        require(spellsContract.ownerOf(spellId) == _msgSender(), "Not owner of spell");
    ...
    // {
    //     require(
    //         msg.sender == address(spells),
    //         "sender not spells"
    //     );
    //     require(
    //         crystalsMap[action.to.tokenId] != 0,
    //         "Invalid Crystal"
    //     );
    ...
    // function ownerSetReceivables() external onlyOwner {
    //     _registerReceivable("cast");
    // }

    function ownerSetSpells(address _spells) external onlyOwner {
        spellsContract = IERC721(_spells);
    }

    function ownerSetHyperXP(address _hxp) 
    external 
    onlyOwner {
        hyperXP = IHXP(_hxp);
    }
