 ...
 * @notice This contract handles minting TONY STARK tokens.
 */
contract TONYSTARK is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x6319c29eECDFd8377Ddc163A3bb544942B81233c;
    ...
    address public royaltyAddress = 0xA003D34A73C4623c8D97007F686728f5866ef7c2;
    address[] public payoutAddresses = [
        0x931EDB91f878Ff8ACC36cFD063A6277A3f52E1a1
    ];
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeidpiu5bofczmoxavycaibfoylp6o6qxypnvaokv52jxrfzjkt5hvu/{id}"
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1672165800;
        tokenPublicSaleEndTime[1] = 1675103400;
