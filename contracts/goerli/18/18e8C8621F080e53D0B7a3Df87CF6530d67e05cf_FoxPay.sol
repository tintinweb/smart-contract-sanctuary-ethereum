    ...
    IFoxPay
{
    ...
    function startDate(uint256 tokenId_) public view returns (uint256) {
        ...
        (uint256 expireYear_, uint256 expireMonth_, ) = BokkyPooBahsDateTimeLibrary.timestampToDate(
            expireDate(tokenId_).addHours(9)
        );
        ...
        return BokkyPooBahsDateTimeLibrary.timestampFromDate(startYear, startMonth, 1).subHours(9);
    }
    ...
    function expireDate(uint256 tokenId_) public view returns (uint256) {
        ...
        return BokkyPooBahsDateTimeLibrary.timestampFromDateTime(year, month, day, 15, 0, 0);
    }
...
contract FoxPayMetadataDescriptor is IERC3525MetadataDescriptor {
    ...
    function _generateSVGTexts(
        ...
        for (uint i; i < 8 - tokenIdLength; i++) {
            tokenIdStr = string.concat(zero.toString(), tokenIdStr);
        }
