...
import "https://github.com/nabil-boudouch/coll77/blob/main/rew77.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Enumerable.sol";

contract VAULTNAB77 is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, REWUpNab77  _token) { 
    nft = _nft;
    token = _token;
  }
...
contract REWUpNab77 is ERC20, ERC20Burnable, Ownable {

  mapping(address => bool) controllers;
  
  constructor() ERC20("REWUpNab77", "REWNab77") { }
