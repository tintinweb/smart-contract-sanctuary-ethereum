...
contract PRBProxy is IPRBProxy {
    ...
    constructor() {
        ...
        emit TransferOwnership({ oldOwner: address(0), newOwner: owner });
    }
    ...
    function transferOwnership(address newOwner) external override {
        ...
        // Load the owner since it's needed for the event.
        ...
        emit TransferOwnership({ oldOwner: oldOwner, newOwner: newOwner });
    }
