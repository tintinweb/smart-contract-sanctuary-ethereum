...
contract ERC1167Factory is ContextUpgradeable {
    ...
    /**
     * @dev Deploy implementation contract
     */
    function deployDeterministic(bytes32 salt, bytes memory data) public returns (address implementation) {
        implementation = Create2Upgradeable.deploy(0, salt, data);
