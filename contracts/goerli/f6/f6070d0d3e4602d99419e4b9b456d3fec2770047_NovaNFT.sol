...
import "./StoryPassWhitelist.sol";

contract NovaNFT is Initializable, OwnableUpgradeable, StoryPassWhitelist, UUPSUpgradeable {
    function initialize() initializer override public {
        __Ownable_init_unchained();
        __StoryPassWhitelist_init("Nova NFT", "NOVA");
    }
...
import "./StoryPass.sol";
import "@openzeppelin/contracts-upgradeable/utils/cryptography/MerkleProofUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

contract StoryPassWhitelist is Initializable, StoryPass {

    bytes32 public merkleRoot;
    mapping(address => bool) public claimed;

    function __StoryPassWhitelist_init(string memory name_, string memory symbol_) internal onlyInitializing {
        __StoryPass_init(name_, symbol_);
    }

    function initialize() initializer virtual override  public {
        __StoryPass_init("StoryPassWhitelist", "SPASSWL");
    }
    ...
    function mint(bytes32[] calldata merkleProof) external {
        ...
        require(MerkleProofUpgradeable.verify(merkleProof, merkleRoot, toBytes32(msg.sender)) == true, "invalid merkle proof");
        mintPass();
    }
...
contract StoryPass is Initializable, ERC721URIStorageUpgradeable {
    ...
    function __StoryPass_init(string memory name_, string memory symbol_) internal onlyInitializing {
    ...
    function initialize() initializer virtual public {
        __ERC721_init_unchained("StoryPass", "SPASS");
        __ERC721URIStorage_init_unchained();
    }
