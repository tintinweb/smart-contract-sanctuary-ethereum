...
contract Spacebear is ERC721, Ownable {
    ...
    constructor() ERC721("Spacebear", "SPBE") {}
    ...
    function buyToken() public payable {
        uint256 tokenId = _tokenIdCounter.current();
        //console.log("gotcha", tokenId, msg.value);
        require(msg.value == tokenId * 0.1 ether, "wrong amount of funds sent");
        _tokenIdCounter.increment();
        _safeMint(msg.sender, tokenId);
    }

    function getCurrentPriceToMintNewToken() public view returns (uint256) {
        return _tokenIdCounter.current() * 0.1 ether;
    }
    ...
    {
        return string(abi.encodePacked(_baseURI(), "spacebear_", (tokenId.toString()), ".json")); 
    }
}