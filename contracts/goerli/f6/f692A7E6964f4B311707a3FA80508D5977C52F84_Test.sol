...
library RenderTime {
    ...
    string constant svg4 = '<circle cx="400" cy="400" r="1.5" stroke="white" stroke-width="1" fill="white" />';
    string constant svg5 = '<rect x="300" y="300" width="200" height="200" stroke="#F2F2F2" stroke-width="0.5" fill="none" rx="5" ry="5"/></svg>';
    ...
    function renderSvg(uint age) internal pure returns (string memory) {
        ...
        string memory second = string(abi.encodePacked(
            ...
            ',450,450)">',
            '<line x1="400" y1="400" x2="400" y2="330" stroke="#F4F4F4" stroke-width="0.3" /></g>' 
        ));
