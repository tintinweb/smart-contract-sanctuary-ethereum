...
contract release_v1 is ERC721, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    // uint16[10] public availablePunks;
    ...
    //     availablePunks[v] = availablePunks[currentLength - 1];
    //     delete availablePunks[currentLength - 1];
