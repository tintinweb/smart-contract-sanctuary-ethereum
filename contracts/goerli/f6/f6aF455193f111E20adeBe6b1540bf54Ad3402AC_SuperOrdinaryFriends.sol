    ...
    Ownable
{
        ...
        Ownable()
    {
        ...
        price[Phases.OGLIST] = 0.05 ether;
        price[Phases.WHITELIST] = 0.05 ether;
        price[Phases.WAITLIST] = 0.05 ether;
        price[Phases.PUBLIC] = 0.05 ether;
    }
    ...
    function setFilter(bool value) external onlyRole(DEFAULT_ADMIN_ROLE) {
        filter = value;
    }
