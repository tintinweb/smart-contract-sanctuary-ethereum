...
contract NFTmy is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, EIP712, ERC721Votes{
	...
	uint256 private immutable NUMBER_OF_RESERVED_BOX;
	uint256 private immutable MAX_BOX_SUPPLY; 
	uint256 private immutable MAX_BOX_SMALL;        
	uint256 private immutable MAX_BOX_MEDIUM;
    uint256 private immutable MAX_BOX_LARGE;
    uint256 private immutable MAX_BOX_ULTRA;
    uint256 private immutable MAX_BOX_MEGA;    
    uint256 private immutable MAX_MINTS_PER_ADDRESS; 
     struct MintTypes {
...
mapping(address => MintTypes) public addressToMints;
   ...
   constructor() ERC721("MYNFT", "MYCOLLECTION") EIP712("",""){
    ...
    function safeMint(uint256 count) public payable
    {
        ...
        function _mintRandomId(address ) private {
