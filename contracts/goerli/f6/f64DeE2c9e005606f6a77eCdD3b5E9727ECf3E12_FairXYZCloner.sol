...
contract ERC721Deploy is Ownable, ReentrancyGuard, ERC165, IERC721, IERC721Metadata {
  ...
  string  public  baseTokenURI = "ipfs://QmbHmLWmjVGX1vGDHsdXHCUiP5C876Zr6uCkWFVZ7FpMrg/";
...
contract FairXYZCloner is ERC721Deploy{
    ...
    constructor() payable ERC721Deploy(_name,_symbol){
     ...
     function initialize(uint256 maxTokens_, uint256 nftPrice_, string memory name_, string memory symbol_,
        ...
        require(!isBase,"This has been initialized.");
