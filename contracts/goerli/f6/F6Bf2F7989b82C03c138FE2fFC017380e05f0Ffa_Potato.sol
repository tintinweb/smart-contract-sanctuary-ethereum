...
contract Potato is ERC721Delegated {
    ...
    uint public collectionSize = 1001;
    ...
    function mint() external payable {
        ...
        require(freeMinted[msg.sender] == false && msg.value != 0, "Do not pay for the first potato");
        require(freeMinted[msg.sender] == true && msg.value != price, "You have to pay for your potato");
    ...
    function mintBatch (uint256 amount) external payable {
        ...
        require(freeMinted[msg.sender] == true && amount * price != msg.value, "Payable amount doesnt match. Wallet already claimed free potato");
        require(freeMinted[msg.sender] == true && amount * price - price != msg.value, "Payable amount doesnt match. Wallet can get a free potato");
