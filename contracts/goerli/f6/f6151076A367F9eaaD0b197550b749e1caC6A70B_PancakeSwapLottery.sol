...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    uint256 public maxPriceTicketInCake = 50 * (10**6);
    uint256 public minPriceTicketInCake = 0.005 * (10**6);
    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        if (_autoInjection) {
            ...
            if (amountToWithdrawToTreasury < amountToShareToWinners) {
                feeAfterDraw =
                    (amountToWithdrawToTreasury * feeAfterDrawLottery0) /
                    10000;
            ...
            if (amountToWithdrawToTreasury >= amountToShareToWinners) {
                feeAfterDraw =
                    (amountToWithdrawToTreasury * feeAfterDrawLottery1) /
                    10000;
     ...
     * @dev Only callable by owner
     */
    function setMaxNumberTicketsPerBuy(uint256 _fee0, uint256 _fee1)
        external
        onlyOperator
    {
