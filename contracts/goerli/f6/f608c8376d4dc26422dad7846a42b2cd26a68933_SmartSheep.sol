...
contract SmartSheep is ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    constructor() ERC721("SmartSheep", "SS") {}

    function safeMint(address to, string memory uri) public {
        require(to == _msgSender(), "invalid address");
        require(_tokenIdCounter.current() <= MAX_SUPPLY, "I'm sorry we reached the cap");
        require(balances[to] < 5, "Each person can only mint 5 NFTs");
