...
contract LBSKR is IERC20, Ownable, Manageable, Pausable, DSMath {
    ...
    // Returns the current accumulated LBSKR rewards
    ...
    // Returns the total number of stake holders
    function getTotalStakeholders() external view returns (uint256) {
        return stakeholders.length();
    }

    // Returns the total number of stakes
    ...
    // Sets max transaction size for LBSKR - TODO we are not limiting LBSKR?
