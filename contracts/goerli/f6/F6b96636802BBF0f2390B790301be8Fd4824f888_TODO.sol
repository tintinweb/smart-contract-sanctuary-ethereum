...
contract TODO is ERC721, Ownable {
	...
	modifier overallSupplyCheck() {
		...
		require(mintedSupply < maxSupply, "All NFTs have been minted");
		_;

	}

	constructor() ERC721("TODO", "TODO") {}
	
	function remainingNFTs() private view returns (string memory) {
		
        return string(abi.encodePacked("Only ", (maxSupply - mintedSupply).toString(), " NFTs left in supply"));
    }
	...
	function mint(uint mintAmount) external overallSupplyCheck {
		...
		require(mintAmount > 0 && mintAmount < 3, "Must mint 1 or 2 NFTs at a time");
		require(addressMintedAmount[msg.sender] + mintAmount < 3, "Maximum 2 TODO minted per wallet");
