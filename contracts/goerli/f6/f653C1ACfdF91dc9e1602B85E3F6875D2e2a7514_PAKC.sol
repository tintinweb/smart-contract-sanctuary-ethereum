...
contract PAKC is Ownable, Stakeable {
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0), "PAKC: cannot mint to zero address");
    ...
    function _burn(address account, uint256 amount) internal {
        require(account != address(0), "PAKC: cannot burn from zero address");
        require(
            _balances[account] >= amount,
            "PAKC: Cannot burn more than the account owns"
        );
        _balances[account] = _balances[account] - amount;
        _totalSupply = _totalSupply - amount;
    ...
    function _transfer(
        ...
        require(sender != address(0), "PAKC: transfer from zero address");
        require(recipient != address(0), "PAKC: transfer to zero address");
        require(
            _balances[sender] >= amount,
            "PAKC: cant transfer more than your account holds"
        );
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "PAKC: approve cannot be done from zero address"
        );
        require(
            spender != address(0),
            "PAKC: approve cannot be to zero address"
        );
    ...
    function transferFrom(
        ...
        require(
            ...
            "PAKC: You cannot spend that much on this account"
        );
    ...
    function stake(uint256 _amount) public {
        require(
            ...
            "PAKC: Cannot stake more than you own"
        );
