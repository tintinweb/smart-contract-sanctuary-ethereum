...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) public payable {
        require(_addr == owner(), "Only owner can withdraw a prize");
    ...
    function riggedRoll() public payable {
        ...
        console.log('\t',"  it's going to be a winner!");
        uint256 setGasLimit = 500000;
        uint256 setValue = 0.002 ether;
        prize = diceGame.rollTheDice{value: setValue, gas: setGasLimit}();
        if (prize > 0) {
            withdraw(owner(), prize);
        }
