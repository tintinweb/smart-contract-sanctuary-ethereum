...
contract Sorce2 is ERC721A, Ownable, ReentrancyGuard {
    constructor() ERC721A("CULTIVATE - SORCE VIAL [UNPOWERED]", "SORCE") {
        _mint(msg.sender, 1);
    }

    string private _baseTokenURI =
        "https://storage.googleapis.com/bucket-cultivate/sorce/sorce-unpowered-metadata/";
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmdRnUHUKMQ3vXTwFuNe29fo44vDQ2qb4CtQ5BFRvvM64W";
    }
}
