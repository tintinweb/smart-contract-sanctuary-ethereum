...
contract DividendPoolSales is Ownable {
    ...
    // seaside nft
    IDividendPoolNFT public immutable dividendPoolNFT;

    // real estate sale enable flags
    bool public dividendPoolSalesEnabled;
    ...
    constructor(
        ...
        dividendPoolNFT = IDividendPoolNFT(dividendPoolNFT_);
    }
    ...
    */
    ...
    function setDividendPoolSalesEnabled(bool enabled) external onlyOwner {
        dividendPoolSalesEnabled = enabled;
    }
    ...
    */
    modifier whenAllowed() {
        require(isAllowed[msg.sender], "DividendPoolSales: address is not allowed to call this function");
        _;
    }
    ...
    */
    ...
    function buy(uint256 amount, uint256 splitNFTCount, Coin coinType) external whenAllowed {
        require(dividendPoolSalesEnabled, "DividendPoolSales: sale is not enabled");
        require(splitNFTCount <= getMaxSplitCount(amount), "DividendPoolSales: split count exceed it's limit");
        require(amount >= priceLimit, "DividendPoolSales: amount should be greater than price limit ");
