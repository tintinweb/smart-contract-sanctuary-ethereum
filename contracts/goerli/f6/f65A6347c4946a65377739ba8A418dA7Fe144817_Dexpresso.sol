...
contract Dexpresso is IDexpresso, Pausable {
    ...
    /// @dev orderStatus mapps the address of the user to one of it's orderID to it's order status
     ...
     *
     * @dev orderCancelled event is emitted with the masg.sender(users address) and the orderID,
     * @param _orderID is the ID of the order the user wants to cancel.
     *
     */
