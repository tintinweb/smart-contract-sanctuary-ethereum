...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [0x0fa2f5f737f82b04eE4ec723B441263D6d58D897];
...
// File: contracts/ArtsDaOxLedgerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract ArtsDaOxLedgerContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Arts DAO x Ledger";
    string public symbol = "ADLedger";
