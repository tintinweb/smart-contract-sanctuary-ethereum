/**
 * fake LOOT contract for testing purposes.
 * This contract can be deployed and then claimed to test claim() functions
*/
...
contract FakeLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("Fake Loot", "FLOOT") Ownable() {}
}
