...
contract Hearts is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_PER_TX = 20; // Max amount of Hearts per tx (public sale)
    uint256 public constant MAX_PER_WALLET_PUBLIC = 20; // Max amount of hearts per wallet during public sale.
    
    uint256 public constant PRICE = 0.00000000000005 ether;
    ...
    function mint(uint256 quantity) external payable onlyPublicSale {
        // Remove this to make deploy_hearts.ts work
