    ...
    ReentrancyGuard
{
     ...
     */
    function mint(address to, uint256 tokenId) isValidToken(tokenId) external payable nonReentrant {
    ...
    function meetsPaymentRequirements(uint256 tokenId) private returns(bool) {
        ...
        require(
            ...
            (msg.value != 0 && 
                Math.mulDiv(publicPrices[tokenId], 21, 20) <= estimateUSDCValue(msg.value)
            ) ||
