...
// File: contracts/YouAreTheChampion.sol
...
contract YouAreTheChampion is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable , UUPSUpgradeable{
    ...
    uint256 public constant MAX_ELEMENTS = 520;
    ...
    function initialize() initializer public{
        __ERC721_init("YouAreTheChampion", "YATC");
    ...
    function safeMint(uint8 num, address to) public onlyRole(MINTER_ROLE) {
        require(_tokenIdCounter.current() - 1 + num <= MAX_ELEMENTS , "not enough tokens left to mint");
