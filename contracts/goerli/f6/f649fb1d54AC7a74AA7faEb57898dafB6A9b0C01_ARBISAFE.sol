...
contract ARBISAFE is ERC20, Ownable {
    ...
    address payable public _marketingWallet = payable(address(0xd30c61dD6E2673A2765C0Dd47A3e13041e2caFd5));
    ...
    constructor() ERC20("ARBI SAFE", "ASAFE") {
    ...
    function updateRouter(address newAddress) public onlyOwner {
        require(newAddress != address(sushiswapRouter), "ASAFE The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ASAFE Account is already excluded");
    ...
    function _transfer(
        ...
        if (takeFee && (automatedMarketMakerPairs[from] || automatedMarketMakerPairs[to])) {
            ...
            uint256 fees = amount.mul(marketingFee).div(1000);
