...
contract AtamoAscension is ERC721A, VRFConsumerBaseV2, Ownable {
    ...
    uint64 public s_subscriptionId = 6908;
    ...
    function addPrizes(uint256[] calldata ids) public onlyOwner {
    ...
    function selectRandomWinnersForPrizes() public onlyOwner {
    ...
    function withdrawToRecipients() external onlyOwner {
        ...
        address owner           = 0xFcc9313204Dd02D6c335B43a8F06704485a3d8e2;
