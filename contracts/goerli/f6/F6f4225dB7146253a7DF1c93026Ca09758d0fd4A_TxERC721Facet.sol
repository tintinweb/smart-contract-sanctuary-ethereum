...
contract TxERC721Facet is IOperations {
    ...
    /* ------ EXTERNAL FUNTIONS ------ */
    function depositERC721(uint88 _tokenId, IERC721 _tokenAddress) external {
        ...
        Deposit memory deposit = Deposit({from: msg.sender, listingId: listingId_, tokenId: _tokenId, amount: 1});
