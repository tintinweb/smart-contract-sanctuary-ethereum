...
library Sealib {
    ...
    function buildOrderFor(
        ...
        safeConsideration.startAmount = 1; // Always allocate 1 wei since seaport doesn't allow transfers of 0 eth
        safeConsideration.endAmount = 1;
        safeConsideration.recipient = payable(offerer);

        // Opensea fee. 2.5% of revenue
        uint256 openseaRevenue = (amount * (100e18 - 2.5e18)) / 100e18;
        ...
        uint256 revenue = amount - openseaRevenue - 1; //Minus 1 wei from safeConsideration
