...
{   
   ...
   function verifyAdminRole() internal view override returns (bool) {
    ...
    function getMintPrice(uint256 _salesPhaseId, uint256 amount) external view returns(uint256 price){
        price = salesPhase.phases[_salesPhaseId].pricePerToken * amount;
    } 
