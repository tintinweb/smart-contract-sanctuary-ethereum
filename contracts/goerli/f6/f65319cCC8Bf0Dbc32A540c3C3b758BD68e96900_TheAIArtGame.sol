...
contract TheAIArtGame is Ownable, ERC2981, ERC721A, ReentrancyGuard {
    ...
    //mapping of the above arrays into a Struct

    string[10] arrayNames = [
        "funnyWords",
        "nounLivingThings",
        "adjectiveColors",
    ...
    string public test = [arrayNames[0]][0];
    ...
    function grabMyWord(uint256 tokenId) public view returns (string memory) {
        ...
        return
            [arrayNames[wordIndex]][
                generateSeed(tokenId) % [arrayNames[wordIndex]].length
            ];
    }
