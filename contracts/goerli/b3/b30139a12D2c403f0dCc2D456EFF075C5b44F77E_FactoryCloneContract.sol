...
contract FactoryCloneContract is Ownable {
        ...
        returns (address)
    {
        ...
        if (!_params.isTemplateErc721) {
            ...
            data = abi.encodeWithSignature(
                "initializeERC721(uint256,uint256,uint256,uint256,address,address,address,address[],address)",
                _params.ownerFeePerDeposit,
                _params.depositFunctioningDays,
                _params.quorum,
                _params.threshold,
    ...
    IERC721Receiver
{
    ...
    function mintNftToken(address to) internal {
        Nft(nftContractAddress).mintToken(to);
    }
