...
interface WhitelistContract {
    function invitationList(address key) external view returns (bool);
}

contract TeleptPassMerkle is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("TeleptPassMerkle", "TELEPT") {}
