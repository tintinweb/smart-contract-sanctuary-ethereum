...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xc274F2e0969704fA509A09203f6349449525fD9F];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xc274F2e0969704fA509A09203f6349449525fD9F;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiac7hmvrgatboire4y5z6yxrfn3fjvl2hhue4p34fnadnzedfywxu/";
...
// File: contracts/GoerliTest20Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoerliTest20Contract is RamppERC721A {
    constructor() RamppERC721A("GoerliTest20", "GOERLI"){}
}
