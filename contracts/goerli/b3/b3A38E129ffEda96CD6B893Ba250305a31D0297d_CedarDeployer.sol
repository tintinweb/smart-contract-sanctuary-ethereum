...
contract CedarDeployer is Initializable, UUPSUpgradeable, AccessControlUpgradeable, BaseCedarDeployerV10 {
    ...
    {
        return drop721DelegateLogicFactory.implementationVersion();
    }
    ...
    {
        return drop1155DelegateLogicFactory.implementationVersion();
    }
    ...
    function cedarERC721DropDelegateLogicFeatures() external view override returns (string[] memory features) {
        return drop721DelegateLogicFactory.implementation().supportedFeatures();
    }

    function cedarERC1155DropDelegateLogicFeatures() external view override returns (string[] memory features) {
        return drop1155DelegateLogicFactory.implementation().supportedFeatures();
    }
    ...
    function _payDeploymentFee() internal {
        if (deploymentFee > 0 && feeReceiver != address(0)) {
            feeReceiver.transfer(deploymentFee);
        }
    }
...
contract CedarERC721DropDelegateLogicFactory is
    Ownable,
    ICedarERC721DropDelegateLogicFactoryEventsV0,
    ICedarImplementationVersionedV0
{
    ...
    constructor() {
        ...
        (uint256 major, uint256 minor, uint256 patch) = implementation.implementationVersion();
        emit CedarImplementationDeployed(address(implementation), major, minor, patch, "IAccessControlV0");
    }
    ...
    /// ===================================
    function _emitEvent(EventParams memory params) private {
        emit CedarERC721DropDelegateLogicDeployment(
            params.contractAddress,
            params.majorVersion,
            params.minorVersion,
            params.patchVersion
...
contract CedarERC1155DropDelegateLogicFactory is
    Ownable,
    ICedarERC1155DropDelegateLogicFactoryEventsV0,
    ICedarImplementationVersionedV0
{
    /// ===============================================
    ///  ========== State variables - public ==========
    ...
    /// ===================================
    function _emitEvent(EventParams memory params) private {
        emit CedarERC1155DropDelegateLogicDeployment(
            params.contractAddress,
            params.majorVersion,
            params.minorVersion,
            params.patchVersion
...
/// Inherit from this base to implement introspection
abstract contract BaseCedarERC721DropV7 is ICedarERC721DropV7 {
...
import "./CedarERC721DropStorage.sol";
import "../generated/impl/BaseCedarERC721DropDelegateLogicV0.sol";
import "./CedarERC721DropLogic.sol";
...
contract CedarERC721DropDelegateLogic is
    ...
    BaseCedarERC721DropDelegateLogicV0
{
    /// ================================
    /// =========== Libraries ==========
    /// ================================
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(BaseCedarERC721DropDelegateLogicV0, CedarERC721DropStorage)
        returns (bool)
    {
        return
            CedarERC721DropStorage.supportsInterface(interfaceId) ||
            BaseCedarERC721DropDelegateLogicV0.supportsInterface(interfaceId);
    }
...
// Generated by impl.ts. Will be overwritten.
// Filename: './BaseCedarERC721DropDelegateLogicV0.sol'

pragma solidity ^0.8.4;

import "../../api/impl/ICedarERC721DropDelegateLogic.sol";

/// Inherit from this base to implement introspection
abstract contract BaseCedarERC721DropDelegateLogicV0 is ICedarERC721DropDelegateLogicV0 {
    function supportedFeatures() override public pure returns (string[] memory features) {
        features = new string[](11);
        features[0] = "ICedarFeatures.sol:ICedarFeaturesV0";
        features[1] = "ICedarVersioned.sol:ICedarVersionedV2";
        features[2] = "agreement/ICedarAgreement.sol:IRestrictedAgreementV0";
        features[3] = "issuance/ICedarNFTIssuance.sol:IRestrictedNFTIssuanceV0";
        features[4] = "lazymint/ICedarLazyMint.sol:IRestrictedLazyMintV0";
        features[5] = "pausable/ICedarPausable.sol:IRestrictedPausableV0";
        features[6] = "metadata/IContractMetadata.sol:IRestrictedMetadataV0";
        features[7] = "baseURI/ICedarUpdateBaseURI.sol:IRestrictedUpdateBaseURIV0";
        features[8] = "royalties/IRoyalty.sol:IRestrictedRoyaltyV0";
        features[9] = "primarysale/IPrimarySale.sol:IRestrictedPrimarySaleV1";
        features[10] = "issuance/INFTLimitSupply.sol:INFTLimitSupplyV0";
    }
    ...
    function implementationInterfaceId() virtual override public pure returns (string memory interfaceId) {
        interfaceId = "impl/ICedarERC721DropDelegateLogic.sol:ICedarERC721DropDelegateLogicV0";
    }

    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || ((interfaceID == type(ICedarFeaturesV0).interfaceId) || ((interfaceID == type(ICedarVersionedV2).interfaceId) || ((interfaceID == type(IRestrictedAgreementV0).interfaceId) || ((interfaceID == type(IRestrictedNFTIssuanceV0).interfaceId) || ((interfaceID == type(IRestrictedLazyMintV0).interfaceId) || ((interfaceID == type(IRestrictedPausableV0).interfaceId) || ((interfaceID == type(IRestrictedMetadataV0).interfaceId) || ((interfaceID == type(IRestrictedUpdateBaseURIV0).interfaceId) || ((interfaceID == type(IRestrictedRoyaltyV0).interfaceId) || ((interfaceID == type(IRestrictedPrimarySaleV1).interfaceId) || ((interfaceID == type(INFTLimitSupplyV0).interfaceId) || (interfaceID == type(ICedarERC721DropDelegateLogicV0).interfaceId))))))))))));
    }
...
interface ICedarERC721DropDelegateLogicV0 is
    ICedarFeaturesV0,
    ICedarVersionedV2,
    IRestrictedAgreementV0,
...
import "./CedarERC1155DropStorage.sol";
import "../generated/impl/BaseCedarERC1155DropDelegateLogicV0.sol";

contract CedarERC1155DropDelegateLogic is
    IRestrictedOwnable,
    IRestrictedPlatformFee,
    CedarERC1155DropStorage,
    BaseCedarERC1155DropDelegateLogicV0
{
    /// ================================
    /// =========== Libraries ==========
    /// ================================
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(BaseCedarERC1155DropDelegateLogicV0, CedarERC1155DropStorage)
        returns (bool)
    {
        return
            CedarERC1155DropStorage.supportsInterface(interfaceId) ||
            BaseCedarERC1155DropDelegateLogicV0.supportsInterface(interfaceId);
    }
...
// Generated by impl.ts. Will be overwritten.
// Filename: './BaseCedarERC1155DropDelegateLogicV0.sol'
...
/// Inherit from this base to implement introspection
abstract contract BaseCedarERC1155DropDelegateLogicV0 is ICedarERC1155DropDelegateLogicV0 {
    function supportedFeatures() override public pure returns (string[] memory features) {
        features = new string[](11);
        features[0] = "ICedarFeatures.sol:ICedarFeaturesV0";
        features[1] = "ICedarVersioned.sol:ICedarVersionedV2";
        features[2] = "agreement/ICedarAgreement.sol:IRestrictedAgreementV0";
        features[3] = "issuance/ICedarSFTIssuance.sol:IRestrictedSFTIssuanceV0";
        features[4] = "lazymint/ICedarLazyMint.sol:IRestrictedLazyMintV0";
        features[5] = "pausable/ICedarPausable.sol:IRestrictedPausableV0";
        features[6] = "metadata/IContractMetadata.sol:IRestrictedMetadataV0";
        features[7] = "baseURI/ICedarUpdateBaseURI.sol:IRestrictedUpdateBaseURIV0";
        features[8] = "royalties/IRoyalty.sol:IRestrictedRoyaltyV0";
        features[9] = "primarysale/IPrimarySale.sol:IRestrictedPrimarySaleV1";
        features[10] = "issuance/ISFTLimitSupply.sol:ISFTLimitSupplyV0";
    }
    ...
    function implementationInterfaceId() virtual override public pure returns (string memory interfaceId) {
        interfaceId = "impl/ICedarERC1155DropDelegateLogic.sol:ICedarERC1155DropDelegateLogicV0";
    }

    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID == type(IERC165Upgradeable).interfaceId) || ((interfaceID == type(ICedarFeaturesV0).interfaceId) || ((interfaceID == type(ICedarVersionedV2).interfaceId) || ((interfaceID == type(IRestrictedAgreementV0).interfaceId) || ((interfaceID == type(IRestrictedSFTIssuanceV0).interfaceId) || ((interfaceID == type(IRestrictedLazyMintV0).interfaceId) || ((interfaceID == type(IRestrictedPausableV0).interfaceId) || ((interfaceID == type(IRestrictedMetadataV0).interfaceId) || ((interfaceID == type(IRestrictedUpdateBaseURIV0).interfaceId) || ((interfaceID == type(IRestrictedRoyaltyV0).interfaceId) || ((interfaceID == type(IRestrictedPrimarySaleV1).interfaceId) || ((interfaceID == type(ISFTLimitSupplyV0).interfaceId) || (interfaceID == type(ICedarERC1155DropDelegateLogicV0).interfaceId))))))))))));
    }
