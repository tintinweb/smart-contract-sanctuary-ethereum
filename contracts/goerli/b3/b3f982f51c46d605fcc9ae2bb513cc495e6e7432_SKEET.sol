...
contract SKEET is ERC20, Ownable {
    ...
    address public marketingWallet = 0xF2ccd579b4A0783c70D20af1BeFA6bD06BE93fae;
    address private devWallet = 0xef550de9c5189C5FF6BAEe8f603F40B87fc071ef;
    ...
    constructor() ERC20("SKEET", "SKEET") {
        _tokengeneration(msg.sender, 1e7 * 550**decimals());
