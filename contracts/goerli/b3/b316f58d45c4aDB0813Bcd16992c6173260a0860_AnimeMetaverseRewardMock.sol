...
import "./AmvUtils.sol";
import "../interfaces/IAnimeMetaverseReward.sol";
    ...
    IAnimeMetaverseReward
{
    ...
    function mintBatch(
        ...
        for (
            uint256 idCounter = 0;
            idCounter < _ids.length;
            idCounter = _uncheckedInc(idCounter)
        ) {
...
/// @dev this contract is the the mock contract being used for testing
contract AnimeMetaverseRewardMock is AnimeMetaverseReward {
    constructor() AnimeMetaverseReward() {}

    // @dev freeMint function used to mint free NFTs to any address for testing purposes
    function freeMint(
        address _to,
        uint256 _id,
        uint256 _amount,
