...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    constructor()
        ERC1155(
            "https://continentkey-genesis-key.mypinata.cloud/ipfs/QmeTcKLxDch2avA7YEMcvNArsLs9UhfHJ2ZWdKk5wefeX6/{id}.json"
        )
    {
        contractUri = "https://continentkey-opensea.mypinata.cloud/ipfs/QmNWvnp1TDTcYWKeq8gmattyAWLgSnTL6ACopPtCcf2YD1"; // json contract metadata file for OpenSea
