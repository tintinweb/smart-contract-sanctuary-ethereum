...
contract MockERC721 is Ownable, ERC721 {
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    "{",
                                    '"name": "Mock ERC-721", ',
                                    '"description": "This is a Mock ERC-721 collection"',
                                    "}"
                                )
                            )
                        )
                        ...
                        bytes(
                            string(
                                abi.encodePacked(
                                    ...
                                    toString(id),
                                    '", ',
                                    '"description": "I am a mock ERC-721 Token", ',
                                    '"image": "ipfs://QmY4wycPhiWM9YujgZ6fiyJgac2Yv2NCqZcEyDBJ3rphe5", ',
                                    '"attributes": [{"trait_type": "Mock", "value": "Very Much So"}]',
                                    "}"
                                )
                            )
                        )
    ...
    function multiMint(address to, uint256 quantity) public {
