...
contract test is ERC721, Ownable, RandomlyAssigned {
  ...
  string public baseURI = "https://ipfs.io/ipfs/QmNvMFz3nVRAF6JvjK6pTUe1Yj4xBYf6t2sgezNKb2Euhy/";

  constructor() 
    ERC721("Planet Vision", "PVN")
    RandomlyAssigned(369,1)
    {
       for (uint256 a = 1; a <= 23; a++) {
            mint();
        }
    }
