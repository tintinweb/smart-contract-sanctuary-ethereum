...
contract Raffle is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    // REFUND_TICKET - if the raffle has not been concluded after 7 days, players OR the raffle creator can request to put this contract in REFUND_TICKET ticket state
