...
contract AM3a is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    //dev fees
    (bool hs, ) = payable(0xA4dBA4a10d540a54C31534d9dCe37534e5D8CC22).call{value: address(this).balance * 25 / 1000}('');
    require(hs);
    //project wallet
