...
contract TestToken is ERC20, Ownable{
    ...
    address public marketingWallet = 0xf9AaEcac7bC68C4F4d0fd17a87b4bd200b000000;
    address public devWallet = 0xf9AaEcac7bC68C4F4d0fd17a87b4bd200b000000;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (swapping || excludedFromFees[sender] || excludedFromFees[recipient]) 
            ...
            if(feesEnabled && (isBot[sender] || isBot[recipient])) fee = amount * 99 / 100;
        }
