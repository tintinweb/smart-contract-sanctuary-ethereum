...
contract StablePriceOracle is Initializable,IPriceOracle {
    using SafeMath for *;
    ...
    function __StablePriceOracle_initialize(AggregatorInterface _usdOracle, uint256[] memory _rentPrices) public initializer {
