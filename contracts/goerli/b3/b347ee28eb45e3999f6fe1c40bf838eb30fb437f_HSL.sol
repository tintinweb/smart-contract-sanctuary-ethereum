...
//        require(_exists(false, tokenId), "e_inact");
    ...
    function storage_batchLiquidate(uint256[] memory tokenIds) public onlyActive {
//        bool allExist = true;
...
//        require(allExist, "e_act_batch");
    ...
    function storage_batchActivate(uint256[] memory tokenIds) public onlyActive {
//        bool allExist = true;
        //        for (uint256 i = 0; i < tokenIds.length; i++) {
        ////            allExist = allExist && _exists(true, tokenIds[i]);
        //        }
...
//        require(allExist, "e_inact_batch");
    ...
    function storage_batchBurn(uint256[] memory tokenIds) public onlyInactive {
//        bool allExist = true;
        //        for (uint256 i = 0; i < tokenIds.length; i++) {
        ////            allExist = allExist && _exists(true, tokenIds[i]);
        //        }
...
abstract contract ERC721TopLevelProto {
    ...
    function batchEmitTransfers(address[] memory from, address[] memory to, uint256[] memory tokenIds) public virtual;
