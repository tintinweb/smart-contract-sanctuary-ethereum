...
contract Legitimate721NFTDistribution is ERC721Psi, AccessControl {
    ...
    // METADATA
    string public nftTitle = "Friends of LGT"; // Title of the NFT collection
    string public nftDescription = "This is an example NFT that can be minted from Legitimate powered items. Use cases include membership referral and distribution, scavenger hunt, and digital collectibles."; // Description in string or markdown format
    ...
    constructor() ERC721Psi("FriendsOfLGTDemo", "FriendsOfLGT") {
