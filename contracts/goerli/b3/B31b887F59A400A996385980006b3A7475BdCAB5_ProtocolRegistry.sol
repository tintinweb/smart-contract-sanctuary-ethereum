...
contract ProtocolRegistry is Registry, Ownable {
    ...
    function registerRentContract(
        ...
        return _registerRentContract(partnerName_, nodeName_, owner_, IERC4907(address(originalNftAddr_)), originalNftAddr_);
    }
    ...
    function registerRentContractWithWrapper(
        ...
        return _registerRentContract(partnerName_, nodeName_, owner_, wrapperContractAddr_, originalNftAddr_);
    }
    ...
    function registerRentContractAndDeployWrapper(
        ...
        UnfreezeWrapper wrapper = LUnfreezeWrapper.deployWrapper(name_, symbol_, owner_, originalNftAddr_);
        return _registerRentContract(partnerName_, nodeName_, owner_, wrapper, originalNftAddr_);
    }
