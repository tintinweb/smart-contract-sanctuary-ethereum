...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x82aDAC884A44947638680325F82b56B554Cf2b0E];
  address public erc20Payable = 0x82aDAC884A44947638680325F82b56B554Cf2b0E;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/FsV3vAz2FK4tcEbctlXt/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/6hg00D7Nk7LPuMU20Pf7/contract-metadata";
  }
...
// File: contracts/UnoChainCubesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UnoChainCubesContract is ERC721APlus {
    constructor() ERC721APlus("Uno Chain Cubes", "UCC"){}
}