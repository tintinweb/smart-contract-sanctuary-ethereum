    ...
    ERC721URIStorageUpgradeable
{
    ...
    function kuchBhi() public pure returns (string memory) {
        return "added this new function to test the new proxy";
    }

    function addNftToCollection(uint256 _idNft, uint256 _idCollection) public {
        require(
    ...
    function deleteCollection(uint256 _collectionIdToDel) public {
