...
contract OrdinalWizardz is ERC721A, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    string private _wizardTower;

    constructor() ERC721A("OrdinalWizardz", "OWizardz") {
        _safeMint(msg.sender, 3);
    }


    modifier underMaxWizard(uint256 _quantity) {
        require(
    ...
    modifier validateMasteryLevel(uint256 _quantity) {
    ...
    function mint(uint256 _quantity)
        external
        payable
        validateMasteryLevel(_quantity)
        underMaxWizard(_quantity)
    {
    ...
    function towerSetup(string calldata baseURI) external onlyOwner {
        _wizardTower = baseURI;
    }
    ...
    function letWizardComing() external onlyOwner {
