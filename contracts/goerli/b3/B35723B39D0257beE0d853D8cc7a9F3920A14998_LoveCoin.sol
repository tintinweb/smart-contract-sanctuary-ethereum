...
contract LoveCoin is ERC20, Ownable {
	...
	constructor(address stablecoinAddress) ERC20("Love Coin", "$LOVE") {
		address _dexRouter;
		...
		PAIREDTOKEN = IERC20Metadata(stablecoinAddress);
		...
		sellMarketingAndBuybacksTax = 250;
		sellLiquidityTax = 100;
		sellDevelopmentTax = 250;
		sellTotalTax = sellMarketingAndBuybacksTax + sellLiquidityTax + sellDevelopmentTax;
	...
	function updateBuyTax(
		uint256 _marketingAndBuybacksTax,
	...
	function swapBack() private {
		...
		uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketingAndBuybacks + tokensForDevelopment;
