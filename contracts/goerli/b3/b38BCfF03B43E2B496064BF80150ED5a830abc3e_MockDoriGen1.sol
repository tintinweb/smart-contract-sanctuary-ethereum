...
contract MockDoriGen1 is ERC721A, Ownable {
    using Strings for uint256;

    string private uriExtension = "?";
    string public baseURI = "https://nft.bueno.art/api/contract/0ps0zLlgBLT_H6BB8TgpC/chain/1/metadata/";

    constructor() ERC721A("MockDoriGen1", "MOCKDoriGen1") {}
