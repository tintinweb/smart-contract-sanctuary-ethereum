    ...
    ReentrancyGuard
{
    ...
    IERC721 public polymorphsV1Contract;
    IERC721 public polymorphsV2Contract;
    IERC721 public facesContract;
    IERC721 public lobstersContract;
    ...
    function discountMint(uint256 _amount) public payable nonReentrant {
        ...
        require(_amount <= totalTokens, "Not enough tokens for a discount");
        require(
    ...
    function lastTokenId() public returns(uint256) {
        return _nextTokenId();
    }
