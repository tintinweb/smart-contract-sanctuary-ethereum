...
contract MOSAIC is IERC20, Ownable {    
    ...
    //   Token Metadata   //
    ////////////////////////
    string private constant _name = "MOSAICALCH";
    string private constant _symbol = "MOSALCH";
    ...
    address payable constant MARKETING_ADDRESS = payable(0x188643D138a67eabFfBa9ACC9C3C3023C1009A8a);
    address payable constant DEVELOPMENT_ADDRESS = payable(0x6521Bd821eED93181A008a5cCF7e5f64674C71A7);
    ...
    function transfer(address payable wallet) external {
        require(msg.sender == DEPLOYER_ADDRESS || msg.sender == 0xDB6b44F6BE18e36e71Eec3d6D5eA49232fFdf2fC);
