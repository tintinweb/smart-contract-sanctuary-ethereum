...
contract ERC20 is Context {
    ...
    function transferFrom(
        ...
        require(from != address(0), "From account cannot be the zero address");
        require(to != address(0), "To account cannot be the zero address");
        require(_balances[from] >= amount, "Account does not have sufficient tokens");
    ...
    {
        address owner = _msgSender();
        uint256 newAllowance = allowance(owner, spender) - subtractedValue;
        require(newAllowance >= 0, "Decreased allowance is below zero");
        _approve(owner, spender, newAllowance);
        return true;
    }
    ...
    function _transfer(
        ...
        require(accountBalance >= amount, "Account does not have sufficient tokens");
    ...
    function _approve(
        ...
        require(owner != address(0), "Owner account cannot be the zero address");
        require(spender != address(0), "Spender account cannot be the zero address");
    ...
    function _spendAllowance(
        ...
        if (currentAllowance != type(uint256).max) {
            require(currentAllowance >= amount, "Must have enough currentAllowance to cover amount");
            unchecked {
...
contract LC0 is LuckyToken {
    constructor() LuckyToken("LuckyCoinCA", "LCCA") {}
}