...
// |__  $$__/| $$                         |__  $$                                                                      
//    | $$   | $$$$$$$   /$$$$$$             | $$  /$$$$$$   /$$$$$$   /$$$$$$  /$$$$$$$   /$$$$$$   /$$$$$$$  /$$$$$$ 
//    | $$   | $$__  $$ /$$__  $$            | $$ |____  $$ /$$__  $$ |____  $$| $$__  $$ /$$__  $$ /$$_____/ /$$__  $$
//    | $$   | $$  \ $$| $$$$$$$$       /$$  | $$  /$$$$$$$| $$  \ $$  /$$$$$$$| $$  \ $$| $$$$$$$$|  $$$$$$ | $$$$$$$$
//    | $$   | $$  | $$| $$_____/      | $$  | $$ /$$__  $$| $$  | $$ /$$__  $$| $$  | $$| $$_____/ \____  $$| $$_____/
//    | $$   | $$  | $$|  $$$$$$$      |  $$$$$$/|  $$$$$$$| $$$$$$$/|  $$$$$$$| $$  | $$|  $$$$$$$ /$$$$$$$/|  $$$$$$$
//    |__/   |__/  |__/ \_______/       \______/  \_______/| $$____/  \_______/|__/  |__/ \_______/|_______/  \_______/
//                                                         | $$                                                        
//                                                         | $$                                                        
//                                                         |__/                                                        
//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1667329200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1667325600;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xd836BB994A9AF7E90e4A2C57B541e9E76026B8d6];
  address public erc20Payable = 0xd836BB994A9AF7E90e4A2C57B541e9E76026B8d6;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifuxyultejf6h4mcfcwe4vspui7zvqkgbfqpudd4cermg2umgxdii/";
...
// File: contracts/TheJapaneseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheJapaneseContract is RamppERC721A {
    constructor() RamppERC721A("The Japanese", "Japan"){}
}
