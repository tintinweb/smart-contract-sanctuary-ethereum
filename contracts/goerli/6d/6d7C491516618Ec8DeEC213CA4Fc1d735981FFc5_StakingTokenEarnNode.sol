...
contract StakingTokenEarnNode is Pausable, Ownable, ReentrancyGuard {
    ...
    constructor(ERC20 _token, address _nft)
    {
        ...
        token = _token;
        nft = _nft;
        setPackageInfo(1,1400, 10, 100);
        setPackageInfo(2,400, 12, 120);
        setPackageInfo(3,180, 18, 180);
        setPackageInfo(4,20, 20, 200);
    }
    ...
    function setPackageInfo(uint8 _idArr,uint256 _maxAmoutNft,uint256 _valueA, uint256 _valueB) public onlyOwner
    {
        ...
        packageInfo memory info = packageInfo(_maxAmoutNft, _valueA, _valueB);
        packageInfoList[_idArr] = info;

    }

    function stake(string memory _idTurn, uint256 _tokenId, uint8 _ndays, uint8 _quality) public
    {
        ...
        require(packInfo.maxAmoutNft > 0, "NFT Is Not Available");
        ...
        packInfo.maxAmoutNft = packInfo.maxAmoutNft - 1;
    ...
    function editUserStaking(address _addressUser,string memory _idTurn, uint8 _quality, uint256 _endTime) public
    {
        uint8 _packageId = _quality;
        bytes32 _value = keccak256(abi.encodePacked(_addressUser, _idTurn));
