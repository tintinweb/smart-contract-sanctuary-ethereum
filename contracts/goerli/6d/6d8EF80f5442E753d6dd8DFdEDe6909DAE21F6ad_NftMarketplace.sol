...
contract NftMarketplace is ReentrancyGuard {
     ...
     * @param tokenId: The Token ID of the NFT(private Id for the marketplace)
     * @param price: Sale price of the listed NFT
     * @dev Technically, we could have the contract be the escrow for the NFTs
     * but this way people can still hod their NFTs when listed.
     */
    function listItem(
        address nftAddress,
        uint256 tokenId,
    ...
    function buyItem(address nftAddress, uint256 tokenId) external payable isListed(nftAddress, tokenId) {
        ...
        // Sending the money to the users X
