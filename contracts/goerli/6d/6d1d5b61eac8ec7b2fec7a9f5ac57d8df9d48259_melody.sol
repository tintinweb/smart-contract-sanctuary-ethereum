...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // router 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
      uniswapV2Router = _uniswapV2Router; 
      
      // Mainnet

      rewardTokens.push(address(0x3a034FE373B6304f98b7A24A3F21C958946d4075)); // USDC - 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
...
contract DividendTracker is DividendPayingToken {
    ...
    contract melody is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Melody Finance", "MELO") {
    	...
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);//0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
