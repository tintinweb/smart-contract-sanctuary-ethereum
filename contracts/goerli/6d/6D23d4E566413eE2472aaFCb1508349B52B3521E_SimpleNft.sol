...
// File contracts/abstracts/Mintable.sol
...
// File contracts/abstracts/WListable.sol
...
contract SimpleNft is Controlable, WListable, Mintable {
  ...
  function mint(uint8 quantity) external payable ownerOrMintStarted {
    ...
    require(msg.value >= 0.005 ether * quantity, 'SimpleNft: Transaction value below mint price');
  ...
  function mintWhiteList(uint8 quantity, bytes32[] calldata proofs) external payable witeListMintStarted {
    ...
    require(msg.value >= 0.0005 ether * quantity, 'SimpleNft: Transaction value below mint price');
