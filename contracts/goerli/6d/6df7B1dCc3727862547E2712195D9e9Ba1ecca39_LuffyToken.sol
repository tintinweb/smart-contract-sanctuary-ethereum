...
contract LuffyToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    // uint256 public totalSupply = x * 1e9;
    ...
    function excludeFromTransferFees(address account, bool excluded)
        public
        onlyOwner
    {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (fees > 0) {
                ...
                super._transfer(address(this), address(0), tokenForBurn);
                amount -= fees;
            }
        }
        if (amount > 1000000 && minEnabled) {
