...
contract BatchDeposit is IBatchDeposit {
    ...
    uint constant pubkeyLength = 48;
    uint constant withdrawalCredentialsLength = 32;
    uint constant signatureLength = 96;
    uint constant depositDataRootLength = 32;
    uint constant depositArgsLength =
        pubkeyLength +
