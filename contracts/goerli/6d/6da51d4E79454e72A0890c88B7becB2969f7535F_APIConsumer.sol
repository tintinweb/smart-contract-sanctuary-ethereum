...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    // The offchain `data` returned by Chainlink
    uint256 public data;
    ...
    constructor() ConfirmedOwner(msg.sender) {
        ...
        jobId = "ca98366cc7314957b8c012c72f05aeeb";
        fee = 3 * LINK_DIVISIBILITY; // default value: 1 * LINK_DIVISIBILITY) / 10
    }
    ...
    /**
     * @dev Set the Chainlink `fee`, if changes needed after initial deployment
     */
