    ...
    ITGE
{
    ...
    function initialize(
        ...
        info = TGEInfo ({
            price: info_.price,
            hardcap: info_.hardcap,
            softcap: info_.softcap,
            minPurchase: info_.minPurchase,
            maxPurchase: info_.maxPurchase,
            vestingPercent: info_.vestingPercent,
            vestingDuration: info_.vestingDuration,
            vestingTVL: info_.vestingTVL,
            duration: info_.duration,
            userWhitelist: info_.userWhitelist,
            unitOfAccount: info_.unitOfAccount,
            lockupDuration: info_.lockupDuration,
            lockupTVL: info_.lockupTVL
        });
