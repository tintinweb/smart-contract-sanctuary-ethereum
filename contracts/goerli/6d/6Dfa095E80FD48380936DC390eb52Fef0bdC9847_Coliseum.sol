...
contract Coliseum is ERC721, Ownable, ReentrancyGuard {
    ...
    mapping(address => bool) public soulbounds;
        ...
        nonReentrant
    {
        ...
        // User can mint with only one address, as the tokens are soulbound
    ...
    function whichTierIsAddress(
        address _sender
    ) public view returns(uint256) {
        return _tierIndex[_sender];
    }
