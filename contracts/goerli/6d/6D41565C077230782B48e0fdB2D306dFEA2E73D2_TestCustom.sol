 ...
 * @notice This contract handles minting test custom tokens.
 */
contract TestCustom is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    string public baseTokenURI = "https://my-custom-uri/";
    ...
    constructor() ERC721A("test custom", "TEST") {
