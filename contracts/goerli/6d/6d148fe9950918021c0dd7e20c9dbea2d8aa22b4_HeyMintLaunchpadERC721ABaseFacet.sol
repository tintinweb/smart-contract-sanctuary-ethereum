...
contract HeyMintLaunchpadERC721ABaseFacet is
    ERC721AUpgradeable,
    ...
    IERC2981Upgradeable
{
    ...
    address public constant blocklistContractAddress =
        0x7dB717725467dBD6405fa95298e40Cc14766F058;
    ...
    function initialize(
        ...
        LaunchpadStorage.BaseConfig memory _config,
        LaunchpadStorage.AdvancedConfig memory _advancedConfig,
        LaunchpadStorage.AddressConfig memory _addressConfig
    ...
    //  */
    // function setRoyaltyPayoutAddress(address _royaltyPayoutAddress)
    //     external
    //     onlyOwner
    // {
    //     LaunchpadStorage
    ...
    function updateBlocklistedExchanges(
        ...
        require(_exchanges.length == _blocklisted.length, 'INVALID_ARGS');
        for (uint256 i = 0; i < _exchanges.length; i++) {
            LaunchpadStorage.state().data.isExchangeBlocklisted[
                _exchanges[i]
            ] = _blocklisted[i];
        }
    }
     ...
     */
    function isBlocklistedOperator(address _operator)
        internal
        view
        returns (bool)
    {
        ...
        ).operatorAddressToExchange(_operator);
        return
            LaunchpadStorage.state().data.isExchangeBlocklisted[
                operatorExchangeId
            ];
    ...
    function withdraw() external nonReentrant onlyOwner {
        ...
        if (LaunchpadStorage.state().addrCfg.payoutAddresses.length == 0) {
            ...
            for (
                ...
                require(
                    payable(LaunchpadStorage.state().addrCfg.payoutAddresses[i])
                        .send(
                        (balance *
                            LaunchpadStorage.state().addrCfg.payoutBasisPoints[
                                i
                            ]) / 10000
                    )
                );
    ...
    //     onlyOwner
    // {
    //     require(_receivers.length == _mintNumber.length, 'INVALID_ARGS');
    //     uint256 totalMint = 0;
    ...
    //         'INVALID_ARGS'
    //     );
    //     require(verifySignerAddress(_messageHash, _signature), 'INVALID_ARGS');
    ...
    //     require(LaunchpadStorage.state().cfg.fundingDuration > 0, 'NOT_ACTIVE');
    //     require(
    ...
    //     require(msg.sender == adminAddress, 'NOT_OWNED');
    //     require(
    //         !LaunchpadStorage
    //             .state()
    //             .advCfg
    ...
    //     require(borrowerAddress != msg.sender, 'NOT_OWNED');
    //     require(
    //         LaunchpadStorage.state().data.tokenOwnersOnLoan[_tokenId] ==
    //             msg.sender,
    //         'NOT_OWNED'
    ...
    //     if (_burnClaimActive) {
    //         require(
    //             LaunchpadStorage.state().advCfg.burnToMintContractAddress !=
    //                 address(0),
    //             'INVALID_ARGS'
    //         );
    //         require(
    ...
    //         );
    //         require(
    //             LaunchpadStorage.state().advCfg.burnToMintContractType != 0,
    //             'INVALID_ARGS'
    //         );
    //         if (LaunchpadStorage.state().advCfg.burnToMintContractType == 2) {
    //             require(
    //                 LaunchpadStorage.state().advCfg.burnToMintTokenId != 0,
    //                 'INVALID_ARGS'
    //             );
    //         }
    //     }
    ...
    //  */
    // function setBurnToMintContractAddress(address _burnToMintContractAddress)
    //     external
    //     onlyOwner
    // {
    //     LaunchpadStorage
    //     .state()
    //     .advCfg
    //     .burnToMintContractAddress = _burnToMintContractAddress;
    // }
    ...
    //  */
    // function setBurnToMintContractType(uint8 _burnToMintContractType)
    //     external
    //     onlyOwner
    // {
    //     LaunchpadStorage
    //     .state()
    //     .advCfg
    //     .burnToMintContractType = _burnToMintContractType;
    // }
    ...
    //     require(
    //         LaunchpadStorage.state().advCfg.burnToMintContractType == 1,
    //         'NOT_ACTIVE'
    //     );
    //     require(
    //         totalSupply() +
    //             (_tokenIDs.length *
    //                 LaunchpadStorage.state().advCfg.mintsPerBurn) <=
    //             LaunchpadStorage.state().cfg.maxSupply,
    //         'TOO_LARGE'
    //     );
    //     IERC721 ExternalERC721BurnContract = IERC721(
    //         LaunchpadStorage.state().advCfg.burnToMintContractAddress
    //     );
    //     for (uint256 i = 0; i < _tokenIDs.length; i++) {
    //         require(
    ...
    //     _safeMint(
    //         msg.sender,
    //         _tokenIDs.length * LaunchpadStorage.state().advCfg.mintsPerBurn
    //     );
    // }
    ...
    //  */
    // function burnERC1155ToMint(uint256 _amount)
    //     external
    //     nonReentrant
    //     originalUser
    // {
    ...
    //     require(_amount > 0);
    //     require(
    //         LaunchpadStorage.state().advCfg.burnToMintContractType == 2,
    //         'NOT_ACTIVE'
    //     );
    //     require(
    //         totalSupply() +
    //             (_amount * LaunchpadStorage.state().advCfg.mintsPerBurn) <=
    //             LaunchpadStorage.state().cfg.maxSupply,
    //         'TOO_LARGE'
    //     );
    //     IERC1155 ExternalERC1155BurnContract = IERC1155(
    //         LaunchpadStorage.state().advCfg.burnToMintContractAddress
    //     );
    //     require(
    //         ExternalERC1155BurnContract.balanceOf(
    //             msg.sender,
    //             LaunchpadStorage.state().advCfg.burnToMintTokenId
    //         ) >= _amount,
    //         'NOT_OWNED'
    //     );
    ...
    //  */
    // function setFreeClaimContractAddress(address _freeClaimContractAddress)
    //     external
    //     onlyOwner
    // {
    //     LaunchpadStorage
