...
contract MultiWordConsumer is ChainlinkClient, ConfirmedOwner {
     ...
     */
    function requestMultipleParameters(string memory _symbol, string memory _priceDescendant) public {
        ...
        req.add('urlAccumulatedLiquidations', string(url));
        req.add('pathAccumulatedLiquidations', 'accumulatedLiquidations');
