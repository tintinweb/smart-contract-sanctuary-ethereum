    ...
    FactoryUpgradeable
{
    ...
    mapping(address => EnumerableSet.AddressSet) private _poolsCreated;
    ...
    function createContract(
        ...
        for (uint256 i = 0; i < length; ) {
            _poolsCreated[recipients_[i]].add(instance);
    ...
    function poolsCreated(address account) external view returns (address[] memory) {
        return _poolsCreated[account].values();
    }
