 ...
 * @notice This contract handles minting BrainBalls_Goerli tokens.
 */
contract BrainBallsGoerli is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x01382656605A8cdD3e1600010A911dc2c657E3f1;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x7A7121a840B495103d83308d30FAE1310820f71d;
    address[] public payoutAddresses = [
        0x7A7121a840B495103d83308d30FAE1310820f71d
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeic7hbzraq72alo4vkj6innxvdg6fojuylnvn3j6v3timpgcjxstmm/";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("BrainBalls_Goerli", "BBBALS")
        RevokableOperatorFilterer(
