...
contract FiguresToken is ERC721Creator, IFiguresToken {
    ...
    function render(
        ...
        attributes = _concat(attributes, '", "description":"Figures is a collection of abstract numerals (0..99) generated at random.", "created_by":"Figures", "external_url":"https://figures.art/token/');

        attributes = _concat(attributes, Strings.toString(assetId));

        attributes = _concat(attributes, '", "attributes": [{"display_type": "number", "trait_type": "Number", "value":');
