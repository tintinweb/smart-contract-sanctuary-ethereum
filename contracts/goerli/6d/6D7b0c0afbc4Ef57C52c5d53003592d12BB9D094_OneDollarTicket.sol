...
contract OneDollarTicket is VRFV2WrapperConsumerBase, ReentrancyGuard, Ownable, Pausable {
    ...
    // this will call the reset function reseting current running lottery
    // variables such as ticket count and players array
    function resetCurrentLottery() whenPaused() public onlyOwner {
        ticketcount = 0;
        lastRequestId = 0;
        lotteryId = 1;
        freeplaycount = 0;
    ...
    function freePlayCount() public view returns (uint) {
    ...
    function payWinner() whenPaused() public onlyOwner nonReentrant {
        ...
        // updating variables and arrays for new lottery draw
        lotteryHistory[lotteryId] = players[index];
        lotteryId++;
        
        // reset the state of contract variables
        ticketcount = 0;
        lastRequestId = 0;
        players = new address payable[](0);
    }
