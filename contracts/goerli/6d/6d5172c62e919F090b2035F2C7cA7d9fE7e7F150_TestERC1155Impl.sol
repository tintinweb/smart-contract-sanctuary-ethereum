...
contract TestERC1155Impl is ERC1155PresetMinterPauserUpgradeable {
    function __TestERC1155Impl_init(string memory uri, address owner)
        external
        initializer
    {
    ...
    //TODO: add set URI for individual IDs if required.
    function setURI(string memory newUri) external {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "TestERC1155Impl: must have admin role to set uri"
        );
