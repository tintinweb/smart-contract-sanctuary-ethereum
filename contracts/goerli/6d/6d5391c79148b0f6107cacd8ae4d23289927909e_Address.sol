...
contract Dream is IERC20 {
    ...
    uint256 private constant startingSupply = 1000000; // 1 Quadrillion, underscores aid readability
    ...
    address payable private _marketingWallet = payable(0x6821e2a55DA1c668DB1556a121CdA011A3Dc0a0D);
