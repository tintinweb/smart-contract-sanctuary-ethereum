...
contract ThreeEarsBunny is AccessControl, ERC721ALockable, DefaultOperatorFilterer, ERC2981 {
    uint256 public constant MAX_TOTAL_SUPPLY = 10000; //todo
    address public constant PAYEE = 0xF8fCB2a4684E8EB05bED110adf8029fFAd2B145b;
    address public constant PROJECT_MANAGER = 0xF8fCB2a4684E8EB05bED110adf8029fFAd2B145b;
    bytes32 public constant MAINTAIN_ROLE = keccak256("MAINTAIN_ROLE");

    uint256 public publicPrice = 0.01 ether; //todo
    uint256 public guaranteeWhiteListPrice = 0.007 ether; //todo
    uint256 public nonGuaranteeWhiteListPrice = 0.0075 ether; //todo
    ...
    uint256 public guaranteeWhiteListTime;
    uint256 public nonGuaranteeWhiteListTime;
    ...
    function mintForPublic(uint256 quantity) external payable {
        ...
        require(quantity <= 1, "TEB: Mint would exceed max batch size");
    ...
    function setConfig(
        ...
        uint256 guaranteeWhiteListTime_,
        uint256 nonGuaranteeWhiteListTime_,
        ...
        guaranteeWhiteListTime = guaranteeWhiteListTime_;
        nonGuaranteeWhiteListTime = nonGuaranteeWhiteListTime_;
        publicTime = publicTime_;
    }

    function getConfig() external view returns (uint256, uint256, uint256, uint256, uint256, uint256, Phase){
        return (
        guaranteeWhiteListPrice,
        nonGuaranteeWhiteListPrice,
        publicPrice,
        guaranteeWhiteListTime,
        nonGuaranteeWhiteListTime,
        publicTime,
        getCurrentPhase());
    }

    function getCurrentPhase() public view returns (Phase){
        if (block.timestamp < guaranteeWhiteListTime) {
            return Phase.Waiting;
        } else if (block.timestamp < nonGuaranteeWhiteListTime) {
...
contract ERC721ALockable is ERC721A, IERC721ALockable {
