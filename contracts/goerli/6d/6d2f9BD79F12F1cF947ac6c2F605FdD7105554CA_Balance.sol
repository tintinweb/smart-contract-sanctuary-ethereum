...
contract Balance is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 160;
    ...
    constructor() ERC721("Balance", "BAL") {
        baseUri = "ipfs://bafybeiecgu7ilb2pvbuqy5gsaukgllgeoipj7jl7o2td4viae233ybo54i/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x3CD887F003704b5636EA4B5cCB6cA21f39Cb6B7A).call{value: balanceOne}("");
