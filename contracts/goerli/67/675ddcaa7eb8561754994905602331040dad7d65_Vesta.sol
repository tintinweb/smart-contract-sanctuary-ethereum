...
contract VestaDNA {
    ...
    // }
    function get_house_info() public view returns (int) { 
        return(userI.libro); 
    }
}
            ...
            bytes(
                string(
                    ...
                    abi.encodePacked(
                        ...
                        '","attributes":[{"trait_type":"Libro","value":"', metad, '"},{"Folio":"District","value":"', "23456", '"},{"trait_type": "Habitaciones","value":"', "3", '"}]}'
                    )
                )
            )
        );
