...
contract PoorPleb is ERC20, ERC20Burnable, Ownable {
    ...
    constructor(bytes32 _merkleRoot) ERC20("PoorPleb", "PP") {
        _mint(msg.sender, 44664119643900000000000000000000);
        ...
        allowClaimAllDate = block.timestamp + 7 days; // test net 7 days
        //allowClaimAllDate = block.timestamp + 69 days; // main net 69 days
    }
