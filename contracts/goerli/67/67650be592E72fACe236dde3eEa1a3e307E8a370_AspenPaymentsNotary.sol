    ...
    PaymentsNotary
{
    ...
    function _authorizeUpgrade(address _newImplementation) internal view override onlyRole(DEFAULT_ADMIN_ROLE) {
        if (!_newImplementation.supportsInterface(type(IPaymentNotaryV2).interfaceId)) {
...
interface IAspenCoreRegistryV1 is IAspenFeaturesV1, IAspenVersionedV2, IGlobalConfigV1 {}
...
interface ITermsRegistryV2 is IAspenFeaturesV1, IAspenVersionedV2, IAgreementsRegistryV1, IMulticallableV0 {}
    ...
    BaseAspenCoreRegistryV1
{
    ...
    function _authorizeUpgrade(address newImplementation) internal view override onlyRole(DEFAULT_ADMIN_ROLE) {
        if (!newImplementation.supportsInterface(type(IGlobalConfigV1).interfaceId)) {
...
contract AspenERC1155Drop is AspenERC1155DropStorage, BaseAspenERC1155DropV3 {
    ...
    function balanceOf(address _account, uint256 _id)
        public
        view
        override(ERC1155Upgradeable, IERC1155V4)
        returns (uint256)
    {
    ...
    function safeTransferFrom(
        ...
        uint256 amount,
        bytes memory data
    ) public override(ERC1155Upgradeable, IERC1155V4) onlyAllowedOperator(from) {
    ...
    function safeBatchTransferFrom(
        ...
        uint256[] memory amounts,
        bytes memory data
    ) public virtual override(ERC1155Upgradeable, IERC1155V4) onlyAllowedOperator(from) {
...
library AspenERC1155DropLogic {
    ...
    function collectClaimPrice(
        ...
        if (claimFees.claimPrice - claimFees.claimFee > 0 && recipient != address(0)) {
            CurrencyTransferLib.transferCurrency(
                _currency,
                claimFeesRequestData.msgSender,
                recipient,
...
/// Inherit from this base to implement introspection
abstract contract BaseAspenCoreRegistryV1 is IAspenFeaturesV1, IAspenVersionedV2, IGlobalConfigV1 {
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID != 0x0) && ((interfaceID != 0xffffffff) && ((interfaceID == 0x01ffc9a7) || ((interfaceID == type(IAspenFeaturesV1).interfaceId) || ((interfaceID == type(IAspenVersionedV2).interfaceId) || ((interfaceID == type(IGlobalConfigV1).interfaceId) || (interfaceID == type(IAspenCoreRegistryV1).interfaceId))))));
    }
...
/// Inherit from this base to implement introspection
abstract contract BaseTermsRegistryMockV3 is IAspenFeaturesV1, IAspenVersionedV2, IAgreementsRegistryV1, IAgreementsRegistryMockV0, IMulticallableV0 {
    function supportedFeatureCodes() override public pure returns (uint256[] memory features) {
        features = new uint256[](5);
        /// IAspenFeatures.sol:IAspenFeaturesV1
        features[0] = 0x6efbb19b;
        /// IAspenVersioned.sol:IAspenVersionedV2
        features[1] = 0xe4144b09;
        /// agreement/IAgreementsRegistry.sol:IAgreementsRegistryV1
        features[2] = 0x5533a548;
        /// agreement/IAgreementsRegistry.sol:IAgreementsRegistryMockV0
        features[3] = 0x1baa5857;
        /// IMulticallable.sol:IMulticallableV0
        features[4] = 0xad792170;
    }
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID != 0x0) && ((interfaceID != 0xffffffff) && ((interfaceID == 0x01ffc9a7) || ((interfaceID == type(IAspenFeaturesV1).interfaceId) || ((interfaceID == type(IAspenVersionedV2).interfaceId) || ((interfaceID == type(IAgreementsRegistryV1).interfaceId) || ((interfaceID == type(IAgreementsRegistryMockV0).interfaceId) || ((interfaceID == type(IMulticallableV0).interfaceId) || (interfaceID == type(ITermsRegistryMockV3).interfaceId))))))));
    }
...
/// Inherit from this base to implement introspection
abstract contract BaseTermsRegistryNonUpgradeableMockV3 is IAspenFeaturesV1, IAspenVersionedV2, IAgreementsRegistryMockV1, IMulticallableV0 {
    function supportedFeatureCodes() override public pure returns (uint256[] memory features) {
        features = new uint256[](4);
        /// IAspenFeatures.sol:IAspenFeaturesV1
        features[0] = 0x6efbb19b;
        /// IAspenVersioned.sol:IAspenVersionedV2
        features[1] = 0xe4144b09;
        /// agreement/IAgreementsRegistry.sol:IAgreementsRegistryMockV1
        features[2] = 0x96357b60;
        /// IMulticallable.sol:IMulticallableV0
        features[3] = 0xad792170;
    }
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID != 0x0) && ((interfaceID != 0xffffffff) && ((interfaceID == 0x01ffc9a7) || ((interfaceID == type(IAspenFeaturesV1).interfaceId) || ((interfaceID == type(IAspenVersionedV2).interfaceId) || ((interfaceID == type(IAgreementsRegistryMockV1).interfaceId) || ((interfaceID == type(IMulticallableV0).interfaceId) || (interfaceID == type(ITermsRegistryNonUpgradeableMockV3).interfaceId)))))));
    }
...
/// Inherit from this base to implement introspection
abstract contract BaseTermsRegistryV2 is IAspenFeaturesV1, IAspenVersionedV2, IAgreementsRegistryV1, IMulticallableV0 {
    function supportedFeatureCodes() override public pure returns (uint256[] memory features) {
        features = new uint256[](4);
        /// IAspenFeatures.sol:IAspenFeaturesV1
        features[0] = 0x6efbb19b;
    ...
    function supportsInterface(bytes4 interfaceID) virtual override public view returns (bool) {
        return (interfaceID != 0x0) && ((interfaceID != 0xffffffff) && ((interfaceID == 0x01ffc9a7) || ((interfaceID == type(IAspenFeaturesV1).interfaceId) || ((interfaceID == type(IAspenVersionedV2).interfaceId) || ((interfaceID == type(IAgreementsRegistryV1).interfaceId) || ((interfaceID == type(IMulticallableV0).interfaceId) || (interfaceID == type(ITermsRegistryV2).interfaceId)))))));
    }
