...
contract NFTCollection is ERC721A, ERC2981, Ownable {
    ...
    */
     ...
     */
    function _getBrokerage(address _currency)
        private
        view
        returns (int256)
    {
    ...
    function mint(
        ...
        int256 brokerage = _getBrokerage(address(currency));
     ...
     */
    function withdrawERC20Token(address _receiver)
        external
        onlyOwner
    {
        require(
