...
contract NewWorldGuardiansNFT is ERC721A, Ownable, Pausable {
     ...
     */
    uint8 public donationRatio = 20;

    /**
     @dev The maximum amount of NFTs that can be minted per whitelisted wallet
     */
     ...
     */
    uint16 public constant RESERVED = 20;
    ...
    /**
    @dev open sale on 1st November 19:00 CET (UTC+1)
     */
    uint32 public openSaleTimestamp = 1667325600;

    /**
     @dev the PRICE of the NFT
     */
    uint128 public constant PRICE = 0.001 ether;
    ...
    function whitelistMintNFT(
        ...
        require(
            _numberMinted(to) + amount <= MAX_WHITELIST_MINT,
    ...
    function checkMintCondition(uint256 value, uint8 amount) public view {
        require(value >= PRICE * amount, "Not enough ETH sent");
    ...
    */
    function withdrawAll() external onlyOwner {
        ...
        uint256 donation = balance / 100 * donationRatio;
