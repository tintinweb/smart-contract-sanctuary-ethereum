...
contract PresaleSale2 {
    ...
    ERC721 Superrat = ERC721(0x87abD078e4d05d2D0179B41Bb14fE49f41910E91);
    IERC20A ratboy = IERC20A(0xE99BB31d0782f7Da05366EA5D683e781213c4AFC);
    ...
    function claim() public {
        ...
        require(selfInfo.finalized>0,"The Presale has not yet finalized");
        ...
        require(Token.balanceOf(address(this))>=netEntitlement,"Contract does not have balance");
    ...
    // _adminAllowed 
    {
        require(selfInfo.finalized==0,"The presale has been finalized");
    ...
    function finalize() public {
        require(msg.sender == selfInfo._token_owner_admin_currency[1],"you are not the owner");
        ...
        uint tokens = address(this).balance / selfInfo._noOfTokens_price_max_min_vesting_month_start_end[10];
        IERC20 Token = IERC20(selfInfo._token_owner_admin_currency[0]);
...
contract tokenLockLauncher {
    ...
    function lockToken(address _token, uint _amount,string memory _title,uint _time,bool LP) public {
     ...
     Locks memory tx2 = Locks(_token,address(tx1),_title,_name,_symbol,msg.sender,_amount,_time,LP);
