...
contract LSArtWorks721 is ERC721, CantBeEvil {
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
    require(_exists(tokenId), "ERC721: token not mint");

    return "https://ipfs.io/ipfs/QmfC347aTxaUsQfjHeHNcAz6whs8d3R12PSAnmGr2Xt9fq";
  }
  ...
  //   require(_exists(_tokenId), "ERC721: token not mint");
