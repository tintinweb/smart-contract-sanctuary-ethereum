...
contract Club7 is ERC1155, Ownable, Pausable {
    ...
    function _setUnlocked(bool unlocked_) internal {
        unlocked = unlocked_;
    }
    ...
    function claim(bytes32[] calldata proof) external payable whenNotPaused {
        ...
        require(verified(2, msg.sender, proof), "Not in WL");
    ...
    function wlMint(bytes32[] calldata proof) external payable whenNotPaused {
        ...
        require(verified(1, msg.sender, proof), "Not in WL");
    ...
    function withdraw(uint256 amountInWei) external onlyOwner {
