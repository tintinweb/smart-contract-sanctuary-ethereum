// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Special Item", unicode"Head Accessory", unicode"Head", unicode"Body", unicode"Background"];
        ...
        constructor() ERC721A(unicode"RobosOnChain", unicode"ROC") {
            TIERS[0] = [2,2,11,21,29,40,41,41,75,84,84,117,117,140,142,288];
TIERS[1] = [3,3,6,12,17,30,34,36,51,53,54,58,66,73,79,86,95,122,126,230];
TIERS[2] = [7,11,48,55,65,81,109,111,184,185,188,190];
TIERS[3] = [7,11,48,55,65,81,109,111,184,185,188,190];
TIERS[4] = [28,35,36,37,38,44,47,190,191,192,198,198];
