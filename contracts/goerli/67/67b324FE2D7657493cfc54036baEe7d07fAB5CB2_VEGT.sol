...
contract VEGT {
    ...
    string public constant name = "VEGT_T"; // solium-disable-line
    string public constant symbol = "VEGT_T"; // solium-disable-line uppercase
    ...
    */
     ...
     */
    function reclaimVEGT() external onlyOwner {
