...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xF3EBEA794CA4890F876F9e0408127Edbb9160F38];
  address public erc20Payable = 0xF3EBEA794CA4890F876F9e0408127Edbb9160F38;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 100) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihwpw3xotc2gzw3e2nwb7wk4j3vsxl4xv42r5iy4vx7l7jzxeyori/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/R0r1dYe4Py8DaKOBOG7y/contract-metadata";
  }
...
// File: contracts/CrazyDinoClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CrazyDinoClubContract is RamppERC721A {
    constructor() RamppERC721A("Crazy Dino Club", "CDC"){}
}
