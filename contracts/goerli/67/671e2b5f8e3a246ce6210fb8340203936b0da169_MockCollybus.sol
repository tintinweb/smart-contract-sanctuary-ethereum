...
import {ChainlinkValidator} from "../validators/ChainlinkValidator.sol";
...
contract ChainlinkValidatorScript is Script {
    function run() external {
        ...
        address daiAddress = address(0x1);
        address daiChainlinkFeed = address(0x0d79df66BE487753B02D015Fb622DED7f0E9798d);
        address usdcAddress = address(0x2);
        address usdcChainlinkFeed = address(0xAb5c49580294Aff77670F839ea425f5b78ab3Ae7);
        ...
        // Give permissions to the caller in order to add new rates
        ...
        uint256 proposeWindow = 24*3600;
        uint256 disputeWindow = 48*3600;

        ChainlinkValidator validator = new ChainlinkValidator(proposeWindow, disputeWindow);
        validator.setFeed(daiAddress, daiChainlinkFeed);
        validator.setFeed(usdcAddress, usdcChainlinkFeed);

        for (uint idx = 0; idx < coins.length; ++idx){
            ...
            (uint256 value, bytes32 nonce) = validator.value(coins[idx]);
