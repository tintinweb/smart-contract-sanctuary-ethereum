...
// File: github/abdullahtilalcodup/nftContracts/3ListContract.sol
...
contract NFTA is ERC721A, Ownable {
    ...
    uint8 public nftPerAddressLimitFreeO =5; //Max Free mint for WL
    uint8 public nftPerAddressLimitO =10; //Max Limit per Wallet for WL
    uint8 public nftPerAddressLimitFreeL =3; //Max Free mint for WL
    uint8 public nftPerAddressLimitL =10; //Max Limit per Wallet for WL
    uint8 public nftPerAddressLimitFreePublic =2; //Max Free mint for Public
    uint8 public nftPerAddressLimitPublic =10; //Max Limit per Wallet for Public
    ...
    uint256 public publicFreeLimit=14;
    uint256 public whitelistFreeLimit=30; //Not needed
    uint256 public whitelistOLimit=6;
    uint256 public whitelistLLimit=10;
    uint256 public paidMinted=0;
    uint256 public paidMintedLimit=40;
