...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x0bba14478FF03cBbb565F2F8f49f3ed745D97d3d];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x0bba14478FF03cBbb565F2F8f49f3ed745D97d3d;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 1200) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiax6mo756ik3xu76274svttjqy34boqik5ss6m5r7yknihunfzdv4/";
...
// File: contracts/RolandLifestyleTr808Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RolandLifestyleTr808Contract is RamppERC721A {
    constructor() RamppERC721A("Roland Lifestyle TR808 ", "TR808"){}
}
