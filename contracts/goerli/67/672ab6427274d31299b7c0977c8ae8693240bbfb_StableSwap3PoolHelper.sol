...
library StableSwap3PoolHelper {
    ...
    function verifyAndExtractStorage(
        ...
        RLPReader.RLPItem[] memory accountProof = accountProofRplBytes
            .toRlpItem()
            .toList();
        RLPReader.RLPItem[] memory storageProof = storageProofRplBytes
            .toRlpItem()
            .toList();

        StateProofVerifier.Account memory curve3PoolAccount = StateProofVerifier
            .extractAccountFromProof(poolAddressHash, headerRoot, accountProof);
