    ...
    IPool
{
    ...
    function _getProposalCreatedAt(uint256 proposalId)
        ...
        returns (uint256)
    {
        return proposalCreatedAt[proposalId];    
    }
...
abstract contract Governor {
    ...
    {
        uint256 createdAt = _getProposalCreatedAt(proposalId) == 0 ? 0 :  _getProposalCreatedAt(proposalId) - 1;
        return (
            ballots[account][proposalId],
            _getPastVotes(account, createdAt)
        );
    }
