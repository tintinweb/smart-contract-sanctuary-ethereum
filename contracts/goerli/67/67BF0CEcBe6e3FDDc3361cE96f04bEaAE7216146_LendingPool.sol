...
contract LendingPool is Ownable, KeeperCompatibleInterface {
  ...
  modifier onlyOwnerOrCreator() {
    require(msg.sender == owner() || msg.sender == creator, 'ONLYOWNERCREATOR');
    _;
  }
    ...
    )
  {
    ...
    uint256 _amountETHBorrowedX96 = _loan.amountETHBorrowed * 2 ** 96;
    return (
  ...
  function _borrow(
    ...
    uint256 ethDeposited = ethDepositedX96 / 2 ** 96;
    uint256 ethBorrowed = ethBorrowedX96 / 2 ** 96;
  ...
  function revokeCreator() external onlyOwner {
    require(creator != address(0), 'REVOKECREATOR');
    creator = address(0);
  }
  ...
  function toggleWhitelistCollateralPool(
    address _pool
