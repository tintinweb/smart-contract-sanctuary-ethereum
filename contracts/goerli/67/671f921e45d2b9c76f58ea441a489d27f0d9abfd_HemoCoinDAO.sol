...
contract HemoCoinDAO is ERC20, Ownable {
    ...
    IWrap public wrap = IWrap(0xC7AB7062383FACF080243Ac91dFC49B633b70111);
    IERC20 public usdt = IERC20(0xdDA73847cb6f5928f7F9275443eb5015BB87c526);
    ISwapRouter public immutable swapRouter;
    mapping (address => bool) public isMarketPair; 

    constructor (ISwapRouter _swapRouter) ERC20("Hemo Coin DAO", "HEMODAO", 8, 7000000000000 * 10 ** 8){
        address msgSender = _msgSender();
        _balances[msg.sender] = totalSupply();
        emit Transfer(address(0), msgSender, totalSupply());
        swapRouter = _swapRouter;
        pancakePair = IUniswapV3Factory(swapRouter.factory()).createPool(address(this), address(usdt), poolFee);
    ...
    function _swapTokensForUsdt(uint256 amountIn, address to) private returns (uint256 amountOut) {
        address tokenIn = address(this); 
        address tokenOut = address(usdt);
