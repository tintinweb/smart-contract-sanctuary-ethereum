...
contract MyNftMerkleTree is ERC721 {
    ...
    uint256 public fixedPrice = 100000000;
    bool public isMystery = true;
    ...
    function setNFTSale(uint256 num,uint256 price) external onlyOwner() {
        totalSupply = num;
        fixedPrice = price;
    }
    ...
    function whitelistMint(bytes32[] calldata _proof) external payable verifyProof(_proof) {
        require(totalSupply > tokenId,"out of stock");
        require(msg.value >= fixedPrice,"you are poor");
        tokenId++;  
    ...
    function setRoot(bytes32 _root) external {
        ...
        // "https://gateway.pinata.cloud/ipfs/QmR8eAKLDLVJVu5fPqfQBszmmezmu1c81BHKaMWdF8FRjA/"; open
        // "https://gateway.pinata.cloud/ipfs/QmXXq4XFVSd3y2ZWQLDL697viFrPFfHhe7PTZi2CQWfk86/"; mystery

    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        _requireMinted(_tokenId);
        if(isMystery){
            return string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmXXq4XFVSd3y2ZWQLDL697viFrPFfHhe7PTZi2CQWfk86/","1.json"));
        }
        return string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmR8eAKLDLVJVu5fPqfQBszmmezmu1c81BHKaMWdF8FRjA/", _tokenId.toString(), ".json"));
    }
    struct Auction {
        uint256 startTime;
        uint256 timeStep;
