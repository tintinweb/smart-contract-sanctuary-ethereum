...
contract Traffic is ERC721 {
     ...
     * ERC20
     */
    function _flushTokens(uint256 ownershipId, address forwarderAddress, address token, uint256 value, address dest)
        internal
    {
    ...
    function flushTokens(uint256 ownershipId, bytes32 forwarderSalt, address token, uint256 value, address dest)
        public
    {
        address forwarderAddress = computeForwarderAddress(ownershipId, forwarderSalt);
        _flushTokens(ownershipId, forwarderAddress, token, value, dest);
    }
    ...
    function createForwarderTokens(
        ...
        _flushTokens(ownershipId, forwarder, token, value, dest);
    }
