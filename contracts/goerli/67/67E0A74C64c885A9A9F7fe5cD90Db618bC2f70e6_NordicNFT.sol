...
contract NordicNFT is ERC721, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {

    using Strings for uint256;
    using SafeMath for uint256;

    string public baseURI = "https://pink-permanent-porcupine-505.mypinata.cloud/ipfs/QmdN5z3YFipKTzSDQHvoneENCQmerw5XB4HBY7H3xW6jSF/";
    string public baseExtension = ".json";
    uint256 public cost = 0.15 ether;
    uint256 public maxSupply = 10000;
    uint256 public maxMintAmount = 5; // max mint amout per transaction
    uint16 public devPercentage = 1000; // percentage in bips
    ...
    function _setDevWallet(address _devWallet) external onlyOwner {
    ...
    function mint(uint256 _mintAmount) public payable whenNotPaused nonReentrant {
        ...
        if (msg.sender != owner()) {
            ...
            require(msg.value >= cost.add(devCost).mul(_mintAmount), "insufficient funds");
    ...
    function getTotalPricePerNFT() external view returns (uint256) {
