...
// 1. Replace your contract name
contract Sample is ERC721Enumerable, Ownable {
    // 2. Replace your max supply
    uint256 public constant MAX_SUPPLY = 5;

    // 3. Replace your token base URI
    string private tokenBaseURI =
        "https://cos-nft-hosting.web.app/nft/sample/";
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    // 4. Replace your token name and symbol
