...
contract Feed is ChainlinkClient, ConfirmedOwner {
    using Chainlink for Chainlink.Request;

    uint256 private constant ORACLE_PAYMENT = 0 * LINK_DIVISIBILITY; // 1 * 10**18
    ...
    function requestEthereumPric(address _oracle, string memory _jobId) public onlyOwner {
