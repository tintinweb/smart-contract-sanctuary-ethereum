...
contract ve is IERC721, IERC721Metadata {
    ...
    uint internal constant WEEK = 1 days; // Changed from 1 week to 1 day for testing purposes
    uint internal constant MAXTIME = 1 weeks; // Changed from 4 years to 1 week for testing purposes
    int128 internal constant iMAXTIME = 1 weeks; // Changed from 4 years to 1 week for testing purposes
    ...
    function _create_lock(uint _value, uint _lock_duration, address _to) internal returns (uint) {
        ...
        require(unlock_time <= block.timestamp + MAXTIME, 'Voting lock can be 1 week max');
