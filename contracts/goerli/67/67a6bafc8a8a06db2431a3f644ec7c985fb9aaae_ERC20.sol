...
contract ERC20 is Context {
    ...
    {
        require(address(0) != spender);
        require(subtractedValue <= _allowances[spender][_msgSender()]);
        uint256 oldallowance = allowance(_msgSender(),spender);
    ...
    function _approve(
        ...
        require(address(0) != owner);  //https://ethereum.stackexchange.com/questions/42717/what-does-address0-mean
        require(address(0) != spender);
...
contract LC0 is LuckyToken {
    constructor() LuckyToken("LuckyCoin362015", "LC362015") {}
}