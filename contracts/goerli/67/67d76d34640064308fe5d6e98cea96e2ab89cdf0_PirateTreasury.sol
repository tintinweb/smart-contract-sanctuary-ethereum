...
//             E%                 E  8 .$$$$$$$$K!!$$$$$$$$&M$RMM>               :"5
//            z  %                3  $ 4$$$$$$$$!~!*$$$$$$$$!$MM$               :" `
//            K   ":              ?> # '#$$$$$#[email protected]              z   R
//            ?     %.             5     ^"""~~~:XW!!!!T?T!XSMMM~            :^    J
//             ".    ^s             ?.       ~~d$X$NX!!!!!!M!MM             f     :~
//              '+.    #L            *c:.    .~"[email protected]@~           z"    .*
//                '+     %L           #c`"!+~~~!/[email protected]*TM8M           z"    .~
//                  ":    '%.         'C*X  [email protected]         .#     +
//                    ":    ^%.        9-MX!X!!X~H!!M!N!X$MM        .#`    +"
//                      #:    "n       'L'!~M~)H!M!XX!$!XMXF      .+`   .z"
//                        #:    ":      R *[email protected]@$H$*@[email protected][email protected]$%M~     z`    +"
//                          %:   `*L    'k' [email protected]!tF    z"    z"
//                            *:   ^*L   "k ~~~!~!!!!!M!X*   z*   .+"
//                              "s   ^*L  '%:.~~~:!!!!XH"  z#   .*"
//                                #s   ^%L  ^"#[email protected]@##"  z#   .*"
//                                  #s   ^%L           z#   .r"
//                                    #s   ^%.       u#   .r"
//                                      #i   '%.   u#   [email protected]"
//                                        #s   ^%u#   [email protected]"
...
contract PirateTreasury {
    ...
    event ChestBuried(uint256 coins);
    ...
    /// @notice Use thissss to bury yar chest somewhere
    /// @param chest - geolocation hash
    /// @param keuy - address that can sign message that unlocks
    function buryChest(bytes32 chest, address keuy) external payable {
