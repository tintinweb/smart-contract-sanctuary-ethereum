...
contract StakefishNFTManager is IStakefishNFTManager, ERC721Enumerable, ReentrancyGuard {
    ...
    function burnIfNeccessary(uint256 tokenId) internal {
        address validatorAddr = this.validatorForTokenId(tokenId);
