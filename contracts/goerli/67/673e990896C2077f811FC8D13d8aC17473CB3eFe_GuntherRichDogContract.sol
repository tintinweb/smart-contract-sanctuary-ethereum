...
contract GuntherRichDogContract is ERC721, VRFConsumerBaseV2, ConfirmedOwner {
    using Strings for uint256;

    string public baseURIUnrevealed = "TODO unrevealed uri";
    string public baseURIRevealed = "TODO revealed uri";
    ...
    uint64 s_subscriptionId = 0; // TODO set sub id
    bytes32 keyHash = 0x474e34a077df58807dbe9c96d3c009b23b3c6d0cce433e59bbf5b34f823bc56c; // TODO
     ...
     */
    constructor()
        ERC721("TODO Name", "TODO Symbol")
        VRFConsumerBaseV2(0x8103B0A8A00be2DDC778e6e7eaa21791Cd364625) // TODO HARDCODED FOR SEPOLIA
        ConfirmedOwner(msg.sender)
    {
        COORDINATOR = VRFCoordinatorV2Interface(
            0x8103B0A8A00be2DDC778e6e7eaa21791Cd364625 // TODO HARDCODED FOR SEPOLIA
        );
    }
     ...
     */
    function mint(uint256 count, bytes32[] calldata proof) external payable {
        ...
        if (block.timestamp < saleStartTimestamp + WHITELIST_TIME) {
            require(verifyWhitelisted(msg.sender, proof), "Address not whitelisted");
        }
