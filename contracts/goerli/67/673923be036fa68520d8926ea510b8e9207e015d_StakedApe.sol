...
contract StakedApe is ERC4626, Owned {
    ...
    uint256 public constant WITHDRAW_FEE = 250; // 2.5% fee
    ...
    function withdraw(
        ...
        uint256 fee = (assets * WITHDRAW_FEE) / 10000;
    ...
    function totalAssets() public view override returns (uint256) {
        return staking.stakedTotal(address(this)) + staking.pendingRewards(0, address(this), 0) + asset.balanceOf(address(this));
    }
