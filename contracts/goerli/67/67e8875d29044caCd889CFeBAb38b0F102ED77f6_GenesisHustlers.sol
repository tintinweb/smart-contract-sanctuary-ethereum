...

{
    ...
    uint256 _priceWL = 30000000000000000; // 0.03 ETH
    ...
    function Whitelist(address account, uint256 _amount, bytes32[] calldata _proofWL)
    external
    payable
    ...
    function Pub_mint(uint256 _amount) 
    external 
    payable
    onlyAccounts
    {
