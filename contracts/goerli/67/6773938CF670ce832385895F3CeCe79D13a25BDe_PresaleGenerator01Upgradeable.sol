...
// File: Library/EnumerableSetUpgradeable.sol
...
// File: Library/ERC1967Upgrade.sol
...
abstract contract ERC1967Upgrade {
    ...
    function _setBeacon(address newBeacon) private {
        ...
        require(
            Address.isContract(IBeaconUpgradeable(newBeacon).implementation()),
    ...
    function _upgradeBeaconToAndCall(address newBeacon, bytes memory data, bool forceCall) internal {
        ...
        if (data.length > 0 || forceCall) {
            Address.functionDelegateCall(IBeaconUpgradeable(newBeacon).implementation(), data);
        }
    }
}
// File: Main/ERC1967Proxy.sol
...
// File: Main/PresaleGenerator01Upgradeable.sol
...
contract PresaleGenerator01Upgradeable {
    using SafeMath for uint256;
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0xA5EdDD58a0d63bFb5E43e6802c28308e9F8FD024);
        PRESALE_SETTINGS = IPresaleSettings(0x643998b4D9Acb15a931d4dAf876F13DfA3331974);
    ...
    function createPresale (
      ...
      address _logicCodeAddress
        ...
        ERC1967Proxy newPresale = (new ERC1967Proxy)(_logicCodeAddress);
        Presale01Upgradeable(address(newPresale)).initialize(address(this));
        TransferHelper.safeTransferFrom(address(_presaleToken), address(msg.sender), address(newPresale), params.amount);
        Presale01Upgradeable(address(newPresale)).init1(_presaleOwner, params.amount, params.tokenPrice, params.maxSpendPerBuyer, params.hardcap, params.softcap, params.startTime, params.endTime);
        Presale01Upgradeable(address(newPresale)).init2(_baseToken, _presaleToken, PRESALE_SETTINGS.getBaseFee(), PRESALE_SETTINGS.getTokenFee(), PRESALE_SETTINGS.getEthAddress(), PRESALE_SETTINGS.getTokenAddress());
        require(_refundInfo[0] >= 0 && _refundInfo[0] <= 1000, "INVALID REFUND FEE."); 
        Presale01Upgradeable(address(newPresale)).init3(is_white_list, _caller, percentFee, _distributionTime, _unlockRate, _isRefund, _refundInfo);
        PRESALE_FACTORY.registerPresale(address(Presale01Upgradeable(address(newPresale))));
    }
