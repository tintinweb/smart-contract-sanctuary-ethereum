...
// Add royalty to a lock contract
...
contract Coinflip is VRFConsumerBaseV2 {
    ...
    function flipCoin(uint256 _guess) public payable returns (uint256 requestId) {
        ...
        require(msg.value*2 < address(this).balance, 'Amount is less than contract balance.');
        require(msg.value > 0, 'Amount muster greater than 0.');
