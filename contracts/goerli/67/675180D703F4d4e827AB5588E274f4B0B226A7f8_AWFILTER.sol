...
contract ERC721A is IERC721A, DefaultOperatorFilterer  {
     ...
     * Emits an {Approval} event.
     */
    function approve(address to, uint256 tokenId) public payable virtual override(IERC721A)  onlyAllowedOperatorApproval(to) {
     ...
     * Emits an {ApprovalForAll} event.
     */
    function setApprovalForAll(address operator, bool approved) public virtual override(IERC721A)  onlyAllowedOperatorApproval(operator) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public payable virtual override(IERC721A) onlyAllowedOperator(from) {
...
contract AWFILTER is ERC721ABurnable, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("A W FILTER", "AWF") {
    setBaseURI("http://localhost:4000/api/a-w-filter/token/");
