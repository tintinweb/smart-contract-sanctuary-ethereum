...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    RaffleState private s_rafleState;
    ...
    function enterRaffle() public payable {
        ...
        if (s_rafleState != RaffleState.OPEN) {
    ...
    /**
     * @dev this is the funciton that the chainlink keeper nodes call they look for the 'upkeepNeeded' to return true
    ...
    {
        bool isOpen = RaffleState.OPEN == s_rafleState;
    ...
    function performUpkeep(
        ...
        if (!upkeepNeeded) {
            revert Raffle__UpkeepNotNeeded(
                ...
                s_players.length,
                uint256(s_rafleState)
            );
        }

        // request the random number
        s_rafleState = RaffleState.CALCULATING;
