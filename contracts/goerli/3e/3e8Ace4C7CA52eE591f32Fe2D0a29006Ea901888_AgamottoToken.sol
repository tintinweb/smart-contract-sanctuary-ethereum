...
contract NODERewardManagement {
    ...
    constructor(uint256 _nodePrice, uint256 _rewardPerNode) {
        ...
        returns (uint256)
    {
        ...
        for (uint256 i = 0; i < nodesCount; i++) {
            _node = nodes[i];
            rewardsTotal +=
                (block.timestamp - _node.lastClaimTime) *
                rewardPerNode;
        ...
        returns (uint256)
    {
        ...
        for (uint256 i = 0; i < nodesCount; i++) {
            rewardCount +=
                (block.timestamp - nodes[i].lastClaimTime) *
                rewardPerNode;
        }
...
contract AgamottoToken is ERC20, Ownable {
    ...
    address public distributionPool =
        0xd488180a5a9093d701b9FeA9F79a426e4066E986;
    ...
    function cashoutAll() public {
        ...
        for (uint256 id = 0; id < 3; id++) {
            ...
            rewardAmount = rewardAmount.add(
                nodeRewardManager[id]._getRewardAmountOf(sender)
            );
        }
