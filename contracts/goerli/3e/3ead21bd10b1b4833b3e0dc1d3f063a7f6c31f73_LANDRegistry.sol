...
contract LANDRegistry is Storage, Ownable, FullAssetRegistry, ILANDRegistry {
  ...
  function initialize(bytes) external {
    _name = "Mollyverse MLAND";
    _symbol = "LAND";
    _description = "Contract that stores the Mollyverse MLAND registry";
    _baseURI = "https://metadata.demetaverse.me/land/";
  ...
  // Metadata control
  //
  function setBaseURI(string newBaseURI) external onlyProxyOwner {
