...
contract DPSToken is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x6510028F10E4b8Fc548Adce32Ab595311D901f73;
    address public developerWallet = 0xB22dba81C608DD614503520A63e234a489Bff082;
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(20).div(denominator);     //3.0%
    uint256 public _walletMax = _totalSupply.mul(40).div(denominator);    //6.0%
    ...
    constructor () {
        ...
        address _owner = 0x042e2BD46a306D45549cefaa9Bb053DDD9B952CB;
