...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDC65d8bc45343B0544769Ac243e554272f084772;
...
contract BRBToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xab6F8d96b86AD1484cBCBF0120BA4dC9Fd88AD96;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BRB Token";
    string private _symbol = "BRBT";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 10;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 15;
