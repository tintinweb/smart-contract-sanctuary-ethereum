...
import {TestingSouldboundSkeletonNFT} from "./TestingSouldboundSkeletonNFT.sol";
import {EIP712Upgradeable} from "@openzeppelin/contracts-upgradeable/utils/cryptography/draft-EIP712Upgradeable.sol";
import {UUPSUpgradeable} from "@openzeppelin/contracts-upgradeable/proxy/utils/UUPSUpgradeable.sol";
import {SignatureCheckerUpgradeable} from "@openzeppelin/contracts-upgradeable/utils/cryptography/SignatureCheckerUpgradeable.sol";
import {AccessControlUpgradeable} from "@openzeppelin/contracts-upgradeable/access/AccessControlUpgradeable.sol";

// TSB Core membership contract (Updatable)
contract TestingSoulbound is
    OwnableUpgradeable,
    TestingSouldboundSkeletonNFT,
    EIP712Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function initialize(string memory _urlBase, address admin)
        ...
        initializer
    {
        __EIP712_init("TestingSoulbound", "1");
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(TestingSouldboundSkeletonNFT, AccessControlUpgradeable)
        returns (bool)
    {
        return
            TestingSouldboundSkeletonNFT.supportsInterface(interfaceId) ||
...
/// @notice Base non-transferrable optimized nft contract for Testing Soulbound NFTs
abstract contract TestingSouldboundSkeletonNFT is
    ERC165Upgradeable,
    IERC721Upgradeable,
    IERC721MetadataUpgradeable
{
    ...
    string public constant name = "TestingSouldboundSkeletonNFT";

    /// @notice NFT Metadata Symbol
    string public constant symbol = "TSBMEM";
