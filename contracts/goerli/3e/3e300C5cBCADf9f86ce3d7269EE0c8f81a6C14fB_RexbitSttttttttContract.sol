    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeie5eqfin7lwzltkb25ljzkqpfg4s72cmm4dga2gyodsy7xwtcsoue/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/WrkY3MnW0leZ77RBlITF/contract-metadata";
  }
...
// File: contracts/RexbitSttttttttContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RexbitSttttttttContract is ERC721APlus {
    constructor() ERC721APlus("REXBITStttttttt", "RXBT"){}
}