...
contract PEPE is Ownable, ERC721A, ReentrancyGuard {  
    using Strings for uint256;
    
    string private _baseURIextended = "ipfs://QmexE4Fsu3zb1YZ1QdWknfWWkUyuQTViwtpustAmvrXzan/";
    ...
    constructor() ERC721A("Its Just PEPE", "$PEPE") {
    }
    ...
    function mintNFT(uint256 _quantity) public payable {
        ...
        require(msg.value >= publicSalePrice * _quantity, "ETH value is not correct");
