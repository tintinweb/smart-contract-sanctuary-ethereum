...
// File: Souls Of Wuxias.sol


pragma solidity ^0.8.4;
contract SoulsOfWuxias is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Souls Of Wuxias", "SOW") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmRQwV6QZAJk3J5jcQvYbSdJ3P2RrnnRKqGDQHtxHk27pk";
    }
