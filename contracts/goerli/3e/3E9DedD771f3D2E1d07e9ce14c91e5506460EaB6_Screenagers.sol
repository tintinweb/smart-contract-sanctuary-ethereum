    ...
    ReentrancyGuard
{
    ...
    // Base URI
    string public baseURI = "https://ipfs.io/ipfs/QmT4uhEB5yKnGqAe4Lu5ZkUuRsUjnSHaNxH4vGfpYNesVB/";
    // Total Number of ScreenAgers
    uint256 public _maxSupply = 4444;
    // Sale active or not
    bool public isSaleActive;
    // Number of free screens in wallet
    uint256 public _screensperwallet = 1;
...
/*---------- ----------- ---------- Internal Functions ---------- ----------- ----------*/
    ...
    address[] private _team = [
        0x50b47F614330d02f51154c4F0C98e5aB2ffFAafb
    ];
