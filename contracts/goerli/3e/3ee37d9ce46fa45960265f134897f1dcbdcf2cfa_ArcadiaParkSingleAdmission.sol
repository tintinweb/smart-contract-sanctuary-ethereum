...

{
  ...
  constructor(string memory customBaseURI_, address accessTokenAddress_)
    ...
    ERC721("ArcadiaParkSingleAdmission", "ARCADIA1")
...
for (uint256 i = 0; i < count; i++) {
    ...
    if (accessTokenIsActive && accessToken.balanceOf(msg.sender) > 0) {
        ...
        require(false,"Insufficient payment, 0.03 ETH per item");
