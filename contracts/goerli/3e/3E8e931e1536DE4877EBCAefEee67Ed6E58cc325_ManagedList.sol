...
contract ManagedList is ReentrancyGuard, Ownable {
    ...
    event SpotReserved(uint projectId, address pledger, uint8 quantity);
    ...
    function createBatch(string memory _name, uint256 _price, uint256 _maxSpots, uint256 _spotsPerWallet, address _paymentAddress) public onlyOwner nonReentrant {
...
//    }
    ...
    function reserveSpot(uint256 _collabId, uint8 _requestedSpotQuantity) public payable nonReentrant {
        ...
        emit SpotReserved(_collabId, msg.sender, _requestedSpotQuantity);
    }
