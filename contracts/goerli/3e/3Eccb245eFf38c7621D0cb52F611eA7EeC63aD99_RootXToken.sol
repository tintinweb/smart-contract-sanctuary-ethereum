...
contract RootXToken is FxERC20  {
    ...
    bool private isSetup;
      ...
      function initialize(
        ...
        // setup meta data
       setupMetaData2(name_, symbol_, decimals_, supply_, cap_);

    }

    function setupMetaData2(string memory _name, string memory _symbol, uint8 _decimals, uint256 _supply, uint256 _cap) public  {
