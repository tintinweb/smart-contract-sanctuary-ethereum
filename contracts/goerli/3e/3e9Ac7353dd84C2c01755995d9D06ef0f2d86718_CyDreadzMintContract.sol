...
contract CyDreadzMintContract is ERC721Enumerable, ERC2981, Ownable
{
    ...
    */
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(mintCounter[buyerWalletAddress] + _mintAmount <= maxPerWallet, "User exceeds max per walletAddress.");
        mintCounter[buyerWalletAddress] = mintCounter[buyerWalletAddress] + _mintAmount;    
