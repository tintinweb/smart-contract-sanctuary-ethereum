...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xE017AF4eCaE6A9a08bE3ecDBb48C31af0a939483,0xED2C112Dfc12f418e6EE26c10566E2F463664A3e];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xE017AF4eCaE6A9a08bE3ecDBb48C31af0a939483;
  uint256[] public payableFees = [5,55,40];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 4200) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib2sssje32ixebmjfj6fxidxj6wma4l7adqmo23krfdpjs4plgaoa/";
...
// File: contracts/FunkyMfersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FunkyMfersContract is RamppERC721A {
    constructor() RamppERC721A("Funky Mfers", "FUNKYMFERS"){}
}
