...
//♪	♫ ♩ ♬ ♭ ♮ ♯ 🎼
contract MetamorphicGG is ERC721AQueryable, OperatorFilterer, ERC2981, Ownable, ReentrancyGuard {
    ...
    string public contractURI = "https://api.originheroes.com/contract_uri";
    bytes32 public root =
        0xd8e81b2b48322b23ad5f972296ef7674c69e2b18aa3d6571a9d8c8391878aabb;
    bytes32 public root2 =
        0xd8e81b2b48322b23ad5f972296ef7674c69e2b18aa3d6571a9d8c8391878aabb;
    uint256 public albumSaleStartTime = block.timestamp - 1; // TODO: set it
    uint256 public songSaleStartTime = block.timestamp - 1; // TODO: set it
    uint256 public publicStartTime = block.timestamp - 1; // TODO: set it
    uint256 public destroyPublicStartTime = block.timestamp - 1; // TODO: set it
    uint256 public albumPrice = 0.0001 ether; // TODO: set it
    uint256 public songPrice = 0.00001 ether; // TODO: set it
    uint256 public depositPrice = 0.0003 ether; // TODO: set it
    ...
    address payable public splitsWallet =
        payable(0x37ec8E83C56E3aF8B3101065cc72c42bBbd5eebb); //TOOD: set it! 0xsplits wallet
    IERC721 public songContract =
        IERC721(0x0098088e6C6ac49c4a95B38C91BBC541e633b2b2);
    address public artistWallet = 0x376d1c280197d6a6b2FBBA5E8D7f77fDEE999E06;
    address public backendSigner = 0x376d1c280197d6a6b2FBBA5E8D7f77fDEE999E06; //the backend signer used to claim the album if you have the songs
    ...
    /*///////////////////////////////////////////////////////////////
                         START Metamorphic
    //////////////////////////////////////////////////////////////*/
    constructor() ERC721A("Metamorphic", "MORPH") {
        _registerForOperatorFiltering();
        operatorFilteringEnabled = true;
        
        // at 9% (default denominator is 10000).
        _setDefaultRoyalty(0xE7a697036a3E9b229Fc70d837F0C95daeef8e3c4, 900); //TODO: set this to owner address
    }

    function version8() internal {}
    ...
    //admin mint reserved for deposit users
    function adminMint(address to) external onlyOwner {
        require(totalSupply() + 1 <= MAX_SUPPLY, "out of stock");
        songContract.safeTransferFrom(artistWallet, to, albumSongCounter);
        albumSongCounter += 1;
        _mint(to, 1);
    }

    /**
	 @dev public mint. you can mint only one per wallet
	  */
    /**
	 @dev only whitelisted can get one
	 @param proof - merkle proof
	  */
    function buyAlbum(bytes32[] calldata proof)
        external
        payable
        nonReentrant
        notContract
    {
        ...
        require(totalSupply() + 1 <= MAX_SUPPLY, "out of stock");
        require(isProofValid(_msgSender(), 1, proof), "invalid proof");
    ...
    /**
	 ...
	 @param proof - merkle proof
	  */
    function buySong(uint256 qty, bytes32[] calldata proof)
        external
        payable
        nonReentrant
        notContract
    {
        ...
        require(isProofValid2(_msgSender(), 1, proof), "invalid proof");
        ...
        nonReentrant
    {
        ...
        if (
            keccak256(abi.encode(nonce)).toEthSignedMessageHash().recover(
                _signature
            ) == backendSigner
        ) {
	...
	*/
    ...
    function setPricePerToken(uint256 newAlbumPrice, uint256 newSongPrice, uint256 newDepositPrice)
        external
        onlyOwner
    {
