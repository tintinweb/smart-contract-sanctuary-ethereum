...
contract Naughtymonkey is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmS64t9DRnwZTj4LGnxTKHYgTxnxTBevA1XQdmRBhsaiQc/";
  ...
  ) ERC721A("Naughtymonkey", "Ngmonkey") {
