...
contract VyderOGNFT is ERC721AQueryable, Ownable, ReentrancyGuard, OperatorFilterer {
  ...
  constructor(
    ...
    uint256 _mintTeamAmount,
    address _mintTeamAddress 
  ) ERC721A(_tokenName, _tokenSymbol) OperatorFilterer(address(0), false) { // Don't use a pre-set filterer
    setCost(_cost);
    maxSupply = _maxSupply;
    setMaxMintAmountPerTx(_maxMintAmountPerTx);
    setHiddenMetadataUri(_hiddenMetadataUri);
    _safeMint(_mintTeamAddress, _mintTeamAmount);
  }
