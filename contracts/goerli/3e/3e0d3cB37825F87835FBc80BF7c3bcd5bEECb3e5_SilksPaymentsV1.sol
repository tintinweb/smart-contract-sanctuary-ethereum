...
contract SilksPaymentsV1 is Ownable {
    ...
    function getNumPurchasesForSale(string calldata _saleId) view public returns(uint) {
        return numPurchases[_saleId];
    }
    
    function getNumPurchasesByBuyer(address buyer, string calldata _saleId) view public returns(uint) {
