...
contract NowUnitedTheMusicalTier1 is ERC1155, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _baseURI, address _primaryRecipient, address _secondaryRecipient, uint16 _royaltyBPS) ERC1155(string(abi.encodePacked(_baseURI, "{id}.json"))) {
        currentTokenId = 1;
        maxSupply = 60000;
