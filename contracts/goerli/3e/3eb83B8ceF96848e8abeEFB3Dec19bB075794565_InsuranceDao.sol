...
contract InsuranceDao {
    ...
    //goerli
    address public constant USDT = 	0x3F1fD406Af56B5643D5887A3942Ec1f643b94f79;
    address public constant USDC = 	0xDE61e707B0A28fE9f6EBEf6ee053aB3B0b3B30BB;
    address public constant WETH = 	0x6CfadBe894b506Feec38096464C097624B38D5F7;
    address public constant WBTC = 	0xE6d830937FA8DB2ebD2c046C58F797A95550fA4E;
    ...
    function insure(uint256 amount, string memory symbol, address insuredDaoLp) public returns (uint256) {
        ...
        if(outToken == WETH) {
            payable(address(insuredDaoLp)).transfer(amount);     
        }else {
            IERC20(outToken).safeTransfer(address(insuredDaoLp), amount);
        }
        _payOut += amount;
        return amount;
    }
