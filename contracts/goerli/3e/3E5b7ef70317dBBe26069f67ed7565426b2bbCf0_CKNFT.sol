...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    uint256 public MAX_MINT = 501;
    uint256 public max_mint_wl = 501;
    uint256 public MAX_AL_MINT = 501;   
    ...
    //address public companyTreasuryWallet = 0x79e7e03d7BCbEeeF25B2C4cBBC82ecc677C7fe5C;
    address public companyTreasuryWallet = 0x6666Ec43dEb25910121Dd544E89301a86165Fa6b;

    constructor()
        ERC1155(
            "https://continentkey-genesis-key.mypinata.cloud/ipfs/QmPtJANbhkDYvG2cXts5SregogRLTu3uy9xibg8TKpEJwB/{id}.json"
        )
    {
        contractUri = "https://continentkey-opensea.mypinata.cloud/ipfs/QmTVbb4Wy7j68iGZ7qkVifGeEGGeEGPmvtW9SWfNpXADT1"; // json contract metadata file for OpenSea

        tokenIdToMaxSupplyPlusOne[0] = 2500;        
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "Only 500 Nfts by allowlists address."
        );
        require(_id < MAX_TOKEN_ID_PLUS_ONE, "id must be < 1");
        require(tokenIdToExistingSupply[_id] + _amount <= 1500, "All tokens minted");
