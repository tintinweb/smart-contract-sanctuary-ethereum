...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        i_gasLane = gasLane; // gasLane = keyHash = gasLimit in wei
    ...
    /* this function will be called by chainlink keeper nodes
    they look for the 'upKeepNeeded' value. If true - performUpKeep is called, else nothing is done */
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        // requestRandomWords in vrfCoordinator'll also emit an event with request id
        // so the below event emit is redundant
