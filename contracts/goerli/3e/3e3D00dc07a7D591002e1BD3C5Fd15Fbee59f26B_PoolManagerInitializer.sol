...
contract Pool is IPool, ERC20 {
    ...
    /**
     * This function would allow LP to lend. He needs to provide the amount and receiver of the fund. 
     * It is guarded by a modifier checkCall to check if deposit is allowed at this stage.
     * This expects approval to the contract before calling deposit
     */
    ...
    /**
     * This is same as deposit but does approval of spender on owner's behalf in same. 
     * msg.sender needs to sign the nonce and send it as params
     */
    ...
    /**
     * Simple mints the shares to the reciever on behalf of msg.sender.
     * Needs approval for this contract before calling
     */
    ...
    /**
     * Mints without approval using erc20 permit funcitonality.. Caller needs to sign the nonce.
     */
    ...
    /**
     * processes redeem. Burn the token of PoolToken of owner and sends asset Token to reciever
     */
    ...
    /**
     * processes Withdraw. Burns the token of PoolToken of owner and sends asset Token to reciever
     */
