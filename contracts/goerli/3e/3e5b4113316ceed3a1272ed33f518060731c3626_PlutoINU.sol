...
// ----------------------------------------------------------------------------
// 'PlutoINU' token AND staking contract
...
contract PlutoINU is IERC20, Owned {
    ...
    string public  name = "Pluto INU";
    uint256 public decimals = 18;
    address airdropContract;
    uint256 _totalSupply = 100000000000 * 10 ** (18); // 1,000,000
    ...
    constructor(address owner) public {
        ...
        balances[address(owner)] =   100000000000  * 10 ** (18); // 1,000,000
        emit Transfer(address(0), address(owner), 100000000000  * 10 ** (18));
