...
contract FriendsNFT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Frinds of OxCreator", "0xF") {
    }
    ...
    {
        require(!claimed[msg.sender], "0xF already claimed by this wallet");
    ...
    function giftNFT(address[] calldata addresses)
        external
        nonReentrant
        onlyOwner
    {
        uint256 numToGift = addresses.length;
        numGiftedNFT += numToGift;
