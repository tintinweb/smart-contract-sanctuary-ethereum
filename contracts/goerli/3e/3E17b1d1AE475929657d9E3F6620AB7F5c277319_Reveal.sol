...
contract Reveal is ReentrancyGuard, Ownable {
    ...
    function setCapsule(address _addr) external onlyOwner {
        _capsule = Capsule(_addr);
    }

    function setWearable(address _addr) external onlyOwner {
        _wearable = Wearable(_addr);
    }
