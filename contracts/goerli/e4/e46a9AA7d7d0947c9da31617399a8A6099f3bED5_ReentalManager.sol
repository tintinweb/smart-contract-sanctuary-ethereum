...
/// @title The contract of ReentalManager
/// @notice Manages smart contracts deployments, ids and protocol roles
contract ReentalManager is IReentalManager, AccessControlUpgradeable {

    /** STORAGE */
    
    /// @inheritdoc IReentalManager
    ...
    function deployProxyWithImplementation(
        ...
        require(!locked[id], "ReentalManager: id locked");
        _deployProxy(id, implementation, initializeCalldata);
