...
contract Eclipse is EclipseAccess {
    ...
    event ArtistCreated(address wallet);
    ...
    function _createCollection(
        ...
        IEclipseMinter(minters[pricingMode]).setPricing(instance, pricingData);
        store.setCollection(
            Collection(
                id,
                params.artist,
...
abstract contract EclipseAccess is Ownable {
    ...
    function setAdminAccess(address admin, bool access) public onlyEclipseAdmin {
        admins[admin] = access;
    }
}
