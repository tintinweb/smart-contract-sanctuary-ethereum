...
contract PadelSquareAjmanEvent is ERC721, ERC2981, OperatorFilterer, Ownable {
    using Strings for uint256;
    bool public operatorFilteringEnabled = true;

    bool public paused = true;
    // Test Values:
    uint256 public salePricePlatinum = 1120000000000000; // 0.0112ETH
    uint256 public salePriceGold = 4500000000000000; // 0.0045ETH
    // Live Values
    // uint256 public salePricePlatinum = 112000000000000000; // 1.12ETH ~ AED 5,000
    // uint256 public salePriceGold = 450000000000000000; // 0.45ETH ~ AED 2,000
    uint256 public maxVipNFTs = 10;
    ...
    uint256 startPlatinumTokenID = 11;
    uint256 startGoldTokenID = 25;
    string public baseUri;

    constructor() ERC721("Padel Square Club Ajman Event", "PSCAE") {}
