...
//// Using Uniswap
import "./PSwapPair.sol";

contract PSwapFactory {
        ...
        returns (address pair)
    {
        ...
        PSwapPair _pair = new PSwapPair();
        pair = address(_pair);
        PSwapPair(pair).initialize(token0, token1);
...
contract PSwapERC20 {
    ...
    string public constant name = "PSwap-V1";
...
import "../interfaces/IPSwapFactory.sol";
import "./PSwapERC20.sol";

contract PSwapPair is PSwapERC20 {
    using SafeMath for uint256;
