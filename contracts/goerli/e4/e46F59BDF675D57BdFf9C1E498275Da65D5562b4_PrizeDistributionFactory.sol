...
contract PrizeDistributionFactory is Initializable, Manageable {
    ...
    function estimatePartialPicks(
        ...
        uint256 normalizedBalance = (balances[0] * 1 ether) / totalSupplies[0];
     ...
     * @return PrizeDistribution using info from the Draw for the given draw id, total network ticket supply for the draw.
     */
     ...
     * @return A PrizeDistribution based on the given params for the passed draw id
     */
