...
contract ChilesNogadaNFT is Ownable, ERC721A, ReentrancyGuard {
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721A) returns (string memory) {
        ...
        return bytes(base).length > 0 ? string(abi.encodePacked(base, Strings.toString(tokenId), ".json")) : "https://bafybeidypsa5x4bzcdh4o4i3fwrv5mw25wl4vlqsijnnhgi7a76sylfwd4.ipfs.nftstorage.link/";
    }
}
