...
//                           ,s#b  ;N       ^% @N.  @#                                    //
//                          ###b    %       'w  7#p @##b      |N                          //
//                          #N,, @#Nm#######Nm##p'#N,#b sw, ,s##N                         //
//                         {#~|##N#M\"       '^7"777777 "777|^^7#p                        //
//                         @b ,J##                              @#                        //
//                          `  j##                              j#                        //
//                          #  j##    s#####Nm,           ,,smw,j#                        //
//                          #"%{##          .."7         "T|.``|jb                        //
//                          @b ]##   ,aN#####Nw           ,aNNw,#`                        //
//                          {##N#b   |##@#^[email protected]#[email protected]       ##W#|"##^                         //
//                         {##'       |##N  {b j#        ` #  #^                          //
//                         @###p        7%@##NM7        '%@mm#|                           //
//                          7####p                 ,mp                                    //
//                           ##[email protected]#                7W\                                    //
...
contract E11E is ERC1155Creator {
    constructor() ERC1155Creator("E11E EVANS COLLECTION", "E11E") {}
}
