    ...
    ERC2981
{
    ...
    */
    ...
    uint256 public maxDigiCollectPerWallet = 200;
    uint256 public digiCollectPrice = 0 ether;
    uint256 public saleActiveTime = type(uint256).max; // sale is closed by default

    string digiCollectImages = "https://nftstorage.link/ipfs/bafybeih4nywxgrpij7w2mgjv5c3gsejo4y53h2sk2jfgdqlbohl45oxa6q/";
