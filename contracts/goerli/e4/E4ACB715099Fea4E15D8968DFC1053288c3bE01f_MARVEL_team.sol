...
contract MARVEL_team is ERC721URIStorage {
  ...
  string[] firstWords = ["CAPTAINAMERICA ", "THOR ", "IRONMAN ", "HULK ", "BLACKPANTHER ", "THANOS "];
  string[] secondWords = ["WITCH ", "NATASHA ", "ANTMAN ", "SPIDERMAN ", "GOBLIN " , "LOKI ","Dr.STRANGE "];
  string[] thirdWords = ["ULTRON ", "HAWKEYE ", "BUCKY ", "SHANGCHI ", "DEADPOOL ", "WOLVERINE "];
