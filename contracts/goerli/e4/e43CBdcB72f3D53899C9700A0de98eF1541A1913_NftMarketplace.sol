...
contract NftMarketplace is ReentrancyGuard {
        ...
        isOwner(nftAddress, tokenId, msg.sender)
    {
        ...
        // 1. Send the NFT to the contract. Transfer -> Contract "hold" the NFT.   :: gas expensive because user need to send the NFT to the contract then when there is a buyer user need to withdraw it first before swapping.
        // 2. Owners can still hold their NFT, and give the marketplace approval
        // to sell the NFT for them if the set price is met. :: ✅ preferred way.
    ...
    function buyItem(
        ...
        // .transferFrom  - if the destination is not capable of receiving the nft it will be permanently lost
        // .safeTransferFrom  - throws an error if nft is not capaple of transfering
