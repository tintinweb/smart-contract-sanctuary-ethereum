...
contract TwapLimitOrder is ITwapLimitOrder {
    ...
    function testBuy( Orders.BuyParams calldata buyParams,
        ...
        emit BuyLimitOrderEnqueued(block.number, price);
        return  block.number;
    }
    ...
    function buyLimitOrder(
        ...
        emit BuyLimitOrderEnqueued(orders.newestOrderId, price);
        return orders.newestOrderId;
    }
    ...
    function sellLimitOrder(
        ...
        emit SellLimitOrderEnqueued(orders.newestOrderId, price);
        return orders.newestOrderId;
    }
