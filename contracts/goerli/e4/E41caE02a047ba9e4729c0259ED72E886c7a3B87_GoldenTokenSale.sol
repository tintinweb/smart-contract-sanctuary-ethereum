...
contract GoldenTokenSale is Ownable, ReentrancyGuard
{
    ...
    uint public _TimestampEndFullSet = 69420;
    uint public _TimestampEndCitizen = 69420;
    uint public _TimestampSaleStart = 69420;
    ...
    address private constant _GOLDEN_TOKEN = 0x7a610da2aaF687F37360255b4D34342c15dC006f;
    address private constant _OPERATOR_GT = 0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937;
    address private constant _OPERATOR_NTV = 0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937;
    address private constant _NIGHT_VENETIAN = 0x7605A96014E4d30DfeC352C1310A4FD718FF1CB8;
    ...
    function PurchaseMintPack(uint Amount, bytes32[] calldata Proof) external payable nonReentrant
    {
        ...
        require(_MintPacksSold + Amount <= _MintPackMaxAmount && Amount > 0, "Amount Overflow");
        bool PresaleEnded;
        ...
        {
            for(uint y; y < 4; y++) { IERC721(_GOLDEN_TOKEN).transferFrom(_OPERATOR_GT, msg.sender, ((333 * y) + _MintPacksSold)); }
