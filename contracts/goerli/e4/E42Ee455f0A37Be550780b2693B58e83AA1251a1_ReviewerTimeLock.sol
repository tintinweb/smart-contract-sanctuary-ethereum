...
contract ReviewerTimeLock is Initializable, TimelockControllerUpgradeable  {
    constructor(){
        _disableInitializers();
    }

    function initialize(address proposer) initializer public {
        address[] memory proposers = new address[](1);
        proposers[0] = proposer;
        address[] memory executors = new address[](1);
        executors[0] = address(0);
        __TimelockController_init(1, proposers, executors, address(0));
    }
}
