 ...
 * @notice This contract handles minting 11-28-22 straight to mainnet tokens.
 */
contract _112822StraightToMainnet is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    constructor() ERC721A("11-28-22 straight to mainnet", "TEST") {
