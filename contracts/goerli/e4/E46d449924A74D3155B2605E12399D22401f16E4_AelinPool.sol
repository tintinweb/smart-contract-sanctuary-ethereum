...
contract AelinPool is AelinERC20, MinimalProxyFactory {
    ...
    function initialize(
        ...
        require(
            1 minutes <= _purchaseDuration && 30 days >= _purchaseDuration,
    ...
    function createDeal(
        ...
        require(
            1 minutes <= _proRataRedemptionPeriod &&
        ...
        require(
            1 minutes <= _holderFundingDuration &&
        ...
        if (proRataConversion == 1e18) {
            ...
            require(
                1 minutes <= _openRedemptionPeriod &&
