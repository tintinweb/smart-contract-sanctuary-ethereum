...
import "./MoxieArtTradable.sol";

contract MoxieArtFactory is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Moxie marketplace contract address;
    address public marketplace;

    /// @notice Moxie bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new MoxieArtTradable contract
        ...
        returns (address)
    {
        ...
        MoxieArtTradable nft = new MoxieArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing MoxieArtTradable contract
    ...
    /// @notice Method for disabling existing MoxieArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title MoxieArtTradable
 * MoxieArtTradable - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract MoxieArtTradable is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // Moxie Marketplace contract
    address marketplace;
    // Moxie Bundle Marketplace contract
    ...
    /**
     * Override isApprovedForAll to whitelist Moxie contracts to enable gas-less listings.
     */
    ...
    {
        // Whitelist Moxie marketplace, bundle marketplace contracts for easy trading.
