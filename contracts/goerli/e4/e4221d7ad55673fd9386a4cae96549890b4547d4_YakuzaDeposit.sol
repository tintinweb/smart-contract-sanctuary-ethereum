...
contract YakuzaDeposit is Ownable {
    ...
    address public tokenAddress = 0x8e87d154CAc8FA8A088B35F8143399AA99fDa5c6;

    // Default: Burn
    address public depositDestination = address(0);
    ...
    function depositTokens(uint _depositAmount) external {
        ...
        require(token.balanceOf(msg.sender) > _depositAmount, "You do not have enough tokens to stake this amount"); 
