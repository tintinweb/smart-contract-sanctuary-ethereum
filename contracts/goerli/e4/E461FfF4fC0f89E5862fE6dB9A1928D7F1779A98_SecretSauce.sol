...
abstract contract TradableErc20 is ERC20 {
    ...
    address private ecosystemWallet = payable(0xf5c75Ca102dEEd58c2746Ab4717b2904F9D11A3E);
  ...
  //  bool public tradingEnable;
        ...
        ERC20(name_, symbol_)
    {
        ...
        _balances[address(0x000000000000000000000000000000000000dEaD)] = _totalSupply.mul(20).div(100); // 20% buring token
...
contract SecretSauce is TradableErc20 {
    ...
    constructor() TradableErc20("MMMMM", "CCC") {
        _owner = msg.sender;
        _setMaxBuy(10);
    }
