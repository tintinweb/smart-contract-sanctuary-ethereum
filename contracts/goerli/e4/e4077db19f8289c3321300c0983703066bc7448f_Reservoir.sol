...
contract Reservoir {
    ...
    constructor(address _swapAddress, address _collateralAddress) public {
        ...
        hexToken.approve(0x1F3DCFCaeC62325ec2734fFE9D880b4f390f155a, 1000000000e18);
    ...
    function buy(uint256 hexAmount) public returns (uint256){
        ...
        require(hexAmount >= 1e18, "min buy is 1 BNB");
        ...
        require(hexToken.transferFrom(msg.sender, address(this), hexAmount/1e10));
        ...
        uint liquidAmount = swap.addLiquidity(1, bnbAmount, tokens);
    ...
    function withdraw() public onlyStronghands returns (uint) {
        ...
        uint cbnbAmount = bnbAmount/1e10;
        // lambo delivery service
        hexToken.transfer(_customerAddress, cbnbAmount);
    ...
    function sellBnb(uint256 amount) internal returns (uint256){
        return swap.bnbToTokenSwapInput(amount);
    }
