...
contract Staker {
  ...
  modifier notCompleted() {
    require(!exampleExternalContract.completed(), 'Execution has completed');
    _;
  }
  ...
  function timeLeft() external view returns (int256) {
    int256 difference = int256(deadline) - int256(block.timestamp);
    return int256(difference < 0 ? int256(0) : difference);
  }
