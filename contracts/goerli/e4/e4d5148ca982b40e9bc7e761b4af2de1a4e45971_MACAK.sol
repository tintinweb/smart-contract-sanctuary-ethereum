...
//    Portal: https://t.me/macak_eth_portal
//    Web: https://www.macak-eth.com 
//    Twitter: https://twitter.com/macak_eth
//
...
contract MACAK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public percentForLPBurn = 0; // 25 = 0%
    ...
    constructor() ERC20("MACAK", "$MACAK") {
        ...
        marketingWallet = address(0x9c18b4c4b0634C0E07357C4530f3c6c1E7e5cF1B); // set as marketing wallet
        devWallet = address(0x3916509eEd6578BaF9418f2943A534779aDDE1f8); // set as charity wallet
