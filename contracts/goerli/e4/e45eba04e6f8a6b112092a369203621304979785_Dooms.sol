...
contract Dooms is ERC721, Ownable {
    ...
    function mint(bytes32[] memory proof_, uint256 quantity_) external {
        ...
        (, uint256 allowance) = quantity_.trySub(_minted[msg.sender]);
    ...
    function isRevealed(uint256 id_) external view returns (bool) {
        return _revealed[id_];
    }
