...
// File: contracts/OBYCHonorbearyBears.sol

pragma solidity >=0.8.17 <0.9.0;

error TokenDoesntExist();

contract OBYCHonorbearyBears is ERC721A, Ownable {
    mapping(uint256 => string) private _tokenURIs;

    event NewOBYCHonorbearyBearsMinted(address sender);

    constructor() ERC721A("OBYC Honorbeary Bears", "OHB") {}
        ...
        onlyOwner
    {
        ...
        emit NewOBYCHonorbearyBearsMinted(msg.sender);
    }
