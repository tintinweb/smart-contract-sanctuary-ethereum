    ...
    NiftyPrideAuctionHouse
{
    ...
    function startFirst() external onlyOwner {
        ...
        // forcing the first auction timestamp at June 1st 1PM UTC because I started this project in the afternoon
        // of June 1st 2022 and I am not sure I can deploy before June 2nd
    ...
    function _nextBeneficiary() internal returns (address) {
        ...
        address beneficiary = _beneficiaries.at(beneficiaryIndex % length);
        beneficiaryIndex = (beneficiaryIndex + 1) % length;
        return beneficiary;
    }
}
