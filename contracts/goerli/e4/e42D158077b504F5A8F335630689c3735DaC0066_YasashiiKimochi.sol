...
/*
  ...
  `    `       `   `  `    .M]..-WS=?JM|..dN   `    `       d%.-+6=??=1HF..(M%     `     `        `
    ...
    .d8Z1;;_(:::::;;;;:<_:<+OwwXHN,.(HugNMB"<<!_...._?7""[email protected]_(d#1+z;:<;;<;;:::::::;zn.
   ...
   jkI~<<+?zOq#=~~<+1zlOwXXZWM!....?N,HNMB([email protected]`.JNJMNMMt(M#...dMN0z?<<~~~~.(Wmz><::::;zH
    ...
    (Wk<~~~~<~d!  -___(zOwd\...._(((-(((J&JggQmmmmgg++JJJJJJ-----......_MN??<<_~~~.(Nx~~~~.~_J%
     XX0-~~~~(5(+d:__~(>1dNgMMMMWB9Y77C1<<:<<<<<<??77<77?C17?7TTHHMMNg.,JN2;<<~.(QaJJE<~~~~_(f
      ?Ww-~~~_<<<H~.JgH0OwU01?>><;::::::::::::::::::::::::::::::::::<[email protected]+j.~_(k+=>><~~_(+K`
       .Wk+~~::;<v11z1==OwXI?>>;;::::::::::;:;::::::::;:::::::::::::::::[email protected]+?;<:::+gY`
         (Sw+_:::;<>>>>+jKZz>>><++++<:::::;:;;;;;;;;;;;;:;:;;:::::(::::::Wz=????>><<<<:+&Y'
           (4y+++++>;>>+WSv<>>>+#77dMMMNmaJ+:::j+&J+:::<j+ggMMM#""Mb:~:::?Nx===?><::<jgY!
              ?zAzOz&+uXMZ1>????d/`dNMMMF`[email protected]:(jWMgHWh+:Jb~?MNMM#~_dt::::::JNQez1&j&[email protected]^
                    `` J#Z?>>?>?>W,`?""'.(8:+WMgmmmHNHc:?e`?"HB!..8::::::;<N.?77^`
                       dWI??>>>>?>?HaaJd8<:[email protected]@HMc:?4+...JB>;;;;;;;;:d&....
                       JKZ?<>>;>;>;;;:::;<[email protected]@[email protected]@HHHHMb~::::;;;;;>;;;>>;+j9!__~(T,
                       ,NXI>?>>>>>>>>;;;;;[email protected]#(::::::;;>>>>>>>+H>_`.....(4.
                        (HkO??????>>>>;;;;+HMHHHHHHHHHMD(;::::;;>>????>>+#_.``````.-4.
                         ?HZy====??>;;;;;;;[email protected];>;;:::;;>>>>?>><;B_-``.``.._J\
                          ?MmXOz=????>>;;;>>jxzTMMMB9C>e>;;;;;:;;>>>>>+jd6+__....._(=
                            ?MNmyOzz+?++>>>??SgggMHaggd5;>;;;;;;;;>+&kH6<<<<~~__(JY`
                               ?TMNmgQyOlzl=zzltttOOOlll11+++++=ugWBC<<::::~:~-J=
                                 ...
                                 [email protected]@[email protected]~~~~~~(N-::(d%
                                [email protected]@[email protected],~([email protected]~~~~~~~_X(JY`
                              .dHHHHHMMmMHMMHHMMMMMMMHNbMp(NWHS~~~~~~~-(#`
                              [email protected]~j~~?MNHkMcM~:d_~~~_(gM+
                             (MHHMHqqHMMBdMNMB:~~d~~~~?TBM$N~~d>[email protected]
                            -HHHMHqqHMMD~_Jl~~~~~d~~~~~~~~~d~~Jr~~([email protected]@Mb
*/
contract YasashiiKimochi is ERC1155, Ownable, Pausable {
    ...
    // id 0,1,2,3 -> SBT②,③,④,⑤
    uint256[] public mintCost = [0.03 ether, 100 ether, 0.04 ether, 0.05 ether];
    ...
    constructor() ERC1155("") {
        ...
        symbol = "YKSBT";
        setURI(0,"ipfs://bafkreibpt6fz7yie24p2uxvzm7ijdbevlw3rgklm22r372z65c6lu457au");
        setURI(1,"ipfs://bafkreifo226qqosyjf4zaykb4htlxh7xfl6eap4zutjvxnyr6dbhpwdy4i");
        setURI(2,"ipfs://bafkreifxycbue5drlk4mcutfggh4dbkz5yfb5gp3uts6jlxvqzhmkhclca");
        setURI(3,"ipfs://bafkreig5rceohcyssnwf2gt265eksxg5aukntiwfdwielgfslulmtyeham");
    }
    ...
    function publicMint(
        ...
        require(
            balanceOf(msg.sender, _id) + _mintAmount <= _allocation[_id],
            "Exceeds your allocation"
        );

        require(mintCost[_id] * _mintAmount <= msg.value, "Not enough eth");
