...
{    
    ...
    {  
        ...
        GalaGameItems(params.token).burn(msg.sender, baseIds, amounts);
...
interface GalaGameItems is IERC1155 {
...
contract MessageValidator is OwnableUpgradeable {
    ...
    modifier isValidMessageForErc1155(paymentMessageErc1155 calldata params) 
    {        
        bytes32 message = keccak256(abi.encodePacked(params.orderId, params.token, params.baseId, params.amount, params.transBlock, params.transType));
        require(recoverSigner(message, params.sig) == importantAddress, "ERC1155 Token Invalid signature");        
        _;    
    }   
