...
contract ABABABA is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(uint256 _maxSupply, uint256 _amountForDev, address _teamAddress) ERC721A("ABAB", "ABABAB"){
    ...
    function mint(bytes32 hash, bytes memory signature) external payable callerIsUser {
    ...
    function teamMint() external payable callerIsUser{
        ...
        require ( teamMintStatus == false, "Team NFT has been minted.");
        _internalMint();
    }    
