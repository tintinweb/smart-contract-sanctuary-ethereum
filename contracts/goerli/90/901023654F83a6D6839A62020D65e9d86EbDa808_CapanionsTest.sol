...
contract CapanionsTest is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint public mintLimit = 50;
    uint public presaleMintLimit = 25;
    uint public maxSupply = 10000;

    mapping(address => bool) public denylist;

    constructor() ERC721A("CapanionsTest", "CAPNT") {
    }

    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        require(_exists(_tokenId), "No data exists for provided tokenId.");
        return baseTokenURI;
    }
