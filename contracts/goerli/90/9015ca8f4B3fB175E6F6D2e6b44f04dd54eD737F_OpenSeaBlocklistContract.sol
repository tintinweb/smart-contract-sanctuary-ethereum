 ...
 * @notice This contract handles minting OpenSea Blocklist Contract tokens.
 */
contract OpenSeaBlocklistContract is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xadb102cb595173843407d6c484E689287d5B7AE5;
    ...
    constructor()
        ERC721A("OpenSea Blocklist Contract", "OSBC")
        RevokableOperatorFilterer(
