...
contract CFTBET {
    ...
    address payable private _wallet = payable(0xf3166439517D09F3D9b0a9c379081A3bB0b0B6A0); // our wallet address
    address payable private ceo = payable(0xf3166439517D09F3D9b0a9c379081A3bB0b0B6A0); // ceo address
    address payable private fas = payable(0xf3166439517D09F3D9b0a9c379081A3bB0b0B6A0); // fas address
    address payable private tresor = payable(0xf3166439517D09F3D9b0a9c379081A3bB0b0B6A0); // tresor address
    address payable private dev = payable(0xf3166439517D09F3D9b0a9c379081A3bB0b0B6A0); // dev address
    address payable private staking = payable(0xf3166439517D09F3D9b0a9c379081A3bB0b0B6A0);// staking address
    ...
    constructor () {
        ...
        _token = IERC20(0x555a9a4c44eE2b506e738312d4fA55923b85a793);
        owner = msg.sender;
        owner2 = 0xf3166439517D09F3D9b0a9c379081A3bB0b0B6A0;
    }
