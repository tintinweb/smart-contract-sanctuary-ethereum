...
contract OldERC721Sim is ERC721Enumerable {
    ...
    function mint(address recipient, uint256[] calldata tokensIds_) external {
    ...
    function tokenURI(uint256 tokenId_) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0	? string(abi.encodePacked(currentBaseURI, Strings.toString(tokenId_), ".json")) : "";
    }
