...
contract CustomNFT is ERC721, Ownable {
    ...
    uint256 public tierPrice = 0.05 ether;    
    uint256 public totalSupply;
    uint256 public MINT_CAP = 21;
    address public dev = 0x09f2e7fA562Db13Aa3aC27EF753003967FaAc62a; //address to withdraw to
    ...
    function publicsaleKangaroo(uint256 num) public payable returns (bool) {
        ...
        require(msg.value >= tierPrice * num,'Ether value sent is not sufficient');        
        return _mintKangaroo(num);
    }
    ...
    function setTierPrice(uint256 _newPrice) public onlyOwner {
        tierPrice = _newPrice;
    }    
