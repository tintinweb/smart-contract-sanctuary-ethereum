...
contract FlashSwapTest1 is IUniswapV2Callee {
    ...
    function _sushi_swap(uint[] memory amounts, address[] memory path, address _to) public virtual {
    ...
    function _swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(
            path[0], msg.sender, pairForSushiswap(SushiswapV2Factory, path[0], path[1]), amounts[0]
        );
    ...
    function uniswapV2Call(address _sender, uint _amount0, uint _amount1, bytes calldata _data) override external {
        ...
        require(amountTokenBorrowed > 0, "token borrowed is 0");
        ...
        uint amountReceived = _swapExactTokensForTokens(amountTokenBorrowed, amountRequired, pathA, msg.sender, block.timestamp)[1]; 
