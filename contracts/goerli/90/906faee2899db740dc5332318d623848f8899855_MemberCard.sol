...
contract Dispatcher is IMemberCard, IDispatcher, Ownable {
    ...
    //     memberCard = new MemberCard(address(this), "Jon Doe");
    // }
    ...
    ERC721Burnable
{
    ...
    function mint(string memory _name) public returns (uint256) {
        ...
        // Skill storage initialSkill;
        // initialSkill.name = "";
        // initialSkill.level = 0;
        // initialSkill.xp = 0;

        // Badge storage initialBadge;
        // initialBadge.name = "";
        // initialBadge.token = 0x0000000000000000000000000000000000000000;
        // initialBadge.level = 0;
        // initialBadge.xp = 0;

        // Skill[] storage initialSkills;
        // Badge[] storage initialBadges;

        // initialSkills.push(initialSkill);
        // initialBadges.push(initialBadge);

        // Attributes storage _holdersAttributes = Attributes(
        //     msg.sender,
        //     _name,
        //     block.timestamp,
        //     block.timestamp,
