    ...
    OwnableUpgradeable
{
    ...
    function createMetaCell(uint256 positionId) external override {
        ...
        uint256 metaCellId1 = IMetaCellCreator(metaCell).create(msg.sender);
        uint256 metaCellId2;
        if(positionId <= 200) {
            metaCellId2 = IMetaCellCreator(metaCell).create(msg.sender);
        }
        ...
        emit NewMetaCellCreated(msg.sender, positionId, metaCellId1, metaCellId2, block.timestamp);
    }
...
interface ILaboratoryEvent {
     ...
     * @param scientistId is id of Scientist NFT
     * @param tokenId1 is id of MetaCell NFT
     * @param tokenId2 is id of MetaCell NFT
     * @param timestamp is the time that event emitted
     */
