...
//    address public _artAddr;
//    address public _codeAddr;
//    address public _htmlAddr;
//    address public _artFactoryAddr;
    address public _traitsAddr;
    address public _previewerAddr;
    address public _rendererAddr;
    IColors public colors;

    string _externalUri = "https://twitter.com/BlockGenerative";
    string description = "On-chain generative coded art as part of BlockGenerative collection.";
    string name = "Pings";
...
//        require(address(_artFactoryAddr) != address(0), "No art factory address");
        ...
        if(address(_rendererAddr) != address(0)) {
            ...
            render = renderer.render(tokenId, atts, false/*, artProps*/);
        }
        else {
            render = previewImage;
        }
