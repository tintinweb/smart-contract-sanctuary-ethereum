...
//*********************************************************************//
//
//     __    _______   ______    ____  ___    ____  ____________
//    / /   / ____/ | / / __ \  / __ )/   |  / __ \/ ____/ ____/
//   / /   / __/ /  |/ / / / / / __  / /| | / / / / / __/ __/   
//  / /___/ /___/ /|  / /_/ / / /_/ / ___ |/ /_/ / /_/ / /___   
// /_____/_____/_/ |_/_____(_)_____/_/  |_/_____/\____/_____/   
//                                                              
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x56919BF963A03DBF7E1aA51fca2bb94A04187743];
  address public erc20Payable = 0x56919BF963A03DBF7E1aA51fca2bb94A04187743;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 100) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVWJG6bo5rrTyUrZ9hXr4sE8rhdriLsvKrr55UMndM7B4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/p0Z5f2XSQDkMzIeXwm8C/contract-metadata";
  }
...
// File: contracts/LendbadgeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LendbadgeContract is RamppERC721A {
    constructor() RamppERC721A("LENDBADGE", "LENDBADGE"){}
}