...
contract Hestia {
    ...
    */
    ...
    function createTask(string memory taskId, uint8 typeId, uint32 cityId, uint amount, string memory hashIpfsDetails) public {
        _createTask(taskId, typeId, cityId, amount, hashIpfsDetails);
        emit Created(msg.sender, taskId, tasks[taskId].num, typeId, cityId, amount, hashIpfsDetails);   
    }

    function createTaskAndSelectTasker(string memory taskId, uint8 typeId, uint32 cityId, uint amount, string memory hashIpfsDetails, address tasker) external {
    ...
    function _createTask(string memory taskId, uint8 typeId, uint32 cityId, uint amount, string memory hashIpfsDetails) private {
