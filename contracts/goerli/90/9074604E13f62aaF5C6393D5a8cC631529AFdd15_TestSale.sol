...
contract TestSale is Ownable {
    ...
    uint public constant DUTCH_ROUND_DURATION = 200 seconds;
    uint public constant DUTCH_ROUND_MAX_DURATION = 200 seconds;
    ...
    function publicMint(uint _quantity,address _to) public payable isInitialized isPublicSaleActive {
        uint price = getPrice();
     ...
     function publicMintStake(uint256 _quantity) external payable isInitialized isPublicSaleActive {
        ...
        this.publicMint{value: msg.value}(_quantity,msg.sender);
        uint totalSupply=ITestNFT(oxyalandsNFTAddress).totalSupply();
