 ...
 */
contract NiftyLaunchComicsL2 is ERC721Upgradeable, OwnableUpgradeable, PausableUpgradeable, IMintable {
    string public uri;
    address public imx;
    ...
    function initialize(address _imx) external initializer {
        __ERC721_init("Nifty Launch Comics L2", "NLCL2");
        __Ownable_init();
        __Pausable_init();
    ...
    function mintFor(address _to, uint256 _quantity, bytes calldata _mintingBlob) external override onlyOwnerOrIMX whenNotPaused {
