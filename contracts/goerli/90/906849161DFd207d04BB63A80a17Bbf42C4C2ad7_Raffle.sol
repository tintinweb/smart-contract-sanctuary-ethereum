 ...
 *  @author Neel Patel
 *  @notice This is contract is for creating an untamparable decentralized smart contract
 *  @dev This implemetnts VRFV2 and chainlink keepers
 */
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function enterRaffle() public payable {
        ...
        //Event Name => reverse of The Function Name
        emit RaffleEnter(msg.sender);
    }

    /**
     * @dev This is the function that chainlink keeper nodes call they look for the `upkeepNeeded` to return true.
     * the follwing should true in order to return it true;
     * 1. Our Time interval should have passed
     * 2. The lottery should have one player and some ETH
