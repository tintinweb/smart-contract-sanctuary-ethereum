...
contract OnChainPhunks is ERC721, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    uint16[10001] public availablePunks;
    ...
    constructor() ERC721("OnChainPhunks", "OCPHUNKS") Ownable() {}
    ...
    /// @param tokenId The tokenId value used to retreive the assigned CryptoPunk.
