...
contract ROSAI is Context, IERC20, Ownable {
    ...
    TaxStructure private initialSellTax = TaxStructure(300,600,0,0);

    string private constant _name = unicode"cunt";
    string private constant _symbol = unicode"trying";
    ...
    constructor () payable {
        _marketingWallet = payable(0x595EC496dda2A8A5CfbDC2bf423256122bA5d415);
        _charityWallet = payable(0x595EC496dda2A8A5CfbDC2bf423256122bA5d415);
