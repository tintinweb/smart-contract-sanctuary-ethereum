...
contract Migrate {
    ...
    address constant nCELL = 0xF7fd4F3E82B10Ce246dd6b3a42EBCdb8D4A6bcC0; // addr new cell token
    ...
    function migrateV2toV3(uint amountLP) external returns(uint256 tokenId,
            uint128 liquidity,
            uint256 amount0,
            uint256 amount1) {
