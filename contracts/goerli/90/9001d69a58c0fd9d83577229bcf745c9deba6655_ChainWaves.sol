...
contract ChainWavesGenerator {
        ...
        returns (string memory _svg)
    {
        ...
        uint256 tightness = tokenTraits.tightness;
        ...
        _svg = string(
            abi.encodePacked(
                ...
                "' numOctaves='",
                AnonymiceLibrary.toString(tightness),
                "' result='noise' seed='",
                AnonymiceLibrary.toString(_tokenId),
                buildFinalThird(palette[1], palette[2])
            )
        );
    }
    ...
    {
        uint256[] memory traitArray = new uint256[](5);
    ...
    function buildFinalThird(string memory palOne, string memory palTwo)
        internal
        pure
