...
contract MergeGators is
    ...
    function verify(address whitelisted, uint8 v, bytes32 r, bytes32 s) public virtual {
        address recoveredAddress = ecrecover(
            keccak256(abi.encodePacked("\x19\x01", DOMAIN_SEPARATOR(), keccak256(abi.encodePacked(whitelisted)))),
            v,
            r,
            s
        );
