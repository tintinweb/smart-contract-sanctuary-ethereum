...
contract AssetsRegistry is Ownable, IAssetRegistry {
    ...
    function uniqueWeightsForTypeIndexes(uint _assetId) public view override returns (uint256) {
        return assetsUniqueWeightsIndexes[_assetId];
    }
...
interface IAssetRegistry {
    ...
    function uniqueWeightsForTypeIndexes(uint _weight) external view returns (uint256);
