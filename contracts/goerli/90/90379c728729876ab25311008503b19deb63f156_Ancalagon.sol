...
// Facing final defeat, Morgoth unleashed his last and greatest weapon; a fleet of winged fire dragons, led 
// by Ancalagon The Black. So terrible was their onslaught that the armies of the Valar were driven back from 
// the gates of Angband, and their coming was said to have been accompanied by great thunder, lightning, and a tempest of fire.

// TG: t.me/ancalagon_the_black_portal
// Website: www.ancalagontheblack.com
...
contract Ancalagon is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ANCALAGON THE BLACK";
    string constant _symbol = "ANCALAGON";
    ...
    address payable public liquidityFeeReceiver = payable(0x23474f3E1Bb790aD6567B3D738290002b1F51680);
    address payable public marketingFeeReceiver = payable(0x23474f3E1Bb790aD6567B3D738290002b1F51680);
