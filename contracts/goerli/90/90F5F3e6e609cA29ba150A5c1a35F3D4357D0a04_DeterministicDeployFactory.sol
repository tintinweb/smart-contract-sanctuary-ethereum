...
import { BuilderV1 } from "./BuilderV1.sol";

contract DeterministicDeployFactory {
    function deploy(bytes32 _salt, address gmr) external returns (address) {
        return address(new BuilderV1{salt: _salt}(gmr));
    }
}
