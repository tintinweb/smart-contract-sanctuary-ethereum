...
contract CurrencyValueStore {
    ...
    event PriceUpdated(Currency currencyUpdated, uint40 price);
     ...
     */
    function set(Currency currency, uint40 newPrice) public isAboveThreshold(currency, newPrice) isUnrealisticHighPrice(newPrice) {
