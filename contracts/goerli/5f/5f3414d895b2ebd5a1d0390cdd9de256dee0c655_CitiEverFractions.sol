...
contract CitiEverFractions is BaseCitiNFT, IExplicitTokenIdNFT {    
    ...
    function initialize(NFTContractInitializer memory _initializer) 
        ...
        public 
    {
        __BaseCitiNFT_init("CitiEverFractions", "CEF", _initializer);
    }
...
contract Versioned {
    string public constant version = "0x64ef52516f82b2a2627b11c82fdae7fe75261f57";
}
