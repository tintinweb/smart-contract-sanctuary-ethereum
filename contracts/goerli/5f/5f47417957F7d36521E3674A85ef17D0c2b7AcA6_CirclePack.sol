...
contract CirclePack is ERC721 {
    ...
    function tokenURI(
        ...
        requests[4].scriptContent = scriptContent;

        uint256 finalBufferSize = bufferSize + scriptContent.length;
        ...
        bytes memory metadata = abi.encodePacked(
            '{"name":"Circles", "description":"Just a simple algorithm using p5js","image":"',
