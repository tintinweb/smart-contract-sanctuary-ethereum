...
contract TokenOfCoins is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Token Of Coins", "TOK") {
        ...
        marketingWallet = address(0xD2aF69f48840c85be2823df76E8D0eF17Cde244c);
        developmentWallet = address(0xD2aF69f48840c85be2823df76E8D0eF17Cde244c);
