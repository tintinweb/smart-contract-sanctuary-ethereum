...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x1264EB4ad33ceF667C0fe2A84150b6a98fF4caf7];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 690) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihbxgudm7jdvabsieloedswkwuekprosgmn3t6jtudlgldsd3etbi/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 690");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 690");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 690");
...
// File: contracts/NonFungibleTestTokenNfttContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NonFungibleTestTokenNfttContract is RamppERC721A {
    constructor() RamppERC721A("Non Fungible Test Token NFTT", "NFTT"){}
}
