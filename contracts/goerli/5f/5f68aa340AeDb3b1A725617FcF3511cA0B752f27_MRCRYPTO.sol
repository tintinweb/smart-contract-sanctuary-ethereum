...
contract MRCRYPTO is ERC721Enumerable, Ownable {
	...
	uint256 public cost = 14 ether; //hacer como si ether fuera matic
	...
	address liquidity = 0x7eC7aF8CFF090c533dc23132286f33dD31d13E29;
	...
	constructor (
		...
		giveAway(1, 0x844435cD4f8Efab891a7e10a1A03e6ee8C47A366); //CARLOS
		giveAway(1, 0x8407A400dAdFd053199b1e67Fe75ba1e9d76D3A1); //YONA
		giveAway(1, 0x0AeaC6D1424EA6d0F87123A50CA5eEc9f16108c5); //JOMMYS
		giveAway(1, 0xbCbb32C0caC8833061D6281e934B20bb93004255); //ALEXFU
		giveAway(1, 0xa3B17117F104e5965e98F07fe007784F6e3F3A2D); //JON
		giveAway(1, 0x4aBb876da9c5A48D64753Cd077B3f5b870856ed8); //VICTOR
		giveAway(1, 0xC608d2dD5AFA199a0c0E487Fdd669c1AD7459bE4); //TOYOS
		
		giveAway(3, 0x844435cD4f8Efab891a7e10a1A03e6ee8C47A366); //CARLOS
		giveAway(3, 0x8407A400dAdFd053199b1e67Fe75ba1e9d76D3A1); //YONA
		giveAway(3, 0x0AeaC6D1424EA6d0F87123A50CA5eEc9f16108c5); //JOMMYS
		giveAway(3, 0xbCbb32C0caC8833061D6281e934B20bb93004255); //ALEXFU
		giveAway(3, 0x4aBb876da9c5A48D64753Cd077B3f5b870856ed8); //VICTOR
		giveAway(3, 0xC608d2dD5AFA199a0c0E487Fdd669c1AD7459bE4); //TOYOS
		
		// añadir gente que tiene mr crypto anteriores.
		// En otra transaccion hacer giveaway a la cartera de carlos para hacer los sorteos.
		//añadir a alex y jaime de admins
	}
	...
	function reservedMint(uint256 _tokenId) public payable { //para canjear tokens antiguos por nuevos a precio reducido
		uint256 supply = totalSupply();
	...
	function setPriceIfInterval() internal {
		uint256 _currSupply = totalSupply();

		if(_currSupply > 25 && _currSupply <= 30 && cost == 14 ether)
			cost = 19 ether;

		else if (_currSupply > 30 && cost == 19 ether)
			cost = 25 ether;
	}
	...
	function setBaseURI(string memory _newBaseURI) public onlyOwner {
		//TODO: if supply == 10000 locktxn
		baseURI = _newBaseURI;
	}

	function setBaseExtension(string memory _newBaseExtension) public onlyOwner {
		require(lockURI == false && totalSupply() == totalMaxSupply);
	...
	function withdraw() public payable onlyOwner { //TODO: carteras de los fundadores del contrato
		uint256 each = (address(this).balance * 3)/100;
		uint256 help = (address(this).balance * 2)/100;
		
		// ======================================== =====================================
			(bool jom, ) = 0x0AeaC6D1424EA6d0F87123A50CA5eEc9f16108c5.call{value: each}("");
            require(jom, "transaction failed");
            (bool alx, ) = 0xbCbb32C0caC8833061D6281e934B20bb93004255.call{value: each}("");
            require(alx, "transaction failed");
			(bool yon, ) = 0x8407A400dAdFd053199b1e67Fe75ba1e9d76D3A1.call{value: each}("");
            require(yon, "transaction failed");
            (bool toyo, ) = 0xC608d2dD5AFA199a0c0E487Fdd669c1AD7459bE4.call{value: each}("");
            require(toyo, "transaction failed");
			 (bool jon, ) = 0xa3B17117F104e5965e98F07fe007784F6e3F3A2D.call{value: help}("");
            require(jon, "transaction failed");
			(bool carl, ) = liquidity.call{value: address(this).balance}(""); // RESTO DEL BALANCE
            require(carl, "transaction failed");
