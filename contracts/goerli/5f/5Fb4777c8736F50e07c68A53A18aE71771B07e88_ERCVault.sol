...
contract ERCVault is ReentrancyGuard {
    ...
    function lockLiquidity(address tokenAddress, uint tokenQuantity, uint unlockDate) external {
    ...
    function changeUnlockDate(uint id, uint newUnlockDate) external {
        ...
        require(vaults[id].walletAddress == msg.sender, 'You need to be owner of this vault');
