...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x178692Cf8CEC886374f65fb00494E803C4d86438];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x178692Cf8CEC886374f65fb00494E803C4d86438;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 543) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmddrtEFQD1RbbSQQKREHpDV6tfEmW4uSTHNJXExEh97ss/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 543");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 543");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 543");
...
// File: contracts/GenesisExplorersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GenesisExplorersContract is RamppERC721A {
    constructor() RamppERC721A("Genesis Explorers", "Explorers"){}
}
