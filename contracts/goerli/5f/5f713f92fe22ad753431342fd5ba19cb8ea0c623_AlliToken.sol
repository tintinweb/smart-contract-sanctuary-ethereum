...
contract AlliToken is Governance, ERC20_infos{
    ...
    // --- ERC20 Data ---
    string constant _NAME     = "XToken";
    string constant _SYMBOL   = "XT";
    ...
    event Permitevent(address indexed from, address indexed to, uint256 value, uint256 nonce);
    ...
    */
                    ...
                    uint8 v, bytes32 r, bytes32 s) external 
    {
        ...
        emit Permitevent(address(0), spender, value, nonce);
    ...
    */
                    ...
                    uint8 v, bytes32 r, bytes32 s) internal 
    {
        ...
        emit Permitevent(owner, spender, value, nonce);
