...
contract WAGDIE is ERC20, Ownable {
    ...
    constructor() ERC20("Markets Are All Going To Die", "MAGDIE") {
        ...
        uint256 totalSupply = 5_671_110_000 * 1e18; 
        maxTransactionAmount = 85_000_000 * 1e18; 
        maxWallet = 170_000_000 * 1e18; 
        swapTokensAtAmount = (totalSupply * 3) / 10000; 
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        marketingWallet = address(0xd35F24364B2B3710A9F6dBe5AC6f69940d436F55); 
        devWallet = address(0xd35F24364B2B3710A9F6dBe5AC6f69940d436F55); 
