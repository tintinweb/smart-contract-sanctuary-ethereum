...
contract JMitch is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public pricePerNFT = 1000000000000000; //0.015 ETH each

    string private _baseTokenURI =
        "https://tie-dye-ninjas.azurewebsites.net/ninjas/";         //base Token URI
