...
contract Indelible is ERC721AX, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"top", unicode"bottom", unicode"background"];
    ...
    ContractData public contractData = ContractData(unicode"Pixel Bros", unicode"cute pixel bros fully on chain", "https://files.indelible.xyz/profile/29280526-fa4c-4ed2-89b6-2abd34b1ea36", "https://files.indelible.xyz/banner/29280526-fa4c-4ed2-89b6-2abd34b1ea36", "", 0, "0x71ee17dDeA256081D6A58D4b05b4f313d3B8Dbb5");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Pixel Bros", unicode"PB") {
        tiers[0] = [27,12,8,3];
        tiers[1] = [23,19,7,1];
        tiers[2] = [17,15,10,8];
