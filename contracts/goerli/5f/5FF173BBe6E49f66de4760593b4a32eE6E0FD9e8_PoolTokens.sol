...
interface IRoyaltyContract {
    ...
    function poolTokens() external view returns(IPoolTokens);
    ...
    ERC1155SupplyUpgradeable
{
    ...
    event SetUri(string indexed _baseTokenUri);
    ...
    function initialize(string calldata uris) public initializer {
        __ERC1155_init(uris);
    ...
    function setURI(string memory _newUri) external onlyRole(MANAGER_ROLE) {
        _setURI(_newUri);
        emit SetUri(_newUri);
    }
