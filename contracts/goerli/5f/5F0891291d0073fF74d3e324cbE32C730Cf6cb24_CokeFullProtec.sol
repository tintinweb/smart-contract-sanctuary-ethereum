...
// File: contracts/CokeFullProtec.sol
...
contract CokeFullProtec is Ownable {
    ...
    constructor(ICokeToken _coke, uint256 _lockDuration, bool _depositsEnabled) {
        coke = _coke;
    ...
    function deposit(uint256 _amount) external {
        ...
        IERC20(address(coke)).safeTransferFrom(address(msg.sender), address(this), _amount);
        coke.burn(_amount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        user.amount -= _amount;
        totalStaked -= _amount;
        coke.mint(address(msg.sender), _amount);
