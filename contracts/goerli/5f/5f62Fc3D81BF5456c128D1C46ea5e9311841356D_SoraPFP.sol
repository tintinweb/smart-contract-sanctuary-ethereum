    ...
    ERC2981
{
    ...
    constructor() ERC721A("Sora PFP", "SORA"){
    ...
    function tokenURI(uint256 id) public view  override returns (string memory) {
        ...
        return string(abi.encodePacked(baseUrl, Strings.toString(id), ".json"));
    }
...
// public function
    ...
    function presaleMint(bytes32[] calldata _merkleProof, uint256 quantity) external payable {
        ...
        require(MerkleProof.verifyCalldata(_merkleProof, _merkleRoot, leaf), "not in whitelist!");
        require(walletMinted[msg.sender] + quantity <= phases[uint256(currentPhase)].maxPerWallet, "Exceeds max per wallet");
