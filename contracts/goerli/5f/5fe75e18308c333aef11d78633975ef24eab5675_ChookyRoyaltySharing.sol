...
contract ChookyRoyaltySharing is ReentrancyGuard, Ownable {
    ...
    function _claimRoyalty() external nonReentrant{
        ...
        require(block.timestamp >= holder.stakeTime + 60, "Can't claim before two weeks of staking!");
        require(block.timestamp >= holder.lastClaimTime + 60, "Can't claim before two weeks of last claim!");
