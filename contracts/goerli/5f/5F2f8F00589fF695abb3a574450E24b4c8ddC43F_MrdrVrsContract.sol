...
contract MrdrVrsContract is ERC721A, Ownable, PaymentSplitter, DefaultOperatorFilterer, ReentrancyGuard, Referable {
    ...
    function burn(uint256 _burnId, uint256 _guessId, uint256 _userId) public {
