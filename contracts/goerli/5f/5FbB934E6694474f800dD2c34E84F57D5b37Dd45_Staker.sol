...
contract Staker {
  ...
  modifier deadLinePassed(bool requiredDeadLinePassed){
    uint256 timeRemaining = timeLeft();
    if(requiredDeadLinePassed){
      require(timeRemaining <=0,"Deadline has not yet passed");
    }
    else {
    ...
    function execute() public notCompleted {
        ...
        if (address(this).balance >= threshold) {
            console.log("calling another contract");
