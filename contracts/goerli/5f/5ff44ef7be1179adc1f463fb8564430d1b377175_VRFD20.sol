...
contract VRFD20 is VRFConsumerBaseV2{
    ...
    function setVRFCoordinatorAddress(address _VRFCoordinatoraddress) external onlyOwner {
    ...
    function setS_keyHash(bytes32 _S_keyHash) external onlyOwner {
    ...
    function setCallbackGassLimit(uint32 _CallbackGassLimit) external onlyOwner {
        callbackGasLimit = _CallbackGassLimit; 
    }
