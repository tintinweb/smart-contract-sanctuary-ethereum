 ...
 */
contract ExchangeDeposit1 {
    using SafeERC20 for IERC20;
    using Address for address payable;
    /**
     * @notice Address to which any funds sent to this contract will be forwarded
     * @dev This is only set in ExchangeDeposit1 (this) contract's storage.
     * It should be cold.
     */
     ...
     * accessed directly from ExchangeDeposit1
     */
    ...
    /**
     * @dev The address of this ExchangeDeposit1 instance. This is used
     ...
     * ExchangeDeposit1 contract or one of the proxies.
     * @return bool of whether or not this is ExchangeDeposit1
     */
    ...
    /**
     * @dev Get an instance of ExchangeDeposit1 for the main contract
     * @return ExchangeDeposit1 instance (main contract of the system)
     */
    function getExchangeDepositor() internal view returns (ExchangeDeposit1) {
        // If this context is ExchangeDeposit1, use `this`, else use exDepositorAddr
        return isExchangeDepositor() ? this : ExchangeDeposit1(thisAddress);
    }
     ...
     * the ExchangeDeposit1 contract or a proxy contract.
    ...
    function getImplAddress() internal view returns (address payable) {
        return
            isExchangeDepositor()
                ? implementation
                : ExchangeDeposit1(thisAddress).implementation();
    }
    ...
    function getSendAddress() internal view returns (address payable) {
        ExchangeDeposit1 exDepositor = getExchangeDepositor();
        // Use exDepositor to perform logic for finding send address
        address payable coldAddr = exDepositor.coldAddress();
        // If ExchangeDeposit1 is killed, use adminAddress, else use coldAddress
    ...
    receive() external payable {
        ...
        // that this can only be called from the ExchangeDeposit1 context
