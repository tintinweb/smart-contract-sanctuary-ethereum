...
// address public _ofriendContractAddress = 0x3bd77b6047929098d147d671d44c772e77479527;    
// contract interface
...
contract OLandRocketLaboratory is ReentrancyGuard, ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    function getMissionSuccess(uint256 missionIdEnd_) public view returns (bool) {
        uint256 tokenIdCurrent = _tokenIdCounter.current();
        if (tokenIdCurrent < missionIdEnd_) return false;
        return true;
    }
    ...
    function getPublicEnvelope() public payable nonReentrant() {
        ...
        if (tokenId + 1 > _maxPublicSupply) revert();
