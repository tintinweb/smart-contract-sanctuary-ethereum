...
contract Test_ERC721 is DoodleProxyStorage, Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = Test_ERC721.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(Test_ERC721.ownerOf(tokenId) == from, 'ERC721: transfer of token that is not own');
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Test_ERC721.ownerOf(tokenId), to, tokenId);
    }
