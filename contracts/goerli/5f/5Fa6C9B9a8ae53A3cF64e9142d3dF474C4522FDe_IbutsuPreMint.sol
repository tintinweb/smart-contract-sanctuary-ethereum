...
contract IbutsuPreMint is Ownable, ReentrancyGuard {
    ...
    constructor(uint256 _cost, uint256 _maxSupply, uint256 _maxPreMintAmountPerTx) {
        setCost(_cost);
    ...
    function mint(uint256 _mintAmount) public payable onlyOwner amountCompliance(_mintAmount) {
        require(!paused, "The contract is paused");
        safeMint(_mintAmount);
    }
    ...
    function safeMint(uint256 _mintAmount) private {
    ...
    function withdraw() public onlyOwner nonReentrant {
        // (bool ok1, ) = payable(0xA03e2a663F9c04E76e6BC4a51d06972597DA8f91).call{value: address(this).balance * 90 / 100}('');
        // require(ok1);
