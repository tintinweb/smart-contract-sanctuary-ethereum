...
//Questions asked by chatbot and answers of candidate
  ...
  //  mapping(address => bytes32) public candCv;  //To store Cv of Candidate
    ...
    function signUpCandidate(string memory _name, uint256 _phoneNumber, string memory _email, bool _isCand) external returns(bool){
    ...
    function verifyLogin(address _logger) public view returns(string memory, string memory,uint,bool){
