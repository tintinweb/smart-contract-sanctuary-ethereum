...
contract Hestia {
    ...
    */
    ...
    event Created(address poster, string taskId, uint num, uint8 typeId, uint32 cityId, uint amount, string hashIpfsDetails);
    event CreatedAndSelect(address poster, string taskId, uint num, uint8 typeId, uint32 cityId, uint amount, string hashIpfsDetails, address tasker);
    ...
    function createTask(string memory taskId, uint8 typeId, uint32 cityId, uint amount, uint16 limitDays, string memory description, string memory hashIpfsDetails) public {
        ...
        emit Created(msg.sender, taskId, tasks[taskId].num, typeId, cityId, amount, hashIpfsDetails);   
    }
    ...
    function createTaskAndSelectTasker(string memory taskId, uint8 typeId, uint32 cityId, uint amount, uint16 limitDays, string memory description, string memory hashIpfsDetails, address tasker) external {
        ...
        _createTask(taskId, typeId, cityId, amount, limitDays, description, hashIpfsDetails);
        emit CreatedAndSelect(msg.sender, taskId, tasks[taskId].num, typeId, cityId, amount, hashIpfsDetails, tasker); 
    }
