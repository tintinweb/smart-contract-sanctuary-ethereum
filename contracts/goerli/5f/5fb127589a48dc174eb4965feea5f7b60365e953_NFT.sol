...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("The Blue Pill", "BluePill") {
        baseUri = "ipfs://QmWCoh78TSctRaHAoHxFyefTDz8boYtjABnedZmSCXzSW3/";
    }
    ...
    function mintTeam(uint256 _numTokens, address _teamAddress) external onlyOwner{
        uint256 curTotalSupply = totalSupply;
        require(curTotalSupply + _numTokens <= MAX_TOKENS, "Exceeds total supply.");

        for(uint256 i = 1; i <= _numTokens; ++i) {
            _safeMint(_teamAddress, curTotalSupply + i);
        }
        totalSupply += _numTokens;
    }
