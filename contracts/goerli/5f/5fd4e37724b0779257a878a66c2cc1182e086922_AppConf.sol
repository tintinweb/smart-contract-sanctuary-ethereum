...
contract AppConf is IAppConf, Ownable {
    ...
    uint256 incenseMinAmount = 0;
    uint256 incenseMaxAmount = 0;
    ...
    function setIncenseAddr(address _incenseAddr) public onlyOwner {
    ...
    function setRedeemToken(address redeemToken, uint8 status) public onlyOwner {
        redeemTokenMap[redeemToken] = status;
    }

    function validRedeemToken(address redeemToken) public view override returns(bool) {
