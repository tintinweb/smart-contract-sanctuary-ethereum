...
contract BottzArmy is ERC721A, Ownable, AccessControl, ReentrancyGuard {
  ...
  uint256 private constant maxSupply = 15;
  uint256 public maxSupplyCaptains = 6;
  uint256 public maxSupplyMajors = 3;
  uint256 public maxSupplyGenerals = 3;
  uint256 public maxSupplyTotal = 15;
  ...
  uint256 public majorsPrice = 0.10 ether;
  uint256 public generalsPrice = 0.20 ether;
  ...
  bool public captainsStarted = false;
  bool public majorsStarted = false;
  bool public generalsStarted = false;
