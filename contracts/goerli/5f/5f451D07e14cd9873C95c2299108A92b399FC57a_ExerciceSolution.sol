...
{
   address private constant dai = 0xBa8DCeD3512925e52FE67b1b5329187589072A55;
   address private constant usdc = 0x65aFADD39029741B3b8f0756952C74678c9cEC93;
   address private constant poolAddressProvider = 0xC911B590248d127aD18546B186cC6B324e99F02c;
   ...
   function depositSomeTokens() override external{
      ...
      IERC20(dai).transferFrom(msg.sender, address(this), 1*10**10);
      IERC20(dai).approve(address(pool), 2**256 - 1);

      pool.deposit(dai, 1*10**10, 0x0Bf0Dc06F8F1b6AD19F63CE88066F693FaF18e2B, 0);

      IERC20(dai).allowance(address(this), address(pool));
   }
