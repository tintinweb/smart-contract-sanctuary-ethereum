...
contract DynamicSvgNft is ERC721, Ownable{
    ...
    event CreatedNFT(uint256 indexed tokenId, int256 hightValue);
    ...
    function mintNft(int256 hightValue) public {
        s_tokeIdToHighValues[s_tokenCounter] = hightValue;
        emit CreatedNFT(s_tokenCounter, hightValue);
    ...
    function svgToImageURI(string memory svg) public pure returns(string memory) {
        string memory baseURL = "base:image/svg+xml;base64,";
    ...
    function tokenURI(uint256 tokenID) public view virtual override returns (string memory) {
        require(_exists(tokenID), "ERC721Metadata: URI query for nonexiststent token");
        ...
        return string(abi.encodePacked(_baseURI(),Base64.encode(bytes(abi.encodePacked(
            ...
            '"attribute": [{"trait_type": "coolness", "value": 100}], "image":"', imageURI,'"}'
