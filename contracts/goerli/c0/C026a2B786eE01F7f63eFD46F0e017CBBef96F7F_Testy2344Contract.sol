...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x98ff1C68DbE759F3fc772563bF786DcF80dbcd16];
  address public erc20Payable = 0x98ff1C68DbE759F3fc772563bF786DcF80dbcd16;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeic2aymrgod24wxtaxc2ydj4b4ravfoqipjac74aetr5k2ja64p42m/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XVTjYoLlQNHNQG20OPLd/contract-metadata";
  }
...
// File: contracts/Testy2344Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Testy2344Contract is RamppERC721A {
    constructor() RamppERC721A("testy2344", "testy234"){}
}
