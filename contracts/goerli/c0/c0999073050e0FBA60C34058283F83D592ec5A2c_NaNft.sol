...
contract NaNft is ERC1155, Ownable, ERC1155Supply {
    struct TokenInfo {
        bool exists;
    ...
    function add(uint256 tokenId, uint256 maxAmountAllowed, string memory metadataUrl) public onlyOwner {
        ...
        console.log("add Token. sender=%s, tokenId=%s, maxAmountAllowed=%s", msg.sender, tokenId, maxAmountAllowed);
        tokenInfos[tokenId] = TokenInfo(true, maxAmountAllowed, metadataUrl);
    }
    ...
    function mint(uint256 tokenId, uint256 amount) public onlyOwner {
        ...
        require((minted + amount) <= tokenInfo.maxAmountAllowed, "Too many tokens");
