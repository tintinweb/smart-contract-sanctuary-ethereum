...
contract LaunchNFTv2 is ERC721A, VRFV2WrapperConsumerBase, ConfirmedOwner {
    // For Chainlink VRF
    ...
    function fulfillRandomWords(
        ...
        setRandomSeed(_randomWords[0] % listOfParticipants.length);
    }
    ...
    function setRandomSeed(uint num) internal onlyOperator {
        seed = num;
    }
