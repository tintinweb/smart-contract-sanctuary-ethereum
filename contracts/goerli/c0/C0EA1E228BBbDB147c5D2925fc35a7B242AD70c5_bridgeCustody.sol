...
contract bridgeCustody is IERC1155Receiver, ReentrancyGuard, Ownable {
    ...
    event NFTCustody(uint256 indexed tokenId, uint256 amount, address holder);

    ERC1155 public nft;

    constructor(ERC1155 _nft) {
        nft = _nft;
    }
    ...
    function retainNFT(
        ...
        holdCustody[tokenId] = Custody(tokenId, amount, msg.sender);
        emit NFTCustody(tokenId, amount, msg.sender);
    }
    ...
    function updateHolder(
        ...
        holdCustody[tokenId] = Custody(tokenId, newAmount, newHolder);
        emit NFTCustody(tokenId, newAmount, newHolder);
    }
    ...
    function onERC1155BatchReceived(
        ...
        require(operator == address(0x0), "Cannot Receive Tokens Directly");
