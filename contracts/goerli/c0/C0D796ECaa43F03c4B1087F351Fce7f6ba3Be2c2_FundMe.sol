...
contract FundMe {// Type Declarations
    ...
    modifier onlyOwner {
        ...
        if (msg.sender != i_owner) {revert FundMe__NotOwner({errorCode : "Only Owner Can Perform This"});
        }
        _;
    }
    ...
    constructor(address priceFeedAddress){i_owner = msg.sender;
...
*/
    ...
    function withdraw() public onlyOwner {
        ...
        for (uint funderIndex = 0; funderIndex < s_funders.length; funderIndex++) {address funder = s_funders[funderIndex];
    ...
    function cheaperWithdraw() public onlyOwner {
        ...
        for (uint256 funderIndex = 0; funderIndex < funders.length; funderIndex++) {address funder = funders[funderIndex];
            s_addressToAmountFunded[funder] = 0;}
        s_funders = new address[](0);
    ...
    function getFunder(uint256 index) public view returns (address){return s_funders[index];
    }

    function getAddressToAmountFunded(address funder) public view returns (uint256){return s_addressToAmountFunded[funder];
    }
}
