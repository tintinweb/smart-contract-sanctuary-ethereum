 ...
 * @notice This contract handles minting Big Pumper Test tokens.
 */
contract BigPumperTest is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x644F09201916bd743191A17bA00a0c966357aF41;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x92b224ec3f99753f5b3f5E2Cc12C09a306D99FFa;
    address[] public payoutAddresses = [
        0x92b224ec3f99753f5b3f5E2Cc12C09a306D99FFa
    ];
    ...
    string public name = "Big Pumper Test";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeicds4yqdm6erlj2lvwxkgmnqqm5g5osy5zc66tao7nj7ipmmsspki/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 200;
        tokenPublicPrice[1] = 0 ether;
        tokenPublicMintsPerAddress[1] = 200;
        require(
