...
//Sr Banano & Rotten Banano contract
...
contract MutantsGodHatesNFTees is ERC721Enumerable, PaymentSplitter, Ownable {
    // IDs 1 - 200: M1
    // IDs 201 - 4696: M2
    ...
    //2nd wallet: ok--> mat 15 % 0x80d18688e13C9a9C65EcF82a0544755F7187fC6e
    //3rd wallet: ok --> chilli 15% 0xfBc5C7DC2aEBa334e67a6326A7cAF0F6DaEa1de2
     //4th wallet: ok --> veazy 10% 0x24A77F76fe0CF427f26A9E49F33f7E9287217250
    ...
    address[] _payees = [
        ...
        0x24A77F76fe0CF427f26A9E49F33f7E9287217250,
        0xE8188362F8DceAf08557b8FaEebB33AFaeF4Ac7D,
        0x9eB6c57183132E351f06141d2f6E73841c005d08,
        0xa42976d0220b6c9655013ce5E3464f1d7B53d76C
    ];

    uint256[] _shares = [40, 15, 15, 10, 10, 5, 5];
    ...
    function Mutate(
        ...
        require(
            ...
            "Must own at least 1 Ape to mutate, or exceed amount selected."
        );
        if (MutationType == 1) {
            require(
                bnno.balanceOf(msg.sender, 0) > 0 &&
                    bnno.balanceOf(msg.sender, 0) >= Amount,
                "Must own at least 1 Sr Banano to mutate, or max bananas."
            );
            ...
            require(
                ...
                "Must own at least 1 Rotten Banano to mutate, or max bananas."
            );
    ...
    function initialMintWithM1() external onlyOwner {
        M1_minted++;
        uint256 M1_index = M1_minted;
        M1_index += M1_minted;
        _safeMint(msg.sender, M1_index);
