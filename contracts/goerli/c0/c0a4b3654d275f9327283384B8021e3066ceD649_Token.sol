...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = (_tTotal.mul(15)).div(1000); //1.5% of the supply
    ...
    constructor() {
        ...
        marketingWallet = address(0x5CaD11bFf9a5E5471D19C5aB3C9cAeaf78D6fE99); // set your marketing wallet here
   ...
   function includeInReward (address account) external onlyOwner { 
    ...
    function updateMaxWalletAmount (uint256 amount) external onlyOwner {
        require (amount > totalSupply()/100, "amount must be greator than 1% of the supply");
