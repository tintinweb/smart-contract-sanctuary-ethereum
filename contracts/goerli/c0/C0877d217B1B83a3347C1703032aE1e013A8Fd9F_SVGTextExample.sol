...
contract SVGTextExample is ShellBaseEngine, SVGTextEngine {
        ...
        returns (string[] memory)
    {
        ...
        lines[2] = string(abi.encodePacked("Member: ", name_));
        lines[4] = "powered by heyshell.xyz from Playgrounds";
...
abstract contract SVGTextEngine is SVGImageEngine {
        ...
        returns (string memory)
    {
        ...
        svg = string.concat(svg, '<text x="10" y="20" class="base">hey</text>');
    ...
    function _computeTextConfig(IShellFramework collection, uint256 tokenId)
        internal
        view
        virtual
