...
contract GUM is Context, IERC20, Ownable {
    ...
    string public constant _name ="Gummy Warriors";
    string public constant _symbol = "GUM";
    uint8 private constant _decimals = 18;

    uint256 public _tTotal = 1000_000_000 * 10**_decimals;
    ...
    uint256 public _walletMax = _tTotal.mul(20).div(1000);  //2%
    ...
    address public MarketingWallet = address(0x31CFE10fF17d469432De575d0821b931c24C8448);
    address public DeveloperWallet = address(0x7814756F93e63a0c410837C368fB19f0e67A349f);
