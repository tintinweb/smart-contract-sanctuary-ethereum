...
import { StableCoinInterface } from "../../src/stable/StableCoinInterface.sol";
import "forge-std/Test.sol";

contract TestUSDC is StableCoinInterface {
    ...
    function transferFrom(
        ...
        address to,
        uint256 value
    ) external notBlacklisted(to) returns (bool) {
        require(
    ...
    function transfer(
        address to,
        uint256 value
    ) external override notBlacklisted(to) returns (bool) {
