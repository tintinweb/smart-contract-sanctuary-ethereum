...
contract NFT is ERC721A, ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
   ...
   function setMaxPerWallet(uint256 _maxPerWallet) external onlyOwner {
    ...
    function mint(uint256 quantity_) external payable nonReentrant {
       ...
       uint256 ts = totalSupply();
        ...
        require(walletMints[msg.sender].add(quantity_) <= maxPerWallet, 'Maximum per wallet exceeded.');
