...
contract release_v5 is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Releasev5", "RV5") Ownable() {}
    ...
    function makeAttributes(uint256 tokenId) private view returns (string memory) {
        ...
        // traits[2] = string(abi.encodePacked(' ', getAttributes(tokenId), ' '));
        traits[2] = string(abi.encodePacked(getAttributes(tokenId)));
    ...
    function getPlain(uint256 tokenId) public view returns (string memory) {
        ...
        string memory punkSvg = cryptopunksData.punkImageSvg(uint16(tokenId)); // Running
    ...
    function getAttributes(uint256 tokenId) public view returns (string memory) {
        ...
        string memory attributes = cryptopunksData.punkAttributes(uint16(tokenId));
