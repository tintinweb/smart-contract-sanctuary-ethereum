...
// Pour logger dans le code du contrat
// console.log("Unlock time is %o and block timestamp is %o", unlockTime, block.timestamp);

contract ArtpointV1 is
    Initializable,
    ERC721Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("Artpoint.xyz", "ART");
    ...
    {
        require(
            !blockedMarketplaces[operator],
            "Invalid marketplace, not allowed"
        );
        super.setApprovalForAll(operator, approved);
    }

    function setBlockedMarketplace(address marketplace, bool blocked)
        public
    ...
    function redeem(
        ...
        require(
            _verify(_hash(account, tokenId, uri, msg.value), signature),
            "Invalid signature"
        );
    ...
    function _hash(
        ...
        return
            ECDSAUpgradeable.toEthSignedMessageHash(
                keccak256(abi.encodePacked(tokenId, uri, account, value))
            );
    }
