...
interface INamiNFT {
    ...
    function mint(uint tokenId, address to, uint quantity, bytes memory data) external;
...
contract NamiLandGameNFTStore is Ownable, ERC1155Holder {
    ...
    constructor(INamiNFT _namiNFT, address _operator) {
    ...
    function depositBatchNFTs(uint256[] calldata nftIds, uint256[] calldata amounts) external {
        namiGameNFT.burnBatch(msg.sender, nftIds, amounts);
