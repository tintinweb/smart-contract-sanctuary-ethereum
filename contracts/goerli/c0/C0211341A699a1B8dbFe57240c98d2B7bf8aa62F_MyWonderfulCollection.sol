 ...
 * @notice This contract handles minting My Wonderful Collection tokens.
 */
contract MyWonderfulCollection is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xc4514ADbFa3263b668c44331F5dfd6C0D6069E7e;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xEbD2E171385cf39fCDB145b344D9c7F5f6eae189;
    address[] public payoutAddresses = [
        0xEbD2E171385cf39fCDB145b344D9c7F5f6eae189
    ];
    ...
    string public name = "My Wonderful Collection";
    string public symbol = "MWC";
    ...
    uint96 public royaltyFee = 350;

    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeihzc2dfdnuouhpm2dwqnkxuwmtp3ylrlkbbus33f2gh4hojs57zvm/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 777;
        tokenPublicPrice[1] = 0.025 ether;
        tokenPublicMintsPerAddress[1] = 3;
        tokenPresaleMaxSupply[1] = 500;
        tokenPresalePrice[1] = 0.01 ether;
        tokenPresaleMintsPerAddress[1] = 0;
        tokenMaxSupply[2] = 1000;
        tokenPublicPrice[2] = 0 ether;
        tokenPublicMintsPerAddress[2] = 1000;
        require(
