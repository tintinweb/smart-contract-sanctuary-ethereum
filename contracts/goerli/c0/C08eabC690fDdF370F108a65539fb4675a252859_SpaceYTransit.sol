...
abstract contract CostToken is IERC20 {
    function burnFrom(address account, uint256 amount) public virtual;

}

contract SpaceYTransit is ReentrancyGuard,AccessControl {
    IERC721 public immutable nftCollection;
    CostToken public immutable costToken;

    uint256 public dismantleCost;
    ...
    constructor(IERC721 _nftCollection, CostToken _costToken) {
    ...
    function setDismantleCost(uint256 _cost) external {
    ...
    function dismantle(uint256 _tokenId) external nonReentrant {
        ...
        costToken.burnFrom(msg.sender, dismantleCost);
