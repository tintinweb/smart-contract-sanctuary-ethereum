...
contract Sorce is ERC721A, Ownable, ReentrancyGuard {
    ...
    string _baseTokenURI =
        "ipfs://QmeNKZ5sEhWXsgauRMkjo9ER4t7B5W7U4jdFfKEAoQaLL8";
    ...
    bytes32 public merkleRoot =
        0x443fe2a89c1738953911c5e699a2ae87fef212cd7ee77df8185854d141ec8812;
    ...
    function allowlistMint(
        ...
        require(
            mintList[sender] + quantity <= allocation,
            "KD: not allowed to mint that much"
        );
    ...
    function batchMigration(uint256[] memory tokenIds) public payable {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            MintableInterface dr1verContract = MintableInterface(
                dr1verContractAddress
            );
            dr1verContract.mintTransfer{value: (msg.value / tokenIds.length)}(
                _msgSenderERC721A()
            ); // Mint the Dr1ver
        }
    }
