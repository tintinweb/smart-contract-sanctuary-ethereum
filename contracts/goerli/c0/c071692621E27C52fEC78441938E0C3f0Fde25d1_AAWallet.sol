...
contract AAWallet {
    ...
    function executionFromEntryPoint(bytes memory callData) external onlyEntryPoint returns(address destination, uint amount, bool success) {
        // unpacking callData.
    ...
    function _call(address payee, uint value) private returns(bool success) {
        // sending empty data for simplicity.
        // value is almost certainly in WEI.
        (success, ) = payee.call{value : value}("");
