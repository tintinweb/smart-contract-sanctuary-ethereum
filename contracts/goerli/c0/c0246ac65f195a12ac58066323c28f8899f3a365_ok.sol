...
// This is just a test NFT collections that helps decentralized Finance, NFT Finance, Social Finance and others kind Dapps building on testnet.
contract ok is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private supply;

    string public uriPrefix = "ipfs://QmYDkVGzJNkP5NexACNA4HWdCZ8Zebbx9AvHoPx6tmsabt/";
    string public uriSuffix = "";

    uint256 public mintCost = 0.0025 ether;
    uint256 public maxSupply = 1500;
    uint256 public maxMintAmountPerTx = 10;
    uint256 mintLimit = 100;
    mapping(address => uint256) public mintCount;

    constructor() ERC721("Cguis", "CGUIS") {}
