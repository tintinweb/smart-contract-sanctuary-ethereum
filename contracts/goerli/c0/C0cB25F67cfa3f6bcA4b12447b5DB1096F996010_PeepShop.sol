...
contract PeepShop is ERC721AUpgradeable, ERC721ABurnableUpgradeable, OwnableUpgradeable{
    ...
    mapping(address => mapping(MintPhase => uint256)) userMintCount;
    ...
    modifier saleCondition(bytes32[] memory _merkleProof, uint256 _qty){
        ...
        saleData[currPhase].mintedSupply++;
        userMintCount[msg.sender][currPhase]++;
        _;
    }
    ...
    function initialize() initializerERC721A initializer external{
        ...
        treasuryAddress = 0x03C34357fc6d2786AA8B6607dc2779736c46dBc8;
        ...
        saleData[MintPhase.PEEPLIST].supply = 1583;
