...
contract MyToken is ERC721, Ownable {
    ...
    uint price;
    constructor(uint _priceInWeiUSDC) ERC721("MyToken", "MTK") {
        //USDC is only 6 decimals !
        price = _priceInWeiUSDC;
    }
    //set price et check price
    function safeMint(address to, uint _amount) public {
        require(usdc.allowance(msg.sender, address(this)) >= _amount, "Please make sure you have approve enought USDC !");
        require(_amount >= price, "Make sure you send the right amount !");
