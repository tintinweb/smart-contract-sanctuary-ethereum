...
//import "contracts/lib/Interfaces.sol";
    ...
    */
    ...
    function swap(address router, address[] memory path, uint256 _amount) external axx {
        ...
        */
        ...
        IV2SwapRouter(router).swapExactTokensForTokens(_amount, 1, path, address(this), block.timestamp + 300);
    }
    ...
    function resetFailedAdminUpdate() public payable reqFee noReentrency {
        /*
        ...
        */
        require(block.timestamp > initUpdateTimestamp + 86400 && initUpdateTimestamp != 0, "Transfer already pending or no need to call reset");
        temporaryNewAdmin = address(0);
        initUpdateTimestamp = 0;
        emit RecoveryReset(msg.sender, tx.origin);
    }

    function initUpdateAdmin(string memory otpPasswd1, bytes32 newOpt1) public payable reqFee noReentrency {
        /*
    ...
    function commitUpdateAdmin(string memory otpPasswd2, bytes32 newOpt2) public payable reqFee noReentrency{
        /*
        ...
        */
        ...
        require(temporaryNewAdmin == msg.sender, "Not the original caller");
        require(newOpt2 != 0);
