...
contract Tempura is Ownable, GIGADRIP20, ReentrancyGuard {
    ...
    IERC721 public YakuzaGen = IERC721(0xf52ae754AE9aaAC2f3A6C8730871d980389a424d);

    constructor() GIGADRIP20('Tempura', 'TEMP', 18, 167000000000000) {
    ...
    function claimReward(uint256 _tokenId) external nonReentrant {
        require(
            YakuzaGen.ownerOf(_tokenId) == msg.sender,
