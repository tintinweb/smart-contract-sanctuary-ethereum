...
import "AggregatorV3Interface.sol"; // VERSÃƒO 0.6!!!
...
/* ## Como deployar contratos com DependÃªncias Externas
# Arquivo YAML:
dotenv = .env       // Para que o servidor ache a goerli no deploymeny
wallets:
    from_key: ${PRIVATE_KEY}
dependencies:
    - smartcontractkit/[email protected]  // - organization/[email protected]
compiler:
    solc:
        remappings:
            - "@chainlink=smartcontractkit/[email protected]"

/* ## Deployment em testnet Goerli
o mesmo de antes.

Lembre de criar a funÃ§Ã£o get_account() com os impports especÃ­ficos

*/

/** ## VerificaÃ§Ã£o e Flattering
