...
// File: contracts/RichAnimalsClub.sol
...
contract RichAnimalsClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Rich Animals Club", "RAC") {
    setHiddenMetadataUri("ipfs://QmTSXQjzcx1YDytYZD3kQJsFBt3QQLS7jncLGYos9bTehV/hidden.json");
  }
