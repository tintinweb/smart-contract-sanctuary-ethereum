...
contract NFTCONTRACT is ERC721Enumerable, Ownable { //Change name here if you need from NFTCONTRACT
    using Strings for uint256;
    ...
    uint256 public cost = 0.0001 ether;  // ether always = base currency of the chain you deploy too

    // Supply
    uint256 public mintReward = 5;  // reward token amount (5/100 = 20% of mint fee will go to rewards edit this to suit)
    uint256 private creatorReward = 20; // 20/100 = 5% etc below
    uint256 private devReward = 10;
    uint256 public maxSupply = 40; //max supply of NFTS
    ...
    // Addresses
    address public DexRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //change router based on chain this is set for BSC
    address public RewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //reward token
    address private TeamReceiver = 0xa1eF812225FC6448E95e733d7f1717023DF4F1e1; // Team address
    address private CreatorReceiver = 0xa1eF812225FC6448E95e733d7f1717023DF4F1e1; // Team address
    address private DevReceiver = msg.sender; // msg.sender = deployer update to a wallet address like above if needed to split
    ...
    function setCost(uint256 _newCost) public onlyOwner {  // make sure you include 18 decimals when updating after deployment
        cost = _newCost;
    }
