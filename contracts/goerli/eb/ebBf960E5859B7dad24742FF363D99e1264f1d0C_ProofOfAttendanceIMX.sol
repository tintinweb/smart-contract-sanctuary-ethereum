...
contract ProofOfAttendanceIMX is ERC721, Pausable, Ownable, ERC721Burnable, Mintable {
  ...
  /**
     ...
     */
  constructor(address _owner, address _imx) ERC721("Fr0ntierX Proof Of Attendance", "FXPOA") Mintable(_owner, _imx) {}
  ...
  function _mintFor(address to, uint256 id, bytes memory) internal override {
    require(balanceOf(to) == 0, "ProofOfAttendance: the wallet already contains a Proof of Attendance token");
  ...
  function _beforeTokenTransfer(
    ...
    require(from == address(0) || to == address(0), "ProofOfAttendance: non transferrable");
