...
contract OpenchainContract {
    ...
    function swapToETH(
        ...
        // approve
        require(sellTokenContract.approve(address(UNISWAP_ROUTER_ADDRESS), amountIn), 'approve failed.');

        address[] memory path = new address[](2);
        path[0] = address(_tokenIn);
        path[1] = uniswapRouter.WETH();
        uniswapRouter.swapExactTokensForETH(amountIn, _amountOutMin, path, msg.sender, _deadline);
    }
}
