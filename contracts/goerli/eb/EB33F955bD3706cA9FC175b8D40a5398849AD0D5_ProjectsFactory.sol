...
contract ProjectsFactory {
    // some how save the addresses of the deployed projects
...
contract ProjectFunding is Ownable {
    ...
    constructor(string memory _projectName, uint256 _budget, address _owner, address tokenAddress) {
        ...
        // 0x6B0809b99a8035C483c55ccFfCe781FC12ff1bBF for goerli
    ...
    function testTransfer() public view returns(uint256) {
