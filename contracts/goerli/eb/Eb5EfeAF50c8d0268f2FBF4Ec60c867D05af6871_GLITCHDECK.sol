...
contract GLITCHDECK is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
   ...
   // FREE CLAIM FUNCTIONALITY:
    ...
    function claimFreeNFTs() external payable noReentrant {
        ...
        uint numMapped = 0;
        uint claimLimit = 50;  // limit # free mints to 50/tx, just for good measure.
        ...
        if ( availableClaims > 0 ) {
            ...
            // Likely not needed, but just a sanity check...
            require(totalSupply() + availableClaims <= maxSupply, "Error: This would exceed the max supply.");
