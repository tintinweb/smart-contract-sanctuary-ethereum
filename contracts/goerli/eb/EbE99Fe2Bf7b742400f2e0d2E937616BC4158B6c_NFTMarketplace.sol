...
contract NFTMarketplace is ERC721URIStorage {
    ...
    function updateListPrice(uint256 _listPrice) public payable {
        require(owner == msg.sender, "You aren't authorized to call this function");
    ...
    function executeSale(uint256 tokenId) public payable {
        ...
        ListedToken memory currentNFT= idToListedToken[tokenId];

        uint256 price = currentNFT.price;
        require(msg.value == price, "Please pay the asking price of the NFT!");
