...
contract MyCoolHEROES1st is ERC721A, Ownable, AccessControl, ReentrancyGuard {
    constructor() ERC721A("My Cool HEROES 1st", "MCH1") {
...
//param block
    address public constant withdrawAddress = 0x4DB2bE4C40E5f13320601e9ddEe365ae3704b0da;
    string public baseURI = "https://www.omorooinen.com/mch/";
    string public baseExtension = ".json";
    uint256 public cost = 0.001 ether;
    uint256 public maxSupply = 30;
    uint256 public maxMintAmountPerTx = 15;
    uint256 public publicSaleMaxMintAmountPerAddress = 60;
...
//only berner role block
    function burnOwnToken(uint256[] memory _burnTokenIds) external {
