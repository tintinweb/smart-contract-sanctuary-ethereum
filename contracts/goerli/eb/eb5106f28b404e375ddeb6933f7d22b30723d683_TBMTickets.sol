...
contract TBMTickets is ERC721, ERC721Enumerable, Ownable, Pausable {

    using Strings for uint256;
    using SafeMath for uint256;

    string public baseURI = "https://peach-impossible-hyena-474.mypinata.cloud/ipfs/QmZzeTnQi5SeKu1Zfg8XL9WNxN94mKnVECYRNWRu6978vU";
    uint256 public cost = 0.1 ether;
    uint256 public devContribution = 0.01 ether;
    ...
    function mint(uint256 _mintAmount) public payable whenNotPaused {
        ...
        if (msg.sender != owner()) {
            ...
            require(ownerMintCount.add(_mintAmount)  <= nftPerAddressLimit, "max NFT per address exceeded");
            require(msg.value >= cost.add(devContribution).mul(_mintAmount), "insufficient funds");
        }
        ...
        uint256 ownerPayable = cost.mul(_mintAmount);
        uint256 devPayable = devContribution.mul(_mintAmount);    
