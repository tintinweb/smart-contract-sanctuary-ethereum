...
contract Crowdfund is ERC20SnapshotUpgradeable, ICrowdfundEvents {
     ...
     */
    // TODO: need a setter/initializing for this that only avatar can set
...
contract Sealib is Ownable {
    ...
    uint256 public OPEN_SEA_FEE = 2.5e18;
...
contract ListModule is Module, IListEvents, IListActions, IERC721Receiver {
    ...
    function setUp(
        ...
        __Ownable_init();
        (address _avatar, address _target, address _sealib) = abi.decode(
            initializeParams,
            (address, address, address)
        );
    ...
    function list(
        ...
        Order memory seaportOrder = Sealib(sealib).buildOrderFor(
            address(this),
    ...
    CaptainGuard
{
    ...
    // TODO: need a setter for this that only avatar can set
    ...
    constructor(
        ...
        ListModule(_seaport, _conduit, _royaltyEngine, _sealib)
    {
        if (_sznsDAO == address(0)) revert ZeroAddressShipModule();
        SZNSDAO = _sznsDAO;
        bytes memory initParams = abi.encode(_avatar, _target, _sv, _sealib);
    ...
    function setUp(
        ...
        (
            ...
            address _sealib
                ...
                initializeParams,
                (address, address, ShipSetupArgs, address)
            );
