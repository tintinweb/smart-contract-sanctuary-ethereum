...
import "./SHR_NFT_1155_custom_init_v1.1.sol";

contract SHRFactoryERC1155CloneV1_1 is
    Initializable,
    OwnableUpgradeable,
    UUPSUpgradeable
{
    SHRNFT_1155_Collection_v1_CustomInitV1_1[] public collections; //an array that contains different ERC1155 tokens deployed
    ...
    function initialize() public initializer {
        ...
        erc1155Implementation = address(
            new SHRNFT_1155_Collection_v1_CustomInitV1_1()
        );
    }
    ...
    function deployERC1155(
        ...
        address clone = ClonesUpgradeable.clone(erc1155Implementation);
        SHRNFT_1155_Collection_v1_CustomInitV1_1 col = SHRNFT_1155_Collection_v1_CustomInitV1_1(
                clone
            );
        col.initialize(
            _contractName,
    ...
    */
    ...
    {
        SHRNFT_1155_Collection_v1_CustomInitV1_1 token = collections[_index];
        return (
            address(token),
            token.owner(),
            token.uri(_id),
    ...
    function getERC1155ImplementationAddress() public onlyOwner view returns (address) {
        return erc1155Implementation;
    }
}
...
contract SHRNFT_1155_Collection_v1_CustomInitV1_1 is
    Initializable,
    ERC1155Upgradeable,
    OwnableUpgradeable,
    PausableUpgradeable,
