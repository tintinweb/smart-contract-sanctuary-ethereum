...
contract LazyMinting is ERC721URIStorage, EIP712, AccessControl, Ownable {
   
    // Signing domains
    string private constant SIGNING_DOMAIN = "Bling-NFT";
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "NFTVoucher(address signerAddress,string title,string description,string userId)"
                        ),
