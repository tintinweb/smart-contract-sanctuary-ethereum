...
/// @title Redlions SuperSubscriptions
/// @author Gui "Qruz" Rodrigues
/// @notice A ERC-721 Soulbound contract that disables any transfers except from and to the null address (0x0) allowing minting and burning of tokens
/// @dev ERC721Soulbound is a custom made interface to according to the EIP-5484 proposal (https://github.com/ethereum/EIPs/blob/master/EIPS/eip-5484.md)
contract RedlionSubscriptions is
  ERC721,
  Pausable,
  ISubscriptions,
  AccessControl
{
  ...
  string public baseURI = 'https://nft.redlion.news/subscription/normal/';
  ...
  constructor(address _manager) ERC721('Redlion Subscrptions', 'RLSUBS') {
