...
contract RoboPunksNFT is ERC721, Ownable { //RoboPunks contract is going to be inheriting from ERC721 and ownable Openzeppelin contracts
    ...
    function mint(uint256 quantity_) public payable {
        ...
        require(walletMints[msg.sender] + quantity_ <= maxPerWallet, 'exceed max per wallet'); //THIS FUNCTION SOLVES THE EVO APES PROBLEM. Making a require statement will stop then from transferiing NFTs to other wallet and reminting
