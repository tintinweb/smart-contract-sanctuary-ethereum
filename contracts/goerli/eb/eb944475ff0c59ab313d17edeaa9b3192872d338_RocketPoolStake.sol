...
// File: contracts/RocketTokenRETHInterface.sol
...
// File: contracts/RocketStorageInterface.sol
...
// File: contracts/RocketDepositPoolInterface.sol
...
// File: contracts/RocketPoolStake.sol
...
contract RocketPoolStake is ReentrancyGuard, Initializable {

   /**
   * @notice contracts address constants and lido constructor 
    */
    ...
    address constant public _rocketStorageAddress= 0xd8Cd47263414aFEca62d6e2a3917d6600abDceB3 ;
    ...
    rocketTokenRETH = RocketTokenRETHInterface(rocketTokenRETHAddress);
      ...
      function submitEth2() external payable nonReentrant {
        ...
        rocketTokenRETH.transfer(myAddress, actualRethMinted);
    }
}