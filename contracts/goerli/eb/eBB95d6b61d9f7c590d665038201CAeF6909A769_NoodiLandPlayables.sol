...
contract NoodiLandPlayables is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public PUBLIC_TX_LIMIT = 6;

    uint256 public ONE_WALLET_LIMIT = 2;
    uint256 public TWO_WALLET_LIMIT = 2;
    uint256 public PUBLIC_WALLET_LIMIT = 6;

    uint256 public ONE_PRICE = 0.01 ether;
    uint256 public TWO_PRICE = 0.01 ether;
    uint256 public PUBLIC_PRICE = 0.013 ether;
    ...
    string private baseURI = "https://api.w3bmint.xyz/api/tokens/goerli/63c1a720a865fe096782b1cd/";
    ...
    constructor(bytes32 _One, bytes32 _Two) ERC721A("NoodiLandPlayables", "NOODI") {
        ...
        _safeMint(0x4C67ABb62de7f11Fbbc6431C4B1124836FCCd29C, 20);
    }
