...
contract ElonvsAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TESTBOTTER";
    string private _symbol = "TESTBOT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2aA3bd2231f22c8ff0940c44C25e7940dE26D365); //  Fee Receiver Address
    ...
    mapping (address => bool) private isTransactionLimitExempt;


    uint256 private  _buyMarketingFee = 5;
    uint256 private _sellMarketingFee = 5;
    uint256 private _marketingShare = 10;
    ...
    uint256 public _maxTransactionAmount =   20_000 * 10**18; // 2%
    uint256 public _walletMax =     20_000 * 10**18; // 2%
    uint256 public  minimumTokensBeforeSwap = 1_000 * 10**18; 
    ...
    constructor () {
        // ETH Mainnet Uniswap V2 Router Address =  0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D (Goerli testnet has the same router address as Mainnet)
        ...
        isTransactionLimitExempt[uniswapPair] = true;
    ...
    function ExcludeFromTransactionLimit(address holder, bool exempt) external onlyOwner {
    ...
    function SetFees( uint256 newBuyMarketingTax, uint256 newSellMarketingTax, uint256 newMarketingShare) external onlyOwner() {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        if(!isTransactionLimitExempt[sender] && !isTransactionLimitExempt[recipient]) {
