...
// File: @openzeppelin/contracts-upgradeable/access/AccessControlCrossChainUpgradeable.sol
...
// File: /contracts/RidoUpgradeable/RIDOUpgradeableAbstract.sol
...
abstract contract RIDOUpgradeableAbstract is
    Initializable,
    ERC20Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    // //Bu kod main deploy ederken açılacak
    // initialize()
    // //Bu kod chain deploy ederken açılacak.
    // //initializer {}
    ...
    function initialize() public initializer {
        ...
        _grantRole(PAUSER_ROLE, 0x13C2870c285B2F2f5831E53700b4E5E139e73596);
        _grantRole(PAUSER_ROLE, 0x668F723e961aab7089Ce61fB90989f7Bac49Bb5b);

        _grantRole(PAUSER_ROLE, 0xc2b642856f06fE467a046189cC466E8c4BEFA469);
        _grantRole(PAUSER_ROLE, 0xAF9BA890a097997CBe13DcADd48529F3517F2F1e);

        //Default Admin Role
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(
            DEFAULT_ADMIN_ROLE,
            0xc2b642856f06fE467a046189cC466E8c4BEFA469
        );
        ...
        _grantRole(MINTER_ROLE, 0x13C2870c285B2F2f5831E53700b4E5E139e73596);
        _grantRole(MINTER_ROLE, 0x668F723e961aab7089Ce61fB90989f7Bac49Bb5b);
        _grantRole(MINTER_ROLE, 0xc2b642856f06fE467a046189cC466E8c4BEFA469);

        //Ganache and metamask default
        _grantRole(MINTER_ROLE, 0xc2b642856f06fE467a046189cC466E8c4BEFA469);
        _grantRole(MINTER_ROLE, 0xAF9BA890a097997CBe13DcADd48529F3517F2F1e);

        //Upgrader Role
        _grantRole(UPGRADER_ROLE, msg.sender);
        _grantRole(UPGRADER_ROLE, 0x13C2870c285B2F2f5831E53700b4E5E139e73596);
        _grantRole(UPGRADER_ROLE, 0x668F723e961aab7089Ce61fB90989f7Bac49Bb5b);

        //Ganache and metamask default
        _grantRole(UPGRADER_ROLE, 0xc2b642856f06fE467a046189cC466E8c4BEFA469);
        _grantRole(UPGRADER_ROLE, 0xAF9BA890a097997CBe13DcADd48529F3517F2F1e);

        //Bu kodu main olmayan chainlerde aç
...
// File: contracts/RidoUpgradeable/RIDOCrossChainEthereum.sol
...
contract RIDOCrossChainEthereum is
    RIDOUpgradeableAbstract,
    CrossChainEnabledAMBUpgradeable(0xEB0788F72A759B1522e96B147c6A1bE150E66Ae4)
{}