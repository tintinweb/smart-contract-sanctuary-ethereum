...
contract PVCShares is ERC20 {
    ...
    address public constant USDC = 0x11973df5fCb72Ff0f744f811F4d1b76fba79Bdf7;
    address public constant USDT = 0xb356e9231ecD2E65aFFFFBaA9eF50FD489fc8A6f;
    ...
    function mint(uint256 _amount, bool _usdc) external {
        ...
        _mint(msg.sender, estimatedAmount);
    }
