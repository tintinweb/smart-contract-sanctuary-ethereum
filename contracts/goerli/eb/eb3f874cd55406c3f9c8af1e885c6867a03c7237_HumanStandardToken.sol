...
contract HumanStandardToken is StandardToken, IMintableERC20 {
    ...
    */
    ...
    function updateERC20PredicateProxy(address _newERC20PredicateProxy) external {
    ...
    function mint(address _user, uint256 _amount) external override {
        require(msg.sender == erc20PredicateProxy, "You're not allowed to mint");
        _mint(_user, _amount);
    }
}