...
// revert if maxmintamount is less than balance on requestRandomWords
    ...
    Ownable
{
    ...
    // Uniswap Variables
    IUniswapV2Pair public WETHLINKPair;
    IUniswapV2Router02 internal uniswapRouter;
    address WETHLINKPairAddress = 0x32bE40dC4Db907aCf18773bfC81F1bFFA92B77c2;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

    // v3 pair => 0x4Cff90F02897259E1aB69FF6bbD370EA14529bD8
    // factory => 0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f
    // weth add => 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6
        ...
        ERC721("Nakashi Manga", "NM")
    {
        ...
        WETHLINKPair = IUniswapV2Pair(WETHLINKPairAddress);
    ...
    function requestRandomWords() external payable {
        ...
        this.topUpSubscription();

        // put link token conveert func here
    ...
    function getCurrentSwapPrice() public view returns (uint256) {
        uint256 LINKReserve;
        uint256 ETHReserve;

        if (WETHLINKPair.token0() == linkToken) {
            (LINKReserve, ETHReserve, ) = WETHLINKPair.getReserves();
        } else {
            (ETHReserve, LINKReserve, ) = WETHLINKPair.getReserves();
        }
        return ((LINKReserve / ETHReserve) * 50) / 100;
    }

    function swapETHForTokens() private {
        // Generate the uniswap pair path of token -> weth
        uint256 amount = getCurrentSwapPrice();
