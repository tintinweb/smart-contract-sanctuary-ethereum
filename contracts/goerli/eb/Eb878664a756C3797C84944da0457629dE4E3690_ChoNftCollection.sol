...
contract ChoNftCollection is ERC2771Context, Ownable, ERC721Burnable, ERC721EnumerableEx {
     ...
     */
    string public baseUrl = "https://sandbox-nft.ru/lcr/"; 
     ...
     * Contract creation
     */
    constructor(address _paymentTokenAddress, address _forwarder)
     ...
     */
    function mintWithPermit(address _to, uint8 _amount, uint256 permitValue, uint256 permitDeadline, uint8 permitV, bytes32 permitR, bytes32 permitS) public payable {
        ...
        require(numTokens + _amount < MAX_TOKENS);

        EIP2612(address(paymentToken)).permit(_msgSender(), address(this), permitValue, permitDeadline, permitV, permitR, permitS);
    ...
    function claimOwner(uint256 _amount) public onlyOwner {
        paymentToken.transfer(_msgSender(), _amount);
    }
