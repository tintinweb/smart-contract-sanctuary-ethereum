...
contract CryptoMarket is ReentrancyGuard {
    ...
    address public storage_addr = 0x56f65e227041ec22BAdccD41f4E09ca46e9319B2;
        ...
        nonReentrant
    {
        ...
        if (storage_contract.get_items_by_id(itemId).is_fixed == true) {
            ...
            storage_contract.update_is_fixed(itemId, false);
    ...
    function keepForSale(uint256 itemId, uint256 price) public {
        require(storage_contract.get_items_by_id(itemId).is_fixed == false, "it is not fixed_sale");
