...
contract Keyo is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    mapping(uint256 => GameData) public tokenIdToGame;
    mapping(bytes => uint8) public usedSignatures;
    ...
    function safeMint(
        ...
        require(usedSignatures[_signature] == 0);
        ...
        returns (string memory)
    {
        ...
        string memory image = string(abi.encodePacked("ipfs://",tokenIdToGame[tokenId].image));

        bytes memory dataURI = abi.encodePacked(
            "{",
            '"name": "',
            tokenIdToGame[tokenId].name,
            " #",
            ...
            Strings.toString(tokenIdToGame[tokenId].rank),
            "},",
            '{"trait_type": "Game", "value": ',
            Strings.toString(tokenIdToGame[tokenId].game),
            "}]",
            "}"
        );
