...
contract DreamsChristmas is ERC721A, DefaultOperatorFilterer {
    uint256 public maxSupply = 111; 
    uint256 private price = 0 ether;
    string public ShowPrice = "FREE Mint";
    uint256 private maxPerTx = 3;
    string public baseURI;
    error LengthsDoNotMatch();

    function DreamsMint(uint256 amount) payable public {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////// NAME OF THE COLLECTION AND THE NAME OF THE TOKEN ////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////
    constructor() ERC721A("Dreams Christmas", "XMAS") {
        owner = msg.sender;
    }
...
/////// FUNCTION TO LOAD METADATA, METADATA TO CREATE //////
