...
contract GeoInsuranceProvider {
    ...
    uint256 private chain_id; // 1 LINK
    // address public LINK;
    ...
    */    
    ...
    function newContract(address payable _client, uint _premium, uint _payoutValue) public payable onlyOwner() returns(address) {
        ...
        GeoInsuranceConsumer i = (new GeoInsuranceConsumer){value:((_payoutValue * 1 ether) / (uint(getLatestPrice())))}(_client, _premium, _payoutValue, chain_id);
