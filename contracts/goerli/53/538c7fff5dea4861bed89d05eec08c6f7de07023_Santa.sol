...
contract Santa is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("Santa Digital Trading Cards", "SDTC") {
        setHiddenMetadataUri("ipfs://bafkreiedmd7svznaf7qqg6b327nbelmtvhcqiaovt63huzuxlil2wujiaq");
    }

    uint256 public price = 0.002 ether;
    uint256 public maxPerTx = 12;
    uint256 public maxPerFree = 3;    
    uint256 public maxFreeSupply = 313;
    uint256 public maxSupply = 3131;
