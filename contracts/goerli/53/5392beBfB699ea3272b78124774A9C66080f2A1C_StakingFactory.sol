...
contract StakingFactory is Ownable, IStakingFactory {
    ...
    constructor(
        ...
        uint256 totalBlocksPerYear = 14040; // for goerli
    ...
    function _createPool(
        ...
        IStaking(_pool).initialize(_stakingToken, lockinBlocks, _admin, _plasmaPerBlockPerToken, poolIndex == 0 || poolIndex == 1);
