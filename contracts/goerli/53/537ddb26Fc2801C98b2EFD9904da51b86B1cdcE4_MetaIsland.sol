...
contract MetaIsland is ERC721A, Ownable {    
    ...
    uint256 public  mintPrice = 0.0005 * 10**18;
    ...
    function mintMI(uint256 quantity) external payable callerIsUser {

        require(msg.value >= (mintPrice * quantity), "balance is not enough");
