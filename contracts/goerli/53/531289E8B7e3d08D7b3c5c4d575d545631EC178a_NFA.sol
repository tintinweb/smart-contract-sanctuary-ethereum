...
contract NFA is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public BASE_PRICE = 0.0222 ether;

    uint256 public total_GM = 0;
    uint256 public gm_Burn = 69;
    uint256 public MaxFren = 4;

    uint256 public _gmTime = 1 minutes;
    ...
    function userMintPrice(address user) public view returns (uint256) {
        uint256 mintprice = (BASE_PRICE * (100 - 3 * user_GM[user])) / 100;
    ...
    function burnFren(uint256 bellId) public nonReentrant {
        require(!_hasBurned[msg.sender], "You Have already burned your fren");
