...
contract ChangeMe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ChangeMe";
    string private constant _symbol = unicode"ChangeMe";
    ...
    function reduceFee(uint256 _newFee) external{
      ...
      require(_newFee<=_initialBuyTax, "Token: only fee reduction permitted");
      _finalTax=_newFee;
    }

    function returnPairAddress() external returns (address) {
