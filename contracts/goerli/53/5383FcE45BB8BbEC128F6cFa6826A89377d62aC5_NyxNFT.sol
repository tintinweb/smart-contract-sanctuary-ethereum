...
// import "operator_filter/RevokableOperatorFilterer.sol";
import "operator_filter/DefaultOperatorFilterer.sol";
import "operator_filter/IOperatorFilterRegistry.sol";


// contract NyxNFT is ERC1155Supply, Ownable
// contract NyxNFT is ERC1155Supply, Ownable, RevokableOperatorFilterer
contract NyxNFT is ERC1155Supply, Ownable, DefaultOperatorFilterer
{
    //////////////////////////////////////////////////////////////////
    // Attributes
    //////////////////////////////////////////////////////////////////
    ...
    /**
    * Modifer for functions that can be externally called by approved contracts
    */
    ...
    constructor(address _vault_address, address _main_address, address _signer_address,
        ...
        uint256 teamMintPct, uint256 teamFeePct) ERC1155(metadata_url)
    {
    ...
    /**
    * Overriding ERC1155.safeBatchTransferFrom to update balanceHistory
    */
    ...
    /**
    * Overriding ERC1155.safeTransferFrom to update balanceHistory
    */
    ...
    /**
    * Get current NyxDao NFT's balance of an address for all token IDs
    */
    ...
    /**
    * Get current NyxDao NFT's balance of an address for a given token ID
    */
    ...
    /**
    * Get NyxDao NFT's balance of an address at a given block number, for all token IDs
    */
    ...
    /**
    * Get NyxDao NFT's balance of an address at a given block number, for a given token ID
    */
    ...
    /**
    * Get NyxDao NFT's balance of an address around a given block number, for all token IDs
    */
    ...
    /**
    * Get NyxDao NFT's balance of an address around a given block number, for given token ID
    */
    ...
    */
    ...
    /**
    * Get ETH balance of Nyx DAO NFT's contract
    */
    ...
    /**
    * Get current supply of a given token ID
    */
    ...
    /**
    * Get total current supply for all token IDs
    */
    ...
    /**
    * Get metadata URI for a given token ID
    */
    ...
    /**
    * If public mint is closed, open it. Otherwise, close public mint.
    */
    ...
    /**
    * Set the address of NYX's Vault
    */
    ...
    */
    ...
    /**
    * Set the metadata URI for a given token ID
    */
    ...
    /**
    * Set the max mintable for public mint
    */
    ...
    /**
    * Set the max mint for whitelist mint
    */
    ...
    /**
    * If the given address is an approved caller, remove its role.
    ...
    */
    ...
    /**
    * Get total supply given a supply and a token ID
    ...
    */
    ...
    /**
    * Private helper function to initialize a new token ID
    */
    function initWave(uint256 wave, uint256 _wavePrice, uint256 _waveMintableSupply, uint256 votingPower, uint256 redeemRatio,
        ...
        private
    {
        ...
        waveRedeemRatio[wave] = redeemRatio;
    ...
    /**
    * Definitely close the mint of a given token ID
    */
    ...
    /**
    * External function to initialize a new token ID
    */
        ...
        external onlyApproved
    {
        ...
        currentTokenId += 1;
        initWave(currentTokenId, _wavePrice, _waveMintableSupply, votingPower, redeemRatio, teamMintPct, teamFeePct);
        _isMinting = false;
    }
    ...
    /**
    * Internal helper function to mint a Nyx DAO's NFT
    */
    ...
    */
    ...
    /**
    * Check the given address is holder of a given token ID
    */
    ...
    /**
    * Check the given address is holder of any token IDs
    */
    ...
    /**
    * Check the given signature params against signer address
    ...
    */
    ...
    /**
    * Retrieve the signer address induced by the given signature params
    */
    ...
    /**
    * Emergency withdraw function to send all smart contract funds to NYX's Vault
    */
    function withdraw()
        external onlyOwner
    {
    ...
    /**
    * Helper function to get the amount to withdraw for the team, and for the vault, given a token ID
    */
