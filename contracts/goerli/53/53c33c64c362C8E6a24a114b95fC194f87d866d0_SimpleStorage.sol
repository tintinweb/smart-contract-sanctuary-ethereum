...
pragma solidity 0.8.8; // could use >= 0.8.1 < 0.9.0, ^0.8.8 -> least 0.8.8 all the way to newer version of 0.8
...
contract SimpleStorage {
    ...
    function store(uint256 _favoriteNumber) public virtual { // need to specify virtual because in 3_ExtraStorage we need to override this function
