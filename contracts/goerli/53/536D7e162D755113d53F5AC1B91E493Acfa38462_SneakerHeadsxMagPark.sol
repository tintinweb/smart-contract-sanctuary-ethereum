...
contract SneakerHeadsxMagPark is ERC721A, Manageable, DefaultOperatorFilterer, ReentrancyGuard {
	...
	uint32 private constant VIP_SALE_START_TIME = 1673964900;
	uint32 private constant ALLOWLIST_SALE_START_TIME = 1673965200;
	uint32 private constant PUBLIC_SALE_START_TIME = 1673965500;
	uint32 private constant SALES_END_TIME = 1673967600;

	uint256 private constant VIP_SALE_PRICE = 0.00003 ether;
	uint256 private constant ALLOWLIST_SALE_PRICE = 0.00006 ether;
	uint256 private constant PUBLIC_SALE_PRICE = 0.00009 ether;
