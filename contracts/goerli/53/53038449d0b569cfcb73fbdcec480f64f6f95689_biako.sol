...
contract biako is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("NFT Name", "SYMBOL") {
        baseUri = "ipfs://QmUHceZeSgCpYGb5XtB9PMDskX4JR69tbp2kMoB6zcybKA/";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= 10, "You cannot mint that many in one transaction.");
        require(mintedPerWallet[msg.sender] + _numTokens <= 10, "You cannot mint that many total.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferTwo, ) = payable(0x34C944702f23563688d1f2b4b313161c8DbF0A51).call{value: balanceTwo}("");
