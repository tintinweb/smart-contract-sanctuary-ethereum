...
contract CurioTarotCards is ERC721AQueryable, IERC721ABurnable, Ownable, Pausable, ReentrancyGuard {
    ...
    //Paper Functions
    // using the modifier
    function paperMint(address toAddress,uint256 quantity, bytes32 _nonce, bytes calldata _signature) public
        onlyPaper(keccak256(abi.encode(toAddress)), _nonce, _signature)
