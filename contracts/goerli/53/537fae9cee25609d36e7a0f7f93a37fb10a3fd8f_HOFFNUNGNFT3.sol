...
contract HOFFNUNGNFT3 is ERC721, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("HOFFNUNGNFT3", "HFNFT3") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://sparkling-semolina-6c3b8a.netlify.app/";
    }
