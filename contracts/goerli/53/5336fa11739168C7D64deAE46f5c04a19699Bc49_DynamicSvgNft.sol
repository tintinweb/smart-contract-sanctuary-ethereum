...
contract DynamicSvgNft is ERC721 {
    ...
    //some logic to say "Show X Image" or "Snow Y Image"
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        //data:application/json;base64, --- prefix for json images
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                name(),
                                '", "descripition":"An NFT that change based on  Chainlink feed", ',
