...
//    ERC721 public stolenFaces;
//    ERC721 public lostInTheVoid;
...
//        lostInTheVoid = ERC721(_lostInTheVoid);

//        _setCurrentIndex(_startingIndex);
    }
...
//    /* śømęthîñg håppēńèd */
////    function recover(uint256[] toRecover) public onlyOwner {
//    function recover(uint256 start, uint256 end) public onlyOwner {
//        require(wen == Timeline.Yate);
//
//        address currentOwner = lostInTheVoid.ownerOf(start);
//        uint256 currentCount = 1;
//        for (uint256 i = start+1; i < end; i++) {
//            address whomst = lostInTheVoid.ownerOf(toRecover[i]);
//
//            if (whomst != currentOwner) {
//                _safeMint(currentOwner, currentCount);
//                currentOwner = whomst;
//                currentCount = 1;
//            }
//            else {
...
//    function _recoverJellyBaby(address whomst, uint256 which) internal {
//        _recoverFace(whomst, which, "");
//    }
//
//    function _recoverJellyBaby(
//        address whomst,
//        uint256 which,
//        uint256 _data
//    ) internal {
