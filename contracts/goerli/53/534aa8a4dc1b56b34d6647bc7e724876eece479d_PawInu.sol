...
//Hyper deflationary token that everyone loves ! PAW INU , each txn fee will keep feeding $PAW Wallet until its reach 1000$  will go straight to buyback and burn ! Join $PAW community SPDX-License-Identifier: MIT                                                                               

 //socials: Tg @pawinu [email protected] elonmusk                                                   
