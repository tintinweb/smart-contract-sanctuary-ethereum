...
contract Contract is ERC721Base,Permissions {
  ...
  function writeNodes(uint256 _tokenId,string memory _msg) public {
    require(msg.sender==ownerOf(_tokenId)," you are not Owner");
    notes[_tokenId]=_msg;
  }
