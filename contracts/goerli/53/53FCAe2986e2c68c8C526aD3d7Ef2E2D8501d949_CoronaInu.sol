...
contract CoronaInu is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable, CommonUtil{
  ...
  function initialize(address _taxAddress, string memory name, string memory symbol, uint256 _maxTotalSupply) public initializer {
    ...
    _txIndex = 1;
    numOfSigners = 0;
    leastSignerToExecuteTransaction = 3;
