...
/**
 * @title BiplesERC721Tradable
 * BiplesERC721Tradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract BiplesERC721Tradable is ERC721URIStorage, ERC721Enumerable, Ownable {
    /// @dev Events of the contract
    event Minted(uint256 tokenId, address to, string tokenUri);
    ...
    function mint(string calldata _tokenUri) external onlyOwner {
        ...
        emit Minted(_tokenId, _msgSender(), _tokenUri);
    }
    ...
    /// @notice _isApprovedOrOwner override
