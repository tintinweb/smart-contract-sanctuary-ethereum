...
contract RoleOverride is ERC721A, ERC721AQueryable, IERC721ABurnable, Context, OwnableRoles, Pausable, ReentrancyGuard, ERC2981 {
   ...
   function tokenURI(uint256 tokenId) public view virtual override(ERC721A, IERC721A) returns (string memory) {
    ...
    function grantRoles(address user, uint256 roles) public override onlyRolesOrOwner(ADMIN_ROLE) {
