    ...
    ReentrancyGuard
{
    ...
    uint256 public _price = 0.0089 ether; // 0.01 ETH
    Counters.Counter private _tokenIds;
    
    constructor(string memory uri, address _proxyRegistryAddress)
        ERC721("Bizarre Octopus", "BZR")
    ...
    onlyAccounts
    {
        ...
        require(!paused, "Bizarre : Contract is paused");
        require(_amount > 0, "Bizarre : zero amount");
