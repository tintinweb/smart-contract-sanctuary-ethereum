    ...
    Pausable
{
     ...
     */
    function totalSupply() public pure //override
     returns (uint256) {
...
contract LBSKRCore is BaseBSKR, DSMath {
    ...
    uint8 private constant _SECS_IN_AN_HOUR = 10; // TODO set value of 3600
    ...
    function calcInflation(uint256 nowTS)
        internal
        returns (
            // view // TODO enable it later after removing debug event
            uint256 inflation
        )
    {
...
contract LBSKR is LBSKRCore {
    ...
    function setInitialRatio(
        ...
        uint256 stakeAmount
    ) public isInitialRatioNotSet onlyManager {
    ...
    function createStake(uint256 stakeAmount)
        public
        whenNotPaused
        isInitialRatioSet // TODO need to fix setInitialRatio
    {
        uint256 nowTS = block.timestamp;
        uint256 inflation = calcInflation(nowTS);
        ...
        creditInflation(inflation, nowTS);
    ...
    function getBSKRPerShare() public //view TODO enable later
    returns (uint256) {
    ...
    function rewardOf(address stakeholder) public //view TODO enable later
    returns (uint256) {
        uint256 inflation = calcInflation(block.timestamp);
    ...
    function rewardForBSKR(address stakeholder, uint256 bskrAmount)
        public
        // view TODO enable view after debug event is removed
        returns (uint256)
    {
        uint256 inflation = calcInflation(block.timestamp);
        uint256 stakeholderStake = stakeholderToStake[stakeholder].stakedBSKR;
    ...
    function getCurrentRewards() public //view // TODO make is view after debug event is removed
     returns (uint256) {
    ...
    function refundLockedBSKR(uint256 from, uint256 to) public onlyManager {
        // IT - Invalid `to` param
    ...
    function removeLockedRewards() public onlyManager {
