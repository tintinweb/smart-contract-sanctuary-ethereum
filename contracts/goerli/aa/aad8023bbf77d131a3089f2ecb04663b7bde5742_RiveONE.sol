...
abstract contract Ownable is Context {
    ...
    contract RiveONE is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix = "ipfs://QmWv74oNxFJZfVb81YtQ2u5CxTp8nvBX7SqDBimpNUhr3Y/" ;
  ...
  uint256 public whiteListCost = 0.4 ether ;
  ...
  constructor() ERC721A("RiveONE", "RONE") {
  }
