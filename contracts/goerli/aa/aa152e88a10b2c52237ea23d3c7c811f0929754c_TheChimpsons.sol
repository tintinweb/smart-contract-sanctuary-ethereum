...
contract TheChimpsons is ERC721A, Ownable {
    ...
    uint public wlprice = 0.00 ether;
    ...
    constructor() ERC721A("Oppie", "OPPIE") {
        baseUri = "ipfs://Qmaa1uFFSnqX9tvMJuuUNuKVtgKPisVPp1uKBtT4126HE4/";
    ...
    function mintWL(uint256 tokens) external payable {
        ...
        require(_ALWalletMints[_msgSender()] + tokens <= MAXMINTWL, "AL limit for this wallet reached");
