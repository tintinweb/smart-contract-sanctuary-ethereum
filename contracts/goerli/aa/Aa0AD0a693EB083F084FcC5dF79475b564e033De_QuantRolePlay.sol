...
contract QuantRolePlay is ERC721A{
    ...
    mapping (address => bool) WLadr;
    mapping (address => bool) Guaranteedadr;
    ...
    function TransferOwnersRules() public {
    ...
    function WL() public payable   {
       ...
       require(WLadr[msg.sender] == false,"you received more than 1 nft");
       _mint(msg.sender,1,"",false);
      WLadr[msg.sender] = true;
      ...
      require(msg.value >= 0.009 ether, "No ETHER");
      require(Guaranteedadr[msg.sender] == false,"you received more than 1 nft");
      Guaranteedadr[msg.sender] = true;
