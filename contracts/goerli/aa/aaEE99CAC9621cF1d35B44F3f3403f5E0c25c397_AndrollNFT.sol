...
contract AndrollNFT is Ownable, ERC721AURIStorage {
    address public controller;
    uint256 immutable totalMint;

    constructor(uint256 _totalMint) ERC721AURIStorage("Androll", "ADR") {
    ...
    function mint(
        ...
        require(
            ...
            "AndrollNFT: only owner or controller are allowed"
        );
        require(
            _currentIndex + _quantity <= totalMint + 1,
            "AndrollNFT: the total mint has been exeeded"
        );
