 ...
 * prevent sending tokens from a backlisted wallet
 *
 */
contract Blacklist is IBlacklists, Ownable {
    ...
    /**
     * @notice Used to add wallet to blacklist
    ...
    /**
     * @notice Used to remove a wallet from blacklist
     * Only owner has permission change
    ...
    /**
     * @notice Used to know if the wallet is backlisted or not
