 ...
 * @notice This contract handles minting sattu tokens.
 */
contract Sattu is ERC1155Supply, Ownable, Pausable, ReentrancyGuard, ERC2981 {
    using ECDSA for bytes32;

    // Used to validate authorized presale mint addresses
    address private presaleSignerAddress =
        0xC7398877cd5A29b8679a1e020D04aBF8BeA515f5;
    ...
    address public royaltyAddress = 0xAA2650451419f165878BD8be2A1c0e467A9A430F;
    address[] public payoutAddresses = [
        0xAA2650451419f165878BD8be2A1c0e467A9A430F
    ];
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeihj3r4rhhq4n5cg423y7j7u5loj6lonjrxs72fphgkzmjwdx63koa/{id}"
        )
    {
        blocklistContractAddress = _blocklistContractAddress;
        _setDefaultRoyalty(royaltyAddress, royaltyFee);
        tokenMaxSupply[69] = 1000;
        tokenPublicPrice[69] = 0.001 ether;
        tokenPublicMintsPerAddress[69] = 2;
        tokenPresaleMaxSupply[69] = 100;
        tokenPresalePrice[69] = 0.001 ether;
        tokenPresaleMintsPerAddress[69] = 2;
        tokenPresaleSaleStartTime[69] = 1674460800;
        tokenPresaleSaleEndTime[69] = 1674455400;
