...
contract NftBridgeEth is Ownable, ReentrancyGuard, ERC721, ERC721URIStorage {
    ...
    enum SourceChainTokensAvailable{ TOKEN1, TOKEN2, TOKEN3 }
    enum DestinationChainTokensAvailable{ TOKEN1, TOKEN2, TOKEN3 }

    event NftTransferedToDestinationChain(
        address _from,
        address _to,
        string indexed _uri
    );
    ...
    function transferNft(
        ...
        emit NftTransferedToDestinationChain(address(this), recipient, uri);
    ...
    function withdrawNft(address tokenAddress, address recipient, uint256 tokenId)
        external
        onlyOwner
    {
    ...
    function getNftBalance(address tokenAddress, address recipient)
        external
        onlyOwner
        view
        returns (uint256)
