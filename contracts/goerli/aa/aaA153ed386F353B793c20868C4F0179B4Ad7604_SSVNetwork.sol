...
library ClusterLib {
    ...
    function updateBalance(
        ...
        uint64 networkFeeX = uint64(currentNetworkFeeIndex - cluster.networkFeeIndex) * cluster.validatorCount;
        uint64 usage = (newIndex - cluster.index) * cluster.validatorCount + networkFeeX;
