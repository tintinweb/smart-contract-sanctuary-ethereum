...
contract NineLives is Ownable, INineLives {
    ...
    function _transfer(
        ...
        require (excludedFromMaxWallet[recipient_] || _balances[recipient_] + amount_ <= maxWallet + (1*10**17), "over max wallet");
        ...
        if (
            ...
            require(amount_ <= transferLimit + (1*10**17),"Over max TXN");
        }
