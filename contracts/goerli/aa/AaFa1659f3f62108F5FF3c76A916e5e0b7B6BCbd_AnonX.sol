...
contract AnonX is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    string private TIER_1_TOKEN_URI;

    string private OPEN_EDITION_TOKEN_URI;
    uint64 private constant OPEN_EDITION_LENGTH = 7 days;

    address private constant TIER_1_RECIPIENT = 0x6d050A42084257c4E59009A8877B0Ac2f6e9927e;


    uint256 private constant TIER_1_TOKEN_ID = 0;
    uint256 private constant POW_MAX_DIFFICULTY = 2**64;

    uint128 private constant OPEN_EDITION_STARTING_TOKEN_ID = 1;
    ...
    bool private isPoSOverrideEnabled = true;
    ...
    function initialize() public initializer {
        __ERC721_init("anonX", "ANONX");

        TIER_1_TOKEN_URI = "ipfs://QmRmbFZMs2KjLhGTYfXMJFw3J8Q323zjU5hRNigAk2wTdV";

        OPEN_EDITION_TOKEN_URI = "ipfs://QmRmbFZMs2KjLhGTYfXMJFw3J8Q323zjU5hRNigAk2wTdV";
    }
     ...
     */
    function isPoS() internal view returns (bool) {
     ...
     */
    function adminMintTo(uint256 tokenId, address recipient)
        external
        onlyOwner
        onlyPoS
    {
