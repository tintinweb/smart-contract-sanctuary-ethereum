...
contract IMXTest is ERC721, Mintable {
  ...
  constructor(
    ...
    _owner = msg.sender;
    //set loyalty 2.5% equal to 250 basis points
    _royaltyAmount = 250;
  }
  ...
  //This function is to overide supportInterface function of ERC721 and ERC2981 interfaceId
