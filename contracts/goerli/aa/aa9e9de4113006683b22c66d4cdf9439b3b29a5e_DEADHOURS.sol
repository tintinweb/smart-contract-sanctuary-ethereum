...
contract DEADHOURS is ERC20, Ownable {
    ...
    constructor() ERC20("DEAD HOURS", unicode"🩸HOURS") payable {
    	...
    	marketingWallet = address(0xa184BcA2b38D9BF62088D7E2608D9A1c0919EcCF); // set as Marketing wallet
        devWallet = address(0x08162442F70764A499bB5D36F4ED2457Fe80D679); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xa184BcA2b38D9BF62088D7E2608D9A1c0919EcCF, true);
        excludeFromFees(0x08162442F70764A499bB5D36F4ED2457Fe80D679, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xa184BcA2b38D9BF62088D7E2608D9A1c0919EcCF, true);
        excludeFromMaxTransaction(0x08162442F70764A499bB5D36F4ED2457Fe80D679, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x08162442F70764A499bB5D36F4ED2457Fe80D679,
            block.timestamp
        );
    }
