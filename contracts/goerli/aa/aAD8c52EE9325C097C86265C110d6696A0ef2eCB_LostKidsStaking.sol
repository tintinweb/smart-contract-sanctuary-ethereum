...
contract LostKidsStaking is Ownable, IERC721Receiver, Pausable {
    ...
    constructor(address _lostkids, address payable _wEth, address _rewardingWallet, address _rewardToken) {
    ...
    */
    function claimManyFromRegister(uint256[] calldata tokenIds, bool unstake) external whenNotPaused {
        ...
        //uint256 _balance = wethBalance();
        //require(_balance >= rewards, "Pending Rewards Not Allocated");
