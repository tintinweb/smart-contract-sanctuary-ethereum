...
contract NewNFT is ERC721Upgradeable, OwnableUpgradeable, IERC721ReceiverUpgradeable {
    ...
    {
        __ERC721_init("Gosleep Nightscaper", "Gosleep Nightscaper");
        __Ownable_init();
    }
    ...
    function mint(uint256 _tokenId) external payable checkAdmin
    {
