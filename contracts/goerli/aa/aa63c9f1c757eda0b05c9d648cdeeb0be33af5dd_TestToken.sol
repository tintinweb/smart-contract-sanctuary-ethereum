...
Supply: 1,000,000,000 $TeTo
Tax: 0% final tax
Max Wallet: 20,000,000 $TeTo (2%) at launch then remove max wallet limit once stabilize

Twitter:    twitter.com/LFG
TG:         t.me/DTestToken
*/
...
contract TestToken is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TeTo";
    ...
    address payable private _developmentAddress = payable(0xB4aEeaE206441E197Fc307C111797dE92e72E6aA);
    address payable private _marketingAddress = payable(0xB4aEeaE206441E197Fc307C111797dE92e72E6aA);
