...
contract digi is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public currentCollectSize = 4;
    uint256 public oldCollectSize ;
    uint256 public firstMintSize = 4;
    ...
    function secondMint(string memory _data) external payable callerIsUser returns(address payable,uint256,uint256) {
        ...
        return (_owner,tid,tokenIdOwner) ;
    }
