...
contract PVBundledWallets is BasicValidator {
    ...
    /**
     * @notice Add Secondary wallets to Primary Wallet (msg.sender)
     * @dev Signatures and Data to be constructed in the backend by web3
     * @param _addresses    Array of secondary wallet addresses
     * @param _signatures   Array of EIP-712 signatures by the primary wallet
     * @param _data         Array of Data structs constructed using web3
     */
    function addWallets(
    ...
    /**
     * @notice Remove Secondary wallets from Primary Wallet (msg.sender)
     * @param _addresses    Array of secondary wallet addresses
     */
    ...
    /**
     * @notice Remove Secondary wallet from Primary Wallet
     * @dev Used for deleting signatures from secondary wallets
     */
    ...
    /**
     * @notice Toogle bundling status - provides users with more flexibility
     * @param _bundleStatus true to enable and false to disable
     */
    ...
    /**
     * @notice Bundled ERC-721 balance of - See {IERC721-balanceOf}
     * @param user          Primary Wallet address
     * @param tokenContract NFT Contract to query for
    ...
    /**
     * @notice Bundled ERC-721 owner of - See {IERC721-ownerOf}
     * @dev Checks for ownership of a token in the bundle
     * @param tokenId       tokenId to query for
     * @param user          Primary Wallet address
     * @param tokenContract NFT Contract to query for
     * @return ownership
     */
    ...
    /**
     * @notice Bundled ERC-20 balance of - See {IERC20-balanceOf}
     * @param user          Primary Wallet address
     * @param tokenContract Token Contract to query for
     * @return bundledBalance
     */
    ...
    /**
     * @notice Bundled ERC-1155 balance of - See {IERC1155-balanceOf}
     * @param user          Primary Wallet address
     * @param tokenContract NFT Contract to query for
     * @param id            token id to query for
     * @return bundledBalance
     */
    ...
    /**
     * @notice Fetch secondary wallets given a primary wallet address
