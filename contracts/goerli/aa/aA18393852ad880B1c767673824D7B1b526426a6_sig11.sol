...
contract sig11 is Ownable, ERC721A, DefaultOperatorFilterer, ERC2981 {
    ...
    constructor(
        ...
        //setPause(false);
        //setMaxSupply(6);
        _setDefaultRoyalty(0x14145DDf324BC975Ee621044D662739d9A6EDe96, 1000);
    ...
    function externalMint(address _address , uint256 _amount ) external payable onlyOwner {
        // require(hasRole(MINTER_ROLE, msg.sender), "Caller is not a minter");
        require( _nextTokenId() -1 + _amount <= maxSupply , "max NFT limit exceeded");
        _safeMint( _address, _amount );
    }

    function externalBurn(uint256[] memory _burnTokenIds) external onlyOwner {
