...
contract NFT_ERC721r is ERC721r, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _initBaseURI, string memory _hiddenMetadataUri, uint _cost, uint _maxMintAmountPerTx) ERC721r("Bunny Blocks NFT", "BBFnft", 35_0) {
  ...
  modifier mintCompliance(uint quantity) {
    ...
    require(totalSupply() + quantity <= 10_0, "Max supply exceeded!");
    _;
  }
