...
import {IMoonftExchange} from "IMoonftExchange.sol";
...
// CurrencyManager: https://etherscan.io/address/0xc881addf409ee2c4b6bbc8b607c2c5cafab93d25#code
// ExecutionManager: https://etherscan.io/address/0x9cc58bf22a173c0fa8791c13df396d18185d62b2#code

/**
 * @title MoonftExchange
 * @notice It is the core contract of the Moonft exchange.
 */
contract MoonftExchange is IMoonftExchange, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x378a1d39adcc2560de478651a2d7b1aaae8f90a80f5a2fd392920bc573d8fdd4, // keccak256("MoonftExchange")
    ...
    function cancelAllOrdersForSender(uint256 minNonce) external {
        ...
        require(minNonce <= block.timestamp, "Cancel: Cannot cancel more orders");
    ...
    function getHash(OrderTypes.MakerOrder memory makerOrder) public view returns (bytes32) {
