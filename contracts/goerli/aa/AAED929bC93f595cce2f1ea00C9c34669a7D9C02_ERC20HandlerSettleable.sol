 ...
 *
 */
contract ERC20PresetPauserMinter is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC20PresetPauserMinter: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC20PresetPauserMinter: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC20PresetPauserMinter: must have pauser role to unpause");
        _unpause();
    }
 ...
 * For a generic mechanism see {ERC20PresetERC20PresetMinterPauser}.
 *
