    ...
    PausableUpgradeable
{
    ...
    mapping(bytes32 => bool) public statusOrderExtension;
    ...
    function cancelExtension(LibOrder.Input calldata input)
        external
        override
        nonReentrant
        whenNotPaused
    {
        ...
        emit Cancel(input.salt, bytes4(keccak256("SELL_ORDER")));
    }
        ...
        whenNotPaused
    {
        ...
        emit Cancel(order.salt, bytes4(keccak256("OFFER")));
    }
