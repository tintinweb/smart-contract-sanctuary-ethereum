...
contract Raffle is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    function getContractVariables() public view returns (bytes memory) {
        ...
        return abi.encode(
            raffleCreator, deployDate, raffleName, totalTickets, ticketPrice, 
    ...
    function drawWinner(uint256 _gweiForFulfillPrayer) public payable onlyOwner nonReentrant returns (uint256) {
