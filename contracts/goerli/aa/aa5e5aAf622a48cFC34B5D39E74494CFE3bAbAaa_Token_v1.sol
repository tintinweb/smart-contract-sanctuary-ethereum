...
contract Admin is Capper, Prohibiter {
    ...
    event CapperChanged(
        address indexed oldCapper,
        address indexed newCapper,
    ...
    event ProhibiterChanged(
        address indexed oldProhibiter,
        address indexed newProhibiter,
        address indexed sender
    );
...
contract Owner is Admin, MinterAdmin {
    ...
    event MinterAdminChanged(
        address indexed oldMinterAdmin,
        address indexed newMinterAdmin,
        address indexed sender
    );
