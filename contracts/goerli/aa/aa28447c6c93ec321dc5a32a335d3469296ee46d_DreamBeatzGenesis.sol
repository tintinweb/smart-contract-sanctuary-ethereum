...
contract DreamBeatzGenesis is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer  {
    ...
    string public uri = "https://bafkreibkxhdeiwjiijpkhv253k3btycl6hlsa4ls3ivk4ocdeba225pofa.ipfs.nftstorage.link";
    function setURI(string memory u) public onlyOwner{
        uri = u;
    }
    
    address public beatzAddress = 0x920330085CBEf3ccCa2c3b163809Cecf2210726f;
    function setBeatzAddress(address a) public onlyOwner{
        beatzAddress = a;
    }
    
    address public beatz_vault = 0x77E5C0704d9681765d9C7204D66e5110c6556DDd;
    ...
    constructor() ERC721A("DreamBeatz! Genesis", "DRMBTZ") {
        swapPrice["Accessory 1"] = 0.0001 ether;
        swapPrice["Accessory 2"] = 0.0002 ether;
        swapPrice["Accessory 3"] = 0.0003 ether;
        swapPrice["Accessory 4"] = 0.0004 ether;
        swapPrice["Accessory 5"] = 0.0005 ether;
        swapPrice["Background"] = 0.0006 ether;
        swapPrice["Body Trait"] = 0.0007 ether;
        swapPrice["Clothes"] = 0.0008 ether;
        swapPrice["Eyes"] = 0.0009 ether;
        swapPrice["Hairstyle"] = 0.0010 ether;
        swapPrice["Instrument Design"] = 0.0020 ether;
        swapPrice["Mouth"] = 0.0030 ether;
    }
