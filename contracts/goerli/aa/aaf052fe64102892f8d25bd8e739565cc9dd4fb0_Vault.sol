...
contract Vault is Ownable, Tokenlist/*, UniswapV2Router02*/ {
        ...
        isWhitelisted(_tokenAddress) returns (uint256)
   {
        ...
        //uint112 _reserveIn = (UniswapV2Pair(slp).getReserves()).0;
        (uint112 reserve1, uint112 reserve2, ) = UniswapV2Pair(slp).getReserves();
        uint256 _amountOut = UniswapV2Router02(router).getAmountOut(_amountIn, reserve1, reserve2);
   ...
   function _withdrawAll(address _tokenAddress) 
      internal
   {
