...
contract Test_Gotchi_2 is ERC721Enumerable, VRFConsumerBase, Ownable {
    ...
    constructor(
        ...
        ERC721("Test Gotchi 2", "test_pet_2") 
    {
    ...
    */
    ...
    //  *******add back in onlyMinter modifier on mainnet***********
    function batchMint(address[] memory recipients, uint256 _dayPasses, uint256 _packChoice, uint256 _petChoice) public { 
