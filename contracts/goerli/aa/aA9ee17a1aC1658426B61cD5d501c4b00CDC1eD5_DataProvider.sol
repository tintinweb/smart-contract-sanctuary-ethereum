...
contract DataProvider {
        ...
        returns (RoundData[] memory result)
    {
        ...
        result = new RoundData[](numRounds + 1);

        // result 0 is about the team supply

        result[0].maxMintPerAccount = 0;
        result[0].maxMint = 0;
        result[0].totalMinted = n.TEAM_SUPPLY();
        result[0].price = 0;
        result[0].startTimestamp = 0;
        result[0].endTimestamp = 0;

        // Get data from the round, the first round is 1
        ...
        returns (uint256 totalNumberOfItem, uint256 accMintedAmount)
    {
        ...
        totalNumberOfItem = n.TEAM_SUPPLY();
        accMintedAmount = n.TEAM_SUPPLY();
