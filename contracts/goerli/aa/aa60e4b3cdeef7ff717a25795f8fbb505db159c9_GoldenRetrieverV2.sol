...
START THE REVOLUTION. We are not just here to take part, we are here to TAKE OVER!!! 



https://www.financialfreedom.com
https://t.me/financialfreedom
https://twitter.com/0xfinancialfreedom
...
contract DividendDistributor is IDividendDistributor {
    ...
    //Mainnet
    IERC20 PAX = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7); 
...
contract GoldenRetrieverV2 is ERC20Detailed, Ownable {
    ...
    address public _marketingWalletAddress = 0xC78FD508Be61d1f93E33a596f73415b95679d437;
    ...
    uint256 public _totalSupply = 69000000_500_000 * (10 ** DECIMALS);
    uint256 public swapTokensAtAmount = _totalSupply.mul(5).div(1e5); //0.05%

    uint256 public MaxWalletLimit = _totalSupply.mul(30).div(feeDenominator);  //1%
    uint256 public MaxTxLimit = _totalSupply.mul(15).div(feeDenominator);    //0.1%
    ...
    constructor() ERC20Detailed("Grande Finale", "SONNTAG", uint8(DECIMALS)) Ownable() {
