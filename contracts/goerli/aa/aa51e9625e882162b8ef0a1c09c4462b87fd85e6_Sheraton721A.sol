...
// File: contracts/Sheraton721A.sol
...
contract Sheraton721A is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint256 MAX_MINTS = 100;
    uint256 MAX_SUPPLY = 10021;
    uint256 MAX_SUPPLY_PRIVATE_WHITELISTED = 100;
    ...
    string public baseURI = "ipfs://QmWseNcxVsXvrJ69WHT9m6DanfmLjSaYQz4DLLFXW4USxe/";
    string public uriSuffix = ".json";    
    string public hiddenMetadataUri;

    address constant public privateWLAddress = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;

    constructor(bytes32 _root) ERC721A("Sheraton", "SHER") {
    ...
    function publicWhitelistMint(uint256 quantity, bytes32[] memory proof) external payable mintCompliance(quantity) {
        ...
        require(publicSale == false, "Public sale not false");
        require(isValidWhitelistedPublic(proof, keccak256(abi.encodePacked(msg.sender))), "You are not on public whitelist to perform minting");
    ...
    function setBaseURI(string memory _basUri) public onlyOwner {
        baseURI = _basUri;
    }
