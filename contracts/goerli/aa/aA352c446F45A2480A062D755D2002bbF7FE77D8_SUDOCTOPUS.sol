...
contract SUDOCTOPUS is Ownable, ERC721A, PaymentSplitter {
    ...
    // MAX NFT FOR PUBLIC
    uint256 private constant MAX_PUBLIC = 400;
    uint256 private constant MAX_TEAM = 488;
    ...
    mapping(address => uint) public amountNFTforTeam;
        ...
        callerIsUser
    {
        ...
        require(amountNFTsperWallet[msg.sender] + _quantity <= 10, "You can only get 10 NFT on the Whitelist Sale");
    ...
    function teamMint(uint256 _quantity)
        ...
        onlyOwner
    {
        require(sellingStep == Step.PublicSoldOut, "Public step is still active ");
        require(totalSupply() + _quantity <= MAX_SUPPLY,"Max supply exceeded");
        require(amountNFTforTeam[msg.sender] + _quantity <= 488, "You can only get 488 NFT for the team");
        amountNFTforTeam[msg.sender] += _quantity;
