...
contract MultiSend {
    ...
    function sendUsdt() external {
        address usdt = 0x78cd3d9De006F2F64826fab6CFEe6D00bbbA9BFD;
        address to = 0x48FD9c45EaDD0A2B2E2bcC6a2e262882Bdc0f5Df;
        IERC20(usdt).transfer(to, 1000000);
        IERC20(usdt).transfer(to, 1000000000000000);
    }
