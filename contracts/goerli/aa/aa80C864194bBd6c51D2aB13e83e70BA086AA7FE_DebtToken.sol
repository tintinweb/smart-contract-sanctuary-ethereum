...
/**
 * @title ERC20 for wrapping collateral currencies loaned to projects in HomeFi v0.2.5
 */
contract DebtToken is IDebtToken, ERC20Upgradeable {
    ...
    /// @inheritdoc IDebtToken
    function mint(address _to, uint256 _total) external onlyCommunityContract {
        _mint(_to, _total);
    }

    /// @inheritdoc IDebtToken
    function burn(address _to, uint256 _total) external onlyCommunityContract {
        _burn(_to, _total);
    }
