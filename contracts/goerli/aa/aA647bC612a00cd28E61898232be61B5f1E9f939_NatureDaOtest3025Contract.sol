...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x00dDcE3741c37E1d5694b15377cB4794395Ec1b7];
  address public erc20Payable = 0x00dDcE3741c37E1d5694b15377cB4794395Ec1b7;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3025, 3025) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaalfh3iog6h4vnkinrxitls2u2i2knjcxp3hsq2g7hyonp4mccxu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/rNFmGz2sjBydvdbytbxB/contract-metadata";
  }
...
// File: contracts/NatureDaOtest3025Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NatureDaOtest3025Contract is ERC721APlus {
    constructor() ERC721APlus("Nature DAO test 3025", "NDT3025"){}
}
