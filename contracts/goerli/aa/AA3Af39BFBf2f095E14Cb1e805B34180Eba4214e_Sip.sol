...
// A JuiceboxStudios Project - $SIP IS A UTILITY TOKEN FOR THE JUICEBOXES ECOSYSTEM.
// $SIP is NOT an investment and has NO economic value.
...
contract Sip is ERC20, Ownable {
    ...
    function claim(uint256 _voucherId, address _address, uint256 _amount, bytes calldata _voucher) external {
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(_voucherId, _address, _amount, "sip")
        );
