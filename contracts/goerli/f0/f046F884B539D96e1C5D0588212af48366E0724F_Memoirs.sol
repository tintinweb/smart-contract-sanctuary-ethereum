...
contract Memoirs is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 1010;
    uint256 public immutable supply = 1010;
    ...
    address[] public withdrawAddresses = [0x3C1e611dBAbA22B95C0F4776550258E9875886fa, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x658d025303f3bfb99a78bfc0afbbd93c0364e51f0b48b65c85de539074e7d6a0;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x79BAD552f4A09a97F63b6ca758C2e901d8306c8a, _royaltyAmount);
    }
