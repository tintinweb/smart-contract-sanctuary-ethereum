...
contract ERC721 is IERC721, IERC721Metadata, ERC165 {
    ...
    function approve(address _spender, uint256 _tokenId) public {
        ...
        require(
            msg.sender == owners[_tokenId] ||
                ...
                operatorAprovals[owners[_tokenId]][msg.sender],
    ...
    function transferFrom(
        ...
        require(
            msg.sender == owners[_tokenId] ||
                isApprovedForAll(owners[_tokenId], msg.sender) ||
    ...
    function tokenURI(uint256 _tokenId) public view returns (string memory) {
        require(_tokenId > 0 && _tokenId <= tokenId, "ERC721: URI query for nonexistent token");
