...
contract ERC721A is Context, ERC165, IERC721A {
    ...
    // Mapping from token ID to rarity bucket
    mapping(uint256 => uint256) public _rarityBucket;
    ...
    function _safeMint(
        ...
        unchecked {
            ...
            if (to.isContract()) {
                ...
                do {
                    emit Transfer(address(0), to, updatedIndex++);
                    //adding rarity in same place where Transfer event is emitted is safe
                    uint256 raritySeed = block.timestamp;
                    uint256 rarityModulus = raritySeed%10;
                    uint rarityAssigned = 1;
                    ...
                    _rarityBucket[updatedIndex] = rarityAssigned;
                } while (updatedIndex < end);
            }
