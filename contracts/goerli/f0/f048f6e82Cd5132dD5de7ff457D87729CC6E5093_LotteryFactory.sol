...
interface ILotteryFactory {
    ...
    event LotteryCreated(uint256 indexed ticketPrice, uint256 indexed durationMinutes, address lottery);
    ...
    function getLottery(uint256 ticketPrice, uint256 durationMinutes) external view returns (address lottery);
    ...
    function createLottery(uint256 ticketPrice, uint256 durationMinutes) external returns (address lottery);
...
contract LotteryFactory is ILotteryFactory, LotteryDeployer, NoDelegateCall {
    ...
    function createLottery(
        ...
        lottery = deploy(address(this), ticketPrice, durationMinutes);
