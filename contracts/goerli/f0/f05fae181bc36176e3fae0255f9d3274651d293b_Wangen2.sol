...
contract Wangen2 is Ownable, ERC1155Supply {
    ...
    uint256 public goldMaxSupply = 100;

    uint256 public platMaxSupply = 50;

    uint256 public blackMaxSupply = 20;
    ...
    uint256 public bronzeEurPrice = 1;

    uint256 public silverEurPrice = 2;

    uint256 public goldEurPrice = 3;

    uint256 public platEurPrice = 4;

    uint256 public blackEurPrice = 5;

    uint256 public eurFunds;

    uint256 public maxEurFunds = 2000;
    ...
    function _beforeTokenTransfer(
        ...
        require(buyBack == false,"Transfer are not allowed during buyBack period");
    ...
    function batchBurn(uint256[] memory ids, uint256[] memory amounts, address from) external {
