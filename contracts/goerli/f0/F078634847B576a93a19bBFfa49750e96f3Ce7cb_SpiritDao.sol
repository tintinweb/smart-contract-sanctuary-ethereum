...
contract SpiritDao is ReentrancyGuard {
    ...
    constructor () {
        ...
        nextProposal = 1;
        nextVote = 1;
        daoContract = IdaoContract(0xa75280b84fAC7251D7aFF6B49F4ae5DF5e8Ac900); // Spirit Address ($Goerli Turkey)
        validTokens = [0xa75280b84fAC7251D7aFF6B49F4ae5DF5e8Ac900]; // Spirit Address ($Goerli Turkey)
    }
    ...
    function createProposal(string memory _description) public {
        require(checkProposalEligibility(msg.sender), 'You need to hold at least 100,000,000 $SPIRIT to put forth proposals.');
