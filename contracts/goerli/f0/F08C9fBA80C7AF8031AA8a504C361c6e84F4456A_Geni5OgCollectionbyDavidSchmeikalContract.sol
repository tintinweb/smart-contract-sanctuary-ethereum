...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xE6A843BDCCC7Ef7745268Df49cabae7Ba5015508];
  address public erc20Payable = 0xE6A843BDCCC7Ef7745268Df49cabae7Ba5015508;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 555) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigqsy7iya52tbg53oensvckufbldajtkyzu2qurjifdhzvmq5fasq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/MfBe4roHQZBVqNVJrdK8/contract-metadata";
  }
...
// File: contracts/Geni5OgCollectionbyDavidSchmeikalContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Geni5OgCollectionbyDavidSchmeikalContract is RamppERC721A {
    constructor() RamppERC721A("Geni 5 OG Collection by David Schmeikal", "gEni"){}
}
