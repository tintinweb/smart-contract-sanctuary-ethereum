...
contract LandMinter is Minter {
    ...
    function beforeLandMinting_(address to_, uint256 pioneerId_, ILand.PurchaseType purchaseType_) internal view {
        ...
        require(mintsPerWallet[to_] < maxMintsPerWallet, "LandMinter: Cannot mint more for this wallet");
        require(land.balanceOf(to_) < maxTokensPerWallet, "");
    }
...
contract Minter {
    ...
    function setLimits(uint256 maxMintsPerWallet_, uint256 maxTokensPerWallet_) external onlyAdmin {
