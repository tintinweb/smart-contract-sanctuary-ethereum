...
contract CaTest is ERC721A, Ownable, ReentrancyGuard, ERC2981{
    ...
    uint256 public prePrice = 0.001 ether;//デプロイ前に修正
    uint256 public pubPrice = 0.002 ether;//デプロイ前に修正
    uint256 public batchSize = 100;
    uint256 public mintLimit = 3;
    uint256 public _totalSupply = 1500;//デプロイ前に修正
    ...
    constructor() ERC721A("CaTestV3", "CTV3",batchSize, _totalSupply) {
        tokenCount = 0;
