...
contract Davin_Test_2 is ERC721A, Ownable, ReentrancyGuard {
    ...
    string private unrevealedURI = "unrevealedURI";
    ...
    constructor (bytes32 _root_al, bytes32 _root_free) ERC721A("Davin_Test_2", "DTEST") {
        root_al = _root_al;
