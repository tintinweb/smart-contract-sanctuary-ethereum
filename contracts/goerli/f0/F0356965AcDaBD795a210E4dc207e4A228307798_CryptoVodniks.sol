...
contract CryptoVodniks is ERC721A, Ownable {
    ...
    function freeMint() public {
        ...
        require(maxFreeMint == 0, "Exceeds free supply");
    ...
    function twopackMint() external payable {
        ...
        require(!paused, "The contract is paused!");
        require(msg.value >= uint256(0.003 ether), "Insufficient funds!");
    ...
    function sixpackMint() external payable {
        uint16 totalSupply = uint16(totalSupply());
        require(totalSupply + 6 <= maxSupply, "Exceeds max supply.");
        require(!paused, "The contract is paused!");
        require(msg.value >= uint256(0.015 ether), "Insufficient funds!");
