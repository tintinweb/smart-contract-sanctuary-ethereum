...
contract OracleConsumer is DataConsumerV3 {
    ...
    function update() public {
        uint256 Chainlink_rate = uint256(getLatestData());
        uint256 LB_rate = _LB_Oracle._last_updated_rate();
        uint256 difference = Chainlink_rate - LB_rate;
        emit RateUpdate(Chainlink_rate, LB_rate, difference);
    }
}
