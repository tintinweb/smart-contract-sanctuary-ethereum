    ...
    ReentrancyGuard
{
    ...
    event UpdateWhitelistMintStatus(bool _whitelistMint);
    ...
    {
        if (!whitelistMint) revert SaleNotActive();
    ...
    function setWhitelistMintStatus(bool _whitelistMint) external onlyOwner {
        whitelistMint = _whitelistMint;
        emit UpdateWhitelistMintStatus(_whitelistMint);
    }
