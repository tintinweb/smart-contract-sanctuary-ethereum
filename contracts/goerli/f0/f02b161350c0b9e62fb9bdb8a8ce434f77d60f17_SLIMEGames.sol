...
contract SLIMEGames is Context, IERC20, Ownable {
    ...
    address payable private charityAddress = payable(0x3b53AEB77Eb77542D59ecD65FA6c7B4626A2787f);
    ...
    string private _name = "Slime Games";
...
//        }
    ...
    function setNewPair(address newPair) public onlyOwner() {
