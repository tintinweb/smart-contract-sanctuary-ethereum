...
contract Orca is Ownable, ERC721, ERC721Enumerable {
    ...
    function _actualMintPrice() public view returns (uint) {
        ...
        if (currentSupply >= 201) {
            return 330000000000000000; // 201 - 250 0.33 ETH
        } else if (currentSupply >= 126) {
            return 220000000000000000; // 126 - 200 0.22 ETH
        } else {
            return 100000000000000000; // 1 - 125 0.11 ETH
        }
    }
    ...
    function _updateReflections() internal {
        ...
        if (currentSupply >= 201) {
            _reflection = (330000000000000000 * _mintSharesReflect) / (10 ** _decimalBase); // 201 - 250 0.33 ETH
        } else if (currentSupply >= 126) {
            _reflection = (220000000000000000 * _mintSharesReflect) / (10 ** _decimalBase); // 126 - 200 0.22 ETH
        } else {
            _reflection = (100000000000000000 * _mintSharesReflect) / (10 ** _decimalBase); // 1 - 125 0.11 ETH
        }
    }
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*3334)/10000); // 6% Co-Founder
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*3333)/10000); // 6% Co-Founder
        payable(0xa0eA2525BC4Db4Ac72BE18baaD6249152380503f).transfer((p*3333)/10000); // 6% Co-Founderz
        _balanceTeam = 0;
    }
