    ...
    IRenderer
{
    ...
    address immutable public scriptyBuilder;
    address immutable public scriptyStorage;
    ...
    constructor(address _nft, address _scriptyStorageAddress, address _scriptyBuilderAddress) NFTExtension(_nft) {
        // generativeArt = _art;
    ...
    function tokenHTML(
        ...
        requests[0].contractAddress = scriptyStorage;
        ...
        uint256 bufferSize = IScriptyBuilder(scriptyBuilder).getBufferSizeForEncodedHTMLWrapped(requests);

        bytes memory htmlFile = IScriptyBuilder(scriptyBuilder).getHTMLWrapped(requests, bufferSize);
