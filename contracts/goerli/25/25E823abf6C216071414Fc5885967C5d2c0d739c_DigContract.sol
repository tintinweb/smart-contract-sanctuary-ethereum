...
contract DigContract is ERC721URIStorage, Ownable{
    ...
    function mintNFT(uint256 quantity) external payable{
        ...
        //safemint nft to user quantity times
        for (uint256 i = 0; i < quantity; i++) {
            _safeMint(msg.sender, newItemId);
            _setTokenURI(newItemId, 'https://ipfs.moralis.io:2053/ipfs/Qmd1TUfLccLhbLfMqzvnrTy33mp4jyum39gimR3Jkzz1KD/shovelNew.json');
            _tokenIds.increment();
