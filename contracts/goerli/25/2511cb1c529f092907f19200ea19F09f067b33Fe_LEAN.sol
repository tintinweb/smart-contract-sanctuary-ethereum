...
contract LEAN is ERC20 {
    // 18 decimals
    constructor() ERC20("Lean Management Token", "LEAN") {
        address sender = 0x93bCC3981ce0eE99a4a0fdC3a8bdAe146ea2B9A7;
        _mint(sender, 3_000_000 * (10 ** uint256(decimals())));
    }

    function batchTransfer(address[] calldata destinations, uint256[] calldata amounts) public {
        uint256 n = destinations.length;
        address sender = _msgSender();
        require(n == amounts.length, "LEAN: Invalid BatchTransfer");
