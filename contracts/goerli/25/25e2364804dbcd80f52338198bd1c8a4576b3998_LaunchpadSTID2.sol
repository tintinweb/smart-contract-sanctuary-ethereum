...
// File: erc721a/contracts/extensions/ERC4907A.sol
 ...
 * @notice This contract handles minting STID2 tokens.
 */
contract LaunchpadSTID2 is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private soulboundAdminAddress;
    address public royaltyAddress = 0x16aD4E68C2E1D312C01098d3E1Cfc633B90dFF46;
    ...
    string public baseTokenURI = "https://curiousaddys.com/metadata/";
    ...
    constructor() ERC721A("STID2", "STID2") {
     ...
     */
    function setSoulbindingActive(bool _soulbindingActive) public onlyOwner {
        require(
     ...
     */
    function setBurnClaimState(bool _burnClaimActive) public onlyOwner {
        require(
    ...
    function burnERC1155ToMint(uint256 amount) public originalUser {
        ...
        ERC1155 ExternalERC1155BurnContract = ERC1155(
            0xF5621a065F267D382C00839Ae8a04688c93D24b8
        );
        require(
     ...
     */
    function setFreeClaimState(bool _freeClaimActive) public onlyOwner {
        require(
     ...
     */
    function freeClaim(uint256[] calldata _tokenIDs) public originalUser {
        require(freeClaimActive, "FREE_CLAIM_IS_NOT_ACTIVE");
        require(
            totalSupply() + (_tokenIDs.length * 3) <= MAX_SUPPLY,
            "MAX_SUPPLY_EXCEEDED"
        );
        ERC721A ExternalERC721FreeClaimContract = ERC721A(
            0xf37488Af8f71233d75aC69Dc29C45732374D3419
        );
        for (uint256 i = 0; i < _tokenIDs.length; i++) {
            ...
            require(!tokenClaimed[_tokenIDs[i]], "TOKEN_ALREADY_CLAIMED");
            tokenClaimed[_tokenIDs[i]] = true;
        }
        _safeMint(msg.sender, _tokenIDs.length * 3);
    }
    ...
    function generateRandomHash(uint256 tokenId) internal {
        require(
            randomHashStore[tokenId] == bytes32(0),
            "RANDOM_HASH_ALREADY_SET"
        );
    ...
    function randomHashToString(uint256 tokenId)
        public
        view
        returns (string memory)
    {
        return string(abi.encodePacked(randomHashStore[tokenId]));
    }
