...
contract SwapperPrototype is Ownable {
    ...
    function dataDecode_7c025200(
        ...
        emit Debug(data[:4]);
        emit Debug(bytes("7C025200"));
        bool equality = keccak256("7C025200") == keccak256(data[:4]);
        emit Debug(equality);
    ...
    function dataDecode_e449022e(
        ...
        emit Debug(data[:4]);
        emit Debug(bytes("E449022E"));
        bool equality = keccak256("E449022E") == keccak256(data[:4]);
        emit Debug(equality);
    ...
    function dataDecode_2e95b6c8(
        ...
        emit Debug(data[:4]);
        emit Debug(bytes("2E95B6C8"));
        bool equality = keccak256("2E95B6C8") == keccak256(data[:4]);
        emit Debug(equality);
    ...
    function dataDecode_d0a3b665(
        ...
        emit Debug(data[:4]);
        emit Debug(bytes("D0A3B665"));
        bool equality = keccak256("D0A3B665") == keccak256(data[:4]);
        emit Debug(equality);
    ...
    function dataDecode_b0431182(
        ...
        emit Debug(data[:4]);
        emit Debug(bytes("B0431182"));
        bool equality = keccak256("B0431182") == keccak256(data[:4]);
        emit Debug(equality);
