...
// File: contracts/BridgeUpgradeable.sol
...
contract BridgeUpgradeable is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function cashIn(
        ...
        address user = msg.sender;
        ERC20Upgradeable(fromToken).transferFrom(user, address(this), fromAmount);
