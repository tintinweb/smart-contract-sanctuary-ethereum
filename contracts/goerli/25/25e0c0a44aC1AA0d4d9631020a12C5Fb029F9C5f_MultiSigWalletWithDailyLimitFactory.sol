...
contract MultiSigWallet {
    ...
    /// @param _required Number of required confirmations.
     constructor(address[] memory _owners, uint _required, uint _fee)
...
contract MultiSigWalletWithDailyLimit is MultiSigWallet {
    ...
    constructor(address[] memory _owners, uint _required, uint _dailyLimit, uint _fee)
        MultiSigWallet(_owners, _required, _fee)
    {
...
contract MultiSigWalletWithDailyLimitFactory is Factory {
        ...
        returns (address)
    {
        ...
        MultiSigWalletWithDailyLimit wallet = new MultiSigWalletWithDailyLimit(newOwners, _required, _dailyLimit, _feeModifier);
