...
contract cecxleqsa is ERC721A, Ownable {
    uint256 MAX_MINTS = 9;
    uint256 MAX_SUPPLY = 100;
    uint256 public mintRate = 0.001 ether;

    string public baseURI = "ipfs://QmcTCVa9LLwF9uALjd7jGQRML7kYUPsixnJa3HCMFgzEj4/";

    constructor() ERC721A("cecxleqsa", "CECX") {}
