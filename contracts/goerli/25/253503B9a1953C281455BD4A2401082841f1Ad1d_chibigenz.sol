...
contract chibigenz is ERC721A, ERC2981, OperatorFilterer, Ownable {
    ...
    address public constant w1 = 0x0d27520d5F85A5226aF4718070b15e7CCBFf6929;

    constructor() ERC721A("Chibigenz", "CBZ"){
    ...
    function mint(uint256 amount) external payable {
        ...
        require(totalSupply() + amount <= maxSupply, "Chibi full");
    ...
    //function mintPublic(uint256 amount) external payable {
        ...
        //require(mintEnabled[msg.sender] + amount <= maxPerWallet, "Exceeding max tokens");
        //require(totalSupply() + amount <= maxSupply, "Exceeding max supply of total tokens.");
        //require(msg.value == price * amount, "Incorrect Ether value.");
