...
interface ILaunchKey is IERC721 {
    function burn(uint16 tokenID) external;

}

contract MasterRegistry is AccessControl {
    ...
    mapping (uint16 => MasterListEntry)   public communityListByID;
    mapping (uint256 => uint16)           public communitiesAsAdded;
    ...
    function launchKey() public view returns (ILaunchKey) {
        return ILaunchKey(reg.getRegistryAddress("LAUNCHKEY"));
    }
