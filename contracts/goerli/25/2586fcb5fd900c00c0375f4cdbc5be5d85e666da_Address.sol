...
contract PocketWaifusv2 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVCdYqzKxbKADTxv5x9ZBT8VPzcbX9GA4gCNqRAmSFdtR";
    ...
    constructor(
    ) ERC721A("PW", "PocketWaifusv2", 100, maxSupply) {
    }
