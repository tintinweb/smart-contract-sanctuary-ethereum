...
contract unr1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "unr1";
    string private constant _symbol = "unr1";
    ...
    constructor () payable {
        _balances[_msgSender()] = _totalSupply.mul(3).div(100);                   // 3% of supply goes to dev
