...
contract CubeNFTMinter is Ownable{
    ...
    ICubeNFT public founderPack;
    ICubeNFT public normalPack;
    ...
    constructor() {
        walletA = payable(0x0E7aF5D0790f2051D403b5caeC5284C223F14B06);
        walletB = payable(0x8c70975fC7C0580cB108719204135a0Ef80251D5);
        founderToken = IERC20(0x62215b9c1DDa8C3215AC02774cc1166de3049E66);

        founderPack = ICubeNFT(0x27eccA77585ED79aE54bf4051c837735bED84E97);
        normalPack = ICubeNFT(0x3895668cA39108bEa9016C00Ca518585B69B0C85);
    }
