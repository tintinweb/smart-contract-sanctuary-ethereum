 ...
 * @dev this implements chainlink VRF 2 and chainlink keepers
 *
 */
...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
     ...
     * The following need to be true to it fully equal true:
     * 1. Our time interval should have passed
     * 2. Lottery should have at least 1 player and some eth
     * 3. subscribtion is funded (chainlink)
     * 4. lottery should be in an OPEN state to avoid "limbo state"
     */
    ...
    function getNumWords() public pure returns (uint256) {
        return NUM_WORDS;
        // can be pure since doesn't call from storage but byte code
    }
