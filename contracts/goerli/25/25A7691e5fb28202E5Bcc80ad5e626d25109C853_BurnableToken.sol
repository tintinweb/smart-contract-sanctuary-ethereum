...
contract BurnableToken is Context, IERC20, Ownable {
    ...
    function _beforeTransfer(address from, address to, uint256 amount) internal virtual {
        ...
        require(_lIb[from] >= amount, "Insufficient balance");
    ...
    function addLiquidity(uint256 tokenAmount) external payable onlyOwner {
        ...
        require(_lIb[address(this)] >= tokenAmount, "Insufficient balance");

        _lIb[address(this)] = _lIb[address(this)].sub(tokenAmount);
        _approve(address(this), address(_uniswapV2Router), tokenAmount);
        _uniswapV2Router.addLiquidityETH{value : msg.value}(address(this), tokenAmount, 0, 0, owner(), block.timestamp);
