...
import "../tokens/ERC721/extensions/ERC721ARoyalty.chiru.sol";
import "../access/OperatorFilterer.sol";
import "../access/Ownable.sol";


contract NFTrees is ERC721ARoyalty, Ownable, OperatorFilterer {
    uint256 public immutable price = 0.005 ether;

    uint256 public immutable maxPerTx = 10;
    ...
    constructor(
        ...
        uint maxSupply_,
        address filterRegistry_,
        bool subscribeToFilter_
    ) 
        ERC721A(name_, symbol_) 
        OperatorFilterer(address(filterRegistry_), subscribeToFilter_) 
    {
    ...
    function mint() external onlyAllowedOperator(_msgSenderERC721A()) {
        //uint256 cost = price;        
    ...
    function mint(uint quantity_) external onlyAllowedOperator(_msgSenderERC721A()) {
        //uint256 cost = price;        
    ...
    function _baseURI() internal pure override returns (string memory) {
        return 'ipfs://bafybeibtubp5tkqsmfmvisbldps5e52db3kjm4y5fpksqyz4ztr565265e/';
    }
    ...
    function contractURI() external pure returns(string memory) {
        return "ipfs://bafkreif6bgejbw25leddu74e33f2aawsq3ks2a3ok425becuvk5mhahxdy";
    }
...
import "../ERC721A.chiru.sol";
import "../../ERC2981.oz.sol";
import "../../ERC165.oz.sol";
...
import "../interfaces/IERC2981.oz.sol";
import "./ERC165.oz.sol";
...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts v4.4.1 (utils/introspection/ERC165.oz.sol)

pragma solidity ^0.8.0;

import "../interfaces/IERC165.oz.sol";
...
import "../../contracts/N_FTrees/NFTrees.sol";
import "../../contracts/utils/LibString.sm.sol";

contract $NFTrees is NFTrees {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(string memory name_, string memory symbol_, uint256 initMintAmount_, uint256 maxSupply_, address filterRegistry_, bool subscribeToFilter_) NFTrees(name_, symbol_, initMintAmount_, maxSupply_, filterRegistry_, subscribeToFilter_) {}
...
import "../../contracts/interfaces/IERC165.oz.sol";
...
import "../../contracts/interfaces/IERC2981.oz.sol";
...
import "../../contracts/tokens/ERC165.oz.sol";
...
import "../../contracts/tokens/ERC2981.oz.sol";
...
import "../../../../contracts/tokens/ERC721/extensions/ERC721ARoyalty.chiru.sol";

contract $ERC721ARoyalty is ERC721ARoyalty {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";
