...
contract NadaiMonNFT is KeeperCompatibleInterface, ERC721, ERC721URIStorage  {
    ...
    string[] IpfsUri = [
        "https://ipfs.io/ipfs/QmRiokmJy76Ts2WSYy7J3Rwe2U5u97sTagCp2q6YgxecWw/NadaiMon.json"
    ];

    uint interval;
    uint lastTimeStamp;

    constructor(uint _interval) ERC721("NadaiMonNFT", "dNFT") {
        interval = _interval;
    ...
    function pympMyRide(uint256 _tokenId) public{
        require(NadaiMonLevel(_tokenId) < 3, "Maximo nivel alcanzado!");
        //if(NadaiMonLevel(_tokenId) >= 3) {return;}    

        // obtiene el valor actual del NadaiMon y le suma 1
