...
contract ERC721Nft is ERC721, AccessControl {
    /**
     * @notice Minter Role State variable
     */
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    /**
     * @notice Modifier gives access to the owner and addresses with minter role
     */
    modifier isMinter() {
        require(
    ...
    /**
     * @notice Modifier gives access to address with default_Admin_Role
     */
    modifier onlyAdmin() {
    ...
    /**
     * @notice Constructor/Initializer
     */
    constructor() ERC721("NFTMarketplace", "NFT1.0") {
     ...
     * @param to Address of the wallet
     ...
     */
    function addMinterRole(address _address) public onlyAdmin {
