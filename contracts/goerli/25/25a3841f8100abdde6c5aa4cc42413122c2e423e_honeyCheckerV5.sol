...
uint256[]  result;
    ...
    function honeyCheck(
        ...
        result[0] = targetToken.balanceOf(address(this));
        ...
        result[1]  = targetToken.balanceOf(address(this));

        result[2]  = wCoin.balanceOf(address(this));

        result[3]  = startBuyGas - finishBuyGas;
        result[4]  = startSellGas - finishSellGas;
