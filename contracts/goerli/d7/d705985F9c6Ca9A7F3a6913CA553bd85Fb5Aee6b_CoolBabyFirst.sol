...
contract CoolBabyFirst is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmZM8Chgxaq1gKjYnVAs2jvRFb5bBi8Q6TACY4xU24v1sQ/";
    uint   public price             = 0.003 ether;
    uint   public maxPerTx          = 4;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 12;
    uint   public maxSupply         = 12;
    bool   public mintEnabled = true;
    uint   public totalFreeMinted = 0;
    bool   public paused = false;
    bool   public reveled = true;
    mapping(address => uint256) public _mintedFreeAmount;

    //constructor() ERC721A("CoolBabyFirst", "CBF"){}
    constructor(
        string memory _name,
