...
contract AiProfilePicture is ERC721, ERC721Enumerable, Ownable {
    ...
    // TODO: change price for production?
    ...
    // TODO: pass in session/account token
    // TODO: what if people want to upload their own photo?

    // TODO: check merkle proof for session/account token
    // basically only people on "whitelist" can mint

    // TODO: flag session/account token as "used" or whatever
    // prevent the same session/account token from being "used" more than once
