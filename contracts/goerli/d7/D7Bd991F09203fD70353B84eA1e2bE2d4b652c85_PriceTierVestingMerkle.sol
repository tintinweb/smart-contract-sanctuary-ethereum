...
abstract contract Distributor is IDistributor, ReentrancyGuard {
	...
	function _initializeDistributionRecord(address beneficiary, uint256 amount) virtual internal {
	...
	function _executeClaim(address beneficiary, uint256 _amount) internal virtual {
