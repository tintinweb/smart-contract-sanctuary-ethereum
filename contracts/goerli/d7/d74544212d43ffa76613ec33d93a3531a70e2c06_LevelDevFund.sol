...
contract LevelDevFund is Initializable, Ownable, TokenVesting {
    ...
    function claimVested(uint256 _amount, address _recipient) public override (TokenVesting) onlyOwner {
        TokenVesting.claimVested(_amount, _recipient);
    }
...
abstract contract TokenVesting {
    ...
    function claimVested(uint256 _amount, address _recipient) public virtual {
        if (_amount == 0) {
