...
contract MyToken is ERC20, Ownable, ERC20Burnable, CuratedByToken("1.0"), FeeProcessor{
constructor(address payable feeReceiver_) 
        ...
        FeeProcessor(feeReceiver_){
            // Tokenomics
            //Owner
            _mint(0x805ABA4d3E9E1CF45e5CD05B4eCad7207768d3Ec,  50* 10 ** decimals());
            //asas
            _mint(0x805ABA4d3E9E1CF45e5CD05B4eCad7207768d3Ec,  25* 10 ** decimals());
            //asas
            _mint(0x26D9161aC825bB39ad84C0203503Bb0091c8C635,  25* 10 ** decimals());
...
abstract contract FeeProcessor {
    constructor(address payable receiver) payable {
        // IFeeReceiver(receiver).processFee{value: msg.value}(serviceId);
        require(msg.value >= 5* 10**16, 'Need 0.05 for fee');
        receiver.transfer(5* 10**16);
    }
}