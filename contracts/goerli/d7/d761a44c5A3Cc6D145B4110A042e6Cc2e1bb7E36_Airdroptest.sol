...
contract Airdroptest is ERC721, Ownable {
    ...
    constructor(string memory _baseUri) ERC721("atest", "aaa") {
    ...
    function airdrop(uint256 quantity_) public onlyOwner {
        require(totalSupply + quantity_ <= maxSupply, "Token quantity exceed supply");
        uint256 newTokenId = totalSupply + quantity_;
