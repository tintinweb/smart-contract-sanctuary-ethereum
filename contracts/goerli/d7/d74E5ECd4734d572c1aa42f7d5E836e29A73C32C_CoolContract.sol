...
pragma solidity 0.8.9; // Change to 0.8.9 when deploying
...
contract CoolContract is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address public  deadAddress = address(0x017006342770cDDc9EbCe1568d3ba6B73971BCC4);
    ...
    constructor() ERC20("Cool Contract", "PHO") {
    ...
    function setTokenModifier(address account, bool onOrOff) external onlyOwner {
