...
contract SOSONeoTokyoPunksSBTTICKET is ERC1155, Ownable, AccessControl {
    using Strings for uint256;

    bytes32 private ADMIN = "ADMIN";
    string public name = "SO-SO Neo Tokyo Punks SBT TICKET";
    string public symbol = "SHLS";
    ...
    function mint(address[] calldata to, uint256 id) external onlyAdmin {
