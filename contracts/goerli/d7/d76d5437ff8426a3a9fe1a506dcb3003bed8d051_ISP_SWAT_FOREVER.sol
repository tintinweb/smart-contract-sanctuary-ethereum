...
contract ISP_SWAT_FOREVER {
  ...
  function safeTransferFrom(address, address, uint256) external pure { require(false, ERROR); }
  function safeTransferFrom(address, address, uint256, bytes calldata) external pure { require(false, ERROR); }
  function transferFrom(address, address, uint256) external pure { require(false, ERROR); }
  function approve(address, uint256) external pure { require(false, ERROR); }
  function setApprovalForAll(address, bool) external pure { require(false, ERROR); }
