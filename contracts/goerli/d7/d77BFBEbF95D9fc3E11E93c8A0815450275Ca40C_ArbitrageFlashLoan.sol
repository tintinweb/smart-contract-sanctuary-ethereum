...
contract ArbitrageFlashLoan is FlashLoanSimpleReceiverBase {
    ...
    address private dexContractAddress =
        0x9fe4667743fe857dB3BfF09801A85501ea24786B;

    IERC20 private dai;
    IERC20 private usdc;
    ISwap private swapContract;
    constructor(address _addressProvider)
        FlashLoanSimpleReceiverBase(IPoolAddressesProvider(_addressProvider))
    {
        swapContract = ISwap(dexContractAddress);
    ...
    function arbitrargeUSDC(address _tokenAddress, uint256 _amount) private  returns(bool) {
        ...
        uint daiAmountOut = swapContract.swapSingleHopExactAmountIn(_amount,1); // 1000 USDC 

        IERC20 token = IERC20(_tokenAddress);
        return token.transfer(owner, daiAmountOut);
    }
