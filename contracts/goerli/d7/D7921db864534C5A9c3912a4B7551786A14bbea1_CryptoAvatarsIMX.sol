...
contract CryptoAvatarsIMX is
    ...
    constructor(address _eventEmitter, address _imx) ERC721("CryptoAvatarsIMX", "CAIMX") {
    ...
    function mintAvatar(bytes calldata mintingBlob) public {
        mintFor(_msgSender(), 1, mintingBlob);
    }
    ...
    function mintFor(
        ...
        eventEmitter.emitEvent(
            "Mint",
            abi.encode(_msgSender(), blueprint, id, address(this))
        );
    }
