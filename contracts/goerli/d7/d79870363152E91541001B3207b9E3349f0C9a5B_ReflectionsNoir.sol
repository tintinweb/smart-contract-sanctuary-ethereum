...
// Created by Robert McMenemy & Steven Isaac Co Founders of blockgeni3.com
...
contract ReflectionsNoir is ERC721A, Ownable, ReentrancyGuard {
    ...
    modifier whenMint(uint8 quantity) {
        ...
        require(userMintCount[msg.sender] <= maxPerWallet, "[Max Per Wallet Error] You have max minte the amount for this wallet");
        ...
        if(userMintCount[msg.sender] < 1 && privateMintStarted) {
        ...
        userMintCount[msg.sender] += quantity; 
    ...
    // ===== Get total minted for user ===== //
    function getTotalMintedForUser() public view returns(uint) {
        return userMintCount[msg.sender];
    }
