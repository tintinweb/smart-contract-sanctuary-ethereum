...
oooooooooo.  ooooo              .o.       oooooo   oooo   .oooooo.   
`888'   `Y8b `888'             .888.       `888.   .8'   d8P'  `Y8b  
 888     888  888             .8"888.       `888. .8'   888          
 888oooo888'  888            .8' `888.       `888.8'    888          
 888    `88b  888           .88ooo8888.       `888'     888          
 888    .88P  888       o  .8'     `888.       888      `88b    ooo  
o888bood8P'  o888ooooood8 o88o     o8888o     o888o      `Y8bood8P'  
...
// File: contracts/blurApeYachtClub.sol

pragma solidity ^0.8.4;

contract BlurApeYachtClub is ERC721A, Ownable {

    string public baseURI = "https://blurapeyachtclub.s3.amazonaws.com/metadata/";
    ...
    constructor() ERC721A("BlurApeYachtClub", "BLAYC") {}
    ...
    function mintFree(uint256 _amount) external payable {
		...
		require(totalFreeMinted + _amount <= maxFreeSupply, "Cannot exceed Free BLAYC supply." );
        require(totalSupply() + _amount <= maxSupply, "Sold out.");
    ...
    function devMint(uint256 _amount, address _wallet) external onlyOwner {
    ...
    function approve(address to, uint256 id) public virtual override {
        require(!blacklistedMarketplaces[to], "Opensea, LooksRare, X2Y2, and Sudoswap are not permited. Please use Blur.io");
        super.approve(to, id);
    }

    function setApprovalForAll(address operator, bool approved) public virtual override {
        require(!blacklistedMarketplaces[operator], "Opensea, LooksRare, X2Y2, and Sudoswap are not permited. Please use Blur.io");
