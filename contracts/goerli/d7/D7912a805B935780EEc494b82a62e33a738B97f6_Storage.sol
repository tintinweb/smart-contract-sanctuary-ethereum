...
contract Storage is AdminInitializable{
    ...
    */
    ...
    function initialize2(bytes memory _description, bytes memory _detail, address _generator, uint256 _number) external initializer {
        ___Adminable_init();
