...
/**
 * @title MTest05A Contract
 * @notice This contract handles minting and distribution of tokens.
 */
contract MTest05A is ERC721A, Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Override; Read the base token URI.
     */
    ...
    /**
     * @notice Override; Set start token id from 0 to 1.
     */
    ...
    /**
     * @notice Override; Take a token ID as its only argument and returns a URI which points to metadata about that specific token.
    **/
     ...
     */
    function mint() external payable nonReentrant onlyAccounts {
        require(enableMint, "Cannot mint. Please try it later.");
    ...
    /**
     * @notice Modifier of onlyAccounts
     */
    ...
    /**
     * @notice Set mint is enable or disable
     */
