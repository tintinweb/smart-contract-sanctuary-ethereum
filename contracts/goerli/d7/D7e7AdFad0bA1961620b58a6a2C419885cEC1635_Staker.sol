...
contract Staker {
  ...
  function execute() public notCompleted {
    // require(timeLeft() == 0, 'too early to execute!');
    // require(address(this).balance >= threshold, 'not enough funds to execute!');

    // using if instead of revert
  ...
  function withdraw() public notCompleted {
    // require(timeLeft() == 0, 'too early to execute!');
    // require(address(this).balance < threshold, 'threshold was met. you cannot withdraw');
    if (timeLeft() == 0 && address(this).balance < threshold) {
      uint256 accountBalance = balances[msg.sender];
      (bool sent, ) = msg.sender.call{value: accountBalance}('');
      require(sent, 'withdrawal failed');
      balances[msg.sender] = 0;
      emit Withdraw(msg.sender, accountBalance);
    }
  }
