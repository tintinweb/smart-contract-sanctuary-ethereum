...
contract TestNft is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    address[] public withdrawAddresses = [0x25C50cE7C9eD933ee537539cc0c192a3cDd506E7, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x04630ccfcf082ba3ae76637a4d098ed7f43080155fd5dd2c822081fb6a11fcb0;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x25C50cE7C9eD933ee537539cc0c192a3cDd506E7, _royaltyAmount);
    }
