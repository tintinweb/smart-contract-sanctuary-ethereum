    ...
    Ownable
{
    ...
    function ownedNightMotherPlants(
        ...
        uint256[] memory _ownedNightMotherPlants = new uint256[](_nightMotherPlantBalance);
    ...
    function setOnlyWhitelist(bool _onlyWhitelist,uint256 _id) external onlyOwner {
        idStats[_id].onlyWhitelist = _onlyWhitelist;
    }
