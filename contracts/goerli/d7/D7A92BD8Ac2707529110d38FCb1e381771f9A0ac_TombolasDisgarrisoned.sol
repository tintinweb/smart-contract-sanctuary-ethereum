...
/**
 * @title TombolasDisgarrisoned
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract TombolasDisgarrisoned is ERC20Burnable, ERC20Permit {
    address private _owner;

    constructor() ERC20("Tombolas Disgarrisoned","BLG")  ERC20Permit("Tombolas Disgarrisoned") { 
        _owner = _msgSender();
     }
