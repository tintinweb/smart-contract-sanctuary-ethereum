...
/// @title: PatchworkCanteenAppalachian
...
contract PatchworkCanteenAppalachian is
    ERC1155,
    ERC1155Burnable,
    ERC1155Supply,
    Ownable,
    ERC2981
{
    ...
    /**
     * @dev Create and mint a new Edition
     * @param to address to receive mints
     * @param supply qty of tokens for the new edition
     * @param _uri uri for the edition metadata
     * @param royaltyReceiver address to receive royalties
     * @param royaltyPercentage percent of sales paid to receiver
     *
     * Requirements:
    ...
    function createEdition(
        ...
        editions.push(
            Edition(id, supply, _uri, royaltyReceiver, royaltyPercentage)
        );
    ...
    /**
     * @dev Create and mint a new Edition
     * @param amount qty of tokens for the edition
     * @param id edition id to increase
     * @param to address to receive mints
     *
     * Requirements:
     * - `to` cannot be address 0
     ...
     */
    function increaseEditionSupply(
        uint256 amount,
        uint256 id,
        address to
    ) external onlyAuthorized {
        ...
        if (!exists(id)) revert NonExistentEdition();
        _mint(to, id, amount, "0x0000");
    }

    /**
     * @dev Sets the URI to the contract metadata for marketplaces
     */
    ...
    /**
     * @dev Sets the royalty for an edition
    ...
    /**
     * @dev Returns the royalty info for an edition
     * @param id unique identifier of the edition being updated
    ...
    /**
     * @dev Sets a uri for an edition
     * @param id unique identifier of the edition being updated
     * @param _uri uri for the edition metadata
     */
    function setEditionURI(uint256 id, string calldata _uri)
        external
        onlyAuthorized
    {
        editions[id].uri = _uri;
    }

    /**
     * @dev Returns the URI to the editions metadata
     * @param id unique identifier of the edition being updated
     */
    ...
    /**
     * @dev helper function to get edition array
     */
    ...
    /**
     * @dev helper function to get an edition
     */
