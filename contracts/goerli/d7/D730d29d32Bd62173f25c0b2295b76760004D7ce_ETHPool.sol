...
contract ETHPool is AccessControl {
    ...
    *************************/
    ...
    event Withdrawed(bool success, bytes data);
    ...
    ************************/
    ...
    // Users can deposit Ether only with this function.
    ...
    function withdraw() public {
        /**
         * Saves balance, then sets to zero user balance
        ...
        if (rewardsParticipated > 0) {
            ...
            // Value deposited in pool without the rewards distributed.
            uint256 pool = address(this).balance - reward;
             ...
             */
            uint256 percentage = (amount * (pool * 1 ether)) / pool;
            uint256 earned = (reward * percentage) / (pool * 1 ether);
        ...
        emit Withdrawed(success, data);
    }

    /**
     * @dev TEAM_MEMBER Function for deposit rewards in Pool of Users.
     */
    function depostiRewards() public payable onlyRole(TEAM_MEMBER) {
        ++_counter;
