...
contract NomoNounsSeeder is INomoNounsSeeder {
     ...
     */
    // prettier-ignore
    function generateSeed(uint256 nounId, uint256 blockNumber, INounsDescriptorMinimal descriptor) external view override returns (INounsSeeder.Seed memory) {
...
interface INomoNounsSeeder {
    ...
    ) external view returns (INounsSeeder.Seed memory);
}
