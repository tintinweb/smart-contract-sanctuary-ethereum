...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("LITTLE HUMAN", "DUWENDE") {
        baseUri = "ipfs://QmSGbVoJco6zLVPr44KVU3TvfpTbxG73ogmL3Na21AfjKj";
    ...
    function mint(uint256 _numTokens) external payable {
        require(isSaleActive, "TANGINA ALAM MONG NAKAPAUSE EH.");
        require(_numTokens <= MAX_MINT_PER_TX, "BAWAL THREE SOME");
        require(mintedPerWallet[msg.sender] + _numTokens <= MAX_MINT_PER_TX, "PAULIT ULIT AMPOTA");
        uint256 curTotalSupply = totalSupply;
        require(curTotalSupply + _numTokens <= MAX_TOKENS, "TAMA NA NANGSASAGAD KA");
        require(_numTokens * price <= msg.value, "MAHIRAP KA TANGINA.");
