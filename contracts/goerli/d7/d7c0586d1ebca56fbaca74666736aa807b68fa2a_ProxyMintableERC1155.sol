...
interface IERC2981 is IERC165 {
 ...
 abstract contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable, RoyaltiesV2Impl,ReentrancyGuard, IERC2981 {
    ...
    string private baseURI = "https://magazine-api.blockchainfirm.io/magazine/getmeta/";
...
// Optional mapping for token URIs
    ...
    constructor(string memory uri_)  {
        ...
        _setDefaultRoyalty(_msgSender(), 500);
         proxyAddress.push(0x72d6066F486bd0052eefB9114B66ae40e0A6031a);
        proxyAddress.push(0xBbD7cBFA79faee899Eaf900F13C9065bF03B1A74);
        _uri = uri_;
 ...
 //Erc2981Contract
  ...
  function _setURI(uint256 _id, string memory data) internal  {
    ...
    modifier onlyOwnerOrProxy(uint256 _id) {
        require(balanceOf(msg.sender ,_id)>0 || owner() == _msgSender()  , "Ownable: caller is not the owner");
        _;
    }
    
    function uri(uint256 _id) public view override  returns (string memory)  {
         require(owner()==msg.sender || balanceOf(msg.sender ,_id)>0 , "Not Owner");

            return bytes(baseURI).length > 0 ? string(abi.encodePacked(bytes(baseURI),'',bytes(Strings.toString(_id)))) : "";
 ...
 */
 abstract contract IAccessControl {
     ...
     */
    function getRoleAdmin(bytes32 role) external view virtual returns (bytes32);
...
contract ProxyMintableERC1155 is
    ERC1155,
    AccessControlMixin,
  ...
  string private _name;
    string private _symbol;
     constructor()  ERC1155("DNFT") {
        ...
        _setupRole(PREDICATE_ROLE, 0x72d6066F486bd0052eefB9114B66ae40e0A6031a);
    _name ="TESTDNFT";
    _symbol = "DNFT";
    ...
    function mint(
        ...
        uint256 amount,
        bytes calldata data
    ) external override only(PREDICATE_ROLE) nonReentrant(){
