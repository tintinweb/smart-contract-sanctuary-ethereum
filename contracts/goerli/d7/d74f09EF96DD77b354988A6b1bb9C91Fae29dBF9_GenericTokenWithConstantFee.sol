 ...
 */
contract GenericTokenWithConstantFee is Context, IERC20, AccessControl {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[sender] = _balances[sender].sub(amountAfterFee, "ERC20: transfer amount exceeds balance");
