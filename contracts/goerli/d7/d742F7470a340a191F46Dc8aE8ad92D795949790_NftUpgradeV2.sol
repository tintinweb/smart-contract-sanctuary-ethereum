...
contract NftUpgradeV2 is Initializable, ContextUpgradeable, OwnableUpgradeable,ERC721Upgradeable, ERC721EnumerableUpgradeable {
    ...
    function mint() external {
        require(currentTokenId <= MAX_AMOUT,"limit mint amout");
