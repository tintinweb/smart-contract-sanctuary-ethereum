...
contract CryptoMoney is Ownable {
    ...
    function verifyCode(uint256 billId, string memory code) external view returns (bool) {
        return (keccak256((abi.encodePacked(s_bills[billId].codeHash))) == keccak256(abi.encodePacked(code)));
    }
