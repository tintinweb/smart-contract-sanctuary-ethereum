...
contract BuyNowMarketplaceSignerV0007 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, EIP712Upgradeable {
    ...
    function checkMintUnique(bool isUniqueMint, address nftContract, address purchaser) private view {
        if (isUniqueMint == true) {
            require(uniqueWalletMintMapping[address(nftContract)][address(purchaser)] == false, "Only 1 unique NFT per address");
        }
    }
