...
//import 'erc1155/contracts/extensions/ERC1155Queryable.sol';
...
contract MyMFTV8 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  bool public speicalWhitelistMintEnabled = false;
...
function specialWhitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
  require(speicalWhitelistMintEnabled, 'The special whitelist sale is not enabled!');
  ...
  require(_specialWhitelistmintCounter[_msgSender()] <= maxMintAmountPerTx, 'You are going over your');
...
//public mint
  ...
  function setSpecialWhitelistMintEnabled(bool _state) public onlyOwner {
    speicalWhitelistMintEnabled = _state;
  }
