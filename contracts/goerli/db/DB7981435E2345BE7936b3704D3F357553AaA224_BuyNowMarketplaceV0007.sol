...
contract BuyNowMarketplaceV0007 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, EIP712Upgradeable {
    ...
    function initialize(uint _feePercent, uint _initialFeePercent, address payable _feeAccount, address _mintAdmin, address _hpRolesContractAddress, string memory name, string memory version) initializer public {
    ...
    function purchaseMintSignerItem(MintSignerItem calldata mintSignerData) public payable nonReentrant {
        ...
        require(mintAdmin == signer || hpRoles.isAdmin(signer) == true, "Admin rights required");
        ...
        require(mintSignerData.price > 0, "Price can't be 0 for ETH sales");
    ...
    function purchaseSignerItem(SignerItem calldata signerData) public payable nonReentrant {
        ...
        require(signerData.price > 0, "Price can't be 0 for ETH sales");
        ...
        IHPMarketplaceMintV0002 hpMarketplaceNft = IHPMarketplaceMintV0002(address(signerData.nft));
        hpMarketplaceNft.marketplaceTransfer(
            signerData.seller, 
            msg.sender,
            signerData.tokenId);
