...
contract Energetic is ERC721, Ownable, ReentrancyGuard {
    ...
    // ====================== RANDOM ====================== //
    // ==================================================== //
    function randomNumber(uint _modulus) internal view returns (uint) {
        return
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    randomNumber(360),
                    ', 100%, 50%)">',
                    '<animate attributeName="stop-color" values="lightblue;orange;purple;purple;black;purple;purple;blue;lightblue" dur="',
                    randomNumber(360),
