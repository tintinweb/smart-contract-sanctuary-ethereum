...
contract BoostedTokenWrapper is InitializableReentrancyGuard {
    ...
    IERC20 public constant stakingToken = IERC20(0xeB2583f3dC3adDB271FE64bEF9a5cBF97314cA37);
     ...
     * @param _amount Units of StakingToken
     */
    function _stakeRaw(address _beneficiary, uint256 _amount) internal {
     ...
     * @param _amount Units of StakingToken
     */
    function _withdrawRaw(uint256 _amount) internal {
     ...
     * @param _amount Units of StakingToken
     */
    function _reduceRaw(uint256 _amount) internal {
        _rawBalances[msg.sender] = _rawBalances[msg.sender].sub(_amount);
    }
    ...
    BoostedTokenWrapper
{
    ...
    IERC20 public constant rewardsToken = IERC20(0x9A8539222E2a9817F1d796706504792c8bbB3B8C);
