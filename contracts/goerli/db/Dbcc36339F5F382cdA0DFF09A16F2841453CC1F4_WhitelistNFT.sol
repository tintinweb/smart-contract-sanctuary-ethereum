...
import "../interfaces/IWhitelistNFT.sol";
import "@openzeppelin/contracts/token/ERC721/ERC721.sol";

/**
 * This is a contract which extends the IWhitelistNFT interface
 */
contract WhitelistNFT is IWhitelistNFT, ERC721 {
  // EOA account -> is whitelisted
...
interface IWhitelistNFT is IERC721 {
  /**
   * @notice Mint an NFT that can only be transferred between whitelist addresses
   */
  function mint() external;
   ...
   * @return bool Is the token whitelisted
   */
  function isWhitelisted(address _address) external view returns (bool);
}
