 ...
 */
function mint(address to, string memory uri, uint256 nTokens) public {
    require(nTokens == 1);
    require(to != address(0), "Invalid address");
    // Check if the recipient address is the deployer
    if (to == msg.sender) {
        // Allow the deployer to mint an unlimited number of NFTs but not more than maximum supply
        ...
        // Ensure that the number of minted NFTs does not exceed the maximum supply
