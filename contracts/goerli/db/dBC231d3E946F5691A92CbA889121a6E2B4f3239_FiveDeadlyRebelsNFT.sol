...
// File: contracts/extensions/IOperatorFilterRegistry.sol
...
// File: contracts/extensions/OperatorFilterer.sol
...
// File: contracts/extensions/DefaultOperatorFilterer.sol
...
contract FiveDeadlyRebelsNFT is ERC721AQueryable, Ownable, MessageSigning, PaymentSplitter, DefaultOperatorFilterer, ERC2981 {
    ...
    address[] private addressList = [
		...
		0x6f7968ef230c5C5AdB82682B75dfC70D58408A14
	];
	uint256[] private shareList = [85, 15];

    constructor() ERC721A("5DeadlyRebelsNFT", "5DeadlyRebelsNFT") MessageSigning(0x89c414614a488B929D081367B1B9a31bB1E04369)  PaymentSplitter(addressList, shareList) {
