...
// Adapted from https://github.com/CoinbaseStablecoin/coinbase-ens-contract
...
import {IResolverService} from "./IResolverService.sol";
 ...
 */
/**
 * @notice Alchemy Offchain ENS Resolver.
 * @dev Adapted From: https://github.com/CoinbaseStablecoin/coinbase-ens-contract/blob/master/contracts/CoinbaseResolver.sol
 */
contract AlchemyResolver is ERC165, IExtendedResolver, Ownable {
     ...
     */
    constructor(address newOwner, string memory newUrl, address[] memory newSigners) {
    ...
    function resolveWithProof(bytes calldata response, bytes calldata extraData) external view returns (bytes memory) {
        ...
        require(_signers.contains(signer), "AlchemyResolver::resolveWithProof: invalid signature");
        return result;
    }
     ...
     */
    function makeSignatureHash(uint64 expires, bytes calldata request, bytes calldata result)
        external
        view
        returns (bytes32)
    {
