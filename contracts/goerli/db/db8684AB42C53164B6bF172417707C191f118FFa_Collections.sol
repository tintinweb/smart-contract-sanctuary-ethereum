...
contract Collections is Initializable, UUPSUpgradeable {
    ...
    */
    ...
    function create_collection(string memory name, uint256 supply, bytes calldata uri_, uint256 royaltyValue, string memory contract_Metadata_Uri, address royaltyRecipient) public {
            ...
            ERC1155Lockable ERC1155 =new ERC1155Lockable(name,contract_Metadata_Uri);
     ...
     */
    function mint(ERC1155Lockable Collection, uint256 supply, bytes calldata uri_, bytes calldata key, uint256 royaltyValue, address royaltyRecipient) public  {
...
contract ERC1155Lockable is
    ...
    constructor(string memory _name, string memory _metadata_uri)
        ERC1155("") {
            name=_name;
            id = 0;
            symbol = _name;
