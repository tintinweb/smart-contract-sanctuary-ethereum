...
abstract contract VNDutchAuction is VNWhitelist {
...
abstract contract VNWhitelist is VNAdmin {
    ...
    function initWhiteList(
        ...
        emit whiteListPriceSet(_whiteListPrice, _whiteListStartTime, _whiteListEndTime);
    }
    ...
    function isWhiteListActive() public view returns (bool) {
        if (_whiteListPrice == 0) {
            ...
            return block.timestamp >= _whiteListStartTime && block.timestamp <= _whiteListEndTime;
        }
    }
...
abstract contract VNAdmin is ERC721Enumerable, Ownable {
    ...
    function setTermsAndConditions(string calldata termsAndConditions) external onlyOwner {
