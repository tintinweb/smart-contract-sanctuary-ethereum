...
//
//  Our intent is that while you own an NFT minted under this smart contract, you own all copyright
//  that may exist in the image and text depicted in the corresponding SVG file, subject to the rights
//  of owners of other NFTs minted under this smart contract. Unless legally compelled to do otherwise,
//  we will not take a legal position inconsistent with that intent or support another party in taking
//  such a position. In an effort to accomplish this intent, we intend to insert the following language
//  into the metadata of each NFT minted under this smart contract:
//
