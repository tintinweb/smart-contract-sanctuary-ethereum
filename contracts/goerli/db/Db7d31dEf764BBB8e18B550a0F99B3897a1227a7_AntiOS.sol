...
contract AntiOS is ERC721A, Ownable {
    uint256 public immutable MaxWalletPerToken = 10;
    uint256 public immutable MaxSupply = 20;
    mapping(address => uint256) public minted;
    bytes32 public whiteListMerkleRoot;

    constructor() ERC721A("Anti OS", "AO") {}
    ...
    function mint(uint256 quantity, bytes32[] calldata proof) external payable validateAddress(proof) onlyEOA {
