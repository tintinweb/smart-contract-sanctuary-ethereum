...
contract ERC20 is Context {
    ...
    function decimals() public view virtual returns (uint8) {
        //TOD: return the value of decimals specified in README
        return numdecimals;
    }
        ...
        returns (bool)
    {
        ...
        amount=allowance(msg.sender, spender);
        return true;
    ...
    function transferFrom(
        ...
        require(_approve(to, from, amount));
        ...
        returns (bool)
    {
        ...
        emit Approval(spender, msg.sender , addedValue);
        return true;
    }
    ...
    {
        // TODO: use `_approve` defined later in the contract
        require(_approve(msg.sender, spender,subtractedValue));
    ...
    function _mint(address account, uint256 amount) internal virtual returns (bool) {
        //TODO
        require(_approve(account,msg.sender,amount));
        _totalSupply+= amount;
    ...
    function _spendAllowance(
        ...
        // TODO
        require(_allowances[owner][spender]<=100000000000000000000000000000,"infinite allowance");
...
contract LC335147 is LuckyToken {
    constructor() LuckyToken("LuckyToken", "LC335147") {}
}