...
contract BitsVault is Ownable {
    ...
    address private feeWallet = 0xFE089FD61e1749BEcAd77d8e3f85946642B6f609;
    address _dexRouter;
    ...
    function depositEthAndSwap() public payable {
        ...
        // send fees to feesWallet
        payable(feeWallet).transfer(fees);
        emit TransferComplete(fees);
    }
    ...
    function payOwner(uint256 amount) internal {
        payable(address(feeWallet)).transfer(amount);
