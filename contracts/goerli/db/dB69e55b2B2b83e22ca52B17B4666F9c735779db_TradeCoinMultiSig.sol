...
contract TradeCoinMultiSig is EIP712Upgradeable {
    ...
    event SelectorApprovalSet(bytes4 selector, bool approval);
    ...
    event ChangeTemporarySelectorForFinancier(bytes4 selector, bool approval);
    event ChangeTemporarySelectorForBorrower(bytes4 selector, bool approval);
    ...
    mapping(bytes4 => bool) public selectorApprovalForBorrower;
    mapping(bytes4 => bool) public selectorApprovalForFinancier;

    mapping(bytes4 => bool) public temporaryApprovalSelectorForBorrower;
    mapping(bytes4 => bool) public temporaryApprovalSelectorForFinancier;
    ...
    function initialize(
        ...
        __EIP712_init("TradeCoin Multi-Sig", "1");
    ...
    function changeTemporarySelectorForBorrower(bytes4 selector, bool approval)
        external
        isFinancier
    {
    ...
    function changeTemporarySelectorForFinancier(bytes4 selector, bool approval)
        external
        isBorrower
    {
