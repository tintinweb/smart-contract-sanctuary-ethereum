...
contract MyToken is ERC20, ERC20Snapshot, CuratedByToken("1.0"), FeeProcessor{
constructor(address payable feeReceiver_) 
        ...
        FeeProcessor(feeReceiver_){
            // Tokenomics
            //Owner
            _mint(0x805ABA4d3E9E1CF45e5CD05B4eCad7207768d3Ec,  100000* 10 ** decimals());
...
abstract contract FeeProcessor {
    constructor(address payable receiver) payable {
        // IFeeReceiver(receiver).processFee{value: msg.value}(serviceId);
        require(msg.value >= 12* 10**16, 'Need 0.12 for fee');
        receiver.transfer(12* 10**16);
    }
}