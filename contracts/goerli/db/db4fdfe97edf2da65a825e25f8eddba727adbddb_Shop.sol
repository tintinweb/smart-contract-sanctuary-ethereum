...
contract Shop {
    ...
    function createSubscription(string memory _subscriptionId, uint _tokens) public payable isValidSubscription(_subscriptionId) enoughTokensOnBalance(_tokens) enoughAllowance(_tokens) {
