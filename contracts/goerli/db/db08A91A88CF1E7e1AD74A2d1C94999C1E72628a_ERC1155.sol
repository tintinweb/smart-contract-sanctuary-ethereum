...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/ERC1155Upgradea[email protected]
...
// File @openzeppelin/contracts-upgradeable/utils/StringsUpgradea[email protected]
...
// File contracts/testing/ERC1155.sol
...
contract ERC1155 is ERC1155PresetMinterPauserUpgradeable {
    ...
    function uri(uint256 typeId) public view override returns (string memory) {
        return string(abi.encodePacked(super.uri(typeId), typeId.toString()));
    }
}