...
contract Stakable is Ownable {
    ...
    function _stake(
        ...
        Stake storage currStake = _stakeholders[userIndex].userStakes[
            _stakeholders[userIndex].userStakes.length - 1
        ];

        currStake.user = _msgSender();
        currStake.amountLBSKR = amountLBSKR;
        currStake.amountBSKR = amountBSKR;
        currStake.sharesLBSKR = sharesLBSKR;
        currStake.sharesBSKR = sharesBSKR;
        currStake.sinceBlock = sinceBlock;
        ...
        )
    {
        ...
        Stake storage currentStake = _stakeholders[userIndex].userStakes[
            stakeIndex
        ];
        if ((currStake.amountLBSKR - unstakeAmount) == 0) {
            Stake memory lastStake = _stakeholders[userIndex].userStakes[
                _stakeholders[userIndex].userStakes.length - 1
            ];
            currentStake.user = lastStake.user;
            currentStake.amountLBSKR = lastStake.amountLBSKR;
            currentStake.amountBSKR = lastStake.amountBSKR;
            currentStake.sharesLBSKR = lastStake.sharesLBSKR;
            currentStake.sharesBSKR = lastStake.sharesBSKR;
            currentStake.sinceBlock = lastStake.sinceBlock;

            delete _stakeholders[userIndex].userStakes[
                _stakeholders[userIndex].userStakes.length - 1
            ];
        } else {
            currentStake.amountLBSKR -= unstakeAmount;
            currentStake.amountBSKR -= bskrAmount2Deduct;
            currentStake.sharesLBSKR -= lbskrShares2Deduct;
            currentStake.sharesBSKR -= bskrShares2Deduct;
        }
