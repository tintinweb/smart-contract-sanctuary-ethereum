...
abstract contract Whitelistable is IWhitelistable, ERC721LACore {
    ...
    function whitelistMint(
        ...
        if (
            mintCountState._mintedPerWallet[mintCountKey] + _quantity >
...
abstract contract LimitedAmountMint is ERC721LACore {
    /**
     * @dev Internal batch minting function
     */
    function _safeMint(
        ...
        uint24 _quantity,
        address _recipient
    ) virtual override(ERC721LACore) internal returns (uint256 firstTokenId) {
        ...
        return ERC721LACore._safeMint(_editionId, _quantity,_recipient);
    }
}
