...
contract GeoMint is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    // LOL using WizBitz IPFS cause a little lazy on this since its testnet
    string internal URI = "ipfs://QmT2NdspCEU1WbzBv3e7HMeZTrZrDNR35hRoBKhbMGi1pC/";
    string internal baseExt = ".json";

    constructor() ERC721A("GeoMint", "GeoMint") {
    }
    ...
    function ownerMintToUser(address user) external onlyDev {
        _mint(user, 1);
    }
