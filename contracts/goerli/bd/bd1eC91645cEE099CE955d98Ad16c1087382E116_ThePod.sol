    ...
    OperatorFilterer
{
    ...
    constructor(
        ...
        _thePass = ThePass(thePass_);

        _registerForOperatorFiltering();
        operatorFilteringEnabled = true;
    }

    function redeem(uint256 passTypeId, address to, uint256 amount) external {
        _thePass.burn(passTypeId, to, amount);
