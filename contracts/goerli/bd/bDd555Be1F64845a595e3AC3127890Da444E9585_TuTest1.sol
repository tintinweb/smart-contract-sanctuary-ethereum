...
contract TuTest1 is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(whitelistMintEnabled, 'Hold on a sec! The sale for Drivers is not enabled yet! Come back later... ; )');
    require(!whitelistClaimed[_msgSender()], 'Sorry :( You already minted your Car! Get another Tubular on OpenSea! ;)');
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    require(!paused, 'Cars are still at our Laboratories; check our Twitter @tubular_labs for announcements!');
