        ...
        for (y = 0; y <= 800; y += 100) {
            for (x = 0; x <= 800; x += 100) {
                ...
                if (PrimesUtils.isPrime(uint256(count))) {
                    string memory d = PrimesUtils.getPath(x, y);
...
library PrimesUtils {
    ...
    function getPath(
        ...
        return combinePathString(x, y, (x + 100), (y + 100), x);
    }
    ...
    function setMinValuesAnimation(
        ...
        if (x == 200 && y == 0) {
            return combinePathString(x, y, x + 50, y + 50, x);
        } else {
            if (x % 300 == 0) {
                if (y % 200 == 0) {
                    return
                        combinePathString(x + 50, y, x + 100, y + 50, x + 50);
                } else {
                    return
                        combinePathString(
                            x + 50,
                ...
                if (y % 200 == 0) {
                    ...
                    return combinePathString(x, y + 50, x + 50, y + 100, x);
                }
            }
        }
    }
    ...
    function setMaxValuesAnimation(
        ...
        if (x == 200 && y == 0) {
            return combineIntPathString(x, y, x + 150, y + 150, x);
        } else {
            if (x % 300 == 0) {
                if (y % 200 == 0) {
                    return
                        combineIntPathString(
                            x - 50,
                            y,
                            x + 100,
                            y + 150,
                ...
                if (y % 200 == 0) {
                    ...
                    return combineIntPathString(x, y - 50, x + 150, y + 100, x);
                }
            }
        }
    }
