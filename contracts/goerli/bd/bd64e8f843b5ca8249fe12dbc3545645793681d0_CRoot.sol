...
contract CChild is CrossChainEnabledPolygonChild, AccessControlCrossChain {
    ...
    function getEncodedSetNumberData(uint256 newNumber) external pure returns (bytes memory) {
        return abi.encodeWithSelector(CChild.setNumberForParentChain.selector, newNumber);
    }
...
contract CRoot is FxBaseRootTunnel {
