...
contract BluemoonNFTEvolution is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    function updateMetadata(uint256 _tokenId, string memory _tokenURI) public nonReentrant  {
