...
/**
 * @notice Implementation of the {ILockdropFactory} interface.
 */
contract LockdropFactory is ILockdropFactory, Accessible, TemplateDeployer {

    /**
     * @inheritdoc ILockdropFactory
     */
    bytes32 public constant override CREATE_ROLE = keccak256('Lockdrop.CREATE_ROLE');

    constructor(uint256 templateVersion)
    TemplateDeployer(bytes32('Lockdrop'), templateVersion) {}
    ...
    function create(
        ...
        ILockdrop(instance).initialize(index, asset, withdrawTo, dateConfig);

        emit LockdropCreated(index, asset, instance);
    }
}
...
library TemplateFactoryLibrary {
    ...
    ITemplateFactory internal constant FACTORY = ITemplateFactory(0x6b0b5956441E45F0769aD9d15C9F22dbBEA8B660);
