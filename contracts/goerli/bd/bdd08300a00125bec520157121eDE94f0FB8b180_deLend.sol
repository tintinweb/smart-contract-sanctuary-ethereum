...
contract deLend is Ownable {
    ...
    // errors
    error InsufficientAllowance(address tokenAddress, uint supplyAmount);
    error InsufficientBalance(uint balance, uint supplyAmount);
    ...
    function withdraw(
        ...
        if(_allowance<amountWithdrow){
            revert InsufficientAllowance({tokenAddress: aTokenAddress, supplyAmount: amountWithdrow});
        }
