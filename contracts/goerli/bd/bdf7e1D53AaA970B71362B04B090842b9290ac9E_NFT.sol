...
contract NFT is ERC721, PullPayment, ERC721URIStorage, Ownable, ERC721Enumerable {

    using Counters for Counters.Counter;
    uint256 public constant TOTAL_SUPPLY = 5000;
    Counters.Counter private currentTokenId;

    constructor() ERC721("ProfitOnWeed", "NFT") {}
    ...
    function mintNFT(address recipient, string memory uri) public payable returns (uint256) {
        uint256 tokenId = currentTokenId.current();
        require(tokenId < TOTAL_SUPPLY, "Max supply reached");
        require(msg.value >= 0.1 ether, "You sent not enough money to the contract");
