...
contract FULNFTMarketplace is UUPSUpgradeable,OwnableUpgradeable, ReentrancyGuard {
    ...
    function claimNFT(uint256 auctionId) public isValidAuctionId(auctionId) {
        ...
        if (auctions[auctionId].curBidder != address(0)) {
            ...
            IERC721(auctions[auctionId].NftContractAddress).transferFrom(address(this),winner, auctions[auctionId].NFTId);
            ...
            IERC721(auctions[auctionId].NftContractAddress).transferFrom( address(this), msg.sender, auctions[auctionId].NFTId);
        }
    }
