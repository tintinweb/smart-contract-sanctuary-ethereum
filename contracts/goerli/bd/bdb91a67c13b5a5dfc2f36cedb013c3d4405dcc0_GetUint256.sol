...
contract GetUint256 is ChainlinkClient, ConfirmedOwner {
    ...
    uint256 private immutable ORACLE_PAYMENT;
    string public url;
    string public path;
    int256 immutable multiply;
    ...
    constructor(
        ...
        ORACLE_PAYMENT = oraclePayment;
        jobId = jobId_;
    }

    // Should be set onlyOwner and set to the registry address as owner
