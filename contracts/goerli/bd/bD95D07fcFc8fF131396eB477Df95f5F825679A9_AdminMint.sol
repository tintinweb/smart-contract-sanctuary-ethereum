    ...
    Ownable
{
    ...
    function setTargetContract(address _address) external onlyOwner {
        _nft = CNPC(_address);
    }
}
...
contract CNPC is DefaultOperatorFilterer ,ERC2981, ERC721A, Ownable, AccessControl {
