...
import "../../contracts/archive/ExternalProxyCall.sol";

contract $ExternalProxyCall is ExternalProxyCall {
...
import "../../../contracts/archive/interfaces/IProxyCall.sol";

abstract contract $IProxyCall is IProxyCall {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";
