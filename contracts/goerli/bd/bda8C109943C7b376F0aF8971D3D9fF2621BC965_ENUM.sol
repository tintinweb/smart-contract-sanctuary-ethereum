...
contract ENUM is ERC721Upgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function makeReservation(
        ...
        reservations[_reserver] = _newReservationId;

        emit ReservationMade(_reserver, _newReservationId);
    ...
    function mintItem(
        ...
        require(
            reservations[_minter] > 0,
            "3NUM: Must have a reservation to mint"
        );

        require(
            verifyNumberSignature(_tokenId, reservations[_minter], _signature),
        ...
        emit TokenMinted(_minter, _tokenId, _pfpId);
