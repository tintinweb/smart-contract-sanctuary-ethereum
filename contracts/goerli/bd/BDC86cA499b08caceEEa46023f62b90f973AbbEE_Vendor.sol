...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    ...
    require(amountOfEth > 0, "You need to send some ETH to buy tokens");

    uint256 amountOfTokens = msg.value * tokensPerEth;

    //require(yourToken.balanceOf(address(this)) >= tokensBought, "There are not enough tokens to purchase");
