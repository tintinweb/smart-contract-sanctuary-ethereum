...
contract Staker {
  ...
  modifier notCompleted() {
    require(exampleExternalContract.completed() == false, 'Contract is already completed');
    require(openToWithdraw == false, 'Contract is already completed');
    _;
  }
  ...
  function withdraw() public returns (uint256) {
    ...
    require(openToWithdraw, 'Threshold was met');
