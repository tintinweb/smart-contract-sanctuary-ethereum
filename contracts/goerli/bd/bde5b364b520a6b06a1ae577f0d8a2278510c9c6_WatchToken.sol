...
contract WatchToken is ERC721, Ownable {
    ...
    // keccak256("Msg(firstName string, lastName string)");
    bytes32 public constant MSG_TYPEHASH =
        0x70c479ae1a1ad038a3e1f41bc96e6e7e0f06594d518da6eb6dd3e49cb0e2831a;
    ...
    function _checkSignature(
        ...
        bytes32 digest = keccak256(
            abi.encodePacked(
                ...
                DOMAIN_SEPARATOR,
                keccak256(
                    abi.encode(MSG_TYPEHASH, firstName, lastName, deadline)
                )
            )
        );
    ...
    function burn(
        ...
        _checkSignature(firstName, lastName, deadline, v, r, s);
        _burn(tokenId);
    }
