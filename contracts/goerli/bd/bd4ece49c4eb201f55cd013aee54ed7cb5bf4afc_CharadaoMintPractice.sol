...
contract CharadaoMintPractice is ERC1155, Ownable {
    ...
    string[] public baseURI = ["https://interactive-shikibu.s3.ap-northeast-3.amazonaws.com/metadata/1.json"];
    ...
    function mint(address to, uint256 id, uint256 amount) public onlySender{
        ...
        require(psMinted[msg.sender][id] < 20, "You have no mints remaining!");
