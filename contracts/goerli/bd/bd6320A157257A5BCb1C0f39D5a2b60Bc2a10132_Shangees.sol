...
contract Shangees is ERC721, ERC2981, Pausable, Ownable, ReentrancyGuard {
   ...
   // uint256 public ShenaniganCIGsPrice = 0.01 ether;   // <<----------------------------------------------- CIGs not ETH!!!
   ...
   uint96 public royaltyPercentage = 1000; // <<----- 10% !!!
...
//  ROYALTY FEES????????????????????????????????
   ...
   constructor() ERC721("ShangeesNFTs!", "SHANG") {   
