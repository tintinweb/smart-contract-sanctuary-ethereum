...
// @@@@@@@@@@@@@@@&PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
...
contract OCASnakeArt is Ownable, ReentrancyGuard {
        ...
        returns (string memory)
    {
        ...
        string[30] memory test = generateAllColors(tokenId);
        ...
        returns (string[30] memory)
    {
        ...
        uint256 rn = generateAppleSeed(tokenId, 420) % colors.length;

        string[30] memory result;
        for (uint256 i = 0; i < rn + 10; i++) {
            result[i] = colors[i];
        }
    ...
    function checkRandomNumber(uint256 tokenId, uint256 number)
        ...
        returns (uint256)
    {
        uint256 rn = generateAppleSeed(tokenId, 420) % number;
