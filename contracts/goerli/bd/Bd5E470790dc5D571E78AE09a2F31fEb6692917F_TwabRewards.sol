...
interface ITwabRewards {
     ...
     */
    function getRemainingRewards(uint256 _promotionId)
        external
        view
        returns (uint256);
...
contract TwabRewards is Initializable, ITwabRewards {
    ...
    function __TwabRewards_init_unchained(ITicket _ticket)
        internal
        onlyInitializing
    {
     ...
     * @param _promotion Promotion to check
     */
    function _requirePromotionCreator(Promotion memory _promotion)
        internal
        view
    {
        require(
     ...
     * @return Amount of tokens left to be rewarded
     */
    function _getRemainingRewards(Promotion memory _promotion)
        internal
        view
        returns (uint256)
    {
