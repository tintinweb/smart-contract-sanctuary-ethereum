 ...
 * @notice This contract handles minting The Vile tokens.
 */
contract LaunchpadTheVile is
    ReentrancyGuard,
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xbdd134f0c0eF32b98267a5014bB83f321Df1c559;
    address public royaltyAddress = 0x705601B211776c2B694Ff67ec0893a7882bFF844;
    // Used to allow transferring soulbound tokens with admin privileges
    address public soulboundAdminAddress =
        0xBd55bC8a91d9A35726ac702Ee5668800D5Afb599;
    ...
    string public baseTokenURI =
        "ipfs://bafybeiac3wd3ohgdjvvcky3iu5pfh2yebvnfcopole7kke5g32iy7cuvqq/";
    ...
    uint256[] public payoutPercentages = [15, 6, 15, 64];
    // Array of all soulbound token ids
    uint256[] public soulboundTokens;
    uint96 public royaltyFee = 555;

    constructor() ERC721A("The Vile", "VILE") {
