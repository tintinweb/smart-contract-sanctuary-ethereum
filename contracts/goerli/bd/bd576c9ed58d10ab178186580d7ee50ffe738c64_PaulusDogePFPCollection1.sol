...
contract PaulusDogePFPCollection1 is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    constructor() ERC721("yay, a p. d. pfp", "PPFPt5")
    {
    }
    ...
    {
        require(ownerOf(tokenId) == msg.sender, "You can only do this for tokens that are yours!");
