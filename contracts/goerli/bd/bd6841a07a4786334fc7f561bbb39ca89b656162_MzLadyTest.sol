...
// File: contracts/imzlady_test.sol


pragma solidity ^0.8.2;


interface IMzLadyTest is IERC1155 {
...
// File: contracts/mzlady_test.sol
...
contract MzLadyTest is ERC1155, AccessControl, DefaultOperatorFilterer, ReentrancyGuard {
    using Strings for uint256;
    ...
    function presaleMint(uint256 _typeId, uint256 _quantity) public payable nonReentrant {
        ...
        require(_typeId == currentTokenId, "Wrong Token ID");
        require(msg.value >= (_quantity * presalePrice), "Not enough ether sent");
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155, AccessControl) returns (bool) {
        return interfaceId == type(IMzLadyTest).interfaceId || super.supportsInterface(interfaceId);
    }
