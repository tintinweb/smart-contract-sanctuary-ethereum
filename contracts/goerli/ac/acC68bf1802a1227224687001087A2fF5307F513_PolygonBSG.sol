...
contract PolygonBSG {
    ...
    uint256 private constant minTransferAmount = 1e6; //$10
    uint256 private constant minDeposit = 10e6; //$100
    uint256 private constant maxDeposit = 250e6; //$2500
    uint256 private constant freezeIncomePercents = 2000;
    uint256 private constant freezeIncomePercents1 = 3000;
    uint256 private constant LuckDeposit = 100e6; //$2500
    ...
    function _deposit(address _user, uint256 amount) private {
