...
/*Vlin NFT-ERC721 */
contract VlinNFT is ERC721URIStorage, ERC2981, Ownable {
    ...
    constructor(
        ...
        require(_royaltyFee <= 1000, "can't more than 10 percent");
        require(_royaltyRecipient != address(0),"Must provide an address");
