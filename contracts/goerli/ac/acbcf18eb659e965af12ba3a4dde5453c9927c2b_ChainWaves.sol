...
contract ChainWaves is ERC721, Owned {
        ...
        Owned(0x9ea04B953640223dbb8098ee89C28E7a3B448858)
    {
        ...
        //Palette
        TIERS[0] = [1500, 2000, 2000, 3000, 1000, 500];
        //Noise
        TIERS[1] = [1000, 4000, 4000, 1000];
        //Speed
        TIERS[2] = [1000, 4000, 4000, 100];
        //Char set
...
contract ChainWavesGenerator {
    ...
    constructor() {
        ...
        PALETTES[4] = ["009638", "F6D800", "002672"];
        PALETTES[5] = ["23B024", "F02423", "294AF6"];
        ...
        returns (string memory _svg)
    {
        ...
        uint256 speed = tokenTraits.speed;
        ...
        _svg = string(
            abi.encodePacked(
                ...
                AnonymiceLibrary.toString(speed),
