...
contract AdSpaceFactory is ERC721Holder, Ownable {
    ...
    constructor(address tablelandAddress) {
        ...
        string memory sqlAdSpace = string.concat(
            ...
            " (adspace_id AUTOINCREMENT PRIMARY KEY UNIQUE,name TEXT, website TEXT, verified INTEGER, status TEXT, owner TEXT, contract TEXT, asking_price INTEGER, size TEXT);"
        );
        ...
        string memory sqlCampaign = string.concat(
            ...
            "_",
            Strings.toString(block.chainid),
            " (campaign_id AUTOINCREMENT PRIMARY KEY UNIQUE, cid TEXT, size TEXT, link TEXT);"
        );
        ...
        string memory sqlDeal = string.concat(
            ...
            "_",
            Strings.toString(block.chainid),
            " (deal_id AUTOINCREMENT PRIMARY KEY UNIQUE, campaign_id_fk INTEGER, adspace_id_fk INTEGER, duration_deal INTEGER, price INTEGER, started_at INTEGER);"
        );
