...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.12 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiakuhe7dl2rozbnaufurl7kqivfbxpvcv2kbpuc74rn7bfovq5dha/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/a1Hm6hTJU1y6q9hcvi8W/contract-metadata";
  }
...
contract BellyJeansContract is ERC721APlus {
    constructor() ERC721APlus("BellyJeans", "BJEANS"){}
}
  /*******************************************************/
  /*                                                     */
