...
//                                                 ................
/**
* Crypta Contribution Proof
* 100% Utility token. 
* It can't be bought.
* It can only be earned by contributing to the Crypta Network.
*/
contract CryptaContributionProofToken is ERC20Votes, Ownable, ReentrancyGuard {
    address private signer;
    address public vault;
    uint256 immutable internal MAX_SUPPLY = 1_000_000_000 * 10 ** 18;

    mapping(string => bool) private _claimed;
    event Received(address indexed sender, uint256 value);

    constructor() ERC20Permit("CryptaContributionProof") ERC20("CryptaContributionProof", "KUDOS") {
    }
