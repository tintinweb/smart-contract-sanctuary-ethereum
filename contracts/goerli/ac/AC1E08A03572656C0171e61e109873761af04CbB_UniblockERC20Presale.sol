...
contract UniblockERC20Presale is Initializable, AccessControl, IUniblockProxy {
    ...
    /**
     * Emitted when the presale gets configured.
     *
    ...
    /**
     * Emitted when a payment method gets modified.
     *
    ...
    /**
     * Emitted when a buyer withdraws their allotted presale tokens.
     *
    ...
    /**
     * Emitted when a the owner withdraws any token.
     *
     * @param receiver the receiver of the withdrawn tokens
    ...
    /**
     * Emitted when an address gets added to the whitelist.
     *
    ...
    /**
     * Emitted when an address gets removed from the whitelist.
     *
    ...
    /**
     * When a provided address is the zero address when it should not be.
     */
    ...
    /// reverts WhitelistNotEnabled error if whitelist is not enabled.
    ...
    function getPurchasedAmount(address _address)
        ...
        returns (uint256)
    {
        return purchasedTokens[_address];
    }
    ...
    /**
     * Function to read accepted payment methods
     *
     * @return address[] The list of payment methods
     */
    function getPaymentMethods() public view returns (address[] memory) {
    ...
    /**
     * Function to change the payment receiver
     *
    ...
    /**
     * Function to both buy and withdraw presale tokens
     *
