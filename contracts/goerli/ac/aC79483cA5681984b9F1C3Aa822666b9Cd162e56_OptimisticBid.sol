    ...
    SafeSend
{
    ...
    function end(address _vault, bytes32[] calldata _burnProof) external nonReentrant {
        ...
        // Sets auction state to successful
    ...
    function withdrawERC20(
        ...
        _verifyVault(_vault);
        // Reverts if auction state is not successful
        uint256 auctionId = _verifySuccess(_vault);
    ...
    function batchWithdrawERC1155(
        ...
        if (msg.sender != proposer) revert NotProposer(proposer, msg.sender);
