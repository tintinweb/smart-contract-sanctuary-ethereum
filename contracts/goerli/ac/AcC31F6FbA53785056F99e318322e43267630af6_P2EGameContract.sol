    ...
    function withdrawToken(uint256 amount) public   {
       ...
       payable(account).transfer(toPlayer);
        ...
        if(once == true){
            ...
            if(keccak256(abi.encodePacked(isWithdrawed)) == keccak256(abi.encodePacked("yes"))){


            }
            if(keccak256(abi.encodePacked(isWithdrawed)) == keccak256(abi.encodePacked("no"))){
