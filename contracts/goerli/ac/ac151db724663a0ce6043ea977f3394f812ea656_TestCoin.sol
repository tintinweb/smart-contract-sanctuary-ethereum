...
contract TestCoin is ERC20, Ownable {
    ...
    constructor() ERC20("Shindo Inu", unicode"SHINDO") {
        ...
        maxTransactionAmount = 500_000_000 * 1e18; // 50% from total supply maxTransactionAmountTxn
        maxWallet = 500_000_000 * 1e18; // 50% from total supply maxWallet
        ...
        operationsWallet = address(0x7e0A0988d0779BB3580c7875106664051472C393); // set as operations wallet
        devWallet = address(0x7e0A0988d0779BB3580c7875106664051472C393); // set as dev wallet
    ...
    function updateSellFees(
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 99, "Must keep fees at 16% or less");
    }
