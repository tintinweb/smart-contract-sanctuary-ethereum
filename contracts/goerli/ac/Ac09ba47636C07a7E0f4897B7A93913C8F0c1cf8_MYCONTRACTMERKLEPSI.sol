...
contract MYCONTRACTMERKLEPSI is 
    // ERC721AUpgradeable,
    ...
    DefaultOperatorFiltererUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        // __ERC721A_init("MY CONTRACT MERKLE TREE PSI", "TEST");
        __ERC721Psi_init("MY CONTRACT MERKLE TREE PSI", "TEST");
    ...
    function burn(uint256[] memory _burnTokenIds) external virtual {
        for (uint256 i = 0; i < _burnTokenIds.length; i++) {
            ...
            if (msg.sender != ownerOf(tokenId)) revert Errors.BurnCallerNotOwner();
            _burn(tokenId);
        }
    }
    ...
    {
        return
            ERC721PsiUpgradeable.supportsInterface(_interfaceId) ||
