...
contract Web3Builders is ERC1155, Ownable, Pausable, ERC1155Supply {
    ...
    // give us a to activate and deactivate the whitelist 
    // store whitelist data
    // cehck if you are on the whitelist in the mint function

    mapping (address => bool) public whiteList;
    // uint256[] public maxSupply = [100, 3, 20] 
    // uint256[] public price = [0.2 ether, 0.3 ether, 0.1 ether] 

    constructor()
        ERC1155("ipfs://Qmc6YyYUMdwEjBkdHpzYq7TGYngibBH3QETrFVmyEunCrq/")
    {}
    ...
    */
        ...
        payable
    {
        ...
        if(whiteListActive) {
            // require that you must in the whitelist
            require(whiteList[msg.sender], "Not on the whitelist");
        }
        // apply a require rul if whitelist active
        require(msg.value >= amount * 0.01 ether, "I NEED MORE MONEY");
        require(totalSupply(id) + amount <= maxSupply, "We have reached the limt");
