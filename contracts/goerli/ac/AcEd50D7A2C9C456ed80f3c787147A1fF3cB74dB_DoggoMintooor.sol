...
contract DoggoMintooor is ERC721, Ownable, Pausable {
    struct metadata {
        string url;
    }
    ...
    constructor() ERC721("DoggoMintooor", "DM") {
        // Set up splitter addresses
        // TODO: Replace with final addresses
        address[] memory addresses = new address[](7);
        addresses[0] = 0x3eAB9C85718df9454aA7A1ca6BC765Bcee361617;
        addresses[1] = 0xac391c87d125d55cf67a9EbAFB338a440742D74E;
        addresses[2] = 0xd409aEB3191c5a50208Fb43eA45D1668805686De;
        addresses[3] = 0x8fDb80E7DEB0429A2fEA2025Daa4628D5978219A;
        addresses[4] = 0x46d29A3646B5f57d146B9910ae20DA0dCC45b6CE;
        addresses[5] = 0x301B491f10C05aD85c6852e5B3F2FF557782DD41;
        addresses[6] = 0xd3D95E122999435A2D6EBF6Fde4525a987eE3E20;
