...
//                                                                                               //
//                                                                                               //
//     _______  ______    _______  __   __  __   __  ______                                      //
//    |   _   ||    _ |  |       ||  | |  ||  | |  ||    _ |                                     //
//    |  |_|  ||   | ||  |_     _||  |_|  ||  | |  ||   | ||                                     //
//    |       ||   |_||_   |   |  |       ||  |_|  ||   |_||_                                    //
//    |       ||    __  |  |   |  |       ||       ||    __  |                                   //
//    |   _   ||   |  | |  |   |  |   _   ||       ||   |  | |                                   //
//    |__| |__||___|  |_|  |___|  |__| |__||_______||___|  |_|                                   //
//     _______  _______  ___      _______  ______    _______  __   __  ___                       //
//    |       ||       ||   |    |       ||    _ |  |       ||  | |  ||   |                      //
//    |       ||   _   ||   |    |   _   ||   | ||  |    ___||  | |  ||   |                      //
//    |       ||  | |  ||   |    |  | |  ||   |_||_ |   |___ |  |_|  ||   |                      //
//    |      _||  |_|  ||   |___ |  |_|  ||    __  ||    ___||       ||   |___                   //
//    |     |_ |       ||       ||       ||   |  | ||   |    |       ||       |                  //
//    |_______||_______||_______||_______||___|  |_||___|    |_______||_______|                  //
...
contract CL is ERC1155Creator {
    constructor() ERC1155Creator("Colorful Lion", "CL") {}
}
