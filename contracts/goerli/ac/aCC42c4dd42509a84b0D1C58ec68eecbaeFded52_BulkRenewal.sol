...
contract BulkRenewal {
    bytes32 constant private ETM_NAMEHASH = 0x05e9490b78296b2df84ef5739c668cb68da84d64d9cc46c8167decfc81072e64 ;
    ...
    function getController() internal view returns(ETHRegistrarController) {
        ...
        Resolver r = Resolver(ens.resolver(ETM_NAMEHASH));
        return ETHRegistrarController(r.interfaceImplementer(ETM_NAMEHASH, REGISTRAR_CONTROLLER_ID));
    }
