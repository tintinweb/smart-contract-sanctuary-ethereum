...
// contract by yangbok ([email protected])
 ...
 */
contract BishojoPassERC721A is  ERC721A, ERC721AQueryable, Pausable, Ownable, ReentrancyGuard, ERC2981, DefaultOperatorFilterer {
    mapping(address => bool) public mintClaimed;
    
    bool public operatorFilteringEnabled = true;
    // The time at which the token can be transferred or approved.
    bool private SBTMode = true;

    uint256 public constant MAX_SUPPLY = 690;
    uint256 public constant MINT_PER_WALLET = 1;

    string public baseURI = "";
    string public prerevealURI = "https://bafkreid4mge5zt7cjsfucrnqgemjht363puv7xwnzws42zbx26kuha4p5i.ipfs.nftstorage.link";
    ...
    constructor(address _defender) ERC721A("BishojoPass", "BSP") {
    ...
    function mint(bytes32 hash, bytes memory signature) public whenNotPaused nonReentrant {
        ...
        // require (MerkleProof.verify(merkleProof, merkleRoot, keccak256(abi.encodePacked(msg.sender))), "Sender address is not in allowlist");
