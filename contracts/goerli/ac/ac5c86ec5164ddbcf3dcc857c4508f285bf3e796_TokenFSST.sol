...
contract TokenFSST is OwnableUpgradeable, ERC20PresetFixedSupplyUpgradeable {
    uint256 public constant MAX_SUPPLY = 10 * 10e9 ether;
    uint8 public constant DECIMALS_DECENT = 18;
    ...
    function initialize(address _saleAddress) external initializer {
        salesAddress = _saleAddress;
        __Ownable_init();
        __ERC20PresetFixedSupply_init("First Swiss Trust", "FSST", MAX_SUPPLY, salesAddress);
