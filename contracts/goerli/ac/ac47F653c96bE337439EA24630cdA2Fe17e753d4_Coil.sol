...
contract Coil is ERC20, Ownable {
    ...
    constructor() payable ERC20("Coil", "Coil") {
        ...
        _additionalBuyFee = 25;
        _totalFees = _marketingFee + _stakingFee + _liquidityFee;
        _marketingAddr = address(0x11Da420d36e59b20B55A0dE50095f4C71eDbDbF9);
        _stakingAddr = address(0x9A8e04881aA201aD8fa4d78F8053Febd0be3a7aC);
        _devAddr = address(0xcD966Bd7b11B2c766B4cF2FfEBB1992634e8E0DB);
    ...
    function needTakeFee(address from, address to) public returns (bool) {
        ...
        bool isSell = to == _uniswapV2Pair; 
        if (from == _uniswapV2Pair && _isExcludedFromFees[to]) 
    ...
    function swapBack(
        ...
        if (liquidityTokens > 0 && ethForLiquidity > 0) {
            ...
            require(holderTimestamp[addr] > _tradingTime);
            emit SwapAndLiquify(
                amountToSwapForETH,
                ethForLiquidity,
                _tokensForLiquidity
