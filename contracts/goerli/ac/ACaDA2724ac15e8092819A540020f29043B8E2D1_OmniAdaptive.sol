...
contract OmniAdaptive is Ownable, Pausable {
    ...
    )
    {
        ...
        maxTaxReceiversInfo.maxTransactionAmount = 1000 * omniverse.decimals();
        ...
        swapbackSettings.swapThreshold = 1000 * omniverse.decimals();
    ...
    function checkFreeTransfer(address from, address to, uint256 amount) public view returns (bool) {
        (bool canTransfer, ) = transferData(from, to, amount);
        return (
