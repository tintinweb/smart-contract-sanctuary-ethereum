...
// import nitro AddressAliasHelper
...
contract Swaper {
    ...
    function swapExactInputSingle(address input, address output, uint256 amountIn, address recipient) external returns (uint256 amountOut) {
        // require that the address deployed is the alias of the L1 address
...
contract Bridge {
    ...
    function sendAndSwap(
        ...
        // hard code swap target
        // change params for L2 token addresses
        IL1_Bridge(l1Bridge).sendToL2(
