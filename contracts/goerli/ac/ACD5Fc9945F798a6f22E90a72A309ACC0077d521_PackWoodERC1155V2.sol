...
contract PackWoodERC1155V2 is ERC1155Upgradeable, OwnableUpgradeable {
    ...
    function updateChildAddress(address _address)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function updatePriceFeedAddress(address _address)
        external
        onlyOwner
    {
        ethUsdPriceFeed = AggregatorV3Interface(_address);
    }
    ...
    function conversionUsdEth(uint256 _amount)
        public
        view
        virtual
        returns (uint256 Price)
    {
        ...
        Price = ((100000000 * _amount) / uint256(price)) * (10**10);
    }
        ...
        returns (bool)
    {
        ...
        require(
            conversionUsdEth(tokenPrice) * amount == msg.value,
     ...
     * - bool.
     *
     * Emits a {crossmintTokenDetails} event.
     */
    ...
    function mintTo(
        ...
        require(
            conversionUsdEth(tokenPrice) * _count == msg.value,
            "PackWoodERC1155: Price is incorrect"
        );
