...
contract UpStake is Pausable {
    ...
    function addCase(Case memory theCase) public isSuperOperator whenNotPaused returns (uint256) {
        ...
        emit caseAdded(newId, theCase.Name, theCase.TokenSymbol, theCase.SupplyTotal, theCase.APR);
        return newId;
    }
    ...
    function setCaseLimits(uint256 caseId, uint256 min, uint256 max) public isSuperOperator whenNotPaused {
        require(
        ...
        emit caseLimitsSet(caseId, min, max);
    }
