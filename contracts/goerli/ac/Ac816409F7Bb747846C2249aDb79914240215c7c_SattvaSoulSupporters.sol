    ...
    IERC4906
{
    ...
    // Royalty
    address public royaltyAddress = 0x14145DDf324BC975Ee621044D662739d9A6EDe96;
    ...
    // Mapping tokenId to spiritualityState
    // Bits layout:
    // - [  0..127]  `spiritualityState`
    // - [128..255]  `sadhanaTime`
    mapping(uint256 => uint256) public spiritualityStateEachToken;
    uint256 public currentSpiritualityState = 2;
    uint256 public sadhanaTime = 1;
    ...
    function sadhana(uint256 _tokenId)
        ...
        onlyRole(SADHANA)
    {
        spiritualityStateEachToken[_tokenId] = spiritualityStateEachToken[_tokenId].set128(0, currentSpiritualityState);
        spiritualityStateEachToken[_tokenId] = spiritualityStateEachToken[_tokenId].set128(1, sadhanaTime);
    }
        ...
        returns (uint256, string memory)
    {
        return
            (
                spiritualityStateEachToken[_tokenId].get128(0),
                spiritualityPhase[spiritualityStateEachToken[_tokenId].get128(0)]
            );
    }
    ...
    function getTokenSadhanaTime(uint256 _tokenId)
        ...
        returns (uint256)
    {
        return spiritualityStateEachToken[_tokenId].get128(1);
    }
        ...
        returns (string memory)
    {
        if(useInterfaceMetadata == true) {
            ...
            if(spiritualityStateEachToken[_tokenId].get128(1) >= sadhanaTime) {
