...
contract SD is ERC1155Burnable, Ownable, DefaultOperatorFilterer {
    ...
    function addMint(uint256 _tokenId, uint256 _amount) public {
        require(
            !finalize[_tokenId],
    ...
    function tokenFinalize(uint256 _tokenId) external {
