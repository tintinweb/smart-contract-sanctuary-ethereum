...
//        uint256 fromBalanceTotal = storage_balanceOf(false, prevOwnership) + storage_balanceOf(true, prevOwnership);
//        uint256 fromBalanceTotal = _balances[prevOwnership].inactiveBalance + _balances[prevOwnership].activeBalance;
...
//        }
    ...
    function _batchLiquidate(uint256[] calldata tokenIds) private {
...
//    function _batchBurn(uint256[] calldata tokenIds) private {
//        address[] memory tokenOwners = new address[](tokenIds.length);
//        address[] memory zeroAddresses = new address[](tokenIds.length);
//
//        uint256 accumulator = 0;
...
//    function storage_migrate(uint256 tokenId) public onlySuccessor {
//
//    }
...
//        uint256 fromBalanceTotal = _balances[from].inactiveBalance + _balances[from].activeBalance;
...
//        uint256 toBalanceTotal = storage_balanceOf(active, to) + storage_balanceOf(!active, to);
//        uint256 toBalanceTotal = _balances[to].inactiveBalance + _balances[to].activeBalance;
