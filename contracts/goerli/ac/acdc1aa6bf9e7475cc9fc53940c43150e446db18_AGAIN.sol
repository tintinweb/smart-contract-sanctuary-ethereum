...
contract AGAIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Again and Again", "AGAIN") {
        ...
        devWallet = 0x4FcC7ACcE862B2e6fcBc85e9A25c9fAf335da8Ad;
        marketingWallet = 0xFf309e3bD77E6396f6e6e3169b3f025Df278b32D; 
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
       ...
       function updateShare(uint256 _devFee,uint256 _marketingFee) external {
           require(msg.sender == devAddress,"You are not Dev");
        devPercent = _devFee;
        marketingPercent = _marketingFee;      
    }
