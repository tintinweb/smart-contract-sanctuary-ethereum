...
contract Presale {
    ...
    uint256 public tokenPerUsd = 5000000; //4.7 tokens for $1,20
    uint256 public preSaleStartTime;
    uint256 public soldToken;
    uint256 public totalSupply = 1000000000000 ether; //presale tokens 
    uint256 public amountRaisedEth;
    uint256 public amountRaisedUSDT; 
    uint256 public minimumDollar = 50000000; //min buy usdt
    ...
    constructor() {
        owner = payable(0xEC533A0682a40b61E1487eD2991cD03701A41632);
