...
contract JSSNUNFT is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 25;
    ...
    constructor() ERC721("JSSNUNFT", "JSSNU") {
        baseUri = "ipfs://bafybeiflktpkv2yr2kmkx3b2rbfeda3ljnw75mnhsufufzwbr3f4psxvze";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transfer, ) = payable(0x7Ed1Af0cB236B6cBd31d2255F14515a90D55EC72).call{value: balance}("");
