...
contract BlueCreators is Ownable, PaymentSplitter {
    ...
    **/
    function individualSubscribe(string calldata discord_user_id, Version version, uint month, string calldata code) external payable {
    ...
    * @param month The amount of month for the subscription plan
    **/
    function communitySubscribe(string calldata discord_guild_id, Version version, uint month) external payable {
        if(tx.origin != msg.sender) revert CallerIsContractError();
