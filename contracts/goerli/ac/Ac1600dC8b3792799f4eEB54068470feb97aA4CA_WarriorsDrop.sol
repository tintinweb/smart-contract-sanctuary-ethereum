...
contract WarriorsDrop is Ownable, Pausable, ReentrancyGuard {
    ...
    function verify(
        ...
        console.log(string(abi.encodePacked(messageHash)));
        address addrRecovered = messageHash.toEthSignedMessageHash().recover(signature);
    ...
    function airdropMT(
        ...
        require(verify(addr, allocations, nonce, signature, isGen0), 'Invalid signature');
