...
contract MLootMarket is Ownable, Pausable {
    ...
    function matchTransaction(
        ...
        IBlackList list = IBlackList(blacklist);
        require(list.getTokenId(addresses[1],values[0]) < block.timestamp, "TokenId in blacklist");
