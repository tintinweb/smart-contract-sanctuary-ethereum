...
abstract contract GuildOracle is Initializable, ChainlinkClient {
    using Chainlink for Chainlink.Request;
    ...
    /// @notice Sets some of the oracle's details.
    /// @dev These are immutable values, but they should be upgrade-safe.
    ...
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor(bytes32 jobId_, uint256 oracleFee_) {
        jobId = jobId_;
    ...
    /// @param oracleAddress The address of the oracle processing the requests.
    // solhint-disable-next-line func-name-mixedcase
    function __GuildOracle_init(address linkToken, address oracleAddress) internal onlyInitializing {
