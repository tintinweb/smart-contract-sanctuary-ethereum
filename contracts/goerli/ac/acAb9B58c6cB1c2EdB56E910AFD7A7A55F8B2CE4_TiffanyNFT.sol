...
pragma solidity ^0.8.0;
contract TiffanyNFT is Ownable, ERC721, IERC2981, ReentrancyGuard {
    using Address for address;
    using Strings for uint256;
    ...
    constructor(ENS _ens, address _feeReceiver, uint256 _mintStartTime, string memory _baseTokenURI) 
    ...
    function mint(string calldata label) external nonReentrant {
        ...
        bytes32 node = _makeNode(PARENT_NODE, keccak256(bytes(label)));
