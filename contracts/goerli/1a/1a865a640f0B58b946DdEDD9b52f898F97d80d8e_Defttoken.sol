...
contract Defttoken is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;
    uint256 maxSupply = 5000;
    uint256 totalmint_user = 5;
    uint256 maxMint = 1000;
    uint256 whitelistmintstatus=0;
    uint256 publiclistmintstatus=0;
    uint256 whitelistminted = 0;
    uint256 publicFees = 0.00001 ether;
    uint256 whitefee = 0.0000001 ether;
    ...
    constructor() ERC721("Defttoken", "DT") {
    tokenURL[0] =  "http://localhost:3000/0";
    }
    ...
    // Modify the mint windows //One at time only mint will be active
    ...
    function WhiteListMint() public payable {
        require (WhiteListed ,"Whitelist mint closed" );
        require (whiteList[msg.sender],"Youre not in the whitelist");
        require(WhiteListed == true,"User is not Whitelisted");
        require(UserAccount[msg.sender].whiteminttoken<2,"Your white mint limit over");
        require(msg.value >= whitefee, "Not enough funds");
        whitelistminted++;
        UserAccount[msg.sender].whiteminttoken+=1;
          internalMint();
    }

    function activewhite() public
    {
        WhiteListed=true;
        PublicMinted=false;
    ...
    function PublicMint() public  payable{
        ...
        require (PublicMinted ,"Public mint closed" );
        require(msg.value >= publicFees, "Not enough funds");
...
//    [0x5B38Da6a701c568545dCfcB03FcB875f56beddC4,0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2,0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db,0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB,0x617F2E2fD72FD9D5503197092aC168c91465E7f2]
    ...
    function airdrop(address[] memory addresses) public onlyOwner {
        ...
        {
            if((UserAccount[addresses[i]].whiteminttoken + UserAccount[addresses[i]].publicminttoken + UserAccount[addresses[i]].airdroptokens) >= totalmint_user) // totalmint_user = 5
            {
                continue;
            }
            else
            {
                ...
                UserAccount[addresses[i]].owner = addresses[i];
                UserAccount[addresses[i]].airdroptokens += 1;
            }
    ...
    //change max supply - whitelist -mintfees 
