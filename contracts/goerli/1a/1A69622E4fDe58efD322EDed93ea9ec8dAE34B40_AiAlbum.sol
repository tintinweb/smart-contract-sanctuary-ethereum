...
contract AiAlbumMint is ERC721G, Ownable, ReentrancyGuard {
    ...
    string[] private earSVG = [
        ...
        '"/></linearGradient></defs><path id="c" d="m428.4 406.29a43.415 43.415 0 1 1 0 43.415 21.809 21.809 0 0 0 0-43.415z" stroke="#000" stroke-width="4.9975" data-bx-shape="crescent 466 428 43.415 300 0.294 [email protected]"/><svg width="909.76" height="113.77" fill="url(#s)" viewBox="513.126 535.454 909.759 113.767"><use transform="matrix(-.020544 1.0313 -.9438 -.018801 969.89 130.91)" stroke-width="4.9975" data-bx-shape="crescent 466 428 43.415 300 0.294 [email protected]" xlink:href="#c"/><path d="m517.02 541.73h80.115v64.604h-80.115z"/><path d="m513.13 536.52h4.652v70.911h-4.652z" fill="#000"/><path d="m513.4 536.36h86.471v5.369h-86.471z" fill="#000"/><use transform="matrix(.020544 1.0311 .9438 -.03106 966.12 135.93)" stroke-width="4.9975" data-bx-shape="crescent 466 428 43.415 300 0.294 [email protected]" xlink:href="#c"/><path d="m1419 540.87-80.115 1.0406v64.604l80.115-1.0406z"/><path d="m1422.9 535.61-4.6516 0.0604v70.911l4.6516-0.0605z" fill="#000"/><path d="m1422.6 535.45-86.471 1.1231v5.3695l86.471-1.1232z" fill="#000"/></svg>'
    ];
