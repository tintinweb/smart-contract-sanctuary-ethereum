...
contract Asset is ERC721, Mintable, Registration {
    constructor(
        address _owner,
        string memory _name,
        string memory _symbol,
        address _imx,
        IMX _imx_registration
    ) ERC721(_name, _symbol) Mintable(_owner, _imx) Registration(_imx_registration) {}
...
contract Registration {
    IMX public _imx_registration;

    constructor(IMX _imx) {
        _imx_registration = _imx;
    }
    ...
    function registerAndDeposit(
        ...
        _imx_registration.registerUser(ethKey, starkKey, signature);
        // the standard way to write this is: _imx_registration.deposit.value(msg.value)(starkKey, assetType, vaultId);
        // but the Solidity compiler hates the overloading of deposit + the use of .value()
        (bool success, ) = address(_imx_registration).call{value: msg.value}(
    ...
    function registerAndDeposit(
        ...
        _imx_registration.registerUser(ethKey, starkKey, signature);
        _imx_registration.deposit(starkKey, assetType, vaultId, quantizedAmount);
    }
    ...
    function registerAndDepositNft(
        ...
        _imx_registration.registerUser(ethKey, starkKey, signature);
        _imx_registration.depositNft(starkKey, assetType, vaultId, tokenId);
    }
    ...
    function registerAndWithdraw(
        ...
        _imx_registration.registerUser(ethKey, starkKey, signature);
        _imx_registration.withdraw(starkKey, assetType);
    }
    ...
    function registerAndWithdrawTo(
        ...
        _imx_registration.registerUser(ethKey, starkKey, signature);
        _imx_registration.withdrawTo(starkKey, assetType, recipient);
    }
    ...
    function registerAndWithdrawNft(
        ...
        _imx_registration.registerUser(ethKey, starkKey, signature);
        _imx_registration.withdrawNft(starkKey, assetType, tokenId);
    }
    ...
    function registerAndWithdrawNftTo(
        ...
        _imx_registration.registerUser(ethKey, starkKey, signature);
        _imx_registration.withdrawNftTo(starkKey, assetType, tokenId, recipient);
    }
    ...
    function regsiterAndWithdrawAndMint(
        ...
        _imx_registration.registerUser(ethKey, starkKey, signature);
        _imx_registration.withdrawAndMint(starkKey, assetType, mintingBlob);
    }

    function isRegistered(uint256 starkKey) public view returns (bool) {
        return _imx_registration.getEthKey(starkKey) != address(0);
    }
}
