...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 private _tFeeTotal; // only for reflection
    ...
    address payable private _marketingAddress =
        payable(0xC80076ce8034066a155583874701DA9b223AbF4a); //updated
    ...
    uint256 public _maxTxAmount = 10000 * 10**18; // 1%
    uint256 public _maxWalletSize = 20000 * 10**18; // 2%
    ...
    uint256 twentyprocent = 2000000000000;
    ...
    constructor() {
        ...
        _tokenTransfer(msg.sender, _marketingAddress, _totalSupply / 5, false); // only ran once
