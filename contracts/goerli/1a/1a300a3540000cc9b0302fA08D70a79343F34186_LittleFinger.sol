...
contract LittleFinger is ERC721URIStorage, Ownable, ReentrancyGuard{
    ...
    **/
    ...
    constructor(string memory _baseURI, string memory collectionURI) ERC721("LittleFinger", "NFT") {
        setBaseURI(_baseURI);
