...
contract wagmiRenderer is IwagmiRenderer, Ownable, AccessControl {
    /* Constants */
    bytes32 private constant CAN_STYLE = keccak256("CAN_STYLE");

    string private constant tokenUriStart = "{ \"name\": \"say wagmi #";
    string private constant tokenUriSeparator = " , ";
    string private constant tokenUriImage = "\"image\": ";
    string private constant tokenUriEnd = "}";
    string private constant description = "\"description\":\"Saying WAGMI to ETH one address at a time. By icebear_the_artist.\"";
    ...
    function generateAddressText(uint16 tokenId) private view returns (string memory) {
        ...
        string memory wagmiStart = "\"><tspan class=\"";
        string memory wagmiEnd = "\">wagmi</tspan> <tspan>";
        ...
        for (uint16 i = 0; i < addressArr.length; i++) {
            ...
            result = abi.encodePacked(
                ...
                Strings.toString(i),
                wagmiStart,
                getWagmiClass(substring(addressAtIndex,2,8)),
                wagmiEnd,
                addressAtIndex,
                end
            );
    ...
    function getWagmiClass(string memory hexNum) private pure returns (string memory) {
