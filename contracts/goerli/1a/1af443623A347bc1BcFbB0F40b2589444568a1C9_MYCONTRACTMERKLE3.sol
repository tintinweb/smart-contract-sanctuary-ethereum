...
contract MYCONTRACTMERKLE3 is Initializable, OwnableUpgradeable, ERC721AQueryableUpgradeable, ERC721ABurnableUpgradeable {  //, DefaultOperatorFilterer
    ...
    function preMint(
        ...
        if(!(salePhase == 1 || salePhase == 2 || salePhase == 3 || salePhase == 4)) revert PresaleIsNotActive();      //フェーズ１−３の間のみ許可
    ...
    function withdraw() external onlyTeam {
        ...
        address adrs1 = payable(0x9e81fd993203113AebD886707D8E8c21dDe939c6);
        address adrs2 = payable(0x9e81fd993203113AebD886707D8E8c21dDe939c6);
        bool success;
        (success, ) = adrs1.call{value: (sendAmount * 600/1000)}("");
        if(!success) revert FailedWithdraw();
        // require(success, "Failed to withdraw Ether");
        (success, ) = adrs2.call{value: (sendAmount * 400/1000)}("");
        if(!success) revert FailedWithdraw();
        // require(success, "Failed to withdraw Ether");
    }
