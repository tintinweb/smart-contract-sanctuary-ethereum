...
contract KidTest is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("KidTest", "KT"){}
  ...
  function freeMint(uint256 amt) external callerIsUser {
    ...
    require(totalSupply() + amt <= totalFree, "Max free KT");
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more KT");
