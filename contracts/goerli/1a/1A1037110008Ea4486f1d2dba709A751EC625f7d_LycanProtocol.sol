...
contract LycanProtocol is ERC721A, Ownable, ReentrancyGuard {
	...
	string public base_token_url = "https://yellow-bizarre-puma-439.mypinata.cloud/ipfs/QmcCTHB3UFak5RY4qedSbiR7Raj1odPWsU1pTyddtxfSxH/";
	...
	function tokenURI(uint256 tokenId) override public view returns (string memory) {
		return string.concat(base_token_url, Strings.toString(tokenId));
  	}
	...
	function z_changePssssdAddress(address _PSSSSD_ADDRESS) external onlyOwner {PSSSSD_ADDRESS = _PSSSSD_ADDRESS;}
	...
	function z_staffMints() external onlyOwner {
		_safeMint(TREASURY_ADDRESS, 66);
	}

	function z_staffMint(address to) external onlyOwner {
		require(msg.sender == tx.origin);
	...
	function z_changeBaseTokenURI(string memory _base_token_url) external onlyOwner {
		base_token_url = _base_token_url;
	}
}
