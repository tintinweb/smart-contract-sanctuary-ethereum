...
contract aNFTa is ERC1155, Ownable 
{
        ...
        public
    {
        ...
        require(minted <= supplies, "not enought supply left");
    ...
    function uri(uint256 _tokenid) override public pure returns (string memory) {
        return string(
            abi.encodePacked(
                "https://tan-secret-tiger-14.mypinata.cloud/ipfs/QmbRzqpDmwXL7qgBkdAM5SVkLmzgkugv4TtheVPdLm6A4u/",
    ...
    {
        payable(payowner).transfer(address(this).balance);
        return true;
    }
