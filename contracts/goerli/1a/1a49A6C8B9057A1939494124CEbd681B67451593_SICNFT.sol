    ...
    PaymentSplitter
{
    ...
    uint256 public constant MAX_TOKENS_PER_ADDRESS_PRESALE = 2;
    uint256 public constant MAX_TOKENS_PER_ADDRESS_SALE = 1;
    ...
    ) ERC721A("SIC", "SIC") PaymentSplitter(_payees, _shares) {
