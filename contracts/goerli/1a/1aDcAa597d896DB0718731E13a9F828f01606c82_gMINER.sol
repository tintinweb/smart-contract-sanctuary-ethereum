...
contract gMINER is IgMINER, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _vMINER) ERC20("Governance MINER", "gMINER", 18) {
     ...
     * @param _vMINER address
     */
    function migrate(address _staking, address _vMINER) external override onlyApproved {
        ...
        require(_vMINER != address(0), "Zero address found");
        vMINER = IvMINER(_vMINER);
    }
    ...
    /**
     * @notice pull index from vMINER token
     */
    ...
    /**
        @notice converts gMINER amount to MINER
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts MINER amount to gMINER
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gMINER::getPriorVotes: not yet determined");
