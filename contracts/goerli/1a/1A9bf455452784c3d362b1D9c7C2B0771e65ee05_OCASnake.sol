...
// @@@@@@@@@@@@@@@@@@@@@&PPPP[email protected]@@@@@@@&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@&&&&&&Y?????B&&&@@@@@@@@@&&&PPPPP5J???777775&&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
...
// @@@@@@@@@@@@#55B&&&&&&@@@@@@@&&[email protected]@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@#[email protected]@@@@@[email protected]@@[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@&&&#PPPPPPBB#@@@GPPPPPPPPPPPPPPPPPPBBBPP[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@&PPPPPPPPP&&&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@&&#PPPPPPPPPPPPPPPPPPPP5B&&#[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@&BBBPPPPPPPPPPPP555PBB&@@&[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
...
contract OCASnakeArt is Ownable, ReentrancyGuard {
        ...
        returns (bytes memory)
    {
        ...
        for (uint256 i = 0; i < vars.length; i++) {
            svgBytes = abi.encodePacked(svgBytes, svgBuild[i], vars[i]);
            if (i == vars.length - 1) {
                svgBytes = abi.encodePacked(svgBytes, svgBuild[i + 1]);
            }
