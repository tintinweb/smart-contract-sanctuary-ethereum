  ...
  MathFunctions
{
  ...
  uint256 private constant PUBLIC_STAGE = 1;

  uint256 private constant TIERS = 2; // 3 - 0 inclusive
    ...
    nonReentrant
  {
    ...
    requireAvailableSupply(_tier, _quantity);
  ...
  */
    ...
    onlyRole(MANAGER_ROLE)
  {
    ...
    _mint(_to, _tier, _quantity, _lock);
  }
    ...
    onlyRole(UPGRADE_ROLE)
  {
    ...
    requireValidTier(_tier, false);
    requireAvailableSupply(_tier, 1);
    ...
    returns (uint256)
  {
    ...
    return mulDiv(amount, uint256(price), 10**(_decimals + 18));
  }
    ...
    returns (uint256)
  {
    ...
    return mulDiv(amountWithSlippage, 10**(decimals + 18), uint256(price));
  }
    ...
    override
  {
    if(_quantity == 1
      && address(0) != _from
      && block.timestamp > tokenLock[_tokenId]) {
