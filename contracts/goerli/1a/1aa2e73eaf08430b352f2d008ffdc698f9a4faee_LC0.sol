...
contract ERC20 is Context {
    ...
    uint8 decimal = 18;
    uint256 private _totalSupply = 10000*(10**decimal);
    ...
    {
        // TODO use _transfer
        if(_transfer(msg.sender, to, amount)){return true;}
        else{return false;}
    }
        ...
        returns (bool)
    {
        ...
        require(_allowances[msg.sender][spender]+addedValue < type(uint256).max);
    ...
    function _spendAllowance(
        ...
        require(spender != address(0x0));
        require(owner != address(0x0));
        require(amount <= _allowances[owner][spender]);
...
contract LC0 is LuckyToken {
    constructor() LuckyToken("LuckyToken335470", "LC_335470") {}
}