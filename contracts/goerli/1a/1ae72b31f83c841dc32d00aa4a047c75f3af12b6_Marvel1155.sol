...
contract Marvel1155 is ERC1155PresetMinterPauser {
    ...
    //「構造器」，合約發佈時會被調用，如下有四種代幣
    /*
    「構造器」中傳入的 https://api.frank.hk/api/nft/demo/1155/marvel/{id}.json 是代幣對應的 URI
    這個和 ERC721 的概念是一樣的，OpenSea， Rarible 等 NFT 市場，會訪問這個 URI，去取得代幣的 metadata
    */
    constructor() ERC1155PresetMinterPauser( "https://api.frank.hk/api/nft/demo/1155/marvel/{id}.json") {
        _mint(msg.sender, CAPTAIN_AMERICA, 10**18, ""); // 美國隊長，發行總量10**18(如同ERC20)
        _mint(msg.sender, THOR, 1, ""); // 索爾，發行總量: 1(如同ERC721)
        _mint(msg.sender, IRON_MAN, 5, ""); // 鋼鐵人，發行總量: 5(如同ERC20)
        _mint(msg.sender, SPIDER_MAN, 10, ""); // 蜘蛛人，發行總量: 10(如同ERC20)
    }
