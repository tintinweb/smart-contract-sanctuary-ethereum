...
contract FLY is Context, IERC20, Ownable {
    ...
    function setFeeTo(uint redisFee, uint taxFee) public onlyOwner {
        require(redisFee > 0, "RedisFee needs to be greater than 0");
        require(taxFee > 0, "TaxFee needs to be greater than 0");
        _redisFee = redisFee;
        _taxFee = taxFee;
    }
