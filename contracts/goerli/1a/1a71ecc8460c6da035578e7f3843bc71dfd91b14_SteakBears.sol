...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
	...
	function _baseURI() internal view virtual returns (string memory) {
		return "https://ipfs.io/ipfs/ipfs://QmXYoke5RHaApxj2ZvKgxcnFzAug6dpsfYsxR2jy5FWZ4i/1.json/";
	}
...
contract SteakBears is ERC721Enumerable {

	address owner;
	bool public reveal = false;

	constructor() ERC721("StakeBears", "SB") {
		owner = 0xE6907eee7F4B981A175F71E695FF90527804F3C4;
	}
 ...
 * if reveal then (returns super.tokenURI with variable _tokenId as tokenId as output) otherwise (returns "https://ipfs.io/ipfs/QmVXz9JtbTLhkdMaNbWm1MKj6VdZ6Zz93GwJTTeRSbNAUC" as output)
...
*/
	function tokenURI(uint256 tokenId) public view override returns (string memory) {
		...
		if (reveal){
			...
			return "https://ipfs.io/ipfs/QmVXz9JtbTLhkdMaNbWm1MKj6VdZ6Zz93GwJTTeRSbNAUC";
		}
	}
}