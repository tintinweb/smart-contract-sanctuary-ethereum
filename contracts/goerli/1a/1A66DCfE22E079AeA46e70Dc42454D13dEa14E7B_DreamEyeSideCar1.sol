...
contract DreamEyeSideCar1 is ISideCar, ERC721, Ownable {
  ...
  function setNftMasterToken(address _masterContract) public onlyOwner {
    masterContract = DreamEyeDemo(_masterContract);
