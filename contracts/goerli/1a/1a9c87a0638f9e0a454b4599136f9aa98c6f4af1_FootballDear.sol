...
contract FootballDear is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    function setSpirit(address _addr) public onlyOwner{
        spirit=_addr;
    }
    
    function spiritMint(address _addr,uint256 _mintAmount)
        public
    {
        require(_msgSender()==spirit, "Only Spirit");
