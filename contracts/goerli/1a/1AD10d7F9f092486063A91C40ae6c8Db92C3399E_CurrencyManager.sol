 ...
 * @dev It allows adding/removing currencies for trading on the Minthree marketplace.
 */
contract CurrencyManager is ICurrencyManager, Ownable {
    mapping(address => bool) public currencies;

    /**
     * @dev Add a currency in the whitelist
     * @param currency address of the currency to add (ERC-20)
     */
    ...
    /**
     * @dev Remove a currency from the whitelist
    ...
    /**
     * @dev Returns if a currency is in the whitelist
     * @param currency address of the currency to check
     */
    function check(address currency) external view override returns (bool) {
