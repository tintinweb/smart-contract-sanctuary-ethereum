...
contract TokenPaymaster is BasePaymaster {
    ...
    function versionPaymaster() external override virtual view returns (string memory){
        return "3.0.0-beta.1+opengsn.token.ipaymaster";
    }
    ...
    uint256 public gasUsedByPost = 53000;
    uint256 public minGas = 300000;
    uint256 public minBalance = 1 ether;
    address public target;
    bool private _pause;

    constructor(address uniswapRouter, address forwarder, IRelayHub hub) {
    ...
    returns (bytes memory context, bool revertOnRecipientRevert) {
        ...
        return (abi.encode(request.from, ethPrecharge, amountOut), false);
    }
    ...
    virtual {
        ...
        require(amountOut > ethPrecharge - ethActualCharge, "Invalid");
        uint256 refund = _relayHub.balanceOf(address(this)) - minBalance - ethActualCharge;
        _relayHub.withdraw(payable(payer), refund);
        require(_relayHub.balanceOf(address(this)) >= minBalance, "Hub balance is lower");
    }
