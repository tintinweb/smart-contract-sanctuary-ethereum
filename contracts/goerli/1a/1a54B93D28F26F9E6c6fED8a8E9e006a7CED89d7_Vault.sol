    ...
    ERC721Holder
{
    ...
    function asdfasdf1() external pure returns (bool) {
        return true;
    }

    function asdfasdf2() external pure returns (bool) {
        return true;
    }

    function asdfasdf3() external pure returns (bool) {
        return true;
    }

    function asdfasdf4() external pure returns (bool) {
        return true;
    }

    function asdfasdf5() external pure returns (bool) {
        return true;
    }
}
