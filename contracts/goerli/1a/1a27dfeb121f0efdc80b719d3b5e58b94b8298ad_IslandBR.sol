...
contract IslandBR is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 10000;
    uint public _price = 0.02 ether;
    uint256 public maxBuyPerTx = 5;
    bool public paused;
    

    constructor() ERC721A("Island Battle Royale", "IBR") {
        paused = true;
    }
    // Read the price
