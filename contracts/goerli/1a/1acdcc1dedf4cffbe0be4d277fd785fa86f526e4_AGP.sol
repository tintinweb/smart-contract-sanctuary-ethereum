...
// Core Logic
// --------------------------------------------------------------
contract AGP is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    using Address for address;

    // Context
    string private _name = "AGF";
    ...
    address payable public liquidityWallet =
        payable(0x478cf08697b893C44404a1FEc2F4B73a230d7bb3);
    ...
    // updates the buyback wallet (marketing, charity, etc.)
