...
import { MinimalForwarder } from "lib/openzeppelin-contracts/contracts/metatx/MinimalForwarder.sol";
    ...
    UUPSUpgradeable
{
    ...
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor(MinimalForwarder trustedForwarder) ERC2771ContextUpgradeable(address(trustedForwarder)) {
        _disableInitializers();
    }
    ...
    function initialize(
        ...
        _grantRole(MINTER_ROLE, address(trustedForwarder));
