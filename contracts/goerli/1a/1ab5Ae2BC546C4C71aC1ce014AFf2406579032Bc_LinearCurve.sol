...
contract LinearCurve is ICurve, CurveErrorCodes {
    ...
    function getNumUint128By256(uint256 num) external pure returns(uint128 newNum) {
        newNum = uint128(num);
    }
        ...
        )
    {
        ...
        // spotprice 4975124378109454
        // delta。    1000000000000000
        //numItems    1
        //feeMultiplier 0
        // protocolFeeMultiplier  0.05

        //newspotprice 5975124378109454
