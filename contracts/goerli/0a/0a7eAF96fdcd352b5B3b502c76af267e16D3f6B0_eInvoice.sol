...
contract eInvoice {
    ...
    function purchase() public payable {
        require(
            msg.value == invoice.totalPrice - invoice.vatToken,
        ...
        if (invoice.netVatAmount != 0) {
            ...
            sellerContract.deposit{
                value: invoice.totalPrice - invoice.netVatAmount
            }();
        } else {
            vat.transferFrom(msg.sender, address(this), invoice.vatToken);
            sellerContract.deposit{
                value: invoice.totalPrice - invoice.vatToken
            }();
        }
        invoice.paid = true;
    }
