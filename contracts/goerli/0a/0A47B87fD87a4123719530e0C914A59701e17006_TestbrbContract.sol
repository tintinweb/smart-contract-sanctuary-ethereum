...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x873F92b7d9fC7F92d1Ac361F2AdD7e1F2891dE8F];
  address public erc20Payable = 0x873F92b7d9fC7F92d1Ac361F2AdD7e1F2891dE8F;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeie6n7e6wjn4dw45pjvo4dbca4rb7nkp4g74brrpkpq26iwfl3seum/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/QXq5dqqJLHWwclcNnPzN/contract-metadata";
  }
...
// File: contracts/TestbrbContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestbrbContract is ERC721APlus {
    constructor() ERC721APlus("TEST BRB", "BRB"){}
}
