...
contract Skkkrrr is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  ...
  uint256 public PRESALE_COUNT = 0;
    ...
    string private baseURI = "https://stg-api.w3bmint.xyz/api/tokens/goerli/63d8834981261db499171a74/";

    mapping(address => uint256) addressBlockBought;

    address public constant RL_ADDRESS = 0xc9b5553910bA47719e0202fF9F617B8BE06b3A09; 

    constructor() ERC721A("Skkkrrr", "SKR") {
        
        
  _safeMint(0x776AEd51c7544f07dfC70AE56DBAB080b279D9C8, 1);
    }
  ...
  (bool successFinal, ) = payable(0x776AEd51c7544f07dfC70AE56DBAB080b279D9C8).call{value: address(this).balance}("");
