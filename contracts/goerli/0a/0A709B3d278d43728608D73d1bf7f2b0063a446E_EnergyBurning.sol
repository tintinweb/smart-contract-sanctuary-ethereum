...
contract EnergyBurning is Ownable, Pausable, ReentrancyGuard {
    ...
    function validateSignature(
        ...
        return _verify(_getHash(_walletAddress, _nonce, _voidsToFill), _signature);
    }
     ...
     * @param _signature The signature passed from the caller
     */
    function burn(uint256 _voidsToFill, bytes calldata _signature) external whenNotPaused nonReentrant {
        require(validateSignature(msg.sender, nonces[msg.sender], _voidsToFill, _signature), "Invalid signature");
