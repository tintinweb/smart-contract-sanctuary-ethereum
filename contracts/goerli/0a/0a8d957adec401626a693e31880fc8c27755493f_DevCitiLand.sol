...
contract DevCitiLand is DevCitiNFT {
    ...
    function initialize(NFTContractInitializer memory _initializer) 
        ...
        public 
    {
        __DevCitiNFT_init("CitiLand", "CTL", _initializer);
    }
}
...
contract Versioned {
  string public constant version = "0x61213dd506b9f27ea7e75a1bf30d60a02f7117b9";
}
