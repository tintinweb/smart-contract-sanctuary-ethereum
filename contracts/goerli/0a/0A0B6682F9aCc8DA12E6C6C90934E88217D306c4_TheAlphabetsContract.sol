...
// /        |/  |                       /      \ /  |          /  |                /  |                  /  |  /  |       
// $$$$$$$$/ $$ |____    ______        /$$$$$$  |$$ |  ______  $$ |____    ______  $$ |____    ______   _$$ |_ $$/_______ 
//    $$ |   $$      \  /      \       $$ |__$$ |$$ | /      \ $$      \  /      \ $$      \  /      \ / $$   |$//       |
//    $$ |   $$$$$$$  |/$$$$$$  |      $$    $$ |$$ |/$$$$$$  |$$$$$$$  | $$$$$$  |$$$$$$$  |/$$$$$$  |$$$$$$/  /$$$$$$$/ 
//    $$ |   $$ |  $$ |$$    $$ |      $$$$$$$$ |$$ |$$ |  $$ |$$ |  $$ | /    $$ |$$ |  $$ |$$    $$ |  $$ | __$$      \ 
//    $$ |   $$ |  $$ |$$$$$$$$/       $$ |  $$ |$$ |$$ |__$$ |$$ |  $$ |/$$$$$$$ |$$ |__$$ |$$$$$$$$/   $$ |/  |$$$$$$  |
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x0341a7b933e1d3eFF7a83fc555485FC69720f3FD,0xD444F8C690A08B49E4d4ce9Fb652E04eBDef6681];
...
// File: contracts/TheAlphabetsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract TheAlphabetsContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "The Alphabets";
    string public symbol = "APb";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/h7glGqlwrFiqy8jmQQfi/contract-metadata";
  }
