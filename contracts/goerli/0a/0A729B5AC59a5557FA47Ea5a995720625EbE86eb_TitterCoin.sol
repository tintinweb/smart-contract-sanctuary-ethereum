...
/**
 * https://twitter.com/titter_ceo
 * ------------------------------
 * The oldest currency in history
...
error TitterCoin__FeescollectionFailed();

contract TitterCoin is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if (from != address(0) && to != address(0)) {
            ...
            uint256 burn = amount.mul(iBurnOnTx).div(iDenominator);
