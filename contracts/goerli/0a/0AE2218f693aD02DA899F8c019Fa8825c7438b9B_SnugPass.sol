    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public amountOwedToDevTwo = 4 ether;

    uint8 public maxMintAmount = 2;

    string private _baseTokenURI = "ipfs://INPUTCID/";
    ...
    function payDevOne() public onlyOwner nonReentrant {
        uint256 balance = address(this).balance;
        balance = address(this).balance;
    ...
    function payDevTwo() public onlyOwner nonReentrant {
        uint256 balance = address(this).balance;
        balance = address(this).balance;
        if (amountOwedToDevTwo != 0) {
            if (balance < amountOwedToDevTwo) {
                payable(0xAedaD68EAfa16Dc0E4c231A02273A93d574323Ca).transfer(
                    balance
                );
                amountOwedToDevTwo - balance;
            } else {
                payable(0xAedaD68EAfa16Dc0E4c231A02273A93d574323Ca).transfer(
                    amountOwedToDevTwo
                );
                amountOwedToDevTwo = 0;
            }
        }
    }
