...
contract TestNeo is ERC721A, Ownable, ReentrancyGuard {
    ...
    modifier canMint(uint256 _mintAmount) {
        ...
        require(balanceOf(msg.sender) + _mintAmount <= maxMint, "Allowed mint amount exceeded!");
    ...
    function mint(uint256 _mintAmount) external payable canMint(_mintAmount) {
