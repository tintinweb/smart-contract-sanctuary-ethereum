...
contract NgTest is ERC721, Ownable {
    using Strings for uint256;
    ...
    string BASE_URI = "ipfs://QmNZ8YgViGa5RqosY5hCqE5meufbZ2ifspUFjKDRpSpU1s/";
    

    bool public on_sale = false;
    // If you have Reveal Image
    ...
    uint256 constant max_nft_per_transaction = 2;
    uint256 constant max_mint_nft = 5;
    ...
    event NgTestMinted(uint256 tokenId, address owner);
    ...
    function publicSaleMint(uint numberOfTokens) public payable onlyAccounts{
        require(on_sale, "Sale haven't started");
        require(numberOfTokens <= max_nft_per_transaction, "Too many requested");
        ...
        require(addressToMintCount[msg.sender] + numberOfTokens <= max_mint_nft, "Exceeds allowance");
    ...
    function withdrawAll() public onlyOwner {
        ...
        _withdraw(FOUNDER_1, (balance * 400) / 1000);
        _withdraw(FOUNDER_2, (balance * 400) / 1000);
    ...
    // Reveal function for closed NFT
