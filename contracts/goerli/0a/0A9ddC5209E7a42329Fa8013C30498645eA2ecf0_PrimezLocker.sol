...
contract PrimezLocker is Ownable, Lockable , ILocker{
    ...
    **/
    ...
    function getLockedInfo(address _user) external view onlyLocker returns (LockItem memory){
    ...
    function getSystemLock() public view onlyLocker returns (bool){
        return systemLock;
    }
}
...
abstract contract Lockable {
    ...
    modifier onlyLocker() {
        require(lockers[msg.sender], "Mintable: caller is not minter");
        _;
    }
