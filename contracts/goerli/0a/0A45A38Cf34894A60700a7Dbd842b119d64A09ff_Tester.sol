...
contract Tester is DefaultOperatorFilterer, Ownable, ERC721Enumerable {
    ...
    require(minted < maxSupply, "Max Supply is 777");
    require(_tokenID < maxSupply, "Token ID should be between 0-777");
