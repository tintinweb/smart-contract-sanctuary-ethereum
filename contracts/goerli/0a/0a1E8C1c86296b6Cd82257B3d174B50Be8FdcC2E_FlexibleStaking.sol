...
contract FlexibleStaking is Pausable, Ownable {
  ...
  bytes32[] private _availableConditionsHashes = [
    ...
    keccak256(abi.encodePacked(_availableExpiresAfter[1])),
    keccak256(abi.encodePacked(_availableExpiresAfter[2])),
    keccak256(abi.encodePacked(_availableExpiresAfter[3]))
  ];
