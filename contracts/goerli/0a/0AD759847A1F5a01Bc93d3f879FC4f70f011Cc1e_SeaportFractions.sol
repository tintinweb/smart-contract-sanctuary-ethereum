...
contract SeaportFractions
{
	fallback () external payable
	{
		assembly {
			...
			let result := delegatecall(gas(), 0xb355c7e7eFD95fD52eAdD72099cB17B2683dC7B4, 0, calldatasize(), 0, 0)
...
// File @openzeppelin/contracts/token/ERC721/[email protected]3.3.0
...
contract SeaportFractionsImpl is ERC721Holder, ERC20, ReentrancyGuard
{
	...
	address constant SEAPORT_ENCODER = 0x16a2fF8D329A173924136Ce5f2e1c8771dF6E963;
