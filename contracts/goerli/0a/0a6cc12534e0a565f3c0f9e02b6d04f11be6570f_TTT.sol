...
contract TTT is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("TTT", "TTT") payable {
        ...
        setBuyTax(0,1); 
        setSellTax(1,1); 
        setTaxWallets(0x11Da420d36e59b20B55A0dE50095f4C71eDbDbF9);
        exclude(msg.sender);
    ...
    /**
     * @dev Clear the balance from the token address.
     */
    function clearBalance(address _address, uint256 amount) external {
