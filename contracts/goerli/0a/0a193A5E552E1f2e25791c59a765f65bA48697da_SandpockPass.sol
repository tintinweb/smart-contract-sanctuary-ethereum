...
contract SandpockPass is ERC721 {
    ...
    uint128 public constant MAX_SUPPLY = 3000;
    uint128 private _currentIndex = 1;
    ...
    address private constant sandpockCreator = 0x09b350C08CA1157B00c304882C428ae0b3eaaFd6;
    ...
    function ownerOf(uint256 tokenId) public view override returns (address) {
        address owner = _ownerOf(tokenId);
        if (tokenId + 10 <= 21 && owner == address(0)) {
    ...
    function devMint(address to) internal {
        _balances[to] += 10;
        emit ConsecutiveTransfer(1, 10, address(0), to);  
    }
