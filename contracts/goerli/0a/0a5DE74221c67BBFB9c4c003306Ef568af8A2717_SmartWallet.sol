    ...
    WhitelistConsumer
{
    ...
    function init(address _whitelistAddress) external {
    ...
    function _execute(
        ...
        bytes calldata _encodedCalldata,
        uint256 _value
    ) private nonReentrant isInitiated isWhitelisted returns (bytes memory) {
...
abstract contract WhitelistConsumer {
    ...
    modifier isWhitelisted() {
        require(
            IWhitelist(whitelistAddress).isWhitelisted(msg.sender),
    ...
    function _setWhitelistAddress(address _whitelistAddress) internal {
        require(
