...
contract SweepDollarCoin is BaseSweep {
    ...
    uint256 public constant TIME_ONE_YEAR = 365.25 * 24 * 60 * 60;
    ...
    function setInterestRate(uint256 _new_interest_rate) public onlyByOwnGov {
        global_interest_rate = _new_interest_rate;
    ...
    function setPriceTarget(uint256 _new_target_price) public onlyByOwnGov {
        ...
        previous_target_price = current_target_price;
        next_target_price = current_target_price * (((1 + global_interest_rate / PRICE_PRECISION)**(period_time / TIME_ONE_YEAR)) * PRICE_PRECISION) / PRICE_PRECISION; 
