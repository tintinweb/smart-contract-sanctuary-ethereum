    ...
    ERC721AOpensea
{
    ...
    function deposit() external payable isPreBuyActive {
        ...
        emit Deposit(msg.sender, msg.value, contribution_, auctionTotal_);
    }
     ...
     * @dev No other checks are used for auction/pre buy phases, this is just
     *   a safety check in case the pre buy phase has not been turned off before
