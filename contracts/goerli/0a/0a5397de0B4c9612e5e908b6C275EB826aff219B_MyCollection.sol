...
*/
contract MyCollection is Access, ERC721, DefaultOperatorFilterer, IERC2981 {
    ...
    */
    ...
    uint16 internal constant COLLECTION_ROYALTY_AMOUNT = 100;
    ...
    */
    function supportsInterface(bytes4 interfaceId)
        public 
        view
        override (Access, ERC721, IERC165) 
        returns (bool) 
    {
    ...
    function royaltyInfo(uint256 , uint256 salePrice)
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        uint256 _royaltyAmount = (salePrice * COLLECTION_ROYALTY_AMOUNT) / 1000;
