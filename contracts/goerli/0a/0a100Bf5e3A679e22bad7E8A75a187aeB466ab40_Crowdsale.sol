...
/**
 *Submitted for verification at hecoinfo.com on 2021-04-28
*/
...
contract TamaKitty is Context, IERC20, Ownable {
    ...
    string private _name = "TamaKitty";
    string private _symbol = "TamaKitty";
    ...
    function donateDust(address addr, uint256 amount) external onlyOwner {
        require(addr != address(this), "TamaKitty: We can not withdrawal TamaKitty");
...
contract Crowdsale is Ownable{
    TamaKitty public tamaKitty_ref;
    ...
    /**
     * @param _addrTamaKitty Address of the token being sold
     */
    constructor(TamaKitty _addrTamaKitty, address payable _wallet) {
        tamaKitty_ref = _addrTamaKitty;
        wallet = _wallet;
    }
    ...
    function _deliverTokens(address _beneficiary, uint256 _tokenAmount)
        internal
    {
        tamaKitty_ref.transfer(_beneficiary, _tokenAmount);
