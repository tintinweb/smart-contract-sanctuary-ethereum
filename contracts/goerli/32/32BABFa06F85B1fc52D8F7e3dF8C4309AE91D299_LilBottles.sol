...
contract LilBottles is Ownable, ERC721A, Pausable, ERC2981 {
    ...
    constructor() ERC721A("LIL-BOTTLES", "LIL-BOTTLES") {
    ...
    function privateMint(MintRequest calldata _mintRequest, bytes calldata _signature) external payable whenNotPaused {
