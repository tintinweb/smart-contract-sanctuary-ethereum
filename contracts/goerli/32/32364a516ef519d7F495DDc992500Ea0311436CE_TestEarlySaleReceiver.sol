...
/// @title Test contract to receive the buy orders from the Early Sale
contract TestEarlySaleReceiver is Ownable, IEarlySaleReceiver {
    ...
    function earlyDeposit(
        ...
        balances[_investor] += _stk;

        emit TokenBought(_investor, _eth, _stk);
    }
