...
contract HolderImplementation is Initializable,NFTReceiver { 
    ...
    */
   function collection(address target,address to, uint256 id) external returns (bool success) {
   ...
   function execute(address target,bytes calldata _data)external payable returns (bytes memory response) {
