...
// import './newupdatedcontractnft_b.sol';
import './newerc1155_cc.sol';
...
contract Collections is Initializable, UUPSUpgradeable {
    ...
    */
    ...
    function create_collection(string memory name, uint256 supply, bytes calldata uri_, uint256 royaltyValue, string memory contract_Metadata_Uri) public {
            ...
            CollectionsRecord[CollectionCount] = CollectionsDetails(ERC1155, name, msg.sender, block.timestamp);
            collectionOwners[address(msg.sender)].ids.push(CollectionCount);
            ERC1155.mint(msg.sender, supply, uri_, msg.sender, royaltyValue);
     ...
     */
    function mint(ERC1155Lockable Collection, uint256 supply, bytes calldata uri_, bytes calldata key, uint256 royaltyValue) public  {
        require(OwnerRole[address(Collection)] == address(msg.sender), "Only Collection owner is allowed");
        Collection.mint(msg.sender, supply, uri_, msg.sender, royaltyValue);
    }
