...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
    // When we mint an NFT we will trigger Chainlink VRF to get a random number.
    // Using the random number we will get a random NFT from these options:
    ...
    function withdraw() public onlyOwner {
        ...
        if (!sent || initialBal <= address(this).balance) {
