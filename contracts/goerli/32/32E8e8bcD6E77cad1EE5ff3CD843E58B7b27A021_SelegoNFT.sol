...
contract SelegoNFT is ERC721Enumerable, Ownable {
    ...
    address public withdrawer = 0x1FcC0725CFB0a1540d8Dd6a6B46857dF00a7bA3C;
    ...
    function changeWithdrawer(address _withdrawer) public onlyOwner {
        withdrawer = _withdrawer;
    }

    function withdraw() public {
        require(msg.sender == withdrawer, "Only withdrawer");
