...
contract Elumnt721 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    Counters.Counter private _tokenI1dCounter;
    ...
    function safeMint(address to, string memory uri) public onlyMarketplace returns(uint256) {
