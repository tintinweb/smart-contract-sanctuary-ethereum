...
//author = atak.eth
contract DGTestV2 is ERC721AUpgradeable, DefaultOperatorFiltererUpgradeable,
    OwnableUpgradeable {
    ...
    */
    ...
    mapping (address => uint256) WLMintedSN;
    ...
    function mint(bytes32[] calldata merkleProof, uint256 allowance, uint256 quantity) external payable{
        ...
        if(phase == 1){
            ...
            require(msg.value >=  0.069 ether * quantity, "Not enough funds sent");
            if(verify(SNroot, merkleProof, msg.sender, allowance)){
                require(quantity <= allowance - WLMintedSN[msg.sender], "This exceeds max amount for this wallet");
                WLMintedSN[msg.sender] += quantity;
