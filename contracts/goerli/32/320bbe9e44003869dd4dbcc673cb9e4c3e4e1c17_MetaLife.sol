...
// 判断是否收取手续费
contract ExcludedFromFeeList is Owner {
...
// File: contracts/Uniswap/DexBase.sol
...
abstract contract DexBase {
    ...
    constructor(){
        ...
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), address(0xdAC17F958D2ee523a2206206994597C13D831ec7));
    }
}
...
// File: contracts/Utils/MarketFee.sol
...
abstract contract MarketFee is Owner, ERC20, DexBase, ExcludedFromFeeList{
    // 收取多少手续费
    uint256 public constant handlingFee = 3;
    // 用于接收手续费的钱包
    address constant marketAddress = address(0x7840bD65C939491f696A5eE3D05eB7a0df6448e0);
    ...
    {
        // 计算出要收取的金额
        uint256 marketAmount = (amount * handlingFee) / 100;
        // 收取手续费到本合约存着
...
// File: contracts/ERC20/MetaLife.sol
...
contract MetaLife is MarketFee {
    // 初始化代币名称和代号
    constructor() ERC20("Meta Life", "META") {
        // 铸造2100个币
        _mint(msg.sender, 2100);
    }
