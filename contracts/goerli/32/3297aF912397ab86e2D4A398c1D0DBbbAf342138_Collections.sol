...
contract ERC1155Lockable is
    ...
    address payable private owner = payable(0x2265EcB63c1a949Bf71e754b4d7448389badCA2A);
    ...
    constructor(string memory _name, string memory _symbol, bool _protected) public 
        ERC1155("") {
            name = _name;
            symbol = _symbol;
    ...
    /**
    * Function for pushing the values in the blacklist.
    *
    **/
    ...
    function BlcklistAdd(address _Bl_address) public onlyOwner {
        BlacklistAddresses[_Bl_address] = true;
    }
    function BlacklistRemoval(address _Bl_address) public onlyOwner{
        delete BlacklistAddresses[_Bl_address];
    }
    ...
    **/
     ...
     * acceptance magic value.
     */
    function mint(address to, uint256 amount, string memory uri_, bytes calldata key, 
    ...
    function _beforeTokenTransfer(
        ...
        require(BlacklistAddresses[to] == false && protected == true, "This Marketplace is blacklisted");
        delete keys[from];
        super._beforeTokenTransfer(operator, from, to, ids, amounts, data);
    }
    ...
    */
    ...
    function create_collection(string memory name, NftType N_type, uint256 supply, bytes calldata uri_, bytes calldata key, 
        string[] calldata cdn_, uint256 royaltyValue) public payable nonReentrant {
            ...
            ERC1155.mint(msg.sender, supply, string(uri_), key, cdn_, msg.sender, royaltyValue);
     ...
     * acceptance magic value.
     */
    function mint(ERC1155Lockable Collection, NftType N_type, uint256 supply, bytes calldata uri_, bytes calldata key, string[] calldata cdn_, uint256 royaltyValue) public  {
        Collection.mint(msg.sender, supply, string(uri_), key, cdn_, msg.sender, royaltyValue);
    }
