...
//create function to verify userName is normalized
//alphanumeric and emojii
...
contract OnChainAlpha is ERC721A, ReentrancyGuard, Ownable {
    ...
    // function normalize(string memory word) private pure returns (string) {
    ...
    function normalize(string memory word) private pure returns (string memory) {
        ...
        for (uint256 i = 0; i < word.length(); i++) {
            ...
            if(StringUtils.compareTo(checkLetter, " ")==false)
            {
