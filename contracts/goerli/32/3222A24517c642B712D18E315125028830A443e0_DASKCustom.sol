...
contract DASKCustom is IERC721, Proxy, Functional, IERC2981, DefaultOperatorFilterer {
    ...
    constructor() {
        _name = "DASK Custom";
        _symbol = "DASKc";
        _baseURI = "https://thedeadarmyskeletonklub.io/metadata/";
        _postURI = ".json";
        ...
        _royaltyReciever = address(payable(0x366796aA22ede203984A6e817c2D46586B9C144C));
    }
    ...
    function royaltyInfo( uint256 tokenId_, uint256 salePrice_ ) external override view returns ( address receiver, uint256 royaltyAmount ){
    	// Set royalty amount to 6.9% for all secondary sales
        uint256 royaltyAmt = (salePrice_ * 69) / 100;

        return (_royaltyReciever, royaltyAmt);
    }
    ...
    function mint(uint256 setTier) public reentryLock {
    	// This function will mint 1 NFT at a time only
    	//
    ...
    /////////////////// Proxy Access for Future Use Cases /////////////////
    ...
    function setRoyaltyReciever(address reciever) external onlyOwner {
    	_royaltyReciever = reciever;
    }
    ...
    function setPostURI(string memory URIextension) public onlyOwner {
    	_postURI = URIextension;
    }
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory){
        ...
        return string(abi.encodePacked(_baseURI, toString(tokenId), _postURI));
    }
