...
contract Decoy is ERC721A, VRFV2WrapperConsumerBase, ConfirmedOwner {
    IERC721 decoyContract = IERC721(0xD32C6E104c460E5E1531d89d62eE4C19E581CE28);
    ...
    function freeMint(uint256 amount) external {
        uint256 availableFreeMints = decoyContract.balanceOf(msg.sender) -
            balanceOf(msg.sender);
        require(availableFreeMints - amount + 1 > 0, "Reached free mint limit");
    ...
    function setSaleState(uint256 state) external onlyOwner {
        require(state < uint256(SaleState.PUBLIC) + 1, "Bad state");
