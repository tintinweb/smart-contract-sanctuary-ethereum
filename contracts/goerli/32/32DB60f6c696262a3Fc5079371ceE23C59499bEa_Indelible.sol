// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Hand", unicode"Eyes", unicode"Nose", unicode"Mouth", unicode"Hat", unicode"Dick", unicode"Butt", unicode"Skin", unicode"Background"];
        ...
        uint public constant maxSupply = 4200;
        ...
        ContractData public contractData = ContractData(unicode"caaaaa", unicode"Gooch Island is full of mysterious secrets. Scientists have recently discovered a new species of cute creatures : LarvaDickbutts.  A cc0 and fully onchain collection of 4200 LarvaDickbutts, inspired by CryptoDickbutts and Larva Lads.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/e22eb3b8-861f-459e-8cb1-0393fe0fc04e", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/e22eb3b8-861f-459e-8cb1-0393fe0fc04e", "", 500, "0x75F52aEf21c1692afa9bBE897a31dB3002BAF6c3");

        constructor() ERC721A(unicode"caaaaa", unicode"LDB") {
            TIERS[0] = [34,93,176,179,958,2760];
TIERS[1] = [39,73,73,75,124,125,140,146,150,153,178,296,304,329,343,348,1304];
TIERS[2] = [88,129,3983];
TIERS[3] = [35,145,1269,2751];
TIERS[4] = [4,13,19,26,35,40,44,46,57,58,78,82,95,98,99,100,103,106,115,117,124,132,143,144,150,224,236,323,657,732];
TIERS[5] = [42,88,104,107,137,273,335,378,408,463,515,581,769];
TIERS[6] = [260,315,555,619,2451];
TIERS[7] = [8,45,138,446,1193,2370];
TIERS[8] = [388,419,599,770,858,1166];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"caaaaa #");
