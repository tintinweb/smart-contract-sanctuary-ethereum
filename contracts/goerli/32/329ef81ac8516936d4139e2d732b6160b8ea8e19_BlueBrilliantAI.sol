...
contract BlueBrilliantAI is BEP20, Ownable {
    ...
    address public marketingWallet = 0xFdEB411B6D5705c2eB278dAF2B52e7f81D45fFE0;
    address public devWallet = 0xFdEB411B6D5705c2eB278dAF2B52e7f81D45fFE0;
    address public bbWallet = 0xFdEB411B6D5705c2eB278dAF2B52e7f81D45fFE0;
    ...
    Taxes public taxes = Taxes(5, 0, 0, 5);
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 1e5, "Swap threshold amount should be lower or equal to 0.1% of tokens");
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity + _bb + _dev) <= 15, "Must keep fees at 15% or less");
    }
