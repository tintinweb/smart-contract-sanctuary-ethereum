...
contract TEST is Context, IERC20, Ownable {
  ...
  address payable public treasuryWallet =
    payable(0xD14F5076b7368e22FF674cc49B80c1940493E161);
  ...
  uint256 public rewardsClaimTimeSeconds = 60 * 60; // 1H
  ...
  uint256 public _maxTxAmount = _tTotal.mul(1).div(100); // 2.0%
