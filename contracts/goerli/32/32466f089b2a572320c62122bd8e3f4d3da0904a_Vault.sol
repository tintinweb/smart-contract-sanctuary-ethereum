...
contract TimeLockContract is TimelockControllerUpgradeable {
  ...
  function initialize(DAOArguments calldata _timelockContractArguments) external initializer{
    // TODO: DOUBLE CHECK IF THIS IS CORRCT - Since we are setting the proposer and executors after this. this can be anything. 
...
contract Vault {
    ...
    // owner - nft contract. It will help us identify who the owner of the campaign is
    mapping(address => address) public ownerOfCampaign;
    ...
    function setupCampaign(
        ...
        require(ownerOfCampaign[msg.sender] == address(0), "You already have a campaign");
        require(
        ...
        bytes memory initializer = abi.encodeWithSignature(
            ...
            _DAOArguments._signatories,
            _DAOArguments._quorum,
            address(0x0),
            new bytes(0),
            address(0x0),
            address(0x0),
    ...
    function storeCampaign(
        ...
        ownerOfCampaign[_creator] = _nftContractAddress;
    }
