...
contract TryAvatars is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    constructor() ERC721("TryAvatars", "TRY") {
        // Start token ID at 1 instead 0
    ...
    function safeMint(address to, string memory uri) public payable {
        // check that the totalSupply is less than MAX_SUPPLY
        require(totalSupply() < MAX_SUPPLY, "Can't mint anymore.");
   
        // Check is the ether value is correct
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmStNrctZDcVDtqV9z64hvSuiuaSJffN1ftMfeKyezrAk2/";
        // Enter the NFT Metadata.json location here
    }
    ...
    // Allows us to update the URI for each token
