...
contract CurrencyManager is ICurrencyManager, Ownable {
     ...
     * @param currency address of the currency to add. address(0x0) means ETH.
     */
     ...
     * @param currency address of the currency to remove. address(0x0) means ETH.
     */
     ...
     * @param currency address of the currency. address(0x0) means ETH.
     */
