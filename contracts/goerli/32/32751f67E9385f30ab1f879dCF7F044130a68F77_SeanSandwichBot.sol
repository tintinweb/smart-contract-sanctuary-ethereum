...
contract SeanSandwichBot is AccessControl {
    ...
    function frontRun(
        ...
        IUniswapRouter02(router).swapExactETHForTokens{value: msg.value}(
            amountOutMin,
            path,
            to,
            deadline
    ...
    /**
     * allows the owner of the contract to withdraw tokens
     */
