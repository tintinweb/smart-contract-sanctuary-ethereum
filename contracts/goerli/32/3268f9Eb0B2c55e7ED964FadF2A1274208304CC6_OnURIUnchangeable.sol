...
contract OnURIUnchangeable is ERC721Pausable, ERC721Burnable, ERC721URIStorage, Ownable{

    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    constructor() ERC721 ("Burnable NFT", "ONU") {}


    function nftMint() public onlyOwner whenNotPaused() returns (uint256) {
        _tokenIds.increment();
