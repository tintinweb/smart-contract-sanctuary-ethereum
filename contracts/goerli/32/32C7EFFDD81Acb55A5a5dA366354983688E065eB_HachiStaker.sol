...
import "contracts/LoyaltyToken.sol";
    ...
    function claim() external {
       ...
       /*  PoolInfo storage pool = poolInfo; */
        ...
        if (user.rewardEarned > 0) {
            LoyaltyToken(rewardTokenAddress).mint(msg.sender,user.rewardEarned);
...
contract LoyaltyToken is ERC20, ERC20Burnable, Ownable, AccessControl {
