...
// File: contracts/CentralizedBabySupe.sol
...
contract BabySupeContract is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function safeTransferBatch(
        ...
        for (uint256 i = 0; i < nftIds.length; ++i) {
            ...
            _safeTransfer(from, to, nftIds[i], data);
