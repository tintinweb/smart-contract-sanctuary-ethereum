...
contract UniswapAMO is Owned {
    ...
    constructor(
        ...
        SWEEP = SweepDollarCoin(_sweep_contract_address);
    ...
    // Uni V3 only
    function swap(address _tokenA, address _tokenB, uint24 _fee_tier, uint256 _amountAtoB)  public onlyByOwnGov returns (uint256) {
    ...
    function burnSweep(uint256 sweep_amount) public onlyByOwnGovCust {
        ...
        amo_minter.burnSweepFromAMO(sweep_amount);
    }
