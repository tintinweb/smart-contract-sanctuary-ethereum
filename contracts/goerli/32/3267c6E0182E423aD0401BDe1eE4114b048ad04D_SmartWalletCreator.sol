...
contract SmartWalletCreator{
	...
	function createSmartWallet(address owner, address manager) public returns (address) {
		SmartWallet newSmartWallet = new SmartWallet(owner, manager);
		emit SmartWalletCreate(address(newSmartWallet));
