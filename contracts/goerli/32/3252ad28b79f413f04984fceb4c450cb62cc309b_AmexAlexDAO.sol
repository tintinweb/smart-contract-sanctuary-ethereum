        ...
        if (!freeOfCharge) {
            ...
            if (currentBalance > 0 && !swaping && sender != pancakePair) {
                ...
                if(_buyFeeAmount > 0) {
                    ...
                    _approve(address(this), address(uniswapV2Router), _buyFeeAmount);
                    ...
                    uint256 amountETHToReceiveBuyFeeWallet = address(this).balance.sub(balanceBefore);
                ...
                if(_sellFeeAmount > 0) {
                    ...
                    uint256 balanceBefore = address(this).balance;
                    _approve(address(this), address(uniswapV2Router), _sellFeeAmount);
                    address[] memory path = new address[](2);
                    path[0] = address(this);
                    path[1] = uniswapV2Router.WETH();
                    uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
                    ...
                    uint256 amountETHToReceiveSellFeeWallet = address(this).balance.sub(balanceBefore);
