...
/*
    ...
    function createListing(ListingParameters memory _params) internal {
        ...
        require(tokenAmountToList > 0, "EO2");
        require(
    ...
    function bulkCreateSell (
        ...
        address[] memory tokenHash,
        uint256[] memory price,
        uint256[] memory endSeconds
    ) external {
    ...
    function setPlatformFee(
        ...
        require(_platformFeeBps <= MAX_BPS, "EO22");
    ...
    function setAuctionBuffers(
        ...
        require(_bidBufferBps < MAX_BPS, "EO23");
...
interface IMarketplace {
    ...
    **/
    ...
    /// @dev Emitted when listing fee updated.
