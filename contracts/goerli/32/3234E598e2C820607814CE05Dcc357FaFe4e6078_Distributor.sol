...
contract Distributor is IDistributor, ElasticDollarAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    IERC20 private immutable elastic;
    ...
    function nextRewardAt(uint256 _rate) public view override returns (uint256) {
        return elastic.totalSupply().mul(_rate).div(rateDenominator);
    }
