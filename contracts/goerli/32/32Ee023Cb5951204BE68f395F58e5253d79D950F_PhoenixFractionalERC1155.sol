  ...
  IERC721ReceiverUpgradeable
{
  ...
  function initialize(address tBotFCAddress_, string memory contractURI_) public initializer {
    __Ownable_init();
    __ERC1155_init("");
  ...
  function uri(uint256 tokenId) public view override returns (string memory) {
    // return same uri of tokenId of contract ERC721 tBotFCAddress
    return IERC721MetadataUpgradeable(tBotFCAddress).tokenURI(tokenId);
  }
  ...
  */
  function onERC721Received(
    ...
    require(msg.sender == tBotFCAddress, "only accept phoenix");
  ...
  function redeem(uint256 tokenId) external {
    ...
    require(balanceOf(msg.sender, tokenId) == NUMBER_FRACTION, "you not own all fraction");

    // burn 10000 tokenId
    _burn(msg.sender, tokenId, NUMBER_FRACTION);

    // transfer tokenId to msg.sender
    IERC721(tBotFCAddress).safeTransferFrom(address(this), msg.sender, tokenId, "");
  }
