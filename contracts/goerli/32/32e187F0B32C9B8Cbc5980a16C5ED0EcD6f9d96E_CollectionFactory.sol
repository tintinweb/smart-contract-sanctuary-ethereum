 ...
 * @notice Factory Contract to setup collections
 */
contract CollectionFactory {
    /**
     * @notice MintManager for controlling all mint functionality
     */
    address public immutable mintManagerAddress;

    /**
     * @notice MintManager for controlling all auction functionality
     */
    address public immutable auctionManagerAddress;

    /**
     * @notice EditionsMetadataRenderer for handling Editions Metadata
     */
    address public immutable editionsMetadataRendererAddress;

    /**
     * @notice ERC721Editions implementation
     */
    address public immutable erc721EditionsImplementation;

    /**
     * @notice ERC721SingleEdition implementation
     */
    address public immutable erc721SingleEditionImplementation;

    /**
     * @notice ERC721General implementation
     */
    address public immutable erc721GeneralImplementation;

    /**
     * @notice Trusted forwarder of meta-transactions
     */
    ...
    /**
     * @notice Initialize ERC721Edition collection, deployed via Create2
    ...
    /**
     * @notice Initialize ERC721Edition collection, deployed via Create2 AND create first edition on it
     * @param _creator Creator/owner of contract
     * @param _defaultRoyalty Default royalty object for contract (optional)
     * @param _defaultTokenManager Default token manager for contract (optional)
     * @param _contractURI Contract metadata
    ...
    /**
     * @notice Initialize ERC721SingleEdition collection, deployed via Create2
     * @param _creator Creator/owner of contract
     * @param _defaultRoyalty Default royalty object for contract (optional)
     * @param _defaultTokenManager Default token manager for contract (optional)
     * @param _contractURI Contract metadata
    ...
    /**
     * @notice Initialize ERC721SingleEdition collection, deployed via Create2.
     * @dev Duplicate fix to avoid stack depth, patch.
     * @param _creator Creator/owner of contract
     * @param _defaultRoyalty Default royalty object for contract (optional)
     * @param _defaultTokenManager Default token manager for contract (optional)
     * @param _contractURI Contract metadata
     ...
     * @param salt Salt used to uniquely deploy collection (via Create2)
     */
    function setupERC721SingleEditionCollectionWithMarketplaceFilterer(
        address _creator,
        IRoyaltyManager.Royalty memory _defaultRoyalty,
        address _defaultTokenManager,
        string memory _contractURI,
    ...
    /**
     * @notice Initialize ERC721General collection, deployed via Create2
     * @param _creator Creator/owner of contract
     * @param _defaultRoyalty Default royalty object for contract (optional)
     * @param _defaultTokenManager Default token manager for contract (optional)
     * @param _contractURI Contract metadata
    ...
    /**
     * @notice Initialize ERC721General collection, deployed via Create2,
     *         and create 1/1 auction for a new token (to be minted) on it
     * @param _creator Creator/owner of contract
     * @param _defaultRoyalty Default royalty object for contract (optional)
     * @param _defaultTokenManager Default token manager for contract (optional)
     * @param _contractURI Contract metadata
     ...
     * @ param auctionPaymentRecipient Recipient of winning bid
     * @ param auctionCurrency Currency to facilitate auction in
     * @param auctionEndTime Auction end time
     * @param salt Salt used to uniquely deploy collection (via Create2)
     */
    function setupERC721GeneralCollectionWithNewTokenEtherAuction(
        ...
        IAuctionManager(auctionManagerAddress).createAuctionForNewToken(auctionId, auction);
        OwnableUpgradeable(clone).transferOwnership(_creator);
        return clone;
    }

    /**
     * @notice Initialize ERC721General collection, deployed via Create2,
     *         and create 1/1 auction for a new token (to be minted) on it. Use marketplace filter registry
     * @param _creator Creator/owner of contract
     * @param _defaultRoyalty Default royalty object for contract (optional)
     * @param _defaultTokenManager Default token manager for contract (optional)
     * @param _contractURI Contract metadata
     ...
     * @param salt Salt used to uniquely deploy collection (via Create2)
     */
    function setupERC721GeneralCollectionWithNewTokenEtherAuctionAndMFR(
        address payable _creator,
        IRoyaltyManager.Royalty memory _defaultRoyalty,
        address _defaultTokenManager,
        string memory _contractURI,
    ...
    /**
     * @notice Predict Create2 deployed ERC721Edition collection
    ...
    /**
     * @notice Predict Create2 deployed ERC721SingleEdition collection
     * @param salt Salt used to uniquely deploy collection
     */
    ...
    /**
     * @notice Predict Create2 deployed ERC721General collection
     * @param salt Salt used to uniquely deploy collection
     */
