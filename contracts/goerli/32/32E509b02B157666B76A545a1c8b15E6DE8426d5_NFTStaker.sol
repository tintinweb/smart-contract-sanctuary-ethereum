...
contract GoldenSlags is ERC20, ERC20Burnable, Ownable {
    ...
    function removeAccess(address _accessor) public onlyOwner {
        mintingAccess[_accessor] = false;
    }
...
contract NFTStaker is Ownable {
    ...
    constructor() {
        ...
        rewardToken = GoldenSlags(0xb2Bafbb2e243f6998446a050db5316122E067cd1);
