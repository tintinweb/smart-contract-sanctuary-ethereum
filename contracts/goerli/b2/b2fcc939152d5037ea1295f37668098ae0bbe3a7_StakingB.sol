...
contract StakingA is Ownable, IERC721Receiver{
    ...
    address public _token_Contract = 0x90C23a8531d05793f05E31391b91a29d4459a4b2;
...
contract ANONbyanon is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    ...
    function mintByAnon(address _to, uint256 quantity) external payable  {
        require(totalSupply() + quantity <= MAX_SUPPLY,"No More NFTs to Mint");
            ...
            require(publicMinted[_to] + quantity <= max_per_wallet, "Per Wallet Limit Reached");
            
            require(msg.value >= (publicSaleCost * quantity), "Not Enough ETHER Sent");  
            total_PS_count = total_PS_count + quantity;        
            publicMinted[_to] = publicMinted[_to] + quantity;
...
contract KEEPOUTbyanon is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer,IERC721Receiver {
    ...
    function burnBlackBox(address _addr, uint256 _tokenId) external payable{
        
        safeTransferFrom(msg.sender, address(0), _tokenId);
        ANONbyanon(contractAddr).mintByAnon{value:msg.value}(_addr,1);
