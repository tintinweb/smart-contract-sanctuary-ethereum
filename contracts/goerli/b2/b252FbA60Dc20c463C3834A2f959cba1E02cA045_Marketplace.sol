    ...
    IERC721ReceiverUpgradeable
{
    ...
    */
    ...
    function broadcastExternalBid(
        ...
        Offer memory newOffer = Offer({
            listingId: _listingId,
            offeror: address(0), //TODO: Check if this is ok to set address 0 when is an external address
            currency: nativeTokenWrapper,
            pricePerToken: 0, //TODO: Check if this is ok, maybe we can put the native token value at the bid moment
    ...
    function handleOffer(Listing memory _targetListing, Offer memory _newOffer) internal {
        validateERC20BalAndAllowance(_newOffer.offeror, _newOffer.currency, _newOffer.pricePerToken);
...
interface IMarketplace is IThirdwebContract, IPlatformFee {
    ...
    **/
     ...
     *                           amount per token. The total offer/bid amount is ` _pricePerToken`.
     *
     */
    function offer(uint256 _listingId, address _currency, uint256 _pricePerToken) external payable;
