...
// File contracts/vrf/VRFConsumer.sol
...
contract VRFConsumer is VRFConsumerBaseV2, RandConsumer {
    ...
    mapping(uint256 => uint256) mapRequestId;
    ...
    function _requestRandom(uint256 requestId) internal override {
        ...
        mapRequestId[requestId] = s_requestId;
    }
    ...
    function fulfillRandomWords(
        ...
        _fullfillRandomness(mapRequestId[requestId], randomWords[0]);
    }
}