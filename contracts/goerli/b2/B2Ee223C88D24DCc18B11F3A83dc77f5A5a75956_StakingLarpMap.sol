...
contract TESTO is Ownable, ERC20 {
	...
	constructor() ERC20(_name, _symbol) {
		...
		marketingWallet = address(0xf4E9Dc0DB85547C481410A63F6b6B417Eec4447e);
		buyBackWallet = address(0x33898033AC642A3f58FC1cdb5F01f818b5628fd0);
...
contract TESTODividendTracker is DividendPayingToken {
	using SafeMath for uint256;
	using SafeMathInt for int256;
	...
	constructor() DividendPayingToken("TESTO_Dividend_Tracker", "TESTO_Dividend_Tracker") {
		claimWait = 3600;
	...
	function setTokenBalanceForDividends(uint256 newValue) external onlyOwner {
		require(minimumTokenBalanceForDividends != newValue, "TESTO_Dividend_Tracker: minimumTokenBalanceForDividends already the value of 'newValue'.");
