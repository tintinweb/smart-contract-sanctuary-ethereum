...
contract DBonez is ERC721A, ERC2981, Ownable {
    ...
    constructor() ERC721A("DBonez", "DBonez") {
       _shareholders[0] = 0x37bBD66971490EcE57EF1Cfd89Fbe07FD50991e4;  //replace  with wallet
       setRoyalties(0x37bBD66971490EcE57EF1Cfd89Fbe07FD50991e4,750);
...
*/
    ...
    function withdraw(uint256 amount) external onlyOwner {
        ...
        Address.sendValue(payable(_shareholders[0]), payment);
        emit PaymentReleased(_shareholders[0], payment);
