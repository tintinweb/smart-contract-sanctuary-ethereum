...
contract AaveAdapter is OwnableUpgradeable {
    ...
    address public immutable V2_LENDING_POOL;
    ...
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor(address _v2DataProvider, address _v3AddressesProvider) {
        _disableInitializers();
        ...
        V2_LENDING_POOL = v2Supported ? V2_ADDRESSES_PROVIDER.getLendingPool() : address(0);
