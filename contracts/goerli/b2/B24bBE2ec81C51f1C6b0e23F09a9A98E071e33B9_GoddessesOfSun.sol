...
contract GoddessesOfSun is ERC721, Ownable{
    ...
    //0xbd05b19c7bdd1b5f1f74d85dcd7f98a41f7668dbd222ec2e14db5ba72e24a1b0
    ...
    function setMintLimit(uint256 _mintLimit) public onlyOwner{
        require(_mintLimit > 0, "mint limit can't be zero" );
        mintLimit = _mintLimit;
    }

    //MINT PRICE
    function setMintPrice(uint256 _mintPrice) public onlyOwner{
        require(_mintPrice > 0, "mint limit can't be zero" );
