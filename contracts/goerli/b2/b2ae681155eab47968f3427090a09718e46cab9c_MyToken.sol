...
error Claimed();
contract MyToken is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, ERC2981, Pausable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    string public constant NAME = "REAL AGENTS V3";
    string public constant SYMBOL = "AGENTV3";
    ...
    constructor(string memory _uri, address _contract) ERC721("Real Agents V2", "REAL") {
