...
contract Archer is ERC721AGuardable, Owned {
    address public immutable BOX_O_BAD_GUYS_CONTRACT_ADDRESS;
    string private constant baseUri = "ipfs://SOME_BASE_URI_HERE/"; // get real URI before deploy (duh)
    uint256 public constant MAX_SUPPLY = 3000;

    constructor(address _mintPassContractAddress) ERC721AGuardable("Archer", "ARCHER") Owned(msg.sender) {
