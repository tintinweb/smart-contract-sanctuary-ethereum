...
contract GeorgeAnimalFriends is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public allowlistType = 0; //0:MerkleTree 1:Mapping
...
//mint block
    ...
    function mint(uint256 _mintAmount , uint256 _maxMintAmount , bytes32[] calldata _merkleProof) public payable nonReentrant{
