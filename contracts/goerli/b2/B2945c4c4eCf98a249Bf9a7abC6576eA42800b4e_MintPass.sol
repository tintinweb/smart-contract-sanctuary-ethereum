...
contract MintPass is ERC721AQueryable, Ownable, ERC2981 {
    ...
    /// @notice Define supply for preMInt
    uint256 public constant PRE_MINT_SUPPLY = 400;

    /// @notice Define max mintable supply of NFTs.
    uint256 public constant MAX_SUPPLY = 500;

    /// @notice Define URI of metadata api.
    string public BASE_URI = "ipfs://QmTroTPFdveysoznbXNnpzpox3AE79cfq3wQNGCHVWbEmd/";
    ...
    modifier canMint(uint256 max_supply) {
        require(
    ...
    ) ERC721A("Timeight Mint Pass", "TMP") {
    ...
    ) external canMint(PRE_MINT_SUPPLY) {
