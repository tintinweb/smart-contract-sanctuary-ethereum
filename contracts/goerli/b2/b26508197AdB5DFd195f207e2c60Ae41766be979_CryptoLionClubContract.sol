    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiaz26ftyetao2xxkyrbvax6svabmodbjt7m2tief5heqh5mvdnqoy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ZSPgbcItsxhsYmWfBgaK/contract-metadata";
  }
...
// File: contracts/CryptoLionClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoLionClubContract is RamppERC721A {
    constructor() RamppERC721A("Crypto Lion Club", "Lion"){}
}
  /*******************************************************/
  /*                                                     */
