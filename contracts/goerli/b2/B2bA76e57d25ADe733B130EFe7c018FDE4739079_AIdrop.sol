...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x3a034FE373B6304f98b7A24A3F21C958946d4075); //RWRD Token
    address WBNB = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6; // ETH Address
    IDEXRouter router;
...
contract AIdrop is IBEP20, Auth {

    address WBNB = 0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "AIdrop";
    string constant _symbol = "AIDROP"; 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xf7f1aFeAEF5aDf23F72e2CefA65F01489b3353cd ;
