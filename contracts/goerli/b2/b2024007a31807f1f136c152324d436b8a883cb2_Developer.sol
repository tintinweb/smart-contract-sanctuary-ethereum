...
contract Developer is ERC721Enumerable, Ownable {
    ...
    uint256 public constant BASE_MINT_PRICE = 0.005 ether; 
    uint256 public constant PRESALE_MINT_PRICE = 0.005 ether;  
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        if (isUpgrade(_tokenId)) {
            ...
            return string("https://opensea-creatures-api.herokuapp.com/api/creature/25");
