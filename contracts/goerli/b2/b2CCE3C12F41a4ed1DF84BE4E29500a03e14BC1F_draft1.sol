...
contract draft1 is ERC721A, ERC2981, OperatorFilterer, Ownable {
    string public baseURI;

    uint256 public constant price = 0.0049 ether;

    uint256 public constant totalTokens = 20;
    uint256 public constant freeTotalTokens = 8;
    uint256 public constant paidTotalTokens = 12;
