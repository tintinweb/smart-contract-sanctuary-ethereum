...
contract TFTokens is ERC20, Ownable {
    uint256 private _maxSupply;

    constructor() ERC20("Techforce Token", "TF") {
        _maxSupply = 5000000000 * 10**decimals(); // 5B tokens wei
        _mint(msg.sender, 1000000000 * 10**decimals()); //1B tokens initial supply
    }
    ...
    {
        require(
            (totalSupply() + tokenAmount) <= _maxSupply,
