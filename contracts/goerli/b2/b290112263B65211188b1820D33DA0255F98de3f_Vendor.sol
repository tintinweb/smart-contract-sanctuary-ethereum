...
contract Vendor is Ownable {
    ...
    function buyTokens() public payable {
        uint256 tokenstoSend = tokensPerEth * msg.value;
    ...
    function sellTokens(uint256 amount) public {
        ...
        require(address(this).balance >= ethToSend, "Not enough ETH to send");
        yourToken.transferFrom(msg.sender, address(this), amount);
        (bool success, ) = payable(msg.sender).call{value: ethToSend}("");
        emit BuyTokens(msg.sender, ethToSend, amount);
    }
}
...
contract YourToken is ERC20 {
    constructor() ERC20("Gold", "GLD") {
        ...
        _mint(0x0b07dA10b31DBf39624B3BabbDD05c934b6C2538, 1000 * 10 ** 18);
    }
}