...
contract Gray is ERC20, Ownable {
    ...
    uint256 _decimal = 18;
    uint256 private _totalSupply = 1e8 * 10 ** _decimal;
    ...
    //Wallets
    address public marketingWallet = 0x7a2A439074f7Ffe203785bB50f5C346C0D9145ba;
    address public charityWallet = 0x7a2A439074f7Ffe203785bB50f5C346C0D9145ba;
