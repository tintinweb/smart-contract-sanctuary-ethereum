...
contract IP3 {
        ...
        returns (bytes32[] memory, uint256[][] memory)
    {
        ...
        for (uint256 i = 0; i < size; i++) {
            ...
            singleNFTPriceforBoth= getCurrentStartingPricePerNFTforBothOptions(hashedNfts[i]);
    ...
    function getCurrentStartingPricePerNFTforBothOptions(bytes32 hashedNft) public view returns (uint256[] memory) {
