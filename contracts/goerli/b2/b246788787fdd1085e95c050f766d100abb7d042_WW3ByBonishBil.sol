...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract WW3ByBonishBil is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("WW3 By BonishBil", "WW3BB") {
  }


  
 
  function mintdraft(uint8 _mintAmount) external payable  {
