...
contract TomiStates {
    ...
    uint256 public amountNFTRequiredToPropose = 1;
    uint256 public amountNFTRequiredToVote = 1;

    uint256 public baseFee = 100 * (10 ** 26);
...
contract TomiMainDao is TomiEvents, TomiStates, Ownable {
    ...
    function priceOfUSDinETH() public view returns(uint256 ) {
        return baseFee.div(getLatestPrice());
    }
