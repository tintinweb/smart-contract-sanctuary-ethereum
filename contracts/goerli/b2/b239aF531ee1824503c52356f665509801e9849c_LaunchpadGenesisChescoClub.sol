 ...
 * @notice This contract handles minting Genesis Chesco Club tokens.
 */
contract LaunchpadGenesisChescoClub is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xCD9e240f275A588a8DbFe8336ac48147d5Bc100c;
    address public royaltyAddress = 0x30439021Ed5B3BB247bF0FDbb92F18010930ee7c;
    ...
    uint256 public presaleStartTime = 1663353900;
    ...
    uint256 public publicSaleEndTime = 1978714861;
    uint256 public publicSaleStartTime = 1663354800;
    uint256[] public payoutPercentages = [100];
    uint96 public royaltyFee = 1000;

    constructor() ERC721A("Genesis Chesco Club", "GCC") {
