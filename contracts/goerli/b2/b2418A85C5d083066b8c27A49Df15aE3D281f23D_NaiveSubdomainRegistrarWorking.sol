...
/* TODO: 
1. mint fee [v]
2. name owner can withdraw fund, add balance [v]
3. records: resolved address
4. parent_cannot_control
5. check if subdomain already minted (!!! subdomains minted not on the contract ???) 
*/
