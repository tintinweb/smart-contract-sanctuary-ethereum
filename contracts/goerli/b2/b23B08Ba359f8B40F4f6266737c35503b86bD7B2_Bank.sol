...
contract Bank is ReentrancyGuard, Ownable {
    ...
    uint256 public indiciaFraction = 1000;
    uint256 public communityFraction = 9000;
    address private _indiciaRecipient;
    address public admin;
    IERC721 public indicia;
    Counters.Counter private _phaseId;
    ...
    function claim(
        ...
        require(
            _validateClaim(phaseId_, tokenId_, fraction_, r, s, v),
            "Indicia Bank: Invalid fraction"
        );
        Pool memory pool = pools[phaseId_];
    ...
    function _validateClaim(
        ...
        bytes32 digest = keccak256(abi.encode(phaseId_, tokenId_, fraction_));
        return
