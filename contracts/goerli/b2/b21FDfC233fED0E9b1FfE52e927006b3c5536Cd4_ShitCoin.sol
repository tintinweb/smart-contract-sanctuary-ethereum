...
contract ShitCoin is Context, IERC20, Ownable {
  ...
  string private _name = 'FICKCOIN';
  string private _symbol = 'FICK';
  ...
  uint256 private _maxTxAmount = 1000000e18;
  // We will set a minimum amount of tokens to be swaped => 5M
  uint256 private _numOfTokensToExchangeForTeam = 20000 * 10**18;
  ...
  constructor(
    ...
    teamWallet = MCCWalletAddress;
    taxWallet = marketingWalletAddress;
  ...
  function sendETHToTeam(uint256 amount) private {
    ...
    uint team = amount / 30;
    teamWallet.call{ value: amount.mul(team) }('');
    taxWallet.call{ value: amount.mul(amount-team) }('');
  }
