...
contract PaymentsProcessor is Ownable {
  ...
  function getERC20Fee(address receipient, address token_address) public view onlyOwner returns (uint8) {
    require(available_tokens[token_address].exists, "Unsupported token address");
  ...
  function getNativeCoinFee(address receipient) public view onlyOwner returns (uint8){
