...
contract YatGems is ERC1155, Ownable, YatSignatures {
    ...
    event AdminBurnDisabled(address admin);
    ...
    bool private _allowAdminBurn = true;
    //-----------------------------------------      Constructor       -------------------------------------------------
    ...
    */
    ...
    /**
      Create a new Gem with the given name. It will be assigned the next available GemId
    */
    ...
    */
    ...
    // Allows admin to burn tokens.
    function adminBurn(address holder, uint256 gemId, uint256 amount) public onlyAdmin {
        require(_allowAdminBurn, "Burns have been disabled");
        ERC1155._burn(holder, gemId, amount);
        _burns[gemId][holder] += amount;
    }

    // Permanently disables admin burning
    function endAdminBurns() public onlyAdmin {
        _allowAdminBurn = false;
        emit AdminBurnDisabled(msg.sender);
    }
