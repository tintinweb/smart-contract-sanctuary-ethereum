...
interface ILicense {
    ...
    function isLicenseActive(address _collection, uint256 _tokenId) external view returns (bool _isLicenseActive);
    function safeMint(
        address _to,
        address _collection,
...
contract Escrow is Ownable, ReentrancyGuard, IEscrow {
    ...
    uint96 public minDuration = 15724800;

    /// @notice Maximal license duration
    uint96 public maxDuration = 157680000;
     ...
     * @param _seller Person who sales
    ...
    function _mintLicense(
        ...
        emit License(_seller, _buyer, _licenseId, _collection, _tokenId, _duration);
    }
    ...
    function _resaleLicense(SellLicense memory _params) internal {
        ...
        emit License(_params.seller, _params.buyer, _params.licenseId, _params.collection, _params.tokenId, 0);
    }
