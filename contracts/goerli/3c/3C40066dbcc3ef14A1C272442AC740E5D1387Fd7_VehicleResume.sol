...
contract VehicleResume is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    function safeMintWithMetadata(
        ...
        _setValue(
            ...
            abi.encode(string(abi.encodePacked("NFT for IVDL", " ", ivdl)))
        );
        _setValue(
            tokenId,
            key_token_image,
            abi.encode(
                string(
                    abi.encodePacked("http://vehicleresume.io/svg/", "", ivdl)
                )
            )
        );
        //
        ...
        _setValue(
            ...
            abi.encode(
                string(abi.encodePacked("http://vehicleresume.io/", "", ivdl))
            )
        );
    ...
    function updateToken(
        ...
        string memory ivdl = string(
            abi.decode(_getValue(tokenId, key_token_ivdl), (string))
        );
