...
abstract contract RewardContract {
    function mintReward(address to_, uint256 tokenId_)
        public
        payable
        virtual
        returns (uint256);
    ...
    VRFV2WrapperConsumerBase
{
    ...
    // uint256 public totalAirdrop; // Tracker for batchMints
        ...
        isSaleState(SaleState.VIP)
    {
        ...
        // User directly receive the token
        ...
        isSaleState(SaleState.BuddyList)
    {
        ...
        if (msg.value != mintPrice) revert IncorrectPrice();
        if (buddyListMints[msg.sender] >= buddyListLimitPerWallet)
