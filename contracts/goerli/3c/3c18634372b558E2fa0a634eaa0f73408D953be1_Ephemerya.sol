...
contract Ephemerya is BaseTokenURI, SignerManager, ERC2981, EphemeryaStack {
    using EnumerableSet for EnumerableSet.AddressSet;
    using SignatureChecker for EnumerableSet.AddressSet;
    uint256 public immutable collectionSize = 100;
    ...
    constructor(
        ...
        BaseTokenURI(
            "https://gateway.pinata.cloud/ipfs/QmQFF9vWewGxzLksLiRGYqBebibTV8wymZSDL7SXEU7s1b/"
        )
        EphemeryaStack(name, symbol, royaltyReceiver)
    {
    ...
    function setBeneficiary(address payable new_beneficiary) public onlyOwner {
    ...
    function hasToken(address to) public view returns (bool) {
        return hasMinted[to];
    }
    ...
    modifier abideMintRequirements() {
        require(
            !hasToken(msg.sender),
            "already minted"
        );
        ...
        if (_price > 0) {
            ...
            emit Revenue(beneficiary, 1, _price);
        }
    ...
    function mint() external payable whenNotPaused abideMintRequirements {
    ...
    function allowlistMint() external payable callerIsUser abideMintRequirements {
