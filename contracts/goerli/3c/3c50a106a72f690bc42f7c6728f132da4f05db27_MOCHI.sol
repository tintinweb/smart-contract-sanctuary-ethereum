...
contract MOCHI is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**18; // 10% of max supply 
    ...
    uint256 public maxBuyTransactionAmount = 60000000 * (10**18); // 0.6
    ...
    constructor() {
        ...
        _MarketingWalletAddress = payable(0x82A4C9437C7aA6711b79e8916820a86761c43619);
