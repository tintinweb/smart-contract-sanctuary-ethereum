...
// ---- Change end ----
    ...
    */
    ...
    function getTokenData(uint16 tokenId) public view returns (uint8[] memory) {
        ...
        while(i < traitCount) {
            ...
            if(traits[i].enabled && hasTrait(i, tokenId)) {
            // ---- Change end ----
    ...
    */
    ...
    // ---- Change start ----
        ...
        return hasRole(TRAIT_DROP_ADMIN, msg.sender) || traitControllerAccess[_addr][uint8(byteNum)] & (0x01 * 2**bitPos) != 0;
    // ---- Change end ----
    ...
    // ---- Change start ----
            ...
            msg.sender == owner() || addressCanModifyTrait(msg.sender, traitID),
            // "Not Authorised"
