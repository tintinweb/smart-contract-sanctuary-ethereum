...
contract DemoContract is ERC721A, InventoryAccessControl, ERC721AQueryable,ERC721ABurnable, DefaultOperatorFilterer, ERC2981 {
     ...
     * @param _contractURI uri of contract metadata
     */
    constructor(
        string memory _name,
     ...
     */
     //TODO: add onlyMinter role
    function mint(address _beneficiary, uint256 quantity) public  {
...
contract MinterControl is Ownable {
    ...
    *Mint can be performed only when the crowdsale contract is added as a minter by the owner
    ...
    modifier onlyMinter() {
        require(
            minters[msg.sender],
            "ERROR: Function accessible only by the minter !!"
        );
        _;
    }
