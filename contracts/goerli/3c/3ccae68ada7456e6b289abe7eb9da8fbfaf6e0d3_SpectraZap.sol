...
interface ISpectraZap {
     ...
     * - deposits into curve pool
     * @param _principalToken the _principalToken to interact with
     * @param poolIndex The index of pool with respect to associated principalToken.
...
contract SpectraZap is ISpectraZap, Initializable {
    ...
    function initialize(address _registry) external initializer {
        require(
            _registry != address(0),
            "SpectraZap: Cannot set registry to zero address"
        );
        registry = _registry;
    }
    ...
    function zapInToCurvePoolWithAsset(
        ...
        require(
            factory != address(0),
            "SpectraZap: principalTokenFactory address is not set in registry"
        );
        ...
        require(
            ...
            "SpectraZap: Actual lp token amount is less than the minimum expected value"
        );
    ...
    function _addLiquidityToCurvePool(
        ...
        **/
        ...
        require(success, "SpectraZap: Failed to add liquidity to curve pool");
    ...
    function _calcExpectedLpTokenAmount(
        ...
        require(
            success,
            "SpectraZap: Could not fetch expected LP token for the curve pool"
        );
