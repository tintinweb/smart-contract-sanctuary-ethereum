...
contract pruebagoerli is ERC721A, DefaultOperatorFilterer, Ownable { //le agregue DefaultOperatorFilterer antes de Ownable
    using Strings for uint256;
    ...
    constructor(string memory _baseTokenURI, string memory _placeholderURI) ERC721A("prueba goerli", "pgr") {
