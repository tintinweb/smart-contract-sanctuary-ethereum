 ...
 * @notice This contract handles minting Schedule presale and sale tokens.
 */
contract SchedulePresaleAndSale is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xCad428831e2a038A9919CE7F39BB0aC7ad9969a7;
    ...
    string public name = "Schedule presale and sale";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeid7owgmzlrg22sbcz75sqj7rq772b34w5tx6xhwafw5hncfbwk66q/{id}"
        )
    {
        ...
        tokenPublicSaleStartTime[1] = 1671039000;
        tokenPublicSaleEndTime[1] = 1671177600;
        tokenUsePublicSaleTimes[1] = true;
        tokenPresaleMaxSupply[1] = 500;
        tokenPresalePrice[1] = 0 ether;
        tokenPresaleMintsPerAddress[1] = 0;
        tokenPresaleSaleStartTime[1] = 1671523200;
        tokenPresaleSaleEndTime[1] = 1670610600;
