...
/**
 * @title RemeasurementUnmiter
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract RemeasurementUnmiter is ERC20Burnable, ERC20Permit {
    address private _owner;

    constructor() ERC20("Remeasurement Unmiter","ERUT")  ERC20Permit("Remeasurement Unmiter") { 
        _owner = _msgSender();
     }
