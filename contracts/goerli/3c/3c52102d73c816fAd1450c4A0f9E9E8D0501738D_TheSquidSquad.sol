...
contract TheSquidSquad is Ownable, ERC721URIStorage, VRFConsumerBase, KeeperCompatibleInterface, ReentrancyGuard {
    ...
    lotteryState public c_lotteryState;
    ...
    constructor(
        ...
        c_lotteryState = lotteryState.OPEN;
    }
    ...
    // check upkeep (monitor draw) every 111th mint so 110 will trigger draw.
        ...
        returns (bool upKeepNeeded, bytes memory performData)
    {
        ...
        bool isOpen = lotteryState.OPEN == c_lotteryState;
        uint currentToken = _tokenIds.current();
            upKeepNeeded = (currentToken == 3 || currentToken == 6 || currentToken == 9 || currentToken == 440 ||
            currentToken == 550 || currentToken == 660 || currentToken == 770 || currentToken == 880  &&
    ...
    function performUpkeep(bytes calldata /*performData*/) external override {
        ...
        c_lastTimeStamp = block.timestamp;
        c_lotteryState = lotteryState.Drawing_Winner;
    ...
    function fulfillRandomness(
        ...
        uint256 index = randomness % c_drawEnteries.length;
