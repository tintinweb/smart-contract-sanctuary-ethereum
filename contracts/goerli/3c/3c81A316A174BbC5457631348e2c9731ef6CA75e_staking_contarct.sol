...
contract staking_contarct is ReentrancyGuard {
    ...
    constructor(IERC721A _nftCollection) {
    ...
    function _unstake(address _user, uint256 _tokenId) private {
        ...
        for (uint256 i = 0; i < stakers[_user].stakedTokens.length; i++) {
            ...
            require(
                stakers[_user].stakedTokens[i].tokenStakedAt + 120 seconds <
                block.timestamp,
