...
// File contracts/features-interfaces/ITxFeeFeatureV3.sol
...
// File contracts/features/TxFeeFeatureV3.sol
...
// File contracts/templates/SnapshotTxFeeTemplate.sol


pragma solidity ^0.8.0;
contract SnapshotTxFeeTemplate is SnapshotFeature, TxFeeFeatureV3 {
    function initialize(
        string memory name_,
        string memory symbol_,
        uint8 decimals_,
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    ) internal virtual override(SnapshotFeature, TxFeeFeatureV3) {
