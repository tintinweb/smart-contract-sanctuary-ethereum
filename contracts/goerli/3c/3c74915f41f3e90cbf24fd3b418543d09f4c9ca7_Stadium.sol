...
contract Stadium is ContextUpgradeable, ERC721AUpgradeable {
    ...
    function mint(
        ...
        _mint(oType, ipfsHash, _msgSender(), quantity);
    }
    ...
    function mintNamed(
        ...
        _mint(oType, ipfsHash, _msgSender(), 1);
    }
    ...
    function _mint(uint8 oType, string memory ipfsHash, address receiver, uint quantity) internal {
        uint tokenId = _nextTokenId();
        ERC721AUpgradeable._mint(receiver, quantity);
