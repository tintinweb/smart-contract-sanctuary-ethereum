...
// File: contracts/FinalCheckCoinToken.sol

// 
pragma solidity ^0.8.5;

/**
 * @title FinalCheckCoinToken
 ...
 */
contract FinalCheckCoinToken is ERC777 {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC777("FinalCheckCoin", "FCC", new address[](0)) {
        _mint(msg.sender, 65212 * 10 ** 18, "", "");
    }
}
