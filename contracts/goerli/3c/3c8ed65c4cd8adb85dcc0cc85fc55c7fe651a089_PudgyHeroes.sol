...
contract PudgyHeroes is Ownable, ERC721A, ERC2981, PaymentSplitter {
    using Strings for uint256;

    uint256 public constant maxSupply = 2000;

    uint256 public constant maxTokensPerTx = 5;
    ...
    ) ERC721A("Pudgy Heroes", "PUDGYHEROES") PaymentSplitter(payees_, shares_) {
        _mint(msg.sender, 1);
    ...
    function pudgyMint(uint256 quantity) external payable {
