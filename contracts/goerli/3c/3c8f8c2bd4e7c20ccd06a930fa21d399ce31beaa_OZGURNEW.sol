...
// File: deps/IERC1363Receiver.sol
...
contract OZGURNEW is ERC1363 {
    using SafeMath for uint256;
    using Address for address;

    address private owner;
    string _name = "OZGURNEW";
