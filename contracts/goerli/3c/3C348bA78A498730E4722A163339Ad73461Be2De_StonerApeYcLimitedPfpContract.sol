...
//*********************************************************************//
//
//       _____ __                        ___           __  ________   __    _           _ __           __   ____  __________ 
//   / ___// /_____  ____  ___  _____/   |  ____  __\ \/ / ____/  / /   (_)___ ___  (_) /____  ____/ /  / __ \/ ____/ __ \
//   \__ \/ __/ __ \/ __ \/ _ \/ ___/ /| | / __ \/ _ \  / /      / /   / / __ `__ \/ / __/ _ \/ __  /  / /_/ / /_  / /_/ /
//  ___/ / /_/ /_/ / / / /  __/ /  / ___ |/ /_/ /  __/ / /___   / /___/ / / / / / / / /_/  __/ /_/ /  / ____/ __/ / ____/ 
// /____/\__/\____/_/ /_/\___/_/  /_/  |_/ .___/\___/_/\____/  /_____/_/_/ /_/ /_/_/\__/\___/\__,_/  /_/   /_/   /_/      
//                                      /_/                                                                               
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3eB6F988EC52423d519c0f194882EA40D1881382];
  address public erc20Payable = 0x3eB6F988EC52423d519c0f194882EA40D1881382;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 0.037 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 15, 100) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigmlh3pwqt6l4b5btwyamlzg7kvtebas4imbmiqcvl4u5jer25wsa/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PeGLIAJezKpZdAlvRz91/contract-metadata";
  }
...
// File: contracts/StonerApeYcLimitedPfpContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract StonerApeYcLimitedPfpContract is RamppERC721A {
    constructor() RamppERC721A("StonerApeYC Limited PFP", "SAYCLPFP"){}
}
