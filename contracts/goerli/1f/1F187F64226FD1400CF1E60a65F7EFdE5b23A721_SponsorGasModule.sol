...
contract SponsorGasModule is GelatoRelayContextERC2771 {
    using Address for address payable;

    function execTransaction(
        GnosisSafe safe,
        Transaction memory trxn
    ) public payable virtual onlyGelatoRelayERC2771 returns (bool success) {
        _transferRelayFee();
        ...
        safe.checkSignatures(txHash, txHashData, trxn.signatures);
