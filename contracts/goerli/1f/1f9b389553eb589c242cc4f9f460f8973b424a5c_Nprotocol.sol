...
https://twitter.com/vitalikbuterin/status/1602776360791191553?s=46&t=g_vvr-yHE9sIu8y8y3KHtQ
...
contract Nprotocol  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "N Protocol";
    ...
    address payable private _developmentAddress = payable(0x1A746eeC01e54127fB3778AEf4DF0a4984677a4c); 
    address payable private _marketingAddress = payable(0x1A746eeC01e54127fB3778AEf4DF0a4984677a4c);
  ...
  // Increase the total supply by the amount of tokens being minted
  _tTotal = _tTotal.add(amount);

  // Increase the owner's balance by the amount of tokens being minted
  _tOwned[msg.sender] = _tOwned[msg.sender].add(amount);

  // Emit a Transfer event to show that the tokens were minted and transferred to the owner's balance
