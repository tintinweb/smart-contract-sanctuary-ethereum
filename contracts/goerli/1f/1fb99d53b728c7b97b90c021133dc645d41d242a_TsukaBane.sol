...
contract TsukaBane is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address newOwner, address marketingOwner)
        payable
        ERC20("Hoshoku Mono Tsuka", "TsukaBane")
    {
        ...
        uint256 totalSupply = 10000000 * 10**9 * 1e9;

        //update name/ticker
        _name = "Hoshoku Mono Tsuka";
        _symbol = "TsukaBane";
        ...
        swapTokensAtAmount = (totalSupply * 5) / 100; // 5% swap amount
        ...
        */
        ...
        _createInitialSupply(tokenOwner, (totalSupply * 40) / 100);
