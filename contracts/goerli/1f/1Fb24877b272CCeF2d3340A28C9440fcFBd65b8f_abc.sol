...
contract abc is ERC721, Ownable {
    ...
    constructor() ERC721("NTF Name", "SYMBOL") {
        // Base IPFS URI of the NFTs
        baseUri = "ipfs://QmVQQaWxcGYEM35RsqpTC4NvYBt3mF4WjugwjsYFeVuBUi/";
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= MAX_MINT_PER_TX, "You can only mint a maximun of 10 NTFs per transaction");
        require(mintedPerWallet[msg.sender] + _numTokens <= 10, " You can only mint 10 per wallet.");
        uint256 curTotalSupply = totalSupply;
        require(curTotalSupply + _numTokens <= MAX_TOKEN, "Exceeds 'MAX_TOKENS'");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x09cB0be8e789137808B667C0b08C67D48a2d1C3e).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x09cB0be8e789137808B667C0b08C67D48a2d1C3e).call{value: balanceTwo}("");
