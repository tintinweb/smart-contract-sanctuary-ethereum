...
contract XmultiverseOpenUp  is ERC721Enumerable, ERC721Royalty, MintCounter, ReentrancyGuard, AccessControl, Ownable {
    ...
    constructor(address payable shareholderAddress_) ERC721("Xmultiverse open-up", "XM") {
    ...
    function setMaxSupply(uint256 supply) external onlyRole(SUPPORT_ROLE) {
        MAX_SUPPLY = supply;
    }
