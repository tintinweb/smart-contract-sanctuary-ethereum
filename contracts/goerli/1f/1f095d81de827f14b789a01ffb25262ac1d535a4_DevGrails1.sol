...
import "grails/season-01/Grails.sol";

contract DevGrails1 is Grails {
    constructor() Grails(IERC721(address(0))) {
        baseTokenURI = "https://www.721.so/api/example/metadata/";
    }
...
contract DeployDevGrails is Script {
    ...
    function run() public {
        vm.startBroadcast();
        DevGrails1 grails = new DevGrails1();
