...
/**
 * Polygon interface for mintable root contract:
 */
...
contract IndieExample is ERC721Enumerable, AccessControl, IMintableERC721 {
  ...
  // Track which tokens are minted for predicate:
  mapping(uint256 => bool) private _tokensMinted;

  constructor(address predicateProxy) ERC721("IndieExample", "V1") {
