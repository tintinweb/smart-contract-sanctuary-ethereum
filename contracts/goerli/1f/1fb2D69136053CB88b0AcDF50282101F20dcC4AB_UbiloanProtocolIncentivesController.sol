...
contract DistributionManager is Initializable, OwnableUpgradeable {
     ...
     * @param _underlyingAsset The address used as key in the distribution, for example sUbiloan or the aTokens addresses on Ubiloan
...
import {DistributionTypes} from "../interfaces/DistributionTypes.sol";

import {DistributionManager} from "../interfaces/DistributionManager.sol";
...
/**
 * @title UbiloanProtocolIncentivesController
 * @notice Distributor contract for rewards to the Ubiloan protocol
 * @author Ubiloan
 **/
contract UbiloanProtocolIncentivesController is
