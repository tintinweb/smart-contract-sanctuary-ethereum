...
contract SquareManager is Initializable, SquareManagerContracts {
        ...
        private
    {
        ...
        for (uint256 i = 0; i < awayNumbers.length; i++) {
            uint256 n = i + uint256(keccak256(abi.encodePacked(block.timestamp))) % (awayNumbers.length - i);
...
{   
    ...
    function __SquareManagerState_init() internal initializer {
        ...
        maxTokensPerWallet = 1; // by default, will increase depending on # of users
        tableSet = false;
    }
}
