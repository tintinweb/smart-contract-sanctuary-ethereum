...
contract CAESAR is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = maxSupply * 2  / 100; // 2% of the supply
    ...
    address payable marketingWallet = payable(address(0xCAEef0f8e107289b72aD0B47Cb86975B917772cE)); // marketingWallet to receive ETH
