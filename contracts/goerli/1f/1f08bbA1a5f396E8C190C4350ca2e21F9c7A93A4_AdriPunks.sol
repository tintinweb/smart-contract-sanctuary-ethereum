...
// File contracts/AdriPunks.sol

// 

pragma solidity ^0.8.0;
contract AdriPunks is ERC721, ERC721Enumerable, PlatzipunksDNA {
    using Counters for Counters.Counter;

    constructor(uint256 _maxSupply) ERC721("AdriPunks", "ADRI") {
    ...
    function mint() public {
        ...
        require(tokenId < maxSupply, "Max tokens minted");
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                '{ "name": "AdriPunks #',
                tokenId,
                '", "description": "Adri Punks are randomized Avataaars stored on chain to teach DApp development on Platzi", "image": "',
                imageByDNA(dna),
                '"}'
            )
        );
