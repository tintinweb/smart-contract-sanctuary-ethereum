...
contract Staking is Ownable {
    ...
    function authorityWithdrawStaking(
        ...
        uint256 toWithdraw = authorityStakings[msg.sender][authorityStakingId].stakingAmount * (10000 + 12000) / 10000;
        ...
        governanceTokenContract.transfer(
            msg.sender,
            authorityStakings[msg.sender][authorityStakingId].stakingAmount * 12000 / 10000
        );
