...
contract ERC721Marketplace is ERC721, ERC2981, Ownable {
    ...
    constructor(string memory marketplaceName, string memory symbol)
        ERC721(marketplaceName, symbol)
    {
    ...
    function nftMint(string memory _tokenURI, uint96 _royaltyNumerator) public {
        lastID = lastID + 1;
