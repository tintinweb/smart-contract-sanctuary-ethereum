...
contract ICO is Ownable, ICOEvents, ReentrancyGuard {
    ...
    constructor(address _tokenAddress, address _usdtAddress) {
        ...
        expirationTime = startTime + 60 days; // ICO For Two Months
        percentageArray = [
            700,
            700,
            700,
        ...
        startVestingTime = uint32(60 days); // Two Months After ICO Ends
    }
        ...
        returns (uint256 _toBeTransfer, uint8 _claimCount)
    {
        ...
        uint8 claimCount = ((uint8(time / 30 days)) + 1); // Claim in Ever Month
