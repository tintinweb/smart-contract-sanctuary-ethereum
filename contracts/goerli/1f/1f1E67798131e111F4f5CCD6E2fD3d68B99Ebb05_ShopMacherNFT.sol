...
contract ShopMacherNFT is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("ShopMacherNFT", "SMNFT") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://aws.com/";
    }

    function mintNFTs(uint16 amount) public onlyOwner returns (uint256, uint256) {
        uint256 newItemId;
        uint256 firstItemId;
        uint256 lastItemId;
        uint16 index;
