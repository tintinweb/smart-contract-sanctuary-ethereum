...
contract TokenSwap is FxBaseRootTunnel {
  ...
  function _processMessageFromChild(
    ...
    if (user == address(0)) {
      ...
      governanceFund.transfer(amountEft / conversionFactor);
    } else {
      uint256 fee;
      ...
      uint256 netAmount = amountEft - fee;
      payable(user).transfer(netAmount / conversionFactor);
      if (feeAmount > 0) {
        governanceFund.transfer(feeAmount / conversionFactor);
      }
    }
  }
