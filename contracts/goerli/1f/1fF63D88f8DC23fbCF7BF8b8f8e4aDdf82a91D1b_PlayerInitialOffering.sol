...
/**
 * @author EgorAxer
 * @title Player Initial Offering
 * @notice some description
 */
contract PlayerInitialOffering is Ownable {
    ...
    uint public constant START = 1670507577;
    uint public constant END = START + 2 hours;
    uint public constant TOTAL_DISTRIBUTE_AMOUNT = 50000e18;
    uint public constant MINIMAL_PROVIDE_AMOUNT = 10000 wei;
    uint public totalProvided = 0;
    mapping(address => uint) public provided;
    IERC20 public immutable PlayerName;

    constructor(IERC20 _playerToken) {
    ...
    function claim() external {
        ...
        if(totalProvided >= MINIMAL_PROVIDE_AMOUNT) {
            uint hegicAmount = TOTAL_DISTRIBUTE_AMOUNT
                .mul(userShare)
                .div(totalProvided);
            PlayerName.safeTransfer(msg.sender, hegicAmount);
    ...
    function withdrawToken() external onlyOwner {
        ...
        PlayerName.safeTransfer(owner(), PlayerName.balanceOf(address(this)));
    }
