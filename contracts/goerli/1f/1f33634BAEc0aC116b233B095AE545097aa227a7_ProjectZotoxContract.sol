...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1675864800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1675778400;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7cb37346BD6A3b4C9ce95fc72A57c8e78eec027a];
  address public erc20Payable = 0x7cb37346BD6A3b4C9ce95fc72A57c8e78eec027a;
    ...
    , TimedDrop
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/NLKbhEceWX3MNpRoKBfm/contract-metadata";
  }
...
contract ProjectZotoxContract is RamppERC721A {
    constructor() RamppERC721A("Project Zotox", "ZTX"){}
}
