...
// File: contracts/artifacts/bridge.sol
...
contract TokenCustody is Ownable {
    ...
    event Locked(uint256 amount, address tokenAddress, string indexed aptosAddress, address indexed ethereumAddress);
    event Unlocked(uint256 amount, address tokenAddress, address indexed ethereumAddress, string indexed aptosHash);
