...
contract hkcTest is
    ...
    uint256 public generalMeowListSuppyPlusOne = 3001;
    ...
    function _mintMeowListReservedMerkle(
        ...
        uint256 totalClaim = premintedAmount[to] + amount;
        require(totalClaim < MAX_PRESALE_MINTS_PLUS_ONE, "Over max presale allowed");

        uint256 generalAmount = premintedAmount[to] + amount - 1;
    ...
    function mintMeowListCockadoodleHash(
        ...
        require(generalMeowMinted + generalAmount < generalMeowListSuppyPlusOne );
