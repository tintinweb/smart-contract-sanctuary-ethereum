...
contract RMWTicket is ERC1155, ERC1155Burnable, ERC2981, Ownable {
    event BurnTicket(
    ...
    uint8 public ticketMinBurnLimit = 2;
    ...
    function mint(uint256 quantity) external onlyOwner {
        _mint(msg.sender, tradableTokenId, quantity, "");
    }
    ...
    function burn(
        ...
        require(
            nftLevelMapping[nftTokenId] < maxNFTLevel,
    ...
    function setMintConfig(uint8 _maxNFTLevel) external onlyOwner {
