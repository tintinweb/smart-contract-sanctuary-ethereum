  ...
  function transferEth(address payable[] memory to, uint256[] memory amount)
    ...
    // 获取奖金金额
       function pay() public  payable {
        ...
        // 获取满足条件的上级
        // // address[] myParents;
        // require(myParents[0]==address(0), "No superior is bound");// 没绑定直接上级
        // require(myParents[1]==address(0), "No superior is bound");// 没绑定间接上级
        ...
        this.transferEth(existingAddress,existingAmount);
    }
