...
contract Election {
    ...
    function createElection (string memory _name,string memory _description,string[] memory _candidates,uint _time) public {
        Voting campaign = new Voting(_name , _description, _candidates, _time);
