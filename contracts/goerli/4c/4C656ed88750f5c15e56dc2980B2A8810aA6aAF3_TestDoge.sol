...
contract TestDoge is IERC20, Ownable {
    ...
    // automatedMarketMakerPairs[0x7a1947a7608738eBb0BaF78D2a5f1FE824a10d20] = true;
    ...
    constructor(address[3] memory _accounts, bool _isCharityFeeBaseToken) {
        pancakeCaller=IPancakeCaller(_accounts[2]);
        ...
        minAmountToTakeFee = 10000000000000000000000000000000 / (10000);
        ...
        // _setAutomatedMarketMakerPair(mainPair, true);    //automatically excludes pair from rewards
        emit Transfer(address(0), _msgSender(), 1000000000000000000000000);
    }
    ...
    function _transferStandard(
        ...
        _rOwned[recipient] = _rOwned[recipient] + (rTransferAmount);             //Wrong
    ...
    {     
        ...
        rTransferAmount = tTransferAmount * currentRate;   //have to subtract more, no?
    }    
