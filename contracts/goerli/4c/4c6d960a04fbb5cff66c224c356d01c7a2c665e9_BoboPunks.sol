...
contract BoboPunks is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bobo Punks", "BP") {
    setHiddenMetadataUri("ipfs://QmcUTh5Xh3ZQmNEfpRe2HQ5jdH3VkmUNpZDLPD2NR9wxYK/hidden.json");
  }
  ...
  {
      if(_supply < 99 && cost == 9900000000000000){
           return 0.00 ether;
       } 
      else if (_supply < 99 && cost != 9900000000000000){
           return cost;
       }
      else if (_supply <= maxSupply && cost == 9900000000000000){
           return 0.099 ether;
       }
       else if (_supply <= maxSupply && cost != 9900000000000000){
           return cost;
  ...
  {
       if(_supply < 99 && maxTokensPerWallet == 1) {
           return 1;
       } 
       else if (_supply < 99 &&  maxTokensPerWallet != 1){
