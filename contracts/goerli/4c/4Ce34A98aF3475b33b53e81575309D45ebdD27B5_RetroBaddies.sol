...
contract RetroBaddies is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC2981, ClampedRandomizer {
    ...
    uint public price = 8;//scaled by 0.001 eth

    uint public publicTime= 1679079600; // 	Fri Mar 17 2023 19:00:00 GMT+0000
        ...
        whenNotPaused 
    {
        ...
        require(supply + amount <= maxSupply, "Not enough RetroBaddies left for you");

        //transaction limits
        require(amount > 0,"you want to mint more than just air right?");
        require(amount <= maxPerTx, "You cant handle so many RetroBaddies at once");

        
        if (price > 0) 
        {
            require(msg.value >= price * 0.001 ether * amount, "You didnt send enough eth to mint");
        }
