...
contract PermitVault is Initializable, UUPSUpgradeable, Permit721, Permit1155, PausableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        __Ownable_init();
        __Pausable_init();
        __EIP712_init("PermitVault", "1");
        _platformFeeAddr = owner();
    }

    /**
     * @notice Function that should revert when msg.sender is not authorized to upgrade the contract. Called by upgradeTo and upgradeToAndCall.
     * @param   newImplementation new implamentation Address.
     */
    function _authorizeUpgrade(address newImplementation) internal override onlyOwner {}

    /**
     * @notice Transfer ETH to "to" param if the value is greater than 0 and "to" is not a Zero address
     ...
     * @param   actionType Internal Action Identifier.
