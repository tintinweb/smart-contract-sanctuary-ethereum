...
contract TestUniV3Pool {
  ...
  uint160 public sqrtPriceX96 = TickMath.getSqrtRatioAtTick(0);
  ...
  function burn(
    ...
    (_amount0, _amount1) = LiquidityAmounts.getAmountsForLiquidity(sqrtPriceX96, sqrtRatioAX96, sqrtRatioBX96, _amount);
  }
  ...
  function collect(
    ...
    IERC20(token0).transfer(_recipient, _amount0Requested);
    IERC20(token1).transfer(_recipient, _amount1Requested);
    _amount0 = _amount0Requested;
    _amount1 = _amount1Requested;
  }
