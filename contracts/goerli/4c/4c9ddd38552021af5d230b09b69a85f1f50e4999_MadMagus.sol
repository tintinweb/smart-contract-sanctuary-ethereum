...
contract MadMagus is ERC721, Ownable {
    ...
    IERC20 public tokenAddress = IERC20(0x669e0cB3E21ADDB44924653811423edd04E9e7fE);
    address public cofounder = 0xf32a7C58F80B9a354d55e24B0495d24f0C2983D3;


    string public uriPrefix = "https://github.com/cryptonft/madmagus/raw/main/"; //github
    ...
    function claylistMint(uint qty) external payable {
        require(qty+ totalSupply() <= maxSupply, "ERROR: Sold out");
        tokenAddress.transferFrom(msg.sender, address(0x0000000000000000000000000000000000000000), rate);         //pay $clay
    ...
    function withdrawOwner() external onlyOwner {
        if(totalSupply() == maxSupply){
            payable(cofounder).transfer(address(this).balance/5);
        }
    ...
    function setTokenAddress(address _tokenAddress, uint256 _rate) external onlyOwner {
