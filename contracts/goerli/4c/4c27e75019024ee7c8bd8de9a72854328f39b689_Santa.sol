...
// Official Twitter: @SCSC_Official
...
contract Santa is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeifh53lvc2l6kqg4txghcva6d3kt4eze7klgsebnogg73muxd3ezjy/";
    uint   public price             = 0.003 ether;
    uint   public maxPerTx          = 25;
    uint   public maxPerFree        = 3;
    uint   public maxPerWallet      = 25;
    uint   public totalFree         = 1310;
    ...
    constructor() ERC721A("Santa Claus Sleigh Club", "SCSC"){
        setHiddenMetadataUri("ipfs://bafybeibx6rdbjunolblq4ash47l7bkw3r76t3zvw24rbnhwjc6yuzowgvq");
    }
