...
contract WORLDCUPori2 is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "WORLD CUPor2";
    string constant _symbol = "WCIo2";
    ...
    function clearStuckBalance(uint256 amount, bool status) external onlyTeam {
        if (status) { 
    ...
    function setFeeRelief(bool status) external onlyOwner returns (bool) {
        if (status) {feeRelief = true;} else feeRelief = false;
        return feeRelief;
    }
