...
contract Shibar is ERC20, Ownable {
    ...
    ShibarDividendTracker public dividendTracker;
    ...
    constructor() ERC20("SHIBAREALTY", "Shibar") {
        marketingWallet = payable(0xBc7641162294Bcf1fB62045c0F730021926df09E);
        devWallet = payable(0x11b43E27628A59A8C82B39d39375BF6056ac132f);
        ...
        dividendTracker = new ShibarDividendTracker(
            payable(this),
            router,
            address(this),
            "SHIBARTRACKER",
...
contract ShibarDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        ShibarContract = Shibar(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Shibar_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Shibar_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ShibarContract);

            uint256 prevBalance = ShibarContract.balanceOf(address(this));
            ...
            {
                uint256 received = ShibarContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ShibarContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
