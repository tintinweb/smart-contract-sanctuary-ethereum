...
contract CryptotronLottery is VRFConsumerBaseV2, AutomationCompatibleInterface {
   ...
   */
    function checkUpkeep(
        ...
        bool timePassed = block.timestamp > drawDate;
    ...
    function activate(
        ...
        uint256 newDrawDate
            ...
            cti.setDrawDate(drawDate);
            cti.setStateOpen();

            isLotteryActive = true;
            
            emit LotteryActivated(nftAddress, rewardTokenAddress, drawDate);
    }
   ...
   */
    function refund() public onlyIfLotteryIsActive{
        if (isDrawFailed == true || block.timestamp > drawDate + ONE_DAY_IN_SEC) {
            revert();
        }
