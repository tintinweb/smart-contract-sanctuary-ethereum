...
contract UtilitiDemo is ERC721, Ownable {
    address private _trustedForwarder;

    constructor() ERC721("UtilitiV2", "UtilitiV2") {
    }

    // ERC721 Functions
    function _baseURI() internal pure override returns (string memory) {
        return "https://api.herogalaxy.io/token/";
    }
    ...
    // EIP-2771 (Meta Transaction) Functions
    ...
    function foobar() public onlyOwner {
