...
contract BasicNft is ERC721URIStorage, ERC2981, Ownable {
    ...
    function mintNft() public onlyOwner {
        ...
        emit DogMinted(newItemId);

        s_tokenCounter.increment();
    }

    function mintNFTWithRoyalty(address royaltyReceiver, uint96 feeNumerator) public onlyOwner {
        uint256 newItemId = s_tokenCounter.current();
        mintNft();
