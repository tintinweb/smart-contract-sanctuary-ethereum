...
contract ZombunniesDistributor is AccessControl {
    ...
    uint256 public mintPriceWhitelist = 0.001 ether; //TODO: Price change
    uint256 public mintPricePublicSale = 0.002 ether; //TODO:  price change

    uint256 public burnToMintCap = 100; //TODO: mainnet: 3024;
    uint256 public bunrToMintCount;

    uint256 public mintCap = 100; //TODO: mainnet: 1974;
    uint256 public mintCount;

    uint256 public whitelistMintCap = 66; //TODO: mainnet: 666;
    uint256 public whitelistMintCount;

    uint256 public maxMintAllowed = 10;
    uint256 public totalBunniesSacrifised;
    ...
    mapping(uint256 => uint256[]) public sacrifisedChainbunnies;
        ...
        returns (bool)
    {
        ...
        require(
            bunrToMintCount + 1 <= burnToMintCap,
        ...
        for (uint256 index = 0; index < tokensLength; index++) {
            ...
            sacrifisedChainbunnies[nextZombunnyId].push(_tokenIds[index]);
        }

        bunrToMintCount++;
        totalBunniesSacrifised += 2;
    ...
    function getSacrifiesBunnies(uint256 _zomBunnyID)
        external
        view
        returns (uint256[] memory _sacrifisedChainbunnies)
    {
        _sacrifisedChainbunnies = sacrifisedChainbunnies[_zomBunnyID];
    }
