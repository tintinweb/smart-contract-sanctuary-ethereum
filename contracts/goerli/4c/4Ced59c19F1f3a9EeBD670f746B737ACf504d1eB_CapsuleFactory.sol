...
contract CapsuleFactory is Initializable, Governable, CapsuleFactoryStorage {
    ...
    /// @dev It will prevent this contract from being initialized and thus lock implementation contract.
    constructor() {
        _disableInitializers();
    }
     ...
     *****************************************************************************/
    /**
     * @notice Create a Capsule NFT Collection which the IronCapsule can manage
     */
    ...
    /// @notice Set IronCapsule address. This method can only be called once.
    function setIronCapsule(address _newIronCapsule) external onlyGovernor {
        require(_newIronCapsule != address(0), Errors.ZERO_ADDRESS);
        // Below check will make sure we only set minter once
        require(ironCapsule == address(0), Errors.NON_ZERO_ADDRESS);
        ironCapsule = _newIronCapsule;
    }
