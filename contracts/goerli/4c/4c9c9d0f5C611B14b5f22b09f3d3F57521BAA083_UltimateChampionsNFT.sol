...
contract UltimateChampionsNFT is ERC721Enumerable, Multicall, AccessControl {
    ...
    constructor() ERC721("UltimateChampionsNFT", "CHAMP") {
    ...
    function safeMint(string memory ipfsMedataURI) public onlyRole(PREDICATE_ROLE) returns (uint256) {
        _tokenIds.increment();
