...
contract LBSKR is BaseBSKR, DSMath, Stakable {
    ...
    event Debug04L(uint256 lbskrSent, uint256 bskrSent);
    event Debug05L(
        string msg,
        address user,
        uint256 amountLBSKR,
        ...
        returns (uint256 bskrAmount)
    {
        ...
        _approve(owner, owner, tokenAmount); // allow this contract to spend its tokens
        _approve(owner, address(_dexRouterV2), tokenAmount); // allow router to spend contract's tokens
        ...
        whenNotPaused
    {
        ...
        emit Debug04L(lbskrToSend, bskrToSend);
    }
