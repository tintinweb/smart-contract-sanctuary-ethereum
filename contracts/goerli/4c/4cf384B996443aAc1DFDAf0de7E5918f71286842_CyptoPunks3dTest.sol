...
contract CyptoPunks3dTest is ERC721, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(
        address _ExistingERC1155,
        address usdt,
        address usdc,
        address dai,
        address busd,
        uint256 _currentEthPrice
    ) ERC721("Crypto3d", "C3d") {
        // constructor() ERC721("CyptoPunks3d", "CP3d") {
        // ExistingERC1155 = 0x3c1601b2513A3F489b5034fba4c41F1f1f87CF08;
    ...
    //  Should we force the nftIds to be complete.
    ...
    function getPriceForARound(
        ...
        for (uint256 i = 0; i < 6; i++) {
            if (isEther) {
                uint256 amountinWei = (priceCardInDollar[round][i] * (10**20)) /
                    EtherPrice;
