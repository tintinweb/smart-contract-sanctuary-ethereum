...
/**
  @title A contract for Choir Genesis notes.
  @author Liam Clancy
  @author Tim Clancy

  This is the contract for Choir Genesis notes. It is a thin veneer of a
  contract used to control the contract display name on Etherscan.

  May 2nd, 2022.
*/
contract ChoirGenesis is
  Tiny721
{
  ...
  */
  constructor (
    ...
    uint256 _cap
  ) Tiny721(_name, _symbol, _metadataURI, _cap) {
  }
}
