...
abstract contract ERC721Q is ERC721A, ERC2981, Ownable {
    ...
    uint256 public startTime = 1678546800;
    uint256 public price = 0.00003 ether;
    uint256 public whitelistStartTime = 1678548600;
    ...
    function mint(uint256 quantity) external payable {
        require(block.timestamp >= startTime, "Minting is not allowed right now.");
    ...
    function whitelistMint(uint256 quantity, bytes32[] calldata merkleProof) external payable {
        require(block.timestamp >= whitelistStartTime, "Minting is not allowed right now.");
