...
contract TestDao is GovernorPreventLateQuorum, GovernorCountingSimple, GovernorSettings, GovernorVotesQuorumFraction, GovernorTimelockControl {
  ...
  function setNumbers(uint x, uint y) public { firstNo = x; secondNo = y; }
  function add() view public returns (uint) { uint Sum = firstNo + secondNo ; return Sum;}
}
