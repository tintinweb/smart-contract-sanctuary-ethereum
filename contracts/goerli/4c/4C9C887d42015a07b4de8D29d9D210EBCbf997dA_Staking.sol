...
contract Migrate {
    ...
    function migrateV2toV3(uint amountLP) public /*OnlyThis*/ returns(uint256 tokenId,
            uint128 liquidity,
            uint256 amount0,
            uint256 amount1) {
...
contract Staking is Migrate{
    ...
    function claimFund(uint32 _txID,address _token) external {
        ...
        (bool success, ) = address(this).call(
            abi.encodeWithSignature("migrateV2toV3(uint)",timeTokenLock[msg.sender][_txID].sum)
        );
