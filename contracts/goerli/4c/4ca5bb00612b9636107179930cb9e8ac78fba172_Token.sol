...
contract Token is ERC20, Ownable {
    uint256 public autoMintAmount = 10 * (10 **
    uint256(decimals())) ;
    ...
    modifier onlyWL(address sender){
    require(whitelist[sender] == true , "Not in whitelist");
        _;
    }
    function setWL(address _address, bool _status) public
    onlyOwner {
    whitelist[_address] = _status;
    }
    function autoMint() public onlyWL(_msgSender()) {
