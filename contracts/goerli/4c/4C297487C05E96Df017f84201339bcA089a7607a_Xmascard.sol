...
contract Xmascard is ERC721A, ReentrancyGuard, Ownable {
    using Address for address;
    string private _tokenUriBase;

    event Mint(address user, uint256 quantity);

    mapping(address => bool) private _mintedAddress;
    IERC721 private drugReceiptToken;

    constructor(address _drugReceiptToken) ERC721A("Xmas Card", "XmasC") {
    ...
    {        
        ...
        require(
            _mintedAddress[msg.sender] == false,
