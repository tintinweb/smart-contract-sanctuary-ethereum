...
contract SuperMetaMarketplace is OwnableUpgradeable, ERC1155Upgradeable, RevokableDefaultOperatorFiltererUpgradeable {
    ...
    mapping (uint256 => string) private tokenIdToMongoId;
    ...
    function whitelistTokenId (uint256 _priceOfToken, uint256 _tokenLimit, string calldata _mongoId, address _artist) external onlyController {
