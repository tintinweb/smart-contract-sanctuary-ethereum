...
contract AtlendisLockdrop is BaseLockdrop {
        ...
        )
    {
        ...
        (address underlyingToken, , , , , , , , , , ) = IPoolsController(poolsController).getPoolParameters(poolHash);
        require(underlyingToken != address(0), "Wrong pool hash");
    }
...
contract LockdropFactory {
    ...
    address immutable poolsController;
    ...
    constructor(AtlendisToken _token, address _poolsController, address _positionManager) {
        token = _token;
        poolsController = _poolsController;
