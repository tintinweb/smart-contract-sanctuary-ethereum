...
contract CONNORS is ERC721, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public publicMintPrice = 0.069420 ether;
    uint256 public whitelistMintPrice = 0.069420 ether;
    ...
    function mint(bytes32[] memory _proof, bytes32 _leaf) public payable {
    ...
    function mintPublic() public payable supplyChecks(1) {
        ...
        if(mintedByAddressPublic[msg.sender] >= mintLimitPerWalletPublic) { revert PublicConditionsNotMet(); }
    ...
    function mintWhitelist(bytes32[] memory _proof, bytes32 _leaf) public payable supplyChecks(1) {
        ...
        if(mintedByAddressWhitelist[msg.sender] >= mintLimitPerWalletWhitelist) { revert PublicConditionsNotMet(); }
        
        mintedByAddressWhitelist[msg.sender] ++;
        amountMinted++;
        _safeMint(msg.sender, amountMinted);
