  ...
  AccessControl
{
  ...
  function subscribe(address to) public onlyRole(MANAGER) whenNotPaused {
    ...
    require(isSubscribed(to) == false, 'MAX_MINT_REACHED');
  ...
  function _beforeTokenTransfer(
    ...
    if (to == address(0)) {
      ...
      delete subscribersList[subscribersListIndex[msg.sender]];
      delete subscribersListIndex[msg.sender];
    }
  }
