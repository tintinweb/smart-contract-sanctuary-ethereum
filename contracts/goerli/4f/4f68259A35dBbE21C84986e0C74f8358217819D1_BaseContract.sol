 ...
 * @dev Extends ERC721A
 */
contract BaseContract is ERC721A, Seller, ReentrancyGuard {
    ...
    constructor(
        ...
        // allowlist sale 
        setAllowlistSale(1666252112, 1209600, 20000000000, 5, 0xbE3e96404FB53BcaF2bC623e66FFaF9c6a912A45, false);
        // waitlist sale 
        setWaitlistSale(1666252112, 1209600, 20000000000, 5, 0xbE3e96404FB53BcaF2bC623e66FFaF9c6a912A45, false);
        // public sale
        setPublicSale(1666252112, 1209600, 20000000000, 5);
    }
    ...
    */
    function allowlistMint(uint256 quantity, bytes calldata mintKey) external payable nonReentrant {
        require(totalSupply() + quantity <= COLLECTION_SIZE, "purchase would exceed max supply");
        verifyAllowlist(quantity, mintKey);
        _safeMint(msg.sender, quantity);
    }
    function waitlistMint(uint256 quantity, bytes calldata mintKey) external payable nonReentrant {
        require(totalSupply() + quantity <= COLLECTION_SIZE, "purchase would exceed max supply");
        verifyWaitlist(quantity, mintKey);
        _safeMint(msg.sender, quantity);
    }
