...
contract TKMC is ERC721, Ownable, ReentrancyGuard, Pausable {
    ...
    IERC20 public USDT = IERC20(0xD5Dd6E3DF9B7dA35e746d099a61F64A47B92a448);
        ...
        callerIsUser
    {
        ...
        if (USDT.allowance(msg.sender, address(this)) < preSaleCost * _amount)
            revert InsufficientValue();
        USDT.transferFrom(msg.sender, address(this), preSaleCost * _amount);
    ...
    function mint(uint8 _amount) external callerIsUser {
        ...
        if (addressMintedBalance[msg.sender] + _amount > maxMintAmount)
            revert MaxPerWalletExceeded();
        if (USDT.allowance(msg.sender, address(this)) < publicCost * _amount)
            revert InsufficientValue();
        USDT.transferFrom(msg.sender, address(this), publicCost * _amount);
