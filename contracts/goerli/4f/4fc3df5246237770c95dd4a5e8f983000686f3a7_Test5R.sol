...
contract Test5R is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Test5R", "TEST5") {
    ...
    function refund(uint256[] calldata tokenIds) external {
        require(isRefundGuaranteeActive(), "Refund period not active");
    ...
    function setRefundPeriod(uint _time) public onlyOwner {
        refundPeriod = _time;
    }
