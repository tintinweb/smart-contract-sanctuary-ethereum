  ...
  PaymentSplitter
{
  ...
  string public notRevealedUriBase =
    'ipfs://QmYUuwLoiRb8woXwJCCsr1gvbr8E21KuxRtmVBmnH1tZz7/'; // Done
  ...
  uint256 _priceWhiteListSale = 10000000000000000; // 0.01 ETH
  uint256 _pricePublicSale = 20000000000000000; // 0.02 ETH
  ...
  function presaleMint(
    ...
    require(
      ...
      "MetaJetz Sparrow 977: You can't mint so much tokens"
    );
    require(
  ...
  function publicSaleMint(uint256 _amount) external payable onlyAccounts {
    require(publicM, 'MetaJetz Sparrow 977: PublicSale is OFF');
    require(!paused, 'MetaJetz Sparrow 977: Contract is paused');
