...
contract Marketplace is Ownable {
    ...
    function initialize(address _owner, address _acceptedToken) public {
        require(_owner != address(0), "Marketplace#constructor: INVALID_OWNER");
        transferOwnership(_owner);

        require(
            _acceptedToken != address(0),
            "Marketplace#constructor: INVALID_ACCEPTED_TOKEN"
        );
    ...
    function _createOrder(
        ...
        console.log("assetOwner: %s", assetOwner);
        ...
        require(
            expiresAt > block.timestamp + 1 minutes,
    ...
    function _requireERC721(address nftAddress) internal view {
        require(
            ...
            "MarketplaceV2#_requireERC721: INVALID_NFT_ADDRESS"
        );
    ...
    function _executeOrder(
        ...
        require(
            ...
            "MarketplaceV2#_executeOrder: INVALID_SELLER"
        );
        require(
            order.seller != sender,
        ...
        require(
            acceptedToken.transferFrom(sender, order.seller, price),
