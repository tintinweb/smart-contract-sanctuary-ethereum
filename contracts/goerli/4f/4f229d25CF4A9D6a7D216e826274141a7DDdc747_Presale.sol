...
contract Presale {
    bytes32 public merkleRoot =
        0xeae37cba888464e7c99d122d4cb312fd4222d12c538ece3e283b1e400d8cd75c;

    uint public publicPrice; // Divide by 100 to get actual value
    uint public privatePrice; // Divide by 100 to get actual value
    uint public maxAlloc; // Value for public. Double it for private
    ...
    function enterPublic(uint _tokenAmount) public {
        ...
        uint price = (_tokenAmount * publicPrice) / 100;
    ...
    function enterPrivate(
        ...
        require(presaleIsOpen == true, "Presale is closed");
        require(
            alloc[msg.sender] + _tokenAmount <= maxAlloc * 2,
            "Max alloc reached"
        );
        ...
        uint price = (_tokenAmount * privatePrice) / 100;
        IERC20(stable).transferFrom(msg.sender, address(this), price);
        alloc[msg.sender] += _tokenAmount;
    }
