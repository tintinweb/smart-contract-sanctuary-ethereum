...
contract KeenVerse is ERC721A, Ownable {
    ...
    constructor(uint8[] memory _phases, uint256[] memory _supply) ERC721A("KeenVerse Genesis", "KeenVerse Genesis"){
    ...
    uint64 public maxSupply = 22;
    uint64 public maxPerWallet = 1;
    uint8 public mintPhase;
    
    bool keenverseEnabled = false;
    ...
    function setURI(string memory _URI_UNREVEALED, string memory _URI_BASE)
        external 
        onlyOwner 
    {
