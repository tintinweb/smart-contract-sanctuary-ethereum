    ...
    ReentrancyGuard
{
    ...
    // uint256 public constant maxEarlySupply = 1000; // D-Day mainnet value
    uint256 public constant maxEarlySupply = 3; // For tests only
    ...
    function activateWeek(uint256 weekId) public {
        _tokenActivated[(2 * weekId) - 1] = true;
        _tokenActivated[(2 * weekId)] = true;
    }

    function deactivateWeek(uint256 weekId) public {
