...
contract MyMasterchef {
    ...
    event UpdatePool(uint256 pid, uint256 rdxReward, uint256 accRdxPerShare, uint256 lastRewardBlock);
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.lastRewardBlock = block.number;
        emit UpdatePool(_pid, rdxReward, pool.accRdxPerShare, pool.lastRewardBlock);
    }
