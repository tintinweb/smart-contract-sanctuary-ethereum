...
interface IMAsterChef{
	function depositFromDaaAndDAO(uint256 _pid, uint256 _amount, uint256 vault, address _sender) external;
...
contract PoolV2 is ReentrancyGuard,Initializable {
    ...
    */
	function stakeAstra(uint _amount)internal{
		...
		IMAsterChef(poolChef).depositFromDaaAndDAO(0,_amount,6,msg.sender);
	}	
