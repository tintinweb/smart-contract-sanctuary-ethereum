...
//Make Funds in this contract
//Withdraw fund from this contract
//Set minimum amount patable in USD
...
contract FundMe {
    ...
    //When deploy our contract it also has its own address just like account address in a wallet
    //Both can hold native blockchain token just like Ethereium, Avalanche, Polygon
    ...
    function fund() public payable {
        ...
        // How to send ETH through contracts
        require(
            msg.value.getConversionRate(priceFeed) >= minimumUSD,
            "Didn't Send Enough Ether"
        ); //1x10^18 Wei = 1ETH
        address addressOfFunder = msg.sender;
        addressToAmountFunded[addressOfFunder] += msg.value;
        funders.push(addressOfFunder);
    }
