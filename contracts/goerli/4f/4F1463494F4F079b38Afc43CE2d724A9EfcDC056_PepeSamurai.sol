...
contract PepeSamurai is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant MAX_TOKENS = 1366;
    uint256 public price = 0.0003 ether;
    uint256 public whitelistSalePrice = 0.0002 ether;
    uint256 public ogSalePrice = 0.0001 ether;
    uint256 public maxPerOGWallet = 2;
    uint256 public maxPerWLWallet = 2;
    uint256 public maxPerWallet = 3;
    // update this to owner address
    address public constant w1 = 0x8A3b76324087283CeC738722191A0e6aB54e38ad;
    ...
    mapping(address => uint256) private _ogMints;
    ...
    constructor() ERC721A("Pepe Samurai", "PSM") {}
        ...
        payable
    {
        ...
        require(
            _whitelistMints[_msgSender()] + tokens <= maxPerWLWallet,
