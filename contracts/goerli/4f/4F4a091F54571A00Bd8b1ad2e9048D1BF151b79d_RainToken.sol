...
contract RainToken is Initializable, ERC20PausableUpgradeable, AccessControlUpgradeable {
    ...
    /// @notice Freeze user wallet funds, only compliance officers can call this fucntion
    /// @param account The wallet address needed to freeze
    ...
    /// @notice Unfreeze user wallet funds, only compliance officers can call this fucntion
    /// @param account The wallet address needed to unfreeze
    ...
    /// @notice Check whether the wallet funds is frozen or not
