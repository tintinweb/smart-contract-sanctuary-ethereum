...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1666209600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1666209600;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x60A4FeDE54619947d71A707E9E18A6D76B99e0dd];
  address public erc20Payable = 0x60A4FeDE54619947d71A707E9E18A6D76B99e0dd;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeie3fvpmwnhu7ha4dwwla7h2thzsodetwnjm7dll33tvh5gpfajy4m/";
...
// File: contracts/OkaypumpkinsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OkaypumpkinsContract is RamppERC721A {
    constructor() RamppERC721A("OKAY PUMPKINS", "OKPUMPKIN"){}
}
