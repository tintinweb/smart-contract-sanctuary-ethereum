...
contract DEX {
     ...
     */
    event EthToTokenSwap(address user, string description, uint256 value, uint256 tokens);

    /**
     * @notice Emitted when tokenToEth() swap transacted
     */
    event TokenToEthSwap(address user, string description, uint256 value, uint256 tokens);

    /**
     * @notice Emitted when liquidity provided to DEX and mints LPTs.
     */
    event LiquidityProvided(address user, uint256 liquidity, uint256 amount, uint256 tokens);

    /**
     * @notice Emitted when liquidity removed from DEX and decreases LPT count within DEX.
     */
    event LiquidityRemoved(address user, uint256 liquidity, uint256 amount, uint256 tokens);
