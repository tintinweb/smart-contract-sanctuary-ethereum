...
contract AaveStat {
    ...
    function getUserAssets(CalcuParam memory param) internal view returns (UserAssets memory){
        ...
        userAssets.supplyList = new AssetDetail[](param.reserves.length);
        userAssets.borrowList = new AssetDetail[](param.reserves.length);
