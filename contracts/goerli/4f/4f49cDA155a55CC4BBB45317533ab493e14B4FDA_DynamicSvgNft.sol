...
contract DynamicSvgNft is ERC721 {
    ...
    string private constant base64SvgEncodedPrefix = "data:image/svg+xml;base64,";
    ...
    function mint(int256 highValue) public {
        s_tokenIdToHighValue[tokenCounter] = highValue;
    ...
    function svgToImageURI(string memory svg) public pure returns (string memory) {
        ...
        return string(abi.encodePacked(base64SvgEncodedPrefix, svgBase64Encoded));
    }
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name": "',
                                name(),
                                '", "description":"An NFT that changes based on the Chainlink Price Feed", "attributes": [{"trait_type": "coolness", "value": 100}], "image": "',
                                imageURI,
                                '" }'
                            )
                        )
