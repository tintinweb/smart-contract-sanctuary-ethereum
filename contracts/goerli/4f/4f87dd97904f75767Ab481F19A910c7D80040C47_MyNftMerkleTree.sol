...
contract MyNftMerkleTree is ERC721 {
    ...
    function setRoot(bytes32 _root) external {
        ...
        // "https://gateway.pinata.cloud/ipfs/QmeYjuj37RpJmNFSPcpycCC3nvH66wZKj47qJ8AaoDRNjh/"; open
        // "https://gateway.pinata.cloud/ipfs/QmYjCW6GMfucPLTGNK51KJqsvdezHL3K3b6xctSsvHvqs3/"; mystery

    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        _requireMinted(_tokenId);
        if(isMystery){
            return string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmeYjuj37RpJmNFSPcpycCC3nvH66wZKj47qJ8AaoDRNjh/", _tokenId.toString(), ".json"));
        }
        return bytes(baseURI).length > 0 ? string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmeYjuj37RpJmNFSPcpycCC3nvH66wZKj47qJ8AaoDRNjh/", _tokenId.toString(), ".json")) : "";
    }
    struct Auction {
        uint256 startTime;
        uint256 timeStep;
