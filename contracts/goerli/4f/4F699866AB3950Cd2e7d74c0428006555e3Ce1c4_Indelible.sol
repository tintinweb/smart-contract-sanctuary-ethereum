...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Accessories", unicode"Body", unicode"Head", unicode"Background"];
    bool private shouldWrapSVG = true;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0x9bacd173162556beb93a3ac1a1b0f870c7212cd9d6aea28ec3591b105f435911;
    ...
    ContractData public contractData = ContractData(unicode"Tes2", unicode"Test 🤝 Description", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/4f3e25fc-3729-439f-9b13-79a8189b1fcd", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/4f3e25fc-3729-439f-9b13-79a8189b1fcd", "https://bbc.com/", 0, "0x1f1177e1EA1D5f7761B7A9083af1064369303E30");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Tes2", unicode"TTS") {
        tiers[0] = [10,10];
        tiers[1] = [10,10];
        tiers[2] = [10,10];
        tiers[3] = [10,10];
