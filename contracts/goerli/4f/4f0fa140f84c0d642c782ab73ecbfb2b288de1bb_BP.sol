...
contract BP is ERC20, Ownable {
    ...
    constructor() ERC20("BPS", "BP") payable {
    ...
    */
    ...
    function updateValidatorAPR(uint256 _apr) external onlyOwner {
        require (_apr != apr[0], "Bounty Protocol : can not update apr to same value!");
        apr.push(_apr);
    }
