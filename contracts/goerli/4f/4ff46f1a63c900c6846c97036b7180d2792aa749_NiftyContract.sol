...
contract NiftyContract is ERC721A, Ownable, DefaultOperatorFilterer {
  ...
  address public couponSigner = 0x818EbA749c2B52CfD2e8E4dA25ec3a5c80E1E759;

  string public revealedURI;
  string public prevealURI;
  ...
  function setRevealedURI(string calldata _newURI) external onlyOwner {
    revealedURI = _newURI;
  }

  function setPrevealedURI(string calldata _newURI) external onlyOwner {
    prevealURI = _newURI;
  }
