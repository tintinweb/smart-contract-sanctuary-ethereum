...
contract DummyAdapterForTest {
  ...
  event Create2(bytes32);

  constructor() {
    emit Create2(keccak256(type(OracleSidechain).creationCode));
    console.logBytes32(keccak256(type(OracleSidechain).creationCode));
  }
  ...
  function bridgeObservations(
    ...
    _to.addObservations(_observationsData, _token0, _token1, _fee);
