...
contract MintableERC1155V2 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function uri(uint256 _id) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(_uri, StringsUpgradeable.toString(_id), "x.json"));
    }
