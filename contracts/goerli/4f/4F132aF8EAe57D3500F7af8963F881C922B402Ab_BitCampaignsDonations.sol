...
contract BitCampaignsDonations is Ownable
{
    ...
    constructor() {
        donationWalletAddress = address(0); //Hardcode later
        feeWalletAddress = address(0); //Hardcode later
        adminWalletAddress = address(0); //Hardcode later
    ...
    function donateETH(string memory campaignRef) public payable {

        require(donationEnabled, "Donations Are Not Enabled");
    ...
    function donateERC20(address erc20Contract, uint256 amount, string memory campaignRef) public {
