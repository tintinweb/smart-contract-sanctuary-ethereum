...
contract CryptotronLottery is VRFConsumerBaseV2, AutomationCompatibleInterface {
   ...
   */
    function refund() public isActive {
        if (isDrawFailed == false /* || block.timestamp < _drawDate + ONE_DAY_IN_SEC*/ && alreadyRefunded == true) {
            revert();
        }
   ...
   */
    function reset() internal notFailed isActive {
