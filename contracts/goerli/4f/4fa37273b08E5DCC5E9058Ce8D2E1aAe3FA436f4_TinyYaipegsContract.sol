...
//
//   _______                __  __      _                      
//  /_  __(_)___  __  __    \ \/ /___ _(_)___  ___  ____ ______
//   / / / / __ \/ / / /     \  / __ `/ / __ \/ _ \/ __ `/ ___/
//  / / / / / / / /_/ /      / / /_/ / / /_/ /  __/ /_/ (__  ) 
// /_/ /_/_/ /_/\__, /      /_/\__,_/_/ .___/\___/\__, /____/  
//             /____/                /_/         /____/        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF0F48c2AaFbeADabc9cd030D11a60c873040B2E5];
  address public erc20Payable = 0xF0F48c2AaFbeADabc9cd030D11a60c873040B2E5;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 133;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiaytf67jx4lugbzzvlhrgrmd6at47efair4zetouc6p5bcdfqifgm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/pad1n4qZDCo7Rv4pM7eh/contract-metadata";
  }
...
// File: contracts/TinyYaipegsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TinyYaipegsContract is RamppERC721A {
    constructor() RamppERC721A("Tiny Yaipegs", "Yai"){}
}
