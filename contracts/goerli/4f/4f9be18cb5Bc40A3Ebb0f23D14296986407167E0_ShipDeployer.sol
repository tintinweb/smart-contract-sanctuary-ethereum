...
contract ShipDeployer is IDeployerEvents, IDeployerActions, Ownable {
    ...
    address public CAPTAIN_PASS_NFT;
    ...
    function setCaptainPass(address _nft) public onlyOwner {
        CAPTAIN_PASS_NFT = _nft;
    }
}
    ...
    CaptainGuard
{
    ...
    constructor(
        ...
        ListModule(_seaport, _conduit, _royaltyEngine, _sailHelper)
    {
