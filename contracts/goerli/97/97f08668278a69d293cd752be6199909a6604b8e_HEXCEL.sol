...
contract HEXCEL is Context, IERC20, Ownable {
    ...
    bool walletFeeInETH = false;
    bool walletCharityFeeInETH = false;
    ...
    constructor(
        ...
        walletFeeInETH = wallet.walletFeeInETH;
        walletCharityFeeInETH = wallet.walletCharityFeeInETH;
        ...
        require(
            fee.setRewardFee >= 3 && fee.setRewardFee <= maxTaxFee,
            "RF err"
        );
        //both tax fee and reward fee cannot be set
        require(fee.setRewardFee == 3 || fee.setTaxFee == 0, "RT fee err");
