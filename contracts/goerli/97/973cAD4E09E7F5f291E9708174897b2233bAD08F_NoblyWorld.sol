...
contract NoblyWorld is ERC721, Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => BuyInfo[]) public _buyers;
 ...
 //   constructor() ERC721("Nobly World", "NoblyWorld") {
    constructor() ERC721("Test World", "TestWorld") {
        ...
        _setBaseURI("https://gateway.pinata.cloud/ipfs/QmePJtPpfjLB6rR7zCKtH8YTrGwKPjmdonvUDUg7ZnUAQV/");
    }
