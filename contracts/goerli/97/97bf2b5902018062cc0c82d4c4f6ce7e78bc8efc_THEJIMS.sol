...
contract THEJIMS is Ownable, ERC721A, ReentrancyGuard {
    ...
    function mint(bytes32 _hashedMessage, uint8 _v, bytes32 _r, bytes32 _s,uint256 quantity) public payable {
        address verifyAddress = VerifyMessage(_hashedMessage,_v,_r,_s);
        // bytes32 messageHash = hashTransaction(msg.sender, quantity, address(this));
        require(verifyAddress == msg.sender, "Signature not verified");
