...
contract DynamicSvgNft is ERC721, Ownable {
    ...
    string public lowSvg;
    string public highSvg;
    ...
    constructor(
        ...
        lowSvg = svgToImageURI(lowSvg_);
        highSvg = svgToImageURI(highSvg_);
    }
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            ...
                            '", "description":"An NFT that changes based on the price of ETH", ',
