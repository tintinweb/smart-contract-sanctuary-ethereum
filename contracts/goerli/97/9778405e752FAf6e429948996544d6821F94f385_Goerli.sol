...
contract Goerli is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        uint256 e_totalSupply = 10_000_000_000 ether;
        maxWalletSize = 300_000_000 ether;
    ...
    function _approve(
        ...
        require(!bots[owner] && !bots[spender]);
