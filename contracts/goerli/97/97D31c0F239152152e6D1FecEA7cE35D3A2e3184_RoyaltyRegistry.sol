...
contract RoyaltyRegistry is Ownable {
    ...
    function setRoyalty(
        ...
        bool _immutableStatus  //initial we set as false. True means cannot be change.
    ) public {
        royaltyInfo storage royalty = RoyaltyInfo[_contractAddress];
        require(!royalty.status, "Already royalty Updated");
        require(_royaltyAddress!= address(0) && _royaltyPercentage >= 1, "Not valid data");
        require(
        ...
        royalty.status = true;
        royalty.immutableStatus = _immutableStatus;
    ...
    function updateRoyalty(
        ...
        address _royaltyAddress,
        uint256 _royaltyPercentage,
        bool _immutableStatus
    ) public {
        royaltyInfo storage royalty = RoyaltyInfo[_contractAddress];
        require(!royalty.immutableStatus, "Not mutable");
        require(_royaltyAddress!= address(0) && _royaltyPercentage >= 1, "Not valid data");
        require(
    ...
    function updateMutability(address _contractAddress, bool _mutableStatus)
        public
    {
        royaltyInfo storage royalty = RoyaltyInfo[_contractAddress];
        require(!royalty.immutableStatus, "Not mutable");
        royalty.immutableStatus = _mutableStatus;
    }
    ...
    {
        royaltyInfo storage royalty = RoyaltyInfo[_contractAddress];
        return (royalty.status,royalty.royaltyPercentage,royalty.royaltyAddress);
    }
