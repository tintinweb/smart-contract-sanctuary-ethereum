...
contract JM is ERC721, ReentrancyGuard, DefaultOperatorFilterer, Ownable {
    
    uint256 public price = 10000000000000000; //0.01 ETH
    uint256 public constant MAX_SUPPLY = 1000;

    constructor() ERC721("JM", "JM") {}
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "JM #',
                        toString(tokenId),
                        '", "description": "JM", "image": "data:image/svg+xml;base64,',
