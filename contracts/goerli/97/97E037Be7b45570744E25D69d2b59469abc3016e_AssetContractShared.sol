...
contract AssetContractShared is AssetContract, ReentrancyGuard {
     ...
     */
    function addSharedProxyAddress(address _address) public _onlyOwner {
     ...
     */
    function disableMigrate() public _onlyOwner {
     ...
     */
    function migrate(Ownership[] memory _ownerships) public _onlyOwner {
...
contract AssetContract is ERC1155Tradable {
    ...
    function WhitelabelNftMarketplace() public pure returns (string memory) {
        return "1.0.0";
    }
    ...
    function setTemplateURI(string memory _uri) public _onlyOwner {
        templateURI = _uri;
    }
    ...
    function safeTransferFrom(
        ...
        if (mintedBalance < _amount) { 
            ...
            _mint(_to, _id, _amount - mintedBalance, _data);
            if (mintedBalance > 0) {
    ...
    function _isCreator(uint256, address _address)
    internal
    view
    virtual
    returns (bool)
