...
/**
 * @title OfficialWINO Wine Club ERC721A Smart Contract
 */

contract OfficialWINOWineClub is Ownable, ReentrancyGuard, ERC721A {
    event PaymentReceived(address from, uint256 amount);

    constructor(address authorizerAddress_, address distributorAddress_)
        ERC721A("OfficialWINO Wine Club", "WINO")
    {
