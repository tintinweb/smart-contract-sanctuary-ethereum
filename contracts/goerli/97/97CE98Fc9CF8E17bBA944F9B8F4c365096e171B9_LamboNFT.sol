...
contract LamboNFT is Ownable, ERC721A {  

    using Strings for uint256;

    string private _baseURIextended = "";
    bool public pauseMint = true;
    uint256 public constant MAX_NFT_SUPPLY = 2600;

    constructor() ERC721A("LamboNFT", "LN") {
    }

    function mintNFTForOwner(uint256 _qty) public onlyOwner {
