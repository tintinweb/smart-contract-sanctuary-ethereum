...
contract NFT is ERC721, Ownable {
    ...
    uint public constant MAX_TOKENS = 10000; //max supply 
    uint private constant TOKENS_RESERVED = 5; //wenn der vertrag erstellt ist, gehen 5 stk. in meine wallet
    uint public price = 100000000000000000; //0.08 ETH
    uint256 public constant MAX_MINT_PER_TX = 10;

    bool public isSaleActive;
    uint256 public totalSupply;
    mapping(address => uint256) private mintedPerWallet; //tracks wieviele nfts per wallet gemintet wurden

    string public baseUri;
    string public baseExtesion = ".json";

    constructor() ERC721("JSNFT","JNF") {
