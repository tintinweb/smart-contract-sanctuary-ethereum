...
// payable nonReentrant
  constructor (
    ...
    transferNFT(owner, address(this), nftTokenId);
    // IERC721 erc721 = IERC721(nftContract);
    // erc721.transferFrom(owner, address(this), nftTokenId);
  }

  function transferNFT(address from, address to, uint256 tokenId) private {
    IERC721 erc721 = IERC721(nftContract);
  ...
  function cancelRaffle(address _owner) public {
    ...
    transferNFT(address(this), owner, nftTokenId);
