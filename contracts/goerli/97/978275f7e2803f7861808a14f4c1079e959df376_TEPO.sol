...
contract TEPO is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x2dd6844C0324F142134297AAB24BF7EACDE1DFBc);
    address payable public teamWallet = payable(0xC14617a46d730fE15a231C370C0BdB2Be3D571C5);
    ...
    constructor() ERC20("Test Protocol", "TEPO") {
