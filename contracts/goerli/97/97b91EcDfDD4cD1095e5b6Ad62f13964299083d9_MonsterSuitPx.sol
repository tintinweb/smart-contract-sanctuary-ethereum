...
contract MonsterSuitPx is ERC721A, Ownable
{
    ...
    function freeAMint(uint16 amount, bytes32[] memory proof) external payable
    {
    ...
    function freeBMint(uint16 amount, bytes32[] memory proof) external payable
    {
        require(freeMintIsActive, "Free mint is not active");
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
    ...
    function freeCMint(uint16 amount, bytes32[] memory proof) external payable
    {
        require(freeMintIsActive, "Free mint is not active");
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
    ...
    function freeDMint(uint16 amount, bytes32[] memory proof) external payable
    {
        require(freeMintIsActive, "Free mint is not active");
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
