 ...
 */
contract PrizeTierHistory is Initializable, IPrizeTierHistory, Manageable {
    ...
    */
    ...
    function initialize(address _owner) public initializer {
        __PrizeTierHistory_init_unchained(_owner);
    }

    function __PrizeTierHistory_init_unchained(address _owner)
        internal
        onlyInitializing
    {
    ...
    // @inheritdoc IPrizeTierHistory
    function push(PrizeTier calldata nextPrizeTier)
        external
        override
        onlyManagerOrOwner
    {
        ...
        returns (uint32)
    {
        ...
        require(
            history[length - 1] == newPrizeTier.drawId,
    ...
    // @inheritdoc IPrizeTierHistory
    function replace(PrizeTier calldata newPrizeTier)
        external
        override
        onlyOwner
    {
