...
contract ChainPotsTest {
    ...
    event EntrySilverLottery(
        address indexed _from,
        uint256 _value,
        address payable[] _entries
    );
    ...
    uint256 public silverBattleEntryPrice = 0.001 ether;
    uint256 public silverBattlePotMaxAmount = 0.002 ether;
    uint256 public silverBattleMaxEntries = 2;

    address payable[] public playersGoldBattle;
    uint256 public goldBattleEntryPrice = 0.002 ether;
    uint256 public goldBattlePotMaxAmount = 0.004 ether;
    uint256 public goldBattleMaxEntries = 2;

    address payable[] public playersDiamondBattle;
    uint256 public diamondBattleEntryPrice = 0.003 ether;
    uint256 public diamondBattlePotMaxAmount = 0.006 ether;
    uint256 public diamondBattleMaxEntries = 2;

    event EntrySilverBattle(
        address indexed _from,
        uint256 _value,
        address payable[] _entries
    );
    ...
    function enterSilverLottery(uint256 _count) public payable {
        ...
        emit EntrySilverLottery(msg.sender, msg.value, playersSilverLottery);
    }
    ...
    function enterGoldLottery(uint256 _count) public payable {
        ...
        emit EntryGoldLottery(msg.sender, msg.value, playersGoldLottery);
    }
    ...
    function enterDiamondLottery(uint256 _count) public payable {
        ...
        emit EntryDiamondLottery(msg.sender, msg.value, playersDiamondLottery);
    }
    ...
    function enterSilverBattle(uint256 _count) public payable {
        ...
        emit EntrySilverBattle(msg.sender, msg.value, playersSilverBattle);
    }
    ...
    function enterGoldBattle(uint256 _count) public payable {
        ...
        emit EntryGoldBattle(msg.sender, msg.value, playersGoldBattle);
    }
    ...
    function enterDiamondBattle(uint256 _count) public payable {
        ...
        emit EntryDiamondBattle(msg.sender, msg.value, playersDiamondBattle);
    }
