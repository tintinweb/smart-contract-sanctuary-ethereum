...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xE367f889c0bB85d30e0EFBB4F6Fb508Cac250757];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xE367f889c0bB85d30e0EFBB4F6Fb508Cac250757;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeic5oqknejlk2f2t2sbkz3qgqxlivispevbawlhfewnngyzuyy4sb4/";
...
// File: contracts/LilWizardsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LilWizardsContract is RamppERC721A {
    constructor() RamppERC721A("Lil Wizards", "LWZRD"){}
}
