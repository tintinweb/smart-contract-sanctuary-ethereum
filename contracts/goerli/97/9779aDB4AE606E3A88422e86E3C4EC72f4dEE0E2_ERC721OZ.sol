    ...
    DefaultOperatorFilterer
{
    ...
    */
    ...
    bytes32 constant public NO_WHITELIST = bytes32(0);
    ...
    */
     ...
     * @param proof contains the hash proof related to user address
    */
    function mintNft(address buyer, bytes32[] memory proof)
        external
        payable
    ...
    */
    ...
    /**
     * @notice isWhitelisted function
     * @param proof of address
     * @param leaf of address
     * @return bool true if is inside whilest or false if not 
     */
