...
contract Token is ERC20, ERC20Burnable, Ownable {
    ...
    address public devWallet = address(0x8a0Bc0A6C3d2BA099008337fd93f5E8f95625411); //  DEV WALLET
    ...
    constructor() ERC20("Flat", "FLAT") {
        devWallet = owner();
       
        buyFee = 2000; // 40% will drop after bots
        sellFee = 2000; // 40% will drop after bots
