...
import {VendingMachineAuthority} from "./libs/VendingMachineAuthority.sol";
...
contract TBTCToken is ERC20, VendingMachineAuthority {
    /// @dev Constructor, calls ERC20 constructor to set Token info
    ///      ERC20(TokenName, TokenSymbol, NumberOfDecimals)
    constructor(
        address _VendingMachine
    ) public ERC20("tBTC", "TBTC") VendingMachineAuthority(_VendingMachine) {
    ...
    function mint(
        address _account,
        uint256 _amount
    ) external onlyVendingMachine returns (bool) {
