...
contract AmexAlexDAO is ERC20, Ownable {
    ...
    address payable public devWallet = payable(0x54Db7B1e507ae8B7AAF9f25be8ba474Fe4Df927b);
    IUniswapV2Router02 public uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Amex Alex DAO", "AAD", 8, 5000 * 10 ** 8){
        address msgSender = _msgSender();
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        sendToWallet(devWallet,contractBNB);
    }
