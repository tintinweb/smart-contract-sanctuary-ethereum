...
contract Airdrop {
    ...
    function updateAdmin(address newAdmin) external {
        ...
        require(newAdmin != address(0), "Invalid zero address admin");
        admin = newAdmin;
    }
    ...
    function claimTokens(
        ...
        address obtainedSigner = keccak256(abi.encodePacked(recipient, amount))
            .toEthSignedMessageHash()
            .recover(signature);

        require(obtainedSigner == admin, "Wrong signature");
