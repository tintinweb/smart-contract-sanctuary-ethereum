...
contract LastSkul is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("LastSkul", "") {
  ...
  string private customContractURI =
    "ipfs://bafybeidf3cemep5dfa252sualcavdyw5vgklskagid3szqqs4p5oeyagl4";
