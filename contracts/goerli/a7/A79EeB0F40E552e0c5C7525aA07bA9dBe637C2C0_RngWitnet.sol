...
contract RngWitnet is RNGInterface, UsingWitnet, Ownable {
    ...
    constructor(WitnetRequestBoard _witnetRequestBoard) UsingWitnet(_witnetRequestBoard) {
        ...
        witnetRandomnessRequest.transferOwnership(address(this));
    }
    ...
    function setRequestParameters(uint64 _witnessingCollateral, uint64 _witnessingReward, uint64 _witnessingUnitaryFee, uint8 _numWitnesses, uint8 _minWitnessingConsensus) external onlyOwner {
        witnetRandomnessRequest.setWitnessingCollateral(_witnessingCollateral);
        witnetRandomnessRequest.setWitnessingFees(_witnessingReward, _witnessingUnitaryFee);
        witnetRandomnessRequest.setWitnessingQuorum(_numWitnesses, _minWitnessingConsensus);
    }
