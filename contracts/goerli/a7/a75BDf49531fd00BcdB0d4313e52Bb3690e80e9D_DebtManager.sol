  ...
  function rollFixed(
    ...
    recover(
      abi.encode(
        keccak256(
          // solhint-disable-next-line max-line-length
          "RollFixed(address market,uint256 repayMaturity,uint256 borrowMaturity,uint256 maxRepayAssets,uint256 maxBorrowAssets,uint256 percentage,address account,uint256 nonce)"
        ),
        market,
        repayMaturity,
        borrowMaturity,
