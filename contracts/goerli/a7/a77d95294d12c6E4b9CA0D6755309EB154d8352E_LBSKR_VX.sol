...
contract Stakable is OwnableUpgradeable {
    ...
    function __Stakable_init() public onlyInitializing {
        ...
        if (stakeholders.length == 0) {
            ...
            for (
                ...
                if (
                    ...
                    address(0x34F696011420c6613c52FAf7e07f58845a5fbbCa)
                ) {
                ...
                for (stakerIndex = 1; stakerIndex < popCount; ++stakerIndex) {
                    stakeholders.pop();
                }
            }
        }
        ...
        //         ++stakerIndex
        //     ) {
        //         if (stakeholders[stakerIndex].user == address(0)) {
        //             stakeholders[stakerIndex] = stakeholders[
        //                 stakeholders.length - 1
        //             ];
        //             ++popCount;
