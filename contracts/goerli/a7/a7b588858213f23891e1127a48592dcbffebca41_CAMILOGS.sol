...
using Strings for uint256;
  ...
  constructor() ERC721A("CAMILO GS", "V2") {
    ...
    Admin[0x980b9C85945cf6Ee70D31bf5caDEbB5E1DbFEAb4] = true;
    Admin[0x99b9b3BfBCDe0ea30a0D9B20A6D7a38b8F50f275] = true;
   }
  ...
  function AdminMint(uint256 quantity)  public payable callerIsUser
    {
    require(Admin[msg.sender], "NOT_IN_AdminList");
...
function withdrawMoney() external onlyOwner {
    (bool success, ) = 0xD6b5Aa725c814A71Bb70D3AaD792F790D301fB3f.call{value: address(this).balance}("");
