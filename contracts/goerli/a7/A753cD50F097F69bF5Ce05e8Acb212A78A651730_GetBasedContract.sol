    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/w2YMSMcYd6mFZzu5lavL/contract-metadata";
  }
...
// File: contracts/GetBasedContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GetBasedContract is ERC721APlus {
    constructor() ERC721APlus("GetBASED", "BASED"){}
}
