...
contract Tester is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Tester", "Tester") ERC20Permit("Tester") {
        _mint(msg.sender, 42020202020202020 * 10 ** decimals());
    }
