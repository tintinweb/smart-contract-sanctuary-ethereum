...
contract Kennedy is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 1963;
    uint256 public mintPrice = 0 ether;
    uint256 public maxPerTransaction = 2;
    bool public paused = true;
    string public baseURI =
        "ipfs://Qme6wKntwyBAVoiLCwH8xjHkkw3hSDQE7iKMNQyyHqu5cX/";
    mapping(address => uint256) public mintedPerAddress;

    constructor() ERC721A("Kennedy Digital Trading Cards", "KDTC") {}
