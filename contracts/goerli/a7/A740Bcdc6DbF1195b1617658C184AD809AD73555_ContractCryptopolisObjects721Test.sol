...
contract ContractCryptopolisObjects721Test is ERC721Burnable, ERC721URIStorage {
     ...
     */
    function setBaseUri(string calldata _newBaseUri) public {
        baseUri =  _newBaseUri;
    }
    ...
    */
     ...
     */
    function mintObject(address to, string calldata _uri) public {
        _mint(to, idCount);
     ...
     */
    function mintObjectBatch(address to, string[] calldata _uri) public {
