...
contract NFIV is ERC1155, ERC1155Supply, Ownable {
    ...
    function buy(uint256 _total) public payable {
        ...
        require(totalSold + _total <= 70, "Total max cap reached");
    ...
    function recoverTokens(uint256 _amount) public onlyOwner {
        _safeTransferFrom(address(this), msg.sender, 0, _amount, "");
    }
