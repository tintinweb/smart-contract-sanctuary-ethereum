...
// File: contracts/Spaceportas.sol
...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("Spaceportas Sample", "SPACEPORTAS") {
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= MAX_MINT_PER_TX, "You cannot mint that many in one transaction; Only 10 NFTs.");
        require(mintedPerWallet[msg.sender] + _numTokens <= MAX_MINT_PER_TX, "You cannot mint that many total.");
        uint256 curTotalSupply = totalSupply;
        require(curTotalSupply + _numTokens <= MAX_TOKENS, "Exceeds total supply of 'MAX_TOKENS'.");
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x5db29B241C29d5c54C09164b4004b21fD2eC3CFE).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x5db29B241C29d5c54C09164b4004b21fD2eC3CFE).call{value: balanceTwo}("");
