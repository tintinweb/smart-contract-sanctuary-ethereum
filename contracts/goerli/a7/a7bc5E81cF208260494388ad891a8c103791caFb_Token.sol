...
contract Token is ERC20PresetFixedSupply
{
	...
	constructor (string memory name, string memory symbol, uint initialSupply, uint8 _decimalsValue) ERC20PresetFixedSupply(name, symbol, initialSupply, msg.sender)
	{
