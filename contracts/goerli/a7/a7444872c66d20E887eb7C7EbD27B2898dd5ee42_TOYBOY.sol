...
function withdrawRevenueShare() external onlyOwner {
        ...
        address founder1   = payable(0x7A3df47Cb07Cb1b35A6d706Fd639bfbD46e907Ac); //yuto
        address founder2   = payable(0xf75df006509e8F22d1Ce3E941655942ed542bd66); //AI DAO
        address platformer = payable(0x48A23fb6f56F9c14D29FA47A4f45b3a03167dDAe); //genta
        address engineer   = payable(0xC7ec777ad0d39B2e88D8278dB79212C06032B6B2); //nashio
        bool success;
