...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) public virtual{
        ...
        require(supplyOwner == msg.sender, "Only supplyOwner can call this function");
        ...
        emit Transferr(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) public virtual {
        ...
        emit Transferr(account, address(0), amount);
