...
contract Lakan is
    ...
    ERC20Votes
{
    error TransferPausedAndCallerIsNotAllowedTransferee();
    ...
    constructor() ERC20Permit("Lakan") ERC20("Lakan", "LKN") {
        _mint(_msgSender(), 300_000_000 * 1e18);
        ...
        override
    {
        if (paused() && allowedTransferee[from]) {
            revert TransferPausedAndCallerIsNotAllowedTransferee();
        }
    ...
    function _transfer(
        ...
        if (_to == address(this)) {
            revert TransferToSelfNotAllowed();
        }
