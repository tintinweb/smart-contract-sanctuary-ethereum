...
contract cbtest is ERC721A, Ownable {
    ...
    constructor() ERC721A("cbtests", "cbtestz"){}
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!revealed) {
            return "https://bafybeidc7ecroqwprnhox6mm7swk2oqp3czrq4w5qjbe7uv37qtlrsv42y.ipfs.nftstorage.link/orange.PNG";
        }
