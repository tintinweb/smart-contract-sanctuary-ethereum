...
contract DssSpellAction is DssAction, DssSpellCollateralAction {
    ...
    function actions() public override {
        ...
        require(OptimismTeleportBridgeLike_1(TELEPORT_GATEWAY_OPT).l1Escrow() == ESCROW_OPT);
        ...
        require(ArbitrumTeleportBridgeLike_1(TELEPORT_GATEWAY_ARB).l1Escrow() == ESCROW_ARB);
        ...
        TeleportOracleAuthLike_1(ORACLE_AUTH).file("threshold", 1);
