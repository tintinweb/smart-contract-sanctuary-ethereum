...
contract MultiSigWallet {
    ...
    modifier txIsNotConfirmed(uint256 _txId) {
        require(!confirmed[_txId][msg.sender], "tx confirmed");
        _;
    }
    ...
    function confirm(uint256 _txId) external onlyOwner txExist(_txId) txIsNotConfirmed(_txId) txIsNotExecuted(_txId) {
    ...
    function execute(uint256 _txId) external txExist(_txId) txIsNotExecuted(_txId) {
        require((isConfirmed(_txId)), "approvals required");
