...
contract SBT is Ownable, ERC721 {
    ...
    constructor(string memory _uriString) ERC721("XCAL-SBT", "XCAL") {
    ...
    mapping(address => uint) userToTokenId;
    ...
    function mint(address _user) external {
        ...
        require(
            ...
            "Function only callable by sale contract address"
        );

        totalSupply++;
        _safeMint(_user, totalSupply);
        userToTokenId[_user] = totalSupply;
    ...
    /**
     * @dev Set the Sale contract address
     * @param _address - address of Sale contract
     */
    function setSaleContractAddress(address _address) public onlyOwner{
