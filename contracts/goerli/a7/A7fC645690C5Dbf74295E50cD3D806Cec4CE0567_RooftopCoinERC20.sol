...
contract RooftopCoinERC20 is ERC20 {
    
    constructor(uint256 initialSupply) ERC20("RooftopCoin", "RTC") {
        _mint(msg.sender, initialSupply);
    }

    //deployar en goerly, crear archivo de deploy y crear archivo hardhat.config.js
}
    // *** Sobre Decimales ***
