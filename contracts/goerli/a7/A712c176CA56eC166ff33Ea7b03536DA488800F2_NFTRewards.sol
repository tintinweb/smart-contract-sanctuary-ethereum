...
contract NFTRewards is ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 private constant MIN_STAKE = 3000 ether; // Minimum amount of tokens can be stake
    uint256 private constant MAX_STAKE = 60000 ether; // Maximum amount of tokens can be staked
    uint256 private constant STAKE_MULTIPLE = 3000 ether;

    uint256 private constant MIN_UNSTAKE = 3000 ether; // Minimum amount of tokens can be unstake
    uint256 private constant MAX_UNSTAKE = 60000 ether; // Maximum amount of tokens can be unstaked
    uint256 private constant UNSTAKE_MULTIPLE = 3000 ether; // unstake count

    uint256 private constant MAX_PER_DAY = 3000 ether;
