...
contract Staking {
    ...
    IERC721A private _mainContract = IERC721A(0xF50e2A2970F817eA2A0b55e5F70ccd74cFE5a355);
    ITicket _ticketContract = ITicket(0xbb0773354006595dFfFe09f6e953447209A73767);
    ...
    constructor() {
        _stakingTimes[TicketTypes.SILVER] = 10;
        _stakingTimes[TicketTypes.GOLD] = 30;
