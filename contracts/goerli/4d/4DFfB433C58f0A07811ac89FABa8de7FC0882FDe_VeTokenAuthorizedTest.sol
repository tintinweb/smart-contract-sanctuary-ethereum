...
contract VeTokenAuthorizedTest is VeTokenTest, Pausable {
    ...
    uint256 public validationTreshold;
    ...
    function setAllowedToActWithoutPermission(address _allowedAddress, bool _status) external override {
        revert("restricted");
    }

    function setCreateLockAllowance(address _spender, bool _status) external override {
        revert("restricted");
    }
    ...
    function increaseAmountFor(address _account, uint256 _value) external override {
        revert("restricted");
    }
    ...
    function increaseUnlockTimeFor(address _account, uint256 _unlockTime) external override {
        revert("restricted");
    }
...
contract VeTokenTest is ReentrancyGuard {
    ...
    function setCreateLockAllowance(address _spender, bool _status) external virtual {
