...
contract ICO is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function userInvestment(uint8 _roundId, address _address) external view returns (InvestorInfo memory) {
...
interface IWalletStore {
    ...
    function setReferralReward(uint256 _referrerReward, uint256 _referreeReward) external returns (bool);
