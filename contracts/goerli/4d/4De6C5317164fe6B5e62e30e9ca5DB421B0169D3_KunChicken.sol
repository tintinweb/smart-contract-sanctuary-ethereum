...
// import "openzeppelin-contracts\contracts\token\common\ERC2981.sol";
...
// File: contracts/GitcoinPunks.sol
...
contract KunChicken is ERC721A, Ownable, ReentrancyGuard, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    constructor() ERC721A("KunChicken", "KUN") {
        setBaseURI("ipfs://bafybeieiyl4yhn6s3rus7opmnpjtwiiydwxohpu7d6l74qu7diaycqgrae/");
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        ...
        if (cost > 0) {
            ...
            require(freemintCount + _mintAmount <= freeSupply, "Max FreeSupply exceeded!");
        }
