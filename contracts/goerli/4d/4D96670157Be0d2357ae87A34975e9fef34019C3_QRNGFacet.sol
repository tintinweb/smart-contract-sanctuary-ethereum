...
contract QRNGFacet is WithRoles, IQRNGReceiver, WithAirnodeRrp {
  ...
  function makeRequestUint256() external onlyRole(REQUEST_NUMBER_ROLE) returns (bytes32) {
  ...
  function setRequestParameters(
    ...
    QRNGStorage storage qs = LibQRNG.DS();
    qs.setRequestParameters(_airnode, _endpointIdUint256, _endpointIdUint256Array, _sponsorWallet);
  }
