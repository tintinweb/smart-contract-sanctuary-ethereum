...
/**
    ...
    @author boredGenius and 0xmons
 */
abstract contract RSPairERC20 is RSPair {
    ...
    /**
        ...
        @dev See RSPairCloner for an explanation on how this works
     */
...
/**
    ...
    @author boredGenius and 0xmons
 */
abstract contract RSPairEnumerable is RSPair {
    /// @inheritdoc RSPair
    function _sendAnyNFTsToRecipient(
        IERC721 _nft,
        address nftRecipient,
...
import {RSPairERC20} from "./RSPairERC20.sol";
import {RSPairEnumerable} from "./RSPairEnumerable.sol";
import {IRSPairFactoryLike} from "./IRSPairFactoryLike.sol";
...
/**
    ...
    @author boredGenius and 0xmons
 */
contract RSPairEnumerableERC20 is RSPairEnumerable, RSPairERC20 {
    /**
        @notice Returns the RSPair type
     */
    function pairVariant()
        public
        pure
        ...
        returns (IRSPairFactoryLike.PairVariant)
    {
        return IRSPairFactoryLike.PairVariant.ENUMERABLE_ERC20;
    }
}
