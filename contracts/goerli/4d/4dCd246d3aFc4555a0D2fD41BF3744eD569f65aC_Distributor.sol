...
contract Distributor is Ownable, IDistributor {
    ...
    function distributeFunds(uint256 amount) external onlyMarketplace returns (uint256) {
        ...
        if(result == false){
            ...
            console.log("The collateral could not be distributed to the supply of wells, the collateral will be saved until a new distribution");
            return 0;
        }
        ...
        console.log("Collateral was successfully distributed");
        return distribution;
    }
