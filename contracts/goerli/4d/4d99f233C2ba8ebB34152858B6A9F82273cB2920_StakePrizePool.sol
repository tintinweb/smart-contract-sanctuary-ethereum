...
/**
  ...
  * @author Asymetrix Protocol Inc Team
  * @notice Escrows assets and deposits them into a yield source.  Exposes interest to Prize Flush.
    ...
    IERC721ReceiverUpgradeable
{
    ...
    /// @param _rewardPerSecond The reward per second that will be used in time of distribution of ASX tokens
    ...
    /// @inheritdoc IPrizePool
    function claim(address _user) external override {
        UserStakeInfo storage userInfo = userStakeInfo[_user];
    ...
    /// @notice Sets the prize flush of the prize pool. Only callable by the owner.
    /// @param _prizeFlush The new prize flush
    function _setPrizeFlush(address _prizeFlush) internal {
        require(_prizeFlush != address(0), "PrizePool/prizeFlush-not-zero");
    ...
    /// @notice Sets the reward token address (ASX token) for the prize pool that will be used for distribution. Only callable by the owner.
    /// @param _rewardToken The ASX token address.
