...
contract BankingSystem {
    ...
    // for Users
    function getUserDeposits() view public returns(UserDeposits[] memory) {
    ...
    function withdraw(uint256 _amount) public payable grantAccess loginFirst {
        ...
        userWithdraws[msg.sender].push(UserWithdraws(_amount*1e18, block.timestamp));
    ...
    // for Users
    function getUserWithdraws() public view returns(UserWithdraws[] memory) {
    ...
    function transferEth(address _receiver, uint256 _amount) public grantAccess loginFirst {
        ...
        userTransfers[msg.sender].push(UserTransfers(_receiver,_amount * 1e18,block.timestamp));
    ...
    // for Users
    function getUserTransfers() view public returns(UserTransfers[] memory) {
