    ...
    RoyaltiesV2Impl
{
    ...
    mapping(address => uint256) public freeMintsL1;

    bytes32 public merkleRootL2;
    uint256 public merkleRootL2Time;
    mapping(address => uint256) public freeMintsL2;
    ...
    constructor(
        ...
        merkleRootL1Time = 1 days;
        merkleRootL2Time = 1 days;
    ...
    function setFreeMintLimit(uint256 mintLimits) public onlyOwner {
        freeMintLimit = mintLimits;
    }
    ...
    function calculateMintingCost(
        ...
        if (
            ...
            getElapsedTime(deployedTimestamp, block.timestamp) <=
            merkleRootL1Time &&
            freeMintsL1[account] <= freeMintLimit
        ) {
            return 0;
        }
        ...
        if (
            ...
            getElapsedTime(deployedTimestamp, block.timestamp) <=
            merkleRootL2Time * 2 &&
            freeMintsL2[account] <= freeMintLimit
        ) {
            return 0;
        }
