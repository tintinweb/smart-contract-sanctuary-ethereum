...
contract TEST1 is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0xbC7b67140E5BAB7E94Cc970B966D43818b065471);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _charityFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _charityFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee) external onlyOwner {
