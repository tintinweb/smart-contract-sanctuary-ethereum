...
contract testNFT is ERC721URIStorage, Ownable {
    ...
    address private constant treasury = 0xC3027242aA8f7327BF105F202f64f2a9422e5FCd;

    constructor(string memory startURI) ERC721("testNFT", "testNFT") {
        baseURI = startURI;
        _mint(owner(), 1 + totalNFTS++);
    }
    ...
    function mint(uint256 amount) payable public {
        ...
        require(amount > 0 && amount <= maxPerTX, "Max 10 Per Transaction");
        require(maxSupply > amount + totalNFTS, "Sold Out");
