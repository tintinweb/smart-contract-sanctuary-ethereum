...
contract HilmaKlint is ReentrancyGuard, WCNFTToken, IWCNFTErrorCodes, ERC721A, DefaultOperatorFilterer {
    struct RefundData {
    ...
    uint256 public minimumContribution = 0.0000001 ether;
