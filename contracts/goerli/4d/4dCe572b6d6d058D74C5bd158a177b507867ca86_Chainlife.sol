...
contract Chainlife is ERC721Royalty, Ownable, ReentrancyGuard {
  ...
  // address private ABcontract = 0xa7d8d9ef8D8Ce8992Df33D8b8CF4Aebabd5bD270; // mainnet
  address private ABcontract = 0xDa62f67BE7194775A75BE91CBF9FEeDcC5776D4b; // goerli token 94000000 is owned by zenerative
  ...
  {
      require(mintStage == 1);
      require(projectNumber == 34 || projectNumber == 94);
      require(
          msg.sender ==
