...
contract NFT is ERC721Enumerable, Ownable {
	...
	constructor(
		...
		baseURI = "https://bafybeiam47dzcpw6z7vmv2oeidfhz2vmz3wppp77gwrjmvnyrkefo44qfu.ipfs.w3s.link/";
	...
	function mint(address recipient, uint256 amount) internal notPaused {
		...
		returns (string memory)
	{
		...
		string memory result = string(
			abi.encodePacked(currentBaseURI, metadataPointerId, baseExtension)
		);

		return bytes(currentBaseURI).length != 0 ? result : "";
	}
