...
contract ProxySaleV2 is Ownable, ReentrancyGuard, IProxySale {
    ...
    uint256 public mintStakeType = 0;
    ...
    function setMintStakeType(uint256 _mintStakeType) public onlyOwner{
        mintStakeType = _mintStakeType;
    }
