    ...
    PaymentSplitterUpgradeable
{
    ...
    uint256 public WhiteListandFreeLockDuration;

    uint256 public maxMintAmountPerTx;
    uint256 public maxPerWallet;

    uint256 public firstSaleSupply;
    uint256 public reserveSupply;
    uint256 public maxSupply;

    bytes32 public merkleRoot;

    uint256 constant public refundableDays = 100 days;
   ...
   constructor() {
    ...
    function refundGuaranteeActive() public view returns (bool) {
        return (block.timestamp < (saleEndTime + refundableDays));
    }
