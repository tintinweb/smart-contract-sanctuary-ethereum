...
contract TrumpandtheBird is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Trump and the Bird";
    string constant _symbol = "$TrumpBird";
    ...
    address payable public liquidityFeeReceiver = payable(0x4fF3122dc8151883e6E4998f4c07bb74338A5cDB);
    address payable public marketingFeeReceiver = payable(0x4fF3122dc8151883e6E4998f4c07bb74338A5cDB);
