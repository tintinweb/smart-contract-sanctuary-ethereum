...
contract Indicia is ERC721A, Ownable, ReentrancyGuard {
    struct Coupon {
        bytes32 r;
        bytes32 s;
        uint8 v;
    ...
    constructor(address adminSigner_) ERC721A("Indicia NFT", "IDCT") {
        ...
        nonReentrant
    {
        ...
        bytes32 digest = keccak256(abi.encode(_msgSender()));
        require(
