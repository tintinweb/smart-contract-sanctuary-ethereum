...
import { Dumbledore } from "../dAgoraWizard/Dumbledore.sol";
import '../IdAgoraMembership.sol';

contract dAgoraDumbledoreFactory is Ownable, ReentrancyGuard {
    Dumbledore albus;
    ...
    uint256 public albusCount = 0;
    bool public paused;

    mapping(address => Deploys) private _deployedContracts;

    event AlbusDumbledoreCreated(address albusContract, address owner, uint256 albusIndex);
        ...
        nonReentrant
    {
        ...
        albusCount++;
        _deployedContracts[msg.sender].ContractAddress.push(address(albus));
        _deployedContracts[msg.sender].Owner = msg.sender;
        _deployedContracts[msg.sender].albusIndex = albusCount;
        emit AlbusDumbledoreCreated(address(albus), msg.sender, albusCount);
    }
