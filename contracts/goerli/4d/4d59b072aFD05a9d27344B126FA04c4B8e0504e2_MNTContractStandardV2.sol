...
/// @author Monumental Team
/// @title Standard Contract
contract MNTContractStandardV2 is IMNTContract, Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {

    using CountersUpgradeable for CountersUpgradeable.Counter;
    CountersUpgradeable.Counter private _tokenIds;
    CountersUpgradeable.Counter private _tokenBurntCounter;
    ...
    function initializeStandard(
        ...
        uint256 royalties,
        uint256 maxSupply
    ) external initializer override returns (bool) {
        ...
        mntMintStandard(_creator,pinCode);
    ...
    /// @return newTokenId
    /// @dev Only owner
    function mntMintStandard(address _owner,  uint256 _pinCode)
    public nonReentrant onlyOwner
    returns (uint256)
    {
        require(_tokenIds.current() < _maxSupply + _tokenBurntCounter.current(), "All tokens already minted !");
        _tokenIds.increment();
    ...
    function getTokenBurntCounter()
    internal
    returns (uint256){
        return _tokenBurntCounter.current();
    }
    ...
    function totalSupply() public view returns (uint256) {
        return _tokenIds.current() - _tokenBurntCounter.current();
    }
