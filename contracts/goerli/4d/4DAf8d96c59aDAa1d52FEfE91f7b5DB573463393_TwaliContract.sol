...
contract TwaliContract is Initializable, ReentrancyGuard {
    ...
    bytes32 public constant WERK_PAYMENT_TYPEHASH = keccak256(
        "WerkDetails(address owner,string contract_sowMetaData,uint contract_payment_amount,bool contract_werkApproved,bool contract_werkPaidOut,bool contract_werkRefunded,uint contract_start_date,uint contract_end_date,uint contract_created_on)"
         );
...
//   gnosisSafeProxyFactory: '0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2',
    ...
    function hashWorkDetails(WorkDetails memory workObj) internal view returns (bytes32) {
        ...
        return keccak256(abi.encodePacked(
            ...
            WERK_PAYMENT_TYPEHASH,// validator address
            workObj
            ))
        ));
    }
    ...
    function signatureCheck(WorkDetails memory _workObj, uint8 sigV, bytes32 sigR, bytes32 sigS) internal view returns (bool) {
