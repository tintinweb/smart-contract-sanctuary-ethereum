...
contract MultipleFrameFixed is Ownable, ERC1155Holder {
	...
	function lazyMultiBuy(LazyMultiBuyItem memory _lazyItem) external payable{
		...
		uint256 _id = onMultipleList(_lazyItem._collection, tokenId, _lazyItem._tokenAdr, _lazyItem._amount, _lazyItem._price, _lazyItem.sender, _lazyItem.pairId);
		onMultipleBuy(_id, _lazyItem._amount, _lazyItem._lazyTokenId, _lazyItem.sender);
