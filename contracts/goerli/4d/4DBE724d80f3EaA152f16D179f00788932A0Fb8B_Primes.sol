...
pragma solidity ^0.8.0;
// @author G. Collard https://twitter.com/_g56d_
...
contract Primes is ERC721r, Ownable {
    ...
    function randomEvenOdd(uint256 _seed, uint256 _salt)
        public
        view
    ...
    {
        if (randomEvenOdd(_seed, _salt) == 1) {
            initAnimation = "begin='click'";
        } else {
            initAnimation = "end='click'";
        }
    }
