...
contract Control is AccessControl, OpsReady {
     ...
     * @param ops_ The address of the ops proxy contract.
    ...
    function initialize(address ops_, address taskCreator_, address hydt_, address reserve_, uint256 initialMintStartTime_) external {
        ...
        require(ops_ != address(0), "Control: invalid ops_ address");
        require(taskCreator_ != address(0), "Control: invalid taskCreator_ address");
        require(hydt_ != address(0), "Control: invalid hydt_ address");
        require(reserve_ != address(0), "Control: invalid reserve_ address");
        OPS = IOps(ops_);
    ...
    // TODO remove this function
    function test_oneDayTime(uint128 oneDayTime_) external {
     ...
     * @param newOpsReadyState true/false value to assign to `opsReadyState`.
     */
    ...
    /**
     * @notice Gets current HYDT price corresponding to the preferred HYDT/USD pair.
     */
