...
contract Primes is ERC721A, ERC2981, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Primes", "PRIMES") {
        setPathMap();
        _setDefaultRoyalty(0x37104d59E899c558Ea60518Af3F43E46bA040e07, 500);
    }
    ...
    function mint(address to, uint256 _quantity) external onlyOwner {
        uint256 ts = totalSupply();
        if (ts % 10 == 0) {
            _initializeOwnershipAt(ts);
        }
        require(
