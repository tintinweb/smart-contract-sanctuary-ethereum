...
contract KossiV1 is Initializable, ERC1155Upgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function mint(address account, uint256 tokenId, uint256 amount)
        ...
        nonReentrant
    {
        require(_mintCountsByAccountByTokenId[tokenId][msg.sender] > 0, "No eligibility requirements");
        require(_mintCountsByAccountByTokenId[tokenId][msg.sender] >= amount, "Number of purchases has been exceeded");
        require(msg.value == mintPrices[tokenId] * amount, "Value sent is not correct");
        
        _mint(account, tokenId, amount, "");

        _mintCountsByAccountByTokenId[tokenId][msg.sender] = _mintCountsByAccountByTokenId[tokenId][msg.sender] - amount;
    }
