...
// File: https://github.com/aave/aave-v3-periphery/blob/7a9542963b8030885443800179c57ff8ffdac29c/contracts/misc/interfaces/IWETHGateway.sol
    ...
    function Bondredemption () external {
        ...
        for ( id = 0 ; id <= bondInfo[id].buyers.length; id++){
            if (block.timestamp >= bondInfo[id].bondMaturityDate){
                ...
                _burn(bondInfo[id].buyers[id], id, 1); 
