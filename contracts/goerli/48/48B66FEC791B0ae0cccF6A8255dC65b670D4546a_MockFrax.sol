...
contract MockFrax is ERC20 {
    ...
    function addPool(address pool_address) public {
    ...
    function _burnFrom(address b_address, uint256 b_amount) internal {
