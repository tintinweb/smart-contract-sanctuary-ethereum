...
library DrawRingBufferLib {
    ...
    function push(Buffer memory _buffer, uint32 _drawId)
        internal
        pure
    ...
    function getIndex(Buffer memory _buffer, uint32 _drawId)
        internal
        pure
        returns (uint32)
    {
...
contract DrawCalculatorTimelock is IDrawCalculatorTimelock, Manageable {
    ...
    /// @inheritdoc IDrawCalculatorTimelock
    function setTimelock(Timelock memory _timelock)
        external
        override
        onlyOwner
    {
     ...
     * @return IDrawCalculator
     */
    function _timelockHasElapsed(Timelock memory _timelock)
        internal
        view
        returns (bool)
    {
