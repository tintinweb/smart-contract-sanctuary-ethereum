...
contract IP3 {
    ...
    function setManageFee(address manageFeeAddress)
        public
    {
    ...
    function hashAuthorizeNFT(
        ...
        bytes32 hashedAuthorization = keccak256(
            abi.encodePacked(
                ...
                isByDuration
                    ? authorizedNFT.authorizedByDurationInfo.listStartTime
                    : authorizedNFT.authorizedByCountInfo.listStartTime,
                isByDuration
                    ? authorizedNFT.authorizedByDurationInfo.listEndTime
                    : authorizedNFT.authorizedByCountInfo.listEndTime
            )
        );
    ...
    function purchaseByAmount(
        ...
        bytes32 hashedAuthorizeNFTbyAmount = hashAuthorizeNFT(
            authorizedNFTSubmit,
            isByDuration
        );
        ...
        // if (
        //     (nftOnRecord.contains(hashedNft)) &&
        //     latestStartPriceByCountRecord != 0
        // ) {
        //     // get the latest start price from record on chain
        //     currentStartPrice = getCurrentStartingPricePerNFT(
        //         hashedNft,
        //         isByDuration
        //     );
        // } else {
        ...
        //     currentStartPrice = authorizedNFTSubmit
        //         .authorizedByCountInfo
        //         .initialStartPrice;
        ...
        //         .authorizedNFT
        //         .authorizedByCountInfo
        //         .initialStartPrice = authorizedNFTSubmit
        //         .authorizedByCountInfo
        //         .initialStartPrice;
        //     // input the list start and end time, add the authorizer struct info
        //     authroizeRecordMap[hashedNft]
        //         .authorizedNFT
        //         .authorizedByCountInfo
        //         .listStartTime = authorizedNFTSubmit
        //         .authorizedByCountInfo
        //         .listStartTime;
        ...
        //         .authorizedNFT
        //         .authorizedByCountInfo
        //         .listEndTime = authorizedNFTSubmit
        //         .authorizedByCountInfo
        //         .listEndTime;
