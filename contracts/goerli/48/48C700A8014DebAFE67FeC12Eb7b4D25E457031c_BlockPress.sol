...
contract BlockPress is Ownable, ReentrancyGuard, ERC721A {
    string private _URI;
    ...
    constructor() ERC721A("BLockPress", "BLOCKPRESS") {}

    function mint(uint256 numTokens) payable external nonReentrant {
        uint256 totalPrice = 0.005 ether;
