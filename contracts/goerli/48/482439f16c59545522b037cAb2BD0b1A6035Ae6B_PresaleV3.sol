...
contract PresaleV3 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
  ...
  function update(uint256 amount, uint256 lockup_months) internal returns (uint256) {
    ...
    // if (totalTokensSold >= 300_300_300 && linearStartTime == 0) {
    //   linearStartTime = block.timestamp;
    // }
