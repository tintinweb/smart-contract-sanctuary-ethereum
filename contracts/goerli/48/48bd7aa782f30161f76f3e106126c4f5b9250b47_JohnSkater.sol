...
contract JohnSkater is ERC721A, ERC721AQueryable, ERC721ABurnable, ERC2981, Ownable, Pausable, DefaultOperatorFilterer {
    ...
    string private baseURI = "ar://X5aFZOg0x3052HVxIkO8g8U-oPgSdOZ1i_G0i6_kLS4/";
    ...
    constructor(bool mintERC2309Flg, bool _callerIsUserFlg) ERC721A("JohnSkater", "JOHN") {
        ...
        _setDefaultRoyalty(0x7D7C9681342DdB120D4239C82f4603D09dA67F01, 1000);
        if (mintERC2309Flg == true) {
            _mintERC2309(0x61a0B31c6e8182584AeF37F58A2e859b9bc2B73d, 497);
        }
    }
    ...
    function withdraw() external onlyOwner {
        Address.sendValue(payable(0x7D7C9681342DdB120D4239C82f4603D09dA67F01), address(this).balance);
    }
