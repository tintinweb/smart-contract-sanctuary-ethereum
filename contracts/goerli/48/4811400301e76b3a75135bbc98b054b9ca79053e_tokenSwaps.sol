...
contract tokenSwaps {
    ...
    uint256 immutable public fee = 2;       // fee For Contract_Creater
    ...
    constructor(IBEP20 tokenOne,IBEP20 tokenTwo) {
        owner = msg.sender;
        token1 = IBEP20(tokenOne);
        token2 = IBEP20(tokenTwo);
    }
    ...
    function tokenAToB(uint256 amount) public {
    ...
    function tokenBtoA(uint256 amount) public {
