...
// File contracts/interfaces/DeCashRoleInterface.sol
...
// File contracts/contract/DeCashRole.sol
...
contract DeCashRole is DeCashBase, DeCashRoleInterface {
    ...
    onlySuperUser
  {
    ...
    // Add role
    _setBool(keccak256(abi.encodePacked("access.role", _role, _address)), true);
    ...
    onlySuperUser
  {
    ...
    // Remove role
    _deleteBool(keccak256(abi.encodePacked("access.role", _role, _address)));
    // Emit role removed event
    emit RoleRemoved(keccak256(abi.encodePacked(_role)), _address);
  }
}

// File contracts/currencies/EURD/EURDRole.sol
