...
contract NyxNFT is ERC1155Supply, Ownable
{
        ...
        private
    {
        ...
        waveMintableSupply[wave] = _waveMaxSupply - (_waveMaxSupply - (_waveMaxSupply/nyx_mint_pct)) / nyx_mint_pct;
        ...
        public onlyApproved
    {
        ...
        uint256 mint_amount = (waveCurrentSupply[wave] - (waveCurrentSupply[wave]/nyx_mint_pct)) / nyx_mint_pct;
        if (mint_amount > 0)
        {
