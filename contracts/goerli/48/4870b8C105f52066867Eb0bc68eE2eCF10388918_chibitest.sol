...
contract chibitest is ERC721A, ERC2981, OperatorFilterer, Ownable {
    string public baseURI;

    uint256 public constant price = 0.01 ether;

    uint256 public constant totalTokens = 7777;
    uint256 public constant freeTotalTokens = 777;
    uint256 public constant paidTotalTokens = 6900;
    uint256 public constant treasury = 100;
    uint256 public constant maxFreeState = 1;
    ...
    constructor() ERC721A("chibitest", "chibi") { 
        _setDefaultRoyalty(msg.sender, 500);
        _registerForOperatorFiltering();
    }

    function mintFree(uint256 _amount, uint256 _maxAmount) external
        callerIsUser
    ...
    function mintPaid(uint256 _amount, uint256 _maxAmount) external payable 
        callerIsUser
