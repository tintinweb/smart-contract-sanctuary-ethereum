...
contract Saiktest is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Saiktest", "SATE") {
        baseUri = "ipfs://bafybeiddyrz4zdarauq3mvv2vvi36tvkko7cki3ncypg2erqm2tktyipky/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xd80f007f8dA4CeD64bffEeab92160f86779218de).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xd80f007f8dA4CeD64bffEeab92160f86779218de).call{value: balanceTwo}("");
