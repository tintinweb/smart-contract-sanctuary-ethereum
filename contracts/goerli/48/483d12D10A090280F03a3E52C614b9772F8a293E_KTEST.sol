...
contract KTEST is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    address nftAddress = 0x85c4Ab9D3CBe8B8d58100b69CE1C48C30B4F0F4e;
    ...
    function claim(bytes calldata signature, uint256 box, uint256 id ) external payable callerIsUser {
        if(!verifySig(id, box, msg.value, signature)) revert IncorrectSignature();
