    ...
    ReentrancyGuard
{
    ...
    /**
     * need to update prior to release
     */
    address private constant WINTER_ADDRESS = address(0xe0CB05cBf3dBeb647394905848d9361Daa99dE28);
    ...
    */
        ...
        nonReentrant
    {
        ...
        require(!paused, "paused");
        require(msg.sender == WINTER_ADDRESS, "WINTER IS NOT HERE");
        require((totalSupply() + _amount) <= maxSupply, "not enough supply");
        require(msg.value == (_cost * _amount), "ether != cost");
        ...
        nonReentrant
    {
        ...
        {
            require((totalSupply() + amount[i]) <= maxSupply, "not enough supply");
