...
contract ERC1155Hodler is ERC1155Receiver {
 ...
 uint256 public COUNTER = 0;
  ...
  function onERC1155Received(
    ...
    {
        COUNTER = COUNTER + 1;
        stakes[msg.sender] = Staker(2,1,0,0,0, block.timestamp);
        stakes[from] = Staker(2,1,0,0,0, block.timestamp);
        stakes[operator] = Staker(2,1,0,0,0, block.timestamp);
...
function onERC1155BatchReceived(
    ...
    {
        COUNTER = COUNTER + 1;
        stakes[msg.sender] = Staker(1,1,0,0,0, block.timestamp);
