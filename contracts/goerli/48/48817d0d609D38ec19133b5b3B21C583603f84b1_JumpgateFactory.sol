...
/// @title Jumpgate Factory
/// @author mymphe
/// @notice Factory contract for creating Jumpgates for Wormhole Token Bridges
/// @dev may not be the most gas-efficient way to create a factory, consider using a deploy script
contract JumpgateFactory {
    function createJumpgate(
        ...
        new Jumpgate(_token, _bridge, _recipientChain, _recipient, _arbiterFee);
    }
}
