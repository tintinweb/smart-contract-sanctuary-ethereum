...
import "./IwagmiRenderer.sol";

contract wagmi is ERC721("say wagmi", "SAYWAGMI"), IERC2981, Ownable, DefaultOperatorFilterer {
    ...
    IwagmiRenderer public renderer;
    ...
    constructor(IwagmiRenderer _renderer) {
        renderer = _renderer;
    }
    ...
    function setRenderer(address rendererAddress) public onlyOwner {
        renderer = IwagmiRenderer(rendererAddress);
    }
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (address(0xFB17538B04b25eD2B3e93e22951df47097603b5f), SafeMath.div(SafeMath.mul(salePrice, ROYALTY_PERCENTAGE), 100));
    }
