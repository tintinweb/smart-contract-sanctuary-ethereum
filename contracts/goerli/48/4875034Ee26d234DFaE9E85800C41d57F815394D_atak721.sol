...
contract atak721 is  ERC721Upgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable {

    using Counters for Counters.Counter;
    
    address constant SNContract = 0xd532b88607B1877Fe20c181CBa2550E3BbD6B31C;
    //address constant souvenirNFTAddress;
    ...
    function mint(uint256[] calldata tokenIds) external hasSN(msg.sender){
        ...
        IMinter(0x8D9b961989c98Dcb46037EbC4c67683CCd0fFe28).mint(to);
    }
