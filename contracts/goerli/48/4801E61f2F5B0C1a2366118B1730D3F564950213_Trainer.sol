...
// If we do not allow transfers then we cannot transfer to cold wallets??
// Allow transfers but not allow sales?

//Add payment address and withdraw to payment address

contract Trainer is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    // State Changes
    ///////////////////////////////////////////////////////////////////////////
    function changeSaleState(bool state) external onlyOwner {
        saleActive = state;
    }
    ...
    // Mint Functions
    ///////////////////////////////////////////////////////////////////////////
    function mintTrainer() public payable {
        require(saleActive, "Sale must be active to mint");
        require(numberMinted(msg.sender) + 1 <= ADDRESS_MAX_MINTS, "You already have a trainer on this address!");

        numberOfMintsOnAddress[msg.sender] += 1;
        _safeMint(msg.sender, 1);
        emit TrainerCreated(msg.sender, totalSupply());
    }
