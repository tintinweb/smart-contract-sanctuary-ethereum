...
contract TicketingSystem is ERC721Enumerable, Ownable {
    ...
    function mint(string memory _ticketType, uint256 _amount, uint256 _validUntil) public payable {
        Ticket memory newTicket = Ticket(AllowedCrypto[0].payToken, _ticketType, _amount, _validUntil, msg.sender, false);
        ...
        )
    {
        ...
        return (ticket.ticketType, ticket.costValue, ticket.validUntil, ticket.owner, ticket.used);
    }
}