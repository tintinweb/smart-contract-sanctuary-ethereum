...
contract mining{
    ...
    ERC20 token = ERC20(0x5459f4a637275aDFe9AEbfa51952B0abDc8AFa0f);
    ERC721 my_nft = ERC721(0xBC73B29e98c459A02Aa46D23Ac71c4720F08c3bb);

  mapping( uint256 => uint256 ) last_block;

    function cat_mine(uint256 nft_id) public {
