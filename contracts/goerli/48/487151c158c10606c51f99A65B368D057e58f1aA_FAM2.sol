...
contract FAM2 is ERC721, DefaultOperatorFilterer {
    ...
    address private famAddress = 0xa0fDa388f1Ea32AbE096Df2a4d30916786fB39CB;
    ...
    function mint(uint256[] memory tokenIds) external payable {
        ...
        for(uint i = 0; i < tokenIds.length; i++){
            if(IERC721(famAddress).ownerOf(tokenIds[i]) == msg.sender){
    ...
    function setNFTContractAddress(address _nftContract) external onlyTeam {
        famAddress = _nftContract;
    }
