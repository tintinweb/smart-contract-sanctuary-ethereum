...
contract ForcedOffline is Initializable, ERC721EnumerableUpgradeable {
    ...
    function __ForceOffline_init(string memory name_, string memory symbol_) internal onlyInitializing {
    ...
    function tokenURI(uint256 tokenId_) public view override returns (string memory) {
        ...
        string memory occupation = string(abi.encodePacked(tokenOccupation[tokenId_]));
