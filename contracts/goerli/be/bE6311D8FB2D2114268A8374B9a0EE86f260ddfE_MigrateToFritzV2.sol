...
contract MigrateToFritzV2 is Ownable{
    FritzTheCat public FritzV1 = FritzTheCat(payable(0x7F398558001CaD9671aAeFb7F507a432DdEa3c13));
    FritzTheCoin public FritzV2 = FritzTheCoin(payable(0x2167b37D2F0A584f60A8c1F20bC46A9a54ca9d09));
    ...
    function migrateToFrtizV2() external onlyOwner{
        for(uint i = 0; i < mCnt; i ++) {
