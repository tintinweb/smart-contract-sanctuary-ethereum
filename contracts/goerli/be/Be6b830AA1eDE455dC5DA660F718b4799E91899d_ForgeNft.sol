...
contract ForgeNft is ERC721AQueryable, Ownable, Pausable {
  ...
  constructor() ERC721A("ForgeNft", "LNFT") {}
  ...
  function mint(
    ...
    require(
      verifySignature(contractAddress, cid, signature),
      "Invalid signature"
    );
  ...
  function verifySignature(
    ...
    bytes32 payloadHash = keccak256(abi.encode(contractAddress, cid));
  ...
  function tokenURI(
    ...
    return
      bytes(baseURI).length != 0
        ? string(abi.encodePacked(baseURI, _tokenCid[tokenId]))
        : "";
  }
