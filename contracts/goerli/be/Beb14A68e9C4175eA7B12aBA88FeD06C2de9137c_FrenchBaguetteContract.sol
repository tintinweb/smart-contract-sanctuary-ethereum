...
//    / ____/_______  ____  _____/ /_  / __ )____ _____ ___  _____  / /_/ /____ 
//   / /_  / ___/ _ \/ __ \/ ___/ __ \/ __  / __ `/ __ `/ / / / _ \/ __/ __/ _ \
//  / __/ / /  /  __/ / / / /__/ / / / /_/ / /_/ / /_/ / /_/ /  __/ /_/ /_/  __/
// /_/   /_/   \___/_/ /_/\___/_/ /_/_____/\__,_/\__, /\__,_/\___/\__/\__/\___/ 
//                                              /____/
//
//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xAE30d98aE6c889469D9F483909e2af6Af13f002a];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xAE30d98aE6c889469D9F483909e2af6Af13f002a;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmaqZEnX2BojP47VEzwAYYqLdtBoY1NHvmb1BMMyEsxgxg/";
...
// File: contracts/FrenchBaguetteContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FrenchBaguetteContract is RamppERC721A {
    constructor() RamppERC721A("FrenchBaguette", "BaguetteFR"){}
}
