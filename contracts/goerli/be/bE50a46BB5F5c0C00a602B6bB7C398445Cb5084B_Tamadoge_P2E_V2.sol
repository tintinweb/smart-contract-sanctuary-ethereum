    ...
    OwnableUpgradeable
{
    ...
    // Black listing users from buying credits, staking tama and claiming rewards.
    ...
    /**
     * @notice Function for owner to blacklist users.
     * @param _users Array of addresses to blacklist.
     */
    function addToBlacklist(address[] memory _users) external onlyOwner {
    ...
    /**
     * @notice Function for owner to remove users from blacklist.
     * @param _users Array of addresses to remove from blacklist.
     */
    function removeFromBlacklist(address[] memory _users) external onlyOwner {
        for(uint256 i=0; i<_users.length; ++i) {
