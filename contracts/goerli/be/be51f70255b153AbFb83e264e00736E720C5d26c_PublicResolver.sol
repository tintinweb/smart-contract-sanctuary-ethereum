...
abstract contract Multicallable is IMulticallable, ERC165 {
    ...
    // from priviledged contracts (such as RootRegistrarController)
...
abstract contract ABIResolver is IABIResolver, ResolverBase {
    ...
    /**
     * Sets the ABI associated with an BDNS node.
    ...
    ResolverBase
{
    ...
    /**
     * Sets the address associated with an BDNS node.
     * May only be called by the owner of that node in the BDNS registry.
     * @param node The node to update.
...
abstract contract ContentHashResolver is IContentHashResolver, ResolverBase {
    ...
    /**
     * Sets the contenthash associated with an BDNS node.
     * May only be called by the owner of that node in the BDNS registry.
     * @param node The node to update.
...
abstract contract NameResolver is INameResolver, ResolverBase {
    ...
    /**
     * Sets the name associated with an BDNS node, for reverse records.
     * May only be called by the owner of that node in the BDNS registry.
     * @param node The node to update.
     */
...
abstract contract PubkeyResolver is IPubkeyResolver, ResolverBase {
    ...
    /**
     * Sets the SECP256k1 public key associated with an BDNS node.
     * @param node The BDNS node to query
...
abstract contract TextResolver is ITextResolver, ResolverBase {
    ...
    /**
     * Sets the text data associated with an BDNS node and key.
     * May only be called by the owner of that node in the BDNS registry.
     * @param node The node to update.
