...
contract NFTToken is ERC721URIStorage {
    ...
    constructor() ERC721("ScaleUP-NFT-Token", "SUT") {
        creator = msg.sender;
    }

    function setMarketplace(address newMarketplace) public {
        require(msg.sender == creator, "You must be the contract creator to change the ownership");
