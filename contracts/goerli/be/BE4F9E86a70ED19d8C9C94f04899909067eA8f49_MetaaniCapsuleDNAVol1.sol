...
contract MetaaniCapsuleDNAVol1 is ERC721Enumerable {
    ...
    // - 資金救出用振込先ウォレット
    address owner;                                                                    // デプロイ
    address constant fundsWallet           = 0x60a89BB4C35A62DE53e4E1852E2d4037a008aC5b; // metawallet
    address constant fundsRescueSpareKey   = 0xE35B827177398D8d2FBA304d9cF53bc8fC1573B7; // なんとーさんの私物
    ...
    function holderFreeMint(address account, uint256 allowedAmount, bytes32[] calldata proof) public {
        ...
        require(1600 >= tokenIdCount, "out of stock");
        // ALでのミント可能数。
    ...
    function premintPublicFreeMint(address account, uint256 allowedAmount, bytes32[] calldata proof) public {
        ...
        require(3100 >= tokenIdCount, "out of stock");
        // ALでのミント可能数。
    ...
    function publicFreeMint1() public {
        ...
        require(4000 >= tokenIdCount, "out of stock"); // [!] 第2回のために6,000個残さないといけない。
    ...
    function DNAHolderFreeMint(address account, uint256 allowedAmount, bytes32[] calldata proof) public {
        ...
        require(10000 >= tokenIdCount, "out of stock");
        // ALでのミント可能数。
