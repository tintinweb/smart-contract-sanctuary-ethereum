...
contract TestNFT is ERC721, Ownable, Pausable {
    /**
...
enum MintPhase {
    ...
    uint8 public NFTlimitPerUser = 3;
    uint256 MINT_PRICE = 0.00666 ether;
        ...
        payable
    {
        ...
        require(msg.value == amount * MINT_PRICE, 'need to send correct eth');
        require(mintPhase == MintPhase.Public, 'not public stage');
