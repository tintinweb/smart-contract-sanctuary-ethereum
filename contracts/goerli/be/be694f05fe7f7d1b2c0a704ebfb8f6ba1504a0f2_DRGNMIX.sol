...
contract DRGNMIX is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "DRGNMIX";//
    string private constant _symbol = "DRGM";//
    ...
    address payable private _developmentAddress = payable(0x60479aaC3224aa838a375C2B7b9ffb996f8f971F);//
    address payable private _marketingAddress = payable(0x60479aaC3224aa838a375C2B7b9ffb996f8f971F);//
