 ...
 * @notice This contract handles minting Scammer's Guild Oligopollos Colection tokens.
 */
contract ScammersGuildOligopollosColection is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0x4975601EC661a929051e1aB21A04503D0D579B67;
    // Used to allow transferring soulbound tokens with admin privileges
    address public soulboundAdminAddress =
        0x4975601EC661a929051e1aB21A04503D0D579B67;
    ...
    string public baseTokenURI =
        "ipfs://bafybeieae2pafeufkylg3hlagk6fsyute4zybx3kwucjn2qsejnqbrvrfq/";
    ...
    uint96 public royaltyFee = 5000;

    constructor(address _blocklistContractAddress)
        ERC721A("Scammer's Guild Oligopollos Colection", "SGOC")
    {
