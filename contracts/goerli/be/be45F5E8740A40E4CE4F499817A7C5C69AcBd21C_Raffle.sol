...
// Chainlinks oracle -> randomnesm, Automated execution (chainlinks keeper)
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    // mapping(uint256 ammount => address) ammountToAdress;
    ...
    function enterRaffle() public payable {
        // require(msg.value >= i_enteranceFee, "You sent didn't send enough eth!");
