...
contract NFT is ERC721Enumerable, Ownable {
  ...
  uint public priceIncrementValue = 0.05 ether;
  address payable fundWallet = payable(0x3F7011AE4E97Fc305614E9Af58B21392544A1047);
  ...
  address payable founder3 = payable(0x4a443081Ab78AaAb0CEFFfcE721410d93Ae8C8C2);
  ...
  uint public totalRewardPerDay=35000000;
  ...
  // public
    ...
    // require(block.timestamp>=timestamp+1 days, "One day has to be over in order to announce again");
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    founder3.transfer(foundersCut);

    priceIncCounter++;
    if(priceIncCounter==priceIncrementEvery){
      priceIncCounter = 0;
      cost+=priceIncrementValue;
    }
  ...
  function changeFounderAddress(address _founder) public {
    require (msg.sender == founder1 || msg.sender == founder2 || msg.sender == founder3, "You must be one of the founder to execute this");
    if(msg.sender==founder1){
      founder1 = payable(_founder);
    } else if(msg.sender==founder2){
      founder2 = payable(_founder);
    }else if(msg.sender==founder3){
      founder3 = payable(_founder);
    }
  }
