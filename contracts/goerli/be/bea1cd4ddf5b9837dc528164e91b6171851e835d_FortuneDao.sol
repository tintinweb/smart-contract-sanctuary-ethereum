...
// Forked from https://etherscan.io/address/0x534d37c630b7e4d2a6c1e064f3a2632739e9ee04#code
...
contract FortuneDao is ERC721A, Ownable, ReentrancyGuard {
    ...
    ) ERC721A("FortuneDao", "Fortune", _maxMint, _maxSupply) {
        baseURI = initBaseURI;
        _signer = signer;
        maxMint = _maxMint;
    ...
    function presaleMint(
        ...
        require(_verify(_hash(salt, msg.sender), signature), "Invalid signature.");
