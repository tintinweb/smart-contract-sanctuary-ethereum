    ...
    */
    ...
    function _buildTokenURI(uint256 id, address walletAddress) internal view returns (string memory) {
        ...
        string memory svg = string(
            abi.encodePacked(
                parts[0],
                "Soul: 0x", addressToString(walletAddress), '</text>'
            '<text x="10" y="40" class="base">'"Name: ", parts[1], '</text>'
            '<text x="10" y="80" class="base">'"Manufacturer: ", parts[2], '</text>'
            )
        );
        ...
        svg = string(
            abi.encodePacked(
                svg,
                '<text x="10" y="100" class="base">'"Year: ", parts[4],
                parts[6]
            )
        );
                ...
                Base64.encode(
                    bytes(
                        ...
                        //                            '", "image":"',
                            ...
                            image,
                            '", "external_url":"',
                            "https://gateway.pinata.cloud/ipfs/QmaDb7VWQpuZBHUAE1NQfKrhdRbHvAFpnFogXhttvs5sNj",
