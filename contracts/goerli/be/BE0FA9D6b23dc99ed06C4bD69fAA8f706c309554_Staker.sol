...
contract Staker {
  ...
  event Stake(address indexed funder, uint256 indexed amountFunded);

  constructor(address exampleExternalContractAddress) {
      exampleExternalContract = ExampleExternalContract(exampleExternalContractAddress);
      i_deadline = block.timestamp + 72 hours;
      i_thresholdEth = 1 ether;
  }
  ...
  function balances(address _funder) public view returns (uint256) {
    return balanceOf[_funder];
  }
