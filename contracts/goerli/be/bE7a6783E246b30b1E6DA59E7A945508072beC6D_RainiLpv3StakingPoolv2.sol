...
contract RainiLpv3StakingPoolv2 is AccessControl, ReentrancyGuard, ERC721Holder {
    ...
    constructor(
        ...
        require(
            _rainiLpNft != address(0),
            "RainiLpStakingPool: _rainiLpToken is zero address"
        );
    ...
    modifier onlyOwner() {
        require(
            ...
            "RainiLpStakingPool: caller is not an owner"
        );
        _;
    }
    ...
    modifier onlyEditor() {
        require(
            ...
            "RainiLpStakingPool: caller is not a editor"
        );
        _;
    }
