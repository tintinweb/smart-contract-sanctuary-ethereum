...
contract Test3  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Test 3";
    ...
    address payable private _developmentAddress = payable(0x357ec55b18df90E2698f3b335219852582087c5C); 
    address payable private _marketingAddress = payable(0x357ec55b18df90E2698f3b335219852582087c5C);
