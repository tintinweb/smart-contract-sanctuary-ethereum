...
contract PK is ERC721, ERC721Enumerable, ERC721URIStorage, AccessControl, DefaultOperatorFilterer {
    ...
    uint public mintsPerAddress = 100;
    mapping(address => uint) public mints;

    constructor(bytes32 _merkleRoot, uint _maxSupply, uint _startTimestamp) ERC721("PK", "PK") {
    ...
    {
        return string(abi.encodePacked(_baseURI(), "metadata_", Strings.toString(tokenId), ".json"));
    }
