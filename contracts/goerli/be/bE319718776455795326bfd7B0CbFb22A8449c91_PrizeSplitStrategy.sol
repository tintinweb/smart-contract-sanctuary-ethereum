...
abstract contract PrizeSplit is IPrizeSplit, Ownable {
    ...
    function __PrizeSplit_init_unchained(
        address owner
    ...
    function getPrizeSplit(
        uint256 _prizeSplitIndex
    ) external view override returns (PrizeSplitConfig memory) {
    ...
    /// @inheritdoc IPrizeSplit
    function setPrizeSplits(
        PrizeSplitConfig[] calldata _newPrizeSplits
...
/**
  * @title  Asymetrix Protocol V1 PrizeSplitStrategy
  * @author Asymetrix Protocol Inc Team
  * @notice Captures PrizePool interest for PrizeReserve and additional PrizeSplit recipients.
            ...
            the deployers requirements (i.e. percentage to charity). In contrast to previous Asymetrix Protocol
