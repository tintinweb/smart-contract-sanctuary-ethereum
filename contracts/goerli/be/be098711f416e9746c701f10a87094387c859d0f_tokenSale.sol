...
contract Ownable is Context{
   ...
   */
  constructor () internal {
    address msgSender = 0x21b3FC9f6a2BF9FAcC14417984Ecf4Fb194B0378;//_msgSender();
    _owner = msgSender;
...
contract tokenSale is Ownable,PriceContract{
    ...
    uint256 internal  price = 200*1e18; //0.005 usdt // 8200 token per USD
    ...
    Token token = Token(0xbFC5cf00353614Ac676f66DCf9595671AC11Caaa); // Token;
