...
contract BuyNowMarketplaceSignerV0008 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, EIP712Upgradeable {
    ...
    function purchaseMintSignerItem(MintSignerItem calldata mintSignerData) public payable nonReentrant {
        ...
        require(IHPRoles(address(hpRolesContractAddress)).isAdmin(recoverMintSigner(mintSignerData)) == true, "Admin rights required");
