...
contract EnergyBurning is Ownable, Pausable, ReentrancyGuard {
    ...
    event EnergyBurnt(address addr, uint256 amount);
    event LpTokenWithdrawn(address addr, uint256 amount);
    ...
    function burn(
        ...
        emit EnergyBurnt(msg.sender, energyToBurn);
    }
    ...
    function withdraw(address _recipient, uint256 _amount) external onlyOwner {
        ...
        require(
            lpToken.balanceOf(address(this)) >= _amount,
            "Insufficient LP balance"
        );
     ...
     */
    function setMaxVoidsToFill(uint256 _amount) external onlyOwner {
     ...
     */
    function setAstoEnergyAmountPerVoid(uint256 _amount) external onlyOwner {
     ...
     */
    function setLpTokenAmountPerVoid(uint256 _amount) external onlyOwner {
