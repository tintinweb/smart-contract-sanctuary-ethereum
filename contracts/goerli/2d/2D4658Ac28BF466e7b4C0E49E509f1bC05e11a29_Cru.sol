...
contract Cru is ERC20, OnlyAuthorized, IOperable {
    ...
    constructor() ERC20("CRUITEM", "CRU") {}

    function mint(uint256 amount) external {
        require(
            msg.sender == oilWellAddress,
            "only the well can create crus"
        );
    ...
    function setOilWellAddress(address oilWell) external onlyOwner {
