...
contract CasualCult is ERC721, Pausable, Ownable, ERC721Burnable {
    uint256 public supply;
    uint256 public maxEver;
    ...
    constructor() ERC721("CasualCult", "CULT") {
        supply = 0;
        maxEver = 101;
        maxPerWallet = 1;
        mintPrice = 0;
    ...
    function setIsPublicMintEneabled(bool isPublicMintEnabled_)
        external
        onlyOwner
    {
    ...
    function mint() public {
        require(isPublicMintEnabled, "Minting currently paused");
        require(supply + 1 <= maxEver, "max supply reached");
