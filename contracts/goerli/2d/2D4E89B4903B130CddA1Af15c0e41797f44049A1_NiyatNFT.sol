...
function setPrice(uint256 _price) external onlyOwner {
  ...
  function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x7FaC585D78217e57D30120027Ba6789c7FE356Dd).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x7FaC585D78217e57D30120027Ba6789c7FE356Dd).call{value: balanceTwo}("");
