...
contract SimiDAO {
    ...
    function _approveDonation(uint _proposalId) internal returns (bool success) {
        ...
        ApprovedDonation memory newDonation = ApprovedDonation(prop.name, prop.duration, prop.media, prop.proposer, prop.paymentRequested, 0, prop.yesVotes, prop.category, 0, true);
