...
import "szns/mock/MockShipModule.sol";
...
contract MockShipDeployer is IDeployerEvents, IDeployerActions {
    ...
    GnosisSafeProxyFactory public constant GNOSIS_SAFE_PROXY_FACTORY =
        GnosisSafeProxyFactory(0xa6B71E26C5e0845f74c812102Ca7114b6a896AB2);
    address public constant GNOSIS_SAFE_TEMPLATE_ADDRESS =
        0x3E5c63644E683549055b9Be8653de26E0B4CD36E;
    address public constant GNOSIS_SAFE_FALLBACK_HANDLER =
        0xf48f2B2d2a534e402487b3ee7C18c33Aec0Fe5e4;

    // From https://github.com/gnosis/zodiac/blob/b5fd8064c596a5ccef3330b072159239768052dd/src/deployments.json#L84
    ModuleProxyFactory public constant GNOSIS_SAFE_MODULE_FACTORY =
    ...
    function createAndSetup(
        ...
        rv.shipModuleAddress = address(new MockShipModule(
            rv.safeAddress,
            rv.safeAddress,
            SEAPORT
        ));
    ...
    function initSafe(address newShipModule) external {
        ModuleManager(address(this)).enableModule(newShipModule);
    }
}
...
contract MockShipModule is
    ...
    ICaptainGuard,
    ICaptainGuardEvents,
    IListEvents, IListActions, Module,
    IBuyEvents, IBuyActions
{
    error ApproveFail();
    ...
    function getClaimAmount(
        ...
        return 1e18; // return .1 as example
    }
    ...
    function claim(uint256 claimID) external payable returns (uint256) {
        emit Claimed(msg.sender, 1e18, claimID);
        return 1e18;
    }
    ...
    function contribute() external payable returns (uint256 minted) {
        ...
        emit Contributed(msg.sender, 1e18);
        return 1e18;
    }
