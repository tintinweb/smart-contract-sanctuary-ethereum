...
import "./interfaces/lotteryEvents.sol";

contract Lottery is ReentrancyGuard, Initializable, VRFv2Consumer, lotteryEvents {
    ...
    function createRaffle(
        ...
        raffleEntry1.rewardPercent = 10000 - profitPercent - burnPercent;
        emit RaffleCreated(
            totalRaffles,
            _raffleName,
            _maxTickets,
        ...
        nonReentrant
    {
        ...
        totalBurnAmount += (msg.value * raffleInfo1.burnPercent) / 10000;
        ...
        totalRevenue += (msg.value * (10000 - raffleInfo1.rewardPercent)) / 10000;
        emit BuyTicket(
            _raffleNumber,
            msg.sender,
            ticketStart,
    ...
    function declareWinner(uint256 _raffleNumber) external onlyOperator {
        ...
        uint256 rewardInEth = ((raffleInfo.ticketPrice * raffleInfo.ticketCounter) *
            raffleInfo1.rewardPercent) / 10000;
    ...
    function claimReward(uint256 _raffleNumber) external nonReentrant returns (bool) {
        ...
        raffleInfo1.raffleRewardTokenAmount = 0;
    ...
    function swapRewardInToken(address _rewardToken, uint256 _reward)
        internal
        returns (uint256)
    {
        ...
        returns (uint256)
    {
        ...
        uint256 profitAmount = (profitpercent * totalAmount) / 10000;
        uint256 splitWallet1Amount = (profitAmount * profitSplit1BP) / 10000;
    ...
    // Update Percentages and Wallets
