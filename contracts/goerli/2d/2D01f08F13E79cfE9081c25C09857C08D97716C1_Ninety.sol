  ...
  return
    string(
      abi.encodePacked(
        ...
        '" fill="',
        rectangle.border,
        '" stroke-width="5" /> <pattern id="pattern" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse"><rect x="0" y="0" width="20" height="20" fill="',
        rectangle.border,
        '" /> <path d="M 0 10 L 10 0 10 20 0 10" fill="white" /></pattern> <rect x="',
        uint2str(rectangle.x + rectangle.width - 100),
        '" y="',
        uint2str(rectangle.y + rectangle.height - 100),
        '" width="100" height="100" fill="url(#pattern)" />'
        )
    );
}
        ...
        returns (string memory)
    {
        ...
        if (rectangleSize1 == 1) {
            ...
            // Generate a random x-coordinate between 0 and 800
            uint x3 = (randomSeed % 800) ;
            Rectangle memory rectangle3 = createRectangleStruct(
                x3,
                y,
                300,
            ...
            // Generate a random x-coordinate between 0 and 550
            uint x2 = (randomSeed % 550) ;
            // Generate a random x-coordinate between 550 and 800
            uint x3 = (randomSeed % 250)  + 550;
            Rectangle memory rectangle2 = createRectangleStruct(
                x2,
                y,
                300,
            ...
            lineSvg = string.concat(lineSvg, RectangleSvg(rectangle1), RectangleSvg(rectangle2), RectangleSvg(rectangle3));
        }
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '" cy="',
                    uint2str(y),
                    '" r="40" fill="#ffffff" stroke="black" stroke-width="3"><animate attributeType="XML" attributeName="fill" values="#ffffff00;#ffffff00;#ffffff00;#ffffff00;#ffffff00;#ffffff;#ffffff00;#ffffff00;#ffffff00;#ffffff00;" dur="3s" repeatCount="indefinite"/></circle>'
                )
            );
    }
