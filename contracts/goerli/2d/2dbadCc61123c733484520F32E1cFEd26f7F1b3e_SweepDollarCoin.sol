...
contract SweepDollarCoin is BaseSweep {
    ...
    uint256 public constant TIME_ONE_YEAR = 31536000;
    ...
    function setPriceTarget(uint256 _new_target_price) public onlyByOwnGov {
        ...
        previous_target_price = current_target_price;
        next_target_price = current_target_price * ((((PRICE_PRECISION + global_interest_rate) / PRICE_PRECISION)**(period_time / TIME_ONE_YEAR)) * PRICE_PRECISION) / PRICE_PRECISION; 
