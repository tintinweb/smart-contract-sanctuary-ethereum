...
contract Vesting is Ownable {
    ...
    struct VestingParams {
        ...
        uint256 price; // 12-decimals value of "paymentToken" amount asked per 1 "vestedToken" unit
     ...
     */
    constructor(address vestedToken_, address paymentToken_) Ownable() {
