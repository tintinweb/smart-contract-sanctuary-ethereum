...
contract GuardiansOfEthTreasury is Ownable, Utilities {
    ...
    constructor (address _geth) {
        geth = IERC20(_geth);
    }

    receive() external payable {}

    function setGEth(address _geth) external onlyOwner {
        geth = IERC20(_geth);
    }
    ...
    function swapAndDistribution() external onlyOwner {
        ...
        IRevanentStaking(staking).updatePools();
    }
