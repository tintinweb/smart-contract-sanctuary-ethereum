...
abstract contract EventEnds is OwnableUpgradeable {
    ...
    function __EventEnds_set_unchained(uint256 ends_) internal {
    	_ends = ends_;
    }
...
abstract contract EventStarts is OwnableUpgradeable {
    ...
    function __EventStarts_set_unchained(uint256 starts_) internal {
    	_starts = starts_;
    }
...
ERC721BurnableUpgradeable, EventStarts, EventEnds {
