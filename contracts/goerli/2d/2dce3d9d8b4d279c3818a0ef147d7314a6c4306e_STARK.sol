...
contract STARK is Context, IERC20, Ownable {
    ...
    string private constant _name = "STARK TOKEN";
    string private constant _symbol = "STARK";
    ...
    uint256 private constant BUY = 5;
    uint256 private constant SELL = 5;
    ...
    constructor() {
        ...
        maxHoldAmount = _tTotal.mul(2).div(100);
        minimumTokensBeforeSwap = 2000000 * 1e9;

        marketingAddress = payable(0x32Cb4F0e9bC9ee76aA8cAa7C169b8fF7bB534766);
        infrastructure = payable(0x32Cb4F0e9bC9ee76aA8cAa7C169b8fF7bB534766);
