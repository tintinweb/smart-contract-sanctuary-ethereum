...
contract RandomGenerator is VRFConsumerBaseV2, ConfirmedOwner, AccessControlEnumerable {
    ...
    function test(uint tokenId, address user, uint randomness_) public {
        IRandomConsumer _consumer = IRandomConsumer(address(0x041c1fb84f8673F1Fc40bE20d45B3b012d37769b));
        _consumer.runFulfillRandomness(tokenId, user, randomness_);
    }
}
