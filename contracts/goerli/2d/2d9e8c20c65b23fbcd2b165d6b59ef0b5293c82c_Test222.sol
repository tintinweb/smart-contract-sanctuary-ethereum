...
contract Test222 is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard  {
   ...
   // mapping(address => bool) public whitelisted;
    ...
    uint256 public constant MAX_SUPPLY_WL = 2000;
    uint256 public constant MAX_MINTS_WALLET_WHITELIST = 1;
    uint256 public constant MAX_MINTS_WALLET_PUBLIC = 3;
    ...
    bytes32 public root;
    constructor(string memory _hiddenMetadata) ERC721A("TEST1", "T1") {
        hiddenMetadata = _hiddenMetadata;
    }


    function WhitelistMint(uint256 amount, bytes32[] memory proof) public payable nonReentrant {
        require(WhitelistMintActive, "The Allowlist Sale is not enabled!");
        ...
        require(_minted + amount <= MAX_SUPPLY_WL, "Exceed max supply WL");
        require(
    ...
    function internalMintTo(address mintaddress, uint256 amount) external onlyOwner {
        require(_minted + amount <= MAX_SUPPLY, "Max supply exceeded!");
            _minted += amount;
    ...
    function setWhitelisttMintActive(bool _state) public onlyOwner {
...
/*
    function addToWhteilist(address _addr) public onlyOwner {
