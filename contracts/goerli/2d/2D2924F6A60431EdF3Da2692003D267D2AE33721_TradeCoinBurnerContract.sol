...
contract TradeCoinBurnerContract is ERC721, ITradeCoinBurnerContract {
    uint256 public tokenCounter = 1;

    mapping(uint256 => TradeCoinBurner) private _tradeCoinBurner;
    ...
    function mintToken(
        ...
        _tradeCoinBurner[tokenCounter] = TradeCoinBurner(
            commodity,
            amount,
            unit,
        ...
        override
    {
        ...
        unchecked {
            _tradeCoinBurner[tokenId].amount += amountIncrease;
        }
    }
        ...
        override
    {
        ...
        unchecked {
            _tradeCoinBurner[tokenId].amount -= amountDecrease;
        }
    }
    ...
    function updateDefaultTransaction(
        ...
        _tradeCoinBurner[tokenId].defaultTransformation = defaultTransformation;
    }
    ...
    function tradeCoinBurner(uint256 tokenId)
        ...
        returns (TradeCoinBurner memory)
    {
        require(_exists(tokenId), "Query for non-existent burner token");

        return _tradeCoinBurner[tokenId];
    }
}