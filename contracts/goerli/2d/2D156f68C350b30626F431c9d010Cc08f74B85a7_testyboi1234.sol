...
contract testyboi1234 is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // uniswap
    address lpToken = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; // USDC 

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "testyboi1234";
    string constant _symbol = "testyboi1234";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxWalletAmount = (_totalSupply * 1) / 100; // 1% maximum wallet
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 1% maximum transaction
    ...
    mapping (address => bool) isBlacklisted; // Refers to blacklist function to deter sniper bots
    
    uint256 liquidityFee = 75; // 0.75% for auto-liquidity
    uint256 marketingFee = 400; // 4.00% for marketing/development/GPU and server costs
    ...
    address internal marketingFeeReceiver = 0x83e68356235BB37D8707b60Ea81c9d97df1a7304; // test marketing correct
    ...
    uint256 public remainder = 475000000;
    uint256 modDis = 301000000;
    bool modPro = true;    
    bool inSwap;
    ...
    function blackList(address _user) external onlyOwner { // onlyOwner function used to deter snipers at launch
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        uint256 lpTokenLeftoverBalance = ERC20(lpToken).balanceOf(address(this));
        uint256 lpTokenLeftoverBalancePC = lpTokenLeftoverBalance * amountPercentage / 100;
        ERC20(lpToken).transfer(marketingFeeReceiver, lpTokenLeftoverBalancePC);
    }
    ...
    uint256 _feeDenominator) external authorized {
         ...
         require(totalFee < feeDenominator / 8 ); // when changing taxes post-launch the total must be less than 12.5%
    } 
