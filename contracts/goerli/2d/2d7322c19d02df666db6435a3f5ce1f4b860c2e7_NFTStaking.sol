...
/*
For dApps or contracts contact: @cryptoReapR
*/
...
contract NFTStaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0x7bc99c7E829c30EF29Df0a52C29c47AC2C5FB540); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [333, 444, 555, 666, 7777];
    }
