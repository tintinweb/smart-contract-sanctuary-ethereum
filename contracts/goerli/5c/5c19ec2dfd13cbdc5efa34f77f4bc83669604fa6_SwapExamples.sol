...
contract SwapExamples is Ownable {
    ...
    function _swapExactInputSingle(uint256 amountIn) private returns (uint256 amountOut) {
        ...
        // Approve the pegswap to spend LINK.
        TransferHelper.safeApprove(LINK, address(pegswap), amountOut);
        pegswap.swap(amountOut,LINK,ERC677LINK);
        IERC20(ERC677LINK).transfer(consumer,amountOut);
        return(amountOut);
    }
