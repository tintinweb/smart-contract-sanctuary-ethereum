    ...
    IERC721KODACreatorWithBuyItNow
{
     ...
     */
    function buyEditionToken(uint256 _editionId, address _recipient)
        external
        payable
        override
        whenNotPaused
     ...
     * @param _recipient the address that should receive the token purchased
     */
    function buyToken(uint256 _tokenId, address _recipient)
        external
        payable
        override
        nonReentrant
    ...
    function createEditionBuyItNowListing(
        ...
        _createEditionBuyItNowListing(_editionId, _listingPrice, _startDate);
    }
     ...
     */
    function deleteEditionBuyItNowListing(uint256 _editionId)
        external
        override
        onlyEditionOwner(_editionId)
    {
    ...
    function mintAndListEditionForBuyNow(
        ...
        _createEditionBuyItNowListing(editionId, _listingPrice, _startDate);
        return editionId;
    }
    ...
    function _createEditionBuyItNowListing(
        ...
        // Store listing data
        editionListing[_editionId] = EditionListing(_listingPrice, _startDate);
