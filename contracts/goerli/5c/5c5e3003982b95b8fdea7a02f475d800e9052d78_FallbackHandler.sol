...
import "../interfaces/IStacktWalletV0_0_1.sol";
import "../StacktWallet.sol";

// IERC1155Receiver is IERC165
contract FallbackHandler is IERC1271, IERC1155Receiver, IERC721Receiver, IERC777Recipient { 
    ...
    function supportsInterface(bytes4 interfaceId) external view virtual override returns (bool) {
        return
            ...
            interfaceId == type(IStacktWalletV0_0_1).interfaceId;
    }
...
interface IStacktWalletV0_0_1 {
    ...
    function STACKT_VERSION() external view returns (string memory);
    function approveHash(bytes32 hashToApprove) external;
    function approvedHashes(address, bytes32) external view returns (uint256);
    function changeThreshold(uint256 _threshold) external;
    function checkNSignatures(bytes32 dataHash, bytes memory signatures, uint256 requiredSignatures) external view;
    ...
    function fundPrice() external view returns (uint256);
    function funderLimit() external view returns (uint256);
    ...
    function setup(StacktWalletSetup memory stacktSetup, address fallbackHandler, address guard) external payable;
    function signedMessages(bytes32) external view returns (uint256);
    function simulateAndRevert(address targetContract, bytes memory calldataPayload) external;
    function startFundingTime() external view returns (uint256);
    function useAutoThreshold() external view returns (bool);
}
