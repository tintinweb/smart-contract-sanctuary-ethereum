...
// @authors: Jack & Brume https://twitter.com/JJ2020 for humanunderwatersociety.org
/**
 * @title: FFOHERC721A 
 * 
/*
...
contract FFOHisERC721A is Ownable, ERC721A, PaymentSplitter, ERC721AQueryable {
    ...
    uint private constant MAX_RESERVE = 1000;
    uint private constant MAX_WHITELIST = 3800;
    uint private constant MAX_PUBLIC = 5200;
    uint private constant MAX_SUPPLY_MINUS_RESERVE = MAX_SUPPLY - MAX_RESERVE;

    uint public wlSalePrice = 0.01 ether;
    uint public publicSalePrice = 0.02 ether;

    uint public saleStartTime = 1669150800;
    ...
    uint private constant maxPerAddressDuringWhitelistMint = 20;
    uint private constant maxPerAddressDuringPublicMint = 80;
    ...
    address[] private _team = [
        0x8F098A65f5ad1c9F1a92Ee2D3F1e203e2a73fF04,
        0x5A2A5E7A05cd51A6B9B36D5fcfD5aBa6769F5A41,
        0x8f434824960eB7Ba8a0615295f0E47F4784dAa0B,
        0x7a32bb02E2d87A979fFA0791c607bF280B982C7a
    ];
    ...
    ERC721A("The First Friends Of HUS", "FFOH") 
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        require(!isPaused, "Contract is Paused");
        require(currentTime() >= saleStartTime + 72 hours, "Public sale has not started yet");
        require(currentTime() < saleStartTime + 216 hours, "Public Sale is finished");
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY_MINUS_RESERVE, "Max supply exceeded");
        require(msg.value >= price * _quantity, "Not enought funds");
    ...
    **/
    function pullOnReserve(address _to, uint _quantity) external onlyOwner {
