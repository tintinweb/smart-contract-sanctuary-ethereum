...
// File: contracts/library/CloneBase.sol
...
// File: contracts/Interface/IMinimalProxy.sol
...
// File: contracts/Interface/IReferralManager.sol
...
// File: contracts/vesting/LinearVesting.sol
...
contract LinearVesting is ReentrancyGuard, Ownable {
    ...
    function init(bytes memory _encodedData) public {
        ...
        (token, owner, start, end, cliffDuration, vestingName, tokenURL) = abi
            .decode(
                _encodedData,
...
// File: contracts/vesting/VestingFactory.sol
