...
contract CrossChainNFT is Initializable, ONFT721Upgradeable, ERC721URIStorageUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(string memory _name, string memory _symbol, address _lzEndpoint, uint _startMintId, uint _endMintId, address sender, uint16[] memory remoteChainIds) public initializer {
        ...
        for(uint i = 0; i < remoteChainIds.length; i++) {
            //this.setTrustedRemote(remoteChainIds[i], abi.encodePacked(address(this), address(this)));
