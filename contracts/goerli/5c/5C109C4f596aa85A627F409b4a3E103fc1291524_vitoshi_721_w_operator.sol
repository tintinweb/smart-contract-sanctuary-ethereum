...
contract vitoshi_721_w_operator is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {  
  ...
  mapping (address => uint256) public whitelistMintedByAddress;  
	...
	constructor() ERC721("Vitoshis Castle OutTakes", "VITOT") {
    ...
    require( (whitelistMintedByAddress[msg.sender] + contestantsToMint) <= WHITELIST_LIMIT_PER_WALLET , "Exceeds Whitelist Limit / Wallet");
    require(balanceOf(msg.sender) + contestantsToMint <= TOTAL_LIMIT_PER_WALLET,"Exceeds limit - 30/wallet");

    whitelistMintedByAddress[msg.sender] += contestantsToMint;
