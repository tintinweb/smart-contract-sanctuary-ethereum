...
contract ParentC8Token is ERC1155, AccessControl {
    string public constant contractURI = 'https://nft-dev-b6c9c-default-rtdb.europe-west1.firebasedatabase.app/mumbai/store.json';
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    constructor() ERC1155('https://nft-dev-b6c9c-default-rtdb.europe-west1.firebasedatabase.app/mumbai/titles/') {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(URI_SETTER_ROLE, msg.sender);
        _grantRole(PAUSER_ROLE, msg.sender);
        // ERC1155Predicate on Goerli
        _grantRole(PREDICATE_ROLE, 0x72d6066F486bd0052eefB9114B66ae40e0A6031a);
    }
