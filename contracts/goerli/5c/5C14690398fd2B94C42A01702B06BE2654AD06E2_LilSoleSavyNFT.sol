...
contract LilSoleSavyNFT is ERC721, AccessControl {
    ...
    function publicSalesMint(uint256 amount) external payable {
        ...
        require(
            amountMintedPublic[msg.sender] + amount <= 10,
            "SSNFT: You can only mint 10 in total on Public Sale."
        );
        ...
        payable
    {
        ...
        require(
            amountMintedPresale[msg.sender] + amount <= 10,
            "SSNFT: You can only mint 10 in total on Pre Sale."
        );
    ...
    /// @param _baseURI is the new url for baseURI
