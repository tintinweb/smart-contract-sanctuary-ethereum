...
contract MerkleRedeemer is Ownable {
    ...
    function addRoot(
        ...
        require(oopsieDAI.transferFrom(msg.sender, address(this), totalWeekAmount), "redeemer/transfer-from-failed");
    ...
    function claimMultiple(
        ...
        for (uint256 i = 0; i < _weeks.length; i = unsafe_inc(i)) {
        ...
        require(oopsieDAI.transfer(msg.sender, total), "redeemer/transfer-failed");
    }
