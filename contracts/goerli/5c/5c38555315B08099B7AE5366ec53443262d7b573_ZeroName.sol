...
contract ZeroName is UniversalZeroName {
    constructor(address _layerZeroEndpoint, uint _startMintId, uint _endMintId) UniversalZeroName("Zero Name DID", "ZeroName", _layerZeroEndpoint, _startMintId, _endMintId) {}
}
...
contract UniversalZeroName is ONFT721 {
    ...
    // return "https://ipfs.io/ipfs/QmZDkFkunmdjYRp4wMocJ4GXrceEhDDmxi4qkKE6R5DwUZ?filename=Warrior";
}
