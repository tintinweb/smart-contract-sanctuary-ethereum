...
contract Test1 is ERC20, Ownable {
    ...
    constructor() payable ERC20("Test 1", "Test1") {
        ...
        uint256 totalSupply = 1 * 1e9 * 1e18; // 1 trillion
        ...
        _createInitialSupply(newOwner, (totalSupply * 50) / 100); // Lock
    ...
    function stepOne(bool confirmAddLp) external onlyOwner {
