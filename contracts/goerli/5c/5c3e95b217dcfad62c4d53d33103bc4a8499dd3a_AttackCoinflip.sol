...
contract AttackCoinflip{  
    ...
    constructor (address victimAddress) {
        coinflipAddress = victimAddress;
        coinflipContract = ICoinFlip(victimAddress);
    }
    ...
    function flip() external {
        ...
        // console.logBytes32(keccak256(abi.encodePacked(block.number-1)));
        // console.logBytes((abi.encodePacked(block.number-1)));
