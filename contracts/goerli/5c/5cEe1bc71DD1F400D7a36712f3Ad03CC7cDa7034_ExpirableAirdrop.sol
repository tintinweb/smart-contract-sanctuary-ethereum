...
interface IGovernable {
   ...
   * @param _newPendingGovernor The new pending governor
   */
  event PendingGovernorSet(address _newPendingGovernor);
   ...
   */
  function isPendingGovernor(address _account) external view returns (bool);
