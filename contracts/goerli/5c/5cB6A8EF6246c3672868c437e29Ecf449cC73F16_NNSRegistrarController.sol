...
contract NNSRegistrarController is Ownable {
    ...
    {
        __NNSRegistrarController_init(_base,_prices,_minCommitmentAge,_maxCommitmentAge,_wlBegin,_wlEnd,_pubBegin);
    }    
    ...
    {
        __Ownable_init();
        __NNSRegistrarController_init_unchained(_base,_prices,_minCommitmentAge,_maxCommitmentAge,_wlBegin,_wlEnd,_pubBegin);
    }
    ...
    function __NNSRegistrarController_init_unchained(
        ...
        uint _wlBegin,
        uint _wlEnd,
        uint _pubBegin) internal onlyInitializing {
