...
contract CCore is FxBaseRootTunnel {
...
contract CSub is CrossChainEnabledPolygonChild, AccessControlCrossChain {
    ...
    function getEncodedSetNumberData(uint256 newNumber) external pure returns (bytes memory) {
        return abi.encodeWithSelector(CSub.setNumberForParentChain.selector, newNumber);
    }
