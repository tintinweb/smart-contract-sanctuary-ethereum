...
contract staging is ERC721A, Ownable, ERC2981 {
    ...
    function wlMint(uint256 _amount) public payable {
        ...
        require(_presaleList[msg.sender], "You are not on the Whitelist");
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory){
            ...
            if(isRevealed == false){
                return "ipfs://QmfDwfpQZNCESSjzaYTx44pU2uLifFaBtYHkZiDd1oD94N/hidden.json";
            }
