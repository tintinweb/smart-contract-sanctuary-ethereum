...
// Winner to be selected every X mininutes --> completly automate
// Chainlink Oracle -> Randomness, Automated execution (Chainlink Keepers)

contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    /* Type declarations */
    enum RaffleState {
        // enum create types for specific uses
        OPEN,
        CALCULATING
    } // equivalent to uint256 0 = OPEN, 1 = CALCULATE
    /* State Variables */
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        // Once we get it, do something with if
        ...
        uint256 requestId = i_vrfCoordinator.requestRandomWords(
            i_gasLane, // gasLane, gas price limit
            i_subscriptionId,
