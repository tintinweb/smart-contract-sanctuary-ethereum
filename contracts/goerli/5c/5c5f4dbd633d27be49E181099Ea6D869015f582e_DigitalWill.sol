...
contract DigitalWill is ERC721A, Ownable, DefaultOperatorFilterer  {
  using SafeMath for uint256;
	using Strings for uint256;
    bytes32 public merkleRoot;
    bytes32 public vipMerkleRoot;
    uint256 public WL_PRICE = 0.023 ether;
    uint256 public VIPWL_PRICE = 0 ether;
    uint256 public PRICE = 0.023 ether;
    string public baseTokenURI;
    bool public whitelistSaleIsActive;
    bool public saleIsActive;
    address public wallet1 = 0x3A5247aC226dFe23c2Dd934a4B4FDBf9bEA71c69; // Wallet 1 - Project
    address public Authorized = 0x3A5247aC226dFe23c2Dd934a4B4FDBf9bEA71c69; // Dev Wallet for Testing (no percentage)
    ...
    constructor() ERC721A("DigitalWill", "DW") {}
  ...
  */
        ...
        bool isApprovedOrOwner = getApproved(tokenId) == msg.sender || ownerOf(tokenId) == msg.sender;
