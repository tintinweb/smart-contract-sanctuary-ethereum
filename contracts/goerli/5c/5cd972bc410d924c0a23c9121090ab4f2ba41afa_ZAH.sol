...
contract ZAH is ERC20, Ownable {
    ...
    constructor() ERC20("Meow", "SMD") {
    	...
    	marketingWallet = 0x64151B60C2B0F5de26690B43BCDA0FcDfd23d7d7; // set as marketing wallet
    	devWallet = 0x37b9714224264C9cb12A37235133167B193EC10c; // set as dev wallet
        ...
        */
        _mint(0x5860BC3769Dfff82Fa6AB8F08ADD9E9562bf141B, totalSupply);
    }
