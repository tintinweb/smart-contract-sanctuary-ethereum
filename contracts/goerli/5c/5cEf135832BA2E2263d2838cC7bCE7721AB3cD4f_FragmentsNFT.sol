...
contract Versioned {
  string public constant version = "0xfa08b7bd6b6bd79b0f533e9bd1ddec00602f6d61";
}
...
abstract contract OperatorFiltererUpgradeable is Initializable {
    ...
    modifier onlyAllowedOperatorApproval(address operator, bool approved) virtual {
        // WITH_DIRECTIVE        
        if (approved) {
            // only check the operator when approving, this allows the user to remove approval from filtered operators
