...
contract ThugCityNFT is ERC721Psi, Ownable {
    ...
    uint256 public immutable maxSupply = 501;
    uint256 public immutable maxMintAmount = 16;
    uint256 public immutable maxWhitelistSupply = 101;
    uint256 public immutable devSupply = 106;
    mapping(address => bool) public managers;
    bool public paused = false;
    bool public whitelistOnly = false;
    mapping(uint256 => bool) private _isCop;
    bytes32 public merkleRoot = 0xa9932bded785f84a4bbc1451d77fb0687644239a7d073a05491dc7a0808eb1db;
    ...
    function devMint(address _addr, uint256 _mintAmount) external onlyOwner{
        require(totalSupply() < devSupply);
        require(_mintAmount % maxMintAmount == 0);
        for(uint256 i = 0; i < _mintAmount / maxMintAmount; i++){
            _safeMint(_addr, maxMintAmount);
        }
    }
