...
contract FactoryNew is OwnableUpgradeable{
    ...
    event DeleteStakeType(address indexed stakeProxy, uint128 stakeType, address indexed caller, uint256 blockTimestamp);
    ...
    event StakingInitialized(address indexed proxyInstance, address indexed stakedToken, uint128 stakePeriod, uint128 depositFees, uint128 withdrawlsFees, uint128 rewardRate, string name, string _symbol, uint256 blockTimestamp);
    ...
    function deleteStakeType(address _stakedToken, uint128 _stakeType) external onlyOwner {
        ...
        emit DeleteStakeType(tokenAddrToStakingAddr[_stakedToken], _stakeType,msg.sender, block.timestamp);
    }
    ...
    function initializeProxyInstance(address _proxyInstance, address _ownerWallet, address _stakedToken, 
                        ...
                        uint128 _withdrawalFees, uint128 _rewardRate, uint128 _emergencyFees, uint128 _platformFee, address _treasury) external onlyOwner {
        ...
        emit StakingInitialized(_proxyInstance, _stakedToken, _stakePeriod, _depositFees, _withdrawalFees, _rewardRate, _name, _symbol, block.timestamp);
        }
    }
