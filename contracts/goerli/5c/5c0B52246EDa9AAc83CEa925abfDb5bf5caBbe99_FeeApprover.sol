...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function setMinimumLiquidityToTriggerStop(uint finneyAmnt)
        public
        onlyOwner
    {
        // 1000 = 1eth
    ...
    function sync() public returns (bool lastIsMint, bool lpTokenBurn) {
        ...
        uint256 _balanceCORE = IERC20(coreTokenAddress).balanceOf(
            tokenUniswapPair
        );
        ...
        lastIsMint =
            _balanceCORE > lastSupplyOfCoreInPair &&
            _balanceWETH > lastSupplyOfWETHInPair.add(minFinney.mul(1 finney));
