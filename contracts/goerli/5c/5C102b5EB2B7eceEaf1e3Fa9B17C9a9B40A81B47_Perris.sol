...
contract Perris is ERC721A, Ownable {
    ...
    constructor(bytes32 _perrisMerkleRoot) ERC721A("Perris", "PERRIS") {
    ...
    function mint(uint256 amount) internal {
        ...
        require(claimedCount[msg.sender] + amount <= LIMIT_PER_WALLET, "Exceeds limit per wallet");

        claimedCount[msg.sender] += amount;
