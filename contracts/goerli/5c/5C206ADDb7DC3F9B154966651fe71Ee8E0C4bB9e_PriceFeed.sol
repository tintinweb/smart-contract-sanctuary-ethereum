...
contract FreezingMON is Pausable, Ownable, CheckContract, ReentrancyGuard, Initializable {
    ...
    address public stakingPool = 0x8Bc3702c35D33E5DF7cb0F06cb72a0c34Ae0C56F;
    address public oracle = 0x09AB3C0ce6Cb41C13343879A667a6bDAd65ee9DA;
    ...
    uint256 public constant VEST_TIME = 180 days; // Half a year of Vesting
    uint256 public constant VEST_DELAY = 2000 days; // 5,48 years of Freezing
...
contract VestingMON is Ownable, ReentrancyGuard {
    ...
    uint256 public constant VEST_TIME = 1000 days;

    IERC20 public immutable MON = IERC20(address(0x1EA48B9965bb5086F3b468E50ED93888a661fc17)); // MON Ethereum
...
contract PriceFeed is Ownable {
    ...
    function getDirectPrice(address _asset) public view returns (uint256 _priceAssetInDCHF) {
        ...
        _priceAssetInDCHF = (scaledChainlinkPrice * (1 ether)) / (scaledChainlinkIndexPrice);
    }
    ...
    function _getChainlinkResponses(
        ...
        internal
        view
        returns (ChainlinkResponse memory currentChainlink, ChainlinkResponse memory currentChainlinkIndex)
    {
        ...
        return (currentChainlink, currentChainlinkIndex);
    }
