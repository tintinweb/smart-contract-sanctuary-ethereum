...
contract DividendDistributor is IDividendDistributor, Ownable {
    ...
    IBEP20 private reflectionToken;
    ...
    function process(uint256 gas) external override onlyToken {
        uint256 _shareholderCount = shareholders.length;

        if(_shareholderCount == 0) { return; }
        ...
        while(gasUsed < gas && iterations < _shareholderCount) {
            if(currentIndex >= _shareholderCount){
                currentIndex = 0;
            }
