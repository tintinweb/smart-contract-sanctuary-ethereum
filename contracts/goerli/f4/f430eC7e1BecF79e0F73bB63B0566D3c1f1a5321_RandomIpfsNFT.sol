...
contract RandomIpfsNFT is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
  ...
  uint256 public s_requestId;  address s_owner;
  ...
  event NftMinted(Breed indexed breed, address indexed minter);
  ...
  function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
    ...
    uint256 moddedRnd = randomWords[0] % 100;
    Breed breed = getBreedFromModdedRng(moddedRnd);
  ...
  function withdraw() public onlyOwner {
    ...
    if(!success) { revert RandomIpfsNFT__WithdrawalFailed(); }
  }
