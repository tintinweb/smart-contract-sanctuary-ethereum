...
// File: contracts/Bats/IERC2981.sol
...
// File: contracts/Bats/ERC2981.sol
...
contract myNFT is Ownable, ERC721, ERC2981 {
  using Address for address;
  ...
  uint256 public constant CRYPTO_SUPPLY = 666;
  ...
  address private mintPayee = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    ...
    ERC721("myNFT", "mNFT")
  {
    ...
    _setRoyalties(mintPayee, 750); // 7.5% royalties
  ...
  function buyPublic(uint256 numberOfTokens) external payable {
    ...
    require(
      (totalSupply + numberOfTokens) <= CRYPTO_SUPPLY,
      "Not enough NFTs remaining"
    );

    uint256 mintPrice = 0.001 ether * numberOfTokens;
  ...
  function withdrawAll() payable onlyOwner external{
    require(address(this).balance > 0, "No balance to withdraw");
    payable(mintPayee).transfer(address(this).balance);
  }
  ...
  function rollStartIndex() external onlyOwner {
    ...
    randomizedStartIndex = (number % CRYPTO_SUPPLY) + 1;
