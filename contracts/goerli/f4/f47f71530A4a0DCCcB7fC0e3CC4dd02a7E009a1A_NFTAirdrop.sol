...
import "dnd/nft_airdrop/token/IERC721AMintable.sol";
import "dnd/nft_collection/token/ERC721A.sol";
import "dnd/nft_airdrop/libraries/MerkleProof.sol";
contract NFTAirdrop is Pausable {
  ...
  constructor (){_owner0 = msg.sender;}
...
interface IERC721AMintable {
    /**
     * @dev Mint `quantity` tokens for address `to`
     * @param to Account will be received token
     * @param quantity Quantity token will be minted
     */
