...
// This is an example used for testing Ramper live payments
...
contract LivePaymentsTest is ERC721Enumerable, IRamperInterface721 {
    uint256 constant public MAX_TOKENS = 10000;
    uint256 constant public MAX_TOKENS_PER_TXN = 3;
    uint256 constant public MAX_TOKENS_PER_ADDRESS = 500;
    uint256 constant public TOKEN_PRICE = 0.00019 ether;

    string public baseTokenURI = "https://nfts-public.s3.amazonaws.com/livepayments/metadata/";

    constructor() ERC721("Live Payments Test", "LPMT") {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        // Regardless of tokenID always return 0 so we don't need to make so many metadata files
