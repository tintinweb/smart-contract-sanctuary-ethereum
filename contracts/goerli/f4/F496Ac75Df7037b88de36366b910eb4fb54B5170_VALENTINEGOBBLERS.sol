 ...
 * @notice This contract handles minting VALENTINE GOBBLERS tokens.
 */
contract VALENTINEGOBBLERS is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeihu2rbyi7pdrqho5wqm7p5xsfwphmbdlfh7n2a2iclpxghdffdome/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 7777;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 7770;
    ...
    constructor(address _blocklistContractAddress)
        ERC721A("VALENTINE GOBBLERS", "VGB")
    {
