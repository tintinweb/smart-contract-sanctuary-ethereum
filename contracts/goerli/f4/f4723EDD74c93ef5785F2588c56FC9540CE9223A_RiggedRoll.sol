...
contract RiggedRoll is Ownable {
  ...
  function riggedRoll() public {
    ...
    //console.log('THE RIG ROLL IS ', roll);
    //require(roll <= 2, 'Roll not good');

    if (roll <= 2) {
      //console.log('riggRolling dice with :');
      //console.log(0.02 * 10**18);
      diceGame.rollTheDice{value: 0.02 * 10**18}();
    } else {
      revert('roll not gud.');
    }
  }
