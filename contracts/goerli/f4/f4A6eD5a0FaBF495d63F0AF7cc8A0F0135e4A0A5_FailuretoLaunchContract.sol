    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "http://localhost:8787/9DFjN2IhEWRnQf71YSxo/contract-metadata";
  }
...
// File: contracts/FailuretoLaunchContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FailuretoLaunchContract is ERC721APlus {
    constructor() ERC721APlus("Failure to Launch", "Fail"){}
}
