...
contract PipaToken is ERC20, Ownable {
    ...
    constructor() ERC20("PipaToken", "PIPA") {
        ...
        uint256 _buyMarketingFee = 3; // 3% supply buy fee
        uint256 _buyLiquidityFee = 0;
        uint256 _buyDevFee = 0;

        uint256 _sellMarketingFee = 3;  // 3% supply sell fee
        ...
        marketingWallet = address(0x96eb917bf80154cBB87Af7139437300864B40032); // set as marketing wallet
        devWallet = address(0xd8EBCd8a9CaAA80DE3cc44147A3e4d6f69881083); // set as dev wallet
