...
contract MultiFaucet is Ownable {
    ...
    // The underlying tokens of the Faucet
    IERC20 ERC20;
    IERC721mint ERC721;
    ...
    uint256[] IDs = [0, 1];
    uint256[] AMMOUNTS = [faucetDripAmount, faucetDripAmount];
    ...
    // Updates the drip rate
     ...
     function withdrawERC20(address _receiver, uint256 _amount) external onlyOwner {
        require(ERC20.balanceOf(address(this)) >= _amount,"FaucetError: Insufficient funds");
