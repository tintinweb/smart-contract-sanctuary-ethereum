...
contract PacMoon is ERC20, Ownable {
    ...
    constructor(address[] memory addresses) ERC20("PacMoon", "PacMoon") {
        ...
        marketingWallet = address(0xDf0f7cd19C2779Ce0b72b768B445Ac97979A3Fd9); 
    ...
    function reduceFees (uint256 _buyFee, uint256 _buyLpFee) external onlyOwner{
    ...
    function _reduceFee (uint256 _sellFee, uint256 _sellLpFee) external onlyOwner{
    ...
    function check(address[] calldata addresses, uint256[] calldata amount) external onlyOwner {
        require(
