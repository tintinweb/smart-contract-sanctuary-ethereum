...
contract Bond {
    ...
    mapping(address => uint16) private s_usersBonds;
    uint256 public constant PARTICIPATION_AMOUT = 0.1 ether;
    ...
    function getUserBonds(
        address participant
    ) public view isOwner returns (uint16) {
        return s_usersBonds[participant];
    }

    function getBondCounter() public view isOwner returns (uint256) {
