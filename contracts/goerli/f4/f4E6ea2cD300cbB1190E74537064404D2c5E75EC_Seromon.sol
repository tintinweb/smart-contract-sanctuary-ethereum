...
contract Seromon is ERC721AQueryable, Ownable, ReentrancyGuard {
 ...
 function whitelist2Mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    // Verify whitelist requirements
    require(whitelist2MintEnabled, 'The whitelist sale is not enabled!');
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This will seperate 41% (30% of Seromon Standard, 10% of Community Return, 1% of Donation) from the total Minting profit.
    // =============================================================================
    (bool mt, ) = payable(0x0fFfF45105270Ed5D814D6356D07F2dE67846cEf).call{value: address(this).balance * 41 / 100}('');
    require(mt);
    // =============================================================================
