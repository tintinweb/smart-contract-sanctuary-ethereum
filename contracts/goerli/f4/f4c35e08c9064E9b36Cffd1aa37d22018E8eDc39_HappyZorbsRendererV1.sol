...
contract HappyZorbsRendererV1 is Initializable, OwnableUpgradeable {
    ...
    function getTokenIdSvg(
        ...
        return
            string(
                abi.encodePacked(
                    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path fill="#EBEBEB" d="M100 0H0V100H100V0Z"/><path fill="white" d="M77.3615 16.3496H22.6504V83.6461H77.3615V16.3496Z"/>',
                    zorbs,
                    '</svg>'
                )
            );
...
@@@@@@@@@@@@@@@@@@@B#RRRRRRRROOOOOOOOOOOOOOOZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ[email protected]@@@@@@@@@@@@@@@@@@@
