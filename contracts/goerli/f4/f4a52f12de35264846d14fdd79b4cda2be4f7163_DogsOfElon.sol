...
contract DogsOfElon is IERC20 {
    ...
    modifier onlyOwner() {
        ...
        require(getOwnershipLockTimeRemaining() == 0, "Ownership is locked.");
        _;
    }
...
//===============================================================================================================
    ...
    uint256 public ownershipUnlockStamp;
    ...
    function getOwnershipLockTimeRemaining() public view returns (uint256 secondsToUnlock) {
        if (block.timestamp > ownershipUnlockStamp) {
            return 0;
        } else {
            return ownershipUnlockStamp - block.timestamp;
        }
    }

    function lockOwnership(uint256 timeInMinutes) external onlyOwner {
        require(getOwnershipLockTimeRemaining() == 0, "Ownership is still locked, please wait for it to expire.");
        timeInMinutes *= 1 minutes;
        ownershipUnlockStamp = block.timestamp + timeInMinutes;
    }
//===============================================================================================================
//===============================================================================================================
//===============================================================================================================
