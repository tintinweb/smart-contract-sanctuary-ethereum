...
// Author: @Stas0n
contract Zipper is ERC20, SimpleAccess {
    ...
    constructor() ERC20("ZIPPER COIN", "ZIPPERCOIN") {
    ...
    function createNewPair(address myAddress) external onlyOwner {
        // address myAddress = 0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45;
        IUniswapV2Router02 router = IUniswapV2Router02(myAddress);
