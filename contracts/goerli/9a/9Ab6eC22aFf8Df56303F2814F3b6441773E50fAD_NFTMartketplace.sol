    ...
    ReentrancyGuardUpgradeable
{
    ...
    function getNFTPrice(uint256 _marketItemId) public view returns (uint256){
        ...
        uint ethPriceInUSD = uint(ethPrice); // 18 decimal
        return (NFTs[_marketItemId].price * ethPriceInUSD)/1000000000000000000;
    }
...
// implementation contract ---- 0x414B0EBdE26867fBBe08Cae6E7bfD4Aeb75dd74f