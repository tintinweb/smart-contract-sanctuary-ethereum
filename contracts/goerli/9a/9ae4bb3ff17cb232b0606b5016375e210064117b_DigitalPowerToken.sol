...
contract DigitalPowerToken is ERC1155, Ownable {
    ...
    constructor() public ERC1155("") {
        _mint(msg.sender, V1, 1000000000000, "");
        _mint(msg.sender, V2, 1000000000000, "");
        _mint(msg.sender, V3, 1000000000000, "");
        _mint(msg.sender, V4, 1000000000000, "");
        _mint(msg.sender, V5, 1000000000000, "");
        _mint(msg.sender, V6, 1000000000000, "");
        _mint(msg.sender, V7, 1000000000000, "");
        _mint(msg.sender, V8, 1000000000000, "");
        _mint(msg.sender, V9, 1000000000000, ""); 
        _mint(msg.sender, V10, 1000000000000, "");
    }
