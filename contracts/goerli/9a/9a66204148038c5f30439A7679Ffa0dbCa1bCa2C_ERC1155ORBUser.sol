...
contract ERC1155ORBUser is OwnableUpgradeable, ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI {
    ...
    /**
     * @dev mint tokens with data (tokenId tokenURI supply creators royalties signatures). 
     */
    ...
    /**
     * @dev return supported interface
     */
...
abstract contract AbstractRoyalties {
    ...
    function _saveRoyalties(uint256 id, LibPart.Part[] memory _royalties) internal {
        ...
        for (uint i = 0; i < _royalties.length; i++) {
            ...
            require(_royalties[i].value >= 0, "Royalty value should be positive number");
            require(_royalties[i].value <=1500,"Royalty can`t be higher than 15%");
...
library LibERC1155LazyMint {
    ...
    /**
     * @notice Mint1155Data struct that we use in mintAndTransfer function when mint ERC1155
     */
    ...
    /**
     * @dev hash mint data (Mint1155Data)
     */
...
abstract contract ERC1155Lazy is IERC1155LazyMint, ERC1155BaseURI, Mint1155Validator, RoyaltiesV2Upgradeable, RoyaltiesV2Impl {
    ...
    function mintAndTransfer(LibERC1155LazyMint.Mint1155Data memory data, address to, uint256 _amount) public override virtual {
        ...
        if (supply[data.tokenId] == 0) {
            ...
            //if needed set _amount in data.supply !!!
