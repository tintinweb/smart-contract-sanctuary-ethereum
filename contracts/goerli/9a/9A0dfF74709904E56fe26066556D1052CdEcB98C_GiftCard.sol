...
contract GiftCard is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    constructor() ERC721("GiftCard", "GFT") {}
    ...
    function safeMint(address to, string memory text) public payable onlyOwner {
        ...
        string memory _value = Strings.toString(msg.value);
        ...
        string memory description = string(
            abi.encodePacked("Unity", _value, " ETH Gift Card")
        );
    ...
    function redeem(uint256 tokenId) public {
        ...
        if (!success) {
            revert GiftCard__RedeemTransferFailed();
        }
