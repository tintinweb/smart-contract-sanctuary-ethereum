...
contract SimpleSwapGOETH {
    ...
    function depositUSDC(uint256 amount) external {
        ...
        //console.log("usdcAddress wallet balance ", this.getBalanceAddress(0xA2025B15a1757311bfD68cb14eaeFCc237AF5b43,0x70997970C51812dc3A010C7d01b50e0d17dc79C8));
    ...
    function getBalance(address _tokenAddress) external view returns (uint256) {
        ...
        function getBalanceAddress(address _tokenAddress,address addr) external view returns (uint256) {
    ...
    function makeArbitrage(uint256 arbitrageamt) external {
        uint256 amountIn = arbitrageamt;
        Exchange result = this._comparePrice(amountIn);
        if (result == Exchange.UNI) {
            //console.log("UNI BODY");
   ...
   function makeArbitrageall(uint256 arbitrageamt) external {
        uint256 amountIn = arbitrageamt;
            ...
            //console.log("daiAddress amount ",amountOut,daiAddress);
            uint256 amountFinal = _swap(
                amountOut,
                sushiswapRouterAddress,
                daiAddress,
            ...
            //console.log("usdcAddress amount ",amountFinal, usdcAddress);
       
    }

    function _comparePrice(uint256 amount) external view returns (Exchange) {
