...
contract TokenBridge is ITokenBridge, PausableUpgradeable, OwnableUpgradeable {
  ...
  function _safeName(address _token) internal view returns (string memory) {
    (bool success, bytes memory data) = _token.staticcall(abi.encodeCall(IERC20Metadata.name, ()));
  ...
  function _safeSymbol(address _token) internal view returns (string memory) {
    (bool success, bytes memory data) = _token.staticcall(abi.encodeCall(IERC20Metadata.symbol, ()));
  ...
  function _safeDecimals(address _token) internal view returns (uint8) {
    (bool success, bytes memory data) = _token.staticcall(abi.encodeCall(IERC20Metadata.decimals, ()));
