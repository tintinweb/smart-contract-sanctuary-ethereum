...
contract OneBitCitizen is ERC721, Pausable, AccessControl, EIP712, ERC721Votes {
    ...
    constructor() ERC721("One-Bit-Citizens", "1BCTZ") EIP712("One-Bit-Citizens", "1"){
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, msg.sender);
        deck.setup(limit); // set count
