...
contract NFTea is ERC721, ReentrancyGuard, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    uint256 public constant MAX_SUPPLY = 304;
    ...
    function mintNFTea() public payable nonReentrant {
        ...
        _tokenIds.increment();
        console.log("Minted", Strings.toString(newItemId));
