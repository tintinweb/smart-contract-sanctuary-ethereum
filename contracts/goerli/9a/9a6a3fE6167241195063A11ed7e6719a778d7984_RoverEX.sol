...
contract RoverEX is Context, IERC20, Ownable {
    ...
    string private constant _name = "RoverEX";
    string private constant _symbol = "RoverX";
    uint256 public _maxTxAmount =   8000000000 * 10**_decimals;
    ...
    constructor () {
        _taxWallet = payable(0xC438E7aDfFd9f50F7D94933ab8c7ac02AcCEf4f9);
