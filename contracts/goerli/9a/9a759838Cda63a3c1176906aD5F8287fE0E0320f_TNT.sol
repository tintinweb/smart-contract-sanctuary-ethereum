...
contract TNT is BaseContract, ERC20Upgradeable {
    ...
    {
        IERC20 _payment_ = IERC20(addressBook.get("USDC"));
        require(_payment_.transferFrom(msg.sender, address(this), amount_), "TNT: Transfer failed");
        _mint(msg.sender, amount_ * 20);
    }
