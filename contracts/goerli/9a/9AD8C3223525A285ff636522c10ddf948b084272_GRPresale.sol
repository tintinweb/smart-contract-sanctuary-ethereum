...
contract GRPresale is Ownable, Whitelist, ReentrancyGuard {
    ...
    */
    ...
    function changeVestingStartTime(
        ...
        require(
            _vestingStartTime > pool.endTime,
    ...
    */
    ...
    function buyTokens(
    ...
    ) public payable onlyActive isEligibleSender nonReentrant {
        ...
        if (userVesting[msg.sender].totalAmount > 0) {
            ...
            userVesting[msg.sender] = Vesting(
                ...
                vestingStartTime + vestingPeriod + vestingCliff
            );
        }
     ...
     */
    function _checkSaleRequirements(
        ...
        require(
            _amount + userVesting[_beneficiary].totalAmount <= pool.maxBuy,
