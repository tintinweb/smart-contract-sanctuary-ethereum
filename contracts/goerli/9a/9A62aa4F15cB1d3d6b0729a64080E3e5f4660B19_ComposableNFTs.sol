...
contract ComposableNFTs is ERC721Enumerable, Ownable {
  bytes32 public termsOfService = "https://www.ghostballnft.com/tos";
  ...
  function mint() public payable onlyWhenNotPaused{
    ...
    if(block.timestamp < mintStartDate + 1 days){
      require(whitelist.whitelistedAddresses(msg.sender) == true, "Not whitelisted");
    }
    
    require(mintsPerAddr[msg.sender] <= 5, "Max. 5 mints per wallet");

    mintsPerAddr[msg.sender] = mintsPerAddr[msg.sender] + 1;
    tokenIds += 1;
