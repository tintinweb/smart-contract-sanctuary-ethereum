...
contract StakeBitcoinxEarnBTCX is ReentrancyGuard{
    ...
    uint256 public maxLimitPerUser = 10000000000000000000000000000;
    uint256 public rewardPerBlock = 2000000000000000000; //wei BTCX Per 10M BTCX (2BTCX per block/10M) 
    uint256 public baseShare = 10000000000000000000000000; //10M BTCX
