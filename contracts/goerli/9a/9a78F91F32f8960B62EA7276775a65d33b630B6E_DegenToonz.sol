...
// File: contracts/DegenToonzMock.sol
...
contract DegenToonz is ERC721, Ownable, ReentrancyGuard {
  ...
  function setRevealed(bool _revealed) public {
      revealed = _revealed;
  }
  ...
  function setBaseURI(string memory _baseURI, string memory _baseExtension) public {
    baseURI = _baseURI;
