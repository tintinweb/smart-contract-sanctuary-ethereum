...
contract FortuneGroup is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    ...
    uint256 public              reserveSupply = 20; // Maximum tokens reserved
    uint256 public              mintPrice = 4 ether; // Price of each NFT in Ethereum
    uint256 public              reservesMinted; // Variable to track total reserves minted
    ...
    mapping(address => uint256) public reserveMintsByAddress; // Mapping to track addresses that have minted reserve tokens

    constructor() ERC721A("The Fortune Group", "FG") {}
    ...
    /**
     * * Set Reserve Supply
     * @dev Set the maximum reserve supply
     * @param reserveSupply_ The new maximum reserve supply
     */
    ...
    /**
     * * Set Coupon Signer
     * @dev Set the coupon signing wallet (public address)
     * @param couponSigner_ The new coupon signing wallet
     */
    ...
    function mint() external payable {
        ...
        require(_totalMinted() - reservesMinted < maxSupply - reserveSupply, "Exceeded Public Supply!");
        // Verify payment
    ...
    /**
     * * Mint Reserve Tokens
     * @dev Minting function for reserved tokens
     * @param qty_ The number of tokens being minted
     * @param coupon_ The hashed signature
     * @param allotted_ The allotted number of reserved tokens
     */
    function mintReserves(uint256 qty_, Coupon memory coupon_, uint256 allotted_) external {
        ...
        // Verify sender has not minted more than allotted reserves
        require(qty_ + reserveMintsByAddress[msg.sender] < allotted_ + 1, "Exceeded Max Allotment!");
               
        // Increase number of reserve tokens minted by sender
        reserveMintsByAddress[msg.sender] += qty_;
