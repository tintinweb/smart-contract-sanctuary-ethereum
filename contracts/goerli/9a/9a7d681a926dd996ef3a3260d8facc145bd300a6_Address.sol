    ...
    IERC721Enumerable
{
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://nft.animalsredlist.com/concept-test/721/";
    }
...
abstract contract ERC721NES is ERC721A {
    address stakingController = 0xa21023028231d0Df484a6E2aE3c6f64dae94EF28;
    uint multiplier = 0;
...
// File: contracts/ERC721NESBasicImpl.sol
...
contract ERC721NESBasicImpl is ERC721NES, Ownable {
    mapping(uint256 => uint256) private tokenToWhenStaked;
    mapping(uint256 => uint256) private tokenToTotalDurationStaked;
    mapping(uint256 => uint256) private startTokenIdOrDie;
    constructor(uint256 _multipler)
        ERC721A("token0test", "T0T")
    {
        multiplier = _multipler;
    }
    function contractURI() public view returns (string memory) {
        return "https://nft.animalsredlist.com/concept-test/721/collection";
    }
    ...
    function getCumulativeDurationLocked(uint256 tokenId)
        private
        view
        returns (uint256)
    {
