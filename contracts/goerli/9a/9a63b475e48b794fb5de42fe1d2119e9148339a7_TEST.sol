...
contract TEST is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 100000 * 1e18;
    uint256 public maxBuyTransactionAmount = 100000 * 1e18;
    uint256 public maxWalletToken = 200000 * 1e18;
    uint256 public swapTokensAtAmount = 10000 * 1e18;

    uint256 private buyTotalFees = 4;
    ...
    uint256 public marketingPercent = 37; 
    uint256 public devPercent = 38; 

    uint256 totalWalletRewardsPercent;
    uint256 totalTeamWalletRewardsPercent;

    address payable public liquidityWallet = payable(0x3eB5Af7d101c8E14eF731E9D7109D6ca42C2D966);

    address payable public treasuryWallet = payable(0x2c72FFA04C311614C16c493A50b6D93cEA4A8feE);
    address payable public marketingWallet = payable(0x45a4E4cB5DcadD3445AcA304026E0157D4Ba0ff2);
    address payable public devWallet = payable(0xf01E9C7D52CFa6f3F5B99Dc20eF4c1a90A832A3a);
