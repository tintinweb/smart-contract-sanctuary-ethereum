...
contract TestMeme is ERC20, Ownable {
    ...
    constructor() ERC20("Test Meme", "TESTMEME") {
        ...
        marketingWallet = payable(0x70997970C51812dc3A010C7d01b50e0d17dc79C8);
        developmentWallet = payable(0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC);
        liquidityWallet = payable(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
        operationsWallet = payable(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
