...
//     .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .----------------.  .-----------------. .----------------.     //
//    | .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |    //
//    | |      __      | || |     _____    | | | |  ____  ____  | || | _____  _____ | || | ____    ____ | || |      __      | || | ____  _____  | || |    _______   | |    //
//    | |     /  \     | || |    |_   _|   | | | | |_   ||   _| | || ||_   _||_   _|| || ||_   \  /   _|| || |     /  \     | || ||_   \|_   _| | || |   /  ___  |  | |    //
//    | |    / /\ \    | || |      | |     | | | |   | |__| |   | || |  | |    | |  | || |  |   \/   |  | || |    / /\ \    | || |  |   \ | |   | || |  |  (__ \_|  | |    //
//    | |   / ____ \   | || |      | |     | | | |   |  __  |   | || |  | '    ' |  | || |  | |\  /| |  | || |   / ____ \   | || |  | |\ \| |   | || |   '.___`-.   | |    //
//    | | _/ /    \ \_ | || |     _| |_    | | | |  _| |  | |_  | || |   \ `--' /   | || | _| |_\/_| |_ | || | _/ /    \ \_ | || | _| |_\   |_  | || |  |`\____) |  | |    //
//    | ||____|  |____|| || |    |_____|   | | | | |____||____| | || |    `.__.'    | || ||_____||_____|| || ||____|  |____|| || ||_____|\____| | || |  |_______.'  | |    //
//    | |              | || |              | | | |              | || |              | || |              | || |              | || |              | || |              | |    //
//    | '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |    //
//     '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'     //
//                                                                                                                                                                         //
...
contract AF is ERC721Creator {
    constructor() ERC721Creator("AI Humans", "AF") {}
}
