...
function createParticular(uint256 percent, address ong, address _wallet) virtual public onlyAdmin {
    Particular particular = new Particular(msg.sender, percent, ong, address(this), _wallet);
