...
// Dependency file: contracts/components/Governor.sol
...
abstract contract Governor {
        ...
        returns (ProposalState)
    {
        ...
        uint256 quorumVotes = (_getTotalVotes() * proposal.ballotQuorumThreshold); // / 10000 because 10000 = 100% 
        uint256 totalVotes = proposal.forVotes + proposal.againstVotes;
        if (
            totalVotes * 10000 >= quorumVotes &&
...
// Dependency file: contracts/interfaces/IMetadata.sol
...
// Dependency file: contracts/interfaces/IWhitelistedTokens.sol
...
// import "contracts/interfaces/IWhitelistedTokens.sol";
...
// import "contracts/components/Governor.sol";
// import "contracts/interfaces/IService.sol";
