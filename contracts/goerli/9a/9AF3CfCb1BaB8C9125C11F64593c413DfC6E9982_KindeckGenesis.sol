    ...
    // ReentrancyGuard
{
    ...
    function initialize(
        ...
        setTierLevel(2, TiersData({tierName: "legendary", tier: 2, tierInitId: 555 , whitelistSupply: 250, WHITELIST_SALE_PRICE: 0.1 * 10 ** 18,  tierSupply: 777, PUBLIC_SALE_PRICE: 0.4 ether }) );
        setTierLevel(3, TiersData({tierName: "epic", tier: 3, tierInitId: 555 + 777, whitelistSupply: 200,  WHITELIST_SALE_PRICE: 0.2 * 10 ** 18, tierSupply: 888, PUBLIC_SALE_PRICE: 0.3 ether}) );
        setTierLevel(4, TiersData({tierName: "rare", tier: 4, tierInitId: 555 + 777 + 888, whitelistSupply: 150,  WHITELIST_SALE_PRICE: 0.3 * 10 ** 18, tierSupply: 2222, PUBLIC_SALE_PRICE: 0.2 ether}) );
        setTierLevel(5, TiersData({tierName: "tranche", tier: 5, tierInitId:  555 + 777 + 888 + 2222, whitelistSupply: 50, WHITELIST_SALE_PRICE: 0.4 * 10 ** 18 , tierSupply: 20000, PUBLIC_SALE_PRICE: 0.1 ether}) );
    }
    ...
    modifier isCorrectPayment(uint256 _price, uint256 _numberOfTokens) {
        ...
        // bool sent = payable(address(this)).transfer(_price * _numberOfTokens);   
