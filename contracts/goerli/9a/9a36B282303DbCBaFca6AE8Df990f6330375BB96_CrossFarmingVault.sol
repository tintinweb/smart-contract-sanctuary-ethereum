...
/// @title A vault contract which deployed on EVM chain, user can stake LP token from EVM liquidity pool
/// to participate MasterchefV2 farm pools(BSC chain), get native CAKE reward in BSC chain.
/// @dev deployed on EVM chain(source chain).
