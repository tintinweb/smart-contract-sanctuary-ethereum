...
contract FairXYZBurn2Redeem is ERC721, Pausable, Ownable, ERC2981 {
    ...
    address collarsContractAddress; 
    ...
    function burn2Redeem(uint256[] memory tokenIds) public whenNotPaused {
        ...
        do {
            require(msg.sender == IERC721xyz(collarsContractAddress).ownerOf(tokenIds[i]), "Sender is not the owner of the collar");
            IERC721xyz((collarsContractAddress)).burn(tokenIds[i]);
