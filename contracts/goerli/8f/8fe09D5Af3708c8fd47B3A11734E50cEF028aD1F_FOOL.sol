...
contract FOOL is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("FOOL", "") {
  ...
  string private customContractURI =
    "ipfs://bafybeicaubdob23y5gluadclpy2ma5okqfssmlz446lmywgq4lmjoitvca";
