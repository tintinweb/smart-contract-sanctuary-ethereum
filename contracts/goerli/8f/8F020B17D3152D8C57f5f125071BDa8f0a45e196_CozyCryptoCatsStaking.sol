...
import "@minteeble/smart-contracts/contracts/token/misc/NftStakingSystem.sol";

contract CozyCryptoCatsStaking is NftStakingSystem {
    constructor(IERC721 _nftCollection, NftStakingERC20Token _rewardToken)
        NftStakingSystem(_nftCollection, _rewardToken)
    {}
}
