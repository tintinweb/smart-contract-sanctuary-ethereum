...
contract ProofOfShit is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public SHIT_PRICE = 0.005 ether;

    uint256 public MAX_SHITS = 3333;
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        ...
        require(totalSupply() + _mintAmount <= MAX_SHITS, 'You missed shiiiits');
        _;
    }

    modifier mintPriceCompliance(uint256 _mintAmount) {
        require(msg.value >= SHIT_PRICE * _mintAmount, 'You need enough ETHs to take PoS');
        _;
    }
