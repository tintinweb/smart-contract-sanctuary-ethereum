...
contract HibiscusDesignerSplitResearchContractV0 is Owned, LiquidSplit, ERC721 {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI,"token",tokenId.toString(), ".json")) : "";
    }
}
