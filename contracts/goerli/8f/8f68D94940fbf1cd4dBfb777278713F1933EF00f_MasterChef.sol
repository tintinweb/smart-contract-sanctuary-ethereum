...
contract MasterChef is Ownable {
    ...
    // Safe Cope transfer function, just in case if rounding error causes pool to not have enough Cope.
...
contract CopeToken is ERC20 {
    ...
    constructor() ERC20('SwapFish', 'FISH') {
