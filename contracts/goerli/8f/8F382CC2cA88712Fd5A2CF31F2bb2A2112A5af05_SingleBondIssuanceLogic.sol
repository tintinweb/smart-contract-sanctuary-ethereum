...
library TickLogic {
    ...
    function getPositionValue(
        ...
        else if (position.epochId > tick.loanStartEpochId && tick.baseEpochsAmounts.borrowed > 0) {
            positionValue = (epoch.deposited + epoch.endOfLoanEarnings).mul(position.originalDeposit).div(
                epoch.deposited + epoch.endOfLoanEarnings
            );
        }
