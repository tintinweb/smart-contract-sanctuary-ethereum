...
contract MyTokenUpgr is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;

    CountersUpgradeable.Counter private _tokenIdCounter;
    string private _myVersion = "This is V7.1";
    ...
    function initialize() initializer public {
        __ERC721_init("MyTokenUpgr", "MTKU");
        __Pausable_init();
        __Ownable_init();
