...
contract DOGCoin is ERC20, Ownable {
    ...
    constructor(
        ...
        uint256 marketingAmount = (initialSupply * 6) / 100;
        uint256 cexAmount = (initialSupply * 2) / 100;
        uint256 partnershipAmount = (initialSupply * 10) / 100;
    ...
    function _transfer(
        ...
        if ((tradingEnabled && sender == uniswapPair) && !isExcludedWallet) {
            require(balanceOf(recipient) + amount <= maxWalletAmount, "Forbid");
        }
        // Apply tax
