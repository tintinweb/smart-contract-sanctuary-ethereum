...
contract BDC is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
    ...
    // uint256 public constant WL_SALE_PRICE = 0.1 ether;
    ...
    modifier canMintBDCs(uint256 numberOfTokens) {
        require(
            _nextTokenId() + numberOfTokens <= maxBadDogs,
    ...
    // function maxBDC() external view returns (uint256) {
    //     return maxBadDogs - 1;
    // }
