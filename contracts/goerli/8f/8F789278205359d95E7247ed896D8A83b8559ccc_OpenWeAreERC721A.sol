...
// @author Nolan.msnldry https://www.instagram.com/nolan.msnldry/
...
contract OpenWeAreERC721A is Ownable, ERC721A, PaymentSplitter {
    ...
    /**
    * This contract can't be called by other contracts
    */
    ...
    /**
    * @notice Mint fonction for the Whitelist Sale
    *
    ...
    */
    ...
    function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        require(!isPaused, "Contray is paused");
    ...
    /**
    * @notice Mint fonction for the Public Sale
    *
    ...
    */
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(amountNFTperWalletPublicSale[msg.sender] + _quantity <= maxPerAddressDuringPublicMint, "You can only get 3 NFT during the Public Sale");
    ...
    *
    * @param _isPaused the or false if we want tp âuse or unpause the contract
    */
    ...
    */
    ...
    /**
    * @notice Returns true if leaf can be proved to be a part of a merkle tree defined by root
    *
    ...
    * @param _proof The Merkle Proof
    *
    * @return bool return tue if the address is whitelisted, false otherwise
    */
