...
contract RentNFT is IERC721Receiver, AccessControl {
    ...
    // create local varible and this variable is used in rentnftinternal method
    uint256 ownerCommision;
    ...
    function rentnftinternal(
        ...
        ownerCommision = (rent * rentCommision) / 100;
        collectingRent = rent - ownerCommision;
        ...
        ownerCommision -= discount;

        // rentCommisionFunds
        rentCommisionFunds = rentCommisionFunds + ownerCommision;
