  ...
  Claimable
{
    ...
    validGender(_gender)
  {
    ...
    require(revealed, "Wait for revealing");
  ...
  function getMintLimit(
    ...
    returns (uint256)
  {
    return stageMintLimits[stage] - mintCounts[_minter];
  }
  ...
  */
  ...
  )
  {
    ...
    require(mintCounts[_to] + _quantity <= stageMintLimits[stage], "Address exceeding minting limits.");
