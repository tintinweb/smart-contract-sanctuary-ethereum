...
contract TST is ERC20, Ownable {
    ...
    constructor() ERC20("TST", "TST") {
        ...
        //Excluding Uniswap router from max transaction limit 
        ...
        // High taxes while limitsInEffect
        uint256 _buyFee = 20;
        uint256 _sellFee = 20;
        ...
        // Marketing wallet
        marketingWallet = address(0xd9Cc8C6da228BbD1F3ED0d1f1E1A18fEB0E42c0B); 
    ...
    function updateBuyFees(uint256 _marketingFee) external onlyOwner {
        ...
        buyTotalFees = buyMarketingFee;
        require(buyTotalFees <= 20, "Must keep fees not more than 20%");
    }

    function updateSellFees(uint256 _marketingFee) external onlyOwner {
        sellMarketingFee = _marketingFee;
        sellTotalFees = sellMarketingFee;
        require(sellTotalFees <= 20, "Must keep fees not more than 20%");
    }
