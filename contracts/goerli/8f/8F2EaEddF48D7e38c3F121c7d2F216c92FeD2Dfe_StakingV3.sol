...
contract StakingV3 is IStakingV2, StakingV3Base, ReentrancyGuardUpgradeable {
  ...
  bool internal unlockStakes;

  /// @notice Allows governance to unlock all stakes to let
  /// usrs unstake early
  /// @param isUnlocked flag to lock or unlock all the stakes
  function setUnlockStakes(bool isUnlocked) external onlyGovernance {
    unlockStakes = isUnlocked;
  }
...
contract StakingV3Base is IStaking, ERC1155Upgradeable, BasePauseableUpgradeable {
  using SafeERC20Upgradeable for IERC20Upgradeable;
