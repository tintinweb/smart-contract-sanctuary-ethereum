...
contract TradeCoinMultiSigFactory is EIP712 {
    ...
    constructor(
        ...
        multiSigProxy = address(
            new TradeCoinMultiSig(
                address(this),
                _tradeCoinProductAddress,
                _tradeCoinCompositionAddress
            )
        );
    }
    ...
    function supplyCollateralInBulk(
        ...
        uint256[] memory _compositionTokens
    ) external {
        require(
            multiSigAgreements[multiSigId].financier != address(0),
            "Multi-Sig non-existent"
    ...
    function createMultiSig(uint256 multiSigId) external returns (address) {
        ...
        address multiSig = Clones.clone(multiSigProxy);
        TradeCoinMultiSig(multiSig).initialize(
    ...
    function createMultiSigWithSignatures(
        MultiSigAgreement memory multiSigAgreement,
        ...
        require(
            SignatureChecker.isValidSignatureNow(
                ...
                bytes.concat(
                    ...
                    bytes1(signatureFromFinancier.v)
                )
            ),
        ...
        require(
            SignatureChecker.isValidSignatureNow(
                ...
                bytes.concat(
                    ...
                    bytes1(signatureFromBorrower.v)
                )
            ),
    ...
    function getTypedDataHash(MultiSigAgreement memory multiSigAgreement)
        internal
