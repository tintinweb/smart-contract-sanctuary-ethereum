...
contract Service is IService, Ownable {
    ...
    address public whitelistedTokensContract;
    ...
    constructor(
        ...
        uint256 fee_,
        uint256[3] memory ballotParams, // ballotQuorumThreshold_, 
        ...
        whitelistedTokensContract = whitelistedTokensContract_;
    ...
    function createPool(
        ...
        // );
        require(
            IWhitelistedTokens(whitelistedTokensContract).isTokenWhitelisted(tgeInfo.unitOfAccount) || tgeInfo.unitOfAccount == address(0), 
            "Invalid UnitOfAccount"
        );
    ...
    function tokenWhitelist() external view returns (address[] memory) {
            return IWhitelistedTokens(whitelistedTokensContract).tokenWhitelist();
    }
