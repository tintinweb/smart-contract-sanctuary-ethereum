...
{    
    ...
    struct UserInformation
    {
        ...
        uint _MintPassAmountPurchased;     // [0] -> _MintPassAmountPurchased
        uint _MintPassAllocation;          // [1] -> _MintPassAllocation
        uint _MintPassRemainingToPurchase; // [2] -> _MintPassRemainingToPurchase
        ...
        uint _MintPackRemainingToPurchase; // [6] -> _MintPackRemainingToPurchase
        bool _MintPackEligible;            // [7] -> _MintPackEligible
    }
    struct SaleInformation
    {
        // Mint Pass Information
        uint _MintPassCurrentPrice;
        uint _MintPassRemaining;
        uint _MintPassSaleStartTime;
        uint _MintPassStartingPrice;
        uint _MintPassEndingPrice;

        // Mint Pack Information
        uint _MintPackCurrentPrice;
        uint _MintPackRemaining;
        uint _MintPackSaleStartTime;
        uint _MintPackStartingPrice;
        uint _MintPackEndingPrice;
    }
