...
contract Factory  is ERC1155, Initializable, Ownable {
...
contract Ko1155 is Factory, Pausable {
    ...
    function mint(uint256 amount) external payable whenNotPaused {
        ...
        //LibSalePhase.setMintAddress(msg.sender,amount);
    ...
    // Whitelist
    ///////////////
    function addWhitelist(address[] calldata users, string memory phaseName) public onlyOwner {
        LibSalePhase.addWhitelist(users, phaseName);
    }
  
    function unWhitelist(address[] calldata users, string memory phaseName) public onlyOwner {
        LibSalePhase.unWhitelist(users, phaseName);
    }
...
library LibSalePhase {
  ...
  // Whitelist
  ///////////////
  function addWhitelist(address[] calldata _users, string memory phaseName) public {

  }

  function unWhitelist(address[] calldata _users, string memory phaseName) public {

  }

  function isWhitelist(address addr, string memory phaseName) public returns(bool) {
    return true;
  }
