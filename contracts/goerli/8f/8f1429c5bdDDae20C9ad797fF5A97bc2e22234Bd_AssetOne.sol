...
/// @title Beehive NFT Contract
/// @author notmokk
/// @notice This is the primary beehive NFT contract.
/// @notice This contract implements marketplace operator filtering
/// @dev This contract is used to mint Assets for the Beehive project.
contract AssetOne is
    ERC721AQueryable,
    Ownable,
    OperatorFilterer,
    ERC2981,
    ReentrancyGuard
{
    ...
    uint256 public MINT_LIMIT_PER_ADDRESS = 2;

    bool public operatorFilteringEnabled;
    bool public publicSaleActive = false;
    bool public preSaleActive = false;
    int32 public allowListStartTime = 0;
    int32 public waitListStartTime = 0;
    string private _baseTokenURI;
    mapping(address => uint256) public userMinted;

    constructor(address _developerFund, address _ownerFund)
        ERC721A("AssetOne", "ASSET")
    {
        if (
     ...
     ** required for the transaction to eliminate the need for returning overages.
     ** @param _merkleProof The nerkle proof in byte32[] format
     ** @param _quantity The quantity to mint
     */
    ...
    function setAllowListStartTime(int32 _startTime) external onlyOwner {
        if (_startTime == 0) revert TimeCannotBeZero();
        allowListStartTime = _startTime;
    }

    function setWaitListStartTime(int32 _startTime) external onlyOwner {
        if (_startTime == 0) revert TimeCannotBeZero();
        waitListStartTime = _startTime;
    }
