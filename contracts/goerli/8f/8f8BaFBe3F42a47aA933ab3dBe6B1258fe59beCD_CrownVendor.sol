...
contract CrownVendor is Ownable, ReentrancyGuard { 
  ...
  */
  function crownToUSDC(uint256 crownTokens) public pure returns (uint256 usdc) {
  ...
  */
  function usdcToCrown(uint256 USDC) external pure returns (uint256 crownTokens) {
  ...
  */
  function buyCrown(uint256 crownTokens) external nonReentrant {
    ...
    require(contractAllowance >= usdcToSpend, "Must approve contract to spend more USDC.");
