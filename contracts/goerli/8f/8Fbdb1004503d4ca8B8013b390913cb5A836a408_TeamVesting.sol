...
contract TeamVesting is Ownable {
    ...
    function getTotalReleased() external returns (uint256) {
    ...
    function getAvailableAmount() external returns (uint256) {
    ...
    function getDuration(uint256 _duration) internal returns (uint256) {
