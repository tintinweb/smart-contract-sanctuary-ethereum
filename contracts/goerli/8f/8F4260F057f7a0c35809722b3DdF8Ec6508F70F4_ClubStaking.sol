...
contract ClubStaking is Initializable, OwnableUpgradeable {
    using SafeMath for uint256;
    ERC20PresetMinterPauser public clubToken;
     ...
     * @param _clubAddress contract addresss that is already deployed
     */
    function initialize(ERC20PresetMinterPauser _tokenAddress, ERC20PresetMinterPauser _clubAddress)
        public
        initializer
    {
        rewardToken = _tokenAddress;
        clubToken = _clubAddress;
    ...
    function deposit(uint256 _amount) public {
        require(
            clubToken.balanceOf(msg.sender) >= _amount,
        ...
        clubToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function withdraw(uint256 _amount) public {
        ...
        clubToken.transfer(msg.sender, _amount);
        _personStakeStatus.rewardsAmount = updateReward(msg.sender);
        totalDepositAmount -= _amount;
        _personStakeStatus.stakesAmount -= _amount;
        _personStakeStatus.lastUpdateTime = block.timestamp;
