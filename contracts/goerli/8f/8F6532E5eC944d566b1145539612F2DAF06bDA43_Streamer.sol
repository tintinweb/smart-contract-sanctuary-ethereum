...
contract Streamer is Ownable {
    ...
    function withdrawEarnings(Voucher calldata voucher) public onlyOwner {
        ...
        */
        ...
        require(balances[signer] > voucher.updatedBalance, "channel balance too low");
    ...
    */
    ...
    function challengeChannel() public {
        require(balances[msg.sender] != 0, "channel not open");
    ...
    */
    ...
    function defundChannel() public {
        require(canCloseAt[msg.sender] != 0, "channel not closing");
