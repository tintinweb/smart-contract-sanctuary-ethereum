...
contract CollectibleTokenUpgradeableV2 is OwnableUpgradeable, AccessControlEnumerableUpgradeable, ERC721Upgradeable, IMintableERC721 {
    ...
    function mint(address user, uint256 tokenId) external virtual override onlyRole(MINTER_ROLE) {      
        _safeMint(user, tokenId, "");
    }
    
    function mint(address user, uint256 tokenId, bytes calldata metaData) external virtual override onlyRole(MINTER_ROLE) {      
