...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    uint256 public NFT_PRICE = 110000000000000000; // 0.11 ETH
...
contract test is ERC721Enumerable, Ownable {
    ...
    uint256 private constant MAX_NFT_SUPPLY = 2;

    uint public constant MAX_PURCHASABLE = 1;
    uint256 public mintIndex = 0;
    string URI;
    string contracturi;
    address public pot = 0x62f3264e4F3a0F8CF7F7598D83FE679b516A56F7;
    uint256 public amountForPot = 100000000000000000;

  
    constructor() ERC721("ticket", "test") {
    }
   ...
   function mint() public payable {
       ...
       payable(pot).transfer(amountForPot);
       payable(pot).transfer(msg.value - amountForPot);
