...
// File: contracts/CryptoToucans.sol


// Developed by: www.fiverr.com/cesar4design
//  
//    /$$$$$$                                  /$$                  /$$$$$$$$                                                         
//   /$$__  $$                                | $$                 |__  $$__/                                                         
//  | $$  \__/  /$$$$$$  /$$   /$$  /$$$$$$  /$$$$$$    /$$$$$$       | $$  /$$$$$$  /$$   /$$  /$$$$$$$  /$$$$$$  /$$$$$$$   /$$$$$$$
//  | $$       /$$__  $$| $$  | $$ /$$__  $$|_  $$_/   /$$__  $$      | $$ /$$__  $$| $$  | $$ /$$_____/ |____  $$| $$__  $$ /$$_____/
//  | $$      | $$  \__/| $$  | $$| $$  \ $$  | $$    | $$  \ $$      | $$| $$  \ $$| $$  | $$| $$        /$$$$$$$| $$  \ $$|  $$$$$$ 
//  | $$    $$| $$      | $$  | $$| $$  | $$  | $$ /$$| $$  | $$      | $$| $$  | $$| $$  | $$| $$       /$$__  $$| $$  | $$ \____  $$
//  |  $$$$$$/| $$      |  $$$$$$$| $$$$$$$/  |  $$$$/|  $$$$$$/      | $$|  $$$$$$/|  $$$$$$/|  $$$$$$$|  $$$$$$$| $$  | $$ /$$$$$$$/
//   \______/ |__/       \____  $$| $$____/    \___/   \______/       |__/ \______/  \______/  \_______/ \_______/|__/  |__/|_______/ 
//                       /$$  | $$| $$                                                                                                   
//                      |  $$$$$$/| $$                                                                                                   
//                       \______/ |__/                                                                                                   
...
contract CryptoToucans is ERC721Enumerable, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    bool public isOGMode = false;
    bool public isWLMode = false;
    bool public isPSMode = false;
    uint256 public PriceOG = 0.0069 ether;
    uint256 public PriceWL = 0.0079 ether;
    uint256 public PricePS = 0.0090 ether;
    uint256 public MaxCollection = 1000;
    uint256 public MaxMint = 5;

    constructor(string memory _BaseURI, string memory _NotRevealedUri)
        ERC721("CryptoToucans", "CT")
    {
        setURIBase(_BaseURI);
    ...
    function OGmint(uint256 _Amount) public payable {
        require(isOGMode == true, "OG Sale not started");
        ...
        require(isOG(msg.sender), "Wallet not Whitelisted");
        require(msg.value >= PriceOG * _Amount, "PS: Balance Insufficient");
    ...
    function WLmint(uint256 _Amount) public payable {
        require(isWLMode == true, "WL Sale not started");
        uint256 supply = totalSupply();
        require(_Amount > 0, "");
        uint256 ownerMintedCount = Minted[msg.sender];
        require(ownerMintedCount + _Amount <= MaxMint, "Max NFT per Wallet Reached");
        require(supply + _Amount <= MaxCollection, "Sold Out");
        require(isWL(msg.sender), "Wallet not Whitelisted");
        require(msg.value >= PriceWL * _Amount, "PS: Balance Insufficient");
    ...
    function PSmint(uint256 _Amount) public payable {
        require(isPSMode == true, "WL Sale not started");
        uint256 supply = totalSupply();
        require(_Amount > 0, "");
        uint256 ownerMintedCount = Minted[msg.sender];
        require(ownerMintedCount + _Amount <= MaxMint, "Max NFT per Wallet Reached");
        require(supply + _Amount <= MaxCollection, "Sold Out");
        require(msg.value >= PricePS * _Amount, "Balance Insufficient");
    ...
    // Add OG Users, delete OG & Verify OG Users

    function addOGWallets(address[] calldata _users) public onlyOwner {
        OG = _users;
    }

    function delOGWallets() public onlyOwner {
        delete OG;
    }
    ...
    function addWLWallets(address[] calldata _users) public onlyOwner {
        WL = _users;
    }

    function delWLWallets() public onlyOwner {
        delete WL;
    }
    ...
    function TurnOGMode(bool _state) public onlyOwner {
        isOGMode = _state;
    }
    ...
    function setPriceOG(uint256 _newPriceOG) public onlyOwner {
        PriceOG = _newPriceOG;
    }
