...
abstract contract IHelixCreditLineV2 is IHelixCreditLine {
...
// SPDX-License-Identifier: MIT
pragma solidity 0.8.4;
import {IHelixCreditLineV2} from "./IHelixCreditLineV2.sol";
import {IHelixPoolShares} from "./IHelixPoolShares.sol";

abstract contract IHelixTranchedPool {
    IHelixCreditLineV2 public creditLine;
...
import {IHelixCreditLineV2} from "../interfaces/IHelixCreditLineV2.sol";
...
library HelixTranchingLogic {
    ...
    function applyToAllSeniorTranches(
        ...
        for (uint256 i = 0; i < numSlices; i++) {
            ...
            SliceInfo memory sliceInfo = getSliceInfo(
                slice,
                IHelixCreditLineV2(addresses[0]),
                totalDeployed,
                reserveFeePercent
            );
    ...
    function migrateAccountingVariables(
        IHelixCreditLineV2 originalCl,
        IHelixCreditLineV2 newCl
    ) external {
    ...
    function closeCreditLine(IHelixCreditLineV2 cl) external {
        // Close out old CL
        cl.setBalance(0);
        cl.setLimit(0);
        cl.setMaxLimit(0);
    ...
    function initializeNextSlice(
        ...
        poolSlices[sliceIndex] = IHelixTranchedPool.PoolSlice({
