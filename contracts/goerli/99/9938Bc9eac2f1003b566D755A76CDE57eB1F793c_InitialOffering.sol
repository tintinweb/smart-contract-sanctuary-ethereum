...
//    function updateToEarlyStartAt(uint256 __startAt) internal returns (uint256) {
//        if (__startAt > block.timestamp) {
//            return __startAt;
//        } else {
//            require(__startAt + 3000 > block.timestamp,
...
//        int256 startDeltaTime = block.timestamp - _startAt;
...
//        if (block.timestamp - _startAt < 3600 ) {
//        if (startDeltaTime < 3600 ) {
//            _startAt = startDeltaTime < 0 ? block.timestamp + 15 : _startAt;
//        }
//
//        if ( (block.timestamp > _startAt) && (block.timestamp - _startAt < (60 * 60))) {
//            _startAt = block.timestamp + 15;
//        }

//        uint256 ___startAt = updateToEarlyStartAt(_startAt)
...
//        initialOfferingData.beneficiary = _beneficiary;
//        initialOfferingData.admin = _admin;
//        initialOfferingData.feePerThousand = _feePerThousand;
//        initialOfferingData.minimalAmount = _minimalAmount;
//        initialOfferingData.pledgedTotalAmount = 0;
//        initialOfferingData.startAt = _startAt;
//        initialOfferingData.endAt = _endAt;
//        initialOfferingData.launched = true;
...
//            startAt: _startAt,
    ...
    function refundMe() external {
        ...
        uint256 bal = pledgedAmountsDict[msg.sender];
    ...
    BurnModule
{
    ...
    function initialize(BaseData memory __baseData)
        public
        initializer
    {
...
//            bondData_.currency,
    ...
    function __DataStorage_init_unchained(BaseData memory baseData__)
        internal
        onlyInitializing
    {
