...
contract SuperfineClaimV2 is Ownable, ReentrancyGuard {
    ...
    function setOperators(
        ...
        require(
            ...
            "SuperfineClaimV2: lengths mismatch"
        );
    ...
    function claimAssets(
        ...
        require(_operators[signer], "SuperfineClaimV2: invalid signer");
        ...
        for (uint256 i = 0; i < assets.length; i++) {
            ...
            if (asset.assetType == AssetType.ERC20) {
                require(
                    asset.assetId == 0,
                    "SuperfineClaimV2: invalid asset ID"
                );
                ...
                require(success, "SuperfineClaimV2: failed to claim");
            } else if (asset.assetType == AssetType.ERC721) {
                require(
                    asset.amount == 1,
                    "SuperfineClaimV2: invalid asset amount"
                );
