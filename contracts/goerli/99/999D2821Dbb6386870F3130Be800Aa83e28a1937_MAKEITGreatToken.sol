...
contract MAKEITGreatToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MAKEITGREAT";
    ...
    uint256 public  minimumTokensBeforeSwap = 1_000 * 10**18; /** Should be 0.1% of the total supply, This is the limit of,
    when tax is collected it's held in token's contract first and once it reaches 0.1% of the supply it will swap for BNB or ETH
    And trasfer to marketing wallet **/
