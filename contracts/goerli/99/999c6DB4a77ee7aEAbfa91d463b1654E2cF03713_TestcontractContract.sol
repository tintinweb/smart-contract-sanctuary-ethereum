...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xD5A83276bBC80c17Cb2cFA2Ed87063ed75C1A6B2];
  address public erc20Payable = 0xD5A83276bBC80c17Cb2cFA2Ed87063ed75C1A6B2;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 3333) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiacjdxxu7ilvdximvaqo3jm27qks5sbmv4t6lohmvyyq73xk64dwe/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 3333");
...
// File: contracts/TestcontractContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestcontractContract is RamppERC721A {
    constructor() RamppERC721A("TESTCONTRACT", "TESTTOKEN"){}
}
