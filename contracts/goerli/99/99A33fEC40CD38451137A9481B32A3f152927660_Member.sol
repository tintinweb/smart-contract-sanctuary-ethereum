    ...
    ReentrancyGuardUpgradeable
{
    ...
    function addBackupWallet(
        ...
        require(
            ...
            "User should have a primary wallet prior to adding a backup wallet"
        );
...
library Errors {
    ...
    // Membership Errors
    string public constant MS_NEED_MORE_DOUGH = "32"; // "User needs to send sufficient amount to topUp"
    string public constant MS_INACTIVE = "33"; // "Membership inactive"

    // RelayerContract Errors
    string public constant RC_UNAUTHORIZED = "34"; // "Only relayer can invoke this function"
}
...
interface IMembershipFactory {
     ...
     * @param _whitelisted bool representing if the user was on the whitelist contract storage
     *
     */
