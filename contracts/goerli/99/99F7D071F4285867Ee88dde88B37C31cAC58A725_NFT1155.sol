...
contract NFT1155 is Ownable, AccessControl, ERC1155Base {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControl, ERC1155Base) returns (bool) {
        return
...
contract ERC1155Base is HasSecondarySaleFees, Ownable, HasTokenURI, HasContractURI, ERC1155 {
    ...
    function _mint(address to, uint256 _id, Fee[] memory _fees, uint256 _supply, string memory _uri) internal {
        ...
        // Remove as its duplicated (already emitted in the its base ERC1155 contract from openzeppelin)
        emit URI(_uri, _id);
    }
