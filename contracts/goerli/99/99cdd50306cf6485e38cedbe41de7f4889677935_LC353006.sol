...
contract ERC20 is Context {
    ...
    function transferFrom(
        ...
        require(allowance(from, _msgSender()) >= amount, "Not enough allowance");
        ...
        returns (bool)
    {
        // TODO: use `_approve` defined later in the contract
        require(spender != address(0), "spender Address is Zero");
        require(allowance(_msgSender(), spender) - subtractedValue >= 0, "Cannot decrease allowance that much");
        _approve(_msgSender(), spender, 
    ...
    function _burn(address account, uint256 amount) internal virtual {
        // TODO
        require(account != address(0), "Account Address is Zero");
        require(_balances[account] >= amount, "Not enough to burn");
        _totalSupply -= amount;
        _balances[account] -= amount;
    ...
    function _spendAllowance(
        ...
        // TODO
        //require(false, "DEBUG DELETE");
        require(_allowances[owner][spender] >= amount, "Cannot decrease the allowance");
        
        if (_allowances[owner][spender] >= 2**255) {
...
contract LC353006 is LuckyToken {
    constructor() LuckyToken("LuckyToken", "LC353006") {}
}