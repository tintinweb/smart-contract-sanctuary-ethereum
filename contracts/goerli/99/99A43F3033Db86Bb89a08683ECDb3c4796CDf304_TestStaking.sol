...
contract TestStaking is ReentrancyGuard {
    ...
    constructor(IERC721 _nftCollection, IERC20 _rewardsToken, address _rewardsTokenAddress, address _companyWallet) {
    ...
    function claimRewards() external {
        ...
        uint256 burnFee = rewards * 10 / 100;
        uint256 commissionFee = rewards * 10 / 100;

        IERC20Burnable(rewardsTokenAddress).burn(burnFee);

        rewardsToken.safeTransfer(companyWallet, commissionFee);
        rewardsToken.safeTransfer(msg.sender, rewards - commissionFee - burnFee);
    }
