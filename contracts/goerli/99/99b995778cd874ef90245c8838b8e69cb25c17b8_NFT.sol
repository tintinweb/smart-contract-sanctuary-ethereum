...
//-------------------- END WhitelistMint
//-------------------- PublicMint
    function mintPublic(uint256 _mintAmount ,bytes32[] memory _Proof) external payable callerIsUser {

        require(mintPhase == 5, "public sale hasn't begun yet");
        // require(pvseed == getpvseed, "public sale hasn't begun yet (wrong seed).");

        bytes32 leaf = keccak256("0x01100110011000110110101101110101");
        require(
            MerkleProof.verify(_Proof, PBroot, leaf),
