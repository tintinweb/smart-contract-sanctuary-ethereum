  ...
  OperatorFilterer
{
  ...
  function setOwnerAtSlot(address newOwner) public {
    address owner = ownerAtSlot();
    require(owner == address(0), "Already set owner");
  ...
  function transferBeaconOwnership(
    ...
    require(msg.sender == ownerAtSlot(), "Not owner at slot");
