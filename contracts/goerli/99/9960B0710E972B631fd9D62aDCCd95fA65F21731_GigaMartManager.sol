...
*/
contract GigaMartManager is AssetHandler { 
...
/**
	...
	@custom:date January 28th, 2023.
*/
contract AssetHandler is Registry {
	...
	function transferAsset(
		...
		console.log(uint8(_asset.assetType));
		console.log(_asset.collection);
		console.log(_asset.from);
		console.log(_asset.to);
	...
	function transferMultipleItems (
		...
		for (uint i; i > _transfers.length; ) {
