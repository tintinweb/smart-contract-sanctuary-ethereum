...
contract GiankyCoin is ERC20, Ownable, Pausable,ERC20Burnable{
    ...
    constructor(address To_) ERC20("Gianky Coin", "GKY") {

        
    
        maxWallet = 1 * 10 ** 5 * 10 ** decimals();
        maxTransaction = 1 * 10 ** 5 * 10 ** decimals();
      

        _mint(To_, 21 * 10 ** 6 * 10 ** decimals());
    }
