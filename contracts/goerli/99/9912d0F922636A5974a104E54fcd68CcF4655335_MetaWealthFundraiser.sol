...
interface IAssetVault {
    ...
    function burn() external returns(address shareholder);
...
interface IVaultBuilder {
    ...
    /// @notice Takes a an NFT and destroys its vault, returning the NFT to user
    /// @param collection is the address of NFT collection being brought in
    /// @param tokenId is the specific token ID within NFT collection
    ...
    IMetaWealthFundraiser
{
    ...
    function completeRaise(
        ...
        require(
            ...
            "AccessControl: restricted to asset manager"
        );
        CampaignInstance memory campaign = activeCampaigns[collection][tokenId];
        require(
