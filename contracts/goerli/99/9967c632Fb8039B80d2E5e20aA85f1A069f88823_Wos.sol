...
contract Wos is ERC20, OnlyAuthorized, IOperable {
    ...
    function mint(uint256 amount) external {
        require(
            ...
            "only the bars or marketplace can create wos"
        );
    ...
    function setBarsAddress(IOperable _bars) external onlyOwner {
    ...
    function setWosPackagesAddress(address addr) external onlyOwner {
        require(addr != address(0), "Address cannot be zero");
        require(
            wosPackagesAddress == address(0) || development,
            "You can't change the address again"
        );
