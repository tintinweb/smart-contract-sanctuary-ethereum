...
contract keypass is ERC1155, Ownable, ReentrancyGuard, Pausable, ERC1155Burnable, ERC1155Supply  {
    uint256 public constant KeyPass = 1;
  ...
  mapping(address => uint256) purchasesPerWallet;
        ...
        payable
    {
        ...
        require(purchasesPerWallet[msg.sender] + amount <= maxPerWallet, "Max amount per wallet reached.");
  ...
  {
    require(totalSupply(id) + amount < maxSupply + 1,"too many!");
