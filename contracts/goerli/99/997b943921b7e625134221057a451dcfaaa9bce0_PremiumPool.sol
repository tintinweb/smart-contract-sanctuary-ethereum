    ...
    Ownable
{
    ...
    PoolDeposit immutable poolDeposit;
    ...
    function deposit(uint256 _usdcAmount) public {
        ...
        poolDeposit.deposit(_usdcAmount, address(usdc), address(ticket), address(aPool));
    }
    ...
    function pickWinner() public {
        ...
        require(usdcDeposit != 0, "There has been no participation during this draw");
    ...
    Ownable
{
     ...
     * @notice allows users to deposit usdc. Users must manually approve transfer by contract beforehand
     */
    function deposit(uint256 _usdcAmount, address _usdc, address _ticket, address _aPool) public {
        IERC20 usdc = IERC20(_usdc);
        PremiumPoolTicket ticket = PremiumPoolTicket(_ticket);
        ILendingPool aPool = ILendingPool(_aPool);
        ...
        //require(success);
        aPool.deposit(address(usdc), _usdcAmount, address(msg.sender), 0);
