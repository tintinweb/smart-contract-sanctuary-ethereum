...
library SmartPriceEngine {
    ...
    function computeAuthroizedPriceByCount(
        ...
        uint256 authorizedPrice = currentStartPrice * uint256(discountFactor(int256(maxDiscount), int256(count), int256(alpha))) / WAD;
    ...
    function computeAuthroizedPriceByDuration(
        ...
        uint256 authorizedPrice = currentStartPrice * uint256(discountFactor(int256(maxDiscount), int256(duration / TIME_INTERVAL), int256(alpha))) / WAD;
