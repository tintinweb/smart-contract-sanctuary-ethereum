  ...
  DefaultOperatorFilterer
{
  ...
  bytes32 private constant _TYPEHASH =
    keccak256(
      "Attribute(uint256 tokenId,string name,uint256 gender,uint256 height,uint256 weight,string bloodType,string hometown,uint256 character)"
    );
    ...
    returns (string memory)
  {
    ...
    string memory attributeObj1 = string.concat(
      string.concat(
        BEGIN_ATTRIBUTE_DATA("tokenId", true),
        Strings.toString(tokenId),
        END_ATTRIBUTE_DATA(true)
      ),
      string.concat(
        BEGIN_ATTRIBUTE_DATA("name", false),
        attribute.name,
        END_ATTRIBUTE_DATA(false)
      ),
      string.concat(
        BEGIN_ATTRIBUTE_DATA("gender", true),
        Strings.toString(attribute.gender),
        END_ATTRIBUTE_DATA(true)
      ),
      string.concat(
        BEGIN_ATTRIBUTE_DATA("height", true),
    ...
    string memory attributeObj2 = string.concat(
      string.concat(
        BEGIN_ATTRIBUTE_DATA("weight", true),
        Strings.toString(attribute.weight),
        END_ATTRIBUTE_DATA(true)
      ),
      string.concat(
        BEGIN_ATTRIBUTE_DATA("bloodType", false),
        attribute.bloodType,
        END_ATTRIBUTE_DATA(false)
      ),
      string.concat(
        BEGIN_ATTRIBUTE_DATA("hometown", false),
        attribute.hometown,
        END_ATTRIBUTE_DATA(false)
      ),
      string.concat(
        BEGIN_ATTRIBUTE_DATA("character", true),
  ...
  function BEGIN_ATTRIBUTE_DATA(string memory name, bool omitQuotes)
    internal
    pure
    returns (string memory)
  {
  ...
  function END_ATTRIBUTE_DATA(bool omitQuotes)
    internal
    pure
    returns (string memory)
  {
