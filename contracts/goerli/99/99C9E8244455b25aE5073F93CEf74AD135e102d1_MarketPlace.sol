    ...
    ERC2771Recipient
{
    ...
    modifier OnlySeller(address seller) {
        require(seller == _msgSender(), "Only Seller can call this function");
        _;
    }
    ...
    event LogFeePercentUpdated(uint256 newPercent, address senderAddress);
    ...
    function updateFeePercent(uint256 _newFeePercent) public OnlyAdmin {
        feePercent = _newFeePercent;
        emit LogFeePercentUpdated(feePercent, _msgSender());
    }
