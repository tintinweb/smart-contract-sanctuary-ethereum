...
contract SAC is ERC721Enumerable, Ownable {
	...
	address private wallet1 = 0xEf3913b8A1F93F15c2F332ae2F5dfe46C4cf3154;
    ...
    address private Authorized = 0xEf3913b8A1F93F15c2F332ae2F5dfe46C4cf3154;


    uint256 public SACPrice_whitelist = 800000000000000;
	uint256 public SACPrice_public = 800000000000000;
    uint public maxSACTx = 5;
    ...
    function freeMint(uint numberOfTokens) public {
        require(numberOfTokens > 0 && numberOfTokens <= maxSACTx, "5 pTX allowed");
