...
contract voting {
    ...
    function create_vote(string calldata _title, string[] calldata _elements)
        public
    {
        bool isCreator = true;
        ...
        require(isCreator, "You don't have the permission to vote!");
    ...
    function close_vote(uint _key) public {
        Vote storage v = all_votes[_key];
        ...
        require(isCreator, "You don't have the permission to close this vote!");
