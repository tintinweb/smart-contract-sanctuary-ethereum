...
contract WAGDIE is ERC20, Ownable {
    ...
    constructor() ERC20("We Are All Going To Die", "WAGDIE") {
        ...
        uint256 totalSupply = 66_666_666_666 * 1e18; 
        maxTransactionAmount = 666_666_666 * 1e18; 
        maxWallet = 999_999_999 * 1e18; 
        swapTokensAtAmount = (totalSupply * 3) / 10000; 
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        marketingWallet = address(0x2CD4dD6cd149DA75F687f0190b53e5f53315b693); 
        devWallet = address(0x2CD4dD6cd149DA75F687f0190b53e5f53315b693); 
