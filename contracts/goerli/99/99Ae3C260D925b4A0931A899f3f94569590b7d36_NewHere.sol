    ...
    Ownable
{
    ...
    // Public sale free reserved supply (tier 3) //600
        ...
        external
    {
        ...
        //todo: change this to a require to be less than or equal to oneToOneAddressReserve
        require(
            tokenCounter < (MAX_SUPPLY - dPopReserve - publicSaleFreeAllowlistReserve),
        ...
        payable
    {
        ...
        require(
            tokenCounter < (MAX_SUPPLY - dPopReserve - publicSaleFreeAllowlistReserve - oneToOneAddressReserve),
            "Token count exceeds limit"
        );
        require(
        ...
        external
    {
        ...
        //todo: change this to a require to be less than or equal to publicSaleFreeAloowListReserve
        require(
            tokenCounter < (MAX_SUPPLY - dPopReserve - oneToOneAddressReserve),
            "Token count exceeds limit"
        );
        _safeMint(msg.sender, uint256(quantity));
    ...
    function dpopMint(address _address, uint256 quantity)
        external
        onlyAdmin
    {
        require(
    ...
    function adminMint(address _address, uint256 quantity)
        external
        onlyAdmin
    {
        require(
