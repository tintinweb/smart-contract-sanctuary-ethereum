...
contract ParticleToken is ERC1155, Ownable {
  ...
  uint256 public constant RESERVE_MINT_PARTICLES = 200;

  bool private reserveMinted;
  ...
  function reserveMint() external onlyOwner {
    require(!reserveMinted, 'PARTICLE: Mint already performed');
    reserveMinted = true;
    _totalSupply = _totalSupply.add(RESERVE_MINT_PARTICLES);
    _mint(msg.sender, tokenId, RESERVE_MINT_PARTICLES, '');
  }
