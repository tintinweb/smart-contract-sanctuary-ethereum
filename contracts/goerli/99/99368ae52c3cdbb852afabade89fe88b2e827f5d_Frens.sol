...
contract Frens is ERC721, Ownable {
    ...
    constructor(address _tableland) ERC721("FrensFactory", "FRENS") {
        ...
        tableIDs["frens"] = tableland.createTable(
            address(this),
            "CREATE TABLE frens (id INT, name TEXT NOT NULL, skin TEXT NOT NULL, ears TEXT NOT NULL, head TEXT NOT NULL, hair TEXT NOT NULL DEFAULT '', eyes TEXT NOT NULL, clothes TEXT NOT NULL DEFAULT '', mouth TEXT NOT NULL DEFAULT '', accessory TEXT NOT NULL DEFAULT '', background TEXT NOT NULL DEFAULT '');"
        );
