...
contract Test3test is ERC721AQueryable, Ownable, ERC2981, ReentrancyGuard, DefaultOperatorFilterer {
    
    using Strings for uint256;

    /// Funds withdrawal address.
    address payable public withdrawalAddress = payable(0x56Ff1C847AA3272472A0CE2CAE48adDCa6cE896A);

    /// Boolean which displays the public minting status.
    bool public publicMintingStatus = false;

        /// Revealed metadata url prefix.
    string public metadataURLPrefix = "ipfs://QmeMNiZWWV8iAKF3hQbqzW6US9S2w4D3WmKbmQ3J5kkshH/";
    ...
    uint256 public nftPrice;
        ...
        constructor() ERC721A("Test3test","TST") {}
    ...
    function _beforeTokenTransfers(
        ...
        uint256 startTokenId,
        uint256 quantity
    ) internal override(ERC721A) onlyAllowedOperator(from) {
