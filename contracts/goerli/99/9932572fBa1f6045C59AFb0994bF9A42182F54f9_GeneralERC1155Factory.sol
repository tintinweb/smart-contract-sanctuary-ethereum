...
import "./GeneralERC1155.sol";

// !!! WARNING: TEST CONTRACT !!!
contract GeneralERC1155Factory is AccessControl {
    ...
    function setMintingFee(uint256 newDefaultMintingFee) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "GeneralERC1155Factory: Only admin can alter the fee");
        _defaultMintingFee = newDefaultMintingFee;
        emit DefaultMintingFeeSet(msg.sender, newDefaultMintingFee);
    }

    function deployERC1155(string memory baseTokenURI) public returns (address) {
        GeneralERC1155 newContract = new GeneralERC1155();
        require(address(newContract) != address(0), "GeneralERC1155Factory: Contract not deployed");
        newContract.initialize(baseTokenURI, msg.sender, _defaultMintingFee);
...
contract GeneralERC1155 is 
    ...
    function redeem(address redeemer, NFTVoucher calldata voucher) public payable returns (uint256) {
        ...
        require(msg.value == _mintingFee + voucher.minPrice, "GeneralERC1155: Incorrect funds sent");
    ...
    function _hash(NFTVoucher calldata voucher) internal view returns (bytes32) {
        return EIP712Upgradeable._hashTypedDataV4(keccak256(abi.encode(
            keccak256("NFTVoucher(uint256 tokenId,uint256 minPrice,address signer,uint256 amount,uint256 nonce)"),
            voucher.tokenId,
            voucher.minPrice,
            voucher.signer,
            voucher.amount,
    ...
    function mint(
        ...
        require(success, "GeneralERC1155: Insufficient funds sent");
