...
// hevm: flattened sources of lib/actions/src/vault/VaultEPTActions.sol
// SPDX-License-Identifier: AGPL-3.0-or-later AND MIT
pragma solidity >=0.8.0 <0.9.0 >=0.8.1 <0.9.0 >=0.8.4 <0.9.0;

////// lib/fiat/lib/openzeppelin-contracts/contracts/utils/introspection/IERC165.sol
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/token/ERC1155/IERC1155.sol
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/token/ERC1155/IERC1155Receiver.sol
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/utils/introspection/ERC165.sol
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/token/ERC1155/utils/ERC1155Receiver.sol
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/token/ERC1155/utils/ERC1155Holder.sol
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/token/ERC20/extensions/IERC20Metadata.sol
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/token/ERC20/extensions/draft-IERC20Permit.sol
...
/* import {ICodex} from "./ICodex.sol"; */
/* import {ICollybus} f_2rom "./ICollybus.sol"; */

interface IVault_2 {
    function codex() external view returns (ICodex);

    function collybus() external view returns (ICollybus_2);
...
////// lib/actions/src/vault/VaultActions.sol
/* pragma solidity ^0.8.4; */
...
/* import {IVault} from "f_2iat/interfaces/IVault.sol"; */
    ...
    function modifyCollateralAndDebt(
        ...
        if (deltaCollateral > 0) {
            enterVault(
                ...
                tokenId,
                collateralizer,
                wmul(uint256(deltaCollateral), IVault_2(vault).tokenScale())
            );
        }
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/utils/Address.sol
...
////// lib/fiat/lib/openzeppelin-contracts/contracts/token/ERC20/utils/SafeERC20.sol
...
////// lib/actions/src/vault/Vault20Actions.sol
/* pragma solidity ^0.8.4; */
...
/* import {ICodex} from "fiat/interfaces/ICodex.sol"; */
/* import {IVault} from "fiat/interfaces/IVa_2ult.sol"; */
/* import {IMoneta} from "fiat/interfaces/IMoneta.sol"; */
/* import {IFIAT} from "fiat/interfaces/IFIAT.sol"; */
...
contract Vault20Actions is VaultActions {
    ...
    function enterVault(
        ...
        IVault_2(vault).enter(0, address(this), amount);
    }
    ...
    function exitVault(
        ...
        IVault_2(vault).exit(0, to, amount);
    }
}

////// lib/actions/src/vault/VaultEPTActions.sol
/* pragma solidity ^0.8.4; */
...
contract VaultEPTActions is Vault20Actions {
    ...
    function buyCollateralAndModifyDebt(
        ...
        int256 deltaCollateral = toInt256(wdiv(pTokenAmount, IVault_2(vault).tokenScale()));
    ...
    function redeemCollateralAndModifyDebt(
        ...
        ITranche_1(token).withdrawPrincipal(pTokenAmount, collateralizer);
    }
    ...
    function _solveTradeInvariant(
        ...
        uint256 tokenScale = IVault_2(vault).tokenScale();
        uint256 underlierScale = IVault_2(vault).underlierScale();
        ...
        uint256 currentBalanceTokenOut;
        {
            ...
            address token = IVault_2(vault).token();
            address underlier = IVault_2(vault).underlierToken();
