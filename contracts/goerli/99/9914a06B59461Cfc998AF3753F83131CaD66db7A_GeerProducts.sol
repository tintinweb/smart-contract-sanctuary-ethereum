  ...
  ERC2981ContractWideRoyalties
{
  ...
  constructor() ERC721("Lamborghini", "LAMBO") {}
  ...
  function setRoyalties(address recipient, uint256 _royaltyFee)
    public
    onlyOwner
  {
    require(recipient != address(0), "INVALID_WALLET");
    require(_royaltyFee <= ROYALTY_FEE_DENOMINATOR, "INVALID_FEE");
    emit RoyaltyWalletChanged(royaltyWallet, recipient);
    emit RoyaltyFeeChanged(royaltyFee, _royaltyFee);
    _setRoyalties(recipient, _royaltyFee);
