...
contract SpectrumMarketPlace is ERC721URIStorage, ReentrancyGuard, Ownable {
    ...
    constructor() ERC721("Token Creator", "STC") {}
    ...
    mapping(address => mapping(uint256 => CreateToken)) private s_listings;
    /**  MAPPING END */
    ...
    /**  MODIFIERS END */
    function updateServiceFee(uint256 _listPrice) public payable onlyOwner {
    ...
    function createToken(string memory tokenURI) public returns (uint) {
        ...
        createListedToken(currentTokenId, address(this));

        return currentTokenId;
    }

    function createListedToken(uint256 tokenId, address nftAddress) private {
    ...
    function executeSale(address nftAddress, uint256 tokenId)
        ...
        nonReentrant
    {
        CreateToken memory listedItem = s_listings[nftAddress][tokenId];
        ...
        // TO DO: Add Listing Fee on buyin time via
