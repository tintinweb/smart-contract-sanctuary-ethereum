...
// File contracts/interfaces/IEthereumLightClient.sol
...
// File contracts/message-bridge/interfaces/IMessageBridge.sol
...
// File contracts/token-bridge/TokenVault.sol
...
contract TokenVault is Ownable {
    ...
    function setRemotePegBridge(address _remotePegBridge) external onlyOwner {
        require(remotePegBridge == address(0), "already set");
        remotePegBridge = _remotePegBridge;
    }
}