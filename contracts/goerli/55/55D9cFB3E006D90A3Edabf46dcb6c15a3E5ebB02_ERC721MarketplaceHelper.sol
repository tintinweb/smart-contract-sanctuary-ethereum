...
library ERC721MarketplaceHelper {
    ...
    function validateBidSignBatch(
        ...
        // uint256 _tokenId,
        // uint256 _nonce,
        address seller // bytes calldata sign,
    ) external view // bytes32 root,
    // bytes32[] calldata proof
    {
        ...
        require(
            ...
            "ERC1155Marketplace: Invalid Root"
        );
    ...
    ReentrancyGuardUpgradeable
{
    ...
    modifier rootActive(bytes32 root) {
        require(!isRootDiscarded[root], "ERC1155Marketplace: Root Discarded.");
        _;
    }
