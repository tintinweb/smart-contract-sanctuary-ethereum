...
contract RSaleContract is Ownable, ReentrancyGuard {
    ...
    // set time
    uint64 public immutable whitelistStartTime = 1447950400;
    uint64 public immutable whitelistEndTime = 1748036800;
    uint64 public immutable publicStartTime = 1447950400;
    uint64 public immutable publicEndTime = 1748036800;

    mapping(address => bool) public whitelistMinted;
    mapping(address => bool) public publicYinMinted;
    mapping(address => bool) public publicYangMinted;

    address RTokenAddress = address(0xbD7f3958edcDb2925364301f886BD0763Ee56fdE);
