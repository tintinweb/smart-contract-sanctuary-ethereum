...
contract StakeWAYF is Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 public interestRate = 25;
    ...
    function claimReward() external returns (bool){
        ...
        wayfToken.transfer(_msgSender(), totalTokens);
    ...
    function stakeToken(uint256 stakeAmount) external payable whenNotPaused {
        ...
        require(wayfToken.balanceOf(_msgSender()) >= stakeAmount, "Insufficient Balance");
        
           wayfToken.transferFrom(_msgSender(), address(this), stakeAmount);
            totalStakers++;
