...
contract Niftyco721 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable, ERC2981 {
    ...
    /// @param _royalty The fee for collection
    function setDefaultRoyalty(address _creator, uint96 _royalty) public onlyOwner {
        _setDefaultRoyalty(_creator, _royalty);
    }

    /// @dev Set royalty fee for specific token
    /// @param _tokenId The tokenId where to add the royalty
    /// @param _creator The royalty receiver
    /// @param _royalty the fee for specific tokenId
    function setTokenRoyalty(
        uint256 _tokenId,
        address _creator,
        uint96 _royalty
    ) public onlyOwner {
        _setTokenRoyalty(_tokenId, _creator, _royalty);
    }
