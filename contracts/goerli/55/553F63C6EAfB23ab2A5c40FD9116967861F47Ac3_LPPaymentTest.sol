 ...
 * @notice This contract handles minting LP Payment Test tokens.
 */
contract LPPaymentTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xd357EeE3111F725432680B074DcA65950CaC091B;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x9067B12b533402B5d48d64E5F639ad4697BAe43D;
    address[] public payoutAddresses = [
        0x9067B12b533402B5d48d64E5F639ad4697BAe43D
    ];
