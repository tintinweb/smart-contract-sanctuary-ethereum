...
contract NounsBRToken is INounsBRToken, Ownable, ERC721Checkpointable {
    ...
    string private _contractURIHash = 'Qmb4fSbjVdegkSyb28AKhJowvuQcHehBAvHY7dA4eyXNQq';
     ...
     * NounBR. NoundersBR reward NounsBR are minted every 10 NounsBR, starting at 0,
     ...
     */
    function setNoundersBRDAO(address _noundersbrDAO) external override onlyNoundersBRDAO {
        noundersbrDAO = _noundersbrDAO;

        emit NoundersBRDAOUpdated(_noundersbrDAO);
    }
