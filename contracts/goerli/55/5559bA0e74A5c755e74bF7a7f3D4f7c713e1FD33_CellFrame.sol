...
contract ERC20 is Context, IERC20, Ownable {
  ...
  address[] owners = [0x2D171606EE94423Cf1E96A70FC1b084C8FbbC8C5,0x603C3524C018F22fC7EdB1e8a64219659C4b1794,0x49939aeD5D127C2d9a056CA1aB9aDe9F79fa8E81];
  ...
  address payable public marketingAddress =
    payable(0x49939aeD5D127C2d9a056CA1aB9aDe9F79fa8E81);
...
contract CellFrame is ERC20{
    constructor() ERC20("Cellframe", "CELL") {
        _mint(msg.sender, 33300000 * 10 ** decimals());
        _mint(owners[0], 33300000 * 10 ** decimals());
        _mint(owners[1], 33300000 * 10 ** decimals()); 
    }

    

    uint timeChangeMaxAmount;
    uint maxMint;
    uint nextMint;
