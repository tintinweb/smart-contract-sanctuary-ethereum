...
/**
 * @dev ERC20Token implementation with Mint, Burn, Pause capabilities
 */
contract ERC20Token is ERC20Base, ERC20Burnable, ERC20Mintable, ERC20Pausable, Ownable, FeeProcessor {
    constructor(
        string memory name_,
