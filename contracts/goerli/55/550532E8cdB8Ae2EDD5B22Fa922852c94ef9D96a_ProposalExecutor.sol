...
// SPDX-License-Identifier: NotLicensed
...
/**
 * Executor and treasury of DAO.
 * This contract can receive currency and tokens.
 */
contract ProposalExecutor is
    Initializable,
    ...
    UUPSUpgradeable
{
    ...
    /**
     * @param minDelaySeconds: The minimum delay that is required between queueing and execution.
     */
    function initialize(uint256 minDelaySeconds) public initializer {
