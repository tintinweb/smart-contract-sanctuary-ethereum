...
contract MPBRT is ERC721MP, Ownable, ReentrancyGuard
{
    ...
    uint public _UnixUserRedeemTimestamp = 1662416400;
    ...
    event DelegateStatusChanged(uint[] TokenIDs, bool Status);
    ...
    { 
        _mint(msg.sender, 10);
        _mint(0x1117Ee5AF5E5eB341D1a167c82f3cdaB398Bd9da, 10);
    ...
    ************/
    ...
    function RegisterDelegateStatus(uint[] calldata TokenIDs, bool State) external nonReentrant
    {
        ...
        emit DelegateStatusChanged(TokenIDs, State);
    }
    ...
    *****************/
     ...
     */
    function viewSaleInfo(address Wallet, bytes32[] calldata Proof) public view returns (
        uint StartTimePublic,
        uint StartTimeBrightlist,
        uint Price,
        uint TotalMinted,
