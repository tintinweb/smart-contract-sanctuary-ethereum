...
contract NFT is ERC721Tradable{
    ...
    constructor() ERC721Tradable("DummyNFT", "DFT",0x1E0049783F008A0085193E00003D00cd54003c71,"https://creatures-api.opensea.io/api/creature/") {
        // sigVerify = SignatureVerification(0x50e0C6CBA35b1fa1dD3e9d05B3eaFB1b01318717);
        sigVerify = SignatureVerification(0xe1949ac4C67eA48f7c2b8852a6C1988FA568459c);
    }
    ...
    function transferApprovalBatch(address[] memory from, address[] memory to, uint256[] memory tokenIds, bytes32[] memory msgHash, bytes[] memory hashSig) public {
        ...
        for (uint256 index = 0; index < tokenIds.length; index++) {
            ...
            require(sigVerify.recover(msgHash[index], hashSig[index]) == ownerOf(tokenIds[index]),"Approval denied");
            _safeTransfer(from[index], to[index], tokenIds[index], "");
