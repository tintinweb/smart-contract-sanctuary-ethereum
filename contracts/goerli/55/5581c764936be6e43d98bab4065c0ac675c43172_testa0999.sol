...
contract testa0999 is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{

    string public CONTRACT_URI = "https://api.nilbogtown.wtf/";

    mapping(address => uint) public userHasMinted;
    bool public REVEALED;
    string public UNREVEALED_URI = "https://api.nilbogtown.wtf/";
    string public BASE_URI = "https://api.nilbogtown.wtf/";
    ...
    constructor() ERC721A("Testa9999", "Test999") {}
