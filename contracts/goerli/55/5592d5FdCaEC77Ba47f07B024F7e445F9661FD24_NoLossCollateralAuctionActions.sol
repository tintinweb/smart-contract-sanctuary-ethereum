...
/* import {ICodex} from "./ICodex.sol"; */
/* import {ICollybus} from "./IColl_2ybus.sol"; */
/* import {IAer} from "./IAer.sol"; */
...
contract NoLossCollateralAuctionActions {
    ...
    function takeCollateral(
        ...
        uint256 bought = wmul(sub(codex.balances(vault, tokenId, address(this)), balance), IVault_2(vault).tokenScale());
        IVault_2(vault).exit(tokenId, recipient, bought);
    }
}