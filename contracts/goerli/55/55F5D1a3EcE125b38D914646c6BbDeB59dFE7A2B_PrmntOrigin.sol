...
// - handle requrie existing map to update
...
contract PrmntOrigin is ERC721Base, CollectionDescriptor{ // , Ownable 
    ...
    // string public galleryBase = "https://arweave.net/";
    ...
    function getGalleryData(uint256 tokenId) public view returns (string memory ){
        // return string.concat(galleryBase, tokenIdToGallery[tokenId]);
        return tokenIdToGallery[tokenId];
    }
    /**
     * @notice Public facing function to update gallery data
    ...
    function getURI(uint256 tokenId) internal view returns (string memory){
        return string.concat('data:application/json;base64,', 
            Base64.encode(
                abi.encodePacked(
                    '{"description": "Dynamic on-chain art by PRMNT", "name": "Origin Hue ', 
