...
contract SYLBankV2 is Initializable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    uint256 public burnAmountPerClaim;
    ...
    function initializeV2(uint256 amount) public reinitializer(2) {
        burnAmountPerClaim = amount;
    }
    ...
    function claim() external whenNotPaused {
        ...
        if (burnAmountPerClaim > 0) {
            erc20.burnFrom(msg.sender, burnAmountPerClaim);
        }
