 ...
 * @notice This contract handles minting First ERC1155 tokens.
 */
contract FirstERC1155 is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x35Df8cF46C917449A19c46f8E306c812E5E7B221;
    address public royaltyAddress = 0x8AD5Ee55A8425a8a4938106050636E0901Df4321;
    address[] public payoutAddresses = [
        0x8AD5Ee55A8425a8a4938106050636E0901Df4321
    ];
    ...
    string public name = "First ERC1155";
    string public symbol = "FERC1155";
    ...
    uint96 public royaltyFee = 300;

    constructor()
        ERC1155(
            "ipfs://bafybeigjjkmbrgy66jk4e4io7xy5tk6bhmiojy3izvx3tcxtfzs444sz64/{id}"
        )
    {
        ...
        tokenPresalePrice[1] = 0.05 ether;
        tokenPresaleMintsPerAddress[1] = 2;
        tokenPublicPrice[100] = 0.2 ether;
        tokenPublicMintsPerAddress[100] = 3;
        require(
    ...
    function giftTokens(
        ...
        require(
            ...
            "TOKEN_MINTING_PERMANENTLY_DISABLED"
        );
        uint256 totalMint = 0;
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        for (uint256 i = 0; i < payoutAddresses.length; i++) {
            payable(payoutAddresses[i]).transfer(
