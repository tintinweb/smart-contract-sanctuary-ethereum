    ...
    VerifySignature
{
    ...
    function claim(
        ...
        require(
            verify(_to, _tokenId, _timestamp, signature),
            "signature is not valid"
        );
        require(block.timestamp <= _timestamp, "Claiming period ends");
        require(!isClaimed(_tokenId), "NFT has been claimed");
...
contract VerifySignature {
    ...
    function getMessageHash(
        ...
        return keccak256(abi.encodePacked(_to, _tokenId, _timestamp));
    }
    ...
    function verify(
        ...
        bytes32 messageHash = getMessageHash(_to, _tokenId, _timestamp);
