...
interface IMetadataModule {
    /**
     * @dev When implemented, NFTCollection's `tokenURI` redirects execution to this `tokenURI`.
...
/**
 * @dev The information pertaining to this collection.
 */
struct CollectionInfo {
    ...
    uint32 collectionMaxMintable;
    // The lower limit of the maximum number of tokens that can be minted.
    uint32 collectionMaxMintableUpper;
    // The upper limit of the maximum number of tokens that can be minted.
    uint32 collectionMaxMintableLower;
    // The timestamp (in seconds since unix epoch) after which the
    // max amount of tokens mintable will drop from
    // `maxMintableUpper` to `maxMintableLower`.
    uint32 collectionCutoffTime;
 ...
 * @notice The interface for NFT collection contracts.
 */
interface INFTCollection is IERC721AUpgradeable, IERC2981Upgradeable {
    // =============================================================
    //                            EVENTS
    // =============================================================
    ...
    /**
     * @dev Emitted when the collection's maximum mintable token quantity range is set.
     * @param collectionMaxMintableLower_ The lower limit of the maximum number of tokens that can be minted.
     * @param collectionMaxMintableUpper_ The upper limit of the maximum number of tokens that can be minted.
     */
    event CollectionMaxMintableRangeSet(uint32 collectionMaxMintableLower_, uint32 collectionMaxMintableUpper_);

    /**
     * @dev Emitted when the collection's cutoff time set.
     * @param collectionCutoffTime_ The timestamp.
     */
    event CollectionCutoffTimeSet(uint32 collectionCutoffTime_);
     ...
     * @param collection_                 The address of the collection.
     ...
     * @param collectionMaxMintableLower_ The lower bound of the max mintable quantity for the collection.
     * @param collectionMaxMintableUpper_ The upper bound of the max mintable quantity for the collection.
     * @param collectionCutoffTime_       The timestamp after which `collectionMaxMintable` drops from
     *                                 `collectionMaxMintableUpper` to
     *                                 `max(_totalMinted(), collectionMaxMintableLower)`.
     * @param flags_                   The bitwise OR result of the initialization flags.
     *                                 See: {METADATA_IS_FROZEN_FLAG}
     */
    event NFTCollectionInitialized(
        address indexed collection_,
        string name_,
        string symbol_,
    ...
    /**
     * @dev The collection's metadata is frozen (e.g.: `baseURI` can no longer be changed).
     */
    ...
    /**
     * @dev The requested quantity exceeds the collection's remaining mintable token quantity.
     * @param available The number of tokens remaining available for mint.
     */
    error ExceedsCollectionAvailableSupply(uint32 available);
    ...
    /**
     * @dev The `collectionMaxMintableLower` must not be greater than `collectionMaxMintableUpper`.
     */
    error InvalidCollectionMaxMintableRange();

    /**
     * @dev The `collectionMaxMintable` has already been reached.
     */
    ...
    /**
     * @dev Sets the collection max mintable range.
     *
     * Calling conditions:
     * - The caller must be the owner of the contract, or have the `ADMIN_ROLE`.
     *
    ...
    /**
     * @dev Sets the timestamp after which, the `collectionMaxMintable` drops
     *      from `collectionMaxMintableUpper` to `collectionMaxMintableLower.
     *
     * Calling conditions:
     * - The caller must be the owner of the contract, or have the `ADMIN_ROLE`.
     *
     * @param collectionCutoffTime_ The timestamp.
     */
    function setCollectionCutoffTime(uint32 collectionCutoffTime_) external;
    ...
    /**
     * @dev Returns the collection info.
     * @return collectionInfo The latest value.
     */
    function collectionInfo() external view returns (CollectionInfo memory collectionInfo);
    ...
    /**
     * @dev Returns the maximum amount of tokens mintable for this collection.
     * @return The configured value.
     */
    function collectionMaxMintable() external view returns (uint32);

    /**
     * @dev Returns the upper bound for the maximum tokens that can be minted for this collection.
     * @return The configured value.
     */
    function collectionMaxMintableUpper() external view returns (uint32);

    /**
     * @dev Returns the lower bound for the maximum tokens that can be minted for this collection.
     * @return The configured value.
     */
    function collectionMaxMintableLower() external view returns (uint32);

    /**
     * @dev Returns the timestamp after which `collectionMaxMintable` drops from
     *      `collectionMaxMintableUpper` to `collectionMaxMintableLower`.
     * @return The configured value.
     */
    function collectionCutoffTime() external view returns (uint32);
