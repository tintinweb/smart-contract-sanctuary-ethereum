...
contract IPFSTest is ERC721A, IERC2981, Ownable, ReentrancyGuard, Terms, Uri {
  string public PROVENANCE_HASH;
  string public SEED_PHRASE_HASH;
  uint32 public MAX_MINT_BATCH = 20;

  string constant TOKEN_SYMBOL = "IPFS-TEST";
  string constant TOKEN_NAME = "IPFS Test";
  uint32 constant ROYALTY_PCT = 10;
  uint32 constant MAX_SUPPLY = 1000;
