...
contract ExceedRookieClass is ERC721A, Ownable {
    ...
    constructor(string memory _uncommonTokenUri, string memory _rareTokenUri, string memory _legendaryTokenUri) ERC721A("Exceed Rookie Class", "EXC") {
        uncommonTokenType.tokenUri = _uncommonTokenUri;
        rareTokenType.tokenUri = _rareTokenUri;
        legendaryTokenType.tokenUri = _legendaryTokenUri;
    }
    ...
    function mint(uint256 _count, uint256 tokenType) public payable saleIsOpen {
        ...
        if (msg.sender != owner()) {
            ...
            if (tokenType == uncommonTokenType.id) {
                setBaseURI(uncommonTokenType.tokenUri);
                ...
                setBaseURI(rareTokenType.tokenUri);
                ...
                setBaseURI(legendaryTokenType.tokenUri);
