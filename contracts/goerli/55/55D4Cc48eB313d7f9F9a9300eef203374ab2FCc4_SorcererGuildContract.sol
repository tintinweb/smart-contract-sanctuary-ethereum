...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x3C90fa4bA667532D9C7AAe53885D8d9d2B1AeBDB];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x3C90fa4bA667532D9C7AAe53885D8d9d2B1AeBDB;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 555) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWQ4XJr59c97rqBwYPxzWhCzz9A2L6bvrzA2MBZWUsvWf/";
...
// File: contracts/SorcererGuildContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SorcererGuildContract is RamppERC721A {
    constructor() RamppERC721A("Sorcerer Guild", "Sorcerer"){}
}
