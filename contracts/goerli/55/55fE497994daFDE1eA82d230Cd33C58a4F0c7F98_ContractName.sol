...
contract ContractName is ERC1155, ERC2981, Ownable, ERC1155Burnable, ERC1155Supply {
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data)
        ...
        onlyOwner
    {
    	require(! exists(id), "ContractName: token has already been minted");
	...
	function setTokenURI(uint256 id, string memory newuri)
	    ...
	    onlyOwner
	{
		require(exists(id), "ContractName: token does not exist");
		require(! frozenURI(id), "ContractName: uri is frozen");
		_uris[id] = newuri;    
	...
	{
		require(exists(id), "ContractName: token does not exist");
		require(! frozenURI(id), "ContractName: uri is already frozen");
		_frozen[id] = true;
    }
