...
contract OnChainPhotoTest is ERC721Royalty, Ownable {
    mapping(uint256 => bytes) private uris;
    mapping(uint256 => bool) public frozen;

    constructor() ERC721("OnChainPhotoTest", "PHOTO") {}
    ...
    function appendUri(uint256 tokenId, bytes calldata partialUri) external onlyOwner {
        ...
        uris[tokenId] = abi.encodePacked(uris[tokenId], partialUri);
    }
