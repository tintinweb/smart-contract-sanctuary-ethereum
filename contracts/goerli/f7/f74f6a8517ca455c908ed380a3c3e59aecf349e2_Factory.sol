...
contract Factory is OwnableUpgradeable, UUPSUpgradeable {
    ...
    address private constant DAI = 0x9D233A907E065855D2A9c7d4B552ea27fB2E5a36;
    address private constant USDC = 0xd35CCeEAD182dcee0F148EbaC9447DA2c4D449c4;
    address private constant USDT = 0xe583769738b6dd4E7CAF8451050d1948BE717679;
    ...
    function initialize() public initializer {
        ...
        adminAddress = 0x04e8Ba0960C399d51316dDc8E944FbC9D8bBCa66;
    }
...
contract Fundraiser is Ownable, Pausable, ERC20, ReentrancyGuard {
  ...
  function receiveFunds(address token, uint256 amount) private {
    require(token == USDC || token == DAI || token == USDT, "Invalid currency");
