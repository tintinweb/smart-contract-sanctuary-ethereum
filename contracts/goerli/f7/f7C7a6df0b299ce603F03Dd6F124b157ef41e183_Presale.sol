...
contract Presale is Ownable, Pausable, Whitelist {
    ...
    uint256 public constant minContribLimit = 4000000000000000; // The minimum purchase (0,004BNB) in Wei units
    uint256 public constant maxContribLimit = 10000000000000000000; // The maximum purchase (10BNB) in Wei units

    uint256 public constant hardCap = 500000000000000000; // The maximum limit supply (0,5BNB) in Wei units
