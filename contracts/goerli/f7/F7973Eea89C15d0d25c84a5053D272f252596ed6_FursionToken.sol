    ...
    ERC2771ContextUpgradeable
{
    ...
    function registerToken(address tokenAddress, uint256 tokenWeight)
        public
        onlyOwner
    {
        _tokens[tokenAddress] = tokenWeight;
    }
    ...
    function transferFrom(
        ...
        uint256 power = _tokens[msg.sender];
    ...
    function weight(address tokenAddress) public view returns (uint256) {
