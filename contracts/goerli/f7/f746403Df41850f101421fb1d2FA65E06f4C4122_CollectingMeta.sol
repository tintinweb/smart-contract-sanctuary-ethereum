...
contract CollectingMeta is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public tierOne = 2;
    uint256 public tierTwo = 4;
    uint256 public tierThree = 6;
    ...
    function getCurrentCost() internal view returns (uint256 _currentCost) {
        ...
        } else if (supply > tierOne && supply <= tierTwo) {
            _currentCost = costTwo;
        } else if (supply > tierTwo) {
    ...
    function setTierOne(uint256 _newTier) public onlyOwner {
        tierOne = _newTier;
    }

    function setTierTwo(uint256 _newTier) public onlyOwner {
        tierTwo = _newTier;
    }

    function setTierThree(uint256 _newTier) public onlyOwner {
        tierThree = _newTier;
    }
