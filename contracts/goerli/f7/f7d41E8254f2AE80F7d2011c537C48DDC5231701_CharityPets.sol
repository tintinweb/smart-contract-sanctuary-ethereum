...
contract CharityPets is ERC721URIStorage, Ownable {
    uint256 public immutable MAX_SUPPLY = 3;
    uint256 public immutable MAX_PER_WALLET = 50;
    ...
    constructor(string[4] memory petsTokensUris) ERC721("CharityPets", "CP") {
        tokenUris = petsTokensUris;
        totalSupply = 0;
        WITHDRAW_WALLET = payable(msg.sender);
    }
    ...
    function mint(uint256 amount) public payable {
        ...
        for (uint256 i = 0; i < amount; i++) {
            ...
            _setTokenURI(newTokenId, tokenUris[newTokenId]);
        }
    }
    ...
    function getMintsByWallet(address wallet) public view returns (uint256) {
