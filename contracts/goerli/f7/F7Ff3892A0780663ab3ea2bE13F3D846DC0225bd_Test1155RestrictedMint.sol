 ...
 * @notice This contract handles minting test 1155 restricted mint tokens.
 */
contract Test1155RestrictedMint is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xA61Fe82A8fCd0C2CEc07E45BDE314FdAf05eF8BE;
    ...
    string public name = "test 1155 restricted mint";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiftmchfqquq2zp2ekqx7tlsab6ijqe66rik2ojuplgceclz4iuubm/{id}"
        )
        RevokableOperatorFilterer(
