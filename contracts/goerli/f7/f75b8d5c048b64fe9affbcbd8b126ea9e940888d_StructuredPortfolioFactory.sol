...
interface IStructuredPortfolio is ILoansManager {
    ...
    function updateCheckpoint(uint256 trancheIdx, int256 delta) external;
    ...
    /**
     * @dev Role used to access tranches strategies setters
     * @return role Tranche strategies owner role
     */
    function TRANCHE_STRATEGY_OWNER_ROLE() external view returns (bytes32 role);
}
...
import {IDepositStrategy} from "IDepositStrategy.sol";
import {IWithdrawStrategy} from "IWithdrawStrategy.sol";
import {IStructuredPortfolio, TrancheInitData, PortfolioParams} from "IStructuredPortfolio.sol";
import {ITrancheVault} from "ITrancheVault.sol";
