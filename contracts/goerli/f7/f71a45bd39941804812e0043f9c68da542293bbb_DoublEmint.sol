...
contract DoublEmint is Ownable, ERC721A {
  string public baseURI = "https://nftstorage.link/ipfs/bafybeiamfr3mtbgkqb53gibg253ue4pymqqdqxim/";
  ...
  uint256 public immutable maxWalletFreeSupply = 9;

  constructor(uint256 _mintCntToOwner) ERC721A('Dou blE mint', 'DE') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 170) {
