...
import ".././Interface/IPresaleLockForwarder.sol";
...
contract PresaleGenerator01 is Ownable {
    ...
    function createPresale (
      ...
      uint256 _refundFee
        ...
        require(params.endblock.sub(params.startblock) > 0, "INVALID MAX PRESALE LENGTH.");
        ...
        require(_refundFee >= 0 && _refundFee <= 1000, "INVALID REFUND FEE."); 
        newPresale.init3(is_white_list, _caller, percentFee, _distributionTime, _unlockRate, _isRefund, _refundFee);
