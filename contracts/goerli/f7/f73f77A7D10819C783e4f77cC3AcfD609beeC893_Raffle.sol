...
/**
 * Sample Raffle Contract
 * This contract is a sample implementation of a raffle using Chainlink VRF and Keeper.
 */
contract Raffle is VRFConsumerBaseV2, KeeperCompatible {
	...
	function getPlayer(uint256 idx) public view returns (address payable) {
	...
	function getNbPlayers() public view returns (uint256) {
