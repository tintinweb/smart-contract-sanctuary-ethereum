...
contract Cashby is ERC20, protected {
    ...
    address public constant PancakeswapRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Uniswap v2 for testnet
    ...
    function _swapContractToken(uint256 totalMax,
        ...
        // Safety underflow measure
        if (tokenForLiquidity > 0) {
            liqToken = tokenForLiquidity / 2;
            liqBNBToken = tokenForLiquidity - liqToken;
        }
        ...
        // Once again avoid underflow
        if(liqBNBToken > 0) {
            // If we have a liquidity amount, add liquidity calculating it over the whole swap amount
