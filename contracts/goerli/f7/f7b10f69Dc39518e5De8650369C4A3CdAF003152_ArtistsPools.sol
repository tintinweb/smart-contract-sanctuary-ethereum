    ...
    IERC721Receiver
{
    ...
    mapping(address => uint256) public spentPineapples;

    IERC20 public memeToken;
    Auction public auction;
    MEME721 public meme721;
    DontDieMemePool public dontDieMemePool;
        ...
        updateReward(msg.sender, pool)
    {
        ...
        // add to user spentPineapples
        spentPineapples[msg.sender] = spentPineapples[msg.sender].add(c.points);
    ...
    function redeemPina() external {
        uint256 pina = spentPineapples[msg.sender];
        require(pina > 0, "nothing to redeem");
        spentPineapples[msg.sender] = 0;
        dontDieMemePool.mint(msg.sender, pina);
    }
