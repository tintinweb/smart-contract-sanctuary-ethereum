 ...
 * @notice This contract handles minting Nelly and Wumpus going to adventure tokens.
 */
contract NellyAndWumpusGoingToAdventure is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x423193dfbA6C6376e27329C3FeF2Cf18B74d9208;
    ...
    string public name = "Nelly and Wumpus going to adventure";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeihan7kz7ch4jojpzx7x5l2435xtdoiaygkyd6myhqahnp7h3tpb2a/{id}"
        )
    {
        ...
        tokenPresaleMintsPerAddress[1] = 5;
        tokenMaxSupply[2] = 200;
        tokenPublicPrice[2] = 0.001 ether;
        tokenPublicMintsPerAddress[2] = 3;
        tokenPublicSaleStartTime[2] = 1670983200;
        tokenPublicSaleEndTime[2] = 1670985000;
        tokenUsePublicSaleTimes[2] = true;
        tokenURI[
            3
        ] = "ipfs://bafkreicb5y7beipm3gtgsvdztcawee6rwk7pxnvinvchznco2tamd6vv7q";
