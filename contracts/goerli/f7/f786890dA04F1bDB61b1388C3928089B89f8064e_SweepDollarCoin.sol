...
contract BaseSweep is Initializable, ERC20Upgradeable, AccessControlUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    modifier onlyOwnerGovSig() {
        require(msg.sender == timelock_address || msg.sender == multisig_address || msg.sender == owner(), "Not owner or timelock or multi-sig");
        _;
    }
    ...
    // Pause Sweep
    function pause() external onlyOwnerGovSig whenNotPaused {
        _pause();
    }

    // Unpause Sweep
    function unpause() external onlyOwnerGovSig whenPaused {
        _unpause();
    }
    ...
    */
    ...
    function addMinter(address minter_address, uint256 max_mint_amount) public onlyOwnerGovSig {
    ...
    // Remove a minter
    function removeMinter(address minter_address) public onlyOwnerGovSig {
        require(minter_address != address(0), "Zero address detected");
    ...
    function setMinterMaxAmount(address minter_address, uint256 max_mint_amount) external onlyOwnerGovSig {
        require(minters[minter_address].is_listed == true, "Minter nonexistant");
    ...
    function setMinterEnabled(address minter_address, bool is_enabled) external onlyOwnerGovSig {
        require(minters[minter_address].is_listed == true, "Minter nonexistant");
    ...
    function setTimelock(address new_timelock) external onlyOwnerGovSig {
...
contract SweepDollarCoin is BaseSweep {
    ...
    function beginNewPeriod(uint256 _new_period_time) public onlyOwnerGovSig {
    ...
    function setInterestRate(uint256 _new_interest_rate) public onlyOwnerGovSig {
    ...
    /* Set new target price with the following formula:  
        ...
        * p: starting price
    */
    function setPriceTarget(uint256 _new_target_price) public onlyOwnerGovSig {
        previous_target_price = current_target_price;
    ...
    function setUniswapOracle(address _uniswap_oracle_address) public onlyOwnerGovSig {
    ...
    function setPeriodTime(uint256 _period_time) public onlyOwnerGovSig {
