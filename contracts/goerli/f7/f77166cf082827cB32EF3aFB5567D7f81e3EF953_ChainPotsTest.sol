...
contract ChainPotsTest {
    ...
    uint256 public bronzeLotteryEntryPrice = 0.001 ether;
    uint256 public bronzeLotteryPotMaxAmount = 0.01 ether;
    uint256 public bronzeLotteryMaxEntries = 10;

    address payable[] public playersSilverLottery;
    uint256 public silverLotteryEntryPrice = 0.002 ether;
    uint256 public silverLotteryPotMaxAmount = 0.02 ether;
    uint256 public silverLotteryMaxEntries = 10;

    address payable[] public playersGoldLottery;
    uint256 public goldLotteryEntryPrice = 0.003 ether;
    uint256 public goldLotteryPotMaxAmount = 0.03 ether;
    ...
    uint256 public bronzeHTHEntryPrice = 0.001 ether;
    uint256 public bronzeHTHPotMaxAmount = 0.002 ether;
    uint256 public bronzeHTHMaxEntries = 2;

    address payable[] public playersSilverHTH;
    uint256 public silverHTHEntryPrice = 0.002 ether;
    uint256 public silverHTHPotMaxAmount = 0.004 ether;
    uint256 public silverHTHMaxEntries = 2;

    address payable[] public playersGoldHTH;
    uint256 public goldHTHEntryPrice = 0.003 ether;
    uint256 public goldHTHPotMaxAmount = 0.006 ether;
