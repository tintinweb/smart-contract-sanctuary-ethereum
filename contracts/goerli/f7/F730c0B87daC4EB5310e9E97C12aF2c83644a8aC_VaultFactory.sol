...
contract VaultFactory {
    ...
    address public managerUser;

    modifier onlyManagerUser() {
        require(msg.sender==managerUser,"caller is not the owner");
        _;
    }
    ...
    constructor(IEntryPoint _entryPoint) {
        ...
        managerUser=msg.sender;
        entryPoint=_entryPoint;
    }

    function addStake(uint32 unstakeDelaySec) external payable onlyManagerUser {
