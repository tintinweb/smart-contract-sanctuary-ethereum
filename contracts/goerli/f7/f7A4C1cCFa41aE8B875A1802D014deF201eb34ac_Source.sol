...
contract Source is IXReceiver {
    // The connext contract on the origin domain
    IConnext public immutable connext;
    bool comeback;

    // The canonical TEST Token on Goerli
    IERC20 public farmInputToken = IERC20(0x7ea6eA49B0b0Ae9c5db7907d139D9Cd3439862a1);

    constructor(IConnext _connext) {
        connext = _connext;
    }

    function depositInFarm(
        address target,
        uint32 destinationDomain,
        ...
        farmInputToken.transferFrom(msg.sender, address(this), depositAmount);

        // This contract approves transfer to Connext
        farmInputToken.approve(address(connext), depositAmount);

        //yahapar kaunsa function call karna hai wo bhi encode karte aana chaiye
        // Encode the data needed for the target contract call.
        bytes memory callData = abi.encode(msg.sender, depositAmount);
        ...
        connext.xcall{value: relayerFee}(
            ...
            depositAmount, // _amount: amount of tokens to transfer
