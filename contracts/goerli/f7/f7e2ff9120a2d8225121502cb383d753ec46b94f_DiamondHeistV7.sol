    ...
    ReentrancyGuardUpgradeable
{
    ...
    function getPendingUserCommits(address recipient) public view returns (uint16[] memory commitIds, uint16[] memory amounts, bool[] memory stakes) {
        ...
        for (uint16 index = 0; index < pendingCount; index++) {
            ...
            stakes[index] = c.stake;
        }

        return (commitIds, amounts, stakes);
    }
