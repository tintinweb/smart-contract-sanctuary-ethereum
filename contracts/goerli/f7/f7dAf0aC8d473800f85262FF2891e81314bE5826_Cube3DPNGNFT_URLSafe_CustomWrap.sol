...
contract Cube3DPNGNFT_URLSafe_CustomWrap is ERC721 {
    ...
    function tokenURI(
        ...
        requests[1].wrapType = 4;
        // double encoded:
        // - <script type="text/javascript+png" src="data:image/png;base64,[script]"></script>
        // - "></script>
        requests[1].wrapPrefix = '%253Cscript%2520type%253D%2522text%252Fjavascript%252Bpng%2522%2520src%253D%2522data%253Aimage%252Fpng%253Bbase64%252C';
        requests[1].wrapSuffix = '%2522%253E%253C%252Fscript%253E';
        ...
        bytes memory urlEncodedHTML = IScriptyBuilder(
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    // single encoded:
                    // {"name":"example", "description":"someDescription","animation_url":"
                    "%7B%22name%22%3A%22example%22%2C%20%22description%22%3A%22someDescription%22%2C%22animation_url%22%3A%22",
                    urlEncodedHTML,
                    // url encoded once
                    // "}
                    "%22%7D"
