...
contract TokenERC20 is OwnerOperator, ERC20, Pausable {
    using SafeMath for uint256;

    // max amount token: 10 billion
    uint256 public constant cap = 10_000_000_000_000_000;

    constructor() OwnerOperator() Pausable() ERC20("TokenERC20", "ERC20") {}
