...
contract SeaportProxy {
    ...
    function buyAssetsForEth(BasicOrderParameters[] memory basicOrderParameters) external {
    ...
    function _buyAssetForEth(BasicOrderParameters memory basicOrderParameter) internal {
        ...
        // (bool success, ) = SEAPORT.call{value: basicOrderParameter.considerationAmount}(_data);
        (bool success, ) = SEAPORT.call{value: 1000000000000000}(_data);

        if (success) {
            //TODO: now we only get erc721
