...
//MINTING_______________________________________________________________________
    ...
    uint public maxTokensPerTx = 1;
    uint256 public maxCursedTokensPerWallet = 2;

    function setMaxTokenPerTx(uint _value) public onlyGang{
        maxTokensPerTx = _value;
    }
    function setmaxCursedTokensPerWallet(uint _value) public onlyGang{
        maxCursedTokensPerWallet = _value;
    }
    ...
    function _internalMint(address _addr,uint256 _qtty) internal
    {
        ...
        require( _qtty < maxCursedTokensPerWallet + 1, "max per wallet reached.");
...
//MONEY______________________________________________________________________
    address private MonstersBoss = 0x7Ebb60E50208Fd2BE670AEb8F0E591a8a8F67506;
