...
contract boobs is ERC721A, IERC2981, Ownable, ReentrancyGuard {
...
uint256 public reserved_amount_for_whitelist = 5;
...
bool public paused = false;
    ...
    constructor(
    ) ERC721A("boobs", "boobsnft", 100,  total_amount_of_poobs) {
    }
    ...
    function reveal_poobs(string memory _baseURI) external onlyOwner {
    ...
    function reserve_whitelist(uint256 reserve)
        external
        onlyOwner
    {
       reserved_amount_for_whitelist = reserve;
    }
