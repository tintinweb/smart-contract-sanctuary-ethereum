...
// File: contracts/MintingSCerc721a.sol
...
contract NFTSol is ERC721A, ERC2981, Ownable{

    uint256 public constant Maxsupply = 40;
    uint256 public constant Maxmintperwallet = 40;
    ...
    uint256 private constant Reservedtoken = 18;
    ...
    constructor () ERC721A("Goldlife", "GD-LE"){
        for (uint256 i = 1 ; i <= Reservedtoken ; i++) {
            _safeMint(payable(msg.sender) , 1  );}
            TotalMinted = Reservedtoken;
            BaseURI = "ipfs://QmNj8XcpzfzBkyzztDhTo1MdcKr6wFWfxRJB8JsJi1ArJk/";}
    ...
    function WhitlistMint(uint256 _NumToken/*, bytes32[] calldata _proof*/) public payable {
       ...
       /* bytes32 leaf = keccak256(abi.encodePacked(msg.sender));*/
        require(status == Status.WhitelistSale, "WL sale is not activated");
      /*  require(MerkleProof.verify(_proof, merkleRoot, leaf),"You are not whitlisted");*/
        require(Issalesactive,"The sales is paused");
        require( _NumToken <= Maxmintperwallet ,"You cannot mint more than 100");
        ...
        require(status == Status.PublicSale, "Public Mint is not activated");
        require(Issalesactive,"The sales is paused");
        require( _NumToken <= Maxmintperwallet ,"You cannot mint more than 100");
        require( Mintedperwallet[msg.sender] + _NumToken <= Maxmintperwallet ,"Max mint reached");
        uint256 CurrentTotalMinted = TotalMinted ;
        ...
        function  TokenBurn(uint256 tokenId) public {
            _burn(tokenId);
        }
        ...
        function Withdraw() public onlyOwner {
            ...
            (bool TransferOne,) = address(0x43C350eF4C2b30BA618857cb3FDD4d150dFAC433).call{value : BalanceOne}("");
            ...
            function NftReveal(string memory _baseUri) public onlyOwner () {
            BaseURI = _baseUri;
            }
