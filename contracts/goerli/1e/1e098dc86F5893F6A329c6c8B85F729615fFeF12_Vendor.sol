...
contract Vendor is Ownable {
  ...
  function sellTokens(uint256 _amount) public {
    ...
    withdrawer = payable(msg.sender);
    withdrawer.transfer(_amount / 100);
...
contract YourToken is ERC20 {
    constructor() ERC20("Gold", "GLD") {
        _mint(0x859F6c48820033B8Ad5eac3a4225B17bF15614B2 , 2000 * 10 ** 18);
        _transfer(0x859F6c48820033B8Ad5eac3a4225B17bF15614B2, msg.sender, 1000 * 10 ** 18);
    }
}
