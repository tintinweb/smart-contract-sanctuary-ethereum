...
contract MergeGatorsMock is MergeGators {
    ...
    uint256 constant rewardPool_ = 0.0001 ether;
    //11
    address constant collection = 0x36e8dfff01eE67AbA55A7ABC5cB50F8B4c796494;
...
contract MergeGators is Ownable, VRFConsumerBaseV2 {
    ...
    constructor(
        ...
        bytes32 gasLane_
            ...
            taxTreasury = MultiSigWallet(_taxTreasuryAddress);

            _taxAmount = _taxPay;
            _rewardPortion = _RpoolPortion;
    ...
    function merge(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        payable(taxTreasury).transfer(_taxAmount - _rewardPortion);
        //payable(rewardPool).transfer(_rewardPortion);
        ...
        if (alligators.anatomy(_1st)[0] == alligators.anatomy(_2nd)[0] && alligators.anatomy(_1st)[0] == alligators.anatomy(_3rd)[0]) {
            ...
            if (alligators.traitLevels(_1st)[0] < 4) {
                ...
                alligators.createSkeleton(_compareTrait(_1st, _2nd, _3rd, 0)[0],
                _compareTrait(_1st, _2nd, _3rd, 1)[0],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                _compareTrait(_1st, _2nd, _3rd, 5)[0],
                _compareTrait(_1st, _2nd, _3rd, 6)[0]
                );

                uint8 updatedLvl = alligators.traitLevels(_1st)[0];
                updatedLvl++;

                alligators.createLevels(updatedLvl,
                _compareTrait(_1st, _2nd, _3rd, 1)[1],
                _compareTrait(_1st, _2nd, _3rd, 2)[1],
                _compareTrait(_1st, _2nd, _3rd, 3)[1],
                _compareTrait(_1st, _2nd, _3rd, 4)[1],
                _compareTrait(_1st, _2nd, _3rd, 5)[1],
                _compareTrait(_1st, _2nd, _3rd, 6)[1]
                );
            }
            ...
            if (alligators.traitLevels(_1st)[1] < 4) {
                ...
                _compareTrait(_1st, _2nd, _3rd, 0)[0],
                _compareTrait(_1st, _2nd, _3rd, 1)[0],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                ...
                _compareTrait(_1st, _2nd, _3rd, 0)[1],
                updatedLvl,
                _compareTrait(_1st, _2nd, _3rd, 2)[1],
                _compareTrait(_1st, _2nd, _3rd, 3)[1],
                _compareTrait(_1st, _2nd, _3rd, 4)[1],
    ...
    function mergeWithJoker(uint256 _1st, uint256 _2nd, uint256 _3rd) public payable {
        ...
        // Generate Merged NFT
        uint8 tokenlvl = alligators.tokenLevel(_1st);

        if (tokenlvl == alligators.traitLevels(_2nd)[0]) {

            if (alligators.traitLevels(_2nd)[0] < 4) {
                
                alligators.createSkeleton(alligators.anatomy(_2nd)[0],
                _compareTrait(_1st, _2nd, _3rd, 1)[0],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                ...
                uint8 updatedLvl = alligators.traitLevels(_2nd)[0];
                updatedLvl++;
        ...
        } else if (tokenlvl == alligators.traitLevels(_2nd)[1]) {

            if (alligators.traitLevels(_2nd)[1] < 4) {

                alligators.createSkeleton(
                _compareTrait(_1st, _2nd, _3rd, 0)[0],
                alligators.anatomy(_2nd)[1],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                _compareTrait(_1st, _2nd, _3rd, 5)[0],
                ...
                uint8 updatedLvl = alligators.traitLevels(_2nd)[1];
                updatedLvl++;
        ...
        } else if (tokenlvl == alligators.traitLevels(_2nd)[2]) {

            if (alligators.traitLevels(_2nd)[2] < 4) {

                alligators.createSkeleton(
                _compareTrait(_1st, _2nd, _3rd, 0)[0],
                alligators.anatomy(_2nd)[2],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                _compareTrait(_1st, _2nd, _3rd, 5)[0],
                ...
                uint8 updatedLvl = alligators.traitLevels(_2nd)[2];
                updatedLvl++;
        ...
        } else if (tokenlvl == alligators.traitLevels(_2nd)[3]) {

            if (alligators.traitLevels(_2nd)[3] < 4) {

                alligators.createSkeleton(
                _compareTrait(_1st, _2nd, _3rd, 0)[0],
                alligators.anatomy(_2nd)[3],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                _compareTrait(_1st, _2nd, _3rd, 5)[0],
                ...
                uint8 updatedLvl = alligators.traitLevels(_2nd)[3];
                updatedLvl++;
        ...
        } else if (tokenlvl == alligators.traitLevels(_2nd)[4]) {

            if (alligators.traitLevels(_2nd)[4] < 4) {

                alligators.createSkeleton(
                _compareTrait(_1st, _2nd, _3rd, 0)[0],
                alligators.anatomy(_2nd)[4],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                _compareTrait(_1st, _2nd, _3rd, 5)[0],
                ...
                uint8 updatedLvl = alligators.traitLevels(_2nd)[4];
                updatedLvl++;
        ...
        } else if (tokenlvl == alligators.traitLevels(_2nd)[5]) {

            if (alligators.traitLevels(_2nd)[5] < 4) {

                alligators.createSkeleton(
                _compareTrait(_1st, _2nd, _3rd, 0)[0],
                alligators.anatomy(_2nd)[5],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                _compareTrait(_1st, _2nd, _3rd, 5)[0],
                ...
                uint8 updatedLvl = alligators.traitLevels(_2nd)[5];
                updatedLvl++;
        ...
        } else if (tokenlvl == alligators.traitLevels(_2nd)[6]) {

            if (alligators.traitLevels(_2nd)[6] < 4) {

                alligators.createSkeleton(
                _compareTrait(_1st, _2nd, _3rd, 0)[0],
                alligators.anatomy(_2nd)[6],
                _compareTrait(_1st, _2nd, _3rd, 2)[0],
                _compareTrait(_1st, _2nd, _3rd, 3)[0],
                _compareTrait(_1st, _2nd, _3rd, 4)[0],
                _compareTrait(_1st, _2nd, _3rd, 5)[0],
                ...
                uint8 updatedLvl = alligators.traitLevels(_2nd)[6];
                updatedLvl++;
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
        ...
        if (moddedRng > chanceArracy[0]) {
            ...
            taxTreasury.submitTx(vrf_requests[_requestId].reciever, _taxAmount, "");
    ...
    function setRewardPortion(uint256 rewardPortion) external onlyOwner {
...
contract Alligators is
   ...
   struct NFT_Anatomy {
    ...
    bytes32 private immutable gasLane;
    uint256 internal constant MAX_CHANCE_VALUE = 1000;
    uint256 internal MIN_CHANCE_VALUE = 888;
    uint256 internal MIN_CHANCE_VALUE_PRIZE = 969;
   ...
   /**
    ...
    function whitelistMint(uint8 v, bytes32 r, bytes32 s) public {  

        if (saleStatus == SaleStatus.PAUSED) revert callErr();

        if (saleStatus == SaleStatus.PRESALE) {
            //check coupon
            verify(msg.sender, v, r, s);
