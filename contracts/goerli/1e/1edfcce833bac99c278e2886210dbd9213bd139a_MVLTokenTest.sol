...
// File: contracts/token/MVLTokenTest.sol
...
contract TokenLock is Ownable {
    ...
    struct TokenLockInfo {
        // token of `amount` cannot be moved before `time`
    ...
    function addTokenLock(
        ...
        TokenLockState storage lockState = lockingStates[_addr];
        // assigns a pointer. change the member value will update struct itself.
...
contract MVLTokenTest is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
    using SafeMath for uint256;
    ...
    modifier canTransfer(address _sender, uint256 _value) {
        ...
        require(
            ...
            (transferEnabled &&
            (noTokenLocked || canTransferIfLocked(_sender, _value)))
        );
    ...
    returns (bool success)
    {
        ...
        // this will throw if we don't have enough allowance
