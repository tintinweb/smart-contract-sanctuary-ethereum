...
contract Dokokaivial is DefaultOperatorFilterer, ERC1155, Ownable, ERC1155Burnable {
    ...
    constructor() ERC1155("") {}
    string tokenUri = "";
    bytes32 public merkleRoot = 0x891149fca7fb2afabbd0d4ed1972fa53e1db8fd76d6b78cf6308a5cfccfbda96;
    ...
    // Mint function
    function mint(uint256 amountToMint, bytes32[] calldata _merkleProof) public payable {
