...
abstract contract AccessControl is Context, IAccessControl, ERC165 {
    ...
    function _roles() internal view returns (mapping(bytes32 => AccountStorage.RoleData) storage roles){
        return AccountStorage.layout().roles;
    }
...
abstract contract AccessControlEnumerable is IAccessControlEnumerable, AccessControl {
    ...
    function _roleMembers() internal view returns (mapping(bytes32 => EnumerableSet.AddressSet) storage roleMembers){
        return AccountStorage.layout().roleMembers;
    }
