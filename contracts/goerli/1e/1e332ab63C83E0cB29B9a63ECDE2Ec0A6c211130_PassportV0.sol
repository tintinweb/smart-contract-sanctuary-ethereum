    ...
    IPassportV0
{
    ...
    function hasUpgraderRole(address _address) public view override(IPassportV0, PassageAccess) returns (bool) {
    ...
    function upgradeTo(address newImplementation) external override(UUPSUpgradeable, IPassportV0) onlyProxy {
    ...
    function upgradeToAndCall(address newImplementation, bytes memory data)
        external
        payable
        override(UUPSUpgradeable, IPassportV0)
        onlyProxy
    {
        _authorizeUpgrade(newImplementation);
...
interface IPassportV0 is IAccessControlUpgradeable {
