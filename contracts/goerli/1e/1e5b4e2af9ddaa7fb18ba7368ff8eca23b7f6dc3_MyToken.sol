...
contract MyToken is ERC721, Ownable {
    ...
    constructor(
        bytes32 merkleRoot_,
        bool isAllowlistMintActive_,
        bool isPublicMintActive_,
        bytes32[] memory leaves
    ) ERC721("MyToken", "MTK") {
        merkleRoot = merkleRoot_;
        isAllowlistMintActive = isAllowlistMintActive_;
        isPublicMintActive = isPublicMintActive_;
        for (uint256 i; i < leaves.length; i++) { 
            isMinted[leaves[i]] = true;
        }
    }
    ...
    function allowlistMint(
        ...
        require(isAllowlistMintActive, "mint is not opened");
        require(
        ...
        for (uint256 i = 0; i < _grades.length; i++) {
            ...
            require(!isMinted[leaf], "already minted");
    ...
    function publicMint() external  {
        require(isPublicMintActive, "mint is not opened");
        _safeMint(msg.sender);
    }
