...
contract Token is ERC20, Ownable {
    ...
    string constant _name = "Test20";
    string constant _symbol = "TEST20";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxWalletAmount = _totalSupply.mul(1000).div(1000); // 1%
    uint256 public _maxWhitelistWalletAmount = _totalSupply.mul(1000).div(1000); // 0.5%
    uint256 public _maxTx = _totalSupply.mul(1000).div(1000); // 1%
    ...
    Wallets public _taxWallet = Wallets ({
        marketing: 0xE5F4a87D255D66c42e2f5C67b7b2489dBe3bA0E6,
        poolStaking: 0x7249CDc498187B5f59395d52B21547D1C4b0c499
    });
