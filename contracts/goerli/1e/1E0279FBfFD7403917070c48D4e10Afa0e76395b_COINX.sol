...
contract COINX is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function viewUserBalance(address userAddress) external view returns (uint256) {
        require(userAddress != address(0), "COINX: can not view zero address");
    ...
    function mint(address userAddress, uint256 amount) public onlyRole(MINTER_ROLE) whenNotPaused {
        ...
        require(amount > 0, "COINX: invalid mint amount");
    ...
    function burnFrom(address userAddress, uint256 amount) public virtual override onlyRole(MINTER_ROLE) whenNotPaused {
        ...
        require(amount <= _userBalance[userAddress], "COINX: insufficient COINX to burn");
