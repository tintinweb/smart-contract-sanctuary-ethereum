...
contract MNTFactoryV2  {
    ...
    external returns(address instance) {
        ...
        (bool success, ) = instance.call(abi.encodeWithSignature("initialize(address, uint256, string, string, string, uint256, uint256)",_creator, _pinCode, _nftName,  _nftSymbol, _baseURL, _royalties, _maxSupply));
