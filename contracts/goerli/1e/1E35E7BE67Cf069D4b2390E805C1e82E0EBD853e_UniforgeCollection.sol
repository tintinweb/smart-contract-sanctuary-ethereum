 ...
 * @author d-carranza
 * @notice For more info about Uniforge and more visit dapponics.io
 */
contract UniforgeCollection is ERC721Enumerable, Ownable {
    ...
    /**
     * @dev Checks if the mint amount is at least the mintFee and that the amount of tokens is correct, then proceeds to mint the token
     */
    ...
    /**
     * @dev Allows owner to mint freely without constrains for marketing / strategy purposes
     */
    ...
    /**
     * @dev Edit the baseURI allowing owner to have a reveal party or upgrade the metadata
     */
    ...
    /**
     * @dev Edit the max mint amount per transaction to manage a more fair mint (is per transaction and not per address)
     */
    ...
    /**
     * @dev Edit the starting block timestamp of the public sale
     */
    ...
    /**
     * @dev Owner can withdraw 100% of the profits from the sale stored in the contract
     */
    ...
    /**
     * @dev Procedure to mint n tokens safely
     */
    ...
    /**
     * @dev Reads the mint price for the public sale
     */
    ...
    /**
     * @dev Reads the max mint amount per transaction
     */
    ...
    /**
     * @dev Reads the timestamp of the sale's start
     */
    ...
    /**
     * @dev Reads the baseURI of the collection
     */
    ...
    /**
     * @dev Reads the specific URI for a given token
     */
