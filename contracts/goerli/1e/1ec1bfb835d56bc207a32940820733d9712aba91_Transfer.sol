...
/// @notice Example of a cross-chain transfer using Connext
contract Transfer {
    ...
    /// @notice Simple transfer of funds using 'xcall'
    /// @param aTo The destination address
    ...
    function transfer(
        ...
        ERC20 myToken = ERC20(aAsset);

        // Make sure user has approvaed funds to the contract
        require(myToken.allowance(msg.sender, address(this)) >= aAmount, "User must approve amount");

        // User sends funds to this contract
        myToken.transferFrom(msg.sender, address(this), aAmount);
        
        // This contract approves transfer to Connext
        myToken.approve(address(theConnext), aAmount);
        ...
        emit TransferInitiated(aAsset, msg.sender, aTo);
