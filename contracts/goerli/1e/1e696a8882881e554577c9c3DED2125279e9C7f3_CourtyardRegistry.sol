...
ERC721EnumerableUpgradeable
{
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://metadata.courtyard.io/v0/api/content/crt";
    }
     ...
     */
    function burnToken(bytes32 _proof) external override onlyBurner() returns (bool) {
        uint256 tokenId = _tokenId(_proof);
...
interface ITokenRegistryUpgradeable is IERC165Upgradeable {
     ...
     * function.
     */
    function burnToken(bytes32 _tokenHash) external returns (bool);
}
