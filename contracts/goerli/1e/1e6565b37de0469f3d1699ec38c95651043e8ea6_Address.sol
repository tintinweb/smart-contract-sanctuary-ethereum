...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    constructor (address tokenOwner,string memory manam, string memory single,uint8 decimal, uint256 amountOfTokenWei,uint8 setTaxFee, uint8 setLiqFee, uint256 _maxTaxFee, uint256 _maxLiqFee, uint256 _minMxTxPer) public {
        _name = manam;
        _symbol = single;
        _decimals = decimal;
