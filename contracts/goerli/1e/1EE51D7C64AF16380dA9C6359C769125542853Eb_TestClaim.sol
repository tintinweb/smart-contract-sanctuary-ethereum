...
contract TestClaim is Ownable, Pausable {
    ...
    function claimTokens() external whenNotPaused {
        ...
        (tokensToClaim) = getClaimableTokenAmountToClaim(msg.sender);
    ...
    function getClaimableTokenAmount(address _account) public view returns (uint256) {
        ...
        (tokensAmount) = getClaimableTokenAmountToClaim(_account);
        return tokensAmount;
    }

    function getClaimableTokenAmountToClaim(address _account) private view returns (uint256)
    {
        ...
        + (unclaimedBetaBalance * BETA_DISTRIBUTION_AMOUNT);
