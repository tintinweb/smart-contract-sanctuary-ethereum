...
contract TestAB is ERC721A, Ownable {
  ...
  uint256 public FREE_AllowedTokensPerWallet = 3;

  address private Address1 = 0xcA1df70e7c9DAd437eBa2F367cdD0Ef6F43A0019;


  constructor(string memory baseURI) ERC721A("TestAB", "TAB") {
    setBaseURI(baseURI);
  }
