    ...
    IService
{
    ...
    /**
     * @dev Set new contracts
     */
    function setVestingAndCutomProposalAddress()
        public
    {
        vesting = IVesting(address(0x43268f13C7e4B2A49c092E922b6ab5b3b0ecE59A));
        customProposal = ICustomProposal(address(0xE69FeDe2d656026E594eDc6A89d479251Cc9bC2C));
    } 
