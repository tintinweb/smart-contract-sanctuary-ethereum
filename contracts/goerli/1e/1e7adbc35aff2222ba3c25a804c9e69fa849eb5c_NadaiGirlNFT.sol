...
contract NadaiGirlNFT is KeeperCompatibleInterface, ERC721, ERC721URIStorage  {
    ...
    string[] IpfsUri = [
        "https://ipfs.io/ipfs/QmUUiCavH5KqWXmiXeRupKnpCU5Qxvo9hPHsuiwrYwCG7x/NadaiGirlNFT.json",
        "https://ipfs.io/ipfs/QmUUiCavH5KqWXmiXeRupKnpCU5Qxvo9hPHsuiwrYwCG7x/NadaiGirlNFT1.json",
        "https://ipfs.io/ipfs/QmUUiCavH5KqWXmiXeRupKnpCU5Qxvo9hPHsuiwrYwCG7x/NadaiGirlNFT2.json",
        "https://ipfs.io/ipfs/QmUUiCavH5KqWXmiXeRupKnpCU5Qxvo9hPHsuiwrYwCG7x/NadaiGirlNFT3.json"
    ];

    uint interval;
    uint lastTimeStamp;

    constructor(uint _interval) ERC721("Nadai Girl", "dNFT") {
        interval = _interval;
