...
import {ERC721iMintable} from "./ERC721iMintable.sol";
...
contract PackageAirdrop is Ownable, IERC721Receiver {
    ...
    ERC721iMintable public immutable erc721Faucet;
    ...
    constructor(
        ...
        erc721Faucet = new ERC721iMintable(erc721Name, erc721Symbol, erc721StandardURI, address(this), ERC721_SUPPLY);
