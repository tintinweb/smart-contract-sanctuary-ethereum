...
contract test is  ERC721, ReentrancyGuard, Ownable {
  ...
  function mintPlanet1(uint256 count) public payable  {
    ...
    function mintPlanet2(uint256 count) public payable  {
    require(saleIsActive, "Sale not active");
 ...
 // require(count - 1 < MAX_MULTIMINT, "Trying to mint too many at a time");
    ...
    function mintPlanet3(uint256 count) public payable  {
    require(saleIsActive, "Sale not active");
    // required function ~ totalPlanet1Supply() ~ required constant PLANET1_SUPPLY
 ...
 //   require(count - 1 < MAX_MULTIMINT, "Trying to mint too many at a time");
  ...
  function mintAllPlanets(uint256 count1, uint256 count2, uint256 count3) public payable nonReentrant {
    ...
    function BatchP1(uint256 count) private {
    require(totalPlanet1Supply() + count - 1 < PLANET1_SUPPLY, "Exceeds max supply");
    ...
    function BatchP2(uint256 count) private {
    require(totalPlanet2Supply() + count - 1 < PLANET2_SUPPLY, "Exceeds max supply");
    ...
    function BatchP3(uint256 count) private {
    require(totalPlanet3Supply() + count - 1 < PLANET3_SUPPLY, "Exceeds max supply");
