...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1671811560;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xE22123C6974dE8C5F42eaA4DeE2A31d7E5A786e3];
  address public erc20Payable = 0xE22123C6974dE8C5F42eaA4DeE2A31d7E5A786e3;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigrv5q43oedx2kfy3ndf4ugoaf6wkedkvaxh7ax5cnfxq7iw76wxe/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/aLXkEbzR1nw8JVlYlkY6/contract-metadata";
  }
...
// File: contracts/ColorPunkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ColorPunkContract is RamppERC721A {
    constructor() RamppERC721A("Color Punk", "CCP"){}
}
