...
contract airdropContract is ERC721URIStorage,Ownable{
  ...
  ERC721URIStorage contract1 = ERC721URIStorage(0x4949151d73F55E2dce77A71b84dD2121762f2E92);
  constructor() ERC721("airdrop", "air") {
    _customBaseURI = 'ipfs://bafybeibpvl2ai6h5ce5krj6f7wi2jx2old5qhyavpg46yiocfxi3r6e23u/'; 
    _maxMintable = 201; 
    _royaltyAmount = 500;
  }
  function airdrop(uint256 from, uint256 to) public onlyOwner{
    for(uint i = from; i <= to; i++) {
      _mint(contract1.ownerOf(i),i);
      _tokenIds.increment();
    }
  }
  ...
  function setContract(ERC721URIStorage c1) public onlyOwner {
    contract1 = c1;
  }
