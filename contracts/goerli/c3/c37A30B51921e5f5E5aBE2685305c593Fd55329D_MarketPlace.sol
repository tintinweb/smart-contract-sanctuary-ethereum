...
contract MarketPlace is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    function ListNFT(
        ...
        uint256 marketItemId = tokenCounter;
        tokenCounter = tokenCounter + 1;
        _idToNFT[marketItemId] = NFT(
            marketItemId,
            address(nftContract),
            tokenID,
            msg.sender,
    ...
    // Buy an NFT
    function buyNft(uint256 marketItemId, address buyer)
        public
        nonReentrant
        onlyOwner
    {
        NFT storage nft = _idToNFT[marketItemId];
        require(
