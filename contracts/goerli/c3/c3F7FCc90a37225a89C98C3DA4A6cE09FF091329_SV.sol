...
contract SV is ERC721A, Ownable, ReentrancyGuard {
    ...
    address public SVPContract = 0x298B4C9B0Bb64dbF8475d59b4243952A002f15B5;
    ...
    function claim(bytes32[] calldata _merkleProof) public {
        uint256 SVPBalance = IERC721Enumerable(SVPContract).balanceOf(
            msg.sender
        );
        ...
        require(supply + SVPBalance <= maxSupply, "collection is sold out");
    ...
    function checkSVPBalance(address user) external view returns (uint256) {
        return IERC721Enumerable(SVPContract).balanceOf(user);
    }
