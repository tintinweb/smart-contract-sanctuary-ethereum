...
contract BGCCSupporter is ERC1155, EIP712, Ownable {
    ...
    uint256 public maxPerToken = 80; 
    uint256 public bonus = 250000000000000000;
    ...
    function mintAllowList(uint256 tokenId, string memory claimId, bytes32 hash, uint8 v, bytes32 r, bytes32 s) public payable {
        ...
        require(availableTokens >= 2, "Not Enough Tokens Supply");
    ...
    // create a set price function after allowlist has minted out 
    ...
    function testCount(uint256 _count) public view returns (uint256){
