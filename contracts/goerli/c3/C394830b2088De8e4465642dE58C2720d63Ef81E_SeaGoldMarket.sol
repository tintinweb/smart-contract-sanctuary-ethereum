...
contract SeaGoldMarket is Ownable {
    ...
    address private calcAddress;

    constructor(
        bool _preLaunch,
        address _calcAddress
    ) {
    ...
    function updatecalcAddress(address _calcAddress) public onlyOwner {
        calcAddress = _calcAddress;
    }

    function updatepreLaunch(bool _preLaunch) public onlyOwner {
        preLaunch = _preLaunch;
    }
    ...
    function acceptBId(
        ...
        uint256 rewards;
        if (preLaunch){
             rewards = RewardCalc(calcAddress).getRewardsP();
        }
        else{
            rewards = RewardCalc(calcAddress).getRewards();
        }
        ...
        if(IERC20(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6).allowance(salestruct.adress, address(this)) < salestruct.amount || IERC20(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6).balanceOf(salestruct.adress) < salestruct.amount){
        ...
        RoyaltyRegistry royReg = RoyaltyRegistry(0xD7c053A464594Be62FDBB2FC039c43DebCde4B12);
        (,,address royAddress, uint256 royPercentage) = royReg.getRoyaltyInfo(salestruct.conAddr);

        uint256 goldfees = salestruct.amount / 50 ;
        uint256 royalty = ( salestruct.amount * royPercentage ) / 1e20 ;
        uint256 netAmount = salestruct.amount - ( goldfees + royalty );
        
        IERC20(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6).transferFrom(salestruct.adress, 0xCFe30c202B4Dd77fC3B489cfC09Af9FEBb03Beb5, goldfees);
        IERC20(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6).transferFrom(salestruct.adress, msg.sender, netAmount);
        if (royalty > 0) {
            IERC20(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6).transferFrom(salestruct.adress, royAddress, royalty);
        }
        
        uint256 sellerRewards = (rewards * salestruct.amount)/1e18;
        uint256 buyerRewards = sellerRewards / 5;

        if (IERC20(0xD9D2a77508097de682406dD7B528881591e7bF36).balanceOf(address(this)) > (sellerRewards + buyerRewards)) {
            IERC20(0xD9D2a77508097de682406dD7B528881591e7bF36).transfer(salestruct.adress, buyerRewards);
        ...
        IERC20(0xD9D2a77508097de682406dD7B528881591e7bF36).transfer(msg.sender, totalSellerRewards);
    }
    ...
    function buyToken(
        ...
        for (uint256 i; i < seller.length;) {
            ...
            payable(0xCFe30c202B4Dd77fC3B489cfC09Af9FEBb03Beb5).transfer(goldfees);
            if (royalty > 0) {
            ...
            if (IERC20(0xD9D2a77508097de682406dD7B528881591e7bF36).balanceOf(address(this)) > (sellerRewards + buyerRewards)) {
            IERC20(0xD9D2a77508097de682406dD7B528881591e7bF36).transfer(salestruct.adress, sellerRewards);
        ...
        IERC20(0xD9D2a77508097de682406dD7B528881591e7bF36).transfer(msg.sender, totalBuyerRewards);
    }
    ...
    function resqueERC20(address _token, address _address, uint256 _amount)
        ...
        onlyOwner
    {
        require(_token != 0xD9D2a77508097de682406dD7B528881591e7bF36);
