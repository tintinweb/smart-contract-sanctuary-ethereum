...
contract DummyMintableERC20 is ERC20, AccessControlEnumerable, NativeMetaTransaction, ContextMixin, IMintableERC20 {
    bytes32 public constant PREDICATE_ROLE = keccak256("PREDICATE_ROLE");

    constructor(string memory _name, string memory _symbol, address _predicate) public ERC20(_name, _symbol) {
