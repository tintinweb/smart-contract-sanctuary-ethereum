...
contract NotDeployedHunter is DefaultOperatorFilterer, ERC721, Ownable, ReentrancyGuard, PaymentSplitter {
    ...
    address[] private _team = [
            0xADcE9Ba4523CEaaBAFE47df7020D6a84311d6439, // KSH
            0x41e535272bb9988f91AE90fEb63319A92FAE45CC  //  LGS
    ];
    ...
    constructor (string memory uri, bytes32 wlMerkleroot,bytes32 ogMerkleroot) 
        ERC721("Space","SPACE") PaymentSplitter(_team, _teamShares) ReentrancyGuard() 
        {
            root = wlMerkleroot;
            ogRoot = ogMerkleroot;
    ...
    // modifier veritySig(uint _nonce, bytes memory _signature) {
