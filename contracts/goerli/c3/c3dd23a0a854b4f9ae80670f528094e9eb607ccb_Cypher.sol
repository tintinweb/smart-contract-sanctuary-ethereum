...
contract Cypher {
  ...
  event   Register(address indexed usr);
  ...
  function register() public {
    require(balanceOf[msg.sender] >= 1e20);
    burnFrom(msg.sender, 1e20);
  ...
  function payload(string memory str) public payable returns (bool) {
    ...
    require(msg.value >= 0.01 ether, "Too poor");
  ...
  function trustload(string memory str) public returns (bool) {
    require(strlen(str) <= 280, "Too long");
    require(registers[msg.sender] == true, "Not registered");
