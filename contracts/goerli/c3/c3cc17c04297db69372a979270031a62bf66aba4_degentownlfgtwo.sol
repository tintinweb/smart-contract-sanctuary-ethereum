...
contract degentownlfgtwo is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint public          maxSupply         = 1445;
  uint public          maxfreeSupply     = 777;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("DegenTownLFGTwo", "DTLFG"){}

  function mintPaid(uint256 amt) external payable
  {
    uint cost = price;
    ...
    function mintFree(uint256 amt) external payable
  {
    require(msg.sender == tx.origin,"Be yourself, honey.");
