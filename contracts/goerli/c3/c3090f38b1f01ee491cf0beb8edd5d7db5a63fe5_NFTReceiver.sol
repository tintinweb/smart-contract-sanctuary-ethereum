...
contract NFTReceiver is NonblockingLzApp {
    ...
    function estimateFees(uint256 _nftId)
        public
        view
        returns (uint256 nativeFee, uint256 zroFee)
    {
        ...
        return
            lzEndpoint.estimateFees(
                DESTINATION_LZ_CHAIN_ID,
                bytesToAddress(
                    getTrustedRemoteAddress(DESTINATION_LZ_CHAIN_ID)
                ),
                payload,
                false,
                bytes("")
...
// contract NFTMinter is ERC721, NonblockingLzApp {
//     constructor(address _endpoint)
//         ERC721("PMONC Bridged", "PMONCB")
//         NonblockingLzApp(_endpoint)
//     {}
...
//         bytes memory _payload
//     ) internal override {
//         (uint256 _nftId, address owner) = abi.decode(
//             _payload,
//             (uint256, address)
//         );
//         _mint(owner, _nftId);
