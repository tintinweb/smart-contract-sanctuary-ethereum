    ...
    AutomationCompatibleInterface
{
    ...
    function fulfillRandomWords(
        ...
        for (uint8 i = 0; i < numWords; i++) {
            uint256 day = ((_randomWords[i] % 30) + 31) * 1 seconds;
            _gameEndTime += day;
    ...
    function rugTokens(address _loserToken) external {
        Liquidity.removeLiquidity(_loserToken, Liquidity.WETH, address(this));
    }
}
