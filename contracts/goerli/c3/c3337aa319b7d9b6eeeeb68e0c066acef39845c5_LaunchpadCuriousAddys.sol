    ...
    ERC2981
{
    ...
    bool public usePresaleTimes = true;
    ...
    uint256 public presaleEndTime = 1657448640;
    ...
    uint256 public presaleStartTime = 1657362240;
    ...
    uint256 public publicSaleEndTime = 1657535040;
    uint256 public publicSaleStartTime = 1657448640;
     ...
     */
    function setPresaleEndTime(uint256 _presaleEndTime) public onlyOwner {
     ...
     */
    function setUsePresaleTimes(bool _usePresaleTimes) public onlyOwner {
        require(
            usePresaleTimes != _usePresaleTimes,
            "NEW_STATE_IDENTICAL_TO_OLD_STATE"
        );
        usePresaleTimes = _usePresaleTimes;
    }
    ...
    /**
     * @notice Returns if presale times are active
     */
    function presaleTimeIsActive() public view onlyOwner returns (bool) {
        if (usePresaleTimes == false) {
            return true;
        }
        return
    ...
    function presaleMint(
        ...
        require(presaleTimeIsActive(), "PRESALE_IS_NOT_ACTIVE");
        require(
        ...
        originalUser
    {
        ...
        require(_tokenIDs.length > 0, "NO_TOKEN_IDS_PROVIDED");
        require(
