    ...
    Ownable
{
    ...
    uint256 public constant randomNumber = 0;
    ...
    uint256 public constant femaleStartIndex = 100;
    uint256 public constant robotStartIndex = 200;
    uint256 public constant collectionSupply = 299;
    ...
    function burnAndMint(
        ...
        if (typeOption == 0) {
            newTokenId = transformerKeyTokenId + femaleStartIndex;
        } else {
            require(typeOption == 1, "invalid typeOption argument");
            newTokenId = transformerKeyTokenId + robotStartIndex;
        }

        require(newTokenId <= collectionSupply, "tokenId too high");
