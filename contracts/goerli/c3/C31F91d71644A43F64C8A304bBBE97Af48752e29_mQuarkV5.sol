...
contract mQuarkV5 is ERC721, IERC721Receiver, IERC2981 {
  ...
  event NFTMinted(uint256 templateId, uint256 tokenId, address to);
  ...
  */
  ...
  function mint(
    ...
    emit NFTMinted(_templateId, _tokenId, _to);
  }
  ...
  function mintBatch(
    ...
    for (uint256 i; i < _mintParams._templateIds.length; i++) {
      ...
      for (uint256 ii; ii < _mintParams._amounts[i]; ii++) {
        ...
        emit NFTMinted(_mintParams._templateIds[i], _tokenId, _to);
      }
