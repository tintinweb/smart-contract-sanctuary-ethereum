...
/**
 * @title The Raffle contract
 * @notice A contract to determine winners of Illuvium Beta Raffle powered by Chainlink VRF
 */
contract Raffle is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    /**
     * @notice Runs Illuvium Beta Raffle.
    ...
    /**
     * @notice Draws additional winners if someone is unable to attend.
     *
     * @dev Only owner can call.
     *
     * No return, reverts on error.
     */
    function drawAdditionalWinners(
        uint32 numberOfAdditionalWinners
    ) external onlyOwner {
    ...
    /**
     * @notice Returns Illuvium Beta Raffle winners' keccak256 hashes of email addresses.
     *
     * @return Illuvium Beta Raffle winners
     */
    ...
    /**
     * @notice Helper function to calculate keccak256 hash of the email address
     *
     * @return hashed ticket confirmation number
     */
    function getHashedEmailAddress(
        string memory emailAddress
    ) external pure returns (bytes32) {
        return keccak256(abi.encodePacked(emailAddress));
    }
