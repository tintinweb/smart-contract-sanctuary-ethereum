...
contract GrumpyPacks is ERC721A, ERC721AQueryable, IERC721ABurnable, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(address admin, address minter) ERC721A("Testing", "Testing") {
        _admin = admin;
        _minter = minter;
