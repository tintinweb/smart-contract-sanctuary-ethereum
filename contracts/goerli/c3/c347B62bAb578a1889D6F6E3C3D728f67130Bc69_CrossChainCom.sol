    ...
    MessageReceiverApp
{
    ...
    function notifyDst(
        ...
        bytes memory _message = abi.encode(
            Request({nonce: nonce, sender: msg.sender, value: _value})
        );
    ...
    function executeMessage(
        ...
        userValue[message.sender] = message.value;
    ...
    function executeMessageWithTransferFallback(
        ...
        revert(
            "CrossChainCom: executeMessageWithTransferFallback not available"
        );
    }
    ...
    function executeMessageWithTransferRefund(
        ...
        revert("CrossChainCom: executeMessageWithTransferRefund not available");
    }

    function calcFee(uint256 _value) external view returns (uint256) {
