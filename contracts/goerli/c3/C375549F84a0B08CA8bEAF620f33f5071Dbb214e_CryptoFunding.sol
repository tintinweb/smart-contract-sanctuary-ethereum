...
contract CryptoFunding is ERC721A, Ownable {
    ...
    function minterMint(
        ...
        (bool success, ) = payeeAddress.call{value: msg.value}("");
...
contract ERC721A is IERC721A {
    ...
    function approve(address to, uint256 tokenId) public payable virtual override {
        require(_soulboundToken == false, "SBTs can't be sold or transferred");
    ...
    function setSoulboundToken(bool sbt) public virtual {
        _soulboundToken = sbt;
    }
}
