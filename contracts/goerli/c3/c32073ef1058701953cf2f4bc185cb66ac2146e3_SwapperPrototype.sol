...
contract SwapperPrototype is Ownable {
    ...
    */
    ...
    function dataDecode_e449022e(
        bytes calldata data
    ) external view returns(uint256 _a, uint256 _b, uint256[] memory _c) {
    ...
    function dataDecode_2e95b6c8(
        bytes calldata data
    ) external view returns(address _a, uint256 _b, uint256 _c, bytes32[] memory _d) {
    ...
    function dataDecode_d0a3b665(
        bytes calldata data
    ) external view returns(OrderRFQ memory _a, bytes memory _b, uint256 _c, uint256 _d) {
    ...
    function dataDecode_b0431182(
        bytes calldata data
    ) external view returns(address _a, address _b, uint256 _c, uint256 _d) {
