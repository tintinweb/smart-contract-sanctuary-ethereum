 ...
 * @dev Uses OpenZeppelin's v3 Counters library to keep track of the tokenIds.
 * @dev Uses a mint deadline and mint price that can be modified by the owner of the contract upon deployment.
 */
...
contract Paradice is ERC721 {
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        ...
        string memory name = string(abi.encodePacked('Roll #',SVGUtils.uint2str(id)));
