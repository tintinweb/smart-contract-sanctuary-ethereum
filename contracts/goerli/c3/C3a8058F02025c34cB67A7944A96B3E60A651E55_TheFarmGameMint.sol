...
contract TheFarmGameMint is Ownable, ERC165Storage, ReentrancyGuard, Pausable {
  ...
  // Allow List
  uint256 public allowListTime = 1666108800; // Thursday, October 18, 2022 4:00 PM UTC / 12:00 PM EST
  ...
  // Public Sale Gen 0
  uint256 public publicTime = 1666112400; // Thursday, October 18, 2022 5:00 PM UTC / 1:00 PM EST
  uint256 public publicFee = 0.049 ether;
  uint256 public publicStakeFee = 0.035 ether;
  uint256 public publicMaxPerTx = 5;

  // HACK: LOCAL DEV This should be set to 50
  uint256 public teamMintEvery = 5; // Auto mints Gen0 token to team every X
