...
// File: contracts/BoredTrumpApeClubNFT.sol
...
contract BoredTrumpApeClubNFT is ERC721A, Ownable, ERC2981,OperatorFilterer{
    using SafeMath for uint256;
    using Strings for uint256;
  
    uint256 public constant MAX_SUPPLY = 4545;
    ...
    function mint(uint256 _quantity) public payable {
        require(publicSale, "BoredTrumpApeClub :: Not Yet Active.");
        require((totalSupply() + _quantity) <= MAX_SUPPLY, "BoredTrumpApeClub :: Beyond Max Supply");
        require((totalPublicMint[msg.sender] +_quantity) <= MAX_PUBLIC_MINT, "BoredTrumpApeClub :: Already minted max number!");
        require(msg.value >= (PUBLIC_SALE_PRICE * _quantity), "BoredTrumpApeClub :: Payment is below the price");
