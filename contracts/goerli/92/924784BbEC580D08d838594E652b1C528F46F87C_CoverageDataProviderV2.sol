...
contract CoverageDataProviderV2 is ICoverageDataProviderV2, Governable, ReentrancyGuard, MessageSenderApp, MessageReceiverApp {
    ...
    */
    ...
    /**
     * @notice Sets multichain status of the contract.
     * @param status True if multichain is activated.
    */
    function setMultichainStatus(bool status) external override onlyGovernance {
      multichain = status;
      emit MultichainStatusUpdated(status);
    }
}
...
interface ICoverageDataProviderV2 {
    ...
    ***************************************/
    ...
    /// @notice Emitted when cross-chain is activated.
    event MultichainStatusUpdated(bool status);
    ...
    */
     ...
     * @param status True if multichain is activated.
    */
    function setMultichainStatus(bool status) external;
}
