...
contract ProtonStaking is SMAuth, ReentrancyGuard  {
    ...
    function addStakes(address owner, uint256 amount, uint256 st, uint256 et, uint256 m, bool collected, uint256 claimed) public {
        userstakes[owner]++;
