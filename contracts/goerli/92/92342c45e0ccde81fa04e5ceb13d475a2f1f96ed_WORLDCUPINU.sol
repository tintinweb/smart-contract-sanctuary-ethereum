...
contract WORLDCUPINU is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "WORLD CUP INU";
    string constant _symbol = "WCI";
    ...
    address payable public liquidityFeeReceiver = payable(0x6FB8Efee44784af8a0d1fb32811ef417471A5416);
    address payable public marketingFeeReceiver = payable(0x6FB8Efee44784af8a0d1fb32811ef417471A5416);
