 ...
 * @notice This contract handles minting Crazzy Ben tokens.
 */
contract CrazzyBen is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0x774B716ee5176f7f4eE429F62F688e0AC2e6d504;
    ...
    string public baseTokenURI =
        "ipfs://bafybeidjv6gkmcoksh2zbvwkvemzohxcibfcznxehev4vdlhyvjjnuyofa/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 40;
    ...
    uint96 public royaltyFee = 800;

    constructor(address _blocklistContractAddress)
        ERC721A("Crazzy Ben", "CRB")
    {
