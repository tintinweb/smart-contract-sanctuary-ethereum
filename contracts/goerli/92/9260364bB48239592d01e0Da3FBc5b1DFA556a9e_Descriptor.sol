...
contract Descriptor is Ownable {
    ...
    string public description =
        "OPP. Personalized Opepen with colors generated from the owner's wallet address.";
    ...
    function getTokenIdSvg(
        ...
        return
            string(
                abi.encodePacked(
                    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="2000" height="2000" shape-rendering="geometricPrecision">',
                    ...
                    '<path fill="#000" d="M50 37.5c0 6.885 5.604 12.465 12.518 12.465V37.5H50Z"/>',
                    '<path fill="#fff" d="M50.018 37.5c0 6.914-5.604 12.518-12.518 12.518V37.5h12.518Z"/>',
                    '<path fill="#000" d="M25 37.5c0 6.914 5.604 12.518 12.518 12.518V37.5H25Z"/>',
                    '<path fill="#000" d="M75 25.93a.999.999 0 1 0 0-1.998.999.999 0 0 0 0 1.997Z"/>',
                    '<path fill="#fff" d="M75.018 37.5c0 6.914-5.605 12.518-12.518 12.518V37.5h12.518Z"/>',
                    '<path fill="',
                    colorPalette[0],
