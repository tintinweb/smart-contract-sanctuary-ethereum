  ...
  UUPSUpgradeable
{
  ...
  function initialize() public initializer {
    __ERC721_init("3GATE Subdomains", "3GSUB");
    __Ownable_init();
  ...
  function renew(uint256 id, uint256 duration) external live returns (uint256) {
    require(expiries[id] >= block.timestamp); // Name must be registered here or in grace period
