...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xD41c2CAdC3De324370Dca455c5c54d3CCE76311d];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xD41c2CAdC3De324370Dca455c5c54d3CCE76311d;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 25;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmT6RGDEqJdnGPAGWt7F1mLd3YSegHKjZXMCq73hDd2uUm/";
...
// File: contracts/WonderEyesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WonderEyesContract is RamppERC721A {
    constructor() RamppERC721A("wonderEyes", "WEYE"){}
}
