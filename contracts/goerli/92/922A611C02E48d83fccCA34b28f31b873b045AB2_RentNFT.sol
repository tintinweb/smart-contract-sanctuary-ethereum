...
contract RentNFT is IERC721Receiver, AccessControl {
    ...
    event rentCommisionEvent(uint256 rentCommision);

    event buySellCommisionEvent(uint256 buySellCommision);
    ...
    function changeRentCommision(uint256 _rentCommision) external onlyOwner {
        ...
        emit rentCommisionEvent(_rentCommision);
    }
        ...
        onlyOwner
    {
        ...
        emit buySellCommisionEvent(_buySellCommision);
    }
}
