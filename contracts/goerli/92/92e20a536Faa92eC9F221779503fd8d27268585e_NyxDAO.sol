...
contract NyxDAO is Ownable {
    ...
    mapping(address => mapping(uint256 => uint8)) representativeRights;
    ...
    function setProposalCreatorContract(address addr)
        public
    {
