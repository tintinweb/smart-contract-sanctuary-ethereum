...
contract GCCombinedSwap is ReentrancyGuard, Ownable {
    ...
    uint256 public USDM2USDTExchangeRate; //USDM-USDT conversion rate
    ...
    uint8 public feesGCS2USDM = 6;
    uint8 public feesXAUS2USDT = 6;
    ...
    */
    ...
    /* 
        Swap 1 - XAUS=USDT pair
        XAUS: 0x50ea0dfFE399A706EdC310f55c658e8B0eC27981
        USDM: 0x55d398326f99059fF775485246999027B3197955
