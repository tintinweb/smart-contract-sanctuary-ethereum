...
abstract contract Defaults {
    ...
    string constant _name = "KRToken_Eth";
    ...
    uint256 public buyFee = 1 wei;
    uint256 public buyTotalFee = buyFee;
    uint256 public swapLpFee = 3 wei;
    uint256 public swapMarketing = 1 wei;
    uint256 public swapTreasuryFee = 1 wei;
    uint256 public swapTotalFee = swapMarketing + swapLpFee + swapTreasuryFee;
    uint256 public transFee = 5 wei;
...
contract KRToken_Eth is Defaults, IERC20, Ownable {
    ...
    constructor() {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D //this is the address of uniswap v2 router
        ); //Mainnet & Testnet ETH
