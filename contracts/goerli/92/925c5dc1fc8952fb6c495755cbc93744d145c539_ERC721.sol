...
contract ERC721 {
    ...
    function _setTokenURI(uint256 _tokenId) isTokenValid(_tokenId) internal {
        string memory baseURI = "https://gateway.pinata.cloud/ipfs/QmUasGP4PhWAmHxjKr57JsY7wG6XzTffai1U58rtxsFKcY/";
        string memory uri = string(abi.encodePacked(baseURI, toString(_tokenId)));
        tokenURIs[_tokenId] = string(abi.encodePacked(uri, ".jpg"));
    }
