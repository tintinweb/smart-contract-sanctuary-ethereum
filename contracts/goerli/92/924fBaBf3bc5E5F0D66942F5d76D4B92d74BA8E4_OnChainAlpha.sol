...
contract OnChainAlpha is ERC721A, IERC721Receiver, ReentrancyGuard, Ownable {
    ...
    function batchSetProfile(
        uint256 _tokenId,
        bool[] memory _layerStates,
        bool _flipped,
        ...
        toggleLayers(_tokenId, _layerStates);
        togglePhlipPFP(_tokenId, _flipped);
        setBgColor(_tokenId, _bgColor);
        setProfile(_tokenId, _username, _social, _website);
    }
}