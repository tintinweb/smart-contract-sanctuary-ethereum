...
contract ABC is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 21000000 * 10**9; // Totaly Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _redisFeeOnBuy = 0;  
    uint256 private _taxFeeOnBuy = 4;   // Buy Tax
    uint256 private _redisFeeOnSell = 0;  
    uint256 private _taxFeeOnSell = 15; // Sale Tax
    ...
    address payable private _developmentAddress = payable(0x83617E899E1C13E5cE70751d68aAB8c5b94753ae); 
    address payable private _marketingAddress = payable(0x83617E899E1C13E5cE70751d68aAB8c5b94753ae);
    ...
    function setBots(address blacklisted) public onlyOwner {
        bots[blacklisted] = true;
    }

    function unsetBots(address unblacklisted) public onlyOwner {
        bots[unblacklisted] = false;
    }
