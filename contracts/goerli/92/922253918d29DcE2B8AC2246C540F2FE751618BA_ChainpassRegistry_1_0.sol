...
contract ChainpassRegistry_1_0 is Ownable {
    ...
    address public chainpassEventFactoryContractAddress;
    address public chainpassTicketsBaseContractAddress;
    address public usdcContractAddress;
    address public chainpassWallet = owner();
    address public chainpassMarketplaceContractAddress;
    ...
    function getChainpassEventFactoryContractAddress() public view returns (address) {
        return chainpassEventFactoryContractAddress;
    }

    function setChainpassEventFactoryContractAddress(address addr) external onlyOwner {
        chainpassEventFactoryContractAddress = addr;
    }

    function getChainpassTicketsBaseContractAddress() public view returns (address) {
        return chainpassTicketsBaseContractAddress;
    }

    function setChainpassTicketsBaseContractAddress(address addr) external onlyOwner {
        chainpassTicketsBaseContractAddress = addr;
    }
    ...
    function getChainpassDefaultPrimaryBPS() public pure returns (uint256) {
        return 2_000;
    }
    ...
    function setChainpassWallet(address addr) external onlyOwner {
        ...
        return chainpassMarketplaceContractAddress;
    }

    function setChainpassMarketplaceContractAddress(address addr) external onlyOwner {
        chainpassMarketplaceContractAddress = addr;
    }
}
