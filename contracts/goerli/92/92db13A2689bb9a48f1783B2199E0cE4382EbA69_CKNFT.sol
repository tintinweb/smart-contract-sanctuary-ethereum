...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    uint256 public max_mint_wl = 50;
    uint256 public MAX_AL_MINT = 50;   
    ...
    constructor()
        ERC1155(
            "https://gateway.pinata.cloud/ipfs/QmPouGJoDQRREQknX1rNqwtXC1beJRQpLHeh43YkGKcqZg/{id}.json"
        )
    {
        ...
        nonReentrant
    {
        ...
        require(
            ...
            "Only 50 Nfts by allowlists address."
        );
        require(_id < MAX_TOKEN_ID_PLUS_ONE, "id must be < 2");
