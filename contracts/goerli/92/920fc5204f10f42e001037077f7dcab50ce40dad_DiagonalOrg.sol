...
abstract contract Base is IBase {
     ...
     */
    address public constant DIAGONAL_ADMIN = 0x9635b7b739caBB2917BeF65aE4E90E3D148C3d9a;
    ...
    function isBot(address bot) public pure returns (bool) {
        if (bot == 0xBF9fda529C38e8109c3B0649DC6693FfD82d0e65 || bot == 0xb6d1C15af4C88E3d0fa80dF1C53283cd8941F9ae)
            return true;
