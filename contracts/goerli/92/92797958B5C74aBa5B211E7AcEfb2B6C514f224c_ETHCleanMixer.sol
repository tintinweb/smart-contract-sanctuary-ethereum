...
contract ETHCleanMixer is CleanMixer {
    ...
    function _processDeposit(address _referrer) internal override {
        ...
        twoLevelReferral.payReferral(msg.sender, _referrer, denomination);
    }
...
interface ITwoLevelReferral {
    function payReferral(address _depositor, address _referrerAddress, uint256 _denomination) external;

    function getTotalFee() external view returns (uint8);
