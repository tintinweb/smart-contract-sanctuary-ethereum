...
contract EPT is ERC721, Ownable {
    ...
    function waterPlant (uint256 tokenId) external {
        ...
        require(watertime[tokenId] == 0 || block.timestamp - lastwatertime[tokenId] > 450, "only once a week");//7.5min
        require(watertime[tokenId] == 0 || block.timestamp - lastwatertime[tokenId] < 900, "dead! Not growing anmore");//15min
