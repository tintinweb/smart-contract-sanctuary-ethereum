    ...
    Pausable
{
        ...
        whenNotPaused
    {
        ...
        ekigori.mint(msg.sender, _mintAmount);
    }
    ...
    {   
        ...
        ekigori.mint(_airdropAddress, _mintAmount);
    }
    ...
    function setEkigori(address value)
        external
        onlyRole(ADMIN)
    {
        ekigori = IEkigoriTest(value);
    }
    ...
    function cnpmTotalSupply()
        ...
        returns (uint256)
    {
        if(address(ekigori) == address(0)) revert ZeroAddress();
        return ekigori.ekigoriTotalSupply();
    }
...
interface IEkigoriTest {
    ...
    function ekigoriTotalSupply() external view returns (uint256);
}
