...
contract DEX {
     ...
     */
    event EthToTokenSwap(address sender, string conversion, uint256 value, uint256 tokenOutput);

    /**
     * @notice Emitted when tokenToEth() swap transacted
     */
    event TokenToEthSwap(
        address sender, string conversion, uint256 ethOutput, uint256 tokenInput
    );
