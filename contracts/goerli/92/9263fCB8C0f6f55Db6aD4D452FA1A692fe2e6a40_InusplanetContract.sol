...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x07BF13B3fcfd66414b63b51d5A422Cf1ec85F765];
  address public erc20Payable = 0x07BF13B3fcfd66414b63b51d5A422Cf1ec85F765;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeif5eba2b7lhvi5hbsg5ncbnfowhgopywxgcvn7dvhowl63uixptsi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XewDh9aiYWFtebtg79qy/contract-metadata";
  }
...
// File: contracts/InusplanetContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract InusplanetContract is RamppERC721A {
    constructor() RamppERC721A("INUS PLANET", "PLANET"){}
}