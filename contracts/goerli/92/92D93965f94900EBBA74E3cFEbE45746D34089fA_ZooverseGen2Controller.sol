...
contract ZooverseGen2Controller is BaseMint {
    ...
    constructor() {
        // claim
        sales[1] = Sale(genesisLimit, 1, 0xc0a34e4c7ab9506068902d9a31b661c3c61b4b94b498c5e924ffd2e4f16457e0);
        // diamondhand
        sales[2] = Sale(genesisLimit + 1, 1, 0x7db559ab8f46a782f332733d297a884fa8383eea7c9fb4af12226ebadcf04c11);
        // genesis
        sales[3] = Sale(genesisLimit, 1, 0xe8f0bb03e23892b17e302de04a7ff7d2e8ce207b4ae5f35b95e9e749c8c2971a);
        // whitelist
        sales[4] = Sale(1, 1, 0x92d04129f03a7e373e3a6c6867d3a3804cdf0f093f68ec936da83b9dbf31f62c); 
        sales[5] = Sale(1, 2, "");
        _lastSaleType = 5;
    }
