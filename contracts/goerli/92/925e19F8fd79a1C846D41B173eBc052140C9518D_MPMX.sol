...
{    
    ...
    {
        uint _AmountPurchasedMintPass;     // [0] -> _AmountPurchasedMintPass
        uint _AmountPurchasedMintPack;     // [1] -> _AmountPurchasedMintPack
        uint _AllocationMintPass;          // [2] -> _AllocationMintPass
        uint _AllocationMintPack;          // [3] -> _AllocationMintPack
        uint _RemainingToPurchaseMintPass; // [4] -> _RemainingToPurchaseMintPass
        uint _RemainingToPurchaseMintPack; // [5] -> _RemainingToPurchaseMintPack
        bool _EligibleMintPass;            // [6] -> _EligibleMintPass
        bool _EligibleMintPack;            // [7] -> _EligibleMintPack
    }
    ...
    function ViewWalletSaleInformation(
        ...
        UserInformation memory Info = UserInformation(
            _WalletAllocationMintPass, 
            _WalletAllocationMintPack,
            _MintPassPurchasedAmt[Wallet],
            _MintPackPurchasedAmt[Wallet],
            _WalletAllocationMintPass - _MintPassPurchasedAmt[Wallet],
            _WalletAllocationMintPack - _MintPackPurchasedAmt[Wallet],
