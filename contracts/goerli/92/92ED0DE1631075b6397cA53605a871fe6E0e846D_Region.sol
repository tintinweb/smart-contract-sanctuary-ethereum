...
contract Region is ERC721, AccessControl, ERC721Enumerable {
    ...
    function safeMint(address to, string calldata name) public onlyRole(MAINTAINER_ROLE) returns (uint256) {
    ...
    function levelUpBuilding(uint256 tokenId, string calldata buildingName) public onlyRole(EXPLORER_ROLE) {
    ...
    function setMetaDataBaseUrl(string calldata baseUrl) external onlyRole(MAINTAINER_ROLE) {
    ...
    function addBuilding(
        ...
        require(!buildings[regionId][buildingName].initialized, "Building already initialized");
    ...
    function addAction(
        ...
        require(regionId < totalSupply(), "Region doesn't exist");
        require(buildings[regionId][buildingName].initialized, "Building not initialized");

        buildings[regionId][buildingName].actions.push(actionName);
    }

    function disableBuilding(uint256 regionId, string memory buildingName) public onlyRole(MAINTAINER_ROLE) {
        require(regionId < totalSupply(), "Region doesn't exist");
        require(buildings[regionId][buildingName].initialized, "Building isn't initialized");
    ...
    function getBuildingNames(uint256 regionId) public view returns (string[] memory) {
        require(regionId < totalSupply(), "Region doesn't exist");
        return buildingNames[regionId];
    }

    function getBuildingActions(uint256 regionId, string memory buildingName) public view returns (string[] memory) {
        require(regionId < totalSupply(), "Region doesn't exist");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(_metaDataBaseUrl).length > 0 ? string(abi.encodePacked(_metaDataBaseUrl, tokenId.toString(), ".json")) : "";
    }
