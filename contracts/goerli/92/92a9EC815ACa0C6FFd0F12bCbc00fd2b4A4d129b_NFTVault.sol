...
// File contracts/clink/IERC20BurnMintable.sol
...
// File contracts/nft-collateral/interfaces/IPriceHelper.sol
...
// File contracts/nft-collateral/interfaces/IInitialization.sol
...
// File contracts/nft-collateral/NFTVault.sol
...
contract NFTVault is Ownable, ReentrancyGuard, IInitialization, Multicall {
    ...
    function init(bytes calldata data) public payable override {
        ...
        ) = abi.decode(data, (VaultSettings, IERC721, IPriceHelper));
        ...
        returns (PositionPreview memory preview)
    {
        ...
        unchecked {
            preview = PositionPreview({
                ...
                liquidatable: debtAmount >= _getLiquidationLimit(_nftIndex) //if the position can be liquidated
            });
        }
    }
    ...
    function borrow(uint256 _nftIndex, uint256 _amount)
        external
        validNFTIndex(_nftIndex)
        nonReentrant
    {
        ...
        nonReentrant
    {
        ...
        IERC20BurnMintable(clink).burnFrom(msg.sender, _amount);
        ...
        nonReentrant
    {
        ...
        // burn all payment
        IERC20BurnMintable(clink).burnFrom(msg.sender, debtAmount);
    ...
    function collect() external nonReentrant {
        ...
        accrue();
        IERC20BurnMintable(clink).mint(_feeTo, totalFeeCollected);
        totalFeeCollected = 0;
    }
