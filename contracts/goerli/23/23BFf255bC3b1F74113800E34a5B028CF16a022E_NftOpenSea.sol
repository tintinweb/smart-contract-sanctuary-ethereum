...
contract NftOpenSea is ERC721A, Ownable, DefaultOperatorFilterer, ERC2981 {
    ...
    constructor(string memory _collectionName, string memory _collectionSymbol, uint256 _collection_size, string memory _baseURI, string memory _contractURI, uint96 _royalties) ERC721A(_collectionName, _collectionSymbol) {
        collection_size = _collection_size;
        baseURI = _baseURI;
        osContractURI = _contractURI;
        _setDefaultRoyalty(msg.sender, _royalties);
    }
