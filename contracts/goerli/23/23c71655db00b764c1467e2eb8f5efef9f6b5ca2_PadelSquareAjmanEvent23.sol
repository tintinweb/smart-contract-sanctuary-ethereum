...
contract PadelSquareAjmanEvent23 is ERC721, ERC2981, OperatorFilterer, Ownable {
    ...
    constructor() ERC721("Padel Square Club Ajman Event 23", "PSCAE") {
    ...
    /// @dev Checks thich NFT to mint and mints the next one of that to the wallet
    /// @param _address The wallet for whome to mint the NFTs
