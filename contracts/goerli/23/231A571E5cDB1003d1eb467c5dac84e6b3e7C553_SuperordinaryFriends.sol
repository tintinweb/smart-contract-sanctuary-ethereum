...
contract SuperordinaryFriends is ERC1155, ERC1155Supply, DefaultOperatorFilterer, Ownable {
    ...
    constructor(string memory _name, string memory _symbol) ERC1155("https://bafybeihfh26mydnan34nahafkr7gdasizpb3ki3qbenodcyt52p4x3n27q.ipfs.nftstorage.link") {
        name = _name;
        symbol = _symbol;
        _mint(msg.sender, SF_TOKEN, 1, "");
    }
