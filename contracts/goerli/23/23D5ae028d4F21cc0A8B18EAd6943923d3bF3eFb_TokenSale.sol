...
contract TokenSale is Ownable, ReentrancyGuard {
    ...
    uint128 public constant CLAIM_PERIOD = 10 minutes;

    uint256 public tokensPerWeiPublic;

    uint256 public constant MAX_TIER1_CONTRIBUTIONS = 1 ether;
    uint256 public constant MAX_TIER2_CUMULATIVE_CONTRIBUTIONS = MAX_TIER1_CONTRIBUTIONS + 1 ether;
    uint256 public constant MAX_RAISE = MAX_TIER2_CUMULATIVE_CONTRIBUTIONS + 1 ether;

    // uint256 public constant MAX_TIER1_CONTRIBUTIONS = 10000000000000000 wei;
    // uint256 public constant MAX_TIER2_CUMULATIVE_CONTRIBUTIONS = MAX_TIER1_CONTRIBUTIONS + 10000000000000000 wei;
    // uint256 public constant MAX_RAISE = MAX_TIER2_CUMULATIVE_CONTRIBUTIONS + 110000000000000000 wei;
