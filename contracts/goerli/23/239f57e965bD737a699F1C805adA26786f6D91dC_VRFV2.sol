...
contract VRFV2 is VRFConsumerBaseV2 {
    ...
    event VRFFulfilled(uint256[] randNums);
     ...
     */
    constructor(uint64 subscriptionId, address indexContract)
    ...
    function rollDice(uint256 num_req, address to) public returns (uint256) {
        ...
        callbackGasLimit = 40000 * num_req + 200000;
