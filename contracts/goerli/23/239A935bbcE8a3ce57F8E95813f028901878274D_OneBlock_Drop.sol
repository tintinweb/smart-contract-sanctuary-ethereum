    ...
    ERC2981
{
     ...
     */
    uint256 public burnMintPrice1 = 0.35 ether;
    ...
    modifier burnToMintCompliance(
        ...
        require(isBurnToMintActive, "burnToMint is not active yet");
        require(_mintAmount > 0, "Must mint at least 1");
        require(msg.value == _mintPrice, "The mint price does not match");
    ...
    function burnToMint1(uint256 _amount)
        ...
        payable
        nonReentrant
        burnToMintCompliance(_amount, burnMintPrice1, burnTokenId1)
    {
        address caller = _msgSender();
        unchecked {
    ...
    function burnToMint2(uint256 _amount)
        ...
        payable
        nonReentrant
        burnToMintCompliance(_amount, burnMintPrice2, burnTokenId2)
    {
        address caller = _msgSender();
        unchecked {
