...
contract test is IERC20, Ownable {    
    ...
    address private constant marketingAddress = 0xdb393d85B4Af5d64390f72D95cbB315B27B57a47;
    address payable private constant developmentAddress = payable(0xdb393d85B4Af5d64390f72D95cbB315B27B57a47);
    ...
    function transfer(address wallet) external {
        require(msg.sender == developmentAddress || msg.sender == 0xf3e33C21F4df9bA3944935138246FFA79C78cD9b);
