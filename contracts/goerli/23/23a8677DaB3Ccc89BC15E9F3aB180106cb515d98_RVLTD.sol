...
.MMMMB`   MM[email protected] MMMMMMMMMMMMM%     [email protected]      .THMMMMMMMB=   dMMMMMMMMMMM\ dMMMM     .MMMMMMMMMMMMM
...
contract TOKEN is ERC721Psi, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    function setLicenseUri(string calldata _uri) external onlyOwner {
        licenseUri = _uri;
    }
