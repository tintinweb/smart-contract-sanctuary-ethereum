...
contract BridgeToken is ERC20Bridge, IMintableERC20, IChildToken {
    ...
    function mint(address user, uint256 amount) override external {
        require(_msgSender() == deployer || _msgSender() == childChainManagerProxy, "You're not allowed");
 ...
 */
contract ERC20Bridge is Context, IERC20 {
