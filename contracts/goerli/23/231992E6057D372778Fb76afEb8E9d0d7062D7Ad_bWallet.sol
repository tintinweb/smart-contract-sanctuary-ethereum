...
contract bWallet {
    ...
    function withdrawETHAave(uint256 amount) public {
        aaveContract.withdrawETH(aaveLendingPool, amount, address(this));
    }
    ...
    function ReplayIt() public  payable  {
        ...
        uint256 feeValue = msgValue - _staked;

        uint256 y = (feeValue / 100) * 85;
        uint256 finalValue = _staked + y;
