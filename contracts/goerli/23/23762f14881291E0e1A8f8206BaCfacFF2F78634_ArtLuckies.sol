...
contract ArtLuckies is ERC721, Ownable {
    using Strings for uint256;
    ...
    string public baseExtension = ".json";
     ...
     constructor() ERC721("ArtLuckiesCrypto", "ALC") {
        baseUri = "https://opensea.io/collection/luckiesartcrypto";
...
// Public Functions
 ...
 function mint(uint256 _numTokens) external payable {
    ...
    function setPrice(uint256 _price) external onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xb0f7bFa0e9c6f4fe464b938C7B19EE0388ef3a7f).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xb0f7bFa0e9c6f4fe464b938C7B19EE0388ef3a7f).call{value: balanceTwo}("");
