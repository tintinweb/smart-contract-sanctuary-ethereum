...
contract EZNFT is ERC721Enumerable, AccessControlEnumerable, Ownable {
    bytes32 private constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string  private _baseTokenURI;
    uint256 private _currentID = 1;
    bool    public  _open;
    constructor() ERC721("EZNFT", "EZNFT") {
    ...
    function setwitch(bool _flag) public onlyOwner {
        _open = _flag;
    }
    ...
    function tokenURI(uint256 _tokenId) override(ERC721) public view returns (string memory) {
        ...
        return _open?super.tokenURI(_tokenId):super.tokenURI(0);
    }

    function mint(address to) public onlyMintRole  returns (uint256) {
    ...
    function grantRoleMinter(address minter) public onlyOwner {
        _grantRole(MINTER_ROLE, minter);
    }

    function revokeRoleMinter(address minter) public onlyOwner {
    ...
    function _beforeTokenTransfer(
        ...
        if (_open) {
            require(from == address(0), "inoperable");
        }
        super._beforeTokenTransfer(from, to, tokenId);
    }
