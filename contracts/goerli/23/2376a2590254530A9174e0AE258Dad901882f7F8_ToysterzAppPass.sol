...
contract ToysterzAppPass is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public presaleMaxPerWallet = 9;
    ...
    address[] public withdrawAddresses = [0x3D9B994D19952082CfA2CE67AB2e37a05fF8D312, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xe81f17e68a437caf5b7a09a01c48eca573116b02c5984b27cd3458ff6c525423;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x3D9B994D19952082CfA2CE67AB2e37a05fF8D312, _royaltyAmount);
    }
