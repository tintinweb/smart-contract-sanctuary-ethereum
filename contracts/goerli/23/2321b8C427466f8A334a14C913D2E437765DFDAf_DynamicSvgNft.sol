...
contract DynamicSvgNft is ERC721 {
    ...
    //mint
    //store svg info
    //logic show X image or Y image --> aka we call chainlink
    constructor(
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        require(_exists(_tokenId), "URI Query for nonexistent toke");
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                name(),
                                '", "description":"Nft that changes based on the eth used price", "attributes":[{"trait_type": "coolness", "value":100, "highValue":',
                                s_tokenIdToHighValue[_tokenId],
                                '}], "image":"',
                                imageURI,
                                '"}'
                            )
