...
contract StakingPoolAirdrop is Context, Ownable, ReentrancyGuard {
    ...
    uint256 interval = 360; //TODO change!!!
    ...
    constructor (
        ...
        require(_reward > 0, "Staking Pool: amount of reward must be positive");
        reward = _reward;
    }
        ...
        returns (bool)
    {
        ...
        require((totalSupply - reward) >= 0, "Staking Pool: no more NFTs left");
