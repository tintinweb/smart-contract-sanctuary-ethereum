...
contract LoanCalculator is TermData {
    ...
    function getUserInterest(OfferTerm memory _offer)
        external
        view
        returns (uint256)
    {
        return _getUserInterest(_offer);
    }

    function getAdminFee(OfferTerm memory _offer)
        external
        view
        returns (uint256)
    {
        return _getAdminFee(_offer);
    }

    function getTotalRepayAmount(OfferTerm memory _offer)
        external
        view
        returns (uint256)
    {
        return _getUserInterest(_offer) + _getAdminFee(_offer);
    }
    ...
    function _getUserInterest(OfferTerm memory _offer)
        internal
        view
        returns (uint256)
    {
    ...
    function _getAdminFee(OfferTerm memory _offer)
        internal
        view
        returns (uint256)
    {
