...
contract Mah is ERC721Enumerable, Ownable {
    ...
    function setDescriptor(IMahDecode newDescriptor) external onlyOwner {
        descriptor = newDescriptor;
    }
