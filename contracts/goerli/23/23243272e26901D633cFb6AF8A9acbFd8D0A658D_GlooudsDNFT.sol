...
contract GlooudsDNFT is Ownable, Pausable, ERC1155Supply, ERC1155Permit {
    ...
    constructor(
        ...
        string memory _uri,
        string memory _uriPost,
        address _controller
    ) ERC1155Permit(_name, _symbol, _uri) {
        controller = _controller;
        baseURIpost = _uriPost;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused(), "Gloouds dNFT: token transfer while paused");
    }
        ...
        returns (string memory)
    {
        ...
        return
            bytes(baseURI).length > 0
                ? string(abi.encodePacked(baseURI, Strings.toString(tokenId), baseURIpost))
                : "";
    }
    ...
    function mint(
        ...
        require(
            ...
            "ERC1155: only owner or controller"
        );
     ...
     */
    function setURI(string memory _uri, string memory _uriPost) public onlyOwner {
        _setURI(_uri);
        baseURIpost = _uriPost;
    }
