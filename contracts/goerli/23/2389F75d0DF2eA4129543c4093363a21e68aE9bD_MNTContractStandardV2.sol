...
contract MNTContractStandardV2 is ERC721PresetMinterPauserAutoIdUpgradeable , OwnableUpgradeable{
    ...
    function mntCreate(
        ...
        super.initialize(_nftName, _nftSymbol, _baseUrl);
        __Ownable_init();
    ...
    internal
    whenNotPaused
    virtual override(ERC721PresetMinterPauserAutoIdUpgradeable)
    {
    ...
    public
    view
    override(ERC721PresetMinterPauserAutoIdUpgradeable)
    returns (bool)
    {
