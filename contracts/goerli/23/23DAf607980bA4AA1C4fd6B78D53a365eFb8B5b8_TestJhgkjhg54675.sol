...
// _               _       _  _             _       _  _              ____   _  _     __    _____  ____  
//| |_   ___  ___ | |_    (_)| |__    __ _ | | __  (_)| |__    __ _  | ___| | || |   / /_  |___  || ___| 
//| __| / _ \/ __|| __|   | || '_ \  / _` || |/ /  | || '_ \  / _` | |___ \ | || |_ | '_ \    / / |___ \ 
//| |_ |  __/\__ \| |_    | || | | || (_| ||   <   | || | | || (_| |  ___) ||__   _|| (_) |  / /   ___) |
// \__| \___||___/ \__|  _/ ||_| |_| \__, ||_|\_\ _/ ||_| |_| \__, | |____/    |_|   \___/  /_/   |____/ 
//                      |__/         |___/       |__/         |___/
//
...
contract TestJhgkjhg54675 is ERC721A, Ownable, ReentrancyGuard, IERC2981 {
    using ECDSA for bytes32;
	using Strings for uint256;
    using SafeERC20 for IERC20;

	string private _baseTokenURI = "https://metadata.nftify-dev.aegas.it/857/metadata/";
	string private _contractURI = "https://nftify-dev-public-bucket.s3.us-east-2.amazonaws.com/857/contract-uri";

    address public tokenfyAddress = 0xAba2e7729637ADfc6b7f114f13aE999358FD9CBa;
    ...
    uint256 public tokenfyPrice = 1000000000000000000;
    ...
    uint256 public tokenfyPresalePrice = 500000000000000000;
	...
	constructor(address _signerAddress) ERC721A("test jhgkjhg 54675", "TEST") {
