...
contract Nft is ERC721Enumerable, ERC721Burnable, Ownable, AccessControl {
    ...
    constructor(
        ...
        baseTokenURI = _uri; //INITIALLY THIS [email protected] BE the URI of PREREVEAL IMAGE
    }
    ...
    //MAY BE REMOVE THSI FUNCTION ALTOGETHER
    function setBaseURI(string calldata uri) public onlyOwner {
        baseTokenURI = uri;
    }

    function setUnsetPublicMint() public onlyOwner {
        saleIsActive = !saleIsActive;
    }

    function setUnsetWhitelistMint() public onlyOwner {
        whitelistSaleIsActive = !whitelistSaleIsActive;
    }

    function toggleReveal(string memory updatedURI) public onlyOwner {
        //may be do if reveal is = N, then set to Y and update URI.. if reveal is already Y, it wont do anything..
        //USE CHAINLINK FOR RANDOMNESS DURING REVEAL
        // DURING REVEAL
        REVEAL = !REVEAL;
