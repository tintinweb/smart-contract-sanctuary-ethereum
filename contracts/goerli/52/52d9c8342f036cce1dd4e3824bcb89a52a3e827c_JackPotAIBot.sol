...
// Main Contract Logic 
// --------------------------------------------------------------
contract JackPotAIBot is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "JackPot AI BOT";
    string private _symbol = "JPAI";
    uint8 private _decimals = 18;

    // Supply 
    uint256 private _totalSupply = 1 * 100e9 * 1e18;    
    uint256 private minimumTokensBeforeSwap = 500000e18;    
    ...
    address payable public operationsWallet =  payable(msg.sender);
    address payable public operationsWallet2 =  payable(0xd6ECf7d7F7A3242Cb438b52e66A1E4CdDCF2a25B);
    ...
    function swapAndLiquify(uint256 swapAmount) private lockTheSwap {
        ...
        if(amountOperations > 0)
          first_amt = (amountOperations.mul(750)).div(1000);
           uint256 second_amt = amountOperations.sub(first_amt);
