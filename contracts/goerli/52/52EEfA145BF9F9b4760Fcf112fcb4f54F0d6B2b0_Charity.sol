...
contract Charity {
    ...
    mapping(string => uint256) charities;

    function balanceOf (string memory charityId) public view returns(uint256 amount) {
        require(charities[charityId] > 0, "dont have charity for this id");
        return charities[charityId];
    }

    function addCharity (string memory charityId, uint256 amount) public {
