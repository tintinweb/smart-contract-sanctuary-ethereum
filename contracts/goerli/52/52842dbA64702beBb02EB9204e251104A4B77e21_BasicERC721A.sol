...
// File contracts/BasicERC721A.sol
...
contract BasicERC721A is ERC165, ERC721A, ERC2981, ERC721AQueryable, AccessControlEnumerable {
    string private _baseTokenURI;
    uint256 public maxSupply;
    uint256 public constant startIndex = 0;
    ...
    constructor(
        ...
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "__grantRole failed for DEFAULT_ADMIN_ROLE");

        // Minter is not required. If minter address is specified, then give the minter role
    ...
    function setBaseURI(string calldata _newBaseURI) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC165, ERC721A, ERC2981, AccessControlEnumerable)
        returns (bool)
    {
    ...
    // royalty
    function updateRoyalty(address _royaltyReceiver, uint96 _royaltyFee)
        external
    ...
    function resetTokenRoyalty(uint256 _tokenId) external onlyRole(DEFAULT_ADMIN_ROLE) {
