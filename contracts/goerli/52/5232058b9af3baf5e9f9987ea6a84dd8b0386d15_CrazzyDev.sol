...
contract CrazzyDev is ERC721A, Ownable, ReentrancyGuard {  
  ...
  uint256 public prsaleMintprice = 0.008 ether; //here you change phase 1 cost (for example first 1k for free, then 0.004 eth each nft)

  uint256 public publicMintprice = 0.08 ether; //here you change phase 2 cost
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("CarzzyMDeve", "CD")  { //change this line to your full and short NFT name
