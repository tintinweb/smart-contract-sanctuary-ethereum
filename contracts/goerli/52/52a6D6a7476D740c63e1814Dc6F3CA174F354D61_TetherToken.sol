...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    ...
    function balanceOf(address _owner) virtual override public view returns (uint balance) {
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    */
    ...
    function allowance(address _owner, address _spender) virtual override public view returns (uint remaining) {
