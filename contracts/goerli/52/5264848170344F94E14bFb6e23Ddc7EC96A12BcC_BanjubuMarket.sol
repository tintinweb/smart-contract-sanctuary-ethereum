...
contract BanjubuMarket is Ownable {
    ...
    function sellNFT(uint256 tokenId) public {
        ERC721Upgradeable(_nftContract).safeTransferFrom(msg.sender, address(this), tokenId);
    }

    function buyNFT(uint256 tokenId) public payable {
        ERC721Upgradeable(_nftContract).safeTransferFrom(address(this), msg.sender, tokenId);
        ERC20Upgradeable(_coinContract).transfer(msg.sender, msg.value);
    }
}
