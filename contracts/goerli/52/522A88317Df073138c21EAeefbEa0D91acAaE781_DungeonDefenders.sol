...
contract DefenderUtils is DefenderFactory {
    ...
    function gainExperience(uint256 _tokenId, uint256 _expToGain) external {
        ...
        if (updatedLevel != defenders[_tokenId].level) {
            ...
            defenders[_tokenId].health = defenders[_tokenId].health * 107 / 100;
            defenders[_tokenId].speed = defenders[_tokenId].speed * 107 / 100;
            defenders[_tokenId].strength = defenders[_tokenId].strength * 107 / 100;
            defenders[_tokenId].defense = defenders[_tokenId].defense * 107 / 100;
