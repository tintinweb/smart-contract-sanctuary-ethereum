...
/// @title HumeMusicNFTFixedSupply
/// @notice
///
/// <easter_egg> 
///
/// Hume Music NFT 
contract HumeMusicNFTFixedSupply is ERC721A, Ownable, Adminable {
    ...
    uint256 public constant NFT_PRICE_1 = 0.00; // FREE
    uint256 public constant NFT_PRICE_2 = 0.03 ether; // 0.03 => 0.03 * 10 ** 18
    uint256 public constant NFT_PRICE_3 = 0.05 ether; // 0.05
        ...
        ERC721A(config_.name, config_.symbol)
    {
        ...
        priceByState[State.Sale] = NFT_PRICE_3; // public sale price same
