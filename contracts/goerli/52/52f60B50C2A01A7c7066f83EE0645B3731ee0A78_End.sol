...
// hevm: flattened sources of src/end.sol
...
contract End is LibNote {
    ...
    CatLike  public cat;
    VowLike_2  public vow;   // Debt Engine
    PotLike  public pot;
    Spotty   public spot;
    ...
    function file(bytes32 what, address data) external note auth {
        ...
        if (what == "vat")  vat = VatLike_2(data);
        else if (what == "cat")  cat = CatLike(data);
        else if (what == "vow")  vow = VowLike_2(data);
