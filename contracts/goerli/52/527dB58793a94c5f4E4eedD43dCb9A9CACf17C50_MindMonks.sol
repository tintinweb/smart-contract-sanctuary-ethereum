...
contract MindMonks is ERC721A, Ownable, OperatorFilterer {
    ...
    uint256 public monkPrice = 0.01 ether; // 0.01 ETH for testing
    uint256 public constant maxMonkMint = 8;
    uint256 public maxMonks = 888; 
    uint256 public foundersReserve = 50; // Reserve up to 50 Monks for founders, marketing etc.
    ...
    // Withdraw addresses
    address t1 = 0x52e93AED48d3ccDa053b5b28E21729846a224bC5; // Wallet 1
    address t2 = 0x712CD957888163f2374becC10CeB76005c3CA8d0; // Wallet 2
