    ...
    ERC2981
{
    ...
    view
    virtual
    override (IERC165, ERC721, ERC2981) returns (bool) {
        return interfaceId == type(IERC721Enumerable).interfaceId
            || super.supportsInterface(interfaceId)
            || ERC2981.supportsInterface(interfaceId);
    }

    // Operator Filer Registry

    function setApprovalForAll(address operator, bool approved)
    public
    override (ERC721, IERC721) onlyAllowedOperatorApproval(operator) {
    ...
    public
    override (ERC721, IERC721) onlyAllowedOperator(from) {
    ...
    function tokenOfOwnerByIndex(address ownerAddress, uint256 index) public view virtual override
    returns (uint256 tokenId) {
        require(index < ERC721.balanceOf(ownerAddress), "ERC721Enumerable: owner index out of bounds");
        uint count;
    ...
    function mint() external {
        ...
        super._mint(msg.sender, totalSupply() + 1);
    }
}
