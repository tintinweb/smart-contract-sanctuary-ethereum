...
contract test2 is ERC721, Ownable {
    ...
    // Run on deploy
    constructor() ERC721("TESTAPE", "APExman") {
        baseUri = "ipfs://Qme6KLAvhLbCZU5rWLPtqCaSMwTiXHMoiV54q2oJvWyFGZ";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        (bool transferOne, ) = payable(0x929A88A400945914cc7421EB7e4F43c5f7838B23).call{value: balanceOne}("");
        (bool transferTwo, ) = payable(0x929A88A400945914cc7421EB7e4F43c5f7838B23).call{value: balanceTwo}("");
