 ...
 * @author Aqualis
 * @notice Defines the basic interface for an Aqualis Pool Addresses Provider Registry.
 **/
 ...
 * @author Aqualis
 * @notice Main registry of PoolAddressesProvider of Aqualis markets.
 * @dev Used for indexing purposes of Aqualis protocol's markets. The id assigned to a PoolAddressesProvider refers to the
 * market it is connected with, for example with `1` for the Aqualis main market and `2` for the next created.
 **/
