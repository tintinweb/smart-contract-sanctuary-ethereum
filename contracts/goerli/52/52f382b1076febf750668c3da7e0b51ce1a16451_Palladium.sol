...
contract Palladium is protected {
    ...
    function current_pool(bytes32 palladium) 
        ...
        (uint pairings_per_block, uint extra_pairings) = emission_per_n_blocks(
                                                         paired_total, 
                                                         instance[palladium].starting_time, 
                                                         instance[palladium].ending_time);
        uint paired_in_pool = paired_total - (pairings_per_block*(seconds_since_beginning/12)) - extra_pairings;
