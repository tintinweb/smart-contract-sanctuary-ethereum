...
contract MycatNFT is ERC721 {
    uint256 public tokenId = 0;//因ERC721沒有定義totalSupply
    ...
    //可至 testnets.opensea.io 確認
    function _baseURI() internal pure override returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmcGAKTQU9t239F3LeGET2ygaVwYcLCsYDjC37TkSHjejK/";
    }
    //類盲盒功能的開關
    ...
    function tokenURI(uint256 _tokenId) public view override returns (string memory) {
        ...
        string memory baseURI = (uriState == 1? "https://gateway.pinata.cloud/ipfs/QmTz3bHT6sKqGpunMr4PFJPSQ5yPChYb3WSns1WCh5Hefc/": _baseURI());
