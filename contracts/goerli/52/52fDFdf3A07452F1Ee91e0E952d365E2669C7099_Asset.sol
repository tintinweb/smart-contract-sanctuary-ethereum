...
library Minting {
        ...
        returns (uint256, string memory)
    {
        ...
        string memory converted = string(blueprint);
        return (tokenID, converted);
    }
}
...
abstract contract Mintable is Ownable, IMintable {
    ...
    event AssetMinted(address to, uint256 id, string blueprint);
    ...
    function mintFor(
        ...
        (uint256 id, string memory blueprint) = Minting.split(mintingBlob);
...
contract Asset is ERC721, ERC721URIStorage, Mintable {
    constructor(
        address _owner,
        string memory _name,
