...
contract XArcadeToken is ERC20Burnable, AccessControl {
    /**
     ...
     * @param _arcadeVault Address the token supply will be minted to
     */
    constructor(address _arcadeVault) ERC20("xArcade Token", "xARC") {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _mint(_arcadeVault, 799_623_450 * 10**18); // Only mint 799,623,450 xArcade, 376,549.2 xArcade on SOL
    }
