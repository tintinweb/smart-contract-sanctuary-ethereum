...
contract Dorliinthegarbag is Ownable, ERC721A {
  string public baseURI = "https://nftstorage.link/ipfs/bafybeie32wwxxj2zejcc4ijoftpbcxoyaehszqacdw7c/";
  ...
  constructor(uint256 _mintCntToOwner) ERC721A('Dorli in the garbag', 'DTG') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 240) {
