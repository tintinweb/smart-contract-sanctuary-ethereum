...
contract AnalDolphinNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() payable ERC721('AnalDolphin', 'AD') {
    ...
    function mint(uint256 _quantity) public payable nonReentrant {
        ...
        require(totalSupply + _quantity <= maxSupply, 'too many mints requested');
