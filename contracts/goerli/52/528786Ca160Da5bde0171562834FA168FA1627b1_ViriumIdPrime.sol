...
contract ViriumIdPrime is AccessControl, ERC721Lockable {
    ...
    constructor() ERC721Lockable("ViriumIdPrime", "VIP"){
        ...
        currencyInfo = CurrencyInfo(Currency.ETH, 1e15, IERC20(0x1540602fA43D9b4237aa67c640DC8Bb8C4693dCD));
        mintStart = block.timestamp;
        mintClose = block.timestamp + 10000000;
    }
    ...
    function setCurrencyInfoAndDate(
        Currency currency,
        uint256 price,
        address erc20ContractAddress,
        uint256 mintStart_,
        uint256 mintClose_) external onlyRole(MAINTAIN_ROLE) {

        currencyInfo = CurrencyInfo(currency, price, IERC20(erc20ContractAddress));
        mintStart = mintStart_;
        mintClose = mintClose_;
    }
    ...
    function getStatus() public returns (Status){
        ...
        else if (block.timestamp < mintClose) {
            return Status.Live;
        }
        return Status.Close;
    }
    ...
    function merge(uint256[] memory tokenIds) external {
        ...
        require(getStatus() == Status.Live, "ViriumIdPrime: Status mismatch");
    ...
    function mint() external payable {
        ...
        if (currencyInfo.currency == Currency.ETH) {
