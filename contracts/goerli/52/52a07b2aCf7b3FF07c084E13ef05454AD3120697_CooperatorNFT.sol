...
contract CooperatorNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    function mint(uint256 quantity_, string memory _tokenURI) public payable {
        require(isPublicMintEnabled, "minting not enabled");
        require(msg.value == quantity_ * mintPrice, "erong not enabled");
