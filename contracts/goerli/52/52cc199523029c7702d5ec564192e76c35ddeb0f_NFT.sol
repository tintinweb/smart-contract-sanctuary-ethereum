...
contract NFT is ERC721, Ownable {
    ...
    bytes32 public merkleRoot = 0xd449c73ea04407cc92ff712cbf7056615fd821bb8983c4540813bb18ef13d416;
    ...
    function verifyInclusion(address _account, bytes32[] memory _proof) public view returns (bool) {
    bytes32 leaf = keccak256(abi.encodePacked(_account));
    return MerkleProof.verify(_proof, merkleRoot, leaf);
    }
    
    // Public Functions
    function mint(uint256 _numTokens, bytes32[] memory _proof) external payable {
        ...
        require(verifyInclusion(msg.sender, _proof), "You are not on the whitelist");
