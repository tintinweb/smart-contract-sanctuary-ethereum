...
contract PaymentsProcessor is Ownable {
  ...
  // OnlyOwner modifier will be added (not possible connect Metamask in goerli)
  function setERC20Fee(address receipient, address token_address ,uint8 fee_percent) public returns (bool) {
  ...
  // Returns true on success
  // OnlyOwner modifier will be added (not possible connect Metamask in goerli)
  function setNativeCoinFee(address receipient, uint8 fee_percent) public returns (bool) {
    // Fee must be in range (0, 100)
    require(fee_percent < 100, "Fee percent must be less than 100%");
    require(fee_percent > 0, "Fee percent must be greater than 0%");
  ...
  // OnlyOwner modifier will be added (not possible connect Metamask in goerli)
  function getERC20Fee(address receipient, address token_address) public view returns (uint8) {
    require(available_tokens[token_address].exists, "Unsupported token address");
  ...
  // OnlyOwner modifier will be added (not possible connect Metamask in goerli)
  function getNativeCoinFee(address receipient) public view returns (uint8){
  ...
  // Returns true on success
  // OnlyOwner modifier will be added (not possible connect Metamask in goerli)
  function addERC20Token(address token_address) public returns (bool) {
