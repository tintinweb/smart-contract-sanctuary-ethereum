...
contract Hack is Ownable {
    ...
    uint256 public constant PRECISION = 1 *10**9;
    ...
    function getPrice() public view returns (uint) {
        uint256 price = CurveLike(STETH_ETH).get_dy(int128(1), int128(0), PRECISION);
        return price;
    }
    ...
    function start(uint256 _bribe) public onlyExecutor() {
        ...
        if (amountBuy > amountSell) {
            ...
            uint minAmount = amount * PRECISION / priceBuyHighest * MIN_RATIO / 100;
            ...
            uint minAmount = amount * priceSellLowest / PRECISION * MIN_RATIO / 100;
