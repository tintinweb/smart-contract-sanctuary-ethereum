...
contract KangarooClub is ERC721, Ownable {
    ...
    address public dev = 0x3fe667Eb80483D680AF80EC22235749A874e44Cb; //address to withdraw to
    ...
    constructor(string memory _baseuri) ERC721("Kasual Kangaroo Club", "KKC") {
    ...
    function presaleKangaroo(uint256 num) public payable returns (bool) {
        ...
        require(
            ...
            "You are not in the whitelist to mint"
        );
        require(
            currentSupply + num <= presaleSupply,
            "Exceeded pre-sale supply"
        );
        require(
    ...
    function publicsaleKangaroo(uint256 num) public payable returns (bool) {
        ...
        require(
            currentSupply + num <= MAX_SUPPLY - reserved,
            "Exceeded total supply"
        );
        require(
            msg.value >= tierPrice * num,
            "Ether value sent is not sufficient"
        );
        return _mintKangaroo(num);
    }
