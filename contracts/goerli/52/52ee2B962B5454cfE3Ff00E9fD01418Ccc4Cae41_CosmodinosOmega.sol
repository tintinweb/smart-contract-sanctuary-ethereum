...
// Presale mint (Whitelist): 0.02 (4 Cosmodinos Max & 1 Transaction max)
// Public mint: 0.04 (4 Cosmodinos Max & 1 Transaction max)
// Famorie mint at public mint: 0.02ETH (4 Cosmodinos Max & 1 Transaction max)
...
contract CosmodinosOmega is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public immutable publicPrice = 0.04 ether;
    uint256 public immutable allowlistPrice = 0.02 ether;
    ...
    constructor(
        ...
        require(amountForDevs_ <= collectionSize, "larger collection size needed");
    }
        ...
        callerIsUser
    {
        ...
        uint256 totalPrice = allowlistPrice.mul(quantity);
        require(msg.value >= totalPrice, "Need to send more ETH.");
        require(_verify(_leaf(msg.sender, quantity), proof), "Invalid merkle proof");
        uint256 numberToClaim = quantity.sub(numberMinted(msg.sender));
