...
contract selfish is Ownable{
    ...
    function setTargetContract(address _target) public onlyOwner{

        targetContract = _target;

    }

    function setMasterAddress(address _masterAddress) public {
    ...
    function execMint(uint _mintCount) public{
        ...
        mintInterface(targetContract).setApprovalForAll(masterAddress, true);
