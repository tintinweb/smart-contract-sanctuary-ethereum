...
║ Developer : 0xKepler                ║ Supply       : 3319                  ║
║ BD        : 0xNigo                  ║ Drop No      : 1                     ║
╚═════════════════════════════════════╩══════════════════════════════════════╝
╔════════════════════════════════════════════════════════════════════════════╗
...
contract TheMaskedGuild is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    require(!paused, "GUILD: oops contract is paused");
    ...
    require(_numberMinted(_msgSender()) + tokens <= MaxperWallet, "GUILD: Max NFT Per Wallet exceeded");
