...
contract Test202207152033 is ERC721A, ERC721AQueryable, Owned {
  uint256 constant EXTRA_MINT_PRICE = 0.006 ether;
  uint256 constant MAX_SUPPLY_PLUS_ONE = 21;
  uint256 constant MAX_PER_TRANSACTION_PLUS_ONE = 11;

  string tokenBaseUri = "http://sdfosdjfoisdjfoisdjfsdf.com/";

  bool public paused = true;

  mapping(address => uint256) private _freeMintedCount;

  constructor() ERC721A("Test202207152033", "Test202207152033") Owned(msg.sender) {}
