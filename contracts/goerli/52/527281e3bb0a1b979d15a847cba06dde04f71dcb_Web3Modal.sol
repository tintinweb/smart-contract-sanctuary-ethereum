...
contract Web3Modal is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer   {
...
/// @dev presale mint for whitelisted
    ...
    require(WhitelistedMintofUser[_msgSenderERC721A()] + tokens <= MaxWLMint, "SYMBOL: Max NFT Per Wallet exceeded");
    require(tokens <= MaxWLMint, "SYMBOL: max mint per Tx exceeded");
