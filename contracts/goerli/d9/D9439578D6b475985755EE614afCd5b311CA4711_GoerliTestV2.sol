...
// File: contracts/ERC721ACustom.sol
...
// File: contracts/goerliTest_v2.sol
...
contract GoerliTestV2 is ERC721A, Pausable, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        treasury = _treasury;
        _safeMint(treasury, _treasuryMintAmount);
    }
    ...
    function setPreSale(bool _status) external onlyAdminOrOwner {
