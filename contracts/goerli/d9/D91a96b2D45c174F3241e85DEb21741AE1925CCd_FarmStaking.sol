...
contract FarmStaking is IFarmStaking, ReentrancyGuard, Initializable, Pausable, Recoverable {
    ...
    function unstake(uint256 index) public whenNotPaused needInit {
    ...
    function unstakeAll() public whenNotPaused needInit {
        require(!appConf.validBlacklist(_msgSender()), "can not unstake");
