...
contract DeweyDed is ERC721A, Ownable{
    ...
    uint public maxPerWallet = 20; //Max Limit for Presale
  
         
    constructor() ERC721A("Dewey DeD", "DD"){}
