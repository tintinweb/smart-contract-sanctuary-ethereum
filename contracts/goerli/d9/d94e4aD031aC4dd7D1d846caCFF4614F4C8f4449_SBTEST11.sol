 ...
 *   CURRENT GOERLI AT: tbd
 *   Provenance hash is:  699c772c77cbae568a443b70ddfca4433a46f667607a2f1f580b2a8bf6d1931d
 */
...
contract SBTEST11 is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {

    uint public maxSupply  = 11111;           // Hard-coded in setMaxSupply() also.
    uint public mintPrice  = 0.001 ether;     // Testnet price
    uint public promoPrice = 0.0009 ether;    // Testnet price
    bool public presaleIsLive = false;
    string public provenanceHash;
    uint public randomOffset;
    uint public reservedNFTs;
    bool public saleIsLive = false;
    uint public transactionLimit = 10;       // Normally ETH-mint limit
    uint public transactionLimitCC = 6;        // CC-purchase limit
    uint public walletLimit = 200;           // Only applies in certain circumstances.
