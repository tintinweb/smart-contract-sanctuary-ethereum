...
contract rocket1 is ERC20, Ownable {
    ...
    constructor() ERC20("rocket1", unicode"rocket") payable {
    	...
    	marketingWallet = address(0x5D3653f18075B247b5482d9c38ca567a4d8Acc9B); // set as Marketing wallet
        devWallet = address(0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x5D3653f18075B247b5482d9c38ca567a4d8Acc9B, true);
        excludeFromFees(0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x5D3653f18075B247b5482d9c38ca567a4d8Acc9B, true);
        excludeFromMaxTransaction(0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc,
            block.timestamp
        );
    }
