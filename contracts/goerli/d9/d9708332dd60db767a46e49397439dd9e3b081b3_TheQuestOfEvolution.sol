...
contract TheQuestOfEvolution is ERC721Enumerable, ERC2981, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("The Quest Of Evolution", "TQOE") {
        baseURI = "ipfs://.../";
    ...
    function contribute(uint tokenId, string memory paragraph) external payable isContractState(ContractState.ON) {
        ...
        shares > 0 ? royaltySplitter.addPayee(msg.sender, 100) : royaltySplitter.addShares(msg.sender, 100);

        _contributionInfo[tokenId][_numberOfContributions[tokenId]] = contributionInfo;
        contributionLock[tokenId] = true;

        QEV.transferFrom(platformTreasury, msg.sender, QEVPerContribution);
    }
