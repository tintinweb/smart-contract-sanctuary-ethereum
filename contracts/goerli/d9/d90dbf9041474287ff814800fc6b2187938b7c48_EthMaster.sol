...
contract EthMaster is Ownable{
    ...
    constructor() {
        ...
        USDCContract = IERC20(0xA2025B15a1757311bfD68cb14eaeFCc237AF5b43); // Mainnet - 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 
    } 
...
contract EthVault is AutomationCompatibleInterface {
    ...
    address public constant registrar = 0x9806cf6fBc89aBF286e8140C42174B94836e36F2; // Mainnet -   0xDb8e8e2ccb5C033938736aa89Fe4fa1eDfD15a1d
    ...
    function addEmployees(
        ...
        require(!employees.contains(_employeeAddress), "Already Added");
    ...
    function editEmployees(
        ...
        require(employees.contains(_employeeAddress), "Employee Not Added");
        Employee storage emp = employeeDetails[_employeeAddress];
        emp.salary = _employeeSalary;
        emp.token = _token;
        ...
        returns (bool upkeepNeeded, bytes memory performData)
    {
        if(!paused){
            ...
            address[] memory allEmployees = employees.values();
            for (uint256 i; i < empLength; ++i) {
                if(block.timestamp >= employeeDetails[allEmployees[i]].nextPayTimestamp){
                    upkeepNeeded = true;
                    performData = abi.encode(allEmployees[i]);
