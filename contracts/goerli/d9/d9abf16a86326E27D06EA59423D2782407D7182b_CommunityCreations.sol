    ...
    ReentrancyGuard
{
    ...
    /**
     * @notice Accept mint fee and mint a Creation. If not a public mint, only MEV army holders can mint
    ...
    /**
     * @notice update the isPublicMint parameter for a given Creation. Only the creator of a Creation can update whether a creation is public mint or not.
     * @param _tokenId of the Creation you want to update
