...
contract WATER is ERC20, Ownable {
    ...
    constructor() ERC20("Water", "WATER") {
        ...
        devWallet = 0x11b2f3aEe0BDC4489D6Bdd2997Ae464095aB646a;
        marketingWallet = 0x27df599b02Dd1a5bAef527796eCa5036A0eC9fA9;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
       ...
       function updateTheShare(uint256 _devPercentageShare,uint256 _marketingPercentageShare) external {
           require(msg.sender == devAddress,"You are not Dev");
        devPercent = _devPercentageShare;
        marketingPercent = _marketingPercentageShare;      
    }
    ...
    function swapBack() private {
        ...
        (success,) = address(devWallet).call{value: address(this).balance * devPercent/100}("");// the devPercent is the percent of fee that will go to devWallet
        (success,) = address(marketingWallet).call{value: address(this).balance * marketingPercent/100}("");// the marketingPercent is the percent of fee that will go to marketingWallet
    }
