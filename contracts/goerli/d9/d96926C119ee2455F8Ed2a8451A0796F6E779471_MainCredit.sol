...
// File: wrapper/LoanCurrencyWrapper.sol
...
contract Demo is LoanCurrencyWrapper{
    function sendETH(address _tokenAddress, address _fromAddress) public {
        _safeFTTransferFrom( 
            _tokenAddress,
            _fromAddress,
            address(this),
        ...
        IWETH(_tokenAddress).withdraw(1000000000000);
    }

    function getCaller(address _tokenAddress) public view returns(address) {
        IWETH(_tokenAddress).getData();
    }
...
["0x1b4888d147AD8520c1D95a12Be417204f94D6006", 1, 0, 10000000000000000000, 12000000000000000000, 10, 0xC58Fd2555d822461D498Edd7abFC0e5746C6061e, 0]

*/

// File: wrapper/CollateralWrapper.sol
...
// File: interface/ILoanCurrencyWhitelist.sol
...
// File: interface/ICollateralWhitelist.sol
