...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x2ff41f4D28A6C327095bb722812DFaDe75c40618];
  address public erc20Payable = 0x2ff41f4D28A6C327095bb722812DFaDe75c40618;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeid5jovbjwytg4vrxtjgy4hvgi45c5n3blcgrgja6lihb665vs4q54/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/81Qu8BVPx4HzOYEPEQ4s/contract-metadata";
  }
...
// File: contracts/SpaceSneksSocietyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpaceSneksSocietyContract is RamppERC721A {
    constructor() RamppERC721A("Space Sneks Society", "SNEK"){}
}
