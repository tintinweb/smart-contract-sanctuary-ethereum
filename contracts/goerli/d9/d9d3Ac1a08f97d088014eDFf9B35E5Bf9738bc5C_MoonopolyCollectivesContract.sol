...
//*********************************************************************//
//
//     __  ___                                           __          ______        __ __             __   _                   
//    /  |/  /____   ____   ____   ____   ____   ____   / /__  __   / ____/____   / // /___   _____ / /_ (_)_   __ ___   _____
//   / /|_/ // __ \ / __ \ / __ \ / __ \ / __ \ / __ \ / // / / /  / /    / __ \ / // // _ \ / ___// __// /| | / // _ \ / ___/
//  / /  / // /_/ // /_/ // / / // /_/ // /_/ // /_/ // // /_/ /  / /___ / /_/ // // //  __// /__ / /_ / / | |/ //  __/(__  ) 
// /_/  /_/ \____/ \____//_/ /_/ \____// .___/ \____//_/ \__, /   \____/ \____//_//_/ \___/ \___/ \__//_/  |___/ \___//____/  
//                                    /_/               /____/                                                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xe3Eac66989eDf9DB0FDb0817393C6E195849A7A4];
  address public erc20Payable = 0xe3Eac66989eDf9DB0FDb0817393C6E195849A7A4;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 62) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYKtEaKWf5juosHJ82ikkpsab7GqvFaCihegwWsfdCuPK/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/iOGFRI0YJQ3zvzrcyY8p/contract-metadata";
  }
...
// File: contracts/MoonopolyCollectivesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoonopolyCollectivesContract is ERC721APlus {
    constructor() ERC721APlus("Moonopoly Collectives", "Mply"){}
}
