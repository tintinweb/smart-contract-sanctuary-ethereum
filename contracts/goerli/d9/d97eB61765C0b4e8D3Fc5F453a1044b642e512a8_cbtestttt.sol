...
contract cbtestttt is ERC721A, ERC2981, OperatorFilterer, Ownable {
    ...
    constructor() ERC721A("cbtestss", "cbtestzzz"){
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!revealed) {
            return "https://gateway.pinata.cloud/ipfs/QmcE9rBpdVP27hievCMSpBTCQ79zbFxSf8dKWKLpZzT6pY/1.json";
        }
