...
contract SaviorsOfTheSea is ERC721, ERC721URIStorage, ERC721Enumerable, ERC721Burnable, Ownable, ReentrancyGuard {
    ...
    uint256 public mintPrice = 0.00001 ether; // ~0.04 ETH
    ...
    constructor(string memory name, string memory symbol, uint256 onPolygon) ERC721(name, symbol) {
        for (uint256 i = 1; i <= onPolygon; i++) {
