...
contract Dexpresso is IDexpresso, Pausable {
    ...
    struct MatchedOrders {
        uint256 matchID;
        uint256 makerValidUntil;
        uint256 takerValidUntil;
    ...
    event transferredAssets(address[] tokens);
     ...
     *
     */
    constructor(uint256 feeRatio, address _daoMultiSig, address[] memory _brokers) {
     ...
     *
     */
    function setFeeRatio(uint256 _newFeeRatio) external whenNotPaused isDaoMultiSig {
