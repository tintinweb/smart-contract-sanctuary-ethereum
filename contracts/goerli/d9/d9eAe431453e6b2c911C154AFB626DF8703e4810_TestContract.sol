...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1673362200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1673359080;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 2) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidmael5x5t62374dqbictecjd3bamiru7zsggrr6mpt4gijwjba2e/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/oO2NLrKzfG6zsYtNSQBD/contract-metadata";
  }
...
contract TestContract is RamppERC721A {
    constructor() RamppERC721A("Test", "ABC"){}
}
