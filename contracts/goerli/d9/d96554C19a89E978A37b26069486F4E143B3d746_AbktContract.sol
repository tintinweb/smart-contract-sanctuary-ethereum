...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xfd6AE65236cDEb66723bD484883d17Eb3E261a4d];
  address public erc20Payable = 0xfd6AE65236cDEb66723bD484883d17Eb3E261a4d;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibbcpncjyx735vqvaxievvp3usdgvgbf2cdjbrz7dikk2vlvsd75i/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/GYMAAWYMvv8Thx6JAtqk/contract-metadata";
  }
...
// File: contracts/AbktContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AbktContract is RamppERC721A {
    constructor() RamppERC721A("ABKT", "ABKT"){}
}
