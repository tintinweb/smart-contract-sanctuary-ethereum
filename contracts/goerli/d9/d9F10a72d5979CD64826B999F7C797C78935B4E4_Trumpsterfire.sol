...
contract Trumpsterfire is ERC1155, AccessControl, ERC1155Supply {
    ...
    constructor() ERC1155("https://assets.trumpsterfire.ai/metadata/{id}") {
    ...
    function mint(uint16 qty)
        public payable
    {
        require(qty > 0, "You have to mint one");
