...
/**
 * @title Deployer
 * @dev Deploys ERC1155MinterProxy contracts
 */
contract Deployer {
    /**
     * Event for a new contract deployment
     */
    ...
    /**
     * @dev The address of the ERC1155Minter logic contract
     */
    ERC1155Minter minter1155;

    /**
     * @dev The address of the ERC721Minter logic contract
     */
    ERC721Minter minter721;

    constructor(ERC1155Minter minter1155_, ERC721Minter minter721_) {
        minter1155 = minter1155_;
        minter721 = minter721_;
    }

    /**
     * @notice Deploys a new ERC1155Minter proxy contract
     * @param proxyAdmin_ The proxy admin that can perform proxy upgrades (must be different from the msg.sender)
     * @param tokenUri_ The tokenURI of the minter contract
     ...
     * @return The address of the deployed ERC1155MinterProxy contract
     */
    function deploy1155(
        address proxyAdmin_,
        ...
        return _deployProxy(address(minter1155), proxyAdmin_, data);
    }
    ...
    function deploy721(
        ...
        bytes memory data = abi.encodeWithSignature(
            "initialize(string,string,string,string,uint256,uint256,uint256,bytes32,bool,address[],uint256[])",
            name_,
            symbol_,
            baseUri_,
            contractURI_,
        ...
        return _deployProxy(address(minter721), proxyAdmin_, data);
    }
...
/**
 * @title ERC1155Minter
 * @dev An upgradeable ERC1155 contract.
 */
    ...
    PaymentSplitterUpgradeable
{
    ...
    /**
     * @dev The single token id.
     */
    uint256 constant DEFAULT_TOKEN_ID = 1;

    /**
     * @dev The default mint quantity.
     */
     ...
     * @param tokenUri_ The ERC1155 metadata URI
     ...
     */
    function mintAllowList(uint256 quantity, bytes32[] calldata merkleProof_)
        external
        payable
        virtual
        nonReentrant
    ...
    /**
     * @dev Overrides the default _beforeTokenTransfer to check transferability and max supply.
     */
    function _beforeTokenTransfer(
        address operator,
        address from,
    ...
    /**
     * @dev Overrides the default _setApprovalForAll to check max supply.
     */
    function _setApprovalForAll(
        address owner,
        address operator,
