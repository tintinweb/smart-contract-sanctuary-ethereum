...
interface IStakefishTransactionFeePoolV2 {
    ...
    // @amountRequested is the amount of tokens to collect. If set to 0, then all available rewards are collected.
    //                  The transaction would revert if the amount requested is greater than the available balance.
