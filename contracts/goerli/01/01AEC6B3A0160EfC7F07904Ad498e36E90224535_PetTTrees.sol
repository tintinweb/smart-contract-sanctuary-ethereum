...
contract PetTTrees is ERC721A, OpenSeaDefaultOperatorFilterer, Ownable, Paid {
    ...
    function safeMint(address to_, uint quantity_)
        external payable 
    ...
    function safeMintTo(address to_, uint quantity_, bytes memory data)
        external payable 
        onlyPaid(OPEN_MINT_PRICE * quantity_)
    {
        _safeMintGuard(to_, quantity_, "");
