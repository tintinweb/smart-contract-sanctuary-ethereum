...
contract Aniborgz is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_SUPPLY = 6236;
    uint private constant MAX_GIFT = 100;
    uint private constant MAX_PUBLIC = MAX_SUPPLY - MAX_GIFT;

    uint public publicSalePrice = 0.02 ether;

    uint public saleStartTime = 1670092429; // 03 dec 2022 19:33:00
    ...
    **/
    function publicMint(address _account, uint _quantity) external payable callerIsUser {
        ...
        require(currentTime() < saleStartTime + 336 hours, "Public Sale is finished");
        uint price = publicSalePrice;
        require(price != 0, "Price is 0");
        require(sellingStep == Step.PublicSale, "Public sale is not activated");
        require(amountNFTperWalletPublicSale[msg.sender] + _quantity <= maxPerAddressDuringPublicMint, "You can only get 5 NFTs on the Public Sale");
