...
contract MzLadyTest2 is ERC1155, AccessControl, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    uint256 public doublemintPrice = 0.05 ether;
    ...
    function setcurrentTokenId(uint256 _typeId) external onlyRole(OWNER_ROLE) {
        currentTokenId = _typeId;
    }
    ...
    function publicMint(uint256 _typeId, uint256 _quantity) public payable nonReentrant {
        ...
        require(_typeId == currentTokenId, "Wrong Token ID");
