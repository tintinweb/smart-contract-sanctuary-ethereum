...
/**
 * @notice Implementation of the {ISomaGuard} interface.
 */
contract SomaGuard is ISomaGuard, TokenRecovery {
    ...
    /**
     * @notice Checks if SomaGuard inherits a given contract interface.
     ...
     * @inheritdoc ISomaGuard
     */
    function privileges(address account) public view virtual override returns (bytes32) {
     ...
     * @inheritdoc ISomaGuard
     */
    function batchUpdate(address[][] calldata accounts_, bytes32[] calldata privileges_)
        external
        override
...
library SOMAlib {
     ...
     */
    ISOMA public constant SOMA = ISOMA(0x89940e4478702819dd7b01303d923d86b6Bbe447);
}
