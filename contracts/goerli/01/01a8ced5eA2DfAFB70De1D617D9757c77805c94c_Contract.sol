...
contract Contract is ERC721Drop, Permissions{
    ...
    function writeNote(uint256 _tokenId, string memory _holderNote) public
    {
        require(msg.sender == ownerOf(_tokenId),"You are Onwer of this NFT!");
        notes[_tokenId] = _holderNote; 
    
    }
        function overrideNote(uint256 _tokenId, string memory _holderNote) public onlyRole(DEFAULT_ADMIN_ROLE)
    {
        notes[_tokenId] = _holderNote; 
