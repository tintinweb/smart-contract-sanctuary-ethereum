...
contract ERC20 is Context {
     ...
     */
    //this function is used when there are only two parties
    ...
    function transferFrom(
        ...
        _transfer(msg.sender, to, _allowances[from][msg.sender]);
    ...
    {
        // TODO: use `_approve` defined later in the contract
        require (spender != address(0), "ERC20: approved from the zero address");
    ...
    function _transfer(
        ...
        // TODO
        require (from != address(0), "ERC20: approval from the zero address");
        require (to != address(0), "ERC20: approval to the zero address");
        require(_balances[from] >= amount);
