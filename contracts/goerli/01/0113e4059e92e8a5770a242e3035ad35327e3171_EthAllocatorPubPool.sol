...
import "src/RocketStorageInterface.sol";
...
contract EthAllocatorPubPool is ERC1155, ReentrancyGuard, Ownable {
    RocketStorageInterface rocketStorage = RocketStorageInterface(address(0));
    address public quadrataContract = address(0);

    constructor(address _rocketStorageAddress, address _quadrataContract)
        ERC1155(
    ...
    function getMetadata(uint256 _tokenID)
        public
        view
        returns (Metadata[] memory, address[] memory, string memory)
    {
        return (tokenIDtoMetadata[_tokenID], tokenIDtoStaker[_tokenID], tokenIDtoValidator[_tokenID]);
    }
