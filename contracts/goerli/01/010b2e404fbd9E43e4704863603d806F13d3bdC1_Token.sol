...
contract Token is ERC20, Ownable {
    ...
    address public erc20PolygonRootToken;
    ...
    function refillPolygonToken(uint256 _amount) external onlyOwner {
        ...
        _approve(address(this), erc20Predicate, _amount);
        rootChainManager.depositFor(
            erc20PolygonManager,
            erc20PolygonRootToken,
            abi.encode(_amount)
        );
    }
    ...
    function updateErc20PolygonRootToken(address _erc20PolygonRootToken)
        external
        onlyOwner
    {
        require(
            _erc20PolygonRootToken != address(0),
            "Bad ERC20PolygonManager address"
        );
        erc20PolygonRootToken = _erc20PolygonRootToken;
    }
