...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x8112c46bc710698f4a14dFeb267F053a99ea9b36];
  address public erc20Payable = 0x8112c46bc710698f4a14dFeb267F053a99ea9b36;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  uint256 public PRICE = 0.31 ether;
  uint256 public EARLY_MINT_PRICE = 0.2 ether;
  uint256 public earlyMintTokenIdCap = 2000;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 10000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib6shyvodm2wx2pyqf2ani4lpiyn4t7atndrybvhuyaidjolr457e/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XKjiSxpsgsMJqqoP2CLs/contract-metadata";
  }
...
// File: contracts/BellyJeansContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BellyJeansContract is ERC721APlus {
    constructor() ERC721APlus("BellyJeans", "BELLY"){}
}
  /*******************************************************/
  /*                                                     */
  ...
  /*                                                     */
  /*   THIS FREE NO-CODE CONTRACT WAS DEPLOYED WITH      */
  /*   NFT-INATOR AND MINTPLEX. CREATE YOUR OWN NO-CODE  */
  /*   COLLECTION AT NFT-INATOR.COM                      */
  /*                                                     */
  /*   Neither NFT-inator or Mintplex are responsible    */
  /*   for the functionality & content associated with   */
  /*   this smart contract or the creator/collectors     */
  /*   NFT-Inator & Mintplex is not associated or        */
