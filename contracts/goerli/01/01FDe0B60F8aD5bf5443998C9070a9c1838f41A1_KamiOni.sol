...
contract KamiOni is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, bytes32 _merkleRoot, string memory defaultTokenURI) ERC721A(name_, symbol_) {
