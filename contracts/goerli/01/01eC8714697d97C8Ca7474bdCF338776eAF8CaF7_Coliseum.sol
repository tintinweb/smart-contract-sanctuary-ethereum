    ...
    DefaultOperatorFilterer
{
    ...
    event Soulbounded(address[] indexed indexedAddrs);
    event UnSoulbounded(address[] indexed indexedAddrs);
    ...
    string private _baseTokenURI =
        "https://bafybeibk766mclkwhh5ka3nsdqz4kcmy7y37qmogq5h5jrcrjxyhxgkiuq.ipfs.nftstorage.link/metadata/";
    ...
    bool public soulBoundLockActive;
    ...
    function presaleReservedMint() external callerIsUser {
        ...
        if (totalSupply() + 2 > maxSupply) revert MaxSupplyExceeded();
        ...
        _lockedTokenId[totalSupply()] = true;
        _tokenToTier[totalSupply() - 1] = 2;
        _tokenToTier[totalSupply()] = 2;
    }
    ...
    function presaleMint(
        ...
        _lockedTokenIdLater[totalSupply()] = true;
        _lockedTokenIdLater[totalSupply() - 1] = true;
        _tokenToTier[totalSupply() - 1] = 2;
        _tokenToTier[totalSupply()] = 2;
    }
    ...
    function highTierMint(
        ...
        if (_numberMinted(msg.sender) + 1 > 1) revert MaxPerWalletExceeded();
    ...
    function airDropAndSoulBound(
        ...
        for (uint256 i = 0; i < targets.length; i++) {
            _soulBoundList[totalSupply()] = targets[i];
            soulBoundedAmount++;
            _mint(targets[i], 1);
        }
    }
...
contract ERC721A is IERC721A {
    ...
    function totalSupply() public view virtual override returns (uint256) {
        ...
        unchecked {
            return _currentIndex - _burnCounter - _startTokenId() - totalSoulBound();
        }
    }

    function totalSoulBound() public view virtual returns (uint256) {
    }
    /**
