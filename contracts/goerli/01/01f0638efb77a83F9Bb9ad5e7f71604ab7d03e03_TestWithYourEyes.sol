    ...
    DefaultOperatorFilterer
{
    ...
    uint256 public maxFreeMintPerAccount = 1;
    uint256 public totalFreeMint;
    uint256 public publicSalesTimestamp = 1678474434;
    ...
    function mint(uint256 amount) external payable {
        ...
        if (_totalFreeMintPerAccount[msg.sender] < maxFreeMintPerAccount) {
            ...
            if (amount > freeAllowed) {
                require(
                    msg.value >= (amount * mintPrice) - (freeAllowed * mintPrice), "Insufficient funds!");
    ...
    function setMaxFreeMintPerAccount(uint256 maxFreeMintPerAccount_)
        external
        onlyOwner
    {
        maxFreeMintPerAccount = maxFreeMintPerAccount_;
    }
