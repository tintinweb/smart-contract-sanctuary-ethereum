...
contract TESTINGV38457452 is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 4444;
    uint256 public maxPublicMintPerTx = 3;
    uint256 public maxWhitelistMintPerTx = 1;
    uint256 public publicSalePrice = .005 ether;
    ...
    constructor(string memory initBaseURI) ERC721A("TESTINGV38457452", "TEST") {
        baseURI = initBaseURI;
    }
    ...
    function publicMint(uint256 amount) external payable {
        ...
        require(
            (totalPublicMint[msg.sender] + amount) <= maxPublicMintPerTx,
