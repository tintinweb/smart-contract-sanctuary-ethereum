...
contract RuslanToken is ERC721A, Ownable, ReentrancyGuard {
    ...
    function lowerMaxSupply(uint256 newMaxSupply) external onlyOwner {
        ...
        require(newMaxSupply >= _totalMinted(), "Invalid new max supply");
        ...
        mintCompliance(_mintAmount)
    {
        ...
        if (_totalMinted() < FREE_MINT_IS_ALLOWED_UNTIL) {
