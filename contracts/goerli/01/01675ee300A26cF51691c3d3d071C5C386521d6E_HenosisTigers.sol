...
contract HenosisTigers is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public publicSupply = 888;
    ...
    bytes32 public whitelistMerkleRoot = 0x4b050bff9af4912bbc73a374f18f82056992ab497a5cd0f511a60644e014454e;
    ...
    function publicMint(uint256 amount) public payable mintCompliance(amount) {
        ...
        require(publicMinted[msg.sender] + amount <= maxPerWallet);
    ...
    function setPrices(uint256 _allowlistCost, uint256 _publicCost) public onlyOwner {
