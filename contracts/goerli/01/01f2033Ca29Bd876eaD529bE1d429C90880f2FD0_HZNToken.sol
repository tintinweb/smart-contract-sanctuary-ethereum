...
contract HZNToken is ERC721ABurnable, ReentrancyGuard, Ownable {
    ...
    mapping(address => bool) private publicMintAddresses;
    ...
    function whitelistMint(bytes memory _signature)
        ...
        callerIsUser
    {
        require(block.timestamp > wlBatchTime, "Not yet started");
        require(!whitelistMintAddresses[msg.sender], "Already minted");
        ...
        whitelistMintAddresses[msg.sender] = true;
    ...
    {
        require(block.timestamp > publicBatchTime, "Not yet started");
        require(!publicMintAddresses[msg.sender], "Already minted");
        publicMintAddresses[msg.sender] = true;
        _safeMint(msg.sender, 1);
    }
