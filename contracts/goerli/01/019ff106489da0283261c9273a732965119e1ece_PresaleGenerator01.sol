...
// File: Interface/IUniswapV2Locker.sol
...
// File: Interface/IPresaleFactory.sol
...
// File: Interface/IPresaleLockForwarder.sol
...
contract Presale01 is ReentrancyGuard, Proxiable{
    ...
    function ownerWithdrawTokens() external onlyPresaleOwner declineWhenTheSaleStops {
        ...
        if(presaleStatus() == 3) {
            ...
            if(presaleStatus() == 2) {
                ...
                revert("SALE NOT YET FINISH.");
            }
        }

        if(statusWithDraw) {
            require(
                REFUND_INFO.refundTime + 1 hours < block.timestamp, 
                "NOT TIME FOR OWNER WITHDRAW TOKEN WHEN SALE SUCCESS."
            );
        }
    ...
    function updateCode(address _presaleAddress) external onlyNomopolyDev{
...
// File: Main/PresaleGenerator01.sol
...
contract PresaleGenerator01 is Ownable {
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0xB8fAd39DD09b47CA5B229e942C770650540b7fcB);
        PRESALE_SETTINGS = IPresaleSettings(0x97f0E47e9dE204546FF3b3D466999Cee7Fd2fdd0);
    ...
    function createPresale (
      ...
      uint256[] memory _refundInfo
        ...
        require(
            _refundInfo[1] > _distributionTime[_distributionTime.length.sub(1)], 
            "INVALID REFUND TIME."
        );
        require(
            rateWithdrawRemaining == 1000,
        ...
        newPresale.init3(is_white_list, _caller, percentFee, _distributionTime, _unlockRate, _isRefund, _refundInfo);
