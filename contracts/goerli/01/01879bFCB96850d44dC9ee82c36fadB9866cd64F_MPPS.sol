...
contract MPPS is Ownable, ERC721AO, DefaultOperatorFilterer
{
    uint public _ART_BLOCKS_PROJECT_ID = 69420;
     ...
     * @dev Constructor
     */
    constructor() ERC721AO("Mint Pass Passages | Bright Moments x Aaron Penne x Boreta | MPPS", "MPPS") 
    { 
        _mint(0xB96E81f80b3AEEf65CB6d0E280b15FD5DBE71937, 5); // reserve
        // _Authorized[] = true;
    }
    ...
    /**
     * @dev Enables Live Minting By Changing The ArtBlocks ProjectID Returned From LiveMintBurn
     */
    function ____ChangeArtBlocksProjectID(uint NewProjectID) external onlyOwner { _ART_BLOCKS_PROJECT_ID = NewProjectID; }
    ...
    function _LiveMintBurn(uint TokenID) external returns (address _Recipient, uint _ArtistID)
    {
        ...
        _burn(TokenID, false);
        return (Recipient, _ART_BLOCKS_PROJECT_ID);
    }
