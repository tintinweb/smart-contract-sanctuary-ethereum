...
contract HedgeXv3 {
    ...
    function settleOrder(
        ...
        //TODO: If maker is winner, maker pays 10% of taker amount to protocol.
        //TODO: If maker is winner, protocol pays 10% of profit amount^ to settler.
       
        //TODO: If taker is winner, protocol profit = maker amount - taker payout
        //TODO: If taker is winner, protocol pays 10% of profit amount^ to settler, & 1% rebate back goes back to the maker.


        //////////////

        // Update protocol earnings
        protocol_earnings += (payout.protocol_profit - (pyth_update_fee * maker.num_legs));
