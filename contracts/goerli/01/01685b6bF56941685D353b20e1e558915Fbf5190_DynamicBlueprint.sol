    ...
    IDynamicBlueprint
{
    ...
    function mintBlueprints(
        ...
        if (b.isSoulbound) {
            ...
            require(balanceOf(nftRecipient) == 0 && purchaseQuantity == 1, "soulbound pre-cond fail");
        }
    ...
    function updateOperatorFilterAndRegister(
        ...
        registerWithOpenSeaOperatorRegistry(coriCuratedSubscriptionAddress);
    }
     ...
     */
    function registerWithOpenSeaOperatorRegistry(address coriCuratedSubscriptionAddress) public {
        ...
        registry.registerAndSubscribe(address(this), coriCuratedSubscriptionAddress);
    }
