...
contract NFTCOLLUPNAB is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_PUBLIC = 60;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _baseURI) ERC721A("ZONE19", "ZN19")
