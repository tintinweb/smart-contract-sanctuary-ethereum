...
contract mosqETHtos is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool artistSuccess, ) = payable(0xaF1cE624411Cb770132f850c6F47E8fdd34eB307).call{value: artistPayment}('');
    require(artistSuccess);

    (bool marketerSuccess, ) = payable(0x820F6f7f2d4ED99fC62879d160dDCfCc446a740c).call{value: marketerPayment}('');
    require(marketerSuccess);

    (bool assistantSuccess, ) = payable(0x800964190a74578B11eAf20e14CE63f44bCc4894).call{value: assistantPayment}('');
