...
contract OptionLp is BaseOptionLp {
     ...
     * @param token Strike token address
    ...
    function _fillLpPosition(
        ...
        if (lpPosition.usdLiquidity != 0) {
            ...
            underlyingPremium = Math.mulDiv(
                usdPremium,
                getSsovCollateralPrecision(ssov),
                getSsovCollateralPrice(ssov)
            );
            _fillUnderlying({
