...
contract DcentralNFT is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, ERC721RoyaltyUpgradeable, ERC721PausableUpgradeable, OwnableUpgradeable, NFTContractMetadataUpgradeable {
  ...
  function initialize(
    ...
    address _eventEmitterAddress
      ...
      require(hasInitialized == false, "Contract has already been initialized");
      hasInitialized = true;
      ...
      IDcentralEvent eventEmitter = IDcentralEvent(address(eventEmitterAddress));
  ...
  function setApprovalForAll(address operator, bool approved) public override(ERC721Upgradeable) {
    ...
    IDcentralEvent eventEmitter = IDcentralEvent(address(eventEmitterAddress));
    eventEmitter.emitSetApprovedForAll(
      address(this),
      operator,
      approved
    );
  ...
  function isApprovedForAll(address owner, address operator) override(ERC721Upgradeable) public view returns (bool) {
    // TODO: allow dcentral marketplaces to move around dcentral NFTs
  ...
  function _afterTokenTransfer(
    ...
    IDcentralEvent eventEmitter = IDcentralEvent(address(eventEmitterAddress));
    eventEmitter.emitTokenTransferred(
      from,
      to,
      address(this),
      tokenId
  ...
  function setTokenRoyalty(uint256 tokenId, address receiver, uint96 feeNumerator) public {
    require(mintAdmin == msg.sender || owner() == msg.sender, "Admin or owner rights required");
