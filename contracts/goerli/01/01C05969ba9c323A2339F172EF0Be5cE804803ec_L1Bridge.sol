...
// Clone adds common methods for minimal proxy with clone
abstract contract Clone {
    ...
    function createClone(bytes32 _salt, address _target) internal returns (address _result) {
        ...
        require(_result != address(0), "Clone: Failed on minimal deploy");
    }
    ...
    function computedCreate2Address(bytes32 salt, bytes32 bytecodeHash, address deployer)
        public
        pure
        returns (address)
    {
