...
contract KookyKats is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmeEar1BgcbVB5V3QQ3gAugjB7eQAgKXqsiC4JCZetejhg/";
    ...
    constructor() ERC721A("KookyKats", "KKAT") {
    ...
    /// @dev Airdrop KooKyKats
    function batchMint(address[] memory _who)
        external
        onlyMinter
        onlyUnderMaxSupply(1)
    {
