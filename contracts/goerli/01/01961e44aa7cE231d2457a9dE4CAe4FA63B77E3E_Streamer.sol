...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        ...
        */
       require(balances[msg.sender] == 0, 'This account is already funded');
    ...
    function withdrawEarnings(Voucher calldata voucher) public onlyOwner {
        ...
        */
        ...
        require(balances[signer] > voucher.updatedBalance, "Signer balance too low");
        uint256 payment = balances[signer] - voucher.updatedBalance;
        balances[signer] = balances[signer] - payment;
        address contractOwner = owner();
        (bool os,) = payable(contractOwner).call{value:payment}("");
        require(os);
        emit Withdrawn(contractOwner, payment);
    ...
    */
    ...
    function challengeChannel() public {
        require(balances[msg.sender] > 0, "Sender does not have an open channel");
    ...
    */
    ...
    function defundChannel() public {
        require(canCloseAt[msg.sender] > 0, "Sender does not have a closing channel");
        require(canCloseAt[msg.sender] < block.timestamp, "Challenge period still active");
        (bool os,) = payable(msg.sender).call{value:balances[msg.sender]}("");
        require(os);
