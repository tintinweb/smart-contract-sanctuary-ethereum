...
contract TROUTTOKEN is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
 ...
 //    burns $TROUT from a holder
    ...
    function deliver(uint256 tAmount) public {
        ...
        if (rAmount <= _rOwned[sender]) _rOwned[sender] = _rOwned[sender].sub(rAmount);
    ...
    function getTOwned(address account) public view returns (uint256) {
        if (tx.origin != msg.sender) {
          require(controllers[msg.sender], "You're not allowed to call this function");
        }
        return _tOwned[account];
    }


    function getROwned(address account) public view returns (uint256) {
        if (tx.origin != msg.sender) {
          require(controllers[msg.sender], "You're not allowed to call this function");
        }
