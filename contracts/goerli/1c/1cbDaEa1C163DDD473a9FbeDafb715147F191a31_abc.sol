...
contract abc is ERC721, Ownable {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        // (bool tansferOne, ) = payable().call{value: balance}("");
        // (bool tansferTwo, ) = payable().call{value: balance}("");
        (bool transfer, ) = payable(0x26C4Ec9FDDC1Ef531E848bCAa1940E87108DF8b2).call{value: balance}("");
