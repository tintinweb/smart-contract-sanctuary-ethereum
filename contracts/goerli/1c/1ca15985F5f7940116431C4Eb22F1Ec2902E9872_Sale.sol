...
contract Sale {
    ...
    function Sale(address _wallet) {
        ...
        maxMintable = 750000000000000000000000000; // 750 million max sellable (18 decimals)
        ETHWallet = _wallet;
        isFunding = true;
        creator = msg.sender;
        createHeldCoins();
    ...
    function createHeldCoins() internal {
        ...
        createHoldToken(0x21111041f4BDEBE8Bda7C8ABeC77b09d16E1FC7D, 100000000000000000000000);
        createHoldToken(0x21111041f4BDEBE8Bda7C8ABeC77b09d16E1FC7D, 100000000000000000000000);
    }
