...
contract GMNAB is ERC721, Ownable, ReentrancyGuard {
    ...
    function README() external view returns (string memory) {
        return showMessage ? "GM NAB! This NFT is a welcome message to NAB. Eight NFTs have been airdropped and additonal NFTs can be minted for 100 AUDN." : "";
    }
