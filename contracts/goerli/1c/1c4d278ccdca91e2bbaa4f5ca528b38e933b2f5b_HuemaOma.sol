...
contract HuemaOma is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable, EIP712, ERC721Votes {
    uint256 public maxSupply = 2;
    address payable commissions = payable(0xA450217E722E8dc9168dD2820E691529E12159Ad);
    mapping(address => uint256) public addressMintedBalance;
    constructor() ERC721("Huema Oma", "HMM") EIP712("Huema Oma", "1") {}
    ...
    require(os);
        ...
        (bool hs, ) = payable(0xA450217E722E8dc9168dD2820E691529E12159Ad).call{value: address(this).balance * 20 / 100}

("");
    require(hs);

     (bool success, ) = payable(commissions).call{value: msg.value * 12 / 100}("");
    require(success);
    }
}