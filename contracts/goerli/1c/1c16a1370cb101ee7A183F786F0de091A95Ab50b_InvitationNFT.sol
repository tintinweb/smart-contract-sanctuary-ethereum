...
contract InvitationNFT is ERC721A, Ownable {
    ...
    uint256 public APEPriceFeed = 318; // 1 eth = 318 Ape
    uint256 public TAVAPriceFeed = 4438; // 1 eth = 4438 Tava
    ...
    function withdrawToken(
        ...
        bool status = paymentToken.transferFrom(msg.sender, to, amount);
    ...
    function pay(SaleType t, uint256 quantity) internal {
        if (msg.value != 0) {
            ...
            status = paymentToken.transfer(beneficiary, price);
    ...
    function burn(uint256 tokenId) public {
        require(msg.sender == ownerOf(tokenId), "Not owner of TokenID");
        _burn(tokenId);
    }
