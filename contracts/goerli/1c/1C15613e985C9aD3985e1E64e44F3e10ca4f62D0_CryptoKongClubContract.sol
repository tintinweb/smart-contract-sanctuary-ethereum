...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1664251200;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xc4B589dC275eeC35F6C89D35c25c424E9Dc2B0F3];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xc4B589dC275eeC35F6C89D35c25c424E9Dc2B0F3;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.07 ether;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 6500) { }
...
// File: contracts/CryptoKongClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoKongClubContract is RamppERC721A {
    constructor() RamppERC721A("CryptoKongClub", "CKC"){}
}
