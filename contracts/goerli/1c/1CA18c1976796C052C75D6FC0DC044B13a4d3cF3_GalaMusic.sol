...
contract GalaMusic is IERC1155, ERC165, Pausable, CommonConstants, Ownable, IERC1155MetadataURI, UpdatableOperatorFilterer  {
    ...
    function uri(uint256 _tokenId) public override view returns (string memory) {
        if (isNonFungible(_tokenId)) {
            ...
            //return string(abi.encodePacked(baseURI, Strings.toString(baseType), "/", Strings.toString(instanceId), ".json"));
