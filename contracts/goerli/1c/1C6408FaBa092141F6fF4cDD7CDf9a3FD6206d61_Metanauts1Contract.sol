...
//*********************************************************************//
//
// The Metanauts are back
// They are heated to white
// First landing soon 
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmbLkMQwXZZYnDUfwXLDPv2qCf8eVuy6QezQrYNW8oQnJd/";
...
// File: contracts/Metanauts1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Metanauts1Contract is RamppERC721A {
    constructor() RamppERC721A("Metanauts1", "META"){}
}
