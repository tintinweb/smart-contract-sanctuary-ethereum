...
// File: contracts/DYORTEST.sol

pragma solidity ^0.8.14;

contract DYORTEST is ERC721A, Ownable {
  using Strings for uint256;
    ...
    address public constant devAddress = 0x18CFD5D250FC8f4ec3Ba8D425310F62e276F6949;
    address public constant teamAddress = 0xBf5756cE5D0568D3bf48768225A2A1149C084ffe;



  mapping(address => uint256) private _minted;

  constructor() ERC721A("DYOR BROS", "DYORB") {}
    ...
    function reveal() public onlyOwner {
     ...
     function withdraw() external onlyOwner {
        ...
        uint256 teamShare = (totalBalance * 95)/100;
        uint256 devShare = (totalBalance * 5)/100;
