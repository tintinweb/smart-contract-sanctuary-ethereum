 ...
 * @notice This contract handles minting DICK CHECKS tokens.
 */
contract DICKCHECKS is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x343bBe197f76A3b755770340D99c11D5e4FD0bcd;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x4630E1b1A6Ee4d431AE160d2205a3af1D6D5069e;
    address[] public payoutAddresses = [
        0x4630E1b1A6Ee4d431AE160d2205a3af1D6D5069e
    ];
    ...
    string public name = "DICK CHECKS";
    string public symbol = "DCL";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeiezp4vouk5avpd56tmuegnty3d5bg7wrstu7t72arof2rjjoy7kle/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicPrice[69] = 0.0069 ether;
        tokenPublicMintsPerAddress[69] = 0;
        tokenPresaleMaxSupply[69] = 0;
        tokenPresalePrice[69] = 0 ether;
        tokenPresaleMintsPerAddress[69] = 1;
        tokenPresaleSaleStartTime[69] = 1677531600;
        tokenPresaleSaleEndTime[69] = 1677877200;
        tokenUsePresaleTimes[69] = true;
        require(
