...
contract NyxDAO is Ownable {
    ...
    NyxVault public vault_contract;
    ...
    uint256 public redeemPricePerBaseVotingPower;
    ...
    {
        require(msg.sender == owner() || isTeamAddress(msg.sender) ||
            msg.sender == address(proposalCreator), "not called by proposal creator");
        _;
    }
    ...
    */
        ...
        onlyOwner
    {
        ...
        currentRedeem = 0;
        maxRedeem = liquidity;
        redeemPricePerBaseVotingPower = price;
    }
    ...
    */
        ...
        public onlyOwner
    {
        ...
        setVaultContract(nft_contract.vault_address());
    }

    function setVaultContract(address addr)
        public onlyOwner
    {
        vault_contract_address = addr;
        vault_contract = NyxVault(vault_contract_address);
    }
    ...
    function setMinVotingPeriod(uint _days)
        external
        onlyOwner
    {
        minimumVotingPeriod = _days * 1 days;
    }
    ...
    function getRedeemPrice(uint256 tokenId)
        ...
        returns (uint256)
    {
        uint256 tokenIdVotingPower = nft_contract.waveVotingPower(tokenId);
        uint256 redeemPrice = redeemPricePerBaseVotingPower * tokenIdVotingPower/nft_contract.BASE_VOTING_POWER();
        return redeemPrice;
    }
        ...
        public
    {
        ...
        require(nNfts + currentRedeem <= maxRedeem, "too muched NFTs redeemed");
        ...
        uint256 redeemPrice = getRedeemPrice(tokenId);
        uint256 redeemableAmount = redeemPrice * nNfts;

        require(vault_contract.approvedCallers(address(this)) == 1, "vault have to approve dao");

        vault_contract.transfer(address(0), payable(msg.sender), uint96(redeemableAmount));
        nft_contract.burnNFT(msg.sender, nNfts, tokenId);
    }
}
