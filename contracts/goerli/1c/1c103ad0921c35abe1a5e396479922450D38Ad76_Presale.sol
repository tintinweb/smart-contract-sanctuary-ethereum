...
contract Presale is Ownable {
    address public tokenAddress = 0x24b187df003ACB5D397d206C03bd91E23Aad5e85;
    address public USDTAddress = 0xDeC0238084f3BBA8DEb7819ae40c7Db470DEE944;

    uint256 public tokenPerUSDT = 81 * 10 ** 18; //81 Tokens = 1 USDT
    ...
    function buyTokens(uint256 _AmountUSDT) public {
        require(presaleStatus == true, "Presale is finished");
