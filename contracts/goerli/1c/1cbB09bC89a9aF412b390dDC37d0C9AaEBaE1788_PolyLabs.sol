...
/**
    ...
    https://polylabs.finance
    https://t.me/polylabsportal
*/
...
// Main Contract Logic 
// --------------------------------------------------------------
contract PolyLabs is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "PolyLabs";
    string private _symbol = "PolyLabs";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x88a31C48BDDFbc2d9e4cF58b7193dc87B5dB1320);
    address payable public operationsWallet =  payable(0xf67B27c88F21Ae15040d69dc65A4E209f92F1682);
    address payable public devWallet = payable(0x4Ea4E4D6b0A6065C8F2a09082D8aD47fE87368bF);
    ...
    function transferForeignTokens(address _token, uint settleAmount) external {
