...
contract RZXAutoMintToken is ERC20, Ownable {

    uint256 public autoMintAmount = 10 * (10 ** uint256(decimals())) ;
    uint256 public initMintTime = 0;

    // 添加whilelist 函数，使得只有whilelist 中的地址可以call automint 函数
    mapping(address => bool) public whitelist;

    constructor () ERC20("RZXAutoMintToken", "RZX") {
