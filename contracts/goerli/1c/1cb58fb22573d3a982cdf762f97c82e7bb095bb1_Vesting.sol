...
contract Vesting is Ownable, ReentrancyGuard {
     ...
     * @param _amount amount of tokens (in wei)
     */
    function updateVestingSchedule(address _beneficiary, uint256 _amount) external onlyOwner returns (bool) {
    ...
    function _availableDrawDownAmount(address _beneficiary) internal view returns (uint256 _amount) {
        ...
        _amount = timePassedSinceLastInvocation.mul(drawDownRate);
