...
contract Collective is ERC721A, Ownable, OperatorFilterer, MerkleProof {

    uint256 public maxToken = 1000;

    uint256 public wlTime; //1668834000
    uint256 public pbTime; //1668855600
    ...
    constructor(uint256 _wlTime, uint256 _pbTime) ERC721A("Collective", "COLLECT") OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), true) {
        sethiddenBaseURI("ipfs://QmPGHVxeUfvm7nj5jcfMcchWRsRFBeRw8RJQvZZhHqD7v4");
        wlTime = _wlTime;
        pbTime = _pbTime;
    }
