...
contract YokaiGenesis is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("YokaiGenesis", "YGS") {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 9;
