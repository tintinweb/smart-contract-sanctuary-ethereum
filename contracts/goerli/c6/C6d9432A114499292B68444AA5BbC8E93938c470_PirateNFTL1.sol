...
import "./IAfterTokenTransferHandler.sol";
...
abstract contract ERC721AfterTokenTransferHandler is Context, Ownable, ERC721{
    ...
    function _afterTokenTransfer(
        ...
        if (afterTokenTransferHandler != address(0)) {
            IAfterTokenTransferHandler handlerRef = IAfterTokenTransferHandler(
...
interface IAfterTokenTransferHandler {
    /**
    ...
    ERC721AfterTokenTransferHandler
{
    ...
    /** Constructor */
    constructor(uint256 _maxSupply) ERC721("Pirate", "PIRATE") {}
