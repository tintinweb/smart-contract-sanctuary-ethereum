 ...
 * @notice This contract handles minting Campfire Season Genesis Cards tokens.
 */
contract CampfireSeasonGenesisCards is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xe985ce9F9E779740fc63a26460D3595c4B3F82ed;
    address public royaltyAddress = 0x7142f458DD13e88a1B526E6d1cCA88Cd8D1199Df;
    address[] public payoutAddresses = [
        0x7142f458DD13e88a1B526E6d1cCA88Cd8D1199Df
    ];
    ...
    string public name = "Campfire Season Genesis Cards";
    string public symbol = "CSGC";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeid7vwf73yucljjon243ypiegjrrooxdsekmwd4n4bpfjeu7wuw5zy/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenMaxSupply[1] = 99999;
        tokenPresaleMaxSupply[1] = 99999;
        tokenPresalePrice[1] = 0 ether;
        tokenPresaleMintsPerAddress[1] = 9;
        tokenMaxSupply[2] = 99999;
        tokenPresaleMaxSupply[2] = 99999;
        tokenPresalePrice[2] = 0 ether;
        tokenPresaleMintsPerAddress[2] = 9;
        tokenMaxSupply[3] = 99999;
        tokenPresaleMaxSupply[3] = 99999;
        tokenPresalePrice[3] = 0 ether;
        tokenPresaleMintsPerAddress[3] = 9;
        tokenMaxSupply[4] = 99999;
        tokenPresaleMaxSupply[4] = 99999;
        tokenPresalePrice[4] = 0 ether;
        tokenPresaleMintsPerAddress[4] = 9;
        tokenMaxSupply[5] = 99999;
        tokenPresaleMaxSupply[5] = 99999;
        tokenPresalePrice[5] = 0 ether;
        tokenPresaleMintsPerAddress[5] = 9;
        tokenMaxSupply[6] = 99999;
        tokenPresaleMaxSupply[6] = 99999;
        tokenPresalePrice[6] = 0 ether;
        tokenPresaleMintsPerAddress[6] = 9;
        tokenMaxSupply[7] = 99999;
        tokenPresaleMaxSupply[7] = 99999;
        tokenPresalePrice[7] = 0 ether;
        tokenPresaleMintsPerAddress[7] = 9;
        tokenMaxSupply[8] = 99999;
        tokenPresaleMaxSupply[8] = 99999;
        tokenPresalePrice[8] = 0 ether;
        tokenPresaleMintsPerAddress[8] = 9;
        tokenMaxSupply[9] = 99999;
        tokenPresaleMaxSupply[9] = 99999;
        tokenPresalePrice[9] = 0 ether;
        tokenPresaleMintsPerAddress[9] = 9;
        require(
