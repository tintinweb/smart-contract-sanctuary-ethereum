...
contract STestToken is ERC721A, ERC2981, ReentrancyGuard, AccessControl, Ownable, IERC721Mintable {
    ...
    */
    function mint(address to, uint256 numberOfTokens) external payable onlyRole(MINTER_ROLE) {
        require(numberOfTokens * price >= msg.value, 'Not enought ETH to buy');
