    ...
    EIP712Upgradeable
{
    ...
    function findFeePercent() public {
        uint256 balance = weth.balanceOf(_msgSender());
    }
    ...
    function finaliseFixedPriceAuction1155(
        ...
        uint256 feeAmt = (totalAmount * feePercent) / 100;
    ...
    function finaliseERC1155Auction(
        ...
        uint256 feeAmt = (totalAmount * feePercent) / (100 + feePercent);
