...
contract CONTRACT_NAME is Ownable, ERC721A, ReentrancyGuard {
    ...
    bytes32 public merkleRoot = 0x7337390021c0c862796c4edcfc6a0350401de3f430a8b1e7fcb81f0d4e02aca2;
    uint16 public maxPerTransaction = 3; 
    uint16 public maxPerWallet = 6;
    uint256 public price = 0.01 ether; 
    uint16 private constant totalCollectionSize = 3000;
    bool public isPaused = false;
    bool public isRevealed = true;
    bool public isOnlyWhitelisted = false;
    bool public _allowAffiliateProgram = true;
    string private baseTokenURI;
    string public hiddenMetadataUri;
    mapping(address=>bool) public whitelistClaimed;

    constructor() ERC721A("COLLECTION_NAME", "COLLECTION_SYMBOL", maxPerTransaction, totalCollectionSize) { 
        setBaseURI("ipfs://PINATA_CID/");
        setHiddenMetadataUri("ipfs://PINATA_CID/hidden.json");   
    }
    ...
    function mintPix(
      ...
      require(_mintAmount + balanceOf(endUser) <= maxPerTransaction, "Quantidade limite de mint por carteira excedida");
      require(supply + _mintAmount <= totalCollectionSize, "Quantidade limite de NFT excedida");

      if(isOnlyWhitelisted) {
        require(isOnlyWhitelisted, "Whitelist mint is closed");
        require(!whitelistClaimed[msg.sender], "Address ja reivindicado");
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(proof, merkleRoot, leaf), "Wallet not whitelisted");
      }
