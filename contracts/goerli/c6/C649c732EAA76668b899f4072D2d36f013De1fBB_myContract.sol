...
contract myContract is ReentrancyGuard, ERC721A{
    ...
    string constant _tokenName = "wagmilabstestcontract";
    string constant _tokenSymbol = "WLTS";
    ...
    function modifyCanMint(address _address, bool _type) public onlyOwner{
        canMint[_address] = _type;
    }
