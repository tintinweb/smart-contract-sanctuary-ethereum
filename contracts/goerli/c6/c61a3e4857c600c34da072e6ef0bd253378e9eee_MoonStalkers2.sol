...
// File: Moonstalkers.sol
pragma solidity ^0.8.7;

contract MoonStalkers2 is ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard {
    ...
    // ===== Constructor =====
    constructor() ERC721A("MoonStalkers2 Official", "MOONSTLR2") {}
    ...
    // ===== Public mint =====
     function mint(uint256 _mintAmount) public payable nonReentrant {
        ...
        require(StartMint, "I am not ready to lick yet. Be Patient!");
        require(s + _mintAmount <= collectionSize, "Sold out!");
    ...
    // ===== Setter (owner only) =====
    function setStartMint(bool _startminting) external onlyOwner {
        StartMint = _startminting;
    }
