...
contract Minter is Ownable, ReentrancyGuard, IMinter {
    ...
    function purchase(
        ...
        // CHECKS
        uint256 gasPriceInWei = gashapondoContract.getCollectionGasPriceInWei(collectionId);
        ...
        // EFFECTS
        tokenIds = gashapondoContract.mintBatch(to, collectionId, numberOfTokens);
        ...
        bool paymentSuccess;
        IGashapondo.PaymentMetadata memory paymentMetadata = gashapondoContract.getCollectionPaymentMetadata(
            collectionId
        );
        // pay to platform
    ...
    function purchaseWithErc20(
        ...
        // CHECKS
        bool isErc20TokenPaymentSupported = gashapondoContract.isErc20TokenPaymentSupported(collectionId, erc20Token);
        require(isErc20TokenPaymentSupported, "Erc20 token is not supported");

        uint256 erc20TokenPriceInWei = gashapondoContract.getCollectionErc20TokenPrice(collectionId, erc20Token);
...
interface IMinter {
    ...
    function setGashapondo(address gashapondo) external;
}
