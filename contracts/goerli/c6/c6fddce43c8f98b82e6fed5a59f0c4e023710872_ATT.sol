...
contract ATT is ERC20Capped, AccessControl,Ownable {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    using SafeERC20 for IERC20;

    //cap the supply of token to 17,000
    constructor() ERC20("Agatobwe","ATT") ERC20Capped(170000 * (10**18)) {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(MINTER_ROLE, 0xCe1B69Ad3c262fa74830127cEDa3c775fba3242f);
    }
    ...
    function isPrimaryMarketActive() public view returns (bool) {
    ...
    function setBondExpiry() public onlyOwner {
        isBondExpired = true;
    }

    function seeBondExpiryStatus() public view returns (bool) {
        return isBondExpired;
    }

    string public termsATT = "https://www.frigg.eco/";

    //update URL to include pdf embedded in the microsite
