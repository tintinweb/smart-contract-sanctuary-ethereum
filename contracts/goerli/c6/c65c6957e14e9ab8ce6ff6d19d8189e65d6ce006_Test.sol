...
contract Test {
    ...
    //使用者購買專輯
    mapping(uint => mapping (uint=> personal))public playerlist;
    ...
    //2.使用者購買專輯(v)
    function collect(uint _Uid, uint _id) public payable{
    ...
    function play(uint _Uid, uint _id)public view returns (music memory,personal memory){
