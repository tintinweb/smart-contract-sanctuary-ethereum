...
contract StakeLarp is Pausable, Ownable, ReentrancyGuard {
    ...
    function claimReward() external returns (bool){
        ...
        LarpToken.transfer(_msgSender(), totalTokens);
    ...
    function stakeToken(uint256 stakeAmount) external payable whenNotPaused {
        ...
        require(LarpToken.balanceOf(_msgSender()) >= stakeAmount, "Insufficient Balance");
        
           LarpToken.transferFrom(_msgSender(), address(this), stakeAmount);
            totalStakers++;
