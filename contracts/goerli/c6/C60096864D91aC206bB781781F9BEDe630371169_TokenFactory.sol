 ...
 */
contract MasterContractsRegistry is IMasterContractsRegistry, AbstractContractsRegistry {
     ...
     */
    function __MasterContractsRegistry_init() external initializer {
     ...
     * @inheritdoc IMasterContractsRegistry
     */
    function getTokenRegistry() external view override returns (address) {
     ...
     */
    function injectDependencies(string calldata name_) external {
     ...
     */
    function removeContract(string calldata name_) external {
 ...
 * ERC20 and ERC721 tokens via the ReviewableRequests core contract. Deploys beacon proxies.
 */
contract TokenFactory is ITokenFactory, AbstractPoolFactory {
    ...
    function deployERC721(
        IERC721.ConstructorParams calldata params_
    ) external override {
        string memory tokenType_ = _tokenRegistry.ERC721_NAME();

        address tokenProxy_ = _deploy(address(_tokenRegistry), tokenType_);

        ERC721(tokenProxy_).__ERC721_init(params_);

        _register(address(_tokenRegistry), tokenType_, tokenProxy_);
        _injectDependencies(address(_tokenRegistry), tokenProxy_);

        emit DeployedERC721(tokenProxy_, params_);
    }
...
contract TokenRegistry is ITokenRegistry, AbstractPoolContractsRegistry {
    ...
    string public constant ERC20_NAME = "ERC20";
    string public constant ERC721_NAME = "ERC721";
...
interface IMasterContractsRegistry {
    ...
    /**
     * @notice The function to get the TokenFactory contract
     * @return TokenFactory contract address
     */
    function getTokenFactory() external view returns (address);

    /**
     * @notice The function to get the TokenRegistry contract
...
interface ITokenFactory {
    /**
     * @notice The event that gets emitted when new ERC20 token is deployed
     * @param token the address of the token
     * @param params the token constructor params
     */
    event DeployedERC20(address token, IERC20.ConstructorParams params);
    /**
     * @notice The event that gets emitted when new ERC721 token is deployed
     * @param token the address of the token
     * @param params the token constructor params
     */
    event DeployedERC721(address token, IERC721.ConstructorParams params);

    /**
     * @notice The function to deploy the requested ERC20 token. Will be called by a ReviewableRequests contract
     * @param params_ the specified constructor params of the ERC20 token
     */
    function deployERC20(IERC20.ConstructorParams calldata params_) external;

    /**
     * @notice The function to deploy the requested ERC721 token. Will be called by a ReviewableRequests contract
     * @param params_ the specified constructor params of the ERC721 token
     */
    function deployERC721(IERC721.ConstructorParams calldata params_) external;
}
...
interface IERC721 is IERC721EnumerableUpgradeable {
    struct ConstructorParams {
        string name;
        string symbol;
        string contractURI;
...
/**
 * @notice THe ERC721, standard realization.
 */
contract ERC721 is
    IERC721,
    ...
    ContractMetadata
{
     ...
     * @inheritdoc IERC721
     */
    function setBaseURI(string calldata baseURI_) external override  {
        baseURI = baseURI_;
    }
    ...
    function supportsInterface(
        ...
        returns (bool)
    {
        return interfaceId_ == type(IERC721).interfaceId || super.supportsInterface(interfaceId_);
    }
