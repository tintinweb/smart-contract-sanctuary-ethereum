...
contract TheEscapeVerseCollection is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public presaleTokenPrice = 0.07 ether;
    ...
    uint256 public currentMaxTokens = 1000;
    ...
    function addIqPoints(uint256[] calldata tokenIds, uint256[] calldata points, bytes32 hash, bytes memory signature, string memory nonce) external {
        ...
        require(hashTransaction(msg.sender, nonce) == hash, "Hash does not match");
