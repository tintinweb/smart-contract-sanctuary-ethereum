...
contract VermCity is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    ) public ERC721A("Verm City NFT", "VERM CITY") {
    ...
    function ogMint(uint256 _num, bytes32[] memory _proof) external payable {
        ...
        // Use Merkle Tree for whitlisting validation
        ...
        require(vcNum + _num <= maxvcNum, "Num must lower maxWhitelistNum");
