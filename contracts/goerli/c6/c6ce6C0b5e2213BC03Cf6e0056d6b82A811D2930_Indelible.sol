// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"background", unicode"Base Character", unicode"Clothes", unicode"Headwear", unicode"Eyes"];
        ...
        constructor() ERC721A(unicode"Sparroz", unicode"Sprz") {
            TIERS[0] = [150,575,1027,1729,2074];
            TIERS[1] = [1587,1947,2021];
            TIERS[2] = [85,335,548,689,754,919,1092,1133];
            TIERS[3] = [38,62,98,107,109,120,174,175,181,249,326,334,388,602,638,665,1289];
            TIERS[4] = [336,2485,2734];
