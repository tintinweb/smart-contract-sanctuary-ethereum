...
contract ParcelMinter is Minter {
    ...
    * @dev Returns eip712-compatible encoded hash required to be signed by priv key with `PARCEL_MINTER_ROLE` for `mintParcelWithERC20`
        ...
        keccak256(
            abi.encodePacked(
                ...
                keccak256(
                    abi.encode(
                        keccak256(
                            "mintParcelWithERC20(address to_, uint256 parcelId_, uint256 erc20Price_, address erc20Address_, IParcel.MintParams memory mintParams_, uint256 signatureDeadline_, bytes memory signature_)"
                        ),
                        to_,
                        parcelId_,
                        mintParams_,
    ...
    function mintParcelWithERC20(
        ...
        parcel.mintTo(to_, parcelId_, mintParams_);
        require(IERC20(erc20Address_).transferFrom(to_, address(fundsStorage), erc20Price_), "ParcelMinter: transferFrom failed");
    }
}
...
abstract contract DotEarthERC721 is Ownable, DotEarthERC721Royalty, IDotEarth721 {
    ...
    * @dev Gas optimised version of regular OpenZeppelin _mint function with totalSupply counting
    ...
    function emergencyTransferFrom(
        ...
        address to,
        uint256 tokenId
    ) public virtual override onlyAdminRole {
