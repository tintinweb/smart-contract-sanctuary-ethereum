...
// File: contracts/new_contract.sol
...
contract IOIA is ERC721, Ownable, ReentrancyGuard {
   ...
   bytes32 public root;
   string public preRevealURL = "https://fuchsia-secure-shrimp-103.mypinata.cloud/ipfs/QmeLAHruyVwFCEDUNxAWaDEbcetzV7vBfwcMXeysMpuRgK";
   mapping(address => uint) public mintedCount;
   mapping(uint256 => uint256) public allowList;
   bool public allowTransfer;
   
   constructor() ReentrancyGuard() ERC721("IOAI V7T", "IOAII"){}
   ...
   function _baseURI() internal pure override returns (string memory) {
       return "https://fuchsia-secure-shrimp-103.mypinata.cloud/ipfs/QmYKfoSYeMKhjfw8hfRCgoMzSbHZddjR3gbXVQKt2jAZew/";
   }
   ...
   function privateMint(uint8 numberOfTokens) nonReentrant() external payable {
       require(saleStatus != SaleStatus.PAUSED, "IOIAI: Sales are Paused");
    ...
    function _beforeTokenTransfer(
        ...
        if(from != address(0) && to != address(0)){
            if(allowTransfer){
                ...
                require(allowList[tokenId]  != 0, "can not transfer if bid is below 0.5 ETH");
