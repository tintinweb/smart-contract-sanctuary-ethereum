    ...
    ERC721AQueryableUpgradeable
{
    ...
    function burn(uint256[] memory tokenIds) external onlyRole(EXCHANGER_ROLE) {
    ...
    function mintersOf(uint256 stage) external view returns (address[] memory) {
        ...
        return stageDetail.minters.values();
    }
    ...
    function stagesMintedOf(address account)
        external
        view
        returns (bool[] memory)
    {
        ...
        returns (bool)
    {
        ...
        return stageDetail.minters.contains(account);
    }
    ...
    function _performMint(address account, uint256 stage) private {
        ...
        stageDetail.minters.add(account);
