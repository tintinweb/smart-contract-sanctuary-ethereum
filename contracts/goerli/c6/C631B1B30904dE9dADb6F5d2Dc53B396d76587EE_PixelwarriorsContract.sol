...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x6CF57E29e9C45dD8728B74C0C4D533f35a7ADFb2];
  address public erc20Payable = 0x6CF57E29e9C45dD8728B74C0C4D533f35a7ADFb2;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 2500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiavwz3eftdcwa264cvtuzye464zjkn7olkfaexxa2trkspt4aly3q/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/seM4iHPRyYCN9mHEAvLa/contract-metadata";
  }
...
// File: contracts/PixelwarriorsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixelwarriorsContract is RamppERC721A {
    constructor() RamppERC721A("pixel warriors", "PXW"){}
}
