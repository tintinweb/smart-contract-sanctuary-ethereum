...
contract ActionFundsStorage is IActionFundsStorage {
    ...
    event ActionFundsReceived(string actionType, string actionId, uint256 tokenId, uint256 amount);
    ...
    * @notice Returns address of message signer.
    ...
    function payForTheAction(
        ...
        // TODO use dedicated function after next redeployment
        accessController.checkRole(
            keccak256("ACTION_ADMIN_ROLE"),
            _getSigner(messageHash, signature_)
        );

        emit ActionFundsReceived(actionType_, actionId_, tokenId_, msg.value);
    }
}
