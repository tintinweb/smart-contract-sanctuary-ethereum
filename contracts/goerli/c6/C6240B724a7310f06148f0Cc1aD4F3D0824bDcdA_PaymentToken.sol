...
interface IProjectShares {
    function investAtInitialSale(uint256 amount, address sendTo) external;
}
...
contract PaymentToken is ERC20, Ownable {
    ...
    function investAtInitialSaleProxy(
        address project,
        ...
        IProjectShares(project).investAtInitialSale(sharesAmount, msg.sender);
