...
contract MekaDrivers is ERC721AMint, MultiMint, MerkleProofVerify, Withdraw {
    ...
    ERC721A("MekaDrivers", "DRIVERS") {
        ...
        setMaxSupply(200); // test value

        _setMint("HOLDERS", Mint(1674759600, 1674846000, 200, 200, 0.0 ether, false, true)); // test value
        _setMint("WHITELIST", Mint(1674846000, 1674932400, 5, 5, 0.0 ether, false, true)); // test value
        _setMint("PUBLIC", Mint(1674932400, 2654875480, 5, 5, 0.0 ether, false, true)); // test value
