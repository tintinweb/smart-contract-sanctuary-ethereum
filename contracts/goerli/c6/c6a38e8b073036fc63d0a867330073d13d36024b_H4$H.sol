...
contract H4$H is Context, IERC20, Ownable {
    ...
    string private constant _name = "VEXD";
    string private constant _symbol = "VEXD";
    ...
    address payable private _developmentAddress = payable(0x6923D06ED623389561e395aaD83f230f34D4fA6A); 
    address payable private _marketingAddress = payable(0x6923D06ED623389561e395aaD83f230f34D4fA6A);
