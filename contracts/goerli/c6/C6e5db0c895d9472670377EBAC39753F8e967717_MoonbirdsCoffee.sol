...
//                       _    _        _              __  __         
//   _ __  ___  ___ _ _ | |__(_)_ _ __| |___  __ ___ / _|/ _|___ ___ 
//  | '  \/ _ \/ _ \ ' \| '_ \ | '_/ _` (_-< / _/ _ \  _|  _/ -_) -_)
//  |_|_|_\___/\___/_||_|_.__/_|_| \__,_/__/ \__\___/_| |_| \___\___|
//                                                               
//       )  (
//      (   ) )
//       ) ( (
...
contract MoonbirdsCoffee is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    uint256 public salePrice = 0.17 ether;
    ...
    ) ERC721("Moonbirds Coffee Co.", "MNBRDCFE") {
        ...
        maxPunchCardsPerWallet()
    {
        uint256 tokenId = nextTokenId();
         ...
         _setTokenURI(tokenId, coffeeTokenURI(tokenId));
    ...
    function coffeeTokenURI(uint256 tokenId) public view returns (string memory) {
        require(_exists(tokenId), "Nonexistent token");
        string memory json = Base64.encode(
            bytes(
                abi.encodePacked(
                    '{"name": "Moonbirds Coffee Co. - Member #', tokenId.toString(), '",',
                    '"image": "', stampURI, currentPunchCount(tokenId).toString(), '.jpg",',
                    '"attributes": [{"trait_type": "Bags", "value": ', uint2str(punchCards[tokenId].punchCount), '},',
                    '{"trait_type": "Rewards", "value": ', currentRewardCount(tokenId).toString(), '}',
                    ']}'
                )
            )
        );
