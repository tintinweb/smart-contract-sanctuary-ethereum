    ...
    ReentrancyGuardUpgradeable
{
    ...
    function getNFTPrice(uint256 _nftPrice) public view returns (int256){
         (,int price,,,) = priceFeed.latestRoundData();
        
        int result = price * int(_nftPrice);
...
// implementation contract ---- 0xc60b4e1dba15c49ea7138a89155ca42a5355f5cf