...
contract Staker {
  ...
  event Stake(address indexed sender, uint256 val);
  ...
  function stake() public payable {
    console.log("staking is processing!");
  ...
  function timeReset() public completed {
  ...
  function withdraw() public notCompleted {
    ...
    require(balances[msg.sender] > 0, "There is no asset to withdraw");
    withdrawer = payable(msg.sender);
    withdrawer.transfer(balances[msg.sender]);
