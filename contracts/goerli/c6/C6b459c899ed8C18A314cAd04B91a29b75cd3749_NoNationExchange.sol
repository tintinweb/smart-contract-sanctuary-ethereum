    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x70062e84c3cceffc8018d3a6a318920bbdab3f78cc2992b1c62f5acee9e0db59, // keccak256("NoNationExchange")
        ...
        // bytes32 domain1 = keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)");
        // bytes32 domain2 = keccak256("NoNationExchange");
        bytes32 domain3 = keccak256(bytes("5"));
        // console.log("Print");
        // console.logBytes32(domain1);
        // console.logBytes32(domain2);
        console.logBytes32(domain3);
