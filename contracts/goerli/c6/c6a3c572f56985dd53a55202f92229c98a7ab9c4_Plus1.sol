...
import "./IPlus1.sol";
import "./ITokenOwner.sol";
import "./LibStringReplace.sol";

contract Plus1 is IPlus1, ERC721, Initializable, Owned {
    ...
    /// @param _initialURI     The initial URI to be used in tokenURI function.
    ...
    {
        return LibStringReplace.replace(_uri, "{id}", id.toString());
    }
    ...
    /// @param newURI The new URI. Use the {id} placeholder to be replaced by tokenID.
