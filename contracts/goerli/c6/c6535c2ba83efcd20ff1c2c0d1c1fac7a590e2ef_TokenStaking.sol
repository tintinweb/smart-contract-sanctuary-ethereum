...
// File: Staking/APY/TestToken.sol
...
// File: Staking/APY/TokenStaking.sol
...
contract TokenStaking {
    ...
    mapping(address => bool) private isStakingAtm;
    mapping(address => bool) private customIsStakingAtm;

    //array of all stakers
    address[] private stakers;
    address[] private customStakers;
    ...
    //customAPY airdrop: [airdrop - to sending tokens to multiple accounts for free. ]
    function customRewards() public {
        require(msg.sender == owner, "Only contract creator can redistribute");
        // require(address(this).balance,"not enough balance");
