...
// | $$  \ $$| $$      | $$  \ $$   | $$   
// | $$  | $$| $$$$$$$$| $$$$$$$/   | $$   
// |__/  |__/|________/|_______/    |__/   

// DEV BY JAWN                                        
                                        

contract REBT is ERC721, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_PRE_SALE_MINTS = 5;
    ...
    constructor(address _royaltyReceiverAddress)
        ERC721("Real Estate Blockchain Token", "REBT")
    {
