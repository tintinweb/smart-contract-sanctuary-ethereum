...
mapping(address => board) boarder;

board[]State;

function setQuestion(string memory) public {}

function setAnswer(string memory) public {}


function setState(string memory _question , string memory _questionCancel , string memory _questing , string memory _questionfinish)
public {}
