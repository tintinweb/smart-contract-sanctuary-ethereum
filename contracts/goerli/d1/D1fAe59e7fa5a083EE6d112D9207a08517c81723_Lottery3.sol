...
contract Lottery3 {
    ...
    function pickWinner3() public {
        ...
        owner_prize1 = totalAmount3.mul(owner_prize1).div(100);
        owner_prize2 = totalAmount3.mul(owner_prize2).div(100);
        owner_prize3 = totalAmount3.mul(owner_prize3).div(100);
