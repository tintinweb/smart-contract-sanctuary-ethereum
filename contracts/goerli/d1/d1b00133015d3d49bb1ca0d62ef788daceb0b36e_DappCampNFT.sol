...
contract DappCampNFT is ERC721Enumerable, Ownable {
    ...
    function pluck(
        uint256 tokenId,
        string memory keyPrefixSith,
        string[] memory sourceArray
    ) internal pure returns (string memory) {
        uint _randomNumberSith = random(string(abi.encodePacked(keyPrefixSith, Strings.toString(tokenId))));
        uint _indexSith = _randomNumberSith % sourceArray.length;

        string memory selectedSith = sourceArray[_indexSith];
    ...
    {
        string memory sithLord = pluck(tokenId, "sith", sith);
        
        string memory svgOpening = '<svg width="256px" height="200px" viewBox="-96 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M296 160H180.6l42.6-129.8C227.2 15 215.7 0 200 0H56C44 0 33.8 8.9 32.2 20.8l-32 240C-1.7 275.2 9.5 288 24 288h118.7L96.6 482.5c-3.6 15.2 8 29.5 23.3 29.5 8.4 0 16.4-4.4 20.8-12l176-304c9.3-15.9-2.2-36-20.7-36z"/><style>.base { fill: red; font-family: serif; font-weight: bold; font-size: 30px; }</style><text x="-120" y="450" class="base">';
        string memory svgClosing = '</text></svg>';
        
        string memory jsonPart1 = '{"name": "Sith Lord #';
        string memory jsonPart2 = '", "description": "A collection of the most powerful Sith the galaxy has ever known.", "image": "data:image/svg+xml;base64,';
        string memory jsonClosing = '"}';

        string memory svgTotal = Base64.encode(abi.encodePacked(svgOpening, sithLord, svgClosing));

        string memory output = Base64.encode(abi.encodePacked(jsonPart1, Strings.toString(tokenId), jsonPart2, svgTotal, jsonClosing));
