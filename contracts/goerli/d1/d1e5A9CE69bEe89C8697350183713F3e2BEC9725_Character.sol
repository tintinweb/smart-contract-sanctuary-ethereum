...
// File contracts/interfaces/IBag.sol
...
// File contracts/interfaces/IUnpacker.sol
...
// File contracts/interfaces/IMinterManaged.sol
...
// File contracts/helpers/Permissions.sol
...
// File contracts/helpers/MinterManaged.sol
...
// File contracts/interfaces/IMinterPro.sol
...
// File contracts/mocks/MockedAsset.sol

pragma solidity ^0.8.15;

contract MockedAsset is IAsset, ERC1155 {
    string public baseURI;
    ...
    ) payable ERC1155(name) {
        mint(initialAccount, tokenId, initialBalance, bytes(""));
    }
    ...
    function mint(
        ...
        _mint(to, uint256(tokenId), uint256(amount), data);
    }
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155, IAsset) returns (bool) {
        return
            interfaceId == type(IAsset).interfaceId || // ???
            interfaceId == type(IERC1155).interfaceId || // 0x80ac58cd
            interfaceId == type(AccessControl).interfaceId;
    }
}
...
// File contracts/mocks/MockedERC20.sol
...
// File contracts/mocks/MockedUnpacker.sol

pragma solidity ^0.8.15;

contract MockedUnpacker is IUnpacker, IERC165 {
    MockedAsset public asset_;

    constructor(address asset) {
        asset_ = MockedAsset(asset);
    }

    function unpack(uint256 tokenId, address to) public {
        // tokenID is a bag tokenID, not an asset tokenID
        asset_.mint(to, 0, uint32(1), "");
    }

    /**
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IUnpacker, IERC165) returns (bool) {
        return interfaceId == type(IUnpacker).interfaceId || interfaceId == type(IERC165).interfaceId;
    }
}

// SPDX-License-Identifier: MIT

// File contracts/mocks/MockedMultisig.sol
