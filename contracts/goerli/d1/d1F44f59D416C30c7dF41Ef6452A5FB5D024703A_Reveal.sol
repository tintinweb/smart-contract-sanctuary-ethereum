...
contract Reveal is ERC721URIStorage{
    ...
    string private revealURL = "ipfs://QmS4NXmtuZN2k339WdT16Phm8NToJduU4qqcBWFgVRapgw/1.json";

    constructor() ERC721("RC","RC")
    {

    }

    function mintNFT(address collector,string memory _tokenURI) public returns(uint256)
    {
        _tokenIds.increment();
    ...
    function changeRevealed()public
    {
        revealed = !revealed;
    }
    ...
    function changeMetadata(uint256 _tokenId,string memory _str)public 
    {
        _setTokenURI(_tokenId,_str);
