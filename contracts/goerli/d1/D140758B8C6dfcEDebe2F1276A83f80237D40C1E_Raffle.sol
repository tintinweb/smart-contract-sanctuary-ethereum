 ...
 * @author Minh Uchiha
 * @notice This contract is for creating untamperable raffle
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    function checkUpkeep(
        ...
        upkeepNeeded = (isOpen && isTime && hasBalance && hasPlayers);
    }
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        // Request random number and do sth with it
    ...
    function fulfillRandomWords(
        ...
        uint256 randomIdx = randomWords[0] % s_players.length;
        address payable recentWinner = s_players[randomIdx];
    ...
    // Function to get a player at an index
    function getPlayer(uint256 index) public view returns (address) {
        return s_players[index];
    }

    // Function to get the raffle state
    function getRaffleState() public view returns (RaffleState) {
        return s_raffleState;
    }

    // Function to return the numwords
