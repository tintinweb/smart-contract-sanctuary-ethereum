...
contract Vault is NonblockingLzApp {
    ...
    function _nonblockingLzReceive(
        ...
        address _to;
        (uint256 paymentToTransferInEth, address userAddress) = abi.decode(_payload, (uint256, address));
        assembly {
            _to := mload(add(userAddress, 20))
        }
        payable(_to).transfer(paymentToTransferInEth);
    }
}
