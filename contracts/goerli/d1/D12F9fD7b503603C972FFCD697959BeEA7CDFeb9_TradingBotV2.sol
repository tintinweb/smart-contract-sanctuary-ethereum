...
contract TradingBotV2 is ReentrancyGuard, ChainlinkClient {
    ...
    function getERC20Symbol(address contractAddress) public view returns (string memory) {
        return ERC20(contractAddress).symbol();
    }

    function getComposedUrl() public view returns (string memory) {
