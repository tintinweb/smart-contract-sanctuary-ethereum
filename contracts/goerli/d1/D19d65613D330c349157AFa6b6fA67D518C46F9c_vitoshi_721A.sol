...
import './extensions/DefaultOperatorFilterer.sol';

contract vitoshi_721A is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {  
  ...
  bool public whitelistMintingOpen;
	...
	constructor() ERC721A("VC TEST", "VCTST") {}
