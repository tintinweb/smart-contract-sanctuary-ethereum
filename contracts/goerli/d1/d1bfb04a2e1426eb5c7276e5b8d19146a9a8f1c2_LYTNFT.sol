...
contract LYTNFT is ERC721Enumerable,Ownable {
    constructor() ERC721("LYTNFT", "LytNFT") {}

    string private _buri;
    string private constant SUFFIX_URI = ".json";
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(baseTokenIdUri,SUFFIX_URI));
    }
