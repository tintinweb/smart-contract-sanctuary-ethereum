...
// File contracts/TiersOneThirtySevenXContract.sol

pragma solidity ^0.8.0;

contract TiersOneThirtySevenXContract is
  ERC165,
  ERC1155,
  Ownable,
  ReentrancyGuard
{
  ...
  function mintReserve(uint256 amount) external onlyOwner {
  ...
  function supportsInterface(
    bytes4 interfaceId
  ) public view override(ERC165, ERC1155) returns (bool) {
  ...
  function _beforeTokenTransfer(
    ...
    if (!(from == address(this)) || (from == owner() && address(0) == to))
