...
contract Fifotooi is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0xA450217E722E8dc9168dD2820E691529E12159Ad).call{value: address(this).balance * 5 / 100}("");
    require(hs);
