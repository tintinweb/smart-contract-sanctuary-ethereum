...
contract Gh0st is ERC721Enumerable, Ownable, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 0;
    uint256 MAX_MINT_ETHEREUM = 50;
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("Gh0st", "gg") { 
        _owner = msg.sender;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 4, "GG: Max 3 NFTs per transaction");
