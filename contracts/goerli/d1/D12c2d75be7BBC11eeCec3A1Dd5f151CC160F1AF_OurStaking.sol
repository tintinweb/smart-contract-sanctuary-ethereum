...
contract OurStaking is Ownable, ReentrancyGuard {
    ...
    modifier validStakeIndex(address _stakeholder, uint256 _index) {
        ...
        require(_index < _stakes.length, "OurStaking: stake does not exist");
        _;
    }
        ...
        validRewardPlanIndex(_rewardPlanIndex)
    {
        ...
        require(_rewardPlan.deletedAt == 0, "OurStaking: reward plan does not exist");
    ...
    function removeRewardPlan(uint256 _index)
        ...
        validRewardPlanIndex(_index)
    {
        require(rewardPlans[_index].deletedAt == 0, "OurStaking: reward plan does not exist");
