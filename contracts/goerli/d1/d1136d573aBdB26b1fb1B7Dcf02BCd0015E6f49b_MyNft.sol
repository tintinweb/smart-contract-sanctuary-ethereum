...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    uint256 public presaleMaxPerTransaction = 20;
    ...
    address[] public withdrawAddresses = [0x22573b1225c1dBF6fAc7285E86cB48530dE3b677, 0xcc0756D7586Ec64B44F7fdf2f023829e03dAaa4f];
    uint256[] public withdrawPercentages = [15, 85];


    bytes32 public merkleRoot = 0xe0d83b0386cb62aeaf8ae7f1a6900fb56962640d992568ee0a5c5e44e6b6f9c6;

    constructor() ERC721("testing1", "test") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1603577079642202114/metadata/";
        _setDefaultRoyalty(0xcc0756D7586Ec64B44F7fdf2f023829e03dAaa4f, uint96(500));
    }
