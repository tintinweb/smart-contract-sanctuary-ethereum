...
contract FlokiFaceToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private prevSellMarketingFee;
    uint256 private prevSellLiquidityFee;
    ...
    constructor() ERC20("FlokiFace Token", unicode"ᐢ(ˆᴥˆ)ᐢ") {
        ...
        uint256 _buyLiquidityFee = 0;
         ...
         uint256 _prevSellMarketingFee = 5;
        ...
        maxWallet = totalSupply; // 100% maxWallet
        ...
        marketingWallet = address(0xB3B9eeDA5F3Abc153A19908895777dA4277d1534); 
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _prevSellMarketingFee) external onlyOwner {
