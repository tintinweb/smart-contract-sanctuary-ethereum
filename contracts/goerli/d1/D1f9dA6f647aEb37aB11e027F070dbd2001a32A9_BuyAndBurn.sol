...
contract BuyAndBurn is ReentrancyGuard {
    ...
    function processCarn(Ops op) external nonReentrant {
        ...
        uint128 callerReward = (amount * 10000) / 1000000; // amount *10000 gives 1% of the carn amount * 625 give 0.0625% of the carn
        amount -= callerReward;
        ...
        if (op == Ops.BURN) {
            ...
            carnSentToPulseBitcoinLockNftRewards += amount;
