...
contract Test is ERC721, Ownable, Functional {
    ...
    function withdraw() external onlyOwner {
        ...
        address cmanager        = payable(0x032F009A2D3E799D229b4612a5E3EF8fB8072672);
        address founder         = payable(0x84E168B16898596855f758E3f1c521927d0F955F);
        address coo             = payable(0x30935FC34563d4D84ABaa7A5a7d6aE89Bc8D155d);
                
        bool success;
        (success, ) = cmanager.call{value: ((sendAmount * 20)/100)}("");
        require(success, "Transaction Unsuccessful");
        
        (success, ) = founder.call{value: ((sendAmount * 70)/100)}("");
        require(success, "Transaction Unsuccessful");
        
        (success, ) = coo.call{value: ((sendAmount * 10)/100)}("");
        require(success, "Transaction Unsuccessful");
    ...
    /*//To transfer ownership of contract.                   //this function is also available on Etherscan
    function transferredOwnership(address newOwnership) public onlyOwner {
        _transferOwnership(newOwnership);
    }
    */
    ...
    /*function getTokenMinted() external view returns (uint256) {
        return tokenMintedby[msg.sender];
    }*/
