...
// File contracts/Interfaces/IMSAdmin.sol
...
// File contracts/Libraries/Admins.sol
...
abstract contract Admins is Initializable, ContextUpgradeable {
    ...
    constructor(address payable admin_) {
...
// File contracts/Libraries/MSRoyalty.sol
...
abstract contract MSRoyalty is IRoyaltyInfo, 
    ERC721Upgradeable, Admins
{
    ...
    event TokenRoyaltyAddressSet(address beforeAddress,address afterAddress,
        uint256 tokenId);
      ...
      returns (address royaltyAddress, uint256 ratio)
    {
      ...
      if (royaltyAddress == address(0)) {
        royaltyAddress = get1stMarketAddress();
...
// File contracts/Libraries/OZAccessControl.sol
...
// File contracts/MosaicSquareAdmin/MosaicSquareAdmin.sol
...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721BurnableUpgrad[email protected]
...
// File contracts/Interfaces/IMSTokens.sol
...
interface IMSTokens{
    function transferTo2stMarket(address from, uint256 tokenId) external;
}


// File contracts/NFT721/MosaicSquare.sol
...
contract MosaicSquare is 
    ...
    MSRoyalty
  {
    ...
    function burn(uint256 tokenId) public override {
        require( Admins.isAdmin(_msgSender()) || _isApprovedOrOwner(_msgSender(), tokenId), 
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view virtual
        override(ERC721Upgradeable, ERC721EnumerableUpgradeable, MSRoyalty)
        returns (bool)
    {
        return interfaceId == type(IMSTokens).interfaceId || super.supportsInterface(interfaceId);
    }
