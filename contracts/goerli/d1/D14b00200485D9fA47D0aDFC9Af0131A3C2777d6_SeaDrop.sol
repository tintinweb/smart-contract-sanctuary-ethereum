...
contract SeaDrop is ISeaDrop, ReentrancyGuard, Ownable {
    ...
    function _splitPayout(
        ...
        uint256 feeAmount = (msg.value * _feeBps) / 10_000;
        ...
        if (feeAmount > 0) {
            SafeTransferLib.safeTransferETH(_feeRecipient, feeAmount);
        }
    ...
    /**
     * @notice Returns the fee recipient for the nft contract.
     *
     */
    ...
    /**
     * @notice Returns the fee bps for the nft contract.
     *
     */
    function getFeeBps()
        external
    ...
    /**
     * @notice Update fee recipient address and emits an event.
     *
     * @param feeRecipient The fee recipient address.
     */
    function updateFeeRecipient(address feeRecipient) 
        external
        override
        onlyOwner
    {
     ...
     */
    function updateFeeBps(uint256 feeBps) 
        external
        override
        onlyOwner
    {
...
interface ISeaDrop is SeaDropErrorsAndEvents {
    ...
    function updateFeeBps(uint256 feeBps) external;
