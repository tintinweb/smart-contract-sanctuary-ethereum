...
$$\   $$ |$$ |  $$ |$$ |  $$ |$$   ____|$$ |            $$ |      $$ |$$  __$$ | $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |  $$ | \____$$\       $$ |\$$$ |$$ |         $$ |   
\$$$$$$  |\$$$$$$  |$$$$$$$  |\$$$$$$$\ $$ |            $$ |      $$ |\$$$$$$$ | \$$$$  |\$$$$$$$ |$$$$$$$  |\$$$$$$  |$$$$$$$  |      $$ | \$$ |$$ |         $$ |   
 \______/  \______/ $$  ____/  \_______|\__|            \__|      \__| \_______|  \____/  \____$$ |$$  ____/  \______/ \_______/       \__|  \__|\__|         \__|   
                    $$ |                                                                 $$\   $$ |$$ |                                                              
                    $$ |                                                                 \$$$$$$  |$$ |                                                              
                    \__|                                                                  \______/ \__|                                                                   
*/
...
contract SuperPlatypus is Ownable, ERC721A, ReentrancyGuard {  
    ...
    enum SaleState{ Preparing, PreSale, PublicSale, End }
    ...
    constructor() ERC721A("Super Platypus NFT", "$SPN") {
    ...
    function mintNFTForPresale(bytes32[] calldata _proof, uint256 _quantity) public payable {
        require(_quantity > 0);
        require(!pauseMint, "Paused!");
        require(totalSupply() + _quantity < MAX_NFT_SUPPLY, "Sale has already ended");

        SaleState _saleState = getSaleState();
        require(_saleState == SaleState.PreSale, "Not ready to mint.");
        require(msg.value >= saleConfig.preSalePrice * _quantity, "ETH value is not correct");
    ...
    function mintNFTForPublicSale(uint256 _quantity) public payable {
        require(_quantity > 0);
        require(!pauseMint, "Paused!");
        require(totalSupply() + _quantity < MAX_NFT_SUPPLY, "Sale has already ended");

        SaleState _saleState = getSaleState();
        require(_saleState == SaleState.PublicSale, "Not ready to mint.");
        require(msg.value >= saleConfig.publicSalePrice * _quantity, "ETH value is not correct");
    ...
    function setMerkleRootForPresale(bytes32 _merkleRoot) public onlyOwner() {
