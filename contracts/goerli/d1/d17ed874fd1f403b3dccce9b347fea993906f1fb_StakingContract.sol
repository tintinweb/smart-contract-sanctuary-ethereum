...
contract StakingContract {
    ...
    function calculateAreenaPrice() public view returns (uint256 _areenaPrice){
       ...
       uint256 _busdWalletBalance = (busdToken.balanceOf(busdWallet));
        return _areenaPrice = ((_busdWalletBalance.div(10000)).mul(75)).div(100);
    }

    function calculateAreenaBosterPrice() public view returns(uint256){
        
        uint256 _areenaPrice =  calculateAreenaPrice();
        uint256 ABV = ((totalAreena - areenaInCirculation).div(1e18)).mul(_areenaPrice);
