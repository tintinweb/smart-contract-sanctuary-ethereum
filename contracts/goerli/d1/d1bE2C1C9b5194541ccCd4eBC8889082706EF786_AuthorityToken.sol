...
contract AuthorityToken {
    string public name = "Sohle Token";
    string public symbol = "SOHLE";
    ...
    string public imageUrl = "https://drive.google.com/file/d/1ohTPZ_bebm4AB3XDHJIB3knFmcYeWz69/view?usp=share_link"; // URL that points to the image for your token
