...
{    
    ...
    {
        uint _AmountPurchasedMintPass;
        uint _AmountPurchasedMintPack;
        uint _AllocationMintPass;
        uint _AllocationMintPack;
        uint _RemainingToPurchaseMintPass;
        uint _RemainingToPurchaseMintPack;
        bool EligibleMintPass;
        bool EligibleMintPack;
    }
    ...
    function ViewWalletSaleInformation(
        ...
        UserInformation memory Info = UserInformation(
            ...
            _WalletAllocationsMintPass[Wallet] - _MintPassPurchasedAmt[Wallet],
            _WalletAllocationsMintPack[Wallet] - _MintPackPurchasedAmt[Wallet],
