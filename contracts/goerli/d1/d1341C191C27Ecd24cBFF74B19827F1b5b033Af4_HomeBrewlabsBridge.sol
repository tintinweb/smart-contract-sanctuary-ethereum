    ...
    TokensBridgeLimits
{
    ...
    function autoUpdateMediatorBalance(address _token) external onlyIfUpgradeabilityOwner {
        ...
        emit LiquidityAdded(_token, diff);
    }
...
/**
 * @title TokenFactory
 * @dev Factory contract for deployment of new Brewlabs bridge share token.
 */
contract TokenFactory is OwnableModule {
    string public constant NAME_SUFFIX = " Brelwabs Share";
    string public constant SYMBOL_PREFIX = "brews";
    ...
    function deploy(
        ...
        return address(new TokenProxy(
            tokenImage, 
            string(abi.encodePacked(_name, NAME_SUFFIX)), 
