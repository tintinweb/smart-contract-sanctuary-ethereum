...
library Tick {
    ...
    function execute(
        ...
        if (usedTokenXAmount >= prevTokenXAmount) {
            ...
            // if (ABDKMath64x64.mulu(int128(currRatio), prevTokenXAmount) < prevTokenXAmount - usedTokenXAmount) {
            //     currRatio = uint128(ABDKMath64x64.add(int128(currRatio), int128(1)));
            // }
