...
contract SweetsMarket is ERC721HolderUpgradeable, OwnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable {
  ...
  function buyNFT(address _nftAddress, uint256 _categoryId, uint256 size)
    external
    payable
    whenNotPaused
    ...
    onlyEOA
  {
    _buyNFTTo(_nftAddress, _categoryId, _msgSender(), size);
  }
  ...
  function buyNFTTo(
    ...
    onlyEOA
  {
    _buyNFTTo(_nftAddress, _categoryId, _to, size);
  }
