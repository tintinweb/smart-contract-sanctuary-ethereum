    ...
    ERC721DropStorageV1
{
    ...
    ///  @param _baseURI Base URI used for tokenURI
    function initialize(
...
interface IKitsERC721Drop {
    ...
    /// @param baseUri HTTP URI, up to but not including, the token id, which serves metadata for tokens
