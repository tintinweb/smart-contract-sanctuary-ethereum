...
contract HEX1000101 is Ownable, ERC721A, DefaultOperatorFilterer {
    using Strings for uint256;

    uint256 public MAX_SUPPLY = 4444;
    uint256 public PUBLIC_PRICE = 0.005 ether;
    uint256 public PAID_TX_LIMIT = 10;
    uint256 public FREE_LIMIT = 1;

    string private baseURI;
    bool public isSaleActive;

    constructor() ERC721A("NAME_HERE", "TICKER_HERE") {}
    ...
    function paidMint(uint256 quantity) external payable {
        ...
        require(quantity <= PAID_TX_LIMIT, "Limit per transaction exceeded");
    ...
    function freeMint() external {
        ...
        require(_getAux(msg.sender) == 0, "Free limit exceeded");
    ...
    function changePaidLimit(uint256 _limit) external onlyOwner {
        PAID_TX_LIMIT = _limit;
    }
