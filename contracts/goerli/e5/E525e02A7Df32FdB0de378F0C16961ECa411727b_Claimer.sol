...
contract Claimer is Ownable, ReentrancyGuard
{
    ...
    event TokensClaimed(address Redeemer, uint[] TokenIDs, bool[] ProofResults, bytes32[][] Proofs);
    event CitizensClaimed(address Redeemer, uint[] CitizenTokenIDs, uint[] GTMXTokenIDs, bool[] Eligibles, bytes32[][] Proofs);
    ...
    function MerkleClaim (
        ...
        emit TokensClaimed(msg.sender, TokenIDs, Eligibles, Proof);
    }
    ...
    function MerkleClaimCitizens (
        ...
        emit CitizensClaimed(msg.sender, CitizenTokenIDs, GTMXTokenIDs, Eligibles, Proof);
    }
