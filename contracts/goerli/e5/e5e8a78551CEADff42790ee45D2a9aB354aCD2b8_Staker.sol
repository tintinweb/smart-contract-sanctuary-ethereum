...
contract Staker {
    ...
    function execute() public deadlineNotPassed completed {
        require(
    ...
    function withdraw() public completed {
        require(balances[msg.sender] > 0, "Address balance is empty");
        require(
            address(this).balance < threshold,
            "Staked enough. Only complete possible"
        );
