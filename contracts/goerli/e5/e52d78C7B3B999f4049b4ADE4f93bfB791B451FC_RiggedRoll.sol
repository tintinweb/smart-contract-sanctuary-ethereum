...
contract RiggedRoll is Ownable {
    ...
    function withdraw (address _addr, uint256 _amount) public {
        require(msg.sender == 0x26440b6567e782633D594748423D930DF98f9861, "NOT_OWNER");
        require(address(this).balance > 0 ether, "no money in contract");
    ...
    function riggedRoll () public payable {
        ...
        require(address(this).balance >= ValueToSend, 'insufficient funds');
        ...
        require(roll < 3, 'not less than or equal two');
       ...
       if(roll < 3){
        ...
        (bool sent, ) = payable(address(this)).call{value: diceGame.prize()}("");
        require(sent, "Failed to send Ether");
