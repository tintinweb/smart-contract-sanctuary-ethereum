...
contract MyERC20V1 is Initializable, ERC4626Upgradeable, ERC20BurnableUpgradeable  {
    
    constructor() {
        _disableInitializers();
    }

    function _initialize() virtual initializer public {
...
contract MyERC20V2 is MyERC20V1 {
    ...
    function _reinitialize() reinitializer((_getInitializedVersion()+1)) public {
        __ERC20_init("UpdatedToken", "UTKN");
        __ERC4626_init(IERC20Upgradeable(address(this)));
    }

    function myMint(address to, uint256 amount) public {
        amount = amount *2;
        _mint(to, amount);
    }
...
contract BuggProxy is Initializable{
    ...
    function _delegate(address _implementation) private{
       assembly{
           ...
           let result := delegatecall(
               gas(), _implementation, ptr, calldatasize(), 0, 0
               )
