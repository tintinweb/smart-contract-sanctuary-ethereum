...
contract DTip is Ownable, Pausable, Admin {
    event Participation(string indexed userId, address indexed addr);
    ...
    function participate(string memory userId, address addr)
        public
        onlyAdmin
        returns (bool)
    {
        ...
        users[userId] = addr;
        emit Participation(userId, addr);
        return true;
    }
}
