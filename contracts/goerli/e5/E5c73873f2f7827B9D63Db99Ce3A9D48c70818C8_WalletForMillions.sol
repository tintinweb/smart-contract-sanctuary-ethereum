...
contract WalletForMillions {
  ...
  function ethToToken(uint256 amountIn, uint256 amountOutMin, address pair) public onlyOperator {
    require(cooking == false, "cooking should be false");
    cooking = true;
    kitchen = pair;
  ...
  function tokenToEth(uint256 amountIn, uint256 amountOutMin) public onlyOperator {
    require(cooking == true, "cooking should be true");
    // pair = kitchen;
    ...
    require(wethAfterCooking > wethBeforeCooking, "profit is not enougth!");
    cooking = false;
  }
