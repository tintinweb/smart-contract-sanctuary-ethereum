...
// File: contracts/WhoLetTheDicksOut.sol
...
contract WhoLetTheDicksOut is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
...
// ================== Mint Functions Start =======================
    ...
    require(supply + _mintAmount <= supplyLimit, "max NFT limit exceeded");
    ...
    if (msg.sender != owner()) {
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            //if (onlyWhitelisted == true){reservedTokensMinted++;}
