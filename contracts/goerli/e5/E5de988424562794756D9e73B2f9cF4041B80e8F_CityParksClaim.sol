...
contract CityParksClaim is IERC165, IERC721Receiver, IERC721LazyPayableClaim, ICreatorExtensionTokenURI, ReentrancyGuard {
    ...
    function onERC721Received(
        ...
        ERC721Enumerable(cityParksContract).safeTransferFrom(address(this), tx.origin, id);
