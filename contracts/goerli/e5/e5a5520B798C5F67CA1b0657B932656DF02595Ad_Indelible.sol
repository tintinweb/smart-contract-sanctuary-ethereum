// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Eyes", unicode"Nose", unicode"Mouth", unicode"Rosy cheeks", unicode"Earring", unicode"Head", unicode"Beard", unicode"Clothes", unicode"Neck", unicode"Fur", unicode"Background", unicode"Soul", unicode"FLEX"];
        ...
        ContractData public contractData = ContractData(unicode"jasgdkhakdwhda", unicode"A little bit of punk, a little bit of BAYC. No Twitter, no discord, no alpha groups. No promises - for the culture! CC0 and onchain. OLD SKOOL STEALTH MINT.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/e54bd01c-ca92-4c08-a22a-5fd1e37ec55e", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/e54bd01c-ca92-4c08-a22a-5fd1e37ec55e", "", 600, "0x549c01f812E609b80548c9837b2DaCB0CB0ADc64");

        constructor() ERC721A(unicode"jasgdkhakdwhda", unicode"PAYC") {
            TIERS[0] = [20,50,100,150,160,260,300,300,333,400,400,500,500,500,600,600,600,700,700,800,990,1037];
TIERS[1] = [250,9750];
TIERS[2] = [50,80,90,195,207,212,280,286,320,565,565,580,1262,1278,1286,1370,1374];
TIERS[3] = [150,9850];
TIERS[4] = [150,250,450,450,850,900,6950];
TIERS[5] = [50,80,80,100,115,150,150,180,200,200,260,295,300,300,300,300,300,300,300,300,300,400,400,400,400,400,400,400,400,400,450,450,450,490];
TIERS[6] = [100,150,250,9500];
TIERS[7] = [100,150,200,200,200,200,200,300,300,300,300,300,400,400,400,400,500,500,500,550,600,600,2400];
TIERS[8] = [200,300,500,9000];
TIERS[9] = [20,100,120,150,175,215,265,300,397,406,474,490,496,511,626,631,762,1215,1316,1331];
TIERS[10] = [1200,1200,1200,1200,1300,1300,1300,1300];
TIERS[11] = [600,1700,1700,2000,2000,2000];
TIERS[12] = [1,10,20,50,100,200,300,350,400,500,8069];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"jasgdkhakdwhda #");
