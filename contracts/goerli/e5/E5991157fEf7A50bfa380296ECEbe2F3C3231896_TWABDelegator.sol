...
contract Delegation is Initializable {
     ...
     */
    function _executeCall(address to, bytes memory data)
        internal
        returns (bytes memory)
    {
...
contract LowLevelDelegator is Initializable {
     ...
     */
    function _computeSalt(address _delegator, bytes32 _slot)
        internal
        pure
        returns (bytes32)
    {
    ...
    PermitAndMulticall
{
    ...
    function initialize(
        ...
        __TWABDelegator_init_unchained(name_, symbol_, _ticket);
    }
    ...
    function unstake(address _to, uint256 _amount) external {
        ...
        IERC20Upgradeable(ticket).safeTransfer(_to, _amount);
   ...
   */
    ...
    function fundDelegationFromStake(
        ...
        IERC20Upgradeable(ticket).safeTransfer(address(_delegation), _amount);
   ...
   */
    function _computeAddress(address _delegator, uint256 _slot)
        internal
        view
        returns (address)
    {
     ...
     */
    function _computeLockUntil(uint96 _lockDuration)
        internal
        view
        returns (uint96)
    {
     ...
     * @param _delegatee Address of the delegatee
     */
    function _setDelegateeCall(Delegation _delegation, address _delegatee)
        internal
    {
     ...
     * @param _delegator Address of the delegator
     */
    function _requireDelegatorOrRepresentative(address _delegator)
        internal
        view
    {
        require(
