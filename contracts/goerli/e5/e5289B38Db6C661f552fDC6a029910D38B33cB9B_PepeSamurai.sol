...
contract PepeSamurai is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    string public unRevealedURL = "https://pepesamurai.mypinata.cloud/ipfs/Qmc5XWdiNabaM8j9zusbdHWwJyzuthbDN7N5MfVkXfsk62/hidden.json";
        ...
        payable
    {
        ...
        require(tokens > 0, "Must mint at least one Pepe Samurai");
        require(
            _ogMints[_msgSender()] + tokens <= maxPerOGWallet,
