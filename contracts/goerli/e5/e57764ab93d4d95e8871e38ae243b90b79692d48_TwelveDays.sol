...
contract TwelveDays is ERC721AUpgradeable, OwnableUpgradeable, DefaultOperatorFilterer {
    IUltraPass public constant ULTRAPASS = IUltraPass(0x304fbb8C76e9a21ebdD6e8a6a71c6D30F4a817b6);
    ...
    function mint(uint256 burnToken) public {
        ...
        if (msg.sender != ULTRAPASS.ownerOf(burnToken)) {
            revert NotOwner(msg.sender, ULTRAPASS.ownerOf(burnToken));
        }

        ULTRAPASS.burn(burnToken);
        _mint(msg.sender, 1);
    }
