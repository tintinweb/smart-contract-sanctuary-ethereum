    ...
    function leaveWallet(address memberAddress) public {
        ...
        for (
            ...
            if (flag == true) {
                wallet[memberWalletId[memberAddress]]
                    .members[i]
                    .firstName = wallet[memberWalletId[memberAddress]]
                    .members[i + 1]
                    .firstName;
                wallet[memberWalletId[memberAddress]]
                    .members[i]
                    .lastName = wallet[memberWalletId[memberAddress]]
                    .members[i + 1]
                    .lastName;
                wallet[memberWalletId[memberAddress]]
                    .members[i]
                    .currentAddress = wallet[memberWalletId[memberAddress]]
                    .members[i + 1]
                    .currentAddress;
                wallet[memberWalletId[memberAddress]]
                    .members[i]
                    .walletId = wallet[memberWalletId[memberAddress]]
                    .members[i + 1]
                    .walletId;
                wallet[memberWalletId[memberAddress]]
                    .members[i]
                    .balance = wallet[memberWalletId[memberAddress]]
                    .members[i + 1]
                    .balance;
                wallet[memberWalletId[memberAddress]]
                    .members[i]
                    .withdrawalLimit = wallet[memberWalletId[memberAddress]]
                    .members[i + 1]
                    .withdrawalLimit;
            }
        }
        // "Deleting" the last element. Initializing with default values since there is no delete system in Solidity
        wallet[memberWalletId[memberAddress]]
            .members[wallet[memberWalletId[memberAddress]].memberCounter]
            .firstName = "";
        wallet[memberWalletId[memberAddress]]
            .members[wallet[memberWalletId[memberAddress]].memberCounter]
            .lastName = "";
