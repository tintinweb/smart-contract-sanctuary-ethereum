...
contract LaunchSettings is ILaunchSettings, Ownable, IERC165 {
    ...
    constructor() {
        ...
        minAuctionLength = 0;
        // minAuctionLength = 3 days; // for testing
        // minAuctionLengthForNFT = 3 days; // for testing
        minAuctionLengthForNFT = 0;
        ...
        platformFee[0x0000000000000000000000000000000000000000] = 25; // WETH fee is 0.25% is 25
        platformFee[0x326C977E6efc84E512bB9C30f76E30c160eD06FB] = 0; // Link fee is 0%
    }
