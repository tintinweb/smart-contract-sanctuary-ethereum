...
contract PixelNFT is ERC721, Ownable {
	...
	// Total supply
    uint256 private constant MAX_PER_WALLET = 33;
	...
	constructor(string memory _initBaseURI) ERC721("PIXEL", "PXL") {
		_supply.increment();
	...
	function mint(uint256 _quantity) external payable nonReentrant {
		...
		require(msg.value >= (MINT_PRICE * _quantity) && (balanceOf(_to) + _quantity) < MAX_PER_WALLET, "Not enough ETH.");
