...
/** 
 * @title Portraits For People v1.0
 * @notice This is a customized ERC-721 contract for Portraits_For_People. 
 * All tokens created and controlled by this contract are licensed CC NC-BY 4.0.
 * @author Matto
...
contract Portraits_For_People is ERC721Royalty, Ownable, ReentrancyGuard {
  ...
  /** 
   * @notice setCustomData allows token owners to change which processing
   * algorithm is applied to the their token.
   * @dev artist is given access to assist owners for their safety.
   * @param _tokenId is the token to update.
   * @param _customData is the new process that is being selected.
   */
  ...
  {
      require(!projectLocked);
      emit ProjectData(_index, processDescription[_index], _processDescription);
