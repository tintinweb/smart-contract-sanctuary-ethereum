...
contract StakingStream is ERC20, Ownable, ReentrancyGuard {
    ...
    function stake(StakeData memory _stakeData) external nonReentrant {
        ...
        uint256 dailyProfitValue = calculateDailyProfitAmount(_stakeData.amount, _stakeData.period);
    ...
    function withdrawProfit(WithdrawProfitData memory _withdrawProfitData) external nonReentrant onlyOwner {
        uint256 availableProfit = calculateAvailableProfit(_withdrawProfitData.user);
        ...
        withdrawnProfit[_withdrawProfitData.user] = withdrawnProfit[_withdrawProfitData.user] + _withdrawProfitData.amount;
    ...
    function calculateProfitValue(uint256 total, uint256 percent) pure private returns(uint256) {
        ...
        uint256 percentValue = division / 10000;
        return percentValue;
    }
     ...
     */
    function calculateAvailableProfit(address user) public view returns(uint256) {
