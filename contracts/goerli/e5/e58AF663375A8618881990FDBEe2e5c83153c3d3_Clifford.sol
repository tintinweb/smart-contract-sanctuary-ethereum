      ...
      for (uint256 i = 0; i < positions.length; i++) {
        if (positions[i] != 9) {
          ...
          if (i < 2) {
            output = string.concat(
              output,
              rightWallGridArray[2 * i - 5],
              ",",
              rightWallGridArray[2 * i + 1]
            );
          } else if (i == 2) {
            output = string.concat(
              output,
              leftWallGridArray[2 * i],
              ",",
              leftWallGridArray[2 * i + 1]
            );
          } else {
            output = string.concat(
              output,
              floorGridArray[2 * i + 1],
              ",",
              floorGridArray[2 * i + 2]
            );
          }
...
contract SharedAssets {
    ...
    string public constant LEFT_FRAME =
    ...
    string public constant RIGHT_FRAME =
    ...
    string public constant RIGHT_CLOCK =
    ...
    string public constant G_START = "<g transform='translate(";
    ...
    function getAltar() external pure returns (string memory) {
        return ALTAR;
    }

    function getProps() external pure returns (string memory) {
        return PROPS;
    }
