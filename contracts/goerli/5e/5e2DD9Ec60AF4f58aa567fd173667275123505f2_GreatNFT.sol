...
contract GreatNFT is ERC721AUpgradeable, PausableUpgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    function initialize(bytes32 _root, uint256 _maxMint, uint256 _maxSupply, address teamWallet, string memory _realBaseURI, string memory _virtualURI, bool _revealStatus) public initializerERC721A initializer {
        root = _root;
        maxMint = _maxMint;
