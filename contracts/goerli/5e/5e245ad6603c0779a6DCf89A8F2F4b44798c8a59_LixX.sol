...
contract LixX is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1097893 * 10**_decimals;
    string private constant _name = unicode"LixX";
    string private constant _symbol = unicode"LIXX";
