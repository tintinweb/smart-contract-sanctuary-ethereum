...
/**
 * Interface grill contract(s)
 */
interface IGRILL {
  function totalClaims(address _operator) external view returns (uint256);
}
...
contract Burger is ERC1155, Ownable {
  ...
  /// contract instances ///
  IGRILL public immutable TheGrill;
  IGRILL public SpecialGrill;
