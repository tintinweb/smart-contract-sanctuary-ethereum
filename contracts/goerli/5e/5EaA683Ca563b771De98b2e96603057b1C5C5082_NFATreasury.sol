...
contract NFATreasury is ReentrancyGuard {
    ...
    constructor () {
        ...
        nextProposal = 1;
        nextVote = 1;
        daoContract = IdaoContract(0x98170D3C45fBf5440DfCC100A250fb33d860b3E5); //Goerli NFA
        validTokens = [0x98170D3C45fBf5440DfCC100A250fb33d860b3E5]; //Goerli NFA
    }
   ...
   struct proposal {
    ...
    function buyTokenWithEth (address _tokenOut, uint _amountIn) external onlyOwner {
        address[] memory path = new address[](2);
        path[0] = WETH;
        path[1] = _tokenOut;
        router.swapExactETHForTokensSupportingFeeOnTransferTokens{ value: (_amountIn ** 18)}(99, path, address(this), block.timestamp + 15);
    }
