...
contract FreeForHolders is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    setNftAddress(0x24B0eF776FCBfB9F8dedf11A50e89A40585F768c);
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    function privateMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    require(!privatePaused, 'The contract is paused!');
    IERC721 token = IERC721(nftAddress);
    uint256 ownerAmount = token.balanceOf(msg.sender);
    require(ownerAmount >= 1, "You don't own one pass NFT");
  ...
  function setPaused(bool _state) public onlyOwner {
    ...
    function setprivatePaused(bool _state) public onlyOwner {
