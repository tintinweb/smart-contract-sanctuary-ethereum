...
abstract contract Defaults {
    address public marketingWallet = 0xB9FDf25E7f1762aBB48c7feD7C289237015c6FC5;
    address public devWallet = 0xeB57105d129dea644d3F044d37ee0f631C4f7505;
    string constant _name = "KRToken";
    ...
    uint256 public _maxWalletToken = (_totalSupply * 50) / 1000; // (_totalSupply * 50) / 1000 [this equals 5%]
...
contract KRToken is Defaults, IERC20, Ownable {
