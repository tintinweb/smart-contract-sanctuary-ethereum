...
contract ZKS is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private uriPrefix = "https://ipfs://bafybeiff3y5d7zeadydsf656jw266m6hz3tpkgdvkzynqj226hb6li4354/";
  string public uriSuffix = ".json";
  string private hiddenMetadataUri;

    constructor() ERC721A("z00kies", "ZKS") {
    ...
    uint256 public maxFreeSupply = 15000;
