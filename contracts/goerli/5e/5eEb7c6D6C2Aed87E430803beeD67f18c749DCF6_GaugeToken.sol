...
contract GaugeToken is BlacklistToken {
     ...
     */
    function initialize(string memory name_, string memory symbol_, address _blacklist) public initializer {
        __BlacklistToken_init(name_, symbol_, _blacklist);
...
import "./Blacklist/IBlacklist.sol";
...
contract SnapshotToken is PausableToken, ERC20SnapshotUpgradeable {
    /**
     * @dev Initializes the contract setting the deployer as the initial owner.
     */
    function __SnapshotToken_init(string memory name_, string memory symbol_) internal onlyInitializing {
        __PausableToken_init( name_, symbol_);
    }
    ...
    function snapshot() public onlyOwner {
     ...
     function _beforeTokenTransfer(  address from,
        address to,
        uint256 amount
    )virtual internal override(ERC20PausableUpgradeable, ERC20SnapshotUpgradeable)  {
        super._beforeTokenTransfer(from, to, amount);
    }
...
contract PausableToken is ERC20PausableUpgradeable, OwnableUpgradeable {
