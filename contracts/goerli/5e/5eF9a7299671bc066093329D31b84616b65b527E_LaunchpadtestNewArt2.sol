 ...
 * @notice This contract handles minting test new art 2 tokens.
 */
contract LaunchpadtestNewArt2 is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address[] public payoutAddresses = [
        0xAa7A8b6E3C5F37dA184D41fc0A9bC4a65762b8d6
    ];
    bool public isPublicSaleActive = false;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeibaq6vo6ew3tqhiubtntcvho2fcsy3cponnw4slsr7smvp3cvh2ku/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 148;
    ...
    constructor() ERC721A("test new art 2", "test") {
