...
NAME: constant(String[40]) = "ApeWorx Vyper Token 6"
SYMBOL: constant(String[5]) = "KoA"
baseURI: public(String[120])
...
def __init__():
    ...
    self.baseURI = "https://api.gateway.ethswarm.org/bzz/be5acdf1ccfe344a4b78f5e9bc17978c7cb78f4fa71d676bc4f6ac895636b2dd"
...
@view
@external
def tokenURI(tokenId: uint256) -> String[199]:
    return concat(self.baseURI, "/" , uint2str(tokenId))

@external
def setBaseURI(_baseURI: String[120]):
