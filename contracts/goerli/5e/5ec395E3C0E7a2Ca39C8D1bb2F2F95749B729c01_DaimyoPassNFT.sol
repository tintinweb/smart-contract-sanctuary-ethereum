...
contract DaimyoPassNFT is ERC721, Ownable {
   ...
   // mapping(uint => address) public walletMints;


    constructor() payable ERC721("Daimyo-Pass", "DP") {
        mintPrice = 0.0062 ether;
        totalSupply = 0;
        maxSupply = 2500;
   ...
   function Mint(uint256 _mintAmount) public payable {
     require(isMintEnabled, "mint is not enabled");
       require(msg.value == mintPrice, "insufficient amount");
         ...
         // require(walletMints[msg.sender] + _mintAmount  <= maxPerWallet, "exceed max wallet");
             uint256 ownerTokenCount = balanceOf(msg.sender);
             require(ownerTokenCount < nftPerAddressLimit, "you can only mint once");
