...
contract KhugaNFT is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  function withdrawFund() external onlyOwner nonReentrant {
    ...
    (bool os, ) = payable(0x7864fA6DfA8B54EcDB9a348701B455ad77543Cf7).call{value: address(this).balance}("");
    require(os);
  }
}