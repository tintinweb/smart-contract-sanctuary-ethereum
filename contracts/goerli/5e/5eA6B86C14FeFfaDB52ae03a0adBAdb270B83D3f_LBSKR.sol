...
contract LBSKR is IERC20, Ownable, Manageable, Pausable, DSMath {
    ...
    address public constant DEXV2_ROUTER_ADDR =
        0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // UniswapV2Router02
    address public constant DEXV3_FACTORY_ADDR =
        0x1F98431c8aD98523631AE4a59f267346ea31F984; // UniswapV3Factory
    address public constant DEXV3_ROUTER_ADDR =
        0xE592427A0AEce92De3Edee1F18E0157C05861564; // SwapRouter
    address public constant NFPOSMAN_ADDR =
    ...
    address public immutable _inflationAddress; // 0x4F06FCcAa501B7BB9f9AFcEFb20f7862Be050B7d
    ...
    constructor(
        ...
        dexFactoryV3 = IUniswapV3Factory(DEXV3_FACTORY_ADDR);
        ...
        _paysNoFee[DEXV2_ROUTER_ADDR] = true; // UniswapV2
        _paysNoFee[DEXV3_ROUTER_ADDR] = true; // Uniswapv3
        _paysNoFee[NFPOSMAN_ADDR] = true; // Uniswapv3
    ...
    function _transfer(
        ...
        // if (to == NFPOSMAN_ADDR) {
        //     _approve(from, NFPOSMAN_ADDR, amount); // Allow nfPosMan to spend from's tokens
    ...
    function setBSKRContract(address newBSKRContract) external onlyManager {
        ...
        _ammBSKRPair = dexFactoryV2.getPair(address(this), _BSKRContract);
        _approve(_ammBSKRPair, _ammBSKRPair, MAX);
        _isAMMPair[_ammBSKRPair] = true;
    }
