...
contract NFTraits is VRFV2WrapperConsumerBase, ERC1155, Ownable, ERC1155Supply {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    'IyAgMDAw', // need function to take uint256 -> base64 encoded string (includes # possible causing issue)
    ...
    function overlay(uint256 tokenid) public view returns (string memory) {
        ...
        string[5] memory overlay = ['PHJlY3QgY2xhc3M9J28nICBmaWxsPSdibHVlJyAgeD0nMCcgIHk9JzAnIC8+', 'PHJlY3QgY2xhc3M9Im8iICBmaWxsPSdncmVlbicgIHg9JzAnICB5PScwJy8+', 'PHJlY3QgICBjbGFzcz0nbycgICAgIGZpbGw9J3JlZCcgIHg9JzAnICB5PScwJy8+', 'ICA8cmVjdCBjbGFzcz0nbycgIGZpbGw9J3llbGxvdycgIHg9JzAnICB5PScwJy8+', 'ICA8cmVjdCBjbGFzcz0nbycgIGZpbGw9J3B1cnBsZScgIHg9JzAnICB5PScwJy8+'];
        ...
        override
    {
        ...
        for (uint256 i = 0; i < 5; i++) {
            uint256 groupId = randomWords[i] % 9;
