...
contract DHVN is ERC721BasicFrame {
    ...
    // Constructor
    ///////////////////////////////////////////////////////////////////////////
    constructor() ERC721BasicFrame("DAO Heaven TEST", "DHVNTEST", 777) {
        // default royalty set
        address OWNER_ADDRESS = 0x06eF31Bf14e9F65a5D567494843a4C955DbE1808; //! 本番では運営ウォレットにする下に直接書く
        _setDefaultRoyalty(
            IEIP2981RoyaltyOverride.TokenRoyalty({bps: 1000, recipient: OWNER_ADDRESS})
        );
        ...
        _mint(msg.sender, 2);   //! 本番では運営保有分 + 1をOWNER_ADDRESSにmintとする
    }
