    ...
    function removeItemFromWinnings(
        ...
        if (itemsAmounts == randomResult) {
            if (project.items[randomResult] != 0) {
                pb.wonItems.push(project.items[randomResult]);
            } else {
                pb.wonItems.push(project.items[randomResult]);
            }
            itemsAmounts--;
            ...
            if (project.items[randomResult] == 0) {
                uint256 winner = randomResult;
                pb.wonItems.push(project.items[randomResult]);
                if (project.items[itemsAmounts] != 0) {
                    project.items[winner] = project.items[itemsAmounts];
                } else {
                    project.items[winner] = itemsAmounts;
                }
            } else {
                pb.wonItems.push(project.items[randomResult]);
                if (project.items[itemsAmounts] != 0) {
                    project.items[randomResult] = project.items[itemsAmounts];
                } else {
