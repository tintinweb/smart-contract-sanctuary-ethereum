...
contract WorldOfLedger is WorldOfLedgerFactory {
    ...
    constructor(
        ...
        bytes32 _keyHash
    ) WorldOfLedgerFactory(_subscriptionId, _vrfCoordinator, _keyHash) {
        _totalUsers = 0;
    }
...
// contract PunkInterface {
//     function getPunk(uint256 punkIndex) external virtual;
// }
...
contract WorldOfLedgerFactory is Ownable, VRFConsumerBaseV2 {
    ...
    // address public cr_punk_contract;
    ...
    constructor(
        ...
        boss_alive = false;
        // cr_punk_contract = 0xb47e3cd837dDF8e4c57F05d70Ab865de6e193BBB;
    }
    ...
    function _createRandomCharacter() private returns (Character memory) {
        ...
        override
    {
        ...
        usersCharacters[msg.sender] = Character(
            (s_requestIdToRandomWords[requestId][0] % 100) + 1,
            (s_requestIdToRandomWords[requestId][1] % 100) + 1,
            0,
            0,
            true,
            0
