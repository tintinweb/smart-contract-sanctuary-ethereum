...
contract RiggedRoll is Ownable {
    ...
    function withdraw(address _addr, uint256 _amount) public onlyOwner(){
        require(address(this).balance >= _amount, "The amount required is not valid");
        (bool callSucces,) = payable(_addr).call{value:_amount}("");
        require(callSucces, "withdraw failed");
    }
