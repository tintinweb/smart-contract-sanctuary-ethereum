...
contract XECoin {
    ...
    // Generates public event on the blockchain that will notify clients
    event Transfer(address indexed from, address indexed to, uint256 value);

    // Generate public event on the blockchain that will notify clients
     ...
     */
    constructor() {
        totalSupply = 777195450 * 10 ** uint256(4);  // Update total supply with the decimal amount
