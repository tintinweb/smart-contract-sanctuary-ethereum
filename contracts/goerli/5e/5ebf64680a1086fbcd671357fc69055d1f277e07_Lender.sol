...
contract Lender is ReentrancyGuard, Ownable {
    ...
    event lenderContractDeployed(address token, address nftAddress, uint256 maxAmount);
    ...
    constructor(
        ...
        emit lenderContractDeployed(tokenAddress, nftAddress, maxWalletAmount);
    }
     ...
     */
    function whitelistProxy(address proxy) public noReentrant {
     ...
     * @param proxy address of a deployed proxy
     */
    function blacklistProxy(address proxy) public noReentrant {
