 ...
 */
contract CyberVault is Initializable, Owned, ReentrancyGuard, EIP712, ERC721Holder, ERC1155Holder {
    ...
    function claim1155(
        ...
        require(
            _balanceByProfileByCurrencyByTokenID[profileId][currency][tokenId] >= amount,
            "INSUFFICIENT_BALANCE"
        );

        _balanceByProfileByCurrencyByTokenID[profileId][currency][tokenId] -= amount;

        IERC1155(currency).safeTransferFrom(address(this), to, tokenId, amount, "");
    ...
    function deposit1155(
        ...
        IERC1155(currency).safeTransferFrom(msg.sender, address(this), tokenId, amount, "");
     ...
     * @param currency The ERC20 currency address.
     */
    function nftBalanceOf(string calldata profileId, address currency, uint256 tokenId)
        external
        view
        returns (uint256)
    {
        return _balanceByProfileByCurrencyByTokenID[profileId][currency][tokenId];
    }
