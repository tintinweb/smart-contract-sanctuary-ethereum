...
ReentrancyGuardUpgradeable
{
    ...
    */
    function initialize(
        ...
        WL1.endTime = WL1.startTime + 2 hours;
        WL1.buyLimit = 2;
        WL1.maxAvailable = maxSupply - ownerReserve;
        WL1.price = 0.018 ether;

        PB.startTime = WL1.endTime;
    ...
    */
    ...
    checkSupply(_amount)
    {
        ...
        require(msg.value >= _amount * WL1.price, "WL1 insufficient funds sent");
        
        WL1.register[msg.sender] += _amount;
        WL1.maxAvailable -= _amount;

        if (msg.value > _amount * WL1.price) {
            payable(msg.sender).transfer(msg.value - _amount * WL1.price);
        }
...
contract Whitelist is EIP712Upgradeable {
    string private constant SIGNING_DOMAIN = "Knitty";
