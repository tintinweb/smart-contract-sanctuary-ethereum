...
// File: contracts/UltimateAlphaPass.sol
...
contract UltimateAlphaPass is ERC721, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 15000;
    uint private constant TOKENS_RESERVED = 500;
    uint public price = 35000000000000000;
    ...
    constructor() ERC721("Ultimate Alpha: Subscriptions", "ULTA") {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xDB1f0724fD7229FA6572d0F2e3D843F28463c460).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xDB1f0724fD7229FA6572d0F2e3D843F28463c460).call{value: balanceTwo}("");
