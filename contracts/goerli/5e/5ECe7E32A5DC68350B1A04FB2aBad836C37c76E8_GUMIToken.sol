...
// TokenX Contracts v1.0.0 (contracts/GUMIToken.sol)
 ...
 * This contract uses {AccessControl} to include role assigning capabilities.
 * This contract uses {EmergencyWithdrawable} to include emergency withdraw capabilities.
 */
contract GUMIToken is Ownable, ERC20Pausable, ERC20Burnable, ERC20BlackListable, AccessControl, EmergencyWithdrawable {
    bytes32 public constant OPERATOR_ROLE = keccak256("OPERATOR_ROLE");

    /**
     * @dev Mints `initialSupply` amount of token and transfers them to `owner`
     * and sets the values for `name` and `symbol`.
     * Grant `owner` operator role and the default admin role: it will be able to grant and revoke any roles
     *
     * See {ERC20-constructor}.
     */
    constructor(uint256 initialSupply) ERC20("G Token", "G") {
    ...
    function _beforeTokenTransfer(
        ...
        address to, 
        uint256 amount
    ) internal virtual override(ERC20, ERC20Pausable, ERC20BlackListable) {
...
abstract contract ERC20BlackListable is ERC20 {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        bool _isBlackListed = isBlackListed[from] || isBlackListed[to] || isBlackListed[msg.sender];
