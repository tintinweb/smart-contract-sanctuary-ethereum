...
contract ChainpassMarketplace_1_0 is AuthHelper, ReentrancyGuard {
    ...
    function setSecondaryAsks(address ticketContractAddress, uint256[] calldata tokenIds, uint256[] calldata prices, MetaTransactionInput calldata metaTxInput) external {
