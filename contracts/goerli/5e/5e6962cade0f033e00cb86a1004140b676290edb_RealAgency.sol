    ...
    ReentrancyGuard
{
    ...
    function upgradeKey(uint256[] calldata _assetIds) external nonReentrant whenNotPaused {
        for (uint256 i = 0; i < _assetIds.length; i++) {
            ...
            // msg.sender being called from another contract, will return this CA
            // _msgSender returns end user 
            // transfer from end user to this contract address. 
    ...
    function setProtectionSettings(bool marketProtect) external payable onlyOwner {
