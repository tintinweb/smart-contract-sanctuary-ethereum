...
contract Aquarium is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "aquarium";
    string constant _symbol = "AQUA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 1) / 200;
    uint256 _maxSellTxAmount = (_totalSupply * 0) / 200;
    ...
    address payable public liquidityFeeReceiver = payable(0x6a9140c9737bFa8BE4Ad776Ea298E1db1Bd85F32);
    address payable public marketingFeeReceiver = payable(0x6a9140c9737bFa8BE4Ad776Ea298E1db1Bd85F32);
