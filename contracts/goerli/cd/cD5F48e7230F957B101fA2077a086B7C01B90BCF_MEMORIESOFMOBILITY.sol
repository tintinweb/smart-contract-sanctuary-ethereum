...
contract MEMORIESOFMOBILITY is ERC721A, Ownable {
    ...
    address public defaultRoyaltyReceiver = 0x73A6f78501aD217F95000b8D12a50133f0b29cab; //ADDRESS TO RECEIVE ROYALTIES
    mapping(uint256 => address) royaltyReceivers;
    uint256 public defaultRoyaltyPercentage = 100; // Points out 1000, 100 = 10%
    mapping(uint256 => uint256) royaltyPercentages;
    
    string public baseURI = "ipfs://QmQ3tEhBqXMmY64vnYr41EJjMn8KVkpeHQiS8MJCr7z2Wj/";

    constructor() ERC721A("Memories of Mobility by bashobits", "MOM") {
