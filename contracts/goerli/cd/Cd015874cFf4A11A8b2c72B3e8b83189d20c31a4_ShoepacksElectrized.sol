...
/**
 * @title ShoepacksElectrized
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract ShoepacksElectrized is ReentrancyGuard, ERC20Permit, ERC20Burnable {
    address private _owner;

    constructor() ERC20("Shoepacks Electrized","OLD")  ERC20Permit("Shoepacks Electrized") { 
        _owner = _msgSender();
     }
