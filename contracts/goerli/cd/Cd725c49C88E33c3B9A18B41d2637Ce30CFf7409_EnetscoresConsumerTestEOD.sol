...
contract EnetscoresConsumerTestEOD is ChainlinkClient {
    ...
    mapping(bytes32 => GameCreate[]) private requestIdGameCreate;
    mapping(bytes32 => GameResolve[]) private requestIdGameResolve;
        ...
        recordChainlinkFulfillment(_requestId)
    {
        ...
        GameCreate[] memory gameCreateArray = new GameCreate[](resultLength);
