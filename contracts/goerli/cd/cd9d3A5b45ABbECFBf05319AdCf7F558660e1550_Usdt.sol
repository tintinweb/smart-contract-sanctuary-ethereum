...
/**
 * @dev This contract is for integration testing only.
 */
contract Usdt is ERC20, OnlyAuthorized {
    ...
    function faucetUSDT(address to, uint256 amount) public onlyAuthorized {
        require(to != address(0x0));
        _mint(to, amount * 1e6);
    }


    function faucet(address to, uint256 amount) public onlyAuthorized {
        require(to != address(0x0));
        _mint(to, amount);
    }

    function burn(uint amount) public onlyAuthorized{
