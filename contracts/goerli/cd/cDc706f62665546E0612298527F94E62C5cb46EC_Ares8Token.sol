/**  
    ...
    Total Supply : 100 Billions ARES ( 100 000 000 000 )
    
    Max Wallet Tokens holding : 1.0% of initialSupply ( 1 billion : 1 000 000 000 )
    Max Transaction Tokens : 0.33% of initialSupply  ( 330 millions : 330 000 000 )

    -----------
    - Total buy tax = 8 %
    -----------
    2 %  Reflexion to all holders  
    2 %  Dev
    2 %  Marketing
    1 %  BuyBack
    1 %  Liquidity
...
contract Ares8Token is IERC20, Ownable {
	...
	string private constant _name =  "Ares 8 Token";
	string private constant _symbol = "ARES8";
	...
	uint256 private constant _tTotal = 100000000000 * 10**18; // 100 Billions
  ...
  // min tokens before swap is 0.025% of initialSupply
  ...
  // Base fees
	...
	/// @notice Set BUY TAxes
	/// @dev Fill all the fields before submit
	...
	/// @notice Set MIN TOKEN BEFORE SWAP
	/// @dev Set MIN TOKEN BEFORE SWAP from contract
	...
	/// @notice Claim ETH Overflow
	/// @dev Claim ETH Overflow from contract
	...
	/// @notice Get BUY TAXES
	/// @dev liquidity, marketing, dev, buyBack, holders
