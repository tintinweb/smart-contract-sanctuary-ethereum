 ...
 */
contract GovernanceNFT is ERC721, AccessControl {
     ...
     */
    constructor(address issuer, string memory uri) ERC721("Governance NFT", "GovNFT") {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(_baseURI(), Strings.toHexString(getAddressForID(tokenId))));
    }
