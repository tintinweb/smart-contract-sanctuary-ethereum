...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF297eDb04D7379e2A0823eB9C9E484DB4fae8f3C];
  address public erc20Payable = 0xF297eDb04D7379e2A0823eB9C9E484DB4fae8f3C;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 123) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPENSdK6JHuAfUvgZJC36hYyP4NoeetgQGx5yGKTcWGqN/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/JWd2la5KECc55I5Ti3L7/contract-metadata";
  }
...
// File: contracts/DoggoMintContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DoggoMintContract is RamppERC721A {
    constructor() RamppERC721A("Doggo Mint", "MINTDOG"){}
}
