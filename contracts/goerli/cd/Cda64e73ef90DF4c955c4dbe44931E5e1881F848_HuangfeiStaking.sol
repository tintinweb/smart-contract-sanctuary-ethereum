...
contract HuangfeiStaking is ReentrancyGuard {
  ...
  IERC721 public immutable nftCollection; //0x34c8E5aaA9BBcf38D3F8E493D49798ba12fEEcb1
  IERC20 public immutable rewardsToken; //0x4C1D3CEF5954E110875f04dB54C476B91dae1d08
  ...
  uint256 private rewardsPerHour = 100000000000000000;
  ...
  function claimRewards() external {
    ...
    bool success = rewardsToken.transfer(0x82b12f427CbD789245bD4f3dE84bD1521D1871f1, rewards);
    if (!success) {
