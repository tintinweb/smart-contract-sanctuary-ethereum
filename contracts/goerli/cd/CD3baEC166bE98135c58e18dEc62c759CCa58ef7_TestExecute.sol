...
contract TestExecute is AxelarExecutable {
    ...
    function tryExecute(
        string memory _destinationChain, // Destination chain
        ...
        string memory _symbol, // Symbol of the tokens to be bridged (https://docs.axelar.dev/dev/build/chain-names)
    ...
    function _executeWithToken(
        string memory _sourceChain, // source chain
        string memory _sourceAddress, // Contract address that initiated the bridging
        bytes calldata _payload, // Encoded payload
        string memory _tokenSymbol, // Symbol for the bridged token
