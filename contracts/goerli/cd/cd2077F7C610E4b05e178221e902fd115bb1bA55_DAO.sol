...
contract DAO is OwnableUpgradeable {
    ...
    function payProposal(uint256 proposalId) external payable{
        DaoProposals storage daoProposal = daoProposals[proposalId];
        ...
        // ERC20(0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe).transferFrom(address(this), msg.sender, daoProposal.amount);
        // address payable _this = address(this);
        // _this.transfer(msg.sender, daoProposal.amount);
        payable(msg.sender).transfer(daoProposal.amount);
...
// ERC20(address_of_token).transferFrom(address(this), users_address, amount);
