...
contract Evaluator {
    ...
    function ex4(
        uint256 l2ReceiverContract,
        uint256 ex4_a_selector,
        uint256 ex4_b_selector,
        uint256 solution_selector
    ) external {
        uint256[] memory payload = new uint256[](1);
        payload[0] = 10;
        uint256[] memory evaluator_payload = new uint256[](1);
        evaluator_payload[0] = l2ReceiverContract;
