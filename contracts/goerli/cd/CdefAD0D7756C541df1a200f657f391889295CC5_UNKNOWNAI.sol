...
Telegram: https://t.me/UnKnownERC20
...
contract UNKNOWNAI is ERC20, Ownable {
    ...
    {   
        ...
        maxTransactionAmountBuy     = totalSupply() * 25 / 1000;
        maxTransactionAmountSell    = totalSupply() * 25 / 1000;
    ...
    function setMaxTransactionAmounts(uint256 _maxTransactionAmountBuy, uint256 _maxTransactionAmountSell) external onlyOwner {
        require(
            _maxTransactionAmountBuy  >= (totalSupply() / (25 ** decimals())) / 1_000 && 
            _maxTransactionAmountSell >= (totalSupply() / (25 ** decimals())) / 1_000, 
            "Max Transaction limis cannot be lower than 0.1% of total supply"
        ); 
        maxTransactionAmountBuy  = _maxTransactionAmountBuy  * (25 ** decimals());
        maxTransactionAmountSell = _maxTransactionAmountSell * (25 ** decimals());
