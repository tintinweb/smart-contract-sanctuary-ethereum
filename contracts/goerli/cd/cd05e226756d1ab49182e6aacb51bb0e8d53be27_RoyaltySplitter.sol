...
contract RoyaltySplitter is Ownable, IRoyaltySplitter {
    ...
    constructor() payable {
        ...
        _payees.push(tqoe);
        emit PayeeAdded(tqoe, 100);
        _payees.push(charity);
        emit PayeeAdded(charity, 100);
        _payees.push(artist);
        emit PayeeAdded(artist, 100);

        //Set TQOE
        TQOEContract = 0x8DedB5a142B2CA5046386b748f6e977D92BFb0aC;
     ...
     */
    modifier onlyTQOE() {
        require(msg.sender == TQOEContract, "Only TQOE!");
        _;
    }
    ...
    function _addShares(address account, uint256 shares_) private {
        ...
        require(_shares[account] != 0, "RoyaltySplitter: payee is not added");
     ...
     */
    function setTQOE(address newTQOE) public onlyOwner{
        require(newTQOE != address(0), "RoyaltySplitter: Invalid Address");
        TQOEContract = newTQOE;
    }
}