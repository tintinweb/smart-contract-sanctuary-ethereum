...
contract Nft is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, ERC2981Upgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    uint currentTokenId;
    ...
    function initialize(string memory _contractURI) initializer public {
        ...
        propertyPrice = 5 ether;
        currentTokenId = 1;
        MAX_SUPPLY = 5000;
        MAX_PER_WALLET = 5;
        setRoyaltyInfo(0x5C1ecC63B293113Bd40F3136873A6e660115Fca8, 250);
        contractURI = _contractURI;
        wallet1 = payable(0x5C1ecC63B293113Bd40F3136873A6e660115Fca8);
        wallet2 = payable(0xF4496F50aFC75dAaa2E1d3bb9abd164362835126);
    }
    ...
    function MintNFT(string memory _uri, address _to) external payable whenNotPaused {
        ...
        require(msg.value == propertyPrice, "Wrong Payment");
        emit Paid(propertyPrice, msg.value);
    ...
    function airdropNFT(string memory _uri, address _to) public whenNotPaused onlyOwner {
        require(!uriIsPresent[_uri], "This URI already exists");
        require(!_isBlackListed[_to], "This account is blacklisted");
    ...
    function batchAridropNFT(string[] memory _uri, address[] memory _to) public onlyOwner{
        require(_uri.length == _to.length, "Invalid Input");
        uint len = _uri.length;
        uint i = 0;
        for(i=0; i<len; i++){
            airdropNFT(_uri[i], _to[i]);
        }
    }
    ...
    function listNFT(uint tokenId, uint _price) public returns(uint, string memory) {
        ...
        if(_price > propertyPrice && _price > lastPrice[tokenId]){
    ...
    function withdrawMoney() public onlyOwner {
        require(wallet1 != address(0) && wallet2 != address(0), "Assign wallet1, wallet2 and royaltyAddress addresses properly");
    ...
    function _beforeConsecutiveTokenTransfer(
        ...
        _beforeConsecutiveTokenTransfer(from, to, 0, size);
    }
