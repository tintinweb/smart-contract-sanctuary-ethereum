...
{    
    ...
    struct UserSaleInformation
    {
        ...
        uint _MintPackAmountPurchased;     // [4] -> _MintPackAmountPurchased
        uint _MintPackAmountRemaining;     // [5] -> _MintPackAmountRemaining
        uint _MintPackAllocation;          // [5] -> _MintPackAllocation
        bool _MintPackEligible;            // [7] -> _MintPackEligible
    }
     ...
     * @dev Returns MPMX Sale Information
     */
    function ViewMPMXSaleInformation() public view returns (SaleInformation memory) 
    { 
        SaleInformation memory Info = SaleInformation(
            ViewCurrentPriceMintPass(),
            MintPassSale._MaximumAvailableForSale - MintPassInternalSale._AmountSold,
