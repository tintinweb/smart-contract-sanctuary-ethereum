...
// File contracts/interfaces/IRentable.sol
...
contract Rentable is ERC721Enumerable, IRentable {
    ...
    function createRentalUnit(
        ...
        require(_tokenAddr != address(this), "ERCRentable20: cannot rent rentable token");
    ...
    //
    function cancelUnit(uint256 _unitId) external {
        require(_exists(_unitId), "Rentable: Unit does not exist");
