    ...
    ERC721Enumerable
{
     ...
     * @return URI of _tokenId.
     */
    function tokenPayload(uint256 _tokenId)
        external
        view
        validNFToken(_tokenId)
        returns (string memory)
    ...
    function _setTokenPayload(uint256 _tokenId, string memory _uri)
        internal
        validNFToken(_tokenId)
    {
...
contract VorbitNFT is NFTokenEnumerableMetadata, Ownable {
    ...
    function changeName(string calldata name, string calldata symbol)
        external
        onlyOwner
    {
        nftName = name;
