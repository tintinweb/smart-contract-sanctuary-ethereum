...
contract ExchangeChallenge is IExchangeChallenge, Ownable, ERC1155Holder{
    ...
    function addChallenge(        
        ...
        uint256 airdropEndAt)external override{
            _addChallenge(collection, assetId, amount, airdropStartAt, airdropEndAt);
    }
    /**
    ...
    function _addChallenge(        
        ...
        uint256 amount, 
        uint256 airdropStartAt,
        uint256 airdropEndAt) internal returns (bytes32){
    ...
    * @param amount the amount to aidrop to receiver
    ...
    function airdropChallenge(
        ...
        uint256 amount
            ...
            emit AirDropChallenge(challengeId, receiver, amount);
...
interface ILoyalty {
    ...
    */
    function isResaleAllowed(address collection, uint256 assetId)
        external
        view
        returns (bool);
