...
contract IrBankMonitorSingleAsset {
    ...
    function _getBaseUintInternal(address _underlying) internal view returns (uint256) {
    ...
    function getUnderlyingConfig(address _underlying) external view returns (address, address, uint256) {
        ...
        _pToken = _getPtokenInternal(_underlying);
        _stakeReward = _getStakeRewardInternal(_underlying);
        _baseUnit = _getBaseUintInternal(_underlying);
        return (_pToken, _stakeReward, _baseUnit);
