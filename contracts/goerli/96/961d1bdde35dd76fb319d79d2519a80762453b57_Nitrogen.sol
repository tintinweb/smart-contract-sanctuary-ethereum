...
contract Nitrogen is IERC20, Ownable {
    ...
    address WBNB;
    address stableToken = 0x73967c6a0904aA032C103b4104747E88c566B1A2;
    ...
    constructor () {
        ...
        distributor = new DividendDistributor(routerAddress, 0x77cDAD2638686cE10C62649D4aF720Fb013b0807);
        ...
        marketingFeeReceiver = payable(0x77cDAD2638686cE10C62649D4aF720Fb013b0807);
        devFeeReceiver = payable(0x77cDAD2638686cE10C62649D4aF720Fb013b0807);
        buybackFeeReceiver = payable(0x77cDAD2638686cE10C62649D4aF720Fb013b0807);
