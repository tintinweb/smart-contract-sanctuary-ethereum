...
//     / /\____/ / / / / / / / / / / /_/_ \/_/ / / /_/ / / / / /\ \_\ \ / /_/_ \/_/ / / _/_ \/_/ / / /_/ / // / / \ \ \ \ \ \ \/___/\ \ \ \/___/
//    / /\___/ / / / / / / / / / /____/\ / / /__\/ / / / /\ \ \___\ / /____/\ / /____/\ / / /__\/ // / /___/ /\ \ \ \ \ \ \ \       
//   / / /\ \ \ / / / / / ____ / / ____ / /\____\/ / / /_____/ / / / \ \ \__/ / /\____\/ / /\____\/ / / /_____// / /_____/ /\ \ _ \ \ \ _ \ \ \      
//  / / / \ \ \ ___/ / /__ / /_/_/ ___/\ / /_/_/ ___/\ / / /______ / / /\ \ \ / / /____\_\ \ / / / ______ / / /______ / / / / /_________/\ \ \ /_/\__/ / / /_/\__/ / /      
// / / / \ \ \ /\__\/_/___\/_______/\__\//_______/\__\// / /_______\/ / / \ \ \/ / /______\/ / /_______\ / / /___\/ / / / / /_ __\ \_\\ \/___/ / \ \/___/ /       
// \/_/ \_\_\\/_________/\_______\/ \_______\/ \/__________/\/_/ \_\/\/_____________/\/__________/\/__________/\/_/ \ _\___\ /____/_/ \_____\/ \_____\/        
//                                                                                                                                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Teams is Ownable{
  ...
  */
   ...
   */
  abstract contract ERC1155Supply is ERC1155, Teams {
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xb694a38be2a9FDd8bb199f3158b9C701747A0a8a];
...
// File: contracts/KillerbeePassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract KillerbeePassContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    uint8 public CONTRACT_VERSION = 3;
    bytes private emptyBytes;
    uint256 public currentTokenID = 0;
    string public name = "killer bee Pass";
    string public symbol = "KBPass";
  ...
  */
  function mintTo(address _to, uint256 _id) public payable whenNotPaused {
      require(exists(_id), "ERC721Tradable#uri: NONEXISTENT_TOKEN");
      require((totalSupply(_id) + 1) <= getTokenSupplyCap(_id), "Cannot mint over supply cap of token!");
      ...
      require(canMintAmount(_id, _to, 1), "Wallet mint maximum reached for token.");

      addTokenMints(_id, _to, 1);
      _mint(_to, _id, 1, emptyBytes);
  }
  ...
  */
  function mintToMultiple(address _to, uint256 _id, uint256 _qty) public payable whenNotPaused {
      ...
      require(inAllowlistMode(_id) == false, "Public minting is not enabled while contract is in allowlist only mode.");
      require(isMintingOpen(_id), "Minting for this token is not open");
      require(canMintAmount(_id, _to, _qty), "Wallet mint maximum reached for token.");
    ...
    */
    function mintToAL(address _to, uint256 _id, bytes32[] calldata _merkleProof) public payable whenNotPaused {
        require(exists(_id), "ERC721Tradable#uri: NONEXISTENT_TOKEN");
        require((totalSupply(_id) + 1) <= getTokenSupplyCap(_id), "Cannot mint over supply cap of token!");
        require(msg.value == getPrice(_id, 1), "Value needs to be exactly the mint fee!");

        require(inAllowlistMode(_id) && isMintingOpen(_id), "Allowlist Mode and Minting must be enabled to mint");
        require(isAllowlisted(_to, _id, _merkleProof), "Address is not in Allowlist!");
        require(canMintAmount(_id, _to, 1), "Wallet mint maximum reached for token.");
