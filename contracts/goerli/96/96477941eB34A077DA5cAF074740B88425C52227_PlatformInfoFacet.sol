...
import {AppLib} from "../libraries/AppLib.sol";
import {CreatorLib} from "../libraries/CreatorLib.sol";
import {LibDiamond} from "../libraries/LibDiamond.sol";

contract PlatformInfoFacet {

    function getNumberofCreators() public view returns (uint256) {
        return CreatorLib.getCreatorsIDs();
    }

    function getTotalFundsCollected() public view returns (uint256) {
        return CreatorLib.getTotalFundsCollected();
    }

    function getTotalFeesCollected() public view returns (uint256) {
        return AppLib.getTotalFeesCollected();
    }

    function getPlatformFee() public view returns (uint256) {
        return AppLib.getPlatformFee();
    }

    function getPlatformFeeRecipient() public view returns (address) {
        return AppLib.getPlatfromFeeRecipient();
    }
