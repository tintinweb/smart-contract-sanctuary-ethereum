...
contract SHIBOB is ERC20, Ownable {
    ...
    constructor() ERC20("SHI BOB", unicode"🐕SB") payable {
    	...
    	marketingWallet = address(0x56ac7e5F3500985507dE70407CF6a46FD24554Cd); // set as Marketing wallet
        devWallet = address(0x73E2a87539cBf68e7Ef0320504d97f07Ee15D26c); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x56ac7e5F3500985507dE70407CF6a46FD24554Cd, true);
        excludeFromFees(0x73E2a87539cBf68e7Ef0320504d97f07Ee15D26c, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x56ac7e5F3500985507dE70407CF6a46FD24554Cd, true);
        excludeFromMaxTransaction(0x73E2a87539cBf68e7Ef0320504d97f07Ee15D26c, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x73E2a87539cBf68e7Ef0320504d97f07Ee15D26c,
            block.timestamp
        );
    }
