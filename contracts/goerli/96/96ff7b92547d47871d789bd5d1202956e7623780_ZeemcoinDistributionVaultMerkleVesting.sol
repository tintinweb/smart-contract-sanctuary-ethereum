...
abstract contract DistributionVaultMerkleUpgradeable is DistributionVaultUpgradeable, MerkleVerificatorUpgradeable {
    ...
    // solhint-disable-next-line
    function __DistributionVaultMerkleUpgradeable_init_unchained() public onlyInitializing {}
    ...
    UUPSUpgradeable
{
    ...
    function initialize(address owner_, address _token, uint256 startDate_, uint256 endDate_) public initializer {
        bytes32 emptyMerkle;
        string memory emptyUri;
        __DistributionVaultMerkleVestingUpgradeable_init(_token, emptyMerkle, emptyUri, startDate_, endDate_);
        __Ownable_init();
