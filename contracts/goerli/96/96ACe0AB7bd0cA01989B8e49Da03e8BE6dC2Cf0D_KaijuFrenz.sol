...
contract KaijuFrenz is ERC721A, Ownable {
    uint256 public constant PRESALE_SUPPLY = 1;
    uint256 public constant FREE_SUPPLY = 1;
    uint256 public constant MAX_SUPPLY = 5;

    //Create Setters for price
    uint256 public WL_PRICE = 0.0000088 ether;
    uint256 public PUBLIC_PRICE = 0.0000012 ether;

    uint256 public constant PRESALE_LIMIT = 100;
    uint256 public constant MINT_LIMIT = 100;
    ...
    address public constant ADDRESS_1 =
        0xa1eF58670368eCCB27EdC6609dea0fEFC5884f09; //OWNER
    address public constant ADDRESS_2 =
        0xc2A3cB7d4BF24e456051E3a710057ac61f5dB133; //ROYAL LABS
    ...
    constructor() ERC721A("KaijuFrenz", "KAIJUFRENZ", 1, 5) {}
    ...
    function mint(
        ...
        uint64 expireTime,
        bytes memory sig
    ) external payable isSecured(3) {
        bytes32 digest = keccak256(
            abi.encodePacked(msg.sender, expireTime, numberOfTokens)
        );
        // require(, "CONTRACT_MINT_NOT_ALLOWED");
