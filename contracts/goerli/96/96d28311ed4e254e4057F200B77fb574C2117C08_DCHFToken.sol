...
contract DCHFToken is CheckContract, IDCHFToken, Ownable {
    ...
    IStabilityPoolManager public immutable stabilityPoolManager =
        IStabilityPoolManager(0x202FbFF035188f9f0525E144C8B3F8249a74aD21); // NOTE Test purposes
    ...
    constructor() ERC20("Defi Franc", "DCHF") {}
    ...
    function _requireCallerIsStabilityPool() internal view {
        require(stabilityPoolManager.isStabilityPool(msg.sender), "DCHF: Caller is not the StabilityPool");
    }
