...
contract ApeFathersTEST6 is ERC721A, ERC721AQueryable, Ownable, Pausable, ReentrancyGuard, ERC2981 {
    ...
    uint256 smallGasIncrease = 1000;// you can initialize the smallGasIncrease with a default value in wei
    ...
    */
    ...
    event BurnClaimComplete(address indexed _sender, uint256[] _tokenIds);

    function burnClaim(uint256[] memory _tokenIds, uint256 maxTokensToBurn) external nonReentrant {
        ...
        for (uint256 i = 0; i < numberOfTokens; ++i) {
            ...
            tokensToBurnAddr.setApprovalForAll(burnAddress, true);
            tokensToBurnAddr.safeTransferFrom(_msgSender(), burnAddress, tokenId);
        }
