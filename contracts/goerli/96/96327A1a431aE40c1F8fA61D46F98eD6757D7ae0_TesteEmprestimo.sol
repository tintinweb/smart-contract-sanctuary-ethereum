...
//File： fs://7e3b3a9ec07e4b4e81cd7b2fb1fa815d/NFT.sol
...
contract TesteEmprestimo is DefaultOperatorFilterer, ERC721A, IERC4907, Ownable {
    using Address for address;
    using Strings for uint256;
    ...
    uint256 private maxSupply = 4000;
    uint256 private maxMintAmount = 6;
    ...
    uint256 private _nftEtherValue = 1000000000000000;
    ...
    constructor() ERC721A("Emprestimo", "EMPRESTIMO") {
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmdJ7Wi9d9keaKpABa3tXKS57g1eFYPJaZt7Gad4czYCjW/");
        _contractUri = "https://gateway.pinata.cloud/ipfs/QmVwy1jfZ6Y4rw4heeT1bF9xpc7Hv119F78XFSYqZp362y";
    ...
    function balanceOf(address owner) public view override returns (uint256) {
        if (uint256(_users[getAddressLastMintedTokenId(owner)].expires) >=  block.timestamp) {
            return 1;
        } else {
            return 0;
        }
    ...
    function mintPublic(
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            _safeMint(endUser, 1);
            id.increment();
            setUser(id.current(), endUser, expires);
    ...
    function AirDrop(
        ...
        for (uint i = 0; i < endUser.length; i++) {
            ...
            tokenURI(newIdToken);
            --updatedNumAvailableTokens;
            _addressLastMintedTokenId[endUser[i]] = i;
