...
contract RewardContract is ERC165, RewardSettings, IRewarder{
    ...
    struct ProjectProposal{
        ...
        bytes32 IPFS_CID; //The content identifier of the project on IPFS
    ...
    RewardSettings(governor,  28800 /* ~5 days */, 40320 /* ~7 days */, 100e18 /* 100 tokens */, 20e18 /* ~20 percent */, 40320 /* ~7 days */)
    {
   ...
   /**
    ...
    function eligableRewards() public view returns(uint256) {
    ...
    function rewardProposal(uint256 proposalId) public override returns(uint256 rewardsIssued){
        ...
        uint256 totalReward = 
            (_underlying.balanceOf(address(this)) - heldCollateral) * 
            approve /
            adjustedTotalVotes *
            approve /
            (approve + disapprove);
            ...
            uint256 currentReward = 
                totalReward * currentVotes(currentIndexProposal)
                 /
                    ...
                    totalVotes(currentIndexProposal) /  
                    _storageInstance.getEntryNumber(currentIndex, address(this), 0));
...
abstract contract IRewarder is IERC165 {
    ...
    /// @dev Emitted when a new project proposal is uploaded
