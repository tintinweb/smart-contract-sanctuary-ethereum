...
contract NftFactory {
    ...
    function getNftCollectionSize(address collectionAddress)
        ...
        returns (uint256)
    {
        return AuxiunNft(collectionAddress).getCollectionSize();
    }
    ...
    {
        return AuxiunNft(collectionAddress).getCollectionName();
    }

    function mintNft(address collectionAddress) public {
        AuxiunNft(collectionAddress).mint(msg.sender);
    }

    function airdropNft(address collectionAddress, address holder, uint256 id) public {
        AuxiunNft(collectionAddress).airdrop(msg.sender,holder,id);
    }
    ...
    function getNftRemaingNfts(address collectionAddress)
        ...
        returns (uint256)
    {
        return AuxiunNft(collectionAddress).getRemainingNfts();
    }
    ...
    {
        return AuxiunNft(collectionAddress).royaltyInfo(tokenId, salePrice);
    }
    ...
    function collectionOwner(address collectionAddress)
        ...
        returns (address)
    {
        return AuxiunNft(collectionAddress).owner();
    }
    ...
    function nftOwner(address collectionAddress, uint256 id)
        ...
        returns (address)
    {
        return AuxiunNft(collectionAddress).nftOwnerOf(id);
    }

    function getDeploy(address collectionAddress) public returns (uint256) {
        return AuxiunNft(collectionAddress).getDeployedDate();
    }
    ...
    function getDeployTwoDays(address collectionAddress)
        ...
        returns (uint256)
    {
        return AuxiunNft(collectionAddress).getTwoDaysFromDeployment();
    }

    function tokenUri(address collectionAddress, uint256 tokenId)
        public
        view
        returns (string memory)
    {
        return AuxiunNft(collectionAddress).tokenURI(tokenId);
    }
    ...
    function approve(
        ...
        AuxiunNft(collectionAddress).approve(to, tokenId);
    }
}

contract AuxiunNft is Initializable, ERC721Upgradeable {
