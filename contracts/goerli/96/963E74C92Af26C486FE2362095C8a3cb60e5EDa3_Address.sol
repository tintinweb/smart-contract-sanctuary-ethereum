...
contract MyNFTContract is ERC721, Ownable {
    ...
    constructor() ERC721("My NFT Collection", "MYTOKEN") {
        MAX_DOGE_SUPPLY = 10000;
        REVEAL_TIMESTAMP = block.timestamp + (86400 * 7);
        mintPrice = 5; // 0.069 ETH
        maxToMint = 30;
        saleIsActive = false;
        wallet1 = 0x596b111310D02cFD0c05944A991AbB28a13a5437;
        wallet2 = 0x596b111310D02cFD0c05944A991AbB28a13a5437;
    }
