...
contract dAgoraFactory is Ownable {
    ...
    HarryPotter[] public harryPotter;
    ShallNotBeNamed[] public voldamort;

    uint256 public NFTAindex;

    address public dAgoraMembership;
    address public dAgoraFactoryOwner;
    address public dAgoraTreasury;

    bool public paused = false;

    event FactoryCreated(address indexed contractAddress, address indexed owner, uint256 Id);
    ...
    function createSimpleNFTA(
        ...
        emit FactoryCreated(address(simpleNFTa[NFTAindex]), msg.sender, NFTAindex);
