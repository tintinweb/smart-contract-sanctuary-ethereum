...
contract AgencyUsdcAMMRouter is Ownable, AccessControl {
        ...
        returns (uint numerator, uint denominator)
    {
        ...
        */
        ...
        uint n1 = fs*t1; // n1 = reserveFrax * interpolateFromPrice.temple ( current: 900000000000000002000 * 50000 = 4,5×10²⁵ )
        uint n2 = f1*ts; // n2 = interpolateFromPrice.frax * reserveTemple ( current: 100000 * 889382990550305723438 = 8,893829906×10²⁵ )
