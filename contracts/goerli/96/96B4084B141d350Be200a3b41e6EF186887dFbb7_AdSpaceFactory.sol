...
contract AdSpaceFactory is ERC721Holder {
    ...
    constructor(address tablelandAddress) {
        ...
        //);
        _adspacetableid = _createTable(
            "CREATE TABLE AdSpaces (adspace_id INTEGER ,PRIMARY KEY(adspace_id));"
        );
        ...
        _campaigntableid = _createTable(
            "CREATE TABLE Campaigns (deal_id INTEGER PRIMARY KEY);"
        );
        ...
        _dealtableid = _createTable("CREATE TABLE Deals (campaign_id INTEGER)");
