...
contract GrindPass is ERC721A, Ownable {
    ...
    uint public constant WHITELIST_MINT_PRICE = 0.008 ether;
    uint public MINT_PRICE = 0.0077 ether;

    SaleStatus public saleStatus = SaleStatus.PAUSED;

    bytes32 public merkleRoot;
    
    string private _baseURL = "https://freemint-nft.com/ipfs/metadata";

    // TODO: Change this address when deploying on mainnet
    FreemintPass FreemintPassContract = FreemintPass(0xca0Cd1f948C3829E9095C3a728267036F6786927);
    ...
    function contractURI() external pure returns (string memory) {
        return "https://freemint-nft.com/ipfs/contract_metadata.json";
    }
