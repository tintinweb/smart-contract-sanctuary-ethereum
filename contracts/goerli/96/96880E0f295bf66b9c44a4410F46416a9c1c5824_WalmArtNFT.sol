...
contract WalmArtNFT is ERC721URIStorage, Ownable, Mintable {

    constructor(address _imx)
        ERC721("WalmArt", "WalmArt")
    ...
    ) internal virtual onlyOwnerOrIMX override {
        _safeMint(to, id);
        _setTokenURI(id, string(abi.encodePacked(blueprint)));
    }
}
