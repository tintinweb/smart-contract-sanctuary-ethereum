...
contract KAC100_68th is ERC721, Ownable, DefaultOperatorFilterer {
  using Strings for uint256;
  ...
  uint public constant MAX_TOKENS = 100;
    ...
    constructor() ERC721("Karuta Autograph Clollection 100 68th Meijin", "KAC100-68th") {
        baseUri = "ipfs://bafybeigsxxxh4fwybefn6rts2uish5x364dw54f25wpu5xf357cln6yz7i/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOwner, ) = payable(0x1C2cA4a6eD433677a9A60EDf476999249f32b7b3).call{value: balance}("");
        //( bool transferOne, ) = payable(0x1C2cA4a6eD433677a9A60EDf476999249f32b7b3).call{value: balanceOne}("");
        //( bool transferTwo, ) = payable(0x1C2cA4a6eD433677a9A60EDf476999249f32b7b3).call{value: balanceTwo}("");
        require(transferOwner, "Transfer failed.");
    }
}
