...
contract Staking is IERC721Receiver {
    ...
    // delete after safeTransfer seems unsafe ?
    function unstake() external {
        // TODO: here we would need to wait for the game to close the game
        // TODO: call the contract & send the reward amount determined by the game
        uint256 rewardedAmount = STAKING_FEE;
        gemsToken.transferFrom(address(this), msg.sender, rewardedAmount);
