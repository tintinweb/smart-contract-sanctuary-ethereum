...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xc0564Ba784f2DEB3fa32f32b762073A719830D36];
  address public erc20Payable = 0xc0564Ba784f2DEB3fa32f32b762073A719830D36;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 99) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibttre4abzvzafdmso4lafiw6tx6jafw3nran4g3qh6oxln5m4rqy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/jDUY4jb92NIn0RfRIMWm/contract-metadata";
  }
...
// File: contracts/PixelDoriSamuraiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixelDoriSamuraiContract is RamppERC721A {
    constructor() RamppERC721A("Pixel Dori Samurai", "PDS"){}
}
