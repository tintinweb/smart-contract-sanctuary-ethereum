...
//Mental Health Coin ICO contract 
...
contract MentalHealthCoin is ERC20, Ownable, ReentrancyGuard {
    ...
    */
    function mint(address account, uint256 amount) public onlyOwner returns (bool sucess) {
      require(account != address(0) && amount != uint256(0), "function mint invalid input");
    ...
    */
    function burn(address account, uint256 amount) public onlyOwner returns (bool success) {
      require(account != address(0) && amount != uint256(0), "function burn invalid input");
    ...
    */
    function buy() public payable nonReentrant returns (bool sucess) {
      require(msg.sender.balance >= msg.value && msg.value != 0 ether, "function buy invalid input");
    ...
    */
    function withdraw(uint256 amount) public onlyOwner returns (bool success) {
      require(amount <= address(this).balance, "function withdraw invalid input");
