...
contract RootRem is ERC20, NativeMetaTransaction, ContextMixin, IMintableERC20  {
    address public mintableERC20PredicateProxy = 0x37c3bfC05d5ebF9EBb3FF80ce0bd0133Bf221BC8;

    constructor(string memory name_, string memory symbol_) public ERC20(name_, symbol_){}

    function mint(address user, uint256 amount) external override {
        require(_msgSender() == mintableERC20PredicateProxy);
        _mint(user, amount);
    }
