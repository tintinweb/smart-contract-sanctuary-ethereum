...
contract FraAuctionFractionalizer is ReentrancyGuard {
    ...
    function fractionalize(
        ...
        FraAuctionFractionsImpl(_fractions).initialize(_from, _target, _tokenId, _name, _symbol, _fractionsCount, _fractionPrice, _kickoff, _duration, _fee, vault);
        emit Fractionalize(_from, _target, _tokenId, _fractions, _name, _symbol, _fractionsCount, _fractionPrice, _kickoff,_duration, _fee);
        return _fractions;
    }

    event Fractionalize(address indexed _from, address indexed _target, uint256 indexed _tokenId, address _fractions,
        string name, string symbol, uint256 supply, uint256 price, uint256 kickoff, uint256 duration, uint256 fee);
}