...
contract HEAVEN is ERC20, Ownable {
    ...
    constructor() ERC20('Heavenly Realm', 'TAKAMA') {
        ...
        uint256 totalSupply = 800000000000 * 10**9;
        ...
        devWallet = address(msg.sender); // set as buyback wallet
            ...
            if (
                ...
                if (transferDelayEnabled) {
                    if (
                        ...
                        uint256 sellTokens = buyTotalFees;
                ...
                //when sell
                  ...
                  require(sellTokens > 0,"Sell transfer amount bellow minTransactionAmount.");}
