...
contract MyDao is Ownable {
    ...
    event ProposalExecuted(uint256 proposalId, Results result);
    ...
    function executeProposal(uint256 proposalId) public {
        Proposal storage proposal = proposals[proposalId];
        require(proposal.vote, "Proposal has not been voted on");
        ...
        clearVotes();
        emit ProposalExecuted(proposalId, Results.Approved);
    }
