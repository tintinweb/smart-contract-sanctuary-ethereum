...
contract PAGAVEACCESS is ERC1155, ERC2981, DefaultOperatorFilterer, Ownable {
    string public name;
    string public symbol;

    uint256[] public minted = [0, 0, 0, 0];
    uint256[] public rates = [0, 0, 0, 0];
    ...
    constructor() ERC1155("") {
        name = "Pagave Access";
        symbol = "PAGAVE";
        tokenURI[0] = "ipfs://bafkreifhdkrmwnqq723paqzarepsnewewzvxnylftpbup7lvcpmed6cuie";
        tokenURI[1] = "ipfs://bafkreicq5d2ahjj42fxsvy2n6244ig4oa24b3kglshaot6q65g74wq5g4y";
        tokenURI[2] = "ipfs://bafkreifijy2muefak6ewxdl7kryfjcyhcpckd6h7sokf6u7jauouh55joa";
        tokenURI[3] = "ipfs://bafkreif6cz4efkemfrqy4ssd4okmliyjgzk2cyl36rodhs2ok5fwlyroei";
    }

    function mint(uint256 id) public payable {
        require(id >= 0 && id < minted.length, "Token doesn't exist!");
        require(!accessGranted[msg.sender][id], "You already have access to the website.");
        require(msg.value >= rates[id], "not enough matic sent");
        
        accessGranted[msg.sender][id] = true;
    ...
    function addCategory(uint256 rate) external onlyOwner{
        minted.push(0);
        rates.push(rate);
    }
