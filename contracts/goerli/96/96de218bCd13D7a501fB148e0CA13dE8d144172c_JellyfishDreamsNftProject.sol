...
contract JellyfishDreamsNftProject is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Jellyfish Dreams NFT", "JDNFT") {       
    ...
    function mint(bytes32[] memory proof, bytes32 leaf, uint256 numberOfTokens) public payable returns(uint256,uint256){
        ...
        require(res <= maxSupply, "Purchase would exceed max supply of Jellyfish Dreams");        
