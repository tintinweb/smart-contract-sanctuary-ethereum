...
contract GGLori is ERC721, ERC721Enumerable, Pausable, Ownable {
 ...
 uint256 ownerMintedCount = addressMintedBalance[msg.sender];
    ...
    require(WhitelistMintOpen, " WhitelistMintOpen must be Open to mint" );
    ...
    require(totalSupply() + _mintAmount < MAX_TOKENS + 1, "We Sold Out!");
  ...
  uint256 ownerMintedCount = addressMintedBalance[msg.sender];
    ...
    require(publicMintOpen, " publicMintOpen must be Open to mint" );
 ...
 function setNftPerAddressLimit(uint256 _limit) public onlyOwner {
  ...
  function  Airdrop(uint8 _amountPerAddress, address[] calldata addresses) external onlyOwner {
    ...
    require(totalSupply + totalAmount <= MAX_TOKENS, "Exceeds max supply.");
     for (uint256 i = 0; i < addresses.length; i++) {
 ...
 function setmaxMintAmount(uint256 _newmaxMintAmount) public onlyOwner {
        ...
        returns (bool)
    {
       ...
       0xEd42E33703413a62f5aB07B521fb296EE9384515;
