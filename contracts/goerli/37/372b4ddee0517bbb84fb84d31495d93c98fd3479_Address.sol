...
// File: contracts/peenus/ERC721A.sol
...
// File: contracts/peenus/Peens.sol
...
contract Peens is ERC721A, Ownable, ERC2981 {
    ...
    constructor() ERC721A("PEENS", "PEENS") {
        _setDefaultRoyalty(0x1B65a9816EF95229ACC3384E67956A7dFaB2b87c, 500);
    }
    ...
    function chadMint(uint256 qty) external payable mintCompliance(qty) {
        uint balance = IERC721(0x5FD6eB55D12E759a21C09eF703fe0CBa1DC9d88D).balanceOf(msg.sender);
    ...
    function phaseMint(uint phaseId) external payable {
        ...
        if (phases[phaseId].mints[msg.sender].length > 0) revert AlreadyMinted();
        uint qty = phases[phaseId].allowedMints[msg.sender];
        for (uint i = _totalMinted() - qty; i < _totalMinted(); i++) {
