...
contract GenesisPassV1 is ERC721AQueryableUpgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    function initialize(string memory baseURI) public initializerERC721A initializer {
        ...
        ERC721AUpgradeable.__ERC721A_init("GenesisPass", "GenesisPass");
