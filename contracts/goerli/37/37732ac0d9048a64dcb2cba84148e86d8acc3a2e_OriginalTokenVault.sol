 ...
 */
contract OriginalTokenVault is ReentrancyGuard, Ownable, Initializable, Pausable {
    enum Status {
        SUBMITTED,
        COMPLETED,
        CANCELLED
    ...
    //uint64 _nonce
        ...
        uint64 depId = _deposit(NATIVE, amount, toChainId, recipient);
    ...
    function withdraw(
        ...
        transfer(_recipient, _token, _amount);
