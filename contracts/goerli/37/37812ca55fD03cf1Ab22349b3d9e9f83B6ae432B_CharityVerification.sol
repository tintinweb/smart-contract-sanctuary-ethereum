...
contract CharityVerification is
  ...
  ERC721Burnable
{
  constructor() ERC721("Kind Blocks", "KB") {}
  ...
  function checkVerifiedCharity(string calldata _charityId)
    public
    view
    returns (bool)
  {
  ...
  function checkVerifiedSafe(address _safeAddress) public view returns (bool) {
    return verifiedSafes[_safeAddress];
  }

  /// @dev Return charity info of given Gnosis safe address
  function getCharity(address _safeAddress)
    public
    view
