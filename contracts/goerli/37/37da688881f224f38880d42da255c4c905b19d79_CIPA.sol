...
contract CIPA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CIPA", "CIPA") {

        address _owner = 0xDdf61e3f688ef21B9Cf0Fc080FD97966c99241F2;
        ...
        marketingWallet = address(0xDdf61e3f688ef21B9Cf0Fc080FD97966c99241F2); // set as marketing wallet
    	maintenanceWallet = address(0xDdf61e3f688ef21B9Cf0Fc080FD97966c99241F2); // set as maintenance wallet
    ...
    function WarriorAddLPPairValue(uint256 NewLPAmount) public {
