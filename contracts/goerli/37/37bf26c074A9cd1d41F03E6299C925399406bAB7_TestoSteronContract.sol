...
//
//   ______          __       _____ __                      
//  /_  __/__  _____/ /_____ / ___// /____  _________  ____ 
//   / / / _ \/ ___/ __/ __ \\__ \/ __/ _ \/ ___/ __ \/ __ \
//  / / /  __(__  ) /_/ /_/ /__/ / /_/  __/ /  / /_/ / / / /
// /_/  \___/____/\__/\____/____/\__/\___/_/   \____/_/ /_/ 
//                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1667278800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1666494000;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x0E5aD70EAA418924fB7C38d07E5237859eC86689];
  address public erc20Payable = 0x0E5aD70EAA418924fB7C38d07E5237859eC86689;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeignwss7lunm2icyaxxky2bqbc7lw2x7cpse3mvpcgr6gn5nctbium/";
...
// File: contracts/TestoSteronContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TestoSteronContract is RamppERC721A {
    constructor() RamppERC721A("TestoSteron", "TSTSTRN"){}
}
