...
contract BattleSpecies is ERC721Namable, ERC721Enumerable, BattlespeciesWithdrawer, RevokableOperatorFilterer {
    ...
    uint256 public mintWhitelistPrice = 35000000 gwei; //0.35 ETH

    uint256 public autoManifestPrice = 55000000 gwei; //0.01 ETH
    ...
    constructor(address _hyperwarpManager, address _utilityHub, bytes32 _wlRoot) ERC721Namable("Battlespecies", "BATTLE") OperatorFilterer(currentOperatorFiltererSubscriber, true){
    ...
    function setOperatorFiltererSubscriber(address _subscription) public onlyOwner {
        //OPERATOR_FILTER_REGISTRY.unsubscribe(currentOperatorFiltererSubscriber, false);
        OPERATOR_FILTER_REGISTRY.unregister(address(this));//also unsubscribes
