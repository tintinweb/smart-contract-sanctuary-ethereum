...
contract Lottery is Ownable, Pausable {
    ...
    bool private isCountdownStarted;
    ...
    function startCountdown() public onlyOwner whenNotPaused {
        ...
        require(!isCountdownStarted, "Countdown has already been started");
    ...
    function deposit() public payable whenNotPaused {
        ...
        require(isCountdownStarted, "Countdown has not been started yet");
