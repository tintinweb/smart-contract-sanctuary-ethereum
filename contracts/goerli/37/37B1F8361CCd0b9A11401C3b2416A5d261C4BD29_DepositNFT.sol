...
contract DepositNFT is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(uint256 _maxSupply, uint256 _depositPrice, uint256 _sellGoal, uint256 _decisionTime, address _bankOwner, string memory _name, string memory _token) ERC721(_name, _token) {
