...
contract SoSoHLTicket is ERC1155URIStorage, Ownable, Operable {
    using Strings for string;

    string public name = 'So-So Halloween Live Ticket SBT';
    string public symbol = 'SoSoHLTicket';
    mapping(address => bool) bondedAddress;

    constructor() ERC1155('') {
        _grantOperatorRole(msg.sender);
        _setBaseURI('data:application/json;base64,ewogICJuYW1lIjogIlNPQlQiLAogICJkZXNjcmlwdGlvbiI6ICJIYWxsb3dlZW4gTGl2ZS4iLAogICJpbWFnZSI6ICJodHRwczovLzIyMTAtc29zby1tdXNpYy5zMy5hcC1ub3J0aGVhc3QtMS5hbWF6b25hd3MuY29tLzEwMzBfSE5TTlBfdGlja2V0Lm1wNCIKfQ==');
