...
contract GamoFlip is VRFConsumerBaseV2, ReentrancyGuard {
    ...
    function fulfillRandomWords(
        ...
        distribute(getPreFlip.degen, getPreFlip.choice, getPreFlip.ethBetted, randomNumber);
    ...
    function distribute(address degenToPay, uint choice, uint ethBetted, uint randomNumber) internal nonReentrant {
