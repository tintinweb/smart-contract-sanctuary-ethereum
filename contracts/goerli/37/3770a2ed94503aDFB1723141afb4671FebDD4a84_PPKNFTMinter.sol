...
contract PPKNFTMinter is ERC721A, Pausable, Ownable, ReentrancyGuard {
   ...
   // This is it baby!!!
   mapping(address => uint256) public goldMintPassHolders;
   ...
   uint256 public PPKETHPrice = 0.25 ether;
   // Price in CIGs: 0.25 ETH
   uint256 public PPKCIGsPrice = 0.25 ether;   // <<--------- CIGs not ETH!!!
   ...
   constructor() ERC721A("PProduct", "PRDKT", 11, 4595) {

   // constructor(address[] memory mintPassers, uint256 collectionSize) ERC721A("PProduct", "PRDKT", 11, collectionSize) {
      ...
      // goldMPHolderAddressesArray[5] = ;
      // goldMPHolderAddressesArray[6] = ;
      // goldMPHolderAddressesArray[7] = ;
      // goldMPHolderAddressesArray[8] = ;
      // goldMPHolderAddressesArray[9] = ;

      // 10-19:
      // goldMPHolderAddressesArray[10] = 0xBcd4042DE499D14e55001CcbB24a551F3b954096;
      // goldMPHolderAddressesArray[11] = 0x71bE63f3384f5fb98995898A86B02Fb2426c5788;
      // goldMPHolderAddressesArray[12] = 0xFABB0ac9d68B0B445fB7357272Ff202C5651694a;
      // goldMPHolderAddressesArray[13] = 0x1CBd3b2770909D4e10f157cABC84C7264073C9Ec;
      // goldMPHolderAddressesArray[14] = 0xdF3e18d64BC6A983f673Ab319CCaE4f1a57C7097;
      // goldMPHolderAddressesArray[15] = 0xcd3B766CCDd6AE721141F452C550Ca635964ce71;
      // goldMPHolderAddressesArray[16] = 0x2546BcD3c84621e976D8185a91A922aE77ECEc30;
      // goldMPHolderAddressesArray[17] = 0xbDA5747bFD65F08deb54cb465eB87D40e51B197E;
      // goldMPHolderAddressesArray[18] = 0xdD2FD4581271e230360230F9337D5c0430Bf44C0;
      // goldMPHolderAddressesArray[19] = 0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199;
      ...
      // ===>>>CREATE / POPULATE THE "goldMintPassHolders" MAPPING of WINNING GOLD-MINT-PASS BIDDERS/MINTERS:
      // REMINDER: 
      // mapping(address => uint256) public goldMintPassHolders;
    
      for (uint256 i; i < goldMPHolderAddressesArray.length; i++) {
         console.log("\n>CONSTRUCTOR FOR LOOP \n >ADDING Address to 'goldMintPassHolders' MAPPING \n >MINTING to ETH Account # %s, which is: %s \n", i, goldMPHolderAddressesArray[i]);
         // Add address and it's ranking to my MAPPING:
         goldMintPassHolders[goldMPHolderAddressesArray[i]] = i;
   ...
   */
   ...
   // READ comments inside here below:
   function mintToMintPassHolders(uint startingETHAddressIndexNum) public onlyOwner() { 
      ...
      // My array of MintPassHolders - thosw winning bids from the Auction - will have 135 (or wever) ETH addresses in it.
   ...
   function regularMint() external payable callerIsUser whenNotPaused() {
      console.log("\n>In 'regularMint()'");
