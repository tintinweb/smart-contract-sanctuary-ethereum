...
contract TERMTRRR is ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("TERRRTRRR", "TERMTRRR") {
        royalityFee = 1;
        artist = 0xDd58155Cf5080E6CC225BCf41f013cDBAB7471Ac;
    }

    function mintNFT(address to, string memory uri) public virtual payable {
        uint256 supply = totalSupply();
        require(supply + 1 <= maxSupply, 'ERC721 : Max supply exceeds!');
    ...
    //     return "https://gateway.pinata.cloud/ipfs/QmTtBAMFSwbaRHNb6CAep2fFNmVHWUaKUMs8Z88YzVCyAD";
    // }
