...
/**
 * @title  IDiagonalERC1967Proxy contract interface
 * @author Diagonal Finance
 */
interface IDiagonalERC1967Proxy {
    /**
...
import { IDiagonalERC1967Proxy } from "../interfaces/proxy/IDiagonalERC1967Proxy.sol";

import { Initializable } from "openzeppelin-contracts-upgradeable/proxy/utils/Initializable.sol";

contract DiagonalERC1967Proxy is Initializable, IDiagonalERC1967Proxy {
    /**
     *
     * Errors *
     *
    ...
    error DiagonalProxyInitializationFailed();
    error NotContract();
    ...
    function _safeInitDelegateCall(address implementation, bytes memory data) private {
        ...
        if (!success) {
            ...
            revert DiagonalProxyInitializationFailed();
        }
    }
