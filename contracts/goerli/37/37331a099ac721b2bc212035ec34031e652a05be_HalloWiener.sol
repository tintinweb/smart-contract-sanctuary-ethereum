...
// File: contracts/HalloWiener.sol
...
contract HalloWiener is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("HalloWiener", "HAWI") {
  }
...
function whitelistMint(uint8 _mintAmount, bytes32[] memory proof) external payable {  
