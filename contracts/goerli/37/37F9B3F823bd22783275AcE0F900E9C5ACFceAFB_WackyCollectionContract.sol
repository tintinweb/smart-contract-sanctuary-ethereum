...
//  .----------------. .----------------. .----------------. .----------------. .----------------. 
// | .--------------. | .--------------. | .--------------. | .--------------. | .--------------. |
// | | _____  _____ | | |      __      | | |     ______   | | |  ___  ____   | | |  ____  ____  | |
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1670551200;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x7b44D768e084929654dD885cADA37eb72679435B];
  address public erc20Payable = 0x7b44D768e084929654dD885cADA37eb72679435B;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1500, 1500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://ipfs://bafybeiccjgex7btqskcy5qhyc52yqht7hww5kt67vbygxsj4icyjlzrvmm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/1O9MhozutEmk4dpAPhRC/contract-metadata";
  }
...
// File: contracts/WackyCollectionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WackyCollectionContract is RamppERC721A {
    constructor() RamppERC721A("Wacky Collection", "Wackybycc"){}
}
