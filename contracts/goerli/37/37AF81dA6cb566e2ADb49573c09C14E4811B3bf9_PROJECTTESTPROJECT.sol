...
contract PROJECTTESTPROJECT is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 20;

    
  uint256 public PRESALE_SUPPLY = 10;
  uint256 public PUBLIC_SUPPLY = 9;
    
  bool public IS_PRESALE_ACTIVE = false;
  bool public IS_PUBLIC_ACTIVE = false;

    
  uint256 public PRESALE_TX_LIMIT = 1;
  ...
  uint256 public PUBLIC_COUNT = 0;
    ...
    mapping(address => uint) public PRESALE_Minted;mapping(address => uint) public PUBLIC_Minted;

    bool public _revealed = false;

    string private baseURI = "";
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmehsCXCX9UArJwcmE5UcsFVcwtQhbHAD6EYkTP4k5FzX1/pre-reveal";

    mapping(address => uint256) addressBlockBought;

    address public constant RL_ADDRESS = 0xc9b5553910bA47719e0202fF9F617B8BE06b3A09; 

    constructor() ERC721A("PROJECTTESTPROJECT", "TOOOOKEN") {
