...
contract TestCollectionSBT is Ownable, ERC721Enumerable {
    ...
    function mint(
        ...
        require(
            ...
            "TestCollectionSBT: URI should not be empty"
        );
    ...
    function tokenURI(uint256 tokenId_) public view override returns (string memory) {
        require(
            _exists(tokenId_),
            "TestCollectionSBT: URI query for nonexistent token"
        );
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "TestCollectionSBT: transfer is disabled"
        );
