...
contract HAaveProtocolV2 is HandlerBase, IFlashLoanReceiver {
  ...
  // prettier-ignore
  address public constant PROVIDER = 0x5E52dEc931FFb32f609681B8438A51c675cc232d;
  // prettier-ignore
  ...
  function flashLoan(
    ...
    try ILendingPoolV2(pool).flashLoan(address(this), assets, amounts, modes, onBehalfOf, params, REFERRAL_CODE) {} catch Error(string memory reason) {
  ...
  function executeOperation(
    ...
    _requireMsg(msg.sender == ILendingPoolAddressesProviderV2(PROVIDER).getLendingPool(), "executeOperation", "invalid caller");
  ...
  function _borrow(
    ...
    try ILendingPoolV2(pool).borrow(asset, amount, rateMode, REFERRAL_CODE, onBehalfOf) {} catch Error(string memory reason) {
