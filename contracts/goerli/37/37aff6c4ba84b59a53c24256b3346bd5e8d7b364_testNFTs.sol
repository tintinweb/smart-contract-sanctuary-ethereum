...
contract testNFTs is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    // Supply
    uint256 public mintReward = 50;
    uint256 private creatorReward = 20;
    ...
    // Lists
    uint256[2000] public remainingIds;
    mapping(uint256 => uint256) public lastDividendAt;
    mapping(uint256 => address) public minters;

    // Params
    bool public paused = false;
    bool private paysInTokens = true;
    ...
    address private TeamReceiver = 0xE58BaF94B10122c056C3F0514Cd9C5331f82dDEb;
    address private CreatorReceiver = msg.sender;
    ...
    function setFees(uint256 _newcreatorReward, uint256 _newmintReward) public onlyOwner {
    ...
    {
        // Checks
        require(_winner != address(0), " Winner cannot be zero address");
        require(_amount > 0, "You have to mint at least one");
        require(lastSupply != 0, "Collection is all sold out");
    ...
    function tokenURI(uint256 _id)
        ...
        returns (string memory)
    {
        require(_exists(_id), "test: URI query for nonexistent token");
  ...
  function withdraw() public payable onlyOwner {
    ...
    function handleMintReward(uint256 _amount) private {
        ...
        uint256 teamShare = _amount.sub(mintShare).sub(creatorShare);
    ...
    function claimRewards() public {
        require(!paysInTokens, "test: rewards are paid in tokens");
