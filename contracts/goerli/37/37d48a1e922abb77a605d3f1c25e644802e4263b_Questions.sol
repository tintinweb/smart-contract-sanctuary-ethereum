...
/**
    ...
    We all have unanswered questions in the crypto world.
    Where is the Dev?
    When is the next caller?
    When marketing?
    I have one question. When are you gonna stop jeeting lol?
    When are you gonna start taking responsibly profits?
...
contract Questions is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Questions";
