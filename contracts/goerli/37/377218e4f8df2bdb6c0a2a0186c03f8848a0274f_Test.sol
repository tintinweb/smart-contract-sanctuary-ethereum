...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0857F10224527954491579a2E08Fb8b557106e22; // owner address
...
contract Test is Context, IERC20, Ownable {
    ...
    string private _symbol = "Testerinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0857F10224527954491579a2E08Fb8b557106e22); // Marketing Address
    address payable public DevAddress = payable(0x0857F10224527954491579a2E08Fb8b557106e22); // Dev Address
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountDev = amountReceived.mul(_devShare).div(totalFee);
        ...
        if(amountDev > 0)
            transferToAddressETH(DevAddress, amountDev);
