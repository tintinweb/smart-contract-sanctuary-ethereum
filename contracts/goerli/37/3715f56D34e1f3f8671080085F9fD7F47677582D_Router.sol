...
contract Router {
    ...
    function getParifiRewards(address currency)
        external
        view
        returns (address)
    {
    ...
    function setCurrencies(address[] calldata _currencies)
        external
        onlyOwnerOrFactory
    {
    ...
    function setDecimals(address currency, uint8 _decimals)
        external
        onlyOwnerOrFactory
    {
    ...
    function setPool(address currency, address _contract)
        external
        onlyOwnerOrFactory
    {
    ...
    function setPoolShare(address currency, uint256 share)
        external
        onlyOwnerOrFactory
    {
    ...
    function setParifiShare(address currency, uint256 share)
        external
        onlyOwnerOrFactory
    {
    ...
    function setPoolRewards(address currency, address _contract)
        external
        onlyOwnerOrFactory
    {
    ...
    function setParifiRewards(address currency, address _contract)
        external
        onlyOwnerOrFactory
    {
