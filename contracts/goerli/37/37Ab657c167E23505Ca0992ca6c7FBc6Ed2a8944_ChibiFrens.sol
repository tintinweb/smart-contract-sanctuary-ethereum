...
contract ChibiFrens is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public mintPrice = 0.0000005 ether;
    uint public collectionSize = 10000;
    uint256 public maxItemsPerWallet = 533;
    uint256 public allowlistReserved = 3300;
    uint256 public allowlistMinted = 0;
    uint256 public publicMintReserved = 533;
    ...
    // public mint
    function publicMint(uint256 amount) external payable nonReentrant onlySender {
