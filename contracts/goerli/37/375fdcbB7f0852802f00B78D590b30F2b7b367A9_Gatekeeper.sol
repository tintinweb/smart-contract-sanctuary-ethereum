...
contract Gatekeeper is ERC20, Ownable {
    ...
    constructor() ERC20("Tsuka Gatekeeper V2", "Tsukagate_V2") {
        setupRouter();
        setupFee();
    }

    function setupFee() private {
        ...
        devWallet = address(0xfeC037Fe8DebD2351E6a82712c49fe56BA4aae1a); // Deployer wallet
