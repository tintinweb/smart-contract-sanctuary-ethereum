...
contract MetadataServer is Ownable {
    ...
    string[3] public endpoints = [
        ...
        "https://artscript/content/7840b700689166a98618c627b067a60f0139e998538010851ada69c669fa8bfdi0" //?download=true
    ];
    ...
    function setContractInfo(ContractInfo memory _contractInfo) external { //only owner??
        if (msg.sender != tokenContract)
            revert NotAuthorized();
