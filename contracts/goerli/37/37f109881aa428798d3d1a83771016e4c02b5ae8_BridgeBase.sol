...
contract BridgeBase is Ownable{
    ...
    constructor(string memory _network) {
        ...
        // Update Token
        updateAuthorizationForToken(0xf079d762D0a2e0B64eab3E6f2Fa0A9950b4ac15b,true); //USDT 
        updateAuthorizationForToken(0x8670A7764b3101ca67A7952D8270020ED676C93A,true); //USDC
        updateAuthorizationForToken(0x9422d0bACEfe263DD81d76C5F3E08760a52b83d4,true); //WETH
        updateAuthorizationForToken(0x3591cC30525fbdabD5454584AD6ff93eA2ce4681,true); //WBTC
    ...
    function deposit(string memory _uuid,
                    ...
                    uint _destinationAmount,
                    address _destinationTokenAddress,
                    string memory _destinationNetwork) public returns (bool) {
    ...
    function claim( string memory _uuid,
        ...
        // Transfer Tokens
        IERC20(_destinationTokenAddress).transferFrom(address(this),_destination,_destinationAmount);
