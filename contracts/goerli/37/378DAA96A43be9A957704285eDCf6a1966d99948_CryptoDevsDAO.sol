...
contract CryptoDevsDAO is Ownable {
            ...
            bytes(
                string(
                    ...
                    abi.encodePacked(   // entire "identity" Key's IMPLEMENTATION is input below:
                        ...
                        numProposals,
                        ") has been created in the DAO by\n",
    ...
    // Helper function to convert address to string in createProposal()
            ...
            bytes(
                string(                    
                    abi.encodePacked(   
                        ...
                        ",",
                        "\nThank you for casting your vote and your continued support.",
                        "\nGood Day!"
                    )
                )
            )
            ...
            bytes(
                string(                    
                    abi.encodePacked(   
                        ...
                        "Hello",                                        
                        ",",
                        "\nYou're being notified that the proposal has been executed.",
                        "\nGood Day!"
                    )
                )
            )
