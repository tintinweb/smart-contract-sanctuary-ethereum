...
contract MultiPoolDeployer {

    IPoolFactory public factory = IPoolFactory(0xBd8A30b425a7d4eF24520c6338e0B0f39b269459);

    function createPools(uint256 amount) external returns(Pool[] memory) {
        Pool[] memory pools;
        for(uint i = 0; i < amount; i++) {
            factory.deploySurgePool(IERC20(address(0)), IERC20(address(1)), i, i, i, i, i, i, i);
        }
        return pools;
    }
}
