...
//               .#<~~~?Me                            (M=~~_db.
//              .M$~~~~~?Mp                          j#<~~~~(M[
//              .N:~~~~~~?Mp                        [email protected]<~~~~~~d#
//              j#~~~~~~~~?N;                      (#:~~~~~~~JN.
//              [email protected]~~~~~~~~~dN.                    .M3~~~~~~~~(M}
//              db~~~~~~~~~(Mb                   .dD~~~~~~~~~(M[
//              db~~~(dNx~~~(M;                  (#<~~_(g+~~~(M[
//              db~~~(MvNx~~~db.                .M$~~_j#[email protected]~~~(M\
//              d#~~~(M>dN/~~(M;                j#~~~(M{[email protected]~~~(M}
//              J#_~~(Mr(MR_~_db               .M$~~([email protected]~~~(N~
//              ,N<~~(Mb~?Ml~~(M;              (#<~_d#:(MD~~.j#
//             `.Ml~~~d#__dN_~_Mb             .MD~~(M$~(M>[email protected]
//               MP~~~JN:~(Nl~~dN.            -M>~~j#<~j#:~~(M]
//               dN_~~(Mr~(WR_~(M;            j#~~([email protected]~~~(M\
//               ,N<~~~d#_~dN<~(Mb            MD~~(#>~(Ml~~~(#`
//               .Mr~~~?Ml~(Mr~~dN           [email protected]_~d#<~~_dF
...
//  [email protected]<~~~~~~~~~~~.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~.~~~~~~~~~~vM[`
//  (Mt~~~~~~~~~.~~~~~~~~~~~~~~~~(J._~~~~.~(J.~~~~.~~~~~~~~~~~~~.~~~~~~~_M#.
//  d#[email protected]_~~~~~.~~.~~~~~~~~~~.~~~~~JM_
//  [email protected]~~~~~~~~~~~~~~~~~~~.~~.~~~?Hgd$_(J--?Had9~~~~~~~~~~~~.~~~~~~~~~~~~~(N{
//  d#_~~~~~~~~~~~.~~~~~~~~~~~~~~~~~(MMMMMr_~~~~~~~~~~~~~~~~~~.~~~~~~~.~~(M:
//  JNc~~~~.~~~.~~~~~.~~~~~~~~~~(H>~~?WM#Y~~_dp~~~~.~~~~.~~~~~~~~.~~~~~~(d#`
//  .MN-~~~~~~~~~~~~~~~~.~~~~~~.jN+~~~(MR_~~-d#~~~~~~~~~~~~~~~~~~~~~.~~~+M%
//   (MN-~~~~~~~~~~~~~~~~~~.~~~~_?MNmN#WTNNNME<~~~~~~.~~~~~.~~~~~~~~~~~([email protected]
//    ?MN/~~~.~~~.~~.~~~~~~~~~~~~~~~_J}[email protected]`
//     (MNe_~~~~~~~~~~~.~~~~~~~~~~~~_?ojJK~~~~~~~~~~~~~~~~~~~~~~~.~~(dMD
//       TMN&_~~~~~~~~~~~~.~~.~~~~~~~~_<<~~~~~~~~~~~~~~~~~~~~~~~~~(gM#^
//        .TMNe-~~~~.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~.~~.~~~.~~~_(gMM=
//          .TMMNJ-~~~~~~~~~~~~~~~~~~~~~~~~~~~~~.~~~~~~~~~~~_(&MMB^
//             _TMMNa._~~.~~~~.~~.~~~~~~~~~~~~~~~~~~~~~~_(JgMMB=`
//                 ?TMMNaJ--_~~~~~~~.~~~~~.~~.~~~~~((J&gMM#"!
//                     ?7MMMMNNag+JJ--((((([email protected]?`
//                      -M>~~~<?7TTYYYYYBBYYYT7=<<~~~d#.
//                      J#<~_-_~~~~~~~~~~~~~~~~~~--~~JN_
//                      [email protected]~~(Ml~~~~~~~~~~~~~~~~~~d#_~(M[
//                      MD~~d#<~~~~~~~~~~~~~~~~~~dN:~(M]                      .       .
//                      Mh(-d#~~~~~~~~~~~~~~~~~~~(Mo-(MD                      rI    .zI
//                      ?""[email protected]_~~~~~~~~~~~~~~~~~~(M#""9!                      t?{   (<I
//                          dD~~~~~.~_-(--_~.~~~~(M}                   .w7-   z.1  .>.>    ...    ...
//                         .M$~~~~~(gMB"WMNe_~~~~_Wr                .JuuA-x. .zoJ+(J&J>  .====((((===1.
//                         .M$~~~~(MD`    (MR_~~~_db             .JuuuuuuuuV zttrrtrttro.(==?====??==z!
//                         .M>~~~(MF       [email protected]            .uuuV!   ?7` zrt>   -Otr> (==v!  ?=?=_
//                         ,N<[email protected]`        (Nc~~~d#            JuuC         ztrtzzzOrtZ` +==:    +==: .+====:
//                         (N<~~(M:          [email protected]            zuul         zttttttttrI. +?=<....1==: +=z::<_
...
//    mapping (uint256 => NftInfo) nftInfos;
    ...
    string constant rl2='{"name": "Character Dao BCvocalo2 NFT - ';
...
//        _grantRole(ADMIN,0x0dAE5FcaD0DF8E5C029D76927582DFBdFd7eeC79);
    ...
    // 2023/1/21 00:00:00 (JST) = 1674226800				
    // 2023/1/22 00:00:00 (JST) = 1674313200
    function mintableTimer() public view returns (bool){
        if (block.timestamp >= 1674226800 && block.timestamp < 1674313200) {
            bool mintable = true;
            return mintable;
        } else {
            bool mintable = false;
