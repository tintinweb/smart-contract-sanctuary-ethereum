...
contract Staker {
  ...
  // Modifiers
  modifier deadlinePassed(bool passRequired) {
    if (passRequired) {
  ...
  function stake() public payable deadlinePassed(false) stakingNotCompleted {
    ...
    console.log(msg.sender, "balance is", balances[msg.sender]);
    console.log(address(this), "balance: ", address(this).balance);
  }

  // After some `deadline` allow anyone to call an `execute()` function

  function execute() public deadlinePassed(true) stakingNotCompleted {
  ...
  function withdraw() public deadlinePassed(true) {
    ...
    address withdrawer = payable(msg.sender);
    uint256 userBalance = balances[msg.sender];
    require(userBalance > 0, "userBalance has no eth to withdraw");
    balances[msg.sender] = 0;

    (bool success, ) = withdrawer.call{value: userBalance}("");
