...
contract Blackjack is ReentrancyGuard {
    ...
    function play(bool isEth, address tokenAddr, uint256 amount) public payable betLimit(isEth, amount) {
        ...
        uint256 playerCard1 = (cards[0]);
        uint256 playerCard2 = (cards[1]);
        uint256 dealerCard1 = (cards[2]);

        uint256 pCard1 = (playerCard1) % 13;
        uint256 pCard2 = (playerCard2) % 13;
        uint256 dCard1 = (dealerCard1) % 13;
        ...
        emit CardsDistribution(currentBetId, playerCard1, playerCard2, dealerCard1);       
    }
    ...
    function split(uint256 betId) public payable playerChecks(betId) {
        ...
        uint256 playerCard2 = cards[0];
        uint256 splitPlayerCard2 = cards[1];

        uint256 pCard2 = (playerCard2) % 13;
        uint256 spCard2 = (splitPlayerCard2) % 13;
        ...
        emit SplitPlayer(betId, playerCard2, splitPlayerCard2);
    }
    ...
    function doubleDown(uint256 betId, uint256 amount) public payable playerChecks(betId) {
        ...
        uint256 playerCard3 = cards[0]; 
        uint256 pCard3 = (playerCard3) % 13;      
        ...
        emit DoubleDown(betId, playerCard3);
    }
    ...
    function hit(uint256 betId) public playerChecks(betId){
        ...
        emit PlayerHit(betId, playerCard3);
    }
    ...
    function revealDealerCard(uint256 betId) internal {
        ...
        checkWinner(betId);
        emit DealerSecondCard(betId, card[0]);
    }
    ...
    function dealerHit(uint256 betId) internal {
        ...
        uint256 newDealerCard = newCard ;
        uint256 newCardForDealer = newDealerCard % 13;
    ...
    function checkWinner(uint256 betId) internal {
        ...
        uint256 winAmount = bet.player.winningAmount + bet.splitPlayer.winningAmount;
        if(isEther[betId]){
