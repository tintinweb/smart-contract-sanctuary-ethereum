...
contract NFTMarketplace is ReentrancyGuard{
    ...
    //mapping of seller address to amount earned!
    ...
    function listItem(
        ...
        //1. Send the NFT to contract. Transfer-> COntract "hold" the NFT.abi
        //2. Owners can still hold their NFT but give market place the approval to sell the NFT,
        //to sell the NFT for them. (Lease intrusive way to writing)
        IERC721 nft = IERC721(nftAddress);
    ...
    function buyItem(address nftAddress,uint256 tokenId ) external  payable nonReentrant isListed(nftAddress,tokenId) {
        ...
        //pull over push!
        //shift the risk associated with transfering ether to the user!
        //Have them withdraw the money!
        //Shift the risk to the actual user!
