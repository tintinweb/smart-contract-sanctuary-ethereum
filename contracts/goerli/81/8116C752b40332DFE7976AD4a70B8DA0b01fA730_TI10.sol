...
contract TI10 is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
// ATG Main Constructor
  ...
  function reserveTokens (address _receiver, uint256 _mintAmount) public onlyOwner {
   ...
   /**
    * @notice Execute airdrops to all provided addresses
    */
  ...
  /**
    ...
    */
  function setClaimStatus (uint256 _ids, bool _claim) public onlyOwner {
      reserveList[_ids].claimed = _claim;
  }
