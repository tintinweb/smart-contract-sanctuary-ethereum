...
contract ArcadeToken is ERC20Burnable, AccessControl {
    ...
    constructor() ERC20("Arcade Token", "ARC") {
        ...
        // _mint(_arcadeVault, MAX_SUPPLY); // Remove for production, XArcade supply will be minted first
    }
    ...
    function mintArcade(uint256 _amount) public isArcadeSwapContract {
        ...
        ERC20(this).increaseAllowance(ArcadeSwapContractAddress, _amount);
     ...
     */
    function updateArcadeSwapContract(address _ArcadeSwapContractAddress)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ArcadeSwapContractAddress = _ArcadeSwapContractAddress;

        _approve(ArcadeSwapContractAddress, ArcadeSwapContractAddress, MAX_SUPPLY);
