...
contract IP3 is Initializable, OwnableUpgradeable {
    ...
    function initialize(IERC20 instanceAddress, address manageFeeAddress, address _signer)
        public
        initializer
    {
        __Ownable_init();
    ...
    function claimRevenue(bytes32[] memory hashedCertifcates) external {
        ...
        for (uint256 i = 0; i < size; i++) {
            if (isValidClaim(msg.sender, hashedCertifcates[i])) {
                ...
                totalBalance += claimableMap[hashedCertifcates[i]].claimableAmount;
            }
        }
        ...
        returns (bool)
    {
        ...
        address currentHolder = IERC721Upgradeable(nft.NFTAddress).ownerOf(nft.tokenId);
