...
contract AltarHelper {
    function external_getWalletOfOwnerGenerativeGenesis(address address_, IERC721Upgradeable genesis, IERC721Upgradeable generative) public view 
    ...
    function walletOfGenesis(address address_, IERC721Upgradeable genesis) public view 
    returns (uint256[] memory) {
    ...
    function walletOfGenerative(address address_, IERC721Upgradeable generative) public view 
    returns (uint256[] memory) {
