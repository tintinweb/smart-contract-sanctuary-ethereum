...
contract ReignToken is ERC20, Ownable, ReentrancyGuard  {
    // for uint256;
    ...
    constructor(address _busdToken, address _presale)ERC20("Reign", "REIGN"){
    ...
    function takeFee(
        ...
        } else if (automatedMarketMakerPairs[sender]) _realFee = totalBuyFee; */
