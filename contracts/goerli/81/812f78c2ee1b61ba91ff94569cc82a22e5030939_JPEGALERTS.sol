...
contract JPEGALERTS is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    constructor() ERC721("JPEGALERTS", "JPAL") {}
    ...
    // set baseURI
    function setBaseURI(string memory baseURIVal) public {
        baseURI = baseURIVal;
    }
    ...
    // withdraw balance
    function withdrawBalance(address addy) external onlyOwner {
