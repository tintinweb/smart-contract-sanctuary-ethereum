...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    /*  EVENTS    */
    // INDEXED PARAMETER = TOPIC    // MAX 3    // SEARCHABLE
    event RaffleEnter(
    ...
    function performUpkeep(bytes calldata /* if defined what returns from checkupkeep */) external override {
    ...
    function getNumWords() public pure returns(uint256){
        return NUM_WORDS; // CONSTANT ARE PURE
    }
