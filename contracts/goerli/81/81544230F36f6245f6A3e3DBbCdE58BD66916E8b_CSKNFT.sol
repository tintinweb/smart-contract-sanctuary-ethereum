    ...
    Initializable
{
    ...
    event ChangeItemStatus(address userAddress, SignInfo);
    ...
    function checkMetadata(uint256 tokenId)
        public
        view
    ...
    function _hash(SignInfo calldata info) internal view returns (bytes32) {
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "SignInfo(uint256 tokenId,string metadata,bool status)"
                        ),
                        info.tokenId,
    ...
    function _verify(SignInfo calldata order) internal view returns (address) {
    ...
    function updateFlagStatus(SignInfo calldata _info) external payable {
