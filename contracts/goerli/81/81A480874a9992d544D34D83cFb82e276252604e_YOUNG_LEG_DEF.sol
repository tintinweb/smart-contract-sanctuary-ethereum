...
contract YOUNG_LEG_DEF is ERC721A, ERC721ABurnable, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    constructor() ERC721A("YOUNG LEGGENDES HIDDDEND8", "YLHH") {
    ...
    uint public WHITELIST_START_TIME = 1657216800;
    uint public PUBLIC_START_TIME = 9999999999;
    ...
    function whitelistMint(uint _count, bytes memory signature) public payable {
        ...
        require(signatureUsed[msg.sender] + _count <= MAX_PER_MINT, "All mints of this signature has already been used.");
