...
contract FTestPass is ERC721Enumerable, Ownable, ERC2981, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("FTest Pass", "TP") {

        //address that will receive mint funds
        _setRoyalties(msg.sender, 650); //6.5% Royalties
    }
