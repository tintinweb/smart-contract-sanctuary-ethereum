...
contract PosterityWallet {
    ...
    APIConsumer oracle = APIConsumer(0x8459997F58192De7c1E39586B3369A2aC3f5A080);
    ...
    function establishSucessorDeath(string memory authorizedHeir) external {
        ...
        require(msg.sender == 0x8459997F58192De7c1E39586B3369A2aC3f5A080, "Only Oracle contract can call this function");
