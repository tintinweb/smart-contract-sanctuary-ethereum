...
//*********************************************************************//
//
// Optimism Landing 🚀🌑Coming from all over the galaxy, here they are ready to land in your wallet.Take one and join us!Metanauts are 10k NFT ERC-721A generated procedurally and preminted by Minis Labs.
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x985f8C84655Cadf4D245E2D075DAa4cE8C0c4A93];
  address public erc20Payable = 0x985f8C84655Cadf4D245E2D075DAa4cE8C0c4A93;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdWnUN9HS96PozdVv2HarzG7tEk3jhonn6pUhCW2FcSSH/";
...
// File: contracts/Metanauts2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Metanauts2Contract is RamppERC721A {
    constructor() RamppERC721A("Metanauts2", "MINTPLEX"){}
}
