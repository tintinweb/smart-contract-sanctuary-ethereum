    ...
    BlackholePrevention
{
    ...
    ) ERC721("VOX Series 4", "VOX") VRFConsumerBaseV2(_vrfCoordinator) {
     ...
     */
    function setAllowList(address[] calldata addresses)
        public
        onlyRole(ADMIN_ROLE)
    {
     ...
     */
    function clearAllowList(address[] calldata addr)
        public
        onlyRole(ADMIN_ROLE)
    {
     ...
     */
    function openAllowListMint() public onlyRole(ADMIN_ROLE) {
        allowListEvent = true;
    }
     ...
     */
    function closeAllowListMint() public onlyRole(ADMIN_ROLE) {
     ...
     */
    function allowList(address _address) public view returns (bool) {
    ...
    function onERC1155Received(
        ...
        // Added for series 4 to allow for allow list minting
        if (allowListEvent) {
            require(_allowList[from], "VOX Series 4: not in allow list");
            require(
                _allowListCount[from] + value <= MAX_PURCHASE,
                "VOX Series 4: exceeds max purchase"
            );
            _allowListCount[from] += value;
        }
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://www.collectvox.com/metadata/series4/";
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721, ERC721Enumerable, IERC165Upgradeable, AccessControl)
        returns (bool)
    {
        return
