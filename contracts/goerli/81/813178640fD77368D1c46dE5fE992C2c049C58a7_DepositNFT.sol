...
contract DepositNFT {
    ...
    */
    ...
    function supplyLeft() public view returns (uint8) {
        return maxSupply - getTokenIdCounter();
    }

    function decisionTimeIsOver() public view returns (bool) {
        if (block.timestamp >= decisionTimeStartedAt + decisionTime * 1) {
            return true;
        }
