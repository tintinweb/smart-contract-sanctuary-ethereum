 ...
 * @notice This contract handles minting Today DAO tokens.
 */
contract LaunchpadTodayDAO is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0xCD89B56b28914E694BC254E541579dAA4ca4D91D;
    address[] public payoutAddresses = [
        0x53469f448c3EA07671dA492edE02F90790978C9D,
    ...
    string public baseTokenURI =
        "ipfs://bafybeiaqvdhg467szajdcg662brxzfgp5urqzvxktzci2yxyirzmjrri3y/";
    ...
    uint256[] public payoutPercentages = [30, 70];
    uint96 public royaltyFee = 10000;

    constructor() ERC721A("Today DAO", "TDAO") {
