...
contract XENBox is Initializable {
    ...
    function claimMintReward() external onlyAuthorized {
        ...
        // transfer claimed $XEN to NFT Holder
        _transferToOwner();
    }
    ...
    modifier onlyAuthorized() {
        require(
            msg.sender == nft.ownerOf(nftTokenId) || 
            msg.sender == operator,
...
contract XENCrypto is Context, IRankedMintingToken, IStakingToken, IBurnableToken, ERC20("XEN Crypto", "XEN") {
    ...
    function calculateMintReward(
        ...
        return _calculateMintReward(cRank, term, maturityTs, amplifier, eeaRate) * 1 ether;
    }
}
