...
contract Caixunkun is Ownable, ERC721A, ReentrancyGuard {
    constructor() ERC721A("caixunkun", "cxk") {}
    
    uint256 public collectionSize = 98;
    ...
    uint256 public amountForAllowList = 20;
    ...
    uint256 public publicPrice = 0.000010 ether;
    uint256 public amountForPublicSale = 78;
