    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://ipfs.sprawlgame.net/ipfs/QmUsFaCqHVut3E8EJv2pqkC5Ge8irh1NJdzmmJSqB9r2iD/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/QtizrUTguLo5gB8vDDUx/contract-metadata";
  }
...
// File: contracts/PreContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PreContract is RamppERC721A {
    constructor() RamppERC721A("Pre", "PRE"){}
}
