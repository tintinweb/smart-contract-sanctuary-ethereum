...
contract InfanityDrop is ERC721A, AccessControl {
    ...
    uint256 MAX_LIMIT_PER_WHITELIST_ADDRS = 5;
    uint256 MAX_PER_TX = 10;

    uint256 mintPriceInWei = 0.1 ether;

    bytes32 public whitelistMerkleRoot;
    mapping(address => uint256) whitelistMinted;

    bool isPublicMintOpen;
    bool isWhitelistMintOpen;
    ...
    constructor(address _proxyRegistryAddress) ERC721A("Infanity Drop", "INF") {
