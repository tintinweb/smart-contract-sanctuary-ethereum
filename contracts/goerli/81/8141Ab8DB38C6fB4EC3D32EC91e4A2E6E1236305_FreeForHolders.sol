...
contract SynthiaCustomTraits is ERC721AQueryable, Owned, Initializable, ISynthiaTraitsERC721 {
    ...
    function initialize(address _synthiaData, address _synthiaRenderer) public initializer {
        owner = msg.sender;
    ...
    modifier checkSynthiaOwnership(uint256 synthiaTokenId, address to) {
        if (to != ERC721A(0xABf0b84f870ff3B45988e49Fd62B881d7C46C6E6).ownerOf(synthiaTokenId)) {
            revert NotOwner();
        }
        _;
    }
