...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        ...
        string memory baseUrl = "https://lubi.ai/demo.json?address=";
        ...
        string memory url = joinStrings(baseUrl);
    ...
    function joinStrings(string memory a) public returns (string memory) {
        return string(abi.encodePacked(a, msg.sender));
    }
