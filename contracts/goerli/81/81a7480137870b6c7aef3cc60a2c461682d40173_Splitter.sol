...
contract Splitter is Ownable {
    ...
    event PayWhitehat(bytes32 indexed referenceId, address wh, ERC20Payment[] payout, uint256 nativeTokenAmt, address feeRecipient, uint256 fee);
    ...
    function payWhitehat(
        ...
        if (nativeTokenAmt > 0) {
            //TODO: manage excess value from caller and refund
            //TODO: use Address:sendValue and eventually protect from reentrancy
        ...
        //TODO: emit an event per transfer
        emit PayWhitehat(referenceId, wh, payout, nativeTokenAmt, feeRecipient, fee);
    }
}