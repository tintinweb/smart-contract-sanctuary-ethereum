...
// TokenX Contracts v1.0.0 (contracts/Token.sol)
 ...
 */
contract Token is Ownable, ERC20Pausable, ERC20Burnable, ERC20BlackListable, EmergencyWithdrawable {
    /**
...
// SPDX-License-Identifier: MIT
// TokenX Contracts v1.0.0 (extensions/ERC20BlackListable.sol)
pragma solidity ^0.8.0;
...
abstract contract ERC20BlackListable is ERC20 {
    ...
    function _addBlackList(address account) internal virtual {
        require(account != address(0), "ERC20BlackListable: blacklist the zero address");
    ...
    function _removeBlackList(address account) internal virtual {
        require(account != address(0), "ERC20BlackListable: remove blacklist the zero address");
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        require(!isBlackListed[from], "ERC20BlackListable: account blacklisted");
