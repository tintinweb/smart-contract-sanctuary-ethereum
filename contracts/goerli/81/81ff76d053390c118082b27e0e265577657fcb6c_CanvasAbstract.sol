...
contract CanvasAbstract is ERC721A {
    ...
    constructor() ERC721A("Abstract Official By Anon", "COA") {
        owner = msg.sender;
        maxFree = 100;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://Qme5Mix9uaPvU8fSKEVQoej2p1zoCB59etKkEHwT9NF2Yf/", tokenId ,uriSuffix));
    }
