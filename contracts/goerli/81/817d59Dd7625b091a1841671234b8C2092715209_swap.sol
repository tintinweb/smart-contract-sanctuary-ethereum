...
contract swap{
    ...
    function uniswapV3GetPrices(address token0,address token1 , uint amountIn , string memory contractType)public view returns( ItypeData.EndResult [] memory ){
        ...
        for(uint i = 0 ; i <  pairAddress.length ; i++){
            ...
            uniswapPools[count] = ItypeData.EndResult(pairAddress[i] , priceCount[count] , contractType , fee);
    ...
    isToken(token0) view returns(ItypeData.EndResult memory){
        ...
        if(PairPool == address(0)){
            ItypeData.EndResult memory notFound = ItypeData.EndResult(PairPool , 0 , contractType , feeDexV2);
            return notFound;
        }
        ...
        ItypeData.EndResult memory endResult = ItypeData.EndResult(PairPool , amountOut , contractType , feeDexV2);
    ...
    public view returns(ItypeData.EndResult memory)
    {
        ...
        ItypeData.EndResult memory endResult = ItypeData.EndResult(bancorNetWork , amountOut , "BANCORV3" ,0);
