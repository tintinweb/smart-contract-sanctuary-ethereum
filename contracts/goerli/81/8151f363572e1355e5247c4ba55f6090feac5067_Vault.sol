...
// import "chainlink/src/v0.8/factories/CronUpkeepFactory.sol";
...
contract Vault is Ownable {
    // Goerli
    address cronFactoryAddress = 0x1af3cE8de065774B0EC08942FC5779930d1A9622;
    // Mainnet
    ...
    ICronFactory public cronFactory;
    ...
    function addEmployees(address _employeeAddress, uint256 _employeeSalary, address _token) external onlyOwner{
    ...
    function createUpkeep(string memory _cronString) public{
        ...
        bytes memory functionToCall = "0x18e46ce5";
        ...
        cronFactory.newCronUpkeepWithJob(job);
    }
