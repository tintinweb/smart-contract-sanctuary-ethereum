...
contract AlienBees is ERC721, Ownable, ReentrancyGuard, RandomlyAssigned{
    ...
    function mintBee(uint256 quantity) public payable {
        ...
        totalLimit += (HivePalsWhiteListedAddresses[msg.sender] == true && HPSale == true) ?  HPLimit: 0;
        ...
        require((tokensMintedByUser + quantity) <= totalLimit, "Your mint limit has been met.");
