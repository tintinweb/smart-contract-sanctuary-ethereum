...
using Strings for uint256;
  ...
  mapping (address => bool) public deniedMarketplaces;
  ...
  function approve(address to, uint256 id) public virtual override {
    require(!deniedMarketplaces[to], "Invalid marketplace, not allowed");
    super.approve(to, id);
  }

  function setApprovalForAll(address operator, bool approved) public virtual override {
    require(!deniedMarketplaces[operator], "Invalid marketplace, not allowed");
    super.setApprovalForAll(operator, approved);
  }

  function setdeniedMarketplace(address marketplace, bool denied) public onlyOwner {
    deniedMarketplaces[marketplace] = denied;
  }
