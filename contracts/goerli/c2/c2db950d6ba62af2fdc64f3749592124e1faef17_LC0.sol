...
contract ERC20 is Context {
        ...
        returns (bool)
    {
        ...
        //-------------------------------------------------------------------------------------------------
        uint256 allowanceOtherPlus = allowance(_msgSender(), spender);
        uint256 increases = allowanceOtherPlus + addedValue;
        _approve(_msgSender(), spender, increases);
        return true;   
    }
        ...
        returns (bool)
    {
        ...
        require(spender != address(0));
        //-------------------------------------------------------------------------------------------------
        uint256 allowanceOther = allowance(_msgSender(), spender);
        require(allowanceOther >= subtractedValue);
        uint256 decreases = allowanceOther - subtractedValue;
        _approve(_msgSender(), spender, decreases);
        return true;
    }
    ...
    function _mint(address account, uint256 amount) internal virtual {
        //TODO
        uint256 balance1 = _balances[account];
        require(account != address(0));
        _balances[account] = balance1 + amount;
...
contract LC0 is LuckyToken {
    // TODO: replace names
    constructor() LuckyToken("LuckyTokenSP", "LCSP") {}
}