    ...
    function render(uint256 id, uint160 sqrtPriceX96) public view returns (string memory) {
        ...
        return
            string.concat(
                ...
                '<path d="M43.532138,161.525794C26.211909,161.401111,14.270961,191.839849,16.44733,210h153.245886c.91561-1.477597.77527-15.559346,0-18.798493-2.374011-4.687895-12.852309-12.76429-19.670023-17.255565v-2.982799L43.532138,161.525794Z" fill="hsl(',Strings.toString(bg[id+30]),', 100%, 80%)" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
                '<path d="M44.222435,158.93565l-.690297,2.590143c22.65338,20.366154,97.998935,22.133799,102.285558,10.650476L44.222435,158.93565Z" transform="translate(.000001 0.000001)" fill="hsl(',Strings.toString(bg[id+10]),', 100%, 80%)" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
                '<path d="M43.532136,158.49722c-7.193302-2.769057-10.444341-30.915268-7.740564-36.734878c1.581709-11.225501,14.605325-45.413136,25.878472-44.478717c3.526311-10.184046,12.206964-26.700433,22.245631-32.578418c12.443459-7.959621,35.430003-6.5256,45.862888,5.623036c18.43452-12.69121,43.619055-11.759689,46.917207,11.94895c4.87381,1.881459,16.467992,7.588132,15.519504,11.092933c3.398305,1.656981,7.47851,4.828263,6.431164,6.688412c1.419352,1.63023,3.250288,5.294635,3.197039,6.494117.462895,7.446375-2.526177,7.555465-2.682545,8.040315.140906,1.089141-.042849,2.199499-.304967,2.377076l-6.537007,3.932641c-1.935198,3.983228-8.503127,8.819683-12.97255,9.883848c5.881069,4.956369,12.77806,15.386767,12.426191,21.343545l-17.944995,23.381718c-2.564065,4.791131-13.218884,12.855194-24.756826,15.87742-29.31475,6.01402-82.30797,1.314429-105.538642-12.891998Z" transform="translate(.000002 0.000004)" fill="hsl(',Strings.toString(bg[id+10]),', 100%, 80%)" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
                ...
                svg.path(
                    string.concat(
                        ...
                        svg.prop('fill', 'none'),
                        svg.prop('stroke', string.concat('hsl(',Strings.toString(tid),', 100%, 80%)"')),
                ...
                '<path d="M178.303344,136.60599c2.492544-.105922,9.961753-2.485239,13.469257-4.029921c9.403394,6.231565-4.706179,13.091591-15.076829,14.24343" transform="translate(.000001 0)" fill="hsl(',Strings.toString(tid),', 100%, 80%)" stroke="#000" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/><line x1="-103" y1="6" x2="-8" y2="6" transform="translate(125 14.074212)" fill="none" stroke="hsl(',Strings.toString(tid),', 100%, 80%)" stroke-width="4.8" stroke-linecap="round"/>',
                '</svg>'
            );
    }
