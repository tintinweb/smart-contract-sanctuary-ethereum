...
/// @title: Death Clock Lite by DIS x CHAIN/SAW
...
import './IDeathClockLightDescriptor.sol';
    ...
    ReentrancyGuard
{
    ...
    uint256 private constant MINT_PRICE = 0.004321 ether;
    ...
    IDeathClockLightDescriptor public descriptor;
    mapping(uint256 => uint256) public expDates;
    bool public publicCanMint;

    constructor(
        address _deathWishSigner,
        address _descriptor
    )
        ...
        EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION)
    {
        ...
        descriptor = IDeathClockLightDescriptor(_descriptor);
    }
    ...
    // function reset(
    //     DeathReassigment calldata deathWish,
    //     bytes memory signature
    // ) public {
    ...
    function tokenURI(
        ...
        return
            descriptor.getMetadataJSON(
                IDeathClockLightDescriptor.MetadataPayload(
                    tokenId,
                    _mintDates[tokenId],
                    expDates[tokenId],
                    // _resets[tokenId],
...
interface IDeathClockLightDescriptor {
    ...
    function getMetadataJSON(
        MetadataPayload calldata metadataPayload
