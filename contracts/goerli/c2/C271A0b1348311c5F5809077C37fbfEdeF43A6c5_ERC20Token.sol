...
contract ERC20Token is ERC20, Ownable {
    ...
    constructor(
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), 0x07865c6E87B9F70255377e024ace6630C1Eaa37F);
    ...
    function isAccountFee(address _address, bool _value) external onlyOwner {
