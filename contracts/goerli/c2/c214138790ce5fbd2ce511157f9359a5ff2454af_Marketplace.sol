...
contract Marketplace is Ownable {
    ...
    /********************************************
                RULER FUNCTIONS
     ********************************************/
    function setAdmin(address addy, bool isAdmin) public onlyRuler {
        admins[addy] = isAdmin;
    }

    function setOilContract(address oilContract) public onlyRuler {
        OIL_CONTRACT = oilContract;
        OIL = IERC20(OIL_CONTRACT);
    }

    function setMarketplaceActive(bool active) public onlyRuler {
    ...
    function checkAdmin(address addy) public view returns (bool) {
        return admins[addy] || addy == owner() || addy == ruler;
    }
