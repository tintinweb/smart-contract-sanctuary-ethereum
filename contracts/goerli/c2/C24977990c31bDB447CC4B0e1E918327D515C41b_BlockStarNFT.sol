...
contract BlockStarNFT is ERC1155, ERC1155Supply, DefaultOperatorFilterer, Ownable  {
    ...
    string public constant name = "BLOCKSTAR NFT";
    string public constant symbol = "BSTNFT";
