...
contract VerifyStressTest is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 100;

    
  uint256 public PRESALE_SUPPLY = 49;
  uint256 public PUBLIC_SUPPLY = 50;
  ...
  uint256 public PUBLIC_PRICE = 0.15 ether;
  ...
  uint256 public PUBLIC_COUNT = 0;
    ...
    string private baseURI = "https://stg-api.w3bmint.xyz/api/tokens/goerli/63d34c38392ffaaedaa18996/";

    mapping(address => uint256) addressBlockBought;

    address public constant RL_ADDRESS = 0xc9b5553910bA47719e0202fF9F617B8BE06b3A09; 

    constructor() ERC721A("VerifyStressTest", "VERIFY") {
  ...
  function PUBLICMint(uint256 numberOfTokens) external isSecured() payable{
    ...
    require(numberMinted(msg.sender) + numberOfTokens <= PUBLIC_WALLET_LIMIT,"EXCEED__MINT_LIMIT");
