...
contract VLFI is ERC20Upgradeable, ERC20PermitUpgradeable, AccessControlUpgradeable, ERC20VotesUpgradeable {
    ...
    // New method to update stakedToken
    ///@notice Function to update stakedToken
    ///@param _tokenAddress Address of the new token.
    function updateStakedToken(address _tokenAddress) public  onlyRole(MANAGER_ROLE) {
        STAKED_TOKEN = ILFIToken(_tokenAddress);
    }
