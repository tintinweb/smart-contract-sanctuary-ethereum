...
contract Unihorns is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    uint public maxSupply = 3333;
    uint public maxWhitelistSupply = 2000;
    uint public normalMintPrice = 0.01 ether;
    uint public whitelistMintPrice = 0.005 ether;
    ...
    address private _signerPublicKey = 0x6b7fD7eD53127B63c3e45c1C1D91F16E0193B11B;
    string private _contractUri;
    string private _baseUri;

    constructor() ERC721A("Unihorns", "UNIH") EIP712("Unihorns", "1.0.0") {
    }
    ...
    function _hash(address account) private view returns (bytes32) {
        return _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256("Unihorns(address account)"),
                    account
                )
            )
        );
