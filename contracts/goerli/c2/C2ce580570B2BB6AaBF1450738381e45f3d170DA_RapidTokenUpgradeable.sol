...
//        string _currency,
    ...
    function set_coupon_frequency(uint8 _coupon_frequency_) public {
        _coupon_frequency = CouponFrequency(_coupon_frequency_);
    }

    function _storeBaseData(BaseData memory baseData_) public {
        baseData = baseData_;
        emit SetBaseData(
            baseData_.name,
            baseData_.symbol,
    ...
    //    error DateMissmatch(uint256 available, uint256 required);

    function _storeBondData(BondData memory bondData_) public {
        //        require(bondData_.maturity_date > bondData_.start_date, "maturity date <= start date");
        bondData = bondData_;
...
//            bondData_.currency,
        ...
        require(
            block.timestamp < bondData_.start_date,
            "start date has to be greater than now"
        );
        require(
