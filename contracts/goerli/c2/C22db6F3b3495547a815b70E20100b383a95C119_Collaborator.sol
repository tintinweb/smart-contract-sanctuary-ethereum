...
contract Collaborator is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    uint256 public ICOLength = 1000;//1249920; //The length of the ICO in blocks (~1 month) using average block time of 15s CHANGE THIS BACK AFTER TESTING
    ...
    constructor() ERC20("Collaborator", "COLAB") ERC20Permit("Collaborator") Ownable(){
        deploymentBlock = block.number;
        ICOFinalized = false;

        _setMaxChange(20e18); // initialize max change to 20%
        _setChangeTime(40320); // initialize change time to ~1 week
    }
    ...
    function finalizeICO() public{
        ...
        _setMintRate(1000000 ether/*totalSupply() / 3*/); //Sets initial mint rate to 1/3 average ICO rate CHANGE THIS BACK AFTER TESTING
        ICOFinalized = true;
    }
    ...
    function sendTokens() public{
        ...
        _mint(_targetAddress, mintRate() * numBlocks / ICOLength);
