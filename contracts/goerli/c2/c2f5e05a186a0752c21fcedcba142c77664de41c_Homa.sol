...
// File: homa/opensea/IOperatorFilterRegistry.sol
...
// File: homa/opensea/OperatorFilterer.sol
...
// File: homa/opensea/DefaultOperatorFilterer.sol
...
contract Homa is ERC721, Pausable, Ownable, DefaultOperatorFilterer {
  using Strings for uint256;
  using Address for address;
  ...
  uint256 public publicCanMintAt = 1668715200;
  uint256 private canNoLongerPauseAfter = 1669696969;

  mapping(address => uint256) public mintStatus;
  mapping(address => bool) public admins;

  constructor() ERC721("Homa", "HOMA") {
