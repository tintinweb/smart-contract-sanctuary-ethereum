...
function _safeMint1(address to, uint256 tokenId, address _payer,    string memory uri) internal virtual onlyFactory{
...
function _setTokenURI(uint256 tokenId, string memory _tokenURI) internal virtual onlyFactory{
...
function approve(address to, uint256 tokenId) external override onlyFactory{
...
function soulbind(uint256 tokenId) public onlyFactory{
    ...
    function mintSoulboundNFT(uint256 otherNFTTokenId, address payer, string memory uri) external onlyFactory{
