    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiapoloaxu3iuogvouc37fgamx47itknqgjnsdrgcrul2a3ybqc77u/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/S6V7bSDe8kxSxnTW5uty/contract-metadata";
  }
...
// File: contracts/MyTesterProjectContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MyTesterProjectContract is RamppERC721A {
    constructor() RamppERC721A("My Tester Project", "TEEASDA"){}
}
