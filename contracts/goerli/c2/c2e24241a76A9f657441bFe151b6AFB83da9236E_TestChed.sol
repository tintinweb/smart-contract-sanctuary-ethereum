...
contract TestChed is ERC721A, Ownable, OperatorFilterer, MerkleProof {
    ...
    constructor() ERC721A("Test Ched", "POC") OperatorFilterer(address(0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6), true) {
        sethiddenBaseURI("sombodyelse");
    }
    ...
    function chadlistMint(uint256 _amount, bytes32[] memory proof_) public payable onlySender { 
        ...
        if (chadlistMinted[msg.sender] == 0) {
            require(msg.value >= ((_amount * chadlistMintPrice) - chadlistMintPrice), "Not enough ether sent");
        } else {
