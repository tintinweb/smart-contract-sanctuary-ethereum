...
// changed name
contract Skrooge is ERC20, Ownable {
...
// added name
    constructor() ERC20("Skrooge", "Skrooge") {
...
//added bonePileWallet - added addresses
        marketingWallet = address(0x433dEA70d37027090b59C9570045f74Beb953651); 
        devWallet = address(0xbb863eDeeC05b05fBC44d70D0A189a8FffcBD63a);
        bonePileWallet = address(0x0de5ed48d23C73BFF94B6A33678C962C213596a9);
        lpWallet = msg.sender;

        // exclude from paying fees or having max transaction amount 
        // added bonePileWallet and devWallet
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(devWallet, true);
        excludeFromFees(bonePileWallet, true);
        // added bonePileWallet and devWallet
        ...
        excludeFromMaxTransaction(bonePileWallet, true);
    ...
    //changed update MaxTxAmount and MaxWalletAmount to cannot set lower than 1% from ...* 1) / 1000
    ...
    */
    ...
    function updateBuyFees(
        ...
        uint256 _devFee,
        uint256 _bonePileFee
    ) external onlyOwner {
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyDevFee = _devFee;
        buyBonePileFee = _bonePileFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee + buyBonePileFee;
    }
    // added _bonePileFee
    ...
    // added updateBonePileWallet
    function updateBonePileWallet(address newWallet) external onlyOwner {
