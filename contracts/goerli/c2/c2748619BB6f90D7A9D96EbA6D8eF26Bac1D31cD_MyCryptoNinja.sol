...
contract MyCryptoNinja is ERC721A, Ownable {
    ...
    function getNinjaLevel(uint256 tokenId) public view returns (uint256) {
        ...
        if (trainDaysSinceLast >= 14) {
            ...
            upgradeLevel = 300 + ((trainSecondsSinceLast * 100) / (24 * 60 * 5 * DAY_SECOND));
        } else if (trainDaysSinceLast >= 5) {
            upgradeLevel = 200 + ((trainSecondsSinceLast * 100) / (24 * 60 * 4 * DAY_SECOND));
        } else if (trainDaysSinceLast >= 2) {
            upgradeLevel = 100 + ((trainSecondsSinceLast * 100) / (24 * 60 * 3 * DAY_SECOND));
        } else {
            upgradeLevel = (trainSecondsSinceLast * 100) / (24 * 60 * 2 * DAY_SECOND);
        }
