...
contract MyUpgradableToken is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  {}
    ...
    function mint(uint256 amount) external returns (bool) {
        ...
        uint256 paymentTokenDecimals = 6; // Replace with the actual decimal precision of the payment token
        uint256 decimalsMultiplier = 10**(18 - paymentTokenDecimals);

        uint256 feeAmount = (amount * feePercentage * decimalsMultiplier) / (10000 * decimalsMultiplier); // Calculate the fee amount
