...
import "./mason/utils/Payable.sol";
...
contract EarlyMajority is ERC721ABurnable, ERC721AQueryable, Ownable, Payable, AccessControl, Toggleable, EIP712Common, Claimable {
  ...
  function checkWhitelist(uint256 _discount, bytes calldata _signature) public view requiresWhitelist(_signature) returns (bool) {
    return true;
  }

  function checkMemberlist(uint256 _discount, bytes calldata _signature) public view requiresClaim(_signature, 1) returns (bool) {
    return true;
  }
