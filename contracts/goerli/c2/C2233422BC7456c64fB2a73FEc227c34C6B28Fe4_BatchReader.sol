...
contract BatchReader 
{
    ...
    function readWalletOwnedMomentIndividual(uint ProjectID, uint TokenID) public view returns (address Owner)
    {
        IERC721 Moments = IERC721(0xe745243b82ebC46E5c23d9B1B968612c65d45f3d);
        uint _TokenID = (ProjectID * 1000000) + TokenID;
        try Moments.ownerOf(_TokenID) { return Moments.ownerOf(_TokenID); } catch { }
    }
