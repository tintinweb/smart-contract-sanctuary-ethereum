...
//   ______                                                 _______                              
//  /      \                                               /       \                             
// /$$$$$$  | __    __   ______    ______    ______        $$$$$$$  | ______    _______  _______ 
// $$ \__$$/ /  |  /  | /      \  /      \  /      \       $$ |__$$ |/      \  /       |/       |
// $$      \ $$ |  $$ |/$$$$$$  |/$$$$$$  |/$$$$$$  |      $$    $$/ $$$$$$  |/$$$$$$$//$$$$$$$/ 
//  $$$$$$  |$$ |  $$ |$$ |  $$ |$$    $$ |$$ |  $$/       $$$$$$$/  /    $$ |$$      \$$      \ 
// /  \__$$ |$$ \__$$ |$$ |__$$ |$$$$$$$$/ $$ |            $$ |     /$$$$$$$ | $$$$$$  |$$$$$$  |
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0ce2B35f93c5D247a74E9E8bf37BFCCF78EaeEd9];
  address public erc20Payable = 0x0ce2B35f93c5D247a74E9E8bf37BFCCF78EaeEd9;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRC24yMr83XaWsqfY6Hw6jNLzA2htkhNNekrTaRcTWYhk/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/j2vD4v4tVSHcc1FFkimN/contract-metadata";
  }
...
// File: contracts/SuperPassSeason1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SuperPassSeason1Contract is RamppERC721A {
    constructor() RamppERC721A("Super Pass  Season 1", "SuperPass"){}
}