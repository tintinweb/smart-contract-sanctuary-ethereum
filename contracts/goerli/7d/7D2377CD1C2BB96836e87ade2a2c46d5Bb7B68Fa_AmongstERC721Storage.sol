...
contract AmongstERC721Storage is ERC721, ERC721Enumerable, Ownable {
    ...
    event TokenExtended(address indexed owner, uint256 indexed tokenId);
    ...
    function mintToken(uint256 _startBlock, uint256 _endBlock, address _reciever) external onlyMachine() {
      ...
      emit TokenMinted(_reciever, tokenId);
    ...
    function extendToken(uint _tokenId, uint256 _extensionBlocks) external onlyMachine() {
        ...
        emit TokenExtended(ownerOf(_tokenId), _tokenId);
