...
contract CaptainGuard is ICaptainGuard, ICaptainGuardEvents {
    ...
    constructor(address _captain) {
        ...
        // of proxy deployment
        CAPTAIN = _captain;
        emit CaptainAssigned(msg.sender, msg.sender, _captain);
    }

    function updateCaptain(address _captain) public virtual override {
...
library Sealib {
    ...
    function buildOrderFor(
        ...
        uint256 openseaRevenue = (amount * (100e18 - 97.5e18)) / 100e18; // 2.5%
...
contract ListModule is Module, IListEvents, IListActions, IERC721Receiver {
    ...
    constructor(address _seaport, address _conduit) {
        seaport = ConsiderationInterface(_seaport);
        conduit = _conduit;
    }
    ...
    function cancel(OrderComponents[] calldata orders) public virtual {
        if (seaport.cancel(orders) == false) {
            revert CancelFail();
        }
    ...
    CaptainGuard
{
    ...
    function _receive() internal {
        ...
        // TODO: Review how to narrow down the scope
        // of the wallets that can send eth to the contract
        // while the raise is open. Is there a problem?
        if (!_isRaiseOpen()) {
