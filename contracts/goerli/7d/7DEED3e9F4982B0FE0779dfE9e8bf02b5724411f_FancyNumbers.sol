...
contract FancyNumbers is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("FancyNumbers_test1", "FN") {
        baseUri = "ipfs://QmQC8VShP5s6Nde1rsSrgmz7A2gmGguUjGXEgYEr2J7kht/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x577Da7FB6C1d747e7D751ad550781e7A5EF329bC).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x577Da7FB6C1d747e7D751ad550781e7A5EF329bC).call{value: balanceTwo}("");
