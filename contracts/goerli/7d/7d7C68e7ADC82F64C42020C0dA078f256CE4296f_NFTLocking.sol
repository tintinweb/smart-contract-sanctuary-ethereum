...
//    }
    ...
    //    require(shogunIds.length <= 3, "ShogunStaking: Maximum of 3 SS only!");
       //require(NFTIds, "Locking: At least 1 NFT required!");
...
//    }
    ...
    function endTraining(uint256 NFTIds) public {
        ...
        emit TrainingEnded(
            msg.sender,
            NFTIds,
            //families[trainId].NFTIds,
            block.timestamp
        );
    }

    function lockToken(uint256 tokenIds) internal {
 //       for (uint256 i = 0; i < tokenIds.length; i++) {
        SS.safeTransferFrom(msg.sender, address(this), tokenIds);
//        }
   }

    function unlockToken(uint256 tokenIds) internal {
//        for (uint256 i = 0; i < tokenIds.length; i++) {
