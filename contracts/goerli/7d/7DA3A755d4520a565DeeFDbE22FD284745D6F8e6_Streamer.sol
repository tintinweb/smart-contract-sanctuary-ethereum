...
contract Streamer is Ownable {
    ...
    function fundChannel() public payable {
        require(
            ...
            "The sender already has an Open Channel"
        );
    ...
    function withdrawEarnings(Voucher calldata voucher) public {
        ...
        require(
            ...
            "Running channel does not have sufficient balance"
        );
    ...
    */
    function challengeChannel() public payable {
        require(
            balances[msg.sender] > 0,
            "Sender does not have an open channel"
        );
    ...
    */
    ...
    function defundChannel() public payable {
        // require(balances[msg.sender] > 0, "No challenge has been registered");
        // require("timeleft");
        require(canCloseAt[msg.sender] != 0, "Channel is not closing");
        require(canCloseAt[msg.sender] < block.timestamp, "Can't close yet");
