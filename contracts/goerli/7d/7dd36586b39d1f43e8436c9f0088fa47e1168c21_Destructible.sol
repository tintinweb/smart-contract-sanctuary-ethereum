 ...
 * @title HippoSales
 */
contract HippoSales is Ownable, Pausable, Destructible {
    ...
    * @param _nftAddress address for Nanas non-fungible token contract 
    ...
    */
    function purchaseToken(uint256 _tokenId) public payable whenNotPaused {
        require(msg.sender != address(0) && msg.sender != address(this),"purchaser is 0 or contract");
        require(msg.value >= currentPrice,"low balance");
    ...
    */
    function sendTo(address _payee, uint256 _amount) public onlyOwner {
        require(_payee != address(0) && _payee != address(this),"pay is 0 or contract");
        require(_amount > 0 && _amount <= address(this).balance,"amount is 0 or insufficiant!");
