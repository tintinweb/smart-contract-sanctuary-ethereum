...
contract NFTime is Ownable, ERC721URIStorage, ERC721Enumerable, ERC721Burnable {
    ...
    string private baseSvgUrl =
        "ipfs://QmQVS7T3X2eWeXtzpLuDkRWNgqWMsknWJqNpRs1PH666YY";
        ...
        returns (string memory)
    {
        ...
        //"ipfs://bafkreifd55xmhwgcl2zyj5axly4qnphlopa5pewdryd27ngogykeymyjyq";
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                string.concat(
                                    name(),
                                    Strings.toString(tokenIdToTime[_tokenId])
                                ),
                                '", "description":"Collect your favourite Time. Set your time. Mint your time & day.", ',
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmYGSw74RgCr6VxYQMHQgCJvG2ctmmAY7VBJj4RdLS5SwW";
    }
