  ...
  */
  ...
  function mintBatch(
    ...
    for (uint8 i; i < _templateIdsLength;) {
      ...
      _tempData = projectCollections[collectionParams.templateIds[i]][collectionParams.projectId][collectionParams.collectionIds[i]];
      require(_tempData.minTokenId != 0, "unexisting token mint");
      require(
      ...
      for (uint8 ii; ii < _mintCount;) {
        ...
        emit NFTMinted(collectionParams.projectId, collectionParams.templateIds[i], collectionParams.collectionIds[i], _tokenId, to);
        unchecked { ++ii; }
      }

      projectCollections[collectionParams.templateIds[i]][collectionParams.projectId][collectionParams.collectionIds[i]]
  ...
  function mintWithMetadaSlots(
    ...
    addBatchMetadataSlotsToNFT(to, _tokenId, projectIds, projectDefaultUris);
  ...
  function addBatchMetadataSlotsToNFT(
    ...
    for (uint256 i = 0; i < projectCount;) {
      addMetadataSlotToNFT(owner, tokenId, projectIds[i], projectDefaultUris[i]);
      unchecked { ++i; }
    }
  }
  ...
  function addBatchMetadataSlotToNFTs(
    ...
    for (uint8 i; i < mintingLength;) {
      addMetadataSlotToNFT(owner, tokenIds[i], projectId, projectDefaultUris);
      unchecked { ++i; }
    }
  }
