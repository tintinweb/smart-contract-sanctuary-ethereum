...
contract PluralizePause is ERC721, Ownable {
    ...
    constructor() payable ERC721('Pluralize Pause', 'PLRZP') {
        ...
        setHiddenMetadataUri("https://orion.mypinata.cloud/ipfs/QmXtUQftzTBVg8Z9yCeFUUq9YJdvfKoU5W8ZctzU9UpdqP/");
        isRevealed = false;
    ...
    string private customContractURI = "https://orion.mypinata.cloud/ipfs/QmXtUQftzTBVg8Z9yCeFUUq9YJdvfKoU5W8ZctzU9UpdqP/";
    ...
    function getTotalMintPrice(address addr, uint8 quantity_) public view returns(uint256) {
        ...
        uint8 numMintsAtPublicMintCost = quantity_ - numMintsAtCollectorMintCost;

        if(quantity_ < numMintsAtCollectorMintCost ) {
            totalMintPrice = quantity_ * collectorMintCost;
        } else {
            totalMintPrice = (numMintsAtCollectorMintCost * collectorMintCost) + (numMintsAtPublicMintCost * publicMintCost);
        }
    ...
    //Collectors Mint
    // function mintForCollectors(uint256 quantity_) public payable callerIsAWallet {

    //     // uint8 currentNumAvailableToMintForCollector = numAvailableToMintForCollector[msg.sender];
    //     // uint8 currentNumberOfMintsPerWallet = numMintsPerWallet[msg.sender];
    ...
    //     return "currentNumAvailableToMintForCollector: ";
    // }
