...
contract IgnitionList {
    ...
    function _verifyUser(
        ...
        bytes32 leaf = keccak256(abi.encodePacked(_candidate, _userType, _maxPurchaseWhetherOrNotKYCAmount, _maxPurchaseBaseOnAllocations));
...
contract Pool is Pausable, ReentrancyGuard, IgnitionList, AccessControl, Initializable {
    ...
    /// @dev Mapping from User to airdrop amount
