...
contract RecognitionToken is Ownable, ERC1155URIStorage {
	error NotAuthorized();
	error InvalidLength();

	string public name = "Recognition Token";
	string public symbol = "RECOGNITIONTOKEN";

	/// @notice the contract uri
	string public contractURI;

	/// @notice address allowed to mint
	/// @dev using the minter patterns allows to later create contracts allowing to create claiming schemes
	...
	constructor(string memory newContractURI) ERC1155("") {
	...
	/// @notice Allows minter to airdrop `amounts[index]` tokens of `tokenIds[index]` to `addresses[index]`
	/// @param addresses the addresses to airdrop to
	/// @param tokenIds the token ids to airdrop
	/// @param amounts the amount for each token ids to airdrop
	function airdrop(
	...
	/// @notice Allows owner to set the minter address
