...
contract KyvuNFT is ERC721URIStorage, EIP712 {
    ...
    function acceptOffer(string memory _tokenURI, uint256 _offerID) public {
        address recipientOfWETH = offerIDToOffers[_offerID].recipientOfOffer;
        require(
