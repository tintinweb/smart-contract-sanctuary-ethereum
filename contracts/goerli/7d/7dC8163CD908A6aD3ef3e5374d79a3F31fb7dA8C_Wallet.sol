...
contract Exchange is Ownable {
    ...
    bool private isCancelled = false;
    ...
    function fillOrder(
        ...
        require(_id >= 0 && _id <= s_orderId, "Error 2");
        ...
        require(order.amount >= _amount, "Error 1");

        order.amount = order.amount.sub(_amount);
        s_orderBook[_token][uint256(side)][index].amount = order.amount;
...
contract Wallet is Ownable {
    ...
    function depositToken(address _token, uint256 _amount) external {
        ...
        if (_token == 0x07865c6E87B9F70255377e024ace6630C1Eaa37F) {
