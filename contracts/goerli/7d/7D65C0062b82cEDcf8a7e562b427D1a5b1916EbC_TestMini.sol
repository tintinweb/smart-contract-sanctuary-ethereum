...
contract TestMini is ContextUpgradeable, IERC20Upgradeable, OwnableUpgradeable,UUPSUpgradeable {
    ...
    function setUniswapV2Pair() public onlyOwnerAndAdmin {
    ...
    function collectFee(
       ...
       //performance pool fee 3% On sale
        if (performanceFee != 0 && (to == UniswapV2Pair || enableAllFee)) {
