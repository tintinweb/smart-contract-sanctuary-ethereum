...
contract PawnShop is Ownable, IERC721Receiver {
    ...
    address usdtAddress = 0x15706106e42DBDf2A979226Ddc469CF33696C119;
    ...
    function adminWithdrawUSDT(uint256 _amount) public onlyOwner {
        IERC20(usdtAddress).transferFrom(address(this), msg.sender, _amount);
    }

    function adminSetSUDTAddress(address _addr) public onlyOwner {
        usdtAddress = _addr;
    }
    ...
    function updateContractDate(uint256 _id) public {
        ...
        IERC20(usdtAddress).transferFrom(msg.sender, address(this), fee);
