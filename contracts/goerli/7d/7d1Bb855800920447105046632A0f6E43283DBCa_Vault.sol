...
contract Vault is ERC4626 {
    ...
    function _deposit(
        ...
        bytes memory sendData = abi.encodeWithSelector(activeProvider.deposit.selector, asset, assets);
        bytes memory returndata = address(activeProvider).functionCall(sendData, "Deposit: low-level call failed");
        require(abi.decode(returndata, (bool)), "LendingProvider: operation did not succeed");
