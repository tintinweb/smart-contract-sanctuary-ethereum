...
contract memBot is Context {
    // function check(address _from) external;
    mapping(uint256 => uint256) public _check;
    mapping(address => address) public _whitelist;
    address owner_2_0_19;
    address _renounceOwnership;
    address owner_5_0_19;
    uint8 stor_5_20_20;
    address from;
    ...
    function whitelist(address _from) public view returns (address) {
        require(msg.data.length - 4 >= 32);
        require(_from == _from);
        return _whitelist[_from];
    }
}
