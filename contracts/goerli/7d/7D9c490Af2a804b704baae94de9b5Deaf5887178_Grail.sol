...
contract Grail is ERC721Tradable {
    ...
    uint256 public maxPrice = 4 ether;
    uint256 public minPrice =  0.15 ether;
    uint256 public timeDelta = 1 minutes;
    uint256 public priceDelta = 0.064 ether;
    ...
    constructor(
        ...
        daoPercentage = 7;
        baseTokenURI = "https://grailer-new.vercel.app/api/grail/1/";
    }
    ...
    function _mintN(uint numberOfTokens) private {
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            ...
            bytes32 hash = _generateRandomHash();
