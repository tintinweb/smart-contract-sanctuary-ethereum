...
contract BloodLife is ERC20, Ownable {
    uint256 private constant MAX_BPS = 100_00;
    uint256 _totalSupply = 900_000_000e18;
    ...
    constructor() ERC20("BloodLife", "BLIFE") {
        fee = 3_00;
        active = true;

        require(fee <= MAX_BPS, "fee can't exceed 100");

        whitelisted[msg.sender] = true;

        _mint(msg.sender, 900_000_000e18);
    }
    ...
    function updateFee(uint96 fee_) external onlyOwner {
        require(fee_ <= MAX_BPS, "fee can't exceed 100");
        fee = fee_;
    }

    function twistlist(address address_) external onlyOwner {
