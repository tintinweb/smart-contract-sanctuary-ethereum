    ...
    DefaultOperatorFilterer
{
    ...
    function ownerOf(uint256 tokenId)
        ...
        returns (address)
    {
        return interstellarSamuraiNFT.ownerOf(tokenId);
    }
    ...
    function balanceOf(address owner)
        ...
        returns (uint256)
    {
        return interstellarSamuraiNFT.balanceOf(owner);
    }
    ...
    function tokenURI(uint256 tokenId)
        ...
        returns (string memory)
    {
        return interstellarSamuraiNFT.tokenURI(tokenId);
    }

    function totalSupply() public view virtual override returns (uint256) {
        return interstellarSamuraiNFT.totalSupply();
    }
    ...
    {
        interstellarSamuraiNFT.setApprovalForAll(operator, approved);
    }
    ...
    function approve(address operator, uint256 tokenId)
        ...
        onlyAllowedOperatorApproval(operator)
    {
        interstellarSamuraiNFT.approve(operator, tokenId);
    }
    ...
    function transferFrom(
        ...
        interstellarSamuraiNFT.transferFrom(from, to, tokenId);
    }
    ...
    function safeTransferFrom(
        ...
        interstellarSamuraiNFT.safeTransferFrom(from, to, tokenId);
    }
    ...
    function safeTransferFrom(
        ...
        interstellarSamuraiNFT.safeTransferFrom(from, to, tokenId, data);
    }
