...
contract HyperMintERC721A_2_1_0 is ERC721ABurnable, Ownable {
    using SafeERC20 for IERC20;
...
contract HyperMintERC1155_2_1_0 is ERC1155Burnable, Ownable {
    using SafeERC20 for IERC20;
    ...
    function _beforeTokenTransfer(
        ...
        uint256[] memory amounts,
        bytes memory data
    ) internal override(ERC1155) transferAllowed(from, to) {
