...
contract BWBMARKETE is IERC721Receiver, IERC1155Receiver, ERC165, Ownable {
        ...
        isStart(_NFTAddress , _TokenID , _startPrice)
    {
        ...
        auction memory _auction = auction({
            ...
            _auctionId      : auctionId + 1,
            _endTime        : block.timestamp + 3 seconds, // 1667030400 (2022-10-29 17:00:00)
            _Started        : true,
            _Ended          : false
        });
