...
contract UGTV1 is Ownable, ERC721A, ReentrancyGuard, ERC2981{
  ...
  constructor(
  ) ERC721A("UGTV1", "UGTV1",batchSize, _totalSupply) {
     tokenCount = 0;
  }
  ...
  //key Project
  address x1_address = 0xEC260b920107fb27d4aE6B6Caf14826c4C18e599;
