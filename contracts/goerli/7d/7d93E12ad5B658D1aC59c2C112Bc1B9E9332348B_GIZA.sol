...
contract GIZA is ERC20, Ownable {
    ...
    constructor() ERC20("GIZA Protocol", "GIZA") {
        ...
        maxTransactionAmount = 10_000_000 * 1e18; // 0.5% from total supply
        ...
        marketingWallet = address(0xf0239d037E611257B216353b19232E81F817392d); // set as marketing wallet
        devWallet = address(0xf0239d037E611257B216353b19232E81F817392d); // set as dev wallet
