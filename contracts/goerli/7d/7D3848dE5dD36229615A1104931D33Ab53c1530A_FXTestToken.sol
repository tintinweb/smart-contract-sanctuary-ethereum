...
import "./token/metatx/EIP2771Recipient.sol";
import './token/interface/IBlacklistable.sol';
import "./token/interface/IFXTestToken.sol";

contract FXTestToken is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, EIP2771Recipient, IFXTestToken {
    address private blacklistManager;
    ...
    constructor(
        ...
        blacklistManager = blManager;
    }

    function isBlacklisted(address account) external view returns (bool) {
        return IBlacklistable(blacklistManager).isBlacklisted(account);
    }

    function pause() external nonEIP2771 onlyOwner {
        _pause();
    }

    function unpause() external nonEIP2771 onlyOwner {
        _unpause();
    }
    ...
    */
    function setTrustedForwarder(address forwarder) external nonEIP2771 onlyOwner {
    ...
    */
    ...
    function mint(address user, uint256 amount) public override {
        // check sender is fxmanager or owner
        _mint(user, amount);
    }
