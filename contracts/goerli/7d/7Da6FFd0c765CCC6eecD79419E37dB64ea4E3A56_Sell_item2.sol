...
contract Sell_item2 is ERC1155, Ownable {
    ...
    // https://gateway.pinata.cloud/ipfs/QmRV9EnTs7L99wuis2E2dLuYSDirCeu4Y6HBxLrLbVxDBc/

    constructor(string memory _baseURI) ERC1155("https://gateway.pinata.cloud/ipfs/QmRV9EnTs7L99wuis2E2dLuYSDirCeu4Y6HBxLrLbVxDBc/{id}.json")
    {
        createToken(1000, "PULLS");
        createToken(1000, "TEE SHIRTS");
        createToken(1000, "SHOES");
        baseURI = _baseURI;
    }
