...
contract Solmate is ERC721, ERC2981, DefaultOperatorFilterer, Ownable {
    ...
    constructor(
        ...
        if(_royaltyFee != 0 && _receiver != address(0)){
            setRoyaltyInfo(_receiver, _royaltyFee);
        }
    }
    ...
    function transferOwnership(address to) public onlyOwner override {
        require(owner() != to, 'OWNER_SET');
    ...
    function transferFrom(
        ...
        address to,
        uint256 id
    ) public virtual override transferActive onlyAllowedOperator(from) {
    ...
    function resetRoyaltyByTokenId(
        uint256 tokenId
    ) public onlyOwner {
