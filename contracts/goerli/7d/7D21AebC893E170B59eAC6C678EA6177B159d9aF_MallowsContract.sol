...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1677722400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1677718800;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x6a656E8De006605F5617bB4eA0Cab88fA7c332FC];
  address public erc20Payable = 0x6a656E8De006605F5617bB4eA0Cab88fA7c332FC;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibkioi57ezkvyadpbq7dvd7oszudvumzk73htr7zi4g5uygakr4o4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/XSgXU0LLLQsLkW6fDiUu/contract-metadata";
  }
...
// File: contracts/MallowsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MallowsContract is RamppERC721A {
    constructor() RamppERC721A("MALLOWS", "MALLOWS"){}
}
