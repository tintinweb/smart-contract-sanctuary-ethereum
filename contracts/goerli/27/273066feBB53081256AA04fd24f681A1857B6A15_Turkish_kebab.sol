...
contract Turkish_kebab is Ownable, ERC20 {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 100 * 10**18 * 10**18;
    ...
    constructor() ERC20("Turkish Kebab-goerli", "KEBAB-goerli") {
        IRouter _router = IRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        address _pair = IFactory(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f).createPair(address(this), _router.WETH());
        router = _router;
        uniPair = _pair;
