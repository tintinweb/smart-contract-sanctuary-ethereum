...
contract RewardDistributorfGLP is IRewardDistributor, ReentrancyGuard, Governable {
    using SafeMath for uint256;
    ...
    modifier onlyAdmin() {
        require(msg.sender == admin, "RewardDistributorfGLP: forbidden");
        _;
    }
    ...
    function setTokensPerInterval(uint256 _amount) external onlyAdmin {
        require(lastDistributionTime != 0, "RewardDistributorfGLP: invalid lastDistributionTime");
    ...
    function distribute() external override returns (uint256) {
        require(msg.sender == rewardTracker, "RewardDistributorfGLP: invalid msg.sender");
