...
contract S1155 is SoulboundERC1155, Ownable {
    using Strings for string;

    mapping(uint256 => bool) public tokenIsMintable;

    string public name = "SoulboundTickets";
    ...
    function mint(address _to, uint256 _tokenid) public payable {
        ...
        require(tokenIsMintable[_tokenid] == true, "Token not mintable");
        require(balanceOf[_to][_tokenid] == 0, "Token already minted");
        _mint(_to, _tokenid, 1, "");
    }

    function setMintableAndPrice(uint256 _tokenid, bool _mintable, uint256 _price) public onlyOwner {
        tokenIsMintable[_tokenid] = _mintable;
        price = _price;
    }
