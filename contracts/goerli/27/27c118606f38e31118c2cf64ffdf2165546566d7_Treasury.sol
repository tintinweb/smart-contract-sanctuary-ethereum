...
contract Treasury is mortal {
    ...
    function deposit(uint deposit_amount) public payable {
        ...
        require(deposit_amount >= MIN_DEPOSIT && deposit_amount <= MAX_DEPOSIT, "Invalid deposit amount");
        ...
        // require(daitoken.transfer(msg.sender, deposit_amount), "Transfer failed");
        require(daitoken.transfer(address(this), deposit_amount), "Transfer failed");
