...
/**
 * @title TocopherolGrooveless
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract TocopherolGrooveless is ERC165, ERC20Permit {
    address private _owner;

    constructor() ERC20("Tocopherol Grooveless","CEVE")  ERC20Permit("Tocopherol Grooveless") { 
        _owner = _msgSender();
     }
