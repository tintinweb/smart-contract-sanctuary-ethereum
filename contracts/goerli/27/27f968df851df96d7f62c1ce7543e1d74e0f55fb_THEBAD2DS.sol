...
- On Launch
-- Buy tax:
--- 1% Burn (tokens instantly erased from existence + total supply to increase the token price for the same market cap).
--- 4% Marketing (the earnings of the developer and the use of the same also for marketing to ensure the longevity of the project).
-- Sell tax:
--- 1% Burn (tokens instantly erased from existence + total supply to increase the token price for the same market cap).
--- 4% Marketing (the earnings of the developer and the use of the same also for marketing to ensure the longevity of the project).
-- 90 Second Sell Delay Timer for anti-whale and bot-flip function (wallets cannot sell for 90 seconds after making any transaction).
-- Can renounce individual functions if needed in future (Delay Timer, Fee Functions, Max Update Functions, Market Maker Pair Changes, Wallet Changes, Exclude and Include Functions).
-- Max wallet: 8% supply.
-- Contract will be renounced after launch.
-- 80% of of tokens will be added in LP and the remaining 20% will be burned.
-- Max transaction: 6% supply.
-- Swap token for tax: 0.005% supply.
*/
...
contract Ownable is Context {
    ...
    function updateEnableTrading() public virtual onlyOwner {
...
pragma solidity >= 0.8.9;
contract THEBAD2DS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("THEBAD2DS", "TB2DS") {
        ...
        swapTokensAtAmount = supply * 5 / 100000;
        ...
        marketingAddress = 0x3310D490A7579Fb7893a6022d6cCcEc7f116Be2E;
