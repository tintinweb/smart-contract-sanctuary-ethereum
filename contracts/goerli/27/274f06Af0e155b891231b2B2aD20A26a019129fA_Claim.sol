...
contract Claim is ERC721A, ERC2981, ReentrancyGuard, AccessControl, Ownable {
    ...
    string private _baseURIExtended = "https://wcnft.mypinata.cloud/ipfs/QmQHSMW59XRSyvcYtvuhXBw2zbr8PbxK9mM5EQP8VvHcix/";

    bool public claimActive = true;

    constructor(address doodles_, address spaceDoodles_) ERC721A("Claim", "CLAIM") {
        require(
