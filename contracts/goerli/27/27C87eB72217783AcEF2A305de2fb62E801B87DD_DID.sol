...
contract DID is ERC721Upgradeable, OwnableUpgradeable {
    // uint constant public GRACE_PERIOD = 90 days;
    uint constant public GRACE_PERIOD = 3 minutes;
    ...
    function getExpiresUUID(address uuid)
    external
    view
    returns (uint256)
    {
    ...
    function mint(address to, address uuid, uint256 expireAt)
    external
    onlyOwner
    {
        uint256 tokenId = uint256(uint160(uuid));
