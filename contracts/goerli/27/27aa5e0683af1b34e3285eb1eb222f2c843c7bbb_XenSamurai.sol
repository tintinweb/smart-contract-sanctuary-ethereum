...
contract XenSamurai is ERC721A, Ownable, ReentrancyGuard {
  ...
  ) ERC721A("XenSamurai", "XSN") {  // change the name and symbol for your collection
...
/// @dev free mint
  ...
  /// @dev use it for giveaway and team mint
     function XenMint(uint256 _mintAmount, address destination) public onlyOwner nonReentrant {
