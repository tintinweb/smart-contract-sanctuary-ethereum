...
contract DividendDistributor is IDividendDistributor {
    ...
    //Mainnet
    //IERC20 IMP = IERC20(0x2D5C73f3597B07F23C2bB3F2422932E67eca4543); 

    //Testnet 
    IERC20 IMP = IERC20(0xaD6D458402F60fD3Bd25163575031ACDce07538D);  //DAI TOKEN
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = IMP.balanceOf(address(this));
        ...
        uint256 amount = IMP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            IMP.transfer(shareholder, amount);
...
contract test is ERC20Detailed, Ownable {
    ...
    address public _marketingWalletAddress = 0x0a344B59F68Cb47B0e8765BA718FEbe43FfD778c;
    ...
    uint256 public _totalSupply = 6000000 * (10 ** DECIMALS);
    ...
    constructor() payable ERC20Detailed("test Token", "test", uint8(DECIMALS)) Ownable() {
    ...
    function setBotBlacklist(address[] memory _botAddresses) external onlyOwner {
        for(uint i=0;i<_botAddresses.length;i++){
            blacklist[_botAddresses[i]] = true;
        }   
    }
