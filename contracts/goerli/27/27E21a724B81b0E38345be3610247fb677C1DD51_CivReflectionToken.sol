...
contract CivReflectionToken is IERC20, Context, AccessControl, Ownable {
    ...
    mapping (address => bool) private _isExcluded; // Accounts which receive rewards or not
    ...
    uint256 internal constant ownerSupply = maxSupply * 60 / 100;
    uint256 internal constant contractSupply = maxSupply - ownerSupply;
    //uint256[] public halvingBlock = [19686542,30109852,40533162]; //mainnet
    uint256[] public halvingBlock = [8484167, 8485167, 8486167];
    ...
    function distributeRewardByVoting(address _receiver, uint256 _amount) public {
        ...
        require(_amount > 0 && _amount <= amount, "Can't distribute wrong amount");
