...
{    
    ...
    MintPass public MintPassSale = MintPass(
        ...
        1,          // [2] -> _DefaultMaxUserPurchaseableAmount
    ...
    function PurchaseMintPack(uint Amount, bytes32[] calldata Proof) public payable nonReentrant
    {
        ...
        require(MintPackSale._ActiveBrightList, "MPMX: Sale Not Active");
     ...
     */
    function ViewAllMPMXSaleInformation() public view returns (
        MintPass memory,
        MintPack memory,
        uint AmountRemainingMintPass,
        uint AmountRemainingMintPack,
        uint CurrentPriceMintPass,
        uint CurrentPriceMintPack
    ) {
        return(
            MintPassSale, 
            MintPackSale,
     ...
     * @dev Returns MPMX Sale Information
     */
    function ViewMPMXSaleInformation() public view returns (
        // Mint Pass Variables
        uint CurrentPriceMintPass,
        uint RemainingMintPass,
        uint SaleStartTimeMintPass,
        uint StartingPriceMintPass,
        uint EndingPriceMintPass,

        // Mint Pack Variables
        uint CurrentPriceMintPack,
        uint RemainingMintPack,
        uint SaleStartTimeMintPack,
        uint StartingPriceMintPack,
        uint EndingPriceMintPack
    ) { 
        return (
            // Mint Pass Variables
            ViewCurrentPriceMintPass(),
    ...
    function ViewWalletSaleInformation(
        ...
        uint WalletAllocationMintPass,
        uint WalletAllocationMintPack,
