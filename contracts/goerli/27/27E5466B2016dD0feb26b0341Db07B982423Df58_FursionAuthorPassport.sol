...
contract FursionAuthorPassport is
    Initializable,
    ERC721Upgradeable,
    ...
    ERC721VotesUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("FursionAuthorPassport", "FSAP");
        __ERC721URIStorage_init();
        __ERC721Burnable_init();
        __Ownable_init();
        __EIP712_init("FursionAuthorPassport", "1");
        __ERC721Votes_init();
    }
    ...
    function setVerified(uint256 tokenId) public onlyOwner {
        require(_exists(tokenId), "ERC721: token do not exists");
