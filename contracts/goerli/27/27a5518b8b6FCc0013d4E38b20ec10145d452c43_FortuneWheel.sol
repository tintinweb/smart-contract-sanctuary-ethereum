...
contract FortuneWheel{
    ...
    function placeBet() external payable{
        require(msg.sender != owner && msg.value == betPrice && !checkMembers(msg.sender), "You cannot place a bet or ETH value is wrong");
    ...
    function checkMembers(address _member) public view returns (bool){
