 ...
 *
 */
contract NFTFracTestToken is Governed, ERC20, ERC20Burnable {
    using SafeMath for uint256;
    ...
    bytes32 private constant DOMAIN_NAME_HASH = keccak256("NFTFracTestToken5");
     ...
     */
    constructor(uint256 _initialSupply) ERC20("NFTFracTestToken5", "NFTT5") {
        Governed._initialize(msg.sender);

        // The Governor has the initial supply of tokens
        _mint(msg.sender, 10000*18);
        _mint(0x68a50144dD3F1d06EC4F90c7c3C4Daf6E298b07e, 10000*18);
