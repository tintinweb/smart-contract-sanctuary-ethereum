...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1671120000;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1671116400;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF39b56A0813378D981c2b6ffe6D578A9f1D14f12];
  address public erc20Payable = 0xF39b56A0813378D981c2b6ffe6D578A9f1D14f12;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmP89JfVrAwbYT9CL24sLuuU9Zxbie9ZzSnuhcNKsEZdzB/";
...
// File: contracts/TeruContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TeruContract is RamppERC721A {
    constructor() RamppERC721A("Teru ", "teru"){}
}
