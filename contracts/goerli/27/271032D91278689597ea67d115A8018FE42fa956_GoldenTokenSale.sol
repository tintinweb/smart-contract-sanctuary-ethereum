...
contract GoldenTokenSale is Ownable, ReentrancyGuard
{
     ...
     */
    bytes32 public _RootEligibilityFullSet = 0x0217cf7137ac9bcacc86e4b7228420d6d14b0c4d403e6a41bd7708bb29758231;
    bytes32 public _RootEligibilityCitizen = 0x2e0d039308d61d7344c45c4fb5b9beb2046c4b212aad393a78a8ee30e3d9b880;

    /**
     * @dev Roots For Merkle Amounts
     */
    bytes32 public _RootAmountFullSet = 0x7e5f08a60ea79e98ef7296c36b99da7b079d4256090abf1e1914f5e5e2f9a147;
    bytes32 public _RootAmountCitizen = 0x3c0e0dd8a4d2c3466799168ead82b1419b4853165772e75adf139a7ef5d060c4;

    /**
     * @dev Token Info
     */
    uint public _AmountSold;
    uint public _CurrentTokenIndex = 204;
     ...
     * @dev Sale Timestamps
     */
    uint public _TimestampSaleStart = 1675749000;
    uint public _TimestampEndFullSet = 1675749600;
    uint public _TimestampEndCitizen = 1675750200;

    /**
     * @dev Prices
     */
    uint private constant _PricePresale = 0.25 ether;
    uint private constant _PricePublic = 0.3 ether;

    /**
     * @dev Constants
     */
    uint private constant _MaxForSale = 50;
    address private constant _GOLDEN_TOKEN = 0x00A439f6b708Be6D504eFf3EdACDC1DC37fCd5Be;
    address private constant _OPERATOR = 0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937;
     ...
     */
    function __NewRoots(bytes32 FullsetRoot, bytes32 CitizenRoot, bytes32 CitizenAmount, bytes32 FullsetAmount) external onlyOwner 
    {
    ...
    /**
     * @dev Verifies Amount Being Passed Is Valid
     */
