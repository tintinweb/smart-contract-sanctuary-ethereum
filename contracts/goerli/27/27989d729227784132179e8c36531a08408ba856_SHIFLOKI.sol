...
contract BTCDividend is IDividendDistributor {     // FLOKI REWARD DIVIDEND
    ...
    IERC20 RewardToken = IERC20(0xf064c0A72A23e0F9C8bEB186431ec47a191C16Bc); 
...
contract ETHDividend is IDividendDistributor {     //SHIBA INU REWARD DIVIDEND
    ...
    IERC20 RewardToken = IERC20(0x6B9Ae4D64feBB297C5BF12b4667616b751d05b77); 
...
contract SHIFLOKI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private _name = "Shifloki";
    string private _symbol = "SHIFLOKI";
    uint8 private _decimals = 18;

    uint256 public buyMarketingFee = 230;
    uint256 public buyFlokiFee = 10;
    uint256 public buyShibaFee = 10;

    uint256 public sellMarketingFee = 230;
    uint256 public sellFlokiFee = 10;
    ...
    address public _marketingWalletAddress = 0xcAA9e8Aef56acab66aC6F17C6FfD4A247076edd7;
    ...
    constructor() {
        ...
        totalBuy = buyMarketingFee.add(buyFlokiFee).add(buyShibaFee);
        totalSell = sellMarketingFee.add(sellFlokiFee).add(sellShibaFee);
    ...
    function swapBack() internal swapping {
        ...
        uint _btcshares = buyFlokiFee.add(sellFlokiFee);
        // uint _ethshares = buyShibaFee.add(sellShibaFee);
    ...
    function getFlokiRewardInfo(address _receiver) external view returns (uint) {
        return btcdividend.getUnpaidEarning(_receiver);
    }
    ...
    function FlokiRescueToken(address tokenAddress,address _receiver, uint256 tokens) external onlyRewardController {
        btcdividend.rescueToken(tokenAddress,_receiver,tokens);
    }

    function FlokiRescueFunds(address _receiver) external onlyRewardController {
