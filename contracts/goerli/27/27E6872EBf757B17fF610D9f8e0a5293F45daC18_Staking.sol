    ...
    ReentrancyGuardUpgradeable
{
    ...
    function harvestRewardTokens(
        ...
        uint256 _amountWithBonus = _amountToRestake +
            ((_amountToRestake * harvestingBonusPercentage) / NUMERATOR);
