...
import '@layerzerolabs/solidity-examples/contracts/contracts-upgradable/token/ONFT721/ONFT721CoreUpgradeable.sol';
import '@layerzerolabs/solidity-examples/contracts/contracts-upgradable/token/ONFT721/IONFT721Upgradeable.sol';
  ...
  ERC721BurnableUpgradeable
{
  ...
  function __ONFT721Upgradeable_init(
    ...
    __ONFT721Upgradeable_init_unchained(name, symbol, lzEndpoint, startTokenId, endTokenId);
  }
  ...
  function __ONFT721Upgradeable_init_unchained(
    ...
    __ONFT721CoreUpgradeable_init_unchained(lzEndpoint);
  }
  ...
  function supportsInterface(
    ...
    view
    virtual
    override(ONFT721CoreUpgradeable, ERC721EnumerableUpgradeable, ERC721Upgradeable)
    returns (bool)
  {
    return
...
import './omnichain/OmniERC721Upgradeable.sol';

contract OmniCoolERC721 is
  ...
  ErrorsAndEvents
{
  ...
  event MintLimitsChanged(uint256 tokenIdStart, uint256 tokenIdEnd);

  error InvalidMintLimits(uint256 tokenIdStart, uint256 tokenIdEnd);
  ...
  function initialize(
    ...
    __ONFT721Upgradeable_init(name, symbol, lzEndpoint, startTokenId, endTokenId);
  ...
  function mint(address to, uint256 amount) external virtual onlyMinter {
    ...
    unchecked {
      if (nextTokenId + amount > _endTokenId) {
        revert MaxLimitReached(_endTokenId - _startTokenId);
      }
  ...
  /// @notice Set the mint limits
  /// @param startTokenId The start token id
  /// @param endTokenId The end token id
  function setMintLimits(uint256 startTokenId, uint256 endTokenId) external virtual onlyManager {
    if (endTokenId < startTokenId) {
      revert InvalidMintLimits(startTokenId, endTokenId);
    }

    _startTokenId = startTokenId;
    _endTokenId = endTokenId;

    emit MintLimitsChanged(startTokenId, endTokenId);
  }
  ...
  function transferFrom(
    ...
    address to,
    uint256 tokenId
  ) public virtual override(ERC721Upgradeable, IERC721Upgradeable) onlyAllowedOperator(from) {
  ...
  function supportsInterface(
    bytes4 interfaceId
  ) public view virtual override(AccessControlUpgradeable, OmniERC721Upgradeable) returns (bool) {
    return
      OmniERC721Upgradeable.supportsInterface(interfaceId) ||
