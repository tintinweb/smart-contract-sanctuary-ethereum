...
// File: contracts/hardERC721Token.sol
...
contract HardHazelERC721 is ERC721 {
    ...
    */
    ...
    event RefundChange(address _from, uint256 _tokenId, uint256 balance);
    // emit RefundChange(_to, _tokenId, balance);
    ...
    function refund(uint256 _tokenId) external {
        ...
        // TODO: event 紀錄退款
        emit RefundChange(msg.sender, _tokenId, mintPrice);
    }
