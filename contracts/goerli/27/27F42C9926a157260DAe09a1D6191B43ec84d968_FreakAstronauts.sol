...
contract FreakAstronauts is Ownable, ERC721A {
    using Strings for uint256;

    uint256 public PUBLIC_PRICE = 0.0015 ether;
    ...
    constructor() ERC721A("FreakAstronauts", "FRKAST") {}

    function publicMint(uint256 quantity) external payable {
        require(isSaleActive, "Mint has not started yet");
        require(quantity <= MAX_PER_TX, "Limit per transaction exceeded");
