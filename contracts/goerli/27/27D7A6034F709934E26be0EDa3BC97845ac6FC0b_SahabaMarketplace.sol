    ...
    ReentrancyGuard
{
    ...
    function calcItemPrice(
        ...
        uint256 _price = price - platformFees;
        ...
        returns (uint256)
    {
        ...
        if (_service_fees > 0) {
            platformFees = (price) * _service_fees;
        ...
        returns (uint256)
    {
        ...
        uint256 platformFees = calcItemPlatformFee(newItemId, _price);
        uint256 price = calcItemPrice(newItemId, _price, platformFees);
        ...
        MarketItem memory newItem = MarketItem(
            ...
            price, // price after remove service fee
            platformFees, // calculated platform service fees
