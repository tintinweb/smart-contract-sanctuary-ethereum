...
import "./sellItMarketPlace.sol";


contract sellItMarketPlaceV2 is sellItMarketPlace{
 
    function initialize(address _marketplaceOwner,uint256 _setServiceFee) public override virtual initializer {
...
//    }
    ...
    function initialize(address _marketplaceOwner,uint256 _setServiceFee)  virtual public initializer {
