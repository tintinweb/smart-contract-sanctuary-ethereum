...
contract gELASTIC is IgELASTIC, ERC20, ElasticDollarAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        ...
        ERC20("Governance ELASTIC", "gELASTIC", 18)
        ElasticDollarAccessControlled(IElasticDollarAuthority(_authority))
    {
        require(_sELASTIC != address(0), "Zero address: sELASTIC");
        sELASTIC = IsELASTIC(_sELASTIC);
    }

    /* ========== MUTATIVE FUNCTIONS ========== */

    /**
     * @notice transfer mint rights
     * @notice can only be done once, at the time of contract migration
     * @param _staking address
     * @param _sELASTIC address
     */
    function setStaking(address _staking, address _sELASTIC)
        external
        override
        onlyPolicy
    {
        ...
        require(_sELASTIC != address(0), "Zero address found");
        sELASTIC = IsELASTIC(_sELASTIC);
    }
    ...
    /**
     * @notice pull index from sELASTIC token
     */
    function index() public view override returns (uint256) {
        return sELASTIC.index();
    }

    /**
        @notice converts gELASTIC amount to ELASTIC
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts ELASTIC amount to gELASTIC
        @param _amount uint
        @return uint
     */
        ...
        returns (uint256)
    {
        require(
            ...
            "gELASTIC::getPriorVotes: not yet determined"
        );
