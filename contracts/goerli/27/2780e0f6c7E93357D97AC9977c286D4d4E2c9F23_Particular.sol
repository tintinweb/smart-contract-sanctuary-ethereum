...
contract Particular is Initializable {
    ...
    IChainlink public constant chainlink = IChainlink(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e);
    ...
    */
    receive() external payable {
        ...
        TransferHelper.safeApprove(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2, address(swapRouter), toStable);
        ...
        uint256 totalConverted = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48).balanceOf(address(this));
