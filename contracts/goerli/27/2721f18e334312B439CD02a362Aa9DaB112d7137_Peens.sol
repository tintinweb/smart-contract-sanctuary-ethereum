...
contract Peens is ERC721A, Ownable, ERC2981 {
    ...
    mapping(address => uint256[]) public pahse1Burners;
    mapping(address => uint256[]) public pahse2Burners;
    mapping(address => uint256[]) public pahse3Burners;
    mapping(address => uint256[]) public pahse4Burners;
    ...
    function chadMint(uint256 qty) external payable {
        ...
        uint balance = IERC721(0xd9145CCE52D386f254917e481eB44e9943F39138).balanceOf(msg.sender);
    ...
    function phaseOne(uint[] calldata tokens) public burnCompliance(tokens) {
        for (uint i=0; i < tokens.length; i++) {
            ...
            pahse1Burners[msg.sender].push(tokens[i]);
            _burn(tokens[i], true);
        }
    ...
    */
    ...
    function getPerWalletMax() public view returns(uint256) {
        return maxPerWallet;
    }
    ...
    function getPerTransactionMax() public view returns(uint256) {
