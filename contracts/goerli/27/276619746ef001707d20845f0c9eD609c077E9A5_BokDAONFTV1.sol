...
contract BokDAONFTV1 is ERC721, ERC721URIStorage {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://storage.googleapis.com/bok-dao/version1/metadata.json";
    }
    ...
    function changeAttributes(uint256 tokenId, string memory newTokenURI)
        public
    {
        require(
