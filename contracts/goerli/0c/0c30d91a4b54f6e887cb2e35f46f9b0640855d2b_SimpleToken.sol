...
contract SimpleToken is ERC20Interface, OwnerHelper {
    ...
    function reLock(address _who) public onlyOwner returns(string memory) {
        if(_personalTokenLock[_who] == false) {
    ...
    function checkLock(address _who) public view onlyOwner returns(bool) {
