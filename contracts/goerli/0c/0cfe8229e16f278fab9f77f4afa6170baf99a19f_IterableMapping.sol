...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, Ownable {
  ...
  constructor(string memory _name, string memory _symbol)  ERC20(_name, _symbol) {
      IRouter _router = IRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
      router = _router;
      rewardToken = 0xb7e94Cce902E34e618A23Cb82432B95d03096146;
  }
...
contract Ar is ERC20, Ownable {
    ...
    ArbogeDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x4383Cd813B15824368C79423074B11b20150Bb50;
    address public devWallet = 0x4383Cd813B15824368C79423074B11b20150Bb50;
    ...
    Taxes public buyTaxes = Taxes(1, 2, 0, 0);
    Taxes public sellTaxes = Taxes(8, 2, 0, 0);
    ...
    constructor() ERC20("Arbo", "Arbo") {
        dividendTracker = new ArbogeDividendTracker();
//0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D. //0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ArbogeDividendTracker newDividendTracker = ArbogeDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "iStable: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "iStable: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "iStable: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "iStable: Cannot update gasForProcessing to same value"
        );
...
contract ArbogeDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("iStable_Dividen_Tracker", "iStable_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "iStable_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "iStable_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "iStable_Dividend_Tracker: Cannot update claimWait to same value"
        );
