...
contract Advertise is ERC721, ReentrancyGuard, Ownable {
	...
	function tokenURI(uint256 tokenId) public view override returns (string memory) {
		...
		string memory name = string(abi.encodePacked("Receipt #", Strings.toString(tokenId)));
		string memory description = "Thank you for your participation.";
		...
		return
			string(
				abi.encodePacked(
					...
					font.base64(),
					'")format("woff2")};</style><rect width="1080" height="1080" fill="var(--sub)"/><clipPath id="m"><rect width="1080" height="1080"/></clipPath><g clip-path="url(#m)"><text x="35" y="60" font-size="36px" letter-spacing="-0.01em">ADVERTISE</text><text x="1046" y="60" text-anchor="end">RECEIPT #',
					plusZero(tokenId),
