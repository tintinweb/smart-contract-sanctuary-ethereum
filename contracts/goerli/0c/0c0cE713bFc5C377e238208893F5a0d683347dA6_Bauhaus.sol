...
contract Bauhaus is ERC721A, IERC2981, ERC721AQueryable, ERC721ABurnable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("Bauhaus", "BAU") {
        PRICE = price;
