...
contract LiquidDelegate is ERC721, ERC2981, INFTFlashLender {
    ...
    function create(address contract_, uint256 tokenId, uint256 expiration, address payable referrer) external payable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory attributes = string.concat(
            ...
            '}, {"trait_type": "Expiration", "display_type": "date", "value": ', rights.expiration.toString(),
