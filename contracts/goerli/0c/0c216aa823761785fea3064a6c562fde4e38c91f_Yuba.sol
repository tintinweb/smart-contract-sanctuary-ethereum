...
contract Yuba{
    ...
    uint256 public constant _maxxSupply = 10000 * (10 ** uint256(decimals));
    ...
    function mintToken(address _target) public{
        require(msg.sender==owner, "Only Admin is allowed for this action.");
        require(totalSupply()<_maxxSupply,"Minting Limit Exceed.");
