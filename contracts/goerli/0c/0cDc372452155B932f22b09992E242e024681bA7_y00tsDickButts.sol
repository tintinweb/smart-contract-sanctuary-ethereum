    ...
    Ownable
{
    ...
    {
        uint256 reservePublicSupply = MAX_PUBLIC_SUPPLY;

        require((reservePublicSupply < numberOfTokens), "No more public Supply Available ");
        
        MAX_PUBLIC_SUPPLY = reservePublicSupply - numberOfTokens;
