    ...
    ERC1155Holder
{
    ...
    function _addOffer(
        ...
        bool resalAllowed = ILoyalty(newOffer._collection).isResaleAllowed(newOffer._collection, newOffer._assetId);
        require(resalAllowed, "Marketplace: Resale not allowed");
        require(
