 ...
 * @title TGE contract
 */
contract thegreatextinction is Ownable, ERC721 {

    uint256 public tokenPrice = 20000000000000000; //0.02 ETH
    
    uint256 public constant maxTGEPurchase = 5;
    ...
    function reserveTGE(uint8 numberOfTokens) public onlyOwner {
        uint256 supply = totalSupply();
        require(numberOfTokens <= maxTGEPurchase, "e2");
        require((supply + numberOfTokens) <= MAX_TGE, "e3");
    ...
    function mintTGE(uint8 numberOfTokens) public payable {
        uint256 supply = totalSupply();
        require(numberOfTokens <= maxTGEPurchase, "e2");
        require((supply + numberOfTokens) <= MAX_TGE, "e3");
        require(saleIsActive, "e4");
