 ...
 */
contract DeVontaSmithTradingCard is EndstatePreMintedNFT
{
    address devontaSmithTradingWalletAddress;
   ...
   constructor(
        ...
        EndstatePreMintedNFT(
            ...
            devontaSmithTradingWalletAddress
        )
    {
        devontaSmithTradingWalletAddress = wallet;
    }
    ...
    function claimTo(
        ...
        safeTransferFrom(devontaSmithTradingWalletAddress, _userWallet, _tokenId);
    }
}
