...
contract UnordinalButts is ERC721A, DefaultOperatorFilterer, Ownable {

    string public baseURI="ipfs://bafybeidalh7fbv4t65wd24ujdatxgwar22y3ogw7ntqdod5izjgpst4cva/";
    ...
    constructor () ERC721A("UnordinalButts", "UBT") {
        paused = true;
    }
    ...
    modifier compliant(uint256 amount) {
        require(msg.value >= (amount - freePerTx) * mintPrice);
        _;
    }
    ...
    function setFreePerTx(uint256 _freePerTx) public onlyOwner {
        freePerTx = _freePerTx;
    }
