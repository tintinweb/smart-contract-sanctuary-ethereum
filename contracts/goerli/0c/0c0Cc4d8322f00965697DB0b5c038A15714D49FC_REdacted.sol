...
contract REdacted is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  modifier mintPriceCompliance(uint256 _mintPrice) {
    require(msg.value >= _mintPrice, "Insufficient funds!");
    _;
  }

  function ogMint(bytes32[] calldata _ogMerkleRoot) public payable mintCompliance mintPriceCompliance(ogMintPrice) {
  ...
  function whitelistMint(bytes32[] calldata _whitelistMerkleRoot) public payable mintCompliance mintPriceCompliance(whitelistMintPrice) {
  ...
  function waitlistMint(bytes32[] calldata _waitlistMerkleRoot) public payable mintCompliance mintPriceCompliance(waitlistMintPrice) {
  ...
  function publicMint() public payable mintCompliance mintPriceCompliance(publicMintPrice) {
  ...
  function reservedMint() public onlyOwner() mintCompliance {
