    ...
    ERC721Pausable
{
    /**
     * @dev
     * CountersライブラリのCounterという型（構造体）に、Countersライブラリの全関数をアタッチ（使えるように）している
     */
    ...
    constructor() ERC721("EtherScanTest", "EST") {}
     ...
     * - mintの際にURIを設定 _setTokenURI() (mint後にmetadataやtokenURIの変更不可)
     * - EVENT発火 emit TokenURIChanged
     */
    function nftMint() public onlyOwner whenNotPaused {
        _tokenIds.increment(); //value=1となる、詳細はCounters.sol参照
    ...
    function _baseURI() internal pure override returns (string memory) {
        return
            "ipfs://bafybeieueihzcxsfqrzb52kkugvdbtzmtei7c2z5jt4d72mfeienkzcuoq/";
    }
    ...
    /**
     * @dev
     * - 複数継承による同名メソッド存在エラーへの対応としてのoverride
     */
