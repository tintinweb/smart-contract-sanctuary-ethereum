...
contract ERC20Factory is Ownable {
    ...
    function deploy(
        ...
        ERC20Contract _contract = new ERC20Contract(_name, _symbol, _payees, _shares, msg.sender, _maxSupply, _initialSupply);
...
contract ERC20Contract is ERC20, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        require(_initialSupply <= maxSupply, "Insufficient supply");
