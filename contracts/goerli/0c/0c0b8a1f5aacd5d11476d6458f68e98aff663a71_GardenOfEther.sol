...
// thinkl about the image mapping [][] which braket is which
...
contract GardenOfEther is Ownable, ERC721A, ReentrancyGuard {
    ...
    mapping(uint8 => mapping(uint8 => string)) private _animationUrlMapper;

    //ajusts reserve for the metadata
    mapping(uint8 => uint256) private _reserveAdjuster;

    //status tracker(s) for URLS
    mapping(uint8 => string) private glowingOrDarkName;
    mapping(uint8 => string) private _uintToType;
    mapping(string => uint8) private glowingOrDarkToUint;
    mapping(string => uint8) private typeToUint;
    ...
    constructor() ERC721A("Garden Of Ether", "GOE") {
        ...
        _unstakeImageMapper[0][2] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // _shardGlowingDepleted
        _unstakeImageMapper[0][3] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // _shardDarkDepleted
        _unstakeImageMapper[1][2] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // _splinterGlowingDepleted
        _unstakeImageMapper[1][3] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // _splinterDarkDepleted
        _animationUrlMapper[0][
            0
        ] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // needs to change
        _animationUrlMapper[1][
            0
        ] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // needs to change
        _animationUrlMapper[0][
            1
        ...
        _animationUrlMapper[0][2] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // needs to change
        _animationUrlMapper[0][3] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // needs to change
        _animationUrlMapper[1][2] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // needs to change
        _animationUrlMapper[1][3] = "https://gateway.pinata.cloud/ipfs/QmWWzPT1j67UcVE16pwPSY4JsjcSpebAggPh9q6JDcMXJN"; // needs to change
    }
    ...
    function setforAllURL(
        ...
        _unstakeImageMapper[0][0] = _shardGlowing;
        _unstakeImageMapper[0][1] = _shardDark;
        _unstakeImageMapper[1][0] = _splinterGlowing;
        _unstakeImageMapper[1][1] = _splinterDark;
        _unstakeImageMapper[0][2] = _shardGlowingDepleted;
        _unstakeImageMapper[0][3] = _shardDarkDepleted;
        _unstakeImageMapper[1][2] = _splinterGlowingDepleted;
        _unstakeImageMapper[1][3] = _splinterDarkDepleted;
    }
    ...
    function emergencyAdjustImageMetadata(uint256 _tokenId, uint8 state)
        external
        onlyOwner
    {
        if (isFrozen) revert FrozenForever();
        mapToToken[_tokenId].image = _unstakeImageMapper[mapToToken[_tokenId].tokenType][state];
        mapToToken[_tokenId].state = state;
    }
    ...
    function changeState(uint256 _tokenId, uint8 _glowOrDark) external {
        ...
        mapToToken[_tokenId].image = _unstakeImageMapper[mapToToken[_tokenId].tokenType][_glowOrDark];
        mapToToken[_tokenId].state = _glowOrDark;
    }
    function testSetTokenTimestamp(uint256 tokenId, uint48 _time) external onlyOwner{
        tokenTimestamp[tokenId] = _time;
    }

    function testManipulateReserveOfTokenBySub(
        uint256 tokenId,
        uint256 reserveToBeDecreasedBy
    ) external onlyOwner{
        manipulateReserveOfTokenBySub(
         tokenId,
         reserveToBeDecreasedBy
    );
    }
    ...
    function initiateDepletion(uint256 _tokenId) internal {
        ...
        if (mapToToken[_tokenId].massReserve == 0) {
            ...
            if(tokenState == 0){
                mapToToken[_tokenId].image = _unstakeImageMapper[tokenType][2];
                mapToToken[_tokenId].state = 2;

            }else{
                 mapToToken[_tokenId].image = _unstakeImageMapper[tokenType][3];
                mapToToken[_tokenId].state = 3;
    ...
    function readAnimationVideoForToken(uint256 _tokenId)
        ...
        returns (string memory)
    {
        return _animationUrlMapper[mapToToken[_tokenId].tokenType][mapToToken[_tokenId].state];
    }
        ...
        returns (string memory)
    {
        ...
        bytes memory dataURI = abi.encodePacked(
            ...
            ","
            '"animation_url": "',
            _animationUrlMapper[mapToToken[tokenId].tokenType][mapToToken[tokenId].state],
            '"'
            ","
            '"attributes":',
            "["
    ...
    function callZkSync(
        ...
        txHash = zksync.requestL2Transaction{value: msg.value}(
            ...
            abi.encodeWithSignature(
                "receiveData(address, uint256, uint256)",
                _user,
                _glowingAmount,
                _darkAmount
            ),
    ...
    function stake(uint256[] calldata tokenIds) external {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            require(mapToToken[tokenId].massReserve != 0, "Can not Stake Depleted!");
        ...
        internal
    {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            if(mapToToken[tokenId].massReserve != 0){
            mapToToken[tokenId].image = _unstakeImageMapper[mapToToken[tokenId].tokenType][mapToToken[tokenId].state];
            }
        }
        totalStaked -= tokenIds.length;
        _staked[msg.sender] -= tokenIds.length;
    ...
    function _claim(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            if (mapToToken[tokenId].tokenType == 1) {
                massDepletion =
                    (0.5 * 1 ether * (block.timestamp - stakedAt)) /
                    1 days /
                    2;
            } else {
                massDepletion = (1 *1 ether * (block.timestamp - stakedAt)) / 1 days;
            }
            
            if (mapToToken[tokenId].state == 0) {
                glowingAmount += 200 * manipulateReserveOfTokenBySub(tokenId, massDepletion);
            } else {
                darkAmount += 200 * manipulateReserveOfTokenBySub(tokenId, massDepletion);
            }
            }
            tokenTimestamp[tokenId] = uint48(block.timestamp);
        }
        ...
        emit Claimed(account, glowingAmount + darkAmount);
    }
    ...
    function getExtract(uint256 tokenId) public view returns (string memory) {
        if(mapToToken[tokenId].massReserve <= displayReserveToBeDepleted(tokenId)){
