...
contract ERC721BurnableFactory is Initializable {
    ...
    function createERC721Burnable(
        ...
        address proxy = Create2Upgradeable.deploy(0, salt_, bytecode);

        ERC721Burnable(proxy).transferOwnership(contractOwner_);
