...
contract Bearz is Ownable, ERC2981, ERC721A {
    ...
    uint256 public allowlistMintPrice = 0.002 ether;
    uint256 public whitelistMintPrice = 0.003 ether;
    uint256 public publicMintPrice = 0.004 ether;

    uint96 public mintLimitPerTx = 3;
    uint96 public mintLimitPerWallet = 5;
