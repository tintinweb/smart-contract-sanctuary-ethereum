    ...
    Multicall
{
    ...
    function transfer20(
        ...
        super.transfer20WithSign(registry, from, to, value, platformFee, nonce, deadline, metadata, signatures);
    ...
    function transfer721(
        ...
        super.transfer721WithSign(assetIdentifierData, to, feeData, nonce, deadline, metadata, signature);
...
abstract contract Permit20 is OwnableUpgradeable, EIP712WithNonce {
    ...
    function getPermit20TypeHash() private pure returns (bytes32) {
        return
            keccak256(
                "Permit20(address registry,address from,address to,uint256 value,uint256 platformFee,uint256 nonce,uint256 deadline,uint32 metadata)"
            );
    }
    ...
    function transfer20WithSign(
        ...
        bytes32 structHash = keccak256(
            abi.encode(getPermit20TypeHash(), registry, from, to, value, platformFee, nonce, deadline, metadata)
        );
...
abstract contract Permit721 is OwnableUpgradeable, EIP712WithNonce {
    function getPermit721TypeHash() private pure returns (bytes32) {
        return
            keccak256(
                "Permit721(address registry,uint256 tokenId,address to,address receiverFeeAddr,address ownVaultApprovalFeeAddr,uint256 ownVaultApprovalFee,uint256 platformFee,uint256 ownerFee,uint256 nonce,uint256 deadline,uint32 metadata)"
            );
    }
    ...
    function transfer721WithSign(
        ...
        EIP712WithNonce._verifyAndConsumeNonce(from, nonce);
        bytes32 structHash = keccak256(
            abi.encode(getPermit721TypeHash(), assetIdentifierData, to, feeData, nonce, deadline, metadata)
        );
        bytes32 hash = _hashTypedDataV4(structHash);
        require(
...
abstract contract Permit1155 is OwnableUpgradeable, EIP712WithNonce {
    function getPermit1155TypeHash() private pure returns (bytes32) {
        return
            keccak256(
                "Permit1155(address registry,uint256 tokenId,address from,address to,uint256 value,address receiverFeeAddr,address ownVaultApprovalFeeAddr,uint256 ownVaultApprovalFee,uint256 platformFee,uint256 ownerFee,uint256 nonce,uint256 deadline,uint32 metadata,bytes data)"
            );
    }
