...
contract CrazzyDevelopers is ERC721A, Ownable, ReentrancyGuard {  
  ...
  uint256 public prsaleMintprice = 0 ether; //here you change phase 1 cost (for example first 1k for free, then 0.004 eth each nft)

  uint256 public publicMintprice = 0.004 ether; //here you change phase 2 cost
  ...
  bool public publicMintStarted  = true;
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("CarzzyDeveloper", "CD")  { //change this line to your full and short NFT name
