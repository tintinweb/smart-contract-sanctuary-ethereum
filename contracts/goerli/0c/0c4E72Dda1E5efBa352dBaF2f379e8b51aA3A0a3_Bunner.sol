...
// desmo added from here
import "@openzeppelin/contracts/token/ERC1155/ERC1155.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/utils/Strings.sol";
// desmo added to here

contract Bunner is ERC1155, Ownable {
    uint256 public constant BCbanner = 0;
    ...
    constructor(string memory _name, string memory _symbol, string memory uri_)
     ERC1155(uri_) {
        ...
        // initial mint to msg.sender
        _mint(msg.sender, BCbanner, 10**5, "");
    }

    // set newURI
    function setMetadataURI(string memory newuri) public {
        MetadataURI = newuri;
    }
