...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    constructor(
        ...
        _ethUsdPricefeed = AggregatorV3Interface(ethUsdPricefeedAddress);
    }
    ...
    function getEntranceFeeInEth() public view returns (uint256) {
        ...
        uint256 convertedEntranceFee = uint256(i_entranceFee * 10**36) / adjustedPrice;
        return convertedEntranceFee;
    }
