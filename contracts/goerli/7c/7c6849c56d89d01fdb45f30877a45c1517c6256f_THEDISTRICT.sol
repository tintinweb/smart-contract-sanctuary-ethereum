...
contract THEDISTRICT is ERC20, Ownable {
    ...
    constructor() ERC20("The District", "D82") {
        ...
        swapTokensAtAmount = totalSupply * 15 / 10000; // 1.05% swap tokens amount
    	...
    	operationsWallet = address(0x1c7eE09BeD6ED00e22d846757d190431D090f09c); // set as operations wallet
        developmentWallet = address(0x2B3161796Ee272fcf4EcE24e373F83147aDFfa0A);
