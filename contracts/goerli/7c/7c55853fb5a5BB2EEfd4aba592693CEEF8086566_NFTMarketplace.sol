...
contract NFTMarketplace is Initializable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _WETH, uint256 _feePercentage, address _feeAddress) initializer public {
        // __Pausable_init();
        __Ownable_init();
