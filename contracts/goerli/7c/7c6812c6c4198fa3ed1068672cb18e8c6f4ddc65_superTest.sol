 ...
 * {ERC721Enumerable}.
 */
contract ERC721FancyMint is Context, ERC165, IERC721, IERC721Metadata {
...
contract superTest is ERC721FancyMintEnum, Ownable {
    using Strings for uint256;

    //
    address private preOwner_ = 0x42D184ccD43e84368ea95902847D137f5C49704C;
    uint256 private maxSupply_ = 10000;

    constructor()
        ERC721FancyMintEnum("Ape Hoes", "AH", maxSupply_, preOwner_)
    {}
