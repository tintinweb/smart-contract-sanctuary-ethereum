...
contract Artificial_IntelV1 is ERC20, Ownable {
    ...
    constructor(
        ...
        require(_fees[0]+(_fees[2])<=70, "sell fee <= 7%");
        require(_fees[1]+(_fees[3])<=70, "buy fee <= 7%");
    ...
    function updateLiquidityFee(
        ...
        require(_sellLiquidityFee + (sellMarketingFee) <= 70, "sell fee <= 7%");
        require(_buyLiquidityFee + (buyMarketingFee) <= 70, "buy fee <= 7%");
