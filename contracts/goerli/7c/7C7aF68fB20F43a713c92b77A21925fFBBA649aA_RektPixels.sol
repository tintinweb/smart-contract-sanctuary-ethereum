...
contract RektPixels is ERC721A, Ownable {
    ...
    constructor() ERC721A("REKTPIXEL", "REKTPXL") {
        ...
        metadataBaseURL = "ipfs://QmXt5TvxYTJ4rATpgvnpu51kW2RCHCchLafyaTMWpmEjHX/";
    }
    ...
    function setMaxMints(uint256 _maxTxn) external onlyOwner {
        maxMints = _maxTxn;
    }

    function setMaxFreeMints(uint256 _maxTxnFree) external onlyOwner {
        maxFreeMints = _maxTxnFree;
    }
    ...
    function mint(uint256 numOfTokens) external payable {
        ...
        require(numOfTokens <= maxMints, "Exceed mints per transaction");
        require(
    ...
    function freeMint(uint256 numOfTokens) external payable {
        ...
        require(numOfTokens <= maxFreeMints, "Exceed MAX Free Mints per transaction");
        require(
