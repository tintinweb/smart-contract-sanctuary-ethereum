...
contract Vault is Pausable,ReentrancyGuard, Ownable{
    ...
    function earnedInfo(uint16 tokenid) public  view  returns(uint256 reward){
        usersDetails memory details = Details[tokenid];
...
// forge verify-contract --chain-id 5 --num-of-optimizations 1000000 --watch  0xEFE28A13b0b2cC47f9c558eAcD2834D35b29b2ed src/Vault.sol:Vault Z8P4W843RDB83JD848SWFRI6JVVXGVM9KT
