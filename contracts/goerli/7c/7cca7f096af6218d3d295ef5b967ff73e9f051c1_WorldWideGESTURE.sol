...
contract WorldWideGESTURE is ERC721, Ownable {
    ...
    function mint(uint256 mintAmount) public payable{
        require(mintAmount > 0, "I'm sorry only three NFT per user");
        require(mintAmount <= userLimit, "I'm sorry only three NFT per user");
        require(msg.value >= 0.0088 ether);
