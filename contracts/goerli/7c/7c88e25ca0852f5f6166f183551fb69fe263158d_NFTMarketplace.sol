    ...
    EIP712
{
    ...
    function buyItem(
        ...
        uint256 royaltyFee = (price * creatorEarnings) / 100;
        uint256 profits = price - platformFee - royaltyFee;
        ...
        payRoyalties(payoutAddress, royaltyFee, tokenId, price, msg.sender);
    ...
    function payRoyalties(
        ...
        proceeds[payoutAddress] += royaltyFee;

        if (royaltyFee > 0) {
            sendViaCall(payoutAddress, royaltyFee);
            royalties[payoutAddress].push(
                Royalty(block.timestamp, royaltyFee, price, tokenId, buyer)
            );
        }
    }
    ...
    function redeem(
        ...
        payRoyalties(payoutAddress, royaltyFee, voucher.tokenId, price, msg.sender);
