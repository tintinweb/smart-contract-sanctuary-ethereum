...
contract UniswapV3Flash {
    ...
    IUniswapV3Factory private poolFactory = IUniswapV3Factory(FACTORY);
    ...
    constructor(
        ...
        pool = IUniswapV3Pool(getPool2(_token0, _token1, _fee));
    }
    ...
    function getPool2(
        ...
        return poolFactory.getPool(_token0, _token1, fee);
    }
    ...
    function flash(uint amount0, uint amount1) external {
        ...
        console.log("pool address is ", address(pool), "begin flash");
    ...
    function uniswapV3FlashCallback(
        ...
        // Repay borrow
        console.log("begin repay borrow");
        if (fee0 > 0) {
            console.log(2);
