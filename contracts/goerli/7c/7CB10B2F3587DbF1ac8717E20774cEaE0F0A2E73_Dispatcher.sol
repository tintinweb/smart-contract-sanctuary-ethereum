    ...
    IDispatcher
{
    ...
    function createTGEProposal(
        ...
        validateTGEInfo(info, address(pool.token()));
    ...
    function createGovernanceSettingsProposal(
        ...
        proposalId = pool.proposeSingleAction(
            ...
            description,
            ProposalType.GovernanceSettings,
            metaHash
        );
        pool.setLastProposalIdForAccount(msg.sender, proposalId);
    }
    ...
    function validateTGEInfo(ITGE.TGEInfo calldata info, address token_) public view returns (bool) {
