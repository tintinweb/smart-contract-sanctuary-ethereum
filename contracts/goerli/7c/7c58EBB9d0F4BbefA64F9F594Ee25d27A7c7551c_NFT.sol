...
contract NFT is ERC721, ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    constructor(address _usdt) ERC721("ProfitOnWeed", "NFT") {
        usdt = IERC20(_usdt);
    }
    ...
    function mintNFT(address recipient, string memory uri, string memory _category) public returns (uint256) {
        ...
        usdt.safeTransferFrom(msg.sender, address(this), prices[_category]);
        currentTokenId.increment();
        _safeMint(recipient, tokenId);
        _setTokenURI(tokenId, uri);
        return tokenId;
    ...
    function withdrawPayments(address recipient) public onlyOwner virtual {
