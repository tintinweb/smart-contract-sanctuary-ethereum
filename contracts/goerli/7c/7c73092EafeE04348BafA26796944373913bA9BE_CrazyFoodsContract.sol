...
//  .--.--.--.--.--.-----|  |--|__|  |_ 
//  |  |  |  |  |  |     |  _  |  |   _|
//  |________|_____|__|__|_____|__|____|
//                                      
//                                      
//                                      
//                                      
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1668866400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1668261600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x670231Bb25B4aB0Fa86a4D492EF168c406058e36];
  address public erc20Payable = 0x670231Bb25B4aB0Fa86a4D492EF168c406058e36;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 7500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif7u3iqudt6uoklcvgmnra5k74gvzva3kw3dwrq6kia2tvssdj4vq/";
    string public _baseTokenExtension = "";

    bool public mintingOpen = false;
    
    
    uint256 public MAX_WALLET_MINTS = 60;
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 7500");
...
// File: contracts/CrazyFoodsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CrazyFoodsContract is RamppERC721A {
    constructor() RamppERC721A("Crazy Foods", "CRAZYFOODS"){}
}
