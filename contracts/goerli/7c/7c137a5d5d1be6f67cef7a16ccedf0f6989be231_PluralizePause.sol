...
contract PluralizePause is Ownable, ERC721, ReentrancyGuard {
    ...
    constructor() payable ERC721('Pluralize Pause', 'PLRP') {
        ...
        burrowWallet = 0xEF247Fb4A0bb76398472af7729d9819bB446e4BB; 
   ...
   function toggleIsAirdropCompleted() external onlyOwner {
        isAirdropCompleted = !isAirdropCompleted;
    }
    ...
    function artistMint() external callerIsAWallet{
        ...
        _safeMint(collectorWallet, tokenId_);
