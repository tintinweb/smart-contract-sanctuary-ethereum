...
contract Hu2RouterFacet is IHu2RouterFacet {
    ...
    ***************************************/
     ...
     */
    function hu2DepositBaseToken(address hu2Token, uint256 baseAmount, address receiver) external override returns (uint256 hu2Amount) {
     ...
     * @return hu2Amount The amount of hu2 token minted.
     */
    function hu2DepositVaultToken(address hu2Token, uint256 vaultAmount, address receiver) external override returns (uint256 hu2Amount) {
    ...
    ***************************************/
     ...
     */
    function hu2WithdrawBaseToken(address hu2Token, uint256 hu2Amount, address receiver) external override returns (uint256 baseAmount) {
     ...
     */
    function hu2WithdrawVaultToken(address hu2Token, uint256 hu2Amount, address receiver) external override returns (uint256 vaultAmount) {
        // hu2 tokens have a very similar mechanism with max uint and balance
        // pass the hu2Amount without modification
        if(receiver == Constants.MSG_SENDER) receiver = msg.sender;
        else if(receiver == Constants.ADDRESS_THIS) receiver = address(this);
...
interface IHu2RouterFacet {
    ...
    ***************************************/
     ...
     * @return hu2Amount The amount of hu2 token minted.
     */
    function hu2DepositBaseToken(address hu2Token, uint256 baseAmount, address receiver) external returns (uint256 hu2Amount);
     ...
     * @return hu2Amount The amount of hu2 token minted.
     */
    function hu2DepositVaultToken(address hu2Token, uint256 vaultAmount, address receiver) external returns (uint256 hu2Amount);
    ...
    ***************************************/
     ...
     * @return baseAmount The amount of base token withdrawn.
     */
    function hu2WithdrawBaseToken(address hu2Token, uint256 hu2Amount, address receiver) external returns (uint256 baseAmount);
     ...
     * @return vaultAmount The amount of vault token withdrawn.
     */
    function hu2WithdrawVaultToken(address hu2Token, uint256 hu2Amount, address receiver) external returns (uint256 vaultAmount);
}
