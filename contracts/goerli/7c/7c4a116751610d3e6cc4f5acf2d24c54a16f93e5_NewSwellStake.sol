...
// File: contracts/NewSwellStake.sol
...
contract NewSwellStake is ReentrancyGuard{
   ...
   */
    ...
    constructor()  {
      ...
      function swellStakeEth ( Stake[] calldata stakes , string calldata referral) external payable   nonReentrant {
