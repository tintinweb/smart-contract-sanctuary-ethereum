...
contract HalloweenPoupelle is ERC721AntiScamControl, ERC2981, ReentrancyGuard {
    ...
    uint256 public privateSaleStartTime = 1667221200; //2022-10-31 22:00:00 +09:00
...
//    address public withdrawAddress = 0x4262098A3a607b263c414F3D16ABf2cc8C1F3711;
    address public withdrawAddress = 0xd6d93E634360D5100119b985159F933ec95e1d13;
   ...
   function wlMint(uint64 _saleType, uint256 _mintCount, uint256 _maxCount, bytes32[] calldata _merkleProof)
        ...
        nonReentrant
    {
        ...
        if(_saleType == 0){
            ...
            //add wl sale
            require(privateSaleStartTime <= block.timestamp , "can not mint, is not private sale");
            root = privateSaleRoot;
        }else{
