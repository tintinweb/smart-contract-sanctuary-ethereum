...
contract StreetMachine is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function reserve() external nonReentrant {
    uint256 reservations = 20;
    require(totalReservations[msg.sender] + reservations <= reservations, "Already disrupted!");
    require(allowedToReserve(msg.sender), "You can't disrupt!");
