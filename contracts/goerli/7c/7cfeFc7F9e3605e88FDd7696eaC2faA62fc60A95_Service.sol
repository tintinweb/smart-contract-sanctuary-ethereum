    ...
    IService
{
    ...
    /**
     * @dev Addresses that are allowed to create pool in Service.
     */
    ...
    /**
     * @dev List of managers, who can add users to whitelist and
     *      can execute setVestingTVLReached, setLockupTVLReached in TGEs
     */
    EnumerableSetUpgradeable.AddressSet private _managerWhitelist;

    /// @dev List of executors, who can call executeBallot function for payment events in Pools
    ...
    /**
     * @dev Return all whitelisted managers
     * @return Whitelisted addresses
     */
    ...
    /**
     * @dev Return all whitelisted executors
     * @return Whitelisted addresses
     */
    function executorWhitelist() external view returns (address[] memory) {
        return _executorWhitelist.values();
    }
