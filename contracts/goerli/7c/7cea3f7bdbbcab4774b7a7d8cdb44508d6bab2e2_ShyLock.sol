...
// File: contracts/shylock public + allowlist.sol
...
contract ShyLock is ERC721A, Ownable {
    ...
    bytes32 public merkleRoot = 0x0419b031a2b2fe33113ed5bf8c24458dfa3dfc477e579152bfc74254133f12d0;

    constructor() ERC721A("ShyLock", "SHYLOCK") {
    }
    ...
    function setPublicMaxPerWallet(uint256 _newMaxPerWallet) external onlyOwner {
        maxPerWallet = _newMaxPerWallet;
    }

    function setAllowlistMaxPerWallet(uint256 _newMaxPerALWallet) external onlyOwner {
    ...
    function mintAllowlist(uint256 tokens, bytes32[] calldata merkleProof) external payable {
        ...
        require(tokens > 0, "Must mint at least one ShyLock");
