...
import "./OwnIconiqUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new IconiqUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        IconiqUser721Token token = IconiqUser721Token(address(addr));
...
contract IconiqUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
