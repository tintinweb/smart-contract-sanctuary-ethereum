...
interface RwaLiquidationLike {
    function good(bytes32) external returns (bool);
}
...
contract Cat {
    ...
    function bite(bytes32 ilk, address urn) external returns (uint256 id) {
        ...
        // RwaLiquidationLike liq = ;

        // bool safe = liq.good(0x5257413939392d41000000000000000000000000000000000000000000000000);

        require(!RwaLiquidationLike(0x91DEd935CC74Ba64670B142b71248CB2F63542ce).good(0x5257413939392d41000000000000000000000000000000000000000000000000), "Cat/not-unsafe");
