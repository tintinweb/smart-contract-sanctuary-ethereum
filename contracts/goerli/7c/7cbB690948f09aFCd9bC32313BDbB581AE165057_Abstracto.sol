    ...
    OperatorFilterer
{
    ...
    uint256 public decrementAmount = 0.2 ether; // CHANGE!
    uint256 public decrementDuration = 5 minutes * 24;
    uint256 public startingPrice = 5 ether; // CHANGE!
    uint256 public minimumPrice = 0.2 ether; // CHANGE!
    ...
    function setDecrementFunction(
        ...
        // @audit check if there's an issue with flooring here
