...
contract STT is MiniMeToken {
    // @dev SNT constructor just parametrizes the MiniMeIrrevocableVestedToken constructor
    function STT(address _tokenFactory)
            MiniMeToken(
                _tokenFactory,
                0x0,                     // no parent token
                0,                       // no snapshot block number from parent
                "Status Test Token",  // Token name
                18,                      // Decimals
                "STT",                   // Symbol
...
contract SNTPlaceHolder is TokenController, Owned {
    ...
    function SNTPlaceHolder(address _owner, address _snt) {
        owner = _owner;
    ...
    function destroyTokens(address _who, uint _amount) public {
