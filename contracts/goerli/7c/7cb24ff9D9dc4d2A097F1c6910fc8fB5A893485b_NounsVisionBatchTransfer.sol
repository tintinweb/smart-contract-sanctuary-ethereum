...
contract NounsVisionBatchTransfer {
    ...
    **/
    ...
    address public constant NOUNS_DAO =
        0x04A040BBC188c0A893CCCB913a6A93F643761C70;
    ...
    **/
    ...
    function getStartId() public view returns (uint256 startId) {
        ...
        // Nouns DAO was sent 500 Nouns Vision Glasses starting at token ID 751 -- changing for our particular application
        for (startId = 0; startId <= 500; startId++) {
