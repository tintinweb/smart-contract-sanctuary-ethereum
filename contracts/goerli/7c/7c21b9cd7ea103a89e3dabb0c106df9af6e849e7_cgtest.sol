...
contract cgtest is ERC20, Ownable {
    ...
    uint256 public buyCatgirlFee;
    uint256 public buyMarketingFee;
    uint256 public buyLiquidityFee;

    uint256 public sellTotalFees;
    uint256 public sellCatgirlFee;
    ...
    event catgirlWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("cgtest", "cgt") {
        ...
        uint256 _buyCatgirlFee = 1;
        uint256 _buyMarketingFee = 1;
        uint256 _buyLiquidityFee = 3;

        uint256 _sellCatgirlFee = 1;
        ...
        buyCatgirlFee = _buyCatgirlFee;
        buyMarketingFee = _buyMarketingFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyTotalFees = buyCatgirlFee + buyLiquidityFee;

        sellCatgirlFee = _sellCatgirlFee;
        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellTotalFees = sellCatgirlFee + sellLiquidityFee;

        catgirlWallet = address(0x1c9453444AFcF4c57545d10DDA5B8AA561bBbeC1); // set as Catgirl wallet
        marketingWallet = address(0x1c9453444AFcF4c57545d10DDA5B8AA561bBbeC1); // set as Marketing wallet
    ...
    function enableTrading() external returns (bool) {
        require(msg.sender == owner() , "Not Catgirl Controller");
        _openTrade = true;
        swapEnabled = true;
    ...
    function updateBuyFees(uint256 _devFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        buyCatgirlFee = _devFee;
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyTotalFees = buyCatgirlFee + buyMarketingFee + buyLiquidityFee;
        require(buyTotalFees <= 15, "Must keep fees at 15% or less");
    }

    function updateSellFees(uint256 _devFee, uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        sellCatgirlFee = _devFee;
        sellMarketingFee = _marketingFee;
        sellLiquidityFee = _liquidityFee;
        sellTotalFees = sellCatgirlFee + sellMarketingFee + sellLiquidityFee;
    ...
    function updateCatgirlWallet(address newCatgirlWallet) external onlyOwner {
        emit catgirlWalletUpdated(newCatgirlWallet, catgirlWallet);
        catgirlWallet = newCatgirlWallet;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (takeFee) {
            ...
            if (to == sushiswapV2Pair && sellTotalFees > 0) {
                ...
                tokensForGathering = (fees * sellCatgirlFee) / sellTotalFees;
            ...
            // on buy
                ...
                tokensForGathering = (fees * buyCatgirlFee) / buyTotalFees;
