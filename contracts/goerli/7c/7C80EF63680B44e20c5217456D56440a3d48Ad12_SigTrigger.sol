...
contract SigTrigger is ERC2771Context, Ownable {
   ...
   //Set Signer
    ...
    function setTrustedForwarder(address newForwarder) external onlyOwnerOrAdmin {
...
contract GenesisRocket is ERC721A, ERC721AQueryable, IERC721ABurnable, Context, OwnableRoles, DefaultOperatorFilterer, ERC2981 {
