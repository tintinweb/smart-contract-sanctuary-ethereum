//SPDX-License-Identifier: MIT   
    ...
    import "./RGBCollectible.sol";

    contract RGBCollectibleV2 is RGBCollectible {
...
contract RGBCollectible is ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory baseURI) public initializer {
        __ERC721_init("NFT RGB Collection", "RGBFREE");
        __Ownable_init();
