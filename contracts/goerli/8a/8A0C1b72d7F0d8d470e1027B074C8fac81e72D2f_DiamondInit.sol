...
library LibDiamond {
    ...
    function enforceIsContractOwner() internal view {
        if(msg.sender != diamondStorage().contractOwner && msg.sender != diamondStorage().project.superAdmin) {
...
library LibRoyalty {
    ...
    bytes32 constant STORAGE_SLOT = keccak256("diamond.standard.diamond.royalty");
...
import { LibPayments } from "../libraries/LibPayments.sol";
import {ERC721AStorage} from '../facets/ERC721AUpgradeable/ERC721AStorage.sol';
...
contract DiamondInit {    
    ...
    function init(bytes memory _calldata) external {
        ...
        // Project Symbol
        ds.project.symbol = project.symbol;
        ERC721AStorage.layout()._symbol = project.symbol;
        // Max Total Supply
        ds.project.maxSupply = project.maxSupply;
        // Mint Price
        ds.project.price = project.price;
        // Max Total Transactions
        ds.project.maxTotalMints = project.maxTotalMints;
        // Max Mint Transactions
        ds.project.maxMintTxns = project.maxMintTxns;
        // Private Sale Timestamp
        ds.project.privateSaleTimestamp = project.privateSaleTimestamp; 
        // Public Sale Timestamp
        ds.project.publicSaleTimestamp = project.publicSaleTimestamp;         
        // Contract Admin
        ds.project.superAdmin = project.superAdmin;
        // Payment Split        
        ds.project.primaryDistRecipients = project.primaryDistRecipients;
        ds.project.primaryDistShares = project.primaryDistShares;
        _initPaymentSplit(project.primaryDistRecipients, project.primaryDistShares);                
        // Royalty Recipient
        ds.project.royaltyReceiver = project.royaltyReceiver;
        LibRoyalty.layout()._defaultRoyaltyInfo.receiver = project.royaltyReceiver;
        // Royalty Share
        ds.project.royaltyFraction = project.royaltyFraction;
        LibRoyalty.layout()._defaultRoyaltyInfo.royaltyFraction = project.royaltyFraction;
        // Merkleroot
        ds.project.merkleroot = project.merkleroot;
    }
