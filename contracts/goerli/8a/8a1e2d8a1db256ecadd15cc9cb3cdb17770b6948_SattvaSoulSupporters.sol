    ...
    EIP2981RoyaltyOverrideCore
{
    ...
    bytes32 public constant SADHANA  = "SADHANA";
    bytes32 public constant METADATA = "METADATA";

    ITokenURI public interfaceOfTokenURI;
    bool public useInterfaceMetadata = false;

    TokenRoyalty localTokenRoyalty;
    address constant private DEFAULT_ROYALITY_ADDRESS = 0x0892E00684B1517863Eb831384ea0b0D9f5b18e6;
    ...
    uint256 public currentSpiritualityState = 0;
    uint256 public sadhanaTime = 0;
    ...
    constructor() ERC721Psi("SattvaSoulSupporters", "SSS") {
        ...
        localTokenRoyalty.recipient = DEFAULT_ROYALITY_ADDRESS;
        localTokenRoyalty.bps = royaltyFee;
        _setDefaultRoyalty(localTokenRoyalty);
        ...
        onlyRole(ADMIN)
    {
        ...
        //if(this.totalSupply() != 0) refreshMetadata(1, this.totalSupply());
    }
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(IERC165, ERC721RestrictApprove, AccessControl, EIP2981RoyaltyOverrideCore)
        returns (bool)
    {
        return
