 ...
 * @notice This contract handles minting Fractional Coinery tokens.
 */
contract FractionalCoinery is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xBc42aeA123a71E1c567De7Bc8E10F5e28b960BF2;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x84D680c1cc4c0bb15863dA8d62C8198650a906a6;
    address[] public payoutAddresses = [
        0x84D680c1cc4c0bb15863dA8d62C8198650a906a6
    ];
    ...
    string public name = "Fractional Coinery";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC1155(
            "ipfs://bafybeig7kdt7leudrt56tgfywzm5ehvojdranfzhgxasbkbsz3rqvohvgi/{id}"
        )
        RevokableOperatorFilterer(
