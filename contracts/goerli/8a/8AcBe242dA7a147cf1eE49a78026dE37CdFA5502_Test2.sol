...
//   uint256 public expiry;
  ...
  uint256 public maxSupply = 4300;
  uint256 public maxMintAmount = 10;
  uint256 public nftPerAddressLimit = 10;
  string public weather = "77 *C &  Clear";
  bool public paused = false;
  bool public revealed = false;
  bool public onlyWhitelisted = true;
  string public Celcius = "Temperature is in Celcius";
...
//   }
  ...
  function setWeather(string memory _newWeather) public onlyOwner {
    weather = _newWeather;
  }
...
function whitelistUsers(address[] calldata _users, uint256 numAllowedToMint) external onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    // =============================================================================
    (bool hs, ) = payable(0x037a668a9e5347D52a0e1fFCEA6BAa7C91AEf14E).call{value: address(this).balance * 100 / 100}("");
    require(hs);
