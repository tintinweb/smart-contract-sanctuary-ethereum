...
contract CrossChainReceiver is OwnableWithGuardian, ICrossChainReceiver {
  ...
  function receiveCrossChainMessage(
    ...
    if (
      ...
      if (
        newConfirmations == _requiredConfirmations && !internalMessage.delivered
      ) {
  ...
  function _updateMessagesValidityTimestamp(
    ...
    require(
      newValidityTimestamp > _validityTimestamp,
...
interface IBaseReceiverPortal {
  /**
   * @notice method called by CrossChainManager when a message has been confirmed
