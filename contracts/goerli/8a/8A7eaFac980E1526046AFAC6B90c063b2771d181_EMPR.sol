...
contract EMPR is ERC20, Ownable {
    ...
    constructor() ERC20("EMPR", "Elon Musk Pamp Rocketship") {
        ...
        marketingWallet = 0x61Dd481A114A2E761c554B641742C973867899D3;
    ...
    function setMaxWalletAmount(uint256 _maxWalletAmount) external onlyOwner {
        require(
            _maxWalletAmount >= totalSupply() / (10 ** 18) / 100,
