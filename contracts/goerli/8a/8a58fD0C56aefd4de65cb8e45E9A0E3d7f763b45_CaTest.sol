...
contract CaTest is ERC721A, Ownable, ReentrancyGuard, ERC2981{
    uint256 public tokenCount;
    uint256 private prePrice = 0.001 ether;//デプロイ前に修正
    uint256 private pubPrice = 0.002 ether;//デプロイ前に修正
    uint256 public batchSize = 100;
    uint256 public mintLimit = 3;
    uint256 public _totalSupply = 50;//デプロイ前に修正
    ...
    constructor() ERC721A("CaTestV1", "CTV1",batchSize, _totalSupply) {
        tokenCount = 0;
    ...
    function withdrawRevenueShare() external onlyOwner {
        ...
        address artist = payable(0xa4Dc179955B5B5120183a39e4aE46502622225F8);//12 デプロイ前に修正
        address engineer1 = payable(0x30cE4a8789483Bbf77BAE5bCB5B3b0539fFB299E);//17 デプロイ前に修正
        address engineer2 = payable(0xB2a669299Ad64D6E1dDF090F35188D1Ef23C58eA);//18 デプロイ前に修正
        bool success;
