...
contract Test3 is ERC721, Ownable, DefaultOperatorFilterer {
    ...
    uint256 public constant COLLECTION_SIZE = 333;
    ...
    constructor() ERC721("Test3", "WCMP") {}

    function contractURI() public pure returns (string memory) {
        return
            "data:application/json;base64,eyJuYW1lIjoiWmVyb0NvZGVORlRUZXN0OTk5MSIsImRlc2NyaXB0aW9uIjpudWxsLCJleHRlcm5hbF91cmwiOiJ6ZXJvY29kZW5mdC5jb20iLCJmZWVfcmVjaXBpZW50IjoiMHhBYmI2ODJBOWUwMEQ3ODhEOURjQjYzRmNBNjUzQjExYTFEMDMwOGJGIiwic2VsbGVyX2ZlZV9iYXNpc19wb2ludHMiOjUwMH0=";
    }
    ...
    function calcTotal(uint256 count) public view returns (uint256) {
        require(saleStatus != SaleStatus.PAUSED, "Test3: Sales are off");
    ...
    function mint(uint256 count) external payable {
        ...
        require(
            _tokenIds.current() + count <= COLLECTION_SIZE,
            "Test3: Number of requested tokens will exceed collection size"
        );

        require(
            msg.value >= calcTotal(count),
            "Test3: Ether value sent is not sufficient"
        );
