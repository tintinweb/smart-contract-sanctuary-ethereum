...
contract SatAv is ERC721FCOMMON {
    ...
    constructor() ERC721FCOMMON("SaMyAv", "SMA") {
        setBaseTokenURI("https://minshi.com/erc721/");
        _mint(msg.sender, 0);
    }
    ...
    function mint() external payable {
        ...
        require(userBalanceSaleMint[msg.sender]<1,"$_sat_$Max mint amount is 1 token for 1 address$$_sat_$$");
        ...
        require(supply < MAX_TOKENS, "$_sat_$Purchase would exceed collection length$$_sat_$$");
