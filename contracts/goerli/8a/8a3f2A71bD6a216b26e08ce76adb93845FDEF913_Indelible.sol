// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"DOS Phunks", unicode"A Collection of 5K DOS/ASCII Phunks by @n0xiyz  | CC0 Project | 100% On-Chain", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/69daf2c4-9752-4273-bbc2-b767201211f1", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/69daf2c4-9752-4273-bbc2-b767201211f1", "", 1000, "0x78ad9aA2FD9Fe6cbeC04A59feA81cea9Cb70F172");

        constructor() ERC721A(unicode"DOS Phunks", unicode"DOSPHUNKS") {
            TIERS[0] = [877,2456];
...
TIERS[6] = [112,114,115,199,210,282,296,392,411,465,737];
...
TIERS[10] = [762,2571];
TIERS[11] = [5,15,30,833,1095,1355];
TIERS[12] = [486,547,558,591,1151];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"DOS Phunks #");
