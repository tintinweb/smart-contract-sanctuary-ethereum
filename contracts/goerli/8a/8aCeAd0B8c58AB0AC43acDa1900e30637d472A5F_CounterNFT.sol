...
contract CounterNFT is ERC721URIStorage, Ownable {
    ...
    */
    ...
    /**
     * @dev owner value is msgSender onlyOwner
     * - tokenIdをインクリメント  _tokenIds.increment()
     * - nftMint関数の実行アドレスにtokenIdを紐づけ _msgSender()
    ...
    function nftMint() public onlyOwner{
        ...
        string memory jsonFile = string.concat("metadata", Strings.toString(newTokenId), ".json");
    ...
    */
    function _baseURI() internal pure override returns (string memory){
        return "ipfs://bafybeia7sonfglobdng25vkpgtsomxyskfmjkpavu6zjepwvmf3znoec64/";
    }
