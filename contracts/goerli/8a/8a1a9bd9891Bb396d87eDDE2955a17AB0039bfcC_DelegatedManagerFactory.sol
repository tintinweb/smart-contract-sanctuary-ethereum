...
contract DelegatedManager is Ownable, MutualUpgradeV2 {
    ...
    {
        require(
            _module != address(setToken),
            "Extensions cannot call SetToken"
        );
     ...
     */
    function updateUseAssetAllowlist(bool _useAssetAllowlist)
        external
        onlyOwner
    {
        useAssetAllowlist = _useAssetAllowlist;
     ...
     */
    function updateOwnerFeeSplit(uint256 _newFeeSplit)
        external
     ...
     */
    function updateOwnerFeeRecipient(address _newFeeRecipient)
        external
        onlyOwner
    {
