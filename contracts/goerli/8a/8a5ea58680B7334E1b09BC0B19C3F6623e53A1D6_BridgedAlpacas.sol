...
abstract contract BridgedERC721 is
    ERC721Enumerable,
    EIP712,
    ERC2981,
    IERC721Receiver,
    ...
    PermissionsEnumerable
{
    ...
    bytes32 private constant TYPEHASH =
        keccak256(
            "BridgeRequest(address to,string uri,uint64 assetId,bytes32 uid)"
        );
    ...
    constructor(
        ...
        address _royaltyRecipient,
        uint96 _royaltyBps
    ) ERC721(_name, _symbol) EIP712("BridgedERC721", "1") {
    ...
    function bridgeOut(uint64 _assetId, uint64 _owner) external virtual {
        assetIdOwner[_assetId] = _owner;
        safeTransferFrom(msg.sender, address(this), _assetId);
    }
