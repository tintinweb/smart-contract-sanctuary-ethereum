...
contract AsciiPunks is Ownable, ERC721A {
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '"image_data":"data:text/html;base64,', Base64.encode(svg), '",'
                                '"attributes": ',
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                ...
                                '"name":"', title, '",'
                                '"description":"', desc, '",'
                                '"image_data":"data:text/html;base64,', baguetteImg, '",'
    ...
    function tokenImage(uint16 punkId) public view returns (string memory) {
        ...
        for (uint i = 0; i < attrCount; ++i) {
            ...
            if (attrVal != none) {
                svgBytes.append('<image src="data:image/svg+xml;base64,');
    ...
    function setAttributeFromStr(string memory attrM, string memory attrF, string memory traitName) external onlyOwner {
    ...
    function setAttributeEqualFromStr(string memory attr, string memory traitName) external onlyOwner {
        uint attrIndex = uint(extendedPunkDataContract.attrStringToEnumMapping(traitName));
        require(attrIndex != 0, "not found");
        setAttributeEqual(attr, attrIndex);
    }
