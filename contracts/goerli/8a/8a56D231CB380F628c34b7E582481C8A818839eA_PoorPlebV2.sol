...
contract PoorPlebV2 is ERC20, Ownable {
    ...
    function claim() external {
        ...
        if (claimListCounter[msg.sender] != 0) {
            require(claimList[msg.sender], "not in claim list");
        }

        require(claimListCounter[msg.sender] < claimMaxNumber, "max claim exceded");
     ...
     */
    function getClaimNumber(address account)
        external
        view
        virtual
        returns (uint256)
