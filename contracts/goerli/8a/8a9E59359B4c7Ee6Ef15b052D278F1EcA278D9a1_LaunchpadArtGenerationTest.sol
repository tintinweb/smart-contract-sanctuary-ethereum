 ...
 * @notice This contract handles minting Art generation test tokens.
 */
contract LaunchpadArtGenerationTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xf8d031bB863e239374409D4C4AC3fDCbEbf18E77;
    ...
    uint256 public constant PRESALE_MAX_SUPPLY = 4444;
    uint256 public presaleMintsAllowedPerAddress = 1000;
    uint256 public presaleMintsAllowedPerTransaction = 1000;
    uint256 public presalePrice = 0.02 ether;
    uint256 public publicMintsAllowedPerAddress = 1000;
    ...
    constructor() ERC721A("Art generation test", "CATC") {
