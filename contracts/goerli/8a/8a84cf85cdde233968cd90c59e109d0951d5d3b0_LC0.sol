...
contract ERC20 is Context {
    ...
    function transfer(address to, uint256 amount) public virtual returns (bool) {
        // TODO use _transfer
        //     no need for require calls here as they are done in _transfer
    ...
    function approve(address spender, uint256 amount) public virtual returns (bool) {
        ...
        //     no need for require call as this is done in _approve
    ...
    function transferFrom(address from, address to, uint256 amount) public virtual returns (bool) {
        ...
        /*     no need for requirement calls as these are done respectively in 
               _spendAllwoance and _transfer  */
    ...
    function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
        ...
        //     no need for emit Approval as this is again done in the _approve function
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        // TODO: use `_approve` defined later in the contract
        //     no need for require to check zero address as this is done in _approve
        ...
        //     no need to include an emit Approval here as its done in the _approve function
        return true;
    }
    ...
    function _spendAllowance(address owner, address spender, uint256 amount) internal virtual {
        ...
        if (currentAllowance != type(uint256).max) {
            require( // TODO: must have enough currentAllowance to cover amount
...
contract LC0 is LuckyToken {  // TODO: replace names
    constructor() LuckyToken("LuckyCoinLK", "LCLK") {}
}