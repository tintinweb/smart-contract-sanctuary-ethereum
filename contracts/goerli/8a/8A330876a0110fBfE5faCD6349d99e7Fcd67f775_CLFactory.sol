...
contract CLHouse is CLStorage {
    ...
    function GetArrDataPropAddMemberLength() external view returns( uint256 ){
        return arrDataPropAddMember.length;
    }
    ...
    /// @notice Get complete array of arrDataPropAddMember
    /// @return arrDataPropAddMember the array with all proposals
    function GetArrDataPropAddMember() external view returns( strDataAddMember[] memory ) {
        return arrDataPropAddMember;
    }
}
