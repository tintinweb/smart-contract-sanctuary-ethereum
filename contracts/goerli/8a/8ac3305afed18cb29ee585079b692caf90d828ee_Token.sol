...
contract Token is Context, ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    /// @notice The maximum amout of vvddrr that can be created through cRank claims + 1.
    /// @dev This includes burned vvddrr created as part of the cRank minting process.
    uint256 public constant MAX_CLAIM_CREATED = 1000000000000000000000000; // 1_000_000 ETH
    ...
    function claimMintReward_72B() external {
        ...
        uint256 _currentClaimCreated = currentClaimCreated;
        ...
        // require(totalAmount + _currentClaimCreated < MAX_CLAIM_CREATED, "Max claim vvddrr created");
        ...
        _currentClaimCreated += totalAmount;
        currentClaimCreated = _currentClaimCreated;
