...
contract HongBao is ERC721A, Ownable {
    ...
    uint256 public maxPerALWallet = 1000;
    ...
    string public unRevealedURL = "https://ipfs.io/ipfs/QmQ8GTjxDTJwhT8Xn1s9zHkvqAvwv9piEEiNTxahxoSLeL/hidden.json";
    ...
    constructor() ERC721A("Hong Bao", "HB") {}
        ...
        payable
    {
        ...
        require(tokens > 0, "Must mint at least one  Hong Bao");
        require(
