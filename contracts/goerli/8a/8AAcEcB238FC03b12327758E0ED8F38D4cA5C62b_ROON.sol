...
contract ROON is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "ROON";
    string private _symbol = "RaaN";
    ...
    constructor () {
        ...
        Boy = payable(address(0xfE174fdC048331eE2b1518871352545ca0e3219B));
