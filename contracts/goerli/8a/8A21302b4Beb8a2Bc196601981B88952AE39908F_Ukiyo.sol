...
contract Ukiyo is ERC20, ERC20Burnable, Ownable {
    ...
    uint32 public claimPeriodforTeam = uint32(block.timestamp + 10 minutes); //use 730 days for main net
    uint8 _decimals;
    ...
    uint256 public maxTxnAmount = 50_000 * 10**8;
    uint256 public maxHolding = 100_000 * 10**8;
    ...
    {
        _treasuryWalletAmount = (_amount * sellBuyTaxAmt[0]) / 10000; //3%
        _vaultAmount = (_amount * sellBuyTaxAmt[1]) / 10000; //2%
        _PRWalletAmount = (_amount * sellBuyTaxAmt[2]) / 10000; //2%
        _tax = (_amount * sellBuyTaxAmt[3]) / 10000; //3%
