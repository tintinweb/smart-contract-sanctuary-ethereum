...
abstract contract MarketFee is Owned, DexBase, ERC20 {
    ...
    address constant marketAddress = address(0x982b4C94955F6B566C0a46f8DD65B00bF61897c5);

    uint256 public numTokenToDividend = 2 * 1e8;
...
contract AmexTokenCoin is ExcludedFromFeeList, MarketFee {
    uint256 private constant _totalSupply = 21000 * 1e8;

    constructor() ERC20("AmexTokenCoin", "ATC", 8) MarketFee() {
