...
contract PLM {
    ...
    function createProductCategory(uint companyId, string memory name, string[] memory stages, address[] memory stagesAssignees) public {
        ...
        emit ProductCategoryAdded(productCategoriesCounter, name, stages, stagesAssignees, companyId);
    }

    function updateProductCategory(uint id, string memory name, string[] memory stages, address[] memory stagesAssignees) public {
    ...
    function createProduct(uint companyId, uint productCategoryId, string memory name, string memory description) public {
        require(companies[companyId].owner == msg.sender, "Only company owner is allowed to perform this action");
        ...
        emit ProductAdded(productsCounter, name, description, companyId, productCategoryId);
    }

    function updateProduct(uint id, uint productCategoryId, string memory name, string memory description) public {
        ...
        emit ProductUpdated(id, name, description, productCategoryId);
    }

    function processToNextStage(uint id, string memory record) public {
        Product storage product = products[id];
        ...
        emit ProductLifecycleUpdated(id, product.currentStage, record, msg.sender);
    }
}