...
contract IDO is Ownable {
    ...
    constructor(projectInfo memory data,address owner,address admin,uint256 _adminPoint
        ) {
    ...
    function initIdo () internal   {      
      ...
      //require(statusRun==false, "initIdo already!");

     //授权合约得到代币
    //SafeERC20.safeApprove(tokenB,address(this), Info.inTokenCapacity);
      ...
      //项目方提供供应的代币余量
      //Info.outTokenCapacity=Info.inTokenCapacity;
