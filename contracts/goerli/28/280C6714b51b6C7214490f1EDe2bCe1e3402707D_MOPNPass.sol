...
contract MOPNPass is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(uint256 _saleStartTime) ERC721A("MOPNLAND", "MOPN") {
    ...
    function mint(
        ...
        require(
            isWhitelisted(msg.sender, maxQuantity, price, proof),
        ...
        returns (string memory tokenuri)
    {
        ...
        if (mopnPassMetaDataRenderAddress != address(0)) {
            ...
            tokenuri = metaDataRender.constructTokenURI(tokenIdToIndex[id]);
        }
    }
    ...
    function isWhitelisted(
        ...
        return _verify(_leaf(account, maxQuantity, price), proof);
    }

    function _leaf(address account, uint256 maxQuantity, uint256 price)
        internal
        pure
        returns (bytes32)
    {
        return keccak256(abi.encodePacked(account, maxQuantity, price));
    }
