...
// The Plum Inu  (梅犬, Plum-ken)

// TELEGRAM: https://t.me/pluminuportal

// TWITTER: https://twitter.com/PlumInuerc20

// We are a 100% decentralized community experiment that is preparing for advancements in our digital future.

// Our mission is to provide a secure and reliable platform for users to transact and interact with each other.
...
contract KOMPIUTERIS is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "KOMPIUTERIS";
    string private constant _symbol = "KMPTR";
    ...
    address payable private _developmentAddress = payable(0xa87432dD7d4eda54b52e0E26c4A5dc5ca611B0DB); 
    address payable private _marketingAddress = payable(0xa87432dD7d4eda54b52e0E26c4A5dc5ca611B0DB);
