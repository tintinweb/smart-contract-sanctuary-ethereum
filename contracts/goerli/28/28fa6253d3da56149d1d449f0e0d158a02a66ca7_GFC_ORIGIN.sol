...
contract GFC_ORIGIN is ERC1155, AccessControl, RrpRequesterV0 {
        ...
        RrpRequesterV0(_airnodeRrp)
    {
        ...
        //set gold IDs (500/10000 spaced evenly)
    ...
    /// removeGoldId() is not working as intended
    /// check moduli to ensure all outputs are within bounds of [1, mintSupply] and [1, goldSupply]
    function getTierFromQrnAndManageSupply(uint256 _QRN) private returns (uint256) {
        uint256 thisRandomId = (_QRN % mintSupply-1) + 1; //inclusive of 1...
        // uint256 thisRandomGoldIdIndex = (_QRN % goldSupply-2) + 1; //for removing gold ids in random order, should one be selected, to preserve odds
        uint256 thisTier;
