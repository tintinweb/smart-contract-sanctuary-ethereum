...
contract DemoOne is ERC721, Ownable {
    ...
    constructor() ERC721("DemoOne", "DMO") payable {}
    ...
    function mintDemo(uint256 _count) public payable {
        uint256 totalSupply = totalSupply();

        require(isSaleActive, "Sale is not active" );
        require(totalSupply + _count < MAX_TOKENS + 1, "Exceeds available");
    ...
    function freeMintDemo(uint256 _count) public payable {
        ...
        require(totalSupply + _count < FREE_TOKENS + 1, "Exceeds available ");
