...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x0B8d43D4A6a854966ceFBE2Cf44FBeFd28101B78];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x0B8d43D4A6a854966ceFBE2Cf44FBeFd28101B78;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmfAVDwM9ThEnpVMXy1xN7zZUzKeybUH1Y2UwxGnadSTaf/";
...
// File: contracts/Prova7Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Prova7Contract is RamppERC721A {
    constructor() RamppERC721A("Prova7", "PRV7"){}
}
