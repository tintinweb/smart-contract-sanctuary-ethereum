...
contract KungFuVerse is ERC721A, ReentrancyGuard, Ownable {
    uint256 public constant MAX_SUPPLY = 5000;
    uint256 public constant MAX_PER_MINT_NUM = 2;
    ...
    * Minting
    */
    function reserve(address to, uint32 num) external onlyOwner {
