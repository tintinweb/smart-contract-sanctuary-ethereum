...
contract RichestInTheWorld is ERC721, Ownable {
    ...
    constructor(uint256 _price) ERC721("RichestInTheWorld", "DREAMS") {
        price = _price;
    }
    ...
    function tokenURI(uint256 _tokenId) public view virtual override(ERC721) returns (string memory) {
        ...
        return string(abi.encodePacked("https://ritw.vercel.app/metadata/", _tokenId.toString(), ".json"));
    }
}