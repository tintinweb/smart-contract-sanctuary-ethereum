...
contract FlashSwapTest1 is IUniswapV2Callee {
    ...
    function uniswapV2Call(address _sender, uint _amount0, uint _amount1, bytes calldata _data) override external {
        ...
        uint amountRequired = UniswapV2Library.getAmountsIn(UniswapV2Factory, amountTokenBorrowed, path)[0]; 
        ...
        uint amountReceived = sushi_router.swapExactTokensForTokens( amountTokenBorrowed, amountRequired, path, msg.sender, block.timestamp)[1]; 
