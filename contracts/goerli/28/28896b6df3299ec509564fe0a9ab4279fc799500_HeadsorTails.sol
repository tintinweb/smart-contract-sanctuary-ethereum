...
contract HeadsorTails is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor() ERC721A("Heads or Tails", "HEADTAIL") {}
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    require(!paused, "HEADTAIL: oops contract is paused");
    require(tokens <= MaxperWallet, "HEADTAIL: max mint amount per tx exceeded");
    require(totalSupply() + tokens <= maxSupply, "HEADTAIL: We Soldout");
    require(PublicMintofUser[_msgSenderERC721A()] + tokens <= MaxperWallet, "HEADTAIL: Max NFT Per Wallet exceeded");
    require(msg.value >= cost * tokens, "HEADTAIL: insufficient funds");
