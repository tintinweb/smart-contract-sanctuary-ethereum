...
/**
 * @title ERC721 Drop contract that can disable trading on certain marketplaces 
 * @notice Requires manually approving marketplace contracts to enable trading on them. By default, no marketplaces are approved.
 */
contract ERC721DropRestrictedMarkets is ERC721Drop {
