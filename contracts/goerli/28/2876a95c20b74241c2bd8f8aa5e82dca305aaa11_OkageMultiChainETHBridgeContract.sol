...
contract OkageMultiChainETHBridgeContract is Ownable {
    ...
    constructor(address _okage) {
        ...
        _processFees[43113] = 0.001 ether;
        supportedTargetChains[43113] = true;

        okage = IERC20(_okage);
        emit TargetChainAdded(43113, block.timestamp);
    }
