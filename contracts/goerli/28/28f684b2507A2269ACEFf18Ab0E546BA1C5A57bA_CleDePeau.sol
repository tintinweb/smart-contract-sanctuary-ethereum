...
contract CleDePeau is ERC721Enumerable, Ownable, Pausable {
  ...
  address _operator;
  uint256 TOTAL_SUPPORT = 1000;

  event CollectionBaseURIUpdated(string oldURI, string newURI);
  ...
  constructor(string memory baseURI, address operator)
  ...
  function setCollectionBaseURI(string memory _collectionBaseURI) external onlyOwner whenNotPaused {
    emit CollectionBaseURIUpdated(collectionBaseURI, _collectionBaseURI);
