...
contract NFT is ERC721Royalty, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public constant limitSupply = 40;
    uint256 public constant presaleSupply = 15;
    uint256 public constant presalePrice = 0.001  ether;
    uint256 public constant publicSalePrice = 0.003 ether;
    uint256 public PRESALE_MAX_MINT = 3;
    uint256 public MAX_PER_MINT = 20;
    address private constant royaltyReceiverAddress = 0x977e48Ed6709c0D84b4F43cea2e28E7F04e7F0F3;
    uint96 private constant royaltyFee = 15;
    ...
    constructor() ERC721("Accessories (copy)", "AA") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://bafybeidkgb6ixrjmj2zjffqmuqljxot43hqx2pmea7sue42yamis2e7uqq.ipfs.w3s.link/metadata/";
    }
    ...
    function _preValidatePurchase(uint256 amountOfNFTs) internal view {
        ...
        if (presaleActive) {
            ...
            require(publicSaleMinted + amountOfNFTs <= publicLimit(), "PublicSale: Requested quantity would exceed max presale supply.");
