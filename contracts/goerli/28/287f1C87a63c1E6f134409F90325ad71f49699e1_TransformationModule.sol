...
contract LegacySushiModule is TransferModule {
    ...
    /// @param sourceAddress    The address of the token / approval source. Required if the source is a sponsor.
...
contract TransferModule is ConduitModule {
    ...
    /// @param sourceAddress The address of the token / approval source. Required if the source is a concierge.
    ...
    function transferERC20From(
        ...
        } else if (source == TokenSource.CONCIERGE) {
            bytes32 conduitKey = abi.decode(data, (bytes32));
