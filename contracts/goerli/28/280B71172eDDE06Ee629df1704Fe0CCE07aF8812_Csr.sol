...
contract Csr is DefaultOperatorFilterer {
    ...
    function drawByKind(uint _tokenId) internal view returns (string memory) {
        ...
        for (uint i = 0; i < nfts[_tokenId].len; i++) {
            ...
            height = nfts[_tokenId].elements[i].height;
            if (_generate) {
                figure = minMax(i * 12, 1, 100);
    ...
    function safeTransferFrom(
        ...
        uint256 _tokenId,
        bytes memory _data
    ) external onlyAllowedOperator(_from) {
        ...
        returns (string memory)
    {
        ...
        return
            string.concat(
                ...
                '","seller_fee_basis_points": 512,"fee_recipient": "0xe4dd4725Ed4634A130977CB12De23366E6eCe1f8"}'
            );
    }
}