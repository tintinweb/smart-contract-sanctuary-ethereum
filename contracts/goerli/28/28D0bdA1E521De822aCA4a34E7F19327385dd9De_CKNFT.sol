...
contract CKNFT is ERC1155, Ownable, Pausable {
    ...
    uint256 public MAX_MINT = 51;
    uint256 public max_mint_wl = 51;
    uint256 public MAX_AL_MINT = 51;   
    ...
    //address public teamWallet = 0x79e7e03d7BCbEeeF25B2C4cBBC82ecc677C7fe5C;
        ...
        )
    {
        ...
        tokenIdToMaxSupplyPlusOne[0] = 200;
        tokenIdToMaxSupplyPlusOne[1] = 200;
        ...
        for (uint256 i = 0; i < MAX_TOKEN_ID_PLUS_ONE; ++i) {
            _ids[i] = i;
            _amounts[i] = 100;
            tokenIdToExistingSupply[i] = 100;
        }
        _mintBatch(teamWallet, _ids, _amounts, "");
    }
    ...
    {
        require(_id < MAX_TOKEN_ID_PLUS_ONE, "id must be < 2");
        require(tokenIdToExistingSupply[_id] + _amount <= 150, "All tokens minted");
