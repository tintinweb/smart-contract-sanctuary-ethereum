...
// Enter the lottery by paying a fee
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    address payable[] private s_players; // Array called players
    ...
    /**
     * @dev This is the function that the Chainlink Keeper node call. They look for the "upkeepneeded" to return true
        ...
        )
    {
        ...
        // (block.timestamp - previous timestamp) > interval
    }
    ...
    function getEntranceFee() public view returns (uint256) {
        //Function to call and find out entrance fee
