...
/// @author DePlayground team
/// @title Teach token manager contract
...
contract TeachTokenManager {
    ...
    /** @dev Returns the current token reserves in the uniswap pair.
     * @return  reserveA token reserves of $TEACH.
     * @return reserveB token reserves of ETH.
    ...
    /** @dev Updates $TEACH address.
     * @param TEACH_ New $TEACH_ address.
     */
    ...
    /** @dev Updates WETH address.
     * @param WETH_ New weth address.
     */
    ...
    /** @dev Updates COLD_WALLET address.
     * @param coldwallet_ New COLD_WALLET address.
     */
    ...
    /** @dev Adds liquidity to the uniswap liquidity pool.
     * @param teachTokenAmount Amount of $TEACH to be added to the pool.
     * @param deadline Dealine (timestamp) for the transaction to execute.
     */
    ...
    /** @dev Swaps $TEACH from uniswap for ETH and transfers it to COLD_WALLET.
     * @param userId The user ID of the user purchasing $TEACH.
     * @param deadline dealine (timestamp) for the transaction to execute.
     */
    ...
    /** @dev Transfer $TEACH from user's account to COLD_WALLET.
     * @param amount The amount of $TEACH to transfer.
     * @param userId The user ID of the user transferring $TEACH.
     */
