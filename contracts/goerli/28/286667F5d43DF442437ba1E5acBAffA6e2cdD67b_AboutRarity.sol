...
contract AboutRarity is ERC721Drop {
    ...
    //string[] public serial_2 = ["282328043", "219128449", "299505035", "215948087", "275984435", "260752128", "218741184", "289098392", "224665171", "296267164", "253518629", "235355955", "253987260", "221407067", "264306593", "292343045", "250580829", "290280364", "282322767", "244785198", "206662775", "284003335", "299317788", "210648121", "257872496", "232393489", "262940846", "247700491", "202167775", "296599669"];

    //string[] public serial_3 = ["337360171", "336894458", "349760369", "364785554", "364422880", "381748505", "302295151", "350843200", "326502651", "306734130", "382748107", "358897368"];
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory){
        ...
        //uint256 rand2 = random(string(abi.encodePacked(parts[0], parts[2], toString(tokenId))));
        uint256 greatness = rand % 1000;
        

        // aggiungere Legendary, max 10 in totale
        ...
        if (greatness > 960) {
            ...
            //parts[8] = toString (serial);
                ...
                //uint rColorR = 200;
                uint rColorG = 150 + 15 * (rand % 4);
                uint rColorB = 150 + 15 * (rand % 5);
                
                //parts[1] = string(abi.encodePacked('"rgb(', toString (rColorR), ',', toString (rColorG), ',', toString (rColorB), ')"'));

                parts[1] = string(abi.encodePacked('"rgb(200,', toString (rColorG), ',', toString (rColorB), ')"'));
