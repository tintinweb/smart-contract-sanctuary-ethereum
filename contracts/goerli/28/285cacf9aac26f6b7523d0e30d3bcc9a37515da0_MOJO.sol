...
pragma solidity ^0.8.10;
contract MOJO is ERC20, Owner {
    using SafeMath for uint256;
    
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public constant deadAddress = address(0xdead);
    address public WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //Yet to confirm and add the correct address
    ...
    uint256 public projectBuyDevFee;
    uint256 public projectBuyLiquidityFee;

    uint256 public sellTotalFees;
    uint256 public sellDevFee;
    uint256 public sellLiquidityFee;
    uint256 public projectSellDevFee;
    uint256 public projectSellLiquidityFee;
    ...
    event unblackList(address); // TO REMOVE THE BLACKLISTED BOT



     constructor(uint256 initialSupply) ERC20("MOJO JOJO", "MOJO") {
    ...
    /*
        ...
        */
        ...
        uint256 _projectBuyDevFee = 1;
        uint256 _projectBuyLiquidityFee = 0;

        uint256 _sellDevFee = 20;
        uint256 _sellLiquidityFee = 20;
        uint256 _projectSellDevFee = 3;
        uint256 _projectSellLiquidityFee = 0;
        ...
        projectBuyDevFee = _projectBuyDevFee;
        projectBuyLiquidityFee = _projectBuyLiquidityFee;
        buyTotalFees = buyDevFee + buyLiquidityFee;

        sellDevFee = _sellDevFee;
        sellLiquidityFee = _sellLiquidityFee;
        projectSellDevFee = _projectSellDevFee;
        projectSellLiquidityFee = _projectSellLiquidityFee;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (
            buyDevFee != projectBuyDevFee &&
            sellDevFee != projectSellDevFee 
        ) {
            buyDevFee = projectBuyDevFee;
            buyLiquidityFee = projectBuyLiquidityFee;
            buyTotalFees = buyDevFee + buyLiquidityFee;

            sellDevFee = projectSellDevFee;
            sellLiquidityFee = projectSellLiquidityFee;
            sellTotalFees = sellDevFee + sellLiquidityFee;
        }
