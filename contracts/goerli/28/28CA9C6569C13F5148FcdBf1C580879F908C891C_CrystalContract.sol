...
contract CrystalContract is ERC721LazyMint {
     ...
     */
    function setPrice(uint256 _price, uint256 _decimals) public onlyOwner { 
     ...
     * @param _uri new link
     */
    function setMetaLink(string memory _uri) public onlyOwner {
       metaUri = _uri;
    }
