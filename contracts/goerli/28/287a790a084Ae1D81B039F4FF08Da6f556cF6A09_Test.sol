...
contract Test is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 3600;
    ...
    address[] public withdrawAddresses = [0x51C0FB7dff796E93B60A8bd8b73d8A79845C82bA, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xdd017ea2811113f64a4ec50742355b4ea4e880861680272f6826d92b75eccded;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x51C0FB7dff796E93B60A8bd8b73d8A79845C82bA, _royaltyAmount);
    }
