...
contract TPDIDFactory is Ownable {
    ...
    function createTPDID(
        ...
        address forwardPolicies,
        address gnosisProxyFactory,
        address singleton,
        address fallbackHandler,
        uint saltNonce
    ) external onlyOwner returns (address) {
        return _createTPDID(_owners, _masters, forwardPolicies, gnosisProxyFactory, singleton, fallbackHandler, saltNonce);
    }
...
contract TPDID is DID {
    address private _forwardPolicies;
    ...
    function initialize(
        ...
        _forwardPolicies = forwardPolicies_;
    ...
    function forwardPolicies() public view returns (address) {
        return _forwardPolicies;
    }

    function approveManagerForToken(address token) public onlyOwner {
        address _swapManager = ITPDIDForwardPolicies(_forwardPolicies).swapManager();
    ...
    function _forwardCheckOwner(
        ...
        return ITPDIDForwardPolicies(_forwardPolicies).forwardCheckOwner(destination, data, value);
    }
