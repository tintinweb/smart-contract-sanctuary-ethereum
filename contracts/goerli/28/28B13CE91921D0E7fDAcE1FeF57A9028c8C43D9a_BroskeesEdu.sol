...
contract BroskeesEdu is ERC721Enumerable, Ownable {
    ...
    string baseURI;
    string public notRevealedUri = "ipfs://QmfJugBfd25kKmXrbLHYtDHvR5ohQCTCQ5S2FnRpUgJpTF";
    string public extension = ".json";

    constructor()
        ERC721("BroskeesEdu", "BRO")
    {
    }
