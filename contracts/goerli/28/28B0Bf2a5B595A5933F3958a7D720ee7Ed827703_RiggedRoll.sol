...
error RollGreaterThan2();

contract RiggedRoll is Ownable {
    DiceGame public diceGame;
    uint256 public nonce;
    uint256 public prize;
    uint256 public constant payment = 0.002 ether;
    ...
    function riggedRoll() public {
        ...
        console.log("\t", "   Dice Game Roll(rigged):", roll);

        nonce++;
        if (roll > 2) {
            revert("not what we're looking for");
        }
        diceGame.rollTheDice{value: payment}();
    }
