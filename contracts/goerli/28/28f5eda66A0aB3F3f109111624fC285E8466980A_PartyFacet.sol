...
contract PartyFacet is Modifiers, IPartyFacet, IERC20 {
    ...
    ***************/
    ...
    // @inheritdoc IPartyOwnerActions
    function closeParty() external override onlyManager isAlive {
        s.closed = true;
        // Emit Close event
    ...
    // @inheritdoc IPartyOwnerActions
    function editPartyInfo(PartyInfo memory _partyInfo)
        external
        override
        onlyManager
    {
...
import {IPartyOwnerActions} from "./party/IPartyOwnerActions.sol";
...
interface IPartyOwnerActions {
     ...
     * @dev The user must be a manager and the party must be opened
     */
