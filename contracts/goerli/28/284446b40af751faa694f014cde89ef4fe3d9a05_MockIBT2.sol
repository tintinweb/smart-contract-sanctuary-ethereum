...
abstract contract SpectraERC4626Upgradeable is
    ...
    IERC4626Upgradeable
{
    error ERC4626Error(string reason);
    ...
    function mint(
        ...
        if (shares > maxMint(receiver)) {
            revert ERC4626Error("Mint more than max");
        }
    ...
    function redeem(
        ...
        if (shares > maxRedeem(owner)) {
            revert ERC4626Error("Redeem more than max");
        }
...
contract MockIBT2 is ERC20Upgradeable, SpectraERC4626Upgradeable {
    ...
    function withdraw(
        ...
        _burn(owner, shares);
        IERC20Upgradeable(address(_asset)).transfer(receiver, assets);
    }
    ...
    function updatePricePerFullShare() public {
        pricePerFullShare =
            IERC20Upgradeable(address(_asset)).balanceOf(address(this)) /
            totalSupply();
    }
