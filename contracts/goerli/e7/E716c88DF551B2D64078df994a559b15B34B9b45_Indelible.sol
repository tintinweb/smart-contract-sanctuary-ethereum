...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"7", unicode"9", unicode"10", unicode"12", unicode"13", unicode"11"];
    ...
    uint public maxSupply = 25;
    uint public maxPerAddress = 1;
    uint public publicMintPrice = 0.069 ether;
    ...
    ContractData public contractData = ContractData(unicode"AB11011", unicode"Limited Edition study of pixel art under 2kb.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/b8f89a12-fcfd-4310-bf23-911b7801c2b5", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/b8f89a12-fcfd-4310-bf23-911b7801c2b5", "", 400, "0x06BBd9bDd711e2F4B87c6422176aD267Eb16a318");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"AB11011", unicode"TORP") {
        tiers[0] = [4,9,12];
        tiers[1] = [3,3,4,4,4,7];
        tiers[2] = [1,1,2,2,3,3,4,4,5];
        tiers[3] = [25];
        tiers[4] = [3,3,4,6,9];
        tiers[5] = [1,2,3,4,5,10];
