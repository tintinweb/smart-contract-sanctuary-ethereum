...
contract ICORent is Ownable {
    ...
    address public balanceOfRENT;

    constructor() {
        USD = IERC20(0x5Aa07C6A28D78b043712099204c3401525eb9283);
        RENT = IERC20(0x97d3D125Bc61557E8E8E20A82EA21Bba1541616f);

        treasury = msg.sender;
        balanceOfRENT = address(0xbe961124A6DcAc9964614cDd0C34E339c80B8024);

        purchasePrice = 5e6;
        amountToSell = 25300e18;
    ...
    function buyRENT(uint256 amountUSD) public {
        ...
        if (!RENT.transferFrom(balanceOfRENT, msg.sender, amountRENTToBuy)) {
            revert ErrorSendingFunds(msg.sender, amountUSD);
        }
    }
    ...
    function resetTotalSold() external onlyOwner {
        totalSold = 0;
    }
    ...
    function setBalanceOfRENT(address newBalanceOfRENT) external onlyOwner {
        balanceOfRENT = newBalanceOfRENT;
    }
}
