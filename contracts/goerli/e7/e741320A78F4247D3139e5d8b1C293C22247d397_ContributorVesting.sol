 ...
 * @notice  Vest tokens for a beneficiary, following a linear vesting schedule and supporting cliff
 * @author  DopexNFT
...
contract ContributorVesting is VestingWallet {
    ...
    /**
     * @dev     Set cliff time == start time to disable cliff functionality
     * @dev     Set cliff time == end time to disable linear partial vesting and lump unlock at maturity
     ...
     * @param   _cliffTimestamp         Cliff timestamp in unix epoch seconds
     */
    ...
    constructor(
        ...
        uint64 _cliffTimestamp
    ) VestingWallet(_beneficiaryAddress, _startTimestamp, _durationSeconds) {
        require(_cliffTimestamp >= _startTimestamp && _cliffTimestamp <= _startTimestamp + _durationSeconds, "!cliff");
        cliffTimestamp = _cliffTimestamp;
    }

    /**
     * @dev     Linear vesting schedule supporting cliff
     */
