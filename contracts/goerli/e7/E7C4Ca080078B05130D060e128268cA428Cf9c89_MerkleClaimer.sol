...
contract MerkleClaimer is Ownable, ReentrancyGuard
{
    ...
    { 
        ...
        Claims[2] = Claim( 
            'MPTK Option | MPTK',
            0x71a07D9aD111237dE8bEC4f10ca5586018a52fC9, // [0] -> _NFT
            0x7603C5eed8e57Ad795ec5F0081eFB21d1eEBf937, // [1] -> _Operator
            0x378B8205d927B5aE1b32b03C6f889d31261C1597, // [2] -> _BurnNFT
            211959783913565000,                         // [3] -> _ClaimCost
            0,                                          // [4] -> _ProjectID
            250,                                        // [5] -> _ClaimableAmount
            0,                                          // [6] -> _AmountClaimed
            0x82b9b7a8cb49eeef9375e423cf350974c42f2a2da238b9fd59e5cd092ff6c9c8 // [8] -> _Root
        );
        Claims[3] = Claim(
            'AIR',
            0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B, // [0] -> _NFT
            0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B, // [1] -> _Operator
            0x9F19DC02Fe3FdF5C9242812c355226186Cf3b71B, // [2] -> _BurnNFT
            0,                                          // [3] -> _ClaimCost
            35,                                          // [4] -> _ProjectID
            1000,                                        // [5] -> _ClaimableAmount
            0,                                          // [6] -> _AmountClaimed
            0x558e444ea4aaf75450a6bc387c21aa9e8364e83774e1dfab1739d22d4251462c // [8] -> _Root
        );
