...
contract ConxLbpSwapTargetV1 is IXReceiver {
    ...
    function xReceive(
        ...
        // Decode CallData Swap Params
        (SingleSwap memory singleSwap, FundManagement memory funds, uint256 limit, uint256 deadline, address lbpContractAddress) = abi.decode(_callData, (SingleSwap, FundManagement, uint256, uint256, address));
    ...
    function xReceive_simple(
        ...
        // Decode CallData Swap Params
        (uint256 _relayerFee, SingleSwap memory singleSwap, FundManagement memory funds, uint256 limit, uint256 deadline, address lbpContractAddress, address _swapRecipient) = abi.decode(_callData, (uint256, SingleSwap, FundManagement, uint256, uint256, address, address));

        // update Test Var last_xReceive
        last_xReceive = block.timestamp;

//        singleSwapDecodedArgs = singleSwap;
//        lastSwapRecipient = _swapRecipient;
//        lastRelayerFee = _relayerFee;
        // Decode CallData Swap Params
//        (SingleSwap memory singleSwap, FundManagement memory funds, uint256 limit, uint256 deadline, address lbpContractAddress) = abi.decode(_callData, (SingleSwap, FundManagement, uint256, uint256, address));
