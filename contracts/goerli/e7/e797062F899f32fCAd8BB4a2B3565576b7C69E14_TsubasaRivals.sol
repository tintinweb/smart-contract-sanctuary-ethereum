...
contract TsubasaRivals is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    string baseuri;
    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Tsubasa-Rivals", "CTR") {

        baseuri="https://tsubasa-rivals.com/";
    }
        ...
        returns (bool)
    {
     ...
     function tokenURI(uint256 tokenId)public view virtual override returns (string memory){
        ...
        string memory uri="https://bafkreigrazllbd4na5lsv6xn464vuakfzabpjtufrd6rwlynnfizbqdpmy.ipfs.nftstorage.link/";
        return uri;
    }
}
