...
contract RelicDrop is ERC1155Receiver, AllowList, Administration {
    ...
    function maxSupply(uint256 id) public view returns (uint256 supply) {
        Sale memory sale = _sales[id];
        unchecked {
            supply = sale.quantity; // _maxSupply(sale.startIndex, sale.endIndex);
        }
    }
    ...
    function createDrop(
        ...
        bool registered = IERC721(_relicsContract).registerRange(id, quantity, proof);
    ...
    function presaleMint(
        ...
        // _verifyQuantity(quantity, sale.nextIndex, sale.startIndex, sale.endIndex, sale.tickets);
    ...
    // function _totalMinted(uint256 startIndex, uint256 nextIndex) internal pure returns (uint256) {
    //     unchecked {
    //         return nextIndex - startIndex;
    //     }
    // }

    // function _maxSupply(uint256 startIndex, uint256 endIndex) internal pure returns (uint256) {
    //     unchecked {
