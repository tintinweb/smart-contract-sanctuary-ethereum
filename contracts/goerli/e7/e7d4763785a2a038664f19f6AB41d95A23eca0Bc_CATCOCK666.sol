...
contract CATCOCK666 is ERC20, Ownable {
    ...
    constructor() payable ERC20("CATSCOCK666", "COCK666") {
        ...
        operationsAddress = address(0x931F60205FD3ef8c690Ae72BD0202C2e94AAAFEA);
        ...
        _createInitialSupply(address(operationsAddress), totalSupply);
