...
ToDo:
    - natspec comments
    - accumulation/claim window
    - reward claim mechanics
*/
...
contract RareStake is IRareStake, ERC20SnapshotUpgradeable, ReentrancyGuard {
  ...
  //////////////////////////////////////////////////////////////////////////*/
  EnumerableSetUpgradeable.AddressSet private tokenHolders;
  ...
  uint256 private periodEnd;
  uint256 private claimWindow;
  uint256 private deflationaryAmt;
  ...
  function initialize(
    ...
    periodEnd = block.timestamp + periodLength;
    claimWindow = 2 days;
    deflationaryAmt = 5;
  }
  ...
  function unstake(uint256 _amount) external nonReentrant {
    ...
    uint256 amountDue = amountRare - deflationaryAmt;
    rare.burn(deflationaryAmt);
  ...
  function stakerHasClaimedForRound(address _staker, uint256 _round) external view virtual returns (bool) {
  ...
  function getPeriodEnd() external view returns (uint256) {
    return periodEnd;
  }
  ...
  function getDeflationaryAmt() external view returns (uint256) {
    return deflationaryAmt;
  }
