    ...
    PaymentSplitter
{
    ...
    uint256 public presalePrice = 0.08 ether; //0.08 WL
    uint256 public publicPrice = 0.1 ether; //0.10 public sa

    uint256 public presaleStartTime = 1; // TODO: set it //1667210400
    uint256 public publicStartTime = 9999999999999999999999; // TODO: set it //1667383200
    ...
    {        
        _setDefaultRoyalty(
            0xE7a697036a3E9b229Fc70d837F0C95daeef8e3c4,
            100
        );
    }
