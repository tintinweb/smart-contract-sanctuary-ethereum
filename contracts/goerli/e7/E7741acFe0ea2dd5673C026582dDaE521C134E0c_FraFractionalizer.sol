...
contract FraFractionsImpl is ERC721Holder, ERC20, ReentrancyGuard
{
    ...
    function initialize(address _from, address _target, uint256 _tokenId, string memory _name, string memory _symbol, uint256 _fractionsCount, uint256 _fractionPrice) 
    external {
...
contract FraFractionalizer is ReentrancyGuard {
    function fractionalize(
        ...
        FraFractionsImpl(_fractions).initialize(_from, _target, _tokenId, _name, _symbol, _fractionsCount, _fractionPrice);
