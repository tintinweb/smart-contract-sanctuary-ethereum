...
contract NftMarketplace is ReentrancyGuard {
    ...
    event ItemCanceled(address indexed seller, address nftAddress, uint256 indexed tokenId);
    ...
    function withdrawProceeds() external {
        ...
        if (proceeds <= 0) {
            revert NftMarketplace__NoProceed();
        }
...
//5. `withdrawProceeds` : Withdraw payment fro my sold NFTs