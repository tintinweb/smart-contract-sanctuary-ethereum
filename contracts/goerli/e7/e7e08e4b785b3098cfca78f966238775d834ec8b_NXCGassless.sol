...
contract NXCGassless is ERC2771Recipient, ERC721A, Ownable {
  string private baseURI = "";

  uint256 public constant maxSupply = 100;
  uint256 public constant mintQuantity = 1;

  constructor() ERC721A("12873481", "891238812") {
    _mint(msg.sender, 1);
    _setTrustedForwarder(0x7A95fA73250dc53556d264522150A940d4C50238); //Goerli
  }

  function mint() public {
    _mint(_msgSender(), mintQuantity);
  }
