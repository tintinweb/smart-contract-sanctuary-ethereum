...
contract FINOMEN is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("FINOMEN", "FLA") {
    setHiddenMetadataUri("ipfs://QmYTZpjKquLikPzwGSQFvFXJ9fWwhJ5XUvvpZwzP8mg5o8/hidden.json");
  }
