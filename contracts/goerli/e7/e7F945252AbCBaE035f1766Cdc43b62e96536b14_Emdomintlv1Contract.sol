...
//                                                                                                                                       
//                                                                                                                                       
// __________ ___       ___________      ____    ___       ___      ____  ___      ___ __________       MMM       ____                      
// `MMMMMMMMM `MMb     dMM'`MMMMMMMb.   6MMMMb   `MMb     dMM'      `MM'  `MM\     `M' MMMMMMMMMM       NNN       `MM'                      
//  MM      \  MMM.   ,PMM  MM    `Mb  8P    Y8   MMM.   ,PMM        MM    MMM\     M  /   MM   \        M         MM                       
//  MM         M`Mb   d'MM  MM     MM 6M      Mb  M`Mb   d'MM        MM    M\MM\    M      MM           /          MM                       
//  MM    ,    M YM. ,P MM  MM     MM MM      MM  M YM. ,P MM        MM    M \MM\   M      MM                      MM                       
//  MMMMMMM    M `Mb d' MM  MM     MM MM      MM  M `Mb d' MM        MM    M  \MM\  M      MM                      MM                       
//  MM    `    M  YM.P  MM  MM     MM MM      MM  M  YM.P  MM        MM    M   \MM\ M      MM                      MM                       
//  MM         M  `Mb'  MM  MM     MM MM      MM  M  `Mb'  MM        MM    M    \MM\M      MM                      MM                       
//  MM         M   YP   MM  MM     MM YM      M9  M   YP   MM        MM    M     \MMM      MM                      MM                       
//  MM      /  M   `'   MM  MM    .M9  8b    d8   M   `'   MM        MM    M      \MM      MM                      MM    /                  
// _MMMMMMMMM _M_      _MM__MMMMMMM9'   YMMMM9   _M_      _MM_      _MM_  _M_      \M     _MM_                    _MMMMMMM                  
//                                                                                                                                       
//                                                                                                                                       
//                                                                                                                                       
//                                                                                                                                       
//                                                                                                                                       
// ____              ___ __________ ________                  ________   ________       ____         ______________    ____   __________ 
// `Mb(      db      )d' `MMMMMMMMM `MMMMMMMb.                `MMMMMMMb. `MMMMMMMb.    6MMMMb        `MM'`MMMMMMMMM   6MMMMb/ MMMMMMMMMM 
//  YM.     ,PM.     ,P   MM      \  MM    `Mb                 MM    `Mb  MM    `Mb   8P    Y8        MM  MM      \  8P    YM /   MM   \ 
//  `Mb     d'Mb     d'   MM         MM     MM   ____          MM     MM  MM     MM  6M      Mb       MM  MM        6M      Y     MM     
//   YM.   ,P YM.   ,P    MM    ,    MM    .M9  6MMMMb         MM     MM  MM     MM  MM      MM       MM  MM    ,   MM            MM     
//   `Mb   d' `Mb   d'    MMMMMMM    MMMMMMM(  MM'  `Mb        MM    .M9  MM    .M9  MM      MM       MM  MMMMMMM   MM            MM     
//    YM. ,P   YM. ,P     MM    `    MM    `Mb       MM        MMMMMMM9'  MMMMMMM9'  MM      MM       MM  MM    `   MM            MM     
//    `Mb d'   `Mb d'     MM         MM     MM      .M9        MM         MM  \M\    MM      MM       MM  MM        MM            MM     
//     YM,P     YM,P      MM         MM     MM   MMMM          MM         MM   \M\   YM      M9 (8)   MM  MM        YM      6     MM     
//     `MM'     `MM'      MM      /  MM    .M9      `Mb        MM         MM    \M\   8b    d8  ((   ,M9  MM      /  8b    d9     MM     
//      YP       YP      _MMMMMMMMM _MMMMMMM9'       MM       _MM_       _MM_    \M\_  YMMMM9    YMMMM9  _MMMMMMMMM   YMMMM9     _MM_    
//                                                   MM                                                                                  
//                                             MM.  ,M9                                                                                  
//                                              YMMMM9       
//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x83f1C8ECec2a5c5d6a0eB2339522Fdb24A057Db4,0x274827F9F1726CC53c242F40EDb3f4920d576E71];
  address public erc20Payable = 0x83f1C8ECec2a5c5d6a0eB2339522Fdb24A057Db4;
  uint256[] public payableFees = [70,30];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public EARLY_MINT_PRICE = 0.066 ether;
  uint256 public earlyMintTokenIdCap = 360;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 1234) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihzu7uj5klk3j7n4ur7qzk7n6s6mgdmdazgsp5albqghavqxibnoq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Kak9DQ5asTQOLoWIrk1D/contract-metadata";
  }
...
// File: contracts/Emdomintlv1Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Emdomintlv1Contract is RamppERC721A {
    constructor() RamppERC721A("EMDOM INTL V1", "EL1"){}
}
