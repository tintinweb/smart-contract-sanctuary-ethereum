...
_transferOwnership(0x33D7c2B607e7409ba0c69b9ba009e9452cA9F80F);
}
...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0x33D7c2B607e7409ba0c69b9ba009e9452cA9F80F;
...
address[] public payableAddresses = [RAMPPADDRESS,0x33D7c2B607e7409ba0c69b9ba009e9452cA9F80F];
...
string public _baseTokenURI = "ipfs://QmdPZJac1xxLQEkUoTCwZ76TLyNsSeQnNhLopEwQgQwstY/";
string public _contractURI = "ipfs://QmcnSPv2EnBeGh6i73bDvxnmF2zxbPvxkJRJze3tRkguEX";
...
contract INVADER is RamppERC721A {
constructor() RamppERC721A("spaceinvader_test", "INV"){}
