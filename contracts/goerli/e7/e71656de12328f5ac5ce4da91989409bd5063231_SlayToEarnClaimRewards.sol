...
contract SlayToEarnClaimRewards is Ownable {
    ...
    function getAffiliateLink() public view returns (string memory) {
    ...
    function getLinkOrigin() public view returns (address) {
        return getLinkOriginForPlayer(msg.sender);
    }
    ...
    function _rewardLinkOrigin(
        ...
        address linkOrigin = getLinkOrigin();
