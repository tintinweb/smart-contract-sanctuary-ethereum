...
contract Card is ERC721URIStorage {
    ...
    function getAbbrAddress(address addr) public view returns (string memory) {
        ...
        bytes memory str = new bytes(12);
        str[0] = "0";
        str[1] = "x";
        uint256 data = uint256(uint160(addr));
        str[2] = alphabet[
            (data & uint160(0x00_f000_000000000000000000000000000000000000)) >>
                156
        ];
        str[3] = alphabet[
            (data & uint160(0x00_0f00_000000000000000000000000000000000000)) >>
                152
        ];
        str[4] = alphabet[
            (data & uint160(0x00_00f0_000000000000000000000000000000000000)) >>
                148
        ];
        str[5] = alphabet[
            (data & uint160(0x00_000f_000000000000000000000000000000000000)) >>
                144
        ];
        str[6] = ".";
        str[7] = ".";
        str[8] = ".";
        str[9] = alphabet[
            (data & uint160(0x00_000000000000000000000000000000000000_f000)) >>
                12
        ];
        str[10] = alphabet[
            (data & uint160(0x00_000000000000000000000000000000000000_0f00)) >>
                8
        ];
        str[11] = alphabet[
            (data & uint160(0x00_000000000000000000000000000000000000_00f0)) >>
                4
        ];
        str[12] = alphabet[
            data & uint160(0x00_000000000000000000000000000000000000_000f)
        ];
        return string(str);
    }
    ...
    function checkName(string memory name) public view returns (bool) {
        ...
        if (data[0] == MIN || data[data.length - 1] == MIN) {
    ...
    bytes1 constant MIN = bytes1(" ");
    bytes1 constant MAX = bytes1("`");
    bytes1 constant QUOTE = bytes1('"');
    bytes1 constant LT = bytes1("<");
    bytes1 constant GT = bytes1(">");
}