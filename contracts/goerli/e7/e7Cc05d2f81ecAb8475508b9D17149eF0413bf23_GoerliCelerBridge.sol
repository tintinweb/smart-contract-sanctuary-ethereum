...
contract GoerliCelerBridge {
    ...
    event goerli_fantom_testnet_bridge(address indexed originalAddress, address indexed contract_address, uint256 value);
    ...
    function goerliToFantomTestnetBridge(
        ...
        emit goerli_fantom_testnet_bridge(originalAddress, address(this), msg.value);
    }
...
event sendMessageWithLiquidityBridgeTransferEvent(address _messageBus, uint256 _fee, uint256 _value);
    /**
    ...
    function sendMessageWithLiquidityBridgeTransfer(
        ...
        emit sendMessageWithLiquidityBridgeTransferEvent(_messageBus, _fee, msg.value);
        return "123";
