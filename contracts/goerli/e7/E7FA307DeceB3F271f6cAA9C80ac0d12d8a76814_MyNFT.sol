...
contract MyNFT is PriceConsumerV3, ERC721, ERC721Enumerable, Pausable, Ownable {
...
//pause minting vs unpause it
    ...
    // Set WL Price
    function setWLPrice(uint _WLPrice) external onlyOwner {
        WLPrice = _WLPrice;
    }
    ...
    function allowListMint() public payable {
        ...
        uint PaidAmount = getPriceRate(WLPrice);
        require(msg.value >= PaidAmount * 1 ether, "Not Enough Funds");
    ...
    function publicMint() public payable {
        ...
        uint PaidAmount = getPriceRate(PreSalePrice);
        require(msg.value >= PaidAmount * 1 ether, "Not Enough Funds");
    ...
    function internalMint() internal {
        ...
        //get the current new minting token ID
        _tokenIdCounter.increment();
        //using msg.sender as the minting address
...
//ERC721Enumerable used to track how many NFTs are minted so far
...
contract PriceConsumerV3 {
    ...
    function getPriceRate(uint _amount) internal view returns (uint) {
