...
// File: Blockies1155.sol

pragma solidity ^0.8.4;

contract Blockies1155 is ERC1155, Ownable {
    constructor() ERC1155("https://blockie.tk/{id}") {}

    string public name = "Blockies 1155";
    ...
    function faucet(uint256 amount) public {
        ...
        uint256 _tokenId = ++tokenSupply;
        _mint(_target, _tokenId, amount, "");
    }
}