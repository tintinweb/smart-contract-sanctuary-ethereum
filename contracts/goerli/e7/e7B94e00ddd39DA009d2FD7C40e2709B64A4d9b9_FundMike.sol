...
// File: contracts/FundMeStuff/LibPriceConversion.sol
...
library LibPriceConversion
{
    ...
    function GetPrice() internal view returns (uint256)
    {
        ...
        AggregatorV3Interface priceAggregator = AggregatorV3Interface(0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e);
...
// File: contracts/FundMeStuff/FundMike.sol
...
contract FundMike
{
    ...
    address public constant mikeAddress = 0x7e666adEFA7cb2645F8dff81D2fc214aa96DAE29;
    ...
    function Fund() public payable
    {
        ...
        require(msg.value.GetConversionRate() >= minimumUSDAmount, "The amount you want to donate os lower than minimum donate amount.");
