...
contract Lotto is ERC721, VRFConsumerBaseV2 {
    ...
    constructor(
        ...
        uint256 _intervalVal,
        address _vrfCoordinator
    ) ERC721("LOTTO", "LOT") VRFConsumerBaseV2(_vrfCoordinator) {
        ...
        override
    {
        ...
        uint256 winningAdr = uint256(w2 % accountInfo.length);

        _safeMint(accountInfo[winningAdr], tokenId);
    ...
    function register() external payable {
        require(msg.value == 0.01 ether, "insufficient deposit");
        require(
