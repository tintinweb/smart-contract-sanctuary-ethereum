...
contract SV is ERC721A, Ownable, ReentrancyGuard {
    ...
    function checkSVPBalance(address user) external view returns (uint256) {
        return
            IERC721Enumerable(0x298B4C9B0Bb64dbF8475d59b4243952A002f15B5)
                .balanceOf(user);
    }

    function airDrop(bytes32[] calldata _merkleProof) public {
        uint256 SVPBalance = IERC721Enumerable(
            0x298B4C9B0Bb64dbF8475d59b4243952A002f15B5
        ...
        require(SVPBalance > 0, "balance must be greater then zero");
        if (!airDropSaleClaimedChecker[msg.sender]) {
            airDropSaleClaimedChecker[msg.sender] = true;
            airDropSaleClaimed[msg.sender] = SVPBalance;
        }
        require(
        ...
        airDropSaleClaimed[msg.sender] =
            airDropSaleClaimed[msg.sender] -
            SVPBalance;
        _safeMint(msg.sender, SVPBalance);
    }
