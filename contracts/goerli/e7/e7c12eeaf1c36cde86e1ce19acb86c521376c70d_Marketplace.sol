...
contract Marketplace is ReentrancyGuard {
    ...
    function createOrder(IERC721 _nft, uint256 _tokenId, uint256 _price, uint256 endTimeStamp) external nonReentrant {
        require(endTimeStamp > block.timestamp, "Item is not on sale");
