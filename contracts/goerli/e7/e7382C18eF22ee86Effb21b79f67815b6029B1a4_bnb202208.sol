...
contract bnb202208 is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("bnb202208", "BNB2") {
  ...
  {
    return (address(this), (salePrice * 900) / 10000);
  }
