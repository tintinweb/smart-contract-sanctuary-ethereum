...
contract DarkSide is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint256;

    string public baseTokenURI =
        "ipfs://QmUmva5FMGrqjrX2cjrE52X3zsVbptDvRBMpAxW8rq2Nnn/";
    ...
    constructor() ERC721A("DarkSide", "DS") {}
    ...
    function mint(uint256 numberOfTokens) external payable {
        ...
        if (
            totalSupply() + numberOfTokens > TOTAL_FREE_MINTS ||
    ...
    function treasuryMint(uint256 quantity, address user) public onlyOwner {
