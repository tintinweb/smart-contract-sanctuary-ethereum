...
// hevm: flattened sources of lib/guards/src/AuctionGuard.sol
...
////// lib/fiat/src/auctions/PriceCalculator.sol
// Copyright (C) 2020 Maker Ecosystem Growth Holdings, INC.
/* pragma solidity ^0.8.4; */
...
contract Delayed {
    ...
    function execute(
        ...
        bool ok;
        (ok, out) = target.call(data); // delegatecall?
...
////// lib/guards/src/AuctionGuard.sol
/* pragma solidity >=0.8.4; */
