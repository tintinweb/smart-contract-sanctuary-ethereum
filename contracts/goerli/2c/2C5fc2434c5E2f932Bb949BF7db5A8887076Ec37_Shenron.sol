...
contract Shenron is ERC20, Ownable {
    ...
    constructor() ERC20("Shenron", "SHENT") {
    	...
    	marketingWallet = address(0x3A23ACf34007De8F3f234d7e465722481508B6c9); // set as marketing wallet
    	devWallet = address(0xc33191a0A2596813D01842A43c4fb781Ff793c08); // set as buyback wallet
