...
contract QWERASD is
    ...
    constructor() ERC721A("HGDDDF World", "QWER") {
        ...
        _safeMint(TREASURY_ADDRESS_1,5);
        _safeMint(TREASURY_ADDRESS_2,4);
        _safeMint(TREASURY_ADDRESS_3,15);
        _safeMint(TREASURY_ADDRESS_4,1);
    }
