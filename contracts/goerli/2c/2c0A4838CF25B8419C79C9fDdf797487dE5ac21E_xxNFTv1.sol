...
contract xxNFTv1 is ERC721Upgradeable, AccessControlUpgradeable, PausableUpgradeable, UUPSUpgradeable {
  ...
  /** Mints tokens. */
  function mint(uint256 count) external onlyRole(DEFAULT_ADMIN_ROLE){
...
//  }
    ...
    function setBaseURI(string memory newuri) public onlyRole(DEFAULT_ADMIN_ROLE) {
      _baseTokenURI = string(abi.encodePacked(newuri,"test new contract!"));
    }
