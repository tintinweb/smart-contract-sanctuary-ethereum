...
// below, main contract and basic funtion  
...
contract Lottery is VRFConsumerBase, Ownable {
    ...
    // enum state: open 0, closed 1, calc...2
    ...
    function getEntranceFee() public view returns (uint256) {
        ...
        uint256 costToEnter = (usdEntryFree * 10**18) / adjustPrice;
        return costToEnter;
    ...
    function endLottery() public onlyOwner {
        // this is a rogue way to get a random number
        // uint256(
        //     keccak256(
        //         abi.encodePacked(
        //             nonce,
