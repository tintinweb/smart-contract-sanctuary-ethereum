...
contract MergeNFT is ERC721, Ownable {
        ...
        returns (string memory)
    {
        ...
        string memory temp = string(Base64.encode(bytes(string.concat(
            '<object ',
                                'data="data:image/svg+xml;base64,"',
                                ' type="image/svg+xml"> <img',
                                ' src="https://bafybeicxgp4cf5k6alt6awd3tusi6jerp6gam5377ghtygvgwv5iw657ky.ipfs.nftstorage.link/place2.webp">',
                                '</object>'
        ))));
