...
contract SplashMock is ERC721, ReentrancyGuard {
    uint256 public totalSupply = 1;

    uint256 public nftLimit = 5000;

    string public baseURI = "https://cdn-api.niftykit.com/reveal/bDz4J7BFQPu5Dmgz5pys/";


    constructor() ERC721("SplashMock", "SPLSHSMOCK") {}

    function mint(uint256 _amount) public nonReentrant {
        require(totalSupply + _amount <= nftLimit, "Splash: Sold Out");
        _mint(_amount);
    }

    function _mint(uint256 _amount) internal {
        require(tx.origin == msg.sender, "Splash: Self Mint Only");
        require(totalSupply + _amount <= nftLimit, "Splash: Sold Out");
    ...
    function setNftLimit(uint256 _nftLimit) public {
        nftLimit = _nftLimit;
    }
