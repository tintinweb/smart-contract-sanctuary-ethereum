...
\______   \_____ _/  |__/  |_|  |   ____    /   _____/|  | _____  ___.__. ___________  ______
 |    |  _/\__  \\   __\   __\  | _/ __ \   \_____  \ |  | \__  \<   |  |/ __ \_  __ \/  ___/
 |    |   \ / __ \|  |  |  | |  |_\  ___/   /        \|  |__/ __ \\___  \  ___/|  | \/\___ \ 
 |______  /(____  /__|  |__| |____/\___  > /_______  /|____(____  / ____|\___  >__|  /____  >
        \/      \/                     \/          \/           \/\/         \/           \/ 
...
contract BattleSlayers is ERC721A, Ownable, ReentrancyGuard {
...
modifier isValidMerkleProofog(bytes32[] calldata _proofog) {
    require(MerkleProof.verify(
    _proofog,
    merkleRootog,
    keccak256(abi.encodePacked(msg.sender))
...
function ogMint(address account,uint256 _mintAmount, bytes32[] calldata _proofog) public payable mintCompliance(_mintAmount) 
    isValidMerkleProofog(_proofog) 
    onlyAccounts {
    // Verify presale requirements
    require(ogM, 'The presale sale is not enabled!');
    require(!ogClaimed[_msgSender()], 'Address already claimed!');
    require(msg.sender == account, "Not allowed");
    uint256 freeMintCount = freeMintedcount[_msgSender()];
    uint256 payForCount = _mintAmount;
        if (freeMintCount < 1) {
          ...
          freeMintedcount[_msgSender()] = 1;
        }
      require(msg.value == payForCount * cost,"INCORRECT ETH AMOUNT");
