...
/**
 * @title ERC721A token for NFTs
 * 
 * @dev NFTs redeemable through burning NFTs, a minimum of 7 total are needed 6 will be burned 1 will be upgraded.
 * 
 * @author Author:
 */

contract TannerTestContractTestv3 is ERC721AQueryable, AccessControl {
    
    bytes32 constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
    uint256 public keys = 35;
    ...
    /**
     * @notice Called by contract admin to set a new base URI for NFTs
     */
    ...
    /**
     * @notice Called by contract admin to set a new gold base URI for NFTs
     */
    ...
    function mint() external payable {
        ...
        require(totalKeys + max_key <= keys);
    ...
    /**
     * @notice Admin function to mint NFTs to a specified address
     */
    function mintTo(
    ...
    /**
     * @notice For upgrading a ECHO KEY to gold tier
     * @dev User must own at least 7 NFTs to call this
     * @dev 7 NFTs 6 will be burned 1 primary key will be upgraded
     * @param _primaryTokenId Token ID of KEY to upgrade
     * @param _tokenIds Array of NFTs token IDs to burn as part of the upgrade
     */
    function upgrade(
