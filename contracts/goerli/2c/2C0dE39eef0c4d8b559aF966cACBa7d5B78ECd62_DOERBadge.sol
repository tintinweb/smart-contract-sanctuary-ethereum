...
contract DOERBadge is ERC721, Ownable, ERC721Enumerable {
     ...
     */
    function batchMintByOwner(address[] memory to) external onlyOwner
    {
        uint256 i;
    ...
    /**
     * @notice All tokens have the same badge
     */
