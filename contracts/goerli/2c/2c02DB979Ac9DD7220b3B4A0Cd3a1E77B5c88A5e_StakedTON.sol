...
interface IStakedTON {
    ...
    /**
     * @notice Revert reason for minting without validator role
     */
    error InvalidSigner();
     ...
     * @param signature Signed encoded to+amountUnderlying+nonce
     */
    function mint(
        address to,
    ...
    IStakedTON
{
    ...
    function _validateSignature(
        ...
        if (!hasRole(VALIDATOR_ROLE, signer)) revert InvalidSigner();
    }
