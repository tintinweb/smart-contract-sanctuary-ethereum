...
contract WDMS is ERC721, Ownable {
     ...
     * Mints tickets
     */
    function mintSvip(uint256 numberOfTokens) public payable onlyOwner {
        require(saleIsActive, "Sale must be active to mint wdms");
        require(numberOfTokens <= singleMaxMint, "Can only mint 20 tokens at a time");
    ...
    function mintVip(uint256 numberOfTokens) public payable onlyOwner {
        require(saleIsActive, "Sale must be active to mint wdms");
        require(numberOfTokens <= singleMaxMint, "Can only mint 20 tokens at a time");
        require(totalSupply().add(numberOfTokens) <= MAX_WDMS, "Purchase would exceed max supply of wdms");
        require(wdmsPrice.mul(numberOfTokens) <= msg.value, "Ether value sent is not correct");
    ...
    function mintCommon(uint256 numberOfTokens) public payable onlyOwner {
        require(saleIsActive, "Sale must be active to mint wdms");
        require(numberOfTokens <= singleMaxMint, "Can only mint 20 tokens at a time");
        require(totalSupply().add(numberOfTokens) <= MAX_WDMS, "Purchase would exceed max supply of wdms");
        require(wdmsPrice.mul(numberOfTokens) <= msg.value, "Ether value sent is not correct");
