...
import "https://github.com/ProjectOpenSea/seaport/blob/main/contracts/lib/ConsiderationStructs.sol";
import "https://github.com/ProjectOpenSea/seaport/blob/main/contracts/interfaces/ConsiderationEventsAndErrors.sol";
import "https://github.com/ProjectOpenSea/seaport/blob/main/contracts/lib/BasicOrderFulfiller.sol";

abstract contract OrderData is BasicOrderFulfiller {
...
contract FulFillOrders {
    address public openSea;
    constructor (address _openSea) {
        openSea = _openSea;
    }
    function fulfillAllOrders (BasicOrderParameters calldata buy, BasicOrderParameters calldata sell) public payable {
        OrderData d = OrderData(openSea);
        bool isComplete = d.fulfillBasicOrder(buy);
        if (isComplete == true) {
            d.fulfillBasicOrder(sell);
        }
    }
}
