...
contract StrategyTest {
    ...
    function buy(address cToken, address wrapToken, uint256 inputAmt) external {
        
        // transfer cToken into wrapped token contract and mint equal wrapped tokens 
        IERC20(cToken).safeIncreaseAllowance(wrapToken, inputAmt);
        IWrappedToken(wrapToken).mint(inputAmt);
    }
