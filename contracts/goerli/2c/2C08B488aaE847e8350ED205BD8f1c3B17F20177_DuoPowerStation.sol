  ...
  Pool[] public pools; // Staking pools
    ...
    function stakerJoinPool(uint256 _pid, uint256 shares, string memory payby) public override {
        ...
        if (keccak256(abi.encodePacked(payby)) == keccak256(abi.encodePacked("USDT"))){
            ...
            require(usdt.transferFrom(msg.sender,devAddr, (poolUSDT.poolInfoVars[4] + (poolUSDT.timing[2]-poolUSDT.timing[1])/30 days * 
            ...
            //IDC
            require(usdt.transferFrom(msg.sender, devAddr, (poolUSDT.timing[2]-poolUSDT.timing[1])/30 days * 
    ...
    function getStakerInfoNTime(uint256 _pid, address stakerAddr) public override view returns(uint256[6] memory){
        ...
        uint256[6] memory data = [stakerUSDT.shares,stakerRGP.shares,pricePerShare,rgpTosShare,startTime,endTime];
        return(data);
    }
