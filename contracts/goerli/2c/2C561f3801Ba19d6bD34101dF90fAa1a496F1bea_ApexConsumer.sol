...
contract ApexConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function requestMetaData(address _oracle, bytes32 _jobId) public onlyOwner {
        Chainlink.Request memory req = buildChainlinkRequest(_jobId, address(this), this.fulfillMetaData.selector);
        req.add("sports", "formula1");
    ...
    function requestMatchup(
        ...
        Chainlink.Request memory req = buildChainlinkRequest(_jobId, address(this), this.fulfillMatchup.selector);
    ...
    function requestResults(
        ...
        Chainlink.Request memory req = buildChainlinkRequest(_jobId, address(this), this.fulfillResults.selector);
