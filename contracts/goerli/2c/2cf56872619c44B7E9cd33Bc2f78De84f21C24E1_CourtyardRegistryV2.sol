 ...
 * @title {CourtyardRegistryV2} is a registry that holds ERC721 tokens and implements special actions around these tokens.
 * 
 ...
 * 
 * 	Changelog from {CourtyardRegistry} to {CourtyardRegistryV2}:
 * 
 *  	* Support for royalty enforcement by extending {DefaultOperatorFiltererUpgradeable}.
 */
