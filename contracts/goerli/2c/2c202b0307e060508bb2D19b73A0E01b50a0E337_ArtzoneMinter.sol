...
contract ArtzoneMinter is ERC1155, BoringOwnable, AccessControl, ERC2981RoyaltiesPerToken {
    ...
    modifier validateBatchMint(uint256[] memory _tokens, uint256[] memory _quantities){
        ...
        for (uint256 i = 0; i < _tokens.length;){
            ...
            require(tokenIdQuantityCount[_tokens[i]] + _quantities[i] <= tokenIdMaxCount[_tokens[i]], "Invalid quantity specified.");
    ...
    function batchMintToken(uint256[] memory _tokens, uint256[] memory _quantities, address _receiver) external isMinter validateBatchMint(_tokens, _quantities){
        ...
        for(uint256 i = 0; i < length;){
            ...
            tokenIdQuantityCount[tokenId] += quantity;
