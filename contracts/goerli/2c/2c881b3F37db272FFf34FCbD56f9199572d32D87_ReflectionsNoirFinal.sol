...
// Reflections Noir by Rich Simmons - Testnet 1
...
contract ReflectionsNoirFinal is ERC721AQueryable, Ownable {
    using Strings for uint256;
    using MerkleProof for bytes32[];

    address payable immutable private bgaddress = payable(0x26bD46e3804DA5e0801C6c9AFB39F05696f1E943);
    ...
    function sendFunds(uint256 _totalMsgValue) internal {
        (bool s1,) = bgaddress.call{value: (_totalMsgValue * 10) / 100}("");
...
contract ERC721A is IERC721A {
    ...
    function _mint(address to, uint256 quantity) internal virtual {
        ...
        unchecked {
            ...
            _packedAddressData[to] += quantity * ((_BITPOS_NUMBER_MINTED << 1) | 1);
