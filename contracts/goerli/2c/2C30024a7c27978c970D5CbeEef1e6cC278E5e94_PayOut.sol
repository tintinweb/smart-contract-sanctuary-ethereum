...
contract PayOut {
    ...
    function pay() external payable {
        ...
        require(correctBets.length * payoutAmt <= address(this).balance, "Not enough funds in contract to pay out.");
        ...
        delete correctBets;
        console.log("Closest bets reset. Size: ", correctBets.length);
        changePrice();
        changePriceDecimal();
    }
}
