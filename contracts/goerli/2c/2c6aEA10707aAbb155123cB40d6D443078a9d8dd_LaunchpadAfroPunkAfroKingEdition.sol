 ...
 * @notice This contract handles minting AfroPunk: AfroKing Edition tokens.
 */
contract LaunchpadAfroPunkAfroKingEdition is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0x5478D62322328cb1FA565E8847eCcD5e3428480B;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeihkow7rgqedzqywyzsyrsy5vaf7uy4b2dbyfdvaku44v4rcdxq4oy/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 3333;
    uint96 public royaltyFee = 500;

    constructor() ERC721A("AfroPunk: AfroKing Edition", "AFRKNG") {
