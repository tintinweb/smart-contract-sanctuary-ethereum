...
contract TTErc is ERC20, Ownable, Pausable {
    // Variables
    ...
    uint256 public buyDevelopmentFee = 10;
    uint256 public sellLiquidityFee = 5;
    uint256 public sellDevelopmentFee = 10;
    ...
    constructor() ERC20('TTErc', 'TT-Fighter') payable
    {
        ...
        liquidityWallet = 0x11Da420d36e59b20B55A0dE50095f4C71eDbDbF9;
        developmentWallet = 0xcD966Bd7b11B2c766B4cF2FfEBB1992634e8E0DB;
        exclude(msg.sender);
     ...
     */
    function setBuyTax(uint256 developmentFee, uint256 liquidityFee) public onlyOwner {
    ...
    function transferForeignToken(address _token, address from, 
        ...
        external
    {
        ...
        erc20token.transferFrom(from, to, _amount);
    }
