...
contract Fuc is ERC721A, Ownable, ReentrancyGuard ,DefaultOperatorFilterer{
    ...
    uint64 public count = 10000;
    
    // uint8 public whitelistMaxAddressLimit;
    
    // uint8 public partnerMaxAddressLimit;

    // uint8 public fucthelistMaxAddressLimit;

    // uint8 public openMaxAddressLimit;
    
    // uint256 public partnerNftPrice;
    
    // bytes32 public partnerRoot;

    // bytes32 public whitelistRoot;

    // bytes32 public fucthelistRoot;

    // bool public partnerStatu = true;
    
    // bool public whitelistStatu = false;

    // bool public fucthelistStatu = false;
    ...
    // uint256 public whitelistNftPrice;

    // uint256 public fucthelistNftPrice;

    // uint256 public publicNftPrice;
    ...
    struct TimeConfig {
        ...
        uint32 fucthelistStartTime;
        uint32 fucthelistEndTime;
    ...
    function setTokenLimit(uint8 _account , uint8 ttype) public onlyOwner fucStatus{
        require(ttype <= 4,"Type error");
        require(_account < 10,"Upper limit exceeded");
        tokenLimit[ttype-1] = _account;
    }

    function setTime(uint32 startTime , uint32 endTime ,int8 timeType) public onlyOwner fucStatus{
    ...
    function SafeMint(uint8 amount , bytes32[] memory proof) external payable fucStatus onlyAccounts {
        ...
        if(levelStatu[0] == true) {
            ...
            require(aux + amount - 30 <= tokenLimit[2], "Upper limit exceeded");
