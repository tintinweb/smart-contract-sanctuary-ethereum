...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
  ...
  function performUpkeep(bytes calldata /* performData */) external override {
    ...
    raffleState = Raffle__State
      .CALCULATING; /* As we request the random winner lottery state is set to "CALCULATING" so that no new player can enter the raffle */
  ...
  function fulfillRandomWords(
    ...
    lastTimestamp = block.timestamp;
    raffleState = Raffle__State
      .OPEN; /* After winner is picked up the lottery will be "OPEN" again for participation of the players */
