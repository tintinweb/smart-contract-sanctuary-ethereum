...
contract MvM is ERC721A, Ownable {
    ...
    mapping(string => bool) public mvmL1Addresses;
    mapping(string => bool) public mvmL2Addresses;
    mapping(string => bool) public mvmL3Addresses;
    ...
    function mint(
        ...
        require(_level < 5, "Level Not Within Range");
        if (_level == 1) {
            require(!pauseMintL1, "Minting for L1 is Paused");
            require(
                !mvmL1Addresses[_text],
