...
contract Bond {
    ...
    event BuyBond(address indexed participant);
    ...
    event ChangeBondToCoins(address indexed participant, uint userCoins);
    ...
    function requestReward() external {
        ...
        uint256 userCoins = (((block.timestamp -
    ...
    function changeBondsToCoins() external {
        ...
        emit ChangeBondToCoins(msg.sender, coins);
    }
    ...
    function getUserBonds(address participant) public view returns (uint16) {
