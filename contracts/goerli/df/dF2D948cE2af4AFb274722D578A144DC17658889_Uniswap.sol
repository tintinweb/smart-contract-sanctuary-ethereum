...
contract Uniswap {
    ...
    //Get the balance of a particular token (_tokenName) in a particular wallet (_address)
    function getBalance(string memory _tokenName, address _address) public view returns(uint) {
        return tokenInstanceMap[_tokenName].balanceOf(_address);
    }

    function getTokenName(string memory _tokenName) public view returns(string memory) {
    ...
    function swapEthToToken(string memory _tokenName) public payable returns(uint) {
    ...
    function swapTokenToEth(string memory _tokenName, uint _amount) public returns(uint) {
    ...
    function swapTokenToToken(string memory _srcTokenName, string memory _destTokenName, uint _amount) public {
    ...
    // get the eth balance stored in the contract
