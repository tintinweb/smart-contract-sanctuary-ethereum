...
// @@@@@@@@@@@@@@@@@@@@@&[email protected]@@@@@@@&PPPPP[email protected]@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
// @@@@@@@@@@@@@@@@@@@@@@&&&&&&Y?????B&&&@@@@@@@@@&&&PPPPP5J???777775&&&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@//
...
contract OCASnakeArt is Ownable, ReentrancyGuard {
        ...
        returns (string memory)
    {
        ...
        return Strings.toString(uint256(seed) % uint256(3));
    }

    function randomNumber(uint256 tokenId) public view returns (uint256) {
        uint256 seed = generateAppleSeed(tokenId, 0);
        return uint256(seed) % uint256(255);
    }
