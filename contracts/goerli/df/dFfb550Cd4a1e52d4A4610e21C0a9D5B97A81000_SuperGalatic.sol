...
import './RobotBody.sol';

/**
 * @notice SuperGalatic NFT Contract
 */
contract SuperGalatic is Initializable, ERC721EnumerableUpgradeable, ERC721HolderUpgradeable, RandomnessGenerator, RatingManager, RobotBody {
    
    mapping(uint256 => Robot) public superGalaticInfo;
...
//SPDX-License-Identifier: MIT
pragma solidity 0.8.7;
import '../base/Rare.sol';
contract RobotBody is Rare{
    struct BodyPart{
        Rarity rarity;
        Level level;
        uint256 health;
        ...
        uint256 energy;
        uint256 skillPower;
        uint256 skillDuration;
        uint256 skillRange;
        uint256 skillEfficiency;
    }
    struct Robot {
        BodyPart arm;
        BodyPart head;
