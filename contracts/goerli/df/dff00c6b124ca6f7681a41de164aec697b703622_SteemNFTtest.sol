...
contract SteemNFTtest is Ownable, ERC721A {
    ...
    uint256 public collabListMax = 3;
    uint256 public allowListMax = 3;
    uint256 public publicMintMax = 9;
    ...
    mapping(address => bool) public userMintedCollab;
    ...
    */
     ...
     function collabListMint(bytes32[] memory proof) external payable mintCompliance(1) {
        require(_verifyPublicAllowList(proof, merkleRootCollabList), "User not on Collab list");

        uint256 price = COLLAB_LIST_PRICE;
        
        require(!userMintedCollab[msg.sender], "User already minted Collab List");

        refundOverpay(price * 2);
        
        userMintedCollab[msg.sender] = true;
