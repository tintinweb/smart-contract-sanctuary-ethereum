...
contract VISIONSAAKI is ERC721A, ReentrancyGuard, Ownable {  
  using Address for address;
  ...
  address[4] public fundRecipients = [
    ...
    0x88A76450FB0F38F7cB7752ee787E43AA180adea3
  ];
  uint256[] public receivePercentagePt = [20, 80];   //distribution in basis points

  constructor(string memory _baseURI) ERC721A("VISIONSAAKI", "VOS", MAX_MINT) {
