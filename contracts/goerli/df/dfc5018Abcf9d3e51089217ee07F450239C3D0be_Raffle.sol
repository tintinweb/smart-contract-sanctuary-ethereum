...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
        ...
        )
    {
        ...
        // if upkeepNeded returns true then request a new random number and end the lottery
        upkeepNeded = (isOpen && timePassed && hasPlayers && hasBalance);
        return (upkeepNeded, "0x0");
    }
