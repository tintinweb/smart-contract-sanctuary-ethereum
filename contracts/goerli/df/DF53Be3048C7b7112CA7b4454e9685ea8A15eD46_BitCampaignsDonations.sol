...
contract BitCampaignsDonations is Ownable
{
    ...
    event DonatedETHToCampaign(uint256 amount, address _from, string _campaignRef, uint256 stage);
    event DonatedERC20ToCampaign(uint256 amount, address _from, string _campaignRef, address _contract, uint256 stage);
    ...
    constructor() {
         donationWalletAddress = 0x2349334b6c1Ee1eaF11CBFaD871570ccdF28440e; 
    ...
    function donateETH(bytes calldata signature, string memory campaignRef) public payable {
        ...
        emit DonatedETHToCampaign(msg.value, msg.sender, campaignRef, payoutStage);
    }

    function donateERC20(bytes calldata signature, address erc20Contract, uint256 amount, string memory campaignRef) public {

        bytes32 hashAllowed = ECDSA.toEthSignedMessageHash(keccak256(abi.encodePacked(msg.sender)));

        require(verify(hashAllowed, signature), "Not on KYC list");
        require(approvedERC20[erc20Contract], "This ERC20 is not approved");
        ...
        emit DonatedERC20ToCampaign(amountToDonate + feeToPay, msg.sender, campaignRef, erc20Contract, payoutStage);
    }
    ...
    function setERC20(address _address, bool _state) public onlyAdmin {
        approvedERC20[_address] = _state;
    }
