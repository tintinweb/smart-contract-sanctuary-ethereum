 ...
 */
contract MetabetMask is IMetabetMask, AccessControl {
    ...
    */
    ...
    modifier onlySuperAdmin() {
        require(hasRole("SuperAdmin", msg.sender) && msg.sender == superAdmin, 
        "MetabetMask: Not an Admin");
        _;
    }
    ...
    constructor(address _adminAddress){
        _setupRole("SuperAdmin", _adminAddress); 
        ...
        public view returns (bool)
    {
        ...
        hasRole("SuperAdmin",account)){ return true; }
    }
     ...
     */
    function updateSuperAdmin(address _adminAddress)
        external 
        onlySuperAdmin notAddress0(_adminAddress)
    {
        superAdmin = _adminAddress;
        _grantRole("SuperAdmin", _adminAddress);
        ...
        public onlyAuthorized returns (bytes32)
    {
        ...
        IPool pool = new Pool(superAdmin);
    ...
    function addSportEvents(
        ...
        public onlyAuthorized returns (bytes32[] memory)
    {
...
contract Pool is AccessControl, IPool{
    ...
    modifier onlyAuthorized() {
        require(isAuthorized(msg.sender), 
        "Pool:Restricted to only authorized accounts.");
        _;
    }
     ...
     */
    function withdraw(uint _amount) public override onlyAuthorized(){
