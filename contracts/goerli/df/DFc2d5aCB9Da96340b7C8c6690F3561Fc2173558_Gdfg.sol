 ...
 * @notice This contract handles minting gdfg tokens.
 */
contract Gdfg is ERC1155Supply, Ownable, Pausable, ReentrancyGuard, ERC2981 {
    using ECDSA for bytes32;

    // Used to validate authorized presale mint addresses
    address private presaleSignerAddress =
        0x670284f51485d660e9188955b24b13D49f0132bf;
    ...
    string public name = "gdfg";
    string public symbol = "gdf";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeifgq5dtifdk3oepi5h2tz4gs4yuhsc2x76uwcpip7gtdsnbirdqhq/{id}"
        )
    {
        ...
        tokenPublicMintsPerAddress[1] = 4;
        require(
