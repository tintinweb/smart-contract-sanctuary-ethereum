...
/**
 It's just one simple token.
 The waste of plenty is the resource of scarcity.- Thomas Love Peacoock 
 
 Steps after launch: Add liquidity -> LP Lock -> Open trading -> remove limits -> Renounce
*/
...
contract JustAToken is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x4891D42Bb57d21E7F38d0F2E0c5dC874B91185fd);//
    address payable private _marketingAddress = payable(0x4891D42Bb57d21E7F38d0F2E0c5dC874B91185fd);//
