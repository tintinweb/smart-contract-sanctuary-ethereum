...
contract UnimoonToken is ERC20, Ownable {
    ...
    /** @dev Function to change liquidity treshold
     * @notice available for owner only
     * @param _treshold new liquidity treshold
     */
    function setTreshold(uint256 _treshold) external onlyOwner {
        treshold = _treshold;
    }
