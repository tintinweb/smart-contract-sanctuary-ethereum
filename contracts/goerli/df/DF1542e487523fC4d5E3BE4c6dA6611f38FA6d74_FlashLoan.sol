...
//address _pool=s 0xc4dCB5126a3AfEd129BC3668Ea19285A9f56D15D
...
this.swap(tokenA, tokenB, amount, 0, address(this));


this.swap(tokenB, tokenA, IERC20 (tokenB).balanceOf(address(this)), 0, address(this));
...
function flashloan(address _assetAddress, uint256 amount, address _tokenA,  address _tokenB) external {
