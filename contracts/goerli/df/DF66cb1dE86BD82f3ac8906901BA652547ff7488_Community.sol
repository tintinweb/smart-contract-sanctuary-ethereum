    ...
    ERC2771ContextUpgradeable
{
    ...
    modifier onlyHomeFiAdmin() {
        ...
        require(msg.sender == homeFi.admin(), "Community::!admin");
        _;
    }
    ...
    function initialize(address _homeFi) external payable initializer {
        ...
        require(_homeFi != address(0), "Community::0 address");
        ...
        whenNotPaused
    {
        ...
        require(
            !restrictedToAdmin || _sender == _homeFi.admin(),
            "Community::!admin"
        );
        ...
        whenNotPaused
    {
        ...
        require(!_community.isMember[_data.member], "Community::Member Exists");
    ...
    function publishProject(
        ...
        require(
            _communityProject.lentAmount == 0,
            "Community::Repayment pending"
        );

        // Revert if decoded nonce is incorrect. This indicates wrong _data.
        require(
            _data.publishNonce == _community.publishNonce,
            "Community::invalid publishNonce"
        );
        // Revert if APR is invalid
        require(_data.apr < PPT_DIVISOR, "Community::invalid apr");

        // Reverts if _project not originated from HomeFi
        require(
            homeFi.isProjectExist(_data.project),
        ...
        whenNotPaused
    {
        ...
        require(
            _data.builder == _projectInstance.builder(),
            "Community::!Builder"
        );

        // Revert if decoded _communityID's owner is not decoded _lender
        require(
            _data.lender == _communities[_data.communityID].owner,
            "Community::!Owner"
        );
    ...
    function _reduceDebt(
        ...
        require(_lentAmount != 0, "Community::!Liquid");
