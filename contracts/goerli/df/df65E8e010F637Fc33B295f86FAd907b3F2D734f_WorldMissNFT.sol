...
contract WorldMissNFT is ERC721A, Ownable, ReentrancyGuard {
    ...
    **/
    ...
    function buyNFTWithERC20(uint256 amount) external nonReentrant {
        ...
        addr_num1 = priceSale * getLatestPrice() * amount * (addr_rate1) / (100*1e18);
        addr_num2 = priceSale * getLatestPrice() * amount * (addr_rate2) / (100*1e18);
        addr_num3 = priceSale * getLatestPrice() * amount * (addr_rate3) / (100*1e18);
    ...
    **/
    function tokenURI(uint _nftId) public view override(ERC721A) returns (string memory) {
        ...
        return "https://econft.market/nft-meta/tree/video_tree_nft.MP4";
    }   
