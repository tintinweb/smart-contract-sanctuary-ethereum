...
// https://bafybeibylnimev4skezun4xafhmhlrzgt47gpcis5fkqbrwoyy2ihpn7b4.ipfs.nftstorage.link/

// need various states here and setters for each
...
contract ChainsDropV2 is ERC1155, Ownable {
  ...
  uint public price = 0.00001 ether; // todo
  ...
  bool claimIsOpen = true; // DEPLOY: false
  bool freeClaimIsOpen = true; // DEPLOY: false
  bool paidMintIsOpen = true; // DEPLOY: false
  bool teamDidMint;
  ...
  constructor() ERC1155("") {
    mintLegendary(true, true, true, true); // REMOVE
    mintLegendary(false, false, false, false);
  }
...
*/
  ...
  // take signature, mints the different types
  function claim(
    uint _ownedCount,
    bool _mdWhale,
    bool _diamondRing,
  ...
  function freeClaim() external {
    ...
    // require(addressHasFreeClaimed[msg.sender] == false, "Already claimed"); // DEPLOY
  ...
  // _idToMint should be either 11 or 12
  ...
  function setPrice(uint _wei) external { // onlyOwner { todo
    price = _wei;
  }
