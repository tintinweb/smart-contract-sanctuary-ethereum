...
contract Vendor is Ownable {
  ...
  function buyTokens() public payable {
    ...
    require(amountOfEth > 0, "Send sone eth");
    uint256 amountOfTokens = amountOfEth * tokensPerEth;
    uint256 vendorBalance = yourToken.balanceOf(address(this));
    require(vendorBalance >= amountOfTokens, "Vendor doesn't have enough tokens");
  ...
  function sellTokens(uint256 _amount) public {
    ...
    uint256 amountToSend = _amount / tokensPerEth;
...
// buy 100 tokens = 1 ether
// sell 100 tokens = 1 ether
