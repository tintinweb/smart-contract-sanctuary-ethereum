...
contract OnChainAlpha is ERC721A, ReentrancyGuard, Ownable {
    ...
    string[] private LAYER_NAMES = [unicode"Mouth Special", unicode"Outwear", unicode"Headwear", unicode"Eyewear", unicode"Mouth", unicode"Ears", unicode"Eyes", unicode"Body"];
    ...
    constructor() ERC721A("On-Chain Alpha", "OCA") {
        ...
        // TIERS[8] = [9999]; //background and 1/1's
    }
