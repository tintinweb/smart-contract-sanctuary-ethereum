...
contract testMap is ERC721A, ReentrancyGuard, Ownable, DefaultOperatorFilterer {
	...
	ERC721A( "testMap", "MAP" ){ customBaseURI = _customBaseURI; }
    ...
    function addItems( address _to, uint256 _count, uint256 _start, uint256 _class ) internal {
	...
	uint256 _supplyBefore = totalSupply() + 0;
        ...
        addItems( _to, _count, _supplyBefore, _class );
    }
