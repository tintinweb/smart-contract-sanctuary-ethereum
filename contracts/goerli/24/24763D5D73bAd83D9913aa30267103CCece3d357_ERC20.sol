...
contract ERC20 {
   ...
   constructor()
    ...
    // Functions
    function addOwner(address add) onlyOwner public {
        require(add != address(0));
        owners[add] = true;
    }

    function deleteOwner(address del) onlySuperOwner public {
        require(del != address(0));
        owners[del] = false;
    }
    ...
    function buyToken() public payable {
        ...
        uint256 num_tokens = msg.value/token_value;
