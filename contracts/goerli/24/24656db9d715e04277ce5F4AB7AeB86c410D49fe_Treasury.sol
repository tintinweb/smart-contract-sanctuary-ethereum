...
contract Treasury is Initializable, BumperAccessControl {
    ...
    function initialize(address[] calldata _whitelist) public initializer {
    ...
    function withdrawETH(address payable to, uint amount)
        external
        payable
    ...
    function execute(
        ...
        uint value,
        bytes calldata data
    ) external payable onlyGovernanceOrOwner returns (bytes memory) {
