            ...
            Base64.encode(
                bytes(
                    abi.encodePacked(
                        ...
                        "Extraversion: ",
                        Strings.toString(outputs[tokenId].scores[0]/outputs[tokenId].counts[0]*100),
                        '</text><text x="10" y="40" class="base">',
                        "Conscientiousness: ",
                        Strings.toString(outputs[tokenId].scores[1]/outputs[tokenId].counts[1]*100),
                        '</text><text x="10" y="60" class="base">',
                        "Agreeableness: ",
                        Strings.toString(outputs[tokenId].scores[2]/outputs[tokenId].counts[2]*100),
                        '</text><text x="10" y="80" class="base">',
                        "Emotional Stability: ",
                        Strings.toString(outputs[tokenId].scores[3]/outputs[tokenId].counts[3]*100),
                        '</text><text x="10" y="100" class="base">',
                        "Intellect: ",
                        Strings.toString(outputs[tokenId].scores[4]/outputs[tokenId].counts[4]*100),
                        '</text></svg>'
                    )
                )
            )
                    ...
                    bytes(
                        abi.encodePacked(
                            '{',
                                ...
                                '"description": "",'
                                '"extraversion": ', '"', Strings.toString(outputs[tokenId].scores[0]/outputs[tokenId].counts[0]*100), '",'
                                '"conscientiousness": ', '"', Strings.toString(outputs[tokenId].scores[1]/outputs[tokenId].counts[1]*100), '",'
                                '"agreeableness": ', '"', Strings.toString(outputs[tokenId].scores[2]/outputs[tokenId].counts[2]*100), '",'
                                '"emotionalStability": ', '"', Strings.toString(outputs[tokenId].scores[3]/outputs[tokenId].counts[3]*100), '",'
                                '"intellect": ', '"', Strings.toString(outputs[tokenId].scores[4]/outputs[tokenId].counts[4]*100), '",'
                                '"image": "',
                                svgData,
                                '"',
                            '}'
