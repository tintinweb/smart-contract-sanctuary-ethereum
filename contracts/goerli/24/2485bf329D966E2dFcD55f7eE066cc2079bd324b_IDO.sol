...
contract IDO {
    ...
    uint256 public usdtHardCap; // 플랙서스 최대 모금액
    uint256 public usdtSoftCap; // 플랙서스 최소 모금액 
    uint256 public userHardCap; // 한 유저가 살수있는 최대 금액
    uint256 public userSoftCap; // 한 유저가 한번에 살수있는 최소 금액 
    ...
    function userLength() public returns (uint256 user) {
        return userAddress.length;
    }

    function userP2Length() public returns (uint256 user) {
