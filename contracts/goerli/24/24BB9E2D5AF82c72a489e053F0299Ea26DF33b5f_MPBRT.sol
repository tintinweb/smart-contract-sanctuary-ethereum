...
contract MPBRT is ERC721MP, Ownable, ReentrancyGuard
{
    ...
    uint public _TotalAvailableForPurchase = 100;
    uint public _UnixSaleStartTimeBrightlist = 1662416400;
    uint public _UnixSaleStartTimePublic = 1662416400;
    ...
    ************/
    ...
    function Purchase(uint Amount, bool Status) public payable nonReentrant
    {
        ...
        require(Amount == 1, "MP: One Per Tx");
     ...
     */
    function BurnToRedeemPasses() external nonReentrant
    {
        require(block.timestamp > _UnixUserRedeemTimestamp, "Cannot Redeem Pass Unitl After The Start Time");
