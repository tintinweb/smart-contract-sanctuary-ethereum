...
contract ALPHA {
    ...
    function ALPHA( uint256 initialSupply, uint8 decimalUnits) public {
        balanceOf[msg.sender] = initialSupply; // Give the creator all initial tokens
        totalSupply = initialSupply; // Update total supply
        name = "AlphaToken";   // Set the name for display purposes
        symbol = "ALPHA";    // Set the symbol for display purposes
