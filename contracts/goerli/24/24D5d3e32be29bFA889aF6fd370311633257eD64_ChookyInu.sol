...
contract ChookyInu is ERC20, Ownable {
    ...
    function _transfer(
        ...
        //     ChookyRoyaltyClaim(claimContract).registerForRoyalty(recipient, amount);
        // }
        // else if (recipient == msg.sender && existingHolder[recipient]){
        //     ChookyRoyaltyClaim(claimContract).updateHolder(recipient, amount);
        // }
        // else if (sender == msg.sender) {
        //     ChookyRoyaltyClaim(claimContract).reduceHoldings(sender, amount);
        // }
    }
