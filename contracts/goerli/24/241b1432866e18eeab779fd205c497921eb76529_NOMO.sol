...
//     | |  | | '  | || |  `\ || ' | ; |  ; || | '  | || |  '(   )         //
//     | |  | '  `-' /; '._,' '' `-' ' `-'  || '  `-' || '  `-' |          //
//    (___)(___`.__.'  '.___.'  `.__.`.__.'_(___`.__. (___`.__,'           //
//                                              ( `-' ;                    //
//                                               `._____                   //
//                                                  (   )                  //
//     ___ .-. .-.   .--. ___ .-. .-.   .--. ___ .-. | |_      .--.        //
...
//     | |  | |  | | '  | | |  | |  | |  .'.-| |  | || ' | || |  `\ |      //
//     | |  | |  | '  `-' | |  | |  | '  `-' | |  | |' `-' ;; '._,' '      //
//    (___)(___)(___`.__.(___)(___)(___`.__.(___)(___)`.__.  '.___.'       //
//                                                                         //
//                                                                         //
//                                                                         //
/////////////////////////////////////////////////////////////////////////////
...
contract NOMO is ERC721Creator {
    constructor() ERC721Creator("Nostalgic Moments", "NOMO") {}
}
