...
contract DokuRingo is ERC721AQueryable ,ERC2981 ,AccessControl , Ownable2Step, DefaultOperatorFilterer  {
    ...
    uint256 private publicPrice  = 0.01 ether;//publicSale price.
    ...
    function getALMinted(address wallet) external view virtual
    returns (uint256) 
    {
        return (_MintedAL[wallet]);
    }
    ...
    function setSaleState(uint256 _state) external virtual onlyRole(TEAM_ROLE) {
        //1:Not Sale, 2:PreSale1, 3:PublicSale, 4:Fin /*5*/
    ...
    function setMinted(uint256 tokenId, uint256 minted) external onlyRole(TEAM_ROLE){
