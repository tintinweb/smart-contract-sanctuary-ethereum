...
/**
 *Submitted for verification at testnet.snowtrace.io on 2022-11-24
*/
...
// File contracts/muto.sol

// contracts/MutoToken.sol
...
contract MutoToken is ERC20, Ownable {
    ...
    function buyTokens() public payable returns (uint256 tokenAmount) {
        ...
        amountToBuy = amountToBuy * 1e18;
        uint256 motubalance = balanceOf(address(this));    
        // if(motubalance >= amountToBuy){
        //     transfer(msg.sender, amountToBuy);
        //     bool sent = transferFrom(address(this),msg.sender, amountToBuy);
    ...
    function sellTokens(uint256 tokenAmountToSell) public {
        ...
        tokenAmountToSell = tokenAmountToSell / 1e18;
        ...
        bool sent = transferFrom(msg.sender, _deadAddress , tokenAmountToSell * 1e18 );
        require(sent, "Failed to transfer tokens from user to vendor");
