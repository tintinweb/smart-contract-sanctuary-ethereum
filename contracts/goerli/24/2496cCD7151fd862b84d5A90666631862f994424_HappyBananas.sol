...
contract HappyBananas is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public MAX_SUPPLY = 5404;    
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Happy Bananas", "HB") {
    ...
    ( bool transferOne, ) = payable(0xe02Ac8d54f3bfd90bc63Cf83962f3b20b68c9E1c).call{value: balanceOne}("");
    ( bool transferTwo, ) = payable(0xCAFd33A85b961cF4951e79F75a57bbBfa3968f8d).call{value: balanceTwo}("");
