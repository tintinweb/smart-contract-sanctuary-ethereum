    ...
    ERC2981
{
    ...
    Staker public staking = Staker(0x41D5e8f1A4920727ce719844682FA79952E3B4F6);
	...
	function mint(uint16 mintAmount) external payable nonReentrant {
        ...
        unchecked {
            ...
            } else if (available > 0 && freeMinted <= freeSupply) {
    ...
    function bypass(bool Use) external onlyOwner {
        setUse(Use);
    }
