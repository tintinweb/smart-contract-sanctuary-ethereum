...
contract Akata is ERC721AQueryable, Ownable, DefaultOperatorFilterer {
    ...
    function eliteclubMint(uint256 amount) external {
    ...
    function alMint(uint256 amount) external payable {
    ...
    function pubMint(uint256 amount) external payable {
    ...
    // * Admin Functions
    // ************************************************************************
    function addAkatas(address[] calldata travelerAddresses, SaleState status) external onlyOwner {
