...
contract AaveProtocol is IDefiProtocol, OwnableUpgradeable, AbstractDependant {
    ...
    /// @notice claim rewards and send it to dein treasury pool
    function claimRewards() external override onlyYieldGenerator {
        ...
        if (_totalStblValue > totalDeposit) {
            ...
            uint256 _amountInUnderlying =
                lendingPool.withdraw(address(stablecoin), _accumaltedAmount, deinTreasury);
    ...
    function _totalValue() internal view returns (uint256) {
        ...
        uint256 accumlatedUserBalance =
            aTokenBalance
                .mul(lendingPool.getReserveNormalizedIncome(address(stablecoin)))
                .uncheckedDiv(10**27);
    ...
    function getOneDayGain() external view override returns (uint256) {
        ...
        return reserveData.currentLiquidityRate.uncheckedDiv(365).uncheckedDiv(100);
    }
