...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x714Ba6F0d76770c30d094491C111407858d3B107];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x714Ba6F0d76770c30d094491C111407858d3B107;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 666) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicweexub6bmjrietn5rte5emquat5eau4xkqincnsec4zhgmfdhz4/";
...
// File: contracts/InfernalEyesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract InfernalEyesContract is RamppERC721A {
    constructor() RamppERC721A("Infernal Eyes", "EYE"){}
}
