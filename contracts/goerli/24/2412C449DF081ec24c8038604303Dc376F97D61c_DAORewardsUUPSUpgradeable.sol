...
contract DAORewards is IModule, IDAOV1Rewards, Initializable, AccessControlUpgradeable {
    ...
    function enforcePrerequisites(address registryAddr, bytes32 orgId) external view {
        ...
        require(registry.hasModule(orgId, Modules.DAO_V1_STAKING), "Prerequisites: module dao_v1_staking required");
        require(address(daoStaking) == registry.getModuleValue(orgId, Modules.DAO_V1_STAKING, 0), "Prerequisites: daoStaking address must match registry");
    }
