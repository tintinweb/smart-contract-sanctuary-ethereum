...
contract dooplicatortest is ERC721A, ERC2981, ReentrancyGuard, AccessControl, Ownable {
    ...
    constructor(address doodles_, address spaceDoodles_) ERC721A("Token", "TOKEN") {
        require(
