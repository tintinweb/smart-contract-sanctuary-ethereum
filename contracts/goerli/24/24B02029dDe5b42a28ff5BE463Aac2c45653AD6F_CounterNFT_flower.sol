...
contract CounterNFT_flower is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("CounterNFT_flower", "CNF") {}
    ...
    function nftMint() public onlyOwner{
        ...
        string memory jsonFile = string(abi.encodePacked('metadata_', Strings.toString(newTokenId), '.json'));
    ...
    function _baseURI() internal pure override returns (string memory){
        return "ipfs://bafybeiegugyismslgde524agr2hfwvrspxa5kjfojut74ouvvcsuiwrifu/";
    }
}
