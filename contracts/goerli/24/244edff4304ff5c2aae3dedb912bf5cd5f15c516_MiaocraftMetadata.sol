...
contract MiaocraftMetadata is IMetadata, Initializable, Ownable {
    ...
    function getMetadata(uint256 tokenId) public view returns (string memory) {
        // TODO: refactor into metadata contract for easy upgrade
        ...
        uint256 spins = miaocraft.spinsOf(tokenId) / 1e18;
        uint256 spinsDecay = miaocraft.spinsDecayOf(tokenId) / 1e18;
