...
contract MyERC20V1 is Initializable, ERC4626Upgradeable, ERC20BurnableUpgradeable  {
    ...
    function _initialize(IERC20Upgradeable _asset) virtual initializer public {
    ...
    function _reinitialize(IERC20Upgradeable _asset) reinitializer((_getInitializedVersion()+1)) public {
        __ERC20_init("SToken", "STKN");
        _mint(address(this), 1000000);
        __ERC4626_init(_asset);
        token = _asset;
