...
import { NounsDescriptor } from './NounsDescriptor.sol';
import { IProxyRegistry } from './external/opensea/IProxyRegistry.sol';
import { NounsDAOExecutor } from './governance/NounsDAOExecutor.sol';
import { NounsDAOLogicV1 } from './governance/NounsDAOLogicV1.sol';
import { NounsDAOProxy } from './governance/NounsDAOProxy.sol';
contract NounFactory {
    constructor(){
        NounsSeeder seeder = new NounsSeeder();
        NounsDescriptor descriptor = new NounsDescriptor();
        NounsToken noun = new NounsToken(msg.sender, msg.sender,
                descriptor,
                seeder,
                IProxyRegistry(address(0))
        );
        NounsDAOExecutor timelock = new NounsDAOExecutor(msg.sender, 172800);
        NounsDAOLogicV1 implementation = new NounsDAOLogicV1();
        new NounsDAOProxy(
            address(timelock),
            address(noun),
            msg.sender,
