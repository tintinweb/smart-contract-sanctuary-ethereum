...
/// @author Solmate (https://github.com/transmissions11/solmate/blob/main/src/mixins/ERC4626.sol)
   contract ERC4626 is ERC20 {
    ...
    { //the erc20 acting as our receipt token
        asset = _asset;
    }
    ...
    //Enter the strategy by depositing x amount of assets
    ...
    //Enter the strategy by deciding to mint x amount of vault share
    ...
    //Withdraw based on a number of shares
    function withdraw(
        uint256 assets,
        address receiver,
        address owner
