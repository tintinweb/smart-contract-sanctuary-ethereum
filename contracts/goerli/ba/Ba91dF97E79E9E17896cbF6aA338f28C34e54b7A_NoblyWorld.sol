...
contract NoblyWorld is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    string baseURI;
    bool public _revealed = true;               // false
    string private _notRevealedUri;
    string private _baseExtension = ".json";

    // Market and minting
    bool public mintingActive = true;           // false
    uint256 public _maxSupply = 33;
    uint256 public _maxLimitPerMint = 10;
    uint _reservedTokens = 10;
    uint256 _mintPrice = 0.001 * 1e18;          // 0.1 ETH

    uint256 _totalClaimable = 0;
    uint256 _marketplaceVolume = 0;
    uint256 _minterFee = 3;
    uint256 _marketFee = 2;
    address _marketFeeAddress = address(0x2C4C168A2fE4CaB8E32d1B2A119d4Aa8BdA377e7);
 ...
 //   constructor() ERC721("Nobly World", "NoblyWorld") {
    constructor() ERC721("Test World", "TestWorld") {
        _notRevealedUri = "ipfs://QmUV2B2RrxAwX4Hx4Y2mr9HVnAVoEgvQVtmfbbqgrcfiFJ/1";
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmePJtPpfjLB6rR7zCKtH8YTrGwKPjmdonvUDUg7ZnUAQV/");
    }
