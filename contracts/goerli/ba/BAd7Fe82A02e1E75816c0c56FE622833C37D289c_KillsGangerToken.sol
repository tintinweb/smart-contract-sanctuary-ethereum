...
/**
 * @title KillsGangerToken
 * @dev Standard ERC20 token 
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract KillsGangerToken is ERC20Permit, Pausable, ERC165 {
    address private _owner;

    constructor() ERC20("Kills Ganger Token","KNGR")  ERC20Permit("Kills Ganger Token") { 
        _owner = _msgSender();
     }
