...
contract testta is ERC721A, Ownable, ReentrancyGuard {
  ...
  function tanasinn(uint256 amount) external payable
  {
    uint cost = price;
  ...
  function ownerBatchTanasinn(uint256 amount) external onlyOwner
  {
  ...
  function toggleTanasinn() external onlyOwner {
