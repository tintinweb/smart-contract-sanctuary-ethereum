...
contract usdtContract is TRC20 {
    ...
    mapping (address => _lockToken) public lockToken;
    uint256 public transferAmt;
    //uint public twentyfourMonth = 2*(30*12*(24*60*60));
    uint public twentyfourMonth = 600;
    ...
    function changeTokensale(address _add) public  returns(string memory){
