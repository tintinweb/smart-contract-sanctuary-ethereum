...
contract Vendor is Ownable {
  ...
  event SellTokens(uint256 amount);
  ...
  function sellTokens(uint256 tokenAmountToSell) public {
      ...
      uint256 amountOfTokensWei = tokenAmountToSell * 10 ** 18;
      uint256 amountToSend = tokenAmountToSell * pricePerToken;
      ...
      emit SellTokens(tokenAmountToSell);
  }
