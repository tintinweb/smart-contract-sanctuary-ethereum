...
contract YuumiSociety is Ownable, ERC721A {
    ...
    address internal constant CHARITY_ADDRESS =
        0x58B7A883C26A55aA7763789872a0E59e00Dc224c;
    address public teamWallet = 0x450104CebEF64577F25CdDeb3Ab3de7603B55C7A;

    uint256 internal devWithdrawPercent = 1500;

    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("YuumiSociety", "YUUMI") {}
