...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    building decentralized social networks through the use of our anonymous image board

    Website     > https://bizzchain.org/
    Image Board > https://bizzchan.com/
    Telegram    > https://t.me/bizz_chain
    Twitter     > https://twitter.com/bizzchain
...
contract TEST is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Test-QA";
    string private constant _symbol = unicode"QA";
