...
contract PaymentManager is Ownable {
    ...
    function payRemix(address _token, uint256 amount)
        external
        payable
        returns (bool)
    {
        return IERC20(_token).transferFrom(_msgSender(), address(this), amount);
    }
}
...
interface IPaymentManager {
    ...
    function payRemix(address token, uint256 amount)
        external
        payable
        returns (bool);
}
