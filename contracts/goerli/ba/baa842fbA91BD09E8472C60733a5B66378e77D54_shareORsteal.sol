 ...
 */
contract shareORsteal is gameTools {
     ...
     * @param result the result of the game 0->player1, 1->player2, 2->both
     */
    function endGame(
        address player1,
        address player2,
        ...
        require(elapsedTime >= 0 && elapsedTime <= 300, "Invalid elapsed time");
        require(result != 2 || elapsedTime == 300, "Invalid elapsed time");
        ...
        require(player1Allowance >= betAmount, "Not enough allowance");
        require(player2Allowance >= betAmount, "Not enough allowance");

        IERC20(erc20Address).transferFrom(address(this), player1, betAmount);
        IERC20(erc20Address).transferFrom(address(this), player2, betAmount);

        uint256 profit = pricePerSecond * elapsedTime;

        if (result == 0) {
            IERC20(erc20Address).transferFrom(player1, address(this), profit);
        } else if (result == 1) {
            IERC20(erc20Address).transferFrom(player2, address(this), profit);
        } else {
