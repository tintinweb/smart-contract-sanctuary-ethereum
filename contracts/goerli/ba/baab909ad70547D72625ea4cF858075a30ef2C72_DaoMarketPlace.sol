...
import "../Utils/IThirdwebContract.sol";
import "../Utils/IPlatformFee.sol";
    ...
    IERC1155ReceiverUpgradeable
{
    ...
    constructor(address owner,address _nativeTokenWrapper) initializer {
        nativeTokenWrapper = address(0);
        tokenWrapper = _nativeTokenWrapper;
        initialize(owner);
    }

    /// @dev Initiliazes the contract, like a constructor.
    function initialize(address owner) internal initializer {
        string memory ccontractURI = "";
    ...
    function createListing(ListingParameters memory _params) internal {
        ...
        require(allowedContracts[_params.assetContract], "CONTRACT");
