  ...
  Payable
{
  ...
  uint8 public mint_list_limit = 5;
  ...
  function mintFromList(bytes32[] calldata proof, uint256 amount, address to) external payable whenNotPaused {
    ...
    require(this.onMintList(to, proof), 'Unable to mint; not on the mint list.');
  ...
  //todo: write test
  function getFactionNames() external view returns (string[6] memory) {
    return factionNames;
  }
