...
contract Silhouette is ERC721A, Ownable {
    ...
    constructor() ERC721A("Silhouette", "Silhouette") {
        bannedMarketplaces[0x000000000000Ad05Ccc4F10045630fb830B95127] = true; // Blur
    }
    ...
    function approve(address to, uint256 tokenId) public payable virtual override {
        require(!bannedMarketplaces[to], "Not approved marketplace");
        super.approve(to, tokenId);
    }

    function setApprovalForAll(address operator, bool approved) public virtual override {
        require(!bannedMarketplaces[operator], "Not approved marketplace");
