 ...
 *   SBTEST9, via Goerli
 *   v20221102.539pm
 *   [ ASCII header & copyright info to appear atop contract (currently in readme.md) ]
 *   REMINDER -- ASCII art, set PRICES, and other settings / general review.
 */
...
import "erc721a/contracts/ERC721A.sol";
        // In imported ERC721A, we have imported the OpenSea Operator Filter Registry (DefaultOperatorFilterer)
        // npm i operator-filter-registry
import "@openzeppelin/contracts/finance/PaymentSplitter.sol"; 
        // In imported PaymentSplitter, two release() functions changed to internal.
...
contract SBTEST9 is Ownable, ERC721A, PaymentSplitter {
        ...
        PaymentSplitter(distro, distro_shares)
    {
        ...
        accounts[teamclaim[0]] = Account(575, 0, 1 ); // Team Use NFTs
        ...
        accounts[teamclaim[5]] = Account(  1, 0, 1 ); // tbd
...
/**
 * Importing OpenSea's Operator Filter Registry here so that we can add the onlyAllowedOperator modifier
 * to transferFrom(), safeTransferFrom() [no data version], and safeTransferFrom() [data version]
 * (those functions on lines 295, 306, & 317); also change to line 46 here. Note: When this package is
 * ever updated, the "DefaultOperatorFilterer" ay change to "DefaultOperatorFilterer".
 */
