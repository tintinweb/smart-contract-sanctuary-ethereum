...
contract Vendor is Ownable {
  ...
  function withdraw() payable public onlyOwner {
    (bool succeeded, ) = msg.sender.call{ value: address(this).balance }("");
    require(succeeded, "Transferring balance failed.");
  }

  function sellTokens(uint256 tokenAmount) public {
    require(tokenAmount > 0, "No amount of tokens provided.");
    uint256 ethAmount = tokenAmount / tokensPerEth;
    yourToken.transferFrom(msg.sender, address(this), tokenAmount);
    (bool succeeded, ) = msg.sender.call{ value: ethAmount }("");
    require(succeeded, "Transferring of Ether failed.");
