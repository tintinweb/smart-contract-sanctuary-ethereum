...
library SystemSettingsLib {
    ...
    function setEtherWrapperMintFeeRate(
        ...
        require(_rate <= uint256(MAX_WRAPPER_MINT_FEE_RATE), "rate > MAX_WRAPPER_MINT_FEE_RATE");
    ...
    function setEtherWrapperBurnFeeRate(
        ...
        require(_rate <= uint256(MAX_WRAPPER_BURN_FEE_RATE), "rate > MAX_WRAPPER_BURN_FEE_RATE");
        flexibleStorage.setUIntValue(SETTINGS_CONTRACT_NAME, settingName, _rate);
    }
    ...
    function setWrapperMaxTokenAmount(
        ...
        flexibleStorage.setUIntValue(SETTINGS_CONTRACT_NAME, keccak256(abi.encodePacked(settingName, _wrapper)), _maxTokenAmount);
    }
