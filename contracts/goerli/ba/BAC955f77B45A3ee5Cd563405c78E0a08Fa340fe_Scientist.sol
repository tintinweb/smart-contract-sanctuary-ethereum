    ...
    OwnableUpgradeable
{
    ...
    /**
     * @dev operator validates signature
     */

    modifier _isOperatorValidSign(
        address to,
        bytes calldata sig,
        uint256 index
    ) {
    ...
    function mintFor(
        ...
        external
        payable
        _isOperatorValidSign(to, sign, index)
        nonReentrant
        isOperator
    {
    ...
    ) external payable isValidSign(sign, index) nonReentrant whenNotPaused {
        require(
