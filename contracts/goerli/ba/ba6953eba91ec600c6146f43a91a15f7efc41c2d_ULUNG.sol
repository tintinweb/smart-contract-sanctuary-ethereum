...
contract ULUNG is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ULUNG";
    string private constant _symbol = "ULUNG";
    ...
    address payable private _developmentAddress = payable(0xeA6D91d643fac81a2A7783c1B0d4cf361fb00434);
    address payable private _marketingAddress = payable(0xeA6D91d643fac81a2A7783c1B0d4cf361fb00434);
