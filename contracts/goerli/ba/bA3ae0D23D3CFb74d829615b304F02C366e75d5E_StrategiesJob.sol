...
contract StrategiesJob is Ownable {
  ...
  function setWorkCooldown(uint256 _cooldown) external onlyOwner {
  ...
  function addMultipleStrategies(address[] calldata _strategies) external onlyOwner {
