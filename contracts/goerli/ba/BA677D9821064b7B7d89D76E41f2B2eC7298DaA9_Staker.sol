...
contract Staker {
    ...
    modifier stakingNotComplete() {
        bool isCompleted = exampleExternalContract.completed();
        require(!isCompleted, "Staking period has completed");
        _;
    }

    function stake() public payable deadlinePassed(false) stakingNotComplete {
        balances[msg.sender] += msg.value;
        emit Stake(msg.sender, msg.value);
    }

    function execute() public stakingNotComplete {
