...
contract Collabo is ERC721AUpgradeable, OwnableUpgradeable {
    using StringsUpgradeable for uint256;

    string public baseURI;

    event MintBatchEvent(
    ...
    function safeMintBatch(uint256 amount, address receiver) public onlyOwner {
        uint256 firstTokenID = _nextTokenId();
        _safeMint(receiver, amount);
        emit MintBatchEvent(firstTokenID, amount, receiver, totalSupply());
    }
