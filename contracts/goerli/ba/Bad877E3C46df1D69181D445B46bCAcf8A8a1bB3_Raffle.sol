...
contract Raffle is RaffleManager {
    ...
    constructor(
        ...
        bool _onlyAllowed
    ) payable RaffleManager(_subscriptionId) {
        interval = _interval;
    ...
    /// @dev get number of user participating in current round till present
    function getNumbersOfEntries() external view returns (uint256) {
