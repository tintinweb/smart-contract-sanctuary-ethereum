...
contract AnonTimelock is AccessControl {
  ...
  modifier onlyTokenOwner(uint256 tokenId) {
    if (anon.ownerOf(tokenId) != msg.sender) revert NotTokenOwner();
    _;
  }
  ...
  function timelockExpiresAt(uint256 tokenId) public view returns (uint256) {
