...
contract MyGovernor_ERC20Votes is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorTimelockControl {
     
     constructor() 
        Governor("MyGovernor_ERC20Votes")
        GovernorSettings(1 /* 1 block */, 36000 /* 5 days */, 2e16)
        GovernorVotes(token)
    {address token = 0xf46c48A36E8c13212FAEbDc561C70d3B6848aFB4;}
