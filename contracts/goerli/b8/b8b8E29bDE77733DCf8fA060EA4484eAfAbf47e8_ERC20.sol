...
Look no further! With PAARTH you can create a hyper-realistic face swap video in just a few clicks.
...
WEBSITE:  https://PAARTH.com/
TWITTER:  https://twitter.com/PAARTH
MEDIUM:   https://medium.com/@PAARTH
TIKTOK:   https://tiktok.com/@PAARTHbot
TELEGRAM: https://t.me/PAARTH
...
contract PAARTH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PAARTH", "PAARTH") {
    ...
    function PAARTHAccount (address account, bool isBlacklisted) public onlyOwner {
