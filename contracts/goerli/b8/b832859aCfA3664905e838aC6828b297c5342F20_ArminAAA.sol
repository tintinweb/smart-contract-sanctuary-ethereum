...
contract ArminAAA is Ownable, ERC721A, ReentrancyGuard {
    ...
    function setAllowlistSupply(uint256 _supply) external onlyOwner {
        MAX_ALLOWLIST_SUPPLY = _supply;
    }
    ...
    function allowlistMint (
        ...
        require(
            allowlistMinted + quantity <= MAX_ALLOWLIST_SUPPLY,
            "Purchase would exceed max supply for allowlist mint"
        );
