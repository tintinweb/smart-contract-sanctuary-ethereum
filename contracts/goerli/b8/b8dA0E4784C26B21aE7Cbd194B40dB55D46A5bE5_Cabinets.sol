...
contract Cabinets is CabinetsSVG, ERC721Royalty, Ownable {
    ...
    constructor(address signer) ERC721("Cabinets", "CBNTS") {
        _signer = signer;
    ...
    function safeMint(
        ...
        require(_dnas.length < 150, "Cabinets: sold out");
        require(
        ...
        if (_msgSender() == owner) {
            ...
            require(msg.value == 0.025 ether, "Cabinets: wrong amount");
            (bool success, ) = owner.call{value: 0.020 ether}("");
            require(success, "Cabinets: unable transfer to A");
            (success, ) = dev.call{value: 0.005 ether}("");
...
contract CabinetsSVG {
    ...
    bytes constant _PALETTES =
        hex"b8ffdeffff9bbffffffccdffd8d2ff000000e6e6e6"
            ...
            abi.encodePacked(
                ...
                Base64.encode(
                    abi.encodePacked(
                        ...
                        tokenId.toString(),
                        '",',
                        unicode'"description":"Cabinets is a collection of 150 fully on–chain artworks 🌹 '
