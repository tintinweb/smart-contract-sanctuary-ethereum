 ...
 *  
 */
contract Dummy_VIS is Ownable, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant private _name = "Dummy VIS";
    string constant private _symbol = "DVIS";
    uint8  constant private _decimal = 18;
    uint256 private _totalSupply = 20000 * (10 ** _decimal); // 200 thousand tokens
