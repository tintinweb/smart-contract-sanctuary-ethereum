...
//*********************************************************************//
//
//     __  ___         _______           __     ____                 __            __ 
//    /  |/  /_  __   / ____(_)_________/ /_   / __ \____  ____ _   / /____  _____/ /_
//   / /|_/ / / / /  / /_  / / ___/ ___/ __/  / / / / __ \/ __ `/  / __/ _ \/ ___/ __/
//  / /  / / /_/ /  / __/ / / /  (__  ) /_   / /_/ / /_/ / /_/ /  / /_/  __(__  ) /_  
// /_/  /_/\__, /  /_/   /_/_/  /____/\__/  /_____/\____/\__, /   \__/\___/____/\__/  
//        /____/                                        /____/                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x8c9Db725dDBaE3ca654Dc208F0783C10300F10B8];
...
// File: contracts/MyFirstDogtestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MyFirstDogtestContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "My First Dog test";
    string public symbol = "MFDT";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/OWLbC9XDXIqm4eQ0OjzW/contract-metadata";
  }
