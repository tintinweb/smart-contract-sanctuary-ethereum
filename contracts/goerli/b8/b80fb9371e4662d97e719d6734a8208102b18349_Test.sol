...
contract Test is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor() ERC721A("Knights", "KOTE") {

    }

    string public uri = "ipfs://QmYUxV1E3t3cNR7oGwb1uwnGmGECCTPqzFD26ufQMiAysB/";
    ...
    function mintMany(address[] calldata _addresses, uint256 _amount) public {
