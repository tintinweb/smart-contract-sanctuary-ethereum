...
// 10000 NFTs, 5000 of these NFTs have to reserved to nbe mintable in CRO (these can not be airdropped or be minted in Steak TOKEN), 
// remaining 5000 can be minted in STEAK Token (airdrop will substract from this 5000) 

//70% of all mint funds go to  0xb68b5B646ECa05fe554a5e3cb499e664a91050D5 - project
//10% of all mint funds go to  0x1E6D5aa35A21B3221630EC898F50128de3cB1c1C - marketing
//10% of all mint funds go to  0xf6882F46E94e9Dd57f8fd12cF40d7dC0Af27331d - team
//10% of all mint funds go to  0x42C58f27681380E0fc1D3D313D275f5916fB3C04 - dev
// 69 CRO or 69 STEAK cost to mint
//42 CRO Whitelist price
//mint does not have to be random, currently is in contract
...
contract Cowz is ERC721Enumerable, Ownable {
  ...
  function _distributeFee(address token, uint256 totalPrice) private {
