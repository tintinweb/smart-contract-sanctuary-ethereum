...
contract Reflections is Context, IERC20, Ownable {
    ...
    address public buyBackAddress = 0x665a7EBf291E0B35A5ad8E5343Ed872544cE22D9;
    address public marketingAddress = 0x665a7EBf291E0B35A5ad8E5343Ed872544cE22D9;
    address public devAddress = 0xFa3EE774Ad290A14cC02154784FD601A37e23793;
...
contract DividendTracker is IERC20, Context, Ownable {
    ...
    string private _name = "Test TRACKER";
    ...
    function setTokenBalance(address account) external {
        uint256 balance = reflection.balanceOf(account);
        if(!reflection.isExcludedFromRewards(account)) {
    ...
    function setERC20Contract(address contractAddr) external onlyOwner {
        reflection = Reflections(payable(contractAddr));
    }
