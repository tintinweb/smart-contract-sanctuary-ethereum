// An NFT Contract Generator
// Where the tokenURI can be one of 6 UB logos
...
contract UBNFT is ERC721 {
    ...
    uint public maxLogos = 5;

    enum Logos{KNIGTH, SHIELD_SWORDS,TEXT_KNIGHT,TEXT_OVERLAP,VERTICAL_PURPLE}
