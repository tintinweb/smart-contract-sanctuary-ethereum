...
contract LBSKR is LBSKRCore {
    ...
    function setInitialRatio(
        ...
        emit StakeAdded(_msgSender(), stakeAmount, stakeAmount, block.timestamp);
    }
        ...
        isInitialRatioSet
    {
        ...
        emit StakeAdded(_msgSender(), stakeAmount, stakeAmount, block.timestamp); // TODO remove this line
    }
