...
{   
    ...
    mapping(uint => mapping(uint => uint)) public MintedTokenID;        // Returns [ArtistID][TicketID] => Minted Work TokenID
    ...
    constructor()
    { 
        // Artists[15]._MintPass = 0x2D995A0120bD9d8f25FD9bef8C2C5A5D41d5E335; // mainnet
        // Artists[15]._ProjectID = 15; // mainnet
        // Artists[15]._Minter = 0x7b9a45E278b5B374bb2d96C65665d4360C97BF01; // mainnet
        // Artists[15]._ERC20 = 0x989F573BfA0DF488C0806937E7Eb3FbeC4538218; // mainnet
    ...
    function RedeemQR(uint ArtistID, bytes32[] calldata Proof, string calldata Data) external nonReentrant
    {
        ...
        unchecked
        {
            ...
            if(QRAllocation[ArtistID][msg.sender] == 0) // User Is Able To Redeem Explicitly 1 QR Code
            {
                ...
                emit QRRedeemed(msg.sender, Artists[ArtistID]._CurrentQR, Data);
            }
            else // User Is Able To Redeem More Than 1 QR Code Because Their Integer Allocation > 0
            {
                ...
                for(CurrentQR; CurrentQR < Limit; CurrentQR++)
                {
                    ...
                    emit QRRedeemed(msg.sender, CurrentQR, Data);
                }
            }
        }
    }
    ...
    function __NewRoots(uint[] calldata ArtistIDs, bytes32[] calldata NewRoots) external onlyOwner
    {
        for(uint x; x < ArtistIDs.length; x++)
        {
            Artists[ArtistIDs[x]]._Root = NewRoots[x];
        }
