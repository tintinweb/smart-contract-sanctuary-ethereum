...
contract Claimer is Ownable, ReentrancyGuard
{
    ...
    bytes32 public _RootCaminos = 0x8994c046b8c899660a7ca9ca163a02dea3551a3aa85b79342dd7f4fe15451686;
    bytes32 public _RootCitizens = 0x6e9fb19af27784891054cc9a63145f22087c1456b371d23930564e918d363d8a;
    ...
    function ReadEligibilityMerkleCaminos (
        ...
        {
            bytes32 Node = keccak256(abi.encodePacked(Wallet, TokenIDs[x]));
            Eligibles[x] = MerkleProof.verify(Proof[x], _RootCaminos, Node);
        }
        return Eligibles;
    }
    ...
    function ReadEligibilityMerkleCitizens (
        ...
        for(uint x; x < GTMXTokenIDs.length; x++)
        {
            bytes32 Node = keccak256(abi.encodePacked(GTMXTokenIDs[x], CitizenTokenIDs[x]));
            Eligibles[x] = MerkleProof.verify(Proof[x], _RootCitizens, Node);
        }
        return Eligibles;
    }
