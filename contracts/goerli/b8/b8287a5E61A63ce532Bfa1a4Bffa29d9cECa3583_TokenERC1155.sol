...
contract ERC1155Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC1155Upgradeable, IERC1155MetadataURIUpgradeable {
     ...
     *
     * Emits a {TransferSingleMSERC1155MSERC1155} event.
     *
     * Requirements:
     *
    ...
    function _safeTransferFrom(
        ...
        emit TransferSingleMSERC1155(operator, from, to, id, amount);
     ...
     *
     * Emits a {TransferSingleMSERC1155} event.
     *
     * Requirements:
     *
     * - `to` cannot be the zero address.
    ...
    function _mint(
        ...
        _balances[id][to] += amount;
        emit TransferSingleMSERC1155(operator, address(0), to, id, amount);
    ...
    function _burn(
        ...
        emit TransferSingleMSERC1155(operator, from, address(0), id, amount);
...
interface IERC1155Upgradeable is IERC165Upgradeable {
     ...
     */
    event TransferSingleMSERC1155(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value);
