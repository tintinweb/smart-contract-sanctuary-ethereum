...
contract P2PLoanFactory{
    ...
    event LoanContract(P2PLoan indexed _p2ploan, uint256 index);
    constructor () {
        owner = msg.sender;
    }
    ...
    uint256 _tokenID) public {
        P2PLoan p2pLoan = getContractByIndex(_index);
    ...
    function getContractByIndex (uint256 _index) public view returns(P2PLoan p2ploanContract){
        p2ploanContract = P2PLoan(address(loanFactory[msg.sender].p2ploans[_index]));
