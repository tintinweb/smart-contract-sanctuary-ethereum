    ...
    ERC2981
{
    ...
    ) ERC721A(name_, symbol_) OrderPortInvoke(orderPortAddress_) {
        _config = config_;
    }
     ...
     */
    function airdrop(address[] calldata addresses_, uint64[] calldata nums_)
        external
        onlyOwner
        nonReentrant
    {
     ...
     */
    function whitelistSale(address address_, uint32 num_)
        external
        payable
        onlyOrderPort
        nonReentrant
     ...
     * @param num_ number of tokens
     */
    function publicSale(address address_, uint32 num_)
        external
        payable
        onlyOrderPort
        nonReentrant
     ...
     */
    function setWhitelistConfig(WhitelistSaleConfig memory config_)
        external
        onlyOwner
    {
     ...
     */
    function setPublicSaleConfig(PublicSaleConfig memory config_)
        external
        onlyOwner
    {
     ...
     */
    function _checkTimestamp(uint256 startTime_, uint256 endTime_)
        internal
        view
        returns (bool)
    {
     ...
     */
    function getMinted(address address_)
        public
        view
        returns (uint32 whiltelistMinted, uint32 publicSaleMinted)
    {
