...
contract PatriotNFT is ERC721, Ownable {
    ...
    uint256 public totalSupply; // Current number of NFTs during mint
    uint256 public maxSupply;   // Max number of NFts in the collection
    uint256 public maxPerWallet; // Defines max NFT allowed
    ...
    constructor() payable ERC721('PatriotNFT', 'PCTFNFT'){
