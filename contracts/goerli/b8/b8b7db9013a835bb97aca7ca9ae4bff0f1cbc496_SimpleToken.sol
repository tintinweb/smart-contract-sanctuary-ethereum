...
contract SimpleToken is ERC20Interface, OwnerHelper {
    ...
    function lockPersonalToken(address _who) public onlyOwner returns(string memory) {
      require(!_personalTokenLock[_who] || _personalTokenLock[_who] == false, "ERC20: The address had already been locked");
