...
contract MoonDescriptor is IDescriptor {
    struct Color {
        string value;
        string name;
    }
    ...
    function tokenURI(uint256 tokenId, uint256 seed) external pure override returns (string memory) {
        ...
        string memory description = 'Moon';
            ...
            abi.encodePacked(
                ...
                Base64.encode(
                    bytes(
                        abi.encodePacked(
                            '{',
                            '"name":"MOON #', tokenId.toString(), '",',
                            '"description":"', description, '",',
                            '"image": "', 'data:image/svg+xml;base64,', encodedSvg, '",',
                            '"attributes": [{,',
                            '{"trait_type": "Colors", "value": ', head.name, '}',
                            '{"trait_type": "Colors", "value": ', head.color.name, '}',
                            '{"trait_type": "Colors", "value": ', face.name, '}',
                            '{"trait_type": "Colors", "value": ', face.color.name, '}',
                            '{"trait_type": "Colors", "value": ', nose.name, '}',
                            '{"trait_type": "Colors", "value": ', nose.color.name, '}',
                            '{"trait_type": "Colors", "value": ', body.name, '}',
                            '{"trait_type": "Colors", "value": ', body.color.name, '}',
                            ']',
                            '}')
                    )
                )
