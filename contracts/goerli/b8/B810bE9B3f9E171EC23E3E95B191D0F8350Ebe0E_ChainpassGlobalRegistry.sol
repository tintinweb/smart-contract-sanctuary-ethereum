...
contract ChainpassGlobalRegistry is Ownable {
    using Strings for uint256;

    string public baseUri;
    address public chainpassEventRegistryContractAddress;
    ...
    function getChainpassEventRegistryContractAddress() public view returns (address) {
        return chainpassEventRegistryContractAddress;
    }

    function setChainpassEventRegistryContractAddress(address addr) public onlyOwner {
        chainpassEventRegistryContractAddress = addr;
    }
    ...
    function setUSDCContractAddress(address addr) public onlyOwner {
    ...
    function setChainpassWallet(address addr) public onlyOwner {
        chainpassWallet = addr;
    }

    function setChainpassMarketplaceContractAddress(address addr) public onlyOwner {
