...
contract AtamoAscension is ERC721A, VRFConsumerBaseV2, Ownable {
    ...
    modifier onlyIfWinnersSelected() {
        require(prizeWinners.length > 0, "Winners must be selected");
        _;
    }
    ...
    function setWLLimit(uint256 _newLimit) public onlyOwner {
     ...
     function setPrizesAmount(uint256 _newAmount) public onlyOwner {
        PRIZES_AMOUNT = _newAmount;
    }
    ...
    function sendGiftsToWinner(address collectionAddress) external onlyIfWinnersSelected onlyOwner {
