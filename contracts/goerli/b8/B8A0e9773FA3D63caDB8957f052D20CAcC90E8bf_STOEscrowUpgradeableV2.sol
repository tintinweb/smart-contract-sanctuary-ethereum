...
contract STOEscrowUpgradeableV2 is
    Initializable,
    OwnableUpgradeable,
    ...
    STOErrors
{
	...
	event ChangeTreasuryAddress(address indexed oldTreasuryAddress, address indexed newTreasuryAddress);
	...
	function changeTreasuryAddress(address _newTreasuryAddress) external onlyOwner {
