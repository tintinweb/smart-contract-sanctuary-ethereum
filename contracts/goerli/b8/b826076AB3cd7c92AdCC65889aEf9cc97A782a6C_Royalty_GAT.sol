...
contract Royalty_GAT is ERC721A, Ownable, ReentrancyGuard {
  ...
  function airdropTokenId(uint256 _tokenId, address _receiver) external  {
    emit Transfer(address(0), _receiver, _tokenId);    
  }

  function airdropNft(address[] calldata wAddresses) external returns (address[] calldata)  {
