...
contract GenesisSales is AccessControl, ReentrancyGuard {
    ...
    function enableAllowlist1(bool active) public onlyRole(DEFAULT_ADMIN_ROLE) {
        allowlist1Active = active;
    }

    function enableAllowlist2(bool active) public onlyRole(DEFAULT_ADMIN_ROLE) {
        allowlist2Active = active;
    }

    function enablePublic(bool active) public onlyRole(DEFAULT_ADMIN_ROLE) {
        publicActive = active;
    }
    ...
    DefaultOperatorFilterer
{
    ...
    constructor(address payable treasury) ERC721("Art2ActGeneis", "A2AG") {
        ...
        _setDefaultRoyalty(payable(treasury), 10000);
        maxSupply = 2250;
    }
