...
contract testContract2 is ERC721A, Ownable {
    ...
    constructor() ERC721A("testContract2", "test2") {}
    ...
    function withdraw() external onlyOwner {
        ...
        /** Transfer 2% of total mint proceeds to the #1 referrer **/
        payable(topDogAddress).transfer(balance / 50);
