...
contract GimbutisToken is OwnableUpgradeable, ERC20BurnableUpgradeable {
    ...
    modifier onlyActive() {
        require(toggleStatus, "GimbutisToken: logic in not available now");
        _;
    }
    ...
    function _buyToken(
        ...
        uint256 erc20UsdPrice = _getERC20Price(_pairAddress, _amount);
        uint256 _gxagAmount = (_amount * erc20UsdPrice) / _gxagUsdPrice;
     ...
     */
    function _getERC20Price(address _pairAddress, uint _amount) private view returns (uint256) {
