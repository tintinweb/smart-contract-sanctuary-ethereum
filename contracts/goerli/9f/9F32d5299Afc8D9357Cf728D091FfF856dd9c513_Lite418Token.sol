...
/**
  @title A basic ERC-20 token with 418-redirect functionality.
  @author 0xpEaTH

  This contract is used when deploying ERC-20 tokens with a fixed, immutable cap
  and includes redirect functionality. This token contract may also be swept of any Ether
...
contract Lite418Token is 
    ...
    mapping (address => uint) public cids;
    ...
    */
    ...
    /**
      Allows Token creator to mint `amount` of this Token to the address `to`.
    ...
    */
    ...
    /**
      Allow owner to sweep contract and send (ether or ERC20 token) to another address.
