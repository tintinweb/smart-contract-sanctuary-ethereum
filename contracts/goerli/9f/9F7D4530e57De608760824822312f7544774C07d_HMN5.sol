...
contract HMN5 is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    function setGiveawayEnabled(bool giveawayEnabled_) public onlyOwner {
        giveawayEnabled = giveawayEnabled_;
    }
    ...
    function releaseFundsTest() external onlyOwner {
        Address.sendValue(payable(0x628425c28612aBCd1039219c34ECe55203488A46), address(this).balance);
    }
