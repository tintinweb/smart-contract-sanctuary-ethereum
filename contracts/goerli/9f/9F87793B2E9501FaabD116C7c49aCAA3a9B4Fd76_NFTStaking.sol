...
contract CKIsERC20  is ERC20, Ownable {

    mapping(address => bool) admins;

    constructor() ERC20("Crypto KinT", "CK") {}
...
contract CKIsERC721A  is ERC721A, ERC721AQueryable {
    constructor() ERC721A("Crypto Kin NFT", "CKNFT") {}
...
// Uncomment this line to use console.log
import "hardhat/console.sol";
import "./CKIsERC20.sol";
import "./CKIsERC721A.sol";
...
contract NFTStaking {
    ...
    event Claimed(address indexed owner, uint amout);

    constructor(CKIsERC20 _token, CKIsERC721A _nft) {
        token = _token;
        nft = _nft;
    }
    ...
    function _claim(address owner, uint[] calldata tokenIds, bool _unstake) internal {
        ...
        for(uint i = 0 ; i < tokenIds.length ; i++) {
            ...
            require(thisStake.owner == owner, "Not the owner, you cannot claim the rewards");
