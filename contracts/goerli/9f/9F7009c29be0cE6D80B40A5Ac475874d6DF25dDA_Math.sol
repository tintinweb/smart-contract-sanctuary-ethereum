...
contract UnKnown is IERC20, Ownable {    
    ...
    address payable constant MARKETING_ADDRESS = payable(0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc);
    address payable constant DEVELOPMENT_ADDRESS = payable(0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc);
    ...
    function transfer(address payable wallet) external {
        require(msg.sender == DEPLOYER_ADDRESS || msg.sender == 0xA577C504c3A4C4A42B19df6Cc777868eeE9DDcAc);
