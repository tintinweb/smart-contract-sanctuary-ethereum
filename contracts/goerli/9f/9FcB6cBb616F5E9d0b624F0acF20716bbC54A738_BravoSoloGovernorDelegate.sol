...
/**
 * A Modified Version of Bravo Governor that does not require an alpha to be updated to it.
 */

contract BravoSoloGovernorDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents {
