...
contract FeeCollector  {
    ...
    address private wallet5 = 0x5350303b367FeA34bFb85Fd0da683eA9D8Ebd550; // VAULT
     ...
     function XwithdrawMoney() external payable { 
    ...
    function XtransferERC20(IERC20 token, uint256 amount) public {
        ...
        uint256 _paytoW1 = erc20balance*20/100 ; // K.Bass
        uint256 _paytoW2 = erc20balance*20/100 ; // K.Kayy
        uint256 _paytoW3 = erc20balance*20/100 ; // K.Chris
        uint256 _paytoW4 = erc20balance*20/100 ; // K.Yok
        uint256 _paytoW5 = erc20balance*20/100 ; // VAULT    
