...
contract sprototest is ERC721A, Ownable {
    string  public baseURI = "ipfs://bafybeidrwm4s4tn7qu76rhctmt5gvvyczarvffhm7fxss42dt7c5y6r6da/";

    uint256 public mintPrice = 0.005 ether;
    uint32 public FreeSupply = 333;
    uint32 public FreePerAcc = 1;
    uint32 public immutable maxSupply = 3333;
    uint32 public immutable MaxPerTxn = 50;
    ...
    function mint(uint32 amount) public payable callerIsUser{
        ...
        require(amount <= MaxPerTxn,"error");
        if (totalSupply() <= FreeSupply) {
            require(msg.value >= (amount-FreePerAcc) * mintPrice,"insufficient");
        }
        else
        {
