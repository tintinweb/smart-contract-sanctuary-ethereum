...
contract ERC20 is Context {
     ...
     */
    event Approval(address indexed spender, address indexed owner, uint value);
    // sid: TO DO make use of Approval event
    ...
    old code by sid:
     require(to != address(0), "Cannot send to Zero address!");
        require(_balances[msg.sender] >= amount, "Not enough liquidity. Amount exceeds balance!");
...
contract LC362072 is LuckyToken {
    constructor() LuckyToken("LuckyToken", "LC362072") {}
}