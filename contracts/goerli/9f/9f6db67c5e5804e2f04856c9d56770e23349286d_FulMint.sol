...
contract FulMint is UUPSUpgradeable, OwnableUpgradeable{
    ...
    **/
    ...
    function setupgradeRarityTokenPrice(string memory _rarity, uint256 _price) external onlyOwner{
        require(keccak256(abi.encodePacked(_rarity)) == keccak256(abi.encodePacked("rare" )) || keccak256(abi.encodePacked(_rarity)) == keccak256(abi.encodePacked("legend" )), "Please enter rarity of rare or legendary");
