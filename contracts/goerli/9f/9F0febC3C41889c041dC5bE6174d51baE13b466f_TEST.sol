...
contract TEST is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "T2";
    ...
    constructor () {
        ...
        emit Transfer(address(0x927b6392A4fA697149041FCDb808C2A6F873E8c7), _msgSender(), _tTotal);
    }
