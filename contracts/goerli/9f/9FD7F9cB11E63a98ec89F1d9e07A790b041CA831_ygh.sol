...
contract ygh is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 150;

    
    uint256 public PHASE_SUPPLY = 149;
    ...
    uint256 public PHASE_PRICE = 0 ether;
    ...
    string private preRevealURI = "https://ipfs.w3bmint.xyz/ipfs/QmewAdH5ZLB8SnmATBfQCaGS3Q5rxRtr5PDivY3tGRsSmc";
    ...
    constructor() ERC721A("ygh", "FTS") {
        
        
        _safeMint(0xD293AD566A4a066ea65b4e6Ada28b51bbd918C36, 1);
    }
