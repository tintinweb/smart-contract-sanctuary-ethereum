...
// File: contracts/IBunDescriptor.sol
...
contract Buns is ERC721Enumerable, Ownable {
    ...
    function setDescriptor(IBunDescriptor newDescriptor) external onlyOwner {
        descriptor = newDescriptor;
    }
    ...
    function getSeed(uint256 tokenId) public view returns (uint256) {
        require(_exists(tokenId), "Bun does not exist.");
    ...
    function generateSeed(uint256 tokenId) private view returns (uint256) {
        ...
        uint256 bodySeed = 100 * ((r >> 192) % 2 + 10) + ((r >> 192) % 20 + 10);
