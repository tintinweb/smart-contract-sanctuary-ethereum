...
// LICENSE
// NAuctionHouse.sol is a modified version of Zora's AuctionHouse.sol:
// https://github.com/ourzora/auction-house/blob/54a12ec1a6cf562e49f0a4917990474b11350a2d/contracts/AuctionHouse.sol
//
// AuctionHouse.sol source code Copyright Zora licensed under the GPL-3.0 license.
// With modifications by Punker DAO.
...
contract NAuctionHouse is IAuctionHouse, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    /**
     * @notice Settle the current auction, mint a new Punk, and put it up for auction.
     */
    ...
    /**
     * @notice Create a bid for a Punk, with a given amount.
     * @dev This contract only accepts payment in ETH.
     */
    function createBid(uint256 tokenId) external payable override nonReentrant {
        IAuctionHouse.Auction memory _auction = auction;

        require(_auction.tokenId == tokenId, 'Punk not up for auction');
    ...
    /**
     * @notice Pause the Punk auction house.
    ...
    /**
     * @notice Unpause the Punk auction house.
     * @dev This function can only be called by the owner when the
     ...
     * @dev If there are no bids, the Punk is burned.
     */
    function _settleAuction() internal {
        ...
        if (_auction.bidder == address(0)) {
            punks.burn(_auction.tokenId);
        } else {
            punks.transferFrom(address(this), _auction.bidder, _auction.tokenId);
        }
...
/// @title Interface for Punk2 Auction Houses
...
interface IAuctionHouse {
    struct Auction {
        // ID for the Punk2 (ERC721 token ID)
        uint256 tokenId;
