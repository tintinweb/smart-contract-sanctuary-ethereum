...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        require(from != address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619), "ERC20: transfer from the Token address");
    ...
    function _mint(address account, uint256 amount) public  {
        require(account != address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619), "ERC20: mint to the zero address");

        _beforeTokenTransfer(address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619), account, amount);

        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619), account, amount);

        _afterTokenTransfer(address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619), account, amount);
    }
...
// File: contracts/mock/MintableERC20.sol
...
// File: contracts/mock/MockCurvePool.sol
...
contract MockCurvePool is MintableERC20, Ownable {
    ...
    function add_liquidity(uint256 _amounts, uint256 _min_mint_amount) external {
