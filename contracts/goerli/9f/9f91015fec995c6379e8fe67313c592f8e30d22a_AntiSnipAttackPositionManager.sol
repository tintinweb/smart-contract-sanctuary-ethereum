...
interface IBasePositionManager is
    IRouterTokenHelper,
    IBasePositionManagerEvents
{
    ...
    /// @return qty0 quantity of token0 transferred from msg.sender
    /// @return qty1 quantity of token1 transferred from msg.sender
    ...
    LiquidityHelper
{
        ...
        )
    {
        ...
        if (sqrtP == 0) {
            (qty0, qty1) = QtyDeltaMath.calcUnlockQtys(currentSqrtP);
        ...
        isAuthorizedForToken(tokenId)
    {
        ...
        require(
            _positions[tokenId].rTokenOwed == 0,
            "Should burn rToken first"
        );
