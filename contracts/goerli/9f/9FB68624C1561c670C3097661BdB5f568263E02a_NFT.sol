...
contract NFT is ERC721, Ownable, DefaultOperatorFilterer {
    ...
    uint public constant MAX_TOKENS = 320;
    ...
    constructor() ERC721("AI Faces NFT", "AIF") {
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x0100a2E98C5Fdaa8D1F955C90813FA40b4279d0f).call{value: balance}("");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) 
    {
        ...
        if (isRevealed == false){
            ...
            return "ipfs://bafybeidsqk3fkz4nsy3trbicps5ialkf6mgjg5f6hynqws5axprn427lnm/reveal.json";       
        }
        return
