    ...
    IERC2981
{
    ...
    function createEdition(
        ...
        _mint(owner(), id, _supply, "0x0000");
        nextEditionId.increment();
        emit EditionCreated(id);
    }

    /**
     * @dev Sets the URI to the tokens metadata
     */
    ...
    /**
     * @dev Sets the royalty for a token id
     */
    function setEditionRoyalty(
        ...
        editions[id].royaltyPercentage = royaltyPercentage;
    }
    ...
    {
        receiver = editions[id].royaltyReceiver;
        royaltyAmount = (salePrice * editions[id].royaltyPercentage) / 100;
    }
    ...
    /**
     * @dev helper function to get editions array
     */
