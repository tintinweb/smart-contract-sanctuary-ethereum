    ...
    Ownable
{
    ...
    function publicSaleMint(uint256 _quantity) external payable {
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY, "SUPPLY_EXCEEDED");
        require(
    ...
    function addPrivateSale(uint256 _kind, PrivateSale memory _privateSale)
        external
        onlyOwner
    {
    ...
    function updatePublicSale(PublicSale memory _publicSale)
        external
        onlyOwner
    {
