...
contract NFTCredential is ERC721A, Ownable {
    ...
    constructor(uint256 _newMaxBatchSize)
        ERC721A("ERC721A TEST TOKEN v1", "TEST-v1") // TODO: change before production release
    {
    ...
    function mintAndTransfer(
        ...
        for (uint i = 0; i < requestNum; i++) {
            ...
            _setTokenURI(
                tokenId,
                generateTokenURI(_imageURIs[i], _externalURIs[i])
            );
            tokenId += 1;
        }
    }
    ...
    function updateNFT(
        ...
        // update the tokenURI
        _setTokenURI(tokenId, generateTokenURI(_imageURI, _externalURI));
    }
    ...
    function generateTokenURI(
        ...
        string memory _name = "Foobar NFT name"; // TODO: change before production release
        string memory _description = "Foobar NFT description"; // TODO: change before production release
