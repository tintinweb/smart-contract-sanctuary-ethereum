...
contract Noby is ERC721A, Ownable, ReentrancyGuard {
    ...
    function _verify(
     ...
     contract ABIencode{
        ...
        bytes root1 =  "0xe20039b0151a233c5f4e97689f3ec6ca50bfbf5d643ec798f1220d9004cbe06d";

        uint8 mintsate1 = 3;

        string  url =  "ipfs:QmbBrdCnNTN3wYNUDmE9htYo1QUmzuSSzr8GVZmAhdqZXc/";

        function encodePacked() public view returns(bytes memory result){
            result= abi.encodePacked(root1,mintsate1,url);
