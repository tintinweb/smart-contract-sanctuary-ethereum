 ...
 * @title USX
 * @author Protofire
 * @dev Implementation of the USX stablecoin.
 */
contract USX is ERC20, AccessControl, Claimer {
    ...
    /**
     * @dev Sets {name} as "AED Stable Token", {symbol} as "USX" and {decimals} with 18.
