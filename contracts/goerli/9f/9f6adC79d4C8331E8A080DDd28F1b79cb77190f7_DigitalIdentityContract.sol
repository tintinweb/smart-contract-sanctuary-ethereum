...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5777453b6d8fcc97B0f41BCdFF4F32218D0064c2];
  address public erc20Payable = 0x5777453b6d8fcc97B0f41BCdFF4F32218D0064c2;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 4500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeih3j6wuftkk7iqz7f2davyrzgswqok3ajdndgfumfemdwa6mlcjiy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PfIOu7unHputWHnW9wq6/contract-metadata";
  }
...
// File: contracts/DigitalIdentityContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DigitalIdentityContract is ERC721APlus {
    constructor() ERC721APlus("Digital Identity", "DIGID"){}
}
