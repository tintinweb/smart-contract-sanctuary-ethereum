...
// File: contracts/RidoSwap/contracts/BaseToken.sol
...
// File: contracts/RidoSwap/contracts/interfaces/IUniswapV2Factory.sol
...
// File: contracts/RidoSwap/contracts/interfaces/IUniswapV2Router02.sol
...
// File: contracts/RidoSwap/Copy_RidoWithSwap.sol
...
contract RideDao is IERC20, Ownable, BaseToken {
    ...
    constructor() payable {
        string memory name_ = "RideDao";
        string memory symbol_ = "Rido";
        uint256 totalSupply_ = 6000000000 ether;
        address router_ =address(0xEfF92A263d31888d860bD50809A8D171709b7b1c);
        address charityAddress_ = address(0xc2b642856f06fE467a046189cC466E8c4BEFA469);
        address developerAddress_ = address(0xc2b642856f06fE467a046189cC466E8c4BEFA469);
        uint256 maxWalletPercent_ = 25;
        // uint16 taxFeeBps_,
        // uint16 liquidityFeeBps_,
        // uint16 charityFeeBps_,
        // uint16 developerFeeBps_,
        uint16[4] memory Bps = [1001, 0, 0, 0];
        address serviceFeeReceiver_ = address(0xc2b642856f06fE467a046189cC466E8c4BEFA469);
    ...
    function excludeFromReward(address account) public onlyOwner {
        // require(account != 0xB10E4A7Dc9ECac53ccdE57515265704FD801FDEc, 'We can not exclude Uniswap router.');
    ...
    function setDeveloperFeePercent(uint256 developerFeeBps)
        external
        onlyOwner
    {
    ...
    function _takeDeveloperFee(uint256 tDeveloper) private {
        if (tDeveloper > 0) {
            uint256 currentRate = _getRate();
            uint256 rDeveloper = tDeveloper.mul(currentRate);
            _rOwned[_developerAddress] = _rOwned[_developerAddress].add(
                rDeveloper
            );
    ...
    function _transfer(
        ...
        require(
            _tOwned[to] + amount <= _getMaxHolding(),
