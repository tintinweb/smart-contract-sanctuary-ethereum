...
contract TIMEVALUE3 is ERC721, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("TIMEVALUE3", "TV3") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://whimsical-meringue-5bde66.netlify.app/";
    }
