...
//    bytes32 public merkleRoot = 0x3f4500794b717c7e25c0cfe9ee3f5bd58ae0af57ef2038de6847879660d0c9f1;
    ...
    mapping(address => uint256) private _totalClaimsMade;
...
//
//            toReturn -= min(_totalClaimsMade[wallet], toReturn);
...
//            }
            ...
            toReturn = 3 - _totalClaimsMade[wallet];
...
//        require()
        ...
        _totalClaimsMade[msg.sender] += numFreeCopy;
