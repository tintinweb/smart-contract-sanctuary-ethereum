...
contract Mecole is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Mecole Hardman", "MC") {
        _editionToTokenUri[1] = "ipfs://bafybeibbd7szxhd6nlw266djelfm6klpmjqjkdid2ciyvn74663fpist5m/PreseasonEdition.json";

        _editionToMaxSupply[1] = 250;
        _editionToMaxSupply[2] = 247;
        _editionToMaxSupply[3] = 3;

        _editionToPrice[1] = 10000000000000000;
        _editionToPrice[2] = 10000000000000000;
        _editionToPrice[3] = 10000000000000000;
    }

    // MAKE WAY FOR US TO MINT FOR FREE
