...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    uint256 public minBuy       = 0.0001 * 1e6;     //150   USDT;
    uint256 public maxBuy       = 0.01 * 1e6;       //750   USDT
    uint256 public sale_price   = 0.00045 * 1e6;    //0.043 USDT;
    ...
    constructor (uint256 buyTime_, uint256 lockTime, uint256 claimTime_, address payable manager_, 
        ...
        USDT = IERC20(0x2260f1e1cE50F59ddBD61cDA90922bfb24b47f46);   // USDT address on Ethereum mainnet
    }
