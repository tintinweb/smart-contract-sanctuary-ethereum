...
contract sellItMarketPlaceV2 is Initializable , ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable , UUPSUpgradeable{
...
//    }
    ...
    function initialize(address _marketplaceOwner,uint256 _setServiceFee) public initializer {
        __ERC721_init("Sell it marketplace","umar");
        __Ownable_init();
        __UUPSUpgradeable_init();
