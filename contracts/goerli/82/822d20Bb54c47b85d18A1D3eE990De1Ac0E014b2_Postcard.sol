...
contract Postcard is
    ...
    Pausable
{
    /// Minter role. An address with this role is allowed to mint a Postcard.
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    /// Base URI for metadata.
    string private baseURI;

    constructor(string memory baseURI_, address _trustedForwarder)
        ERC2771Context(_trustedForwarder)
        ERC721("Postcard", "POSTCARD")
    {
        baseURI = baseURI_;
    ...
    /// @param baseURI_ the new base URI to be used
...
// Deployed on 2022-01-01: 0xe91A7256d51295d3964F011a849b2d6d91cfa816
...
// Deployed on 2022-02-02: 0x5AB5E0f2eb410ACedB30E365c20572dC8ab4c4a8
