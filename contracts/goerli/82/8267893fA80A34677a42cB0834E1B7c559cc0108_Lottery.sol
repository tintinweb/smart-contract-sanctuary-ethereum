...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
     ...
     * note: Admin compensates USDC because of USDC amount loss when Player transfers USDC.
     * Keeps the Lottery "No Loss"
     * note: TODO Automate
     */
    function adminFundLotteryWithUSDC(uint256 _usdcAmount) external {
        usdc.transfer(address(this), _usdcAmount);
    }
