    ...
    ERC721AUpgradeable
{
     ...
     */
    event EMechMinted(address receiverAddress, uint tokenId, string tokenURI);
    ...
    */
    function mintEMech(address _receiverAddress, string calldata _uri) external {
        uint _tokenId = _nextTokenId();
        _mint(_receiverAddress, FIXED_BUYING_UNIT);
        setURI(_tokenId, _uri);
        emit EMechMinted(_receiverAddress, _tokenId, _uri);
    }

    function mintBulkEMech(uint _index, address _receiverAddress, string calldata _uri) external {
    ...
    */
    function setURI(uint256 _tokenId, string calldata _uri) internal {
        require(
            ownerOf(_tokenId) == msg.sender,
            "setURI: Only owner of the token can set URI"
        );
