...
contract LuckyDraw is Ownable {
    ...
    event TransferEvent(uint256 _round ,address indexed _from, address indexed _to, uint256 _value, string _event);
        ...
        onlyOwner 
    {
        ...
        emit TransferEvent(currentRound, address(this), toAccount, reward, "Transfer reward");
        payable(owner()).transfer(fee);
        emit TransferEvent(currentRound, address(this), owner(), fee, "Transfer fee");
        adminReset();
    }
