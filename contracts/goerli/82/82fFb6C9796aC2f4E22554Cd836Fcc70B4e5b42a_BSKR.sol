...
contract BSKR is BaseBSKR {
    ...
    address private immutable _paydayAddress;
    ...
    uint16[6] private _currFees = [200, 150, 100, 50, 50, 550];
    ...
    function _swapTokensForEth(uint256 tokenAmount) private {
        ...
        _approve(address(this), address(this), tokenAmount); // allow address(this) to spend its tokens
        _approve(address(this), address(_dexRouterV2), tokenAmount);
