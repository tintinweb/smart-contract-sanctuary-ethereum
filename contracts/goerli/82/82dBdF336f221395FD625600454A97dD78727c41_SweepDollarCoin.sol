...
contract SweepDollarCoin is BaseSweep {
    ...
    function sweep_info() public view returns (uint256, uint256, uint256) {
        return (
    ...
    /* ========== PUBLIC FUNCTIONS ========== */
    function beginNewPeriod(uint256 _new_period_time, uint256 _new_target_price) public onlyByOwnGov {
    ...
    function setPriceTarget(uint256 _new_target_price) public onlyByOwnGov {
        ...
        previous_target_price = target_price;
        next_target_price = target_price * (1 + global_interest_rate**(period_time / TIME_ONE_YEAR)); 
