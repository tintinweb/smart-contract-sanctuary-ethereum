...
// ERC721URIStorageはERC721を継承している
contract CounterNFT is ERC721URIStorage, Ownable {
     ...
     */
    using Counters for Counters.Counter; // CountersライブラリのCounter型の構造体に対してCountersライブラリの関数を全てアタッチするという意味
    Counters.Counter private _tokenIds; // 外部からtokenIdを受け取らないためprivate
     ...
     * - tokenIdをインクリメント _tokenId.increment()
     * - nftMint関数の実行アドレスにtokenIdを紐付け
     * - mint時にuriを設定 _setTokenURI()
