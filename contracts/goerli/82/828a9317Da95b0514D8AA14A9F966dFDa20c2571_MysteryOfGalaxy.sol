...
█░▀░█ ░█░ ▄█ ░█░ ██▄ █▀▄ ░█░   █▄█ █▀░   █▄█ █▀█ █▄▄ █▀█ █░█ ░█░
*/
contract MysteryOfGalaxy is ERC721A, Ownable {
    ...
    constructor() ERC721A("MysteryOfGalaxy", "MOG") {
        mintIsActive = false;
        baseURI = '';
        price = 0.0077 ether;
        whitelistPrice = 0.0055 ether;
        mintLimit = 5;
        maxSupply = 555;
    }
    ...
    function mint(uint256 quantity) external payable {
        require(mintIsActive, "The mint is not active.");
