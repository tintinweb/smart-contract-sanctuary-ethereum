...
contract ClawFinance is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1049775 * 10**_decimals;
    string private constant _name = unicode"ClawFinance";
    string private constant _symbol = unicode"CLAF";
