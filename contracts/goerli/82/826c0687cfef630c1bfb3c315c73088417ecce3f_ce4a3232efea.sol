...
contract ce4a3232efea is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        string memory background = "ipfs://bafkreic4fuzesyosya7gvrmnodveo6qrvcqblfir5zsf62giemeif5oocu";
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "REPLACE_THIS_VALUE #', toString(tokenId), '", "description": "The End Is Just The Beginning.", "image": "', background, '"}'))));
