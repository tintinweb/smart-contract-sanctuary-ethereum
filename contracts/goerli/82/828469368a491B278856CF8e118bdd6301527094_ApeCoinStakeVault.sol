...
contract ApeCoinStakeVault is ERC4626, IApeCoinStakeVault, Ownable {
    ...
    constructor(
        ...
        require(_fees < 10000, "Invalid Basis point value");
        FEE = _fees;
...
interface IApeCoinStaking {
    ...
    function withdrawBAYC(SingleNft[] memory _nfts, address _recipient)
        external;
    ...
    function withdrawMAYC(SingleNft[] memory _nfts, address _recipient)
        external;
    ...
    function nftPosition(uint256 _poolId, uint256 _tokenId)
        external
        view
