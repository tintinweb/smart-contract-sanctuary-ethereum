 ...
 * @notice This contract handles minting We Key test tokens.
 */
contract LaunchpadWeKeyTest is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeic4sr7jirxt5p7dlteuyhjyddm3vu4wmrdgczfvh5cgxizq3qnr7m/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 2300;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 1836;
    ...
    uint256[] public payoutBasisPoints = [6500, 3500];
    uint96 public royaltyFee = 700;

    constructor() ERC721A("We Key test", "KEYT") {
