...
ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721CappedUpgradeable,
ERC721BurnableUpgradeable {
    ...
    function safeMint(address to, string memory uri)
				...
				whenNotPaused
		{
			  require(ERC721EnumerableUpgradeable.totalSupply() <= cap(), "ERC721: cap exceeded");
 ...
 */
abstract contract ERC721CappedUpgradeable is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable {

	  uint256 private _cap;

    /**
     * @dev Sets the value of the `cap`. It can only be changed by owner.
     */
    function __ERC721Capped_set(uint256 cap_) internal onlyOwner {
        __ERC721Capped_set_unchained(cap_);
    }

    function __ERC721Capped_set_unchained(uint256 cap_) internal onlyOwner {
