...
contract Recordian721NFTs is ERC721Enumerable, Ownable {
    using Strings for uint256;
...
contract Recordian1155NFTs is ERC1155, Ownable {
    string public name;
    ...
    function mint(uint256 _id) public onlyOwner {
        // require(_amount + _totalSupply[_id] <= tokenSupply, "Can't mint more than the total supply");
        _mint(msg.sender, _id, totalSupply, "");
        tokenSupply[_id] = totalSupply;
    }
...
contract NFTCollectionFactory {
    ...
    ) external virtual returns (address newNFTCollectionAddress) {
        Recordian721NFTs newNFTCollection = new Recordian721NFTs(
            name,
            symbol,
            baseURI,
            1
    ...
    function createNFT1155(
        ...
        Recordian1155NFTs newNFTCollection = new Recordian1155NFTs(
            _name,
            _symbol,
            _totalSupply,
            _newURI
