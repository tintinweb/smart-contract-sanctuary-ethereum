...
contract NeonBunnyContract is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
mapping(address => uint256) public alreadyFreeMinted;
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && balanceOf(msg.sender) < maxPerWalletPublic && _mintAmount <= maxPerWalletPublic, 'Invalid mint amount!');
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    {
    require(amount > 0, "Amount have to be > 0");
		require(balanceOf(msg.sender) < maxPerWalletPublic, "You can't mint more!");
    require(amount <= maxPerWalletPublic, "You can't mint this amount");
