...
contract CharityVerification is ERC721, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    /// @dev Retrun boolean with charity Id (EIN)
    function checkVerifiedCharity(string calldata _charityId) view public returns (bool) {
        return verifiedCharities[_charityId];
    }

    /// @dev Return boolean with safe address (Gnosis)
    function checkVerifiedSafe(address _safeAddress) view public returns(bool) {
        return verifiedSafes[_safeAddress];
    }
