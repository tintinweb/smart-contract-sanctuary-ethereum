...
struct Name {
    ...
    bool available;
    uint256 balance;
    mapping(string => bool) subdomainAvailable;
}

/* TODO: 
1. mint fee [v]
2. records: resolved address
3. parent_cannot_control [v]
...
contract NaiveSubdomainRegistrar is BaseSubdomainRegistrar, ERC1155Holder {
    ...
    function register(
        ...
        require(names[parentNode].subdomainAvailable[label], "this subdomain has been minted");
        ...
        names[parentNode].subdomainAvailable[label] = false;
    }
}