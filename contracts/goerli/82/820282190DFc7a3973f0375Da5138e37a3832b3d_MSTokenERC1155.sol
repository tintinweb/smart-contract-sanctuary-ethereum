...
// Thirdweb top-level
import "../interfaces/IMSFee.sol";

contract MSTokenERC1155 is
    Initializable,
    EIP712Upgradeable,
    ...
    ITokenERC1155
{
    ...
    IMSFee public immutable mondesingulierFee;
    ...
    constructor(address _mondesingulierFee) initializer {
        mondesingulierFee = IMSFee(_mondesingulierFee);
    }
    ...
    function initialize(
        ...
        _owner = _creatorAdmin;
        _setupRole(DEFAULT_ADMIN_ROLE, _defaultAdmin);
        _setupRole(MINTER_ROLE, _defaultAdmin);
        _setupRole(MINTER_ROLE, _creatorAdmin);
        _setupRole(TRANSFER_ROLE, _creatorAdmin);
    ...
    function collectPrice(MintRequest memory _req) internal {
        ...
        (address twFeeRecipient, uint256 twFeeBps) = mondesingulierFee.getFeeInfo(address(this), FeeType.PRIMARY_SALE);
...
import "../../extension/interface/IMSPlatformFee.sol";
import "../../extension/interface/IMSPrimarySale.sol";
import "../../extension/interface/IMSRoyalty.sol";
import "../../extension/interface/IMSOwnable.sol";
...
contract ERC1155Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC1155Upgradeable, IERC1155MetadataURIUpgradeable {
    ...
    function _safeTransferFrom(
        ...
        emit TransferSingleERC1155(operator, from, to, id, amount);
    ...
    function _mint(
        ...
        _balances[id][to] += amount;
        emit TransferSingleERC1155(operator, address(0), to, id, amount);
    ...
    function _burn(
        ...
        emit TransferSingleERC1155(operator, from, address(0), id, amount);
    }
...
interface IERC1155Upgradeable is IERC165Upgradeable {
     ...
     */
    event TransferSingleERC1155(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value);
...
interface IMSRoyalty is IERC2981Upgradeable {
    struct RoyaltyInfo {
        address recipient;
        uint256 bps;
    }
