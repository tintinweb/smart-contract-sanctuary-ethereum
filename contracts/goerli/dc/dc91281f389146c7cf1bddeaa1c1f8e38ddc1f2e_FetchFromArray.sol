...
contract FetchFromArray is ChainlinkClient, ConfirmedOwner {
    ...
    function requestFirstId() public returns (bytes32 requestId) {
        ...
        req.add(
            "get",
            "https://api.coingecko.com/api/v3/simple/price?ids=tominet&vs_currencies=usd&include_market_cap=false&include_24hr_vol=false&include_24hr_change=false&include_last_updated_at=false"
        );
        ...
        req.add("path", "0,tominet"); // Chainlink nodes 1.0.0 and later support this format
        // Sends the request
