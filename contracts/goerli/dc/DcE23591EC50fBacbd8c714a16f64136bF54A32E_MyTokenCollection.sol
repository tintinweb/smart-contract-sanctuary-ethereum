...
contract MyTokenCollection is ERC721Enumerable, Ownable {
  ...
  function _merkleProofCheck(bytes32[] calldata _merkleProof) internal view {
    require(MerkleProof.verify(_merkleProof, waitingListMerkleRoot, keccak256(abi.encodePacked(msg.sender))), "invalid proof, you're not on the list.");
  }
  ...
  function isEligibleForWhitelistMint(bytes32[] calldata _merkleProof) external view returns (bool) {
    ...
    _merkleProofCheck(_merkleProof);
