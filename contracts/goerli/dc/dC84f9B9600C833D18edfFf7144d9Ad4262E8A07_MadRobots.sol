...
contract MadRobots is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint public constant MAX_GIVEAWAY_TOKENS = 30;
  uint256 public constant TOKEN_PRICE = 0; //0ETH in wei
  ...
  function mintGiveaway(uint256 numTokens, address to) public onlyOwner {
    require(countMintedGiveawayTokens.add(numTokens) <= MAX_GIVEAWAY_TOKENS, "Only 30 tokens max");
    for (uint i = 0; i < numTokens; i++) {
