...
contract WomanTest is ERC721, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string public uriPrefix = "https://womenrise.art/meta/";
  ...
  constructor() ERC721("NFT test2", "FTSQ") {
    setHiddenMetadataUri("ipfs://QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/8");
  }
  ...
  function setERC20(address _txToken) public onlyOwner {
    txToken = _txToken;
  ...
  function claimReward() external nonReentrant() {
    ...
    returns (uint256[] memory)
  {
    uint256 ownerTokenCount = totalNFTThatHaveRewardPerAddress(_owner);
    uint256 currentSupply = totalSupply();
    uint256[] memory ownedTokenIds = new uint256[](ownerTokenCount);
    uint256 index = 0;
    ...
    returns (NFT[] memory)
  {
   ...
   function viewAllYourNFTIdthatWithReward()
    ...
    function totalNFTThatHaveRewardPerAddress(address _holder) public view returns (uint256) {
      uint256 total;
