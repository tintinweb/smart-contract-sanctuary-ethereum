...
abstract contract RaffleVRFRandomPick is Raffle, VRFConsumerBaseV2 {
    ...
    uint64 private constant _subscriptionId = 1; // Subscription ID of the VRF consumer
     ...
     * @dev hint: use the modulo of this.entryCount(), then use the _resolveRandomPick function 
     */
