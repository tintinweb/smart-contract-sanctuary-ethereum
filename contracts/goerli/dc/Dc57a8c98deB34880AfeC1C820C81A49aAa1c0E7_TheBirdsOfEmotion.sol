...
contract TheBirdsOfEmotion is ERC721A, Ownable, ERC2981, VRFV2WrapperConsumerBase {
    /* PROVENANCE HASH */
    string public provenanceHash;
    uint256 public startingIndex;
    /**
     * @dev set the provenance hash for emergency only if art needs to be fixed (not affecting order / rarity)
     */
    ...
    */
    ...
    /* SUPPLY */
    uint256 public RESERVED_TOKENS = 0;
    ...
    {
        if (RESERVED_TOKENS > 0) _mintERC2309(withdrawAddress_, RESERVED_TOKENS);
        ...
        isSaleState(SaleState.Public)
    {
        ...
        if (_totalMinted() + quantity_ > (collectionSize - RESERVED_TOKENS)) revert SoldOut(); //✅
    ...
    /* WITHDRAW */
    // Sets Treasury Jar Address for withdraw() and ERC2981 royaltyInfo
    ...
    function setReservedToken(uint256 size) public onlyOwner {
