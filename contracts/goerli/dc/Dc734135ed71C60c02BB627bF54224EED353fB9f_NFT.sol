...
contract NFT is ERC721A, ERC721AQueryable, Ownable, PaymentSplitter {
    ...
    uint public saleStartTime = 1673650800;
    ...
    address[] private _team = [
        0x4ac8E6177D6bA59EC47087fb1fFD2F100eaFe949,
        0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC,
        0x90F79bf6EB2c4f870365E785982E1f101E93b906
    ];

    uint[] private teamShares = [700, 295, 5];

    constructor(
        bytes32 _merkleRoot,
        string memory _baseURI
    ) ERC721A("NFT Alyra", "NFTAly") PaymentSplitter(_team, teamShares) {
