...
contract BabelongAzuki is ERC721A, Ownable {
    uint256 private constant MAX_SUPPLY = 3000;

    uint256 private constant MAX_MINTS_PER_ADDRESS = 20;
    uint256 private constant MAX_WLA_MINTS_PER_ADDRESS = 15;
    uint256 private constant MAX_WLB_MINTS_PER_ADDRESS = 10;
    uint256 private constant MAX_PUB_MINTS_PER_ADDRESS = 5;
    uint256 private constant MAX_FIAT_MINT = 5;
...
//    constructor(bytes32 _merkleRootA, bytes32 _merkleRootB, string memory _initNotRevealedUri) ERC721A("Babelong NFTs", "BABELONG") {
    constructor() ERC721A("Babelong NFTs", "BABELONG") {
//        setMerkleRootA(_merkleRootA);
//        setMerkleRootB(_merkleRootB);
...
// Mitigation for bots minting
    ...
    function fiatMint(address _account, uint _quantity) external onlyFiatMinter {
        ...
        require(totalSupply() + _quantity <= MAX_SUPPLY, "Not enough tokens left");
        require(_quantity <= MAX_FIAT_MINT, "Exceeded the fiat mint limit");
