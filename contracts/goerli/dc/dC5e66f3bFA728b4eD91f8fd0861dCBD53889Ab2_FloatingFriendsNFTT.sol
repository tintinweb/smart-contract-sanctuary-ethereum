...
/// @custom:security-contact [email protected]evs.com
contract FloatingFriendsNFTT is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable,ERC721RoyaltyUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable,NativeMetaTransactionUpgradeable,ContextMixin {
    ...
    function initialize(string memory name, string memory symbol,uint256 mintPrice, uint saleStartsIn ,string memory baseURI,uint maxSupply,uint getFreeBuyCount,uint getFree,uint promoBefore,address royaltyReceiver,uint96 royaltyFeeBasePoint,bytes32 merkleRoot) initializer public {
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, 0xFC2e0CBc5B06864bC8Ca717dB17C371Db4C90006);
    ...
    function withdraw() public whenNotPaused onlyRole(DEFAULT_ADMIN_ROLE) onlyRole(MINTER_ROLE) {
     ...
     */
    function setMerkleRoot(bytes32 merkleRootHash) external onlyRole(DEFAULT_ADMIN_ROLE) onlyRole(MINTER_ROLE)
    {
