...
contract AssetBundleTokens is ERC1155PresetMinterPauser, Ownable, IERC1155Receiver {
    ...
    function purchaseAssetBundleID(address receiver, uint256 index) public payable {
        require(msg.value == assetBundlePrice, "Insufficient funds for skin purchase");
        safeTransferFrom(address(this), receiver, index, 1, "");
    ...
    function getTokenBalanceByAssetBundleId(address account, string calldata assetBundleID) public view returns(uint256 balance) {
        return balanceOf(account, idmap[assetBundleID]);
    }

    function getTokenBalanceByIndex(address account, uint256 index) public view returns(uint256 balance) {
