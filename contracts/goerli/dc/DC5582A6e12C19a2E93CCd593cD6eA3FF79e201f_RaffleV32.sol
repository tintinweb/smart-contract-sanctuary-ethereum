...
// File: WinStake/YieldAggregatorV32.sol
...
contract YieldAggregatorV32 is Ownable {
    //////// Variables ////////
    ...
    // function withdrawFromAave(uint256 _value) internal {
    //     uint256 bal = balances[msg.sender];
    //     balances[msg.sender] = 0;
    //     totalDeposited -= (bal-wonPrizes);
    //     POOL.withdraw(address(WETH), bal, address(this));
    // }
...
contract RaffleV32 is
    ...
    VRFConsumerBaseV2
{
    /**@title A DEFI powered verifiable random raffle contract
     * @author Ferris Vermeulen
     * @notice This project was built to test implementations of the Chainlink VRF, Chainlink Keepers and Aave lending contracts.
