...
contract AERIAL is Ownable, ReentrancyGuard, RrpRequesterV0, AccessControl {
    ...
    mapping(address => uint8) public coordX;
    mapping(address => uint8) public coordY;
    ...
    event RequestedUint256(address indexed requestAddress, bytes32 indexed requestId);
    ...
    function makeRequestUint256(address userAddress) internal {
        ...
        emit RequestedUint256(userAddress, requestId);
    }
    ...
    function Fire(
        ...
        require(_amount <= GetAllowance(),"Must Approve War Tokens first");
    ...
    function Reveal() public nonReentrant {
        ...
        uint8 x = coordX[msg.sender];
        uint8 y = coordY[msg.sender];
        ...
        delete coordX[msg.sender];        
        delete coordY[msg.sender];        
    }
    ...
    function devWithdrawWar(address recipient) public nonReentrant {
        require(
    ...
    function warWithdrawWar(address _recipient) onlyOwner public nonReentrant {
        require(
