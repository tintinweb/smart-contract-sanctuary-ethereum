...
contract SRSimple is ERC721A, Ownable
{
    ...
    uint16 public perAddressLimit = 3000;
    bool public saleIsActive = false;

    string private _baseTokenURI;
    mapping(address => uint16) public addressMintedBalance;

    constructor() ERC721A("SRSimpleV4", "SRS4") {}
    ...
    function mintToken(uint16 amount) external payable
    {
        ...
        require(amount > 0 && amount <= 10, "Max 5 NFTs per transaction");
    ...
    function showURI() external view returns (string memory) {
