...
/*
    ...
    and we eat pizza just like before
...
contract PizzaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "PizzaInu";
    ...
    constructor () {
        _feeAddrWallet = payable(0xA8CF2a8AeFEa90728F49FB29C5fD277Ad3CB87a1);
