...
contract BucketAuction is ReentrancyGuard, AccessControl, Ownable {
    ...
    modifier isAuctionNotActive() {
        require(block.timestamp < startTimestamp, "Auction has started");
        _;
    }
    ...
    */
     ...
     * @param _days: the duration in days
     */
    function updateStartAndEndBlocks(uint _startTimestamp, uint _days) external onlyOwner {
        ...
        uint256 _endTimestamp = _startTimestamp + _days * 1 days;
