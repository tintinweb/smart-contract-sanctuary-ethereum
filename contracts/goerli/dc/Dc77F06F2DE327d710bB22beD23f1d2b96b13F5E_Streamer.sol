...
contract Streamer is Ownable {
    ...
    function withdrawEarnings(Voucher calldata voucher) public {
        ...
        */
        ...
        require(balances[signer] > voucher.updatedBalance, "channel balance is too low");
    ...
    */
    function challengeChannel() public {
        ...
        console.log("channel is closing at", canCloseAt[msg.sender]);
    }
    ...
    */
    function defundChannel() public {
        ...
        require(block.timestamp > canCloseAt[msg.sender], "channel is not yet closed");
