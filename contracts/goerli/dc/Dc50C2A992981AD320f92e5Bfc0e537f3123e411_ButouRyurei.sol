...
contract ButouRyurei is ERC721Enumerable, Ownable, ERC2981, ReentrancyGuard, DefaultOperatorFilterer{
  ...
  constructor(
    ...
    _setDefaultRoyalty(0x05C072468A91603E727033153375D8659489FF75, 1000);//本番デプロイ時変更
  }
  ...
  function withdrawRevenueShare() external onlyOwner {
        ...
        address founder1 = payable(0x05C072468A91603E727033153375D8659489FF75);//本番デプロイ時変更
        address founder2 = payable(0x17A104CE8dfDf4d6b930e31E7a4CE73CC706858B);//本番デプロイ時変更
        address platformer = payable(0x6cA14b1692B822479d95f1DDdA21AEd08f6eC961);//本番デプロイ時変更
        address engineer = payable(0x5e8137aA563B0f424D8d34b9F612AC743b13eFD3);//本番デプロイ時変更
        bool success;
