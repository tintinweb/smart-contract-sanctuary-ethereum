    ...
    ITGE
{
    ...
    function redeem() external override onlyState(State.Failed) nonReentrant whenServiceNotPaused {
    ...
    function transferFunds() external onlyState(State.Successful) whenServiceNotPaused {
