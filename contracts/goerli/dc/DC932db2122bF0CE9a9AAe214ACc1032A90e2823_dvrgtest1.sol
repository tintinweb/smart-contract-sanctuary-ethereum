  ...
  DefaultOperatorFilterer
{
  ...
  function claimOrdinals(
    uint256[] calldata tokenIds
  ) public {
    require(tokenIds.length < _maxSupply + 1, 'Requested claim amount is too high');
  ...
  function claimOrdinal(uint256 tokenId) private {
    ...
    require(ownerOf(tokenId) == msg.sender, "Caller does not own the requested token");
