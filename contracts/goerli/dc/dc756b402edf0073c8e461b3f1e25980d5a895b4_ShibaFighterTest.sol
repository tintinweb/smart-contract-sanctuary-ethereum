...
contract ShibaFighterTest is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ShibaFighterTest";
    ...
    IERC20 token;
    uint256 public _profitStakeByYear = 200;
    uint256 public _limitTimeWithdrawFee = 25;
