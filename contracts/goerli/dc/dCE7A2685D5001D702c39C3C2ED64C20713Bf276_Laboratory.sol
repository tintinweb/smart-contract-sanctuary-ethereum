...
contract Laboratory {
    ...
    function NewStreamWallet(TeamWalletLibrary.Payee[] calldata team,string calldata walletTitle) external returns (address) {
        require(team.length < 100, "Too many wallet members");
        address payable clone = payable(Clones.clone(implementation));
        TeamWallet teamWallet = TeamWallet(clone);
        teamWallet.initialize(team,walletTitle);
...
contract TeamWallet is Initializable {
    ...
    string public walletTitle;

    function initialize(TeamWalletLibrary.Payee[] calldata team,string calldata _walletTitle) initializer public {
