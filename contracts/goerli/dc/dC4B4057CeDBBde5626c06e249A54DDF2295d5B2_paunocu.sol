...
contract paunocu is ERC721A, Ownable {
    ...
    string public prerevealURL = "https://gateway.pinata.cloud/ipfs/ipfs://QmYCN4g8ye3usTEM4CAT6KNN1hLR2narpvTYJzcHmVfbMA/" ;
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("paunocu", "pnc") {}
