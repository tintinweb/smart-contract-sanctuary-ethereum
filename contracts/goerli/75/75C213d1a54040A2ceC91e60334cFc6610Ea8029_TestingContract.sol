...
contract TestingContract is ERC721SeaDrop {
    ...
    // The Genesis NFT Collection smart contract address
    address private constant _GENESIS_COLLECTION_ADDRESS =
        0x57d46f9979f76ff57004d04A3594cEf9686Aa87F;
    ...
    // NFT sale window
    uint256 private constant _MINT_START = 1677081606;

    // Genesis + Derivative = OG_WINDOW
    uint256 private constant _OG_WINDOW_START = _MINT_START;
    uint256 private constant _OG_WINDOW_END = _OG_WINDOW_START + 2 hours;

    // Prospects + Whitelist A = WHITELIST_WINDOW
    uint256 private constant _WHITELIST_WINDOW_START = _MINT_START + 1 hours;
    uint256 private constant _WHITELIST_WINDOW_END =
        _WHITELIST_WINDOW_START + 1 hours;

    // Whitelist B = FINAL_WINDOW
    uint256 private constant _FINAL_WINDOW_START = _MINT_START + 2 hours;
    uint256 private constant _FINAL_WINDOW_END = _FINAL_WINDOW_START + 1 hours;
    ...
    // The merkle tree root hash for the whitelistA addresses.
    bytes32 private _WHITELIST_A_ROOT =
        0xbba4722640f44c94be29fd77a8a05f370a6e4148efae342a0a029e0c2a711b11;

    // The merkle tree root hash for the whitelistB addresses.
    bytes32 private _WHITELIST_B_ROOT =
        0x6b653210297509a2b48ca3462e70212d671580f0704af6ae6b61a0e092f796a6;
