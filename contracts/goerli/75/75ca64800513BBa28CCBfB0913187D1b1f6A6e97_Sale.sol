...
contract Sale is ReentrancyGuard, Ownable {
    ...
    function updatePresale(
        ...
        presale[_id].minTokenToBuy = _minTokenToBuy;
        presale[_id].cliffTime = _cliffTime;
        presale[_id].unlockedAtTGE = _unlockedAtTge;
        presale[_id].unlockPercentage = _vestingUnlockPerct;
        presale[_id].vestingCycleTime = _vestingCycleTime;
    }
        ...
        returns (bool)
    {
        ...
        sendValue(payable(fundReceiver), ethAmount);
