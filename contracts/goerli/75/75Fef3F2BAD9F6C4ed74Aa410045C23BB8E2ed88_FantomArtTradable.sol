    ...
    ERC1155Burnable
{
    ...
    function totalSupply(uint256 _id) public view returns (uint256) {
     ...
     // Creates a new token type and assigns _supply to an address
     //  _to owner address of the new token
     //  _supply Optional amount to supply the first owner
    ...
    function getCurrentTokenID() public view returns (uint256) {
      ...
      // isApprovedForAll to whitelist contracts to enable gas-less listings.
    ...
    function _incrementTokenTypeId() private {
      ...
      // _id uint256 ID of the token to set its URI
