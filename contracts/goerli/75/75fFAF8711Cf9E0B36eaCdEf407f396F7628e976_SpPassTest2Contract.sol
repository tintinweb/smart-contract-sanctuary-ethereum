...
//   / ___// __ \   / __ \____ ___________   /_  __/__  _____/ /_   |__ \
//   \__ \/ /_/ /  / /_/ / __ `/ ___/ ___/    / / / _ \/ ___/ __/   __/ /
//  ___/ / ____/  / ____/ /_/ (__  |__  )    / / /  __(__  ) /_    / __/ 
// /____/_/      /_/    \__,_/____/____/    /_/  \___/____/\__/   /____/ 
//                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xB6329Dd8e68dED6C973d7B1d3098Cc4FaD3858Da];
  address public erc20Payable = 0xB6329Dd8e68dED6C973d7B1d3098Cc4FaD3858Da;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmfWN2CRBkaY7tisj9z7KukZp4fVeMMJgAxXGhMqRnGAnc/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/d2Vajb3mr8f1cDdiu2WJ/contract-metadata";
  }
...
// File: contracts/SpPassTest2Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpPassTest2Contract is ERC721APlus {
    constructor() ERC721APlus("SP Pass Test 2", "SPPT2"){}
}
