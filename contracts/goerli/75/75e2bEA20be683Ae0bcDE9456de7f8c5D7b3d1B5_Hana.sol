...
contract Hana is ERC721A, Ownable {
    ...
    bytes32 public merkleRoot = 0x17c21eb85c2614de9433fee5678d1414b901cbb8a077b782eed2a6673122314a;

    constructor() ERC721A("Chibits - Hana", "HANA") {
    }
    ...
    returns (string memory)
  {
    ...
    function mintPresale(uint256 tokens, bytes32[] calldata merkleProof) external payable {
        ...
        require(tokens > 0, "DMust mint at least one token");
