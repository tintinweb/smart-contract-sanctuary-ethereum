...
contract Dexpresso is IDexpresso, Pausable {
    ...
    /// @dev isDaoMember, using the IAccessController checks to see if the caller is one the listed DAOmember of the DAOMultiSig
     ...
     * @dev SwapExecuted event is emitted with the batchExecuteStatus array in the executeSwap function,
    ...
    /**
     * @notice addBroker function sets an address to True in brokersAddresses mapping
     *
     * @dev msg.sender must be a DAO member,
     *
     * @param _broker address is the latest broker in the brokersAddresses mapping which will be mapped to True.
     *
     */
    ...
    /**
     * @notice removeBroker function sets an address to False in brokersAddresses mapping
     *
     * @dev msg.sender must be a DAO member,
     *
     * @param _broker address is the  broker in the brokersAddresses mapping which will be mapped to False.
     *
     */
    ...
    /**
     * @notice pause function, transfers all the given tokens balances to the DAOMultiSig contract and triggers stopped state,
     *
     ...
     *
     */
    function pause(address[] memory tokenAddresses) external whenNotPaused isDaoMember {
    ...
    /**
     * @dev ValidateTransaction function compares the users balance and allowance against the amounts to be transferred,
