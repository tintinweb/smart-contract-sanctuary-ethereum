...
contract BondApproachV1 is BondBase {
    ...
    function takerBond(
        ...
        bondAmount = amount * bondConfig[token].x / DIVIDER;
    }
    ...
    function makerBond(
        ...
        bondAmount = amount *  bondConfig[token].y / DIVIDER;
    }
}
...
abstract contract BondBase is Initializable, BACUpgradable, IBond {
    ...
    function deposit(uint256 amount) external virtual override {
        ...
        IERC20Upgradeable(bondToken).safeTransferFrom(_msgSender(), address(this), amount);
    }
    ...
    function unlock(
        ...
        console.log("Locked: %s", lockedBalances[_owner] );
    ...
    function transferLocked(address token, address from, address to, uint amount) external override onlyMarket(token) {
