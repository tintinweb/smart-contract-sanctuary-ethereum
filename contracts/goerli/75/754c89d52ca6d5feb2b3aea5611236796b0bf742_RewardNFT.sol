...
contract RewardNFT is ERC721 {
 ...
 using Strings for uint256;
  ...
  Counters.Counter private _tokenIdCounter;
    ...
    constructor() ERC721("RewardNFT", "RewardNFT") {
    ...
    function _baseURI() internal view override virtual returns (string memory) {
        return"https://kiwiistaging.mypinata.cloud/ipfs/QmWwoneq5poqyQyeGaFrkfu8oSGiJprWYKNY4dbVd66BZU/";
    }
 ...
 function tokenURI(uint256 tokenId)
    ...
    function mintReward(address to , uint256 tokenId) public  {
