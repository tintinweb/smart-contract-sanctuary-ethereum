...
contract OSBSoul is ERC721Upgradeable {
    ...
    /**
     * @notice that is called before any token transfer. This includes minting.
     *
     * Calling conditions:
...
import "../contracts/OSBSoul.sol";

contract $OSBSoul is OSBSoul {
    constructor() {}

    function $_beforeTokenTransfer(address from,address to,uint256 arg2) external {
        return super._beforeTokenTransfer(from,to,arg2);
    }
