...
contract MyTokenCollection is ERC721Enumerable, Ownable {
  ...
  string public constant CONCEALED_TOKEN_URI = string(abi.encodePacked("ipfs://Qma4au37DpZGUpLQuyTF1sFBmDVcN8A7QteTYRcZ1uv4Ek"));
  ...
  constructor() ERC721("MyToken", "MT") {
    ...
    whitelistMintStartTime = 1667030700;
    waitingListMintStartTime = 1667224800;
    mintStartTime = 1667232000;
