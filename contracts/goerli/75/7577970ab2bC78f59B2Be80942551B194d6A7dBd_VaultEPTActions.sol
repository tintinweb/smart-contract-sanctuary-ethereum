    ...
    function modifyCollateralAndDebt(
        ...
        if (deltaCollateral > 0) {
            enterVault(
                ...
                tokenId,
                collateralizer,
                wmul(uint256(deltaCollateral), IVault_1(vault).tokenScale())
            );
        }
...
contract Vault20Actions is VaultActions {
    ...
    function enterVault(
        ...
        IVault_1(vault).enter(0, address(this), amount);
    }
    ...
    function exitVault(
        ...
        IVault_1(vault).exit(0, to, amount);
    }
}
...
contract VaultEPTActions is Vault20Actions {
    ...
    function buyCollateralAndModifyDebt(
        ...
        int256 deltaCollateral = toInt256(wdiv(pTokenAmount, IVault_1(vault).tokenScale()));
    ...
    function _solveTradeInvariant(
        ...
        uint256 tokenScale = IVault_1(vault).tokenScale();
        uint256 underlierScale = IVault_1(vault).underlierScale();
        ...
        uint256 currentBalanceTokenOut;
        {
            ...
            address token = IVault_1(vault).token();
            address underlier = IVault_1(vault).underlierToken();
