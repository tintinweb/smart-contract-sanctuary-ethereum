// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Accessory", unicode"Hair", unicode"Eye Accessory", unicode"Mouth", unicode"Eyes", unicode"Head", unicode"Body", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"OnChainPeople", unicode"2000 people on chain.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/250908c7-295d-4bce-84c3-84a026632b29", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/250908c7-295d-4bce-84c3-84a026632b29", "", 600, "0xAf7a60900bF698814B7D4F5E3995361F9CEE9150");

        constructor() ERC721A(unicode"OnChainPeople", unicode"OCP") {
            TIERS[0] = [0,3,7,32,69,77,111,146,150,159,160,169,212,251,272,325,397];
            TIERS[1] = [3,17,19,27,33,67,91,100,120,132,178,236,307,400,405,405];
            TIERS[2] = [69,76,128,160,184,356,502,502,563];
            TIERS[3] = [111,235,276,430,467,471,550];
            TIERS[4] = [11,21,36,126,171,276,276,361,382,411,469];
            TIERS[5] = [12,499,499,765,765];
            TIERS[6] = [48,63,77,94,95,103,154,186,192,226,232,238,261,284,287];
