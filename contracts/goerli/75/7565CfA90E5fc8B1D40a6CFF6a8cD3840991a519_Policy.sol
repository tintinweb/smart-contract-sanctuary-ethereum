...
contract Policy is Ownable, Pausable, IPolicy {
    ...
    function isTransferable(address, address, address from, address to, uint256) external override view whenNotPaused returns (bool) {
    ...
    function isOperatorFor(address, address operator, address) external override view whenNotPaused returns (bool) {
...
interface IPolicy {
    function isTransferable(address token, address operator, address from, address to, uint256 amount) external view returns (bool);
    function isOperatorFor(address token, address operator, address tokenHolder) external view returns (bool);
}
//althabe.eth
