...
contract SocialBlox is Ownable, ReentrancyGuard, ERC721A {
    ...
    uint16 public teamAllocation = 521;
    ...
    constructor(address _team, string memory _uri)
        ERC721A("SocialBlox", "SBLX")
    {
        team = _team;
        hiddenURI = _uri;
    }
    ...
    function setRevealed(bool _revealed, string calldata _data)
        external
        onlyOwner
    {
        revealed = _revealed;
    ...
    function setHiddenURI(string calldata _data) external onlyOwner {
        hiddenURI = _data;
    }
