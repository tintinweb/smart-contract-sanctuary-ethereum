...
contract MinerStaking is MinerAccessControlled {
    ...
    uint256 public constant WEEK = 30; // all future times are rounded by week
    uint256 public constant MAXTIME = 5760; // 4 years
    ...
    function unstake(address _to, bool _trigger) external returns (uint256 amount_) {
        ...
        gMINER.updateUserCheckPointOnUnstake(msg.sender);
    }
