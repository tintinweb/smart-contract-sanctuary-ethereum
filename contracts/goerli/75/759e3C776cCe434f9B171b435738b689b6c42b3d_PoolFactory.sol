        ...
        returns (DetailedInvestmentPoolInfo[] memory poolInfoArr_)
    {
        ...
        for (uint256 i = 0; i < poolArr_.length; i++) {
            ...
            poolInfoArr_[i] = DetailedInvestmentPoolInfo(
                ...
                investmentPool_.totalAddedAmountForRewards()
            );
        }
    }
...
interface IInvestmentPool {
    ...
    /**
     * @notice The event that is emitted during the adding rewards to the Investment pool
     * @param userAddr an address of the user who added rewards to the contract
     * @param amount an amount of the added rewards
     */
    event RewardsAdded(address userAddr, uint256 amount);
    ...
    /**
     * @notice Function to get the total added amount for rewards
     * @return total added amount for rewards
     */
    function totalAddedAmountForRewards() external view returns (uint256);
     ...
     * @dev If you pass a token ID that does not exist, an empty structure NFTInfo will be returned
     * with a tokenID field equal to maxUint256
...
interface IPoolFactory {
     ...
     * @param totalAddedAmountForRewards an amount of the total added rewards to the contract
     */
    struct DetailedInvestmentPoolInfo {
        ...
        uint256 totalAddedAmountForRewards;
    }
