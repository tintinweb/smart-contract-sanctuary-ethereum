...
contract BTCDividend is IDividendDistributor {     //SHIBA
    ...
    IERC20 RewardToken = IERC20(0x6B9Ae4D64feBB297C5BF12b4667616b751d05b77); // SHIBA CA
...
contract ETHDividend is IDividendDistributor {     //ETH
    ...
    IERC20 RewardToken = IERC20(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6); // WETH CA
...
contract SHIBETH is Context, IERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xf3DF825c87edEDA6F57bFE2690e1e84a375dc3d2;
