...
abstract contract Governor {
        ...
        returns (ProposalState)
    {
        ...
        uint256 totalAvailableVotes = _getTotalVotes();
        uint256 quorumVotes = (totalAvailableVotes *
            proposal.ballotQuorumThreshold) / 10000; // /10000 because 10000 = 100%
    ...
    {
        return
            proposals[proposalId].endBlock - proposals[proposalId].startBlock;
    }
