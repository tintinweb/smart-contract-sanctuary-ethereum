...
contract Owls is ERC721Enumerable, Ownable, IERC4906 {
    mapping(uint256 => uint256) internal seeds;
    IOwlDescriptor public descriptor;
    uint256 public maxSupply = 10000;
    bool public minting = false;

    constructor(IOwlDescriptor newDescriptor) ERC721("Stripes", "STRIP") {
    ...
    function random(uint256 tokenId) public view returns (uint256 pseudoRandomness) {
