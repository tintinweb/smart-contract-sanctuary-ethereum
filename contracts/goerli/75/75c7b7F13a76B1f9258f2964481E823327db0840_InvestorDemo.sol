...
import './ExpandableExtensionWithAccessControl.sol';
 ...
 */
abstract contract ERC721A_NFTCExtended_Expandable is ExpandableExtensionWithAccessControl, ERC721A_NFTCExtended {
    ...
    constructor(
        ...
        ERC721A_NFTCExtended(__baseURI)
        ExpandableExtensionWithAccessControl(__allowMaxSupplyIncrease)
    {
        // Nothing to do
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override(ERC721A, IERC721A) returns (string memory) {
        ...
        return string(abi.encodePacked(base, _getUriFragmentForToken(tokenId, _getFlavorInfo(flavor))));
    }
    ...
    function _setFlavorForToken(uint256 tokenId, uint256 flavorId) internal {
        _setExtraDataAt(tokenId, uint24(flavorId));
    }
...
/**
 * @title ExpandableExtension
 * @author @NiftyMike | @NFTCulture
 * @dev Extension contract for Expandable Token Types.
 */
abstract contract ExpandableExtension is FlavorInfoManager {
    ...
    function _checkValueIsValid(FlavorInfo memory tokenFlavor, uint256 count, uint256 valueSent) internal pure {
...
// NFTC Prerelease Contracts
import './ExpandableExtension.sol';
 ...
 * @dev Extension contract for Expandable Token Types.
 */
abstract contract ExpandableExtensionWithAccessControl is ExpandableExtension, AccessControl {
    bytes32 public constant CREATOR_ROLE = keccak256('CREATOR_ROLE');

    constructor(bool __allowMaxSupplyIncrease) ExpandableExtension(__allowMaxSupplyIncrease) {
...
import './InvestorDemoBase.sol';
import './InvestorDemoSplitsAndRoyalties.sol';
 ...
 * @title InvestorDemo
 */
contract InvestorDemo is InvestorDemoSplitsAndRoyalties, InvestorDemoBase {
    constructor()
        ERC721A('InvestorDemo', 'ID')
        InvestorDemoBase(
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721A_NFTCExtended_Expandable, ERC2981)
        returns (bool)
    {
    ...
    function _getInitialFlavors() internal pure override returns (FlavorInfo[] memory) {
        FlavorInfo memory nftc_token1 = FlavorInfo(100100, .08 ether, 15, 0, 'Qm000000/token1');
        FlavorInfo memory nftc_token2 = FlavorInfo(200100, .05 ether, 100, 0, 'Qm000000/token2');
        FlavorInfo memory nftc_token3 = FlavorInfo(
            300100,
            .02 ether,
            0, // Open Edition
            0,
        ...
        FlavorInfo[] memory initialFlavors = new FlavorInfo[](3);

        initialFlavors[0] = nftc_token1;
        initialFlavors[1] = nftc_token2;
        initialFlavors[2] = nftc_token3;
    ...
    PhaseTwoIsIndexed
{
    ...
    constructor(
        ...
        ERC721A_NFTCExtended_Expandable(__baseURI, true)
        ExpandablePhasedMintThree()
    {
...
abstract contract InvestorDemoSplitsAndRoyalties is NFTCSplitsAndRoyalties {
    address[] internal addresses = [
        0x000000000000000000000000000000000000dEaD // TODO: Set InvestorDemo Wallet(s)
    ];

    uint256[] internal splits = [100]; // TODO: Set InvestorDemo Split(s)
