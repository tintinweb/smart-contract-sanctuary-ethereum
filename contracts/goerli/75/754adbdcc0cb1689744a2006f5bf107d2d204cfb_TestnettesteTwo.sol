...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract TestnettesteTwo is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;


  string private uriPrefix;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://bafybeihyuymacpze2bpk2stplyrl6kbddjqoprmignyd5fwbt5i4wdumly";
  ...
  constructor() ERC721A("TestnetTestttt", "Test") {
  }
