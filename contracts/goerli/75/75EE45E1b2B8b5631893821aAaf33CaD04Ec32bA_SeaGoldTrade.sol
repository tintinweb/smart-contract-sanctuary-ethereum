...
contract SeaGoldTrade is Ownable {
    ...
    function updateTreasuryAddress1(address _treasuryAddress) public onlyOwner {
        TreasuryAddress1 = _treasuryAddress;
    }
    ...
    function buyback() private {
        ...
        if (betaLaunched = true) {
            payable(TreasuryAddress1).transfer(SwapBalanceETH);
        } else {
