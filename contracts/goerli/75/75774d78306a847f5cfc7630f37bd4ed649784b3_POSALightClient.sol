...
// hevm: flattened sources of flat/POSALightClient.f.sol
// SPDX-License-Identifier: GPL-3.0 AND MIT
pragma solidity =0.7.6;
pragma abicoder v2;

////// flat/POSALightClient.f.sol
 ...
 * ====
 */
abstract contract Initializable_5 {
    /**
    ...
    modifier initializer() {
        ...
        require(
            (isTopLevelCall && _initialized < 1) || (!Address_11.isContract(address(this)) && _initialized == 1),
...
contract EcdsaAuthority {
    ...
    function _check_n_signatures(
        ...
        for (uint256 i = 0; i < requiredSignatures; i++) {
            current = ECDSA_2.recover(dataHash, signatures[i]);
    ...
    function encode_data_hash(bytes32 structHash) private view returns (bytes32) {
        return ECDSA_2.toTypedDataHash(domain_separator(), structHash);
    }
}
...
contract POSALightClient is Initializable_5, POSACommitmentScheme, EcdsaAuthority, ILightClient_6 {
