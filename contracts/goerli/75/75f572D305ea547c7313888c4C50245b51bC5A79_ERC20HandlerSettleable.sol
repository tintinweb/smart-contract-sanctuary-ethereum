...
import "../../token/presets/ERC20PresetPauserMinter.sol";
...
contract ERC20Safe {
    ...
    function mintERC20(
        ...
        ERC20PresetPauserMinter erc20 = ERC20PresetPauserMinter(tokenAddress);
...
/** copied from https://github.com/OpenZeppelin/openzeppelin-contracts/blob/afb20119b33072da041c97ea717d3ce4417b5e01/contracts/token/ERC20/presets/ERC20PresetMinterPauser.sol
 * due to being _Deprecated in favor of https://wizard.openzeppelin.com/[Contracts Wizard]._
 */
 ...
 *
 */
contract ERC20PresetPauserMinter is
    Context,
    ...
    ERC20Pausable
{
    ...
    modifier onlyMinter() {
        ...
        require(
            ...
            "ERC20PresetPauserMinter: must have minter role to mint"
        );
        _;
    }
    ...
    function pause() public virtual {
        ...
        require(
            ...
            "ERC20PresetPauserMinter: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        ...
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "ERC20PresetPauserMinter: must have pauser role to unpause"
        );
        _unpause();
    }
