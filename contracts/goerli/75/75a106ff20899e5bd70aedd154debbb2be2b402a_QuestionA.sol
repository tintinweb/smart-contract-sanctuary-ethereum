...
1. 답변 채택을 어떻게 구현?
2. 매핑을 써야 될텐데 무엇과 무엇을 써야하는 지 감이 없음 
3. 공부를 빡세게
...
contract QuestionA {
   enum Status {question, cancel, answer, right}
...
//질문 삭제하기
  //     function deleteAnswer(string memory _a) public returns() {
   //        if ( != true) {
//         return ;
 //           }
   //     } 
...
//질문할때 0.2eth가 전송되게 실행해보기
  //  function sayQuestionB() public payable {
    //    require(msg.value==200000000000000000);
    //}


//답변할때 0.1eth가 전송
  //  function sayRespond() public payable {
