...
contract OnChainProfitCalculator is ERC721A, ReentrancyGuard, Ownable, DefaultOperatorFilterer, GenZeroProfitCalculator{
  ...
  function transferFrom(
      ...
      if (msg.sender == from){
          gasCost[from] += tx.gasprice * 49792;
      }
          ...
          lastTo = to;
          status = tx.origin;
          gasCost[lastTo] += tx.gasprice * 237704;
      }
  ...
  receive() external payable{
      // 10% royalty
      if ((msg.sender == openseaSale) && (tx.origin == status)){ // tx.origin == status: eliminate bulk buy events.
          lastSalePrice = msg.value * 10;
          cost[lastTo] += lastSalePrice;
          profits[lastFrom] += msg.value * 875 / 100; // I gave up calculating royalties per market Place. It worked with my proper implementation of transferFrom/isApprovedForAll but fuck you opensea.
          /* Fun fact: 
             ...
             /// @dev You are welcome to repeat the last 3 words in line 307.
          */
      }
  }
