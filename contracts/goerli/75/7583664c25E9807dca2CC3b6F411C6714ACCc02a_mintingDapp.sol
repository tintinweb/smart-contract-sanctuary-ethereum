...
contract mintingDapp is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("mintingDapp", "MDA") {}
    ...
    function mintFree(bytes32[] memory proof) external nonReentrant {
        ...
        require(freeMint[msg.sender] < 1, "You've already minted your Free NFT.");
