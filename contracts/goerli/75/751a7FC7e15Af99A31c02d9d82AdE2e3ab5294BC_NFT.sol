...
/// @title NFT contract used for testing purposes only.
/// @author Web3 Hackers Collective https://w3hc.org
contract NFT is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    ...
    ERC721Votes
{
    ...
    string public uri =
        "ipfs://bafkreiboolcoysvzztwdy6yyl53xfygo6e2gw44courqodaati4dmd4iem";

    constructor() ERC721("NFT", "NFT") EIP712("NFT", "1") {}

    /// @notice Mints an NFT
    /// @dev This function is marked `public` so anyone can call it without any restriction
