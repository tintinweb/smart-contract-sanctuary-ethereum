...
contract WojakiansBeta is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    //Max Custom 
    uint64 public publicT1MaxSupply = 100;
    uint64 public publicT2MaxSupply = 100;
    uint64 public publicT3MaxSupply = 100;
    // Supply Custom
    ...
    function publicMintT1(uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
       ...
       function publicMintT2(uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
        require(publicSaleT2Active, "Public is not Active");
        require(tx.origin == msg.sender);
        ...
        require(publicSaleT3Active, "Public is not Active");
        require(tx.origin == msg.sender);
