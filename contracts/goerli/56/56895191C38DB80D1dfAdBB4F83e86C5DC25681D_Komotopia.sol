...
contract Komotopia is ERC721Enumerable, Ownable, PrivateSale, PublicSale {
    ...
    constructor(
        ...
        ERC721("Komotopia", "KOMO")
        PrivateSale(_privSaleStart, _privSaleExpiry)
        PublicSale(_publicSaleStart, _publicSaleEnd)
     {
        setBaseURI(baseURI);
        price = _price;
    }
    ...
    function mintNFT(uint256 qty) public payable publicSaleActive {
        ...
        require(tokenToMint + qty - 1 < maxSupply, "NFT run out of supply!");
...
contract PublicSale is Ownable {
    ...
    constructor(uint256 _publicSaleStart, uint256 _publicSaleEnd) {
        publicSaleStart = _publicSaleStart;
        publicSaleEnd = _publicSaleEnd;
    }

    modifier publicSaleActive() {
        require(_publicSaleActive(), "No ongoing public sale");
        _;
    }

    function _publicSaleActive() public view returns (bool) {
        return publicSaleStart > 0 && publicSaleStart < block.timestamp && block.timestamp < publicSaleEnd;
    }
