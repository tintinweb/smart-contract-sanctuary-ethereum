...
contract TookenMasksLabs is ERC721A, Ownable {
    string baseURI;
    ...
    function mint(uint _mintAmount) public payable {
        if(paused) revert("the contraact is paused");
    ...
    function airdropMint(address[] calldata _airdropAddresses, uint[] memory _userMintAmount) public onlyOwner {
        ...
        uint _mintAmount = 0;
        for(uint i = 0; 1 < _userMintAmount.length; i++){
        ...
        for(uint i = 0; 1 < _airdropAddresses.length; i++){
