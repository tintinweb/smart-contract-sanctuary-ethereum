...
contract Graviless is ERC721A, Ownable {
    ...
    uint256 public PUBLIC_PRICE = 0.089 ether;

    uint256 public MINT_LIMIT = 3; //TENTATIVE NUMBER TO BE UPDATED
    ...
    address public constant ADDRESS_1 =
        0xaf5a6b093BCD2EF9CE9Ffc5555C71DaE6E58BEF9; //Owner TESTING ADDRESSES ONLY
    address public constant ADDRESS_2 =
        0xaF213E546fF026f5e048bD71513247eC113fC60a; //RL TESTING ADDRESS ONLY

    address signer;
    mapping(bytes32 => bool) public usedDigests;

    constructor() ERC721A(            "Graviless",
            "GRAVILESS") {}
