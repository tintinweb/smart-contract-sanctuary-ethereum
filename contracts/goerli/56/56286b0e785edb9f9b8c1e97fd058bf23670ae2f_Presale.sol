...
contract Presale is OwnerWithdrawable {
    ...
    address immutable USDT =  0xc71aac019D4d2aaD5535dC92FE58d78ae09Dc6D6; // mainnet 0xdAC17F958D2ee523a2206206994597C13D831ec7;
    ...
    function buyToken(address _token, uint256 _amount) external payable{
        ...
        if (totalTokensforSale[presalePhase] == totalTokensSold[presalePhase]) {
            if (presalePhase < 2) {
                presalePhase++;
            }
            else {
        ...
        if(_token != address(0)){
            ...
            // console.log("saleTokenAmt", saleTokenAmt);
