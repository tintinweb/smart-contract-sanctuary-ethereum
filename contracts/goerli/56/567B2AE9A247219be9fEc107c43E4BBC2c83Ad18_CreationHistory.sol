    ...
    OwnableUpgradeable
{
    ...
    function _additionalMultiplierBasedSalary(
        ...
        uint256[] memory metaCell = scientistIdToMetaCellId[_scientistId];
        uint256 _nanoCellCount = metaCellIdToNanoCellIds[metaCell[0]].length() + metaCellIdToNanoCellIds[metaCell[1]].length();
        uint256 _stageCell1 = _stageOfMetaCell(metaCell[0]);
        uint256 _stageCell2 = _stageOfMetaCell(metaCell[1]);
        uint256 _stage = _stageCell1 > _stageCell2 ? _stageCell1 : _stageCell2;
