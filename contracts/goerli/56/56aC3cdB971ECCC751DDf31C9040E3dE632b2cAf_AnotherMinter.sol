...
contract AnotherMinter is ERC721ABv2, ERC721ABErrors {
    ...
    mapping(uint256 => Phase[]) public phasesPerDrop;
     ...
     */
    function withdrawToRightholder(address _rightholder, uint256 _amount)
        external
        onlyOwner
    {
     ...
     */
    function setDropPhases(uint256 _dropId, Phase[] memory _phases)
        external
        onlyOwner
    {
    ...
    function _mintAB(
        ...
        Phase[] memory phases = phasesPerDrop[_dropId];
