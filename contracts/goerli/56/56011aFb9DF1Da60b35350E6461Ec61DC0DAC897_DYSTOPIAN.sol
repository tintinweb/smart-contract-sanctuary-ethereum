...
contract DYSTOPIAN is DefaultOperatorFilterer, ERC721A, Ownable, ERC2981 {
    ...
    uint256 private s_presale_cost = 0.05 ether;
    uint256 private s_public_cost = 0.08 ether;
    ...
    constructor() ERC721A("Dystopian Rule", "DYSTOPIAN") {
        ...
        setHiddenMetadataUri(
            "https://gateway.pinata.cloud/ipfs/QmYD2yionxJifg6nQgZfJa5nZAngRDsFDREnBpadafPUGR/hidden.json"
        );
    }
    ...
    function setPreSaleMaxLimit(uint256 _limit) public onlyOwner {
        if (_limit == 0) revert DYSTOPIAN_CannotBeZero();
    ...
    function setWalletPresaleMaxLimit(uint256 _limit) public onlyOwner {
        if (_limit == 0) revert DYSTOPIAN_CannotBeZero();
