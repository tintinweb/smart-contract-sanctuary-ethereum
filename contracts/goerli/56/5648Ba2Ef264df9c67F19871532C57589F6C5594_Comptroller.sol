    ...
    ExponentialNoError
{
    ...
    function borrowAllowed(
        ...
        if (oracle.getCTokenPrice(CToken(cToken)) == 0) {
        ...
        )
    {
        ...
        for (uint256 i = 0; i < assets.length; i++) {
            ...
            vars.oraclePriceMantissa = oracle.getCTokenPrice(asset);
    ...
    function liquidateCalculateSeizeTokens(
        ...
        uint256 priceBorrowedMantissa = oracle.getCTokenPrice(
            CToken(cTokenBorrowed)
        );
        uint256 priceCollateralMantissa = oracle.getCTokenPrice(
    ...
    function _setCollateralFactor(
        ...
        if (
            ...
            oracle.getCTokenPrice(cToken) == 0
        ) {
            return
                fail(
                    Error.PRICE_ERROR,
