...
/**
 * @dev DSPStacking is a contract that gives rewards in terms of TMAP for NFT holders
 *
 */
contract DSPStacking is ReentrancyGuard, Ownable {
    /**
    ...
    /**
     * @dev used for batch claiming triggered by owner
     */
    ...
    /**
     * @dev pause rewards claiming, do not pause generation
     */
