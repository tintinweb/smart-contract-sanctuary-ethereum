    ...
    IPool
{
    ...
    function _getProposalCreatedAt(uint256 proposalId)
        ...
        returns (uint256)
    {
        //for avoiding revert on block number = 0
        uint256 createdAt = proposalCreatedAt[proposalId]==0 ? 1 : proposalCreatedAt[proposalId];
...
abstract contract Governor {
        ...
        returns (Ballot ballot, uint256 votes)
    {
        return (
            ...
            _getPastVotes(account, _getProposalCreatedAt(proposalId))
        );
    }
