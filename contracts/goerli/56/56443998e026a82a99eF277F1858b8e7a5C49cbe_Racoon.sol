...
contract Racoon is ERC165, IERC721, IERC721Metadata, Ownable{
    ...
    mapping ( address => bool ) private mintedbefore;

    bool public PublicMintingPaused = true;
    bool public ALMintingPaused = true;

    uint256 public MAX_CAP = 2222;

    uint8 public MAX_MINT_PER_TX = 1;

    uint256 private _price = 0.009 ether;
    ...
    */
    function cheapMint (
      ...
      _amount=1;
        ...
        if (mintedbefore[_recipient] == true) { revert ("You can only mint one NFT maximum"); }
