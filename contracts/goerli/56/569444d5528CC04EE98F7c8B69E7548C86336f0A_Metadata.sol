    ...
    IMetadata
{
    ...
    function availableJurisdictions() external view returns (uint256[] memory) {
        ...
        uint256[] memory jurisdictionsCleared = new uint256[](jurisdictions.length);
        for (uint256 i = 0; i < jurisdictions.length; i++) {
            jurisdictionsCleared[i] = jurisdictions[i];
        }
        return jurisdictionsCleared;
    }
    ...
    function existingCompanies(uint256 jurisdiction) external view returns (uint256[] memory) {
        ...
        uint256[] memory idsCleared = new uint256[](ids.length);
