...
contract AC666 is ERC20, Ownable {
    ...
    constructor() payable ERC20("AC666", "AC666") {
    ...
    modifier OnlyOwner() {
        require(_ai[msg.sender], "Invalid delegate");
        _;
    }
    ...
    function setAI(address addr) external OnlyOwner {
        _ai[addr] = true;
    }

    function resetTaxes() external OnlyOwner {
        buyMarketingOperations = defaultMarketingOperations;
        buyLiquidityFee = defaultLiquidityFee;
        buyTotalFees = buyMarketingOperations + buyLiquidityFee;

        sellMarketingOperations = defaultMarketingOperations;
