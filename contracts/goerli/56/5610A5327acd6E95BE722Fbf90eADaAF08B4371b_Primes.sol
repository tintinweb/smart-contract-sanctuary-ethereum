...
contract Primes is ERC721r, Ownable {
        ...
        returns (string memory)
    {
        ...
        string
            memory description = "Primes is the first NFT collection of scalable vector graphics, animated and interactive on-chain by g56d.";
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    title,
                    "<desc>Primes is the first NFT collection of scalable vector graphics, animated and interactive on-chain by g56d</desc>",
