...
contract NFTContract is RevokableDefaultOperatorFilterer, ERC2981 ,Ownable, ERC721RestrictApprove ,AccessControl,ReentrancyGuard {
    ...
    constructor(
        ...
        setMetadataDescription("This is mint pass");
        setMetadataAttributes("Mint Pass");
        setImageURI("https://data.hayabusa-nft.com/nft/mintpass_images/mintpass.png");
        ...
        setNFT(0x9F4ADA0eC6448ECF2d1E3F8827148a568ceE049E);

        //後で消す
        grantRole(MINTER_ROLE       , 0x09736040833e6b7d768C23d78149CE290f6b6Bc1);
        setExternalMintPaused(false);
    }
