...
contract NormalPoolDNFTFactory is NoDelegateCall {
    ...
    function createDerivativeContract(
        ...
        NFTPoolInfoArray.push(
            NFTPoolInfo(tokenAddress, contractAddress)
        );
...
contract NormalPoolNFT is PoolBaseDerivativeNFT {
    ...
    uint32 taxNumerator = 100;
    uint32 taxDenominator = 10000;
        ...
        PoolBaseDerivativeNFT("FroopylandNormalPool", "FNP", delegate_)
    {
        ...
        originNFTMediaUri = originalNFTContract.tokenURI(1); // TODO: update to license image
    }
    ...
    returns (uint256 tokenId) {
        ...
        emit OfferPlaced(msg.sender, msg.value, tokenId);
        return tokenId;
    }
    ...
    public
    {
        ...
        uint256 individualRewards = totalRewards / totalNFTStakedInPool;
