...
// File: contracts/mintgrams_st2_3/MNTST3.sol
...
contract MNTST3 is  Ownable, ERC2981, ERC721Enumerable {
  ...
  uint256  public publicPrice = 0.000003 ether; 
  uint256  public maxSupply = 35; 
  uint256  public maxMintPerWallet = 2; 

  bool public paused = false;
  bool public whitelistMintable = true;
  bool public publicMintable = true;

  constructor(        
        string memory uri_,
        address _royaltyRecipient,
        uint96 _royaltyValue) ERC721("MNTST3", "MST3") {
  ...
  function isWhitelisted(address _addressToQuery, bytes32[] calldata proof) external view returns (bool){
      return MerkleProof.verify(proof, merkleRoot, keccak256(abi.encodePacked(_addressToQuery)));
  }
