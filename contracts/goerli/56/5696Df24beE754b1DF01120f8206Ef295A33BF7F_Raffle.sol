...
//Winer to be selected every X minutes

//ChainlinkOracle -> Randomness, Automated executions
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function enterRaffle() public payable {
        ...
        // Name event with the raffle name revareted
     ...
     * 2. The lottery shoul have at least 1 player, and have some ETH
     * 3. Our subscription is funded with LINK
     * 4. Should be in an open state
     */

    function checkUpkeep(
        bytes memory /*chackData*/
    )
        public
        override
        returns (
