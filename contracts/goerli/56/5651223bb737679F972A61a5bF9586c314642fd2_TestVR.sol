...
contract TestVR is ERC721ALockable, ERC2981, Ownable, Pausable {
    ...
    address private constant DEFAULT_ROYALITY_ADDRESS =
        0xdA0b9f2FCB35572E6684E7bbDdF752BcF3BDa2D8;
    bytes32 public merkleRoot;
    mapping(address => uint256) private whiteListClaimed;

    constructor() ERC721A('TestVR', 'TVR') {
    ...
    {
        mintCheck(_mintAmount, 0);
        require(totalSupply() + _mintAmount <= PRE_MAX_SUPPLY, 'PRE_MAXSUPPLY over');
