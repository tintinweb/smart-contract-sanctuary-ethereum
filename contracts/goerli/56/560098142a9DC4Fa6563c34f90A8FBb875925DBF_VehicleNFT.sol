...
contract VehicleNFT is ERC721Upgradeable, AccessControlUpgradeable {
  ...
  mapping(uint256 => uint8) public vehicleType;

  /**
   * @dev Upgradable initializer
   */
  function VehicleNFTInit(
  ...
  function fMint(
    ...
    vehicleType[_pId] = _pVehicleType;
   ...
   * @dev Allow burn
   */
  function fBurn(uint256 _pId) external {
    require(ownerOf(_pId) == _msgSender() || hasRole(BURNER_ROLE, _msgSender()), "Invalid role");
    _burn(_pId);
  }
