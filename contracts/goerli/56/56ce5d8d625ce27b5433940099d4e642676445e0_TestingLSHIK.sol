...
contract TestingLSHIK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Little Shikoku Testing";
    string private constant _symbol = "LSHIKTESTING";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  100000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 1000000 * 10**_decimals;
    uint256 public _maxTxAmount = 1000000 * 10**_decimals;
    uint256 public swapTokenAtAmount = 10000 * 10**_decimals;
