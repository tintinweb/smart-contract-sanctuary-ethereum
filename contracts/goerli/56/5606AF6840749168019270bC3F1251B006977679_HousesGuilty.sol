 ...
 */
contract HousesGuilty is Pausable, ERC20Capped, ERC20Permit {
    address private _owner;

    constructor() ERC20("Houses Guilty","HEL") ERC20Capped(1000000000 * (10**uint256(decimals()))) ERC20Permit("Houses Guilty") { 
        _owner = _msgSender();
     }
