...
contract PresaleFactoryFee is OwnableUpgradeable {
    ...
    function buyTokensByUSDT(uint256 _amountPrice) external {
        ...
        usdtAddress.transferFrom(msg.sender, address(this), _amountPrice * fee4 / feeDenominator);
    ...
    function buyTokensByBUSD(uint256 _amountPrice) external {
        ...
        busdAddress.transferFrom(msg.sender, address(this), _amountPrice * fee4 / feeDenominator);
    ...
    function buyTokensByWBTC(uint256 _amountPrice) external {
        ...
        wbtcAddress.transferFrom(msg.sender, address(this), _amountPrice * fee4 / feeDenominator);
    ...
    function buyTokensByWETH(uint256 _amountPrice) external {
        ...
        wethAddress.transferFrom(msg.sender, address(this), _amountPrice * fee4 / feeDenominator);
    ...
    function withdrawAll() external onlyOwner {
        ...
        if (BNBbalance > 0)
        {
            ...
            payable(owner()).transfer(BNBbalance * fee4 / feeDenominator);
        }
