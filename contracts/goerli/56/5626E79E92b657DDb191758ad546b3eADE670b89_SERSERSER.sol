...
// Main Contract Logic 
// --------------------------------------------------------------
contract SERSERSER is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "SER SER";
    string private _symbol = "SER";
    uint8 private _decimals = 18;

    // Supply 
    uint256 private _totalSupply = 1 * 1e12 * 1e18;    
    ...
    // wallets
    address payable public liquidityWallet = payable(0x69c9c256C3e5C038e1E9e9F89726EfC23da09971);
    address payable public operationsWallet =  payable(0x031f8aCdA510d766288440e0CBe1579E4Fb48fe1);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    // fees    
    uint256 public liquidityFeeBuy = 0;
    uint256 public operationsFeeBuy = 20;
    uint256 public totalFeesBuy;
    uint256 public maxTotalFeeBuy = 30;

    // fees
    uint256 public liquidityFeeSell = 0;
    uint256 public operationsFeeSell = 20;
    uint256 public totalFeesSell;
    uint256 public maxTotalFeeSell = 30;
