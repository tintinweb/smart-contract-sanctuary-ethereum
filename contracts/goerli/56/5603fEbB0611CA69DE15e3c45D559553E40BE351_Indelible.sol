...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Hat", unicode"Face", unicode"Arms", unicode"Torso", unicode"Legs", unicode"Max Health", unicode"Body Color", unicode"Hat Color"];
    bool private shouldWrapSVG = true;
    address private indelibleProContractAddress = 0xf3DAEb3772B00dFB3BBb1Ad4fB3494ea6b9Be4fE;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0xda7f079e6aa74db0530c8b389db82b798e4c0ccc29d03db83649f8f5bc9a51ff;
    ...
    ContractData public contractData = ContractData(unicode"OnChainBandits", unicode"Fight. Survive. Win.", "https://files.indelible.xyz/profile/a590dcbc-d140-4447-8bb8-76976eb2ba37", "https://files.indelible.xyz/banner/a590dcbc-d140-4447-8bb8-76976eb2ba37", "", 500, "0x2052051A0474fB0B98283b3F38C13b0B0B6a3677");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"OnChainBandits", unicode"BANDIT") {
