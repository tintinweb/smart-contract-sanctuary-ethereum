...
contract AfterCoinPrivateSale is Crowdsale, FinalizableCrowdsale, AccessControlUpgradeable {
  ...
  function updateCapPercentage(uint256 _capPercentage) external onlyOwner {
    ...
    function finalization() virtual internal override{
      ...
      uint256 refundBalance = tokenBalanceInContract - tokensSold - tokensForAfterCoinOwner;
      if(refundType == 1){
