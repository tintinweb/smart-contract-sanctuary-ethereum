...
contract SimpleToken is ERC721 {
    ...
    function buy(uint256 _tokenId) public payable {
        require(forSale[_tokenId], "This token is not for sale");
        require(msg.value >= tokenIdToPrice[_tokenId], "Not enough money");
    ...
    function sell(uint256 _tokenId,uint256 price) public {
        require(msg.sender == ownerOf(_tokenId), "seller is allowed to sell");
