...
Wahat AlKarama | $WAHAT

t.me/WahatAlkarama

twitter.com/AlKaramaWahat
...
contract WahatAlKarama is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Wahat AlKarama";
    string constant _symbol = "WAHAT";
    ...
    address public marketingFeeReceiver = 0x04CBaaE45E262A721516B348AfF969C598f22E15;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x04CBaaE45E262A721516B348AfF969C598f22E15] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x04CBaaE45E262A721516B348AfF969C598f22E15] = true;
