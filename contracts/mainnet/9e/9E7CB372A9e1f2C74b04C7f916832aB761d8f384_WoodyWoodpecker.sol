...
// 🐤 Woody Woodpecker (WWC) Unleash your wings, join the conversation, and let's make history together! 🔥✨
// Website - https://woodywcoin.com/
// Twitter - https://twitter.com/WoodyWCoin
// Telegram - https://t.me/WoodyWCoin
...
contract WoodyWoodpecker is IERC20, IERC20Metadata, Ownable {

    using SafeMath for uint256;
    string  private constant _name = "Woody Woodpecker";
    string  private constant _symbol = "WWC";
    ...
    uint256 private _sellFee = 2; // 0%
    uint256 private _burnFee = 0; // 0%
    uint256 private _buyFee = 2; // 0%
