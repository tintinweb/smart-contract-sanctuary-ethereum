...
contract BABYLFT is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x32BE4edFB265f9B1C5F8A6B6D7Ad38cD1620B3e6));
    ...
    string private _name = "Baby LendFlare DAO";
    string private _symbol = "BABYLFT";
    ...
    uint256 public _maxWalletSize = 50000 * 10**6 * 10**9;
