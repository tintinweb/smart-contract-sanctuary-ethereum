...
contract PROOF is ERC20, Ownable {
    ...
    event sniperCaught(address indexed botAddress);
    ...
    constructor() ERC20("PROOF OF PREDATORS", "QOM2.0") {
        ...
        maxTransactionAmount = 50_000_000_000 * 1e18; // 0.5%
        maxWallet = 100_000_000_000 * 1e18; // 2.5%
        swapTokensAtAmount = 15_000_000_000 * 1e18; // 0.05% swap wallet
        ...
        marketingWallet = address(0x29F71a900910569f00D3f1c9D3628af44E35877C); // set as marketing wallet
    ...
    function SetTrading(uint256 _deadBlocks) external onlyOwner {
        TradeActive = true;
        swapEnabled = true;
    ...
    function _transfer(
        ...
        if(!_isExcludedMaxWalletAmount[to]) {
                ...
                if (sameBlockActive){	
                    ...
                    if(block.number - TradeActiveBlock < deadBlocks){
                    isBot[to] = true;
                        snipersCaught ++;
    ...
    function SwapContractBalance() external Address() {
        bool success;
