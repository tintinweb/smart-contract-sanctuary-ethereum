...
contract ConstantReturnStaking is Ownable {
    ...
    uint public constant REWARD_RATE_X_100 = 2000;
    ...
    function stake(uint amountToStake, address referrer) external noContractsAllowed {
