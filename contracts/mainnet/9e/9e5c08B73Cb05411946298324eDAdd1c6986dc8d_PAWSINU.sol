...
contract PAWSINU is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Paws Inu";
    ...
    address payable private _developmentAddress = payable(0x2766ebc48C841EcDCd29d0C5709D453451F3d2de);
    address payable private _marketingAddress = payable(0x2766ebc48C841EcDCd29d0C5709D453451F3d2de);
