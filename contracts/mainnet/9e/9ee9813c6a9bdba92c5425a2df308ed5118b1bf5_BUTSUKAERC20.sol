...
contract BUTSUKAERC20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsuka Deez Buts";
    string private constant _symbol = "BUTSUKA";
