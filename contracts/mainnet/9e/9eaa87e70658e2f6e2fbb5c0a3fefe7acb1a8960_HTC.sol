...
contract HTC is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public quantumLPTokens = 200000000000000000000000; // number of LP tokens needed to earn the reward (200000) x 18 dec
