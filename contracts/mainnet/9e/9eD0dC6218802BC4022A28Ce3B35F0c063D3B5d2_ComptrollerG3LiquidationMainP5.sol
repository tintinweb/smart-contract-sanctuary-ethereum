 ...
 * @author Compound
 */
contract ComptrollerG3Liquidation is ComptrollerV5Storage, ComptrollerG3Interface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getLiquidationExtraRepayAmount() public virtual view returns(uint) {}

    function getLiquidationSeizeIndexes() public virtual view returns(uint[] memory) {}
