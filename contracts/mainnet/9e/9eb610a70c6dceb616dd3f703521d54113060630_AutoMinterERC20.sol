...
contract AutoMinterERC20 is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    // the address of the pro pass staking contract
    address proStakingContract;
    ...
    function mint(address to) payable public
    {
        ...
        uint256 volumeRewardsQuantity = diff  * 350 / 980;
        uint256 stakingRewardsQuantity = diff  * 153 / 980;
        uint256 proStakingRewardsQuantity = diff  * 17 / 980;
        uint256 fundsQuantity = diff  * 460 / 980;
        ...
        _mint(proStakingContract, proStakingRewardsQuantity);
    ...
    /**
     * @notice update the pro pass staking contract address
     * @dev update the pro pass staking contract address
     */
    function updateProPassStakingContract(address proStakingContract_) onlyOwner() public
    {
        proStakingContract = proStakingContract_;
    }
