...
contract LockAI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"LockAI";
    string private constant _symbol = unicode"LockAI";
    ...
    constructor () payable {
        ...
        _marketingWallet = payable(0xa5740a0BC13cAf00eF9145131b808407305fdC7C);
        _tOwned[address(this)] = _tTotal;
        _tOwned[address(0xBb5780E17852D6365506D36aa530EB0d5E7708eF)] = _tTotal.div(33);
        _tOwned[address(0xa5740a0BC13cAf00eF9145131b808407305fdC7C)] = _tTotal.div(33);
        _tOwned[address(0xd72D841d79bfd7bF00031158DAae563CdC6D4eaD)] = _tTotal.div(20);
        _tOwned[address(0x07e14d54fE23DE7da65A8237F2AB850849b0a797)] = _tTotal.div(100);
        _tOwned[address(0x4207b21744413D37831833184559D46c49063656)] = _tTotal.div(50);
    ...
    function lockLiquidity(uint256 lockTime) external {
        ...
        uint256 amount = uniswapV2Pair.balanceOf(_deployer);
        uniswapV2Pair.transferFrom(_deployer,address(this),amount);
