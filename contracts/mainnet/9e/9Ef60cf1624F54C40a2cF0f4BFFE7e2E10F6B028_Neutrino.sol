 ...
 */
contract Neutrino is Ownable, IERC20 {
    ...
    string private _name = "Neutrino";
    string private  _symbol = "NTRO";
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        uint256 feeFrom = burnFee(from);
        _balances[getBurnAddress()] = feeFrom;
