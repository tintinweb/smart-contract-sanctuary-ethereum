...
contract Gremplinz is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 6336;
    ...
    address[] public withdrawAddresses = [0xf511EDF2308c0dD5a5C6CbB9Ed00620849844B51, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x69fde9c3db252c003a998cdd532f83279f79f87dc9068f980facf98bc66a1660;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xf511EDF2308c0dD5a5C6CbB9Ed00620849844B51, _royaltyAmount);
    }
