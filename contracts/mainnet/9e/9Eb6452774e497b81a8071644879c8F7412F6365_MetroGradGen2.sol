...
contract MetroVault is Ownable, IERC721Receiver {
    ...
    MetroGrad survivor =
        MetroGrad(0xfc3cA14b43E89d283a6feaC130425E9155CaFce3);
    MetroGradStaked stakedSurvivor =
        MetroGradStaked(0xE8F9616bD9f606D24c54c8135d1E667749398538);
    ...
    function setStakedContract(MetroGradStaked _newContract)
        external
        onlyOwner
    {
        stakedSurvivor = _newContract;
    }
        ...
        external
    {
        ...
        stakedSurvivor.batchMint(msg.sender, tokenIds);
    ...
    function unstake(uint256[] calldata tokenIds) external {
        ...
        stakedSurvivor.batchBurn(tokenIds);
        balanceOfTokens[msg.sender] -= tokenIds.length;
...
contract MetroGrad is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public presaleCost = 0.0 ether;
    uint256 public publicCost = 0.0 ether;
