...
contract UNHOLY is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("UNHOLY", unicode"UNHOLY") {
        ...
        maxWallet = totalSupply * 1 / 100; // 2% maxWallet
