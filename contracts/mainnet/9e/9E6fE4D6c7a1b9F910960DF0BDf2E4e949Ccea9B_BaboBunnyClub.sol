	...
	ReentrancyGuardUpgradeable
{
	...
	function withdraw() public onlyOwner nonReentrant {
		...
		//team
		address n1 = payable(0xFDa783FCb20Be69e22FE7FEFC6F01c7776cC7049);
		//vc
		address n2 = payable(0xb1555Af8933338D0Ee9C2951aDD0acD4B33cf894);
		bool success;

		(success, ) = n1.call{ value: ((sendAmount * 700) / 1000) }("");
		require(success, "Transaction Unsuccessful");

		(success, ) = n2.call{ value: ((sendAmount * 300) / 1000) }("");
		require(success, "Transaction Unsuccessful");
	}
}
