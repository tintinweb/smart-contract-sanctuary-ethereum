...
🐶 Hot Doge is a trendy initiative on the Ethereum network and run by an experienced team. We’re big fans of Hot Doges! 
and we want to spread our love to all people in the world. We build Hot Doge as a community-centric model, 
in which 100% Liquidity Pool will be locked and the ownership will also be renounced.

Socials: 
🌭 Website: https://hotdoge.io 
🌭 TG Chat: @hotdogeeth
...
contract HotDogeEth is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , HotDogeEth{
...
contract HOTDOGE is ERC20{
    ...
    constructor () ERC20('Hot Doge', unicode'HOTDOGE') {
