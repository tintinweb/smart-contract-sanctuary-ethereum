...
contract THD is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 66666 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "Teh Doge's";
    string private _symbol = "THD";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 8;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public marketingFeePercent = 8;
    ...
    uint256 public _maxTxAmount = 666 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 999 * 10**9;
    uint256 public _maxWalletSize = 1322 * 10**9;
