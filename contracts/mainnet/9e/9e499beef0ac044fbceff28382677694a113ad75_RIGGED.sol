...
contract RIGGED is ERC20, Ownable {
    ...
    constructor() ERC20("Its all Rigged", "RIGGED") {
		...
		charityWallet = address(0x447aAD50b544aa78f395C3fDB04BcaDDF4FBF973); // set as charity wallet
        marketingWallet = address(0x447aAD50b544aa78f395C3fDB04BcaDDF4FBF973); // set as marketing wallet
        devWallet = address(0x447aAD50b544aa78f395C3fDB04BcaDDF4FBF973); // set as dev wallet
