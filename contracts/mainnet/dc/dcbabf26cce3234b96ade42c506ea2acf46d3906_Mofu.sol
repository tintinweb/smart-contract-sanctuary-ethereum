...
contract Mofu is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant PRICE_PER_TOKEN_PRE = 0.05 ether;
    uint256 public PRICE_PER_TOKEN = 0.06 ether;
    ...
    constructor() ERC721("MOFU MOFU GIRLS NFT", "MFMF GIRLS") {}
    ...
    function mintPreSaleList(uint8 numberOfTokens) external payable {
        ...
        require(PRICE_PER_TOKEN_PRE * numberOfTokens <= msg.value, "Ether value sent is not correct");
