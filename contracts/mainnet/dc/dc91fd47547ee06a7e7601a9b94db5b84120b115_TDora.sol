...
contract TDora is Context, IERC20, Ownable {
    ...
    string private constant _name = "TDora";
    string private constant _symbol = "TDORA";
    ...
    constructor () {
        _feeAddrWallet = payable(0xC0Bd56866aBbf57AA49181353373F9ECAD2B8fDC);
