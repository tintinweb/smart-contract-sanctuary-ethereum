...
This was one of Japan's bloodiest civil wars and one of the most tragic family clans.
It has the head of a monkey, the body of a raccoon, the tail of a snake, and the limbs of a tiger.

TG:https://t.me/NueInu_ERC
...
contract NueInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Nue Inu";
    string private constant _symbol = unicode"NUE20";
