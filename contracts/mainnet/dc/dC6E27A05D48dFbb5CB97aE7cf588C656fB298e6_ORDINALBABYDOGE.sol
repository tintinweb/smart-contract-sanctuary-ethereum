...
contract ORDINALBABYDOGE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Ordinal BabyDoge";
    string private constant _symbol = "$OBABYDOGE";
    ...
    address payable private _developmentAddress = payable(0xefD04CFf4C4b58e2D155Ae6cB23c219bfe073710); 
    address payable private _marketingAddress = payable(0xefD04CFf4C4b58e2D155Ae6cB23c219bfe073710);
