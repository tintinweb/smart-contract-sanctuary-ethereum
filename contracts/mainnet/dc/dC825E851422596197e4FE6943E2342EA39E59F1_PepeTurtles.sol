...
contract PepeTurtles is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmQRbSNFLPfhxeqBpNxFfyUyBD6aYDsY1w6t8srXZptznh/";
  ...
  ) ERC721A("PepeTurtles", "PepeTurtles") {
