...
https://twitter.com/elonmusk/status/1586831721386766337?s=20&t=dN-StbNQIBtdIMCpfnip5w

Token Based On Latest Elon Tweet! 
...
contract FALSEELON is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "FALSE ELON";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x41499b14FCa49A40bDd3d0eCe0CBa637ed1F0D8f);
 ...
 //Tokenomics related functions
  function FELONDay() public onlyOwner{
      require(block.timestamp > FELONDaycooldown, "You cant call FELONCoinDay more than once a day");
 ...
 function FELONCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      FELONDaycooldown = block.timestamp + 86400;
 }
