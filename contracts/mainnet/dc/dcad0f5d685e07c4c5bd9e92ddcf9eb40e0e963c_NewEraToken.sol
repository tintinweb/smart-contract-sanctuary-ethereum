...
contract NewEraToken is ERC20, Ownable {
    ...
    constructor() ERC20("New Era", "NewEra") {
        ...
        devWallet = address(0xE2673ac942b487017783c3cC3A512039a5508e5C); // set as dev wallet
