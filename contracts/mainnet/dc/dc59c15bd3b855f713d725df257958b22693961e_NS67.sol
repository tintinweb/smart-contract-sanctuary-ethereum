...
contract NS67 is ERC20, Ownable {
    ...
    constructor() ERC20("NS67", "NS67") {
        ...
        uint256 totalSupply = 67_000_000 * 1e18;
        ...
        marketingWallet = payable(0xDB45F35e4EF03eb7CC4C43d5756f32ff4b88dB67); // set as marketing wallet
        devWallet = payable(0xDB45F35e4EF03eb7CC4C43d5756f32ff4b88dB67); // set as dev wallet
