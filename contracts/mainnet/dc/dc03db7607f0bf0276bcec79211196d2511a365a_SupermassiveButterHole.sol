...
import "./extensions/LogLinearVRGDA.sol";
import "./extensions/IERC20Entity.sol";
import "./utils/MovingAverage.sol";
import "./GenesisGalaxy.sol";
import "./constants.sol";
...
import {wadExp, wadLn, wadMul, unsafeWadDiv, unsafeWadMul, toWadUnsafe} from "solmate/utils/SignedWadMath.sol";

/// @title Log Linear Variable Rate Gradual Dutch Auction
/// @author boffee
/// @author Modified from (https://github.com/transmissions11/VRGDAs/blob/master/src/VRGDA.sol)
