...
/*
The "CoreGPT" is an AI-powered web application designed to simplify the crypto experience for users, Utilizing cutting-edge AI technology.
Web: Website: http://coregpt.network/ 
Tg: https://t.me/CoreGPT
...
contract CoreGPT is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "CORE GPT";
    string private constant _symbol = "CGPT";
