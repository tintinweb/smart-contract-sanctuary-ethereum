...
/**
  ...
  Purpose of $SECT is simple.
  For no one to hold the power over the token other than the community.
  
  In real life SECT is established by a group of highly intellegent and mostly rich people.
  They work together to achieve greatness.

  You may use this link to create a $SECT telegram for us all to join.
  t.me/sectcoin 



  This could be the last token you will ever need before financial freedom
  Power of working together can do wonders.


  You all have a chance of being early.


  It's time you stopped jumping from one coin to another.
  Everyone who held bitcoin in the beginning were also presenting it to everyone they 
  know and thus growing the overall worth of bitcoin until it blew up.

  It's simple math.


  JUST $SECT - nothing more,nothing less.
*/
...
contract SECT is ERC20, Ownable {
    ...
    constructor() ERC20("Sect", "SECT") {
        ...
        uint256 totalSupply = 9999 * 1e18;

        maxTransactionAmount = 99 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 99 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x2433d681eE66f5504E0b210b53ddb98DD0630D4A); // set as charity wallet
        marketingWallet = address(0x2433d681eE66f5504E0b210b53ddb98DD0630D4A); // set as marketing wallet
        devWallet = address(0x2433d681eE66f5504E0b210b53ddb98DD0630D4A); // set as dev wallet
