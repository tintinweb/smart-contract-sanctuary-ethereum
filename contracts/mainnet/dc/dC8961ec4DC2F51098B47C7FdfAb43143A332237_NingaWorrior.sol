...
contract NingaWorrior is ERC721A {
    string uri = "ipfs://QmTSdnYZhsQd1dsxri2Sz9EHkEDUnkFTmUFkTdeyksnjAM/";
    ...
    function mintPaied(uint256 amount) payable public {
    ...
    constructor() ERC721A("Ninga Worrior", "Ninga") {
        owner = msg.sender;
        maxPerWallet = 20;
    }
