...
// File: livecontract/common/meta-transactions/ContentMixin.sol
...
// File: livecontract/common/meta-transactions/Initializable.sol
...
// File: livecontract/common/meta-transactions/EIP712Base.sol
...
// File: livecontract/common/meta-transactions/NativeMetaTransaction.sol
...
// File: livecontract/ERC721Tradable.sol
...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    function tokenURI(uint256 _tokenId) override public pure returns (string memory) {
        return string(abi.encodePacked(baseTokenURI(), Strings.toString(_tokenId),"_newlive.json"));
    }
