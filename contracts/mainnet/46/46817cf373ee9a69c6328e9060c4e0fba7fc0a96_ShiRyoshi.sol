...
/**
  ShiRyoshi | $SHIRY | 
  Community driven and owned ERC20 smart contract with 0% tax. Locked & Renounced!
  ...
  "主人 ShiRyoshi モットー
  人の行動、人の利益！
  誰もが最終的に彼らの行動の結果に直面します!"

  "Shujin ShiRyoshi Motto
  One’s act, one’s profit!
  Everyone eventually faces the consequences of their actions!"
  
  Socials:
 -Telegram | https://t.me/ShiRyoshiERC20
 -Twitter  | https://twitter.com/ShiRyoshiERC20
 -Medium   | https://medium.com/@shiryoshierc20

  Join teh $SHIRY Movement!
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
contract ShiRyoshi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "ShiRyoshi";
    string private constant _symbol = "SHIRY";
    ...
    address payable private _developmentAddress = payable(0xA09Fe98468711dcC24fA8bF9E7Bb0FEcd45317dc);
    ...
    uint256 public _maxTxAmount = 4e1 * 10**9; 
    uint256 public _maxWalletSize = 4e1 * 10**9; 
