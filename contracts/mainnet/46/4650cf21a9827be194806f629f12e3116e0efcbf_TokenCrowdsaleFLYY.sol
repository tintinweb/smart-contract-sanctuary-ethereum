...
contract TokenCrowdsaleFLYY is Ownable, ReentrancyGuard {
    ...
    function changeVestingSchedule(
        ...
        require(_unlockedPercentageTGE <= 100, "TokenCrowdsaleFLYY: unlocked TGE percentage must not be greater than 100");
    ...
    function _buyToken() private {
        ...
        uint256 unlockedShareTGE = (buyableTokens * unlockedPercentageTGE)/100;
