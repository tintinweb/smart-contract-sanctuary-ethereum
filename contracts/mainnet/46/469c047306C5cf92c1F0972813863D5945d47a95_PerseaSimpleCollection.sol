...
contract PerseaSimpleCollection is ERC721, ReentrancyGuard, Randomize(), Ownable {
     ...
     */
    constructor(string memory _folderURI, uint256 _price,uint256 _limit) ERC721("elclasicodemexico","ECDMXN") {
    ...
    function payableMint(uint256 quantity, uint256 tokenId) public nonReentrant payable returns (uint256) {
