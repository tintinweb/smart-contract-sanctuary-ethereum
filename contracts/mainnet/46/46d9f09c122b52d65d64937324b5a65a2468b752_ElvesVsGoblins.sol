...
contract ElvesVsGoblins is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 3332;
    uint256 public MAX_FREE_SUPPLY = 3332;
    uint256 public FREE_MINT_MAX = 1;
    uint256 public publicPrice = 0.001 ether;
    uint256 constant public PUBLIC_MINT_LIMIT_TXN = 10;
    uint256 constant public PUBLIC_MINT_LIMIT_WALLET = 20;


    

    string public revealedURI = "ipfs://QmSDuiDEceitfFJK54RrT8bwoKwCWALa1i4NWrvYqUk68Y/";
    ...
    address public teamWallet = 0x8989b90922c9DC8a2885944Dad88aCe1D7Ce80c6;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("ElvesVsGoblins", "EVG") { }
    ...
    */
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 3332, "Not enough free supply");
