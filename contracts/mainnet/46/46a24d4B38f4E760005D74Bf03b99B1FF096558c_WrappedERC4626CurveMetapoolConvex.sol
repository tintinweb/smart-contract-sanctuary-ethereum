...
contract WrappedERC4626CurveMetapoolConvex is ERC4626, PricePerTokenMixin {
    ...
    IConvexReward public convexReward;
    ...
    uint256 metapoolLpTokenDecimals;
        ...
        ERC20(params.name, params.symbol)
    {
        ...
        metapoolLpTokenDecimals = params.LPToken.decimals();
        ...
        returns (uint256 shares)
    {
        ...
        if (balance == 0)
            shares =
                (lpAmount * (10**decimals())) /
                (10**metapoolLpTokenDecimals);
        else {
    ...
    {
        if (totalSupply() == 0)
            return (shares * (10**metapoolLpTokenDecimals)) / (10**decimals());
        else
            return
        ...
        returns (uint256 shares)
    {
        ...
        uint256 metapoolLpAmount = (assets * (10**metapoolLpTokenDecimals)) /
        ...
        returns (uint256 assets)
    {
        ...
        return
            ...
            ((10**18) * (10**metapoolLpTokenDecimals));
    }
    ...
    function previewDeposit(uint256 assets)
        ...
        returns (uint256)
    {
        uint256 metapoolLpAmount = curveMetapool.calcTokenAmount(assets, true);
        return _convertMetapoolLpAmountToShares(metapoolLpAmount);
    }
    ...
    function previewWithdraw(uint256 assets)
        ...
        returns (uint256)
    {
        uint256 metapoolLpAmount = curveMetapool.calcTokenAmount(assets, false);
        return _convertMetapoolLpAmountToShares(metapoolLpAmount);
    }
