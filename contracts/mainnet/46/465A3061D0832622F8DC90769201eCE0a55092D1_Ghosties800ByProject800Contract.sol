...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x6b84225F4acCfB89DB8Acd29d18BEC56e6a4328C];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 800 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVLry82RpAhJP5fbvE5Fhg6Tj8uENaYEff1o5X2ihPx1P/";
...
// File: contracts/Ghosties800ByProject800Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Ghosties800ByProject800Contract is RamppERC721A {
    constructor() RamppERC721A("Ghosties 800 by PROJECT 800", "Ghosties"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9u3OVYy8BpSkeAW8r1nG/contract-metadata";
    }
}
