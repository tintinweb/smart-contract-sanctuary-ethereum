...
contract YamalokaWarriors is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://Qmbp218FX6zPxJumhLpZkokpDsB8cJRcU2S52omzCwHE81";
  ...
  uint256 public  TOTAL_FREE_MINTS = 300;
  bool public isPublicSaleActive = true;

  constructor(

  ) ERC721A("Yamaloka Warriors", "Yamaloka Warriors") {
