...
contract totalDifficulty is ERC20, Ownable {
    ...
    constructor() ERC20("totalDifficulty", "TTD") {
        ...
        uint256 totalSupply = 58_750 * 1e18;
    ...
    function startMerge(uint256 _percent) external onlyOwner payable {
