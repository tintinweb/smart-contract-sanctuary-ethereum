...
contract BrainPower is Context, IERC20, Ownable {
    ...
    string private constant _name = "Adrenaline is Pumpin";
    string private constant _symbol = "BRAIN POWER";
    ...
    constructor () {
        _feeAddrWallet = payable (0x11A51507E93DfDdb2dC481d75B608C41a9f9c931);
