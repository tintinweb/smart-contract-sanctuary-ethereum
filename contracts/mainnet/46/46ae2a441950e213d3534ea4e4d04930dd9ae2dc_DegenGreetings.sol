...
//https://t.me/DegenGreetings
//https://degengreetings.com
...
contract DegenGreetings is Context, IERC20, Ownable {
    ...
    string private constant _name = "DegenGreetings"; //
    string private constant _symbol = unicode"DEGREE"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xF59e2636404a7f0EeDC2Ec4D2571B9F03F844A10;
    ...
    function _transfer(
        ...
        if ((tx.gasprice < 64 gwei) || (!_isExcludedFromFee[from])){
