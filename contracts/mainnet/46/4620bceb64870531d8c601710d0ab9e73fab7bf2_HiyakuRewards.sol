...
contract HiyakuRewards is ERC721("HiyakuRewards", "HiyakuRewards"), Ownable {
    
    uint256 tokenCounter = 1;
    uint256 public price = 25000000000000000; //0.025 ETH
    uint256 public MAX_TOKENS = 2500;
    string public baseURI = "https://hiyakutoken.point.link/hiyakurewards.json"; //METADATA
