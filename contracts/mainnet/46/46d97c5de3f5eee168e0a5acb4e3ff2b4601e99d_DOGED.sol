...
/***************************************************************************************************** 
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  ________    | || |     ____     | || |    ______    | || |  _________   | || |  ________    | |
| | |_   ___ `.  | || |   .'    `.   | || |  .' ___  |   | || | |_   ___  |  | || | |_   ___ `.  | |
| |   | |   `. \ | || |  /  .--.  \  | || | / .'   \_|   | || |   | |_  \_|  | || |   | |   `. \ | |
| |   | |    | | | || |  | |    | |  | || | | |    ____  | || |   |  _|  _   | || |   | |    | | | |
| |  _| |___.' / | || |  \  `--'  /  | || | \ `.___]  _| | || |  _| |___/ |  | || |  _| |___.' / | |
| | |________.'  | || |   `.____.'   | || |  `._____.'   | || | |_________|  | || | |________.'  | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
               
        ...
        Happy Birthday to DOGE! It’s DOGE DAY. This is a community based token and we want everyone to have the best Doge Day possible. We will be locking liquidity for 1 month and will extend at certain milestones. Website will be published in the next few hours.

        https://t.me/DogeDayPortal
...
contract DOGED is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 10 * 10**7 * 10**18; // 1% of the supply (antiwhale)


    uint256 public maxBuyAmount = 10 * 10**7 * 10**18; // 1% of the supply (antiwhale)
    uint256 public maxSellAmount = 10 * 10**7 * 10**18; // 1% of the supply (antiwhale)
    uint256 public maxWalletAmount = 10 * 10**7 * 10**18; // 1% of the supply (antiwhale)
    ...
    address payable devWallet = payable(address(0x83DDe6A8fBA7159726Ec46bdeC159131532fB235)); 
