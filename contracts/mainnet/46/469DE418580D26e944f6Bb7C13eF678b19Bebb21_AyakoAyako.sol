...
/                                                                                                                                                          
/ By : Murikawa Tugashi
/ Claim one for free Rest 0.0019E
/ 芸術は愛です
/*
...
contract AyakoAyako is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.0019 ether;
    uint   public maxTx             = 10;
    uint   public maxSupply         = 612;
    uint256 public reservedSupply   = 612;
    ...
    constructor() ERC721A("Ayako Ayako", "Ayako") {}
    ...
    function MintAyako(uint256 count) external payable {
    ...
    function MintAyakoo(uint256 Amount) external onlyOwner
    {
