...
//  0% Tax Liquidity locked for 1 month, extended at 100k.  
//  10% Tax at launch to avoid any sniper activity.
...
contract PaulG is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Paul Graham Inu", "PGINU") {
     ...
     uint256 totalSupply = 1 * 10 ** 8 * 10 ** decimals();
        ...
        MarketingWallet = address(0x9beC8443D98e2C3Aa53F8bAa2B9DCA70C2693494); // set as Marketing wallet
        DevWallet = address(0x9beC8443D98e2C3Aa53F8bAa2B9DCA70C2693494); // set as dev wallet
