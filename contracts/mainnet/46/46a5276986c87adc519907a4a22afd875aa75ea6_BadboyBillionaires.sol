...
contract BadboyBillionaires is ERC721A
{
    using Strings for uint256;
    ...
    uint256 public maxMintPerTransaction = 50;
    ...
    constructor(string memory defaultBaseURI) ERC721A("Bad Boy Billionaires", "BBB", maxMintAmount) {
        owner = msg.sender;
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool hs, ) = payable(0x2D6D4CBbE680250C1fE92ECBfFdbEF3F891ce553).call{value: address(this).balance * 15 / 100}("");
        require(hs);
