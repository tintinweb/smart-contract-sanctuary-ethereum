...
The team at $BELLA is developing a wide range of decentralized products & services that offer solutions to common problems consumers face in the DeFi space.

These products & services will launch across a multitude of networks and will collect user fees that are automatically sent to the treasury of the DAO named $BELLA.

Tokenomics - 0% Trading Fee

Max Txn: 1%
Max Wallet: 2%

Anti Bot, No Team tokens, 100% added to the LP and Burnt to the Dead Address Forever

TG: https://t.me/BellatrixDeFi
...
contract BellatrixDeFi is Ownable {
    constructor(
        string memory _NAME,
