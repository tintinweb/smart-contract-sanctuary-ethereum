...
contract IndexedPunks is IERC721A { 
    ...
    string private constant _name = "Indexed Punks";
    string private constant _symbol = "IDXPKS";
    string private constant _contractURI = "ipfs://QmYMnP3hRLDuPcbfx7SgjdvhMtQxG1jxMqJernH1CrWsWU";
    string private _baseURI = "ipfs://bafybeieix2a37wemiq3xi3xckb4542irv4puxs2hc6uiidcvssvjsegjnm/";
    ...
    function mint50() external payable{
        address _caller = _msgSenderERC721A();
        uint256 _amount = 50;
        uint256 _price = ((_amount * COST) / 5)*4; // 20% Discount
        
        require(saleIsActive, "NotActive");
        require(totalSupply() + _amount <= MAX_SUPPLY, "SoldOut");
        require(msg.value >= _price, "More");
