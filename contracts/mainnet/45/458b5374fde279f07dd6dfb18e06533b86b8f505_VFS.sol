...
contract VFS is ERC20, Ownable {
    ...
    constructor() ERC20("VFantasySports", "VFS") {
        ...
        buyBonusFee = 2;
        buyBurnFee = 0;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyBonusFee + buyBurnFee;

        sellOperationsFee = 3;
        sellLiquidityFee = 2;
        sellBonusFee = 2;
        sellBurnFee = 0;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellBonusFee + sellBurnFee;
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _BonusFee, uint256 _burnFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _BonusFee, uint256 _burnFee) external onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee){
            ...
            if(earlyBuyPenaltyInEffect() && automatedMarketMakerPairs[from] && !automatedMarketMakerPairs[to] && buyTotalFees > 0){
                ...
                tokensForDev += fees * buyBonusFee / buyTotalFees;
            ...
            // on sell
                ...
                tokensForDev += fees * sellBonusFee / sellTotalFees;
