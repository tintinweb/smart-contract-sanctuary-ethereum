...
contract Ownable is Context {
     ...
     */
    constructor() {
        _owner = 0x96d21915152EA872Ad2Eb7Be885910210563aA1f;
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //0x10ED43C718714eb63d5aA57B78B54704E256024E pancake
        _token = msg.sender;
    }
