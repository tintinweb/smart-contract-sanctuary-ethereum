...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xA58fb5795dC9146450964cE3bf2A6B7e14Be58dE];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 999) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeidy735k5ldpxzhfgxapn3fwfpsbhp7vujz7xyazhxomkz4oq33po4/";
...
// File: contracts/HoboTownDaoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HoboTownDaoContract is RamppERC721A {
    constructor() RamppERC721A("HoboTownDao", "HOBO"){}
}