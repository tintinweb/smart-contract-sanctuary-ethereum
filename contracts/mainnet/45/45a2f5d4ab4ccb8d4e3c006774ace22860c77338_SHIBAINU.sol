...
/**
Believe it or not,but it's me- RyoshiResearch

If you guys are wondering why I do not send any messages from my twitter it's simply because I have lost the
access to that twitter account.... Yes,I know..

It's all about Shiba Inu.
The army
The believers.
...
Therefore we are starting out fresh.
Another SHIB for me. This time I it will stay in my hands.

Only for teh believers.

We will call it $SHIBA this time. 


FULLY decentralized.

Enjoy- it's time to gather the survivors of the army and have anoter push.
...
contract SHIBAINU is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Inu", "SHIBA") {
        ...
        maxWallet = 5000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x8DDe35E9b3cc4cAf6786b645C79f1C5149c87396); // set as charity wallet
        marketingWallet = address(0x8DDe35E9b3cc4cAf6786b645C79f1C5149c87396); // set as marketing wallet
        devWallet = address(0x8DDe35E9b3cc4cAf6786b645C79f1C5149c87396); // set as dev wallet
