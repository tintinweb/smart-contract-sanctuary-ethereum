...
contract ShibFi is Context, IERC20, Ownable {
    ...
    string private _name = "Shibarium Finance";
    string private _symbol = "ShibFi";
    ...
    uint256 public _totalTax = 4;

    uint256 private _totalSupply = 10_000 * 10**9;
    uint256 public _maxTxAmount = 200 * 10**9;
    uint256 public _walletMax = 200 * 10**9;
    uint256 private minimumTokensBeforeSwap = 20 * 10**9; 
