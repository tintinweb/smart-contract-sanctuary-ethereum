...
/**
     * 10INCH - From the creators of Edgelon.
     * Token for big boys only
     */
...
contract TENINCH is Context, IERC20, Ownable {
    ...
    string private _name = "10INCH TOKEN";
    string private _symbol = "10INCH";
