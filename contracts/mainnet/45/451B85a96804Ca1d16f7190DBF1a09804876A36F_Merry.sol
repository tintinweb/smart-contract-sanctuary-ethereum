...
/**
Christmas is coming soon what's better than a  $MERRY ChrETHmas community Token! 
Low tax 1/1 
Ca renounce
LP will first be locked for 2 weeks initially and extend at higher marketcap if community holds well.

Have a jolly $MERRY ChrETHmas!

Any updates will be via etherscan message so look out for it.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x89Ff88067c8E782a0d28b1cD73f76D2F112079BB;
...
contract Merry is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x89Ff88067c8E782a0d28b1cD73f76D2F112079BB);
    ...
    */
    ...
    string private _name = unicode"Merry ChrETHmas"; 
    string private _symbol = "$MERRY";  
