...
contract KWOND is Context, IERC20, Ownable { 
    ...
    uint256 private constant _tTotal = 111111111111 * 10**8;
    ...
    string private constant _name = "A Kwons Dream";
    string private constant _symbol = "KWOND";
