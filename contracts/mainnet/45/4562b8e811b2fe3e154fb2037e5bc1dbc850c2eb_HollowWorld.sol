...
contract HollowWorld is ERC721A {
    ...
    constructor() ERC721A("Hollow World", "HW") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmQf1aG3zwexQTanUCkjVS1YkrxurUFTpeNxw1kCr3gL2s/", _toString(tokenId), ".json"));
    }
