...
contract HappyChristmasBullRunETH is Context, IERC20, Ownable {
    ...
    string private _name = unicode"عيد ميلاد سعيد الثور تشغيل ETH";
    string private _symbol = unicode"BullETH";
