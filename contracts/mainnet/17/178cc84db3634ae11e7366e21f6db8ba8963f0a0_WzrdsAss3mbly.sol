...
contract WzrdsAss3mbly  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmXfnfbkYyWedyVuNLcyEutWyd3BfQVTqUE9ZBcqAmAWHA/";

    uint256 public immutable mintPrice = 0.003 ether;
    uint256 public immutable minWzrdsAss3mbly = 0.002 ether;
    uint32 public immutable maxSupply = 1666;
    ...
    constructor()
    ERC721A ("WzrdsAss3mbly Official", "Wzrd") {
    }
    ...
    function wzrdsSummon(uint256 amount) public payable callerIsUser{
        require(msg.value > minWzrdsAss3mbly, "insufficient");
    ...
    function wzrdsAss3mbly(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
