...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xe1f28798c532Af6491bB8a85BE28CCf39eB96994];
  address public erc20Payable = 0xe1f28798c532Af6491bB8a85BE28CCf39eB96994;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 8088) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZgX6ZPHTZFPpWEzaBRTdX6sJnxFVsn6BoW13QJZMvKA6/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/oeqTbMWQxNv9NTsmHguu/contract-metadata";
  }
...
// File: contracts/MorphDnAsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MorphDnAsContract is RamppERC721A {
    constructor() RamppERC721A("Morph DNAs", "MORPHDNA"){}
}
