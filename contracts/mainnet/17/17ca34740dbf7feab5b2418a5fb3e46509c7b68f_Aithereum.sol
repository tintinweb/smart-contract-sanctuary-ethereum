...
// File: contracts/ContractNew.sol
...
contract Aithereum is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Aithereum", "AI") {
    setHiddenMetadataUri("ipfs://QmPEL1S1NnMtGA5RYLxWPmbZQwtbBRLrnM9dBHXcvjjmja/1.json");
  }
