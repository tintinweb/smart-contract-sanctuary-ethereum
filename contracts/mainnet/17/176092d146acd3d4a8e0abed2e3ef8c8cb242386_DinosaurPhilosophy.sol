...
contract DinosaurPhilosophy is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("dinosaur philosophy", "DP"){
  }
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on dinosaur");
