// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Goggles", unicode"Eyes", unicode"Teeth", unicode"Mouth", unicode"Hat", unicode"Body", unicode"Stick", unicode"Background"];
        bool private shouldWrapSVG = true;
        string private backgroundColor = "transparent";

        bool public isContractSealed;
        uint public constant maxSupply = 2420;
        ...
        ContractData public contractData = ContractData(unicode"BlockedHeads OnChain", unicode"Pixelated BlockedHeads On Chain", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/6fc324f6-3971-4358-b58f-d3236a31d1fc", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/6fc324f6-3971-4358-b58f-d3236a31d1fc", "", 500, "0xf8Df47772a7FDEd068a44e5c0e292840211Dd590");

        constructor() ERC721A(unicode"BlockedHeads OnChain", unicode"BHOC") {
            TIERS[0] = [100,250,350,500,1220];
TIERS[1] = [100,200,300,500,600,720];
TIERS[2] = [100,219,300,300,351,450,700];
TIERS[3] = [2420];
TIERS[4] = [200,200,269,300,300,351,400,400];
TIERS[5] = [150,250,300,300,300,320,400,400];
TIERS[6] = [200,350,500,1370];
TIERS[7] = [49,100,200,200,200,200,220,251,300,300,400];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"BlockedHeads OnChain #");
