...
contract UniV3VaultConfigurableGovernance is ContractMeta, IUniV3VaultConfigurableGovernance, VaultGovernance {
    ...
    /// @inheritdoc IUniV3VaultConfigurableGovernance
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return
            super.supportsInterface(interfaceId) || type(IUniV3VaultConfigurableGovernance).interfaceId == interfaceId;
    }
    ...
    function createVault(
        ...
        vault = IUniV3VaultConfigurable(vaddr);
        vault.initialize(nft, vaultTokens_, fee_, uniV3Helper_, safetyIndicesSet_);
