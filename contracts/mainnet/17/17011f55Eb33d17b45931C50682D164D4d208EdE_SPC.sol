...
contract SPC is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "https://gateway.pinata.cloud/ipfs/Qmd1HzBCJHhXTPz5LdhTV7AThj6XtCpV5Wp8EUeKiCuKGL";
  ...
  ) ERC721A("The Shy Ponies Club", "SPC") {
