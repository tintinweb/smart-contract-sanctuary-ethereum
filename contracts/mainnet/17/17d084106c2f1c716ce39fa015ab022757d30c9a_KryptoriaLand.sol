...
// File: contracts/KryptoriaAlphaCitizensInterface.sol
...
// File: contracts/KryptoriaLand.sol
...
contract KryptoriaLand is ERC721A, BaseTokenURI {
    ...
    modifier claimIsOpen {
        require(_isClaimActive, "claim land is closed");
    ...
    function toggleClaim()
        ...
        emit ToggleClaimLand(_isClaimActive, block.timestamp);
    }
        ...
        returns (bool[] memory)
    {
        ...
        for (uint16 i = 0; i < tokenIds.length; i++) {
            tokenStatus[i] = _landAllotted[tokenIds[i]];
        }
        return tokenStatus;
    }
    ...
    function transferFrom(address from, address to, uint256 tokenID)
        ...
        override
        {
        require(_stakingStartTime[tokenID] == 0, "land is on stake");
