...
Twitter : https://twitter.com/nizoneko/
Website : https://www.nizoneko.world/
Telegram : T.me/NizoNeko
...
contract NizoNeko is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NizoNeko", "NizoNeko") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xCB9Cd49a02D056627402B49498836Bc0AaE9DD84); // set as marketing wallet
        devWallet = address(0x114d063797eAA2Da0372417aB66f8e0ea7F5FCbB); // set as dev wallet
