...
// TELEGRAM LINK:https://t.me/TheGoatsPortal
...
contract THELASTDANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GOATS-the Last Dance";
    string private _symbol = "MESSI AND RONALDO";
    uint8 private _decimals = 18;

    address public marketingWallet = 0x2090A71663CFF7a1EE927c2CA2cf91Fc17278698;
    address public developerWallet = 0x4CD8fe803e31FA7f2Ed3DaE27D09EdB3C5A3693F;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if((block.timestamp > launchTime + 15 minutes) && !triggered && (launchTime != 0) ){
            _maxTxAmount =  _totalSupply.mul(50).div(denominator);     //5%
            _walletMax = _totalSupply.mul(50).div(denominator);    //5%
            triggered = true;
