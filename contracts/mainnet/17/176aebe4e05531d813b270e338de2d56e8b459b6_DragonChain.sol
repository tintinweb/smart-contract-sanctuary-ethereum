...
/**
    Dragon Chain ERC Token
    Telegram: https://t.me/DragonChainETH
...
contract DragonChain is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x479aF7559335a26A93554e0d0A356334DD90c3A9); // Marketing Address
    address payable public multiSigAddress = payable(0x479aF7559335a26A93554e0d0A356334DD90c3A9); // Marketing Address
    address payable public devAddress = payable(0x479aF7559335a26A93554e0d0A356334DD90c3A9); // Dev Address
    address payable public liquidityAddress = payable(0x479aF7559335a26A93554e0d0A356334DD90c3A9); // Liquidity Address
    ...
    string private constant _symbol = unicode"DRAGCHAIN";
