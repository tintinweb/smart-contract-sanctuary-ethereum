...
contract FF6000 is Context, IERC20 {
    ...
    address public _Owner = 0xf997FD1317852BE08e92Ca56dCeED0A6B595F3c1;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _noAccess(){
    ...
    function airdropPresaleTokens(address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
