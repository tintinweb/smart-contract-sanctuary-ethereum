...
// File contracts/isk/IskraTokenEth.sol

pragma solidity ^0.8.0;

contract IskraTokenEth is IERC165, ERC20, IERC1363 {
    using Address for address;

    constructor(uint256 initialSupply, address initialHolder) ERC20("ISKRA TOKEN", "ISK") {
    ...
    function transferFromAndCall(
        ...
        require(_checkOnTransferReceived(sender, recipient, amount, data), "ERC1363: _checkAndCallTransfer reverts");
        return true;
    }
    ...
    function approveAndCall(
        ...
        require(_checkOnApprovalReceived(spender, amount, data), "ERC1363: _checkAndCallApprove reverts");
        return true;
    }
