...
contract Goki is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Goki", "GOKI") {
    setHiddenMetadataUri("ipfs://QmWwn4WVSUFMTnoBVdV8NMsCj1YpBuV8F9bBMrQojAznoF/hidden.json");
  }
