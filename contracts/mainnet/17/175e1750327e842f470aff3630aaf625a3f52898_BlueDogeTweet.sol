...
contract BlueDogeTweet is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xDDABAa18e7DdC1E3F9161d4Ff947F57b93B09222));

    string private _name = "BlueDogeTweet";
    string private _symbol = "BlueTweet";
