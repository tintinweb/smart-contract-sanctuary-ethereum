...
// ---------------------------- $EMPIRE ---------------------------- //
//Telegram: https://t.me/empiretg
//Twitter: https://twitter.com/EmpireERC20
//Website: https://empireerc20.vercel.app/ (Temporary! Main domain will be shared once website fully built!)


// 4% TAX (1% LIQUIDITY | 3% TREASURY)
// 100,000 Total Supply 5% Max wallet
...
contract EMPIRE is IERC20, Ownable {
    ...
    string constant _name = "EMPIRE";
    string constant _symbol = "EMPIRE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 3) / 100;
    uint256 _maxSellTxAmount = (_totalSupply * 3) / 100;
    uint256 _maxWalletSize = (_totalSupply * 4) / 100;
    ...
    address payable public liquidityFeeReceiver = payable(0x1b6B1586bA315dc6C17D06b166f46c9795f2670A);
    address payable public marketingFeeReceiver = payable(0x1b6B1586bA315dc6C17D06b166f46c9795f2670A);
