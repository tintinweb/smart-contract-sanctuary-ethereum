...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x12839C12A8c4B94aCE4a2608B1F6aa80991d901D];
  address public erc20Payable = 0x12839C12A8c4B94aCE4a2608B1F6aa80991d901D;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihibys5s7j6zebex7vmpbapjtgcrmpgcmrchlnlqrnvvwipi5qfdq/";
...
// File: contracts/DeaddiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DeaddiesContract is RamppERC721A {
    constructor() RamppERC721A("Deaddies", "DEADDIE"){}
}
