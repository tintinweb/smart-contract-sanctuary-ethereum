...
//
//     ___    __                           __                 
//    /   |  / /_  ____  ___  ____ _____ _/ /_____  __________
//   / /| | / __ \/ __ \/ _ \/ __ `/ __ `/ __/ __ \/ ___/ ___/
//  / ___ |/ /_/ / / / /  __/ /_/ / /_/ / /_/ /_/ / /  (__  ) 
// /_/  |_/_.___/_/ /_/\___/\__, /\__,_/\__/\____/_/  /____/  
//                         /____/                             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xd676174De110A262689AF19F2200eE94adf5338c];
  address public erc20Payable = 0xd676174De110A262689AF19F2200eE94adf5338c;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRECg9KWTScNuh3ZZbsx49cqoSKTMVN7ztzaETtTw6XfF/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/5nGsJpt7AopI3nUI5pfF/contract-metadata";
  }
...
// File: contracts/AbnegatorsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AbnegatorsContract is RamppERC721A {
    constructor() RamppERC721A("Abnegators", "Abnegators"){}
}
