...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xB67EB6cdD39bae7095B55D579E80e265D9B6B932];
  address public erc20Payable = 0xB67EB6cdD39bae7095B55D579E80e265D9B6B932;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 706) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXnmapjausBjJgYAaAid4vKf56NqaAyNTomCF1ANMCdy9/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Xc96gqMP2z6gCTziVIfj/contract-metadata";
  }
...
// File: contracts/AncientLandscapesbyFukeiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AncientLandscapesbyFukeiContract is RamppERC721A {
    constructor() RamppERC721A("Ancient Landscapes by Fukei", "Fukei"){}
}
