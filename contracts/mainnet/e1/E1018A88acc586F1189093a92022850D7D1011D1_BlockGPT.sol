...
contract BlockGPT is ERC20, Ownable {
    ...
    event ClaimSupply(address indexed to, uint256 amount, SupplyType indexed supplyType);

    // 1bn total supply
    uint256 public constant TOTAL_SUPPLY = 1_000_000_000 * 10**18;

    uint256 public constant SEED_SUPPLY = 100_000_000 * 10**18;
    uint256 public constant TEAM_SUPPLY = 100_000_000 * 10**18;
    uint256 public constant CEX_SUPPLY = 100_000_000 * 10**18;

    uint256 public constant LIQUIDITY_SUPPLY = 700_000_000 * 10**18;
    ...
    function claimSupply(address _to, uint256 _amount, SupplyType _type) external {
