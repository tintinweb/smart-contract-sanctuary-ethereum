...
contract INUTOSHI is ERC20, Ownable {
    ...
    constructor() ERC20("Inutoshi", "INUTOSHI") {
		...
		charityWallet = address(0xF6E85C6B9E80F2Dddb6b684688d4feff0d5EBfff); // set as charity wallet
        marketingWallet = address(0xF6E85C6B9E80F2Dddb6b684688d4feff0d5EBfff); // set as marketing wallet
        devWallet = address(0xF6E85C6B9E80F2Dddb6b684688d4feff0d5EBfff); // set as dev wallet
