...
contract BABYTY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fable of the Baby";
    string private constant _symbol = unicode"BABYTY";
