...
contract Puppyrium is ERC20, Ownable {
    ...
    constructor() ERC20("Puppyrium", "PUPPYRIUM") {
        ...
        marketingWallet = address(0xEd4876cF3747a0a7a8eFeC9bd374e9D561fDfBc9); // set as marketing wallet
        devWallet = address(0xDF5d1403938e8ed555a1D26b25e1d7290feb0204); // set as dev wallet
