...
The 12% sell tax is collected in the community treasury. Buying after a consecutive amount of 6 sells results in the degen being rewarded.
=================================================================================
=================================================================================
*/
...
contract OnlyUp is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x6977297AB9d4da3123b84A277038E403197128C8);
    address payable private _devAddress = payable(0x6977297AB9d4da3123b84A277038E403197128C8);
    ...
    uint256 public _maxTxAmount = 20000000000 * 10**9; //2% of total supply per txn 
    uint256 public _maxWalletSize = 300000000000 * 10**9; //3% of total supply
