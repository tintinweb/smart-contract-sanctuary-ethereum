...
contract ETHBTC is Context, IERC20, Ownable {
    ...
    string private constant _name = "EthereumBitcoin";
    string private constant _symbol = "ETHBTC";
    ...
    constructor () {
        _taxWallet = payable(0xc254fdCEa2Bbd316F93c6Be919571f2ecF54Bd22);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(taxAmount>100000000000000000){
