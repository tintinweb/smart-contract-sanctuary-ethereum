// ------ This token is a low liquidity token. It will have massive pumps and be volatile because of the liquidity. 
// ------ Please be very careful when buying use low slippage to ensure you don't get frontrun by bots. 
//
// ------ I will add 0.5 ETH to liquidity you will have to buy small at the start, everyone share the buys everywhere 
// ------ lets send this, the market cap will increase very quickly with the big buys!
//
// ------>> https://t.me/lowliquidity 
//
...
contract LowLiquidity is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Low Liquidity", unicode"📊") {
