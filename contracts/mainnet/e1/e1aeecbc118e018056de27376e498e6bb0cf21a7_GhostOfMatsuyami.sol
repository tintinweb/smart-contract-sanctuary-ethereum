...
contract GhostOfMatsuyami is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Ghost Of Matsuyami", "Matsuyami") {
    ...
    function updateFees(uint256 _burnFee, uint256 _devFee) external {
