...
contract Ai_LMAO is Context, IERC20, Ownable {
    ...
    uint256 private constant TaxSwapAmount = 5000000 * 10**_decimals; //
  
    string private constant _name = "Ai_LMAO"; // 
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xA902562296b0e72098E89a7Ce7517ec9A77D95F0).transfer(ethToSend); //marketing wallet
    }
