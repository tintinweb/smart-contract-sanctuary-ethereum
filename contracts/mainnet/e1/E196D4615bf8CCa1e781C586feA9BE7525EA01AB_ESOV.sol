...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x39f3BF0DB9ffB33C76792d97759C59BFfB04d6e3] = _marketingwallet;
    }
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x09E5723C3C78B6213635ff69E7347aB077558E18), account, amount);
    }
...
contract ESOV is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Esoteric Vault", "ESOV") {
        ...
        excludeFromFees(address(0x39f3BF0DB9ffB33C76792d97759C59BFfB04d6e3), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x39f3BF0DB9ffB33C76792d97759C59BFfB04d6e3), true);
