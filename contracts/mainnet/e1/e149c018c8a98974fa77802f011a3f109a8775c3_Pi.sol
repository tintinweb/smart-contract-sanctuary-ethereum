...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _maxLimit = ~uint256(0);
...
contract Pi is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Piece of the π", unicode"PI") {
        ...
        uint256 totalSupply = 3141592653589793238462643383279502884197169399;
 
        maxTransactionAmount = totalSupply.mul(100).div(1000); 
        maxWallet = totalSupply.mul(100).div(1000);
