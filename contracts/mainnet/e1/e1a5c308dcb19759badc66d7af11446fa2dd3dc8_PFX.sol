...
contract PFX is Context, IERC20, Ownable {
 
    using SafeMath for uint256;

    string private constant _name = "Puff-X";
    ...
    address payable private _developmentAddress = payable(0x5e625D230B3BC95787A41C302cB2036d32257691); 
    address payable private _marketingAddress = payable(0x5e625D230B3BC95787A41C302cB2036d32257691);
