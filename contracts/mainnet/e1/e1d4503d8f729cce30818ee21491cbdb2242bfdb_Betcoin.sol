...
Website: https://betcoinsport.com/

Telegram: http://t.me/betcoinsportapp

We are the #1 official decentralized bidding sport app

*/

// Verified using https://dapp.tools

// hevm: flattened sources of src/Betcoin.sol
...
Decentralized bidding sport app
...
contract Betcoin is Ownable, IERC20 {
    ...
    constructor(){
        address _marketingWallet = address(0x0994b0e7f04571104d89370e98dd9F9349CAAE8B);
        address _liquidityWallet = address(0x0994b0e7f04571104d89370e98dd9F9349CAAE8B);
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "Betcoin: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "Betcoin: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "Betcoin: Sender is blacklisted");
        require(!isBlacklisted[recipient], "Betcoin: Recipient is blacklisted");

        require(sender != address(0), "Betcoin: transfer from the zero address");
        require(recipient != address(0), "Betcoin: transfer to the zero address");
        ...
        require(
            ...
            "Betcoin: transfer amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(owner != address(0), "Betcoin: approve from the zero address");
        require(spender != address(0), "Betcoin: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }

    function _mint(address account, uint256 amount) private {
        require(account != address(0), "Betcoin: mint to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) private {
        require(account != address(0), "Betcoin: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "Betcoin: burn amount exceeds balance");
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Betcoin: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "Betcoin: DEX pair can not be removed");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Betcoin: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Betcoin: the router is already set to the new address"
        );
    ...
    function compound() public {
        require(compoundingEnabled, "Betcoin: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "Betcoin_DividendTracker";
    string private _symbol = "Betcoin_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "Betcoin_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "Betcoin_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "Betcoin_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "Betcoin_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("Betcoin_DividendTracker: method not implemented");
    }
