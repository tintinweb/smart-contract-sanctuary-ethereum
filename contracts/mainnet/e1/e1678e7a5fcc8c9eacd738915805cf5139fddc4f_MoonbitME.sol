...
contract MoonbitME is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("MoonbitME", "MBME") {
        setBaseURI("");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max MoonbitME per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 MoonbitME" );
		require(s + _mintAmount <= maxFree, "Cant exceed MoonbitMEs supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 MoonbitME");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more MoonbitME" );
        require(s + _mintAmount <= maxSupply, "Cant exceed MoonbitMES supply");
