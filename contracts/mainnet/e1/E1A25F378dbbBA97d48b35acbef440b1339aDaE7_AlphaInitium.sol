...
contract AlphaInitium is ERC721("Alpha Initium", "ALPHA"), ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    string private baseURI;
    uint256 public constant BUY_LIMIT_PER_TX = 5;
    uint256 public constant MAX_NFT_PUBLIC = 8860;
    uint256 private constant MAX_NFT = 8912;
    uint256 public constant maxGiveaway = 52;
    ...
    */
    function withdraw() public onlyOwner {
        ...
        payable(0x1fbB915efB4BD5E044A09e13C1672df4B8990Ca1).transfer((balance * 900) / 1000);
        payable(0x87114B3f17A7f55DF710d749b39211d20049E866).transfer((balance * 50) / 1000);
        payable(0x18C4d8385a0f6D4Ff2115432DB8B3bC0a643Ecf6).transfer((balance * 50) / 1000);
    }
    ...
    */
    function mintNFT(uint256 _numOfTokens, bytes32[] memory _proof) public payable {
        ...
        if(!isPublicSaleActive) {
            ...
            require(verify(_proof, bytes32(uint256(uint160(msg.sender)))), "Not whitelisted or raffle");
    ...
    */
    function mintMultipleByOwner(address[] memory _to) public onlyOwner {
        require(giveawayCount.add(_to.length) <= maxGiveaway,"Cannot do more giveaway");
