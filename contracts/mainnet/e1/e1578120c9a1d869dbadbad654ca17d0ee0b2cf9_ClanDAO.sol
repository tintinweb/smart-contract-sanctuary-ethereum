...
contract ClanDAO is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _na = "Clan DAO";
    string private constant _sym = "CLAN";
    ...
    uint256 private constant _tTotal = 777777777777 * 10**18;
    ...
    uint256 public taxBuyMarketing = 2;
    uint256 public taxBuyOther = 0;
    uint256 public taxBuyReflections = 0;
    uint256 public taxBuyLiquidity = 2;
	
    uint256 public taxSellMarketing = 2;
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x155268984929946D89Eb2CD80afD1c653A10172b);
        OtherWallet = payable(0x155268984929946D89Eb2CD80afD1c653A10172b);
        DevWallet = payable(0x155268984929946D89Eb2CD80afD1c653A10172b);
