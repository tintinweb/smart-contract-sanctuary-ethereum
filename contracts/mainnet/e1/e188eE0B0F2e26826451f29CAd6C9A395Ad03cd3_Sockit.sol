...
contract Sockit is IERC721A { 
    ...
    uint256 public MAX_FREE = 260;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.002 ether;

    string private constant _name = "Sockit";
    string private constant _symbol = "SOCKIT";
    string private _baseURI = "Qmc6bAUHPYC6GobtR15chhpEFocyYUjveXC2PFGxNJPZzv";
