...
/**
          ...
          _       _________ _______  _______  _______ _________
...
(_______)|/    )_)\_______/|/   \__/(_______)(_______)   )_(   
                                                                                 
      Website: https://uniroot.info/

     Telegram: https://t.me/uniroot
...
contract UNIROOT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("UNIROOT TOKEN", "UNIROOT") payable {
        ...
        MarketingWallet = address(0x299Fea2301bFe27F9a1E57b79dB6c9ae075B892b);
        DevWallet = address(0xe2Ab84512Ff05756500bA7E24f07d2E21324DF0C);
        ...
        // addLiquidity(totalSupply, 10000000000000000);
        updateMaxTxnAmount(10000000001);
        updateMaxWalletAmount(10000000001);
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForDev - ethForBurn;
