...
Flirty AI BOT - Next Trending AI and Valentines coin on ETH!

V1 bot released on launch day + integration with Tinder soon

TG: https://t.me/FlirtyAIBot

Website: https://flirtyai.com/
...
contract FlirtyAIBot is ERC20, Ownable {

    address WBNB = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Flirty AI"; // 
    string constant _symbol = "Flirty AI"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (1); // 1%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (1); // 1%
    uint256 public _maxWalletToken = _totalSupply / (100) * (1); // 1%

    // Fees receivers
    address public autoLiquidityReceiver = 0x1709ea8D12041732B45e70d951595357F64f9469;
    address public marketingFeeReceiver = 0x1709ea8D12041732B45e70d951595357F64f9469;
