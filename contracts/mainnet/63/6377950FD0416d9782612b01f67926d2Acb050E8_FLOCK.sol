...
no one know where we're going

https://twitter.com/BillyM2k/status/1545265462493061120
...
contract FLOCK is ERC20, Ownable {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xc0e12Ae99732ED9d2F276B3e11B4761396D97a99); // set as marketing wallet
    ...
    function inicio() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
