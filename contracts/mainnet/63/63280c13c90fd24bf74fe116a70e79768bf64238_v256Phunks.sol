...
contract v256Phunks is ERC721A, Ownable, ReentrancyGuard {
  ...
  /**
  * @dev Initializes the contract setting the `tokenName` and `symbol` of the v256Phunks, `cost` of each mint call, and maximum `supply` of the v256Phunks.
  * Note: `cost` is in wei. 
  */
  ...
  */
  ...
  nonReentrant{
    ...
    require(count > 0 && count <= 25, "You can drop minimum 1, maximum 25 v256Phunks");
  ...
  */
  ...
  nonReentrant{
    ...
    require(totalSupply() + count <= freeSupply, "Exceed max free supply");
    require(count <= freeMintLimit, "Cant mint more than mint limit");
