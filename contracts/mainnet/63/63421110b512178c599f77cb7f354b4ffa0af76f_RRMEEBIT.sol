...
contract RRMEEBIT is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("RR/MEEBIT", "RR/MEEBIT", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked("https://meebits.app/meebit/", (tokenId+1).toString()));
    }
