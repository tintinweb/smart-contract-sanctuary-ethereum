...
contract Dejavu is ERC20, Ownable {
    ...
    constructor() ERC20("Dejavu", "DJ") {
        ...
        uint256 _totalSupply = 969_696_969 * 1e18;
        ...
        TaxWallet = address(0x3d65181a66a34f3CDF9A462cb4aa90B62931Cac9);
    ...
    function updateBuyFees(uint256 _TaxFee, uint256 _liquidityFee)
        external
        onlyOwner
    {
        buyTaxFee = _TaxFee;
    ...
    function updateSellFees(uint256 _TaxFee, uint256 _liquidityFee)
        external
        onlyOwner
    {
        sellTaxFee = _TaxFee;
