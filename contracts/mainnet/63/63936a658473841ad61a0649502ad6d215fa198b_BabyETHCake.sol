...
contract BabyETHCake is Context, IERC20, Ownable {
 
    using SafeMath for uint256;


    //token info:
    string private constant _name = unicode"Baby ETHCake";
    string private constant _symbol = "BETHCAKE";
    ...
    address payable private _developmentAddress = payable(0x4c7dc128aa3583054678df13C3112d7de587Bc14); 
    address payable private _marketingAddress = payable(0x4c7dc128aa3583054678df13C3112d7de587Bc14);
