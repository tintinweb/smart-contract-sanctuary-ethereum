...
/*
The Illuminati have been lurking in the shadows for ages, pulling the strings and levers behind the scenes in
order to establish a new world order. Cryptonian Illuminati will focus on setting a new world order in the crypto
wolrd. It will be a place where wealth is distributed among members through secret society events.

Every 48h we will select 3 active community members that will share the wealth in the Illuminati wallet: 1% of
taxes generated each.

More info: 
- www: https://cryptonianilluminati.com
- tg: https://t.me/cryptonianilluminati
*/
...
contract CRYPTONIAN is Ownable, IERC20 {
    ...
    uint256 public _feePercent = 8;
    IUniswapV2Router private _router = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    string private _name = "Cryptonian Illuminati";
    string private  _symbol = "CRILL";
