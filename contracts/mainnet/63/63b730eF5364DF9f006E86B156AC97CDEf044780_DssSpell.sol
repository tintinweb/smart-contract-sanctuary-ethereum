...
contract DssSpellAction is DssAction, DssSpellCollateralOnboardingAction {
    ...
    function actions() public override {
        ...
        GemJoin6Like_1(MCD_JOIN_TUSD_A).setImplementation(TUSD_PREV_IMPL, 0);
        GemJoin6Like_1(MCD_JOIN_TUSD_A).setImplementation(TUSD_NEXT_IMPL, 1);
