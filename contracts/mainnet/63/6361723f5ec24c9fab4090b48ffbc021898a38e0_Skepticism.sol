...
contract Skepticism is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.005 ether;
  uint public          maxPerTx          = 20;
  uint public          totalFree         = 158;
  uint public          maxSupply         = 458;
  uint256 public        maxFreePerWallet = 2;
  bool public          mintEnabled;
  mapping(address => uint256) private _mintedFreeAmount;

  constructor() ERC721A("Skepticism by Rad", "Skepticism"){
  }
