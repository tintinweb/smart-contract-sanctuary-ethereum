...
import './IERC721Child.sol';
import "@openzeppelin/contracts/access/Ownable.sol";

contract StylikeNFTEthBridge is Ownable {
  ...
  function initializeBridge(address ethNFTAddress) external onlyOwner {
    ethNFT = IERC721Child(ethNFTAddress);
  ...
  function bridgeNFT(
    ...
    ethNFT.mint(_requester, _tokenId);
    emit NFTBridged(
      _requester,
      _mainDepositHash,
      _tokenId,
  ...
  function setGatewayAddress(address gatewayAddress)
    external
    onlyOwner
  {
    require(gatewayAddress != address(0));
