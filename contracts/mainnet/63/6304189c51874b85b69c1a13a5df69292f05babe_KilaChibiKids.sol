...
contract KilaChibiKids is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public  PUBLIC_SALE_PRICE = 0.001 ether; //do not be stingy on real projects
  uint256 public  NUM_FREE_MINTS = 1000;
  uint256 public  MAX_FREE_PER_WALLET = 1;
  uint256 public freeAlreadyMinted = 0;
  bool public isPublicSaleActive = false;
  constructor() ERC721A("KilaChibiKids", "KCK") {
  }
      ...
      payable
  {
    ...
    require(totalSupply() + numberOfTokens < maxSupply + 1, "minted out!");
  ...
  function treasuryReserve(uint quantity)
    public
    onlyOwner
  {
    require(
