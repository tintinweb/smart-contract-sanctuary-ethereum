...
/**
For all the antisocial chads out there. No Twitter, no telegram, no communnication with other people. 

對於所有反社會的乍得。沒有推特，沒有電報，沒有與其他人的交流。
...
contract Antisocial is ERC20, Ownable {
    ...
    constructor() ERC20("Antisocial", "ALONE") {
