...
Welcome to the official launch of $SOUL token, $SOUL is a decentralized ERC token that will be attached to their NFT Collection (Devil Town).

- ERC-20 
- Completed NFT Collection
- Top 1,000 Holders air-dropped one of our NFT's, after release.

More info to come join for now Saiyans!

Web: deviltown.org
Telegram: t.me/soultokenerc
Twitter: http://twitter.com/deviltownnft
...
contract DevilTown   is Context, IERC20, Ownable {
    ...
    string private _name = 'DevilTown   ';
