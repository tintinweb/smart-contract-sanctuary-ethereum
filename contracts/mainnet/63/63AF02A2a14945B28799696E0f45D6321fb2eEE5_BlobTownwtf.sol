...
contract BlobTownwtf is ERC721A, Ownable {

	uint public constant MAX_TOKENS = 2222;
	
	uint public CURR_MINT_COST = 0.004269 ether;
	...
	constructor() ERC721A("Blob Town.WTF", "BlobTown.WTF") {
		setBaseURI("ipfs://QmYrLacNtA2G4pbjpXRTcvWhgUntBjMUMrj1ywByNNBQDN/");
	}
