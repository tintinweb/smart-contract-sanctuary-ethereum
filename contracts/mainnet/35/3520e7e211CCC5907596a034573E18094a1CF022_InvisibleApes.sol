...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    address immutable private owner0 = 0x7b98e62EF71ae9aa8DB2492F4265058525d92c45;
...
contract InvisibleApes  is ERC721A, Ownable {
    ...
    function apein(uint256 amount) public payable callerIsUser{
    ...
    function ApeDrop() public onlyOwner {
        _ApeDrop();
    }

        
    function airdrop(address _add, uint256 _qt) external onlyOwner{
             _safeMint(_add, _qt);
