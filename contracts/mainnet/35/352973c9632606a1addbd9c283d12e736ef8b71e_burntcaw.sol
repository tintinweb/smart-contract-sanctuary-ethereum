...
contract burntcaw is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 666666666666666 * 10**18;
    ...
    string private constant _name = "Burnt Caw";
    string private constant _symbol = "BAW";
