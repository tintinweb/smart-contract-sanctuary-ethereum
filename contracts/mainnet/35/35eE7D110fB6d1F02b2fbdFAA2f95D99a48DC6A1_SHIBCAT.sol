...
/*
In a crypto world ruled by Dogs , SHIBARIUM CAT $SHIBCAT aims to be the first cat crypto meme coin on the Shibarium chain.
...
contract SHIBCAT is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SHIBARIUM CAT";
    string private constant _symbol = "SHIBCAT";
    ...
    address payable private _developmentAddress = payable(0x79aC7b4FBa14139B0285039111965a4FC5A5e2Ee); 
    address payable private _marketingAddress = payable(0x79aC7b4FBa14139B0285039111965a4FC5A5e2Ee);
