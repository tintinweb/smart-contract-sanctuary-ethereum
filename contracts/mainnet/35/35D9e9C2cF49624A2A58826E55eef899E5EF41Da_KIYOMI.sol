...
/**
Telegram: https://t.me/KiyomiERC
Website: https://kiyomicoin.space/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0EE2Bc101f2A2C57dF413d4b5A93E02281B9fE3d;
...
contract KIYOMI is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x0EE2Bc101f2A2C57dF413d4b5A93E02281B9fE3d);
    ...
    */
    ...
    string private _name = unicode"Kiyomi きよみ"; 
    ...
    */
    ...
    function Opentrading(bool true_or_false) public onlyOwner {
    ...
    */
    ...
    function SetMarketingwallet(address addresses) external onlyOwner {
    ...
    function SetBurnwallet(address addresses) external onlyOwner {
    ...
    */
    ...
    function blacklistMode(bool true_or_false) public onlyOwner {
    ...
    */
    ...
    // Default is true
    function setTransfersFee(bool true_or_false, uint256 _uint) external onlyOwner {
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function setMaxWalletPercent(uint256 maxWallPercent_x100) external onlyOwner() {
