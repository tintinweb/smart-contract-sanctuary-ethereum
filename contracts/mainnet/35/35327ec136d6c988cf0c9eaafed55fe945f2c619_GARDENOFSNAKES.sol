...
contract GARDENOFSNAKES is ERC20, Ownable {
    ...
    constructor() ERC20("Garden of Snakes", "SNAKES") {
		...
		charityWallet = address(0x303a1d330ceaF6f7A084dEd7b854225b8a9025D6); // set as charity wallet
        marketingWallet = address(0x303a1d330ceaF6f7A084dEd7b854225b8a9025D6); // set as marketing wallet
        devWallet = address(0x303a1d330ceaF6f7A084dEd7b854225b8a9025D6); // set as dev wallet
