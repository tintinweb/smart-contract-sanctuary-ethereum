...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢠⡾⢷⡄⠀⠀⠀⠀⠉⠙⠯⠀⠀⡴⠋⠀⢠⠟⠀⠀⢹⡄    
 ...
 if you missed PEPEGOLD, dont fade PEPEREUM
 
 PEPE + ETHEREUM = PEPEREUM

 MAKE PEPE AND ETHEREUM GREAT AGAIN. COMMUNITY DRIVEN. LOCK AND RENOUNCE AFTER LAUNCH.
 WEBSITE: pepereum.xyz
 TWITTER: @pepereumerc20
...
contract PEPEREUM is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x5CEfD0FF8614495864502E70C6BAd46f1f9D92eD); 
    address payable private _marketingAddress = payable(0x5CEfD0FF8614495864502E70C6BAd46f1f9D92eD);
