...
contract PirateChest is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Pirate ETH Chest", "CHEST") {
        setHiddenMetadataUri("https://api.piratechest.xyz/");
        setBaseURI("https://api.piratechest.xyz/");
    }
    ...
    require(mintEnabled, "Mint not live yet");
      ...
      require(totalSupply() + count <= maxSupply, "No more Chest");
