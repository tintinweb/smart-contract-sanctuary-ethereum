...
contract LobsterRoll is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Lobster Roll";
    ...
    address payable private scorcherWallet = payable(0xc98B7923fbc5330544E44f14e23a00d71f634c53);
    address payable private jeetWallet = payable(0xc98B7923fbc5330544E44f14e23a00d71f634c53);
    ...
    function sendETHToFee(uint256 amount) private {
        scorcherWallet.transfer((amount).div(2));
        jeetWallet.transfer((amount).div(2));
    }
    ...
    function setJeetWallet(address payable _address) external onlyOwner {
        jeetWallet = _address;
    }
