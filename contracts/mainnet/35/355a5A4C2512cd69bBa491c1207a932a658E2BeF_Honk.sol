...
contract Honk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Honk";
    string private constant _symbol = "HONK";
    ...
    address payable private _developmentAddress = payable(0xAd0A82b533a42485041CfA105F2FCEf32C3138F1);
    address payable private _marketingAddress = payable(0x536fffDdb5FA755166C4B194d46E1B6310CD8bAe);
