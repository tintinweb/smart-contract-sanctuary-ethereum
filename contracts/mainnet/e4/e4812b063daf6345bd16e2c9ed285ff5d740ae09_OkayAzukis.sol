...
contract OkayAzukis is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("OkayAzukis", "OKAYA"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more okay azuki");
    require(mintEnabled, "Minting is not live yet, hold on okay azuki.");
