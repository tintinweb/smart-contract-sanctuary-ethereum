...
contract DegenXmas2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("A Degens Christmas Story Ch 2", "$DegenX") {
        ...
        maxWallet = totalSupply * 40 / 1000; // 1% maxWallet
        ...
        marketingWallet = address(0xCFB58866Fb604b258fad6784CDd9A927d43499B8); // set as marketing wallet
        devWallet = address(0x9db02DDfa70476D26763BE14BCc5dDaaE3DF40e5); // set as dev wallet
