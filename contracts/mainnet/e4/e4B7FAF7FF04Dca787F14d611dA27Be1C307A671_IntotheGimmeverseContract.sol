...
//    /  _/___  / /_____     / /_/ /_  ___     / ____(_)___ ___  ____ ___  ___ _   _____  _____________ 
//    / // __ \/ __/ __ \   / __/ __ \/ _ \   / / __/ / __ `__ \/ __ `__ \/ _ \ | / / _ \/ ___/ ___/ _ \
//  _/ // / / / /_/ /_/ /  / /_/ / / /  __/  / /_/ / / / / / / / / / / / /  __/ |/ /  __/ /  (__  )  __/
// /___/_/ /_/\__/\____/   \__/_/ /_/\___/   \____/_/_/ /_/ /_/_/ /_/ /_/\___/|___/\___/_/  /____/\___/ 
//                                                                                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x86E5373e6eceAd0Db0D75dfa646aD4155C48Efa6];
  address public erc20Payable = 0x86E5373e6eceAd0Db0D75dfa646aD4155C48Efa6;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 0.0195 ether;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiezpst5ifdofmakkwd46vqyf7jb24lfjounk3lk5iarhybil5hpwy/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 4000");
...
// File: contracts/IntotheGimmeverseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract IntotheGimmeverseContract is RamppERC721A {
    constructor() RamppERC721A("Into the Gimmeverse", "GIMME"){}
}