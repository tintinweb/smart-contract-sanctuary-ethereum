...
contract SiriGPT is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Siri GPT';
    ...
    address internal constant development_receiver = 0x8940Abcfdb975cD207096AbBeEc836ff7669Cb10; 
    address internal constant marketing_receiver = 0x8940Abcfdb975cD207096AbBeEc836ff7669Cb10;
    address internal constant liquidity_receiver = 0x8940Abcfdb975cD207096AbBeEc836ff7669Cb10;
    ...
    function swapBack(address sender, address recipient, uint256 amount) internal {
        if(shouldSwapBack(sender, recipient, amount)){swapAndLiquify(swapThreshold); swapTimes = uint256(1);}
    }
