...
contract GobbleGobble is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private earlySellBuybackFee;
    ...
    constructor() ERC20("GobbleGobble", "Gobble") {
    ...
    ; uint256 totalSupply = 7777777 * 10**9;
 
        maxTransactionAmount = totalSupply * 100 / 10000; // .25% maxTransactionAmountTxn
        maxWallet = totalSupply * 200 / 10000; // .5% maxWallet  
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _buybackFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee, uint256 _earlySellBuybackFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if (!isBuy && enableEarlySellTax) {
            if (_holderFirstBuyTimestamp[from] != 0 &&
		        ...
		        sellBuybackFee = earlySellBuybackFee;
                sellTotalFees = sellMarketingFee + sellLiquidityFee + sellBuybackFee;
            } else {
                sellLiquidityFee = 0;
                sellMarketingFee = 8;
