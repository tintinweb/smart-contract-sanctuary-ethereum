...
The aggressive protector of TSUKA, Dejitaru Katana ($sword) is here to defend him from his enemies. Sending 50% of the taxes to TSUKA deployer and burning even more TSUKA tokens manually. 

https://t.me/DejitaruKatanaERC20
...
contract DejitaruKatana is Context, IERC20, Ownable {
    ...
    constructor () {
        _taxWallet1 = payable(0x8242e56a759aa0B069B9c983fe3f582020CD1eC9);
        _taxWallet2 = payable(0xA23683f6386795182af77df054c0e43b8CcD4879);
        _taxWallet3 = payable(0x948962071F11D43D2434B1Bf49ab34D8edE92C25);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _taxWallet2.transfer(amount.mul(25).div(100));
        _taxWallet3.transfer(amount.mul(25).div(100));
