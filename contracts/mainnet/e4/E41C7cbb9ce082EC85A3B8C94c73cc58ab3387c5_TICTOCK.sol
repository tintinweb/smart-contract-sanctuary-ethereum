...
/**
Cryptocurrency has become a mainstrem nowadays and you can see lots of people gain awareness weather its the good side or the bad side. 

Although not all people can be profitable some are still finding ways to coup up to learnings and such . 

We are introducing to you the Tick-tock token where you can see in our developing site about the latest news and fundamental
analysis than can help you in your trading journey weather its huge caps, low caps, NFT ,DeFi or shitcoins. 

A mysterious man once said: 
...
contract TICTOCK is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xfd6F7d83aaA94064b20ad667bB8aF0DcB6956B78;

    string private _name = "Divine Timing";
    string private _symbol = "TIC - TOCK";
