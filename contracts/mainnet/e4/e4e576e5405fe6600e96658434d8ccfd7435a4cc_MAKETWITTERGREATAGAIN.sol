...
contract MAKETWITTERGREATAGAIN is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "MAKETWITTERGREATAGAIN";
 string private _symbol = "MAKETWITTERGREATAGAIN";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x770582B59A443fe2F2fe9D8a1C338A6f38c64201);
 ...
 uint256 MAKETWITTERGREATAGAINDaycooldown = 0;
 ...
 //Tokenomics related functions
  function MAKETWITTERGREATAGAINDay() public onlyOwner{
      require(block.timestamp > MAKETWITTERGREATAGAINDaycooldown, "You cant call MAKETWITTERGREATAGAINCoinDay more than once a day");
 ...
 function MAKETWITTERGREATAGAINCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      MAKETWITTERGREATAGAINDaycooldown = block.timestamp + 86400;
 }
