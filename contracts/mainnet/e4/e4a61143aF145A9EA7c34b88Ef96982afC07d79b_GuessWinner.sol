...
contract GuessWinner is ReentrancyGuard, Ownable {
    ...
    function deposit(
        ...
        uint256 reward = getRelationReward(fee);
        fee = fee - reward;
    ...
    function getUserFee(uint256 _amount) public view returns (uint256) {
        return (_amount * poolFee) / 100;
    }

    function getRelationReward(uint256 _amount) public view returns (uint256) {
