...
contract ArechiNFT is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint public MAX_PER_WALLET_WL = 999;


    uint public wlSalePrice = 0.0099 ether;
    uint public publicSalePrice = 0.011 ether;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL, string memory _baseURI) ERC721A("ArechiNFT", "ArechiNFT")
