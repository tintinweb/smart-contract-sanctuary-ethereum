...
/*
 ...
 _               _                          __              
| |             | |                        / _|             
| |__   __ _  __| | __ _ ___ ___ _ __ ___ | |_ ___ _ __ ___ 
| '_ \ / _` |/ _` |/ _` / __/ __| '_ ` _ \|  _/ _ \ '__/ __|
| |_) | (_| | (_| | (_| \__ \__ \ | | | | | ||  __/ |  \__ \
|_.__/ \__,_|\__,_|\__,_|___/___/_| |_| |_|_| \___|_|  |___/
...
error SenderExceedsMintedItsRights();



contract badassmfers is ERC721A, Ownable, ReentrancyGuard {
    uint256 public constant MAX_SUPPLY = 19;
    uint256 private constant MAX_MINTS_PER_WALLET = 1;
    uint256 private constant MAX_MINTS_PER_TX = 1;

    address public constant GB_ADDRESS = 0xb1779B51577A6a88A36d93ab4e8e03E21b359a24;
    ...
    constructor() ERC721A("badassmfers", "BAMFERS") {}
    ...
    function mint(uint256 quantity) external payable nonReentrant onlyEOA {
        ...
        if (_mints[msg.sender] >= MAX_MINTS_PER_WALLET)
            revert SenderExceedsMintedItsRights();

        _mints[msg.sender] += quantity;
    ...
    function withdraw() external onlyOwner {
        (bool os, ) = payable(GB_ADDRESS).call{value: address(this).balance}("");
        require(os);
    }
...
// Drawn by Ryan Maloney, Crunchy Cows creator.
// A small band of mfers came together to make this project possible.
// You know who you are.
// HeresMyCharityProject 😎