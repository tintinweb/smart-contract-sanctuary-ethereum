...
This contract is forked from Classic Luna Inu (https://etherscan.io/address/0x76Cc895a0Cb822a50D03CCaFc7e99F2Ba9462B25#code)
You can check the similarity using this link, https://etherscan.io/contractdiffchecker?a1=0x76Cc895a0Cb822a50D03CCaFc7e99F2Ba9462B25
then add this contract address on the contract address 2 on the right side of your screen

I will add 3 ETH to liquidity pool then lock it for 1 week, and extend it if this get enough traction
Ownership will also be renounced after i lift the tx limit
Tokenomic is the same as Classic Luna Inu but i reduced the tax from 6/15 to 3/3 
I will add 99% supply to the liquidity pool and keep 1% of supply for my wallet

https://t.me/TopGunInuEntry
*/
...
contract TopGunInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Top Gun Inu", "TGI") {
    ...
    ; uint256 totalSupply = 1 * 1e12 * 1e18;
        ...
        maxTransactionAmount = totalSupply * 15 / 1000; // 0.9% maxTransactionAmountTxn
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        maxTransactionAmount = newNum * (10**18); // Cannot set maxTransactionAmount lower than 0.1%
    }
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee; // Must keep fees at 10% or less
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee, uint256 _earlySellDevFee) external onlyOwner {
        ...
        earlySellMarketingFee = _earlySellMarketingFee;
	    earlySellDevFee = _earlySellDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee; // Must keep fees at 15% or less
    }
