...
// https://t.me/RyoshiLegacy
// https://ryoshilegacy.io/
...
// Main Contract Logic 
// --------------------------------------------------------------
contract RyoshiLegacy is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Ryoshi Legacy";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xaCE0b5D9dCcE2AB1D5C3403E3bd42d393f2E5440);
    address payable public operationsWallet =  payable(0xaCE0b5D9dCcE2AB1D5C3403E3bd42d393f2E5440);
