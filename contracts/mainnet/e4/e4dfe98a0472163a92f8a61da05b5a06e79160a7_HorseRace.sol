...
contract HorseRace is protected {
    ...
    constructor(address d, address token) {
        ...
        devWallet = d;
        enable_bet_value(10000000000000000, true);
        enable_bet_value(20000000000000000, true);
        enable_bet_value(50000000000000000, true);
    }
