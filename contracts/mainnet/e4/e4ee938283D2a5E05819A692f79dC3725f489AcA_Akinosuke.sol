...
contract Akinosuke is ERC20, Ownable {
    ...
    constructor() ERC20("AKINOSUKE", "YUME") {
        ...
        uint256 totalSupply = 2560000000 * 1e18;
		...
		charityWallet = address(0x2A2F7B4Ce7E9D06e6C68f27Db13e070928b3d728); // set as charity wallet
        marketingWallet = address(0x2A2F7B4Ce7E9D06e6C68f27Db13e070928b3d728); // set as marketing wallet
        devWallet = address(0x2A2F7B4Ce7E9D06e6C68f27Db13e070928b3d728); // set as dev wallet
