 ...
 */
contract ERC20 is Context, IERC20, IERC20Detailed, IERC20Allowance, ERC165Storage {
...
contract knoknok is ERC20 {
    constructor(address[] memory holders, uint256[] memory amounts) ERC20("knoknok", "KKC") {
        require(holders.length == amounts.length, "knoknok: inconsistent arrays");
        for (uint256 i = 0; i != holders.length; ++i) {
            _mint(holders[i], amounts[i] * 10 ** decimals());
        }
    }
}