...
BIG BALLER CHEEMS -
An ambitious and exploratory project in the ever-so-growing De-Fi space. Our in-house Baller Progressive Protocol (BPP) helps automatically regulate liquidity for steady growth and safer transactions.

Become a part of the next generation of crypto brands.

WEB:
https://www.bigballercheems.com/

TWITTER:
https://twitter.com/BigBallerCheems/

TELEGRAM:
https://t.me/BigBallerCheems/
...
contract BigBallerCheems is Context, IERC20, Ownable {
    ...
    string private constant _name = "Big Baller Cheems";
