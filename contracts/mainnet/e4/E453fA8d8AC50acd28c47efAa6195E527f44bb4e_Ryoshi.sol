...
contract Ryoshi is ERC20, Ownable {
    ...
    constructor() ERC20("Ryoshi Legacy", unicode"ⓇⓎⓄⓈⒽⒾ ⓁⒺⒼⒶⒸⓎ") {
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 1000)/1e6, "Cannot set maxTransactionAmount lower than 0.1%");
        maxTransactionAmount = newNum * (10**6);
    }
 
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 1000)/1e6, "Cannot set maxWallet lower than 0.5%");
        maxWallet = newNum * (10**6);
    }
