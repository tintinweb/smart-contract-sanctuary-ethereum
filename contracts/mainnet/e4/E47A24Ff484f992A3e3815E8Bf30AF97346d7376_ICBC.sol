...
//.      https://twitter.com/ICBCeth 
//.      Industrial and Commercial Bank of China coin (中国工商银行)
...
contract ICBC is ERC20, Ownable {
    ...
    constructor() ERC20("Bank of China", "ICBC") {
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner {
  	    ...
  	    require(newAmount <= totalSupply() * 1 / 5000, "Swap amount cannot be higher than 0.5% total supply.");
