...
contract TheNewInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The New Inu";//
    string private constant _symbol = unicode"TNI";//
    ...
    address payable private _developmentAddress = payable(0xB17b50bEc3Ae6E62791b426078EE425511A70371);//
    address payable private _marketingAddress = payable(0xbaBe80f320b3FAF6A3Eb56E65F2B098487BC8212);//
