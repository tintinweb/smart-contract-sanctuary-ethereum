...
contract BabyDosa is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xdd37C7E19978bEAd29028BA37FA1B76083fc2822); // Marketing Address
    address payable public multiSigAddress = payable(0xdd37C7E19978bEAd29028BA37FA1B76083fc2822); // Marketing Address
    address payable public devAddress = payable(0xdd37C7E19978bEAd29028BA37FA1B76083fc2822); // Dev Address
    address payable public liquidityAddress = payable(0xdd37C7E19978bEAd29028BA37FA1B76083fc2822); // Liquidity Address
    ...
    string private constant _name = unicode"Baby Dosa";
    string private constant _symbol = unicode"BDOSA";
