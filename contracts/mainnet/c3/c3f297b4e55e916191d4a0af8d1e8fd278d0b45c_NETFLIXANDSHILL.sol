...
contract NETFLIXANDSHILL is ERC20, Auth {
 using SafeMath for uint256;
 address immutable WETH;
 address constant DEAD = 0x000000000000000000000000000000000000dEaD;
 address constant ZERO = 0x0000000000000000000000000000000000000000;
 string public constant name = "NETFLIX & SHILL";
 ...
 uint256 public constant maintainerFee = 1;
 uint256 public constant totalFee = 3;
 uint256 public constant feeDenominator = 100;
 address public autoLiquidityReceiver;
 address public maintainerFeeReceiver;
 ...
 maintainerFeeReceiver = msg.sender;
 ...
 uint256 amountETHmaintainer = amountETH.mul(maintainerFee).div(totalETHFee);
 payable(maintainerFeeReceiver).transfer(amountETHmaintainer);
