...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function getHolderWL(address owner) public view returns (uint256) {
       uint256 holderWL;
       holderWL = uint256(IERC721(0x0d6D6e695b06e1A9439C3479597A9e8af016Dec4).balanceOf(owner));
       return holderWL;
    }
...
contract ControlNetZukis is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    constructor() ERC721A("ControlNet Zukis", "CZ"){}
    ...
    function holderMint(uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
        require(holderSaleActive, "Holder  is not Active");
        require(numberMinted(msg.sender) + _mintAmount <= publicLimit, "Mint limit exceeded." );
        holderCheck = getHolderWL(msg.sender);
        require(holderCheck >= 1);
        require(msg.value >= holderCost, "INCORRECT_ETH");
    ...
    function publicMint(uint64 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        require(numberMinted(msg.sender) + _mintAmount <= publicLimit, "Mint limit exceeded." );
        require(msg.value >= publicCost, "INCORRECT_ETH");
    ...
    function setHolderActive(bool _state) public onlyOwner {
        holderSaleActive = _state;
    }
