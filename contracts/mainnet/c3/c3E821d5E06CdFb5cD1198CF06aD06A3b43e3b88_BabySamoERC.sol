...
contract BabySamoERC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Samoyed";
    string private constant _symbol = unicode"BABYSAMO";
