...
contract Reset is ERC20Burnable, Ownable {
    ...
    uint72 public numTokensToSwap; //9 bytes
    ...
    constructor(
        ...
        statuses[owner()].isExcludedFromFees = true;
        statuses[owner()].isExcludedFromMaxWallet = true;
        statuses[owner()].isExcludedFromMaxTx = true;
    ...
    function unlock(IERC20 token) public {
        ...
        SafeERC20.safeTransfer(token,devAddress, amount);
    }
