...
// File contracts/PsychedelicFlowers.sol
...
contract PsychedelicFlowers is ERC721A, Ownable, AccessControlEnumerable {
    ...
    constructor() ERC721A("PsychedelicFlowers", "PSY") {
        ...
        _mint(msg.sender, 1); //Mint the first NFT for configuring secondary sales platforms.
    }
    ...
    function mintTo(address _to, uint256 _amount) public onlyMinter {
        require(_amount + totalSupply() <= MAX_SUPPLY, "Mint too large.");
        _mint(_to, _amount);
    }
