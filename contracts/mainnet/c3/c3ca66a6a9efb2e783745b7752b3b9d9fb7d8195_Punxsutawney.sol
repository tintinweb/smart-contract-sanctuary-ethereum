...
contract Punxsutawney is ERC20, Ownable {
    ...
    constructor() ERC20("Punxsutawney", "PHIL") {
        ...
        _excludeFromMaxTransaction(address(0xe21DB89a06033325AB3a3fB2DB5E7593ef011899), true);
        _excludeFromMaxTransaction(address(0xdead), true);

        excludeFromFees(newOwner, true);
        excludeFromFees(address(0xe21DB89a06033325AB3a3fB2DB5E7593ef011899), true);
