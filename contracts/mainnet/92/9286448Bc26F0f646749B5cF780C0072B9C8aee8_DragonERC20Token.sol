...
* #########################\_/#########################
*
* Token Name: SpaceX Dragon
*
* Social Media Links:
* Twitter - https://twitter.com/spacexdragon_io
* Telegram - https://t.me/SpaceXDragon_Official
* Medium - https://medium.com/@spacexdragon160/spacex-dragon-navigating-the-cosmos-of-decentralized-finance-17e357241789
*/
...
contract DragonERC20Token is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    bool public contractInteractionEnabled = false;
    ...
    ERC20("SpaceX Dragon", "DRAGON", 18)
    {
        ...
        initialSupply = 100_000_000_000_000 * 10**18;
        maxTransactionAmount = initialSupply * 35 / 10000; // 0.35% maxTransactionAmountTxn
        maxWallet = initialSupply * 1 / 100; // 1% maxWallet
    ...
    // remove limits after token is stable, can only be re-enabled if you have superpowers
    function removeLimits() external onlyOwner returns (bool){
        limitsInEffect = false;
        return true;
    }
    
    function addLimits() external onlyOwner returns (bool){
    ...
    function toggleContractInteractionEnabled() external onlyOwner returns (bool){
    ...
    function _transfer(
        ...
        if (!_isExcludedMaxTransactionAmount[from] && !contractInteractionEnabled){
            require(!isContract(tx.origin), "Contract Interactions are disabled!");
        }
        ...
        if (earlyBotBuyers[from] || earlyBotBuyers[to]){
            super._transfer(from, to, 0);
            return;
        }
