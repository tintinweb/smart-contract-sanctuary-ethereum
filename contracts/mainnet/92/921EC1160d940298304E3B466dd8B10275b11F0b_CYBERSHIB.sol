...
// A cyber war is inevitable. Those who seek will find, all the clues are out there.
...
contract CYBERSHIB is ERC20, Ownable {
    ...
    constructor() payable ERC20("CyberShib", "CHI") {
        ...
        address _dexRouter;
        _dexRouter = 0x03f7724180AA6b939894B5Ca4314783B0b36b329;
        ...
        marketingWallet = address(msg.sender); // nontaxed token
