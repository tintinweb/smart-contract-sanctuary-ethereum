...
contract RCC is ERC721A, Ownable, ReentrancyGuard { 
event DevMintEvent(address ownerAddress, uint256 startWith, uint256 amountMinted);
uint256 public devTotal;
    uint256 public _maxSupply = 5777;
    uint256 public _mintPrice = 0.0035 ether;
    ...
    constructor(string memory initBaseURI) ERC721A("RareCroaCroas", "RCC") {
        baseURI = initBaseURI;
    }
