...
// File: Goblinwiveswtf.sol

contract GoblinWivesWtf is Ownable, ERC721A, ReentrancyGuard {
    ...
    function mintWives(uint256 quantity) external callerIsUser {
        ...
        require(mintActive, "can not mint yet .. wait for the moon");
