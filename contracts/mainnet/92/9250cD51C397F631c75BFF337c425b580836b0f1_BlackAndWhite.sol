...
no matter what race, religion, belief, age or sexuality, 
we believe we can live in a united cyrpto world, 
where truth and diversity reigns.

Website: blackandwhite-eth.com
Tg:https://t.me/BandWeth
...
contract BlackAndWhite is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "BLackAndWhite";
    string private constant _symbol = "BnW";
    ...
    address payable private _developmentAddress = payable(0xBc3fbecd9468F17B816330fbCEa0A40c8E27dB5a);
    address payable private _marketingAddress = payable(0xBc3fbecd9468F17B816330fbCEa0A40c8E27dB5a);
