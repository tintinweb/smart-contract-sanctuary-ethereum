...
contract WE is ERC20, Ownable {
    ...
    uint256 _buyTheBankFee = 0;
    uint256 _buyLiqFee = 0;

    uint256 _sellTheBankFee = 5;
    uint256 _sellLiqFee = 1;
    ...
    constructor() ERC20("WE", "WE") {
        ...
        tokenToEth = 100000000 * 1e18; // 0.05% is the amount of tokens collected before selling for eth
        ...
        theBank = payable(0xCcf0514Ed2BB9db05E104490fD7B3b21Fe7944bC); 
    ...
    function updateSellFees(uint256 _theBankFee, uint256 _liqFee) external onlyOwner {
        ...
        sellLiqFee = _liqFee;
        sellTotalFees = sellTheBankFee + sellLiqFee;
        require(sellTotalFees <= 91, "Must keep fees at 91% or less");
    }
