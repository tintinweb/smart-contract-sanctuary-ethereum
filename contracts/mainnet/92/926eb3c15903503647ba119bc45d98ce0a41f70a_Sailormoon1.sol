...
contract Sailormoon1 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Sailormoon Inu", "SailorMoon") {
    	...
    	operationsWallet = address(0xf088E2D22CD6A52F48772c074acA1bc0CBFa7e28); // set as operations wallet
