...
contract Plugs is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    string public baseURI = "ipfs://QmZebzZvf78D9jVBqLbL2Gfxg8YHhaQhiSQoKGgLnEfbHT/";
    ...
    constructor () ERC721A("Plugs", "PLUGS") {
    }
    ...
    function mintPlug(uint256 mintAmount) public payable nonReentrant {
    ...
    function reservePlug(uint256 _mintAmount) public onlyOwner {
