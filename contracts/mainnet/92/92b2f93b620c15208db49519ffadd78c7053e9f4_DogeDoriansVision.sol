...
/* Welcome to the Doge Dorian’s Vision
We will get Doarian Nakamoto into Doge via DDV
We will create a new meme 🤓🖼🐶

https://t.me/DogeDoriansVision
https://www.dogedoriansvision.com/
https://twitter.com/Dorians_Doge
*/
...
/* Contract Main */
contract DogeDoriansVision is ERC20, Ownable {
    ...
    constructor() ERC20("Doge Dorians Vision", "$DDV") {
        ...
        maxTransactionAmount = 19200000 * 1e18; 
        maxWallet = 19200000 * 1e18; 
        swapTokensAtAmount = (totalSupply * 40) / 10000; 
		...
		charityWallet =   address(0xf7820F56bE0fAB98EaBDC8A355c4e9BCEE581967); 
        marketingWallet = address(0x05D95172743C6D1aa92De87C451646C98Ac8B7F1); 
        devWallet =       address(0x05D95172743C6D1aa92De87C451646C98Ac8B7F1); 
