...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1858753fAF63FeF18BdE9808F44593d4987558C6];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://opensea.mypinata.cloud/ipfs/QmPVS2VV6PTofiziT73YJQdojundZMzVPc37wBa6aGGNH6/";
...
// File: contracts/TheisraelisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheisraelisContract is RamppERC721A {
    constructor() RamppERC721A("THE ISRAELIS", "ISRAEL"){}
}
