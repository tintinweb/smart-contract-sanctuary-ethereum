/*
宫保鸡丁是中式干辣椒炒鸡块。 这是一种四川人的主食，被带到美国并根据当地风味和口味进行了改造。 川菜有点复杂，用花椒和一大堆干辣椒调味。 美国版本保留了大部分原始成分，但味道明显更甜，有时会加入甜椒。
*/
...
contract KungPao is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"KungPao", unicode"KungPao") 
    {
        address supplyRecipient = 0x522168766Bc32B7bBAEA2F09E0f5651A614D3EF9;
        
        updateSwapThreshold(50000000 * (10 ** decimals()));

        marketingdevelopmentAddressSetup(0x522168766Bc32B7bBAEA2F09E0f5651A614D3EF9);
        marketingdevelopmentFeesSetup(200, 500, 0);
        ...
        updateMaxWalletAmount(5000000000 * (10 ** decimals()));

        updateMaxTxAmount(5000000000 * (10 ** decimals()));

        _mint(supplyRecipient, 100000000000 * (10 ** decimals()));
        _transferOwnership(0x522168766Bc32B7bBAEA2F09E0f5651A614D3EF9);
    }
