...
contract METATROLLS is ERC721A, Ownable {
    ...
    string public unrevealedTokenURI =
        "https://gateway.pinata.cloud/ipfs/QmbBBE67sCo8miWa3pXayFp5yjb9KESsuzdcjcQSC3AXu3";
    string public baseURI = "";

    mapping(uint256 => string) private _tokenURIs;

    address private _ownerWallet = 0x659CBED5cfD11E19eB3D4885F85B98862a0E3956;

    constructor( ) ERC721A("metatrollswtf", "METATROLL") {
    }
