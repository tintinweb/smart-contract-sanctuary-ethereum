...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return msg.sender;
    } //telegram https://t.me/tyrantDkwon 
}     // 
...
contract tyrantDkwon  is Context, IERC20, Ownable {
    ...
    string private constant _name = "@tyrantDkwon";
    string private constant _symbol = "$TDK";
