...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x8c30Ae79608283Ac38F56c3929a3c65CC7C8c5ec];
  address public erc20Payable = 0x8c30Ae79608283Ac38F56c3929a3c65CC7C8c5ec;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 6666) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://api.catsandbones.club/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 6666");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6666");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6666");
...
// File: contracts/CatsBonesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CatsBonesContract is RamppERC721A {
    constructor() RamppERC721A("Cats  Bones", "CB"){}
}