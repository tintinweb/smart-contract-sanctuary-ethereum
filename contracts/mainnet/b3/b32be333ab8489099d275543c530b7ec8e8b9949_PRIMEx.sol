...
contract PRIMEx is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PRIMEx () {
        ...
        name = "PRIMEx";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PRX";                                             // Set the symbol for display purposes (CHANGE THIS)
