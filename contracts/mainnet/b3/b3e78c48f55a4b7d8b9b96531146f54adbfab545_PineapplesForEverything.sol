...
contract PineapplesForEverything is Ownable, ERC721A  {
    ...
    uint128 public maxSupply = 3000;

    uint64 public maxMintAmountPerPresaleAccount = 4;
    ...
    constructor() ERC721A("Pineapples For Everything", "Go") {}
