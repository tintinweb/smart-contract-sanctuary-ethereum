...
contract ANIMOToken is ERC20, Ownable {
    ...
    constructor() ERC20("ANIMO", "$AMO") {
        ...
        marketingWallet = address(0x14FE03D0797770328f820Ca1CD2B46a1de5e72f5); // set as marketing wallet
        devWallet = address(0x14FE03D0797770328f820Ca1CD2B46a1de5e72f5); // set as dev wallet
