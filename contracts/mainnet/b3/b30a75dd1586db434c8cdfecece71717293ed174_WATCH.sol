 ...
 * allowances. See {IERC20-approve}.
 */
contract WATCH is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Fvck Socials";
    string private _symbol = "ETHSCAN";
    ...
    address public marketingWallet = 0xbf8dF0A48b20C288c61A43c255A982AC203df663;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 14, "ERC20: total tax must not be greater than 50");
