...
contract IK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Injustice Kungfu";
    string private constant _symbol = unicode"IK";
