...
contract HubbyInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"Hubby Inu";
    string private constant _symbol = unicode"$HUI";
    ...
    address payable private _developmentAddress = payable(0x44FCC51E7B0Fb1Ed8bCBC57F6eB8509E694E42A4);
    address payable private _marketingAddress = payable(0x44FCC51E7B0Fb1Ed8bCBC57F6eB8509E694E42A4);
