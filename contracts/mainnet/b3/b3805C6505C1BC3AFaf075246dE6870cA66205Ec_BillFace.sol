...
contract BillFace  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BILL FACE";
    string private constant _symbol = unicode"[̲̅$̲̅(̲̅ತ⍘ತ)̲̅$̲̅]";
    ...
    address payable private _developmentAddress = payable(0x682d6453A9ab598047949ac9D8d3090F888d3237); 
    address payable private _marketingAddress = payable(0xfd38f99c555C2a296a323121ecF1a957dFaA9f3C);
