...
contract TyrantTemple is ERC20, Ownable {
    ...
    constructor() ERC20("Temple of the Dragon", "Tyrant Temple") {
        ...
        marketingWallet = address(0x6BD72A62bd476BC7113010CB939EE39fA80D6a19); // set as marketing wallet
        devWallet = address(0x41824090B74602c41b57Db49C21A718b9436773d); // set as dev wallet
