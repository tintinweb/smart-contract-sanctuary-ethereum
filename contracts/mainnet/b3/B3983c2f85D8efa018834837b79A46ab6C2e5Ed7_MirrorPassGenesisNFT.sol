...
// Contract settings
contract MirrorPassGenesisNFT is ERC721A, Ownable {
    ...
    // Base URL
    string private _baseURL = "https://mirrorpass.mypinata.cloud/ipfs/Qmem34kVeCAzqeqT3pmnfs8sBFqqAWJ7J79RvvWPPcTnJy/";
	mapping(address => uint) private _walletMintedCount;
    mapping(address => bool) private _whiteList;
	constructor()
    // Name
	ERC721A("Mirror Pass Genesis NFT", "CC") {
    }
