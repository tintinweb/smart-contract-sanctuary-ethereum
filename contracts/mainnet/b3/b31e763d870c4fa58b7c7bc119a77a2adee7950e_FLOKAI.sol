...
//    Floki is the world's first robot dog powered by artificial intelligence and built on the Ethereum blockchain. 
//    Using its AI-powered neural net, Floki has been designed to autonomously interact with decentralized ledger systems
...
contract FLOKAI is ERC20, Ownable {
    ...
    constructor() ERC20("FLOKAI", "FLOKAI") {
        ...
        uint256 totalSupply = 5000000000000 * 1e18;

        maxTransactionAmount = 25000000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 50000000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x5A0097A81bE331907727153fcbDEa15237374053); //  Charity
        marketingWallet = address(0x5A0097A81bE331907727153fcbDEa15237374053); // Marketing
        devWallet = address(0x5A0097A81bE331907727153fcbDEa15237374053); // set as dev wallet
