...
contract FunkyWolvesTest is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
    using Strings for uint256;

    //NOTE Token values incremented for gas efficiency
    uint256 public maxSalePlusOne = 51;
    ...
    constructor() ERC721A("Funky Wolves Test", "FWT") {
