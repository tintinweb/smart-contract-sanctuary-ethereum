...
contract QuickyInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Quicky Inu";
    string private constant _symbol = "$QUICKY";
    ...
    address payable private _developmentAddress = payable(0x436591c537B940b293f1bCb642c223db2C45A2DD); 
    address payable private _marketingAddress = payable(0x436591c537B940b293f1bCb642c223db2C45A2DD);
