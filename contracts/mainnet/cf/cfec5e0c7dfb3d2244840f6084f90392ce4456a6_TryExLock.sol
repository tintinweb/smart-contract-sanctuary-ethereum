...
/**
The TryEx Token Lock Contract - 3,000,000 Tokens Locked for 1 year as per Tokenomics
...
function LockTryEx(address recipient, uint256 amount) public onlyOwner timestampIsSet incomingDepositsStillAllowed {
...
function UnlockTryEx(IERC20 token, address to, uint256 amount) public timestampIsSet noReentrant {
