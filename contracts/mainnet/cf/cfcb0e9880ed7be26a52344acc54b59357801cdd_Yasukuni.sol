...
/**
  World War II, Tokyo's Yasukuni shrine is still considered a powerful symbol of the country's wartime legacy 
 and a source of tension in the East Asian region . 
 the shrine was built to commemorate soldiers who died in the war,
 and its impact on Japan's relations with China and the two Koreas.
...
contract Yasukuni is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x6c23144DcAD17808be46969a33C9ECDE96516F94));

    string private _name = "Yasukuni";
    string private _symbol = "YASAKUNI";
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(100).mul(2); //0.2%
    uint256 public _maxWalletSize = _tTotal.div(100).mul(2); // 2%
