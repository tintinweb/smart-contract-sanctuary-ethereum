...
contract WDI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wednesday Inu";
    string private constant _symbol = "WDI";
    ...
    function removeMaxTxAndMaxWallet() external onlyOwner{
