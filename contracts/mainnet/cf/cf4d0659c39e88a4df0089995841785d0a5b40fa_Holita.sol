...
contract Holita is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Holita OO";
    string private constant _symbol = unicode"Holita";
