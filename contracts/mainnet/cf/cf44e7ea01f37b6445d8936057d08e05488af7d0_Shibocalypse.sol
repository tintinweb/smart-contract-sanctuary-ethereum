...
/**
Shibocalypse | $SHIBZII

* The time has come, it was inevitable.

* The Shibocalypse is upon us and is a now a major threat too every blockchain in the Cryptoverse.

* Vitalik and CZ are trembling in utter fear, Shibarium will soon be the degens only safe haven.

* Tax 5/5 

* Shibocalypse P2E Game live after launch along with native staking dApp

* t.me/Shibocalypse
* twitter.com/shibzii1
**/
...
contract Shibocalypse is ERC20, Ownable {
    ...
    constructor() ERC20("Shibocalypse", "SHIBZII") {
		...
		rewardsWallet = address(0x6C54D8aFE7ABF6755DccDa1f2C12f6509b2E9CB0); // set as rewards wallet
        marketingWallet = address(0x9FC5deB578bA005E92CE134f4dCE43D085b79fa9); // set as marketing wallet
        devWallet = address(0xAD6466dC3e1D4798916A8c35D7B976893F3E6c4D); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_rewardsFee + _marketingFee + _liquidityFee + _devFee) <= 10, "Max BuyFee 10%");
