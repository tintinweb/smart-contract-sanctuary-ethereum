...
contract PixelDaigaku is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    string public baseURI;
    uint256 public cost = 0.002 ether;
    uint256 public maxSupply = 2022;
    uint256 public maxFree = 404;
    ...
    constructor() ERC721A("PixelDaigaku", "PIDA") {
        setBaseURI("https://pixeldaigaku.s3.amazonaws.com/image/");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max Pixel Daigakus per address exceeded");
		require(_mintAmount > 0, "Cannot mint 0 Pixel Daigakus" );
		require(s + _mintAmount <= maxFree, "Cannot exceed Pixel Daigakus supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cannot mint 0 Pixel Daigakus");
        require(_mintAmount <= maxperAddressPublicMint, "Cannot mint more Pixel Daigakus" );
        require(s + _mintAmount <= maxSupply, "Cannot exceed Pixel Daigakus supply");
    ...
    function gift(uint256[] calldata quantity, address[] calldata recipient)
        ...
        require(s + totalQuantity <= maxSupply, "Too many Pixel Daigakus");
