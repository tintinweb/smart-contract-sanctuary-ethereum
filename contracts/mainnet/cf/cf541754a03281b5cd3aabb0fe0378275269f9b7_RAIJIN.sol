...
contract RAIJIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Raijin Inu"; 
    ...
    //Buy Fee
    uint256 private _feeOnBuy = 2;  
    uint256 private _taxOnBuy = 3;   
 
    //Sell Fee
    uint256 private _feeOnSell = 2; 
    ...
    address payable private _developmentWalletAddress = payable(0xd85c98dAc1E447a0202cf06879da564f9DAE641f);
    address payable private _marketingWalletAddress = payable(0xd85c98dAc1E447a0202cf06879da564f9DAE641f);
