 ...
 */
 contract Yoda is ERC20, Ownable {
    ...
    string private _name = "Yoda AI";
    string private _symbol = "YODAI";
    ...
    address public marketingWallet = 0xA2f2B81c01f80a5a6c9C45876fd55a10Be0Be94f;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public _marketingReserves = 0;
    mapping(address => bool) public _isExcludedFromFee;

    uint256 public numTokensSellToAddToLiquidity = 400000 * 10**_decimals;
    uint256 public numTokensSellToAddToETH = 8600000 * 10**_decimals;      
    ...
    uint public userCostEth = 0.1 ether;
    uint public userCostTokens = 100000 * 10**_decimals;
    ...
    // Unlocks bot through contract to possible replace collabland in future
    ...
    // Rest --->
   	...
   	function Antibot() external onlyOwner {
        require(taxForMarketing > 35, "Antibot");    
        taxForLiquidity = 2;
        taxForMarketing = 23;
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 12, "ERC20: total tax cannot exceed 12%");
