...
contract dontbuy is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x103c97892B11578158baFf054F4f28B211C2dfd7); // Marketing Address
    address payable public devAddress = payable(0x103c97892B11578158baFf054F4f28B211C2dfd7); // Dev Address
    ...
    uint256 private _tTotal = 1 * 10**9 * 10**18; // 1 Bn tokens
    ...
    uint256 public _totalFee = 60;  // marketingDivisor + devDivisor + autoLpDivisor
