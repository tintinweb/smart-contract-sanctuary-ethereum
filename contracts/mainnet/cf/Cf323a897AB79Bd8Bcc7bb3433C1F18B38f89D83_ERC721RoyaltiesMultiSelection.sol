    ...
    RoyaltiesV2Impl
{
    ...
    constructor(
        ...
        selectionSupplies.push(SelectionLib.Selection("Amsterdam", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Atlanta", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Barcelona", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Berlin", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Boston", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Buenos Aires", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Chicago", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Dublin", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Hong Kong", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Lisbon", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("London", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Los Angeles", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Madrid", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Mexico City", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Miami", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Milan", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Montreal", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("New York", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Paris", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Prague", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Rio de Janeiro", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Rome", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("San Francisco", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Toronto", 250, 0, 0.05 ether));
        selectionSupplies.push(SelectionLib.Selection("Vancouver", 250, 0, 0.05 ether));
    }
