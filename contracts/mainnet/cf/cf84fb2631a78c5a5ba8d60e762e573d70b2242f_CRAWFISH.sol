...
contract CRAWFISH is ERC20, Ownable {
    ...
    address payable public  marketingWallet = payable(0x8350f84C8129905B7d128ae9A5cF9fB5613eF4Ca);
    ...
    constructor(address _owner) ERC20("CRAW FISH", "CRAW FISH") {
