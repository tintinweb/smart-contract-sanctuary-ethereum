...
import "./PiArtTradablePrivate.sol";
...
contract PiArtFactoryPrivate is Ownable {
    ...
    /// @notice Pi marketplace contract address;
    address public marketplace;

    /// @notice Pi bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new PiArtTradablePrivate contract
    ...
    /// @notice Method for registering existing PiArtTradable contract
    ...
    /// @notice Method for disabling existing PiArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
