...
//
contract DoodMfers is ERC721A, Ownable {
    ...
    uint256 public maximumSupply = 8888;
    bool public paused = false;
    
    constructor(string memory _initBaseURI) ERC721A("DoodMfers", "DM") {
