...
A safe, true community token that can be a shining beacon of light in the now dark and murky world of Crypto.

Ticker BT
Supply 21 Million
Tax 1/1

https://www.thebasictoken.com
https://twitter.com/TheBasicToken

https://t.me/thebasictoken
...
contract Basic is IERC20, Ownable {
    ...
    uint256 private _liquidityFeeSplit = 5; // Denominator of fees that go to liquidity. 4 = 1/5 goes to liquidity
    ...
    address payable private _developmentAddress =
        payable(0xAe684dBBA5a5B878C1cA4c288db01f89Ca8e3aE4);
    address payable private _marketingAddress =
        payable(0x31C15843612816Afc3b1a8Dd44e6507B468b27b9);
