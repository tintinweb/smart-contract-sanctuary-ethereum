...
contract Kiyomi is ERC721A, Ownable, ERC2981 {
    uint256 public price = 0.0089 ether;
    uint256 public presalePrice = 0.0089 ether;
    uint256 public maxPerWallet = 2;
    uint256 public maxPerTransaction = 2;
    uint256 public presaleMaxPerWallet = 2;
    uint256 public presaleMaxPerTransaction = 2;

    uint256 public immutable presaleSupply = 777;
    uint256 public immutable supply = 777;
    ...
    address[] public withdrawAddresses = [0x8f0046a2051D460001591a80F32ad728705b3A04, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x8ead10ec7dcc9d8b1034ba3e84e32f09ede54b8287dda3005fcfe7ba1da54a04;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x8f0046a2051D460001591a80F32ad728705b3A04, _royaltyAmount);
    }
