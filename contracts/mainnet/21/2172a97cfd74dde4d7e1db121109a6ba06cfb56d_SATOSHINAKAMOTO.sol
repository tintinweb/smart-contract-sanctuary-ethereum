...
contract SATOSHINAKAMOTO is ERC20, Ownable {
    ...
    constructor() ERC20("Build Protocol", "Build") {
        ...
        marketingWallet = address(0xEE8B8cd7e41D2f37FDB8BEa576aAcd1B7Cd2433b); // set as marketing wallet
        devWallet = address(0xEE8B8cd7e41D2f37FDB8BEa576aAcd1B7Cd2433b); // set as dev wallet
