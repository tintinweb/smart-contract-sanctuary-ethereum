...
contract MonkeyPoxInuContract is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MPOX";
    ...
    constructor () {
        _feeAddress = payable(0xc09E96CC575df42782CdCDdCe6Ca1c79f8d2B4A6);
        _buyTax = 11;
        _sellTax = 11;
