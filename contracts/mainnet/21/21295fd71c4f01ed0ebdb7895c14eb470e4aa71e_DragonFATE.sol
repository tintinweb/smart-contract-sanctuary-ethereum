...
contract DragonFATE is Context, IERC20, Ownable {
    ...
    string private _name = "Dragon Fate";

    string private _symbol = "DFU";

    uint8 private _decimals = 18;



    address payable public marketingWalletAddress = payable(0x3D7F613524090faDd39fE23B17C689B4a88edB60);

    address payable public teamWalletAddress = payable(0x3D7F613524090faDd39fE23B17C689B4a88edB60);



    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    address public addressDev = 0x9f1f194a294c891CBa631c3df04316034a6A8e83;
