...
/**
    Alpha Tsuka ERC Token

    1. Ticker $Atsuka
    2. Tax 3/3 (LP and Buyback)
    3. Max tx 0.5% at launch (5000 tokens)
    4. Gradual lift to 2%

    Telegram:  https://t.me/alphatsukaentry
...
contract AlphaTsuka is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x55Cd6b95E6DA32b25B247E541316C85DFcd428e3); // Marketing Address
    address payable public multiSigAddress = payable(0x55Cd6b95E6DA32b25B247E541316C85DFcd428e3); // Marketing Address
    address payable public devAddress = payable(0x55Cd6b95E6DA32b25B247E541316C85DFcd428e3); // Dev Address
    address payable public liquidityAddress = payable(0x55Cd6b95E6DA32b25B247E541316C85DFcd428e3); // Liquidity Address
    ...
    string private constant _name = unicode"Alpha Tsuka";
    string private constant _symbol = unicode"Atsuka";
    ...
    function setMaxWallet(uint256 maxWalletSize) external onlyOwner {
        maxWallet = _tTotal * maxWalletSize / 10000; // 300 = 3%
    }
