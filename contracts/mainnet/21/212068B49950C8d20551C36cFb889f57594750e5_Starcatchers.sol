...
contract Starcatchers is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor(
    ...
    Tiers[5] = Tier(0, 0.0000888 ether, _maxMintAmountPerTx);
    Tiers[4] = Tier(0, 0.0000888 ether, _maxMintAmountPerTx-1);
    Tiers[3] = Tier(0, 0.0000999 ether, _maxMintAmountPerTx-1);
    Tiers[2] = Tier(0, 0.0000999 ether, _maxMintAmountPerTx-2);
    Tiers[1] = Tier(0, 0.000111 ether, _maxMintAmountPerTx-2);
    Tiers[11] = Tier(86400, 0.000111 ether, _maxMintAmountPerTx-2);
    Tiers[12] = Tier(172800, 0.000111 ether, _maxMintAmountPerTx-2);
    Tiers[0] = Tier(604800, 0.000111 ether, _maxMintAmountPerTx-2);
  }
