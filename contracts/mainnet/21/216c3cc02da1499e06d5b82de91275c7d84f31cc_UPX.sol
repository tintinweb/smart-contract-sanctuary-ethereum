...
// File: contracts/IUPXAccessControl.sol
...
// File: contracts/UPXAccessControl.sol
 ...
 */
abstract contract UPXAccessControl is Context, IUPXAccessControl, ERC165 {
    struct RoleData {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return interfaceId == type(IUPXAccessControl).interfaceId || super.supportsInterface(interfaceId);
    }
...
// File: contracts/UPXBurnable.sol
