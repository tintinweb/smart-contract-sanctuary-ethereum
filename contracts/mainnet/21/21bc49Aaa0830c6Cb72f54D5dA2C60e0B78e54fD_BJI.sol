...
/*
Black Jack Inu $BJI
is a cryptocurrency coin that seeks to revolutionize gaming by developing a blockchain-powered casino. 
It is developed as an open source project and uses the decentralized platform of the Ethereum network in order to operate securely and transparently. 
The central objective of BJ is to create a decentralized and secure gaming experience, offering a safe and trustless way for players to interact, play, and purchase goods while benefiting from lower transaction fees due to its underlying blockchain technology. 
Further, it has put forth several measures such as Know Your Customer (KYC) procedures, which guarantee transparency of operations during casino activities—thereby providing users with confidence in the trustworthiness of their holdings in the system.

Website : https://www.blackjackinu.xyz/
...
contract BJI is ERC20, Ownable{
    ...
    address public marketingWallet = 0x32198e22f0A9b8151c80C3D4946c29AB7da07E84;
    address public devWallet = 0x32198e22f0A9b8151c80C3D4946c29AB7da07E84;
    ...
    constructor() ERC20("BLACK JACK INU", "BJI") {
