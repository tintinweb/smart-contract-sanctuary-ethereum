...
contract ShadowFriends is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Shadow Friends", "SF") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmXgUo1s4CabyvLqEbq2oRNQfeCu9yBZUDn9MsKWHcxihN/", _toString(tokenId), ".json"));
    }
