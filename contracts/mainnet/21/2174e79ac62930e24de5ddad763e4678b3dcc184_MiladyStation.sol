...
// File: miladystation/contract-7d8526827f.sol
...
contract MiladyStation is ERC721, ERC721Enumerable, ERC721Burnable, DefaultOperatorFilterer, Ownable {
    ...
    //sha1 of 2 groups of 2 groups of 3 groups of 101 images
    //
    ...
    function reserveMintMiladys() public {
        require(whitelistHunMint[msg.sender] || whitelistOneMint[msg.sender], "sender not whitelisted");
        uint mintAmount;
        if (whitelistHunMint[msg.sender]){
            whitelistHunMint[msg.sender] = false;
            mintAmount = 30;
