...
contract IKIGAI is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"$KI";
    ...
    address payable private _developmentAddress = payable(0x4d4Fea001f7E5aD1C76098218f3a4b60a6A12f25); 
    address payable private _marketingAddress = payable(0x4d4Fea001f7E5aD1C76098218f3a4b60a6A12f25);
