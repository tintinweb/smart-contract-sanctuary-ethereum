...
contract BICHON is Ownable {
    ...
    function updateXYZ(uint256 amount) external onlyOwner {
    ...
    function checkBichon(address _whaleaddr) external view returns (bool) {
    ...
    function updateBichon(address _hodladdr, bool status) external onlyOwner {
