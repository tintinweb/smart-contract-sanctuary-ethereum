...
$CDC
0 tax
https://twitter.com/cryptowendyo/status/1602700815747014662?s=61&t=rZ0nea3aNSxIa5KYTPUHuQ
...
contract CDC is Context, IERC20, Ownable {
    ...
    string private constant _name = "CREEPY DOUGH CURRENCY";
    string private constant _symbol = "CDC";
    ...
    address payable private _developmentAddress = payable(0x5EBa2C3D855E030D40B4AEBC4C6A7b26cA9fbAA8); 
    address payable private _marketingAddress = payable(0x5EBa2C3D855E030D40B4AEBC4C6A7b26cA9fbAA8);
