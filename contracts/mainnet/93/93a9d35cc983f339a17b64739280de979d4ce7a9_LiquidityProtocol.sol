...
/*
One of the biggest problems in this space is liquidity.
The extreme volatility can easily kill a project in a blink of a second.
We have all been witnessing a whale liquidate his bag, painting the chart red, and it hardly comes back up.
Liquidity Protocol will not burn any tokens. It only adds to the liquidity pool. Make it stronger and stronger for every trade.
...
6/6 to liquidity
1/1 for marketing developement.


Liquidity tokens will be locked upon launch, and renounced after lifting limits.
*/
...
contract LiquidityProtocol is ERC20, Ownable{
    ...
    address public marketingWallet = 0x00168eAcE221E3eb0456fDdF13b94bb32CFA94E4;
    address public devWallet = 0x00168eAcE221E3eb0456fDdF13b94bb32CFA94E4;
    ...
    Taxes public taxes = Taxes(1,6,0);
    Taxes public sellTaxes = Taxes(1,6,0);
    uint256 public totTax = 7;
    uint256 public totSellTax = 7;
    ...
    constructor() ERC20("LiquidityProtocol", "LP") {
