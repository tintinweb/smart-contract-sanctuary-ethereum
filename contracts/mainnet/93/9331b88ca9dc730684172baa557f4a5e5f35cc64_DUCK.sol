...
contract DUCK is ERC721A, Ownable, ReentrancyGuard, ERC2981 { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 777;
     uint256 public devSupply = 50;
    ...
    constructor(string memory initBaseURI) ERC721A("CryptoDuckzz", "DUCKZZ") {
        baseURI = initBaseURI;
