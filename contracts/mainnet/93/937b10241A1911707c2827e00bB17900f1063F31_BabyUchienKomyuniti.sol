...
contract BabyUchienKomyuniti is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Uchi en Komyuniti";
    string constant _symbol = "BUCHI";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0x97C6D5EA059904f5Bf4297f65fd0FA1ca319FDAF; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x97C6D5EA059904f5Bf4297f65fd0FA1ca319FDAF;
        solor = msg.sender;
...
contract StandarToken is BabyUchienKomyuniti {
    constructor() {}
}