...
contract TOKEN is Owner, Context, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply = 0;
    uint256 private _maxSupply = 400000000000000000;

    string private _name = "0xVIRAL.com";
    string private _symbol = "CLAIM YOUR TOKENS";
