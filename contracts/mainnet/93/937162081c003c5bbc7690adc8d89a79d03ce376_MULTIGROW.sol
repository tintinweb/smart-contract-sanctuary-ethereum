...
/**
“Surrender to the flow of life. Relinquish the need to control. 
All happens as it is meant to. The future will bring what you need, 
not what you want. Control is an illusion. Your influence on the future is 
limited. Yield and be flexible. A gentle, passive approach.”
*/

//https://medium.com/@themultiverse
...
contract MULTIGROW is Context, IERC20, Ownable {
    ...
    string private _name = "The Multiverse";
    string private _symbol = "MULTIGROW";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x1569A780722DE6FD4EBc40719E5d98D9fEAE3A07, 'We can not exclude Uniswap router.');
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 200000, "Max Tx Amount cannot be less than 69 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 200000, "Swap Threshold Amount cannot be less than 69 Million");
