...
// https://onebeltonecoin.xyz/
// https://t.me/OneBeltOneCoin
// https://twitter.com/OneBeltOneCoin
...
contract OneBeltOneCoin is ERC20, Ownable {  
    using SafeMath for uint256;
    ...
    constructor() ERC20("One Belt One Coin", unicode"一带一币") { 
        ...
        _fees.sellDevelopmentFee = 15; 
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;

        marketingWallet = address(0xEEB1d484f4cD04821d6204918d363c025D5F8483); 
        developmentWallet = address(0xEEB1d484f4cD04821d6204918d363c025D5F8483); 
