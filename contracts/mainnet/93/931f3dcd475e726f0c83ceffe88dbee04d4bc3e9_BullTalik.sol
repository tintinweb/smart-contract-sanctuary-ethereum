...
contract BullTalik is ERC20, Ownable {
    ...
    constructor() ERC20("Bulltalik", "BULL") {
        ...
        marketingWallet = address(0xd9119AD60CfB5918B7e5b3b2Bd2Ab5088c9D3d6B); // set as marketing wallet
        devWallet = address(0xd9119AD60CfB5918B7e5b3b2Bd2Ab5088c9D3d6B); // set as dev wallet
