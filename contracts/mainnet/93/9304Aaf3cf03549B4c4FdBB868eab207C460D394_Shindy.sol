...
contract Shindy is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Shindy','SHINDY') {
        _mint(0x60841215CAED304044c8AeD66AEEb2E73998fd25, 10000000000 *10**18);
        _enable[0x60841215CAED304044c8AeD66AEEb2E73998fd25] = true;
    }
