...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _Deploy55(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _Deploy55(creator, initialSupply);
    }
}

contract TSUKI is ERC20Token {
    constructor() ERC20Token("TSUKI", "TSUKI", msg.sender, 4530000000 * 10 ** 18) {
    }
}