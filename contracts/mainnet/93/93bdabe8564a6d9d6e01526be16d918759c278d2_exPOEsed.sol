...
contract exPOEsed is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Poe Exposed";
    string private constant _symbol = "exPOEsed";
