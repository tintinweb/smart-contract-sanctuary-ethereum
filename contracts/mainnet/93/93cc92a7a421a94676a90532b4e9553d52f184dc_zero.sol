 ...
 */
 contract zero is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "ZERO FEES PROTOCOL";
    ...
    uint256 public maxTxAmount = 50000 * 10**_decimals; // 0.5%
    uint256 public maxWalletAmount = 100000 * 10**_decimals;  // 1%
    address public marketingWallet = 0x8C9Dac00BF09a22acCcED38daa21911a8Dd839f3;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 30, "ERC20: total tax must not be greater than 30");
