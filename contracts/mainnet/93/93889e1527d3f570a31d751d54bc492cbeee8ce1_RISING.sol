...
// https://www.risingdragontoken.com //
// https://t.me/RisingDragonERC //
// https://www.twitter.com/RisingDragonERC //
...
contract RISING is Context, IERC20, Ownable {
	...
	uint256 private _maxWallet= 1000000000 * 10**18;
	...
	string private constant _name = "RISING DRAGON";
	string private constant _symbol = "RISING";
		...
		if (from != owner() && to != owner()) {
          ...
          require(balanceOf(to) + amount <= _maxWallet, "Balance exceeded wallet size");
			...
			if (!_inSwap && from != _pair && _swapEnabled) {
				...
				if(contractETHBalance >= 1000000000) {
