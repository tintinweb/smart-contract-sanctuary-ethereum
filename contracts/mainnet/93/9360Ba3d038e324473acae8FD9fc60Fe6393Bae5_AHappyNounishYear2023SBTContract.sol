...
contract AHappyNounishYear2023SBTContract is RevokableDefaultOperatorFilterer, ERC2981 ,Ownable, ERC721RestrictApprove ,AccessControl,ReentrancyGuard {

    constructor(
    ) ERC721Psi("A Happy Nounish Year 2023 SBT", "HNYSBT") {
        ...
        setMetadataTitle("A Happy Nounish Year 2023 SBT");
        setMetadataDescription("Thank you for minting.");
        setMetadataAttributes("SBT");
        setImageURI("https://data.nounsjp.wtf/2022-end-year/sbt/2023.gif");
