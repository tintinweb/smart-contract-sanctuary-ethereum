...
contract Tengoku     is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000* 10**3 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = 'TENGOKU SPACE ';
    string private _symbol = 'Tengoku ';
