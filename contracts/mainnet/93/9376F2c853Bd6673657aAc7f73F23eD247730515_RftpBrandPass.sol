...
// File: contracts/RFTP_Brand_Pass.sol
...
contract RftpBrandPass is ERC721A, ERC721AQueryable, Ownable {
    string  public baseURI;
    uint256 public maxSupply = 150;

    constructor(string memory contractBaseURI) ERC721A ("RFTP BRAND PASS", "RFTPB") {
