...
contract FFI is ERC20, Ownable {
    ...
    uint256 public percentForLPBurn = 75; // 25 = .75%
    ...
    constructor() ERC20("Fvck Floki Inu", "FFI") {
        ...
        maxTransactionAmount = totalSupply * 10 / 1000; // 1% max taxn
        ...
        marketingWallet = address(0xF3380dBb817AC24505DE5a2A5f2C81156842dcCc); // set as marketing wallet
        devWallet = address(0x4E8a8c3354655763D2a082C034A1607959768be8); // set as dev wallet
    ...
    function blockBots(address[] memory bots_) public onlyOwner {
        require(launchedAt < block.number + 30, "Unable to blacklist anymore");
    ...
    function swapBack() private {
        ...
        uint256 ethfordev = address(this).balance.div(2);
