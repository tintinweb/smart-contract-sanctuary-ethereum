...
contract MirrorDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmXxsB2is7G3KgHGwHrjabe7keCJo15YTz1rddjS7Rxe9n";
    ...
    constructor(
    ) ERC721A("MIRRORv2", "MirrorDAOv2", 1000, maxSupply) {
    }
