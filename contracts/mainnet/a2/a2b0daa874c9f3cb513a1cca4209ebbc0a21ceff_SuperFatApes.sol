...
contract SuperFatApes is ERC721Enumerable, Ownable {
  ...
  address private OtherAddress = 0x3775C7Bd1626f1d4797265c214c26F68B50B304F;
  ...
  constructor(string memory baseURI) ERC721("Super Fat Apes", "SFA") {
    setBaseURI(baseURI);
  }
  ...
  function withdraw() external onlyAuthorized {
    ...
    payable(OtherAddress).transfer(balance * 5000 / 10000);
