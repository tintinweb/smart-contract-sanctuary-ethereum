...
contract Hachurui is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hachūrui labs";
    string private constant _symbol = unicode"Hachurui";
    ...
    constructor () payable {
        ...
        _marketingWallet = payable(0x17E9D300f2BEfC82A8b64De1d3E2b3EAcA9efAB0);
        _tOwned[address(this)] = _tTotal;
        _tOwned[address(0x17E9D300f2BEfC82A8b64De1d3E2b3EAcA9efAB0)] = _tTotal.div(33);
        _tOwned[address(0x803a0F2a96eCcaD3b15Ef583Bd8A9052605f7Eef)] = _tTotal.div(33);
        _tOwned[address(0x7C773CEb879431e027F464d92b104fE068D5ECf8)] = _tTotal.div(33);
