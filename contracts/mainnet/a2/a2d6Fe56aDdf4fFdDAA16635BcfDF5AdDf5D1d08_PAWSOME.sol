...
PAWSOME is an ERC20 token that aims to revolutionize the pet industry by providing a seamless e-commerce platform for all pet necessities.

Telegram : https://t.me/PawSomePortal
Website : http://pawsome.live/
Twitter : https://twitter.com/PawsomeETH
Shopify Ecommerce Link - 
https://pawsometh.myshopify.com/ (use password - “ipurte” )
...
contract PAWSOME is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 1_000_000 * 10e18;
    uint256 public maxTxAmount = 2000_000_000 * 10**18;
    uint256 public maxWalletAmount = 3000_000_000 * 10**18;
    
    address public marketingWallet = 0x864f0AB21F089b518F5a0D015b7876D0A62516D5;
    address public devWallet = 0x864f0AB21F089b518F5a0D015b7876D0A62516D5;
    ...
    constructor() ERC20("PAWSOME", unicode" $PAWS  ") {
    ...
    function openPaws (uint256 numOfDeadBlocks) external onlyOwner{
    ...
    function pawBuyFee(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function pawSellFee(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
