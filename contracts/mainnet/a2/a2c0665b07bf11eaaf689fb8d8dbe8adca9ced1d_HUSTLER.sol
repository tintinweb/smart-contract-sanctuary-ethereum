...
contract HUSTLER is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmfK8K9U2vExAp5aVUSzonDN45hHnaLUobUM6mdibgBhru";
    ...
    constructor(
    ) ERC721A("BETA HUSTLER PASS", "BHP", 100, maxSupply) {
    }
