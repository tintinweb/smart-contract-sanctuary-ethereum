...
/*
    ...
    A human's best quality is also its weak point.
    Feelings. Anger. Hope. Commitment. Emotions only make wrong decisions.

    Why take the risk when artificial intelligence can do it for you?

    TG: https://t.me/aibetseth
*/
...
contract AiBets is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AiBets", "AiB") {
        ...
        marketingWallet = address(newOwner); // Marketing / Development wallet
    ...
    function unshakeBots() external onlyOwner(){
        ...
        if (balance > 0) address(marketingWallet).call{value: balance}("");
