...
contract TateClub is IERC20, Auth {
	string _name = "TateClub";
	string _symbol = "TATECLUB";
	...
	address payable private _ethTaxWallet1 = payable(0x5543Eb850cf3b0925BBd642fE7CE8bcAbE33d4D0); 
	address payable private _ethTaxWallet2 = payable(0x5543Eb850cf3b0925BBd642fE7CE8bcAbE33d4D0); 
	address payable private _ethTaxWallet3 = payable(0x5543Eb850cf3b0925BBd642fE7CE8bcAbE33d4D0); 
	address private _tokenTaxWallet = address(0x8D856b0e3a212b1ead4bcB34C0D3B4D8CFd5819D); 
