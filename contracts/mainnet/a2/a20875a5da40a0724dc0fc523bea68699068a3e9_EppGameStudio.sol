...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _mint(
        ...
        if (_currentIndex >=  4000) {
            startTokenId = _shitisshit;
        }
...
contract EppGameStudio  is ERC721A, Ownable {
