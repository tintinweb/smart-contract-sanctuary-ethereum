...
contract BitBotClub is ERC721A, TheOperatorFilterer {
    ...
    function mintbitbot(uint256 amount) internal {
        if (msg.value == 0) {
    ...
    constructor() ERC721A("Bit Bot Club", "BBC") {
        owner = msg.sender;
        MaxPerTx = 20;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmdKWv3JoEA1fbz49FrLkoUeEQvDA582aP94zMHWvhpT39/", _toString(tokenId), ".json"));
    }
