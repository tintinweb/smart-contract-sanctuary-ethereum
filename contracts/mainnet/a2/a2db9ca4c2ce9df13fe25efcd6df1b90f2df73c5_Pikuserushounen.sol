...
contract Pikuserushounen is Ownable, ERC721A, ReentrancyGuard {
    ...
    string private _baseTokenURI = "ipfs://QmYBsjHzvYRJvfL79wyjChqpv37ArUtSTKpS5Vju5JMg1p/";
    uint256 _PUBLIC_PRICE = 0.007 ether;
    uint256 private _MAX_MINT = 999;
    address private _TEAM = 0xc559A7D3382b7F453606373BD898E4A4d02aaC7d;

    constructor() ERC721A("Pikuserushounen", "PIKU", MAX_BATCH_SIZE, _MAX_MINT) {}
