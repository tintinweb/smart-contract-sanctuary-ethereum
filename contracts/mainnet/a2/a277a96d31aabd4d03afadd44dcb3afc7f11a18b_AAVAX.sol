...
contract AAVAX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Amazon Avalanche";
    string private constant _symbol = "AAVAX";
    ...
    address payable private _opAddress = payable(0x3dbB3A28506eBeC3A0d9FD1A999979618dDB27ac);
