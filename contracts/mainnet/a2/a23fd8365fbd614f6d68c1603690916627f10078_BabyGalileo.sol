...
contract BabyGalileo is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x38c6764Fde17E945B61cA00ab1BA5E570faB276C));

    string private _name = "BabyGalileo";
    string private _symbol = "BabyGali";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(3); //3%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(3); // 3%
