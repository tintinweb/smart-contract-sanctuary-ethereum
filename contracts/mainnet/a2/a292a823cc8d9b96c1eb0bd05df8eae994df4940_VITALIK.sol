...
contract  VITALIK  is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE VITALIK APE"; // 
    string private constant _symbol = unicode"VitalikButerin"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xA1C792F620a4153b7920dBE5ec96d3E7FB0b6c59;
