...
YASUKE is NFTs empowered and supported by the $YSK token in the Japanese metaverse on the Ethereum blockchain.

Tg: https://t.me/Yasuke_portal

Twitter: https://twitter.com/yasuke_erc20
...
contract YASUKE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Yasuke";
    string private constant _symbol = unicode"YASUKE";
    uint256 public _maxTxAmount =   45000000 * 10**_decimals;
