...
// CA Testing , do join the group and wait for actual CA

/*
Santa Ethereum is a blockchain-based platform that enables users to create and deploy decentralized applications,
or “dApps”, on the Ethereum blockchain. Using the platform, users can create open financial systems and use Smart Contracts to automate transactions.
...
contract SantaEther is Ownable, IERC20 {
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0x7F14d9b6504A1C3a1Fdcb48AC15490ABedfAC0Eb;
        devWallet = 0x7F14d9b6504A1C3a1Fdcb48AC15490ABedfAC0Eb;
