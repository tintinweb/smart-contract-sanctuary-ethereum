...
contract BaseBirdsOfficial is ERC721A {
    ...
    constructor() ERC721A("Base Birds Official", "BBO") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmVi2er9rXz2oKDifYwcP43aN1iezC3QSZF6s9FKp3aqnV/", _toString(tokenId), ".json"));
    }
