...
contract Swoosh is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Swoosh";
    string private constant _symbol = "SWOOSH";
    ...
    address payable private _developmentAddress = payable(0x2b7a2a3a90Fb44821eCf25dE77a20ED7Af1ddDfD); 
    address payable private _marketingAddress = payable(0x2b7a2a3a90Fb44821eCf25dE77a20ED7Af1ddDfD);
