...
/*
Niú Tóu IS AN HYPER DEFLATIONARY TOKEN MADE FOR THE COMMUNITY WHICH GUARANTEES REWARDS TO ITS HOLDERS WHILE DECREASING THE SUPPLY THROUGH AN AUTOBURN FUNCTION.
Niú Tóu, has been created with the goal to guarantee its holders a steady passive income over time thanks to the reflection tax. 
A bullish meme created for the community by the community.

https://t.me/NiuTouERC
*/
...
contract NiuTou is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x46BB4256DFa18519e1B0A004A85B13B41138b996));

    string private _name = "Niu Tou";
