...
contract MutantGoblinYachtClub is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0xce78cD34258620D101F37f19C778252605901D07).call{value: address(this).balance * 50 / 100}("");
    require(hs);
