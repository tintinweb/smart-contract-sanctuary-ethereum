...
/*
The first is here. Launched by the first 3 buyers in $DIE, currently at 13M$, soon at 100M$
...
contract THEFIRSTDIE is Auth {
    ...
    string public name = "The First DIE";
    string public symbol = "FDIE";
    ...
    uint256 public max_wallet = totalSupply * 40 / 1000; // 4% of Total Supply initially
    ...
    uint256 public liquidityFee = 50;      // 5%
