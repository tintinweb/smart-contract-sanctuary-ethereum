...
contract Kazumi is ERC20, Ownable {
    ...
    constructor() ERC20("KAZUMI", "KAZUMI") {
        ...
        maxWallet = totalSupply *5/100; // 2% from total supply maxWallet
		...
		charityWallet = address(0x0a4B1dCffe52E28db64C23634230b81ebd0F2bD1); // set as charity wallet
        marketingWallet = address(0x0a4B1dCffe52E28db64C23634230b81ebd0F2bD1); // set as marketing wallet
        devWallet = address(0x0a4B1dCffe52E28db64C23634230b81ebd0F2bD1); // set as dev wallet
