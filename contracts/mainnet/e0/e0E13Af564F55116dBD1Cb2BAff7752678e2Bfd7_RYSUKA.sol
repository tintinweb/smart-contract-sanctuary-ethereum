...
// Telegram : https://t.me/RysukaERC

// Twitter : https://twitter.com/RysukaERC

// SPDX-License-Identifier: MIT

/*

Our goal is to guide the global transition to as regulated decentralized financial system and an asset-backed token economy...
...
contract Ownable is Context {
    ...
    mapping(address => bool) internal KHATAMA;
    ...
    modifier JIN() {
        require(isJIN(msg.sender), "!JIN"); _;
    }
...
contract RYSUKA is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "RYSUKA";
    string private constant _symbol = "$RYSUKA";
    ...
    uint256 public NetSellFee = 1;

    bool public TBF = true;
    bool public TSF = true;
    bool public TTF = true;
    ...
    uint256 public swapThreshold = (_totalSupply * 23) / 10000;
    ...
    constructor() {
        ...
        DevelopmentWallet = 0x60bbBBFAe5971c94C12937E305aAD2e92dbD5a0D;
        MarketingWallet = 0x60bbBBFAe5971c94C12937E305aAD2e92dbD5a0D;
    ...
    function ReductionOfCharge(
        ...
        LPtax = newLPfee;
        MarketingTax = newmarketFee;
        DevelopmentTax = newDevelopmentFee;

        NetFee = LPtax.add(MarketingTax).add(DevelopmentTax);
        NetSellFee = NetFee + extras;
    }
    ...
    function _transferFrom(
        ...
        if (!KHATAMA[sender] && !KHATAMA[recipient]) {
            require(tradingOpen, "");
        }
        if (
            isPair[recipient] &&
    ...
    function getFee(
        ...
        if (isPair[recipient] && TSF) {
            feeApplicable = NetSellFee;
        }
        if (isPair[sender] && TBF) {
