    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 4666) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://api.madnessalien.xyz/";
...
// File: contracts/MadnessAlienContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MadnessAlienContract is RamppERC721A {
    constructor() RamppERC721A("Madness Alien", "Alien"){}
}