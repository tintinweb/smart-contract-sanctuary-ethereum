...
contract  HomeJSimpson is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "HomerJSimpson";
    string private _symbol = "HJS";
    ...
    constructor () {
        ...
        receiver = payable(address(0x347365A7f210678F7Ac1aD809115cc23C1768906));
