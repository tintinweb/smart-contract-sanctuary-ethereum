...
contract Myriad is ERC20, Ownable {
    ...
    constructor() ERC20("Myriad", "Myr") {
        ...
        maxWallet = 1500000 * 1e18; // 3% from total supply maxWallet
		...
		charityWallet = address(0xED48695F8A26067652E67e20F896d0717994f6e9); // set as charity wallet
        marketingWallet = address(0xACfE0C931f43a462E4d551c51BCFe57C3a3926CE); // set as marketing wallet
        devWallet = address(0x8C145002752E030eA6305314816Af2f8B6bAF4e9); // set as dev wallet
