/*
/ IllusionistNFT
/ unique and innovative digital art project.
/ Num of FreeMint = 2 
/ 0.0008E Per Illusionist 
/*
...
contract IllusionistNFT is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.0008 ether;
    uint   public maxTx             = 20;
    uint   public maxSupply         = 2222;
    uint256 public reservedSupply   = 2222;
    ...
    constructor() ERC721A("Illusionist NFT", "Illusionist") {}
    ...
    function MintIllusionist(uint256 count) external payable {
    ...
    function TMintIllusionist(uint256 Amount) external onlyOwner
    {
    ...
    function EnableIllusionist() external onlyOwner {
