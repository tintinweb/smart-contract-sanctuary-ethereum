...
// File: contracts/ReeferMadness.sol
...
contract ReeferMadness is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQzufoAymZFBbfgZ28CTNGYDmLafFWvocPQHb7XtVEq99";
    ...
    uint256 public NUM_FREE_MINTS = 315;
    ...
    constructor(
    ) ERC721A("Reefer Madness", "Reefer", 100, maxSupply) {
    }
