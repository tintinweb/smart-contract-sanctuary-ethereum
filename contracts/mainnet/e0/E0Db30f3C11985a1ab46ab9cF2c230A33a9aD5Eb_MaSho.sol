...
contract MaSho is ERC20, Ownable {
    ...
    constructor() ERC20("MaSho Inu", "MASHO") {
        ...
        maxTransactionAmount = 300000000 * 1e18; // 1.5% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0xD19eadf8f22fe174fdEAa8fD6A2E223514E9fDCd); // set as charity wallet
        marketingWallet = address(0xD19eadf8f22fe174fdEAa8fD6A2E223514E9fDCd); // set as marketing wallet
        devWallet = address(0xD19eadf8f22fe174fdEAa8fD6A2E223514E9fDCd); // set as dev wallet
