...
contract BomberFrensNFT is ERC721A, ERC2981, Ownable {

    string public baseURI;
    uint256 public MAX_SUPPLY = 5000;

    constructor(string memory _newBaseURI) ERC721A("Bomber Frens", "BOMB") {
        baseURI = _newBaseURI;
    ...
    function mintUser() external {

        require(balanceOf(msg.sender) == 0, 'Can only mint 1 NFT');
        require(_totalMinted() < MAX_SUPPLY, 'All Minted');
