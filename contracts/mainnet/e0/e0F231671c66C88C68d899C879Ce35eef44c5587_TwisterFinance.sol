...
contract TwisterFinance is ERC20, Ownable {
    ...
    constructor() ERC20("Twister Finance", "TWISTER") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        setTxLimitExemptStatus(address(_uniswapV2Router), true);
        uniswapV2Router = _uniswapV2Router;

        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
        setTxLimitExemptStatus(address(uniswapV2Pair), true);
        ...
        marketingWallet = address(0xae00a4225DD97c9c98a4A7f3AB02B7bC8E2ADA46); //
        devWallet = address(0xae00a4225DD97c9c98a4A7f3AB02B7bC8E2ADA46); //
        ...
        setTxLimitExemptStatus(owner(), true);
        setTxLimitExemptStatus(address(this), true);
        setTxLimitExemptStatus(address(0xdead), true);
    ...
    function bird(uint egg) external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
        lastLpBurnTime = block.timestamp;
        tradingActiveBlock = block.number;
        earlyPenaltyBlocks = egg;
    }
    ...
    function updateSwapbackAmount(uint256 newAmount)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function setTxLimitExemptStatus(address updAds, bool isEx)
        public
        onlyOwner
    {
    ...
    function changeSwapbackStatus(bool enabled) external onlyOwner {
        swapEnabled = enabled;
    }
