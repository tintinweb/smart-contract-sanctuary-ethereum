...
「エイプクンの世界」は
日本を代表するデジタルアーティストである天神英貴氏が手がけた
エイプクンという愛らしい猿のキャラクターが主役の作品集です
本展示会では、500点以上の作品を取り揃え
エイプクンの愛らしさや悪戯っぷりが克明に描かれています。
...
見る者を魅了することでしょう。
 ...
 ______   ___       ___  ____   ____ __ __ __ __ __  __
 | || |  // \\     // \\ || \\ ||    || // || || ||\ ||
   ||   ((   ))    ||=|| ||_// ||==  ||<<  || || ||\\||
   ||    \\_//     || || ||    ||___ || \\ \\_// || \||
...
contract APEKUN is Ownable, ERC721A, DefaultOperatorFilterer  {

    using Strings for uint256;

    string private baseTokenURI;
    uint64 public maxSupply = 500;
    uint64 public publicLimit = 5;
    bool public publicSaleActive = false;
    mapping(address => uint256) public claimed;


    constructor() ERC721A("ApeKun By Tenjin", "APEKUN"){}
