...
// https://www.izanamiofficial.com/

// https://twitter.com/Izanamieth

// https://izanami-eth.medium.com/new-meta-and-the-goddess-of-creation-is-now-here-on-erc20-8496f64ea169
...
contract IzanamiMikoto is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9292eb3E2974672076a698565aBf313bbB21Da9C); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x9292eb3E2974672076a698565aBf313bbB21Da9C);
    ...
    string private constant _name = "Izanami Mikoto"; 
    string private constant _symbol = unicode"$IZANAMI";
    ...
    constructor () {
        ...
        _owner = 0x9292eb3E2974672076a698565aBf313bbB21Da9C;
