...
contract ZiPorCoin is ERC20, Ownable {
    ...
    constructor() ERC20("ZiPorCoin", "ZIPOR") {
        ...
        uint256 totalSupply = 5855555555 * 1e18;

        maxTransactionAmount = 58555556 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 117111111 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x395CaC52b17dDeF2428e9826011A5eb2718370B1); // 
        marketingWallet = address(0x395CaC52b17dDeF2428e9826011A5eb2718370B1); // 
        devWallet = address(0x395CaC52b17dDeF2428e9826011A5eb2718370B1); // 
