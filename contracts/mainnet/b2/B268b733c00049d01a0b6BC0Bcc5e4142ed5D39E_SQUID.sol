...
contract SQUID is ERC20, Ownable {
    ...
    constructor() ERC20("Squid Game", "SQUID") {
        ...
        marketingWallet = address(0x8180dD2b555DA6Ec560adc034c939C404AAb0ABf); // set as marketing wallet
        devWallet = address(0x8180dD2b555DA6Ec560adc034c939C404AAb0ABf); // set as dev wallet
