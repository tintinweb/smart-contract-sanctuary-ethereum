...
contract AtosStaking17 is ReentrancyGuard {
    ...
    uint public constant YIELD_RATE = 2000;
    uint public constant LOCK_TIME = 17 days;
    uint public constant EARLY_UNSTAKE_FEE = 1200;
