...
contract DogeHemi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Doge Hemi";
    string private constant _symbol = unicode"DOHEMI";
