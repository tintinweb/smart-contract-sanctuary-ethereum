...
contract TheGreatSpirit is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Ōkami";
    string private constant _symbol = unicode"Ō神";
    ...
    address payable private _developmentAddress = payable(0x713A1d85389A1e65048E40D7703967A16d5C4A3b); 
    address payable private _marketingAddress = payable(0x713A1d85389A1e65048E40D7703967A16d5C4A3b);
    ...
    function setTrading(bool _tradingenable) public onlyOwner {
