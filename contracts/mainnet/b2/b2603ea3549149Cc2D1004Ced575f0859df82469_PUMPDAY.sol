...
/*
Sunday Pump, that's what we like to see.
$PUMPDAY
*/
...
contract PUMPDAY is Context, IERC20, Ownable {
    ...
    string private constant _name = "SUNDAY PUMP";
    string private constant _symbol = "PUMPDAY";
    ...
    address payable private _developmentAddress = payable(0x98cebFEB5403C8e1Fb8CDC6B10CbaeBbF99b4Af2); 
    address payable private _marketingAddress = payable(0x98cebFEB5403C8e1Fb8CDC6B10CbaeBbF99b4Af2);
