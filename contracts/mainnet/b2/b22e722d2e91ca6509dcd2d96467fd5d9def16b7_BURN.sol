...
/*
 ...
 https://t.me/BurnInuERC

 https://twitter.com/BurnInuERC

🔥 The ONLY hyper deflationary and burn Inu token on the market.

🔥 Buy and Sell taxes are the following (post Trading Enabled): 5% Buy (burn) tax / 5% Sell (burn) tax, 2% Sell dev tax.

🔥 Burns $BURN on EVERY transaction
...
🔥 NOTE: We have a higher launch sell tax set in place to help kickstart the burning process while volume is high, and to help keep pesty bots out of the project.
...
contract BURN is ERC20, Ownable {
    ...
    constructor() ERC20("Burn Inu", "BURN") {
        ...
        devWallet = 0xC5204EC62C218b737356442eA1984fdD8d75AD93;
