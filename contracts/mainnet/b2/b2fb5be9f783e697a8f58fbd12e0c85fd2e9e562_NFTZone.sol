...
Introducing the ultimate NFT Platform! Our platform gives you the ability to buy, sell, stake, trade and manage your Non-Fungible Tokens (NFTs) in one place. Our cutting-edge platform is incredibly secure and offers unparalleled ease of use when trading NFTs. With our flexible staking feature, you can maximize your returns with an intuitive user interface. Our platform also allows you to purchase, sell, and manage your NFTs with a few simple clicks. In addition to these features, we offer the latest in blockchain technology to ensure the security of your investments. Our dedicated team of experts are available to answer questions and offer guidance as you explore the world of NFTs. Try out the ultimate NFT platform today and join us on the journey to revolutionize digital assets.

Tax: 1/1
Locked for 90 Days
Renounced

Telegram: https://t.me/NFTZoneERC
*/
...
contract NFTZone is ERC20, Ownable{
    ...
    address public marketingWallet = 0x86d38865590d51746cCCc1777DACB456ea03dCDc;
    address public devWallet = 0x86d38865590d51746cCCc1777DACB456ea03dCDc;
    ...
    uint256 public totTax = 1;
    uint256 public totSellTax = 1;
    ...
    constructor() ERC20("NFTZone", "NFTZ") {
