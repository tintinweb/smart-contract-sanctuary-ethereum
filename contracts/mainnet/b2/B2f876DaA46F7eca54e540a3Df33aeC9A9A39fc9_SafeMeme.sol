...
contract SafeMeme is ERC20, Ownable {
    ...
    // TOKENOMICS START
    string private _name = "SAFE MEME";
    string private _symbol = "sMEME";
    ...
    uint256 private _numTokensSellToAddToLiquidity = 5000000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 5000000 * 10**_decimals;
    address public marketingWallet = 0x58a11a452a95C5c8667917dBc995161d54F01CD3;
    // TOKENOMICS END
