...
contract PixelDance is ERC721A, Owned {
    ...
    address private _ownerWallet = 0x1ee5C22BB216a827c9CFce3e8a04AC31CBDD1762;

    string public baseURI = "ipfs://QmRtW3fckW3avRw6txCDZaSuX7g2LdT8uVvNoEFiaJNRgk/";
    bool public revealed = false;


      constructor() ERC721A("Pixel Dance", "PXD") Owned(msg.sender) {}
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if (revealed) {
        return bytes(baseURI_).length > 0 ? string(abi.encodePacked(baseURI, tokenId, ".json")) : "";
        } else {
