...
contract MoriChica  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmUJFmMfhsZAnrvAQZq3yqVh46xai9xuj5VDdySTNLj37z/";

    uint256 public immutable cost = 0.009 ether;
    uint256 public immutable costMin = 0.003 ether;
    uint32 public immutable maxSupply = 899;
    ...
    function publicBuy(uint256 amount) public payable callerIsUser{
