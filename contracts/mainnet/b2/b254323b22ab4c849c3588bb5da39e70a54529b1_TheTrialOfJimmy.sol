...
contract TheTrialOfJimmy is ERC721A, Ownable, OperatorFilterer {
    using Strings for uint256;

    uint256 public maxSupply = 420;
	  uint256 public Ownermint = 1;
    uint256 public maxPerAddress = 12;
	  uint256 public maxPerTX = 4;
    uint256 public cost = 0.0042 ether;
    address public constant OSlist = 0x3cc6CddA760b79bAfa08dF41ECFA224f810dCeB6;
  ...
  constructor(string memory baseURI) ERC721A("The Trial Of Jimmy", "TTOJ") OperatorFilterer(address(OSlist), false) {
