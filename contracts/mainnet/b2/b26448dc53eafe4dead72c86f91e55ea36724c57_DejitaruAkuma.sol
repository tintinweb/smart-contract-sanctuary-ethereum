...
The akuma (悪魔) is here 👹

Telegram : https://t.me/DejitaruAkuma
Twitter : https://twitter.com/DejitaruAkuma
...
contract DejitaruAkuma is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Dejitaru Akuma"; 
    string private constant _symbol = "DAK"; 
    ...
    //Buy Fee
    uint256 private _feeOnBuy = 20;  
    uint256 private _taxOnBuy = 5;   
 
    //Sell Fee
    uint256 private _feeOnSell = 30; 
    ...
    address payable private _developmentWalletAddress = payable(0xF0422409c98CEB38Bcd5C8a7314a5db5a5bd7390);
    address payable private _marketingWalletAddress = payable(0x56F43dbdd97Da60cB89Cce2f75681d6B80925547);
