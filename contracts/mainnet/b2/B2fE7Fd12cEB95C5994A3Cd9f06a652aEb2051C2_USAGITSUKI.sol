...
contract USAGITSUKI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"USAGI TSUKI", unicode"TSUKI") {
        ...
        marketingWallet = address(0x86187905b4210144ecC35eA5f39F17e7ac966b54); // set as marketing wallet
        devWallet = address(0x86187905b4210144ecC35eA5f39F17e7ac966b54); // set as dev wallet
