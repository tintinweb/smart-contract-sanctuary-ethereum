...
contract ERC721MACH1 is Ownable, ERC721A {
    ...
    constructor(
        ...
        uint256 PAID_MINT_MAX_QTY_,
        uint256 GIFT_MAX_QTY_,
        uint256 PRICE_,
        uint256 MAX_QTY_PER_WALLET_
    ) ERC721A(name_, symbol_) {
        FREE_MINT_MAX_QTY = FREE_MINT_MAX_QTY_;
        PAID_MINT_MAX_QTY = PAID_MINT_MAX_QTY_;
        TOTAL_MINT_MAX_QTY = FREE_MINT_MAX_QTY_ + PAID_MINT_MAX_QTY_;
        GIFT_MAX_QTY = GIFT_MAX_QTY_;
        PRICE = PRICE_;
        MAX_QTY_PER_WALLET = MAX_QTY_PER_WALLET_;
    }

    function TOTAL_MAX_QTY() public view returns (uint256) {
        return FREE_MINT_MAX_QTY + PAID_MINT_MAX_QTY + GIFT_MAX_QTY;
    }
