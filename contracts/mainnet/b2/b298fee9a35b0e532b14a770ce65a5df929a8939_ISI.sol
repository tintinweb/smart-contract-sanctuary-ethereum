...
contract ISI is Context, IERC20, Ownable {
    ...
    string private constant _name = "IncomeSharks Inu";
    ...
    address payable private _developmentAddress = payable(0x604b3F2Cc5111eB3e6DD67fCa24c9Da0633940ef); 
    address payable private _marketingAddress = payable(0x604b3F2Cc5111eB3e6DD67fCa24c9Da0633940ef);
