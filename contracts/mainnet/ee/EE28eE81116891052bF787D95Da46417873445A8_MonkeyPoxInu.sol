...
LP will be locked for 2 weeks before launch(Will be extended of course)
Max tx 1% max wallet 2%, opening trade, lifting max tx, ownership renounced, and we sending this
Tax is 2% buy 2% sell
Please make a telegram for the community, @MONUERC
*/
...
contract MonkeyPoxInu is ERC20, Ownable {
    ...
    constructor() ERC20("Monkeypox Inu", "MONU") {
