...
import "../../tokens/Erc721/Erc721V1.sol";
import "./IDetonatedToonzV1.sol";
import "../../storage/implementations/DetonatedToonz/DetonatedToonzStorageV1.sol";

contract DetonatedToonzV1 is Erc721V1, IDetonatedToonzV1 {
    // =============================================================
    // Main Token Logic
    // =============================================================

    function canDetonate() public view returns (bool) {
        return DetonatedToonzStorageV1.layout()._canDetonate;
    }
    ...
    function hasBeenDetonated(uint256 _ogToonId, uint256 _detonationType) public view returns (bool) {
        ...
        return DetonatedToonzStorageV1.layout()._detonationStatusesBitMap[_detonationType][bucket] & mask != 0;
    }
    ...
    function detonate(uint256 _ogToonId, uint256 _detonationType) public {
        ...
        if (DetonatedToonzStorageV1.layout()._degenToonzCollection.ownerOf(_ogToonId) != msg.sender) {
            revert YouMustOwnTheOgToon();
        }

        if (DetonatedToonzStorageV1.layout()._gmGnDynamiteCollection.balanceOf(msg.sender, _detonationType) < 1) {
        ...
        DetonatedToonzStorageV1.layout()._detonationStatusesBitMap[_detonationType][bitMapBucket] |= bitMapMask;

        emit Detonation(_ogToonId, _detonationType, newTokenId, msg.sender);

        DetonatedToonzStorageV1.layout()._gmGnDynamiteCollection.burn(msg.sender, _detonationType, 1);
    ...
    function setCanDetonate(bool _canDetonate) public onlyRole(DEFAULT_ADMIN_ROLE) {
        DetonatedToonzStorageV1.layout()._canDetonate = _canDetonate;
    }
...
contract DegenToonzV1 is Erc721V1, IDegenToonzV1 {
    // =============================================================
    // Off-chain Indexing Tools
    // =============================================================
...
import "../../tokens/Erc1155/Erc1155V1.sol";
import "./IGmGnDynamiteV1.sol";
import "../../storage/implementations/GmGnDynamite/GmGnDynamiteStorageV1.sol";

contract GmGnDynamiteV1 is Erc1155V1, IGmGnDynamiteV1 {
    ...
    function canClaim() public view returns (bool) {
        return GmGnDynamiteStorageV1.layout()._canClaim;
    }

    function canExchange() public view returns (bool) {
        return GmGnDynamiteStorageV1.layout()._canExchange;
    }
    ...
    function hasClaimed(uint256 _tokenId) public view returns (bool) {
        ...
        return GmGnDynamiteStorageV1.layout()._claimStatusesBitMap[bucket] & mask != 0;
    }

    function claim(uint256[] memory _tokenIds) public {
        if (!GmGnDynamiteStorageV1.layout()._canClaim) {
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            if (GmGnDynamiteStorageV1.layout()._degenToonzCollection.ownerOf(tokenId) != msg.sender) {
            ...
            GmGnDynamiteStorageV1.layout()._claimStatusesBitMap[bitMapBucket] |= bitMapMask;
    ...
    function exchangeNormalForRadioactive(uint8 _radioactiveAmount) public {
        if (!GmGnDynamiteStorageV1.layout()._canExchange) {
    ...
    function setCanClaim(bool _canClaim) public onlyRole(DEFAULT_ADMIN_ROLE) {
        GmGnDynamiteStorageV1.layout()._canClaim = _canClaim;
    }

    function setCanExchange(bool _canExchange) public onlyRole(DEFAULT_ADMIN_ROLE) {
        GmGnDynamiteStorageV1.layout()._canExchange = _canExchange;
    }
    ...
    function getClaimStatusesOfOwner(
        ...
        uint256 currentTokenId = _startId;
        uint256 maxResultLength = GmGnDynamiteStorageV1.layout()._degenToonzCollection.balanceOf(_owner) - _startBalance;

        uint256 i = 0;
        for (;;) {
            if (GmGnDynamiteStorageV1.layout()._degenToonzCollection.ownerOf(currentTokenId) == _owner) {
...
import "../../../implementations/DegenToonz/DegenToonzV1.sol";
import "../../../implementations/GmGnDynamite/GmGnDynamiteV1.sol";

library DetonatedToonzStorageV1 {
    struct Layout {
        // =============================================================
        // Storage
        // =============================================================
        ...
        DegenToonzV1 _degenToonzCollection;
        // Reference to the GMGN Dynamite Collection
        GmGnDynamiteV1 _gmGnDynamiteCollection;
...
abstract contract Erc1155V1 is
    ...
    AccessControlUpgradeable
{
    ...
    function setApprovalForAll(address _operator, bool _approved) public virtual override onlyAllowedOperatorApproval(_operator) {
    ...
    AccessControlUpgradeable
{
    ...
    function __Erc721V1_init(
        ...
        __Erc721V1_init_unchained();
    }

    function __Erc721V1_init_unchained() internal onlyInitializing {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
    }
    ...
    function supportsInterface(bytes4 _interfaceId) public view virtual override(ERC721AUpgradeable, BasicErc2981V1, AccessControlUpgradeable) returns (bool) {
        return ERC721AUpgradeable.supportsInterface(_interfaceId) || BasicErc2981V1.supportsInterface(_interfaceId) || AccessControlUpgradeable.supportsInterface(_interfaceId);
    }
