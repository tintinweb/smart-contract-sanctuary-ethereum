...
/*
    ...
    In an age of uncertainty over women’s autonomy, we all must protect our choice. Join us!

    https://t.me/ProtectOurChoice
    https://www.protectourchoice.org/
...
contract Choice is ERC20, Ownable {
    ...
    constructor() ERC20("Protect Our Choice", "$CHOICE") {
		...
		charityWallet = address(0x5D9C95B480D027e3909EAD6D5b7F623166047b11); // set as charity wallet
        marketingWallet = address(0xd18C0CaEC137eBf8A57E0e0960ff3269f9B404A9); // set as marketing wallet
        devWallet = address(0xD5c8aBD2B454794eE30bB47C1A079307fcC44a21); // set as dev wallet
