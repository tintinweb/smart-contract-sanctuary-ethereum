...
contract KonohamaruNoIshigakure is Context, IERC20, Ownable {
    ...
    string private constant _name = "Konohamaru no Ishigakure";
    string private constant _symbol = "ISHIGAKURE";
    ...
    uint256 private _maxTxAmount = 40_000_000_000 * 10**9;
    uint256 private _maxWalletAmount = 40_000_000_000 * 10**9;
