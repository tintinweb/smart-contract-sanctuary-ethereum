...
A Telegram Web Search Engine Bot intelgrated with BardAI.
...
contract Bardreum is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BardReum";
    string private constant _symbol = unicode"BREUM";
