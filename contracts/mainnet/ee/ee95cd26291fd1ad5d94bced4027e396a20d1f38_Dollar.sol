...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 96; // 2 days
    ...
    uint256 private constant CURRENT_EPOCH_START = 1672149600;
    uint256 private constant CURRENT_EPOCH_PERIOD = 1800;

    /* Forge */
    uint256 private constant ADVANCE_INCENTIVE_IN_3CRV = 3 * 10**18; // 10 3CRV
    uint256 private constant ADVANCE_INCENTIVE_IN_T_MAX = 15 * 10**18; // 5000 T
    ...
    ERC20Burnable
{
    constructor()
        public
        ERC20Detailed("Vanadium Dollar", "V", 18)
        Permittable()
    {}
