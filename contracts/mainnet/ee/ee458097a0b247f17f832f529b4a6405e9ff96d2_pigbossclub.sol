...
contract pigbossclub is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcV6zEEpkKx48FjDF2j4UQrNEpx6NVUfv5Biz7cboZQUT/";
    ...
    constructor(
    ) ERC721A("Pigbossclub", "PBC", 100, maxSupply) {
    }
