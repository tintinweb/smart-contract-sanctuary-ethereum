...
contract ERROR is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ERROR";
    string private constant _symbol = "404";
    ...
    address payable private _developmentAddress = payable(0xA241a9d6691F13162aB2e8b8BBBde503020dC0Ee); 
    address payable private _marketingAddress = payable(0xA241a9d6691F13162aB2e8b8BBBde503020dC0Ee);
