...
The first and only contract that yields actual stablecoin LP and constantly burns token supply to pump your investment to the next dimension.
Tokenomics
Supply: 100 Million
Max Buy: 2%
Max Wallet: 3%
...
Telegram: https://t.me/PoodleERC
Twitter: https://twitter.com/poodleerc
Medium: https://medium.com/@poodleeth
Website: https://poodle.cool/
...
contract Poodle is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable marketingWallet =
        payable(0xb94f44436E21d80D3374F44d3bDEb50A62f08380);
    ...
    constructor() ERC20("Poodle", "POODLE") {
        ...
        maxWallet = (100000000 * (10**18) * 3) / 100; // 3% Max wallet
        maxTransactionAmount = (100000000 * (10**18) * 2) / 100; // 2% maxTransactionAmountTxn
