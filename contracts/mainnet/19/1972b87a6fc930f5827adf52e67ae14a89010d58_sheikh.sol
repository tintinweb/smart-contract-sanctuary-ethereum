...
/**
 ...
 Teh Sheikh Life Dream
 "Seeing the sheikh in the dream means that the dreamer will have health, peace, happiness, gain, abundance, abundance and wealth."

 3/3 Tax
 Build your Empire, live your Sheikhs Life
 👳
*/
...
contract sheikh is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SHEIKH INU";
    ...
    address payable private _developmentAddress = payable(0xbf3E667d43f696A3B4160b0E98d5d505473F831E); 
    address payable private _marketingAddress = payable(0xbf3E667d43f696A3B4160b0E98d5d505473F831E);
