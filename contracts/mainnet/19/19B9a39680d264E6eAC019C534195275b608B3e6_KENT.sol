...
contract KENT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"KENT Inu";
    string private constant _symbol = unicode"KENT";
    ...
    function removeLimitsNew() external onlyOwner{
        _maxTxAmount = _tTotal;
        _maxWalletSize=_tTotal;
        transferDelayEnabled=false;
        emit MaxTxAmountUpdated(_tTotal);
    ...
    function removeLimitsOld() external onlyOwner{
        _maxTxAmount = _tTotal;
        _maxWalletSize=_tTotal;
        transferDelayEnabled=false;
        emit MaxTxAmountUpdated(_tTotal);
