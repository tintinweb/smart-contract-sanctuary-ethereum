...
contract ExtinctHero is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    constructor() ERC721A("Extinct Hero", "Hero") {
        owner = msg.sender;
        maxPerTx = 10;
        price = 0.002 ether;
        maxSupply = 555;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmNwCwXhzovSUGA39T5Qu5fmUYh1YgWxxmTLM5BmxDnw1v/", _toString(tokenId), ".json"));
    }
