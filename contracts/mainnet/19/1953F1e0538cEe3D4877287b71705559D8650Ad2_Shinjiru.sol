...
/**
     https://t.me/ShinjiruErc
     https://www.shinjiru.tokyo/
     https://twitter.com/SHINJIRUERC
     https://shinjiru.gitbook.io/tokyo-boyz-present-shinjiru/?fbclid=IwAR3UazeTekpPJ-YE81rXPBrNei36Dn6kSwGNyg5AAQPjwFrVf5_Cuo086UM
...
contract Shinjiru is Context, IERC20, Ownable {
    ...
    uint256 private constant TaxSwapAmount = 10000 * 10**_decimals; //
 
    string private constant _name = "SHINJIRU"; // 
    string private constant _symbol = unicode"SHINJI"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x0053f87DCA05C804cDD379c21c47239E8D58dD21).transfer(ethToSend); //marketing wallet
    }
