...
contract  GASGOBBLERS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUVP5DNGTafjwEn1Moqhfbb8FzSQPH8oD9aYF2G5qUHex";
    ...
    constructor(
    ) ERC721A("GAS GOBBLERS", "GSOOEY", 100, maxSupply) {
    }
