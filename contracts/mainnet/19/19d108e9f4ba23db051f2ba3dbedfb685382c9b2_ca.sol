...
43 Before Christ.
The expansion of the Doge Empire starts with King Doge the Second as the leader.
After weeks of searches, King Doge and his soldiers found the Ruins of the ShibaCulture, the last civilisation known to be greater than Doge.
The old Curse transformed King Doge into Rock.
...
Tg: https://t.me/antiquedoge
Website: antiquedoge.xyz
...
contract ca  is ERC20, Ownable{
    ...
    address public marketingWallet = 0xc7Aa4d72b7D39D11837567CaEa400eBe0b0349Dc;
    address public devWallet = 0xc7Aa4d72b7D39D11837567CaEa400eBe0b0349Dc;
    ...
    Taxes public taxes = Taxes(6,0,0);
    Taxes public sellTaxes = Taxes(6,0,0);
    uint256 public totTax = 6;
    uint256 public totSellTax = 6;
    ...
    constructor() ERC20("AntiqueDoge", "AGE") {
