...
// SPDX-License-Identifier: Unlicensed
    ...
    /* 
   https://twitter.com/elonmusk/status/1567201841590550531?s=21&t=VDhBKKOdQxzi21aZzN6kVg
    */
    ...
    contract ChocolateChipInu is Context, IERC20, Ownable {

        using SafeMath for uint256;

        string private constant _name = "ChocolateChipInu";
