...
// File: contracts/BaseToken/base/TokenBeacon.sol
...
// File: contracts/BaseToken/base/TokenFactoryUpgradeable.sol
    ...
    ITokenFactory
{
    ...
    function createToken(
        ...
        _tokens.push(token);
        emit TokenCreated(name, symbol, amount, cap, token);
    }
...
// File: contracts/Net-Ethereum/Token/EthereumTokenFactory.sol
