...
contract KingCharles is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmejN2YmE2xN7u2F51tuspH93XoYjmLSUYHSx3a6WE";
    ...
    constructor(
    ) ERC721A("King Charles", "KING", 100, maxSupply) {
    }
