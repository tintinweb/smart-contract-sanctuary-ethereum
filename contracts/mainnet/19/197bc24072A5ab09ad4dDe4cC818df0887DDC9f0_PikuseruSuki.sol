...
//https://twitter.com/PikuseroSuki
//https://pikuserosuki.xyz/
/*
9696 個のランダムに生成された完全にアニメーション化されたピクセロ スキが、イーサリアム ブロックチェーン上に存在します。
300 を超える特性
ロードマップもユーティリティもありません。cc0 ピクセルの人形だけです。


9696 randomly generated full animated Pikusero Suki living on the Ethereum Blockchain.
More than 300 traits
No roadmap, no utility, just cc0 pixel dolls.
*/
...
pragma solidity ^0.8.0;
    ...
    contract PikuseruSuki is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;


  string private uriPrefix = "";
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://bafkreihy3fi2gikqulm3fvfhyw7u2bsgu27gpxqdbdfzb5a642xh5yuvem";
  uint256 public cost = 0.003 ether;
  uint16 public  maxSupply = 9696;
  uint8 public maxMintAmountPerTx = 10;
  uint8 public maxMintAmountPerWallet = 100;
  uint8 public maxFreeClaimAmountPerWallet = 3;  
  ...
  uint16 public  freeClaimUntil = 2500;
  constructor() ERC721A("Pikuseru Suki", "PSK") {}
