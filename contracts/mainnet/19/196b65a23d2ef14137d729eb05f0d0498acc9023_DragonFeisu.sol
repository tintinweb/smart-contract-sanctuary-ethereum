...
contract DragonFeisu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x1dF4137ABf7d33De96b3985070e71851e0b81e28));

    string private _name = "Dragon Feisu";
    string private _symbol = "DragonFeisu";
