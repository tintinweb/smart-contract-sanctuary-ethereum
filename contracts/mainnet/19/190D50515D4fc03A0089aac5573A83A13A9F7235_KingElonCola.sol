...
contract KingElonCola is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "King Elon Cola";
    string private constant _symbol = "KOLA";
    ...
    address payable private _marketingAddress = payable(0x05988FCa20124cA0B1f3E6ad188A0dB10Ea46d83);
