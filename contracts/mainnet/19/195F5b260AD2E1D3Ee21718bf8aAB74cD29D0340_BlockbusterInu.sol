...
contract BlockbusterInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Blockbuster Inu";
    string private constant _symbol = "BBI";
    ...
    address payable private _developmentAddress = payable(0x50565cc69b31c0EF6a5815C6C2D1a30C7E2c03c4);
    address payable private _marketingAddress = payable(0x50565cc69b31c0EF6a5815C6C2D1a30C7E2c03c4);
    ...
    function SetFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy + taxFeeOnBuy <= 100, "Tax on buy can't be more than 10");
