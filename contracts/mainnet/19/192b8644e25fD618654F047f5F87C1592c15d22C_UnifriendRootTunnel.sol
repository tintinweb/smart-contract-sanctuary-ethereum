...
/**
 * @title UnifriendRootTunnel
 */
contract UnifriendRootTunnel is FxBaseRootTunnel, Create2 {
    ...
    function deposit(
        ...
        require(
            ...
            "UnifriendRootTunnel: NO_MAPPING_FOUND"
        );
    ...
    function _processMessageFromChild(bytes memory data) internal override {
        ...
        if (
            ...
            require(
                _createdToken == rootToken,
                "UnifriendRootTunnel: ROOT_TOKEN_CREATION_MISMATCH"
            );
        }
