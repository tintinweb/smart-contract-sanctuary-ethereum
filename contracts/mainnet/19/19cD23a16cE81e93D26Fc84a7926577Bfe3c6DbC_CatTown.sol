...
contract CatTown is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://Qme7dcwdczuXMe4HbhHxwxW7roecB9B4Ar3oX84auZ8pVb/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0.002 ether;
  uint256 public maxSupply = 9999;
  uint256 public maxMintAmountPerTx = 25;
  uint256 public freeUntil = 9999;
  uint256 public freebiesPerWallet = 3;
  mapping(address => uint256) public freebieMap;

  bool public paused = false;

  constructor() ERC721A("CatTown", "CT") {
  }
