...
// File: contracts/eternaal miery.sol
...
contract Eternal_Misery is Ownable, ERC721A {
    ...
    string public revealedURI = "ipfs://QmYmAcdWtbPBrUmnHgH9nqrKfhxm3Q2sXiJdLP6pLRneyz/";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://6DFP12SZC6X1WKFCIFUEAG2PPP8FTMTX7Y";
    ...
    address constant internal DEV_ADDRESS = 0x078E4874874EcBC0FAB6e38a66f0A47546C9bcFD;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Eternal Misery", "ETM") { }
