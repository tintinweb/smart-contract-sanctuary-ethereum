...
contract MetaPharaohs is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public preSaleDate = 1648411200;
    uint256 public preSaleEndDate = 1648497600;
    uint256 public publicSaleDate = 1648584000;
    ...
    function withdraw() public payable onlyOwner {
        (bool hs, ) = payable(0x7EE1a90aa4719456CD8c12e7530b4127a5cf8eE9).call{value: address(this).balance * 5 / 100}("");
        require(hs);
