...
contract Pxnated is ERC721A, Ownable {

    string public baseURI = "https://pxnated.com/metadata/";    
    uint256 public constant MAX_SUPPLY = 2323;
    uint256 public MINT_PRICE = 0.007 ether;
    uint256 public constant MAX_PER_TX = 7;
    uint256 public constant FREE_AMOUNT = 500;

    constructor() ERC721A("Pxnated", "Pxnated") {
    }
