...
contract ChiliInu is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20("Chili Inu", "CHILI") {
        ...
        uint256 totalSupply = 77777777777777 * 1e9;

        maxTransactionAmount = 77777777777777 * 1e9;
        maxWallet = 77777777777777 * 1e9;
        swapTokensAtAmount = 77777777777 * 1e9;
    ...
    function Bonk() external onlyOwner {
      ...
      maxTransactionAmount = 1633333333333 * 1e9;
      maxWallet = 1633333333333 * 1e9;
