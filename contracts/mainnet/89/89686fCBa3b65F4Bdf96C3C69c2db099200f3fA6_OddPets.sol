...
contract OddFrens is ERC721A, ERC721AQueryable, Ownable {
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    OpenSeaProxyRegistry2 proxyRegistry = OpenSeaProxyRegistry2(
      proxyRegistryAddress
    );
...
contract OwnableDelegateProxy2 {}

contract OpenSeaProxyRegistry2 {
  mapping(address => OwnableDelegateProxy2) public proxies;
}
