...
contract BUGERC20 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = unicode"BUG";
    string private _symbol = unicode"BUG";
    ...
    constructor () {
        ...
        raca = payable(address(0x388F19714B1ADFdE3dd20C9Dff46CfaB79B03329));
