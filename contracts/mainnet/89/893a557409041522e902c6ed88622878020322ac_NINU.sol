...
contract NINU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "NAYAN CAT INU";//
    ...
    address payable private _developmentAddress = payable(0x9C240cb2DA038D3286073E0609cb615654F786e7);//
    address payable private _marketingAddress = payable(0x58DA4cd81d25Ea7c083772AB4aE2187fA0f2f8Ca);//
    ...
    uint256 public _swapTokensAtAmount = 2500000000000 * 10**9; //
