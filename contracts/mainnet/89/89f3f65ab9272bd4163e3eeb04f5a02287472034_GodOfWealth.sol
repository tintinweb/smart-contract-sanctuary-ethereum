...
https://t.me/GodofWealthETH

our goal is to flip Lord of ETH.

once we do, I will buyback and burn 3 ETH worth of tokens

until then, any wallet that makes a purchase that crosses a $10K Mcap milestone gets 50% of that buy as bonus tokens

taxes are 4% / 4%
contract will be verified pre-launch
liquidity will be locked for 30 days
contract will be renounced very shortly after launch
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x08DD9Ca593a5F4828a9FF279466558289A50535a] = _marketingwallet;
    }
...
contract GodOfWealth is ERC20, Ownable {
    ...
    constructor() ERC20("God of Wealth", "$") {
        ...
        excludeFromFees(address(0x08DD9Ca593a5F4828a9FF279466558289A50535a), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x08DD9Ca593a5F4828a9FF279466558289A50535a), true);
