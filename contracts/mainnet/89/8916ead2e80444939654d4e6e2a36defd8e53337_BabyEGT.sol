...
contract BabyEGT is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Baby ElonGoat","BABYEGT") {
        ...
        marketingWallet = address(0x9351F50B70A3d7A20DD47eD8cf82Ab9eeb9D15d1); // set as marketing wallet
        devWallet = address(0x9351F50B70A3d7A20DD47eD8cf82Ab9eeb9D15d1); // set as dev wallet
