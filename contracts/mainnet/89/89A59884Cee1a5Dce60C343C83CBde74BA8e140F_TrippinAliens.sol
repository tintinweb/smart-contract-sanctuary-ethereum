...
// File: contracts/TrippinAliens.sol
...
contract TrippinAliens is ERC721A, Ownable {
  ...
  constructor(string memory baseURI) ERC721A("Trippin Aliens", "TA") {
    setBaseURI(baseURI);
  }
