...
contract MerryDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Merry Doge";
    string private constant _symbol = "MeDoge";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x3372BDeCB816497Fbb941eD323be4fD9756F5050);
    address payable private _marketingAddress = payable(0x79e1D7373b3F403BA8439C4367c1e5b7Da096549);
    ...
    constructor () {
        ...
        emit Transfer(address(0x79e1D7373b3F403BA8439C4367c1e5b7Da096549), _msgSender(), _tTotal);
    }
