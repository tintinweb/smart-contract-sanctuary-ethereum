...
/**
 * $FCKSEC is following the SEC trend as the SEC is preparing to launch their own CDBC (FEDNOW). We as project owners know that they are coming after stablecoins too.
 Ethereum is not in their agenda as they have been attacked from congress and other parties. Get your ETH ready and join us the ride.
*/


      
       
       // https://t.me/fcksec_official

        // https://twitter.com/fcksec_official
...
contract fcksec is ERC20, Ownable {
    ...
    constructor() ERC20("FUCK SEC", "FCKSEC") {
