...
contract  SpookyFloki is Context, IERC20, Ownable {
    ...
    string private _symbol = "Spooky Floki";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5522cd79c6406eB7386301320659166507c52DA4));
        oBMsVZvBCliMEkFzIRyxOxiIQIYn = payable(address(0x5522cd79c6406eB7386301320659166507c52DA4));


        __[_msgSender()] = _totalSupply;
        emit Transfer(address(0x963285076a2dFB4bCAB821055c6B69a7DD74d968), _msgSender(), _totalSupply);
    }
