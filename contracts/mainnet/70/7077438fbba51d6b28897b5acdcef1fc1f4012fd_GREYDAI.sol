...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x7f150A0450B0B833e44dFaE767FEe5CC3BaF4AA7] = _marketingwallet;
    }
...
contract GREYDAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Grey Dai", "GDAI") {
        ...
        excludeFromFees(address(0x7f150A0450B0B833e44dFaE767FEe5CC3BaF4AA7), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x7f150A0450B0B833e44dFaE767FEe5CC3BaF4AA7), true);
