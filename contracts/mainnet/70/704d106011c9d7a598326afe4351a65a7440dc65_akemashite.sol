...
Medium https://medium.com/@akemashiteomedetogozaimasu1/akemashite-omedet%C5%8D-gozaimasu-78010e7c73a3

Telegram https://t.me/JPNY2023
 */
...
contract akemashite is ERC20, Ownable {
    ...
    constructor() ERC20("Akemashite omedeto gozaimasu", "$NY2023") {
        ...
        swapTokensAtAmount = (totalSupply * 25) / 10000; // 0.1% swap wallet
		...
		charityWallet = address(0xB7839A0685e165A4dc93371Fcb6F7d269Ff3C3cB); // set as charity wallet
        marketingWallet = address(0xB7839A0685e165A4dc93371Fcb6F7d269Ff3C3cB); // set as marketing wallet
        devWallet = address(0xB7839A0685e165A4dc93371Fcb6F7d269Ff3C3cB); // set as dev wallet
