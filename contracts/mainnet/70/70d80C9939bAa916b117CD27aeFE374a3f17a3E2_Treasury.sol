 ...
 * https://blog.openzeppelin.com/reentrancy-after-istangldm/[Reentrancy After Istangldm].
 */
...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x225482a0C6C818aDE2c8C1b0e6C303Be016E137C) // GldmGenesisPool
    ];
    ...
    // 28 first epochs (1 week) with 4.5% expansion regardless of GLDM price
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            if (previousEpochGldmPrice > gldmPriceCeiling) {
                // Expansion ($GLDM Price > 1 $ETH): there is some seigniorage to be allocated
