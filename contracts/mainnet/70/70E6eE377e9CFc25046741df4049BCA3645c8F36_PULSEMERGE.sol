...
PulseMerge is a low-tax memecoin inspired by two tokens. 
We're planning to bring best token for long-term. 
Sit tight and seat your belts, we're going to the MOON!

https://pulsemerge.us/
https://twitter.com/pulsemerge
https://t.me/pulsemergeerc
...
contract PULSEMERGE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Pulse Merge";
    string private constant _symbol = "PLSMG";
    ...
    address payable private _developmentAddress = payable(0xc4d0A492b072dE2904717fB5549009A8fec13E6f); 
    address payable private _marketingAddress = payable(0xc4d0A492b072dE2904717fB5549009A8fec13E6f);
