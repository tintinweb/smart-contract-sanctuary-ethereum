...
A dream of better World

A dream of seemless Experience
...
contract InuYoshi is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1_000_000_0 * 10**8;
    ...
    string private constant _name = "Ryoshis Dream";
    string private constant _symbol = "Inuyoshi";
    ...
    uint256 public _maxTxAmount = 20_000_0 * 10**8;
    uint256 public _maxWalletSize = 30_000_0 * 10**8;
