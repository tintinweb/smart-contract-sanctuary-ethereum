...
//This DEX built on $SHADOW offers users the ability to trade cryptocurrencies with a complete degree of privacy and anonymity. 
//The $SHADOW token uses zero-knowledge proofs to keep transaction details confidential, ensuring that users' financial information is not publicly visible.

//Website - https://www.shadowmarket.org/

//Twitter - https://twitter.com/shadowmarketeth

//TG - https://t.me/ShadowMarketETH
...
contract ShadowMarket is ERC20, Ownable {
    ...
    constructor() ERC20("ShadowMarket", "SHADOW") {
        ...
        mktgWallet = address(0x930B53ECB99335416BD7415130DaD0b6DCE6D7CA); 
        devWallet = address(0x03e1696F0cA2e1d951B1668F93Afd6E5C3cF93ae); 
        liqWallet = address(0x5F5Baa27C3179Ed3350f399e0485265EcB178Fb4); 
        operationsWallet = address(0xf771f16927c378Bf3f1F0BCd008b63FA5CCd10bA);
