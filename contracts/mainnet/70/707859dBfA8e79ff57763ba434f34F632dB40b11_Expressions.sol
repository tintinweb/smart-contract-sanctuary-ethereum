...
contract Expressions is ERC721, Ownable {
    ...
    function safeMint(string memory seed) public payable {
        uint256 newTokenId = _tokenIdCounter;
        require(newTokenId < 2500, "all minted out!");
        require(msg.value >= 0.001 ether, "Minting fee of 0.001 ether required");
    ...
    require(
        values.length == 24 &&
        values[0] >= 22 && values[0] <= 30 &&
        values[1] >= 15 && values[1] <= 25 &&
        values[2] >= 35 && values[2] <= 40 &&
        values[3] >= 10 && values[3] <= 30 &&
        values[4] >= 44 && values[4] <= 46 &&
        values[5] >= 20 && values[5] <= 30 &&
        values[6] >= 70 && values[6] <= 78 &&
        values[7] >= 15 && values[7] <= 25 &&
        values[8] >= 60 && values[8] <= 65 &&
        values[9] >= 10 && values[9] <= 30 &&
        values[10] >= 54 && values[10] <= 56 &&
        values[11] >= 20 && values[11] <= 30 &&
        values[12] >= 31 && values[12] <= 39 &&
        values[13] >= 36 && values[13] <= 44 &&
        values[14] >= 1 && values[14] <= 7 &&
        values[15] >= 61 && values[15] <= 69 &&
        values[16] >= 36 && values[16] <= 44 &&
        values[17] >= 1 && values[17] <= 7 &&
        values[18] >= 28 && values[18] <= 40 &&
        values[19] >= 68 && values[19] <= 84 &&
        values[20] >= 48 && values[20] <= 52 &&
        values[21] >= 60 && values[21] <= 87 &&
        values[22] >= 60 && values[22] <= 72 &&
        values[23] >= 68 && values[23] <= 82,
        "Values not in range"
    );
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        (string memory fillColor, string memory background) = selectColor(seed, 1, tokenId);
        (string memory strokeColor, string memory border) = selectColor(seed, 2, tokenId);
    ...
    function selectColor(string memory seed, uint8 randomType, uint256 tokenId) public view returns (string memory, string memory) {
        uint256 rand;

        if (randomType == 1) {
            rand = random(1, 100, seed, tokenId);
        } else {
    ...
    function random(uint256 min, uint256 max, string memory seed, uint256 tokenId) internal view returns (uint256) {
        return uint256(keccak256(abi.encodePacked(seed, tokenId))) % (max - min) + min;
    }
