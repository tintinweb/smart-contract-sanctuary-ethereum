...
contract TSUDOGE is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000 * 1e9 * 1e9; //100,000,000,000
    ...
    string private constant _symbol = "COMMUNITY TSUDOGE";
    ...
    constructor () {
        dev = payable(0xC5b57A16936e39fF939D82E06ded5525b076fA83);
