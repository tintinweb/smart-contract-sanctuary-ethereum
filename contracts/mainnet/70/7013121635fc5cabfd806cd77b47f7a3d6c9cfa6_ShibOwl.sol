...
contract ShibOwl is Context, IERC20, Ownable {
    ...
    string private _name = "SHIB OWL";
    string private _symbol = "SHIWL";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 2000000, "Max Tx Amount cannot be less than 69 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 2000000, "Swap Threshold Amount cannot be less than 69 Million");
