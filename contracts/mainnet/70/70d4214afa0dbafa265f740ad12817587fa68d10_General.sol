...
// A Decentralized Meme -  LaRocca Imanta Inu

/**
 
LaRocca Imanta Inu is new dimension in web3 architecture

Nejc Kodric Blocked Unblock Follow Following Dec 27, 2017

We, Jan (Sergey Meshkov) and me, today started the construction of our first machine in LaRocca Imanta building. 
The building is dedicated to innovation. Now LaRocca Imanta is the heart of our new research center in Lejre, Denmark. 
You may know Lejre as the home of “lumenlab” and many students go there to work on projects. 
It’s a hub of culture and a very nice city.

When we built Lumenlab, there were so many amazing technologies that we didn’t know how we’ll use them in practice
...
// TG- https://t.me/LaRoccaImantaInu
...
contract General is ERC20, Ownable {
    // Namings
    string private projectName = "LaRocca Imanta Inu";
    string private tokenName = "LAROCCA";

    // Wallets
    address public devWallet = address(0xdCD7d03354b2d1A9093f3BF9599faeA461E153cc);
    address public marketingWallet = address(0xdCD7d03354b2d1A9093f3BF9599faeA461E153cc);
