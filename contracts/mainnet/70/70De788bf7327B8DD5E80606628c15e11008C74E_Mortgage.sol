...
contract Mortgage is ERC721Enumerable, Vault, IFlashLoanReceiver {
        ...
        abi.encodePacked(
          ...
          Base64.encode(
            abi.encodePacked(
              ...
              '","description":"',
              'This NFT represents a loan position at Drops',
              '","image":"',
  ...
  function mortgage(
    ...
    uint8 flashLoanType                     // 0: own flashloan, 1: dydx
  ) external payable {
    ...
    provider.flashLoan(aggregator, value - msg.value, trades, flashLoanType);
  }
