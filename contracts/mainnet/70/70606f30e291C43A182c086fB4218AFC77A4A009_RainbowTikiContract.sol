...
//    / __ \____ _(_)___  / /_  ____ _      _/_  __(_) /__(_)
//   / /_/ / __ `/ / __ \/ __ \/ __ \ | /| / // / / / //_/ / 
//  / _, _/ /_/ / / / / / /_/ / /_/ / |/ |/ // / / / ,< / /  
// /_/ |_|\__,_/_/_/ /_/_.___/\____/|__/|__//_/ /_/_/|_/_/   
//                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xCE61909c14CE3E47D1751145d18052e3E69081EE];
  address public erc20Payable = 0xCE61909c14CE3E47D1751145d18052e3E69081EE;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmXdNAPvjJdJjLhfY8uJTwsP26eTK4R3yDAXiLrzXvgGt8/";
...
// File: contracts/RainbowTikiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RainbowTikiContract is RamppERC721A {
    constructor() RamppERC721A("RainbowTiki", "RBT"){}
}