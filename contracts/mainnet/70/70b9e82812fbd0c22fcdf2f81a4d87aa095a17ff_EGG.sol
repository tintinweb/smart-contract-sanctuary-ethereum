...
contract EGG is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "FOTE";
    ...
    address payable private _developmentAddress = payable(0x4BB93DAa07901430bB2f26a4cd1B2FD9b8e235d1);
    address payable private _marketingAddress = payable(0x4BB93DAa07901430bB2f26a4cd1B2FD9b8e235d1);
