...
/**
 * @title MetaThirst ERC721A Smart Contract
 */
contract MetaThirst is ERC721A, BaseTokenV2, DistributableV1, AuthorizerV1 {
    constructor(
    ...
    uint256 public constant MAX_SUPPLY = 2_525;
