...
contract TheGame is ERC721A, Ownable, ReentrancyGuard {

    // constants
    uint256 constant MAX_ELEMENTS = 2000;
    uint256 constant MAX_ELEMENTS_TX = 10;
    uint256 constant MAX_FREE_PER_TX = 2;
    uint256 constant PUBLIC_PRICE = 0.005 ether;

    string public baseTokenURI = "";
    bool public paused = false;

    constructor(uint256 maxBatchSize_) ERC721A("The GAME", "GAME", maxBatchSize_) {}
