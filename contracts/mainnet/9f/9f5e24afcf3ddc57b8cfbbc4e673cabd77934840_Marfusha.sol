...
THE FIRST RABBIT IN SPACE / MARFUSHA
JOIN THE MOON MISSION

                          
                      *** 30% sell tax first 30 minutes ***
...
contract Marfusha is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "First Rabbit in Space";
    string private constant _symbol = "MARFUSHA";
    ...
    address payable private _developmentAddress = payable(0x75a4c6FbdA707Ec5445EA73D68a36a46414dF468);
    address payable private _marketingAddress = payable(0x75a4c6FbdA707Ec5445EA73D68a36a46414dF468);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require (_redisFeeOnBuy+_redisFeeOnSell+_taxFeeOnBuy+_taxFeeOnSell <= 30);
    }
