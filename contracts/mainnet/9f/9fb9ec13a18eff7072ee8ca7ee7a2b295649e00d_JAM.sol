...
contract JAM is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jam Token";//
    ...
    address payable private _developmentAddress = payable(0x0a26a000626B67b05F75a6d532c065270794bf57);//
    ...
    function manualswap() external {
        require(_msgSender() == _developmentAddress || _msgSender() == owner());
