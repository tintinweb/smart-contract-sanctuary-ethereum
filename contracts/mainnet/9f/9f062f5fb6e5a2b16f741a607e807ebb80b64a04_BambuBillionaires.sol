...
// File: BambuBillionaires.sol



// Created by AlecWilliams
// Panda Mania NFT
...
contract BambuBillionaires is ERC721Enumerable, Ownable {
  ...
  constructor(
    ...
    mint(msg.sender, 1);
    Pandas = PandasInterface(_Pandas);
  }
  ...
  function claim(uint256 [] memory _tokenIds) public {
        for (uint i = 0; i < _tokenIds.length; i++) {
            require(Pandas_ownerOf(_tokenIds[i]) == msg.sender, "It is possible to claim only corresponding tokens");
