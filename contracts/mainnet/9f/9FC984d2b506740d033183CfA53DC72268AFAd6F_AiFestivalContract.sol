  ...
  constructor(
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 698");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 698");
...
// File: contracts/AiFestivalContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AiFestivalContract is RamppERC721A {
    constructor() RamppERC721A("AI Festival", "Festival"){}
}
