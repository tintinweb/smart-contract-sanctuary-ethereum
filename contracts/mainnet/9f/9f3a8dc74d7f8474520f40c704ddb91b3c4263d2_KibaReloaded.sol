...
/*
Kiba Reloaded ($KibaRE)

Tax 4/4

There’s no tg so you can’t fud and spam silly “eric watching” bs

You will get everything you love so much if you show you can hold it until 20k at least. 
Otherwise there’s no sense for us to put any afford in the jeetery. 

At 20k we will open official tg for you and reveal the dev
*/
...
contract KibaReloaded is Context, IERC20, Ownable {
    ...
    string private _name = "Kiba Reloaded";
    string private _symbol = "KibaRE";
