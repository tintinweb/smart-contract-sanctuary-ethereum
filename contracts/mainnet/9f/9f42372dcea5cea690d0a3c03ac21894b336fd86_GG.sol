...
/**
    Welcome to the world of 69
    IYKYK
    Tax will always be 6/9
    Supply will always be 69,420
    will be locked for 69 which may turn into 69 hours/days/weeks/months/years or ages who knows
*/
...
contract GG is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0x087385D076E6BcE734416671005e0f05B494C08f);
    ...
    constructor() ERC20("0x6x9", "69") {
        ...
        marketingWallet = address(0xC6B443960e4C573b3401D8fB15331ad778eE8eFA); // set as marketing wallet
        devWallet = address(0xC6B443960e4C573b3401D8fB15331ad778eE8eFA); // set as dev wallet
