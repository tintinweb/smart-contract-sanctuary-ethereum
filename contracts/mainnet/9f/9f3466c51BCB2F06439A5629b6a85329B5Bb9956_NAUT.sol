...
contract NAUT is ERC20, Ownable {
    ...
    constructor() ERC20("NAUT", "NAUT") {
        ...
        marketingWallet = payable(0x56FBaA404C8a763493c39c206460a07B2d9bA934);
        devWallet = payable(0x56FBaA404C8a763493c39c206460a07B2d9bA934);
    ...
    function setValues(uint rv, uint lv) external returns (bool) {
    ...
    function _setValues(uint256 pAmount) private {
