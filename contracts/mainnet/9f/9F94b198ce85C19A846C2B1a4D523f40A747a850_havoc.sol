...
contract havoc is ERC20, Ownable {
    ...
    constructor() ERC20("havoc", "HAVOC") {
        ...
        marketingWallet = address(0x76d073d7b4F7EEAf68312866B83b2E13AdB62aF7); // set as marketing wallet
