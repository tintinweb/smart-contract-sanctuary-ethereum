...
/// @title Lyfebloc constants contract
contract Utils {
...
contract ConversionRates is ConversionRatesInterface, VolumeImbalanceRecorder, Utils {
    ...
    struct TokenData {
        ...
        uint baseBuyRate;  // in PRECISION units. see LyfeblocConstants
...
// File: contracts/LyfeblocReserveInterface.sol

/// @title Lyfebloc Reserve contract
interface LyfeblocReserveInterface {
...
// File: contracts/LyfeblocNetwork.sol

////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @title Lyfebloc Network main contract
contract LyfeblocNetwork is Withdrawable, Utils {

    uint public negligibleRateDiff = 10; // basic rate steps will be in 0.01%
    LyfeblocReserveInterface[] public reserves;
    ...
    function LyfeblocNetwork(address _admin) public {
        require(_admin != address(0));
        admin = _admin;
    }
    ...
    event AddReserveToNetwork(LyfeblocReserveInterface reserve, bool add);

    /// @notice can be called only by admin
    /// @dev add or deletes a reserve to/from the network.
    /// @param reserve The reserve address.
    /// @param add If true, the add reserve. Otherwise delete reserve.
    function addReserve(LyfeblocReserveInterface reserve, bool add) public onlyAdmin {
    ...
    function getReserves() public view returns(LyfeblocReserveInterface[]) {
        return reserves;
    }
        ...
        returns(uint)
    {
        ...
        LyfeblocReserveInterface theReserve = reserves[reserveInd];
        require(rate > 0);
        require(rate < MAX_RATE);
    ...
    function doReserveTrade(
        ...
        LyfeblocReserveInterface reserve,
        uint conversionRate,
        bool validate
    )
        internal
...
// File: contracts/LyfeblocReserve.sol

/// @title Lyfebloc Reserve contract
contract LyfeblocReserve is LyfeblocReserveInterface, Withdrawable, Utils {

    address public lyfeblocNetwork;
    bool public tradeEnabled;
    ConversionRatesInterface public conversionRatesContract;
    SanityRatesInterface public sanityRatesContract;
    mapping(bytes32=>bool) public approvedWithdrawAddresses; // sha3(token,address)=>bool

    function LyfeblocReserve(address _lyfeblocNetwork, ConversionRatesInterface _ratesContract, address _admin) public {
        require(_admin != address(0));
        require(_ratesContract != address(0));
        require(_lyfeblocNetwork != address(0));
        ...
        returns(bool)
    {
        ...
        require(msg.sender == lyfeblocNetwork);
    ...
    function setContracts(address _lyfeblocNetwork, ConversionRatesInterface _conversionRates, SanityRatesInterface _sanityRates)
        public
        onlyAdmin
    {
        require(_lyfeblocNetwork != address(0));
        ...
        SetContractAddresses(lyfeblocNetwork, conversionRatesContract, sanityRatesContract);
    }
    ...
    function doTrade(
        ...
        returns(bool)
    {
        // can skip validation if done at lyfebloc network level
        if (validate) {
...
//    }
    ...
    function getExpectedRates( LyfeblocNetwork network, ERC20[] srcs, ERC20[] dests, uint[] qty )
    ...
    function getReserveRate(LyfeblocReserve reserve, ERC20[] srcs, ERC20[] dests)
        public view returns(uint[], uint[])
    {
        require( srcs.length == dests.length );
        require( srcs.length == dests.length );
