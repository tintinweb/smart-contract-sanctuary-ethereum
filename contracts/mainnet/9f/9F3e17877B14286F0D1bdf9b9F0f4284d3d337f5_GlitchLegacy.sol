...
The Matrix has been initiated. You've entered the world of glitches. The war between dinasties has begun. The faith of the metaverse is at stake. What side will you choose?

100,000,000 $GLX
2% Tax

Telegram: https://t.me/GlitchLegacyERC
Twitter: https://twitter.com/GlitchLegacyERC
Website: https://glitchlegacy.site
...
contract GlitchLegacy {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Glitch Legacy";   
    ...
    address payable constant deployer = payable(address(0xC2556faA709cc7d50DF3F3588839fFf3BD5D1447));
