...
contract FixedAPRSoloStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(address _tokenAddress, uint256 _apr, uint256 _lockDurationInDays, uint256 _exitPenaltyPerc) {
