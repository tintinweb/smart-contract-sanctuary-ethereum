...
contract Taniguku is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Iwataten no Taniguku";
    string private constant _symbol = "KANA";
