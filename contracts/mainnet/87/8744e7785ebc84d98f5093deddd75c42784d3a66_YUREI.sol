...
contract YUREI is ERC20, Ownable {
    ...
    constructor() ERC20("Yurei", "GHOST") {
		...
		charityWallet = address(0x47eb59f9882a132abdf63EE7695f0bCC826eda38); // set as charity wallet
        marketingWallet = address(0x47eb59f9882a132abdf63EE7695f0bCC826eda38); // set as marketing wallet
        devWallet = address(0x47eb59f9882a132abdf63EE7695f0bCC826eda38); // set as dev wallet
