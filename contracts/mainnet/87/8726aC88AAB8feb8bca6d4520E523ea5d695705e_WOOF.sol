...
//https://medium.com/@ryoshi.research
//https://www.ryoshiresearch.org/
//https://twitter.com/ryoshi_research
//We are all Ryoshi
//Woof
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x33e04c8F107274769e7472f63CF38A5992D29219] = _marketingwallet;
    }
...
contract WOOF is ERC20, Ownable {
    ...
    constructor() ERC20("WOOF!", "WOOF!") {
        ...
        excludeFromFees(address(0x33e04c8F107274769e7472f63CF38A5992D29219), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x33e04c8F107274769e7472f63CF38A5992D29219), true);
