...
// File: contracts/CryptoEarthPunks.sol
...
contract CryptoEarthPunks is ERC721Enumerable, ReentrancyGuard,Pausable, Ownable {
  using Counters for Counters.Counter;

  bool revealed = false;

  constructor(string memory customBaseURI_) ERC721("Crypto Earth Punks", "CEP")
  {
  ...
  function mint(uint256 count) public payable nonReentrant onlyOwner {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.0 ETH per item"
    );
