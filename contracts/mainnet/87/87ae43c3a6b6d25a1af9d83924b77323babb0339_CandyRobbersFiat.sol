...
// File contracts/ICandyRobbers.sol

//SPDX-License-Identifier: UNLICENSED
pragma solidity 0.8.13;

interface ICandyRobbers {
...
// File contracts/CandyRobbersFiat.sol
...
contract CandyRobbersFiat is Ownable, PaymentSplitter, Pausable {
    ...
    address public immutable fiatPayer;
    ...
    constructor(ICandyRobbers _candyRobbers, address _fiatPayer)
        PaymentSplitter(team_, teamShares_)
    {
        candyRobbers = _candyRobbers;
        fiatPayer = _fiatPayer;
    }
    ...
    function mintTo(address to, uint256 count) external payable {
        ...
        require(msg.sender == fiatPayer, "Not allowed"); 
