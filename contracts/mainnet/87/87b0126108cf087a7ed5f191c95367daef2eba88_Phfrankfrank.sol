  ...
  IERC721Enumerable
{
    ...
    returns (string memory)
  {
    ...
    string memory baseURI = "https://ipfs.io/ipfs/QmVniuzpcL4MvW98Tz98PFrFxEqGDPosL2hQ7fsvFanf4g/";
    return baseURI;
  }
...
contract Phfrankfrank is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.02 ether;
    uint256 public MAX_SUPPLY = 2000;
    uint256 public MAX_MINTS = 20;
    string public projName = "Phfrankfrank";
    string public projSym = "PHFRNK";

    bool public DROP_ACTIVE = false;

    string public baseURI = "https://ipfs.io/ipfs/QmVniuzpcL4MvW98Tz98PFrFxEqGDPosL2hQ7fsvFanf4g/";
    ...
    function setSupply(uint256 newMax) public onlyOwner {
        MAX_SUPPLY = newMax;
    }
