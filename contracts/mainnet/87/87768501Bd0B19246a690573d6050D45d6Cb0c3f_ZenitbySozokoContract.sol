    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 232) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmckgMTZHoTJfgnX19XwK5Cwacav4Rt2iumCjhF5AJQ2hn/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 232");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 232");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 232");
...
// File: contracts/ZenitbySozokoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ZenitbySozokoContract is RamppERC721A {
    constructor() RamppERC721A("Zenit by Sozoko", "Zenit"){}
}
