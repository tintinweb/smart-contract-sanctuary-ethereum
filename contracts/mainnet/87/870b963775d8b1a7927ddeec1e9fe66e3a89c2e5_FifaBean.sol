...
Open Trading on: 2022-09-27 05:30 UTC

Txn Limit / Max Wallet : 3% / 3%
Remove Limit after 10 minues

Initital Taxes: 0% Buy / 10% Sell / 2% Liquidity
Taxes after 30 minues: 3% Buy / 3% Sell / 2% Liquidity
...
contract FifaBean is ERC20, Ownable {
    ...
    constructor() ERC20('Fifa Bean', '$FBean') {
    ...
    function setDevFee(uint256 _buyDevFee, uint256 _sellDevFee) external onlyOwner {
        require(_buyDevFee <= 5 && _sellDevFee <= 5, 'Cannot set fee greater than 5%');
        buyDevFee = _buyDevFee;
        sellDevFee = _sellDevFee;
        buyTotalFees = buyLiquidityFee + buyDevFee;
        sellTotalFees = sellLiquidityFee + sellDevFee;
