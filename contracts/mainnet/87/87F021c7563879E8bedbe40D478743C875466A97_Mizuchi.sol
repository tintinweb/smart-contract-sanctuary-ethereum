...
contract Mizuchi is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x85E3f15c24F7C84373B1a776B4DceBcA8440320C); 
    address payable public Wallet_Developer = payable(0x85E3f15c24F7C84373B1a776B4DceBcA8440320C);
    ...
    string private constant _name = "Mizuchi"; 
    string private constant _symbol = unicode"MZCHI";
    ...
    constructor () {
        ...
        _owner = 0x85E3f15c24F7C84373B1a776B4DceBcA8440320C;
