...
contract Religare is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Religare", "Religare") {
     ...
     uint256 totalSupply = 1 * 10 ** 10 * 10 ** decimals();
 
        maxTransactionAmount = 3 * 10 ** 7 * 10 ** decimals(); // 0.3% maxTransactionAmountTxn
        maxWallet = 10 * 10 ** 7 * 10 ** decimals(); // 1% maxWallet
