...
/**
* @title ERC-721 contract for MeebitsDAO MBBT General Membership
* @dev This contract allows the distribution of MeebitsDAO MBBT General Membership tokens.
* @author maikir (based off of joshpeters.eth's MeebitsDAO General Membership)
*/
contract MeebitsDAOMBBTGeneralMembership is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    ERC721Burnable,
    Ownable
{
    ...
    */
    ...
    /**
    * @dev Actual minting and incrementing of token count called by other front facing mint functions
