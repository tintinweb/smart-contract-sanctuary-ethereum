...
ANYTHING U WANT TO TYPE ABOUT PROJECT GOES HERE
...
contract smashF is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("SMASH", "SMASH") { // 
        marketingWallet = payable(0xf6C6C74d322537409550A1df3E56A95AF5F051Ed); // 
        devWallet = payable(0xf21A293288001831CC1304fA24951d3eB34e08CA); // 
        address router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; /// 

        //INITIAL FEE VALUES HERE
        buyMarketingFees = 2;
        sellMarketingFees = 45;
        buyBurnFee = 1;
        sellBurnFee = 1;
        buyDevFee = 2;
        sellDevFee = 45;
        ...
        uint256 totalSupply = (1_000) * (10**18); // 
        _mint(owner(), totalSupply); // 
        maxWallet = _totalSupply / 50; // 
        swapTokensAtAmount = _totalSupply / 200; // ;
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 burnBuy,
        ...
        require(totalSellFees <= 99 && totalBuyFees <= 15, "t");
