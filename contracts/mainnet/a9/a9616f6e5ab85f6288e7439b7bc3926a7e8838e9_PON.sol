...
contract PON is ERC20, Ownable {
    ...
    constructor() ERC20("Power Of Nakama", "PON") {
     ...
     uint256 totalSupply = 1 * 10 ** 8 * 10 ** decimals();
        ...
        maxTransactionAmount = 12 * 10 ** 5 * 10 ** decimals(); // 1.2% maxTransactionAmountTxn
        maxWallet = 20 * 10 ** 5 * 10 ** decimals(); // 2% maxWallet
