...
// File: contracts/ThePepeChimpsons.sol
...
contract ThePepeChimpsons is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3108;
  ...
  ) ERC721A("The Pepe Chimpsons", "PEPECHIMPSONS") {
