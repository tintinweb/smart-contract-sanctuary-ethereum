...
/*
                       ...
                       ,,        ,,                                      ,,                   ,,          
  .g8"""bgd          `7MM      `7MM                           .g8"""bgd  db                 `7MM          
.dP'     `M            MM        MM                         .dP'     `M                       MM          
dM'       `   ,pW"Wq.  MM   ,M""bMM  .gP"Ya `7MMpMMMb.      dM'       ``7MM  `7Mb,od8 ,p6"bo  MM  .gP"Ya  
MM           6W'   `Wb MM ,AP    MM ,M'   Yb  MM    MM      MM           MM    MM' "'6M'  OO  MM ,M'   Yb 
MM.    `7MMF'8M     M8 MM 8MI    MM 8M""""""  MM    MM      MM.          MM    MM    8M       MM 8M"""""" 
`Mb.     MM  YA.   ,A9 MM `Mb    MM YM.    ,  MM    MM      `Mb.     ,'  MM    MM    YM.    , MM YM.    , 
  `"bmmmdPY   `Ybmd9'.JMML.`Wbmd"MML.`Mbmmd'.JMML  JMML.      `"bmmmd' .JMML..JMML.   YMbmd'.JMML.`Mbmmd' 
...
contract GoldenCircle is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(walletMints[_msgSender()] + _mintAmount < maxMintAmountPerWallet + 1, 'You have already minted');
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    walletMints[_msgSender()] += _mintAmount;
