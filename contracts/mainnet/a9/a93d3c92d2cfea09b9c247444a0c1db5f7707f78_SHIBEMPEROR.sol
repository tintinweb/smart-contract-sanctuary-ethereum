...
https://t.me/SHIBEMPEROR

www.twitter.com/shibemperor
*/
...
contract SHIBEMPEROR is Context,IERC20, Ownable{
using Address for address;
string private _name = "SHIBEMPEROR";
string private _symbol = "SHIBEMP";
...
address _owner;
address payable public marketingAddress = payable(0x2CE77dFB77AE61Ad87fE23f4747aE2e2dE011B3B);
...
function COINDay() public onlyOwner{
    require(block.timestamp > SHIBEMPERORCOINDaycooldown, "You cant call SHIBEMPERORCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function SHIBEMPERORCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    SHIBEMPERORCOINDaycooldown = block.timestamp + 86400;
}
