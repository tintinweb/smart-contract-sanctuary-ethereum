...
Elon Musk will use (Twitter Coin) for payments on twitter. So We can make $TWC be the first famous token on the Ethereum chain.

Twitter: twitter.com/TWCOIN_
Telegram: https://t.me/twcoinportal
**/
  ...
  contract twcoinportal is Context, IERC20, Ownable {
