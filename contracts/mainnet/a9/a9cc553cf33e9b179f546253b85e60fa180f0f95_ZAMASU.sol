...
contract ZAMASU is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xca9420B6C74BCC8bB69B5167C4Fec996128bbFB7));

    string private _name = "Zamasu";
    string private _symbol = "ZAMASU";
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(10000).mul(3); //0.03%
