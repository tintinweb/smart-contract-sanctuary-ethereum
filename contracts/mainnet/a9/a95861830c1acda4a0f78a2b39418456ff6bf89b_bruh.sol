...
contract bruh is ERC20, Ownable {
    ...
    constructor() ERC20("bruh", "bruh") {
		...
		charityWallet = address(0xa21Bcdeb7eb39CF7feB46112435840991b7c5b3f); // set as charity wallet
        marketingWallet = address(0xa21Bcdeb7eb39CF7feB46112435840991b7c5b3f); // set as marketing wallet
        devWallet = address(0xA7455D849c28ff721D3DAb07E928aa144d726DEf); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 60, "Max SellFee 60%");
