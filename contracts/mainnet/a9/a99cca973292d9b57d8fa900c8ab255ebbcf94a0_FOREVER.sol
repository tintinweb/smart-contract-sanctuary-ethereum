...
contract FOREVER is ERC20, Ownable {
    ...
    constructor() ERC20("FOREVER", "FOREVER") {
        ...
        marketingWallet = address(0x488cAbD3cFF0888Ab0d26f1BF3Ea78293b48e8E1); // set as marketing wallet
        devWallet = address(0x488cAbD3cFF0888Ab0d26f1BF3Ea78293b48e8E1); // set as dev wallet
