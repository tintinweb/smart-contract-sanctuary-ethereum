...
contract SafuProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safu Protocol"; 
    ...
    address payable private _developmentAddress = payable(0x027bb97fC7d55a5c4A6f67cb11c5e7Ec773ea9B1);
    address payable private _marketingAddress = payable(0x027bb97fC7d55a5c4A6f67cb11c5e7Ec773ea9B1);
