...
contract FUDiblesS4 is ERC721A, ERC2981, Ownable, DefaultOperatorFilterer{
    ...
    string public tokenUriBase = "http://metadata.mintfud.com:3333/season4/";
    uint256 public winner;
    address public lotteryPicker = 0x7DE56813aF4D33555B44dd6C5A542cedb59B761E;

    constructor() ERC721A("FUDibles Season 4", "FUDibles-S4") {
    ...
    function mint(uint256 amount) public payable mintCompliance(amount) {
        ...
        require (amount <= 10, "Too many mints per transaction requested");
    ...
    function pickwinner(string calldata _random) public authz{
        uint256 maxStatValue = 1001;
