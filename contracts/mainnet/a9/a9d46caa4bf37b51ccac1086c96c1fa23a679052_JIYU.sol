...
contract JIYU is Context, IERC20, LockToken 
{
    using SafeMath for uint256;

    address payable public marketingAddress = payable(0x05cD5d0e81044354D601574f2ec3B1A186B0c23a);
    ...
    string private _name = "JIYU Network";
    ...
    function setAllFees(uint256 buymarketingFee, uint256 sellmarketingFee) external onlyOwner
    {
        ...
        require(_sellMarketingFee<=15, "Too High Sell Fee");
        require(_marketingFee<=12, "Too High Sell Fee");
    }
