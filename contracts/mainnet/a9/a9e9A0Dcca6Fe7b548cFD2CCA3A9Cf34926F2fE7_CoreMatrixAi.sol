...
/*
tg : https://t.me/corematrixAi

web : https://corematrixai.pro/
...
contract CoreMatrixAi is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xe619c34fdf73cfe2512dDFDD8745385F819FA2F4));

    string private _name = "CoreMatrixAi";
    string private _symbol = "CMAI";
