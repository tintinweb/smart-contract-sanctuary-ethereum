...
contract McFly is ERC20, Ownable {
    ...
    constructor() ERC20("McFly", "Fly") {
        ...
        maxTransactionAmount = 10000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 20000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x5D5b0814baF0467f475e1B10ea3F6734cEbfb9Cd); // set as charity wallet
        marketingWallet = address(0x5D5b0814baF0467f475e1B10ea3F6734cEbfb9Cd); // set as marketing wallet
        devWallet = address(0xCbbc9C6c11F3C3C5A4C540BB2db48da1b92b0A17); // set as dev wallet
