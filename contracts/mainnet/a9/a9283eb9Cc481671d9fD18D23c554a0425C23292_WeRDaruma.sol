...
WeRDaruma is a traditional Japanese good luck charm for making a wish or setting a goal.
It is typically round, made with paper-mache, and painted by a skilled artisan for the face, body, 
and other aesthetics. Daruma dolls are ubiquitous in Japanese culture and often found on the shelves or altars in homes and temples, because auspicious charms are an ingrained part of Japanese fashion and lifestyle.
Other Japanese good luck charms include maneki neko, omamori, omikuji, and senbazuru.

🚫Tax Per Transaction: 4%
-2% Liquidity
-2% Marketing

☎️Telegram: https://t.me/WerDarumaETH
🌏Website: Before Launch
🐦Twitter: https://twitter.com/WeRDaruma
*/
...
contract WeRDaruma is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd8bBE4472cAD5df9f192Cec1BdC3D8E1523f5ECf); 
    address payable public Wallet_Utility = payable(0x64fF602069474812EA04beA0546F19027922B756);
    ...
    uint256 private _tTotal = 100* 10**7 * 10**_decimals;
    string private constant _name = "WeR Daruma"; 
    string private constant _symbol = unicode"WRDARUMA "; 
    ...
    constructor () {
        ...
        _owner = 0x64fF602069474812EA04beA0546F19027922B756;
