...
The best combination of $MOZZA and $SHINTAMA

- Twitter: twitter.com/mozzatamaeth
- Telegram: t.me/mozzatamaeth
...
contract MozzaTama is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MozzaTama", "MOZZATAMA") {
        ...
        maxTransactionAmount = totalSupply * 3 / 100; // 3% maxTransactionAmount
        ...
        marketingWallet = payable(0xD82B33f3F090FEB7DaC7Daad77DCE7cFfa5e5dCC);
        devWallet = payable(0xD82B33f3F090FEB7DaC7Daad77DCE7cFfa5e5dCC);
