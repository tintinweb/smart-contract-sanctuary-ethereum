...
contract ShibaOrdinalZkLsdCasino is Ownable, ERC20 { 

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public developmentWallet = 0xc7683C7d5a01cB86971e1EF6F0D8D21093917c8A;//ASSIGN
    ...
    constructor() ERC20("ShibaOrdinalZkLsdCasino", "SHIOZKLSDC") {
        totalSupply = 69420000000000 * (10**decimals());
        _mint(msg.sender, totalSupply);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D//CHECK
        );
    ...
    function updatebuyFee(uint256 newAmount) external onlyOwner {
        buyFee = newAmount;
    }

    function updatesellFee(uint256 newSellAmount ) external onlyOwner {
        sellFee = newSellAmount;
    }
        ...
        if (
            ...
            if (
                ...
                ((balanceOf(address(this))) >= _numTokensSellToAddToSwap)
                    ...
                    uint256 totalfee = 2*(buyFee)+sellFee;
                    _numTokensSellToAddToSwap = balanceOf(address(this));

                    uint256 marketingTokens = _numTokensSellToAddToSwap * sellFee / totalfee;
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                uint256 liquidityAmount = ((amount * buyFee) /
                    100);
                if (from == uniswapV2Pair) {
                    ...
                    // sell transaction
                    uint256 developmentAmount = ((amount * sellFee) /
                        100);
