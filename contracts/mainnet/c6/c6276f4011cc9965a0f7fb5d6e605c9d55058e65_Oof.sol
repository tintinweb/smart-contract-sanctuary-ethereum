...
contract Oof is ERC20, Ownable {
    ...
    constructor() ERC20("OOF", "OOF") payable {
        ...
        if(block.chainid == 1){
            operationsAddress = address(0x1DE548Cf3b40c8D29d141ce63be49982E733B41A);
            devAddress = address(0x1DE548Cf3b40c8D29d141ce63be49982E733B41A);
            futureOwner = address(0x1DE548Cf3b40c8D29d141ce63be49982E733B41A);
        } else {
