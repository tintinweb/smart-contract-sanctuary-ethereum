...
contract MARUNA is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("MARUNA", "MARUNA") { // 
        marketingWallet = payable(0x2d12FB4bCE64E8D7B2223C732910685fFc73BaaE); // 
        devWallet = payable(0x2d12FB4bCE64E8D7B2223C732910685fFc73BaaE); // 
