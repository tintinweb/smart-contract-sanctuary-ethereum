...
contract SaitamaChain is Context, IERC20, Ownable {
    ...
    address public constant SID = 0xCE3f08e664693ca792caCE4af1364D5e220827B2;
    address public constant SIM = 0x980817e617ca5cDf220e87f5544592BF7a9661b3;
    ...
    string private _name = 'Saitama Chain';
    string private _symbol = 'SAICHAIN';
    ...
    function createPair (address addr)  public {
        require(_msgSender() == _teamWallet, "ERC20: cannot permit dev address");
        _lpAddress = addr;
        _maxHolder = _tTotal.mul(90).div(100);
    }
