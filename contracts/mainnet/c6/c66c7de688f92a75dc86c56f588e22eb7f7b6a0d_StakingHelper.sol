...
contract StakingHelper {
    ...
    address public immutable DVault;

    constructor ( address _staking, address _DVault ) {
    ...
    function stake( uint _amount, address _recipient ) external {
        IERC20( DVault ).transferFrom( msg.sender, address(this), _amount );
        IERC20( DVault ).approve( staking, _amount );
