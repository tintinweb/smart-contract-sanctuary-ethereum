...
contract SLAzuki is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("SLAzuki", "SLA", maxMintAmountPerTx) {
    setHiddenMetadataUri("https://slazuki.mypinata.cloud/ipfs/QmWVqzaE92wUeXmrCNQeGkkHyYGnmdxbp3ZzzFJ12rgVda/hidden.json");
  }
