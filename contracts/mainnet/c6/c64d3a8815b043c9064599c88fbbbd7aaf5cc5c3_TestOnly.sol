...
contract TestOnly is Context, IERC20, Ownable {
    ...
    string constant private _name = "Test Only 12";
    string constant private _symbol = "TST 12";
    uint8 constant private _decimals = 18;

    address public constant  deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public autoLiquidityReceiver = payable(0x242052E3DB796050e210f790594F6c1f717179F2); // LP Address
    address payable public marketingWalletAddress = payable(0xDe7796cc7F65F98a053Dba0215a75a7449b34e08); // Marketing Address
    address payable public operationsWalletAddress = payable(0xd9Cb687EccC712A045eE3Af1542A4b057d8611C1); // operations Address
