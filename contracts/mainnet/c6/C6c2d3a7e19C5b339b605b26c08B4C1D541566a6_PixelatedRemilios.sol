//All mint revenue goes to sweeping and airdropping remilios to holders.                                                              
...
contract PixelatedRemilios is ERC721A {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmYxwmVSNsPJxi4ezJkLyZGnT4vUMKZCjkK5imzDk4cVDY/", _toString(tokenId), ".json"));
    }
