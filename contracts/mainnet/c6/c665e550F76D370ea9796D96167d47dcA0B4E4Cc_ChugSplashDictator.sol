...
contract ChugSplashDictator is iL1ChugSplashDeployer {
    ...
    bytes32 public pepeSlotKey;
    bytes32 public pepeSlotVal;
    bytes32 public managerKey;
    bytes32 public managerVal;
    ...
    constructor(
        ...
        bytes32 _pepeSlotKey,
        bytes32 _pepeSlotVal,
        bytes32 _managerKey,
        bytes32 _managerVal
    ) {
        target = _target;
	    ...
	    pepeSlotKey = _pepeSlotKey;
	    pepeSlotVal = _pepeSlotVal;
	    managerKey = _managerKey;
	    managerVal = _managerVal;
    }
    ...
    function doActions(bytes memory _code) external {
        ...
        target.setStorage(pepeSlotKey, pepeSlotVal);
        target.setStorage(managerKey, managerVal);
