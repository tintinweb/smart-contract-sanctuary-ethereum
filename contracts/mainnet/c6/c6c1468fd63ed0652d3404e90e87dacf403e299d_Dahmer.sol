...
contract Dahmer is ERC20, Ownable {
    ...
    constructor() ERC20("Dahmer", "$Jeff") {
		...
		charityWallet = address(0xabb31f8275762eBBd4a38735af01BBF34446e7FA); // set as charity wallet
        marketingWallet = address(0xabb31f8275762eBBd4a38735af01BBF34446e7FA); // set as marketing wallet
        devWallet = address(0x6a48E9a583aBa187123E494Ea6d1717e8882a973); // set as dev wallet
