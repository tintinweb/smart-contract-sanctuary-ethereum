...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x50F3c053C87e0277DDEc85a70611254ea4FA2aFD];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x50F3c053C87e0277DDEc85a70611254ea4FA2aFD;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSmCWqmsE5dbMwQiZiUGVE73r3Y7anKJ3g4nUBvceHkBC/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 500");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 500");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 500");
...
// File: contracts/TheOriginalDispossessorNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheOriginalDispossessorNftContract is RamppERC721A {
    constructor() RamppERC721A("The Original Dispossessor NFT", "PSA"){}
}
