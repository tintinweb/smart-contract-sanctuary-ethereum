...
/***************************************************************************************************************
    World Cup Qatar 2022 is without a doubt the biggest sporting event of the year! 
    And with millions of people from around the world tuning in to follow the action, 
    you have a great opportunity to touch base with your audience and generate engagement 
    and visibility for your brand. Stay top of mind with customers, give away unforgettable prizes, 
    and generate leads from loyal followers - it's all possible with our World Cup promotion ideas and resources!

********************************************************************************************************************/

// https://twitter.com/FQATAR_ETH
...
contract QATAR is Context, IERC20, Ownable {
    ...
    string private _name = "FIFA World Cup Qatar";
    string private _symbol = "QATAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x465CAcaA60ccF3cB4E334cE7FdB7253d76a62f5C); 
