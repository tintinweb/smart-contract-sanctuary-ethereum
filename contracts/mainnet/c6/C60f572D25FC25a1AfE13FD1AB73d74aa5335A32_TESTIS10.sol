...
contract TESTIS10 is IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "TESTIS10";
    string private constant _symbol = "T10";

    uint8 private constant _decimals = 18;

    uint256 private _totalSupply = 1000000000000 * (10 ** _decimals); // 1 trillion supply
    ...
    address public devWallet = 0x1ec6793Cde9148bEC6286D1bd87Ed9E53FFbC480; 
