...
contract HabibINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HabibINU";
    string private constant _symbol = unicode"HABIBINU";
