...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1726bc984bDd93dB772A5CBA45331459BD2e1D72];
  address public erc20Payable = 0x1726bc984bDd93dB772A5CBA45331459BD2e1D72;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmXj57f4pkLnFP9x3NWkbDuLNWStz2iDcDFb4y67CCfU8D/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = false;
    bool public isRevealed = false;
    
    uint256 public MAX_WALLET_MINTS = 1111;
...
// File: contracts/BackToLifeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BackToLifeContract is RamppERC721A {
    constructor() RamppERC721A("Back To Life", "BTL"){}
}