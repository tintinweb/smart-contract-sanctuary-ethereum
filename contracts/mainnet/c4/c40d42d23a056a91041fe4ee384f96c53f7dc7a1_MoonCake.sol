...
contract MoonCake is ERC20, Ownable {
    using SafeMath for uint256;

    string private name_ = "MoonCake";
    string private symbol_ = "MoonCake";
    uint256 private totalSupply_ = 100000000;

    uint256 public deadFee = 2;
    uint256 public marketingFee = 1;

    address public marketingWalletAddress = 0x2bBD9D60f99DD8255c955287238430D295EC3AB7;
