...
contract Doodrunners is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUWHCeUfTZ56N8KByNE5EjDYFpfEJUAnAXYRxQXzGxbvm";
    ...
    constructor(
    ) ERC721A("Doodrunners", "DOODRUNNERS", 100, maxSupply) {
    }
