...
contract KurosakiIchigo is Context, IERC20, Ownable {
    ...
    string private _symbol = "Kurosaki";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x456B2d61A4eE26Ae1c3b29b67468d6CF8001bc25);
    address payable public DeveloperWallet = payable(0xd054F5af93051ca68FE2595341bB9b9873AC6139);
    ...
    uint256 public _walletMax =   _totalSupply.mul(10).div(100);   //10%
