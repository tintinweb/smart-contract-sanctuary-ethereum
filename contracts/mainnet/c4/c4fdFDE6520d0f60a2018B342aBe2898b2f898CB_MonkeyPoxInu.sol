...
All these jeet dev making monkey pox inu with jeet tax and another one rugged ffs lol
lemme give u this 2/2 tax
1 month lock
renounced
1% max tx, 2% max wallet
make a tg by yourself, @monkeypoxinuethereum

launching 5 minutes after this contract is verified
*/
...
contract MonkeyPoxInu is ERC20, Ownable {
    ...
    constructor() ERC20("Monkeypox Inu", "MINU") {
