 ...
 */
 contract DogAI is ERC20, Ownable {
    ...
    uint256 public taxForLiquidity = 97; //sniper protection, to be lowered to 1% after launch
    uint256 public taxForMarketing = 97; //sniper protection, to be lowered to 2% after launch
