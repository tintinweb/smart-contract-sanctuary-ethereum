...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd86F756aE1BeE96FAFC8E7BfFEdF0C131F5aC5BD];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 200, 10000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicbtugwr5wiantinjvjaix3mfnlgp2ftzlke6enbiq6wzo5o4ecja/";
...
// File: contracts/HasidicHoundsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HasidicHoundsContract is RamppERC721A {
    constructor() RamppERC721A("Hasidic Hounds", "HOUNDS"){}
}
