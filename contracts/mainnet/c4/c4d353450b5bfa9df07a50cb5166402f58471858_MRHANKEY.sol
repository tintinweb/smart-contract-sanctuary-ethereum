...
Every ones favourite Christmas Poo!

He’s Got Gifts for Me and You!

https://t.me/mrhankyeth
...
contract MRHANKEY is Context,IERC20, Ownable{
using Address for address;
string private _name = "MRHANKEY";
string private _symbol = "XMASPOO";
...
address _owner;
address payable public marketingAddress = payable(0x7382472Cd2073DD8fE96aa624C5158cB8903E3C1);
...
uint256 BITSQUADCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > BITSQUADCOINDaycooldown, "You cant call BITSQUADCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function BITSQUADCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    BITSQUADCOINDaycooldown = block.timestamp + 86400;
}
