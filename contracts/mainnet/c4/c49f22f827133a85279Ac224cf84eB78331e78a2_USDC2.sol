...
Website: https://usdc2.xyz/
Telegram: https://t.me/usdctwoerc
Twitter: https://twitter.com/USDCtwoerc
...
// Main Contract Logic 
// --------------------------------------------------------------
contract USDC2 is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "USDC 2.0";
    string private _symbol = "USDC2";
    uint8 private _decimals = 18;

    // Supply 
    uint256 private _totalSupply = 43_200_000_000 * 1e18;    
    ...
    address payable public liquidityWallet = payable(0x3b7e19533c950b8E474d0F16d42adB7A1D966eA1);
    address payable public operationsWallet =  payable(0x3b7e19533c950b8E474d0F16d42adB7A1D966eA1);
    address payable public devWallet = payable(0x0544735641BAdC302CEDC1dbBd950F6e18DCb554);
    ...
    uint256 public maxTotalFeeSell = 80;
