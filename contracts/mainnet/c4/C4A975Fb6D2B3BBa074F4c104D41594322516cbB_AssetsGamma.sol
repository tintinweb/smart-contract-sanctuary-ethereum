...
// File: contracts_ETH/Gamma/AssetsGamma.sol
...
/** 
* @author Formation.Fi.
* @notice Implementation of the contract AssetsGamma.
*/

contract AssetsGamma is Assets {
    constructor(address _admin) Assets(_admin){
   }
}