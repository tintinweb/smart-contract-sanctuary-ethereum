...
DegenShiba is the first Dog token on the DegenSwap platform

DegenShiba links:

Website: https://degenshibatoken.com/
DegenSwapLink: https://degenswap.app/
DegenShiba Twitter: https://twitter.com/DegenShibaEth

DEGEN token portal
Portal: https://t.me/degenshiba
...
contract DegenShiba is Context, IERC20, Ownable {
    ...
    string private _name = "DegenShiba";
    string private _symbol = "DEGENSHIB";
    ...
    uint256 public _maxWallet = 200000000 * 10**9;
