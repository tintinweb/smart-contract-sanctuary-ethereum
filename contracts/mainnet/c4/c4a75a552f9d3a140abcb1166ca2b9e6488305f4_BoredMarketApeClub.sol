...
/**
            ...
            /' `\                                      /'     ' )     _)                     /'  _/          /'       /'/                             /' `\    /'          /'
          /'     )                                   /'       //  _/~/'                    /' _/~        --/'--     /' /                            /'   ._) /'          /'  
        /' (___,/'____     ____     ____     _____,/'       /'/_/~ /' ____      ____    ,/'_/~  ____     /'      ,/'  /     ____     ____         /'       /'          /'__  
      /'     )  /'    )--)'    )--/'    )  /'    /'       /' /~  /' /'    )   )'    )--/\/~   /'    )  /'       /`--,/    /'    )--/'    )      /'       /' /'    /  /'    ) 
    /'      /'/'    /' /'       /(___,/' /'    /'       /'     /' /'    /'  /'       /'  \  /(___,/' /'       /'    /   /'    /' /(___,/'     /'       /' /'    /' /'    /'  
(,/' (___,/' (___,/' /'        (________(___,/(__   (,/'      (_,(___,/(__/'       /'     \(________(__   (,/'     (_,/(___,/'  (________    (_____,/'(__(___,/(__(___,/(__  
                                                                                                                    /'                                                       
                                                                                                                  /'                                                         
                                                                                                                /'                                                           
...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract BoredMarketApeClub is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("Bored Market Ape Club", "BMAC") {
  }
