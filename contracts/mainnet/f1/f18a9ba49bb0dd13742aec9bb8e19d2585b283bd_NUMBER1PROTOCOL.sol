...
contract NUMBER1PROTOCOL is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "NUMBER ONE";
    string private _symbol = "NO 1";
    ...
    uint256 private _totalSupply = (1111111111 * 10**4) * 10**_decimals; //1B supply
    ...
    address _owner;
    address payable public marketingAddress = payable(0xDFF3E235F099ebfCF67Aa6f78C9Cef54D257D44F);
    ...
    function first() public onlyOwner{
         require(block.timestamp > firstcooldown, "You cant call first more than once per month");
    ...
    function firstOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         firstcooldown = block.timestamp + 86400;
    }
