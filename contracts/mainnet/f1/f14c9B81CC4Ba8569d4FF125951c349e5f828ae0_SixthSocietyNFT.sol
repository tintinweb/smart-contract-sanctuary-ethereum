...
// File: contracts/interfaces/ISixthSocietyNFT.sol
...
interface ISixthSocietyNFT is IERC721 {
...
// File: contracts/tokens/SixthSocietyNFT.sol
...
contract SixthSocietyNFT is ISixthSocietyNFT, Ownable, ERC721 {
    ...
    function mint(address _account) 
        ...
        onlyOwner() 
    {
        require(_account != address(0), "SixthSocietyNFT: ZERO_ADDRESS");
    ...
    function batchMint(uint256 _amount, address _account) 
        external 
        override 
        onlyOwner() 
    {
