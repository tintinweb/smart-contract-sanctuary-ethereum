...
/**
TAMADOGE 2.0 $TAMATWO

Introducing TAMA 2.0 ($TAMATWO) a deflationary token on the Ethereum blockchain with great tokenomics!

Join our #$TAMATWO Movement!
...
contract TAMA is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //UNISWAP
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TAMADOGE 2.0";
    string constant _symbol = "$TAMATWO";
