...
// File: contracts/PixelMories.sol
...
contract PixelMories is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("PixelMories", "{PixelMories}") {
  ...
  function reserve(uint numberOfTokens, address user)
    public
    onlyOwner
  {
    require(
