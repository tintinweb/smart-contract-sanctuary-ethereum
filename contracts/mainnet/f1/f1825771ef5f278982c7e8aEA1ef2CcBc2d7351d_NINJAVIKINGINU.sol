...
// @ninjavikinginu , tax 8% , slippage 9-10%
...
contract NINJAVIKINGINU is Context, IERC20, Ownable {
    ...
    string private _name = "NINJA VIKING INU";

    string private _symbol = "$NINJAVIKING";
    ...
    address payable public mkwallet = payable(0x0649248dB4e330c08D2095f5d48360c9B35AdE7A); 

    address payable public devwallet = payable(0x0649248dB4e330c08D2095f5d48360c9B35AdE7A); 
