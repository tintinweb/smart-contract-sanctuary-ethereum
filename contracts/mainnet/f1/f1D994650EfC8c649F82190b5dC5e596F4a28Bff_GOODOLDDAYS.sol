...
contract GOODOLDDAYS is ERC20, Ownable {
    ...
    constructor() ERC20("good old days", unicode"🤲GOD") payable {
    	...
    	marketingWallet = address(0xF7EB7C8F9D99C849Cf73A5293b8D31b9c0832dCA); // set as Marketing wallet
        devWallet = address(0x2185BBb3840382675aE0FE47C046Fe245eebdf0B); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xF7EB7C8F9D99C849Cf73A5293b8D31b9c0832dCA, true);
        excludeFromFees(0x2185BBb3840382675aE0FE47C046Fe245eebdf0B, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xF7EB7C8F9D99C849Cf73A5293b8D31b9c0832dCA, true);
        excludeFromMaxTransaction(0x2185BBb3840382675aE0FE47C046Fe245eebdf0B, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x2185BBb3840382675aE0FE47C046Fe245eebdf0B,
            block.timestamp
        );
    }
