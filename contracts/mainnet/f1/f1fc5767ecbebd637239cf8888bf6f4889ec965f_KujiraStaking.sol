...
/// @title KUJI Staking Contract
/// @author KUJI
/// @notice The contract is used to manage staking Shitai tokens.
contract KujiraStaking {
    using SafeMath for uint256;
    IERC20 public KujiraToken;
    ...
    function stake(uint256 amount, uint256 planIndex) public {
        ...
        KujiraToken.transferFrom(msg.sender, address(this), amount);
    ...
    function withdraw(uint256 index) public {
        ...
        KujiraToken.transfer(msg.sender, userStakeInfo.amount);
        KujiraToken.transferFrom(owner, msg.sender, remaingReward);
