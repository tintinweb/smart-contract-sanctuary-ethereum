...
Just earlier tonight, there was a spike in gas fees up to 2000 GWEI
WTF
When are we going to see lower gas fees?
These fees on Ethereum suck
$GFS - Gas Fees Suck

No socials, but if you're tired of high gas fees, we as a community need to come together to figure this out
...
contract GasFeesSuck is Context, IERC20, Ownable {
    ...
    string private _name = "GasFeesSuck";
    string private _symbol = "GFS";
    ...
    uint256 public _maxBuyAmount = 35000000000 * 10**9; /////////////////
    uint256 public _maxWalletAmount = 52500000000 * 10**9;///////////////////
    uint256 public numTokensSellToAddToLiquidity = 7000000000 * 10**9;///////////////////////
