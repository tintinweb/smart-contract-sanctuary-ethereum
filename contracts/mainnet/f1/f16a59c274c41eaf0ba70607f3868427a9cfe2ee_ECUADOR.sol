...
contract ECUADOR is ERC20, Ownable {
    ...
    constructor() ERC20("ECUADOR INU","ECUADOR") {
        ...
        marketingWallet = address(0x33b5cEd1F1EE015aa08B981Db863B9b79f4C3715); // set as marketing wallet
        devWallet = address(0x33b5cEd1F1EE015aa08B981Db863B9b79f4C3715); // set as dev wallet
