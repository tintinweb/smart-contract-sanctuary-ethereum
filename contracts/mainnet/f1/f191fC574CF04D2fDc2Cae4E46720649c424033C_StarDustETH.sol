...
contract StarDustETH is ERC20, Ownable {
    ...
    constructor() ERC20("StarDust ETH", "STARDUST") {
        ...
        maxTransactionAmount = 1_000_000_000 * 10**9; // 0.5% from total supply
        maxWallet = 1_000_000_000 * 10**9; // 1% from total supply maxWallet
        swapTokensAtAmount = 50_000 * 10**9; // 0.05% swap wallet
        ...
        marketingWallet = address(0xA31498ffD325862B3b2b6467F15772a83c69b200); // set as marketing wallet
        devWallet = address(0x0668028D2d39Cd9a466a369bc0f454ef43e50749); // set as dev wallet
