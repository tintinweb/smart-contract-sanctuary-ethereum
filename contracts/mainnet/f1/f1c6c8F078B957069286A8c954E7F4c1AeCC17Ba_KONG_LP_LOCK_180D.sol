...
// This lock will enable the $KONG developer to withdraw ONLY ETH fees, not $KONG fees, and lock the liquidity for the next 6 months
// The V3 fees will be used to buyback & burn $KONG
 ...
 */
contract KONG_LP_LOCK_180D {
    address public kongdev;
    address public nftContract;
    uint256 public lockUpEndTime;
    bool public isNFTLocked;
    bool public isWithdrawalTriggered;

    modifier onlykongdev() {
        require(msg.sender == kongdev, "Only kongdev can call this function");
        _;
    }
    ...
    function lockNFT(uint256 tokenId) external onlykongdev {
    ...
    function triggerWithdrawal() external onlykongdev {
    ...
    function cancelWithdrawalTrigger() external onlykongdev {
        require(isNFTLocked, "NFT is not locked");
    ...
    function withdrawNFT(uint256 tokenId) external onlykongdev {
        require(isNFTLocked, "NFT is not locked");
        require(lockUpEndTime != 0, "Withdrawal is not triggered");
    ...
    function changeOwner(address newOwner) external onlykongdev {
