    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeibrypmn7h7gadaew5piby4rsezus43rktd4wfuerjhn4n3xk55gqm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/MF7lfwzvISCX64YX6xT6/contract-metadata";
  }
...
// File: contracts/AbstractionByMcLeanContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AbstractionByMcLeanContract is RamppERC721A {
    constructor() RamppERC721A("Abstraction By McLean", "ABM"){}
}
