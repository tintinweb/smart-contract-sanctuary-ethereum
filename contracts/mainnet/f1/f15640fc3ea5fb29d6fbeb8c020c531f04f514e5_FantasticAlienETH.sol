...
// File: contracts/Fantastic_Alien_ETH.sol
...
contract FantasticAlienETH is ERC721A, Ownable, ReentrancyGuard {
  ...
  ) ERC721A("FantasticAlienETH", "FAETH") {
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(!paused, "Oops contract is paused");
    uint256 supply = totalSupply();
    require(_numberMinted(_msgSender()) + tokens <= MaxperWalletFree, "Max NFT Per Wallet exceeded");
    require(tokens > 0, "Need to mint at least 1 NFT");
    require(tokens <= MaxperWalletFree, "Max mint per Tx exceeded");
    require(supply + tokens <= FreeSupply, "Whitelist MaxSupply exceeded");
