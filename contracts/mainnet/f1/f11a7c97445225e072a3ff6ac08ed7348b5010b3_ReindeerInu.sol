...
//                     '-' '-'       '-'    `-`           '-'   `-`
// REINDEER INU
// Telegram: https://t.me/reindeer_inu_chat
...
contract ReindeerInu is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "REINDEER INU";
    ...
    address payable private _operationsAddress =
        payable(0xa5fDB5d7b6eEd2DEEAF188EF798b96D6dba3a51D);
