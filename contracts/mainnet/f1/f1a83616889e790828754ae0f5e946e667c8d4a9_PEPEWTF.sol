...
contract PEPEWTF is ERC721A {

    address public owner;

    uint256 public maxSupply = 599;
    ...
    constructor() ERC721A("PEPE.WTF", "PEPE") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmYRjEEspJpGmptunoBecQkyJEquPcFJCWpB3djycs8rLz/", _toString(tokenId), ".json"));
    }
