...
contract RELIGION is Context, IERC20, Ownable {
    ...
    string private _name = "RELIGION DAO";
    string private _symbol = "RELIGION";
    ...
    address payable public marketingWallet = payable(0x287203dED0f2C18f0E7c777b52C2C8240aB0Bf3e);
