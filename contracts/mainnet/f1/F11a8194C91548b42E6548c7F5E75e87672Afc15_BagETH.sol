...
contract BagETH is IERC20, Ownable {
    ...
    uint256 private constant _totalSupply = 200_000_000_000 * 10 ** _decimals; //Token Decimals
    ...
    constructor() {
        ...
        maxTxnLimit = 2000000000 * 10 ** 18;
        maxHoldLimit = 6000000000 * 10 ** 18;
        router = IUniRouter(_router);
        ...
        isRewardExempt[
            address(0xEa6F12D7E1F1E49258467E4C3DF4a65979bAf436)
        ] = true;
        isRewardExempt[address(this)] = true;

        isFeeExempt[owner()] = true;
        isFeeExempt[address(0xEa6F12D7E1F1E49258467E4C3DF4a65979bAf436)] = true;
