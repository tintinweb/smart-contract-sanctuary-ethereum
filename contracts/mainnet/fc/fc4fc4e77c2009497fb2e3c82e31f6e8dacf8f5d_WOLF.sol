...
Moon wolf is is the biggest wolf  who appears on the first full moon of the month. 
Every full moon has a special magic. 
We chose Moon Wolf as our protocol’s mascot because it represents strength and power.

https://www.moonwolf.info/

https://twitter.com/MoonWolfErc

https://t.me/MoonWolfErc
...
contract WOLF is ERC20, Ownable {
    ...
    constructor() ERC20("Moon Wolf", "WOLF") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xFacED63cf03c87b454C92B052D8306fe28900618); // set as Marketing wallet
        DevWallet = address(0xFacED63cf03c87b454C92B052D8306fe28900618); // set as dev wallet
