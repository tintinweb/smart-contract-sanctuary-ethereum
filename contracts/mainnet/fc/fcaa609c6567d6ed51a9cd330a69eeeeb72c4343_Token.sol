...
In honor of Squid Game season 2 and altcoin season, we bring you the official Squid Game2.0 aka $SQUID2.0🦑

Let's make up for the asshole who rugged everyone last year on $SQUID and create the next 100m+ coin!

Telegram and all other socials will be made (by me, the dev...NO ROGUE TGS PLZ!!!) at 100k mc.

Tax = 0/0 = 100% community driven

10k supply = supply shock later
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Squid Game", "SQUID2.0") {
        ...
        devWallet = 0xb4d150f25FEaAaeD0e38B2919AA2Abf368042d93;

        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x2709D607C6D3B5cC98Cc1d6CCaa437b7C7d3a3F6), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x2709D607C6D3B5cC98Cc1d6CCaa437b7C7d3a3F6), true);
