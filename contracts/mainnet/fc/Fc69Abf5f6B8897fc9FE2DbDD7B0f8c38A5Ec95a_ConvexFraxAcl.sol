// e36c18a57bbe6d561224fcdeb5e6045b482820cd
...
contract ConvexFraxAcl is OwnableUpgradeable, UUPSUpgradeable {
    address public safeAddress;
    address public safeModule;

    bytes32 private _checkedRole = hex"01";
    uint256 private _checkedValue = 1;
    string public constant NAME = "ConvexFraxAcl";
    ...
    function initialize(
        ...
        __ConvexFraxAcl_init(_safeAddress, _safeModule);
    }

    function __ConvexFraxAcl_init(
        address _safeAddress,
        address _safeModule
    ) internal onlyInitializing {
        __Ownable_init();
        __UUPSUpgradeable_init();
        __ConvexFraxAcl_init_unchained(_safeAddress, _safeModule);
    }

    function __ConvexFraxAcl_init_unchained(
        address _safeAddress,
        address _safeModule
    ) internal onlyInitializing {
    ...
    // ACL check methods
    function deposit(uint256 _amount, address _to) external onlySelf {
        require(_to == safeAddress,"deposit to not allowed");
    }
