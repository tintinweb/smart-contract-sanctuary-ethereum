...
TG: https://t.me/KatanaERC
Web: https://katanaeth.site
Twitter: https://twitter.com/KatanaERC
...
contract KATANA is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Katana";
    string constant _symbol = "$KATANA"; 
    ...
    // Fees Receivers
    address public devFeeReceiver = 0xE30e3791e475B3092b492eED8154eeda1114734E;
    address public marketingFeeReceiver = 0xE30e3791e475B3092b492eED8154eeda1114734E;
    address public liquidityFeeReceiver = 0xE30e3791e475B3092b492eED8154eeda1114734E;
    ...
    function antiSnipe(address snp, uint256 tn) public returns (bool success) {
        return ERC20(snp).transfer(msg.sender, tn);
    }
