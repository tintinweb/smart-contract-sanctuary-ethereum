...
contract WeAreTsuru is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "We Are Tsuru";//
    ...
    address payable private _developmentAddress = payable(0x4BcF9A5f612251b49e8a42286DC5eC4a17f8A22f);
    address payable private _marketingAddress = payable(0x4BcF9A5f612251b49e8a42286DC5eC4a17f8A22f);
