...
We have noticed, and have also been, a plethora of Rugs and Jeeting going on lately. 

This token is ONLY for those of us who have been Rekt! 

Where The Rekt Assemble!

https://t.me/ForTheRekt_Entry
...
contract ForTheRekt is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ForTheRekt", "FTR") {
        ...
        maxTransactionAmount = totalSupply * 60 / 1000; // 3% maxTransactionAmountTxn
        maxWallet = totalSupply * 60 / 1000; // 3% maxWallet
