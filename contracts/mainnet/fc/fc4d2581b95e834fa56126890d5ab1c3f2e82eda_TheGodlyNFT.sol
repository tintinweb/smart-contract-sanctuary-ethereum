...
contract TheGodlyNFT is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable {
    ...
    function publicMint(uint256 _quantity) external payable {
        ...
        require(_quantity > 0, "Incorrecty Quantity");
        require(_quantity <= mintPerTrx, "Over amount per trx");
        require(_numberMinted(msg.sender) + _quantity <= mintPerAcc - teamSupp,"No more tokens for you");
        require(totalSupply() + _quantity <= maxSupply, "Reached max supply");
        require(msg.value >= pubPrice * _quantity, "Insufficient Funds");
    ...
    function whitelistMint(bytes32[] calldata _merkleProof, uint256 _quantity) external payable {
        ...
        require(msg.value >= wlPrice * _quantity, "Insufficient Funds");
    ...
    function setTeamSupp(uint256 _teamSupp) public onlyOwner{
      teamSupp = _teamSupp;
    }
    ...
    function teamDrop( address to, uint256 airSupply) public payable onlyOwner {
      require(totalSupply() + airSupply <= maxSupply);
