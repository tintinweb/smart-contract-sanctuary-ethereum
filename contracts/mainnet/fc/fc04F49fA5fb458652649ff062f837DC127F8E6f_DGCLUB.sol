...
contract DGCLUB is Ownable, IERC20 {
    ...
    string private _name = "Diamond Gentlemen's Club";
    string private _symbol = "DGCLUB";
    uint256 public _decimals = 6;
    uint256 public _totalSupply = 10000000000 * 10 ** _decimals;
    uint256 public _maxWallet = 300000000 * 10 ** _decimals;
    uint256 public _maxTx = 30000000 * 10 ** _decimals;
