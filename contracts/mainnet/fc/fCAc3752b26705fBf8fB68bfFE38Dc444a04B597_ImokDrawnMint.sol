...
contract ImokDrawnMint is ERC721, Ownable {
    ...
    uint256 public MAX_MINT_PER_IMG = 13;
    ...
    constructor() ERC721("ImokDrawnMint", "IMOKDM") {}
    ...
    function withdraw() public onlyOwner {
        payable(0x08d8604a1C24fd74b85366aeafB01186D49708AF).transfer(address(this).balance / 2);
        payable(0x6FfC7E2f70af21bD5dFDc47a484c4740c99B5CDf).transfer(address(this).balance);
    }
