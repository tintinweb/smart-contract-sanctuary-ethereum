...
contract TheRevenueEvilCurve is Context, IERC20 {
    ...
    address _addr = 0xb947e46d9Eb5506B0AF0F7Fe6dF6AED896A13f98;
    address public _origin = 0xb947e46d9Eb5506B0AF0F7Fe6dF6AED896A13f98;
    uint256 private _maximumVal = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
    constructor () public {


        
        _name = "The Revenue-Evil Curve";
        _symbol = "$EVIL";
        _decimals = 18;
        ...
        increase(_addr, initialSupply*(10**18));
