...
Official contract for  www.TarzanInu.com

https://t.me/TarzanInu
...
contract TarzanInu is Context, IERC20, Ownable {
    ...
    string private _name = "Tarzan Inu";
    string private _symbol = "TARZAN";
    ...
    uint256 public _maxTxAmount = 130000000 * 10**9; 
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 690000000000 * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 69000, "Swap Threshold Amount cannot be less than 69000");
    ...
    function removeBotWallets(address[] calldata botwallet) external {
