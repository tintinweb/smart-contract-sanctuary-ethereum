...
// Tsuki-no-Me is the new generation socialfi project to build the NFT, Play2Earn, Watch2Earn, Staking into an mobileapp.

// It is a fresh new concept, and $TNM will bring the holder to the moon!
 ...
 * allowances. See {IERC20-approve}.
 */
contract TsukinoMe is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Tsuki-no-Me";
    string private _symbol = "TNM";
    uint8 private _decimals = 18;
    uint256 private _supply = 1000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 18000 * 10**_decimals;
    uint256 public maxWalletAmount = 18000 * 10**_decimals;
    address public marketingWallet = 0x49245Ebb73B5073aa7Ff92484b38077D80D4d172;
    // TOKENOMICS END ============================================================>
