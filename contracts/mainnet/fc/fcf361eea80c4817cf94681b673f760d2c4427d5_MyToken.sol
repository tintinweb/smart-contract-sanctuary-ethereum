...
contract MyToken is ERC721A, Ownable {
    uint8 MAX_MINT_PER_TX = 20;
    
    // reveal config
    bool public revealed = false;
    string public baseURI = "ipfs://QmNXqGmS3Spi78h8v29eDGBnSkkitFM9pSNxvUSdEU86U4/";

    bool public isMintEnabled = false;
    uint256 public mintPrice = 0.006 ether;
    uint256 public maxSupply = 3000;

    // wallet address we want to split withdrawals with
    address public vaultAddress = 0xCc0eCD808Ce4fEd81f0552b3889656B28aa2BAe9;

    constructor() ERC721A("Pixel Aku", "PXAKU") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(quantity <= MAX_MINT_PER_TX, "Cannot mint more than max mint per transaction");
        require(totalSupply() + quantity <= maxSupply, "Not enough tokens left");
    ...
    function withdraw() external onlyOwner {
        ...
        payable(vaultAddress).transfer(split);
    }
