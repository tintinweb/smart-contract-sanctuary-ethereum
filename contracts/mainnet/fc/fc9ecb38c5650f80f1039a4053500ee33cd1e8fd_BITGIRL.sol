...
contract BITGIRL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bitgirl Inu", "BITGIRL") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x585D42c35cD39f8E0Fd7D46dA4C08621Ecc9E8CA); // set as Marketing wallet
        DevWallet = address(0x585D42c35cD39f8E0Fd7D46dA4C08621Ecc9E8CA); // set as dev wallet
