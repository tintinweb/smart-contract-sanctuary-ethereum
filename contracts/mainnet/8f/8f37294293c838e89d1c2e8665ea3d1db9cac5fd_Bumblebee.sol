...
contract Bumblebee is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bumblebee";
    string private constant _symbol = "Bumblebee";
    ...
    constructor () {
        _feeAddrWallet = payable(0x47a7B578ce3a75c1A28467890a54be8e0155c50B);
