...
NO AI JUST MEME.
$MEME. 
With the hope of bringing it back to life $MEME coins.
*/
...
contract MEME is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 100_000_000_000 * 10e18;
    uint256 public maxTxAmount = 100_000_000 * 10**18;
    uint256 public maxWalletAmount = 2_000_000 * 10**18;
    
    address public marketingWallet = 0x9c4F2161Eb834BD54F490DaA28B145BAa850afD1;
    address public devWallet = 0x9c4F2161Eb834BD54F490DaA28B145BAa850afD1;
    ...
    constructor() ERC20("NO AI JUST MEME", "MEME") {
