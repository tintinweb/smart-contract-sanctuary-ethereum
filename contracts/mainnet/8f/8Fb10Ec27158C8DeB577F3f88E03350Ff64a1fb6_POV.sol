...
contract POV is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof Of Visions";
    ...
    address payable private _developmentAddress = payable(0x3A2c26713C90db55d7551AE66B6ECAF89C4CD8A2);
    address payable private _marketingAddress = payable(0x3A2c26713C90db55d7551AE66B6ECAF89C4CD8A2);
    ...
    function SetFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(redisFeeOnSell + taxFeeOnSell <= 25, "Tax on sell can't be more than 10");
