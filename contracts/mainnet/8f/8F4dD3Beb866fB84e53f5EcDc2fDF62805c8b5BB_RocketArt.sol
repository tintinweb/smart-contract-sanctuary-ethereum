...
contract RocketArt is ERC20, Ownable {  

    using SafeMath for uint256; 

    string[] public rocketUUIDs; 
    ...
    uint256 public lpBurnFrequency = 4000 seconds; 
   ...
   // could be subject to a maximum transfer amount
    ...
    constructor() ERC20("RocketArt", "RKT") {  
        ...
        marketingWallet = address(0x431Cb03E3Fa0Cc22E1f0438654efD61d0c1D6177); 
   ...
   // remove limits after token is stable
    function addRocketID(string memory uuid) external onlyOwner returns (bool) {  
        rocketUUIDs.push(uuid);
        return true; 
    }          
   ...
   // change the minimum amount of tokens to sell from fees
    ...
    function setMaxWalletAmount(uint256 _val) external onlyOwner {  
        require(_val >= ((totalSupply() * 30) / 1000) / 1e18, "Cannot set maxWallet lower than 3.0%"); 
        maxWallet = _val * (10**18); 
    }            
    function setMaxTxAmount(uint256 _val) external onlyOwner {  
        require(_val >= ((totalSupply() * 30) / 1000) / 1e18, "Cannot set maxTransactionAmount lower than 3.0%"); 
