...
contract Braunkohle is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 670;
    uint256 public MAX_FREE = 390;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "Braunkohle";
    string private constant _symbol = "BRAUNKOHLE";
