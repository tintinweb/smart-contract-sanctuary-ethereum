...
contract MurraysBarrel is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmRka4377b2gZFgQNKnWfLRDhfbZbj3bRcAd7ZycTTRjKB/hidden.json";
  string  public  AGING_RED = "180 minutes";
  string  public  AGING_WHITE = "90 minutes";
  ...
  ) ERC721A("Murray's Barrel", "BARREL") {
