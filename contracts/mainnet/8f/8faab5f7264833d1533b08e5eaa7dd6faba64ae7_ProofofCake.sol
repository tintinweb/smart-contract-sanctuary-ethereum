...
contract ProofofCake is ERC20, Auth {
    ...
    string constant _name = "ProofofCake";
...
//    mapping (address => bool) public isBlacklisted;
   ...
   // block number of opened trading
    ...
    uint256 public sellMultiplier  = 1500;
    ...
    constructor () Auth(msg.sender) {
        //router = IDEXRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Uni on ETH
        router = IDEXRouter(0xEfF92A263d31888d860bD50809A8D171709b7b1c); //PCS on ETH
        WETH = router.WETH();
        ...
        marketingFeeReceiver = 0x595559Ce713f21a440B5BeEA7aB3913aD3B7b1f1;
        buybackFeeReceiver = 0x595559Ce713f21a440B5BeEA7aB3913aD3B7b1f1;
        teamFeeReceiver = 0x595559Ce713f21a440B5BeEA7aB3913aD3B7b1f1;
