...
Inu Inu Inu Inu - $IIIINU 
https://inuinuinuinu.co 
https://twitter.com/inuinuinuinu_erc20
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x8EdEb26e1963256FdBA833E80F8f3464Bc795a8a] = _marketingwallet;
    }
...
contract TokenMintERC20Token is ERC20, Ownable {
    ...
    constructor() ERC20("Inu Inu Inu Inu", "IIIINU") {
        ...
        uint256 totalSupply = 10 * 1e8 * 1e18;        

        maxTransactionAmount = totalSupply * 1000 / 1000; // 1% maxTransactionAmountTxn
        maxWallet = totalSupply * 1000 / 1000; // 3% maxWallet
        ...
        excludeFromFees(address(0x8EdEb26e1963256FdBA833E80F8f3464Bc795a8a), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x8EdEb26e1963256FdBA833E80F8f3464Bc795a8a), true);
    ...
    function updateBuyFees(uint256 _feereceiverFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
