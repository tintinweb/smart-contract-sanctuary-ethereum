...
contract Dotexe is IERC721A { 
    ...
    string private constant _name = "Dotexe";
    string private constant _symbol = "DOTEXE";
    string private _baseURI = "QmWvxsGorASLRAptPkyinTmz4P8zJ5eJtMfTCx98XCpbzC";
