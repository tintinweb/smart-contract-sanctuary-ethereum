...
contract CHEAP is ERC20, Ownable {
    ...
    constructor() ERC20("Very Cheap Token", "CHEAP") {
        ...
        maxWallet = 50000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x89Da15023Ddf4A0B584c4469d60508502440eD49); // set as charity wallet
        marketingWallet = address(0x89Da15023Ddf4A0B584c4469d60508502440eD49); // set as marketing wallet
        devWallet = address(0x89Da15023Ddf4A0B584c4469d60508502440eD49); // set as dev wallet
