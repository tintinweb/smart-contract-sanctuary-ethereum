...
contract MansBestfriend is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Mans BestFriend";
    string constant _symbol = "Doggo";
    ...
    address payable public liquidityFeeReceiver = payable(0x42f5cb79757C6D35D3e63beeb391DCC98055824D);
    address payable public marketingFeeReceiver = payable(0x42f5cb79757C6D35D3e63beeb391DCC98055824D);
