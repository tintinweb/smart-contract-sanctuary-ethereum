// SPDX-License-Identifier: MIT
  /**
Welcome to Drink&Earn ! 🍸💸

If you hold 0.2% of supply you will be able to Drink&Earn !

How? 
 - You can do shopping in any supermarket for a maximum value of 100$ a day 
 - Write $DrinkEarn on your receipt and send it 
 - After we confirm we will send you 50% back

If you hold more than 0.2% you will be able to do it multiple times a day and receive a bigger discount
**/
  ...
  contract DRINKEARN is Context, IERC20, Ownable {
      ...
      string private constant _name = unicode" Drink & Earn";
      string private constant _symbol = unicode"DRINKEARN";
