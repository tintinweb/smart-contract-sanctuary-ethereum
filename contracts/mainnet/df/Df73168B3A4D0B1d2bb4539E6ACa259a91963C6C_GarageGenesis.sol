...
contract GarageGenesis is ERC721A, Ownable {
  ...
  constructor(uint256 cap, uint256 supply, uint256 price) ERC721A("GarageGenesis", "GARAGE") {
  ...
  function mint(uint256 num) external payable {
    ...
    uint256 price = msg.sender == owner() ? 0 : mintPrice;
