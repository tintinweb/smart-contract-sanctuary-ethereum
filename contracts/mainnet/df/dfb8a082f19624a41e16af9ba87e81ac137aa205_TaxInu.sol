...
/**
        ...
        Fuck high taxes. Only take what's needed. $TINU.
        Tax Inu is born to show apes, that all we need is 3% to catapult a project to the moon!

        Taxes splitted into 2% LP, 1% Marketing. No Dev Tax, No Dev Wallet, No Team Wallets!
        ...
        Website: Coming soon
        Twitter: https://twitter.com/TaxInuETH
        Telegram: https://t.me/taxinuportal
...
contract TaxInu is ERC20, Ownable {
    using SafeMath for uint256;
