...
contract TYRANO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tyrano";
    string private constant _symbol = "TYRANO";
    ...
    address payable private _developmentAddress = payable(0x946E18fEB12B3A643ff89E138C735480A2Cb5aa4); 
    address payable private _marketingAddress = payable(0xE855Db688541098B102B787789a65743bC02A5C4);
