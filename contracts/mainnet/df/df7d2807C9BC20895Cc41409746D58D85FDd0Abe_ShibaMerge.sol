...
Buy, hold and lets shill like a community. 

Full transparency.

100% supply to liquidity. Locked for 2 weeks. Extended if needed. Contract will be renounced.
...
contract ShibaMerge is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Merge", "SMerge") {
        ...
        devWallet = address(0x7871972675aA0C8e180c3765DaBF1fFEFE078B35); // set as dev wallet
