 ...
 *          DISTRIBUTOR______________________________________________________________________________
 *
 */
...
/**
 * @title Open3 x Dreaming in the Wilderness Distributor Smart Contract
 */
contract DreamingInTheWildernessDistributor is Ownable, PaymentSplitter {
     ...
     * contract.
     */
    function release(IERC20 token_, address account_)
        public
        override
        onlyOwner
    {
        super.release(token_, account_);
    }
}
