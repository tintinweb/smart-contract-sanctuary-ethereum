...
contract SecretSociety is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
	...
	string public prerevealURL = "ipfs://bafybeihhlaoxfhvm5t7tyxtpa2a5w3mg3t7nltwtmk74lwb2ouz74kdbgu/prereveal.json";

    //**                          WITHDRAW WALLET                          **//
    address public withdrawAddress = 0x4592F827d0f3f26a95Be05B763907D73807bb52a;

	mapping(address => uint) private _walletMintedCount;

	constructor()
	ERC721A("Secret Society", "SECRET") {
    }
	...
	*/
    ...
    function whitelistMint(uint count, bytes32[] memory proof) public payable {
