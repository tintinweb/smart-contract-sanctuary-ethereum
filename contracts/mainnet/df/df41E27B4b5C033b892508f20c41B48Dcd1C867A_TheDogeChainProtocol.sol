...
DogeChain is the fastest growing chain across all Blockchains and yesterday with a 3x jump DogeChain has shown it’s dominance among other Alts.
DogeChain Protocol is a Defi token with 100% Liquidity burn along with 2% Redistribution

https://t.me/theDCprotocol
...
contract TheDogeChainProtocol is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The DC Protocol";////////////////
    string private constant _symbol = "TheDC";////////////////
    ...
    address payable private _developmentAddress = payable(0x5CE4d7599ddF33b239Dc278DFb86ab9e726f1Be6);////////////////////
    address payable private _marketingAddress = payable(0x5CE4d7599ddF33b239Dc278DFb86ab9e726f1Be6);/////////////////////
