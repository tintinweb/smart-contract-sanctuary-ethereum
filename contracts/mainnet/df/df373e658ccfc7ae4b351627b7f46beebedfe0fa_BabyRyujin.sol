...
/**
        Welcome to Baby Ryujin, the token which you can control.
        Baby Ryujin was founded upon many of the same tenets that
        cryptocurrency idealists gravitate to: Decentralization,
        Community, Financial Freedom.  These principles remain the
        foundation of Baby Ryujin and always will.

        電報
    Denpō: https://t.me/BabyRyujinERC

        ツイッター
    Tsuittā: https://twitter.com/babyryujinerc

        WEBサイト
    WEB saito: https://www.babyryujin.com/
*/
...
contract BabyRyujin is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _bOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "Baby Ryujin";
    string private  _symbol = "BABY RYUJIN";
