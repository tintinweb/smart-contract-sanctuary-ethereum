...
contract ANUBIS is Context,IERC20, Ownable{
    ...
    string private _name = "A HUNTERS FAITH";
    ...
    address _owner;
    address payable public marketingAddress = payable(0x1053440F11EA379AFb583de8762aA518D1FFdb43);
