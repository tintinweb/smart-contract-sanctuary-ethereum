...
contract ShibaShiba is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shiba Shiba";
    string private constant _symbol = "2xShiba";
    ...
    address payable private _developmentAddress = payable(0x0efd95Bd56756c9d3B73ECB1Ee7D432A8e3AbcED);
    address payable private _marketingAddress = payable(0x0efd95Bd56756c9d3B73ECB1Ee7D432A8e3AbcED);
