...
// hevm: flattened sources of /nix/store/n0zrh7hav4swn38ckv0y2panmrlaxy1s-geb-fsm/dapp/geb-fsm/src/FSMWrapper.sol
...
////// /nix/store/3d3msxain9q01swpn63dsh9wl2hsal24-geb-treasury-reimbursement/dapp/geb-treasury-reimbursement/src/reimbursement/NoSetupIncreasingTreasuryReimbursement.sol
/* pragma solidity 0.6.7; */

/* import "../math/GebMath.sol"; */

abstract contract StabilityFeeTreasuryLike_1 {
...
contract NoSetupIncreasingTreasuryReimbursement is GebMath {
    ...
    **/
    ...
    // SF treasury
    StabilityFeeTreasuryLike_1  public treasury;
...
////// /nix/store/n0zrh7hav4swn38ckv0y2panmrlaxy1s-geb-fsm/dapp/geb-fsm/src/FSMWrapper.sol
/* pragma solidity 0.6.7; */
    ...
    */
    function modifyParameters(bytes32 parameter, address addr) external isAuthorized {
        ...
        if (parameter == "fsm") {
          ...
          require(StabilityFeeTreasuryLike_1(addr).systemCoin() != address(0), "FSMWrapper/treasury-coin-not-set");
          treasury = StabilityFeeTreasuryLike_1(addr);
        }
