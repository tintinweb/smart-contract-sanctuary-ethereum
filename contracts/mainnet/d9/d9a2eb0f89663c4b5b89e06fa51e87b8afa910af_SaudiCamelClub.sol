...
contract SaudiCamelClub is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Saudi Camel Club";
    ...
    address payable public marketingWallet = payable(0x8DaBE6A2760d0a9D3403e93339AB50dA0eb66317);
    address payable public treasury = payable(0x8DaBE6A2760d0a9D3403e93339AB50dA0eb66317);
    ...
    uint256 private maxBuy = 3000000 * (10 ** _decimals);
