...
// Created by a group of Donkey's.

// Telegram: This is up to the community to build. The first of its kind!
...
contract Change_Here is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 497314 * 10**9;
  string private _symbol = "DP";
  string private _name = "Donkey Penis";
