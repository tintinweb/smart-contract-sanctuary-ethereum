...
contract CosmosSwap is Ownable {
    ...
    event SwapInitialized(uint256 indexed id, SwapInfo swapInfo);
    ...
    function deposit(DepositArgsAxelar calldata depositArgs) external payable {
        ...
        require(depositArgs.amount != 0, "invalid amount");
        ...
        emit SwapInitialized(id, swapInfos[id]);
    }
        ...
        onlyOperator
    {
        ...
        IERC20(info.bridgeToken).universalTransfer(
            axelarDepositor,
            info.bridgeAmount
        );
