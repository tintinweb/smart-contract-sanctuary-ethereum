...
contract DividendDistributor is IDividendDistributor {
  ...
  IBEP20 DC = IBEP20(0x7B4328c127B85369D9f82ca0503B000D09CF9180);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DC.balanceOf(address(this));
        ...
        uint256 amount = DC.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DC.transfer(shareholder, amount);
...
contract  HotDoge is IBEP20, Auth {
    using SafeMath for uint256;

    address DC = 0x7B4328c127B85369D9f82ca0503B000D09CF9180;
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "HotDoge";
    string constant _symbol = "HD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 2; // 5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x8fa5394019d4be1128a17C32b0120c568c32f8Ee; //WALLET DEV
