...
/**
    ...
    https://t.me/HarutoERC

    https://twitter.com/Erc20Haruto

    https://medium.com/@HarutoERC
...
contract Haruto is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7f310009f18a176b2fa7E7d2D8a4A36326D02C35); 
    address payable public Wallet_Team = payable(0xdaE43413DbC6459eDa39F81dD5EC1aA6Cb4059e7);
    ...
    string private constant _name = "HARUTO"; 
    string private constant _symbol = unicode"$HARUTO"; 
    ...
    constructor () {
        ...
        _owner = 0xdaE43413DbC6459eDa39F81dD5EC1aA6Cb4059e7;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7f310009f18a176b2fa7E7d2D8a4A36326D02C35); // Testnet
