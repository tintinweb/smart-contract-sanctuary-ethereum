...
// File: contracts/BabyDuckyStaking.sol
...
contract BabyDuckyStaking is IERC721Receiver, Ownable {
    using EnumerableSet for EnumerableSet.UintSet;

    address public ERC20_CONTRACT = 0xC8Cb415ae3888AD34f86561b13255CFF6E705a1A;
    address public ERC721_CONTRACT = 0x470D525Fc10F66B80AC7D1639815C1725690d717;
    uint256 public EXPIRATION = block.number + 100000000000000;

    mapping(address => EnumerableSet.UintSet) private _deposits;
    mapping(address => mapping(uint256 => uint256)) public depositBlocks;
    mapping (uint256 => uint256) public tokenRarity;
    uint256[8] public rewardRate;   
    bool public started = true;

    constructor() {
        // number of tokens Per day
        rewardRate = [5, 10, 15, 20, 30, 40, 50, 60]; 
    }
    ...
    function claimRewards(uint256[] calldata tokenIds) public {
        ...
        if (reward > 0) {
            ITOKEN(ERC20_CONTRACT).whitelist_mint(msg.sender, reward);
        }
    }
