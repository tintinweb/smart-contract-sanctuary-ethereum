...
contract Burnable is Context, ERC20 {
    ...
    function convertTokenWithTransfer(uint256 amount, string memory username) public {
       address depositAddress = 0x9C73724f89d392d0a05293E1aC5f8939d7C0a488;
...
contract wToken is WrappedToken, ERC20Capped(50000000000000000), ERC20Detailed("Wrapped LVL", "WLVL", 8) {}