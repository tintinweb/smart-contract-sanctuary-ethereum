...
contract JustOne is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Just One";
    string private constant _symbol = "JUSTONE";
    ...
    uint256 public _swapTokensAtAmount = 0.01 * 10**9;
