...
contract Olympian_Elements is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://39KS8DT2BT25D75YGT7NPNJIUEAAA1IMUJ";
    ...
    address constant internal DEV_ADDRESS = 0x5E1e4443Bfea0640112E8EfD96C79E85216C8b71;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Olympian Elements", "OPES") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 155, "Not enough free supply");
