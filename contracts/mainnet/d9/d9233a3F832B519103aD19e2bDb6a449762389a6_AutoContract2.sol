...
contract AutoContract2 is ERC20, Authorizable {
    string private TOKEN_NAME = "AutoContract2";
    string private TOKEN_SYMBOL = "ACT";

    event Minted(address owner, uint256 AutoAmt);
    event Burned(address owner, uint256 AutoAmt);
