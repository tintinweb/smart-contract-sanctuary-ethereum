...
// | | | |/ _` | | | | | | ___ \/ _` | '_ \| |/ _ \/ __|
// | |_| | (_| | | |_| | | |_/ / (_| | |_) | |  __/\__ \
//  \___/ \__, |_|\__, | \____/ \__,_|_.__/|_|\___||___/
//         __/ |   __/ |                                
//        |___/   |___/                                 
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe5a93d3d0AD3beE468F1434bF5b436351575147a];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbNsp5YrU724fmGTjYU1bhk3zZq3KvVoWtsJGyGCxYmbT/";

    bool public mintingOpen = false;
    
    uint256 public PRICE = 0.003 ether;
    
    uint256 public MAX_WALLET_MINTS = 55;
...
// File: contracts/UglyBabiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UglyBabiesContract is RamppERC721A {
    constructor() RamppERC721A("Ugly Babies", "BABIES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/DKT4xj3bcFoAVTY3yGCa/contract-metadata";
    }
}
