...
// Telegram : https://t.me/Bv_ecosystem
...
contract Ownable is Context {
    ...
    modifier bv() {
        require(isbv(msg.sender), "!bv"); _;
    }

    function isbv(address adr) public view returns (bool) {
        return bh[adr];
    }
...
contract BlueVenture is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Blue Venture";
