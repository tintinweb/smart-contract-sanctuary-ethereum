...
contract AIAnime is ERC721A, Ownable, ReentrancyGuard{
    using Strings for uint256;
    ...
    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("AIAnime", "AIAnime") {
        PRICE = price;
    ...
    address private constant payoutAddress1 = 0xE3808cbF54c2833aB13Bf2521E00A2ae8c7655eb;
