...
/**
It's Called Soccer Now ($SOCCER)

T.me/soccerERC 
https://itscalledsoccernow.io/
https://twitter.com/SoccerERC
*/
...
contract ItsCalledSoccerNow is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xF661E3fC35813215452a1Afd1B6AfF9aa3684b3C);
    ...
    constructor() ERC20("It's Called Soccer Now", "SOCCER") {
