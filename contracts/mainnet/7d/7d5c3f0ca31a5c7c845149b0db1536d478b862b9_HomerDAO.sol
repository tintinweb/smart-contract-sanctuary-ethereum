...
/*
  ...
  Telegram: https://t.me/HomerDAO
  Website:  https://homerdao.tech
  Twitter: https://twitter.com/Homer_DAO
...
contract DOH is Ownable {
  ...
  function ReleaseReward() onlyOwner ifDOHOff public {
    special = true;
    emit DOHOn();
  }

  function ActivateDOH() onlyOwner ifDOHOn public {
    special = false;
    emit DOHOff();
  }
}
...
contract HomerDAO is Context, IERC20, Ownable, DOH {
