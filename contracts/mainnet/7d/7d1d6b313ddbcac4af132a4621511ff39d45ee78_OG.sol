 ...
 * allowances. See {IERC20-approve}.
 */
contract OG is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Ore Gairu";
    string private _symbol = "ORE";
    uint8 private _decimals = 9;
    uint256 private _supply = 80000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 800 * 10**_decimals;
    uint256 public maxWalletAmount = 1600 * 10**_decimals;
    address public marketingWallet = 0xd1B4fe61e68A17f153acD5519C7E4593558E6d2e;
    // TOKENOMICS END ============================================================>
