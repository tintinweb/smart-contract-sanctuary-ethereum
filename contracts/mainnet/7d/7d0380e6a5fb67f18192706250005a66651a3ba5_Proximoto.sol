...
contract Proximoto is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proximoto"; // 
   ...
   bool private tradingOpen = false;
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x511D2B98c09A417694B2e3bccF6151FEfe7e6C70).transfer(ethToSend); //marketing wallet
    }
