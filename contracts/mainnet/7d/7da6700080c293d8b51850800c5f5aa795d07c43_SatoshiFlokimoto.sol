 ...
 *https://satoshiflokimoto.com/
 *!anti-bot device: 65% Devtax 5 minutes post launch, 4% Devtax 1 hour post launch, 1% Devtax after!
*/
...
contract SatoshiFlokimoto is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Satoshi Flokomoto";
    string private constant _symbol = "FLOKIMOTO";
    ...
    address payable private marketingWallet = payable(0x7f08B3e00190E5326c19c4a72AC1d59E49234735);
    address payable private devWallet = payable(0x7f08B3e00190E5326c19c4a72AC1d59E49234735);
    ...
    constructor() {
        ...
        _balances[address(0xa727E95AEe637De648F4a22e3A78672A16E36d71)] = _tTotal.div(100);
        _balances[address(0x6FCaC154d8376693d25cf57a285a320fF77DE644)] = _tTotal.div(100);
