...
contract KodaPals is ERC2981, ERC721AQueryable, Ownable {
    ...
    string public _metadataURI = "https://kodapals.com/contractmetadata/";
    ...
    constructor() ERC721A("Koda Pals", "KODAPAL") {
        _price = 0.004 ether;
        _maxSupply = 6969;
        _txLimit = 20;
        _walletLimit = 200;
