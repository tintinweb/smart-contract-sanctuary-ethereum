...
We will not speak until 20-11-22
https://medium.com/@behindthecurtainerc
...
contract BehindTheCurtain is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(3,1); //dev tax, liquidity tax
        setSellTax(3,1); //dev tax, liquidity tax
        setTaxWallets(0xD112233fAb2D37E207B4795862bA24Aed8f48526); 
        exclude(msg.sender);
