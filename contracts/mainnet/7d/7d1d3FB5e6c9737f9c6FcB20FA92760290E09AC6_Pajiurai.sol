...
contract Pajiurai is Context, IERC20, Ownable {
    using SafeMath for uint256;

    uint256 MAX_INT =
        115792089237316195423570985008687907853269984665640564039457584007913129639935;
    string private constant _name = "Pajiurai";
    string private constant _symbol = "PAJI";
    ...
    uint256 private wipeBlocks = 0;
    uint256 private launchedAt;
    uint256 public _maxTxAmount = 30000000000 * 10**9; // 3% MAX TX
    uint256 public _maxWalletSize = 30000000000 * 10**9; // 3% MAX WALLET
    uint256 public _swapTokensAtAmount = 1000000000 * 10**9; // 0.1% SWAPBACK
    ...
    function AntiSnipe() public onlyOwner lockTheSwap {
