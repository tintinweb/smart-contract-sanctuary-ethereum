...
/*
It begins in hell of sorrow and ends in heaven of light.
Who is GOD?
I'll give you an answer in eight minutes.
This is something new. This is a test of humanity
We will initially lock the liquidity for 24 hours, and for every 5 eth increase in liquidity, we will extend the lock for 240 hours

https://twitter.com/InfernoETH
*/
...
contract INFERNO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Divine Comedy", "INFERNO") {
