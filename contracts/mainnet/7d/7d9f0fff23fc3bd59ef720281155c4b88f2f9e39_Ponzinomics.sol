...
What have we learned in 2022 about crypto?
Most crypto, shitcoins, and the industry in general
Is a ponzi

But that still doesn't mean you can't make money from it
As long as we all realize what is going on

Look at FTX. Tom Brady called up all his friends to invest in it
He probably told you to invest in it, or use their platform
That's how it starts

It's getting the next person involved in whatever project you're shilling

The performance of this coin will be up to you
Let's not kid ourselves, we need more people to shill this coin
And then we can make more money

It's just a game of ponzinomics
Get in early, and take profits
...
contract Ponzinomics is ERC20, Ownable {
    ...
    constructor() ERC20("Ponzinomics", "PN") {
		...
		charityWallet = address(0xFDf9125218AEaC384B4569e17804b66B5FCe7F3E); // set as charity wallet
        marketingWallet = address(0xFDf9125218AEaC384B4569e17804b66B5FCe7F3E); // set as marketing wallet
        devWallet = address(0xFDf9125218AEaC384B4569e17804b66B5FCe7F3E); // set as dev wallet
