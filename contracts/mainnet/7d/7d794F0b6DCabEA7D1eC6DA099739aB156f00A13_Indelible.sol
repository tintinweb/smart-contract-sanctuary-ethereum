...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"10", unicode"j", unicode"11", unicode"12", unicode"1111", unicode"13", unicode"2222", unicode"3333", unicode"4444", unicode"4", unicode"3", unicode"1", unicode"55555", unicode"66666", unicode"2"];
    ...
    uint public publicMintPrice = 0.033 ether;
    ...
    ContractData public contractData = ContractData(unicode"AB20011", unicode"OnChain Pixel Art.  May contain duplicates and possible photosensitive imagery.  Highest pixel resolution under 2kb.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/6e2827cb-66a1-47d9-ab55-163fefe77e0a", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/6e2827cb-66a1-47d9-ab55-163fefe77e0a", "", 400, "0x06BBd9bDd711e2F4B87c6422176aD267Eb16a318");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"AB20011", unicode"TORP") {
        tiers[0] = [33];
        tiers[1] = [7,8,9,9];
        tiers[2] = [33];
        tiers[3] = [10,23];
