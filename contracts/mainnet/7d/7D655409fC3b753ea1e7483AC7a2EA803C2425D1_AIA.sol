...
/*
circle
AIAnalysis (AIA) is an AI-powered sentiment analysis tool for cryptocurrencies. 
Essentially, the tool would use natural language processing (NLP) and machine learning algorithms to analyse social media posts, news articles, and other sources of information to determine the overall sentiment towards a particular cryptocurrency.

Important Links:
Twitter: https://twitter.com/aianalysiserc
Telegram: https://t.me/AIAnalysisEth
Website: http://analysisai.org/
...
contract AIA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ARTIFICIAL INTELLIGENCE ANALYSIS";
    ...
    address payable private _developmentAddress = payable(0x77F54cd40f0EB70617C5b2bfb2a4EAc7ce8926A1); 
    address payable private _marketingAddress = payable(0x77F54cd40f0EB70617C5b2bfb2a4EAc7ce8926A1);
