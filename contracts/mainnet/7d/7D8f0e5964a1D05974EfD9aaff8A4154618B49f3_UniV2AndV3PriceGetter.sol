...
contract UniV2AndV3PriceGetter {
    ...
    address public constant FACTORYV2 = 0xBAe5dc9B19004883d0377419FeF3c2C8832d7d7B; //FactoryV2
    bytes32 public constant INITCODEHASHV2 = hex"e2200989b6f9506f3beca7e9c844741b3ad1a88ad978b6b0973e96d3ca4707aa";

    address public constant FACTORYV3 = 0x1F98431c8aD98523631AE4a59f267346ea31F984; //FactoryV3
    bytes32 public constant INITCODEHASHV3 = hex"e34f199b19b2b4f47f68442619d555527d244f78a3297ea89325f843f87b8b54";
    ...
    function getPrice(address token, uint32 secondsAgo, Protocol version) public view returns (uint256) {
    ...
    function getLPPrice(address token0, address token1, uint24 fee, uint32 secondsAgo) public view returns (uint256) {
    ...
    function pairFor(address tokenA, address tokenB, uint24 fee) internal pure returns (address pool) {
        if (tokenA > tokenB) (tokenA, tokenB) = (tokenB, tokenA);
