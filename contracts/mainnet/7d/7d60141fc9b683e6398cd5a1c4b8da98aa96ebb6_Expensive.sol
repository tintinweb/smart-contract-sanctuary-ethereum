...
/**
    accompanied by the number of rich people, the need for goods
    luxury also increases
*/
...
contract Expensive is ERC20, Ownable {
    ...
    constructor() ERC20("Expensive", "EXP") {
        ...
        maxWallet = totalSupply * 2 / 100; // 3% from total supply maxWallet
        ...
        devWallet = address(0xAFD621140636d792A8002b0a6e38Fb94Ba01D724); // set as dev wallet
