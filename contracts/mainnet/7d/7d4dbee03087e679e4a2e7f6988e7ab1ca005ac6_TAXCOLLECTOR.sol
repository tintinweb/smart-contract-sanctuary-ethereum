...
contract TAXCOLLECTOR is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TAX COLLECTOR";
    ...
    address payable public liquidityFeeReceiver = payable(0xBB39CBF9f91d0ea61B4e6E65e59c91f2404819c2);
    address payable public marketingFeeReceiver = payable(0xBB39CBF9f91d0ea61B4e6E65e59c91f2404819c2);
    ...
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        if (block.number < launchedAt + 50 && !earlyTransferAllowed[msg.sender]){
            assert(recipient != pair);
        }
