...
contract PAWSOME is ERC20, Ownable{
    ...
    uint256 public maxTxAmount = 2_000_000_000 * 10**18;
    uint256 public maxWalletAmount = 3_000_000_000 * 10**18;
    
    address public marketingWallet = 0xC237804e3272e91849E5E8024742faDD114AC5BD;
    address public devWallet = 0xC237804e3272e91849E5E8024742faDD114AC5BD;
    ...
    function findPAW(uint256 numOfDeadBlocks) external onlyOwner{
    ...
    function pawTax(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
