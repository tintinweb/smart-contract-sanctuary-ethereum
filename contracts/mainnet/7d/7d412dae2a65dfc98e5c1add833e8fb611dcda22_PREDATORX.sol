...
contract PREDATORX is Context, IERC20, Ownable {
    ...
    string private constant _name = "PREDATOR-X";
    string private constant _symbol = "PRX";
    ...
    function openTrading() external onlyOwner {
        ...
        // .5% 
        _maxTxAmount = 2000000000001 * 10**9;
        _maxWalletAmount = 4000000000001 * 10**9;
        tradingOpen = true;
