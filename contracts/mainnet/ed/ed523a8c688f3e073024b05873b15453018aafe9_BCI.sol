...
// THIS IS AN EXPERIMENT TO SEE HOW BOTS APE LAUNCHES - DO NOT APE THIS COIN
// THE LIQUIDITY ON THIS COIN WILL NOT REMAIN POST-LAUNCH, YOU HAVE BEEN WARNED
...
contract BCI is Context, IERC20, Ownable {
    ...
    string private constant _name = "BotCoin Inu";
    ...
    address payable private _developmentAddress = payable(0xCc472C4D7E9658908c886d4910B8134A8E79a578);
    address payable private _marketingAddress = payable(0xCc472C4D7E9658908c886d4910B8134A8E79a578);
    ...
    uint256 public _maxWalletSize = 5000000 * 10**9; // 1%
