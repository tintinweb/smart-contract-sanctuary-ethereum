...
contract onofft is ERC1155, Ownable, Pausable {
    using SafeMath for uint256;
    uint256 public TOKEN_ID = 0;
    uint256 public minted;
    event ReturnEvent(uint256 ID);

    constructor() ERC1155("https://metadata.onofft.io/eth/getmetadata/{id}"){  
