...
contract CHEGG is ERC20, Ownable {
    ...
    address payable _marketingWallet =
        payable(address(0xF481447d479A739E0136F4EEe08052C09db1921A)); // marketingWallet
    address payable _devWallet =
        payable(address(0xa112063652a31bDc9E755BeDE74109A44e293278)); // devWallet
    ...
    constructor() ERC20("CHEGG", "$CHEGG") {
        buyFee.marketingFee = 9;
        buyFee.liquidityFee = 1;

        totalBuyFee = 10;

        sellFee.marketingFee = 23;
