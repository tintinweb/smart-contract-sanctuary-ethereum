...
// File contracts/tokens/ERC1155/WASDArt.sol


pragma solidity ^0.8.15;


contract WASDArt is ERC1155PresetMinterPauser {
    ...
    function uri(uint256 tokenId) public view override returns (string memory) {
        require(
            ...
            "WASDArt: URI query for non-existent token"
        );
    ...
    function getOwnedTokens(
        ...
        require(fromIndex <= lastIndex, "WASDArt: invalid query range");
    ...
    function setTokenURI(uint256[] calldata tokenIds, string[] calldata uris)
        external
    {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, _msgSender()),
            "WASDArt: caller is not an admin"
        );
        require(tokenIds.length == uris.length, "WASDArt: lengths mismatch");
