...
contract Uintnumbersgame is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public AMOUNT2 = 500;
    uint256 public AMOUNT3 = 500;
    uint256 public AMOUNT4 = 500;
    ...
    string public BASE_URI="https://data.uintnumbersgame.net/metadata/";
    string public CONTRACT_URI ="https://data.uintnumbersgame.net/api/contracturl.json";
   ...
   struct Info {
    ...
    constructor() ERC721A("Uintnumbersgame", "uintnumbersgame") {
