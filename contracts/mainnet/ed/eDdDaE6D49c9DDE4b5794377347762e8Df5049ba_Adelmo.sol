...
Adelmo means strong and persistent in Spanish. Our aim is to provide strong and persistent stableswap in the market.

To know more, please check out our social media:
Medium: https://medium.com/@AdelmoProtocol
TG: https://t.me/AdelmoProtocol 
...
contract Adelmo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Adelmo Protocol";
    string private constant _symbol = unicode"ADELMO";
