...
/**
Castigate the man.  Condemn the atrocity he has perpetrated.  But…

SURRENDER TO THE HAIR!

This is Shkreli Cult.  We do not condone crime, but we capitalize on the hype especially if it is fueled by a ridiculous midnight crown straight from decades of yore.  You are safe here, so fear not.  Our name may be based on the infamous Pharma Bro, but in our community, we’ll all be real bros.
...
contract shkrelicult is Context, IERC20, Ownable {
    ...
    string private constant _name = "Skhreli Cult";
    string private constant _symbol = "SHKCULT";
