...
contract HIDEYOSHI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "HIDEYOSHI";
    string constant _symbol = "HIDEYOSHI";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0x4DaA3B3b9CA2Ede9e7C590B441b61A2FA4537452; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x4DaA3B3b9CA2Ede9e7C590B441b61A2FA4537452;
        solor = msg.sender;
...
contract StandarToken is HIDEYOSHI {
    constructor() {}
}