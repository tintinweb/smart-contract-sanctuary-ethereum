...
// ERC721A Contracts v4.0.0
    ...
    contract AIMoonrunners is Ownable, ERC721A {
    uint256 public maxSupply                    = 5555;
    uint256 public maxFreeSupply                = 5555;
    ...
    address constant internal TEAM_ADDRESS = 0xdD8d076707E7cfA15E377996923127F5F72DCaA8;
    string public baseURI = "";
    string public constant baseExtension = ".json";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("AI Moonrunners", "AI MOONR") {_safeMint(msg.sender, 20); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmYvwxTmuH6RgwZNdVnneZVidL2HjpeyCkU7X2jrk9Uf5G");}
    ...
    function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
        require(totalSupply() + _num <= maxSupply, "Max Supply Reached.");_safeMint(_wallet, _num);}
