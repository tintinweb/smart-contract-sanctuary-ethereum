...
Catch the python. if you can.

There is a Telegram group. catch if you can.

There is a Website. Catch if you can.

Catch us if you can and we will let you know what is this all about.

some thing great is about to happen.
...
contract Python is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xE7B8Bb796bCE4b4E5f2160b51C33331C79D74D98);
        _feeAddrWallet2 = payable(0xE7B8Bb796bCE4b4E5f2160b51C33331C79D74D98);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xE7B8Bb796bCE4b4E5f2160b51C33331C79D74D98), _msgSender(), _tTotal);
    }
