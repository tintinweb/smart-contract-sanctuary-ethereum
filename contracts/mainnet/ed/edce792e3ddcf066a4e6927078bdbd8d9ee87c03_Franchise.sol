...
contract Franchise is ERC721Common, ReentrancyGuard {
    using Strings for uint256;

    bool public saleActive;
    uint16 public _tokenIdTracker;
    uint16 public constant MAX_ITEMS = 1400;
    uint256 public PRICE = 0.3 ether;

    address constant w1 = 0xdf9cF289318B0078c2F33fFa55f0294F559A01AE;
    address constant w2 = 0x3ea4C2ffBD8e3a997e1140e10B280c2ED22D75C7;
    ...
    function mint(address _to) public payable 
        ...
        require(_tokenIdTracker < MAX_ITEMS, "Max limit");
