...
contract Anonglyphs is IERC721A { 
    ...
    uint256 public MAX_FREE = 290;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.002 ether;

    string private constant _name = "Anonglyphs";
    string private constant _symbol = "/ANONGLYPH+";
    string private _baseURI = "QmYSfMJQFW8oWg2oxxhoQKjuBtP1PSbZZGLvaQrpumyBKP";
