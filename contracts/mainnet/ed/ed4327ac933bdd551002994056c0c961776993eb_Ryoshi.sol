...
contract Ryoshi is Ownable, ERC20 {
    uint256 private _numTokensSellToAddToSwap = 100000 * (10**decimals());
    bool inSwapAndLiquify;

    uint256 public constant buySellLiquidityTax = 0;
    uint256 public constant sellDevelopmentTax = 4;
    address public developmentWallet = 0x9661487e3a5EEE1B6d5ec7cC9E97762291D8c24B;
    ...
    constructor() ERC20("Ryoshi is DEAD", "DEAD") {
        _mint(msg.sender, (7474747474 * 10**decimals()));
