...
contract ProjectOne is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVd1VgvL4TANScw9ZWQEfq8BtXsqWX59q4R9YKJ82Trwg";
    ...
    constructor(
    ) ERC721A("ProjectOne by Rooland", "1", 100, maxSupply) {
    }
