...
/*
    Telegram : @BabyShinaInu
    Website : www.BabyShina.com
...
contract BabyShinaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Baby Shina Inu";
    ...
    address payable private _opAddress = payable(0x1d8664A87C0c10D8064FB9cB2eA9E1E5A4678a1B);
    ...
    uint256 public _maxTxAmount = 1000000000 * 10**9; //.5 
    uint256 public _maxWalletSize = 1000000000 * 10**9; //.5
