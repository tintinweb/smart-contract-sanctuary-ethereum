...
In tribute to our creator Vitalik Buterin, aka VitalikLongSchlong
https://twitter.com/Route2FI/status/1564483328450904065/photo/1
...
contract VitalikLong is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"VitalikLong";
    string private constant _symbol = unicode"Schlong";
    ...
    function setTeamFee(uint256 fee) external onlyOwner() {
        require(fee <= 16, "not larger than 16%");
        _teamFee = fee;
    }
