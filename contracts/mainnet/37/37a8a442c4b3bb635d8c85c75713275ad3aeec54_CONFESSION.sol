...
contract CONFESSION is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Proof of Confession", "POC") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0xbb06Bca5d307764D0561d8cC55C251471AB83837); // set as Marketing wallet
        DevWallet = address(0xbb06Bca5d307764D0561d8cC55C251471AB83837); // set as dev wallet
