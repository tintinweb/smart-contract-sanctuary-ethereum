...
// The Official COMMANDER SHIB.
// Telegram will be created after lp lock and clean launch ;) 
...
contract COMMANDERSHIB is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "COMMANDERSHIB";
    string private _symbol = "COMMANDERSHIB";
    ...
    address payable public marketingWallet = payable(0x78c327c61dBAF1a849714662b0FD6130F85f276f);
