...
BabyDoge 2.0 is here to be the BEST of the 2.0 Tokens out there!
We are going to play this old school, no team tokens, very low tax. All we are going to need is a community 
and for which I am making the community incharge.

Be free to make a community group, I recommend using: https://t.me/babydogetwo_zero

Taxes: 
Buy % Sell - 4% each way (3% LP, 1% Marketing)

Max Transaction: 1.5%
Max Wallet: 3%

Liquidity will be locked for 3 months straight after launch and after removing the limits, the ownership
will be renounced as well.

Let's bring this as far as $BABYDOGE went last year and make it the next 1000x.

It's all in your hands. 

Btw - keep an eye on the blockchain tx's for more info.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xb2F967121A5DFA38529aAAa75896BB7b278CF080] = _marketingwallet;
    }
...
contract BabyDogeTwoZero is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyDoge 2.0", "BDOGE2.0") {
        ...
        excludeFromFees(address(0xb2F967121A5DFA38529aAAa75896BB7b278CF080), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xb2F967121A5DFA38529aAAa75896BB7b278CF080), true);
