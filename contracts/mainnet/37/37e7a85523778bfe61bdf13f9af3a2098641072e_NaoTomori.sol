...
Twitter Handle :
https://twitter.com/NaoTomoriErc

Telegram Potal :
https://t.me/NaoTomoriErc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd927841a3351a36CB27974aAdeD4cD09C5A9AA83;
...
contract NaoTomori is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xd927841a3351a36CB27974aAdeD4cD09C5A9AA83);
    ...
    */
    ...
    string private _name = " Nao Tomori"; 
    string private _symbol = " TOMORI ";  
    ...
    */
    ...
    uint256 private _maxWalletToken = _tTotal.mul(2).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (% at launch)
    uint256 private _maxTxAmount = _tTotal.mul(4).div(100); 
    ...
    */
    ...
    function BotWallets(address[] calldata addresses) external onlyOwner {
    ...
    function RemoveWallets_BOT(address[] calldata addresses) external onlyOwner {
    ...
    function AntiBOT(bool true_or_false) public onlyOwner {
