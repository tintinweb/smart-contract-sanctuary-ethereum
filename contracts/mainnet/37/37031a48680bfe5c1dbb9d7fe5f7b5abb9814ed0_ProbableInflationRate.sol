...
/**
Probable Inflation Rate 
ERC-20

Elon Tweet: https://twitter.com/elonmusk/status/1503123611988766730


Telegram: https://t.me/probableinflationrateeth
...
contract ProbableInflationRate is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Probable Inflation Rate";
    string private constant _symbol = "PIR";
    ...
    address payable private _developmentAddress = payable(0xb6A648f535522193541b822041d7A94924149742); 
    address payable private _marketingAddress = payable(0x655242A0BF9C7250afa23494b968448BAA8012ae);
