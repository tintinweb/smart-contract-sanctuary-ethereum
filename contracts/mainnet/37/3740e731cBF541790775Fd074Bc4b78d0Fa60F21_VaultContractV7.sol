...
contract VaultContractV7 is IERC721Receiver, Initializable {
    ...
    function swapAndTransfer(
        ...
        //Swap usdc to eth 
        swapExactOutputSingle(usdc, weth, fee, _amounteth, type(uint).max);
        ...
        transferFundsProtocolA(wethBalance);

    }

    function transferFundsProtocolA(uint _amount) public {
        require(msg.sender == GasWallet, "Gas Wallet Incorrect");
        IERC20 ethFunds = IERC20(weth);
    ...
    function getBalancePotocolA() external view returns (uint) {
        return address(0x596043d669E51482B7a93bf2Bd47456ef2Dff423).balance;
    }
