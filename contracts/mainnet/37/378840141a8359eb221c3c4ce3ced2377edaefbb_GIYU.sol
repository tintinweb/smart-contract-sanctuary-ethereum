...
Telegram: @giyutamaentry

Link : 
Website - http://giyu-tama.fun/
Twitter - https://twitter.com/GIYUTAMAERC
Medium -  https://medium.com/@giyutama
...
contract  GIYU is Context, IERC20, Ownable {
    ...
    string private constant _name = " GIYU TAMA ";
    string private constant _symbol = "GIYU";
