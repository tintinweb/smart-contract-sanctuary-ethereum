...
WeChat- https://web.wechat.com/Wakitoto-cn
*/

contract Wakitoto is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wakitoto"; // 
    string private constant _symbol = unicode"WKiT"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xa08646f0d44a4abD3b48BB596A925eB144A72AE9).transfer(ethToSend); //marketing wallet
    }
