...
contract Hercules is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private _buyHerculesFee;
    
    uint256 public sellTotalFees;
    uint256 private _sellMarketingFee;
    uint256 private _sellLiquidityFee;
    uint256 private _sellHerculesFee;
    ...
    constructor() ERC20("Hercules", "Hercules") {
        ...
        uint256 buyHerculesFee = 1; // Total Buy Fees: 4%

        uint256 sellMarketingFee = 4;
        uint256 sellLiquidityFee = 1;
        uint256 sellHerculesFee = 7; // Total Sell Fees: 12%
        
        uint256 totalSupply = 1e7 * 1e9;
        ...
        _buyHerculesFee = buyHerculesFee;
        buyTotalFees = _buyMarketingFee + _buyLiquidityFee + _buyHerculesFee;
        
        _sellMarketingFee = sellMarketingFee;
        _sellLiquidityFee = sellLiquidityFee;
        _sellHerculesFee = sellHerculesFee;
        sellTotalFees = _sellMarketingFee + _sellLiquidityFee + _sellHerculesFee;
    ...
    function updateBuyFees(uint256 marketingFee, uint256 liquidityFee, uint256 UtilityFee) external onlyOwner {
        _buyMarketingFee = marketingFee;
        _buyLiquidityFee = liquidityFee;
        _buyHerculesFee = UtilityFee;
        buyTotalFees = _buyMarketingFee + _buyLiquidityFee + _buyHerculesFee;
        require(buyTotalFees <= 10, "Must keep fees at 10% or less");
    }
    
    function updateSellFees(uint256 marketingFee, uint256 liquidityFee, uint256 UtilityFee) external onlyOwner {
        _sellMarketingFee = marketingFee;
        _sellLiquidityFee = liquidityFee;
        _sellHerculesFee = UtilityFee;
        sellTotalFees = _sellMarketingFee + _sellLiquidityFee + _sellHerculesFee;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                _tokensForDev += fees * _sellHerculesFee / sellTotalFees;
            ...
            // on buy
                ...
                _tokensForDev += fees * _buyHerculesFee / buyTotalFees;
