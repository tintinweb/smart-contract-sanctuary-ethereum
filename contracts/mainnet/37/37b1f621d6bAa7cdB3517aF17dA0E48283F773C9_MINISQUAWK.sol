...
/**
 ...
 Everyone searching for MINISQUAWK , well here it is.
 
    At launch :

    Max transaction : 100000

    Max wallet : 200000 ( Per address,you can use multiple addresses)

    5% liquidity Fee on buying and selling MINISQUAWK

    There is no dev or marketing fee.

    MINISQUAWK is a social experiment style of token.
...
contract MINISQUAWK is Context, IERC20, Ownable {
    ...
    string private _name = "MINISQUAWK";
    string private _symbol = "MINISQUAWK";
