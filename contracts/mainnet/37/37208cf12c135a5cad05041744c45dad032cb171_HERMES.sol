...
Hermes was the ancient Greek god of  wealth, luck, fertility, animal husbandry, sleep, language, thieves, and travel. One of the cleverest and most mischievous of the Olympian gods
...
Website: https://www.hermestoken.org/
Telegram: https://t.me/HermesCommunity
Twitter: https://twitter.com/HermesErc20
Medium: https://medium.com/@hermestoken                                                                                                                                                                                                                                                                                                                                             
*/
...
interface IUniswapV2Pair {
    ...
    // 
    string private _name = "Hermes God";
    string private _symbol = "HERMES";
    ...
    address payable public marketingWallet = payable(0xeCE30d5B4F6aEC9E1e08735Ad3903328c1289fd9);
    ...
    function Lock(uint256 marketingFee4Sellers) external onlyOwner() {
