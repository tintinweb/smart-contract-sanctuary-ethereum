...
contract ZAOS is ERC721, Ownable, ReentrancyGuard {
  ...
  string public notRevealedURI = "ipfs://QmeS4BLYue1GnqYxGJEtn3wnTHnV6gsn8s9iiA6NQuJZwq/hidden.json";
  string public baseURI;
  string public baseExtension = ".json";
  uint public maxPublicSupply = 3900;
