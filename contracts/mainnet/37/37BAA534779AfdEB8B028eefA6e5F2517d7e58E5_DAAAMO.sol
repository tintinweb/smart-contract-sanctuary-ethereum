...
contract DAAAMO is ERC721A, ERC4907A, OperatorFilterer, ERC721AQueryable, IERC4906, ERC721ABurnable, ERC2981, Ownable, Pausable, AccessControl {
    string private baseURI = "https://arweave.net/BOop4RnqhN5Mm6mPGsvmXL00q3CsFq-IYJ3o7thaHPA/";
    ...
    constructor() ERC721A("DAAAMO-V2", "DAAAMO") {
        _grantRole(DEFAULT_ADMIN_ROLE, owner());
        _grantRole(MINTER_ROLE, owner());
        _grantRole(MINTER_ROLE, 0x9d22AFDF3F2489e5F4E7c4320114CbbD12fd648b);
    ...
    function _createJson(uint256 tokenId) internal view virtual returns (string memory) {
        ...
        bytes memory bytesImage = abi.encodePacked('"image":"', _baseURI(), _ticketName[uint256(tokenTicket[tokenId])], '.mp4"');

        bytes memory bytesObject = abi.encodePacked("{", bytesName, ",", bytesDesc, ",", bytesImage, "}");
    ...
    function withdraw() external onlyRole(DEFAULT_ADMIN_ROLE) {
        Address.sendValue(payable(0x9d22AFDF3F2489e5F4E7c4320114CbbD12fd648b), address(this).balance);
    }
