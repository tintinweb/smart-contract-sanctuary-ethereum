...
contract Platform is ReentrancyGuard {
    ...
    /// @notice The maximum number of blacklisted addresses per bribe.
    uint256 private constant _MAX_BLACKLIST_SIZE = 5;
    ...
    function createBribe(
        ...
        if (totalRewardAmount == 0 || blacklist.length > _MAX_BLACKLIST_SIZE) revert WRONG_INPUT();
