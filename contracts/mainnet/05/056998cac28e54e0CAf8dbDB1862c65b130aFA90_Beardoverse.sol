...
contract Beardoverse is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 2000;
    ...
    address[] public withdrawAddresses = [0xA648Dd44900d53E6Bc42B7126e32287b6A333a70, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xf1f5419a1c25c78d243afdd36213cc9b6a5068da1b73a73c0d04a2d434ac92f8;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xA648Dd44900d53E6Bc42B7126e32287b6A333a70, _royaltyAmount);
    }
