    ...
    IERC721MetadataUpgradeable
{
     ...
     */
    function __ERC721T_init(
        string memory name_,
        string memory symbol_,
        uint256 startToken_
    ) internal onlyInitializing {
        __ERC721T_init_unchained(name_, symbol_, startToken_);
    }
    ...
    function __ERC721T_init_unchained(
        ...
        while (_owners.length < startToken) {
    ...
    /**
     * @dev Safely mints a token in sequence and transfers it to `to`.
     *
     * Requirements:
     *
     * - If `to` refers to a smart contract, it must implement {IERC721Receiver-onERC721Received}, which is called upon a safe transfer.
    ...
    /**
     * @dev Mints a token in sequence and transfers it to `to`.
     *
