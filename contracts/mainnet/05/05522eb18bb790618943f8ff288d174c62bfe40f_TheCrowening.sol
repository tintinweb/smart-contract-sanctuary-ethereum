...
contract TheCrowening is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Crowening", "CROW") {
        ...
        uint256 totalSupply = 987654321 * (10 ** 18);
        supply += totalSupply;
        ...
        marketingAddress = 0x43713550192b79ACf555645Dac50CFcC32222bF2;
    ...
    function updateBuyFees( uint256 _marketingFee, uint256 _buyLiquidityFee) external onlyOwner {
      require(!_renounceFeeFunctions, "Cannot update fees after renouncement");
    ...
    function updateSellFees( uint256 _marketingFee, uint256 _sellLiquidityFee) external onlyOwner {
      require(!_renounceFeeFunctions, "Cannot update fees after renouncement");
