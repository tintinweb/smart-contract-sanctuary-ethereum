...
contract Land is ERC721A, Ownable {
    ...
    uint256 public presaleR1StartTime;
    uint256 public presaleR2StartTime;
    uint256 public totalPresaleMinted;
    mapping(address => uint256) public presaleMinted;
    uint256 public constant MAX_PRESALE_LANDS = 888;
    uint256 public constant PRESALE_MINT_PRICE = 0.0001 ether;       // 0.1 ether
    uint256 public constant PRESALE_UNLOCK_TIME = 1668006000;

    uint256 public allowListR1StartTime;
    uint256 public allowListR2StartTime;
    ...
    uint256 public constant ALLOW_LIST_MINT_PRICE = 0.00025 ether;    // 0.25 ether

    uint256 public claimableStartTime;
    ...
    uint256 public constant CLAIMABLE_UNLOCK_TIME = 1668178800;

    uint256 public mintStartTime;
    uint256 public mintEndTime;
    uint256 public mintStartTokenId;
    uint256 public constant MINT_PRICE = 0.0004 ether;                // 0.4  ether
    ...
    bool public bonusMarketingFee = false;
    ...
    constructor(uint256 maxLands) ERC721A("BlueSky", "BSK") {
        MAX_LANDS = maxLands;
    }
        ...
        mustMatchPrice(MINT_PRICE, numLands)
    {
        ...
        if (elapsed <= 1800 && !bonusMarketingFee && totalSupply() - mintStartTokenId + 1 >= 750) {
            bonusMarketingFee = true;
        }
    ...
    function _payBonusMarketingFee(uint256 elapsed) internal {
        if (marketingWallet != address(0)) {
            uint256 _percent;
            bool _in1h = elapsed <= 3600;
            if (_in1h && bonusMarketingFee) {
                _percent = 8;
            } else if (_in1h || bonusMarketingFee) {
                _percent = 4;
            }
            if (_percent > 0) {
