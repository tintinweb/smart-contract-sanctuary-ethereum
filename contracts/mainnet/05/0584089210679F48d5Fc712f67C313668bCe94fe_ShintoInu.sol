...
contract ShintoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shinto Inu";
    string private constant _symbol = unicode"SHINU";
