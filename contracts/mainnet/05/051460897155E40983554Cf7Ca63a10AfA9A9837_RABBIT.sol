...
//  Web:    https://www.rabbit_eth.org/
//  Twit:   https://twitter.com/RABBIT_ETH
...
library SafeMath {
    ...
    /**
     * @dev Returns
 the division of two unsigned integers, with a division by zero flag.
     *
     * _Available since v3.4._
     */
...
contract RABBIT is ERC20, Ownable {
    ...
    constructor() ERC20("RABBIT", "RAB") {
        ...
        marketingWallet = address(0x69d8d4B7B4A4E69f59cEeE981c5a8CfC70a63f67); // set as marketing wallet
        devWallet = address(0x69d8d4B7B4A4E69f59cEeE981c5a8CfC70a63f67); // set as dev wallet
