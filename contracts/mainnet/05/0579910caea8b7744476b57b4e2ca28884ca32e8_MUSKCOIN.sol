...
contract MUSKCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Musk Coin", "ELON") {
        ...
        marketingWallet = address(0x191977b8615C29fC0dc572a58bC7C24fc7308DE5); // set as marketing wallet
        devWallet = address(0x191977b8615C29fC0dc572a58bC7C24fc7308DE5); // set as dev wallet
