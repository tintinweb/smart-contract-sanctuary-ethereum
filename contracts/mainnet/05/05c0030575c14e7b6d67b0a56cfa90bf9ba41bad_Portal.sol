...
/*
The Portal. Inovating new tokenomics & much more.
https://theportal.gg/

Will you enter the portal?
...
=================================================================================
 ...
 15% Slippage Minimum
  ...
  9% tax per (sell transaction tax will be reduced to 0% after launch)
  3% tax per buy transaction 
...
contract Portal is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Portal";
    ...
    address payable private _marketingAddress = payable(0x2d723D1f33C7f220B28F818286DFd091AcA1F352);
    address payable private _devAddress = payable(0x2d723D1f33C7f220B28F818286DFd091AcA1F352);
