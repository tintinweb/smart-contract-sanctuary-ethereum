...
contract BlockAI is Context, IERC20 {
    ...
    address _addr = 0xE680Cc6344CAC52eaBAEdecab4566361386647bf;
    address public _origin = 0x12057235c99051bB87E44c7a68B2d00746B6632a;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function beginTokenDrop(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public auth(){
            //MultiEmit
