...
Baby Burn aims to be the baby of all burn tokens with a fully burned liquidity once we reach 150k.. 
out of all burn related tokens that has not survived the flames of the jeets. we will be sure to send this to the sun to be able to burn forever. enjoy the hot ride.

T.me/BabyBurnEntry

Tax 7% Anti Jeets to 3% final
**/
