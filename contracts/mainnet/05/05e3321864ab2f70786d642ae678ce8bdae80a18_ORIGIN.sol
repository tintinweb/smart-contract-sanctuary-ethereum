...
contract ORIGIN is ERC20, Ownable {
    ...
    constructor() ERC20("Era of Ascension", "295") {
        ...
        uint256 totalSupply = 2950000 * 1e18;

        maxTransactionAmount = 60000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 60000 * 1e18; // 2% from total supply maxWallet
        ...
        marketingWallet = address(0xA2bE65080834bD665D83A2e4611543558d2F338f); // set as marketing wallet
        devWallet = address(0xA2bE65080834bD665D83A2e4611543558d2F338f); // set as dev wallet
