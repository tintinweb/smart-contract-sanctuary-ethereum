...
contract TsukaDAO is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0xa1E0C73fe4fDEa86838a7BD5a2912da2C41C0e1a);
  ...
  string private constant _name = 'Tsuka DAO';
  string private constant _symbol = 'TSUKA DAO';
  ...
  address public buybackTokenAddress = 0xc5fB36dd2fb59d3B98dEfF88425a3F425Ee469eD;
