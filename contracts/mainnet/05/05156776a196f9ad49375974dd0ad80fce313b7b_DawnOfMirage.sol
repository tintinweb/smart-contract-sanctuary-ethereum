...
contract DawnOfMirage is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dawn Of Mirage", "DOM") {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), USDCToken);
