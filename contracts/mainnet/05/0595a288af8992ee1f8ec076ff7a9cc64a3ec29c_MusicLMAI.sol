...
MusicLM AI - Make Music using AI

Google announced the release of MusicLM and we will make a TG bot and customized web app using it! 

TG: https://t.me/MusicLM_AI

Website: https://musiclm-ai.com/
...
contract MusicLMAI is ERC20, Ownable {

    address WBNB = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MusicLM AI"; // 
    string constant _symbol = "MusicLM AI"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (5); // 5%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (5); // 5%
    uint256 public _maxWalletToken = _totalSupply / (100) * (5); // 5%

    // Fees receivers
    address public autoLiquidityReceiver = 0x6d6F50623b2A6e92d3a9b90d2b5fDaB48cbC9fa3;
    address public marketingFeeReceiver = 0x6d6F50623b2A6e92d3a9b90d2b5fDaB48cbC9fa3;
    address public devFeeReceiver = 0x4364eFfabeE2a2c9b67B781eB01EC4ECC7da00a2;
    address public buybackFeeReceiver = 0x4364eFfabeE2a2c9b67B781eB01EC4ECC7da00a2;
    ...
    uint256 public maxSwapSize = _totalSupply / 100 * 5; //5%
