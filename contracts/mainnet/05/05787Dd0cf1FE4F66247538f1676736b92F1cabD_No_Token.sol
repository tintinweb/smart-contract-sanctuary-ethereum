...
contract No_Token is IERC20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        // Set fee receivers
        liquidityWallet = 0x3411b6C32076AAbBAF6941819bbB4C1E65E46D0a;
        marketingWallet = 0x3411b6C32076AAbBAF6941819bbB4C1E65E46D0a;
        developmentWallet = 0x3411b6C32076AAbBAF6941819bbB4C1E65E46D0a;
    ...
    function setBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _developFee) external authorized{
        require(_marketingFee + _liquidityFee + _developFee <= 120); // max 12%
