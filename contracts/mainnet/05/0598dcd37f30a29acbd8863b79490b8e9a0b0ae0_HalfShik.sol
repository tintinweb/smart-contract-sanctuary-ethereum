...
contract HalfShik is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Half Shikoku Inu", "SHIK 0.5") {
        ...
        devWallet = address(0xC85bf883B953838235F36099D6bf9b78B8956677); 
    ...
    function updateSellFees(uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 100, "DFees");
    }
