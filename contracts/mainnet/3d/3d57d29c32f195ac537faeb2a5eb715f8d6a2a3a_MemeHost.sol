...
contract MemeHost is ERC20, Ownable {
    ...
    constructor() ERC20("Meme Host", "MEMEH") {
        ...
        treasuryWallet = address(0xB424EB65915A77526994df55c2741cAA31109ba0); // set as treasury wallet
