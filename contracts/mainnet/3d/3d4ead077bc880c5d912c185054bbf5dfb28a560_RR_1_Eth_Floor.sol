...
// File: contracts/1 ethh floor.sol
...
contract RR_1_Eth_Floor is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://35GWFQCUU8YDTKA6G1YJSCTP68Z4HK5PJX";
    ...
    address constant internal DEV_ADDRESS = 0x5F7b3a3Cc9431E0A6199FC7BE3C792Cd84783cf7;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("RR 1 ETH FLOOR", "RR1ETH") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 100, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0x5F7b3a3Cc9431E0A6199FC7BE3C792Cd84783cf7");
