...
contract BabyDoKwonInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Do Kwon Inu", "BDKWON") {
        ...
        swapTokensAtAmount = totalSupply * 20 / 10000; // 0.15% swap wallet
