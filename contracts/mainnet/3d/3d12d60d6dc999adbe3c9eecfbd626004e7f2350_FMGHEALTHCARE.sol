...
// FMG Healthcare Smart contract based on the full ERC20 Token standard
// https://github.com/ethereum/EIPs/issues/20
// Verified Status: ERC20 Verified Token
// FMG Healthcare Symbol: FMG


contract FMGHEALTHCAREToken { 
...
/**
 * FMG HEALTHCARE Math operations with safety checks to avoid unnecessary conflicts
 */
...
contract FMGStandardToken is FMGHEALTHCAREToken, Ownable {
...
contract FMGHEALTHCARE is FMGStandardToken {
    ...
    */
    ...
    string constant public name = "FMG Healthcare";
    string constant public symbol = "FMG";
    
    function FMGHEALTHCARE(){
