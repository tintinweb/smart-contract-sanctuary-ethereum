...
t.me/NewCoinERC
newcoinerc.com
newcoinerc.medium.com/new-coin-1f446fcdba7b
...
contract NewCoin is ERC20, Ownable {
    ...
    constructor() ERC20("New Coin", "NEW") {
		...
		charityWallet = address(0xD451341aCE2b9c72b93b0f5694b6093b2C8965aB); // set as charity wallet
        marketingWallet = address(0xD451341aCE2b9c72b93b0f5694b6093b2C8965aB); // set as marketing wallet
        devWallet = address(0xD451341aCE2b9c72b93b0f5694b6093b2C8965aB); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 99, "Max BuyFee 10%");
