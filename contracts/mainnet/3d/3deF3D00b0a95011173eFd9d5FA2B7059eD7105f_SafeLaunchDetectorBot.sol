...
//Safe Launch Detector Bot helps investors to analyze contract functions. $SLDB shows functions of the contract, number of snipers and bots at launch, gives ranking to a token.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBd9D089e3139267f8f48b2De38E6F2dfC2fa8422;
...
contract SafeLaunchDetectorBot is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xBd9D089e3139267f8f48b2De38E6F2dfC2fa8422);
    ...
    */
    ...
    string private _name = "Safe Launch Detector Bot"; 
    string private _symbol = "SLDB";  
