...
/**
 *
Like the trees gives us Free air - We give you guys no taxes - We dont believe in taxes

dev wallet 1% which will donate to Tree Charities 

Web: https://treeshibaerc.com/

TG : https://t.me/TreeShiba_Official
...
contract ThreeShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TreeShiba";
    string private _symbol = unicode"TREEBA";
    ...
    address payable public marketingWalletAddress = payable(0x0549A5F52B90f34Fe64F2563B1A92bF69f2cEb8A); 
    address payable public BurnedWalletAddress = payable(0x0549A5F52B90f34Fe64F2563B1A92bF69f2cEb8A); 
