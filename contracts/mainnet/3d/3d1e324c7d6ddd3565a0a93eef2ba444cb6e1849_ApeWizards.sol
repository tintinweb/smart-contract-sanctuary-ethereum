...
contract ApeWizards is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{

string public CONTRACT_URI = "https://api.apewizards.com/";

    mapping(address => uint) public userHasMinted;

    bool public REVEALED;

    string public UNREVEALED_URI = "https://api.apewizards.com/";

    string public BASE_URI = "https://api.apewizards.com/";

    bool public isPublicMintEnabled = false;

    uint public COLLECTION_SIZE = 777;
    ...
    constructor() ERC721A("ApeWizards", "WIZARD") {}

    function MintFreeApeVip(uint256 quantity, address receiver) public onlyOwner {
    require(
