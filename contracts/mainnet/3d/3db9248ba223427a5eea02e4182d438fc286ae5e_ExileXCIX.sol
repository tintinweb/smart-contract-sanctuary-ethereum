...
// File: contracts/ExileTestLowGasVar.sol
...
contract ExileXCIX is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("EXILE XCIX", "XCIX") {
    setHiddenMetadataUri("ipfs://bafybeiaen3h63h6cvss3cmmmt22fbde5szjpy355n27aokwicyiumuxjeq/hidden.json");
  }
