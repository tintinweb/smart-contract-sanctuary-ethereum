...
The EVERYTHINGKILLER..

4% Buy/Sell Tax

Telegram: @DOGEPUNKZ
Twitter: https://twitter.com/DogePunkz
Website: TBA
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x1F131F45005B5758436f03eC0542dC309Bb921D8] = _marketingwallet;
    }
...
contract DogePunkz is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Doge Punkz", "DPUNKZ") {
        ...
        excludeFromFees(address(0x1F131F45005B5758436f03eC0542dC309Bb921D8), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x1F131F45005B5758436f03eC0542dC309Bb921D8), true);
