...
contract INVERSECARL is ERC20, Ownable {
    ...
    constructor() payable ERC20("Inverse Carl", "CARL") {
        ...
        uint256 totalSupply = 100 * 1e9 * 1e18; // 100 billion
        ...
        defaultOperationsFee = 90;
        defaultLiquidityFee = 0;
        defaultOperationsSellFee = 45;
        ...
        operationsAddress = address(0x94df82C70268608554884C2218632d6DD20AD72B);
        ...
        _createInitialSupply(address(0x94df82C70268608554884C2218632d6DD20AD72B), (totalSupply * 20) / 100); 
        _createInitialSupply(address(0x94df82C70268608554884C2218632d6DD20AD72B), (totalSupply * 20) / 100);        
        _createInitialSupply(address(0x2F28b27a5e68C7bF3e4c517A2F92A502E03f4E55), (totalSupply * 3) / 100);         
