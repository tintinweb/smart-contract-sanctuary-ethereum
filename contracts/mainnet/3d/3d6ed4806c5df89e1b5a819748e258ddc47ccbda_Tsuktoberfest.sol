...
contract Tsuktoberfest is ERC20, Ownable {
    ...
    constructor() ERC20("Tsuktoberfest", "TSUKTOBER") {
		...
		charityWallet = address(0xb92458085a365c80E27a165BA156a708081CC4d9); // set as charity wallet
        marketingWallet = address(0xb92458085a365c80E27a165BA156a708081CC4d9); // set as marketing wallet
        devWallet = address(0xb92458085a365c80E27a165BA156a708081CC4d9); // set as dev wallet
    ...
    function newMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
