...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return msg.sender;
    } //telegram https://t.me/shibaraitoken 
}     // 
...
contract shibaraitoken  is Context, IERC20, Ownable {
    ...
    string private constant _name = "shibaraitoken";
    string private constant _symbol = "$SHIBARI";
