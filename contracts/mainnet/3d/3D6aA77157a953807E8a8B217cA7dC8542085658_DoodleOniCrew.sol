...
contract DoodleOniCrew is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "https://mypinata.space/ipfs/QmaLzrz2KEjbqjAweL2QpxdBJLNrqr1GQfaddFz1b9mp8e";

  uint256 public maxSupply = 350;
  uint256 public  MAX_MINTS_PER_TX = 1;
  uint256 public FREE_MINTS = 150;
  ...
  ) ERC721A("Doodle Oni Crew", "Doodle Oni Crew") {
