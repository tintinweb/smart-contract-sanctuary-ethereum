...
contract SatoshiTsuka
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "SatoshiTsuka";
    string private _symbol = "SATSUKA";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xD39Dc917971485CB7A21D1e768AEC554443c0AfC));
        _metawallet = payable(address(0xD39Dc917971485CB7A21D1e768AEC554443c0AfC));
