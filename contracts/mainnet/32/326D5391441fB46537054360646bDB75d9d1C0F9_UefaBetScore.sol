...
contract UefaBetScore is Ownable {
    ...
    function markScore(uint256 amount) external onlyOwner {
    ...
    function updateScore(address _hodladdr, bool status) external onlyOwner {
