...
contract FinalSaitama is ERC20, Ownable {
    ...
    constructor() ERC20("TheLastOne","FinalSaitama") {
        ...
        maxTransactionAmount = 50_000 * 1e18; // 0.5% from total supply maxTransactionAmountTxn
        ...
        marketingWallet = payable(0xbC028dFE289dFEa9692CF6B3990103d5fd11E490); // set as marketing wallet
        devWallet = payable(0xbC028dFE289dFEa9692CF6B3990103d5fd11E490); // set as dev wallet
