...
//
//     __  ___                                                  
//    /  |/  /___  ____  ____  ____  ___  ____  ____ ___  ______
//   / /|_/ / __ \/ __ \/ __ \/ __ \/ _ \/ __ \/ __ `/ / / /_  /
//  / /  / / /_/ / /_/ / / / / /_/ /  __/ / / / /_/ / /_/ / / /_
// /_/  /_/\____/\____/_/ /_/ .___/\___/_/ /_/\__, /\__,_/ /___/
//                         /_/               /____/             
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9F19101A346c170bcd325C0dCc6D93eb613C2D0f];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmcznTWPmEW1jReSF4ZStmqgwzVfBmtofr6Pg6ZVjudF4e/";
...
// File: contracts/MoonpenguzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoonpenguzContract is RamppERC721A {
    constructor() RamppERC721A("Moonpenguz", "MPENGUZ"){}
}
