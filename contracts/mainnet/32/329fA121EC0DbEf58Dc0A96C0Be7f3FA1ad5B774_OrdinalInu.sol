...
contract OrdinalInu is ERC20, Ownable {
    ...
    constructor() payable ERC20("Ordinal Inu", "ORD") {
        ...
        operationsAddress = address(0x9AE1357c50f37324EC454758fe007CE39c281055);
        devAddress = address(0x75B33c8e9c8771D92E405e7F4374437C7f1B278F);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x75B33c8e9c8771D92E405e7F4374437C7f1B278F),
            block.timestamp
        );
    }
