...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xeA6E8fD19D8D955AC78FFc7AB90B8c474e42770E];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xeA6E8fD19D8D955AC78FFc7AB90B8c474e42770E;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 1200;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 2212) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://yepdderqweqw.mypinata.cloud/ipfs/QmRazY5uKuvXtJoVAZ7AGN3tfHtyhnZ1dGfUKF5kqnpJRM/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2212");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2212");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2212");
...
// File: contracts/StoicLionsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract StoicLionsContract is RamppERC721A {
    constructor() RamppERC721A("Stoic Lions", "Stoic"){}
}
