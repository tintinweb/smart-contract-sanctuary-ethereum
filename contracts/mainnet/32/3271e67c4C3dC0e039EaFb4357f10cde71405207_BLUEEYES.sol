...
contract BLUEEYES is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Blue-Eyes";
    string private constant _symbol = unicode"White Dragon";
