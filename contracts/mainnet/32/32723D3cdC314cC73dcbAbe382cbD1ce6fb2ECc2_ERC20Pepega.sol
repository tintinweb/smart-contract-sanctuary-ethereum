...
contract ERC20Pepega is ERC20, Ownable {  /*🐸🟪*/
...
/* You get nothing*/
    ...
    constructor() ERC20("Pepega", "PEPEGA") { /*🐸🟪*/
        ...
        maxTransactionAmount =  690_000_000_000 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 690_000_000_000 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0xDFd6698b8e50aEc7B11e8b20a7c3F6Dc16d5314a); // set as dev wallet
        MarketingWallet = address(0xDFd6698b8e50aEc7B11e8b20a7c3F6Dc16d5314a); // set as mkt wallet
