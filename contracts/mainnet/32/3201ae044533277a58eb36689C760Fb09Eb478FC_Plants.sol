...
import "./opensea/src/upgradeable/DefaultOperatorFiltererUpgradeable.sol";
...
contract Plants is ERC721PausableUpgradeable, ERC721BurnableUpgradeable, ERC721RoyaltyUpgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable {
  ...
  function v2Initialize() public onlyOwner {
    require(!v2Init, "Cannot initialize v2 again");
