...
contract TitterMania  is Context, IERC20, Ownable {
    uint256 public immutable _buyTax =10;
    uint256 public immutable _sellTax =3;
    string private _name = unicode"Titter Mania";
    string private _symbol = unicode"TitterM";
