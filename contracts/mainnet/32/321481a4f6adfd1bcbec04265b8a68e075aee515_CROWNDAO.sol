...
Who will be the first to find the crown?
Clues will be given, it's up to you to find.


Find me on telegram, you won't regret
...
Max buy    : 20.000.000.000 // 2%
Max wallet : 40.000.000.000 // 4%
...
contract CROWNDAO is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"CROWNDAO"; ////
    string public constant symbol = unicode"CROWNDAO"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxHeldTokens = 4000000000 * 10**9; // 4%
    }
