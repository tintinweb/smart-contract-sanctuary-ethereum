...
// File: contracts/TimeMachine.sol
...
contract TimeMachine is ERC721("Time Machine", "TM"), IERC2981, Ownable, DefaultOperatorFilterer {

    using Counters for Counters.Counter;

    /* Constants */
    uint256 public constant MAX_SUPPLY = 8888;
    uint256 public constant WALLET_LIMIT = 8;
    uint256 public constant PRICE = 8000000000000000;

    uint256 public constant ROYALTY_PERCENTAGE = 8;
    address public ROYALTY_RECEIVER = 0x41B40243664bDb1e9E8A2B84f700ACED402387a8;
    ...
    returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (address(ROYALTY_RECEIVER), SafeMath.div(SafeMath.mul(salePrice, ROYALTY_PERCENTAGE), 100));
    }
