...
contract AKANE  is ERC20, Ownable {
    ...
    constructor() ERC20("AKANE INU", "AKANE") {
		...
		charityWallet = address(0x7471a6db1fCDC629329D4A59ca2dF26c663887a5); // set as charity wallet
        marketingWallet = address(0x7471a6db1fCDC629329D4A59ca2dF26c663887a5); // set as marketing wallet
        devWallet = address(0x7471a6db1fCDC629329D4A59ca2dF26c663887a5); // set as dev wallet
