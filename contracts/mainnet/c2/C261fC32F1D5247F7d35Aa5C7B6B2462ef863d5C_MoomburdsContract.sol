...
// | $$\  $ | $$| $$  | $$| $$  | $$| $$ | $$ | $$| $$  | $$| $$  | $$| $$      | $$  | $$ \____  $$
// | $$ \/  | $$|  $$$$$$/|  $$$$$$/| $$ | $$ | $$| $$$$$$$/|  $$$$$$/| $$      |  $$$$$$$ /$$$$$$$/
// |__/     |__/ \______/  \______/ |__/ |__/ |__/|_______/  \______/ |__/       \_______/|_______/ 
//                                                                                                  
//                                                                                                  
//                                                                                                  
//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x1829193B8ef2BCff8aBF85388d6FAaE630FA408d];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x1829193B8ef2BCff8aBF85388d6FAaE630FA408d;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 10000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaxkkaac6x6vbmyghsofshxyv6mgtxx7ya6sowihdnfqk5slnounu/";
...
// File: contracts/MoomburdsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoomburdsContract is RamppERC721A {
    constructor() RamppERC721A("Moomburds", "MOOMBURDS"){}
}
