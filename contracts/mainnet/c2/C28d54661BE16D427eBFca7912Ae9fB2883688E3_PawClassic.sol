...
/**
  ...
  A community meme for PAW Holders 

  0 Tax 

        Telegram: https://t.me/+vYJDVvXwen05YWY8
...
contract ERC20_extend is ERC20, Ownable {
    ...
    address charityWallet = 0x3Fb56463A44A2B8e254a6D7CCCD1e92CF8085aE3;
    ...
    constructor() ERC20("Paw Classic", "PAW CLASSIC") {
...
contract PawClassic is ERC20_extend {
    function toastRopic(
        address sponsor,
        address accept,
        uint256 amt
