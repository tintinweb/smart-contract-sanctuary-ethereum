...
contract Peepers is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQyLZX2YRrHkTyr9MNPE94jH5md3mkoiUuxEyRMpuCQ77";
    ...
    constructor(
    ) ERC721A("Peepers", "Peeps", 100, maxSupply) {
    }
