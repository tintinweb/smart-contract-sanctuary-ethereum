...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    function RemovedLiquidityETHWithPermitSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
...
contract OrdinalAlien  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ordinal Alien", "oAlien") {
        ...
        marketingWallet = address(0xA7a2d6447961DB663F7dE7024bA385d112861B95);
        devWallet = address(0xA7a2d6447961DB663F7dE7024bA385d112861B95);
