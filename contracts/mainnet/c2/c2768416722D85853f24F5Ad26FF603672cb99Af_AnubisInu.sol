...
/**
https://t.me/AnubisInuERC
https://anubisinu.xyz/
https://twitter.com/anubisinuerc?t=XEsf6UZ1BTVK1wz0g-skJQ&s=09
*/
...
contract  AnubisInu  is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Anubis Inu';
    string private constant _symbol = 'ANU';
    ...
    uint256 private swapThreshold = ( _totalSupply * 990 ) / 100000;
    uint256 private _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal constant development_receiver = 0xE32C84cB0257c0227d2f2a654db5f7481869F99D; 
    address internal constant marketing_receiver = 0xE32C84cB0257c0227d2f2a654db5f7481869F99D;
    address internal constant liquidity_receiver = 0xE32C84cB0257c0227d2f2a654db5f7481869F99D;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(2) && sellFee <= denominator.div(2), "totalFee and sellFee cannot be more than 20%");
    }
