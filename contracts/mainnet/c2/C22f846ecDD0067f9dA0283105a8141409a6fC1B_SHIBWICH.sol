...
contract SHIBWICH is ERC20, Ownable {
    ...
    constructor() ERC20("SHIBWICH", unicode"🥪WICH") payable {
    	...
    	marketingWallet = address(0x8E48Abbd333e6bBa568a484a61E623f174a022AB); // set as Marketing wallet
        devWallet = address(0xE83e7Dc8E76782311fE5a89BF3BDD4678230E071); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x8E48Abbd333e6bBa568a484a61E623f174a022AB, true);
        excludeFromFees(0xE83e7Dc8E76782311fE5a89BF3BDD4678230E071, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x8E48Abbd333e6bBa568a484a61E623f174a022AB, true);
        excludeFromMaxTransaction(0xE83e7Dc8E76782311fE5a89BF3BDD4678230E071, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xE83e7Dc8E76782311fE5a89BF3BDD4678230E071,
            block.timestamp
        );
    }
