...
// File: contracts/CryptoPunksBack.sol
...
contract CryptoPunksBack is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer   {


  string public baseURI = "ipfs://bafybeiclfcdpx37wpk4xa2f3gnpkafixixo3duqjc4ssxncufyxaws2chu/";
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(tokens <= MaxperWallet, "CPB: max mint amount per tx exceeded");
    require(totalSupply() + tokens <= maxSupply, "CPB: We Soldout");
    require(numberMinted(_msgSenderERC721A()) + tokens <= MaxperWallet, "CPB: Max NFT Per Wallet exceeded");
