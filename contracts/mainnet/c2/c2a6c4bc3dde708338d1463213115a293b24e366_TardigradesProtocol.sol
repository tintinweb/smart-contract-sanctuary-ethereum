...
/*
Tardigrades Protocol|$TRDG 
The tardigrade "water bears" is the first known animal to survive exposure to the moon from outer space.
Species capable of surviving under extreme conditions.
...
contract TardigradesProtocol is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Tardigrades Protocol";
    string private constant _symbol = "$TRDG";
