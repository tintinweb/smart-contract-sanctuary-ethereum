...
contract testtoken1 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "testtoken2";
    string private _symbol = "test2";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xb4D1bBc79e2784006Ce8b909fb5eE50d3978419B);
    address payable public DeveloperWallet = payable(0xb4D1bBc79e2784006Ce8b909fb5eE50d3978419B);
