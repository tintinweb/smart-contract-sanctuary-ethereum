...
The Playboy Rabbitars are a collection of 11,953 unique, non-fungible tokens brought to you by one of the most iconic brands in the world.
Each Rabbitar was generated from 175+ traits inspired by Playboy’s most famous iconography, art, photography, celebrities and more. 
Rabbitar community members receive special access to Playboy’s archival content and art (including free access to iPlayboy) 
and new content, IRL & Metaverse experiences, and giveaways and discounts on physical and virtual fashion. 
Rabbitars also receive limited commercial access to Playboy IP via the DeRabbitives program, 
the first time offered to fans in nearly 70 years. 

Coming soon! Rabbitars will have access to special experiences in Playboy’s upcoming MetaMansion in The Sandbox. 
Visit the Sandbox Discord server for all the NFT-ea. https://register.sandbox.game/playboy 

TOKEN NAME: CENTERFOLD
TICKER: PlayboyNFT
SUPPLY 69,000,000
Max wallet on the first minute of launch is 690000   

Tax = 5%


TG: https://t.me/PlayboyNFTofficialgroup 
...
contract CENTERFOLD is Context, IERC20, Ownable {
    ...
    string private constant _name = "CENTERFOLD";
    string private constant _symbol = "PlayboyNFT";
    ...
    uint256 private _tTotal = 69000000   * 10**9;
    uint256 private maxWalletAmount = 690001   * 10**9;
    uint256 private maxTxAmount = 690001  * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x68C40827427782d7b0aCa7323A5D1a41Ee936c0C); 
        ...
        maxTxAmount = 690001 * 10**9;
        maxWalletAmount = 690001 * 10**9;
