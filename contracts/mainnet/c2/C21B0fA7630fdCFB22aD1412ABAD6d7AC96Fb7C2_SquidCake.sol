...
Ficha comunitaria
He implementado esto para la comunidad. Quemaremos LP y renunciaremos al contrato. Trabaja por tus maletas, cómplice,
y llevar esto a la luna!
*/
...
contract SquidCake is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Squid Cake";
