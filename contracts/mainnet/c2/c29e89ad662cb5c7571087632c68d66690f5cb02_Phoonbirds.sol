...
/**
    ...
    PHOONBIRDS IS NOT AFFILIATED WITH MOONBIRDS FROM PROOF COLLECTIVE.
*/
...
contract Phoonbirds is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x20EB9f0c9fb454FA32d276Dddd1Df0ef22026c78).call{value: address(this).balance * 0 / 100}("");
    require(hs);
    // =============================================================================
