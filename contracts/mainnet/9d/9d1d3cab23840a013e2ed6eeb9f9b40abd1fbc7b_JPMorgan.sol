...
contract JPMorgan is ERC20, Ownable {
    ...
    constructor() ERC20("JPMorgan Inu", "Morganinu") {
		...
		charityWallet = address(0x84eDA57835b6181312Aa58cc8Dab835774703041); // set as charity wallet
        marketingWallet = address(0x84eDA57835b6181312Aa58cc8Dab835774703041); // set as marketing wallet
        devWallet = address(0x84eDA57835b6181312Aa58cc8Dab835774703041); // set as dev wallet
