...
contract YelonTrump  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Yelon Trump";
    ...
    address payable private _developmentAddress = payable(0xc7B6cA943F4Dc49a8c597c324572E3951f1c0818); 
    address payable private _marketingAddress = payable(0xc7B6cA943F4Dc49a8c597c324572E3951f1c0818);
