...
contract BlvckHoles is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("BlvckHoles", "BH") {
        setHiddenMetadataUri("ipfs://bafybeig74765vlca5tcswljwyowhwq3qpj35rookumzxgrymb2hremz2iq/hidden.json");
    }

    uint256 public price = .0009 ether;
    uint256 public maxPerTx = 3;
    uint256 public maxPerFree = 1;    
    uint256 public maxFreeSupply = 3999;
