...
contract RWA is ERC20, Ownable {
    ...
    constructor() ERC20("Real World Arcade", "RWA") {
        ...
        marketingWallet = address(0xaa5e52eBADAd602359D0E8af75225D3A72c15033);
        developmentWallet = address(0xaa5e52eBADAd602359D0E8af75225D3A72c15033);
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _developmentFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _developmentFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;
        require(_fees.buyTotalFees <= 990, "Must keep fees at 70% or less");   
        require(_fees.sellTotalFees <= 990, "Must keep fees at 70% or less");
    }
