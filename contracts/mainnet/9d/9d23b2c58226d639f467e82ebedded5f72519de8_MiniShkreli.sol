...
// File: CollapsingBirthRate.sol

// An honourary token for Martin Shkreli and all of the degens who missed the $MSI pump. Let's send this and donate 50% of the proceeds to Martin!
...
contract MiniShkreli is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Mini Shkreli", "MSHKI") {
        ...
        devOpsWallet = address(0x7BF77f2FF12B7A80F8Cf027Cc086904afAB0BBbe); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x7BF77f2FF12B7A80F8Cf027Cc086904afAB0BBbe), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x7BF77f2FF12B7A80F8Cf027Cc086904afAB0BBbe), true);
