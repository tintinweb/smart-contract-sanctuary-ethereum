...
contract DivasOfSativa is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  uint256 public supplyLimit = 31;


  uint256 public maxMintAmountPerTx = 31;


  uint256 public maxLimitPerWallet = 31;
