    ...
    ILayerZeroUserApplicationConfig
{
    ...
    function lzReceive(
        ...
        require(
            ...
            "BaseLzApp: invalid endpoint caller"
        );
        ...
        require(
            ...
            "BaseLzApp: invalid source sending contract"
        );
    ...
    function _lzSend(
        ...
        require(
            ...
            "BaseLzApp: destination chain is not a trusted source"
        );
    ...
    function setMinDstGasLookup(
        ...
        require(_dstGasAmount > 0, "BaseLzApp: invalid _dstGasAmount");
