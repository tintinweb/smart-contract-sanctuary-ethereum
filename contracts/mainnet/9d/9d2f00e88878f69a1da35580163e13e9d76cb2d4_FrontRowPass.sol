...
// File: contracts/FrontRowPass.sol
...
contract FrontRowPass is Ownable, ERC721A, ERC721AQueryable, ReentrancyGuard, PaymentSplitter{
    ...
    uint private constant MAX_SUPPLY = 1000000;
    uint private constant MAX_WhiteList = 6000;
