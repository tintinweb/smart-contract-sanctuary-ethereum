...
https://t.me/AIChessPortal

https://game.aichess.network
...
contract AiChess is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Ai Chess';
    ...
    address internal constant development_receiver = 0x21674A98D73fDB756547333B0a2a5F8EA84e37cf; 
    address public constant marketing_receiver = 0x21674A98D73fDB756547333B0a2a5F8EA84e37cf;
    ...
    function AutomaticTaxLoweringSystem() internal {
        if(launchTime.add(10 minutes) <= block.timestamp){totalFee = uint256(3000); sellFee =uint256(4000);}
        ...
        if(launchTime.add(60 minutes) <= block.timestamp){totalFee = uint256(500); sellFee =uint256(800);}
