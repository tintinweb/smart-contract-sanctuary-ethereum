...
contract There is ERC20, Ownable {
    ...
    constructor() ERC20("There", "There") {
		...
		charityWallet = address(0x18E04503c771f450e73dEfB7bEd5A828a24DeEb9); // set as charity wallet
        marketingWallet = address(0x18E04503c771f450e73dEfB7bEd5A828a24DeEb9); // set as marketing wallet
        devWallet = address(0x18E04503c771f450e73dEfB7bEd5A828a24DeEb9); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 20, "Max SellFee 20%");
