...
//  ___  ___  ____ ______  ___      ____   ___   _   _
//  ||\\//|| ||    | || | // \\    ||     // \\  \\ //
//  || \/ || ||==    ||   ||=||    ||==  ((   ))  )X( 
//  ||    || ||___   ||   || ||    ||     \\_//  // \\
...
contract MetaFox is ERC721A {
    ...
    constructor() ERC721A("Meta Fox", "Fox") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmdgGcjewEiAUPEUHU2XLVRMzuTS48aNBWpUzMCYyEHF7Z/", _toString(tokenId), ".json"));
    }
