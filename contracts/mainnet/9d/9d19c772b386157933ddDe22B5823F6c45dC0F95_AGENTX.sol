...
contract AGENTX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Agent-X";
    string private constant _symbol = unicode"AGENTX";
