...
contract DeDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dejitaru Doge";
    string private constant _symbol = "DeDoge";
    ...
    uint256 private _maxWalletSize = _tTotal.mul(40).div(1000);
