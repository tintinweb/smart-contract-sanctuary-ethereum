 ...
 * allowances. See {IERC20-approve}.
 */
contract TokenMakerInsane is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Token Maker Insane";
    string private _symbol = "TMI";
    uint8 private _decimals = 18;
    uint256 private _supply = 10000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 4;
    uint256 public maxTxAmount = 180000 * 10**_decimals;
    uint256 public maxWalletAmount = 180000 * 10**_decimals;
    address public marketingWallet = 0xCF307bCBf297Aa61a85664e1AD52DeE8743562f9;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 20000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 15000 * 10**_decimals;
