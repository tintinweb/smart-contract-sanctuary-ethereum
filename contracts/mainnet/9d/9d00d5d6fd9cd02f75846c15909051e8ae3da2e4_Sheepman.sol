...
contract Sheepman  is ERC721W, Ownable {

    string  public uriPrefix = "ipfs://bafybeiauugwzcsybi5fz7ndkwlpzzz6cl5zk3zn4ss5otnqvo3f6bs4v2m/";

    uint256 public immutable mintPrice = 0.000 ether;
    uint32 public immutable maxSupply = 333;
    uint32 public immutable maxPerTx = 2;
    ...
    function mint(uint256 amount) public payable callerIsUser{
        ...
        require(mintAmount <= maxPerTx, "Max2PerTx");
    ...
    function airdrop(address to, uint256 amount) external onlyOwner {
        require(totalSupply() + amount <= maxSupply, "Request exceeds collection size");
        _safeMint(to, amount);
    }
