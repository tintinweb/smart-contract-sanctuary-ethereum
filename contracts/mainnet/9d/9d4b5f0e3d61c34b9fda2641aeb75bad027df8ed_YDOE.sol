...
abstract contract Ownable is Context {
    ...
    contract YDOE is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix = "ipfs://QmZJ4p67G1CzQmkKknVn9jtBVuWDMoCsB5d9q36xxHy7o1/" ;
  string private uriSuffix = ".json";
  string public hiddenURL= "ipfs://QmZJ4p67G1CzQmkKknVn9jtBVuWDMoCsB5d9q36xxHy7o1";

  

  uint16 public constant maxSupply = 5555;
  uint8 public maxMintAmountPerWallet = 5;
  uint public cost = 0.0055 ether;
  ...
  constructor() ERC721A("Your Dad on Ethereum", "YDOE") {
  }
