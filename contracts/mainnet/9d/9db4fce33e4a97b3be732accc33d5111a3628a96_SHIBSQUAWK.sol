...
/**
SHIBSQUAWK, the first moon landing token created by the SQUAWK community. 
8% of the tax goes to marketing and goes to the moon through community voting. 2% for developing .
TG:https://t.me/squawkofficial
WEB:https://shibsquawk.com/
*/
...
contract SHIBSQUAWK is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquawkOfficial";
    string private constant _symbol = "SHIBSQUAWK";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xF773CaffC5b8C8d5665908Ae65a3064B3aAdC297);
        _feeAddrWallet2 = payable(0xF773CaffC5b8C8d5665908Ae65a3064B3aAdC297);
