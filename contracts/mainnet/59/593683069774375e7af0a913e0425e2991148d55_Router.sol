...
// File: @openzeppelin/contracts-4.7.3/token/ERC20/extensions/draft-IERC20Permit.sol
...
// File: @openzeppelin/contracts-4.7.3/token/ERC20/utils/SafeERC20.sol
...
contract Router is Ownable {
    ...
    function _checkAllowance(IERC20 inputToken, uint256 amount) private {
        ...
        if (inputToken.allowance(address(this), uniswapRouterV2Address) < amount) {
            ...
            inputToken.safeApprove(uniswapRouterV2Address, type(uint256).max);
