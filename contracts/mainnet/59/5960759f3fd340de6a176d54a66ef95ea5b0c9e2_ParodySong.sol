...
https://twitter.com/VitalikButerin/status/1585406063100465156
...
abstract contract Ownable {
    ...
    function transferOwnership(address payable adr) public onlyOwner {
        owner = adr; emit OwnershipTransferred(adr);
    }
...
contract ParodySong  is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Parody Song';
    ...
    address public constant liquidity_receiver = 0x2D2c245abCec050fE40E15d420C379d19Ff03166; 
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant marketing_receiver = 0x2D2c245abCec050fE40E15d420C379d19Ff03166;
