...
Website: https://shibig.xyz/

Telegram: https://t.me/ShibariumBIG
...
contract SHIBIG is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Shibarium BIG", "SHIBIG") {
        ...
        maxTransactionAmount = 200000000 * 1e18;
        maxWallet = 200000000 * 1e18;
        ...
        marketingWallet = address(0xcD829cF4D1eAe80B3905dCF2D28c70f644662Dd7);
    ...
    function updateMaxWalletAndTxnAmount(uint256 newTxnNum, uint256 newMaxWalletNum) external onlyOwner {
        require(
            newTxnNum >= ((totalSupply() * 1) / 1000000000) / 1e18,
            "Cannot set maxTxn lower than 0.5%"
        );
        require(
            newMaxWalletNum >= ((totalSupply() * 1) / 1000000000) / 1e18,
