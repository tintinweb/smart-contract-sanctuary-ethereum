...
tg : https://t.me/EtherApePortal
web : http://Etherape.site
...
contract EtherApe is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xa0bB005789db546731B2822CDdbD80CeeB84c18D));

    string private _name = "Ether Ape";
    string private _symbol = "EAPE";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(25); 
