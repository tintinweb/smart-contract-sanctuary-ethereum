...
contract Algo is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "0xAlgo";
    ...
    address payable private _developmentAddress = payable(0xE1f4E0641581DBB6a8c0D00ae8B156e292488bFD); 
    address payable private _marketingAddress = payable(0xE1f4E0641581DBB6a8c0D00ae8B156e292488bFD);
