...
contract WishPresale is Ownable, EIP712 {
    ...
    */
    ...
    /*
    * Allows the specified contributor to buy tokens by sending Ether, verifying the signature against the whitelisted signer
    */
    ...
    /*
    * Sets the whitelist status based on the provided boolean value
    */
    ...
    /*
    * Sets the public address of the signer
    */
    ...
    */
    ...
    /*
    * Get the hash value for a given account address
    */
    function _hash(address account) internal view returns (bytes32) {
        return _hashTypedDataV4(
            keccak256(
                abi.encode(
                    keccak256("WishPresale(address account)"),
                    account
                )
            )
        );
    ...
    /*
    * Recover the address from a given signature and hashed account
    */
