...
contract pumpking is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "PumpKing Inu";
    string private constant tokenSymbol = "PUMPKING";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x8A35B2804f88A3f1F1CEF81BB537F56564001EeB);
        devAddress = payable(0x8A35B2804f88A3f1F1CEF81BB537F56564001EeB);
