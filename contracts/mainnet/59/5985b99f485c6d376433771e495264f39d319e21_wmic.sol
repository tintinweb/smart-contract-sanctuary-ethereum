...
//https://t.me/WildestMonthInCrypto
//https://wildestmonthincrypto.net
...
contract wmic is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 1000000 * 10**8; // 
    uint256 private  TaxSwapAmount = _tTotal * 5 / 100; //
  
    string private constant _name = "Wildest Month In Crypto"; // 
    string private constant _symbol = unicode"WILDMONTH"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xFbabD46C4e4b8E23E4e3659E9679C60e56eF3BBe).transfer(ethToSend); //marketing wallet
    }
