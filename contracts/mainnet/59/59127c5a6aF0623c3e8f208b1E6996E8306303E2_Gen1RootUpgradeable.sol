...
contract Gen1RootUpgradeable is Initializable, ERC721Upgradeable, ERC721BurnableUpgradeable, ERC721PausableUpgradeable, AccessControlMixinUpgradeable, NativeMetaTransactionUpgradeable, IMintableERC721, ContextMixinUpgradeable {
    ...
    function __Gen1Root_init(
        string memory name_,
        string memory symbol_
    ) public initializer {
        __ERC721_init(name_, symbol_);
        __ERC721Pausable_init();
        _setupContractId("Gen1RootUpgradeable");
...
import "./interface/IERC721Upgradeable.sol";
import "./interface/IERC721MetadataUpgradeable.sol";
import "./interface/IERC721EnumerableUpgradeable.sol";
import "./interface/IERC721ReceiverUpgradeable.sol";
import "./ERC165Upgradeable.sol";
import "./library/SafeMathUpgradeable.sol";
import "./library/AddressUpgradeable.sol";
import "./library/EnumerableSetUpgradeable.sol";
import "./library/EnumerableMapUpgradeable.sol";
import "./library/StringsUpgradeable.sol";
...
import {IERC721Upgradeable} from "../../shared/interface/IERC721Upgradeable.sol";
...
abstract contract ContextMixinUpgradeable {
    function msgSender()
        internal
        view
...
import {PortalInitializable} from "./PortalInitializable.sol";

contract EIP712BaseUpgradeable is PortalInitializable {
    struct EIP712Domain {
        string name;
        string version;
    ...
    function _initializeEIP712(string memory name) internal portalInitializer {
