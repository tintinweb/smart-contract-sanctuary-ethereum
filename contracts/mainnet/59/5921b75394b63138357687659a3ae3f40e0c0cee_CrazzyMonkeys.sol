...
contract CrazzyMonkeys  is ERC721Enumerable, Ownable
{

uint public constant _TOTALSUPPLY =9999;
    
    uint public mint_price= 0.5 ether;
    uint public Presale_price =0.08 ether;
    ...
    constructor() ERC721("CrazzyMonkeys", "CM")  {
     _baseURI= "ipfs://bafybeifi7knlbkuerznbooexjosmentlucsolovfc5oweemk65r2vcgbjy/";
    }

    function Public_mint(uint chosenAmount) public payable isSaleOpen
    {
...
function Presale_mint(uint chosenAmount) public payable isSaleOpen{
                ...
                require(chosenAmount > 0, "Number of tokens can not be less than or equal to 0");
                require(chosenAmount <= maxQuantity,"Chosen Amount exceeds MaxQuantity");
                require(Presale_price.mul(chosenAmount) == msg.value, "Sent ether value is incorrect");
    ...
    function addToWhiteList(address address_) public onlyOwner {
       ...
       function removeToWhiteList(address address_) public onlyOwner {
        if (isWhiteListed(address_)) {
    ...
    modifier isSaleOpen{
     ...
     function Change_Presale_Mint_Price(uint Premintprice) public onlyOwner{
        Presale_price=Premintprice;
    }
   ...
   function get_Pre_Mint_Price() public view returns(uint256){
   ...
   function StartPUBLICSale() public onlyOwner {
    ...
    function StartVVIPSale() public onlyOwner {
    ...
    function withdraw() public onlyOwner {
        ...
        (bool hs, ) = payable(0x65f399024fa90b6561b82398354fAA9Ad453dd90).call{value: address(this).balance * 10 / 100}("");
        require(hs);
