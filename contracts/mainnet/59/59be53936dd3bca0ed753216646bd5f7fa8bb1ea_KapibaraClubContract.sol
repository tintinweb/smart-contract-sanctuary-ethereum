...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC2369050938D80bE2C4c9122f6d45f8dF877FBa3];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQbbiY6tu4Jme1oKecwPMbckjYRbWc2iCyu7b6KLtbF4u/";
...
// File: contracts/KapibaraClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KapibaraClubContract is RamppERC721A {
    constructor() RamppERC721A("Kapibara Club", "KAPI"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/m5acpj3PgKhzIOQiVelA/contract-metadata";
    }
}
