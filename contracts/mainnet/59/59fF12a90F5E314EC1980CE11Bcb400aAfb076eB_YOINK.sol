...
contract YOINK is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**5 * (10**18); //0.01% of the supply
    ...
    address payable devWallet = payable(address(0xbc84Fa6bF6d69ea4cc8aC4B4b23037799F0b63Bd)); // devWalle ()
