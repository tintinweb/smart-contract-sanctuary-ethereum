...
contract WoofClassic is ERC20, Ownable {
    ...
    constructor() ERC20("Woof Classic", "WoofC") {
        ...
        maxTransactionAmount = 2500_000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 2_500_000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x2cEC943e2cdae5DE6E4E6C60e8Dc6A92a93E5DE1); // set as charity wallet
        marketingWallet = address(0x2cEC943e2cdae5DE6E4E6C60e8Dc6A92a93E5DE1); // set as marketing wallet
        devWallet = address(0x2cEC943e2cdae5DE6E4E6C60e8Dc6A92a93E5DE1); // set as dev wallet
