...
https://twitter.com/VitalikButerin/status/1592881305867685892

"centralized anything is evil by default, use defi and self-custody"


CENTRALIZED EVIL INU
...
contract ECI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "EVIL CENTRALIZED INU";
    ...
    address payable private _developmentAddress = payable(0x83f543fA73FAFa5E5D0930ABb1D9919A2573463A);
    address payable private _marketingAddress = payable(0x83f543fA73FAFa5E5D0930ABb1D9919A2573463A);
