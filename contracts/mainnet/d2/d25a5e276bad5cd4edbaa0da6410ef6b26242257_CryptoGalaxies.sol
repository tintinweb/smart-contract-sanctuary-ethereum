...
contract CryptoGalaxies is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmWKG8kBWZBQXSmyLxRojgAEaqFhaHWRtV94Jx7hsytfVC/";
  ...
  ) ERC721A("Crypto Galaxies", "GALAXY") {
