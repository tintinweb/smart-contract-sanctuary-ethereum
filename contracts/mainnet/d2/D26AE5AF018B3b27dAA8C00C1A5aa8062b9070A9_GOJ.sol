...
/*
https://medium.com/@GOJcoin/gojira-goj-co-5cc8accf2926 
...
Gojira was a giant monster that lived in the depths of the ocean. 
It was said to be so large that its…
...
contract GOJ is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Gojira";
    string private constant _symbol = unicode"GOJ";
