...
contract CastleOfAllegiance is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmfA4jTHFXPdYzaJMcff7UCJw9zTKM3auLtY6Xrc1JWwWF/";
    uint   public price             = 0.004 ether;
    uint   public maxPerTx          = 20;
    uint   public maxPerFree        = 1;
    uint   public totalFree         = 7000;
    uint   public maxSupply         = 10000;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Castle Of Allegiance", "COA"){}
    ...
    function allegiance(address mintAddress, uint256 count) public onlyOwner {
