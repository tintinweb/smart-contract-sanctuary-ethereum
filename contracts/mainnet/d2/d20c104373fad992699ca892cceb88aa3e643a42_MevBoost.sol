...
Inspired by MevBoost Bot - introducing token which will track blocks with large rewards from mev-boost relays
https://twitter.com/MevBoostBot
...
contract MevBoost is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "MevBoost Bot Tracker";
    string private constant _symbol = "MEVBOOST";
