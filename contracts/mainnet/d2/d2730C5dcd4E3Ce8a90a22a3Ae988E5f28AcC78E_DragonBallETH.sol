...
contract DragonBallETH is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xed44bA1A37F50fAbE0B3fa1Df8E976E6ee803906));

    string private _name = "DragonBallETH";
    string private _symbol = "DGBLL";
