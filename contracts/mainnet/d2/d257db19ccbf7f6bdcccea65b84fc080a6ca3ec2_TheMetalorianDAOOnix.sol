...
// File: contracts/theMetalorianDAOOnix.sol
...
///@title TheMetalorianDAOOnix
///@notice Token ERC721 for the Metalorian DAO
contract TheMetalorianDAOOnix is ERC721, Ownable {   
    ...
    uint256 public constant AVAILABLE_SUPPLY = 300;
   
    ///@notice Maximum number of nft to buy per address
    uint256 public constant LIMIT_NFT_BY_ADDRES = 300;
    ...
    /// ======================================================
    /// ============ Constructor =============================
    constructor() ERC721("The Metalorian DAO Onix", "TMDO") {

        tokenIdCounter.increment();
        baseURI = "ipfs://bafybeicxcqzcjbheng5mqstj43cichhwhvyrwy7zqzb345ctduj3kxq3ne/OnixMetadata/";   
        mintCost = 11 ether;
    }
    ...
    event MintTheMetalorianDAOOnix(address indexed user, uint256 tokenId); 
    ...
    function mintTheMetalorianDAOOnix(uint256 amountNft) external payable {
        ...
        for(uint i; i < amountNft ; i++){
            ...
            emit MintTheMetalorianDAOOnix(msg.sender, tokenIdCounter.current());            
