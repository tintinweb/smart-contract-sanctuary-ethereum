...
https://twitter.com/WatcherGuru/status/1616299635252887552
...
contract GC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Genesis Classic";
    ...
    address payable private _developmentAddress = payable(0x9A6e2BAB7642B887fbA89005B142B1a6c1011eD1);
    address payable private _marketingAddress = payable(0x9A6e2BAB7642B887fbA89005B142B1a6c1011eD1);
