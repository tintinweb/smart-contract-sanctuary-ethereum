...
contract WelcomeSolarTime is Context, IERC20, Ownable {
    uint256 public immutable _buyTax =3;
    uint256 public immutable _sellTax = 2;
    string private _name = unicode"Welcome Solar Time";
    string private _symbol = unicode"-1H";
    uint8 private _decimals = 16;


    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public  _totalSupply = 60000000  * 10**(_decimals);
    bool active=true;  
    bool init=false;
