...
contract Buns is ERC721, ERC2981, DefaultOperatorFilterer, Ownable  {
    ...
    function mint(uint32 count) external payable {
        ...
        require(count < pertrx + 1, "Exceeds max 100 per transaction.");
    ...
    function getPerTransaction() public view returns (uint256) {
        return pertrx;
    }
    ...
    function getMinting() public view returns (bool) {
        return minting;
    }
