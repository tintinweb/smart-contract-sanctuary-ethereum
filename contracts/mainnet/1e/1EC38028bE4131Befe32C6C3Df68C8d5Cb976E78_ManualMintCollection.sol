...
// File contracts/ManualMintCollection.sol

// SPDX-License-Identifier: NONE
pragma solidity ^0.8.2;
contract ManualMintCollection is ERC721, ERC721Enumerable, AccessControl, Ownable {
    using EnumerableSet for EnumerableSet.AddressSet;
    ...
    function _isApprovedOrOwner(address _user, uint256 _tokenId)
        internal
        view
        override(ERC721)
        returns (bool)
    {
        return super._isApprovedOrOwner(_user, _tokenId);
    }
