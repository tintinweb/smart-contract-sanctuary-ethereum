...
// White LINES Matter
// 5/5 tax : 2% dev / 2% marketing / 1% liquidity
// https://t.me/LinesPortal
...
contract LINES is ERC20, Ownable {
    ...
    constructor(address _address) ERC20("White LINES Matter", "LINES") {
		...
		charityWallet = address(0x8A9D947e61803863DF6Db2882715c7e2EF155Ba8); // set as charity wallet
        marketingWallet = address(0x8A9D947e61803863DF6Db2882715c7e2EF155Ba8); // set as marketing wallet
        devWallet = address(0xD313D359a74211bEf58953F1e36Cd00Fb5412749); // set as dev wallet
