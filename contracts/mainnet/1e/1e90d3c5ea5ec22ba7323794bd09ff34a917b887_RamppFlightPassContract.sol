...
// ooooooooo.                                                                                       
// `888   `Y88.                                                                                     
//  888   .d88'  .oooo.   ooo. .oo.  .oo.   oo.ooooo.  oo.ooooo.                                    
//  888ooo88P'  `P  )88b  `888P"Y88bP"Y88b   888' `88b  888' `88b                                   
//  888`88b.     .oP"888   888   888   888   888   888  888   888                                   
//  888  `88b.  d8(  888   888   888   888   888   888  888   888                                   
// o888o  o888o `Y888""8o o888o o888o o888o  888bod8P'  888bod8P'                                   
//                                           888        888                                         
//                                          o888o      o888o                                        
// oooooooooooo oooo   o8o             oooo            .   ooooooooo.                               
// `888'     `8 `888   `"'             `888          .o8   `888   `Y88.                             
//  888          888  oooo   .oooooooo  888 .oo.   .o888oo  888   .d88'  .oooo.    .oooo.o  .oooo.o 
//  888oooo8     888  `888  888' `88b   888P"Y88b    888    888ooo88P'  `P  )88b  d88(  "8 d88(  "8 
//  888    "     888   888  888   888   888   888    888    888          .oP"888  `"Y88b.  `"Y88b.  
//  888          888   888  `88bod8P'   888   888    888 .  888         d8(  888  o.  )88b o.  )88b 
// o888o        o888o o888o `8oooooo.  o888o o888o   "888" o888o        `Y888""8o 8""888P' 8""888P' 
//                          d"     YD                                                               
//                          "Y88888P'                                                               
//                                                                                                  
//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa9dAC8f3aEDC55D0FE707B86B8A45d246858d2E1];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 315 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZCKoApZ6RGU3zAhXNY1V9cLHWimpKCU9g6jwrfC8r4up/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 315");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 315");
...
// File: contracts/RamppFlightPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RamppFlightPassContract is RamppERC721A {
    constructor() RamppERC721A("Rampp FlightPass", "FLY"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/LGJ3lL48wCeVynQ93Yss/contract-metadata";
    }
}
