...
contract SquirtingApes is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmNjQoEoqwe6S9AR8y7bqWMWYQ3eUzbKQCLUFvLBS5qSHZ/";
  ...
  constructor() ERC721("Squirting Apes", "SAYC") {
