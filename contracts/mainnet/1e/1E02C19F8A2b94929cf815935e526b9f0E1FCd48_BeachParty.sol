...
contract BeachParty is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 1335;
    uint256 public immutable supply = 6900;
    ...
    address[] public withdrawAddresses = [0x9A6F23a3979b1B98825368138B29e7c3039c9608, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x44122a5c71fbb7348dff532f9755fda1901d2a29c8a19e52b9a7b334f9fcf812;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x9A6F23a3979b1B98825368138B29e7c3039c9608, _royaltyAmount);
    }
