    ...
    ERC2981SinglePercentual
{
    ...
    uint32 internal constant NUM_EARLY_ACCESS_MINTS = 600;
    ...
    ) ERC721Common("Koripo by Rich Poole", "KORIPO") {
    ...
    function _processMint(address to, uint32 num) internal {
        ...
        if (nextTokenId + num > MAX_NUM_TOKENS)
            revert InsufficientTokensRemanining();
