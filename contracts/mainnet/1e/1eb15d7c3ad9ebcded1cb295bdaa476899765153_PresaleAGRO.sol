...
contract PresaleAGRO is Ownable {
    using SafeMath for uint;

    address public tokenAddr;
    
    uint256 public tokenPriceEth = 50000000000000; // 1 ETH = 20k AGC
    uint256 public tokenDecimal = 2;
    uint256 public ethDecimal = 18;
    uint256 public totalTransaction;
    uint256 public totalHardCap;
    uint256 public minContribution = 1e17;  // 0.1 ETH
    uint256 public maxContribution = 10e18; // 10 ETH
    uint256 public hardCap = 750e18;        // 750 ETH
    ...
    event EthDeposited(address indexed beneficiary, uint amount);
    ...
    /* This will deposit ETH to Contract */
    function depositCrypto() payable public returns (bool){
        uint256 amount = msg.value;
        address userAddress = msg.sender;
        emit EthDeposited(userAddress, amount);
        return true;
    }
    ...
    /* This Function will exchange ETH to Token */    
    function ExchangeETHforToken(address _addr, uint256 _amount) private {
        ...
        require(totalHardCap < hardCap, "ETH Hardcap Reached");
        ...
        tokenExchanged[userAdd] += ethAmount;
        
        emit EthDeposited(msg.sender,msg.value);
    }

    /* This Function will exchange ETH to Token in Manual Call */
    function ExchangeETHforTokenManual() public payable {
        uint256 amount = msg.value;
        address userAdd = msg.sender;
        uint256 ethAmount = 0;
        balances[msg.sender] = balances[msg.sender].add(msg.value);
