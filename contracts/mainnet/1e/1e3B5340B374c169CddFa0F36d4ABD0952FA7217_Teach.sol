...
/*
    Marshall·D·Teach 闇を表し、闇はすべてを飲み込み、
    光があるところには闇があり、
    私たちは闇を表し、
    最後に勝利は私たちのものです
    https://t.me/Darkgodportal
*/
...
contract Teach  is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Dark God";
    string private constant _symbol = "Teach";
