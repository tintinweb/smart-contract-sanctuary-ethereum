...
contract PixelCreatures is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint public          maxFreePerWallet  = 10;
  uint public          totalFree         = 234;
  uint public          maxSupply         = 1234;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("PixelCreatures", "PXC"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Creatures...");
