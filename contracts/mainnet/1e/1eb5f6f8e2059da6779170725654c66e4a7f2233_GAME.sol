...
contract GAME is ERC20, Ownable {
    ...
    constructor() ERC20("The Game", "GAME") {
		...
		charityWallet = address(0x9e7B401bD91759C7D70f5BfDd5400205822f1ACe); // set as charity wallet
        marketingWallet = address(0x9e7B401bD91759C7D70f5BfDd5400205822f1ACe); // set as marketing wallet
        devWallet = address(0x9e7B401bD91759C7D70f5BfDd5400205822f1ACe); // set as dev wallet
