...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 7, 7777 ) {}
...
// File: contracts/BananaGangContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BananaGangContract is RamppERC721A {
    constructor() RamppERC721A("Banana Gang", "BNG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gPt3ucmhtE6FswtOceik/contract-metadata";
    }
}
