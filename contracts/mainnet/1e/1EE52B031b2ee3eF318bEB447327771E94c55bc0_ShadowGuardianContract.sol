...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 15, 2222 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSmki5TPKFpJ67sMPXEh37ipMovNZrdkU8RPFQjnPAiPC/";
...
// File: contracts/ShadowGuardianContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ShadowGuardianContract is RamppERC721A {
    constructor() RamppERC721A("Shadow Guardian", "SHDWGRD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/CvpMrGz2HuJmqBt92grn/contract-metadata";
    }
}
