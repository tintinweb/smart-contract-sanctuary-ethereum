...
contract TatsuyaKazuya is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tatsuya Kazuya", "KAZUYA") {
        ...
        devOpsWallet = address(0x3Af8288DBCBde7A9D570a91078C4e08f98651bc2); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x3Af8288DBCBde7A9D570a91078C4e08f98651bc2), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x3Af8288DBCBde7A9D570a91078C4e08f98651bc2), true);
