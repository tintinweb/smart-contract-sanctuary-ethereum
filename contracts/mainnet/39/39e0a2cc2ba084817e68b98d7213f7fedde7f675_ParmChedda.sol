...
/*    
    ...
    After the explosive movement of Chedda tokens, a worthy version was born by the name of ParmChedda.
    Enormous marketing push straight from launch 
    Spread the word that you're holding PARMCHEDDA and stay tuned for utility!

    NO Team Tokens. Dev funding liquidity and LOCKED 
    ...
    Telegram: https://t.me/ParmChedda
...
contract ParmChedda is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ParmChedda", "PARMCHEDDA") {
        ...
        uint256 totalSupply = 1 * 1e14 * 1e18;
        
        maxTransactionAmount = totalSupply * 25 / 10000; // 0.25% maxTransactionAmountTxn
        ...
        marketingWallet = payable(0xAA5870F76a9d572978883969524D50d62E2dDa73);
        devWallet = payable(0xAA5870F76a9d572978883969524D50d62E2dDa73);
