...
contract Bardt is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmNzFPfgj9RUfPNSWthxRtV5TqKBjH8SdasUtA3EjT5YF8/";
  uint256  public  maxSupply = 888;
  uint256 public  MAX_MINTS_PER_TX = 3;
  uint256 public  PUBLIC_SALE_PRICE = 0.0066 ether;
