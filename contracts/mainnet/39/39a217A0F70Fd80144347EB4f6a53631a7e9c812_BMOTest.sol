...
contract BMOTest is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor(bytes32 _initWhitelistRootHash,string memory _initBaseURI, string memory _initPreviewURI) ERC721A("BMO Test", "BMOT"){
