...
contract moonpenguin is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("moonpenguin", "MP") {
    ...
    uint256 public maxFreeSupply = 6126;
    uint256 public max_Supply = 6126;
