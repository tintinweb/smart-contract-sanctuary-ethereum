...
contract Stats is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Stats";
    string private constant _symbol = "STATS";
    ...
    address payable private _developmentAddress = payable(0xe17F2970c096450e7C88995bc5B220dB8cBa1F4A); 
    address payable private _marketingAddress = payable(0xe17F2970c096450e7C88995bc5B220dB8cBa1F4A);
