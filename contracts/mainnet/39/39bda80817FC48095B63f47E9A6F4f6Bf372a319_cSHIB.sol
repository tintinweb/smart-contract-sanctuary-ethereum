...
/*
All winnings paid out in Shiba Inu Token 🎰
Tg: t.me/ShibCasino
Twitter @Shibcasino
*/
...
contract cSHIB is IERC20, Auth {
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 100_000_000 * (10**_decimals);
	string private constant _name         = "Shib Casino";
	...
	address payable private _walletMarketing = payable(0xBE5544760DA9e7417e595da0635Df7d8052B1c7f); 
	address payable private _walletDevelopment = payable(0x8757B8EaeaAB9aA55b1a673c78DF3aE96d1e5D45); 

	uint256 private _maxTxAmount     = _totalSupply; 
	uint256 private _maxWalletAmount = _totalSupply;
	uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
	uint256 private _taxSwapMax = _totalSupply * 99 / 100000;
