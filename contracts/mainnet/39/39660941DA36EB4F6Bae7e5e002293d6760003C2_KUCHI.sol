...
// Secondly, the KUCHI community will endeavour and have great success within. ~ Dev
...
contract KUCHI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FUTAKUCHIONNA", "KUCHI") {
        ...
        marketingWallet = address(0x6e886Ee2a7961C47934BdEeF0d5422dF0896F3Df); // set as marketing wallet
        devWallet = address(0xF0b0c079925F05Df31320a1Ff5ce9038e244725b); // set as dev wallet
