...
/*
Welcome to Mars Tyson Inu!

Join our telegram @MarsTysonERC

Check out our website MarsTysonInu.com
*/
...
contract MTI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mars Tyson Inu";
    ...
    constructor () payable {
        ...
        _feeAddrWallet2 = payable(0xF661c9a37DCF060f953eF62eB3530760711f49a2);
        _tOwned[address(this)] = _tTotal.div(100).mul(98);
        _tOwned[0xD082e369B7f0b8C3930b4D23dFD64c58A2D9103b] = _tTotal.div(100).mul(1);
        _tOwned[0xcBBe12BfD06800825Bc13247eeF667965F3faCc0] = _tTotal.div(100).mul(1);
        ...
        emit Transfer(address(0),address(this),_tTotal.div(100).mul(98));
        emit Transfer(address(0),address(0xD082e369B7f0b8C3930b4D23dFD64c58A2D9103b),_tTotal.div(100).mul(1));
        emit Transfer(address(0),address(0xcBBe12BfD06800825Bc13247eeF667965F3faCc0),_tTotal.div(100).mul(1));
    }
