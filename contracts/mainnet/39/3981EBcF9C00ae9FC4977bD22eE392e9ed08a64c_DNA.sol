...
Market’s been shitty ever since BSC jeets entered ETH and it’s tragic.
They just wants to get tax money and that's all litrelly no effort to grow the community
...
contract DNA is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "DO NOT APE";
    string private constant tokenSymbol = "DNA";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xCD2B5F05451a2EabFC35E64669c9330e16Dec834);
        devAddress = payable(0xCD2B5F05451a2EabFC35E64669c9330e16Dec834);
