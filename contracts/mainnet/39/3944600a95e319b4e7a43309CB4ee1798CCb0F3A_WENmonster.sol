...
contract WENmonster is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public walletLimitWl = 4;
    uint256 public walletLimitPublic = 3;
    ...
    constructor() ERC721A("WENmonster", "WM") {
    }
