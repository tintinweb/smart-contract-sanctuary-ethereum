...
CTRL-SHIFT-M | $TASKMOONAGER

Auto reducing tax - 8-0%
0% tax after 40 buys
1% transaction / 2% max wallet
LP burned at 100k mcap
No tg 
If you find this interesting, create tg, but not before 20-30k
This will (hopefuly) prevent premature fuds and botters like cryptox and similar jeets like him botting 0% tax/community tokens.
(IT'S ZERO TAX!)

𝒀𝒐𝒖𝒓 𝒐𝒏𝒍𝒚 𝒕𝒂𝒔𝒌 𝒊𝒔 𝒕𝒐 𝒎𝒐𝒐𝒏 𝒕𝒉𝒊𝒔!
...
contract CTRLSHIFTM is Context, IERC20, Ownable { 
    ...
    string private constant _name = "CTRL-SHIFT-M";
    string private constant _symbol = "TASKMOONAGER";
