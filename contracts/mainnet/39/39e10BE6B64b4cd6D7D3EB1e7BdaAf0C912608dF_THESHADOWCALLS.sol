...
contract THESHADOWCALLS {
    function name() public pure returns (string memory) {return "THESHADOWCALLS";}
    function symbol() public pure returns (string memory) {return "SHDW";}
