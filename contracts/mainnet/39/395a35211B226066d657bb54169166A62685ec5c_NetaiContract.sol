...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD4F3e11640F4f31bA63d4861274eEcb746B73072];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 650;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 757) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYekyT2Ln5skAhrLAsRnR55DPvAfDkJe3pcphTLB15fzY/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 757");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 757");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 757");
...
// File: contracts/NetaiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NetaiContract is RamppERC721A {
    constructor() RamppERC721A("NET AI ", "NETiAI"){}
}
