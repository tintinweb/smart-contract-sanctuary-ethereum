...
/*
 * Pride Month token, fees go to support relevant causes.
 * Tokenomics:
...
contract PRIDE is ERC20, Ownable {
    ...
    constructor() ERC20("Pride Month", "PRIDE") {
        ...
        dev = address(0x886285C35006Ac0D7e6830e2690200c4fD5192Ff);
        deployer = _msgSender();
