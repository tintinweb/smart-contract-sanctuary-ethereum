...
contract Pluto is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Pluto", "Pluto") {
        ...
        marketingWallet = address(0xcFd5147CBa0F100C493399a277de9bF23832511B); // set as marketing wallet
        devWallet = address(0xcFd5147CBa0F100C493399a277de9bF23832511B); // set as dev wallet
