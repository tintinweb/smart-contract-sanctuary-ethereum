...
contract Lucy is DefaultOperatorFilterer, Context, ERC721Tradeable {
  ...
  constructor(address _proxyAddress) ERC721Tradeable("Lucy", "LUCYDREAM", _proxyAddress) {
    _baseTokenURI = "ipfs://tbd/";
    payableAddress = payable(0x73A90C7d2E1A43aa33EaB2Df9B286633151435F9);
  }
...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  uint256 internal MAX_SUPPLY = 400;
