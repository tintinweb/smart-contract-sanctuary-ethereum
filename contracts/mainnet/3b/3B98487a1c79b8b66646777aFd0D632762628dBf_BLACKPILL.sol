...
contract  BLACKPILL is Context, IERC20, Ownable {
    ...
    string private _name = "BLACKPILL";
    string private _symbol = "BPILL";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x42493132cD36E7E2E939E64D1900c9b53B129751));
        DcafVz = payable(address(0x42493132cD36E7E2E939E64D1900c9b53B129751));
