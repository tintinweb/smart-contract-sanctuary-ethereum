...
contract BabySuperBowlInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Super Bowl Inu";
    string private constant _symbol = unicode"BSBI";
