...
contract LazyHeroes is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    uint64 public maxSupply = 8000;

    uint64 public publicMaxSupply = 8000;
    uint64 public publicTotalSupply = 0;
    uint64 public presaleMaxSupply = 0;
    uint64 public presaleTotalSupply = 0;

    uint64 public maxMintAmountPerPresaleAccount = 20;
    ...
    constructor() ERC721A("LazyHeroes", "LazyHeroes"){}
