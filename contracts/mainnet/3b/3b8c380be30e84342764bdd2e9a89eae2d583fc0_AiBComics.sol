...
contract AiBComics is ERC721, Ownable, EIP712, ERC2981 {
  using Strings for uint256;
  ...
  constructor(string memory  baseURI) ERC721("AiBlocks Comics", "AIBC") EIP712("AiBlocks Comics", "1") {
      baseTokenURI = baseURI;
  }

  /// @notice Owner mint to reserve
  ...
  function mint(uint256 tokenId) public payable {
        ...
        require(tokenId >= 1 && tokenId <= maxSupply, "invalid claim");
