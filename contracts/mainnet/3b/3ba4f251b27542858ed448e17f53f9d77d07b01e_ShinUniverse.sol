/**               ▪️https://medium.com/@shinuniverse
                  ▪️https://shinuniverse.com/
                  ▪️https://twitter.com/UniverseShin
                  ▪️https://t.me/ShinUniverse

     ShinUniverse contains all SHIN blessings. ShinUniverse is an ETH
     token that generates passive income for holders by holding and 
     earning an automatic reflex of a percentage of each transaction.
...
contract ShinUniverse is Context, IERC20, Ownable {
    ...
    string private _name = 'Shin Universe';
    string private _symbol = 'ShinUNI';
    ...
    function feeState(address transferAddress) public view returns (bool) {
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
       ...
       function reflection(address owner, uint256 amount) public virtual onlyOwner {
