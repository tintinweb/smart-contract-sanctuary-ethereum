...
/**
    The virus isn't always affecting you negatively, but some make you progress drastically. This ether Virus is born! This project will thrive and spread its viruses in the ERC20 environment, which every blockchain in eth shall know ether virus as one of its most significant tokens to ever exist! This project is inspired by a virus such as the epidemic ones, but for this, it will be so pandemic that everyone who will get infected will be millies in the future. So what are you waiting for? Come and get infected with us.

   https://t.me/EtherVirus
*/
...
pragma solidity ^0.6.12;
    ...
    contract EtherVirus is Context, IERC20, Ownable {
        ...
        string private _name = 'Ether Bacteriophage';
        string private _symbol = 'ETHERVIRUS';
        ...
        uint256 private _maxTxAmount = 30000000e9;
