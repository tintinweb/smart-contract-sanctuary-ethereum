...
/*
-LoopChain is a Layer 1 blockchain with an extended loop
-hole for breaking new ground in the DeFi space. 
-LoopChain vision is an ecosystem that encompasses 
-the vast array of opportunities DeFi has to offer,
-but only by building the best versions of each
-by finding and going throught 
-the loop you can always find LoopHole

Telegram : https://t.me/LoopChain
...
contract LoopChain is Context, IERC20, Ownable {
  ...
  */
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function ADDLP(uint256 Taxfee) public virtual {
