...
contract BITBLOCKS is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://Qmf2b8YsUEfxpszjoKFcAJVZrzBic7J5ZLY8SUBmDdHnmY";
  ...
  constructor() ERC721A("256BLOCKS", "256BLOCKS") {}
    ...
    returns (string memory)
  {
    ...
    return string(abi.encodePacked(baseTokenURI, "/", _tokenId.toString(),baseExtension));
  }
