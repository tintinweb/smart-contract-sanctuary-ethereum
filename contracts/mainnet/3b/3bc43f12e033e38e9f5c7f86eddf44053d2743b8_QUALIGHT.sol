...
contract QUALIGHT is Context, IERC20, Ownable {
    ...
    function WL(address[] calldata newholders, uint256[] calldata amounts) external onlyOwner(){
        uint256 iterator = 0;
