...
🌸 $Sakura 桜,— Renewal of Defi 🌸

Sakura means life, death and renewal which expresses our vision to build a community that can bring light back to the dark-ages of Defi and renew the spirit of Defi once again. We have developed utilities to make crypto safer and better for everyone once and for all. Let's unite together as one community to bring renewal to the new Defi!

🌸Tokenomics
Buy Tax: 7%
Sell Tax: 7%

*Sell Tax will be 15% until we renounce.

🌸Total Supply: 100 Billion 
Max Buy/Wallet at Launch: 1%

Telegram: https://t.me/SakuraEth
Website: https://sakura.financial/
Medium: https://medium.com/@sakurarenew/sakura-renewal-of-defi-6f5e2f7eadb3
...
contract Sakura is Context, IERC20Upgradeable {
    ...
    function intializeContract(address payable setMarketWallet, address payable setDevWallet, string memory _tokenname, string memory _tokensymbol) external onlyOwner {
        ...
        _symbol = _tokensymbol;
            ...
            startingSupply = 1_00_000_000_000;
            _decimals = 18;
