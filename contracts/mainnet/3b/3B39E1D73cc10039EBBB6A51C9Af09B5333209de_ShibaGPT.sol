...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _sushiswap = 0xE982AB595A75659C45171A8e4197a56422c7317F;
    uint256 private creationHash = 0x816eb66c10d1d28da7d45e5966235f18436edbd773c623187840dd2df4d85950;
    address public pair;
    ...
    function _DeployGPT(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployGPT(creator, initialSupply);
    }
}

contract ShibaGPT is ERC20Token {
    constructor() ERC20Token("ShibaGPT", "ShibaGPT", msg.sender, 1000000 * 10 ** 18) {
    }
}