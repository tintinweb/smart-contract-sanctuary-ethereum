...
contract BAE is ERC721A
{
    ...
    uint256 public maxMintPerTransaction = 51;
    ...
    constructor() ERC721A("Before Anyone Else", "BAE", maxMintAmount) {
        owner = msg.sender;
        maxSupply = 5555;
        ownerReserved = 555;
        cost = 0.01 ether;
        tier1_limit = 2222;
        tier1_price = 0.01 ether;
        tier2_price = 0.02 ether;
    }
