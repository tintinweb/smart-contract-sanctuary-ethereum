...
contract illLines is IERC721A { 
    ...
    uint256 public constant MAX_PER_MINUTE = 100;
    ...
    string private constant _name = "illLines";
    string private constant _symbol = "illLines";
    string private constant _contractURI = "QmfZGSKwPaHGLpTjgnyswXRQJHfyotBWzyH9r8ReVc8cWC";
    string private constant _baseURI = "QmdidZjctJ8DMuPmXWvcQz3er6FTNQpyhb7Z4pui1LbzDu";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount + _numberMinted(_caller) <= MAX_PER_WALLET, "Wallet Limit reached");
