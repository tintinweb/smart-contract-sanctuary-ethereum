...
contract LittleTsuka
 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "LittleTsuka";
    string private _symbol = "$LILTSUKA";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc1e13ba93b257Cb0818a08789e4a014BA320227F));
        _metawallet = payable(address(0xc1e13ba93b257Cb0818a08789e4a014BA320227F));
