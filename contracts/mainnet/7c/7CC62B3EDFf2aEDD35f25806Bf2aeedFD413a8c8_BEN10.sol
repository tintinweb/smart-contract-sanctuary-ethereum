...
contract BEN10 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ben 10";
    ...
    address payable private _marketingAddress = payable(0x4b70daB331E6Ba28f26c33e1E8684619646C240F);
    ...
    uint256 public _maxTxAmount = 1250000 * 10**9; //0.75
    uint256 public _maxWalletSize = 1250000 * 10**9; //1.5
