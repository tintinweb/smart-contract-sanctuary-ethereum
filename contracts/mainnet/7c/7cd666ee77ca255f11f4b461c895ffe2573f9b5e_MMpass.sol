...
// you need to use conctractot-aka erc721 in somewhere in the code



contract MMpass is ERC721, Ownable{
    ...
    constructor ( ) payable ERC721("MelaMarketplace Pass", "MMpass"){
