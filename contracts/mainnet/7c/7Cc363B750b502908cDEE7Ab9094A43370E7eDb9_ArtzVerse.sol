...
contract ArtzVerse is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public mintRate = 0.55 ether;
    uint public MAX_SUPPLY = 10000;

    constructor() ERC721("ArtzVerse", "MNFT") {}
    ...
    // The following functions are override required by Solidity
