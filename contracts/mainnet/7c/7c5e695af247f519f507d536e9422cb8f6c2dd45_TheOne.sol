...
contract TheOne is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x577Ca23bd6C7C01431C2C8AD68f2ff25340B3195); 
    address payable private _marketingAddress = payable(0x577Ca23bd6C7C01431C2C8AD68f2ff25340B3195);
