...
/**
Long, long ago in the province of ERC20 there lived an elite token named Tale Of Urashima. Urashima was the most skilful dev in all that countryside and could send more charts in a day than his comrades could in a year.

Today, Urashima will launch 浦島 太郎 and return 100 years later. It gives us the highest pleasure to welcome you to our kingdom. For we are here to stay for hundreds of years.
 */
...
contract TaleOfUrashima is ERC20, Ownable {
    ...
    constructor() ERC20("Tale Of Urashima", unicode"浦島 太郎") {
        ...
        devWallet = address(0xb7E474B17C1A9B1A6300B46049cBcef5B2652DAB); // set as dev wallet
