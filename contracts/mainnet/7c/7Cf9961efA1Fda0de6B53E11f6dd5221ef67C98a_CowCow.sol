...
contract CowCow is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "CowCow";
    string private constant _symbol = "COWCOW";
    ...
    address payable private _developmentAddress = payable(0xB2E8286200509C658361aE5B23039Eb13ffD3192);
    address payable private _marketingAddress = payable(0xB2E8286200509C658361aE5B23039Eb13ffD3192);
