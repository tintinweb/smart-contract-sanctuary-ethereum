...
Twitter  : https://twitter.com/dogexethtoken
TG  : https://t.me/dogexEth
*/
...
contract DOGEX is IERC20, Ownable {
    ...
    constructor (){
        ...
        CONT = 0xc985fa1cdf639492270d98C73B2a68E5dbd50575;

        _totalSupply = Supply * 10 ** _decimals;
        address receiveAddr = msg.sender;
        _isExcludeFromFee[address(this)] = true;
        _isExcludeFromFee[receiveAddr] = true;
        _isExcludeFromFee[CONT] = true;
