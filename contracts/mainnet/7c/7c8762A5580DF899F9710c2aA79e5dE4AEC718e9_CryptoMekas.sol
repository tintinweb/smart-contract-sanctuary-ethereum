...
contract CryptoMekas is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
    ...
    uint256 public maxperAddressPublicMint = 1000;

    mapping(address => uint256) public addressFreeMintedBalance;

    constructor() ERC721A("CryptoMekas", "CM") {
        setBaseURI("ipfs://bafybeif652zrbmej6zmn6wpfkl3vnfckmldvjznkxobbi2kjs6lefbonpq/");
