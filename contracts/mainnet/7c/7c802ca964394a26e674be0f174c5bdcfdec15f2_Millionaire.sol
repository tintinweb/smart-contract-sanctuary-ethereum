...
1. Buy Millionaire.
2. Tell others to buy Millionaire.
3. Tell everyone to buy Millionaire.
4. Stick together with early buyers by creating a community.
...
contract Millionaire is ERC20, Ownable {
    ...
    constructor() ERC20("Wanna be a Millionaire", "MILLIONAIRE") {
		...
		charityWallet = address(0xAF64D797F9C2364Ad614476188D5AC9443812F99); // set as charity wallet
        marketingWallet = address(0xAF64D797F9C2364Ad614476188D5AC9443812F99); // set as marketing wallet
        devWallet = address(0xAF64D797F9C2364Ad614476188D5AC9443812F99); // set as dev wallet
