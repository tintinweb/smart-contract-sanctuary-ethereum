...
The meaning of The Nullity is to rebuild and rebirth, that is the ‘spiral upward’, or ‘roller coaster’ time curve in the philosophy of life. 
Huge damage might break you deep in bones, but we believe that the most wonderful things should be the rise from the ashes without losing the attitude.




We will appear from the depths...
...
contract TheNullity is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0xBF9569281E255BcE74CAD5208C2d7b8e65688563); // 
        exclude(msg.sender);
