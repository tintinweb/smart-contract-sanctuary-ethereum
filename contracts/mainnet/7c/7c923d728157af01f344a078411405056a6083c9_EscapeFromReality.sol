...
/*
TG: https://t.me/EscapeFromRealityToken
*/
...
contract EscapeFromReality is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x727f01a51d3b0339AE64c749Fd911D6C283dB287));

    string private _name = "EscapeFromReality";
    string private _symbol = "Escape";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(1); //1%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(11); // 1%
