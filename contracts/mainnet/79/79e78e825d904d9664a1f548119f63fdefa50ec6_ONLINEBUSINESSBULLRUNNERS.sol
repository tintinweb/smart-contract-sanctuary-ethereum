...
contract ONLINEBUSINESSBULLRUNNERS is ERC721, Ownable {
    constructor(string memory _uri, address payable _team_wallet) ERC721
    ("ONLINE BUSINESS BULLRUNNERS", "OBBR")
    {
        notRevealedUri = _uri;
    ...
    uint public team_price = 0.008 ether;
    uint public team_balance = 0;

    
    mapping(uint256 => bool) runpasses;
    address public RUNPASS_CONTRACT_ADDRESS = 0xd9145CCE52D386f254917e481eB44e9943F39138;
