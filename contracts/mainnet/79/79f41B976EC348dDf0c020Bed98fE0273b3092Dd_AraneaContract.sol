...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x880AB5B1F73bD472bD74438bA65CFB3919686601];
  address public erc20Payable = 0x880AB5B1F73bD472bD74438bA65CFB3919686601;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 1470) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPesAyMs2oQD8tu2TSJgSKACtdGP9Nf2AAZdvT5HfAHA7/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/xSuXxwmCMZLyVbqw4hhQ/contract-metadata";
  }
...
// File: contracts/AraneaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AraneaContract is RamppERC721A {
    constructor() RamppERC721A("Aranea", "Aranea"){}
}
