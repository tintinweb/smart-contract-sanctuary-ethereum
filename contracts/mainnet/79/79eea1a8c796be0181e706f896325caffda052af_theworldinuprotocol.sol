...
THE WORLD INU PROTOCOL will have many utilities and will be released in the short term.
For now, just follow the official Twitter for when there will be new communications about the community, website and more.
Initial sniper bots will be blacklisted and after that the lp will be locked and ownership will be renounced.
0% Tax
...
contract theworldinuprotocol is ERC20, Ownable {
    ...
    constructor() ERC20("THE WORLD INU PROTOCOL", "TWIP") {
