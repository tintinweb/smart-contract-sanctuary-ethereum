...
/* 
        ...
        $Revert has no use case. Stealth launch and community do as you please. Website will be released 
        if members decide to make the social medias such as TG, Twitter, etc. Whale-proof. Focused on LP. 1% tax
        for buy-backs.
...
contract $REVERT is ERC20, Ownable {
    ...
    constructor() ERC20( "State of Mind", "$REVERT") {
        ...
        operationsAddress = address(0x6F50029448561AA0Cf921C1a7886635a18F8A9BC); 
        TaxAddress = address(0x6F50029448561AA0Cf921C1a7886635a18F8A9BC); 
