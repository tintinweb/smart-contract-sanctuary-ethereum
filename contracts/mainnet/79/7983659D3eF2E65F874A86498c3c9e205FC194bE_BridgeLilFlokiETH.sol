...
contract BridgeLilFlokiETH is Context, Ownable {
    ...
    address public lilfloki;
    address public system = address(0x6d790570E091a08328493F0b3D6349D652D3BB4E);
    ...
    constructor() {
        ...
        _processedFees[56] = 0.005 ether;
    }


    function updateLilflokiContract(address _lilfloki) external onlyOwner {
       lilfloki = _lilfloki;
   }
    ...
    function swapBack(
       ...
       if(fees > 0) {
            TransferHelper.safeTransfer(lilfloki, bridgeFeesAddress, fees);
       }
       
        TransferHelper.safeTransfer(lilfloki, to, temp);
    }
