...
contract LBI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Liquidity Burn Inu";
    string private constant _symbol = "LBI";
    ...
    address payable private _devAdd = payable(0x3fDa4F2f730AA394B99a9Bd538cA7e59954f6CE1);
    address payable private _mktAdd = payable(0x3fDa4F2f730AA394B99a9Bd538cA7e59954f6CE1);
    ...
    constructor() {
        ...
        _isExcludedFromFee[_mktAdd] = true;
