...
/**
    ...
    🌐Website:   https://www.grandi.finance
    📷Instagram: https://www.instagram.com/grandi_token
    💬 Telegram: https://t.me/grandi_token
...
contract GRANDI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address[] memory e) ERC20("Grandi Token", "Grandi") {
        ...
        marketingWallet = address(0x2d6cB2f0F8B37A1De18BDace95C7d1753551E1FB);
        devWallet = address(0x55E9829272c8a52E1d58935F6E2eD8837eB7eE68);
        ...
        if (limitsInEffect) {
            if (
                ...
                if (
                    ...
                    //this is a buy, so we need to check if the amount is below the max limit
                    require(amount <= maxTransactionAmount);
                    require(amount + balanceOf(to) <= maxWallet);
                } else if (
                    //this is a sell, so we need to check if the amount is below the max limit
