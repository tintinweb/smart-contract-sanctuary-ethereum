...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1658991600;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1658646000;
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x42A3520CdfaC7138A3C3D12d76D0F5AcB6298f22,0xaCCb7Ef22d7c578Cf05a6EC34bF99ba329272312];
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 11000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeieybm35kdy5cb2lbsam6cisaqa3udkuu7lokes56odlm3ut3qhj7y/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 11000");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 11000");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 11000");
...
// File: contracts/AkozeeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AkozeeContract is RamppERC721A {
    constructor() RamppERC721A("Akozee", "AKOZEE"){}
}
