...
abstract contract Ownable is Context {
    ...
    function _transferOwnership(address newOwner) internal virtual {
        ...
        contract CultOfEther_Elixirs is ERC721A, Ownable {
        using Strings for uint256;

            // Name & Symbol of Project in Constructor 
            constructor() ERC721A("Cult Of Ether Elixirs", "COEE") {}

            //max supply is set to 13332
            uint16 public constant maxSupply = 13332;
            // uriPrefix is the BaseUri
            string public uriPrefix = "ipfs://QmRThQPRGsG8zzdcgSC1FDFRkw49S4rNbhVRh66XSxU86i/";
            string public uriSuffix = ".json";
            string public hiddenURL = "ipfs://QmYT7tTcJwLjL3V2aCEsgqjiSyDRQ8ZVidFqDzgPdg5XMe/elixir.json" ;
            //cost for Pulic Mint
            uint256 public PublicCost = 0.0006 ether;
            //cost for WL Mint
            uint256 public WLCost = 0.0006 ether;
