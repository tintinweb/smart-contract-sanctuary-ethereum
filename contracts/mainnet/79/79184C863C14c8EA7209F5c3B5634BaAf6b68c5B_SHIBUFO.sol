...
Shiba Inu from the far corners of the space.

$SHIBUFO

http://www.shibufo.com/

https://t.me/SHIBUFO


https://twitter.com/SHIBUFO
...
contract SHIBUFO is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Inu From Space", "SHIBUFO") {
        ...
        maxTransactionAmount = 200000000  * 1e18; // 1% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0xE222eDc4fAc1cAca610de38E3C10e68e9Da32673); // set as charity wallet
        marketingWallet = address(0xE222eDc4fAc1cAca610de38E3C10e68e9Da32673); // set as marketing wallet
        devWallet = address(0xE222eDc4fAc1cAca610de38E3C10e68e9Da32673); // set as dev wallet
