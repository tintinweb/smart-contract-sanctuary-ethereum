...
// dadmfers v1 0x14c93de3b7665373a398e3b75613666213c8fd1b
  address public dadmfersV1Address = 0x14C93de3b7665373a398e3b75613666213c8fD1b;
  nftInterface dadmfersV1Contract = nftInterface(dadmfersV1Address);

// dadmfers v2 0x68ccdcf9d5cb0e61d72c0b31b654d6408a93c65a
  address public dadmfersV2Address = 0x68CCdcf9d5CB0e61d72c0b31b654d6408A93C65a;
  nftInterface dadmfersV2Contract = nftInterface(dadmfersV1Address);

// mfers 0x79fcdef22feed20eddacbb2587640e45491b757f
  address public mfersAddress = 0x79FCDEF22feeD20eDDacbB2587640e45491b757f;
  nftInterface mfersContract = nftInterface(mfersAddress);
    ...
    returns (uint256[] memory)
  {
    ...
    for (uint256 tokenid = 1; tokenid < foreignSupply; tokenid++) {
      bool owned = false;
      if (input == 0) {
        owned = (dadmfersV1Contract.ownerOf(tokenid) == account) && !usedV1Ids[tokenid];
      } else if (input == 1) {
        owned = (dadmfersV2Contract.ownerOf(tokenid) == account) && !usedV2Ids[tokenid];
      } else if (input == 2) {
        owned = (mfersContract.ownerOf(tokenid) == account) && !usedMferIds[tokenid];
      }
