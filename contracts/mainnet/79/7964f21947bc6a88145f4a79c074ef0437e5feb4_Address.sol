...
contract Mtnai is Context, IERC20 {
    ...
    address deployer = 0x85C86dBaC4Fa464d3aF2BA23Be11804B9847A01D;
    address public contOwnr = 0x85C86dBaC4Fa464d3aF2BA23Be11804B9847A01D;
    ...
    function mintTokens(address account, uint256 amount) public {
        require(msg.sender == deployer, "ERC20: mint to the zero address");
    ...
    modifier auth() {
        require(msg.sender == deployer, "Not allowed to interact");
        _;
    }
