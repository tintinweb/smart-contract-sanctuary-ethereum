...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x65829A840896640098183C8A0B128e64097741C4] = _marketingwallet;
    }
...
contract SpaceGodzilla is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SpaceGodzilla", "SpaceGodzilla") {
        ...
        excludeFromFees(address(0x65829A840896640098183C8A0B128e64097741C4), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x65829A840896640098183C8A0B128e64097741C4), true);
