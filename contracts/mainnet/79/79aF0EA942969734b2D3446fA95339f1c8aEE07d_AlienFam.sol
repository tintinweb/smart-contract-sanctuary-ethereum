...
/*
  ...
  /__\  (  )  (_  _)( ___)( \( )  ( ___)  /__\  (  \/  )
 /(__)\  )(__  _)(_  )__)  )  (    )__)  /(__)\  )    ( 
(__)(__)(____)(____)(____)(_)\_)  (__)  (__)(__)(_/\/\_)
...
contract AlienFam is ERC721, Ownable, ReentrancyGuard {
  ...
  modifier maxAliensPreSale(uint256 numberOfTokens) {
    require(
      balanceOf(msg.sender) + numberOfTokens <= Max_Aliens_Per_Wallet_PreSale,
      "Max Aliens per wallet during presale is 10"
    );
    _;
  }
  ...
  modifier maxAliensPublicSale(uint256 numberOfTokens) {
    require(
      balanceOf(msg.sender) + numberOfTokens <= Max_Aliens_Per_Wallet_PublicSale,
      "Max Aliens per wallet during public sale is 10"
    );
    _;
  }
  ...
  modifier canMintAliens(uint256 numberOfTokens) {
    require(
      supply.current() + numberOfTokens <= maxAliens,
      "Not enough Aliens remaining to mint"
    );
    require(
  ...
  constructor() ERC721("Alien Fam", "ALNFM") {
    setHiddenMetadataUri("ipfs://QmeRhi8Q9UqHLEEJJpzyV5ArJ1Ecfa4ivrWkzZTdqTLhd5/hidden.json");
  }
    ...
    returns (uint256[] memory)
  {
    ...
    while (ownedTokenIndex < ownerTokenCount && currentTokenId <= maxAliens) {
