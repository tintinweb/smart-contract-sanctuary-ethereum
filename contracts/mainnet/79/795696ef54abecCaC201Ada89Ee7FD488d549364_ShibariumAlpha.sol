...
/**
Shibarium Alpha provides users with staking capabilities, allowing users to earn rewards for holding the token in their accounts. Additionally, a suite of tools are available for Shibarium users, such as trackers, portfolio management and a wallet for increased security. 

Telegram: https://t.me/ShibariumAlphaEth
...
contract ShibariumAlpha is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shibarium Alpha";
    string private constant _symbol = unicode"ALPHASHIB";
