...
Bla bla bla bla bla...
Everything and everyone bla blas...
We are going to make this $bla. very big and very good.
Bla bla bla...

0% buy
8% sell
Taxes will be reduced to 0/6% after burn, renounce will follow.

Starting a day with bullish lp burn (at 15k, pinky promise) ((have no trust, don't ape))

Only for people with strong heart! (1% max tx / 2% max wallet) / 0.5eth lp
...
contract blabla is ERC20, Ownable {
    using SafeMath for uint256;
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xcF85CE1670ad955e0E6BDBef023534F74a907B1C); // set as marketing wallet
        devWallet = address(0xcF85CE1670ad955e0E6BDBef023534F74a907B1C); // set as dev wallet
