...
contract RoyalFamily is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 6666;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmSpL6rVyrjZuFYKRiocL73d93eFa8DDaduuwmPKRoybRW/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Royal Family Fools", "RF", MAX_MINTS, MAX_SUPPLY) {  
    }
