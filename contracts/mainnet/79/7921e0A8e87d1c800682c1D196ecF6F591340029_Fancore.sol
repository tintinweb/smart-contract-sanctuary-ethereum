...
import './ERC1155Fancore.sol';

contract Fancore is  ERC1155Fancore {

constructor(string memory _name,
    string memory _symbol,
    string memory _uri) public ERC1155Fancore(_name, _symbol, _uri){
...
contract ERC1155Fancore is ContextMixin, ERC1155Burnable, ERC1155Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 public mint_price = 55000000000000000;
    ...
    function mintNFT(address _to, uint256 _quantity) public payable nonReentrant {
        require(_quantity > 0);
