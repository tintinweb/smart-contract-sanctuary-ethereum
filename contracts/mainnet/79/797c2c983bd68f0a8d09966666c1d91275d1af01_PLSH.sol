...
contract PLSH is ERC20, Ownable {
    ...
    constructor() ERC20("Pulse Hati", "PLSH") {
        ...
        maxTransactionAmount = 13333332 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 13333332 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x8a9970Ac468eA337Fe60941C752dcF7A43732f93); // set as charity wallet
        marketingWallet = address(0xf59657F9f2429d23160F1Fd0F14E8BB384acC328); // set as marketing wallet
        devWallet = address(0xd63D6f00dc55934B3D9142D79c33aB167363cCdB); // set as dev wallet
