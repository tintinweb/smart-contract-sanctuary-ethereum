...
contract NUTSUKAERC20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tsuka Deez Nuts";
    string private constant _symbol = "NUTSUKA";
