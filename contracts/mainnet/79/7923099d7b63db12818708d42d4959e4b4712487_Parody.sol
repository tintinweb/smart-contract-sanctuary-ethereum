...
contract Parody is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Parody"; 
    ...
    address payable private _developmentAddress = payable(0x7DCe0559447ac7E456Bc5fEa6e4B1dCd8935B73f);
    address payable private _marketingAddress = payable(0x6b886f8C7bEa4001e0DCac6b8f2Ed5038dAF2fA9);
