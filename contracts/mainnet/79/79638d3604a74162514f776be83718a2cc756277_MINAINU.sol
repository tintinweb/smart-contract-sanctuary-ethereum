...
contract MINAINU is ERC20, Ownable {
    ...
    constructor() ERC20("MINA INU", "MINA") {
        ...
        marketingWallet = address(0x617b69914AEb3cFd09feA1958CaC6bf185EEfD27); // set as marketing wallet
        buybackWallet = address(0x1e3AD0672F4b0Ff0cC6961209AC8a4a70cFC4393); // set as dev wallet
        rewardContract = address(0xF16496479821E6e2d404C053749BCd053567E08B); //staking contract address
