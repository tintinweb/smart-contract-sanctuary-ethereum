...
contract ProofOfDione is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof of Dione";
    string private constant _symbol = "DIONE2.0";
