...
contract PEPAYFeeSplitter is Ownable, ReentrancyGuard {
    ...
    uint256 public MIN = 1000000 * 10 ** 18;
    ...
    function setTEAMWallet(address _address) external onlyOwner {
        ...
        emit TeamWalletChanged(_address);
    }
    ...
    function setMin(uint256 min_) external onlyOwner {
        MIN = min_;
        emit MinValueChanged(min_);
    }
}