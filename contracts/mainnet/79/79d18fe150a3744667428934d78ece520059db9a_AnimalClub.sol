...
contract AnimalClub is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4444;
    uint256 public MAX_MINTS = 4;
    string public baseURI = "ipfs://QmbtdPT2UvGkiQVVJSi9znCMAtLRCpSYJwUuFxqGJDWWAu/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Animal Club", "ANIMAL", MAX_MINTS, MAX_SUPPLY) {  
    }
