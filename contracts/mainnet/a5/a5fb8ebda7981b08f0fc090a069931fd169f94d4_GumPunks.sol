...
// File contracts/GumPunks.sol


contract GumPunks is ERC721A, Ownable {

    string public baseURI = "ipfs://QmTxuPhVPHLX27bRtq4Px9tWWouR63osyAJ9K9xtSF7HRk/";
    ...
    constructor() ERC721A("GumPunks", "GP") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(MAX_PER_TX >= minted[_caller] + _amount, "Excess max per free wallet");
