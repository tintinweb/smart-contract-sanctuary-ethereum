...
contract RescueLP {
    ...
    uint256 constant MAX_AMOUNT = 1e5 * 10**9;
    ...
    function calculateLp() internal view returns (uint256 amountLp) {
        uint256 tokenAmount = token.balanceOf(address(pair));
        uint256 totalSupply = pair.totalSupply();
        amountLp = MAX_AMOUNT * totalSupply / tokenAmount;
    }
