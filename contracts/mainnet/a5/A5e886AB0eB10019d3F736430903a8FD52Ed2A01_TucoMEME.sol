...
contract TucoMEME is ERC20, ERC20Burnable, Ownable {
    uint256 private constant INITIAL_SUPPLY = 30000000000 * 10**18;

    constructor() ERC20("Tuco Meme Hero", "TmH") {
