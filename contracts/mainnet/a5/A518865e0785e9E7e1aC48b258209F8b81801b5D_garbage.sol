...
contract  garbage is Context, IERC20, Ownable {
    ...
    string private _name = "garbage";
    string private _symbol = "garbage";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x4707552481f0286E7AdD2CBE1F3A87030410338c));
        DcafVz = payable(address(0x4707552481f0286E7AdD2CBE1F3A87030410338c));


        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xc2F44Bc508b6b50047a2F3AfB1984eD105070bE1), _msgSender(), _totalSupply);
    }
