...
contract CHUPACABRA is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost3 = 0.002 ether;
  uint256 public cost4 = 0.003 ether;
  uint256 public maxSupply = 6666;
  uint256 public maxMintAmount = 5;
  uint256 public maxMintAmountPerW = 5;
  ...
  function calculatePrice() public view returns (uint256) {
        ...
        if (currentSupply >= 4667) {
            return cost4;
        } else if (currentSupply >= 2667) {
            return cost3;
        } else if (currentSupply >= 667) {
            return cost2;
        } else {
            return cost1;
        }
  ...
  function setadjprice(uint256 _cost1, uint256 _cost2, uint256 _cost3,uint256 _cost4) external onlyOwner {
        cost1 = _cost1;
        cost2 = _cost2;
        cost3 = _cost3;
        cost4 = _cost4;
 ...
 function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0x975b1FB3A54D6665D0FE1677766342eF787A08ED).call{value: address(this).balance * 5 / 100}("");
    require(hs);
