...
// File: contracts/Crypt3DPunks.sol
...
contract Crypt3DPunks is ERC1155, Ownable {

    string public constant name = "Crypt3D Punks";

    string public constant symbol = "CRYPT3D";
    ...
    uint256 public constant preSaleUnitPrice = 0.05 ether;

    uint32 public constant preSaleMaxPerWallet = 2;



    uint32 public preSaleStart = 1646611200;

    uint32 public preSaleEnd = 1646740800;



    uint256 public constant publicSaleUnitPrice = 0.07 ether;

    uint32 public constant publicSaleMaxPerWallet = 10;



    uint32 public publicSaleStart = 1646913600;
    ...
    address private signerAddress = 0x5A8A76Ea7278803143294f1F9Ce418dd7Ed4c564;
    ...
    function setPreSaleStart(uint32 start) external onlyOwner {
    ...
    function setPreSaleEnd(uint32 end) external onlyOwner {
    ...
    function setPublicSaleStart(uint32 start) external onlyOwner {
    ...
    function preSaleMint(
        ...
        require(isValidAccessMessage(v, r, s), "Invalid access message.");
    ...
    function withdraw() external onlyOwner {
        ...
        address[2] memory addresses = [
            ...
            0xAffc1EB9AA0fC1659A99eE719789105D3487F221,
        ...
        uint32[2] memory shares = [uint32(9500), uint32(500)];
