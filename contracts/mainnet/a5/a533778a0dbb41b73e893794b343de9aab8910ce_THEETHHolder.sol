...
/**
Telegram: https://t.me/THEETHHolder
*/
...
contract THEETHHolder is IERC20, Ownable {
    ...
    string constant _name = "THEETHHolder";
    string constant _symbol = "THE ETH H";
    ...
    function setFee(uint256 _marketingFee) external onlyOwner {
          ...
          require(marketingFee <=99,"Fee should be less than 99%");
    }
