...
// File: contracts/DoodleMushroom.sol
...
contract DoodleMushroom is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(tokens <= MaxperWallet, "Max Mint Amount per Trx Exceeded");
    ...
    require(tokens > 0, "Need to Mint at Least 1 NFT");
    require(tokens <= MaxperWalletFree, "Max Mint per Trx Exceeded");
