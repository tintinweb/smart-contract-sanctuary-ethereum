...
contract KangarooFightClub is ERC721, Ownable {
  ...
  uint256 private reserveAtATime = 40;
  uint256 private reservedCount = 0;
  uint256 private maxReserveCount = 80;
  ...
  constructor(string memory baseURI) ERC721("Kangaroo Fight Club", "KFC") {
    setBaseURI(baseURI);
  }
