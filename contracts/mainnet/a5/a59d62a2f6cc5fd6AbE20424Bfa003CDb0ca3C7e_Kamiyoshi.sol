...
Kamiyoshi
Ryoshi has given us so much we can’t even name it While being anonymous 
Ryoshi has always supported his community and holded upon ShibaInu even though it was dead for first few months. 
We can resemble Ryoshi to a God entity as he shows same characteristics of a true worthy God
...
contract Kamiyoshi is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "God RYOSHI";
    string private constant _symbol = "KamiYoshi";
    ...
    address payable private _developmentAddress = payable(0x3C4d99e51039a83140BC553439DB5cc1e4Ac8981);
    address payable private _marketingAddress = payable(0x3C4d99e51039a83140BC553439DB5cc1e4Ac8981);
