...
//https://t.me/t1000erc20
//https://twitter.com/T1000erc20
...
contract T1000 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "T1000";
    string private _symbol = "T1000";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x582042Bcfe5C8CEc5bfbb9b50224c983F5D2A182); // Marketing Address
    address payable public teamWalletAddress = payable(0x582042Bcfe5C8CEc5bfbb9b50224c983F5D2A182); // Team Address
