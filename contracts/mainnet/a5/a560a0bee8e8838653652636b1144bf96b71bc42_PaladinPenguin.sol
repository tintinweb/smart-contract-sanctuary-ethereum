...
contract PaladinPenguin is ERC721, Ownable {
	using Counters
	for Counters.Counter;
	Counters.Counter private _tokenIds;
	
	
	uint public constant MAX_TOKENS = 9823;
	uint public constant MAX_TOKENS_VIP = 33;
	...
	string public CURR_ROUND_PASSWORD = "c4ca4238a0b923820dcc509a6f75849b";
	...
	constructor() ERC721("Paladin Penguin Club", "PaladinPenguinClub") {
		setBaseURI("http://api.paladinpenguinclub.com/paladin1/");
	}
