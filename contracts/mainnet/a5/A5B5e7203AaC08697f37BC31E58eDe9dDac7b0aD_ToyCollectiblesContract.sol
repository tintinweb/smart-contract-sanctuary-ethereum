...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x1595d8ACE0d4AFe3600f71944C379B2Dc14416bA];
  address public erc20Payable = 0x1595d8ACE0d4AFe3600f71944C379B2Dc14416bA;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 450) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lB69pZWKx27u7VqTiIwE/contract-metadata";
  }
...
// File: contracts/ToyCollectiblesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ToyCollectiblesContract is RamppERC721A {
    constructor() RamppERC721A("Toy Collectibles", "Toys"){}
}
