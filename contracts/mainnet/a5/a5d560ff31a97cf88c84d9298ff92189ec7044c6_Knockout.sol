...
/**
    Knockout Streams ERC20 Token
    https://t.me/knockoutstreams
*/
...
contract Knockout is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x7DD4E2378c32Ce492925b5291B091F2296Ddc708); // Marketing Address
    address payable public multiSigAddress = payable(0x59c1e2EB3bc1CfC2ac79B7755e8D9C1A07a10292); // Multisig Address
    address payable public devAddress = payable(0x28b3748b2e57592EFBB1aCaf631eBC666DBc30c1); // Dev Address
    address payable public liquidityAddress = payable(0x59c1e2EB3bc1CfC2ac79B7755e8D9C1A07a10292); // Liquidity Address
    ...
    string private constant _name = unicode"Knockout Streams";
    string private constant _symbol = unicode"KOTV";
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMultiSigFee + _sellDevFee + _sellMarketingFee <= 900, "Must keep taxes below 90%");
    }
