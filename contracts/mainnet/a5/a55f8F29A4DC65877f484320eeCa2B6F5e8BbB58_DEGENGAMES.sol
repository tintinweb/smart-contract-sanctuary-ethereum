...
contract DEGENGAMES is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "DEGENGAMES";
    string private constant tokenSymbol = "DEGENGAMES";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xF5C16F1D75ba271bbc9601472E8eb9B43B8c6274);
        devAddress = payable(0xF5C16F1D75ba271bbc9601472E8eb9B43B8c6274);
