...
/**
*/
//   The Reaper is not tasked to kill mortals, but merely ferry their souls to the afterlife.
//
//   He is Death. He is Power. He is the last thing we see before our souls leave our bodies.
//
//   Telegram - https://t.me/r3ap3r_erc20
//
//   Twitter  - https://twitter.com/r3ap3r_ERC20
//
//     ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀  ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣠⢖⣠⣄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
//      ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀  ⠀⠀⠀⠀⠀⠀⠀⣀⣤⣾⣿⣿⠎⠀⠀⠹⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
//⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀      ⠀⠀⠀⠀⠀⠀⢀⣤⣾⣿⣿⣿⣿⢿⣤⠴⠒⢦⡇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
contract r3ap3r is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "r3ap3r";
    string private constant _symbol = "r3ap3r";
    ...
    address payable private _marketingAddress = payable(0x68402E79683cA75100B5F74C12805610095509E2);
    ...
    uint256 public _minimumBuyAmount = 1e7 * 10**9 ; 
    ...
    // USUAL TAXES CANNOT BE RAISED MORE THAN 4%
    function setTaxFee(uint256 amountBuy, uint256 amountSell) external onlyOwner {
        require(amountBuy >= 0 && amountBuy <= 4);
        require(amountSell >= 0 && amountSell <= 4);
