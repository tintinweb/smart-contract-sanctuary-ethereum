...
contract D4RMY is ERC20, Ownable {
    ...
    constructor() ERC20("DARK-4RMY", "D4RMY") {
        ...
        marketingWallet = address(0x18AE502495Ba075284C44E6018b716A2B89dc8Ef); // set as marketing wallet
        devWallet = address(0xeeEC987d587edb3BFCC7c0562dBFc71E28189a37); // set as dev wallet
