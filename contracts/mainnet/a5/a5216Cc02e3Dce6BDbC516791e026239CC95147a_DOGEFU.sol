...
/*
    ...
    Welcome to the Kung-Fu Doge-O. 🥋 

    At the Doge-O (pronounced Dojo), we will teach you degen discipline! 
    The shitcoin casino space can be very hard to navigate, and very easy to lose money in if you are not educated. 
    So we are here to help educate and give you your best chance at success!

    LINKS:
    Website: https://dogefu.com
    Telegram: https://t.me/DogeFu
    Medium: http://dogefu.medium.com
    Twitter: https://twitter.com/DogeFuEth
    ...
    */
    ...
    contract DOGEFU is ERC20, Ownable {
        using SafeMath for uint256;
        ...
        constructor() ERC20("DogeFu", "DOGEFU") {
            ...
            marketingWallet = address(0xFC32aE7073fE8Eb802057A3569Ca4BEd1289ee20); // Marketing / Development wallet
        ...
        uint256 _sellLiquidityFee, uint256 _sellBurnFee) external onlyOwner {
            ...
            require(buyTotalFees <= 25, "Must keep buy fees at 30% or less");
        }
