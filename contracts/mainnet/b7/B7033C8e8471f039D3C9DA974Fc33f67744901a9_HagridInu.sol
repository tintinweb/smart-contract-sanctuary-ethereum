...
/**
    Honoring the late actor of Hagrid from Harry Potter, Robbie Coltrane.
    May his soul rest in peace.
    https://twitter.com/ladbible/status/1580965339759751176
*/
...
contract HagridInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;


    //token info:
    string private constant _name = unicode"Hagrid Inu";
    ...
    address payable private _developmentAddress = payable(0x53b0a71a56c908607d2CAAd956133823eD2F29A8); 
    address payable private _marketingAddress = payable(0x53b0a71a56c908607d2CAAd956133823eD2F29A8);
