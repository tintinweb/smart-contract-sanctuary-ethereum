...
contract POWERBALLDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRti2G9i6EYSn5oVrHaqRcoEaGLnQx3vLXDiENUhuBrZV";
    ...
    constructor(
    ) ERC721A("POWERBALL DAO", "BILLIONAIRE", 100, maxSupply) {
    }
