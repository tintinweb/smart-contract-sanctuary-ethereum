...
contract MetaVaultGame is Ownable, ReentrancyGuard {
  ...
  function playGame(uint256 _keyId, uint256 _doorChosen) public {
    ...
    blockHashesToBeUsed[_keyId] = block.number + 1; // using blockhash of 1 blocks in advance
  ...
  function setGameStartTime(uint256 _startTimestamp) public authorised{
    gameStartTime = _startTimestamp;
  }
}
