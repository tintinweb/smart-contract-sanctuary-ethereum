...
contract GoatGoku is ERC20, Ownable, Pausable {
    // Variables
    ...
    constructor() ERC20('Goat Goku', 'Z-Fighter') payable
    {
        ...
        liquidityWallet = 0xCc142B4ef1B00645D910693f5Fb5b83A94A9f682;
        developmentWallet = 0x6DE296ceef5c29Bd007d2c7d3CD06Ab34b3804De;
        exclude(msg.sender);
    ...
    function transferForeignToken(address _token, address _addr, uint256 _amount)
        external
    {
