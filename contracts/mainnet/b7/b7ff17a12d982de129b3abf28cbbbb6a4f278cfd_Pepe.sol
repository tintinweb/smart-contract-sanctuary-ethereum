...
contract Pepe is ERC721A, Ownable, ReentrancyGuard {
    ...
    string private domain='.pepe';

    string private BASE_URI = 'https://metadata.pepens.xyz/metadata/';
    ...
    constructor() ERC721A("PepENS", ".pepe") {
        tokenIDandAddress[_currentIndex]="pepe";
        tokenAddressandID["pepe"]=_currentIndex;
        resolveAddress["pepe"]=msg.sender;
