...
contract Huskinu is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 18000000 * 10**18;
	...
	string private constant _name = "Husky Inu";
	string private constant _symbol = "HUSKINU";
