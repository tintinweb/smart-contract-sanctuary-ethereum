...
contract Coinance is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Coinance"; 
    string private constant _symbol = unicode"CNC"; 
    ...
    address payable private _marketingWalletAddress = payable(0xc583C3496D739968E96D471ceCec9fD72Aa0737e);
    ...
    function setCoinanceFees(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
