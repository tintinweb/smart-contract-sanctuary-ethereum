...
contract BabyShkreli is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Shkreli";
    string private constant _symbol = "BSHK";
    ...
    address payable private _marketingAddress = payable(0xca99496184dF511b86d7C105f51389a65B1317Ba);
    address payable private deploymentWallet = payable(0xf4ef05Fc0D72df38c2673F7767512e505112057e);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        deploymentWallet.transfer((amount).div(2));
