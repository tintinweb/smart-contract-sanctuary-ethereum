...
contract BinaryIdNFT is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public mintPrice = 0.008 ether;
    uint256 public MAX_SUPPLY = 516;
    ...
    function _baseURI() internal pure override returns (string memory) {
        return
            "ipfs://bafybeibdsjuub7wbdr3tv2c6ridpv3vickhctgmkplsf4nfltkojgw34ti/";
    }
    ...
    function mint(address to) public payable {
        require(isMintEnabled, "Minting phase has not started");
