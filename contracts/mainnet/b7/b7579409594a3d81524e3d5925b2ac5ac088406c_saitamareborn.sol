...
Heroes are nowhere,
But there is one man still,
Who's story yet to be uncovered,
He's a hero who's name not known, 
With his mighty fist,
And unwavering will,
There's no enemy that he can't beat, 
He is the strongest hero of all,
He is Saitama.
*/
...
contract saitamareborn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Saitama Reborn", "$SR") {
