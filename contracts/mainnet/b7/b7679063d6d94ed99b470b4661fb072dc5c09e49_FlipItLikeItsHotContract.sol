...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x810E9fA259005A3381e5598105Bb08e7e062A53C];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x810E9fA259005A3381e5598105Bb08e7e062A53C;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 420) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeih5lksb7zao6t574pxomgis6oq42uzfem4qg7txcovnrtwh3ssmzu/";
...
// File: contracts/FlipItLikeItsHotContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FlipItLikeItsHotContract is RamppERC721A {
    constructor() RamppERC721A("Flip It Like Its Hot", "FLIP"){}
}
