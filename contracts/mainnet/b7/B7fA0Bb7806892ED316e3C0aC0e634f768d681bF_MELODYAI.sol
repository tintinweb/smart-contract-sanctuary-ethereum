...
contract MELODYAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Melody AI","MAI") {
        ...
        marketingWallet = address(0xFBb17c20C608E615B294593f5BC57469437AF6D6); // set as marketing wallet
        devWallet = address(0xFBb17c20C608E615B294593f5BC57469437AF6D6); // set as dev wallet
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees.div(feeDenominator) <= 100, "Must keep fees at 20% or less");
    }
