...
contract ChampsOnlyKaiju is ERC721A, Ownable{
    //@notice not relying on ERC721A startTimestamp since it's been buggy
    ...
    function burn(uint tokenId) external {
        ...
        if(isTokenActive(tokenId)) revert PassStillActive();
        _burn(tokenId);
    }
