...
// File: contracts/extensions/ERC721APausable.sol
...
contract GobliDragonZ is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("GobliDragonZ", "GDZ") {
        PRICE = price;
    ...
    function changeMaxSupply(uint newMaxSupply) external onlyOwner {
        require(newMaxSupply >= _currentIndex, "GobliDragonZ: Invalid new max supply");
        require(newMaxSupply <= 10000, "GobliDragonZ: Invalid new max supply");
        require(!MAX_SUPPLY_FROZEN, "GobliDragonZ: You can't change max supply anymore");
