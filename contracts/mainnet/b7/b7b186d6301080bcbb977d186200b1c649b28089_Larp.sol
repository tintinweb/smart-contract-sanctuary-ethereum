...
// File: contracts/Larp.sol


// Larp Finance - a throwback to the simpler days of memecoins //
//                     https://larp.finance/                   //
...
contract Larp is IERC20, ERC20Ownable {
    ...
    constructor(
        ...
        buyBackUpperLimit = initial.mul(1).div(10000);

        _rOwned[_msgSender()] = _rTotal;

        feeWallet = payable(_msgSender());

        numTokensSellToAddToLiquidity = initial.mul(1).div(1000);
        ...
        _taxFee = tax_reflection;
        _liquidityFee = tax_liquidity;
        _burnFee = tax_burn;
        _buybackFee = tax_buyback;
        _walletFee = tax_wallet;
