...
contract ETHA  is Context, IERC20, Ownable {
    ...
    string private constant _name = "ETHalik";
    ...
    address payable private _developmentAddress = payable(0x26BA743Ea2ee915eB4B67Ff08F770c5b850cA135); 
    address payable private _marketingAddress = payable(0x26BA743Ea2ee915eB4B67Ff08F770c5b850cA135);
