...
contract UFCInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x76e4f773fd20a3Dc836B66D7C6fBCDF2FE6A34Da); // Marketing Address
    address payable public multiSigAddress = payable(0x9007B9104ED314e6e04e3b31032D34b85F7AA2C6); // Marketing Address
    address payable public devAddress = payable(0x9007B9104ED314e6e04e3b31032D34b85F7AA2C6); // Dev Address
    address payable public liquidityAddress = payable(0x9007B9104ED314e6e04e3b31032D34b85F7AA2C6); // Liquidity Address
    ...
    string private constant _name = unicode"UFC Inu";
    string private constant _symbol = unicode"UFC Inu";
