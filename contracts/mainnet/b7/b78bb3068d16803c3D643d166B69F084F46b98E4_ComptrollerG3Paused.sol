 ...
 * @author Compound
 */
contract ComptrollerG3Paused is ComptrollerV5Storage, ComptrollerG3Interface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function mintAllowed(address cToken, address minter, uint mintAmount) external override returns (uint) {
        require(false, "[20220715] - deprecated");
