...
contract WrappedInFlashLoan is FlashLoanReceiverBase {
    ...
    function executeOperation(
        ...
        (loanDAI, loanUSDC, collateralUNIV2, drawnDAI, swapForUSDC) = abi.decode(params, (uint256, uint256, uint256, uint256, uint256));
        this.realFlashLoan(
            loanDAI, 
            loanUSDC, 
            collateralUNIV2, 
    ...
    function myFlashLoanCall(
        ...
        bytes memory params = abi.encode(DAI_loan_size, USDC_loan_size, UNIV2_collateral_size, DAI_drawn, USDC_swap);
