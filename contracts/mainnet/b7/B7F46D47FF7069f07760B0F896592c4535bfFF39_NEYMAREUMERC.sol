...
/**
NEYMAREUM - BLOCKCHAIN
we will beat the Shibarium
@NEYMAREUMERC
**/
...
contract NEYMAREUMERC is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "NEYMA-REUM"; 
    string private constant _symbol = "NEYMA-REUM"; 
    ...
    address payable private _developmentWalletAddress = payable(0xAE0d861A234EC7A05246cBA406d31a2A9748F0e1);
    address payable private _marketingWalletAddress = payable(0xAE0d861A234EC7A05246cBA406d31a2A9748F0e1);
