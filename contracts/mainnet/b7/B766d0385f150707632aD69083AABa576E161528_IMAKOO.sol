...
Imakoo is a tribute to the OG Direwolf, the wolf that kills the pack for the village.

https://twitter.com/imakooeth

https://t.me/imakooportal
...
contract IMAKOO is Context, IERC20, Ownable {
    ...
    uint256 private _reduceTaxAt=230;
    uint256 private _preventSwapBefore=30;
    uint256 private _buyCount=0;

    uint8 private constant _decimals = 8;
    uint256 private constant _tTotal = 10000000000 * 10**_decimals;
    string private constant _name = unicode"IMAKOO";
    string private constant _symbol = unicode"IMAKOO";
