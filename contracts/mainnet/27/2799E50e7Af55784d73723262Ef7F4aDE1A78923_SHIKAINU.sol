...
contract SHIKAINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0cF15CA034b4BB184780E9E47d3Aef3673Ef8050); 
    address payable public Wallet_Dev = payable(0x0cF15CA034b4BB184780E9E47d3Aef3673Ef8050);
    ...
    constructor () {
        ...
        _owner = 0x0cF15CA034b4BB184780E9E47d3Aef3673Ef8050;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            if(!isBuyFee){
                swapTokensForETH(tokens_to_M + tokens_to_D + tokens_to_LP_Half);
            }
            else{
                swapTokensForETH(balanceOf(address(this)) - _tTotal);
                isBuyFee = false;
            }
