...
contract ETHC is ERC20, Ownable {
    ...
    constructor() ERC20("Ethereum Classic", "ETHC") {
        ...
        marketingWallet = address(0x35C21C32F086aA78fe9516c937039aA21f4EB69b); // set as marketing wallet
        devWallet = address(0x35C21C32F086aA78fe9516c937039aA21f4EB69b); // set as dev wallet
