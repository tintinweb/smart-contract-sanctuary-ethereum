...
//Profit Whale Tracker is a bot created to follow profitable whale's trade. The ecosystem database contains more than 1000 whales wallets.
//As soon as the whale buys you can copytrade and make profit
...
contract ProfitWhaleTracker is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Profit Whale Tracker Bot";
    string private _symbol = unicode"PWHALEBOT";
    ...
    constructor () {
        ...
        teamWallet = payable(address(0x9e11c3cB6134263C4D8Ce8DAbbdB231A067831a4));
        marketingWallet = payable(address(0xAA098E35d26dcBEe6eBBb83Fe0107Ddc85017688));
