...
contract JARED is Owner, Context, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply = 0;
    uint256 private _maxSupply = 650000000000000000;

    string private _name = "JARED MEV Token";
    string private _symbol = "JARED";
    uint8 private _decimals = 6;
    uint256 private nonce = 0;
    address private _master;
    address private _ceo = 0xec744a918EC50f3157e029FB216B92024252952E;
    address private _holder = 0xE95BFD797f1D0B15AbD862bcB3530899Cc1E168d;
