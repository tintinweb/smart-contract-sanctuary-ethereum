...
contract WAKUMI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "WAKUMI INU";
    ...
    address payable private _developmentAddress = payable(0xCFAdE2acfd0e4097Ef9d25Ab0Da839F2C3dFDE18); 
    address payable private _marketingAddress = payable(0xCFAdE2acfd0e4097Ef9d25Ab0Da839F2C3dFDE18);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 30, "Sell tax must be between 0% and 5%");
