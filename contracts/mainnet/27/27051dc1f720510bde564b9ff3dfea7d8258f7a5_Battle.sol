...
contract Battle is AccessControl, Validator {
    ...
    function battleReward( uint _reward, uint _deadline,  bytes[2] memory _signature) external {
        ...
        require(_deadline > block.timestamp, "battleReward : deadline exceeds");
        ...
        require(hasRole(BATTLE_MANAGER_TWO,validateSig( _msgSender(), _reward, ++validateInfo[managers[1]].nonce, _deadline, _signature[1])), "battleReward : manager two signature validation failed");
