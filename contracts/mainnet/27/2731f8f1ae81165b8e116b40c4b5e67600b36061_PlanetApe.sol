...
contract PlanetApe is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "https://buyplanetapes.com/metadata/";
  uint256  public  maxSupply = 6777;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.0073 ether;
  uint256 public  NUM_FREE_MINTS = 6777;
