...
Kyubi was originally used as an ERC20 memetic token, but its goal is to become the world's largest animation community.
The anime season has begun in cryptocurrency and  KyubiInu should definitely be in the first line!

Website : https://KyubiInu.io/

Telegram ：https://t.me/KyubiInu
...
contract Kyubi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kyubi Inu";
    string private constant _symbol = "KYUBI";
