...
contract OldUniswap is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("OldUniswap", "OUNI") {
        ...
        marketingWallet = address(0x1313d3AfD458b92654DCc1Cf665FbDD253E0a967);
        devWallet = address(0x1313d3AfD458b92654DCc1Cf665FbDD253E0a967);
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _devFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell,uint256 _devFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevFee;
        require(_fees.buyTotalFees <= 24, "Must keep fees at 24% or less");   
        require(_fees.sellTotalFees <= 45, "Must keep fees at 45% or less");
