...
contract PolandRescueInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Poland Rescue Inu";
    string private constant _symbol = "PRI";
    ...
    address payable private _developmentAddress = payable(0xa5Fd3e52295d71994425249084ac1A0f41574631); 
    address payable private _marketingAddress = payable(0xa5Fd3e52295d71994425249084ac1A0f41574631);
