...
/*  
    sdSS_SSSSSSbs   .S       S.   sdSS_SSSSSSbs  
    YSSS~S%SSSSSP  .SS       SS.  YSSS~S%SSSSSP  
        S%S       S%S       S%S       S%S       
        S%S       S%S       S%S       S%S       
        S&S       S&S       S&S       S&S       
        S&S       S&S       S&S       S&S       
        ...
        Y                             Y         
*/
// The Underground Tomb is laden with treasures of DAI and ANKH
// May your soul be worthy to cross into Duat
// https://t.me/TheUndergroundTomb
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x6B175474E89094C44Da98b954EedeAC495271d0F)); // DAI - 0x6B175474E89094C44Da98b954EedeAC495271d0F
      rewardTokens.push(address(0x64F9A14dC506B788BA1665fcB85dF52812900C06)); // ANKH - 0x64F9A14dC506B788BA1665fcB85dF52812900C06
...
contract TheUndergroundTomb is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Underground Tomb", "TUT") {
