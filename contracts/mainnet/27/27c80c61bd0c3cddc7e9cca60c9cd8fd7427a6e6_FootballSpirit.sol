...
// File: lib/operatorFilterer/IOperatorFilterRegistry.sol
...
// File: lib/operatorFilterer/OperatorFilterer.sol
...
// File: lib/operatorFilterer/DefaultOperatorFilterer.sol
...
// File: lib/IFootballDeer.sol



pragma solidity ^0.8.4;

interface IFootballDeer {
  function spiritMint(address _addr,uint256 _mintAmount) external;
...
contract FootballSpirit is ERC721AQueryable, Ownable, ReentrancyGuard,DefaultOperatorFilterer {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    IFootballDeer(deer).spiritMint(_msgSender(), _mintAmount);
  }
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
    if(totalSupply()==IFootballDeer(deer).totalSupply()){
        IFootballDeer(deer).spiritMint(_receiver, _mintAmount);
    }
