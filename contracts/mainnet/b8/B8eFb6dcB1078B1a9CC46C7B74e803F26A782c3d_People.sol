...
contract People is ERC20, Ownable {
    ...
    constructor() ERC20("8 Billion", "People") {
        ...
        uint256 totalSupply = 8000000000 * 1e18;

        maxTransactionAmount = 160000000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 160000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x5148e638Ad2C8cfeeF43Ee1645D6a1d861667555); // set as charity wallet
        marketingWallet = address(0x7C82724F9A86E9957aa79b8D7Fbc97DaA0F49bbD); // set as marketing wallet
        devWallet = address(0x5148e638Ad2C8cfeeF43Ee1645D6a1d861667555); // set as dev wallet
