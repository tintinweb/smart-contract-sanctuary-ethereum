...
contract TTCG is ERC20, Ownable {
    ...
    constructor() ERC20("Trumps Trading Card Game", "TTCG") {
        ...
        uint256 totalSupply = 9 * 1e9 * 1e18;
        ...
        developmentAddress = address(0xA1fDE28994F503cE564fE95ccA6e170a41C20D82);
        marketingAddress = address(0xA1fDE28994F503cE564fE95ccA6e170a41C20D82);
    ...
    function setDevAddress(address _developmentAddress) external onlyOwner {
    ...
    function setMktgAddress(address _marketingAddress) external onlyOwner {
        require(_marketingAddress != address(0), "_marketingAddress address cannot be 0");
        marketingAddress = payable(_marketingAddress);
        emit UpdatedMarketingAddress(_marketingAddress);
    }

     function setLiqAddress(address _liquidityAddress) external onlyOwner {
