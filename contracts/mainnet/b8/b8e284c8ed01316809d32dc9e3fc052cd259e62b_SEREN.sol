...
/*
Serenity is peaceful, but the journey to serenity can be quite chaotic.
Website
https://Seren.Finance

Telegram
https://t.me/SERENFinance

Twitter
https://twitter.com/Serenfinance
...
contract SEREN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTxLimit = _tTotal.mul(150).div(10000);         // 1.50% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(300).div(10000);    // 3%% of total supply
    ...
    constructor(address _dev) public ERC20("SEREN FINANCE", "SEREN") {
