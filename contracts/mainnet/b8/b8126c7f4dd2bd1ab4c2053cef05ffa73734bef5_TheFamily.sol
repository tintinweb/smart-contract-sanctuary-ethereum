...
$FAM is the genesis of a new generation. 

Important:
You want to hurt The Family with sniping?
We will write your name in our "Black Book".


https://wearethefamily.io


https://medium.com/@wearethefamily
https://twitter.com/TheFamilyERC
https://t.me/TheFamilyERC
...
contract TheFamily is ERC20, Ownable, Pausable {
    ...
    uint256 private swapThreshold = 0.000005 ether; // The contract will only swap to ETH, once the fee tokens reach the specified threshold
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(10,2); 
        setSellTax(20,2); 
        setTaxWallets(0xAc1B6B1aFa2dBaBE1D53b31896B88D16f25A19ca); 
        exclude(msg.sender);
