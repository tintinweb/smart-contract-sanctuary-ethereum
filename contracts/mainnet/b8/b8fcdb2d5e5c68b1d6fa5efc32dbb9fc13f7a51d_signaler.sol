...
contract signaler is Context, IERC20, Ownable {
    ...
    string private _name = "signaler";
    string private _symbol = "signaler";
    ...
    uint256 public numTokensSellToAddToLiquidity = 15000000 * 10**9;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 25, "Tax fee cannot be more than 25%");
        _taxFee = taxFee;
    }
    ...
    function AddBotWallets(address[] calldata botwallet) external onlyOwner() {
