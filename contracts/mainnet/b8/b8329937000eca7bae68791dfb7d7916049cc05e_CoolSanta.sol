...
Cool Santa has arrived to  make sure everyone has Merry Christmas.

🎅Giveaways for community 
🎅NO TEAM TOKENS
🎅100% L.P. Will be locked after launch 
🎅100% Tokens to Liquidity
🎅Organic growth
🎅Will have Huge Names Supporting
...
www.coolsanta.net
Twitter.com/coolsantaerc
https://t.me/coolsantaerc
...
contract  CoolSanta       is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 5 * 1000**3* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    bool enableTrading = true;

    string private _name = ' Cool Santa  ';
    string private _symbol = 'COOLSANTA';
