 ...
 * allowances. See {IERC20-approve}.
 */
contract Sanitk is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Sanitk";
    string private _symbol = "Sanitk";
    uint8 private _decimals = 9;
    uint256 private _supply = 900000;
    uint256 public taxForLiquidity = 2;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 3000 * 10**_decimals;
    uint256 public maxWalletAmount = 6000 * 10**_decimals;
    address public marketingWallet = 0xa0a187E0629c1D04E5fdEdBFaA6a802E68ABe8a6;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 5, "ERC20: total tax must not be greater than 5");
