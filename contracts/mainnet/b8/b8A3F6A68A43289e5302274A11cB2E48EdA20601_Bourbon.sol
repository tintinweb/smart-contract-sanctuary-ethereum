...
First gateway to the kingdom: https://t.me/BourbonERC
...
contract Bourbon is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Bourbon";
    ...
    address payable private _developmentAddress = payable(0xD3f707453742788508E4f5782056f4b35FF71d5C);
    address payable private _marketingAddress = payable(0x41E4C1B52eD3b6b4F8835603BC44e23cCb45EE97);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(_redisFeeOnBuy + _taxFeeOnBuy <= 20, "TOKEN: buy fees should be lower than 20%.");
        require(_redisFeeOnSell + _taxFeeOnSell <= 20, "TOKEN: sell fees should be lower than 20%.");
    }
