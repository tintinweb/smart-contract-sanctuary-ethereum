...
//WEBSITE http://notbullish.site/

//TWITTER https://twitter.com/notbullishtoken

//TELEGRAM https://t.me/NotBullishErc
...
contract NOTBULLISH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NOT BULLISH";
    string private _symbol = "$NOBULL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8bfeeDf87d5A20eE0afEc513e62246BFd4458992); // marketing wallet
    address payable lotteryWallet = payable(0x8bfeeDf87d5A20eE0afEc513e62246BFd4458992);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0xc48197e8E9F1Ff24b95935E938187d9317ad7288;  
