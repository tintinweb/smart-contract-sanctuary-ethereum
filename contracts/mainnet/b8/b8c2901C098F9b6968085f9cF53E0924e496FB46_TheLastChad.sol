/*
After the collapse of all shitcoins and blockchains, 
humanity started a war to fight over the remaining resources of the world. 
Eventually only one man survived and he became The Last Chad of the universe.

Taxes will be reduced to 0% - 3%, 1 hour after launch, as our anti jeet protection.

https://t.me/thelastchad
https://twitter.com/TheLastChadERC
https://thelastchaderc.com/
*/
...
contract TheLastChad is ERC20, Ownable {
    ...
    constructor() ERC20("The Last Chad", "TLC") {
        ...
        marketingWallet = address(0x32e7851f332adDE760910F9F66861ffc3bA2656F);
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee;
        previousFee = sellTotalFees;
        require(sellTotalFees <= 13, "Must keep fees at 8% or less");
    }
