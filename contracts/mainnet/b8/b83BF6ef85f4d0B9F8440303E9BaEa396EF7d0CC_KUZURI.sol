...
╚═╝░░╚═╝░╚═════╝░╚══════╝░╚═════╝░╚═╝░░╚═╝╚═╝  ╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝
    ...
    I make #KUZURI to hand over it to the community.
    There is NO TAX - make sure to use low slippage.
    TG: https://t.me/KUZURIKAMARI

   Great features:

   I will burn liquidity LPs to lock the pool forever.
   I will renounce the ownership to transfer #KUZURI to the community, make sure it's 100% safe.
   I will release a medium article about this project via etherscan, as soon as #KUZURI reached 100 Holders.

   I will add 2.22 ETH and 100% of the supply to the pool.
   Can you make #KUZURI 10000000X? 
...
contract KUZURI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20 ("KUZURI KAMARI", "KUZURI") {
