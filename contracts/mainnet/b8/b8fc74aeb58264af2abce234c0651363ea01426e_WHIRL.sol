...
contract WHIRL is ERC20, Ownable {
    ...
    constructor() ERC20("Hydros", "WHIRL") {
        ...
        marketingWallet = address(0x04fd8808410898284102f542E41CE8ceCB2bF1b8); // set as marketing wallet
        devWallet = address(0xaDC6845d7885EDAbDD94369f3FC27C1193931803); // set as dev wallet
