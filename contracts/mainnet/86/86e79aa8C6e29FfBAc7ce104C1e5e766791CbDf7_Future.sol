...
/**
    ...
    'Which?' you will wonder.
    Well, I'm referring to you. Yes, you.

    Each of you reading this message is part of an amazing community. You just gotta believe that strong enough.

    Have faith. That's all i need you to do.

    $Future is how i decided to name it.

    $Future.
    •The $Future community is the best one.
    •$Future to 7 digits day 1.
    •$Future to 8 digits within a week.

    Make the first sentence true. The other two will follow.

    Sell taxes will be 90% for the first 10 minutes. Only those who can read the $future i want to be part of this community.

    Will be lowered to 3%. Then i will renounce the contract.

    2% will go to LP, 1% i will keep. 

    This will be spent towards the project but i am sure you already know that. 
    You see the $Future.

    Create a telegram room under this name @FutureErc20.

    Twitter: https://twitter.com/Future_ETH_Coin
*/
...
contract Future is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Future";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "FTR";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x0ae439C16Da6fF505b0351236dfd8b5B33B7E74a;
        marketingFeeReceiver = 0x1cf14D4f4A9Ad0235616C0Cc3C22763837623Db0;
