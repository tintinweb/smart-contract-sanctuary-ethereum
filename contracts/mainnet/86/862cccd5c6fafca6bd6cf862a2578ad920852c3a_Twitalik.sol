...
contract Twitalik is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Twitalik";
    string private constant _symbol = unicode"Twitalik";
