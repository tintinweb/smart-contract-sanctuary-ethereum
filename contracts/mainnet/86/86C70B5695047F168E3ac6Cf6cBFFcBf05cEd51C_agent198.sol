...
contract agent198  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmeMmvnF9rCKT7m7VcAEeovWHcF9dAwVMgDp1M2qf3cCPr/";

    uint256 public immutable mintPrice = 0.01 ether;
    // uint256 public immutable minfund = 0.003 ether;
    uint32 public immutable maxSupply = 198;
    ...
    function MintToWL(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
