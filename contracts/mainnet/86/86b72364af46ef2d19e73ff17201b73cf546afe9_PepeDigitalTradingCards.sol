...
contract PepeDigitalTradingCards is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Pepe Digital Trading Cards", "PPDTC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibzpq36chpzhotm2zryh3l4q5wrctvyvxb6xg34ktpknuryc4d3tq/", Strings.toString(tokenId), ".json")
            );
    }
