...
/**
@ECAW
Telegram :https://t.me/ElonCawInu
*/
...
contract Ecaw is Context, IERC20, Ownable {
    ...
    string private constant _name = "ElonCaw Inu";
    string private constant _symbol = "ECAW";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xE06b1796420808Ef7A4cc48C1F140Ca0a681255A);
        _feeAddrWallet2 = payable(0xE06b1796420808Ef7A4cc48C1F140Ca0a681255A);
