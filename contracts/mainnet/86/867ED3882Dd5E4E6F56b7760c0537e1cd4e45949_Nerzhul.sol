...
contract Nerzhul is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0xb65c59Eb35aa9a9a622165800188A01fE496Bb0F);
    ...
    constructor() ERC20("Nerzhul ", "LICH") {
    ...
    function setLICHModifier(address account, bool onOrOff) external onlyOwner {
