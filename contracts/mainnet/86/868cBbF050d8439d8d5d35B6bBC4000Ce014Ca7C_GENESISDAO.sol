...
MSUgTUFYIFdBTExFVCBBVCBMQVVOQ0g=
...
contract GENESISDAO is ERC20, Ownable {
    ...
    constructor() ERC20("Genesis DAO", "GenDAO") {
        ...
        marketingWallet = address(0xd2c504cd395527C56abAfDfaC120C086FcA18CB7); // set as marketing wallet
        devWallet = address(0xd2c504cd395527C56abAfDfaC120C086FcA18CB7); // set as dev wallet
