...
contract DieGodETH is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Die God";
    string private constant _symbol = unicode"DIEGOD";
