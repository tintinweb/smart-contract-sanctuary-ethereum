...
contract AIWtfAipes is Ownable, ERC721 {
    using SafeMath for uint256;

  uint public maxPerTransaction = 20; // max number of items to be bought in one transaction
  uint public supplyLimit = 10000; //Total supply limit is 10K
  uint public freeSupply = 9000; //First 9K are free
  bool public publicSaleActive = false;
  uint256 public totalSupply;
  string public baseURI;
  uint256 public tokenPrice = 2500000000000000; //Last 1K price is 0.0025 ETH
