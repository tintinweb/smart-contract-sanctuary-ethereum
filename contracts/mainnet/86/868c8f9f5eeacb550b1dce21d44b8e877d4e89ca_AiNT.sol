...
// Website: https://ainetworktoken.com/
// Telegram: https://t.me/AiNT_erc20
// Medium: https://medium.com/@AiNT_erc20
...
// Main Contract Logic 
// --------------------------------------------------------------
contract AiNT is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Ai Network Token";
    string private _symbol = "AiNT";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xe79027B628450BaAbd1135b0A47314B795C8AF18);
    address payable public operationsWallet =  payable(0xe79027B628450BaAbd1135b0A47314B795C8AF18);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    // fees    
    uint256 public liquidityFeeBuy = 0;
    uint256 public operationsFeeBuy = 5;
    uint256 public totalFeesBuy;
    uint256 public maxTotalFeeBuy = 10;

    // fees
    uint256 public liquidityFeeSell = 0;
    uint256 public operationsFeeSell = 5;
