...
Twitter : https://twitter.com/primefinanceERC
 ...
 One stop solution for all kind of traders under one platform in the DeFi world.
...
contract PrimeFinance is ERC20, Ownable{
    ...
    bool private Pfinan = true ; 
    uint256 public genesis_block;
    uint256 public deadblocks = 0;
    
    uint256 public swapThreshold = 10**9 * 10**18 * 5/10000;
    uint256 public maxTxAmount = 10**9*10**18 * 7/100;
    uint256 public maxWalletAmount = 10**9*10**18 * 100/100;
    
    address public marketingWallet = 0xD176B296D89eF1Fc1c8307967CC86f29784faE4e;
    address public devWallet = 0xD176B296D89eF1Fc1c8307967CC86f29784faE4e;
