...
//Nikolai Muchgian, 29-yr old #stablecoin innovator, #BitShares contributor, $DAI architect/@MakerDAO co-founder has died in San Juan #PuertoRico, five days after #MakerDAO community approves custodian partnership with @Coinbase
//Too young. May he rest in peace. Prayers to his family and friends.
...
contract RIPNicolai is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("RIP Nikolai", "Nikolai") {
        ...
        marketingWallet = address(0x026E3E9457e1C3b8B7634BfeEC5e301779e28B2F); // set as marketing wallet
        devWallet = address(0x026E3E9457e1C3b8B7634BfeEC5e301779e28B2F); // set as dev wallet
