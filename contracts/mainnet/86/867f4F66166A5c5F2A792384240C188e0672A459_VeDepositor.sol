    ...
    AccessControlEnumerableUpgradeable
{
    ...
    function setAddresses(address _lpDepositor, address _splitter)
        external
    ...
    function setMintMargin(uint256 _mintMargin) external onlyRole(SETTER_ROLE) {
        mintMargin = _mintMargin;
    }
