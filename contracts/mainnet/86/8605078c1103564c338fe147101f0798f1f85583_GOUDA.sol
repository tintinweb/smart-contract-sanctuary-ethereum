...
/**
 https://t.me/GoudaPortal

 https://medium.com/@gouda.eth/
...
contract GOUDA is ERC20, Ownable {
    ...
    constructor() ERC20("GOUDA", "GOUDA") {

        address newOwner = msg.sender; // can leave alone if owner is deployer.

        IDexRouter _dexRouter = IDexRouter(0x03f7724180AA6b939894B5Ca4314783B0b36b329);
