...
contract SummerApe is Context, IERC20, Ownable {
	...
	string private constant _name = "Summer Ape";
	string private constant _symbol = "SUMMERAPE";
	...
	function setTax(uint256 newTaxRate) public onlyOwner{
