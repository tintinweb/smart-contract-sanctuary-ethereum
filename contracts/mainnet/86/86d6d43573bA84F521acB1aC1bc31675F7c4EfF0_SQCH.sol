...
contract SQCH is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmTaK2ZcpNacwfawnBhWVkK9iCNUUwsnQTgL9EvbcyHvwQ";

  uint256 public  maxSupply = 777;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  FREE_MINTS_PER_TX = 2;
  uint256 public  PUBLIC_SALE_PRICE = 0.005 ether;
  uint256 public  TOTAL_FREE_MINTS = 150;
  bool public isPublicSaleActive = true;

  constructor(

  ) ERC721A("INTERDIMENSIONAL SASQUATCH", "SQCH") {
