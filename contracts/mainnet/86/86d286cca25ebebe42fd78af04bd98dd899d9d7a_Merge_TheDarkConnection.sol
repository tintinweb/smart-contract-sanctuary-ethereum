...
//1͓̽8͓̽8͓̽6͓̽ ͓̽N͓̽F͓̽T͓̽s͓̽
//F͓̽I͓̽R͓̽S͓̽T͓̽S͓̽ ͓̽300 ͓̽F͓̽O͓̽R͓̽ ͓̽F͓̽R͓̽E͓̽E͓̽ ͓̽-͓̽ ͓̽O͓̽T͓̽H͓̽E͓̽R͓̽S͓̽ ͓̽0͓̽.͓̽0͓̽1͓̽ ͓̽e͓̽t͓̽h͓̽
//M͓̽A͓̽X͓̽ ͓̽2͓̽ ͓̽F͓̽R͓̽E͓̽E͓̽ ͓̽M͓̽I͓̽N͓̽T͓̽ ͓̽x͓̽ ͓̽W͓̽A͓̽L͓̽L͓̽E͓̽T͓̽
...
// File: contracts/TheDarkConnection.sol
...
contract Merge_TheDarkConnection is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public PRICE; // 0.01 ether - 10000000000000000 wei price
    uint256 public MAX_SUPPLY; //1886
    string private BASE_URI; // https://merge-thedarkconnection.sfo3.digitaloceanspaces.com/Json/
    uint256 public FREE_MINT_LIMIT_PER_WALLET; // 1
    uint256 public MAX_MINT_AMOUNT_PER_TX; // 10
    bool public IS_SALE_ACTIVE; // false
    uint256 public FREE_MINT_IS_ALLOWED_UNTIL; // Free mint is allowed until 300 mint
    bool public METADATA_FROZEN;

    mapping(address => uint256) private freeMintCountMap;

    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("Merge_TheDarkConnection", "TDK") {
        PRICE = price; 
    ...
    0x6eabf8Bf8c3b59DbA068F9b97Ad7d693a99f06EE;
