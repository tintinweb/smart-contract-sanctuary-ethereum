...
contract JoyPresale is ContextUpgradeable, AuthorizableU {
    ...
    function transTokenByAdmin(address _userAddr, uint8 _vestingIndex, uint256 _depositedAmount, uint256 _purchasedAmount, bool _transferToken) public onlyOwner {
