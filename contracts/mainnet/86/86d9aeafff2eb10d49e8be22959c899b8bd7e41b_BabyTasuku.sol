...
/**
    ...
    Telegram: https://t.me/BabyTasukuETH
*/
...
contract BabyTasuku is Context, IERC20, Ownable {
    ...
    address payable public multiSigAddress = payable(0x138738112a9D65091194F7b65f8c9a3c95CE4ff6); // Marketing Address
    address payable public devAddress = payable(0x138738112a9D65091194F7b65f8c9a3c95CE4ff6); // Dev Address
    address payable public liquidityAddress = payable(0x138738112a9D65091194F7b65f8c9a3c95CE4ff6); // Liquidity Address
    ...
    string private constant _symbol = unicode"BABYTASUKU";
