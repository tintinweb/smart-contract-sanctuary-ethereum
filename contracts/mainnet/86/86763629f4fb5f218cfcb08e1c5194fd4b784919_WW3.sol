...
/**
    ...
    https://t.me/WW3INUERC

    #WWIII Is trending on Twitter, let's send it.
...
contract WW3 is ERC20, Ownable {
    ...
    constructor() ERC20("WW3 Inu", "WW3") {
		...
		charityWallet = address(0xde7577715052b00C78c66eD7C6D78C29A5eB768E); // set as charity wallet
        marketingWallet = address(0xde7577715052b00C78c66eD7C6D78C29A5eB768E); // set as marketing wallet
        devWallet = address(0xde7577715052b00C78c66eD7C6D78C29A5eB768E); // set as dev wallet
