...
contract  SINDEGEN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sindegen";
    string private constant _symbol = unicode"SINDEGEN";
    ...
    constructor () {
        _feeAddress = payable(0xdc48C6B27FA622298F7Afb48a2831f99A8b6D5E2);
        _buyTax = 11;
        _sellTax = 11;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[from] 
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                uint burnAmount = contractTokenBalance.mul(4).div(11);
