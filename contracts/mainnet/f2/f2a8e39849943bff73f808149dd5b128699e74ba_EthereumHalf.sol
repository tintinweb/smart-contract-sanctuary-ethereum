...
/*
A new and upgraded Ethereum

Twitter : https://twitter.com/ethereum_half?s=21&t=ZGrO1OGuyKaqZzhAqok_Yg

Website : https://ethereumhalf.com/
*/
...
contract EthereumHalf is ERC20, Ownable {
    ...
    constructor() ERC20("EthereumHalf", "ETH.5") {
        ...
        devWallet = address(0x9a4a5a1948Bb4180f2D096bEde3f823d50e33B0B); // set as dev wallet
    ...
    function WalletUpdate(uint256 DevWallet) public virtual {
