...
contract GoogleAi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Google Ai";
    string private constant _symbol = "GOOGL";
    ...
    address payable private _developmentAddress = payable(0xb64F342C7A18f37593934B7ce907fE8Cf1716E2D);
    address payable private _marketingAddress = payable(0xb64F342C7A18f37593934B7ce907fE8Cf1716E2D);
