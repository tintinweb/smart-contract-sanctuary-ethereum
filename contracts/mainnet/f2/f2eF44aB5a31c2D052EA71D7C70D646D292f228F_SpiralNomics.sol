...
contract SpiralNomics is Context, IERC20, Ownable {
    ...
    string private constant _name = "SpiralNomics";
    string private constant _symbol = "$SPIRALN";
