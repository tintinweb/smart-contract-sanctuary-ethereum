...
contract ToughPupClub is ERC721A("ToughPupClub", "TPC"), Ownable, ERC721ABurnable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.08 * 1e18;
    ...
    function reservedNFTs(address[] calldata _sendNftsTo, uint256 _howMany) external onlyOwner {
