...
/**
    ...
    Telegram: https://t.me/HalloweenInuEntry
*/
...
contract HalloweenInu is Context, IERC20, Ownable {
    ...
    address payable public multiSigAddress = payable(0x8c8eff733fb017DEfe1308077db5d51C6a84eaE6); // Marketing Address
    address payable public devAddress = payable(0x80427F8Fb545f08Dabe2872428ffC137bf7e2181); // Dev Address
    address payable public liquidityAddress = payable(0x80427F8Fb545f08Dabe2872428ffC137bf7e2181); // Liquidity Address
    ...
    string private constant _name = unicode"Halloween Inu";
    string private constant _symbol = unicode"HALU";
