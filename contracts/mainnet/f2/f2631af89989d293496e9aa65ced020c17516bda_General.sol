...
// A Decentralized Meme - Bored VALLAS Protocol

/**
 
We are blockchain bridge between crypto and fiat world, where one side can be fiat and the other crypto (not a real trade on the exchange

So what is more important: connectivity or transactability? Yes, both.

Like bitcoin, ethereum provides both connectivity and transactability. 
Like bitcoin, ethereum solves all major issues of its clients and it promises to be a protocol for designing as well as executing everything related to the system.

And like bitcoin, ethereum doesn’t matter which chain will be used: if it is one of the two based on blockchain or not. 
EIP-161 introduced the bridge between the ethereum blockchain and the bitcoin blockchain to build transactable gateways into the cryptocurrency universe.

*/


// TG- https://t.me/IndyReviews
// WEB- https://www.criptonoticias.com
// TWITTER- https://twitter.com/noktakomm__
...
contract General is ERC20, Ownable {
    // Namings
    string private projectName = "Bored VALLAS Protocol";
    string private tokenName = "VALLA";

    // Wallets
    address payable public devWallet = payable(0x295cfa78Fe642C9669876ab39116da3f576DD90d);
    address public marketingWallet = address(0x295cfa78Fe642C9669876ab39116da3f576DD90d);
