...
contract CHAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "ChAI";
    ...
    address payable private _developmentAddress = payable(0x879cB98478B7F8Dc99B3406165CDb19a92FA4f10); 
    address payable private _marketingAddress = payable(0x879cB98478B7F8Dc99B3406165CDb19a92FA4f10);
