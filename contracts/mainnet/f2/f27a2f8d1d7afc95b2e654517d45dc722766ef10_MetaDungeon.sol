...
contract MetaDungeon is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xB525F590C1838E3b37e590Ec2F8b8F97065f20CE));

    string private _name = "MetaDungeon";
    string private _symbol = "MetaDG";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(100); //3%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(100); // 3%
