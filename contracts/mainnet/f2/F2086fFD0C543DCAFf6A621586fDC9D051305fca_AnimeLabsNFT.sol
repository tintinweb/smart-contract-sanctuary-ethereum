...
contract AnimeLabsNFT is ERC721Enumerable, Ownable {
    ...
    string private _baseTokenURI = "https://animelabs.io/meta/";
    bool private _ripCord = false;
    uint256 public PRICE = 0;
    uint256 public PRICE_TOKEN = 5000 * 10**9;

    DeadAnime private _previous;

    constructor(address _dead, address _paymentToken) ERC721("AnimeLabsNFT", "ANIMENFT") {
        _previous = DeadAnime(_dead);
