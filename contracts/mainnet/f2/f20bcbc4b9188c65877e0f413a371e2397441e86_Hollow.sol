...
contract Hollow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hueco Mundo";
    string private constant _symbol = "HOLLOW";
    ...
    constructor () {
        ...
        emit Transfer(address(0x1f2506e89652025e3B166Bd860024E79ef202A95), _msgSender(), _tTotal);
    }
