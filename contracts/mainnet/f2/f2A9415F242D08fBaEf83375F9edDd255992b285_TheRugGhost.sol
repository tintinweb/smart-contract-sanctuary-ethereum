...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(baseURI, "0.json")) : '';
    }
...
contract TheRugGhost  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://bafybeihmcorwjraluxoifoqup7ah5tt6u7hoezzmljkkjkgbalosdwzgvm/";
    ...
    constructor()
    ERC721A ("TheRugGhost", "TRG") {
        _safeMint(0xA37132C489023f5fE46e300071d99Bf8dc826bbA, 1);
    }
