...
contract ShibariumSwap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "ShibariumSwap";
    string private _symbol = "sSWAP";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x92C5F368c3caFbF511c0602Fbba6f1d3deEe7343);
    address payable public DeveloperWallet = payable(0x92C5F368c3caFbF511c0602Fbba6f1d3deEe7343);
