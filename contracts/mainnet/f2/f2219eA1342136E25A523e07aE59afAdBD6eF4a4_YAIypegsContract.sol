...
//
//           ___    ____                           
//    __  __/   |  /  _/_  ______  ___  ____ ______
//   / / / / /| |  / // / / / __ \/ _ \/ __ `/ ___/
//  / /_/ / ___ |_/ // /_/ / /_/ /  __/ /_/ (__  ) 
//  \__, /_/  |_/___/\__, / .___/\___/\__, /____/  
// /____/           /____/_/         /____/        
//
//*********************************************************************//
//*********************************************************************//
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeia3haftlxojqvmm6val5drmicuqihebst52ugzqmj5yecu6dowk5u/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ZtUvT80RaKZBU0Ie1RbB/contract-metadata";
  }
...
// File: contracts/YAIypegsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YAIypegsContract is RamppERC721A {
    constructor() RamppERC721A("yAIypegs", "yAIy"){}
}
