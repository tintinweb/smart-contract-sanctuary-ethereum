...
contract NotDeGods is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"Be yourself, HOOMAN.");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more DeGods");
    require(mintEnabled, "Minting is not live yet, hold on HOOMAN.");
