...
contract LGSGoodCactusFrens is ERC721A, Ownable, ReentrancyGuard, RoyaltiesV2Impl {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    // Transfer to charity:water 25% of the mint
    (bool hs, ) = payable(0x79308448f6daB85693663Bc318A57dd947071dbC).call{value: (cost * _mintAmount) * 25 / 100}('');
    require(hs);
  }
