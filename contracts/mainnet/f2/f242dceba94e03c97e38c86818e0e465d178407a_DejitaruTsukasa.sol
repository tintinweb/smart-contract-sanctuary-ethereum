...
contract DejitaruTsukasa is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Dejitaru Tsukasa";
    string private _symbol = "DTSUKA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x626929c3770bbf58F01d89Fb538542a30D593508);
    address payable private taxWallet2 = payable(0x626929c3770bbf58F01d89Fb538542a30D593508);
