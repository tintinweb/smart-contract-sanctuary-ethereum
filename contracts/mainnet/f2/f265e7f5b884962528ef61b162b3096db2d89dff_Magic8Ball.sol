...
contract Magic8Ball is Context, IERC20, Ownable {
    ...
    string private _name = "Magic 8 Ball";
    string private _symbol = "M8";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _devFee = 600;
    uint256 private _devTax = 300;
    uint256 private _marketingTax = 200;
    uint256 private _platformTax = 100;
    ...
    uint256 public maxTxAmount = _tTotal.mul(30).div(1000); // 3%
    address payable private _devWallet = payable(0x44A8eEC7C8F3cabd9E8171a78bbB3194845FE447);
    address payable private _marketingWallet = payable(0xbbb5a715cFd4Cfe2870F903b91aA0EFf938637EC);
    address payable private _platformWallet = payable(0xb57CeAFA63ddD9237DC5f2833db445bB2fd00397);
    ...
    uint256 private minTokensBeforeSwap = 10000000 * 10**9;
    ...
    constructor () public {
        ...
        // launch sell fee
        launchSellFeeDeadline = now + 0 days;
