...
contract QC is ERC721A__Initializable, UUPSUpgradeable, ERC721AUpgradeable, OwnableUpgradeable, DefaultOperatorFiltererUpgradeable{
    ...
    function initialize() initializerERC721A initializer public {
        ...
        cost = 0.002 ether;
       __ERC721A_init("Queen Chamada", "QC");
       __Ownable_init();
    ...
    function mint(uint256 amount)
        external payable
    {
        require(_tokenIdCounter.current() < maxSupply, "Queen Chamada: exceeds max supply");
        require(balanceOf(_msgSender()) == 0, "Queen Chamada: exceeds mint limit");
        require(publicMintEnabled == true, "Queen Chamada: public mint not enabled");
        require(publicMint > 0, "Queen Chamada: no public mint allocation");
        require(tx.origin == _msgSender(), "Queen Chamada: invalid eoa");
        require(amount <= 10, "Queen Chamada: exceeds mint limit");
        require(amount > 0, "Queen Chamada: invalid eoa");
        require((publicMint - amount) > 0, "Queen Chamada: exceeds mint limit");
        require(msg.value == (amount * cost), "Queen Chamada: invalid price");
