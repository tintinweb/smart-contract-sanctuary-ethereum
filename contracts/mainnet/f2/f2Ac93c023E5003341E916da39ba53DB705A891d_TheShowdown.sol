...
TAIKETSU is a token which implements a reward reward scheme to buyers.
...
contract TheShowdown is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Showdown";
    string private constant _symbol = "TAIKETSU";
    ...
    uint256 private _minTaxSwap=5_000 * 10 ** _decimals;
    uint256 private _taxSwapAmount=5_000* 10 **_decimals;
