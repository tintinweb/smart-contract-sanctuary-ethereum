...
contract GalaGrrrls is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint public constant MAX_TOKEN_PER_TXN = 21;
  
  uint256 public constant MAX_TOKENS = 6001;
  
  uint public tokenReserve = 200;
  address public proxyRegistryAddress;
  mapping(address => uint256) private allowance;
  string public baseURI;
    
  constructor() ERC721A("Gala Grrrls", "GG") {
    setBaseURI("https://blam.io/api/gala-grrrls/lm/");
  ...
  function mintToken(uint numberOfTokens) public payable nonReentrant {
    ...
    require(numberOfTokens < MAX_TOKEN_PER_TXN, "The max mint per transaction is 20");
