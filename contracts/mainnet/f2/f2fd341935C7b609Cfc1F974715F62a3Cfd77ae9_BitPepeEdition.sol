...
contract BitPepeEdition is ERC721A, Ownable {
    using Strings for uint256;

    string private _baseURIPrefix;
    uint256 private _tokenPrice = 2500000000000000; //0.0025 ETH
    uint256 private _curLimit = 999;
    uint256 private _curFreeLimit = 649;
    ...
    constructor() ERC721A("BitPepeEdition", "BITPEPE") {}
