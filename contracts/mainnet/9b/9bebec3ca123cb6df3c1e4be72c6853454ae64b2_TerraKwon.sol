...
contract TerraKwon is ERC20, Ownable {
    ...
    constructor() ERC20("TerraKwon", "Terra Do Kwon") {
		...
		charityWallet = address(0xbb9BEC04378dF7Cd43872728D954fE5085e920BE); // set as charity wallet
        marketingWallet = address(0xbb9BEC04378dF7Cd43872728D954fE5085e920BE); // set as marketing wallet
        devWallet = address(0x959EDa8fD57593B8364ce22360ccc3d8E6b2Ab71); // set as dev wallet
