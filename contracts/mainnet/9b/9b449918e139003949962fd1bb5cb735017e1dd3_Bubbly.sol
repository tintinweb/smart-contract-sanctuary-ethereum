...
contract Bubbly is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bubbly";
    string private constant _symbol = "BUB";
    ...
    address payable private _developmentAddress = payable(0x778bFdA6fEEa6d4D09b4fa937d923Abe3819Ba74); 
    address payable private _marketingAddress = payable(0x778bFdA6fEEa6d4D09b4fa937d923Abe3819Ba74);
