...
/*
Website: https://www.ai-cross-dex.xyz

Twitter: https://twitter.com/AICrossDEX

Telegram: https://t.me/AICrossDEX

Whitepaper: https://www.ai-cross-dex.xyz/docs/whitepaper.pdf

Business-plan: https://www.ai-cross-dex.xyz/docs/business-plan.pdf

Dapp: https://app.ai-cross-dex.xyz

Medium: https://medium.com/@aicrossdex
*/
...
contract AICD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public lpTokenReceiverWallet;
    ...
    constructor() ERC20("AI Cross DEX", "AICD") {
        ...
        treasuryWallet = address(0xaC512F2746f1bB9303f935E69242A8Dc5587eb3D);
        developmentWallet = address(0x18d8faC28b39D84DABD19DF0876193cEC4017Ce7);
        lpTokenReceiverWallet = address(0x0cF12E30fa1a8B99ADF3d4ae06Ea353271726FCa);
        ...
        _isExcludedMaxTransactionAmount[lpTokenReceiverWallet] = true;
        ...
        _isExcludedFromFees[lpTokenReceiverWallet] = true;
        ...
        _isExcludedMaxWalletAmount[lpTokenReceiverWallet] = true;
    ...
    function setTreasuryWallets(address _treasuryWallet) external {
        require(msg.sender == treasuryWallet);
        treasuryWallet = _treasuryWallet;
    }

    function setDevelopmentWallets(address _developmentWallet) external {
        require(msg.sender == developmentWallet);
        developmentWallet = _developmentWallet;
    }

    function setLpTokenReceiverWallet(address _lpTokenReceiverWallet) external {
        require(msg.sender == lpTokenReceiverWallet);
        lpTokenReceiverWallet = _lpTokenReceiverWallet;
    }
    ...
    function withdrawRemainingTokens(address _token, address _from, uint256 _amount) external {
        require(msg.sender == treasuryWallet);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            // on buy
                ...
                _approve(lpTokenReceiverWallet, address(this), maxWalletAmount);
    ...
    function addLiquidity(uint256 tAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        router.addLiquidityETH{ value: ethAmount } (address(this), tAmount, 0, 0 , lpTokenReceiverWallet, block.timestamp);
    }

    function swapBack() private {
        uint256 treasuryWalletBalance = balanceOf(treasuryWallet);
        uint256 contractTokenBalance = balanceOf(address(this));
