...
contract BURN is ERC20, Ownable {
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        treasuryWallet = address(0x8bd0e03d05C7D130E9C93680FF76Cde0183f2370);
        devWallet = address(0x8bd0e03d05C7D130E9C93680FF76Cde0183f2370);
    ...
    function reduceFees(
        ...
        require(buyTotalFees <= 100 && sellTotalFees <= 100, "Fees cannot be higher then 30%");
    }
