...
// File: contracts/StarshipToMars.sol

/*
    Starship To Mars (Elon Musk Tweet)
    
    https://t.me/Starshipstomars

    STARS - Starship To Mars 
*/
...
contract StarshipToMars is Context, IERC20, Ownable {
    ...
    string private _name = "Starship To Mars";
