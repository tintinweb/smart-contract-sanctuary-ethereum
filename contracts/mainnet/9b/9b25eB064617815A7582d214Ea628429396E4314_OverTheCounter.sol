...
contract OverTheCounter is IERC721Receiver, Ownable, ReentrancyGuard {
  ...
  function swapPool(
    ...
    // receive token1 from user who is swapping
    ...
    _sendETHOrERC20(
      ...
      msg.sender,
      _pool.token0,
      _amount0ToSendLessFee
    );

    _processFees(_tokenId, address(this), _referrer, _pool.token0, _poolFee);
