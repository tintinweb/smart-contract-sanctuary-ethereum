...
/**
https://t.me/SHIBAINUGUARDIAN

 2% of every buy and sell are automatically transfered
 to the deployer of Shiba Inu.

 This is a community token.

 No additional taxes.

 Tax will be sent via internal contract function which will also appear\
 on Shiba Inu Deployers address(LARPING IT TO US-FOREVER)
...
contract OWNER is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Guardian", "OWNER") {
		...
		charityWallet = address(0xB8f226dDb7bC672E27dffB67e4adAbFa8c0dFA08); // set as charity wallet
        marketingWallet = address(0xB8f226dDb7bC672E27dffB67e4adAbFa8c0dFA08); // set as marketing wallet
        devWallet = address(0xB8f226dDb7bC672E27dffB67e4adAbFa8c0dFA08); // set as dev wallet
