...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x7213bEE936263d8b4229be87b0C6a2f0CaA73a4f];
  address public erc20Payable = 0x7213bEE936263d8b4229be87b0C6a2f0CaA73a4f;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmWGAoE6Wbt8TCj8skVTYjtBMdSEtH3pX2JDzSq3VyjyoR/";
...
// File: contracts/KruitsTaleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KruitsTaleContract is RamppERC721A {
    constructor() RamppERC721A("Kruits Tale", "KruitsTale"){}
}
