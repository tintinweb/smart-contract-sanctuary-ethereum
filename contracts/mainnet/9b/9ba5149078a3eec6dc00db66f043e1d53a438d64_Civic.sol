...
contract Civic is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {

    // SETUP
    uint256 public maxSupply = 1600;
    uint256 public mintCost = 0.004 ether;
    uint256 public walletMax = 32;
    bool public saleActive = false;

    string public baseURI = "ipfs://QmSzBrYBLH6HJqE5ywuYcfwTyt92zDHCVE9t62fFHieRyC/";
    ...
    constructor () ERC721A("Civic by Honda", "CIVIC") {
    }

    ///// FUNCTIONALITY /////

    function mintCIVIC(uint256 mintAmount) public payable nonReentrant {
        require(saleActive, "Sale is not active.");
        require(addressToMinted[msg.sender] + mintAmount <= walletMax, "Wallet minted max.");
    ...
    function reserveCIVIC(uint256 mintAmount) public onlyOwner {
        require(totalSupply() + mintAmount <= maxSupply, "Sold out.");
