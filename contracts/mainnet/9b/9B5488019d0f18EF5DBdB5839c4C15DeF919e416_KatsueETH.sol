...
contract KatsueETH is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x83983891E8438873f5aDCedF5a9b94Acd9D34A51));

    string private _name = "Katsue";
    string private _symbol = "KTSN";
