...
contract YunaCatCollection is ERC721Enumerable, Ownable, IRamperInterface721 {
    ...
    uint256 constant public TOKEN_PRICE = 0.0052 ether;

    string public baseTokenURI = "ipfs://bafybeigpfzhi76pdgtn3lbc6svvg6ildokqtjldbf3dpxdb25uqfqu2qty/";

    constructor() ERC721("YunaCatCollection", "YCCNFT") {
