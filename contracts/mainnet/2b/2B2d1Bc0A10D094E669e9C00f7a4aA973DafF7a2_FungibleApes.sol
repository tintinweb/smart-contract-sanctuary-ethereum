...
contract FungibleApes is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor()
  ERC721A("Fungible Apes", "FunApes")
  {
    maxPerAddressDuringMint = 50;
    maxBatchSize = 10;
    collectionSize = amountForDevs = amountForSaleAndDev = 3420;
    saleConfig.publicPriceWei = 2 ether / 1000;  // 0.002 ETH
