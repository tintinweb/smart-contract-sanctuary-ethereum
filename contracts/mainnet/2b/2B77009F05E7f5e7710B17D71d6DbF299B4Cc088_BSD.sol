...
contract BSD is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Bone Staking Derivatives";
    string private constant _symbol = "BSD";
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 4200000 * (10**_decimals);
    ...
    address internal constant development_receiver =
        0x49e878B9d40CA9D86CFB9D9FB5FB919c653bD4EF;
