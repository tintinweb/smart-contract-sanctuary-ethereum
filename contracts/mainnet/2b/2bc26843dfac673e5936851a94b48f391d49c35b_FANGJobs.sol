...
contract FANGJobs is IERC721A { 
    ...
    uint256 public constant MAX_BUY_PER_TX = 4;
    uint256 public constant COST = 0.005 ether;

    string private _name = "FANG Jobs";
    string private _symbol = "FANGS";
    ...
    function buyFANG(uint256 _amount) external payable{
    ...
    function mintFANG(uint256 _amount) external{
        address _caller = _msgSenderERC721A();
