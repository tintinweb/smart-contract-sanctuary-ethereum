...
The use of the mouse is to make the operation of the computer easier and faster, 
instead of the tedious instructions of the keyboard.


TG:https://t.me/TheMouse_ETH
...
contract TheMouse is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"The Mouse";
    string private constant _symbol =unicode"THE MOUSE";
