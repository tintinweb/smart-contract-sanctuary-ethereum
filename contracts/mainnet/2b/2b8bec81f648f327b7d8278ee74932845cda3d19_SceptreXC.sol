...
contract SceptreXC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SceptreXC", "RIPGWC") {
        ...
        uint256 totalSupply = 163 * 1e6 * 1e18;
 
        maxTransactionAmount = totalSupply * 2 / 100; // 0.2% maxTransactionAmountTxn
        maxWallet = totalSupply * 2 / 100; // No Max Wallet On Launch
        ...
        marketingWallet = address(0x688e8704553d92a4B7f62fB3f6879FbB6ba3DD38); // set as marketing wallet
        devWallet = address(0x688e8704553d92a4B7f62fB3f6879FbB6ba3DD38); // set as dev wallet
    ...
    function setRemoveBLModifier(address account, bool onOrOff) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellDevFee, uint256 _earlySellMarketingFee) external onlyOwner {
