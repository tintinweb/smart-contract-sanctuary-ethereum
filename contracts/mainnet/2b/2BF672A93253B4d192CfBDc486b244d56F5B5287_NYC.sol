...
//
// Webiste: https://www.nyctoken.net
// Telegram: https://t.me/NYCtoken
...
contract NYC is ERC20, Ownable {
    ...
    uint256 public swapAtAmount = _tTotal.mul(30).div(10000);       // 0.3% of total supply
    ...
    constructor(address _dev) public ERC20("NYC Token", "NYC") {
