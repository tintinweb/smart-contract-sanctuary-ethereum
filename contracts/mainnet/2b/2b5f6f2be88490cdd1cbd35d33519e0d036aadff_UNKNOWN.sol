...
TAX: 3/3, Max wallet 3%, Max Tx 2%

We, the Unknown Generation, will create an "unknown" foundation within the crypto space.  A place where no one knows us, no one can defy us, and no one can rule upon us. We are the Unknown, and we will remain unknown forever.

https://t.me/GenerationXERC20

https://twitter.com/GenX_Erc20

https://medium.com/@genX-unknown
...
contract UNKNOWN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Generation X";
