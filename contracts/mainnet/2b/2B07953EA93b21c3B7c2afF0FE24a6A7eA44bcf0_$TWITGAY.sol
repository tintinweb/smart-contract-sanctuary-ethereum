...
/**
Twitter is Gay $TWITGAY Twitter is not working 
*/
...
contract $TWITGAY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Twitter is Gay";
    string private constant _symbol = unicode"TWITGAY";
