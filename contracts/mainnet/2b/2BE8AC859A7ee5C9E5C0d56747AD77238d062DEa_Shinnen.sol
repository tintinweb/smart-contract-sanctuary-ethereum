...
contract Shinnen is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"Shinnen", "23") {
        ...
        maxWallet = totalSupply * 15 / 1000; // 1.0 % maxWallet
        swapTokensAtAmount = totalSupply * 10 / 10000; // 1.5% swap wallet
