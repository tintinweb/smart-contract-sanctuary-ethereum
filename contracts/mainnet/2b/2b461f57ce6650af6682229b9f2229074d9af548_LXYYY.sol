...
contract LXYYY is ERC721A, Ownable, ReentrancyGuard, ERC2981 { 
...
uint256 public devTotal;
    ...
    constructor(string memory initBaseURI) ERC721A("liangxiyingyingying", "LXYYY") {
        baseURI = initBaseURI;
