...
contract RoadsToRiches is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.002 ether;
  uint public          maxPerTx          = 10;
  uint public          maxFreePerWallet  = 1;
  uint public          totalFree         = 7500;
  uint public          maxSupply         = 7500;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("PORSCHE 420", "420"){}
  ...
  function freeMint(uint256 amt) external callerIsUser {
    ...
    require(amt <= 10, "can not mint this many free at a time");
    require(numberMinted(msg.sender) + amt <= maxFreePerWallet,"Too many free per wallet!");
  ...
  function openMint(uint256 amt) external onlyOwner
  {
