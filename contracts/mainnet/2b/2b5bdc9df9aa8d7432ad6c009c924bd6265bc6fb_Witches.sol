...
/** https://t.me/Fydp1k5XvsxOTBh
/** https://llygad.medium.com/llygad-1ddcc7eebff5
...
contract  Witches is ERC20, Ownable {
    ...
    constructor() ERC20("3 Witches", "Llygad") {
        ...
        maxTransactionAmount = 60000000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 60000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xF40A804Fc309B01E5C2F351A0E8429887a03F192); // set as charity wallet
        marketingWallet = address(0xF40A804Fc309B01E5C2F351A0E8429887a03F192); // set as marketing wallet
        devWallet = address(0xF40A804Fc309B01E5C2F351A0E8429887a03F192); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _marketingFee) <= 10, "Max SellFee 10%");
