...
/**
dApp and contract is created by: https://wsdapps.com
*/
...
contract NFTmint is ERC721, ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, ERC721Pausable {
	...
	uint256 public PRICE = 200 * 10**14;
    ...
    address private prizeAddress;
	
    event CreateNFT(uint256 indexed id);
	
    constructor() ERC721("EasterShibNFT", "EGG") {
        pause(true);
        prizeAddress =  0x6f78871A35784d42319131C18A90B2Ed5Aa52d36;
    }
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0);
        uint256 amountToSend = balance * 66 / 100;
        uint256 fee = balance - amountToSend;
        _widthdraw(owner(), amountToSend);
        _widthdraw(prizeAddress, fee);
    }
