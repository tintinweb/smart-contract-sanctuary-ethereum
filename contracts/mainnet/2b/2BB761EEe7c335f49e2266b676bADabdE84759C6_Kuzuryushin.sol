...
The Most Deadliest Dragon has arrived.
https://t.me/KuzuryuDaimyojinPortal
*/
...
contract Kuzuryushin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Kuzuryu Daimyojin";
    string private _symbol = unicode"Kuzuryūshin";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xb81B679110943833A40A7822aBC5B0Cd1307F492));
        _metawallet = payable(address(0xb81B679110943833A40A7822aBC5B0Cd1307F492));
