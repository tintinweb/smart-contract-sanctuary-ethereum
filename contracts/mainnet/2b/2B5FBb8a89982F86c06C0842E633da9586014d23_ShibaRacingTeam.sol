...
contract ShibaRacingTeam is Ownable, ERC721A, DefaultOperatorFilterer, ReentrancyGuard {
    bool public saleStarted = false;

    uint256 public maxToken = 9990;
    uint256 public price = 0.04 ether;

    string private _baseTokenURI= "ipfs://QmVEbzHwAcF4CD1dRgQX5xpTxrYJiVA2eTyFcgXCyZTqWT/";
    string public _extension = ".json";

    constructor()  ERC721A("Shiba Racing Team", "SRT1", 9990, maxToken){}
    ...
    function mint(uint256 quantity) public payable {
        require(saleStarted, "SALE_HAS_NOT_STARTED_YET");
   ...
   function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
    ...
    function changeMaxToken(uint _temp) onlyOwner public {
        maxToken = _temp;
    }
