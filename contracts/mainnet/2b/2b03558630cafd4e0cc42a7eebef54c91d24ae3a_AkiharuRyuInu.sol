...
contract AkiharuRyuInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public lpBurnFrequency = 2600 seconds;
        ...
        ERC20("Akiharu Ryu Inu", "ARINU")
    {
        ...
        //update name/ticker 
        _name = "Akiharu Ryu Inu";
        _symbol = "ARINU";

        tokenOwner = newOwner;

        maxTxnAmount = (totalSupply * 10) / 1000; // 1% of maxTxnAmount
        maxWallet = (totalSupply * 10) / 1000; // 1% maxWallet
        swapTokensAtAmount = (totalSupply * 10) / 10000; // 1% swap amount
        ...
        */
        ...
        _createInitialSupply(tokenOwner, (totalSupply * 2) / 100);
        _createInitialSupply(address(this), (totalSupply * 98) / 100);
    }
