...
library MessageConstants {
    string public constant MAX_SUPPLY = "Max supply will be exceeded";
}
 ...
 */
contract TWDDegenerativeStage4B is ERC721Airdroppable, Terms {
    /**
     * @notice TWDDegenerativeStage4B constructor.
     *
     * @param name The token name.
     * @param symbol The token symbol.
     */
        ...
        ERC721Airdroppable(name, symbol)
    {
        ...
        _baseTokenURI = "https://api.orangecomet.io/collectible-metadata/twd-degenerative-stage-4b/";

        // Initial contract URI
        _contractURI = "https://api.orangecomet.io/collectible-contracts/twd-degenerative-stage-4b/opensea";
