...
contract Parabolic is Context, IBEP20, Ownable {
    ...
    string private _name    = "Parabolic";
    ...
    uint256 public _numTokensSellToAndTransfer      = 1000 * 10**6 * 10**_decimals;
    ...
    function bridgeBurn(address from, uint amount) external onlyBridge() tempExcludeRewards(from) {
      bool addressIsExcludedFromReward = isExcludedFromReward(from);
