...
contract ZelenskiyDigitalTradingCards is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    ) ERC721A("Zelenskiy Digital Trading Cards", "Zelenskiy Digital Trading Cards") {
        PRICE = price;
    ...
    address private constant payoutAddress1 =
        0xa42124D4C69a23602114bF8a61a4d2f081C8Af59;
