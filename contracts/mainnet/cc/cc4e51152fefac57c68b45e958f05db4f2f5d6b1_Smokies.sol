...
/**
Fluttering. Hypnotic. Interactive! 
The Smokies are 1555 friendly puffs of smoke that you can interact with. 
You will remain hours to make them flutter on your screens. 
Each smokie is unique with different attributes and different possible animations.
...
contract Smokies is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.15 ether;
    uint256 public NFT_PRICEx5 = 0.12 ether;
    uint256 public MAX_SUPPLY = 1555;
    uint256 public maxFreeMint = 0;
    uint256 public cap = 1555;
    ...
    constructor() ERC721A("Smokies", "SMKs", MAX_MINTS, MAX_SUPPLY) {  
    }
    ...
    function setPrice(uint256 newPrice, uint256 newPricex5) public onlyOwner {
        NFT_PRICE = newPrice;
    ...
    function setRound(uint256 newPrice, uint256 newPricex5, uint256 _cap) public onlyOwner {
        NFT_PRICE = newPrice;
        NFT_PRICEx5 = newPricex5;
        cap = _cap;
    }
