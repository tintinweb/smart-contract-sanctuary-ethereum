...
contract BananaBallers is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;

    address payable private _PaymentAddress = payable(0x7352F978247cBD11e0795EAddc9C1BF482d8125A);
    address payable private _DevAddress = payable(0x7De83438D71cCF4A5121e12259ec4e717E9b7205);

    uint256 public MAX_SUPPLY = 5002;
    ...
    uint256 private PRESALE_PURCHASE_LIMIT = MAX_SUPPLY;
    uint256 private PUBLIC_PURCHASE_LIMIT = MAX_SUPPLY;
    uint256 private POOL_PERCENT = 10;
    ...
    constructor() ERC721("Banana Ballers", "BANANAB") {}

    function setPaymentAddress(address paymentAddress, address devAddress, uint256 pool) external onlyOwner {
    ...
    function purchase(uint256 numberOfTokens) external payable {
        ...
        if (msg.sender != owner()) {
            ...
            if (POOL_PERCENT > 0) {
                ...
                _DevAddress.transfer(poolAmount);
