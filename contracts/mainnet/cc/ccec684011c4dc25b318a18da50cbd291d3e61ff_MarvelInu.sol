...
Marvel Inu is a very ambitious project that aims to create an ecosystem that mixes our love for Marvel. Our goals are big and audacious. 
🌐Website : https://marvelinu.one/
*/
...
contract MarvelInu      is Context, IERC20, Ownable {
    ...
    string private _name = 'Marvel Inu  ';
    string private _symbol = 'MARVELINU   ';
