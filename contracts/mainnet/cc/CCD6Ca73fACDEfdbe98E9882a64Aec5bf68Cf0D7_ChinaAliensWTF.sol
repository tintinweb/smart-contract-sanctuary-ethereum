...
contract ChinaAliensWTF is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmWUv7KTPujTVHNqH9h7QomTMjHkbmc3Z7oPRmB3aAJWXJ";
    ...
    constructor(
    ) ERC721A("ChinaAliens.WTF", "WTF THERES CHINESE ALIENS???", 100, maxSupply) {
    }
