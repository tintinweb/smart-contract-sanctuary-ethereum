...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x3df1C6c2D595eE3B5f33BD7B26EEf946e9977859];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 1111;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 4444) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmS4vhrLiUoqKMWK2rVSu1edKaCWQzhviC8tu2CCZdH9LR/";
...
// File: contracts/DegendinosContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DegendinosContract is RamppERC721A {
    constructor() RamppERC721A("DEGEN DINOS", "DegenDinos"){}
}
