...
// Medium:
// https://medium.com/@TheFutureeth/the-future-remain-bc526acb4767
...
contract Future is IERC20, Auth {
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0x5046dAd86F39cD266BcD265482D4fadd3B5Baa8e);
	    teamFeeReceiver = address(0x5046dAd86F39cD266BcD265482D4fadd3B5Baa8e);
    ...
    function launchMode() internal view returns(bool) {
        return launchedAt !=0 && launchedAt + 3 < block.number && launchedTime + 1 minutes >= block.timestamp ;
    }
