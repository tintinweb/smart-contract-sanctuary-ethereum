...
contract Buoy is Ownable, ERC721A {

    // constants
    uint256 constant MAX_ELEMENTS = 100;
    uint256 constant MAX_ELEMENTS_TX = 3;
    uint256 constant MAX_FREE_PER_TX = 1;
    uint256 constant PUBLIC_PRICE = 1 ether;

    string public baseTokenURI = "ipfs://QmbcoyZu6MxVfXz4SULCXAgNnjvye4zARk7x9vscB2E8Nn/";
    bool public paused = false;

    constructor(uint256 maxBatchSize_) ERC721A("The Buoy", "BUOY", maxBatchSize_) {}
