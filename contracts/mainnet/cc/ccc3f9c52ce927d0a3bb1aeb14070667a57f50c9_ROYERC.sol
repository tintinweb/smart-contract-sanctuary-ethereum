...
contract ROYERC is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ROY";
    string private constant _symbol = unicode"ロイ";
    ...
    address payable private _developmentAddress = payable(0xdD848221f38DF674094398d4EEFE1B085A09eeD3);
    address payable private _marketingAddress = payable(0xdD848221f38DF674094398d4EEFE1B085A09eeD3);
