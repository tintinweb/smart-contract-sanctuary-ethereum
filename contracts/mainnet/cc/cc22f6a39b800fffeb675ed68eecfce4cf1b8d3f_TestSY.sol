...
Because why not? It seems to work?
...
contract TestSY is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TestSY";
    string constant _symbol = unicode"实验";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 2_000_000 * (10 ** _decimals);
    ...
    function setmarketingFee(uint256 _marketingFee) external onlyOwner {
        ...
        require(marketingFee<=95,"Fee should be less than 10%");
    }
