...
// File: contracts/ThroughOtherEyes.sol
...
contract ThroughOtherEyes  is ERC721A, Ownable, DefaultOperatorFilterer {
    uint256 max_supply = 500;

    string public baseURI = "ipfs://bafybeigzfo5yhkfcpzjdljm7bijy4agoffq3a2hm2lke3rtb5jrsftsnsm/";

    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("Through Other Eyes", "TOE") {
    }
