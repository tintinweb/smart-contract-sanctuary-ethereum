...
//neverrug
//t.me.neverrug
//for everyone that has been rugged too many times
...
//--- Contract v2 ---//
contract RICK is Context, Ownable, IERC20 {
    ...
    string constant private _name = "Never Rug";
    string constant private _symbol = "NORUG";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function enableTrading(uint256 deadline) external onlyOwner {
            require(deadline < 8,"Deadline too high");
