...
/*
JUST IN: $META (Facebook) offers to discuss Twitter moderation with Elon Musk.
*/
...
contract ERC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bye Zuckerberg";
    string private constant _symbol = "ZUCKERBERG";
