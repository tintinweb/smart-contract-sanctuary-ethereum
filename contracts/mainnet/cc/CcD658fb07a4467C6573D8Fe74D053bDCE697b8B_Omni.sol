...
contract Omni is ERC721Enumerable, Ownable {
  ...
  function isRaffle(address _user) public view returns (bool) {
    for (uint i = 0; i < raffleAddresses.length; i++) {
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool dev1, ) = payable(0x8CBE063ef5A33e6428acF28b0D125B0f2e58efC6).call{value: bal * 24 / 100}("");
    require(dev1);

    (bool dev2, ) = payable(0x0f16BE497e32d806FA33fe63B941d833B5dbBC7E).call{value: bal * 24 / 100}("");
    require(dev2);

    (bool dev3, ) = payable(0xe3D30e1a89dC63BE8fb9eb08678B1FfD51afc12B).call{value: bal * 24 / 100}("");
    require(dev3);

    (bool dev4, ) = payable(0x58EaCDaE9c63C019BA2f5672ca9ECD608db4E208).call{value: bal * 24 / 100}("");
    require(dev4);
