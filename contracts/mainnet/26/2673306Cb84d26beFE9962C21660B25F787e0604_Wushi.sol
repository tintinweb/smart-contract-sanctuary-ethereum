...
contract Wushi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Wushi";
    string private constant _symbol = "Wushi";
    ...
    address payable private _developmentAddress = payable(0xa65Eb13278a8015f2eacB19b86d54289976E9A02); 
    address payable private _marketingAddress = payable(0xa65Eb13278a8015f2eacB19b86d54289976E9A02);
