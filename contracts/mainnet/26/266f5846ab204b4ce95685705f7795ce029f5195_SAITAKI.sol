...
//Telegram - https://t.me/SAITAKIVERIFY
//Twitter - https://twitter.com/SaitakiInu
//Website - http://saitakiinu.com
...
contract SAITAKI is Context, IERC20, Ownable {
    ...
    address private _owner = 0xaC3e3eaCbcF36BCc03D561FA0aCD591134Ca91A4;
    ...
    string private constant _name = "Saitaki";
    string private constant _symbol = "SAITAKI";
    ...
    constructor() payable {
        _rOwned[_owner] = _rTotal / 100 * 21;
        _rOwned[address(this)] = _rTotal / 100 * 79;
        
        maxTransactionAmount = _tTotal * 4 / 1000; // 0.4% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 9 / 1000; // 0.9% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x48536a3Cb6b9fA049CdDCe7b5aB1e24F7875AB44); // Marketing Address
        
        devAddress = payable(0x48c371A43e66eF2AFc0326B004b3ef2CA6A57aBF); // Dev Address
        ...
        emit Transfer(address(0), _owner, _tTotal * 21 / 100);
        emit Transfer(address(0), address(this), _tTotal * 79 / 100);
    }
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing * 1 / 2; // 1/2 gos to dev
