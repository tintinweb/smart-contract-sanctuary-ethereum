...
// File contracts/Permissionless.sol

//

pragma solidity ^0.8.4;

contract Permissionless is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("permissionless.cc", "PERMISSIONLESS") {
        PRICE = price;
        MAX_SUPPLY = max;
    ...
    function getPermissionlessPic(uint32 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    function sendPermissionlessPic(address _to, uint _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
