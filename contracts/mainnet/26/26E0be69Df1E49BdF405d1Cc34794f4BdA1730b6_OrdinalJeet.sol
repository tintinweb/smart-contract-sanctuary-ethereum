...
/**
Tired of every project dying within the first 60 minutes? Get yourself some $oJEET,
a revolutionary coin designed to combat early profit taking. Ordinal Jeet features a 
time degrading sell tax that promotes holding and stops jeeting in its tracks.


https://t.me/ordinaljeet
...
contract OrdinalJeet is ERC20, Ownable {
    ...
    address public marketingWallet = 0x1498a79855d03eBDb9351EAcd27f33e182fb9F43;
    ...
    constructor (address _newOwner) ERC20("Ordinal Jeet", "oJEET") {
    ...
    uint256 private maxTransactionRateBuy = 25;   
    uint256 private maxTransactionRateSell = 25;
