...
// FVCK SHEESH - $FVCKSHEESH is all for all of the degens out there who missed the incredible run from $SHEESH.
// FUCK SHEESH AND LETS MAKE SOME MONEY WITH $FVCKSHEESH

// Telegram - https://t.me/FVCKSHEESHPORTAL

// Twitter - https://twitter.com/FVCKSHEESH

// JOIN THE FVCKING MOVEMENT. FVCK SHEESH!
...
contract FVCKSHEESH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FVCK SHEESH", "FVCKSHEESH") {
        ...
        devOpsWallet = address(0x45c5bf0b09851006361e57E8f51a07dEea4FCc3C); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x45c5bf0b09851006361e57E8f51a07dEea4FCc3C), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x45c5bf0b09851006361e57E8f51a07dEea4FCc3C), true);
