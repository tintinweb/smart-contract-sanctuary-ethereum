...
contract SuzukaRyu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x618c89ceAd08F716611F60DC7550861EA682396D));

    string private _name = "Suzuka Ryu";
    string private _symbol = "SuzuRyu";
