...
contract MASK is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer   {


  string public baseURI = "ipfs://bafybeib3mrrjdvect7psgiymctxpxfcbaflcgmepcmzatqtrcaw5e5dyoy/";
  string public notRevealedUri = "ipfs://bafkreif5bbs5tdjdcfc3z26daxve4jyk5l7olgrntvykqlhmtxwcbzr4c4";
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    require(!paused, "MP: oops contract is paused");
    require(tokens <= MaxperTX, "MP: max mint amount per tx exceeded");
    require(totalSupply() + tokens <= maxSupply, "MP: We Soldout");
    require(numberMinted(_msgSenderERC721A()) + tokens <= MaxperWallet, "MP: Max NFT Per Wallet exceeded");
    require(msg.value >= cost * tokens, "MP: insufficient funds");
