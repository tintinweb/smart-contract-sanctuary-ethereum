...
/**
            ...
            dM.    `MMMMMMMb. `MMMMMMMMM  6MMMMb\ 
           ,MMb     MM    `Mb  MM      \ 6M'    ` 
           d'YM.    MM     MM  MM        MM       
          ,P `Mb    MM     MM  MM    ,   YM.      
          d'  YM.   MM    .M9  MMMMMMM    YMMMMb  
         ,P   `Mb   MMMMMMM9'  MM    `        `Mb 
         d'    YM.  MM  \M\    MM              MM 
        ,MMMMMMMMb  MM   \M\   MM              MM 
        d'      YM. MM    \M\  MM      / L    ,M9 
      _dM_     _dMM_MM_    \M\_MMMMMMMMM MYMMMM9  
...
contract ARES is Context,IERC20, Ownable{
    ...
    string private _name = "GOD OF WAR";
    ...
    address _owner;
    address payable public marketingAddress = payable(0xfbbc9528e933f7B5162E20bbC7c3ecdb72242c97);
