...
/**
  Telegram: t.me/BasedLaunchpad
  Website: https://basedlaunchpad.com
  Twitter: twitter.com/BasedLaunchpad
 */
...
contract BasedPAD is Context, IERC20, Ownable {
    ...
    uint256 private constant minSwap = 900 * 10**_decimals; //0.03% from (supply - burn 60%)
    uint256 private constant onePercent = 30000 * 10**_decimals; //1% from (supply - burn 60%)
    ...
    string private constant _name = "Based Launchpad";
    string private constant _symbol = "$BASEDP";
