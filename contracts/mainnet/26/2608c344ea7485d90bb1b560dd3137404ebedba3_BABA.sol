...
Ryan Cohen is taking a stake in Alibaba (BABA)

Might mean the stock will pump
Might not

The timing, a little bit suspect right?

Let's see how this goes
Maybe we can get some more money and liquidity into this thing

https://twitter.com/muddywatersre/status/1615135461793533952?s=20&t=4wnHfiG9k2SbPuQYLzfmiQ
...
contract BABA is ERC20, Ownable {
    ...
    constructor() ERC20("Alibaba", "BABA") {
        ...
        uint256 totalSupply = 84840000 * 1e18;

        maxTransactionAmount = 1696800 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 1696800 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x0bc8CFab23877f64D0b3C75415a3E84A017A4A06); // set as charity wallet
        marketingWallet = address(0x0bc8CFab23877f64D0b3C75415a3E84A017A4A06); // set as marketing wallet
        devWallet = address(0x0bc8CFab23877f64D0b3C75415a3E84A017A4A06); // set as dev wallet
