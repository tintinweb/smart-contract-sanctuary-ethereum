...
contract MrTweet is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Mr.Tweet";
    ...
    address payable private _developmentAddress = payable(0x81E53436079cF05Bd0c59dACA28c26b4ec46774C); 
    address payable private _marketingAddress = payable(0x81E53436079cF05Bd0c59dACA28c26b4ec46774C);
