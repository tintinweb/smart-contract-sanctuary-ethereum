...
'----------|  |---' 
           |  |     
          /____\    
   Keep building. If you want to help a person for a day, give them crypto
   If you want to help a person for a life time, teach them crypto
   There is no overnight success - CZ     
...
abstract contract Project {
    address public marketingWallet = 0x3373f61567a641c699D342D17C8908111eF71b3b;
    address public devWallet = 0x3373f61567a641c699D342D17C8908111eF71b3b;

    string constant _name = "Free Changpeng Zhao";
    string constant _symbol = "FREECZ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 50) / 1000; // (_totalSupply * 10) / 1000 [this equals 1%]
 ...
 * MainContract
 */
contract freeczContract is Project, IERC20, Ownable {
