...
contract StonerKong is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x4759a273673824D83D20cAe3849c6A696883bb87));
    ...
    string private _name = "StonerKong";
    ...
    uint256 public _maxTxAmount = 50 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 100 * 10**19 * 10**9;
