...
We will be developing an in-depth remixer on ETH network as well as a wallet that automatically 
keeps prying eyes away while keeping your funds secure using a number of features.

Website - https://SnowEth.tech

Twitter - https://mobile.twitter.com/SnowToken
...
contract SnowToken is Ownable, IERC20 {
    ...
    string constant private _name = "Snow Token";
    string constant private _symbol = "$SNOW";
    ...
    constructor() {
        ...
        lpWallet = 0x66E8F2C712Ffc140243fBfbE5437aBBfbB603758;
        projectAddress = 0x66E8F2C712Ffc140243fBfbE5437aBBfbB603758;
        devWallet = 0x66E8F2C712Ffc140243fBfbE5437aBBfbB603758;
