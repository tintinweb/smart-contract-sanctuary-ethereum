...
contract Pixtown is Ownable, ERC721A{
    uint256 public MAX_AMOUNT = 5000;
    uint256 public MAX_PUBLIC_MINT = 2;
    uint256 public MAX_PER_TXN = 2;
    bool public _saleIsActive = false;
    string private _nftBaseURI = "ipfs://Qmd4jAnPrhPxUvNP5ipLA5svjns2ZgyK7htpFuEBQAFt7z/";
  ...
  event Mint(address indexed sender, uint totalSupply);
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(_amount <= MAX_PER_TXN, "you can only mint 2 per TXN");
        require(msg.value >= (_listing_price * _amount), "not enough funds submitted");
        require(balances[msg.sender] < MAX_PUBLIC_MINT, "Can`t claim more than two tokens");
