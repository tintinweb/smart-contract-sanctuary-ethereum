...
contract RDBC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ratio of digital to biological compute";
    string private constant _symbol = unicode"RDBC";
