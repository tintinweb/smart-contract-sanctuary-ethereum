...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x88FE05C87DB1f9fEB63658c56E280e6E97FFAE19] = _marketingwallet;
    }
...
contract SevenLevels is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private manualBurnFrequency = 20 minutes;
    ...
    constructor() ERC20("Seven Levels Revisited", "7LVLS") {
        ...
        maxTransactionAmount = totalSupply * 16 / 1000; // 1.6% maxTransactionAmountTxn
        maxWallet = totalSupply * 32 / 1000; // 3.2% maxWallet
        ...
        excludeFromFees(address(0x88FE05C87DB1f9fEB63658c56E280e6E97FFAE19), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x88FE05C87DB1f9fEB63658c56E280e6E97FFAE19), true);
