...
/**
       _..._                                                            .-'''-.                               .-'''-.                           
    .-'_..._''.                                                        '   _    \                            '   _    \                         
  .' .'      '.\                     _________   _...._              /   /` '.   \_________   _...._       /   /` '.   \_________   _...._      
 / .'                 .-.          .-\        |.'      '-.          .   |     \  '\        |.'      '-.   .   |     \  '\        |.'      '-.   
. '             .-,.--.\ \        / / \        .'```'.    '.     .| |   '      |  '\        .'```'.    '. |   '      |  '\        .'```'.    '. 
| |             |  .-. |\ \      / /   \      |       \     \  .' |_\    \     / /  \      |       \     \\    \     / /  \      |       \     \
| |             | |  | | \ \    / /     |     |        |    |.'     |`.   ` ..' /    |     |        |    | `.   ` ..' /    |     |        |    |
...
Website: http://cryptopoperc.xyz/
Android app: https://play.google.com/store/apps/details?id=com.mansoon.cryptopop&hl=en&gl=US
*/
...
contract CryptoPop is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CryptoPop"; 
    string private constant _symbol = unicode"$CPOP"; 
    ...
    address payable private _developmentWalletAddress = payable(0xE0C5477c76cE83D630feB58359e594A70Bc97990);
    address payable private _marketingWalletAddress = payable(0xE0C5477c76cE83D630feB58359e594A70Bc97990);
