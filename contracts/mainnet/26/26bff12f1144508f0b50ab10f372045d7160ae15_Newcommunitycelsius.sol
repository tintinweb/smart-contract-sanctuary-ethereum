...
Hello and welcome to New Community Celsius!

There are couple of things to say before we explain you what's this all about.
So you apparently heard about Celsius and what threatens to happen to it. As of market bleeding 
pretty hard, it is quite possible, the mighty Luna scenario.
With #FUCKCELSIUS trending on Twitter, we have extrodinary chances to embrace this opportunity,
and make this one, a big one!

Here is the deal from our side;
 - Initial liquidity will be 1 ETH.
 - Liquidity will be locked initially for 7 days ( Unicrypt ), PRE LAUNCH!
 - Max transaction will be 2% and wallet will be 3%.
   ( This won't be lifted as we want to maintain good wallet distro,
     not allowing pnds )    
 - Tax will be 1%, as this is a community token afterall.
 - There will be no official telegram group made by us.
 - Cooldown will be removed at 20-30k, following by renouncing of the contract.
 - Liquidity lock will be extended exactly at 123k marketcap, for 1 month.
 - Liquidity lock will be extended for 69 years at 567k marketcap.
  **  It might happen that sites for checking tokens for hpots
      shows it as positive, remember that this is due to small max tx at low marketcap stage.
      Once we take off, it will show it as it is.
  *** Trading will be opened after exactly 30 minutes of us locking it.  

This is made for you, for the community!
...
contract Newcommunitycelsius is Context, IERC20, Ownable {
    ...
    uint256 public _tokensBuyFee = 1;
    uint256 public _tokensSellFee = 1;
    ...
    string private constant _name = "New Community Celsius";
    string private constant _symbol = "cCels";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x04DCb2074bd37e8c67B47f785245F64177941167);
