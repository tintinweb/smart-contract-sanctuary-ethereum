...
// File: contracts/4_BESSFRENS.sol

/***
 *     _______   ________   ______    ______   ________  _______   ________  __    __   ______  
 *    /       \ /        | /      \  /      \ /        |/       \ /        |/  \  /  | /      \ 
 *    $$$$$$$  |$$$$$$$$/ /$$$$$$  |/$$$$$$  |$$$$$$$$/ $$$$$$$  |$$$$$$$$/ $$  \ $$ |/$$$$$$  |
...
contract BESSFRENS is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 public constant PRICE_PER_TOKEN_WL = 0.04 ether;

    mapping(address => uint8) private _allowList;

    constructor() ERC721("BESSFRENS", "BFRENS") {
    }
    ...
    function constructTokenURI(uint256 tokenId) internal pure returns (string memory) {
        return append("https://bessfrens.mypinata.cloud/ipfs/QmTBhdiXDgdmQdZyxHAEYefvqRwJiW828iP1bYzNuKL1pN/BESSFREN", uint2str(tokenId), ".json");
    }
