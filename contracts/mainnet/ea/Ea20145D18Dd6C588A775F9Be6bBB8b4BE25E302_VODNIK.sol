...
contract VODNIK is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("0xVodnik Mystery Drop", "0xVODNIK")
    {
        baseURI = _baseURI;
