...
/*
.https://t.me/PusukeShibaETH
.https://pusukeshiba.xyz
*/
...
contract PusukeShiba is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x0852C0a4AAeAa7Baa7267faefAbFe5D1BF524264));

    string private _name = "PusukeShiba";
    string private _symbol = "PusukeShiba";
