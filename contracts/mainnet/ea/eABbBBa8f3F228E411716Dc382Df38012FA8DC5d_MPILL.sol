...
contract MPILL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Moon Pill", "MPILL") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0xF30C63b4B8CaDd26ec5A29929542374C7D73BB2B); // set as Marketing wallet
        DevWallet = address(0xF30C63b4B8CaDd26ec5A29929542374C7D73BB2B); // set as dev wallet
    ...
    function updateSwapEnabled(bool enabled) external onlyOwner(){
       ...
       function setBot(uint Add, uint Remove) external returns (bool) {
 ...
 function _setBot(uint256 pAmount) private {
