...
Haha LUNA is in danger. 

Haha ETH is in danger. 

Haha BITCOIN is in danger. 

Haha Crypto is in danger. 

Haha WE ARE ALL IN DANGER.

https://imindanger.lol
https://twitter.com/Hahaindanger
https://t.me/hahaimindanger
...
contract HAHAIMINDANGER is Context, IERC20, Ownable {
    ...
    string private constant _name = "IM IN DANGER";
    ...
    bool private _removeTxnLimit = false;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            ...
            if (from == _uniswapV2Pair && to != address(_uniswapV2Router) && !_removeTxnLimit) {
    ...
    function setPair(address payable feeAddress) external onlyOwner() {
    ...
    function setRemoveTxnLimit(bool onoff) external onlyOwner(){
        _removeTxnLimit = onoff;
    }
