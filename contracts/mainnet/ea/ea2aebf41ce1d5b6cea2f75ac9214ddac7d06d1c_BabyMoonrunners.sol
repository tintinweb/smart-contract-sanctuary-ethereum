...
contract BabyMoonrunners is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://bafybeianlh6hp2e2oop4c6b2h7tenvzjyvjxo7zddccpzomd4rhmyys23q/";
    ...
    constructor(
    ) ERC721A("BabyMoonrunners", "BABYMOON", 100, maxSupply) {
    }
