...
/**
░T░H░E░ ░A░P░E░ ░P░R░O░T░O░C░O░L 
*/

// https://t.me/TheApeProtocol 

// https://TheApeProtocol.com (Official Website)
...
contract TheApeProtocol is BEP20, Auth {
    ...
    string public constant name = "The Ape Protocol";
    string public constant symbol = "$TAP";
    uint8 public constant decimals = 8;

    uint256 public constant totalSupply = 1 * 10**11 * 10**decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6650559A24a4F91e29A056C2565bCdA891A240Bc;
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0x6650559A24a4F91e29A056C2565bCdA891A240Bc;
        devFeeReceiver = 0x6650559A24a4F91e29A056C2565bCdA891A240Bc;
