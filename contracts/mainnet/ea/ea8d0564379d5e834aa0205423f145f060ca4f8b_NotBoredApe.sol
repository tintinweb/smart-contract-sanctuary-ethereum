...
contract NotBoredApe is Context, IERC20, Ownable {
    ...
    string private _name = "Not Bored Ape";
    string private _symbol = "NOTBOREDAPE";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 10000000, "Max Tx Amount cannot be less than 69 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 100000, "Swap Threshold Amount cannot be less than 69 Million");
