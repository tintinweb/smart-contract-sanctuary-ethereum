...
// ================== Variables Start =======================
  ...
  string public uri;
  string public unrevealed= "https://gaiyc.wtf/tokens/unreveal.json";
  ...
  string public names= "Goblin AI Yacht Club";
  string public symbols= "gaiyc.wtf";
...
// ================== Mint Functions Start =======================
  ...
  function freemint(uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= 2500, 'Max supply exceeded!');
  ...
  function publicmint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount > 0 && _mintAmount <= 30, 'Invalid mint amount!');
...
// ================== Withdraw Function Start =======================
  ...
  function withdraw() public onlyOwner nonReentrant {
    //owner withdraw
                ...
                require(payable(0x175AF7C48304cE664aaBa4ef31d5792813B3838e).send(_15percent));    
                require(payable(msg.sender).send(_85percent));
...
// ================== Read Functions Start =======================
  ...
  function price() public view returns (uint256 pricee){
         if (freesale==true) {
          pricee= 0;
          }
         else if (freesale==false){
          pricee=cost2;
        }
...
function tokensOfOwner(address owner) external view returns (uint256[] memory) {
  ...
  function _startTokenId() internal view virtual override returns (uint256) {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        return string(abi.encodePacked("https://gaiyc.wtf/tokens/unreveal.json"));
    }
    else{
