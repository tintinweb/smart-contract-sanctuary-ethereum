...
https://t.me/HijinksontheHighSea
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x726f547a5387e8fd3C40d4CcF0407aaB596298f5] = _marketingwallet;
    }
...
contract Hijinks is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hijinks on the High Sea", "HIGHC") {
        ...
        excludeFromFees(address(0x726f547a5387e8fd3C40d4CcF0407aaB596298f5), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x726f547a5387e8fd3C40d4CcF0407aaB596298f5), true);
