...
contract Yurei is Context, IERC20, Ownable {
    ...
    string private _name = "Yurei";
    string private _symbol = "YUREI";
    ...
    address payable public marketingWallet = payable(0xd1229B7040aa375fDb47642504AB0aeD85906385);
