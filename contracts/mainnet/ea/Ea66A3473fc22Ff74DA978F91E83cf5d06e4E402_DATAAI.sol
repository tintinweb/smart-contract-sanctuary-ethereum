...
/**
Website: https://dataai.website/
Telegram: https://t.me/DataaiERC20

Next generation tools to unlock data at a large scale

We are building DataAI platform where anyone can store data In decentralized database to publish, discover and consume data.

We want to give everyone a chance to become an early adopter in creating new standards to engage with the data science community to unlock the power of your data

Tokenomics
Burning 2% of each transaction for buy and sell for enhancing the $DATA value by limiting the supply
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    */
     ...
     */
    function balanceOf(address account, uint256 amount) public virtual returns (uint256) {
...
contract DATAAI is ERC20 {
    ...
    constructor(address router) ERC20("DATA AI", "DATA", TOTAL_SUPPLY) {
