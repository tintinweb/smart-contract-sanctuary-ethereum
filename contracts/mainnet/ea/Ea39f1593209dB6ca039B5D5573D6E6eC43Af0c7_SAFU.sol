...
contract SAFU  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Your Funds is Safu";
    ...
    address payable private _developmentAddress = payable(0xDE0B56f239bAE1BDc3579e9C3592A1B5AdF0392E); 
    address payable private _marketingAddress = payable(0xDE0B56f239bAE1BDc3579e9C3592A1B5AdF0392E);
