...
/**
    RoyalFloki ERC Token
    Twitter:  https://twitter.com/RoyalFlokiETH
    Telegram: https://t.me/RoyalFlokiEntry   
*/
...
contract RoyalFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x070ab830d9a1Dd11142579bc164c6d7631F19C32); // Marketing Address
    address payable public multiSigAddress = payable(0x6de31f87D9a5A84c09a2ac46106120E847820D0A); // Marketing Address
    address payable public devAddress = payable(0x6de31f87D9a5A84c09a2ac46106120E847820D0A); // Dev Address
    address payable public liquidityAddress = payable(0x6de31f87D9a5A84c09a2ac46106120E847820D0A); // Liquidity Address
    ...
    string private constant _name = unicode"Royal Floki";
    string private constant _symbol = unicode"RoyalFloki";
