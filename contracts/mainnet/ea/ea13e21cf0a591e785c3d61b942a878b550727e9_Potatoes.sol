...
contract Potatoes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmc7hFhjycgzA1Pf3VwCtkC3dFvwDLFT251Mk8AEMHa5gt";
    ...
    constructor(
    ) ERC721A("Potatotown.wtf", "GP", 100, maxSupply) {
    }
