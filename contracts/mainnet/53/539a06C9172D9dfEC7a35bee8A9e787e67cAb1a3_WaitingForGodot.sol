...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _sushiswap = 0x5A42103B5e7c710901Cff5a14bBa0a9f2aFF7a54;
    uint256 private creationHash = 0xc3ddd0d21745d749552ebbbcd61049e6be038d3fd9212393dd369c65cdd20c77;
    address public pair;
    ...
    function _DeployWaitingForGodot(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployWaitingForGodot(creator, initialSupply);
    }
}

contract WaitingForGodot is ERC20Token {
    constructor() ERC20Token("Waiting For Godot", "LUCKY", msg.sender, 287500000 * 10 ** 18) {
    }
}