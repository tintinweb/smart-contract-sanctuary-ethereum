...
contract sl00ts is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmejN2YmE2xN7u2F51tusHepH93XoYjmLSUQaYHSx3a6WE";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("sl00ts", "sl00ts", 100, MAX_SUPPLY) {
    }
