...
contract TDOTCToken is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "The Dream of the Crypto";
    string constant _symbol = "TDC";
    ...
    address payable public liquidityFeeReceiver = payable(0x6Eb211F31bBBDEe96996677b6A4c4b938583C236);
    address payable public marketingFeeReceiver = payable(0x6Eb211F31bBBDEe96996677b6A4c4b938583C236);
