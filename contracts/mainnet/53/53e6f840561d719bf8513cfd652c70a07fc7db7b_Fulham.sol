...
contract Fulham is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fulham";
    string private constant _symbol = "Fulham";
    ...
    uint256 private _maxTxAmount = 4_000_000 * 10**_decimals;
