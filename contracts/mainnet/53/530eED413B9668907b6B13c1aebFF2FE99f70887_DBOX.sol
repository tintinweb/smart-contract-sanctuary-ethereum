...
// The first fully decentralised,immutable file storage system built with IPFS and blockchain Web 3.0
...
contract DBOX is ERC20, Ownable {
    ...
    constructor() ERC20("Decentra Box", "DBOX") {
        ...
        marketingWallet = address(0x8f4e9Fe7Aa8636A97bB6e47343EaC8B7fD003D7b);
        developmentWallet = address(0x8EdbC4d0b286F0241A207461B4dBAD63DE1528c9);
