...
/**
Website: https://waruiinu.com
Telegram: https://t.me/waruiinu
*/
...
contract WARUI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address _marketingWallet) ERC20("Warui Inu", "WARUI") {
        ...
        uint256 totalSupply = 1 * 10**12 * 10**18;
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 10000)/1e18, "Cannot set maxTransactionAmount lower than 0.1%");
