...
https://t.me/GreenDragonERC
https://greendragonerc20.site
...
contract GreenDragon is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x58eDb60C8247676c040f85021DC58a789AB264Aa));

    string private _name = "Green Dragon";
    string private _symbol = "GDRAGON";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(25); //2.5%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(1000);
