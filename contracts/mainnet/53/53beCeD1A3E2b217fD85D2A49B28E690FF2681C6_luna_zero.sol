...
contract luna_zero is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Luna Zero";//
    string private constant _symbol = "LUNAZERO";//
    ...
    address payable private _marketingAddress = payable(  0x733A82d69B79cC5eD5C761E1a45f4Fa2eC12d865);
