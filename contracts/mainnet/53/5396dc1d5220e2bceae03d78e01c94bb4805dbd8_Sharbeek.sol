...
contract Sharbeek  is ERC721A, Ownable {
    ...
    string  public uriPrefix = "ipfs://QmcK1QArmBYUxRg9BLN217AbKQgCjsARPyRfGdnWCVyoSk/";

    uint256 public immutable mintPrice = 0.001 ether;
    uint32 public immutable maxSupply = 4600;
    uint32 public immutable maxPerTx = 60;
