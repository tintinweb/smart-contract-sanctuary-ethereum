...
contract jesterersbyvlad is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeibzk6sncae3f2v5pb7yhlerybse5jrh3jmv4txjoy4vgap2izjgiu/";
  uint256 public  maxSupply = 333;
  uint256 public  MAX_MINTS_PER_TX = 5;
  uint256 public  PUBLIC_SALE_PRICE = 0.0075 ether;
  uint256 public  NUM_FREE_MINTS = 0;
  uint256 public  MAX_FREE_PER_WALLET = 0;
  uint256 public freeAlreadyMinted = 0;
  bool public isPublicSaleActive = false;
  constructor() ERC721A("jesterers by vlad", "JESTS") {
  }
