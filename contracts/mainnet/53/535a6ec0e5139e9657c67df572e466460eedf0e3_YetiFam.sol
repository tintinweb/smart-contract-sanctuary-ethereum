...
contract YetiFam is ERC721A, Ownable {
  using Strings for uint256;
  uint256 public mintPrice = 0.008 ether;
  uint256 public supply = 1500;
  string private baseURI = "ipfs://QmUMWzwpCLZn7EYqRDRKAZ8LCbJWRNm7i7Z5cC1kSAv/";
  ...
  constructor() ERC721A("YetiFam", "YetiFam") {
  }
  ...
  function airdrop(address[] calldata _addresses, uint256 quantity) public onlyOwner {
  ...
  function withdrawAll() external onlyOwner{
        ...
        address[2] memory addresses = [
            0xb81737cE7508A23ED8a4956F97547F04C3002d15,
            0xb81737cE7508A23ED8a4956F97547F04C3002d15 
        ];
