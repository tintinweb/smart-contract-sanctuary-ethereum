...
contract Japanese is ERC721A, Ownable, ReentrancyGuard {
 using Address for address;
 using Strings for uint;
 
 string  public  baseTokenURI = "ipfs://QmdxNFTnP5XdecoqRYb25FJ1guVHqhCaf1TPHJubWAkuye/";
 ...
 constructor() ERC721A("The Japanese", "Japanese") {
