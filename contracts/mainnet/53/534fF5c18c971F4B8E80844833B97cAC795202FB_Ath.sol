...
/*
    ...
    - TG: https://t.me/wenathsers
    - Website: https://twitter.com/wenathsers
    - Twitter: https://wenathsers.com/
*/
...
contract Ath is ERC20, Ownable {
    ...
    constructor() ERC20("wenATHsers", "ATH") {
        ...
        uint256 totalSupply = 21 * 1e18;

        maxTransactionAmount = 21 * 1e16; // 1% max txn
        maxWallet = 21 * 1e16; // 1% max wallet
        ...
        mktgWallet = address(owner()); 
        devWallet = address(owner()); 
        liqWallet = address(owner()); 
        operationsWallet = address(owner());
