...
/**
I’m DogeApe, the most bullish meme intersection that ever
existed in crypto space. I’m here to bring all the believers
to the moon and start the new bull run.

We know Doge is the OG of the meme coins and that also BAYC is the OG of NFT communities, we are bringing the best of both together and creating the most insane community that crypto has ever seen.

Website: https://dogeape.lol/

Twitter: https://twitter.com/dogeapeeth

Telegram Portal : https://t.me/DogeApeETH
...
contract DOPE is ERC20, Ownable{
    ...
    uint256 public maxTxAmount = 15_000_000 * 10**18;
    uint256 public maxWalletAmount = 30_000_000 * 10**18;
    
    address public marketingWallet = 0x1321cFA083cae3C993AD8FdDbC87939BB68550BB;
    address public devWallet = 0x1321cFA083cae3C993AD8FdDbC87939BB68550BB;
    ...
    Taxes public taxes = Taxes(10,0,5);
    Taxes public sellTaxes = Taxes(20,0,15);
    uint256 public totTax = 15;
    uint256 public totSellTax = 35;
    ...
    constructor() ERC20(" Doge Ape", unicode" $DOPE ") {
