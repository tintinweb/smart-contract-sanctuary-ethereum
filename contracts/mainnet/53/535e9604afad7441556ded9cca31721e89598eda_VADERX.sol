...
John Briggs inu presents vader x
cryptonites a scumbag dev and This token was made in honour of cryptonite who rugged alot of based chads
so now i launch this in his memory as he never did i hope he burns in hell
A safe launch of vader x  join us in the tg for a safe eth launch
https://t.me/+VVmRRjYJSzRmYTc9
...
contract VADERX is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    uint256 public sellAmount = 8;
    uint256 public buyAmount = 8;
    ...
    constructor() BEP20("VADERX", "VDX") { // PROJECTNAME AND TICKER GO HERE
        ...
        maxWallet = _totalSupply / 25; // 4%
        swapTokensAtAmount = _totalSupply / 25; // 4%;
