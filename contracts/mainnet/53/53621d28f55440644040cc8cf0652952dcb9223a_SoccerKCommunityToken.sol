...
// File: contracts/SoccerKCommunityToken.sol

/**
 * @title SoccerK Community Token
 * @dev This contract is based on StandardToken, Ownable and Burnable token interface implementation.
 */
contract SoccerKCommunityToken is Ownable, BurnableToken, StandardToken {
    using SafeMath for uint256;

    // Constants
    string public constant symbol = "SKC";
    string public constant name = "SoccerK Community Token";
    ...
    /**
     * @dev Constructor for SoccerK Community Token, assigns the total supply to admin address 
