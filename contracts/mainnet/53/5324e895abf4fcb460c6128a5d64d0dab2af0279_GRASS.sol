...
contract GRASS is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1 * 10**7 * 10**18; // 1% of the supply (antiwhale)
    ...
    address payable devWallet = payable(address(0x4E213B7e19CBfD5c7fC974601250491406197dc2)); 
