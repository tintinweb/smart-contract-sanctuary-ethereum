...
contract DRAGON is Context, IERC20, Ownable {
    ...
    address payable private _opAddress = payable(0x3a01b12B055D4B59575f9A9102176580ebaA8972);
    ...
    uint256 public _maxTxAmount = 800000000 * 10**9; //1
    uint256 public _maxWalletSize = 1500000000 * 10**9; //1
