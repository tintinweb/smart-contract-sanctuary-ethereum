...
I will add 3 ETH to liquidity pool then lock it for 1 month, and extend it if this get enough traction
Ownership will also be renounced after i lift the tx limit
Tokenomic is the same as Classic Luna Inu but i reduced the tax from 6/15 to 6/10 
I will add 99% supply to the liquidity pool and keep 1% of supply for my wallet
I'm not gonna make a telegram, but if you apes want to make one, i suggest to name it @Monkeypoxinuerc20

I will launch exactly 10 minutes after this contract deployed
*/
