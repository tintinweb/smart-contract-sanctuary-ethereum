...
contract NARUGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Naruto Doge";
    string private constant _symbol = "NARUGE";
    ...
    address payable private _opAddress = payable(0x681d0d131AcB8C58409215956E7577A6E6467816);
