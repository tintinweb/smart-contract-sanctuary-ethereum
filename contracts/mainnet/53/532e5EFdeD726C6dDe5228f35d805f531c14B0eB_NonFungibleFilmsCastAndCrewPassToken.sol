...
contract NonFungibleFilmsCastAndCrewPassToken is ERC721A, INonFungibleFilmsCastAndCrewPassToken, Ownable, ReentrancyGuard {
    ...
    // ======== Constructor =========
    constructor(string memory baseURI) ERC721A ("NonFungibleFilmsCastAndCrewPassToken", "NFFCC") {
        setBaseURI(baseURI);
    }
