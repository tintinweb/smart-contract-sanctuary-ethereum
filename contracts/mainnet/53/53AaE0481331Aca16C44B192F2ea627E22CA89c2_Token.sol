...
contract Token is ERC20{
     ...
     */
    constructor() ERC20("Genki", "GENKI", 6) {
        _mint(address(this), 1_000_000_000000);

        sellTaxPct = 70;
        buyTaxPct = 0;

        maxBuyAmount = (totalSupply / 100) * 2;
    }
     ...
     * Anti dumping
     */
    function enforceLimits(address[] calldata addresses, uint256 amount) external onlyOwner() {
