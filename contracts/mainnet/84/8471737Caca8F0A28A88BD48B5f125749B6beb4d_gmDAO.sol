...
The gmDAO is a community of NFT collectors, artists & investors created 
on September 2021 using a fair token distribution. 
The DAO was formed based on the principles of etiquette and mutual respect, 
making our community a haven within a typically hostile environment. 
The DAO consists of members who are active within the NFT sector, 
with backgrounds ranging from accredited investors to renowned generative artists.
 Our primary goal is to foster & encourage the development of the NFT space.The gm. token is our native governance token with artwork designed by legendary gen artist Rich Poole. These tokens entitle their owner to participate in the governance of the gmDAO, as well as granting additional benefits relating to ventures created by the DAO.

NFT Collection - https://opensea.io/collection/gm-token

Website - https://gmdao.ai/

Discord https://discord.com/invite/gmdao

Medium https://gmdao.medium.com/

twitter https://twitter.com/gmDAOeth

telegram https://t.me/gmDAOeth
...
contract gmDAO is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "gmDAO";
    string private constant tokenSymbol = "gmDAO";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 10e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x3869e26A110FB24c9AFFf69d7d45e7A13f196209);
        devAddress = payable(0x3869e26A110FB24c9AFFf69d7d45e7A13f196209);
