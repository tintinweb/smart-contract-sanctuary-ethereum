...
contract COOLOOKS is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 888;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.088 * 10 ** 18;
    bytes32 public whitelistMerkleRoot =
        0x55b0851e01d00b0f631e74f760828de41ba90c07505faee442c89ea3cf6ef78f;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmNU7DuogsbrnsDQzCQ7ExCk5D71VJ5b2SF1RY4MtfmSEt";

    constructor() public ERC721A("COOLOOKS", "COOLOOKS", 888, 888) {}
