...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF619bBcaC06D03B501E8E829063f37f2e805D588];
  address public erc20Payable = 0xF619bBcaC06D03B501E8E829063f37f2e805D588;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 400) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/X1lja649kLveX7mVm7xZ/contract-metadata";
  }
...
// File: contracts/PunksbyHanukaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PunksbyHanukaContract is RamppERC721A {
    constructor() RamppERC721A("Punks by Hanuka", "Punks"){}
}
