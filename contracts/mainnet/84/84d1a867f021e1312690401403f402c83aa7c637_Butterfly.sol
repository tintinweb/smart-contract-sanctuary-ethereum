...
contract Butterfly is Context, IERC20, Ownable {
 
    using SafeMath for uint256;

    string private constant _name = "Butterfly Wings";
    string private constant _symbol = "\xF0\x9F\xA6\x8B";
    ...
    address payable private _developmentAddress = payable(0xe425f92C465a1Bd05Ed3e555A9a22e3B3b3B2cc5); 
    address payable private _marketingAddress = payable(0xe425f92C465a1Bd05Ed3e555A9a22e3B3b3B2cc5);
