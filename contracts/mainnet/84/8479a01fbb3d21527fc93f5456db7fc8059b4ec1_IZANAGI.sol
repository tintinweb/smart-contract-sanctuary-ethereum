...
// https://medium.com/@Izanagi.eth/he-who-invites-e1eaa3027db4
// https://twitter.com/Izanagi_ERC
...
contract IZANAGI is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Izanagi-no-Mikoto";
    string private constant tokenSymbol = "IZANAGI";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x4B5c77C5cd0b4ccD8fA35d23C4f0179ad78aC1Cd);
        devAddress = payable(0x4B5c77C5cd0b4ccD8fA35d23C4f0179ad78aC1Cd);
