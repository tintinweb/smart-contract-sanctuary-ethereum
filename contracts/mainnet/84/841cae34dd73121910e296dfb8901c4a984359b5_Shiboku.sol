...
//Shiboku has been born from the gods to destory the jeet lands, taking his spot as most powerful Shiba in the universe. 
//In the present coward devs have been letting there communities down, looking out for there own backs and forgetting about who got them too where they are today. 
//This is where Shiboku causes a shift in the crypto space by only becoming stronger and stronger as he evolves infinitly. 
//As weeks turn into months and months turn into years... Shiboku will keep training, growing his following in the progress.
...
contract Shiboku is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x3619B4AB7fdE6d612caA514E4b4B886049Cf8054);
    ...
    constructor() ERC20("Shiboku", "SOKU") {
