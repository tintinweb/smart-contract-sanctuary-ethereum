...
contract StoryofTamar is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Story of Tamar';
    ...
    address internal constant development_receiver = 0x01758d2317Bf3bD1a173d6163Dc1eEFcd8ACDdF0; 
    address internal constant marketing_receiver = 0x01758d2317Bf3bD1a173d6163Dc1eEFcd8ACDdF0;
    address internal constant liquidity_receiver = 0x01758d2317Bf3bD1a173d6163Dc1eEFcd8ACDdF0;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(100) && sellFee <= denominator.div(100), "totalFee and sellFee cannot be more than 10%");
    }
