...
Our lord and savior ELON MUSK has graced us with wisdom:

DEATH TO ALL TWITTER BOTS #SOON

https://twitter.com/cyalaterbots
https://t.me/DeadTwitterBOTS
...
contract TwitterBOTS is Context, IERC20, Ownable {
    ...
    uint256 private _reduceTaxAt=11;
    uint256 private _preventSwapBefore=9;
    uint256 private _buyCount=0;

    uint8 private constant _decimals = 8;
    uint256 private constant _tTotal = 1000000 * 10**_decimals;
    string private constant _name = unicode"Death To Twitter BOTS";
    string private constant _symbol = unicode"$DTB";
