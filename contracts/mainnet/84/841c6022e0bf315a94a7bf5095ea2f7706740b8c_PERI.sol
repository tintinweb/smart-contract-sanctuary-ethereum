...
contract PERI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Peripheral Protocol";
    string private constant _symbol = "PERI";
    ...
    address payable private _developmentAddress = payable(0x206718440D80fba3FC77e036838FB12B20943296);
    address payable private _marketingAddress = payable(0x206718440D80fba3FC77e036838FB12B20943296);
