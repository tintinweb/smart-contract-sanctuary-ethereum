...
contract LuxveyXMajobros is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public baseURI = "ipfs://bafybeihcdgo2z4w7fpfn2igfhssojnvkpduftc5ipm3zompmcr55iu6ulq/";
    string public baseExtension = ".json";
    uint256 public costWL = 0.02 ether;
    uint256 public cost = 2.1 ether;
    uint256 public maxSupply = 121;
    uint256 public publicSupply = 111;
    ...
    constructor() ERC721A("Luxvey X Majobros - Personality Bugs", "LXM.PB") {}
    ...
    function mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable {
        ...
        if (msg.sender != owner()) {
	        ...
	        require(supply + _mintAmount <= maxSupply, "max Wl NFT limit exceeded");
	        ...
	        require(supply + _mintAmount <= publicSupply, "max Public NFT limit exceeded");
    ...
    function setWlSupply(uint256 wlSupply_) external onlyOwner {
        wlSupply = wlSupply_;
    }
