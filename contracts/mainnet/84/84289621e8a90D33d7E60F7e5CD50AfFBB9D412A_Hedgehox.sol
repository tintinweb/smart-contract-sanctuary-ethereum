...
contract Hedgehox is ERC721, Ownable, ERC721Enumerable {
  ...
  uint256 public constant tokenPrice = 60000000000000000; // 0.06 ETH

  uint256 public constant preTokenPrice = 40000000000000000; // 0.04 ETH
  ...
  uint256 public devReserve = 500;



  event HedgehoxMinted(uint256 tokenId, address owner);



  constructor() ERC721("Hedgehox", "HOX") {}
  ...
  function mintHedgehox(uint256 numberOfTokens) external payable {
    ...
    for (uint256 i = 0; i < numberOfTokens; i++) {
      ...
      if (totalSupply() < MAX_TOKENS) {
        ...
        emit HedgehoxMinted(id, msg.sender);
  ...
  function presaleHedgehox(uint256 numberOfTokens) external payable {
    ...
    require(
      ...
      msg.value >= preTokenPrice.mul(numberOfTokens),
...

  {
    ...
    if (isRevealed == false) {
      ...
      return
        ...
        "ipfs://QmX2wxAJCKyACp8jGkvaUoEH1way1SQPEJeKtcfEpNQwQQ/1.json";
