...
contract Elysium is ERC721, Ownable, DefaultOperatorFilterer {
  using Strings for uint256;
  ...
  constructor() ERC721("Elysium", "ELYSIUM") {
    setHiddenMetadataUri("ipfs://Qmddh6swhzfdo8a1TcaowNQDUvbY58A9i4qQJasT6HD4eH/hidden.json");
  }
