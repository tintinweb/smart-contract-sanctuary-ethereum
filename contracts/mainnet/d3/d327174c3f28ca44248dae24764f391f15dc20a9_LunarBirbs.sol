...
contract LunarBirbs is Ownable, ERC721A {

    using Strings for uint256;

    uint256 public paid_price = 0.05 ether;
    uint256 public maxNFTPerWallet = 3;
    uint256 public maxFreeNFTPerWallet = 1;
    uint256 public MAX_SUPPLY = 1111;
    uint256 public FREE_SUPPLY = 111;

    bool public revealed = false;
    string public baseUri = "https://gateway.pinata.cloud/ipfs/QmXBy8RM81z9raGdHVEEYFm2dXBFjZHmf4Q3BbaLyHUUpp/";
    ...
    constructor() ERC721A("LunarBirbs", "BIRBS") {}
...
function freeMint(uint _quantity) external {
        ...
        require(_quantity + amountNFTsperWalletFreeMint[msg.sender] <= maxFreeNFTPerWallet, "You can only get one NFT on the Sale");
