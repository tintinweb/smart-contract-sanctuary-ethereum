...
contract TRUMP is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xE0B20989564539293C32780cf522932554B58586);
    address payable private _marketingAddress = payable(0xE0B20989564539293C32780cf522932554B58586);
