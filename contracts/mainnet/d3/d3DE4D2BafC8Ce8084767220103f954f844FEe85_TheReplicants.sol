...
// Free yourself from the shackles of the invisible prison. 
// Nobody can do that for you but you. And in order for it to happen you have to die to all that you thought was what you wanted and needed. 
// You have to die before dying.

// Replicantas TG:
// https://t.me/TheReplicantsPortal

// Medium:
// https://medium.com/@thereplicantss/tr-963f2ed71bdb

// Twitter :
// https://twitter.com/thereplicanterc
...
contract TheReplicants is ERC20, Ownable {
    ...
    constructor() ERC20("The Replicants", "$TR") payable {
        //taxes set
