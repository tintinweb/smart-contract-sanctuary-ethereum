...
contract ShootABE is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShootABE";
    string private constant _symbol = "SHOOTABE";
    ...
    constructor () {
        _feeAddrWallet = payable(0x73EB21399E1bd9c61B7b92AC3Ee76CC90a0DE32A);
