...
// File: contracts/IWabipunks.sol

pragma solidity ^0.8.7;
interface IWabipunks {
...
contract WabiStore is Pausable, Ownable {
  using Strings for uint256;
  using SignatureChecker for address;
  address payable private wabiWallet;
  mapping(uint256 => bool) public _nonceSpended;
  address private signer;
  IWabipunks public wabiPunks;
  constructor(
    ...
    signer = signer_;
    wabiPunks = IWabipunks(wabiPunks_);
  }
