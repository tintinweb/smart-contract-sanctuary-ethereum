...
contract blonktrains is ERC721Delegated, ReentrancyGuard {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 1999;
  ...
  uint256 public constant MAX_MULTIMINT = 1999;

  uint256 public constant PRICE = 69000000000000010;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 1999 at a time");

    require(
      msg.value >= PRICE * count, "Insufficient payment, 0.069 ETH per item"
    );
