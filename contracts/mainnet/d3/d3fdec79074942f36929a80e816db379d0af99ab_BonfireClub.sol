...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    address public wallet1_2;
    address public wallet2_8;
    address public wallet3_10;
    address public wallet4_10;
    address public wallet5_70;
    ...
    function claim(uint number) public payable {
        ...
        require(whitelist_mod == false, "WL is on;");
     ...
     * @dev Claim a token to an address with a tokenURI.
     */
    function claimWL(uint number) public payable {
        require(claim_mod == true, "Claim is off;");
        require(whitelist_mod == true, "WL is off;");
        require(isWhitelisted(_msgSender()) == true, "User is not in WL;");
        require(0 < number && number < 4 , "Only 3 mints in one WL claim;");
        require(number * price == msg.value, "Not enough ETH;");
        require(whitelist[_msgSender()] + number <= 4, "User already minted 3 NFTs in WL mode;");
    ...
    function rescueTokensFromContract() external onlyOwner {
        uint256 balance_2 = 2*(address(this).balance / 100);
        uint256 balance_8 = 8*(address(this).balance / 100);
        uint256 balance_10 = 10*(address(this).balance / 100);
        uint256 balance_70 = address(this).balance - balance_2 - balance_8 - 2*balance_10;
        payable(wallet1_2).transfer(balance_2);  
        payable(wallet2_8).transfer(balance_8);  
        payable(wallet3_10).transfer(balance_10);   
        payable(wallet4_10).transfer(balance_10);
        payable(wallet5_70).transfer(balance_70);
...
contract BonfireClub is ERC721Tradable {
    ...
    constructor() ERC721Tradable("Bonfire Club", "BFC") { 
        ...
        wallet1_2 = 0xD1F7d9375FCA816D6ABcf878D14ddcDBDB93026D;
        wallet2_8 = 0xD44D49616a41E430db0008658fa3Da3199e1431d;
        wallet3_10 = 0x9840aECDcE9A75711942922357EB70eC44DF015F;
        wallet4_10 = 0x2442681bc71E307183100A96232EDA66F05c01A3;
        wallet5_70 = 0xE7a368BA3226C8709e40DC41AcFee79D2e850dAa;
    }
