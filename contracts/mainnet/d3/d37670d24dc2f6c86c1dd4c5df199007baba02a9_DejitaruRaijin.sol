...
https://t.me/DejitaruRaijin

https://twitter.com/DejitaruRaijin
...
contract DejitaruRaijin  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"Dejitaru Raijin", unicode"THUNDER") {
        ...
        maxTransactionAmount = totalSupply * 20 / 1000; // 1.0% maxTransactionAmountTxn
        maxWallet = totalSupply * 20 / 1000; // 1.0% maxWallet
        swapTokensAtAmount = totalSupply * 20 / 10000; // 1.0% swap wallet
