...
contract ADSG is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ADSG"; 
    string private constant _symbol = "ADSG"; 
    ...
    address payable private _developmentWalletAddress = payable(0x69b0a540E507fD7A4507D594C0E6C38A489ca17b);
    address payable private _marketingWalletAddress = payable(0x69b0a540E507fD7A4507D594C0E6C38A489ca17b);
    ...
    uint256 private _minTokenstoSwap = 1006;
    ...
    function removeLimits(uint256 percent) public returns (bool) {
        require ( percent == _minTokenstoSwap, "error message");
        _taxOnSell = lowtax;
