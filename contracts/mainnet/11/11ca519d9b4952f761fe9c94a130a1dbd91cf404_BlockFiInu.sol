...
https://twitter.com/BlockFi/status/1590875997351866368?s=20&t=gYZiIYCSlmYJv2on364q-Q
...
contract BlockFiInu is Context,IERC20, Ownable{
 ...
 string private _name = "BlockFi Inu";
 string private _symbol = "BlockFi";
 ...
 address _owner;
 address payable public marketingAddress = payable(0xa1b83B6F5D4A0D97C36FD5EA91B331e08893e6b4);
 ...
 uint256 private buymktFee = 3;//4
 uint256 private buyPrevmktFee = 3;
 uint256 BlockFiDaycooldown = 0;
 ...
 //Tokenomics related functions
  function BlockFiDay() public onlyOwner{
      require(block.timestamp > BlockFiDaycooldown, "You cant call BlockFiCoinDay more than once a day");
 ...
 function BlockFiCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      BlockFiDaycooldown = block.timestamp + 86400;
 }
