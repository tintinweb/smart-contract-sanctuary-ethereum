...
/**
The Kyoshin are legendary Samurai who have a deep connection to the spiritual realms. 
...
contract KyoshinInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kyoshin Inu";
    string private constant _symbol = "KYOSHIN";
    ...
    constructor () {
        _feeAddrWallet = payable(0xBD06Fa50473a465C24bd64406C9CD8Fa21A92cd8);
