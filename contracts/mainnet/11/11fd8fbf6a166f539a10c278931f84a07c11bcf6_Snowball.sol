...
contract Snowball is ERC20, Ownable {
    ...
    constructor() ERC20("Snuffles", "Snowball") {
        ...
        marketingWallet = address(0x4724a7d905f40C771995Fd5557F1C05a2C282B2c); // set as marketing wallet
        devWallet = address(0x5626e8514183809068b9c684aF6AeDe26d97BC6A); // set as dev wallet
