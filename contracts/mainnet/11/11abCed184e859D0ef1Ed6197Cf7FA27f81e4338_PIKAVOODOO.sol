...
contract PIKAVOODOO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PIKA VOODOO";
    string private _symbol = "PVOODOO";
    uint8 private _decimals = 18;

    address payable public marketingwallet = payable(0x8722d3701604387aE148472196eE071c0f857460);
    ...
    uint256 private _totalSupply = 10000000 * 10**_decimals;    // supply 10,000,000     
