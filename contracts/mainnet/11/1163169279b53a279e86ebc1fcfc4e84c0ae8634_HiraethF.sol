...
/*
Yearning. Reminiscence. Longing. Hiraeth (“here - eyeth”) encapsulates all of these words but is none of these.

https://link.medium.com/STllZyAu9sb
...
contract HiraethF is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("Hiraeth", "HIRA") { // 
        marketingWallet = payable(0x0E654fBbc6144060De91f464C4e056f27C629686); // 
        devWallet = payable(0x6e152bFdA68244e4F15F776443579C4b860C0Ceb); // 
