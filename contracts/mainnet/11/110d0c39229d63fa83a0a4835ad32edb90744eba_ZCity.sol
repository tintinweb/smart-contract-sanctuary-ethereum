...
contract ZCity is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Z-City';
    string private constant _symbol = 'Zeddo Shi';
    ...
    address internal constant development_receiver = 0x4eA074b0812fAcbe7c79567807B48241e4d3d0ee; 
    address internal constant marketing_receiver = 0x4eA074b0812fAcbe7c79567807B48241e4d3d0ee;
    address internal constant liquidity_receiver = 0x4eA074b0812fAcbe7c79567807B48241e4d3d0ee;
    ...
    function setVariables(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
