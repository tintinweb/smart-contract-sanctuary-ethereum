...
contract unBEARableBears is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcSXD6WkZJqNJqCsy1e3XP3wF8FRjRVe9NTnvHZb7ehuc";
    ...
    constructor(
    ) ERC721A("unBEARable Bears", "unBEARable", 100, maxSupply) {
    }
