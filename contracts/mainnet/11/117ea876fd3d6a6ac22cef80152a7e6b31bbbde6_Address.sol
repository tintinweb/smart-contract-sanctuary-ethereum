...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE68bD755C87749F6144f6762283698742E0daA0c;
...
contract pilipili is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1B9E77ac8866ceeE5Faf040C72CA9042B9148A8B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Pili Pili";
    string private _symbol = "PILI";
