...
SHIBARIUM
PUNKS
The new Punk Collection.
But a bit more different. A collection of 10k Shiba Punks on Shibarium.

https://twitter.com/Shibarium_Punks

https://shibariumpunks.com/
...
contract ShibariumPunks is IERC20, Ownable {       
    string private constant _name = "Shibarium Punks";
    string private constant _symbol = "sPUNKS";
    ...
    address payable private constant devWallet = payable(0x020dCd44cC8007921071C88a6364829CFC3F1A9E);
