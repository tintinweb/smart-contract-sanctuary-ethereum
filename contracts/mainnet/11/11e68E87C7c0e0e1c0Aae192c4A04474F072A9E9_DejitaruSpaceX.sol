...
/**
Dejitaru Space X $DSX

🐉Dejitaru Space X will dominate the next generation's multiplanetary exchange systems. Leading currency for interplanetary.

📱t.me/DejitaruSpaceX
📱https://medium.com/@DejitaurSpaceX/dejitaur-space-x-222bd0a7af2e
**/
  ...
  contract DejitaruSpaceX is Context, IERC20, Ownable {
      ...
      string private constant _name = "Dejitaru Space X";
      string private constant _symbol = "DSX";
