...
contract Radcoin is ERC20, ReentrancyGuard {
    ...
    /// @notice Claim RAD for a set of Radbros.
    ...
    /// @notice Claim virtual radcoin without needing to mint. Can only be called by Radbros.
    /// @param id The id of the radbro to burn claim from.
