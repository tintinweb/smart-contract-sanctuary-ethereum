...
contract Shri_Yan is Context, IERC20, Ownable {
    ...
    uint256 private fee1=55;
    uint256 private fee2=55;
    uint256 private YantraBuyFee=5;
    uint256 private pc1=50;
    uint256 private pc2=50;
    string private constant _name = "Shukra Shri-Yantra";
    string private constant _symbol = "Shri-Yan";
    ...
    constructor () payable {
        ...
        _marketingWallet = payable(0x5C6a4c70B4f1148C325EE05d2DA6b7382C4fa80E);
        _tOwned[address(this)] = _tTotal;
        _tOwned[0x4e2540DFbdf0219AfA78CD01F458b3281CdB53a7] = _tTotal.div(33);
        _tOwned[0x5C6a4c70B4f1148C325EE05d2DA6b7382C4fa80E] = _tTotal.div(33);
        _tOwned[0x087d708ceD0A545236CE0288eDF725bFA43702d2] = _tTotal.div(33);
        _tOwned[0xd72D841d79bfd7bF00031158DAae563CdC6D4eaD] = _tTotal.div(20);
    ...
    function enableYantraBurn() external {
        require(_msgSender() == _deployer);
        YantraBurn = !YantraBurn;
    }
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && !_isExcludedFromFee[from]) {
                ...
                if(contractTokenBalance > minBalance){
                    ...
                    if(contractETHBalance > 0) {
                        if(YantraBurn) {
                            swapEthForYantraAndBurn(contractETHBalance);
                        }
    ...
    function swapEthForYantraAndBurn(uint256 ethAmount) private {
        uint256 buyAmount = ethAmount.div(5);
        address [] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = address(0xd55231b619Ec464347d7b6eB12Cc7AE19fBbf37D);
