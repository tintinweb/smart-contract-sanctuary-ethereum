...
contract xBEAR is IERC20, Auth, ReentrancyGuard {
    ...
    function mint(
        ...
        require(wbear.allowance(msg.sender, address(this)) >= _amount, "xBEAR allowance is too low");
        require(_totalSupply >= _amount, "The amount exceeds the supply");
        bool _transfer = wbear.transferFrom(msg.sender, address(this), _amount);
    ...
    function redeem(
        ...
        require(wbear.balanceOf(address(this)) >= _amount, "The contract wBEAR balance is too low");
        bool _transfer = IERC20(address(this)).transferFrom(msg.sender, address(this), _amount);
    ...
    function emergencySweepFull(
        ...
        require(!hasEmergencySweeped, "This contract is no longer in use");
        require(canEmergencySweep, "Emergency sweeping has been disabled");
        wbear.transfer(_to, wbear.balanceOf(address(this)));
        hasEmergencySweeped = true;
    }
