...
contract Wormzzz is  Ownable, ERC721A, ReentrancyGuard {
    ...
    function hatch(uint256 tokenId_) public {
        ...
        wormLevel[tokenId_] = ((block.timestamp - startTime) / 86400) + 1 ;
    ...
    function consume(uint256 consumerId_, uint256 targetId_) public {
        ...
        burnCounter++;
        payable(msg.sender).transfer(address(this).balance /(maxSupply-burnCounter));
    }
