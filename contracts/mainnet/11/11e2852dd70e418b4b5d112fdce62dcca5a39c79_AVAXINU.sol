...
/*
    - https://t.me/Avax_Inu
    - https://avaxinu.xyz/
    - https://medium.com/@AvaxInu
    - https://twitter.com/Avax_Inu
*/
...
contract AVAXINU is Ownable, ERC20 {
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xB57681228Bde10fdEA5AF95483d14738178EDA79;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        function updateMaxWallet(uint256 maxWallPercent) external onlyOwner {
    ...
    function setStructure(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setoverLiquified(uint256 _target, uint256 _denominator) external onlyOwner {
