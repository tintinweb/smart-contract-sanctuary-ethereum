...
https://kungfupanda.fandom.com/wiki/Mrs._Chow
...
contract MsChowChow is Context , IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Ms Chow Chow";
    string private constant _symbol = "MSChow";
