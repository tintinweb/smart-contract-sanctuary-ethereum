...
Website: https://widgets-ai.com/
Telegram: https://t.me/WidgetsAIPortal
...
contract Widgets is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Widgets AI", "WIDGETS") {
        ...
        marketingWallet = address(0x2c144C00d64E671568030a5DC9dbF93B8a6D256D);
    ...
    function updateMaxWalletAndTxnAmount(uint256 newTxnNum, uint256 newMaxWalletNum) external onlyOwner {
        require(
            newTxnNum >= ((totalSupply() * 1) / 100000) / 1e18,
            "Cannot set maxTxn lower than 0.1%"
        );
        require(
            newMaxWalletNum >= ((totalSupply() * 1) / 100000) / 1e18,
