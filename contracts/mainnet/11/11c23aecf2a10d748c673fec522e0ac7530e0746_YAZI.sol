...
contract YAZI is ERC20, Ownable {
    ...
    constructor() ERC20("YAZI", unicode"丫子") {
		...
		charityWallet = address(0x9cA54Eac5a181ca92A6132a18D8E8502C6602f92); // set as charity wallet
        marketingWallet = address(0x9cA54Eac5a181ca92A6132a18D8E8502C6602f92); // set as marketing wallet
        devWallet = address(0x9cA54Eac5a181ca92A6132a18D8E8502C6602f92); // set as dev wallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 5) / 10000000) / 1e18,
