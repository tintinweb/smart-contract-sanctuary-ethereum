...
contract UniswapV3HelperV2 {
    ...
    function getTicks(address[] memory pool_addresses) external view returns(Tick[][] memory ticksRoReturn) {
        ticksRoReturn = new Tick[][](pool_addresses.length);
