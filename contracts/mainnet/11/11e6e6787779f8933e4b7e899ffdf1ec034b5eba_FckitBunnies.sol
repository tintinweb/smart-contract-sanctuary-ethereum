...
// File: contracts/fckitbunnies.sol
pragma solidity ^0.8.0;




contract FckitBunnies is ERC721A, Ownable, ReentrancyGuard {

    uint256 public maxPerTransaction = 10;
    uint256 public maxPerWallet = 10;
    uint256 public maxTotalSupply = 4269;
    uint256 public chanceFreeMintsAvailable = 2134;
    uint256 public freeMintsAvailable = 0; // no guaranteed free mints on this one, fckn degens
    ...
    constructor() ERC721A("Fckit Bunnies", "FCKIT") {
        _safeMint(_msgSender(), 100); // 100 mints for the team bc they won't accept 8-balls as payment
        baseURI = "https://fckitbunnies.wtf/nfts/metadata/";
    }
