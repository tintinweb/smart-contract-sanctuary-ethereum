...
contract MONONOKE is Context, IERC20 { 
    ...
    address payable public Mkt_Wallet = payable(0x6698a06BC32F458962C0aaaAC3Dd367E0C40BD74); 
    address payable public Dev_Wallet = payable(0x28Ccf1a7C75b3208a76aB39f0419a433A3205Ccb);
    ...
    string private constant _name = unicode"Mononoke"; 
    ...
    uint256 public _maxTxAmount = _dTotal * 8 / 100; 
    ...
    constructor () {
        ...
        _owner = 0x28Ccf1a7C75b3208a76aB39f0419a433A3205Ccb;
