...
contract FUKYEH is IBEP20, Ownable {
    ...
    string constant _name = "Murica";
    string constant _symbol = "FUKYEH";
    ...
    address private prizeFeeReceiver = 0x77F6dD389DA33bF03fb0c5C53f29429f26e7249E;
    address private devFeeReceiver = 0x2BF573528B70c66B161aa502825E4ed0D5689171;
    address private teamFeeReceiver = 0x1161E23d75E40e3B5Ab79eDfd32F2a973C42fc62;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees( uint256 _teamFee, uint256 _prizeFee, uint256 _devFee , uint256 _feeDenominator) external onlyOwner() {
        teamFee = _teamFee;
        prizeFee = _prizeFee;
        devFee = _devFee ;
        totalFee = _devFee.add(_teamFee).add(_prizeFee);
        feeDenominator = _feeDenominator;
    }

    function setFeeReceiver(address _prizeFeeReceiver, address _teamFeeReceiver) external onlyOwner() {
