...
contract EthX is Ownable, IERC20 {
    ...
    constructor(){
        address _marketingWallet = address(0x9060a9a0a350E7D31007858A10428A7b8c3c1DD1);
        address _liquidityWallet = address(0x9060a9a0a350E7D31007858A10428A7b8c3c1DD1);
        ...
        excludeFromFee(address(dividendTracker), true);
    ...
    function setallFee(
        ...
        treasuryFeeBPS = _treasury;
        liquidityFeeBPS = _liquidity;
        dividendFeeBPS = _dividend;
        totalFeeBPS = _treasury + _liquidity + _dividend;
    }
    ...
    function setMaxTxamount(uint256 bps) external onlyOwner {
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "Eth_DividendTracker";
    string private _symbol = "Eth_DividendTracker";
