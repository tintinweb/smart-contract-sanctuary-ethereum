...
contract Enigmus is ERC20, Ownable {
    ...
    constructor() ERC20("Enigmus", "EGMS") {
        ...
        marketingWallet = address(0xB89a7E4a6bB2Aa4eDB70427d8f51501123ebAc27); // set as marketing wallet
        devWallet = address(0xB89a7E4a6bB2Aa4eDB70427d8f51501123ebAc27); // set as dev wallet
