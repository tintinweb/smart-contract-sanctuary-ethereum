...
contract CroatiaFanToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Croatia Fan Token";
    string private constant _symbol = unicode"CRO";
