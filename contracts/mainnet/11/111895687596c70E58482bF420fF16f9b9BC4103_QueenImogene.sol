...
/*
 * Queen Imogene ($BUZZ)
 * Twitter: https://twitter.com/QueenImogeneERC
 * Telegram: https://t.me/imogeneERC
 * Website: https://queenimogene.com/
*/
...
contract QueenImogene is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Queen Imogene", "BUZZ") {
        ...
        uint256 totalSupply = 1_000_000_001 * 1e18;
 
        maxTransactionAmount = totalSupply * 4 / 100; // 4% maxTransactionAmountTxn
        maxWallet = totalSupply * 4 / 100; // No Max Wallet On Launch
        ...
        devWallet = address(0x99fdc68B59A2572A5d4658F6d03F26709c3CA614); // set as dev wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 150, "Must keep fees at 10% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellDevFee, uint256 _earlySellMarketingFee) external onlyOwner {
        ...
        earlySellMarketingFee = _earlySellMarketingFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 250, "Must keep fees at 15% or less");
    }
