...
/**
The Ame no Habakiri (天羽々斬あめのはばきり Ame no Habakiri?, 
literally meaning "Feathery Cutter of Heaven") is one of the most famous 
Totsuka no Tsurugi, appearing in Japanese mythology as a blade used by the 
Shinto god Susanoo to slay the legendary monster serpent Yamata no Orochi.
"Haba" (羽々?) while using the kanji for "feather/wing", is also an archaic
term for "big snake/great serpent" (Orochi).
*/
...
contract Habakiri is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Ame No Habakiri";
    string private constant _symbol   = "Habakiri";
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x76955CABdABDC2fBEa7f021C4BBa6dbCfb8AdF1D;
        _marketingWallet = 0x76955CABdABDC2fBEa7f021C4BBa6dbCfb8AdF1D;
