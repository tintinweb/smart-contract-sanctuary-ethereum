...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xF17b39994313522C11D523e4fE674B4352D2A641];
  address public erc20Payable = 0xF17b39994313522C11D523e4fE674B4352D2A641;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 412) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigza5vs52s25ekqtgpui6dbsa7j5ldpmonhaapt36nst32zqnfire/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/wjSXzb1QohiNG2Tbcb3u/contract-metadata";
  }
...
// File: contracts/OraorContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OraorContract is RamppERC721A {
    constructor() RamppERC721A("oraor", "ORA"){}
}
