...
Together as one, Fire and Ice shifts between phases. During the Fire phase, tokens are burned automatically with every transaction. During the Ice Phase, holders receive USDC rewards distributed automatically every 6 hours!

Simply by holding you benefit from the token supply decreasing, and receiving USDC rewards!  The longer you hold - the more you benefit!

Tokenomics:

Initial Supply: 1,000,000
Max TXN: 2% current supply.
Max Wallet: 3% current supply.
...
https://fireandicedragons.net/
https://t.me/FireAndIcePortal
https://twitter.com/FireAndIceTeam
...
contract FireAndIce is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'The Dragon of Fire And Ice';
    ...
    uint256 public minPeriod = 360 minutes;
    ...
    address internal constant development_receiver = 0xA54B8E9Ffb67DD6d233763D22b3E8b6900D8b0F3; 
    address internal constant marketing_receiver = 0xA54B8E9Ffb67DD6d233763D22b3E8b6900D8b0F3;
    address internal constant liquidity_receiver = 0xA54B8E9Ffb67DD6d233763D22b3E8b6900D8b0F3;
    ...
    function swapbackCounters(address sender, address recipient) internal {
        if(recipient == pair && !isFeeExempt[sender]){swapTimes += uint256(0);}
    }
