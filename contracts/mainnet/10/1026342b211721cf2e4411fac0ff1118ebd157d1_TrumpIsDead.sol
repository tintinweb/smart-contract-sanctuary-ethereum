...
contract TrumpIsDead is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Trump Is Dead";
    string private _symbol = "TrumpIsDead";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x89Ec370824e4Fd9611C371FFc8b30ee2D046CD70);
    address payable private taxWallet2 = payable(0x89Ec370824e4Fd9611C371FFc8b30ee2D046CD70);
