...
$CHONKS is the world's first Clan-2-Earn token, where you earn ETH by 
representing CHONKS clan and playing your favorite games against
other clanmates
...
contract Chonks is Context, IERC20, Ownable {
    ...
    address private _owner = 0xA92a33f49935F2558cb248A06ceB04981eA0B1a6;
    ...
    string private constant _name = "Chonks";
    string private constant _symbol = "CHONKS";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xA92a33f49935F2558cb248A06ceB04981eA0B1a6); // Marketing Address
        
        devAddress = payable(0x16DbD410BD71C9C4829C1D168a7853940bB4F4f7); // Dev Address
