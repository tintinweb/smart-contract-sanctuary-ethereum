...
contract Bullish is Context, IERC20, Ownable {
    ...
    string private _name = "Bullish";
    string private _symbol = "$BABYWHY ";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5258bD439Ecce69aA86e4784f533bA577af9F26c));
        marketingWalletAddress = payable(address(0x5258bD439Ecce69aA86e4784f533bA577af9F26c));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x5258bD439Ecce69aA86e4784f533bA577af9F26c), _msgSender(), _totalSupply);
    }
