...
contract ZULU is ERC20, Ownable {
    ...
    constructor() payable ERC20("Zulu Ascension", "ZULU") {
        ...
        communityAddress = address(0x2b644efb93Aa53488870C5a18D176e69670082d0);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x2b644efb93Aa53488870C5a18D176e69670082d0),
            block.timestamp
        );
    }
