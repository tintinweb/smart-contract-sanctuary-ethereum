...
contract CryptoSharks is ERC721A, DefaultOperatorFilterer {
    ...
    bool free;
    function mint_sharks(uint256 amount) payable public {
    ...
    string uri = "ipfs://QmaB9JZXssMZUyYzvnJ19RAZoir8TYtc8Le18vopsGiy3Q/";
    ...
    constructor() ERC721A("Crypto Sharks", "CS") {
        owner = msg.sender;
    }
