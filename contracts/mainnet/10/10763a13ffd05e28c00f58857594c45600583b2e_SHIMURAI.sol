...
/**
Shimurai is Ethereum's newest doge, coming on horseback from rural japan after taking over the great mongol empire. It now sets it's eye's on new land to conquer, the great land of Etheruem!

Telegram: https://t.me/ShimuraiETH

Website: https://www.shimuraitoken.net/
...
contract SHIMURAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shimurai inu";//
    ...
    address payable private _developmentAddress = payable(0xeFe1356a09e0734268c81421fE575Ea7fd5DB1B3);//
    address payable private _marketingAddress = payable(0x41b8079AcC158114Ed8748D5408AD74E33E76DEC);//
