...
contract TycoonPass is ERC721, Ownable {
    ...
    IERC20 public usdc;
    uint256 public constant MAX_SUPPLY = 10000; // max supply
    uint256 price = 5 * 10 ** 6; // only change the first value (because usdc is a 6 decimal ERC20 token)
    string public baseUri = "ipfs://QmVVSAKGvCWQEV6RtWRnRxMVFS7y3A3RqJK6zfKqa48fUJ/";
    string public baseExtension = ".json";


    constructor(address _usdcAddress) payable ERC721("TycoonPass", "TP") {
