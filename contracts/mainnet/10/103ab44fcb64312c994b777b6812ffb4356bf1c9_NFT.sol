...
contract NFT is ERC721Upgradeable, IERC2981, INFT {
    ...
    function openseaMint(address to, uint256 tokenId) external {
        require(msg.sender == MINTER && tokenId < MAX_SUPPLY);
        _mint(to, tokenId);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns(string memory) {
        require(tokenId < MAX_SUPPLY, "out of bound tokenid");
    ...
    function isApprovedForAll(address owner, address operator) public view override returns(bool) {
        return operator == CONDUIT || super.isApprovedForAll(owner, operator);
    }
}