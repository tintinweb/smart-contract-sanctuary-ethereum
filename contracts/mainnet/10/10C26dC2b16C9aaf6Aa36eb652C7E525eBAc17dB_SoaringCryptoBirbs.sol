...
contract SoaringCryptoBirbs is Ownable, ERC721A, DefaultOperatorFilterer  {

    using Strings for uint256;

    string private baseTokenURI;

    uint256 public presaleCost = 0.0088 ether;
    uint256 public publicSaleCost = 0.0099 ether;
    ...
    constructor() ERC721A("Soaring CryptoBirbs", "SOAR"){}
