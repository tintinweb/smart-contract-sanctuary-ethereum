...
contract CLAN2122s is ERC721A, Ownable, OperatorFilterer {

    constructor() ERC721A("CLAN2122s", "CLAN") OperatorFilterer(address(0), false) {}

    string baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0 ether;
    uint256 public maxSupply = 555;
    uint256 public preSaleSupply = 555;
