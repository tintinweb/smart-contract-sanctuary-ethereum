...
OPINIONS PROTOCOL
Based On VB Tweet
https://twitter.com/VitalikButerin/status/1586558071618568193?s=20&t=GIhuLI71auiZJguz2rSFHQ
*/
...
contract OP is Context,IERC20, Ownable{
 ...
 string private _name = "OPINIONSPROTOCOL";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x20fdaea2AB5fe5D28781101620F25cbD21a1dA42);
 ...
 //Tokenomics related functions
  function OPDay() public onlyOwner{
      require(block.timestamp > OPDaycooldown, "You cant call OPCoinDay more than once a day");
 ...
 function OPCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      OPDaycooldown = block.timestamp + 86400;
 }
