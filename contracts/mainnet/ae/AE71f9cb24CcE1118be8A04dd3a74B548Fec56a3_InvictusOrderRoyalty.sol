...
contract InvictusOrderRoyalty is ERC2981, AccessControl {
    constructor() {
     ...
     * @inheritdoc ERC2981
     */
    function royaltyInfo(uint256 tokenId, uint256 salePrice) public view override(ERC2981) returns (address, uint256) {
