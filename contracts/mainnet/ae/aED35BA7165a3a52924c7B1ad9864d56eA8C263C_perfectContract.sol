...
abstract contract Project {
    ...
    string constant _name = "Perfect Coin";
    string constant _symbol = "PC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 100) / 1000; // (_totalSupply * 10) / 1000 [this equals 10%]
    uint256 public _maxWalletToken = (_totalSupply * 200) / 1000; //
 ...
 * MainContract
 */
contract perfectContract is Project, IERC20, Ownable {
