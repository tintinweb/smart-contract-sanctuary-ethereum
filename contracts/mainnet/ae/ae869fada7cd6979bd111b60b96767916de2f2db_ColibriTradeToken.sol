...
abstract contract ERC20Token is Context, IERC20, IERC20Metadata {
...
contract ColibriTradeToken is ERC20Token, Ownable {
    constructor() ERC20Token("Colibri Trade Token", "CTT") {
        _mint(_msgSender(), 10**6 * 10 ** 18);
    }
