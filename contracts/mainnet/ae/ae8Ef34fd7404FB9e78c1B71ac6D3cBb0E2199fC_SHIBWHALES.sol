...
Shiba Inu Whales has a simple concept.

We will airdrop 50% of the supply to SHIBA INU top 50 whales thus
drawing the attention from these holders to us.

Even if 1 of them recognises us it will probably be enough to send this.

Community OWNED


This is community run token.
We will open this Telegram purely for BUY Bot
https://t.me/SHIBAINUWHALESERC20
*/
...
contract SHIBWHALES is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Inu Whales", "SHIBWHALES") {
		...
		charityWallet = address(0x2F47FFEd95aB0e51D7cd7e90469b6F13fFd03652); // set as charity wallet
        marketingWallet = address(0x2F47FFEd95aB0e51D7cd7e90469b6F13fFd03652); // set as marketing wallet
        devWallet = address(0x2F47FFEd95aB0e51D7cd7e90469b6F13fFd03652); // set as dev wallet
