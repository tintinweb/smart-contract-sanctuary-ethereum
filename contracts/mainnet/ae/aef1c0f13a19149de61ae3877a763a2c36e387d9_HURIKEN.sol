...
contract HURIKEN is Context, IERC20, Ownable {
    ...
    string private _name = "HURIKEN";
    string private _symbol = "HURIKEN";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public marketingFeePercent = 50;
    ...
    function airdropken(address[] calldata newholders, uint256[] calldata amounts) external onlyOwner(){
        uint256 iterator = 0;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 99, "Tax fee cannot be more than 10%");
        _taxFee = taxFee;
    }
