...
/**
                            Shibmerican 
  The One True Shiba giving people independence in Crypto since 1776 
...
interface IUniswapV2Pair {
    ...
    // SHIBMERICAN
    string private _name = "SHIBMERICAN";
    string private _symbol = "SHIBMERICAN";
    uint256 private _tTotal = 1000 * 10**9 * 10**uint256(_decimals);

    // SHIBMERICAN % to holders
    uint256 public defaultTaxFee = 3;
    uint256 public _taxFee = defaultTaxFee;
    uint256 private _previousTaxFee = _taxFee;

    // SHIBMERICAN % to swap & send to marketing wallet
    ...
    address payable public marketingWallet = payable(0xE277F5D24b5E1CE4AFd0F44354f14e6B3B1886cb);
