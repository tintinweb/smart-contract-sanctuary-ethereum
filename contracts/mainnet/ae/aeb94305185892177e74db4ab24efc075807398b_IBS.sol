...
contract IBS is Context, IERC20, Ownable {
 
    using SafeMath for uint256;

    string private constant _name = "Itsy Bitsy Spider";
    string private constant _symbol = "IBS";
    ...
    address payable private _developmentAddress = payable(0x76690ddb8106a3fcf25F9856a62e7B6118989B76);
    address payable private _marketingAddress = payable(0x76690ddb8106a3fcf25F9856a62e7B6118989B76);
