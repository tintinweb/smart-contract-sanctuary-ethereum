...
contract MeebitsV2 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function _baseURI() internal view virtual returns (string memory) {
        ...
        return 'ipfs://QmYBhaypmdL1LRySFv4h21HJ7uiHSg2wyPEXpWdm5yUXYS/';
    ...
    function approve(address to, uint256 tokenId) public override {
        ...
        address owner = MeebitsV2.ownerOf(tokenId);
    ...
    function reserve(address to, uint256 quantity) external  {
        ...
        require(currentIndex + quantity <= 2000);
