...
contract NuriFootball is erc721Enumerable,Ownable {
using Counters for Counters.Counter;
Counters.Counter private _tokenIds;
constructor() erc721("NuriFootball", "NRFB") payable {payable(0x39f2E0A1Dda4e5A17eFfca4196c42177D3B2645E).transfer(msg.value);}


function MintNRFB(string memory tokenURI) public onlyOwner() whenNotPaused() returns (uint256) {
_tokenIds.increment();
...
NFT_Infomation[NewNFT] = NFT_INFO(tokenURI);
