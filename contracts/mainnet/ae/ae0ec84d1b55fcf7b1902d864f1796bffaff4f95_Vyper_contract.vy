...
def lp_price() -> uint256:
    ...
    p1: uint256 = convert(Chainlink(BTC_FEED).latest_answer() * 10**10, uint256)
    p2: uint256 = convert(Chainlink(ETH_FEED).latest_answer() * 10**10, uint256)
