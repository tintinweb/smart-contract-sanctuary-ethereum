// https://darkhorsecoin.org
// https://t.me/DarkHorseCoinPortal
...
contract DARKHORSE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DARK HORSE", "HORSE") {
        ...
        maxTransactionAmount = totalSupply * 40 / 1000; // 4% max transaction
        maxWallet = totalSupply * 45 / 1000; // 4.5% max wallet
        ...
        marketingWallet = address(0x95fA92D97C050c778E1d113b72ce74f4246B2238); // marketingwallet
        devWallet = address(0xE2e5355df32ae682b2d9CfAE0d09FB68E25FD8fA); // devwallet
