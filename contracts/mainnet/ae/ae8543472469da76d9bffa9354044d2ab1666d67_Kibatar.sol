...
https://t.me/KibatarPortal
https://kibatar.com/
https://medium.com/@kibatar
https://twitter.com/KibatarETH
...
contract Kibatar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Kibatar";
    string private _symbol = "KTA";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xce1E7ab683512e0d00dFD55c3fffA806B2912f29);
    address payable public DeveloperWallet = payable(0xB22ea9f59CD4839A72584Ae5C039386452D0216c);
