...
Shiburb - All these birds need an exterminator, the freshest bird killer.”
...
|  $$$$$$ | $$$$$$$$  | $$  | $$$$$$$ | $$  | $$| $$$$$$$/| $$$$$$$ 
 ...
 /$$  \ $$| $$  | $$  | $$  | $$  \ $$| $$  | $$| $$  \ $$| $$  \ $$
|  $$$$$$/| $$  | $$ /$$$$$$| $$$$$$$/|  $$$$$$/| $$  | $$| $$$$$$$/
 \______/ |__/  |__/|______/|_______/  \______/ |__/  |__/|_______/ 
...
contract ShiburbToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shiburb Token";//
    string private constant _symbol = "SHIBURB";//
    ...
    address payable private _developmentAddress = payable(0x3D0fE205cEC5A88014F163dF67c2CCa0dF9A4EAa);//
    address payable private _marketingAddress = payable(0x875b1E8c1EDB3DE1259C5A291EFb7C2a6c374613);//
