...
/*
Long Live Shiba.
The 17-year-old shiba inu stopped "eating and drinking voluntarily" on Christmas Eve,
and has been diagnosed with acute cholangiohepatitis and chronic lymphoma leukemia.
Most powerful meme doge is duying!
Lets celebrate this beautiful life
Be safe*
*/
...
contract KABOSU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Long Live Shiba";
    ...
    address payable private _developmentAddress = payable(0x3a9d25Bcde699D85f7c939cfAe282c69E8ab387B); 
    address payable private _marketingAddress = payable(0x3a9d25Bcde699D85f7c939cfAe282c69E8ab387B);
