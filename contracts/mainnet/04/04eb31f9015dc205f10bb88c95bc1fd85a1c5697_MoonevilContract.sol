...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xa9dEB21D02b95120fDc1D0C14A664765f4D75Af6];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 5, 1995 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmNxVxxsvrC6PUYyHd4bQqmmbAKcqbinJQo732AL9LTRTK/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1995");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1995");
...
// File: contracts/MoonevilContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoonevilContract is RamppERC721A {
    constructor() RamppERC721A("Moonevil", "EVIL"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/lOu9DUbfkth2MW68Jbzu/contract-metadata";
    }
}
