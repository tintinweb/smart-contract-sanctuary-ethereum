...
contract MorphingMuffinsNFT is ERC721A, Ownable, ReentrancyGuard
{
    uint public constant MAX_TOKENS = 10000; //This is your total supply limit
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 2000; //This is your reserved supply that can be used for marketing etc.
    ...
    constructor() ERC721A("Morphing Muffins", "MORPH") {} //Name of Project and Token "Ticker"

    function mintToken(uint256 amount) external //This function is for Public Mint and Presale Mint Parameters and Error Messages
    {
