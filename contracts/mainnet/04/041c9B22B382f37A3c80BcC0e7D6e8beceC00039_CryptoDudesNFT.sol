...
contract CryptoDudesNFT is Ownable, ERC721A, ERC721AQueryable, PaymentSplitter {
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRoot, string memory _notRevealedURI, uint _startTime) ERC721A("CrytoDudes", "CRYPTODUDES") PaymentSplitter(_team, _teamShares) {
