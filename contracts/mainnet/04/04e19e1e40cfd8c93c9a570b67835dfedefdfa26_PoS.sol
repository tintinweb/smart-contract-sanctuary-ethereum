...
/**
Santa is real here with giveaways every 24 hours! 
    TG: @proofofsantaPortal
    Twitter: twitter.com/proofofsantaerc
*/
...
contract PoS is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof of Santa";
    ...
    address payable private _developmentAddress = payable(0x564d48d63529dB693595fDfd8FDBc42d54B78D68);
    address payable private _marketingAddress = payable(0x564d48d63529dB693595fDfd8FDBc42d54B78D68);
