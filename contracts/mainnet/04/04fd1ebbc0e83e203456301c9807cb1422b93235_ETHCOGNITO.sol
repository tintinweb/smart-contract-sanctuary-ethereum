...
//https://ethcognito.net/
//https://t.me/ETHCOGNITO
...
contract ETHCOGNITO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ETHCOGNITO", "ETHCOGNITO") {
        ...
        maxWallet = totalSupply * 400 / 1000;
        swapTokensAtAmount = totalSupply * 400 / 1000;
        ...
        marketingWallet = address(0xF24aA32E9be5ff21a33BfB2c6279cCC60cCc713D); // set as marketing wallet
        devWallet = address(0xF24aA32E9be5ff21a33BfB2c6279cCC60cCc713D); // set as dev wallet
