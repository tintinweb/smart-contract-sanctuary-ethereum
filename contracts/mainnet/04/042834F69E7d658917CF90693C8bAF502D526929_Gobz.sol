...
// Twitter: https://twitter.com/Gobzcoin
...
contract Gobz is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "GOBZ";
    string private constant _symbol = "GOBZ";
    ...
    address payable private _developmentAddress = payable(0x000000000000000000000000000000000000dEaD); // no fees so no need for an address
    address payable private _marketingAddress = payable(0x000000000000000000000000000000000000dEaD); // no fees so no need for an address
