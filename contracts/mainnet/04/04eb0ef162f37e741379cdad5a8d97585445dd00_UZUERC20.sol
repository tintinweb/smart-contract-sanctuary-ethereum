 ...
 * allowances. See {IERC20-approve}.
 */
contract UZUERC20 is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Uzuki";
    string private _symbol = "UZUKI";
    ...
    address public marketingWallet = 0xa3285644B6052EbA9fb3ed55952C60784e5555E3;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 3, "ERC20: total tax must not be greater than 3");
