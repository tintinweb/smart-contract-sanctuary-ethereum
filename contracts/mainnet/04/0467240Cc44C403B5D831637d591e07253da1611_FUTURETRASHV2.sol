 ...
 * @notice This contract handles minting FUTURE TRASH V2 tokens.
 */
contract FUTURETRASHV2 is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0xD4E00A090bd456ea242032643e39D860F3BBAa63;
    address[] public payoutAddresses = [
        0xD4E00A090bd456ea242032643e39D860F3BBAa63
    ];
    bool public isPublicSaleActive = false;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeicrc37ydsbd3j73siiepqzqeapzayxj4y6nln56sdwpvhsst6372a/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 128;
    uint256 public publicMintsAllowedPerAddress = 5;
    uint256 public publicMintsAllowedPerTransaction = 128;
    ...
    constructor() ERC721A("FUTURE TRASH V2", "FTRSH") {
