...
contract DESPIRIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Dejitaru Spirit";
    string private _symbol = "DESPIRIT";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xeBE89A81cacE96bfab147a07085B7F2dE9F36789);
    address payable public DeveloperWallet = payable(0xeBE89A81cacE96bfab147a07085B7F2dE9F36789);
