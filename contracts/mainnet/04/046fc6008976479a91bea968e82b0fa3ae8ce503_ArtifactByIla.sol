...
// File contracts/ERC721A.sol
    ...
    contract ArtifactByIla is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    string public uriPrefix = "ipfs://QmeLxwoN1xepdzE3P9NADsJHvakTAtVKheNQB1ezkWgpgu/"; string public uriSuffix = ".json"; string public hiddenMetadataUri;
    ...
    constructor() ERC721A("ArtifactByIla", "AI") {setHiddenMetadataUri("ipfs:///hidden.json");}
