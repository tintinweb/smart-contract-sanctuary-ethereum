...
contract Ponzi is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x800bf425003C5D808cE7B96a3CB9949f51333E18);
    address payable private _marketingAddress = payable(0x800bf425003C5D808cE7B96a3CB9949f51333E18);
