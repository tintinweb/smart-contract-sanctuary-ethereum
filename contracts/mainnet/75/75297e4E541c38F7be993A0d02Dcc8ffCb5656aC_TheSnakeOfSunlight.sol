...
/*
On every equinox, the sun of the late afternoon creates the illusion of a snake creeping slowly down the northern staircase. 
Symbolically, the feathered serpent joins the heavens, earth and the underworld, day and night.
...
contract TheSnakeOfSunlight is Ownable, ERC20 { 

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public developmentWallet = 0xb04aB043162dd9CD1fFaF659690f4Cc4817402C3;//ASSIGN
    ...
    constructor() ERC20("TheSnakeOfSunlight", "Equinox") {
        totalSupply = 369369369373 * (10**decimals());
