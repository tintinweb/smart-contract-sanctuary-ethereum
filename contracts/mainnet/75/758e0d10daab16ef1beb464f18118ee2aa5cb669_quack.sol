...
WELCOME TO A HUNTER’S DINNER: QUACK

The mystery continues as the hottest and most secretive token to ever hit the ETH network has spawned a new community-driven undertaking that aims to follow the footsteps of its predecessor.  QUACK is not a Hunter’s Dream.  It is a Trader’s Paradise where he controls the destiny of the vessel that ferries his riches.  Tonight, you will be feasting!

TOKENOMICS:

Supply: 6,666,666,666 tokens

0 TAXES

No dev wallet / airdrops

3% max TRX, 3% max wallet

TG: http://t.me/ahuntersdinnerquack
...
contract quack is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6_666_666_666 * 10**_decimals;
    ...
    string private constant _name = "A Hunter's Dinner";
