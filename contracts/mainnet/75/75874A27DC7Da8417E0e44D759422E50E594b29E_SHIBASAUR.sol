...
contract SHIBASAUR is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "SHIBASAUR";
    string private constant tokenSymbol = "SHIBASAUR";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x741A591B2663cae76Cb4E00d1aa628EfF0077E8D);
        devAddress = payable(0x741A591B2663cae76Cb4E00d1aa628EfF0077E8D);
