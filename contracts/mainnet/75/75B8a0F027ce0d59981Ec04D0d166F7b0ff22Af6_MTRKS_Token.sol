...
contract MTRKS_Token is ERC721A, Ownable, ReentrancyGuard {
    ...
    address public address1 = 0x6C9e2Ab158B9AFC8322647132c4419ABCb474d08; // User1
    address public address2 = 0x8a8C1478083587775dfBDb0a10532Ae015bdF605; // User2
    ...
    modifier canMintFree(address minter, uint256 numberOfTokens) {
        ...
        require(
            (numberOfTokens > 0) && (freeMintCountMap[minter] + numberOfTokens) <= MAX_FREE_PER_WALLET,
    ...
    /* Leaving selfdestruct in contract during development, will report for prodution */
