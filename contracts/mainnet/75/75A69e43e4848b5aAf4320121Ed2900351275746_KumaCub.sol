...
contract KumaCub is ERC721ACustom, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        FactionInfos memory f = faction[tokenId];
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(baseURI, "cub?faction=" ,f.faction.toString(), "&id=", f.factionIndex.toString())) : '';
    }
