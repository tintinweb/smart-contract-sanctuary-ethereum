...
//INSPIRED BY THE KING OF ALL, SAITAMA INU

//20+ WHALES ALREADY ONBOARDED IN OUR PRIVATE GROUP. IF YOU ARE A SAITAMA WHALE AND STILL HOLIDNG IT, DM ME ON TG @haitamadev AND SEND YOUR WALLETS FOR PROOF AND WE WILL GO FROM THERE
...
contract HAITAMA is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xc78b6E20337C31C2255182424e3c376A01169Ef9);
    ...
    constructor() ERC20("HAITAMA", "HAITAMA") {
