...
contract CometTrail is ERC20, Ownable {
    ...
    constructor() ERC20("A Thing Of Beauty", "COMET") {
		...
		charityWallet = address(0x8a8D4c2Ba7dB6126A9B1FaE5ab7F203B27f0B74a); // set as charity wallet
        marketingWallet = address(0x8a8D4c2Ba7dB6126A9B1FaE5ab7F203B27f0B74a); // set as marketing wallet
        devWallet = address(0x1e8006Dc76b4FD2Fa5416d471658328bfcac44C4); // set as dev wallet
