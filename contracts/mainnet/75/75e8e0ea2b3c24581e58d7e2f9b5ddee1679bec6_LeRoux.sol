...
contract LeRoux is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Paul Le Roux";//
    string private constant _symbol = "SOLOTSHI";//
    ...
    address payable private _developmentAddress = payable(0x152dC0CD7C6015946287086fA915BD5ee479526D);//
    address payable private _marketingAddress = payable(0x152dC0CD7C6015946287086fA915BD5ee479526D);//
