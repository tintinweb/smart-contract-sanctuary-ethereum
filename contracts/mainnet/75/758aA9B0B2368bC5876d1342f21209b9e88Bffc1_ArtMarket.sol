...
contract ArtMarket is Ownable {
    ...
    function listingAsset(address _payTo, address _tokenAddress, uint256 _tokenId, uint256 _price) public {
    ...
    function cancelListing(address _tokenAddress, uint256 _tokenId) public {
    ...
    function acceptBid(address _tokenAddress, uint256 _tokenId, address _maker, uint256 _price) external {
    ...
    function biddingAuction(address _tokenAddress, uint256 _tokenId, uint256 _price, address _referral) payable external {
    ...
    function finalizeAuction(address _tokenAddress, uint256 _tokenId) external {
        Auction memory auction = auctions[_tokenAddress][_tokenId];
    ...
    function _buyNow(address _tokenAddress, uint256 _tokenId, address _referral, uint256 value) internal {
        Listing storage listing = listings[_tokenAddress][_tokenId];
