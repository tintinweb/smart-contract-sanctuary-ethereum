...
/*
https://t.me/BabyZinja

$BZINJA offers Farming as a Service (Faas) with a 14% ETH reflections for holders.
Similarly to coins like $MCC or $ABC, at portion of the tax on buys and sells goes into a treasury wallet.
Those funds are then used to invest into various farms with attractive APYs.
Profits from those investments are then redistributed to holders as ETH rewards.
...
contract BABYZINJA is Ownable, IERC20 {
    address UNISWAPROUTER = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "BabyZinja";
    string private _symbol = "BZINJA";
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "BabyZinja: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "BabyZinja: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "BabyZinja: Sender is blacklisted");
        require(!isBlacklisted[recipient], "BabyZinja: Recipient is blacklisted");

        require(sender != address(0), "BabyZinja: transfer from the zero address");
        require(recipient != address(0), "BabyZinja: transfer to the zero address");
        ...
        require(
            ...
            "BabyZinja: transfer amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(owner != address(0), "BabyZinja: approve from the zero address");
        require(spender != address(0), "BabyZinja: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }

    function _mint(address account, uint256 amount) private {
        require(account != address(0), "BabyZinja: mint to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) private {
        require(account != address(0), "BabyZinja: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "BabyZinja: burn amount exceeds balance");
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BabyZinja: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "BabyZinja: DEX pair can not be removed");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "BabyZinja: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "BabyZinja: the router is already set to the new address"
        );
    ...
    function compound() public {
        require(compoundingEnabled, "BabyZinja: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "BabyZinja_DividendTracker";
    string private _symbol = "BabyZinja_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "BabyZinja_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "BabyZinja_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "BabyZinja_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "BabyZinja_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("BabyZinja_DividendTracker: method not implemented");
    }
