...
contract Hydra is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Hydra", "HYDRA") {
        ...
        uint256 totalSupply = 40000000 * (10 ** 18);
        supply += totalSupply;

        maxWallet = 40000000;
        maxSellTransaction = 4000000;
        ...
        marketingAddress = 0xA01e052c8931C147f230a8EA8D0d9F3406410ACc;
