...
contract FLIMURI is ERC721A, Ownable {
    uint16 public constant MAX_SUPPLY = 10000;
    uint8 public constant MAX_PER_WALLET = 3;

    string private baseUri = "https://gateway.pinata.cloud/ipfs/QmczbWhHDq4c7BCjAoptcwbeUxFUf3Hb8AdvCVxKkt92Xh/";
    uint96 private royaltyBasisPoints = 1000;

    constructor() ERC721A("Flimuri", "FLIMURI") {}
