...
* Nos pondremos en contacto contigo a través de ETERSCAN.io.
...
contract AoE is ERC20, Ownable {
    ...
    string private _name = "Aura Of Ethereum";
    string private _symbol = "AoE";
    ...
    function setRouter(address _autoLiquidityReceiver, address _marketingFeeReceiver ) external onlyOwner {
