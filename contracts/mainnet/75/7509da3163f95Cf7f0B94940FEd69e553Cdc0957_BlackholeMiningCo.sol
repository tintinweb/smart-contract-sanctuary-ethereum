...
contract BlackholeMiningCo is ERC721A, Ownable, ReentrancyGuard {
    ...
    ) ERC721A("BlackholeMiningCo", "BHMC") {
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xf406Ba81a324b78c6fd73E33d1f15A429D972c04).transfer(amount);
        payable(0xE616B4EdA0Fbd4A8b9A43eECd614ee6Ef024d740).transfer(amount);
    }
    ...
    function toggleIsHidden() external onlyOwner {
        isHidden = !isHidden;
    }
    ...
    function reserveTokens(address to, uint256 numberOfTokens) external nonReentrant onlyOwner {
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Transaction would exceed max supply");
