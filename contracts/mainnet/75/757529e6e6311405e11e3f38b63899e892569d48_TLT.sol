...
/**
TLT - The Letter Token

26,000,000 tokens
2% max (520,000)
TAX : 5 buy /5 sell taxes will be dropped after 10 minutes of launch

One Letter to Rule Them All

Telegram : T.ME/TheLetterToken 
*/
...
// SPDX-License-Identifier: Unlicensed
    ...
    contract TLT is ERC20 {
        ...
        constructor () ERC20("THE LETTER TOKEN", "$TLT"){

            numTokensSellToSendEthToDev = 260000 * 10 ** decimals();
            _devWalletAddress = 0x4a1670466172B7Cc1e80733c402561C69572Da8B;
            ...
            */
            _mint(owner(), 26000000 * 10 ** decimals());		
