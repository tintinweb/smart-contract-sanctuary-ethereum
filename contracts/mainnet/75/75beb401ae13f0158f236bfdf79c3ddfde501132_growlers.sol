...
// File: contracts/growlers.sol

pragma solidity ^0.8.4;

contract growlers is ERC721A, Ownable {

    using Strings for uint256;

    string public baseURI = "https://growlers.s3.amazonaws.com/metadata/";
    ...
    constructor() ERC721A("Growlers", "GROWL") {
        _mint(msg.sender, 1);
    }
