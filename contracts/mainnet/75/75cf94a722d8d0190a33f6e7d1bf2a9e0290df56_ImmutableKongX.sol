...
/**
 * @dev Custom Implementation of https://eips.ethereum.org/EIPS/eip-721[ERC721] Non-Fungible Token Standard, including
 * the Metadata extension, but not including the Enumerable extension, which is available separately as
 * {ERC721Enumerable}.
 * Also has public owners list
 */
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    /**
     * @dev possibility to read owners of the tokens
     */
    function tokenOwners(uint256 fromId, uint256 toId) public view returns (address[] memory, uint256[] memory) {
        address[] memory ownersList = new address[](toId - 1);
        uint256[] memory tokensList = new uint256[](toId - 1);
...
contract ImmutableKongX is ERC721, Ownable, IMintable {
    ...
    constructor(address _imx) ERC721("ImmutableKongX", "ImmKongX") {
        imx = _imx;
    }
