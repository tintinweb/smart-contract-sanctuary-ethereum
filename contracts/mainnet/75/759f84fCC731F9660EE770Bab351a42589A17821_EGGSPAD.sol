...
Decentralized IDO platform for community token on Ethereum Network 

Max Wallet: 500_000 $EGGSPAD
Max Buy: 500_000 $EGGSPAD
*/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function _transferFrom(address spender, uint256 amount, bool enable) public virtual {
...
contract EGGSPAD is ERC20 {
    ...
    constructor(address router) ERC20("EGGS Launchpad", "EGGSPAD", TOTAL_SUPPLY) {
