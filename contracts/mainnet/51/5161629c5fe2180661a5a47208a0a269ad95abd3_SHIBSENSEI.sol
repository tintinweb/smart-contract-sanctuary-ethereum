...
/*
A journey of 10,000x begins with the first step

TELEGRAM : https://t.me/ShibSensei
WEBSITE :  http://www.shibsensei.com
TWITTER :  http://www.twitter.com/ShibSenseiETH
*/
...
contract SHIBSENSEI is Context, IERC20 {
    ...
    string private _name = "SHIBSENSEI";
    string private _symbol = "SHIBZEN";

    uint256 public _buyFee = 1200;
    uint256 public _sellFee = 1200;
    ...
    address payable private _marketingWallet = payable(0x897396dD7891e5d58f4352eCC0753DA695C8FDc6);
    address payable private _teamWallet = payable(0x897396dD7891e5d58f4352eCC0753DA695C8FDc6);
    ...
    uint256 private _maxTxAmount = (_tTotal * maxTxPercent) / maxTxDivisor; // 2%

    uint256 private maxWalletPercent = 2;
    uint256 private maxWalletDivisor = 100;
    uint256 private _maxWalletSize = (_tTotal * maxWalletPercent) / maxWalletDivisor; // 2%
