...
1% Buy limit for first 2 minutes
...
contract YorkiPooToken is Context, IERC20, Ownable { ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTradeAmount = 1000000000000000 * 10**9; // 1% for first 2 minutes after launch
    ...
    function setBot(address botwallet) external onlyOwner() {
            _isBot[botwallet] = true;
    }


    function delBot(address botwallet) external onlyOwner() {
