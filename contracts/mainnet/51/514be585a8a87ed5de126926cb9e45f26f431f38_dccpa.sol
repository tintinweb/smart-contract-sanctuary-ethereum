...
https://t.me/FuckDCCPA

https://twitter.com/FuckDCCPA

---

This is bigger than just one project
This is bigger than just one ecosystem
This affects all of DeFI. This affects us all.
...
If you oppose the DCCPA and CFTC, this is the place to be.
...
contract dccpa is Context, IERC20, Ownable {
    ...
    string private constant _name = "FUCK DCCPA";
    ...
    address payable private _developmentAddress = payable(0xE80F6BF67EcA9C893Ed7aBBA61BA3564cDa82F4E); 
    address payable private _marketingAddress = payable(0xE80F6BF67EcA9C893Ed7aBBA61BA3564cDa82F4E);
