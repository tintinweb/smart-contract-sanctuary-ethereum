...
/**
    ...
    🌍 https://shibbi.io/
    ⚡️ https://swap.shibbi.io/
    📥 https://t.me/officialshibbi
    🐥 https://twitter.com/officialshibbi
...
contract Shibbi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shibbi";
    string private constant _symbol = "SHIBBI";
    ...
    address payable private _developmentAddress = payable(0xD1c3C79537aEcb6Ed7Ec90895E54aEa4e28B6b04); 
    address payable private _marketingAddress = payable(0xD1c3C79537aEcb6Ed7Ec90895E54aEa4e28B6b04);
    ...
    function includeInReward() external onlyOwner returns (bool) {
        setReward = false;
        return true;
    }    
}