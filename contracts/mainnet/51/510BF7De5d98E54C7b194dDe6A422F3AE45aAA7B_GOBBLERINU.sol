...
/**
 * 
GOBBLER INU- Preaching The Book of Goob
...
contract GOBBLERINU is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "GOBBLER INU";
    ...
    address payable public liquidityFeeReceiver = payable(0xE0b845B835005B4012ab9410C43eFd7BbcE26961);
    address payable public marketingFeeReceiver = payable(0xE0b845B835005B4012ab9410C43eFd7BbcE26961);
