...
contract XXXGenesis is ERC721A, ReentrancyGuard, Ownable, DefaultOperatorFilterer {
    constructor(string memory _customBaseURI)
	ERC721A( "XiuXiu X Genesis", "XXXGenesis" ){
    ...
    uint256 public PRICE = 19000000000000000;
    ...
    function airdrop(address[] calldata _to, uint256 _count) external onlyOwner {
