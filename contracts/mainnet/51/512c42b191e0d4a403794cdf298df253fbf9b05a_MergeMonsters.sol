...
contract MergeMonsters is ERC721A, Ownable {
    ...
    constructor( uint256 newMaxSupply, address newSignerAddress, string memory newBaseURI ) ERC721A("Merge Monsters", "MMON") {
