...
contract SoulReturn is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Soul Return", "SR") {
        setHiddenMetadataUri("ipfs://QmPch2ADP8oTi61XcC2jtChPHgFSZKgnHfDdbAvk8eZXJb//");
        setBaseURI("ipfs://QmPch2ADP8oTi61XcC2jtChPHgFSZKgnHfDdbAvk8eZXJb//");
    }
    ...
    function mint(uint256 count) external payable {
      ...
      require(totalSupply() + count <= maxSupply, "No more SR");
