...
contract CrossChainSwapBot is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CrossChainSwap Bot"; 
    string private constant _symbol = "CCSB"; 
    ...
    address payable private _developmentWalletAddress = payable(0x334Db08FdB9416dB0C947603F9449f5b2eaC2bD3);
    address payable private _marketingWalletAddress = payable(0x334Db08FdB9416dB0C947603F9449f5b2eaC2bD3);
