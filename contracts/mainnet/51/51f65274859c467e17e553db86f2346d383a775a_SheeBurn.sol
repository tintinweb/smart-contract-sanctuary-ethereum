...
contract SheeBurn is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SheeBurn Inu";
    string constant _symbol = "SHINUBURN";
    ...
    address public marketingFeeReceiver = 0xFdc67dca789480F80CCB2FE87543689333884683;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 70; // 0.70%
    bool inSwap;
    ...
    function setFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _sellLiquidityFee, uint256 _sellMarketingFee) external onlyOwner {
         ...
         require(totalFee <= 10 && totalSellFee <= 10, "Must keep fees at 25% or less");
    }
