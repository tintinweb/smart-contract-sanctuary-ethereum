...
contract Saruno is ERC721A, Ownable, ERC2981, OperatorFilterer {
    uint256 public price = 0.0089 ether;
    uint256 public presalePrice = 0.0075 ether;
    ...
    address[] public withdrawAddresses = [0x714797e241B2e0761f8934936aFc793AF835bCef, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xcddcb429977a374c5584351fa2e9dcb2c3095ea4923c46a624db5a3cb11b02b8;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x714797e241B2e0761f8934936aFc793AF835bCef, _royaltyAmount);
    }
