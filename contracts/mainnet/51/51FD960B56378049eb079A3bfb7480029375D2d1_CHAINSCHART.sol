...
/**
https://www.chainschart.io
https://t.me/ChainsChartERC
*/
...
contract CHAINSCHART is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Chains Chart"; 
    string private constant _symbol = "CHAINS CHART"; 
    ...
    address payable private _developmentWalletAddress = payable(0xFAaAe6e9ea5169aB7F39CE92Fb0800eB46F62892);
    address payable private _marketingWalletAddress = payable(0xFAaAe6e9ea5169aB7F39CE92Fb0800eB46F62892);
    ...
    function setFeec(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
