...
Telegram: https://t.me/LiquidApes
Website: https://liquidapes.net
...
contract LiquidApes is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'LiquidApes';
    string private constant _symbol = 'LA';
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 1000 * (10 ** _decimals);
    uint256 private _maxTxAmountPercent = 40; // 10000;
    uint256 private _maxTransferPercent = 40;
    ...
    address internal constant development_receiver = 0xEF18a1E95969FFDE49C81853806C262332dd3FfF; 
    address internal constant marketing_receiver = 0xEF18a1E95969FFDE49C81853806C262332dd3FfF;
    address internal constant liquidity_receiver = 0xEF18a1E95969FFDE49C81853806C262332dd3FfF;
    ...
    function _transfer(address sender, address recipient, uint256 tAmount) private {
        preTxCheck(sender, recipient, tAmount);
        checkTradingAllowed(sender, recipient);
        checkMaxWallet(sender, recipient, tAmount); 
        swapbackCounters(sender, recipient);
        checkTxLimit(sender, recipient, tAmount); 
        swapBack(sender, recipient, tAmount);
        uint256 amount = shouldTakeFee(sender, recipient) ? takeFee(sender, recipient, tAmount) : tAmount;
