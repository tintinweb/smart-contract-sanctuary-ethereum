...
contract TheRealCats is ERC721A, Ownable, ReentrancyGuard, ERC2981 { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 4200;
    ...
    constructor(string memory initBaseURI) ERC721A("TheRealCats", "TRC") {
        baseURI = initBaseURI;
