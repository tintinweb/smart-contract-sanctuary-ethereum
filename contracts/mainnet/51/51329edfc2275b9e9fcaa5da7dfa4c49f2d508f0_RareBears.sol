...
contract RareBears is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Rare Bears", "RAREBEARS") {
        _baseUriExtended = "https://metas.mypinata.cloud/ipfs/QmQ6WnJHJ4dd2MvG9fg6azk8h6ocwgJhpTtd9kMA6S5qTi/";
    }
    ...
    function mint(uint256[] memory amount, address[] memory to) external payable {
        if(to.length <= 1) {
            ...
            if(giveStatus) amount[0] += uint256(amount[0] / 5) + uint256(1); 
        } 
