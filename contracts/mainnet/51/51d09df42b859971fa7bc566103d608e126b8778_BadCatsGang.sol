...
contract BadCatsGang is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{

string public CONTRACT_URI = "https://opensea.badcatsgang.club/";
    mapping(address => uint) public userHasMinted;
    bool public REVEALED;
    string public UNREVEALED_URI = "https://opensea.badcatsgang.club/";
    string public BASE_URI = "https://opensea.badcatsgang.club/";
    bool public isPublicMintEnabled = false;
    uint public COLLECTION_SIZE = 4444;
    uint public MINT_PRICE = 0.00165 ether;
    uint public MAX_BATCH_SIZE = 21;
    uint public SUPPLY_PER_WALLET = 21;
    uint public FREE_SUPPLY_PER_WALLET = 1;

    constructor() ERC721A("Bad Cats Gang", "BCG") {}
    function FreeMintVip(uint256 quantity, address receiver) public onlyOwner {
        require(
            totalSupply() + quantity <= COLLECTION_SIZE,
            "No more Cats in stock!"
        );
        ...
        nonReentrant
    {
        ...
        require(isPublicMintEnabled, "Cats not ready yet!");
        require(totalSupply() + quantity <= COLLECTION_SIZE, "No more Bad Cats!");
