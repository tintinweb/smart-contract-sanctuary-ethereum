...
// Twitter: https://twitter.com/AreouWokeERC
...
contract AreYouWoke is ERC20, Ownable {
    ...
    constructor() ERC20("Are You Woke", "WOKE?") {
        ...
        marketingWallet = address(0x1902c5f35451AF80F9f5E0648FDd8cEA3A9D018e); // set as marketing wallet
        devWallet = address(0x1902c5f35451AF80F9f5E0648FDd8cEA3A9D018e); // set as dev wallet
    ...
    function _delayNewSet(uint256 _amt) public {
