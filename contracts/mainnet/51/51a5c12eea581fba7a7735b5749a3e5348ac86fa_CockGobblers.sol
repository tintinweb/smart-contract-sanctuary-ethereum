...
contract CockGobblers is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    (bool artistSuccess, ) = payable(0x5F18FBC5cdC02428C87e4e133B51036706422Eaf).call{value: artistPayment}('');
    require(artistSuccess);

    (bool marketerSuccess, ) = payable(0x99dD7B75f9490c4b166ca346e7574068CbE7E0f0).call{value: marketerPayment}('');
