...
contract SigmaChads is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Sigma Chads";
    string private _symbol = "$IGMA";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x0B67E8985cFE224600E1f461F69a4B53D7B0eC1d);
    address payable private taxWallet2 = payable(0xF44B56F205941AdEd93653fa359d5f40F351845F);
