...
contract Ontocoin is ERC20, AccessControl {
    ...
    uint public txFee = 0;
    uint public maxAmount=150000e18; 
    bool public inSwapAndLiquify = false;

    address public uniswapV2Pair;

    address private marketting_address=0xFc2816c4D2C9CD752dA8B03D575b2A2d371Cfd42;
    ...
    constructor() ERC20("Ontocoin", "ONTO") {
        _mint(_msgSender(), 150000 * 10 ** decimals()); 
