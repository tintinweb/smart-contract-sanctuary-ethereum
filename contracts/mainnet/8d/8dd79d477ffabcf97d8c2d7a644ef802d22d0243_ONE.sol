...
/**
    ...
    The One Fungible Token

    $1FT is a single token, a fully decentralized protocol

    There is no dev nor marketing fee

    Everyone that holds a piece of $1FT becomes ONE

    1% Liquidity fee on buying and selling $1FT

    All you need to do is buy and share or simply talk about it
    The price of $1FT and your Xs will depend on how much you shill

    There is no team or dev behind the project. Only One. 
   ...
   https://twitter.com/1FungibleToken
   https://t.me/OneFungibleToken
...
contract ONE is ERC20, Ownable {
    ...
    constructor() ERC20("One Fungible Token  ", "1FT") {
        ...
        maxTransactionAmount = 0.01 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 0.02 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x1b0c4671c391EE4859a5AEc40dd19776f3822904); // set as charity wallet
        marketingWallet = address(0x1b0c4671c391EE4859a5AEc40dd19776f3822904); // set as marketing wallet
        devWallet = address(0x1b0c4671c391EE4859a5AEc40dd19776f3822904); // set as dev wallet
