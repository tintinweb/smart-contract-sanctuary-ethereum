...
|       \                 |  \|        \                          |  \                                                  |  \     /      \ 
| $$$$$$$\  ______    ____| $$ \$$$$$$$$  ______    ______    ____| $$  ______    ______    ______       __   __   __  _| $$_   |  $$$$$$\
| $$__/ $$ |      \  /      $$   | $$    /      \  |      \  /      $$ /      \  /      \  /      \     |  \ |  \ |  \|   $$ \  | $$_  \$$
| $$    $$  \$$$$$$\|  $$$$$$$   | $$   |  $$$$$$\  \$$$$$$\|  $$$$$$$|  $$$$$$\|  $$$$$$\|  $$$$$$\    | $$ | $$ | $$ \$$$$$$  | $$ \    
| $$$$$$$\ /      $$| $$  | $$   | $$   | $$   \$$ /      $$| $$  | $$| $$  | $$| $$  | $$| $$   \$$    | $$ | $$ | $$  | $$ __ | $$$$    
...
contract BadTradoorwtf is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.003 ether;
    uint   public maxTx             = 1010;
    uint   public maxSupply         = 1010;
    uint256 public reservedSupply   = 150;
    string private baseURI          = "ipfs://bafybeidbvdrd3ovd4ujkxib7wlnym7xvrbhrwjhcsecthqr2dwlhwq7u5q/";
    bool   public mintEnabled       = true;
    uint   public maxPerFree        = 1;
    uint   public totalFreeMinted   = 0;
    uint   public totalFree         = 150;
    
    mapping(address => uint256) public _FreeMinted;

    constructor() ERC721A("BadTradoor.wtf", "BadTradoorwtf") {}
