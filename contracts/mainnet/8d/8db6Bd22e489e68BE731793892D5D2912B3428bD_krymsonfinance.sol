/*
http://krymsonfinance.com/
https://t.me/krymsonfinance
*/
...
abstract contract Configuration is IERC20 {
    ...
    uint256 public _totalSupply = 10000000 * 10**_decimals; // 10 million total supply
    ...
    uint8 public _liquidityFee = 5; // 4%
    uint8 public _developerFee = 1;  // 1%
    }

contract krymsonfinance is Context, Configuration, Ownable, Blacklist {
