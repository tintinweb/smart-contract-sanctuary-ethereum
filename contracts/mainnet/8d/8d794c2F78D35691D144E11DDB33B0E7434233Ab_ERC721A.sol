...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata,Ownable {
    ...
    uint256 public cost;
    uint256 public maxSupply = 2881;
    uint256 public maxMintAmount = 5;
    bytes32 public root = 0x570c6b64e284275766484cc0bed8016f4916f8c9b6f16b59ce93427eb9591c0d;
    ...
    constructor(string memory name_, string memory symbol_, uint256 _cost, string memory revealURI_) {
        _name = name_;
        _symbol = symbol_;
    ...
    function revealCollection(string memory _URI) external onlyOwner{
        require(!collectionRevealed, "collection already revealed");
        baseURI_ = _URI;
   ...
   function endPresale(uint256 _newCost) external onlyOwner{
       require(preSaleActive == true, "presale already ended");
       cost = _newCost;
       preSaleActive = false;
   }
