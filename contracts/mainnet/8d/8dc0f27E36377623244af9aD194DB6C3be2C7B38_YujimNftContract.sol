...
//*********************************************************************//
//
// __  __        _ _              _   ______________
// \ \/ /_  __  (_|_)___ ___     / | / / ____/_  __/
//  \  / / / / / / / __ `__ \   /  |/ / /_    / /   
//  / / /_/ / / / / / / / / /  / /|  / __/   / /    
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x13f56eF80F1D1500b0C38E145B3449D0beEB7711,0x1Fb50A1DEE43550f8f941a1D1D35E058413e2130];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmRJ1pGsXEMqtXW1zfC7mkmWWXm6to4uAbcirrvPkiuKHJ/";
...
// File: contracts/YujimNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract YujimNftContract is RamppERC721A {
    constructor() RamppERC721A("Yujim NFT", "Yujim"){}
}
