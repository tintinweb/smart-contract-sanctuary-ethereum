...
contract DigiDaigakuVillians is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 209;
    uint256 public MAX_MINTS = 3;
    string public baseURI = "";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("DigiDaigaku Villians Whitelist Spot", "VILLIAN", MAX_MINTS, MAX_SUPPLY) {  
    }
