...
contract ZEITGEIST is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "ZEITGEIST";
    string private constant tokenSymbol = "ZEITGEIST";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 33e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xF2b951183da4Ca121541421eD7604d61E0f14d18);
        devAddress = payable(0x91B1AEe1066CE5aD249E5575c5d58552FebE1622);
