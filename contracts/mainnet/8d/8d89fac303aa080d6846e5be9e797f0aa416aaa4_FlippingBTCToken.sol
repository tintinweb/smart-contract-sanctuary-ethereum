...
contract FlippingBTCToken is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Flipping BTC Token";
    ...
    uint256 private constant _tTotal = 1000 * 1e9; // 100,000,000
    ...
    // fees
    uint256 public _liquidityFee = 0; // divided by 1000
    ...
    address payable private _marketingAddress = payable(0x8d234651Ed15E60c9EC2b9f94f7942FE3F37A9Cc);
    address payable private _dev = payable(0x66739610C9CE88DdA86d156F020Db2121807B5a8);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && from != address(this) && to != address(this)) {
            ...
            if (!inSwap && from != uniswapV2Pair) { //sells, transfers
                ...
                if (contractTokenBalance > 1000 * 1e9) {
