...
contract SKYBIRDS is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("SKYBIRDS", "SBIRD") {
        PRICE = price;
    ...
    0xBE4BbfdBbd69c6DAdc5590B62D5B32fd68B0ab47;
