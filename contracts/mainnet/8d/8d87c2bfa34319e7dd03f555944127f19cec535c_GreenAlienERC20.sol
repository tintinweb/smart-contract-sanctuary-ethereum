...
/** *
Telegram: https://t.me/GreenAllienERC
Website: Reveal Before launch
...
contract GreenAlienERC20 is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Green Alien";
    string private constant _symbol   = "GreenAlien";
    ...
    uint256 public  _minTokenBalance = _tTotal * 1000 / 10000;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 1000 / 10000; // 
