// contracts/TokenizedSilverMinter.sol
 ...
 */
contract TokenizedSilverMinter is Ownable {
    using SafeMath for uint256;
    uint256 private constant MPIP_DIVIDER = 10000000;
    string public constant COMMODITY = "silver";
    ...
    modifier onlyMinter() {
        require(
            isMinter[msg.sender],
            "TokenizedSilverMinter: Only a minter can call this function"
        );
        _;
    }
