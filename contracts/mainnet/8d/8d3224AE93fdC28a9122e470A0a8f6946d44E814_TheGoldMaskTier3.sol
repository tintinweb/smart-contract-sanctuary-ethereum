...
contract TheGoldMaskTier3 is ERC1155, DefaultOperatorFilterer, Ownable {
    ...
    uint256 public tokenCount = 5000; // To ensure the users that only 3000 NFTs will exist!
    mapping(uint256=>bool) mintedTokens;
    uint256 mintedTokensAll = 2000; // The tier 1-2 minted already
    ...
    function addToWhitelist(address[] calldata toAddAddresses) external onlyOwner {
        ...
        require(whitelistedUserCount + toAddAddresses.length<=150, "Max 150 whitelist spot!");
    ...
    function mint(uint256 quantity) external payable { 
        ...
        for (uint256 i = 1; i <= quantity; ++i) {
            ...
            require(id > 2000, "Tier 3, first token ID is #2001!");
    ...
    function salesEndMint() external onlyOwner {
        ...
        require(mintedTokensAll != 5000, "You already minted all you can!");

        uint256 arrayLength;
        if (mintedTokensAll<=4980) {
            arrayLength = 20;
        } else {
