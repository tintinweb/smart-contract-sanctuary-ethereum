...
// https://www.zhihu.com/
// https://okaminetwork.shangzil.io
...
contract ERC2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Okami Network";
    ...
    uint256 public _maxTxAmount = 2500000 * 10**8;
    uint256 public _maxWalletSize = 2500000 * 10**8;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance>0 && _reduceTaxCountdown<15) {
