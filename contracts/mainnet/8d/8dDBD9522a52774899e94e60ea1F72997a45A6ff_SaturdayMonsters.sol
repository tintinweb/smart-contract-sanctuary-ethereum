...
contract SaturdayMonsters is ERC721A, Ownable {
    ...
    uint256 public max_per_wallet = 5000;

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("Saturday Monsters", "SM") {
