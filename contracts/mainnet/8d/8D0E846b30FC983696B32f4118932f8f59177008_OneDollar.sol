...
contract OneDollar
 is Context, IERC20, Ownable {
    ...
    string private _name = "ONE DOLLAR";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xF42A538a5F1bC245d90F9a8Aa434c485Db42f364));
        _anotherA = payable(address(0xF42A538a5F1bC245d90F9a8Aa434c485Db42f364));
