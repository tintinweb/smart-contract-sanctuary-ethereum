...
contract tyrantdog is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "tyrantdog";
    string constant _symbol = "TYD";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xad09657683B3DDf38F9148C4C6C160C5F1b89f43;
