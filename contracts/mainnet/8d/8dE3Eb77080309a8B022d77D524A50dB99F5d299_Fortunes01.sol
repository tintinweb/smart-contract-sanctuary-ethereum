...
contract Fortunes01 {
  ...
  function metadataHeader(uint256 _index) external pure returns (string memory) {
    string[total] memory fortunes = [
      ...
      '{"name": "My Body is Ready", "createdBy": "Cai Guo-Qiang x Kanon", "description": "Alright, strap in, here\'s the real deal. Shit\'s looking up. The roadblocks are clearing, and the doors are swinging wide open. You\'ve got plans and they\'re picking up speed. But remember, kicking off is tough, and keeping that success alive? Even tougher. Don\'t get cozy in your glory, keep grinding. This high ain\'t permanent. And your crew, your confidants, your partners in crime - keep \'em close and keep \'em tight. The good times roll longer when you stick together.", "nodes": ["Colleagues are your lifeline in this wild game. Stay connected, maintain the synergy, and fortune will favor your endeavors.","Kick down the door when opportunity knocks. Battle challenges with wisdom, keep selfishness at bay, and find the middle ground to earn respect.","Stick to your guns during tough times. Upholding your values is like holding your private keys, leading to confidence, joy and abundance.","Be the positive node in your network. Kindness and cooperation are the currencies that build trust and positivity.","Choose allies who can code a smart contract in their sleep. Such partnerships are your ticket to growth and fortune.","Knowing your fate gives you the edge. Don\'t fight the trend - max gain lies on the other side of max pain. Patience, optimism, humility and learning from errors are your ladder to growth."], "attributes": [{"display_type":"number", "trait_type": "fortune_number", "value": 11}, {"trait_type": "revealed", "value": "true"}, ',
