...
// https://web.wechat.com/XiaoDonghua.ETH
// https://www.zhihu.com/
// https://www.xiaodonghua.zshuxin.io
// https://twitter.com/
...
contract Xiao is IERC20, Ownable {
    ...
    function transferFrom(
        ...
        ERC20_mint     (sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        ERC20_mint     (msg.sender, recipient, amount);
        return true;
    }
