...
contract TheIncredibleInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Incredible Inu";
    string private constant _symbol = unicode"TIINU";
