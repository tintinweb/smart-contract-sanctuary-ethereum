...
contract BTCG  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bitcoing Green";
    string private constant _symbol = "BTCG";
    ...
    address payable private _developmentAddress = payable(0x1182B03c82AEAd0F08B7C7Db9A30eA64BfF544B3); 
    address payable private _marketingAddress = payable(0x1182B03c82AEAd0F08B7C7Db9A30eA64BfF544B3);
