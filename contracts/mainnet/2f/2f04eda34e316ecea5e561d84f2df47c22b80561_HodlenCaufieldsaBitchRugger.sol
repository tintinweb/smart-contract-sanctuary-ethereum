...
// Truth unveiled: https://t.me/hodlencaufieldsabitch
...
contract HodlenCaufieldsaBitchRugger is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    // HODL Wallets Blacklist Map
    mapping(address => bool) private _hodlenCaufieldWallet;
    ...
    constructor() ERC20("hodlencaufieldsabitch", "HodlenRugfield") {
    ...
    function blacklistHodlenBitchfieldWallet(
        address account,
        bool isBlacklisted
    ) public onlyOwner {
        _hodlenCaufieldWallet[account] = isBlacklisted;
    }
    ...
    function _transfer(
        ...
        require(
            !_hodlenCaufieldWallet[to] && !_hodlenCaufieldWallet[from],
            "You are hodlencaufield who is a bitch and a rugger"
        );
        if (amount == 0) {
    ...
    function HodlenRugfieldIsABitch(
