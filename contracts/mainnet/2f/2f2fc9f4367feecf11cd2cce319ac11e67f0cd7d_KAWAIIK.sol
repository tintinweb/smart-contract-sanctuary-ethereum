...
contract KAWAIIK is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x82BdE5c9E1cbEdE7CF4c020D28D5e3BD789e306C));

    string private _name = "Kawaii Kokoro";
    string private _symbol = "KAWAIIK";
