...
contract Flokichain is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Flokichain";
    ...
    address payable private _developmentAddress = payable(0x479ddbe3dDdDbe78a38Db81F160648F6f30740B8); 
    address payable private _marketingAddress = payable(0x479ddbe3dDdDbe78a38Db81F160648F6f30740B8);
