...
contract AirdropUSACOIN is Ownable {

    using SafeERC20 for IERC20;

    IERC20 public usacoin;
    uint256 public AMOUNT = 150000000000000000000;
    ...
    constructor(address _usacoin) {
        require(_usacoin != address(0), "INVALID_ADDRESS_NFT");
        usacoin = IERC20(_usacoin);
    }
    ...
    function claimTokens(bytes32[] calldata _proof, uint256 _quantity) external {
        require(claimActive, "CLAIM_NOT_ACTIVE");
        ...
        uint256 tokensToClaim = AMOUNT * _quantity;
        isClaimed[msg.sender] = true;
        usacoin.safeTransfer(msg.sender, tokensToClaim);
    }

    function claimUnclaimedTokens() external onlyOwner {
        usacoin.safeTransfer(owner(), usacoin.balanceOf(address(this)));
    ...
    function changeReward(uint256 _amountInWEI) external onlyOwner {
        AMOUNT = _amountInWEI;
    }
}