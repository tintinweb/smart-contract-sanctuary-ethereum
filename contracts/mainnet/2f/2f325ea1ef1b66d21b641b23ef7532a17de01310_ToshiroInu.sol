...
/*
 https://t.me/ToshiroInu
 https://ToshiroInu.info

TOSHIRO INU : Arrived here in order to have fun and enrich his holders.
...
contract ToshiroInu is Context, IERC20, Ownable {
    ...
    string private _name = "Toshiro Inu";
    ...
    function ApplyZeroFees() external onlyOwner() {
        _taxFee = 0;
        _liquidityFee = 0;
    }

    function ApplyHalfFees() external onlyOwner() {
        _taxFee = 1;
        _liquidityFee = 4;
    }


    function RestoreOriginalFee() external onlyOwner() {
        _taxFee = 2;
        _liquidityFee = 8;
    }
