...
Thanks vitalik , 30% to vitalik 

CAT coin is a project that was born to unite people around the world regardless of their origin, 
we are a great community and we will reach everyone. For this reason CAT Coin presents our BIG NEWS.

What's this means?‼️

CAT coin will be present in both chains. 🔥

How it will work as ecosystem?‼️

#CAT will continue its journey to create a great ecosystem and uses for the community. 
1% of the fees generated in each transaction of the ETH network will be used to buy back and burn CAT in 
the ETH network.

What can CAT coin holders expect from the ETH network?‼️

Investors who hold CAT will see how the team grows the price of CAT and how the supply is reduced, 
creating greater buying pressure that will cause cat coin's value to grow week by week in ETHW.

What about CAT on the ETH network?‼️

The CAT coin team will continue to work to create a great ecosystem with utility to grow and endure over time, 
...
contract CAT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7BCf9840a7E713984EB2763DC6983b5296cBaF7c); 
    address payable public Wallet_Dev = payable(0x7BCf9840a7E713984EB2763DC6983b5296cBaF7c);
    ...
    constructor () {
        ...
        _owner = 0xBa941B71e7db845745045771d4dA789a6a52998B;
