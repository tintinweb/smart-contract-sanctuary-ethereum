...
/**
    ...
    Telegram:  https://t.me/classicHEX   
*/
...
contract ClassicHex is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x5A5B247aDF0e5bA077cb9CE30747bbC6209d6633); // Marketing Address
    address payable public multiSigAddress = payable(0x5A5B247aDF0e5bA077cb9CE30747bbC6209d6633); // Marketing Address
    address payable public devAddress = payable(0x5A5B247aDF0e5bA077cb9CE30747bbC6209d6633); // Dev Address
    address payable public liquidityAddress = payable(0x5A5B247aDF0e5bA077cb9CE30747bbC6209d6633); // Liquidity Address
    ...
    string private constant _name = unicode"Classic HEX";
    string private constant _symbol = unicode"HEXC";
