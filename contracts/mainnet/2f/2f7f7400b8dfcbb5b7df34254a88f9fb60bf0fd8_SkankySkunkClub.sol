...
contract SkankySkunkClub is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://skankyskunkclub.mypinata.cloud/ipfs/QmPxMve4MwV3Sb4hQ6QjGBuxFgL1NJpR3p2XgsMuD4LHjz/unrevealed.json";
    bool public reveal = false;
    bool private endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 90000000000000000;
    ...
    constructor() ERC721("Skanky Skunk Club", "SSC") {
    }
