...
contract adroit is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmea2Ea7d7jKTVZutWE5vdCoqTzHdXBBAuB4duggfoYHLa";
    ...
    constructor(
    ) ERC721A("adroit Gallery", "AG", 100, maxSupply) {
    }
