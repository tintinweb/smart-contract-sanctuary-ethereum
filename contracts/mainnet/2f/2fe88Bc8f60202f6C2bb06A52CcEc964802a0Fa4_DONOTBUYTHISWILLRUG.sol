...
///THIS IS A TEST IN PROGRESS; DO NOT BUY YOU WILL GET RUGGED!
...
contract DONOTBUYTHISWILLRUG is ERC20, Ownable {
    ...
    ) public ERC20("DONOTBUYTHISWILLRUG", "DNBTWR") {
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> Liquinity swap when swap+liquify is triggered
