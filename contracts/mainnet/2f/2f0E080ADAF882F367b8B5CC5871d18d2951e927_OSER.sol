...
/*
        ...
        https://t.me/oSERportal

        https://twitter.com/OrdinalSerum
*/
...
contract OSER is ERC20, Ownable {
    ...
    constructor() ERC20("Ordinal Serum", "oSER") {
        ...
        swapTokensAtAmount = (totalSupply * 5) / 20000;
        ...
        marketingWallet = address(0x0fF4bBc27194EDDaE9864C4A751EE03337557e83);
    ...
    function updateMaxWalletAndTxnAmount(uint256 newTxnNum, uint256 newMaxWalletNum) external onlyOwner {
        require(
            newTxnNum >= ((totalSupply() * 5) / 10000000000000000) / 1e18,
            "Cannot set maxTxn lower than 0.5%"
        );
        require(
            newMaxWalletNum >= ((totalSupply() * 5) / 1000000000000000) / 1e18,
