...
contract Yetis is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint256 public  PRICE = 0.03 ether; //0.03 WL price 0.05 eth public sale
  ...
  uint private reserveNFTs=88;

  bool public _revelNFT = false;

  uint public whitelistSpots=333;
  ...
  constructor() ERC721A("Yetis","YETIS", MaxMintPerBatch_, TotalCollectionSize_) {

    _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/QmWe4c9oFf5okdF4UYJjQ4S3Deguzyady4G1pFSzmF6wWJ";
