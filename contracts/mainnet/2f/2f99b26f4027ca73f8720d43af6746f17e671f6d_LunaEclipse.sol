...
//https://t.me/LunaXportal

//Luna Eclipse is ramping up for astronomical burn events. $LUNA devs think the solution is to fork, however 
//forking will not create value. The only path forward is to burn $LUNA. 
//5% of our tax is designed to do such burns. Each Eclipse, we will burn $LUNA and $LUNAX. 
//Join the community movement, as we can only save ourselves.
...
contract LunaEclipse is ERC20, Ownable {
    ...
    constructor() ERC20("Luna Eclipse", "LUNAX") {
