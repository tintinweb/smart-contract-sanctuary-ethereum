 ...
 *
 * Abe represents the lost memories of a time when community was truly all that was needed for
 ...
 * telegram logo, or anything past the Abe contract itself.
 *
 * It is up to YOU, the individual, to bring glory and wealth back to the Abe name.
 *
 * All hail the Abe.
 *
 * telegram: https://t.me/+tyZfjQHEjKEyM2Fl
 */
...
// File: contracts/AbeInuToken.sol
pragma solidity ^0.8.13;

contract AbeInuToken is IERC20, ReentrancyGuard, Ownable {
