...
contract DoodsVerse is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmedDJCRuZW5Bpj433X6vZvcnf2Tk1KpXLNHLHFwRb2pn5";
    ...
    constructor(
    ) ERC721A("DoodsVerse", "Doods", 100, maxSupply) {
    }
