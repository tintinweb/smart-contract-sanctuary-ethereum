...
contract SAZUNO  is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SAZUNO INU";
    string private constant _symbol = "SAZ";
    ...
    uint256 constant private _taxFeeOnBuyFixed = 4;
    uint256 constant private _redisFeeOnSellFixed = 0;
    uint256 constant private _taxFeeOnSellFixed = 4;
