...
/**
  ...
  / _ \      / ____|                | |          / ____| |      (_) |       
 | | | |_  _| |     ___  _   _ _ __ | |_ ___ _ _| (___ | |_ _ __ _| | _____ 
 | | | \ \/ / |    / _ \| | | | '_ \| __/ _ \ '__\___ \| __| '__| | |/ / _ \
 | |_| |>  <| |___| (_) | |_| | | | | ||  __/ |  ____) | |_| |  | |   <  __/
  \___//_/\_\\_____\___/ \__,_|_| |_|\__\___|_| |_____/ \__|_|  |_|_|\_\___|
...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract CounterStrike is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("Counter Strike", "CS2") {
  }
  ...
  function treasuryMint(uint16 _mintAmount, address _receiver) external onlyOwner {
     uint16 totalSupply = uint16(totalSupply());
    require(totalSupply + _mintAmount <= maxSupply, "Exceeds max supply.");
  ...
  function  AirdropNFT(uint8 _amountPerAddress, address[] calldata addresses) external onlyOwner {
     uint16 totalSupply = uint16(totalSupply());
