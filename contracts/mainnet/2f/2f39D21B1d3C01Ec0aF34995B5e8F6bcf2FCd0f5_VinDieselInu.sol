...
contract VinDieselInu is ERC20, Ownable {
    ...
    constructor() ERC20("Vin Diesel Inu", "VDI") {
        ...
        marketingWallet = address(0xD05C3474525C666B526150B6FC62296d7a77E708); // deployer/marketing
        devWallet = address(0x0b3494F90D03A4AA99142FAF1CaDf73eFf4A1C68); // dev
