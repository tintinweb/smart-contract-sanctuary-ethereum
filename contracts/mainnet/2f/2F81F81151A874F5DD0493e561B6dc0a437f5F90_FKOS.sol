...
contract FKOS is ERC20, Ownable {
    constructor() ERC20("FKOS", "FKOS") {
    ...
    uint256 public HARD_CAP = 25 ether;
    ...
    uint256 public constant PRESALE_SUPPLY = 126126126126126 * 10 ** 18;
    ...
    /// update hard cap
    function updateHardCap(uint256 cap) external onlyOwner {
        require(cap >= 25 ether && cap <= 50 ether, "Bad cap");
        HARD_CAP = cap;
    }
