...
contract connectdot is ERC721A {
    ...
    constructor() ERC721A("./connect.dot", "connect") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeidmwe2mtmyrnlwhbjnpuhfttsctm3kntfuagm75pfo6jnadsrrsa4/", _toString(tokenId), ".json"));
    }
