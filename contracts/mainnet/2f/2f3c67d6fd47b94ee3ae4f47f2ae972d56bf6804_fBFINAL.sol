...
contract fBFINAL is BEP20, Ownable { 
    using SafeMath for uint256;
    ...
    constructor() BEP20("FIREBALL", "FB") { // 
        marketingWallet = payable(0x9372bFb3D91ddc3b313C3bE43D2Ac40255C8Dcdd); // 
        devWallet = payable(0x9372bFb3D91ddc3b313C3bE43D2Ac40255C8Dcdd); // 
