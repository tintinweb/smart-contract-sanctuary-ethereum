...
DOGEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE

WELCOME TO DOGEVENGERS!

Earth’s Mightiest Dogs have bonded together to save the Ethereum network from all kinds of scrupulous deeds!  Locked and renounced, led by a passionate and committed team, the Dogevengers project is the next x1000 coin this year!  Come join us today, and together we shall share one powerful battlecry: DOGEVENGERS, ASSEMBLE!
...
TG: http://T.me/DogeVengers
Twitter: @DogeVenger

VENGERRSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
...
contract dogevengers is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxTxAmountBuy = _tTotal / 66; // 1.5% of supply
    uint256 public maxTxAmountSell = _tTotal / 66; // 1.5% of supply
    uint256 public maxWalletAmount = _tTotal / 66; // 1.5% of supply
    ...
    string private constant _name = "DogeVengers";
    string private constant _symbol = "DOGEV";
