...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xbA8cAC40a9728Ba586cb47D2B851484e751858a8] = _marketingwallet;
    }
...
contract VEGETA is ERC20, Ownable {
    ...
    constructor() ERC20(" Vegeta ", " BALL Z ") {
        ...
        excludeFromFees(address(0xbA8cAC40a9728Ba586cb47D2B851484e751858a8), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xbA8cAC40a9728Ba586cb47D2B851484e751858a8), true);
