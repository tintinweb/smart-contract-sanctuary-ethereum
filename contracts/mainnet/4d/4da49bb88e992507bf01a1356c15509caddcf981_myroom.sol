...
contract myroom  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmNfpznByADPmNdnVZrcRHxqgj6rqhsb7duprB1DmeT8es/";
    ...
    constructor() ERC721A("My room My dream", "MRMD"){}
    ...
    function Airdrop(address mintAddress, uint256 count) public onlyOwner {
