...
contract DecentraBox is Context, IERC20, Ownable {
    ...
    uint256 private constant maxSwap = 90000000 * 10**_decimals;
    ...
    constructor() {
        ...
        marketingWallet = payable(0x4A476937959Da1a0b2af81001C3256f7f080aAAa);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x4A476937959Da1a0b2af81001C3256f7f080aAAa] = true;
