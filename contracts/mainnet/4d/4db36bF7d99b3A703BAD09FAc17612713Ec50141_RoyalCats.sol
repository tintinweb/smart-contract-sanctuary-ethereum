...
contract RoyalCats is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x375fBEADB2dabF28792f608d235b1ceA2DDC4ba1));

    string private _name = "Royal Cats";
    string private _symbol = "MEWO";
