...
/**
    ...
    It's been a challenging year for the cryptocurrency market, 
    especially compared to the previous year's bull run. 
    However, it's important to remember that market fluctuations are a 
    normal part of the industry and to maintain a long-term perspective. 

    Despite the current bear market, we can remain hopeful for recovery 
    and a better year ahead. In the meantime, it looks like the hashtag 
    #merrycrisis is trending on Twitter, so let's enjoy this moment and 
    make a banger out of it.

    The contract is 100% safe and unruggable when LP is locked.
    We will reduce the final tax to 3/3 and renounce ownership of the 
    contract.

    Happy holidays and here's to brighter years ahead for crypto!

        ⊛ https://t.me/MerryCrisisETH
        ⊛ https://twitter.com/MerryCrisisETH
        ⊛ https://medium.com/@merrycrisiserc/merry-crisis-and-happy-new-fear-c059eb720ddb
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract MerryCrisis is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Merry Crisis", "CRiSiS") {
