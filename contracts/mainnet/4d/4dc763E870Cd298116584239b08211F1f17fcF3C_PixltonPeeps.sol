 ...
 */
abstract contract PPERC721Enumerable is PPERC721, IERC721Enumerable {
    /**
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, PPERC721) returns (bool) {
...
abstract contract PPERC721 is Context, ERC165, IERC721, IERC721Metadata {
    using PPAddress for address;
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = PPERC721.ownerOf(tokenId);
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(PPERC721.ownerOf(tokenId), to, tokenId);
    }
