...
contract LilCrocodile is ERC721A, Ownable {
    string  public baseURI = "ipfs://QmPh6GcVNTGTkPAYTTa4dyWpVkCN61GPGueeeFVDmW8P4e/";
    ...
    function mint(uint32 amount) public payable callerIsUser{
        ...
        require(amount <= 25,"max 25 amount");
        require(msg.value >= (amount-freeNum) * cost,"not enough");
