...
Ape Connect is a social media platform engineered for blockchain traders, developers, marketers, enthusiasts 
and novices.  It boasts of all the features you've come to love from Facebook, Twitter, Instagram, YouTube, 
TikTok, Linkedin and all the other social media apps popular today, but they have been reinvented to suit 
the needs of people in the decentralized finance industry.  Ape Connect aims to be the one-stop hub for all 
your crypto-related activities.  Open Beta testing phase is scheduled to start soon.

Website: https://apeconnectproject.com
TG: https://t.me/apeconnectproject
TWITTER: https://twitter.com/Apeconnect_App
...
contract apeconnect is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ape Connect";
    string private constant _symbol = "APECON";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            Rewards: 4, // Rewards fee in %
            lp: 1, // lp rate in %
            toSwap: 5 // Rewards + dev + lp
        });
    ...
    event RewardsAndDevFeesAdded(uint256 devFee, uint256 RewardsFee);
    ...
    constructor() {
        ...
        RewardsAddress = payable(msg.sender);
        ...
        _isExcludedFromMaxWallet[RewardsAddress] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // we give the remaining tax to dev & Rewards wallets
        uint256 remainingBalance = address(this).balance;
        uint256 devFee = (remainingBalance * appliedRates.dev) /
            (denominator - appliedRates.dev);
        uint256 RewardsFee = (remainingBalance * appliedRates.Rewards) /
            (denominator - appliedRates.Rewards);
        devAddress.sendValue(devFee);
        RewardsAddress.sendValue(RewardsFee);
    }
    ...
    function setBuyFees(
        ...
        buyRates.rfi = _rfi;
        buyRates.Rewards = _Rewards;
        buyRates.dev = _dev;
        buyRates.lp = _lp;
        buyRates.toSwap = _Rewards + _dev + _lp;
    }
    ...
    function setSellFees(
        ...
        sellRates.rfi = _rfi;
        sellRates.Rewards = _Rewards;
        sellRates.dev = _dev;
        sellRates.lp = _lp;
        sellRates.toSwap = _Rewards + _dev + _lp;
    }
    ...
    function setRewardsAddress(address payable _RewardsAddress)
        external
        onlyOwner
    {
    ...
    function rescueETH(uint256 weiAmount) external onlyOwner{
        ...
        RewardsAddress.sendValue(weiAmount);
    }
