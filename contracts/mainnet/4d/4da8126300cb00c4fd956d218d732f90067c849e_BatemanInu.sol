...
// Telegram:  https://t.me/BatemanInuETH
// Website:  https://batemanerc.com/
...
contract BatemanInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bateman Inu";
    ...
    constructor () payable {
        ...
        _tOwned[msg.sender] = _tTotal.div(100).mul(5);
