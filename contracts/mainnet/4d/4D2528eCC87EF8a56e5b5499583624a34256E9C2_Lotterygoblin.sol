...
contract Lotterygoblin is ERC2981, ERC721A, Ownable {
    ...
    string public _metadataURI = "https://bucketlg.s3.us-east-2.amazonaws.com/json/";

    constructor() ERC721A("lotterygoblin", "LG") {
