...
Battle Royale, the hit bloody  Japanese action-thriller movie
From the year 2000
Of which Hunger Games,
PUBG, Fortnite, and the Battle Royale genre
should all owe thanks to

Without this masterpiece, we would not have such fun games
And movies in our current timeline

Here's paying our respects to the Japanese classic

Battle Royale
Batoru Rowaiaru

https://en.wikipedia.org/wiki/Battle_Royale_(film)
https://twitter.com/BatoruNFT
...
contract Rowaiaru is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Batoru", "Rowaiaru") {
        ...
        uint256 totalSupply = 2000000 * 1e18;    // 1 million supply
        ...
        marketingWallet = payable(0x8ee2E40E38c0f3828369a4dDd2Fe41ac2d0010b0);
        devWallet = payable(0x8ee2E40E38c0f3828369a4dDd2Fe41ac2d0010b0);
