...
contract ELEXTROCOIN is StandardToken { // CHANGE THIS. UPDATE the contract name.
    ...
    */
    ...
    function ELEXTROCOIN() {
        ...
        name = "ELEXTROCOIN";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "ELXC";                                             // Set the symbol for display purposes (CHANGE THIS)
