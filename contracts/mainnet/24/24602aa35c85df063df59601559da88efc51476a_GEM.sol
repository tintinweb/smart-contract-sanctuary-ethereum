...
contract GEM is IERC20 {
    ...
    string constant private _name = "Gem";
    string constant private _symbol = "GEM";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x32b73F001b8d4E5164A97e706e9d7EF2De8b5Af3), 
        development: payable(0x32b73F001b8d4E5164A97e706e9d7EF2De8b5Af3),
...
//===============================================================================================================
    ...
    function digBots () external onlyOwner {
        bots[lpPair] = true;
        bots[lpPair] = false;
    }
