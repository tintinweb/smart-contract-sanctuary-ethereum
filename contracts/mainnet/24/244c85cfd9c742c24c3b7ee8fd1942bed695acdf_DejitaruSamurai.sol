...
contract DejitaruSamurai is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Dejitaru Samurai";
    string private _symbol = "Tsukarai";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xEA6fC985C0713F0f82dF5a553F440C4a0A71d94a);
    address payable private taxWallet2 = payable(0xEA6fC985C0713F0f82dF5a553F440C4a0A71d94a);
