...
Lucifer - The Devils Dream

https://t.me/devilsdreameth
https://twitter.com/devilsdreameth
https://thedevilsdream.com
...
contract Lucifer is ERC20, Ownable {
    ...
    constructor() payable ERC20("The Devils Dream", "Lucifer") {
        ...
        if (block.chainid == 1) {
            ...
            _dexRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // ETH: Uniswap V2 GOERLI
        } else {
        ...
        maxSellAmount = (totalSupply * 20) / 1000; // 20%
        ...
        operationsAddress = address(0xB16530950250a4111a50BC81B541FBB87C0dF621);
