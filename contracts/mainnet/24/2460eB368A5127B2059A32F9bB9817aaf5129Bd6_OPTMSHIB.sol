...
contract OPTMSHIB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Optimus Shiba";
    string private constant _symbol = "OPTMSHIB";
    ...
    address payable private _developmentAddress = payable(0x030F1d34Dc6Afb42Bd6814E441C373e9d7E9B17D); 
    address payable private _marketingAddress = payable(0xeABE376017777E7Cc9e7D823cBc0635D0A58348b);
