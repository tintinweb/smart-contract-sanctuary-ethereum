...
I was once a diamond handed chad....No dip ever shook when F.U.D created entry...i made sure to buy the dip to keep the fudders from entry.
But now the jeets have gotten to me, a once proud chad now i panic at the first dip unsure if it will recover.
I think the time has come for me to step out of the shadows of jeetery and be forgiven.  
either invest or dont
no socials means no Blasphemy enjoy the ride.
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract Blasphemy is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Blasphemy";
    string private _symbol = "Forgiven";
    uint8 private _decimals = 18;
    uint256 private _supply = 1000000000;

    uint256 public buyTaxForLiquidity = 0;
    uint256 public buyTaxForMarketing = 2;
    uint256 public buyTaxForBurning = 0;
    uint256 public sellTaxForLiquidity = 0;
    uint256 public sellTaxForMarketing = 2;
    uint256 public sellTaxForBurning = 0;

    address public marketingWallet = 0x6F17E97F2261Fc39DbCc096fEa8459CF1dAc8e57;
