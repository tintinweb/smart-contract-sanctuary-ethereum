...
contract Frymates is ERC721A, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(_mintAmount + _numberMinted(msg.sender) <= maxMintAmount, "exceed the max limit");
    require(msg.value >= (cost * _mintAmount), "don't have enough eth");
