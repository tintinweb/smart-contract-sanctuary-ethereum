...
// 10% BUY/SELL
// Telegram/website will be made if adoption prevails
// Max buy/sell increases 2% every minute from launch
...
abstract contract MaxWalletDynamic {
    ...
    uint256 constant startMaxBuyPercentil = 10; // maximum buy on start 1000=100%
    uint256 constant maxBuyIncrementMinutesTimer = 1; // increment maxbuy minutes
    uint256 constant maxBuyIncrementPercentil = 20; // increment maxbuy percentil 1000=100%
    uint256 constant maxIncrements = 50; // maximum time incrementations
...
// File: contracts/ElonPunch.sol

pragma solidity ^0.8.7;

contract ELONPUNCH is TradableErc20, Withdrawable {
    constructor()
        TradableErc20("Elon Punch", "EPUNCH")
