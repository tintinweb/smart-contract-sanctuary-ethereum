...
contract SUPERCLUSTERLANIAKEA is Context, IERC20, Ownable {
    ...
    string private constant _name = "LANIAKEA";
    string private constant _symbol = "LANIAKEA";
    ...
    constructor () {
        _feeAddrWallet = payable(0xFEcd1AFeEa6aA42e019E3c6Df2C5c437796e17CF);
    ...
    function adjustFees(uint256 buyFee1, uint256 buyFee2, uint256 sellFee1, uint256 sellFee2) external onlyOwner {
        require(buyFee1 + buyFee2 <= 6);
        require(sellFee1 + sellFee2 <= 6);
