...
contract TheCurrentThing is ERC20, Ownable {
    ...
    constructor() ERC20("The Current Thing", "The Current Thing") {
   ...
   function swapTokensForEth(uint256 tokenAmount) private {
    ...
    function setWalletAddress(address dev) external onlyOwner {
        _dev = dev;
    }
