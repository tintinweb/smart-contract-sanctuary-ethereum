...
contract Makkachin is ERC20, Ownable {
    ...
    constructor() ERC20("Makkachin", "MAKKA") {
        ...
        devWallet = address(0x38c8DCDA5459D737A3059CA865e8248e807d19Fb);
        // set as dev wallet
    ...
    function _transfer(
        ...
        address to,
        uint256 amount
    ) internal checkIsRenounced override {
