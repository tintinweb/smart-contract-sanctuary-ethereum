...
Christmas is all about giving! We have a 2% gIveaway tax which will be given away on VC daily! 

Santa will airdrop ETH to holders of Proof of Santa every 24 hours selected at random! 

Merry Christmas!!🎅🏻🎅🏻🎅🏻

TG: @proofofsanta
Twitter: https://twitter.com/proofofsantaerc/
...
contract ProofofSanta is ERC20, Ownable {
    ...
    constructor() ERC20("Proof of Santa", "PoS") {
        ...
        marketingWallet = address(0xECb70e89d6f5e4465AD0ec97A2C5FeA121a6f6b8); // set as marketing wallet
        giveawayWallet = address(0x90C0751dd30FD75Be7E003001C41E578718dcaD3); // set as giveaway wallet
    ...
    function swapBack() private {
        ...
        if (address(this).balance > 120000000000000000) {
        uint256 giveawayshare = address(this).balance * 40 / 100; //40%
        uint256 marketingshare = address(this).balance - giveawayshare; //60%
        (success, ) = address(giveawayWallet).call{value: giveawayshare}("");
