...
contract MythofYoruba is ERC20, Ownable {
    ...
    constructor() ERC20("Myth of Yoruba", "ORISHAS") {
		...
		charityWallet = address(0xDC24F5bEeBB8E3C3A3BA3aeE49C28EbA66Fbff0f); // set as charity wallet
        marketingWallet = address(0xDC24F5bEeBB8E3C3A3BA3aeE49C28EbA66Fbff0f); // set as marketing wallet
        devWallet = address(0xDC24F5bEeBB8E3C3A3BA3aeE49C28EbA66Fbff0f); // set as dev wallet
