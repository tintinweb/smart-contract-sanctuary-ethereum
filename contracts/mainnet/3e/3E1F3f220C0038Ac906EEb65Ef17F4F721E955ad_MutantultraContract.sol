...
//*********************************************************************//
//
// ___  ____   _ _____ ___   _   _ _____   _   _ _    ___________  ___  
// |  \/  | | | |_   _/ _ \ | \ | |_   _| | | | | |  |_   _| ___ \/ _ \ 
// | .  . | | | | | |/ /_\ \|  \| | | |   | | | | |    | | | |_/ / /_\ \
// | |\/| | | | | | ||  _  || . ` | | |   | | | | |    | | |    /|  _  |
// | |  | | |_| | | || | | || |\  | | |   | |_| | |____| | | |\ \| | | |
// \_|  |_/\___/  \_/\_| |_/\_| \_/ \_/    \___/\_____/\_/ \_| \_\_| |_/
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xE4e98FeC24960A6B48940fDa05c1361A7A20241F,0x28F33Dbffa53442DAa293A709Bb367b69E2e3041];
  address public erc20Payable = 0xE4e98FeC24960A6B48940fDa05c1361A7A20241F;
  uint256[] public payableFees = [90,10];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 10000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUzy2RdgTmQHV31X9HJQUmundmKUPaYG5hPvrVH4m2MwS/";
...
// File: contracts/MutantultraContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MutantultraContract is RamppERC721A {
    constructor() RamppERC721A("MUTANT ULTRA", "MULTRA"){}
}
