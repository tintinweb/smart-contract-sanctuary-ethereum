...
/**
        ...
        "The Ankh are ready to lighten your path"

//  https://t.me/ANKHPortal
//  https://twitter.com/ANKHerc20
//  https://ankh.website/
...
contract KeyofLife is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Key of Life"; 
    string private constant _symbol = "ANKH"; 
    ...
    address payable private _developmentWalletAddress = payable(0xB4001BdB7959115C9dE3A4621f843D47e6A6a7a0);
    address payable private _marketingWalletAddress = payable(0xB4001BdB7959115C9dE3A4621f843D47e6A6a7a0);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(totalFees <= 30, "Must keep fees at 30% or less");
    }
