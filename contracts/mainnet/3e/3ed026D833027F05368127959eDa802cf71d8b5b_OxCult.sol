...
contract OxCult is Ownable, IERC20 {
    ...
    string constant private _name = "OxCult";
    string constant private _symbol = "OCX";
    ...
    constructor() {
        ...
        marketingWallet = 0xBD6e8Bd4c48D90a080f11345BA9436707B269e94;
        devWallet = 0xb09280675D9c566662DC0727cB5D636A22633BF1;
        nativeWallet = 0xFC22F963177B00A36b13d12E40492eD43235858d;

        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(nativeFee).add(devFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newDevFee, uint256 newNativeFee, uint256 extraSellFee) external onlyOwner {
        liquidityFee = newLiqFee;
        marketingFee = newMarketingFee;
        devFee = newDevFee;
        nativeFee = newNativeFee;

        totalFee = liquidityFee.add(marketingFee).add(devFee).add(nativeFee);
    ...
    function setFeeReceivers(address newMktWallet, address newDevWallet, address newLpWallet, address newNativeWallet) public onlyOwner{
