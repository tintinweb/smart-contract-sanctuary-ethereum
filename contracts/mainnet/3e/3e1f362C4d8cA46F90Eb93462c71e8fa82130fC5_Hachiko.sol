...
/* 
WEBSİTE : http://hachiko.guru

TWİTTER : https://twitter.com/Hachiko_erc20

TELEGRAM: https://t.me/HachikoErc20
**/
...
contract Hachiko is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"ハチ公";
    ...
    address payable private _developmentAddress = payable(0x4012f73C24589A1C2D1B8bd0D0EC822908e21CFd);
    address payable private _marketingAddress = payable(0x4012f73C24589A1C2D1B8bd0D0EC822908e21CFd);
