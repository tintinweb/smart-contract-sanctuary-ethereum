...
/**
The Yezo sika deer (Cervus nippon yesoensis, Japanese: エゾシカ / 蝦夷鹿,
 romanized: yezoshika, Ainu: ユク ) is one of the many subspecies of the sika deer.

https://t.me/ShikaPortal
https://twitter.com/ShikaErc20
https://medium.com/@shikaerc20

Shika token is an erc20 token relying on Japanese deer.
Supply 1000000000
Decimal 18
Max tx 2%
...
contract SHIKA is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("SHIKA", "SHIKA") { // 
        marketingWallet = payable(0xeCc2e811Df361b390BBabCE5C900e69c22b4BB96); // 
        devWallet = payable(0xeCc2e811Df361b390BBabCE5C900e69c22b4BB96); // 
