...
/*
TG LINK: https://t.me/BaphometDemon
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); 
...
contract sixsixsix is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BAPHOMET DEMON"; 
    string constant _symbol = "666"; 
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 666666666 * 10**_decimals; 
    ...
    uint256 public swapThreshold = _totalSupply * 66 / 10000;
    bool inSwap;
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base100) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base100 ) / 100;
    }
    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base100) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base100 ) / 100;
    }
    ...
    function setSwapBackSettings(bool _enabled, uint256 _amount) external authorized {
        ...
        swapThreshold = (_totalSupply * _amount / 1000);
    }
