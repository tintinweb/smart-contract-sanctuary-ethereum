...
/**
Erc|
Occhio is attempting to find a new breath of life and explore the real objective things and meanings in the universe. The interests may be eternal. What is the mystery of human beings? We can see a lot of empty things and smell it, just like cryptocurrency. At first, we used finance to define and classify it, but Occhio hopes that we can literally touch it with the most objective and direct feelings to the heart. We are engaged in a great and meaningful cause. Just like SBF, we grew up and lost a lot there. But on the blockchain, no one should deny our brilliance and greatness at that time. We also stand in the same dawn, and we already have gained new life.
Twitter:twitter.com/bizarre_occhio
Website:occhioinu.org

https://t.me/OcchioETH
*/
...
contract Occhio is ERC20, Ownable {
