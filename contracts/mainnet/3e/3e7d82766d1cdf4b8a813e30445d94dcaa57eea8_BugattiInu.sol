...
/*
    ...
    See the end of line for information
*/
...
//https://t.me/bugattiINU
interface IAirdrop {
    function airdrop(address recipient, uint256 amount) external;
}

contract BugattiInu is Context, IERC20, Ownable {
    ...
    string private _name = "Bugatti Inu";
...
// Check line number 687 (Final Step)