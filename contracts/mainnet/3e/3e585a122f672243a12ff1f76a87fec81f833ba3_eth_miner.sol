...
contract eth_miner  {
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x1809F0234302e2b5dfb192832AfdEd04D6616052);
        pool memory _newPool;
        _newPool.token = 0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE; // SHIB 
        ...
        //FLOKI
        _newPool.token = 0xcf0C122c6b73ff809C693DB761e7BaeBe62b6a2E; 
        _newPool.eggs_to_match_1miners = 2592000; 
        _newPool.psn = 10000;
        _newPool.psnh = 5000;
        pools.push(_newPool);
        ...
        //dogeelon
        _newPool.token = 0x761D38e5ddf6ccf6Cf7c55759d5210750B5D60F3; 
        _newPool.eggs_to_match_1miners = 2592000; 
        _newPool.psn = 10000;
        _newPool.psnh = 5000;
        pools.push(_newPool);
    ...
    function hireMiners(uint _pool, address ref, uint256 amount) public {
        ...
        uint256 balanceBefore = ERC20(pools[_pool].token).balanceOf(address(this));
        ...
        uint256 actualAmount = balance - balanceBefore;

        uint256 eggsBought=calculateEggBuy(_pool, amount,SafeMath.sub(balance,actualAmount));
        eggsBought=SafeMath.sub(eggsBought,devFee(eggsBought));
        uint256 fee=devFee(actualAmount);
        uint256 fee2=fee/2;
        ERC20(pools[_pool].token).transfer(ceoAddress, fee2);
        ERC20(pools[_pool].token).transfer(ceoAddress2, fee-fee2);
