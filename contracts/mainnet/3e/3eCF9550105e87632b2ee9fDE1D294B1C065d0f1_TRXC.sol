...
/**
    ...
    https://www.docdroid.net/owTRUU3/justin-pdf
...
contract TRXC is ERC20, Ownable {
    ...
    constructor() ERC20("TRX Classic", "TRXC") {
        ...
        uint256 totalSupply = 281961196 * 1e18;
        ...
        TreasuryAddress = address(0x97B92eF5c39D3c2f665cC7F7bbf5f2DCf6748420);
        RewardsAddress = address(0x97B92eF5c39D3c2f665cC7F7bbf5f2DCf6748420);
