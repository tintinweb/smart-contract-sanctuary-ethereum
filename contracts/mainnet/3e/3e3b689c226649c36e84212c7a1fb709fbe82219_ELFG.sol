...
/*
 0 Tax for as many goals qatar has scored
 Feel free to make a community tg
 Initially locked for 2 months every goal adds 1 month
...
contract ELFG is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ecuador LFG", "ELFG") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0x4EB9f25D4C6Fe6158C025DCe03b5cA8Cf2314633); // set as Marketing wallet
        DevWallet = address(0x4EB9f25D4C6Fe6158C025DCe03b5cA8Cf2314633); // set as dev wallet
