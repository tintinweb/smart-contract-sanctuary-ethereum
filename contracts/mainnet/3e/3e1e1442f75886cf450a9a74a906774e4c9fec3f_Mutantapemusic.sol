...
contract Mutantapemusic is ERC721A, Ownable {

    string public baseURI = "https://ipfs-storage.s3.amazonaws.com/mutantapemusic/";

    uint256 public tokenPrice = 30000000000000000; //0.005 ETH
    ...
    constructor() ERC721A("Mutantapemusic", "MAPE", 100, MAX_TOKENS) {
    }
