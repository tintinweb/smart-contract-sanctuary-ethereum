...
//
//     ____  __            __     ____              __ 
//    / __ )/ /___  ____  / /_   / __ \____  ____  / /_
//   / __  / / __ \/ __ \/ __/  / /_/ / __ \/ __ \/ __/
//  / /_/ / / /_/ / /_/ / /_   / ____/ /_/ / /_/ / /_  
// /_____/_/\____/\____/\__/  /_/    \____/\____/\__/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x96008F300a7BFD48933F217e3078216C03Ecc6c1];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUYk88BkZAB9jNzA6xRnCvTKCg6qhZzygQ9Z6YbMfrMzN/";
...
// File: contracts/BlootPootContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BlootPootContract is RamppERC721A {
    constructor() RamppERC721A("Bloot Poot", "FART"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/qtwWLfh8YCSNW0JO1KTx/contract-metadata";
    }
}
