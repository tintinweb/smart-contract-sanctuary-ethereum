...
/**
𝐒𝐡𝐢𝐧𝐨𝐨𝐟 𝐀𝐈❗ 𝐋𝐚𝐮𝐧𝐜𝐡𝐢𝐧𝐠 𝐨𝐧 𝐞𝐭𝐡𝐞𝐫𝐞𝐮𝐦 𝐧𝐞𝐭𝐰𝐨𝐫𝐤❗

𝐂𝐡𝐞𝐜𝐤 𝐬𝐨𝐜𝐢𝐚𝐥𝐬:

-𝐡𝐭𝐭𝐩𝐬://𝐰𝐰𝐰.𝐬𝐡𝐢𝐧𝐨𝐨𝐟𝐚𝐢.𝐜𝐨𝐦/
-𝐡𝐭𝐭𝐩𝐬://𝐭𝐰𝐢𝐭𝐭𝐞𝐫.𝐜𝐨𝐦/𝐬𝐡𝐢𝐧𝐨𝐨𝐟𝐚𝐢
-𝐡𝐭𝐭𝐩𝐬://𝐬𝐡𝐢𝐧𝐨𝐨𝐟𝐚𝐢.𝐦𝐞𝐝𝐢𝐮𝐦.𝐜𝐨𝐦/
-𝐡𝐭𝐭𝐩𝐬://𝐭.𝐦𝐞/𝐬𝐡𝐢𝐧𝐨𝐨𝐟𝐀𝐢𝐞𝐫𝐜
*/
...
contract ShinoofAI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Shinoof AI";
    string private _symbol = "SHINOOF";
    ...
    constructor () {
        ...
        blockw = payable(address(0x0E5a4d509F0C83163aDfBf6C268AAb343fF2F0AB));
    ...
    function enebleTrading() public onlyOwner{
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapPair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());
