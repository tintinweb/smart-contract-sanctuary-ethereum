...
contract KONG is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000 * 10 ** 8 * 10 ** 9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "KONG";
    string private _symbol = "KWRLD";
    ...
    uint256 public _maxBuyAmount = 15000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 5000000000000 * 10**9;
    uint256 private _largeSellNumOfTokens = 10000000000000 * 10**9;
    address public marketingWallet = 0x36850BE832CaF605f3Bf1ae19CB967e54976eB8D;
