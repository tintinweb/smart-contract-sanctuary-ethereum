...
contract Iccaruss is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x5307cd53B50Bd8FD674CfE2dFB832aD05e2B5eb3));

    string private _name = "Black Of Wings";
    string private _symbol = "Iccaruss";
