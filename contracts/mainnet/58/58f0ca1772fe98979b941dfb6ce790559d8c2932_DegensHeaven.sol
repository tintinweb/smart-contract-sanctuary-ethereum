...
Wouldn't we all just be okay with a 69X return? White paper/medium coming soon. Community run TG!
...
contract DegensHeaven is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"A Degens Heaven";
    string private constant _symbol = unicode"69X";
