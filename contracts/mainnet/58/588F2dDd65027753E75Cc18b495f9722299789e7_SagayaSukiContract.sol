...
/**
SagayaSuki is an AI powered P2E game and NFT marketplace

4/4 tax

Telegram :- t.me/sagayasuki
Twitter :- https://twitter.com/sagayasuki
Website :- https://sagayasuki.xyz
...
contract SagayaSukiContract is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 2e4 * 10**18;
    uint256 public maxSellLimit = 2e4 * 10**18;
    uint256 public maxWalletLimit = 2e4 * 10**18;
    uint256 public genesis_block;
    uint256 private deadline = 5;
    uint256 private launchtax = 45;
    address public marketingWallet = 0x3e599Ebd62671Fd7c1F97a6582E914acB3471006; 
    address public devWallet = 0x3e599Ebd62671Fd7c1F97a6582E914acB3471006;
    address public treasuryWallet = 0x4A49DFB1146e84d0a1784788A7ba777B3BA4A09B;
    ...
    Taxes public taxes = Taxes(19, 1, 0, 0);
    Taxes public sellTaxes = Taxes(19, 1, 0, 0);
    ...
    constructor() ERC20("SagayaSuki", "SASUKI") {
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity,  _treasury, _dev);
        require((_marketing + _liquidity + _treasury + _dev) <= 20, "Must keep fees at 20% or less");
    }
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity,  _treasury,  _dev);
        require((_marketing + _liquidity + _treasury + _dev) <= 45, "Must keep fees at 45% or less");
    }
