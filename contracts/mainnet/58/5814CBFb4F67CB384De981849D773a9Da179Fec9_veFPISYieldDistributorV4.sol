...
// File contracts/Curve/IveFPIS.sol
...
// File contracts/Staking/veFPISYieldDistributorV4.sol
...
contract veFPISYieldDistributorV4 is Owned, ReentrancyGuard {
    ...
    function earned(address account) public view returns (uint256) {
        ...
        // If the amount of veFPIS increased, only pay off based on the old balance
