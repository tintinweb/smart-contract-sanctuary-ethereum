    ...
    IERC721xHelper
{
    ...
    function getNextBreed(uint256 genesisTokenId)
        public
        view
        returns (uint256)
    {
        ...
        uint256 waitSeconds = (BREED_PER_SECONDS * (alreadyBreedCount + 1)) - holdingForSeconds;
    ...
    function getCanBreedCountMultiple(uint256[] calldata tokenIds)
        external
        view
    ...
    function getNextBreedMultiple(uint256[] calldata tokenIds)
        external
        view
        returns (uint256[] memory)
    {
    ...
    function getCurrentTime() view external returns (uint256) {
