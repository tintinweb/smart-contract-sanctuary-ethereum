...
/*
“If you hype, I'll unplug it. I hate you, you miscarriages can do it yourself, why should I open a TG. 
If you fud properly you will get a website and a twitter open at most. Hatred and envy is the strongest energy. 
Use them to moon this token. Fuck hype, I want to see and feel FUD.”
*/
...
contract FearUncertaintyDoubt is Context, IERC20, Ownable {
    ...
    constructor () {
        _FourWallet = payable(0x22d26d25F29B93d9eF33555a5a21CC78582F411C);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0x22d26d25F29B93d9eF33555a5a21CC78582F411C);
        ...
        emit Transfer(address(0xEF017AF2A4399175D90bFc6c283C06e83A23f974), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 2e8 * 10**9;
        _maxSellAmount = 2e8 * 10**9;
    ...
    function setBuyFee(uint256 buyFourFee, uint256 buyLiquidityFee, uint256 buyRewardFee) external onlyOwner {
        require(buyFourFee + buyLiquidityFee + buyRewardFee <= 10, "Must keep buy taxes below 30%");
    ...
    function setSellFee(uint256 sellFourFee, uint256 sellLiquidityFee, uint256 sellRewardFee) external onlyOwner {
        require(sellFourFee + sellLiquidityFee + sellRewardFee <= 10, "Must keep sell taxes below 60%");
