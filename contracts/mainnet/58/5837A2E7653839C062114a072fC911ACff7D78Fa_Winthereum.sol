...
contract Winthereum is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Winthereum";
    string private constant _symbol = "WINTH";
    ...
    address payable private _developmentAddress = payable(0xE96B187c7304edEEF6073568193A25A908938553); 
    address payable private _marketingAddress = payable(0xE96B187c7304edEEF6073568193A25A908938553);
