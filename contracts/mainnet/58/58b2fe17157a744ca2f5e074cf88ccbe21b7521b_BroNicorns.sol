...
contract BroNicorns is ERC721A, Ownable {
    using Strings for uint256;
    string private baseURI;
    string public hiddenMetadataUri;
    uint256 public price = 0.00555 ether;
...
constructor() ERC721A("BroNicorns", "BRO") {
        setHiddenMetadataUri("https://api.bronicorns.fun/");
        setBaseURI("https://api.bronicorns.fun/");
    }

    function mint(uint256 count) external payable {
    require(mintEnabled, "BRO, Mint not live yet!");
      uint256 cost = price;
      bool isFree =
      ...
      require(totalSupply() + count <= maxSupply, "No more BRO");
    ...
    function MintVIP(address to, uint256 quantity)public onlyOwner{
