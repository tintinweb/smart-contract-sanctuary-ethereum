...
/*
The Federal Reserve said it will launch its long-awaited instant payment service FedNow

Telegram: https://t.me/FedNowInu
...
contract FedNowInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "FedNow Inu"; 
    string private constant _symbol = "FNI"; 
    ...
    address payable private _developmentWalletAddress = payable(0xa095b9ed10d3F2A7De2619c8312EaB3B1283aC17);
    address payable private _marketingWalletAddress = payable(0xa095b9ed10d3F2A7De2619c8312EaB3B1283aC17);
