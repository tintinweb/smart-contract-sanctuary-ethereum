...
contract UmiHime is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "UMI HIME";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xfA45491233188766A76AB1b4c170e153A5d7DcE9));
        _metawallet = payable(address(0xfA45491233188766A76AB1b4c170e153A5d7DcE9));
