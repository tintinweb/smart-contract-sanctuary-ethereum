...
💸Cents to Million Coin💸
Burned LP
1/1 Tax

 TG: https://t.me/CentsToMilionErc
*/
...
contract Millionaire is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cents to Million";
    string private constant _symbol = "CTM";
    ...
    address payable private _developmentAddress = payable(0x8D6e5958940847c126E807CdFEEDf631A462806B); 
    address payable private _marketingAddress = payable(0x8D6e5958940847c126E807CdFEEDf631A462806B);
