...
contract TALEBONE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Tale Of Bone";
    string private constant _symbol = "TALEBONE";
    ...
    address payable private _developmentAddress = payable(0x031AC5645C70FD236b4751C6224aA5C639F8237f); 
    address payable private _marketingAddress = payable(0x7923e933463D2517662eb2d9BDEE4F84a914a86B);
