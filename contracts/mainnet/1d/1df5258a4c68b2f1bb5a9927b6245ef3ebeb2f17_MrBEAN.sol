...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc25aa1b0314e8F52AaC9C7a6dB57862aa9975C52;
...
contract MrBEAN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc25aa1b0314e8F52AaC9C7a6dB57862aa9975C52;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Mr Bean";
    string private _symbol = "MRBEAN";
