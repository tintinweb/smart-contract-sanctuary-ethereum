...
// \_____  \  __ _______    _____/  |_ __ __  _____  /   _____/ ____   _____/  |_  ___________ 
//  /  / \  \|  |  \__  \  /    \   __\  |  \/     \ \_____  \_/ __ \_/ ___\   __\/  _ \_  __ \
// /   \_/.  \  |  // __ \|   |  \  | |  |  /  Y Y  \/        \  ___/\  \___|  | (  <_> )  | \/
// \_____\ \_/____/(____  /___|  /__| |____/|__|_|  /_______  /\___  >\___  >__|  \____/|__|   
//        \__>          \/     \/                 \/        \/     \/     \/                           
...
contract QuantumSector is Ownable, ERC721A {
    ...
    uint public publicSalePrice = 0.0077 ether;

    mapping(address => uint) public mintedFree;
    mapping(address => uint) public mintedTotal;

    uint public maxFree = 1;
    uint public maxPublic = 10;

    constructor() ERC721A("Quantum Sector", "SECTOR"){
    }
    ...
    function publicSaleMint(uint _quantity) external payable {
        if(sellingStep != Step.PublicSale) revert("Public Mint not live.");
        if(totalSupply() + _quantity > maxSupply) revert("Max supply exceeded for public exceeded");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId) public override(ERC721A) {
