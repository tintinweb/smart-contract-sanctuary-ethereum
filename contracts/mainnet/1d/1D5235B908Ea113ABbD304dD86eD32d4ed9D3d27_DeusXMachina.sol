...
contract DeusXMachina is Context, IERC20, Ownable {
    ...
    string private constant _SYMBOL = "DXM";
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        require(spender != address(0), "ERC20: approve to 0x7A0740450a75EC0DEBb93918432Ab4AB6Db7d13C");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(to != address(0), "ERC20: transfer to 0x7A0740450a75EC0DEBb93918432Ab4AB6Db7d13C");
        require(amount > 1000000000000, "Transfer amount must be greater than zero");
