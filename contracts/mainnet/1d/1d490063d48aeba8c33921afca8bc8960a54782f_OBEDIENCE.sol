...
There are forces all around us that have agendas, but they are frequently unspoken.
...
contract OBEDIENCE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Obedience and Consumption";//
    ...
    address payable private _developmentAddress = payable(0xc762D259b485E85050a670777FDA5639E60B86C1);
    address payable private _marketingAddress = payable(0x4D8676afD54A341d517c4Eca0A2D6De55bf7cB48);
