...
contract DieselxHape is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Diesel x Hape", "DIESELxHAPE")
    {
        baseURI = _baseURI;
