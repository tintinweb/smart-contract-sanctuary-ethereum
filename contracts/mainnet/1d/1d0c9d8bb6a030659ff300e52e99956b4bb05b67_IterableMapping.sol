...
contract GrowCropCorpToken is Ownable, ERC20 {
    ...
    // Base taxes
    CustomTaxPeriod private _base = CustomTaxPeriod("base", 0, 0, 2, 4, 1, 4, 2, 3, 1, 4, 2, 5);
    ...
    event FeesApplied(uint8 liquidityFee,uint8 operationsFee,uint8 buyBackFee,uint8 treasuryFee,uint8 holdersFee,uint8 totalFee);
    ...
    function _setCustomSellTaxPeriod(CustomTaxPeriod storage map,uint8 _liquidityFeeOnSell,uint8 _operationsFeeOnSell,uint8 _buyBackFeeOnSell,uint8 _treasuryFeeOnSell,uint8 _holdersFeeOnSell) private {
    ...
    function _setCustomBuyTaxPeriod(CustomTaxPeriod storage map,uint8 _liquidityFeeOnBuy,uint8 _operationsFeeOnBuy,uint8 _buyBackFeeOnBuy,uint8 _treasuryFeeOnBuy,uint8 _holdersFeeOnBuy) private {
    ...
    function _swapAndLiquify() private {
        ...
        uint256 amountETHHolders = ETHBalanceAfterSwap - (amountETHLiquidity + amountETHBuyBack + amountETHOperations + amountETHTreasury);
