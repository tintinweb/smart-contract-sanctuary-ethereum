...
/*
 ______  _______ _____  ______  _    __    ______   ______   ______ 
/ |        | |    | |  | |     | |  / /   / |  | \ | |  \ \ | |     
'------.   | |    | |  | |     | |-< <    | |  | | | |  | | | |---- 
 ____|_/   |_|   _|_|_ |_|____ |_|  \_\   \_|__|_/ |_|  |_| |_|____ 
...
contract StickOne is ERC721A, TheOperatorFilterer {
    ...
    function getStick(uint256 amount) payable public {
    ...
    constructor() ERC721A("Stick One", "Stick") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.003 ether;
        maxSupply = 799;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmWDYWqCoaymjJtBHjgZLoJhuzyKYAnGTtvp3VGVBKBsWw/", _toString(tokenId), ".json"));
    }
