...
Movement fighting for individual privacy, developing WEB 3.0 decentralized Anonymous Chain for increased browsing privacy and security.

Tax: 4/4


Website: http://www.annon.network/ < DAPP
Telegram: https://t.me/annon_chain
...
contract AnonymousChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Anonymous Chain";
    string private constant _symbol = "ANNONC";
    ...
    address payable private _developmentAddress = payable(0x34e5c8Ef771177f969AFbb9DEC5e6AdCD57e0766); 
    address payable private _marketingAddress = payable(0x34e5c8Ef771177f969AFbb9DEC5e6AdCD57e0766);
