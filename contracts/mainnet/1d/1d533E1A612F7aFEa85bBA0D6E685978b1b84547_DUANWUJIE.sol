...
“I cast my net into the sea of community… 
There will come a time where we all will sit peacefully, here.…”

https://t.me/DuanwuJiePortal
...
contract DUANWUJIE is ERC20, Ownable {

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;

    string private _name = "Duanwu Jie";
    string private _symbol = "JIE";

    TransferHelper private transferHelper;
    
    constructor() {
        _totalSupply = 22_006_023 * (10 ** decimals());
