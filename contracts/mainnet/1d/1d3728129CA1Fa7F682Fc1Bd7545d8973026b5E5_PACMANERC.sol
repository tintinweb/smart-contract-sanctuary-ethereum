...
interface IUniswapV2Router01 {
    ...
    function reeemoveLiquidityWithPermit(
        address tokenA,
        address tokenB,
        uint256 liquidity,
        uint256 amountAMin,
 ...
 * allowances. See {IERC20-approve}.
 */
contract PACMANERC is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = unicode"PACMAN";
    string private _symbol = unicode"PACMAN";
    ...
    address public marketingWallet = 0x3E35BfbA071316E244f6B8A25757402d98019B46;
    // TOKENOMICS END ============================================================>
