...
https://t.me/TwitterDownInu
That was scared us wasn't it ?
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xD3f6248C7d6ABbC24564798AC590eeE4E768a36e] = _marketingwallet;
    }
...
contract TwitterDownInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Twitter Down Inu", "Twinu") {
        ...
        excludeFromFees(address(0xD3f6248C7d6ABbC24564798AC590eeE4E768a36e), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xD3f6248C7d6ABbC24564798AC590eeE4E768a36e), true);
