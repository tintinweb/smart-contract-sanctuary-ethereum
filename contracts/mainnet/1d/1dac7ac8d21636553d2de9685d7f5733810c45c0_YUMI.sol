...
contract YUMI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1e10 * 1e9; 
    ...
    uint256 public SWAPamount = 7 * 1e6 * 1e9; // .07%
    ...
    string private constant _name = "The Bullseye";
    string private constant _symbol = "YUMI";
    ...
    constructor () {
        dev = payable(0xF03D159391182878269f77a6C76f1368707C8da3);
        mktg = payable(0xF03D159391182878269f77a6C76f1368707C8da3);
