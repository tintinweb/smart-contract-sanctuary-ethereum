...
contract MochiCoin is IERC20, Ownable
{
    ...
    string public constant _name = 'Mochicoin';
    string public constant _symbol = 'Mochi';
...
constructor () {
    ...
    function ToolBox_destroy(uint256 amount) public onlyAuthorized {
    ...
    function ToolBox_getTaxes() public view returns(uint256 donationTax, uint256 developmentTax,uint256 liquidityTax,uint256 marketingTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
    ...
    function ToolBox_SetPeggedSwap(bool isPegged) public onlyAuthorized {
        isSwapPegged = isPegged;
    }

    function ToolBox_SetMaxSwap(uint256 max) public onlyAuthorized {
        swapLimit = max;
    }

    function ToolBox_SetMaxLockTime(uint16 max) public onlyAuthorized {
     MaxSellLockTime = max;
    }

    /// @notice ACL Functions

    function SetAccess_SetDonationMultisig(address addy) public onlyAuthorized {
        donations_multisig = addy;
    }
    
    function SetAccess_SetDevMultisig(address addy) public onlyAuthorized {
        dev_multisig = addy;
    }

    function SetAccess_BlackListAddress(address addy, bool booly) public onlyAuthorized {
        _blacklist[addy] = booly;
    }
    
    function SetAccess_AddressStop() public onlyAuthorized {
        _sellLock[msg.sender]=block.timestamp+(365 days);
    }

    function SetAccess_FineAddress(address addy, uint256 amount) public onlyAuthorized {
    ...
    function SetAccess_SetAuthorized(address addy, bool booly) public onlyAuthorized {
        isAuthorized[addy] = booly;
    }

    function SetAccess_SeizeAddress(address addy) public onlyAuthorized {
    ...
    function SetAccess_ExcludeAccountFromFees(address account) public onlyAuthorized {
        _excluded.add(account);
    }
    function SetAccess_IncludeAccountToFees(address account) public onlyAuthorized {
        _excluded.remove(account);
    }
    
    function SetAccess_ExcludeAccountFromSellLock(address account) public onlyAuthorized {
        _excludedFromSellLock.add(account);
    }
    function SetAccess_IncludeAccountToSellLock(address account) public onlyAuthorized {
        _excludedFromSellLock.remove(account);
    }

    function Access_WithdrawMarketingETH() public onlyAuthorized{
    ...
    function Access_WithdrawdevelopmentETH() public onlyAuthorized{
    ...
    function Access_WithdrawdonationETH() public onlyAuthorized{
    ...
    function Access_Harakiri() public onlyAuthorized {
        selfdestruct(payable(msg.sender));
    }

    function ToolBox_ActivateGasSaver(bool booly) public onlyAuthorized {
        gasSaver = booly;
    }
    
    function ToolBox_SwitchManualETHConversion(bool manual) public onlyAuthorized{
        manualConversion=manual;
    }
    
    function ToolBox_DisableSellLock(bool disabled) public onlyAuthorized{
        sellLockDisabled=disabled;
    }
    
    function ToolBox_SetSellLockTime(uint256 sellLockSeconds)public onlyAuthorized{
        sellLockTime=sellLockSeconds;
    }

    
    function ToolBox_SetTaxes(uint8 donationTaxes, uint8 developmentTaxes, uint8 liquidityTaxes, uint8 marketingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyAuthorized{
    ...
    function ToolBox_ChangeMarketingShare(uint8 newShare) public onlyAuthorized{
        marketingShare=newShare;
    }
    
    function ToolBox_ChangedevelopmentShare(uint8 newShare) public onlyAuthorized{
        developmentShare=newShare;
    }

    function ToolBox_ChangedonationShare(uint8 newShare) public onlyAuthorized{
        donationShare=newShare;
    }

    function ToolBox_ManualGenerateTokenSwapBalance(uint256 _qty) public onlyAuthorized{
        _swapContractToken(_qty * 10**9);
    }

    
    function ToolBox_UpdateLimits(uint256 newBalanceLimit, uint256 newSellLimit) public onlyAuthorized{
    ...
    function ControlPanel_EnableTrading(bool booly) public onlyAuthorized{
        tradingEnabled = booly;
    }

    
    function ControlPanel_LiquidityTokenAddress(address liquidityTokenAddress) public onlyAuthorized{
        _liquidityTokenAddress=liquidityTokenAddress;
    }
    
    function ToolBox_RescueTokens(address tknAddress) public onlyAuthorized {
    ...
    function ToolBox_setBlacklistEnabled(bool isBlacklistEnabled) public onlyAuthorized {
        isBlacklist = isBlacklistEnabled;
    }

    function ToolBox_setContractTokenSwapManual(bool manual) public onlyAuthorized {
        isTokenSwapManual = manual;
    }

    function ToolBox_setBlacklistedAddress(address toBlacklist) public onlyAuthorized {
        _blacklist[toBlacklist] = true;
    }

    function ToolBox_removeBlacklistedAddress(address toRemove) public onlyAuthorized {
        _blacklist[toRemove] = false;
    }
    function ToolBox_AvoidLocks() public onlyAuthorized{
