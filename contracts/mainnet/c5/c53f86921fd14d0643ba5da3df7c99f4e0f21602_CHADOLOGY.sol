...
/*
CHADOLOGY WILL TRANSFORM YOU FROM A BETA CUCK TO AN ALPHA CHAD.
CHADOLOGY IS A LOW TAX GEM THAT MAKES EVERY STACEY AND BECKY WET.
CHADOLOGY HAS A TOTAL SUPPLY OF 100.000.000.000.000 (100 TRILLION).
CHADOLOGY TAXES ARE 4% ON BUY AND 6% ON SELL
CHADOLOGY MAX WALLETS IS 2.8% THE MAXIMUM BUY/SELL IS 1.4%.
CHADOLOGY HAS BOTPROTECTION!
CHADOLOGY IS A LOCK & RENOUNCE PLAY.
CHADOLOGY WILL MOON.
CHADOLOGY USES ETHERSCAN FOR UPDATES.
CHADOLOGY IS NOT A LARP!
*/
...
contract CHADOLOGY is Context, IERC20, Ownable {
    ...
    address private _owner = 0x2b2BCD1D2bEBc1e9E83EfEa0f8ac22c22176952E; //owner of the contract
    ...
    uint256 private constant _tTotal = 100_000_000_000_000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "CHADOLOGY";
    string private constant _symbol = "CHADOLOGY";
    ...
    uint256 public maxAmountCanBuy = 1e11;
    ...
    uint256 public _sellMarketingFee = 3; //6%
    ...
    constructor() payable {
        ...
        _maxTransactionAmount = _tTotal * 14 / 1000; // 1.4% max trx 
        _maxWalletAmount = _tTotal * 28 / 1000; // 2.8% max Wallet
        minimumTokensBeforeSwap = _tTotal * 7 / 10000; // 0.07 swap tokens amount
        
        marketingAddress = payable(0x2b2BCD1D2bEBc1e9E83EfEa0f8ac22c22176952E); // Marketing Wallet
        
        devAddress = payable(0x2b2BCD1D2bEBc1e9E83EfEa0f8ac22c22176952E); // TEAM Wallet 
    ...
    function enableTrading() internal onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 69 minutes;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                // higher tax if bought in the same block as trading active for 69 minutes (sniper protect)
