...
contract Dragoons is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmVsCbARYZVN4LvTkYZZkKBtaASyieDhQUU636KPrt2LZ6/";
    uint256 public constant MAX_MINT_PER_ADDR = 10;
    uint256 public constant MAX_FREE_MINT_PER_ADDR = 3;
    uint256 public PUBLIC_PRICE = 0.003 * 10**18;
    uint256 public constant MAX_SUPPLY = 888;
    uint256 public constant FREE_MINT_SUPPLY = 100;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("Dragoons", "DG") {
        baseURI = initBaseURI;
