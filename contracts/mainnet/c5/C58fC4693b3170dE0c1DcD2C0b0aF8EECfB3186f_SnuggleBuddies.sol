...
contract SnuggleBuddies is ERC721Enumerable, Ownable {
  ...
  uint public tokenReserve = 33;

  address public proxyRegistryAddress;
  mapping(address => uint256) private allowance;
  string public baseURI;
    
  constructor() ERC721("Snuggle Buddies", "SNUGBUDS") {
    setBaseURI("https://blam.io/api/snuggle-buddies/lm/");
  ...
  function withdraw() public onlyOwner {
    ...
    address payoutAddress3 = payable(0x81b5162AdD600560CF575AD49db3e1B7fB98736D);
    uint256 payoutPayment3 = balance.mul(10).div(100);
