...
contract QCXC is ERC20, Ownable {
    ...
    constructor() ERC20("QuadrigaCX Classic", "QCXC") {
		...
		charityWallet = address(0xa9d16B0b545cfE311CfC2FdcD49B502814df4525); // set as charity wallet
        marketingWallet = address(0xa9d16B0b545cfE311CfC2FdcD49B502814df4525); // set as marketing wallet
        devWallet = address(0xa9d16B0b545cfE311CfC2FdcD49B502814df4525); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 12, "Max BuyFee 12%");
