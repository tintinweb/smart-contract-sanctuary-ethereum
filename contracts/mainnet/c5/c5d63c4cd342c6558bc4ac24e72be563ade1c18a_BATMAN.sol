...
contract BATMAN is ERC20, Ownable {
    ...
    constructor() ERC20("Gotham Knights", "BATMAN") {
     ...
     uint256 totalSupply = 9 * 10 ** 5 * 10 ** decimals();
 
        maxTransactionAmount = 18 * 10 ** 3 * 10 ** decimals(); 
        maxWallet = 18 * 10 ** 3 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0x44C4B708559536a095bd93835828b4E86f845193); // set as Marketing wallet
        DevWallet = address(0x44C4B708559536a095bd93835828b4E86f845193); // set as dev wallet
