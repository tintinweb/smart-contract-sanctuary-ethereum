...
contract OCB is ERC721A {

    mapping (address => uint8) public _minted;

    uint public salePrice = 80000000000000000;
    uint public charityPaymentProcent = 99;
    uint16 public maxSupply = 22222;
    uint8 public maxPerTx = 10;
    uint8 public maxPerWallet = 10;
    string public baseURI = "https://ipfs.io/QmY1J3HR5By2DrsxwZnJBvLTu8S3CAygwPYMeuNHAsfYzz/";
    bool public publicMintStatus = true;
    address public withdrawAddress = 0x165CD37b4C644C2921454429E7F9358d18A45e14; 
    ...
    function setCharityPaymentProcent(uint amount) external onlyOwner {
        charityPaymentProcent = amount;
    }
    ...
    function mintReserve(uint8 amount) external onlyOwner {
    ...
    function charityWithdraw() external onlyOwner {
        payable(withdrawAddress).transfer(address(this).balance * charityPaymentProcent/100);
    }

    constructor() ERC721A("OccupierBalls", "OCB") {
        owner = msg.sender;
    }
