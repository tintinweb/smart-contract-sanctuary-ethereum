...
https://t.me/boredbuilder
https://twitter.com/boredbuildereth
https://t.me/boredbuilderbot
*/
...
contract BoredBuilder is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Bored Builder';
    string private constant _symbol = 'BORB';
    ...
    address internal constant development_receiver = 0x58755D6BE7fEf2f64EC0580213f537C7A6952D53; 
    address internal constant marketing_receiver = 0x58755D6BE7fEf2f64EC0580213f537C7A6952D53;
    address internal constant liquidity_receiver = 0x58755D6BE7fEf2f64EC0580213f537C7A6952D53;
    ...
    function setisBot(address[] memory _address, bool _enabled) external onlyOwner { for (uint i = 0; i < _address.length; i++) { isBot[_address[i]] = _enabled; }}
