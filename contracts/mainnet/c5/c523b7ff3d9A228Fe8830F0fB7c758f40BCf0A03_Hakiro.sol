...
contract Hakiro is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint private constant MAX_PUBLIC = 1111;
    uint private constant MAX_WL = 1111;

    uint public wlSalePrice = 0.0045 ether;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, address _signerAddressWL, string memory _baseURI) ERC721A("Hakiro", "HAKIRO")
