...
/**
There is  Dejitaru Tsuka
There is Kanagawa Nami (Okinami)
AND THIS IS OKITSUKA 
...
contract Dejitarunami is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Dejitarunami";
    string private _symbol = "Okitsuka";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x4eA931128fE50d4efF694636EbA44add5eA194c9);
    address payable private taxWallet2 = payable(0x4eA931128fE50d4efF694636EbA44add5eA194c9);
