...
/**
 * 
TELEGRAM : https://t.me/Y_Protocol
...
contract Y is IERC20, Ownable {
    ...
    uint256 _maxSellTxAmount = (_totalSupply * 5) / 100;
    ...
    address payable public liquidityFeeReceiver = payable(0x3e1A4b757D1ecCF6703c4922FD476DA39d69695e);
    address payable public marketingFeeReceiver = payable(0x3e1A4b757D1ecCF6703c4922FD476DA39d69695e);
