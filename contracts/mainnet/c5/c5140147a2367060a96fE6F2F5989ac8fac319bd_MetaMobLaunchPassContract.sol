...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x881b32052DB71C81DeB190862925A1b1EB297d6a];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 500;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 1500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXkV2Ru7DnRhLaj4jPt1Tnb5Fki8hsCBsZrKFRuT3uwjG/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1500");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1500");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1500");
...
// File: contracts/MetaMobLaunchPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MetaMobLaunchPassContract is RamppERC721A {
    constructor() RamppERC721A("MetaMob Launch Pass", "METAMOB"){}
}
