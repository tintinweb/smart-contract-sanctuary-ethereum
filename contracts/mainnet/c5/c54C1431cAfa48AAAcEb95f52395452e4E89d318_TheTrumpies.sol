...
// File: contracts/TheTrumpies.sol
...
contract TheTrumpies is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeidfhhnn5ic5r7bflghak5sotyvvaun57clwgymmsz7d2dnc3whbwy/";
    uint   public price             = 0.002 ether;
    uint   public maxPerTx          = 10;
    uint   public maxPerFree        = 1;
    uint   public maxPerWallet      = 31;
    uint   public totalFree         = 2420;
    uint   public maxSupply         = 2420;
    ...
    constructor() ERC721A("The Trumpies", "TRUMP"){}
