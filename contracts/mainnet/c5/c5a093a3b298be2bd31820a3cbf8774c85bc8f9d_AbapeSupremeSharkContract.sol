...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1611cF31236Ea828E8B174C98A43c3f9f08746A0];
...
// File: contracts/AbapeSupremeSharkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AbapeSupremeSharkContract is RamppERC721A {
    constructor() RamppERC721A("Abape Supreme Shark ", "Abape"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/dY58nGLVaMnXTUiEkEQm/contract-metadata";
    }
}
