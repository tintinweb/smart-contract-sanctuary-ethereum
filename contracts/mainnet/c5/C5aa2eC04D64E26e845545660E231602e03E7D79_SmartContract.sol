...
Yomi-no-kuni (黄泉, 黄泉の国, or 黄泉ノ国) (World of Darkness).
Darkness will never fade...

Tax: 5/5
**initial sell tax 18% for the 1st hour, revert to 5% afterwards..

TOKENOMICS
1% AUTO BURN (sent to darkness)
4% MARKETING wallet (future projects: nft's, website, DeFi, Blockchain, etc..)

TOKEN NAME: Yomi-No-Kuni
SYMBOL: YOMI
SUPPLY: 1,000,000,000,000,000,000
MAX WALLET 1% AT LAUNCH = 10,000,000,000,000,000
Set maxwallet & maxbuy to 5% = 50,000,000,000,000,000

Telegram: https://t.me/worldofdarknessETH
***Official Webiste and Twitter is posted in our telegram***
*/
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Yomi-No-Kuni";
    string private constant _symbol = "YOMI";
    ...
    uint256 private maxWalletAmount = 10000000000000001 * 10**9;
    uint256 private maxTxAmount = 10000000000000001 * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x09aAb92e2A24D9BB8e6E03a0c6B992f66c4F6d5e); 
        ...
        uint256 _sellMarketingFee = 1700;
        ...
        maxTxAmount = 10000000000000001 * 10**9;
        maxWalletAmount = 10000000000000001 * 10**9;
