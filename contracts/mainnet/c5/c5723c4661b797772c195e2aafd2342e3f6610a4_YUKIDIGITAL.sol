...
/**
__     ___    _ _  _______   _____ _____ _____ _____ _______       _      
\ \   / / |  | | |/ /_   _| |  __ \_   _/ ____|_   _|__   __|/\   | |     
 \ \_/ /| |  | | ' /  | |   | |  | || || |  __  | |    | |  /  \  | |     
  \   / | |  | |  <   | |   | |  | || || | |_ | | |    | | / /\ \ | |     
   | |  | |__| | . \ _| |_  | |__| || || |__| |_| |_   | |/ ____ \| |____ 
   |_|   \____/|_|\_\_____| |_____/_____\_____|_____|  |_/_/    \_\______|
...
abstract contract Ownable is Context {
    ...
    contract YUKIDIGITAL is ERC721A, Ownable {
    using Strings for uint256;
  ...
  constructor() ERC721A("YUKI DIGITAL", "YUKI") {
  }
