...
contract ERC721Test is ERC721Enumerable, Ownable, ERC2981 {
    using Strings for uint256;
    ...
    constructor(string memory initBaseURI) ERC721("Windvane Test", "WDVt") {
    ...
    function mintNFTtoAddr(uint256 amount, address sender) public payable {
        require(amount > 0, "amount should be large than 0");
        // require(msg.value >= amount * price, "invalid value");
        // ERC20(currency).transferFrom(msg.sender, rece, amount * price);
        for(uint256 i = 0; i< amount; i++) {
