...
contract BISKIT is MintableToken {
  string public constant name = "BISKIT"; // solium-disable-line uppercase
  string public constant symbol = "BISKIT"; // solium-disable-line uppercase
