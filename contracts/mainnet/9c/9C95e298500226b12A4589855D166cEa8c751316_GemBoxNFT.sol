...
* GemBox is an ERC-20 token created on the Ethereum blockchain.
* GemBox serves to fast forward the collapse of the financial system,
* to end the tyranny of sovereign nations and central banks.
* A purpose-built investment token and a store of value,
* a token created by the people for the people.

* Telegram - https://t.me/gembox_official
* Twitter -  https://twitter.com/gembox_nft
* Website -  https://gembox.site/
* Medimum -  https://medium.com/@gembox
 */
...
contract GemBoxNFT is ERC20Burnable {
    ...
    constructor () ERC20("GemBox NFT", "GEMBOX")
    {
    ...
    function updateMarketingAddress(address _devAddress) external {
