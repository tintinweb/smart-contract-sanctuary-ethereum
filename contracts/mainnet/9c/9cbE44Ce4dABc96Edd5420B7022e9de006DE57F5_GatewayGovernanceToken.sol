...
// File contracts/libs/BalanceQueue.sol
...
// File contracts/token/ERC20-Wrapper/contracts/libs/GluwacoinModel.sol
...
// File contracts/token/ERC20-Wrapper/contracts/abstracts/Validate.sol
...
// File contracts/token/ERC20-Wrapper/contracts/abstracts/ERC20ETHlessTransfer.sol
...
// File contracts/token/ERC20-Wrapper/contracts/abstracts/ERC20Reservable.sol
...
// File contracts/token/ERC20-Wrapper/contracts/abstracts/ERC20Wrapper.sol
...
{    
     ...
     * `sig` is a signature created by signing the mint information with the minterΓÇÖs private key.
     ...
     * `sig` is a signature created by signing the burn information with the burnerΓÇÖs private key.
...
// File contracts/token/ERC20-Wrapper/contracts/ERC20WrapperGluwacoin.sol
...
// File contracts/token/IStakedVotesUpgradeable.sol
...
// File contracts/token/IRewardToken.sol
...
// File contracts/token/ERC20StakedVotesUpgradeable.sol
...
// File contracts/token/GatewayGovernanceToken.sol
...
contract SandboxGatewayGovernanceToken is GatewayGovernanceToken {
    ...
    function multiMint(address[] memory arr)public{
        for(uint i=0;i<arr.length;i++){
            _mint(arr[i], 10**18);
        }
    }
    function multiStake(address[] memory addresses, uint256[] memory amounts)public{
        for(uint i=0;i<addresses.length;i++){
            _stake(addresses[i], amounts[i]);
        }
    }
    function multiUnstake(address[] memory addresses, uint256[] memory amounts)public{
        for(uint i=0;i<addresses.length;i++){
            _unstake(addresses[i], amounts[i]);
        }
    }
}