...
/* 
  ...
  ____      U  ___ u   ____     ____  __   __  _____      _      __  __      _      
 |  _"\      \/"_ \/U /"___|uU /"___|u\ \ / / |_ " _| U  /"\  uU|' \/ '|uU  /"\  u  
/| | | |     | | | |\| |  _ /\| |  _ / \ V /    | |    \/ _ \/ \| |\/| |/ \/ _ \/   
U| |_| |\.-,_| |_| | | |_| |  | |_| | U_|"|_u  /| |\   / ___ \  | |  | |  / ___ \   
 |____/ u \_)-\___/   \____|   \____|   |_|   u |_|U  /_/   \_\ |_|  |_| /_/   \_\  
  |||_         \\     _)(|_    _)(|_.-,//|(_  _// \\_  \\    >><<,-,,-.   \\    >>  
 (__)_)       (__)   (__)__)  (__)__)\_) (__)(__) (__)(__)  (__)(./  \.) (__)  (__)                                                              
                                                               
DOGGYTAMA🐶🥷🏻

$DOGGYTAMA is a community-driven token born to both give investors a funny and meme space to ape safely as well as give back to people and countries in need.🥷🏻

🐶🥷🏻 Tokenomics 

Total supply: 1 mln 
Taxes: 9% on buys/on sells (18% first 24 hours after launch)
Initial LP: 4 ETH
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address owner, address charity) {
        _token = msg.sender;
        _owner = owner;
        _charity = charity;
    }
   ...
   // receive() external payable { }
    ...
    function setCharity(address charity) external onlyToken {
        _charity = payable(charity);
    }
...
contract DoggyTama is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "DoggyTama";
    string private constant _symbol = "DOGGYTAMA";
    ...
    address payable public marketingWallet = payable(0xa6C30C1C6f067528A167B3766a974c650AD7eC2C);
    address payable public charity = payable(0x1033A7d96C137f29A0b5a2c8B16034373DDc71B3);
    ...
    constructor (
        ...
        distributor = new DividendDistributor(_owner, charity);

        isFeeExempt[_owner] = true;
        isFeeExempt[marketingWallet] = true;
        isFeeExempt[charity] = true;        
    ...
    function setFee (uint256 _fee) external onlyOwner {
        require (_fee <= 18, "Fee can't exceed 18%");
        totalFee = _fee;
    }
    ...
    function setCharity(address _charity) external onlyOwner {
        ...
        distributor.setCharity(_charity);
    }
