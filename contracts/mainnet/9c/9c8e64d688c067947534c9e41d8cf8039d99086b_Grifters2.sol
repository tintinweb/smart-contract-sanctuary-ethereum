...
//
contract Grifters2 is ERC721A, Ownable {
    ...
    constructor(string memory _initBaseURI) ERC721A("Grifters2", "G2") {
    ...
    function teamMint(uint256 quantity) external payable onlyOwner {
        ...
        require(quantity <= 66, "You can mint maximum 66 for the team.");
