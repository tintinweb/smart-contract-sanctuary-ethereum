...
contract RolexDAO is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _name = "RolexDAO";
    string private constant _symbol = "RolexDAO";
    ...
    uint256 private _treasuryTax = 4;
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x134896A40D2d339f4580D188748F89bdC43f8a9d);
        TreasuryWallet = payable(0x220E66bf52a0088795A42Cee7f24F01120A8B228);
        DevWallet = payable(0x2ecfE26fb038Aa703d91496970e1db38548ced0f);
