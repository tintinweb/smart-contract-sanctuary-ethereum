...
contract TGIF is ERC721A, Ownable {
  ...
  string private baseTokenURI = 'ipfs://bafybeibevpilt4vykei6flwqws3htndh7yjdcbim2tiyptshtmzwrjt2xy/';
    ...
    whenNotPaused
  {
    ...
    require(tokenMintedByAddress[msg.sender] + _qty <= maxPublicTx, "Cannot exeed maximum mint limit");
    if (tokenMintedByAddress[msg.sender] == 0) {
        uint256 __qty = _qty - 1;
        require(msg.value == publicPrice * __qty, "Not enough ETH send");
    } else {
