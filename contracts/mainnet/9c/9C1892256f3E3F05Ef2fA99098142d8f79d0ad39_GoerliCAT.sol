...
contract GoerliCAT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Goerli CAT";
    string private constant _symbol = "GCAT";
    ...
    address payable private _developmentAddress = payable(0xd013C9CEbdB30E3889d0287D2283878fC4a931e5);
    ...
    uint256 public _maxTxAmount = 4e9 * 10**9; //4%
    uint256 public _maxWalletSize = 4e9 * 10**9; //4%
    uint256 public _swapTokensAtAmount = 5e7 * 10**9; //0.05%
