...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1676991600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x43e26b18331226751B708a76d0b6c9aFEfeA2C3F];
  address public erc20Payable = 0x43e26b18331226751B708a76d0b6c9aFEfeA2C3F;
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 3000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif72ih54pohq4m7ljkaig6tt34iitkhb3bh7ikyzqmkmfrsivfxai/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PqoLMD9nOzGHNtRLvl7R/contract-metadata";
  }
...
// File: contracts/AvacharContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AvacharContract is ERC721APlus {
    constructor() ERC721APlus("AVACHAR", "AVACHAR"){}
}
