...
//   / ____/__  / /______   ____  ____     / ____/_  __/ / / /
//  / /   / _ \/ __/ ___/  / __ \/ __ \   / __/   / / / /_/ / 
// / /___/  __/ /_(__  )  / /_/ / / / /  / /___  / / / __  /  
// \____/\___/\__/____/   \____/_/ /_/  /_____/ /_/ /_/ /_/   
//                                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 30, 6968 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmX58BjzkXdqoAE6W8gcT2greLsLHW4kKVQVkPvNLttFDR/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6968");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6968");
...
// File: contracts/CetsonEthContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CetsonEthContract is RamppERC721A {
    constructor() RamppERC721A("Cets on ETH", "CETS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/BvfwfdF1KhLcC7c2BQTV/contract-metadata";
    }
}
