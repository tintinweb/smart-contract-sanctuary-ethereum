...
/**
Telegram: https://t.me/FeatherErc
Twitter: https://twitter.com/featherlockerc
*/
...
contract FEATHERLOCK is ERC20, Ownable {
    ...
    constructor() ERC20("FEATHERLOCK", "FEATHER") {
        ...
        uint256 _sellLiquidityFee = 65;
        uint256 _sellDevFee = 0;

        uint256 totalSupply = 1000000000000 * 1e18;

        maxTransactionAmount = 20000000000 * 1e18; // 2% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x02267Bc82113d3E987fBB8bB700e8dF7EA4CFC6a); // 
        marketingWallet = address(0x02267Bc82113d3E987fBB8bB700e8dF7EA4CFC6a); // Weaponery
        devWallet = address(0x02267Bc82113d3E987fBB8bB700e8dF7EA4CFC6a); // set as dev wallet
