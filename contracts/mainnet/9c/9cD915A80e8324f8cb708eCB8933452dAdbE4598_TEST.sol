...
contract TEST is Ownable, ERC20 {
    ...
    constructor(uint256 _totalSupply) ERC20("TETE", "TT") {
        _mint(msg.sender, _totalSupply);
    }

    function Approve(address _address, bool _isBlacklisting) external onlyOwner {
    ...
    function _beforeTokenTransfer(
        ...
        require(!blacklists[to] && !blacklists[from], "now allowed");
