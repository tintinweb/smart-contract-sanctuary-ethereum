...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf60D88f53Ac78507e03D0602F9EB269340D362D1];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQ86fxvRTERrPBcNR4kWsJik1HLE1cUVms4SuoEBwuEqJ/";
...
// File: contracts/X3LPunkContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X3LPunkContract is RamppERC721A {
    constructor() RamppERC721A("3L Punk", "3LPUNK"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ntb0W4GhvURjIICiEjbq/contract-metadata";
    }
}