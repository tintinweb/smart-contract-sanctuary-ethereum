...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant _magic_n = 1103;
...
contract LandOfExgf  is ERC721A, Ownable {
    ...
    constructor()
    ERC721A ("LandOfExgf", "7LandOfExgf") {
    }
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        require(amount - amount <= maxPerTx, "invalid mint amount");
