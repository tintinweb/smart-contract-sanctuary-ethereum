...
/*
    @big boy Currency 
    https://t.me/bigboycoin
    https://twitter.com/BBCOfficial2022

// Big Boy Coin $BBC
// As the name suggests this token is for Big Boys. 
// $BBC aspires to become the currency of the masses, 
...
// 🔒LP WILL BE LOCKED FOR >29 Days

// ✅ Hard Coded Taxes
// ✅ BBC NFTs
// ✅ BUY LIMIT OF 0.5% (first 3 mins)
// telegram group link : https://t.me/bigboycoin
Every 14 days after launch, taxes will be lowered by 1%, to eventually make BIG Boy Token a 1% tax token, as development and marketing will mostly be funded by transactions done with our wallet.
...
contract BigBoy is ERC20, Ownable {
    ...
    constructor() ERC20("Big Boy Currency", "BBC") {
