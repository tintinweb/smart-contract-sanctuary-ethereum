...
contract BTCGOBBLERS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZxDnojLvjgMe1aNdMyg43xYH4uZpcZVshxUc";
    ...
    constructor(
    ) ERC721A("BTC GOBBLERS", "BOOEY", 100, maxSupply) {
    }
