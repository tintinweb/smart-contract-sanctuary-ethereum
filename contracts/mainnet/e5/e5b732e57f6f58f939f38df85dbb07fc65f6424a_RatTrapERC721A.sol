...
contract RatTrapERC721A is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public MAX_MINTS = 333;
    string public baseURI = "https://salmon-official-locust-57.mypinata.cloud/ipfs/QmdsiqYxV46bH3tmEHuc4UyuZ5XBk1vQBsZKGizkJuDjhX/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("The Rat Trap", "TRT", MAX_MINTS, MAX_SUPPLY) {  
    }
