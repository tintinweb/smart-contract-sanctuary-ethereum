...
/*
https://t.me/BonfireETH
https://twitter.com/BonfireETH
https://bonfireburn.xyz/
*/
...
contract BONFIREETH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bonfire ETH", "BONFIRE") {
        ...
        swapTokensAtAmount = supply * 10 / 10000000; // 0.1% swap wallet;
        ...
        devWallet = 0x3DFA55487fb3c1C094233D291624F52Ff0A34dd8;
    ...
    function updateLimits() private {
        maxTransactionAmount = supply * transDigit / 100;
        swapTokensAtAmount = supply * 5 / 10000000; // 0.05% swap wallet;
        maxWallet = supply * walletDigit / 100;
    }
