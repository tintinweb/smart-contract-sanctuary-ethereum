...
contract REINDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="REINDOGE";
    string private _symbol = "RDOGE";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x126dA86c0Ec0e9Fb98C6ef6B910B6945E3e33955);
