 ...
 *                
 *                  
 *      Fees on Buy: 10%   Sell:10 
 *                          
 *      https://t.me/BOBAFETTETH
ELON MUSK BASED TWEET COIN
 *         
 * 
*/         
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x56143E2736C1b7F8A7d8C74707777850b46ac9aF); //DOGGER
...
contract BobaFett is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BobaFett";
    string constant _symbol = "BBF";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address RewardToken = 0x56143E2736C1b7F8A7d8C74707777850b46ac9aF;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 800;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x0DcC3aF9a55C49DAa7170A7a2468C588323D7430;
