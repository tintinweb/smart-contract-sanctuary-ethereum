...
contract SFNV1MintContract is ERC721A, Ownable {
    ...
    //Pricing
    //***************************************************************************************************
    uint256 public pricePartner = 0.02 ether; //set NFT price
    uint256 public pricePresale = 0.02 ether; //set NFT price
    uint256 public pricePublic = 0.02 ether; //set NFT price
    ...
    constructor(
        ...
        devShare = 10; //Dev Fee
        ownerWithdrawAddress = 0xa50D6F46c2D969F8c8C635975F6c824c1eC75EB8;//Owner
    }
