...
contract LaBabies is ERC721A, Ownable, ERC2981 {
    uint256 public price = .05 ether;
    uint256 public presalePrice = .05 ether;
    ...
    uint256 public immutable supply = 1213;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0x7e9d3d03b7Ac3A0573DCCA95A8374D2Ad571F469, 0x8D8d0510AaA586448CA0B6Df0A8D48D194BB1BA1, 0x7FcaABA7b948613b436ebA35Fc8BE0068824Fc6a];
    uint256[] public withdrawPercentages = [5, 57, 28, 10];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x7e9d3d03b7Ac3A0573DCCA95A8374D2Ad571F469, _royaltyAmount);
    }
