...
contract MetaFashion is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xA674B38ACDB303296e622cCdbf5d42FA496a40eB); // Marketing Address
    address payable public rewardAddress = payable(0xA674B38ACDB303296e622cCdbf5d42FA496a40eB); // Reward Address
    address payable public liquidityAddress = payable(0xA674B38ACDB303296e622cCdbf5d42FA496a40eB); // Liquidity Address
    ...
    string private constant _name = "MetaFashion Coin";
    string private constant _symbol = "METAFS";
    ...
    function _transfer(
        ...
        if (!tradingActive){
            require(from != uniswapV2Pair && to != uniswapV2Pair , "You cannot add liquidity before trading active.");
        }
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyRewardFee + _buyMarketingFee <= 15, "Must keep buy taxes below 15%");
    }
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellRewardFee + _sellMarketingFee <= 25, "Must keep sell taxes below 25%");
    }
