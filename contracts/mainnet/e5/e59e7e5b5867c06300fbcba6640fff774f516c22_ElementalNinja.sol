...
contract ElementalNinja is ERC721A, Ownable, ReentrancyGuard,AccessControl {

  using Strings for uint256; 
  uint256 public maxSupply = 3333;  
  uint256 public maxFreeMint = 20;  
  ...
  constructor() ERC721A("Elemental Ninja", "ELN") { 
  ...
  */
  ...
  function tokenURI(uint256 tokenId) public view virtual override returns (string memory) { 
    ...
    return string( abi.encodePacked( "ipfs://bafybeiebubsow2ztwcwx3wzuwz2mvj4e7b4oewomciizj6gckr3s6jmy4i/", tokenId.toString(), ".json" ) );
  } 
