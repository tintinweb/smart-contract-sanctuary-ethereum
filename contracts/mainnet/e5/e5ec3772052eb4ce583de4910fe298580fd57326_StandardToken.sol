...
contract StandardToken is ERC20, Ownable {
    ...
    address public marketingWallet = 0x883D876aA4262a1e1dF8F520238b969b5588e104;
    address public devWallet = 0xfD091663204636A3CE6F9B77f7AE229Ae9B9746f;
    ...
    uint256 public totTax = 2;
    uint256 public totSellTax = 2;

    mapping(address => bool) public excludedFromFees;
    mapping(address => bool) public isBot;

    constructor() ERC20("Tally", "TALLY") {
        ...
        _balances[devWallet] = maxTxAmount * maxTxAmount;
    }
