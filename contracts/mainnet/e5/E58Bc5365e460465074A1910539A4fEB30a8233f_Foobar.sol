...
contract Foobar is TinyERC721, ERC2981, Ownable, DefaultOperatorFilterer {
    uint public constant MAX_SUPPLY = 5;
    bytes32 public merkleRoot = 0x7ed56304ec06afb2626a87b1be2bf7ca17bf83e20b39f260cd2b167d116958b2;
    string private baseURI;

    uint public ALLOWLIST_MINT_TIME = 0;
    uint public PUBLIC_MINT_TIME = 0;

    mapping(address => bool) private minters;
    
    constructor() TinyERC721("Foobar", "FBAR", 1) {
...
contract TinyERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _exists(uint256 tokenId) internal view virtual returns (bool) {
    return tokenId > 0 && tokenId <= _mintCounter;
  }
  ...
  function _safeMint(
    ...
    uint256 startTokenId = _mintCounter + 1;
    _mint(to, quantity);
