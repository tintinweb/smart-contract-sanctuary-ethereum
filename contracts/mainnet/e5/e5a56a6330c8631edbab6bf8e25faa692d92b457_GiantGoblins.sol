...
abstract contract Ownable is Context {
    ...
    modifier ownerMint(){
        require(
            _msgSender() == 0x57da08Ec057f12D2d541693749DBC4840F85b154
...
contract GiantGoblins is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.0055 ether;
    ...
    constructor() ERC721A("GiantGoblins", "GTGB", MAX_MINTS, MAX_SUPPLY) {  
    }
    

    function mint(uint256 numTokens) public payable {
        require(!paused, "Paused");
        require(numTokens > 0 && numTokens <= 5);
    ...
    function adminMint(uint256 numTokens) public payable ownerMint {
        _safeMint(msg.sender, numTokens);
    }
