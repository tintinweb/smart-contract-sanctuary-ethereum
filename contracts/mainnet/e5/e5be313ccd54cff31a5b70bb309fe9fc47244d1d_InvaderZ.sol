...
/**
.___                         .___                   
|   | _______  _______     __| _/___________________
|   |/    \  \/ /\__  \   / __ |/ __ \_  __ \___   /
|   |   |  \   /  / __ \_/ /_/ \  ___/|  | \//    / 
|___|___|  /\_/  (____  /\____ |\___  >__|  /_____ \
         \/           \/      \/    \/            \/
*/
...
contract InvaderZ is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public maxSupply = 5000;
	uint256 public Ownermint = 2;
  ...
  constructor(string memory baseURI) ERC721A("InvaderZ", "IVDRZ") {
  ...
  function Mintinvaderz (uint256 _mintAmount) public payable nonReentrant callerIsUser{
  ...
  function Releaseinvaderz() public onlyOwner {
    paused = !paused;
  }
