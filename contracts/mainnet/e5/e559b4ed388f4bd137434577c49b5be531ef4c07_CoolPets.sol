...
contract CoolPets is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://arweave.net/HiEvTlb4eGD-8dQML1CLoMlDfnC1FHl6AaUus9y6fjs";
    ...
    constructor(
    ) ERC721A("COOL PETS", "PETS", 100, maxSupply) {
    }
        ...
        canMintNFTs(numberOfTokens)
    {
        ...
        _safeMint(address(0), numberOfTokens);
    }
    ...
    function reserveMint(address to, uint256 numberOfTokens) public onlyOwner {
