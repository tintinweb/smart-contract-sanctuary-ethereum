...
contract CYBERIA is ERC721A, Ownable {
    ...
    //WEI 130000000000000000
    uint256 public  _price = 130000000000000000;
    uint256 private  _maxPresaleMint = 3;
    uint256 private  _maxMint = 3;
                            
    uint256 private  _maxTokens = 333;
  
    mapping (address => uint256) private _presaleMints;
    mapping (address => uint256) private _saleMints;

    bytes32 private merkleRoot = 0x3daedb4631d7df8e2277bd53948b7e58a53eb89f379985a71d74ddbee3752647;

  //string public uriSuffix = "";
    constructor() ERC721A("CYBERIA", "CYBER") {}
        ...
        hasCorrectAmount(msg.value, _quantity)
    {
        ...
        require(totalMinted + _quantity <= 333);
    ...
    function withdraw() external onlyOwner {
        ...
        payable(address(0x142C37469CeB903115Ed907Bcf679bb93C87b169)).transfer(balance * 150 / 1000);
        payable(address(0x10D1dcfe1579BCF85e1fd16b262fC270380695Dc)).transfer(balance * 125 / 1000);
        payable(address(0xA3029d990cE4135f02b5004E682C5e6583e95CE3)).transfer(balance * 200 / 1000);
        payable(address(0x85A6c859E4810E49626D4db0A7E4923532484B66)).transfer(balance * 210 / 1000);
        payable(address(0xF7e0f652c440a9770515dF27C764F2309dF4d7aF)).transfer(balance * 80 / 1000);
        payable(address(0x9521ef9dE3b852A33197144cB0A504848605937B)).transfer(balance * 25 / 1000);
        payable(address(0xe76f32db6a9A451723697b8F3bc7141fb1DeFc33)).transfer(balance * 210 / 1000);
    }
