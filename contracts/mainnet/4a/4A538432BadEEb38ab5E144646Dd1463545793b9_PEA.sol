...
ROADMAP:
Launch :  Renounce, Lock LP for 7 days
50k  MC:  Extend LP lock for 1 month
100k MC:  DEXT information
200k MC:  Meme Competition
500k MC:  Buy Competition
1M   MC:  Website + Pro Memes
2M   MC:  Extend LP lock for 6 months
3M   MC:  Whitepaper and Utility
5M   MC:  List on Popular Indexes
10M  MC:  Twitter Spaces + Telegram Stickers
15M  MC:  Meme & Twitter Competitions
20M  MC:  DEXT Banner Ads
50M  MC:  $50k Random Giveaway
100M MC:  Lots of Fun
...
contract PEA is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 500001 * (10**18); // 0.5% of total supply
    uint256 public maxBuyTransactionAmount = 500001 * (10**18); // 0.5% of total supply
    uint256 public swapTokensAtAmount = 200000 * (10**18);
    uint256 public maxWalletToken = 1500001 * (10**18); // 1.5% of total supply

    uint256 private buyTotalFees = 5; // 5%
    uint256 public sellTotalFees = 5; // 5%
    uint256 public earlySellTotalFee = 20; // 20%

    // auto burn fee
    uint256 public burnFee = 0;
    address public deadWallet = 0xAAc7Cfd69545Bb683602081476e97D38b41f536D;
    

    // distribute the collected tax percentage wise
    uint256 public liquidityPercent = 5;
    uint256 public marketingPercent = 95;
    uint256 public devPercent = 0;


    address payable public marketingWallet = payable(0xAAc7Cfd69545Bb683602081476e97D38b41f536D);
    address payable public devWallet = payable(0xe102f8efecc03D1b30D1f45EB8904582f6313eF7);
    ...
    constructor() ERC20("EZ PEA-Z", "PEA") {
    ...
    function _transfer(address from, address to, uint256 amount) internal override 
    {
        ...
        if(!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            ...
            if (!automatedMarketMakerPairs[from]) {   
                ...
                if(enableEarlySellTax && span <= 1 hours) {
