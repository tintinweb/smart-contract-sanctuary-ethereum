...
contract KEEPGOINGWEWILLRISE is ERC721A {
    ...
    constructor() ERC721A("Keep Going, We Will Rise", "KGWWR") {
        owner = msg.sender;
        royalty = 69;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmWhEjByYrpq2DgJw66KSFHCx4YvFTfbo5tRwhTTSncCRe/", _toString(tokenId), ".json"));
    }
