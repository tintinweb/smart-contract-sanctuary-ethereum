...
contract GOUDA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "GOUDA";//
    string private constant _symbol = "GOUDA";//
    ...
    address payable private _developmentAddress = payable(0xfaD57ac7ccA23F6320CB2DbE462F77cb713e0613);//
    address payable private _marketingAddress = payable(0xc0959A563304Bb28E796932c75E31094e3A1C081);//
