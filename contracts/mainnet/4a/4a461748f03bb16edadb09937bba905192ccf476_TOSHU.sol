...
contract TOSHU is ERC20, Ownable {
    ...
    constructor() ERC20("Toshu", "TOSHU") {
        ...
        maxTransactionAmount = 50000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 100000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x6BB335b820729bcD8F296b1E0635229A7b7595ed); // set as charity wallet
        marketingWallet = address(0x6BB335b820729bcD8F296b1E0635229A7b7595ed); // set as marketing wallet
        devWallet = address(0x6BB335b820729bcD8F296b1E0635229A7b7595ed); // set as dev wallet
