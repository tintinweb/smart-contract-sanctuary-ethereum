...
contract ElementalEscapes is ERC721A, Ownable {
   ...
   /*    _______  _______
    ...
    string public baseURI = "ipfs://QmcTYtohtF1oNfW1g6mkbG1v1jZbaPUKZVPJzRLrcrA7AD/";

    constructor() ERC721A("Elemental Escapes", "EMNT") {}
    ...
    function mint(uint256 _amount) public payable {
        require(mintOpen == true, "mint is not live");
