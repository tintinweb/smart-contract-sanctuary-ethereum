...
contract Autonomy is ERC20, Ownable {
    ...
    // TOKENOMICS START
    string private _name = "AUTONOMY DAO";
    string private _symbol = "AUTONOMY";
    uint8 private _decimals = 18;
    uint256 private _supply = 25000;
    ...
    uint256 public maxTxAmount = 750 * 10**_decimals;
    uint256 public maxWalletAmount = 750 * 10**_decimals;
    uint256 private _numTokensSellToAddToLiquidity = 250 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 250 * 10**_decimals;
    address public marketingWallet = 0x0268d3ECCEa6d1c92a137E0122589224BC372646;
    // TOKENOMICS END
