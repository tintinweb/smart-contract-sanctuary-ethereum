...
contract TerraDeezNutsToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Terra Deez Nuts";//
    string private constant _symbol = "TDN";//
    ...
    address payable private _developmentAddress = payable(0xdAFc581f2938A2D586cAC3992cC77f42661DF743);//
    address payable private _marketingAddress = payable(0x4cB575f08bC4aD095E3b7CF37c69f62a96A2da39);//
