...
contract BOTPAK is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("BOT by Pak x 0xVodnik", "PAKVODNIK")
    {
        baseURI = _baseURI;
