...
// SPDX-License-Identifier: Unlicensed
        ...
        contract TOKEN is ERC20 {
            ...
            constructor () ERC20("1945", "KAMI"){


                 numTokensSellToSendFees = 10000000000 * 10 ** decimals();
                _devAddress = 0x898398c20A640747078AcDD4ce3c71e3e57E4767;
                ...
                */
                _mint(owner(), 5700000000000 * 10 ** decimals());		
            ...
            function setBuyAndSellFeePercent(uint256 buyFee, uint256 sellFee) external onlyOwner {
                require(buyFee <= 25 && sellFee <= 25,"ERC20: Buy & Sell Fees Can't Higher than 25%");
                _buyDevFee = buyFee;
                _sellDevFee = sellFee;
