...
Baahubali is an epic story in which, a baby boy is miraculously found alive in the middle of a river by a few villagers. They raise him as their own. Named Shiva (Prabhas), the boy grows up to be an adventurous commoner until his past comes back to haunt him.

Buy Bahubali and be “Bahu”

Bahu’s Tax: 5%

TG: https://t.me/bahubaliinu 
*/
...
contract BAHUBALIINU is Context, IERC20, Ownable {
    ...
    string private _name = "BAHUBALI INU";
    string private _symbol = "BAHUBALI";
    ...
    address payable public marketingaddress = payable(0xC58fe4EDcBEa63F752cC4f49675049a93b628363);

    uint256 public _MarketingFeeBuy = 5;
    ...
    uint256 public _walletMax = 50000000 * 10**_decimals;  
