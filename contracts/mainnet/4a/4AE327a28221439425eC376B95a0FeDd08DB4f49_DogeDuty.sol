...
contract DogeDuty is Context, IERC20, Ownable {
    ...
    string private _name = "Doge of Duty";
    ...
    uint256 public _maxBuyAmount = 65000000000000 * 10**9;
    uint256 public _maxWalletAmount = 152500000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 7000000000000 * 10**9;
    uint public ethSellAmount = 1000000000000000000;  //1 ETH
    address public marketingWallet = 0x2C680478e0f858c1aBaf12c7403F3bFc2Cc908CB;
    address public devWallet = 0x2C680478e0f858c1aBaf12c7403F3bFc2Cc908CB;
    ...
    function enableTrading(uint256 reflectionFee, uint256 liquidityFee, uint256 sellReflectionFee, uint256 sellLiquidityFee, uint256 superSellOffFee) external onlyOwner {
        taxFees.reflectionBuyFee = reflectionFee;
        taxFees.liquidityBuyFee = liquidityFee;
        taxFees.sellLiquidityFee = sellLiquidityFee;
        taxFees.sellReflectionFee = sellReflectionFee;
