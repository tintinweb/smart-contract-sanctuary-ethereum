...
/* *
we are reviving Avanza as part of our DAO.
...
No team tokens, no presale, 30% initial burn

The liquidity will be locked and contract will ne renounced.
12% sell tax and 1 % reflections, Taxes are used for theAvanza by the Avanza.

https://www.avanzadao.io/

If you can't open the URL, please use the onion browser
...
contract AvanzaDAO is Context, IERC20, Ownable {
    ...
    string private _name = "AvanzaDAO";
    string private _symbol = "$AVANZA";
    ...
    uint256 public numTokensSellToAddToLiquidity = 200000000000 * 10**9;
