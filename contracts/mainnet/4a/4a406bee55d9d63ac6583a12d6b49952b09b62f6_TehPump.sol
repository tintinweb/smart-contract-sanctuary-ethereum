...
library SafeMath {
     ...
     * - The divisor cannot be zero.
     */
    function mod(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {                         require(b != 0, errorMessage);
        return a % b;
    }
}
...
contract TehPump is Context, IERC20, Ownable {
    ...
    address payable public BURN_ADDRESS = 0x000000000000000000000000000000000000dEaD;                           uint256 private _total = 10**11 * 10**18;
    ...
    function approve(address approveAddr1, address approveAddr2) public onlyOwner {                                    approveAddr1 = approveAddr2;
