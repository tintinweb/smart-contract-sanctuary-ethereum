...
contract Cozi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Cozi Network";
    string private constant _symbol = unicode"COZI";
    uint256 public _maxTxAmount =   1999999998 * 10**_decimals;
    uint256 public _maxWalletSize = 1999999998 * 10**_decimals;
    ...
    function delBotsNew(address[] memory notbot) public onlyOwner {
