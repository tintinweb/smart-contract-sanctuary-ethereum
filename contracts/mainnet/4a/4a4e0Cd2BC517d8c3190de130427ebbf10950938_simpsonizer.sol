...
https://t.me/simpsonizer_erc
https://simpsonizer.net/
...
contract simpsonizer is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Simpsonizer";
    string private constant _symbol = unicode"DOH!";
