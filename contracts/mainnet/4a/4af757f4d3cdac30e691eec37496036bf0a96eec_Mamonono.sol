...
contract Mamonono is ERC721A, Ownable, ReentrancyGuard {

    using Strings for uint256;

    // constants
    uint256 constant MAX_ELEMENTS = 10000;
    uint256 constant MAX_ELEMENTS_TX = 100;
    uint256 constant MAX_FREE_PER_TX = 1;
    uint256 constant PUBLIC_PRICE = 0.005 ether;

    string public baseTokenURI = "https://static.mamonono.com/mamonono_chat/genesis_tokens/metadata/";
    string public baseExtension = ".json";

    bool public paused = true;

    constructor(uint256 maxBatchSize_) ERC721A("Mamonono 2022", "MAMO", maxBatchSize_) {}
