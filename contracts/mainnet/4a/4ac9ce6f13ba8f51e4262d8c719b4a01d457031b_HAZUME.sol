...
contract HAZUME is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "HAZUME";
    string private constant tokenSymbol = "HAZUME";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x0fB0df2B331De7874f443a2AA0c89B52a6f00ae2);
        devAddress = payable(0x0fB0df2B331De7874f443a2AA0c89B52a6f00ae2);
