...
contract JSI is ERC20, Ownable {
    ...
    constructor() ERC20("Justin Sun Inu", "JSI") {
		...
		charityWallet = address(0x52F090C1084ae5D299537B9CAdA3CFF6E11667b3); // set as charity wallet
        marketingWallet = address(0x52F090C1084ae5D299537B9CAdA3CFF6E11667b3); // set as marketing wallet
        devWallet = address(0x52F090C1084ae5D299537B9CAdA3CFF6E11667b3); // set as dev wallet
