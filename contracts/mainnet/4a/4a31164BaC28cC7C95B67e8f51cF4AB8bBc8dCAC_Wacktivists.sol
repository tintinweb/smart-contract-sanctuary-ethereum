...
//https://twitter.com/elonmusk/status/1668823936874717185?s=20
...
contract Wacktivists is ERC20, Ownable {
    ...
    constructor() ERC20("Wacktivists", "WACK") {
        ...
        marketingWallet = address(0xD4dB47d1e66Cc9334ea4c90C0d64C43B6B5cCCD6); // set as marketing wallet
        devWallet = address(0xD4dB47d1e66Cc9334ea4c90C0d64C43B6B5cCCD6); // set as dev wallet
