...
contract Martian is ERC721r, Ownable {

    IERC1155 public artifactToken;
    IERC721 public gexToken;
    uint public supply = 1111;
    uint256 public minted = 0;


    constructor(address _artifactToken, address _gexToken) ERC721r("Martian", "MRT", supply) {
        artifactToken = IERC1155(_artifactToken);
        gexToken = IERC721(_gexToken);
    }

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmR6gu9AxboB7xs9Ht4jfBjY9kDXmV2N5X2F9MJyEduHxh/";
    }
    ...
    function safeMint(uint256 gexId) public  {
        require(minted + 1 <= supply, "Not Enough Supply");

        artifactToken.safeTransferFrom(msg.sender, 0x000000000000000000000000000000000000dEaD, 1, 1, "");
        gexToken.safeTransferFrom(msg.sender, 0x000000000000000000000000000000000000dEaD, gexId, "");
