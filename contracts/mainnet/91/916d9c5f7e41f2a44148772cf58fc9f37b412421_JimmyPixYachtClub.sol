...
contract JimmyPixYachtClub is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    address private _mechaMonkeyContract; //Companion 
    uint   private _totalStake;
    bool   public JimmyPixYachtClub = false; // Key owners reveal phase 2
    ...
    constructor() ERC721A("JimmyPixYachtClub", "JPYC") {}
   ...
   function setBaseUri(string memory baseuri_) public onlyOwner {
    ...
    function toggleJimmyPixYachtClub() public onlyOwner {
        JimmyPixYachtClub = !JimmyPixYachtClub;
    }
