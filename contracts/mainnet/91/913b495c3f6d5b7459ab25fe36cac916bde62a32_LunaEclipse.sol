...
contract LunaEclipse is ERC165, IERC2981, IERC1155MetadataURI, Ownable {
  ...
  string private constant ipfs_hash = "bafybeihyobycbhozuwvbsbhpewu6sn3b5eujoijvpfsx2trsmrtzextnlm";
  ...
  function uri(uint256 _tokenId) external view returns (string memory) {
    if (_tokenId >= bear_prize) {
      return string(abi.encodePacked('ipfs://', ipfs_hash_prizes, '/{id}.json'));
    }
    return string(abi.encodePacked('ipfs://', ipfs_hash, '/{id}.json'));
  }
