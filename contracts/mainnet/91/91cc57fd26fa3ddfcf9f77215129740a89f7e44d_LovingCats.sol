...
contract LovingCats is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "https://ipfs.io/ipfs/bafybeicv7ohio6nsifhzadjgvqu5tcbqvjkdp5au2duvvpem2qhml53l5e/";
    string public baseExtension = ".json";
    uint   public price             = 0.0005 ether;
    uint   public maxPerTx          = 20;
    uint   public maxTxForFreeMints = 5;
    uint   public totalFree         = 500;
    uint   public maxSupply         = 2500;
    uint   public nextOwnerToExplicitlySet;
    bool   public mintEnabled       = true;

    constructor() ERC721A("LovingCats", "LC"){}

    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        require(_exists(_tokenId),"ERC721Metadata: URI query for nonexistent token");
        string memory currentBaseURI = _baseURI();
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI,Strings.toString(_tokenId+1) , baseExtension))
            : "";
    }
