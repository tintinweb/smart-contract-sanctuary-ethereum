...
contract THEHOLCIM is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "THE HOLCIM";
    string private constant _symbol = "HOLCIM";
    ...
    uint256 public _maxTxAmount = 130000 * 10**9;
    uint256 public _maxWalletSize = 260000 * 10**9;
    uint256 public _swapTokensAtAmount = 13000 * 10**9;
