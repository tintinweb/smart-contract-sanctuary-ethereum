...
contract BeastSuit is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{
...
string public CONTRACT_URI = "";
    ...
    uint public COLLECTION_SIZE = 2777;

    uint public MINT_PRICE = 0.0016 ether;
    ...
    constructor() ERC721A("a Suit called BEAST", "BEAST") {}
    function FreeMintWL(uint256 quantity, address receiver) public onlyOwner {
        require(
            totalSupply() + quantity <= COLLECTION_SIZE,
            "No more Suits in stock!"
        );
        ...
        nonReentrant
    {
        ...
        require(isPublicMintEnabled, "Suits not ready yet!");
        require(totalSupply() + quantity <= COLLECTION_SIZE, "No more Suits!");
