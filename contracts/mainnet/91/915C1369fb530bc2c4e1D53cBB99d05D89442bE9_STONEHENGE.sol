...
/**
   ...
   Rumors about Stonehenge are related to UFOs, and Stonehenge may be one of the tools to connect alien civilizations. 

   According to legend, the westernmost part of the world is where heaven is located. There are no coincidences
   
   https://t.me/stonehengeeth
...
contract STONEHENGE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("UFOs Cemetery", "STONEHENGE") {
