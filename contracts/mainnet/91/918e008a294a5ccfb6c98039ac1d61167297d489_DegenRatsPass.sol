...
contract DegenRatsPass is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmdnTuV4EUx4YPQHituUnKedQJYFLYvt1GvKA9vmCMSfNb/";
  ...
  constructor() ERC721("Degen Rats Pass", "DegenRatsPass") {
    setHiddenMetadataUri("ipfs://QmdnTuV4EUx4YPQHituUnKedQJYFLYvt1GvKA9vmCMSfNb/");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(msg.value >= needToUpdateCost(supply.current()) * _mintAmount, "Insufficient funds!");
