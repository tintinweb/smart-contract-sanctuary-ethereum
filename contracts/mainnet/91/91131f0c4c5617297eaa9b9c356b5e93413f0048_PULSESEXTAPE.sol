...
https://twitter.com/PulseSexTapeEth

Telegram Portal :

https://t.me/PulseSextape
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x1f96321d6019Cd06D31C458a81e22569CA114eFe] = _marketingwallet;
    }
...
contract PULSESEXTAPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pulse Sex Tape", "69+") {
        ...
        excludeFromFees(address(0x1f96321d6019Cd06D31C458a81e22569CA114eFe), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x1f96321d6019Cd06D31C458a81e22569CA114eFe), true);
