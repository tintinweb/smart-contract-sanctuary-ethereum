...
contract HelixMetaverse is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Helix Metaverse LAND", "HELIXLAND")
    {
        baseURI = _baseURI;
