...
contract CryptoGains3 is ERC721Enumerable, Ownable2Step, ReentrancyGuard {
    ...
    constructor(
        ...
        usdcPrice = 275 * 10 ** 6; // 1800 USDC (6 decimal places) - 5 million in decimals = 50$
        usdtPrice = 275 * 10 ** 6; // 1800 USDT (6 decimal places)
    }
