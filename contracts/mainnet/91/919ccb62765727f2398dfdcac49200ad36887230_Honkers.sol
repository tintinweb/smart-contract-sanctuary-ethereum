...
contract Honkers is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public cost = 0.0080085 ether;
 ...
 uint256 ownerTokenCount = balanceOf(msg.sender);
  ...
  //only owner funcs (aka Saavy or whoever)
...
//function to withdraw only to wallet set as owner
