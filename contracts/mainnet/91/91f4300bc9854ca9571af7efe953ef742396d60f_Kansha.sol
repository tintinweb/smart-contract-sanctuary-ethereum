...
/**
    ...
    感謝する - Meaning to Give Thanks 

    During the holiday season, we must come together and give thanks. 

    Buy tax: 2% 
    Sell tax: 2%

    2% - auto lp
    2% - giveaways to the community as a reward of what we create.
...
contract Kansha is Context, IERC20, Ownable {

    using SafeMath for uint256;
    //naming
    string private constant _name = "Kansha Suru";
    ...
    address payable private _developmentAddress = payable(0x1Ef80Ef6d6b5e761FdfAA952d24908449e0aaD32);
    address payable private _marketingAddress = payable(0x1Ef80Ef6d6b5e761FdfAA952d24908449e0aaD32);
