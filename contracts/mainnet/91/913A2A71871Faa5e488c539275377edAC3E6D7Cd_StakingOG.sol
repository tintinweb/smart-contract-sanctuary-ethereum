...
contract StakingOG is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Ownest Staking OGs", "OWNG"){
        StakedMatic = IERC20(0xD14a87025109013B0a2354a775cB335F926Af65A); // dev: 0x1B09895C2AD5a0C6Be4053E5627C3575757C6705, prod: 0xD14a87025109013B0a2354a775cB335F926Af65A
        mintEnabled = true;
        setNodeAPR(480);
        setNodeCommission(500);
        setBaseImageURI("https://api.onigiri.art/ownest/staking/OGs/");
        setRankNameFromRankId(1, "Sage");
        setRankNameFromRankId(2, "Venerable");
        setRankNameFromRankId(3, "Veteran");
        setRankNameFromRankId(4, "Regular");
        setRankNameFromRankId(5, "Rookie");
        setDescriptionForRankId(1, "Holding this NFT gives refunds of commission fees and the special OG title as initial delegators on Ownest validator node of Polygon. Ahoy, adventurer! Seek the mystical card to eliminate commissions on Ownest Validator Node 47 within the Polygon network. With this card, conquer the blockchain, and receive bountiful rewards directly or via the Ownest staking reward contract. Embark on your journey, for limitless treasures await!");
        setDescriptionForRankId(2, "Holding this NFT gives refunds of commission fees and the special OG title as initial delegators on Ownest validator node of Polygon. Ahoy, adventurer! Seek the mystical card to eliminate commissions on Ownest Validator Node 47 within the Polygon network. With this card, conquer the blockchain, and receive bountiful rewards directly or via the Ownest staking reward contract. Embark on your journey, for limitless treasures await!");
        setDescriptionForRankId(3, "Holding this NFT gives refunds of commission fees and the special OG title as initial delegators on Ownest validator node of Polygon. Ahoy, adventurer! Seek the mystical card to eliminate commissions on Ownest Validator Node 47 within the Polygon network. With this card, conquer the blockchain, and receive bountiful rewards directly or via the Ownest staking reward contract. Embark on your journey, for limitless treasures await!");
        setDescriptionForRankId(4, "Holding this NFT gives refunds of commission fees and the special OG title as initial delegators on Ownest validator node of Polygon. Ahoy, adventurer! Seek the mystical card to eliminate commissions on Ownest Validator Node 47 within the Polygon network. With this card, conquer the blockchain, and receive bountiful rewards directly or via the Ownest staking reward contract. Embark on your journey, for limitless treasures await!");
        setDescriptionForRankId(5, "Holding this NFT gives refunds of commission fees and the special OG title as initial delegators on Ownest validator node of Polygon. Ahoy, adventurer! Seek the mystical card to eliminate commissions on Ownest Validator Node 47 within the Polygon network. With this card, conquer the blockchain, and receive bountiful rewards directly or via the Ownest staking reward contract. Embark on your journey, for limitless treasures await!");
        setTitleForRankId(1, "Sage | OG");
        setTitleForRankId(2, "Venerable | OG");
        setTitleForRankId(3, "Veteran | OG");
        setTitleForRankId(4, "Regular | OG");
        setTitleForRankId(5, "Rookie | OG");
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory){
        ...
        bytes memory dataURI = abi.encodePacked(
            '{',
                '"name": "',getTokenTitle(tokenId), ' #', tokenId.toString(), '",',
                ...
                '[',
                    ...
                    '{"trait_type": "Rank", "value": "', getRankName(tokenId),'"}',
                    getAdditionalAttributes(tokenId),
                ']',
            '}'
        );
        return string(
