...
contract CheekyCubClub is ERC721("Cheeky Cub Club", "CCC") {
    ...
    function breedingCondition(uint _howMany, uint _Lion, uint _Cougar)internal{
        ...
        _BreadedLion.push(_Lion);
        _BreededCougar.push(_Cougar);
    ...
    function LionFinder() public view returns(uint[] memory){
        return _BreadedLion;
    }
    function CougarFinder() public view returns(uint[] memory){
        return _BreededCougar;
    }
