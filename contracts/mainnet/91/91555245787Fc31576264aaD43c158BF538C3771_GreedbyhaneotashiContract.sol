...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xE9A981dC95668116D374FeAeD3316dd34588d1F5];
  address public erc20Payable = 0xE9A981dC95668116D374FeAeD3316dd34588d1F5;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 215) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmbEguNqmrNKNVygdgoCg2yv3kVXBf7XYCtP4zAMp4rw6i/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lqylAOfUdKSy8kpTuJkp/contract-metadata";
  }
...
// File: contracts/GreedbyhaneotashiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GreedbyhaneotashiContract is RamppERC721A {
    constructor() RamppERC721A("Greed by haneo tashi", "Greed"){}
}
