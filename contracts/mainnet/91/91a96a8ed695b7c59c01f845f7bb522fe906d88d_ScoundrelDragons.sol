...
/*
   SSS		DDDD	    GGG		NN   NN
 SSSSSSS	DDDDDD	   GGGGG	NNN  NN
 SS   SS	DD   DD	  GG   GG	NNN  NN
  SS		DD   DD	  GG   GG	NNNNNNN
   SSS		DD   DD	  GG		NNNNNNN
     SS		DD   DD	  GG  GGG	NN NNNN
 SS   SS	DD   DD	  GG   GG	NN  NNN
 SSSSSSS	DDDDDD	   GGGGGG	NN  NNN
   SSS		DDDD	    GGGGG	NN   NN
*/
...
contract ScoundrelDragons is IERC721, Ownable, Functional {
    ...
    bool private _revealTokens;  //for URI redirects
     ...
     */
    constructor() {
        _name = "Scoundrels Dragons";
        _symbol = "SDGN";
        _baseURI = "https://scoundrelsmint.io/metadata/";
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == ScoundrelDragons.onERC721Received.selector;
    }
    ...
    function mint() external reentryLock {
        require(mintActive, "Not open for business");
        require((numberMinted + 1) <= totalTokens, "Mint: Not enough avaialability");
        require((_mintTracker[_msgSender()] + 1) <= maxPerWallet, "Mint: Max tkn per wallet exceeded");

        _mintTracker[_msgSender()] += 1;

        //send tokens
        _safeMint(_msgSender(), numberMinted);
        numberMinted += 1;
    }
