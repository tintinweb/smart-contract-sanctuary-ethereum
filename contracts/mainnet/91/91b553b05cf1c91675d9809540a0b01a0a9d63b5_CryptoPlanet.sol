...
/**
Idek what is going on in this space, reckon we should rebrand it at this point. 
Savage seems a bit harsh but it is what it is ygm.

Feels like most of the ppl in this space are degens of some sort who will jeet their mom at x2.

https://t.me/cryptoanimalplanet
...
contract CryptoPlanet is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Crypto Planet";
    string private constant _symbol = "CPLANET";
