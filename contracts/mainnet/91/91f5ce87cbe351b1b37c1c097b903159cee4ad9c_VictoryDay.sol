...
This is the official Victory-Day group,

in honor of the Russian celebration of May 9,

marking the end of World War II

Website: https://victorydayerc20.com

Telegram: https://t.me/VictoryDayErc20

*/

// Verified using https://dapp.tools

// hevm: flattened sources of src/VEDAY.sol
...
contract VictoryDay is Ownable, IERC20 {
    address UNISWAPROUTER = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "Victory Day";
    string private _symbol = "VEDAY";
    ...
    constructor(){
        address _marketingWallet = address(0x919fA5cFACb16eaFBbb4C65D8ED3A25795Ca2483);
        address _liquidityWallet = address(0x919fA5cFACb16eaFBbb4C65D8ED3A25795Ca2483);
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "VEDAY: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "VEDAY: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "VEDAY: Sender is blacklisted");
        require(!isBlacklisted[recipient], "VEDAY: Recipient is blacklisted");

        require(sender != address(0), "VEDAY: transfer from the zero address");
        require(recipient != address(0), "VEDAY: transfer to the zero address");
        ...
        require(
            ...
            "VEDAY: transfer amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(owner != address(0), "VEDAY: approve from the zero address");
        require(spender != address(0), "VEDAY: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }

    function _mint(address account, uint256 amount) private {
        require(account != address(0), "VEDAY: mint to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) private {
        require(account != address(0), "VEDAY: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "VEDAY: burn amount exceeds balance");
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "VEDAY: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "VEDAY: DEX pair can not be removed");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "VEDAY: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "VEDAY: the router is already set to the new address"
        );
    ...
    function compound() public {
        require(compoundingEnabled, "VEDAY: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "VEDAY_DividendTracker";
    string private _symbol = "VEDAY_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "VEDAY_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "VEDAY_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "VEDAY_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "VEDAY_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("VEDAY_DividendTracker: method not implemented");
    }
