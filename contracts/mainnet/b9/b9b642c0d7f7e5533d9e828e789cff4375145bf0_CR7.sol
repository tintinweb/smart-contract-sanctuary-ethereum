...
contract CR7 is ERC20, Ownable {
    ...
    constructor() ERC20("Cristiano Ronaldo Inu","CR7") {
        ...
        marketingWallet = address(0x32db593185F2E0119777215cb0a56eE75C16FC61); // set as marketing wallet
        devWallet = address(0x32db593185F2E0119777215cb0a56eE75C16FC61); // set as dev wallet
