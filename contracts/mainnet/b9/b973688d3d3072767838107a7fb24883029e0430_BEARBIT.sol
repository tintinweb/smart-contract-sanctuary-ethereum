 ...
 * allowances. See {IERC20-approve}.
 */
 contract BEARBIT is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "BEARBIT";
    ...
    address public marketingWallet = 0x3f858bB455Af2a10e7765a5D934d74055eA41E25 ;
    // TOKENOMICS END ============================================================>
    ...
    function changeMaxTxAmount()
        ...
        returns (bool)
    {
        maxTxAmount = _supply * 10**_decimals;
