...
contract Shim is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Inu Metaverse", "SHIM") {
		...
		charityWallet = address(0xe7Edb7C349C991FB9897369238C0eF21f4462Ce6); // set as charity wallet
        marketingWallet = address(0x140579B519067260984FB9Ef47e18DB6c60f9097); // set as marketing wallet
        devWallet = address(0xedd6F9325BE766338319A7c8eE0c9A2d237436F5); // set as dev wallet
