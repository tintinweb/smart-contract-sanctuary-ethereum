    ...
    UUPSUpgradeable
{
    ...
    /// @custom:oz-renamed-from _isDropUnpaused
    BitMapsUpgradeable.BitMap private _isDropPaused;
    ...
    function __QuantumSpaces_init_unchained(
        ...
        _baseURI = "https://core-api.quantum.art/v1/drop/metadata/space/";
        _ipfsURI = "ipfs://";
    ...
    */
    ...
    function _mint(
        ...
        if (_dropNumOfVariants[dropId] > 0 && numOfVariants == 0)
        ...
        )
    {
        ...
        exists = max != 0;
        paused = _isDropPaused.get(dropId);
    }
    ...
    function _beforeTokenTransfers(
        ...
        if (_isDropPaused.get(startTokenId.dropId()))
