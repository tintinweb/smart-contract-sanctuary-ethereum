...
/*
    TG: https://t.me/SHIBCHEDDA_JOIN
    WEB: https://www.shibcheddatoken.com
    TW: https://twitter.com/ShibCheddaToken
*/
...
contract SHIBCHEDDA is Context, IERC20, Ownable {
    ...
    uint256 public _tokensFeeFirst12h = 20;
    ...
    string private constant _name = "SHIBCHEDDA";
    string private constant _symbol = "$SHIBCHEDDA";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xDb26347509c783a6819b2508A602936ab12378bb);
        _feeAddrWallet2 = payable(0xd7b04aC822FaC11de8c5BdeaFA9228f02CB2cC66);
