...
More info on website: retardbots.xyz/

Entry: t.me/retard_bots
Twitter: twitter.com/Retard_Bots
...
contract RetardBots is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Retard Bots";
    string private constant _symbol = "RETARDBOTS";
