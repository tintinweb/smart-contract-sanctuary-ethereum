...
"Itadakimasu" is an essential phrase in your Japanese vocabulary. 
It's often translated as "I humbly receive," but in a mealtime setting, 
it's compared to "Let's eat," "Bon appétit," or "Thanks for the food." 
Some even liken it to the religious tradition of saying grace before eating.

Max Tx - 2%
Max Wallet - 3%
6/6 tax - 2% burn,2%liq,2%marketing

Bringing back rebase! 
A contract that burns some % of supply on every transaction but liquidity stays the same so the value of your holding goes up.

But the uses for itadakimasu extend far beyond food. 
And though its roots are ancient, saying the phrase before meals is a fairly recent Japanese custom. 
Get ready to dig in. You are going to learn the history, uses, meaning, and philosophy behind itadakimasu.

In its simplest form, Itadakimasu 頂きますいただ is used before receiving something. 
That's why the most common itadakimasu translation is:This explains why you say it before you eat. 
You're "receiving" food, after all.

Itadakimasu (and its dictionary form itadaku 頂くいただ　) comes from Japan's roots in Buddhism, 
which teaches respect for all living things. 
This thinking extends to mealtime in the form of thanks to the plants, animals, farmers, hunters, chefs, and everything that went into the meal.
...
contract Itadakimasu is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Itadakimasu';
    string private constant _symbol = unicode'いただきます';
