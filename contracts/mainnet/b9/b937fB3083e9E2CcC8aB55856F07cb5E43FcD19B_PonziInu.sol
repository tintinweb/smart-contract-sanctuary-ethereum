...
👁⃤  Enter the $PONZI - Ponzi Inu 👁⃤

For more: https://medium.com/@ponzi_inu/finally-an-honest-ponzi-ponzi-inu-ce989f9dfa21
...
contract PonziInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ponzi Inu";
