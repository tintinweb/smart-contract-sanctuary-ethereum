...
contract Seventh_Dimensions is Ownable, ERC721A {
    uint256 constant public MAX_SUPPLY = 667;
    ...
    string public CONTRACT_URI = "ipfs://DJA8EZS4X6RYVYA2T5B81WSZ4PX9MBNAI8";
    ...
    address constant internal DEV_ADDRESS = 0xC2353f9dFC149F92cBB39AaEFB9e572D4BB19b0A;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("7th Dimensions", "7D") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 175, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0xC2353f9dFC149F92cBB39AaEFB9e572D4BB19b0A");
