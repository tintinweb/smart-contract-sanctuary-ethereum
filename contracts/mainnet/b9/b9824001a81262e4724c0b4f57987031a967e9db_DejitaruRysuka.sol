...
contract DejitaruRysuka is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "DejitaruRysuka";
    string private _symbol = "RYSUKA";
    ...
    address _owner;
    address payable public marketingAddress = payable(0x1965e9F85Ee883481800d99E8602E8D070c7Fb7d);
    ...
    function Rysuka() public onlyOwner{
         require(block.timestamp > Rysukacooldown, "You cant call Rysuka more than once per day");
    ...
    function RysukaOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         Rysukacooldown = block.timestamp + 86400;
    }
