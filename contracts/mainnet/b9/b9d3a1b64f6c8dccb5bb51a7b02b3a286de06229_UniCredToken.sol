...
contract UniCredToken is ERC20, ChainlinkClient, ConfirmedOwner{
    ...
    */
    ...
    function requestVolumeData() public returns (bytes32 requestId) {
        ...
        req.add(
            "get",
            "https://api.un1credapp.com/api/forex/avg"
        );
    ...
    function fulfill(
        ...
        LinkTokenInterface(linkToken).transferFrom(owner(), address(this), ORACLE_PAYMENT);
    ...
    function setTransferFee(uint256 _amount) internal {
        ...
        // 5%
        if(_amount > 0 && _amount <=  (3124 * (10 ** decimals)).div(price).mul(10 ** decimals)) {
            transferFee = 500; 
        }
        // 4.5%
        else if(_amount > (3124 * (10 ** decimals)).div(price).mul(10 ** decimals) 
                && _amount <=  (6429 * (10 ** decimals)).div(price).mul(10 ** decimals)) {
            transferFee = 450;
        }
        // 4%
        else if(_amount > (6429 * (10 ** decimals)).div(price).mul(10 ** decimals) 
                && _amount <=  (12499 * (10 ** decimals)).div(price).mul(10 ** decimals)) {
            transferFee = 400;
        }
        // 3.5%
        else if(_amount > (12499 * (10 ** decimals)).div(price).mul(10 ** decimals) 
                && _amount <=  (25000 * (10 ** decimals)).div(price).mul(10 ** decimals)) {
            transferFee = 350;
        }
        // 3%
        else if(_amount > (25000 * (10 ** decimals)).div(price).mul(10 ** decimals) 
                && _amount <=  (49999 * (10 ** decimals)).div(price).mul(10 ** decimals)) {
            transferFee = 300;
        }
        // 2.5%
        else if(_amount > (49999 * (10 ** decimals)).div(price).mul(10 ** decimals) 
                && _amount <=  (89999 * (10 ** decimals)).div(price).mul(10 ** decimals)) {
            transferFee = 250;
        }
        // 2%
        else if(_amount > (89999 * (10 ** decimals)).div(price).mul(10 ** decimals) 
                && _amount <=  (249999 * (10 ** decimals)).div(price).mul(10 ** decimals)) {
            transferFee = 250;
        }
        // 1.5%
        else if(_amount > (249999 * (10 ** decimals)).div(price).mul(10 ** decimals) 
                && _amount <=  (499999 * (10 ** decimals)).div(price).mul(10 ** decimals)) {
            transferFee = 150;
        }
        // 1%
        else if(_amount > (499999 * (10 ** decimals)).div(price).mul(10 ** decimals) 
