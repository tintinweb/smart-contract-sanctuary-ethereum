...
contract NanoDIE is ERC20, Ownable {
    ...
    constructor() ERC20("Nano DIE", unicode"纳米死") {
        ...
        marketingWallet = address(0xE4CB7ccfB4A33847349d82977086bE9c1b48A559); // set as marketing wallet
        devWallet = address(0x52341C66B0F8Ae63B12cD06806443ff12C7d1c1D); // set as dev wallet
