...
Your offerings shall be received.
Your misdeeds shall be punished.
*/
...
contract VisionOfHorus is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Vision of Horus", "HORUS") {
