...
contract SHIBERIUMPRO is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shiberium Pro";
    string private constant _symbol = "$SHIBPRO";
    ...
    address payable private _developmentAddress = payable(0x2D512d5D5FE3cAF6AC8dec8a83D88B616168Dea0); 
    address payable private _marketingAddress = payable(0x2D512d5D5FE3cAF6AC8dec8a83D88B616168Dea0);
    ...
    function sendETHToFee(uint256 amount) private {
        _marketingAddress.transfer(amount.mul(2).div(5));
        _developmentAddress.transfer(amount.mul(3).div(5));
    }
