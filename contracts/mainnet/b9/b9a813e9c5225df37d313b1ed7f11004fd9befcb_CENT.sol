...
contract CENT is IERC20, Auth {
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 1_000_000_000 * (10**_decimals);
	string private constant _name         = "Cent Taurus";
	...
	address payable private _walletMarketing = payable(0xf5962F637391baA10df45f66a3D4e8a259A244D3); 
	address payable private _walletDevelopment = payable(0x28122a611f63047Eff34A10e1CE66e4Cf49FFed4); 
	...
	constructor() Auth(msg.sender) {
		...
		_balances[address(this)] =  950_000_000 * (10 ** _decimals);
	...
	function setTaxRates(uint8 newBuyTax, uint8 newSellTax) external onlyOwner {
		require(newBuyTax + newSellTax <= 100, "Roundtrip too high");
