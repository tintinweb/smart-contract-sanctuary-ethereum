...
// ✿ MIMOMORI ✿
// ✿ No promises. But Do not expect nothing 
// ✿ Surprises always come unexpectedly. 
// ✿ Surprises always happen from time to time.
...
contract MIMOMORI  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmWriGjJTZHEimzeYnPuCuEks3jCZHjaFUVSyxpsuD43iP/";

    uint256 public immutable mintPrice = 0.01 ether;
    uint256 public immutable minFeel = 0.003 ether;
    uint32 public immutable maxSupply = 2777;
