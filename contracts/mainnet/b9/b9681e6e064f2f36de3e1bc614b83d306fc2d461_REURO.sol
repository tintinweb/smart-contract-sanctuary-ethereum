...
// REURO - Reflective Euro - Earn 1% Reflections
// Rebases to 1 EURO = 1 REURO Daily (Semi-Random Interval to Prevent Front Running)
...
contract REURO is ERC20UpgradeSafe, OwnableUpgradeSafe {
    ...
    function initialize()
        ...
        initializer
    {
        __ERC20_init("Reflective EURO", "REURO");
