...
//*********************************************************************//
//
//   ______         _ ______         _                  __   _____
//  /_  __/      __(_)_  __/      __(_)  _      _____  / /_ |__  /
//   / / | | /| / / / / / | | /| / / /  | | /| / / _ \/ __ \ /_ < 
//  / /  | |/ |/ / / / /  | |/ |/ / /   | |/ |/ /  __/ /_/ /__/ / 
// /_/   |__/|__/_/ /_/   |__/|__/_/    |__/|__/\___/_.___/____/  
//                                                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xe6793df488A9123451F98A2C82126e8c01514B2D];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xe6793df488A9123451F98A2C82126e8c01514B2D;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 4000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeichvfxogzpnpskezwodwrpe3sxilrtrtq4llqdnyztqzm7pyx7h4q/";
...
// File: contracts/TwiTwiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TwiTwiContract is RamppERC721A {
    constructor() RamppERC721A("TwiTwi", "TT"){}
}
