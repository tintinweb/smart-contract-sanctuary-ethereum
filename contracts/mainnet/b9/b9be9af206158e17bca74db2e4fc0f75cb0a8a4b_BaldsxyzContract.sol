...
// /_____/_/  |_/_____/_____/   /____(_)_/|_|\__, / /___/
//                                          /____/       
//     
//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmcv91p8hF2gUCgmC2KM8wJb9heq7T3b1odQt6HLFDj8B7/";
...
// File: contracts/BaldsxyzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BaldsxyzContract is RamppERC721A {
    constructor() RamppERC721A("Baldsxyz", "BALDS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/IGoZnC4KPGivbeWPaD09/contract-metadata";
    }
}
