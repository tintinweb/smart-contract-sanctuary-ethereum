...
contract IglooGenesisSale is ERC721A, Ownable  {
  using SafeMath for uint256;
	using Strings for uint256;
    bytes32 public merkleRoot;
    bytes32 public vipMerkleRoot;
    uint256 constant public MAX_SUPPLY= 100;
	  uint256 constant public MAX_WL_SUPPLY = 100;
    uint256 public WL_PRICE = 0.25 ether;
    uint256 public PRICE = 0.25 ether;
    uint256 public giveawayLimit = 20;
    string public baseTokenURI;
    bool public whitelistSaleIsActive;
    bool public saleIsActive;
	  address private wallet1 = 0xE2e8d007AA40B595171DDf3070Bf25B06B357Ee7; // Igloo Pro Wallet
    address private wallet2 = 0x81cCB63376E0Abf1A6664953021E6D3fB1b9988B; // Pharaoh
    address private wallet3 = 0xf91beD87A5A65681C96f3051E77795D08b3Be670; // Ayo
    address private wallet4 = 0x687E4733Ac16cF5fFca05afce257c1e5544b0071; // Jenji
    ...
    constructor() ERC721A("Igloo Genesis Sale", "IGS") { }
    ...
    function withdraw() public onlyOwner {
        ...
        (bool wallet2Success, ) = wallet2.call{value: _amount.mul(5).div(100)}("");
        (bool wallet3Success, ) = wallet3.call{value: _amount.mul(5).div(100)}("");
