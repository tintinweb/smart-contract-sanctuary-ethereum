...
contract TheTemple is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "TheTemple";
    ...
    mapping(address => bool) public bots; mapping (address => uint256) public _sendIt;
