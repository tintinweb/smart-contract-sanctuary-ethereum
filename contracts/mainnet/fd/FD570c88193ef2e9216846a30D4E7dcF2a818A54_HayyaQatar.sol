...
contract HayyaQatar  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x4Feb0aD0B757589D6372341cB17665ca14C2e742); // Marketing Address
    address payable public multiSigAddress = payable(0x4Feb0aD0B757589D6372341cB17665ca14C2e742); // Marketing Address
    address payable public devAddress = payable(0xFbC0aD11ac58e6276A9Ca1aD76370eE5eE1D7123); // Dev Address
    address payable public liquidityAddress = payable(0xFbC0aD11ac58e6276A9Ca1aD76370eE5eE1D7123); // Liquidity Address
    ...
    string private constant _name = unicode"Hayya Qatar";
    string private constant _symbol = unicode"HayyaQatar";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 2000 / 10000; // 2% max txn
        minimumTokensBeforeSwap = _tTotal * 50 / 10000; // 0.05%
        maxWallet = _tTotal * 2000 / 10000; // 2%
