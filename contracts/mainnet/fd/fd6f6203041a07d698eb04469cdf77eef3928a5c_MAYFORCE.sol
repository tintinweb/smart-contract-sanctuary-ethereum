...
/**
   ...
   _____                 ___________                          
  /     \ _____  ___.__. \_   _____/__________   ____  ____   
...
www.twitter.com/forceeth

https://t.me/may_force_portal
...
contract MAYFORCE is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _name = "MAYFORCE";
    string private constant _symbol = "FORCE";
    ...
    uint256 public taxBuyMarketing = 6;
    uint256 public taxBuyTreasury = 2;
    uint256 public taxBuyReflections = 3;
    uint256 public taxBuyLiquidity = 1;
    uint256 public taxSellMarketing = 6;
    uint256 public taxSellTreasury = 2;
    uint256 public taxSellReflections = 3;
    uint256 public taxSellLiquidity = 1;
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x8289ac28Fc3e45F85d6EB37F130b405001d31271);
        TreasuryWallet = payable(0x8289ac28Fc3e45F85d6EB37F130b405001d31271);
        DevWallet = payable(0x8289ac28Fc3e45F85d6EB37F130b405001d31271);
