...
contract BEARMARKET is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("BEAR MARKET ACADEMY", "BMA", 100, maxSupply) {
    }
