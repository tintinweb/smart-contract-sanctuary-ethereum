...
contract FlokTama is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "FlokTama";//
    string private constant _symbol = "FLOTA";//
    ...
    address payable private _developmentAddress = payable(0x9f8529acB0A9A80f3994Bab992891368FA7b48c0);//
    address payable private _marketingAddress = payable(0xBcA58FEf0FaE488420fE051c70FC7137C7D745a9);//
