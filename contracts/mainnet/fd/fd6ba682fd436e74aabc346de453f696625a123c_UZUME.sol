...
contract UZUME is Context, IERC20, Ownable {
    ...
    string private constant _name = "Goddess of Dawn";
    string private constant _symbol = "UZUME";
    ...
    uint256 public _maxWalletSize = 200000 * 10**8;
