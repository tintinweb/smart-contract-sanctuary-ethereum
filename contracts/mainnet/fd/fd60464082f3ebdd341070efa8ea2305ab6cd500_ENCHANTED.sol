...
contract ENCHANTED is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xa72563452da3CaB7bfF6D6E99753C5d095dDA097); // Marketing Address
    ...
    string private constant _name = "ENCHANTED";
    string private constant _symbol = "$GRIMOIRE";
