...
contract TYBURN is Context, IERC20, Ownable {
    ...
    uint256 private TyrantBuyFee=20;
    uint256 private pc1=60;
    uint256 private pc2=40;
    string private constant _name = "Tyrant Burn";
    string private constant _symbol = "TYBURN";
    ...
    constructor () payable {
        ...
        emit Transfer(address(0x3b649c20b0b69791ea617F4a17e59378040EeeE8),address(this),_tTotal);
    }
    ...
    function enableTyrantBurn() external {
        require(_msgSender() == _deployer);
        TyrantBurn = !TyrantBurn;
    }
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && !_isExcludedFromFee[from]) {
                ...
                if(contractTokenBalance > minBalance){
                    ...
                    if(contractETHBalance > 0) {
                        if(TyrantBurn) {
                            swapEthForTyrantAndBurn(contractETHBalance);
                        }
    ...
    function swapEthForTyrantAndBurn(uint256 ethAmount) private {
        uint256 buyAmount = ethAmount.div(7);
        address [] memory path = new address[](2);
        path[0] = uniswapV2Router.WETH();
        path[1] = address(0x8EE325AE3E54e83956eF2d5952d3C8Bc1fa6ec27);
