...
contract IkigaiOma is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x216Ae0f86B88919D477500e7158D7798b029a6B4));

    string private _name = "IkigaiOma";
    string private _symbol = "Ikioma";
