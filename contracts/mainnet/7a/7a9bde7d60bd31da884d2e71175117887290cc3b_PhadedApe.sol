...
contract PhadedApe is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmVU9nUjbgXBEw2X5zeCDSpkZVZPZCkhJDofoVH9aySESj/";
    ...
    constructor(string memory initBaseURI) ERC721A("Phaded Ape", "PA") {
        baseURI = initBaseURI;
