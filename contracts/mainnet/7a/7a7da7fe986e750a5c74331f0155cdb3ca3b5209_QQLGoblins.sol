...
contract QQLGoblins is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.1 ether;
    uint256 public MAX_SUPPLY = 555;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "https://rasc.mypinata.cloud/ipfs/QmWnoVd15qypEMFnhVVKdLygFCiB3TyXL9sFBDVXYHAZe9/";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("QQL Goblins", "QQLGOBLIN", MAX_MINTS, MAX_SUPPLY) {  
    }
