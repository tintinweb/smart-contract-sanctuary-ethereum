...
Hold $BLAIKA to earn $LAIKA

Tax 4/4
Max Transaction 2%
Max Wallet 4%

Twitter: https://twitter.com/babylaika_eth
Telegram: https://t.me/babylaikapreverify
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    //------Main Net router address------//
    // address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    //------Test Net router address------//
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    IBEP20 RewardToken = IBEP20(0x77f9CF0bd8C500CfFdF420e72343893aeCC2EC0b); //Laika
...
contract BabyLaika is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Laika";
    string constant _symbol = "$BLAIKA";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
	address marketingAddress = 0x51ea913c50d20149CC8928DfF9Ab4857676509e1; //dev wallet

    uint256 _totalSupply = 1 * 1000000000000000 * (10 ** _decimals);
    ...
    uint256 public silentBlockNumber = 1;
