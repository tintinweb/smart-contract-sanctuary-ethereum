...
contract FinRa is Context, IERC20, Ownable {
    ...
    string private constant _name = "FinRa";
    string private constant _symbol = "FinRa";
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
     ...
     function swapTokensForEthNew(uint256 tokenAmount) private lockTheSwap {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        _approve(address(this), address(uniswapV2Router), tokenAmount);
    ...
    function openTradingNewNew() external onlyOwner() {
        require(!tradingOpen,"trading is already open");
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Router = _uniswapV2Router;
        _approve(address(this), address(uniswapV2Router), _tTotal);
