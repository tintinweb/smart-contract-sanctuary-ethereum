...
/**
    ...
    In Japanese mythology, the Seven Lucky Gods or Seven Gods of Fortune (七福神, shichifukujin in Japanese) are believed to grant good luck.
    They are often represented in netsuke and in artworks.
    ...
    During the course of their history, the mutual influence between gods has created confusion about which of them was the patron of certain professions.
...
contract Shichifukujin is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Shichifukujin";
    string constant _symbol = unicode"七福神";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 7 * (10 ** _decimals);
    ...
    function setmarketingFee(uint256 _marketingFee) external onlyOwner {
        ...
        require(marketingFee<=10,"Fees cannot be more than 10%");
    }
