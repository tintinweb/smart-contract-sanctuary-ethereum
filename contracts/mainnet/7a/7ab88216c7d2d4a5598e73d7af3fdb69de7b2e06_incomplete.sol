...
contract incomplete is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmap9m1utdpVKeRtUJ5ckx4XqJWTZf4Nq1TPSYKvKieaTE";
    ...
    constructor(
    ) ERC721A("incomplete by Famous When Dead", "FWD", 100, maxSupply) {
    }
