...
// Main Contract Logic 
// --------------------------------------------------------------
contract Kuroshi  is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Kuroshi";
    string private _symbol = "$Kuroshi";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x5E18004bE66116dd14b783DC0478126221197545);
    address payable public operationsWallet =  payable(0x20c4D86CC3Ac4187790aBC1ce9147381a5478Bf3);
    ...
    uint256 public maxTotalFeeSell = 49;
