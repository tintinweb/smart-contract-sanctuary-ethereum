...
/*
   ...
   / /\ \ |  _  /| |  | |  __/ /\ \       | | | . ` | |  | |
  / ____ \| | \ \| |__| | | / ____ \     _| |_| |\  | |__| |
 /_/    \_\_|  \_\\____/|_|/_/    \_\   |_____|_| \_|\____/ 
                                                            
🌐https://arufainu.com/
📡https://t.me/ArufaINU
ARUFA INU (translated Alpha INU) ais a community dedicated to send apes to space. Experience a professional space travel by joining our community and growing with our team.
We constantly working on our project success - currently finished Alpha preparation and will be launching it to space! No apes were harmed or miss treated
during the process. Grab your space helmet and join us! Remember Alpha collection is one and only collection that will be launched.
...
contract ALPHA is Context, IERC20, Ownable {
    ...
    string private constant _name = "ArufaINU";
    ...
    constructor () {
        _MarketingWallet = payable(0x4A4A100C92CEA1D56e15beb13962659AC104736a);
        _liquidityWallet = payable(address(0x4A4A100C92CEA1D56e15beb13962659AC104736a));
        _rOwned[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_MarketingWallet] = true;
        _isExcludedFromFee[_liquidityWallet] = true;
        emit Transfer(address(0xab10f851276766270369a56f2af2647858D89ac4), _msgSender(), _tTotal);
    }
