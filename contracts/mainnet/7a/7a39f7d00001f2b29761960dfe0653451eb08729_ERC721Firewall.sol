...
import './AccessMaintainer.sol';
import './IWhitelist.sol';

contract Whitelist is AccessMaintainer, IWhitelist {
...
contract Allocator is AccessMaintainer, IAllocator {
    ...
    function allocate(address allocator, uint256 amount) public override onlyMaintainer onlyWhenAllocatable(allocator, amount) {
...
contract AccessMaintainer is Ownable, AccessControl {
    ...
    modifier onlyMaintainer {
        require(msg.sender == owner() || hasRole(MAINTAINER_ROLE, msg.sender),
            'AccessMaintainer: only owner and or maintainers can call this method');
        _;
    }
