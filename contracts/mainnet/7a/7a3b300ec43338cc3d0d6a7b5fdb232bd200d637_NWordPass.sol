...
contract NWordPass is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmek4EEUzP22GEsqSaWXpeGgt2eCfDB8mDQHzTjdK9XRkJ";
    address private openSeaProxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    bool private isOpenSeaProxyActive = true;

    uint256 public constant MAX_MINTS_PER_TX = 1;
    uint256 public maxSupply = 999;

    uint256 public constant PUBLIC_SALE_PRICE = 0.00 ether;
    ...
    constructor(
    ) ERC721A("N-Word Pass", "N", 100, maxSupply) {
    }
