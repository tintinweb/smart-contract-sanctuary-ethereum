...
contract Blizzard is StandardToken {
...
//contract name above is also TutorialToken instead of Blizzard
    ...
    function Blizzard(
        ...
        name = "Blizzard";                              // Set the name for display purposes
        decimals = 0;                                   // Amount of decimals for display purposes
        symbol = "BLIZ";                                // Set the symbol for display purposes
    }
