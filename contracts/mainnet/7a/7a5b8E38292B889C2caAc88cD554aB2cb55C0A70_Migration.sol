...
contract Migration is Ownable {
    ...
    constructor() {
        ...
        // Token V1
        token1 = IERC20(address(0x703841230b744aDA54356449E9FebAd09D5eD972));
        
        // Token V2 -- will be updated to new Contract once live
        token2 = IERC20(address(0xF9366FB1778315Fc90c1e3e6dd5199C9C2Bb3A73));  // UPDATE
        
        // change to token owner or liquidity holder (usually the project owner, not the developer) before launch
        liquidityWalletForV2 = address(0xa62dD96D8D4aBf0894166935702bA69bB9fB2f16);  // UPDATE
