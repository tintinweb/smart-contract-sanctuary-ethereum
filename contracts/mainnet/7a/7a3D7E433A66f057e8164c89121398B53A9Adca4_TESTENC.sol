...
/**
 * @title Elchai Car Club | Card NFT
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */

contract TESTENC is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _uri) ERC721("TESTENC", "ECN") {
        baseTokenURI =_uri;
    }
    ...
    function nftsAvailabelForFreeMint() external view returns(uint256) {
        return (max_nft_supply - maxReservedMints);
    }
