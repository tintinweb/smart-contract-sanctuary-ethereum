...
This waifu is the perfect mix of strong and sexy
she can break your heart and your face if you're a jeet
your buys make her BOUNCE
We have re-animated the Kizo fork to include in our project
a stronger marketing push and  development plan 
through higher Marketing/ Dev taxes
Enjoy the same benefits of 0% tax on buys and sells
If you can hold!
...
https://www.waifuma.com
https://t.me/WaifumaEntry
*/
...
contract WAIFUMA is ERC20, Ownable {
    ...
    uint256 public marketingPercent = 25; // 25% of total collected tax
    uint256 public devPercent = 25; // 25% of total collected tax


    address payable public marketingWallet = payable(0x0683BB6594ECEd07edcC7dE2A6F55f81121a4A94);
    address payable public devWallet = payable(0xb05AFB7197a8FD0265f809498566edF9B309edf6);
    ...
    constructor() ERC20("Waifuma", "WAIFUMA") {

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Uniswap Router Adress
