...
contract thelastgboy is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeid6uprdvlpra5sllojebjpuprltlu3k3gyedmdp266i5b6elpgo7e/", Strings.toString(tokenId), ".json")
            );
    }
