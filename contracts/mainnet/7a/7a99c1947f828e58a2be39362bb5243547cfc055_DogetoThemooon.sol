...
/**
Loud with Elon. Doge to The moon
low tax 4
*/
...
contract DogetoThemooon is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Doge to The mooon";
    ...
    uint256 public _taxSwap= 30000000 * 10**_decimals;
