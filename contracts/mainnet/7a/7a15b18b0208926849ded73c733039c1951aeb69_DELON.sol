...
Twitter at 10k MC
TG at 20k MC
Lock and Renounce at launch
Lock to be increased at incrementals of every 25k MC
Anti whale 2% max wallet
Anti dumping 2% max txn 
...
contract DELON is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DELON", "DARK ELON") {
        ...
        uint256 _earlySellMarketingFee = 24;
