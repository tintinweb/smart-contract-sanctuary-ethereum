...
Ares is the Greek god of war and courage. He is one of the Twelve Olympians
join us
Tg : https://t.me/WeAreTsuru
Website: https://wearetsuru.io/
Twitter: https://twitter.com/wearetsuru?s=21&t=w4XgCslM9ZK8Hdqwx9C8qw
*/
...
contract Tsuru is ERC20, Ownable {
    ...
    constructor() ERC20("Tsuru", "$TSURU") payable {
    	...
    	marketingWallet = address(0x1748c52679E4269fb9705BfbDB20005D9e395a51); // set as Marketing wallet
        devWallet = address(0x1748c52679E4269fb9705BfbDB20005D9e395a51); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x1748c52679E4269fb9705BfbDB20005D9e395a51, true);
        excludeFromFees(0x1748c52679E4269fb9705BfbDB20005D9e395a51, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x1748c52679E4269fb9705BfbDB20005D9e395a51, true);
        excludeFromMaxTransaction(0x1748c52679E4269fb9705BfbDB20005D9e395a51, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x1748c52679E4269fb9705BfbDB20005D9e395a51,
            block.timestamp
        );
    }
