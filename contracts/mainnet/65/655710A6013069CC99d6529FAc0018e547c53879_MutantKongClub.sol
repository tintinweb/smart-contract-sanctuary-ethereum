...
contract MutantKongClub is ERC721ANamable, Ownable {  
    ...
    constructor ( ) 
    ERC721ANamable ("Mutant Kong Club", "MKC", 10, 10015) {}
    ...
    function MintPublic(uint256 _amount) external payable {
        ...
        require(supply+_amount<=MAX_SUPPLY-FREE_SUPPLY, "Exceed Max Supply");
    ...
    function MintPresale(uint256 _amount, bytes memory _signature) public payable {
        ...
        if(rarity == signer_wl){
            ...
            require(supply+_amount<=MAX_SUPPLY, "Exceed Max Supply");
...
contract ERC721ANamable is ERC721A {
	...
	constructor(string memory _name, string memory _symbol, uint256 maxBatchSize_, uint256 collectionSize_) ERC721A(_name, _symbol, maxBatchSize_, collectionSize_) {
