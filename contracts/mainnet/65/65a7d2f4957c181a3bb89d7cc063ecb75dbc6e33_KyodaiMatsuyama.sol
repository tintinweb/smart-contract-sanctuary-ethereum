...
contract KyodaiMatsuyama is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Kyodai Matsuyama";
    string private constant _symbol = unicode"MARUKA";
