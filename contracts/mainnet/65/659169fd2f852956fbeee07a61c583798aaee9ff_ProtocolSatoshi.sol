...
contract ProtocolSatoshi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "The Protocol Satoshi";
    string private _symbol = "$PROTOSHI ";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x64f04ACE67A1CF3331A739960E514D4eA6d46578));
        marketingWalletAddress = payable(address(0x64f04ACE67A1CF3331A739960E514D4eA6d46578));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x64f04ACE67A1CF3331A739960E514D4eA6d46578), _msgSender(), _totalSupply);
    }
