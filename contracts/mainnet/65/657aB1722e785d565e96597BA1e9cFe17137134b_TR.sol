...
Telegram: https://t.me/tholosrequest
Website: https://tholosrequest.tech/
...
contract TR is ERC20, Ownable {
    ...
    constructor() ERC20("TholosRequest", "TR") {
        ...
        maxTransactionAmount = 100000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 100000 * 1e18; // 1% from total supply maxWallet
		...
		charityWallet = address(0x017642Dc5ebBdfA0A25F8F03Ecd8a6283ce34453); // set as charity wallet
        marketingWallet = address(0x017642Dc5ebBdfA0A25F8F03Ecd8a6283ce34453); // set as marketing wallet
        devWallet = address(0x017642Dc5ebBdfA0A25F8F03Ecd8a6283ce34453); // set as dev wallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 5) / 1000000000) / 1e18,
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 20, "Max BuyFee 20%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 100, "Max SellFee 100%");
