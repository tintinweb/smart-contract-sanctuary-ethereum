...
https://t.me/PlanetDAO

As the clock ticks on humanity's response to the ever-growing crisis climate change, 
Planet DAO combines cryptocurrency's unprecedented capability to form networks with a 
powerful drive to solve real problems.
...
contract PlanetDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Planet DAO", "PDAO") {
        ...
        marketingWallet = address(0x856d1F4C666003bDa58F5bF032384948a20ef51d); // set as marketing wallet
        devWallet = address(0x856d1F4C666003bDa58F5bF032384948a20ef51d); // set as dev wallet
    ...
    function setPDAOModifier(address account, bool onOrOff) external onlyOwner {
