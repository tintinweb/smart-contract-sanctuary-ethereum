...
/**
            👊 HAITAMA 👊 inspired by the King of all tokens, 
            SAITAMA INU. It will follow the Trend and strategy 
            which SAITAMA had it in the back days for the growth hack. 

            Official TG - https://t.me/haitamaofficial

            Twitter - https://twitter.com/haitamaerc20
...
// SPDX-License-Identifier: MIT
    ...
    contract HAITAMA is Context, IERC20, Ownable {
    ...
    uint256 public _tokensBuyFee = 0;
    uint256 public _tokensSellFee = 6;
    ...
    string private constant _name = "HAITAMA";
    string private constant _symbol = "HAITAMA";
    ...
    constructor () {
        ...
        _feeAddrWallet1 = payable(0xCd57D6114B82DF2f62C03223185276Dbc3BD011B);
        _feeAddrWallet2 = payable(0xCd57D6114B82DF2f62C03223185276Dbc3BD011B);
        ...
        emit Transfer(address(0xBE7C3Dc615245D3404858386ce6E2443ddd4bC25), _msgSender(), _tTotal);
    }
    ...
    function updateBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 100, 'fee can not set more than 100%');
        _tokensBuyFee = _fee;
    }
