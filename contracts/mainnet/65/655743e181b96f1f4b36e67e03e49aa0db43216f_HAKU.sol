...
Spirit Oblations (Hakuzōsu)

One day, a deer hunt took place at a nearby farm. Many people traveled to the farm to witness the hunt. 
Hakuzōsu (the kitsune) went to spectate as well. At the farm, two dogs belonging to a samurai sensed the kitsune’s true identity. 
The leaped upon Hakuzōsu and ripped him to pieces. When the dogs were finally called off of the old monk, the torn body of an old, 
silver-furred kitsune was discovered and Hakuzōsu’s true form was exposed.

https://t.me/hakuzosuerc
https://medium.com/@TheHakuzosu
...
contract HAKU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hakuzosu", "HAKU") {
    ...
    function _transfer(
        ...
        // early sell logic - > CHANGE TIME FOR DEPLOY (24 hours)
