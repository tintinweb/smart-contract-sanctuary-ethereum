...
/*
LiquidLock $LL
LiquidLock is a multi-chain liquidity locking service available on Arbitrum, Shibarium and Polygon. 
Secure your LP tokens or lock your personal tokens to prevent you from spending them!

TG: https://t.me/+Y2Vfoi9RpfQ4MDNh
Website : https://Liquidlock.xyz/
Twitter: http://twitter.com/liquidlock_erc
Medium: https://medium.com/@liquidlock_ERC/introducing-liquidlock-6d4f9fb456a4
*/
...
contract LL is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Liquid Lock";
    string private constant _symbol = "LL";
    ...
    address payable private _developmentAddress = payable(0xe8Af88c98BDd8FA4c8A02987f880697084c8939d); 
    address payable private _marketingAddress = payable(0xe8Af88c98BDd8FA4c8A02987f880697084c8939d);
