...
contract Peeeee is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("peeeeeeeeeeee", "pee") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmXN1fkwjPhfDy5aPEtqW5UnEccX6RL34L1LvVag4yMfZd/", _toString(tokenId), ".json"));
    }
