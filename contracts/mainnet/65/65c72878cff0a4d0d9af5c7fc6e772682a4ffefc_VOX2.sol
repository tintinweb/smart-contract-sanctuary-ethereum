...
contract VOX2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Prooof of Vox Dei", "VOX 2.0") {
     ...
     uint256 totalSupply = 3 * 10 ** 6 * 10 ** decimals();
 
        maxTransactionAmount = 50 * 10 ** 3 * 10 ** decimals(); 
        maxWallet = 50 * 10 ** 3 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0x12Fc03581499CD9530681A02aAA8d27495d3427b); // set as Marketing wallet
        DevWallet = address(0x12Fc03581499CD9530681A02aAA8d27495d3427b); // set as dev wallet
