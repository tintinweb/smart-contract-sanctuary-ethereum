...
contract KumaFasshon is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"KumaFasshon";
    string private constant _symbol = unicode"KUMA";
