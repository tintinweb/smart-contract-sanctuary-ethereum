...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xDCe29588b892768515e758628c9FA16E4E9C5c00] = _marketingwallet;
    }
...
contract cSolana is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("New Community Solana", "cSOL") {
        ...
        excludeFromFees(address(0xDCe29588b892768515e758628c9FA16E4E9C5c00), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xDCe29588b892768515e758628c9FA16E4E9C5c00), true);
