...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1656208800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1656208500;
  ...
  */
  ...
  function useAllowlistDropTime() public onlyOwner {
    enforceAllowlistDropTime = true;
  }

  function disableAllowlistDropTime() public onlyOwner {
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF4ed0716C55fbCa4DB1a772FF2f32902B120843a];
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 4444) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRA9CMboWYxcQYRe1JqPCZrydS9TfKombKbTKKRuR8U6D/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 4444");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 4444");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 4444");
...
// File: contracts/BoolishbunniesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BoolishbunniesContract is RamppERC721A {
    constructor() RamppERC721A("boolish bunnies", "BOOLISH"){}
}