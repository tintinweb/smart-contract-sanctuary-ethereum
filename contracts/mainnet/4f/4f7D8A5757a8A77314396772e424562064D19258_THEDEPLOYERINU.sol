...
contract THEDEPLOYERINU  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "THE DEPLOYER INU";
    string private constant _symbol = "DEPLOYER";
    ...
    address payable private _developmentAddress = payable(0xbB91E2fBD9b3d6370b05925f62AA9FeD69A2ebFb); 
    address payable private _marketingAddress = payable(0xbB91E2fBD9b3d6370b05925f62AA9FeD69A2ebFb);
