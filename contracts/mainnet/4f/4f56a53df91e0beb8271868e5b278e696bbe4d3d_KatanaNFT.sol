...
contract KatanaNFT is ERC721("KatanaNFT", "KatanaNFT"), Ownable {
    
    uint256 tokenCounter = 0;
    uint256 public price = 5e16; // 0.05 ETH
    uint256 public MAX_TOKENS = 2500; // maximum supply
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmRknvp6wN75G2yyT3FgFnaTUFZYQN3bJp2SDb1L74Vj4Y/"; //METADATA
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (_msgSender() != owner()) { 
                ...
                require(msg.value >= price * _mintAmount, "The price per NFT is 0.05 ETH.");   
        }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0 ? string(abi.encodePacked(currentBaseURI, "0", baseExtension)) : "";
    }
