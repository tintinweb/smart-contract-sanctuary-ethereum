...
/* 
Shibariun Burn ($SB)
First ordinal deflationary token with a revolutionary burning mechanism to reduce the total supply.
Get ready to step into the cutting-edge world of Shibarium Burn ($SB) and prepare to have your mind blown by the seriously cool new lingo you’ll learn! 
Ordinals and Inscriptions are just the tip of the iceberg. 
 
https://shibariumburn.lol/
https://t.me/shibariumburnportal
https://medium.com/@shibariumburn
*/
...
contract SB is ERC20, Ownable { 
    ...
    constructor() ERC20("Shibarium Burn", "SB") { 
        ...
        marketingWallet = address(0x29fB277b39Fd7c7F8108A0a85d4DA7e87d0b3ed4);
        developmentWallet = address(0x29fB277b39Fd7c7F8108A0a85d4DA7e87d0b3ed4);
