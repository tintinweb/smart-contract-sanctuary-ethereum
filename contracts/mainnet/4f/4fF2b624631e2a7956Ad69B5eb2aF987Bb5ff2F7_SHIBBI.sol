...
contract SHIBBI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shibbi", "SHIBBI") {
        ...
        marketingWallet = address(0x6FaAD7d84dA1f5e6209822C015d86d311257cD9D); // set as marketing wallet
        devWallet = address(0x7510Cf4727D07408680fC0862Be6F4b89D818999); // set as dev wallet
