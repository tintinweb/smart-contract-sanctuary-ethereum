...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x1687cf4999ccA3DFCA0B068D9e8A59790c35873B];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x1687cf4999ccA3DFCA0B068D9e8A59790c35873B;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 497) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmUqbdXcR3J4KmdMeUM5fbcZyk8LQyeFouxax7k4bLTvDr/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 497");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 497");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 497");
...
// File: contracts/RampageDinoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RampageDinoContract is RamppERC721A {
    constructor() RamppERC721A("Rampage Dino", "Bone"){}
}
