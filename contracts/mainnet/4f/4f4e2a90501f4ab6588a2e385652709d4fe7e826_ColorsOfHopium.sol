...
// File contracts/ColorsOfHopium.sol
...
contract ColorsOfHopium is ERC721A, IERC2981, Ownable {
    using Strings for uint256;

    ///////////////////////////////////////////////////////////////////////////
    // Public constants
    ///////////////////////////////////////////////////////////////////////////
    uint256 constant public MAX_SUPPLY = 4269;
    uint256 constant public MAX_PER_WALLET = 10;

    ///////////////////////////////////////////////////////////////////////////
    // Important Globals
    ///////////////////////////////////////////////////////////////////////////
    uint256 public publicSaleTime = 1654610400;

    // how many has each address minted
    mapping (address => uint256) userMinted;

    string public provenance;
    string private baseURI = "ipfs://bafybeiaidpxrygckmja5khnrvulmnjbmctbphohcxzvxjdhe4plokwv7ja/";

    address constant public LARKIN = 0x14E8F54f35eE42Cdf436A19086659B34dA6D9D47;
    ...
    ///////////////////////////////////////////////////////////////////////////
    constructor() ERC721A("ColorsOfHopium", "CHOPIUM") {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory mBaseURI = baseURI;
    ...
    function mint(uint256 _amount) external {
        //if (msg.sender != tx.origin) revert MintClosed();
    ...
    function withdrawETH() public onlyDev {
        ...
        address payable wallet = payable(LARKIN);
        // Send payment
        Address.sendValue(wallet, totalETH);

        emit ETHWithdrawn(totalETH);
    }

    // Royalties in any ERC20 are accepted
    function withdrawERC20(IERC20 _token) public onlyDev {
        uint256 totalERC20 = _token.balanceOf(address(this));
        if (totalERC20 == 0) revert EmptyWithdraw();

        // Send payment
        _token.transfer(LARKIN, totalERC20);
