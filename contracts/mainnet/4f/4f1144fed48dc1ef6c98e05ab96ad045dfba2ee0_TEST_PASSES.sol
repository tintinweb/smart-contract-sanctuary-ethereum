...
contract TEST_PASSES is ERC721 {
    ...
    constructor() ERC721("Test Pass ETH", "PASS") public {
 ...
 function contractURI() public pure returns (string memory) {
   ...
   function TOKEN_VALUE() public view returns (uint256) {
        ...
        return((300000000000000000000000000000 / (uint256(price) * 0.000000000000000001 ether)));
 ...
 function TEST_PASS() public payable returns (uint256) {
        ...
        address payable ownert = 0x8F0e79Cd19c489F1b428c145C2dF7a200D49426D;
