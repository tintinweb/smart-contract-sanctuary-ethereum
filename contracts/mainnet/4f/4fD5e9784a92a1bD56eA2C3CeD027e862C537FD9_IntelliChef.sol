...
Your New Favorite Kitchen Assistant
The IntelliChef Bot is an extremely convenient solution to the usual meal planning and recipe problem. 
You know... The old "What should I cook?" dilemma. It is fueled by artificial intelligence, and it 
offers a unique value proposition.

Telegram: https://t.me/IntelliChef
Website: https://intellichef.app/
Twitter: https://twitter.com/IntelliChef
...
contract IntelliChef is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "IntelliChef";
    string private constant _symbol = "$ICHF";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require (_redisFeeOnBuy+_redisFeeOnSell+_taxFeeOnBuy+_taxFeeOnSell <= 55);
    }
