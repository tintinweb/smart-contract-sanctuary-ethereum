 ...
 */
contract ERC721AUpgradeable is ERC721A__Initializable, IERC721AUpgradeable, BBTy {
     ...
     * an out-of-gas error (10K pfp collections should be fine).
     */
    function tokensOfOwner_(address owner) internal view returns (uint256[] memory) {
        unchecked {
            uint256 tokenIdsIdx;
            address currOwnershipAddr;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        if (!showup) {
            return "ipfs://QmbwjccTsqdzeQ4diRjvc459T7Ut1H1v3sPhYkJt8S87nQ";
        } else {
     ...
     */
    function approve(address to, uint256 tokenId) public override unlockedToken(tokenId) {
