...
contract Inu is ERC20, Ownable {
    ...
    constructor() ERC20("5x Inu", "IIIIINU") {
        ...
        maxWallet = 50_000_000 * 1e18; // 3% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 3) / 10000; // 0.03% swap wallet

        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;

        marketingWallet = address(0x136b9A05cb561882Fbd0Ed023cE8Dac8890fb74A); // set as marketing wallet
        devWallet = address(0x136b9A05cb561882Fbd0Ed023cE8Dac8890fb74A); // set as dev wallet
