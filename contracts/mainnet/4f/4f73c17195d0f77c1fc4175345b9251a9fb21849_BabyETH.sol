...
/**
    BabyETH ERC Token
    Telegram: https://t.me/babyethportal
*/
...
contract BabyETH is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6C62b7348145CAeb93278403cF65f9DdE0c7DC73); // Marketing Address
    address payable public multiSigAddress = payable(0x6C62b7348145CAeb93278403cF65f9DdE0c7DC73); // Marketing Address
    address payable public devAddress = payable(0x6C62b7348145CAeb93278403cF65f9DdE0c7DC73); // Dev Address
    address payable public liquidityAddress = payable(0x6C62b7348145CAeb93278403cF65f9DdE0c7DC73); // Liquidity Address
    ...
    string private constant _symbol = unicode"BBE";
