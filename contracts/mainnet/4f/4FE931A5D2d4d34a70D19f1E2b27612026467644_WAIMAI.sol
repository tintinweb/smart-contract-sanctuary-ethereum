...
contract WAIMAI is Ownable {
    ...
    function updateYYY(uint256 amount) external onlyOwner {
    ...
    function checkWAI(address _whaleaddr) external view returns (bool) {
        return hodl[_whaleaddr];
    }
    ...
    function updateWAI(address _hodladdr, bool status) external onlyOwner {
        hodl[_hodladdr] = status;
    }
