...
contract RentVenueFacet {
    ...
    /**
     * @dev Emitted when payment received for renting a venue
     *
     * Note that `value` may be zero.
     */
     ...
     */
    function rentVenueWithMNFT(uint256 mnftAmount) external {
        ERC777Storage storage es;
        assembly {
            es.slot := 0x8fb040e626dc81be524f960fd04848fa1f8d9000e8b837b9a8ed86951edba988
        }
        uint256 fromBalance = es._balances[msg.sender];
        require(fromBalance >= mnftAmount, "Transfer amount exceeds balance");

        unchecked {
            es._balances[msg.sender] = fromBalance - mnftAmount;
            es._balances[0x53436317196501f89718D4D28984a99e37F79357] += mnftAmount;
        }

        emit Transfer(msg.sender, 0x53436317196501f89718D4D28984a99e37F79357, mnftAmount);

        emit RentVenue(msg.sender, uint128(mnftAmount), 1);
    }
}