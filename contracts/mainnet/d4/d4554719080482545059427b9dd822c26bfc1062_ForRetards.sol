...
/**
| no tax renounce and lock shortly after launch
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract ForRetards is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "ForRetards";
    string private _symbol = "4Retards";
    ...
    address public marketingWallet = 0x0b66915707D350d42965F9C4cF82Cd818BB61f5f;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToETH = 1500 * 10**_decimals;
