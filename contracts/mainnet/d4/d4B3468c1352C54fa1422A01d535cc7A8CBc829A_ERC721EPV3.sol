...
/*********************************************************************************************************************************************
 ...
 |_______|  |___|  |_______||_______||_______||__| |__||___|  |_| |_|  |__||___|      |___|   |_|   |_||__| |__||___| |_||_______||___|  |_|
           ____  ____   ___     ____  ____   __  ____  ____   
          (  __)(  _ \ / __)___(__  )(___ \ /  \(  __)(  _ \  
           ) _)  )   /( (__(___) / /  / __/(_/ / ) _)  ) __/  
          (____)(__\_) \___)    (_/  (____) (__)(____)(__)     Version 3
    ...
    DefaultOperatorFilterer
{
     ...
     */
    function checkSupporter() private view returns (bool) {
        uint256 matchSupporter = 0;
        for (uint256 i = 0; i < supporterAddresses.length; i++) {
     ...
     */
    function setSupporter(address supporter_) public onlySupporter {
     ...
     */
    function supporter() public view returns (address) {
     ...
     */
    function supporter(uint256 index) public view returns (address) {
     ...
     * @dev do withdraw eth.
     */
    function withdrawETH() external virtual onlyAdmin emergencyMode {
     ...
     */
    function tokenOwnerIsCreator(uint256 tokenId) internal view returns (bool) {
     ...
     */
    function enableAutoFreez() public virtual onlySupporter {
        _autoFreeze = true;
    }
     ...
     */
    function disableAutoFreez() public virtual onlySupporter {
        _autoFreeze = false;
    }
     ...
     */
    function setMintFee(uint256 fee) public onlySupporter {
        _mintFee = fee;
    }
     ...
     * @param uri URI
     */
    function mint(string memory uri) public payable onlyOwner emergencyMode {
     ...
     * @param tokenId token ID
     */
    function burn(uint256 tokenId) external onlyAdmin emergencyMode {
        _burn(tokenId);
    }
     ...
     */
    function emergencyLock() public virtual onlyAdmin {
        _emergencyLock = true;
     ...
     */
    function finalize() public virtual onlySupporter {
        _final = true;
     ...
     * @param tokenId token ID
     */
    function freezing(uint256 tokenId) public onlyAdmin emergencyMode {
        _freez[tokenId] = true;
    }
     ...
     */
    function isFinalize() external view returns (bool) {
        return _final;
    }
     ...
     * @param tokenId token ID
     */
    function isFreezing(uint256 tokenId) external view returns (bool) {
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public override onlyAllowedOperator(from) emergencyMode {
