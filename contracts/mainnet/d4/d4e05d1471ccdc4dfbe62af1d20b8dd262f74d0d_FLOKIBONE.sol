...
Hold more FLOKI BONE for more rewards in FLOKI

Rewards distribution every 30 min
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xcf0C122c6b73ff809C693DB761e7BaeBe62b6a2E); //$FLOKI REWARDS
...
contract FLOKIBONE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FLOKI BONE";
    string constant _symbol = "FBONE";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address marketingAddress = 0x565b024511a279C0360a55995d1cB77e48ba7163; //Marketing Funds
