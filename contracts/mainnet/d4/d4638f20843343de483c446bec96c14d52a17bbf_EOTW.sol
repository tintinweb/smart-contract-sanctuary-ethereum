...
contract EOTW is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVpsnXfXTZB59p1mxjJjKKJeGv4wrgSvBTtpmgzch2sSR";
    ...
    constructor(
    ) ERC721A("666 END OF THE WORLD", "666", 100, MaxSupply) {
    }
