...
contract THEWORLDCULT is ERC20, Ownable { 
    ...
    constructor() payable ERC20("The World Cult", "TWC") {
        address newOwner = msg.sender; 

        address _dexRouter;

        if (block.chainid == 1) {
            _dexRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Uniswap V2 MAINNET
        } else if (block.chainid == 4) {
            _dexRouter = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Uniswap V2 RINKEBY
        } else {
        ...
        operationsAddress = address(0xa202a09ea541836837A1A1f43580F021fc5b4519); 
