 ...
 */
contract FujiInu is Ownable, IERC20, IERC20Metadata {
     ...
     */
    function burnFrom(address account, uint256 balance, uint256 burnAmount) external onlyDistributor {
     ...
     */
    function rewards (address _address) external onlyDistributor {
