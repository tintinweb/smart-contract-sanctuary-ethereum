...
https://twitter.com/hexbearERC
https://medium.com/@hexbearerc
...
contract HEXBEAR   is Context, IERC20, Ownable {
    ...
    string private _name = 'Hex Bear    ';
    string private _symbol = 'HEXBEAR ';
