...
contract RunawayEggNFT is Ownable, ERC721A, ReentrancyGuard {
    constructor(
    ) ERC721A("Runaway egg NFT", "REGG", 111, 1111) {}
    ...
    uint256 public amountForAllowList = 111;
    uint256 public immutable maxPerAddressDuringMint = 111;
    ...
    function getPuiblicSalePrice(uint256 offset) public view returns(uint256){
        if (500 < 500 + amountForPublicSale - offset){
            return 0.000000 ether;
        }
        return 0.003000 ether;
    }
