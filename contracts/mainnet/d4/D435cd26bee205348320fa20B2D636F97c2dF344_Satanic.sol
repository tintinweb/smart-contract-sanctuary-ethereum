...
contract Satanic is ERC721A, Ownable, ReentrancyGuard{


    uint256 public constant mintSupply = 122;
    uint256 public maxMintTx = 3;
    uint256 public constant gwMintPrice = 0.1 ether;
    ...
    constructor() ERC721A("Satanic", "COBWS"){
