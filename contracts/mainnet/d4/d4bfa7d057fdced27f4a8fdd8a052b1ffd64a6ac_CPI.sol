...
contract CPI is ERC20, Ownable {
    ...
    constructor() ERC20("The Final Decision", "CPI") {
     ...
     uint256 totalSupply = 10 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xc280Dbf7779baD52CB422c99586F241AE085EE8d); // set as Marketing wallet
        DevWallet = address(0xc280Dbf7779baD52CB422c99586F241AE085EE8d); // set as dev wallet
