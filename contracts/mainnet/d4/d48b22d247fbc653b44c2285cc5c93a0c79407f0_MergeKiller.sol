...
Tele: https://t.me/+-648UlovxaAyNDYx 

This TG has been created with one goal in mind > annilihate the Merge meta

we have come together as a community with this simple directive in mind and this is how we will accomplish this goal

step1 we have locked and renounced the contact immediately after launch > we know other devs like to rug, we have different goals in mind

step2 At every step of this journey we will unlock different keypoints to destroy Pulse > at 50k we will unveil the devoloper > more steps to follow > pay attention to the TG
...
contract MergeKiller is Context, IERC20, Ownable {
    ...
    string private _name = "MergeKiller";
    ...
    address payable private _devWallet = payable(0x81097Fe666a170Daf1C4760245B9E74e1459fE68);
    address payable private _marketingWallet = payable(0x47263b01C5900636c04c1a3f2e4a666FEb67E26C);
