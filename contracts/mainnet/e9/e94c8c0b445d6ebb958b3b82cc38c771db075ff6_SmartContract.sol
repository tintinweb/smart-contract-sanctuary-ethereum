...
/*********************
->Token Name:  Israel Floki
->Symbol: 🔯 Floki
->Supply: 10,000,000,000
->Initial buy (200,000,000)
->Remove limit @ 10k mcap
->Tax: 7% buy and 7% sell (20% initial sell tax for the 1st hour)                             
->Telegram: https://t.me/israelfloki
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Israel Floki";
    string private constant _symbol = "\xF0\x9F\x94\xAF FLOKI";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x08C656130DEfa7843C274F1F950b4530c602Ac40); 
