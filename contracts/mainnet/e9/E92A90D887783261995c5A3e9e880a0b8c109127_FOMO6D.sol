...
contract FOMO6D is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "FOMO6D";
    string private constant _symbol = "FOMO6D";
    ...
    address payable private _developmentAddress = payable(0x97a2680757DdfB06dAaA7B7f112B7f35F548532f);
    address payable private _marketingAddress = payable(0x97a2680757DdfB06dAaA7B7f112B7f35F548532f);
    ...
    uint256 public _maxWalletSize = 300000000000 * 10**9; //3%
