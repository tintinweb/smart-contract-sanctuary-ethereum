...
contract SOULDAFOUNTAIN is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmNbyiEXJ6hxfQYtsYaKhAJcLzuR2zHNaxR3jaJzM1Usn2//";
  uint256  public  maxSupply = 10000;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.003 ether;
  uint256 public  NUM_FREE_MINTS = 8000;
  uint256 public  MAX_FREE_PER_WALLET = 1;
  uint256 public freeNFTAlreadyMinted = 0;
  bool public isPublicSaleActive = true;

  constructor() ERC721A("SOULDA FOUNTAIN", "SOULDA") {
  }
