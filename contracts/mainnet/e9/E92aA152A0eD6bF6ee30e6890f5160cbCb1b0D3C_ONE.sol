...
/**
     ...
     Annuit cœptis  - He Approves the Undertaking
     Novus ordo seclorum - New Order of the Ages
     "In God We Trust"

    Secrets and shadows on every corner

     #1j.       American Bald Eagle
     #2i.       13 Arrows
     #3h.       13 Leaves 
     #4g.       13 Stripes 
     #5_.       5_ Stars
     #6e.       __ Colonies
     #7d.       13 Pyramid Steps
     #8c.       1 The All Seeing Eye 
     #9b.       Great Seal of the Realm
     #_ _ _.    MDCCLXXVI 
...
contract ONE is Context, IERC20, Ownable {
    ...
    string private constant _name = "E PLURIBUS UNUM";//
    ...
    address payable private _developmentAddress = payable(0x90068Bd8B65E5371d14b5D6811bE77EEE2004467);//
    address payable private _marketingAddress = payable(0x90068Bd8B65E5371d14b5D6811bE77EEE2004467);//
