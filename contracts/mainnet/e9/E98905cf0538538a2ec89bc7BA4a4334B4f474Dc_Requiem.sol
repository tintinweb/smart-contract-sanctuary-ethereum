...
contract Requiem is ERC20, Ownable {
    ...
    constructor() ERC20("Requiem", "$DREAM") {
        ...
        marketingWallet = address(0xA6FCa455F9D9F5Ef047c4a69Be02f3fD0087c33f); // set as marketing wallet
        devWallet = address(0xAA3ABd6725714B4e2781256CDC4a219e035d99be); // set as dev wallet
