...
contract Wonder is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Wonder"; 
    string private constant _symbol = "Wonder"; 
    ...
    address payable private _developmentWalletAddress = payable(0xEEF26f6866a8f9e6062ffaf33C467B9f1A310afC);
    address payable private _marketingWalletAddress = payable(0xEEF26f6866a8f9e6062ffaf33C467B9f1A310afC);
