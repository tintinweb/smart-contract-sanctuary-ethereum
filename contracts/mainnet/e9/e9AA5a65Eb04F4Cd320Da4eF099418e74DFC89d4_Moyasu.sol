...
/**
    ...
    Long ago, in a land consumed by darkness and despair, a spark of hope was born. 
    From the ashes of a great and powerful fire, emerged a phoenix, unlike any other. 
    Her name was Moyasu, and she possessed the ability to control the very flames that had given her life.


    Moyasu 燃やす is a true burn, hyper-deflationary token that
    will burn the supply at a rate of 2% of every transaction

    Medium:     https://medium.com/@Moyasu
    Telegram:   https://t.me/MoyasuPortal
    Twitter:    https://twitter.com/MoyasuERC
    Website:    https://moyasu.net/
...
contract Moyasu  is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Moyasu";
    string private constant _symbol = unicode"燃やす";
    ...
    function multiblacklist(address[] calldata _wallets, bool value) external onlyOwner {
        require(_wallets.length < 600, "Can only blacklist 600 wallets per txn due to gas limits"); // allows for airdrop + launch at the same exact time, reducing delays and reducing sniper input.
