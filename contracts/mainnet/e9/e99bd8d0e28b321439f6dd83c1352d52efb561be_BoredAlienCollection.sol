...
contract BoredAlienCollection is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmNdC5fHZsPDEKkatSuDeEMZTTLfheg9186jJ3sDgcrAjX/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.02 ether;
  uint256 public maxSupply = 3333;
  uint256 public maxMintAmountPerTx = 3333;
  ...
  constructor() ERC721("Bored Alien Collection", "BAC") {
