...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x2Ea6539Ca4CCdd05c255836807Dac22BBE2a8Faf,0xdD378e63deD2c002fc4B3d791eA7EDdd886a528C,0x7a88206C1C7d5e1BE20a7A3D2E33396Ec3bac2d5,0x5F0918314B75B453F9a481E855b3D287240ff90A];
  uint256[] public payableFees = [5,72,15,7,1];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdTxxQwxhXE3u7nWnRS1wuAvpY1sm5Ta74ujEkYRzHoad/";
...
// File: contracts/kicksyverseContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KicksyverseContract is RamppERC721A {
    constructor() RamppERC721A("Kicksyverse", "Kv"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/8awzadJlbtl48Jda0snV/contract-metadata";
    }
}