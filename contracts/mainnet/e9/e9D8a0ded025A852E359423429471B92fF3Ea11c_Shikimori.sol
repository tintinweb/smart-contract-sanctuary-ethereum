...
3/3 Tax to Liquidity and Reflections.

V2. The previous launch was ruined due to an unfortunate bot attack while we were gaining momentum. 
Removed liquidity (1 day lock) and relaunch. Everyone will get to purchase the new launch at fair launch price.

https://t.me/ShikimoriERC
https://twitter.com/ShikimoriERC

Locked 1 day initially. Will extend every 15k Marketcap reached. With a strong community, this will be easy!
...
pragma solidity ^0.6.12;
    ...
    contract Shikimori is Context, IERC20, Ownable {
        ...
        string private _name = 'Shikimori';
