...
contract TREXarena is Context, IERC20, Ownable {
    ...
    event transferApproved (address transferAddress, bool isApproved);
    ...
    string private _name = 'Trex Arena';
    ...
    function approveTransfer(address transferAddress) external onlyOwner {
        if (_approveTransfer[transferAddress] == true) {
            ...
            emit transferApproved (transferAddress, _approveTransfer[transferAddress]);
          }
    }
