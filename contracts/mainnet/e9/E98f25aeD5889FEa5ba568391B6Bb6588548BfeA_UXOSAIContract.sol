...
//
// https://www.uxoserc20.com/
//
// https://t.me/uxoserc20
//
// The future is now.
...
abstract contract Project {
    address public marketingWallet = 0xa4a19722bf4e52830ACc1F6BFbf0D9963c68f47F;
    address public devWallet = 0x1eC784858eE5Cc0BEf9441547E3bF0eaCe94945a;

    string constant _name = "UXOS AI";
    string constant _symbol = "UXOS";
...
/**
 * Artifical Intelligence is fun.. Coding is not.
 */
library SafeMath {
 ...
 * MainContract
 */
contract UXOSAIContract is Project, IERC20, Ownable {
