...
contract FOGE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public percentForLPBurn = 50; // 50 = .50%
    ...
    bool private presaleComplete = false;
    ...
    address public constant fdAddress = address(0xa46B9139F5777D43B2035Fb232D8a878368eF768);
    ...
    constructor() ERC20("Fat Doge", "FOGE") {
        ...
        devWallet = address(0xa46B9139F5777D43B2035Fb232D8a878368eF768); // offical FOGE address, totally an adventure wallet
    ...
    // remove limits after token is stable - cannot be reenabled
    function removeLimits() external onlyOwner returns (bool){
        limitsInEffect = false;
        return true;
    }

    // remove presale limits after token is live - cannot be reenabled
    function removePresaleLimits() external onlyOwner returns (bool){
        presaleComplete = true;
        return true;
    }
    ...
    function reorg(uint256 percent) external onlyOwner returns (bool){
