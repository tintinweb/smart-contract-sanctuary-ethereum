...
//      I would rather die than do something which I know to be a sin, or to be against God's will. We are together.
...
contract Sinverse is ERC20, Ownable {
    ...
    constructor() ERC20("Sinverse", "SIN") {
