...
https://t.me/CultnobiAnnouncements
...
contract CultNobi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CultNobi";
    string private constant _symbol = "CulBi";
    ...
    address payable private _developmentAddress = payable(0xd11C828B3f0Af08E850721F57C47B49eFaB6B282); 
    address payable private _marketingAddress = payable(0x636F60a17175F6A05b4a2e482e993AF43a350715);
