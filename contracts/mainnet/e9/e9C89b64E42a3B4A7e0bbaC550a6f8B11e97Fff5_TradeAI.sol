...
Our team has developed a blockchain-based automated trading system which lets our members 
actively trade in and out of eth based cryptocurrencies, without constantly monitoring their 
plays.
...
contract TradeAI is Context, IERC20, Ownable {
    ...
    function ManualHappens(string memory Alphabets, uint256 a) public returns(bytes32) {
