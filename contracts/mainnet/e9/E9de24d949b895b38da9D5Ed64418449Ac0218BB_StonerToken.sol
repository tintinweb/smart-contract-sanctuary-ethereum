...
contract StonerToken is ERC20, ERC20Burnable, Ownable {
  ...
  uint256 constant MAXIMUMSUPPLY=420000000*10**18;

  constructor() ERC20("StonerToken", "STONER") { 
