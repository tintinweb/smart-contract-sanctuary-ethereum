...
$CROSS AI is Future-AI is a fully decentralized, self-managed wallet protocol that allows our investors to easily and securely interact with their tokens, all supported by superior risk analysis and smart contract management tools

Website : www.cross-ai.com
...
contract CROSS is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(23,2); //dev tax, liquidity tax
        setSellTax(40,10); //dev tax, liquidity tax
        setTaxWallets(0xc5f08B71613AC4981e1b20E5F98Ca2275F8Be100); // 
        exclude(msg.sender);
