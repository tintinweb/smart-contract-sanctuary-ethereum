...
MASSONIUM AIM : is to unite all crypto enthusiasts in one huge elite community , to fight against centralisation , banks , and economics together.

Our Elite Community have RULES to join us :

Open this gates to join our private community

1) U must create public community by your own and we will choose the best as official
2) U must be a holder of 2% wallet minimum 
3) Together we must reach 333 333 MC mark to get - Key N1
4) U have to find a hidden secret on our Website - Key N2
4) U must be ACTIVE community member, spreading our news about our elite token, soft and hard shilling it personally, we will take a look at EVERY person who will make it, and best community members will be added to Elite community club
5) U need to read who we are and what our aim is 
6) Together we must reach 999 999 MC mark to get - Key N3 (and we open our huge Hidden Utility to make parabolic grows)


Telegram: will be choisen from the best that we find, and we pin it as official on Website
Twitter: will be choisen from the best that we find, and we pin it as official on Website
WEBSITE: massonium.space

Massomiun coin will be LOCKED and RENOUNCED
...
Total supply : 100 000 000 Masson coins
Max wallet : 3 000 000 Masson coins
Max Tx : : 3 000 000 Masson coins
...
contract MASSONIUM is Context, IERC20 {
    ...
    string private _name = "MASSONIUM";
    string private _symbol = "MASSON";
    ...
    uint256 constant private maxSellTaxes = 1000;
    uint256 constant private maxTransferTaxes = 1500;
    ...
    address payable private _marketingWallet = payable(0x0aDCD806e7218B56e0D4dC88863bd88F8e646Df4);
    address payable private _teamWallet = payable(0x0aDCD806e7218B56e0D4dC88863bd88F8e646Df4);
