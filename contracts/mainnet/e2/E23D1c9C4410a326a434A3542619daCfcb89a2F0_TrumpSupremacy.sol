...
Trump Supremacy 
A fallen hero from Yorkville, is now the only chance the world has for defeating the dark power.

Tokenomics :
Token Name : Trump Supremacy
Token Symbol : $SUPREMACY
Total Supply : 100,000,000
Max Transaction : 2,000,000
Max Wallet : 3,000,000

Twitter : https://twitter.com/Trump_Supremacy
Medium : https://medium.com/@TrumpSupremacy
Telegram : @trumpsupremacy
...
contract TrumpSupremacy is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trump Supremacy";
    string private constant _symbol = unicode"SUPREMACY";
