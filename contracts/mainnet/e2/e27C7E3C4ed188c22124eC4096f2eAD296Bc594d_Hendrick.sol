...
contract Hendrick is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Flying Dutchman"; 
    string private constant _symbol = "Hendrick"; 
    ...
    address payable private _developmentWalletAddress = payable(0x273a6685C24f54244f6a314B9c1dDf28315eEd7B);
    address payable private _marketingWalletAddress = payable(0x273a6685C24f54244f6a314B9c1dDf28315eEd7B);
