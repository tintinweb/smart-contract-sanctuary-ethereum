...
contract XonY is ERC721A, TheOperatorFilterer {
    ...
    function mintXY(uint256 amount) payable public {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmWjeQi2HcVrxe7zVe5hGEA9kNrEkqkvFfeP9aoEgQ5vuK/", _toString(tokenId), ".json"));
    }
