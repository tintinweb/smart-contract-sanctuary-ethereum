...
contract AllRocks is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("All Rocks", "ARS") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmQcDDPPkwsrEi7G1d8A5xN3mWs2zkHTHHmm7VmA7R5GkF/", _toString(tokenId), ".json"));
    }
