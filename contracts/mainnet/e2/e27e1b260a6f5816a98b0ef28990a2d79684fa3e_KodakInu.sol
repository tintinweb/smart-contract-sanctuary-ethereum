...
/*
Kodak Inu Token Is a reflection and rewards token. Our main goal is to bring trust and confidence on ETH space.
We are going to be a stable token and also a trust checker in the space.

TG: https://t.me/kodakportal
...
contract KodakInu is ERC20, Ownable {
    ...
    constructor() ERC20("Kodak Inu", "KODAK") {
        ...
        maxWallet = totalSupply.mul(30).div(1000); // 2% from total supply maxWallet
		...
		charityWallet = address(0xF020AEbcd3D727515CC62b40F81425e626f61105); // set as charity wallet
        marketingWallet = address(0xF020AEbcd3D727515CC62b40F81425e626f61105); // set as marketing wallet
        devWallet = address(0xF020AEbcd3D727515CC62b40F81425e626f61105); // set as dev wallet
