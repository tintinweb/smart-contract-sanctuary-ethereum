...
/* 
Twitter: https://twitter.com/wbci_erc20
Telegram: https://t.me/WBCI_ERC20
Medium: https://medium.com/@wbcierc20
Website: https://worldbaseballclassicinu.com

WBCI, born from World Baseball Classic, is
here to deliver a baseball betting and web3
fantasy league experience!
Test your skills and get in the action through
the WBCI Fantasy League, NFT Collection or
Betting Platform!

Wager on your Favorite Teams through the 2023-2024
MLB Season & Beyond with the WBCI Betting
Website. Wager the crypto of your choice, or your
$WBCI tokens to earn and enjoy the thrill.
...
contract WorldBaseballClassicInu is Ownable, ERC20 {
    ...
    string constant _name = "World Baseball Classic Inu";
    string constant _symbol = "WBCI";
    ...
    uint256 public swapThreshold = _totalSupply * 27 / 1000; 
    bool inSwap;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xdFfce77a2a22281E359Cd77bAdf72f576953D232;
        utilityFeeReceiver = msg.sender;
        teamFeeReceiver = 0x999591bA0F000F69FF406d01149336DbF6820007;
    ...
    function readyToRenounce() external onlyOwner { 
