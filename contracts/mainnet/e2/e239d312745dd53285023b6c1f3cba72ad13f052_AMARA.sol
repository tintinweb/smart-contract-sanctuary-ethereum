...
/*
We are back home to our land of a black fecund earth
Broken chains of thought, everlasting love, freedom and power, this is not Utopia, this is Amara.
https://amaratoken.com
https://twitter.com/AMARAtoken
https://t.me/Amaraportal
*/
...
contract AMARA is Context, IERC20, Ownable {
    ...
    string private _name = "Everlasting Love";
    string private _symbol = "AMARA";
    ...
    address public marketingTokenFeeWallet = 0x196146159b14a59da0cf4dd6B094527016F6435a;
    address public marketingETHFeeWallet = 0x196146159b14a59da0cf4dd6B094527016F6435a;
    ...
    uint256 public _maxTxAmount = 2000000 * 10**9;// 2% maxTxAmount
    uint256 public _maxWallet = 2000000 * 10**9;// 2% maxWallet
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 2 * 10**6 * 10**9, "Cannot set transaction amount less than 2 percent of initial Total Supply!");
