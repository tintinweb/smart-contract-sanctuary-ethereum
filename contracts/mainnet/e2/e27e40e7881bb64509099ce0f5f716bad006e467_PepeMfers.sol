...
contract PepeMfers is ERC721A, Ownable, ReentrancyGuard{
    using Strings for uint256;
    ...
    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("3DPepeMfers", "3DPepeMfers") {
        PRICE = price;
    ...
    address private constant payoutAddress1 = 0x294EfF7F1850e504C506f8789cdB28D2Bc35f218;
