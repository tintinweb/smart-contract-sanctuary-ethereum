...
contract StrategyAuraBalSingle is StratFeeManagerInitializable {
    ...
    function addLiquidity() internal {
        ...
        BalancerActionsLib.balancerJoin(unirouter, IBalancerPool(bpt).getPoolId(), input.input, inputBal);
    ...
    function addRewardToken(address _token, BeefyBalancerStructs.BatchSwapStruct[] memory _swapInfo, address[] memory _assets, bytes calldata _routeToNative, uint _minAmount, bool _composable) external onlyOwner {
