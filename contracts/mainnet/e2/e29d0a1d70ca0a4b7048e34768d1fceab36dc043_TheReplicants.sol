...
LP gonna get burnt and the taxes are 5/5 few minuts after launch! 

Website: https://thereplicants.org/

Telegram: https://t.me/TheReplicantsPortal

Twitter: https://twitter.com/thereplicanterc
...
contract TheReplicants is ERC20, Ownable {
    ...
    function _setbuyfees(uint256 _marketing,uint256 _liquidity) external onlyOwner{
        require((_marketing+_liquidity) <= 100, "Must keep fees lower than 10%");
