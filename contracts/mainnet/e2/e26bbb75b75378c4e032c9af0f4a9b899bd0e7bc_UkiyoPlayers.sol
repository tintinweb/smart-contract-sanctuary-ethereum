...
|   (  ) : |(: |/   /  ||  |   \   \  /// ____  \       (. |__) :)||  |         /    \     \   \  /(: ______)|:        |(:   \___/  
(:  |  | . )|    __/   |:  |    \\  \//  /    ) :)      |:  ____/ |:  |        /' /\  \     \\  \/  \/    |  |_____/   ) \___  \    
 \\ \__/ // (// _  \   |.  |    /   /(: (____/ //       (|  /      \  |___    //  __'  \    /   /   // ___)_  //      /   __/  \\   
 /\\ __ //\ |: | \  \  /\  |\  /   /  \        /       /|__/ \    ( \_|:  \  /   /  \\  \  /   /   (:      "||:  __   \  /" \   :)  
(__________)(__|  \__)(__\_|_)|___/    \"_____/       (_______)    \_______)(___/    \___)|___/     \_______)|__|  \___)(_______/   
...
contract UkiyoPlayers is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public presaleMax = 10;
    uint256 public mainsaleMax = 20;
    ...
    function whitelistMintUkiyoPlayer(bytes32[] calldata _merkleProof, uint256 howManyUkiyoPlayers) public payable nonReentrant onlySender whitelistIsOpen
    {
        bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
        require(MerkleProof.verify(_merkleProof, merkleRoot, leaf), "Invalid proof.");

        require(msg.value >= (mintPrice * howManyUkiyoPlayers), "Minting a Ukiyo Player 0.1 Ether Each!");
