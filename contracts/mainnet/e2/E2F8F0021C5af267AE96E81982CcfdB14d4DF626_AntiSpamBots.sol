...
contract AntiSpamBots is ERC721A, Ownable, ERC2981 {
    uint256 public price = .005 ether;
    uint256 public presalePrice = .004 ether;
    uint256 public maxPerWallet = 5;
    uint256 public maxPerTransaction = 5;
    uint256 public presaleMaxPerWallet = 5;
    uint256 public presaleMaxPerTransaction = 5;

    uint256 public immutable presaleSupply = 3333;
    uint256 public immutable supply = 5555;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0xd57249C656CEfeb023187634d0Cf618D6c6A0466];
    uint256[] public withdrawPercentages = [5, 95];

    bytes32 public merkleRoot = 0x68221f9462c22738d42e2c4bc6b4c1e5695da526e6e95920af777fcd50b41aa7;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xd57249C656CEfeb023187634d0Cf618D6c6A0466, _royaltyAmount);
    }
