...
/**
 * Dog dimension Info：
 * Dog dimension is a two-dimensional Lipan mansion gentleman sharing website that collects animation, 
 * COSPLAY and pixiv, and an animation community that integrates GALGAME games, Lipan, 
 * notebook and Coser to share and discuss.

 * Create contract init fee: 
 * total buy 0%
 * total sell 0%
 * 
 * Web: http://www.dogacg.com/
 * Telegram: https://t.me/DOGACG_ERC20
 */
...
// File: contracts/trunk/BaseSetTax0ERC20Token.sol
...
contract BaseSetTaxERC20Token is IERC20, ReentrancyGuard, Ownable {
    ...
    string private _name = "The Dogacg Game";
    string private _symbol = "DOGACG";
