...
abstract contract Ownable {
    ...
    function renounceOwnership() public virtual onlyOwner {emit OwnershipTransferred(address(0)); owner = address(0);    }
...
contract NekoX is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Neko-X';
    string private constant _symbol = unicode'Neko-X';
    ...
    address internal constant development_receiver = 0xB948fA21DA84b8c646175cC5620063d10ae6d11B; 
    address internal constant marketing_receiver = 0xB948fA21DA84b8c646175cC5620063d10ae6d11B;
    address internal constant liquidity_receiver = 0xB948fA21DA84b8c646175cC5620063d10ae6d11B;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        _balances[sender] = _balances[sender].sub(amountReceived);
