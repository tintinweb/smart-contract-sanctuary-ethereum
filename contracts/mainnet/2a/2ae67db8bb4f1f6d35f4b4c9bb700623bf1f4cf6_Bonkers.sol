...
/**
4269 BONK!! BONK!! BONKERS!-- noice!
Each Bonker has Bonk Capabilities be careful not to get bonked!

Twitter https://twitter.com/Bonk_lord
...
contract Bonkers is ERC721AQueryable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public maxSupply = 4260;
  ...
  constructor(string memory baseURI) ERC721A("Bonker", "BNKRS") {
