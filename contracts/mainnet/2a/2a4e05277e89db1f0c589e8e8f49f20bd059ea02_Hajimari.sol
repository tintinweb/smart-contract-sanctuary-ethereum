...
contract Hajimari is ERC20, Ownable {
    ...
    constructor() ERC20("Hajimari", "HAJI") {
		...
		charityWallet = address(0xE65A42e0214eEAAe7C37ed4D897fC731777935D9); // set as charity wallet
        marketingWallet = address(0xE65A42e0214eEAAe7C37ed4D897fC731777935D9); // set as marketing wallet
        devWallet = address(0x8a3CAAF89fa419062e78a55C3001f26a907942f8); // set as dev wallet
