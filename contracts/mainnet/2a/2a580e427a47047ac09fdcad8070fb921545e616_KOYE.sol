...
contract KOYE is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public TotalNum = 10000;
    uint256 public WhiteListNum = 1700;

    string private _baseURIextended = "";
    string public hiddenMetadataUri = "ipfs://QmQ6h22qbEPGwWqFh9MP7se7F49r7S151ReDAsu7f9pnHn";
    address private proxyRegistryAddress;

    bytes32 public root = ""; //
    mapping(address => bool) public whitelistClaimed; //

    constructor() ERC721A("Mini KOYE", "MKY", 500) {}
    ...
    function setRoot(bytes32 mroot) public onlyOwner {
        root = mroot;
    }
    ...
    function setWlMint(bool enable) public onlyOwner {
    ...
    //one wl
    function wlmint(bytes32[] calldata proof) external callerIsUser {
        require(WhiteListNum > 0, "The whitelist already mint out");
        require(whitelistMintEnabled, "The whitelist sale is not enabled!");
        require(_verify(_leaf(msg.sender), proof), "Invalid merkle proof"); //
        require(!whitelistClaimed[msg.sender], "Already minted!"); //
