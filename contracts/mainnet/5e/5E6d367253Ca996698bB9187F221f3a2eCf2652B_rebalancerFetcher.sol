 ...
 */
contract rebalancerFetcher {

    IVault constant vault  = IVault(0xBA12222222228d8Ba445958a75a0704d566BF2C8);

    mapping(address => address) public poolList;
    address[] public poolList2;

    function getRebalancerForPool(address lpToken) public returns (address){
        ILinearPool pool = ILinearPool(lpToken);
        (, , , address assetManager) = vault.getPoolTokenInfo(pool.getPoolId(), pool.getMainToken());
        return (assetManager);
    }
