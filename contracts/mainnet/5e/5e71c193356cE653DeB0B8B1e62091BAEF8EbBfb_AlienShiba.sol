...
contract AlienShiba is Context, IERC20, Ownable {
    ...
    uint256 private _initialSellTax=255;
    ...
    string private constant _name = unicode"Alien Shiba";
    string private constant _symbol = unicode"ALISH";
    ...
    uint256 public _maxTaxSwap= 250000000000 * 10**_decimals;
