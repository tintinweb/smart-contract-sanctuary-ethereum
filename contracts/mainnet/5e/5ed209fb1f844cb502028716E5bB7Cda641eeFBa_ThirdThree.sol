...
contract ThirdThree is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmf1EJCiA64ySoiR5UBwmt2JaoNWgBCDcYoBLY2qd6aXCK";
    ...
    constructor(
    ) ERC721A("AI BEANz", "BEANz", 100, maxSupply) {
    }
