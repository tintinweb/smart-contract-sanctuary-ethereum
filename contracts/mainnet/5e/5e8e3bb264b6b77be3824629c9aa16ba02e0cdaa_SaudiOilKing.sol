...
contract SaudiOilKing is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SAUDI OIL KING", "SOK") {
        ...
        uint256 _buyOilFee = 4;

        uint256 _sellBurnFee = 2;
        uint256 _sellOilFee = 4;
        ...
        buyTotalFees = buyBurnFee + buyOilFee;
        
        sellBurnFee = _sellBurnFee;
        sellOilFee = _sellOilFee;
        sellTotalFees = sellBurnFee + sellOilFee;
        
        devWallet = 0xc6B3666b3b6cA8C7252D45483ef84Fc9a41e65D0;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _oilFee) external onlyOwner {
        buyBurnFee = _burnFee;
        buyOilFee = _oilFee;
        buyTotalFees = buyBurnFee + buyOilFee;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _oilFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForDev += fees * sellOilFee / sellTotalFees;
            }
            ...
            // on buy
                ...
                tokensForDev += fees * buyOilFee / buyTotalFees;
            }
