...
//
//     __ __            __         ____               
//    / //_/___  ____ _/ /___ _   / __ \____ ___  __  
//   / ,< / __ \/ __ `/ / __ `/  / / / / __ `/ / / /  
//  / /| / /_/ / /_/ / / /_/ /  / /_/ / /_/ / /_/ /   
// /_/ |_\____/\__,_/_/\__,_/  /_____/\__,_/\__, /    
//    / __ )__  __                         /____/     
//   / __  / / / /                                    
//  / /_/ / /_/ /                                     
// /_____/\__, /                                      
//    ___/____/  __  __                               
//   / __ \_  __/ / / /___ __________ ___  ____  ____ 
//  / / / / |/_/ /_/ / __ `/ ___/ __ `__ \/ __ \/ __ \
// / /_/ />  </ __  / /_/ / /  / / / / / / /_/ / / / /
// \____/_/|_/_/ /_/\__,_/_/  /_/ /_/ /_/\____/_/ /_/ 
//                                                    
//
//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1679677200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1679414400;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xCFb6bc33AF4F6f0a69F00d6DAB045dEE83f627f9];
  address public erc20Payable = 0xCFb6bc33AF4F6f0a69F00d6DAB045dEE83f627f9;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmXqiQPVYtSnbK8nWRd8iGYDofb2khWys4SWushrLhTtN3/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/M14VU3m0US9N3Zq9ubbO/contract-metadata";
  }
...
// File: contracts/KoalaDayContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KoalaDayContract is ERC721APlus {
    constructor() ERC721APlus("Koala Day", "KOALA"){}
}
  /*******************************************************/
  /*                                                     */
