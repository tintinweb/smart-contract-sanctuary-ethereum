...
SNM Inu is a meme token inspired by the decentralization of Fog Computing platform based on distributed customer level hardware including PCs, Mining equipment, and servers that Sonm provides.

SNM Inu Tokenomics 

Total Supply of 100,000,000
4% tax for each buy and sell 
2% marketing 
2% project development

Telegram: https://t.me/SNM_INU
Twitter: https://twitter.com/sonm_inu
...
**/
  ...
  contract SNMI is Context, IERC20, Ownable {
      ...
      string private constant _name = "SNM Inu";
      string private constant _symbol = "SNMI";
