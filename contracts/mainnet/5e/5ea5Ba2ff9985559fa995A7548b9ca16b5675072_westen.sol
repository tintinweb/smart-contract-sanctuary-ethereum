...
contract westen is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 6000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 6000000* 10**_decimals; // 
    uint256 private constant TaxSwapAmount = 500000 * 10**_decimals; //
  
    string private constant _name = "NazYeWesten"; // 
    string private constant _symbol = unicode"NAZYE"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x4B316968177B26bcAC4CC384F6Ea6bD34Af4A54b).transfer(ethToSend); //marketing wallet
    }
