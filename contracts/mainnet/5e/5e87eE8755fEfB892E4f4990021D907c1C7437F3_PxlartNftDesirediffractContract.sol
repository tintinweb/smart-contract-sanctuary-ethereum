    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmYwVzJPXX4nSCCYMHvwRjy9SRhMXKhiSXim1PG62AuL6j/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/8RYkDJlZXGWzRvrL6n14/contract-metadata";
  }
...
// File: contracts/PxlartNftDesirediffractContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PxlartNftDesirediffractContract is RamppERC721A {
    constructor() RamppERC721A("pxlartNFT Desire diffract", "pxlartNFT"){}
}