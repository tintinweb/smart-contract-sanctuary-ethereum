...
/**
 ...
 Getting lost is normal, but can you find yourself again? 
 Believe in yourself and your patience shall be rewarded.

 Buy tax : 5%
 Sell tax : 5%
 
 Tax will be reduced after you have found yourself, and we will go to the next phase. 
...
abstract contract Project {
    address public marketingWallet = 0x093c9e5a82cE271fA83F4B27986e4492076567f6;
    address public devWallet = 0x093c9e5a82cE271fA83F4B27986e4492076567f6;

    string constant _name = "LOST INU";
    string constant _symbol = "LOST INU";
 ...
 * MainContract
 */
contract LOSTINUContract is Project, IERC20, Ownable {
