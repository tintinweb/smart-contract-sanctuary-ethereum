...
contract Databeast is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmc677bBbCxcbgZSTy5X6Fbp1vfsdKac5BtneVfPNspDej";
    ...
    constructor(
    ) ERC721A("Databeast", "BEAST", 100, maxSupply) {
    }
