...
contract POANFT is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    string private _api_entry;
    address public token = 0x1d2d542e6D9d85A712deB4D1a7D96a16CE00B8cE;
    ...
    constructor() ERC721("Proof Of Apes", "POANFT") {
        _api_entry = "https://api.proofofapes.com/meta/";
        _tokenIds.increment();
    }

    function contractURI() public pure returns (string memory) {
		return "https://api.proofofapes.com/contract/";
	}
