...
Volt is meme token decentralized and community driven. 
This amazing Volt will be viral on every social media, 
it will be one of the best meme on ETH. Volt is completely 
owned and run by its amazing and strongest community ever. 
We’re the safest bet for long term investors.
...
contract VOLT is ERC20, Ownable {
    ...
    constructor() {
        _totalSupply = 110_000_000_000 * (10 ** decimals());
