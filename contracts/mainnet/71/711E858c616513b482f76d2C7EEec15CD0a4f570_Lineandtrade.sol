...
contract Lineandtrade is ERC721A {
    ...
    constructor() ERC721A("./Line.trade", "line") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigft332zgzqhpctiwkqoxvf34mcwo4qwzfiepquw2yeanynpazehm/", _toString(tokenId), ".json"));
    }
