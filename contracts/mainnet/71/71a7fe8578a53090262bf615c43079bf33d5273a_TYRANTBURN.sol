...
TYRANT BURN
$TyBn
https://t.me/TyrantBurn_official
...
contract TYRANTBURN is Context,IERC20, Ownable{
using Address for address;
string private _name = "TYRANT BURN";
string private _symbol = "TyBn";
...
address _owner;
address payable public marketingAddress = payable(0x90830c21dc6E92203d455E5E2Af01CE2656932c8);
...
uint256 TYRANTBURNCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > TYRANTBURNCOINDaycooldown, "You cant call TYRANTBURNCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function TYRANTBURNCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    TYRANTBURNCOINDaycooldown = block.timestamp + 86400;
}
