...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x49436f62f1e30312D38f85a4F3aD2dfFB5b880ca];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmf1CntsFekUrX2y13W5EGazVwDu1oNQLHfg1i8K2wLeP1/";
...
// File: contracts/JustAnAppleContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JustAnAppleContract is RamppERC721A {
    constructor() RamppERC721A("JustAnApple", "JAA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/IlOAaO8QqMo2lo8DSVCp/contract-metadata";
    }
}
