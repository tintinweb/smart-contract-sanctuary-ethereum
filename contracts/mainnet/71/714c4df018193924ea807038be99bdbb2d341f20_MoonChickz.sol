...
contract MoonChickz is ERC721A {
    string uri = "ipfs://bafybeieox4d6lfwhchxl3a7lsywnstt72u7r3bo3i52k3mewjmhsnhggyu/";
    ...
    constructor() ERC721A("MoonChickz", "MC") {
        owner = msg.sender;
        maxSupply = 3333;
        mintPrice = 0.000 ether;
        maxPerWallet = 10;
        maxPerTx = 10;
    }
