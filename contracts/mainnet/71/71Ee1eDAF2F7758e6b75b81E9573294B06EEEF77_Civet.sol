...
contract Civet is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x1591Ee0088a8e08636E6Ae0F9a98669fb2791472);
    ...
    constructor() ERC20("Civet Coin", "Civet") {
        ...
        maxTransactionAmount = totalSupply * 50 / 1000; // 0.3% maxTransactionAmountTxn
        maxWallet = totalSupply * 100 / 1000; // 1% maxWallet
        swapTokensAtAmount = totalSupply * 50 / 1000; // 0.05% swap wallet
