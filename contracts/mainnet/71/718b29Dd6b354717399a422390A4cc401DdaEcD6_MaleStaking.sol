...
contract MaleStaking is IERC20Staking {
    ...
    constructor(address _stakingToken) IERC20Staking(_stakingToken) {
        plans[0].apr = 50;
        plans[0].stakeDuration = 0;
        plans[0].depositDeduction = 0;
        plans[0].withdrawDeduction = 50;
        plans[0].earlyPenalty = 0;

        plans[1].apr = 100;
        plans[1].stakeDuration = 10 days;
        plans[1].depositDeduction = 0;
        plans[1].withdrawDeduction = 100;
        plans[1].earlyPenalty = 10;

        plans[2].apr = 150;
        plans[2].stakeDuration = 15 days;
        plans[2].depositDeduction = 0;
        plans[2].withdrawDeduction = 100;
        plans[2].earlyPenalty = 25;

        plans[3].apr = 250;
        plans[3].stakeDuration = 30 days;
        plans[3].depositDeduction = 0;
        plans[3].withdrawDeduction = 0;
        plans[3].earlyPenalty = 40;
    }
