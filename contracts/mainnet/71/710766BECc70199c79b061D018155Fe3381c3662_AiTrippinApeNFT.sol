...
contract AiTrippinApeNFT is ERC721A, Ownable, INFT {
    /// @dev Library
    using Strings for uint256;
    /// @dev Event
    ...
    uint256 private anti_hacker_limit = 0.003 ether;

    uint8 private _free_mint_available = 1;
    uint256 private _free_mint_start = 1653274800; 
    uint256 private MINT_LIMIT = 5;

    bool private _is_revealed = false;

    string private _base_uri = "";

    string private _blindbox_uri = "https://ipfs.aitrippinape.com/aiape/blind/";
    ...
    /// NFT Related
    constructor() ERC721A("Ai TrippinApe NFT", "AiAPE") {
        mintTo(msg.sender, 5);  //For Init Opensea
    }
