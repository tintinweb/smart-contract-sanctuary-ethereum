...
contract PreSale is Ownable{
   ...
   function claim() public noReentrancy{
    ...
    //Set a claim time
    function startClaim(uint256 _releaseTime) public{
        require(msg.sender == changeAddress,"Permission denied");
    ...
    function setChangeAddress(address _address) public onlyOwner{
