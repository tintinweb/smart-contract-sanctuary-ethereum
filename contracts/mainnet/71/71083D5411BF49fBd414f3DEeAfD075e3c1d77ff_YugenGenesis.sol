...
contract YugenGenesis is ERC721A, Ownable {
    ...
    string public notRevealedURI = "ipfs://bafkreievxxaknamoad3bsptweaq73ua3rrf45h2wi5lxn6lllq3kdqcmuy";
    bool public revealed;

    constructor(
        address recipient,
        uint256 allocation
    ) ERC721A("Yugen Genesis", "YG") {
