...
contract Tiffbirds is ERC721A, Ownable, ReentrancyGuard { 

    uint256 public _maxSupply = 5555;
    uint256 public _mintPrice = 0.0015 ether;
    ...
    constructor(string memory initBaseURI) ERC721A("Tiffbirds", "Tiffbirds") {
        baseURI = initBaseURI;
    }
