...
/**
RIDDLER TOKEN
https://t.me/riddletoken
March 5th

Riddle me this, check the telegram for puzzles and prizes.
Only Purchase from our verified contract deployed from 0xcfa... and pinned in the telegram.
...
22% Round Trip
8% (3.5% Donation, 3.5% Market/Dev, 1% Redistribution) - BUY
14% (6.5% Donation, 6.5% Market/Dev, 1% Redistribution) - SELL
*/
...
contract RiddleToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Riddle Token";//
    ...
    address payable private _developmentAddress = payable(0xcfa05B11215d5821ED9AD0e332de559109cd180e);//
    address payable private _marketingAddress = payable(0xccD08B9aB294aa19eF019c25178646A27B8F02C3);//
