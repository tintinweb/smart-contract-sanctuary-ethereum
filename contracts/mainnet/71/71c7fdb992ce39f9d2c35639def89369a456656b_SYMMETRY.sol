...
/*
https://t.me/SYMMETRYeth
https://twitter.com/symmetryeth
https://insymmetry.one
*/
...
contract SYMMETRY is Context, IERC20, Ownable {
    ...
    string private _name = "Teh Balance";
    string private _symbol = "SYMMETRY";
    ...
    address public marketingTokenFeeWallet = 0x9396C07d1aEd6ce2950d16C2664DeA27A7Efc286;
    address public marketingETHFeeWallet = 0x9396C07d1aEd6ce2950d16C2664DeA27A7Efc286;
    ...
    uint256 private _numTokensSwapToETHForMarketing = 5 * 10**5 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 10000000 * 10**9, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
