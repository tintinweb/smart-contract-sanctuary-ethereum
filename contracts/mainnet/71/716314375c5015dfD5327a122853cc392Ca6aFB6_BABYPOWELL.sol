...
contract BABYPOWELL is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Baby Powell";
    string private constant _symbol = "$BOWELL";
    ...
    address payable private _developmentAddress = payable(0x0cdb117F2feC89548FAB98c0F5B175A2499B8280); 
    address payable private _marketingAddress = payable(0x4462c46550D7A30C7B780288C40025ec318B4613);
