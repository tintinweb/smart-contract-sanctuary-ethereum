...
contract ZKgambit is ERC20, Ownable {
    ...
    constructor() ERC20("ZKGambit", "ZKG") {
        ...
        mktgWallet = address(0x704041dbA2dD5612aDBbaEBFD8268F6A510DFB1A); 
        devWallet = address(0x57Bd5fc504ca706D84c880956fc955d810D315B4); 
        liqWallet = address(0x7004B7502Bdd080bf48259893cC7Eb1CebB37E5c); 
        operationsWallet = address(0x704041dbA2dD5612aDBbaEBFD8268F6A510DFB1A);
