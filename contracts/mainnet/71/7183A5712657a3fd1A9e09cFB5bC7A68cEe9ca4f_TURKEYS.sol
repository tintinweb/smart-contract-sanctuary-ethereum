...
// MAKE A COMMUINTY TG AND RUN IT. ITS JUST A MATTER OF TIME UNTIL THE TURKEYS TAKE OVER.
...
contract TURKEYS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PLANETOFTHETURKEYS", "TURKEYS") {
