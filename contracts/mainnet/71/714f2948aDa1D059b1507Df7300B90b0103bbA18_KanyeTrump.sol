...
// Kanye and Trump are back on Twitter, a good meme.
...
contract KanyeTrump is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Kanye Trump";
    string private constant _symbol = "YETRUMP";
