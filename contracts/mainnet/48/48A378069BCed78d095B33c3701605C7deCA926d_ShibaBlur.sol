...
contract ShibaBlur is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        reward: 0x805723db954EC8a3205E994021BfBd01C47Be385,
        marketing: 0x805723db954EC8a3205E994021BfBd01C47Be385
    });
    ...
    constructor() ERC20("ShibaBlur", "SBLUR") {
        ...
        uint256 totalSupply = 50 * 1e6 * 1e18;
