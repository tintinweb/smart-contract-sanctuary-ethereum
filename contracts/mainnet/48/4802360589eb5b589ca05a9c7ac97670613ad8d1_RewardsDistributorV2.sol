...
interface INFTFeeClaim {
    function depositRewards(uint256[] memory ids, address _nft, address _token, uint256 _amount) external;
}
...
contract RewardsDistributorV2 is INFTFeeClaim, Ownable, ReentrancyGuard, TokensRecoverable {
    using Address for address;
    ...
    function depositRewards(uint256[] memory ids, address _nft, address _token, uint256 _amount) override external nonReentrant {
