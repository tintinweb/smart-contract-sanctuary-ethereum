...
contract DRACARYS is Ownable, ERC721A {
    
    
    uint256 public dragongold = 0.009 ether;
    uint256 public max_supply = 111;
    bool public dovah = true;

    string private baseurl;

    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("DRACARYS", "DCRYS") {
        	_safeMint(0x36d805A97A5F5De2c320E14032Fbd20B16d8d919, 15);

    }

    function mint(uint256 _quantity) external payable mintCompliance(){
         require(msg.value >= dragongold * _quantity, "NO MONEY");
    ...
    function bexdovah() public onlyOwner {
        dovah = !dovah;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(!dovah, "Sale is not active yet.");
