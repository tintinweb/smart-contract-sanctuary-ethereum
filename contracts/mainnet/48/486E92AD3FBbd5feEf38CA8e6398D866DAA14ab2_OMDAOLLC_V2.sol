...
contract OMDAOLLC_V2 is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable {
    ...
    function buyToken(uint256 _amount) external{
        ...
        IERC20 usdt = IERC20(addrUSDT);
        (bool success) = usdt.transferFrom(_msgSender(), address(this), _amount);
    ...
    function sellToken(uint256 _amount) external{
        ...
        IERC20 usdt = IERC20(addrUSDT);
        (bool success) = usdt.transfer(_msgSender(), _amount*9/10);
        require(success,"Transfer failed!");
    }
