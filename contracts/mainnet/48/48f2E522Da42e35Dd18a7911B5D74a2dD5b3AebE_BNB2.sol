...
contract BNB2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BNB2.0";
    string private constant _symbol = unicode"BNB2.0";
    ...
    uint256 private _maxTxAmount = 30_000 * 10**9;
