...
/**
Shazam || Fury of The Gods 沙赞

Shazam is a superhero based on the DC Comics character

Shazam has a Superhuman strength, therefore we'll make it to be Super project on Ethereum

Multiple NFTs of Shazam will be published to powering this project

SHAZAM will help us all, to be the real heroes!

Telegram : http://t.me/ShazamERC20
*/
...
// SPDX-License-Identifier: Unlicensed
    ...
    contract shazam is ERC20 {
        ...
        constructor () ERC20("Fury of The Gods", "$Shazam"){

            numTokensSellToSendEthToDev = 8000000 * 10 ** decimals();
            _devWalletAddress = 0xac357d6b5a214a9E05B99157E106F4e94Dec0Fbc;
            ...
            */
            ...
            _maxWalletBalance = (totalSupply() * 4 ) / 100;
            _maxTxAmount = (totalSupply() * 4 ) / 100;
