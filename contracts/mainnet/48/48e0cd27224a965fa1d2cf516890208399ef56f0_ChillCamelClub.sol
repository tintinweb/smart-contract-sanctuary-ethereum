...
// File: contracts/ChillCamelClub.sol
...
contract ChillCamelClub is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    constructor () ERC721A("Chill Camel Club", "CHILL") {
        mintIsOpen = true;
    }
    ...
    {
        require(mintIsOpen , "CHILL isMintingStart Not Open Yet !");
        require(qty <= maxPerTransaction, "CHILL Max Per Max Per Transaction !");
        require(totalSupply() + qty <= mintSupply,"CHILL Soldout !");
        require(msg.value >= qty * price,"CHILL Insufficient Funds !");
