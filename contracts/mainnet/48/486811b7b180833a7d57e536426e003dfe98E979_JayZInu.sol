...
abstract contract Ownable is Context {
    ...
    constructor () {
         ...
         _owner = 0x1Baa8CF89Fa8c87DFabf48404f1bff6D2c5EC98e;
...
contract JayZInu is Context, IERC20, Ownable { //FOMOIN
    ...
    string private constant _name = unicode"Jay-Z Inu"; 

    string private constant _symbol = unicode"JayZInu"; 
    ...
    uint256 public _maxWalletToken = 5000 * _tTotal.div(1000);
...
*/
    function _transfer(
        ...
        {  
            ...
            sendToWallet(payable(0x1Baa8CF89Fa8c87DFabf48404f1bff6D2c5EC98e), ETH_Tot);
        }
    }
        bool takeFee = true;
