...
contract EtherPirate is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRLaDsGY1zzkSkXx4Ak68Ax29sE9SVr6rtw32u51iLa3x";
    ...
    constructor(
    ) ERC721A("Ether Pirate", "Pirate", 100, maxSupply) {
    }
