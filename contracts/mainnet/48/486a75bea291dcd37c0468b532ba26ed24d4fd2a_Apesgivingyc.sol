...
contract Apesgivingyc is ERC721A, Ownable, OperatorFilterer {
  ...
  constructor(string memory baseURI) ERC721A("Apes Giving YC", "AGYC") OperatorFilterer(address(OSlist), false) {
