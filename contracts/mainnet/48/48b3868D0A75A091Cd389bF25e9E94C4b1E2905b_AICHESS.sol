...
/**
Telegram: https://t.me/AIChessPortal
Website:  game.aichess.network/
Twitter:  Twitter.com/AIChessErc
*/
...
contract AICHESS is ERC20, Ownable {
    ...
    constructor() ERC20("AI Chess", "AICHESS") {
		...
		charityWallet = address(0xADCA206b1630C2F258bff32C2E60c4DBCb524020); // set as charity wallet
        marketingWallet = address(0xADCA206b1630C2F258bff32C2E60c4DBCb524020); // set as marketing wallet
        devWallet = address(0xADCA206b1630C2F258bff32C2E60c4DBCb524020); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 35, "Max BuyFee 35%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 35, "Max SellFee 35%");
