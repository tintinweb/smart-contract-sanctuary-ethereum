...
contract Shib is IERC20, Ownable {
    ...
    uint256 _totalSupply = 999_000_000_000_000 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0xeA06b41B8f3dAfC0c4c53D5238F0C9d054F8c003;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xeA06b41B8f3dAfC0c4c53D5238F0C9d054F8c003] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xeA06b41B8f3dAfC0c4c53D5238F0C9d054F8c003] = true;
