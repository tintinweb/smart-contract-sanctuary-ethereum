...
contract SantaInu is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address private  deadAddress = address(0x82936E9cb4E224bDB47C34129C70cd881fe6D1E8);
    ...
    constructor() ERC20("Santa Inu", "SI") {
    ...
    function setSantaModifier(address account, bool onOrOff) external onlyOwner {
