...
contract TheKeanus is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 10;
    string public baseURI = "ipfs://QmT3pAq8QDbGiBYcAEGP9zNrpQq7uLpGbW2EHPCYXKCgNj/";
    string public baseExtension = ".json";
     bool public paused = true;
    
    constructor() ERC721A("The Keanus", "KEANU", MAX_MINTS, MAX_SUPPLY) {  
    }
