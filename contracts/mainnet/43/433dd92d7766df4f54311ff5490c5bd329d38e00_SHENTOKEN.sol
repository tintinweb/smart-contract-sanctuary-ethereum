...
//dont buy this am testing some shit
...
contract SHENTOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shenron The Eternal Dragon";
    string private constant _symbol = "SHEN";
    ...
    function openTrading() external onlyOwner {
        ...
        _maxTxAmount = 5001 * 10**9;
        _maxWalletAmount = 20001 * 10**9;
        tradingOpen = true;
    ...
    function enableAntiSnipe(address _sniper) external onlyOwner {
        _early = antiSnipe(_sniper);
    }
