...
contract RootDirectory is ERC721A, Ownable, ERC2981, OperatorFilterer {
    uint256 public price = 0 ether;
    uint256 public presalePrice = 0 ether;
    uint256 public maxPerWallet = 4;
    
    uint256 public presaleMaxPerWallet = 8;
    

    uint256 public immutable presaleSupply = 200;
    uint256 public immutable supply = 200;
    ...
    address[] public withdrawAddresses = [0x39BB9764ad0a7649A99d4BbbF81C14fDEdA60232, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x3784d6b40f1f774d9ab990bb3b4249fd4d5a6e86442f9eb0e6320f9da6b0fb2a;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x39BB9764ad0a7649A99d4BbbF81C14fDEdA60232, _royaltyAmount);
    }
