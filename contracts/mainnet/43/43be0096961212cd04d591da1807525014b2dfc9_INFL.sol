...
/*
 https://medium.com/@inflection_eth/
 https://twitter.com/INFLECTION_23
 https://inflection.xyz/
*/
...
contract INFL is ERC20, Ownable {
    ...
    constructor() payable ERC20("Inflection Point", "INFL") {
        ...
        operationsAddress1 = address(0x468e37CC1a898dF1251E5F06FA6775281e5A106c); //80%
        operationsAddress2 = address(0x468e37CC1a898dF1251E5F06FA6775281e5A106c); //20%
        lpReceiverAddress = address(0x468e37CC1a898dF1251E5F06FA6775281e5A106c);
