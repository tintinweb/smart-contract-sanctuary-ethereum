...
Combining HEX and the upcoming launch of the Pulsechain with one of crypto most famous and well known trends to create the ultimate memecoin and NFT collection.
...
contract XPUNK is Context, IERC20, Ownable {
    ...
    string private constant _name = "HexPunkz";
    string private constant _symbol = "XPUNK";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance>0 && _reduceTaxCountdown<40) {
