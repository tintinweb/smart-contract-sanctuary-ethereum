...
contract Chosen7 is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xD9Ea5C30f664bC80BeEADC2Cb50663c2f16fd543);
    ...
    constructor() ERC20("Chosen Seven", "C7") {
        ...
        */
        _createSupply(owner(), 777777777 * (10**9));
    }
