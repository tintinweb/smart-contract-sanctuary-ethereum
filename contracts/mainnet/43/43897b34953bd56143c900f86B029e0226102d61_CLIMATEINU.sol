...
contract CLIMATEINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Climate Change Inu";
    string private constant _symbol = unicode"CCI";
