...
contract PreGen is ERC721Enumerable, Ownable {
    ...
    function _mint(address _toAddress) internal {
        ...
        uint256 tokenIdToBe = getRandomness(_toAddress);
    ...
    function getRandomness(address _to) public view returns (uint256) {
        ...
        uint256 randomNumber = uint256(keccak256(abi.encodePacked(block.number, block.timestamp, _to, totalSupply()))) % count;
