...
contract ShibaCat is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Shiba Cat";
    ...
    address payable private _developmentAddress = payable(0x59832FF9616aad9ea03D1223F40624B8Cf50a9fA);
    address payable private _marketingAddress = payable(0x59832FF9616aad9ea03D1223F40624B8Cf50a9fA);
