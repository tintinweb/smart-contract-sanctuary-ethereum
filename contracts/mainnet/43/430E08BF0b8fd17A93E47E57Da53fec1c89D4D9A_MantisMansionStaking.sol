...
contract MantisMansionStaking is ReentrancyGuard {
    ...
    function withdraw(uint256 _tokenId) external nonReentrant {
        ...
        require(
            ...
            "You have no Mantises staked"
        );
        
        // Wallet must own the token they are trying to withdraw
        require(stakerAddress[_tokenId] == msg.sender, "You don't own this Mantis!");
    ...
    function claimRewards() external {
        ...
        require(rewards > 0, "You have no BUGZ to claim");
        stakers[msg.sender].timeOfLastUpdate = block.timestamp;
