...
contract DonkeyShlongInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "DonkeyShlongInu";
    string private constant _symbol = "SHLONG";
    ...
    address payable private _developmentAddress = payable(0xEcef0de446A78DC921a9797A6fdCF58a06061445);
    address payable private _marketingAddress = payable(0xc9EFA0A60E2b7c373b38Bd29A2dee6bCfbE8416A);
    ...
    uint256 public _maxTxAmount = 50000000000 * 10**9; //0.1%
    uint256 public _maxWalletSize = 500000000000 * 10**9; //1%
    uint256 public _swapTokensAtAmount = 50000000000 * 10**9; //0.1%
