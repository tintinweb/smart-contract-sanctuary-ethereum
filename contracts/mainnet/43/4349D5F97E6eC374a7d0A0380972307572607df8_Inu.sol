...
contract Inu is Context, IERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0xCD9d56Ca52A05fA798AF4dCf0A87c8b7aE9545B3);
    ...
    string private constant _name = unicode"كلب";
    string private constant _symbol = unicode"كلب";
