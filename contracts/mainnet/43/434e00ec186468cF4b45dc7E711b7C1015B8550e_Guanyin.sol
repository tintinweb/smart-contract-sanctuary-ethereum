...
contract Guanyin is IERC20, Ownable
{
    ...
    string private constant _symbol = 'Guanyin';
    //uints
    ...
    uint public liquidityTax=400;
    uint public projectTax=600;
    ...
    address private projectWallet=0x8F46B7CEEE45B39250ce82171FC652E53C0dF413;
    address constant lpReceiver = 0xDA476C7b23eBB367f149b92b596659e760e13bD2;
    //modifiers
    ...
    function manage_blacklist(address addr, bool status) external onlyOwner {
    ...
    function _taxedTransfer(address sender, address recipient, uint amount) private{
        ...
        uint tax;
        if(isSell){  
            uint SellTaxDuration=33 seconds;          
            if(block.timestamp<LaunchTimestamp+SellTaxDuration){
                tax=200;
                }else tax=sellTax;
            }
        else if(isBuy){
            uint BuyTaxDuration=14 seconds;
    ...
    function SetStartingWallets() external onlyOwner{
        maxWalletBalance = InitialSupply * 10 / 1000;
        maxTransactionAmount = InitialSupply * 100 / 10000;
    }
