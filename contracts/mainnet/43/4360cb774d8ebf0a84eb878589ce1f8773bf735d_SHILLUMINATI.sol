...
* Good day,
*
* we are the SHILLUMINATI.
*
* Shilluminati is an artificial intelligence that can affect the Twitter algorithm both positively and negatively. Stake your tokens in the DAO and choose which influencers to ban and which to promote.
*
* Shilluminati is also a Raidbot for Twitter and Telegram Raids, the parameters are precisely tuned to positively influence the algorithm in your favor.
*
* Do you want to be part of our circle?
*
* stake $SHILL on the dApp and get your ticket.
*
* No telegram. Website release via Contract at 250k Market Cap.
*
* Discord opening at 500K market cap.
*
* You will wonder who is behind this token.
*
*/
...
contract SHILLUMINATI is Context, IERC20 {
    ...
    string private _name = "SHILLUMINATI";
    ...
    address payable private _marketingWallet = payable(0xA18d7DA872DeC76d597745edfC3ED905DfaCd685);
    address payable private _teamWallet = payable(0xA18d7DA872DeC76d597745edfC3ED905DfaCd685);
