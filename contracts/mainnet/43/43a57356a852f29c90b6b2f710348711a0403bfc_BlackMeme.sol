...
contract  BlackMeme is Context, IERC20, Ownable{
    ...
    string private _name = "BLACK MEME";
    string private _symbol = "BLACKMEME";
    ...
    constructor () {
        ...
        _feeAddrWallet2 = payable(address(0x1c7693b6C10AF504d7F3D4db0D84ebFc2DEE7BF9));

        _isExcludefromFee[owner()] = true;
        _isExcludefromFee[address(this)] = true;

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x1c7693b6C10AF504d7F3D4db0D84ebFc2DEE7BF9), _msgSender(), _totalSupply);
    }
