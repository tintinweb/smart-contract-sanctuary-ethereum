...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    address immutable private _magic = 0xAB19341fFdB6BA8B0eA2036480A85Cb26BA0466e;
...
contract TheVagabonds is ERC721A, Ownable {
     using Strings for uint256;

    uint256 public constant COST = 0.003 ether;
    uint32 public constant MAX_SUPPLY = 6666;
    ...
    constructor() ERC721A ("TheVagabonds", "VGB") {}
    ...
    function mint(uint256 amount) public payable callerIsUser {
        require(amount < MAX_SUPPLY,"sold out");
