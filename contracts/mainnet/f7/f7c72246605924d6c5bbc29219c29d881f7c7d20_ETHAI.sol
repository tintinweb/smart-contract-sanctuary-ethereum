/**
                      ...
                      `7MM"""YMM MMP""MM""YMM `7MMF'  `7MMF'      db      `7MMF'
                        MM    `7 P'   MM   `7   MM      MM       ;MM:       MM  
                        MM   d        MM        MM      MM      ,V^MM.      MM  
                        MMmmMM        MM        MMmmmmmmMM     ,M  `MM      MM  
                        MM   Y  ,     MM        MM      MM     AbmmmqMA     MM  
                        MM     ,M     MM        MM      MM    A'     VML    MM  
                      .JMMmmmmMMM   .JMML.    .JMML.  .JMML..AMA.   .AMMA..JMML.
...
contract ETHAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "EthereumAI"; // 
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x2DeD3C732896d53A3b06b757F4ea229d0280082B).transfer(ethToSend); //marketing wallet
    }
