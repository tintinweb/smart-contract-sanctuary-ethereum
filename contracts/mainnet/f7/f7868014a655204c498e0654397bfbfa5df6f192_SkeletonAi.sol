...
abstract contract Ownable is Context {
 ...
 abstract contract ERC721AQueryable is ERC721A
 {
    ...
    contract SkeletonAi is ERC721AQueryable, Ownable {
    using Strings for uint256;


  string private uriPrefix ;
  string private uriSuffix = ".json";
 string public hiddenUri = "ipfs://QmR5uRN9aSSs2TqNvCVW7rPtL8SqURTCdQzhyPnpqdG2Jj" ;

  
  

  uint256 public cost = 0.03 ether;
  uint256 public whiteListCost = 0.025 ether;

  uint16 public constant maxSupply = 4000;
  ...
  bytes32 public whitelistMerkleRoot = 0xb81fc004937b9c12795a2434569dbb174e1fcc500ac6fca51912afbecd6ff06d;
  

  constructor() ERC721A("Skeleton Ai", "$SKEL") {
  }
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
       ...
       require (_txPerAddress + _mintAmount <= maxWLMintAmountPerWallet, "Exceeds max nfts allowed per wallet");
      


    require(!WLpaused, "Sale has not started yet!");
