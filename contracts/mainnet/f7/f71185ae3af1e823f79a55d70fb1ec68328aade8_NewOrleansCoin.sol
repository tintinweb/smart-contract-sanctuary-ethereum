...
contract NewOrleansCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NewOrleansCoin() {
        ...
        name = "New Orleans Coin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NOLA";                                             // Set the symbol for display purposes (CHANGE THIS)
