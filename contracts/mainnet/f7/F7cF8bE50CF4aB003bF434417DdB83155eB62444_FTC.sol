...
/        |                       /        |       /  |                                /  |  /  |                                  
$$$$$$$$/______    ______        $$$$$$$$/______  $$ |____          _______  __    __ $$ | _$$ |_    __    __   ______    ______  
$$ |__  /      \  /      \          $$ | /      \ $$      \        /       |/  |  /  |$$ |/ $$   |  /  |  /  | /      \  /      \ 
$$    |/$$$$$$  |/$$$$$$  |         $$ |/$$$$$$  |$$$$$$$  |      /$$$$$$$/ $$ |  $$ |$$ |$$$$$$/   $$ |  $$ |/$$$$$$  |/$$$$$$  |
$$$$$/ $$ |  $$ |$$ |  $$/          $$ |$$    $$ |$$ |  $$ |      $$ |      $$ |  $$ |$$ |  $$ | __ $$ |  $$ |$$ |  $$/ $$    $$ |
$$ |   $$ \__$$ |$$ |               $$ |$$$$$$$$/ $$ |  $$ |      $$ \_____ $$ \__$$ |$$ |  $$ |/  |$$ \__$$ |$$ |      $$$$$$$$/ 
...
$$/     $$$$$$/  $$/                $$/  $$$$$$$/ $$/   $$/        $$$$$$$/  $$$$$$/  $$/    $$$$/   $$$$$$/  $$/        $$$$$$$/ 
 ...
 TG: @ForTehCulture_Portal
 Twitter: https://twitter.com/4TehCulture
 Website: https://fortehculture.app/                                                                                                                                                                                                                                                                    
*/
...
contract FTC is ERC20, Ownable {
    ...
    constructor(
        address[] memory _excludedAddress
    ) ERC20("ForTehCulture", "$FTC") {
        ...
        swapTokensAtAmount = 750_000 * 1e18;
        ...
        for (uint256 i = 0; i < _excludedAddress.length; i++) {
            _isExcludedFromFees[_excludedAddress[i]] = true;
        }
        /*
    ...
    function updateSellFees(
        ...
        sellDevFee = _devFee;
        sellTreasuryFee = _buyTreasuryFee;
    ...
    function _transfer(
        ...
        require(!isBot[to], "Sniper detected");
        require(!isBot[from], "Sniper detected");
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokenForTreasury += (fees * sellTreasuryFee) / sellTotalFees;
            ...
            // on buy
                ...
                tokenForTreasury += (fees * buyTreasuryFee) / buyTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 ethForDev = ethBalance.mul(tokenForDev).div(totalTokensToSwap);
