...
// The White Rabbit can moon, so can we.
...
contract BRBT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Black Rabbit", "BRBT") {
        ...
        marketingWallet = address(0xA63727B0D1b13b32110780f3A39581A3E7046835); // set as marketing wallet
