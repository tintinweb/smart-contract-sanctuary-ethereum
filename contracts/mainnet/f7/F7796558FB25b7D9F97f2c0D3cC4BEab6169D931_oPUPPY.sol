...
contract oPUPPY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ordinal Puppynet", "oPUPPY") {
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    ...
  	    require(newAmount <= totalSupply() * 7 / 1000, "Swap amount cannot be higher than 0.7% total supply.");
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x2094bFDE3C7A31b9F04d4A52Db58c5B4F8b39e1B,
            block.timestamp
        );
    }
