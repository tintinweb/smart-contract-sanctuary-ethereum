...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IERC20  USDT = IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
...
/* Token contract */
contract Santacatoken is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x38f0F536Fb46D95A1d448AA817C73d2628f17134;
    ...
    // Name and symbol
    string constant _name = "Santa Cat Token";
    string constant _symbol = "SANTA";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 20023 * (10 ** _decimals);

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000;
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 10000; // .5% of supply
