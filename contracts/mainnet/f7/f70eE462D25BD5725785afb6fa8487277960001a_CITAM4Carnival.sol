...
/** 
  * @title CIT AM4 Carnival
  * @author 0xjikangu
  * @notice This is the Main NFT contract for CIT AM4 Carnival
*/

contract CITAM4Carnival is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {

  using Strings for uint256;

  string public uriPrefix = "ipfs://QmQHrSXkYLX69ApBBHerMppUXc1xgWSTY2qxfeKF1fzcTo/";
...
// ATG Main Constructor
  ...
  function reserveTokens (address _receiver, uint256 _mintAmount) public onlyOwner {
    ...
    */
  function airdropTokens(address[] calldata hAddresses, uint256[] calldata tokenAmt) public onlyOwner {
