...
contract BCDividends is IBCDividends {
    ...
    function removeStuckDividends() external onlyToken {
        uint256 balance = IERC20(Shib).balanceOf(address(this));

        IERC20(Shib).transfer(
    ...
    function deposit() public payable override {
        uint256 balanceBefore = IERC20(Shib).balanceOf(address(this));
        ...
        uint256 amount = IERC20(Shib).balanceOf(address(this)).sub(
            balanceBefore
        );
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            IERC20(Shib).transfer(shareholder, amount);
...
contract ShibSupport is IERC20, Auth {
    using SafeMath for uint256;

    address public Shib = 0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE; //Shib

    string private constant _name = "Support Our Shib";
