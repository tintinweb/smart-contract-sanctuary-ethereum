...
contract BebeeNfts is Ownable, ERC721A {
  string public baseURI = "https://bafybeideys4dhruyjk7b7eebvqdshrbeiydbn3rnvpuxdllgca4dniuqrm.ipfs.nftstorage.link/";
  ...
  constructor(uint256 _mintCntToOwner) ERC721A('BeBee', 'BEE') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 3332) {
