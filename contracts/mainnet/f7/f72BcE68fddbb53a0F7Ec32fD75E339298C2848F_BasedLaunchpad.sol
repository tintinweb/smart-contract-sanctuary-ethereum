...
Telegram Portal : https://t.me/BasedLaunchpad

V1 Whitepaper: https://basedlaunchpads-organization.gitbook.io/based-launchpad-whitepaper/
⠀⠀⠀⠀⠀⠀⠀
*/
...
contract BasedLaunchpad is ERC20, Ownable{
    ...
    address public marketingWallet = 0x214b08d10D033AF606acAb6525E2C2519a01bCFB;
    address public devWallet = 0x214b08d10D033AF606acAb6525E2C2519a01bCFB;
    ...
    Taxes public taxes = Taxes(99,0,0);
    Taxes public sellTaxes = Taxes(35,0,0);
    uint256 public totTax = 99;
    ...
    constructor() ERC20("Based Launchpad ", unicode" $BPAD") {
    ...
    function setTradeOpen(uint256 numOfDeadBlocks) external onlyOwner{
    ...
    function BaseTax(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function BaseSellTax(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
