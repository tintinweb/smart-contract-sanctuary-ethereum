...
contract SashimiSwap is IERC20, Auth {
	string _name = "SashimiSwap";
	string _symbol = "SASHIMI";
	...
	address payable private _ethTaxWallet1 = payable(0x36377285E7bE3d8d2e482594525D459EdEdA7043); 
	address payable private _ethTaxWallet2 = payable(0x36377285E7bE3d8d2e482594525D459EdEdA7043); 
	address payable private _ethTaxWallet3 = payable(0x36377285E7bE3d8d2e482594525D459EdEdA7043); 
	address private _tokenTaxWallet = address(0x4ab34E78C6FF3a782E3EF2A985221f4a755E16f8); 
