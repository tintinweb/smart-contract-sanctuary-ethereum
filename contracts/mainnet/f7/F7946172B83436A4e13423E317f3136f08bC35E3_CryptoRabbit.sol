/**
  ...
  / ____|                | |        |  __ \     | |   | |   (_) |  
 | |     _ __ _   _ _ __ | |_ ___   | |__) |__ _| |__ | |__  _| |_ 
 | |    | '__| | | | '_ \| __/ _ \  |  _  // _` | '_ \| '_ \| | __|
 | |____| |  | |_| | |_) | || (_) | | | \ \ (_| | |_) | |_) | | |_ 
  \_____|_|   \__, | .__/ \__\___/  |_|  \_\__,_|_.__/|_.__/|_|\__|
               __/ | |                                             
              |___/|_|                                             
...
contract CryptoRabbit is ERC721A {
    string uri = "ipfs://QmTw7k5fTnsGciCoznG83VFd5o1fuKqPvNXFtfYRQLvPWL/";
    ...
    constructor() ERC721A("Crypto Rabbit", "CR") {
        owner = msg.sender;
        maxSupply = 100;
    ...
    function FreeNum() internal view returns (uint256){
        if (totalSupply() < 50) {
            return 10;
        }
        if (totalSupply() < 80) {
