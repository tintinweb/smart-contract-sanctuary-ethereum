...
contract MONSSALE is ReentrancyGuard, Ownable, Pausable {
    ...
    constructor() {
        ...
        baseDecimals = (10 ** 18);
        salePrice = 10 * (10 ** 12); //0.00001 USD
        hardcapSize = 101_000_000_000_000_000_000_000;
        hardcapsizeUSD = 500000000000000000;
        totalTokensForPresale = 101_000_000_000_000_000_000_000;
        totalUsdValueForPresale = 500000000000000000;
        minimumBuyAmount = 20;
        inSale = totalTokensForPresale;
        inSaleUSDvalue = 5000000000000000000000000000000000;
        startTime = block.timestamp;
        endTime = block.timestamp + 900 days;
