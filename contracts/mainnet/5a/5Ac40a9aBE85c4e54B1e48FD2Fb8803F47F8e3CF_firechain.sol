...
contract firechain is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Firechain", "FIRE") {
        ...
        marketingWallet = address(0xA39a1F98057F9fC509084B4FD0F75334a030BC9B); // set as marketing wallet
        devWallet = address(0xEB5fF685f29DeEF207B10d4CBA8dC7E1D867b6aF); // set as dev wallet
