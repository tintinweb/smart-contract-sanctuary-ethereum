...
Taxes are 2% on buys and 2% on sells.  Tax revenue goes to GiveWell - their wallet address is 0x7cF2eBb5Ca55A8bd671A020F8BDbAF07f60F26C1
...
contract GiveWellInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GiveWell Inu", "GINU") {
        ...
        uint256 _buyGiveWellWalletFee = 0;

        uint256 _sellDevFee = 200;
        uint256 _sellGiveWellWalletFee = 0;
        ...
        buyTotalFees = buyDevFee + buyGiveWellWalletFee;
        
        sellDevFee = _sellDevFee;
        sellGiveWellWalletFee = _sellGiveWellWalletFee;
        sellTotalFees = sellDevFee + sellGiveWellWalletFee;
        
        devWallet = 0x4a2be7572EbFd4a097178520Bd91b337C4EFc0b0; // set as dev wallet
    ...
    function updateBuyFees(uint256 _devFee, uint _buyGiveWellWalletFee) external onlyOwner {
        buyDevFee = _devFee;
        buyGiveWellWalletFee = _buyGiveWellWalletFee;
        buyTotalFees = buyDevFee + buyGiveWellWalletFee;
        require(buyTotalFees <= 200, "Must keep fees at 2% or less");
    }
    
    function updateSellFees(uint256 _devFee, uint _sellGiveWellWalletFee) external onlyOwner {
        sellDevFee = _devFee;
        sellGiveWellWalletFee = _sellGiveWellWalletFee;
        sellTotalFees = sellDevFee + sellGiveWellWalletFee;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForDev + tokensForGiveWellWallet;
        bool success;
        ...
        (success,) = address(GiveWellWallet).call{value: ethForGiveWell}("");
