...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7885205b0E1275978F8cEE160A81aDFEaE4517C1];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmUpW99BE2EUbpm1a1Cvs15f8EvKiPB71RayKMt2KS9p4C/";
...
// File: contracts/RunBlocksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RunBlocksContract is RamppERC721A {
    constructor() RamppERC721A("Run Blocks", "Block"){}
}
