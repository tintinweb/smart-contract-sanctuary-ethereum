...
//Channel：https://t.me/REDFEGAICHANNEL
//Twitter: @Red_feg
...
contract RedFegAi is ERC20, Ownable {
    ...
    constructor() ERC20("RedFegAi", "RedFegAi") {
        ...
        uint256 totalSupply = 100000 * 1e8 * 1e18;
        ...
        marketingWallet = address(0xACD5554aB6db3B175852d339521fDB908ec79A33); // set as marketing wallet
        devWallet = address(0xACD5554aB6db3B175852d339521fDB908ec79A33); // set as dev wallet
