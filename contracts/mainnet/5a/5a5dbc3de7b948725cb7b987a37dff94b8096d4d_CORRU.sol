...
contract CORRU is ERC20, Ownable {
    ...
    constructor() ERC20("CORRU", "CORRU") {
        ...
        marketingWallet = address(0xe7FD65E0B2b6ad0a834829be9E7c19384c1A4e0E); // set as marketing wallet
        devWallet = address(0xe7FD65E0B2b6ad0a834829be9E7c19384c1A4e0E); // set as dev wallet
