 ...
 */
 contract Darkpool is ERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToETH = 2400000 * 10**_decimals;     // will be reduced post launch to .1 total swap


    // Antibot  ==============================================>
    function Antibot() external onlyOwner {
        require(taxForMarketing > 45, "Antibot stage one 42%");
        taxForLiquidity = 3;
        taxForMarketing = 39;
        ...
        require(taxForMarketing > 35, "Antibot stage two 24%");
        taxForLiquidity = 2;
        taxForMarketing = 22;
        maxTxAmount = 15000000 * 10**_decimals;
        maxWalletAmount = 15000000 * 10**_decimals;
        ...
        require(taxForMarketing > 20, "Antibot stage three 10%");
        taxForLiquidity = 2;
        taxForMarketing = 8;
        maxTxAmount = 15000000 * 10**_decimals;
        maxWalletAmount = 15000000 * 10**_decimals;
