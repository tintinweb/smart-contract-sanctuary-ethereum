...
/**
Blade Heart Token (BLADEHEART)

🚀LAUNCHING IN 30 MINUTES🚀

🔥🔥 The BLADEHEART project will launch on Uniswap ( ERC20 ) today. Big marketing plans after launch!
...
Renounce + Lock 100% after launch .🚀🚀

Careful where you ape! DYOR!

Telegram : t.me/bladehearteth
**/
...
contract BladeHeart is Context, IERC20, Ownable {
	...
	uint256 private _maxWallet= 50000000 * 10**18;
	...
	string private constant _name = "Blade Heart Token";
	string private constant _symbol = "BLADEHEART";
