...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _totalMinted() internal view returns (uint256) {
        ...
        unchecked {
            ...
            return minted < ShitNumWhat ? minted : ShitNumWhat;
        }
    }
...
contract CosmosPeopleClub  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmdVnS8TW37deMr4QAXzAwtHyyjzgm9wUfpqiVLSthCNGk/";

    uint256 public immutable mintPrice = 0.001 ether;
    uint32 public immutable maxSupply = 5999;
    ...
    constructor()
    ERC721A ("Cosmos People Club", "CPC") {
    }
