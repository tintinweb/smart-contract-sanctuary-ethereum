...
contract BlackPowerSociety is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Power Society";
    string private constant _symbol = "BPS";
    uint256 public _maxTxAmount =   _tTotal.mul(20).div(1000);
    uint256 public _maxWalletSize = _tTotal.mul(20).div(1000);
    uint256 public _taxSwapThreshold=_tTotal.mul(15).div(1000);
    uint256 public _maxTaxSwap=_tTotal.mul(30).div(1000);
