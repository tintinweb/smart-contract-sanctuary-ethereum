...
**Fable Of The Floki**
$FYRANT
TAXES AT LAUNCH 1% / 7% FOR THE FIRST 25 MINS
TAXES WILL BE LOWERED TO 1% / 1% ALL WILL GO TO LIQUIDTY CONTRACT HAS AUTO LP TAX WHICH WILL BE AUTO BURNED.
CONTRACT WILL BE RENOUNCED ONCE TAXES ARE LOWERED AND LP WILL BE LOCKED FOR 12 DAYS TO START BEFORE RENOUNCE.
t.me/fableoftheflokifyrant
...
contract FableOfTheFloki is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "Fable Of The Floki";
    string private _symbol = "FYRANT";
    ...
    uint256 private _totalSupply = 3_333_333_333 * 10**_decimals; 
    ...
    address _owner;
    address payable public marketingAddress = payable(0x74680e600A11916b4FE1a97dD08765575905Ac52);
