...
// https://twitter.com/FlokiPadCoin
...
contract FPAD is ERC20, Ownable {
    ...
    constructor() ERC20("Floki Pad", "FPAD") {
        ...
        marketingWallet = address(0x50521bCFFd3dE09b3C6f7Ef4e37032c0cCfB9D84); // set as marketing wallet
        devWallet = address(0x50521bCFFd3dE09b3C6f7Ef4e37032c0cCfB9D84); // set as dev wallet
