...
Pulse QOM?
QOM = Shiba Predator, the new chain, the merge
PLQOM
...
contract PulseQOM is ERC20, Ownable {
    ...
    constructor() ERC20("PulseShibaPredator", "PLQOM") {
        
        IDexRouter _dexRouter = IDexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        operationsAddress = address(0xd0E0CFE829247Cd5F3b154533A8F6858bb18769C); 
        ...
        uint256 totalSupply = 2 * 1e8 * 1e18;
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _lotteryFee) external onlyOwner {
        ...
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyLotteryFee;
        require(buyTotalFees <= 1000, "Must keep fees at 15% or less");
    }
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _lotteryFee) external onlyOwner {
        ...
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellLotteryFee;
        require(sellTotalFees <= 9500, "Must keep fees at 20% or less");
    }
