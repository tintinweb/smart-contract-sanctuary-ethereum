...
/**
   _      wWw ()_() ))    wWw  wWw     W  W          ___    oo_    
  /||_    (O)_(O o)(o0)-. (O)  (O)    (O)(O)    /)  (___)__/  _)-< 
   /o_)   / __)|^_\ | (_))( \  / )      ||    (o)(O)(O)(O) \__ `.  
  / |(\  / (   |(_))| .-'  \ \/ /       | \    //\\ /  _\     `. | 
  | | ))(  _)  |  / |(      \o /        |  `. |(__)|| |_))    _| | 
  | |//  \ \_  )|\\  \)    _/ /        (.-.__)/,-. || |_)) ,-'   | 
  \__/    \__)(/  \) (    (_.'          `-'  -'   ''(.'-' (_..--'  
...
contract DefinitelyARugNot is ERC721A, Ownable {
    ...
    constructor() ERC721A("Definitely A Rug, Not", "DARN", MAX_MINTS, MAX_SUPPLY) {    
    }
