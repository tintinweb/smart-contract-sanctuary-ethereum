...
// Welcome to Ethernet - 0/0

// TG: https://t.me/ethernetportal

// Website: https://ethernetwork.io/
...
contract Ethernet {
    ...
    string public constant name = "Ethernet";   
    string public constant symbol = "ETHERNET";   
    ...
    address payable constant deployer = payable(address(0x1EceF6c6B1e4fBCAA1aa5A022375f19F2C3A1CA2));
