...
contract FlameCatcher is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlameCatcher"; //
    string private constant _symbol = "Onryo"; //
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xc4604542bb47B0dEd19831db3FEecccC5181DDEC); //wallet
