...
//  ___   __    _  __   __  _______  _______  _______  _______  _______  _______  ______    _______ 
// |   | |  |  | ||  | |  ||       ||       ||       ||       ||       ||       ||    _ |  |       |
// |   | |   |_| ||  |_|  ||    ___||  _____||_     _||   _   ||   _   ||   _   ||   | ||  |  _____|
// |   | |       ||       ||   |___ | |_____   |   |  |  | |  ||  | |  ||  | |  ||   |_||_ | |_____ 
// |   | |  _    ||       ||    ___||_____  |  |   |  |  |_|  ||  |_|  ||  |_|  ||    __  ||_____  |
// |   | | | |   | |     | |   |___  _____| |  |   |  |       ||       ||       ||   |  | | _____| |
// |___| |_|  |__|  |___|  |_______||_______|  |___|  |_______||_______||_______||___|  |_||_______| 

pragma solidity ^0.8.14;

contract Investooor is ERC721A, Ownable {
    using Strings for uint256;
    ...
    address t1 = 0xab45e456c546952996570b08a8f639B997455d08; 
    address t2 = 0x4d32081c4495aE65e726cFfd783C8c096901255E; 
    
    string private baseTokenURI;

    constructor() ERC721A("Investooor", "X100") {}
    ...
    function mint(uint256 _count) external payable {
        ...
        uint256 mintedByAddress = balanceOf(msg.sender);
    ...
    function gift(uint256 _count, address recipient) external onlyOwner {
        uint256 supply = totalSupply();
        require(supply + _count <= MAX_SUPPLY, "Would exceed max supply");
        _safeMint(recipient, _count);
     }
