...
contract BinanceBlack is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Binance Black", "BNBB") {
        ...
        uint256 totalSupply = 200 * 1e6 * 10 ** _decimals;
        supply += totalSupply;
        ...
        devWallet = 0x15fAB93f361Fa5B741C54eC3b997884a56F3D0df; // set as dev wallet
        ...
        */
        ...
        _mint(msg.sender, 200 * 1e6 * 10 ** _decimals);
