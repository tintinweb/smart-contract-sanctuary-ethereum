...
contract DIVIDEND is ERC20, Ownable {
    ...
    string constant _name = "DIVIDENDS BABY";
    string constant _symbol = "DIV";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  // 2% max tx
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100;  // 2% max wallet
    ...
    address private marketingFeeReceiver = 0x1b671Ce6b4a1183CB18ff3C39c1c7B263376834d;
    address private devFeeReceiver = 0x1b671Ce6b4a1183CB18ff3C39c1c7B263376834d;
    address private teamFeeReceiver = 0x1b671Ce6b4a1183CB18ff3C39c1c7B263376834d;
