...
WELCOME TO GOLDEN POTTER

With abilities to produce one of the most valuable GEMS known as GOLDEN POTTER.

https://goldenpotter.com/
https://t.me/GoldenPotterERC
...
contract GOLDENPOTTER is ERC20, Ownable {

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;

    string private _name = "Golden Potter";
