...
contract PunkX is ERC721A {

    uint256 public collectionSize = 88;
    // events
    constructor() ERC721A("OxyTest", "OxyTest", 30000) {}

    function _mintToken(uint _amount) external {
