...
/*
The Trick or Treat is a Fan token of traditional Halloween custom for children and adults in some countries.
The project's mission is to become a payment method for all sweet shops and to make known this beautiful tradition that unites children and adults.
In the coming months we will give the list of stores (for the moment in the US territory).



*/

// WebSite: https://trickortreat-erc20.com/
...
contract TrickOrTreat is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Trick Or Treat - Traditional Halloween Fan";
    string private _symbol = unicode"TOTFAN";
