...
contract SouthParkInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "South Park Inu";
    ...
    address payable private _developmentAddress = payable(0x04da9FEC929489d6B38452A05f17276Da239dD24); 
    address payable private _marketingAddress = payable(0xF3C91e8EbB1787eAA4A73709Ea7dFB5b7c4bC0eE);
