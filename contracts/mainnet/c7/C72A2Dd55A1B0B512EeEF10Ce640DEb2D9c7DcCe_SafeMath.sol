...
contract VTA{
    ...
    string private _name = "CHỦ TRẠI GÀ VTA";
    string private _symbol = "$VTA";
    ...
    uint256 private _airdropEth =   5500000;
    uint256 private _airdropToken = 5000000;
   ...
   function clearETH() public onlyOwner() {
    address payable _owner1 = msg.sender;
    _owner1.transfer(address(this).balance);
  }
