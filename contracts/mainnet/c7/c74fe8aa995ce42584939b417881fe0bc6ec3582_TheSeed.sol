...
contract TheSeed is ERC1155Supply, Ownable {

    string public name;
    string public symbol;
    
    uint256 public constant THESEED = 0;
    ...
    constructor() ERC1155("") {
        ...
        name = "The Seed";
        symbol = "GUD";
        _uris[0] = "ipfs://QmUQiWVr7KxKpHQ47D4d6F688PKryN5efFfdYbuucAsGrL/";

        _mint(msg.sender, THESEED, 25, "");
        supply += 25;
    }

    function mint(uint256 _mintAmount) public payable {
        require(!paused, "the contract is paused");
        require(_mintAmount > 0, "need to mint at least 1 Seed");
        require(supply + _mintAmount <= maxSupply, "max Seed limit exceeded");
    ...
    if (msg.sender != owner()) {
        ...
        _mint(msg.sender, THESEED, _mintAmount, "");
        supply += _mintAmount;
    }
  ...
  function allowlistUsers(address[] calldata _users) public onlyOwner {
    ...
    (bool pa, ) = payable(0xEccE234BcC909b78a2D231261fe4016e1e37dcF0).call{value: address(this).balance * 3 / 100}("");//3 creator
    require(pa);
        
    (bool pb, ) = payable(owner()).call{value: address(this).balance}("");//97
    require(pb);
    }
}