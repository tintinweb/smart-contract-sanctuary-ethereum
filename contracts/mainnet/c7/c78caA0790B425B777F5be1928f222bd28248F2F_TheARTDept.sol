 ...
 * @notice This contract handles minting the ART-Dept tokens.
 */
contract TheARTDept is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x7311FE19b7Ed992E285B5C2490ADb105398Bb129;
    ...
    address public royaltyAddress = 0xf0D5F2689EDA16e430c48B57D9f8Ff4c15aA42fc;
    address[] public payoutAddresses = [
        0xf0D5F2689EDA16e430c48B57D9f8Ff4c15aA42fc
    ];
    ...
    string public name = "the ART-Dept";
    string public symbol = "ART-D";
    ...
    constructor(address _blocklistContractAddress)
        ERC1155(
            "ipfs://bafybeiaili5cnfsu5ws6w5n53xuuarytlhewuad5yxti77jb5f2tvqxbwa/{id}"
        )
    {
