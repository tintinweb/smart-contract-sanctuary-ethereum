...
contract uniapeeth is Context, IERC20, Ownable {
    ...
    string private constant _name = "Uni Ape";
    string private constant _symbol = "UNIAPE";
    ...
    constructor () {
        _feeAddress = payable(0x011ee33eDb3852eC90708045557AD9A1f4D72A46);
        _buyTax = 12;
        _sellTax = 12;
