...
/*
ONIGIRINU SHIBA
The same mentality applies to meme coins. If enough people believe an asset’s value, 
the sky’s the limit.
Telegram : https://t.me/OnigirinuShibaERC
Website : https://www.onigirinushiba.online/
*/
...
contract OnigirinuShiba is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x59aE2740817E21D91E8690029822d482Ce8BF964));

    string private _name = "OnigirinuShiba";
    string private _symbol = "ONISHIBA";
