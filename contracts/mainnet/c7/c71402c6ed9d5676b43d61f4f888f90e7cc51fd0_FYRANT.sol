...
contract FYRANT is ERC20, Ownable {
    ...
    constructor() ERC20("Fable Of The Floki", "FYRANT") {
        ...
        marketingWallet = address(0xff6A268b304AE2FEB656cBDED99e4cB9457fcE3F);
        marketingWallet2 = address(0xe0898fa5D613f6b9b4Ec92735F4047824AF0294a);
    ...
    function swapBack() private {
        ...
        (success, ) = address(marketingWallet).call{value: amt}("");
        (success, ) = address(marketingWallet2).call{value: marketingbalance.sub(amt)}("");
    }
}