...
/**
 NoBuyTax is a 100% Community Driven Token that will feature a SAFEU Stealth Launched 
 that delievers 0% Buy Tax to our investors. 

 The Sell tax will always be 4%, with excepion to if you sell early (<24 hours from buy)
 then the Sell Tax will be 8%. 

 Contract will be Renounced - LP Will be BURNED. 

 TG, Twitter, Website, and other Socials are not planned on launch but could evolve with token growth. 

 This is an M87 Forked Contract
*/
...
contract NoBuyTax is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NoBuyTax", "NBT") {
