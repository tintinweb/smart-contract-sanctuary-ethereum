...
Regal goddess who shines in the heavens
Celestial matriarch of the universe and sun
From Amaterasu-ōmikami descends

The exalted Emperor and his fierce shogun 
 
Keeping the order in the chaos of space
Ensuring the functions of heavenly bodies 
Every morning her radiance shines on my face
Blooming the lotus and ripeness of teas
 
Let me feel you glorious rays
Ōhirume-no-muchi-no-kami 

Bring us another beautiful day 
Let me feel your smile on me

Faith, Prosperity, Well-being.
*/
...
contract GoddessofSun is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20(unicode"Amaterasu-Ōmikami", "FAITH") {
        ...
        uint256 _sellBurnFee = 600;
        uint256 _sellDevFee = 300;
        
        uint256 totalSupply = 1 * 1e3 * 1e18;
    ...
    function updateBuyFees(uint256 _mintFee) external {
        ...
        buyMintFee = _mintFee;
        buyTotalFees = buyMintFee;
        require(buyTotalFees <= 642, "Must keep fees at 6.42% or less");
    }
