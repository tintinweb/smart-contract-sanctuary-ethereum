...
When the BONK is dejitaru, the BONK is extra good.
...
Fees:
    ...
    NO PERSON CAN CALL THE MINT OR BURN FUNCTIONS. IT HAPPENS AUTOMATICALLY. BONK BONK BONK. DEJITARU BONK.

Token Explanation:

BONK BONK BONK BONK BONK BONK BONK BONK DEJITARU BONK BONK DEJITARU BONK BONK
BONK BONK BONK BONK DEJITARU BONK BONK BONK BONK DEJITARU BONK BONK BONK BONK
DEJITARU BONK BONK BONK DEJITARU BONK BONK BONK BONK BONK BONK BONK BONK BONK
...
contract DejitaruBonk is ERC20, Ownable {
    ...
    constructor(address router_, address feeRecipient_) ERC20("Dejitaru Bonk", "dBONK") {
    ...
    function addLiquidity() external payable onlyOwner {
        _addUniswapLiquidity(balanceOf(address(this)), msg.value, feeRecipient);
    }
