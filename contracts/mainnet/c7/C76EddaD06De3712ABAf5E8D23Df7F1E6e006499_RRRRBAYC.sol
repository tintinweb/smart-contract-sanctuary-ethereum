...
contract RRRRBAYC is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("RR/RR/BAYC", "RR/RR/BAYC", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked("ipfs://QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq/", (tokenId+1).toString()));
    }
