...
//(/|  |^ )(\*)(.+|) \s+\n \n\n
contract CryptoSaudis is ERC721A, Ownable {
    ...
    constructor(uint256 maxTokens_, bool saleEnabled_, bool freeMintEnabled_, string memory baseURI_, uint256 maxFreeMints_, uint256 price_) ERC721A("CryptoSaudis","CryptoSaudis") {
    ...
    function mint() external {
        require(_freeMintEnabled, "Mint off");
        require(freeMints[msg.sender] < 1, "You reached max free tokens");
        require(tokensAvailable() > 0, "You reached max tokens");
