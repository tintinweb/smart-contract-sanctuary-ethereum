...
contract Numbuddies10k is ERC721, Ownable, ReentrancyGuard {
    ...
    function getRemainingFree() external view returns (uint256) {
        if (totalSupply.current() < 1000) return 1000 - totalSupply.current();
        else return 0;
    }
    ...
    function getPrice() public view returns (uint256) {
        if (totalSupply.current() < 1000) return 0;
        else if (totalSupply.current() < 2000) return 0.0111 ether;
        else if (totalSupply.current() < 3000) return 0.0222 ether;
        else if (totalSupply.current() < 4000) return 0.0333 ether;
        else if (totalSupply.current() < 5000) return 0.0444 ether;
        else if (totalSupply.current() < 6000) return 0.0555 ether;
        else if (totalSupply.current() < 8000) return 0.0666 ether;
