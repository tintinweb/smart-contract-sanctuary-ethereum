...
⚽️WELCOME TO THE WORLD OF CHAMPION INUS!⚽️

World of Champion Inus  is developing a unique P2E game that allows users to hedge bets against other select meme coins (Floki, Doge, Shiba, etc.) and uses the memecoins of choice as the playable characters for the World of Champion Inus video game!

Experience the joy of using your favorite memecoins characters to bet against other top memecoins in crypto for a chance to earn profit and become the World Champion of all Inus.

⚽️2022 FIFA WORLD CUP! 
...
JOIN OUR COMMUNITY!
- Telegram: https://t.me/worldofchampioninus
- Twitter: https://twitter.com/championinus
- Website: https://worldofchampioninus.com/
*/
...
contract WORLDCHAMPIONINUS is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "WORLD OF CHAMPION INUS";
    string constant _symbol = "WOCI";
    ...
    address payable public liquidityFeeReceiver = payable(0x6F37Fb1Bf66dF52Dc67e90fd253Af9DFA6210dC1);
    address payable public marketingFeeReceiver = payable(0x6F37Fb1Bf66dF52Dc67e90fd253Af9DFA6210dC1);
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _sellBias, uint256 _feeDenominator) external onlyOwner {
        require(_liquidityFee < 10 && _marketingFee < 10 && _sellBias < 10 && _feeDenominator <= 10000);        
