...
contract THEPROTOCOL is ERC20, Ownable {
    ...
    constructor() ERC20("The Protocol", "THE") {
        ...
        marketingWallet = address(0x8D21b508091BD04cA9f05f50c931F2C19c5BC4e5); // set as marketing wallet
        devWallet = address(0x8D21b508091BD04cA9f05f50c931F2C19c5BC4e5); // set as dev wallet
