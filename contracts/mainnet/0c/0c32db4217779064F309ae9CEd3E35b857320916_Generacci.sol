...
contract Generacci is ERC721A {
    ...
    function mint(uint256 amount) compliance(amount) payable public {
        require(totalSupply() + amount <= maxSupply);
        _safeMint(msg.sender, amount);
    }

    modifier compliance(uint256 amount) {
        if (msg.value == 0) {
            require(amount == 1);
    ...
    constructor() ERC721A("Generacci", "Generacci") {
        owner = msg.sender;
        price = 0.002 ether;
        uri = "ipfs://QmeoZGvfL1mtzUHqEJJhRtDeBb9y1HeNx32SUHskchmBoa/";
    }
