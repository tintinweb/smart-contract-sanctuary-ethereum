...
contract DiamondHearts is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 555;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.005 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x42ac946eeed40c4ee11bda66c70ad766df039b590fc437a58789a047bb2edc14;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://Qmaathtzft7UqiFkcjknaqpuuHD2DpVYfLrkfPA3CgiMm4";

    constructor() public ERC721A("DiamondHearts", "DIHART", 555, 555) {}
