...
contract TheRaven is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "The Raven";
    ...
    address payable private _opAddress = payable(0x7ea1d2041aD5B9BDB4dF7aAD889A574f4a7CA152);
