...
https://twitter.com/elonmusk/status/1596704250880720898?s=20&t=qfP8T69xB9-X9cWJaSgUug
...
contract ElonsElons81000MilesMiles is Context,IERC20, Ownable{
using Address for address;
string private _name = "Elons 81000 Miles";
string private _symbol = "81000";
...
address _owner;
address payable public marketingAddress = payable(0x8B897aA2e6B965F714A7FC11ECe4e3B059b8BA87);
...
uint256 Elons81000MilesCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > Elons81000MilesCOINDaycooldown, "You cant call Elons81000MilesCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function Elons81000MilesCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    Elons81000MilesCOINDaycooldown = block.timestamp + 86400;
}
