...
contract D7 is ERC20, Ownable {
    ...
    constructor() ERC20("Dimension 7", "D7") {
        ...
        marketingWallet = address(0x6CAf13a24A6eA606fdada35745BF6feC7D694cC6); // set as marketing wallet
        devWallet = address(0x6CAf13a24A6eA606fdada35745BF6feC7D694cC6); // set as dev wallet
