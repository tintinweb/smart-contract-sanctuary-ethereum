...
/**
 Update: Lets try again! Last one had major volume, few calls, telegram and lowered SELL TAX this time!

 TELEGRAM : https://t.me/ReceiveCryptoToken

This is AcceptCrypto launched correctly and with a good contract. For everyone who missed AcceptCrypto and got rugged by the drain.

Note: The LP tokens will be locked before trading is enabled, if the project does good we will be extending the lock to 100 years.

Fees: 0% on buy & 8% on sell, Some of the funds will be used for marketing.
*/
...
contract ReceiveCrypto is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ReceiveCrypto";//
    string private constant _symbol = "RECEIVE";//
    ...
    address payable private _developmentAddress = payable(0x79B972c8bc07EEFc3602Fa911E8C4cd7F4BB065B);//
    address payable private _marketingAddress = payable(0x19Cccb9C8481479405378Fb30f657288668945d2);//
