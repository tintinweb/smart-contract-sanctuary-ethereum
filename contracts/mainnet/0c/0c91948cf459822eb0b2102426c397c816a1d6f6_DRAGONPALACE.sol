...
contract DRAGONPALACE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function OpenGate() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function ReleaseBeast() external onlyOwner returns (bool){
