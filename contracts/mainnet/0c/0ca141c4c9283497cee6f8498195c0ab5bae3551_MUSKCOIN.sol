...
contract MUSKCOIN is Context,IERC20, Ownable{
 ...
 address _owner;
 address payable public marketingAddress = payable(0x42C64fB0f3e658F94C2024ED83a862399b2c5BBD);
 ...
 //Tokenomics related functions
  function MUSKCOINDay() public onlyOwner{
      require(block.timestamp > MUSKCOINDaycooldown, "You cant call MUSKCOINCoinDay more than once a day");
 ...
 function MUSKCOINCoinDayOver() public onlyOwner{
