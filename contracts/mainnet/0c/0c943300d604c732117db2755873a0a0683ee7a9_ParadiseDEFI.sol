...
contract ParadiseDEFI is ERC20, Ownable {
    ...
    constructor() ERC20("Paradise DEFI", "PDF") {
        ...
        marketingWallet = address(0x44a735Cd083B6fc8084dAB37BeB4562D7AFb5063); // set as marketing wallet
        buybackWallet = address(0x91053421819155CCAd52eC83539ABF9432B4db11); // set as dev wallet
