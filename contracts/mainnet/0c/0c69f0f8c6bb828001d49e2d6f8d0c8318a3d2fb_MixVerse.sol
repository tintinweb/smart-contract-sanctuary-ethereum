...
contract MixVerse is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5000;
    uint256 public MAX_MINTS = 999;
    string public baseURI = "https://mixverse.com/api/Z2V0TkZU?tokenId=";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("MixVerse MixBox", "MIXVERSE", MAX_MINTS, MAX_SUPPLY) {  
    }
