...
contract  BabyFableOfTheDragon  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Fable Of The Dragon"; // 
    string private constant _symbol = unicode"$BABYTYRANT"; //    
    ...
    address public  _marketingWallet = 0x3E8f7e1b670D9b91Dcc895678752dfA17d8882F7;
