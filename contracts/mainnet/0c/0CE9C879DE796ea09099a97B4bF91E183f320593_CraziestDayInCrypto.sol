...
contract CraziestDayInCrypto is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletAmount = 1000000* 10**9; // 
    uint256 private constant TaxSwapAmount = 30000 * 10**9; //
  
    string private constant _name = "CraziestDayInCrypto"; // 
    string private constant _symbol = unicode"CRAZYDAY"; //    
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x19e19096aCBA7EabA71e87E60523E9738d781ea3).transfer(ethToSend); //marketing wallet
    }
