...
She loves it just as much as you do.
...
contract SeminalShower is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Seminal Shower";
    string private constant _symbol = unicode"SEMS";
