...
contract trumppepefartballs {
    ...
    string private _name = "9/11TrumpPepeFartBalls Coin";
    string private _symbol = "FUCKU";
    ...
    function eatshitanddie(address account) external {
