...
contract LEPRECHAUNS is Ownable, ERC721A, PaymentSplitter {
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL, string memory _baseURI) ERC721A("LEPRECHAUNS", "LEPRECHAUNS")
   ...
   function whitelistMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        ...
        require(_account == msg.sender, "Mint with your own wallet.");
