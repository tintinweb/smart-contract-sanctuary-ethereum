...
library PositionLogic {
    ...
    event RepaidShort(address indexed user, address indexed asset, uint256 amount, address behalfOf);
    event WithdrawnLong(address indexed user, address indexed asset, uint256 amount);
