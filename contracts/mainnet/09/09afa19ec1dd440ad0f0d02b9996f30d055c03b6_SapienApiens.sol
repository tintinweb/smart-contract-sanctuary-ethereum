...
contract SapienApiens is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "ipfs://QmaD8MGr8obMSeAUMZymxev1CHi8nxmWq7eXuWsAdPojNN/";
    string public baseExtension = "";
     bool public paused = true;   
    
    constructor() ERC721A("Sapien Apiens", "SAPE", MAX_MINTS, MAX_SUPPLY) {  
