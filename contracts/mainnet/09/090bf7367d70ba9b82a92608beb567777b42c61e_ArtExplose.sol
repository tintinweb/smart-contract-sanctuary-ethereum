...
//  █   ▀                         ▀       ▀                                                                               ▀     
// ▀       
//Art Explose by Oblex - First artwork "A mad painter" explose in 1600 pieces in the Blockchain Ethereum
//A mad painter after having concluded his work in the throes 
//of a crisis decided to destroy his painting in 1600 parts. 
//Who will now fill his work by him?
...
interface IOperatorFilterRegistry {
   ...
   contract ArtExplose is DefaultOperatorFilterer, ERC721A,Ownable, ReentrancyGuard {
    using Strings for uint256;
    string private uriPrefix ="ipfs://QmUj1Y2D1sqUhnkq4DxaVusHerU4CDGW7iyUrA2hv1S9UE/";
    string private uriSuffix = ".json";
    string public hiddenURL;
    uint256 public cost = 0.0025 ether;
    uint256 public whiteListCost = 0.00001 ether;
    uint16 public maxSupply = 1601;
    uint8 public maxMintAmountPerTx = 20;
    uint8 public maxFreeMintAmountPerWallet = 4;
