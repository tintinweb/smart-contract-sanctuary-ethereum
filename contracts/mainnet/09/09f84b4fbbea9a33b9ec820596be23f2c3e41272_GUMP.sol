...
contract GUMP is ERC20, Ownable {
    ...
    constructor() payable ERC20("Forest Gump", "GUMP") {
       ...
       buyOperationsFee = 4;
        ...
        operationsAddress1 = address(0x496BdBb2f01b5bb14b47B672E4Ed44D2C00f4c2f); //80%
        operationsAddress2 = address(0x496BdBb2f01b5bb14b47B672E4Ed44D2C00f4c2f); //20%
        lpReceiverAddress = address(0x496BdBb2f01b5bb14b47B672E4Ed44D2C00f4c2f);
