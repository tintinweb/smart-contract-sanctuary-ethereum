...
Telegram: https://t.me/WagyuInuERC20

Feed the DOG VILLAGE! Feed the Stray DOGS. The first charity tokens for DOGS!

Token Name: Wagyu for all inus
Symbol: Wagyu Inu     
Supply: 100,000,000
                           
Initial max buy:  2,000,000 (2% supply)
...
contract WagyuInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Wagyu for all inus";
    string private constant _symbol = "Wagyu Inu";
    ...
    uint256 private maxWalletAmount = 2000001 * 10**9;  
    uint256 private maxTxAmount = 2000001 * 10**9;      
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0xC9330F8DaA661C5e1d09213DFF3fbf5DaF010af6); 
        ...
        uint256 _sellMarketingFee = 1900;
        ...
        swapEnabled = true;
        tradingOpen = true;
        maxTxAmount = 2000001 * 10**9;
        maxWalletAmount = 2000001 * 10**9;
