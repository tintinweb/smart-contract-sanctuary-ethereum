...
contract FatMan is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fat Man";
    string private constant _symbol = "NAGASAKI";
    ...
    constructor () {
        _feeAddrWallet = payable(0x66c083E12A23665C31b402Bc19C682526fa2E7DC);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                require(block.number >= (launchedAt + 0), "Anti sniper mechanism");
    ...
    function changeMaxTxAmount(uint256 percentage) external onlyOwner{
        ...
        _maxTxAmount = _tTotal.mul(percentage).div(10);
    }

    function changeMaxWalletSize(uint256 percentage) external onlyOwner{
        require(percentage>0);
        _maxWalletSize = _tTotal.mul(percentage).div(10);
    }
