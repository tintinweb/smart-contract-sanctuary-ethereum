...
/**
    Website: https://www.vitalik-sellerin.com
    
    Might go up, might go down,
    Atleast this token showed up in town,
    Is it good or is it bad,
    It was funny, you can't really be mad
    Please make us a lil buck,
    So on the next shit I don't have to chuck,
    LP Tokens are locked, please moon,
    People keep typing in telegram "lambo soon"
*/
...
contract vSELL is IERC20, Auth {
    ...
    string constant _name = "Vitalik Sellerin";
    string constant _symbol = "vSELL";
    ...
    // 1000 / 1000 = 1 = 100%
    uint256 public _maxTxAmount = _totalSupply * 1000 / taxDivisor; 
    uint256 public _maxWalletToken =  _totalSupply * 1000 / taxDivisor; 
    ...
    constructor () Auth(msg.sender) {
        ...
        // Set fee receivers
        liquidityWallet = 0xbc51058EAe22b598C60E8E4e21c4830Ae26656da;
        marketingWallet = 0xbc51058EAe22b598C60E8E4e21c4830Ae26656da;
        developmentWallet = 0xbc51058EAe22b598C60E8E4e21c4830Ae26656da;
    ...
    // Set the buy fees, this can not exceed 12%, 120 / 1000 = 0.12 = 12%
    ...
    // Set the sell fees, this can not exceed 12%, 120 / 1000 = 0.12 = 12%
    ...
    function startTrading() external onlyOwner {
        ...
        tradeBlock = false;
        sniperTaxTill = block.number + 0; // (<sniperTaxTill, so first block)
        lockUsed = true;
    }
