...
contract ZukiGen is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 8888;
    uint256 public MAX_MINTS = 100;
    string public baseURI = "ipfs://QmaXS7PeeZrgT2gMqmFk6DjLbgunWGhGmkdLesnxaHsgPY/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Zuki-Gen Official", "ZGEN", MAX_MINTS, MAX_SUPPLY) {  
    }
