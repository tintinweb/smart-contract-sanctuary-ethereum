...
contract Satoshiwanami is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private _name = "Satoshiwanami";
    string private _symbol = "SATOWANAMI";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5717B24C023850234d09690B6d6215E850c4FDc2));
        _metawallet = payable(address(0x5717B24C023850234d09690B6d6215E850c4FDc2));
