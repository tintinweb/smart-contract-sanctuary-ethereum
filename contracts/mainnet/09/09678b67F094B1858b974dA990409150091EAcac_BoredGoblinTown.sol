...
contract BoredGoblinTown is ERC721A, Ownable {
	using Strings for uint256;
    ...
    address address1 = 0x5e4f786f919955a66607Df686CC740748f47AD87;
    address address2 = 0x59D3F38B7Fdb48cf4d105D4283C845f2BF34B40a;

    mapping(address => bool) public mintlist;

	constructor() ERC721A("BoredGoblinTown", "UGH") {}
    ...
    function claim(address _wallet) external {
        require(status, "Sale inactive" );
        require(msg.sender == tx.origin, "No contracts!");
