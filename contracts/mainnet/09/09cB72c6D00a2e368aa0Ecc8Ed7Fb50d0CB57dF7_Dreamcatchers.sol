...
contract Dreamcatchers is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qma63QF1yr43FkYe7XQWvPJZyzzQr6UaPXEtNiihzDjaeV";
    ...
    constructor(
    ) ERC721A("Maya Patel's Dream Catchers", "DREAMCATCHERS", 100, maxSupply) {
    }
