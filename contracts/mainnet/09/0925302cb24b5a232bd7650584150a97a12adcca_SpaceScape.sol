...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0xC49ee1C39eBAe3213fDE090BC8356f74F4B5CC6d);
...
contract SpaceScape is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("SpaceScape", "SS") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmW2dVRy3hnoVDarJvzwEF6Eh2E85Qtwg5ReqiWiaL8PrF/", _toString(tokenId), ".json"));
    }
