...
contract Orca is Ownable, ERC721, ERC721Enumerable {
    ...
    function _actualMintPrice() public view returns (uint) {
        ...
        if (currentSupply >= 201) {
            ...
            return 110000000000000000; // 1 - 125 0.11 ETH
        }
    }
    ...
    function _updateReflections() internal {
        ...
        if (currentSupply >= 201) {
            ...
            _reflection = (110000000000000000 * _mintSharesReflect) / (10 ** _decimalBase); // 1 - 125 0.11 ETH
        }
    }
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0xaFd164d218a00C04A3d3b6b5ce2F22Db7F1d26A8).transfer((p*3334)/10000);
        payable(0xEA54305d63Dbd32339637CB5B8A23905e59BE16e).transfer((p*3333)/10000);
        payable(0xD991edBF5e93993312520F4570958d6f93c3aaEe).transfer((p*3333)/10000);
        _balanceTeam = 0;
    }
