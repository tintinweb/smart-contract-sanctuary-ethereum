...
contract BowlToken is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BOWL SHIBARIUM";
    string constant _symbol = "BOWL";
    ...
    address payable public liquidityFeeReceiver = payable(0xf760f83b69188397F9115EFB783b37621b934366);
    address payable public marketingFeeReceiver = payable(0xf760f83b69188397F9115EFB783b37621b934366);
