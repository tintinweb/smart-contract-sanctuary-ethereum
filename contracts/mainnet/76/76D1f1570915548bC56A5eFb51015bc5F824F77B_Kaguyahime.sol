...
contract Kaguyahime is ERC20, Ownable {
    ...
    constructor() ERC20("Kaguyahime", "KAGUYAHIME") {
        ...
        devWallet = address(0x79a938019445F245e2DaC5683E0C0fffd6D9C51d); // set as dev wallet
