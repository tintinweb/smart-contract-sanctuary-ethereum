 ...
 * allowances. See {IERC20-approve}.
 */
contract LuncXen is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "LuncXen";
    string private _symbol = "LuXen";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000000;
    uint256 public taxForLiquidity = 3;
    uint256 public taxForMarketing = 0;
    uint256 public maxTxAmount = 100000000000 * 10**_decimals;
    uint256 public maxWalletAmount = 10000000000000 * 10**_decimals;
    address public marketingWallet = 0x54d86988Ef30A8fAE704f44C5f1A17DD99d19cAC;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToETH = 100000000 * 10**_decimals;
