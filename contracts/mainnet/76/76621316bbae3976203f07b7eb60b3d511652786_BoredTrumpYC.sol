...
// File: contracts/BoredTrumpYC.sol
...
contract BoredTrumpYC is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2100;
  ...
  ) ERC721A("Bored Trump YC", "BOREDTRUMPYC") {
