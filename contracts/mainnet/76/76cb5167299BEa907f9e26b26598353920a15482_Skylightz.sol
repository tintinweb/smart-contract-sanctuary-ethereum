...
contract Skylightz is ERC721A, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;

    string public baseURI;
    string public hiddenMetadataURI = "ipfs://QmfUphunq4LuY4hLGBQPfVSr4FWckajTJLxHkHBhddTtjr/unreveal.json";
    string public baseExtension = ".json";
    bool public publicSale;
    bool public preSale;
    bool public revealed;
    bool public activeBatch2;
    bytes32 public merkleRootBatch1 = 0xed41c67b980fccb4f8b33f304612b72b83a32455e6c37766d76001de97c89417;
    bytes32 public merkleRootBatch2 = 0x9d4d56a9b5e219a456f53377e4a061ae2e4ba494c993f8fa62712d174ebabedb;
    ...
    constructor() ERC721A("Skylightz", "Skylightz") {}

    modifier mintCompliance(uint256 quantity) {
        require(quantity > 0, "Quantity must be higher than zero!");
        require(totalSupply() + quantity <= maxSupply, "Max supply reached");
        require(quantity <= maxPerTx, "Limit per tx exceed!");
        require(addressMintedBalance[msg.sender] + quantity <= maxPerWallet, "Can't mint more than the limit");
        _;
    }
        ...
        payable
    {
        ...
        if (supply < 10 && activeBatch2 == false) {
            bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
            require(
                MerkleProof.verify(_proof, merkleRootBatch1, leaf),
                "Invalid proof!"
            );
            ...
            bytes32 leaf = keccak256(abi.encodePacked(msg.sender));
            require(
                MerkleProof.verify(_proof, merkleRootBatch2, leaf),
                "Invalid proof!"
            );
            require(msg.value >= cost * quantity, "Not enough ether!");
    ...
    function setActiveBatch2(bool _state) public onlyOwner {
        activeBatch2 = _state;
    }
    ...
    function setMerkleRootBatch1(bytes32 _merkleRoot) public onlyOwner {
        merkleRootBatch1 = _merkleRoot;
    }

    function setMerkleRootBatch2(bytes32 _merkleRoot) public onlyOwner {
        merkleRootBatch2 = _merkleRoot;
    }
