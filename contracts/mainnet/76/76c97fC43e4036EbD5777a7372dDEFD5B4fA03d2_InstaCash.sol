...
contract InstaCash is ERC20, Ownable {
    string constant _name = "Insta Cash";
    string constant _symbol = "ICASH";
    uint256 _totalSupply = 875000000 * (10**decimals());
    ...
    function setLimit1(uint256 amountPercent) external onlyOwner {
