...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x113Ca7F93ED87E21c5064775e9B506c462aEe67b];
  address public erc20Payable = 0x113Ca7F93ED87E21c5064775e9B506c462aEe67b;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 2222) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaqzzx2v5cabkfj2x277jr34wk6a2j5xl5wems4nnn6qotinoiqpm/";
    string public _baseTokenExtension = ".json";

    bool public mintingOpen = false;
    
    
    uint256 public MAX_WALLET_MINTS = 21;
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PwaTL0lk8PcVeJQ1vgqh/contract-metadata";
  }
...
// File: contracts/CrypticCatsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CrypticCatsContract is ERC721APlus {
    constructor() ERC721APlus("CrypticCats", "CCs"){}
}
  /*******************************************************/
  /*                                                     */
