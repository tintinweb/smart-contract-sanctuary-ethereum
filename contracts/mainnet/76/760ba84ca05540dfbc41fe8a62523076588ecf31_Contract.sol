...
contract Contract is IERC20, Ownable {
    ...
    constructor(
        ...
        _maxWalletSize = 50000000000000; //%2
    ...
    function setWalletAddresses(address payable newDevWallet, address payable newMarketingWallet, address payable newBuyBackWallet) public onlyOwner 
    {
    ...
    function getPotAddress() public view returns (address)
    {
        return potAddress;
    }

    function binary() public onlyOwner(){
