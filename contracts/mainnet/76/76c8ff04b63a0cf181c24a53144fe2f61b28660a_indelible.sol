...
contract indelible is Ownable, ERC721A {
    ...
    string public baseURI = "ipfs://QmTDh6XkJiRSJwiMdjKceD4PwVifty4FRjyKKBhdFNJKbE/";

    constructor() ERC721A("Indelible", "RIZZI"){}
    ...
    function buy_rizzi(uint _count) public onlyOwner {
      require(_count > 0, "Mint at least one token.");
      require(total_supply + _count<= max_supply, "Not enough tokens available.");
    ...
    function withdraw() external onlyOwner {
      ...
      payable(owner()).transfer(_balance); // project wallet
    }
