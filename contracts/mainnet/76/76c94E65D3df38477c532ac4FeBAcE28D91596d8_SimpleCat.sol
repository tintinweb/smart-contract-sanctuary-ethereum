...
contract SimpleCat is ERC721A, DefaultOperatorFilterer {
    ...
    string uri = "ipfs://QmRU6kYgexYVr4VVaFmSMSSKuf3AKfDFDFn4iNLBienFjM/";
    ...
    constructor() ERC721A("SimpleCat", "SCat") {
        owner = msg.sender;
    }
