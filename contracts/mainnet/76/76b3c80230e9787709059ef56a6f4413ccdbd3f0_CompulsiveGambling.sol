...
contract CompulsiveGambling is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20("Compulsive Gambler", unicode"KAKEGURUIかけ") {
        ...
        maxTransactionAmount = 4_444_444_444 * 1e18;
        maxWallet = 13_333_333_333 * 1e18;
    ...
    function DealCards() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
