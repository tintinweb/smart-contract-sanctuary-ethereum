...
contract RAYC is ERC721A, Ownable, ReentrancyGuard {
    ...
    // QmX9kAxP1Nh7genaGhZ25pFwTRSSJ2u1LH2uHHtsaeFLtK

    constructor(string memory uri) ERC721A("Refurbished Ape Yacht Club", "RAYC") {
        baseURL = uri;
    }
    ...
    modifier mintComp(uint256 _mintAmount){
        ...
        require(balanceOf(msg.sender) < maxMintAmountPerWallet, "You have 10 NFTs.");
        _;
    }
