...
contract GlobalIdolCoinToken is StandardToken {
  using SafeMath for uint256;

  string public name = "Global Idol Coin Token";
  string public symbol = "GICT";
  uint256 public decimals = 8;
  uint256 public INITIAL_SUPPLY = 1000000000;

  event Burn(address indexed from, uint256 value);

  function GlobalIdolCoinToken() {
...
contract GICTLock is HasNoEther {
    using SafeMath for uint256;

    GlobalIdolCoinToken public GICT;
    ...
    function GICTLock (
        ...
        GICT = GlobalIdolCoinToken(_GICTAddr);

        startTime = _startTime;
        endTime1 = _startTime + _duration * 365 days;
        endTime2 = _startTime + 2 * _duration * 365 days;
    ...
    function GICTBalance() external constant returns(uint256) {
        return GICT.balanceOf(this);
    }
