...
contract TAISHA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Izumo Taisha", "TAISHA") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x92f627f39b286Cb434E295a5244810FDE339662c); // marketing wallet
        devWallet = address(0x92f627f39b286Cb434E295a5244810FDE339662c); // dev wallet
    ...
    function _transfer(
        ...
        if (!isBuy && enableEarlySellTax) {
            if (_holderFirstBuyTimestamp[from] != 0 &&
                (_holderFirstBuyTimestamp[from] + (4 hours) >= block.timestamp))  {
