...
contract TheFourHorsemen is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 8000000 * 10**8;
    ...
    string private constant _name = "The Four Horsemen";
    string private constant _symbol = "4HM";
    ...
    uint256 private _maxTxAmount = 160000 * 10**8;
    uint256 private _maxWalletSize = 160000 * 10**8;
