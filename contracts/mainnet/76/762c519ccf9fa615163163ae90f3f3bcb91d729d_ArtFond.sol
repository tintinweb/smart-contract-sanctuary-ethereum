...
//  &&&&&%              .%./&&&&&&/     *&&&&&.        /&&&&& ,&&&&&&&&&&&&#*       
//
//  collection ART FOND (AF)
//  artfond.sk ERC-721 contract
...
contract ArtFond is ERC721URIStorage, ERC721Burnable, ERC721Royalty, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;
    string private _contractURI;
    uint256 public burned;

    constructor(string memory contractURI_, uint96 feeNumerator) ERC721("ART FOND", "AF") {
