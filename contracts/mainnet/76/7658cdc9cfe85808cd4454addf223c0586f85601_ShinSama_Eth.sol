...
contract ShinSama_Eth is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shinsama ERC-20";//
    string private constant _symbol = "SSE";//
    ...
    address payable private _developmentAddress = payable(0x017057f6C5EF189ca13cc983ADd6B5FeDe664aff);  // insert dev address here
    address payable private _marketingAddress = payable(0x5FC421A3cdb5a04Bf6805030ca27Db31DeDbB7af); // insert marketing address here
    ...
    uint256 public _maxSellTxAmount = 50000000000000 * 10**9; //
    uint256 public _maxBuyTxAmount = 40000000 * 10**9; //
