...
/**
    ...
    10% liquidity Fee on buying and selling Anon
    (The 10% LP fee ensures evergrowing floor and allows whales to enter much easier)

    There is no dev or marketing fee.

    ANON relies on the buyers to create the hype.
