...
// File interfaces/tokenomics/ILpGauge.sol
...
// File interfaces/IRewardHandler.sol

pragma solidity 0.8.10;

interface IRewardHandler {
    event Burned(address indexed rewardToken, uint256 totalAmount);
...
contract Controller is IController, Authorization {
    ...
    uint256 public keeperRequireStakedMero;
...
contract StakerVault is IStakerVault, Authorization, Pausable, Initializable {
     ...
     */
    function increaseActionLockedBalance(address account, uint256 amount) external override {
     ...
     */
    function decreaseActionLockedBalance(address account, uint256 amount) external override {
        require(addressProvider.isAction(msg.sender), Error.UNAUTHORIZED_ACCESS);
