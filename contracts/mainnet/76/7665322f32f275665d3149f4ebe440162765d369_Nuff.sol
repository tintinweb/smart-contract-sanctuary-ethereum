...
contract Nuff is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SBF NUFF";
    string private constant _symbol = "Nuff";
    ...
    address payable private _developmentAddress = payable(0x810ECa5F01CF7Abce46942ef2ca6E069d4F60501); 
    address payable private _marketingAddress = payable(0x810ECa5F01CF7Abce46942ef2ca6E069d4F60501);
