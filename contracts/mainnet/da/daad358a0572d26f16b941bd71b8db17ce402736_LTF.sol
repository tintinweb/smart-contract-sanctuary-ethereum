...
contract LTF is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmeT9p3Z9SMSrH54oLttw2MgQnaCXW1tMuNdGQxhdwyVgM/";
    ...
    constructor() ERC721A("Let them fight", "LTF"){}
    ...
    function mint(uint256 count) external payable {
        ...
        require(!paused, "The contract is paused!");
        require(msg.value >= count * cost, "Send the exact amount: 0.001*(count)");
        require(totalSupply() + count <= maxSupply, "No more.");
        require(count <= maxPerTx, "Max per TX reached.");
        }
