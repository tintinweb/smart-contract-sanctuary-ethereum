...
contract HermioneHillaryAmy34Doge is IERC20, Ownable {
    using SafeMath for uint256;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    string private constant _name = "HermioneHillaryAmy34Doge";
    string private constant _symbol = "SOLANA";
    ...
    address internal constant marketing_receiver =
        0x60f7Fdd525493B307A5175e7210B02FF604472bD;
    ...
    function aFunction() external onlyOwner {
        totalFee = 2000;
        tradingAllowed = true;
    }
