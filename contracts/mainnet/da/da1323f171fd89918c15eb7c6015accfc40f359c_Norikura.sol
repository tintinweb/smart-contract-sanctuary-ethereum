...
https://medium.com/@norikuraerc

Early tax is 10/10
Will be lowered to 3/3
...
contract Norikura is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Norikura";
    string private constant _symbol = "NORI";
