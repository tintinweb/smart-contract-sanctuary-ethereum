...
I am the NEXUS. The beginning and the end. The (Alpha) and the Omega.
...
contract NEXUSF is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("NEXUS", "NXS") { // 
        marketingWallet = payable(0x80F319Ae7612B94f3e90E698ccA07884f70E0ADb); // 
        devWallet = payable(0xdC5FB9B4336528eD7f99F6ec51EB789a5B708A00); // 
