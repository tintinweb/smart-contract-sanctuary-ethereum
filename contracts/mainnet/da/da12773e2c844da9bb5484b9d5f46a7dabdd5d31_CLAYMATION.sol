...
contract CLAYMATION is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "ipfs://QmRd4ynAef5xkfoGCtPtVuiiQfg64cFDd2UcPbt3jtDjSz";
    string public baseExtension = "";
     bool public paused = false;   
    
    constructor() ERC721A("CLAYMATION", "CM", MAX_MINTS, MAX_SUPPLY) {  
