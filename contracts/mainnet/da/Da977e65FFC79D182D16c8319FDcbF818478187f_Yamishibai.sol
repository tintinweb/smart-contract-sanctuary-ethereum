...
contract Yamishibai is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yamishi Bai";
    string private constant _symbol = unicode"Yūrei";
    uint256 public _maxTxAmount = 20_000 * 10**_decimals;
    uint256 public _maxWalletSize = 20_000 * 10**_decimals;
    uint256 public minSwapThreshold= 20_000 * 10**_decimals;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (tradingOpen&&from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isExcludedFromFee[to] ) {
                ...
                taxAmount = amount.mul(6).div(100);
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance>minSwapThreshold && _reduceTaxCountdown<=_preventSwapBefore) {
