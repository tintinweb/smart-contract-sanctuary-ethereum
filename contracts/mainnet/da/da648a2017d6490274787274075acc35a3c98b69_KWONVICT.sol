...
contract KWONVICT is Context, IERC20, Ownable {
 
    using SafeMath for uint256;


    //token info:
    string private constant _name = unicode"KWONVICT";
    string private constant _symbol = "KWONVICT";
    ...
    address payable private _developmentAddress = payable(0x0773Dada30fFC1e2d1144Dd65e6ce7BCCb74beec); 
    address payable private _marketingAddress = payable(0x0773Dada30fFC1e2d1144Dd65e6ce7BCCb74beec);
