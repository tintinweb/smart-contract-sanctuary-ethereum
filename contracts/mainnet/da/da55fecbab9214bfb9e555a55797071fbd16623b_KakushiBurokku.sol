...
/*
        Kakushi Burokku
        $KIN
        Telegram will be send as a encrypted message as soon as the liquidity has been burned.


                Four things cannot be long hidden: the sun, the moon, the truth and Kakushi Burokku.        
*/
...
contract KakushiBurokku is Context, IERC20, Ownable {
    ...
    string private _name = "Kakushi Burokku";
