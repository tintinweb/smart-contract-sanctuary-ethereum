...
contract Balerion is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Balerion - The Black Dread";
    string private constant _symbol = unicode"BALIERON";
