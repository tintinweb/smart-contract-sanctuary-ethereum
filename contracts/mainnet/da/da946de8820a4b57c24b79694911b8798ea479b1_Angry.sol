...
/**
  ...
  We are the angry ape and we are bringing a zero tax token that will make us strong again

Angry ape is our answer to the current market conditions.

We cannot survive the bear market if we do not have strong communities and zero tax tokens.

The old meta of high round trip tax token is over.

Meme market won't recover if we are paying 10% just to buy a token.

We are a here to make a contribution for all.

Let's make that real.

We are the Angry Ape !

Website: http://www.angryapetoken.com
Telegram: https://t.me/angryapeETH
Twitter: https://www.twitter.com/angryapetoken
...
contract Angry is ERC20, Ownable {
    ...
    constructor() ERC20("Angry Ape", "AngryApe") {
