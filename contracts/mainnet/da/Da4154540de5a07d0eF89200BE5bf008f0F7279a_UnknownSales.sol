...
// File: contracts/UnknownSociety.sol
...
// File: contracts/UnknownSales.sol
...
contract UnknownSales is Ownable, ReentrancyGuard {
    ...
    address private signer;
    uint256 private salePrice = 0.035 ether;
    ...
    function sendAirdrop(UnknownSociety.Airdrop[] memory _aidrops)
    external
    onlyOwner
    {
        unk.sendAirdrop(_aidrops);
    }
