...
/*Blue Azuki VS Red Azuki
 *The rules of the competition are whichever SOLD OUT comes first, and the winner will get the Reaveal of the Spine animated GIF version.
*/
...
contract MorikuNFT  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmUJFmMfhsZAnrvAQZq3yqVh46xai9xuj5VDdySTNLj37z/";

    uint256 public immutable cost = 0.003 ether;
    uint256 public immutable costMin = 0.002 ether;
    uint32 public immutable maxSUPPLY = 1499;
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        ...
        require(msg.value >= costMin, "insufficient");
        if (msg.value >= cost * amount) {
            _safeMint(msg.sender, amount);
        }
    }

    function StakeDrop(uint256 amount) public onlyOwner {
