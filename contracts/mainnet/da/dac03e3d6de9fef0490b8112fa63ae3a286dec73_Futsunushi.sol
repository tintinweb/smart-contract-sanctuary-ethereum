...
contract Futsunushi is ERC20, Ownable {
    ...
    constructor() payable ERC20("Futsunushi", "FUTSU") {
        ...
        uint256 totalSupply = 666777888 * 1e18;
        ...
        operationsAddress = address(0x5B07EBFe03d846062e96dA2E029A129d821e491b);
        treasuryAddress = address(0x5B07EBFe03d846062e96dA2E029A129d821e491b);
        ...
        _createInitialSupply(address(0xdead), (totalSupply * 22) / 100);
        _createInitialSupply(address(this), (totalSupply * 78) / 100);
