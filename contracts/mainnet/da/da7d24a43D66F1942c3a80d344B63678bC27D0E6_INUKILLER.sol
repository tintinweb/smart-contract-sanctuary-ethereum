...
contract INUKILLER is Context, IERC20, Ownable { 
    ...
    string private constant _name = "INU KILLER";
    string private constant _symbol = "INU KILLER";
