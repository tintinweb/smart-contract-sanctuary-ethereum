...
contract XYZprotocol is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("XYZ Protocol", "$XYZ") {
        ...
        marketingWallet = address(0x12707014d8e467531F044050f672Ab9692bCb7Ed); // set as marketing wallet
        devWallet = address(0x12707014d8e467531F044050f672Ab9692bCb7Ed); // set as dev wallet
