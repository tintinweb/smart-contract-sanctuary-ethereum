...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3d404bfaf8FF3f77df2e0026172D3dA86C22D826];
  address public erc20Payable = 0x3d404bfaf8FF3f77df2e0026172D3dA86C22D826;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 505;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 5005) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeicu3xqerbso3yuq2t6jbbjjjnfa6q4vpucjrm2iagbmwg57nwsczi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/EfU9iaX4hgF5OjhjjsgV/contract-metadata";
  }
...
// File: contracts/BrokiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BrokiesContract is RamppERC721A {
    constructor() RamppERC721A("Brokies", "Brokie"){}
}
