...
// by @BoredHound (Twitter)


// SPDX-License-Identifier: MIT
// File: contracts/HoundsYachtClub.sol
...
contract HoundYachtClub is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeibhfqegratpypzkpzd5jdrg5ks4zlnrttgzeqnccobkrwe4ciq2em/";
    uint   public price             = 0.003 ether;
    uint   public maxPerTx          = 20;
    uint   public maxPerFree        = 2;
    uint   public maxPerWallet      = 42;
    ...
    constructor() ERC721A("Hound Yacht Club", "HoundYC"){}
