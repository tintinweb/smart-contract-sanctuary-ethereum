...
contract Dragon is ERC20, Ownable {
    ...
    constructor() ERC20("Floki Dragon", "FDR") {
        ...
        marketingWallet = address(0xeEd49700be09B1e65270f36eD25db2fcCC4255Bd); // set as marketing wallet
        devWallet = address(0xeEd49700be09B1e65270f36eD25db2fcCC4255Bd); // set as dev wallet
