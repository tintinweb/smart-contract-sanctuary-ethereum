...
contract MessyCats is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 3333;
    uint256 public price  = 0 ;
    uint256 private maxTransactionAmount =3;
    string baseURI = "ipfs://QmY1J4KdE7dLNmomqrz5FLRv8dHiELP1uSpZsjxnWK9NBx/";
    bool paused;



    constructor () ERC721A("Messy Cats","MCS"){
