...
contract ShibaAI is ERC20, Ownable {
    ...
    constructor() ERC20("ShibaAI", "ShibAI") {
		...
		charityWallet = address(0x388292696DE029bddCA97aF7795dC4ee90f4A2a7); 
        marketingWallet = address(0x388292696DE029bddCA97aF7795dC4ee90f4A2a7); // set as marketing wallet
        devWallet = address(0x388292696DE029bddCA97aF7795dC4ee90f4A2a7); // set as dev wallet
