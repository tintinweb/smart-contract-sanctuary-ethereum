...
contract Armageddon is ERC20, Ownable {
    ...
    constructor() ERC20("Armageddon", "DoomsDay") {

        uint256 totalSupply = 13 * 1e9 * 1e18;
        
        maxTransactionAmount = totalSupply * 30 / 1000; // 3% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 30 / 10000; // 0.3% swap tokens amount
        maxWallet = totalSupply * 3 / 1000; // 3% Max wallet
    	...
    	operationsWallet = address(0xa00aE19cac713d3d025b46bD6c579f8Fb29674c3); // set as operations wallet
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 750, "Must keep fees at 25% or less");
    }
