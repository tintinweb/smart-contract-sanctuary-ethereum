...
/**
 *Submitted for verification at Etherscan.io on 2022-10-6
 ...
 * allowances. See {IERC20-approve}.
 */
contract BNBurn is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "BNBurn";
    ...
    address public marketingWallet = 0x19b78925d42C9b633B37E010aeee873D15Ff1c7f;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 2000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 4000 * 10**_decimals;
