...
contract WhyWas6Afraidof7 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 789;
  uint256 public maxMintAmountPerTx = 2;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Why Was 6 Afraid of 7", "789") {
    setHiddenMetadataUri("ipfs://QmPA4h9TqLrCMUpS1j5fSdRifZYUYFBrJYxbAAognfVdXi/hidden.json");
  }
