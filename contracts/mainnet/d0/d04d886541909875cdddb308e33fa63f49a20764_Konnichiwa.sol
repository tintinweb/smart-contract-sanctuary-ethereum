...
/**
Konnichiwa Inu - こんにちは犬 - $KWI 

For all the Japanese dogs who are in the shadow of Shiba Inu: Konnichiwa (hello)!

2% tax

Telegram is made on time!
...
contract Konnichiwa is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Konnichiwa Inu"; // Konnichiwa Inu - こんにちは犬 - $KWI 
    string private constant tokenSymbol = "KWI";
    uint8 private constant tokenDecimal = 9;
    uint256 private constant tokenSupply = 1000000000 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        maxWallet = tokenSupply.mul(2).div(50);
        minTaxSwap = tokenSupply.mul(5).div(10000);

        marketingAddress = payable(0xB67b9d2A44F308247B4cF91124E481ecEE149225);
        devAddress = payable(0xB67b9d2A44F308247B4cF91124E481ecEE149225);
    ...
    function setMaxWalletAmount(uint256 percent, uint256 divider) external onlyOwner {
        ...
        require(maxWallet <=tokenSupply.mul(5).div(100), "ERC20: Can not set max wallet more than 5%");
    }
