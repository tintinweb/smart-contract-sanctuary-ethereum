...
contract Doge is ERC20, Ownable {
    ...
    constructor() ERC20("Tale Of Doge", "THE DOGEN ONE") {
        ...
        marketingWallet = address(0x5683Df53586CE44aA60947048F95C7F4b633e92F); // set as marketing wallet
        devWallet = address(0x5683Df53586CE44aA60947048F95C7F4b633e92F); // set as dev wallet
