...
In celebration of the Godfather of crypto, we wanted to follow in the footsteps of Elon Goat Token and pay a tribute to Vitalik. We will be using taxes to build a massive statue of Vitalik and deliver it to the true goat of crypto.

Taxes: 5/5

Twitter: https://twitter.com/vitalikgoat

Telegram: https://t.me/vitalikgoattokenportal
...
contract VitalikGoatToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Vitalik Goat";
    string private constant _symbol = unicode"VGT";
