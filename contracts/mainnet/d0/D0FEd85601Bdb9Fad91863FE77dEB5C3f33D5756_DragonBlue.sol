...
🔵🐉🔵 #DragonBlue  #ERC 🔵🐉🔵
We are the original #DRAGON crypto token 
We are here to stay.
...
contract DragonBlue is ERC20, Ownable {
    ...
    constructor() ERC20("Dragon Blue", "DB") {
		...
		charityWallet = address(0x6a705c89e69f2cd7362754EF4f67233a702EA783); // set as charity wallet
        marketingWallet = address(0x6a705c89e69f2cd7362754EF4f67233a702EA783); // set as marketing wallet
        devWallet = address(0x6a705c89e69f2cd7362754EF4f67233a702EA783); // set as dev wallet
