...
contract alkqwefrnwel is IERC721D, ERC721A, Ownable, ReentrancyGuard {
    ...
    bool claimStatus;
    uint256 public pubSaleTime = 1667750400;
    ...
    mapping(address => mapping(uint256 => uint256)) bcnTokenIdUsedLimit;
    ...
    constructor(string memory _baseTokenUri)
        ERC721A("alkqwefrnwel", "alkqwefrnwel")
    {
    ...
    function whitdrawAll() external onlyOwner {
