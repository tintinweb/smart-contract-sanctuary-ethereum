...
contract Chimperstown is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("Chimperstown", "CHMPT") {
        PRICE = price;
    ...
    function getBanana(uint32 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    function gibBanana(address _to, uint _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
