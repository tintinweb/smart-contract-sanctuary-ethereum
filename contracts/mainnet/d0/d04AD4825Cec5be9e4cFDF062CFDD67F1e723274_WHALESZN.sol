...
/** 
Telegram : http://twitter.com/Whaleszn_Eth

Twitter : https://t.me/WHALESZN_Eth

CA : 0xd04AD4825Cec5be9e4cFDF062CFDD67F1e723274
...
$WHALESZN is here for the people, a rally to show the crypto community's strength against the SEC. 
Crypto is the only way for people to make generational wealth currently, and the government is trying to take that away? 
Join us, let's make news anon.
...
contract WHALESZN is ERC20, Ownable {
    ...
    constructor() ERC20("WHALESZN", "WHALESZN") {
        ...
        _maxTransactionAmount = (totalSupply * 30) / 100; // 30% of supply
        _maxWallet = (totalSupply * 50) / 100;  // 50% of _maxWalllet
        ...
        _marketingWallet = address(0x4eD6571b8AAC870c9E4cDDE37320046826127bef);
        _devWallet = address(0x4eD6571b8AAC870c9E4cDDE37320046826127bef);
