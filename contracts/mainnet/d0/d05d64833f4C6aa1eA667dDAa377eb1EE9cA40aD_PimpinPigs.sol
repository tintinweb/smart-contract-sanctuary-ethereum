...
contract PimpinPigs is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://www.cutepigclub.com/api/";
    ...
    constructor(
    ) ERC721A("Pimpin Pigs", "PIMPS", 100, maxSupply) {
    }
