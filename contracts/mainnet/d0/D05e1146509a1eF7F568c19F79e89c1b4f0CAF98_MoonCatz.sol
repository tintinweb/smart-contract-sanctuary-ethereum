...
import './ReentrancyGuard.sol';
  ...
  contract MoonCatz is ERC721B, Ownable, ReentrancyGuard{
    ...
    constructor() ERC721B("Mooncatz Universe Official", "MC") {}
    ...
    function VIPMint(uint256 reserveAmount)
    external
    onlyOwner
      {
    ...
    function PublicMint(uint256 quantity) external payable {
        ...
        msg.value >= tokenPrice.mul(quantity),
         "Public Mint is 0.01 eth per token"
        );
