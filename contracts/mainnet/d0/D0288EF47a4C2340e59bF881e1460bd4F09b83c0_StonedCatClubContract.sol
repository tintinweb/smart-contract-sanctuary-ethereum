...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQis6SQh4Z2CQV95D9WEFupZQPNzVEzDpFWcH2fRegJvL/";
...
// File: contracts/StonedCatClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract StonedCatClubContract is RamppERC721A {
    constructor() RamppERC721A("Stoned Cat Club", "SCC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/iWThPHUw51PgVAFfKoLq/contract-metadata";
    }
}
