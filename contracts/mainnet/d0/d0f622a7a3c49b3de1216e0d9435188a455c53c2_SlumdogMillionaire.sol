...
Jamal Malik takes on crypto, from the deep blood we will rise up to become millionaires

Low LP start - will be burned
...
contract SlumdogMillionaire is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Slumdog Millionaire";
    string private constant _symbol = unicode"SLUM";
