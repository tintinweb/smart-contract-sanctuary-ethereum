...
contract SolveToken is IERC20, Ownable {
    ...
    address payable public liquidityFeeReceiver = payable(0xB48306a7108C6e76f1B9B4d430ACA465f4659459);
    address payable public marketingFeeReceiver = payable(0xB48306a7108C6e76f1B9B4d430ACA465f4659459);
