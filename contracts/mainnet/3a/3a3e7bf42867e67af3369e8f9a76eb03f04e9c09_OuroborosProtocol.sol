...
Rich with cultural significance and religious meaning, the ouroboros  embodies rebirth, eternity, self-reliance, immortality, and nature’s cyclic character. 
Join us to learn more - https://t.me/CYCLIC_ERC20
**/
...
contract OuroborosProtocol is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Ouroboros Protocol";
    string private constant _symbol = "CYCLIC";
    ...
    address payable private _developmentAddress = payable(0x543429b82D8D6cC0D2CCe570d692Bb9CAdB21bDA);
    address payable private _marketingAddress = payable(0x543429b82D8D6cC0D2CCe570d692Bb9CAdB21bDA);
