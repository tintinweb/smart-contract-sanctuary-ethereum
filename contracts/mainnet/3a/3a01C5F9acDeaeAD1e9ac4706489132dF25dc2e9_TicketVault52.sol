...
contract TicketVault52 is Context, Ownable, Fees {
    ...
    constructor(address Token) {
        ...
        vault.stakingPeriod = 52 weeks; // 3 months staking period.
        withdrawFeePeriod = vault.stakingPeriod; // 3 months fee period.
        withdrawPenaltyPeriod = 8 weeks; // 2 weeks penalty period.
