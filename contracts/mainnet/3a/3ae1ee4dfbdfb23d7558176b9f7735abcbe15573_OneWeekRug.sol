...
Welcome to One Week Rug (OWR)! The rules of this token are simple. I will lock the liquidity for exactly 1 week.
You will be free to trade within those 7 days with no restrictions whatsoever. Once the week has ended, the
liquidity WILL be pulled. The lock link will be posted so everyone can keep track of the time. This coin
is meant for everyone to have fun and trade for 1 week's time. If this token gains significant traction,
I will continue to launch more with different lock periods to play around with such as 1 month, 2 weeks,
3 days, 1 day, etc.

Enjoy the ride while it lasts ;)

Buy and sell tax will both be fixed at 6% and the contract will be renounced as well.

Telegram: https://t.me/OneWeekRug
...
contract OneWeekRug is ERC20, Ownable {
    ...
    uint256 private buyTotalFees = 6;
    uint256 public sellTotalFees = 6;
    uint256 public earlySellTotalFee = 6;
    ...
    constructor(address router) ERC20("One Week Rug", "OWR") {
