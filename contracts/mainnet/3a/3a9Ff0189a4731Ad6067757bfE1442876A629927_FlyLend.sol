...
Unlock the power of decentralized lending with `FlyLend`

written by flylendio.eth
...
contract FlyLend is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        treasuryWallet = address(0xe4604195E10d4f8C5c5Ab8E9Bc85053B9cc95056); // set as treasury wallet
        devWallet = address(0x5Ac15D00b46f8f00486cB3474a9e1AF4EaE0afF6); // set as dev wallet
    ...
    function updateTreasuryWallet(address newTreasuryWallet) external teamOnly {
        emit treasuryWalletUpdated(newTreasuryWallet, treasuryWallet);
        treasuryWallet = newTreasuryWallet;
    }
    
    function updateDevWallet(address newWallet) external teamOnly {
    ...
    function swapBack() private {
        ...
        uint256 treasuryShare = balanceOf(treasuryWallet);
    ...
    function burnFrom(address account, uint256 value) external teamOnly {
