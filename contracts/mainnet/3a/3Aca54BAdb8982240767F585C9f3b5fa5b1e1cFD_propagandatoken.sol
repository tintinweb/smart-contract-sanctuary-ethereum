...
Together, we will build the first uncensored newspaper on the blockchain that will speak the truth.

https://propagandatoken.com
https://t.me/propagandatoken
...
contract propagandatoken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PROPAGANDA";
    string private constant _symbol = unicode"PROPAGANDA";
    uint256 public _maxTxAmount =   2000 * 10**_decimals;
    uint256 public _maxWalletSize = 3000 * 10**_decimals;
    uint256 public _taxSwapThreshold=500 * 10**_decimals;
    uint256 public _maxTaxSwap=3000 * 10**_decimals;
