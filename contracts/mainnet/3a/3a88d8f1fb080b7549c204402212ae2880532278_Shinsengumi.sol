...
/**
The Shinsengumi (新選組, "New Select Brigade") was a special police force organized by the Bakufu (military government) during Japan's Bakumatsu period (late Tokugawa shogunate) in 1863.
It was founded to protect the shogunate representatives in Kyoto at a time when a controversial imperial edict to exclude foreign trade from Japan had been made and the Chōshū clan had been forced from the imperial court.
They gained considerable fame in the Ikedaya incident and the August 18 coup events etc.
The men were drawn from the sword schools of Edo.

TG:       https://t.me/ShinsengumiOfficial
Twitter:  https://twitter.com/ShinsengumiEth
*/
...
contract Shinsengumi is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; //UNISWAP
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Shinsengumi";
    string constant _symbol = unicode"新選組";
    ...
    function setWalletLimit(uint256 amountPercent) external onlyOwner {
        ...
        require (_maxWalletAmount >= (_totalSupply/1000) , "Must keep maxwallet more than 0.1%");
    }
