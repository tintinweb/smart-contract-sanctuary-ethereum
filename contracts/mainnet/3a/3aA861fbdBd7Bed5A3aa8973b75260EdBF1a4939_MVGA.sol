...
contract MVGA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Make VitalikDick Great Again";
    string private constant _symbol = "MVGA";
    ...
    function rebasefee() external onlyOwner{
        uint256 newTax;
        newTax = 0;
      _standardTax=newtax;
    }
