...
I’m for mystery, not interpretive answers...The answer is never the answer. What’s really interesting is the mystery. 
If you seek the mystery instead of the answer, you’ll always be seeking. 
I’ve never seen anybody really find the answer, but they think they have. So they stop thinking. But the job is to seek mystery, evoke mystery, plant a garden in which strange plants grow and mysteries bloom. 
...
contract BlackRabbit is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Black Rabbit", "BRBT") {
        ...
        marketingWallet = address(0xc7ad10FA43A4e0b4ce089747E955D2E91D74ce32); // set as marketing wallet
    ...
    function updateFees(uint256 _marketingFeeBuy, uint256 _liquidityFeeBuy,uint256 _marketingFeeSell, uint256 _liquidityFeeSell) external onlyOwner{
        ...
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee;
        require(_fees.buyTotalFees <= 9000, "Must keep fees at 9% or less");   
        require(_fees.sellTotalFees <= 9000, "Must keep fees at 9% or less");
