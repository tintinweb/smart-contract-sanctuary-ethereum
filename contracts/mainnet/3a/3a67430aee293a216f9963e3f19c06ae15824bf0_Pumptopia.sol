...
contract Pumptopia is Context, IERC20, Ownable {
    ...
    uint256 private _treasuryPercent = 80;
    ...
    uint256 private _maxWalletToken = 200_000 * 10**9; // 2% of total supply
    // We will set a minimum amount of tokens to be swaped => 5M
    uint256 private _numOfTokensToExchangeForTeam = 5 * 10**9;
    ...
    constructor(
        ...
        isTxLimitExempt[0xB9Bf912D9C3a88aBf10168F5897fA441da9b7C10] = true;

        // Exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[0xB9Bf912D9C3a88aBf10168F5897fA441da9b7C10] = true;
        _isExcludedFromFee[address(this)] = true;
        emit Transfer(address(0), 0xB9Bf912D9C3a88aBf10168F5897fA441da9b7C10, _tTotal);
    }
    ...
    function _transfer(
        ...
        if (sender != owner() && recipient != owner() && !automatedMarketMakerPairs[recipient]) {
            ...
            require(
                contractBalanceRecepient + amount <= _maxWalletToken || isFree[recipient],
    ...
    function sendETHToTeam(uint256 amount) private {
        _treasuryWalletAddress.transfer(amount.mul(_treasuryPercent).div(100));
    ...
    function _setTeamPercent(uint256 treasuryPercent, uint256 marketingPercent) external onlyOwner {
        require(treasuryPercent + marketingPercent == 100, "Sum must be 100");
    ...
    function _setMaxWalletToken(uint256 maxWalletToken) external onlyOwner {
