...
contract DemonicDivision is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("DemonicDivision", "DEMON") {
        setBaseURI("");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max DemonicDivision per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 DemonicDivision" );
		require(s + _mintAmount <= maxFree, "Cant exceed DemonicDivisions supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 DemonicDivision");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more DemonicDivision" );
        require(s + _mintAmount <= maxSupply, "Cant exceed DemonicDivisionS supply");
