...
string private _name = "WELP";
string private _symbol = "WELP";
...
address _owner;
address payable public marketingAddress = payable(0x03F4D1D8CD10Ed159C188d387081b6c2d0071749);
...
function COINDay() public onlyOwner{
    require(block.timestamp > WELPCOINDaycooldown, "You cant call WELPCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function WELPCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    WELPCOINDaycooldown = block.timestamp + 86400;
}
