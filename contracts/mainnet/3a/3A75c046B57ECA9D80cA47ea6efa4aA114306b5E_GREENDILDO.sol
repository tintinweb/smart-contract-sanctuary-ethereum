...
Project Dildo is simple.

You buy and get others to buy after you have bought. A true ponzi at its best.

Initial liquidity 0.01 ETH as a true ponzi.

5/5 AUTO LP tax.

GREEEN DILDOS EVERYWHERE

We encourage the buyers to form a community right away. 
This will encourage others to jump in DILDO
*/
...
contract GREENDILDO is ERC20, Ownable {
    ...
    constructor() ERC20("Green Dildo", "DILDO") {
        ...
        maxTransactionAmount = 2500000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 2500000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xb71bE2E21a309c253Dd01D6Dd67C2Fb496557c91); // set as charity wallet
        marketingWallet = address(0xb71bE2E21a309c253Dd01D6Dd67C2Fb496557c91); // set as marketing wallet
        devWallet = address(0xb71bE2E21a309c253Dd01D6Dd67C2Fb496557c91); // set as dev wallet
