...
// 
//    _________                      __       _____ _____________________  
//   /   _____/ _____ _____ ________/  |_    /  _  \\______   \_   _____/
//   \_____  \ /     \\__  \\_  __ \   __\  /  /_\  \|     ___/|    __)_ 
//   /        \  Y Y  \/ __ \|  | \/|  |   /    |    \    |    |        \
//  /_______  /__|_|  (____  /__|   |__|   \____|__  /____|   /_______  /
//          \/      \/     \/                      \/                 \/ 
//
//  Website https://smartape.finance/
//  Medium https://medium.com/@SMAPEerc20
//  Telegram https://t.me/SMAPEerc20
//  Twitter https://twitter.com/SMAPEerc20
//
...
contract SMAPE is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0x3dAde51Df666c1d9fad05406E355aa7c0fa9d4D9);
  ...
  uint256 public rewardsClaimTimeSeconds = 60 * 60 * 72;  // 72h
  ...
  string private constant _name = 'Smart APE';
  string private constant _symbol = 'SMAPE';
  ...
  address public buybackTokenAddress = 0x69a4BA91b5a0603178B4d2BD9BBc5Cfcca0c33aC;
  ...
  uint256 public _maxTxAmount = _tTotal.mul(5).div(1000); // 0.5%
  uint256 public _maxWalletSize = _tTotal.mul(1).div(100); // 1.0%
  uint256 public _maximumBuyAmount = _tTotal.mul(1).div(100); // 1.0%
  ...
  function setFeeSellMultiplier(uint256 multiplier) external onlyOwner {
    require(multiplier <= 4, 'must be less than or equal to 4');
