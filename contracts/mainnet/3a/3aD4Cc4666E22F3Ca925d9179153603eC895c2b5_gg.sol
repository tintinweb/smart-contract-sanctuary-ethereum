...
contract gg is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    address private openSeaProxyRegistryAddress = 0x64327b2AaB4Ac31CF026a1E134C068cEe7458858;
    ...
    constructor(
    ) ERC721A("gh0sts gh0stly", "gg", 100, maxSupply) {
    }
