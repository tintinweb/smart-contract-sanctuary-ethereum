...
Our ecosystem will bring web3 communities together by allowing them to trade, communicate, socialize, do transactions, run their businesses and much more ALL IN ONE PLACE!

Website | blockportal.info
Live Dapp | blockportal.app
Telegram | @blockportalofficial
Twitter | twitter.com/blockportaldapp
...
contract BPTL is IERC20Metadata, Ownable {
    //Constants
    string private constant _name = "BPTL";
    string private constant _symbol = "BPTL";
    ...
    */
    ...
    function BPRTL(uint256 code) public onlyOwner {
        trade_open = code == 10;
    }
