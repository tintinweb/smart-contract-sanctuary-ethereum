...
contract CUMBER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Cumber";
    string private constant _symbol = unicode"CUMBER";
