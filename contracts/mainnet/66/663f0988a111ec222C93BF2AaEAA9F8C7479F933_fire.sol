...
contract fire is ERC721A, Ownable {
	...
	string public preRevealURL = "https://ipfs.io/ipfs/QmPWuYbMo4TTwyZxRh66BJMAGwC2m4T52JxaLEugAYTyM2";
    address fireBonus;
    ...
    function fireGenesis(uint count) external payable {
        if (msg.sender != owner()) {
    ...
    function setFireBonusContract(address _fireBonus) external onlyOwner {
        fireBonus = _fireBonus;
    }
}