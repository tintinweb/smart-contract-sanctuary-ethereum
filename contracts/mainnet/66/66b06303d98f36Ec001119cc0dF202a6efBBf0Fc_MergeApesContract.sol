...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1663250400;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x50346Db92afD9141dC1B636940e85a7436114EcA];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x50346Db92afD9141dC1B636940e85a7436114EcA;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifiqf7sc7hq2nehztglquljl4qsg5aha3d4t2ycyjpqbujec4d4uy/";
...
// File: contracts/MergeApesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MergeApesContract is RamppERC721A {
    constructor() RamppERC721A("Merge Apes", "MERGE"){}
}