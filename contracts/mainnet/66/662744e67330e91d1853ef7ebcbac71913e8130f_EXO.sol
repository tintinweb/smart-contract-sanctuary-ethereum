...
//EXO-磁力代理行動強化外骨格-
*/
contract EXO is Ownable, ERC721PsiBurnable, ReentrancyGuard, MerkleProof, ERC2981, DefaultOperatorFilterer,Operable {
  //Project Settings
  uint256 public wlMintPrice = 0.03 ether;
  uint256 public alMintPrice = 0.035 ether;
  uint256 public psMintPrice = 0.04 ether;
  uint256 public maxMintsPerWL = 3;
  uint256 public maxMintsPerAL = 5;
  uint256 public maxMintsPerPS = 1500;
  uint256 public maxMintsPerWLOT = 3;
  uint256 public maxMintsPerALOT = 5;
  uint256 public maxMintsPerPSOT = 2;
  uint256 public maxSupply = 5000;
  uint256 public mintable = 1500;
