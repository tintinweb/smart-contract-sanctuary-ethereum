...
/**
 TG: https://t.me/SHIBASBARKPORTAL
 Twitter: https://twitter.com/ShibasBark
*/
...
contract WOOFWOOF is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba's Bark", "WOOF WOOF") {
		...
		charityWallet = address(0xBFAd924C8Bb058f6832D776915a15772D3eC4c93); // set as charity wallet
        marketingWallet = address(0xBFAd924C8Bb058f6832D776915a15772D3eC4c93); // set as marketing wallet
        devWallet = address(0xBFAd924C8Bb058f6832D776915a15772D3eC4c93); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 50, "Max BuyFee 50%");
