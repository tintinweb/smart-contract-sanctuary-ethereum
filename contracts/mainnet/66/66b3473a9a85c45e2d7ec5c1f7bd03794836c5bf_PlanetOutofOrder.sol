...
contract PlanetOutofOrder is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;string public baseURI;
  ...
  ) ERC721A("Planet Out of Order", "Pooo") {  
