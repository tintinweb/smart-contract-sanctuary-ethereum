...
contract LilBOB is ERC721Enumerable, Ownable {
    ...
    uint256 private constant MAX_NFT_VIP = 68; // This is for VIP giveaways should be 68
    uint256 private constant MAX_NFT_GIVEAWAY = 143; // This is for general giveaways should be 143
