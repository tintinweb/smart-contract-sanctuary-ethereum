...
contract JizzedTooEarlyAi is ERC20, Ownable {
    ...
    constructor() ERC20("JizzedTooEarly.Ai", unicode"JIZZAI") {
        ...
        operationsWallet = address(0x05663602Aa5aF3C743ac99abC3514194245Cd9F7); // set as operations wallet
        devWallet = address(0x24C5c11655131f6BC97e34A2d19ab5302Dd64cF9); // set as dev wallet
