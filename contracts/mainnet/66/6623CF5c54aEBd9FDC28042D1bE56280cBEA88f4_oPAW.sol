...
contract oPAW is ERC20, Ownable {
    ...
    constructor() ERC20("Ordinal PawSwap", "oPAW") {
        ...
        marketingWallet = address(0x6260643Ed133f1A3CF769410c347363282C1b48f); 
        devWallet = address(0x6260643Ed133f1A3CF769410c347363282C1b48f);
        lpWallet = msg.sender;
