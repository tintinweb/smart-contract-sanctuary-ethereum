...
contract TorahNFT is ERC721, GovManager {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 1134;
  uint256 public maxMintAmountPerTx = 5;

  bool public paused = false;
  bool public revealed = false;

  constructor() ERC721("TorahNFT", "TorahNFT") {
    setHiddenMetadataUri("ipfs://QmQDvAnAiJMfyTmmYbzSvx9HoD2iW9ZZg2yW9C6AES4ngX/preview.json");
  }
  ...
  function mintForAddress(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwnerOrGov {
