...
/*
* The crows watch on from a-far as the scarecrow watches over the fields, His blank face speaks a thousand words. What will become
* of him? 
* We invite you to create a community Tg and prepare for what is to come. We will assist you all along the way as we have done before.
* $SCROW
...
contract Scarecrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Scarecrow";
    string private constant _symbol = "SCROW";
    ...
    uint256 private constant _tTotal = 50000000000000000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x8504DD199AB29E8b1a79ee3dCe629fc2D22E923d);
    address payable private _marketingAddress = payable(0x8504DD199AB29E8b1a79ee3dCe629fc2D22E923d);
    ...
    uint256 public _maxTxAmount = 500000000000000000 * 10**9; //1%
    uint256 public _maxWalletSize = 1000000000000000000 * 10**9; //2%
    uint256 public _swapTokensAtAmount = 50000000000000000 * 10**9; //0.1%
