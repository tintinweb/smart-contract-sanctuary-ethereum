...
/// @title Interface for ISuNounsRenderer
...
interface ISuNounsRenderer {
    event DataURIToggled(bool enabled);

    event BaseURIUpdated(string baseURI);

    event NounsDescriptorUpdated(INounsDescriptor descriptor);
    ...
    function setNounsDescriptor(INounsDescriptor descriptor) external;
