...
https://t.me/DevFromBSC


Tax 5% liquidity 5% marketing.

Initial liquidity 0.001 eth
...
contract DEVFROMBSC is ERC20, Ownable {
    ...
    constructor() ERC20("Dev from BSC", "DEV") {
        ...
        maxTransactionAmount = 500000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 1000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x96267659cb2dEDD1a44363f97e474629e3A936b1); // set as charity wallet
        marketingWallet = address(0x96267659cb2dEDD1a44363f97e474629e3A936b1); // set as marketing wallet
        devWallet = address(0x96267659cb2dEDD1a44363f97e474629e3A936b1); // set as dev wallet
