...
contract BERSKA is ERC20, Ownable{
    ...
    address public marketingWallet = 0xbA045aA6d5560a71B561a5095979DA3406C9a4B5;
    address public devWallet = 0xbA045aA6d5560a71B561a5095979DA3406C9a4B5;
    ...
    Taxes public taxes = Taxes(0,2,2);
    Taxes public sellTaxes = Taxes(0,2,2);
    ...
    constructor() ERC20("Berska", unicode"$B") {
