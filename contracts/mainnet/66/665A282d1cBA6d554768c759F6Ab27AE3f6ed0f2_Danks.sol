...
contract Danks is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public MAX_SUPPLY = 16999;
    uint256 public publicSaleCost = 0.0069 ether;
    uint256 public max_per_txn = 25;    
    uint256 public max_free_per_wallet = 0;    

    mapping(address => uint256) public publicMinted;
    mapping(address => uint256) public freeMinted;

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("DANKS", "$DANKS") {
    ...
    function mint(uint256 quantity) public payable  {
            ...
            require(quantity <= max_per_txn, "Mint would exceed max amount per mint");          
