...
contract NFT is ERC721Enumerable, Ownable {
    ...
    string private uri_ = "ipfs://bafkreihxltaczgiimw5wo67n324jz6mpdqwwm7wnzzqjclli75ydiuqkxm/";

    constructor()
        ERC721("The Non-Fungible Times", "NFT") 
    {
        
    }

    function mint(uint256 amount) external {
        require(amount + mintedAmount[_msgSender()] <= 10, "Max amount 10 per wallet");
        mintedAmount[_msgSender()] += amount;
