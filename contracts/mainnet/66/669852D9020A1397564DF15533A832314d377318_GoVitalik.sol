...
// https://t.me/GoVitalikEntryPortal
...
// Core Logic
// --------------------------------------------------------------
contract GoVitalik is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    using Address for address;

    // Context
    string private _name = "GoVitalik";
    string private _symbol = "GoVitalik";
    ...
    address payable public liquidityWallet =
        payable(0x8136318219ebE991946cA0dc15fE0C83c4441301);
