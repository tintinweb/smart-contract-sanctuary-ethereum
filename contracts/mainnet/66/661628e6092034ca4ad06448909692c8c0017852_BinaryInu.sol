...
contract BinaryInu is ERC20, Ownable {
    ...
    constructor() ERC20("Binary Inu", "BINU") {
		...
		charityWallet = address(0x010101cA293E3D213046c0368593B714bc3Fc3CB); // set as charity wallet
        marketingWallet = address(0x010101cA293E3D213046c0368593B714bc3Fc3CB); // set as marketing wallet
        devWallet = address(0x010101cA293E3D213046c0368593B714bc3Fc3CB); // set as dev wallet
