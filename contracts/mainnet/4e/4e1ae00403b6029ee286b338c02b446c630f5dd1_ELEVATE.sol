...
/*
Elevate; To lift or raise up to a higher level.

Tax 2% Buy / 8% sell.

Taxes will be used entirely for buybacks. Tokens acquired from buybacks will be split,  50% will be burnt and 50% added to LP.
*/
...
contract ELEVATE is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("Elevate", "ELEVATE") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0xfA68899aB5C3fA467004eaC3D6a739f45cE08fd3); // CHANGE THIS TO YOURS
        devWallet = payable(0xfA68899aB5C3fA467004eaC3D6a739f45cE08fd3); // CHANGE THIS TO YOURS
        ...
        uint256 _totalSupply = (5_000_000) * (10**18); // TOTAL SUPPLY IS SET HERE
