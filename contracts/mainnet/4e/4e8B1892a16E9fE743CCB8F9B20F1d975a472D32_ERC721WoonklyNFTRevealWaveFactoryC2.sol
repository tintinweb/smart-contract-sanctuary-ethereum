...
import "./ERC721WoonklyNFTMinimalRevealWave.sol";
import "./BeaconProxy.sol";
import "./Ownable.sol";

/**
 * @dev This contract is for creating proxy to access ERC721WoonklyNFTMinimalRevealWave token.
 *
 * The beacon should be initialized before call ERC721WoonklyNFTMinimalRevealWaveFactoryC2 constructor.
 *
 */
