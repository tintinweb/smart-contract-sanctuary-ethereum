...
🕰️The Key is not spending time, is investing it. 

Official Entry
https://t.me/TimeCultPortal
**/
...
contract TimeCultPortal is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TimeCult";
    string private constant _symbol = unicode"TIMECULT";
