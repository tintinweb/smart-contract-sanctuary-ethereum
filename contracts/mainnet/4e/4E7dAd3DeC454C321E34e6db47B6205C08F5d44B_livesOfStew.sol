...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract livesOfStew is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor(string memory _uriPrefix) ERC721A("LivesOfStew", "LOS") {
