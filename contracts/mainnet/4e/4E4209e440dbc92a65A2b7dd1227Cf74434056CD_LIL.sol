...
/**
* Lil JoJo is a dedicated support token for JoJo's Adventure @JOJO_Coin
*
* Telegram: https://t.me/LilJoJoETH
* Twitter: https://twitter.com/LilJoJo_Erc
*
* IMPORTANT PLEASE READ
*
* Lil JoJo Launch Plan.
*
* 0) Add LP
* 1) 00-15 mins 98% - Initial LP lock for 3 months
* 2) 16-30 mins 72%
* 3) 31-45 mins 50%
* 4) 46-60 mins 28%
* 5) 61-90 mins 16%
* 6) 91-120 mins 12% 
* 7) 121-240 mins 8%
* 8) then tax = 5% - Renounce Contract
*
* >> LP lock to be extended to 888 years at 200K MC <<
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract LIL is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Lil JoJo";
