...
Telegram : @Text2EarnPortal
Litepaper is available on Telegram

Website will be available shortly on domain: text2earn.xyz
...
**/
  ...
  contract Text2Earn is Context, IERC20, Ownable {
      ...
      string private constant _name = unicode"Text2Earn";
      string private constant _symbol = unicode"Text2Earn";
