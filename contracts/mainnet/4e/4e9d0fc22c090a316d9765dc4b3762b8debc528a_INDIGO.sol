...
The Indigo Collective is a project promoting Ethereans to buidl 
Decentralized Finance in a more pragmatic and responsible way.

https://www.indigo.cash/
...
contract INDIGO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Indigo Collective", "DIGO") {
    ...
    ; uint256 totalSupply = 0.55 * 1e12 * 1e18;
