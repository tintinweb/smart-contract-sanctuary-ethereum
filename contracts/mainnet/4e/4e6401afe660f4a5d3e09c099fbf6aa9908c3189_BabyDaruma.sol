...
Activate the guardian parents, the Baby Daruma is awake!
Eight times down, nine times up.

"I need nothing, I seek nothing, I desire everything."

Baby Daruma - $DAYUMA

TG:
https://t.me/dayumatoken
Twitter:
...
contract BabyDaruma is Context, IERC20, Ownable {
    ...
    uint256 private decreasingTaxFrequency = 10 minutes;
    uint256 private lastDecreasingTaxTime;
    
    string private constant _name = "Baby Dayuma";
    string private constant _symbol = "DAYUMA";
    ...
    constructor () {
        _feeAddrWallet = payable(0x0c7BfB976f95735f184cAB73db4bDBA5D38AB527);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (_taxes.buyFee2 > 0 && block.timestamp >= lastDecreasingTaxTime + decreasingTaxFrequency) {
                _taxes.buyFee2 = _taxes.buyFee2.sub(1);
                _taxes.sellFee2 = _taxes.sellFee2.sub(1);
                lastDecreasingTaxTime = block.timestamp;
                emit ChangedTax(_taxes.buyFee2);
            }
        }
