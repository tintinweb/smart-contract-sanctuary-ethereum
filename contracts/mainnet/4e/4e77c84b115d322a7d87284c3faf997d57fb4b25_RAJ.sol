...
Rick and Johnny (RAJ)
is a MEME token that draws inspiration from Rick and Morty and Johnny Depp.

Website: https://rickandjohnnytoken.com/
Tg: https://t.me/rickandjohnny
...
contract RAJ is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rick and Johnny";
    string private constant _symbol = "RAJ";
