    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 429) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://yep.mypinata.cloud/ipfs/QmefV6nzhrMwH93VKgywj7UmPLgWFWU7AVWoRxNgk7Hh8h/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 429");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 429");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 429");
...
// File: contracts/HeroesXContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HeroesXContract is RamppERC721A {
    constructor() RamppERC721A("Heroes X", "RPGS"){}
}
