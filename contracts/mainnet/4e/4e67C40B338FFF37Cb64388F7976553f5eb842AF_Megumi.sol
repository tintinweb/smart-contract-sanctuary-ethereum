...
contract Megumi is Ownable, ERC721A, DefaultOperatorFilterer  {

    using Strings for uint256;

    string private baseTokenURI;
    uint64 public maxSupply = 777;
    uint64 public publicLimit = 5;
    bool public publicSaleActive = false;
    mapping(address => uint256) public claimed;


    constructor() ERC721A("Megumi GENESIS", "MEG"){}
