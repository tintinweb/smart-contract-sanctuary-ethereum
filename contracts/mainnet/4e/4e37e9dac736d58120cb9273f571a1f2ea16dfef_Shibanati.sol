...
TOGETHER WE CAN OVER TURN THE GOVERNMENT...
https://shibanati.com
https://twitter.com/SHIBANATI_NSO?t=FLxg6RTYF0Y2PtqZgPOx6g&s=35
https://t.me/SHIBANATI_NSO_PORTAL
...
contract Shibanati is ERC20, Ownable {
    ...
    constructor() ERC20("Shibanati", "SHIBANATI") payable {
    	...
    	marketingWallet = address(0x11533Ca829081999bBE182515EaAF36B78A42E11); // set as Marketing wallet
        devWallet = address(0x85D6A2D3bD558Ed531175E287A3AaFA1658Bab96); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x85D6A2D3bD558Ed531175E287A3AaFA1658Bab96, true);
        excludeFromFees(0x11533Ca829081999bBE182515EaAF36B78A42E11, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x85D6A2D3bD558Ed531175E287A3AaFA1658Bab96, true);
        excludeFromMaxTransaction(0x11533Ca829081999bBE182515EaAF36B78A42E11, true);
        ...
        */
        ...
        _createInitialSupply(0x89C814eacAb77c01B171b05ce19EcE4d1b16b705, totalSupply*2/100);
        _createInitialSupply(0xBbfe8CbEF2bAF09c1808D47F65DbcAf1E42b9F59, totalSupply*2/100);
        _createInitialSupply(0x68bBc23B0f9492Cf01Ed2Bb8A00baFAAE4d6C032, totalSupply*2/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x11533Ca829081999bBE182515EaAF36B78A42E11,
            block.timestamp
        );
    }
