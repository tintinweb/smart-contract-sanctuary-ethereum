...
contract WVW is ERC20, Ownable {
    ...
    constructor() ERC20("Woke v Woke", "WVW") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0xCfef195B743984b219D871779e62071548392438); // set as Marketing wallet
        DevWallet = address(0xCfef195B743984b219D871779e62071548392438); // set as dev wallet
