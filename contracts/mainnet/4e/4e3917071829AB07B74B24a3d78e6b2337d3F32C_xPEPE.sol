...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F;
    IBEP20 RewardToken = IBEP20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
...
contract xPEPE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "0xPEPE";
    string constant _symbol = "xPEPE";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F;
    address RewardToken = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    ...
    bool public restrictWhales = true; //set max tx and max wallet limit as true (enabled) or false (disabled) will be disabled later
   ...
   // bool public blacklistMode = true;
    ...
    constructor () Auth(msg.sender) {
        ...
        lotteryWallet = 0x042588833C082524394264E1F326191971A95836; 
