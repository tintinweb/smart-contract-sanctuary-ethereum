...
contract ProofofLuffy is Context, IERC20, Ownable {
    ...
    string private _name = "Proof of Luffy";
    string private _symbol = "LUFFY2.0";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 3; //(3% liquidityAddition + 2% rewardsDistribution + 3% devExpenses)
    ...
    // limit
    uint256 public _maxTxAmount = 9000000000000 * 10**2 * 10**9; //1.5% after 50% burn
