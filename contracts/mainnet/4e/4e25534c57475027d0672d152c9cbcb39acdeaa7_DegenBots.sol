...
The battle against paper hands and newbies must be won by bots. We will unveil our future plans 
when their corpses pile up as high as possible. Keep your head up and stay degen

Telegram:https://t.me/degenbots
Twitter:https://twitter.com/degenbotseth
Website:https://degenbots.me
...
contract DegenBots is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Degen Bots";
    string private constant _symbol = "DEGEN BOTS";
