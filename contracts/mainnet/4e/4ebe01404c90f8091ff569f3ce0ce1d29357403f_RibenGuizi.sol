...
contract RibenGuizi  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "RibenGuizi";
    string private constant _symbol = unicode"日本鬼子";
    ...
    address payable private _developmentAddress = payable(0x9D7A452Dd1bd1B8E0e606c3F3Af55Dab5b272a7C); 
    address payable private _marketingAddress = payable(0x9D7A452Dd1bd1B8E0e606c3F3Af55Dab5b272a7C);
