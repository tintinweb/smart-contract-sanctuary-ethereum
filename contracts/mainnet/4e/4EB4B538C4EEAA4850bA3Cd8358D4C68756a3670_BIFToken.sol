...
contract BIFToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Biden Invisible Frens";
    string private constant _symbol = "BIF";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance>0 && _buyCount > 35) {
