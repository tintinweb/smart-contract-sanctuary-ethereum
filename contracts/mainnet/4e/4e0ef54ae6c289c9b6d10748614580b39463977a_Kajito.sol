...
이더리움 네트워크를 날려버릴 차세대 이더리움 유틸리티 토큰, Kajito IO 에 오신 것을 환영합니다.
...
contract Kajito is Context, IERC20 { 
...
// https://web.wechat.com/KajitoKOR
// https://www.kajitoxino.web3page.io
// https://www.zhihu.com/
    ...
    address payable public Wallet_Marketing = payable(0x8d6A742B525F94bae68169f4d3b3C6B595d3D32B); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Wallet_Developer = payable(0x8d6A742B525F94bae68169f4d3b3C6B595d3D32B);
    ...
    string private constant _name = "Kajito IO"; 
    ...
    constructor () {
        ...
        _owner = 0x8d6A742B525F94bae68169f4d3b3C6B595d3D32B;
