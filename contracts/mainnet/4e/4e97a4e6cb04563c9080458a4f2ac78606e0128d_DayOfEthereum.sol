...
/**
    ...
    We bringing big dreams and many future project with us!
    With under 5% taxes both on buys and sells, experienced team that has taken projects came with community driven.

    https://t.me/DayOfEthereum
*/
...
contract DayOfEthereum is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4272aF0b1672e2fa0C738D91FA9694a8e7729970); 
    address payable public Wallet_Utility = payable(0x4272aF0b1672e2fa0C738D91FA9694a8e7729970);
    ...
    string private constant _name = "Day of Ethereum"; 
    ...
    constructor () {
        ...
        _owner = 0x4272aF0b1672e2fa0C738D91FA9694a8e7729970;
