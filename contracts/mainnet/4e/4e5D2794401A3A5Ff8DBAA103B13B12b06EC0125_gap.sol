...
✈️Telegram - https://t.me/GameApeETH

📰Medium - https://medium.com/@gameapeerc/
*/
...
contract gap is Context, IERC20, Ownable {
    ...
    string private constant _name = "GameApe";
    ...
    function removemaxtxamount(uint256 maxTxAmount) public onlyOwner {
        _maxTxAmount = maxTxAmount;
    }

    function removemaxwalletamount(uint256 maxWalletSize) public onlyOwner {
