...
// that's why we have a decompiler, forked straight from The Great Pyramid $GIZA
// https://t.me/thegreatpharaoherc
...
contract Pharaoh is ERC20, Ownable {
    ...
    constructor() ERC20("The Great Pharaoh", "RAMSES II") {
    ...
    ; uint256 totalSupply = 21 * 1e6 * 1e18;
        ...
        swapTokensAtAmount = totalSupply * 50 / 10000; // 0.1% swap wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
    } // Cannot set Buyfees higher than 16%
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee, uint256 _earlySellDevFee) external onlyOwner {
	    ...
	    earlySellDevFee = _earlySellDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
    } // Cannot set Sellfees higher than 1%
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x1f5ed298467B11F0093A6c7a3EA4D3C28b938b32) &&
                !swapping
            ){
                if(!tradingActive){
