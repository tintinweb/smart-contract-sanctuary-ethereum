...
contract BGFSTYXV2 is Ownable {

    address public hellspawn;
    ...
    function spendBalanceHellspawn(address _address, uint256 _amount) public {
        require(spendingEnabled, "Balance spending functions are disabled.");
        require(msg.sender == hellspawn, "Not Allowed.");
    ...
    //Only Owner
    function setHellspawnAddress(address _address) public onlyOwner {
        hellspawn = _address;
    }
