...
/**
AmongCheese($ACCOIN)  Among Cheese Token($ACCOIN) is combining the mobile game and AMOUNG US fanbases will allow Among Cheese($ACCOIN) to dominate the cryptoverse.
**/
// Telegram: https://t.me/AmongCheese

pragma solidity ^0.8.12;

uint256 constant INITIAL_TAX=12;
uint256 constant TOTAL_SUPPLY=100000000;
string constant TOKEN_SYMBOL="ACCOIN";
string constant TOKEN_NAME="Among Cheese";
...
contract AmongCheese is Context, IERC20, Ownable {
