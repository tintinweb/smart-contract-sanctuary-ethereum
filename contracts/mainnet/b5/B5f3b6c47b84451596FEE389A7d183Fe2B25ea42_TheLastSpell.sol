...
contract TheLastSpell is ERC721A, Ownable {
    ...
    string public prerevealURL = "ipfs://QmT4zN8qQ5WTakVz2d3Hb4hhj817RdWbLb1LiUfvBgDUzH/hidden.json/";
    bool public start = true;
 
    mapping (address => uint256) private MintedBalance;

    constructor() ERC721A("The Last Spell", "TLS") {}
