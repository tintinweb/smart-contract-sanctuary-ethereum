...
//*********************************************************************//
//
// By signing to mint, you agree to the terms and conditions defined in this URL: https://app.termly.io/document/terms-of-use-for-website/50bc304c-82ff-43bc-a8e4-7098fc7216e5
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x86cBf57556cbf859334821606D930056a16Ca0cF,0x97a5810acDDF54371e3bBA01C41eFbA8ada268d6];
  address public erc20Payable = 0x86cBf57556cbf859334821606D930056a16Ca0cF;
  uint256[] public payableFees = [85,15];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 10) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeigfugelqikx75a2pspvhj7ru4257ykuupn7dya5l73gpahibwrrqy/";
...
// File: contracts/ThetenredeemedContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ThetenredeemedContract is RamppERC721A {
    constructor() RamppERC721A("THE TEN REDEEMED", "TNR"){}
}
