...
/**
 SafeSOL is a community led ERC20 token made to pay homage to those impacted by the massive Solana exploit.
 Telegram: t.me/SafeSOL
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x56e771580132b7B2144ee3188d366725C539E7dF] = _marketingwallet;
    }
...
contract SafeSOL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SafeSOL", "sSOL") {
        ...
        excludeFromFees(address(0x56e771580132b7B2144ee3188d366725C539E7dF), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x56e771580132b7B2144ee3188d366725C539E7dF), true);
