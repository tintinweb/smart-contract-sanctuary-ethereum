...
contract Fallen is ERC721, ERC721Metadata {
    string public _name;
    ...
    constructor() {
        _balance = 1;
        _name = "Chapter I: A New Beginning";
        _symbol = "FALLEN";
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        ...
        emit Transfer(_owner, to, _balance);
        _owner = to;
    }

    function burn() public virtual {
        require(msg.sender == 0xd0E922378E3440Eb8586aE034C28309F393E0FbB, "ERC721: not yours to break!");
