...
Everything that has happened has lead you to this moment. Don’t change a thing. 
Everything worked out exactly as it should be. 
All the puzzle pieces fit, all the paths make sense. 
All the people were meant to be. 
All the successes and failures and heartwarming and heartbreaking moments were all worth it. 
No regrets. 
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xDeF8C08cC71187429BA86F9a4dE7ff49aefeF32A] = _marketingwallet;
    }
...
contract BEGIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Future", "BEGIN") {
        ...
        excludeFromFees(address(0xDeF8C08cC71187429BA86F9a4dE7ff49aefeF32A), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xDeF8C08cC71187429BA86F9a4dE7ff49aefeF32A), true);
