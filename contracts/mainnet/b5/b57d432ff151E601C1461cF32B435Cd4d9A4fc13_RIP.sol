...
$RIP is a tribute to the dog which brought the meme aspect in the crypto market. He united us and now its time to give him his last goodbyes👋

Liquidity for $RIP will be locked for 1 month at start and ownership will be renounced too🔒

Taxes will be - 4% after 60 buys are completed.

TG- https://t.me/RIPKabosuETH
Twitter- www.twitter.com/RIPKabosuETH
...
contract RIP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"RIP KABOSU";
    string private constant _symbol = unicode"$RIP";
