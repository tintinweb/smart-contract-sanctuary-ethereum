...
contract KFF is ERC721, ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxSupply; // this is the maximum supply of NFTs 
    bool public isPaused = true; // this is the toggle to pause and unpause minting
    ...
    constructor(
        ...
        uint256 _maxSupply // the total number of NFTs that can be minted
        // deploy!
    ...
    // MINT FUNCTION
    // This will mint one token, set ranking to zero, 
    ...
    function mint(address _to) public payable returns (uint256) {
        ...
        require(!isPaused || msg.sender == owner(), "Minting is currently paused");
    ...
    // RECEIVER WITHDRAW FUNDS FROM CONTRACT
    // this withdraws all of a arbitrary token in the contract
    function receiverTokenWithdraw(address _token) public payable {
