...
contract COMA is ERC20, Ownable {
    ...
    constructor() ERC20("Coma", ",") {
		...
		charityWallet = address(0x488ddf5B955605690a0933aE28c23fA548137183); // set as charity wallet
        marketingWallet = address(0x488ddf5B955605690a0933aE28c23fA548137183); // set as marketing wallet
        devWallet = address(0x488ddf5B955605690a0933aE28c23fA548137183); // set as dev wallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 5) / 100000000) / 1e18,
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 15, "Max BuyFee 8%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 15, "Max SellFee 8%");
