...
contract TheTeamFinanceProtocol is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"The Team Finance Protocol";
    string private constant _symbol = unicode"$TFP";
