...
contract ITSCONE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Its Cone";
    string private constant _symbol = "CONE";
    ...
    function openTrading() external onlyOwner {
        ...
        _maxTxAmount = 5000001 * 10**9;
        _maxWalletAmount = 20000001 * 10**9;
        tradingOpen = true;
    ...
    function setAntiSnipe(address _antiMev) external onlyOwner {
