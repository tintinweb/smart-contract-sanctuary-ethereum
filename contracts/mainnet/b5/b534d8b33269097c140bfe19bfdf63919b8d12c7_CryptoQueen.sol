...
contract CryptoQueen is ERC721A, Ownable {

    string public baseURI = "https://ipfs-storage.s3.amazonaws.com/cryptoqueen/";

    uint256 public tokenPrice = 5200000000000000; //0.0052 ETH

    uint public maxTokensPerTx = 10;

    uint public defaultTokensPerTx = 3;

    uint256 public MAX_TOKENS = 9696;
    ...
    constructor() ERC721A("CryptoQueen", "CQ", 100, MAX_TOKENS) {
    }
