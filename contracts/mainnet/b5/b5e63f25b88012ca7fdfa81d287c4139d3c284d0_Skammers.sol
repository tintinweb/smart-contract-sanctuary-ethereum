...
contract Skammers is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 1337;
    uint public PRESALE_LIMIT = 1337;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 13;
    uint256 public PRICE = 69420000000000000; //0.06942 eth
    uint public perAddressLimit = 5;
    ...
    address payable private devguy = payable(0x2a07f1C285eeE2CEf31a1E689c445F732D17b7Ee);

    constructor() ERC721("Skammers", "SKAM") {}
