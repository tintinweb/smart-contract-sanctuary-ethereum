...
contract Globe  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Globe";
    string private constant _symbol = "GLOBE";
    ...
    address payable private _developmentAddress = payable(0x52203C9f165325F52b6E4AeeDfdEB24Cb8C8E89d); 
    address payable private _marketingAddress = payable(0x52203C9f165325F52b6E4AeeDfdEB24Cb8C8E89d);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 40, "Buy tax must be between 0% and 40%");
