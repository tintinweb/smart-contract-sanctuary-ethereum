...
// File: contracts/Aidigidaigaku.sol
...
contract ProofOfPepe is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    constructor(string memory initBaseURI) ERC721A("Proof of Pepe", "POPEP") {
        baseURI = initBaseURI;
    ...
    function setpublic(bool _isPublicSaleActive)
      external
      onlyOwner
  {
