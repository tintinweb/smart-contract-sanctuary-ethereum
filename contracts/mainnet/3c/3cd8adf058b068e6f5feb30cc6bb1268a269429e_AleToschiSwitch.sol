...
contract AleToschiSwitch {
    ...
    constructor(address _switchPriceDumper, address _destinationTokenAddress, address[] memory _tokenAddresses, uint256 _totalSupply, uint256[] memory _conversionsPerToken) {
        switchPriceDumper = _switchPriceDumper;
        destinationTokenAddress = _destinationTokenAddress;
        tokenAddresses = _tokenAddresses;
        totalSupply = _totalSupply;
        conversionsPerToken = _conversionsPerToken;
    }
