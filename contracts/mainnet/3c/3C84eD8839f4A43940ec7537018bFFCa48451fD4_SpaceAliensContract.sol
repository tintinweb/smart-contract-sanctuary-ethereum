...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xA6897206C197Ab358d89dB6759755796379841f8];
  address public erc20Payable = 0xA6897206C197Ab358d89dB6759755796379841f8;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 6499) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiajydcr737m4comwupy7qpibfiuxkzrxdy7neofy3a67js5yqxthq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/PQpHg2ZeZsNFVVeh5hvB/contract-metadata";
  }
...
// File: contracts/SpaceAliensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpaceAliensContract is ERC721APlus {
    constructor() ERC721APlus("Space Aliens ", "SA"){}
}
  /*******************************************************/
  /*                                                     */
