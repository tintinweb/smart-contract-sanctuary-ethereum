...
contract DogeFamily is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge Family";
    string private constant _symbol = "DogeFamily";
    ...
    address payable private _developmentAddress = payable(0x77131a6707A573eF6C1fc4C655cF8e8D16572De2);
    address payable private _marketingAddress = payable(0x77131a6707A573eF6C1fc4C655cF8e8D16572De2);
