...
//*********************************************************************//
//
//     ___              __  ___         __     ________    ___   __________ _______________    ______      ____          __  _           
//    /   |_   ______ _/ /_/   |  _____/ /_   / ____/ /   /   | / ___/ ___//  _/ ____/ ___/   / ____/___  / / /__  _____/ /_(_)___  ____ 
//   / /| | | / / __ `/ __/ /| | / ___/ __/  / /   / /   / /| | \__ \\__ \ / // /    \__ \   / /   / __ \/ / / _ \/ ___/ __/ / __ \/ __ \
//  / ___ | |/ / /_/ / /_/ ___ |/ /  / /_   / /___/ /___/ ___ |___/ /__/ // // /___ ___/ /  / /___/ /_/ / / /  __/ /__/ /_/ / /_/ / / / /
// /_/  |_|___/\__,_/\__/_/  |_/_/   \__/   \____/_____/_/  |_/____/____/___/\____//____/   \____/\____/_/_/\___/\___/\__/_/\____/_/ /_/ 
//                                                                                                                                       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1658725200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1658638800;
...
abstract contract Withdrawable is Teams, Ramppable {
  ...
  uint256[] public payableFees = [5,25,25,45];
    ...
    , TimedDrop
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 1, 1250) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif663elkxo7g4ebqbt35aisvufbkjrol4akxjyuch32ujmmf6vraq/";
...
// File: contracts/AvatArtClassicsCollectionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AvatArtClassicsCollectionContract is RamppERC721A {
    constructor() RamppERC721A("AvatArt CLASSICS Collection", "CLASS"){}
}
