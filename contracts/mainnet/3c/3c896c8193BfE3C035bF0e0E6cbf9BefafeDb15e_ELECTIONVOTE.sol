...
contract ELECTIONVOTE  is Context, IERC20, Ownable {
    uint8 private _decimals = 9;
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public  _totalSupply = 25000000  * 10**(_decimals);
    ...
    string private _name = unicode"Election Vote";
    string private _symbol = unicode"EVOTE";
