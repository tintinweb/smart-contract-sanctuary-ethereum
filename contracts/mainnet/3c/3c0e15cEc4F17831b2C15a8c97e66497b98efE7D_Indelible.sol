...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Clothes", unicode"Mouth", unicode"Hair", unicode"Eyebrown", unicode"Eye", unicode"hand", unicode"Skin", unicode"Body", unicode"Weapon", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"CyberGangsterOC", unicode"The story of a land. Talk about notorious gangs. Greed to the throne or for the safety of this land they will unite together !!!", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/45f3068d-d63b-4b37-a6b2-0ee2fb27fd73", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/45f3068d-d63b-4b37-a6b2-0ee2fb27fd73", "", 700, "0x187D73906DFe9455d35525b8e726974DA2EB3B56");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"CyberGangsterOC", unicode"CGOC") {
        tiers[0] = [1,1,1,1,1,31,32,34,35,110,112,132,137,141,148,158,258,260,304,493,610];
        tiers[1] = [0,0,0,0,0,86,140,262,287,316,336,417,556,600];
        tiers[2] = [0,0,0,0,0,187,187,187,187,187,187,187,187,188,188,188,188,188,188,188,188];
        tiers[3] = [0,0,0,0,0,24,52,66,102,128,165,185,541,761,976];
        tiers[4] = [0,0,0,0,0,139,145,150,155,164,169,169,171,190,200,215,216,279,296,342];
        tiers[5] = [0,0,0,0,0,171,183,205,222,228,232,259,352,366,384,398];
        tiers[6] = [0,0,0,0,0,517,569,608,619,687];
        tiers[7] = [0,0,0,0,0,750,750,750,750];
        tiers[8] = [0,0,0,0,0,88,103,120,135,138,149,150,163,170,172,176,242,257,432,505];
        tiers[9] = [0,0,0,0,0,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200];
