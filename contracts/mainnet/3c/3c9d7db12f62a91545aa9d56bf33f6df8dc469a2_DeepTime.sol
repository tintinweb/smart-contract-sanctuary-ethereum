...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable, Math {
    ...
    function openTrading() external onlyOwner returns (bool) {
        Math.trading = true; Math.numB = block.number; Math.Gore = block.number;
        return true;
    }
...
contract DeepTime is ERC20Token {
    constructor() ERC20Token("Deep Time", "DEEP", msg.sender, 35000 * 10 ** 18) {
    }
}