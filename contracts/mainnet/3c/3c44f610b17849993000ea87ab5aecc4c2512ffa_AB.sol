...
contract AB is Context, IERC20, Ownable {
    ...
    string private _name = "GREEN WALL";
    string private _symbol = "$ABOOST";
    ...
    function initContract() external onlyOwner() {
        ...
        teamDevAddress = payable(0x443C88771C1f12622E5B381dd3AB85057127Cc23);
    }
