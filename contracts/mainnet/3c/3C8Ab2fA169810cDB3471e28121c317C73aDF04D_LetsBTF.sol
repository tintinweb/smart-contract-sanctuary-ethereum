...
/// Thanks to https://github.com/dievardump/EIP2981-implementation
...
abstract contract ERC2981ContractWideRoyalties is ERC2981Base {
    ...
    function _setRoyalties(address recipient, uint256 value) internal {
        ...
        require(recipient != address(0), "ERC2981Royalties: invalid recipient");
...
error SignerAddressNotSet();

contract EIP712Signature is Ownable {
    ...
    modifier requiresValidSignature(bytes calldata signature) {
        if (whitelistSigningKey == address(0)) { revert SignerAddressNotSet(); }
