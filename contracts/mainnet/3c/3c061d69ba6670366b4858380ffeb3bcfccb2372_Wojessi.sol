...
/** 
It's Lionel Wojessi's final world cup and in his honour we are launching a meme-based Ethereum token...

www.wojessi.com

medium.com/@wojessi

twitter.com/WojessiETH
...
contract Wojessi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Wojessi";
    string private _symbol = "WESSI";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x5AF343EAFc4A6b47542e74aC80cE4D7c36EBd88F);
    address payable private taxWallet2 = payable(0x5AF343EAFc4A6b47542e74aC80cE4D7c36EBd88F);
