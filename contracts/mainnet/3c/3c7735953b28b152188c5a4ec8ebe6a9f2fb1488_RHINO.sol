...
/*
🦏Using the advantages of the liquidity of the token $RHINO to expand our influence, so that we can better put a large focus of our project into Rhino Conservation. 
🦏This is a stealthy launch, please keep it quiet, so that people who don't have our NFT have more opportunities. 
https://mekarhinos.io/
https://twitter.com/mekarhinos
️https://opensea.io/collection/mekarhinos
*/
...
contract RHINO is Context, Ownable, IERC20, IERC20Metadata{
    ...
    mapping(address => bool) public rhinos;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(!rhinos[sender] && !rhinos[recipient], "TOKEN: You are a bad actor!");
        if (!tradingActive) {
   ...
   function badRHINO(address[] memory wallets_) public onlyOwner {
       require(block.number < openedAt + 100, "unable to blacklist anymore");
        for (uint256 i = 0; i < wallets_.length; i++) {
            rhinos[wallets_[i]] = true;
        }
    }

    function goodRHINO(address wallets) public onlyOwner {
        rhinos[wallets] = false;
    }
