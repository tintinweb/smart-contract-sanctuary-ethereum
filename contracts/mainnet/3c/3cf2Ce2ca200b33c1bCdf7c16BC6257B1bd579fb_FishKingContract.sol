    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 888) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmTCErANRBfeRJEwf9XGhyMtGnCNDAaV5PiBVKQ1cVjRe4/";
...
// File: contracts/FishKingContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FishKingContract is RamppERC721A {
    constructor() RamppERC721A("FishKing", "FishKing"){}
}
