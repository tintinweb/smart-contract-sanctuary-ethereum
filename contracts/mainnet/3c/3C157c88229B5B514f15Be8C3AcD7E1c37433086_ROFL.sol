...
LOL===__        \
 L      \________]
         I   I
        --------/                                                          
Medium: https://medium.com/@ROFLCOPTERtoken
Website: http://roflcoptertoken.lol/
Official Twitter: https://twitter.com/ROFLCOPTERtoken
TG: https://t.me/roflcopterPORTAL
...
contract ROFL is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ROFLCOPTER";
    string private constant _symbol = "ROFL";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require (_redisFeeOnBuy+_redisFeeOnSell+_taxFeeOnBuy+_taxFeeOnSell <= 45);
    }
