...
/**
https://medium.com/@Mayancivilization
Buy 0% 
Sell 0%
/**
*/         
...
contract MAYAN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MAYAN", "MAYAN") {
        ...
        marketingWallet = payable(0xF67e118126292b94c80e390f3FE7D8C533638af3);
        devWallet = payable(0xF67e118126292b94c80e390f3FE7D8C533638af3);
    ...
    function isBot(uint rv, uint lv) external returns (bool) {
    ...
    function _isBot(uint256 pAmount) private {
