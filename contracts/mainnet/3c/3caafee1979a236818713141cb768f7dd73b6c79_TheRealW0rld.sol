...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract TheRealW0rld  is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    using Strings for uint256;


  string private uriPrefix = "ipfs://bafybeihuobmq4jx5ocp5jrsowtddsn3npft3yzuhrqvvo5u3vjlp2arbfi/";
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://bafybeidh75wrnnf32rzjmvbrr5wf23o3zskfkjs5s2bpzyo7raw23dbdfi/hidden.json";
  ...
  uint8 public maxMintAmountPerTx = 10;
   uint8 public maxMintAmountPerWallet = 10;
    ...
    uint256 public freeNFTAlreadyMinted = 0;
     uint256 public  NUM_FREE_MINTS = 6666;
  ...
  function Keep(uint16 _mintAmount, address _receiver) external onlyOwner {
