...
contract ETHGI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ETH Girl";
    string private constant _symbol = "ETHGI";
    ...
    uint256 private _taxFeeOnBuy = 33;
