...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1DFA35f514CdEf21Bef5Dd0c1b33E57f13E90a5a];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZRUBm8N4ahDJFg9rQMLFJXju9NNTMXdyV6uGBmCr3AEK/";
...
contract SaniksanikContract is RamppERC721A {
    constructor() RamppERC721A("SANIKSANIK", "sanik"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/hXudbQBdwiYol1vuyBop/contract-metadata";
    }
}
