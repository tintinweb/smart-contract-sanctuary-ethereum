...
contract InstaETHVaultV2Resolver is Helpers, NetAssetsHelpers {
    ...
    function getUIDetails(address user_)
        ...
        returns (UIInfo memory uiInfo_) {
            ...
            |           PROTOCOLS INFO          |
            |__________________________________*/
            (uiInfo_.protoInfo, ,)= getAllProtocolInfo();
            ...
            uint256 ratioDiffAaveV2_ = 
                uiInfo_.protoInfo.aaveV2.ratio < uiInfo_.protoInfo.aaveV2.maxRiskRatio // we can set buffer margin on backend.
                ? uiInfo_.protoInfo.aaveV2.maxRiskRatio - uiInfo_.protoInfo.aaveV2.ratio
                : 0;

            // in 1e6
            uint256 ratioDiffAaveV3_ = 
                uiInfo_.protoInfo.aaveV3.ratio < uiInfo_.protoInfo.aaveV3.maxRiskRatio // we can set buffer margin on backend.
                ? uiInfo_.protoInfo.aaveV3.maxRiskRatio - uiInfo_.protoInfo.aaveV3.ratio
                : 0;

            // in 1e6
            uint256 ratioDiffCompoundV3_ = 
                uiInfo_.protoInfo.compoundV3.ratio < uiInfo_.protoInfo.compoundV3.maxRiskRatio // we can set buffer margin on backend.
                ? uiInfo_.protoInfo.compoundV3.maxRiskRatio - uiInfo_.protoInfo.compoundV3.ratio
                : 0;

            // in 1e6
            uint256 ratioDiffEuler_ = 
                uiInfo_.protoInfo.euler.ratio < uiInfo_.protoInfo.euler.maxRiskRatio // we can set buffer margin on backend.
                ? uiInfo_.protoInfo.euler.maxRiskRatio - uiInfo_.protoInfo.euler.ratio
                : 0;

            // in 1e6
            uint256 ratioDiffmorphoAaveV2_ = 
                uiInfo_.protoInfo.morphoAaveV2.ratio < uiInfo_.protoInfo.morphoAaveV2.maxRiskRatio // we can set buffer margin on backend.
                ? uiInfo_.protoInfo.morphoAaveV2.maxRiskRatio - uiInfo_.protoInfo.morphoAaveV2.ratio
                : 0;
            ...
            : (uiInfo_.protoInfo.aaveV2.stETHCol * ratioDiffAaveV2_) / uiInfo_.protoInfo.aaveV2.maxRiskRatio;

            uiInfo_.availableAaveV3 = uiInfo_.protoInfo.aaveV3.maxRiskRatio == 0
            ? uiInfo_.protoInfo.aaveV3.stETHCol
            : (uiInfo_.protoInfo.aaveV3.stETHCol * ratioDiffAaveV3_) / uiInfo_.protoInfo.aaveV3.maxRiskRatio;

            uiInfo_.availableCompoundV3 = uiInfo_.protoInfo.compoundV3.maxRiskRatio == 0
            ? uiInfo_.protoInfo.compoundV3.stETHCol
            : (uiInfo_.protoInfo.compoundV3.stETHCol * ratioDiffCompoundV3_) / uiInfo_.protoInfo.compoundV3.maxRiskRatio;

            uiInfo_.availableEuler = uiInfo_.protoInfo.euler.maxRiskRatio == 0
            ? uiInfo_.protoInfo.euler.stETHCol
            : (uiInfo_.protoInfo.euler.stETHCol * ratioDiffEuler_) / uiInfo_.protoInfo.euler.maxRiskRatio;

            uiInfo_.availableMorphoAaveV2 = uiInfo_.protoInfo.morphoAaveV2.maxRiskRatio == 0
            ? uiInfo_.protoInfo.morphoAaveV2.stETHCol
            : (uiInfo_.protoInfo.morphoAaveV2.stETHCol * ratioDiffmorphoAaveV2_) / uiInfo_.protoInfo.morphoAaveV2.maxRiskRatio;
