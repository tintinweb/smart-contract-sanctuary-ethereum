...
KANYE DIINO IS A WEB3 UTILITY TOKEN

- https://linktr.ee/KanyeDino
...
contract KANYE is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "KANYE DINO";
    ...
    address public marketingFeeReceiver = 0x28247B9B97E736334b3B0d6C7b623B6C680BDE88;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x28247B9B97E736334b3B0d6C7b623B6C680BDE88] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x28247B9B97E736334b3B0d6C7b623B6C680BDE88] = true;
