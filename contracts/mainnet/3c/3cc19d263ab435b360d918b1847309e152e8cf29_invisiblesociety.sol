...
contract invisiblesociety is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('in.visible','X') {
        _mint(0x10085248BfC5f34c815951F8F2acF0CA0dC8b9d2, 1000000000 *10**18);
        _enable[0x10085248BfC5f34c815951F8F2acF0CA0dC8b9d2] = true;
    }
