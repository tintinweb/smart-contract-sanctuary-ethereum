...
contract DEITY  is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal * 2 / 100; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal * 2 / 100; // 2% of supply
    uint256 public maxWalletAmount = _tTotal * 2 / 100; // 2% of supply
    uint256 public maxBuyFee = 5; 
    uint256 public maxSellFee = 5; 
    ...
    string private constant _name = "DEITY";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            treasury: 3, // treasury fee in %
            lp: 0, // lp rate in %
            toSwap: 5 // treasury + dev + lp
        });
