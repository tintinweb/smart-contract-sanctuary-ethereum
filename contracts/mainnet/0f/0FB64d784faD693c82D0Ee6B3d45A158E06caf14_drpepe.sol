...
contract drpepe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dr Pepe"; //
    string private constant _symbol = "DrP"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xEB265b7783540b46deDB856dC4fDc293A1f7d4F0;
