...
contract SWANZILLA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SwanZilla";
    string private constant _symbol = "$SWANZ";
    ...
    address payable private _developmentAddress = payable(0x14D69cE4503F85596fE43B43A4d8D94Bf4A0ba49); 
    address payable private _marketingAddress = payable(0xA715eDf43A11e41A8b0b74725E43CB0134c503D5);
