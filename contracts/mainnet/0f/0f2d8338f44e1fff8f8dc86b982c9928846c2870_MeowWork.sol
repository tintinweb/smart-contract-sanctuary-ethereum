...
// t.me/Meow_work
//   MEOW MEOW MEOW MEOW MEOW MEOW MEOW MEOW MEOW MOON
...
// Main Contract Logic 
// --------------------------------------------------------------
contract MeowWork is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Meow Work";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xb1D062e9367410B932CD64517Ce526f876e9757b);
    address payable public operationsWallet =  payable(0xb1D062e9367410B932CD64517Ce526f876e9757b);
    ...
    uint256 public operationsFeeSell = 30;
