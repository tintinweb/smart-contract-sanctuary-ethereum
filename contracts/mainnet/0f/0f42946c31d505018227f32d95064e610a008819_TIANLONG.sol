// https://medium.com/@theaether/tianlong-the-celestial-dragon-a270e73582a5
// https://t.me/tianlongeth
...
contract TIANLONG is ERC20, Ownable {
    ...
    address payable _marketingWallet =
        payable(address(0xA74Cab53036cc8CF56610b545DB2364767aC545C)); // marketingWallet
    address payable _devWallet =
        payable(address(0x61c6a9708DCcf3E05DF0b53655B7d5B6fed9DdAA)); // devWallet
    ...
    constructor() ERC20("The Celestial Dragon", "TIANLONG") {
        buyFee.marketingFee = 4;
        buyFee.liquidityFee = 1;

        totalBuyFee = 5;

        sellFee.marketingFee = 19;
    ...
    function swapAndSendToMarketing(uint256 tokens) private lockTheSwap {
        ...
        uint256 devShare = newBalance.div(4);
