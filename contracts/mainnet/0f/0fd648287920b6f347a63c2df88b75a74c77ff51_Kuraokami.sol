...
/**
Dragon Tutelary of Water - $KURAOKAMI

Kuraokami (闇龗)  is a legendary Japanese dragon and Shinto deity of ice, rain, snow and winter . In Japanese mythology, the sibling progenitors Izanagi and Izanami gave birth to the islands and gods of Japan. After Izanami died from burns during the childbirth of the fire deity Kagu-tsuchi, Izanagi was enraged and killed his son. Kagutsuchi's blood or body, according to differing versions of the legend, created several other deities, including Kuraokami.
...
contract Kuraokami is ERC20, Ownable {
    ...
    constructor() ERC20("Dragon Tutelary of Water", "KURAOKAMI") {
        ...
        marketingWallet = address(0x02239545EdBe55Cf4431985d4B5F659b521fA1C1); // set as marketing wallet
        devWallet = address(0x02239545EdBe55Cf4431985d4B5F659b521fA1C1); // set as dev wallet
