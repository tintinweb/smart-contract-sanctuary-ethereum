...
// The Bakunawa came into being, one such legend tells the story of how the Bakunawa caused the first eclipse. 
...
contract BAKUNAWA is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BAKUNAWA";
