...
contract THEGAMEOFCHAD is Context, IERC20, Ownable {
    ...
    address private _owner = 0xE66eF5d309Ccb91f46EA49b6274f799bA196B938; //owner of the contract
    ...
    string private constant _name = "CHADNOPOLY";
    string private constant _symbol = "CHADNOPOLY";
    ...
    uint256 public maxAmountCanBuy = 1e9;

    uint256 public _buyTaxFee = 0;
    uint256 public _buyLiquidityFee = 2;
    uint256 public _buyMarketingFee = 2; //4%
    
    uint256 public _sellTaxFee = 0;
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 3; //5%
    
    uint256 public tradingActiveBlock = 0; 
    mapping(address => bool) public boughtEarly; // mapping to track addresses that buy within the first 2 blocks pay a 3x tax for 180 minutes to sell
    ...
    constructor() payable {
        ...
        _maxTransactionAmount = _tTotal * 10 / 1000; // 1% max trx 
        _maxWalletAmount = _tTotal * 30 / 1000; // 3% max Wallet
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05 swap tokens amount
        
        marketingAddress = payable(0xE66eF5d309Ccb91f46EA49b6274f799bA196B938); // Marketing Wallet
        
        devAddress = payable(0xE66eF5d309Ccb91f46EA49b6274f799bA196B938); // TEAM Wallet 
    ...
    function enableTrading() internal onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 180 minutes;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                // higher tax if bought in the same block as trading active for 180 minutes (sniper protect)
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing *  1 / 6;
