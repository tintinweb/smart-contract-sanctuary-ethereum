...
contract RadianceBySlapHA is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 666;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.02 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x450fccd90615356321601542788a28776b5a85862e4ec57e75bab5ce2c9520be;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmU5wCgHUrD6LK8tNofknGojD4z1Aoif2ZwWbobevX5pES";

    constructor() public ERC721A("RadianceBySlapHA", "RADIANCE", 666, 666) {}
