...
contract deVATARS is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x0554796e6F22C3BD40bE8c3Ce5E7B955b9163f27));

    string private _name = "deVATARS";
    string private _symbol = "Devatars";
