...
contract GalacticKatz is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Galactic Katz", "GKZ"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Katz...");
