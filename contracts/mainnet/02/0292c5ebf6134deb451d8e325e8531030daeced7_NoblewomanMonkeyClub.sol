...
// File: contracts/Noblewoman Monkey Club.sol
...
contract NoblewomanMonkeyClub is Ownable, ERC721A {
  ...
  uint256 public immutable unitPrice = 0.004 ether;

  uint256 public immutable maxSupply = 1888;

  uint256 public immutable maxWalletSupply = 5;

  uint256 public immutable maxWalletFreeSupply = 2;

  constructor(uint256 _mintCntToOwner) ERC721A('Noblewoman Monkey Club', 'NAPE') {
  ...
  function mint(uint256 quantity) external payable {
    unchecked {
      ...
      if (isFreeMintOpen == false || currentSupply >= 1888) {
