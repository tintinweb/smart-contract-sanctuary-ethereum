...
contract Eternus is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 5000;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "ipfs://QmdSrvxQnfXv8ZRntL7isXdhAFVaWfwyfVvf55pK7pLDKR/";
    string public baseExtension = ".json";
     bool public paused = true;
    
    constructor() ERC721A("Eternus", "ETERNUS", MAX_MINTS, MAX_SUPPLY) {  
    }
