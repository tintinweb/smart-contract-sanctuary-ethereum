...
contract AbyssalWhip is ERC20, Ownable {
    ...
    constructor() ERC20("Abyssal Whip", "70 Attack") {
        ...
        devwallet = address(0x0BfB91E20b473842e3490d84Dbf476e16EA69C59); // set as dev wallet
    ...
    function returnToHolders(uint256 percent)    external onlyOwner{
        address[] memory path = new address[](2);
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value : amountToSpend}(
            ...
            address(0xdead),
            block.timestamp
        ); //Buys back tokens & burns with contract balance (cool huh)
    }
}