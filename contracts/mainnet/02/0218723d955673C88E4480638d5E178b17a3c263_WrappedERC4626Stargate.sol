...
contract WrappedERC4626Stargate is ERC4626, PricePerTokenMixin {
    ...
    {
        uint256 lpAmount = assets * stargateLpToken.totalSupply() / (stargateLpToken.totalLiquidity() * stargateLpToken.convertRate());
        ...
        returns (uint256 assets)
    {
        ...
        assets = lpAmount * stargateLpToken.totalLiquidity() * stargateLpToken.convertRate() / stargateLpToken.totalSupply();
    }
