...
contract METADROP is Context, IERC20, Ownable {
    ...
    string private constant _name = "Metadrop";
    string private constant _symbol = "METADROP";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x7715d5376a7aF0633e394A6B75537FF928aDD401); // Marketing Address
        ...
        emit Transfer(address(0x454a6CC8a0891779639Bb72b1A8e5E163567C229), _msgSender(), _tTotal);
    }
