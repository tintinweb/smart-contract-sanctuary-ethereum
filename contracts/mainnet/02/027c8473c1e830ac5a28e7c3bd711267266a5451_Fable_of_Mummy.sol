...
/*
    Welcome to Fable of Mummy

    https://t.me/fableofmummy
    https://t.twitter/fableofmummy
    https://medium.com/@fableofmummy/fable-of-mummy-story-99b68b657140
*/
...
contract Fable_of_Mummy is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Fable of Mummy";
    string private constant _symbol = "$MUMMY";
    ...
    address payable private _developmentAddress = payable(0xb4fA964C739BcCc91468172196127b4d97820Ae4); 
    address payable private _marketingAddress = payable(0xb4fA964C739BcCc91468172196127b4d97820Ae4);
