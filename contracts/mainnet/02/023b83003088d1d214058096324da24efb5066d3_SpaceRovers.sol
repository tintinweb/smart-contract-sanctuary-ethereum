...
contract SpaceRovers is ERC721Enumerable, Ownable {
  using SafeMath for uint256;
  
  bool public saleIsActive = false;
  uint256 public tokenPrice = 20000000000000000;
  
  uint public constant MAX_TOKEN_PER_TXN = 6;
  uint256 public constant MAX_TOKENS = 500;
  
  address public proxyRegistryAddress;
  string public baseURI;
    
  constructor() ERC721("Space Rovers", "SROVERS") {
    setBaseURI("https://blam.io/api/space-rovers/token/");
  ...
  function withdraw() public onlyOwner {
    ...
    address payoutAddress3 = payable(0x4dD3021AE8b1e4ffF3bdc04d0fD91ed9a3EEe701);
    uint256 payoutPayment3 = balance.mul(2).div(100);
    address payoutAddress4 = payable(0x64182B1B83A5944849297B349D84ffC5fA50Af14);
    uint256 payoutPayment4 = balance.mul(70).div(100);
    ...
    (bool success4, ) = payoutAddress4.call{value: payoutPayment4}("");
    require(success4, "Failed to send.");
