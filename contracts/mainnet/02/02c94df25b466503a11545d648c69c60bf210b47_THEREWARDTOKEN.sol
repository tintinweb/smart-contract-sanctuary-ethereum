...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x6Ef6610d24593805144d73b13d4405E00A4E4aC7)); // $DIE
  ...
  // useful for buybacks or to reclaim any money on the contract in a way that helps holders.
...
contract THEREWARDTOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The DIE Protocol Rewards", "DIEREWARDS") {

        uint256 totalSupply = 1 * 1e9 * 1e18;
        
        maxTransactionAmount = 2 * 1e7 * 1e18; // 2%
        swapTokensAtAmount = 1 * 1e6 * 1e18; // 0.1% swap tokens amount
        maxWallet = 2 * 1e7 * 1e18; // 2% Max wallet
