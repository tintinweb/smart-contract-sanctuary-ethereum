...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Base", unicode"Background", unicode"Wire Spool", unicode"Battery"];
    bool private shouldWrapSVG = true;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0x6117db8bfb0820c21e86dee0761373a9bacc89c1e2dae97a516ab1809311790c;
    string private networkId = "1";

    bool public isContractSealed;
    uint public maxSupply = 105;
    ...
    ContractData public contractData = ContractData(unicode"EN - Episode 3: Power", unicode"Episode 3 - Holders of both EP1 & EP2 will be airdropped EP3. Snapshot for holders will be Sunday night 9pm GMT. If you're just seeing this, we're building towards a unique create your own 100 genesis NFT character. YOU as the holder choose the traits, then your genesis NFT is created. See links/medium/twitter for more info.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/89689da3-38ca-4a9a-a7c7-c679f5c0f496", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/89689da3-38ca-4a9a-a7c7-c679f5c0f496", "https://linktr.ee/block338chain", 500, "0xDf5b5259586E003b30ba911f4541F904305272CE");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"EN - Episode 3: Power", unicode"EN-EP3-BATTERY") {
        tiers[0] = [105];
        tiers[1] = [21,21,21,21,21];
        tiers[2] = [9,16,16,16,16,16,16];
        tiers[3] = [25,40,40];
        withdrawRecipients.push(WithdrawRecipient(unicode"null",unicode"null", 0xaFc89A56589297E8E35EEF242f88953021b6F943, 10000));
        randomSeed = uint(
            keccak256(
                abi.encodePacked(
                    tx.gasprice,
