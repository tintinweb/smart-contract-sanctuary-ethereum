...
contract AIHAPE is ERC721A, Ownable, ReentrancyGuard{
    using Strings for uint256;
    ...
    constructor(uint256 price, uint256 maxSupply, string memory baseUri, uint256 freeMintAllowance, uint256 maxMintPerTx, bool isSaleActive, uint256 freeMintIsAllowedUntil) ERC721A("AIHAPE", "AIHape") {
        PRICE = price;
    ...
    address private constant payoutAddress1 = 0xAF2D7911b777bA2eB74F2C4EE7bEe2F00Bf091A9;
