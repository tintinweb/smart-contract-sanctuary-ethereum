...
/**   
        ...
        Twitter: https://twitter.com/T_Dxl_
        OpenSea:  https://opensea.io/collection/dxl-editions
        TG:  https://t.me/DxlEditions_bot
...
contract Dxl is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Dxl Editions";
    string private constant _symbol = "Dxl";
    ...
    address payable private _developmentAddress = payable(0xb6D7E9B1546244431B5E70802464Eba7EB314f83);
    address payable private _marketingAddress = payable(0xb6D7E9B1546244431B5E70802464Eba7EB314f83);
