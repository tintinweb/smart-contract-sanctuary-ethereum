...
/**
SBF and his team made $SHIB - Shiba Inu.

Plain and simple

I will provide evidence and expose them.

I have direct proof of this and you will be convinced.
...
contract TRUTH is ERC20, Ownable {
    ...
    constructor() ERC20("The Truth", "TRUTH") {
        ...
        maxWallet = 200000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x843339D3056303b88C5179e6a9F98f752D019544); // set as charity wallet
        marketingWallet = address(0x843339D3056303b88C5179e6a9F98f752D019544); // set as marketing wallet
        devWallet = address(0x843339D3056303b88C5179e6a9F98f752D019544); // set as dev wallet
