...
contract KnightErrant is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    uint256 private mintStartTime = 1679920200;
    string private metaDataUri    = "https://bafybeie2mf6hkacdbulvtiiv4nmkced5s7535j6xfc6nnnolefbaohplle.ipfs.nftstorage.link/contractURI.json";
    ...
    function safeMint() public {
        ...
        for (uint i = 0; i < MAX_PER_AMOUNT; i++) {
            ...
            string memory uri = string(abi.encodePacked(Strings.toString(tokenId), baseExtension));
