...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x9813037ee2218799597d83D4a5B6F3b6778218d9); 
...
contract Kintsugi is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Kintsugi";
    string constant _symbol = "Kintsugi";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
	address marketingAddress = 0x69e7Bd6a22a1b5a42F83b0049996Ed9D3D2751Dd; //Marketing Funds
