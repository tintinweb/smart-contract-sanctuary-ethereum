...
contract pythagoras is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 33; // 3% of supply
    uint256 public maxTxAmountSell = _tTotal / 33; // 3% of supply
    uint256 public maxWalletAmount = _tTotal / 33; // 3% of supply
    ...
    string private constant _name = "Pythagoras Token";
    string private constant _symbol = "Pythagoras";
    bool private inSwapAndLiquify;

    IUniswapV2Router02 public UniswapV2Router;
    address public uniswapPair;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 5 / 1000; //0.5%
