...
contract MESSI is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard { 
event DevMintEvent(address ownerAddress, uint256 startWith, uint256 amountMinted);
uint256 public devTotal;
    uint256 public _maxSupply = 2022;
    uint256 public _mintPrice = 0.001 ether;
    uint256 public _maxMintPerTx = 20;
 
    uint256 public _maxFreeMintPerAddr = 1;
    uint256 public _maxFreeMintSupply = 222;
     uint256 public devSupply = 20;
    ...
    constructor(string memory initBaseURI) ERC721A("Messi Messi Messi", "MESSI") {
        baseURI = initBaseURI;
    }
