...
/**
NFTGreetings.xyz Presents:
     .->    (`-')  _                               .->     _      (`-').-> (`-').->  _     <-. (`-')_            
 (`(`-')/`) ( OO).-/  <-.      <-.             (`(`-')/`) (_)     ( OO)_   (OO )__  (_)       \( OO) )    .->    
,-`( OO).',(,------.,--. )   ,--. )   (`-')   ,-`( OO).', ,-(`-')(_)--\_) ,--. ,'-' ,-(`-'),--./ ,--/  ,---(`-') 
|  |\  |  | |  .---'|  (`-') |  (`-') ( OO).->|  |\  |  | | ( OO)/    _ / |  | |  | | ( OO)|   \ |  | '  .-(OO ) 
|  | '.|  |(|  '--. |  |OO ) |  |OO )(,------.|  | '.|  | |  |  )\_..`--. |  `-'  | |  |  )|  . '|  |)|  | .-, \ 
|  |.'.|  | |  .--'(|  '__ |(|  '__ | `------'|  |.'.|  |(|  |_/ .-._)   \|  .-.  |(|  |_/ |  |\    | |  | '.(_/ 
...
AI WELL-WISHING RABBITS: ALL OCCASSIONS. Positive wishes are sent with these AI-generated cards featuring rabbits. Sometimes abstract, simple lines, or elaborate -- always including well-wishes for the receiver. MESSAGE: Issued at random with possible messages: (1) Wishing You / Joy, Happiness & Peace, (2) Wishing You / Good Health & Blessings, (3) Wishing You / Good Luck & Fortune, (4) Wishing You / Happiness, Laughter & Positivity, (5) Wishing You / Prosperity & Good Fortune. All rights reserved by NFTGreetings.xzy. Mint at: https://nftgreetings.xyz/ 
*/
...
contract RABBITS is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {

    uint public maxSupply  = 500; 
    uint public mintPrice  = 0.0075 ether; 
    uint public promoPrice = 0.0065 ether;  
    bool public presaleIsLive = false;
    string public provenanceHash;
    uint public reservedNFTs;
    bool public saleIsLive = false;
    uint public transactionLimit = 1; 
