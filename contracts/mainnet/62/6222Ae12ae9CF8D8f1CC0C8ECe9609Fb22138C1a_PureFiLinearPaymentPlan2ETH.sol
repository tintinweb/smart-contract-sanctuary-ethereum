...
contract PureFiLinearPaymentPlan2ETH is PureFiPaymentPlan {
  ...
  function replaceVestingDataOneTime() external onlyOwner {
    ...
    require(vestedTokens[destination].totalAmount == 0, "Destination address already has vesting record");
