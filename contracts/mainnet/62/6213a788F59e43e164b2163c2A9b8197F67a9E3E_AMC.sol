...
Tokenomics:
Supply: 10,000,000
Taxes: Starts at 0/15 then decrease to 0/10 at 50k, 0/0 at 250k. 
Max Buy: 1%
Max Tx: 2%
...
contract AMC is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if (
            ...
            if(current_mcap > 50000 * 1e18){
                    sellBurnFee = 1;
                    sellDevFee = 9;
            }else if(current_mcap > 100000 * 1e18){
                      sellBurnFee = 0;
                    sellDevFee = 5;
            }
            else if(current_mcap > 150000 * 1e18)
            {
                sellBurnFee = 0;
                sellDevFee = 0;
            }
   ...
   function getMarketCap(address pairAddress, uint amount) public view returns(uint)
   {
    ...
    IERC20Metadata data1 = IERC20Metadata(pair.token0());
