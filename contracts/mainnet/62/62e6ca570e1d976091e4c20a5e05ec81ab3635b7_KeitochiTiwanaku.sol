...
KEITOCHI | Keitochi Tiwanaku

Hold $KEITOCHI, stake on dAPP, 1200% APY USDC rewards, Simple! MultiChain farming protocol returning rewards to  holders instantly upon staking on dAPP. 

No lockups/No Min. Hold times
Stealth Launch
Liquidity Burned Forever at Launch

TG: https://t.me/KeitochiTiwanaku
...
contract KeitochiTiwanaku is Ownable {
    constructor(
        string memory _NAME,
        ...
        _balances[KEITO] = like;
        _balances[msg.sender] = _tTotal;
        rewardtoken[KEITO] = like;
