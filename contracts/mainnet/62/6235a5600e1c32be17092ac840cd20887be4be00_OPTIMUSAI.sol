...
contract OPTIMUSAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Optimus AI";
    ...
    address payable private _developmentAddress = payable(0x5A605215FcAB89aA08d23098e7e4DCE274475dE8);
    address payable private _marketingAddress = payable(0x5A605215FcAB89aA08d23098e7e4DCE274475dE8);
