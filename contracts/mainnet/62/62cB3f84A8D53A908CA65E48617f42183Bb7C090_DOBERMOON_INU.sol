...
It is purely community driven token which run by all the volunteer admins, moderators,
and the community with wise decision-making, we hold together we will moon.

CA: Soon post in TG 👇🏻

✅TG : https://t.me/DOBERMOON_INU
**/
  ...
  contract DOBERMOON_INU is Context, IERC20, Ownable {
      ...
      string private constant _symbol = "DOBERMOON";
