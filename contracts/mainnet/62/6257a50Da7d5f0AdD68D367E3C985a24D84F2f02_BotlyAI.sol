...
With Botly{AI}, Ethereum Blockchain investors can easily maximize their chances at maximizing their return on investment with few risks involved.
...
contract BotlyAI is Context, IERC20, Ownable {
    ...
    string private _name = unicode"BOTLY{AI}";
    string private _symbol = unicode"$BOTLY";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xE75CDAA0004eed9a5D7b9Ab602225b787D616d97);
    address payable private taxWallet2 = payable(0xE75CDAA0004eed9a5D7b9Ab602225b787D616d97);
    ...
    uint256 public _sellMarketingFees = 22;
