...
contract DFXSnapshot {
    ...
    IERC20 public constant DFX_AURA_DEPOSIT_VAULT = IERC20(0xdFFC232eD74A25031a3e16C81013Da22AC75806f);
    ...
    function balanceOf(address _voter) public view returns (uint256) {
        ...
        // Balancer LP in Aura deposit Vault
        uint256 blpInAuraVault = DFX_AURA_DEPOSIT_VAULT.balanceOf(_voter);
        ...
        uint256 votePower = getAmountFromSLP(_stakedSlpAmount) + getAmountFromSLP(pool2StakedAmount) + getAmountFromSLP(slpAmount) + getAmountFromBLP(blpAmount + blpInAuraAmount + blpInAuraVault) + bareAmount;
