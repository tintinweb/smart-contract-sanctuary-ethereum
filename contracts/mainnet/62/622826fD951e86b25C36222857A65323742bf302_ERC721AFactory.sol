...
contract ERC721AFactory is Ownable {
    ...
    constructor(address _treasuryAddress, address _launchpassAddress, uint16 _treasuryShare, address[] memory _fiatMinters, address _r2eAddress) {
    ...
    function resetFiatMinters(address[] memory _addresses) external onlyOwner {
        fiatMinters = _addresses;
    }
    ...
    function updateConfig(address _treasuryAddress, address _launchpassAddress, uint16 _treasuryShare, address _r2eAddress) external onlyOwner {
        treasuryShare = _treasuryShare;
        launchpassAddress = _launchpassAddress;
        treasuryAddress = _treasuryAddress;
        r2eAddress = _r2eAddress;
    ...
    function deploy(
        ...
        ERC721AContract nft = new ERC721AContract(_name, _symbol, _uri, payees, shares, msg.sender, r2eAddress, fiatMinters, _provenance, token);
