...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"1/1", unicode"Eyes", unicode"Head", unicode"Nose", unicode"Face", unicode"Mouth", unicode"Neck", unicode"Body", unicode"Background"];
    ...
    ContractData public contractData = ContractData(unicode"The Grimmers", unicode"Weary souls trying to find true happiness in an ocean of cynicism.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/5a2a5db8-5f17-444a-b738-201802e76516", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/5a2a5db8-5f17-444a-b738-201802e76516", "", 1000, "0xE38A7e006aaa0D848587606022Dc72872fA6B5E3");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"The Grimmers", unicode"GRIM") {
        tiers[0] = [1,4999];
        tiers[1] = [0,129,139,165,176,214,229,236,621,665,705,838,883];
        tiers[2] = [0,31,43,68,77,94,126,145,170,180,200,238,298,311,329,340,344,351,364,388,430,473];
        tiers[3] = [0,1000,1000,1000,1000,1000];
        tiers[4] = [0,1000,1000,1500,1500];
        tiers[5] = [0,236,296,373,452,480,501,723,939,1000];
        tiers[6] = [0,226,240,496,637,714,793,914,980];
        tiers[7] = [0,616,967,1540,1877];
        tiers[8] = [5000];
