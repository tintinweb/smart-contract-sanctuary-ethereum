...
contract Monsterdolls is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("Monsterdolls", "Dolls") {
        setBaseURI("");
	...
	require(saleActivated, "Mint: Mint process is pause");
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max MonsterDolls per address exceeded");
        require(_mintAmount > 0, "Cant mint 0 Monsterdolls");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more Monsterdolls" );
        require(s + _mintAmount <= maxSupply, "Cant exceed Monsterdolls supply");
