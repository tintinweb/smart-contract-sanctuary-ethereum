...
contract SheAndMe is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("She and Me", "SM") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmNyQEpYY1dFsyAR9oorSY8Fnk5ppphVhGPj52JxQE1jbw/", _toString(tokenId), ".json"));
    }
