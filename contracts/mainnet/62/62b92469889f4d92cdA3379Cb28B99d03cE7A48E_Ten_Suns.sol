...
"The Ten Suns will set a blazing path, Hou Yi shall take aim"

https://medium.com/@TenSuns/rising-suns-2900e60482ff
...
contract Ten_Suns is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ten Suns", "HOUYI") {
        ...
        lpReceiver = address(owner()); // set as lp receiver
