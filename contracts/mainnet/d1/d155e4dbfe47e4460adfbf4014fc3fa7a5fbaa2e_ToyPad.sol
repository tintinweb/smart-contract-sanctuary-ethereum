...
contract ToyPad is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x03f7724180AA6b939894B5Ca4314783B0b36b329;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Shiba's Toy";
    string constant _symbol = "TOYPAD";
    ...
    address private marketingFeeReceiver = 0xA918c76A49198C0a9D0283379963c273715e835f;
    ...
    constructor (address _address) Ownable(msg.sender) {
        ...
        isFeeExempt[0xA918c76A49198C0a9D0283379963c273715e835f] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xA918c76A49198C0a9D0283379963c273715e835f] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0xA918c76A49198C0a9D0283379963c273715e835f,
                block.timestamp
            );
