...
$NYR
Twitter - https://twitter.com/NYR_ETH
Telegram - https://t.me/NYR_ETH

Being a better person then yesterday, 
that's what New Year Resolution stands for, 
that's what we aim for, that's who we are. 
...
contract NewYearResolution is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"New Year Resolution";
    string private constant _symbol = unicode"NYR";
