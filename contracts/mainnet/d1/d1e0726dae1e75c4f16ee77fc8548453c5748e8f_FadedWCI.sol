...
/*
  Let's be honest, a lot of us faded it... $FWCI comes as a second chance.
  --------------------
  0% tax after 30 buys
...
contract FadedWCI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Faded WCI";
    string private constant _symbol = "FWCI";
    uint256 public _maxTxAmount = 20000 * 10**_decimals;
    uint256 public _maxWalletSize = 30000 * 10**_decimals;
    uint256 public _taxSwap = 15000 * 10**_decimals;
