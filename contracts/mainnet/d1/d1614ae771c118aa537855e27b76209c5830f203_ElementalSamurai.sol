...
// File: ElementalSamurai.sol

pragma solidity ^0.8.13;

contract ElementalSamurai is ERC721A, Ownable, DefaultOperatorFilterer {
  ...
  string public baseURI = "https://nftstorage.link/ipfs/bafybeidd4doe6xp43ei6zoahtfneofxdkt74w64dfbogzfmx7rcz6miihe/";

  uint256 public price = 0.001 ether;
  uint256 public constant MAX_SUPPLY = 333;
  uint256 public max_per_txn = 5;

  address public constant DEV_ADDRESS = 0xD07DB9ae51b021c9D65fb106BD547837c106263d;  
  address public constant PROJECT_ADDRESS = 0x6D12F310C4E82Ee9F8a069EF671D431A4e5C06E7;  

  bool public saleActive = false;

  mapping(address => bool) hasMinted;

  constructor() ERC721A("Elemental Samurai", "ElementalSamurai") payable {
    _mint(msg.sender, 1);
  }
