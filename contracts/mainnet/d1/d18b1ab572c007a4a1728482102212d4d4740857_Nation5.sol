...
contract Nation5 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nation5";
    string private constant _symbol = unicode"Nation5";
