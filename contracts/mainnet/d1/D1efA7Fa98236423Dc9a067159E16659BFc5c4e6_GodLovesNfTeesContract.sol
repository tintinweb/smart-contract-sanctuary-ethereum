...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xb3205B1E74042288d633a79806AfF73Cc4eF4a33];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 5500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmVTuf8VqSjJ6ma6ykTJiuVtvAY9CHJiJnXsgSMf5rBRtZ/";
...
// File: contracts/GodLovesNfTeesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GodLovesNfTeesContract is RamppERC721A {
    constructor() RamppERC721A("God Loves NFTees", "GLN"){}
}
