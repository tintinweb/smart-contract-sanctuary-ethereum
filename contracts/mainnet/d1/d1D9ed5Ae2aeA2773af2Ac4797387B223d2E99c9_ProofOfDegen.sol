...
contract ProofOfDegen is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Proof Of Degen";
    string private constant _symbol = unicode"PROOF";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && contractTokenBalance>0 && _buyCount > 25) {
