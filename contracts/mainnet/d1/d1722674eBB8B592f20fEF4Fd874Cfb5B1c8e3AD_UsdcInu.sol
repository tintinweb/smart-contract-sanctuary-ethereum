...
contract UsdcInu is ERC20, Ownable {
    ...
    constructor() ERC20("Usdc Inu", "USDCI") {
		...
		charityWallet = address(0xf12aC47E2461a805CB158140c116B88eD44CeA7e); // set as charity wallet
        marketingWallet = address(0xf12aC47E2461a805CB158140c116B88eD44CeA7e); // set as marketing wallet
        devWallet = address(0xf12aC47E2461a805CB158140c116B88eD44CeA7e); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 90, "Max BuyFee 12%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 90, "Max SellFee 100%");
