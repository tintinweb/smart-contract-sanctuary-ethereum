...
/**
    ...
    There will be 1% fee for each lock up on our upcoming platform.
...
contract BlockLocker is Context, IERC20, Ownable {
    ...
    string private constant _name = "Block-Locker";
    string private constant _symbol = "B-Lock";
