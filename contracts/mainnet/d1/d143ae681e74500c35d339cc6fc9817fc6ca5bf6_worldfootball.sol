...
contract worldfootball is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "World Football";
    string private constant _symbol = "WOFO";
    ...
    address payable private _marketingAddress = payable(0x71BB683C88939956e21A39C307d50855F3A25823);
