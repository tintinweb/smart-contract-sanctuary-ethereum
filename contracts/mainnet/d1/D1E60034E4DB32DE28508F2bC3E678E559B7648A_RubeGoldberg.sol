...
contract RubeGoldberg is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fractal of Rube Goldberg machines";
    string private constant _symbol = "Rube Goldberg";
