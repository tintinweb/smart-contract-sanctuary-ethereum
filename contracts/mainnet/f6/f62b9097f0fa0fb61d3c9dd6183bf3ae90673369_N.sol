...
contract N is ERC20, Ownable {
    ...
    constructor() ERC20("$N", "$N") {
     ...
     uint256 totalSupply = 5 * 10 ** 6 * 10 ** decimals();
 
        maxTransactionAmount = 10 * 10 ** 4 * 10 ** decimals(); 
        maxWallet = 10 * 10 ** 4 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0x3149aF5a6bf7b9E822e435FeCe2346E848dA6c8B); // set as Marketing wallet
        DevWallet = address(0x3149aF5a6bf7b9E822e435FeCe2346E848dA6c8B); // set as dev wallet
