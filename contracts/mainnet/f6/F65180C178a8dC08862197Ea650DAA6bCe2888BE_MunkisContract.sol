...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x9227c153Bd23f303aD9153940BA4857fC0146058];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 7, 1515 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmcKmjAvA3G5svqiwMQ52FPWWyqCtjbmyQ9f9CWKuhpTBp/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1515");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1515");
...
// File: contracts/MunkisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MunkisContract is RamppERC721A {
    constructor() RamppERC721A("Munkis", "MKS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/SsqGigA3Gfy8lV8Iqb35/contract-metadata";
    }
}
