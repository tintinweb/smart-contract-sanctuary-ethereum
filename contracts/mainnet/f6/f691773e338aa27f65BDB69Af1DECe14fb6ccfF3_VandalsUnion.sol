...
contract VandalsUnion is MinteebleERC721A, DefaultOperatorFilterer {
    constructor(
...
contract MinteebleERC721A is MinteeblePartialERC721, ERC721A, ReentrancyGuard {
    ...
    uint256 public maxWhitelistMintAmountPerTrx = 8;
...
abstract contract MinteeblePartialERC721 is Ownable {
    ...
    uint256 public maxMintAmountPerTrx = 8;
    uint256 public maxMintAmountPerAddress = 1509;
