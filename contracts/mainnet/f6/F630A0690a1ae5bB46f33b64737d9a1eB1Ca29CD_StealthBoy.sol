...
contract StealthBoy is Context, IERC20, Ownable {
    ...
    string private constant _name = "StealthBoy"; // 
    string private constant _symbol = unicode"STEALTH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _MarketingWallet = 0x0b2aDC09Fb92a0d53977F512F7FA1df2d07b7dCe;
