...
/** 
 * Alien Inu - $ALIEN Relaunch
 * Medium:  https://medium.com/@alieninu345/d1a9b15a6cef <------READ IT!!!!!!!
 * Website: https://alieninu.webflow.io/ 
 * Website reclaimed from original dev. Updated website up in 2-3h
 * TG: https://t.me/AlienInuERC20
 * Twitter: https://twitter.com/inu_alien
 *
 * ⍙⟒ ⏃⍀⟒ ☊⍜⋔⟟⋏☌ ⏁⊑⟒ ⏁⟟⋔⟒ ⟟⌇ ⋏⟒⏃⍀
 * 
...
contract AlienInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x6a07Eab9C9b2b82655cBb578b2CC90de62dC0934);
    address payable private _marketingAddress = payable(0x6a07Eab9C9b2b82655cBb578b2CC90de62dC0934);
