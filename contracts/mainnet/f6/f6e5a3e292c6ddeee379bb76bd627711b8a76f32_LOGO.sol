...
/**
Can you name them just by their logo?
It's hard to remember, indeed.
...
contract LOGO is Context, IERC20, Ownable {
    ...
    string private constant _name = "LOGO";
    string private constant _symbol = "LOGO ";
