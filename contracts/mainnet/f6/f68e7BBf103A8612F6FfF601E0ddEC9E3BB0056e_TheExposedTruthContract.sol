...
//    | $$   | $$  | $$| $$_____/      | $$        >$$  $$ | $$  | $$| $$  | $$ \____  $$| $$_____/| $$  | $$         | $$| $$      | $$  | $$  | $$ /$$| $$  | $$
//    | $$   | $$  | $$|  $$$$$$$      | $$$$$$$$ /$$/\  $$| $$$$$$$/|  $$$$$$/ /$$$$$$$/|  $$$$$$$|  $$$$$$$         | $$| $$      |  $$$$$$/  |  $$$$/| $$  | $$
//    |__/   |__/  |__/ \_______/      |________/|__/  \__/| $$____/  \______/ |_______/  \_______/ \_______/         |__/|__/       \______/    \___/  |__/  |__/
//                                                         | $$                                                                                                   
//                                                         | $$                                                                                                   
//                                                         |__/                                                                                                   
//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xEf71987B683D1ce5116B6c2D1376550b9291ef99];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigvv74zx45r6etd2mvq6vkpuyhquyyk3vpaykpzghjfu65fxcxjdy/";
...
// File: contracts/TheExposedTruthContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheExposedTruthContract is RamppERC721A {
    constructor() RamppERC721A("The Exposed Truth", "TRUTH"){}
}
