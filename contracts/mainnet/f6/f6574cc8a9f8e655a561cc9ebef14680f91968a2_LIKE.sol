...
████████████████████████████████████████
Like, buy, and shill
https://t.me/LikeETH - giving admin to the first person that joins and then leaving group
...
contract LIKE is ERC20, Auth {
    ...
    string public constant name = "Like";
    string public constant symbol = unicode"👍";
    uint8 public constant decimals = 4;
    uint256 public constant totalSupply = 10 * 10**9 * 10**decimals;

    uint256 public _maxTxAmount = 5 * totalSupply / 100;
    uint256 public _maxWalletToken = 5 * totalSupply / 100;
