...
// ----------------------------------------------------------------------------
// 'MAD APE ETH' token AND staking contract
...
// token transfers
// ----------------------------------------------------------------------------
contract MAE is IERC20, Owned {
    using SafeMath for uint256;
   
    string public symbol = "MAE";
    string public  name = "MAD APE ETH";
    uint256 public decimals = 18;
    address airdropContract;
    uint256 _totalSupply = 1000000000 * 10 ** (18); // 1,000,000
    ...
    constructor(address owner) public {
        ...
        balances[address(owner)] =   1000000000  * 10 ** (18); // 1,000,000
    ...
    function STAKE(uint256 _tokens) external returns(bool){
        ...
        // gets MAE tokens from user to contract address
