...
yoSDaq ghoS vIQoy'chu'moH. DeSvel vIghoSbe' jIH. yInmeH jIghoS yInmeH, veqlargh DaneHchugh
...
contract MajPo is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Maj Po", "MAJPO", maxBatchSize_, collectionSize_) {
