...
contract Bearistaverse is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{

    //Contract URI
    string public CONTRACT_URI = "ipfs://QmbAb5BTmhXqNtpStzW91HiEFywJRgyq5mVNp5G6UNb5dQ";

    mapping(address => bool) public userHasMinted;
    bool public REVEALED;
    string public UNREVEALED_URI = "ipfs://QmP5gMChVAHEdnRFtjypZ5j39rQMXsW2Am6jLPwWiYRLzm";
    string public BASE_URI;
    bool public isPublicMintEnabled = false;
    uint public COLLECTION_SIZE = 10000;
    uint public MINT_PRICE = 0.0 ether;
    uint public MAX_BATCH_SIZE = 3;


    constructor() ERC721A("Bearistaverse", "BEARISTAVERSE") {}
        ...
        nonReentrant
    {
        ...
        require(!userHasMinted[msg.sender], "Can only mint once");
