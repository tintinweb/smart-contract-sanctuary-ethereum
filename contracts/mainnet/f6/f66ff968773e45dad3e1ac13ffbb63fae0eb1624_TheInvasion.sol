...
contract TheInvasion is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmYddfFTudNDkvmUwY3HTE7VdwF2qhiRw8yRMDJ2AnEzF5/";
    ...
    constructor(string memory initBaseURI) ERC721A("TheInvasion", "IN") {
        baseURI = initBaseURI;
