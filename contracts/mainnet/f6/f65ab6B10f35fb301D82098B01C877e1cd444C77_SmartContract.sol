...
𝔹𝕚𝕠C𝕙𝕒𝕚𝕟 𝔹𝕣𝕚𝕕𝕘𝕖 is a decentralized cross chain bridge allowing users to securely
move cryptoccurencies to the various blockchain. BioChain will be the 
most leading cross chain bridge
on the network.

name: 𝔹𝕚𝕠C𝕙𝕒𝕚𝕟 𝔹𝕣𝕚𝕕𝕘𝕖
symbol: 𝗕𝗶𝗼𝗖𝗵𝗮𝗶𝗻
supply: 1B
...
buy - 4% LP supply
sell - 6% marketing wallet (exchange website, DAPP, Development, CMC listing etc.)

𝗥𝗼𝗮𝗱 𝗠𝗮𝗽
Q2 2022 - Design / Develop / Discus
Q3 2022 - Deploy / Website / DAPP
Q4 2022 - Listing / Advertise / Fully Deploy BioChain
Q1 2023 - BioChain (Blockchain)

Telegram: https://t.me/BioChainERC20
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "BioChain Bridge";
    string private constant _symbol = "BioChain";
    uint8 private constant _decimals = 9;

    uint256 public buyAutoLiquidityFee = 400;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x38313249d091A11E11fD9e20cAB59009e4393E04); 
        ...
        uint256 _buyAutoLiquidityFee = 400;
