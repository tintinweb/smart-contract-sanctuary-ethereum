...
TSUKA BONK - TSUBO
TSUBO will become a Meme's of the Year, home of MemeTech, Missed out on TSUKA? Bonk it!
https://tsukabonk.org
https://tsukabonk.medium.com
https://twitter.com/TsukaBonkERC
https://t.me/TsukaBonkERC
*/
...
contract TSUKABONK is Context, IERC20, Ownable {
    ...
    string private constant _name = "TSUKA BONK";
    string private constant _symbol = "TSUBO";
    ...
    function setBuyTaxes(uint256 liquidityFees, uint256 marketingFees) public onlyOwner {
        buyFee.liquidity = liquidityFees;
        buyFee.marketing = marketingFees;
    }

    function setSellTaxes(uint256 liquidityFees, uint256 marketingFees) public onlyOwner {
