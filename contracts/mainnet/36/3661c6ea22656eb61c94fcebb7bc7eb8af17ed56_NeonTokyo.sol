...
contract NeonTokyo is Ownable, ERC721A {
    ...
    address constant internal Owner = 0xa780e5F7E4bbF5130E18251F6bE90DE5ddC69fBA;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("Neon Tokyo", "NEOTKYO") { }
