  ...
  ReentrancyGuard
{
  ...
  uint256[] private teamShares_ = [295,295,25,65,70,250];

address[] private team_ = [
    0x06A30395353D7d3742E49Bf69fD25fDf69A131c8,
    0x49BB5e19F3FFb6e166c6eBb988d3a7E0AaDbFe04,
    0x1042587422FcF2B101Afa52A565A0f525785E724,
    0x3B89C0C14f91Fe414423ACcf04fdbbfDB9A0CB5f,
    0xD7E39C749A9c34bff1Dac37b4681B9636F87Ff9A,
    0x2B11dbB668eD975a566B3F27603CC0a28ba49cFE
  ];
  ...
  ) ERC721("Digital Art Bridge", "DAB") PaymentSplitter(team_, teamShares_) {
    ...
    whenNotPaused
  {
    ...
    require(
      WHITELIST >= privateRedeemedCount + amount,
    ...
    whenNotPaused
  {
    ...
    require(
      alreadyRedeemed + amount <= maxAmount,
      "You can't mint more than 5 tokens!"
    );
