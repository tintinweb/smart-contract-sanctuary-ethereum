...
// SPDX-License-Identifier: MIT
// OpenZeppelin Contracts (last updated v4.5.0) (./ERC721.sol)
 ...
 * {ERC721Enumerable}.
 */
contract CMTNERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     * Emits a {Transfer} event.
     */
    function _safeMint(address to, uint256[20] memory tokenIds) internal virtual {
        require(tokenIds.length > 0, "ERC721: quantity must be 1 - 20");
     ...
     */
    function _mint(address to, uint256[20] memory tokenIds) internal {
        require(to != address(0), "Mintable: mint to the zero address");
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            require(!_exists(tokenIds[i]), "Mintable: token already minted");
            ...
            _afterTokenTransfer(address(0), to, tokenIds[i]);
        }
        _balances[to] += count;
    }
