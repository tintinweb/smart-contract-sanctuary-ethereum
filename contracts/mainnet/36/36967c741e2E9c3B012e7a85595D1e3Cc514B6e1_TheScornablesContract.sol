...
//  /_  __/ /_  ___     / ___/_________  _________  ____ _/ /_  / /__  _____
//   / / / __ \/ _ \    \__ \/ ___/ __ \/ ___/ __ \/ __ `/ __ \/ / _ \/ ___/
//  / / / / / /  __/   ___/ / /__/ /_/ / /  / / / / /_/ / /_/ / /  __(__  ) 
// /_/ /_/ /_/\___/   /____/\___/\____/_/  /_/ /_/\__,_/_.___/_/\___/____/  
//                                                                          
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1663279140;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1663275540;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5B67b5d2D0B4E48A2694b4e5989976385058faEa,0xEC14c11c573bBDA3DE569a1B72b0914ACE91BF4F];
  ...
  uint256[] public payableFees = [0,20,80];
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintOwnershipCap = 7000;
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 7000) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifmeelmu2cggfflz2thcu5c3673xwy7fjjgmifddijx4rom37co44/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 7000");
...
// File: contracts/TheScornablesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheScornablesContract is RamppERC721A {
    constructor() RamppERC721A("The Scornables", "SCOR"){}
}