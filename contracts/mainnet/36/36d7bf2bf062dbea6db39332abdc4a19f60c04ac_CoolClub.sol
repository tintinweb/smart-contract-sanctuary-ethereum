...
contract CoolClub is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor () ERC721A("The Cool Club", "COOL") {
        _safeMint(msg.sender, 100);
    }
    
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return string(abi.encodePacked("https://mnt.thecool.club/metadata/", tokenId.toString(), ".json"));
    }   
    ...
    function whitelistMint(bytes32 [] calldata _merkleProof, uint64 _quantity) external payable nonReentrant {
