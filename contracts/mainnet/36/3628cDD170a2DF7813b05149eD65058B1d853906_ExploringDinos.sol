// SPDX-License-Identifier: MIT
    ...
    contract ExploringDinos is Ownable, ERC721A, ReentrancyGuard {
        string public notRevealedUri;   
        string public baseExtension = ".json";
        
        uint256 public immutable MAX_SUPPLY = 5555;
        uint256 public PRICE = 0.0555 ether;
        uint256 public PRESALE_PRICE = 0.3 ether;
        uint256 public maxPresale = 555;
        ...
        uint256 public maxpublicsaleMintAmount = 3;
