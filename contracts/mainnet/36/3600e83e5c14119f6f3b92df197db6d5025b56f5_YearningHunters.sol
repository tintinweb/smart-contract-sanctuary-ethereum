...
contract YearningHunters is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmUk8H5MFbrpk8JSnVtWeHLSPKvpG33w1pktHZ7H79Fdon";
  ...
  ) ERC721A("Yearning Hunters", "Yearning Hunters") {
