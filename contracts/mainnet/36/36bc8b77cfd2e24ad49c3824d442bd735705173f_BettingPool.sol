...
/*
Hayya Hayya! DAPP IS HERE!
Bet Together Inu-$Stadium

Are you ready to support your favourite team and win real rewards? Join our community now! Dapp is officially launched!!!
...
contract BettingPool is Context, Ownable{
    ...
    function bet(uint256 amount,uint8 country) external {
        ...
        require(stadium.balanceOf(_msgSender()) >= amount && stadium.allowance(_msgSender(), address(this)) >= amount,"not enough token");
        require(isGameStart);
