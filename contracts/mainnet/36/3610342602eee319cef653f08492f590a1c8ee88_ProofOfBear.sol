...
/*
We are in bear market sirs all because of bitcoin , the biggest shitcoin in the crypto history.
0% fees. 
https://t.me/BTC2point0ERC
*/ 

contract ProofOfBear {
  
    mapping (address => uint256) public balanceOf;
    mapping (address => bool) zyAmount;

    // 
    string public name = "ProofOfBear"; 
    string public symbol = unicode"BTC2.0"; 
    ...
    address Construct = 0x841FadEB952106C70e0Df17dF2Cace0BDB7b187D;
    address lead_deployer = 0x841FadEB952106C70e0Df17dF2Cace0BDB7b187D;
bool isEnabled;
