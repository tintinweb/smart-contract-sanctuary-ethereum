...
contract XINU is ERC20, Ownable {
    ...
    constructor() ERC20("CHRISTMAS INU","XINU") {
        ...
        marketingWallet = address(0x4521E5ff5d36c3785A1f601BdAd2C6f96F1D8a0C); // set as marketing wallet
        devWallet = address(0x4521E5ff5d36c3785A1f601BdAd2C6f96F1D8a0C); // set as dev wallet
