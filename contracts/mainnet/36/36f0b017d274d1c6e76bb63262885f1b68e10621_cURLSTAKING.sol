...
contract cURLSTAKING is Auth, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() Auth(msg.sender) {
        stakingcURL = IERC20(0x24F3563650d124675a6b0fD13510f554d8BB306d);
        rewardPerBlock = 100000;
        startBlock = block.number;
        bonusEndBlock = 99999999;

        poolInfo.push(PoolInfo({
            stakedToken: stakingcURL,
            allocPoint: 10000,
            lastRewardBlock: 9999999,
