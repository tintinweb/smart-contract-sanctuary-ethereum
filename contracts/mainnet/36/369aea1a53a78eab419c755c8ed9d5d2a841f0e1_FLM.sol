...
contract FLM is ERC20, Ownable {
    ...
    uint256 public liquidityShare = 600;
    ...
    event SharesUpdated(uint256 liquidityShare, uint256 marketingShare, uint256 burnShare);
    ...
    constructor(address marketing) ERC20("Frog Lives Matter", "FLM") {
    ...
    function setShares(
        ...
        emit SharesUpdated (liquidityShare, marketingShare,burnShare);
