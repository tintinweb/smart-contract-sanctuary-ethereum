...
contract DELTABIRDS is ERC721A, Ownable {
    ...
    string public unrevealedTokenURI =
        "https://gateway.pinata.cloud/ipfs/QmZjkvMQUsAgKsGzN7daP6umL5fSt6sNn1EfzLLzUfLdWS";
    string public baseURI = "";

    mapping(uint256 => string) private _tokenURIs;

    address private _ownerWallet = 0x0b05A393E31F186b08ec4C37cdF3E5DC1bb2F50C;

    constructor( ) ERC721A("deltabirdswtf", "DELTABIRD") {
    }
