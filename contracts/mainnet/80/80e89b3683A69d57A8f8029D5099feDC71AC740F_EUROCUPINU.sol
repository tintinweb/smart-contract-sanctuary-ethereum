...
contract EUROCUPINU is ERC20, Ownable {
    ...
    constructor() ERC20("Euro Cup Inu", "ECI") {
        ...
        marketingWallet = address(0x142C8541530656b6daCe6d78Af4d0Da71420Bc2D); // set as marketing wallet
        devWallet = address(0x142C8541530656b6daCe6d78Af4d0Da71420Bc2D); // set as dev wallet
