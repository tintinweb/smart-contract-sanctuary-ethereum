...
contract Migrate is IERC721Receiver{
    ...
    function addPair(string memory tokenName, address tokenAddrV2) public onlyOwner{
...
contract Staking is Migrate{
    ...
    function stake(
        ...
        address tokenAddr = getPair(_tokenName);
        emit staked(
                msg.sender,
                _sum,
                count,
    ...
    function claimFund(uint32 _txID) external {
        ...
        delete timeTokenLock[msg.sender][_txID];
