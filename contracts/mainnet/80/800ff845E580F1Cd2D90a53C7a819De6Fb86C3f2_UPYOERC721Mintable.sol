...
contract UPYOERC721Mintable is ERC721Base {
    ...
    function setMintingCharge(uint256 _mintingCharge) public onlyOwner {
        mintingCharge = _mintingCharge;
    }

    // Method to set minting charges per NFT
    function setBroker(address payable _broker) public onlyOwner {
       broker = _broker;
    }
    ...
    function lazyMint(
        ...
        broker.transfer(msg.value - price);
    }
}