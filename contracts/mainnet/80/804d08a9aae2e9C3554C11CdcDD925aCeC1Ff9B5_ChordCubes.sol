...
contract ChordCubes is ERC721A {
    ...
    constructor() ERC721A("Chord Cubes", "CC") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeifpq3hkhptt22sxc3fci6j4zwq4ku5eacvopck5mboncmv4kenvjm/", _toString(tokenId), ".json"));
    }
