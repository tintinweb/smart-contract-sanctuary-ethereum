...
contract FKIT is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "FUCK IT";
    string private constant _symbol = "FKIT";
    ...
    address payable private _developmentAddress = payable(0xc158f6Ac5f2c150C3Cd145b39E37661ca977AC8B); 
    address payable private _marketingAddress = payable(0xc158f6Ac5f2c150C3Cd145b39E37661ca977AC8B);
