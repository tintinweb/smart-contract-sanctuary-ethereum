...
contract Ethplus is Ownable, IERC20 {
    ...
    constructor(){
        address _marketingWallet = address(0xA5feA96E7548C829B2113f516A793141EDBE1ba2);
        address _liquidityWallet = address(0xA5feA96E7548C829B2113f516A793141EDBE1ba2);
    ...
    function setMaxTxWallet(uint256 bps) external onlyOwner {
