...
// --
//
// A project built with https://rampp.xyz so people can use their $PEOPLE tokens
// from https://www.constitutiondao.com to get an NFT to showcase on-chain.
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x5E630b3537fa6B5a5118DF26D6F38E5008dCd7C0];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x5E630b3537fa6B5a5118DF26D6F38E5008dCd7C0;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 1787) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiapo65gun2zjm3r5634bpp2dczptrhq36tobtc4hk2zavzhv5vgra/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1787");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1787");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1787");
...
// File: contracts/TheConstitutionalConventionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheConstitutionalConventionContract is RamppERC721A {
    constructor() RamppERC721A("The Constitutional Convention", "USA"){}
}
