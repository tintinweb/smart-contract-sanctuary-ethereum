...
contract SinceEve is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 0.07 ether;
    ...
    function mint() external payable {
        if (totalSupply + 1 > 992) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmVk1kBvKwt93vsUc1jWWmcbw8FpxLftiNCRM3ZqhFwkdc/",
