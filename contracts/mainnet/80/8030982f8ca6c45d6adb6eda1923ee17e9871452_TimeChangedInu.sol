...
contract TimeChangedInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Time Changed Inu";
    string private constant _symbol = "CHANGED";
