...
import "./PricyArtTradablePrivate.sol";

contract PricyArtFactoryPrivate is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new PricyArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        PricyArtTradablePrivate nft = new PricyArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
...
/**
 * @title PricyArtTradablePrivate
 * PricyArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract PricyArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    {
        // Whitelist Pricy marketplace contracts for easy trading.
