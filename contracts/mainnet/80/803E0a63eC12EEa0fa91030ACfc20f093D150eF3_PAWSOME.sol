...
Website: https://pawsome.live/

Telegram: https://t.me/pawsomeeth
...
contract PAWSOME is ERC20, Ownable{
    ...
    address public marketingWallet = 0x45a40b5Afb1fF3a21d136e6169287d7CEb81b399;
    address public devWallet = 0x45a40b5Afb1fF3a21d136e6169287d7CEb81b399;
    ...
    function readyPAWS(uint256 numOfDeadBlocks) external onlyOwner{
    ...
    function tB(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function tS(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
