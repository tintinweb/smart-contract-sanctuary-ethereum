...
contract Zods is ERC721A, Ownable{
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 1234;
    uint256 public GENERAL_PRICE = .01 ether;
    ...
    function setGENERAL_PRICE(uint256 _newGENERAL_PRICE) public onlyOwner {
        GENERAL_PRICE = _newGENERAL_PRICE;
    }
