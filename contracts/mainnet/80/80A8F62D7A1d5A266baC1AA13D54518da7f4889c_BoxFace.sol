...
contract BoxFace is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("BoxFace by Charlie", "BoxFace") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmUTRw2Wq8VSqW2cNFPChFtTyr8ryE2Q9Zfq6RSA2mZTFx/", _toString(tokenId), ".json"));
    }
