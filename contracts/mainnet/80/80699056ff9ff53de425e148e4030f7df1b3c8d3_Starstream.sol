...
contract Starstream is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Starstream Tech", "STARSTREAM") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x2C8b4c6e686D5dbC03faF796e7005Aa521cDc06A); // set as marketing wallet
        devWallet = address(0xFE6287023F568c6C211906CA1EeA5EB071532103); // set as dev wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x2C8b4c6e686D5dbC03faF796e7005Aa521cDc06A), true);
        excludeFromFees(address(0xFE6287023F568c6C211906CA1EeA5EB071532103), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x2C8b4c6e686D5dbC03faF796e7005Aa521cDc06A), true);
        excludeFromMaxTransaction(address(0xFE6287023F568c6C211906CA1EeA5EB071532103), true);
