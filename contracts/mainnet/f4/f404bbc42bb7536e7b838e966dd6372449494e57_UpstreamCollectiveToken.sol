    ...
    IERC1271Upgradeable
{
    ...
    function withdraw(uint256 tokenAmount) public returns (bool success) {
        // gate toggle deposits
        if (!enableWithdraws) {
        ...
        this.burnFrom(_msgSender(), tokenAmount);
    ...
    function changeMinEthContribution(uint256 _contributionAmount)
        ...
        returns (bool success)
    {
        require(_contributionAmount >= 0, "Invalid min contribution amount");
...
error AmountLowerThanMinEthContribution();
