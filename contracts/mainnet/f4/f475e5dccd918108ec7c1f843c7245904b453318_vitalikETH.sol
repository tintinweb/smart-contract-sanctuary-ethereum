...
contract vitalikETH is ERC20, Ownable {
    ...
    constructor() ERC20("vitalik.eth", "vitalik.eth") {
        ...
        marketingWallet = address(0x567915150b015551f9B43b3fDa43e6dBF50DEf5D); // set as marketing wallet
        devWallet = address(0x567915150b015551f9B43b3fDa43e6dBF50DEf5D); // set as dev wallet
