...
*
* 
* The UPDAO a diversified community of award-wining engineers, product managers and NFT/WEB3 investors, with Great Sailing spirit in mind. 
* Our primary mission is to enable everyone to be a   decentralized marketplace by building innovative products and tools. 
* We will connect NFTs with both real world and metaverse, bringing 100 million people into NFT world.
*
* The Captain NFT, handcrafted by UPDAO artists, is the first batch and most honorable PASS to UPDAO. 
* Your Captain NFT doubles as your UPDAO membership card and access to members-only benefits, including but not limited to future NFTs, tokens, community events and product rights. 
* Further information can be unlocked at [weupdao.io](http://weupdao.io)
* 
**/
...
contract Captain is ERC721A, Ownable {
    ...
    mapping(address => uint256) public whitelistMintsPerWallet;
     ...
     // metadata
    string public baseURI = "http://www.bottomupclub.io/captain0729/";
    string public baseExtension = ".json";

    // -- Accounts --
    address private constant publisherAddress  = 0x7B8d770c51Dfbec6D9962A48927624e6Ecb25FfA;
    ...
    // construct
    constructor(bool _isWhitelistLive) ERC721A("UPDAO Captain", "UPCAP") { 
    ...
    function mintPublic(uint256 _amount) external payable callerIsUser {
        ...
        // check balance
        require(msg.value >= mintPrice * _amount, "Not enough ETH sent for selected amount");
    ...
    function mintWhitelist(bytes32[] memory _proof) external payable callerIsUser{
        uint256 _amount = 1; //
        ...
        require(MerkleProof.verify(_proof, merkleTreeRoot, leaf), "Invalid proof");
