...
contract Goatreum is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Goatreum";
    string private constant _symbol = "GOATER";
    ...
    address payable private _developmentAddress = payable(0x03abFd20a69Ae22B750fB7E01feB13d9Ea8998C0);
    address payable private _marketingAddress = payable(0xfE733df8640558B1B7cdbCa3ED98c10749B4c42b);
