...
contract Mechaverse is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4600;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "ipfs://QmVSAy8prxGTaRA1z56WZ7cbEACBEaZvGfbKQQUwy6j1cR/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("The Mechaverse", "MCHAVERSE", MAX_MINTS, MAX_SUPPLY) {  
    }
