...
contract FF6010 is Ownable, ERC721A, ReentrancyGuard, ERC721ABurnable, DefaultOperatorFilterer{
...
uint public COLLECTION_SIZE = 8997;
...
constructor() ERC721A("FF6010", "FF6010") {}
        ...
        nonReentrant
    {
        ...
        require(isPublicMintEnabled, "FF6010 not ready yet!");
        require(totalSupply() + quantity <= COLLECTION_SIZE, "No more FF6010!");

        require(balanceOf(msg.sender) + quantity <= SUPPLY_PER_WALLET, "Tried to total mint FF6010 per wallet over limit");

        require(quantity <= MAX_BATCH_SIZE, "Tried to mint FF6010 over limit, retry with reduced quantity");
