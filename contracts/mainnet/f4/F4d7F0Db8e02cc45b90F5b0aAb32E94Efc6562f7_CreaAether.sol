...
contract CreaAether is
    ...
    /// @dev set Mint State
    /// @param _claimPass bool
    /// @param _mintPass bool
    /// @param allowList bool
    /// @param publicList bool
    function setMintState(bool _claimPass, bool _mintPass, bool allowList, bool publicList) external onlyOwner {
        isMintPassClaim = _claimPass;
    ...
    function claimWithMintPass(uint256 tokenId, string memory variant) external {
        require(isMintPassClaim, "Mint Pass claim is not active");
    ...
    /// mintPass claim getter
    /// @return bool
    function isMintPassClaimActive() external view returns (bool) {
        return isMintPassClaim;
    }
