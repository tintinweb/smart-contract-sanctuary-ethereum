/**
/** One must have a holistic worldview, encompassing all the issues, what is reality without a vision to see the real truth.
/** all taxes from this project will be used for buybacks and tokens will be burnt.         https://medium.com/@TheView./the-view-5f87d7c7bb5b    
*/     
...
contract EagleEyes is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("EagleEyes", "THEVIEW") {
