...
contract BitFrog is Context, ERC721Tradeable {
  using SafeMath for uint256;
  using SafeMath for int256;
  using Counters for Counters.Counter;

  address payable payableAddress;
  constructor(address _proxyRegistryAddress) ERC721Tradeable("BitFrog", "BFROG", _proxyRegistryAddress) {
    _baseTokenURI = "ipfs://bafybeigqsr7z3eujdgfti6ivd2t7uxgrhhec6u7ojbqyoskpkwvmmxqqey/";
    payableAddress = payable(0x4eD88f15a8c80016Fd1696c25080CBDa73E854f7);
  }
    ...
    function contractURI() public pure returns (string memory) {
      return "https://bafkreie3rdjr2zbnioip2xfm6cpfj44ezqsxa7rotzvlhpt6q4fzzbowdu.ipfs.nftstorage.link";
    }
...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  uint256 internal constant MAX_SUPPLY = 840;
  ...
  uint256 internal MAX_FREE_PER_WALLET = 3;
  uint256 internal PHASE_SWITCH_ON = 100;
