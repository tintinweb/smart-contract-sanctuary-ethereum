...
contract LitElon is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Lit Elon";//
    ...
    address payable private _developmentAddress = payable(0x125f3232184aB526a9Fcd8da26E88542236166e9);//
    address payable private _marketingAddress = payable(0xB665712A198264571d69791f87bDd35F2b41Ad94);//
