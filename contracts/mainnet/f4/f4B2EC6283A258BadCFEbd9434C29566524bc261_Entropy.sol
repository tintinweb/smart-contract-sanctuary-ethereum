...
contract Entropy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Entropy", unicode"ΔS") {
        ...
        marketingWallet = address(0x53cc72746ef467844cF1182485cF5B41AF8E83C6); // set as marketing wallet
        devWallet = address(0x53cc72746ef467844cF1182485cF5B41AF8E83C6); // set as dev wallet
