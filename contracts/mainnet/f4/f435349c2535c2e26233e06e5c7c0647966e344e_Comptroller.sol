...
contract Comptroller {
    ...
    /// @dev Returns the cliend Id for a given Safe address
    ...
    /// @dev Returns the cliend Id for a given primary address
    /// @param _address The address to look up.
    ...
    /// @param clientSafe The client Safe address.
    ...
    ///       If the safe is a Withdraw module, it will also return the withdraw whitelisted address,
    ///       if the module is a DeFi module, it will return the SmartWallet address).
    /// @param primaryAddress The client primary address - the wallet connected to the app.
    ...
    /// @dev Takes a Safe address as input and returns all connected Safes.
