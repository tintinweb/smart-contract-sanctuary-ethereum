...
contract POOCH is ERC20, Ownable {
    ...
    constructor() ERC20("POOCH", "POO") {
		...
		charityWallet = address(0xBDf74e8659Fe58e223e8De4DEc78Ccf1285Db6b5); // 
        marketingWallet = address(0xBDf74e8659Fe58e223e8De4DEc78Ccf1285Db6b5); // Weaponery
        devWallet = address(0xBDf74e8659Fe58e223e8De4DEc78Ccf1285Db6b5); // set as dev wallet
