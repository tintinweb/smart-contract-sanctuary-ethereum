...
contract VoorlichtingVertaald is ERC721A, Ownable {
    ...
    uint256 public freeMintMax = 3333;
    uint256 public price = 0.0025 ether;

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmU82YYXKWT7RAVuCKerYxDZBGjPPFzoBejtuGZCL46JQY/";
    string public constant baseExtension = ".json";

    bool public paused = true;
    error freeMintIsOver();

    constructor() ERC721A("Voorlichting Vertaald", "VVNFT") {}
