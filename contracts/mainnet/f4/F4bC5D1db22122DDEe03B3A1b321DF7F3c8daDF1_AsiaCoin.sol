...
contract AsiaCoin is ERC20, Ownable {
    uint256 public marketingFee = 300; // 3%
    uint256 public rewardsFee = 200; // 2%
    address public marketingWallet = 0x183760F7E2b5a4b0E3e1A97619A9FAB95c9F891e;
    address public rewardsWallet = 0x9C3D249412a2F3042dF1769c4c556B0A98c42397;
    ...
    constructor() ERC20("Asia Coin", "ASIA") {
        ...
        */
        _createTotalSupply(owner(), 1000000000000 * (10**6));
    }
