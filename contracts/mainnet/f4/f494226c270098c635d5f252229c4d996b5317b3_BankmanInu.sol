...
contract BankmanInu is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20("Bankman Inu", "SBF") {
        ...
        maxTransactionAmount = 8_000_000_000 * 1e18;
        maxWallet = 8_000_000_000 * 1e18;
    ...
    function sorrySBF() external onlyOwner {
