...
In Chinese culture, the tiger is the king of the beasts.
According to legend, the tiger's tail would turn white when it reached the age of 500 years.
...
And he appears today. Live long.
*/
...
contract BYAKKO is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x7d62304d9d9F6f8838337a368E15Cd182baE2C55));
