...
contract NTS2Identity is
    ...
    ReentrancyGuardUpgradeable
 {
    ...
    function initialize (
        uint16 boughtIdentityOffset_, address config_, address registry, address subscriptionOrRegistrantToCopy) external initializer
    {
        __ERC721_init("Neo Tokyo: Outer Identities V2", "NEOTOI");
        __ERC2981_init();
    ...
    function getClass(uint256 tokenId) public view returns (string memory) {
        ...
        output = config.getClass(tokenId);
    ...
    function getExpression(uint256 tokenId) public view returns (string memory) {
        ...
        output = config.getExpression(tokenId);
    ...
    function getStrength(uint256 tokenId) public view returns (string memory) {
        ...
        output = config.getStrength(tokenId);
    ...
    function getAttractiveness(uint256 tokenId) public view returns (string memory) {
        ...
        output = config.getAttractiveness(tokenId);
    ...
    function getTechSkill(uint256 tokenId) public view returns (string memory) {
        ...
        output = config.getTechSkill(tokenId);
    ...
    function getAbility(uint256 tokenId) public view returns (string memory) {
        ...
        output = config.getAbility(tokenId);
    ...
    function migrateAsset(address sender, uint256 tokenId) public nonReentrant {
        ...
        IERC721Upgradeable v1Contract = IERC721Upgradeable(config.findComponent(NTComponent.S2_IDENTITY, false));
