...
contract BONKSTASH is Context, IERC20, Ownable {
    ...
    string private constant _name = "BONKSTASH"; //
    string private constant _symbol = unicode"STASH"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x87c9030fEa90efBa012a5A6d9eBb127B79ff9AEA;
