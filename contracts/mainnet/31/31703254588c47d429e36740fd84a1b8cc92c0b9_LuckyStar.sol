...
contract LuckyStar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LuckyStar";
    string private _symbol = "Luck";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x754b663f36C99Fb63b546728A41dAc51476A3461);
    address payable public buybackAddress = payable(0x9165b4B09EDD2bad922dc166daf86943Fa0c0a59);

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public addressDev = 0x06e6DEB89fB6469a5fEccA831Fb403EDFe1049E1;
    ...
    uint256 public _BuybackShare = 16;
    ...
    function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newBuybackTax) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBBuyback > 0)
            transferToAddressETH(buybackAddress, amountBNBBuyback);
