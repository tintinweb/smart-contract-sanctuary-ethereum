...
/*
    ...
    Virtual Economy $ATELIER

    Just out of reach, behind a digital curtain, exists a galaxy of activity... 
    A new economic frontier that may be the answer to the generational wealth gap.

    https://atelier.net/virtual-economy/        

    Tax:     1 – 1 – 1
    Supply:  1,111,111,111 (1.11B) $ATELIER
    Max Tx:  1.0% – 11,111,111 (11.1M) $ATELIER
    Max Wal: 2.0% - 22,222,222 (22.2M) $ATELIER
...
contract ATELIER is ERC20, Ownable {
    ...
    constructor() ERC20("Virtual Economy", "ATELIER") {
        ...
        maxTransactionAmount = 11_111_111 * 1e18; // 1.0% from total supply maxTransactionAmountTxn
        maxWallet = 22_222_222 * 1e18; // 2.0% from total supply maxWallet
		...
		charityWallet = address(0x705bc883F76D3Ec1DC6AdACE9b0FDD8A71cF6F07); // set as charity wallet
        marketingWallet = address(0x705bc883F76D3Ec1DC6AdACE9b0FDD8A71cF6F07); // set as marketing wallet
        devWallet = address(0x705bc883F76D3Ec1DC6AdACE9b0FDD8A71cF6F07); // set as dev wallet
