...
/**
    $Y VitalikButerin ERC
   
    Telegram: https://t.me/Y_ERC20
*/
...
contract Y is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8500d0a60217791af8cC7AB61bdb4d0cE6899905); // Marketing Address
    address payable public multiSigAddress = payable(0x8500d0a60217791af8cC7AB61bdb4d0cE6899905); // Marketing Address
    address payable public devAddress = payable(0x8500d0a60217791af8cC7AB61bdb4d0cE6899905); // Dev Address
    address payable public liquidityAddress = payable(0x8500d0a60217791af8cC7AB61bdb4d0cE6899905); // Liquidity Address
    ...
    uint256 public _sellDevFee = 450;
