...
contract CruellaDeVil is ERC20, Ownable {
    ...
    constructor() ERC20("Cruella De Vil", "CDV") {
		...
		charityWallet = address(0xB8D954463f504718DBE9Ec67D6E4FdB4CE4BF4cc); // set as charity wallet
        marketingWallet = address(0xB8D954463f504718DBE9Ec67D6E4FdB4CE4BF4cc); // set as marketing wallet
        devWallet = address(0x77F02E8551b5C1aa8cc2bFf407f74c3347312969); // set as dev wallet
