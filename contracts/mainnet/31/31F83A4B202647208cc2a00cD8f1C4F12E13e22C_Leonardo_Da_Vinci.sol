...
/**
Website: https://vincitoken.com/
Telegram: https://t.me/DaVinciETH
*/
...
contract Leonardo_Da_Vinci is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Leonardo Da Vinci";
    string private _symbol = "VINCI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC30c9A03F9330C571d12C43923c95B2Feb73de72); // Marketing
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
        ...
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee);
        require(_totalTaxIfSelling <= 60, "Sell tax must be less than 60%");
    }
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare) external onlyOwner() {
        ...
        _totalDistributionShares = _liquidityShare.add(_marketingShare);
        require(_totalDistributionShares <=90, "Distribution Shares must be less than 90%");
    }
