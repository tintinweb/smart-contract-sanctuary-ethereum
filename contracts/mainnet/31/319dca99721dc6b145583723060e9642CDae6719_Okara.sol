...
//
// Okara aims to bring people in from all over the crypto sphere.
// We are doing a fair launch soon after the contract is written.
// We have call groups ready to contract, and we're ready to turn this into the monster it's supposed to be!
//    
//    Tg: https://t.me/Okara_Token
//    Website: https://okara.pro
...
contract Okara is ERC20, Ownable {
    ...
    constructor() payable ERC20("Okara Token", "Okara") {
