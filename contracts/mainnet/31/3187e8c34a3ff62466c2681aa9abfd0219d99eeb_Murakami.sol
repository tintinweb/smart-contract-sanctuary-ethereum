...
contract Murakami is ERC20, Ownable {
    ...
    constructor() payable ERC20("Murakami Inu", "MURAKAMI") {
        ...
        operationsAddress1 = address(0x1E0333C23eDBdd9e0e21f856ca91719e9da6fA36);
        lpReceiverAddress = address(0x1E0333C23eDBdd9e0e21f856ca91719e9da6fA36);
        ...
        onlyOwner
    {
        ...
        buyTotalFees = buyOperationsFee + buyLiquidityFee;
        require(buyTotalFees <= 25, "Must keep fees at 5% or less");
    }
