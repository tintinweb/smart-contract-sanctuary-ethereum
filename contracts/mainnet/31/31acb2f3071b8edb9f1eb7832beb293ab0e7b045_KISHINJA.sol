...
contract KISHINJA is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "KISHINJA";
    string private _symbol = "KISHINJA";
    uint256 private _tTotal = 1000 * 10**9 * 10**uint256(_decimals);

    //
    uint256 public defaultTaxFee = 10;
    ...
    address payable public marketingWallet = payable(0x70322b1ac1A818361f8923651E082E4Dae93F889);
