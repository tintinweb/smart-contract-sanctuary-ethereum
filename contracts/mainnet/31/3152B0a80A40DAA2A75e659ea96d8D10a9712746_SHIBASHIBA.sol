...
/**
HERE WE GO WITH SHIBASHIBA WE WILL NOT HAVE A MARKETING FEE BUT WE WILL HAVE A BURN AND LP TAX! 
COME FIND THIS GEM AS I WILL RENOUNCE THE CONTRACT AND BURN THE LP!
...
contract SHIBASHIBA is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'SHIBASHIBA';
    string private constant _symbol = 'SHIBASHIBA';
