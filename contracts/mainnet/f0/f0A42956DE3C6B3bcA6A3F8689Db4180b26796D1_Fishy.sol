...
contract Fishy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Fishy", "FISHY") {
        ...
        marketingWallet = address(0x354638162eFbea1148B2bbe68C390BCcBB6cd553);
        developmentWallet = address(0x354638162eFbea1148B2bbe68C390BCcBB6cd553);
