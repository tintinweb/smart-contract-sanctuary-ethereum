...
contract RarePenguinPepe is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmPzEyVYHeaJ9TTWtxHU1dH9fFYMJFf1CExbkAXSWHmDU9/";
  uint256  public  maxSupply = 999;
  uint256 public  MAX_MINTS_PER_TX = 20;
  uint256 public  PUBLIC_SALE_PRICE = 0.0005 ether;
  uint256 public  NUM_FREE_MINTS = 900;
