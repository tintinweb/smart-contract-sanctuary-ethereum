...
contract HalfETH is IERC20, Ownable {
    ...
    uint256 public maxTxAmount = _totalSupply.mul(30).div(1000); // 1%
    uint256 public maxHoldingLimit = _totalSupply.mul(30).div(1000); // 1%
    ...
    uint256 antiSnipingTime = 600 seconds;
