 ...
 * allowances. See {IERC20-approve}.
 */
 contract Atai is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Animate AI" ;
    string private _symbol = "ATAI";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000000;
    uint256 public taxForLiquidity = 47; //sniper protection, to be lowered to 5% after launch
    uint256 public taxForMarketing = 47; //sniper protection, to be lowered to 5% after launch
    uint256 public maxTxAmount = 10000001 * 10**_decimals;
    uint256 public maxWalletAmount = 10000001 * 10**_decimals;
    address public marketingWallet = 0x2c459aDA711a51490ce2717b3feef13fF724D741;
    ...
    function changeSwapThresholds(uint256 _numTokensSellToAddToLiquidity, uint256 _numTokensSellToAddToETH)
        ...
        returns (bool)
    {
        require(_numTokensSellToAddToLiquidity < _supply / 95, "Cannot liquidate more than 5% of the supply at once!");
        require(_numTokensSellToAddToETH < _supply / 95, "Cannot liquidate more than 5% of the supply at once!");
