...
contract Frodas is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor()
  ERC721A("Frodas - koda frens", "FRDS")
  {
    maxPerAddressDuringMint = 30;
    maxBatchSize = 10;
    collectionSize = amountForDevs = amountForSaleAndDev = 3333;
    saleConfig.publicPriceWei = 9 ether / 1000; // 0.009 eth
