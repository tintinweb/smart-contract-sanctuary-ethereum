...
contract WEOWNAMOONBIRD is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = 'ipfs;//bafybeifld3bwpmb7jmnmbwbrkhfurm7mogoexlnzxxqs23fdnxayk2v4i4/';
  ...
  function freeMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount){
    ...
    require(_mintAmount > 0 && _mintAmount <= 1, 'no');
