...
contract AICHAIN is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "AI Chain";
    string private constant _symbol = "AICHAIN";
    ...
    address payable private _developmentAddress = payable(0x491ac91291A084393FFae5b31199312AA2db78F0); 
    address payable private _marketingAddress = payable(0x8112ED3f446BCDce6C44DE22af358e35C1D16706);
