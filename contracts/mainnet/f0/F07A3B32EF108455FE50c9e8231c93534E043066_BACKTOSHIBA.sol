...
contract BACKTOSHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "BACK TO SHIBA";
    string private _symbol = "$BTS";
    ...
    address payable public marketingaddress = payable(0xFa35a7b8aA7CD8256FC7E3Ff47aC0c6DbAEEcB9E);
