...
contract CharlesMacLoud is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 150;
    ...
    address[] public withdrawAddresses = [0x3df8Caf9EB2D883D2d09B3a347A4452A5Cf09b03, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xe959fa9d53192a6880326dbce22fb815d24e2a7c97d63aaa78febf419ccfdfe2;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x3df8Caf9EB2D883D2d09B3a347A4452A5Cf09b03, _royaltyAmount);
    }
