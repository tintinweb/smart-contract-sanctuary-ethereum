...
//    MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM#                                                             `     `       `                                                            -MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM    //
//    MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM#    MMMMMMMMMMMMMMMMMMMMMMMMMN.                 -MMMMMMMMM~                   [email protected]                  .MMMMMMMMMMMMMMMMMMMMMMMMMF   -MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM    //
...
//    MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM#    [email protected]     `  `         .M~   `      `        db              `   -MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMF   -MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM    //
...
//    MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM#    [email protected]           `   `  .MMMMMMM~   `    `        ` dMMMMMMR   `  `           ,MMMMMMMMMMMMMMMMMMMMMMMMMMMF   -MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM    //
...
//    MMMMMMMMMMMMB"~````````````?7MM#    MMMMM]                         `           `````````_?`               `   ?!``````````     `  `     `                      MMMMMF   [email protected]^`````````````?TMMMMMMMMMMMM    //
...
//    [email protected]            `  `  .]     `    `        ,,            `     WMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM^    `  `  `  `    g  `    `   `  `     h     `            ,MMMMMMMMMMMMMMMMMMMMM    //
...
//    MMMMMMMMMMMMMMMMMM%           `   `  dMMM]                   ,MMMb  `      `        ,[email protected]            `  `  .MMM#             `  `   MMMM,             `    WMMMMMMMMMMMMMMMMM    //
