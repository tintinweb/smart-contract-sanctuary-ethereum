...
/*
  ...
  /     \   ____ |  | _______    \______   \  |__ |__| ____   ____  ______
 /  \ /  \_/ __ \|  |/ /\__  \    |       _/  |  \|  |/    \ /  _ \/  ___/
/    Y    \  ___/|    <  / __ \_  |    |   \   Y  \  |   |  (  <_> )___ \ 
\____|__  /\___  >__|_ \(____  /  |____|_  /___|  /__|___|  /\____/____  >
        \/     \/     \/     \/          \/     \/        \/           \/ 
...
contract Mekarhinos is ERC721A, Ownable {
    using ECDSA for bytes32;
    using Strings for uint256;

    address private constant TEAM_ADDRESS = 0x5212B606e807451Dd3f57bB3332CeD9500D009eE;

    uint256 public TOTAL_MAX_SUPPLY = 6666;
    uint256 public constant TOTAL_FREE_SUPPLY = 3333; 
    uint256 public constant TEAM_CLAIM_AMOUNT = 50;
    ...
    uint256 public token_price = 0.0069 ether;
    ...
    constructor() ERC721A("Mekarhinos", "MEKARHINO") {
    ...
    function levelup(uint256 _quantity) external onlyOwner {
        TOTAL_MAX_SUPPLY = _quantity;
    }
