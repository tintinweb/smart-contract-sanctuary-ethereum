...
contract IbizaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"IBIZA INU";
    string private constant _symbol = unicode"IBIZA";
