...
📱 TELEGRAM : https://t.me/BankOfPearlOfficial

Total Tax : 5% Pearl rewards

Dashboard for tracking & Claim Rewards will be live soon and already on developpement.
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable PEARL = address(0xB4743bfABfcE34537A4baf0F3eB2F269246D180A); //PEARL
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a Claim PEARL shareholder!");
...
contract BankOfPearl is IERC20, Auth {
    ...
    address public immutable PEARL = address(0xB4743bfABfcE34537A4baf0F3eB2F269246D180A); //Δ

    string private constant  _name = "BankOfPearl";
    string private constant _symbol = "BOPEARL";
    ...
    address payable public marketingWallet = payable(0xAd789853c99306B25FB808e3cFeF9aE78173ca5F);
    ...
    uint256 private maxBuy = 20000000001 * (10 ** _decimals); // 2%
