...
contract BAGCCore is OwnableUpgradeable {
    ...
    function setPoolEndTime(uint256 poolId, uint256 endTime) public onlyOwner {
    ...
    function getRandomAvailableTokenId(
        ...
        uint256 availableIndex = getAvailableTokenAtIndex(randomIndex, updatedNumAvailableTokens);
