...
/**
 * Dassai Sake - Sublimata
 */
contract Sublimata is ERC721CollectionBase, ERC721, AdminControl {

    constructor(address signingAddress) ERC721("Sublimata", "DASSAI") {
        _initialize(
            // Total supply
            777,
            // Price (1.5 ETH)
