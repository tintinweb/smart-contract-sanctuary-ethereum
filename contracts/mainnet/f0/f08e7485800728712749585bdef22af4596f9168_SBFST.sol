...
/**
    $SBFST - SBF SEX TAPE
    https://twitter.com/whalechart/status/1592913773542576128?s=46&t=ZT9B2lqgBxjjcPTfRdpIag

    https://t.me/SBFSEXTAPE
*/
...
contract SBFST  is Context, IERC20, Ownable {
    ...
    address payable public devAddress = payable(0x550F8f4A6d51B4C8d0652C4e66d2c328B68Db92B); // Dev Address
    address payable public liquidityAddress = payable(0x550F8f4A6d51B4C8d0652C4e66d2c328B68Db92B); // Liquidity Address
    ...
    string private constant _name = unicode"SBF SEX TAPE";
    string private constant _symbol = unicode"SBFST";
