...
contract Farmereum is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Farmereum", "FEREUM") {
        ...
        maxWallet = 1000000 * 1e18; // Max Wallet 1%
        swapTokensAtAmount = 100000 * 1e18; // 0.1% swap threshold for the CA
		...
		marketingWallet = address(0x25C8aaFF8808a5f72a4A092C70aD1A214f744e0B); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x25C8aaFF8808a5f72a4A092C70aD1A214f744e0B)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x25C8aaFF8808a5f72a4A092C70aD1A214f744e0B)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x25C8aaFF8808a5f72a4A092C70aD1A214f744e0B)] = true;
    ...
    function updateMaxWallet() external onlyOwner {
        maxWallet = 3000000 * 1e18;   //3%
    }
