...
contract RengaLore is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQM6zuN4Ux85WWEm8Ev2SWeXxNPnKbshuqtrWDvMc5NX4";
    ...
    uint256 public MaxSupply = 3564;

    uint256 public constant MintPrice = 0.005 ether;
    uint256 public FreeMints = 564;
    ...
    constructor(
    ) ERC721A("RENGA LORE", "RL", 100, MaxSupply) {
    }
