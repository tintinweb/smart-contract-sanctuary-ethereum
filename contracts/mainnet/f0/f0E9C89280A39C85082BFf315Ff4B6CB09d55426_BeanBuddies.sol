...
contract BeanBuddies is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_TOKENS = 6671;
  uint256 public constant COLLECTOR_ALLOWANCE = 11;
  
  uint public tokenReserve = 20;
  ...
  constructor() ERC721("BeanBuddies", "BB") {
    setBaseURI("https://blam.io/api/beanbuddies/token/");
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    address payoutAddress1 = payable(0x5b45c2a338ac27e64C02BC9feDC52745Bf2651AB);
