...
contract DSI is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x0FE3bEacAB1C579De2D7ffbdd69f1b9b86F1Be16);
    address payable private _marketingAddress = payable(0x0FE3bEacAB1C579De2D7ffbdd69f1b9b86F1Be16);
    ...
    uint256 public _maxWalletSize = 200000 * 10**9; //3%
