...
contract Arttigos is IERC721A { 
    ...
    string private constant _name = "Arttigos";
    string private constant _symbol = "Arttigos";
    string private _baseURI = "bafybeianyebwagf3zgrzddsazigbdtumrg6xrpdsczeymfe6iiggnmgiea";
    ...
    function freeMint() external{
        ...
        require(amount + _numberMinted(_caller) <= MAX_FREE_PER_WALLET, "Max 2 per Wallet");
