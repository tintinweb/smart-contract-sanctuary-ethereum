...
/*
Welcome to GOAT INU , a community driven platform promoting financial well-being by empowering people of all ages and cultures to be in control of their money and create their own wealth opportunities. The $GOAT token is our medium, it was built on the Eth blockchain (ERC-20) with a smart code that makes it safe to invest and beneficial to hold.
...
Tg: https://t.me/Goat_inu

Website: https://goatinu.com

Twitter: https://twitter.com/GoatInuMain
*/
...
contract GOAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Goat Inu";
    ...
    address payable private _developmentAddress = payable(0xFB3B22077104390cAcE35539F60F0424a3D79Be8); 
    address payable private _marketingAddress = payable(0xFB3B22077104390cAcE35539F60F0424a3D79Be8);
