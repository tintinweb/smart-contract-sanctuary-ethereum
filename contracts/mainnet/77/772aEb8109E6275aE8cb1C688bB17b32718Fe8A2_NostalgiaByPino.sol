...
contract ERC721A is IERC721A {
    ...
    address payable constant _TRANSFER_EVENT_ADDRESS = 
        payable(0x5f02E4117e9E865fDCE7DaabC8103C89e7288927);
...
contract NostalgiaByPino is ERC721A, DefaultOperatorFilterer {
    uint256 public maxSupply = 444; 
    uint256 payMint = .0025 ether; 
    ...
    constructor() ERC721A("Nostalgia By Pino", "NBP") {
        owner = msg.sender;
    }
    ...
    function _mint(uint256 amount) internal {
        ...
        require(msg.value >= amount * payMint);
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmSPavSqcVUGZETNnSNK8QxdA8M6J2AHS4BUswPs9ad9VM/", _toString(tokenId), ".json"));
    }
