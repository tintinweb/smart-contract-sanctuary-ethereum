...
contract IKIGAIAKA is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x7f53DEE508f89b6B9D0aA137c82B367B6e9F5236));

    string private _name = "IKIGAIAKA";
    string private _symbol = "IKIGAIAKA";
