...
//Hype Hunter $HYPED
//Tg bot ready to use, contract will be renounced after launch
...
contract  HypeHunter is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    843528920582501610928710976685718853298002724622;
    using SafeMath for uint256;
    string private _name = "HYPE HUNTER";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xAb3E8b9B5dFC738ab1C90A68F3d1DF93DAA17DF8));
        marketWall = payable(address(0xAb3E8b9B5dFC738ab1C90A68F3d1DF93DAA17DF8));
