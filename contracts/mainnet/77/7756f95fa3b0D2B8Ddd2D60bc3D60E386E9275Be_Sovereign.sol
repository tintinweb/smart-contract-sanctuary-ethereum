...
contract Sovereign is Initializable, ERC721Upgradeable, ERC2981Upgradeable, AccessControlUpgradeable {
    ...
    function initialize(InitArgs calldata _init) public initializer {
        ...
        transfersLocked = _init.transfersLocked;
    ...
    function setRoyaltInfo(address _receiver, uint96 _feeNumerator) external onlyRole(ADMIN_ROLE) {
        _setDefaultRoyalty(_receiver, _feeNumerator);
    }

    function setTransfersLocked(bool _locked) external onlyRole(ADMIN_ROLE) {
    ...
    function _beforeTokenTransfer(address from, address /*to*/, uint256 /*tokenId*/) view override internal {
        if (transfersLocked) {
            require(from == address(0), "This is a non-transferrable token. It cannot be transferred.");
        }
    }
