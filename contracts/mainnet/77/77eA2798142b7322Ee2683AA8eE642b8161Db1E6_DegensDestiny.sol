...
contract DegensDestiny is Context, IERC20, Ownable {
    ...
    string private constant _name = "Degens Destiny";
    string private constant _symbol = "Gamble";
