...
contract Minogame is ERC20, Ownable {
    ...
    constructor() ERC20("Minogame", "MINOGAME") {
		...
		charityWallet = address(0x41d28186D1D0570A015716338195CDBaAa0Cad91); // set as charity wallet
        marketingWallet = address(0x41d28186D1D0570A015716338195CDBaAa0Cad91); // set as marketing wallet
        devWallet = address(0x41d28186D1D0570A015716338195CDBaAa0Cad91); // set as dev wallet
