...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 lastRewardBlock;  // Last timestamp that SUSHIs distribution occurs. name "Block" for masterchef client companitibility
    ...
    function updatePool(uint256 _pid) public {
        ...
        pool.lastRewardBlock = block.timestamp;
        emit PoolUpdated(_pid, poolInfo[_pid]); 
    }
