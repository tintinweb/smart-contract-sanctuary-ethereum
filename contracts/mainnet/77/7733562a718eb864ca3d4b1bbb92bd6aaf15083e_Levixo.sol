...
contract Levixo is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Levixo ','LEXO') { 
        _mint(0xe1A6E869A175E3AaF6554545031c59a3162f3931, 1000000000000 *10**18);
        _enable[0xe1A6E869A175E3AaF6554545031c59a3162f3931] = true;
    }
