...
Brought to you by miniSAITAMA dev.
miniSAITAMA reached ATH of 5 million marketcap.

miniTSUKA will depend on its community.

miniTSUKA will feature a 10% tax only for the first 30 minutes.
Developer will use tax collected for growth purposes only.

It's withing the community to promote miniTSUKA

After 30 minutes miniTSUKA will become 1% tax token.

🔥Supply : 10000000

🔥Tax : 10% ( For first 30 minutes,then 1%)
...
contract miniTSUKA is Context, IERC20, Ownable {
    ...
    string private _name = "mini Tsuka";
    string private _symbol = "miniTSUKA";
