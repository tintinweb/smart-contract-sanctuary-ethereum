...
contract ProofOfNFT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof of NFT";
    string private constant _symbol = "PONFT";
    uint256 public _maxTxAmount = 2_000 * 10**_decimals;
    uint256 public _maxWalletSize = 4_000 * 10**_decimals;
    uint256 public _taxSwap=1_000 * 10**_decimals;
