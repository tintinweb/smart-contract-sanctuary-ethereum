...
contract DITMAXNFT1155 is Initializable,ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable {
   event Approve(
    ...
    function initialize() public initializer {
        ERC1155Upgradeable.__ERC1155_init("", "DITMAXNFT", "$DITMAXNFT");
        __Ownable_init();
        _tid = 1;
