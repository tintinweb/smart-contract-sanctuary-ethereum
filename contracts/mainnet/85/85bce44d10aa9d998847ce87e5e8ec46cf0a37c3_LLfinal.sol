...
we present the ultimate larp token the greatest larp to end them all 
Lord larp we are all ryoshis and cheeda devs together we can create the ultimate moon.
...
contract LLfinal is BEP20, Ownable { 
    using SafeMath for uint256;
    ...
    constructor() BEP20("LL", "LL") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0x2A120cB747dA9F3A66799d4620886A485D637f8A); // CHANGE THIS TO YOURS
        devWallet = payable(0x2A120cB747dA9F3A66799d4620886A485D637f8A); // CHANGE THIS TO YOURS
