...
contract Alpha is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Alpha", "ALPHA", 9) ERC20Permit() {
    ...
    /**
        @notice increases Alpha supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess Alpha
