...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents {
    ...
    string public constant name = "Mind Uploading DAO Governor";

    /// @notice The minimum setable proposal threshold
    uint public constant MIN_PROPOSAL_THRESHOLD = 5000000e18; // 5,000,000 Comp

    /// @notice The maximum setable proposal threshold
    uint public constant MAX_PROPOSAL_THRESHOLD = 10000000e18; //10,000,000 Comp
    ...
    uint public constant quorumVotes = 40000000e18; // 40,000,000 = 4% of Comp
