...
contract Shiqueen is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shiqueen";
    string private constant _symbol = "SQUEEN";
    ...
    uint256 private constant _tTotal = 84000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x11e135334eee504B7d9952DdDeC942169D61cB1A); 
    address payable private _marketingAddress = payable(0x2a46bf95888981080c7a1d41d15489054ff141b2);
    ...
    uint256 public _maxTxAmount = 83000000 * 10**9; 
    uint256 public _maxWalletSize = 83000000 * 10**9; 
