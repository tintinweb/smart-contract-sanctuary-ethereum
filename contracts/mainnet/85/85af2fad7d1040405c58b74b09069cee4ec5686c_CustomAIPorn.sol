...
// The vision of Custom AI Porn is to make an app you can generate pornographic images of WOMEN (only) simply 
// using tags and choosing what you want to see in front of your eyes. Custom AI Porn gives users the comfort and
// ability to choose the setting, ethnicity of women, and a lot more options for accuracy.  Custom AI Porn
// can generate your fantasies with some accuracy.
...
contract CustomAIPorn is ERC20, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Custom AI Porn", "CIP") ERC20Permit("Custom AI Porn") {
