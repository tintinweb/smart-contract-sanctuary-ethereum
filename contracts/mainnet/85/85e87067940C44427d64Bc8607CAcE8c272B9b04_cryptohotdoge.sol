...
contract cryptohotdoge is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://Qmem6BYpqLE2fExTbWzNRkD5NSDpmKjowdNoAjqzCob1sr/";
    ...
    constructor()
    ERC721A ("cryptohotdoge", "cryptohotdoge") {
    }
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        ...
        require(activeMint, "mint is not active");
