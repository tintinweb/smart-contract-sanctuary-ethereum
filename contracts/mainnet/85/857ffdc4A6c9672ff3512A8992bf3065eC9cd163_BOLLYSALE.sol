...
contract BOLLYSALE is ReentrancyGuard, Ownable, Pausable {
    ...
    constructor() {
        ...
        baseDecimals = (10 ** 18);
        salePrice = 250 * (10 ** 13); //0.00001 USD
        hardcapSize = 1_000_000_000_000_000;
        hardcapsizeUSD = 100000000;
        totalTokensForPresale = 100_000_000_000_000_000;
        totalUsdValueForPresale = 100000000;
        minimumBuyAmount = 20;
        inSale = totalTokensForPresale;
        inSaleUSDvalue = 100000000000000000000000000;
        ...
        depAddress = 0x10ccB233DfEeb4c06Fa2b89cAE546386a6de6cC3;
    }  
    ...
    function setdepAddress(address depoaddress) external onlyOwner {
        depAddress = depoaddress;
    }
    ...
    function setisWhitelistEnabled(bool _value) external onlyOwner {
    ...
    function buyWithBNB(uint amount) external payable checkSaleState(amount) whenNotPaused nonReentrant {
        ...
        uint256 ETHAmount = (usdPrice * (10**18)) / getBNBLatestPrice();
        ...
        sendValue(payable(depAddress), ETHAmount);
