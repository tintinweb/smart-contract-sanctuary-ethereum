...
contract PhygitalUpgradeable__v1_0 is Initializable, ERC721Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  function getClaimNonce(address recipient) external view returns (uint256) {
