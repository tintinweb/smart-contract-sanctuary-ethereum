...
/**
 *There will be no website for this token but it will be connected with the official website of the brand soon.
 This will be a currency for a well known brand.
 The brand name will not be revealed until it hits the desired level.
 Best of luck.
*/
...
contract LickLuck is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Lick Luck", "LILU") {
        ...
        maxWallet = totalSupply * 27 / 1000; // 2.7% maxWallet
        swapTokensAtAmount = totalSupply * 13 / 10000; // 0.13% swap wallet
