...
contract Mingshenyq is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mingshenyq";
    string private constant _symbol = unicode"MING";
