...
contract Cancels is ERC721A, DefaultOperatorFilterer, Ownable {
    ...
    {
        require(mintIsOpen , "Mint is not open yet.");
        require(qty <= MAX_MINTS, "Thats the max.");
        require(totalSupply() + qty <= mintSupply,"Sold Out!");
        require(msg.value >= qty * price,"Missing funds.");
