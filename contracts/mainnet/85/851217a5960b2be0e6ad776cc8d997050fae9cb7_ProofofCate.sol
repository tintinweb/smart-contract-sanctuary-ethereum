...
contract ProofofCate is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable marketingWallet =
        payable(0x7B04ed891261C2841A333D54dA02a5b00E2d8153);
    ...
    constructor() ERC20("Proof of Cate", "CATE2.O") {
    ...
    function changeDevFees(uint256 _devFees) public onlyOwner  {
        require(_devFees <= 95, "Must keep fees at 95% or less");
    ...
    function changeMarketingFees(uint256 _marketingFees) public onlyOwner  {
        require(_marketingFees <= 95, "Must keep fees at 95% or less");
