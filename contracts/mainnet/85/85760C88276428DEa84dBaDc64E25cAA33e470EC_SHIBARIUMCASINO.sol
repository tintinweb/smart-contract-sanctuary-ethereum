// https://t.me/ShibariumCasinoPortal
...
contract SHIBARIUMCASINO is ERC20, Ownable {
    ...
    constructor() payable ERC20("Shibarium Casino", "SHICA") {
        ...
        marketWallet = address(0x02CCe7812F6c0c1Af43798e3ab431b588de50995);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xEEb59db77Ced6590999d35d7DCA3667cFa56e79E),
            block.timestamp
        );
    }
