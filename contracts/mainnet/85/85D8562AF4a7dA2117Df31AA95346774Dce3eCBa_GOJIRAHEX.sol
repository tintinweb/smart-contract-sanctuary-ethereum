...
Token Name: Gojira Hex
Ticker: Ghex
Supply: 100,000
Initial BUY: .05% = 500
BURN: 1%
TAX: 3%
Telegram: https://t.me/Gojira_HexETH
...
contract GOJIRAHEX is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gojira Hex";
    string private constant _symbol = "Ghex";
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x999B990cc49eC86DDCdC516E24A1e95796911BAA); 
        ...
        maxTxAmount = 501  * 10**9;
        maxWalletAmount = 501 * 10**9;
