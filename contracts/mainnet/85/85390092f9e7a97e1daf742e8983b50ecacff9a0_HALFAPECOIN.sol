...
Half ApeCoin is a meme coin backed by utility to serve the degen community.

Tg: https://t.me/halfapecoin
...
contract HALFAPECOIN  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Half ApeCoin";
    string private constant _symbol = "APE0.5";
    ...
    address payable private _developmentAddress = payable(0x4D635508725C59dbdD9d0c0b8D9EB7Db47F4d061); 
    address payable private _marketingAddress = payable(0x4D635508725C59dbdD9d0c0b8D9EB7Db47F4d061);
