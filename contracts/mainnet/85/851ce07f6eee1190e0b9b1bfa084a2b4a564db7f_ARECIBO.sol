...
and Earth sent to globular star cluster M13 in the hope that extraterrestrial intelligence might 
receive and decipher it. The message was broadcast into space a single time via frequency modulated 
radio waves at a ceremony to mark the remodeling of the Arecibo radio telescope.

TG      https://t.me/LONESIGNALPORTAL
WEB     https://www.lonesignal.net/
...
contract ARECIBO is ERC20, Ownable {
    ...
    constructor() ERC20("LONE SIGNAL", "ARECIBO") {
        ...
        uint256 totalSupply = .333 * 1e9 * 1e18;
