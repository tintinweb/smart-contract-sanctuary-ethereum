...
contract Jora is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Jora Network";
    string private constant _symbol = unicode"JORA";
    uint256 public _maxTxAmount =   199999999 * 10**_decimals;
    uint256 public _maxWalletSize = 199999999 * 10**_decimals;
