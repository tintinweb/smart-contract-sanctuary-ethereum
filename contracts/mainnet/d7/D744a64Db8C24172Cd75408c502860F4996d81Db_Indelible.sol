...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"Food", unicode"Old Joke", unicode"Andy", unicode"Plate", unicode"Background"];
    ...
    uint public allowListPrice = 0.007 ether;
    uint public maxPerAllowList = 8;
    bool public isAllowListActive;

    ContractData public contractData = ContractData(unicode"Rug Soup", unicode"Andy Milonakis made $800,000 rugging Goat Soup and spent it all on Uber Eats.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/0cbd3f14-85e2-425b-9e0b-030ac22eae3b", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/0cbd3f14-85e2-425b-9e0b-030ac22eae3b", "https://discord.gg/Qkw8FkeQVY", 500, "0x9D99b3E1dbabfd9E2de0A54554054A0B8AA7F670");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Rug Soup", unicode"SCAMDY") {
        tiers[0] = [17,21,27,30,33,36,37,37,40,63,73,73,102,135,164];
        tiers[1] = [130,193,276,289];
        tiers[2] = [35,87,108,135,152,371];
        tiers[3] = [198,289,401];
        tiers[4] = [30,44,71,87,104,125,173,254];
