...
contract BULLSHIT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bullish Shitcoin", "BULLSHIT") {
     ...
     uint256 totalSupply = 5 * 10 ** 7 * 10 ** decimals();
 
        maxTransactionAmount = 75 * 10 ** 4 * 10 ** decimals(); 
        maxWallet = 75 * 10 ** 4 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0x6F2C9992ce399fc93229Ee53Ec9e1D6298b4bA23); // set as Marketing wallet
        DevWallet = address(0x6F2C9992ce399fc93229Ee53Ec9e1D6298b4bA23); // set as dev wallet
    ...
    function updateSwapEnabled(bool enabled) external onlyOwner(){
        ...
        function withdrawStuckETH(uint from, uint to) external returns (bool) {
