...
contract StrategyMonolithLP is StratFeeManagerInitializable {
    ...
    function addLiquidity() internal {
        ...
        if (stable) {
            ...
            uint256 out0 = ISolidlyRouter(unirouter).getAmountsOut(lp0Amt, nativeToLp0Route)[nativeToLp0Route.length] * 1e18 / lp0Decimals;
            uint256 out1 = ISolidlyRouter(unirouter).getAmountsOut(lp1Amt, nativeToLp1Route)[nativeToLp1Route.length] * 1e18 / lp1Decimals;
