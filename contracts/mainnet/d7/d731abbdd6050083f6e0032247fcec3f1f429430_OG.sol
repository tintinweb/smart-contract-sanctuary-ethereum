...
You can hold a total of 1 OG per address.

2% Liquidity Tax 2% listing tax.
...
contract OG is Context, IERC20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity = 1 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 1, "Max Tx Amount cannot be less than 69 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 1, "Swap Threshold Amount cannot be less than 69 Million");
