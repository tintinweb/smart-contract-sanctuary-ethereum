...
//(/|  |^ )(\*)(.+|) \s+\n \n\n
contract LazyApeClub is ERC721A, Ownable {
    ...
    constructor(uint256 maxTokens_, bool saleEnabled_, bool freeMintEnabled_, string memory baseURI_, uint256 maxFreeMints_, uint256 price_) ERC721A("LazyApeClub","LAC") {
