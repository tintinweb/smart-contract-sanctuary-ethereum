...
contract MoonPings is ERC721A, Ownable {
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(mintedWallets[_caller]+_amount <= MAX_MINT_PER_WALLET, "Max Mint Limit is 5!");
    ...
    function setMaxMint(uint256 _new_max_mint) external onlyOwner{
        MAX_MINT_PER_WALLET = _new_max_mint;
    }

    function setMaxSupply(uint256 _new_max_supply) external onlyOwner{
        require(_new_max_supply<MAX_SUPPLY, "you can only decrease the supply!");
