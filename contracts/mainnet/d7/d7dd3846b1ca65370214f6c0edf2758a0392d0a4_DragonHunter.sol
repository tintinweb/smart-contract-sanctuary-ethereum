...
/**
This will allow deception to go unpunished if the light of the Crypto world is covered by evil dragons. Pepe plays the role of the light of darkness, 
which will hunt the evil dragon and shine the darkness.

https://t.me/DragonHunter_ETH
*/
...
pragma solidity 0.8.8;
contract DragonHunter is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dragon Hunter";
