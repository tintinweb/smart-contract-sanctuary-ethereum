...
It's all a whitewash by the so-called top bananas.

https://laputaeth.com/
https://t.me/laputaeth
https://twitter.com/laputaeth
...
contract LAPUTA is ERC20, Ownable {
    ...
    constructor() payable ERC20("Castle In The Sky", "LAPUTA") {
        ...
        operationsAddress = address(0xd4B62779D0E8aFc771236Ecd4B9cAb269Ec64E52);
        ...
        _createInitialSupply(address(this), totalSupply); // LP
    ...
    function setMaxSellAmount(uint256 newNum) external onlyOwner {
        require(
            newNum >= ((totalSupply() * 200) / 10000) / 1e18,
            "Cannot set max sell amount lower than 2%"
        );
