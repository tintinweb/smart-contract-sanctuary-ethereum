...
// ERC721A Contracts v4.0.0
    ...
    contract RektMutantApeCopeClub is Ownable, ERC721A {
    ...
    address constant internal TEAM_ADDRESS = 0x42493113f686c5Ee9ef2f1301e5A9ea3b16bc52C;
    string public baseURI = "";
    string public constant baseExtension = ".json";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("Rekt Mutant Ape Cope Club", "REKT MUTANT") {_safeMint(msg.sender, 20); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmPAxke5QQ87SVVeeCRtKxjrhMwVVgshQHFGfpB1sMChD6");}
