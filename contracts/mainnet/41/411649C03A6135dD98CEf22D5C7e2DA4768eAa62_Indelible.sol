// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Flame", unicode"Eyes", unicode"Eye Extra", unicode"Hair extra", unicode"Mouth", unicode"Face extra", unicode"Neck accessory", unicode"Clothes", unicode"Hair", unicode"GHOUL", unicode"background"];
        ...
        uint public constant maxSupply = 200;
        ...
        ContractData public contractData = ContractData(unicode"GHOULSonchain", unicode"An official WONC derivative -  the first women PFP collection fully onchain!", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/bf5fd957-42a0-493c-bf30-46e41f55027b", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/bf5fd957-42a0-493c-bf30-46e41f55027b", "womenonchain.xyz ", 600, "0x7CE5C931BEeA68A6Bba6551fF5d993C86fA121C5");

        constructor() ERC721A(unicode"GHOULSonchain", unicode"GHOULS") {
            TIERS[0] = [15,185];
TIERS[1] = [5,15,20,25,30,35,35,35];
TIERS[2] = [10,20,20,20,20,20,40,50];
TIERS[3] = [15,18,43,60,64];
TIERS[4] = [5,10,15,18,20,22,23,29,29,29];
TIERS[5] = [11,14,17,20,23,115];
TIERS[6] = [20,20,160];
TIERS[7] = [10,15,15,15,20,25,25,25,25,25];
TIERS[8] = [10,20,20,30,30,30,30,30];
TIERS[9] = [5,32,32,32,33,33,33];
TIERS[10] = [5,35,50,55,55];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"GHOULSonchain #");
