...
contract BirthdayElon is ERC20, Auth {
    ...
    string constant _name = "Birthday Elon";
    string constant _symbol = "BElon";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1F87A5Ba0A1c69F3786c89635bCC0Ff4FEd1233A;
        devFeeReceiver = 0xa2b52495371EEd0bf260B056895077B09E7e2C84;
        buybackFeeReceiver = 0xaa8529f878a050124b6CEb8be2F7547CC2025ABb;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != burnFeeReceiver && !isTxLimitExempt[sender] && !isTxLimitExempt[recipient]) {
    ...
    function tradingStatus_Birthday(bool _status) public onlyOwner {
         Birthday = _status;
    }
