...
// File: contracts/OmniWonderBibiz.sol
...
contract OmniWonderBibiz is ERC721A, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721A("Omni Wonder Bibiz", "OmWBz", maxMintAmountPerTx) {
    setHiddenMetadataUri("ipfs://QmSy18FYfEFqLak6a9d9o8qkcJNKPmJzrwPMLaY3cF5wkK/");
  }
  ...
  function devMint(address _to, uint256 _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
  ...
  address t1 = 0x989d787382f0237eC647FEf41481F5F205B7550C; 
