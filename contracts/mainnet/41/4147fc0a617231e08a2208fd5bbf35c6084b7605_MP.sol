...
Blockchain world of music player platform, forever blockchain, forever music. By uploading all meaningful music to the blockchain, this is a great project, we need everyone's participation, everyone can upload later, let us build the music empire in the blockchain together.
A reward system for uploading music will be opened soon: tax dollars will be used to reward $MP holders for uploading music.

Tokenomics
Total: 8,000,000
Tax: 5/5 down to 3/3
2% reward 1% liquidity

Please enjoy our music (https://metaplayer.pro/) first and you can connect MetaMask later ($MP holders) to upload your favorite music.

For more information
WEBSITE (https://metaplayer.pro/)
TG (https://t.me/metaplayerportal)
TWITTER (https://twitter.com/metaplayertoken)
...
contract MP is ERC20, Ownable {
    ...
    constructor() payable ERC20("Meta Player", "MP") {
        ...
        operationsAddress = address(0x79E56579423429b9EC03B12AAC1CD71a364d4a75);
