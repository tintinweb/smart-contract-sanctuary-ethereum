...
contract Overmoon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Overmoon", "OVERMOON") {
        ...
        marketingWallet = address(0x2DA12c40bf09B73E4999D555DBC792a133259ea3); // set as marketing wallet
    	devWallet = address(0x2DA12c40bf09B73E4999D555DBC792a133259ea3); // set as dev wallet
    	buyBackWallet = address(0x2DA12c40bf09B73E4999D555DBC792a133259ea3); // set as buyBackWallet
    ...
    function _transfer(
        ...
        if (!swapping && antiMevBot){
            if (currentBlock == block.number){
                blockTxCount++;
                require (blockTxCount <= 2, "Max 2 tx per block to avoid sandwhich attack");
            }
            else{
