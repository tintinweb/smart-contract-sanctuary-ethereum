...
/*
    ...
    The Qing dynasty was first established in 1636 by the Manchus to designate their regime in Manchuria (now the Northeast region of China). In 1644 the Chinese capital at Beijing was captured by the rebel leader Li Zicheng, 
    and desperate Ming dynasty officials called on the Manchus for aid. The Manchus took advantage of the opportunity to seize the capital and establish their own dynasty in China. By adopting the Ming form of government and continuing to employ Ming officials, 
    the Manchus pacified the Chinese population.

    $MANCHU

     We also collect the tax from Manchurians for 3% of each transaction

    Tg: https://t.me/houseofmanchu 
*/
...
contract HOUSEOFMANCHU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 100 * 10**10 * 10**9; 
    uint256 public _maxbuy = 5 * 10**10 * 10**9; 
    uint256 public _maxwallet = 5 * 10**10 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9;   
    uint256 public _totaltax = 0;
    uint256 public _cooldown = 0;

    address payable public marketingWallet = payable(0xb545BC2b3a56838FD99eE62e2E7CbF5af11ad7F9); 
    address payable public rewardsWallet = payable(0xb545BC2b3a56838FD99eE62e2E7CbF5af11ad7F9); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "HOUSE OF MANCHU";
    string private _symbol = "$MANCHU";
