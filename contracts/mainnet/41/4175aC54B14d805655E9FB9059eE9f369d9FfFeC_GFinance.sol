/**
 Sustainable Layer 2 stable coin yield farming
 Web: https://www.gfinancedao.com/
 Twitter: https://twitter.com/GFinanceDao
 Telegram: https://t.me/GFinancePortal
 Medium: https://gfinance.medium.com
 Github: https://github.com/GFinanceOrganization
*/
...
contract GFinance is ERC20, Ownable {
    ...
    uint256[2] public buyTaxes = [200, 200];
    /// @notice Sell taxes in BPS
    uint256[2] public sellTaxes = [200, 200];
    ...
    constructor()
        ERC20("GFinance Token", "GFI")
        Ownable()
    {
        taxWallets[0] = payable(address(0xA1261D88C64B03861727240A46e42C751B5b6A42));
        taxWallets[1] = payable(address(0xA1261D88C64B03861727240A46e42C751B5b6A42));
