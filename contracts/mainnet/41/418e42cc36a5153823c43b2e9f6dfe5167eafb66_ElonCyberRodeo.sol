...
contract ElonCyberRodeo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ElonCyberRodeo", "ElonCyberRodeo") {
        ...
        marketingWallet = address(0x9ec41701DEa086FeeE2BcB0D394cFa06424DFf95); // set as marketing wallet
        buyBackWallet = address(0x1A0986452cb1a6CE55D99bf641B04711a0ff5383); // set as buyback wallet
