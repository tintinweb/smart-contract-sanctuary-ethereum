...
contract Voltnobi is Ownable, ERC721A, ReentrancyGuard {
  ...
  uint private stopat = 900;
  uint private reserve = 100;

  uint public status = 0; //0-pause 1-whitelist 2-public

  constructor() ERC721A("Ninjas of Kojiki","Voltnobi", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeReveal = "ipfs://QmVyTzSE1yGHK4fUJVfyLM9daNuWUj4CQXbp7A1sWZNjE7";
  }
  ...
  function mint(uint256 quantity) external payable callerIsUser {
    ...
    require(numberMinted(msg.sender) + quantity <= MAX_PER_Address && status == 2 , "Quantity exceeds allowed Mints" );
