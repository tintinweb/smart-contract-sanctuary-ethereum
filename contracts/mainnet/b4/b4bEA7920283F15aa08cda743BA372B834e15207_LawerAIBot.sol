...
contract LawerAIBot is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Lawer AI Bot"; 
    string private constant _symbol = "LAIB"; 
    ...
    address payable private _developmentWalletAddress = payable(0x4A4a55Cf3B9C2FEEbCC1742aE1F26a01c367369F);
    address payable private _marketingWalletAddress = payable(0x4A4a55Cf3B9C2FEEbCC1742aE1F26a01c367369F);
