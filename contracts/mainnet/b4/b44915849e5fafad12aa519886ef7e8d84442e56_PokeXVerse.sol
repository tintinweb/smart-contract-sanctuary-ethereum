...
contract PokeXVerse is ERC721A, Ownable, ReentrancyGuard{
    ...
    uint256 private maxTotalTokens = 4000;
    ...
    uint public amountForPublicSale = 1000;
    ...
    constructor() ERC721A('PokeXVerse', 'PXV') {
    }
