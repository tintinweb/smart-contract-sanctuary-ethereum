...
Annoucement only on: https://medium.com/@yaocho03
*/
...
contract Yaocho is Context, IERC20, Ownable { 
    ...
    string private constant _name = "The Fixed Match";
    string private constant _symbol = "Yaocho";
