...
/*
https://twitter.com/thisisorange

https://opensea.io/collection/trueorange

https://t.me/FF6000Portal
...
contract FF6000 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private _name = "THIS IS ORANGE"; // token name
    string private _symbol = "FF6000"; // token ticker
    ...
    mapping (address => bool) public isFF6000WL;
    ...
    constructor() {
        ...
        isFF6000WL[address(msg.sender)] = true;
        isFF6000WL[address(this)] = true;
        isFF6000WL[address(dexRouter)] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (!isFF6000WL[sender] && !isFF6000WL[recipient]) {
