...
contract BULLISH is ERC20, Ownable {
    ...
    constructor() ERC20("BULLISH", "CPI") {
     ...
     uint256 totalSupply = 9 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x481c7b37c13db4A525B69c7C703e8ED842175fdd); // set as Marketing wallet
        DevWallet = address(0x481c7b37c13db4A525B69c7C703e8ED842175fdd); // set as dev wallet
