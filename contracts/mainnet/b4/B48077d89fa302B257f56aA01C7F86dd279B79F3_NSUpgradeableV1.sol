    ...
    IERC721MetadataUpgradeable
{
     ...
     */
    function __ERC721_init(string memory name_, string memory symbol_, uint256 maxSupply_) internal onlyInitializing {
    ...
    function _preGhostMintCollection(address to, uint start, uint end) internal virtual {
        require(to != address(0), "ERC721: mint to the zero address");
