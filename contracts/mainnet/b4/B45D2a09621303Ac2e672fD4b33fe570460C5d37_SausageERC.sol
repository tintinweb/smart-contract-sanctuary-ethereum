...
And found out it was a Spanish sausage

This sausage contains all energy in the universe
...
contract SausageERC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sausage Inu";
    ...
    uint256 private _maxTxAmount = 20_000 * 10**_decimals;
    uint256 private _maxWalletSize = 40_000 * 10**_decimals;
