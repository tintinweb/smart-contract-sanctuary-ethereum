...
contract Haazinu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Haazinu";
    string private constant _symbol = "HAAZINU";
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xC2CBAC305c9A6bD5f256ce8a0f3F3751EB7363BC] = true;
        _initialTax=8;
        _finalTax=3;
