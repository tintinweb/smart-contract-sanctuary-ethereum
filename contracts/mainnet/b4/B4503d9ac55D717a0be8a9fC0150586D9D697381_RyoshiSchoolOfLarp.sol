...
contract RyoshiSchoolOfLarp is ERC20, Ownable {
    ...
    constructor() ERC20("Ryoshi School of Larp", "LARP") {
        ...
        marketingWallet = address(0x5C90a00Fa27f3813b53A52b9A3F4B0Df0F10dCe8); // set as marketing wallet
        devWallet = address(0x5C90a00Fa27f3813b53A52b9A3F4B0Df0F10dCe8); // set as dev wallet
