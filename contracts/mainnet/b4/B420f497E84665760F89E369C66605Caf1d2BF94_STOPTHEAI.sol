...
contract STOPTHEAI is ERC20, Ownable {
    ...
    constructor() ERC20("STOP THE AI", "STOPAI") {
		...
		charityWallet = address(0x762011240AA5BF153B9EF029f9a1cF07dED59DB8); // set as charity wallet
        marketingWallet = address(0x762011240AA5BF153B9EF029f9a1cF07dED59DB8); // set as marketing wallet
        devWallet = address(0x762011240AA5BF153B9EF029f9a1cF07dED59DB8); // set as dev wallet
