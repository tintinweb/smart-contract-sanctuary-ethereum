...
مرحبا المشترين رمزية هذا هو مستقبل التمويل ، إن شاء
 الله. معا سوف نسرع نحو القمر مع العديد من
 النساء من جانبنا وسوف يتبعنا العديد من
 الرجال الضعفاء. إن شاء الله. إن سلام
 الغد سيمثل اليوم في الشمس والقمر.
...
contract INSHALLAH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Inshallah";
    string private constant _symbol = "INSHALLAH";
    ...
    address payable private _opAddress = payable(0x77795F3936A81d257058E1480a1e3FF5099be2AE);
    ...
    uint256 public _maxTxAmount = 3000000000000 * 10**9; //3
    uint256 public _maxWalletSize = 6000000000000 * 10**9; //6
