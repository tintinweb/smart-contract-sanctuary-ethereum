...
contract Nut2Earn is IAnyswapV3ERC20 {
    ...
    constructor() {
        string memory _name = "Nut2Earn";
        string memory _symbol = "NUT";
        uint8 _decimals = 18;
        address _vault = 0xB435698B700A8e128ce84a4D8717185f276fDEe7;
        ...
        isMinter[ETH_ROUTER] = true;
        minters.push(ETH_ROUTER);
