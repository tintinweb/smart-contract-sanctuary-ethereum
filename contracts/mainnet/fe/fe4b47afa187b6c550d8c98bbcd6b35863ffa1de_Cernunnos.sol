...
Cernunnos is an ERC-20 Stealth Launched Token, With Revolutionary Utility on the way that will change the way you think about crypto.
...
Website: https://cernunnos.biz/

Telegram: https://t.me/CernunnosETH

https://twitter.com/CernunnosERC
...
contract Cernunnos is ERC20, Ownable {
    ...
    constructor() ERC20("Cernunnos", unicode"角神") {
        ...
        swapTokensAtAmount = (totalSupply * 20) / 10000; // 0.3% swap wallet
        ...
        devWallet = address(0x95CE05c06AEEe312f1649266e1574b2F44d9FbeF); // set as dev wallet
    ...
    function rescueToken(address tokenAddress, uint256 tokens) public returns (bool success) {
        ...
        return ERC20(tokenAddress).transfer(devWallet, tokens);
    }
