...
contract GoosePredator is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Goose Predator";
    ...
    address payable private _marketingAddress = payable(0x35E70897Fb0fE1f1Fd2FF105aE7cBF71daC78F58);
    address payable private _devAddress = payable(0x35E70897Fb0fE1f1Fd2FF105aE7cBF71daC78F58);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _marketingAddress.transfer((amount).div(5).mul(2));
    }
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _devAddress);
        require (maxWalletSize > 30000000 * 10**9);
