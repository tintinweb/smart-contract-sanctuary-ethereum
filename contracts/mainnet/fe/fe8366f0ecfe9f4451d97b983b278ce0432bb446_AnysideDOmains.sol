...
contract AnysideDOmains is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint public MAX_SUPPLY = 55555;
    uint public MAX_TEAM = 5555;
    uint public MAX_TX = 555;
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Anyside Web3 Names", "Anyside")
    {
        baseURI = _baseURI;
