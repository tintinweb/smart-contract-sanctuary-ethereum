// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Finger tip", unicode"Nail", unicode"Ring", unicode"Extra", unicode"Skin", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Middle Finger Floaty", unicode"Crypto-starter for Middle Finger Floaty.  - Holders will be eligible to pre-order IRL product.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/e7e17b85-a3c8-41ff-96b0-6ff71a0d6565", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/e7e17b85-a3c8-41ff-96b0-6ff71a0d6565", "https://middlefingerfloaty.com/", 0, "0xA5726d993e48d5CAA1ae40fa1b76873AcBaA70cd");

        constructor() ERC721A(unicode"Middle Finger Floaty", unicode"MFFNFT") {
            TIERS[0] = [12,98,215,266,285,421,452,500,538,610,631,686,745,758,779,829,2174];
TIERS[1] = [122,133,312,472,536,624,653,819,853,866,950,1179,2480];
TIERS[2] = [218,361,481,604,728,775,835,900,1107,1246,1346,1398];
TIERS[3] = [223,1469,2274,2495,3538];
TIERS[4] = [16,24,88,2356,2356,2367,2792];
TIERS[5] = [120,140,184,237,391,505,523,667,1110,1329,1385,1589,1819];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Middle Finger Floaty #");
