...
contract LockBalance is Token {
    ...
    function setLockUser(address _to, uint256 _value, uint256 _endTime) onlyOwner public {
        ...
        uint256 usedLockBalance = lockBalanceAll(_to);

        require(balance >= usedLockBalance.add(_value));
    ...
    function setLockUsers(address[] _to, uint256[] _value, uint256[] _endTime) onlyOwner public {  
    ...
    function deleteLockUserInfos(address _to, uint256[] _endTime) onlyOwner public {
...
contract ONEPICKToken is LockBalance {

    constructor() public {
        name = "ONEPICK";
        symbol = "OPT";
        decimals = 18;
        totalSupply = 6000000000 * 10 ** uint(decimals);
    ...
    function transferWithtLockUser(address _to, uint256 _amount, uint256[] _lockAmount, uint256[] _endTime) onlyOwner public {  
