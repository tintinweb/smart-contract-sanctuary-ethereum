...
contract RumbleInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rumble Inu";
    string private _symbol = "Rumble";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xF4F4b4EEbA3030911BD63D69f3eCa70Fb2FA33b0);
    address payable private taxWallet2 = payable(0xF4F4b4EEbA3030911BD63D69f3eCa70Fb2FA33b0);
