...
contract UkrNoWar is ERC721("UkrNoWar", "UNW"), ERC721Enumerable, Ownable {
    ...
    address public charityFund = 0xA59B29d7dbC9794d1e7f45123C48b2b8d0a34636; //Unicef
    ...
    function withdraw(address development) public onlyOwner {
        uint256 balance = address(this).balance;
        uint256 amount1 = balance * 20 / 100;
        uint256 amount2 = balance - amount1;
        payable(charityFund).transfer(amount1);
        payable(development).transfer(amount2);
    }
