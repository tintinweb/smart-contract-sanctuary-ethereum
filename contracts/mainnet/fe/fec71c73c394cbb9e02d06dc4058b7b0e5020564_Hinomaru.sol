...
The exact origin of the Hinomaru is unknown, but the rising sun held symbolic 
meaning since the early 7th century (the Japanese archipelago is east of the Asian mainland, 
and is thus where the sun "rises"). In 607, an official correspondence that began with 
"from the Emperor of the rising sun" was sent to Chinese Emperor Yang of Sui. 
Japan is often referred to as "the land of the rising sun".

The sun is closely related to the Imperial family, as legend states the imperial throne
was descended from the sun goddess Amaterasu. The religion, which is categorized 
as the ancient Ko-Shintō religion of the Japanese people, includes nature worship and animism, 
and the faith has been worshiping the sun, especially in agriculture and fishing. The Imperial 
God, Amaterasu-ōmikami, is the sun goddess. From the Yayoi period (300 BCE) to the Kofun 
period (250 CE) (Yamato period), the Naiko Kamonkyo (内行花文鏡, a large bronze mirror 
with patterns like a flower-petal manufactured in Japan) was used as a celebration of the 
shape of the shining sun and there is a theory that one of the Three Sacred Treasures, 
Yata no Kagami, is used like this mirror.
 
$Hinomaru will live on forever.
...
contract Hinomaru is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Rising Sun", "Hinomaru") {
