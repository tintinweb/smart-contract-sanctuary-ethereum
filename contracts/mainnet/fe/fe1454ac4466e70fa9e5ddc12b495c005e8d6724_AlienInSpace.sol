...
contract AlienInSpace is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmczY6rCFj45voFpCBESMhsMNtbUDvzyZs1t6ReZSWifJz";

    uint256 public constant MAX_MINTS_PER_TX = 10;
    uint256 public maxSupply = 649;
    ...
    constructor(
    ) ERC721A("Alien in Space", "AIS", 100, maxSupply) {
    }
...
modifier isCorrectPayment(uint256 price, uint256 numberOfTokens) {
    ...
    function DEV(uint256 _maxSupply)
        external
        onlyOwner
    {
