...
contract ShapeClub is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 666;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x189add105ae8dcc4f364b1943fc645dcd4138299b0b23814e5380eab320198c9;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmYbuCff4jy2gYBSQqBHa6RdDX8ykSip9SbzQDQ5iAKRpV";

    constructor() public ERC721A("Shape Club", "SHAPE", 666, 666) {}
