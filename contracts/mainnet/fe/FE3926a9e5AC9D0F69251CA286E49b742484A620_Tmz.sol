...
/*
 ...
 (KYC VERIFIED)
 https://t.me/TheMemeZone
 https://TheMemeZone.com
...
contract Tmz is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 100_000_000_000 * (10**_decimals);
    string private constant _name         = "THE MEMEZONE";
    string private constant _symbol       = "TMZ";
    ...
    uint16 private _taxSharesMarketing   = 66;
    uint16 private _taxSharesDevelopment = 34;
    uint16 private _taxSharesLP          = 0;
    uint16 private _totalTaxShares = _taxSharesMarketing + _taxSharesDevelopment + _taxSharesLP;

    address payable private _walletMarketing = payable(0x3ff9cA5D92FC6B1F8c21D9F31d0221e95Fc3a4ce); 
    address payable private _walletDevelopment = payable(0x67A1abA12A8239E2a122E4E099a717657A7f3eC9); 
    ...
    uint256 private _swapLimit = _taxSwapMin * 53 * 100;
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropAmount = _totalSupply * 22 / 100;
    ...
    function _openTrading() internal {
        _maxTxAmount     = _totalSupply * 4 / 100; 
        _maxWalletAmount = _totalSupply * 4 / 100;
        _tradingOpen = true;
