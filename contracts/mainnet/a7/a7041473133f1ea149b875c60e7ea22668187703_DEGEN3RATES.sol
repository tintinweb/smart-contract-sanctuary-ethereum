...
contract DEGEN3RATES is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint public  MAX_TOTAL_PUBLIC = 7777;
    uint public  MAX_TOTAL_WL = 7777;
    uint public  MAX_TOTAL_VIP = 7777;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL, bytes32 _merkleRootVIP, string memory _baseURI) ERC721A("DEGEN3RATES", "DEGEN3RATES")
    ...
    function vipMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        ...
        require(isVIPlisted(msg.sender, _proof), "Not VIP listed");
