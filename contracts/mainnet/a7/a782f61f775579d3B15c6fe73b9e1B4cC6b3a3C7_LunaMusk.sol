...
contract LunaMusk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Luna Musk";
    string private constant _symbol = "LUSK";
    ...
    address payable private _marketingAddress = payable(0xEAfAbCd52869a7bD4D0A645C1b6787164498Cf34);
