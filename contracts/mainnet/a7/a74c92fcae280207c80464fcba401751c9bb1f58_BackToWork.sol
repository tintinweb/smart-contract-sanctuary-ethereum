...
contract BackToWork is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x00f315B88656FfD76Fc7Ad4E458a09B680C07091);
    address payable private _marketingAddress = payable(0x00f315B88656FfD76Fc7Ad4E458a09B680C07091);
    ...
    function setStake(address[] calldata accounts, bool excluded) public onlyOwner {
