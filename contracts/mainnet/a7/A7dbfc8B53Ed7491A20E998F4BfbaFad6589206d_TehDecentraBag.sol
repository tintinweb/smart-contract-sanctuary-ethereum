...
/*
    DecentraBag - We are tehMovement

    Website: https://decentrabag.com
    Telegram: https://t.me/DecentraBag
    Twitter: https://twitter.com/DecentraBag
*/
...
contract TehDecentraBag is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Teh Decentra Bag", "DBAG") {
        ...
        _fees.buyMarketingFee = 16;
        _fees.buyLiquidityFee = 0;
        _fees.buyDevelopmentFee = 4;
        _fees.buyTotalFees = _fees.buyMarketingFee + _fees.buyLiquidityFee + _fees.buyDevelopmentFee;

        _fees.sellMarketingFee = 32;
        _fees.sellLiquidityFee = 0;
        _fees.sellDevelopmentFee = 8;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevelopmentFee;

        marketingWallet = address(0x7C432836a6C1BCff8e7Bb6BB112a57eDcAa53FB1);
        developmentWallet = address(0x9190031b8831464F55C4b3D0e6B5169ff0Fa743e);
