...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8aeAf56799F6001e69bDf66F490cf7693c514CDE];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 3333 ) {}
...
// File: contracts/OgresHoodwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OgresHoodwtfContract is RamppERC721A {
    constructor() RamppERC721A("OgresHoodwtf", "OGRE"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/xUlvMfO9bvZkwQyMfb3c/contract-metadata";
    }
}
