...
contract ADESANYAINU is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "ADESANYA";
 string private _symbol = "ADESANYA";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x2CCa2252b7f1117946A91c444f8f31564D7DFa0e);
 ...
 //Tokenomics related functions
  function ADESANYADay() public onlyOwner{
      require(block.timestamp > ADESANYADaycooldown, "You cant call ADESANYACoinDay more than once a day");
 ...
 function ADESANYACoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      ADESANYADaycooldown = block.timestamp + 86400;
 }
