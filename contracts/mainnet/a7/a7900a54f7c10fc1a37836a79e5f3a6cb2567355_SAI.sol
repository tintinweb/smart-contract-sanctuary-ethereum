...
contract SAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Social Ai"; 
    ...
    address payable private _developmentWalletAddress = payable(0x56240c568C132Fe4fe8cbE4BACDD7741CEC8bd0D);
    address payable private _marketingWalletAddress = payable(0x56240c568C132Fe4fe8cbE4BACDD7741CEC8bd0D);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(totalFees <= 98, "Must keep fees at 98% or less");
    }
