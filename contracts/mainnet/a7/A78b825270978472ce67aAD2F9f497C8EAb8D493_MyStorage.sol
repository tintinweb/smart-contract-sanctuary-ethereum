...
contract MyStorage is ERC721, EthUsPriceConvert, VRFConsumerBase, Ownable, State {
    ...
    EthUsPriceConvert(_priceFeedAddress, _minimumEntreeFee)
    ...
    function send() external payable {
        // $50 minimum
        require(getCurrentStateNum() == 0, "Not open yet.");
