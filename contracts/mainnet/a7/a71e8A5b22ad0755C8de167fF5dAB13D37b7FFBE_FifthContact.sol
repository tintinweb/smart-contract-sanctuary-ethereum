...
contract FifthContact is DefaultOperatorFilterer, Context, ERC721Tradeable {
  ...
  constructor(address _proxyAddress) ERC721Tradeable("FifthContact", "5THCONTACT", _proxyAddress) {
...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  uint256 internal MAX_SUPPLY = 555;
