...
contract Apple is BEP20 {
    ...
    constructor(address minter, address burner, address marketing) public BEP20('Apple PYE', 'APPLE') {
...
// PYEChef is the master of Apple. He can make Apple and he is a fair guy.
//
...
contract PYEChefV3 is Ownable {
    ...
    function add(uint256 _allocPoint, IBEP20 _lpToken, uint16 _depositFeeBP, uint16 _withdrawFeeBP, uint256 _lockTime, bool _withUpdate) public onlyOwner {
