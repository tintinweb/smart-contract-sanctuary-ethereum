...
contract SQUISHEDGUYS is ERC721A, Ownable {
    ...
    string public unrevealedTokenURI =
        "https://gateway.pinata.cloud/ipfs/QmdeAwSmKHUKnUyGPi1ndd8Ymy4rZZ3w3sMREwLKYKzMFJ";
    string public baseURI = "";

    mapping(uint256 => string) private _tokenURIs;

    address private _ownerWallet = 0x886e1a19EF9c3bDDc422363C9494012b88EeD65b;

    constructor( ) ERC721A("squishedguyswtf", "SQUISHED") {
    }
