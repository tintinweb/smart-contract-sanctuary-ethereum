...
Website: 
http://www.coolsanta.net

Twitter:
http://twitter.com/coolsantaerc
...
contract SANTA is Context, IERC20, Ownable {
    ...
    string private constant _name = "COOL SANTA";
    string private constant _symbol = "CSANTA";
    ...
    function cspairunbl() public deployerOnly {
        // ublacklist pair addr
        address bbot;
