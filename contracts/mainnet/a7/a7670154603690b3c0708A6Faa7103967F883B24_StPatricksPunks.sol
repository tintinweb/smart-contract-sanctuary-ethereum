...
contract StPatricksPunks is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint256 public  maxSupply = 3170;
  uint256 public  MAX_MINTS_PER_TX = 7;
  uint256 public  PUBLIC_SALE_PRICE = 0.00317 ether;
  uint256 public  NUM_FREE_MINTS = 3170;
  uint256 public  MAX_FREE_PER_WALLET = 2;
  uint256 public  freeNFTAlreadyMinted = 0;

  constructor() ERC721A("StPatricksPunks", "SPP") {}
