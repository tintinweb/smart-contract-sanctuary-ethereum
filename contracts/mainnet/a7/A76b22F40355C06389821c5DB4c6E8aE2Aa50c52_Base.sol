...
contract Base is ERC20, Ownable {
    ...
    constructor() ERC20("Base", "BASE") {
        ...
        marketingWallet = address(0x0f10f327Fc7e95df38BB3F58264361Bb6A9AB033); // set as marketing wallet
        devWallet = address(0x854e32Cb0BEfD464372B3b6D28706B8780a0db51); // set as dev wallet
