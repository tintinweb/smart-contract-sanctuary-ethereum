...
/*
Multi-Chain Capital Inu v2: $MCCInu


Tokenomics:
5% of each buy/sell goes to existing holders.
5% of each buy/sell goes into farming development
...
contract MCCINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Multi-Chain Capital Inu v2", "$MCCINU") {
        ...
        uint256 totalSupply = 4206900000000 * 1e9;
 
        maxWallet = 84138000000 * 1e9; // Max Wallet 2%
        swapTokensAtAmount = 4206900000 * 1e9; // 0.1% swap threshold for the CA
		...
		marketingWallet = address(0xFBeAAA14eBbf84B9A8501C3Ad12307355971359e); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0xFBeAAA14eBbf84B9A8501C3Ad12307355971359e)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0xFBeAAA14eBbf84B9A8501C3Ad12307355971359e)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0xFBeAAA14eBbf84B9A8501C3Ad12307355971359e)] = true;
