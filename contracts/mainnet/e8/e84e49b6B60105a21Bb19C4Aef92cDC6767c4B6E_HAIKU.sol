...
https://twitter.com/ShytoshiKusama/status/1635831123732230144
...
contract HAIKU is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "HAIKU";
    string constant _symbol = "HAIKU";
    ...
    address payable public liquidityFeeReceiver = payable(0x8f679722F7bd6Ed7fa48242b75aD05b027873026);
    address payable public marketingFeeReceiver = payable(0x8f679722F7bd6Ed7fa48242b75aD05b027873026);
