...
// File: contracts/SpermLabMutationsLowGas.sol
...
contract Sperm_lab_mutations is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Sperm Lab Mutation", "SLM") {
    setHiddenMetadataUri("ipfs://QmdZ2tfqGb4iDHtPFjuuo2gGW59h2V9tkDnkoC8wWXVEPt/hidden.json");
  }
