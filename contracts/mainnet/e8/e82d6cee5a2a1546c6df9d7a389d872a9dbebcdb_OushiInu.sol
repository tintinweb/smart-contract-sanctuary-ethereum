...
contract OushiInu is ERC20, Ownable {
    using SafeMath for uint256;
        ...
        ERC20("Oushi Inu", "OINU")
    {
        ...
        maxTxnAmount = (totalSupply * 3) / 1000; // 1% of maxTxnAmount
        maxWallet = (totalSupply * 10) / 1000; // 1% maxWallet
        swapTokensAtAmount = (totalSupply * 5) / 10000; // 1% swap amount
