...
contract Blacked is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BLACKED Inu";//
    ...
    address payable private _developmentAddress = payable(0x990571fB612Af475E685987873621D36523fb55C);
    address payable private _marketingAddress = payable(0x990571fB612Af475E685987873621D36523fb55C);
    ...
    uint256 public _maxTxAmount = 1200000000 * 10**9; //
