 ...
 * @title  ERC721Base
 * @notice Base contract for Renaissance Limited Editions to inherit from
 *
 * Features:
    ...
    OperatorFilterer
{
    ...
    /// @notice artist.eth
    address public artist = 0xd2839E6d35EfAe479Bcc932fe2779f97a24177AF;

    /// @notice Contract information
    string public contractURI;

    /// @notice EIP-712 signing domain
    string public constant SIGNING_DOMAIN = "RenaissanceLimitedEditions";
