// https://t.me/LuckyETHPortal
// https://luckytokeneth.com/

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.17;

abstract contract Project {
    address public projectFund = 0xed97A4F71860a304683a7e4A6Bfe4175002e3416;
    address public devWallet = 0x35C78594b110C611c650FA1f4B14D11a88845d19;
    ...
    uint256 public swapProjectFund      = 1;
    uint256 public swapTreasuryFee    = 0;
    uint256 public swapTotalFee       = swapProjectFund + swapLpFee + swapTreasuryFee;
 ...
 * MainContract
 */
contract luckyContract is Project, IERC20, Ownable {
    ...
    constructor () {
        ...
        isFeeExempt[projectFund] = true;
        isMaxExempt[projectFund] = true;
        isTxLimitExempt[projectFund] = true;
...
// *** 
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner() {
        ...
        payable(projectFund).transfer(amountETH * amountPercentage / 100);
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHProjectFund = amountETH.mul(swapProjectFund).div(totalETHFee);
        uint256 amountETHTreasury = amountETH.mul(swapTreasuryFee).div(totalETHFee);

        (bool tmpSuccess,) = payable(projectFund).call{value: amountETHProjectFund, gas: 30000}("");
...
// ***
    ...
    function setSwapFees(uint256 _newSwapLpFee, uint256 _newSwapProjectFundFee, uint256 _newSwapTreasuryFee, uint256 _feeDenominator) external onlyOwner() {
        swapLpFee = _newSwapLpFee;
        swapProjectFund = _newSwapProjectFundFee;
        swapTreasuryFee = _newSwapTreasuryFee;
        swapTotalFee = _newSwapLpFee.add(_newSwapProjectFundFee).add(_newSwapTreasuryFee);
...
// ***
    ...
    function setProjectFundAddress(address _newWallet) external onlyOwner() {
        isFeeExempt[projectFund] = false;
        isFeeExempt[_newWallet] = true;

        isMaxExempt[_newWallet] = true;

        projectFund = _newWallet;
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _newProjectFundAddress, address _newdevWallet ) external onlyOwner() {

        isFeeExempt[devWallet] = false;
        isFeeExempt[_newdevWallet] = true;
        isFeeExempt[projectFund] = false;
        isFeeExempt[_newProjectFundAddress] = true;

        isMaxExempt[_newProjectFundAddress] = true;

        autoLiquidityReceiver = _autoLiquidityReceiver;
        projectFund = _newProjectFundAddress;
