...
Loneliness is more a function of our perceptions than of the number of people around us.

Twitter: https://twitter.com/Artofbeinglone
Telegram: https://t.me/Artofbeinglone
Medium: https://medium.com/@Artofbeinglone
...
contract Artofbeinglone is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Artofbeinglone", unicode"I'm Alone") {
    ...
    ; uint256 totalSupply = 0.1 * 1e9 * 1e18;
