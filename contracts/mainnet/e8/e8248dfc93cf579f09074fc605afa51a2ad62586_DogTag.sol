...
contract DogTag is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x38e0C59ed0bF72aE51f98324efC19A8B8f263340));

    string private _name = "DogTag";
    string private _symbol = "DogTag";
