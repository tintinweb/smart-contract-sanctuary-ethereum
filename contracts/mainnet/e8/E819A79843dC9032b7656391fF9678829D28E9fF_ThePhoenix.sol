...
☎️TELEGRAM PORTAL : https://t.me/thephoenixerc
🐦TWITTER: https://twitter.com/thephoenixErc20
*/
...
contract ThePhoenix is Context, IBEP20, Ownable {
    ...
    uint256 public  _minTokenBalance = _tTotal * 300 / 10000;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 500 / 10000; // 2% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0xbF6a8fDcEf7405A1D1275dB444e8f1A872472C0D;
        _marketingWallet = 0xbF6a8fDcEf7405A1D1275dB444e8f1A872472C0D;
