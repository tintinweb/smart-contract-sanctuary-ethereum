...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
     uint256 constant StockholmIndex = 4759;
    function totalSupply() public view returns (uint256) {
        // Counter underflow is impossible as _burnCounter cannot be incremented
        // more than _currentIndex - _startTokenId() times
        unchecked {
            uint256 supply = _currentIndex - _burnCounter - _startTokenId();
            return supply < StockholmIndex ? supply : StockholmIndex;
        }
    }
    ...
    function _totalMinted() internal view returns (uint256) {
        ...
        unchecked {
            ...
            return minted < StockholmIndex ? minted : StockholmIndex;
        }
    }
    ...
    function _mint(
        ...
        if (_currentIndex >= StockholmIndex) {
...
contract NiWaByFabrik  is ERC721A, Ownable {

    string  public uriPrefix = "ipfs://QmVFTygzosHbLSWzDikup1MH2iwDLm5hYaWYpFaeomUJsf/";

    uint256 public immutable mintPrice = 0.001 ether;
    uint32 public immutable maxSupply = 4999;
