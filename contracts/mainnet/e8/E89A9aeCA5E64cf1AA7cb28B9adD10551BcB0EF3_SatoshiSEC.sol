...
/**
Satoshi SEC is a cryptocurrency oversight body. We have great purpose
as legal protection and we also hope that cryptocurrency can be adopted
by everyone in the world and can stabilize the world economy.
*/
...
contract SatoshiSEC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Satoshi SEC","SatoshiSEC") {
