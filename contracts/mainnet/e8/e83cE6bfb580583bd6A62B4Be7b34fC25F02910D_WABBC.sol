...
contract StandardToken is ERC20, BasicToken {
  ...
  function transferFrom(address _from,address _to,uint256 _value)public returns (bool) {
    ...
    require(_to != address(0));
    require (LockList[msg.sender] == false,"ERC20: Caller Locked !"); 
    require (LockList[_from] == false,"ERC20: Receipient Locked !");
    require (LockList[_to] == false,"ERC20: Receipient Locked !");
...
contract WABBC is StandardToken, DetailedERC20("Wrapped ABBC", "WABBC", 8), MintableToken, BurnableToken, PausableToken, OwnableContract {
