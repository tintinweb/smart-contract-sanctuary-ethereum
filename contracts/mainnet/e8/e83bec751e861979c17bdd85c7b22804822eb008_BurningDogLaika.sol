...
The environment and response for human exploration of space 
Laika is one of the first animals to enter space 
to commemorate its great contribution to the study of space flight

https://t.me/BurningDogLaika_ETH
https://twitter.com/burninginu_ERC
...
contract BurningDogLaika is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Burning Dog Laika";
    string private constant _symbol = unicode"BURNING INU";
