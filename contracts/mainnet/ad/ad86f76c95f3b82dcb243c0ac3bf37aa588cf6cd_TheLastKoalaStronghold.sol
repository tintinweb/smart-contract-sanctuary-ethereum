...
contract TheLastKoalaStronghold is ERC721A, Ownable {
  ...
  constructor(uint256 cap, uint256 supply, uint256 price) ERC721A("TheLastKoalaStronghold", "TLKS") {
  ...
  function mintTo(address recipient, uint256 num) public payable {
    ...
    uint256 price = recipient == owner() ? mintPrice : mintPrice;
