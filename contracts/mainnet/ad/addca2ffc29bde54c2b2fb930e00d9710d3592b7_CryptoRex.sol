...
contract CryptoRex is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "CryptoRex";
    string private constant _symbol = "CPOREX";
    ...
    address payable private _developmentAddress = payable(0x82a500139164511D24DcCfEBf3863f2C4A51070D);
    address payable private _marketingAddress = payable(0x82a500139164511D24DcCfEBf3863f2C4A51070D);
