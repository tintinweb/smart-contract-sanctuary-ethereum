...
contract MutantBirdZuki is ERC721A, Ownable {
    string  public baseURI;
    uint256 public freeBird;
    ...
    constructor() ERC721A("MutantBirdZuki", "MutantBirdZuki", 100) {
    }
    ...
    function mint(uint256 count) public payable {
        ...
        require(totalSupply() + 1  > freeBird, "Public sale isnot live yet.");
    ...
    function freeMint() public payable {
        require(totalSupply() + 1 <= freeBird, "not available");
    ...
    function setprivateBird(uint256 _newfreeBird) public onlyOwner {
        freeBird = _newfreeBird;
    }
