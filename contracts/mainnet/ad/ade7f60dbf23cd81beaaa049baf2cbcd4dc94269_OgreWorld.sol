...
contract OgreWorld is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmRq6EZbieeV8EihyDfDTwEdhMeVnNjxkRiJ1J9Zhua222/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Ogre World", "OrWrd", MAX_MINTS, MAX_SUPPLY) {  
    ...
    function FreeMint(uint256 numTokens) public payable {
        ...
        require(numTokens <= 5 && numTokens >0);
        _safeMint(msg.sender, numTokens);
    }

    function OwnerMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
