...
/*
Degens often forget that crypto and finance in general is about speculations where the chances to hit a 1000X is quite low.
Almost non existent.
The best in the game has higher hitrate over TIME. The keyword here is TIME.

Taxes 4/4 will be used for buybacks and burn.
...
contract TIME is ERC20, Ownable {
    ...
    constructor() ERC20("THE MARKET", "TIME") {
        ...
        marketingWallet = payable(0x800a126F352D21f12c5E36149ed62327E496a66E); // set as marketing wallet
        devWallet = payable(0x800a126F352D21f12c5E36149ed62327E496a66E); // set as dev wallet
