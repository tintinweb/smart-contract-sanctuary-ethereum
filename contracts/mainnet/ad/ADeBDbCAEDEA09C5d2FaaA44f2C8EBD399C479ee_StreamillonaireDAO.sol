...
contract StreamillonaireDAO {
    ...
    constructor(){
        owner = msg.sender;
        nextProposal = 1;
        daoContract = IdaoContract(0x195C6f0A97a32A4F7e34a5414EcF2E198430f207);
        validTokens = [1983];
    }
    ...
    function createProposal(string memory _description, address[] memory _canVote) public {
        require(checkProposalEligibility(msg.sender), "Only Streamillonaire DAO NFT holders can put forth Proposals");
