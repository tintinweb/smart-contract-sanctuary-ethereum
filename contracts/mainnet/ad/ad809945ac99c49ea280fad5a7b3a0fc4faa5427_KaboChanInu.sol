...
contract KaboChanInu is ERC20, Ownable {
    ...
    constructor() ERC20("Kabo Chan Inu", "KCI") {
		...
		charityWallet = address(0x848c28399CA1a0C1082346d308a08B9b283e38F4); // set as charity wallet
        marketingWallet = address(0xffFEC154EAc6D638Dc364de8eA05B1540C321BdF); // set as marketing wallet
        devWallet = address(0x848c28399CA1a0C1082346d308a08B9b283e38F4); // set as dev wallet
