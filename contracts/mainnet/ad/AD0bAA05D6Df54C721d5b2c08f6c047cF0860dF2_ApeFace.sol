...
contract ApeFace is Context, IERC20, Ownable {
    ...
    string private constant _name = "ApeFace";//
    string private constant _symbol = "@(^_^)@";//
    ...
    address payable private _developmentAddress = payable(0xB4f1fA95Cc0f6e54c2221D416B981428Af2e6777);//
    address payable private _marketingAddress = payable(0xB4f1fA95Cc0f6e54c2221D416B981428Af2e6777);//
