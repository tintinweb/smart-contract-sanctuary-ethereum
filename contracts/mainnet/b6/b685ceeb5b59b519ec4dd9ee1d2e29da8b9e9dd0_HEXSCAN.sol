...
INITIAL BUY: 1% = 60000 
TAX: 3%
TELEGRAM: https://t.me/HexScanERC20
...
contract HEXSCAN is Context, IERC20, Ownable {
    ...
    string private constant _name = "HEXSCAN";
    string private constant _symbol = "HXS";
    ...
    uint256 private _tTotal = 6000000  * 10**9;
    uint256 private maxWalletAmount = 60001  * 10**9;
    uint256 private maxTxAmount = 60001 * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x4fa06327DC8BE4c77Ea5B3670d19d8b808FE0C44); 
        ...
        maxTxAmount = 60001  * 10**9;
        maxWalletAmount = 60001 * 10**9;
