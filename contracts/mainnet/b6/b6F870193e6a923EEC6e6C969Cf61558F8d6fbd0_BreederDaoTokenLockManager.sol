...
import "./interfaces/IBreederDaoTokenLockManager.sol";

/**
 * @title BreederDaoTokenLockManager
 ...
 */
contract BreederDaoTokenLockManager is
    MinimalProxyFactory,
    IBreederDaoTokenLockManager
{
    ...
    event TokenLockCreated(
        ...
        IBreederDaoTokenLock.Revocability revocable
    );
    ...
    function createTokenLockWallet(
        ...
        IBreederDaoTokenLock.Revocability _revocable
...
interface IBreederDaoTokenLock {
    enum Revocability {
        NotSet,
        Enabled,
        Disabled
...
import "./IBreederDaoTokenLock.sol";

interface IBreederDaoTokenLockManager {
    // -- Factory --
