...
/**
https://www.mrsrobinsonclass.net/
https://t.me/mrsrobinsonsclass
**/
...
contract Robinson is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"My First Grade Teacher";
    string private constant _symbol = unicode"MRSROBINSON";
    uint256 public _maxTxAmount =   30000 * 10**_decimals;
    uint256 public _maxWalletSize = 30000 * 10**_decimals;
    uint256 public _taxSwapThreshold=5500 * 10**_decimals;
    uint256 public _maxTaxSwap=5500 * 10**_decimals;
