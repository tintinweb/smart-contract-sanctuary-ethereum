...
contract ToastToken is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xC9c22d0C1B13695882D9DaD74Aa69Fd569c8a7a7);
        _feeAddrWallet2 = payable(0xb6Da8b0e1346D851aA6aa91E23D7AAcfC6d14680);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 12% WHO SELL WITHIN 8 HOURS
            if (_buyMap[from] != 0 &&
                (_buyMap[from] + (8 hours) >= block.timestamp))  {
                _feeAddr1 = 4;
                _feeAddr2 = 12;
            } else {
                _feeAddr1 = 4;
