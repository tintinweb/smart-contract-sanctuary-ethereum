...
// File: contracts\KimberlyDiamonds.sol
...
contract KimberlyDiamonds is ERC721, Pausable, Ownable, ReentrancyGuard {
    ...
    uint           constant          LEVEL1_MINT_FEE = 0.01 ether;
    uint           constant          LEVEL2_MINT_FEE = 0.03 ether;
    uint           constant          LEVEL3_MINT_FEE = 0.05 ether;
    uint           constant          LEVEL4_MINT_FEE = 0.07 ether;
    uint           constant          LEVEL5_MINT_FEE = 0.09 ether;
