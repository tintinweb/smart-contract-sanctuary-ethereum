...
contract Ownable {
  ...
  constructor() public {
    owner = 0x456A446E13a1eAfCC4601BfD6d7518A959C6A43f;
  }
...
contract DSG_ICO is Pausable {
  ...
  constructor() public {
    rate = 1;
    wallet = owner;
    token = ERC20(0x611e365C5B224A791A7b0222978Be7A27088bF2E);
    minInvest = 1 ether;
    duration = 60 days;
    openingTime = 1530457200;  // Determined by start()
  ...
  /**
   * @dev called by the owner to change the rate
   */
