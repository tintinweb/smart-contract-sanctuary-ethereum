...
contract BabyAvocado is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes {
    constructor() ERC20("Baby Avocado", "BACO") ERC20Permit("Baby Avocado") {
        _mint(msg.sender, 212251221531415 * 10 ** decimals());
    }
