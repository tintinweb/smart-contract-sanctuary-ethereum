...
// File: Todoro/ReentrancyGuard.sol
...
// File: Todoro/IERC721Receiver.sol
...
// File: Todoro/IERC721Metadata.sol
...
// File: Todoro/IERC721Enumerable.sol
...
contract Todoro is Ownable, ERC721A, ReentrancyGuard {
    uint256 private _publicPrice = 0.015 ether;
    ...
    uint256 private _maxMint = 1922;
    address private _team = 0xE5617feC6F6Dc51B7AAca8A35bC85Eb03c609C0f;
    ...
    constructor() ERC721A("Todoro", "TODO", _maxPerTransaction, _maxMint) {}
    ...
    modifier mintGuard(uint256 tokenCount) {
        ...
        // Price check
        if (isPublicMint) {
            require(_publicPrice * tokenCount <= msg.value, "Insufficient funds (P)");
        } else {
            require(_presalePrice * tokenCount <= msg.value, "Insufficient funds (WL)");
        }
