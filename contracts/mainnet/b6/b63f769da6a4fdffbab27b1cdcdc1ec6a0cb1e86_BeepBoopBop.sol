...
contract BeepBoopBop is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private supply;

    string public uriPrefix = "ipfs://QmPuVz2wc6jrB9wjAi5YAfBv4rL1NSyeca2X2W3brmhVk5/";
    string public uriSuffix = ".json";
    string public hiddenMetadataUri;
    
    uint256 public publicsaleCost = 0.095 ether;
    ...
    constructor() ERC721("Beep Boop Bop", "BBB") {
        setHiddenMetadataUri("https://musicpromotiontoday.com/bbb/placeholder.json");
    }
