    ...
    VRFConsumerBase
{
    ...
    struct RaffleStruct {
        ...
        uint256 totalEntriesCap; // max amount of entries the raffle can have
    }
    ...
    /// @param _totalEntryCap max amount of entries the raffle can have
    ...
    function createRaffle(
        ...
        RaffleStruct memory raffle = RaffleStruct({
            ...
            totalEntriesCap: _totalEntryCap
        });
...
*/
    ...
    function buyEntry(
        ...
        require((raffle.totalEntriesCap == 0 || (raffle.entriesLength + priceStruct.numEntries <= raffle.totalEntriesCap)), "Total Cap Entries reached");
