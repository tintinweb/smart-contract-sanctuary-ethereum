...
contract LndiaDiwaliAgreement is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Lndia Diwali Agreement";
    string private constant _symbol = "$LDA 20";
