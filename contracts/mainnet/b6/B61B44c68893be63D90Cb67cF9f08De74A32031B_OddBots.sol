...
contract OddBots is Ownable, ERC721 {
    
    uint public tokenPrice = 0.08825 ether;
    uint constant maxSupply = 8825;
    uint public presale_price = 0.08825 ether;
    ...
    uint public _walletLimit=20; //Max Limit for perwallet
  
         
    constructor() ERC721("OddBots", "OddBots"){}
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0xE207E6D083b7Cb973e73453aBe9dF1AfeF57ae26).transfer(_balance * 30 / 100); 
        payable(0xFf560af8083E293aDF5ac82c9b5aCb2B002E7773).transfer(_balance * 30 / 100); 
        payable(0xC82F0d78b5Ab127d6040e83acdD2bbeaf037A7C9).transfer(_balance * 15 / 100); 
        payable(0xB49468C708Ac2B355D10AeDA8f9f6B10E3922Fa7).transfer(_balance * 15 / 100);
        payable(0x1932bB256f213Dc83b0fc5c5924d38134f11833B).transfer(_balance * 5 / 100); 
        payable(0xF137215aDBe8755C21f030Fc329fA46892cD5d2C).transfer(_balance * 5 / 100);
    }
