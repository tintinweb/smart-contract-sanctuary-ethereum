...
interface IFragmentMiniGame {
    ...
    /// @notice Emitted when a fragment group has been unregistered.
    ...
    /// @notice Emitted when the contract name has been set.
    event NameSet(string name);

    /// @notice Emitted when the contract symbol has been set.
    event SymbolSet(string symbol);

    /// @notice Thrown when the Object group at a given groupId exists.
    ...
    /// @notice Thrown when the Fragment group at a given groupId exists.
    ...
    /// @notice Thrown when attempting to unregister a fragment group but invalid group/secret hash pair had been submitted.
    ...
    /// @param fragmentAccountCap The maximum amount of fragments that can be minted by a single account.
    function registerFragmentGroup(
        string calldata groupName,
        uint128[] calldata fragmentSupply,
        bytes32 secretHash,
    ...
    /// @notice Unregister a fragment group.
    ...
    /// @notice Unregister an object group.
