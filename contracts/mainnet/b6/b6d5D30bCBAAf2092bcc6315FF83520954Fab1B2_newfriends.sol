...
contract newfriends is Ownable, ERC721A,  PaymentSplitter, ReentrancyGuard {
    uint256 public MAX_SUPPLY = 8888;
    uint256 public constant PRICE = 0.035 ether;
    uint256 public maxPresale = 8;
    uint256 public maxFree = 8;
    uint256 public maxPublicTx = 8; //max per tx public mint
