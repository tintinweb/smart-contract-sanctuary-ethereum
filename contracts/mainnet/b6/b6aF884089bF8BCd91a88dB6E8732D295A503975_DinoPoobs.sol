...
contract DinoPoobs is ERC721A, Ownable {
    ...
    constructor(
        ...
        uint256 _maxSupply
    ) ERC721A ("Dino Poobs", "DP") {
        baseTokenURI = _baseTokenURI;
        maxSupply = _maxSupply;
        _safeMint(_msgSender(), 1);
    }

    function DinoPoobBreakTheShell(uint256 _quantity) external  payable {
    ...
    function devMint(address[] memory marketmintaddress, uint256[] memory mintquantity) public payable  onlyOwner {
