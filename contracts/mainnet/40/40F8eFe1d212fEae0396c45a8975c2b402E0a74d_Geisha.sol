...
/**
     A meme token combined with NFT utility will
     dance towards the ERC20 chain. As this token 
     conversate and song to the desires of the market,
     Geisha will entertain and bring us to the glimpse 
     of Decentralized Finance enchantment.

Telegram: https://t.me/GeishaERC20

Medium: https://medium.com/@geisha2022/the-geisha-wants-to-entertain-all-investors-by-her-japanese-performing-art-style-4dac55d39d3f

Gitbook: https://geisha.gitbook.io/geisha-erc20/
...
contract Geisha is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xD904E6CB071A3bDB637ac048Cf75ea57cFF604ef); 
    address payable public Wallet_Team = payable(0x92848d8c7c21F6E0170DE8A41516909Fa61b7fD2);
    ...
    constructor () {
        ...
        _owner = 0x92848d8c7c21F6E0170DE8A41516909Fa61b7fD2;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD904E6CB071A3bDB637ac048Cf75ea57cFF604ef); // Testnet
