...
contract ROTA is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint public MAX_TX = 200;

    bool private isRevealed = false;

    uint public wl_price = 0 ether;
    uint public public_price = 0.0049 ether;

    uint public saleStartTime = 1649298400;

    bytes32 public merkleRoot;

    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("ROTA - Rise of The Apes", "ROTA")
    {
        baseURI = _baseURI;
