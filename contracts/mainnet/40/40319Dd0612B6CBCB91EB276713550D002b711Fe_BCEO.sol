...
- 420 Quadrillion Supply
- 5% Buy & 5% Sell
- No Blacklist
- No Transaction Limit

Telegram: https://t.me/BaByDogeCEOEN
Twitter: https://twitter.com/TheRealBCEO
*/
...
contract BCEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xaaa245D0b7ACc5129d4284d61e127B612e5219c8;
    address public opsWallet = 0xc520247F4F0C9B3E6819Ac6d9822f83535179F75;
    address public devWallet = 0x640e8938b5aECca43C0f67C0b566900590188FaF;

    string private constant _name = "BabyDoge CEO";
    string private constant _symbol = "BCEO";
    ...
    Taxes public taxes = Taxes(1, 2, 1, 0, 1);
    Taxes public sellTaxes = Taxes(1, 2, 1, 0, 1);
