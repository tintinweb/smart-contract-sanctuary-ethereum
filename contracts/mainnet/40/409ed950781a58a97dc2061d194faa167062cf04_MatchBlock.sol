...
contract MatchBlock is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Match Block";
    string private constant _symbol = "MATCHBLOK";
