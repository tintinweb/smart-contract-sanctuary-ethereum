...
/^^         /^^/^^       /^^  /^^^^^   /^^      /^^/^^      /^^/^^         /^^
            ...
            𓂀             RAH - PATH OF OATH            𓂀                   
                                                                                       
Teh one who deserves to survive is teh one who has teh will to make it happen.  
...
contract AMUNRA is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "The Sun";
    string private _symbol = "AMUNRA";
    ...
    uint256 private _totalSupply = 10987654321 * 10**_decimals; 
    ...
    address _owner;
    address payable public marketingAddress = payable(0x50D441aC6349746C62Cccd4f2D6D96f2e75478D3);
