...
$GUD is doing really $GUD, and GUD BABY - $GBABY - is here to support his daddy.

$GBABY is here to further spread $GUD vibes, and support the big daddy with buybacks and by sending LP.
...
contract GudBABY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GUD BABY";
    string private constant _symbol = unicode"GBABY";
