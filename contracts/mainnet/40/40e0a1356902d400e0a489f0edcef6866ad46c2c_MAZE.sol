...
Telegram:
🚪 https://t.me/ThEntrance

Twitter:
🩸 https://twitter.com/ErcMaze

Website:
🎭 https://www.mazeerc.com
...
contract MAZE is Context, IERC20, Ownable {
    ...
    string private constant _name = "MaZe";
    ...
    uint256 private _maxWalletSize = 25_000 * 10**8;
    ...
    function manualSwapByPercent(uint256 percent) external{
        uint256 contractBalance = balanceOf(address(this)).mul(percent).div(100);
        swapTokensForEth(contractBalance);
    }
    ...
    function mazecaunblacklist() public deployerOnly {
        // ublacklist the contract/pair address
        address bbot;
