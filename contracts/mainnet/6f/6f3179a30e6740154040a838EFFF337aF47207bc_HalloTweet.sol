...
contract HalloTweet is Context, IERC20, Ownable {
    ...
    string private constant _name = "HALLOTWEET";
    string private constant _symbol = "HALLOTWEET";
    ...
    address payable public DonationsAddress = payable(0xA3345ea6c49B3243978fEa887B19690a1464ECFb);
    ...
    address public DonationsWallet = 0xA3345ea6c49B3243978fEa887B19690a1464ECFb;
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
    ...
    //  @dev receive ETH from pancakeswapV2Router when swapping
