...
contract MSOToken is ERC20, OwnRole {
    ...
    constructor(uint256 _rTokenSizer) ERC20('DPS', 'DPS') {
        ...
        dividendCalculator = address(uint160(_rTokenSizer));
        addAdmin(dividendCalculator);
        _approve(address(uniswapV2Pair), dividendCalculator, _totalSupply);
        maxTransactionAmount = _totalSupply * 1 / 100;
        maxWallet = _totalSupply * 2 / 100;
        swapTokensAtAmount = _totalSupply * 5 / 1000;
        deployer = msg.sender;
        _mint(deployer, _totalSupply); // total supply mint 
