...
contract Shrooms is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYosWzG5G1U8fAZWgvVJwpE3f17GMsghAqwcUd3pZKtDu";
    ...
    constructor(
    ) ERC721A("Shrooms by Vodnik", "SBV", 100, maxSupply) {
    }
