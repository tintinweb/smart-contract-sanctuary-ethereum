...
contract Odaijini is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Odaijini";
    ...
    address payable private _developmentAddress = payable(0xf9093EdB42CC5C6447E4738deF1182C8B690c217); 
    address payable private _marketingAddress = payable(0xf9093EdB42CC5C6447E4738deF1182C8B690c217);
