...
contract DOMINO is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("DOMINO", "DOMINO") { // 
        marketingWallet = payable(0x4Bc0ffC5c747476cba6479DfA1A33450dFA8eea9); // 
        devWallet = payable(0x4Bc0ffC5c747476cba6479DfA1A33450dFA8eea9); // 
