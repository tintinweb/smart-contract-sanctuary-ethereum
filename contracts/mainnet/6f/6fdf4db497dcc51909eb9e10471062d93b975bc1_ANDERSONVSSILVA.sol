...
contract ANDERSONVSSILVA is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "PVS";
 string private _symbol = "PVS";
 ...
 address _owner;
 address payable public marketingAddress = payable(0xAE07464Ff1FcF6d41a10c61449c68bE5a79680B1);
 ...
 //Tokenomics related functions
  function PVSDay() public onlyOwner{
      require(block.timestamp > PVSDaycooldown, "You cant call PVSCoinDay more than once a day");
 ...
 function PVSCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      PVSDaycooldown = block.timestamp + 86400;
 }
