...
contract MATRIX is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE MATRIX PROTOCOL";
    ...
    address payable private _developmentAddress = payable(0xeC793d3682A8F3b1c0bB5e8A83E60caF16570fdD);
    address payable private _marketingAddress = payable(0xeC793d3682A8F3b1c0bB5e8A83E60caF16570fdD);
    ...
    function setZeroFeeAndLimits() public onlyOwner{
     _redisFeeOnBuy = 0;
     _taxFeeOnBuy = 0;
     _redisFeeOnSell = 0;
     _taxFeeOnSell = 0;
