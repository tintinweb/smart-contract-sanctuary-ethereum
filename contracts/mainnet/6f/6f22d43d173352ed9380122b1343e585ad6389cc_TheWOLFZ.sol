...
contract TheWOLFZ is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "TheWOLFZ"; 
    string private constant _symbol = "WOLFZ"; 
    ...
    address payable private _developmentAddress = payable(0xcB800570223b1549EE4581063D253061665ca584);
    address payable private _marketingAddress = payable(0xdEd5007f673973fcF5822C5a5f1cEebd5eb4AD11);
