...
contract QD is Ownable, ERC20, ReentrancyGuard {
    ...
    uint constant internal _USDT_DECIMALS = 1e6;
    uint constant public PRECISION = 1e18;
    
    uint constant public SALE_LENGTH = 54 days; 
    uint constant public MAX_QD_PER_DAY = 777_777;
    uint constant public delta = 101_010_000_000_000_018;
    uint constant public start_price = 44 * PRECISION / 100; // = 44B / Elon
    ...
    address immutable public tether; // never changed
