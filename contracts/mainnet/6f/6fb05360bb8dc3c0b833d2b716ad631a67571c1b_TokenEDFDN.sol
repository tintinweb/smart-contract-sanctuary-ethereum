...
contract TokenEDFDN is ERC721, Ownable {
	...
	string public baseURI = "ipfs://QmeMiWZZQfS2Q1777uP9n8VsQjYpgxL8kXrRnDicRSXJEs/";
	...
	uint256 public constant MINT_PRICE = 4.95 ether;

	bool private _locked = false; // for re-entrancy guard

	// Initializes the contract by setting a `name` and a `symbol`
	constructor() ERC721( "Match number #64. Final. Lusail Stadium (First category)" , "LSFCSF" ) {
		_supply.increment();
