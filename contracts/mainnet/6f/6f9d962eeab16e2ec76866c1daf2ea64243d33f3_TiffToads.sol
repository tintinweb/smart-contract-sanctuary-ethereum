...
contract TiffToads is IERC721A { 
    ...
    uint256 public constant FREE_THRESHOLD = 2000;
    uint256 public constant MAX_SUPPLY = 5000;
    uint256 public constant MAX_PER_WALLET = 10;
    uint256 public constant MAX_FREE_PER_WALLET = 5;
    uint256 public constant COST = 0.001 ether;

    string private constant _name = "TiffToads";
    string private constant _symbol = "TIFFTOAD";
    string private _contractURI = "QmeufsCAa6F6PoUN5rrkEtCzENv8rgrAvZ7hW6oVB3LfX9";
    string private _baseURI = "QmVKX3LFx1GTefWYn8QdyKPxLfYQ1M6ZfXAEU4DD9HpigD";
