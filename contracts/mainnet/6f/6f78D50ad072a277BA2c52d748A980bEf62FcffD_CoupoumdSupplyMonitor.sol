...
interface IComet {
    ...
    function totalsCollateral(address asset)
        external
        view
        returns (TotalsCollateral memory);
...
contract CoupoumdSupplyMonitor {
    ...
    constructor(address _owner) {
        owner = _owner;
        compoundStrategy = 0x3adf0870aEfBf93d3efe2aFFF9b9aB287282A3aC; //0x3adf0870aEfBf93d3efe2aFFF9b9aB287282A3aC
    ...
    function getCTokenLiquidity(address underlying, address cToken)
        external
        view
        returns (uint256)
    {
    ...
    function isCompoundV3WethLiquidityInsufficient(uint256 _WethAmountThreshold)
        internal
        view
        returns (bool)
    {
    ...
    function getBaseTokenBalance(address _pool, address _vault)
        external
        view
        returns (uint256)
    {
    ...
    function checker(address _vault, uint256 _wEthCashThreshold)
        external
        view
        returns (bool canExec, bytes memory execPayload)
    {
