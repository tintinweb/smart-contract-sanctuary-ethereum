...
//Telegram : https://t.me/SafeAIERCPortal
//Website : Https://safeai.network

/*
    SAFE AI is a Contract Bot scanner analyzer that can scan functions in contracts that can detect anomalies or fraud attempts
...
contract SAFE_AI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SAFE AI", "SAI") {
        ...
        marketingWallet = address(0x8793FdB6fe42b6D57cc357485fED4Af08c49d2Be); // set as marketing wallet
        devWallet = address(0x8793FdB6fe42b6D57cc357485fED4Af08c49d2Be); // set as dev wallet
