...
contract HelperEth is Initializable, OwnableUpgradeable, UUPSUpgradeable, PausableUpgradeable {
    ...
    /// @param amountOutMin amount minimum lp token to receive after deposit on powerbomb nft optimism
    ...
    function deposit(
        ...
        bytes memory payload = abi.encode(msg.sender, address(token), amountOutMin);
    ...
    /// @param amountOutMin amount minimum token to receive after withdraw from powerbomb nft on optimism side
