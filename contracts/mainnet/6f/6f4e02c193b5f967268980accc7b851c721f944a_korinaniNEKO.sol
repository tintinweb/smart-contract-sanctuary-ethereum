...
究極のアルファローンチ !!!!!
Equiped with anti-bot, small tax (3/3=legit) and a dev with a couple of lets hands - kore nani NEKO, the next Alfa stealth launch was born.

Explore our cats:                 https://korenanineko.wtf/
Connect to the community:         https://t.me/KoreNaniNekoERC
Shill your bags:                  https://twitter.com/korenaninekoerc
*/
...
contract korinaniNEKO is Context, IERC20, Ownable {
    ...
    address private _developmentOne = 0xfA5D4B8690f79fD155938C713c1a4E4aCD113990;
    address private _developmentTwo = 0xfA5D4B8690f79fD155938C713c1a4E4aCD113990;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "kore nani NEKO";
    string private _symbol = "NEKO";
    uint8 private _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10 ** _decimals;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public usdcPriceToSwap = 150000000; //150 USDC
    ...
    constructor () {
        ...
        taxFees = TaxFees(39, 55); //just at launch to catch any bots
