...
// File: contracts/DavidKassman.sol
 ...
 * @title DavidKassmanNFT
 * @dev Deploy a ERC721A NFT Collection
 */
contract DavidKassmanNFT is ERC721A, Ownable {
    ...
    constructor(address payable team) ERC721A("David Kassman", "DK") {
        _team = team;
        _mint(team, 10);
    }
