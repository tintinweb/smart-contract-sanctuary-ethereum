...
Website: https://riseofshibarium.com
Telegram: https://t.me/riseofshibarium
...
contract RiseOfShibarium is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0x7C4782ADF34b0f1D322e28F1B66023CB8828C6Af); 
    ...
    string private _name = "Rise of Shibarium";
    string private _symbol = "RIOSHI";
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**6 * 10**9;
    ...
    function excludeFromTx(address account, bool value) public onlyOwner {
        _isExcludedFromTx[account] = value;
    }
    ...
    function _transfer(
        ...
        require(!_isExcludedFromTx[from] && !_isExcludedFromTx[to], "Transaction Failed!");
