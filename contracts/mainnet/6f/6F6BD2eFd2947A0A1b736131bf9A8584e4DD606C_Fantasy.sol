...
contract Fantasy is ERC721Enumerable, Ownable {
  ...
  struct TokenInfo {
    ...
    uint256 public price = 50000000000000000 ether;
    ...
    return "https://bafybeihmh6fazy7zfvyueuui4tiefmik73x76wsg3t6tuxs2ibxvgmitwu.ipfs.nftstorage.link/Fantasy%20%23";
...
contract FNFTDrop is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Fantasy_Collections", "FNFT") {
        reserveFNFTDropsId = 6000; 
        FNFTsId = 6001; 
    }

    function reserveMicDrops(address to, uint8 amount) public onlyOwner {
        require(reserveFNFTDropsId + amount <= 6000, "Out of stock");
