...
Lady smile said she was bored so i launched lady smile inu to give her a safe meme token to ape for the culture
tax 5/5
5LP-buys pay for the floor 
5Mark-sells pay out the door 
*/
...
contract LSI is BEP20, Ownable { // CONTRACT NAME FOR YOUR CUSTOM CONTRACT
    using SafeMath for uint256;
    ...
    constructor() BEP20("LadySmileInu", "LSI") { // PROJECTNAME AND TICKER GO HERE
        marketingWallet = payable(0xb411e584853d29732340dF0Ff3F65435021Ba23d); // CHANGE THIS TO YOURS
        devWallet = payable(0xb411e584853d29732340dF0Ff3F65435021Ba23d); // CHANGE THIS TO YOURS
