...
contract OthersideDAO is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public  SPRICE = 0.01 ether; 
  ...
  uint256 public freeAllowed = 500;



  uint public status = 0; //0-pause 1-Public

  constructor() ERC721A("OthersideDAO Pass","OthersideDAO Pass") {
    _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/QmeugKM5RWpx8ZY6xW27Fu1pmsvTiMddSNPaeEgFBenNrv/OthersideDAOPass.json";
  }
  ...
  function changeFreeAllowed(uint256 q) external onlyOwner
  {
      freeAllowed = q;
  }
