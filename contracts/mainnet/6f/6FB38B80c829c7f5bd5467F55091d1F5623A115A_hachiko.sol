...
https://t.me/hachikoin 

This launch is in the honor of Hachikō, the OG HODL'er
...
`%/%%%%//%%//,%%%///%%%%@@@[email protected]@@@@@@@@@@@@@@S%%%%////%%,///%%%%%' 
  ...
  `%%%//%%%%/,%%%%@%@@@@@@@@@@@@@@@@@@@@@@@@@[email protected]@%%%%%,/////%%' 
   `%%%//%%%/,%%%@@@[email protected]@[email protected]@@@@@@@@@@@@[email protected]@@@@@%%%,//%%//%' 
    `%%%%%%/  %%[email protected]@[email protected]@@@@Ss` .,,.    '[email protected]@@[email protected]@@@%'  ///%/%' 
...
contract hachiko is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hachikō Inu";
    string private constant _symbol = unicode"HACHIKOIN";
