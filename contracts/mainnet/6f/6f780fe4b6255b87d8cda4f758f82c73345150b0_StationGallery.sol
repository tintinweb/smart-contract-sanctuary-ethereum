...
contract StationGallery is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    string public name = "Station Gallery - Kaleidoscope";
    string public symbol = "KLSP";

    constructor() ERC1155("https://nft.niftable.org/api/stnglry/raeavv/klsp/{id}") {}
