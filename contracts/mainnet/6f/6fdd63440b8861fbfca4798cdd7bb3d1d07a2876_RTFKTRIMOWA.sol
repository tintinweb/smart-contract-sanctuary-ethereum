...
contract RTFKTRIMOWA is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "";
    uint   public price             = 0 ether;
    uint   public maxPerTx          = 100;
    uint   public maxPerFree        = 15;
    uint   public maxPerWallet      = 5000;
    ...
    constructor() ERC721A("RTFKT x RIMOWA", "RIMOWA"){}
