...
contract LAMPBANK is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x4b57f4354708C0e993898B7D3eC9AEAbEb8020Fa));

    string private _name = "LAMPBANK";
    string private _symbol = "LBANK";
