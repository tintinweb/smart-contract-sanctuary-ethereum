...
contract Revengebirds is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 8000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = ".link/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Revengebirds", "RVBR", MAX_MINTS, MAX_SUPPLY) {  
    ...
    function ListMint(uint256 numTokens) public payable onlyOwner {
        _safeMint(msg.sender, numTokens);
    }
