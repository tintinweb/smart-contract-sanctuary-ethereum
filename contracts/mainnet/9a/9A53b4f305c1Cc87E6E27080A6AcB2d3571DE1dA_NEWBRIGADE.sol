...
contract NEWBRIGADE  is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyFee = 2; 
    uint256 public maxSellFee = 2; 
    ...
    string private constant _name = "Special Force";
    string private constant _symbol = "Shinsengumi";
