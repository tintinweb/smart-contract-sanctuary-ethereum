...
pragma solidity ^0.6.12;
    ...
    contract Shimizu is Context, IERC20, Ownable {
        ...
        uint256 public _numTokensSellToAddToLiquidity = 40 * 10**6 * 10**18;
        uint256 public _maxWalletToken = 50 * 10**6 * 10**18; //
    
        IUniswapRouter02 public immutable pcsV2Router;
        address public immutable pcsV2Pair;
    
        string private _name = "Shimizu";
