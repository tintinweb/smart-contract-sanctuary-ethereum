...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Artificial Inu";
    string private _symbol = "AINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B8DF75066735fFD4A72257BCdd734F7A4faF433); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x1B8DF75066735fFD4A72257BCdd734F7A4faF433); // BuyBack Address
