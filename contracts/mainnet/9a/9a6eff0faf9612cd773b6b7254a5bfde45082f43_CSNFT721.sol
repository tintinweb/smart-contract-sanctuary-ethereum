...
contract CSNFT721 is Context, ERC165, IERC721, IERC721Metadata, Ownable, IERC721Enumerable, ReentrancyGuard {
    ...
    * @dev _setConduit
    */
    function _setConduit(address _conduit) internal virtual {
        conduit = _conduit;
    }
     ...
     * @dev setConduit.
     */
    function setConduit(address _conduit) external onlyOwner {
        _setConduit(_conduit);
    }
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory data) public virtual override {  
        ...
        if(!_exists(tokenId)){
            if (msg.sender != tokenId.tokenCreator() && msg.sender != platform && msg.sender != conduit) {
