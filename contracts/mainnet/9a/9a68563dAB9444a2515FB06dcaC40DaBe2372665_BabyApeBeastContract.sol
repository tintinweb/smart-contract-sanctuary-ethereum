...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmNaUNRp7XjKS2kVzF5S3PTgruedStWzwVCkhwYkGYU5ms/";
        ...
        constructor(
            ...
            payableAddresses.push(0xFf7E98664fFE33401Bc85E71DecCE1cFBEe561eD);
    ...
    // File: contracts/babyApeBeastContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract BabyApeBeastContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Baby Ape Beast ", "BABNFT", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/IvYr3XSn4yVyDXPg3TzO/contract-metadata";
        }
    }