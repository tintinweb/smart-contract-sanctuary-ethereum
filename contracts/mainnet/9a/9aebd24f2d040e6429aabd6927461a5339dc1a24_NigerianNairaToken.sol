...
contract NigerianNairaToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function NigerianNairaToken() {
        ...
        name = "NigerianNairaToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 2;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "NGNT";                                             // Set the symbol for display purposes (CHANGE THIS)
        unitsOneEthCanBuy = 111111;                                      // Set the price of your token for the ICO (CHANGE THIS)
