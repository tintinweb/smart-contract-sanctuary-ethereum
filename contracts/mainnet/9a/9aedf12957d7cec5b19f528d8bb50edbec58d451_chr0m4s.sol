...
// File: contracts/machinesbymechanic.sol
...
contract chr0m4s is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  uint256 public  maxSupply = 450;
  string  public  baseTokenURI = "ipfs://bafybeibpxjtf3bvi4my5yk745ituzrbahwzcze5n5pjjdplnargwfgd6jq/";
  ...
  constructor() ERC721A("machinesbymechanics", "mBYm") {
  }
