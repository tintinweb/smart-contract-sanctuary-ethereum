...
Extreme Hyperdeflationary Token, Uniswap (ETH), Forked CA, 3% tax

1% burn 1% $FROGMASTER relfections, 1% LP add

https://t.me/FROGMASTEReth
*/
...
contract FROGMASTER is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0x6ea98Ab153245bBB80ef4744423484B0D29f3CE1);
  ...
  string private constant _name = 'FROGMASTER';
  string private constant _symbol = 'FROGMASTER';
