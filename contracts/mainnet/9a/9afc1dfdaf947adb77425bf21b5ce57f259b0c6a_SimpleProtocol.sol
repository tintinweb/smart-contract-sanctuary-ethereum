...
/*
Simple Protocol aims to solve the problem for all degens and investors. It’s simple, only 1/1 tax going to liquidity.

SimpleSwap

We will be building SimpleSwap which will allow users to trade coins without needing to adjust slippage, gas or gwei on trades. 

https://t.me/simpleprotocol

https://twitter.com/SimpleERC20
*/
...
contract SimpleProtocol is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Simple Protocol";
    string private constant _symbol = "$SIMPLE";
    uint8 private constant _decimals = 9;

    mapping(address => bool) public bots; mapping (address => uint256) public _buyMap;
    address payable private _developmentAddress = payable(0x23B4E0cb0e1b4049cb4E4F23C50083Aa1941D566);
    address payable private _marketingAddress = payable(0x23B4E0cb0e1b4049cb4E4F23C50083Aa1941D566);
