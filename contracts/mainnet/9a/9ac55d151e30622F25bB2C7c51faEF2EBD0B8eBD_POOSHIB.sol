...
contract POOSHIB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "PooShib";
    string private constant _symbol = "POOSHIB";
    ...
    address payable private _developmentAddress = payable(0xFdfa00ecB96a3eEcaE6515aaa0F78Cf0E66F581A); 
    address payable private _marketingAddress = payable(0x315DEdd5e2495493f7d37Fdf938780512b3d974b);
