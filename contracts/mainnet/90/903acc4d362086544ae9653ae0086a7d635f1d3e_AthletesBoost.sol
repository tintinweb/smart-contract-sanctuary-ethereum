...
contract AthletesBoost is ERC20, Ownable {
    ...
    constructor() ERC20("Athletes Boost", "ABOOST") {
		...
		charityWallet = address(0x3D64382AD2BbFE36E5855830578aC7861C2195B4); // set as charity wallet
        marketingWallet = address(0x05Dc1B92ae2C072a8f9e56C8b8C31Ff69Ccf0974); // set as marketing wallet
        devWallet = address(0x894C9683f5aB538D35ec7B8BC3FA8569162405B2); // set as dev wallet
