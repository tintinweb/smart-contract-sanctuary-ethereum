...
Anyone wallet that holds 1 whole token or more becomes an ‘Enlightened One’

‘Enlightened Ones’ are entered into a prize draw to win ETH hourly.

There is an autoburn on every transaction making each 1 token more valuable over time as supply will be forever decreasing!

ETH prizes increase over time and are relevant to the trading volume over a period of time.

WITH A SUPPLY OF ONLY 100 TOKENS, ITS EASY TO BECOME AN ENLIGHTENED ONE, JUST HOLD A MINIMUM OF 1 TOKEN.

https://linktr.ee/enlightenment111
*/
...
contract Enlightenment is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Enlightenment", "111") {
        ...
        devWallet = 0xBd3515683bb8C2FdBfA004c9B75a142DBFC62b23;
