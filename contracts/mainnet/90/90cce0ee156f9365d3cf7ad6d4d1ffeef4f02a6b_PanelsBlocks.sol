...
contract PanelsBlocks is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Non-Fungible Panel-Block", "NBP") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("https://data.thepanels.art/blocks/", _toString(tokenId)));
    }
