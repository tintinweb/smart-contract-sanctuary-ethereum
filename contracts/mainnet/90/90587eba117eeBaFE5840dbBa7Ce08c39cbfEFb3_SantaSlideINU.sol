...
/**
Website: https://santaslideinu.com/
TG: https://t.me/SantaSlideINU_Portal

SantaSlideINU is a 3D game that you can play on desktop or mobile, 
created by experienced developers that wanted to do something fun 
for the holiday season. 

On Santa Slide, you play as Santa skiing through the mountains, 
gathering gifts on the way down. Once certain levels are reached,
you will be verified that you are a holder and awarded the prize. 
Your mission, should you choose to accept, is to reach SBF at 
10,000 points to unlock the grand prize! 

Do you have what it takes to reach Sam and collect the prize?
...
contract SantaSlideINU is ERC20, Ownable {
    ...
    constructor() ERC20("Santa Slide INU", "SSI") {
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee + buyOpsFee;

        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevFee = _sellDevFee;
        sellOpsFee = _sellOpsFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee + sellOpsFee;

        marketingWallet = address(0x035E8709De757c288253d82083B8e02509C0D5EF); 
        devWallet = address(0x552465DAfbBf788C0774a8CAA6EBa6D5c9bCe34D); 
        liqWallet = address(0xa9b44EB4151B8b5c3623804fD715Ce8c4f0e4F20); 
        opsWallet = address(0xb3B8fD6168956511e728DEFbB8068941b21ACA9f);
