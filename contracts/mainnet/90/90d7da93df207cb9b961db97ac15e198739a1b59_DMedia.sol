...
We provide everything you need to run a membership program, so you can get started quickly and start earning.

Telegram 
https://t.me/DmediaERC20	
Website 
https://decentralised.media	
Twitter
https://twitter.com/DmediaERC20
...
contract DMedia is Context, IERC20, Ownable {
    ...
    string private constant _name = "DMedia";
    string private constant _symbol = "DMedia";
    uint256 public _maxTxAmount = 20000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 20000000000 * 10**_decimals;
    uint256 public _taxSwap= 5000000000 * 10**_decimals;
