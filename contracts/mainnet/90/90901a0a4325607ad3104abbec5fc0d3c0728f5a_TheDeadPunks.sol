...
contract TheDeadPunks is IERC721A { 
    ...
    uint256 public constant MAX_SUPPLY = 665;
    uint256 public MAX_FREE = 665;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "The Dead Punks";
    string private constant _symbol = "DEADPUNK";
    string private _baseURI = "QmZ1cmtdxBuFZXWFcASzXfpWkRhswt9sm8GrhyRuwr3b4Q";
