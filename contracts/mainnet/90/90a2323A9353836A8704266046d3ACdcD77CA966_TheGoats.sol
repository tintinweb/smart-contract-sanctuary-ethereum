...
contract TheGoats is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeifgwbm4tcdhkvid44pj2xamtz2diynco5k34wexzrsoi44tg2nx7i/";
    uint   public price             = 0.002 ether;
    uint   public maxPerTx          = 30;
    uint   public maxPerFree        = 1;
    uint   public maxPerWallet      = 31;
    uint   public totalFree         = 2022;
    uint   public maxSupply         = 2022;
    ...
    constructor() ERC721A("The Goats", "GOATS"){}
