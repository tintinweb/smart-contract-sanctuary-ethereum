...
Backing community leaders with DAO, generating yields, and forming relationships across alpha stage projects.

Get in early, stealth launching soon.

0% tax, LP locked for 365 days, and partnerships with top influencers.

First Community Chatroom https://t.me/HorizonCapitalETH
...
contract HORIZON is Ownable {
    constructor(
        ...
        _fee = 0;
        _decimals = 9;
        _tTotal = 100000000000000000 * 10**_decimals;
