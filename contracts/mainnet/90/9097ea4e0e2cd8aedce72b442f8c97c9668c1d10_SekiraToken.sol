...
Token from Sekira Team (NFT https://opensea.io/collection/official-sekira/)

Website: https://sekira-nft.com/

Twitter: https://twitter.com/Sekira_NFT

Changing NFT forever.
...
contract SekiraToken is Context, IERC20, Ownable {
    ...
    address sekiratax = 0xe1f11449328b1e5f7B72d389eAdaC63EF87C1cdc;
    ...
    string private constant _name = unicode"Sekira Token";
    string private constant _symbol = unicode"Sekira Token";
