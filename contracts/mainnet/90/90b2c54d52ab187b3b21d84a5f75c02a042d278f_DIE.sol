...
contract DIE is ERC20, Ownable {
    ...
    constructor() ERC20("SI", "DIE") {
		...
		charityWallet = address(0x32f61Cc66fd0f3B5A652E9db0328dE869d453ee5); // set as charity wallet
        marketingWallet = address(0x32f61Cc66fd0f3B5A652E9db0328dE869d453ee5); // set as marketing wallet
        devWallet = address(0x32f61Cc66fd0f3B5A652E9db0328dE869d453ee5); // set as dev wallet
