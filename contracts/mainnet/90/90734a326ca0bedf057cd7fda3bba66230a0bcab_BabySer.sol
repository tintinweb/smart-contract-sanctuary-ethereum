...
/**
 Rewards in SER https://www.sertoken.io/enter

 Community Chat - https://t.me/BabySer
*/
...
contract BabySer is IERC20, Ownable {
    ...
    string private constant TOKEN_NAME = "BabySer";
    string private constant TOKEN_SYMBOL = "BabySer";
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x7282cA0deD6cA985d9F5d43b940876572cF61942,
        marketing: 0x7282cA0deD6cA985d9F5d43b940876572cF61942
    });
    ...
    address public rewardToken = 0xb19189Fb36c816f3e0f16065057B07B790998fDC;
