...
import "./ISewerPassClaim.sol";
import "./IBAYCSewerPass.sol";

contract CyanWrappedMAYCV2 is
    ...
    ERC721HolderUpgradeable
{
    ...
    function apeCoinStake(uint32 tokenId, uint224 amount) external {
        ...
        apeCoinStaking.depositMAYC(params);
    ...
    function apeCoinClaim(uint256 tokenId) external {
        ...
        apeCoinStaking.claimMAYC(params, msg.sender);
    ...
    function apeCoinWithdraw(uint32 tokenId, uint224 amount) external {
        ...
        apeCoinStaking.withdrawMAYC(params, msg.sender);
    ...
    function mintSewerPass(uint256 tokenId) external {
        ...
        require(
            sewerPassClaim.checkClaimed(1, tokenId) == false,
        ...
        sewerPassClaim.claimMayc(tokenId);
