...
/**
       Die Degens - $DIEDEGENS     Network: ETHEREUM (ERC-20)


TG Portal - @diedegens
Medium:https://medium.com/@DieDegen
Twitter:https://twitter.com/DieDegens
...
contract DieDegens is Context, IERC20, Ownable {
    ...
    string private constant _name = "Die Degens";
    string private constant _symbol = "DIEDEGENS ";
