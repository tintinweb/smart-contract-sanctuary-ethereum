...
contract y0ttt is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 33000;
    uint256 public MAX_MINTS = 33000;
    string public baseURI = "";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("pfps para twitter", "y0ttt", MAX_MINTS, MAX_SUPPLY) {  
