...
Project Name: Lucky Rabbit 
Ticker: $Tuzi
Supply: 100,000,000

Lucky Rabbit $Tuzi is a community-driven token with self-automated liquidity generator and burning feature.  

  The Auto-Liquidity aims to increase $Tuzi Liquidity pool in Uniswap thereby 
  essentially decrease the volatility of swap impacts and such 
  can be attributed to ever growing stability of $TUZI token. 
  This approach attract whale and chads making this their playground.

  The goal of Auto-Burn mechanism aims to reduce the overall supply of $TUZI, 
  substantially maintaining the value, raising demand and eventually the 
  price will rise. This will revive and give more meaning to 
  $HODL thus Diamond hands will surely be rewarded.

Tax: 1% AutoLiquidty, 1% AutoBurn and 5% Marketing

Telegram: https://t.me/TUZIERC20
Twitter: https://twitter.com/TUZIERC20
*/
...
contract Tuzi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lucky Rabbit";
    string private constant _symbol = "Tuzi";
    ...
    uint256 private maxWalletAmount = 50000 * 10**9;
    uint256 private maxTxAmount = 50000 * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x458ed603bc1378b4E383909BD25A0257a78C21D1);    
    ...
    function openTrading() external onlyOwner() {
        ...
        swapEnabled = true;
        maxWalletAmount = 50000 * 10**9;
        maxTxAmount = 50000 * 10**9;
        tradingOpen = true;
