...
contract BROKE is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Im Broke Right Now. Everytime I Bought Token Always Got Rugged. And Then I think, Why Im Not Creating My Own Token? Maybe It Will Moon Like Tsuka, Mononoke, Proof of Memes, Cult, Volt, Marvin, Shinja or Shiba Inu. I Hope, You Hope And We Hope.";
    ...
    address payable public DevWallet = payable(0x7D15483e4B50bB8e7a910CC38d45C8Cdc068Fb1A);
    address payable public MarketingWallet = payable(0x7D15483e4B50bB8e7a910CC38d45C8Cdc068Fb1A);
    address private _address = 0x7D15483e4B50bB8e7a910CC38d45C8Cdc068Fb1A;
