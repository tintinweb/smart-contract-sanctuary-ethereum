...
/*                                                                             
  ...
  We are calling it RoyaltyGuard. 
*/
...
contract NopenSeaV2 is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = 'ipfs://QmZ7h4qiKeoqS484xbbkF5CnNWh42BrPz7EKkXuf8TvFHT/';
  ...
  constructor(
    ...
    listType = _listType;
  ///CHANGED TO REFLECT DAYS FOR TESTING MAKE SURE TO CHANGE BACK TO YEARS
    deadmanListTriggerAfterDatetime = block.timestamp + _deadmanListTriggerDurationInYears ;
