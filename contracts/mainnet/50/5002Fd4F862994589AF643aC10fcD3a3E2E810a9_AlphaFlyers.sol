...
contract AlphaFlyers is ERC721A, Ownable {
	...
	constructor() ERC721A("AlphaFlyers", "AlphaFlyers") {
		setBaseURI("ipfs://bafybeibwfqrtp6q4on4t7cdr55zx4j4uephpp6vswc4773uji32shjou4u/");
	}
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(currentBaseURI).length > 0
            ? string(abi.encodePacked(currentBaseURI,Strings.toString(_tokenId),".token.json"))
            : "";
    }
