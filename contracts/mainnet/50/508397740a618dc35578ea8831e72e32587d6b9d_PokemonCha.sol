...
contract PokemonCha is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x4093293837dD100EE1950ddfb794B67EBEF78ab6));

    string private _name = "PokemonCha";
    string private _symbol = "PokeChaCha";
