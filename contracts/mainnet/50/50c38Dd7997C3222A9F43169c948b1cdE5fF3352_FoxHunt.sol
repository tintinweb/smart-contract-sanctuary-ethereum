...
Telegram : https://t.me/FOXHUNTERC
Twitter : https://twitter.com/FoxHuntERC

"Fox Hunt The Game"

P2E games are recently hot around the crypto community. But most are not 
fun to play or let you actually earn rewards. With us you can have a lot of 
fun and also earn Fox Coin as an in-game rewards and currency.
Customize your fox as much as you want! With our customization system you
can let your imagination runs wild with ideas. As a part of our mission to
cut the cost on minting gas fees, we are using a simpler yet far better Defi
Programming on our platform. With us you can customize your fox and mint 
them in our platform that are also connected to OpenSea so that you can also
enjoy an easier NFTs trading experience
...
contract FoxHunt is Context, IERC20, Ownable {
    ...
    string private _name = "Fox Hunt";
    string private _symbol = "FXHT";
