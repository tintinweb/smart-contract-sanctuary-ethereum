...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    uint256 public MAX_SUPPLY = 100;//Season 1 -> 100 NFTs
    string public baseURI = "ipfs://QmR99Ze4ctLmQx4FQiZHs7dkHuVQfY1WwwRYe7yH22CeR4/";
...
/* SKULLS CLUB custom functions */
    ...
    function mintTokenNFT (uint256 _numTokens)  external payable returns (bool success){
         ...
         require (_numTokens <= 5 ,"Max 5 Mints each transaction");
    ...
    function setTokenPrice(uint256 _price) public {
        require(msg.sender == admin,"Only owner can act here");
        tokenPrice = _price;
    }
...
contract NFT_Token is ERC721A {
  ...
  //Name symbol   
    constructor() ERC721A("SKULLS CLUB", "SkullsClub")  {
