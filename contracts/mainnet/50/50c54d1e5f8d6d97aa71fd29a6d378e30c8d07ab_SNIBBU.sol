...
Twitter: https://twitter.com/snibbueth
Website: http://snibbu.com/
...
contract SNIBBU is ERC20, Ownable {
    ...
    constructor() ERC20("Snibbu", "SNIB") {
        ...
        marketingWallet = address(0x2DA788A94811F3F604805f3003810E0EFC8Ec601); // set as marketing wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x2DA788A94811F3F604805f3003810E0EFC8Ec601,
            block.timestamp
        );
    }
