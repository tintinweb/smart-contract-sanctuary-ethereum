...
https://twitter.com/elonmusk/status/1547919176299270146
...
contract MarsInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xd07d6E423450400b15a44d0c335E935542A74eE8);
    ...
    uint256 public _maxTxAmount = 2e7 * 10**9; //2%
    uint256 public _maxWalletSize = 4e7 * 10**9; //4%
    uint256 public _swapTokensAtAmount = 5e5 * 10**9; //0.05%
