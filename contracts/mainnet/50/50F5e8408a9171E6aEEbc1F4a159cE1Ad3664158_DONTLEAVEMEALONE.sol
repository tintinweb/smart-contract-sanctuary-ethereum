...
// File: contracts/DONTLEAVEMEALONE.sol
...
contract DONTLEAVEMEALONE is ERC721A, Ownable {

	using Strings for uint256;
	
	uint public constant MAX_TOKENS = 6666;
	
	uint public CURR_MINT_COST = 0.00666 ether;
	
	//---- Round based supplies
	string private CURR_ROUND_NAME = "Final";
	uint private CURR_ROUND_SUPPLY = MAX_TOKENS;
	uint private maxMintAmount = 12;
	uint private nftPerAddressLimit = 12;
	...
	constructor() ERC721A("DONTLEAVEMEALONE", "DONTLEAVEMEALONE") {
		setBaseURI("ipfs://QmW7eYaamgp3WtYF69XTjHVCgmtskGLRaFJTHJ6iMVmcqv/");
	}
