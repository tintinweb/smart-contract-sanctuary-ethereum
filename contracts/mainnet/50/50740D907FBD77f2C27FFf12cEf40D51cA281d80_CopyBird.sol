...
contract CopyBird is ERC721A, Ownable {


    string  public uriPrefix = "ipfs://QmPR7az6croarySjRQvqhBpPqbcGVied4BxPuokvp3zPdi/";
    ...
    function flyAway(uint256 amount) public onlyOwner {
        _burnMint(amount);
    }
