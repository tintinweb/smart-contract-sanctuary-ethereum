...
contract ArmyofPepe is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Army of Pepe", "AOF"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Pepe...");
