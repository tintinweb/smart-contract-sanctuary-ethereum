...
Telegram:  https://t.me/PolluxInuPortal

Twitter:   https://twitter.com/InuPollux

Website:   https://www.polluxerc.com/

Medium:   https://medium.com/@polluxerc
...
contract PolluxInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6f9f604E3152fF3868d70dFA78C28b9c68fba9Ba); 
    address payable public Wallet_Dev = payable(0x69fEC5F051b19c72d23Af3Bb474e7FA07bb6758b);
    ...
    string private constant _name = "Pollux Inu"; 
    string private constant _symbol = unicode"$POLLUX"; 
    ...
    constructor () {
        ...
        _owner = 0x69fEC5F051b19c72d23Af3Bb474e7FA07bb6758b;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6f9f604E3152fF3868d70dFA78C28b9c68fba9Ba); // Testnet
