...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1674221400;
    ...
    , TimedDrop
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/dfsmbENExKE9y9m4fB1w/contract-metadata";
  }
...
contract TheKillerCatContract is RamppERC721A {
    constructor() RamppERC721A("The Killer Cat", "KILLERCAT"){}
}
