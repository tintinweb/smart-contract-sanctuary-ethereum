...
contract PartyApesClub is ERC721A, Ownable {
   using Strings for uint256;
    ...
    uint256 public presaleCost = 0.246 ether;
    uint256 public publicSaleCost = 0.278 ether;
    uint256 public collabCost = 0.278 ether;

    uint256 public phaseTwoCollabSupply = 555;
