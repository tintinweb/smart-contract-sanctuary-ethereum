...
abstract contract Ownable is Context {
    ...
    function _transferOwnership(address newOwner) internal virtual {
        ...
        contract Cult_Of_Ether_Disciples is ERC721A, Ownable {
        using Strings for uint256;
            ...
            string public hiddenURL = "ipfs://QmTBLCSwfZDqASMi3jNhJqpecjrFEZMus3CXwKhbNeT76H/0.json" ;
            //cost for Pulic Mint
        ...
        //Contract will switch to Public Mint once 3000 tokens are minted
          ...
          _safeMint(msg.sender , _mintAmount);
           ...
           // WhiteList-Sale  will be automatically paused after 3000 NFTs are minted in this phase
