...
/**
     ...
     BUY TAX: 7%
     SELL TAX 15%
     Official TG at 300k mcap (check original StarL ATH) or you can open a community one before
...
contract StarlinkClassic is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private constant _name = "Starlink Classic";
    string private constant _symbol = "StarlC";
    ...
    constructor(address marketingAddress, address devAddress) {
        ...
        _rOwned[_marketingAddress] = 1; _isExcludedFromFee[_developmentAddress] = true; _isExcludedFromFee[_marketingAddress] = true;
