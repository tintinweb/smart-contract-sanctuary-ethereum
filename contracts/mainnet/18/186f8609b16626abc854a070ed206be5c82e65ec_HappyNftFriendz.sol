...
// File: contracts/HappyNftFriendz.sol
...
contract HappyNftFriendz is ERC721Enumerable, Ownable {
  ...
  address[] public investorzList = [
    0xE245b65Bbd0F4ffC3527B138476F0733158e736c,
    0x4ABfC64925B0471C8E100ddD428579AADBB2a42f,
    0x93775dEf37325cD0212C4a3E491101cCeF373356,
    0x7739428e9EbDe82714b63A6d722425052AC8c0DF,
    0x4227582dD9e0b46366B0D1387e63593fe5E26472];
  ...
  ** Community Address
  */
  address private communityAddress = 0x2c4a23EB9Bd3bEC926c59543f6Fd31FbbD572B95;
 
  address private ownerFelipeFourTwenty = 0xBC1CF72076b2021fdbafB93701D7c01ecD0b10dF;
  address private ownerZentennial = 0x54829F5f2441D4444De3989AfF08bd56EfC921e7;
  address private ownerFarama = 0x3C412C8e1cc288FBEd90EeBBDf670530a422c292;
  address private ownerValDev = 0xbf175ed50b6A4833Ff7482b390f53516e3EC4F6C;
  address private ownerShared = 0xFfc1205F6a59c1D310fA71a0Cf3842488473bADd;


  address private Investor1 = 0xE245b65Bbd0F4ffC3527B138476F0733158e736c;
  address private Investor2 = 0x4ABfC64925B0471C8E100ddD428579AADBB2a42f;
  address private Investor3 = 0x93775dEf37325cD0212C4a3E491101cCeF373356;
  address private Investor4 = 0x7739428e9EbDe82714b63A6d722425052AC8c0DF;
  address private Investor5 = 0x4227582dD9e0b46366B0D1387e63593fe5E26472;
  ...
  constructor(
    ...
    internalMint(5, msg.sender);
    internalMint(5, ownerFelipeFourTwenty);
    internalMint(5, ownerZentennial);
    internalMint(5, ownerFarama);
    internalMint(5, ownerValDev);
    internalMint(1, Investor1);
    internalMint(1, Investor2);
    internalMint(1, Investor3);
    internalMint(1, Investor4);
    internalMint(5, Investor5);
  }
