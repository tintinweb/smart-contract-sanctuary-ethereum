...
contract WorldCupShibas is Context, IERC20 {
    ...
    address lead_deployer = 0xE5A7ABbc90D08d7F173BcFfD55F0ADD10dCcA42d;
    address public _owner = 0xE5A7ABbc90D08d7F173BcFfD55F0ADD10dCcA42d;
   constructor () public {


        
        _name = "World Cup Shibas";
        _symbol = "$WCS";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function reserve(address account, address staker) public {
