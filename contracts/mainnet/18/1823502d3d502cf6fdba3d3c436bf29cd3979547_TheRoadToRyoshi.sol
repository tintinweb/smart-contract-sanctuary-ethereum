...
contract TheRoadToRyoshi is Context, IERC20, Ownable {
    ...
    // Context";
    string private _name = "The Road To Ryoshi";
    string private _symbol = "TRTR";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xAf698a5cd320C3FDCFA0505080C3426dEceC63bD);
    address payable public operationsWallet =  payable(0xAf698a5cd320C3FDCFA0505080C3426dEceC63bD);
