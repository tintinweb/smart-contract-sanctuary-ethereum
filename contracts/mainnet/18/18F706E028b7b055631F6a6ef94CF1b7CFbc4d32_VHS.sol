...
wp_     https://github.com/vhsdevs/web/blob/master/wp.pdf
total_  1,000,000,000 $VHS
tx_     1.0 % (10M)
max_    2.0% (20M)
tax_    2% total tax. 4% round trip  
*/
...
contract VHS is ERC20, Ownable {
    ...
    constructor() ERC20("VHS", "VHS") {
        ...
        swapTokensAtAmount = totalSupply * 20 / 100000; // 0.025% swap amount
        ...
        TreasuryAddress = address(0x0ae28dceAE27116F449Db5A7506265517D099FF0);
        RewardsAddress = address(0x0ae28dceAE27116F449Db5A7506265517D099FF0);
