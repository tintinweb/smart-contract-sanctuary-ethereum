...
contract SlavMfers is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("Slav Mfers", "SLAVMF") {
        PRICE = price;
    ...
    function setMaxSupply(uint newMaxSupply) external onlyOwner {
        ...
        require(newMaxSupply < 10001, "Invalid new max supply");
