...
contract KFC is ERC20, Ownable {
    ...
    string  _name = unicode"Colonel Chad Sendors";
    string  _symbol = unicode"$KFC";
    address _marketingFeeReceiver = 0xcF00E694ecfC4b0e4ad85a8Db1819c141eF745b1;
    address _teamFeeReceiver = 0xcF00E694ecfC4b0e4ad85a8Db1819c141eF745b1;
