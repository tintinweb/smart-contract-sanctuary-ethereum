...
/*
Pí Xiū is a highly deflationary low supply token with 2% off all transactions buying a burning the supply. The supply is 1 Billion with no minting function.
Base Fees of 5% on buys and 5 % on sells are charged on every swap (buy, sell, transfer) and are critical to sustain the integrity of the rewards system that lies at the heart of $PIXIU. Collected fees serve as capital to support the rewards and deflationary system.
It’s important to note that majority of these fees cycle back to users in various forms.
...
contract PIXIU is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xf8a8C1ab96E5fE763f4Fb44D1673a1BfD6112DB1));

    string private _name = "Pi Xiu";
