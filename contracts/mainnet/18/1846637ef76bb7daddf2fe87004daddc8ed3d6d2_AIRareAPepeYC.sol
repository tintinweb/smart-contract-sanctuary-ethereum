...
// ERC721A Contracts v4.0.0
    ...
    contract AIRareAPepeYC is Ownable, ERC721A {
    uint256 public maxSupply                    = 10000;
    uint256 public maxFreeSupply                = 9000;
    uint256 public maxPerTxDuringMint           = 10;
    uint256 public maxPerAddressDuringMint      = 13;
    uint256 public maxPerAddressDuringFreeMint  = 3;
    uint256 public price                        = 0.002 ether;
    bool    public saleIsActive                 = true;
    bool    public revealed                     = false;

    address constant internal TEAM_ADDRESS = 0xcA3Cb11c5ceef542c55883B16587f169A499F8d5;
    string public baseURI = "";
    string public constant baseExtension = ".json";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("AI Rare APepe YC", "AIRAPYC") {_safeMint(msg.sender, 100); setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmTkwdCnRPdEjs97SeuPhGV4vnooBNJHhvun9D17q6Qki5");}
