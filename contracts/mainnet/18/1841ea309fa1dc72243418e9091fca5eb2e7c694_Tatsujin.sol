...
contract Tatsujin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Tatsujin";
    string private constant _symbol = "TSUJIN";
    ...
    address payable private _developmentAddress = payable(0x130d6bcf4EE6520142D1e3764199d64148928e81);
