...
contract ShibaChain is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x29f1fDbE5fd6f1A0093FCC2C72C74F7526933E44);
    address payable private _marketingAddress = payable(0x29f1fDbE5fd6f1A0093FCC2C72C74F7526933E44);
