...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract Saintpattypunks is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;
  ...
  constructor(string memory _uriPrefix) ERC721A("Saint Patty Punks", "STPP") {
  ...
  function setFreeLimit(uint8 _limit) external onlyOwner{
  ...
  function price(uint _cost) external onlyOwner{
      cost = _cost;
