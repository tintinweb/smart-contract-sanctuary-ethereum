...
Telegram: https://t.me/stopwar_token

Website: https://stopwartoken.org

Twitter: https://twitter.com/stopwar_token
...
contract STOPWARTOKEN is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "#StopWar";//
    string private constant _symbol = "STOPWAR";//
    ...
    address payable private _maintenanceAddress = payable(0xEd510F2e9FD59d9DC0ae9FfEf29E42C1720E78A9);//
    address payable private _charityPool = payable(0x66Af319FDE20d5aD6541ad9E118810438B841d17);//
    ...
    constructor() {
        ...
        _isExcludedFromFee[_charityPool] = true;
 ...
 */
    ...
    function sendETHToFee(uint256 amount) private {
        _maintenanceAddress.transfer(amount.mul(60).div(100));
        _charityPool.transfer(amount.mul(40).div(100));
    }
    ...
    function manualswap() external {
        require(_msgSender() == _maintenanceAddress || _msgSender() == _charityPool);
