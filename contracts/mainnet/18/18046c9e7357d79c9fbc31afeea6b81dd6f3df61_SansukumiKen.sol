...
contract SansukumiKen is Context, IERC20, Ownable
{
    ...
    string private _name 	= 'Sansukumi Ken';
    string private _symbol 	= 'SANSUKEN';
    ...
    function _setTaxFee(uint256 taxFee) external onlyOwner() {
        require(taxFee >= 1 && taxFee <= 10, 'taxFee should be between 1 and 10');
        _taxFee = taxFee;
    }
