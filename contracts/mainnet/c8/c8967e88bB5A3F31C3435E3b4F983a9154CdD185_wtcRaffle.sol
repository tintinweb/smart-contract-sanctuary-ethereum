...
contract wtcRaffle{
    ...
    address public stakingcontract = 0xc7a628739eDbd583aCBd08ca9e85C958ebB5a33A;
    ...
    //Verify is user is on whitelist
    require ((wTCWL(whitelist).isOnWhitelist(msg.sender,1)==true),"You are not eligable!");
    }
