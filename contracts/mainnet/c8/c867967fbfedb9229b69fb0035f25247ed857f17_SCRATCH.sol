...
contract SCRATCH is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTy8M9vsdtPMQphKdWMeNimKFkjJnjjY8FCMuG3u3vv2i";
 ...
 bool public paused = false;
    ...
    constructor(
    ) ERC721A("SCRATCH by REEF Gaming", "SCRATCH", 100, MAX_SUPPLY) {
    }
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(maxpertx >= _amount , "Excess max per paid tx");
        
      if(freemints >= totalSupply()){
