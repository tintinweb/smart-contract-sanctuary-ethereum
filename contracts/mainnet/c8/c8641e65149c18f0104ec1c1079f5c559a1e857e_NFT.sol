...
contract NFT is ERC721Enumerable{
    ...
    constructor(string memory name, string memory symbol, uint256 _maxTotolSupply, string memory _baseURI) ERC721(name, symbol){
        maxTotolSupply = _maxTotolSupply;
        baseURI = _baseURI;
    ...
    function mint(address user, uint count) public onlyAdmin{
        require(totalSupply() + count <= maxTotolSupply, "upper limit exceeded");
