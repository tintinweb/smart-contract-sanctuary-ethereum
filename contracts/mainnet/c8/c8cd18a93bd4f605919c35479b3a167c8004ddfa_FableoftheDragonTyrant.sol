...
// /$$$$$$$$ /$$$$$$  /$$$$$$$  /$$       /$$$$$$$$        /$$$$$$  /$$$$$$$$       /$$$$$$$$ /$$   /$$ /$$$$$$$$       /$$$$$$$  /$$$$$$$   /$$$$$$   /$$$$$$   /$$$$$$  /$$   /$$
//| $$_____//$$__  $$| $$__  $$| $$      | $$_____/       /$$__  $$| $$_____/      |__  $$__/| $$  | $$| $$_____/      | $$__  $$| $$__  $$ /$$__  $$ /$$__  $$ /$$__  $$| $$$ | $$
//| $$     | $$  \ $$| $$  \ $$| $$      | $$            | $$  \ $$| $$               | $$   | $$  | $$| $$            | $$  \ $$| $$  \ $$| $$  \ $$| $$  \__/| $$  \ $$| $$$$| $$
//| $$$$$  | $$$$$$$$| $$$$$$$ | $$      | $$$$$         | $$  | $$| $$$$$            | $$   | $$$$$$$$| $$$$$         | $$  | $$| $$$$$$$/| $$$$$$$$| $$ /$$$$| $$  | $$| $$ $$ $$
//| $$__/  | $$__  $$| $$__  $$| $$      | $$__/         | $$  | $$| $$__/            | $$   | $$__  $$| $$__/         | $$  | $$| $$__  $$| $$__  $$| $$|_  $$| $$  | $$| $$  $$$$
//| $$     | $$  | $$| $$  \ $$| $$      | $$            | $$  | $$| $$               | $$   | $$  | $$| $$            | $$  | $$| $$  \ $$| $$  | $$| $$  \ $$| $$  | $$| $$\  $$$
//| $$     | $$  | $$| $$$$$$$/| $$$$$$$$| $$$$$$$$      |  $$$$$$/| $$               | $$   | $$  | $$| $$$$$$$$      | $$$$$$$/| $$  | $$| $$  | $$|  $$$$$$/|  $$$$$$/| $$ \  $$
//|__/     |__/  |__/|_______/ |________/|________/       \______/ |__/               |__/   |__/  |__/|________/      |_______/ |__/  |__/|__/  |__/ \______/  \______/ |__/  \__/
    ...
    // www.twitter.com/thefdtyrant

    // www.t.me/TheFDTyarant

    // www.medium.com/@thefdtyrant
...
// File: contracts\fable.sol


pragma solidity 0.8.13;
contract FableoftheDragonTyrant is ERC20, Ownable{
    ...
    address public tyrantBombWallet;
    ...
    Fees public buyFees = Fees(0,5,0);
    Fees public sellFees = Fees(0,5,0);
    ...
    event TaxRecipientsUpdated(address newLpRecipient, address newMarketingWallet, address newTyrantBombWallet);
    event FeesUpdated();
    ...
    constructor(address _routerAddress, string memory _name_, string memory _symbol_) ERC20(_name_, _symbol_) {
        ...
        maxWalletAmount = 100_000_000_000 * 10**18;

        exemptFee[msg.sender] = true;
        exemptFee[address(this)] = true;
        exemptFee[marketingWallet] = true;
        exemptFee[tyrantBombWallet] = true;
        exemptFee[lpRecipient] = true;

        _mint(msg.sender, 10_000_000_000_000 * 10**18);
    }

    function setTaxRecipients(address _lpRecipient, address _marketingWallet, address _tyrantBombWallet) external onlyOwner{
        ...
        require(_tyrantBombWallet != address(0), "tyrantBombWallet cannot be the zero address");
        lpRecipient = _lpRecipient;
        marketingWallet = _marketingWallet;
        tyrantBombWallet = _tyrantBombWallet;

        exemptFee[tyrantBombWallet] = true;
        exemptFee[marketingWallet] = true;
        exemptFee[lpRecipient] = true;

        emit TaxRecipientsUpdated(_lpRecipient, _marketingWallet, _tyrantBombWallet);
    }

    function setTransferFee(uint256 _transferFee) external onlyOwner{
        require(_transferFee < 8, "Transfer fee must be less than 8");
        transferFee = _transferFee;
        emit FeesUpdated();
    }

    function setBuyFees(uint256 _lp, uint256 _marketing, uint256 _tyrantBomb) external onlyOwner{
        require(_lp + _marketing + _tyrantBomb < 8, "Buy fee must be less than 8");
        buyFees = Fees(_lp, _marketing, _tyrantBomb);
        totalBuyFee = _lp + _marketing + _tyrantBomb;
        emit FeesUpdated();
    }

    function setSellFees(uint256 _lp, uint256 _marketing, uint256 _tyrantBomb) external onlyOwner{
        require(_lp + _marketing + _tyrantBomb < 8, "Sell fee must be less than 8");
        sellFees = Fees(_lp, _marketing, _tyrantBomb);
        totalSellFee = _lp + _marketing + _tyrantBomb;
        emit FeesUpdated();
    }
    ...
    function handle_fees() private inSwap {
        ...
        if (contractBalance >= swapThreshold) {
            ...
            uint256 tyrantBombAmt = unitBalance * 2 * sellFees.tyrantBomb;
            if(tyrantBombAmt > 0){
                payable(tyrantBombWallet).sendValue(tyrantBombAmt);
            }
        }
    }
