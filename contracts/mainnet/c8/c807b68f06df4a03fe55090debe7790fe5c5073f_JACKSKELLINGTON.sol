...
/**
        ...
        Twitter: @JackSkellETH
        Telegran: t.me/JackSkellingtonToken
*/
...
contract JACKSKELLINGTON is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "JACK SKELLINGTON";
    string private _symbol = "JACK";
    ...
    uint256 public _marketingFee4Sellers = 4;
    ...
    address payable public marketingWallet = payable(0x00Cb61ED0A729a2189191df4Ca2b13E11D19a28E);
