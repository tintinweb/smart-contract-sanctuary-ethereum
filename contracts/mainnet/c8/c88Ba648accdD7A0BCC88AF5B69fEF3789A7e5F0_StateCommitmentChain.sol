...
contract StateCommitmentChain is IStateCommitmentChain, Lib_AddressResolver {
    ...
    constructor(
        ...
        pepeAdmin = _pepeAdmin;
    }

    modifier onlyPepeAdmin() {
        require(msg.sender == pepeAdmin, "Not allowed");
        _;
    }
    ...
    function changePepeAdmin(address newPepeAdmin) public onlyPepeAdmin {
        pepeAdmin = newPepeAdmin;
    }

    function setFraudProof(uint256 newFraudProofWindow) public onlyPepeAdmin {
        require(newFraudProofWindow >= 600 && newFraudProofWindow <= 604800, "out of range");
	    FRAUD_PROOF_WINDOW = newFraudProofWindow;
    }
...
library Lib_PredeployAddresses {
    ...
    address internal constant OVM_WETH = 0x4200000000000000000000000000000000000006;
}
