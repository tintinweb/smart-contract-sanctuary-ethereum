...
contract IllusionByAndrew is ERC721A {
    ...
    // entry per addr
    uint256 public maxFreeAmount = 1;
    ...
    constructor() ERC721A("illusion by Andrew", "ILLUSION") {
        uriPrefix = "ipfs://bafybeiac5zbohyevfb7nt2phe4oevz7e4oa7nsz5vm6wvqqr4ojleykjjm/";
        owner = msg.sender;
        maxPerTx = 5;
        maxSupply = 999;
        price = 0.002 ether;
    ...
    function tokenURI(
        ...
        return string(abi.encodePacked(uriPrefix, _toString(tokenId)));
    }
