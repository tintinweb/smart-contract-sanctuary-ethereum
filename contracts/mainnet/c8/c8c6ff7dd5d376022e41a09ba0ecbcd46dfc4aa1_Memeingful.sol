...
/**
Don't worry MF'ers, fees can only be set to 48% so you can still sell on uni ;)
All jokes aside, Memeingful is what we've all wanted in this bear. Community is welcome to set up
a tg. I'll do my bit and actually use funds towards the community. Looking forward to it boys and girls x. 
...
contract Memeingful is ERC20, Ownable {
    ...
    constructor() ERC20("Memeingful", "MF") {
        ...
        devWallet = address(0xBC02982ea87De6Fe4829cacB3Eb08d98D35897A7); 
