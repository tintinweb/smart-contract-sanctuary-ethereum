...
contract Mischievous is ERC20, Ownable {
    ...
    constructor() ERC20("Mischievous", "MISCH") {
    ...
    function SetBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 6, "Buy fee can not be set higher than 6%");
        buyFee = _fee;
    }

    function SetSellFee(uint256 _fee) external onlyOwner {
        require(_fee <= 6, "Sell fee can not be set higher than 6%");
        sellFee = _fee;
    }
