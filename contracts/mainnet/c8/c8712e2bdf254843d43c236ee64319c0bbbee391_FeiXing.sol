...
contract FeiXing is ERC20, Ownable {
    ...
    constructor() ERC20("FEI XING", "1ROSE") {
        ...
        maxTransactionAmount = 36_000_000 * 1e18; // 12% from total supply maxTransactionAmountTxn
        ...
        marketingWallet = address(0x5d3Cb7e65373B6828aD09C4C0c0345974B524a6b); // set as marketing wallet
        devWallet = address(0x5d3Cb7e65373B6828aD09C4C0c0345974B524a6b); // set as dev wallet
