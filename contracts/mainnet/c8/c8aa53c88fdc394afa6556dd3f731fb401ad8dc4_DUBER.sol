...
contract DUBER is Context, IERC20, Ownable {
    ...
    string private constant _name = "DECENTRALIZED RIDESHARING";
    string private constant _symbol = "DUBER";
    ...
    constructor () {
        dev = payable(0x9e7FFd49104a6A4fAf0F96224264276770317060);
