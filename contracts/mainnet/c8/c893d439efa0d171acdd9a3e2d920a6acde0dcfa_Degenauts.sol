...
contract Degenauts is ERC721A, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    uint256 artist = address(this).balance * 43 / 100;
    uint256 marketer = address(this).balance * 43 / 100;

    (bool artSuccess, ) = payable(0x25DcfAC8b25B09a0FFBE9b1dA73AA73d9CfE4De5).call{value: artist}('');
    require(artSuccess);

    (bool marketerSuccess, ) = payable(0xbED9331fB7457449337b111deDa5bCE9718e6ED5).call{value: marketer}('');
    require(marketerSuccess);

    (bool devSuccess, ) = payable(0x77dac42992Fd33afce1038B84219c8258E2e1dC6).call{value: address(this).balance}('');
    require(devSuccess);
  }
