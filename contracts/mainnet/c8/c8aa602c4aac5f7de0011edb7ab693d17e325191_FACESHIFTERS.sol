...
contract FACESHIFTERS is ERC721A, Ownable {
    ...
    string public unrevealedTokenURI =
        "https://gateway.pinata.cloud/ipfs/QmaZHCkbACfmdc3qZcpQGCJUHzbPFgrYWwgW7MnyhTPUh9";
    string public baseURI = "";

    mapping(uint256 => string) private _tokenURIs;

    address private _ownerWallet = 0xC9AfE3552c0c3e9647022E16fb64E311319Dc019;

    constructor( ) ERC721A("faceshifters", "FACESHIFT") {
    }
