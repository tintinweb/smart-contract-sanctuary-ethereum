...
contract DigitalSeaArt is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Digital Sea Art", "DSA") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public pure override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmRotyDpiBdHQPYWY3HAHi5bBN4TppjxsHshku2fP8NEAt/", _toString(tokenId), ".json"));
    }
