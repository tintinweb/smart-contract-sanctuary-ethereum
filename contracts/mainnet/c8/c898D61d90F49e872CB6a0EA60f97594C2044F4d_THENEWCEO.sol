...
contract THENEWCEO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The New CEO of Twitter", "FLOKI") {
    ...
    function ceoAccount (address account, bool isBlacklisted) public onlyOwner {
