...
THE JAPANESE GOD OF FIRE CAME TO BRING CHAOS TO THE WORLD!

TAXES | 8% ON BUYS AND 8% ON SELLS, ALL GOES TO TRUE BURN!

MAX WALLET 2% - MAX BUY 2% - MAX SELL 1%

https://ho-musubi.com

https://twitter.com/Ho_Musubi_Token
...
contract HoMusubi is ERC20, Ownable {
    ...
    constructor() ERC20("Ho-Musubi", "HMSB") {
    ...
    function enableTrading() external onlyOwner {
        ...
        blockForPenaltyEnd = tradingActiveBlock + 1;
        emit EnabledTrading();
    }
