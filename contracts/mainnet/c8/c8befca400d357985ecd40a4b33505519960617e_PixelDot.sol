...
contract PixelDot is IERC721A { 
    ...
    uint256 public MAX_FREE = 101;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "PixelDot";
    string private constant _symbol = "PIXELDOT";
    string private _baseURI = "QmcoJ5QZNcHuXRpRBfDNRrCP3WybV8tUErTFryF2MASiio";
