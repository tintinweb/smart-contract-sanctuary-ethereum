...
contract NOTPUNK  is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmPs6ucGXCwY5gLLKX9ZHoNsRw3asbvs5qRHYvGAsLG1PK/";
    uint   public price             = 0.004 ether;
    uint   public maxPerTx          = 10;
    uint   public maxPerFree        = 2;
    uint   public totalFree         = 8000;
    uint   public maxSupply         = 10000;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("ASCIINOTASCII NOTPUNK ", "PUNK"){}
