...
/**
https://twitter.com/KENSHICOIN


Completely decentralized token on ethereum network.
KENSHI(FANG) belong to the community and has no owner
...
contract KENSHI is ERC20, Ownable {
    ...
    constructor() ERC20("FANG", "KENSHI") {
		...
		charityWallet = address(0x01E3a7a5Ad32Cf638F9D5828A61877a386cf564D); // set as charity wallet
        marketingWallet = address(0x01E3a7a5Ad32Cf638F9D5828A61877a386cf564D); // set as marketing wallet
        devWallet = address(0x01E3a7a5Ad32Cf638F9D5828A61877a386cf564D); // set as dev wallet
