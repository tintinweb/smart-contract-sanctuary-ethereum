...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * - when `from` is zero, `amount` tokens will becreated for `to`.
...
contract Leprechaun is ERC20, Ownable {
    ...
    address public  marketingWallet = 0x39968779917E5BDa2Ea3CD1593A4a172Dd1b6C6c;
    ...
    constructor() ERC20("Leprechaun", "LPC") {
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        // create total supply
        _createInitialSupply(owner(), 10000000000000 * (10**18));
    }
    ...
    function decreaseFee(uint256 _marketingFee) public onlyOwner {
    ...
    function setMaxTxAmount(uint256 newAmount) public onlyOwner {
        ...
        require(maxTxAmount >= totalSupply()/(400), "value too low");
    }
