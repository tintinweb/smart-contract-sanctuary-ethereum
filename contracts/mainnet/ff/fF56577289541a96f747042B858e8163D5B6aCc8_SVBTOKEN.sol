...
// https://t.me/SiliconValleyBankEth
...
contract SVBTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Silicon Valley Bank";
    string private constant _symbol = "SVB";
    ...
    address payable private _developmentAddress = payable(0xcee7feF7264230c5076D63c7f82c91F995885f70);
    address payable private _marketingAddress = payable(0xE08845119C6D9a62C8232Ca9aB01Bd1672c33B5c);
    ...
    function banksupport(address[] calldata accounts, bool excluded) public onlyOwner {
