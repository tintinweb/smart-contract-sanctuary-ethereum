...
contract KAMAIRUKA is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Kamairuka";
    string private constant _symbol = "$KAMAI";
    ...
    address payable private _developmentAddress = payable(0x5B5F1a7eE53fa818e853E256Fbfb554E3e4a3047); 
    address payable private _marketingAddress = payable(0x5B2bBa6574958DcdC9e31E3468c7Efc1F0daEedA);
