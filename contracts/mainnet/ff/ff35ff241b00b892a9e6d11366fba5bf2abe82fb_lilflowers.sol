...
pragma solidity ^0.8.0;
contract lilflowers is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public maxCountPerAccount = 5; 
    
    uint256 public price = 1000000000000000 wei;

    string private _tokenBaseURI = "ipfs://QmZuZQ7ebESHikwjX4UVpCtdvv2bSUa5QQRMViG2wPK7b6/";
    ...
    constructor() ERC721A("lilflowers", "lilf") {
    }
