...
// File: contracts/Legionswinged.sol
...
contract TheWingedLegions is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmbRt5FFLRrHPcsbeLJVzVmzgNHN8a1spALssBxVHAxZiW/";
    ...
    uint256 public constant FREE_MINT_SUPPLY = 111;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("TheWingedLegions", "WL") {
        baseURI = initBaseURI;
