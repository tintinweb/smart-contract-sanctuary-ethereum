...
contract CreatorCoin is StandardToken, Ownable {
    using SafeMath for uint256;
    ...
    address public constant addrDevTeam      = 0xafc1F42a051C612fA5877a2b39669322181B4B5d; // 1%
    address public constant addrLockUp       = 0xb98F6c904E5419c5a5152899F7b9eeB9Cf992FEa; // 9%
    address public constant addrBounty       = 0x5d77021fe7B6b2d9775FCE1CE0513627E631cd32; // 25%
    address public constant addrDistribution = 0xd17d14Bc89329DAb51c43C097AF79c5eFE04D43E; // 10%
    address public constant addrAirDrop      = 0x37CD0F57a98e2A23926A543d4Ab00dF82e2E0D76; // 55%

    uint public constant atto = 100000000;
    uint public constant decimals = 8;

    string public constant name   = "CreatorCoin";
    string public constant symbol = "CTC";

    uint public contractStartTime;

    uint64 public constant lockupSeconds = 60 * 60 * 24 * 365;
