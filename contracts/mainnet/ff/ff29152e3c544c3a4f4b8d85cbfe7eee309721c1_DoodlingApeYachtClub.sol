...
contract DoodlingApeYachtClub is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    uint256 public PUBLIC_PRICE = .0033 * 10**18;
    ...
    constructor(string memory initBaseURI) ERC721A("Doodling Ape Yacht Club", "DAYC") {
        baseURI = initBaseURI;
