...
contract LP is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 33000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress = payable(address(0xeA639C95A2642D6749a68b8676Bbc97b3630c5E1));

    string private _name = "Teh Loop";
