 ...
 * controlled by a central SupplyController. By implementing RURCoin
...
contract RURCoin {
    ...
    string public constant name = "RURC"; // solium-disable-line
    string public constant symbol = "RURC"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all RURC at the contract address.
     * This sends the RURC tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimRURC() external onlyOwner {
