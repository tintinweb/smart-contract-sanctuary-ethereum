...
People ask where I went why I deleted my social accounts the fact of the matter is crypto became stale what started as true decentralisation was always intended to give power to the people in the beginning this was the case unfortunately over time this slowly changed power to the people is exactly what I means a true decentralised project doesn’t need tax for others to gain it needs to support the community & the community will support the project so for this reason Iv created what we can call an experiment of people the token patchinu has 0% tax with open source tec this allows the people to take it in any direction they choose without being taxed the true usecase for anything decentralised is community
...
contract PATCHINU is ERC20, Auth {
