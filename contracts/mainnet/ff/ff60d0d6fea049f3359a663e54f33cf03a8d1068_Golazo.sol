...
contract Golazo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xbEe1bD7303F23E91249f0f77EBa7a87d7baeC9C4); // Marketing Address
    address payable public multiSigAddress = payable(0xbEe1bD7303F23E91249f0f77EBa7a87d7baeC9C4); // Marketing Address
    address payable public devAddress = payable(0xbEe1bD7303F23E91249f0f77EBa7a87d7baeC9C4); // Dev Address
    address payable public liquidityAddress = payable(0xbEe1bD7303F23E91249f0f77EBa7a87d7baeC9C4); // Liquidity Address
    ...
    string private constant _name = unicode"Golazo";
    string private constant _symbol = unicode"GOLAZO";
