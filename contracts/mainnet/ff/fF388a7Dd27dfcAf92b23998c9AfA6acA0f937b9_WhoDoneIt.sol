...
contract ERC721A is IERC721A {
     ...
     */
    function _safeMint(address to, uint256 quantity) external override {
...
contract WhoDoneIt is Ownable, ERC721A, ReentrancyGuard  {
    ...
    uint WhoDunIt_2_status = 0;
    address WhoDunIt_2_address;
    function setWhoDunIt_2_Address(address a) public onlyOwner{
        WhoDunIt_2_address = a;
    }
    function setWhoDunIt_2_Status(uint s) public onlyOwner{
        WhoDunIt_2_status = s;
    }

    bytes32 public merkleRoot = 0xd24b002ba2f296a4f81b90f56aebf15e34add4ffd6357aee7e98bac1426c4b20;
    function setMerkleRoot(bytes32 m) public onlyOwner{
        merkleRoot = m;
    }

    function claim(uint tokenId) public {
        require(WhoDunIt_2_status == 1, "Collection 2 claim not active");

        ERC721A(WhoDunIt_2_address)._safeMint(msg.sender, 1);
        _burn(tokenId);
    }
    ...
    constructor() ERC721A("WhoDunIt", "WDI") {
        uri = "https://bafybeif22ofcs5tkoor3km5loat3ihy4g2um7hci6ml4aatxzz2d5wefcm.ipfs.nftstorage.link/";
    }
