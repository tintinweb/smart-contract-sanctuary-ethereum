...
contract NUT is ERC20, Ownable {
    ...
    constructor() ERC20("Nut Nation", "NUT") {
        ...
        marketingWallet = address(0xC90b023669B3e22C807755c4874649319eec3De9); // set as marketing wallet
        devWallet = address(0x7857ad2380B67fB4Ef222572b6766d08Cff9c7B7); // set as dev wallet
    ...
    function autoBurnLiquidityPairTokens() internal returns (bool) {
        ...
        // pull tokens from LP and move to dead address permanently
        if (amountToBurn > 0) {
