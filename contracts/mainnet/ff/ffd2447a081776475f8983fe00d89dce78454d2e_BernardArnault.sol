...
contract BernardArnault is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bernard Arnault";
    string private constant _symbol = "WRM";
