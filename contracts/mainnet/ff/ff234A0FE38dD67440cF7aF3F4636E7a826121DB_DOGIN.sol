...
contract DOGIN is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Doge In";
    string private constant _symbol = "DOGIN";
    ...
    uint256 private constant _tTotal = 50000000000 * 10**9;
