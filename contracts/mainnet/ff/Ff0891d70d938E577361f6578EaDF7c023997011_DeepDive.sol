...
contract DeepDive is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 555;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.007 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xed5ce181e550f79c082730a7badd8acb7fcc821a04c292d4a7c8864ce873bbab;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmUQVzN2A7ZtHm6RbC278J2H7iy7o477FSe6HrhcQ8r9Lr";

    constructor() public ERC721A("DeepDive Genesis", "DDG", 555, 555) {}
