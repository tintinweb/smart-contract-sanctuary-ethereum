...
contract DogNobi is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 2_070_000_000 * 10**18;
    uint256 public maxSellLimit = 690_000_000 * 10**18;
    uint256 public maxWalletLimit = 2_070_000_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 0;

    address public marketingWallet = 0x276AfD0BEBB13FE23291CD861eA9E5fA7ab4d020;
    address public DogNobiRewardsWallet = 0x276AfD0BEBB13FE23291CD861eA9E5fA7ab4d020;
    address public lotteryWallet = 0x276AfD0BEBB13FE23291CD861eA9E5fA7ab4d020;
    ...
    Taxes public taxes = Taxes(99, 0, 0, 0);
    Taxes public sellTaxes = Taxes(99, 0, 0, 0);
    ...
    constructor() ERC20("Dog Nobi", "Donja") {
        _tokengeneration(msg.sender, 69_000_000_000 * 10**decimals());
        ...
        exemptFee[DogNobiRewardsWallet] = true;
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            if (KaiReward > 0) {
                payable(DogNobiRewardsWallet).sendValue(KaiReward);
            }
    ...
    function updateKaiRewardsWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0),"Fee Address cannot be zero address");
        DogNobiRewardsWallet = newWallet;
    }
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 69_000_000_000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 690_000_000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 69_000_000_000, "Cannot set max wallet amount lower than 1%");
