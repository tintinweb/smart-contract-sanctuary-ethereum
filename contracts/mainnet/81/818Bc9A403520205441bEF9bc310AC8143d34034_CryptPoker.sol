...
Playing Poker is fun, so we want you to have fun, But what is more fun is if you are also gaining money through cryptocurrency. 

Follow this website and start your poker experience.

https://www.cryptopoker.com/
...
contract CryptPoker is Context, IERC20, Ownable {
    ...
    string private constant _name = "CryptPoker";
    string private constant _symbol = "CryptPoker";
