...
/**
    Crypto Classic ERC20 Token
    https://t.me/CryptoClassicERC20
*/
...
contract CryptoClassic  is Context, IERC20, Ownable {
    ...
    address payable public devAddress = payable(0x08Ee70a7bd0397955F2FEc9Cd5aEE7a0DDE4e6b3); // Dev Address
    address payable public liquidityAddress = payable(0x08Ee70a7bd0397955F2FEc9Cd5aEE7a0DDE4e6b3); // Liquidity Address
    ...
    string private constant _name = unicode"Crypto Classic";
    string private constant _symbol = unicode"CryptoC";
