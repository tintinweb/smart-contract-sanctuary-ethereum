...
contract AVYARD is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100_000 * 10**9;
    ...
    string private constant _name = "AVYARD";
    string private constant _symbol = "AVD";
    ...
    uint256 private _maxWalletSize = 4_500_000 * 10**9;
