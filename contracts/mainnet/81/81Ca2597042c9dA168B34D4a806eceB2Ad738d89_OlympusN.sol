...
contract OlympusN is ERC721A, Ownable, ReentrancyGuard {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) {
    ...
    if(_mintAmount > noFreeMintWL){
        require(msg.value >= cost * (_mintAmount - noFreeMintWL), 'Insufficient funds!');
    }
