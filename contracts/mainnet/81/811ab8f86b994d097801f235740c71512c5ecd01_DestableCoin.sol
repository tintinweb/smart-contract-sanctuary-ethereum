...
contract DestableCoin is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20("Destable Coin", "DESTABLE") {
    ...
    function CZ() external onlyOwner {
