...
contract DogeFruit is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeFruit";
    string private constant _symbol = "DOGEFRUIT";
    uint256 public _maxTxAmount = 15_000 * 10**_decimals;
    uint256 public _maxWalletSize = 15_000 * 10**_decimals;
