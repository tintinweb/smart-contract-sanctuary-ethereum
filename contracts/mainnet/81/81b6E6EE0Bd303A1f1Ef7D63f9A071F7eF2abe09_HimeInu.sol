...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x77fBFb1144A3fDe881eDd67C0C17c574d96e32bA; 
...
contract HimeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hime Inu";
    string private _symbol = "HIMEI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77fBFb1144A3fDe881eDd67C0C17c574d96e32bA); 
    ...
    uint256 public _marketingShare = 90;
    ...
    uint256 public _walletMax = 5000000 * 10**_decimals;
