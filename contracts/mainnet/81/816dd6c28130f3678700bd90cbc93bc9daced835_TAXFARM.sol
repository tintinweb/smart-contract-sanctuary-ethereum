...
Way forward:
* Release TAXFARM SWAP at 250K MC
* Build/Release TAXFARM LOCKER at 350K MC
* I will use 0.5% of my collected taxes for fast track CMC & Coingecko at 669K MC
* Start building TAXFARM ANTI RUGG SYSTEM (ARS) RUGGSCANNER/TOKENSNIFFER and HONEYPOTCHECKER at 750K MC
...
Greetings,
A New Dev(I am to replace big names in ETH to mine)
...
contract TAXFARM is ERC20, Ownable {
    ...
    constructor() ERC20("TAXFARM", unicode"TAXFARM") 
    { 
