...
//*********************************************************************//
//
//  _____  ____  ____  ____  ____      __    ____    ____  _  _  ____  ____  ____  _  _  _____ 
// (  _  )(  _ \(_  _)(  _ \(_  _)    /__\  (  _ \  (_  _)( \( )( ___)( ___)(  _ \( \( )(  _  )
//  )(_)(  )   / _)(_  )   / _)(_    /(__)\  ) _ <   _)(_  )  (  )__)  )__)  )   / )  (  )(_)( 
// (_____)(_)\_)(____)(_)\_)(____)  (__)(__)(____/  (____)(_)\_)(__)  (____)(_)\_)(_)\_)(_____)
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xdC228Da49fBBF36add39045657E56c9DDfE8aC24,0x0BD1a5937f9ef9B71109B723956d5E11308100f1];
  uint256[] public payableFees = [5,47,48];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmNWXxXKj3o8Ci398Yt8M47CabHA5mkUjbidiTCmsP3j15/";
...
// File: contracts/OririabinfernoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OririabinfernoContract is RamppERC721A {
    constructor() RamppERC721A("ORIRI AB INFERNO", "INFERNO"){}
}
