...
Eiko was a quiet and unassuming Man, who lived in a small village in rural Japan.
He worked as a farmer, tending to his rice fields and tending to the needs of his family.
Despite his simple life, Eiko was a man of great character and integrity, and was highly respected by his fellow villagers.

Telegram Link: Https://T.me/EikoPortal
Medium: https://medium.com/@eikoerc
...
contract Eiko is Context, IERC20, Ownable {
    ...
    string private _name ="Eiko";
    string private _symbol = "EIKO";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x35751271B0cD97C620Be69199c607DdCfbD8eC89);
    address payable private taxWallet2 = payable(0x35751271B0cD97C620Be69199c607DdCfbD8eC89);
