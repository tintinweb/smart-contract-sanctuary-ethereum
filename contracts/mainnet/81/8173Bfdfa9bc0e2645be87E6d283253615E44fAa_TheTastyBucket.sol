...
contract TheTastyBucket is ERC165, IERC721, IERC721Metadata, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint256;

	address private constant STREAM = 0xec77384DF12b1C49c38fC101c319538Ed7C6D317;
	...
	*/
    ...
    /**
		This function allows admin to mint tokens anytime for giveaways
		@param _amount The amount of tokens to mint.
	*/
    function drip(uint256 _amount) external onlyOwner nonReentrant {
        intMint(_amount);
    }
	...
	*/
    ...
    /**
		Set the pre-reveal uri for the metadata
		@param _uri The new URI to update to.
	*/
    function setPrerevealUrl(string calldata _uri) external virtual onlyOwner {
        preRevealUri = _uri;
    }
