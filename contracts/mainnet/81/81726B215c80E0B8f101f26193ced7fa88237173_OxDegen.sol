...
contract OxDegen {
    ...
    address payable constant development = payable(address(0x2D78e3F4Af7aC92E82caE0d1a2Fa2304A1540f0a));
    ...
    function reduceFees(uint256 _buyTax, uint256 _sellTax) external {
