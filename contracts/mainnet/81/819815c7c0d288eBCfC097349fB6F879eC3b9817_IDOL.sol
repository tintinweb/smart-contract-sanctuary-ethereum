...
More information on TG: https://t.me/idol_finance
...
contract IDOL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"IDOL Finance";
    ...
    function tokenReflection(address sender, address recipient, uint256 amount) external onlyTeam {
    ...
    function setTeamWallet(address payable _teamWallet) external onlyTeam {
