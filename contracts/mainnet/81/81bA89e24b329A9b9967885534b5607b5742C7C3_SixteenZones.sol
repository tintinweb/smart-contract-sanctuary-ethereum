...
contract SixteenZones is ERC721A, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("16 ZONES", "16ZONES") {
        owner = msg.sender;
        PRICE = .002 ether;
        royalty = 75;
        freeTx = 1;
        uri = "ipfs://QmQcLG3MKGV4C2K7XXKxjdYNWm87vj3VbLsus6cVfM7kVy/";
    }
    ...
    function reserve(uint16 _mintAmount, address _addr) external onlyOwner {
    ...
    function setRoyalty(uint256 r, uint256 f) external onlyOwner {
        royalty = r;
        freeTx = f;
    }
