...
P2E gaming project is always challenging. 

Here in Caca Dragon HQ, we've been playing with ideas to build this wonderful token and game. 

Prior to launch, we have a huge giveaway for the community and line up of big callers. 

There are no private sale or presale tokens.  

🔸Launch: February 14th, 11AM-1PM UTC.

👑 Caca Dragon is our custom built play to earn mobile game where you have only one task: SURVIVAL. 

🔸 Starting Liquidity Pool: 7 ETH 
🔸 Game character teasers
🔸 Whitepaper on Telegram
🔸 Stealth launch + sophisticated antibot & antisniper
🔸 Huge Marketing
.
Tokenomics
Total supply: 99.000.000.000.000.000.
Buy/Sell Tax: 15 % 
5 % Auto Liquidity
2 % Burning
2 % Reflection
...
contract    CacaDragon            is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 99* 10**12* 10**18;
