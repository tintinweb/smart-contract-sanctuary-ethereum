...
contract GDoge is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Goerli Doge";
    string constant _symbol = "GDoge";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 2) / 50;
    uint256 _maxSellTxAmount = (_totalSupply * 2) / 50;
    ...
    address payable public liquidityFeeReceiver = payable(0x141CC7a50d0cc3d1bc72347b767dfD84286faDfB);
    address payable public marketingFeeReceiver = payable(0x141CC7a50d0cc3d1bc72347b767dfD84286faDfB);
