...
/*
>https://t.me/KowaretaDragonETH
>https://twitter.com/kowaretadragon
*/
...
contract KowaretaDragon is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x22d315494214bb01b9F3B5aaaCE1e219036924BC));

    string private _name = "KowaretaDragon";
    string private _symbol = "KOWARETA";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(100); //1%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(100); // 1%
