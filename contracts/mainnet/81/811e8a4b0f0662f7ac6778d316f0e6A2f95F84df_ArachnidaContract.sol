...
//                           _           _     _       
//      /\                  | |         (_)   | |      
//     /  \   _ __ __ _  ___| |__  _ __  _  __| | __ _ 
//    / /\ \ | '__/ _` |/ __| '_ \| '_ \| |/ _` |/ _` |
//   / ____ \| | | (_| | (__| | | | | | | | (_| | (_| |
//  /_/    \_\_|  \__,_|\___|_| |_|_| |_|_|\__,_|\__,_|
//                                                     
//                                                     
//
//*********************************************************************//
...
abstract contract Withdrawable is Teams, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x16DB1f0a581acE4371016B83853C7ecee5dFA060];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 1500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmRsBgAFtjHoaK3EXESTZ1ch5z4VMekLUFSDSMzA3QWLVj/3QWLVj/";
...
// File: contracts/ArachnidaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ArachnidaContract is RamppERC721A {
    constructor() RamppERC721A("Arachnida", "vials"){}
}
