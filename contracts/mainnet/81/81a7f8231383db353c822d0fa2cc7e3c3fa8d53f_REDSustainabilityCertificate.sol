...
library Counters {
    ...
    struct LimitCounter {
        ...
        // this feature: see https://github.com/ethereum/solidity/issues/4637
        uint256 _value; // default: 0
        uint256 _limit; //default 0
    }

    function current(LimitCounter storage counter) internal view returns (uint256) {
        return counter._value;
    }

    function currentLimit(LimitCounter storage counter) internal view returns (uint256) {
        return counter._limit;
    }
    function setLimit(LimitCounter storage counter,uint256 limit) internal{
        require(counter._value<limit,"cannot set a lower limit then the value");
        counter._limit=limit;
    }
    function increment(LimitCounter storage counter) internal {
        // The {SafeMath} overflow check can be skipped here, see the comment at the top
        require(counter._value<counter._limit,"cannot add above the limit");
        counter._value += 1;
    }

    function decrement(LimitCounter storage counter) internal {
        counter._value = counter._value.sub(1);
    }
}
//end Counters.sol
...
//end IERC721Metadata.sol
// ----------------- 

//begin IERC721Enumerable.sol
/**
...
//end ERC721Pausable.sol
// ----------------- 

//begin ERC721Burnable.sol
/**
...
//end ERC721Burnable.sol
// ----------------- 

//begin REDSustainabilityCertificate.sol
contract REDSustainabilityCertificate is ERC721, AccessControl, ERC721Pausable, ERC721Burnable {
        ...
        )
    {
        ...
        uint256 _co2offset = 750 * reogBurned + 1000 * gtkBurned;
        SustainabilityCertificateMetadata memory _metadata = SustainabilityCertificateMetadata({
...
//end REDSustainabilityCertificate.sol