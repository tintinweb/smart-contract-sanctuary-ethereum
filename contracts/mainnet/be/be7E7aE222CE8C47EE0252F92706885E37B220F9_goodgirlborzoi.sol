...
abstract contract DefaultOperatorFilterer is OperatorFilterer {
    ...
    contract goodgirlborzoi  is ERC721A, DefaultOperatorFilterer , Ownable {
    using Strings for uint256;


  string private uriPrefix;
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmWLWVYP5zTXjj2KW47PN26ZsubJPTrtd9ERxu6kv1bQXj";
  ...
  constructor() ERC721A("goodgirlborzoi", "GGBZ") {
  }
  ...
  function ReserveAirdrop(uint16 _mintAmount, address _receiver) external onlyOwner {
     uint16 totalSupply = uint16(totalSupply());
    require(totalSupply + _mintAmount <= maxSupply, "Exceeds max supply.");
