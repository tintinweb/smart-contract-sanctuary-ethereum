...
contract Catto is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Catto";
    string private constant _symbol = "CATTO";
    ...
    address payable private _developmentAddress = payable(0xC22710aC6B7b1a343e750304Dea8ECef417A6f72); 
    address payable private _marketingAddress = payable(0xC22710aC6B7b1a343e750304Dea8ECef417A6f72);
