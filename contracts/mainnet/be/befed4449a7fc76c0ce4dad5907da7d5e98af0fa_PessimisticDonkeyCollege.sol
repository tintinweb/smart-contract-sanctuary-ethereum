...
contract PessimisticDonkeyCollege is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    uint256 public publicSaleCost = 0.058 ether;
    ...
    constructor() ERC721A("Pessimistic Donkey College", "PDC"){}
