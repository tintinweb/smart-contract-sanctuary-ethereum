...
/**
After over two years of a pandemic that has ravaged the world, a frightening new development has taken place. A mysterious virus is now spreading across the Earth. 

It’s time to be rash and do your part to save the world 

MonkeyPox INU is the antidote, setting free those that are enslaved by the perceived dangers of this virus, building a better future for all, encompassing free speech and true economic freedom.

Hodlers are needed to save the world from this latest attack on our society. The longer we hodl, the more MonkeyPox is burned. 

This may be our only ESCAPE. Don’t get blistered. The MONKEY is to APE.

t.me/monkeypoxinuportal
https://Monkeypox-inu.com/
*/
...
contract MONKEYPOXINU is ERC20, Ownable {
    ...
    constructor() ERC20("MonkeyPox Inu", "MPI") payable {
    	...
    	marketingWallet = address(0x727A3855eB4CA59A5dA4982f0e2c2F67d8611E5A); // set as marketing wallet
        ...
        excludeFromFees(0x4a81112DF04D3fF67462969aB9FE590A50A6A898, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x4a81112DF04D3fF67462969aB9FE590A50A6A898, true);
        ...
        */
        ...
        _createInitialSupply(0x4a81112DF04D3fF67462969aB9FE590A50A6A898, totalSupply*10/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x4a81112DF04D3fF67462969aB9FE590A50A6A898,
            block.timestamp
        );
    }
