...
contract DroppGroupEmailNfTs is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 3;
    uint256 public immutable supply = 3;
    ...
    address[] public withdrawAddresses = [0x29F1EafBC7542Cf13bBE5EdDF8415cd01a3D5b0d, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x29F1EafBC7542Cf13bBE5EdDF8415cd01a3D5b0d, _royaltyAmount);
    }
