...
contract BabyBlur is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BabyBlur", "BabyBlur") {
        ...
        swapTokensAtAmount = supply * 1 / 10000; // 0.05% swap wallet;
        ...
        devWallet = 0x01367CaBaE8741842a7055d4421F945e974cF0B0;
