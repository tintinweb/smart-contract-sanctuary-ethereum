...
contract ChainZokuLoot is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("ChainZoku Loot", "CZKU") {
    setHiddenMetadataUri("ipfs://QmSw31bDJUcDX8qyzcZq97DxBSd4eUXhwh1jkbjpN9e5Yz/hidden.json");
  }
