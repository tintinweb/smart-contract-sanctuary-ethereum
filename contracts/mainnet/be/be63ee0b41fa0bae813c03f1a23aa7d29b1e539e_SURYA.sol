...
contract SURYA  is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE SUN GOD";
    string private constant _symbol = "SURYA";
    ...
    constructor () {
        dev = payable(0x4E0A4Dcc500eB4e217900dB9bc099Da5920D2451);
        mktg = payable(0x4E0A4Dcc500eB4e217900dB9bc099Da5920D2451);
