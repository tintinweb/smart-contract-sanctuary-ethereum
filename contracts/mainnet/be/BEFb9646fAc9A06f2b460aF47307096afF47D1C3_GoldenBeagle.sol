/*
Token Description : 
Golden Beagle - is the latest dog token to hit the ERC, 
you will not have seen this kind of Cute Beagle anywhere else in the space.
Although there are plenty of a different kind 🐶

Twitter - https://twitter.com/GoldenBeagleERC
Medium - https://medium.com/@GoldenBeagle
Telegram - @goldenbeagle
...
contract GoldenBeagle is ERC20, Ownable {
    ...
    constructor() ERC20("Golden Beagle", "GOLDB") {
        ...
        marketingWallet = address(0xBED0cDc3cBfD9CbD44cD92A821342A57F165f53F);
