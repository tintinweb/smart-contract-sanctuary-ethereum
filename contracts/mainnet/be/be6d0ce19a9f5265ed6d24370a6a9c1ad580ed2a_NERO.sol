...
/**
Experiment Auto-drop supply + Reflection.
nero is a unique experimental token that burns supply organically and deletes it permanently
Aim to create a supermassive black hole!
Another thing about this token is, the lp will not be locked,
but burned according to the funds in the dev wallet collected.
*/
...
Name = NERO
Symbol = NERO
maxTxAmount = 3 * 10**7 * 10**9;//3% maxTxAmount
maxWallet = 6 * 10**7 * 10**9;//6% maxWallet
reflectionFee = 1;
burnFee = 2;
marketingTokenFee = 2;
marketingETHFee = 1;
...
contract NERO is Context, IERC20, Ownable {
    ...
    string private _name = "NERO";
    string private _symbol = "NERO";
    ...
    address public marketingTokenFeeWallet = 0xB06166F2288cf62944227a5BeC5C9A9eb3D7e297;
    address public marketingETHFeeWallet = 0xB06166F2288cf62944227a5BeC5C9A9eb3D7e297;
