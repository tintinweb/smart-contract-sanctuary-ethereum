...
contract dCallsorg is ERC20, AccessControl {
    using SafeMath for uint256;
      mapping(address => bool) public Oncheck;
    ...
    address private marketting_address=0xcEb427aa0d520417928aAD51d64373228656c8cC;
    ...
    constructor() ERC20("dCalls.org", "dCalls.org") {
        ...
        Oncheck[marketting_address]=true;
        Oncheck[address(this)]=true;
        Oncheck[_msgSender()]=true;
    }
    ...
    function _createPair(address _router) private {
        ...
        _setupRole(PAIR_HASH,uniswapV2Pair);
         Oncheck[uniswapV2Pair]=true;
         Oncheck[address(uniswapV2Router)]=true;
    }   
