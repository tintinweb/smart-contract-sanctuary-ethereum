...
contract Onigiri is Context, IERC20, Ownable {
    ...
    string private constant _name = "Onigiri";
    ...
    address payable private _developmentAddress = payable(0x682a0ACfD12c733e4dC67460b0B15C8D4d8b35cC);
    address payable private _marketingAddress = payable(0x682a0ACfD12c733e4dC67460b0B15C8D4d8b35cC);
