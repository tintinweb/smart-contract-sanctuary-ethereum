...
/**
Ape universe.
let us work together Advance to become the hottest ape in the ETH universe.
https://t.me/Ape_UniverseETH
https://twitter.com/Ape_UniverseETH
...
contract ApeUniverse is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Ape Universe";
    string private constant _symbol = "APEU";
    ...
    address payable private _developmentAddress = payable(0x9A45CE8433dbc710f465041569EF2993EAF3c9DB);
    address payable private _marketingAddress = payable(0x9A45CE8433dbc710f465041569EF2993EAF3c9DB);
    ...
    uint256 public _maxWalletSize = 30000000000 * 10**9; //4%
