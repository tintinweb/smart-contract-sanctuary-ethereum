 ...
 */
contract BRLCTokenBridgeable is BRLCTokenBase, IERC20Bridgeable, IERC20Freezable {
...
interface IERC20Freezable {
    /**
     * @dev Emitted when token freezing has been approved for an account.
    ...
    /**
     * @dev Approves token freezing for the caller.
     *
    ...
    /**
     * @dev Freezes tokens of the specified account.
     *
    ...
    /**
     * @dev Checks if token freezing is approved for an account.
     *
