...
contract MU is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("MU", "MU") {}
    uint256 public max_num=1000000000 * 10 ** 18;
    uint256 public now_num=0;
    ...
    function mint(address to, uint256 amount) public onlyOwner {
        require((now_num + amount)<=max_num,"max_num is 1000000000");
        now_num = now_num + amount;
        _mint(to, amount);
    }
