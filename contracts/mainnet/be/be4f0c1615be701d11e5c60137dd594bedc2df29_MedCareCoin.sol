...
contract MedCareCoin is Context, IERC20 {
    ...
    uint256 public maxWalletBalance = 250000000000 * 10 ** decimals();  // 1% of total supply
    uint256 public MaxTradeLimit = 500000000000 * 10 ** decimals();     // 0.5% of total supply
