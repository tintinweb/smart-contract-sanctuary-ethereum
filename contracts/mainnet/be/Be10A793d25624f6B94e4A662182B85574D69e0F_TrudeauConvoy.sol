...
/*
    Trudeau Convoy - Prime Minister Trudeau created lovely convoy protests.
 
    If you missed the first convoy, feel free to join this one.  
...
contract TrudeauConvoy is Context, IERC20, Ownable {
    ...
    string private _name = "Trudeau Convoy";
