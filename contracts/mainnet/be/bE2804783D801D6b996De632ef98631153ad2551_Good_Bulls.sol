...
contract Good_Bulls is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 7001;
  uint256 public maxMintAmountPerTx = 3;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("GoodBulls", "GB") {
    setHiddenMetadataUri("ipfs://QmYvs9Fxp1fxxUfEMS4Bfsd6YskE68tNKhY8wmTHbVLVUe/hidden.json");
  }
