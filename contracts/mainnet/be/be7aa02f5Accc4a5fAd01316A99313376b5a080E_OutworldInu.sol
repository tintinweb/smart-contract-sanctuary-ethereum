/**
 ...
 With projects dying left and right before even reaching 100k MC, we are here to help, save, and support. 
 We will prove tonight that even with the extreme fear in the Crypto Space, projects can still moon! 
 With your help, we can reach the stars AND our goal, MAKE ETHEREUM GREAT AGAIN.

 * TG: https://t.me/alucarderc20official
 */
...
contract OutworldInu is ERC20, Ownable {
    ...
    constructor() ERC20("OUTWORLD INU", "OWI") {
        ...
        marketingWallet = payable(0xEC6F3389aC8a7e6a9dDdc1425f64Fc08890589A7);
        devWallet = payable(0xEC6F3389aC8a7e6a9dDdc1425f64Fc08890589A7);
