...
//https://t.me/ShikereumEntryPortal
...
contract  Shikereum is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "SHIKEREUM";
    string private _symbol = "SHIKEREUM";
    uint8 private _decimals = 9;
    address payable public _feeAddrWallet1;
    mapping (address => uint256) _balances;

    function OpendTrading() public onlyOwner{
    ...
    constructor () {
        ...
        _feeAddrWallet1 = payable(address(0xC5e7bEe8C7f9640cAece5AfDbE004De17af908c6));
