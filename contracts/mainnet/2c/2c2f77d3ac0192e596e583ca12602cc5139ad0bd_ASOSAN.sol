...
//ASOSAN - Burn the price up with the biggest volcano in Japan!
//https://medium.com/@asosan/
...
contract ASOSAN is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Asosan"; 
    string private constant _symbol = "ASOSASN";  
