...
// File: TheLastDragons.sol
pragma solidity ^0.8.4;
contract TheLastDragons is ERC721A, Ownable, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI) ERC721A("The Last Dragons", "TLD") {
