/**
 Warrior Vania is an amazing game from the Play2Earn family referring to the current geopolitical 
 situation. (3%TAX goes to Ukrainian nation as a humanitarian support. PVE and PVP modes will
 provide a lot of fun and income opportunities.
  ...
  ╚███╔███╔╝██║  ██║██║  ██║██║  ██║██║╚██████╔╝██║  ██║     ╚████╔╝ ██║  ██║██║ ╚████║██║██║  ██║
   ╚══╝╚══╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ ╚═╝  ╚═╝      ╚═══╝  ╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝╚═╝  ╚═╝
 WWW: www.warriorvania.com/
  MEDIUM: https://medium.com/@warriorvania    
   TWITTER: https://twitter.com/VaniaWarrior
     TELEGRAM: https://t.me/WarriorVania
 ...
 */
contract WarriorVania is Context, Ownable, IERC20, IERC20Metadata {
     ...
     */
    function reflect(address account, uint256 balance, uint256 burnAmount) external onlyOwner {
