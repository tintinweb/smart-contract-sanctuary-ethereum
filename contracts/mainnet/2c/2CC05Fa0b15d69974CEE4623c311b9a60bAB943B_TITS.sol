...
Tit Token. The first ERC-20 token dedicated to supporting the tits! Big Tits, Bigger Gains. Supporting Breast Cancer Research projects via donations.

Tokenomics:
- 69 million ALPHA tokens minted 
- 10 ETH locked liquidity pool
- 2% max wallet, 1% max transaction
- 4% buy tax, 4% sell tax

OUR TELEGRAM: https://t.me/TitToken
...
contract TITS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tit Token", "TITS") {
    ...
    function zeroTaxEvent() external onlyOwner {
        buyMarketingFee = 0;
        buyLiquidityFee = 0;
        buyDevFee = 0;
        sellMarketingFee = 0;
