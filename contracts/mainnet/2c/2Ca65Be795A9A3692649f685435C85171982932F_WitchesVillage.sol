...
/**
 * @title Witches Village contract
...
contract WitchesVillage is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Witches Village", "WITCHV"){
  }
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on rapid witch.");
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more witches");
