...
contract FormulaInu is ERC20, Ownable {
    ...
    constructor() ERC20("Formula Inu", "FINU") {
        ...
        maxTransactionAmount = 5_000_000 * 1e18; // 0.5% from total supply
        ...
        marketingWallet = address(0xb39337Da23dEeE819F2e7B10246B7660fe644e41); // set as marketing wallet
        devWallet = address(0xd42DdBecBd558AE00eF92A656d1d8c598174939A); // set as dev wallet
