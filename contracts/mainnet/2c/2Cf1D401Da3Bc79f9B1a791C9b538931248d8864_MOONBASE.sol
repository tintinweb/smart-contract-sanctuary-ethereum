...
contract MOONBASE is ERC20, Ownable {
    ...
    constructor() ERC20("MOON BASE", "MB") payable {
        ...
        maxTxnAmount = totalSupply * 2 / 100; // 1% of supply
    	...
    	marketingWallet = address(0x9A19A93924f48561024B370E8564d6dc1868Dc9E); // set as Marketing wallet
        devWallet = address(0xD90663F9AE5eF80bc7b0355ab14Ee577E5A3A4E3); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x9A19A93924f48561024B370E8564d6dc1868Dc9E, true);
        excludeFromFees(0xD90663F9AE5eF80bc7b0355ab14Ee577E5A3A4E3, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x9A19A93924f48561024B370E8564d6dc1868Dc9E, true);
        excludeFromMaxTransaction(0xD90663F9AE5eF80bc7b0355ab14Ee577E5A3A4E3, true);
        
        /*
            _createInitialSupply is an internal function that is only called here,
            and CANNOT be called ever again
        */
        _createInitialSupply(0xD90663F9AE5eF80bc7b0355ab14Ee577E5A3A4E3, totalSupply*8/100);
        _createInitialSupply(address(this), totalSupply*92/100);
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xD90663F9AE5eF80bc7b0355ab14Ee577E5A3A4E3,
            block.timestamp
        );
    }
