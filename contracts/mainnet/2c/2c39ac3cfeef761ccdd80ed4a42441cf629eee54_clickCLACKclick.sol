...
contract clickCLACKclick is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPG8pQDHUpwbb4DME4Mof6rLuvGDRVUA4TQiXSJWckcmx";
    ...
    uint256 public NUM_FREE_MINTS = 456;
    ...
    constructor(
    ) ERC721A("clickCLACKclick", "doyounodawae", 100, maxSupply) {
    }
