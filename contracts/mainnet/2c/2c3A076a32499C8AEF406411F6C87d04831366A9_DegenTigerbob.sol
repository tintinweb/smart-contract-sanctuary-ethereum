...
contract DegenTigerbob is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmVvZJ1djEdkKqX62WPhVG6Kh9deWY6i3EFVXradg6gwfJ";

  uint256 public  maxSupply = 5000;
  uint256 public  MAX_MINTS_PER_TX = 20;
  uint256 public  FREE_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.005 ether;
  uint256 public  TOTAL_FREE_MINTS = 3000;
  bool public isPublicSaleActive = true;

  constructor(

  ) ERC721A("degen tigerbob", "DBOB") {
