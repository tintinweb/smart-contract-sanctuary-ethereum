...
contract CARTOONKIDZ is ERC721A, Ownable {
    ...
    uint256 public freeMintMax = 1520;
    uint256 public price = 0.0025 ether;

    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmeS5GXocNF23mDJ9ZKrFnWuJWbz3M2Bg7hARqyw58dWdD/";
    string public constant baseExtension = ".json";

    bool public paused = true;
    error freeMintIsOver();

    constructor() ERC721A("CARTOON KIDZ", "CTKDZ") {}
