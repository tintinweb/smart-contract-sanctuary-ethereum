...
contract Shikibu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shikibu";
    string private constant _symbol = "Shikibu";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x027631285c5925c64f694be45533a4aC945B12C5);
    address payable private _marketingAddress = payable(0x89F5731a4aEf255B1953209B86C96Ff2f3Ec4661);
    ...
    constructor () {
        ...
        emit Transfer(address(0x89F5731a4aEf255B1953209B86C96Ff2f3Ec4661), _msgSender(), _tTotal);
    }
