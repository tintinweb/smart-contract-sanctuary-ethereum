...
contract zksyncNFT is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint public MAX_TEAM = 2000;
    uint public MAX_TX = 100;
    ...
    uint public saleStartTime = 1659298400;

    bytes32 public merkleRoot;

    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("zksync", "zksync")
    {
        baseURI = _baseURI;
