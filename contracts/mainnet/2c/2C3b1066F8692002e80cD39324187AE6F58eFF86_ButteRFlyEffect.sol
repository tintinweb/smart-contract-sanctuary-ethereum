...
How your life would of been different if you married person X instead of person Y, or how it would be different if you chose to buy Bitcoin in 2012, or anything else that could have made your life different? 
Well welcome to the Butterfly Effect.
...
The whole concept of the butterfly effect hinges on the idea, that minor actions can have huge consequences and alter our the direction of our lives and our future to an immense extent. This idea is based on the fact that an action (A →B →C) and so on. 
However if action A never occurs, the chain of events that follow would also have never happened.
