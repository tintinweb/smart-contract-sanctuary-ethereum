...
/*
Based Ukraine - JOIN THE MOVEMENT!

TELEGRAM : https://t.me/BasedUkraineWar_Join
WEBSITE :  https://basedukraine.com/war
TWITTER :  https://twitter.com/BasedUkraineWar
*/
...
contract BASEDUKRNE is Context, IERC20 {
    ...
    string private _name = "Based Ukraine";
    string private _symbol = "BASEDUKRNE";
    ...
    address payable private _marketingWallet = payable(0xB2f9009BBa849666EcfC50ff710c0c599a9bdc01);
    address payable private _teamWallet = payable(0x055Fc7439a020B2573EE356111B4e1fcc229F56A);
