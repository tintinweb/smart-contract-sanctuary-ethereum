...
contract TheRaptorSyndicate is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    constructor() ERC721("TheRaptorSyndicate", "RAPT") {
    ...
    function safeMint(address to) public payable {
        ...
        require(totalSupply() < maxSupply, "No more mintable tokens.");
        require(saleActive == true, "Tokens are not currently mintable.");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmZaKXBKRgMcBeGjk7h9hgooQaBZK2MXjJRVnmQNAW2vDC/";
    }
