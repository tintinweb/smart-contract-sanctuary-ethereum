...
╚██████╗╚██████╔╝██║ ╚═╝ ██║██║ ╚═╝ ██║╚██████╔╝██║ ╚████║██║   ██║      ██║   
 ╚═════╝ ╚═════╝ ╚═╝     ╚═╝╚═╝     ╚═╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝   ╚═╝      ╚═╝   
    ...
    The first ERC20 community token on the Ethereum network driven by Community 
    Every person is defined by the communities they belongs to

    > https://t.me/FromCommunity
    > https://FromCommunity.co
    > https://twitter.com/FromCommunityERC20
...
contract FromCommunity is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"From Community";
