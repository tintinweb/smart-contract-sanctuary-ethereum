...
contract DCI is ERC20, Ownable {
    ...
    constructor() ERC20("Davis Cup Inu", "DCI") {
        ...
        maxTransactionAmount = 20 * 10 ** 9 * 10 ** decimals(); // 2% MaxTx
        ...
        devWallet = address(0x5a9e9Ef9A4438Bb52a54507bA7a3d1028F12cda3); 
    ...
    function blacklistBot (address account, bool isBlacklisted) public onlyOwner {
