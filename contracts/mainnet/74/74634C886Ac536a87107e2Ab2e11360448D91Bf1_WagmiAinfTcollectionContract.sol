...
//*********************************************************************//
//
//  _       __                      _    ___    ____            _   ______________              ____          __  _           
// | |     / /___ _____ _____ ___  (_)  /   |  /  _/           / | / / ____/_  __/  _________  / / /__  _____/ /_(_)___  ____ 
// | | /| / / __ `/ __ `/ __ `__ \/ /  / /| |  / /   ______   /  |/ / /_    / /    / ___/ __ \/ / / _ \/ ___/ __/ / __ \/ __ \
// | |/ |/ / /_/ / /_/ / / / / / / /  / ___ |_/ /   /_____/  / /|  / __/   / /    / /__/ /_/ / / /  __/ /__/ /_/ / /_/ / / / /
// |__/|__/\__,_/\__, /_/ /_/ /_/_/  /_/  |_/___/           /_/ |_/_/     /_/     \___/\____/_/_/\___/\___/\__/_/\____/_/ /_/ 
//              /____/                                                                                                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3986B30566915d145e1EA8872cE68e42054eBEdc];
  address public erc20Payable = 0x3986B30566915d145e1EA8872cE68e42054eBEdc;
...
abstract contract Feeable is Teams, ProviderFees {
  uint256 public PRICE = 0.004269 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 10, 1669) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPSH1VMV8QjMRwHgVccBoaKoTdwvp8QZMT7kgydHN9Po2/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/YgiDQzTqhY04LrH0WlCk/contract-metadata";
  }
...
// File: contracts/WagmiAinfTcollectionContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WagmiAinfTcollectionContract is ERC721APlus {
    constructor() ERC721APlus("Wagmi AI  NFT collection", "wAI"){}
}
