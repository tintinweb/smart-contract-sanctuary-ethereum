...
contract TBB is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    uint256 public SALE_NFT = 4500;
	uint256 public RESERVED_NFT = 500;
	
	uint256 public MAX_MINT_PRESALE = 4;
	uint256 public MAX_MINT_SALE = 4;
	
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = 4;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 4;
	
	uint256 public PRESALE_PRICE = 0.066 ether;
