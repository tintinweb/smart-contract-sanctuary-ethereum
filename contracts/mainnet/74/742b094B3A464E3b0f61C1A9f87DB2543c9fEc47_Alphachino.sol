...
// Alphachino  0 tax alpha play for the chads. If you like alphas and alpacino, you wouldnt wanna miss this one. Cant say much more unfortunately. the alpha will unfold and the ones who doubt and fade will get hurt. fade at your own risk.

// Telegram: @AlphaChinoErc
// Twitter: will make this right after
// Website:  fuck a website
...
contract Alphachino is ERC20, Ownable {
    ...
    constructor() ERC20("alphachino", "alphachino") {
    ...
    function alphachino() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
