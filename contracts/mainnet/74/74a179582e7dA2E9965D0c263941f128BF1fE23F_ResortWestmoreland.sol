...
contract ResortWestmoreland is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public publicSalePrice = 0.078 ether;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("Resort Westmoreland", "RW")
