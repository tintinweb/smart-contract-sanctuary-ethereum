...
//   \____/ \__,_|___/\__| /_/    \_\ |____/|_|\__,_|_| |_|\__|
//                                                             
//                                                             
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x214B118e7E32c00EAd71706Ea3485AC02130B77A];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmawVpky7o1R8jeRBiWAXzxEjFdNMFaK2cRf1Kmpf7sWSv/";
...
// File: contracts/JustABluntContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JustABluntContract is RamppERC721A {
    constructor() RamppERC721A("Just A Blunt", "BLUNT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/boJLK0QRp12INw4iWbxQ/contract-metadata";
    }
}
