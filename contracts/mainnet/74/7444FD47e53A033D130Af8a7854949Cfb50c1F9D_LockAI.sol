...
// Telegram: https://t.me/lockaierc
// Website:  https://lockaierc.com
...
contract LockAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lock AI";
    string private constant _symbol = "LOCKAI";
    ...
    address payable private _developmentAddress = payable(0x636C830Cef987A0CC821F8E2a570a7802afCa6d0);
    address payable private _marketingAddress = payable(0x9a195e38310622F6962EFbc93504a0a0F01dAcea);
