...
contract Drogon is ERC20, Ownable {
    ...
    constructor() ERC20("DROGON", "DROGON") {
        ...
        marketingWallet = address(0xE1A6ecDD741306163e80a3f3A0d9e57ccBbFE350); // set as marketing wallet
