...
//   _____ _    _ _____ _____ _  ________ _   _ _____         _____ _____ 
//  / ____| |  | |_   _/ ____| |/ /  ____| \ | |  __ \ /\    / ____/ ____|
// | |    | |__| | | || |    | ' /| |__  |  \| | |__) /  \  | (___| (___  
// | |    |  __  | | || |    |  < |  __| | . ` |  ___/ /\ \  \___ \\___ \ 
// | |____| |  | |_| || |____| . \| |____| |\  | |  / ____ \ ____) |___) |
//  \_____|_|  |_|_____\_____|_|\_\______|_| \_|_| /_/    \_\_____/_____/ 

// 500 stock. 100% free. we have 100 codes to start, and we will use royalties to buy more.
...
contract CHICKENPASS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmX9AypnDZ2WZWE5WXJL1msD7b6TzRMQyT2CW5FvTnMzND";
    ...
    constructor(
    ) ERC721A("CHICKEN PASS", "CHKNPSS", 100, maxSupply) {
    }
