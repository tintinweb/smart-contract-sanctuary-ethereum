...
contract PillsOGEdition is ERC721A, Ownable, ReentrancyGuard {

    string public baseURI = "ipfs://QmW7fvrjt2uvbNq3mGZCneRxRMDxXW8JmjZ7Gjm3F3touq/";
    string public baseExtension = ".json";
  uint public          price             = 0.005 ether;
  uint public          maxPerTx          = 10;
  uint public          maxTxForFreeMints    = 1;
  uint public          totalFree         = 100;
  uint public          maxSupply         = 550;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled = true;

  constructor() ERC721A("Pills OG Edition", "Pills OG Edition"){
