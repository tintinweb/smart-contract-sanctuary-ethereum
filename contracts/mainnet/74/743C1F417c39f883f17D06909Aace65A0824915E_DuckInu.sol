...
contract DuckInu is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "DuckInu";
    string private constant tokenSymbol = "DuckInu";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x91291201F5b6F8DaCF62feE90F5940aC3e11cC94);
        devAddress = payable(0x91291201F5b6F8DaCF62feE90F5940aC3e11cC94);
