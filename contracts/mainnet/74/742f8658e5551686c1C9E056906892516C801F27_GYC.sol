...
contract GYC is Ownable, IERC20 {
    ...
    function setMarketing(address a) external onlyOwner {
        marketingWallet = a;
    }
    bool public swapEnabled = true;
    function setSwapEnabled(bool t) external onlyOwner {
        swapEnabled = t;
    }
    uint256 public maxWallet = _totalSupply.div(10);
    function setMaxWallet(uint256 t) external onlyOwner {
        maxWallet = t;
    }
    IUniswapV2Router private _router = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    string private _name = "Gentleman Yacht Club";
