...
Contract: X7 Initial Liquidity Loan Term (003) - "X7ILL003"

Name: Interest Only Loan
Loan Origination Fee: 15% of borrowed capital (6.66x leverage)
Loan Retention Premium: 6.25% in premiums due by the end of each quarter of the loan term
Principal Repayment Condition: 100% of borrowed capital due by the end of the loan term
...
contract X7InitialLiquidityLoanTerm003 is X7InitialLiquidityLoanTerm {
    constructor () Ownable(msg.sender) ERC721("X7 Initial Liquidity Loan Term (003)", "X7ILL003") {
