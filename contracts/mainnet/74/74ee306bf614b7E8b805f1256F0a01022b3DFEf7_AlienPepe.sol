...
contract AlienPepe is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "ALIPE";
    ...
    uint256 private constant _tTotal = 5100000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x87E7a97148cFBD05033Ccdb04F04a78305de0D34);
    address payable private _marketingAddress = payable(0x87E7a97148cFBD05033Ccdb04F04a78305de0D34);
    ...
    uint256 public _maxTxAmount = 102000000 * 10**9; //2%
    uint256 public _maxWalletSize = 102000000 * 10**9; //2%
    uint256 public _swapTokensAtAmount = 5100000 * 10**9; //0.1%
