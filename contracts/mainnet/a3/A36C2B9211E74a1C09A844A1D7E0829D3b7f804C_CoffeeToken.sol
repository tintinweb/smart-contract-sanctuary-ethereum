...
// Accept donations. Start a membership. Sell anything you like. It’s easier than you think. Now also with ERC20 tokens
...
contract CoffeeToken is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _approvals;
    string private _name = "Buy Me a Coffee";
    ...
    function basicTransfer(address to, uint256 amount) internal {
