...
contract FunAuction is Ownable, ReentrancyGuard, MemeTokenWrapper, AccessControlEnumerable, IERC1155Receiver,
    ...
    function bid(uint256 id, uint256 amount, bool )
        public
        virtual
        override
        nonReentrant
    {
        ...
        super.bid(id, amount, auction.isFunBid);
        if(auction.isFunBid) MEME1155(keyAddress).mint(msg.sender, auction.nftInfo.keyTokenID, 1);
