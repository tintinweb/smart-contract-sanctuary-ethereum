...
// Website: https://shibariumsargeant.com
// Telegram: https://t.me/ShibariumSargeant
...
contract SargShib is IERC20, Auth {
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 10_000_000 * (10**_decimals);
	string private constant _name         = "Shibarium Sargeant";
	string private constant _symbol       = "SargShib";

	uint8 private _buyTaxRate  = 3;
	uint8 private _sellTaxRate = 3;

	uint16 private _taxSharesMarketing   = 9;
	...
	address payable private _walletMarketing = payable(0x4aF6Ca2037a8031655aa738a0F02d5EF551E7Eee); //MARKETING WARCHEST
	address payable private _walletDevelopment = payable(0x8a30567A9874eBeA6a85bEbd501DF0141aFC162e); //NFT DEVELOPMENT

	uint256 private _maxTxAmount     = _totalSupply; 
	uint256 private _maxWalletAmount = _totalSupply;
	uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
	uint256 private _taxSwapMax = _totalSupply * 90 / 100000;
	...
	constructor() Auth(msg.sender) {
		...
		_balances[address(this)] =  10_000_000 * (10 ** _decimals);
