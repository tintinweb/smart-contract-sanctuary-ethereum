...
contract RiseOfTheRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Rise of the Rabbit";
    string private constant _symbol = unicode"RIBBI";
