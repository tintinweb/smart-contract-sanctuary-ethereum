...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/libraries/CollateralAuctionHouseLibrary.sol
...
library CollateralAuctionHouseLibrary {
    // retrieves amount to raise on given auction, depending on which type of collateral auction house is used
    // does not support English auction currently
...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v3/interfaces/pool/IUniswapV3PoolActions.sol
...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v3/interfaces/pool/IUniswapV3PoolDerivedState.sol
// SPDX-License-Identifier: GPL-2.0-or-later
/* pragma solidity >=0.5.0; */
...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v3/interfaces/pool/IUniswapV3PoolEvents.sol
// SPDX-License-Identifier: GPL-2.0-or-later
/* pragma solidity >=0.5.0; */
...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v3/interfaces/pool/IUniswapV3PoolImmutables.sol
// SPDX-License-Identifier: GPL-2.0-or-later
/* pragma solidity >=0.5.0; */
...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v3/interfaces/pool/IUniswapV3PoolOwnerActions.sol
// SPDX-License-Identifier: GPL-2.0-or-later
/* pragma solidity >=0.5.0; */
...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v3/interfaces/pool/IUniswapV3PoolState.sol
// SPDX-License-Identifier: GPL-2.0-or-later
/* pragma solidity >=0.5.0; */
...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/uni/v3/interfaces/IUniswapV3Pool.sol
// SPDX-License-Identifier: GPL-2.0-or-later
/* pragma solidity >=0.5.0; */
...
////// /nix/store/i6rj6hk5x56335fazygc2kl7g7xf3jal-h2o-keeper-flash-proxy/dapp/h2o-keeper-flash-proxy/src/GebUniswapV3MultiHopKeeperFlashProxy.sol
/* pragma solidity ^0.6.7; */

/* import "./uni/v3/interfaces/IUniswapV3Pool.sol"; */
/* import "./libraries/CollateralAuctionHouseLibrary.sol"; */
