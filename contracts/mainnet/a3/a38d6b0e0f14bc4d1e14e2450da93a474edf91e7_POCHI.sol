...
/**
"I always love hearing you talk about your dreams, Degens.
 Here's the deal. I'll give you MOONSHOT
 and in exhange, I want you, degens, to show me your DREAM"
                                    ~~~POCHITA INU

Telegram: https://t.me/PochitaInuPortal
Twitter: https://twitter.com/Pochita_Inu
...
contract POCHI is ERC20, Ownable {
    ...
    constructor() ERC20("Pochita Inu", "POCHI") {
        ...
        marketingWallet = address(0xE826D955E230bdB5A62129e5156347d51F7248fA); // set as marketing wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x8c34Eb7b455AeD2687bDd43A2D1956b5BeE0c38A,
            block.timestamp
        );
    }
