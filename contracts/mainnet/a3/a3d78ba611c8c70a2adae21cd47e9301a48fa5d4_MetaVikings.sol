...
contract MetaVikings is ERC721, Ownable {
  using Strings for uint256;
  ...
  function setPresaleSaleCost(uint256 _presaleSaleCost) public onlyOwner {
    presaleCost = _presaleSaleCost;
  }

  function setMaxMintPerPresaleAccount(uint256 _maxMintAmountPerPresaleAccount) public onlyOwner {
