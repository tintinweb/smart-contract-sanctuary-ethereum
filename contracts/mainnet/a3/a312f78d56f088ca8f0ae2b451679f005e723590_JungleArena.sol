...
contract JungleArena is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public wlSalePrice = 0.0079 ether;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, address _signerAddressWL, string memory _baseURI) ERC721A("Jungle Arena", "JA")
