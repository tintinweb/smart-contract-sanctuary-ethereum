...
contract SeretanMinterFix is PullPayment, ISeretanMinter {
  mapping(address => Phase[]) private phaseList;

  mapping(address => mapping(uint256 => uint256)) private numberOfMinted;
    ...
    payable
  {
    ...
    require(phaseList[collection][currentPhaseNumber].maxNumberOfMinted > numberOfMinted[collection][currentPhaseNumber], "Unable to mint anymore");
  ...
  function _mint(
    ...
    internal
  {
    numberOfMinted[collection][currentPhaseNumber]++;
