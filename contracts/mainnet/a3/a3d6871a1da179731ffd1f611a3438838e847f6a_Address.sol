...
contract Spooktober is IERC20, Ownable {
    ...
    string constant _name = "Spooktober";
    string constant _symbol = "BOO";
    ...
    constructor () {
        ...
        distributor = new DividendDistributor(routerAddress, 0x54f8C485187f928c5f5a20e1AfB5B31246c1122a);
        ...
        marketingFeeReceiver = payable(0x54f8C485187f928c5f5a20e1AfB5B31246c1122a);
    ...
    function withdrawStuckCro() public onlyOwner {
