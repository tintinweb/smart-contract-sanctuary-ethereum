...
contract Goldiggerz is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 9735;
    uint256 public MAX_MINTS = 10;
    string public baseURI = "ipfs://QmT2bYd6TjRafRANxrqsZMgTjLsEbmmpZBAuzmpzyTT2HP/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Goldiggerz NFT Club", "GNC", MAX_MINTS, MAX_SUPPLY) {  
    }
