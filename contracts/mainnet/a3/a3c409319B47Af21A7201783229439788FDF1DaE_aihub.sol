...
/*
Twitter: https://twitter.com/aihubmarket
Telegram: https://t.me/AiHubMarket
Website: https://AiHubMarket.org
*/
...
contract aihub is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 500_000_000_000 * (10**_decimals);
    string private constant _name         = "Ai Hub";
    string private constant _symbol       = "AiHub";
    ...
    address payable private _walletMarketing = payable(0x956bC3ccc7b73ca1A44e193082aa85EEe4B8df36); 
    address payable private _walletDevelopment = payable(0xcA655367fC6499448FB6068B89b7E1c428CAC911); 

    uint256 private _maxTxAmount     = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
    uint256 private _taxSwapMax = _totalSupply * 95 / 100000;
    ...
    constructor() Auth(msg.sender) {
        ...
        _balances[address(this)] =  250_000_000_000 * (10 ** _decimals);
