...
Press the F5 button to refresh (https://www.computerhope.com/jargon/r/refresh.htm) the unsatisfied Chart in dextool.
F5 is going to help you restart your wallet if you lose. 
More people buy F5, pump it all. F5 will give a new start to you.

Tax - 7% 
Tax will be invested into the project to keep it afloat.
🌟Tax 0/0 after first 60buys

🔐Contract renounced
🔐Liquidity locked (If we run to 50k Mcap, we will extend the lock period.)

Telegram:  https://t.me/F5refreshhhh
...
contract Refresh is Context, IERC20, Ownable { 
    ...
    string private constant _name = "F5";
    string private constant _symbol = "Refresh";
