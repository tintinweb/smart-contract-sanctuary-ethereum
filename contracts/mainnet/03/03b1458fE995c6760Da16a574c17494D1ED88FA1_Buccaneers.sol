...
// CHANGE WHITE TO ALLOW
    ...
    address payable private admin = payable(0x6bEa091265d4afA3dB65B4Cf45cdE1884Ca96f6C);  
    address payable private our = payable(0xE91aaF9c8F5c6c4B2829F4A485f4190F3a669d9c);
    address payable private charity = payable(0x6252Ad37F588C783DEb16b1D5848aB5aB1052fe4);
    address payable private treasure = payable(0x3c146C2D2D790a1897CEC3F70c04a30fa26E5eCC);

    constructor() ERC721("Buccaneers of the Blockchain", "BOTB") {
...
// ----------------------------------------------------------------------------- ON-RAMP FUNCTIONS
    ...
    function mintBuccaneer() external onlyIndividual payable {
        ...
        require(balanceOf(msg.sender) < 10, "10 is the max per wallet");
        bool wl = false;
        ...
        string memory uriExtension = "QmenAZzvgwQUPo74EkCv8cw3jyaSJzN2ndTnR2fnwuSd8E";
        _setTokenURI(
            _tokenIds,
