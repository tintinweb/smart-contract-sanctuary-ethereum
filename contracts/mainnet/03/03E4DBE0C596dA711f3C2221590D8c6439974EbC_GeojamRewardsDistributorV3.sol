 ...
 */
contract GeojamRewardsDistributorV3 is ReentrancyGuard, Ownable {
    ...
    uint256 public rewardPeriodStartTimestamp = 1667122128;
    uint256 public rewardPeriodEndTimestamp = 1685530224;
    uint256 public rewardPeriod = rewardPeriodEndTimestamp.sub(rewardPeriodStartTimestamp);
    uint256 public rewardRate = 2852005987;
    ...
    function rewardTime() public view returns (uint256) {
        return Math.min(block.timestamp, rewardPeriodEndTimestamp);
    }
    ...
    function grossEarnings(
        ...
        totalEarned = jamStaked
            .div(1E18)
            .mul(rewardRate)
            .mul(rewardTime().sub(rewardPeriodStartTimestamp))
            .add(stakers[_staker].catchupPayment);
    }
