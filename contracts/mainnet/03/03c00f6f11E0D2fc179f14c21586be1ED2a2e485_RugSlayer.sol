...
/*
    ...
    Twitter: https://twitter.com/RugSlayer_Erc20
...
contract RugSlayer is Context, IERC20, Ownable {
    ...
    string private constant _name = "RugSlayer";
    ...
    function updateIsBlacklisted(address account, bool state) external onlyOwner{
        if(account != address(this)) _isBlacklisted[account] = state;
    }

    function setAnitDumpFee(uint _fee)  external onlyOwner() {
        _initialTax = _finalTax = _fee;
    }
