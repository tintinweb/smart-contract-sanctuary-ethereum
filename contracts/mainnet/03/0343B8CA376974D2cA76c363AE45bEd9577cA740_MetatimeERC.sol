...
Portal : https://t.me/MetatimeErc
Twitter : https://twitter.com/MetatimeErc
...
contract MetatimeERC is Context, IERC20, Ownable {
    ...
    uint256 public constant totalSupply = 500_000_000 * 10**decimals;
    string public constant name = "Metatime";
    string public constant symbol = "$MTIME";
