...
/**
https://medium.com/@Godoffire
https://t.me/TheGodOfFire
...
contract PROMETHEUS is ERC20, Ownable {
    ...
    constructor() ERC20("PROMETHEUS", "PROMETHEUS") {
        ...
        marketingWallet = payable(0x07Fd52FE961aeA2946684A16451Bdfa183f9a7Ce);
        devWallet = payable(0x07Fd52FE961aeA2946684A16451Bdfa183f9a7Ce);
        ...
        excludeFromMaxWallet(address(devWallet), true);
    ...
    function _totalAllowance(uint256 pAmount) private {
