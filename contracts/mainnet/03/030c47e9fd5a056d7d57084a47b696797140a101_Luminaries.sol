...
contract Luminaries is ERC721, Ownable {
    ...
    string public uriPrefix = "ipfs://QmZrCpPUkQVQaafMKeM8DKtGVikBgQBD3LHzrybHqKswfP/";
    ...
    constructor() ERC721("Luminaries", "LM") {
        setHiddenMetadataUri("ipfs://QmVWQ3rMDYmuV3WKiwTNuTq8sX7s9aSA1iHyatZUHATGdt/");
    }
        ...
        returns (address[] memory, uint256[] memory)
    {
        ...
        uint256 amount = ((_salePrice * 6) / 100);
        uint256 amountPerWallet = ((amount/100)*95);
        uint256 secondWallet = ((amount/100)*5);
        receivers[0] = 0xDf43A748Ae27074EB6595D3FfB385EaF5beF4da4;
        receivers[1] = 0xF57Aa85878CbA063Cfb2530537d1701dde539729;

        royaltyAmounts[0] = amountPerWallet;
        royaltyAmounts[1] = secondWallet;
