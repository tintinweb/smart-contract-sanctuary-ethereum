...
contract SHIBCHEDDA is Context, IERC20 {
    ...
    uint256 private startingSupply = 100_0000_000_000;
    ...
    uint256 constant public maxSellTaxes = 8500;
    ...
    address payable private _marketingWallet = payable(0x80742d82349dcACfD66C538182CaA696A5E76aB9);
    address payable private _teamWallet = payable(0x80742d82349dcACfD66C538182CaA696A5E76aB9);
