...
/*
       The bull run is back time to celebrate
       https://t.me/BullRunBackPortal
...
contract brbF is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("BullrunBack", "BRB") { // 
        marketingWallet = payable(0xcEFfdeA963A3c43099841298cBDA6b044C61618B); // 
        devWallet = payable(0xaDC78E42D92476F400B08CA9BF61d15Ee1c9b2F7); // 
