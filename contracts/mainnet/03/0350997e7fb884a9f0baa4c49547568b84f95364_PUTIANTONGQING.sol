...
/*
打倒日本帝国主义！
吃席了，没锁池子放弃所有权之前不要购买。这是最好的节日啊，7.7卢沟桥事变之后，7.8就是他的报应！
https://t.me/abeERC20
*/
...
contract PUTIANTONGQING is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"安倍晋三没了", unicode"普天同庆") {
		...
		marketingWallet = address(0x7FDBb70f3b02b21f8Ef54497dbfea4706139025A); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x7FDBb70f3b02b21f8Ef54497dbfea4706139025A)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x7FDBb70f3b02b21f8Ef54497dbfea4706139025A)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x7FDBb70f3b02b21f8Ef54497dbfea4706139025A)] = true;
