...
contract tinypoker is ERC721A, TheOperatorFilterer {
    ...
    constructor() ERC721A("tiny poker", "poker") {
        owner = msg.sender;
        maxPerTx = 20;
        cost = 0.002 ether;
        maxSupply = 999;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmTfGeCJxTytbBXWwPRVhkRBxW3fieCjtupDJPE1hmeMpf/", _toString(tokenId), ".json"));
    }
