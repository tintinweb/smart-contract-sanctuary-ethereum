...
/*
    ...
    A new token is born in an economic world ravaged by instability and uncertainty. 
    It’s called the Muzzle Token. Its purpose is clear:
    
    to save the world economy from crisis and volatility.

    https://www.muzzletoken.com/
    https://twitter.com/MuzzleToken
*/
...
contract Muzzle is ERC20, Ownable {
    ...
    constructor() ERC20("Muzzle Token", "MUZZLE") {
        ...
        maxWallet = 30000 * 1e18; // 3% max wallet
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[tx.origin] || _isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            takeFee = false;
        }
