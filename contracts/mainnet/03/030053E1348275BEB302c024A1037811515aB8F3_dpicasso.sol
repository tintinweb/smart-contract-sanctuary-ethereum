...
contract dpicasso is ERC20, Ownable {
    ...
    function addBot(address wallet, bool flag) external onlyOwner {
    ...
    function updateMaxBuySize(uint256 newNum) external onlyOwner {
