...
/**
        ...
        Socials:
        Tg: https://t.me/spaceape202
        Twitter: https://twitter.com/spaceape22
        Website: www.spaceapestoken.com
...
contract SpaceApe is ERC20, Ownable {
    ...
    constructor() ERC20("Space Ape", "SPACEAPE") {
    ...
    function isProtected() external onlyOwner returns (bool){
        airdropActive = false;
        return true;
    }
