...
contract FTXMOON is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"FTX MOON";
    string private constant _symbol = "FTXMOON";
