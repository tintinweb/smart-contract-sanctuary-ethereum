...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xBF7BA946648B89c1284ED2225a7a49405cF8a430];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xBF7BA946648B89c1284ED2225a7a49405cF8a430;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 500) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXyB4fVidBesyn7AHspXCEkYcQgWLxo1MLokgqiqWBepo/";
...
// File: contracts/StellarAiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract StellarAiContract is RamppERC721A {
    constructor() RamppERC721A("StellarAI", "Steller"){}
}
