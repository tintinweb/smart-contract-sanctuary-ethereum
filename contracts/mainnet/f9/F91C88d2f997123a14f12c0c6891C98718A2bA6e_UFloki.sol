...
/**
Website: https://uglyfloki.com/
TG: https://t.me/UglyFloki
Twitter: https://twitter.com/UglyFloki
Website and SniperDAPP will be alive before launch!
...
contract UFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Ugly Floki";
    string private _symbol = "UFloki";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x34dC7529233f45E1AAcA98783ccE7c47d7832f0c);
    address payable private taxWallet2 = payable(0x34dC7529233f45E1AAcA98783ccE7c47d7832f0c);
