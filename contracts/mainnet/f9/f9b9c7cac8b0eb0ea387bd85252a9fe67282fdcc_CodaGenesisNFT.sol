...
contract CodaGenesisNFT is ERC721A, Ownable, Pausable {
  using Strings for uint256;

  address private wallet1 = 0xEA7a8A7F45544C279350E1a84084cD5e9351ABE1;
  address private wallet2 = 0x8a70d34934a4A3B953fA65cBAD05186a28F78CA3;

  string public baseURI = "ipfs://QmbeEEAhVH9zZW36GFZoR4Gy52Bxub7dVWT2Xc1t5u2B2Q/";
  ...
  constructor() ERC721A("Coda Genesis", "CODA") {}
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool success1, ) = payable(wallet1).call{value: (balance * 85) / 100}("");
    require(success1, "Failed to withdraw to wallet1");

    (bool success2, ) = payable(wallet2).call{value: (balance * 15) / 100}("");
