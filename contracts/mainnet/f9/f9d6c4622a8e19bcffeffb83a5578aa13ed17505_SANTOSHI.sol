...
/**
    The gift giving is primarily about the relationships 
    being transacted - about the people involved in these 
    transactions. We only give gifts so that we may receive 
    something in return or so that it can be returned in the 
    feeling of gratitude and the formation of a social bond.
    Decentralization and its community is all about transactions
    of social bond and goods. I’m a nobody and this is my gift to you. 
    On every buy and sell I have added 4% Redistributions tax which 
    is sent to all holders. Stay pure and humble in your intentions 
    but bold in your actions. 

    Wishing you a magical, magnificent, and merry Christmas!


    We have created a logo for Community to use.

         : https://ibb.co/VDJM7J8
...
contract SANTOSHI is Context, IERC20, Ownable {
    ...
    string private _name = "Santoshi";
    string private _symbol = "SANTOSHI";
