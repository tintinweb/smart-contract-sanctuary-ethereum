...
contract SkullsRium3 is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xb8aD5D202a9A7ebb27479925AF185B9E446364DE));

    string private _name = "SkullsRium 3.0";
    string private _symbol = "SKullsRium3";
