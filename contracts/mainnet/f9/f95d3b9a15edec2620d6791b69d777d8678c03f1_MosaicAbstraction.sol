...
contract MosaicAbstraction is ERC721A, Ownable, DefaultOperatorFilterer {
  ...
  constructor() ERC721A("Mosaic Abstraction By Anoan", "MosaicAbstraction") payable {
    _mint(msg.sender, 1);
  }
  ...
  function mint(uint256 mintAmount_) public payable {
    ...
    unchecked {
      ...
      if (hasMinted[msg.sender]) {
        ...
        if (msg.value != (mintAmount_ - 1) * price) revert InvalidValue();
      }
    }
