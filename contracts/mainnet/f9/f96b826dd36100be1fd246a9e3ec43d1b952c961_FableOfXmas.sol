...
contract FableOfXmas is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Fable of Xmas";
    string private _symbol = unicode"FOX";
    ...
    uint256 private _maxTxAmount = 2500000 * 10**_decimals;
    uint256 private _maxWalletSize = 2500000 * 10**_decimals;
    ...
    constructor () {
        ...
        marketingWallet = payable(address(0x09b5d0ce8108e4F5Cb8D9156a6D53476fFc58a16));
