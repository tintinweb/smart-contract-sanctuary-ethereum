...
Welcome to Raven coin 

RavencoinETH offers fully decentralized  services on web3 that is unmatched by its competitors on the Ethereum blockchain. We aim to use our platform to  create an  easy, seamless and secure   trading experience of every investors of the Raven coin

Raven coin is now live!

Website :https://ravencoineth.com/

Telegram :https://t.me/RavenCoinERC/

Twitter: https://twitter.com/RavenCoinETH/

Medium :https://medium.com/@RavenCoinETH/

Portal: https://t.me/RavencoinETH/
...
contract RavenCoinETH is Context, IERC20, Ownable {
    ...
    string private _name = "RAVEN COIN ETH";
    string private _symbol = "$RAVEN";
