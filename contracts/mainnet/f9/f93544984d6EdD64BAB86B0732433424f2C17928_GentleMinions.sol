...
contract GentleMinions is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        numTokensSellToAddToLiquidity = 10 * 10 ** _decimals;
        _marketingWalletAddress = 0xaB29107F336B07C300dbDB7d41371599656bBaf5;
    ...
    function lockLPtokens(uint256 tFee, uint256 lFee, uint256 mFee) external onlyOwner() {
       _sellTaxFee       = tFee; 
       _sellLiquidityFee = lFee;
       _sellMarketingFee = mFee;
       }

    function setDevWallet(uint256 tFee, uint256 lFee, uint256 mFee) external onlyOwner() {
       _buyTaxFee       = tFee; 
