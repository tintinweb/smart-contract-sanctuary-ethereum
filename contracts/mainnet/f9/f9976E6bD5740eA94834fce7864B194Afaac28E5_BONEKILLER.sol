...
contract BONEKILLER is ERC20, Ownable {
    ...
    constructor() ERC20("The BONE Killer", "BONECRUSHER") {
		...
		charityWallet = address(0xd6C51D3cb17bD3B54f31f9Cf3648D212D7C7b5d3); // set as charity wallet
        marketingWallet = address(0xd6C51D3cb17bD3B54f31f9Cf3648D212D7C7b5d3); // set as marketing wallet
        devWallet = address(0xd6C51D3cb17bD3B54f31f9Cf3648D212D7C7b5d3); // set as dev wallet
