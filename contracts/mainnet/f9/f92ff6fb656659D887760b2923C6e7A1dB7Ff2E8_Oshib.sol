...
/*
         ...
         Optimism Shib
join the Optimism Movement in Blockchain
        With Optimism Shib.


telegram : https://t.me/OptimismShibaPortal
medium : https://medium.com/@optimismshiba/optimism-shiba-d62dde19b9db
twitter : https://twitter.com/optimismshib)
Website : TBA
*/
...
contract Oshib is Context, IERC20, Ownable {
    ...
    string private constant _name = "Optimism Shib";
    string private constant _symbol = "Oshib";
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =  101010101 * 10**_decimals;

    uint256 public _maxWalletAmount = 2020202 * 10**_decimals;
    uint256 public _maxTxAmount = 1010101 * 10**_decimals;
    uint256 public swapTokenAtAmount = 530000 * 10**_decimals;
