...
// File: contracts/omDogs-eth.sol

pragma solidity ^0.8.7;

contract omDogs is Ownable, ERC721, NonblockingReceiver {
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 6, "omni Dogs: Max 5 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_ETHEREUM,
            "omni Dogs: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "omni Dogss: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "omni Dogs: Failed to withdraw Ether");
    }
