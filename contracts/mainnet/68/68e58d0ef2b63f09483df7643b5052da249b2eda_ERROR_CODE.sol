...
**              ERROR_CODE_404
**
**              https://www.errorcode404.org/
**             
**              https://medium.com/@error404eth/error-404-c4d66e53eba3
**
**              https://twitter.com/ERRORCODE_ETH
**
**              https://github.com/ERROR404ETH/ERROR_CODE
**
**
**
...
contract ERROR_CODE is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0x0545a7f01D41e5E9E148Dddae36bD634A3205f02);
    ...
    constructor() ERC20("ERROR_CODE", "404") {
        ...
        uint256 totalSupply = 4.04 * 1e12 * 1e18;
 
        maxTransactionAmount = totalSupply * 6 / 1000; // .6% maxTransactionAmountTxn
        maxWallet = totalSupply * 12 / 1000; // 1.2% maxWallet
