...
/**
 * PLEASE JOIN OUR TG ROOM HTTP://T.ME/MEMETOKENPORTAL
*/
...
contract FLIPAPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MEMES", "MEME") {
    	...
    	operationsWallet = address(0x25802Af01BbD810DcC36A2cBB35135B87DF65572); // set as operations wallet
        ...
        _createInitialSupply(address(0x25802Af01BbD810DcC36A2cBB35135B87DF65572), totalSupply);
    }
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalSellFees <= 990, "Must keep fees at 99% or less");
    }
