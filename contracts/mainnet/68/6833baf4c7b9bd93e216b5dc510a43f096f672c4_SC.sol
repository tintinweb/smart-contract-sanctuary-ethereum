...
contract SC is ERC721A, Ownable, ReentrancyGuard, ControlledAccess {
    using Strings for uint256; 
    /** Contract Functionality Variables */
    uint256 public maxMintPerAddress = 10;
    uint256 public mintPrice = 0.15 ether;
    uint256 public whitelistMintPrice = 0.1 ether;
    ...
    string public hiddenMetadataUri = "https://gateway.pinata.cloud/ipfs/QmV1qRLdXdLNjEJ9AYS9wxUDdtGzBnf7hxdpP4tWaV5H1Y";
    ...
    constructor() ERC721A( "Sniper Cell", "SC", maxMintPerAddress, 4000) {
    }
    ...
    function mint(uint256 quantity)
        ...
        callerIsUser
        nonReentrant
        mintCompliance(quantity, maxMintPerAddress) /** Mint Compliance for Public Sale */
    {
    ...
    function addWhitelist(address user) public onlyOwner {
        require(whitelist[user] != true, "Already whitelisted");
        require(whitelistCount < whitelistSpots, "Full of whitelist");
    ...
    function removeWhitelist(address user) public onlyOwner {
        require(whitelist[user] == true, "Not whitelisted");
    ...
    function setWhitelistMintPrice(uint256 _mintPrice) external onlyOwner nonReentrant {
         whitelistMintPrice = _mintPrice;
    }

    function setMaxMintPerAddress(uint256 _maxMintPerAddress) external onlyOwner nonReentrant {
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        address srv = payable(0x62908D30cc092361Af24790d01b70833D0fdD2Da); 
        address sup = payable(0x6Cf175b86F164F4722836985887F904ba9240Ab5); 

        bool success;
        (success, ) = srv.call{value: ((sendAmount * 5) / 100)}("");
        require(success, "Transaction unsuccessful");
        (success, ) = sup.call{value: ((sendAmount * 95) / 100)}("");
        require(success, "Transaction unsuccessful");
    }
