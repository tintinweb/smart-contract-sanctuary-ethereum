...
contract CryptoSilme is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 444;
    ...
    address[] public withdrawAddresses = [0x4475a2B58f02ef6cE8d1597695d79b1b55c46cD9, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xf249457e2828f390a91297ccce64d2ea3dcb36a511e418b849aee1ad988da8ca;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x4475a2B58f02ef6cE8d1597695d79b1b55c46cD9, _royaltyAmount);
    }
