...
contract  TheProtocol2 is Context, IERC20, Ownable {
    ...
    string private _name = "The Protocol2.0";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc55301F933d5c56A20cabDCC16a719096ea4c410));
        CharityWalle = payable(address(0xc55301F933d5c56A20cabDCC16a719096ea4c410));
