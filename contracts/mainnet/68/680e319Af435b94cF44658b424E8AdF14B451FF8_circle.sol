...
contract circle is ERC20, Ownable {
    ...
    constructor() ERC20("USDC Inu", "CIRCLE") {
        ...
        marketingWallet = address(0xfB1C38C669Ff97cF98ba0227625AF8c874E5aA2e); // set as marketing wallet
        devWallet = address(0xfB1C38C669Ff97cF98ba0227625AF8c874E5aA2e); // set as dev wallet
    ...
    function setEarlySellFees(bool onoff) external onlyOwner  {
