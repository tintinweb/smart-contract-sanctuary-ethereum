...
FLOKI aims to be the most known and most used cryptocurrency in the world.

○3% Tax Buy/Sell
○No max wallet right after launch
○Burn Liq
...
contract ca is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki.eth";
    string private constant _symbol = "FLOKI.ETH";
    ...
    address payable private _developmentAddress = payable(0x72dA81d69E6709809e5306ebb3C07e8469b341A7);
    address payable private _marketingAddress = payable(0x72dA81d69E6709809e5306ebb3C07e8469b341A7);
