...
contract FLATRHINO is ERC721A, Ownable {
    ...
    string public unrevealedTokenURI =
        "https://gateway.pinata.cloud/ipfs/QmPfx1LWRdFgUwPmwi42HfB6ZwTcRtnxinKV5rEJGKypXo";
    string public baseURI = "";

    mapping(uint256 => string) private _tokenURIs;

    address private _ownerWallet = 0x53E6d3d6E46f8D4f79C9BeeDB76ad880De6BE39E;

    constructor( ) ERC721A("flatrhinowtf", "FLATRHINO") {
    }
