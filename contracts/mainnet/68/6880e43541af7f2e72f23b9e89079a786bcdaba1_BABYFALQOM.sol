...
contract BABYFALQOM is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    using TransferHelper for address;

    string private _name = 'Baby Shiba Hunter';
    string private _symbol = 'BFALQOM';
