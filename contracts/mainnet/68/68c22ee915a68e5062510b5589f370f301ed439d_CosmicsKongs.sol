...
// File: contracts/Cosmics Kongs by Sean Blanchet.sol
...
contract CosmicsKongs is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://QmT2dLC624ftQx7UWrV4L1fPtWEf3kw82nF2DSK5zLAVYj/";
    uint   public price             = 0.005 ether;
    uint   public maxPerTx          = 2;
    uint   public maxPerFree        = 0;
    uint   public totalFree         = 0;
    uint   public maxSupply         = 299;
    bool   public mintEnabled;
    uint   public totalFreeMinted = 0;

    mapping(address => uint256) public _mintedFreeAmount;

    constructor() ERC721A("Cosmics Kongs by Sean Blanchet", "Cosmics Kongs by SB"){}
