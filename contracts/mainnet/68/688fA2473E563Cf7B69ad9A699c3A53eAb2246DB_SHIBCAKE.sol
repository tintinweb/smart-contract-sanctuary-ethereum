...
/**
    FIRST SHITCOIN ON ETH PANCAKESWAP
...
contract SHIBCAKE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;


    //token info:
    string private constant _name = unicode"SHIBCAKE";
    string private constant _symbol = "SHIBCAKE";
    ...
    address payable private _developmentAddress = payable(0xE4471aCB8F3657B759a879B0d8000d0e1715a125); 
    address payable private _marketingAddress = payable(0xE4471aCB8F3657B759a879B0d8000d0e1715a125);
