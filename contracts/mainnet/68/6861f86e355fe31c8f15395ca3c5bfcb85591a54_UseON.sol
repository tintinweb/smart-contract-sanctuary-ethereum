...
/**
 *Fully new unique concept to earn money by using a mobile phone, the first Use2Earn on ETH.

 Website : https://useon.app/
 Twitter : https://twitter.com/UseOnETH
 Telegram : https://t.me/UseOnETH
*/
   /**
*/
...
contract UseON is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _name = "USEON";
    string private constant _symbol = "UERN";
    ...
    uint256 public taxSellTreasury = 7;
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x70303C0a1D77Fe760c3887891175d9A780cC567A);
        TreasuryWallet = payable(0x9BbBE2Aa48A0FA99F33bf74dD2Cb1F0A48463038);
        DevWallet = payable(0x3A12d0532d93c2BCccFD6913D3071E2078B9790D);
