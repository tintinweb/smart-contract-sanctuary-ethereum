...
// https://t.me/seggsportal
// https://twitter.com/Seggs_Official
...
contract SEGGS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SEGGS", "SEGGS") {
        ...
        marketingWallet = address(0x93129144756678a450314e9Bca990a3B96700a74); // set as marketing wallet
        devWallet = address(0x93129144756678a450314e9Bca990a3B96700a74); // set as dev wallet
