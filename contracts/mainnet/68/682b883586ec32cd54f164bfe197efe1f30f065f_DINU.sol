...
/*
 0 Tax for Teh People by Teh People.
 Feel free to make a Democratic community telegram and i will update the link on Dextools. 
 Liquidity locked for 1 month, extended at 100k 
...
contract DINU is ERC20, Ownable {
    ...
    constructor() ERC20("Democracy Inu", "DINU") {
     ...
     uint256 totalSupply = 1 * 10 ** 7 * 10 ** decimals();
        ...
        MarketingWallet = address(0x2f480D975C5A2de10A090584F6E045f6447fb293); // set as Marketing wallet
        DevWallet = address(0x2f480D975C5A2de10A090584F6E045f6447fb293); // set as dev wallet
