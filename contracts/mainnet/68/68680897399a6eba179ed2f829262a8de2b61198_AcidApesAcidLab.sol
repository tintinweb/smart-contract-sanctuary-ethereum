...
// File: contracts/AcidApesAcidLab.sol
...
contract AcidApesAcidLab is ERC1155, Ownable {

    string public baseTokenURI; 
    address public experimentsContract;
    ...
    {
        require(msg.sender == experimentsContract, "You are not authorized to burn");
    ...
    function setExperimentsContractAddress(address _contractAddress) public onlyOwner
    {
        experimentsContract = _contractAddress;
    }
