...
contract TheRevival is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "The Revival";
    string constant _symbol = "SAIKO";
    ...
    address payable public liquidityFeeReceiver = payable(0x41DB51F4Af7ea7617A103BeB4b5A07b8390B859F);
    address payable public marketingFeeReceiver = payable(0x41DB51F4Af7ea7617A103BeB4b5A07b8390B859F);
