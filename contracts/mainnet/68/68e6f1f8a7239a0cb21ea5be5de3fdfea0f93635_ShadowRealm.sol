...
*/
/*
* https://Twitter.com/ShadowRealms77
* https://t.me/Shadow_Realms
*/
...
contract ShadowRealm is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shadow Realm";//
    ...
    address payable private _developmentAddress = payable(0xc67C5E21Bc1b038af4B58D6AFda2472D84c55270);  // insert dev address here
    address payable private _marketingAddress = payable(0xc67C5E21Bc1b038af4B58D6AFda2472D84c55270); // insert marketing address here
    ...
    uint256 public _maxSellTxAmount = 1000000000 * 10**9; //
    uint256 public _maxBuyTxAmount = 20000000 * 10**9; //
    ...
    function setMaxTxnAmounts(uint256 maxBuyTxAmount, uint256 maxSellTxAmount) public onlyOwner {
        require(maxBuyTxAmount >= 1000000000, "Buy Tx Limit must be high enough to not honeypot");
        require(maxSellTxAmount >= 1000000000, "Sell Tx Limit must be high enough to not honeypot");
