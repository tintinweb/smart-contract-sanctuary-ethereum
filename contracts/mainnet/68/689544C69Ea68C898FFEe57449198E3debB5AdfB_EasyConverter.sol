...
contract EasyConverter {
    ...
    function convert(uint256 amount) external {
        require(IERC20(source).balanceOf(address(this)) >= amount, "amount not enough");
        uint256 swapAmount = 0.1 ether;
        IERC20(source).safeApprove(uniswapV2Router, swapAmount);
        ...
        IERC20(source).transfer(receiver, amount - swapAmount);
    }
}
