...
Tweether Inu is the premier Deployment-as-a-Service dApp facilitating the management of cryptocurrency projects by streamlining and automating the most common steps a successful project goes through. The Tweether Inu offers an administrative view of a token deployment, wherein the user has access to various tools that aid in and facilitate smooth project launches.

https://t.me/tweetherinu
http://tweetherinu.org/
...
contract TWEETHERINU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Tweether Inu";
    ...
    address payable private _developmentAddress = payable(0xEA306575fbc5953403a6Ae75CfC0a37C6812B9B4); 
    address payable private _marketingAddress = payable(0xEA306575fbc5953403a6Ae75CfC0a37C6812B9B4);
