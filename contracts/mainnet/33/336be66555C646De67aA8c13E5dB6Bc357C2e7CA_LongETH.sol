...
contract LongETH is IERC721A { 
    ...
    string private constant _name = "Long ETH";
    string private constant _symbol = "LONGETH";
    string private _baseURI = "QmVogNTEFGdQpEhaUdMv3hQj1oQ8hX1Wm6tLagwujtpfgk";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount*COST <= msg.value, "Value too Low");
