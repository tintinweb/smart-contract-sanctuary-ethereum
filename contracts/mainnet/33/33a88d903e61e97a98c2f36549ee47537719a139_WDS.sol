...
contract WDS is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "White Dragon Society";
    string private constant _symbol = "WDS";
    ...
    address payable private _developmentAddress = payable(0x4fa88A3725183818df8e4bA0b4C3d8395A83669d); 
    address payable private _marketingAddress = payable(0x4fa88A3725183818df8e4bA0b4C3d8395A83669d);
