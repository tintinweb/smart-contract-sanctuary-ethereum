...
/**
Telegram : https://t.me/InuPsychic

Stealth Launch
Join Telegram for information to be updated
*/
...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime , "Contract is locked until 6 Months");
...
contract InuPsychic is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inu Psychic";
    string private _symbol = "InuPsychic";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3f068982550EEdEe10c9A9E6443a76517ac3361b); 
    address payable public buyBackWalletAddress = payable(0x3f068982550EEdEe10c9A9E6443a76517ac3361b); 
    ...
    uint256 public _walletMax = 1000000000000000000000; 
    uint256 private minimumTokensBeforeSwap = 100000000; 
