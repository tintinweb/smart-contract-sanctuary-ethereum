...
contract DadE is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xFF151CB3b23a113ec0478cca80B7Bc200fd7c6C0);
        _feeAddrWallet2 = payable(0xFF151CB3b23a113ec0478cca80B7Bc200fd7c6C0);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTxAmount = 3e7 * 10**9;
        tradingOpen = true;
        IERC20(uniswapV2Pair).approve(address(uniswapV2Router), type(uint).max);
    }
	
	function nonosquare() public onlyOwner {
