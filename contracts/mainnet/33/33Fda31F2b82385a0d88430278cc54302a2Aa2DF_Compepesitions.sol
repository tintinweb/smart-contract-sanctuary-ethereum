...
contract Compepesitions is Ownable, ERC721A{
    using Strings for uint256;

    string public BASE_URI;
    bool public isPublicMintEnabled = false;
    uint public maxSupply = 1420;
    uint public maxFreeSupply = 420;
    uint public costPublic = 0.0015 ether;
    uint public maxMintPublic = 10;
    uint public freePerWallet = 1;

    mapping(address => uint256) public mintedByAddress;

    address t1 = 0xd733F5DC65012Ac05C984db7c940FB6FDBF3c5B7;
    address t2 = 0xd733F5DC65012Ac05C984db7c940FB6FDBF3c5B7;

    constructor() ERC721A("Compepesitions", "Compepe") {}
