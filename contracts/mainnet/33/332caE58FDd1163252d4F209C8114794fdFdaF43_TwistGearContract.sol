...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x19598d6C1832f5111D64d3512ce7823d4D0c2111];
  address public erc20Payable = 0x19598d6C1832f5111D64d3512ce7823d4D0c2111;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://3dmodel.mypinata.cloud/ipfs/QmWctDK5yQsUMwbtWzmo17ooEELR1JWhwKMatnvvH1CFHD/";
...
// File: contracts/TwistGearContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TwistGearContract is RamppERC721A {
    constructor() RamppERC721A("TwistGear", "TwistGear"){}
}
