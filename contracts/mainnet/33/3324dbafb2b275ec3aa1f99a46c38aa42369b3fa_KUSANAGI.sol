...
Kusanagi-no-Tsurugi (草薙の剣) is a legendary Japanese sword and one of three Imperial Regalia of Japan.  In folklore, the sword represents the virtue of valor.

https://t.me/TheLastKatana
...
contract KUSANAGI is ERC20, Ownable {
    ...
    constructor() ERC20("The Last Katana", "KUSANAGI") {
		...
		charityWallet = address(0x6f8a410699169AadbCe5532E68E438F305Cf15b7); // set as charity wallet
        marketingWallet = address(0x6f8a410699169AadbCe5532E68E438F305Cf15b7); // set as marketing wallet
        devWallet = address(0x6f8a410699169AadbCe5532E68E438F305Cf15b7); // set as dev wallet
