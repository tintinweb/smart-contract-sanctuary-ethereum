...
contract FloraWarriors is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x1708f3a87bf337c872dafd3e57dfe800de76c85c0ba7d2812dd3e3d81b44650c;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmW1ujMuw4xJgBedzWKjnMiQ6rAvPcY5bfveArYWSKNown";

    constructor() public ERC721A("Flora Warriors", "FLORA", 999, 999) {}
