...
contract GenesisElderDragons is ERC721A, Ownable {
    ...
    string private baseUri = "ipfs://bafybeigg3zi2wwkmxgzo463cv3yqo34oqjdu75asq4qdykjbnfw6mx6pme";

    mapping(address => uint256) private _freeMintedCount;

    constructor() ERC721A("999 Genesis Elder Dragons", "Dragons") {}
