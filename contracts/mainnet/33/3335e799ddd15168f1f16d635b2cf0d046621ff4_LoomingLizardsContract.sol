...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF0a779aE9753788aC43A6D5CBA489781D216e0A8];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 4444 ) {}
...
// File: contracts/LoomingLizardsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LoomingLizardsContract is RamppERC721A {
    constructor() RamppERC721A("Looming Lizards", "LLizards"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/N71deee6QOowqp3CbdKb/contract-metadata";
    }
}
