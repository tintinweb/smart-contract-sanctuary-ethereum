...
/**
Ottereum is an ERC20 native token fot Otter coin
using 2/2 fees for marketing funds.
...
contract Ottereum is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x19197CB8D12C747FbA874b5e5d908769718E4367); // Marketing Address
    ...
    string private constant _name = "Ottereum";
    string private constant _symbol = "Otter";
    uint8 private constant _decimals = 18;

    uint256 private constant BUY = 2;
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 10 / 1000; // 1% max txn
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05%
        maxWallet = _tTotal * 1 / 100; // 2%
