...
The QWERTY layout is attributed to an American inventor named Christopher Latham Sholes, and it appeared in its earliest form on July 1, 1874 -- 142 years ago today.

Now on the 24th September 2022, the $QWERTY token is being unleashed to take over this Keyboard meta!

QWERTY is universal. 

Soon $QWERTY will be too...

https://t.me/QWERTY_ERC
**/
...
contract QWERTY is Context, IERC20, Ownable {
    ...
    string private constant _name = "QWERTY";
    string private constant _symbol = "QWERTY";
