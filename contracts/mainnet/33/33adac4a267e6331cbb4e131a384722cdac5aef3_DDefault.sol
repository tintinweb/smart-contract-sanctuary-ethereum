...
contract DDefault is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibi Inu";
    string private _symbol = "SHIBI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBf0ff2c8b8AAc828a1dF6A24E88DbeBC4D17D214); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xBf0ff2c8b8AAc828a1dF6A24E88DbeBC4D17D214); // BuyBack Address
    ...
    uint256 public _marketingShare = 15;
    ...
    uint256 public _walletMax = 30000000 * 10**9;
