...
contract BlackAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Black AI"; 
    string private constant _symbol = "BlackAI"; 
    ...
    uint256 private _taxOnBuy = 6;   
 
    //Sell Fee
    uint256 private _feeOnSell = 0; 
    uint256 private _taxOnSell = 6;  
    ...
    address payable private _developmentWalletAddress = payable(0xD636E7d6B2574629c417A37808281Cf9649B8578);
    address payable private _marketingWalletAddress = payable(0xD636E7d6B2574629c417A37808281Cf9649B8578);
    ...
    uint256 public _maxTxAmount = 40000000 * 10**9;      // 2% MAX TX
    uint256 public _maxWalletSize = 40000000 * 10**9;    // 2% MAX WALLET 
