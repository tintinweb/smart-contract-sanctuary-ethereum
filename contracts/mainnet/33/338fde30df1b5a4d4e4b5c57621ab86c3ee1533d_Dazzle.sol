...
Dazzle has gradually evolved from a real world into Dazzle Token, which will continue to shine every time when investors trade in this space. Illuminated this ETH blockchain, making it shine in all kinds of TOKENS!
...
contract Dazzle is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dazzle";
    string private constant _symbol = "DAZ";
