...
contract PonziLords {
    ...
    string public constant symbol = "PZLD";   
    ...
    address payable constant deployer = payable(address(0xA4Be655075EC011841b4DcEBF21a4B3C1A62F4ff));
