...
contract SWITCHBYPAK is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint public public_price = 0.0025 ether;

    uint public saleStartTime = 1649298400;

    bytes32 public merkleRoot;

    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("THE SWITCH by PAK", "SWITCH")
    {
        baseURI = _baseURI;
