...
contract Munchies is ERC721, Ownable {
  ...
  uint256 public WLPerAddressLimit = 3;
  ...
  function setWlPerAddressLimit(uint256 _limit) public onlyOwner {
    WLPerAddressLimit = _limit;
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0xE128CAddcB658CB2A6E7caB6090947Db15757656).call{value: address(this).balance * 40 / 100}("");
    require(hs);
    (bool bs, ) = payable(0x384E630A593011401A93d0E6D4931dd729f69d32).call{value: address(this).balance * 12 / 100}("");
    require(bs);
    (bool ms, ) = payable(0xFA50ce07Ff7D44fc0642B4E863D830ae1046B3eb).call{value: address(this).balance * 6 / 100}("");
    require(ms);
    (bool js, ) = payable(0x8E5a7a3E44b6dE1FE3efCe8C8fb55D8823501E3e).call{value: address(this).balance * 33 / 100}("");
    require(js);
    (bool ks, ) = payable(0x78ed0F69D455D1E525ad6d8adEbe306BdD34Df23).call{value: address(this).balance * 9 / 100}("");
    require(ks);
    // =============================================================================
