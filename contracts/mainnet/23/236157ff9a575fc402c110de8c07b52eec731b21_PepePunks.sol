...
// ERC721A Contracts v4.0.0
    ...
    contract PepePunks is Ownable, ERC721A {
    ...
    address constant internal TEAM_ADDRESS = 0x62c461bd6Da1D05C40e33357D631D647F0a3d573;
    string public baseURI = "https://ipfs.io/ipfs/QmNdqhL7Y6BDesecDvBTMr1sGAArz8Jo5BMBv3PvqvEshy/";
    string public constant baseExtension = "/metadata.json";
    string public hiddenMetadataUri;
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;
    constructor() ERC721A("Pepe Punk", "Pepe Punk") {_safeMint(msg.sender, 50); setHiddenMetadataUri("");}
