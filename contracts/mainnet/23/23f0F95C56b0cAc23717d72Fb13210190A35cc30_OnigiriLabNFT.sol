...
/**
 ____  _      _  _____ _  ____  _    _     ____  ____ 
/  _ \/ \  /|/ \/  __// \/  __\/ \  / \   /  _ \/  _ \
| / \|| |\ ||| || |  _| ||  \/|| |  | |   | / \|| | //
| \_/|| | \||| || |_//| ||    /| |  | |_/\| |-||| |_\\
\____/\_/  \|\_/\____\\_/\_/\_\\_/  \____/\_/ \|\____/
...
contract OnigiriLabNFT is Ownable, ERC721A, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    constructor() ERC721A("Onigiri Lab NFT", "OLN")VRFConsumerBaseV2(vrfCoordinator) {
        COORDINATOR = VRFCoordinatorV2Interface(vrfCoordinator);
    }

    uint256 public collectionSize = 1798;
    ...
    uint256 public amountForAllowList = 48;
    ...
    function getPublicSalePrice(uint256 offset) public view returns(uint256){
        if (1750 < 1500 + amountForPublicSale - offset){
    ...
    uint256 public amountForPublicSale = 1750;
