...
contract DolphinsInc is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Dolphins Incorporation", "D.Inc") {
        setHiddenMetadataUri("https://api.dolphins.ink/");
        setBaseURI("https://api.dolphins.ink/");
    }
