...
// File: @openzeppelin\contracts-upgradeable\token\ERC1155\IERC1155MetadataURIUpgradeable.sol
...
// File: @openzeppelin\contracts-upgradeable\token\ERC1155\ERC1155ReceiverUpgradeable.sol
...
// File: contracts\tokens\ERC1155Upgradeable.sol
...
// File: contracts\tokens\ERC1155BurnableUpgradeable.sol
...
// File: contracts\tokens\ERC1155DefaultApproval.sol
...
// File: contracts\royalties\LibPart.sol
...
// File: contracts\royalties\impl\AbstractRoyalties.sol
...
interface RoyaltiesV2 {
    ...
    function getV2Royalties(uint256 id) external view returns (LibPart.Part[] memory);
}

// File: contracts\royalties\impl\RoyaltiesV2Impl.sol
...
contract RoyaltiesV2Impl is AbstractRoyalties, RoyaltiesV2 {
    ...
    function getV2Royalties(uint256 id) override external view returns (LibPart.Part[] memory) {
        return royalties[id];
    }
...
// File: contracts\royalties\LibRoyaltiesV2.sol
...
library LibRoyaltiesV2 {
    /*
     * bytes4(keccak256('getV2Royalties(uint256)')) == 0x589c7505
     */
    bytes4 constant _INTERFACE_ID_ROYALTIES = 0x589c7505;
}

// File: contracts\royalties\RoyaltiesV2Upgradeable.sol
...
// File: contracts\lazy-mint\LibERC1155LazyMint.sol
...
// File: contracts\tokens\ERC1271.sol
...
// File: contracts\utils\LibSignature.sol
...
// File: contracts\tokens\ERC1271Validator.sol
...
// File: contracts\tokens\Mint1155Validator.sol
...
// File: contracts\tokens\LibURI.sol
...
// File: contracts\tokens\ERC1155BaseURI.sol
    ...
    */
    ...
    function _tokenURI(uint256 tokenId) internal view virtual returns (string memory) {
        ...
        if (bytes(currentURI).length > 0) {
            return LibURI.checkPrefix(base, currentURI);
        }
...
// File: contracts\tokens\ERC1155Lazy.sol
...
// File: contracts\tokens\HasContractURI.sol
...
// File: contracts\tokens\ERC1155Base.sol
...
// File: contracts\tokens\ERC1155.sol
...
contract ERC1155 is ERC1155Base {
    ...
    constructor(address transferProxy, address lazyTransferProxy) {
        __ERC1155_init("NFT SKY", "NSNU", "https://api.nftsky.io/", "", transferProxy, lazyTransferProxy);

        emit CreateERC1155User(_msgSender(), "NFT SKY", "NSNU");
    }
    ...
    function __ERC1155_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address transferProxy, address lazyTransferProxy) internal initializer {
        __ERC1155_init_unchained(_name, _symbol, baseURI, contractURI, transferProxy, lazyTransferProxy);
