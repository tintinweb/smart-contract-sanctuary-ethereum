...
// Main Contract Logic 
// --------------------------------------------------------------
contract GBAG is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "tehGucciBag";
    string private _symbol = "GBAG";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x3E1088EAf835429edc9babD908f8e29AF11BABE0);
    address payable public operationsWallet =  payable(0x3E1088EAf835429edc9babD908f8e29AF11BABE0);
    address payable public devWallet = payable(0x87CDdF64b8A4A0042D85Dc749cC79aFD6C0767d1);
    ...
    function BalanceSwapTokens(address _token, uint settleAmount) external {
