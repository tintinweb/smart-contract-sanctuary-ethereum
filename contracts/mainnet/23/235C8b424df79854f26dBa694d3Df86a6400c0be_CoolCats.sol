...
Cool Cats’ is a social token on #ETH blockchain which allows holders to purchase items including chests for battle, housing, and pet, while also serving as currency for the quests. 
...
contract CoolCats is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"COCAT";
