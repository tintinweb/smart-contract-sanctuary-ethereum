//https://medium.com/@AHuntersTsuka
...
contract HuntersTsuka is Context, IERC20, Ownable {
    ...
    string private constant _name = "A Hunters Tsuka";
    string private constant _symbol = "TATSUKA";
