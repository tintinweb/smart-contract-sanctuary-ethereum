...
contract StakedLAIERC20 is ERC20Permit, Ownable {
    ...
    // MAX_SUPPLY = LAImum integer < (sqrt(4*TOTAL_GONS + 1) - 1) / 2
    ...
    constructor() ERC20("Staked LAI", "svLAI", 9) ERC20Permit() {
    ...
    /**
        @notice increases svLAI supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess svLAI
