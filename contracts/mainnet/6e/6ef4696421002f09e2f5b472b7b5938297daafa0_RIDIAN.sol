...
Diversified exposure to the largest cryptocurrencies by market cap during rising markets 
and systematically trades them to stablecoins during unfavorable conditions.
    
Home:       https://www.ridian.io/
Twitter:    https://twitter.com/ridiancrypto
API Setup:  https://ridian.zendesk.com/hc/en-us/sections/9665931810445-CONNECTING-TO-EXCHANGE
Instagram:  https://www.instagram.com/ridian.io/

TOKENOMICS:
* FIRST TWO MINUTES: 10,000,000,000 max buy (10B RIDIAN)
* 45-second buy cooldown (these limitations are lifted automatically two minutes post-launch)
* No other cooldowns, no transfer or sell cooldowns
* 8% total tax on round-trip, 2 marketing, 1 lp, 1 dev
* 0.5% holder token threshold on platform
...
contract RIDIAN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("RIDIAN AI", "RIDIAN") {
