...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1d4A886AFEf868f2545b696F1ACADd2Ce0e59318];
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 7, 1550) { }
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmScLwt9E3dnk4vezZScSDeteEZcCsNXGiHj7bPC7EHaEr/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1550");
    ...
    */
    function mintTo(address _to) public payable {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1550");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1550");
...
// File: contracts/GoblinPowerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoblinPowerContract is RamppERC721A {
    constructor() RamppERC721A("Goblin Power", "GOPO"){}
}
