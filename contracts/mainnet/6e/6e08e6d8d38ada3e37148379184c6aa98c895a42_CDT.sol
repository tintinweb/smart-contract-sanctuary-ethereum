...
contract CDT is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "CoolDogToken";
    string private constant _symbol = "CDT";
    ...
    uint256 public _maxTxAmount = 1500 * 10**9;
