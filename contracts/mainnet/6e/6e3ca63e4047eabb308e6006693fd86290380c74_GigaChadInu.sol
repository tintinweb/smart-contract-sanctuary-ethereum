...
contract GigaChadInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "GigaChad Inu";
    string private constant _symbol = "GCINU";
    ...
    address payable public marketingWallet = payable(0xc4C7f1524B3a405C08282133161c50b92C83fd5E);
    address payable public treasury = payable(0xc4C7f1524B3a405C08282133161c50b92C83fd5E);
