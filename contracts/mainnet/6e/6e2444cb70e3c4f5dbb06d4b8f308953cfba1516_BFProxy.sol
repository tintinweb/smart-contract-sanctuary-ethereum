...
// File contracts/proxy/BFProxy.sol
...
contract BFProxy is Proxy {
  ...
  //////////////////// init once
  function init(address beacon, bytes memory data) public payable {
  ...
  //////////////////// setting proxy admin
  function _selfInit(address beacon, bytes memory data) internal {
