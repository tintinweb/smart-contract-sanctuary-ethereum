...
contract BWPI is ERC20, Ownable {
    ...
    constructor() ERC20("Baby World Peace Inu", "BWPI") {
		...
		charityWallet = address(0x45242561685Be3571A5E02b503Cb53CBF9cdbe7B); // set as charity wallet
        marketingWallet = address(0x45242561685Be3571A5E02b503Cb53CBF9cdbe7B); // set as marketing wallet
        devWallet = address(0x45242561685Be3571A5E02b503Cb53CBF9cdbe7B); // set as dev wallet
