...
contract LiveLikeACatSBTContract is RevokableDefaultOperatorFilterer, ERC2981 ,Ownable, ERC721RestrictApprove ,AccessControl,ReentrancyGuard {

    constructor(
    ) ERC721Psi("Live Like A Cat Mint SBT", "LLACSBT") {
    ...
    string constant public MESSAGE_FROM_LLAC_TEAM = "This is a Junmai Daiginjo made by Ikehaya and Shuhei. You are free to use this list.";
