...
There are too many tokens that come out
That get sniped by bots
And then the regular folk can't get in at a decent price
While all the bots dump on you

This token is to discourage that
By making transactions tiny
Hence why it's called mini

Mini transactions for the bots to feast on
Then a remove liquidity to get rid of them
Then all the normal people can ape in
...
contract MiniRocket is ERC20, Ownable {
    ...
    constructor() ERC20("Mini Rocket", "MiniR") {
        
        IDexRouter _dexRouter = IDexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        operationsAddress = address(0x9b5397c691B5bf6C283E04Ea18b7ddD019e4AEF5); 
