...
contract ERC721A is IERC721A {
     ...
     * This function call must use less than 30000 gas.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC721A) returns (bool) {
...
contract BigAssToadz is ERC721A {
    ...
    function claimToadz(uint256 amount) payable public {
        require(
            amount <= maxMintPerTx, 
        ...
        _safeMint(msg.sender, amount, mintPrice);
    }

    function reserve(address addr, uint256 count) public onlyOwner {
    ...
    function setFreeNum(uint8 _num) public onlyOwner {
        freeNum = _num;
    }
    ...
    constructor() ERC721A("Big Ass Toadz", "BATOADZ") {
        owner = msg.sender;
        prefix = "ipfs://QmRRVgePuBxLFXkW5KnyVwyPjzLjEE6SVPXbp6gy34CSLG/";
