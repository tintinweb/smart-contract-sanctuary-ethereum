...
@PompiInu
From the creators of the big red dog you all know.
...
contract POMPIINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "POMPIINU";
    string private constant _symbol = "POMPI";
    ...
    uint256 private _maxWalletSize = 100000 * 10**9;
