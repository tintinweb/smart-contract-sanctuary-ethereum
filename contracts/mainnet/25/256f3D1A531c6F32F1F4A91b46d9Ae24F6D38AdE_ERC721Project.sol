 ...
 */
abstract contract ERC721Tradable is ERC721Pausable, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    bool internal _IsReveal;
    string private _RevealTokenURI;
    string private _DecoyTokenURI;
    ...
    function baseTokenURI() virtual public view returns (string memory) {
        return _RevealTokenURI;
    }

    function setBaseTokenURI(string memory _uri) public onlyOwner {
        _RevealTokenURI = _uri;
    }

    function setDecoyTokenURI(string memory _uri) public onlyOwner {
        _DecoyTokenURI = _uri;
    }
...
abstract contract RandomlyAssigned is WithLimitedSupply {
    ...
    constructor (uint256 _maxSupply, uint256 _startFrom)
        WithLimitedSupply(_maxSupply, _maxSupply+_startFrom)
    {
    ...
    function nextToken() internal override ensureAvailability returns (uint256) {
        uint256 maxIndex = maxTokenSupplyForRandomMinting() - tokenCount();
