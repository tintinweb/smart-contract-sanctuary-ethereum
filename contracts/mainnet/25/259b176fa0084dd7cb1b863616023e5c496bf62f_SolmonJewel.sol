...
contract SolmonJewel is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmccWGyygmDTiCqvJewYXFaA1qnyJquP6TWsqdVNvH";
    ...
    constructor(
    ) ERC721A("SolmonJewel", "GEM", 100, maxSupply) {
    }
