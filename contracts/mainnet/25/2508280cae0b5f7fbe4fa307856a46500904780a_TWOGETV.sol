...
contract TWOGETV is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "TWOGE-TV";
 string private _symbol = "TWOGE-TV";
 ...
 address _owner;
 address payable public marketingAddress = payable(0xCBf334c82D80368C19f579b56dD697564EDD38cF);
 ...
 //Tokenomics related functions
  function TWOGETVDay() public onlyOwner{
      require(block.timestamp > TWOGETVDaycooldown, "You cant call TWOGETVCoinDay more than once a day");
 ...
 function TWOGETVCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      TWOGETVDaycooldown = block.timestamp + 86400;
 }
