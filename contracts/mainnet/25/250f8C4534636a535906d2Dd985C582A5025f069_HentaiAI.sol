...
contract HentaiAI is ERC20, Ownable {
    ...
    constructor() ERC20("HentaiAI", "HAI", DECIMALS) {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        feeReceiver = address(0xE12A3CCB12d1405560c74078BBD0a10C8b9C79E1); 
    ...
    function setFees(uint256 _buyLiquidityFee, uint256 _buyMarketingFee, uint256 _sellLiquidityFee, uint256 _sellMarketingFee) external onlyOwner {
        ...
        sellMarketingFee = _sellMarketingFee;
        sellTotalFees = sellLiquidityFee + sellMarketingFee;
        require(buyTotalFees + sellTotalFees < 100, "Total roundtrip must be less than 100");
    } 
