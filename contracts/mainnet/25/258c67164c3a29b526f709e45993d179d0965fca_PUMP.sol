...
// Be the first to pump the token and then just go away!
...
contract PUMP is ERC20, Ownable {
    ...
    constructor() ERC20("Pump n Go", "PUMP") {
        ...
        // tax is higher at launch to prevent from bot attack, final tax will be 4/5
        ...
        uint256 totalSupply = 770_000_000 * 1e18;
        ...
        marketingWallet = address(0xb79DE72c493a1643E7B687C6E8BA787Dbe93228a); // set as marketing wallet
        devWallet = address(0xb79DE72c493a1643E7B687C6E8BA787Dbe93228a); // set as dev wallet
