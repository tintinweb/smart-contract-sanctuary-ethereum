...
contract CloakSC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Cloak", "USD-CL") {
        ...
        marketingWallet = address(0x60Ab5bC468c072EB54EC2437a488866240fDda6C); // set as marketing wallet
        devWallet = address(0x60Ab5bC468c072EB54EC2437a488866240fDda6C); // set as dev wallet
    ...
    function setunBLModifier(address account, bool onOrOff) external onlyOwner {
