...
contract GOLAZO  is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6fFeC299CbD889Cd7Ad0e89ee17e834189343d7d); // Marketing Address
    address payable public multiSigAddress = payable(0x5CCaf835ea1feb615F874Cf50Bb7E2DbF5aDCCf0); // Marketing Address
    address payable public devAddress = payable(0xB1884a03dA112D0C813e0E5EFd2B648D95133F7c); // Dev Address
    address payable public liquidityAddress = payable(0xB1884a03dA112D0C813e0E5EFd2B648D95133F7c); // Liquidity Address
