...
contract HalfBaked is ERC20, Ownable {
    ...
    event UpdateBuyFees(uint256 liquidityFeeOnBuy, uint256 marketingFeeOnBuy, uint256 rewardFeeOnBuy);
    event UpdateSellFees(uint256 liquidityFeeOnSell, uint256 marketingFeeOnSell, uint256 rewardFeeOnSell);
    ...
    constructor(
        ...
        require(
            _arg.liquditiyFeeOnBuy_  + 
            _arg.marketingFeeOnBuy_  + 
            _arg.rewardFeeOnBuy_  <= 25 &&

            _arg.liquidityFeeOnSell_ + 
            _arg.marketingFeeOnSell_ + 
            _arg.rewardFeeOnSell_ <= 25,
        ...
        require(
            ...
            _arg.rewardToken_ != 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7, 
            "Reward token cannot be AVAX."
        );

        liquidityFeeOnBuy  = _arg.liquditiyFeeOnBuy_;
        liquidityFeeOnSell = _arg.liquidityFeeOnSell_;
        rewardFeeOnBuy     = _arg.rewardFeeOnBuy_;
        rewardFeeOnSell    = _arg.rewardFeeOnSell_;
        marketingFeeOnBuy  = _arg.marketingFeeOnBuy_;
        marketingFeeOnSell = _arg.marketingFeeOnSell_;
        _totalFeesOnBuy    = liquidityFeeOnBuy  + marketingFeeOnBuy  + rewardFeeOnBuy;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell + rewardFeeOnSell;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _rewardFeeOnBuy) external onlyOwner {
        require(
            _liquidityFeeOnBuy + _marketingFeeOnBuy + _rewardFeeOnBuy <= 25,
            "Fees must be less than 25%"
        );
        ...
        _totalFeesOnBuy   = liquidityFeeOnBuy + marketingFeeOnBuy + rewardFeeOnBuy;
        emit UpdateBuyFees(_liquidityFeeOnBuy, _marketingFeeOnBuy, _rewardFeeOnBuy);
    }

    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _rewardFeeOnSell) external onlyOwner {
        require(
            _liquidityFeeOnSell + _marketingFeeOnSell + _rewardFeeOnSell <= 25,
            "Fees must be less than 25%"
        );
        ...
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell + rewardFeeOnSell;
        emit UpdateSellFees(_liquidityFeeOnSell, _marketingFeeOnSell, _rewardFeeOnSell);
    }
