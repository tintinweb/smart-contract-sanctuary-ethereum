...
TG: https://t.me/SundaeInuPortal

Supply: 1 000 000  
Max Wallet: 2% = 20 000 tokens
Max TX: 1% = 10 000 tokens

Buy / Sell Tax: 10% (SELL TAX HIGHER AT LAUNCH)
...
contract SundaeInu is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'SundaeInu';
    ...
    uint256 currentAmountToSwap = 8000 * 10**_decimals;
    ...
    //DevWallets
    address public Marketing=payable(0x621C23AEAb526BF1aC73abE400A09707819Ae486);
	...
	uint256 private antiWhale = 10000 * 10**_decimals;
