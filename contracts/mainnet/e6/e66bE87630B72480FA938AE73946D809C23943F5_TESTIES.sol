...
// File: contracts/TESTIES-Main.sol

pragma solidity >=0.8.12 <=0.8.18;

contract TESTIES is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    uint256 public freeMintPerAddress = 2;

    constructor() ERC721A("TESTIES","TT") {}
