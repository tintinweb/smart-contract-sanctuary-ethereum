...
contract Avatar5 is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        ...
        // require(tokenId >= 0 && tokenId <= total_supply, "ERC1155Metadata: URI query for nonexistent token");
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://bafybeihclsmugnz3a56q2fdz3pdgjwpocaso4gopg3azpv3jdd4y4i3lwa"; // Contract-level metadata for Avatar5
    }
}
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ipfs://bafybeihclsmugnz3a56q2fdz3pdgjwpocaso4gopg3azpv3jdd4y4i3lwa/"; // IPFS base for Avatar5 collection
