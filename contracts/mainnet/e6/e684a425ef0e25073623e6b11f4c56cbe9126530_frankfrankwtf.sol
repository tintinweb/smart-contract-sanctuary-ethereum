...
contract frankfrankwtf is ERC721A, Ownable { 

  using Strings for uint256;

  string private uriPrefix = "ipfs://Qmc3MSSb3cthp6jXNefDm8hmX8sxS6m1d6wDk9Kz81BrQd/";
  ...
  uint256 public totalMaxMintAmount = 4; 

  uint256 public freeMaxMintAmount = 4; 
  ...
  constructor() ERC721A("frankfrank.wtf", "frankWTF") { 
         setHiddenMetadataUri("ipfs://QmaPuVEznmzigxSrqYLw5Z2e4eA2faBb7XEJWRoYr2eAeA/hidden.json"); 
            ownerMint(5); 
    } 
