...
Shiva Inu is a community driven token that will be granting its holders access to ALPHA projects vetted by our expert devs'. 
Only holders will be having the access to the early ALPHA tokens, as well as the DAO.

tg: https://t.me/shiva_inu
...
contract SHIVA is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0xE51852bF6a884BCDb892c03cf127697f3381181C); // 
        exclude(msg.sender);
