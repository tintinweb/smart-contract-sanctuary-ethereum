...
contract Zeroxab is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"0xab";
    string private constant _symbol = unicode"0xab";
