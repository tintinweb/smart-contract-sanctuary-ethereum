...
contract DEVDIED is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "DEVDIED";
    string private constant tokenSymbol = "DEVDIED";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x74462849d33cc0b336e9897886C3b7CCF8BFAe6A);
        devAddress = payable(0x74462849d33cc0b336e9897886C3b7CCF8BFAe6A);
