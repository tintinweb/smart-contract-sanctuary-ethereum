...
This is a test for a stealth launch
If this test goes well, we will have an airdrop for any token holders
...
No nukes though, cause those are way too deadly

Let's see how it goes boys
...
contract LaunchReady is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Testing", "LaunchReady") {
