...
contract ChiefsInu is ERC20, Ownable {
    ...
    constructor() ERC20("Chiefs Inu", unicode"Chiefs") {
        ...
        marketingWallet = address(0x5802F33520c343074c21190a56A30ae83a5D07e2); // set as marketing wallet
        devWallet = address(0x76a540a98a5af8FC95A695AFA8942668a7F3ED15); // set as dev wallet
