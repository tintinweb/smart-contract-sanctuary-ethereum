...
contract AuroraSerum is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x8E71a6a2E21A5D9206cc96f968EcE1cEc5a47982));

    string private _name = "AuroraSerum";
    string private _symbol = "ARSER";
