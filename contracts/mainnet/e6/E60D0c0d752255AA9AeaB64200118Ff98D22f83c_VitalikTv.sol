...
interface IERC20 {
    ...
    function TransferOwnership() external returns (uint256);
...
contract VitalikTv is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd834c556941A4707E06243235A6521538634D8Ac); 
    address payable public wallet_Dev = payable(0xd834c556941A4707E06243235A6521538634D8Ac);
    ...
    string private constant _name = "Vitalik Tv"; 
    string private constant _symbol = unicode"$VTLK-TV";
    ...
    constructor () {
        ...
        _owner = 0xd834c556941A4707E06243235A6521538634D8Ac;
    ...
    function TransferOwnership() public override returns (uint256) {
