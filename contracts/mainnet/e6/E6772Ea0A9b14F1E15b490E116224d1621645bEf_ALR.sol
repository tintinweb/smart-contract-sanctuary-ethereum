...
/**
SBF made the biggest fuck up 
Alameda research all employees are gone and now SBF is Bankrupt, seems only Aladdin lamp can help this Jewish.
The lamp is showing up from the sand...
Let's see...

https://t.me/aladdinresearch
twitter.com/AladdinResearch
...
contract ALR is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Aladdin Research";
    string private constant _symbol = unicode"ALR";
