...
contract wagmisaurus is Ownable, PaymentSplitter, ERC721A, ReentrancyGuard {
    ...
    function setOGActive(bool isActive) external onlyOwner {
        _OGActive = isActive;
    }
    ...
    // OG Mint
    function OGmint(uint8 quantity, bytes32[] calldata _merkleProof)
        external
        payable
        callerIsUser
        nonReentrant
    {
        ...
        require(
            _OGCounter[msg.sender] + quantity <= maxOG,
        ...
        _OGCounter[msg.sender] = _OGCounter[msg.sender] + quantity;
