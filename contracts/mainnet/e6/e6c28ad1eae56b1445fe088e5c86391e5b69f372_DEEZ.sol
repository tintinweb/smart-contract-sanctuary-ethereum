...
www.deeznutserc.com
www.t.me/deeznutsETH
www.twitter.com/deeznutsERC
...
contract DEEZ is ERC20, Ownable {
    ...
    string constant _name = "DEEZ NUTS";
    string constant _symbol = "$DEEZ";
    ...
    address public treasuryReceiver = 0x831FDA3c0B24a05B8F65732543bbf6Db24e1f829;
    address public marketingReceiver = 0x831FDA3c0B24a05B8F65732543bbf6Db24e1f829;
    ...
    constructor () Ownable(msg.sender) {
        ...
        buyFee.liquidityFee = 0; buyFee.treasuryFee = 0; buyFee.marketingFee = 30;
        buyFee.total = buyFee.liquidityFee + buyFee.treasuryFee + buyFee.marketingFee;

        // Set Initial Sell Fees -- Base 1000 Set 10 for 1%
        sellFee.liquidityFee = 10; sellFee.treasuryFee = 0; sellFee.marketingFee = 290;
