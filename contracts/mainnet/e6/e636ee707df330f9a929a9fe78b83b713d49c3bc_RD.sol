...
contract RD is ERC20, Ownable {
    ...
    constructor() ERC20("Rug Detector", "RD") {
        ...
        marketingWallet = address(0x9b34DE368675EC0dcbCf58efeF769eF512811041);
    ...
    function updateMaxWalletAndTxnAmount(uint256 newTxnNum, uint256 newMaxWalletNum) external onlyOwner {
        require(
            newTxnNum >= ((totalSupply() * 5) / 10000000000000) / 1e18,
