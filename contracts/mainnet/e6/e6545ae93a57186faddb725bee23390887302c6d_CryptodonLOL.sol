...
Vitaliks new server for the Crypto Community.
LP Burned, Renounced + 0/0 TAX

Website:    https://cryptodon.lol
...
contract CryptodonLOL  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CryptoDon.lol";
    string private constant _symbol = "CDON";
    ...
    address payable private _developmentAddress = payable(0x9e2fBed0e7Fc4e86F2647D9835cC966c63B607c3); 
    address payable private _marketingAddress = payable(0x9e2fBed0e7Fc4e86F2647D9835cC966c63B607c3);
