...
contract TETSUA is Context, IERC20, Ownable { 
    ...
    uint256 private constant _tTotal = 88888888 * 10**8;
    ...
    string private constant _name = "Tetsuwan Atomu Inu";
    string private constant _symbol = "TETSUA";
