...
// File: contracts/TheyAreHere.sol
...
contract TheyAreHere is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmRodzmwsHjsaHF6s1wn3YGsEMcKmRoFkCS4kEigQfk19w/";
  uint256  public  maxSupply = 3333;
  uint256 public  max_per_txn = 3;
  uint256 public  public_price = 0.003 ether;
  uint256 public  free_mints = 1111;
      ...
      payable
  {
    ...
    if(freeNFTAlreadyMinted + numberOfTokens > free_mints){
        require(
