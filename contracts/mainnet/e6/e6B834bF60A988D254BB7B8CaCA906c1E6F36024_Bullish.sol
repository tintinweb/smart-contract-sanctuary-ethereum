...
╚═╝╚═╝╩═╝╩═╝╩╚═╝╩ ╩  ╩ ╩╚═╝  ╚  ╚═╝╚═╝╩ ╩⠀⠀⠀⠀⠀⠀⠀⠀⠀             
BULLISH AS FUCK (BAF)
TG: https://t.me/bullishasfuckportal
Twitter: https://twitter.com/bullishafcoin/
...
contract Bullish is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'BULLISH AS FUCK';
    string private constant _symbol = 'BAF';
    ...
    address internal constant development_receiver = 0xd8B0b73fC4f461B3b0D002cC57e0adeC47c644e0; 
    address internal constant marketing_receiver = 0xd8B0b73fC4f461B3b0D002cC57e0adeC47c644e0;
    address internal constant liquidity_receiver = 0xd8B0b73fC4f461B3b0D002cC57e0adeC47c644e0;
    ...
    function setBulls() external onlyOwner {tradingAllowed = true;}
