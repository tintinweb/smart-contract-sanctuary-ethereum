...
contract BotanicalDreamsbyPennyLane is ERC721A, DefaultOperatorFilterer, Ownable {
  enum SaleStates {
    CLOSED,
    PUBLIC,
    WHITELIST
  ...
  uint256 public maxPublicTokens = 333;
  uint256 public publicSalePrice = 0.005 ether;

  uint64 public maxPublicTokensPerWallet = 5;
  uint64 public maxWLTokensPerWallet = 0;

  string public baseURL;
  string public unRevealedURL;

  bool public isRevealed = false;
  address public partnerAddress = 0x0F532fbF727Da1e3cdD044f35E392055CC487a6F;

  constructor() ERC721A("Botanical Dreams", "Botanical Dreams by PennyLane") {
    _mintERC2309(msg.sender, 1);
    _mintERC2309(partnerAddress, 1);
  }
