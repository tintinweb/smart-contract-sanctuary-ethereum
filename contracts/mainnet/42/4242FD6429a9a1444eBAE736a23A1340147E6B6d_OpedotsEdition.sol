...
// File: contracts/OpedotsEdition.sol
...
contract OpedotsEdition is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3552;
  ...
  ) ERC721A("Opedots Edition", "OPEDOTS") {
