...
Scan GPT-4 - The first Ultimate Token Detection Bot for Telegram using GPT-4 Technology
...
contract ScanGPT4 is ERC20, Ownable {
    ...
    constructor() ERC20("Scan GPT-4", "SGPT-4") {
        ...
        marketingWallet = address(0x030F35C9fB1171CE2BBd48E5Ff5010c42d7D2d6b);
