...
/**
 *    https://t.me/ShiraInuERC
      https://twitter.com/shirainu_erc
*/
...
contract ShiraInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 70_000_000 * 10**_decimals;
    string private constant _name = "Shira Inu";
    string private constant _symbol = "SHIRA";
    uint256 public _maxTxAmount = 14_000_00 * 10**_decimals;
    uint256 public _maxWalletSize = 14_000_00 * 10**_decimals;
    uint256 public _taxSwap=350_000 * 10**_decimals;
