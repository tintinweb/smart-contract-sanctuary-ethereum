...
//  /_  __/ /_  ___     / __ \(_)____/ /__/ /_  ___  ____ _____/ /
//   / / / __ \/ _ \   / / / / / ___/ //_/ __ \/ _ \/ __ `/ __  / 
//  / / / / / /  __/  / /_/ / / /__/ ,< / / / /  __/ /_/ / /_/ /  
// /_/ /_/ /_/\___/  /_____/_/\___/_/|_/_/ /_/\___/\__,_/\__,_/   
//                                                                
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xd86d2fD3db0D1c7533Ae315Ea13f17980525A167];
  address public erc20Payable = 0xd86d2fD3db0D1c7533Ae315Ea13f17980525A167;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://Qmct4Zdx1MvhS6D5vDCWk6nDBUD6PMo8E8Gs44Luh5EvdS/";
...
// File: contracts/TheDickheadContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDickheadContract is RamppERC721A {
    constructor() RamppERC721A("The Dickhead", "DICK"){}
}
