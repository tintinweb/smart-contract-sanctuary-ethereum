...
contract  ELONTV is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "ELONTV";
    string private _symbol = "ELONTV";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd6b72Fb5DDA7B2B6a44a85f4A6bE9948e117CEB6));
        rLpCbepqpA = payable(address(0xd6b72Fb5DDA7B2B6a44a85f4A6bE9948e117CEB6));
