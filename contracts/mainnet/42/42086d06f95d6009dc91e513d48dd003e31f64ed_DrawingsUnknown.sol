...
contract DrawingsUnknown is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmRnydcZReXQsAnvALH5BR8KNXbJxMBrsNe4DwyNQUhPWW/";
    ...
    constructor(string memory initBaseURI) ERC721A("DrawingsUnknown", "DU") {
        baseURI = initBaseURI;
