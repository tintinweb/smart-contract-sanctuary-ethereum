...
contract MOONCHEESE is Context, IERC20, ERC20Ownable {
    ...
    bool private _liquidityLaunch = false;
    ...
    uint256 private _maxWalletSize = 40000000000 * 10**18;
    uint256 private minTokensBeforeSwap;
    uint256 private liquidityTokens;
    uint256 private marketingTokens;
    uint private _marTax = 15; // tax for marketing
    ...
    constructor() {
        ...
        marketingAddress = payable(0x5A2C2Ab02CEd34E92783Fc73876CBcdCF5FBEBf6);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true) {
			require(amount <= 20000000000 * 10**18, "Limits are in place, please lower buying amount");
		}
        if(_liquidityLaunch == true) {
	...
	function swapTokens() private lockTheSwap {
        ...
        uint256 tokensForLiquidity = liquidityTokens.div(2); //Halve the amount of liquidity tokens
    ...
    function setBuyTax(uint buyMarTax, uint buyLiqTax, uint buyRefTax) external onlyOwner {
        ...
        require(_buyMarTax + _buyLiqTax + _buyRefTax <= 25, "Must keep buy taxes below 25%");
    }
    function setSellTax(uint sellMarTax, uint sellLiqTax, uint sellRefTax) external onlyOwner {
        ...
        require(_sellMarTax + _sellLiqTax + _sellRefTax <= 25, "Must keep sell taxes below 25%");
    }
