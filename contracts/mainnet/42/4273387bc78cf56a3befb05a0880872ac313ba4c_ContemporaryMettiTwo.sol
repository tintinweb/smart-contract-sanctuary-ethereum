...
// Contemporary Metti Two consists of two unique artworks from contemporary artist Pumpametti for the Valentine of 2022. 
// The Contemporary Metti series artworks will be raffled to Metti Art Patrons via Twitter.
// The Contemporary Metti Two raffle will be held on Pumpametti Twitter and picked via https://twitterpicker.com/. The artworks will only be sent to raffle winners who are Metti Art Patrons. 
...
// File: contracts/ContemporaryMettiOne.sol
...
contract ContemporaryMettiTwo is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Enumerable, Ownable, Royalties {  
    ...
    constructor() ERC721("ContemporaryMettiTwo", "ContemporaryMettiTwo") {}
