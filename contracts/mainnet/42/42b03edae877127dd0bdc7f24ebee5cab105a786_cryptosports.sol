...
/*
Socials:
Website: https://cryptosports.app/
Telegram: https://t.me/cryptosportsapp
Twitter: https://twitter.com/CryptoSports22
*/
...
contract cryptosports is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CryptoSports", "CSA") {
        ...
        maxTransactionAmount = 1000000000 * 10**9; // 100%
        maxWallet = 20000000 * 10**9; // 2%
		...
		marketingWallet = address(0x89FbEe4a61DcBF1b1755d72B961DC40E0B516592); // set as marketing wallet
        devWallet = address(0x51A7Fa2BF9bDd94acDd69Dc96df9b3fc300923D9); // set as dev wallet
