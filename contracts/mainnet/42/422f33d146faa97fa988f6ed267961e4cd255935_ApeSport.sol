...
contract ApeSport is ERC20, Ownable {
    ...
    constructor() ERC20("ApeSport", "APEL") {
        ...
        uint256 totalSupply = 30 * 1e9 * 1e18;
    ...
    function setBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _burnFee) external onlyOwner {
    ...
    function setSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _devFee, uint256 _burnFee) external onlyOwner {
    ...
    function backNormalTax() external onlyOwner {
        sellOperationsFee = 2;
        sellLiquidityFee = 0;
        sellDevFee = 0;
        sellBurnFee = 0;
