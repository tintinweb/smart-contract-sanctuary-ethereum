...
contract WhiteBoy is ERC721A, Ownable {
	using Strings for uint;

	uint public maxSupply = 3333;
    uint public constant maxPerTx = 3;
	...
	function mint(uint256 quantity) external payable {
        ...
        require(_walletMintedCount[msg.sender] + count <= maxPerTx * 100,"Exceeds max per wallet");
