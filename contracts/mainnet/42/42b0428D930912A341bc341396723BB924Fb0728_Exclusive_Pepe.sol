/*
www.epepe.xyz
https://twitter.com/EPepeETH
https://t.me/Epepe_Portal
*/
...
contract Exclusive_Pepe is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"Exclusive Pepe", unicode"EPEPE") 
    {
        address supplyRecipient = 0x9543fE19B1C7e2E1E503Cecd362D0414329041C1;
        
        updateSwapThreshold(1 * (10 ** decimals()));

        lpTokensReceiverSetup(0x0000000000000000000000000000000000000000);
        liquidityFeesSetup(10, 0, 0);
        ...
        updateMaxWalletAmount(1 * (10 ** decimals()));

        _mint(supplyRecipient, 100 * (10 ** decimals()));
        _transferOwnership(0x9543fE19B1C7e2E1E503Cecd362D0414329041C1);
    }
