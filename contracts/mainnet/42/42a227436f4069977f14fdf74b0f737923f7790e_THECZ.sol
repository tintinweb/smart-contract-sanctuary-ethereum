...
contract THECZ is Context, IERC20, Ownable {
  ...
  address payable public treasuryWallet =
    payable(0x295882Ea8810779369d9439f2D8866396525b49B);
  ...
  string private constant _name = 'THE CZ';
  string private constant _symbol = 'TCZ';
  ...
  uint256 public _maxTxAmount = _tTotal.mul(3).div(100); // 3.0%
