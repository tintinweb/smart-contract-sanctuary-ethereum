...
contract LendLocal is Ownable, ReentrancyGuard {
    ...
    function loanTokenWithPermit(
        ...
        LoanInfo memory _loanInfo
    ) public nonReentrant onlyOwnerOrOperator {
        address user = _loanInfo.user;        
        address collateralToken = _loanInfo.collateralToken;
        ...
        uint256 kiosk = _loanInfo.kiosk;
        uint256 collateralAmountReal = gainCollateral(user, collateralToken, collateralAmount);
        verifySign(_loanInfo.value, _loanInfo.deadline, _loanInfo.v, _loanInfo.r, _loanInfo.s);
        uint256 tokenPrice = _loanInfo.value;
    ...
    function loanEtherWithPermit(LoanInfo memory _loanInfo) external payable nonReentrant onlyOwnerOrOperator {
        address user = _loanInfo.user;
        ...
        verifySign(_loanInfo.value, _loanInfo.deadline, _loanInfo.v, _loanInfo.r, _loanInfo.s);
        uint256 ethPrice = _loanInfo.value;
