...
// File: contracts/degenmoments.sol
...
// ERC721A Contracts v4.0.0
    ...
    contract DegenMoments is Ownable, ERC721A {
    ...
    address constant internal TEAM_ADDRESS = 0xc953C2275CBdBD07940E8f12B09256164C1dCCCC;
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmbPPL6tajaMGYszT6akdVZVGjj9GMgYsMryfCgsyyP66j/";
    string public constant baseExtension = ".json";
    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("DegenMoments", "DEGEN") {_safeMint(msg.sender, 1);}
