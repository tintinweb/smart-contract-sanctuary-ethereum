...
contract URug is ERC721A, Ownable, ReentrancyGuard {

    // constants
    uint256 constant MAX_ELEMENTS = 333;
    uint256 constant MAX_ELEMENTS_TX = 3;
    uint256 constant MAX_FREE_PER_TX = 1;
    uint256 constant PUBLIC_PRICE = 1 ether;

    string public baseTokenURI = "ipfs://QmXaHPXnziQsbvpmtFCF3pxwUzPfDanqpDTvNh7zjsanaK/";
    bool public paused = true;

    constructor(uint256 maxBatchSize_) ERC721A("The Unpullable Rug", "URUG", maxBatchSize_) {}
