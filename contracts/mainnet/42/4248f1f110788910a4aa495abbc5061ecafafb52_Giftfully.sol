...
contract Giftfully is Ownable, DefaultOperatorFilterer, ERC721A {
    ...
    constructor() ERC721A("Giftfully", "GIFT"){}
   ...
   function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
    ...
    function setmaxSupply(uint256 _supply) public onlyOwner() {
        require(_supply <= 10000, "Error: New max supply cant be higher than original max.");
        maxSupply = _supply;
    }
