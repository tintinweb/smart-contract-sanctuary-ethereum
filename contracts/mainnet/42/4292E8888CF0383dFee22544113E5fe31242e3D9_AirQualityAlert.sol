...
/**
 *Submitted for verification at Etherscan.io on 2023-06-7
*/

// https://twitter.com/search?q=airqualityalert&src=typed_query
...
contract AirQualityAlert is ERC20, Ownable {
    ...
    constructor() ERC20("AirQualityAlert", "BADAIR") {
        ...
        buyFee = 20; // sniper protection, to be lowered to 9% after launch
        sellFee = 20; // sniper protection, to be lowered to 9% after launch

        feeWallet = address(0x4E8360C844eC160a5814D459db4707dD67B497d4); // set as feewallet
    ...
    function updateBuyFees(
       uint256 _fee
        ...
        buyFee = _fee;
        require(_fee<10,"Cannot set fee more then 9%");
    }
