...
| __\ \ / // _ \| | | | | |_   _|_ _| / _ \| \| | 
| _| \ V /| (_) | |_| |_| | | |  | | | (_) | .` | 
|___| \_/  \___/|____\___/  |_| |___| \___/|_|\_| 
 */
...
contract EvolutionAbstract is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  string public OPERATOR_FILTER_REGISTRY = '';
  ...
  function FreeMint(uint256 _mintAmount, address _receiver) public onlyOwner {
