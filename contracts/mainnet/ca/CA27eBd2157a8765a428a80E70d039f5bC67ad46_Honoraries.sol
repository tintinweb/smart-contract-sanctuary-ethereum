...
contract Honoraries is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
    using MerkleProof for bytes32[];
    string public baseURI;
    
    //sale settings
    uint256 public SALE_START_TIMESTAMP = 0; // time when sale starts
    uint256 public SALE_END_TIMESTAMP = 0; // time when sale ends
    uint256 public price = 0.00 ether;
    uint256 public maxSupply = 9;
    uint256 public reserved = 9;
    uint256 public maxPerTx = 9; // max per transaction
    uint256 public ambassadorAllowance = 0; // max per ambassador
    uint256 public allowancePerWallet = 9; // max mintable per wallet
    ...
    // allowlist
    address public constant ALLOWLIST_SIGNER = 0x4BBFB4B577dad0eAF72B44E869Aa09c34CF3E6aF;
    
    string _name = "House of First: Honoraries";
    string _symbol = "House of First: Honoraries";
    string _initBaseURI = "https://houseoffirst.com:1335/uniquecollections/opensea/";
