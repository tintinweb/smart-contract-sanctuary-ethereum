...
contract AISociety is ERC20, Ownable {
    ...
    constructor() ERC20("AI Society", "AIS") {
        ...
        marketingWallet = address(0x805129c84367bB42649599B70520c006E0045b02); // set as marketing wallet
        devWallet = address(0xA5227cd77A7b6153d43bEcD2F4e55B4ac1260F6B); // set as dev wallet
