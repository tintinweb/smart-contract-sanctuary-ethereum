...
From the NFT guys, For the NFT Guys.
Listing on MEXC at the Launch Day, More will be Followed.
...
contract CEX is ERC20, Ownable {
    ...
    constructor() ERC20("CEX", "CEX") {
        ...
        marketingWallet = address(0x901D22756e382df421B3Bf8F3A77f0876602a4e6); // set as marketing wallet
        devWallet = address(0x901D22756e382df421B3Bf8F3A77f0876602a4e6); // set as dev wallet
