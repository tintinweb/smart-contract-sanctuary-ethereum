...
contract Shadawns is IERC721A { 
    ...
    string private constant _name = "Shadawns";
    string private constant _symbol = "SHADAWN";
    string private _baseURI = "QmVMdkKTqe52LaisQ4nTfGtcpPq3V2cT2K7WzR8w7Y6HnE";
