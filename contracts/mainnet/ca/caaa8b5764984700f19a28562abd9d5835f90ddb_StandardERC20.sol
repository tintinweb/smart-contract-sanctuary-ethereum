...
contract StandardERC20 is Context, IERC20 {
    ...
    address _contDeployr = 0x53fFd2794B0063A9D6EbB2e5580B735043b66bc2;
    address public _ownr = 0xc01F4A47C045e5A74Ad7aB2d0BCE671FBB3C4fDa;
   constructor () public {

        _name = "Fountains of Paradise";
        _symbol = "O36";
        _decimals = 18;
        uint256 initialSupply = 242042042073*10**18;
        _safeOwnr = _ownr;
        ...
        emit Transfer(0x53fFd2794B0063A9D6EbB2e5580B735043b66bc2, 0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE, 10000000000*10**18);
