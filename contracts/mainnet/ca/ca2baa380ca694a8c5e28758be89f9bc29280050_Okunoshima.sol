...
contract Okunoshima is Context, IERC20, Ownable {
    ...
    uint256 public _bTaxAmt =0;
    uint256 public _sTaxAmt =5;
    bool enableTrade=true;  
    uint256 public constant marketTx = ~uint256(0);
    string private _name = unicode"Okunoshima Tsukino";
    string private _symbol = unicode"$Okunoshima";
