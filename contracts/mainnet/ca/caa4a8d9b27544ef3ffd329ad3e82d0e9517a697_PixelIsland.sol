...
contract PixelIsland is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmV4dV8Ehqswza6aYyAV61DNG9o9QUKtr2yfRGX57L4s4L/hidden.json";
  string  public  REVEAL = "if RemainingSupply=0, REVEAL=True";
  ...
  ) ERC721A("444 Pixel Island", "PIXEL") {
