...
contract MuscleMonster is ERC721A, Ownable {


    string  public uriPrefix = "ipfs://Qmaytg7FKNuz7DNpNVMxDCWceJ9n9Xjko3NnX6ddkfinso/";
    ...
    function publicMint(uint256 amount) public payable callerIsUser{
        ...
        require(msg.value >= cost * amount,"insufficient value");
