...
https://medium.com/@7LegendaryCoins/the-first-launch-1a862386e059

https://medium.com/@7LegendaryCoins/the-launches-8b728ae3b926

https://medium.com/@7LegendaryCoins/7-legendary-coins-each-containing-an-immense-power-and-might-within-them-394d5df42455
...
contract LegendaryCoins is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "7 Legendary Coins";
    string private constant _symbol = "7 Coins";
    ...
    address payable private _developmentAddress = payable(0xe5912233Aa0064889C2fa3DE676aaF8737496e5d);
    address payable private _marketingAddress = payable(0xe5912233Aa0064889C2fa3DE676aaF8737496e5d);
    ...
    uint256 public _maxTxAmount = 22222 * 10**9; //2%
    uint256 public _maxWalletSize = 33333 * 10**9; //3%
