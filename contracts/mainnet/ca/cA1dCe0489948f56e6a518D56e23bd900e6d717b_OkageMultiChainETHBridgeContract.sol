...
contract OkageMultiChainETHBridgeContract is Ownable {
    ...
    address payable public system = payable(0x94924F6D356121f0509B63F1ae059145942D97F6);
    address public governor = address(0x94924F6D356121f0509B63F1ae059145942D97F6);
    address public bridgeFeesAddress = address(0x94924F6D356121f0509B63F1ae059145942D97F6);
    ...
    constructor(address _okage) {
        ...
        _processFees[43114] = 0.001 ether;
        supportedTargetChains[43114] = true;

        okage = IERC20(_okage);
        emit TargetChainAdded(43114, block.timestamp);
    }
