...
For humanity to realise
The evil that a state, evilly driven
Can pose to their neighbors?
Their own people?

I know of a state
Which sits in darkness.
The people there are misled;
Misled to believe it's all okay.
Yet they starve.

I know of a state
Where visitors are hated.
The censorship will choke you
Like the noose for freedom.
Yet you see.

I know of a state
Where choice is extinct.
Destiny is laid before them
And they accept it.
Yet they feel.

I know of a state
Where the guns are aimed.
War thrives here where love
Is in poverty.

The red button is hit -
There's no turning back;
Is it time
For the state to burn?
 ...
 * allowances. See {IERC20-approve}.
 */
contract WarIsPeace is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "War is Peace";
    string private _symbol = "1984";
    uint8 private _decimals = 9;
    uint256 private _supply = 198400;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 3968 * 10**_decimals;
    uint256 public maxWalletAmount = 3968 * 10**_decimals;
    address public marketingWallet = 0x54dBD8FE2574e606222DA732Bd583931720a6659;
    // TOKENOMICS END ============================================================>
