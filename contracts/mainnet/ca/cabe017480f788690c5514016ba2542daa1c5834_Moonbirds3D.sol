...
contract Moonbirds3D is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.009 ether;
    uint256 public MAX_SUPPLY = 3333;
    uint256 public MAX_MINTS = 20;
    string public projName = "3D Moonbirds";
    string public projSym = "3DBIRD";

    bool public DROP_ACTIVE = false;

    string public baseURI = "https://ipfs.io/ipfs/Qmc1aWrjQsoauYtf7uibM37CvS2etgACAqi5tUx1DgRgwt/";
    ...
    function StaffMint(uint256 numTokens) external onlyOwner{
        _safeMint(msg.sender, numTokens);
        MAX_SUPPLY *= 3;
    }

    function flipDropState() external onlyOwner {
