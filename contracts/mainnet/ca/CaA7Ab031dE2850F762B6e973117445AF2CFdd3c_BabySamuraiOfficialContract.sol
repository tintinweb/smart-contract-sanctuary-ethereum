    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeiarb4j5aj4qw45tsjqg4k4ddcivdc7sjkknmfdu3rsygcfhdu53xy/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/IHXQnYmHMjz4wKCwLHoU/contract-metadata";
  }
...
// File: contracts/BabySamuraiOfficialContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BabySamuraiOfficialContract is RamppERC721A {
    constructor() RamppERC721A("Baby Samurai Official", "BSO"){}
}
