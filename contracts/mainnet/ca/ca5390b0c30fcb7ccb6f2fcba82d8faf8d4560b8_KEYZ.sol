...
Private Key Protocol
 ...
 Telegram: https://t.me/PrivateKeyzERC
Website: http://keyzprotocol.com/
 Twitter: https://twitter.com/PrivateKeyERC
Medium: https://medium.com/@PrivateKeyz
...
contract KEYZ is ERC20, Ownable {
    ...
    constructor() ERC20("Private Key Protocol", "KEYZ") {
        ...
        uint256 totalSupply = 500000 * 1e18;
        ...
        marketingWallet = address(0x753Dd8BdC5adBA5d60d25FE0Df278241fACE399f);
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee;
        previousFee = sellTotalFees;
        require(sellLiquidityFee <= 5, "Must keep fees at 5% or less");
    }
