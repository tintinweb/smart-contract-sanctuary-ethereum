...
// File: contracts/OmegaGenesisPass.sol
...
contract OmegaGenesisPass is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  ) ERC721A("Omega Genesis Pass", "OMEGAPASS") {
 
    setHiddenMetadataUri(_hiddenMetadataUri);
  }
 
  function whitelist(uint256 _mintAmount) public payable nonReentrant {
