...
contract H6E6L6L is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmewoX32iQz3LeXVUwxbLfgXpzCHZ3B5yza3twejfrsPLs/";
    ...
    constructor(string memory initBaseURI) ERC721A("H6E6L6L", "HH") {
        baseURI = initBaseURI;
