...
contract RagnarThor is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x69467F39BFB3d5C52C19fAD79590492B4E1f5C33));

    string private _name = "RagnarThor";
    string private _symbol = "RagnarThor";
