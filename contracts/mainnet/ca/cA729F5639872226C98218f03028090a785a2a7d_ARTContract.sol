...
contract ARTContract is RevokableDefaultOperatorFilterer, ERC2981 ,Ownable, ERC721RestrictApprove ,AccessControl,ReentrancyGuard {
    ...
    constructor(
        ...
        setBaseURI("https://data.hayabusa-nft.com/hayabusa-art-gallery/metadata/");
        ...
        setNFTNumberByTokenId( currentTokenId() ,1);
    ...
    function externalMintWithNumber(address _address , uint256 _Number ) external payable {
        ...
        uint256 amount = 1;
        require( (_nextTokenId() -1) + amount <= maxSupply , "max NFT limit exceeded");
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(baseURI, _toString(NFTNumberByTokenId[tokenId]) , baseExtension));
