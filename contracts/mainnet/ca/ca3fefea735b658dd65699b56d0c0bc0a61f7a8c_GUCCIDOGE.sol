...
contract GUCCIDOGE is ERC20, Ownable {
    ...
    constructor() ERC20("GUCCI DOGE", "GG") {
    	...
    	marketingWallet = address(0xd7B02aa58D55014A85ED51eCf59B62e513313b1a); // set as marketing wallet
    	devWallet = address(0xB60654a0782afa433f3867B1ec1Db6B378C855Ee); // set as dev wallet
