...
/**
 * @title FlippedMoonbirds contract
 * @dev Extends ERC721A
 */
...
contract FlippedMoonbirds is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("FlippedMoonbirds", "FMB"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more birds");
