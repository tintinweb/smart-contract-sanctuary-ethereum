...
contract CreepyInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Creepy Inu";
    ...
    address payable private _developmentAddress = payable(0xb1f80D698e2F5659C79c039224068456a3a5aE3d); 
    address payable private _marketingAddress = payable(0xb1f80D698e2F5659C79c039224068456a3a5aE3d);
