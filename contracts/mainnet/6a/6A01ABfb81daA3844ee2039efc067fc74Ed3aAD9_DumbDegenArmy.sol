...
(_))_  /((_)  )\  '((_)\  (_))_  /((_|(_))\ /((_))\ )   )\ _ )(()\   )\  '(()/(  
 ...
 | |) | || | '  \()| '_ \  | |) / -_)/ _` |/ -_) ' \))   / _ \| '_| '  \()| || | 
 |___/ \_,_|_|_|_| |_.__/  |___/\___|\__, |\___|_||_|   /_/ \_\_| |_|_|_|  \_, | 
                                     |___/                                 |__/  
*/                                                                                               

  contract DumbDegenArmy is ERC721B, Ownable {
    ...
    constructor() ERC721B("DumbDegenArmy", "DDA") {}
    ...
    function mintMultiplePublic(address to, uint256 quantity) external payable {
        ...
        require(
          ...
          "Only 10 mints per wallet, priced at 0.001 eth"
        );
        _mintsClaimed[msg.sender] += quantity;
        _mint(to, quantity);
        }

    function FreeMint(address to) external payable {
      require(isSaleActive, "Sale not Active");
      require(
