...
contract BirthOfAGod is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmWorkcaiEVRRHu5batYKp5tU8gKTjHrGUs3b5K9wdsdqH";
    ...
    constructor(
    ) ERC721A("Birth Of A God", "BOAG", 100, maxSupply) {
    }
