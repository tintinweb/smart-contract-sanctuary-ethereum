...
contract SAKURAPROTOCOL  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(_msgSender()); 
    address payable public Wallet_Dev = payable(0x7f34498b1d45ef02e779b6e024A1872A7a54D3c0);
    ...
    string private constant _name = "SAKURA PROTOCOL "; 
    string private constant _symbol = unicode"$SAKURA"; 
    ...
    uint256 public Percent_Dev = 25;
    uint256 public Percent_Burn = 3;
    uint256 public Percent_AutoLP = 2; 
    ...
    function SetAllFee (uint256 Buy, uint256 Sell) public onlyOwner {
        _Tax_On_Buy = Buy;
        _Tax_On_Sell = Sell;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 rTransferAmount = sellFEE+buyFEE;

            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tTransferAmount;
            _tOwned[address(this)] = _tOwned[address(this)]+rTransferAmount;   
