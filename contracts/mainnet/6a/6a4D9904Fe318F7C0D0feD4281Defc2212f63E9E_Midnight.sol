...
contract Midnight is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmY65jvdZiQMt6BPsxQaBRuntpzsrDxu3Ka9BPhScgaBL7";
    ...
    constructor(
    ) ERC721A("Midnight Monsters", "MIDNIGHT", 100, maxSupply) {
    }
