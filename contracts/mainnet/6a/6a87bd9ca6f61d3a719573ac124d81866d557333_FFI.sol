...
https://t.me/FFI_ERC20

FFI - FINANCIAL FREEDOM INU
1000x is nothing

please don't track our funding tx, it is DEFINITELY not linked to big wallets

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 _maxBuyTxAmount = (_totalSupply * 1) / 100;
    uint256 _maxSellTxAmount = (_totalSupply * 1) / 300;
    uint256 _maxWalletSize = (_totalSupply * 1) / 100;

^ this means you can buy 1% in one tx, 1% is also max wallet, however you can only sell 0.3% at a time
Until we remove limits that is.
...
contract FFI is IERC20, Ownable {
    ...
    string constant _name = "FINANCIAL FREEDOM INU";
    string constant _symbol = "FFI";
    ...
    address payable public liquidityFeeReceiver = payable(0xB41eD775c337E895BC7AccDc542D3dE051Ad16b0);
    address payable public marketingFeeReceiver = payable(0xB41eD775c337E895BC7AccDc542D3dE051Ad16b0);
