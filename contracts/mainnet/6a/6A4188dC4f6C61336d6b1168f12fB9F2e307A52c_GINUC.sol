...
$GINUC | GiveWell Inu Classic

This Project will support what $GINU is doing by using the Taxes to Buy Back & Burn $GINU as well as also donating to GiveWell.

t.me/GiveWellClassic
twitter.com/GINUC_
...
contract GINUC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"GiveWell Inu Classic";
    string private constant _symbol = unicode"GINUC";
