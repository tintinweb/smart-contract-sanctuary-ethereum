...
contract SwagInu is ERC20, Ownable {
    ...
    constructor() ERC20("Swag Inu", "SWAG") {
        ...
        marketingWallet = address(0x3CF4B6674463be7265BA384B318699aBCb0665D9);
    ...
    function EnableSwag() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
    ...
    function updateMaxSwagTxnAmount(uint256 newTxnNum, uint256 newMaxWalletNum) external onlyOwner {
        require(
