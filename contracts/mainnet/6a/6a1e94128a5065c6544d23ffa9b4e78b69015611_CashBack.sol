...
/**
Cash Back: $CASH
- Get USDC Back on Each Sell to Cover Gas Costs

Tokenomics:
5% of each buy/sell goes to existing holders via Reflections
5% of each buy/sell goes into auto-refund in USDC for gas costs (approx.)
*/
...
contract CashBack is Context, IERC20, Ownable {
  ...
  string private _name = 'Cash Back';
  string private _symbol = 'CASH';
  ...
  address payable public _CashContractAddress;
  ...
  uint256 private _numOfTokensToExchangeForTeam = 1 * 10**6;
  ...
  constructor(
    address payable CashWalletAddress,
    address payable marketingWalletAddress
  ) {
    _CashContractAddress = CashWalletAddress;
    ...
    IUniswapV2Router02 _uniswapV2Router;
        ...
        if (block.chainid == 56) {
            ...
            _uniswapV2Router = IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29); // SS for FTM Network
        } else {
            revert();
        }
  ...
  function sendETHToTeam(uint256 amount) private {
    _CashContractAddress.call{ value: amount.div(2) }('');
  ...
  function _setCashContract(address payable CashContract) external onlyOwner {
    _CashContractAddress = CashContract;
  }
