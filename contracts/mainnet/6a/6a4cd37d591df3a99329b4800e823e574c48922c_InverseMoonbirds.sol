...
/**
 * @title InverseMoonbirds contract
...
contract InverseMoonbirds is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.001 ether;
  uint public          maxPerTx          = 27;
  uint public          maxPerWallet      = 77;
  uint public          totalFree         = 2777;
  uint public          maxSupply         = 7777;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("InverseMoonbirds", "IMB"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"INVERSEEEEEEEEEE");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"Sorry degen");
