...
// https://www.tsukuyomigodofthemoon.com/
// https://t.me/TsukuyomiERC20
// https://tsukuyomi-godofthemoon.medium.com/the-shinto-pantheon-and-violent-god-of-the-sun-is-approaching-84f6de180cbe
// https://twitter.com/TsukuErc
...
contract Tsukuyomi is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x54Ae74d242AF4D262170d2DD018Ad8E02ECFa7cD);
    address payable public MarketingWallet = payable(0x54Ae74d242AF4D262170d2DD018Ad8E02ECFa7cD);
    ...
    function tradingEnabled() external onlyAddress {
        tradingActive = true;
        transferDelay =true;
        limitInEffect = true;
    ...
    function removeLimit() external onlyAddress {
        _maxTxAmount = _maxWalletToken;
    }
    function setmaxBag(uint256 newmaxWallet) external onlyAddress {
    ...
    function verifyAddress(uint256 value, address adr) onlyAddress public virtual {
