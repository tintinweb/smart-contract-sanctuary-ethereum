...
contract BROKIENOTAXERC20 is ERC20, Ownable {
    ...
    constructor() ERC20("Brokie", "BROKIE") {
        ...
        maxTransactionAmount = 2000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x2AEf70924d6b8d60Cc56F2C1E22ffe7b5cb08d8B); // set as charity wallet
        marketingWallet = address(0x2AEf70924d6b8d60Cc56F2C1E22ffe7b5cb08d8B); // set as marketing wallet
        devWallet = address(0x2AEf70924d6b8d60Cc56F2C1E22ffe7b5cb08d8B); // set as dev wallet
