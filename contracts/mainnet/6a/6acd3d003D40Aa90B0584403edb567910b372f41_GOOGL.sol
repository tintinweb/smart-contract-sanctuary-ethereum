...
/**
$Googl is a decentralized platform built on the Ethereum network, designed to integrate the advanced capabilities of a ChatGPT-style AI bot within the Telegram app.

https://googl-ai.com/
https://telegram.me/GooglAiErc
https://twitter.com/GooglAiErc
...
contract GOOGL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Googl.AI", "GooglAI") {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x0dD0114533A6F7c361368BD9Efedcc109f907165,
            block.timestamp
        );
    }
