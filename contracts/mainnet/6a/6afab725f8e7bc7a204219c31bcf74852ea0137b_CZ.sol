...
contract CZ is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Proof Of CZ";
    string private constant tokenSymbol = "BNB";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xbF9998a646bf24bffC7b67516a9952E138891377);
        devAddress = payable(0xbF9998a646bf24bffC7b67516a9952E138891377);
