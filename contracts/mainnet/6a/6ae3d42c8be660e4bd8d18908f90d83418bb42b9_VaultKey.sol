...
contract VaultKey is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 2000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "ipfs://QmbeEe9hdsQ11jeC3QcuSYxtRX118yburTvsZBYXTiUXRJ/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("Vault Key", "VK", MAX_MINTS, MAX_SUPPLY) {  
