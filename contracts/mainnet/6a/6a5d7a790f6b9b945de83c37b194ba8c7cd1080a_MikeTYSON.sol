...
/// MTYSON's Liquidity is Perma-Locked in this contract
/// MTYSON's Auto-Burn LP Token prohibits a malicious actor from removing LP
/// even if the malicious actor is me

/// The only LP that will be burned is Liquidity bought by the contract
/// How much liquidity is locked and burned is proportional to MTYSON's market cap
/// Even you can add your own liquidity, because liquidity
/// enables free markets to be free
/// MTYSON is a free market

/// Trust in defi has been abused
/// MTYSON is a shield

/// Total Supply: 100,000,000,000.00 (100B) $MTYSON 
/// Taxes: 6/6%
/// 100% of taxes collected are added to the contract 
/// and introduced into the MTYSON Liquidity Pool 

/// https://t.me/miketysonportal
/// Community Admins will be assigned.
/// https://tyson.best/
/// https://twitter.com/miketysoncoin
...
contract MikeTYSON is ERC20, Ownable {
    /*
    ...
    */
    ...
    ) public ERC20("Mike TYSON", "MTYSON") {
