...
contract Wgmis is ERC721, Ownable {
    ...
    string public suffixBaseURI = ".json";
    ...
    uint96 public foundationAllowance = 100;
    ...
    mapping(address => uint96) public giveawayWhitelist;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked(baseURI, tokenURI_, suffixBaseURI));
    }
