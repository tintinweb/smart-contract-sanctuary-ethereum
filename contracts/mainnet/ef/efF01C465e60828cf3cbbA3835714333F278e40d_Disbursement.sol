...
interface DAPP {
    ...
    function disperseTokenAllotment(address token) external;
...
contract Disbursement is DAPP, Auth {
    address address1;
    address address2;
    address address3;
    ...
    function disperseAllotment() external override {
    ...
    function disperseTokenAllotment(address token) external override {
