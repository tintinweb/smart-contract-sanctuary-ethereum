...
/*
Babyinu will always grow. 
EveryInu, every baby.
https://t.me/babyinueth
https://twitter.com/babyinueth
*/
...
contract BABYINU is ERC20, Ownable {
    ...
    constructor() ERC20("BabyInu", "BabyINU") {
        ...
        maxWallet = 1 * 1e7 * 1e18; // Max Wallet 1%
		...
		marketingWallet = address(0x63161e85AB6043E7F2cA821dB787FF1Fa4122f34); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x63161e85AB6043E7F2cA821dB787FF1Fa4122f34)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x63161e85AB6043E7F2cA821dB787FF1Fa4122f34)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x63161e85AB6043E7F2cA821dB787FF1Fa4122f34)] = true;
