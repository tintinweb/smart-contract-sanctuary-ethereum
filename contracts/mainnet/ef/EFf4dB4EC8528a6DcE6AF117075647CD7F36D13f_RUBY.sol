...
/**
 No Tax. No Owner. Belongs to the Blockchain. LP will be Locked. Supply will be bought up and Burned.
 No Current socials. Feel free to create them. Meet RUBY. 
*/
...
contract RUBY is ERC20, Ownable {
    ...
    constructor() payable ERC20("RUBY", "RUBY") {
    ...
    /**
     * Buy tax cannot be greater than 1
     */
    ...
    /**
     * Sell tax cannot be greater than 1
     */
