...
contract Arosi is ERC20, Ownable {
    ...
    constructor() ERC20("Arosi Inu", "Arosi") {
        ...
        maxTransactionAmount = 3000000000 * 1e18; // 1.5% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0x907aF006EB3E82cD247715728f7343C620bDA33A); // set as charity wallet
        marketingWallet = address(0x907aF006EB3E82cD247715728f7343C620bDA33A); // set as marketing wallet
        devWallet = address(0x907aF006EB3E82cD247715728f7343C620bDA33A); // set as dev wallet
