...
contract RINTINTIN is ERC20, Ownable {
    ...
    constructor() ERC20(" Rin Tin Tin ", "Rinty") {
		...
		charityWallet = address(0x570e1068b5365d67EcC0d39EC027BCAf7bc5be83); 
        marketingWallet = address(0x570e1068b5365d67EcC0d39EC027BCAf7bc5be83); // set as marketing wallet
        devWallet = address(0x570e1068b5365d67EcC0d39EC027BCAf7bc5be83); // set as dev wallet
