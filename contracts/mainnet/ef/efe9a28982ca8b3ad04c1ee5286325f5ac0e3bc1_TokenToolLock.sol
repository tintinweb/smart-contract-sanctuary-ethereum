...
This contract locks liquidity and ERC20 Token tokens. Locked liquidity cannot be removed from DEX
until the specified unlock date has been reached.

 • website:                           https://tokentool.app
 • Telegram Main Channel:             https://t.me/tokentool_app
 • Twitter Page:                      https://twitter.com/tokentool_app
...
import "./interfaces/ITokenToolLock.sol";
import "./interfaces/IPoolManager.sol";

contract TokenToolLock is ITokenToolLock,OwnableUpgradeable, UUPSUpgradeable {
    ...
    // If sender is a pool generated by TokenTool,
    // skip checking fee
    modifier feePaid() {
    ...
    function initialize(uint256 _fee, address _poolManager) external initializer {
        __Ownable_init();
    ...
    function _isGeneratedPool(address addr) private view returns (bool isPool) {
        try
            poolManager.isPoolGenerated(addr) returns (bool _isPool) {
            isPool = _isPool;
        } catch {
            isPool = false;
        }
