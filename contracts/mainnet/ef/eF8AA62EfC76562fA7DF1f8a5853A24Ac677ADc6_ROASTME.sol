...
contract ROASTME is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "ROASTME";
    string private constant tokenSymbol = "ROASTME";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x15101d58552A0f31dcCb56B647C6A7Ec89bFdE5b);
        devAddress = payable(0x15101d58552A0f31dcCb56B647C6A7Ec89bFdE5b);
