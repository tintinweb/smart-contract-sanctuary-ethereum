...
// File: contracts/Refrigerator.sol
...
contract Refrigerator is Ownable {
    ...
    constructor(IMilkToken _milk, uint256 _lockDuration, bool _depositsEnabled) {
        milk = _milk;
    ...
    function deposit(uint256 _amount) external {
        ...
        IERC20(address(milk)).safeTransferFrom(address(msg.sender), address(this), _amount);
        milk.burn(_amount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        user.amount -= _amount;
        totalStaked -= _amount;
        milk.mint(address(msg.sender), _amount);
