...
/*
    ...
    You missed The Golden Bull.
    You want generational wealth.
    You have been ABDUCTED by the Bear Market.
    You need something to APE. 

    Work hard, build together, 
    and we rule like monkeys.
...
contract Ape is ERC20, Ownable {
    ...
    constructor() ERC20("Ape Inu", "\xF0\x9F\xA6\x8D") {
        ...
        devWallet = address(0x7e66Df49C33B83ADCd16a27A9Af7CaBDeC8e215a); // set as dev wallet
