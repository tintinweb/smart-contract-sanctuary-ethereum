...
/**
    Space Of Tsuka ERC Token

    Tg: https://t.me/spaceoftsukacommunity
...
contract SpaceOfTsuka is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x10AA69aDF7eF68621B57fA4f66509AD6a3fde200); // Marketing Address
    address payable public multiSigAddress = payable(0x10AA69aDF7eF68621B57fA4f66509AD6a3fde200); // Marketing Address
    address payable public devAddress = payable(0x10AA69aDF7eF68621B57fA4f66509AD6a3fde200); // Dev Address
    address payable public liquidityAddress = payable(0x10AA69aDF7eF68621B57fA4f66509AD6a3fde200); // Liquidity Address
    ...
    string private constant _name = unicode"Space Of Tsuka";
    string private constant _symbol = unicode"sTsuka";
