...
contract rugimals is Ownable, ERC721A {
    ...
    string public baseURI = "ipfs://QmXkhJueMX3D3K3ZiaCGF1axccZ48pUgHGFHFDmCyZWBbw/";

    constructor() ERC721A("rugimals", "RUG"){}
    ...
    function buy_rey(uint _count) external onlyOwner {
      require(_count > 0, "Mint at least one token.");
      require(total_supply + _count<= max_supply, "Not enough tokens available.");
