...
/** @title GmUkraine */
contract GmUkraine is ERC721Enumerable, Ownable {
    bool public mintingActive = true;
    string private currentBaseURI;

    constructor() ERC721("GmUkraine", "gmUKR") {}

    /** @dev Donate eth to mint a token
     */
    function donate(uint256 tokenId) public payable {
        require(mintingActive, "Minting is not active");
        require(msg.value >= 0.01 ether, "The minimum donation is 0.01 ETH");
    ...
    /** @dev Donates ETH
    Donate all ETH in the contract to a particular wallet
    This address is not hard-coded in case it needs to change
    (There becomes a better source of donations, or the recipient changes wallet)
     */
...
import "../contracts/GmUkraine.sol";

contract XGmUkraine is GmUkraine {
    constructor() {}
