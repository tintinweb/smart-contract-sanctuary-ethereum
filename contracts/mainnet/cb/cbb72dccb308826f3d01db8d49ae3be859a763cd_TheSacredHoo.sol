...
https://medium.com/@TheSacredHoo
https://twitter.com/TheSacredHoo
...
contract TheSacredHoo is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20(unicode"The Scared Hōō", unicode"HŌŌ") {
        ...
        uint256 _sellBurnFee = 800;
        uint256 _sellDevFee = 600; // From the ashes shall rise.
