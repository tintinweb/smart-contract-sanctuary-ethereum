...
contract elfvtown is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://0x977D00703d8ce39316B6558dfd2BDF6b2b2A5faA";
    ...
    constructor(
    ) ERC721A("elfvtown.wtf", "elfv", 100, maxSupply) {
    }
