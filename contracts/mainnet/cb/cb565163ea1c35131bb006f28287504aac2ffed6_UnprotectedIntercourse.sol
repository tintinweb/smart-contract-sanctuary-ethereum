...
// File: Unprotected Intercourse.sol
...
// A project by Zunebra the Dev
// t.me/unprotectedintercourse
...
contract UnprotectedIntercourse is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x21BA3d97c46F720992131Ce73872f9Cde42C5a35); 
    address payable public devWallet = payable(0xFd6C72bd8Ff7EC942605660208fBea016a3Ff8A0);
    ...
    constructor() ERC20("Unprotected Intercourse", "BREED") {
