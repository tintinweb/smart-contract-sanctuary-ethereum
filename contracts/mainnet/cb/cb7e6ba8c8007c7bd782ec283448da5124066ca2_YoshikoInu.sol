...
contract YoshikoInu is ERC20 {
    ...
    constructor (address router, address factory, uint256 supplyTokens) ERC20(_name, _symbol) {
        _name = "Yoshiko Inu";
        _symbol = "YOSHIKO";
        _decimals = 9;
        _router = router;
        ...
        _addressForRewards = 0x0342fBdC9d8c5D71d31Ca201848d3e9c97C4E088;
