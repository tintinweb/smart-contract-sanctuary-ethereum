...
4% taxes to be dropped to 2% at 25k MC. 

Community TG live at 1300 UTC 03/08/22
...
contract MovementApp is IERC20, Auth {
	string _name = "Movement";
	string _symbol = "MOVE";
	uint256 constant _totalSupply = 50 * (10**6) * (10 ** _decimals);
	...
	uint16 private _ethTaxShares1  = 300;
	...
	address payable private _ethTaxWallet1 = payable(0x92ABDE962fA4587F406a79EA6B1E80dBb5fb0904); 
	address payable private _ethTaxWallet2 = payable(0x92ABDE962fA4587F406a79EA6B1E80dBb5fb0904); 
	address payable private _ethTaxWallet3 = payable(0x92ABDE962fA4587F406a79EA6B1E80dBb5fb0904); 
	address private _tokenTaxWallet = address(0x5C073F315cF95251d7a14E2ECf9e6BDb4A986B34); 
