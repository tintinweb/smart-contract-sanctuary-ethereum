...
Telegram: T.me/songokuETH
Medium:   https://medium.com/@songokuerc
Twitter: https://twitter.com/SonGokuErc
...
contract Songoku is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Songoku";
    string private _symbol = "SONGOKU";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x7dca63343653e84Cf5A85CE7ec18c7c7eaC5d7B7);
