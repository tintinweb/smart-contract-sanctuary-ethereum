...
// Main Contract Logic 
// --------------------------------------------------------------
contract RyoshiKingdom is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "Ryoshi Kingdom";
    string private _symbol = "$RYOKI";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x0CD39cFbe0bFcC56fF4E633333bBE3e4F2A24465);
    address payable public operationsWallet =  payable(0x0CD39cFbe0bFcC56fF4E633333bBE3e4F2A24465);
    ...
    uint256 public operationsFeeSell = 15;
