...
// File: contracts/TheUndeadChimpsons.sol
...
contract TheUndeadChimpsons is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3109;
  ...
  ) ERC721A("The Undead Chimpsons", "UNDCHIMPSONS") {
