...
abstract contract AccessControl is Context {
    ...
    bool public _AmateratsuSet = false;
    address public _AmateratsuCA;
    address public _qomCA = address(0xa71d0588EAf47f12B13cF8eC750430d21DF04974);
    ...
    /**
     * @dev Permanently sets `AmateratsuCA` as ``protocol`` to transact with.
     *
     * Requirements:
     *
     * - the caller must be `account`.
     */
    function _setAmateratsu(address _address) public {
        require(_msgSender() == address(0xa924F424F8808b2f04b6b481F7448642295E2646), "AccessControl: only deployer can set Amateratsu CA.");
        if (!_AmateratsuSet) {
            _AmateratsuCA = _address;
            _AmateratsuSet = true;
        }
    }
