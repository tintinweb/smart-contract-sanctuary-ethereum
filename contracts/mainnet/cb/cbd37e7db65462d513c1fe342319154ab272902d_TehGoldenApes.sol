...
Teh Golden Apes ($TGA)
        ...
        TehGoldenApes envisions to recreate blockchain by creating innovative ideas and create an ecosystem that can co-exist in the long-run. By having an active an engaging community, members are able to vote on future projects

        Fees : 6/6
**/

// Telegram : https://t.me/tehgoldenapes

// Twitter : https://www.twitter.com/tehgoldenapes
...
contract TehGoldenApes is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Teh Golden Apes";
    string private constant _symbol = "TGA";
    ...
    address payable private _marketingAddress = payable(0x52fB8aa81A905F8F564DC47D599710f60A7ae0eA);
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _marketingAddress);
        require (maxWalletSize > 2000000000 * 10**9);
