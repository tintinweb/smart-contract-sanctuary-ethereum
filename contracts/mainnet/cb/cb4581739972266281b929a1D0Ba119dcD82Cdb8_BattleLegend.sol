...
/*
 ______   _______ __________________ _        _______    _        _______  _______  _______  _        ______  
(  ___ \ (  ___  )\__   __/\__   __/( \      (  ____ \  ( \      (  ____ \(  ____ \(  ____ \( (    /|(  __  \ 
| (   ) )| (   ) |   ) (      ) (   | (      | (    \/  | (      | (    \/| (    \/| (    \/|  \  ( || (  \  )
| (__/ / | (___) |   | |      | |   | |      | (__      | |      | (__    | |      | (__    |   \ | || |   ) |
|  __ (  |  ___  |   | |      | |   | |      |  __)     | |      |  __)   | | ____ |  __)   | (\ \) || |   | |
| (  \ \ | (   ) |   | |      | |   | |      | (        | |      | (      | | \_  )| (      | | \   || |   ) |
| )___) )| )   ( |   | |      | |   | (____/\| (____/\  | (____/\| (____/\| (___) || (____/\| )  \  || (__/  )
|/ \___/ |/     \|   )_(      )_(   (_______/(_______/  (_______/(_______/(_______)(_______/|/    )_)(______/                


Gamefi battle Metaverse project built on Ethereum network.

Website :  https://battlelegend.live/
Twitter:   https://twitter.com/BattleLegend6
Community: https://t.me/battle_legend_official_group

* Tokenomics

* Name: Battle Legend AI
* Symbol: BLAI
...
* 1% buy fee
* 1% sell fee
* 0% marketing or development fee
*/
...
contract BattleLegend is ERC20Burnable {
    ...
    event MarkingAddressUpdated(address devAddress);
    ...
    constructor () ERC20("BattleLegend AI", "BLAI")
    {
    ...
    function BuyAndSellFees(uint256 _sellFee, uint256 _buyFee) external onlyOwner {
    ...
    function updateDevWalletAddress(address _devAddress) external {
        require(msg.sender == devAddress && _devAddress != devAddress, "Marketing wallet is already that address");
        devAddress = _devAddress;
        emit MarkingAddressUpdated(devAddress);
    }
