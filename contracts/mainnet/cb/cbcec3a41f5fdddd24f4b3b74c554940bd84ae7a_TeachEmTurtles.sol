...
contract TeachEmTurtles is ERC721A, Ownable {
    // variables
    using Strings for uint256;

    constructor(string memory _RevealedUri) ERC721A("TeachEmTurtles", "TET") {
    ...
    uint256 public SaleMaxQuantity = 7;

    bool public isPreSalePaused = true;
    bool public isPaused = true;
    string public _baseURI1;
    address private partner = 0x8A494E6ea672175A87E3C3B54E1B56e49Aa2713e;
    ...
    function PreMint(uint256 chosenAmount) public payable {
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 ownerShare = (Totalbalance * 25) / 100;
        uint256 partnerShare = (Totalbalance * 75) / 100;
        payable(msg.sender).transfer(ownerShare);
        payable(partner).transfer(partnerShare);
    }
}