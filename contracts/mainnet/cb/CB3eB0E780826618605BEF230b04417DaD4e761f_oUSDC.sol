...
// Nothing is stable, new financial crisis is coming, crypto market who can laugh last, and the weak will die.
// A stable system with Bitcoin at its center is trustworthy.
...
contract oUSDC is ERC20, Ownable {
    ...
    constructor() ERC20("Ordinal Usdc", "oUSDC") {
        ...
        uint256 totalSupply = 40928368086 * 1e18;

        maxTransactionAmount = 410000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 820000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xFbE8d8E261BC46376D7E5B8870f46806295445F1); // set as charity wallet
        marketingWallet = address(0xFbE8d8E261BC46376D7E5B8870f46806295445F1); // set as marketing wallet
        devWallet = address(0xFbE8d8E261BC46376D7E5B8870f46806295445F1); // set as dev wallet
