...
contract LiquidityLockerInuETH is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Liquidity Locker Inu";
    string private constant _symbol = unicode"LLI";
