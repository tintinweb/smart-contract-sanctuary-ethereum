...
contract MysteryHeroes is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmSqmRoC9LXHSjKebYWfM6o7i3wYfYN28u6rkRwKwvYKuu/hidden.json";
  string  public  GENDER = "50% MALE / 50% FEMALE";
  string  public  CLASS = "Chosen at time of recruitment";
