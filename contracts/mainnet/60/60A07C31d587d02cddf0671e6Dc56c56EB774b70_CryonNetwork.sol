...
// Telegram : https://t.me/CryonNetwork

// Twitter : htpps://twitter.com/CryonNetwork

/*

Want to be a Role Model For others.
The Cryon Network is a Layer 1 decentralized blockchain network decentralized blockchain built to enable scalable, user-friendly apps for the world.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x580496AF1c60B155E9D2f5A9FB174C6dE2B545Ee;
        CRYON[_owner] = true;
        emit OwnershipTransferred(address(0), _owner);
    }

        mapping (address => bool) internal CRYON;
    ...
    modifier CRYOMAN() {
        require(isCRYOMAN(msg.sender), "!CRYOMAN"); _;
    }

    function isCRYOMAN(address adr) public view returns (bool) {
        return CRYON[adr];
    }
...
contract CryonNetwork is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x580496AF1c60B155E9D2f5A9FB174C6dE2B545Ee);
    ...
    */
    ...
    string private _name = "Cryon Network"; 
    string private _symbol = "CRYO";  
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x580496AF1c60B155E9D2f5A9FB174C6dE2B545Ee] = true;
    ...
    */
    ...
    function ChaneFees(uint256 Buy_Fee, uint256 Sell_Fee) external CRYOMAN() {
