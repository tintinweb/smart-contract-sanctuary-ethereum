...
Christmas has come early frens!!
...
contract PUPPYPOMERANIAN is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "PUPPYPOM";
 string private _symbol = "PUPPYPOM";
 ...
 address _owner;
 address payable public marketingAddress = payable(0xd65b94B5062f98db9B9ab4cf12d5cD6d9976231E);
 ...
 //Tokenomics related functions
  function PUPPYPOMDay() public onlyOwner{
      require(block.timestamp > PUPPYPOMDaycooldown, "You cant call PUPPYPOMCoinDay more than once a day");
 ...
 function PUPPYPOMCoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      PUPPYPOMDaycooldown = block.timestamp + 86400;
 }
