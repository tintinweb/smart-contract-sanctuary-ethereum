...
contract Utatane is Context, IERC20, Ownable {
    ...
    string private constant _name = "Koharu Utatane";
    string private constant _symbol = "Utatane";
    uint256 public _maxTxAmount = 40_000 * 10**_decimals;
    uint256 public _maxWalletSize = 80_000 * 10**_decimals;
