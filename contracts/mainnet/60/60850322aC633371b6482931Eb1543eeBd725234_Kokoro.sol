...
contract Kokoro is ERC20, Ownable {
    ...
    constructor() ERC20("Kokoro", "$KOKO") {
		...
		charityWallet = address(0x8E66754020a2f01b22Bbf27941931DbaCD5EbcBb); // set as charity wallet
        marketingWallet = address(0x8E66754020a2f01b22Bbf27941931DbaCD5EbcBb); // set as marketing wallet
        devWallet = address(0x8E66754020a2f01b22Bbf27941931DbaCD5EbcBb); // set as dev wallet
