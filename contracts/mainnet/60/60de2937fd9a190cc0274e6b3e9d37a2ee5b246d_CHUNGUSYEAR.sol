...
contract CHUNGUSYEAR is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Chungus Year";
    ...
    address payable private _developmentAddress = payable(0x81f56fe186b83bc3b3FC88c6D2E588B5B9655570); 
    address payable private _marketingAddress = payable(0x81f56fe186b83bc3b3FC88c6D2E588B5B9655570);
