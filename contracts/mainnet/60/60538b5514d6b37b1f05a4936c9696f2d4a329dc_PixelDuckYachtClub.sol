...
contract PixelDuckYachtClub is ERC721A, Ownable {

    string public baseURI = "ipfs.io//";
    string public contractURI = "ipfs.io//";
    string public constant baseExtension = ".json";
    address public constant proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;

    uint256 public constant MAX_PER_TX_FREE = 10;
    uint256 public constant MAX_PER_TX = 10;
    uint256 public constant FREE_MAX_SUPPLY = 1555;
    uint256 public MAX_SUPPLY = 5555;
    uint256 public price = 0.004 ether;

    bool public paused = false;

    constructor() ERC721A("Pixel Duck Yacht Club", "PDYC") {}
