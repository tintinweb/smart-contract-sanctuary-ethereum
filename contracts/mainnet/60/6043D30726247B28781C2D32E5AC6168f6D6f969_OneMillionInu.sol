...
contract OneMillionInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("One Million Inu","OMI") {
        ...
        maxTransactionAmount = totalSupply * 100 / 2000; // 2%
        maxWallet = totalSupply * 10 / 2000; // 2% 
        swapTokensAtAmount = totalSupply * 5 / 1000000; // 0.1%
        ...
        marketingWallet =0xf71DDE36402E399BA1A47320BB0F7FFc0fd9383C; // set as marketing wallet
        devWallet = 0xf71DDE36402E399BA1A47320BB0F7FFc0fd9383C; // set as dev wallet
