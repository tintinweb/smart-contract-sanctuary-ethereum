...
/// @title: T+/- Data Sculptures by Refik Anadol
/// @author: manifold.xyz
...
contract TPlusMinusDataSculptureSplashdown is Proxy {
    uint16 constant GROUP_1_SIZE = 422;
    ...
    constructor(address creator, address signingAddress) {
        ...
        Address.functionDelegateCall(
            ...
            abi.encodeWithSignature("initialize(address,uint16,uint256,uint16,uint16,uint256,uint16,address,bool)",
              creator,
              GROUP_1_SIZE + GROUP_PADDING,     // purchaseMax aka totalSupply
              10000000000000000000000000000000, // purchasePrice
              1,                                // purchaseLimit
              1,                                // transactionLimit
              1000000000000000000,              // presalePurchasePrice
