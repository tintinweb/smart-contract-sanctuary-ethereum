 ...
 * allowances. See {IERC20-approve}.
 */
contract ELUNE is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "The Moon Goddess";
    string private _symbol = unicode"🌕ELUNE🌕";
    uint8 private _decimals = 18;
    uint256 private _supply = 69420;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 4;
    uint256 public maxTxAmount = 695 * 10**_decimals;
    uint256 public maxWalletAmount = 695 * 10**_decimals;
    address public marketingWallet = 0xD51a473169cBc271482820A70fcC0F2f9c9EE5cE;
    uint256 private _numTokensSellToAddToLiquidity = 69 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 42 * 10**_decimals;
    // TOKENOMICS END ============================================================>
