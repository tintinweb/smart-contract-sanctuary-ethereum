...
contract MisfitsNFT is ERC721A, Ownable {
    ...
    // Pre Reveal URI: https://themisfitsnft.mypinata.cloud/ipfs/QmPHj5LvPY1C9rzsv5acDCt7FAcFLoLEngtio38t7Yfx6x/
...
// File: contracts/MisfitsNFTMinter.sol
...
contract MisfitsNFTMinter is Ownable {
    ...
    function setRemainingMints(address wallet, uint8 newValue) external onlyOwner {
        remainingMints[wallet] = newValue;
    }
