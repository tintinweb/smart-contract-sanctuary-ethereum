...
contract CicheroPfp is ERC721, Ownable {
    ...
    address private constant CreatorAddress = 0xb8af642f237bed889B6cEfa272c27F3b7fdC011C;
    ...
    constructor(string memory _baseURIextended) ERC721("CICHERO PFP", "CPFP"){
