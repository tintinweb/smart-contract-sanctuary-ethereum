...
// ShadowVerse is the new generation socialfi project to build the NFT, Play2Earn, Watch2Earn, Staking into an mobileapp.
 ...
 * allowances. See {IERC20-approve}.
 */
contract Shadowverse is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Shadowverse";
    string private _symbol = "SDV";
