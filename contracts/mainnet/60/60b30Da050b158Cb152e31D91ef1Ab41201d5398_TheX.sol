...
contract TheX is ERC721A, Ownable, ReentrancyGuard {
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        bool success;
        (success, ) = payable(0xB6BdD4F0839eF6791eC1c77Cf29B10592d514624).call{value: ((balance * 35) / 100)}("BlocqX");
        require(success, "BlocqX Transaction Unsuccessful");

        (success, ) = payable(0x00f724304efBD1c7A5050FaC6d473EDEd4BF6574).call{value: ((balance * 35) / 100)}("Mode");
        require(success, "Mode Transaction Unsuccessful");

        (success, ) = payable(0x245bCEB81a378D5627F60F417Eb7971C98DEa7e5).call{value: ((balance * 10) / 100)}("LtDan");
