...
/**
すべての光の戦士は、戦いに参加することを恐れています。
すべての光の戦士は、過去のある時点で、誰かに嘘をついたり裏切ったりしました。
すべての光の戦士は、自分のものではない道を歩んできました。
それが彼が光の戦士である理由です。彼はこれらすべてを経験してきたにもかかわらず、自分よりも優れているという希望を失ったことがないからです。
...
contract WarriorOfTheLight is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Warrior of the Light";
    string private constant _symbol = "WOTL";
    ...
    address payable private liqAddress = payable(0x7E2fd3071650bEC415f0ABFfcC285bf2e9974782);
