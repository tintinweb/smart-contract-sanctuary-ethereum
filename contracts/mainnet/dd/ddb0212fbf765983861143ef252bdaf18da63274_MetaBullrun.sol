...
// https://t.me/metabullrun_erc
// https://metabullrun.tech/
// https://twitter.com/Metabullrun_erc
...
contract MetaBullrun is ERC20, Ownable{
    ...
    address public marketingWallet = 0xDA0c1C16021A1305FeB4baB517BfC87b68Fc3f7A;
    address public devWallet = 0x92803166364C85b462190649D7D3bfeaa04b371d;
    ...
    Taxes public taxes = Taxes(3,0,7);
    Taxes public sellTaxes = Taxes(72,0,18);
    uint256 public totTax = 10;
    ...
    constructor() ERC20("Meta Bullrun", "MBR") {
