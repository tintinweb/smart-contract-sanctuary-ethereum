...
/**
    Shiba Hakai  -  芝ハカイ - $SHIBKAI

    Hakai (破壊, Hakai - "Destruction") is a powerful ability used by the Gods of Destruction. 

    Tokenomics:
    - Buy Tax: 2% Marketing, 2% Devteam
    - Sell Tax: 4% Marketing, 3% Devteam

    Socials:
    Website: https://www.shibkai.com
    Twitter: https://twitter.com/ShibkaiToken
    Telegram: https://t.me/shibkai
*/
...
contract Shibkai is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba Hakai", "SHIBKAI") {
