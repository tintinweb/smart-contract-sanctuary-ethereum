...
contract LITDOGEETH is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Lit Doge";
    string private constant _symbol = "LITDOGE";

    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 private _maxTxAmountPercent = 2500; // 10000;
    uint256 private _maxTransferPercent = 3000;
    uint256 private _maxWalletPercent = 4000;
    ...
    address internal constant development_receiver = 0xAb6bd8Ac8831377C179d87a4755C0D5484BD941B; 
    address internal constant marketing_receiver = 0xAb6bd8Ac8831377C179d87a4755C0D5484BD941B;
    address internal constant liquidity_receiver = 0xAb6bd8Ac8831377C179d87a4755C0D5484BD941B;
