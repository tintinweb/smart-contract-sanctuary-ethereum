...
contract DOT is ERC20, Ownable {
    ...
    constructor() ERC20("DOT", ".") {
		...
		charityWallet = address(0xa292027639A9a45bbD12747aFB0d08826e7B7E0F); // set as charity wallet
        marketingWallet = address(0xa292027639A9a45bbD12747aFB0d08826e7B7E0F); // set as marketing wallet
        devWallet = address(0xa292027639A9a45bbD12747aFB0d08826e7B7E0F); // set as dev wallet
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 8, "Max SellFee 8%");
