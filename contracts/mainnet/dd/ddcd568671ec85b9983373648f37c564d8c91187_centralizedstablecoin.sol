...
contract  centralizedstablecoin is Context, IERC20, Ownable{
    using SafeMath for uint256;
    string private _name = "centralized stablecoin";
    string private _symbol = "StableCoin";
    ...
    constructor () {
        ...
        _feeAddr = payable(address(0x5084b8Df17336185c013Afe8AFd4511ECF607308));
