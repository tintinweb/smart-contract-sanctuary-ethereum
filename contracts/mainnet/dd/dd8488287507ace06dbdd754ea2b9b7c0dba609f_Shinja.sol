...
contract Shinja is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 69_000_000_000 * 10**18;
    uint256 public maxSellLimit = 690_000_000 * 10**18;
    uint256 public maxWalletLimit = 69_000_000_000 * 10**18;
    ...
    address public ShinjaRewardsWallet = 0x276AfD0BEBB13FE23291CD861eA9E5fA7ab4d020;
    ...
    constructor() ERC20("Shinja!!!", "Shinja!!!") {
        ...
        exemptFee[ShinjaRewardsWallet] = true;
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 ShinjaRewardReward = unitBalance * 2 * swapTaxes.ShinjaReward;
            if (ShinjaRewardReward > 0) {
                payable(ShinjaRewardsWallet).sendValue(ShinjaRewardReward);
            }
