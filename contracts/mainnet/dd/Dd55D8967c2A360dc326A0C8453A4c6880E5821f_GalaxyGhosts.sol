...
contract GalaxyGhosts is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint256 public max_per_wallet = 7;

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("Galaxy Ghosts", "GG ") {
