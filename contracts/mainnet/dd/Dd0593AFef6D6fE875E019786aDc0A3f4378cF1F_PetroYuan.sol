...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCA8E966d09eA5Bffd499fA2c17cdCC954b87ac52; //owner wallet
...
contract PetroYuan is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xCA8E966d09eA5Bffd499fA2c17cdCC954b87ac52; //developement fee wallet
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 888000000000000 * 10**18; // total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Petro Yuan";
    string private _symbol = "pYUAN";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 10; // tax fee = 1%
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 10;  // development tax = 1%
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 10; // liquidity fee 1%
    ...
    uint256 public _maxTxAmount = 888000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 888000000000 * 10**18;
