...
*/
// ERC-721A based NFT contract
// Dev twitter @blockdeve
...
contract LoonyPirates is ERC721A, ReentrancyGuard, Ownable{
    ...
    constructor(string memory _unrevealedUri) ERC721A("LoonyPirates", "LOPI"){
