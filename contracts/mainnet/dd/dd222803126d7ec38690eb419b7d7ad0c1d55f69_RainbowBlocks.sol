...
// File: RainbowBlocks.sol

pragma solidity ^0.8.13;


contract RainbowBlocks is ERC721A, Ownable, DefaultOperatorFilterer {
  ...
  constructor() ERC721A("Rainbow Blocks by Andreotti", "RainbowBlocks") payable {
    _mint(msg.sender, 1);
  }
