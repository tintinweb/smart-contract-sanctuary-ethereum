...
contract TiffBits is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxForSale = 4000;
  uint256 public maxForClaim = 6000;
  ...
  ERC721A private tpunks=ERC721A(0xFb76f849Baf4A4DB22550eBC7BEB520652F888a0);
  constructor(
    string memory _hiddenMetadataUri
  ) ERC721A("TiffBits", "TBITS") {
