...
contract Serendipity is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.002 ether;
    uint   public maxTx             = 908;
    uint   public maxSupply         = 908;
    uint256 public reservedSupply   = 300;
    string private baseURI          = "ipfs://bafybeifzz4jxdzsuw2glowhq6xgsd5aasrvnkm7bzyfslu3g5jgvfv7oo4/";
    ...
    constructor() ERC721A("Serendipity", "Serendipity") {}
