...
/**
Kick UST & Luna back to ATH with a strong $TKD meme coin.
...
contract TaeKwonDo is ERC20, Auth {
    ...
    string constant private _name = "TAE KWON DO";
    string constant private _symbol = "TKD";
