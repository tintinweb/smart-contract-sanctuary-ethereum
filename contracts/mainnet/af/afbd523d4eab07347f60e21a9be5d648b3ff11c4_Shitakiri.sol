...
contract Shitakiri is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shitakiri Suzume";
    string private constant _symbol = unicode"REDSPARROW";
