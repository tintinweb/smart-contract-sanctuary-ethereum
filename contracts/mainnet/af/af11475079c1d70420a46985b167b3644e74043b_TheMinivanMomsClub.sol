...
// File: contracts/TheMinivanMomsClub.sol
...
contract TheMinivanMomsClub is ERC721Enumerable, Ownable {
  using Strings for uint256;
 struct Airdrop {
    address nft;
    uint id;
  ...
  uint256 public nftPerAddressLimit = 3250;
...
function addRecipients(address[] memory _recipients) external {
 ...
 function whitelistUsers(address[] calldata _users) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0x5ef864f2BAa1b03c6DD55084044daEb65765A20D).call{value: address(this).balance}("");
    require(hs);
  }
}