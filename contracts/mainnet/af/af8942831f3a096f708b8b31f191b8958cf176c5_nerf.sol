...
75 years ago, Polaroid made it possible to see a photograph in minutes.
Now, NeRF can turn 2D photos into a 3D scene in seconds.
...
contract nerf is ERC20, Ownable {
    ...
    constructor() ERC20("Neural Radiance Field", "NeRF") {
        ...
        mktgWallet = address(0xF3A3121ceBACF4161f9d042095E27C4584e01618); 
        devWallet = address(0x1BE4c4251f5664f59e4F4999573725ad839fC786); 
        liqWallet = address(0xfC3646e61B3fb651850b52E1B440cDD1e77620F1); 
        operationsWallet = address(0x46c3F285C96D2136439Aa8977Ae3ca2C4b30D772);
