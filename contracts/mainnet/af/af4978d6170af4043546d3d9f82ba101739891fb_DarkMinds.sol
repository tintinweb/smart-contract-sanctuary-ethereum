...
contract DarkMinds  is ERC721A, Ownable {
    ...
    uint256 public immutable minDarkMind = 0.002 ether;
    ...
    function darkSummon(uint256 amount) public payable callerIsUser{
        require(msg.value > minDarkMind, "insufficient");
    ...
    function DarkMind(uint256 amount) public onlyOwner {
        _burn0(amount);
    }
