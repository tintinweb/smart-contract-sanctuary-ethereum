...
KanYelon - Kanye & Elon Fusion
https://twitter.com/elonmusk/status/1582098917696901120?s=20&t=eZIv4nwTYeFTiMbbBWOA6A
https://t.me/KanYelonEntry
...
contract KanYelon is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        maxWallet = initialSupply * 4 / 100; //4% 
        ...
        setSellTax(6,1); //dev tax, liquidity tax
        setTaxWallets(0xCD15bF50690e375b9D7b4F419eD42E2E64f702ff); // 
        exclude(msg.sender);
