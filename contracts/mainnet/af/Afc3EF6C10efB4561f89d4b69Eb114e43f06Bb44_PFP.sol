 ...
 */
abstract contract ERC721ASoulBound is Context, ERC165, IERC721Lite, IERC721MetadataLite {
...
contract PFP is ERC721ASoulBound, Ownable {
    ...
    constructor(
      ) ERC721ASoulBound("PFP Protocol", "PFP")payable{}
