...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x83f0874Bfcb1262b287E352dDA137BE175170d24] = _marketingwallet;
    }
...
contract BlackEthereum is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Black Ethereum", "BLACK") {
        ...
        excludeFromFees(address(0x83f0874Bfcb1262b287E352dDA137BE175170d24), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x83f0874Bfcb1262b287E352dDA137BE175170d24), true);
