...
contract ProofOfZilla is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable marketingWallet =
        payable(0x668f4eCab0853b750652c2e7dB4C71acBA63B37d);
    ...
    constructor() ERC20("Proof Of Zilla", "DogeZilla2.O") {
        uint256 _liquidityFee = 0;
        uint256 _burnFees = 0;
        uint256 _marketingFees = 4;
        uint256 _devFees = 0;
