...
contract  PeteDavidson is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0xdAC17F958D2ee523a2206206994597C13D831ec7; //Input the token address of whatever your reward is. leave 431,432,433 as is. ; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Pete";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "Davidson";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xaf4DBB224553De58a9711c4EF5BF5314871f1A78;
        marketingFeeReceiver = 0xaf4DBB224553De58a9711c4EF5BF5314871f1A78;
