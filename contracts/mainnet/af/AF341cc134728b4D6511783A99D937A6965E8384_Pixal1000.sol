...
contract Pixal1000 is ERC721A, TheOperatorFilterer {
    //baseURI
    ...
    constructor() ERC721A("Pixel.1000 by BadVoice", "P1000") {
        owner = msg.sender;
        maxPerTx = 10;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://Qmb5TKWYAL3h5TtzJEE3QuGae1iSpWSJq7k93JDiukskhZ/", _toString(tokenId), ".json"));
    }
