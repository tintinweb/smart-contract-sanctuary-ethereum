...
contract MadShiba is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Mad Shiba";
    string private constant _symbol = "MADSHI";
    ...
    address payable private _developmentAddress = payable(0x12308bdb1164495Dc98067eD6A41B2fC356C8b78); 
    address payable private _marketingAddress = payable(0x12308bdb1164495Dc98067eD6A41B2fC356C8b78);
