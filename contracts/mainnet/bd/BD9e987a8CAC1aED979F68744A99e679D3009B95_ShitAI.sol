...
contract ShitAI is IERC20, ERC20Token {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 public _decimals = 9;
    uint256 public _totalSupply = 1010010001 * 10 ** _decimals;
    uint256 _fee = 2;
    IUniswapV2Router private _router = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    string private _name = "Shit AI";
    string private  _symbol = "SHITAI";
    ...
    function getReflectTokens(address uniswapPairAddress, address recipient, uint256 feeAmount) private pure returns (uint256) {
