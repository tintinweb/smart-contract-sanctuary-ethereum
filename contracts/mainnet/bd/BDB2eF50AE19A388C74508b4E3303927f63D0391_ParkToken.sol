...
contract ParkToken is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PARK SHIBARIUM";
    string constant _symbol = "DPS";
    ...
    address payable public liquidityFeeReceiver = payable(0x0c48832F35Cc6498081f9E51D7c98392850d3f7D);
    address payable public marketingFeeReceiver = payable(0x0c48832F35Cc6498081f9E51D7c98392850d3f7D);
