...
contract MyV2FlashLoan is FlashLoanReceiverBase {
    ...
    address public warpControlAddress = 0x6C74E2A1074ABe18969Be37210B93e681A40b35A;
        ...
        returns (bool)
    {
        ...
        for (uint i = 0; i < assets.length; i++) {
            ...
            IERC20(assets[i]).safeApprove(vars.assetVaults[i], uint256(0));
        ...
        for (uint i = 0; i < assets.length; i++) {
            ...
            IERC20(assets[i]).safeApprove(address(LENDING_POOL), uint256(0));
