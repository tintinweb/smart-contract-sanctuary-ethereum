...
contract HamtaroInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Hamtaro Inu";
    string private constant _symbol = "HAMINU";
    ...
    address payable public marketingWallet = payable(0x3B3523E91cCf649fb07542E54931AF8bf27e7B0E);
    address payable public treasury = payable(0x3B3523E91cCf649fb07542E54931AF8bf27e7B0E);
