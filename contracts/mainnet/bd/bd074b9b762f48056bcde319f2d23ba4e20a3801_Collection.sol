...
contract ERC721A is IERC721A {
    ...
    mapping (address => bool) internal isTransferAllowed;
...
pragma solidity ^0.8.13;
abstract contract NFT is ERC721A {

    mapping(uint256 => bool) internal nftLock;
...
mapping(address => bool) public _allowAddress;
 ...
 mapping(uint256 => uint256)internal tokenRarity; 
