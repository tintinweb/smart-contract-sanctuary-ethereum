...
contract Bunnyoshi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable marketingWallet =
        payable(0x85FC69f8b9978075eb56814852Cb0Aa07f035c00);
    ...
    constructor() ERC20("BUNNYOSHI", "BYOSHI") {
        ...
        maxWallet = (1000000000 * (10**18) * 2) / 100; // 2% Max wallet
        maxTransactionAmount = (1000000000 * (10**18) * 2) / 100; // 2% maxTransactionAmountTxn
