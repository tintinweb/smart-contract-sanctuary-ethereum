...
Telegram: https://t.me/DCBurnErc

https://t.me/DogechainAnnouncements/218

The Dogechain foundation burning 80% of the total supply of $DC tokens, The Great Burn happening next week!
...
contract BURN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 100_000 * 10**18;

    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint256 public _tokensBuyFee = 7;
    uint256 public _tokensSellFee = 7;
    ...
    string private constant _name = "DCBURN";
    string private constant _symbol = "DCBURN";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x2Dad314ff6C00a31D4E4bC2f080aFe4E3fcF5356);
