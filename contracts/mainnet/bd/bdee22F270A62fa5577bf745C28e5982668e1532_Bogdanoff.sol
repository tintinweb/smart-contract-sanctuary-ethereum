...
contract Bogdanoff is DefaultOperatorFilterer, Context, ERC721Tradeable {
  ...
  constructor(address _proxyAddress) ERC721Tradeable("Bogdanoff", "BOGDA", _proxyAddress) {
    _baseTokenURI = "ipfs://tbd/";
    payableAddress = payable(0x69A4964a6f3846960A354113c78ed9cfc50A7176);
  }
...
contract ERC721Tradeable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
  ...
  //Initial price is 0.0015 ETH
  uint256 internal PRICE = 1500000;
  ...
  uint256 internal MAX_SUPPLY = 1500;
