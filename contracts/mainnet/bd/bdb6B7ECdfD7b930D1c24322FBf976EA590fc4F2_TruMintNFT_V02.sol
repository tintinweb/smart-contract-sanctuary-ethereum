...
// File: contracts/trumintNAme.sol
...
contract TruMintNFT_V02 is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    /// NOTE: Thes sectin is for transfer mechanics
    ...
    // overrides of ERC721 transfer functions
    ...
    /// NOTE: Thes sectin is for additonal functionality
    ...
    * @dev allows the owner to update the tokenURI of a token
    ...
    /**
    * @dev 
    * this overrides the ERC721Upgradeable name function
    * this is only here because I have not been able to figure a 
    * better way to update the name and symbol
    */
    function name() public view virtual override returns (string memory) {
        return _newName;
    }
    ...
    function updateNameAndSymbol(string memory newName, string memory newSymbol)
        public 
        onlyOwner 
    {
        _newName = newName;
