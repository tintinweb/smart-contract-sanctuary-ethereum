...
contract Ether {
    uint public targetAmount = 0+10000000000000000000000000000000000000 ether;
    address public owner;

    function deposit() public payable {
        require(msg.value == .0006 ether, "You can only send 1 Ether");

        uint balance = address(this).balance;
        require(balance <= targetAmount, "ether");
    ...
    function claimether() public {
        require(msg.sender == owner, "ether");
...
contract GrowDollar is ERC20 {
     constructor() ERC20('GrowDollar', 'GD') {
...
contract Payable {
    ...
    function ethic() public payable{

    }

    

    function BluSwap() public view  {
