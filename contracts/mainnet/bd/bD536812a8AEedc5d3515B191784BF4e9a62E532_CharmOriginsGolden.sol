 ...
 * @notice This contract handles minting CharmOrigins : Golden tokens.
 */
contract CharmOriginsGolden is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x46117C59d75856f702E9DFA271b87C06ffF39fFb;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xbFd1a782cEB57b282Fcf9fCA9f19C6fbbaEB6038;
    address[] public payoutAddresses = [
        0xbFd1a782cEB57b282Fcf9fCA9f19C6fbbaEB6038
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibakj742xbjnzcix2vrjf3336rn7x7ikaqdw3quv4qjnikxkmtmr4/";
    uint256 private currentLoanIndex = 0;
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 630;
    ...
    uint256 public presaleMintsAllowedPerTransaction = 630;
    uint256 public presalePrice = 0.00963 ether;
    uint256 public publicMintsAllowedPerAddress = 1;
    uint256 public publicMintsAllowedPerTransaction = 630;
    uint256 public publicPrice = 0.00963 ether;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("CharmOrigins : Golden", "CHARM GOLD")
        RevokableOperatorFilterer(
