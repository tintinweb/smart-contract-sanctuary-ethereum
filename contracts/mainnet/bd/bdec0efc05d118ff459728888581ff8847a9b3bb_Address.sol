...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory json = "{\"image\":\"https://gateway.pinata.cloud/ipfs/QmXMjgTwtHJ3sXbW2pxc8PrHSFBAmyZkUqABELkXd5dQu5\",\"name\":\"my NFT\",\"description\":\"This is my NFT.\"}";
        return json;
    }
...
contract KYMNFT is ERC721A, Ownable, ReentrancyGuard {  
    using Strings for uint256;
	...
	constructor() ERC721A("KymPorn", "KYM") {}
