...
The Pampas eagle flies over Qatar. Argentina is the champion. Pampas eagle will eventually hold its own Hercules Cup.
Max wallet holder to get 50% of tax revenue after Argentina win(In the same situation, the rewards are divided equally)

Tg: https://t.me/Pampaseagle
...
contract PampasEagle is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pampas Eagle";
    string private constant _symbol = unicode"PEAGLE";
