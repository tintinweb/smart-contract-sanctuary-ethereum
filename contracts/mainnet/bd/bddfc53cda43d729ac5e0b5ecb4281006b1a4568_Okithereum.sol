...
欢迎来到 Okithereum 有希望的计划和促进进入以太坊空间，我们不仅仅是一个普通的代币
我们还支持基于我们自己的生态系统、未来 Staking、NFT 集合设计的交换平台
在我们自己的市场上以及更多内容将在适当的时候公布。

https://wei.okithereum.zohonet.io
https://web.wechat.com/Okithereum
*/
...
contract Okithereum is ERC20, Ownable {
    using SafeMath for uint256;
  

    string private _name = "Okithereum";
