...
contract TikTokInu is Context, IERC20, Ownable, Pausable {
    ...
    string private _name ="TikTok Inu";
    string private _symbol = "TIKTOKINU";
    ...
    address payable public marketingWallet = payable(0x416A6577f7886472DdEA89ea22E9E15f28bCE019);
    ...
    uint256 public maxBuyTransactionAmount = 6900000000 * 10**9;  
    uint256 public maxWalletToken = 14000000000 * 10**9; 
