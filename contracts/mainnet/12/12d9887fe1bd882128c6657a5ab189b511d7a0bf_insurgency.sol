...
/**
TRUE*BELIEVERS*WILL*GET*REWARDED
...
contract insurgency is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Insurgency";
    string private constant _symbol = "OUTRAGE";
