...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0x9DE554Df7827Dd8b34B0c4399d1aA997e48a6282;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [0xDF1e3abB229d42A182aD61ce8a63355a8A3EB0F8,0x9DE554Df7827Dd8b34B0c4399d1aA997e48a6282];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRFWrtsAm2nq61gELa7CvNWemADqWUMewEHoJSv117YZJ/";
...
// File: contracts/AkubirdsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AkubirdsContract is RamppERC721A {
    constructor() RamppERC721A("Akubirds", "AKB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/6nycVG76yt8VVXrCQX3f/contract-metadata";
    }
}
