...
/**
Token name: Righteousness
Ticker: Yi イー
Supply: 888,888,888,888
MAX BUY 4,444,444,444
Telegram: https://t.me/YiERC20
...
contract yismartcontract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Righteousness";
    string private constant _symbol = "Yi \u30a4\u30fc \xF0\x9F\x90\xA0";
    ...
    uint256 private maxWalletAmount = 4444444445 * 10**9;
    uint256 private maxTxAmount = 4444444445 * 10**9;
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x28B340BF0484a0c3152Ea1Bb0ae6a9c8c5E2Fe20); 
        ...
        swapEnabled = true;
        maxTxAmount = 4444444445 * 10**9;
        maxWalletAmount = 4444444445 * 10**9;
        tradingOpen = true;
