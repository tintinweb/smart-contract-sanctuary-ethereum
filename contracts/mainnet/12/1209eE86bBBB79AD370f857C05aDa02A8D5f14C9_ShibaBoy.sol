...
https://shiboy.tech/
Telegram:
https://t.me/ShibaBoyERC
Twitter:
https://twitter.com/ShibaBoy_ERC
Medium:
https://medium.com/@ShibaBoyERC

ECOSYSTEM SHIBA BOY:
▪️SHIBA BOY SWAP
https://swap.shiboy.tech/
▪️SHIBA BOY STAKING
https://staking.shiboy.tech/
▪️SHIBA BOY NFT
https://nft.shiboy.tech/
*/
 ...
 */
contract ShibaBoy is ERC20, ServicePayer, GeneratorCopyright {
    constructor(
        string memory name_,
        string memory symbol_,
        bytes memory signature_,
        address payable feeReceiver_
    ) payable ERC20(name_, symbol_) ServicePayer(feeReceiver_, "Shiba Boy", signature_, _msgSender()) {
