...
// $Asuka Inu Will Be A Community Driven Token That Will Have A Unique Buyback Mechanism!
// https://www.asukainuerc.com/
// https://t.me/AsukaInu
...
contract AsukaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AsukaInu", "AsukaInu") {
        ...
        maxWallet = 2000000000 * 1e18; // 2% of supply max wallet
        ...
        theBank = payable(0x53C893cfbBD3Df1D0123F4492E637e3e178a53a2); 
        liqOwner = payable(0x9Ed66cD1904C2C11e0310FD97F36EacCc9597cD2);
    ...
    function updateBuyFees(uint256 _theBankFee, uint256 _liqFee) external onlyOwner {
        ...
        buyLiqFee = _liqFee;
        buyTotalFees = buyTheBankFee + buyLiqFee;
        require(buyTotalFees <= 47, "Must keep fees at 47% or less");
    }
    ...
    function updateSellFees(uint256 _theBankFee, uint256 _liqFee) external onlyOwner {
        ...
        sellLiqFee = _liqFee;
        sellTotalFees = sellTheBankFee + sellLiqFee;
        require(sellTotalFees <= 47, "Must keep fees at 47% or less");
    }
    ...
    function _transfer(
        ...
        if(restrictions){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x9Ed66cD1904C2C11e0310FD97F36EacCc9597cD2) &&
                !inTheZone
            ){
