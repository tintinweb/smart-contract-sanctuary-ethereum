...
/*
    ...
    PDF: https://ufile.io/1y6ej0l5
    TWITTER : https://twitter.com/SecretSocietyX0
...
contract SECRETSOCIETY is Context, IERC20 {
    ...
    string private _name = "Secret Society";
...
//==========================
    ...
    {maxBuy: 100, maxSell: 100, maxTransfer: 1000});
//==========================    
    ...
    { liquidity: 0, burn: 1000, developer: 0});
    ...
    address payable public _developerWallet = payable(0);
...
//===============================================================================================================
    ...
    function setRatios(uint _liquidity, uint _developer, uint _burn) external onlyOwner {
        require ( (_liquidity+_developer+_burn) == 1000, "!1K");
