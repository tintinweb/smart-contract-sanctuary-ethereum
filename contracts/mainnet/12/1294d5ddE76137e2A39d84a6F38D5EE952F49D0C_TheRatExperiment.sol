...
contract TheRatExperiment is ERC721A {
    string uri = "ipfs://the-rat-experiment/";
    ...
    function airDropToken(address addr, uint256 amount) public onlyOwner {
        require(totalSupply() + amount <= maxSupply);
    ...
    constructor() ERC721A("The Rat Experiment", "TRE") {
        owner = msg.sender;
        maxSupply = 3000;
