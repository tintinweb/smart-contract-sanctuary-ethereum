...
// File: contracts/HomoHomiez.sol

pragma solidity ^0.8.0;

contract HomoHomiez is ERC721A, Ownable{
    using Strings for uint256;
    ...
    // Name and symbol
    constructor() ERC721A("Homosexual Homiez NFT", "Homo Homiez"){
    ...
    function FreeMint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalSupply() + _quantity) <= 3000, "Beyond max supply");
    ...
    function PublicMint(uint256 _quantity) external payable callerIsUser{
        ...
        require((totalPublicMint[msg.sender] + _quantity)  <= MaxPublicMint, "Cannot mint beyondw wallet max mint!");
