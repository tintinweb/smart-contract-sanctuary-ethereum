...
/*
Bushido - Code of Glory and Honour.

Buring is the only way to reclaim our glory days. 

Burning is the only promise we can offer; Buring is the only way to success.
...
contract HonorAndCourage is Context, IERC20, Ownable { 
    ...
    string private constant _name = "The Ancient Code";
    string private constant _symbol = "Bushido";
