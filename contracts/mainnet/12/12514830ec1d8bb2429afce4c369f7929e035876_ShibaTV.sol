...
contract ShibaTV  is Context, IERC20, Ownable {
    ...
    address payable public devAddress = payable(0xd5Cd90908A87270E1C1F5d307660Db77DAB5952e); // Dev Address
    address payable public liquidityAddress = payable(0xd5Cd90908A87270E1C1F5d307660Db77DAB5952e); // Liquidity Address
    ...
    string private constant _name = unicode"ShibaTV";
    string private constant _symbol = unicode"ShibaTV";
