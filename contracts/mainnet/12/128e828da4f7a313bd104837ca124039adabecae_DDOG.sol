...
/**
Fully decentralized Dog $DDOG

The real communities are built by its members.
The creator doesn't matter.

The real power is withing the community and people.


It doesnt matter who am I...

Power to the people and communities.
...
Just a pure Decentralization of an asset.


You hold the key to something great.
But you must reach the door by working togethere as a team.
...
contract DDOG is ERC20, Ownable {
    ...
    constructor() ERC20("Decentralized Dog", "DDOG") {
		...
		charityWallet = address(0xed1a1cf30aDFc0d2e41F23954680778A57012A45); // set as charity wallet
        marketingWallet = address(0xed1a1cf30aDFc0d2e41F23954680778A57012A45); // set as marketing wallet
        devWallet = address(0xed1a1cf30aDFc0d2e41F23954680778A57012A45); // set as dev wallet
