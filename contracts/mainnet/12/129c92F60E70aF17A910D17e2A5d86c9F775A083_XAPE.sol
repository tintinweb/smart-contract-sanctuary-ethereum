...
contract XAPE is IERC20, Auth {
    ...
    string constant _name = "X APE";
    string constant _symbol = "$XAPE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 200; // 5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x787f1Bf643fc5277F43862fbd2b6F458d8DCfFcc;
