...
/**
        https://whenmemeofficial.medium.com/

        https://www.whenmemeofficial.com/

        https://twitter.com/WhenMemeErc

        https://t.me/WhenMemeEntry
*/
...
contract WhenMeme is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb1Df25D46a0fb9eA8180Fd1D605752e2880b1409); 
    address payable public Wallet_Utility = payable(0xb1Df25D46a0fb9eA8180Fd1D605752e2880b1409);
    ...
    string private constant _name = "When Meme"; 
    string private constant _symbol = unicode"WHENMEME"; 
    ...
    constructor () {
        ...
        _owner = 0xb1Df25D46a0fb9eA8180Fd1D605752e2880b1409;
