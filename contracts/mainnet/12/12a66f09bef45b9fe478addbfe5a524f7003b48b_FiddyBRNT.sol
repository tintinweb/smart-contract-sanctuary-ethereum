...
/**
Burnt $50 is a tiny LP token with a burning twist! 5% of every transaction goes to our contract's auto burn mechanism that will 
stabilize the LP and pump the MC. We burn, you earn.

5/5 Initial Tax - 100% Burnt
3/3 Final Tax
LP burnt upon launch
1% Max Transaction / 2% Max Wallet

https://t.me/Burnt50ERC
https://twitter.com/50_brnt
**/
...
contract FiddyBRNT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Burnt $50";
    string private constant _symbol = "$50BRNT";
    ...
    uint256 private _maxTxAmount = 10_000 * 10**9;
