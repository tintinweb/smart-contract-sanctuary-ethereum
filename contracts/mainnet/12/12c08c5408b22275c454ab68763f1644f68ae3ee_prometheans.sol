 ...
 * allowances. See {IERC20-approve}.
 */
contract prometheans is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "prometheans.xyz";
    string private _symbol = "prometheans";
    uint8 private _decimals = 18;
    uint256 private _supply = 999999999;

    uint256 public buyTaxForLiquidity = 1;
    uint256 public buyTaxForMarketing = 8;
    uint256 public buyTaxForBurning = 1;
    uint256 public sellTaxForLiquidity = 1;
    uint256 public sellTaxForMarketing = 8;
    uint256 public sellTaxForBurning = 1;

    address public marketingWallet = 0xa041B851AA61c7eF327fce72Ae0248a17E77c684;
    ...
    uint256 private _numTokensSellToAddToETH = 550000 * 10**_decimals;
    // TOKENOMICS END ============================================================>
