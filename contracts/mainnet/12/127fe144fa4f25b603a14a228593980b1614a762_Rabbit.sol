...
/**
Rabbit Kingdom (Rabbit)

https://twitter.com/RabbitKdom
https://t.me/RabbitKingdomERC20
*/
...
contract Rabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Rabbit Kingdom";
    string private _symbol = "Rabbit";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xfE3402c9b69059614E513538Dc0BD4f73f320cc7);
    address payable private taxWallet2 = payable(0xfE3402c9b69059614E513538Dc0BD4f73f320cc7);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 100000000000000000)
