...
contract BlackRocks is IERC721A { 
    ...
    uint256 public MAX_FREE = 888;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.001 ether;

    string private constant _name = "BlackRocks";
    string private constant _symbol = "BLACKROCK";
    string private _baseURI = "Qmeao6QsECKpaHBp4QQrsWwR5g6Mj8V8dYwdfGRgoRG3A2";
