...
// no whitelistmint
// buy n pay n
contract Baby00ts is ERC721A, IERC2981, Ownable {

    string public baseURI = "https://ipfs-storage.s3.amazonaws.com/baby00ts/";

    uint256 public tokenPrice = 59000000000000000; //0.005 ETH
    ...
    constructor() ERC721A("Baby00ts", "BBY", 100, MAX_TOKENS) {
    }
    ...
    function getPrice(uint numberOfTokens) public view returns (uint256) {
