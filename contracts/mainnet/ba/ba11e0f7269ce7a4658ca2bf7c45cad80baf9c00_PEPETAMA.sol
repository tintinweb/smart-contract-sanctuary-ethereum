...
contract PEPETAMA is Context, IERC20, Ownable {
    ...
    string private _name = "PEPETAMA";
    string private _symbol = "PEPETAMA";
    ...
    uint256 public _maxTxAmount = 1380000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 690000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 1380000000000000000000 * 10**9;
