...
// Telegram: https://t.me/Warudokappuinu
...
contract WarudokappuInu is Context, IERC20, Ownable {
    ...
    address payable _marketingAddress = payable(address(0x733c7C767DC906237C9abd62EB85f6f815b17811));

    string private _name = "Warudokappu Inu";
    string private _symbol = unicode"ワールドカップ犬";
    ...
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(50); // 5%
