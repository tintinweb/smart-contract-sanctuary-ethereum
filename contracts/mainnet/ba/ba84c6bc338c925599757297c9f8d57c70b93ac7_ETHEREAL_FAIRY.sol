...
contract ETHEREAL_FAIRY is ERC721Enumerable, Ownable {
    using Strings for uint256;

    bool public _isSaleActive = false;
    bool public _revealed = false;
    bool public _isWLSaleActive = true;

    // Constants
    string public collectionName = "ETHEREAL FAIRY";
    string public tokenName = "ETHF";
    uint256 public constant MAX_SUPPLY = 7777;
    uint256 public currentSupply;
    uint256 public mintPrice = 0 ether;
    uint256 public maxBalance = 500;
    uint256 public maxMint = 2;
    uint256 public maxWLBalance = 3;
