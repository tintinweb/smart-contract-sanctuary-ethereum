...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Telegram: https://t.me/percentageportal
...
contract Percentage is ERC20, Ownable {
    ...
    constructor() ERC20("Percentage", "%") {
        ...
        marketingWallet = address(0x47C94722a61b65bb1C97D963180345c5C587B5dA);
