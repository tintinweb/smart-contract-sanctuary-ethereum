...
contract EggBabiez is ERC721A, Ownable {
    ...
    uint256 public MAX_SUPPLY = 1281;
    ...
    */
     ...
     * base URI
     */
    string public baseURI = "ipfs://EggBabiez/";
     ...
     * contract deployment.
     */
    constructor() ERC721A("EggBabiez", "EGGB") {}
    ...
    */
    function freeHatch(uint256 quantity, address _to) external onlyOwner {
    ...
    */
    ...
    /**
     * Get the array of token for owner. Easy set up for Staking tokens
     */
