...
contract GOLDFINGER is ERC20, Ownable {
    ...
    constructor() ERC20("Goldfinger", "GOLDFINGER") {
    ...
    function UpdateTransactionAmount(uint256 _maxTxAmount) external onlyOwner {
        require(_maxTxAmount * 1e18 >= maxTx, "Max tx can not be lowered");
        maxTx = _maxTxAmount * 1e18;
    }

    function UpdateWalletSize(uint256 _maxWalletAmount) external onlyOwner {
        require(
