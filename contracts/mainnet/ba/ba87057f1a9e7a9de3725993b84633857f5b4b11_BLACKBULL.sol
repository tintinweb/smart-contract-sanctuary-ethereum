...
contract BLACKBULL is ERC20, Ownable {
    ...
    constructor() ERC20("BLACKBULL", "BULL") payable {
    	...
    	marketingWallet = address(0xdb426f62fa1EE0eDebd8B3b2F3E0A35F7EbD386a); // set as Marketing wallet
        devWallet = address(0xdb426f62fa1EE0eDebd8B3b2F3E0A35F7EbD386a); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xdb426f62fa1EE0eDebd8B3b2F3E0A35F7EbD386a, true);
        excludeFromFees(0xdb426f62fa1EE0eDebd8B3b2F3E0A35F7EbD386a, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xdb426f62fa1EE0eDebd8B3b2F3E0A35F7EbD386a, true);
        excludeFromMaxTransaction(0xdb426f62fa1EE0eDebd8B3b2F3E0A35F7EbD386a, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xdb426f62fa1EE0eDebd8B3b2F3E0A35F7EbD386a,
            block.timestamp
        );
    }
