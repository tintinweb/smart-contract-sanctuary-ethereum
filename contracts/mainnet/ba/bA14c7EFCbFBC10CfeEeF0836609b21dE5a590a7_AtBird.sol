...
contract AtBird is ERC721A, Ownable {
    // ====== Variables ======
    string private baseURI;
    uint256 private MAX_SUPPLY = 144;
    uint256 public mintPrice = 0 ether;
    mapping(address => bool) public allowList;
    bool public publicMint = false;
    bool public startMint = false;

    constructor() ERC721A("AT Bird NFT", "ATBIRD") {}
    ...
    // ====== Allow List Settings ======
    function modifyAllowList(address[] calldata _addresses, bool allowType)
        external
        onlyOwner
    {
    ...
    function checkPrice(uint256 _value, uint256 _quantity)
        public
        view
        returns (bool)
    {
