...
/*
        http://www.givingblockinu.com/
        www.twitter.com/GivingBlock
        https://t.me/Givingblockinu
                    The First Charity DAO
*/
...
contract GIVE is ERC20, Ownable {
    ...
    constructor() ERC20("Giving Block Inu", "GIVE") {
		...
		charityWallet = address(0xc60999d77c6A1E0b92AFB8F737c06C0cE4577b99); // set as charity wallet
        marketingWallet = address(0xBc8E3A4f8389D58C99b9E9ceDFc5f1C1E8185584); // set as marketing wallet
        devWallet = address(0xBc8E3A4f8389D58C99b9E9ceDFc5f1C1E8185584); // set as dev wallet
