...
contract ShibariumUniverse is ERC20, Ownable {
    ...
    constructor() ERC20("Shibarium Universe", "$UNIVERSE") {
        ...
        maxTransactionAmount = 1000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 2000000 * 1e18; // 2% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 10) / 100000; // 0.1% swap wallet
		...
		charityWallet = address(0xD339D5087f9C29456fc81d4740f66fba04485fAA); // set as charity wallet
        marketingWallet = address(0xD339D5087f9C29456fc81d4740f66fba04485fAA); // set as marketing wallet
        devWallet = address(0xD339D5087f9C29456fc81d4740f66fba04485fAA); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 100, "Max BuyFee 10%");
