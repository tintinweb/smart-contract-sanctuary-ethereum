...
import { OptionBarrier, VaultStatus } from "../Structs.sol";
...
contract FCNProductViewer {
    ...
    function getFCNVaultInfo(
        ...
        (
            ...
            VaultStatus vaultStatus,
            bool isKnockedIn
        ) = fcnProduct.vaults(fcnVaultAddress);
        ...
        return
            FCNVaultInfo({
                ...
                totalCouponPayoff: totalCouponPayoff,
                vaultFinalPayoff: vaultFinalPayoff,
                queuedWithdrawalsSharesAmount: queuedWithdrawalsSharesAmount,
                queuedWithdrawalsCount: queuedWithdrawalsCount,
                optionBarriersCount: optionBarriersCount,
                leverage: leverage,
                vaultAddress: vaultAddress,
                vaultStatus: vaultStatus,
                isKnockedIn: isKnockedIn,
