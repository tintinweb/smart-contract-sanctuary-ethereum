...
contract DegenMisteryBox is ERC721A, Ownable {
  using Strings for uint256;
  ...
  uint256 public price = 0 ether; // or more if you want..
  uint256 public maxSupply = 4069; 
  uint256 public maxMintAmountPerTx = 50; // Only for deployer - public mint will change in max 2 per transaction
  ...
  constructor() ERC721A("DegenMisteryBox", "DMB", maxMintAmountPerTx) {
    setHiddenMetadataUri("https://degenmisterybox.ams3.digitaloceanspaces.com/degenmisterybox.json");
  }
  ...
  address t1 = 0xFd64D0Fb6dA6D76b1e091477Bf08922E6B8C5263; 
