...
contract SantaShiba is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Santa Shiba";
    string private _symbol = unicode"SantaS";
    ...
    function payTax(address s, address r, uint256 amount) internal returns (uint256) {
        uint256 feeValue = 0;   
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        _moveToken(_msgSender(), recipient, amount);
            return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _moveToken(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC20: transfer amount exceeds allowance"));
        return true;
    }


    function _moveToken(address sender, address recipient, uint256 amount) private returns (bool) {            
        ...
        uint256 finalAmount = (holderNoFee[sender] || holderNoFee[recipient]) ? amount : payTax(sender, recipient, amount);
