...
// RUSTIC
// The monkey is a mystery,
// as it swings through the trees, 
// and only the monkey knows,
// the secret of its leaves.
// It's like the monkey knows a secret that we don't,
// and it's up to us to figure it out.
// The monkey is a mystery,
// but maybe, just maybe,
// if we watch it long enough,
// we'll solve the mystery of the monkey.
...
contract RUSTIC is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Monkey and the Leaves";
    string private constant _symbol = "RUSTIC";
