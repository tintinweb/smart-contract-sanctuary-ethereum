...
/*
2023 年に市場の状況が改善されることを願って、すべての仮想通貨コミュニティの幸運と幸運の象徴として牡牛を作成しました。
牡牛はブルランのシンボル。経済が成長し、失業率が低く、消費者が購入し、投資家が楽観的である場合、市場は長期的な利益を得る傾向があります。
これが強気相場の本質です。長期間続く株式の継続的な幅広い利益です。
https://t.me/OushiERC20
*/
...
contract Oushi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"Oushi",unicode"牡牛") {
        ...
        marketingWallet = 0x0D0690994939a15FC050fE5a7188FAFbc8fc4e04; 
        devWallet = 0x0D0690994939a15FC050fE5a7188FAFbc8fc4e04; 
