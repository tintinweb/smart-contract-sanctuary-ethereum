...
contract BrunoERC721Drop is ERC721A, DefaultOperatorFilterer {
    ...
    uint256 public maxFreeMintPerTx;
   ...
   function setMaxSupply(uint256 _maxSupply) public onlyOwner {
    ...
    function FreeMint(uint256 count) public {
        require(totalSupply() + count < maxFreeSupply + 1, "free supply SOLD OUT");
        require(count < maxFreeMintPerTx + 1, "Max per TX reached.");
        uint256 cost = 0;
        address to = _msgSenderERC721A();
        uint256 quantity = count;
        _mint(to, quantity);
    ...
    function setMaxFeeSupply(uint256 _maxFreeSupply) public onlyOwner {
