...
_______  ___________ ___________________ _______      ________ ________      ________________
\______ \ \_   _____//  _____/\_   _____/ \      \    /  _____/ \_____  \    /  _  \__    ___/
 |    |  \ |    __)_/   \  ___ |    __)_  /   |   \  /   \  ___  /   |   \  /  /_\  \|    |   
 |    `   \|        \    \_\  \|        \/    |    \ \    \_\  \/    |    \/    |    \    |   
/_______  /_______  /\______  /_______  /\____|__  /  \______  /\_______  /\____|__  /____|   
        \/        \/        \/        \/         \/          \/         \/         \/         


https://t.me/degengoat

Traded on degenswap:
https://degenswap.app/#/swap
...
contract DEGENGOAT is Context, IERC20, Ownable {
    ...
    string private _name = "Degen Goat";
    string private _symbol = "dGOAT";
    uint8 private _decimals = 9;
     
    uint256 private _taxFee = 1;    // Reflections tax
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _liquidityFee;  // never used, leave it as is, not chnage anything
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 private _developmentFee = 1200;     // 1200 = 12%  | marketing/development/team tax | this gets collected in the mnarkeing wallet
    ...
    uint256 public _maxTxAmount = 5_000_000_000 * 10**9;  // max transaction is equal to 0.5% of total supply
    uint256 public _maxWallet = 30_000_000_000 * 10**9;  // max wallet is 3% of total supply
    ...
    constructor () {
        ...
        marketingAddress = _msgSender();  // add your marketing wallet address here | its contract deployer by default
    ...
    function _setmaxwalletamount(uint256 amount) external onlyOwner() {
        require(amount >= 5_000_000_000, "Please check the maxwallet amount, should exceed 0.5% of the supply");
        _maxWallet = amount * 10**9;
    }

    function setmaxTxAmount(uint256 amount) external onlyOwner() {
        require(amount >= 5_000_000_000, "Please check MaxtxAmount amount, should exceed 0.5% of the supply");
    ...
    function addBotWallet(address[] memory bots_) external onlyOwner {
