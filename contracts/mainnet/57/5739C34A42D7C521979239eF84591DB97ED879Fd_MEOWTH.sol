...
/**
https://t.me/meowtherc20
*/

/**
https://twitter.com/Meowtherc
https://www.meowth.co
*/
...
contract MEOWTH is ERC20, Ownable {
    ...
    constructor() ERC20("MEOWTH", "MEOWTH") payable {
    	...
    	marketingWallet = address(0x0E433C595b35A7734a318ce7DDc0AEA6c26C1bba); // set as Marketing wallet
        devWallet = address(0x06089D8631f99dE438355c554ceE721fece2Ba06); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x0E433C595b35A7734a318ce7DDc0AEA6c26C1bba, true);
        excludeFromFees(0x06089D8631f99dE438355c554ceE721fece2Ba06, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x0E433C595b35A7734a318ce7DDc0AEA6c26C1bba, true);
        excludeFromMaxTransaction(0x06089D8631f99dE438355c554ceE721fece2Ba06, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x06089D8631f99dE438355c554ceE721fece2Ba06,
            block.timestamp
        );
    }
