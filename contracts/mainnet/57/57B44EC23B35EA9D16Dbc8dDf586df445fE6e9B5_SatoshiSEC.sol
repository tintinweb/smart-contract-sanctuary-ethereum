...
Telegram:
https://t.me/SatoshiSEC
Twitter:
https://twitter.com/SatoshiSEC
Website: TBA
*/
 ...
 */
contract SatoshiSEC is ERC20, ServicePayer, GeneratorCopyright {
    constructor(
        string memory name_,
        string memory symbol_,
        bytes memory signature_,
        address payable feeReceiver_
    ) payable ERC20(name_, symbol_) ServicePayer(feeReceiver_, "Satoshi SEC", signature_, _msgSender()) {
        _mint(_msgSender(), 100000000000e18);
    }
}