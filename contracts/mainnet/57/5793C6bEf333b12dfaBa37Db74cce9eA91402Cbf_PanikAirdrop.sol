...
import {IERC20} from "./panik.sol";



contract PanikAirdrop {
    ...
    function setMerkleProof(bytes32 _merkleRoot) public {
        if(msg.sender != admin) {
            revert NotAdmin();
        }
...
contract Panik is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("Panik", "PANIK") {
